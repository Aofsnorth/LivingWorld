...
// material family so grass sounds like grass, dirt sounds like dirt/gravel,
// stone-family sounds like stone, wood sounds like wood, etc. Anything we don't recognise falls back
