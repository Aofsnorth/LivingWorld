...
type Registries struct {
	...
	DamageType      Registry[nbt.RawMessage] `registry:"minecraft:damage_type"`
	DimensionType   Registry[nbt.RawMessage] `registry:"minecraft:dimension_type"`
...
func NewNetworkCodec() Registries {
	return Registries{
		...
		DamageType:      NewRegistry[nbt.RawMessage](),
		DimensionType:   NewRegistry[nbt.RawMessage](),
