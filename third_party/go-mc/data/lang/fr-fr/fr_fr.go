// Code generated by tools/gen_lang.go from 26.1/fr_fr.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"attribute.name.nameplate_distance": "distance du nom",
	...
	"connect.p2p.failed.unreachable": "Ce joueur est injoignable",
	...
	"menu.multiplayerOptions.title": "Options multijoueur",
	...
	"options.improvedTransparency.tooltip": "Une approche expérimentale qui utilise des shaders d'écran pour dessiner les nuages et les particules, dont celles liées à la météo, derrière les blocs translucides et l'eau.\nCela affectera les performances de la carte graphique.",
	...
	"options.restartRequired": "Certaines de vos modifications nécessitent un redémarrage du jeu pour être appliquées.",
	...
	"options.sprintWindow": "Intervalle de course",
	"options.sprintWindow.tooltip": "Intervalle de temps en ticks pendant lequel appuyer deux fois sur la touche \"Avancer\" active la course.",
	...
	"telemetry.property.backend_name.title": "Nom de l'API graphique",
