// Code generated by tools/gen_lang.go from 26.1/nl_be.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advancements.adventure.blowback.description": "Dood een bries met een door een bries afgevuurde windlading",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Maak een versierde pot van 4 aardewerkscherven\n",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Zorgvuldige restauratie",
	...
	"advancements.adventure.heart_transplanter.title": "Harttransplantator",
	...
	"advancements.adventure.lighten_up.description": "Schraap een koperen lamp met een bijl om hem helderder te maken",
	"advancements.adventure.lighten_up.title": "Oplichten",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Benader een probeer kamer",
	...
	"advancements.adventure.overoverkill.description": "Deel 50 harten schade in een enkele slag met de Mace",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Lees het stroomsignaal van een gebeitelde boekenplank met behulp van een comparator",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "De kracht van boeken",
	"advancements.adventure.revaulting.description": "Open een onheilspellende kluis met een onheilspellende beproevingssleutel",
	...
	"advancements.adventure.salvage_sherd.title": "Respect voor de overblijfselen",
	...
	"advancements.adventure.spear_many_mobs.description": "Raak vijf vijanden met dezelfde Charge-aanval met de speer.",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Pas deze smeedsjablonen minstens één keer toe: Spire, Snout, Rib, Ward, Silence, Vex, Tide, Wayfinder",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Smeden met stijl",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Maak een getrimd pantser aan een Smithing Table",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Een nieuwe look creëren",
	...
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.description": "Lopen op poedersneeuw... zonder erin weg te zinken",
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.title": "Zo licht als een veertje",
	"advancements.adventure.who_needs_rockets.description": "Gebruik een windvlaag om jezelf 8 blokken omhoog te lanceren",
	"advancements.adventure.who_needs_rockets.title": "Geen raket nodig!",
	...
	"advancements.husbandry.feed_snifflet.description": "Voer een Snifflet",
	"advancements.husbandry.feed_snifflet.title": "Kleine snuifjes",
	...
	"advancements.husbandry.obtain_sniffer_egg.description": "Verkrijg een Snuffel-ei",
	"advancements.husbandry.obtain_sniffer_egg.title": "Ruikt interessant",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Plaats een uitgedroogd Ghastblok in water",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Blijf gehydrateerd!",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Plant een Snuffelzaadje",
	"advancements.husbandry.plant_any_sniffer_seed.title": "Het verleden planten",
	...
	"advancements.husbandry.repair_wolf_armor.description": "Gebruik een gordeldierschub om wolvenharnas te repareren",
	...
	"advancements.husbandry.whole_pack.title": "De complete roedel",
	...
	"argument.message.too_long": "Chatbericht was te lang (%s > maximum %s karakters)",
	"argument.nbt.array.invalid": "Regeltype '%s' is ongeldig",
	"argument.nbt.array.mixed": "'%s' kan niet aan '%s' toegevoegd worden",
	"argument.nbt.expected.compound": "Verwachte samengestelde tag",
	...
	"argument.resource_or_id.failed_to_parse": "Verwerken van constructie '%s' mislukt",
	...
	"arguments.item.component.malformed": "Onjuist '%s' is component: %s",
	...
	"attribute.name.armor": "Uitrusting",
	"attribute.name.armor_toughness": "Harnas Sterkte",
	...
	"attribute.name.block_break_speed": "Blok breek snelheid",
	"attribute.name.block_interaction_range": "Block interactie afstand",
	"attribute.name.bounciness": "Veerkracht",
	"attribute.name.burning_time": "Brand tijd",
	"attribute.name.camera_distance": "Camera-afstand",
	"attribute.name.entity_interaction_range": "Entiteit interactie afstand",
	"attribute.name.explosion_knockback_resistance": "Explosie Terugslag Afweering",
	"attribute.name.fall_damage_multiplier": "Valschade Vermenigvuldiger",
	"attribute.name.flying_speed": "Vlieg Snelheid",
	"attribute.name.follow_range": "Mob volg afstand",
	...
	"attribute.name.generic.block_interaction_range": "Blok Interactie Bereik",
	"attribute.name.generic.burning_time": "Brandtijd",
	"attribute.name.generic.entity_interaction_range": "Entiteit Interactie Bereik",
	"attribute.name.generic.explosion_knockback_resistance": "Explosie Terugslagsweerstand",
	"attribute.name.generic.fall_damage_multiplier": "Valschade Vermenigvuldiger",
	...
	"attribute.name.generic.max_absorption": "Maximum absorptie",
	...
	"attribute.name.max_health": "Maximale gezondheid",
	...
	"attribute.name.player.block_break_speed": "Blok Breek Snelheid",
	"attribute.name.player.block_interaction_range": "Blok Interactie Bereik",
	"attribute.name.player.entity_interaction_range": "Entiteit Interactie Bereik",
	"attribute.name.player.mining_efficiency": "Mijnefficiëntie",
	"attribute.name.player.sneaking_speed": "Sluipsnelheid",
	"attribute.name.player.submerged_mining_speed": "Mijnsnelheid onder water",
	...
	"attribute.name.submerged_mining_speed": "Mijnsnelheid onder water",
	...
	"block.minecraft.acacia_shelf": "Acaciahouten plank",
	...
	"block.minecraft.bamboo_shelf": "Bamboeplank",
	...
	"block.minecraft.banner.flow.black": "Zwarte Stroom",
	"block.minecraft.banner.flow.blue": "Blauwe Stroom",
	"block.minecraft.banner.flow.brown": "Bruine Stroom",
	"block.minecraft.banner.flow.cyan": "Turquoise Stroom",
	"block.minecraft.banner.flow.gray": "Grijze Stroom",
	"block.minecraft.banner.flow.green": "Groene Stroom",
	"block.minecraft.banner.flow.light_blue": "Lichtblauwe Stroom",
	"block.minecraft.banner.flow.light_gray": "Lichtgrijze Stroom",
	"block.minecraft.banner.flow.lime": "Lichtgroene Stroom",
	"block.minecraft.banner.flow.magenta": "Magenta Stroom",
	"block.minecraft.banner.flow.orange": "Oranje Stroom",
	"block.minecraft.banner.flow.pink": "Roze Stroom",
	"block.minecraft.banner.flow.purple": "Paarse Stroom",
	"block.minecraft.banner.flow.red": "Rode Stroom",
	"block.minecraft.banner.flow.white": "Witte Stroom",
	"block.minecraft.banner.flow.yellow": "Gele Stroom",
	...
	"block.minecraft.banner.guster.black": "Zwarte Windvlaag",
	"block.minecraft.banner.guster.blue": "Blauwe Windvlaag",
	"block.minecraft.banner.guster.brown": "Bruine Windvlaag",
	"block.minecraft.banner.guster.cyan": "Turquoise Windvlaag",
	"block.minecraft.banner.guster.gray": "Grijze Windvlaag",
	"block.minecraft.banner.guster.green": "Groene Windvlaag",
	"block.minecraft.banner.guster.light_blue": "Lichtblauwe Windvlaag",
	"block.minecraft.banner.guster.light_gray": "Lichtgrijze Windvlaag",
	"block.minecraft.banner.guster.lime": "Lichtgroene Windvlaag",
	"block.minecraft.banner.guster.magenta": "Magenta Windvlaag",
	"block.minecraft.banner.guster.orange": "Oranje Windvlaag",
	"block.minecraft.banner.guster.pink": "Roze Windvlaag",
	"block.minecraft.banner.guster.purple": "Paarse Windvlaag",
	"block.minecraft.banner.guster.red": "Rode Windvlaag",
	"block.minecraft.banner.guster.white": "Witte Windvlaag",
	"block.minecraft.banner.guster.yellow": "Gele Windvlaag",
	...
	"block.minecraft.birch_shelf": "Berkenhouten plank",
	...
	"block.minecraft.cherry_shelf": "Kersenhouten plank",
	...
	"block.minecraft.chiseled_copper": "Gebeiteld Koper",
	...
	"block.minecraft.chiseled_tuff_bricks": "Gebeitelde tufstenen bakstenen",
	...
	"block.minecraft.dark_oak_shelf": "Donkereikenhouten plank",
	...
	"block.minecraft.firefly_bush": "Vuurvliegstruik",
	...
	"block.minecraft.jungle_shelf": "Oerwoudhouten plank",
	...
	"block.minecraft.leaf_litter": "Bladstrooisel",
	...
	"block.minecraft.mangrove_shelf": "Mangrovehouten plank",
	...
	"block.minecraft.oak_shelf": "Eikenhouten plank",
	...
	"block.minecraft.pale_oak_pressure_plate": "Bleke eiken drukplaat",
	"block.minecraft.pale_oak_sapling": "Jonge bleke eiken boom",
	"block.minecraft.pale_oak_shelf": "Bleek eikenhouten plank",
	"block.minecraft.pale_oak_sign": "Bleke eiken bord",
	"block.minecraft.pale_oak_slab": "Bleke eiken plaat",
	"block.minecraft.pale_oak_stairs": "Bleke eiken trap",
	"block.minecraft.pale_oak_trapdoor": "Bleke eiken valluik",
	"block.minecraft.pale_oak_wall_hanging_sign": "Bleke eiken muur hangend bord",
	"block.minecraft.pale_oak_wall_sign": "Bleek eiken bord aan muur",
	"block.minecraft.pale_oak_wood": "Bleke Eikenhouten Schors",
	...
	"block.minecraft.potted_closed_eyeblossom": "Geplante gesloten gluutbloesem",
	...
	"block.minecraft.potted_golden_dandelion": "Gouden paardenbloem in een pot",
	...
	"block.minecraft.potted_pale_oak_sapling": "Geplante jonge bleke eiken boom",
	...
	"block.minecraft.resin_clump": "Harsdruppel",
	...
	"block.minecraft.sniffer_egg": "Snuffelei",
	...
	"block.minecraft.spruce_shelf": "Sparrenhouten plank",
	...
	"block.minecraft.stripped_pale_oak_wood": "Gestripte Bleke Eikenhouten Schors",
	...
	"block.minecraft.suspicious_gravel": "Verdachte grind",
	...
	"block.minecraft.trial_spawner": "Beproevingsspawner",
	...
	"block.minecraft.tuff_brick_slab": "Tufblok plaat",
	"block.minecraft.tuff_brick_stairs": "Tufblok trap",
	"block.minecraft.tuff_brick_wall": "Tufblok muur",
	"block.minecraft.tuff_bricks": "Tufblok",
	...
	"block.minecraft.warped_shelf": "Spookachtig houten plank",
	...
	"block.minecraft.waxed_exposed_copper_bulb": "Gewaxte Bloodgestelde Koperen Lamp",
	...
	"block.minecraft.waxed_exposed_copper_door": "Gewaxte bloodgestelde koper deur",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Ingewassen blootgesteld kopergolemstandbeeld",
	"block.minecraft.waxed_exposed_copper_grate": "Gewaxte bloodgestelde koper rooster",
	"block.minecraft.waxed_exposed_copper_lantern": "Ingewassen blootgestelde koperen lantaarn",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Ingewassen Blootgestelde Koperen Valluik",
	...
	"block.minecraft.waxed_oxidized_chiseled_copper": "Ingewassen Geoxideerd Gebeiteld Koperblok",
	...
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Ingewassen Geoxideerde Koperen Valluik",
	...
	"block.minecraft.waxed_weathered_chiseled_copper": "Ingewassen Verweerd Gebeiteld Koperblok",
	...
	"block.minecraft.weathered_chiseled_copper": "Verweerd Gebeiteld Koperblok",
	...
	"chat.disabled.invalid_signature": "Chat had een ongeldige handtekening. Probeer opnieuw verbinding te maken.",
	...
	"chat.disabled.profile": "De chat is niet toegestaan door accountinstellingen. Druk op '%s' voor meer informatie.",
	...
	"chat.queue.tooltip": "Klik om het volgende bericht te tonen",
	...
	"commands.attribute.base_value.reset.success": "Basiswaarde van attribuut %s voor entiteit %s teruggezet naar standaardwaarde %s",
	...
	"commands.bossbar.set.players.success.some": "Gewijzigde baasbalk '%s' heeft %s speler(s): %s",
	...
	"commands.clone.success": "Succesvol %s blok(ken) gekloond",
	"commands.clone.toobig": "Teveel blokken in het opgegeven gebied (maximaal %s, opgegeven%s)",
	...
	"commands.debug.function.noReturnRun": "Opsporen is niet mogelijk met return run",
	...
	"commands.execute.function.instantiationFailure": "Gefaald om functie %s: %s te instantiëren",
	...
	"commands.fetchprofile.id.success": "Profiel van ID %s: %s",
	"commands.fetchprofile.name.failure": "Profiel ophalen voor naam %s mislukt",
	"commands.fetchprofile.name.success": "Profiel van naam %s: %s",
	"commands.fetchprofile.no_profile": "Entiteit %s heeft geen profiel",
	"commands.fetchprofile.summon_mannequin": "Roep Mannequin op",
	...
	"commands.fillbiome.success.count": "%s Gebied ingang/ingangen ingesteld tussen %s, %s, %s en %s, %s, %s",
	...
	"commands.function.error.argument_not_compound": "Ongeldige argumentssort: %s, verwachte samenstelling",
	"commands.function.error.missing_argument": "Ontbrekend argument %[2]s voor functie %[1]s",
	...
	"commands.function.instantiationFailure": "Gefaald om functie %s: %s te instantiëren",
	"commands.function.result": "Functie %s retourneerde %s",
	"commands.function.scheduled.multiple": "Functies uitvoeren %s",
	"commands.function.scheduled.no_functions": "Kon functies met naam '%s' niet vinden",
	"commands.function.scheduled.single": "Functie %s uitvoeren",
	...
	"commands.kick.singleplayer.failed": "Kan speler niet uit het spel zetten wanneer alleen gespeeld wordt",
	...
	"commands.profile_fetch.id.success": "Profiel van ID %s: %s",
	"commands.profile_fetch.name.failure": "Profiel ophalen voor naam %s mislukt",
	"commands.profile_fetch.name.success": "Profiel van naam %s: %s",
	...
	"commands.random.error.range_too_small": "Bereik van willekeurige waarde moet minstens 2 zijn",
	...
	"commands.schedule.cleared.failure": "Geen schema voor id %s",
	...
	"commands.schedule.macro": "Een macro kon niet worden ingepland",
	...
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Standaardwaarde-opmaak gewist voor doel %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Standaardwaarde-opmaak gewijzigd voor doel %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Weergavenaam gewist voor %s entiteiten in %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Weergavenaam gewist voor %s in %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Weergavenaam gewijzigd naar %s voor %s entiteiten in %s",
	"commands.scoreboard.players.display.name.set.success.single": "Weergavenaam gewijzigd naar %s voor %s in %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Waarde-opmaak gewist voor %s entiteiten in %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Waarde-opmaak gewist voor %s in %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Waarde-opmaak gewijzigd voor %s entiteiten in %s",
	...
	"commands.setidletimeout.success.disabled": "De speler idle timeout is nu uitgeschakeld",
	"commands.setworldspawn.failure.not_overworld": "Kan alleen de wereld spawn instellen voor overworld",
	...
	"commands.spectate.cannot_spectate": "%s kan niet worden bekeken",
	...
	"commands.stopwatch.already_exists": "Stopwatch '%s' bestaat al",
	"commands.stopwatch.create.success": "Stopwatch '%s' aangemaakt",
	"commands.stopwatch.does_not_exist": "Stopwatch '%s' bestaat niet",
	"commands.stopwatch.query": "Tijdmeter '%s' heeft %ss gelopen",
	"commands.stopwatch.remove.success": "Stopwatch '%s' verwijdert",
	"commands.stopwatch.restart.success": "Stopwatch '%s' herstart",
	"commands.summon.failed": "Entiteit kon niet worden opgroepen",
	"commands.summon.failed.peaceful": "Monster kan niet opgeroepen worden in het vredige niveau",
	...
	"commands.test.batch.starting": "Startomgeving %s batch %s",
	"commands.test.clear.error.no_tests": "Kon geen testen vinden om te wissen",
	...
	"commands.test.error.no_test_containing_pos": "Kan geen testinstantie vinden die %s, %s, %s bevat",
	"commands.test.error.no_test_instances": "Geen testinstanties gevonden",
	"commands.test.error.non_existant_test": "Test %s kon niet gevonden worden",
	"commands.test.error.structure_not_found": "Teststructuur %s kon niet worden gevonden",
	"commands.test.error.test_instance_not_found": "Testinstantie blokentiteit kon niet worden gevonden",
	"commands.test.error.test_instance_not_found.position": "Testinstantie blokentiteit kon niet worden gevonden voor test op %s, %s, %s",
	"commands.test.error.too_large": "De structuurgrootte moet %s blokken minder zijn langs elke as",
	"commands.test.locate.done": "Localisatie voltooid, %s Constructie(s) gevonden",
	"commands.test.locate.found": "Constructie op %s gevonden (afstand: %s)",
	"commands.test.locate.started": "Begonnen met het lokaliseren van testconstructies, dit kan even duren...",
	"commands.test.no_tests": "Geen tests om uit te voeren",
	"commands.test.relative_position": "Positie ten opzichte van %s: %s",
	"commands.test.reset.error.no_tests": "Kon geen tests vinden om te resetten",
	"commands.test.reset.success": "%s constructie(s) gereset",
	"commands.test.run.no_tests": "Geen tests gevonden",
	"commands.test.run.running": "Bezig met het uitvoeren van %s test(s)...",
	"commands.test.summary": "Speltest voltooid! %s test(s) zijn uitgevoerd",
	"commands.test.summary.all_required_passed": "Alle vereiste tests zijn geslaagd :)",
	"commands.test.summary.failed": "%s vereiste test(s) zijn mislukt :(",
	"commands.test.summary.optional_failed": "%s optionele test(s) zijn mislukt",
	"commands.tick.query.percentiles": "Percentielen: 50e: %sms; 95e: %sms; 99e: %sms; datasetgrootte: %s",
	"commands.tick.query.rate.running": "Doelwit ticksnelheid: %s per seconde.\nGemiddelde tijd per tick: %sms (Doel: %sms)",
	"commands.tick.query.rate.sprinting": "Doeltikfrequentie: %s per seconde (genegeerd, alleen ter referentie).\nGemiddelde tijd per tik: %sms",
	"commands.tick.rate.success": "Stel de doeltikfrequentie in op %s per seconde",
	"commands.tick.sprint.report": "Sprint voltooid met %s tikken per seconde, of %s ms per tik",
	...
	"commands.tick.status.lagging": "Het spel draait, maar kan de ingestelde ticksnelheid niet halen",
	...
	"commands.time.no_time_marker_found": "Tijdmarkering %s bestaat niet voor klok %s",
	...
	"commands.time.resume": "Klok %s gepauzeerd",
	...
	"commands.version.header": "Serverversie-informatie:",
	...
	"commands.version.stable.no": "stabiel = no",
	"commands.version.stable.yes": "stabiel = yes",
	...
	"dataPack.winter_drop.description": "Nieuwe functies en content voor de Kleine Winterupdate",
	...
	"datapackFailure.title": "Fouten in momenteel geselecteerde datapakketten verhinderden dat de wereld werd geladen.\nJe kunt proberen het te laden met alleen het vanille-datapakket (\"veilige modus\"), of teruggaan naar het titelscherm en het handmatig repareren.",
	...
	"death.attack.genericKill": "%[1]s is gedood",
	...
	"death.attack.lightningBolt.player": "%[1]s is door de bliksem getroffen tijdens het vechten tegen %[2]s",
	"death.attack.mace_smash": "%[2]s plette %[1]s",
	"death.attack.mace_smash.item": "%[1]s was vernield door %[2]s met %[3]s",
	...
	"death.attack.outsideBorder": "%[1]s heeft de grenzen van deze wereld verlaten",
	"death.attack.outsideBorder.player": "%[1]s verliet de grenzen van deze wereld terwijl hij tegen %[2]s vocht",
	...
	"death.attack.spear": "%[1]s werd gespietst door %[2]s",
	"death.attack.spear.item": "%[1]s werd gespietst door %[2]s met %[3]s",
	...
	"debug.crash.message.rebindable": "%s + %s wordt ingehouden. Dit zal het spel laten crashen tenzij dat je loslaat.",
	"debug.crash.warning": "Spel crasht in %s...",
	"debug.creative_spectator.error": "Kan de spelmodus niet wijzigen; geen toestemming",
	"debug.creative_spectator.help": "F3 + N = Cyclus vorige spelmodus <-> toeschouwer",
	...
	"debug.entry.currently.alwaysOn": "%s: Momenteel altijd aan",
	"debug.entry.currently.inF3": "%s: Momenteel alleen in F3-scherm",
	"debug.entry.currently.inOverlay": "%s: momenteel alleen maar in het debug scherm",
	"debug.entry.currently.never": "%s: Momenteel uit",
	...
	"debug.options.help": "F3 + F5 = Debuginstellingen bewerken",
	...
	"debug.profiling.start.rebindable": "Profilling gestart voor %s seconden. Gebruik %s + %s om vroegtijds te stoppen",
	...
	"disconnect.packetError": "Netwerk protocol error",
	...
	"download.pack.failed": "%s van de %s pakketten konden niet gedownload worden",
	"download.pack.progress.bytes": "Progressie: %s (totale grootte onbekend)",
	"download.pack.progress.percent": "Progressie: %s%%",
	"download.pack.title": "Bronpakket downloaden%s/%s",
	...
	"effect.minecraft.breath_of_the_nautilus": "Adem van de nautilus",
	...
	"effect.minecraft.infested": "Geïnfesteerd",
	...
	"enchantment.minecraft.sweeping_edge": "Vegende rand",
	...
	"enchantment.minecraft.wind_burst": "Windstoot",
	...
	"entity.minecraft.dark_oak_boat": "Donkereikenhouten Boot",
	"entity.minecraft.dark_oak_chest_boat": "Donkereikenhouten Boot met Kist",
	...
	"entity.minecraft.jungle_boat": "Tropisch Hardhoutenboot",
	"entity.minecraft.jungle_chest_boat": "Tropisch Hardhoutenboot met kist",
	...
	"event.minecraft.raid.defeat.full": "Aanval - Verloren",
	"event.minecraft.raid.raiders_remaining": "%s overvaller(s) over",
	"event.minecraft.raid.victory": "Gewonnen",
	"event.minecraft.raid.victory.full": "Aanval - Overwinning",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Nederportaal toestaan",
	...
	"gamerule.allowFireTicksAwayFromPlayer": "Tik vuur op afstand van spelers",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Bepaalt of vuur en lava verder dan 8 chunks van een speler mogen tikken",
	...
	"gamerule.doMobLoot.description": "Bestuurt brondruppels van mobs, inclusief ervaringsbollen.",
	"gamerule.doMobSpawning": "Wezens spawnen",
	"gamerule.doMobSpawning.description": "Sommige entiteiten hebben mogelijk afzonderlijke regels.",
	"gamerule.doPatrolSpawning": "Roverspatrouilles spawnen",
	"gamerule.doTileDrops": "Blokken laten vallen",
	"gamerule.doTileDrops.description": "Regelt brondalingen van blokken, inclusief ervaringsbollen.",
	...
	"gamerule.enderPearlsVanishOnDeath.description": "Of de door een speler gegooide Enderparels verdwijnen wanneer die speler doodgaat.",
	...
	"gamerule.locatorBar": "Speleropsporingsbalk gebruiken",
	...
	"gamerule.maxCommandChainLength.description": "Is van toepassing op opdrachtblokketens en -functies.",
	...
	"gamerule.reducedDebugInfo.description": "Beperkt de inhoud van het foutopsporingsscherm.",
	...
	"gamerule.spawnChunkRadius.description": "Het aantal chunks rondom het wereldspawnpunt die geladen moeten blijven.",
	"gamerule.spawnMonsters": "Monsters spawnen",
	"gamerule.spawnMonsters.description": "Bepaalt of monsters van nature paaien",
	...
	"gamerule.tntExplodes": "Bepaalt of TNT aangestoken kan worden en explodeert",
	...
	"gui.abuseReport.describe": "Details delen kan ons helpen met een geïnformeerde keuze maken.",
	...
	"gui.abuseReport.discard.return": "Doorgaan met bewerken",
	"gui.abuseReport.discard.title": "Melding en beschrijving weggooien?",
	"gui.abuseReport.draft.content": "Wil je het bestaande rapport bewerken of een nieuw rapport aanmaken?",
	"gui.abuseReport.draft.discard": "Weggooien",
	"gui.abuseReport.draft.edit": "Blijf bewerken",
	"gui.abuseReport.draft.quittotitle.content": "Wil je doorgaan met bewerken of het annuleren?",
	"gui.abuseReport.draft.quittotitle.title": "Je hebt een chatrapport concept dat verloren zal gaan als je afsluit",
	"gui.abuseReport.draft.title": "Concept van rapport bewerken?",
	"gui.abuseReport.error.title": "Er trad een probleem op bij het sturen van uw melding",
	"gui.abuseReport.message": "Waar heb je het ongepaste gedrag waargenomen?\nDit helpt ons bij het onderzoeken van de situatie.",
	...
	"gui.abuseReport.name.reporting": "Je maakt een rapport over '%s'.",
	"gui.abuseReport.name.title": "Rapporteer ongepaste spelersnaam",
	"gui.abuseReport.observed_what": "Waarom rapporteer je dit?",
	"gui.abuseReport.read_info": "Leer Over Rapporteren",
	...
	"gui.abuseReport.reason.generic": "Ik wil ze rapporteren",
	"gui.abuseReport.reason.generic.description": "Ze irriteren mij / ze hebben iets gedaan dat ik niet leuk vind.",
	...
	"gui.abuseReport.select_reason": "Selecteer een rapportagecategorie",
	"gui.abuseReport.send": "Stuur Rapport",
	...
	"gui.abuseReport.send.no_reason": "Selecteer een rapportagecategorie",
	"gui.abuseReport.send.not_attested": "Lees de bovenstaande tekst en vink het selectievakje aan om het rapport te kunnen verzenden",
	...
	"gui.abuseReport.skin.title": "Rapporteer Spelersskin",
	...
	"gui.banned.description.permanent": "Uw account is permanent geblokkeerd, wat betekent dat u niet online kunt spelen of Realms kunt betreden.",
	...
	"gui.banned.name.description": "Je huidige naam - \"%s\" - voldoet niet aan onze normen. Je kunt in singleplayer spelen, maar je moet je naam veranderen om online te kunnen spelen.\n\nLees meer of dien een herzieningsverzoek in via de volgende link: %s",
	"gui.banned.name.title": "Naam niet toegestaan in multiplayer",
	...
	"gui.banned.skin.description": "Je huidige skin voldoet niet aan onze normen. Je kunt nog steeds spelen met een standaard skin, of een nieuwe selecteren.\n\nLees meer of dien een herzieningsverzoek in via de volgende link: %s",
	...
	"gui.chatReport.discard.title": "Rapporten en opmerkingen verwijderen?",
	...
	"gui.copy_link_to_clipboard": "Link kopiëren naar klembord",
	"gui.days": "%s dag(en)",
	"gui.done": "Klaar",
	"gui.down": "Omlaag",
	"gui.entity_tooltip.type": "Type: %s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "%s bestanden afgewezen",
	...
	"gui.none": "Geen",
	"gui.ok": "Oké",
	"gui.open_report_dir": "Open rapportmap",
	"gui.packSelection.search": "Zoek...",
	...
	"gui.toRealms": "Terug naar lijst met Reams",
	"gui.toTitle": "Weeral naar het hoofdmenu",
	"gui.toWorld": "Terug naar Wereldlijst",
	"gui.togglable_slot": "Klik om het vak te deactiveren",
	"gui.up": "Omhoog",
	...
	"item.minecraft.angler_pottery_shard": "Angler Aardewerk Scherf",
	"item.minecraft.angler_pottery_sherd": "Angler Aardewerk Scherf",
	"item.minecraft.apple": "Appel",
	"item.minecraft.archer_pottery_shard": "Boogschutter Aardewerk Scherf",
	"item.minecraft.archer_pottery_sherd": "Archer Aardewerk Scherf",
	"item.minecraft.armadillo_scute": "Gordeldierschub",
	"item.minecraft.armadillo_spawn_egg": "Gordeldierspawnei",
	"item.minecraft.armor_stand": "Harnashouder",
	"item.minecraft.arms_up_pottery_shard": "Arms Up Aardewerk Scherf",
	"item.minecraft.arms_up_pottery_sherd": "Arms Up aardewerkscherf",
	...
	"item.minecraft.blade_pottery_shard": "Blade aardewerk scherf",
	"item.minecraft.blade_pottery_sherd": "Mes Aardewerk Scherf",
	...
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Bout Harnasversiering",
	"item.minecraft.bone": "Bot",
	"item.minecraft.bone_meal": "Beendermeel",
	"item.minecraft.book": "Boek",
	"item.minecraft.bordure_indented_banner_pattern": "Ingekorte Bordure Vlagpatroon",
	"item.minecraft.bow": "Boog",
	"item.minecraft.bowl": "Kom",
	"item.minecraft.bread": "Brood",
	"item.minecraft.breeze_rod": "Vlaagstaaf",
	"item.minecraft.breeze_spawn_egg": "Vlagenspawnei",
	"item.minecraft.brewer_pottery_shard": "Brouwer aardewerk scherf",
	"item.minecraft.brewer_pottery_sherd": "Brouwer aardewerk scherf",
	...
	"item.minecraft.bundle.empty.description": "Kan een gemengde stapel items bevatten",
	"item.minecraft.bundle.full": "Vol",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "Aardewerkscherf verbranden",
	"item.minecraft.burn_pottery_sherd": "Aardewerkscherf verbranden",
	...
	"item.minecraft.coast_armor_trim_smithing_template.new": "Kust Harnasversiering",
	...
	"item.minecraft.creeper_banner_pattern.new": "Creeperwapen Vlagpatroon",
	...
	"item.minecraft.crossbow.projectile.multiple": "Projectiel: %s x %s",
	"item.minecraft.crossbow.projectile.single": "Projectiel: %s",
	"item.minecraft.cyan_bundle": "Cyaan Bundel",
	"item.minecraft.cyan_dye": "Cyaan kleurstof",
	"item.minecraft.cyan_harness": "Turquoise tuig",
	"item.minecraft.danger_pottery_shard": "Gevaar Aardewerk Scherf",
	...
	"item.minecraft.dune_armor_trim_smithing_template.new": "Duin Harnasversiering",
	...
	"item.minecraft.explorer_pottery_shard": "Ontdekkingsreiziger Aardewerkscherf",
	"item.minecraft.explorer_pottery_sherd": "Ontdekkingsreiziger Aardewerkscherf",
	"item.minecraft.eye_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Oog Harnasversiering",
	...
	"item.minecraft.flow_armor_trim_smithing_template.new": "Windstroom Harnasversiering",
	"item.minecraft.flow_banner_pattern": "Vlagpatroon",
	"item.minecraft.flow_banner_pattern.desc": "Windstroom",
	"item.minecraft.flow_banner_pattern.new": "Windstroom Vlagpatroon",
	...
	"item.minecraft.flower_banner_pattern.new": "Bloemwapen Vlagpatroon",
	"item.minecraft.flower_pot": "Bloempot",
	"item.minecraft.fox_spawn_egg": "Vossenspawnei",
	"item.minecraft.friend_pottery_shard": "Vriend Aardewerkscherf",
	"item.minecraft.friend_pottery_sherd": "Vriend Aardewerkscherf",
	...
	"item.minecraft.heart_pottery_shard": "Hart Aardewerkscherf",
	"item.minecraft.heart_pottery_sherd": "Hart Aardewerkscherf",
	"item.minecraft.heartbreak_pottery_shard": "Gebrokenhart Aardewerkscherf",
	"item.minecraft.heartbreak_pottery_sherd": "Gebrokenhard Aardewerkscherf",
	...
	"item.minecraft.host_armor_trim_smithing_template.new": "Gastheer Harnasversiering",
	"item.minecraft.howl_pottery_shard": "Gehuil Aardewerkscherf",
	"item.minecraft.howl_pottery_sherd": "Gehuil Aardewerkscherf",
	...
	"item.minecraft.miner_pottery_shard": "Mijnwerker Aardewerkscherf",
	"item.minecraft.miner_pottery_sherd": "Mijnwerker Aardewerkscherf",
	...
	"item.minecraft.music_disc_relic": "Muziek schijf",
	...
	"item.minecraft.pottery_shard_prize": "Aardewerkscherf 'beloning'",
	...
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Heffer Harnasversiering",
	...
	"item.minecraft.rib_armor_trim_smithing_template.new": "Rib Harnasversiering",
	...
	"item.minecraft.scute": "Schub",
	"item.minecraft.sentry_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Wachtpost Harnasversiering",
	"item.minecraft.shaper_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Vormer Harnasversiering",
	...
	"item.minecraft.silence_armor_trim_smithing_template.new": "Stilte Harnasversiering",
	...
	"item.minecraft.snout_armor_trim_smithing_template.new": "Snoet Harnasversiering",
	...
	"item.minecraft.spire_armor_trim_smithing_template.new": "Spits Harnasversiering",
	...
	"item.minecraft.splash_potion.effect.wind_charged": "Spattende drank der windvlagen",
	...
	"item.minecraft.tide_armor_trim_smithing_template.new": "Getijden Harnasversiering",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Pijl van Besmetting",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Pijl van Slijmerigheid",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Pijl van Weven",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Pijl van Windvlagen",
	...
	"item.minecraft.turtle_scute": "Zeeschildpadschub",
	"item.minecraft.turtle_spawn_egg": "Schildpaddenspawnei",
	"item.minecraft.vex_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Ergernis Harnasversiering",
	...
	"item.minecraft.ward_armor_trim_smithing_template.new": "Wacht Harnasversiering",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Padvinder Harnasversiering",
	...
	"item.minecraft.wild_armor_trim_smithing_template.new": "Wilde Harnasversiering",
	...
	"item.minecraft.wolf_armor": "Wolfharnas",
	...
	"item.modifiers.any": "Wanneer uitgerust:",
	"item.modifiers.armor": "Wanneer gedragen:",
	"item.modifiers.body": "Wanneer uitgerust:",
	...
	"item.op_block_warning.line2": "Het gebruik van dit item kan leiden tot het uitvoeren van commando's",
	"item.op_block_warning.line3": "Gebruik dit niet tenzij je de exacte inhoud kent!",
	"item.spawn_egg.peaceful": "Op Vreedzaam uitgeschakeld",
	...
	"jigsaw_block.placement_priority.tooltip": "Wanneer dit Jigsaw-blok verbinding maakt met een stuk, is dit de volgorde waarin dat stuk wordt verwerkt voor verbindingen in de grotere structuur.\n\nDe stukken worden verwerkt op basis van prioriteit, van hoog naar laag, waarbij de volgorde van invoeging wordt gebruikt om gelijkwaardige prioriteiten te doorbreken.",
	"jigsaw_block.pool": "Bronpoel:",
	"jigsaw_block.selection_priority": "Selectieprioriteit:",
	"jigsaw_block.selection_priority.tooltip": "Wanneer het bovenliggende stuk wordt verwerkt voor verbindingen, is dit de volgorde waarin dit Jigsaw-blok probeert verbinding te maken met het doelstuk.\n\nJigsaws worden verwerkt op basis van aflopende prioriteit, waarbij willekeurige volgorde wordt gebruikt om gelijke gevallen door te breken.",
	...
	"key.debug.clearChat": "Chat leegmaken",
	"key.debug.copyLocation": "Locatie kopiëren",
	"key.debug.copyRecreateCommand": "Gegevens kopiëren",
	"key.debug.crash": "Debugcrash",
	"key.debug.debugOptions": "Debug Opties",
	"key.debug.dumpDynamicTextures": "Dynamische texturen weergeven",
	"key.debug.dumpVersion": "Versie informatie weergeven",
	"key.debug.focusPause": "Pauzeren bij focusverlies in-/uitschakelen",
	"key.debug.fpsCharts": "FPS grafiek",
	...
	"key.spectatorHotbar": "Selecteer op de hotbar",
	...
	"known_server_link.community_guidelines": "Gemeenschaps richtlijnen",
	...
	"known_server_link.status": "Toestand",
	...
	"manageServer.edit.title": "Serverinfo bewerken",
	"manageServer.enterIp": "Serveradres",
	"manageServer.enterName": "Servernaam",
	"manageServer.resourcePack": "Server Resource-pakketen",
	"manageServer.resourcePack.disabled": "Uitgeschakeld",
	"manageServer.resourcePack.enabled": "Ingeschakeld",
	"manageServer.resourcePack.prompt": "Invoerveld",
	"mco.account.privacy.info": "Lees meer over Mojang en de privacywetten",
	"mco.account.privacy.info.button": "Meer lezen over de GDPR",
	"mco.account.privacy.information": "Mojang voert bepaalde procedures uit om kinderen en hun privacy te beschermen, inclusief het naleven van de Children's Online Privacy Protection Act (COPPA) en de General Data Protection Regulation (GDPR).\n\nJe moet mogelijk toestemming van je ouders verkrijgen voordat je toegang krijgt tot je Realms-account.",
	...
	"mco.backup.entry.enabledPack": "Pakketten ingeschakeld",
	"mco.backup.entry.gameDifficulty": "Moeilijkheidsgraad",
	...
	"mco.backup.entry.worldType": "Werld type",
	...
	"mco.client.outdated.stable.version": "Je cliëntversie (%s) is niet compatibel met Realms.\n\nGebruik de nieuwste versie van Minecraft.",
	"mco.client.unsupported.snapshot.version": "Je cliëntversie (%s) is niet compatibel met Realms.\n\nRealms is niet beschikbaar voor deze snapshot-versie.",
	"mco.compatibility.downgrade": "Downgrade",
	"mco.compatibility.downgrade.description": "Deze wereld werd voor het laatst gespeeld in versie %s; je zit momenteel op versie %s. Het downgraden van een wereld kan corruptie veroorzaken - we kunnen niet garanderen dat deze zal laden of werken.\n\nEen back-up van je wereld wordt opgeslagen onder 'Wereldback-ups'. Herstel je wereld indien nodig.",
	"mco.compatibility.incompatible.popup.title": "Incompatibele versie",
	"mco.compatibility.incompatible.releaseType.popup.message": "De wereld die je probeert te betreden is niet compatibel met de versie die je hebt.",
	"mco.compatibility.incompatible.series.popup.message": "Deze wereld werd voor het laatst gespeeld in versie %s; je zit momenteel op versie %s.\n\nDeze versies zijn niet compatibel met elkaar. Een nieuwe wereld is nodig om op deze versie te spelen.",
	"mco.compatibility.unverifiable.message": "De versie waarin deze wereld voor het laatst werd gespeeld kon niet worden geverifieerd. Als de wereld wordt geüpgraded of gedowngrade, wordt er automatisch een back-up gemaakt en opgeslagen onder 'Wereldback-ups'.",
	"mco.compatibility.unverifiable.title": "Compatibiliteit niet verifieerbaar",
	"mco.compatibility.upgrade": "Upgrade",
	"mco.compatibility.upgrade.description": "Deze wereld werd voor het laatst gespeeld in versie %s; je speelt nu versie %s.\n\nEen back-up van je wereld zal opgeslagen worden onder \"Wereld Back-ups\".\n\nHerstel je wereld indien nodig.",
	"mco.compatibility.upgrade.friend.description": "Deze wereld werd voor het laatst gespeeld in versie %s; je gebruikt versie %s.\n\nEen back-up van de wereld wordt opgeslagen onder \"Wereldback-ups\".\n\nDe eigenaar van de Realm kan, wanneer nodig, de wereld herstellen.",
	...
	"mco.configure.world.buttons.region_preference": "Selecteer Regio...",
	...
	"mco.configure.world.resourcepack.question": "Je hebt een aangepast bronpakket nodig om op deze Realm te spelen.\n\nWil je het downloaden en spelen?",
	...
	"mco.configure.world.subscription.tab": "Abbonement",
	...
	"mco.create.world.subtitle": "Selecteer optioneel welke wereld je in je nieuwe realm wilt zetten",
	...
	"mco.download.confirmation.oversized": "De wereld die je gaat downloaden is groter dan %s\n\nJe zult deze wereld niet opnieuw naar je Realm kunnen uploaden",
	...
	"mco.download.resourcePack.fail": "Kan bronpakket niet downloaden!",
	...
	"mco.errorMessage.6006": "Wereld is voor een oudere versie",
	"mco.errorMessage.6007": "Gebruiker is lid van te veel Realms",
	"mco.errorMessage.6008": "Ongeldige Realmnaam",
	"mco.errorMessage.6009": "Ongeldige Realm omschrijving",
	...
	"mco.errorMessage.noDetails": "Geen foutinformatie beschikbaar",
	...
	"mco.errorMessage.realmsService.unknownCompatibility": "Kan niet op compatibele versie controleren: %s",
	...
	"mco.onlinePlayers": "Online spelers",
	...
	"mco.selectServer.configureRealm": "Realm aanpassen",
	...
	"mco.selectServer.popup": "Realms is een veilige en eenvoudige manier om te genieten van een onlinewereld met tot wel tien vrienden. Het bevat een groot aanbod aan minigames en meer dan genoeg unieke werelden! Alleen de eigenaar van de realm hoeft te betalen.",
	...
	"mco.time.minutesAgo": "%[1]s minuut(en) geleden",
	"mco.time.now": "direct",
	"mco.time.secondsAgo": "rechts n%[1]s seconde(n) geledenow",
	...
	"menu.custom_screen_info.contents": "De inhoud van dit scherm wordt beheerd door servers en werelden van een derde partij die niet eigendom is van, beheerd wordt door of onder toezicht staat van Mojang Studios of Microsoft. \nPas op! Wees steeds voorzichtig bij het volgen van links en geef nooit je persoonlijke informatie, inclusief aanmeldgegevens weg.\nAls dit scherm voorkomt dat je kunt spelen, kun je ook de verbinding met de huidige server verbreken door onderstaande knop te gebruiken.",
	...
	"multiplayer.confirm_command.parse_errors": "Je probeert een ongekende of ongeldige opdracht uit te voeren.\nWeet je het zeker?\nOpdracht:%s",
	...
	"multiplayer.confirm_command.signature_required": "U probeert een opdracht uit te voeren die een chatbericht stuurt op uw naam.\nZe kan alleen vanuit het chatscherm worden uitgevoerd.\nOpdracht: %s",
	...
	"multiplayer.disconnect.banned.reason.default": "Verbannen door een operator.",
	...
	"optimizeWorld.stage.finished.chunks": "Bezig met het upgraden van chunks...",
	"optimizeWorld.stage.finished.entities": "Bezig met het upgraden van entiteiten...",
	"optimizeWorld.stage.finished.poi": "Bezig met het upgraden van nuttige plaatsen...",
	"optimizeWorld.stage.upgrading": "Alle chunks bijwerken...",
	"optimizeWorld.stage.upgrading.chunks": "Alle chunks bijwerken...",
	"optimizeWorld.stage.upgrading.entities": "Alle entiteiten bijwerken...",
	"optimizeWorld.stage.upgrading.poi": "Alle nuttige plaatsen bijwerken...",
	...
	"options.accessibility.narrator_hotkey.mac.tooltip": "Staat de Verteller toe om in- en uitgeschakeld te worden met 'Ctrl+B'.",
	...
	"options.allowCursorChanges.tooltip": "Maakt het mogelijk dat de muiscursor van vorm verandert wanneer deze boven bepaalde UI-elementen staat.",
	...
	"options.chat.drafts": "Onverzonden chats opslaan",
	"options.chat.drafts.tooltip": "Onverzonden berichten worden opgeslagen en kunnen worden verzonden zodra de chat de volgende keer wordt geopend.",
	...
	"options.graphics.warning.cancel": "Stuur Mij Terug",
	...
	"options.hideLightningFlashes.tooltip": "Voorkomt dat bliksemschichten de lucht laten flitsen. De bliksem zelf zal nog steeds zichtbaar zijn.",
	"options.hideMatchedNames": "Op naam verbergen",
	"options.hideMatchedNames.tooltip": "Servers van derden kunnen chatberichten in niet-standaard formaten verzenden.\nAls deze optie is ingeschakeld, worden verborgen spelers gekoppeld op basis van de namen van de afzenders van de chat.",
	...
	"options.inactivityFpsLimit.afk.tooltip": "Beperkt beeldsnelheid tot 30 wanneer het spel langer dan een minuut geen speler invoer krijgt. Beperkt het verder tot 10 na 9 verdere minuten.",
	...
	"options.invertMouseX": "Inverteer muis X",
	"options.invertMouseY": "Inverteer muis Y",
	"options.japaneseGlyphVariants": "Japanse Glyph-varianten",
	"options.japaneseGlyphVariants.tooltip": "Gebruikt Japanse varianten van CJK-tekens in het standaardlettertype.",
	...
	"options.languageAccuracyWarning": "(Vertalingen zijn niet noodzakelijk 100%% nauwkeurig)",
	...
	"options.showSubtitles.tooltip": "Schakelt ondertiteling in voor geluiden die in het spel worden afgespeeld.",
	...
	"options.sprintWindow": "Sprintvenster",
	"options.sprintWindow.tooltip": "Tijdvenster in ticks waarin het dubbel tikken op de vooruit-toets sprint activeert.",
	...
	"options.video.quality.header": "Kwaliteit & Prestaties",
	"options.videoTitle": "Grafische instellingen",
	"options.viewBobbing": "Loopbeweging",
	"options.vignette": "Vignette tonen",
	"options.vignette.tooltip": "Dit is een onopvallende textuur aan de randen van het scherm die de helderheid daar verminderen en waarschuwen bij de wereldgrens.",
	"options.visible": "Zichtbaar",
	"options.vsync": "VSync",
	"options.weatherRadius": "Weereffectradius",
	"options.weatherRadius.tooltip": "Straal waarin regen- en sneeuweffecten zichtbaar zijn. Zeer kleine invloed op prestaties.",
	...
	"pack.dropRejected.message": "De volgende vermeldingen waren geen geldige paketten en zijn niet gekopieerd:\n%s",
	...
	"pack.incompatible.confirm.unknown": "Dit pakket is beschadigd of gemaakt voor een onbekende versie van Minecraft en werkt mogelijk niet correct.",
	...
	"pack.incompatible.unknown": "(beschadigd of incompatibel)",
	...
	"painting.minecraft.backyard.title": "Achtertuin",
	...
	"painting.minecraft.changing.title": "Wijziging",
	...
	"painting.minecraft.tides.title": "Getijden",
	...
	"quickplay.error.invalid_identifier": "Kon de wereld niet vinden met de verstrekte identifier",
	"quickplay.error.realm_connect": "Kan geen verbinding maken met Realm",
	"quickplay.error.realm_permission": "Geen toestemming om verbinding te maken met deze Realm",
	"quickplay.error.title": "Snel afspelen is mislukt",
	...
	"recover_world.bug_tracker": "Rapporteer een bug",
	"recover_world.button": "Probeer te herstellen",
	"recover_world.done.failed": "Herstel van de vorige toestand mislukt.",
	...
	"recover_world.restore": "Probeer te herstellen",
	"recover_world.restoring": "Poging om de wereld te herstellen...",
	...
	"restrictions_screen.permission.receive_player_messages.allowed": "Je kan berichten van spelers ontvangen",
	"restrictions_screen.permission.receive_player_messages.denied": "Je kan geen berichten van spelers ontvangen",
	"restrictions_screen.permission.receive_system_messages.allowed": "Je kan systeemberichten van de server ontvangen",
	"restrictions_screen.permission.receive_system_messages.denied": "Je kan geen systeemberichten van de server ontvangen",
	"restrictions_screen.permission.send_commands.allowed": "Je kan opdrachten versturen",
	"restrictions_screen.permission.send_commands.denied": "Je kan geen opdrachten versturen",
	"restrictions_screen.permission.send_messages.allowed": "Je kan chatberichten sturen",
	...
	"selectWorld.incompatible.description": "Deze wereld kan niet in deze versie geopend. Het werd het laatst in versie %s geopend.",
	...
	"slot.only_single_allowed": "Alleen enkelvoudige slots zijn toegestaan, '%s' gekregen",
	...
	"snbt.parser.expected_decimal_numeral": "Decimaal nummer verwacht",
	...
	"structure_block.detect_size": "Detecteer de structuur grote en positie:",
	...
	"subtitles.block.creaking_heart.spawn": "Schorshart ontwaakt",
	...
	"subtitles.block.shelf.activate": "Plank activeert",
	"subtitles.block.shelf.deactivate": "Plank deactiveert",
	"subtitles.block.shelf.multi_swap": "Voorwerpen wisselen",
	"subtitles.block.shelf.place_item": "Voorwerp geplaatst",
	"subtitles.block.shelf.single_swap": "Voorwerp wisselen",
	"subtitles.block.shelf.take_item": "Voorwerp opgepakt",
	...
	"subtitles.block.sniffer_egg.crack": "Snuffel Ei barst",
	"subtitles.block.sniffer_egg.hatch": "Snuffel Ei komt uit",
	"subtitles.block.sniffer_egg.plop": "Snuffel plopt",
	...
	"subtitles.block.trial_spawner.ambient": "Beproevingsspawner knettert",
	...
	"subtitles.block.trial_spawner.close_shutter": "Beproevingsspawner sluit",
	"subtitles.block.trial_spawner.detect_player": "Beproevingsspawner laadt op",
	"subtitles.block.trial_spawner.eject_item": "Beproevingsspawner spuwt voorwerpen uit",
	"subtitles.block.trial_spawner.ominous_activate": "Onheil neemt beproevingskooi in bezit",
	"subtitles.block.trial_spawner.open_shutter": "Beproevingsspawner opent",
	...
	"subtitles.block.trial_spawner.spawn_mob": "Wezen spawnt",
	...
	"subtitles.block.vault.activate": "Kluis vat vuur",
	"subtitles.block.vault.ambient": "Kluis is aan het breken",
	"subtitles.block.vault.close_shutter": "Kluis sluit",
	"subtitles.block.vault.deactivate": "Kluis wordt geblust",
	"subtitles.block.vault.eject_item": "Kluis geeft voorwerp",
	"subtitles.block.vault.insert_item": "Kluis ontgrendelt",
	"subtitles.block.vault.insert_item_fail": "Kan kluis niet ontgrendelen",
	"subtitles.block.vault.open_shutter": "Kluis gaat open",
	...
	"subtitles.chiseled_bookshelf.insert_enchanted": "Betoverd boek geplaatst",
	"subtitles.chiseled_bookshelf.take": "Boek wordt gepakt",
	"subtitles.chiseled_bookshelf.take_enchanted": "Betoverd boek genomen",
	...
	"subtitles.entity.armadillo.brush": "Armadillo borstels",
	...
	"subtitles.entity.armadillo.scute_drop": "Scute druppels",
	"subtitles.entity.armadillo.unroll_finish": "Gordeldier rolt uit",
	...
	"subtitles.entity.copper_golem.death": "Koperen golem sterft",
	"subtitles.entity.copper_golem.hurt": "Koperen Golem heeft pijn",
	"subtitles.entity.copper_golem.item_drop": "Koperen Golem is een voorwerp aan het plaatsen",
	"subtitles.entity.copper_golem.item_no_drop": "Koperen Golem kan het voorwerp niet plaatsen",
	"subtitles.entity.copper_golem.no_item_get": "Koperen Golem raapt een voorwerp op",
	"subtitles.entity.copper_golem.no_item_no_get": "Koperen Golem kan het voorwerp niet oprapen",
	"subtitles.entity.copper_golem.spawn": "Kopergolem verschijnt",
	"subtitles.entity.copper_golem.spin": "Het hoofd van de Koperen Golem draait",
	"subtitles.entity.copper_golem_become_statue": "Koperen Golem is versteend",
	"subtitles.entity.copper_golem_oxidized.death": "koperen Golem sterft",
	"subtitles.entity.copper_golem_oxidized.hurt": "Koperen Golem heeft pijn",
	"subtitles.entity.copper_golem_oxidized.spin": "Het hoofd van de Koperen Golem draait",
	"subtitles.entity.copper_golem_weathered.death": "Koperen Golem sterft",
	"subtitles.entity.copper_golem_weathered.hurt": "Koperen Golem heeft pijn",
	"subtitles.entity.copper_golem_weathered.spin": "Het hoofd van de Koperen Golem draait",
	...
	"subtitles.entity.creaking.spawn": "Schorswaker manifesteert zich",
	...
	"subtitles.entity.generic.wind_burst": "Wind vlaag spleit open",
	...
	"subtitles.entity.leash_knot.break": "Leiband Knoop breekt",
	"subtitles.entity.leash_knot.place": "Leiband knoop gebonden\n",
	...
	"subtitles.entity.polar_bear.ambient_baby": "Baby IJsbeer bromt",
	...
	"subtitles.entity.sniffer.egg_crack": "Snuffel Ei barst",
	"subtitles.entity.sniffer.egg_hatch": "Snuffel Ei komt uit",
	...
	"subtitles.entity.turtle.death_baby": "Zeeschildpadbaby sterft",
	...
	"subtitles.entity.turtle.hurt_baby": "Zeeschildpadbaby raakt gewond",
	"subtitles.entity.turtle.lay_egg": "Schildpad legt ei",
	"subtitles.entity.turtle.shamble": "Schildpad loopt langzaam",
	"subtitles.entity.turtle.shamble_baby": "Zeeschildpadbaby loopt langzaam",
	...
	"subtitles.item.armor.equip_copper": "Koperen harnas klettert",
	...
	"subtitles.item.shears.snip": "Scharen knippen",
	...
	"subtitles.weather.end_flash": "Einde-flits rommelt",
	"subtitles.weather.rain": "Regen valt",
	"symlink_warning.message": "Werelden laden vanuit mapjes met symbolische links kan onveilig zijn als je niet precies weet wat je doet. Bezoek %s om meer te leren.",
	...
	"symlink_warning.title": "Wereld mapje bevat symbolische koppelings",
	"symlink_warning.title.pack": "Toegevoegde inpakken(s) bevatten symbolische links",
	...
	"telemetry.event.advancement_made.description": "Het verstaan van de context achter het ontvangen van een advancement kan ons beter helpen verstaan en de progressie in het spel verbeteren.",
	"telemetry.event.advancement_made.title": "Vooruitgang gemaakt",
	...
	"telemetry.property.advancement_game_time.title": "Game-tijd (ticks)",
	...
	"telemetry.property.load_time_bootstrap_ms.title": "Bootstrap-tijd (milliseconden)",
	"telemetry.property.load_time_loading_overlay_ms.title": "Tijd in laadscherm (milliseconden)",
	"telemetry.property.load_time_pre_window_ms.title": "Tijd voordat venster wordt geopend (milliseconden)",
	...
	"telemetry.property.realms_map_content.title": "Realms-kaartinhoud (naam minigame)",
	...
	"test.error.block_property_missing": "Blokeigenschap ontbreekt; verwachtte %s voor eigenschap %s",
	...
	"test.error.sequence.minimum_tick": "“Te vroeg voltooid: verwachte tick %s”",
	...
	"test_instance.description.batch": "Groep: %s",
	...
	"trim_pattern.minecraft.bolt": "Bout Harnasversiering",
	"trim_pattern.minecraft.coast": "Kust Harnasversiering",
	"trim_pattern.minecraft.dune": "Duin Harnasversiering",
	"trim_pattern.minecraft.eye": "Oog Harnasversiering",
	"trim_pattern.minecraft.flow": "Windstroom Harnasversiering",
	"trim_pattern.minecraft.host": "Gastheer Harnasversiering",
	"trim_pattern.minecraft.raiser": "Heffer Harnasversiering",
	"trim_pattern.minecraft.rib": "Rib Harnasversiering",
	"trim_pattern.minecraft.sentry": "Wachtpost Harnasversiering",
	"trim_pattern.minecraft.shaper": "Vormer Harnasversiering",
	"trim_pattern.minecraft.silence": "Stilte Harnasversiering",
	"trim_pattern.minecraft.snout": "Snoet Harnasversiering",
	"trim_pattern.minecraft.spire": "Spits Harnasversiering",
	"trim_pattern.minecraft.tide": "Getijden Harnasversiering",
	"trim_pattern.minecraft.vex": "Ergernis Harnasversiering",
	"trim_pattern.minecraft.ward": "Wachter Harnasversiering",
	"trim_pattern.minecraft.wayfinder": "Padvinder Harnasversiering",
	"trim_pattern.minecraft.wild": "Wilde Harnasversiering",
