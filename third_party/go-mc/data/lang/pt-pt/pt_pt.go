// Code generated by tools/gen_lang.go from 26.1/pt_pt.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"accessibility.onboarding.screen.narrator": "Prime Enter para ativares a narração",
	"accessibility.onboarding.screen.title": "Bem-vindo ao Minecraft!\n\nQueres ativar a narração ou aceder às definições de acessibilidade?",
	...
	"advMode.notAllowed": "Tens de ser um operador no Modo Criativo",
	"advMode.notEnabled": "Blocos de comando desativados",
	"advMode.notEnabled.spawner": "Blocos de geração desativados",
	"advMode.previousOutput": "Resultado anterior",
	"advMode.setCommand": "Definir um comando da consola para o bloco",
	"advMode.setCommand.disabled": "Comando definido: %s, mas os blocos de comandos ainda estão desativados",
	...
	"advancements.adventure.arbalistic.description": "Mata cinco criaturas diferentes com um único tiro de Besta",
	...
	"advancements.adventure.blowback.description": "Mata um Vórtice com o seu próprio projétil",
	"advancements.adventure.blowback.title": "De vento em popa",
	"advancements.adventure.brush_armadillo.description": "Obtém as Escamas de um Tatu com um Pincel",
	"advancements.adventure.brush_armadillo.title": "Dar à pele",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Cria um Vaso com 4 Fragmentos de Cerâmica",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Restauração cuidadosa",
	"advancements.adventure.crafters_crafting_crafters.description": "Observa uma Mesa Automática a criar uma Mesa Automática",
	"advancements.adventure.crafters_crafting_crafters.title": "Henry Ford",
	"advancements.adventure.fall_from_world_height.description": "Cai do topo (limite de altura) até ao fundo do mundo e sobrevive",
	"advancements.adventure.fall_from_world_height.title": "Estrela cadente",
	"advancements.adventure.heart_transplanter.description": "Coloca um Coração de Rangente entre dois Troncos de Carvalho Pálido",
	...
	"advancements.adventure.honey_block_slide.description": "Salta para um Bloco de Mel para amparares a tua queda",
	...
	"advancements.adventure.lighten_up.description": "Raspa uma Lâmpada de Cobre com um Machado para a clareares",
	"advancements.adventure.lighten_up.title": "Luz de presença",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Entra numa Sala de Desafios",
	"advancements.adventure.minecraft_trials_edition.title": "Desafio aceite!",
	"advancements.adventure.ol_betsy.description": "Dispara uma Besta",
	"advancements.adventure.ol_betsy.title": "Arco do triunfo",
	"advancements.adventure.overoverkill.description": "Causa 50 corações de dano com um único golpe de uma Maça",
	"advancements.adventure.overoverkill.title": "Massacre",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Capta o sinal de Redstone de uma Estante de Livros Esculpida com um Comparador",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Saber é poder",
	"advancements.adventure.revaulting.description": "Abre um Cofre Sombrio com uma Chave de Desafio Sombria",
	"advancements.adventure.revaulting.title": "Câmara dos Segredos",
	"advancements.adventure.root.description": "Aventura, exploração e combate",
	"advancements.adventure.root.title": "Aventura",
	"advancements.adventure.salvage_sherd.description": "Escova um bloco suspeito e obtém um Fragmento de Cerâmica",
	"advancements.adventure.salvage_sherd.title": "Vestígios preciosos",
	...
	"advancements.adventure.spear_many_mobs.description": "Atinge cinco criaturas com uma investida de uma Lança",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Aplica os moldes de ferraria de Espiral, Focinho, Costelas, Profundezas, Silêncio, Vex, Marés e Procurador pelo menos uma vez",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Ferreiro estiloso",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Reveste uma armadura numa Mesa de Ferraria",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Um novo visual",
	...
	"advancements.adventure.under_lock_and_key.description": "Abre um Cofre com uma Chave de Desafio",
	"advancements.adventure.under_lock_and_key.title": "Fechado a sete chaves",
	"advancements.adventure.use_lodestone.description": "Usa uma Bússola numa Magnetite",
	"advancements.adventure.use_lodestone.title": "A minha alegre casinha",
	"advancements.adventure.very_very_frightening.description": "Atinge um Aldeão com um relâmpago",
	...
	"advancements.adventure.who_needs_rockets.description": "Usa um Projétil de Vento para te lançares 8 blocos no ar",
	"advancements.adventure.who_needs_rockets.title": "Salto em altura",
	"advancements.adventure.whos_the_pillager_now.description": "Dá a um Saqueador a provar o seu próprio veneno",
	"advancements.adventure.whos_the_pillager_now.title": "Praga!",
	"advancements.empty": "Isto está um bocado vazio por aqui...",
	"advancements.end.dragon_breath.description": "Usa um Frasco de Vidro para recolheres o Hálito do Dragão",
	...
	"advancements.end.elytra.description": "Encontra os Élitros",
	...
	"advancements.end.levitate.description": "Sobe 50 blocos com os ataques de um Shulker",
	...
	"advancements.husbandry.feed_snifflet.description": "Alimenta um Farejador Bebé",
	"advancements.husbandry.feed_snifflet.title": "Pequenos odores",
	...
	"advancements.husbandry.netherite_hoe.description": "Usa um Lingote de Netherite para melhorares uma Enxada e reavalia as tuas escolhas de vida",
	"advancements.husbandry.netherite_hoe.title": "Mão inchada",
	"advancements.husbandry.obtain_sniffer_egg.description": "Obtém um Ovo de Farejador",
	"advancements.husbandry.obtain_sniffer_egg.title": "Meter o nariz",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Coloca um Ghast Seco na água",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Duche de água fria",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Planta uma semente de um Farejador",
	"advancements.husbandry.plant_any_sniffer_seed.title": "Paleobotânico",
	"advancements.husbandry.plant_seed.description": "Planta uma Semente e vê-a crescer",
	"advancements.husbandry.plant_seed.title": "À mão de semear",
	"advancements.husbandry.remove_wolf_armor.description": "Remove a Armadura de um Lobo com uma Tesoura",
	"advancements.husbandry.remove_wolf_armor.title": "Tarefa delicada",
	"advancements.husbandry.repair_wolf_armor.description": "Repara a Armadura de um Lobo com Escamas de Tatu",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Usa uma Fogueira para recolheres Mel de uma Colmeia com um Frasco de Vidro, sem provocares as Abelhas",
	"advancements.husbandry.safely_harvest_honey.title": "Abelhudo",
	"advancements.husbandry.silk_touch_nest.description": "Move uma Colmeia, natural ou artificial, com 3 Abelhas no interior usando Toque de Seda",
	...
	"advancements.husbandry.uh_oh.description": "Faz um Cubo de Enxofre absorver um bloco de TNT",
	"advancements.husbandry.uh_oh.title": "Má ideia",
	...
	"advancements.husbandry.whole_pack.description": "Domestica todos os tipos de Lobos",
	"advancements.husbandry.whole_pack.title": "Reunir o grupo",
	...
	"advancements.nether.charge_respawn_anchor.description": "Carrega uma Âncora de Renascimento ao nível máximo",
	...
	"advancements.nether.create_full_beacon.description": "Carrega um Sinalizador ao nível máximo",
	"advancements.nether.create_full_beacon.title": "A grande pirâmide",
	"advancements.nether.distract_piglin.description": "Distrai um Piglin com ouro",
	...
	"advancements.nether.fast_travel.description": "Usa o Nether para viajares 7 km na Superfície",
	...
	"advancements.nether.get_wither_skull.description": "Obtém o crânio de um Esqueleto do Wither",
	...
	"advancements.story.cure_zombie_villager.description": "Enfraquece e cura um Aldeão Zombie",
	...
	"advancements.story.smelt_iron.description": "Funde um Lingote de Ferro",
	...
	"argument.double.big": "O valor double não deve ser superior a %s (encontrado: %s)",
	"argument.double.low": "O valor double não deve ser inferior a %s (encontrado: %s)",
	...
	"argument.entity.options.inapplicable": "A opção \"%s\" não se aplica aqui",
	...
	"argument.entity.options.limit.toosmall": "O limite deve ser pelo menos 1",
	...
	"argument.entity.options.team.description": "Entidades numa determinada equipa",
	...
	"argument.entity.selector.missing": "Tipo de seletor em falta",
	...
	"argument.entity.toomany": "Só é permitida uma entidade, mas o seletor usado permite mais do que uma",
	"argument.enum.invalid": "Valor inválido: %s",
	"argument.float.big": "O valor float não deve ser superior a %s (encontrado: %s)",
	"argument.float.low": "O valor float não deve ser inferior a %s (encontrado: %s)",
	...
	"argument.integer.big": "O número inteiro não deve ser superior a %s (encontrado: %s)",
	"argument.integer.low": "O número inteiro não deve ser inferior a %s (encontrado: %s)",
	...
	"argument.long.big": "O valor long não deve ser superior a %s (encontrado: %s)",
	"argument.long.low": "O valor long não deve ser inferior a %s (encontrado: %s)",
	"argument.message.too_long": "A mensagem é demasiado longa (%s > máximo de %s caracteres)",
	"argument.nbt.array.invalid": "Tipo de matriz inválido: %s",
	"argument.nbt.array.mixed": "Não foi possível inserir %s em %s",
	"argument.nbt.expected.compound": "Espera-se uma etiqueta composta",
	...
	"argument.player.entities": "Este comando só afeta jogadores, mas o seletor usado inclui entidades",
	"argument.player.toomany": "Só é permitido um jogador, mas o seletor usado permite mais do que um",
	"argument.player.unknown": "O jogador não existe",
	...
	"argument.resource_or_id.invalid": "ID ou etiqueta inválida",
	"argument.resource_or_id.no_such_element": "Não foi possível encontrar o elemento \"%s\" no registo \"%s\"",
	"argument.resource_selector.not_found": "Nenhuma correspondência para o seletor \"%s\" de tipo \"%s\"",
	"argument.resource_tag.invalid_type": "A etiqueta \"%s\" contém um tipo \"%s\" errado (espera-se \"%s\")",
	...
	"argument.time.tick_count_too_low": "O número de tiques não deve ser inferior a %s (encontrado: %s)",
	...
	"arguments.item.component.repeated": "O componente %s está repetido, mas só pode ser especificado um valor",
	...
	"arguments.nbtpath.too_deep": "NBT resultante profundamente aninhado",
	...
	"arguments.swizzle.invalid": "Eixos inválidos. Espera-se uma combinação de \"x\", \"y\" e \"z\"",
	...
	"attribute.name.bounciness": "Elasticidade",
	"attribute.name.burning_time": "Tempo a arder",
	"attribute.name.camera_distance": "Distância da câmara",
	...
	"attribute.name.follow_range": "Alcance de seguimento das criaturas",
	...
	"attribute.name.generic.burning_time": "Tempo a arder",
	...
	"attribute.name.generic.oxygen_bonus": "Bónus de oxigénio",
	...
	"attribute.name.oxygen_bonus": "Bónus de oxigénio",
	...
	"attribute.name.player.sneaking_speed": "Velocidade ao agachar",
	"attribute.name.player.submerged_mining_speed": "Velocidade de mineração submersa",
	"attribute.name.player.sweeping_damage_ratio": "Taxa de dano em área",
	"attribute.name.safe_fall_distance": "Distância de queda segura",
	"attribute.name.scale": "Escala",
	"attribute.name.sneaking_speed": "Velocidade ao agachar",
	"attribute.name.spawn_reinforcements": "Reforços de zombies",
	"attribute.name.step_height": "Altura dos passos",
	"attribute.name.submerged_mining_speed": "Velocidade de mineração submersa",
	"attribute.name.sweeping_damage_ratio": "Taxa de dano em área",
	...
	"attribute.name.waypoint_receive_range": "Alcance de receção do marcador",
	...
	"biome.minecraft.snowy_plains": "Planícies geladas",
	"biome.minecraft.snowy_slopes": "Encostas geladas",
	...
	"block.minecraft.attached_melon_stem": "Caule com Melancia Unido",
	"block.minecraft.attached_pumpkin_stem": "Caule com Abóbora Unido",
	...
	"block.minecraft.banner.border.brown": "Bordadura Castanha",
	"block.minecraft.banner.border.cyan": "Bordadura Cíano",
	"block.minecraft.banner.border.gray": "Bordadura Cinzenta",
	"block.minecraft.banner.border.green": "Bordadura Verde",
	"block.minecraft.banner.border.light_blue": "Bordadura Azul-Clara",
	"block.minecraft.banner.border.light_gray": "Bordadura Cinzento-Clara",
	"block.minecraft.banner.border.lime": "Bordadura Verde-Lima",
	...
	"block.minecraft.banner.creeper.brown": "Figura de Creeper Castanho",
	"block.minecraft.banner.creeper.cyan": "Figura de Creeper Cíano",
	"block.minecraft.banner.creeper.gray": "Figura de Creeper Cinzento",
	...
	"block.minecraft.banner.creeper.light_gray": "Figura de Creeper Cinzento-Claro",
	...
	"block.minecraft.banner.cross.brown": "Aspa Castanha",
	"block.minecraft.banner.cross.cyan": "Aspa Cíano",
	"block.minecraft.banner.cross.gray": "Aspa Cinzenta",
	"block.minecraft.banner.cross.green": "Aspa Verde",
	"block.minecraft.banner.cross.light_blue": "Aspa Azul-Clara",
	"block.minecraft.banner.cross.light_gray": "Aspa Cinzento-Clara",
	...
	"block.minecraft.banner.curly_border.brown": "Bordadura Dentada Castanha",
	"block.minecraft.banner.curly_border.cyan": "Bordadura Dentada Cíano",
	"block.minecraft.banner.curly_border.gray": "Bordadura Dentada Cinzenta",
	...
	"block.minecraft.banner.curly_border.light_gray": "Bordadura Dentada Cinzento-Clara",
	"block.minecraft.banner.curly_border.lime": "Bordadura Dentada Verde-Lima",
	...
	"block.minecraft.banner.flow.brown": "Espiral Castanha",
	"block.minecraft.banner.flow.cyan": "Espiral Cíano",
	"block.minecraft.banner.flow.gray": "Espiral Cinzenta",
	"block.minecraft.banner.flow.green": "Espiral Verde",
	"block.minecraft.banner.flow.light_blue": "Espiral Azul-Clara",
	"block.minecraft.banner.flow.light_gray": "Espiral Cinzento-Clara",
	"block.minecraft.banner.flow.lime": "Espiral Verde-Lima",
	...
	"block.minecraft.banner.flower.black": "Figura de Flor Preta",
	"block.minecraft.banner.flower.blue": "Figura de Flor Azul",
	"block.minecraft.banner.flower.brown": "Figura de Flor Castanha",
	"block.minecraft.banner.flower.cyan": "Figura de Flor Cíano",
	"block.minecraft.banner.flower.gray": "Figura de Flor Cinzenta",
	"block.minecraft.banner.flower.green": "Figura de Flor Verde",
	"block.minecraft.banner.flower.light_blue": "Figura de Flor Azul-Clara",
	"block.minecraft.banner.flower.light_gray": "Figura de Flor Cinzento-Clara",
	"block.minecraft.banner.flower.lime": "Figura de Flor Verde-Lima",
	"block.minecraft.banner.flower.magenta": "Figura de Flor Magenta",
	"block.minecraft.banner.flower.orange": "Figura de Flor Laranja",
	"block.minecraft.banner.flower.pink": "Figura de Flor Rosa",
	"block.minecraft.banner.flower.purple": "Figura de Flor Roxa",
	"block.minecraft.banner.flower.red": "Figura de Flor Vermelha",
	"block.minecraft.banner.flower.white": "Figura de Flor Branca",
	"block.minecraft.banner.flower.yellow": "Figura de Flor Amarela",
	...
	"block.minecraft.banner.guster.brown": "Vórtice Castanho",
	"block.minecraft.banner.guster.cyan": "Vórtice Cíano",
	"block.minecraft.banner.guster.gray": "Vórtice Cinzento",
	"block.minecraft.banner.guster.green": "Vórtice Verde",
	"block.minecraft.banner.guster.light_blue": "Vórtice Azul-Claro",
	"block.minecraft.banner.guster.light_gray": "Vórtice Cinzento-Claro",
	"block.minecraft.banner.guster.lime": "Vórtice Verde-Lima",
	...
	"block.minecraft.banner.skull.black": "Figura de Caveira Preta",
	"block.minecraft.banner.skull.blue": "Figura de Caveira Azul",
	"block.minecraft.banner.skull.brown": "Figura de Caveira Castanha",
	"block.minecraft.banner.skull.cyan": "Figura de Caveira Cíano",
	"block.minecraft.banner.skull.gray": "Figura de Caveira Cinzenta",
	"block.minecraft.banner.skull.green": "Figura de Caveira Verde",
	"block.minecraft.banner.skull.light_blue": "Figura de Caveira Azul-Clara",
	"block.minecraft.banner.skull.light_gray": "Figura de Caveira Cinzento-Clara",
	"block.minecraft.banner.skull.lime": "Figura de Caveira Verde-Lima",
	"block.minecraft.banner.skull.magenta": "Figura de Caveira Magenta",
	"block.minecraft.banner.skull.orange": "Figura de Caveira Laranja",
	"block.minecraft.banner.skull.pink": "Figura de Caveira Rosa",
	"block.minecraft.banner.skull.purple": "Figura de Caveira Roxa",
	"block.minecraft.banner.skull.red": "Figura de Caveira Vermelha",
	"block.minecraft.banner.skull.white": "Figura de Caveira Branca",
	"block.minecraft.banner.skull.yellow": "Figura de Caveira Amarela",
	...
	"block.minecraft.brain_coral_fan": "Gorgónia-de-Cérebro",
	"block.minecraft.brain_coral_wall_fan": "Gorgónia-de-Cérebro de Parede",
	...
	"block.minecraft.bubble_coral_fan": "Gorgónia-de-Bolha",
	"block.minecraft.bubble_coral_wall_fan": "Gorgónia-de-Bolha de Parede",
	"block.minecraft.budding_amethyst": "Drusa de Ametista",
	"block.minecraft.bush": "Arbusto",
	"block.minecraft.cactus": "Cato",
	"block.minecraft.cactus_flower": "Flor de Cato",
	...
	"block.minecraft.cherry_hanging_sign": "Tabuleta Pendurada de Cerejeira",
	...
	"block.minecraft.cherry_sapling": "Rebento de Cerejeira",
	"block.minecraft.cherry_shelf": "Estante de Cerejeira",
	"block.minecraft.cherry_sign": "Tabuleta de Cerejeira",
	"block.minecraft.cherry_slab": "Degrau de Cerejeira",
	"block.minecraft.cherry_stairs": "Escadas de Cerejeira",
	"block.minecraft.cherry_trapdoor": "Alçapão de Cerejeira",
	"block.minecraft.cherry_wall_hanging_sign": "Tabuleta Pendurada de Cerejeira de Parede",
	"block.minecraft.cherry_wall_sign": "Tabuleta de Cerejeira de Parede",
	...
	"block.minecraft.chiseled_cinnabar": "Cinábrio Esculpido",
	"block.minecraft.chiseled_copper": "Cobre Esculpido",
	...
	"block.minecraft.chiseled_resin_bricks": "Tijolos de Resina Esculpidos",
	"block.minecraft.chiseled_sandstone": "Arenito Esculpido",
	"block.minecraft.chiseled_stone_bricks": "Tijolos de Pedra Esculpidos",
	"block.minecraft.chiseled_sulfur": "Enxofre Esculpido",
	"block.minecraft.chiseled_tuff": "Tufo Esculpido",
	"block.minecraft.chiseled_tuff_bricks": "Tijolos de Tufo Esculpidos",
	"block.minecraft.chorus_flower": "Flor do Coro",
	"block.minecraft.chorus_plant": "Planta do Coro",
	"block.minecraft.cinnabar": "Cinábrio",
	"block.minecraft.cinnabar_brick_slab": "Degrau de Tijolos de Cinábrio",
	...
	"block.minecraft.cinnabar_slab": "Degrau de Cinábrio",
	...
	"block.minecraft.closed_eyeblossom": "Olheira Fechada",
	...
	"block.minecraft.crafter": "Mesa Automática",
	...
	"block.minecraft.dead_brain_coral_fan": "Gorgónia-de-Cérebro Morta",
	"block.minecraft.dead_brain_coral_wall_fan": "Gorgónia-de-Cérebro de Parede Morta",
	...
	"block.minecraft.dead_bubble_coral_fan": "Gorgónia-de-Bolha Morta",
	"block.minecraft.dead_bubble_coral_wall_fan": "Gorgónia-de-Bolha Morta de Parede",
	...
	"block.minecraft.dead_fire_coral_wall_fan": "Gorgónia-de-Fogo Morta de Parede",
	...
	"block.minecraft.dead_horn_coral_wall_fan": "Gorgónia-Corno-de-Cervo Morta de Parede",
	...
	"block.minecraft.dead_tube_coral_wall_fan": "Gorgónia-Tubular Morta de Parede",
	...
	"block.minecraft.exposed_chiseled_copper": "Cobre Esculpido Exposto",
	...
	"block.minecraft.firefly_bush": "Arbusto com Pirilampos",
	...
	"block.minecraft.jungle_hanging_sign": "Tabuleta Pendurada da Selva",
	...
	"block.minecraft.jungle_sign": "Tabuleta da Selva",
	"block.minecraft.jungle_slab": "Degrau da Selva",
	"block.minecraft.jungle_stairs": "Escadas da Selva",
	"block.minecraft.jungle_trapdoor": "Alçapão da Selva",
	"block.minecraft.jungle_wall_hanging_sign": "Tabuleta Pendurada da Selva de Parede",
	"block.minecraft.jungle_wall_sign": "Tabuleta da Selva de Parede",
	...
	"block.minecraft.leaf_litter": "Folhagem",
	...
	"block.minecraft.open_eyeblossom": "Olheira Aberta",
	...
	"block.minecraft.oxidized_chiseled_copper": "Cobre Esculpido Oxidado",
	...
	"block.minecraft.pale_oak_hanging_sign": "Tabuleta Pendurada de Carvalho Pálido",
	...
	"block.minecraft.pale_oak_sapling": "Rebento de Carvalho Pálido",
	"block.minecraft.pale_oak_shelf": "Estante de Carvalho Pálido",
	"block.minecraft.pale_oak_sign": "Tabuleta de Carvalho Pálido",
	"block.minecraft.pale_oak_slab": "Degrau de Carvalho Pálido",
	"block.minecraft.pale_oak_stairs": "Escadas de Carvalho Pálido",
	"block.minecraft.pale_oak_trapdoor": "Alçapão de Carvalho Pálido",
	"block.minecraft.pale_oak_wall_hanging_sign": "Tabuleta Pendurada de Carvalho Pálido de Parede",
	"block.minecraft.pale_oak_wall_sign": "Tabuleta de Carvalho Pálido de Parede",
	...
	"block.minecraft.pitcher_crop": "Plantação de Cântara",
	"block.minecraft.pitcher_plant": "Cântara",
	...
	"block.minecraft.polished_blackstone_brick_stairs": "Escadas de Tijolos de Negrito Polido",
	...
	"block.minecraft.polished_cinnabar_slab": "Degrau de Cinábrio Polido",
	...
	"block.minecraft.polished_sulfur_slab": "Degrau de Enxofre Polido",
	...
	"block.minecraft.polished_tuff_slab": "Degrau de Tufo Polido",
	...
	"block.minecraft.potted_cherry_sapling": "Rebento de Cerejeira num Vaso",
	"block.minecraft.potted_closed_eyeblossom": "Olheira Fechada num Vaso",
	...
	"block.minecraft.potted_golden_dandelion": "Dente-de-Leão Dourado num Vaso",
	"block.minecraft.potted_jungle_sapling": "Rebento da Selva num Vaso",
	...
	"block.minecraft.potted_open_eyeblossom": "Olheira Aberta num Vaso",
	"block.minecraft.potted_orange_tulip": "Tulipa Laranja num Vaso",
	"block.minecraft.potted_oxeye_daisy": "Margarida num Vaso",
	"block.minecraft.potted_pale_oak_sapling": "Rebento de Carvalho Pálido num Vaso",
	...
	"block.minecraft.potted_spruce_sapling": "Rebento de Pícea num Vaso",
	"block.minecraft.potted_torchflower": "Fagulheira num Vaso",
	...
	"block.minecraft.resin_brick_slab": "Degrau de Tijolos de Resina",
	...
	"block.minecraft.resin_clump": "Torrão de Resina",
	...
	"block.minecraft.set_spawn": "Local de renascimento definido",
	"block.minecraft.short_dry_grass": "Relva Seca Baixa",
	"block.minecraft.short_grass": "Relva Baixa",
	...
	"block.minecraft.sulfur_brick_slab": "Degrau de Tijolos de Enxofre",
	...
	"block.minecraft.sulfur_slab": "Degrau de Enxofre",
	...
	"block.minecraft.tnt.disabled": "As explosões de TNT estão desativadas",
	"block.minecraft.torch": "Tocha",
	"block.minecraft.torchflower": "Fagulheira",
	"block.minecraft.torchflower_crop": "Plantação de Fagulheira",
	"block.minecraft.trapped_chest": "Baú Armadilhado",
	"block.minecraft.trial_spawner": "Gerador Reforçado",
	...
	"block.minecraft.tuff_brick_slab": "Degrau de Tijolos de Tufo",
	...
	"block.minecraft.tuff_slab": "Degrau de Tufo",
	...
	"block.minecraft.warped_shelf": "Estante Deformada",
	...
	"block.minecraft.waxed_chiseled_copper": "Cobre Esculpido Encerado",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Cobre Esculpido Exposto Encerado",
	...
	"block.minecraft.waxed_oxidized_chiseled_copper": "Cobre Esculpido Oxidado Encerado",
	...
	"block.minecraft.waxed_weathered_chiseled_copper": "Cobre Esculpido Corroído Encerado",
	"block.minecraft.waxed_weathered_copper": "Cobre Corroído Encerado",
	"block.minecraft.waxed_weathered_copper_bars": "Barras de Cobre Corroído Encerado",
	"block.minecraft.waxed_weathered_copper_bulb": "Lâmpada de Cobre Corroído Encerado",
	"block.minecraft.waxed_weathered_copper_chain": "Corrente de Cobre Corroído Encerado",
	"block.minecraft.waxed_weathered_copper_chest": "Baú de Cobre Corroído Encerado",
	"block.minecraft.waxed_weathered_copper_door": "Porta de Cobre Corroído Encerado",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Estátua de Golem de Cobre Corroído Encerado",
	"block.minecraft.waxed_weathered_copper_grate": "Grade de Cobre Corroído Encerado",
	"block.minecraft.waxed_weathered_copper_lantern": "Lanterna de Cobre Corroído Encerado",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Alçapão de Cobre Corroído Encerado",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Para-Raios Corroído Encerado",
	"block.minecraft.weathered_chiseled_copper": "Cobre Esculpido Corroído",
	"block.minecraft.weathered_copper": "Cobre Corroído",
	"block.minecraft.weathered_copper_bars": "Barras de Cobre Corroído",
	"block.minecraft.weathered_copper_bulb": "Lâmpada de Cobre Corroído",
	"block.minecraft.weathered_copper_chain": "Corrente de Cobre Corroído",
	"block.minecraft.weathered_copper_chest": "Baú de Cobre Corroído",
	"block.minecraft.weathered_copper_door": "Porta de Cobre Corroído",
	"block.minecraft.weathered_copper_golem_statue": "Estátua de Golem de Cobre Corroído",
	"block.minecraft.weathered_copper_grate": "Grade de Cobre Corroído",
	"block.minecraft.weathered_copper_lantern": "Lanterna de Cobre Corroído",
	"block.minecraft.weathered_copper_trapdoor": "Alçapão de Cobre Corroído",
	...
	"block.minecraft.weathered_lightning_rod": "Para-Raios Corroído",
	...
	"block.minecraft.wither_skeleton_skull": "Crânio de Esqueleto do Wither",
	"block.minecraft.wither_skeleton_wall_skull": "Crânio de Esqueleto do Wither de Parede",
	...
	"book.edit.title": "Ecrã de edição do livro",
	"book.editTitle": "Título do livro:",
	"book.finalizeButton": "Assinar e fechar",
	"book.finalizeWarning": "Nota! Quando assinares o livro, já não o irás poder editar.",
	...
	"book.page_button.next": "Página seguinte",
	"book.page_button.previous": "Página anterior",
	"book.sign.title": "Ecrã de assinatura do livro",
	"book.sign.titlebox": "Título",
	"book.signButton": "Assinar",
	"book.view.title": "Ecrã de visualização do livro",
	"build.spawn_protection": "%s está sob a proteção da área de aparição",
	...
	"chat.disabled.chain_broken": "Chat desativado devido a uma corrente de mensagens corrompida. Tenta restabelecer a ligação.",
	"chat.disabled.expiredProfileKey": "A chave pública do perfil expirou e o chat foi desativado. Tenta restabelecer a ligação.",
	"chat.disabled.invalid_command_signature": "O comando tinha assinaturas de argumentos inesperadas ou em falta.",
	"chat.disabled.invalid_signature": "A assinatura do chat é inválida. Tenta restabelecer a ligação.",
	"chat.disabled.launcher": "Chat desativado nas definições do Launcher. Não é possível enviar mensagens.",
	...
	"chat.disabled.out_of_order_chat": "Foi recebido um pacote de chat corrompido. Alteraste as horas do sistema?",
	"chat.disabled.profile": "Chat desativado nas definições da conta. Prime \"%s\" para saberes mais.",
	"chat.disabled.profile.moreInfo": "Chat desativado nas definições da conta. Não é possível enviar ou ver mensagens.",
	"chat.editBox": "chat",
	...
	"chat.queue": "[+%s linha(s) pendentes]",
	"chat.queue.tooltip": "Clica para mostrar a próxima mensagem",
	...
	"chat.type.advancement.task": "%s adquiriu a proeza %s",
	...
	"chat_restriction.chat_and_commands_disabled_by_options": "Chat bloqueado nas definições do cliente.",
	"chat_restriction.chat_disabled_by_options": "Chat de jogadores bloqueado nas definições do cliente.",
	"chat_restriction.chat_disabled_by_options.action": "Ir para as definições do chat",
	"chat_restriction.disabled_by_launcher": "Chat bloqueado pelo Launcher.",
	"chat_restriction.disabled_by_profile": "Chat bloqueado nas definições do perfil.",
	"chat_restriction.disabled_by_profile.action": "Ir para as definições do perfil",
	"chat_screen.commands_not_allowed": "Envio de comandos bloqueado",
	"chat_screen.message": "Mensagem a ser enviada: %s",
	"chat_screen.messages_not_allowed": "Envio de mensagens de chat bloqueado",
	"chat_screen.restricted": "Chat bloqueado. Clica nesta mensagem para saberes mais.",
	"chat_screen.restricted.narration": "Chat bloqueado. Acede ao menu de Restrições nas Opções do mundo.",
	"chat_screen.title": "Ecrã de chat",
	"chat_screen.usage": "Escreve uma mensagem e prime Enter para a enviares",
	"chunk.toast.checkLog": "Vê o registo para saberes mais",
	"chunk.toast.loadFailure": "Falha ao carregar o chunk em %s",
	"chunk.toast.lowDiskSpace": "Pouco espaço no disco!",
	"chunk.toast.lowDiskSpace.description": "Pode não ser possível guardar o mundo.",
	"chunk.toast.saveFailure": "Falha ao guardar o chunk em %s",
	...
	"command.expected.separator": "Espera-se um espaço vazio para concluir um argumento, mas foram encontrados dados adicionais",
	...
	"command.trailing_data": "Dados adicionais encontrados: %s",
	...
	"commands.advancement.grant.criterion.to.many.success": "Critério \"%s\" da proeza %s concedido a %s jogadores",
	...
	"commands.advancement.revoke.criterion.to.many.success": "Critério \"%s\" da proeza %s retirado de %s jogadores",
	...
	"commands.advancement.revoke.criterion.to.one.success": "Critério \"%s\" da proeza %s retirado de %s",
	...
	"commands.banip.failed": "Nada mudou. O endereço IP já está bloqueado",
	"commands.banip.info": "Este banimento afeta %s jogador(es): %s",
	"commands.banip.invalid": "Endereço IP inválido ou jogador desconhecido",
	"commands.banip.success": "Endereço IP %s bloqueado: %s",
	"commands.banlist.entry": "%[2]s baniu %[1]s: %[3]s",
	"commands.banlist.entry.unknown": "(Desconhecida)",
	"commands.banlist.list": "Há %s jogador(es) banido(s):",
	"commands.banlist.none": "Não há jogadores banidos",
	"commands.bossbar.create.failed": "Já há uma barra de chefe com o ID \"%s\"",
	...
	"commands.bossbar.get.players.none": "A barra de chefe personalizada %s não tem jogadores online",
	"commands.bossbar.get.players.some": "A barra de chefe personalizada %s tem %s jogador(es) online: %s",
	...
	"commands.bossbar.list.bars.none": "Não há barras de chefe personalizadas ativas",
	...
	"commands.bossbar.set.name.success": "Nome da barra de chefe personalizada %s alterado",
	"commands.bossbar.set.name.unchanged": "Nada mudou. Esse já é o nome da barra de chefe",
	"commands.bossbar.set.players.success.none": "A barra de chefe personalizada %s não tem jogadores",
	"commands.bossbar.set.players.success.some": "A barra de chefe personalizada %s tem %s jogador(es): %s",
	"commands.bossbar.set.players.unchanged": "Nada mudou. Os jogadores já estão na barra de chefe sem ninguém para adicionar ou remover",
	...
	"commands.data.block.modified": "Dados do bloco em %s, %s, %s alterados",
	...
	"commands.data.entity.modified": "Dados da entidade %s alterados",
	...
	"commands.data.storage.modified": "Armazenamento %s alterado",
	"commands.data.storage.query": "O armazenamento %s contém: %s",
	"commands.datapack.create.already_exists": "Já há um pacote com o nome \"%s\"",
	...
	"commands.datapack.create.io_failure": "Não foi possível criar um pacote com o nome \"%s\". Verifica os registos",
	"commands.datapack.create.metadata_encode_failure": "Falha ao codificar os metadados do pacote com o nome \"%s\": %s",
	"commands.datapack.create.success": "Um pacote vazio com o nome \"%s\" foi criado",
	"commands.datapack.disable.failed": "O pacote de dados \"%s\" não está ativado!",
	"commands.datapack.disable.failed.feature": "Não é possível desativar o pacote \"%s\" porque pertence a uma variável ativa!",
	...
	"commands.datapack.list.available.none": "Não há pacotes de dados disponíveis",
	"commands.datapack.list.available.success": "Há %s pacote(s) de dado(s) disponível(is): %s",
	"commands.datapack.list.enabled.none": "Não há pacotes de dados ativados",
	"commands.datapack.list.enabled.success": "Há %s pacote(s) de dado(s) ativo(s): %s",
	...
	"commands.debug.function.success.multiple": "%s comando(s) rastreado(s) de %s funções para o ficheiro de saída %s",
	"commands.debug.function.success.single": "%s comando(s) rastreado(s) da função \"%s\" para o ficheiro de saída %s",
	...
	"commands.defaultgamemode.success": "O modo de jogo predefinido foi definido para %s",
	...
	"commands.dialog.show.multiple": "Diálogo mostrado para %s jogadores",
	"commands.dialog.show.single": "Diálogo mostrado para %s",
	...
	"commands.effect.clear.everything.success.multiple": "Todos os efeitos foram removidos de %s alvos",
	"commands.effect.clear.everything.success.single": "Todos os efeitos foram removidos de %s",
	"commands.effect.clear.specific.failed": "O alvo não tem o efeito especificado",
	"commands.effect.clear.specific.success.multiple": "Efeito de %s removido de %s alvos",
	"commands.effect.clear.specific.success.single": "Efeito de %s removido de %s",
	"commands.effect.give.failed": "Não foi possível aplicar este efeito (ou o alvo é imune a efeitos ou tem um mais poderoso)",
	"commands.effect.give.success.multiple": "Efeito de %s aplicado a %s alvos",
	"commands.effect.give.success.single": "Efeito de %s aplicado a %s",
	...
	"commands.execute.conditional.fail_count": "O teste falhou. Quantidade: %s",
	...
	"commands.experience.add.levels.success.multiple": "%s níveis de experiência concedidos a %s jogadores",
	"commands.experience.add.levels.success.single": "%[2]s recebeu %[1]s níveis de experiência",
	"commands.experience.add.points.success.multiple": "%s pontos de experiência concedidos a %s jogadores",
	...
	"commands.fetchprofile.entity.success": "Perfil para a entidade %s resolvido: %s",
	"commands.fetchprofile.failed_to_serialize": "Falha ao serializar o perfil: %s",
	"commands.fetchprofile.give_item": "Dar item",
	"commands.fetchprofile.id.failure": "Falha ao resolver o perfil com o ID %s",
	"commands.fetchprofile.id.success": "Perfil com o ID %s resolvido: %s",
	"commands.fetchprofile.name.failure": "Falha ao resolver o perfil com o nome %s",
	"commands.fetchprofile.name.success": "Perfil com o nome %s resolvido: %s",
	"commands.fetchprofile.no_profile": "A entidade %s não tem nenhum perfil",
	"commands.fetchprofile.summon_mannequin": "Gerar manequim",
	...
	"commands.forceload.toobig": "Há demasiados chunks na área especificada (máximo: %s, especificados: %s)",
	...
	"commands.function.scheduled.multiple": "A executar as funções \"%s\"",
	"commands.function.scheduled.no_functions": "Não foi possível encontrar nenhuma função com o nome %s",
	"commands.function.scheduled.single": "A executar a função \"%s\"",
	"commands.function.success.multiple": "Comandos executados de %[2]s funções: %[1]s",
	...
	"commands.jfr.dump.failed": "Falha ao guardar a análise JFR: %s",
	"commands.jfr.start.failed": "Falha ao iniciar a análise JFR",
	"commands.jfr.started": "Análise JFR iniciada",
	"commands.jfr.stopped": "Análise JFR interrompida e guardada em %s",
	"commands.kick.owner.failed": "Não é possível expulsar o dono de um servidor em LAN",
	"commands.kick.singleplayer.failed": "Não é possível expulsar num jogo local offline",
	"commands.kick.success": "%s foi expulso: %s",
	"commands.kill.success.multiple": "Foram eliminadas %s entidades",
	...
	"commands.pardonip.failed": "Nada mudou. O endereço IP não está bloqueado",
	"commands.pardonip.invalid": "Endereço IP inválido",
	"commands.pardonip.success": "Endereço IP %s desbloqueado",
	"commands.particle.failed": "A partícula não estava visível para ninguém",
	"commands.particle.success": "A mostrar a partícula %s",
	...
	"commands.perf.started": "Análise de desempenho iniciada por 10 segundos (usa \"/perf stop\" para a interromperes)",
	"commands.perf.stopped": "Análise de desempenho interrompida após %s segundo(s) e %s tique(s) (tiques por segundo:%s)",
	"commands.place.feature.failed": "Falha ao colocar o recurso",
	"commands.place.feature.invalid": "O recurso \"%s\" não existe",
	"commands.place.feature.success": "O recurso \"%s\" foi colocado em %s, %s, %s",
	"commands.place.jigsaw.failed": "Falha ao gerar o bloco de puzzle",
	"commands.place.jigsaw.invalid": "O conjunto modelo do tipo \"%s\" não existe",
	"commands.place.jigsaw.success": "Bloco de puzzle gerado em %s, %s, %s",
	...
	"commands.profile_fetch.id.failure": "Falha ao resolver o perfil com o ID %s",
	"commands.profile_fetch.id.success": "Perfil com o ID %s resolvido: %s",
	"commands.profile_fetch.name.failure": "Falha ao resolver o perfil com o nome %s",
	"commands.profile_fetch.name.success": "Perfil com o nome %s resolvido: %s",
	"commands.publish.alreadyPublished": "O jogo multijogador já está alojado na porta %s",
	"commands.publish.alreadyPublished.lan": "Jogo local já alojado na porta %s",
	"commands.publish.alreadyPublished.online": "O jogo online já está alojado",
	"commands.publish.failed": "Não foi possível alojar o jogo local",
	"commands.publish.started": "Jogo local alojado na porta %s",
	"commands.publish.started.lan": "Jogo local alojado na porta %s",
	"commands.publish.started.online": "Jogo online alojado",
	"commands.publish.success": "O jogo multijogador está alojado na porta %s",
	"commands.random.error.range_too_large": "O valor aleatório deve ser no máximo 2147483646",
	...
	"commands.recipe.take.success.multiple": "%s receita(s) removida(s) de %s jogadores",
	"commands.recipe.take.success.single": "%s receita(s) removida(s) de %s",
	"commands.reload.failure": "Erro ao recarregar, os dados antigos serão mantidos",
	"commands.reload.success": "A recarregar!",
	"commands.ride.already_riding": "%s já está a montar um(a) %s",
	"commands.ride.dismount.success": "%s desmontou-se de %s",
	"commands.ride.mount.failure.cant_ride_players": "Não é possível montar em jogadores",
	"commands.ride.mount.failure.generic": "%s não se conseguiu montar num(a) %s",
	"commands.ride.mount.failure.loop": "Não é possível fazer a entidade montar-se em si mesma ou num dos seus passageiros",
	...
	"commands.ride.not_riding": "%s não está montado",
	"commands.rotate.success": "Rotação: %s",
	"commands.save.alreadyOff": "A gravação já está desativada",
	"commands.save.alreadyOn": "A gravação já está ativada",
	"commands.save.disabled": "Gravação automática desativada",
	"commands.save.enabled": "Gravação automática ativada",
	...
	"commands.schedule.cleared.success": "%s função(ões) agendada(s) removida(s) com o ID %s",
	"commands.schedule.created.function": "Função \"%s\" agendada para %s tique(s) no tempo de jogo %s",
	"commands.schedule.created.tag": "Etiqueta \"%s\" agendada para %s tique(s) no tempo de jogo %s",
	...
	"commands.scoreboard.objectives.add.duplicate": "Já há um objetivo com esse nome",
	"commands.scoreboard.objectives.add.success": "Objetivo %s criado",
	"commands.scoreboard.objectives.display.alreadyEmpty": "Nada mudou. O espaço de exibição já está vazio",
	"commands.scoreboard.objectives.display.alreadySet": "Nada mudou. O espaço de exibição já está a mostrar o objetivo",
	"commands.scoreboard.objectives.display.cleared": "Objetivos no espaço de exibição \"%s\" removidos",
	...
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Formato numérico predefinido do objetivo %s removido",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Formato numérico predefinido do objetivo %s alterado",
	"commands.scoreboard.objectives.modify.rendertype": "Tipo de exibição do objetivo %s alterado",
	"commands.scoreboard.objectives.remove.success": "Objetivo %s removido",
	"commands.scoreboard.players.add.success.multiple": "%s pontos adicionados ao objetivo %s para %s entidades",
	"commands.scoreboard.players.add.success.single": "%s pontos adicionados ao objetivo %s para %s (agora tem %s pontos)",
	"commands.scoreboard.players.display.name.clear.success.multiple": "Nome de exibição de %s entidades removido em %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Nome de exibição de %s removido em %s",
	...
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Formato numérico de %s entidades removido em %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Formato numérico de %s removido em %s",
	...
	"commands.scoreboard.players.enable.success.multiple": "Gatilho %s ativado para %s entidades",
	"commands.scoreboard.players.enable.success.single": "Gatilho %s ativado para %s",
	...
	"commands.scoreboard.players.list.empty": "Não há entidades registadas",
	"commands.scoreboard.players.list.entity.empty": "%s não tem pontuações para mostrar",
	"commands.scoreboard.players.list.entity.entry": "%s: %s",
	"commands.scoreboard.players.list.entity.success": "%s tem %s ponto(s):",
	"commands.scoreboard.players.list.success": "Há %s entidade(s) registada(s): %s",
	"commands.scoreboard.players.operation.success.multiple": "Pontuação do objetivo %s atualizada para %s entidades",
	"commands.scoreboard.players.operation.success.single": "Pontuação do objetivo %s para %s definida para %s",
	"commands.scoreboard.players.remove.success.multiple": "%s pontos removidos do objetivo %s para %s entidades",
	"commands.scoreboard.players.remove.success.single": "%s pontos removidos do objetivo %s para %s (agora tem %s pontos)",
	...
	"commands.scoreboard.players.reset.specific.multiple": "Pontuação do objetivo %s para %s entidades redefinida",
	"commands.scoreboard.players.reset.specific.single": "Pontuação do objetivo %s para %s redefinida",
	"commands.scoreboard.players.set.success.multiple": "Pontuação do objetivo %s para %s entidades definida para %s",
	"commands.scoreboard.players.set.success.single": "Pontuação do objetivo %s para %s definida para %s",
	...
	"commands.spreadplayers.failed.entities": "Não foi possível distribuir %s entidade(s) ao redor de %s, %s (há demasiadas entidades para o espaço disponível, tenta não distribuir mais do que %s)",
	"commands.spreadplayers.failed.invalid.height": "Parâmetro maxHeight (%s) inválido. Espera-se um valor superior ao mínimo \"%s\" do mundo",
	"commands.spreadplayers.failed.teams": "Não foi possível distribuir %s equipa(s) ao redor de %s, %s (há demasiadas entidades para o espaço disponível, tenta não distribuir mais do que %s)",
	"commands.spreadplayers.success.entities": "%s entidade(s) distribuída(s) ao redor de %s, %s com uma distância média de %s bloco(s)",
	"commands.spreadplayers.success.teams": "%s equipa(s) distribuída(s) ao redor de %s, %s com uma distância média de %s bloco(s)",
	...
	"commands.stopwatch.already_exists": "O cronómetro \"%s\" já existe",
	"commands.stopwatch.create.success": "Cronómetro criado: %s",
	"commands.stopwatch.does_not_exist": "O cronómetro \"%s\" não existe",
	...
	"commands.summon.success": "Entidade \"%s\" invocada",
	"commands.swing.failed.notliving": "Não foi encontrada nenhuma entidade para mover o braço",
	"commands.swing.success.multiple": "%s entidades moveram os braços",
	"commands.swing.success.single": "%s moveu um braço",
	"commands.tag.add.failed": "O alvo já tem a etiqueta ou já tem demasiadas",
	"commands.tag.add.success.multiple": "Etiqueta \"%s\" adicionada a %s entidades",
	"commands.tag.add.success.single": "Etiqueta \"%s\" adicionada a %s",
	...
	"commands.tag.remove.success.multiple": "Etiqueta \"%s\" removida de %s entidades",
	"commands.tag.remove.success.single": "Etiqueta \"%s\" removida de %s",
	"commands.team.add.duplicate": "Já há uma equipa com esse nome",
	"commands.team.add.success": "Equipa %s criada",
	"commands.team.empty.success": "%s membro(s) removido(s) da equipa %s",
	"commands.team.empty.unchanged": "Nada mudou. A equipa já está vazia",
	"commands.team.join.success.multiple": "%s membros adicionados à equipa %s",
	"commands.team.join.success.single": "%s foi adicionado à equipa %s",
	"commands.team.leave.success.multiple": "%s membros removidos de quaisquer equipas",
	"commands.team.leave.success.single": "%s foi removido da equipa",
	"commands.team.list.members.empty": "Não há membros na equipa %s",
	"commands.team.list.members.success": "A equipa %s tem %s membro(s): %s",
	"commands.team.list.teams.empty": "Não há equipas",
	"commands.team.list.teams.success": "Há %s equipa(s): %s",
	"commands.team.option.collisionRule.success": "Regra de colisão da equipa %s definida para \"%s\"",
	"commands.team.option.collisionRule.unchanged": "Nada mudou. A regra de colisão já tem esse valor",
	"commands.team.option.color.clear.success": "Cor da equipa %s removida",
	"commands.team.option.color.success": "Cor da equipa %s atualizada para %s",
	"commands.team.option.color.unchanged": "Nada mudou. A equipa já tem essa cor",
	"commands.team.option.deathMessageVisibility.success": "Visibilidade da mensagem de morte da equipa %s definida para \"%s\"",
	"commands.team.option.deathMessageVisibility.unchanged": "Nada mudou. A visibilidade das mensagens de morte já tem esse valor",
	"commands.team.option.friendlyfire.alreadyDisabled": "Nada mudou.  O fogo amigável já está desativado para a equipa",
	"commands.team.option.friendlyfire.alreadyEnabled": "Nada mudou. O fogo amigável já está ativado para a equipa",
	"commands.team.option.friendlyfire.disabled": "Fogo amigável desativado para a equipa %s",
	"commands.team.option.friendlyfire.enabled": "Fogo amigável ativado para a equipa %s",
	"commands.team.option.name.success": "Nome da equipa %s atualizado",
	"commands.team.option.name.unchanged": "Nada mudou. A equipa já tem esse nome",
	"commands.team.option.nametagVisibility.success": "Visibilidade do nome da equipa %s definida para \"%s\"",
	"commands.team.option.nametagVisibility.unchanged": "Nada mudou. A visibilidade dos nomes já tem esse valor",
	"commands.team.option.prefix.success": "Prefixo da equipa definido para %s",
	"commands.team.option.seeFriendlyInvisibles.alreadyDisabled": "Nada mudou. Os membros da equipa já não podem ver os colegas invisíveis",
	"commands.team.option.seeFriendlyInvisibles.alreadyEnabled": "Nada mudou. Os membros da equipa já podem ver os colegas invisíveis",
	...
	"commands.team.option.suffix.success": "Sufixo da equipa definido para %s",
	"commands.team.remove.success": "Equipa %s removida",
	...
	"commands.test.batch.starting": "A iniciar o ambiente %s do lote %s",
	"commands.test.clear.error.no_tests": "Não foi encontrado nenhum teste para apagar",
	"commands.test.clear.success": "%s estrutura(s) removida(s)",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Clica para copiar",
	"commands.test.create.success": "Configuração do teste %s criada",
	"commands.test.error.no_test_containing_pos": "Não foi possível encontrar uma instância de teste que contém %s, %s, %s",
	"commands.test.error.no_test_instances": "Não foram encontradas instâncias de teste",
	"commands.test.error.non_existant_test": "Não foi possível encontrar o teste %s",
	"commands.test.error.structure_not_found": "Não foi possível encontrar a estrutura de teste %s",
	"commands.test.error.test_instance_not_found": "Não foi possível encontrar nenhum bloco-entidade de instância de teste",
	"commands.test.error.test_instance_not_found.position": "Não foi possível encontrar nenhum bloco-entidade de instância de teste em %s, %s, %s",
	"commands.test.error.too_large": "O tamanho da estrutura deve ser inferior a %s blocos em cada eixo",
	...
	"commands.test.locate.started": "Localização de estruturas de testes iniciada. Isto pode demorar...",
	"commands.test.no_tests": "Não há nenhum teste para executar",
	"commands.test.relative_position": "Posição relativa a %s: %s",
	"commands.test.reset.error.no_tests": "Não foi possível encontrar nenhum teste para redefinir",
	"commands.test.reset.success": "Estruturas redefinidas: %s",
	"commands.test.run.no_tests": "Não foi encontrado nenhum teste",
	"commands.test.run.running": "Testes em execução: %s",
	"commands.test.summary": "Teste de jogo concluído! %s teste(s) realizado(s)",
	"commands.test.summary.all_required_passed": "Todos os testes necessários foram aprovados :)",
	"commands.test.summary.failed": "Testes necessários falhados: %s",
	"commands.test.summary.optional_failed": "Testes opcionais falhados: %s",
	...
	"commands.tick.sprint.stop.fail": "Sem aceleração de tiques a decorrer",
	"commands.tick.sprint.stop.success": "Aceleração atual de tiques interrompida",
	"commands.tick.status.frozen": "O jogo está parado",
	"commands.tick.status.lagging": "O jogo está em execução, mas não consegue acompanhar a taxa de tiques especificada",
	"commands.tick.status.running": "O jogo decorre normalmente",
	"commands.tick.status.sprinting": "O jogo está acelerado",
	"commands.tick.step.fail": "Não é possível avançar enquanto o jogo não estiver parado",
	"commands.tick.step.stop.fail": "Sem tiques a decorrer",
	"commands.tick.step.stop.success": "Avanço atual de tiques interrompido",
	"commands.tick.step.success": "A avançar %s tique(s)",
	"commands.time.no_default_clock": "Não há nenhum relógio predefinido na dimensão %s",
	"commands.time.no_time_marker_found": "Marcador de tempo %s não existe para o relógio %s",
	"commands.time.pause": "Relógio %s em pausa",
	...
	"commands.time.rate": "O relógio %s irá avançar %sx mais rápido",
	...
	"commands.time.wrong_timeline_for_clock": "A linha do tempo %s é inválida para o relógio %s",
	"commands.title.cleared.multiple": "Títulos removidos de %s jogadores",
	"commands.title.cleared.single": "Títulos removidos de %s",
	...
	"commands.title.times.multiple": "Tempo de exibição dos títulos alterado para %s jogadores",
	"commands.title.times.single": "Tempo de exibição dos títulos alterado para %s",
	"commands.transfer.error.no_players": "Especifica pelo menos um jogador para transferir",
	"commands.transfer.success.multiple": "A transferir %s jogadores para %s:%s",
	"commands.transfer.success.single": "A transferir %s para %s:%s",
	...
	"commands.unpublish.success": "O jogo multijogador já não está publicado",
	...
	"commands.waypoint.list.empty": "Não há marcadores em %s",
	...
	"commands.weather.set.rain": "Tempo definido para chuva",
	"commands.weather.set.thunder": "Tempo definido para tempestade",
	...
	"commands.worldborder.center.failed": "Nada mudou. A barreira do mundo já está centrada nessa posição",
	...
	"commands.worldborder.get": "A barreira do mundo tem %s bloco(s) de extensão",
	...
	"commands.worldborder.set.grow": "A aumentar a barreira do mundo para %s bloco(s) de extensão ao longo de %s segundo(s)",
	"commands.worldborder.set.immediate": "Barreira do mundo definida para %s bloco(s) de extensão",
	"commands.worldborder.set.shrink": "A diminuir a barreira do mundo para %s bloco(s) de extensão ao longo de %s segundo(s)",
	...
	"connect.failed": "Falha ao ligar ao servidor",
	"connect.failed.transfer": "Ocorreu um erro de ligação ao transferir para o servidor",
	"connect.joining": "A entrar no mundo...",
	"connect.negotiating": "A estabelecer ligação...",
	"connect.p2p.establishing": "A estabelecer ligação...",
	"connect.p2p.failed.generic": "Erro ao estabelecer a ligação ao jogador",
	"connect.p2p.failed.signaling": "Ligação indisponível.\nTenta novamente mais tarde.",
	"connect.p2p.failed.timeout": "Tempo limite de pedido de ligação excedido",
	"connect.p2p.failed.unreachable": "Jogador inacessível",
	"connect.reconfiging": "A reconfigurar...",
	"connect.reconfiguring": "A reconfigurar...",
	"connect.transferring": "A transferir para o novo servidor...",
	...
	"container.crafter": "Mesa automática",
	...
	"container.upgrade.error_tooltip": "O item não pode ser melhorado desta maneira",
	"container.upgrade.missing_template_tooltip": "Adiciona um Molde de Ferraria",
	"controls.keybinds": "Atalhos...",
	"controls.keybinds.duplicateKeybinds": "Esta tecla já é usada para:\n%s",
	...
	"createWorld.customize.presets.share": "Queres partilhar o teu modelo? Usa a caixa abaixo!",
	...
	"dataPack.bundle.name": "Sacolas",
	"dataPack.locator_bar.description": "Mostra a direção dos outros jogadores no multijogador",
	"dataPack.locator_bar.name": "Barra de Localização",
	"dataPack.minecart_improvements.description": "Movimento melhorado dos Carrinhos",
	"dataPack.minecart_improvements.name": "Melhorias dos Carrinhos de Mina",
	"dataPack.redstone_experiments.description": "Alterações experimentais de Redstone",
	"dataPack.redstone_experiments.name": "Experiências de Redstone",
	"dataPack.title": "Selecionar pacotes de dados",
	"dataPack.trade_rebalance.description": "Trocas atualizadas para os Aldeões",
	...
	"dataPack.update_1_21.description": "Novo conteúdo para o Minecraft 1.21",
	...
	"dataPack.winter_drop.description": "Novos conteúdos para o Drop de Inverno",
	"dataPack.winter_drop.name": "Drop de Inverno",
	"datapackFailure.safeMode": "Modo de Segurança",
	"datapackFailure.safeMode.failed.description": "Este mundo contém dados inválidos ou corrompidos.",
	"datapackFailure.safeMode.failed.title": "Falha ao carregar o mundo no Modo de Segurança.",
	...
	"death.attack.dragonBreath": "%[1]s assou em hálito do Dragão",
	...
	"death.attack.message_too_long": "A mensagem era demasiado longa para ser entregue na totalidade. Aqui está uma versão reduzida: %s",
	...
	"death.attack.outsideBorder": "%[1]s saiu dos confins deste mundo",
	"death.attack.outsideBorder.player": "%[1]s saiu dos confins deste mundo enquanto lutava com %[2]s",
	...
	"death.attack.sulfurCubeHot": "%[1]s morreu porque não era só o chão que era lava",
	"death.attack.sulfurCubeHot.player": "%[2]s mostrou a %[1]s que não era só o chão que era lava",
	...
	"debug.copy_location.help": "F3 + C = Copiar a posição como comando /tp, ou segura durante 10 segundos para fechares o jogo",
	"debug.copy_location.message": "Posição copiada",
	"debug.crash.message": "As teclas F3 + C estão premidas. O jogo irá ser forçado a fechar a menos que sejam largadas.",
	"debug.crash.message.rebindable": "%s + %s premidos. Solta ou o jogo irá ser interrompido.",
	...
	"debug.dump_dynamic_textures": "Texturas dinâmicas guardadas em %s",
	"debug.dump_dynamic_textures.help": "F3 + S = Guardar texturas dinâmicas",
	"debug.entry.always": "Sempre",
	"debug.entry.currently.alwaysOn": "%s: Visível",
	"debug.entry.currently.inF3": "%s: Apenas no F3",
	"debug.entry.currently.inOverlay": "%s: Só na sobreposição da depuração",
	"debug.entry.currently.never": "%s: Oculto",
	"debug.entry.f3": "No F3",
	"debug.entry.overlay": "Na sobreposição",
	...
	"debug.options.category.renderer": "Processadores de depuração",
	"debug.options.category.text": "Texto do ecrã de depuração",
	"debug.options.help": "F3 + F6 = Editar opções de depuração",
	"debug.options.notAllowed.tooltip": "Oculto com a depuração reduzida",
	...
	"debug.options.warning": "Estas opções servem apenas para teste. Elas podem abrandar o teu computador, fechar o jogo ou abrir um buraco negro.",
	...
	"debug.profiling.start": "A análise de desempenho irá durar %s segundos. Prime F3 + L para interromperes",
	"debug.profiling.start.rebindable": "Análise de desempenho iniciada durante %s segundo(s). Usa %s + %s para interromperes",
	"debug.profiling.stop": "Análise de desempenho concluída. Resultados guardados em %s",
	...
	"demo.day.1": "A demonstração irá durar cinco dias de jogo. Dá o teu melhor!",
	...
	"demo.help.fullWrapped": "A demonstração irá durar cinco dias de jogo (aproximadamente 1 hora e 40 minutos da vida real). Vê as proezas para te orientares e diverte-te!",
	...
	"demo.help.movement": "Prime %[1]s, %[2]s, %[3]s, %[4]s e move o rato para andar",
	...
	"difficulty.lock.question": "Tens a certeza que queres bloquear a dificuldade deste mundo? Irá estar no modo %[1]s e não pode ser alterado.",
	...
	"disconnect.ignoring_status_request": "Pedido de estado ignorado",
	...
	"download.pack.failed": "Falha ao transferir %s de %s pacote(s)",
	"download.pack.progress.bytes": "Progresso: %s (tamanho total desconhecido)",
	"download.pack.progress.percent": "Progresso: %s%%",
	"download.pack.title": "A transferir pacote de recursos (%s/%s)",
	...
	"editGamerule.inGame.discardChanges.message": "Tens a certeza que queres rejeitar as mudanças pendentes nas regras do jogo?",
	"editGamerule.inGame.discardChanges.title": "Alterações nas regras do jogo",
	"editGamerule.inGame.downloadingGamerules": "A transferir regras do jogo...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Respiração de Náutilo",
	...
	"effect.minecraft.oozing": "Viscosidade",
	...
	"effect.minecraft.wind_charged": "Lufada",
	...
	"enchantment.minecraft.breach": "Rutura",
	...
	"entity.minecraft.acacia_boat": "Barco de Acácia",
	"entity.minecraft.acacia_chest_boat": "Barco de Acácia com Baú",
	...
	"entity.minecraft.dark_oak_boat": "Barco de Carvalho Escuro",
	"entity.minecraft.dark_oak_chest_boat": "Barco de Carvalho Escuro com Baú",
	...
	"entity.minecraft.jungle_boat": "Barco da Selva",
	"entity.minecraft.jungle_chest_boat": "Barco da Selva com Baú",
	...
	"entity.minecraft.mangrove_boat": "Barco de Mangue",
	"entity.minecraft.mangrove_chest_boat": "Barco de Mangue com Baú",
	...
	"entity.minecraft.oak_boat": "Barco de Carvalho",
	"entity.minecraft.oak_chest_boat": "Barco de Carvalho com Baú",
	"entity.minecraft.ocelot": "Ocelote",
	"entity.minecraft.ominous_item_spawner": "Gerador Sombrio de Itens",
	"entity.minecraft.painting": "Quadro",
	"entity.minecraft.pale_oak_boat": "Barco de Carvalho Pálido",
	"entity.minecraft.pale_oak_chest_boat": "Barco de Carvalho Pálido com Baú",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Esqueleto-Múmia",
	...
	"entity.minecraft.spruce_boat": "Barco de Abeto",
	"entity.minecraft.spruce_chest_boat": "Barco de Abeto com Baú",
	...
	"entity.minecraft.zombie_nautilus": "Náutilo-Zombie",
	"entity.minecraft.zombie_villager": "Aldeão Zombie",
	...
	"filled_map.trial_chambers": "Mapa de exploração de desafios",
	"filled_map.unknown": "Mapa desconhecido",
	"filled_map.village_desert": "Mapa de aldeia do deserto",
	"filled_map.village_plains": "Mapa de aldeia da planície",
	"filled_map.village_savanna": "Mapa de aldeia da savana",
	"filled_map.village_snowy": "Mapa de aldeia da planície nevada",
	"filled_map.village_taiga": "Mapa de aldeia da taiga",
	...
	"gameMode.changed": "Modo de jogo alterado para %s",
	...
	"gamerule.allowEnteringNetherUsingPortals.description": "Controla se os jogadores podem entrar no Nether.",
	"gamerule.allowFireTicksAwayFromPlayer": "Propagação do fogo à distância",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Controla a propagação do fogo e da lava acima de 8 chunks de distância de qualquer jogador.",
	"gamerule.announceAdvancements": "Anunciar proezas",
	"gamerule.blockExplosionDropDecay": "Desintegrar itens largados pelas explosões de blocos",
	...
	"gamerule.commandModificationBlockLimit.description": "Número de blocos que podem ser alterados só de uma vez com um comando, como /fill ou /clone.",
	...
	"gamerule.doLimitedCrafting.description": "Se ativada, os jogadores só irão poder criar receitas desbloqueadas.",
	"gamerule.doMobLoot": "Largar itens de criaturas",
	"gamerule.doMobLoot.description": "Controla os itens largados pelas criaturas, incluindo as esferas de experiência.",
	...
	"gamerule.doTileDrops.description": "Controla os itens largados pelos blocos, incluindo as esferas de experiência.",
	"gamerule.doTraderSpawning": "Gerar Vendedores Ambulantes",
	"gamerule.doVinesSpread": "Propagação de trepadeiras",
	"gamerule.doVinesSpread.description": "Controla a propagação de trepadeiras para os blocos adjacentes. Não afeta outros tipos de trepadeiras, como as Trepadeiras Melancólicas, Trepadeiras Retorcidas etc.",
	...
	"gamerule.enderPearlsVanishOnDeath": "Destruir Pérolas do Ender lançadas ao morrer",
	"gamerule.enderPearlsVanishOnDeath.description": "As Pérolas do Ender lançadas desaparecem após a morte do jogador.",
	"gamerule.entitiesWithPassengersCanUsePortals": "As entidades com passageiros podem atravessar portais",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Permite as entidades com passageiros atravessar portais do Nether, portais do End e passagens.",
	...
	"gamerule.lavaSourceConversion.description": "Transforma uma corrente de lava numa fonte, quando está cercada por dois lados com lava.",
	"gamerule.locatorBar": "Barra de Localização de jogadores",
	"gamerule.locatorBar.description": "Ao ativares, uma barra é mostrada no ecrã para indicar a direção dos outros jogadores.",
	...
	"gamerule.maxCommandChainLength.description": "Aplicável ao encadeamento dos blocos de comando e das funções.",
	"gamerule.maxCommandForkCount": "Limite de contextos por comando",
	"gamerule.maxCommandForkCount.description": "Número máximo de contextos que podem ser usados em comandos como \"execute as\".",
	...
	"gamerule.minecartMaxSpeed.description": "Velocidade máxima predefinida de um Carrinho de Mina no solo",
	...
	"gamerule.minecraft.fire_spread_radius_around_player.description": "O raio em blocos ao redor de um jogador na qual o fogo se pode propagar",
	"gamerule.minecraft.player_movement_check": "Verificação de movimentos do jogador",
	"gamerule.minecraft.raids": "Invasões",
	"gamerule.minecraft.universal_anger.description": "As criaturas neutras furiosas atacam todos os jogadores. Funciona melhor se a regra \"Perdoar jogadores mortos\" estiver desativada.",
	"gamerule.mobExplosionDropDecay": "Desintegrar itens largados pelas explosões de criaturas",
	...
	"gamerule.playersNetherPortalCreativeDelay.description": "Tempo (em tiques) que um jogador no Modo Criativo permanece num Portal do Nether antes de mudar de dimensão.",
	"gamerule.playersNetherPortalDefaultDelay": "Atraso do Portal do Nether em modo não Criativo",
	"gamerule.playersNetherPortalDefaultDelay.description": "Tempo (em tiques) que um jogador permanece num Portal do Nether antes de mudar de dimensão.",
	...
	"gamerule.projectilesCanBreakBlocks": "Destruir blocos com projéteis",
	"gamerule.projectilesCanBreakBlocks.description": "Controla se os projéteis podem destruir determinados blocos.",
	"gamerule.pvp": "Ativar PvP",
	"gamerule.pvp.description": "Controla se os jogadores podem atacar outros jogadores.",
	...
	"gamerule.spawnChunkRadius.description": "Quantidade de chunks que permanecem carregados ao redor do ponto de renascimento na Superfície.",
	"gamerule.spawnMonsters": "Gerar monstros",
	"gamerule.spawnMonsters.description": "Controla a geração natural dos monstros.",
	"gamerule.spawnRadius": "Raio do local de renascimento",
	"gamerule.spawnRadius.description": "Define o tamanho da área em que os jogadores podem renascer.",
	"gamerule.spawnerBlocksEnabled": "Ativar blocos de geração",
	"gamerule.spectatorsGenerateChunks": "Gerar terreno para os espectadores",
	"gamerule.tntExplodes": "Permite ativar e explodir TNTs",
	"gamerule.tntExplosionDropDecay": "Desintegrar itens largados pelas explosões de TNT",
	...
	"gamerule.waterSourceConversion.description": "Transforma uma corrente de água numa fonte, quando está cercada por dois lados com água.",
	...
	"gui.abuseReport.attestation": "Ao enviares esta denúncia, confirmas que as informações descritas são genuínas.",
	"gui.abuseReport.comments": "Comentários",
	"gui.abuseReport.describe": "Partilhar mais detalhes irá ajudar-nos a tomar a melhor decisão.",
	"gui.abuseReport.discard.content": "Se saíres, a denúncia e os comentários serão rejeitados.\nTens a certeza que queres sair?",
	"gui.abuseReport.discard.discard": "Rejeitar denúncia e sair",
	"gui.abuseReport.discard.draft": "Guardar como rascunho",
	"gui.abuseReport.discard.return": "Continuar a editar",
	"gui.abuseReport.discard.title": "Rejeitar denúncia e comentários?",
	"gui.abuseReport.draft.content": "Queres continuar a editar a denúncia atual ou rejeitá-la e criar uma nova?",
	"gui.abuseReport.draft.discard": "Rejeitar",
	"gui.abuseReport.draft.edit": "Continuar a editar",
	"gui.abuseReport.draft.quittotitle.content": "Queres continuar a editar ou rejeitá-la?",
	"gui.abuseReport.draft.quittotitle.title": "Irás perder o rascunho da denúncia se saíres",
	"gui.abuseReport.draft.title": "Editar rascunho da denúncia?",
	"gui.abuseReport.error.title": "Ocorreu um erro ao enviar a denúncia",
	"gui.abuseReport.message": "Onde observaste o mau comportamento?\nIsto vai ajudar-nos a analisar o teu caso.",
	"gui.abuseReport.more_comments": "Descreve o que aconteceu:",
	"gui.abuseReport.name.comment_box_label": "Descreve porque queres denunciar este nome:",
	"gui.abuseReport.name.reporting": "Estás a denunciar \"%s\".",
	"gui.abuseReport.name.title": "Denunciar nome inapropriado",
	"gui.abuseReport.observed_what": "Porque estás a denunciar isto?",
	"gui.abuseReport.read_info": "Sabe mais sobre as denúncias",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Alguém está a prejudicar a tua reputação ou a de outra pessoa, por exemplo, divulgando informações falsas com o objetivo de explorar ou enganar os outros.",
	...
	"gui.abuseReport.reason.generic.description": "O jogador irritou-me ou fez algo que eu não gosto.",
	...
	"gui.abuseReport.reason.imminent_harm": "Ameaças a outras pessoas",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Sexualmente inapropriado",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Skins gráficas que retratam atos, órgãos ou violência sexual.",
	...
	"gui.abuseReport.report_sent_msg": "Recebemos a tua denúncia. Obrigado!\n\nA nossa equipa irá revê-la assim que possível.",
	"gui.abuseReport.select_reason": "Seleciona a categoria",
	"gui.abuseReport.send": "Enviar denúncia",
	"gui.abuseReport.send.comment_too_long": "Encurta o comentário",
	...
	"gui.abuseReport.send.json_error": "Foi encontrado conteúdo deformado ao enviar a denúncia.",
	"gui.abuseReport.send.no_reason": "Seleciona uma categoria",
	"gui.abuseReport.send.not_attested": "Lê e confirma o texto acima antes de enviares a denúncia",
	...
	"gui.all": "Todas",
	"gui.back": "Voltar",
	"gui.banned.description": "%s\n\n%s\n\nSabe mais através do link: %s",
	"gui.banned.description.permanent": "A tua conta foi banida permanentemente. Não podes jogar online ou entrar no Realms.",
	"gui.banned.description.reason": "Recebemos uma denúncia de comportamento na tua conta. Os moderadores estão a rever o teu caso e identificaram-no como %s, o que infringe os Padrões da Comunidade do Minecraft.",
	"gui.banned.description.reason_id": "Código: %s",
	"gui.banned.description.reason_id_message": "Código: %s — %s",
	"gui.banned.description.temporary": "%s Até lá, não podes jogar online ou entrar no Realms.",
	"gui.banned.description.temporary.duration": "A tua conta está temporariamente suspensa e irá ser reativada em %s.",
	"gui.banned.description.unknownreason": "Recebemos uma denúncia de comportamento na tua conta. Os moderadores estão a rever o teu caso e identificaram que infringe os Padrões da Comunidade do Minecraft.",
	"gui.banned.name.description": "O teu nome atual — \"%s\" — infringe os Padrões da Comunidade. Podes jogar offline, mas precisas de o alterar para jogares online.\n\nSabe mais ou submete um pedido para rever o teu caso através deste link: %s",
	"gui.banned.name.title": "O nome não é permitido no modo multijogador",
	"gui.banned.reason.defamation_impersonation_false_information": "Falsificação de identidade ou partilha de informações com o intuito de explorar ou enganar pessoas",
	"gui.banned.reason.drugs": "Referências a drogas ilegais",
	"gui.banned.reason.extreme_violence_or_gore": "Descrições de violência excessiva ou gráfica na vida real",
	"gui.banned.reason.false_reporting": "Excesso de denúncias falsas ou imprecisas",
	"gui.banned.reason.fraud": "Aquisição ou uso fraudulento de conteúdo",
	"gui.banned.reason.generic_violation": "Infringir os Padrões da Comunidade",
	...
	"gui.banned.reason.hate_terrorism_notorious_figure": "Referências a grupos de ódio, organizações terroristas ou figuras notórias",
	"gui.banned.reason.imminent_harm_to_person_or_property": "Intenção de causar danos a pessoas ou bens na vida real",
	"gui.banned.reason.nudity_or_pornography": "Exibição de material sexual ou pornográfico",
	"gui.banned.reason.sexually_inappropriate": "Tópicos ou conteúdos de natureza sexual",
	"gui.banned.reason.spam_or_advertising": "Spam ou publicidade",
	"gui.banned.skin.description": "A tua skin atual infringe os Padrões da Comunidade. Podes jogar com uma skin predefinida ou trocar por uma nova.\n\nSabe mais ou submete um pedido para rever o teu caso através deste link: %s",
	"gui.banned.skin.title": "A skin não é permitida",
	...
	"gui.chatReport.describe": "Partilhar mais detalhes irá ajudar-nos a tomar a melhor decisão.",
	...
	"gui.chatReport.draft.content": "Queres continuar a editar a denúncia atual ou rejeitá-la e criar uma nova?",
	...
	"gui.chatReport.draft.quittotitle.title": "Irás perder o rascunho da denúncia se saíres",
	...
	"gui.chatSelection.context": "As mensagens relacionadas irão estar incluídas como esclarecimento adicional",
	...
	"gui.fileDropFailure.detail": "%s ficheiros rejeitados",
	"gui.fileDropFailure.title": "Falha ao adicionar os ficheiros",
	"gui.friends.accept": "Aceitar",
	"gui.friends.button.loading": "Aguarda...",
	"gui.friends.button.loading.invite_request_pending": "A aguardar confirmação",
	"gui.friends.button.loading.join_request_pending": "A aguardar confirmação",
	"gui.friends.cancel_request": "Cancelar pedido",
	"gui.friends.confirm_title": "Confirmar",
	"gui.friends.confirm_unfriend": "Tens a certeza que queres remover este jogador da tua lista de amigos?",
	"gui.friends.copy_to_clipboard": "Copiar para a área de transferência",
	"gui.friends.decline": "Recusar",
	"gui.friends.empty_nickname": "Insere um nome de perfil válido antes de enviares um pedido de amizade",
	"gui.friends.empty_state": "Os amigos aparecem aqui.\n\nGere a segurança online através da %s.",
	"gui.friends.empty_state.link": "conta Microsoft",
	"gui.friends.enter_nickname": "Inserir o nome do perfil",
	...
	"gui.friends.error.forbidden.message": "Não foi possível realizar esta ação. Verifica as definições de privacidade da conta.",
	"gui.friends.error.generic": "Ocorreu um erro.\n\nTenta novamente mais tarde.",
	"gui.friends.error.rateLimited.message": "Estás a mexer na lista de amigos demasiado rápido. Aguarda e tenta novamente.",
	"gui.friends.error.temporary_unavailable": "A lista de amigos está atualmente indisponível.\n\nTente novamente mais tarde.",
	"gui.friends.error.unavailable.message": "A lista de amigos está atualmente indisponível. Verifica a ligação à internet ou tenta novamente mais tarde.",
	"gui.friends.error.upgrade_needed": "Atualiza o jogo para acederes à lista de amigos.",
	"gui.friends.error.user_may_lack_active_profile": "Não foi encontrado nenhum jogador com esse nome",
	"gui.friends.join": "Entrar",
	"gui.friends.loading_friends": "A carregar a lista de amigos...",
	"gui.friends.loading_requests": "A carregar pedidos...",
	"gui.friends.manage_account_footer": "Gere a tua segurança online com a %s",
	...
	"gui.friends.my_profile_name": "Nome de perfil: ",
	"gui.friends.my_profile_name.narration": "Copiar o nome de perfil de %s para a área de transferência",
	"gui.friends.narration.button.accept": "Prime Enter para aceitares o pedido de amizade de %s",
	"gui.friends.narration.button.cancel_request": "Prime Enter para cancelares o envio do pedido de amizade para %s",
	"gui.friends.narration.button.decline": "Prime Enter para recusares o pedido de amizade de %s",
	"gui.friends.narration.button.unfriend": "Prime Enter para removeres %s da lista de amigos",
	...
	"gui.friends.pending.empty": "Sem pedidos de amizade pendentes",
	...
	"gui.friends.toast.friend_added.message": "%s aceitou o teu pedido de amizade",
	"gui.friends.toast.friend_invited.message": "Convidaste %s para o teu mundo.",
	"gui.friends.toast.friend_removed.message": "%s foi removido da tua lista de amigos",
	"gui.friends.toast.generic_error": "Ocorreu um erro ao atualizar a lista de amigos. Tenta novamente mais tarde.",
	"gui.friends.toast.host_invite_expired.message": "O convite enviado para %s expirou.",
	"gui.friends.toast.invite_from_friend.message": "%s convidou-te para entrares num mundo. Prime %s para abrires a lista de amigos e entrares",
	"gui.friends.toast.join_invite_expired.message": "O convite para entrares no mundo de %s expirou.",
	"gui.friends.toast.join_request.message": "%s quer entrar no teu mundo. Prime %s para abrires a lista de amigos ou entra através do menu do jogo.",
	"gui.friends.toast.request_accepted.message": "Agora és amigo de %s",
	"gui.friends.toast.request_received.message": "%s enviou-te um pedido de amizade",
	"gui.friends.toast.request_sent.message": "Pedido de amizade enviado para %s",
	"gui.friends.toast.request_to_join_friend.message": "Pediste para entrar no mundo de %s",
	"gui.friends.toast.requests_accepted_multiple.message": "%s amigos aceitaram os teus pedidos de amizade",
	"gui.friends.toast.requests_received_multiple.message": "Recebeste %s pedidos de amizade",
	"gui.friends.unfriend": "Remover amigo",
	"gui.game_rule.search": "Procurar...",
	"gui.hours": "%s hora(s)",
	"gui.language.search": "Procurar...",
	"gui.loadingMinecraft": "A carregar o Minecraft",
	...
	"gui.narrate.tab": "Separador %s",
	"gui.no": "Não",
	"gui.none": "Nenhum",
	"gui.ok": "OK",
	"gui.open_report_dir": "Abrir lista de relatórios",
	"gui.packSelection.search": "Procurar...",
	"gui.privacy_link.message": "Abre este link para gerires as definições de privacidade e segurança online.",
	"gui.privacy_link.title": "As definições da Xbox podem demorar para atualizar.\n\nReinicia o jogo para forçares as atualizações.",
	"gui.proceed": "Avançar",
	"gui.recipebook.moreRecipes": "Clica com o botão direito para ver mais",
	"gui.recipebook.next_page": "Página seguinte",
	...
	"gui.remove": "Remover",
	"gui.report_to_server": "Relatar ao servidor",
	...
	"gui.socialInteractions.hidden_in_chat": "As mensagens de %s irão estar ocultas",
	...
	"gui.socialInteractions.search_empty": "Não há nenhum jogador com esse nome",
	...
	"gui.socialInteractions.shown_in_chat": "As mensagens de %s irão ser mostradas",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Não podes denunciar este jogador porque o chat está desativado ou bloqueado.",
	...
	"gui.togglable_slot": "Clica para desativares o espaço",
	"gui.up": "Cima",
	"gui.waitingForResponse.button.inactive": "Voltar (%ss)",
	"gui.waitingForResponse.title": "A aguardar servidor",
	"gui.yes": "Sim",
	...
	"item.minecraft.angler_pottery_shard": "Fragmento de Cerâmica de Pesca",
	"item.minecraft.angler_pottery_sherd": "Fragmento de Cerâmica de Pesca",
	"item.minecraft.apple": "Maçã",
	"item.minecraft.archer_pottery_shard": "Fragmento de Cerâmica de Arco",
	"item.minecraft.archer_pottery_sherd": "Fragmento de Cerâmica de Arco",
	"item.minecraft.armadillo_scute": "Escama de Tatu",
	"item.minecraft.armadillo_spawn_egg": "Ovo de Invocação de Tatu",
	"item.minecraft.armor_stand": "Suporte de Armaduras",
	"item.minecraft.arms_up_pottery_shard": "Fragmento de Cerâmica de Figura",
	"item.minecraft.arms_up_pottery_sherd": "Fragmento de Cerâmica de Figura",
	...
	"item.minecraft.black_bundle": "Sacola Preta",
	"item.minecraft.black_dye": "Corante Preto",
	"item.minecraft.black_harness": "Arreios Pretos",
	"item.minecraft.blade_pottery_shard": "Fragmento de Cerâmica de Espada",
	"item.minecraft.blade_pottery_sherd": "Fragmento de Cerâmica de Espada",
	...
	"item.minecraft.blue_bundle": "Sacola Azul",
	"item.minecraft.blue_dye": "Corante Azul",
	"item.minecraft.blue_egg": "Ovo Azul",
	"item.minecraft.blue_harness": "Arreios Azuis",
	"item.minecraft.bogged_spawn_egg": "Ovo de Invocação de Enlameado",
	"item.minecraft.bolt_armor_trim_smithing_template": "Molde de Ferraria",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Revestimento de Parafuso",
	...
	"item.minecraft.breeze_spawn_egg": "Ovo de Invocação de Vórtice",
	"item.minecraft.brewer_pottery_shard": "Fragmento de Cerâmica de Poção",
	"item.minecraft.brewer_pottery_sherd": "Fragmento de Cerâmica de Poção",
	"item.minecraft.brewing_stand": "Fermentador",
	"item.minecraft.brick": "Tijolo",
	"item.minecraft.brown_bundle": "Sacola Castanha",
	"item.minecraft.brown_dye": "Corante Castanho",
	"item.minecraft.brown_egg": "Ovo Castanho",
	"item.minecraft.brown_harness": "Arreios Castanhos",
	"item.minecraft.brush": "Pincel",
	"item.minecraft.bucket": "Balde",
	"item.minecraft.bundle": "Sacola",
	"item.minecraft.bundle.empty": "Vazia",
	"item.minecraft.bundle.empty.description": "Pode carregar um conjunto de vários itens",
	"item.minecraft.bundle.full": "Cheia",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "Fragmento de Cerâmica de Fogo",
	"item.minecraft.burn_pottery_sherd": "Fragmento de Cerâmica de Fogo",
	"item.minecraft.camel_husk_spawn_egg": "Ovo de Invocação de Dromedário-Múmia",
	...
	"item.minecraft.cherry_boat": "Barco de Cerejeira",
	"item.minecraft.cherry_chest_boat": "Barco de Cerejeira com Baú",
	...
	"item.minecraft.coast_armor_trim_smithing_template.new": "Revestimento do Litoral",
	...
	"item.minecraft.copper_golem_spawn_egg": "Ovo de Invocação de Golem de Cobre",
	...
	"item.minecraft.copper_leggings": "Perneiras de Cobre",
	...
	"item.minecraft.creaking_spawn_egg": "Ovo de Invocação de Rangente",
	...
	"item.minecraft.cyan_bundle": "Sacola Cíano",
	"item.minecraft.cyan_dye": "Corante Cíano",
	"item.minecraft.cyan_harness": "Arreios Cíanos",
	"item.minecraft.danger_pottery_shard": "Fragmento de Cerâmica de Creeper",
	"item.minecraft.danger_pottery_sherd": "Fragmento de Cerâmica de Creeper",
	...
	"item.minecraft.dune_armor_trim_smithing_template.new": "Revestimento de Dunas",
	...
	"item.minecraft.ender_dragon_spawn_egg": "Ovo de Invocação do Dragão do Ender",
	...
	"item.minecraft.explorer_pottery_shard": "Fragmento de Cerâmica de Mapa",
	"item.minecraft.explorer_pottery_sherd": "Fragmento de Cerâmica de Mapa",
	"item.minecraft.eye_armor_trim_smithing_template": "Molde de Ferraria",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Revestimento de Olho",
	"item.minecraft.feather": "Pena",
	"item.minecraft.fermented_spider_eye": "Olho de Aranha Fermentado",
	"item.minecraft.field_masoned_banner_pattern": "Figura para Estandarte de Alvenaria",
	...
	"item.minecraft.firework_star.fade_to": "Desvanece para",
	...
	"item.minecraft.flow_armor_trim_smithing_template.new": "Revestimento de Fluxo",
	"item.minecraft.flow_banner_pattern": "Padrão para Estandarte",
	"item.minecraft.flow_banner_pattern.desc": "Espiral",
	"item.minecraft.flow_banner_pattern.new": "Figura para Estandarte de Espiral",
	"item.minecraft.flow_pottery_sherd": "Fragmento de Cerâmica de Espiral",
	...
	"item.minecraft.friend_pottery_shard": "Fragmento de Cerâmica de Amigo",
	"item.minecraft.friend_pottery_sherd": "Fragmento de Cerâmica de Amigo",
	...
	"item.minecraft.gray_bundle": "Sacola Cinzenta",
	"item.minecraft.gray_dye": "Corante Cinzento",
	"item.minecraft.gray_harness": "Arreios Cinzentos",
	"item.minecraft.green_bundle": "Sacola Verde",
	"item.minecraft.green_dye": "Corante Verde",
	"item.minecraft.green_harness": "Arreios Verdes",
	"item.minecraft.guardian_spawn_egg": "Ovo de Invocação de Guardião",
	"item.minecraft.gunpowder": "Pólvora",
	"item.minecraft.guster_banner_pattern": "Padrão para Estandarte",
	...
	"item.minecraft.guster_pottery_sherd": "Fragmento de Cerâmica de Vórtice",
	"item.minecraft.happy_ghast_spawn_egg": "Ovo de Invocação de Ghast Feliz",
	"item.minecraft.harness": "Arreios",
	"item.minecraft.heart_of_the_sea": "Coração do Mar",
	"item.minecraft.heart_pottery_shard": "Fragmento de Cerâmica de Coração",
	"item.minecraft.heart_pottery_sherd": "Fragmento de Cerâmica de Coração",
	"item.minecraft.heartbreak_pottery_shard": "Fragmento de Cerâmica de Coração Partido",
	"item.minecraft.heartbreak_pottery_sherd": "Fragmento de Cerâmica de Coração Partido",
	...
	"item.minecraft.host_armor_trim_smithing_template.new": "Revestimento de Hospedeiro",
	"item.minecraft.howl_pottery_shard": "Fragmento de Cerâmica de Lobo",
	"item.minecraft.howl_pottery_sherd": "Fragmento de Cerâmica de Lobo",
	...
	"item.minecraft.jungle_boat": "Barco da Selva",
	"item.minecraft.jungle_chest_boat": "Barco da Selva com Baú",
	...
	"item.minecraft.light_blue_bundle": "Sacola Azul-Clara",
	"item.minecraft.light_blue_dye": "Corante Azul-Claro",
	"item.minecraft.light_blue_harness": "Arreios Azul-Claros",
	"item.minecraft.light_gray_bundle": "Sacola Cinzento-Clara",
	"item.minecraft.light_gray_dye": "Corante Cinzento-Claro",
	"item.minecraft.light_gray_harness": "Arreios Cinzento-Claros",
	"item.minecraft.lime_bundle": "Sacola Verde-Lima",
	"item.minecraft.lime_dye": "Corante Verde-Lima",
	"item.minecraft.lime_harness": "Arreios Verde-Limas",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Poção Prolongada de Viscosidade",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Poção Prolongada de Tecedura",
	"item.minecraft.lingering_potion.effect.wind_charged": "Poção Prolongada de Lufada",
	...
	"item.minecraft.magenta_bundle": "Sacola Magenta",
	"item.minecraft.magenta_dye": "Corante Magenta",
	"item.minecraft.magenta_harness": "Arreios Magentas",
	...
	"item.minecraft.miner_pottery_shard": "Fragmento de Cerâmica de Picareta",
	"item.minecraft.miner_pottery_sherd": "Fragmento de Cerâmica de Picareta",
	"item.minecraft.mojang_banner_pattern": "Padrão para Estandarte",
	"item.minecraft.mojang_banner_pattern.desc": "Insígnia",
	"item.minecraft.mojang_banner_pattern.new": "Figura para Estandarte de Insígnia",
	"item.minecraft.mooshroom_spawn_egg": "Ovo de Invocação de Mooshroom",
	"item.minecraft.mourner_pottery_shard": "Fragmento de Cerâmica de Vigilante",
	"item.minecraft.mourner_pottery_sherd": "Fragmento de Cerâmica de Vigilante",
	...
	"item.minecraft.nautilus_spawn_egg": "Ovo de Invocação de Náutilo",
	...
	"item.minecraft.netherite_horse_armor": "Armadura de Netherite para Cavalo",
	"item.minecraft.netherite_ingot": "Lingote de Netherite",
	"item.minecraft.netherite_leggings": "Perneiras de Netherite",
	"item.minecraft.netherite_nautilus_armor": "Armadura de Netherite para Náutilo",
	...
	"item.minecraft.netherite_spear": "Lança de Netherite",
	"item.minecraft.netherite_sword": "Espada de Netherite",
	"item.minecraft.netherite_upgrade_smithing_template": "Molde de Ferraria",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Melhoria de Netherite",
	...
	"item.minecraft.ominous_trial_key": "Chave de Desafio Sombria",
	"item.minecraft.orange_bundle": "Sacola Laranja",
	"item.minecraft.orange_dye": "Corante Laranja",
	"item.minecraft.orange_harness": "Arreios Laranjas",
	"item.minecraft.painting": "Quadro",
	"item.minecraft.pale_oak_boat": "Barco de Carvalho Pálido",
	"item.minecraft.pale_oak_chest_boat": "Barco de Carvalho Pálido com Baú",
	"item.minecraft.panda_spawn_egg": "Ovo de Invocação de Panda",
	"item.minecraft.paper": "Papel",
	"item.minecraft.parched_spawn_egg": "Ovo de Invocação de Esqueleto-Múmia",
	...
	"item.minecraft.pink_bundle": "Sacola Rosa",
	"item.minecraft.pink_dye": "Corante Rosa",
	"item.minecraft.pink_harness": "Arreios Rosas",
	"item.minecraft.pitcher_plant": "Cântara",
	"item.minecraft.pitcher_pod": "Vagem de Cântara",
	"item.minecraft.plenty_pottery_shard": "Fragmento de Cerâmica de Baú",
	"item.minecraft.plenty_pottery_sherd": "Fragmento de Cerâmica de Baú",
	...
	"item.minecraft.potion.effect.oozing": "Poção de Viscosidade",
	...
	"item.minecraft.potion.effect.weaving": "Poção de Tecedura",
	"item.minecraft.potion.effect.wind_charged": "Poção de Lufada",
	"item.minecraft.pottery_shard_archer": "Fragmento de Cerâmica de Arco",
	"item.minecraft.pottery_shard_arms_up": "Fragmento de Cerâmica de Figura",
	"item.minecraft.pottery_shard_prize": "Fragmento de Cerâmica de Joia",
	"item.minecraft.pottery_shard_skull": "Fragmento de Cerâmica de Caveira",
	...
	"item.minecraft.prize_pottery_shard": "Fragmento de Cerâmica de Joia",
	"item.minecraft.prize_pottery_sherd": "Fragmento de Cerâmica de Joia",
	...
	"item.minecraft.purple_bundle": "Sacola Roxa",
	"item.minecraft.purple_dye": "Corante Roxo",
	"item.minecraft.purple_harness": "Arreios Roxos",
	...
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Revestimento de Criador",
	...
	"item.minecraft.red_bundle": "Sacola Vermelha",
	"item.minecraft.red_dye": "Corante Vermelho",
	"item.minecraft.red_harness": "Arreios Vermelhos",
	"item.minecraft.redstone": "Pó de Redstone",
	"item.minecraft.resin_brick": "Tijolo de Resina",
	"item.minecraft.resin_clump": "Torrão de Resina",
	"item.minecraft.rib_armor_trim_smithing_template": "Molde de Ferraria",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Revestimento de Costelas",
	...
	"item.minecraft.scrape_pottery_sherd": "Fragmento de Cerâmica de Machado",
	"item.minecraft.scute": "Escama",
	"item.minecraft.sentry_armor_trim_smithing_template": "Molde de Ferraria",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Revestimento de Sentinela",
	"item.minecraft.shaper_armor_trim_smithing_template": "Molde de Ferraria",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Revestimento de Moldador",
	"item.minecraft.sheaf_pottery_shard": "Fragmento de Cerâmica de Trigo",
	"item.minecraft.sheaf_pottery_sherd": "Fragmento de Cerâmica de Trigo",
	"item.minecraft.shears": "Tesoura",
	"item.minecraft.sheep_spawn_egg": "Ovo de Invocação de Ovelha",
	"item.minecraft.shelter_pottery_shard": "Fragmento de Cerâmica de Árvore",
	"item.minecraft.shelter_pottery_sherd": "Fragmento de Cerâmica de Árvore",
	...
	"item.minecraft.silence_armor_trim_smithing_template.new": "Revestimento de Silêncio",
	...
	"item.minecraft.skull_pottery_shard": "Fragmento de Cerâmica de Caveira",
	"item.minecraft.skull_pottery_sherd": "Fragmento de Cerâmica de Caveira",
	...
	"item.minecraft.smithing_template.armor_trim.additions_slot_description": "Adiciona um lingote ou cristal",
	"item.minecraft.smithing_template.armor_trim.applies_to": "Armadura",
	"item.minecraft.smithing_template.armor_trim.base_slot_description": "Adiciona uma peça de armadura",
	...
	"item.minecraft.smithing_template.netherite_upgrade.additions_slot_description": "Adiciona um Lingote de Netherite",
	"item.minecraft.smithing_template.netherite_upgrade.applies_to": "Equipamento de Diamante",
	"item.minecraft.smithing_template.netherite_upgrade.base_slot_description": "Adiciona uma armadura, arma ou ferramenta de diamante",
	"item.minecraft.smithing_template.netherite_upgrade.ingredients": "Lingote de Netherite",
	"item.minecraft.smithing_template.upgrade": "Melhorias: ",
	"item.minecraft.sniffer_spawn_egg": "Ovo de Invocação de Farejador",
	"item.minecraft.snort_pottery_shard": "Fragmento de Cerâmica de Farejador",
	"item.minecraft.snort_pottery_sherd": "Fragmento de Cerâmica de Farejador",
	"item.minecraft.snout_armor_trim_smithing_template": "Molde de Ferraria",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Revestimento de Focinho",
	...
	"item.minecraft.spire_armor_trim_smithing_template.new": "Revestimento de Espiral",
	...
	"item.minecraft.splash_potion.effect.oozing": "Poção Arremessável de Viscosidade",
	...
	"item.minecraft.splash_potion.effect.weaving": "Poção Arremessável de Tecedura",
	"item.minecraft.splash_potion.effect.wind_charged": "Poção Arremessável de Lufada",
	...
	"item.minecraft.sulfur_cube_bucket": "Cubo de Enxofre num Balde",
	"item.minecraft.sulfur_cube_spawn_egg": "Ovo de Invocação de Cubo de Enxofre",
	...
	"item.minecraft.tide_armor_trim_smithing_template.new": "Revestimento de Marés",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Flecha de Viscosidade",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Flecha de Tecedura",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Flecha de Lufada",
	"item.minecraft.tnt_minecart": "Carrinho de Mina com TNT",
	"item.minecraft.torchflower_seeds": "Sementes de Fagulheira",
	...
	"item.minecraft.trial_key": "Chave de Desafio",
	...
	"item.minecraft.vex_armor_trim_smithing_template.new": "Revestimento de Vex",
	...
	"item.minecraft.ward_armor_trim_smithing_template.new": "Revestimento das Profundezas",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Revestimento de Procurador",
	"item.minecraft.wheat": "Trigo",
	"item.minecraft.wheat_seeds": "Sementes de Trigo",
	"item.minecraft.white_bundle": "Sacola Branca",
	"item.minecraft.white_dye": "Corante Branco",
	"item.minecraft.white_harness": "Arreios Brancos",
	"item.minecraft.wild_armor_trim_smithing_template": "Molde de Ferraria",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Revestimento da Selva",
	"item.minecraft.wind_charge": "Projétil de Vento",
	"item.minecraft.witch_spawn_egg": "Ovo de Invocação de Bruxa",
	"item.minecraft.wither_skeleton_spawn_egg": "Ovo de Invocação de Esqueleto do Wither",
	"item.minecraft.wither_spawn_egg": "Ovo de invocação do Wither",
	...
	"item.minecraft.yellow_bundle": "Sacola Amarela",
	"item.minecraft.yellow_dye": "Corante Amarelo",
	"item.minecraft.yellow_harness": "Arreios Amarelos",
	...
	"item.minecraft.zombie_nautilus_spawn_egg": "Ovo de Invocação de Náutilo-Zombie",
	"item.minecraft.zombie_spawn_egg": "Ovo de Invocação de Zombie",
	"item.minecraft.zombie_villager_spawn_egg": "Ovo de Invocação de Aldeão Zombie",
	...
	"item.op_block_warning.line2": "Usar este item pode acionar um comando.",
	"item.op_block_warning.line3": "Não uses a menos que saibas o conteúdo exato!",
	"item.spawn_egg.peaceful": "Desativado no Pacífico",
	...
	"jigsaw_block.placement_priority": "Prioridade da colocação:",
	"jigsaw_block.placement_priority.tooltip": "Quando o bloco de puzzle se conecta a uma peça, esta é a ordem em que a peça é processada para ligações em grandes estruturas.\n\nO processo ocorre em ordem decrescente, ou aleatoriamente em caso de empate.",
	"jigsaw_block.pool": "Conjunto:",
	"jigsaw_block.selection_priority": "Prioridade de seleção:",
	"jigsaw_block.selection_priority.tooltip": "Ao processar a peça associada às conexões, esta é a ordem em que o bloco de puzzle se tentará conectar à peça-alvo.\n\nO processo ocorre em ordem decrescente, ou aleatoriamente em caso de empate.",
	...
	"key.category.minecraft.gameplay": "Jogabilidade",
	"key.category.minecraft.inventory": "Inventário",
	"key.category.minecraft.misc": "Diversas",
	...
	"key.debug.focusPause": "Alternar pausa ao mudar de janela",
	...
	"key.saveToolbarActivator": "Guardar barra rápida",
	"key.screenshot": "Tirar captura de ecrã",
	"key.smoothCamera": "Câmara cinematográfica",
	"key.sneak": "Agachar",
	...
	"key.toggleSpectatorShaderEffects": "Alternar efeitos de shaders do espectador",
	...
	"known_server_link.report_bug": "Relatar erro do servidor",
	...
	"mco.account.privacy.info.button": "Sabe mais sobre o RGPD",
	"mco.account.privacy.information": "A Mojang implementa certos procedimentos para ajudar a proteger as crianças e a sua privacidade, tais como o cumprimento da Lei de Proteção de Privacidade Online para Crianças (COPPA) e do Regulamento Geral sobre a Proteção de Dados (RGPD).\n\nPrecisas de autorização dos teus pais antes de acederes à tua conta do Realms.",
	"mco.account.privacyinfo": "A Mojang implementa certos procedimentos para ajudar a proteger as crianças e a sua privacidade, tais como o cumprimento da Lei de Proteção de Privacidade Online para Crianças (COPPA) e com o Regulamento Geral sobre a Proteção de Dados (RGPD).\n\nPrecisas de autorização dos teus pais para acederes à conta do Realms.\n\nSe tiveres uma conta antiga do Minecraft (em que inicias sessão com o nome de utilizador), terás de migrar a tua conta para uma conta Mojang antes de acederes ao Realms.",
	...
	"mco.backup.entry.enabledPack": "Pacote(s) ativo(s)",
	...
	"mco.backup.entry.undefined": "Alteração indefinida",
	...
	"mco.backup.narration": "Cópia do dia %s",
	"mco.backup.nobackups": "Este Realm não tem nenhuma cópia.",
	"mco.backup.restoring": "A restaurar o Realm",
	...
	"mco.client.outdated.stable.version": "A versão do cliente (%s) é incompatível com o Realms.\n\nUsa a versão mais recente do Minecraft.",
	"mco.client.unsupported.snapshot.version": "A versão do cliente (%s) é incompatível com o Realms.\n\nO Realms não está disponível para esta Snapshot.",
	"mco.compatibility.downgrade": "Desatualizar",
	"mco.compatibility.downgrade.description": "Este mundo foi jogado pela última vez na versão %s e estás na %s. Mudar um mundo para uma versão anterior pode corrompê-lo. Não é possível garantir que carregue ou funcione.\n\nUma cópia do teu mundo irá ser guardada em \"Cópias\". Se necessário, podes restaurá-lo.",
	"mco.compatibility.incompatible.popup.title": "Versão incompatível",
	"mco.compatibility.incompatible.releaseType.popup.message": "O mundo em que estás a tentar entrar é incompatível com a versão atual.",
	"mco.compatibility.incompatible.series.popup.message": "Este mundo foi jogado pela última vez na versão %s e estás na %s.\n\nEstas versões são incompatíveis entre si. É necessário um novo mundo para jogares nesta versão.",
	"mco.compatibility.unverifiable.message": "Não foi possível verificar a última versão em que este mundo foi jogado. Se o mundo for convertido para uma versão superior ou inferior, irá ser criada e guardada automaticamente uma cópia.",
	"mco.compatibility.unverifiable.title": "Não é possível verificar a compatibilidade",
	"mco.compatibility.upgrade": "Atualizar",
	"mco.compatibility.upgrade.description": "Este mundo foi jogado pela última vez na versão %s e estás na %s.\n\nUma cópia do mundo irá ser guardada em \"Cópias\". \n\nSe necessário podes restaurar o mundo.",
	"mco.compatibility.upgrade.friend.description": "Este mundo foi jogado pela última vez na versão %s e estás na %s.\n\nUma cópia do mundo irá ser guardada em \"Cópias\".\n\nSe necessário, o dono do Realm pode restaurar o mundo.",
	"mco.compatibility.upgrade.title": "Tens a certeza que queres atualizar o mundo?",
	...
	"mco.configure.world.close.question.line1": "Podes fechar temporariamente o Realm, impedindo de ser jogado enquanto o configuras. Volta a abri-lo quando estiveres pronto. \n\nIsto não cancela a tua subscrição do Realms.",
	"mco.configure.world.close.question.line2": "Tens a certeza que queres continuar?",
	"mco.configure.world.close.question.title": "Precisas de fazer alterações sem interrupções?",
	"mco.configure.world.closing": "A fechar temporariamente o Realm...",
	"mco.configure.world.commandBlocks": "Blocos de Comando",
	"mco.configure.world.delete.button": "Eliminar Realm",
	"mco.configure.world.delete.question.line1": "O teu Realm irá ser eliminado permanentemente",
	...
	"mco.configure.world.edit.subscreen.adventuremap": "Algumas definições estão desativadas já que o teu mundo atual é uma aventura",
	...
	"mco.configure.world.invite.narration": "Novo(s) convite(s) recebido(s): %s",
	...
	"mco.configure.world.loading": "A carregar Realm",
	"mco.configure.world.location": "Localização",
	"mco.configure.world.minigame": "Atual: %s",
	"mco.configure.world.name": "Nome do Realm",
	"mco.configure.world.name.validation.whitespace": "O nome não pode iniciar ou acabar com espaços em branco. O espaço irá ser removido.",
	"mco.configure.world.opening": "A abrir o Realm...",
	"mco.configure.world.players.error": "Não há nenhum jogador com esse nome",
	"mco.configure.world.players.invite.duplicate": "Já foi convidado um jogador com esse nome para o Realm",
	"mco.configure.world.players.inviting": "A convidar jogador...",
	"mco.configure.world.players.title": "Jogadores",
	"mco.configure.world.pvp": "PvP",
	"mco.configure.world.region_preference": "Preferência de região",
	"mco.configure.world.region_preference.title": "Seleção de região",
	"mco.configure.world.reset.question.line1": "O teu mundo irá ser recriado e perderás o atual",
	"mco.configure.world.reset.question.line2": "Tens a certeza que queres continuar?",
	"mco.configure.world.resourcepack.question": "Precisas de um pacote de recursos para entrares neste Realm\n\nQueres transferi-lo?",
	...
	"mco.configure.world.restore.download.question.line1": "O mundo irá ser transferido e adicionado aos teus mundos.",
	"mco.configure.world.restore.download.question.line2": "Queres continuar?",
	"mco.configure.world.restore.question.line1": "O mundo irá ser restituído para o dia \"%s\" (%s)",
	"mco.configure.world.restore.question.line2": "Tens a certeza que queres continuar?",
	"mco.configure.world.settings.expired": "Não é possível editar as definições de um Realm expirado",
	...
	"mco.configure.world.spawn_toggle.message": "Desativar esta opção irá remover todas as entidades existentes desse tipo",
	"mco.configure.world.spawn_toggle.message.npc": "Desativar esta opção irá remover todas as entidades existentes desse tipo, como os Aldeões",
	...
	"mco.configure.world.subscription.recurring.info": "As alterações feitas à tua subscrição do Realms, como prolongar o tempo ou desativar o pagamento automático, não irão ser aplicadas até à próxima fatura.",
	...
	"mco.configure.world.subscription.tab": "Subscrição",
	...
	"mco.configure.world.switch.slot.subtitle": "Este mundo está vazio. Escolhe como criá-lo",
	"mco.configure.world.title": "Configurar Realm:",
	"mco.configure.world.uninvite.player": "Tens a certeza que queres anular o convite de \"%s\"?",
	...
	"mco.connect.connecting": "A ligar ao Realm...",
	"mco.connect.failed": "Falha ao ligar ao Realm",
	...
	"mco.create.world.subtitle": "Se preferires, escolhe um mundo para o teu novo Realm",
	...
	"mco.download.confirmation.line2": "Não poderás voltar a carregar este mundo para o teu Realm",
	"mco.download.confirmation.oversized": "O mundo que vais transferir é maior que %s\n\nNão poderás voltar a carregar este mundo para o teu Realm",
	...
	"mco.download.resourcePack.fail": "Falha ao transferir o pacote de recursos!",
	...
	"mco.errorMessage.6002": "Termos de Serviço não aceites",
	"mco.errorMessage.6003": "Limite de transferência atingido",
	...
	"mco.errorMessage.6007": "O utilizador está em demasiados Realms",
	...
	"mco.errorMessage.initialize.failed": "Falha ao iniciar o Realm",
	"mco.errorMessage.noDetails": "Não foram fornecidos dados do erro",
	"mco.errorMessage.realmsService": "Ocorreu um erro (%s):",
	"mco.errorMessage.realmsService.configurationError": "Ocorreu um erro inesperado ao editar as definições do mundo",
	"mco.errorMessage.realmsService.connectivity": "Não há ligação com o Realms: %s",
	...
	"mco.errorMessage.retry": "Tenta novamente",
	"mco.errorMessage.serviceBusy": "O Realms está atualmente indisponível.\nTenta entrar novamente no Realm daqui a uns minutos.",
	...
	"mco.minigame.world.info.line1": "Este mundo irá ser substituído temporariamente por um minijogo!",
	...
	"mco.minigame.world.restore.question.line1": "O minijogo irá terminar e o Realm será restaurado.",
	...
	"mco.minigame.world.title": "Mudar de Realm para minijogo",
	"mco.news": "Novidades do Realms",
	"mco.notification.dismiss": "Fechar",
	"mco.notification.transferSubscription.buttonText": "Transferir",
	"mco.notification.transferSubscription.message": "As subscrições do Realms do Java vão ser transferidas para a Microsoft Store. Não deixes a tua subscrição expirar!\nTransfere e obtém 30 dias de Realms gratuitos.\nVai a Perfil em Minecraft.net para transferires a subscrição.",
	"mco.notification.visitUrl.buttonText.default": "Abrir link",
	"mco.notification.visitUrl.message.default": "Acede ao link abaixo",
	...
	"mco.reset.world.warning": "Isto substituirá o mundo atual do teu Realm",
	...
	"mco.selectServer.create.subtitle": "Seleciona um mundo para o teu novo Realm",
	...
	"mco.selectServer.loading": "A carregar a lista de Realms",
	...
	"mco.selectServer.noRealms": "Parece que não tens nenhum Realm. Adiciona um para jogares com os teus amigos.",
	...
	"mco.selectServer.uninitialized": "Clica para iniciares um novo Realm!",
	"mco.snapshot.createSnapshotPopup.text": "Estás prestes a criar um Realm da Snapshot gratuito, sincronizado com a tua subscrição do Realms. Irá ser acessível enquanto a subscrição estiver ativa. O teu Realm pago não será afetado.",
	"mco.snapshot.createSnapshotPopup.title": "Criar Realm da Snapshot?",
	"mco.snapshot.creating": "A criar Realm da Snapshot...",
	"mco.snapshot.description": "Sincronizado com %s",
	"mco.snapshot.friendsRealm.downgrade": "Usa a versão %s para entrares neste Realm",
	"mco.snapshot.friendsRealm.upgrade": "O Realm de %s tem de ser atualizado para poderes jogares na versão atual",
	"mco.snapshot.paired": "O Realm da Snapshot está sincronizado com %s",
	"mco.snapshot.parent.tooltip": "Usa a versão mais recente do Minecraft para jogares neste Realm",
	"mco.snapshot.start": "Iniciar Snapshot gratuita do Realm",
	"mco.snapshot.subscription.info": "Este Realm da Snapshot está sincronizado com a subscrição do Realm \"%s\". Irá permanecer ativo enquanto o Realm sincronizado também estiver.",
	"mco.snapshot.tooltip": "Usa o Realms da Snapshot para ficares a par das atualizações futuras do Minecraft, recheadas de novas funcionalidades.\n\nOs Realms normais estarão disponíveis nas versões de lançamento do jogo.",
	"mco.snapshotRealmsPopup.message": "Os Realms já estão disponíveis a partir da Snapshot 23w41a. Cada subscrição do Realms inclui uma versão com uma Snapshot gratuita do Realm, separada do teu Realm normal!",
	"mco.snapshotRealmsPopup.title": "Os Realms já estão disponíveis nas Snapshots",
	"mco.snapshotRealmsPopup.urlText": "Saber mais",
	...
	"mco.upload.failed": "Erro ao carregar! (%s)",
	"mco.upload.failed.too_big.description": "O mundo selecionado é demasiado grande. O tamanho máximo é %s.",
	...
	"mco.upload.preparing": "A preparar o mundo",
	"mco.upload.select.world.none": "Não foi encontrado nenhum mundo pessoal!",
	"mco.upload.select.world.subtitle": "Seleciona o mundo pessoal que pretendes carregar",
	...
	"mco.upload.uploading": "A carregar \"%s\"",
	...
	"menu.custom_options.title": "Definições personalizadas",
	"menu.custom_options.tooltip": "Nota: as definições personalizadas são oferecidas por servidores e/ou conteúdo de terceiros.\nTem cuidado!",
	"menu.custom_screen_info.button_narration": "Isto é um ecrã personalizado. Sabe mais.",
	"menu.custom_screen_info.contents": "O conteúdo deste ecrã é controlado por servidores de terceiros e mapas que não pertencem, e não são operados ou supervisionados pela Mojang Studios ou pela Microsoft.\n\nTem cuidado ao abrires links e nunca partilhes informações pessoais com ninguém, tais como os teus dados de acesso.\n\nSe este ecrã te impedir de jogar, podes premir o botão abaixo para saíres do servidor.",
	"menu.custom_screen_info.disconnect": "Ecrã personalizado rejeitado",
	"menu.custom_screen_info.title": "Nota sobre ecrãs personalizados",
	"menu.custom_screen_info.tooltip": "Isto é um ecrã personalizado. Clica aqui para saberes mais.",
	...
	"menu.multiplayerOptions.applyChanges": "Guardar alterações",
	...
	"menu.multiplayerOptions.network.online.tooltip": "Os amigos online podem entrar.",
	"menu.multiplayerOptions.otherPlayers.header": "Outros jogadores",
	"menu.multiplayerOptions.publish.started.lan": "Este mundo está aberto em LAN na porta %s",
	"menu.multiplayerOptions.publish.started.online": "Este mundo está aberto para multijogador online.",
	"menu.multiplayerOptions.publish.stopped": "Este mundo já não está aberto para multijogador",
	...
	"menu.playerReporting.no_players": "Não há jogadores para denunciar neste mundo",
	...
	"menu.reportBugs": "Relatar um erro",
	...
	"multiplayer.codeOfConduct.check": "Não receber notificações sobre este Código de Conduta",
	"multiplayer.codeOfConduct.title": "Código de Conduta do servidor",
	"multiplayer.confirm_command.parse_errors": "Estás prestes a executar um comando desconhecido ou inválido.\nQueres continuar?\nComando: %s",
	"multiplayer.confirm_command.permissions_required": "Estás prestes a executar um comando que requer permissões elevadas.\nIsto pode prejudicar o teu jogo.\nQueres continuar?\nComando: %s",
	"multiplayer.confirm_command.run_command": "Executar comando",
	"multiplayer.confirm_command.signature_required": "Estás prestes a executar um comando que irá enviar mensagens de chat em teu nome.\nSó é possível executá-lo pelo chat\nComando: %s",
	...
	"multiplayer.disconnect.bad_chat_index": "Detetada uma mensagem ausente ou reordenada do servidor",
	"multiplayer.disconnect.banned": "Foste banido deste servidor",
	"multiplayer.disconnect.banned.expiration": "\nBanido até: %s",
	"multiplayer.disconnect.banned.reason": "Foste banido do servidor.\nMotivo: %s",
	"multiplayer.disconnect.banned.reason.default": "Banido por um operador.",
	"multiplayer.disconnect.banned_ip.expiration": "\nBanido até: %s",
	"multiplayer.disconnect.banned_ip.reason": "O teu endereço IP foi bloqueado deste servidor.\nMotivo: %s",
	"multiplayer.disconnect.chat_validation_failed": "Erro ao validar a mensagem",
	"multiplayer.disconnect.code_of_conduct": "O servidor requer a aceitação do Código de Conduta",
	...
	"multiplayer.disconnect.expired_public_key": "A chave pública do perfil expirou. Verifica se as horas do sistema estão sincronizadas e reinicia o jogo.",
	...
	"multiplayer.disconnect.invalid_player_movement": "Pacote de movimento inválido do jogador recebido",
	...
	"multiplayer.disconnect.invalid_public_key_signature.new": "A assinatura para a chave pública do perfil é inválida.\nTenta reiniciar o jogo.",
	"multiplayer.disconnect.invalid_vehicle_movement": "Pacote de movimento inválido do veículo recebido",
	"multiplayer.disconnect.ip_banned": "O teu endereço IP foi bloqueado deste servidor",
	"multiplayer.disconnect.kicked": "Expulso por um operador",
	"multiplayer.disconnect.missing_tags": "Conjunto de etiquetas incompletas recebidas do servidor.\nContacta um operador do servidor.",
	"multiplayer.disconnect.name_taken": "Esse nome já está em uso",
	"multiplayer.disconnect.not_whitelisted": "Não estás na lista branca do servidor!",
	"multiplayer.disconnect.out_of_order_chat": "Foi recebido um pacote de chat corrompido. Alteraste as horas do sistema?",
	"multiplayer.disconnect.outdated_client": "Cliente incompatível! Usa a versão %s",
	"multiplayer.disconnect.outdated_server": "Cliente incompatível! Usa a versão %s",
	...
	"multiplayer.disconnect.transfers_disabled": "Este servidor não aceita transferências",
	...
	"multiplayer.disconnect.unverified_username": "Falha ao validar o nome de utilizador!",
	...
	"multiplayer.requiredTexturePrompt.disconnect": "Este servidor requer um pacote de recursos personalizado",
	"multiplayer.requiredTexturePrompt.line1": "Este servidor requer o uso de um pacote de recursos personalizado.",
	"multiplayer.requiredTexturePrompt.line2": "A ligação ao servidor irá ser interrompida ao rejeitares o pacote de recursos personalizado.",
	...
	"multiplayer.status.anonymous_player": "Jogador anónimo",
	...
	"multiplayer.status.ping.narration": "Ping de %s milissegundos",
	...
	"narration.button.usage.hovered": "Prime o botão esquerdo para ativares",
	"narration.checkbox": "Caixa de verificação: %s",
	"narration.checkbox.usage.focused": "Prime Enter para alternar",
	"narration.checkbox.usage.focused.check": "Prime Enter para marcares",
	"narration.checkbox.usage.focused.uncheck": "Prime Enter para desmarcares",
	"narration.checkbox.usage.hovered": "Prime o botão esquerdo para alternares",
	"narration.checkbox.usage.hovered.check": "Prime o botão esquerdo para marcares",
	"narration.checkbox.usage.hovered.uncheck": "Prime o botão esquerdo para desmarcares",
	"narration.component_list.usage": "Prime Tab para navegares para o próximo elemento",
	"narration.cycle_button.usage.focused": "Prime Enter para mudares para %s",
	"narration.cycle_button.usage.hovered": "Prime o botão esquerdo para mudares para %s",
	"narration.edit_box": "Caixa de edição: %s",
	"narration.item": "Item: %s",
	"narration.link.usage.focused": "Prime Enter para acederes ao link",
	"narration.link.usage.hovered": "Prime o botão esquerdo para acederes ao link",
	"narration.recipe": "Receita de %s",
	"narration.recipe.usage": "Prime o botão esquerdo para selecionares",
	"narration.recipe.usage.more": "Prime o botão direito para mostrar mais receitas",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Prime Enter para começares a mudar o valor da barra",
	...
	"narration.suggestion.usage.cycle.fixed": "Prime Tab para alternares entre sugestões",
	"narration.suggestion.usage.cycle.hidable": "Prime Tab para alternares entre sugestões, ou Esc para saíres",
	"narration.suggestion.usage.fill.fixed": "Prime Tab para usares a sugestão",
	"narration.suggestion.usage.fill.hidable": "Prime Tab para usares a sugestão, ou Esc para saíres",
	"narration.tab_navigation.usage": "Prime Ctrl + Tab para trocares entre separadores",
	...
	"narrator.position.tab": "O separador %s de %s foi selecionado",
	...
	"optimizeWorld.confirm.description": "Isto vai tentar otimizar o teu mundo para que todos os dados sejam guardados no formato de jogo mais recente, o que pode demorar bastante tempo, dependendo do mundo. Quando estiver otimizado, o teu mundo pode tornar-se mais rápido, mas irá deixar de ser compatível com as versões anteriores do jogo. Tens a certeza que queres continuar?",
	...
	"optimizeWorld.stage.finished": "A terminar...",
	"optimizeWorld.stage.finished.chunks": "A terminar a atualização dos chunks...",
	"optimizeWorld.stage.finished.entities": "A terminar a atualização das entidades...",
	"optimizeWorld.stage.finished.poi": "A terminar a atualização dos pontos de interesse...",
	"optimizeWorld.stage.upgrading": "A atualizar todos os chunks...",
	"optimizeWorld.stage.upgrading.chunks": "A atualizar todos os chunks...",
	"optimizeWorld.stage.upgrading.entities": "A atualizar todas as entidades...",
	"optimizeWorld.stage.upgrading.poi": "A atualizar todos os pontos de interesse...",
	...
	"options.accessibility.high_contrast.error.tooltip": "O pacote de recursos de alto contraste não está disponível",
	"options.accessibility.high_contrast.tooltip": "Melhora o contraste da interface.",
	"options.accessibility.high_contrast_block_outline": "Contraste do contorno dos blocos",
	"options.accessibility.high_contrast_block_outline.tooltip": "Aumenta o contraste do contorno dos blocos.",
	"options.accessibility.link": "Guia de acessibilidade",
	"options.accessibility.menu_background_blurriness": "Desfocagem do fundo",
	"options.accessibility.menu_background_blurriness.tooltip": "Altera a desfocagem do fundo dos menus.",
	...
	"options.allowCursorChanges.tooltip": "Permite alterações do cursor ao passar sobre determinados elementos da interface.",
	"options.allowFriendRequests": "Permitir pedidos",
	"options.allowFriendRequests.tooltip": "Permitir que os outros jogadores te enviem pedidos de amizade",
	"options.allowServerListing": "Nome em listas",
	"options.allowServerListing.tooltip": "Os servidores podem listar jogadores que fazem parte do público.\nCom esta opção desativada, o teu nome não aparece nestas listas.",
	...
	"options.chat.drafts": "Guardar mensagens não enviadas",
	"options.chat.drafts.tooltip": "Mensagens não enviadas irão ser guardadas e podem ser enviadas ao abrir o chat.",
	...
	"options.chunkFade": "Duração de transição dos chunks",
	"options.chunkFade.none": "Transição dos chunks: Nenhuma",
	"options.chunkFade.seconds": "Transição dos chunks: %s segundo(s)",
	"options.chunkFade.tooltip": "Duração em segundos para a transição dos chunks no primeiro processamento, se for aplicável.",
	...
	"options.cutoutLeaves.tooltip": "Permite ver por entre as folhas. Desativa para melhorares o desempenho.",
	"options.damageTiltStrength": "Balanço de dano",
	"options.damageTiltStrength.tooltip": "Controla a intensidade do balanço da visão quando recebes dano.",
	...
	"options.difficulty.easy.info": "As criaturas hostis causam pouco dano. Perdes gradualmente até 5 corações de vida quando a barra de fome ficar vazia.",
	"options.difficulty.hard": "Difícil",
	"options.difficulty.hard.info": "As criaturas hostis causam bastante dano. Perdes gradualmente todos os corações de vida quando a barra de fome ficar vazia.",
	"options.difficulty.hardcore": "Hardcore",
	"options.difficulty.normal": "Normal",
	"options.difficulty.normal.info": "As criaturas hostis causam algum dano. Perdes gradualmente até meio coração de vida quando a barra de fome ficar vazia.",
	"options.difficulty.online": "Dificuldade",
	"options.difficulty.peaceful": "Pacífica",
	"options.difficulty.peaceful.info": "Não há criaturas hostis, apenas algumas criaturas neutras. A vida regenera gradualmente e a barra de fome não se esvazia completamente.",
	...
	"options.exclusiveFullscreen": "Ecrã inteiro exclusivo",
	"options.exclusiveFullscreen.warningTooltip": "Esta opção pode impedir que alguns métodos de entrada funcionem.",
	"options.font": "Fonte...",
	"options.font.title": "Definições de fonte",
	...
	"options.friendsList.confirm.message": "Usa a lista de amigos para enviares e receberes pedidos de amizade.\n\nGere esta definição de segurança online através da %s.",
	...
	"options.glintSpeed": "Velocidade da reflexão",
	"options.glintSpeed.tooltip": "Controla a velocidade da reflexão nos itens encantados.",
	"options.glintStrength": "Intensidade da reflexão",
	"options.glintStrength.tooltip": "Controla a intensidade da reflexão nos itens encantados.",
	...
	"options.graphics.fancy": "Elegante",
	...
	"options.graphics.preset.tooltip": "Define a \"Qualidade e desempenho\" para valores correspondentes ao nível de qualidade pretendido.",
	"options.graphics.warning.accept": "Continuar sem suporte",
	"options.graphics.warning.cancel": "Voltar",
	"options.graphics.warning.message": "A placa gráfica é incompatível com a opção \"%s\".\n\nPodes ignorar este aviso e continuar, mas o teu dispositivo não irá ser suportado se optares por usar esta opção gráfica.",
	...
	"options.graphicsApi.restart": "Tens de reiniciar o jogo para alterares a API gráfica.",
	"options.graphicsApi.tooltip": "Escolhe a API gráfica usada no processamento dos gráficos. Deixa no Padrão, a menos que haja um motivo para a alterares.",
	...
	"options.hideLightningFlashes.tooltip": "Impede que os relâmpagos clareiem o céu. Os raios em si ainda irão ser visíveis.",
	"options.hideMatchedNames": "Ocultar por nome",
	"options.hideMatchedNames.tooltip": "As mensagens enviadas nos servidores de terceiros podem usar formatos incomuns.\nCom esta opção ativada, os jogadores ocultos irão ser associados aos nomes dos remetentes das mensagens.",
	...
	"options.improvedTransparency": "Transparência melhorada",
	"options.improvedTransparency.tooltip": "Gráficos experimentais que usam shaders para desenhar o clima, as nuvens e as partículas através da água e de blocos translúcidos.\nIsto irá afetar o desempenho da placa gráfica.",
	"options.inGameNotification": "Notificação no jogo",
	"options.inGameNotification.tooltip": "Mostrar notificações de amigos no jogo",
	"options.inactivityFpsLimit": "Reduzir FPS ao",
	"options.inactivityFpsLimit.afk": "Ausentar-se",
	"options.inactivityFpsLimit.afk.tooltip": "Limita a taxa de FPS para 30 após um minuto de inatividade do jogador. Reduz para 10 fps após 9 minutos.",
	"options.inactivityFpsLimit.minimized": "Minimizar",
	"options.inactivityFpsLimit.minimized.tooltip": "Limita a taxa de FPS quando o jogo está minimizado.",
	"options.invertMouse": "Inverter rato",
	"options.invertMouseX": "Inverter eixo X do rato",
	"options.invertMouseY": "Inverter eixo Y do rato",
	"options.japaneseGlyphVariants": "Escrita japonesa",
	...
	"options.languageWarning": "As traduções são um esforço colaborativo da comunidade",
	...
	"options.maxAnisotropy.tooltip": "Cada nível melhora significativamente a suavidade das texturas, mas impacta o desempenho e o uso da memória gráfica. Requer a filtragem anisotrópica.",
	...
	"options.music_frequency.default": "Predefinido",
	"options.music_frequency.frequent": "Frequente",
	"options.music_frequency.tooltip": "Altera com que frequência as músicas são tocadas num mundo.",
	...
	"options.needsRestart": "A opção será guardada após reiniciares o jogo.",
	"options.notifications.display_time": "Duração das notificações",
	"options.notifications.display_time.tooltip": "Controla a duração das notificações no ecrã.",
	"options.off": "Não",
	...
	"options.prioritizeChunkUpdates.byPlayer.tooltip": "Algumas ações dentro de um chunk irão recompilar a área de imediato. Isto inclui colocar e destruir blocos.",
	...
	"options.realmsNotifications.tooltip": "Procura por novidades e convites do Realms no menu principal e mostra os respetivos ícones no botão do Realms.",
	...
	"options.restartRequired": "Reinicia o jogo para guardares algumas das alterações.",
	"options.rotateWithMinecart": "Rodar com os carrinhos",
	"options.rotateWithMinecart.tooltip": "Define a rotação da visão do jogador num Carrinho de Mina a girar. Só disponível em mundos com a definição experimental \"Melhorias dos Carrinhos de Mina\" ativada.",
	...
	"options.sharePresence": "Estado",
	"options.sharePresence.all": "Sim",
	"options.sharePresence.all.tooltip": "O estado é partilhado com os teus amigos. Apareces online e a tua atividade é visível.",
	"options.sharePresence.limited": "Limitado",
	"options.sharePresence.limited.tooltip": "O estado é limitado. Apareces online e podes convidar os teus amigos, mas a tua atividade não é visível.",
	"options.sharePresence.none": "Não",
	"options.sharePresence.none.tooltip": "O estado não é visível. Apareces offline.",
	"options.showNowPlayingToast": "Mostrar faixa musical",
	"options.showNowPlayingToast.tooltip": "Mostra um alerta após uma música começar a tocar. O alerta é mostrado constantemente no menu de pausa do jogo enquanto a música está a tocar.",
	...
	"options.sprintWindow.tooltip": "Intervalo de tempo (em tiques) no qual premir duas vezes a tecla para a frente ativa a corrida.",
	...
	"options.textureFiltering.anisotropic.tooltip": "Uma filtragem com base no hardware que impacta o desempenho e o uso da memória de vídeo. Pode não ser compatível com todos os dispositivos.",
	...
	"options.textureFiltering.rgss.tooltip": "(Super Amostragem de Grelha Rotativa)\nUma filtragem com base em shaders que melhora a qualidade das texturas e impacta moderadamente o desempenho.",
	"options.title": "Opções",
	"options.touchscreen": "Ecrã tátil",
	"options.value": "%s",
	"options.video": "Gráficos...",
	"options.video.display.header": "Visualização",
	...
	"options.vignette.tooltip": "Uma textura discreta aplicada sobre o ecrã do jogo para reduzir o brilho nas bordas no ecrã e para realçar a barreira do mundo.",
	"options.visible": "Visível",
	"options.vsync": "VSync",
	"options.weatherRadius": "Raio do efeito atmosférico",
	"options.weatherRadius.tooltip": "Raio da área de visibilidade dos efeitos de chuva e neve. Impacto de desempenho muito baixo.",
	...
	"pack.dropRejected.message": "As entradas seguintes não eram pacotes válidos e não foram copiadas:\n %s",
	...
	"pack.incompatible.confirm.unknown": "Este pacote está corrompido ou foi feito para uma versão desconhecida do Minecraft e pode não funcionar corretamente.",
	...
	"parsing.quote.escape": "Sequência de escape \"\\%s\" inválida na cadeia introduzida",
	...
	"quickplay.error.realm_connect": "Não foi possível ligar ao Realm",
	"quickplay.error.realm_permission": "Não tens permissão para entrar neste Realm",
	"quickplay.error.title": "Falha ao entrar num jogo rápido",
	...
	"realms.configuration.region.japan_east": "Japão (Este)",
	...
	"realms.configuration.region_preference.automatic_owner": "Automática (região do dono)",
	...
	"recover_world.bug_tracker": "Relatar um erro",
	"recover_world.button": "Tentar recuperar",
	"recover_world.done.failed": "Falha ao recuperar a partir de um estado anterior.",
	"recover_world.done.success": "O mundo foi recuperado!",
	"recover_world.done.title": "Recuperação concluída",
	"recover_world.issue.missing_file": "Ficheiro em falta",
	"recover_world.issue.none": "Sem problemas",
	"recover_world.message": "Ocorreram os seguintes problemas ao tentar ler a pasta do mundo \"%s\".\nTenta restaurar o mundo a partir de um estado anterior ou relata este erro.",
	"recover_world.no_fallback": "Não há estados de recuperação disponíveis",
	"recover_world.restore": "Tentar restaurar",
	"recover_world.restoring": "A tentar restaurar o mundo...",
	"recover_world.state_entry": "Estado a %s: ",
	...
	"resourcePack.runtime_failure": "Erro detetado no pacote de recursos",
	...
	"restrictions_screen.permission.receive_player_messages.allowed": "Podes receber mensagens de jogadores",
	"restrictions_screen.permission.receive_player_messages.denied": "Não podes receber mensagens de jogadores",
	"restrictions_screen.permission.receive_system_messages.allowed": "Podes receber mensagens de sistema do servidor",
	"restrictions_screen.permission.receive_system_messages.denied": "Não podes receber mensagens de sistema do servidor",
	"restrictions_screen.permission.send_commands.allowed": "Podes enviar comandos",
	"restrictions_screen.permission.send_commands.denied": "Não podes enviar comandos",
	"restrictions_screen.permission.send_messages.allowed": "Podes enviar mensagens de chat",
	"restrictions_screen.permission.send_messages.denied": "Não podes enviar mensagens de chat",
	...
	"selectServer.deleteWarning": "\"%s\" irá ser perdido para sempre! (é muito tempo!)",
	...
	"selectWorld.access_failure": "Falha ao aceder ao mundo",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Criar uma cópia antes de atualizares este mundo?",
	"selectWorld.backupQuestion.snapshot": "Queres mesmo carregar este mundo?",
	"selectWorld.backupWarning.customized": "Infelizmente, os mundos personalizados não são suportados nesta versão do Minecraft. Ainda podemos carregar este mundo e manter tudo como estava, mas qualquer terreno novo gerado não irá ser personalizado. Pedimos desculpa!",
	"selectWorld.backupWarning.downgrade": "Este mundo foi jogado pela última vez na versão %s e estás na %s. Mudar um mundo para uma versão anterior pode corrompê-lo. Não é possível garantir que carregue ou funcione. Se mesmo assim quiseres continuar, faz uma cópia.",
	"selectWorld.backupWarning.experimental": "Este mundo usa definições experimentais que podem deixar de funcionar a qualquer altura. Não podemos garantir que carregue nem que funcione!",
	"selectWorld.backupWarning.file_fixing_required": "Este mundo tem de ser atualizado para a versão mais recente antes de poder ser jogado. Sugerimos que cries uma cópia antes de continuares, para evitar que o mundo seja corrompido.",
	"selectWorld.backupWarning.snapshot": "Este mundo foi jogado pela última vez na versão %s e estás na %s. Faz uma cópia para evitares que o mundo seja corrompido.",
	...
	"selectWorld.deleteWarning": "\"%s\" irá ser perdido para sempre! (é muito tempo!)",
	"selectWorld.delete_failure": "Falha ao eliminar o mundo",
	...
	"selectWorld.experimental.message": "Cuidado! \nEsta configuração requer funcionalidades ainda em desenvolvimento. O teu mundo pode fechar, corromper ou deixar de funcionar em atualizações futuras.",
	"selectWorld.experimental.title": "Aviso de funcionalidades experimentais",
	"selectWorld.experiments": "Experiências",
	"selectWorld.experiments.info": "As experiências são funcionalidades novas que podem não funcionar corretamente. Não é possível desativá-las após a criação do mundo.",
	...
	"selectWorld.gameMode.adventure.info": "É igual ao Modo Sobrevivência, mas não podes colocar ou partir blocos.",
	...
	"selectWorld.gameMode.creative.info": "Cria, constrói e explora sem limites. Podes voar, ter materiais infinitos e não és atacado por monstros.",
	...
	"selectWorld.gameMode.hardcore.info": "É igual ao Modo Sobrevivência, mas bloqueado na dificuldade \"Difícil\". Não podes renascer se morreres.",
	...
	"selectWorld.gameMode.spectator.info": "Podes olhar, mas não tocar.",
	"selectWorld.gameMode.spectator.line1": "Podes olhar, mas não podes tocar",
	"selectWorld.gameMode.survival": "Sobrevivência",
	"selectWorld.gameMode.survival.info": "Explora um mundo misterioso onde podes construir, recolher, criar e lutar com monstros.",
	...
	"selectWorld.incompatible.description": "Não é possível abrir este mundo nesta versão.\nFoi jogado pela última vez na %s.",
	"selectWorld.incompatible.info": "Versão incompatível: %s",
	"selectWorld.incompatible.title": "Versão incompatível",
	"selectWorld.incompatible.tooltip": "Este mundo não pode ser aberto porque foi criado numa versão incompatível.",
	"selectWorld.incompatible_series": "Criado numa versão incompatível",
	"selectWorld.load_folder_access": "Não foi possível ler ou aceder à pasta dos mundos guardados!",
	"selectWorld.loading_list": "A carregar lista de mundos",
	"selectWorld.locked": "Mundo aberto noutra sessão do Minecraft.",
	"selectWorld.mapFeatures": "Gerar estruturas",
	"selectWorld.mapFeatures.info": "Aldeias, naufrágios etc.",
	...
	"selectWorld.recreate.customized.text": "Os mundos personalizados já não são suportados nesta versão do Minecraft. Podemos tentar recriá-lo com a mesma seed e propriedades, mas quaisquer alterações ao terreno original irão ser perdidas. Pedimos desculpa!",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Este mundo tem de ser atualizado para a versão mais recente antes de poder ser editado devido às mudanças estruturais do formato do mundo.",
	"selectWorld.requiresFileFixingTooltip.play": "Este mundo tem de ser atualizado para a versão mais recente antes de poder ser jogado devido às mudanças estruturais do formato do mundo.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Este mundo tem de ser atualizado para a versão mais recente antes de poder ser recriado devido às mudanças estruturais do formato do mundo.",
	"selectWorld.resource_load": "A preparar recursos...",
	"selectWorld.resultFolder": "Guardado em:",
	...
	"selectWorld.targetFolder": "Guardado em: %s",
	...
	"selectWorld.versionWarning": "Este mundo foi jogado pela última vez na versão %s. Carregá-lo nesta versão pode corrompê-lo!",
	"selectWorld.waitingForBackup.message": "Isto pode demorar, dependendo do tamanho do mundo. Não feches o jogo ou desligues o dispositivo.",
	"selectWorld.waitingForBackup.title": "A criar cópia",
	...
	"selectWorld.warning.deprecated.title": "Aviso! As definições usam funcionalidades ultrapassadas",
	"selectWorld.warning.experimental.question": "As definições são experimentais e podem deixar de funcionar a qualquer altura. Queres mesmo continuar?",
	"selectWorld.warning.experimental.title": "Aviso! As definições usam funcionalidades experimentais",
	"selectWorld.warning.lowDiskSpace.description": "Não tens muito espaço no disco.\nFicar sem espaço durante o jogo pode corromper o mundo.",
	"selectWorld.warning.lowDiskSpace.title": "Aviso! Pouco espaço no disco!",
	"selectWorld.world": "Mundo",
	"selectWorld.world_gen_settings_access": "Não foi possível ler ou aceder ao ficheiro de definições da geração de mundo! %s",
	"selecteWorld.backupRequiredTooltip": "É necessária uma cópia antes de carregares o mundo",
	...
	"sleep.skipping_night": "A passar a noite",
	...
	"snbt.parser.expected_float_type": "Espera-se um número de vírgula flutuante",
	"snbt.parser.expected_hex_escape": "Espera-se um literal de caráter de comprimento %s",
	...
	"snbt.parser.infinity_not_allowed": "Não são permitidos números não finitos",
	"snbt.parser.invalid_array_element_type": "Tipo de elemento de matriz inválido",
	"snbt.parser.invalid_character_name": "Nome de caráter Unicode inválido",
	"snbt.parser.invalid_codepoint": "Valor de caráter Unicode inválido: %s",
	"snbt.parser.invalid_string_contents": "Conteúdos da cadeia inválidos",
	"snbt.parser.invalid_unquoted_start": "Cadeias sem aspas não podem começar por dígitos de 0 a 9, + ou -",
	"snbt.parser.leading_zero_not_allowed": "Números decimais não podem começar por 0",
	"snbt.parser.no_such_operation": "Nenhuma operação: %s",
	"snbt.parser.number_parse_failure": "Falha ao analisar o número: %s",
	"snbt.parser.undescore_not_allowed": "Não são permitidos caracteres sublinhados no início ou no final de um número",
	...
	"stat.minecraft.boat_one_cm": "Distância com barco",
	...
	"stat.minecraft.strider_one_cm": "Distância com vagante",
	...
	"stat.minecraft.walk_under_water_one_cm": "Distância debaixo de água",
	...
	"structure_block.detect_size": "Detetar posição e tamanho da estrutura:",
	...
	"structure_block.mode_info.corner": "Canto — Marcador de colocação e tamanho",
	"structure_block.mode_info.data": "Dados — Marcador de lógica do jogo",
	"structure_block.mode_info.load": "Carregamento — Carregar do ficheiro",
	"structure_block.mode_info.save": "Gravação — Guardar no ficheiro",
	...
	"structure_block.size_success": "Tamanho da estrutura \"%s\" detetado",
	"structure_block.strict": "Posição exata:",
	"structure_block.structure_name": "Nome da estrutura",
	"subtitles.ambient.cave": "Ruído sinistro",
	"subtitles.ambient.sound": "Ruído sinistro",
	...
	"subtitles.block.copper_bulb.turn_off": "Lâmpada de Cobre apaga-se",
	"subtitles.block.copper_bulb.turn_on": "Lâmpada de Cobre acende",
	...
	"subtitles.block.crafter.craft": "Mesa Automática cria",
	"subtitles.block.crafter.fail": "Mesa Automática falha",
	"subtitles.block.creaking_heart.hurt": "Coração de Rangente grunhe",
	"subtitles.block.creaking_heart.idle": "Ruído sinistro",
	"subtitles.block.creaking_heart.spawn": "Coração de Rangente desperta",
	"subtitles.block.deadbush.idle": "Sons secos",
	"subtitles.block.decorated_pot.insert": "Vaso Decorado enchido",
	"subtitles.block.decorated_pot.insert_fail": "Vaso Decorado abana",
	"subtitles.block.decorated_pot.shatter": "Vaso parte-se",
	...
	"subtitles.block.dried_ghast.transition": "Ghast Seco animado",
	...
	"subtitles.block.eyeblossom.close": "Olheira fecha-se",
	"subtitles.block.eyeblossom.idle": "Olheira sussurra",
	"subtitles.block.eyeblossom.open": "Olheira abre-se",
	...
	"subtitles.block.firefly_bush.idle": "Pirilampos zumbem",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Tabuleta abana",
	...
	"subtitles.block.pale_hanging_moss.idle": "Ruído sinistro",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Géiser de enxofre rebenta",
	"subtitles.block.potent_sulfur.noxious_gas": "Gás tóxico aparece",
	...
	"subtitles.block.respawn_anchor.ambient": "Ruídos de Âncora de Renascimento",
	...
	"subtitles.block.sign.waxed_interact_fail": "Tabuleta abana",
	...
	"subtitles.block.trial_spawner.about_to_spawn_item": "Item sombrio preparado",
	"subtitles.block.trial_spawner.ambient": "Gerador Reforçado crepita",
	"subtitles.block.trial_spawner.ambient_charged": "Crepitação sombria",
	"subtitles.block.trial_spawner.ambient_ominous": "Crepitação sombria",
	"subtitles.block.trial_spawner.charge_activate": "Presságio afeta Gerador Reforçado",
	"subtitles.block.trial_spawner.close_shutter": "Gerador Reforçado fechado",
	"subtitles.block.trial_spawner.detect_player": "Gerador Reforçado carrega",
	"subtitles.block.trial_spawner.eject_item": "Gerador Reforçado ejeta itens",
	"subtitles.block.trial_spawner.ominous_activate": "Presságio afeta Gerador Reforçado",
	"subtitles.block.trial_spawner.open_shutter": "Gerador Reforçado aberto",
	...
	"subtitles.block.trial_spawner.spawn_mob": "Criatura nasce",
	...
	"subtitles.block.vault.reject_rewarded_player": "Cofre rejeita jogador",
	...
	"subtitles.entity.armadillo.hurt": "Tatu aleija-se",
	"subtitles.entity.armadillo.hurt_reduced": "Tatu protege-se",
	"subtitles.entity.armadillo.land": "Tatu aterra",
	"subtitles.entity.armadillo.peek": "Tatu espreita",
	"subtitles.entity.armadillo.roll": "Tatu enrola-se",
	"subtitles.entity.armadillo.scute_drop": "Tatu larga escama",
	"subtitles.entity.armadillo.unroll_finish": "Tatu desenrola-se",
	"subtitles.entity.armadillo.unroll_start": "Tatu espreita",
	...
	"subtitles.entity.baby_cat.hurt": "Gatinho aleija-se",
	"subtitles.entity.baby_cat.purr": "Gatinho ronrona",
	"subtitles.entity.baby_chicken.ambient": "Pintainho pia",
	"subtitles.entity.baby_chicken.death": "Pintainho morre",
	"subtitles.entity.baby_chicken.hurts": "Pintainho aleija-se",
	...
	"subtitles.entity.baby_horse.hurt": "Potro aleija-se",
	"subtitles.entity.baby_horse.land": "Potro aterra",
	"subtitles.entity.baby_nautilus.ambient": "Náutilo Bebé chia",
	"subtitles.entity.baby_nautilus.ambient_land": "Náutilo Bebé chia",
	"subtitles.entity.baby_nautilus.death": "Náutilo Bebé morre",
	"subtitles.entity.baby_nautilus.death_land": "Náutilo Bebé morre",
	"subtitles.entity.baby_nautilus.eat": "Náutilo Bebé come",
	"subtitles.entity.baby_nautilus.hurt": "Náutilo Bebé aleija-se",
	"subtitles.entity.baby_nautilus.hurt_land": "Náutilo Bebé aleija-se",
	"subtitles.entity.baby_nautilus.swim": "Náutilo Bebé nada",
	...
	"subtitles.entity.baby_pig.hurt": "Leitão aleija-se",
	"subtitles.entity.baby_wolf.ambient": "Lobo Bebé ladra",
	"subtitles.entity.baby_wolf.death": "Lobo Bebé morre",
	"subtitles.entity.baby_wolf.growl": "Lobo Bebé rosna",
	"subtitles.entity.baby_wolf.hurt": "Lobo Bebé aleija-se",
	"subtitles.entity.baby_wolf.pant": "Lobo Bebé arfa",
	"subtitles.entity.baby_wolf.whine": "Lobo Bebé gane",
	...
	"subtitles.entity.bogged.ambient": "Enlameado chocalha",
	"subtitles.entity.bogged.death": "Enlameado morre",
	"subtitles.entity.bogged.hurt": "Enlameado aleija-se",
	"subtitles.entity.breeze.charge": "Vórtice carrega",
	"subtitles.entity.breeze.death": "Vórtice morre",
	"subtitles.entity.breeze.deflect": "Vórtice desvia-se",
	"subtitles.entity.breeze.hurt": "Vórtice aleija-se",
	"subtitles.entity.breeze.idle_air": "Vórtice voa",
	"subtitles.entity.breeze.idle_ground": "Vórtice sibila",
	"subtitles.entity.breeze.inhale": "Vórtice inspira",
	"subtitles.entity.breeze.jump": "Vórtice salta",
	"subtitles.entity.breeze.land": "Vórtice aterra",
	"subtitles.entity.breeze.shoot": "Vórtice atira",
	"subtitles.entity.breeze.slide": "Vórtice desliza",
	"subtitles.entity.breeze.whirl": "Vórtice sibila",
	"subtitles.entity.breeze.wind_burst": "Projétil de Vento explode",
	...
	"subtitles.entity.camel_husk.ambient": "Dromedário-Múmia grunhe",
	"subtitles.entity.camel_husk.dash": "Dromedário-Múmia lança-se",
	"subtitles.entity.camel_husk.dash_ready": "Dromedário-Múmia recupera",
	"subtitles.entity.camel_husk.death": "Dromedário-Múmia morre",
	"subtitles.entity.camel_husk.eat": "Dromedário-Múmia come",
	"subtitles.entity.camel_husk.hurt": "Dromedário-Múmia aleija-se",
	"subtitles.entity.camel_husk.saddle": "Sela equipada",
	"subtitles.entity.camel_husk.sit": "Dromedário-Múmia senta-se",
	"subtitles.entity.camel_husk.stand": "Dromedário-Múmia levanta-se",
	...
	"subtitles.entity.copper_golem.hurt": "Golem de Cobre aleija-se",
	...
	"subtitles.entity.copper_golem.no_item_get": "Golem de Cobre apanha um item",
	"subtitles.entity.copper_golem.no_item_no_get": "Golem de Cobre não pode apanhar um item",
	"subtitles.entity.copper_golem.spawn": "Golem de Cobre aparece",
	"subtitles.entity.copper_golem.spin": "Cabeça de Golem de Cobre gira",
	...
	"subtitles.entity.copper_golem_oxidized.hurt": "Golem de Cobre aleija-se",
	"subtitles.entity.copper_golem_oxidized.spin": "Cabeça de Golem de Cobre gira",
	"subtitles.entity.copper_golem_weathered.death": "Golem de Cobre morre",
	"subtitles.entity.copper_golem_weathered.hurt": "Golem de Cobre aleija-se",
	"subtitles.entity.copper_golem_weathered.spin": "Cabeça de Golem de Cobre gira",
	...
	"subtitles.entity.creaking.spawn": "Rangente vive",
	"subtitles.entity.creaking.sway": "Rangente atacado",
	"subtitles.entity.creaking.twitch": "Rangente contrai-se",
	...
	"subtitles.entity.fish.swim": "Salpicos",
	...
	"subtitles.entity.generic.wind_burst": "Projétil de vento explode",
	...
	"subtitles.entity.ghastling.ambient": "Ghastito canta",
	"subtitles.entity.ghastling.death": "Ghastito morre",
	"subtitles.entity.ghastling.hurt": "Ghastito aleija-se",
	"subtitles.entity.ghastling.spawn": "Ghastito aparece",
	...
	"subtitles.entity.happy_ghast.equip": "Arreios equipados",
	...
	"subtitles.entity.happy_ghast.hurt": "Ghast Feliz aleija-se",
	"subtitles.entity.happy_ghast.unequip": "Arreios retirados",
	...
	"subtitles.entity.minecart.inside": "Carrinho de Mina abana",
	"subtitles.entity.minecart.inside_underwater": "Carrinho de Mina submerso abana",
	...
	"subtitles.entity.mooshroom.suspicious_milk": "Mooshroom ordenhada de modo suspeito",
	...
	"subtitles.entity.nautilus.dash": "Náutilo propela-se",
	"subtitles.entity.nautilus.dash_land": "Náutilo propela-se",
	"subtitles.entity.nautilus.dash_ready": "Náutilo recupera",
	"subtitles.entity.nautilus.dash_ready_land": "Náutilo recupera",
	...
	"subtitles.entity.nautilus.hurt": "Náutilo aleija-se",
	"subtitles.entity.nautilus.hurt_land": "Náutilo aleija-se",
	...
	"subtitles.entity.parched.ambient": "Esqueleto-Múmia chocalha",
	"subtitles.entity.parched.death": "Esqueleto-Múmia morre",
	"subtitles.entity.parched.hurt": "Esqueleto-Múmia aleija-se",
	...
	"subtitles.entity.parrot.imitate.bogged": "Papagaio imita um Enlameado",
	"subtitles.entity.parrot.imitate.breeze": "Papagaio imita um Vórtice",
	"subtitles.entity.parrot.imitate.camel_husk": "Papagaio imita um Dromedário-Múmia",
	...
	"subtitles.entity.parrot.imitate.ender_dragon": "Papagaio imita o Dragão do Ender",
	...
	"subtitles.entity.parrot.imitate.parched": "Papagaio imita um Esqueleto-Múmia",
	...
	"subtitles.entity.parrot.imitate.wither_skeleton": "Papagaio imita um Esqueleto do Wither",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Papagaio imita um Cavalo-Zombie",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Papagaio imita um Náutilo-Zombie",
	"subtitles.entity.parrot.imitate.zombie_villager": "Papagaio imita um Aldeão Zombie",
	...
	"subtitles.entity.player.teleport": "Jogador teletransporta-se",
	"subtitles.entity.polar_bear.ambient": "Urso-Polar grunhe",
	"subtitles.entity.polar_bear.ambient_baby": "Urso-Polar Bebé sibila",
	...
	"subtitles.entity.sniffer.digging_stop": "Farejador levanta-se",
	"subtitles.entity.sniffer.drop_seed": "Farejador larga semente",
	...
	"subtitles.entity.sniffer.happy": "Farejador alegre",
	"subtitles.entity.sniffer.hurt": "Farejador aleija-se",
	...
	"subtitles.entity.sulfur_cube.bounce": "Cubo de Enxofre ressalta",
	...
	"subtitles.entity.sulfur_cube.hurt": "Cubo de Enxofre aleija-se",
	...
	"subtitles.entity.wind_charge.wind_burst": "Projétil de Vento explode",
	...
	"subtitles.entity.wither_skeleton.ambient": "Esqueleto do Wither chocalha",
	"subtitles.entity.wither_skeleton.death": "Esqueleto do Wither morre",
	"subtitles.entity.wither_skeleton.hurt": "Esqueleto do Wither aleija-se",
	"subtitles.entity.wolf.ambient": "Lobo arfa",
	"subtitles.entity.wolf.bark": "Lobo ladra",
	"subtitles.entity.wolf.death": "Lobo morre",
	"subtitles.entity.wolf.growl": "Lobo rosna",
	"subtitles.entity.wolf.hurt": "Lobo aleija-se",
	"subtitles.entity.wolf.pant": "Lobo arfa",
	"subtitles.entity.wolf.shake": "Lobo sacode-se",
	"subtitles.entity.wolf.whine": "Lobo gane",
	...
	"subtitles.entity.zombie_horse.angry": "Cavalo-Zombie relincha",
	"subtitles.entity.zombie_horse.death": "Cavalo-Zombie morre",
	"subtitles.entity.zombie_horse.eat": "Cavalo-Zombie come",
	"subtitles.entity.zombie_horse.hurt": "Cavalo-Zombie aleija-se",
	"subtitles.entity.zombie_nautilus.ambient": "Náutilo-Zombie borbulha",
	"subtitles.entity.zombie_nautilus.ambient_land": "Náutilo-Zombie borbulha",
	"subtitles.entity.zombie_nautilus.dash": "Náutilo-Zombie propela-se",
	"subtitles.entity.zombie_nautilus.dash_land": "Náutilo-Zombie propela-se",
	"subtitles.entity.zombie_nautilus.dash_ready": "Náutilo-Zombie recupera",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Náutilo-Zombie recupera",
	"subtitles.entity.zombie_nautilus.death": "Náutilo-Zombie morre",
	"subtitles.entity.zombie_nautilus.death_land": "Náutilo-Zombie morre",
	"subtitles.entity.zombie_nautilus.eat": "Náutilo-Zombie come",
	"subtitles.entity.zombie_nautilus.hurt": "Náutilo-Zombie aleija-se",
	"subtitles.entity.zombie_nautilus.hurt_land": "Náutilo-Zombie aleija-se",
	"subtitles.entity.zombie_nautilus.swim": "Náutilo-Zombie nada",
	"subtitles.entity.zombie_villager.ambient": "Aldeão Zombie grunhe",
	"subtitles.entity.zombie_villager.converted": "Aldeão Zombie vocifera",
	"subtitles.entity.zombie_villager.cure": "Aldeão Zombie resmunga",
	"subtitles.entity.zombie_villager.death": "Aldeão Zombie morre",
	"subtitles.entity.zombie_villager.hurt": "Aldeão Zombie aleija-se",
	...
	"subtitles.item.brush.brushing.generic": "A escovar",
	"subtitles.item.brush.brushing.gravel": "A escovar Gravilha",
	"subtitles.item.brush.brushing.gravel.complete": "Gravilha escovada",
	"subtitles.item.brush.brushing.sand": "A escovar Areia",
	...
	"subtitles.item.bundle.insert_fail": "Sacola cheia",
	...
	"subtitles.item.lead.break": "Corda parte-se",
	"subtitles.item.lead.tied": "Corda atada",
	"subtitles.item.lead.untied": "Corda desatada",
	...
	"subtitles.item.ominous_bottle.dispose": "Frasco parte-se",
	...
	"subtitles.item.spear.attack": "Lança perfura",
	"subtitles.item.spear.hit": "Lança atinge",
	"subtitles.item.spear.lunge": "Lança estoca",
	"subtitles.item.spear.use": "Lança carregada",
	"subtitles.item.spear_wood.attack": "Lança perfura",
	"subtitles.item.spear_wood.hit": "Lança atinge",
	"subtitles.item.spear_wood.use": "Lança carregada",
	...
	"subtitles.item.wolf_armor.break": "Armadura de Lobo parte-se",
	"subtitles.item.wolf_armor.crack": "Armadura de Lobo racha",
	"subtitles.item.wolf_armor.damage": "Armadura de Lobo danifica-se",
	...
	"subtitles.ui.hud.bubble_pop": "Respiração baixa",
	...
	"symlink_warning.message": "Carregar mundos de pastas com links simbólicos pode ser perigoso se não souberes o que estás a fazer. Vai a %s para saberes mais.",
	"symlink_warning.message.pack": "Carregar pacotes com links simbólicos pode ser perigoso se não souberes o que estás a fazer. Vai a %s para saberes mais.",
	"symlink_warning.message.world": "Carregar mundos de pastas com links simbólicos pode ser perigoso se não souberes o que estás a fazer. Vai a %s para saberes mais.",
	"symlink_warning.more_info": "Saber mais",
	"symlink_warning.title": "A pasta do mundo contém links simbólicos",
	"symlink_warning.title.pack": "Os pacotes adicionados contêm links simbólicos",
	...
	"team.collision.pushOwnTeam": "Colisão entre jogadores da mesma equipa",
	...
	"telemetry.event.advancement_made.description": "Compreender o contexto de uma proeza pode ajudar-nos a melhorar a progressão do jogo.",
	"telemetry.event.advancement_made.title": "Proezas alcançadas",
	"telemetry.event.game_load_times.description": "Este evento pode ajudar-nos a compreender as melhorias de desempenho de arranque necessárias ao medir os tempos de execução das fases.",
	"telemetry.event.game_load_times.title": "Tempos de carregamento do jogo",
	"telemetry.event.graphics_capabilities.description": "Este evento informa-nos sobre as capacidades do dispositivo gráfico usado durante o jogo.",
	...
	"telemetry.event.p2p_connection.description": "Este evento ajuda-nos a detetar a estabilidade e o desempenho das ligações ponto-a-ponto entre jogadores. Regista se a ligação foi estabelecida com êxito, o tipo de candidato utilizado (também conhecido por Interactive Connectivity Establishment, ou ICE, que é usado para estabelecer ligações ponto-a-ponto), e a duração para estabelecer a ligação.",
	"telemetry.event.p2p_connection.title": "Ligação ponto-a-ponto",
	...
	"telemetry.event.world_load_times.description": "É importante para nós saber o tempo que demora a entrar num mundo e como isso muda a longo do tempo. Por exemplo, quando adicionamos novas funcionalidades ou fazemos grandes mudanças técnicas, necessitamos de saber o impacto que têm nos tempos de carregamento.",
	...
	"telemetry.event.world_unloaded.description": "Este evento está sincronizado com o \"mundo carregado\" para calcular a duração da sessão de jogo.\nA duração (em segundos e tiques) é medida no final de uma sessão de jogo (ao sair para o menu principal ou de um servidor).",
	...
	"telemetry.property.backend_failure_message.title": "Mensagem de erro ao criar a API gráfica",
	"telemetry.property.backend_failure_missing_capabilities.title": "Erro ao criar a API gráfica por falta de capacidades",
	"telemetry.property.backend_failure_reason.title": "Motivo do erro ao criar a API gráfica",
	"telemetry.property.backend_name.title": "Nome da API gráfica",
	...
	"telemetry.property.frame_rate_samples.title": "Amostras de fotogramas por segundo (FPS)",
	...
	"telemetry.property.load_time_bootstrap_ms.title": "Tempo de arranque (milissegundos)",
	"telemetry.property.load_time_loading_overlay_ms.title": "Tempo no ecrã de carregamento (milissegundos)",
	"telemetry.property.load_time_pre_window_ms.title": "Tempo antes da janela abrir (milissegundos)",
	"telemetry.property.load_time_total_time_ms.title": "Tempo total de carregamento (milissegundos)",
	...
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Tempo de ligação (em milissegundos) do Interactive Connectivity Establishment (ICE)",
	...
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Tempo de ligação da sinalização (milissegundos)",
	"telemetry.property.p2p_connection_successful.title": "Ligado com sucesso",
	"telemetry.property.p2p_connection_total_time_ms.title": "Tempo de ligação total (milissegundos)",
	...
	"telemetry_info.opt_in.description": "Autorizo o envio de telemetria adicional",
	"telemetry_info.property_title": "Dados incluídos",
	"telemetry_info.screen.description": "Estes dados ajudam-nos a melhorar o Minecraft, destacando os pontos mais relevantes para os jogadores. Podes ainda enviar-nos sugestões que nos ajudem a melhorar o jogo.",
	...
	"test.error.block_property_missing": "Propriedade de bloco em falta. Espera-se que a propriedade %s seja %s",
	...
	"test.error.expected_block_tag": "Espera-se o bloco na etiqueta #%s, obteve-se %s",
	...
	"test.error.expected_entity_around": "Espera-se que a entidade %s exista à volta de %s, %s, %s",
	"test.error.expected_entity_count": "Espera-se %s entidade(s) do tipo %s, encontrada(s): %s",
	...
	"test.error.expected_items_count": "Esperam-se %s itens do tipo %s, encontrado(s): %s",
	"test.error.fail": "Condições de falha atendidas",
	"test.error.invalid_block_type": "Tipo de bloco inesperado encontrado: %s",
	"test.error.missing_block_entity": "Bloco-entidade em falta",
	...
	"test.error.sequence.invalid_tick": "Êxito no tique inválido. Espera-se: %s",
	"test.error.sequence.minimum_tick": "Êxito antes do tique esperado: esperava-se em %s",
	...
	"test.error.ticking_without_structure": "Teste de tiques antes de colocar a estrutura",
	"test.error.timeout.no_result": "O teste não foi concluído ou falhou dentro de %s tique(s)",
	"test.error.timeout.no_sequences_finished": "Nenhuma sequência terminada dentro de %s tique(s)",
	"test.error.too_many_entities": "Espera-se só uma entidade %s à volta de %s, %s, %s mas há %s",
	...
	"test_block.error.missing": "Estrutura de teste com o bloco em falta: %s",
	"test_block.error.too_many": "Há demasiados blocos (%s)",
	...
	"test_block.mode.log": "Registar",
	"test_block.mode.start": "Iniciar",
	"test_block.mode_info.accept": "Aceite — Aceitar o êxito de (parte de) um teste",
	"test_block.mode_info.fail": "Falha — Falhar o teste",
	"test_block.mode_info.log": "Registo — Registar uma mensagem",
	...
	"test_instance.action.save": "Guardar estrutura",
	...
	"test_instance.type.function": "Teste de função incorporada",
	"test_instance_block.entities": "Entidades:",
	"test_instance_block.error.no_test": "Não foi possível executar a instância de teste em %s, %s, %s porque tem um teste indefinido.",
	"test_instance_block.error.no_test_structure": "Não foi possível executar a instância de teste em %s, %s, %s porque não há nenhuma estrutura de teste",
	"test_instance_block.error.unable_to_save": "Não foi possível guardar o modelo de estrutura de teste da instância de teste em %s, %s, %s",
	...
	"title.32bit.deprecation": "Detetámos que estás a usar um sistema de 32 bits. Isto pode impedir-te de jogar no futuro, visto que irá ser necessário um sistema de 64 bits!",
	"title.32bit.deprecation.realms": "O Minecraft vai passar a exigir um sistema de 64 bits, impedindo que jogues ou uses o Realms neste dispositivo. Irás ter de cancelar manualmente qualquer subscrição do Realms.",
	...
	"title.credits": "Copyright da Mojang AB. Não distribuir!",
	"title.multiplayer.disabled": "O modo multijogador está desativado. Verifica as definições da conta Microsoft.",
	"title.multiplayer.disabled.banned.name": "Tens de alterar o teu nome para jogares online",
	"title.multiplayer.disabled.banned.permanent": "A tua conta está suspensa permanentemente do modo online",
	...
	"trim_material.minecraft.netherite": "Material de netherite",
	...
	"trim_pattern.minecraft.bolt": "Revestimento de parafuso",
	"trim_pattern.minecraft.coast": "Revestimento do litoral",
	"trim_pattern.minecraft.dune": "Revestimento de dunas",
	"trim_pattern.minecraft.eye": "Revestimento de olho",
	"trim_pattern.minecraft.flow": "Revestimento de fluxo",
	"trim_pattern.minecraft.host": "Revestimento de hospedeiro",
	"trim_pattern.minecraft.raiser": "Revestimento de criador",
	"trim_pattern.minecraft.rib": "Revestimento de costelas",
	"trim_pattern.minecraft.sentry": "Revestimento de sentinela",
	"trim_pattern.minecraft.shaper": "Revestimento de moldador",
	"trim_pattern.minecraft.silence": "Revestimento de silêncio",
	"trim_pattern.minecraft.snout": "Revestimento de focinho",
	"trim_pattern.minecraft.spire": "Revestimento de espiral",
	"trim_pattern.minecraft.tide": "Revestimento de marés",
	"trim_pattern.minecraft.vex": "Revestimento de vex",
	"trim_pattern.minecraft.ward": "Revestimento das profundezas",
	"trim_pattern.minecraft.wayfinder": "Revestimento de procurador",
	"trim_pattern.minecraft.wild": "Revestimento da selva",
	"tutorial.bundleInsert.description": "Prime o botão direito",
	...
	"upgrade.minecraft.netherite_upgrade": "Melhoria de netherite",
	"upgradeWorld.aborted.message": "Isto pode acontecer se outro programa acedeu ao mundo durante a atualização.\nTenta reiniciar o computador e tenta novamente. Se o problema persistir, relata este erro.",
	"upgradeWorld.aborted.reportBug": "Relatar um erro",
	"upgradeWorld.aborted.title": "Falha ao atualizar o mundo",
	"upgradeWorld.canceled.message": "O mundo ficou como estava.",
	"upgradeWorld.canceled.title": "Atualização do mundo cancelada",
	"upgradeWorld.done": "Atualização do mundo concluída",
	"upgradeWorld.failed_cleanup.message": "O mundo foi atualizado para a versão atual e já está disponível na lista de mundos.\nEncontramos erros ao apagar os dados desatualizados, por isso o nome da pasta do mundo foi alterado para %s.",
	...
	"upgradeWorld.info.scanning": "A analisar ficheiros...",
	"upgradeWorld.info.total": "Total: %s",
	"upgradeWorld.joinNow": "Queres entrar no mundo agora?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "A mover ficheiros",
	"upgradeWorld.progress.type.legacy_structures": "A atualizar estruturas antigas",
	"upgradeWorld.progress.type.region": "A atualizar regiões",
	"upgradeWorld.symlink.message": "O mundo selecionado contém links simbólicos. \nAs fases necessárias para atualizar o mundo para a versão atual não são compatíveis com o uso de links simbólicos. Resolve este problema antes de atualizares o mundo.",
	"upgradeWorld.symlink.title": "Não é possível atualizar o mundo",
	"upgradeWorld.title": "A atualizar ficheiros do mundo",
}
