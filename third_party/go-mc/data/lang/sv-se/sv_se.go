// Code generated by tools/gen_lang.go from 26.1/sv_se.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Tillgänglighet...",
	"accessibility.onboarding.accessibility.button.narration": "Tillgänglighetsinställningar",
	...
	"advMode.notEnabled": "Kommandoblock är inte aktiverade",
	"advMode.notEnabled.spawner": "Skaparblock är inte aktiverade",
	"advMode.previousOutput": "Föregående utmatning",
	"advMode.setCommand": "Ange konsolkommando för block",
	"advMode.setCommand.disabled": "Angivet kommando: %s, men kommandoblock är fortfarande inaktiverade",
	...
	"advancements.adventure.blowback.description": "Döda ett vindväsen med en blockerad vindattack från ett vindväsen",
	"advancements.adventure.blowback.title": "Vilken blåsning",
	"advancements.adventure.brush_armadillo.description": "Få hornplåtar från ett bältdjur med en borste",
	"advancements.adventure.brush_armadillo.title": "Borsta, borsta!",
	...
	"advancements.adventure.crafters_crafting_crafters.description": "Var nära en tillverkare när den tillverkar en tillverkare",
	"advancements.adventure.crafters_crafting_crafters.title": "Tillverkare tillverkar tillverkare",
	...
	"advancements.adventure.heart_transplanter.description": "Placera ett knarrhjärta mellan två bleka ekstamsblock i samma riktning",
	"advancements.adventure.heart_transplanter.title": "Hjärttransplantation",
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Döda en varelse i närheten av en sculkkatalysator",
	"advancements.adventure.kill_mob_near_sculk_catalyst.title": "Det sprider sig",
	"advancements.adventure.lighten_up.description": "Skrapa en kopparlampa med en yxa för att få den att lysa starkare",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Kliv in i en utmaningskammare",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Utmaningsutgåvan",
	"advancements.adventure.ol_betsy.description": "Avfyra ett armborst",
	"advancements.adventure.ol_betsy.title": "Gamla Bettan",
	"advancements.adventure.overoverkill.description": "Utdela 50 hjärtan i skada med en enda träff från en stridsklubba",
	"advancements.adventure.overoverkill.title": "Grovt övervåld",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Läs av redstonesignalen från en mejslad bokhylla med hjälp av en jämförare",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Böckernas kraft",
	"advancements.adventure.revaulting.description": "Lås upp ett oroväckande kassaskåp med en oroväckande utmaningsnyckel",
	"advancements.adventure.revaulting.title": "Kassaskåpsknäckare",
	...
	"advancements.adventure.spear_many_mobs.description": "Träffa fem varelser med en framåtriktad attack från ett spjut",
	"advancements.adventure.spear_many_mobs.title": "Allt på ett spett",
	...
	"advancements.adventure.trade_at_world_height.title": "Skyhöga priser",
	...
	"advancements.adventure.trim_with_any_armor_pattern.description": "Tillämpa rustningsdetaljer vid en smedsbänk",
	...
	"advancements.adventure.under_lock_and_key.description": "Lås upp ett kassaskåp med en utmaningsnyckel",
	"advancements.adventure.under_lock_and_key.title": "Bakom lås och bom",
	"advancements.adventure.use_lodestone.description": "Använd en kompass på magnetit",
	"advancements.adventure.use_lodestone.title": "Led mig hem, magnetit",
	...
	"advancements.adventure.who_needs_rockets.description": "Använd en vindladdning för att skicka upp dig 8 block i luften",
	"advancements.adventure.who_needs_rockets.title": "Vem behöver raketer?",
	...
	"advancements.husbandry.feed_snifflet.description": "Mata en sniffarunge",
	...
	"advancements.husbandry.obtain_sniffer_egg.title": "En intressant lukt",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Placera en uttorkad ghast i vatten",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Två liter om dagen!",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Ta bort rustningen från en varg med en sax",
	"advancements.husbandry.remove_wolf_armor.title": "Klipp, klipp!",
	"advancements.husbandry.repair_wolf_armor.description": "Reparera en skadad vargrustning helt och hållet med hornplåtar från ett bältdjur",
	"advancements.husbandry.repair_wolf_armor.title": "Så gott som ny",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Använd en lägereld för att samla upp honung från en bikupa i en glasflaska utan att reta upp bina",
	"advancements.husbandry.safely_harvest_honey.title": "Bilateral vapenvila",
	"advancements.husbandry.silk_touch_nest.description": "Använd silkesvante för att flytta ett bisamhälle eller en bikupa med 3 bin inuti",
	...
	"advancements.husbandry.uh_oh.description": "Få en svavelkub att absorbera ett dynamitblock",
	"advancements.husbandry.uh_oh.title": "Ojdå",
	...
	"advancements.husbandry.whole_pack.description": "Tämj alla vargvarianter",
	"advancements.husbandry.whole_pack.title": "Hela flocken",
	...
	"advancements.nether.obtain_blaze_rod.description": "Få en stav från en brännare",
	...
	"argument.block.tag.disallowed": "Taggar är inte tillåtna här, endast riktiga block är det",
	...
	"argument.hexcolor.invalid": "\"%s\" är en ogiltig hexadecimal färgkod",
	...
	"argument.item.tag.disallowed": "Taggar är inte tillåtna här, endast riktiga föremål är det",
	...
	"argument.message.too_long": "Chattleddelandet var för långt (%s > maximalt %s tecken)",
	"argument.nbt.array.invalid": "\"%s\" är en ogiltig arraytyp",
	"argument.nbt.array.mixed": "Kan inte infoga %s i %s",
	"argument.nbt.expected.compound": "Sammansatt tagg förväntades",
	...
	"argument.nbt.trailing": "Efterföljande data förväntades inte",
	...
	"argument.resource_or_id.failed_to_parse": "Misslyckades att tolka strukturen: %s",
	"argument.resource_or_id.invalid": "Ogiltigt ID eller ogiltig tagg",
	"argument.resource_or_id.no_such_element": "Kan inte hitta elementet \"%s\" i registret \"%s\"",
	"argument.resource_selector.not_found": "Inga matchningar för väljaren \"%s\" av typen \"%s\"",
	...
	"argument.style.invalid": "\"%s\" är en ogiltig stil",
	...
	"argument.waypoint.invalid": "Den valda entiteten är inte en vägpunkt",
	...
	"arguments.item.component.expected": "Föremålskomponent förväntades",
	"arguments.item.component.malformed": "\"%[2]s\" är en ogiltig komponent av typen \"%[1]s\"",
	"arguments.item.component.repeated": "Föremålskomponenten \"%s\" upprepades, men endast en kan anges",
	"arguments.item.component.unknown": "\"%s\" är en okänd föremålskomponent",
	"arguments.item.malformed": "\"%s\" är ett ogiltigt föremål",
	"arguments.item.overstacked": "%s kan bara grupperas upp till %s",
	"arguments.item.predicate.malformed": "\"%[2]s\" är ett ogiltigt predikat av typen \"%[1]s\"",
	"arguments.item.predicate.unknown": "\"%s\" är ett okänt föremålspredikat",
	...
	"attribute.name.air_drag_modifier": "modifierare för luftmotstånd",
	"attribute.name.armor": "rustning",
	"attribute.name.armor_toughness": "rustningshårdhet",
	"attribute.name.attack_damage": "attackskada",
	"attribute.name.attack_knockback": "attackknuff",
	"attribute.name.attack_speed": "attackhastighet",
	"attribute.name.below_name_distance": "poängskyltsavstånd",
	"attribute.name.block_break_speed": "blockbrytningshastighet",
	"attribute.name.block_interaction_range": "räckvidd för blockinteraktion",
	"attribute.name.bounciness": "studs",
	"attribute.name.burning_time": "brinntid",
	"attribute.name.camera_distance": "kameraavstånd",
	"attribute.name.entity_interaction_range": "räckvidd för entitetsinteraktion",
	"attribute.name.explosion_knockback_resistance": "knuffresistens för explosioner",
	"attribute.name.fall_damage_multiplier": "multiplikator för fallskada",
	"attribute.name.flying_speed": "flyghastighet",
	"attribute.name.follow_range": "förföljelseräckvidd för monster",
	"attribute.name.friction_modifier": "modifierare för friktion",
	...
	"attribute.name.generic.block_interaction_range": "räckvidd för blockinteraktion",
	"attribute.name.generic.burning_time": "brinntid",
	"attribute.name.generic.entity_interaction_range": "räckvidd för entitetsinteraktion",
	"attribute.name.generic.explosion_knockback_resistance": "knuffresistens för explosioner",
	"attribute.name.generic.fall_damage_multiplier": "multiplikator för fallskada",
	"attribute.name.generic.flying_speed": "flyghastighet",
	"attribute.name.generic.follow_range": "förföljelseräckvidd för monster",
	"attribute.name.generic.gravity": "gravitation",
	"attribute.name.generic.jump_strength": "hoppstyrka",
	"attribute.name.generic.knockback_resistance": "knuffresistens",
	"attribute.name.generic.luck": "tur",
	"attribute.name.generic.max_absorption": "maxabsorbering",
	"attribute.name.generic.max_health": "maxhälsa",
	"attribute.name.generic.movement_efficiency": "rörelseeffektivitet",
	"attribute.name.generic.movement_speed": "hastighet",
	"attribute.name.generic.oxygen_bonus": "syrebonus",
	"attribute.name.generic.safe_fall_distance": "säker fallhöjd",
	"attribute.name.generic.scale": "skala",
	"attribute.name.generic.step_height": "steghöjd",
	"attribute.name.generic.water_movement_efficiency": "rörelseeffektivitet i vatten",
	"attribute.name.gravity": "gravitation",
	"attribute.name.horse.jump_strength": "hästhoppstyrka",
	"attribute.name.jump_strength": "hoppstyrka",
	"attribute.name.knockback_resistance": "knuffresistens",
	"attribute.name.luck": "tur",
	"attribute.name.max_absorption": "maxabsorbering",
	"attribute.name.max_health": "maxhälsa",
	"attribute.name.mining_efficiency": "gräveffektivitet",
	"attribute.name.movement_efficiency": "rörelseeffektivitet",
	"attribute.name.movement_speed": "hastighet",
	"attribute.name.nameplate_distance": "namnskyltsavstånd",
	"attribute.name.oxygen_bonus": "syrebonus",
	"attribute.name.player.block_break_speed": "blockbrytningshastighet",
	"attribute.name.player.block_interaction_range": "räckvidd för blockinteraktion",
	"attribute.name.player.entity_interaction_range": "räckvidd för entitetsinteraktion",
	"attribute.name.player.mining_efficiency": "gräveffektivitet",
	"attribute.name.player.sneaking_speed": "smyghastighet",
	"attribute.name.player.submerged_mining_speed": "grävhastighet under vatten",
	"attribute.name.player.sweeping_damage_ratio": "förhållande till svepande skada",
	"attribute.name.safe_fall_distance": "säker fallhöjd",
	"attribute.name.scale": "skala",
	"attribute.name.sneaking_speed": "smyghastighet",
	"attribute.name.spawn_reinforcements": "zombieförstärkningar",
	"attribute.name.step_height": "steghöjd",
	"attribute.name.submerged_mining_speed": "grävhastighet under vatten",
	"attribute.name.sweeping_damage_ratio": "förhållande till svepande skada",
	"attribute.name.tempt_range": "lockelseräckvidd för varelser",
	"attribute.name.water_movement_efficiency": "rörelseeffektivitet i vatten",
	"attribute.name.waypoint_receive_range": "detektionsavstånd för vägpunkt",
	"attribute.name.waypoint_transmit_range": "transmissionsavstånd för vägpunkt",
	...
	"biome.minecraft.pale_garden": "Blek trädgård",
	...
	"biome.minecraft.sulfur_caves": "Svavelgrottor",
	...
	"block.minecraft.acacia_shelf": "Akaciahylla",
	...
	"block.minecraft.bamboo_shelf": "Bambuhylla",
	...
	"block.minecraft.banner.base.lime": "Limegrön bakgrund",
	...
	"block.minecraft.banner.flow.cyan": "Turkos virvel",
	"block.minecraft.banner.flow.gray": "Grå virvel",
	"block.minecraft.banner.flow.green": "Grön virvel",
	"block.minecraft.banner.flow.light_blue": "Ljusblå virvel",
	"block.minecraft.banner.flow.light_gray": "Ljusgrå virvel",
	"block.minecraft.banner.flow.lime": "Limegrön virvel",
	"block.minecraft.banner.flow.magenta": "Ljuslila virvel",
	"block.minecraft.banner.flow.orange": "Orange virvel",
	"block.minecraft.banner.flow.pink": "Rosa virvel",
	"block.minecraft.banner.flow.purple": "Lila virvel",
	"block.minecraft.banner.flow.red": "Röd virvel",
	"block.minecraft.banner.flow.white": "Vit virvel",
	...
	"block.minecraft.banner.guster.black": "Svart vindväsen",
	"block.minecraft.banner.guster.blue": "Blått vindväsen",
	"block.minecraft.banner.guster.brown": "Brunt vindväsen",
	"block.minecraft.banner.guster.cyan": "Turkost vindväsen",
	"block.minecraft.banner.guster.gray": "Grått vindväsen",
	"block.minecraft.banner.guster.green": "Grönt vindväsen",
	"block.minecraft.banner.guster.light_blue": "Ljusblått vindväsen",
	"block.minecraft.banner.guster.light_gray": "Ljusgrått vindväsen",
	"block.minecraft.banner.guster.lime": "Limegrönt vindväsen",
	"block.minecraft.banner.guster.magenta": "Ljuslila vindväsen",
	"block.minecraft.banner.guster.orange": "Orange vindväsen",
	"block.minecraft.banner.guster.pink": "Rosa vindväsen",
	"block.minecraft.banner.guster.purple": "Lila vindväsen",
	"block.minecraft.banner.guster.red": "Rött vindväsen",
	"block.minecraft.banner.guster.white": "Vitt vindväsen",
	"block.minecraft.banner.guster.yellow": "Gult vindväsen",
	...
	"block.minecraft.banner.piglin.lime": "Limegrönt tryne",
	...
	"block.minecraft.birch_shelf": "Björkhylla",
	...
	"block.minecraft.bush": "Buske",
	"block.minecraft.cactus": "Kaktus",
	"block.minecraft.cactus_flower": "Kaktusblomma",
	...
	"block.minecraft.cherry_shelf": "Körsbärshylla",
	...
	"block.minecraft.chiseled_cinnabar": "Mejslad cinnober",
	"block.minecraft.chiseled_copper": "Mejslad koppar",
	...
	"block.minecraft.chiseled_resin_bricks": "Mejslat hartstegel",
	"block.minecraft.chiseled_sandstone": "Mejslad sandsten",
	"block.minecraft.chiseled_stone_bricks": "Mejslad mursten",
	"block.minecraft.chiseled_sulfur": "Mejslat svavel",
	"block.minecraft.chiseled_tuff": "Mejslad tuff",
	"block.minecraft.chiseled_tuff_bricks": "Mejslad tuffmursten",
	"block.minecraft.chorus_flower": "Körblomma",
	"block.minecraft.chorus_plant": "Körplanta",
	"block.minecraft.cinnabar": "Cinnober",
	"block.minecraft.cinnabar_brick_slab": "Cinnobermurstensplatta",
	"block.minecraft.cinnabar_brick_stairs": "Cinnobermurstenstrappa",
	"block.minecraft.cinnabar_brick_wall": "Cinnobermurstensmur",
	"block.minecraft.cinnabar_bricks": "Cinnobermursten",
	"block.minecraft.cinnabar_slab": "Cinnoberplatta",
	"block.minecraft.cinnabar_stairs": "Cinnobertrappa",
	"block.minecraft.cinnabar_wall": "Cinnobermur",
	"block.minecraft.clay": "Lera",
	"block.minecraft.closed_eyeblossom": "Stängd ögonblomma",
	...
	"block.minecraft.copper_bars": "Koppargaller",
	"block.minecraft.copper_block": "Kopparblock",
	"block.minecraft.copper_bulb": "Kopparlampa",
	"block.minecraft.copper_chain": "Kopparkedja",
	"block.minecraft.copper_chest": "Kopparkista",
	"block.minecraft.copper_door": "Koppardörr",
	"block.minecraft.copper_golem_statue": "Koppargolemstaty",
	"block.minecraft.copper_grate": "Kopparnät",
	"block.minecraft.copper_lantern": "Kopparlykta",
	"block.minecraft.copper_ore": "Kopparmalm",
	"block.minecraft.copper_torch": "Kopparfackla",
	"block.minecraft.copper_trapdoor": "Kopparfallucka",
	"block.minecraft.copper_wall_torch": "Kopparfackla på vägg",
	...
	"block.minecraft.crafter": "Tillverkare",
	"block.minecraft.crafting_table": "Arbetsbänk",
	"block.minecraft.creaking_heart": "Knarrhjärta",
	...
	"block.minecraft.crimson_shelf": "Karmosinhylla",
	...
	"block.minecraft.dark_oak_shelf": "Mörk ekhylla",
	...
	"block.minecraft.dried_ghast": "Uttorkad ghast",
	...
	"block.minecraft.exposed_chiseled_copper": "Exponerad mejslad koppar",
	"block.minecraft.exposed_copper": "Exponerad koppar",
	"block.minecraft.exposed_copper_bars": "Exponerat koppargaller",
	"block.minecraft.exposed_copper_bulb": "Exponerad kopparlampa",
	"block.minecraft.exposed_copper_chain": "Exponerad kopparkedja",
	"block.minecraft.exposed_copper_chest": "Exponerad kopparkista",
	"block.minecraft.exposed_copper_door": "Exponerad koppardörr",
	"block.minecraft.exposed_copper_golem_statue": "Exponerad koppargolemstaty",
	"block.minecraft.exposed_copper_grate": "Exponerat kopparnät",
	"block.minecraft.exposed_copper_lantern": "Exponerad kopparlykta",
	"block.minecraft.exposed_copper_trapdoor": "Exponerad kopparfallucka",
	...
	"block.minecraft.exposed_lightning_rod": "Exponerad åskledare",
	...
	"block.minecraft.firefly_bush": "Eldflugsbuske",
	...
	"block.minecraft.golden_dandelion": "Gyllene maskros",
	...
	"block.minecraft.heavy_core": "Tung kärna",
	...
	"block.minecraft.iron_chain": "Järnkedja",
	...
	"block.minecraft.jungle_shelf": "Djungelhylla",
	...
	"block.minecraft.leaf_litter": "Lövrester",
	...
	"block.minecraft.lime_candle": "Limegrönt stearinljus",
	...
	"block.minecraft.mangrove_shelf": "Mangrovehylla",
	...
	"block.minecraft.oak_shelf": "Ekhylla",
	...
	"block.minecraft.open_eyeblossom": "Öppen ögonblomma",
	...
	"block.minecraft.oxidized_chiseled_copper": "Ärgad mejslad koppar",
	"block.minecraft.oxidized_copper": "Ärgad koppar",
	"block.minecraft.oxidized_copper_bars": "Ärgat koppargaller",
	"block.minecraft.oxidized_copper_bulb": "Ärgad kopparlampa",
	"block.minecraft.oxidized_copper_chain": "Ärgad kopparkedja",
	"block.minecraft.oxidized_copper_chest": "Ärgad kopparkista",
	"block.minecraft.oxidized_copper_door": "Ärgad koppardörr",
	"block.minecraft.oxidized_copper_golem_statue": "Ärgad koppargolemstaty",
	"block.minecraft.oxidized_copper_grate": "Ärgat kopparnät",
	"block.minecraft.oxidized_copper_lantern": "Ärgad kopparlykta",
	"block.minecraft.oxidized_copper_trapdoor": "Ärgad kopparfallucka",
	...
	"block.minecraft.oxidized_lightning_rod": "Ärgad åskledare",
	"block.minecraft.packed_ice": "Packad is",
	"block.minecraft.packed_mud": "Packad gyttja",
	"block.minecraft.pale_hanging_moss": "Hängande blek mossa",
	"block.minecraft.pale_moss_block": "Blekt mossblock",
	"block.minecraft.pale_moss_carpet": "Blek mossmatta",
	"block.minecraft.pale_oak_button": "Blek ekknapp",
	"block.minecraft.pale_oak_door": "Blek ekdörr",
	"block.minecraft.pale_oak_fence": "Blekt ekstaket",
	"block.minecraft.pale_oak_fence_gate": "Blek ekgrind",
	"block.minecraft.pale_oak_hanging_sign": "Hängande blek ekskylt",
	"block.minecraft.pale_oak_leaves": "Bleka eklöv",
	"block.minecraft.pale_oak_log": "Blek ekstam",
	"block.minecraft.pale_oak_planks": "Bleka ekplankor",
	"block.minecraft.pale_oak_pressure_plate": "Blek ektryckplatta",
	"block.minecraft.pale_oak_sapling": "Blek ekplanta",
	"block.minecraft.pale_oak_shelf": "Blek ekhylla",
	"block.minecraft.pale_oak_sign": "Blek ekskylt",
	"block.minecraft.pale_oak_slab": "Blek ekplatta",
	"block.minecraft.pale_oak_stairs": "Blek ektrappa",
	"block.minecraft.pale_oak_trapdoor": "Blek ekfallucka",
	"block.minecraft.pale_oak_wall_hanging_sign": "Hängande blek ekskylt på vägg",
	"block.minecraft.pale_oak_wall_sign": "Blek ekskylt på vägg",
	"block.minecraft.pale_oak_wood": "Blekt ekträ",
	...
	"block.minecraft.polished_cinnabar": "Polerad cinnober",
	"block.minecraft.polished_cinnabar_slab": "Polerad cinnoberplatta",
	"block.minecraft.polished_cinnabar_stairs": "Polerad cinnobertrappa",
	"block.minecraft.polished_cinnabar_wall": "Polerad cinnobermur",
	...
	"block.minecraft.polished_sulfur": "Polerat svavel",
	"block.minecraft.polished_sulfur_slab": "Polerad svavelplatta",
	"block.minecraft.polished_sulfur_stairs": "Polerad svaveltrappa",
	"block.minecraft.polished_sulfur_wall": "Polerad svavelmur",
	"block.minecraft.polished_tuff": "Polerad tuff",
	"block.minecraft.polished_tuff_slab": "Polerad tuffplatta",
	"block.minecraft.polished_tuff_stairs": "Polerad tufftrappa",
	"block.minecraft.polished_tuff_wall": "Polerad tuffmur",
	"block.minecraft.poppy": "Vallmo",
	"block.minecraft.potatoes": "Potatisar",
	"block.minecraft.potent_sulfur": "Potent svavel",
	...
	"block.minecraft.potted_closed_eyeblossom": "Stängd ögonblomma i kruka",
	...
	"block.minecraft.potted_golden_dandelion": "Gyllene maskros i kruka",
	...
	"block.minecraft.potted_open_eyeblossom": "Öppen ögonblomma i kruka",
	"block.minecraft.potted_orange_tulip": "Orange tulpan i kruka",
	"block.minecraft.potted_oxeye_daisy": "Prästkrage i kruka",
	"block.minecraft.potted_pale_oak_sapling": "Blek ekplanta i kruka",
	...
	"block.minecraft.resin_block": "Hartsblock",
	"block.minecraft.resin_brick_slab": "Hartstegelplatta",
	"block.minecraft.resin_brick_stairs": "Hartstegeltrappa",
	"block.minecraft.resin_brick_wall": "Hartstegelmur",
	"block.minecraft.resin_bricks": "Hartstegel",
	"block.minecraft.resin_clump": "Hartsklump",
	...
	"block.minecraft.short_dry_grass": "Kort torrt gräs",
	"block.minecraft.short_grass": "Kort gräs",
	...
	"block.minecraft.spruce_shelf": "Granhylla",
	...
	"block.minecraft.stripped_pale_oak_log": "Avbarkad blek ekstam",
	"block.minecraft.stripped_pale_oak_wood": "Avbarkat blekt ekträ",
	...
	"block.minecraft.sulfur": "Svavel",
	"block.minecraft.sulfur_brick_slab": "Svavelmurstensplatta",
	"block.minecraft.sulfur_brick_stairs": "Svavelmurstenstrappa",
	"block.minecraft.sulfur_brick_wall": "Svavelmurstensmur",
	"block.minecraft.sulfur_bricks": "Svavelmursten",
	"block.minecraft.sulfur_slab": "Svavelplatta",
	"block.minecraft.sulfur_spike": "Svavelspets",
	"block.minecraft.sulfur_stairs": "Svaveltrappa",
	"block.minecraft.sulfur_wall": "Svavelmur",
	...
	"block.minecraft.tall_dry_grass": "Högt torrt gräs",
	...
	"block.minecraft.test_instance_block": "Testinstansblock",
	"block.minecraft.tinted_glass": "Tonat glas",
	"block.minecraft.tnt": "Dynamit",
	"block.minecraft.tnt.disabled": "Dynamitexplosioner är inaktiverade",
	...
	"block.minecraft.trial_spawner": "Utmaningsskapare",
	...
	"block.minecraft.tuff_brick_slab": "Tuffmurstensplatta",
	"block.minecraft.tuff_brick_stairs": "Tuffmurstenstrappa",
	"block.minecraft.tuff_brick_wall": "Tuffmurstensmur",
	"block.minecraft.tuff_bricks": "Tuffmursten",
	"block.minecraft.tuff_slab": "Tuffplatta",
	"block.minecraft.tuff_stairs": "Tufftrappa",
	"block.minecraft.tuff_wall": "Tuffmur",
	...
	"block.minecraft.vault": "Kassaskåp",
	...
	"block.minecraft.warped_shelf": "Förvrängd hylla",
	...
	"block.minecraft.waxed_chiseled_copper": "Vaxad mejslad koppar",
	"block.minecraft.waxed_copper_bars": "Vaxat koppargaller",
	"block.minecraft.waxed_copper_block": "Vaxat kopparblock",
	"block.minecraft.waxed_copper_bulb": "Vaxad kopparlampa",
	"block.minecraft.waxed_copper_chain": "Vaxad kopparkedja",
	"block.minecraft.waxed_copper_chest": "Vaxad kopparkista",
	"block.minecraft.waxed_copper_door": "Vaxad koppardörr",
	"block.minecraft.waxed_copper_golem_statue": "Vaxad koppargolemstaty",
	"block.minecraft.waxed_copper_grate": "Vaxat kopparnät",
	"block.minecraft.waxed_copper_lantern": "Vaxad kopparlykta",
	"block.minecraft.waxed_copper_trapdoor": "Vaxad kopparfallucka",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Vaxad exponerad mejslad koppar",
	"block.minecraft.waxed_exposed_copper": "Vaxad exponerad koppar",
	"block.minecraft.waxed_exposed_copper_bars": "Vaxat exponerat koppargaller",
	"block.minecraft.waxed_exposed_copper_bulb": "Vaxad exponerad kopparlampa",
	"block.minecraft.waxed_exposed_copper_chain": "Vaxad exponerad kopparkedja",
	"block.minecraft.waxed_exposed_copper_chest": "Vaxad exponerad kopparkista",
	"block.minecraft.waxed_exposed_copper_door": "Vaxad exponerad koppardörr",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Vaxad exponerad koppargolemstaty",
	"block.minecraft.waxed_exposed_copper_grate": "Vaxat exponerat kopparnät",
	"block.minecraft.waxed_exposed_copper_lantern": "Vaxad exponerad kopparlykta",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Vaxad exponerad kopparfallucka",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Vaxad exponerad åskledare",
	"block.minecraft.waxed_lightning_rod": "Vaxad åskledare",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Vaxad ärgad mejslad koppar",
	"block.minecraft.waxed_oxidized_copper": "Vaxad ärgad koppar",
	"block.minecraft.waxed_oxidized_copper_bars": "Vaxat ärgat koppargaller",
	"block.minecraft.waxed_oxidized_copper_bulb": "Vaxad ärgad kopparlampa",
	"block.minecraft.waxed_oxidized_copper_chain": "Vaxad ärgad kopparkedja",
	"block.minecraft.waxed_oxidized_copper_chest": "Vaxad ärgad kopparkista",
	"block.minecraft.waxed_oxidized_copper_door": "Vaxad ärgad koppardörr",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Vaxad ärgad koppargolemstaty",
	"block.minecraft.waxed_oxidized_copper_grate": "Vaxat ärgat kopparnät",
	"block.minecraft.waxed_oxidized_copper_lantern": "Vaxad ärgad kopparlykta",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Vaxad ärgad kopparfallucka",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Vaxad ärgad åskledare",
	"block.minecraft.waxed_weathered_chiseled_copper": "Vaxad väderbiten mejslad koppar",
	"block.minecraft.waxed_weathered_copper": "Vaxad väderbiten koppar",
	"block.minecraft.waxed_weathered_copper_bars": "Vaxat väderbitet koppargaller",
	"block.minecraft.waxed_weathered_copper_bulb": "Vaxad väderbiten kopparlampa",
	"block.minecraft.waxed_weathered_copper_chain": "Vaxad väderbiten kopparkedja",
	"block.minecraft.waxed_weathered_copper_chest": "Vaxad väderbiten kopparkista",
	"block.minecraft.waxed_weathered_copper_door": "Vaxad väderbiten koppardörr",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Vaxad väderbiten koppargolemstaty",
	"block.minecraft.waxed_weathered_copper_grate": "Vaxat väderbitet kopparnät",
	"block.minecraft.waxed_weathered_copper_lantern": "Vaxad väderbiten kopparlykta",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Vaxad väderbiten kopparfallucka",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Vaxad väderbiten åskledare",
	"block.minecraft.weathered_chiseled_copper": "Väderbiten mejslad koppar",
	"block.minecraft.weathered_copper": "Väderbiten koppar",
	"block.minecraft.weathered_copper_bars": "Väderbitet koppargaller",
	"block.minecraft.weathered_copper_bulb": "Väderbiten kopparlampa",
	"block.minecraft.weathered_copper_chain": "Väderbiten kopparkedja",
	"block.minecraft.weathered_copper_chest": "Väderbiten kopparkista",
	"block.minecraft.weathered_copper_door": "Väderbiten koppardörr",
	"block.minecraft.weathered_copper_golem_statue": "Väderbiten koppargolemstaty",
	"block.minecraft.weathered_copper_grate": "Väderbitet kopparnät",
	"block.minecraft.weathered_copper_lantern": "Väderbiten kopparlykta",
	"block.minecraft.weathered_copper_trapdoor": "Väderbiten kopparfallucka",
	...
	"block.minecraft.weathered_lightning_rod": "Väderbiten åskledare",
	...
	"block.minecraft.wildflowers": "Vildblommor",
	...
	"book.edit.title": "Redigeringsvy för bok",
	...
	"book.page_button.next": "Nästa sida",
	"book.page_button.previous": "Föregående sida",
	"book.sign.title": "Signeringsvy för bok",
	"book.sign.titlebox": "Titel",
	"book.signButton": "Signera",
	"book.view.title": "Läsvy för bok",
	"build.spawn_protection": "%s är inom skyddat startområde",
	"build.tooHigh": "Höjdgränsen för att bygga är %s",
	"build.tooLow": "Den lägsta höjden för att bygga är %s",
	...
	"chat.disabled.invalid_command_signature": "Kommandot hade en oväntad eller saknad signatur i kommandoargumentet.",
	"chat.disabled.invalid_signature": "Chatten hade en ogiltig signatur. Försök att återansluta.",
	...
	"chat.disabled.out_of_order_chat": "Chattmeddelanden togs emot i fel ordning. Har din systemtid ändrats?",
	...
	"chat.link.confirm": "Är du säker på att du vill öppna följande webbsida?",
	...
	"chat.queue.tooltip": "Klicka för att visa nästa meddelande",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "Servern skickade ett ogiltigt meddelande.",
	...
	"chat.validation_error": "Fel vid validering av chatt",
	"chat_restriction.chat_and_commands_disabled_by_options": "Chatten har begränsats i klientens inställningar.",
	"chat_restriction.chat_disabled_by_options": "Spelarchatten har begränsats i klientens inställningar.",
	"chat_restriction.chat_disabled_by_options.action": "Gå till chattinställningarna",
	"chat_restriction.disabled_by_launcher": "Chatten har begränsats i programstartaren",
	"chat_restriction.disabled_by_profile": "Chatten har begränsats i profilinställningarna.",
	"chat_restriction.disabled_by_profile.action": "Gå till dina profilinställningar",
	"chat_screen.commands_not_allowed": "Det är inte tillåtet att skicka kommandon",
	"chat_screen.message": "Meddelande som ska skickas: %s",
	"chat_screen.messages_not_allowed": "Det är inte tillåtet att skicka chattmeddelanden",
	"chat_screen.restricted": "Chatten har begränsats. Klicka på detta meddelande för mer information.",
	"chat_screen.restricted.narration": "Chatten har begränsats. Gå till begränsningsmenyn i världsalternativen.",
	"chat_screen.title": "Chattfönster",
	"chat_screen.usage": "Skriv ett meddelande och tryck på Retur för att skicka",
	"chunk.toast.checkLog": "Se loggen för mer information",
	"chunk.toast.loadFailure": "Misslyckades att läsa in datablocket vid %s",
	"chunk.toast.lowDiskSpace": "För lite diskutrymme!",
	"chunk.toast.lowDiskSpace.description": "Kanske inte kan spara världen.",
	"chunk.toast.saveFailure": "Misslyckades att spara datablocket vid %s",
	...
	"command.exception": "Kunde inte tolka kommandot: %s",
	"command.expected.separator": "Ett blanktecken förväntades för avsluta ett argument, men efterföljande data hittades",
	"command.failed": "Ett oväntat fel uppstod när kommandot försökte utföras",
	"command.forkLimit": "Maximalt antal sammanhang (%s) har uppnåtts",
	"command.trailing_data": "Efterföljande data hittades: %s",
	...
	"commands.attribute.base_value.reset.success": "Återställde grundvärdet för attributet %s för entiteten %s till standardvärdet %s",
	...
	"commands.banlist.entry.unknown": "(Okänd)",
	...
	"commands.data.modify.invalid_substring": "Ogiltiga index för delsträngar: %s till %s",
	...
	"commands.datapack.create.already_exists": "Ett datapaket med namnet \"%s\" finns redan",
	"commands.datapack.create.invalid_full_name": "Namnet för det nya paketet \"%s\" är ogiltigt",
	"commands.datapack.create.invalid_name": "Namnet för det nya datapaketet \"%s\" innehåller ogiltiga tecken",
	"commands.datapack.create.io_failure": "Kan inte skapa ett datapaket med namnet \"%s\". Se loggarna",
	"commands.datapack.create.metadata_encode_failure": "Misslyckades att koda metadata för paketet med namnet \"%s\": %s",
	"commands.datapack.create.success": "Skapade ett nytt tomt datapaket med namnet \"%s\"",
	"commands.datapack.disable.failed": "Paketet \"%s\" är inte aktiverat!",
	"commands.datapack.disable.failed.feature": "Paketet \"%s\" kan inte inaktiveras eftersom det är en del av en aktiverad flagga!",
	...
	"commands.debug.function.noReturnRun": "Spårning kan inte användas med /return run",
	...
	"commands.dialog.clear.multiple": "Rensade dialog för %s spelare",
	"commands.dialog.clear.single": "Rensade dialog för %s",
	"commands.dialog.show.multiple": "Visade dialog för %s spelare",
	"commands.dialog.show.single": "Visade dialog för %s",
	...
	"commands.drop.no_loot_table.block": "Blocket %s har ingen skattabell",
	...
	"commands.execute.function.instantiationFailure": "Misslyckades att instantiera funktionen %s: %s",
	...
	"commands.fetchprofile.copy_component": "Kopiera komponent",
	"commands.fetchprofile.copy_text": "Kopiera %s",
	"commands.fetchprofile.entity.success": "Hämtade profil för entiteten %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Misslyckades att serialisera profil: %s",
	"commands.fetchprofile.give_item": "Ge föremål",
	"commands.fetchprofile.id.failure": "Misslyckades att hämta profil för id %s",
	"commands.fetchprofile.id.success": "Hämtade profil för id %s: %s",
	"commands.fetchprofile.name.failure": "Misslyckades att hämta profil för namnet %s",
	"commands.fetchprofile.name.success": "Hämtade profil för namnet %s: %s",
	"commands.fetchprofile.no_profile": "Entiteten %s har ingen profil",
	"commands.fetchprofile.summon_mannequin": "Skapa spelarmodell",
	...
	"commands.function.error.argument_not_compound": "\"%s\" är en ogiltig argumenttyp. Sammansatt tagg förväntades",
	"commands.function.error.missing_argument": "Argumentet %[2]s saknas till funktionen %[1]s",
	"commands.function.error.missing_arguments": "Argument saknas till funktionen %s",
	"commands.function.error.parse": "När makrot %s instantierades orsakade kommandot \"%s\" ett fel: %s",
	"commands.function.instantiationFailure": "Misslyckades att instantiera funktionen %s: %s",
	"commands.function.result": "Funktionen %s returnerade %s",
	"commands.function.scheduled.multiple": "Kör funktionerna %s",
	"commands.function.scheduled.no_functions": "Kan inte hitta någon funktion med namnet %s",
	"commands.function.scheduled.single": "Kör funktionen %s",
	...
	"commands.kick.owner.failed": "Kan inte sparka ut serverägaren från LAN-spel",
	"commands.kick.singleplayer.failed": "Kan inte sparka ut spelaren från ett frånkopplat spel i enspelarläget",
	...
	"commands.locate.structure.not_found": "Kunde inte hitta en struktur av typen \"%s\" i närheten",
	...
	"commands.profile_fetch.copy_component": "Kopiera komponent",
	"commands.profile_fetch.failed_to_serialize": "Misslyckades att serialisera profil: %s",
	"commands.profile_fetch.give_item": "Ge föremål",
	"commands.profile_fetch.id.failure": "Misslyckades att hämta profil för ID %s",
	"commands.profile_fetch.id.success": "Hämtade profil för ID %s: %s",
	"commands.profile_fetch.name.failure": "Misslyckades att hämta profil för namnet %s",
	"commands.profile_fetch.name.success": "Hämtade profil för namnet %s: %s",
	"commands.publish.alreadyPublished": "Flerspelarspel är redan öppet på port %s",
	"commands.publish.alreadyPublished.lan": "Lokalt spel är redan öppet på port %s",
	"commands.publish.alreadyPublished.online": "Flerspelarspel är redan öppet",
	"commands.publish.failed": "Kunde inte vara värd för ett lokalt spel",
	"commands.publish.started": "Lokalt spel öppet på port %s",
	"commands.publish.started.lan": "Lokalt spel är öppet på port %s",
	"commands.publish.started.online": "Flerspelarspel är nu öppet",
	"commands.publish.success": "Flerspelarspel är nu öppet på port %s",
	"commands.random.error.range_too_large": "Intervallet får inte vara större än 2147483646 slumpmässiga värden",
	"commands.random.error.range_too_small": "Intervallet får inte vara mindre än 2 slumpmässiga värden",
	"commands.random.reset.all.success": "Återställde %s slumpmässiga sekvenser",
	"commands.random.reset.success": "Återställde slumpmässiga sekvensen %s",
	"commands.random.roll": "%s slog %s (mellan %s och %s)",
	"commands.random.sample.success": "Slumpmässigt värde: %s",
	...
	"commands.rotate.success": "%s roterades",
	...
	"commands.schedule.created.function": "Schemalade funktionen \"%s\" om %s tickningar vid speltiden %s",
	"commands.schedule.created.tag": "Schemalade taggen \"%s\" om %s tickningar vid speltiden %s",
	"commands.schedule.macro": "Kan inte schemalägga ett makro",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Inaktiverade automatisk uppdatering av visad data för målet %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Aktiverade automatisk uppdatering av visad data för målet %s",
	"commands.scoreboard.objectives.modify.displayname": "Ändrade visningsnamnet för %s till %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Rensade standardnummerformatet för målet %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Ändrade standardnummerformatet för målet %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Rensade visningsnamnet för %s entiteter i %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Rensade visningsnamnet för %s i %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Ändrade visningsnamnet för %[2]s entiteter i %[3]s till %[1]s",
	"commands.scoreboard.players.display.name.set.success.single": "Ändrade visningsnamnet för %[2]s i %[3]s till %[1]s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Rensade nummerformatet för %s entiteter i %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Rensade nummerformatet för %s i %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Ändrade nummerformatet för %s entiteter i %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Ändrade nummerformatet för %s i %s",
	"commands.scoreboard.players.enable.failed": "Ingenting förändrades. Denna utlösare är redan aktiverad",
	"commands.scoreboard.players.enable.invalid": "Fungerar endast på mål av typen \"trigger\"",
	...
	"commands.setidletimeout.success": "Tidsgränsen för spelarinaktivitet är nu %s minuter",
	"commands.setidletimeout.success.disabled": "Tidsgränsen för spelarinaktivitet är nu inaktiverad",
	"commands.setworldspawn.failure.not_overworld": "Världens återuppståndelsepunkt kan endast ändras till en plats i Övervärlden",
	"commands.setworldspawn.success": "Ändrade världens återuppståndelsepunkt till %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Ändrade världens återuppståndelsepunkt till %s, %s, %s, [%s, %s] i %s",
	"commands.spawnpoint.success.multiple": "Ändrade återuppståndelsepunkten till %s, %s, %s [%s] i %s för %s spelare",
	"commands.spawnpoint.success.multiple.new": "Ändrade återuppståndelsepunkten till %s, %s, %s [%s, %s] i %s för %s spelare",
	"commands.spawnpoint.success.single": "Ändrade återuppståndelsepunkten till %s, %s, %s [%s] i %s för %s",
	"commands.spawnpoint.success.single.new": "Ändrade återuppståndelsepunkten till %s, %s, %s [%s, %s] i %s för %s",
	"commands.spectate.cannot_spectate": "%s kan inte åskådas",
	...
	"commands.stopwatch.already_exists": "Tidtagaruret \"%s\" finns redan",
	"commands.stopwatch.create.success": "Skapade tidtagaruret \"%s\"",
	"commands.stopwatch.does_not_exist": "Tidtagaruret \"%s\" finns inte",
	"commands.stopwatch.query": "Tidtagaruret \"%s\" har körts i %ss",
	"commands.stopwatch.remove.success": "Tog bort tidtagaruret \"%s\"",
	"commands.stopwatch.restart.success": "Startade om tidtagaruret \"%s\"",
	"commands.summon.failed": "Kunde inte skapa entiteten",
	"commands.summon.failed.peaceful": "Monster kan inte skapas på fredlig svårighetsgrad",
	...
	"commands.summon.success": "%s skapades",
	"commands.swing.failed.notliving": "Inga levande entiteter att svinga armen på hittades",
	"commands.swing.success.multiple": "Gjorde att %s entiteter svingade sin arm",
	"commands.swing.success.single": "Gjorde att %s svingade en arm",
	...
	"commands.team.option.color.clear.success": "Rensade färgen för laget %s",
	...
	"commands.test.batch.starting": "Startar miljön %s, datamängd %s",
	"commands.test.clear.error.no_tests": "Kunde inte hitta något test att rensa",
	"commands.test.clear.success": "Rensade %s strukturer",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Klicka för att kopiera till urklipp",
	"commands.test.create.success": "Skapade testkonfigurering för testet %s",
	"commands.test.error.no_test_containing_pos": "Kan inte hitta en testinstans som innehåller %s, %s, %s",
	"commands.test.error.no_test_instances": "Hittade inga testinstanser",
	"commands.test.error.non_existant_test": "Testet %s kunde inte hittas",
	"commands.test.error.structure_not_found": "Teststrukturen %s kunde inte hittas",
	"commands.test.error.test_instance_not_found": "Entiteten för testinstansblocket kunde inte hittas",
	"commands.test.error.test_instance_not_found.position": "Entiteten för testinstansblocket kunde inte hittas under testkörningen vid %s, %s, %s",
	"commands.test.error.too_large": "Strukturens storlek måste vara mindre än %s block i varje axelriktning",
	"commands.test.locate.done": "Sökningen slutfördes. %s strukturer hittades",
	"commands.test.locate.found": "Struktur hittades vid: %s (avstånd: %s)",
	"commands.test.locate.started": "Startade sökning efter teststrukturer. Detta kan ta en stund...",
	"commands.test.no_tests": "Inga tester att köra",
	"commands.test.relative_position": "Position relativ till %s: %s",
	"commands.test.reset.error.no_tests": "Kunde inte hitta några tester att återställa",
	"commands.test.reset.success": "Återställde %s strukturer",
	"commands.test.run.no_tests": "Inga tester hittades",
	"commands.test.run.running": "Kör %s tester...",
	"commands.test.summary": "Speltest slutfördes! %s tester kördes",
	"commands.test.summary.all_required_passed": "Alla nödvändiga tester genomfördes :)",
	"commands.test.summary.failed": "%s nödvändiga tester misslyckades :(",
	"commands.test.summary.optional_failed": "%s valfria tester misslyckades",
	"commands.tick.query.percentiles": "Percentiler: P50: %s ms, P95: %s ms, P99: %s ms. Stickprov: %s",
	"commands.tick.query.rate.running": "Målvärde för tickningshastighet: %s per sekund.\nGenomsnittlig tid per tickning: %s ms (mål: %s ms)",
	"commands.tick.query.rate.sprinting": "Målvärde för tickningshastighet: %s per sekund (ignoreras, endast för referens).\nGenomsnittlig tid per tickning: %s ms",
	"commands.tick.rate.success": "Ändrar målvärdet för tickningshastigheten till %s per sekund",
	"commands.tick.sprint.report": "Sprint slutfördes med %s tickningar per sekund eller %s ms per tickning",
	"commands.tick.sprint.stop.fail": "Ingen pågående tickningssprint",
	"commands.tick.sprint.stop.success": "Avbröt den nuvarande tickningssprinten",
	"commands.tick.status.frozen": "Spelet har frysts",
	"commands.tick.status.lagging": "Spelet körs men kan inte uppnå målvärdet för tickningshastigheten",
	"commands.tick.status.running": "Spelet körs normalt",
	"commands.tick.status.sprinting": "Spelet sprintar",
	"commands.tick.step.fail": "Kunde inte stega spelet framåt – spelet måste frysas först",
	"commands.tick.step.stop.fail": "Inget pågående tickningssteg",
	"commands.tick.step.stop.success": "Avbröt det nuvarande tickningssteget",
	"commands.tick.step.success": "Stegar framåt %s tickningar",
	"commands.time.no_default_clock": "Det finns ingen standardklocka i dimensionen %s",
	"commands.time.no_time_marker_found": "Tidsmarkören %s finns inte för klockan %s",
	"commands.time.pause": "Pausade klockan %s",
	"commands.time.query": "Tiden är %s",
	"commands.time.query.absolute": "Klockan %s är vid %s tickningar",
	"commands.time.query.gametime": "Speltiden är %s tickningar",
	"commands.time.query.timeline": "Tidslinjen %s är vid %s tickningar",
	"commands.time.query.timeline.repetitions": "Tidslinjen %s har passerat %s repetitioner",
	"commands.time.rate": "Klockan %s tickar nu i %sx normal hastighet",
	"commands.time.resume": "Återupptog klockan %s",
	"commands.time.set": "Ändrade tiden till %s",
	"commands.time.set.absolute": "Ändrade %s till %s tickningar",
	"commands.time.set.time_marker": "Ändrade %s till tidsmarkören %s",
	"commands.time.wrong_timeline_for_clock": "Tidslinjen %s är ogiltig för klockan %s",
	...
	"commands.transfer.error.no_players": "Du måste ange minst en spelare att överföra",
	"commands.transfer.success.multiple": "Överför %s spelare till %s:%s",
	"commands.transfer.success.single": "Överför %s till %s:%s",
	"commands.trigger.add.success": "Utlöste %s (lade till %s i värdet)",
	"commands.trigger.failed.invalid": "Du kan endast utlösa mål av typen \"trigger\"",
	...
	"commands.unpublish.notPublished": "Inget flerspelarspel har publicerats",
	"commands.unpublish.success": "Flerspelarspel är inte längre publicerat",
	...
	"commands.waypoint.list.empty": "Inga vägpunkter i %s",
	"commands.waypoint.list.success": "%s vägpunkter i %s: %s",
	"commands.waypoint.modify.color": "Vägpunktens färg är nu %s",
	"commands.waypoint.modify.color.reset": "Återställde vägpunktens färg",
	"commands.waypoint.modify.style": "Vägpunktens stil ändrades",
	...
	"commands.worldborder.set.shrink": "Förminskar världsgränsens bredd till %s block över %s sekunder",
	...
	"compliance.playtime.hours": "Du har spelat i %s timmar",
	...
	"connect.failed.transfer": "Anslutningen misslyckades vid överföring till servern",
	"connect.joining": "Ansluter till värld...",
	"connect.negotiating": "Förhandlar...",
	"connect.p2p.establishing": "Etablerar anslutning...",
	"connect.p2p.failed.generic": "Kunde inte att ansluta till spelare",
	"connect.p2p.failed.signaling": "Det går inte att ansluta för tillfället.\nFörsök igen senare.",
	"connect.p2p.failed.timeout": "Anslutningsbegäran tappade kontakten",
	"connect.p2p.failed.unreachable": "Spelaren kan inte nås",
	"connect.reconfiging": "Omkonfigurerar...",
	"connect.reconfiguring": "Omkonfigurerar...",
	"connect.transferring": "Överförs till en ny server...",
	"container.barrel": "Tunna",
	"container.beacon": "Fyr",
	"container.beehive.bees": "Bin: %s/%s",
	"container.beehive.honey": "Honung: %s/%s",
	...
	"createWorld.customize.buffet.search": "Sök...",
	"createWorld.customize.buffet.title": "Anpassning av enbiomsvärld",
	...
	"createWorld.customize.presets.list": "Du kan också använda någon vi redan skapat!",
	...
	"dataPack.locator_bar.description": "Visa i vilken riktning som andra spelare befinner sig i flerspelarläge",
	"dataPack.locator_bar.name": "Navigeringsfält",
	"dataPack.minecart_improvements.description": "Förbättrade gruvvagnsrörelser",
	"dataPack.minecart_improvements.name": "Gruvvagnsförbättringar",
	"dataPack.redstone_experiments.description": "Experimentella redstoneförändringar",
	"dataPack.redstone_experiments.name": "Redstoneexperiment",
	"dataPack.title": "Välj datapaket",
	"dataPack.trade_rebalance.description": "Uppdaterade byten för bybor",
	"dataPack.trade_rebalance.name": "Ombalanserade bybobyten",
	...
	"dataPack.update_1_21.description": "Nya funktioner och innehåll för Minecraft 1.21",
	"dataPack.update_1_21.name": "Uppdatering 1.21",
	...
	"dataPack.winter_drop.description": "Nya funktioner och innehåll för vintersläppet",
	"dataPack.winter_drop.name": "Vintersläpp",
	...
	"death.attack.genericKill": "%[1]s dödades",
	"death.attack.genericKill.player": "%[1]s dödades under en strid med %[2]s",
	...
	"death.attack.mace_smash": "%[1]s mosades av %[2]s",
	"death.attack.mace_smash.item": "%[1]s mosades av %[2]s med %[3]s",
	...
	"death.attack.outsideBorder": "%[1]s hamnade utanför världsgränsen",
	"death.attack.outsideBorder.player": "%[1]s hamnade utanför världsgränsen under en strid med %[2]s",
	...
	"death.attack.spear": "%[1]s genomborrades av %[2]s",
	"death.attack.spear.item": "%[1]s genomborrades av %[2]s med %[3]s",
	...
	"death.attack.sulfurCubeHot": "%[1]s dog eftersom inte bara golvet är lava",
	"death.attack.sulfurCubeHot.player": "%[2]s bevisade för %[1]s att golvet är lava",
	...
	"deathScreen.score.value": "Poäng: %s",
	...
	"debug.copy_location.help": "F3 + C = Kopiera position som kommandot /tp eller håll ned F3 + C i 10 sekunder för att krascha spelet",
	"debug.copy_location.message": "Kopierade positionen till urklipp",
	"debug.crash.message": "F3 + C hålls ned. Detta kommer att krascha spelet om det inte släppts.",
	"debug.crash.message.rebindable": "%s + %s hålls ned. Detta kommer att krascha spelet om det inte släppts.",
	...
	"debug.entry.currently.alwaysOn": "%s: För tillfället alltid på",
	"debug.entry.currently.inF3": "%s: För tillfället endast i F3",
	"debug.entry.currently.inOverlay": "%s: För tillfället endast i felsökningsöverlägget",
	"debug.entry.currently.never": "%s: För tillfället av",
	"debug.entry.f3": "I F3",
	"debug.entry.overlay": "I överlägg",
	...
	"debug.options.category.renderer": "Felsökningsrenderare",
	"debug.options.category.text": "Text i felsökningsmenyn",
	"debug.options.help": "F3 + F6 = Redigera felsökningsalternativ",
	"debug.options.notAllowed.tooltip": "Visas inte när reducerad felsökningsinformation har aktiverats",
	"debug.options.profile.default": "Standardprofil",
	"debug.options.profile.performance": "Prestandaprofil",
	"debug.options.search": "Sök...",
	"debug.options.title": "Felsökningsalternativ",
	"debug.options.warning": "Dessa inställningar är endast för felsökning. De kan sega ned din dator, krascha spelet eller äta upp din tama sten.",
	"debug.pause.help": "F3 + Esc = Pausa utan pausmeny (om det går att pausa)",
	"debug.pause_focus.help": "F3 + P = Pausa vid förlorad fokus",
	"debug.pause_focus.off": "Pausa vid förlorat fokus: AV",
	"debug.pause_focus.on": "Pausa vid förlorat fokus: PÅ",
	...
	"debug.profiling.start.rebindable": "Startade en %s sekunder lång profilering. Använd %s + %s för att stoppa tidigt",
	...
	"debug.version.header": "Klientens versionsinformation:",
	"debug.version.help": "F3 + V = Klientens versionsinformation",
	...
	"demo.help.fullWrapped": "Denna demoversion kommer att vara i 5 speldagar (ungefär 1 timme och 40 minuter i verkligheten). Kolla på framstegen för tips! Ha det så kul!",
	...
	"disconnect.ignoring_status_request": "Ignorerar statusbegäran",
	...
	"disconnect.packetError": "Fel i nätverksprotokollet",
	"disconnect.spam": "Utsparkad för spam",
	"disconnect.timeout": "Tappade kontakten",
	"disconnect.transfer": "Överförd till en annan server",
	"disconnect.unknownHost": "Okänd värd",
	"download.pack.failed": "%s av %s paket misslyckades att laddas ned",
	"download.pack.progress.bytes": "Status: %s (total storlek okänd)",
	"download.pack.progress.percent": "Status: %s %%",
	"download.pack.title": "Laddar ned resurspaket %s/%s",
	"editGamerule.default": "Standard: %s",
	"editGamerule.inGame.button": "Redigera spelregler...",
	"editGamerule.inGame.disabled.tooltip": "Operatörsbehörigheter krävs för att ändra spelregler.",
	"editGamerule.inGame.discardChanges.message": "Är du säker på att du vill slänga dina osparade spelregler?",
	"editGamerule.inGame.discardChanges.title": "Spelregler har ändrats",
	"editGamerule.inGame.downloadingGamerules": "Hämtar spelregler...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Pärlbåtsandning",
	...
	"effect.minecraft.infested": "Angripen",
	...
	"effect.minecraft.oozing": "Slemmig",
	"effect.minecraft.poison": "Gift",
	"effect.minecraft.raid_omen": "Föraning om räd",
	...
	"effect.minecraft.trial_omen": "Föraning om utmaning",
	"effect.minecraft.unluck": "Otur",
	"effect.minecraft.water_breathing": "Vattenandning",
	"effect.minecraft.weakness": "Svaghet",
	"effect.minecraft.weaving": "Spinnande",
	"effect.minecraft.wind_charged": "Vindladdad",
	...
	"enchantment.minecraft.breach": "Genombrytning",
	...
	"enchantment.minecraft.lunge": "Utfall",
	...
	"enchantment.minecraft.sweeping_edge": "Svepande svärdsegg",
	...
	"enchantment.minecraft.wind_burst": "Vindexplosion",
	"entity.minecraft.acacia_boat": "Akaciabåt",
	"entity.minecraft.acacia_chest_boat": "Akaciabåt med kista",
	"entity.minecraft.allay": "Hjälpande ande",
	"entity.minecraft.area_effect_cloud": "Områdeseffektsmoln",
	"entity.minecraft.armadillo": "Bältdjur",
	"entity.minecraft.armor_stand": "Rustningsställ",
	"entity.minecraft.arrow": "Pil",
	"entity.minecraft.axolotl": "Axolotl",
	"entity.minecraft.bamboo_chest_raft": "Bambuflotte med kista",
	"entity.minecraft.bamboo_raft": "Bambuflotte",
	"entity.minecraft.bat": "Fladdermus",
	"entity.minecraft.bee": "Bi",
	"entity.minecraft.birch_boat": "Björkbåt",
	"entity.minecraft.birch_chest_boat": "Björkbåt med kista",
	"entity.minecraft.blaze": "Brännare",
	"entity.minecraft.block_display": "Blockvisare",
	"entity.minecraft.boat": "Båt",
	"entity.minecraft.bogged": "Sumpigt skelett",
	"entity.minecraft.breeze": "Vindväsen",
	"entity.minecraft.breeze_wind_charge": "Vindattack",
	"entity.minecraft.camel": "Kamel",
	"entity.minecraft.camel_husk": "Uttorkad kamel",
	"entity.minecraft.cat": "Katt",
	"entity.minecraft.cave_spider": "Grottspindel",
	"entity.minecraft.cherry_boat": "Körsbärsbåt",
	"entity.minecraft.cherry_chest_boat": "Körsbärsbåt med kista",
	...
	"entity.minecraft.copper_golem": "Koppargolem",
	"entity.minecraft.cow": "Ko",
	"entity.minecraft.creaking": "Knarrträd",
	"entity.minecraft.creaking_transient": "Knarrträd",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Mörk ekbåt",
	"entity.minecraft.dark_oak_chest_boat": "Mörk ekbåt med kista",
	...
	"entity.minecraft.jungle_boat": "Djungelbåt",
	"entity.minecraft.jungle_chest_boat": "Djungelbåt med kista",
	...
	"entity.minecraft.lingering_potion": "Kvardröjande brygd",
	...
	"entity.minecraft.mannequin": "Spelarmodell",
	"entity.minecraft.mannequin.label": "Icke-spelbar figur",
	"entity.minecraft.marker": "Markör",
	"entity.minecraft.minecart": "Gruvvagn",
	"entity.minecraft.mooshroom": "Mooshroom",
	"entity.minecraft.mule": "Mula",
	"entity.minecraft.nautilus": "Pärlbåt",
	"entity.minecraft.oak_boat": "Ekbåt",
	"entity.minecraft.oak_chest_boat": "Ekbåt med kista",
	"entity.minecraft.ocelot": "Ozelot",
	"entity.minecraft.ominous_item_spawner": "Oroväckande föremålsskapare",
	"entity.minecraft.painting": "Tavla",
	"entity.minecraft.pale_oak_boat": "Blek ekbåt",
	"entity.minecraft.pale_oak_chest_boat": "Blek ekbåt med kista",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Uttorkat skelett",
	...
	"entity.minecraft.splash_potion": "Kastbar brygd",
	...
	"entity.minecraft.sulfur_cube": "Svavelkub",
	"entity.minecraft.sulfur_cube.content": "Innehåller: %s",
	...
	"entity.minecraft.wind_charge": "Vindladdning",
	...
	"entity.minecraft.zombie_nautilus": "Zombiepärlbåt",
	...
	"event.minecraft.raid.defeat.full": "Räd – förlust",
	"event.minecraft.raid.raiders_remaining": "återstående anfallare: %s",
	"event.minecraft.raid.victory": "Seger",
	"event.minecraft.raid.victory.full": "Räd – seger",
	"filled_map.buried_treasure": "Skattkarta",
	"filled_map.explorer_jungle": "Jungelutforskarkarta",
	"filled_map.explorer_swamp": "Träskutforskarkarta",
	...
	"filled_map.trial_chambers": "Utmaningsutforskarkarta",
	"filled_map.unknown": "Okänd karta",
	"filled_map.village_desert": "Ökenbykarta",
	"filled_map.village_plains": "Slättbykarta",
	"filled_map.village_savanna": "Savannbykarta",
	"filled_map.village_snowy": "Snöbykarta",
	"filled_map.village_taiga": "Tajgabykarta",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Tillåt Nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Styr huruvida spelare tillåts gå in i Nether eller inte.",
	"gamerule.allowFireTicksAwayFromPlayer": "Låt eld sprida sig på avstånd från spelare",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Styr huruvida eld kan sprida sig på avstånd längre bort än 8 datablock från en spelare.",
	...
	"gamerule.commandBlocksEnabled": "Tillåt kommandoblock",
	...
	"gamerule.disablePlayerMovementCheck": "Inaktivera rörelsekontroll för spelare",
	...
	"gamerule.doEntityDrops.description": "Styr om du får föremål från gruvvagnar (inklusive förråd), föremålsramar, båtar etc.",
	...
	"gamerule.doMobLoot.description": "Styr om du får resurser från varelser, inklusive erfarenhetsklot.",
	...
	"gamerule.doTileDrops.description": "Styr om du får resurser från block, inklusive erfarenhetsklot.",
	...
	"gamerule.enableCommandBlocks": "Tillåt kommandoblock",
	"gamerule.enderPearlsVanishOnDeath": "Kastade enderpärlor försvinner vid dödsfall",
	"gamerule.enderPearlsVanishOnDeath.description": "Huruvida enderpärlor som kastats av en spelare försvinner när spelaren dör.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Entiteter med passagerare får använda portaler",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Låter entiteter med passagerare teleporteras med netherportaler, endportaler eller endpassager.",
	...
	"gamerule.locatorBar": "Aktivera navigeringsfält för spelare",
	"gamerule.locatorBar.description": "När detta aktiveras visar en mätare på skärmen i vilken riktning som andra spelare befinner sig.",
	...
	"gamerule.maxCommandForkCount": "Gräns för kommandosammanhang",
	"gamerule.maxCommandForkCount.description": "Maximalt antal sammanhang som kan användas av kommandon som \"execute as\".",
	"gamerule.maxEntityCramming": "Max. entiteter som kan trängas",
	"gamerule.minecartMaxSpeed": "Max. hastighet för gruvvagnar",
	"gamerule.minecartMaxSpeed.description": "Maximal standardhastighet en gruvvagn kan uppnå på land",
	"gamerule.minecraft.elytra_movement_check": "Utför rörelsekontroll för elytra",
	"gamerule.minecraft.fire_spread_radius_around_player": "Radie för eldspridning",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Radie (i block) från en spelare inom vilken eld kan sprida sig",
	"gamerule.minecraft.player_movement_check": "Utför rörelsekontroll för spelare",
	"gamerule.minecraft.raids": "Tillåt räder",
	"gamerule.minecraft.universal_anger.description": "Uppretade neutrala varelser attackerar alla spelare i närheten, inte bara spelaren som retade upp dem. Fungerar bäst om forgive_dead_players är inaktiverat.",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Netherportalsfördröjning för spelare som är i kreativt läge",
	"gamerule.playersNetherPortalCreativeDelay.description": "Tid (i tickningar) en spelare som är i kreativt läge måste stå i en Netherportal innan spelaren byter dimension.",
	"gamerule.playersNetherPortalDefaultDelay": "Netherportalsfördröjning för spelare som inte är i kreativt läge",
	"gamerule.playersNetherPortalDefaultDelay.description": "Tid (i tickningar) en spelare som inte är i kreativt läge måste stå i en Netherportal innan spelaren byter dimension.",
	...
	"gamerule.projectilesCanBreakBlocks": "Projektiler kan ta sönder block",
	"gamerule.projectilesCanBreakBlocks.description": "Styr huruvida projektilers nedslag kan ta sönder block som går att ha sönder.",
	"gamerule.pvp": "Tillåt strider mellan spelare",
	"gamerule.pvp.description": "Styr huruvida spelare tillåts att skada andra spelare eller inte.",
	"gamerule.randomTickSpeed": "Slumpmässig tickhastighet",
	...
	"gamerule.spawnChunkRadius": "Radie för datablocksinläsning vid världens återuppståndelsepunkt",
	"gamerule.spawnChunkRadius.description": "Antalet datablock som förblir inlästa runtomkring Övervärldens återuppståndelsepunkt.",
	"gamerule.spawnMonsters": "Skapa monster",
	"gamerule.spawnMonsters.description": "Styr huruvida monster skapas naturligt eller inte.",
	"gamerule.spawnRadius": "Radie för återuppståndelseplats",
	"gamerule.spawnRadius.description": "Styr storleken på området runtomkring återuppståndelsepunkten som spelare kan uppstå i.",
	"gamerule.spawnerBlocksEnabled": "Tillåt skaparblock",
	"gamerule.spectatorsGenerateChunks": "Låt åskådare generera terräng",
	"gamerule.tntExplodes": "Låt dynamit antändas och explodera",
	...
	"gui.abuseReport.attestation": "Genom att skicka in denna anmälan bekräftar du att den information du har lämnat är korrekt och fullständig efter din bästa förmåga.",
	"gui.abuseReport.comments": "Kommentarer",
	"gui.abuseReport.describe": "Detaljer hjälper oss att ta välgrundade beslut.",
	"gui.abuseReport.discard.content": "Om du lämnar kommer den här anmälan och dina kommentarer att gå förlorade.\nÄr du säker på att du vill lämna?",
	"gui.abuseReport.discard.discard": "Lämna och släng anmälan",
	"gui.abuseReport.discard.draft": "Spara som utkast",
	"gui.abuseReport.discard.return": "Fortsätt redigera",
	"gui.abuseReport.discard.title": "Släng anmälan och kommentarer?",
	"gui.abuseReport.draft.content": "Vill du fortsätta att redigera utkastet till anmälan eller slänga det och skapa ett nytt?",
	"gui.abuseReport.draft.discard": "Släng",
	"gui.abuseReport.draft.edit": "Fortsätt redigera",
	"gui.abuseReport.draft.quittotitle.content": "Vill du fortsätta att redigera eller slänga det?",
	"gui.abuseReport.draft.quittotitle.title": "Du har ett utkast till en chattanmälan som kommer att gå förlorat om du lämnar",
	"gui.abuseReport.draft.title": "Redigera utkast till chattanmälan?",
	"gui.abuseReport.error.title": "Ett problem uppstod när din anmälan skulle skickas",
	"gui.abuseReport.message": "Var observerade du det dåliga beteendet?\nDetta kommer att hjälpa oss att undersöka ditt ärende.",
	"gui.abuseReport.more_comments": "Beskriv vad som har inträffat:",
	"gui.abuseReport.name.comment_box_label": "Beskriv varför du vill anmäla detta namn:",
	"gui.abuseReport.name.reporting": "Du håller på att anmäla \"%s\".",
	"gui.abuseReport.name.title": "Anmäl olämpligt spelarnamn",
	"gui.abuseReport.observed_what": "Varför vill du anmäla detta?",
	"gui.abuseReport.read_info": "Läs mer om anmälningar",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Förtal",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Någon skadar ditt eller någon annans rykte, t.ex. genom att sprida falsk information i syfte att utnyttja eller vilseleda andra.",
	"gui.abuseReport.reason.description": "Beskrivning:",
	"gui.abuseReport.reason.false_reporting": "Missbruk av anmälningsfunktionen",
	"gui.abuseReport.reason.generic": "Jag vill anmäla dem",
	"gui.abuseReport.reason.generic.description": "Jag är irriterad på dem / de har gjort någonting som jag inte tycker om.",
	...
	"gui.abuseReport.reason.imminent_harm": "Hot om att skada andra",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Självskadebeteende eller självmord",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Utseende av sexuell karaktär",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Utseenden som anspelar på sexuella handlingar, könsorgan och sexuellt våld.",
	...
	"gui.abuseReport.report_sent_msg": "Vi har mottagit din anmälan. Tack!\n\nVår arbetsgrupp kommer att granska den så snart som möjligt.",
	"gui.abuseReport.select_reason": "Välj anmälningskategori",
	"gui.abuseReport.send": "Skicka anmälan",
	"gui.abuseReport.send.comment_too_long": "Korta ned kommentaren",
	...
	"gui.abuseReport.send.http_error": "Ett oväntat HTTP-fel uppstod när din anmälan skulle skickas.",
	"gui.abuseReport.send.json_error": "Skadad nyttolast uppstod när din anmälan skulle skickas.",
	"gui.abuseReport.send.no_reason": "Välj en anmälningskategori",
	"gui.abuseReport.send.not_attested": "Läs texten ovan och markera kryssrutan för att kunna skicka anmälan",
	...
	"gui.abuseReport.skin.title": "Anmäl spelarutseende",
	"gui.abuseReport.title": "Anmäl spelare",
	"gui.abuseReport.type.chat": "Chattmeddelanden",
	"gui.abuseReport.type.name": "Spelarnamn",
	"gui.abuseReport.type.skin": "Spelarutseende",
	...
	"gui.banned.name.description": "Ditt nuvarande namn \"%s\" bryter mot våra community-standarder. Du kan fortfarande spela i enspelarläget men måste ändra ditt namn för att spela i flerspelarläget.\n\nLäs mer eller skicka in ärendet för bedömning på följande länk: %s",
	"gui.banned.name.title": "Namnet tillåts inte i flerspelarläget",
	...
	"gui.banned.skin.description": "Ditt nuvarande utseende bryter mot våra community-standarder. Du kan fortfarande spela med ett standardutseende eller välja ett nytt.\n\nLäs mer eller skicka in ärendet för bedömning på följande länk: %s",
	"gui.banned.skin.title": "Utseendet tillåts inte",
	...
	"gui.chatReport.selected_chat": "%s chattmeddelanden har markerats till anmälan",
	...
	"gui.chatReport.title": "Anmäl spelare i chatten",
	...
	"gui.chatSelection.selected": "%s/%s meddelanden har markerats",
	"gui.chatSelection.title": "Välj chattmeddelanden att anmäla",
	"gui.continue": "Fortsätt",
	"gui.copy_link_to_clipboard": "Kopiera länk till urklipp",
	"gui.days": "%s dagar",
	"gui.done": "Klar",
	"gui.down": "Ner",
	"gui.entity_tooltip.type": "Typ: %s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "%s filer nekades",
	"gui.fileDropFailure.title": "Misslyckades att lägga till filer",
	"gui.friends.accept": "Godkänn",
	"gui.friends.button.loading": "Vänta...",
	"gui.friends.button.loading.invite_request_pending": "Väntar på bekräftelse",
	"gui.friends.button.loading.join_request_pending": "Väntar på bekräftelse",
	"gui.friends.cancel_request": "Avbryt förfrågan",
	"gui.friends.confirm_title": "Bekräfta",
	"gui.friends.confirm_unfriend": "Är du säker på att du vill ta bort denna spelare från din vänlista?",
	"gui.friends.copy_to_clipboard": "Kopiera till urklipp",
	"gui.friends.decline": "Avböj",
	"gui.friends.empty_nickname": "Ange ett giltigt profilnamn innan du skickar en vänförfrågan",
	"gui.friends.empty_state": "Vänner som du lägger till kommer att listas här.\n\nHantera onlinesäkerheten med ditt %s.",
	"gui.friends.empty_state.link": "Microsoft-konto",
	"gui.friends.enter_nickname": "Ange profilnamn",
	"gui.friends.error.connection_issue": "Vänlistan fungerar inte för tillfället.\n\nKontrollera din internetanslutning och försök igen.",
	"gui.friends.error.failed.message": "Kunde inte skicka din vänförfrågan för tillfället",
	"gui.friends.error.forbidden.message": "Misslyckades att utföra denna vänåtgärd. Det kan bero på kontots integritetsinställningar.",
	"gui.friends.error.generic": "Någonting är fel — med denna funktion, inte dina vänner!\n\nFörsök igen senare.",
	"gui.friends.error.rateLimited.message": "Du utför åtgärder i vänlistan alldeles för ofta. Vänta en stund och försök igen.",
	"gui.friends.error.temporary_unavailable": "Vänlistan fungerar inte för tillfället.\n\nFörsök igen senare.",
	"gui.friends.error.unavailable.message": "Tjänsten för vänlistan är för tillfället otillgänglig. Kontrollera din anslutning och försök igen senare.",
	"gui.friends.error.upgrade_needed": "Uppdatera spelet för att komma åt din vänlista.",
	"gui.friends.error.user_may_lack_active_profile": "Det finns ingen spelare med detta profilnamn",
	"gui.friends.join": "Anslut",
	"gui.friends.loading_friends": "Läser in vänlista...",
	"gui.friends.loading_requests": "Läser in förfrågningar...",
	"gui.friends.manage_account_footer": "Hantera onlinesäkerheten med ditt %s",
	"gui.friends.multiplayer.invite": "Bjud in",
	"gui.friends.multiplayer.invite_accept": "Godkänn",
	"gui.friends.multiplayer.invite_reject": "Avböj",
	"gui.friends.multiplayer.join_request": "Be om att få ansluta",
	"gui.friends.multiplayer.join_request_accept": "Godkänn",
	"gui.friends.multiplayer.join_request_reject": "Avböj",
	"gui.friends.my_profile_name": "Mitt profilnamn: ",
	"gui.friends.my_profile_name.narration": "Kopiera profilnamnet %s till urklipp",
	"gui.friends.narration.button.accept": "Tryck på Retur för att acceptera vänförfrågan från %s",
	"gui.friends.narration.button.cancel_request": "Tryck på Retur för att avbryta vänförfrågan från %s",
	"gui.friends.narration.button.decline": "Tryck på Retur för att avböja vänförfrågan från %s",
	"gui.friends.narration.button.unfriend": "Tryck på Retur för att ta bort %s från vänlistan",
	"gui.friends.narration.entry.friend": "Vännen %s",
	"gui.friends.narration.entry.incoming": "Inkommande vänförfrågan från %s",
	"gui.friends.narration.entry.outgoing": "Utgående vänförfrågan till %s",
	"gui.friends.open": "Vänner",
	"gui.friends.open.narration": "Vänlista",
	"gui.friends.open.tooltip": "Vänner",
	"gui.friends.pending.empty": "Inga väntade vänförfrågningar",
	"gui.friends.pending.received": "Mottagna",
	"gui.friends.pending.sent": "Skickade",
	"gui.friends.presence.status.offline": "Frånkopplad",
	"gui.friends.presence.status.online": "Uppkopplad",
	"gui.friends.presence.status.playing_hosted_server": "Uppkopplad (värld)",
	"gui.friends.presence.status.playing_offline": "Uppkopplad (värld)",
	"gui.friends.presence.status.playing_realms": "Uppkopplad (Realm)",
	"gui.friends.presence.status.playing_server": "Uppkopplad (server)",
	"gui.friends.requests_count": "Förfrågningar (%s)",
	"gui.friends.send_request": "Skicka vänförfrågan",
	"gui.friends.tab_friends": "Vänner",
	"gui.friends.toast.friend_added.message": "%s godkände din vänförfrågan",
	"gui.friends.toast.friend_invited.message": "%s blev inbjuden att ansluta till din värld.",
	"gui.friends.toast.friend_removed.message": "%s togs bort från din vänlista",
	"gui.friends.toast.generic_error": "Ett oväntat fel uppstod när din vänlista skulle uppdateras. Försök igen senare.",
	"gui.friends.toast.host_invite_expired.message": "Inbjudan för %s att ansluta till denna värld har löpt ut.",
	"gui.friends.toast.invite_from_friend.message": "%s bjöd in dig att ansluta till sin värld. Öppna vänlistan genom att trycka på \"%s\" för att ansluta",
	"gui.friends.toast.join_invite_expired.message": "Inbjudan att ansluta till %ss värld har löpt ut.",
	"gui.friends.toast.join_request.message": "%s vill ansluta till din värld. Öppna vänlistan genom att trycka på \"%s\" eller via spelmenyn.",
	"gui.friends.toast.request_accepted.message": "Du är nu vän med %s",
	"gui.friends.toast.request_received.message": "%s har skickat en vänförfrågan till dig",
	"gui.friends.toast.request_sent.message": "Vänförfrågan skickades till %s",
	"gui.friends.toast.request_to_join_friend.message": "Du bad om att få ansluta till %ss värld",
	"gui.friends.toast.requests_accepted_multiple.message": "%s vänner har godkänt dina vänförfrågningar",
	"gui.friends.toast.requests_received_multiple.message": "Du har fått %s vänförfrågningar",
	"gui.friends.unfriend": "Ta bort vän",
	"gui.game_rule.search": "Sök...",
	"gui.hours": "%s timmar",
	"gui.language.search": "Sök...",
	"gui.loadingMinecraft": "Läser in Minecraft",
	"gui.minutes": "%s minuter",
	...
	"gui.none": "Inga",
	"gui.ok": "OK",
	"gui.open_report_dir": "Öppna rapportmappen",
	"gui.packSelection.search": "Sök...",
	"gui.privacy_link.message": "Öppna denna länk för att hantera dina inställningar för integritet och onlinesäkerhet.",
	"gui.privacy_link.title": "Ändringar i Xbox-inställningarna kan ta en stund att träda i kraft.\n\nStarta om spelet ifall de inte uppdateras.",
	"gui.proceed": "Fortsätt",
	"gui.recipebook.moreRecipes": "Högerklicka för fler",
	"gui.recipebook.next_page": "Nästa sida",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Föregående sida",
	...
	"gui.remove": "Ta bort",
	"gui.report_to_server": "Rapportera till servern",
	"gui.selectWorld.search": "Sök...",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Denna spelare kan inte anmälas eftersom chatten har inaktiverats eller blockerats",
	...
	"gui.stats": "Statistik",
	"gui.stats.none_found": "Ingen statistik hittades.",
	...
	"gui.togglable_slot": "Klicka för att inaktivera plats",
	"gui.up": "Upp",
	"gui.waitingForResponse.button.inactive": "Tillbaka (%s s)",
	"gui.waitingForResponse.title": "Väntar på servern",
	"gui.yes": "Ja",
	...
	"item.canUse.unknown": "Okänd",
	"item.color": "Färg: %s",
	"item.components": "%s komponenter",
	"item.disabled": "Inaktiverat föremål",
	"item.durability": "Hållbarhet: %s / %s",
	"item.dyed": "Färgad",
	"item.intangible": "Icke-interaktiv",
	...
	"item.minecraft.armadillo_scute": "Bältdjurshornplåt",
	"item.minecraft.armadillo_spawn_egg": "Skapelseägg för bältdjur",
	...
	"item.minecraft.black_bundle": "Svart påse",
	"item.minecraft.black_dye": "Svart färg",
	"item.minecraft.black_harness": "Svart sele",
	...
	"item.minecraft.blue_bundle": "Blå påse",
	"item.minecraft.blue_dye": "Blå färg",
	"item.minecraft.blue_egg": "Blått ägg",
	"item.minecraft.blue_harness": "Blå sele",
	"item.minecraft.bogged_spawn_egg": "Skapelseägg för sumpigt skelett",
	"item.minecraft.bolt_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Bultförsedda rustningsdetaljer",
	"item.minecraft.bone": "Ben",
	"item.minecraft.bone_meal": "Benmjöl",
	"item.minecraft.book": "Bok",
	"item.minecraft.bordure_indented_banner_pattern": "Fanemönster för taggig ram",
	"item.minecraft.bow": "Pilbåge",
	"item.minecraft.bowl": "Skål",
	"item.minecraft.bread": "Bröd",
	"item.minecraft.breeze_rod": "Vindstav",
	"item.minecraft.breeze_spawn_egg": "Skapelseägg för vindväsen",
	...
	"item.minecraft.brown_bundle": "Brun påse",
	"item.minecraft.brown_dye": "Brun färg",
	"item.minecraft.brown_egg": "Brunt ägg",
	"item.minecraft.brown_harness": "Brun sele",
	"item.minecraft.brush": "Borste",
	"item.minecraft.bucket": "Hink",
	"item.minecraft.bundle": "Påse",
	"item.minecraft.bundle.empty": "Tom",
	"item.minecraft.bundle.empty.description": "Kan förvara 64 föremål av olika slag",
	...
	"item.minecraft.camel_husk_spawn_egg": "Skapelseägg för uttorkad kamel",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Kustutsmyckade rustningsdetaljer",
	...
	"item.minecraft.copper_axe": "Kopparyxa",
	"item.minecraft.copper_boots": "Kopparstövlar",
	"item.minecraft.copper_chestplate": "Kopparharnesk",
	"item.minecraft.copper_golem_spawn_egg": "Skapelseägg för koppargolem",
	"item.minecraft.copper_helmet": "Kopparhjälm",
	"item.minecraft.copper_hoe": "Kopparflåhacka",
	"item.minecraft.copper_horse_armor": "Kopparhästrustning",
	"item.minecraft.copper_ingot": "Koppartacka",
	"item.minecraft.copper_leggings": "Kopparbyxor",
	"item.minecraft.copper_nautilus_armor": "Kopparpärlbåtsrustning",
	"item.minecraft.copper_nugget": "Kopparklimp",
	"item.minecraft.copper_pickaxe": "Kopparhacka",
	"item.minecraft.copper_shovel": "Kopparspade",
	"item.minecraft.copper_spear": "Kopparspjut",
	"item.minecraft.copper_sword": "Kopparsvärd",
	"item.minecraft.cow_spawn_egg": "Skapelseägg för ko",
	"item.minecraft.creaking_spawn_egg": "Skapelseägg för knarrträd",
	"item.minecraft.creeper_banner_pattern": "Fanemönster",
	"item.minecraft.creeper_banner_pattern.desc": "Creeper",
	"item.minecraft.creeper_banner_pattern.new": "Fanemönster för creeper",
	...
	"item.minecraft.crossbow.projectile.multiple": "Laddade projektiler: %s × %s",
	"item.minecraft.crossbow.projectile.single": "Laddad projektil: %s",
	"item.minecraft.cyan_bundle": "Turkos påse",
	"item.minecraft.cyan_dye": "Turkos färg",
	"item.minecraft.cyan_harness": "Turkos sele",
	...
	"item.minecraft.diamond_nautilus_armor": "Diamantpärlbåtsrustning",
	"item.minecraft.diamond_pickaxe": "Diamanthacka",
	"item.minecraft.diamond_shovel": "Diamantspade",
	"item.minecraft.diamond_spear": "Diamantspjut",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Ökenartade rustningsdetaljer",
	...
	"item.minecraft.enchanted_golden_apple": "Förtrollat gyllene äpple",
	...
	"item.minecraft.eye_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Ögondekorerade rustningsdetaljer",
	"item.minecraft.feather": "Fjäder",
	"item.minecraft.fermented_spider_eye": "Jäst spindelöga",
	"item.minecraft.field_masoned_banner_pattern": "Fanemönster för tegelmönster",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Virvelformade rustningsdetaljer",
	"item.minecraft.flow_banner_pattern": "Fanemönster",
	"item.minecraft.flow_banner_pattern.desc": "Virvel",
	"item.minecraft.flow_banner_pattern.new": "Fanemönster för virvel",
	"item.minecraft.flow_pottery_sherd": "Keramikskärva med virvel",
	"item.minecraft.flower_banner_pattern": "Fanemönster",
	"item.minecraft.flower_banner_pattern.desc": "Blomma",
	"item.minecraft.flower_banner_pattern.new": "Fanemönster för blomma",
	"item.minecraft.flower_pot": "Blomkruka",
	"item.minecraft.fox_spawn_egg": "Skapelseägg för räv",
	"item.minecraft.friend_pottery_shard": "Keramikskärva med vänligt ansikte",
	...
	"item.minecraft.globe_banner_pattern.new": "Fanemönster för glob",
	...
	"item.minecraft.golden_apple": "Gyllene äpple",
	...
	"item.minecraft.golden_nautilus_armor": "Guldpärlbåtsrustning",
	"item.minecraft.golden_pickaxe": "Guldhacka",
	"item.minecraft.golden_shovel": "Guldspade",
	"item.minecraft.golden_spear": "Guldspjut",
	"item.minecraft.golden_sword": "Guldsvärd",
	"item.minecraft.gray_bundle": "Grå påse",
	"item.minecraft.gray_dye": "Grå färg",
	"item.minecraft.gray_harness": "Grå sele",
	"item.minecraft.green_bundle": "Grön påse",
	"item.minecraft.green_dye": "Grön färg",
	"item.minecraft.green_harness": "Grön sele",
	"item.minecraft.guardian_spawn_egg": "Skapelseägg för väktare",
	"item.minecraft.gunpowder": "Krut",
	"item.minecraft.guster_banner_pattern": "Fanemönster",
	"item.minecraft.guster_banner_pattern.desc": "Vindväsen",
	"item.minecraft.guster_banner_pattern.new": "Fanemönster för vindväsen",
	"item.minecraft.guster_pottery_sherd": "Keramikskärva med vindväsen",
	"item.minecraft.happy_ghast_spawn_egg": "Skapelseägg för glad ghast",
	"item.minecraft.harness": "Sele",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.host_armor_trim_smithing_template.new": "Gästgivande rustningsdetaljer",
	...
	"item.minecraft.light_blue_bundle": "Ljusblå påse",
	"item.minecraft.light_blue_dye": "Ljusblå färg",
	"item.minecraft.light_blue_harness": "Ljusblå sele",
	"item.minecraft.light_gray_bundle": "Ljusgrå påse",
	"item.minecraft.light_gray_dye": "Ljusgrå färg",
	"item.minecraft.light_gray_harness": "Ljusgrå sele",
	"item.minecraft.lime_bundle": "Limegrön påse",
	"item.minecraft.lime_dye": "Limegrön färg",
	"item.minecraft.lime_harness": "Limegrön sele",
	...
	"item.minecraft.lingering_potion.effect.infested": "Kvardröjande infestationsbrygd",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Kvardröjande slemmighetsbrygd",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Kvardröjande spindelnätsbrygd",
	"item.minecraft.lingering_potion.effect.wind_charged": "Kvardröjande vindladdningsbrygd",
	...
	"item.minecraft.magenta_bundle": "Ljuslila påse",
	"item.minecraft.magenta_dye": "Ljuslila färg",
	"item.minecraft.magenta_harness": "Ljuslila sele",
	...
	"item.minecraft.mojang_banner_pattern.new": "Fanemönster för mojäng",
	...
	"item.minecraft.music_disc_bounce": "Musikskiva",
	...
	"item.minecraft.music_disc_creator": "Musikskiva",
	"item.minecraft.music_disc_creator.desc": "Lena Raine – Creator",
	"item.minecraft.music_disc_creator_music_box": "Musikskiva",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine – Creator (speldosa)",
	"item.minecraft.music_disc_far": "Musikskiva",
	"item.minecraft.music_disc_far.desc": "C418 – far",
	"item.minecraft.music_disc_lava_chicken": "Musikskiva",
	...
	"item.minecraft.music_disc_precipice": "Musikskiva",
	...
	"item.minecraft.music_disc_tears": "Musikskiva",
	...
	"item.minecraft.nautilus_spawn_egg": "Skapelseägg för pärlbåt",
	...
	"item.minecraft.netherite_horse_armor": "Netherithästrustning",
	"item.minecraft.netherite_ingot": "Netherittacka",
	"item.minecraft.netherite_leggings": "Netheritbyxor",
	"item.minecraft.netherite_nautilus_armor": "Netheritpärlbåtsrustning",
	...
	"item.minecraft.netherite_spear": "Netheritspjut",
	"item.minecraft.netherite_sword": "Netheritsvärd",
	"item.minecraft.netherite_upgrade_smithing_template": "Smidesmall",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Netherituppgradering",
	...
	"item.minecraft.ominous_bottle": "Oroväckande flaska",
	"item.minecraft.ominous_trial_key": "Oroväckande utmaningsnyckel",
	"item.minecraft.orange_bundle": "Orange påse",
	"item.minecraft.orange_dye": "Orange färg",
	"item.minecraft.orange_harness": "Orange sele",
	"item.minecraft.painting": "Tavla",
	"item.minecraft.pale_oak_boat": "Blek ekbåt",
	"item.minecraft.pale_oak_chest_boat": "Blek ekbåt med kista",
	"item.minecraft.panda_spawn_egg": "Skapelseägg för panda",
	"item.minecraft.paper": "Papper",
	"item.minecraft.parched_spawn_egg": "Skapelseägg för uttorkat skelett",
	...
	"item.minecraft.piglin_banner_pattern.new": "Fanemönster för tryne",
	...
	"item.minecraft.pink_bundle": "Rosa påse",
	"item.minecraft.pink_dye": "Rosa färg",
	"item.minecraft.pink_harness": "Rosa sele",
	...
	"item.minecraft.potion.effect.infested": "Infestationsbrygd",
	...
	"item.minecraft.potion.effect.oozing": "Slemmighetsbrygd",
	...
	"item.minecraft.potion.effect.weaving": "Spindelnätsbrygd",
	"item.minecraft.potion.effect.wind_charged": "Vindladdningsbrygd",
	"item.minecraft.pottery_shard_archer": "Keramikskärva med pilbåge",
	"item.minecraft.pottery_shard_arms_up": "Keramikskärva med uppsträckta armar",
	"item.minecraft.pottery_shard_prize": "Keramikskärva med ädelsten",
	"item.minecraft.pottery_shard_skull": "Keramikskärva med dödskalle",
	...
	"item.minecraft.purple_bundle": "Lila påse",
	"item.minecraft.purple_dye": "Lila färg",
	"item.minecraft.purple_harness": "Lila sele",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Uppfödande rustningsdetaljer",
	...
	"item.minecraft.red_bundle": "Röd påse",
	"item.minecraft.red_dye": "Röd färg",
	"item.minecraft.red_harness": "Röd sele",
	"item.minecraft.redstone": "Redstonedamm",
	"item.minecraft.resin_brick": "Hartstegelsten",
	"item.minecraft.resin_clump": "Hartsklump",
	"item.minecraft.rib_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Revbensrandiga rustningsdetaljer",
	...
	"item.minecraft.scrape_pottery_sherd": "Keramikskärva med yxa",
	"item.minecraft.scute": "Skal",
	"item.minecraft.sentry_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Värnande rustningsdetaljer",
	"item.minecraft.shaper_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Formgivande rustningsdetaljer",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Ljudlösa rustningsdetaljer",
	...
	"item.minecraft.skull_banner_pattern.new": "Fanemönster för dödskalle",
	...
	"item.minecraft.snout_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Trynformade rustningsdetaljer",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Spiraformade rustningsdetaljer",
	...
	"item.minecraft.splash_potion.effect.infested": "Kastbar infestationsbrygd",
	...
	"item.minecraft.splash_potion.effect.oozing": "Kastbar slemmighetsbrygd",
	...
	"item.minecraft.splash_potion.effect.weaving": "Kastbar spindelnätsbrygd",
	"item.minecraft.splash_potion.effect.wind_charged": "Kastbar vindladdningsbrygd",
	...
	"item.minecraft.stone_spear": "Stenspjut",
	...
	"item.minecraft.sulfur_cube_bucket": "Hink med svavelkub",
	"item.minecraft.sulfur_cube_spawn_egg": "Skapelseägg för svavelkub",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Tidvattenvågsprydda rustningsdetaljer",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Infestationspil",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Slemmighetspil",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Spindelnätspil",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Vindladdningspil",
	...
	"item.minecraft.trial_key": "Utmaningsnyckel",
	...
	"item.minecraft.turtle_scute": "Sköldpaddsskal",
	"item.minecraft.turtle_spawn_egg": "Skapelseägg för sköldpadda",
	"item.minecraft.vex_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Osaliga rustningsdetaljer",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Vaktande rustningsdetaljer",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Vägvisande rustningsdetaljer",
	"item.minecraft.wheat": "Vete",
	"item.minecraft.wheat_seeds": "Vetefrön",
	"item.minecraft.white_bundle": "Vit påse",
	"item.minecraft.white_dye": "Vit färg",
	"item.minecraft.white_harness": "Vit sele",
	"item.minecraft.wild_armor_trim_smithing_template": "Smidesmall",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Vildsinta rustningsdetaljer",
	"item.minecraft.wind_charge": "Vindladdning",
	...
	"item.minecraft.wolf_armor": "Vargrustning",
	...
	"item.minecraft.wooden_spear": "Träspjut",
	...
	"item.modifiers.any": "Påsatt:",
	"item.modifiers.armor": "Påsatt:",
	"item.modifiers.body": "Påsatt:",
	"item.modifiers.chest": "På bröstet:",
	"item.modifiers.feet": "På fötterna:",
	"item.modifiers.hand": "I handen:",
	...
	"item.modifiers.saddle": "Sadlad:",
	"item.nbt_tags": "NBT: %s taggar",
	"item.op_block_warning.line1": "Varning:",
	"item.op_block_warning.line2": "Kommandon kan komma att köras om detta föremål används.",
	"item.op_block_warning.line3": "Använd endast om du känner till det exakta innehållet!",
	"item.spawn_egg.peaceful": "Inaktiverat på fredlig svårighetsgrad",
	...
	"jigsaw_block.placement_priority.tooltip": "När det här pusselbitsblocket ansluts till en bit är det i denna ordning som biten bearbetas för anslutningar i den större strukturen.\n\nBitar bearbetas i fallande prioritetsordning där insättningordningen bryter sammankopplingar.",
	"jigsaw_block.pool": "Målpool:",
	"jigsaw_block.selection_priority": "Valprioritet:",
	"jigsaw_block.selection_priority.tooltip": "När den överordnade pusselbiten bearbetas för anslutningar är det i denna ordning som det här pusselbitsblocket försöker ansluta till sin målbit.\n\nPusselbitar bearbetas i fallande prioritetsordning där slumpad ordning bryter sammankopplingar.",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine – Creator (speldosa)",
	...
	"key.categories.spectator": "Åskådare",
	"key.categories.ui": "Spelgränssnitt",
	"key.category.minecraft.creative": "Kreativt läge",
	"key.category.minecraft.debug": "Felsökning",
	"key.category.minecraft.gameplay": "Handlingar",
	"key.category.minecraft.inventory": "Förråd",
	"key.category.minecraft.misc": "Blandat",
	"key.category.minecraft.movement": "Rörelse",
	"key.category.minecraft.multiplayer": "Flerspelarläge",
	"key.category.minecraft.spectator": "Åskådarläge",
	"key.chat": "Öppna chatt",
	"key.command": "Öppna kommando",
	"key.debug.clearChat": "Rensa chatt",
	"key.debug.copyLocation": "Kopiera position",
	"key.debug.copyRecreateCommand": "Kopiera data",
	"key.debug.crash": "Felsökningskrasch",
	"key.debug.debugOptions": "Felsökningsalternativ",
	"key.debug.dumpDynamicTextures": "Dumpa dynamiska texturer",
	"key.debug.dumpVersion": "Dumpa versionsinformation",
	"key.debug.focusPause": "Slå på/av paus vid förlorad fokus",
	"key.debug.fpsCharts": "Bildfrekvensdiagram",
	"key.debug.lightmapTexture": "Ljuskartstextur",
	"key.debug.modifier": "Tilläggstangent för kortkommandon",
	"key.debug.networkCharts": "Nätverksdiagram",
	"key.debug.overlay": "Visa/dölj överlägg",
	"key.debug.profiling": "Starta/stoppa profilering",
	"key.debug.profilingChart": "Profileringsdiagram",
	"key.debug.reloadChunk": "Uppdatera datablock",
	"key.debug.reloadResourcePacks": "Uppdatera resurspaket",
	"key.debug.showAdvancedTooltips": "Visa avancerade inforutor",
	"key.debug.showChunkBorders": "Visa datablocksgränser",
	"key.debug.showHitboxes": "Visa hitboxar",
	"key.debug.spectate": "Växla till åskådarläge",
	"key.debug.switchGameMode": "Spellägesbytare",
	...
	"key.quickActions": "Snabbåtgärder",
	...
	"key.spectatorHotbar": "Öppna/välj i åskådarmeny",
	"key.spectatorOutlines": "Tydliggör spelare",
	"key.sprint": "Spring",
	"key.swapOffhand": "Byt föremål med sekundär hand",
	"key.toggleGui": "Visa/dölj gränssnitt",
	"key.togglePerspective": "Byt perspektiv",
	"key.toggleSpectatorShaderEffects": "Visa/dölj shadereffekter i åskådarläge",
	"key.use": "Använd/placera",
	"known_server_link.announcements": "Meddelanden",
	"known_server_link.community": "Gemenskapen",
	"known_server_link.community_guidelines": "Gemenskapsriktlinjer",
	"known_server_link.feedback": "Återkoppling",
	"known_server_link.forums": "Forum",
	"known_server_link.news": "Nyheter",
	"known_server_link.report_bug": "Rapportera serverbugg",
	"known_server_link.status": "Status",
	"known_server_link.support": "Hjälp",
	"known_server_link.website": "Webbplats",
	...
	"loading.progress": "%s %%",
	"manageServer.add.title": "Lägg till server",
	"manageServer.edit.title": "Redigera serverinformation",
	"manageServer.enterIp": "Serveradress",
	"manageServer.enterName": "Servernamn",
	"manageServer.resourcePack": "Serverresurspaket",
	"manageServer.resourcePack.disabled": "AV",
	"manageServer.resourcePack.enabled": "PÅ",
	"manageServer.resourcePack.prompt": "Fråga",
	"mco.account.privacy.info": "Läs mer om Mojang Studios och integritetslagar",
	"mco.account.privacy.info.button": "Läs mer om GDPR",
	"mco.account.privacy.information": "Mojang Studios genomför vissa procedurer för att skydda barn och deras integritet inklusive att följa Children’s Online Privacy Protection Act (COPPA) och dataskyddsförordningen (DSF / GDPR).\n\nDu kanske behöver få tillåtelse från en vårdnadshavare innan du kan komma åt ditt Realms-konto.",
	...
	"mco.backup.button.download": "Ladda ned senaste",
	...
	"mco.backup.entry": "Säkerhetskopia (%s)",
	"mco.backup.entry.description": "Beskrivning",
	"mco.backup.entry.enabledPack": "Aktiverade paket",
	"mco.backup.entry.gameDifficulty": "Spelets svårighetsgrad",
	"mco.backup.entry.gameMode": "Spelläge",
	"mco.backup.entry.gameServerVersion": "Spelserverns version",
	"mco.backup.entry.name": "Namn",
	"mco.backup.entry.seed": "Frö",
	"mco.backup.entry.templateName": "Mallnamn",
	"mco.backup.entry.undefined": "Odefinierad ändring",
	"mco.backup.entry.uploaded": "Uppladdade",
	"mco.backup.entry.worldType": "Världstyp",
	"mco.backup.entry.worldType.adventureMap": "Äventyrskarta",
	"mco.backup.entry.worldType.experience": "Upplevelse",
	...
	"mco.backup.entry.worldType.unknown": "Okänd",
	"mco.backup.generate.world": "Generera värld",
	"mco.backup.info.title": "Ändringar från senaste säkerhetskopian",
	"mco.backup.narration": "Säkerhetskopia från %s",
	"mco.backup.nobackups": "Denna Realm har för tillfället inga säkerhetskopior.",
	"mco.backup.restoring": "Återställer din Realm",
	"mco.backup.unknown": "OKÄND",
	...
	"mco.client.outdated.stable.version": "Din klientversion (%s) är inte kompatibel med Realms.\n\nAnvänd den senaste versionen av Minecraft.",
	"mco.client.unsupported.snapshot.version": "Din klientversion (%s) är inte kompatibel med Realms.\n\nRealms är inte tillgänglig för denna experimentversion.",
	"mco.compatibility.downgrade": "Nedgradera",
	"mco.compatibility.downgrade.description": "Den här världen spelades senast i version %s och du använder version %s. Om en värld nedgraderas kan den skadas – vi kan inte garantera att den kommer att läsas in eller fungera.\n\nEn säkerhetskopia av din värld kommer att sparas under \"Säkerhetskopior\". Återställ den vid behov.",
	"mco.compatibility.incompatible.popup.title": "Inkompatibel version",
	"mco.compatibility.incompatible.releaseType.popup.message": "Världen du försöker ansluta till är inkompatibel med versionen du använder.",
	"mco.compatibility.incompatible.series.popup.message": "Den här världen spelades senast i version %s och du använder version %s.\n\nDessa serier är inte kompatibla med varandra. En ny värld krävs för att kunna spela på den här versionen.",
	"mco.compatibility.unverifiable.message": "Versionen som denna värld senast spelades i kunde inte verifieras. Om världen upp- eller nedgraderas kommer en säkerhetskopia automatiskt att skapas och sparas under \"Säkerhetskopior\".",
	"mco.compatibility.unverifiable.title": "Kompatibilitet kan inte verifieras",
	"mco.compatibility.upgrade": "Uppgradera",
	"mco.compatibility.upgrade.description": "Den här världen spelades senast i version %s och du använder version %s.\n\nEn säkerhetskopia av din värld kommer att sparas under \"Säkerhetskopior\".\n\nÅterställ den vid behov.",
	"mco.compatibility.upgrade.friend.description": "Den här världen spelades senast i version %s och du använder version %s.\n\nEn säkerhetskopia av världen kommer att sparas under \"Säkerhetskopior\".\n\nRealmens ägare kan återställa den vid behov.",
	"mco.compatibility.upgrade.title": "Vill du verkligen uppgradera den här världen?",
	...
	"mco.configure.world.buttons.close": "Stäng Realm tillfälligt",
	...
	"mco.configure.world.buttons.newworld": "Ny värld",
	"mco.configure.world.buttons.open": "Öppna Realm igen",
	"mco.configure.world.buttons.options": "Världsalternativ",
	"mco.configure.world.buttons.players": "Spelare",
	"mco.configure.world.buttons.region_preference": "Välj region...",
	"mco.configure.world.buttons.resetworld": "Återställ värld",
	"mco.configure.world.buttons.save": "Spara",
	...
	"mco.configure.world.close.question.line1": "Du kan tillfälligt stänga din Realm och förhindra att den används medan du gör justeringar. Öppna den igen när du är redo.\n\nDetta avslutar inte din prenumeration på Realms.",
	"mco.configure.world.close.question.line2": "Är du säker på att du vill fortsätta?",
	"mco.configure.world.close.question.title": "Behöver du göra ändringar utan att bli störd?",
	"mco.configure.world.closing": "Stänger Realmen tillfälligt...",
	...
	"mco.configure.world.invited.number": "Inbjudna (%s)",
	...
	"mco.configure.world.loading": "Läser in Realm",
	"mco.configure.world.location": "Plats",
	"mco.configure.world.minigame": "Nuvarande: %s",
	"mco.configure.world.name": "Namn på Realm",
	"mco.configure.world.name.validation.whitespace": "Får inte börja eller sluta med blanktecken. Dessa tas bort automatiskt.",
	"mco.configure.world.opening": "Öppnar Realm...",
	"mco.configure.world.players.error": "En spelare med det angivna namnet finns inte",
	"mco.configure.world.players.invite.duplicate": "En spelare med det angivna namnet har redan blivit inbjuden till Realmen",
	"mco.configure.world.players.inviting": "Bjuder in spelare...",
	"mco.configure.world.players.title": "Spelare",
	"mco.configure.world.pvp": "Strider mellan spelare",
	"mco.configure.world.region_preference": "Regionsinställningar",
	"mco.configure.world.region_preference.title": "Välj region",
	...
	"mco.configure.world.resourcepack.question": "Du behöver ett anpassat resurspaket för att spela på denna Realm\n\nVill du ladda ned det och spela?",
	...
	"mco.configure.world.settings.expired": "Du kan inte redigera inställningarna för en utgången Realm",
	...
	"mco.configure.world.spawn_toggle.message": "Om detta alternativ inaktiveras kommer alla befintliga entiteter av den typen att försvinna",
	"mco.configure.world.spawn_toggle.message.npc": "Om detta alternativ inaktiveras kommer alla befintliga entiteter av den typen att försvinna, t.ex. bybor",
	...
	"mco.configure.world.subscription.remaining.days": "%[1]s dagar",
	"mco.configure.world.subscription.remaining.months": "%[1]s månader",
	"mco.configure.world.subscription.remaining.months.days": "%[1]s månader, %[2]s dagar",
	"mco.configure.world.subscription.start": "Startdatum",
	"mco.configure.world.subscription.tab": "Abonnemang",
	...
	"mco.configure.world.uninvite.player": "Är du säker att du vill dra tillbaka inbjudan för \"%s\"?",
	...
	"mco.create.world.failed": "Misslyckades att skapa värld!",
	...
	"mco.download.confirmation.oversized": "Världen du håller på att ladda ned är större än %s\n\nDu kommer inte att kunna ladda upp den här världen till din Realm igen",
	...
	"mco.download.resourcePack.fail": "Misslyckades att ladda ned resurspaket!",
	"mco.download.speed": "(%s/s)",
	"mco.download.speed.narration": "%s/s",
	"mco.download.title": "Laddar ned senaste världen",
	...
	"mco.errorMessage.6003": "Nedladdningsgränsen har uppnåtts",
	"mco.errorMessage.6004": "Uppladdningsgränsen har uppnåtts",
	"mco.errorMessage.6005": "Världen är låst",
	"mco.errorMessage.6006": "Världen är utdaterad",
	"mco.errorMessage.6007": "Användaren är i för många Realms",
	"mco.errorMessage.6008": "Ogiltigt namn på Realm",
	"mco.errorMessage.6009": "Ogiltig beskrivning på Realm",
	"mco.errorMessage.connectionFailure": "Ett fel uppstod. Försök igen senare.",
	"mco.errorMessage.generic": "Ett fel uppstod: ",
	"mco.errorMessage.initialize.failed": "Misslyckades att initiera Realm",
	"mco.errorMessage.noDetails": "Ingen felinformation har angetts",
	"mco.errorMessage.realmsService": "Ett fel uppstod (%s):",
	"mco.errorMessage.realmsService.configurationError": "Ett oväntat fel uppstod när världsalternativ redigerades",
	"mco.errorMessage.realmsService.connectivity": "Kunde inte ansluta till Realms: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Kontroll av kompatibel version misslyckades. Fick svar: %s",
	"mco.errorMessage.retry": "Försök igen",
	...
	"mco.gui.ok": "OK",
	"mco.info": "Info!",
	"mco.invited.player.narration": "Bjöd in spelaren %s",
	...
	"mco.minigame.world.restore.question.line1": "Minispelet kommer att avslutas och din Realm kommer att återställas.",
	...
	"mco.notification.transferSubscription.buttonText": "Överför nu",
	"mco.notification.transferSubscription.message": "Prenumerationer på Java Realms flyttas till Microsoft Store. Låt inte din prenumeration löpa ut!\nÖverför nu och få 30 dagars kostnadsfri Realms.\nGå till din profil på minecraft.net för att överföra din prenumeration.",
	"mco.notification.visitUrl.buttonText.default": "Öppna länk",
	"mco.notification.visitUrl.message.default": "Besök länken nedan",
	"mco.onlinePlayers": "Anslutna spelare",
	"mco.play.button.realm.closed": "Realmen är stängd",
	"mco.question": "Fråga",
	...
	"mco.selectServer.closed": "Inaktiverad Realm",
	...
	"mco.selectServer.create.subtitle": "Välj vilken värld du ska ha på din nya Realm",
	...
	"mco.selectServer.loading": "Läser in Realms-listan",
	...
	"mco.selectServer.noRealms": "Du verkar inte äga en Realm. Lägg till en för att spela tillsammans med dina vänner.",
	...
	"mco.snapshot.createSnapshotPopup.text": "Du håller på att skapa en kostnadsfri experimentversionsrealm som sammankopplas med din betalda prenumeration på Realms. Denna nya experimentversionsrealm är tillgänglig så länge den betalda prenumerationen är aktiv. Din betalda Realm kommer inte att påverkas",
	"mco.snapshot.createSnapshotPopup.title": "Skapa experimentversionsrealm?",
	"mco.snapshot.creating": "Skapar experimentversionsrealm...",
	"mco.snapshot.description": "Sammankopplad med \"%s\"",
	"mco.snapshot.friendsRealm.downgrade": "Du måste använda version %s för att ansluta till denna Realm",
	"mco.snapshot.friendsRealm.upgrade": "%s måste uppgradera sin Realm innan du kan spela från denna version",
	"mco.snapshot.paired": "Denna experimentversionsrealm är sammankopplad med \"%s\"",
	"mco.snapshot.parent.tooltip": "Använd den senaste utgåvan av Minecraft för att spela på denna Realm",
	"mco.snapshot.start": "Starta kostnadsfri experimentversionsrealm",
	"mco.snapshot.subscription.info": "Detta är en experimentversionsrealm som är sammankopplad till prenumerationen av din Realm \"%s\". Den är aktiv lika länge som dess sammankopplade Realm.",
	"mco.snapshot.tooltip": "Använd experimentversionsrealms för att få en smygtitt på kommande versioner av Minecraft, som kan innehålla nya funktioner och andra ändringar.\n\nDu kan hitta dina vanliga Realms i spelets utgivningsversion.",
	"mco.snapshotRealmsPopup.message": "Realms är nu tillgänglig i experimentversioner från och med 23w41a. Alla prenumerationer på Realms inkluderar en kostnadsfri Realm för experimentversioner som är separat från din vanliga Realm för Java Edition!",
	"mco.snapshotRealmsPopup.title": "Realms är nu tillgänglig i experimentversioner",
	"mco.snapshotRealmsPopup.urlText": "Läs mer",
	...
	"mco.time.daysAgo": "%[1]s dagar sedan",
	"mco.time.hoursAgo": "%[1]s timmar sedan",
	"mco.time.minutesAgo": "%[1]s minuter sedan",
	"mco.time.now": "nu",
	"mco.time.secondsAgo": "%[1]s sekunder sedan",
	...
	"mco.upload.close.failure": "Kunde inte stänga din Realm. Försök igen senare.",
	...
	"mco.upload.failed.too_big.description": "Den valda världen är för stor. Den maximalt tillåtna storleken är %s.",
	"mco.upload.failed.too_big.title": "Världen är för stor",
	...
	"menu.custom_options": "Anpassade alternativ...",
	"menu.custom_options.title": "Anpassade alternativ",
	"menu.custom_options.tooltip": "OBS: Anpassade alternativ tillhandahålls av servrar och/eller innehåll från tredje part.\nVar försiktig!",
	"menu.custom_screen_info.button_narration": "Detta är en anpassad meny. Läs mer.",
	"menu.custom_screen_info.contents": "Innehållet i denna meny styrs av tredjepartsservrar och kartor som varken ägs, hanteras eller övervakas av Mojang Studios eller Microsoft.\n\nVar alltid försiktig när du klickar på länkar och ge aldrig bort privat information, inklusive inloggningsuppgifter.\n\nOm denna meny förhindrar dig från att spela kan du även koppla från den nuvarande servern med hjälp av knappen nedan.",
	"menu.custom_screen_info.disconnect": "Anpassad meny nekades",
	"menu.custom_screen_info.title": "Information om anpassade menyer",
	"menu.custom_screen_info.tooltip": "Detta är en anpassad meny. Klicka här om du vill läsa mer.",
	"menu.disconnect": "Lämna server",
	"menu.feedback": "Återkoppling...",
	"menu.feedback.title": "Återkoppling",
	"menu.game": "Spelmeny",
	"menu.modded": " (moddad)",
	"menu.multiplayer": "Flerspelarläge",
	"menu.multiplayerOptions.applyChanges": "Tillämpa ändringar",
	"menu.multiplayerOptions.button": "Flerspelarläge...",
	"menu.multiplayerOptions.network": "Flerspelarläge",
	"menu.multiplayerOptions.network.header": "Nätverk",
	"menu.multiplayerOptions.network.lan": "LAN",
	"menu.multiplayerOptions.network.lan.tooltip": "Spelare på samma nätverk kan ansluta.",
	"menu.multiplayerOptions.network.off": "AV",
	"menu.multiplayerOptions.network.off.tooltip": "Ingen kan ansluta.",
	"menu.multiplayerOptions.network.online": "Uppkopplat",
	"menu.multiplayerOptions.network.online.tooltip": "Uppkopplade vänner kan ansluta.",
	"menu.multiplayerOptions.otherPlayers.header": "Andra spelare",
	"menu.multiplayerOptions.publish.started.lan": "Denna värld är nu öppen för LAN. Portnumret är %s",
	"menu.multiplayerOptions.publish.started.online": "Denna värld är nu tillgänglig i uppkopplat flerspelarläge.",
	"menu.multiplayerOptions.publish.stopped": "Denna värld är inte längre tillgänglig i flerspelarläge",
	"menu.multiplayerOptions.title": "Flerspelaralternativ",
	"menu.online": "Minecraft Realms",
	"menu.options": "Alternativ...",
	"menu.paused": "Spelet är pausat",
	"menu.playdemo": "Spela demovärld",
	"menu.playerReporting": "Anmäl spelare",
	"menu.playerReporting.no_players": "Det finns inga spelare att rapportera i denna värld",
	"menu.preparingSpawn": "Förbereder startområde: %s %%",
	"menu.quick_actions": "Snabbåtgärder...",
	"menu.quick_actions.title": "Snabbåtgärder",
	"menu.quit": "Avsluta",
	...
	"menu.server_links": "Serverlänkar...",
	"menu.server_links.title": "Serverlänkar",
	...
	"multiplayer.codeOfConduct.check": "Visa inte igen för den här uppförandekoden",
	"multiplayer.codeOfConduct.title": "Serverns uppförandekod",
	"multiplayer.confirm_command.parse_errors": "Du försöker köra ett okänt eller ogiltigt kommando.\nÄr du säker?\nKommando: %s",
	"multiplayer.confirm_command.permissions_required": "Du försöker köra ett kommando som kräver förhöjda behörigheter.\nDet skulle kunna påverka ditt spel negativt.\nÄr du säker?\nKommando: %s",
	"multiplayer.confirm_command.run_command": "Kör kommando",
	"multiplayer.confirm_command.signature_required": "Du försöker köra ett kommando som kommer att skicka chattmeddelanden i ditt namn.\nDet kan endast köras från chattfönstret.\nKommando: %s",
	"multiplayer.confirm_command.suggest_command": "Kopiera till chattfönstret",
	"multiplayer.confirm_command.title": "Bekräfta körning av kommando",
	"multiplayer.disconnect.authservers_down": "Autentiseringsservrarna är nere. Försök igen senare. Förlåt!",
	"multiplayer.disconnect.bad_chat_index": "Identifierade chattmeddelanden som saknats eller inkommit i fel ordning från servern",
	...
	"multiplayer.disconnect.banned.reason.default": "Bannlyst av en operatör.",
	...
	"multiplayer.disconnect.code_of_conduct": "Servern kräver att du accepterar uppförandekoden",
	"multiplayer.disconnect.configuration_error": "Oväntat fel uppstod under konfigurationen",
	...
	"multiplayer.disconnect.transfers_disabled": "Servern accepterar inte överföringar",
	"multiplayer.disconnect.unexpected_query_response": "Oförväntad anpassad data från klienten",
	"multiplayer.disconnect.unsigned_chat": "Mottog ett chattpaket med en saknad eller ogiltig signatur.",
	...
	"multiplayer.player.list.hp": "%s hp",
	...
	"multiplayer.status.anonymous_player": "Anonym spelare",
	...
	"narration.checkbox.usage.focused.check": "Tryck på Retur för att markera",
	"narration.checkbox.usage.focused.uncheck": "Tryck på Retur för att avmarkera",
	"narration.checkbox.usage.hovered": "Vänsterklicka för att markera",
	"narration.checkbox.usage.hovered.check": "Vänsterklicka för att markera",
	"narration.checkbox.usage.hovered.uncheck": "Vänsterklicka för att avmarkera",
	...
	"narration.item": "Föremål: %s",
	"narration.link.usage.focused": "Tryck på Retur för att följa länken",
	"narration.link.usage.hovered": "Vänsterklicka för att följa länken",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Tryck på Retur för att börja ändra på reglaget",
	...
	"narration.suggestion.usage.cycle.fixed": "Tryck på Tabb för att gå till nästa förslag",
	"narration.suggestion.usage.cycle.hidable": "Tryck på Tabb för att gå till nästa förslag, eller Escape för att inaktivera förslag",
	"narration.suggestion.usage.fill.fixed": "Tryck på Tabb för att aktivera förslag",
	"narration.suggestion.usage.fill.hidable": "Tryck på Tabb för att aktivera förslag, eller Escape för att inaktivera förslag",
	...
	"narrator.position.list": "Valde rad %s av %s",
	...
	"narrator.select.world_info": "Valde %s, spelades senast: %s, %s",
	...
	"optimizeWorld.confirm.proceed": "Säkerhetskopiera o. optimera",
	...
	"optimizeWorld.stage.finished.chunks": "Slutför uppgradering av datablock...",
	"optimizeWorld.stage.finished.entities": "Slutför uppgradering av entiteter...",
	"optimizeWorld.stage.finished.poi": "Slutför uppgradering av intressepunkter...",
	"optimizeWorld.stage.upgrading": "Uppgraderar alla datablock...",
	"optimizeWorld.stage.upgrading.chunks": "Uppgraderar alla datablock...",
	"optimizeWorld.stage.upgrading.entities": "Uppgraderar alla entiteter...",
	"optimizeWorld.stage.upgrading.poi": "Uppgraderar alla intressepunkter...",
	"optimizeWorld.title": "Optimerar världen \"%s\"",
	"options.accessibility": "Tillgänglighetsinställningar...",
	...
	"options.accessibility.high_contrast_block_outline.tooltip": "Förstärker konturens kontrast för blocket du tittar på.",
	"options.accessibility.link": "Tillgänglighetsguide",
	"options.accessibility.menu_background_blurriness": "Suddig menybakgrund",
	"options.accessibility.menu_background_blurriness.tooltip": "Ändrar hur oskarp bakgrunden ska vara hos menyer.",
	"options.accessibility.narrator_hotkey": "Kortkomm. för uppläsare",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Gör det möjligt att aktivera eller inaktivera uppläsaren med kortkommandot \"Kmd + B\".",
	"options.accessibility.narrator_hotkey.tooltip": "Gör det möjligt att aktivera eller inaktivera uppläsaren med kortkommandot \"Ctrl + B\".",
	...
	"options.accessibility.tooltip": "Tillgänglighetsinställningar",
	"options.allowCursorChanges": "Dynamisk muspekare",
	"options.allowCursorChanges.tooltip": "Gör det möjligt för muspekaren att ändra form när den förs över specifika element i användargränssnittet.",
	"options.allowFriendRequests": "Tillåt förfrågningar",
	"options.allowFriendRequests.tooltip": "Tillåt andra spelare att skicka vänförfrågningar till dig",
	...
	"options.biomeBlendRadius.13": "13 × 13 (skrytmåns)",
	"options.biomeBlendRadius.15": "15 × 15 (maximal)",
	"options.biomeBlendRadius.3": "3 × 3 (snabb)",
	"options.biomeBlendRadius.5": "5 × 5 (normal)",
	"options.biomeBlendRadius.7": "7 × 7 (hög)",
	"options.biomeBlendRadius.9": "9 × 9 (mycket hög)",
	"options.blocks": "%s block",
	"options.chat": "Chattinställningar...",
	"options.chat.color": "Färger",
	"options.chat.delay": "Chattfördröjning: %s s",
	"options.chat.delay_none": "Chattfördröjning: Ingen",
	"options.chat.drafts": "Spara oskickad chatt",
	"options.chat.drafts.tooltip": "Oskickade meddelanden sparas och kan skickas nästa gång chatten öppnas.",
	...
	"options.chunkFade": "Tid för datablockstoning",
	"options.chunkFade.none": "Datablockstoning: Ingen",
	"options.chunkFade.seconds": "Datablockstoning: %s s",
	"options.chunkFade.tooltip": "Hur lång tid (i sekunder) datablock ska tonas fram när de renderas för första gången – om de ska tonas fram alls.",
	...
	"options.cutoutLeaves": "Genomsynliga löv",
	"options.cutoutLeaves.tooltip": "Gör det möjligt att se igenom hålen i lövblock. Prestandan förbättras när detta inaktiveras.",
	...
	"options.exclusiveFullscreen": "Exklusiv helskärm",
	"options.exclusiveFullscreen.warningTooltip": "Detta alternativ kanske förhindrar vissa inmatningsmetoder från att fungera.",
	"options.font": "Typsnittsinställningar...",
	"options.font.title": "Typsnittsinställningar",
	"options.forceUnicodeFont": "Använd Unicode-typsnitt",
	"options.fov": "Synfält",
	...
	"options.friendsList": "Vänlista",
	"options.friendsList.confirm.message": "Använd vänlistan för att skicka och ta emot vänförfrågningar.\n\nHantera inställningarna för onlinesäkerhet med ditt %s.",
	"options.friendsList.confirm.message.link": "Microsoft-konto",
	"options.friendsList.confirm.title": "Vänlista",
	"options.friendsList.confirm.turnOff": "Inaktivera",
	"options.friendsList.confirm.turnOn": "Aktivera",
	"options.fullscreen": "Helskärm",
	"options.fullscreen.current": "Nuvarande",
	"options.fullscreen.entry": "%s × %s, %s Hz (%s bitar)",
	...
	"options.graphics.custom": "Anpassad",
	...
	"options.graphics.preset": "Förinställning",
	"options.graphics.preset.tooltip": "Ändrar inställningarna i \"Kvalitet och prestanda\" till rimliga standardvärden för att uppnå önskad kvalitet.",
	...
	"options.graphicsApi.opengl": "Föredra OpenGL",
	"options.graphicsApi.restart": "Du måste starta om spelet för att byta grafik-API.",
	"options.graphicsApi.tooltip": "Vilket grafik-API som ska användas för rendering. Lämna inställningen som standard om du inte har något särskilt skäl att ändra den!",
	"options.graphicsApi.tooltip.vulkan": "Experimentellt. Kan försämra prestandan eller orsaka instabilitet på vissa system.",
	"options.graphicsApi.vulkan": "Föredra Vulkan (experimentellt)",
	"options.guiScale": "Gränssnittsskala",
	"options.guiScale.auto": "Automatisk",
	"options.hidden": "Dold",
	"options.hideLightningFlashes": "Dölj sken från blixtar",
	"options.hideLightningFlashes.tooltip": "Hindrar blixtnedslag och andra miljöeffekter från att lysa upp himlen. Själva ljuskällan kommer fortfarande att vara synlig.",
	...
	"options.hideSplashTexts": "Dölj splash-text",
	"options.hideSplashTexts.tooltip": "Döljer den gula splash-texten i huvudmenyn.",
	"options.improvedTransparency": "Bättre genomskinlighet",
	"options.improvedTransparency.tooltip": "En experimentell inställning som använder skärmshaders för att rita väder, moln och partiklar bakom genomskinliga block och vatten.\nDetta kommer att påverka grafikkortets prestanda.",
	"options.inGameNotification": "Notiser i spelet",
	"options.inGameNotification.tooltip": "Visa vännotiser i spelet",
	"options.inactivityFpsLimit": "Sänk bildfrek.",
	"options.inactivityFpsLimit.afk": "Vid inaktivitet",
	"options.inactivityFpsLimit.afk.tooltip": "Begränsar bildfrekvensen till 30 bilder per sekund när spelet inte mottar någon inmatning på över en minut. Bildfrekvensen begränsas efter ytterligare 9 minuter till 10 bilder per sekund.",
	"options.inactivityFpsLimit.minimized": "Vid minimering",
	"options.inactivityFpsLimit.minimized.tooltip": "Begränsar bildfrekvensen endast när spelfönstret är minimerat.",
	"options.invertMouse": "Invertera musriktning",
	"options.invertMouseX": "Invertera musen vågrätt",
	"options.invertMouseY": "Invertera musen lodrätt",
	"options.japaneseGlyphVariants": "Japanska skrivtecken",
	"options.japaneseGlyphVariants.tooltip": "Använder japanska varianter av CJK-tecken i standardtypsnittet.",
	"options.key.hold": "Håll ned",
	"options.key.toggle": "Slå på/av",
	"options.language": "Språk...",
	"options.language.narration": "Ändra språk",
	"options.language.title": "Språk",
	"options.language.tooltip": "Ändra språk",
	"options.languageAccuracyWarning": "(Översättningarna är möjligtvis inte 100 %% korrekta)",
	...
	"options.maxAnisotropy.tooltip": "Varje nivå förbättrar jämnheten på texturer, men påverkar prestanda och användningen av videominne avsevärt. Kräver anisotropisk texturfiltrering.",
	...
	"options.multiplayer.title": "Flerspelaralternativ...",
	"options.multiplier": "%s×",
	"options.musicToast": "Musikinfo",
	"options.musicToast.never": "Aldrig",
	"options.musicToast.never.tooltip": "Inga musikaviseringar visas.",
	"options.musicToast.pauseMenu": "Pausmeny",
	"options.musicToast.pauseMenu.tooltip": "En musikavisering visas hela tiden i pausmenyn när musik spelas.",
	"options.musicToast.pauseMenuAndToast": "Pausmeny/popup",
	"options.musicToast.pauseMenuAndToast.tooltip": "Visar en avisering när musik börjar spelas. Samma avisering visas hela tiden i pausmenyn när musik spelas.",
	"options.music_frequency": "Musikuppspelning",
	"options.music_frequency.constant": "Hela tiden",
	"options.music_frequency.default": "Standard",
	"options.music_frequency.frequent": "Ofta",
	"options.music_frequency.tooltip": "Ändrar hur ofta musik spelas i en spelvärld.",
	...
	"options.needsRestart": "Kräver en omstart av spelet för att träda i kraft.",
	...
	"options.online.friends.header": "Vänlista",
	"options.online.realms.header": "Realms",
	"options.online.servers.header": "Servrar",
	"options.online.title": "Alternativ för flerspelarläge",
	"options.online.xboxSettings": "Xbox-inställningar...",
	...
	"options.realmsNotifications.button": "Nyheter och inbjudningar",
	"options.realmsNotifications.tooltip": "Hämtar nyheter och inbjudningar för Realms på huvudmenyn och visar respektive ikon på Realms-knappen.",
	"options.reducedDebugInfo": "Kort felsökningsinfo",
	"options.renderClouds": "Moln",
	"options.renderCloudsDistance": "Molnavstånd",
	"options.renderDistance": "Synligt avstånd",
	"options.resourcepack": "Resurspaket...",
	"options.restartRequired": "Vissa av dina valda ändringar kräver en omstart av spelet för att tillämpas.",
	"options.rotateWithMinecart": "Rotera vy med gruvvagn",
	"options.rotateWithMinecart.tooltip": "Huruvida spelarens vy ska rotera tillsammans med gruvvagnen. Endast tillgängligt i världar där den experimentella inställningen \"Gruvvagnsförbättringar\" är aktiverad.",
	...
	"options.sharePresence": "Närvaro",
	"options.sharePresence.all": "All",
	"options.sharePresence.all.tooltip": "Närvaro delas med dina vänner. Visas som uppkopplad och delar vad du gör.",
	"options.sharePresence.limited": "Begränsad",
	"options.sharePresence.limited.tooltip": "Delar begränsad närvaro. Visas som uppkopplad, men delar inte vad du gör. Du kan fortfarande bjuda in vänner till ditt spel.",
	"options.sharePresence.none": "Ingen",
	"options.sharePresence.none.tooltip": "Delar ingen närvaro. Visas som frånkopplad.",
	"options.showNowPlayingToast": "Visa musikavisering",
	"options.showNowPlayingToast.tooltip": "Visar en avisering när en låt börjar spelas. Samma avisering visas hela tiden i spelets pausmeny medan låten spelas.",
	"options.showSubtitles": "Undertexter",
	"options.showSubtitles.tooltip": "Aktiverar undertexter för ljud i spelet.",
	...
	"options.sprintWindow": "Period för att springa",
	"options.sprintWindow.tooltip": "Tidsperiod i tickningar då dubbeltryck på tangenten för att gå framåt får dig att börja springa.",
	...
	"options.telemetry.disabled": "Telemetridata är inaktiverat.",
	"options.telemetry.state.all": "Allting",
	"options.telemetry.state.minimal": "Minimal",
	"options.telemetry.state.none": "Ingen",
	"options.textureFiltering": "Texturfiltrering",
	"options.textureFiltering.anisotropic": "Anisotropisk",
	"options.textureFiltering.anisotropic.tooltip": "En hårdvarubaserad filtreringsmetod, men påverkar prestanda och användningen av videominne avsevärt. Stöds kanske inte på all hårdvara.",
	"options.textureFiltering.none": "Ingen",
	"options.textureFiltering.none.tooltip": "Texturer visas utan någon filtrering. Block kan se suddiga ut när de ses snett från sidan.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nEn shaderbaserad filtreringsmetod som förbättrar texturkvaliteten med måttlig prestandapåverkan.",
	"options.title": "Alternativ",
	"options.touchscreen": "Pekskärmsläge",
	"options.value": "%s",
	"options.video": "Grafikinställningar...",
	"options.video.display.header": "Skärm",
	"options.video.interface.header": "Gränssnitt",
	"options.video.preferences.header": "Preferenser",
	"options.video.quality.header": "Kvalitet och prestanda",
	"options.videoTitle": "Grafikinställningar",
	"options.viewBobbing": "Vygungning",
	"options.vignette": "Visa vinjett",
	"options.vignette.tooltip": "Detta är en diskret textur som läggs ovanpå spelskärmen för att minska ljusstyrkan längs skärmens kanter och varna för världsgränsen.",
	"options.visible": "Visas",
	"options.vsync": "VSync",
	"options.weatherRadius": "Vädereffektsradie",
	"options.weatherRadius.tooltip": "Radien för det område där regn- och snöeffekter syns. Mycket låg prestandapåverkan.",
	"options.worldOptions.button": "Världsalternativ...",
	"options.worldOptions.title": "Världsalternativ",
	"outOfMemory.message": "Minecraft har fått slut på minne.\n\nDetta kan bero på en bugg i spelet eller att Java Virtual Machine inte har allokerats tillräckligt mycket minne.\n\nSpelet avslutades för att förhindra att dina spelfiler skadas. Vi har försökt frigöra tillräckligt mycket minne för att du ska kunna gå tillbaka till huvudmenyn och fortsätta spela, men detta kanske inte fungerade.\n\nVar god starta om spelet om du ser detta meddelande igen.",
	...
	"pack.dropRejected.message": "Följande poster var inte giltiga paket och kopierades inte:\n %s",
	"pack.dropRejected.title": "Poster som inte är paket",
	...
	"pack.incompatible.confirm.unknown": "Detta paket är trasigt eller gjordes för en okänd version av Minecraft och kommer kanske inte att fungera korrekt.",
	...
	"pack.incompatible.unknown": "(Trasigt eller inkompatibelt)",
	...
	"painting.minecraft.backyard.title": "Bakgård",
	...
	"painting.minecraft.cavebird.title": "Grottfågel",
	"painting.minecraft.changing.author": "Kristoffer Zetterstrand",
	"painting.minecraft.changing.title": "Förändring",
	...
	"painting.minecraft.lowmist.title": "Låga dimmoln",
	...
	"painting.minecraft.orb.title": "Ljusklot",
	"painting.minecraft.owlemons.author": "Kristoffer Zetterstrand",
	"painting.minecraft.owlemons.title": "Uggla med citroner",
	...
	"particle.invalidOptions": "Kan inte tolka partikelalternativ: %s",
	...
	"realms.configuration.region.japan_east": "Japan, östra",
	"realms.configuration.region.japan_west": "Japan, västra",
	...
	"realms.configuration.region.uae_north": "Förenade arabemiraten",
	"realms.configuration.region.uk_south": "Södra England",
	"realms.configuration.region.west_central_us": "Utah, USA",
	"realms.configuration.region.west_europe": "Nederländerna",
	"realms.configuration.region.west_us": "Kalifornien, USA",
	"realms.configuration.region.west_us_2": "Washington, USA",
	"realms.configuration.region_preference.automatic_owner": "Automatiskt (Realmens ägare)",
	"realms.configuration.region_preference.automatic_player": "Automatiskt (första anslutna spelaren)",
	...
	"recover_world.bug_tracker": "Rapportera bugg",
	"recover_world.button": "Försök återskapa",
	"recover_world.done.failed": "Misslyckades att återskapa från ett tidigare tillstånd.",
	"recover_world.done.success": "Världen återskapades!",
	"recover_world.done.title": "Återskapande slutfördes",
	"recover_world.issue.missing_file": "fil saknas",
	"recover_world.issue.none": "inga fel",
	"recover_world.message": "Följande fel uppstod när världsmappen \"%s\" lästes in.\nDet kan vara möjligt att återskapa världen från ett äldre tillstånd eller så kan du rapportera detta fel som en bugg.",
	"recover_world.no_fallback": "Inga tillgängliga tillstånd att återskapa från",
	"recover_world.restore": "Försök återställa",
	"recover_world.restoring": "Försöker återställa värld...",
	"recover_world.state_entry": "Tillstånd från %s: ",
	"recover_world.state_entry.unknown": "okänt",
	"recover_world.title": "Misslyckades att läsa in världen",
	"recover_world.warning": "Misslyckades att läsa in världsbeskrivning",
	"resourcePack.broken_assets": "HITTADE TRASIGA TILLGÅNGAR",
	"resourcePack.high_contrast.name": "Hög kontrast",
	"resourcePack.load_fail": "Misslyckades att uppdatera resurspaket",
	"resourcePack.programmer_art.name": "Programmeringskonst",
	"resourcePack.runtime_failure": "Fel upptäcktes i resurspaketet",
	...
	"restrictions_screen.button": "Begränsningar...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Du kan ta emot meddelanden från spelare",
	"restrictions_screen.permission.receive_player_messages.denied": "Du kan inte ta emot meddelanden från spelare",
	"restrictions_screen.permission.receive_system_messages.allowed": "Du kan ta emot systemmeddelanden från servern",
	"restrictions_screen.permission.receive_system_messages.denied": "Du kan inte ta emot systemmeddelanden från servern",
	"restrictions_screen.permission.send_commands.allowed": "Du kan skicka kommandon",
	"restrictions_screen.permission.send_commands.denied": "Du kan inte skicka kommandon",
	"restrictions_screen.permission.send_messages.allowed": "Du kan skicka chattmeddelanden",
	"restrictions_screen.permission.send_messages.denied": "Du kan inte skicka chattmeddelanden",
	"restrictions_screen.title": "Begränsningar",
	...
	"selectWorld.allowCommands.new": "Tillåt kommandon",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Skapa en säkerhetskopia innan denna värld uppdateras?",
	...
	"selectWorld.backupWarning.file_fixing_required": "Den här världen måste uppgraderas innan du kan spela på den. Vi rekommenderar starkt att du skapar en säkerhetskopia innan du fortsätter ifall världen är skadad.",
	...
	"selectWorld.commands": "kommandon",
	...
	"selectWorld.incompatible.description": "Den här världen kan inte öppnas i den här versionen.\nVärlden spelades senast i version %s.",
	"selectWorld.incompatible.info": "Inkompatibel version: %s",
	"selectWorld.incompatible.title": "Inkompatibel version",
	"selectWorld.incompatible.tooltip": "Den här världen kan inte öppnas eftersom den skapades i en inkompatibel version.",
	...
	"selectWorld.loading_list": "Läser in världslistan",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Den här världen måste uppgraderas till den senaste versionen innan du kan redigera den på grund av underliggande förändringar i världsformatet.",
	"selectWorld.requiresFileFixingTooltip.play": "Den här världen måste uppgraderas till den senaste versionen innan du kan spela på den på grund av underliggande förändringar i världsformatet.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Den här världen måste uppgraderas till den senaste versionen innan du kan återskapa den på grund av underliggande förändringar i världsformatet.",
	"selectWorld.resource_load": "Förbereder resurser...",
	...
	"selectWorld.tooltip.fromNewerVersion2": "och att läsa in den här världen kan orsaka problem!",
	...
	"selectWorld.upgrade_and_play": "Uppgradera och spela",
	...
	"selectWorld.waitingForBackup.message": "Detta kan ta en stund beroende på världens storlek. Stäng varken av spelet eller din enhet.",
	"selectWorld.waitingForBackup.title": "Skapar säkerhetskopia",
	...
	"selectWorld.warning.lowDiskSpace.description": "Det finns inte mycket utrymme kvar på din enhet.\nOm diskutrymmet tar slut medan du spelar kan det leda till att din värld skadas.",
	"selectWorld.warning.lowDiskSpace.title": "Varning! För lite diskutrymme!",
	"selectWorld.world": "Värld",
	"selectWorld.world_gen_settings_access": "Kunde inte läsa eller komma åt inställningsfilen för världsgenerering! %s",
	"selecteWorld.backupRequiredTooltip": "En säkerhetskopia måste skapas innan världen läses in",
	...
	"slot.only_single_allowed": "Endast en plats är tillåten, \"%s\" hittades",
	"slot.unknown": "\"%s\" är en okänd plats",
	"snbt.parser.empty_key": "Nyckeln kan inte vara tom",
	"snbt.parser.expected_binary_numeral": "Ett binärt tal förväntades",
	"snbt.parser.expected_decimal_numeral": "Ett decimaltal förväntades",
	"snbt.parser.expected_float_type": "Ett flyttal förväntades",
	"snbt.parser.expected_hex_escape": "En teckensekvens med längden %s förväntades",
	"snbt.parser.expected_hex_numeral": "Ett hexadecimalt tal förväntades",
	"snbt.parser.expected_integer_type": "Ett heltal förväntades",
	"snbt.parser.expected_non_negative_number": "Ett icke-negativt tal förväntades",
	"snbt.parser.expected_number_or_boolean": "Ett tal eller booleskt värde förväntades",
	"snbt.parser.expected_string_uuid": "En sträng som motsvarar ett giltigt UUID förväntades",
	"snbt.parser.expected_unquoted_string": "En giltig sträng utan citationstecken förväntades",
	"snbt.parser.infinity_not_allowed": "Endast ändliga tal är tillåtna",
	"snbt.parser.invalid_array_element_type": "Ogiltig typ av arrayelement",
	"snbt.parser.invalid_character_name": "Ogiltigt namn på Unicode-tecken",
	"snbt.parser.invalid_codepoint": "%s är ett ogiltigt värde för Unicode-tecken",
	"snbt.parser.invalid_string_contents": "Ogiltigt stränginnehåll",
	"snbt.parser.invalid_unquoted_start": "Strängar utan citationstecken kan inte börja med siffrorna 0–9, + eller -",
	"snbt.parser.leading_zero_not_allowed": "Decimaltal kan inte börja med 0",
	"snbt.parser.no_such_operation": "Ingen sådan åtgärd hittades: %s",
	"snbt.parser.number_parse_failure": "Misslyckades att tolka talet: %s",
	"snbt.parser.undescore_not_allowed": "Tal får inte börja eller sluta med understreck",
	...
	"soundCategory.ui": "Gränssnitt",
	"soundCategory.voice": "Uppläsare/röst",
	...
	"stat.minecraft.happy_ghast_one_cm": "Distans med glad ghast",
	...
	"stat.minecraft.nautilus_one_cm": "Distans med pärlbåt",
	...
	"stat_type.minecraft.killed": "%[2]s har dödats %[1]s gånger",
	"stat_type.minecraft.killed.none": "Du har aldrig dödat %s",
	"stat_type.minecraft.killed_by": "%s har dödat dig %s gånger",
	...
	"subtitles.block.candle.extinguish": "Stearinljus slocknar",
	...
	"subtitles.block.copper_bulb.turn_off": "Kopparlampa inaktiveras",
	"subtitles.block.copper_bulb.turn_on": "Kopparlampa aktiveras",
	"subtitles.block.copper_chest.close": "Kista stängs",
	"subtitles.block.copper_chest.open": "Kista öppnas",
	"subtitles.block.copper_trapdoor.close": "Fallucka stängs",
	"subtitles.block.copper_trapdoor.open": "Fallucka öppnas",
	"subtitles.block.crafter.craft": "Tillverkare tillverkar",
	"subtitles.block.crafter.fail": "Tillverkare misslyckas",
	"subtitles.block.creaking_heart.hurt": "Knarrhjärta knorrar",
	"subtitles.block.creaking_heart.idle": "Kusligt ljud",
	"subtitles.block.creaking_heart.spawn": "Knarrhjärta vaknar",
	"subtitles.block.deadbush.idle": "Död buske knastrar",
	"subtitles.block.decorated_pot.insert": "Dekorativ kruka fylls",
	"subtitles.block.decorated_pot.insert_fail": "Dekorativ kruka gungar",
	"subtitles.block.decorated_pot.shatter": "Keramikkruka krossas",
	"subtitles.block.dispenser.dispense": "Automat skjuter",
	"subtitles.block.dispenser.fail": "Automat skjuter inte",
	"subtitles.block.door.toggle": "Dörr gnisslar",
	"subtitles.block.dried_ghast.ambient": "Någonting susar",
	"subtitles.block.dried_ghast.ambient_water": "Uttorkad ghast återfuktas",
	"subtitles.block.dried_ghast.place_in_water": "Uttorkad ghast läggs i blöt",
	"subtitles.block.dried_ghast.transition": "Uttorkad ghast mår bättre",
	"subtitles.block.dry_grass.ambient": "Vind susar",
	...
	"subtitles.block.eyeblossom.close": "Ögonblomma stängs",
	"subtitles.block.eyeblossom.idle": "Ögonblomma viskar",
	"subtitles.block.eyeblossom.open": "Ögonblomma öppnas",
	...
	"subtitles.block.firefly_bush.idle": "Eldflugor surrar",
	...
	"subtitles.block.generic.fall": "Någonting landar på ett block",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Skylt gungar",
	...
	"subtitles.block.pale_hanging_moss.idle": "Kusligt ljud",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Svavelkälla får utbrott",
	"subtitles.block.potent_sulfur.noxious_gas": "Giftiga ångor dyker upp",
	...
	"subtitles.block.respawn_anchor.ambient": "Återuppståndelseankare susar",
	...
	"subtitles.block.sand.idle": "Vind virvlar upp sand",
	"subtitles.block.sand.wind": "Vind susar",
	...
	"subtitles.block.sculk_sensor.clicking": "Sculksensor klickar",
	...
	"subtitles.block.shelf.activate": "Hylla aktiveras",
	"subtitles.block.shelf.deactivate": "Hylla inaktiveras",
	"subtitles.block.shelf.multi_swap": "Föremål byts ut",
	"subtitles.block.shelf.place_item": "Föremål placeras",
	"subtitles.block.shelf.single_swap": "Föremål byts ut",
	"subtitles.block.shelf.take_item": "Föremål tas",
	...
	"subtitles.block.sponge.absorb": "Svamp suger upp",
	"subtitles.block.sweet_berry_bush.pick_berries": "Bär plockas",
	"subtitles.block.trapdoor.close": "Fallucka stängs",
	"subtitles.block.trapdoor.open": "Fallucka öppnas",
	"subtitles.block.trapdoor.toggle": "Fallucka knarrar",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Oroväckande föremål förbereds",
	"subtitles.block.trial_spawner.ambient": "Utmaningsskapare knastrar",
	"subtitles.block.trial_spawner.ambient_charged": "Oroväckande knastrande",
	"subtitles.block.trial_spawner.ambient_ominous": "Oroväckande knastrande",
	"subtitles.block.trial_spawner.charge_activate": "Föraning lägger sig över utmaningsskapare",
	"subtitles.block.trial_spawner.close_shutter": "Utmaningsskapare stängs",
	"subtitles.block.trial_spawner.detect_player": "Utmaningsskapare laddar upp",
	"subtitles.block.trial_spawner.eject_item": "Utmaningsskapare skjuter ut föremål",
	"subtitles.block.trial_spawner.ominous_activate": "Föraning lägger sig över utmaningsskapare",
	"subtitles.block.trial_spawner.open_shutter": "Utmaningsskapare öppnas",
	"subtitles.block.trial_spawner.spawn_item": "Oroväckande föremål släpps",
	"subtitles.block.trial_spawner.spawn_item_begin": "Oroväckande föremål dyker upp",
	"subtitles.block.trial_spawner.spawn_mob": "Utmaningsskapare skapar varelse",
	...
	"subtitles.block.vault.activate": "Kassaskåp tänds",
	"subtitles.block.vault.ambient": "Kassaskåp knastrar",
	"subtitles.block.vault.close_shutter": "Kassaskåp stängs",
	"subtitles.block.vault.deactivate": "Kassaskåp slocknar",
	"subtitles.block.vault.eject_item": "Kassaskåp skjuter ut föremål",
	"subtitles.block.vault.insert_item": "Kassaskåp låses upp",
	"subtitles.block.vault.insert_item_fail": "Kassaskåp nekar föremål",
	"subtitles.block.vault.open_shutter": "Kassaskåp öppnas",
	"subtitles.block.vault.reject_rewarded_player": "Kassaskåp nekar spelare",
	"subtitles.block.water.ambient": "Vatten rinner",
	"subtitles.block.wet_sponge.dries": "Svamp torkar",
	...
	"subtitles.entity.armadillo.ambient": "Bältdjur grymtar",
	"subtitles.entity.armadillo.brush": "Hornplåt borstas bort",
	"subtitles.entity.armadillo.death": "Bältdjur dör",
	"subtitles.entity.armadillo.eat": "Bältdjur äter",
	"subtitles.entity.armadillo.hurt": "Bältdjur skadas",
	"subtitles.entity.armadillo.hurt_reduced": "Bältdjur skyddar sig",
	"subtitles.entity.armadillo.land": "Bältdjur landar",
	"subtitles.entity.armadillo.peek": "Bältdjur tittar fram",
	"subtitles.entity.armadillo.roll": "Bältdjur rullar ihop sig",
	"subtitles.entity.armadillo.scute_drop": "Bältdjur släpper hornplåt",
	"subtitles.entity.armadillo.unroll_finish": "Bältdjur vecklar ut sig",
	"subtitles.entity.armadillo.unroll_start": "Bältdjur tittar fram",
	...
	"subtitles.entity.baby_cat.ambient": "Kattunge jamar",
	"subtitles.entity.baby_cat.beg_for_food": "Kattunge tigger",
	"subtitles.entity.baby_cat.death": "Kattunge dör",
	"subtitles.entity.baby_cat.eat": "Kattunge äter",
	"subtitles.entity.baby_cat.hiss": "Kattunge fräser",
	"subtitles.entity.baby_cat.hurt": "Kattunge skadas",
	"subtitles.entity.baby_cat.purr": "Kattunge spinner",
	"subtitles.entity.baby_chicken.ambient": "Kyckling piper",
	"subtitles.entity.baby_chicken.death": "Kyckling dör",
	"subtitles.entity.baby_chicken.hurts": "Kyckling skadas",
	"subtitles.entity.baby_horse.ambient": "Föl gnäggar",
	"subtitles.entity.baby_horse.angry": "Föl gnäggar",
	"subtitles.entity.baby_horse.breathe": "Föl andas",
	"subtitles.entity.baby_horse.death": "Föl dör",
	"subtitles.entity.baby_horse.eat": "Föl äter",
	"subtitles.entity.baby_horse.hurt": "Föl skadas",
	"subtitles.entity.baby_horse.land": "Föl landar",
	"subtitles.entity.baby_nautilus.ambient": "Pärlbåtsunge tjattrar",
	"subtitles.entity.baby_nautilus.ambient_land": "Pärlbåtsunge tjattrar",
	"subtitles.entity.baby_nautilus.death": "Pärlbåtsunge dör",
	"subtitles.entity.baby_nautilus.death_land": "Pärlbåtsunge dör",
	"subtitles.entity.baby_nautilus.eat": "Pärlbåtsunge äter",
	"subtitles.entity.baby_nautilus.hurt": "Pärlbåtsunge skadas",
	"subtitles.entity.baby_nautilus.hurt_land": "Pärlbåtsunge skadas",
	"subtitles.entity.baby_nautilus.swim": "Pärlbåtsunge simmar",
	"subtitles.entity.baby_pig.ambient": "Kulting grymtar",
	"subtitles.entity.baby_pig.death": "Kulting dör",
	"subtitles.entity.baby_pig.eat": "Kulting äter",
	"subtitles.entity.baby_pig.hurt": "Kulting skadas",
	"subtitles.entity.baby_wolf.ambient": "Valp gläfser",
	"subtitles.entity.baby_wolf.death": "Valp dör",
	"subtitles.entity.baby_wolf.growl": "Valp morrar",
	"subtitles.entity.baby_wolf.hurt": "Valp skadas",
	"subtitles.entity.baby_wolf.pant": "Valp flåsar",
	"subtitles.entity.baby_wolf.whine": "Valp gnyr",
	...
	"subtitles.entity.bogged.ambient": "Sumpigt skelett skallrar",
	"subtitles.entity.bogged.death": "Sumpigt skelett dör",
	"subtitles.entity.bogged.hurt": "Sumpigt skelett skadas",
	"subtitles.entity.breeze.charge": "Vindväsen laddar upp",
	"subtitles.entity.breeze.death": "Vindväsen dör",
	"subtitles.entity.breeze.deflect": "Vindväsen blockerar",
	"subtitles.entity.breeze.hurt": "Vindväsen skadas",
	"subtitles.entity.breeze.idle_air": "Vindväsen svävar",
	"subtitles.entity.breeze.idle_ground": "Vindväsen susar",
	"subtitles.entity.breeze.inhale": "Vindväsen samlar luft",
	"subtitles.entity.breeze.jump": "Vindväsen hoppar",
	"subtitles.entity.breeze.land": "Vindväsen landar",
	"subtitles.entity.breeze.shoot": "Vindväsen skjuter",
	"subtitles.entity.breeze.slide": "Vindväsen glider",
	"subtitles.entity.breeze.whirl": "Vindväsen virvlar",
	"subtitles.entity.breeze.wind_burst": "Vindattack exploderar",
	...
	"subtitles.entity.camel_husk.ambient": "Uttorkad kamel grumsar",
	"subtitles.entity.camel_husk.dash": "Uttorkad kamel hoppar",
	"subtitles.entity.camel_husk.dash_ready": "Uttorkad kamel återhämtar sig",
	"subtitles.entity.camel_husk.death": "Uttorkad kamel dör",
	"subtitles.entity.camel_husk.eat": "Uttorkad kamel äter",
	"subtitles.entity.camel_husk.hurt": "Uttorkad kamel skadas",
	"subtitles.entity.camel_husk.saddle": "Sadel sätts på",
	"subtitles.entity.camel_husk.sit": "Uttorkad kamel lägger sig ner",
	"subtitles.entity.camel_husk.stand": "Uttorkad kamel reser sig upp",
	...
	"subtitles.entity.copper_golem.death": "Koppargolem dör",
	"subtitles.entity.copper_golem.hurt": "Koppargolem skadas",
	"subtitles.entity.copper_golem.item_drop": "Koppargolem lägger in ett föremål",
	"subtitles.entity.copper_golem.item_no_drop": "Koppargolem kan inte lägga in föremål",
	"subtitles.entity.copper_golem.no_item_get": "Koppargolem tar ut föremål",
	"subtitles.entity.copper_golem.no_item_no_get": "Koppargolem kan inte ta ut föremål",
	"subtitles.entity.copper_golem.spawn": "Koppargolem dyker upp",
	"subtitles.entity.copper_golem.spin": "Koppargolem snurrar på huvudet",
	"subtitles.entity.copper_golem_become_statue": "Koppargolem förstelnas",
	"subtitles.entity.copper_golem_oxidized.death": "Koppargolem dör",
	"subtitles.entity.copper_golem_oxidized.hurt": "Koppargolem skadas",
	"subtitles.entity.copper_golem_oxidized.spin": "Koppargolem snurrar på huvudet",
	"subtitles.entity.copper_golem_weathered.death": "Koppargolem dör",
	"subtitles.entity.copper_golem_weathered.hurt": "Koppargolem skadas",
	"subtitles.entity.copper_golem_weathered.spin": "Koppargolem snurrar på huvudet",
	...
	"subtitles.entity.creaking.activate": "Knarrträd ser spelare",
	"subtitles.entity.creaking.ambient": "Knarrträd knarrar",
	"subtitles.entity.creaking.attack": "Knarrträd attackerar",
	"subtitles.entity.creaking.deactivate": "Knarrträd lugnar ned sig",
	"subtitles.entity.creaking.death": "Knarrträd förmultnar",
	"subtitles.entity.creaking.freeze": "Knarrträd stannar upp",
	"subtitles.entity.creaking.spawn": "Knarrträd uppstår",
	"subtitles.entity.creaking.sway": "Knarrträd träffas",
	"subtitles.entity.creaking.twitch": "Knarrträd rycker till",
	"subtitles.entity.creaking.unfreeze": "Knarrträd rör sig",
	...
	"subtitles.entity.donkey.jump": "Åsna hoppar",
	...
	"subtitles.entity.fish.swim": "Någonting plaskar",
	...
	"subtitles.entity.generic.wind_burst": "Vindattack exploderar",
	...
	"subtitles.entity.ghastling.ambient": "Ghastling kuttrar",
	"subtitles.entity.ghastling.death": "Ghastling dör",
	"subtitles.entity.ghastling.hurt": "Ghastling skadas",
	"subtitles.entity.ghastling.spawn": "Ghastling dyker upp",
	...
	"subtitles.entity.happy_ghast.ambient": "Glad ghast gnyr glatt",
	"subtitles.entity.happy_ghast.death": "Glad ghast dör",
	"subtitles.entity.happy_ghast.equip": "Sele sätts på",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Glad ghast är redo",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Glad ghast stannar",
	"subtitles.entity.happy_ghast.hurt": "Glad ghast skadas",
	"subtitles.entity.happy_ghast.unequip": "Sele tas av",
	...
	"subtitles.entity.minecart.inside": "Gruvvagn skramlar",
	"subtitles.entity.minecart.inside_underwater": "Gruvvagn skramlar under vatten",
	...
	"subtitles.entity.mule.jump": "Mula hoppar",
	"subtitles.entity.nautilus.ambient": "Pärlbåt knäpper",
	"subtitles.entity.nautilus.ambient_land": "Pärlbåt knäpper",
	"subtitles.entity.nautilus.dash": "Pärlbåt kastar sig framåt",
	"subtitles.entity.nautilus.dash_land": "Pärlbåt kastar sig framåt",
	"subtitles.entity.nautilus.dash_ready": "Pärlbåt återhämtar sig",
	"subtitles.entity.nautilus.dash_ready_land": "Pärlbåt återhämtar sig",
	"subtitles.entity.nautilus.death": "Pärlbåt dör",
	"subtitles.entity.nautilus.death_land": "Pärlbåt dör",
	"subtitles.entity.nautilus.eat": "Pärlbåt äter",
	"subtitles.entity.nautilus.hurt": "Pärlbåt skadas",
	"subtitles.entity.nautilus.hurt_land": "Pärlbåt skadas",
	"subtitles.entity.nautilus.swim": "Pärlbåt simmar",
	...
	"subtitles.entity.parched.ambient": "Uttorkat skelett skallrar",
	"subtitles.entity.parched.death": "Uttorkat skelett dör",
	"subtitles.entity.parched.hurt": "Uttorkat skelett skadas",
	...
	"subtitles.entity.parrot.imitate.bogged": "Papegoja skallrar",
	"subtitles.entity.parrot.imitate.breeze": "Papegoja susar",
	"subtitles.entity.parrot.imitate.camel_husk": "Papegoja grumsar",
	"subtitles.entity.parrot.imitate.creaking": "Papegoja knarrar",
	...
	"subtitles.entity.parrot.imitate.parched": "Papegoja skallrar",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Papegoja stönar",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Papegoja bubblar",
	...
	"subtitles.entity.pig.eat": "Gris äter",
	...
	"subtitles.entity.player.teleport": "Spelare teleporterar",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Skeletthäst hoppar",
	...
	"subtitles.entity.sulfur_cube.absorb": "Block absorberas",
	"subtitles.entity.sulfur_cube.bounce": "Svavelkub hoppar",
	"subtitles.entity.sulfur_cube.death": "Svavelkub dör",
	"subtitles.entity.sulfur_cube.eject": "Block skjuts ut",
	"subtitles.entity.sulfur_cube.hit": "Svavelkub träffas",
	"subtitles.entity.sulfur_cube.hurt": "Svavelkub skadas",
	"subtitles.entity.sulfur_cube.push": "Svavelkub knuffas",
	"subtitles.entity.sulfur_cube.squish": "Svavelkub klafsar",
	...
	"subtitles.entity.wind_charge.throw": "Vindladdning flyger",
	"subtitles.entity.wind_charge.wind_burst": "Vindladdning exploderar",
	...
	"subtitles.entity.zombie_horse.angry": "Zombiehäst gnäggar",
	"subtitles.entity.zombie_horse.death": "Zombiehäst dör",
	"subtitles.entity.zombie_horse.eat": "Zombiehäst äter",
	"subtitles.entity.zombie_horse.hurt": "Zombiehäst skadas",
	"subtitles.entity.zombie_nautilus.ambient": "Zombiepärlbåt bubblar",
	"subtitles.entity.zombie_nautilus.ambient_land": "Zombiepärlbåt bubblar",
	"subtitles.entity.zombie_nautilus.dash": "Zombiepärlbåt kastar sig framåt",
	"subtitles.entity.zombie_nautilus.dash_land": "Zombiepärlbåt kastar sig framåt",
	"subtitles.entity.zombie_nautilus.dash_ready": "Zombiepärlbåt återhämtar sig",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Zombiepärlbåt återhämtar sig",
	"subtitles.entity.zombie_nautilus.death": "Zombiepärlbåt dör",
	"subtitles.entity.zombie_nautilus.death_land": "Zombiepärlbåt dör",
	"subtitles.entity.zombie_nautilus.eat": "Zombiepärlbåt äter",
	"subtitles.entity.zombie_nautilus.hurt": "Zombiepärlbåt skadas",
	"subtitles.entity.zombie_nautilus.hurt_land": "Zombiepärlbåt skadas",
	"subtitles.entity.zombie_nautilus.swim": "Zombiepärlbåt simmar",
	...
	"subtitles.event.mob_effect.bad_omen": "Föraning växer sig starkare",
	"subtitles.event.mob_effect.raid_omen": "Räd för sig nära",
	"subtitles.event.mob_effect.trial_omen": "Oroväckande utmaning för sig nära",
	...
	"subtitles.item.armor.equip_copper": "Kopparrustning skramlar",
	...
	"subtitles.item.armor.equip_nautilus": "Pärlbåtsrustning sätts på",
	"subtitles.item.armor.equip_netherite": "Netheritrustning skramlar",
	"subtitles.item.armor.equip_turtle": "Sköldpaddsskal dunkar",
	"subtitles.item.armor.equip_wolf": "Vargrustning sätts på",
	"subtitles.item.armor.unequip_nautilus": "Pärlbåtsrustning tas av",
	"subtitles.item.armor.unequip_wolf": "Vargrustning tas av",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Svavelkub plockas upp",
	...
	"subtitles.item.bundle.insert_fail": "Föremål ryms inte",
	...
	"subtitles.item.elytra.flying": "Någonting svischar",
	...
	"subtitles.item.golden_dandelion.unuse": "Gyllene maskros återupptar varelses åldrande",
	"subtitles.item.golden_dandelion.use": "Gyllene maskros avstannar varelses åldrande",
	...
	"subtitles.item.horse_armor.unequip": "Hästrustning tas av",
	"subtitles.item.ink_sac.use": "Bläcksäck skvätter",
	"subtitles.item.lead.break": "Koppel går av",
	"subtitles.item.lead.tied": "Koppel knyts fast",
	"subtitles.item.lead.untied": "Koppel knyts upp",
	"subtitles.item.llama_carpet.unequip": "Matta tas av",
	"subtitles.item.lodestone_compass.lock": "Magnetitkompass riktas in på magnetit",
	"subtitles.item.mace.smash_air": "Stridsklubba slår",
	"subtitles.item.mace.smash_ground": "Stridsklubba slår ned",
	"subtitles.item.nautilus_saddle_equip": "Sadel sätts på",
	"subtitles.item.nautilus_saddle_underwater_equip": "Sadel sätts på",
	"subtitles.item.nether_wart.plant": "Gröda planteras",
	"subtitles.item.ominous_bottle.dispose": "Flaska förstörs",
	"subtitles.item.saddle.unequip": "Sadel tas av",
	"subtitles.item.shears.shear": "Sax klipper",
	"subtitles.item.shears.snip": "Sax knipsar",
	"subtitles.item.shield.block": "Sköld blockerar",
	"subtitles.item.shovel.flatten": "Spade plattar till",
	"subtitles.item.spear.attack": "Spjut sticker",
	"subtitles.item.spear.hit": "Spjut träffar",
	"subtitles.item.spear.lunge": "Spjut flyger framåt",
	"subtitles.item.spear.use": "Spjut riktas framåt",
	"subtitles.item.spear_wood.attack": "Spjut sticker",
	"subtitles.item.spear_wood.hit": "Spjut träffar",
	"subtitles.item.spear_wood.use": "Spjut riktas framåt",
	...
	"subtitles.item.underwater_saddle.equip": "Sadel sätts på",
	"subtitles.item.wolf_armor.break": "Vargrustning går sönder",
	"subtitles.item.wolf_armor.crack": "Vargrustning spricker",
	"subtitles.item.wolf_armor.damage": "Vargrustning tar skada",
	"subtitles.item.wolf_armor.repair": "Vargrustning repareras",
	"subtitles.particle.soul_escape": "Själ flyr",
	"subtitles.ui.cartography_table.take_result": "Karta ritas",
	"subtitles.ui.hud.bubble_pop": "Luftmätare sjunker",
	"subtitles.ui.loom.take_result": "Vävstol används",
	"subtitles.ui.stonecutter.take_result": "Stenskärare används",
	"subtitles.weather.end_flash": "Endsken mullrar",
	"subtitles.weather.rain": "Regn faller",
	"symlink_warning.message": "Inläsning av världar från mappar med symboliska länkar kan vara riskabelt om du inte vet exakt vad du gör. Besök %s för att lära dig mer.",
	"symlink_warning.message.pack": "Inläsning av paket med symboliska länkar kan vara riskabelt om du inte vet exakt vad du gör. Besök %s för att lära dig mer.",
	"symlink_warning.message.world": "Inläsning av världar från mappar med symboliska länkar kan vara riskabelt om du inte vet exakt vad du gör. Besök %s för att lära dig mer.",
	"symlink_warning.more_info": "Mer information",
	"symlink_warning.title": "Mappen för världar innehåller symboliska länkar",
	"symlink_warning.title.pack": "Tillagda paket innehåller symboliska länkar",
	"symlink_warning.title.world": "Världsmappen innehåller symboliska länkar",
	...
	"telemetry.event.advancement_made.description": "Att förstå orsaken till varför spelare genomför ett visst framsteg kan hjälpa oss att bättre förstå och förbättra spelets utveckling.",
	"telemetry.event.advancement_made.title": "Genomförande av framsteg",
	"telemetry.event.game_load_times.description": "Denna händelse kan hjälpa oss ta reda på vilka förbättringar av uppstartsprestandan som behövs genom att mäta körningstider för uppstartsfaserna.",
	"telemetry.event.game_load_times.title": "Spelets inläsningstid",
	"telemetry.event.graphics_capabilities.description": "Denna händelse ger oss information om funktionerna i grafikenheten du använder för att spela.",
	"telemetry.event.graphics_capabilities.title": "Grafikfunktioner",
	"telemetry.event.optional": "%s (valfri)",
	"telemetry.event.optional.disabled": "%s (valfri) – inaktiverad",
	"telemetry.event.p2p_connection.description": "Denna händelse hjälper oss att förstå tillförlitligheten och prestandan för peer-to-peer-anslutningar mellan spelare. Den registrerar om anslutningen lyckades, vilken typ av kandidat för interaktiv anslutningsetablering (ICE, protokollet vi använder för att upprätta peer-to-peer-anslutningar) som användes och hur lång tid det tog att upprätta anslutningen.",
	"telemetry.event.p2p_connection.title": "Peer-to-peer-anslutning",
	...
	"telemetry.property.advancement_game_time.title": "Speltid (tickningar)",
	"telemetry.property.advancement_id.title": "Framstegs-ID",
	"telemetry.property.backend_failure_message.title": "Meddelande när grafik-API:et inte kan starta",
	"telemetry.property.backend_failure_missing_capabilities.title": "Funktioner som saknas när grafik-API:et inte kan starta",
	"telemetry.property.backend_failure_reason.title": "Anledning till att grafik-API:et inte kan starta",
	"telemetry.property.backend_name.title": "Grafik-API:ets namn",
	...
	"telemetry.property.launcher_name.title": "Programstartarens namn",
	"telemetry.property.load_time_bootstrap_ms.title": "Uppstartstid (millisekunder)",
	"telemetry.property.load_time_loading_overlay_ms.title": "Tid på inläsningsskärmen (millisekunder)",
	"telemetry.property.load_time_pre_window_ms.title": "Tid innan fönstret öppnas (millisekunder)",
	"telemetry.property.load_time_total_time_ms.title": "Total inläsningstid (millisekunder)",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "Status vid misslyckad anslutning",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Anslutningstid för interaktiv anslutningsetablering (ICE, millisekunder)",
	"telemetry.property.p2p_connection_ice_path.title": "Sökväg för interaktiv anslutningsetablering (ICE)",
	"telemetry.property.p2p_connection_local_candidate_type.title": "Lokalkandidatstyp",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Fjärrkandidatstyp",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Anslutningstid för signalering (millisekunder)",
	"telemetry.property.p2p_connection_successful.title": "Lyckad anslutning",
	"telemetry.property.p2p_connection_total_time_ms.title": "Total anslutningstid (millisekunder)",
	"telemetry.property.platform.title": "Plattform",
	"telemetry.property.realms_map_content.title": "Innehåll i Realms-kartor (minispelsnamn)",
	...
	"telemetry_info.opt_in.description": "Jag samtycker till att skicka valfri telemetridata",
	...
	"test.error.block_property_mismatch": "Egenskapen %s förväntades vara %s, men %s hittades",
	"test.error.block_property_missing": "Blockegenskap saknas. Egenskapen %s förväntades vara %s",
	"test.error.entity_property": "Entiteten %s gjorde att testet misslyckades: %s",
	"test.error.entity_property_details": "Entiteten %s gjorde att testet misslyckades: %s. %s förväntades, men %s hittades",
	"test.error.expected_block": "Blocket %s förväntades, men %s hittades",
	"test.error.expected_block_present": "Blocket %s förväntades att finnas",
	"test.error.expected_block_tag": "Ett block i #%s förväntades, men %s hittades",
	"test.error.expected_container_contents": "Behållaren bör endast innehålla föremålen: %s",
	"test.error.expected_container_contents_single": "Behållaren bör endast innehålla föremålet: %s",
	"test.error.expected_empty_container": "Behållaren bör vara tom",
	"test.error.expected_entity": "%s förväntades",
	"test.error.expected_entity_around": "%s förväntades finnas runtomkring %s, %s, %s",
	"test.error.expected_entity_count": "%s entiteter av typen %s förväntades, men %s hittades",
	"test.error.expected_entity_data": "Entitetsdata förväntades vara %s, men %s hittades",
	"test.error.expected_entity_data_predicate": "Entitetsdata matchar inte %s",
	"test.error.expected_entity_effect": "%s förväntades ha effekten %s %s",
	"test.error.expected_entity_having": "Entitetens förråd bör innehålla %s",
	"test.error.expected_entity_holding": "Entiteten bör hålla i %s",
	"test.error.expected_entity_in_test": "%s förväntades finnas i testet",
	"test.error.expected_entity_not_touching": "%s förväntades inte vidröra %s, %s, %s (relativt: %s, %s, %s)",
	"test.error.expected_entity_touching": "%s förväntades vidröra %s, %s, %s (relativt: %s, %s, %s)",
	"test.error.expected_item": "Föremål av typen %s förväntades",
	"test.error.expected_items_count": "%s föremål av typen %s förväntades, men %s hittades",
	"test.error.fail": "Villkoren för att misslyckas har uppnåtts",
	"test.error.invalid_block_type": "Oväntad blocktyp hittades: %s",
	"test.error.missing_block_entity": "Blockentitet saknas",
	"test.error.not_a_block_item": "Angivet block är inte ett blockföremål",
	"test.error.position": "%s vid %s, %s, %s (relativt: %s, %s, %s) på tickning %s",
	"test.error.sequence.condition_already_triggered": "Villkoret har redan utlösts vid %s",
	"test.error.sequence.condition_not_triggered": "Villkoret har inte utlösts",
	"test.error.sequence.invalid_tick": "Genomfördes på ogiltig tickning: %s förväntades",
	"test.error.sequence.minimum_tick": "Genomfördes innan förväntad tickning: förväntades vänta i %s",
	"test.error.sequence.not_completed": "Testets tidsgräns uppnåddes innan sekvensen slutfördes",
	"test.error.set_biome": "Misslyckades att ändra biom under testkörningen",
	"test.error.spawn_failure": "Misslyckades att skapa entiteten %s",
	"test.error.state_not_equal": "Felaktigt tillstånd. %s förväntades, men %s hittades",
	"test.error.structure.failure": "Misslyckades att placera teststrukturen för %s",
	"test.error.tick": "%s på tickningen %s",
	"test.error.ticking_without_structure": "Testet tickade innan strukturen placerades",
	"test.error.timeout.no_result": "Varken genomfördes eller misslyckades inom %s tickningar",
	"test.error.timeout.no_sequences_finished": "Inga sekvenser slutfördes inom %s tickningar",
	"test.error.too_many_entities": "Endast en %s förväntades finnas runtomkring %s, %s, %s men %s hittades",
	"test.error.unexpected_block": "Blocket förväntades inte vara %s",
	"test.error.unexpected_entity": "%s förväntades inte att finnas",
	"test.error.unexpected_item": "Föremål av typen %s förväntades inte",
	"test.error.unknown": "Okänt internt fel: %s",
	"test.error.value_not_equal": "%s förväntades vara %s, men %s hittades",
	"test.error.value_not_in_between": "%s förväntades vara mellan %s och %s, men %s hittades",
	"test.error.wrong_block_entity": "Fel typ av blockentitet: %s",
	"test_block.error.missing": "Teststrukturen saknar block av typen \"%s\"",
	"test_block.error.too_many": "För många block av typen \"%s\"",
	"test_block.invalid_timeout": "Ogiltig tidsgräns (%s) – måste vara ett positivt antal tickningar",
	"test_block.message": "Meddelande:",
	"test_block.mode.accept": "Godkänn",
	"test_block.mode.fail": "Miss.",
	"test_block.mode.log": "Loggning",
	"test_block.mode.start": "Start",
	"test_block.mode_info.accept": "Godkännandeläge – acceptera att ett test (delvis) lyckas",
	"test_block.mode_info.fail": "Misslyckandeläge – gör att testet misslyckas",
	"test_block.mode_info.log": "Loggningsläge – logga ett meddelande",
	"test_block.mode_info.start": "Startläge – utgångspunkten för ett test",
	"test_instance.action.reset": "Återställ och läs in",
	"test_instance.action.run": "Läs in och kör",
	"test_instance.action.save": "Spara struktur",
	"test_instance.description.batch": "Miljö: %s",
	"test_instance.description.failed": "Misslyckades: %s",
	"test_instance.description.function": "Funktion: %s",
	"test_instance.description.invalid_id": "Ogiltigt test-ID",
	"test_instance.description.no_test": "Inget sådant test hittades",
	"test_instance.description.structure": "Struktur: %s",
	"test_instance.description.type": "Typ: %s",
	"test_instance.type.block_based": "Blockbaserat test",
	"test_instance.type.function": "Inbyggt funktionstest",
	"test_instance_block.entities": "Entiteter:",
	"test_instance_block.error.no_test": "Kunde inte köra testinstansen vid %s, %s, %s eftersom den har ett odefinierat test",
	"test_instance_block.error.no_test_structure": "Kunde inte köra testinstansen vid %s, %s, %s eftersom den saknar teststruktur",
	"test_instance_block.error.unable_to_save": "Kunde inte spara teststrukturmall för testinstansen vid %s, %s, %s",
	"test_instance_block.invalid": "[ogiltig]",
	"test_instance_block.reset_success": "Lyckades återställa testet: %s",
	"test_instance_block.rotation": "Rotation:",
	"test_instance_block.size": "Teststrukturens storlek",
	"test_instance_block.starting": "Startar testet %s",
	"test_instance_block.test_id": "Testinstansens ID",
	...
	"title.32bit.deprecation.realms": "Minecraft kommer snart att kräva ett 64-bitarssystem, vilket kommer att hindra dig från att spela eller använda Realms på den här enheten. Du måste manuellt avsluta eventuella prenumerationer på Realms.",
	...
	"title.credits": "Upphovsrätt Mojang AB. Distribuera inte!",
	"title.multiplayer.disabled": "Flerspelarläget är inaktiverat. Kontrollera inställningarna för ditt Microsoft-konto.",
	"title.multiplayer.disabled.banned.name": "Du måste ändra ditt namn innan du kan spela i flerspelarläget",
	...
	"title.multiplayer.online": "Flerspelarläge (uppkopplat)",
	...
	"trim_material.minecraft.resin": "Hartsmaterial",
	"trim_pattern.minecraft.bolt": "Bultförsedda rustningsdetaljer",
	"trim_pattern.minecraft.coast": "Kustutsmyckade rustningsdetaljer",
	"trim_pattern.minecraft.dune": "Ökenartade rustningsdetaljer",
	"trim_pattern.minecraft.eye": "Ögondekorerade rustningsdetaljer",
	"trim_pattern.minecraft.flow": "Virvelformade rustningsdetaljer",
	"trim_pattern.minecraft.host": "Gästgivande rustningsdetaljer",
	"trim_pattern.minecraft.raiser": "Uppfödande rustningsdetaljer",
	"trim_pattern.minecraft.rib": "Revbensrandiga rustningsdetaljer",
	"trim_pattern.minecraft.sentry": "Värnande rustningsdetaljer",
	"trim_pattern.minecraft.shaper": "Formgivande rustningsdetaljer",
	"trim_pattern.minecraft.silence": "Ljudlösa rustningsdetaljer",
	"trim_pattern.minecraft.snout": "Trynformade rustningsdetaljer",
	"trim_pattern.minecraft.spire": "Spiraformade rustningsdetaljer",
	"trim_pattern.minecraft.tide": "Tidvattenvågsprydda rustningsdetaljer",
	"trim_pattern.minecraft.vex": "Osaliga rustningsdetaljer",
	"trim_pattern.minecraft.ward": "Vaktande rustningsdetaljer",
	"trim_pattern.minecraft.wayfinder": "Vägvisande rustningsdetaljer",
	"trim_pattern.minecraft.wild": "Vildsinta rustningsdetaljer",
	...
	"upgradeWorld.aborted.message": "Detta kan inträffa om andra program har åtkomst till världen under uppgraderingen.\nDet kan underlätta att starta om din dator och försöka igen. Överväg att rapportera en bugg om problemet kvarstår.",
	"upgradeWorld.aborted.reportBug": "Rapportera bugg",
	"upgradeWorld.aborted.title": "Misslyckades att uppgradera världen",
	"upgradeWorld.canceled.message": "Din värld förblir som den var förut.",
	"upgradeWorld.canceled.title": "Världsuppgradering avbröts",
	"upgradeWorld.done": "Världsuppgradering slutfördes",
	"upgradeWorld.failed_cleanup.message": "Världen uppgraderades till den nuvarande versionen och finns nu tillgänglig i listan med världar.\nNär gammal data rensades påträffades ett problem och därför har namnet på världens mapp ändrats till %s.",
	"upgradeWorld.failed_cleanup.title": "Världen har uppgraderats",
	"upgradeWorld.info.converted": "Uppgraderade: %s",
	"upgradeWorld.info.file_fix_stage": "Steg: %s/%s",
	"upgradeWorld.info.scanning": "Går igenom filer...",
	"upgradeWorld.info.total": "Totalt: %s",
	"upgradeWorld.joinNow": "Vill du ansluta dig till denna värld nu?",
	"upgradeWorld.progress.percentage": "%s %%",
	"upgradeWorld.progress.type.files": "Flyttar filer",
	"upgradeWorld.progress.type.legacy_structures": "Uppgraderar äldre strukturer",
	"upgradeWorld.progress.type.region": "Uppgraderar regioner",
	"upgradeWorld.symlink.message": "Den valda världen använder symboliska länkar.\nDet nödvändiga stegen för att uppgradera världen till den nuvarande versionen kräver stöd för symboliska länkar. Länkarna måste åtgärdas innan världen kan uppgraderas.",
	"upgradeWorld.symlink.title": "Kan inte uppgradera världen",
	"upgradeWorld.title": "Uppgraderar världsfiler",
}
