// Code generated by tools/gen_lang.go from 26.1/pl_pl.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Ułatwienia dostępu…",
	"accessibility.onboarding.accessibility.button.narration": "Ułatwienia dostępu",
	"accessibility.onboarding.screen.narrator": "Naciśnij enter, aby aktywować narratora",
	"accessibility.onboarding.screen.title": "Witaj w Minecraft!\n\nCzy chcesz aktywować narratora lub przejść do sekcji ułatwień dostępu?",
	...
	"advMode.mode.redstoneTriggered": "Wymaga zasilenia",
	...
	"advMode.notEnabled": "Bloki poleceń nie są włączone",
	"advMode.notEnabled.spawner": "Bloki przyzywające nie są włączone",
	"advMode.previousOutput": "Poprzednie polecenie",
	"advMode.setCommand": "Ustaw polecenie konsoli dla bloku poleceń",
	"advMode.setCommand.disabled": "Polecenie ustawione: %s, ale bloki poleceń są nadal wyłączone",
	...
	"advancements.adventure.blowback.description": "Zabij wichrzyka poprzez odbicie wystrzelonego przez niego wietrznego pocisku.",
	"advancements.adventure.blowback.title": "Kto sieje wiatr…",
	"advancements.adventure.brush_armadillo.description": "Zdobądź tarczki pancernika poprzez użycie na nim pędzla",
	"advancements.adventure.brush_armadillo.title": "Twarda sztuka",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Stwórz dekorowany garniec z 4 odłamków ceramiki",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Ale dzban!",
	"advancements.adventure.crafters_crafting_crafters.description": "Bądź obok wytwarzacza, kiedy ten wytworzy wytwarzacz",
	"advancements.adventure.crafters_crafting_crafters.title": "Wytwórcza wytwórnia wytwarzaczy",
	...
	"advancements.adventure.heart_transplanter.description": "Umieść trzeszczące serce pomiędzy dwoma pionowymi bladodębowymi pniami",
	"advancements.adventure.heart_transplanter.title": "Przeszczep trzeszcza",
	...
	"advancements.adventure.lighten_up.description": "Oskrob siekierą miedzianą lampę, żeby mocniej świeciła",
	"advancements.adventure.lighten_up.title": "Niech się stanie światłość",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Wejdź do komnaty prób",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Edycja Próbna",
	"advancements.adventure.ol_betsy.description": "Strzel z kuszy",
	"advancements.adventure.ol_betsy.title": "Nie strzel byka",
	"advancements.adventure.overoverkill.description": "Zadaj 50 serc obrażeń pojedynczym uderzeniem buzdyganem",
	"advancements.adventure.overoverkill.title": "Przegięcie pały",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Moc książek",
	"advancements.adventure.revaulting.description": "Odblokuj złowieszczy skarbiec używając złowieszczego klucza próby",
	"advancements.adventure.revaulting.title": "Skarbie, wróciłem",
	...
	"advancements.adventure.salvage_sherd.title": "Powrót do przeszłości",
	...
	"advancements.adventure.spear_many_mobs.description": "Uderz pięć mobów pojedynczym atakiem szarży przy użyciu włóczni",
	"advancements.adventure.spear_many_mobs.title": "Szaszłyk godny wojownika",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Nałóż przynajmniej raz zdobienia zbroi: Iglica, Ryjek, Żebra, Nadzorca, Cisza, Dręczyciel, Fala, Włóczykij",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Kowal własnego stylu",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Stwórz przyozdobioną zbroję na stole kowalskim",
	...
	"advancements.adventure.under_lock_and_key.description": "Otwórz skarbiec za pomocą klucza próby",
	"advancements.adventure.under_lock_and_key.title": "Na cztery spusty",
	"advancements.adventure.use_lodestone.description": "Użyj kompasu na magnetycie",
	"advancements.adventure.use_lodestone.title": "On wskaże Ci drogę",
	...
	"advancements.adventure.who_needs_rockets.description": "Użyj wietrznej kuli, żeby wystrzelić się 8 bloków w górę",
	"advancements.adventure.who_needs_rockets.title": "Na co komu fajerwerki?",
	...
	"advancements.husbandry.leash_all_frog_variants.description": "Weź na linę wszystkie rodzaje żab",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Umieść wyschniętego ghasta w wodzie",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Pij wodę, będziesz wielki!",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Zdejmij wilczą zbroję z wilka za pomocą nożyc",
	"advancements.husbandry.remove_wolf_armor.title": "Rach, ciach!",
	"advancements.husbandry.repair_wolf_armor.description": "Napraw uszkodzoną wilczą zbroję za pomocą tarczek pancernika",
	"advancements.husbandry.repair_wolf_armor.title": "Nówka sztuka",
	...
	"advancements.husbandry.silk_touch_nest.description": "Użyj jedwabnego dotyku, by przenieść gniazdo lub ul z 3 pszczołami w środku",
	...
	"advancements.husbandry.uh_oh.description": "Spraw, aby kostka siarki pochłonęła blok TNT",
	"advancements.husbandry.uh_oh.title": "Ale siara",
	...
	"advancements.husbandry.whole_pack.description": "Oswój wszystkie odmiany wilków",
	"advancements.husbandry.whole_pack.title": "Wataha",
	...
	"advancements.story.enchant_item.description": "Zaklnij przedmiot używając stołu do zaklinania",
	...
	"advancements.story.enter_the_nether.description": "Zbuduj, odpal i przejdź przez portal do Netheru",
	...
	"argument.block.tag.disallowed": "Tagi są niedozwolone; tylko bloki są",
	...
	"argument.entity.options.limit.description": "Maksymalna liczba zwracanych bytów",
	...
	"argument.entity.selector.nearestEntity": "Najbliższy byt",
	...
	"argument.float.big": "Wartość float nie może być większa od %s: wykryto %s",
	"argument.float.low": "Wartość float nie może być mniejsza niż %s: wykryto %s",
	"argument.gamemode.invalid": "Nieznany tryb gry %s",
	"argument.hexcolor.invalid": "Nieprawidłowy kod szesnastkowy koloru „%s”",
	...
	"argument.item.tag.disallowed": "Tagi są niedozwolone; tylko przedmioty są",
	...
	"argument.message.too_long": "Wiadomość na czacie była za długa (%s > maksymalna ilość %s znaków)",
	"argument.nbt.array.invalid": "Niewłaściwy typ tablicy „%s”",
	"argument.nbt.array.mixed": "Nie można wstawić %s do %s",
	"argument.nbt.expected.compound": "Oczekiwano tagu złożonego",
	...
	"argument.range.ints": "Dozwolone są tylko liczby całkowite; nie ułamki",
	...
	"argument.resource_or_id.failed_to_parse": "Nie można przeanalizować struktury: „%s”",
	"argument.resource_or_id.invalid": "Błędne ID lub tag",
	"argument.resource_or_id.no_such_element": "Nie można znaleźć elementu „%s” w rejestrze „%s”",
	"argument.resource_selector.not_found": "Brak wyników dla selektora „%s” rodzaju „%s”",
	...
	"argument.style.invalid": "Nieprawidłowy styl: %s",
	...
	"argument.waypoint.invalid": "Wybrany byt nie jest punktem orientacyjnym",
	...
	"arguments.item.component.expected": "Oczekiwano komponentu przedmiotu",
	"arguments.item.component.malformed": "Ten komponent jest nieprawidłowy „%s”: „%s”",
	"arguments.item.component.repeated": "Komponent „%s” się powtarza. Można określić tylko jedną wartość",
	"arguments.item.component.unknown": "Nieznany komponent „%s”",
	"arguments.item.malformed": "Nieprawidłowy przedmiot: „%s”",
	"arguments.item.overstacked": "%s może mieć tylko %s sztuk w stosie",
	"arguments.item.predicate.malformed": "Ten predykat jest nieprawidłowy „%s”: „%s”",
	"arguments.item.predicate.unknown": "Nieznany predykat: %s",
	...
	"attribute.name.air_drag_modifier": "modyfikator oporu powietrza",
	"attribute.name.armor": "zbroi",
	"attribute.name.armor_toughness": "wytrzymałości zbroi",
	"attribute.name.attack_damage": "obrażeń",
	"attribute.name.attack_knockback": "odrzutu ataku",
	"attribute.name.attack_speed": "szybkości ataku",
	"attribute.name.below_name_distance": "Odległość plakietki wynikowej",
	"attribute.name.block_break_speed": "szybkości niszczenia bloków",
	"attribute.name.block_interaction_range": "zasięgu interakcji z blokami",
	"attribute.name.bounciness": "sprężystość",
	"attribute.name.burning_time": "czasu płonięcia",
	"attribute.name.camera_distance": "odległości kamery",
	"attribute.name.entity_interaction_range": "zasięgu interakcji z bytami",
	"attribute.name.explosion_knockback_resistance": "odporności na odrzut eksplozji",
	"attribute.name.fall_damage_multiplier": "mnożnika obrażeń od upadku",
	"attribute.name.flying_speed": "prędkości lotu",
	"attribute.name.follow_range": "zasięgu podążania stworzeń",
	"attribute.name.friction_modifier": "modyfikator tarcia",
	...
	"attribute.name.generic.block_interaction_range": "zasięgu interakcji z blokami",
	"attribute.name.generic.burning_time": "czasu płonięcia",
	"attribute.name.generic.entity_interaction_range": "zasięgu interakcji z bytami",
	"attribute.name.generic.explosion_knockback_resistance": "odporności na odrzut eksplozji",
	"attribute.name.generic.fall_damage_multiplier": "mnożnika obrażeń od upadku",
	"attribute.name.generic.flying_speed": "prędkości lotu",
	"attribute.name.generic.follow_range": "zasięgu podążania stworzeń",
	"attribute.name.generic.gravity": "grawitacji",
	"attribute.name.generic.jump_strength": "siły skoku",
	"attribute.name.generic.knockback_resistance": "odporności na odrzut",
	"attribute.name.generic.luck": "szczęścia",
	"attribute.name.generic.max_absorption": "maksymalnej absorpcji",
	"attribute.name.generic.max_health": "maksymalnego zdrowia",
	"attribute.name.generic.movement_efficiency": "sprawności ruchu",
	"attribute.name.generic.movement_speed": "szybkości",
	"attribute.name.generic.oxygen_bonus": "premii tlenowej",
	"attribute.name.generic.safe_fall_distance": "wysokości bezpiecznego upadku",
	"attribute.name.generic.scale": "skali",
	"attribute.name.generic.step_height": "wysokości kroku",
	"attribute.name.generic.water_movement_efficiency": "sprawności ruchu w wodzie",
	"attribute.name.gravity": "grawitacji",
	"attribute.name.horse.jump_strength": "siły skoku konia",
	"attribute.name.jump_strength": "siły skoku",
	"attribute.name.knockback_resistance": "odporności na odrzut",
	"attribute.name.luck": "szczęścia",
	"attribute.name.max_absorption": "maksymalnej absorpcji",
	"attribute.name.max_health": "maksymalnego zdrowia",
	"attribute.name.mining_efficiency": "wydajności wydobycia",
	"attribute.name.movement_efficiency": "sprawności ruchu",
	"attribute.name.movement_speed": "szybkości",
	"attribute.name.nameplate_distance": "Odległość plakietki imiennej",
	"attribute.name.oxygen_bonus": "premii tlenowej",
	"attribute.name.player.block_break_speed": "szybkości niszczenia bloków",
	"attribute.name.player.block_interaction_range": "zasięgu interakcji z blokami",
	"attribute.name.player.entity_interaction_range": "zasięgu interakcji z bytami",
	"attribute.name.player.mining_efficiency": "wydajności wydobycia",
	"attribute.name.player.sneaking_speed": "prędkości skradania się",
	"attribute.name.player.submerged_mining_speed": "prędkości wydobycia pod wodą",
	"attribute.name.player.sweeping_damage_ratio": "współczynniku obrażeń od szerokich ataków",
	"attribute.name.safe_fall_distance": "wysokości bezpiecznego upadku",
	"attribute.name.scale": "wielkości",
	"attribute.name.sneaking_speed": "prędkości skradania się",
	"attribute.name.spawn_reinforcements": "posiłków zombie",
	"attribute.name.step_height": "wysokości kroku",
	"attribute.name.submerged_mining_speed": "prędkości wydobycia pod wodą",
	"attribute.name.sweeping_damage_ratio": "współczynnika obrażeń zamaszystych ataków",
	"attribute.name.tempt_range": "zasięgu wabienia stworzeń",
	"attribute.name.water_movement_efficiency": "sprawności ruchu w wodzie",
	"attribute.name.waypoint_receive_range": "zasięgu odbioru punktu orientacyjnego",
	"attribute.name.waypoint_transmit_range": "zasięgu nadawania punktu orientacyjnego",
	...
	"biome.minecraft.pale_garden": "Blady ogród",
	...
	"biome.minecraft.sulfur_caves": "Jaskinie siarkowe",
	...
	"block.minecraft.acacia_shelf": "Akacjowa półka",
	...
	"block.minecraft.azalea_leaves": "Azaliowe liście",
	...
	"block.minecraft.bamboo_shelf": "Bambusowa półka",
	...
	"block.minecraft.banner.border.magenta": "Purpurowe obramowanie",
	...
	"block.minecraft.banner.bricks.magenta": "Purpurowe murowane pole",
	...
	"block.minecraft.banner.circle.magenta": "Purpurowy krąg",
	...
	"block.minecraft.banner.creeper.magenta": "Purpurowy wizerunek creepera",
	...
	"block.minecraft.banner.cross.magenta": "Purpurowy skośny krzyż",
	...
	"block.minecraft.banner.curly_border.magenta": "Purpurowe ząbkowane obramowanie",
	...
	"block.minecraft.banner.diagonal_left.magenta": "Purpurowa skośna lewa górna połowa",
	...
	"block.minecraft.banner.diagonal_right.magenta": "Purpurowa skośna prawa górna połowa",
	...
	"block.minecraft.banner.diagonal_up_left.magenta": "Purpurowa skośna lewa dolna połowa",
	...
	"block.minecraft.banner.diagonal_up_right.magenta": "Purpurowa skośna prawa dolna połowa",
	...
	"block.minecraft.banner.flow.black": "Czarny nurt",
	"block.minecraft.banner.flow.blue": "Niebieski nurt",
	"block.minecraft.banner.flow.brown": "Brązowy nurt",
	"block.minecraft.banner.flow.cyan": "Błękitny nurt",
	"block.minecraft.banner.flow.gray": "Szary nurt",
	"block.minecraft.banner.flow.green": "Zielony nurt",
	"block.minecraft.banner.flow.light_blue": "Jasnoniebieski nurt",
	"block.minecraft.banner.flow.light_gray": "Jasnoszary nurt",
	"block.minecraft.banner.flow.lime": "Jasnozielony nurt",
	"block.minecraft.banner.flow.magenta": "Purpurowy nurt",
	"block.minecraft.banner.flow.orange": "Pomarańczowy nurt",
	"block.minecraft.banner.flow.pink": "Różowy nurt",
	"block.minecraft.banner.flow.purple": "Fioletowy nurt",
	"block.minecraft.banner.flow.red": "Czerwony nurt",
	"block.minecraft.banner.flow.white": "Biały nurt",
	"block.minecraft.banner.flow.yellow": "Żółty nurt",
	...
	"block.minecraft.banner.flower.magenta": "Purpurowy wzór kwiatu",
	...
	"block.minecraft.banner.globe.magenta": "Purpurowy sześcian ziemski",
	...
	"block.minecraft.banner.gradient.magenta": "Purpurowy gradient",
	...
	"block.minecraft.banner.gradient_up.magenta": "Purpurowy odwrócony gradient",
	...
	"block.minecraft.banner.guster.black": "Czarny podmuch",
	"block.minecraft.banner.guster.blue": "Niebieski podmuch",
	"block.minecraft.banner.guster.brown": "Brązowy podmuch",
	"block.minecraft.banner.guster.cyan": "Błękitny podmuch",
	"block.minecraft.banner.guster.gray": "Szary podmuch",
	"block.minecraft.banner.guster.green": "Zielony podmuch",
	"block.minecraft.banner.guster.light_blue": "Jasnoniebieski podmuch",
	"block.minecraft.banner.guster.light_gray": "Jasnoszary podmuch",
	"block.minecraft.banner.guster.lime": "Jasnozielony podmuch",
	"block.minecraft.banner.guster.magenta": "Purpurowy podmuch",
	"block.minecraft.banner.guster.orange": "Pomarańczowy podmuch",
	"block.minecraft.banner.guster.pink": "Różowy podmuch",
	"block.minecraft.banner.guster.purple": "Fioletowy podmuch",
	"block.minecraft.banner.guster.red": "Czerwony podmuch",
	"block.minecraft.banner.guster.white": "Biały podmuch",
	"block.minecraft.banner.guster.yellow": "Żółty podmuch",
	...
	"block.minecraft.banner.half_horizontal.magenta": "Purpurowa górna połowa",
	...
	"block.minecraft.banner.half_horizontal_bottom.magenta": "Purpurowa dolna połowa",
	...
	"block.minecraft.banner.half_vertical.magenta": "Purpurowa lewa połowa",
	...
	"block.minecraft.banner.half_vertical_right.magenta": "Purpurowa prawa połowa",
	...
	"block.minecraft.banner.piglin.magenta": "Purpurowy ryjek",
	...
	"block.minecraft.banner.rhombus.magenta": "Purpurowy romb",
	...
	"block.minecraft.banner.skull.magenta": "Purpurowy wzór czaszki",
	...
	"block.minecraft.banner.small_stripes.magenta": "Purpurowe pasy",
	...
	"block.minecraft.banner.square_bottom_left.magenta": "Purpurowy dolny lewy narożnik",
	...
	"block.minecraft.banner.square_bottom_right.magenta": "Purpurowy dolny prawy narożnik",
	...
	"block.minecraft.banner.square_top_left.magenta": "Purpurowy górny lewy narożnik",
	...
	"block.minecraft.banner.square_top_right.magenta": "Purpurowy górny prawy narożnik",
	...
	"block.minecraft.banner.straight_cross.magenta": "Purpurowy krzyż",
	...
	"block.minecraft.banner.stripe_bottom.magenta": "Purpurowa podstawa",
	...
	"block.minecraft.banner.stripe_center.magenta": "Purpurowy słup",
	...
	"block.minecraft.banner.stripe_downleft.magenta": "Purpurowy lewy skos",
	...
	"block.minecraft.banner.stripe_downright.magenta": "Purpurowy prawy skos",
	...
	"block.minecraft.banner.stripe_left.magenta": "Purpurowa lewa flanka",
	...
	"block.minecraft.banner.stripe_middle.magenta": "Purpurowy poziomy pas",
	...
	"block.minecraft.banner.stripe_right.magenta": "Purpurowa prawa flanka",
	...
	"block.minecraft.banner.stripe_top.magenta": "Purpurowa głowica",
	...
	"block.minecraft.banner.triangle_bottom.magenta": "Purpurowa krokiew",
	...
	"block.minecraft.banner.triangle_top.magenta": "Purpurowa odwrócona krokiew",
	...
	"block.minecraft.banner.triangles_bottom.magenta": "Purpurowa podstawa ząbkowana",
	...
	"block.minecraft.banner.triangles_top.magenta": "Purpurowa głowica ząbkowana",
	...
	"block.minecraft.birch_shelf": "Brzozowa półka",
	...
	"block.minecraft.bush": "Krzew",
	"block.minecraft.cactus": "Kaktus",
	"block.minecraft.cactus_flower": "Kwiat kaktusa",
	...
	"block.minecraft.cherry_button": "Wiśniowy przycisk",
	...
	"block.minecraft.cherry_shelf": "Wiśniowa półka",
	...
	"block.minecraft.chiseled_cinnabar": "Rzeźbiony cynober",
	"block.minecraft.chiseled_copper": "Rzeźbiona miedź",
	...
	"block.minecraft.chiseled_resin_bricks": "Rzeźbione żywicowe cegły",
	"block.minecraft.chiseled_sandstone": "Rzeźbiony piaskowiec",
	"block.minecraft.chiseled_stone_bricks": "Rzeźbione kamienne cegły",
	"block.minecraft.chiseled_sulfur": "Rzeźbiona siarka",
	"block.minecraft.chiseled_tuff": "Rzeźbiony tuf",
	"block.minecraft.chiseled_tuff_bricks": "Rzeźbione tufowe cegły",
	...
	"block.minecraft.cinnabar_brick_slab": "Cynobrowa ceglana płyta",
	"block.minecraft.cinnabar_brick_stairs": "Cynobrowe ceglane schody",
	"block.minecraft.cinnabar_brick_wall": "Cynobrowy ceglany murek",
	"block.minecraft.cinnabar_bricks": "Cynobrowe cegły",
	"block.minecraft.cinnabar_slab": "Cynobrowa płyta",
	"block.minecraft.cinnabar_stairs": "Cynobrowe schody",
	"block.minecraft.cinnabar_wall": "Cynobrowy murek",
	"block.minecraft.clay": "Glina",
	"block.minecraft.closed_eyeblossom": "Zamknięta okrotka",
	...
	"block.minecraft.copper_bars": "Miedziane kraty",
	"block.minecraft.copper_block": "Blok miedzi",
	"block.minecraft.copper_bulb": "Miedziana lampa",
	"block.minecraft.copper_chain": "Miedziany łańcuch",
	"block.minecraft.copper_chest": "Miedziana skrzynia",
	"block.minecraft.copper_door": "Miedziane drzwi",
	"block.minecraft.copper_golem_statue": "Posąg miedzianego golema",
	"block.minecraft.copper_grate": "Miedziana krata",
	"block.minecraft.copper_lantern": "Miedziana latarnia",
	"block.minecraft.copper_ore": "Złoże miedzi",
	"block.minecraft.copper_torch": "Miedziowa pochodnia",
	"block.minecraft.copper_trapdoor": "Miedziana klapa",
	"block.minecraft.copper_wall_torch": "Ścienna miedziowa pochodnia",
	...
	"block.minecraft.crafter": "Wytwarzacz",
	"block.minecraft.crafting_table": "Stół rzemieślniczy",
	"block.minecraft.creaking_heart": "Trzeszczące serce",
	...
	"block.minecraft.crimson_shelf": "Szkarłatna półka",
	...
	"block.minecraft.dark_oak_shelf": "Ciemnodębowa półka",
	...
	"block.minecraft.decorated_pot": "Dekorowany garniec",
	...
	"block.minecraft.dried_ghast": "Wyschnięty ghast",
	...
	"block.minecraft.exposed_chiseled_copper": "Zwietrzała rzeźbiona miedź",
	"block.minecraft.exposed_copper": "Zwietrzała miedź",
	"block.minecraft.exposed_copper_bars": "Zwietrzałe miedziane kraty",
	"block.minecraft.exposed_copper_bulb": "Zwietrzała miedziana lampa",
	"block.minecraft.exposed_copper_chain": "Zwietrzały miedziany łańcuch",
	"block.minecraft.exposed_copper_chest": "Zwietrzała miedziana skrzynia",
	"block.minecraft.exposed_copper_door": "Zwietrzałe miedziane drzwi",
	"block.minecraft.exposed_copper_golem_statue": "Zwietrzały posąg miedzianego golema",
	"block.minecraft.exposed_copper_grate": "Zwietrzała miedziana krata",
	"block.minecraft.exposed_copper_lantern": "Zwietrzała miedziana latarnia",
	"block.minecraft.exposed_copper_trapdoor": "Zwietrzała miedziana klapa",
	...
	"block.minecraft.exposed_lightning_rod": "Zwietrzały piorunochron",
	...
	"block.minecraft.firefly_bush": "Krzew świetlików",
	...
	"block.minecraft.golden_dandelion": "Złoty mlecz",
	...
	"block.minecraft.heavy_core": "Ciężki rdzeń",
	...
	"block.minecraft.iron_chain": "Żelazny łańcuch",
	...
	"block.minecraft.jungle_shelf": "Tropikalna półka",
	...
	"block.minecraft.lantern": "Latarnia",
	...
	"block.minecraft.leaf_litter": "Ściółka",
	...
	"block.minecraft.magenta_banner": "Purpurowy sztandar",
	"block.minecraft.magenta_bed": "Purpurowe łóżko",
	"block.minecraft.magenta_candle": "Purpurowa świeca",
	"block.minecraft.magenta_candle_cake": "Ciasto z purpurową świeczką",
	"block.minecraft.magenta_carpet": "Purpurowy dywan",
	"block.minecraft.magenta_concrete": "Purpurowy beton",
	"block.minecraft.magenta_concrete_powder": "Purpurowy cement",
	"block.minecraft.magenta_glazed_terracotta": "Purpurowa glazurowana terakota",
	"block.minecraft.magenta_shulker_box": "Purpurowa shulkerowa skrzynia",
	"block.minecraft.magenta_stained_glass": "Purpurowe szkło",
	"block.minecraft.magenta_stained_glass_pane": "Purpurowa szyba",
	"block.minecraft.magenta_terracotta": "Purpurowa terakota",
	"block.minecraft.magenta_wool": "Purpurowa wełna",
	...
	"block.minecraft.mangrove_shelf": "Namorzynowa półka",
	...
	"block.minecraft.oak_shelf": "Dębowa półka",
	...
	"block.minecraft.open_eyeblossom": "Otwarta okrotka",
	...
	"block.minecraft.oxidized_chiseled_copper": "Utleniona rzeźbiona miedź",
	"block.minecraft.oxidized_copper": "Utleniona miedź",
	"block.minecraft.oxidized_copper_bars": "Utlenione miedziane kraty",
	"block.minecraft.oxidized_copper_bulb": "Utleniona miedziana lampa",
	"block.minecraft.oxidized_copper_chain": "Utleniony miedziany łańcuch",
	"block.minecraft.oxidized_copper_chest": "Utleniona miedziana skrzynia",
	"block.minecraft.oxidized_copper_door": "Utlenione miedziane drzwi",
	"block.minecraft.oxidized_copper_golem_statue": "Utleniony posąg miedzianego golema",
	"block.minecraft.oxidized_copper_grate": "Utleniona miedziana krata",
	"block.minecraft.oxidized_copper_lantern": "Utleniona miedziana latarnia",
	"block.minecraft.oxidized_copper_trapdoor": "Utleniona miedziana klapa",
	...
	"block.minecraft.oxidized_lightning_rod": "Utleniony piorunochron",
	"block.minecraft.packed_ice": "Zbity lód",
	"block.minecraft.packed_mud": "Utwardzone błoto",
	"block.minecraft.pale_hanging_moss": "Zwisający blady mech",
	"block.minecraft.pale_moss_block": "Blok bladego mchu",
	"block.minecraft.pale_moss_carpet": "Warstwa bladego mchu",
	"block.minecraft.pale_oak_button": "Bladodębowy przycisk",
	"block.minecraft.pale_oak_door": "Bladodębowe drzwi",
	"block.minecraft.pale_oak_fence": "Bladodębowy płot",
	"block.minecraft.pale_oak_fence_gate": "Bladodębowa furtka",
	"block.minecraft.pale_oak_hanging_sign": "Bladodębowa podwieszana tabliczka",
	"block.minecraft.pale_oak_leaves": "Bladodębowe liście",
	"block.minecraft.pale_oak_log": "Bladodębowy pień",
	"block.minecraft.pale_oak_planks": "Bladodębowe deski",
	"block.minecraft.pale_oak_pressure_plate": "Bladodębowa płytka naciskowa",
	"block.minecraft.pale_oak_sapling": "Sadzonka bladego dębu",
	"block.minecraft.pale_oak_shelf": "Bladodębowa półka",
	"block.minecraft.pale_oak_sign": "Bladodębowa tabliczka",
	"block.minecraft.pale_oak_slab": "Bladodębowa płyta",
	"block.minecraft.pale_oak_stairs": "Bladodębowe schody",
	"block.minecraft.pale_oak_trapdoor": "Bladodębowa klapa",
	"block.minecraft.pale_oak_wall_hanging_sign": "Bladodębowa ścienna podwieszana tabliczka",
	"block.minecraft.pale_oak_wall_sign": "Bladodębowa ścienna tabliczka",
	"block.minecraft.pale_oak_wood": "Bladodębowe drewno",
	...
	"block.minecraft.polished_cinnabar": "Wypolerowany cynober",
	"block.minecraft.polished_cinnabar_slab": "Wypolerowana cynobrowa płyta",
	"block.minecraft.polished_cinnabar_stairs": "Wypolerowane cynobrowe schody",
	"block.minecraft.polished_cinnabar_wall": "Wypolerowany cynobrowy murek",
	...
	"block.minecraft.polished_sulfur": "Wypolerowana siarka",
	"block.minecraft.polished_sulfur_slab": "Wypolerowana siarkowa płyta",
	"block.minecraft.polished_sulfur_stairs": "Wypolerowane siarkowe schody",
	"block.minecraft.polished_sulfur_wall": "Wypolerowany siarkowy murek",
	"block.minecraft.polished_tuff": "Wypolerowany tuf",
	"block.minecraft.polished_tuff_slab": "Wypolerowana tufowa płyta",
	"block.minecraft.polished_tuff_stairs": "Wypolerowane tufowe schody",
	"block.minecraft.polished_tuff_wall": "Wypolerowany tufowy murek",
	"block.minecraft.poppy": "Mak",
	"block.minecraft.potatoes": "Ziemniaki",
	"block.minecraft.potent_sulfur": "Stężona siarka",
	...
	"block.minecraft.potted_closed_eyeblossom": "Zamknięta okrotka w doniczce",
	...
	"block.minecraft.potted_golden_dandelion": "Złoty mlecz w doniczce",
	...
	"block.minecraft.potted_open_eyeblossom": "Otwarta okrotka w doniczce",
	...
	"block.minecraft.potted_pale_oak_sapling": "Sadzonka bladego dębu w\u00a0doniczce",
	...
	"block.minecraft.resin_brick_slab": "Żywicowa ceglana płyta",
	"block.minecraft.resin_brick_stairs": "Żywicowe ceglane schody",
	"block.minecraft.resin_brick_wall": "Żywicowy ceglany murek",
	"block.minecraft.resin_bricks": "Żywicowe cegły",
	"block.minecraft.resin_clump": "Gruda żywicy",
	...
	"block.minecraft.short_dry_grass": "Niska sucha trawa",
	"block.minecraft.short_grass": "Niska trawa",
	...
	"block.minecraft.soul_lantern": "Latarnia dusz",
	...
	"block.minecraft.spruce_shelf": "Świerkowa półka",
	...
	"block.minecraft.stripped_pale_oak_log": "Ociosany bladodębowy pień",
	"block.minecraft.stripped_pale_oak_wood": "Ociosane bladodębowe drewno",
	...
	"block.minecraft.sulfur": "Siarka",
	"block.minecraft.sulfur_brick_slab": "Siarkowa ceglana płyta",
	"block.minecraft.sulfur_brick_stairs": "Siarkowe ceglane schody",
	"block.minecraft.sulfur_brick_wall": "Siarkowy ceglany murek",
	"block.minecraft.sulfur_bricks": "Siarkowe cegły",
	"block.minecraft.sulfur_slab": "Siarkowa płyta",
	"block.minecraft.sulfur_spike": "Siarkowy kolec",
	"block.minecraft.sulfur_stairs": "Siarkowe schody",
	"block.minecraft.sulfur_wall": "Siarkowy murek",
	...
	"block.minecraft.tall_dry_grass": "Wysoka sucha trawa",
	...
	"block.minecraft.test_block": "Blok testowy",
	"block.minecraft.test_instance_block": "Blok instancji testowej",
	"block.minecraft.tinted_glass": "Przyciemnione szkło",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "Wybuchy TNT są wyłączone",
	...
	"block.minecraft.trial_spawner": "Przyzywacz prób",
	...
	"block.minecraft.tuff_brick_slab": "Tufowa ceglana płyta",
	"block.minecraft.tuff_brick_stairs": "Tufowe ceglane schody",
	"block.minecraft.tuff_brick_wall": "Tufowy ceglany murek",
	"block.minecraft.tuff_bricks": "Tufowe cegły",
	"block.minecraft.tuff_slab": "Tufowa płyta",
	"block.minecraft.tuff_stairs": "Tufowe schody",
	...
	"block.minecraft.vault": "Skarbiec",
	...
	"block.minecraft.warped_shelf": "Spaczona półka",
	...
	"block.minecraft.waxed_chiseled_copper": "Woskowana rzeźbiona miedź",
	"block.minecraft.waxed_copper_bars": "Woskowane miedziane kraty",
	"block.minecraft.waxed_copper_block": "Woskowany blok miedzi",
	"block.minecraft.waxed_copper_bulb": "Woskowana miedziana lampa",
	"block.minecraft.waxed_copper_chain": "Woskowany miedziany łańcuch",
	"block.minecraft.waxed_copper_chest": "Woskowana miedziana skrzynia",
	"block.minecraft.waxed_copper_door": "Woskowane miedziane drzwi",
	"block.minecraft.waxed_copper_golem_statue": "Woskowany posąg miedzianego golema",
	"block.minecraft.waxed_copper_grate": "Woskowana miedziana krata",
	"block.minecraft.waxed_copper_lantern": "Woskowana miedziana latarnia",
	"block.minecraft.waxed_copper_trapdoor": "Woskowana miedziana klapa",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Woskowana zwietrzała rzeźbiona miedź",
	"block.minecraft.waxed_exposed_copper": "Woskowana zwietrzała miedź",
	"block.minecraft.waxed_exposed_copper_bars": "Woskowane zwietrzałe miedziane kraty",
	"block.minecraft.waxed_exposed_copper_bulb": "Woskowana zwietrzała miedziana lampa",
	"block.minecraft.waxed_exposed_copper_chain": "Woskowany zwietrzały miedziany łańcuch",
	"block.minecraft.waxed_exposed_copper_chest": "Woskowana zwietrzała miedziana skrzynia",
	"block.minecraft.waxed_exposed_copper_door": "Woskowane zwietrzałe miedziane drzwi",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Woskowany zwietrzały posąg miedzianego golema",
	"block.minecraft.waxed_exposed_copper_grate": "Woskowana zwietrzała miedziana krata",
	"block.minecraft.waxed_exposed_copper_lantern": "Woskowana zwietrzała miedziana latarnia",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Woskowana zwietrzała miedziana klapa",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Woskowany zwietrzały piorunochron",
	"block.minecraft.waxed_lightning_rod": "Woskowany piorunochron",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Woskowana utleniona rzeźbiona miedź",
	"block.minecraft.waxed_oxidized_copper": "Woskowana utleniona miedź",
	"block.minecraft.waxed_oxidized_copper_bars": "Woskowane utlenione miedziane kraty",
	"block.minecraft.waxed_oxidized_copper_bulb": "Woskowana utleniona miedziana lampa",
	"block.minecraft.waxed_oxidized_copper_chain": "Woskowany utleniony miedziany łańcuch",
	"block.minecraft.waxed_oxidized_copper_chest": "Woskowana utleniona miedziana skrzynia",
	"block.minecraft.waxed_oxidized_copper_door": "Woskowane utlenione miedziane drzwi",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Woskowany utleniony posąg miedzianego golema",
	"block.minecraft.waxed_oxidized_copper_grate": "Woskowana utleniona miedziana krata",
	"block.minecraft.waxed_oxidized_copper_lantern": "Woskowana utleniona miedziana latarnia",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Woskowana utleniona miedziana klapa",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Woskowany utleniony piorunochron",
	"block.minecraft.waxed_weathered_chiseled_copper": "Woskowana zaśniedziała rzeźbiona miedź",
	"block.minecraft.waxed_weathered_copper": "Woskowana zaśniedziała miedź",
	"block.minecraft.waxed_weathered_copper_bars": "Woskowane zaśniedziałe miedziane kraty",
	"block.minecraft.waxed_weathered_copper_bulb": "Woskowana zaśniedziała miedziana lampa",
	"block.minecraft.waxed_weathered_copper_chain": "Woskowany zaśniedziały miedziany łańcuch",
	"block.minecraft.waxed_weathered_copper_chest": "Woskowana zaśniedziała miedziana skrzynia",
	"block.minecraft.waxed_weathered_copper_door": "Woskowane zaśniedziałe miedziane drzwi",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Woskowany zaśniedziały posąg miedzianego golema",
	"block.minecraft.waxed_weathered_copper_grate": "Woskowana zaśniedziała miedziana krata",
	"block.minecraft.waxed_weathered_copper_lantern": "Woskowana zaśniedziała miedziana latarnia",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Woskowana zaśniedziała miedziana klapa",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Woskowany zaśniedziały piorunochron",
	"block.minecraft.weathered_chiseled_copper": "Zaśniedziała rzeźbiona miedź",
	"block.minecraft.weathered_copper": "Zaśniedziała miedź",
	"block.minecraft.weathered_copper_bars": "Zaśniedziałe miedziane kraty",
	"block.minecraft.weathered_copper_bulb": "Zaśniedziała miedziana lampa",
	"block.minecraft.weathered_copper_chain": "Zaśniedziały miedziany łańcuch",
	"block.minecraft.weathered_copper_chest": "Zaśniedziała miedziana skrzynia",
	"block.minecraft.weathered_copper_door": "Zaśniedziałe miedziane drzwi",
	"block.minecraft.weathered_copper_golem_statue": "Zaśniedziały posąg miedzianego golema",
	"block.minecraft.weathered_copper_grate": "Zaśniedziała miedziana krata",
	"block.minecraft.weathered_copper_lantern": "Zaśniedziała miedziana latarnia",
	"block.minecraft.weathered_copper_trapdoor": "Zaśniedziała miedziana klapa",
	...
	"block.minecraft.weathered_lightning_rod": "Zaśniedziały piorunochron",
	...
	"block.minecraft.wildflowers": "Polne kwiaty",
	...
	"book.edit.title": "Okno edycji książki",
	...
	"book.page_button.next": "Następna strona",
	"book.page_button.previous": "Poprzednia strona",
	"book.sign.title": "Okno podpisu książki",
	"book.sign.titlebox": "Tytuł",
	"book.signButton": "Podpisz",
	"book.view.title": "Okno widoku książki",
	"build.spawn_protection": "%s jest pod ochroną odrodzenia",
	"build.tooHigh": "Górny limit wysokości budowania wynosi %s bloków",
	"build.tooLow": "Dolny limit wysokości budowania wynosi %s",
	...
	"chat.disabled.invalid_command_signature": "Polecenie zawierało nieoczekiwane lub brakujące podpisy argumentów poleceń.",
	"chat.disabled.invalid_signature": "Czat miał nieprawidłowy podpis. Spróbuj połączyć się ponownie.",
	...
	"chat.disabled.out_of_order_chat": "Czat otrzymany w nieprawidłowej kolejności. Czy zmienił się u ciebie czas systemowy?",
	...
	"chat.queue.tooltip": "Kliknij, aby wyświetlić następną wiadomość",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "Serwer wysłał nieprawidłową wiadomość.",
	...
	"chat.validation_error": "Błąd weryfikacji czatu",
	"chat_restriction.chat_and_commands_disabled_by_options": "Czat jest ograniczony przez ustawienia klienta.",
	"chat_restriction.chat_disabled_by_options": "Czat gracza jest ograniczony przez ustawienia klienta.",
	"chat_restriction.chat_disabled_by_options.action": "Przejdź do ekranu ustawień czatu",
	"chat_restriction.disabled_by_launcher": "Czat został ograniczony przez launcher",
	"chat_restriction.disabled_by_profile": "Czat jest ograniczony ustawieniami profilu.",
	"chat_restriction.disabled_by_profile.action": "Przejdź do ustawień swojego profilu",
	"chat_screen.commands_not_allowed": "Wysyłanie poleceń jest niedozwolone",
	"chat_screen.message": "Wiadomość do wysłania: %s",
	"chat_screen.messages_not_allowed": "Wysyłanie wiadomości na czacie jest niedozwolone",
	"chat_screen.restricted": "Czat jest ograniczony. Kliknij tę wiadomość, aby uzyskać więcej informacji.",
	"chat_screen.restricted.narration": "Czat jest ograniczony. Przejdź do ekranu Ograniczenia w ustawieniach świata.",
	"chat_screen.title": "Okno czatu",
	"chat_screen.usage": "Wprowadź wiadomość i naciśnij Enter, aby wysłać",
	"chunk.toast.checkLog": "Zobacz dziennik, aby dowiedzieć się więcej",
	"chunk.toast.loadFailure": "Nie udało się załadować chunku na „%s”",
	"chunk.toast.lowDiskSpace": "Mało miejsca na dysku!",
	"chunk.toast.lowDiskSpace.description": "Może nie być możliwe zapisanie świata.",
	"chunk.toast.saveFailure": "Nie udało się zapisać chunku w miejscu „%s”",
	...
	"color.minecraft.magenta": "Purpurowy",
	...
	"command.forkLimit": "Osiągnięto maksymalną liczbę kontekstów (%s)",
	"command.trailing_data": "Znaleziono nadmiarowe dane: %s",
	"command.unknown.argument": "Nieprawidłowy argument dla polecenia",
	"command.unknown.command": "Nieznane lub niekompletne polecenie. Poniżej znajdują się szczegóły o błędzie",
	...
	"commands.attribute.base_value.get.success": "Podstawowa wartość atrybutu %s dla bytu %s to %s",
	"commands.attribute.base_value.reset.success": "Zresetowano wartość podstawową atrybutu %s u bytu %s do domyślnej %s",
	"commands.attribute.base_value.set.success": "Ustawiono wartość podstawową atrybutu %s dla bytu %s na %s",
	...
	"commands.banlist.entry.unknown": "(Nieznany)",
	"commands.banlist.list": "Zablokowanych jest %s graczy:",
	...
	"commands.data.modify.expected_object": "Oczekiwano obiektu: otrzymano %s",
	...
	"commands.datapack.create.already_exists": "Paczka o nazwie „%s” już istnieje",
	"commands.datapack.create.invalid_full_name": "Nieprawidłowa nazwa nowego pakietu „%s”",
	"commands.datapack.create.invalid_name": "Nieprawidłowe znaki w nowej nazwie paczki „%s”",
	"commands.datapack.create.io_failure": "Nie można utworzyć paczki o nazwie „%s”. Sprawdź logi",
	"commands.datapack.create.metadata_encode_failure": "Nie udało się zakodować metadanych dla paczki o nazwie „%s”: %s",
	"commands.datapack.create.success": "Utworzono nową pustą paczkę o nazwie „%s”",
	"commands.datapack.disable.failed": "Paczka „%s” nie jest włączona!",
	"commands.datapack.disable.failed.feature": "Paczka „%s” nie może zostać wyłączona, ponieważ stanowi część aktywnej flagi!",
	"commands.datapack.enable.failed": "Paczka „%s” jest już włączona!",
	...
	"commands.datapack.unknown": "Nieznana paczka danych: „%s”",
	...
	"commands.debug.function.noReturnRun": "Śledzenia nie można używać z poleceniem „return run”",
	...
	"commands.debug.function.traceFailed": "Nie udało się prześledzić funkcji",
	...
	"commands.dialog.clear.multiple": "Wyczyszczono okno dialogowe dla %s graczy",
	"commands.dialog.clear.single": "Wyczyszczono okno dialogowe dla %s",
	"commands.dialog.show.multiple": "Wyświetlono okno dialogowe dla %s graczy",
	"commands.dialog.show.single": "Wyświetlono okno dialogowe dla %s",
	...
	"commands.drop.no_loot_table.block": "Blok %s nie ma tabeli łupów",
	...
	"commands.execute.function.instantiationFailure": "Nie udało się utworzyć instancji funkcji %s: %s",
	...
	"commands.fetchprofile.copy_component": "Kopiuj komponent",
	"commands.fetchprofile.copy_text": "Kopiuj %s",
	"commands.fetchprofile.entity.success": "Rozwiązano profil dla bytu %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Nie udało się zserializować profilu: %s",
	"commands.fetchprofile.give_item": "Daj przedmiot",
	"commands.fetchprofile.id.failure": "Nie udało się rozwiązać profilu dla identyfikatora %s",
	"commands.fetchprofile.id.success": "Rozwiązano profil dla indetyfikatora %s: %s",
	"commands.fetchprofile.name.failure": "Nie udało się rozwiązać profilu dla nazwy %s",
	"commands.fetchprofile.name.success": "Rozwiązano profil dla nazwy %s: %s",
	"commands.fetchprofile.no_profile": "Byt %s nie ma profilu",
	"commands.fetchprofile.summon_mannequin": "Przywołaj manekina",
	"commands.fill.failed": "Nie wypełniono blokami",
	"commands.fill.success": "Liczba pomyślnie wypełnionych bloków: %s",
	...
	"commands.fillbiome.toobig": "Za dużo bloków w zaznaczonym obszarze (maksymalnie %s, konkretnie %s)",
	...
	"commands.function.error.argument_not_compound": "Nieprawidłowy typ argumentu: %s. Oczekiwano Compound",
	"commands.function.error.missing_argument": "Brakujący argument %[2]s do funkcji %[1]s",
	"commands.function.error.missing_arguments": "Brakujące argumenty funkcji %s",
	"commands.function.error.parse": "Podczas tworzenia wystąpienia makra %s polecenie „%s” spowodowało błąd: %s",
	"commands.function.instantiationFailure": "Nie udało się utworzyć instancji funkcji %s: %s",
	"commands.function.result": "Funkcja „%s” zwróciła wartość %s",
	"commands.function.scheduled.multiple": "Działające funkcje %s",
	"commands.function.scheduled.no_functions": "Nie znaleziono żadnej funkcji dla nazwy %s",
	"commands.function.scheduled.single": "Działająca funkcja %s",
	...
	"commands.help.failed": "Nieznane polecenie albo brak uprawnień",
	...
	"commands.kick.owner.failed": "Nie można wyrzucić właściciela serwera w grze LAN",
	"commands.kick.singleplayer.failed": "Nie można wyrzucić gracza w grze jednoosobowej",
	...
	"commands.locate.poi.not_found": "Nie znaleziono punktu zainteresowania typu „%s” w rozsądnej odległości",
	...
	"commands.profile_fetch.copy_component": "Kopiuj komponent",
	"commands.profile_fetch.failed_to_serialize": "Nie udało się zserializować profilu: %s",
	"commands.profile_fetch.give_item": "Daj przedmiot",
	"commands.profile_fetch.id.failure": "Nie udało się rozpoznać profilu dla identyfikatora %s",
	"commands.profile_fetch.id.success": "Rozpoznano profil dla identyfikatora %s: %s",
	"commands.profile_fetch.name.failure": "Nie udało się rozwiązać profilu dla nazwy %s",
	"commands.profile_fetch.name.success": "Rozwiązano profil dla imienia %s: %s",
	...
	"commands.random.error.range_too_large": "Zakres wartości losowej nie może przekraczać 2147483646",
	"commands.random.error.range_too_small": "Zakres wartości losowej musi wynosić co najmniej 2",
	"commands.random.reset.all.success": "Liczba zresetowanych losowych sekwencji: %s",
	"commands.random.reset.success": "Zresetowano losową sekwencję %s",
	"commands.random.roll": "Gracz %s wylosował liczbę %s (z przedziału %s–%s)",
	"commands.random.sample.success": "Wylosowana wartość: %s",
	...
	"commands.recipe.give.success.single": "Odblokowano %s receptur dla %s",
	"commands.recipe.take.failed": "Nie udało się zapomnieć żadnej receptury",
	"commands.recipe.take.success.multiple": "Odebrano %s receptur %s graczom",
	"commands.recipe.take.success.single": "Odebrano %s receptur graczowi %s",
	...
	"commands.rotate.success": "Obrócono %s",
	...
	"commands.schedule.cleared.success": "Usunięto plany (%s) o identyfikatorze %s",
	...
	"commands.schedule.macro": "Nie można zaplanować makra",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Wyłączono automatyczną aktualizację wyświetlanego celu %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Włączono automatyczną aktualizację wyświetlanego celu %s",
	"commands.scoreboard.objectives.modify.displayname": "Zmieniono ukazywaną nazwę %s na %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Wyczyszczono domyślny format liczbowy celu %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Zmieniono domyślny format liczbowy celu %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Przywrócono ukazywaną nazwę celu %[2]s u %[1]s bytów",
	"commands.scoreboard.players.display.name.clear.success.single": "Przywrócono ukazywaną nazwę celu %[2]s u gracza %[1]s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Zmieniono ukazywaną nazwę celu %[3]s na %[1]s u %[2]s bytów",
	"commands.scoreboard.players.display.name.set.success.single": "Zmieniono ukazywaną nazwę celu %[3]s na %[1]s u gracza %[2]s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Przywrócono format liczbowy celu %[2]s u %[1]s bytów",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Przywrócono format liczbowy celu %[2]s u gracza %[1]s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Zmieniono format liczbowy celu %[2]s u %[1]s bytów",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Zmieniono format liczbowy celu %[2]s u gracza %[1]s",
	...
	"commands.scoreboard.players.get.null": "Nie można odczytać wartości celu %s u gracza %s — brak przypisanej wartości",
	...
	"commands.setidletimeout.success.disabled": "Limit czasu bezczynności gracza jest teraz wyłączony",
	"commands.setworldspawn.failure.not_overworld": "Punkt odradzania można ustawić jedynie w Nadziemiu",
	"commands.setworldspawn.success": "Ustawiono punkt odradzania dla świata na %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Ustawiono punkt odradzania się w świecie na %s, %s, %s [%s, %s] w %s",
	"commands.spawnpoint.success.multiple": "Ustawiono punkt odradzania na %s, %s, %s [%s], w wymiarze %s dla %s graczy",
	"commands.spawnpoint.success.multiple.new": "Ustawiono punkt odradzania na %s, %s, %s [%s, %s] w %s dla %s graczy",
	"commands.spawnpoint.success.single": "Ustawiono punkt odradzania na %s, %s, %s [%s], w wymiarze %s dla gracza %s",
	"commands.spawnpoint.success.single.new": "Ustawiono punkt odradzania na %s, %s, %s [%s, %s] w %s dla %s",
	"commands.spectate.cannot_spectate": "%s nie można obserwować",
	...
	"commands.spreadplayers.success.teams": "Rozrzucono %s drużyn wokół %s, %s na średni dystans wynoszący %s bloków",
	...
	"commands.stopwatch.already_exists": "Stoper „%s” już istnieje",
	"commands.stopwatch.create.success": "Utworzono stoper „%s”",
	"commands.stopwatch.does_not_exist": "Stoper „%s” nie istnieje",
	"commands.stopwatch.query": "Stoper „%s” był włączony przez %s sek.",
	"commands.stopwatch.remove.success": "Usunięto stoper „%s”",
	"commands.stopwatch.restart.success": "Uruchomiono ponownie stoper „%s”",
	"commands.summon.failed": "Nie można przywołać bytu",
	"commands.summon.failed.peaceful": "Potworów nie można przywołać na poziomie pokojowym",
	...
	"commands.swing.failed.notliving": "Nie znaleziono żywych bytów mogących wymachiwać ramieniem",
	"commands.swing.success.multiple": "%s bytów machnęło ramionami",
	"commands.swing.success.single": "Sprawiono, że byt %s wykonał wymach ramieniem",
	...
	"commands.team.leave.success.multiple": "Usunięto razem %s członków z drużyn",
	...
	"commands.team.option.color.clear.success": "Zresetowano kolor drużyny %s",
	...
	"commands.team.option.nametagVisibility.success": "Widoczność plakietki dla drużyny %s to teraz „%s”",
	"commands.team.option.nametagVisibility.unchanged": "Nic nie uległo zmianie, widoczność plakietek imiennych jest już ustawiona w ten sposób",
	...
	"commands.test.batch.starting": "Tworzenie środowiska %s, seria %s",
	"commands.test.clear.error.no_tests": "Nie znaleziono żadnych testów do wyczyszczenia",
	"commands.test.clear.success": "Wyczyszczono %s struktur",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Kliknij, aby skopiować do schowka",
	"commands.test.create.success": "Utworzono konfigurację testową dla testu %s",
	"commands.test.error.no_test_containing_pos": "Nie znaleziono instancji testowej zawierającej %s, %s, %s",
	"commands.test.error.no_test_instances": "Nie znaleziono żadnej instancji testowej",
	"commands.test.error.non_existant_test": "Nie można znaleźć testu %s",
	"commands.test.error.structure_not_found": "Nie można znaleźć struktury %s",
	"commands.test.error.test_instance_not_found": "Nie można znaleźć testowego bloku z danymi",
	"commands.test.error.test_instance_not_found.position": "Nie można znaleźć testowego bloku z danymi dla testu w %s, %s, %s",
	"commands.test.error.too_large": "Rozmiar struktury musi być mniejszy niż %s bloków wzdłuż każdej osi.",
	"commands.test.locate.done": "Zakończono lokalizowanie: znaleziono następującą liczbę struktur: %s",
	"commands.test.locate.found": "Znaleziono strukturę na pozycji %s (odległość: %s)",
	"commands.test.locate.started": "Rozpoczęto lokalizację struktur testowych. To może chwileczkę potrwać…",
	"commands.test.no_tests": "Brak testów do uruchomienia.",
	"commands.test.relative_position": "Pozycja względnie %s: %s",
	"commands.test.reset.error.no_tests": "Nie znaleziono żadnych testów do zresetowania",
	"commands.test.reset.success": "Zresetowano %s struktur",
	"commands.test.run.no_tests": "Nie znaleziono testów",
	"commands.test.run.running": "Przeprowadzanie testów: %s…",
	"commands.test.summary": "Test gry zakończony! Liczba przeprowadzonych testów: %s",
	"commands.test.summary.all_required_passed": "Wszystkie wymagane testy zaliczone :)",
	"commands.test.summary.failed": "%s wymaganych testów zakończyło się niepowodzeniem :(",
	"commands.test.summary.optional_failed": "Liczba opcjonalnych testów zakończonych niepowodzeniem: %s",
	"commands.tick.query.percentiles": "Percentyle: P50: %sms P95: %sms P99: %sms. Próbka: %s",
	"commands.tick.query.rate.running": "Docelowa częstotliwość tików: %s na sekundę.\nŚredni czas na tik: %sms (Cel: %sms)",
	"commands.tick.query.rate.sprinting": "Docelowa częstotliwość tików: %s na sekundę (ignorowane, tylko jako odniesienie).\nŚredni czas na tik: %sms",
	"commands.tick.rate.success": "Ustaw docelową częstotliwość tików na %s na sekundę",
	"commands.tick.sprint.report": "Przyśpieszenie ukończone z %s tikami na sekundę lub %s ms na tik",
	"commands.tick.sprint.stop.fail": "Brak przyśpieszeń tików w toku",
	"commands.tick.sprint.stop.success": "Przerwano przyśpieszanie tików",
	"commands.tick.status.frozen": "Gra jest zamrożona",
	"commands.tick.status.lagging": "Gra działa, ale nie nadąża za docelową częstotliwością tików",
	"commands.tick.status.running": "Gra działa normalnie",
	"commands.tick.status.sprinting": "Gra jest przyśpieszona",
	"commands.tick.step.fail": "Nie można wykonać przeskoku gry — najpierw należy ją zamrozić",
	"commands.tick.step.stop.fail": "Brak przeskoku tików w toku",
	"commands.tick.step.stop.success": "Przerwano przeskok tików",
	"commands.tick.step.success": "Przeskakiwanie tików: łącznie %s",
	"commands.time.no_default_clock": "W wymiarze %s nie ma domyślnego zegara",
	"commands.time.no_time_marker_found": "Znacznik czasu %s dla zegara %s nie istnieje",
	"commands.time.pause": "Wstrzymano zegar %s",
	"commands.time.query": "Czas wynosi %s",
	"commands.time.query.absolute": "Zegar %s znajduje się na %s tiku",
	"commands.time.query.gametime": "Czas gry wskazuje %s tików",
	"commands.time.query.timeline": "Oś czasu %s wskazuje %s tików",
	"commands.time.query.timeline.repetitions": "Liczba powtórzeń osi czasu %s: %s",
	"commands.time.rate": "Od teraz zegar %s będzie działał z %s-krotną prędkością",
	"commands.time.resume": "Wznowiono zegar %s",
	"commands.time.set": "Ustawiono czas na %s",
	"commands.time.set.absolute": "Zmieniono wartość %s na %s tików",
	"commands.time.set.time_marker": "Ustawiono %s na znacznik czasu %s",
	"commands.time.wrong_timeline_for_clock": "Oś czasu %s nie jest prawidłowa dla zegara %s",
	...
	"commands.transfer.error.no_players": "Do przeniesienia musi być wyznaczony co najmniej jeden gracz",
	"commands.transfer.success.multiple": "Przeniesiono %s graczy na %s:%s",
	"commands.transfer.success.single": "Przenoszenie %s na %s:%s",
	...
	"commands.waypoint.list.empty": "Brak punktów orientacyjnych w %s",
	"commands.waypoint.list.success": "%s punkt(ów) orientacyjny(ch) w %s: %s",
	"commands.waypoint.modify.color": "Kolorem punktu orientacyjnego jest teraz %s",
	"commands.waypoint.modify.color.reset": "Zresetuj kolor punktu orientacyjnego",
	"commands.waypoint.modify.style": "Zmieniono styl punktu orientacyjnego",
	...
	"commands.whitelist.list": "Na białej liście jest %s gracz(y): %s",
	...
	"connect.failed.transfer": "Połączenie zawiodło, kiedy przenoszono na serwer",
	...
	"connect.p2p.failed.unreachable": "Gracz jest nieosiągalny",
	"connect.reconfiging": "Rekonfiguracja…",
	"connect.reconfiguring": "Rekonfiguracja…",
	"connect.transferring": "Przenoszenie na nowy serwer…",
	"container.barrel": "Beczka",
	"container.beacon": "Magiczna latarnia",
	"container.beehive.bees": "Pszczoły: %s/%s",
	"container.beehive.honey": "Miód: %s/%s",
	...
	"createWorld.customize.buffet.search": "Szukaj…",
	"createWorld.customize.buffet.title": "Personalizacja jednego biomu",
	...
	"dataPack.locator_bar.description": "Pokaż kierunek innych graczy w grze wieloosobowej",
	"dataPack.locator_bar.name": "Pasek nawigacyjny",
	"dataPack.minecart_improvements.description": "Usprawniony ruch wagoników",
	"dataPack.minecart_improvements.name": "Usprawnienia wagoników",
	"dataPack.redstone_experiments.description": "Eksperymentalne zmiany redstone",
	"dataPack.redstone_experiments.name": "Eksperymenty redstone",
	"dataPack.title": "Wybierz paczki danych",
	"dataPack.trade_rebalance.description": "Zaktualizowany handel z osadnikami",
	"dataPack.trade_rebalance.name": "Zbalansowanie handlu z osadnikami",
	"dataPack.update_1_20.description": "Nowa zawartość i funkcje dla Minecraft 1.20",
	"dataPack.update_1_20.name": "Aktualizacja 1.20",
	"dataPack.update_1_21.description": "Nowa zawartość i funkcje dla Minecraft 1.21",
	"dataPack.update_1_21.name": "Aktualizacja 1.21",
	...
	"dataPack.winter_drop.description": "Nowa zawartość i funkcje dla Zimowej aktualizacji",
	"dataPack.winter_drop.name": "Zimowe uaktualnienie",
	...
	"death.attack.dryout.player": "Gracz %[1]s umarł z odwodnienia, próbując uciec przed graczem %[2]s",
	...
	"death.attack.fall.player": "Gracz %[1]s zaliczył twarde lądowanie podczas ucieczki przed: %[2]s",
	...
	"death.attack.flyIntoWall.player": "Gracz %[1]s doświadczył energii kinetycznej podczas ucieczki przed %[2]s",
	...
	"death.attack.mace_smash": "Gracz %[1]s został zmiażdżony przez %[2]s",
	"death.attack.mace_smash.item": "Gracz %[1]s został wgnieciony w ziemię przez %[2]s z %[3]s",
	...
	"death.attack.spear": "Gracz %[1]s został zadźgany przez %[2]s",
	"death.attack.spear.item": "Gracz %[1]s został zadźgany przez %[2]s za pomocą %[3]s",
	...
	"death.attack.wither.player": "Gracz %[1]s obumarł podczas walki z %[2]s",
	...
	"debug.copy_location.help": "F3 + C = Kopiowanie lokalizacji jako polecenia /tp; lub przytrzymaj F3 + C przez 10 sekund, aby spowodować awarię gry",
	...
	"debug.crash.message.rebindable": "Kombinacja %s + %s jest wciśnięta. Gra ulegnie awarii, jeżeli nie puścisz klawiszy.",
	...
	"debug.entry.always": "Zawsze",
	"debug.entry.currently.alwaysOn": "%s: Obecnie zawsze włączone",
	"debug.entry.currently.inF3": "%s: Obecnie tylko pod F3",
	"debug.entry.currently.inOverlay": "%s: Obecnie tylko w nakładce debugowania",
	"debug.entry.currently.never": "%s: Obecnie wyłączone",
	"debug.entry.f3": "Pod F3",
	"debug.entry.overlay": "W nakładce",
	...
	"debug.options.category.renderer": "Renderery do debugowania",
	"debug.options.category.text": "Tekst ekranu debugowania",
	"debug.options.help": "F3 + F6 = Edytuj opcje debugowania",
	"debug.options.notAllowed.tooltip": "Niewidoczne, gdy informacje debugowania są ograniczone",
	"debug.options.profile.default": "Profil domyślny",
	"debug.options.profile.performance": "Profil wydajności",
	"debug.options.search": "Szukaj…",
	"debug.options.title": "Opcje debugowania",
	"debug.options.warning": "Te opcje służą wyłącznie do celów testowych. Mogą one zamulić komputer, wykrzaczyć grę lub zjeść twoją pracę domową.",
	...
	"debug.profiling.start.rebindable": "Profilowanie rozpoczęte na czas %s sek. Użyj kombinacji %s + %s, aby przerwać przed czasem",
	...
	"debug.version.header": "Informacje o wersji klienta:",
	"debug.version.help": "F3 + V = Informacje o wersji klienta",
	...
	"disconnect.packetError": "Błąd protokołu sieciowego",
	"disconnect.spam": "Wyrzucony za spamowanie",
	"disconnect.timeout": "Upłynął limit czasu",
	"disconnect.transfer": "Przeniesiono na inny serwer",
	"disconnect.unknownHost": "Nieznany host",
	"download.pack.failed": "Nie udało się pobrać %s z %s pakietów",
	"download.pack.progress.bytes": "Postęp: %s (rozmiar całkowity nieznany)",
	"download.pack.progress.percent": "Postęp: %s%%",
	"download.pack.title": "Pobieranie paczki zasobów %s/%s",
	"editGamerule.default": "Domyślnie: %s",
	"editGamerule.inGame.button": "Edytuj zasady gry…",
	"editGamerule.inGame.disabled.tooltip": "Zmiana zasad gry wymaga uprawnień operatora.",
	"editGamerule.inGame.discardChanges.message": "Czy na pewno chcesz porzucić niezapisane zmiany zasad gry?",
	"editGamerule.inGame.discardChanges.title": "Zmiany zasad gry",
	"editGamerule.inGame.downloadingGamerules": "Wczytywanie zasad gry...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Oddech łodzika",
	...
	"effect.minecraft.infested": "Zarobaczenie",
	...
	"effect.minecraft.oozing": "Zaszlamienie",
	"effect.minecraft.poison": "Zatrucie",
	"effect.minecraft.raid_omen": "Omen najazdu",
	...
	"effect.minecraft.trial_omen": "Omen próby",
	"effect.minecraft.unluck": "Pech",
	"effect.minecraft.water_breathing": "Oddychanie pod wodą",
	"effect.minecraft.weakness": "Słabość",
	"effect.minecraft.weaving": "Przędzenie",
	"effect.minecraft.wind_charged": "Napowietrzenie",
	...
	"enchantment.minecraft.breach": "Przedarcie",
	"enchantment.minecraft.channeling": "Porażenie",
	"enchantment.minecraft.density": "Masywność",
	...
	"enchantment.minecraft.lunge": "Pchnięcie",
	...
	"enchantment.minecraft.sweeping_edge": "Szerokie ostrze",
	...
	"entity.minecraft.acacia_boat": "Akacjowa łódka",
	"entity.minecraft.acacia_chest_boat": "Akacjowa łódka ze skrzynią",
	"entity.minecraft.allay": "Otuszek",
	"entity.minecraft.area_effect_cloud": "Obłok mikstury",
	"entity.minecraft.armadillo": "Pancernik",
	"entity.minecraft.armor_stand": "Stojak na\u00a0zbroję",
	"entity.minecraft.arrow": "Strzała",
	"entity.minecraft.axolotl": "Aksolotl",
	"entity.minecraft.bamboo_chest_raft": "Bambusowa tratwa ze skrzynią",
	"entity.minecraft.bamboo_raft": "Bambusowa tratwa",
	"entity.minecraft.bat": "Nietoperz",
	"entity.minecraft.bee": "Pszczoła",
	"entity.minecraft.birch_boat": "Brzozowa łódka",
	"entity.minecraft.birch_chest_boat": "Brzozowa łódka ze skrzynią",
	"entity.minecraft.blaze": "Płomyk",
	"entity.minecraft.block_display": "Wyświetlacz bloku",
	"entity.minecraft.boat": "Łódka",
	"entity.minecraft.bogged": "Bagniak",
	"entity.minecraft.breeze": "Wichrzyk",
	"entity.minecraft.breeze_wind_charge": "Wietrzna kula",
	"entity.minecraft.camel": "Wielbłąd",
	"entity.minecraft.camel_husk": "Wielbłąd-posuch",
	"entity.minecraft.cat": "Kot",
	"entity.minecraft.cave_spider": "Pająk jaskiniowy",
	"entity.minecraft.cherry_boat": "Wiśniowa łódka",
	"entity.minecraft.cherry_chest_boat": "Wiśniowa łódka ze skrzynią",
	...
	"entity.minecraft.copper_golem": "Miedziany golem",
	"entity.minecraft.cow": "Krowa",
	"entity.minecraft.creaking": "Trzeszcz",
	"entity.minecraft.creaking_transient": "Trzeszcz",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Ciemnodębowa łódka",
	"entity.minecraft.dark_oak_chest_boat": "Ciemnodębowa łódka ze skrzynią",
	...
	"entity.minecraft.happy_ghast": "Wesoły ghast",
	...
	"entity.minecraft.jungle_boat": "Tropikalna łódka",
	"entity.minecraft.jungle_chest_boat": "Tropikalna łódka ze skrzynią",
	...
	"entity.minecraft.lingering_potion": "Trwała miotana mikstura",
	"entity.minecraft.llama": "Lama",
	"entity.minecraft.llama_spit": "Ślina lamy",
	"entity.minecraft.magma_cube": "Kostka magmy",
	"entity.minecraft.mangrove_boat": "Namorzynowa łódka",
	"entity.minecraft.mangrove_chest_boat": "Namorzynowa łódka ze skrzynią",
	"entity.minecraft.mannequin": "Manekin",
	...
	"entity.minecraft.oak_boat": "Dębowa łódka",
	"entity.minecraft.oak_chest_boat": "Dębowa łódka ze skrzynią",
	"entity.minecraft.ocelot": "Ocelot",
	"entity.minecraft.ominous_item_spawner": "Złowieszczy przywoływacz przedmiotów",
	"entity.minecraft.painting": "Obraz",
	"entity.minecraft.pale_oak_boat": "Bladodębowa łódka",
	"entity.minecraft.pale_oak_chest_boat": "Bladodębowa łódka ze skrzynią",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Oschlak",
	...
	"entity.minecraft.splash_potion": "Mikstura miotana",
	"entity.minecraft.spruce_boat": "Świerkowa łódka",
	"entity.minecraft.spruce_chest_boat": "Świerkowa łódka ze skrzynią",
	"entity.minecraft.squid": "Kałamarnica",
	"entity.minecraft.stray": "Tułacz",
	"entity.minecraft.strider": "Magmołaz",
	"entity.minecraft.sulfur_cube": "Kostka siarki",
	"entity.minecraft.sulfur_cube.content": "Zawiera: %s",
	...
	"entity.minecraft.wind_charge": "Wietrzna kula",
	...
	"entity.minecraft.zombie_nautilus": "Łodzik-zombie",
	...
	"event.minecraft.raid.defeat.full": "Najazd — Porażka",
	"event.minecraft.raid.raiders_remaining": "Pozostali najeźdźcy: %s",
	"event.minecraft.raid.victory": "Zwycięstwo",
	"event.minecraft.raid.victory.full": "Najazd — Zwycięstwo",
	"filled_map.buried_treasure": "Mapa do ukrytego skarbu",
	"filled_map.explorer_jungle": "Mapa badacza dżungli",
	"filled_map.explorer_swamp": "Mapa badacza bagien",
	"filled_map.id": "Nr #%s",
	...
	"filled_map.trial_chambers": "Mapa do komnat prób",
	"filled_map.unknown": "Nieznana mapa",
	"filled_map.village_desert": "Mapa do wioski na pustyni",
	"filled_map.village_plains": "Mapa do wioski na równinach",
	"filled_map.village_savanna": "Mapa do wioski na sawannie",
	"filled_map.village_snowy": "Mapa do wioski ze śnieżnych terenów",
	"filled_map.village_taiga": "Mapa do wioski z tajgi",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Włącz Nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Określa, czy gracze mogą wejść do Netheru.",
	"gamerule.allowFireTicksAwayFromPlayer": "Tiki ognia oddalonego od graczy",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Kontroluje postępowanie tików ognia i lawy, jeśli znajdą się one na odległości większej niż 8 chunków od dowolnego gracza",
	...
	"gamerule.commandBlocksEnabled": "Włącza bloki poleceń",
	...
	"gamerule.disablePlayerMovementCheck": "Wyłącz sprawdzanie ruchu graczy",
	...
	"gamerule.doLimitedCrafting.description": "Jeśli włączone, gracze będą mogli wytwarzać tylko przedmioty z odblokowanymi recepturami.",
	...
	"gamerule.doMobSpawning.description": "Niektóre byty mogą mieć osobne zasady.",
	...
	"gamerule.enableCommandBlocks": "Włącz bloki poleceń",
	"gamerule.enderPearlsVanishOnDeath": "Rzucone enderperły znikają po śmierci",
	"gamerule.enderPearlsVanishOnDeath.description": "Rzucone przez gracza enderperły znikną, kiedy ten gracz umrze.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Byty z pasażerami mogą korzystać z portali",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Umożliwia bytom z pasażerami przejście przez portale Netheru, portale Endu i bramy Endu.",
	...
	"gamerule.locatorBar": "Włącz wskaźnik nawigacyjny graczy",
	"gamerule.locatorBar.description": "Gdy włączone, wskaźnik lokalizacyjny pojawia się na ekranie, by wskazać pozycję graczy.",
	...
	"gamerule.maxCommandForkCount": "Limit kontekstów polecenia",
	"gamerule.maxCommandForkCount.description": "Maksymalna liczba kontekstów mogących powstać w poleceniach typu „execute as”.",
	"gamerule.maxEntityCramming": "Limit stłoczonych bytów",
	"gamerule.minecartMaxSpeed": "Maksymalna prędkość wagonika",
	"gamerule.minecartMaxSpeed.description": "Maksymalna domyślna prędkość poruszającego się wagonika po lądzie",
	"gamerule.minecraft.elytra_movement_check": "Dokonuj sprawdzania ruchu elytr",
	"gamerule.minecraft.fire_spread_radius_around_player": "Promień rozprzestrzeniania się ognia",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Promień wyrażony w blokach wokół gracza, w którym może rozprzestrzeniać się ogień",
	"gamerule.minecraft.player_movement_check": "Dokonuj sprawdzania ruchu graczy",
	"gamerule.minecraft.raids": "Występowanie najazdów",
	"gamerule.minecraft.universal_anger.description": "Rozzłoszczone neutralne stworzenia atakują każdego pobliskiego gracza, nie tylko tego, który je rozzłościł. Działa najlepiej, gdy zasada forgive_dead_players jest wyłączona.",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Opóźnienie przechodzenia przez portal Netheru w trybie kreatywnym",
	"gamerule.playersNetherPortalCreativeDelay.description": "Czas (w tikach), przez jaki gracz w trybie kreatywnym musi stać w portalu do Netheru, zanim zmieni wymiar.",
	"gamerule.playersNetherPortalDefaultDelay": "Opóźnienie przechodzenia przez portal Netheru w trybie innym niż kreatywny",
	"gamerule.playersNetherPortalDefaultDelay.description": "Czas (w tikach), przez który gracz w trybie innym niż kreatywny musi stać w portalu do Netheru, zanim zmieni wymiar.",
	...
	"gamerule.projectilesCanBreakBlocks": "Pociski mogą niszczyć bloki",
	"gamerule.projectilesCanBreakBlocks.description": "Kontroluje, czy uderzenia pocisków mogą niszczyć podatne bloki.",
	"gamerule.pvp": "Włącz PvP",
	"gamerule.pvp.description": "Określa, czy gracze mogą zadawać obrażenia innym graczom.",
	...
	"gamerule.snowAccumulationHeight.description": "Podczas opadów śniegu warstwy śnieżne będą się piętrzyć, aż osiągną podaną liczbę warstw.",
	"gamerule.spawnChunkRadius": "Promień chunków spawnu",
	"gamerule.spawnChunkRadius.description": "Ilość chunków, która zostanie trwale załadowana wokół miejsca odrodzenia.",
	"gamerule.spawnMonsters": "Odradzanie potworów",
	"gamerule.spawnMonsters.description": "Określa, czy potwory pojawiają się naturalnie.",
	"gamerule.spawnRadius": "Zasięg miejsca odrodzenia",
	"gamerule.spawnRadius.description": "Ustala wielkość obszaru wokół punktu odradzania, w którym gracz może się odrodzić.",
	"gamerule.spawnerBlocksEnabled": "Włącza bloki przyzywające",
	"gamerule.spectatorsGenerateChunks": "Generowanie terenu przez widzów",
	"gamerule.tntExplodes": "Zezwala na odpalanie TNT i jego wybuch",
	...
	"gui.abuseReport.attestation": "Przesyłając zgłoszenie oświadczasz, że zawarte w nim informacje są zgodne z prawdą i posiadaną przez siebie wiedzą.",
	"gui.abuseReport.comments": "Komentarze",
	"gui.abuseReport.describe": "Udzielenie szczegółowych informacji pomoże nam podjąć trafną decyzję.",
	"gui.abuseReport.discard.content": "Jeżeli opuścisz tę stronę, zgłoszenie i komentarze zostaną utracone.\nCzy na pewno chcesz zrezygnować?",
	"gui.abuseReport.discard.discard": "Wyjdź i porzuć zgłoszenie",
	"gui.abuseReport.discard.draft": "Zapisz jako wersję roboczą",
	"gui.abuseReport.discard.return": "Kontynuuj edycję",
	"gui.abuseReport.discard.title": "Porzucić zgłoszenie i komentarze?",
	"gui.abuseReport.draft.content": "Czy chcesz kontynuować edycję istniejącego zgłoszenia, czy porzucić je i utworzyć nowe?",
	"gui.abuseReport.draft.discard": "Porzuć",
	"gui.abuseReport.draft.edit": "Kontynuuj edycję",
	"gui.abuseReport.draft.quittotitle.content": "Chcesz kontynuować edycję zgłoszenia czy je porzucić?",
	"gui.abuseReport.draft.quittotitle.title": "Istnieje wersja robocza zgłoszenia, która zostanie utracona, jeśli zrezygnujesz",
	"gui.abuseReport.draft.title": "Edytować wersję roboczą zgłoszenia?",
	"gui.abuseReport.error.title": "Problem podczas wysyłania Twojego zgłoszenia",
	"gui.abuseReport.message": "Gdzie wystąpiło niewłaściwe zachowanie?\nTwój opis pomoże nam w zbadaniu sprawy.",
	"gui.abuseReport.more_comments": "Opisz, co zaszło:",
	"gui.abuseReport.name.comment_box_label": "Proszę opisać, dlaczego chcesz zgłosić tę nazwę:",
	"gui.abuseReport.name.reporting": "Zgłaszasz „%s”.",
	"gui.abuseReport.name.title": "Zgłoś niewłaściwą nazwę gracza",
	"gui.abuseReport.observed_what": "Jaki jest powód zgłoszenia?",
	"gui.abuseReport.read_info": "Więcej o przesyłaniu zgłoszeń",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Zniesławienie",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Ktoś szarga czyjeś dobre imię, podszywa się pod kogoś lub szerzy nieprawdziwe informacje, chcąc kogoś wykorzystać albo wprowadzić w błąd.",
	"gui.abuseReport.reason.description": "Opis:",
	"gui.abuseReport.reason.false_reporting": "Nieuzasadnione zgłaszanie",
	"gui.abuseReport.reason.generic": "Chcę przesłać zgłoszenie",
	"gui.abuseReport.reason.generic.description": "Ten gracz mnie denerwuje albo jego czyny sprawiły mi przykrość.",
	...
	"gui.abuseReport.reason.imminent_harm": "Groźba wyrządzenia szkody",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Samookaleczenie lub samobójstwo",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Treści o charakterze seksualnym",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Skórki zawierające treści graficzne odnoszące się do aktów seksualnych, narządów płciowych i przemocy seksualnej.",
	...
	"gui.abuseReport.report_sent_msg": "Przyjęliśmy twoje zgłoszenie. Dziękujemy!\n\nNasz zespół przejrzy je w najbliższej wolnej chwili.",
	"gui.abuseReport.select_reason": "Wybierz kategorię zgłoszenia",
	"gui.abuseReport.send": "Wyślij zgłoszenie",
	"gui.abuseReport.send.comment_too_long": "Twój komentarz jest za długi",
	...
	"gui.abuseReport.send.no_reason": "Wybierz kategorię zgłoszenia",
	"gui.abuseReport.send.not_attested": "Przeczytaj powyższy tekst i zaznacz pole wyboru, aby móc przesłać zgłoszenie",
	...
	"gui.abuseReport.skin.title": "Zgłoś skórkę gracza",
	"gui.abuseReport.title": "Zgłoś gracza",
	"gui.abuseReport.type.chat": "Wiadomości czatu",
	"gui.abuseReport.type.name": "Nazwa gracza",
	"gui.abuseReport.type.skin": "Skórka gracza",
	...
	"gui.banned.name.description": "Twoja obecna nazwa — „%s” — narusza nasze Standardy Społeczności. Możesz grać w trybie jednoosobowym, ale zanim zagrasz online, konieczna będzie zmiana twojej nazwy użytkownika.\n\nUzyskaj więcej informacji lub odwołaj się pod następującym linkiem: %s",
	"gui.banned.name.title": "Nazwa użytkownika niedozwolona w trybie gry wieloosobowej",
	...
	"gui.banned.skin.description": "Twoja obecna skórka narusza nasze Standardy Społeczności. Nadal możesz grać ze standardową skórką lub wybrać nową.\n\nUzyskaj więcej informacji lub odwołaj się pod następującym linkiem: %s",
	"gui.banned.skin.title": "Niedozwolona skórka",
	"gui.banned.title.permanent": "Konto zostało trwale zablokowane",
	"gui.banned.title.temporary": "Konto zostało tymczasowo zawieszone",
	"gui.cancel": "Anuluj",
	...
	"gui.chatReport.discard.title": "Odrzucić zgłoszenie i komentarze?",
	...
	"gui.chatReport.draft.title": "Edytować wersję roboczą zgłoszenia?",
	...
	"gui.chatReport.title": "Zgłoś gracza na czacie",
	...
	"gui.copy_link_to_clipboard": "Kopiuj link do schowka",
	"gui.days": "%s dzień/dni",
	"gui.done": "Gotowe",
	"gui.down": "Dół",
	"gui.entity_tooltip.type": "Typ: %s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "Liczba odrzuconych plików: %s",
	"gui.fileDropFailure.title": "Nie udało się dodać plików",
	"gui.friends.accept": "Przyjmij",
	"gui.friends.button.loading": "Czekaj…",
	...
	"gui.friends.confirm_title": "Potwierdź",
	...
	"gui.friends.decline": "Odrzuć",
	"gui.friends.empty_nickname": "Przed wysłaniem zaproszenia do grona znajomych wprowadź prawidłową nazwę gracza",
	...
	"gui.friends.enter_nickname": "Wprowadź nazwę gracza",
	...
	"gui.friends.join": "Dołącz",
	"gui.friends.loading_friends": "Ładowanie listy znajomych…",
	...
	"gui.friends.multiplayer.invite_accept": "Zaakceptuj",
	"gui.friends.multiplayer.invite_reject": "Odrzuć",
	"gui.friends.multiplayer.join_request": "Poproś o dołączenie",
	"gui.friends.multiplayer.join_request_accept": "Zaakceptuj",
	"gui.friends.multiplayer.join_request_reject": "Odrzuć",
	"gui.friends.my_profile_name": "Twoja nazwa profilu: ",
	"gui.friends.my_profile_name.narration": "Skopiuj nazwę profilu „%s” do schowka",
	"gui.friends.narration.button.accept": "Naciśnij klawisz Enter, aby zaakceptować zaproszenie do grona znajomych od gracza %s",
	"gui.friends.narration.button.cancel_request": "Naciśnij klawisz Enter, aby anulować zaproszenie gracza %s do grona znajomych",
	"gui.friends.narration.button.decline": "Naciśnij klawisz Enter, aby odrzucić zaproszenie do grona znajomych od gracza %s",
	"gui.friends.narration.button.unfriend": "Naciśnij klawisz Enter, aby usunąć gracza %s z listy znajomych",
	...
	"gui.friends.open": "Znajomi",
	"gui.friends.open.narration": "Lista znajomych",
	"gui.friends.open.tooltip": "Znajomi",
	"gui.friends.pending.empty": "Brak oczekujących zaproszeń do listy znajomych",
	"gui.friends.pending.received": "Otrzymane",
	"gui.friends.pending.sent": "Wysłane",
	"gui.friends.presence.status.offline": "Offline",
	"gui.friends.presence.status.online": "Online",
	"gui.friends.presence.status.playing_hosted_server": "Online (w świecie)",
	"gui.friends.presence.status.playing_offline": "Online (w świecie)",
	"gui.friends.presence.status.playing_realms": "Online (w Realms)",
	"gui.friends.presence.status.playing_server": "Online (na serwerze)",
	"gui.friends.requests_count": "Zaproszenia (%s)",
	"gui.friends.send_request": "Wyślij zaproszenie",
	"gui.friends.tab_friends": "Znajomi",
	...
	"gui.game_rule.search": "Szukaj…",
	"gui.hours": "%s godz.",
	"gui.language.search": "Szukaj…",
	"gui.loadingMinecraft": "Ładowanie Minecraft",
	"gui.minutes": "%s min",
	...
	"gui.none": "Brak",
	"gui.ok": "Ok",
	"gui.open_report_dir": "Otwórz katalog raportów",
	"gui.packSelection.search": "Szukaj…",
	...
	"gui.recipebook.next_page": "Następna strona",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Poprzednia strona",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Ten gracz nie może zostać zgłoszony, ponieważ czat jest wyłączony lub zablokowany",
	...
	"gui.stats.none_found": "Nie znaleziono statystyk.",
	...
	"gui.togglable_slot": "Kliknij, żeby wyłączyć pole",
	"gui.up": "Góra",
	"gui.waitingForResponse.button.inactive": "Wróć (%ss)",
	"gui.waitingForResponse.title": "Oczekiwanie na serwer",
	"gui.yes": "Tak",
	...
	"item.canUse.unknown": "Nieznany",
	"item.color": "Kolor: %s",
	"item.components": "Komponenty: %s",
	"item.disabled": "Wyłączony przedmiot",
	"item.durability": "Trwałość: %s / %s",
	"item.dyed": "Barwione",
	"item.intangible": "Nieuchwytny",
	...
	"item.minecraft.armadillo_scute": "Tarczka pancernika",
	"item.minecraft.armadillo_spawn_egg": "Jajo przyzywające pancernika",
	...
	"item.minecraft.black_bundle": "Czarna sakwa",
	"item.minecraft.black_dye": "Czarny barwnik",
	"item.minecraft.black_harness": "Czarna uprząż",
	...
	"item.minecraft.blue_bundle": "Niebieska sakwa",
	"item.minecraft.blue_dye": "Niebieski barwnik",
	"item.minecraft.blue_egg": "Niebieskie jajko",
	"item.minecraft.blue_harness": "Niebieska uprząż",
	"item.minecraft.bogged_spawn_egg": "Jajo przyzywające bagniaka",
	"item.minecraft.bolt_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Zdobienie zbroi „Nit”",
	"item.minecraft.bone": "Kość",
	"item.minecraft.bone_meal": "Mączka kostna",
	"item.minecraft.book": "Książka",
	"item.minecraft.bordure_indented_banner_pattern": "Wzór sztandaru — ząbkowane obramowanie",
	"item.minecraft.bow": "Łuk",
	"item.minecraft.bowl": "Miska",
	"item.minecraft.bread": "Chleb",
	"item.minecraft.breeze_rod": "Wichrowa różdżka",
	"item.minecraft.breeze_spawn_egg": "Jajo przyzywające wichrzyka",
	...
	"item.minecraft.brown_bundle": "Brązowa sakwa",
	"item.minecraft.brown_dye": "Brązowy barwnik",
	"item.minecraft.brown_egg": "Brązowe jajko",
	"item.minecraft.brown_harness": "Brązowa uprząż",
	"item.minecraft.brush": "Pędzel",
	"item.minecraft.bucket": "Wiadro",
	"item.minecraft.bundle": "Sakwa",
	"item.minecraft.bundle.empty": "Pusta",
	"item.minecraft.bundle.empty.description": "Może przechowywać stos różnorakich przedmiotów",
	"item.minecraft.bundle.full": "Pełna",
	...
	"item.minecraft.camel_husk_spawn_egg": "Jajo przyzywające wielbłąda-posucha",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Zdobienie zbroi „Wybrzeże”",
	...
	"item.minecraft.copper_axe": "Miedziana siekiera",
	"item.minecraft.copper_boots": "Miedziane buty",
	"item.minecraft.copper_chestplate": "Miedziany napierśnik",
	"item.minecraft.copper_golem_spawn_egg": "Jajo przyzywające miedzianego golema",
	"item.minecraft.copper_helmet": "Miedziany hełm",
	"item.minecraft.copper_hoe": "Miedziana motyka",
	"item.minecraft.copper_horse_armor": "Miedziana zbroja końska",
	"item.minecraft.copper_ingot": "Sztabka miedzi",
	"item.minecraft.copper_leggings": "Miedziane nogawice",
	"item.minecraft.copper_nautilus_armor": "Miedziana zbroja łodzika",
	"item.minecraft.copper_nugget": "Bryłka miedzi",
	"item.minecraft.copper_pickaxe": "Miedziany kilof",
	"item.minecraft.copper_shovel": "Miedziana łopata",
	"item.minecraft.copper_spear": "Miedziana włócznia",
	"item.minecraft.copper_sword": "Miedziany miecz",
	"item.minecraft.cow_spawn_egg": "Jajo przyzywające krowę",
	"item.minecraft.creaking_spawn_egg": "Jajo przyzywające trzeszcza",
	"item.minecraft.creeper_banner_pattern": "Wzór sztandaru",
	"item.minecraft.creeper_banner_pattern.desc": "Wizerunek creepera",
	"item.minecraft.creeper_banner_pattern.new": "Wzór sztandaru — wizerunek creepera",
	...
	"item.minecraft.crossbow.projectile.multiple": "Pocisk: %s x %s",
	"item.minecraft.crossbow.projectile.single": "Pocisk: %s",
	"item.minecraft.cyan_bundle": "Błękitna sakwa",
	"item.minecraft.cyan_dye": "Błękitny barwnik",
	"item.minecraft.cyan_harness": "Błękitna uprząż",
	...
	"item.minecraft.diamond_nautilus_armor": "Diamentowa zbroja łodzika",
	"item.minecraft.diamond_pickaxe": "Diamentowy kilof",
	"item.minecraft.diamond_shovel": "Diamentowa łopata",
	"item.minecraft.diamond_spear": "Diamentowa włócznia",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Zdobienie zbroi „Wydma”",
	...
	"item.minecraft.eye_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Zdobienie zbroi „Oko”",
	"item.minecraft.feather": "Pióro",
	"item.minecraft.fermented_spider_eye": "Sfermentowane oko pająka",
	"item.minecraft.field_masoned_banner_pattern": "Wzór sztandaru — mur",
	...
	"item.minecraft.firework_star.magenta": "Purpurowy",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Zdobienie zbroi „Nurt”",
	"item.minecraft.flow_banner_pattern": "Wzór sztandaru",
	"item.minecraft.flow_banner_pattern.desc": "Nurt",
	"item.minecraft.flow_banner_pattern.new": "Wzór sztandaru — nurt",
	"item.minecraft.flow_pottery_sherd": "Odłamek ceramiki „Nurt”",
	"item.minecraft.flower_banner_pattern": "Wzór sztandaru",
	"item.minecraft.flower_banner_pattern.desc": "Wzór kwiatu",
	"item.minecraft.flower_banner_pattern.new": "Wzór sztandaru — kwiat",
	...
	"item.minecraft.globe_banner_pattern.new": "Wzór sztandaru — glob",
	...
	"item.minecraft.golden_nautilus_armor": "Złota zbroja łodzika",
	"item.minecraft.golden_pickaxe": "Złoty kilof",
	"item.minecraft.golden_shovel": "Złota łopata",
	"item.minecraft.golden_spear": "Złota włócznia",
	"item.minecraft.golden_sword": "Złoty miecz",
	"item.minecraft.gray_bundle": "Szara sakwa",
	"item.minecraft.gray_dye": "Szary barwnik",
	"item.minecraft.gray_harness": "Szara uprząż",
	"item.minecraft.green_bundle": "Zielona sakwa",
	"item.minecraft.green_dye": "Zielony barwnik",
	"item.minecraft.green_harness": "Zielona uprząż",
	"item.minecraft.guardian_spawn_egg": "Jajo przyzywające strażnika",
	"item.minecraft.gunpowder": "Proch",
	"item.minecraft.guster_banner_pattern": "Wzór sztandaru",
	"item.minecraft.guster_banner_pattern.desc": "Podmuch",
	"item.minecraft.guster_banner_pattern.new": "Wzór sztandaru — podmuch",
	"item.minecraft.guster_pottery_sherd": "Odłamek ceramiki „Podmuch”",
	"item.minecraft.happy_ghast_spawn_egg": "Jajo przyzywające wesołego ghasta",
	"item.minecraft.harness": "Uprząż",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.host_armor_trim_smithing_template.new": "Zdobienie zbroi „Gospodarz”",
	...
	"item.minecraft.iron_nautilus_armor": "Żelazna zbroja łodzika",
	...
	"item.minecraft.iron_spear": "Żelazna włócznia",
	...
	"item.minecraft.light_blue_bundle": "Jasnoniebieska sakwa",
	"item.minecraft.light_blue_dye": "Jasnoniebieski barwnik",
	"item.minecraft.light_blue_harness": "Jasnoniebieska uprząż",
	"item.minecraft.light_gray_bundle": "Jasnoszara sakwa",
	"item.minecraft.light_gray_dye": "Jasnoszary barwnik",
	"item.minecraft.light_gray_harness": "Jasnoszara uprząż",
	"item.minecraft.lime_bundle": "Jasnozielona sakwa",
	"item.minecraft.lime_dye": "Jasnozielony barwnik",
	"item.minecraft.lime_harness": "Jasnozielona uprząż",
	...
	"item.minecraft.lingering_potion.effect.infested": "Trwała mikstura zarobaczenia",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Trwała mikstura zaszlamienia",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Trwała mikstura przędzenia",
	"item.minecraft.lingering_potion.effect.wind_charged": "Trwała mikstura napowietrzenia",
	"item.minecraft.llama_spawn_egg": "Jajo przyzywające lamę",
	"item.minecraft.lodestone_compass": "Magnetytowy kompas",
	"item.minecraft.mace": "Buzdygan",
	"item.minecraft.magenta_bundle": "Purpurowa sakwa",
	"item.minecraft.magenta_dye": "Purpurowy barwnik",
	"item.minecraft.magenta_harness": "Purpurowa uprząż",
	...
	"item.minecraft.mojang_banner_pattern.new": "Wzór sztandaru — coś",
	...
	"item.minecraft.music_disc_creator": "Płyta muzyczna",
	"item.minecraft.music_disc_creator.desc": "Lena Raine — Creator",
	"item.minecraft.music_disc_creator_music_box": "Płyta muzyczna",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine — Creator (Pozytywka)",
	"item.minecraft.music_disc_far": "Płyta muzyczna",
	"item.minecraft.music_disc_far.desc": "C418 — far",
	"item.minecraft.music_disc_lava_chicken": "Płyta muzyczna",
	...
	"item.minecraft.music_disc_precipice": "Płyta muzyczna",
	...
	"item.minecraft.music_disc_tears": "Płyta muzyczna",
	...
	"item.minecraft.name_tag": "Plakietka",
	"item.minecraft.nautilus_shell": "Muszla łodzika",
	"item.minecraft.nautilus_spawn_egg": "Jajo przyzywające łodzika",
	...
	"item.minecraft.netherite_horse_armor": "Netherytowa zbroja końska",
	"item.minecraft.netherite_ingot": "Sztabka netherytu",
	"item.minecraft.netherite_leggings": "Netherytowe nogawice",
	"item.minecraft.netherite_nautilus_armor": "Netherytowa zbroja łodzika",
	...
	"item.minecraft.netherite_spear": "Netherytowa włócznia",
	"item.minecraft.netherite_sword": "Netherytowy miecz",
	"item.minecraft.netherite_upgrade_smithing_template": "Szablon kowalski",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Netherytowe ulepszenie",
	...
	"item.minecraft.ominous_bottle": "Złowieszcza butelka",
	"item.minecraft.ominous_trial_key": "Złowieszczy klucz próby",
	"item.minecraft.orange_bundle": "Pomarańczowa sakwa",
	"item.minecraft.orange_dye": "Pomarańczowy barwnik",
	"item.minecraft.orange_harness": "Pomarańczowa uprząż",
	"item.minecraft.painting": "Obraz",
	"item.minecraft.pale_oak_boat": "Bladodębowa łódka",
	"item.minecraft.pale_oak_chest_boat": "Bladodębowa łódka ze skrzynią",
	"item.minecraft.panda_spawn_egg": "Jajo przyzywające pandę",
	"item.minecraft.paper": "Papier",
	"item.minecraft.parched_spawn_egg": "Jajo przyzywające oschlaka",
	...
	"item.minecraft.piglin_banner_pattern.new": "Wzór sztandaru — ryjek",
	...
	"item.minecraft.pink_bundle": "Różowa sakwa",
	"item.minecraft.pink_dye": "Różowy barwnik",
	"item.minecraft.pink_harness": "Różowa uprząż",
	...
	"item.minecraft.potion.effect.infested": "Mikstura zarobaczenia",
	...
	"item.minecraft.potion.effect.oozing": "Mikstura zaszlamienia",
	...
	"item.minecraft.potion.effect.weaving": "Mikstura przędzenia",
	"item.minecraft.potion.effect.wind_charged": "Mikstura napowietrzenia",
	...
	"item.minecraft.purple_bundle": "Fioletowa sakwa",
	"item.minecraft.purple_dye": "Fioletowy barwnik",
	"item.minecraft.purple_harness": "Fioletowa uprząż",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Zdobienie zbroi „Opiekun”",
	...
	"item.minecraft.red_bundle": "Czerwona sakwa",
	"item.minecraft.red_dye": "Czerwony barwnik",
	"item.minecraft.red_harness": "Czerwona uprząż",
	"item.minecraft.redstone": "Sproszkowany redstone",
	"item.minecraft.resin_brick": "Żywicowa cegła",
	"item.minecraft.resin_clump": "Gruda żywicy",
	"item.minecraft.rib_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Zdobienie zbroi „Żebra”",
	...
	"item.minecraft.scrape_pottery_sherd": "Odłamek ceramiki „Skrobak”",
	"item.minecraft.scute": "Tarczka",
	"item.minecraft.sentry_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Zdobienie zbroi „Wartownik”",
	"item.minecraft.shaper_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Zdobienie zbroi „Rzeźbiarz”",
	...
	"item.minecraft.shield.magenta": "Purpurowa tarcza",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Zdobienie zbroi „Cisza”",
	...
	"item.minecraft.skull_banner_pattern.new": "Wzór sztandaru — czaszka",
	...
	"item.minecraft.snout_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Zdobienie zbroi „Ryjek”",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Zdobienie zbroi „Iglica”",
	...
	"item.minecraft.splash_potion.effect.infested": "Miotana mikstura zarobaczenia",
	...
	"item.minecraft.splash_potion.effect.oozing": "Miotana mikstura zaszlamienia",
	...
	"item.minecraft.splash_potion.effect.weaving": "Miotana mikstura przędzenia",
	"item.minecraft.splash_potion.effect.wind_charged": "Miotana mikstura napowietrzenia",
	...
	"item.minecraft.stone_spear": "Kamienna włócznia",
	...
	"item.minecraft.sulfur_cube_bucket": "Wiadro z kostką siarki",
	"item.minecraft.sulfur_cube_spawn_egg": "Jajo przyzywające kostkę siarki",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Zdobienie zbroi „Fala”",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Strzała zarobaczenia",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Strzała zaszlamienia",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Strzała przędzenia",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Strzała napowietrzenia",
	...
	"item.minecraft.trial_key": "Klucz próby",
	...
	"item.minecraft.turtle_scute": "Tarczka żółwia",
	"item.minecraft.turtle_spawn_egg": "Jajo przyzywające żółwia",
	"item.minecraft.vex_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Zdobienie zbroi „Dręczyciel”",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Zdobienie zbroi „Nadzorca”",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Zdobienie zbroi „Włóczykij”",
	"item.minecraft.wheat": "Pszenica",
	"item.minecraft.wheat_seeds": "Nasiona pszenicy",
	"item.minecraft.white_bundle": "Biała sakwa",
	"item.minecraft.white_dye": "Biały barwnik",
	"item.minecraft.white_harness": "Biała uprząż",
	"item.minecraft.wild_armor_trim_smithing_template": "Szablon kowalski",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Zdobienie zbroi „Dzicz”",
	"item.minecraft.wind_charge": "Wietrzna kula",
	...
	"item.minecraft.wolf_armor": "Wilcza zbroja",
	...
	"item.minecraft.wooden_spear": "Drewniana włócznia",
	...
	"item.minecraft.yellow_bundle": "Żółta sakwa",
	"item.minecraft.yellow_dye": "Żółty barwnik",
	"item.minecraft.yellow_harness": "Żółta uprząż",
	...
	"item.minecraft.zombie_nautilus_spawn_egg": "Jajo przyzywające łodzika-zombie",
	...
	"item.modifiers.any": "Kiedy wyposażono:",
	"item.modifiers.armor": "Kiedy noszony:",
	"item.modifiers.body": "Kiedy wyposażono:",
	"item.modifiers.chest": "Kiedy na torsie:",
	"item.modifiers.feet": "Kiedy na stopach:",
	"item.modifiers.hand": "Kiedy trzymany:",
	...
	"item.modifiers.saddle": "Kiedy osiodłany:",
	"item.nbt_tags": "Liczba tagów NBT: %s",
	"item.op_block_warning.line1": "Uwaga:",
	"item.op_block_warning.line2": "Użycie tego przedmiotu może spowodować wykonanie polecenia.",
	"item.op_block_warning.line3": "Nie używaj, dopóki nie znasz dokładnej zawartości!",
	"item.spawn_egg.peaceful": "Niedostępne na pokojowym poziomie trudności",
	...
	"jigsaw_block.placement_priority": "Priorytet umieszcz.:",
	"jigsaw_block.placement_priority.tooltip": "Gdy ten blok konstrukcyjny złączy się z elementem, będzie on poszukiwał połączeń na obszarze szerszej struktury w podanej tu kolejności.\n\nBloki konstrukcyjne będą przetwarzane począwszy od tych z najwyższym priorytetem, a w przypadku kilku równych wartości nad porządkiem zadecyduje kolejność wstawienia elementów.",
	"jigsaw_block.pool": "Pula początkowa:",
	"jigsaw_block.selection_priority": "Priorytet wyboru:",
	"jigsaw_block.selection_priority.tooltip": "Gdy element nadrzędny zacznie poszukiwać połączeń, ten blok konstrukcyjny spróbuje połączyć się z elementami docelowymi w podanej tu kolejności.\n\nBloki konstrukcyjne będą przetwarzane począwszy od tych z najwyższym priorytetem, a w przypadku kilku równych wartości element zostanie wybrany losowo.",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine – Creator (pozytywka)",
	...
	"key.categories.spectator": "Tryb widza",
	"key.categories.ui": "Interfejs gry",
	"key.category.minecraft.creative": "Tryb kreatywny",
	"key.category.minecraft.debug": "Debugowanie",
	"key.category.minecraft.gameplay": "Rozgrywka",
	"key.category.minecraft.inventory": "Ekwipunek",
	"key.category.minecraft.misc": "Różne",
	"key.category.minecraft.movement": "Ruch",
	"key.category.minecraft.multiplayer": "Gra wieloosobowa",
	"key.category.minecraft.spectator": "Tryb widza",
	"key.chat": "Otwórz czat",
	"key.command": "Wpisywanie polecenia",
	"key.debug.clearChat": "Wyczyść czat",
	"key.debug.copyLocation": "Kopiuj lokalizację",
	"key.debug.copyRecreateCommand": "Kopiuj dane",
	"key.debug.crash": "Awaria dla debugowania",
	"key.debug.debugOptions": "Opcje debugowania",
	"key.debug.dumpDynamicTextures": "Utwórz zrzut dynamicznych tekstur",
	"key.debug.dumpVersion": "Zrzuć informacje o wersji",
	"key.debug.focusPause": "Przełącz pauzę po opuszczeniu okna gry",
	"key.debug.fpsCharts": "Wykresy FPS",
	"key.debug.lightmapTexture": "Tekstura mapy świateł",
	"key.debug.modifier": "Klawisz modyfikatora debugowania",
	"key.debug.networkCharts": "Wykresy sieciowe",
	"key.debug.overlay": "Przełącz nakładkę",
	"key.debug.profiling": "Uruchom/zatrzymaj profilowanie",
	"key.debug.profilingChart": "Wykres profilowania",
	"key.debug.reloadChunk": "Przeładuj chunki",
	"key.debug.reloadResourcePacks": "Przeładuj paczki zasobów",
	"key.debug.showAdvancedTooltips": "Pokaż zaawansowane etykiety",
	"key.debug.showChunkBorders": "Pokaż granice chunków",
	"key.debug.showHitboxes": "Pokaż hitboxy",
	"key.debug.spectate": "Przełącz tryb widza",
	"key.debug.switchGameMode": "Przełącznik trybu gry",
	...
	"key.quickActions": "Szybkie akcje",
	...
	"key.spectatorHotbar": "Wybierz na pasku szybkiego wyboru",
	"key.spectatorOutlines": "Podświetlaj graczy",
	"key.sprint": "Bieg",
	"key.swapOffhand": "Przerzuć przedmiot do drugiej ręki",
	"key.toggleGui": "Przełącz interfejs graficzny",
	"key.togglePerspective": "Przełącz perspektywę",
	"key.toggleSpectatorShaderEffects": "Przełącz efekty shaderów widza",
	"key.use": "Użyj przedmiotu/umieść blok",
	"known_server_link.announcements": "Ogłoszenia",
	"known_server_link.community": "Społeczność",
	"known_server_link.community_guidelines": "Wytyczne społeczności",
	"known_server_link.feedback": "Opinia",
	"known_server_link.forums": "Fora",
	"known_server_link.news": "Aktualności",
	"known_server_link.report_bug": "Zgłoś błąd serwera",
	"known_server_link.status": "Stan",
	"known_server_link.support": "Wsparcie",
	"known_server_link.website": "Witryna internetowa",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Dodaj serwer",
	"manageServer.edit.title": "Edytuj informacje o serwerze",
	"manageServer.enterIp": "Adres serwera",
	"manageServer.enterName": "Nazwa serwera",
	"manageServer.resourcePack": "Pakiety zasobów serwera",
	"manageServer.resourcePack.disabled": "Wyłączone",
	"manageServer.resourcePack.enabled": "Włączone",
	"manageServer.resourcePack.prompt": "Pytaj",
	"mco.account.privacy.info": "Przeczytaj więcej o Mojang i przepisach dotyczących prywatności",
	"mco.account.privacy.info.button": "Przeczytaj więcej o RODO",
	"mco.account.privacy.information": "Mojang wdraża określone procedury w celu ochrony dzieci i ich prywatności, w tym przestrzegania Children’s Online Privacy Protection Act (COPPA) oraz rozporządzenia o ochronie danych osobowych (RODO).\n\nPrzed uzyskaniem dostępu do konta Realms może być konieczne uzyskanie zgody rodzica.",
	...
	"mco.backup.entry.enabledPack": "Wybrane paczki",
	...
	"mco.client.outdated.stable.version": "Nie można włączyć Realms, ponieważ twoja wersja gry (%s) jest niekompatybilna.\n\nUruchom grę na najnowszej wersji.",
	"mco.client.unsupported.snapshot.version": "Twoja wersja gry (%s) nie jest kompatybilna z usługą Realms.\n\nRealms jest niedostępne w tej wersji typu snapshot.",
	"mco.compatibility.downgrade": "Obniż wersję",
	"mco.compatibility.downgrade.description": "Ten świat był ostatnio otwierany w wersji %s. Obecnie używasz wersji %s. Obniżenie wersji gry może spowodować jego uszkodzenie — nie możemy zagwarantować, że świat się załaduje, ani że będzie poprawnie działać. \n\nKopia twojego świata zostanie zapisana w menu „Kopie zapasowe świata”. Tam w razie potrzeby możliwe jest przywrócenie swojego świata.",
	"mco.compatibility.incompatible.popup.title": "Niezgodna wersja",
	"mco.compatibility.incompatible.releaseType.popup.message": "Świat, do którego próbujesz dołączyć, jest niezgodny z wersją, z której korzystasz.",
	"mco.compatibility.incompatible.series.popup.message": "Ten świat był ostatnio uruchamiany na wersji %s; Aktualnie korzystasz z wersji %s.\n\nTe wersje gry nie są kompatybilne ze sobą. Aby zagrać w tej wersji potrzebujesz nowego świata.",
	"mco.compatibility.unverifiable.message": "Nie można zweryfikować wersji świata, na którym ostatnio grano. Jeśli wersja świata zostanie podniesiona lub obniżona, kopia zapasowa zostanie automatycznie utworzona i zapisana w menu „Kopie zapasowe świata”.",
	"mco.compatibility.unverifiable.title": "Zgodność nieweryfikowalna",
	"mco.compatibility.upgrade": "Aktualizuj",
	"mco.compatibility.upgrade.description": "Ten świat był ostatnio załadowany w wersji %s; ty jesteś na wersji %s.\n\nKopia zapasowa twoich światów zostanie zapisana w „Kopii zapasowej światów”. Przywróć swój świat w razie potrzeby.",
	"mco.compatibility.upgrade.friend.description": "Ten świat był ostatnio załadowany w wersji %s; ty jesteś na wersji %s.\n\nKopia zapasowa twojego świata zostanie zapisana w „World backups”.\n\nW razie potrzeby właściciel Realm może przywrócić świat.",
	"mco.compatibility.upgrade.title": "Czy na pewno chcesz zaktualizować swój świat?",
	...
	"mco.configure.world.buttons.close": "Tymczasowo zamknij Realm",
	...
	"mco.configure.world.buttons.invite": "Zaproś gracza",
	"mco.configure.world.buttons.moreoptions": "Więcej opcji",
	"mco.configure.world.buttons.newworld": "Nowy świat",
	"mco.configure.world.buttons.open": "Otwórz ponownie Realm",
	"mco.configure.world.buttons.options": "Ustawienia świata",
	"mco.configure.world.buttons.players": "Gracze",
	"mco.configure.world.buttons.region_preference": "Wybierz region…",
	"mco.configure.world.buttons.resetworld": "Zresetuj realm",
	"mco.configure.world.buttons.save": "Zapisz",
	...
	"mco.configure.world.close.question.line1": "Możesz tymczasowo zamknąć swój Realm, uniemożliwiając grę podczas wprowadzania zmian.\nOtwórz go ponownie, gdy będziesz gotowy.\n\nTo nie anuluje Twojej subskrypcji Realms.",
	"mco.configure.world.close.question.line2": "Jesteś pewien, że chcesz kontynuować?",
	"mco.configure.world.close.question.title": "Czy chcesz wprowadzić zmiany bez zakłóceń?",
	"mco.configure.world.closing": "Tymczasowe zamykanie Realmu...",
	...
	"mco.configure.world.invited.number": "Zaproszono (%s)",
	...
	"mco.configure.world.loading": "Ładowanie Realmu",
	"mco.configure.world.location": "Lokalizacja",
	"mco.configure.world.minigame": "Obecny: %s",
	"mco.configure.world.name": "Nazwa realmu",
	"mco.configure.world.name.validation.whitespace": "Nie może zaczynać się ani kończyć pustymi znakami. Zostaną usunięte.",
	"mco.configure.world.opening": "Otwieranie realmu…",
	"mco.configure.world.players.error": "Użytkownik o podanej nazwie nie istnieje",
	"mco.configure.world.players.invite.duplicate": "Gracz o podanej nazwie został już zaproszony do Realmu",
	"mco.configure.world.players.inviting": "Zapraszanie gracza…",
	"mco.configure.world.players.title": "Gracze",
	"mco.configure.world.pvp": "PVP",
	"mco.configure.world.region_preference": "Preferowany region",
	"mco.configure.world.region_preference.title": "Wybór regionu",
	...
	"mco.configure.world.resourcepack.question": "Ten realm potrzebuje niestandardowej paczki zasobów\n\nCzy chcesz ją pobrać do gry?",
	...
	"mco.configure.world.settings.expired": "Nie możesz edytować ustawień wygasłego Realmu",
	...
	"mco.configure.world.spawnMonsters": "Odradzanie potworów",
	"mco.configure.world.spawnNPCs": "Spawnuj NPC",
	"mco.configure.world.spawnProtection": "Ochrona miejsca odrodzenia",
	"mco.configure.world.spawn_toggle.message": "Wyłączenie tej opcji spowoduje usunięcie wszystkich istniejących jednostek tego typu",
	"mco.configure.world.spawn_toggle.message.npc": "Wyłączenie tej opcji spowoduje usunięcie wszystkich istniejących jednostek tego typu, np. osadników",
	...
	"mco.configure.world.subscription.tab": "Subskrypcja",
	...
	"mco.configure.world.switch.slot.subtitle": "Ten świat jest pusty. Wybierz, jak chcesz go stworzyć.",
	...
	"mco.download.confirmation.oversized": "Świat, który zamierzasz pobrać, jest większy niż %s\n\nNie będziesz już w stanie przesłać tego świata do swojego Realmu",
	...
	"mco.errorMessage.6008": "Nieprawidłowa nazwa Realm",
	"mco.errorMessage.6009": "Nieprawidłowy opis Realm",
	"mco.errorMessage.connectionFailure": "Wystąpił błąd. Spróbuj ponownie później.",
	"mco.errorMessage.generic": "Wystąpił błąd: ",
	"mco.errorMessage.initialize.failed": "Nie udało się zainicjować realmu",
	"mco.errorMessage.noDetails": "Nie podano szczegółów błędu",
	"mco.errorMessage.realmsService": "Wystąpił błąd (%s):",
	"mco.errorMessage.realmsService.configurationError": "Wystąpił niespodziewany błąd podczas edytowania opcji świata",
	"mco.errorMessage.realmsService.connectivity": "Nie można połączyć się z Realms: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Nie udało się sprawdzić zgodnej wersji. Otrzymano odpowiedź: %s",
	"mco.errorMessage.retry": "Spróbuj ponownie",
	...
	"mco.gui.ok": "Ok",
	"mco.info": "Informacje!",
	"mco.invited.player.narration": "Zaproszono gracza %s",
	...
	"mco.notification.transferSubscription.buttonText": "Przenieś teraz",
	"mco.notification.transferSubscription.message": "Subskrypcje Java Realms zostają przeniesione do sklepu Microsoft Store. Nie pozwól, aby Twoja subskrypcja wygasła! Przenieś ją teraz i zdobądź 30 dni Realms za darmo. Wejdź na swój profil na stronie minecraft.net, aby przenieść swoją subskrypcję.",
	"mco.notification.visitUrl.buttonText.default": "Otwórz link",
	"mco.notification.visitUrl.message.default": "Odwiedź poniższy link",
	"mco.onlinePlayers": "Aktywni gracze",
	"mco.play.button.realm.closed": "Realm zamknięty",
	...
	"mco.reset.world.template": "Szablony realm",
	...
	"mco.selectServer.closed": "Nieaktywny Realm",
	...
	"mco.selectServer.create.subtitle": "Wybierz, który świat umieścić w realmie",
	...
	"mco.selectServer.loading": "Ładowanie listy światów Realms",
	...
	"mco.selectServer.noRealms": "Wygląda na to, że nie posiadasz świata Realms. Dodaj Realm, aby grać razem ze znajomymi.",
	...
	"mco.selectServer.popup": "Realms to prosty i bezpieczny sposób na grę online nawet z dziesięcioma znajomymi naraz. Obsługiwanych jest mnóstwo minigier oraz własne światy! Koszty realmu ponosi jedynie jego właściciel.",
	...
	"mco.snapshot.createSnapshotPopup.text": "Za chwilę utworzysz bezpłatny realm dla snapshotów, który zostanie połączony z twoją płatną subskrypcją Realms. Realm dostępny będzie dopóty, dopóki będzie aktywna płatna subskrypcja. Nie będzie to miało wpływu na płatny realm.",
	"mco.snapshot.createSnapshotPopup.title": "Stworzyć realm na tym snapshocie?",
	"mco.snapshot.creating": "Tworzenie realmu na snapshocie…",
	"mco.snapshot.description": "Sparowano z „%s”",
	"mco.snapshot.friendsRealm.downgrade": "Aby dołączyć do tego realmu, wymagana jest wersja %s",
	"mco.snapshot.friendsRealm.upgrade": "Zanim zagrasz na tym snapshocie, %s musi zaktualizować wersję swojego realmu",
	"mco.snapshot.paired": "Ten realm dla snapshotów jest połączony z realmem „%s”",
	"mco.snapshot.parent.tooltip": "Użyj najnowszej wersji Minecrafta, aby zagrać na tym realmie",
	"mco.snapshot.start": "Rozpocznij darmowy realm dla snapshotów",
	"mco.snapshot.subscription.info": "To jest Realm dla snapshotów, który jest połączony z subskrypcją Realm „%s”. Będzie on dostępny dopóty, dopóki aktywny będzie sparowany z nim Realm.",
	"mco.snapshot.tooltip": "Realms dla snapshotów pozwalają ci rzucić okiem na nadchodzące wersje Minecrafta oraz zawarte w nich nowości i zmiany.\n\nTradycyjne światy Realms są wciąż dostępne w stabilnej wersji gry.",
	"mco.snapshotRealmsPopup.message": "Począwszy od snapshotu 23w41a, Realms jest również dostępny dla snapshotów. Jeżeli posiadasz subskrypcję Realms, poza zwykłym Realms dla Javy, możesz dodatkowo bezpłatnie korzystać z Realms dla snapshotów!",
	"mco.snapshotRealmsPopup.title": "Realms są teraz dostępne w Snapshotach",
	"mco.snapshotRealmsPopup.urlText": "Dowiedz się więcej",
	...
	"mco.upload.failed.too_big.description": "Wybrany świat jest za duży. Maksymalny dozwolony rozmiar to %s.",
	"mco.upload.failed.too_big.title": "Za duży świat",
	...
	"mco.version": "Wersja: %s",
	"mco.warning": "Uwaga!",
	"mco.worldSlot.minigame": "Minigra",
	"menu.custom_options": "Niestandardowe opcje...",
	"menu.custom_options.title": "Niestandardowe opcje",
	"menu.custom_options.tooltip": "Uwaga: Opcje niestandardowe są dostarczane przez serwery i/lub treści stron trzecich.\nObchodź się z nimi ostrożnie!",
	"menu.custom_screen_info.button_narration": "To jest niestandardowy ekran. Dowiedz się więcej.",
	"menu.custom_screen_info.contents": "Zawartość tego ekranu jest kontrolowana przez serwery i mapy stron trzecich, które nie należą do Mojang Studios ani Microsoftu, nie są przez nie obsługiwane ani nadzorowane.\n\nUważaj! Zawsze zachowuj ostrożność podczas otwierania linków i nigdy nie podawaj swoich danych osobowych, w tym danych logowania.\n\nJeśli ten ekran uniemożliwia Ci grę, możesz rozłączyć się z serwerem, używając przycisku poniżej.",
	"menu.custom_screen_info.disconnect": "Odrzucono niestandardowy ekran",
	"menu.custom_screen_info.title": "Uwaga dotycząca niestandardowych ekranów",
	"menu.custom_screen_info.tooltip": "To jest niestandardowy ekran. Kliknij tutaj, aby dowiedzieć się więcej.",
	"menu.disconnect": "Rozłącz",
	"menu.feedback": "Opinia…",
	"menu.feedback.title": "Opinia",
	"menu.game": "Menu gry",
	...
	"menu.multiplayerOptions.network.online": "Ze znajomymi",
	...
	"menu.quick_actions": "Szybkie akcje...",
	"menu.quick_actions.title": "Szybkie akcje",
	...
	"menu.server_links": "Odnośniki serwera…",
	"menu.server_links.title": "Odnośniki serwera…",
	...
	"multiplayer.codeOfConduct.check": "Nie powiadamiaj ponownie o niniejszym regulaminie",
	"multiplayer.codeOfConduct.title": "Regulamin serwera",
	"multiplayer.confirm_command.parse_errors": "Próbujesz wykonać nierozpoznane lub nieprawidłowe polecenie.\nCzy jesteś pewien?\nPolecenie: %s",
	"multiplayer.confirm_command.permissions_required": "Próbujesz wykonać polecenie, które wymaga podwyższonych uprawnień.\nMoże to negatywnie wpłynąć na grę.\nCzy jesteś pewien?\nPolecenie: %s",
	"multiplayer.confirm_command.run_command": "Wykonaj polecenie",
	"multiplayer.confirm_command.signature_required": "Próbujesz wykonać polecenie, które będzie wysyłać wiadomości na czat, używając twojego imienia.\nMożna je uruchomić tylko z ekranu czatu.\nPolecenie: %s",
	"multiplayer.confirm_command.suggest_command": "Kopiuj do ekranu czatu",
	"multiplayer.confirm_command.title": "Potwierdź wykonanie polecenia",
	"multiplayer.disconnect.authservers_down": "Serwery uwierzytelniania są wyłączone. Spróbuj ponownie później, przepraszamy!",
	"multiplayer.disconnect.bad_chat_index": "Wykryto brakującą lub nieuporządkowaną wiadomość z czatu serwera",
	...
	"multiplayer.disconnect.banned.reason.default": "Zablokowany przez operatora.",
	...
	"multiplayer.disconnect.code_of_conduct": "Serwer wymaga zaakceptowania regulaminu",
	"multiplayer.disconnect.configuration_error": "Nieoczekiwany błąd podczas konfiguracji",
	...
	"multiplayer.disconnect.transfers_disabled": "Serwer nie wspiera przeniesień",
	...
	"multiplayer.status.anonymous_player": "Anonimowy gracz",
	...
	"music.game.swamp.labyrinthine": "Lena Raine — Labirynthine",
	...
	"narration.checkbox.usage.focused.check": "Naciśnij Enter, aby zaznaczyć",
	"narration.checkbox.usage.focused.uncheck": "Naciśnij Enter, aby odznaczyć",
	"narration.checkbox.usage.hovered": "Naciśnij lewy przycisk myszy, aby przełączyć",
	"narration.checkbox.usage.hovered.check": "Naciśnij lewy przycisk myszy, aby zaznaczyć",
	"narration.checkbox.usage.hovered.uncheck": "Naciśnij lewy przycisk myszy, aby odznaczyć",
	...
	"narration.item": "Przedmiot: %s",
	"narration.link.usage.focused": "Naciśnij Enter, aby otworzyć link",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Naciśnij Enter, aby rozpocząć zmianę wartości suwaka",
	"narration.slider.usage.hovered": "Przeciągnij suwak, aby zmienić wartość",
	"narration.suggestion": "Wybrano sugestię %s. z %s: %s",
	"narration.suggestion.tooltip": "Wybrano sugestię %s. z %s: %s (%s)",
	"narration.suggestion.usage.cycle.fixed": "Naciśnij przycisk Tab, aby przejść do następnej sugestii",
	"narration.suggestion.usage.cycle.hidable": "Naciśnij przycisk Tab, aby przejść do następnej sugestii lub przycisk Escape, aby wyjść",
	"narration.suggestion.usage.fill.fixed": "Naciśnij Tab, aby użyć sugestii",
	"narration.suggestion.usage.fill.hidable": "Uzupełnij sugestię klawiszem Tab lub wyjdź klawiszem Escape",
	...
	"narrator.select.world_info": "Wybrano %s, ostatnio grano: %s, %s",
	...
	"optimizeWorld.confirm.proceed": "Utwórz kopię zapasową i zoptymalizuj",
	...
	"optimizeWorld.stage.finished.chunks": "Kończenie uaktualniania chunków…",
	"optimizeWorld.stage.finished.entities": "Kończenie uaktualniania bytów…",
	"optimizeWorld.stage.finished.poi": "Kończenie uaktualniania wszystkich punktów zainteresowania…",
	"optimizeWorld.stage.upgrading": "Uaktualnianie wszystkich chunków…",
	"optimizeWorld.stage.upgrading.chunks": "Uaktualnianie wszystkich chunków…",
	"optimizeWorld.stage.upgrading.entities": "Uaktualnianie wszystkich bytów…",
	"optimizeWorld.stage.upgrading.poi": "Uaktualnianie wszystkich punktów zainteresowania…",
	"optimizeWorld.title": "Optymalizowanie świata „%s”",
	"options.accessibility": "Ułatwienia dostępu…",
	...
	"options.accessibility.high_contrast_block_outline": "Kontrastowe obrysy bloków",
	"options.accessibility.high_contrast_block_outline.tooltip": "Wzmacnia kontrast obrysu bloku pod kursorem.",
	"options.accessibility.link": "Wskazówki ułatwień dostępu",
	"options.accessibility.menu_background_blurriness": "Rozmycie tła w menu",
	"options.accessibility.menu_background_blurriness.tooltip": "Zmienia rozmazanie tła menu",
	"options.accessibility.narrator_hotkey": "Klawisz skrótu narratora",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Umożliwia włączanie i wyłączanie narratora za pomocą „⌘ B”.",
	"options.accessibility.narrator_hotkey.tooltip": "Umożliwia włączanie i wyłączanie narratora kombinacją „Ctrl + B”.",
	...
	"options.accessibility.text_background_opacity": "Nieprzezrocz. tła tekstu",
	"options.accessibility.title": "Ułatwienia dostępu…",
	"options.accessibility.tooltip": "Ułatwienia dostępu",
	"options.allowCursorChanges": "Zezwalaj na zmiany kursora",
	"options.allowCursorChanges.tooltip": "Umożliwia zmianę kształtu kursora myszy, gdy znajdzie się on nad określonymi elementami interfejsu użytkownika.",
	...
	"options.allowServerListing.tooltip": "Serwery mogą udostępniać listy graczy online.\nPo wyłączeniu tej opcji twoja nazwa nie będzie wyświetlana na takich listach.",
	...
	"options.blocks": "%s bloków",
	"options.chat": "Ustawienia czatu…",
	"options.chat.color": "Kolory",
	"options.chat.delay": "Opóźnienie czatu: %s sek.",
	"options.chat.delay_none": "Opóźnienie czatu: brak",
	"options.chat.drafts": "Zapisz niewysłane wiadomości",
	"options.chat.drafts.tooltip": "Niewysłane wiadomości zostaną zapisane i będzie można je wysłać przy następnym otwarciu czatu.",
	...
	"options.chunkFade": "Czas pojawiania się chunków",
	"options.chunkFade.none": "Stopniowe pojawianie się chunków: Brak",
	"options.chunkFade.seconds": "Stopniowe pojawianie się chunków: %s sek.",
	"options.chunkFade.tooltip": "W ile sekund powinny pojawiać się chunki przy ich pierwszym renderowaniu, jeśli włączone.",
	...
	"options.cutoutLeaves": "Prześwitujące liście",
	"options.cutoutLeaves.tooltip": "Pozwala widzieć przez szczeliny między liśćmi. Wyłączenie tej opcji poprawia wydajność.",
	...
	"options.difficulty.easy.info": "Występują stworzenia agresywne, ale zadają mniej obrażeń. Poziom sytości może spaść i wyczerpać połowę twojego zdrowia.",
	...
	"options.directionalAudio.off.tooltip": "Klasyczny dźwięk stereo",
	"options.directionalAudio.on.tooltip": "Wykorzystuje dźwięk przestrzenny oparty na HRTF, aby poprawić symulację dźwięku 3D. Wymaga sprzętu audio zgodnego z HRTF i jest najlepiej doświadczany w słuchawkach.",
	...
	"options.exclusiveFullscreen": "Pełny ekran na wyłączność",
	"options.exclusiveFullscreen.warningTooltip": "Ta opcja może uniemożliwić działanie niektórym metodom wprowadzania danych.",
	"options.font": "Ustawienia czcionki…",
	"options.font.title": "Ustawienia czcionki",
	...
	"options.fullscreen.entry": "%sx%s przy %s Hz (%s-bitowa)",
	...
	"options.graphics.custom": "Niestandardowy",
	...
	"options.graphics.preset": "Domyślne",
	"options.graphics.preset.tooltip": "Ustawia ustawienia „Jakość i wydajność” na rozsądne wartości domyślne, odpowiadające pożądanej jakości.",
	...
	"options.graphicsApi": "API graficzne",
	"options.graphicsApi.default": "Domyślne",
	"options.graphicsApi.opengl": "Preferuj OpenGL",
	"options.graphicsApi.restart": "Aby zmienić API graficzne, ponownie uruchom grę.",
	"options.graphicsApi.tooltip": "Wybór API graficznego używanego do renderowania. Pozostaw wartość domyślną, chyba że masz konkretny powód, by ją zmienić!",
	...
	"options.graphicsApi.vulkan": "Preferuj Vulkan (eksperymentalne)",
	"options.guiScale": "Wielkość interfejsu",
	"options.guiScale.auto": "Auto",
	"options.hidden": "Niewidoczny",
	"options.hideLightningFlashes": "Wyłącz rozbłyski nieba",
	"options.hideLightningFlashes.tooltip": "Zapobiega rozbłyskiwaniu nieba przez pioruny lub inne efekty środowiska. Same źródła błysków wciąż będą widoczne.",
	...
	"options.hideSplashTexts": "Ukryj przytytuły",
	"options.hideSplashTexts.tooltip": "Ukryje żółte przytytuły z menu głównego.",
	"options.improvedTransparency": "Ulepszona przejrzystość",
	"options.improvedTransparency.tooltip": "Eksperymentalne podejście wykorzystujące moduły cieniujące ekranu do rysowania pogody, chmur i cząsteczek za półprzezroczystymi blokami i wodą.\nWpłynie to na wydajność procesora graficznego.",
	...
	"options.inactivityFpsLimit": "Zmniejsz liczbę FPS podczas",
	"options.inactivityFpsLimit.afk": "bezczynności",
	"options.inactivityFpsLimit.afk.tooltip": "Ogranicza liczbę klatek na sekundę do 30, jeżeli gra nie otrzymuje żadnych danych wejściowych od gracza przez ponad minutę. Ogranicza ją dalej do 10 po kolejnych 9 minutach.",
	"options.inactivityFpsLimit.minimized": "zminimalizowania",
	"options.inactivityFpsLimit.minimized.tooltip": "Ogranicza liczbę klatek na sekundę tylko wtedy, gdy okno gry jest zminimalizowane.",
	"options.invertMouse": "Odwróć oś myszy",
	"options.invertMouseX": "Odwróć oś myszy w poziomie",
	"options.invertMouseY": "Odwróć oś myszy w pionie",
	"options.japaneseGlyphVariants": "Japońskie warianty glifów",
	"options.japaneseGlyphVariants.tooltip": "Korzysta z japońskich wariantów znaków CJK w domyślnej czcionce",
	...
	"options.language.title": "Język",
	"options.language.tooltip": "Zmień język",
	"options.languageAccuracyWarning": "(Tłumaczenia mogą nie być w 100%% dokładne)",
	...
	"options.maxAnisotropy": "Filtrowanie anizotropowe",
	"options.maxAnisotropy.tooltip": "Każdy poziom znacznie poprawia wygląd gładkich tekstur, ale obniża wydajność i znacząco wpływa na zużycie pamięci wideo. Wymaga ustawienia opcji Filtrowanie tekstur na anizotropowe.",
	...
	"options.musicToast": "Dymek muzyczny",
	"options.musicToast.never": "Nigdy",
	"options.musicToast.never.tooltip": "Dymek muzyczny się nie pokaże.",
	"options.musicToast.pauseMenu": "Menu pauzy",
	"options.musicToast.pauseMenu.tooltip": "Dymek muzyczny jest stale wyświetlany w menu pauzy, dopóki odtwarzana jest muzyka.",
	"options.musicToast.pauseMenuAndToast": "Menu pauzy i dymki",
	"options.musicToast.pauseMenuAndToast.tooltip": "Wyświetla dymek po rozpoczęciu odtwarzania utworu. Taki sam dymek jest stale widoczny w menu pauzy, dopóki odtwarzana jest muzyka.",
	"options.music_frequency": "Częstość muzyki",
	"options.music_frequency.constant": "Stała",
	"options.music_frequency.default": "Domyślna",
	"options.music_frequency.frequent": "Wysoka",
	"options.music_frequency.tooltip": "Zmienia częstotliwość odtwarzania muzyki w świecie gry.",
	...
	"options.needsRestart": "Wymaga ponownego uruchomienia gry, aby zmiany zaczęły obowiązywać.",
	...
	"options.realmsNotifications.tooltip": "Pobiera wiadomości i zaproszenia z Realms na ekranie tytułowym i wyświetla odpowiednią ikonę na przycisku Realms.",
	"options.reducedDebugInfo": "Min. inf. o debugowaniu",
	"options.renderClouds": "Chmury",
	"options.renderCloudsDistance": "Odległość chmur",
	...
	"options.rotateWithMinecart": "Obrót z wagonikiem",
	"options.rotateWithMinecart.tooltip": "Czy widok gracza powinien obracać się wraz z obracającym się wagonikiem. Dostępne tylko w światach z włączonym eksperymentalnym ustawieniem „Ulepszenia wagonika”.",
	...
	"options.showNowPlayingToast": "Pokaż dymek z muzyką",
	"options.showNowPlayingToast.tooltip": "Wyświetla dymek przy początku odtwarzania utworu. Dymek jest stale widoczny w menu pauzy podczas odtwarzania.",
	"options.showSubtitles": "Napisy",
	"options.showSubtitles.tooltip": "Włącza napisy dla dźwięków odtwarzanych w grze.",
	...
	"options.sprintWindow": "Interwał biegu",
	"options.sprintWindow.tooltip": "Czas (w tikach), w którym dwukrotne naciśnięcie klawisza ruchu wprzód włączy bieganie.",
	...
	"options.telemetry.disabled": "Telemetria jest wyłączona.",
	"options.telemetry.state.all": "Wszystkie",
	"options.telemetry.state.minimal": "Minimalne",
	"options.telemetry.state.none": "Żadne",
	"options.textureFiltering": "Filtrowanie tekstur",
	"options.textureFiltering.anisotropic": "Anizotropowe",
	"options.textureFiltering.anisotropic.tooltip": "Sprzętowa metoda filtrowania, mogąca obniżać wydajność i znacząco wpływać na zużycie pamięci wideo. Może nie być obsługiwana na wszystkich urządzeniach.",
	"options.textureFiltering.none": "Brak",
	"options.textureFiltering.none.tooltip": "Tekstury będą wyświetlane bez żadnego filtrowania. Bloki mogą wyglądać na rozmyte, gdy patrzy się na nie pod kątem.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nMetoda filtrowania oparta na shaderze, która poprawia jakość tekstur przy umiarkowanym wpływie na wydajność.",
	"options.title": "Opcje",
	"options.touchscreen": "Tryb ekranu dotykowego",
	"options.value": "%s",
	"options.video": "Ustawienia graficzne…",
	"options.video.display.header": "Wyświetlanie",
	"options.video.interface.header": "Interfejs",
	"options.video.preferences.header": "Preferencje",
	"options.video.quality.header": "Jakość i wydajność",
	"options.videoTitle": "Ustawienia graficzne",
	"options.viewBobbing": "Animacja chodzenia",
	"options.vignette": "Pokazuj winietę",
	"options.vignette.tooltip": "Jest to subtelna tekstura nakładana na ekran gry, służąca do zmniejszenia jasności przy krawędziach ekranu i ostrzegająca o granicy świata.",
	"options.visible": "Widoczne",
	"options.vsync": "Synchronizacja pionowa",
	"options.weatherRadius": "Promień efektów pogodowych",
	"options.weatherRadius.tooltip": "Promień obszaru, na którym widoczne są efekty deszczu i śniegu. Ma bardzo mały wpływ na wydajność.",
	"options.worldOptions.button": "Ustawienia świata…",
	"options.worldOptions.title": "Ustawienia świata",
	"outOfMemory.message": "Minecraftowi skończyła się pamięć.\n\nMoże to być spowodowane błędem w grze lub przydzieleniem niewystarczającej ilości pamięci wirtualnej maszynie Java.\n\nW celu zapobiegnięcia uszkodzeniu świata, bieżąca gra została zamknięta. Próbowaliśmy zwolnić wystarczająco dużo pamięci, by pozwolić na powrót do menu głównego i do gry, ale mogło się to nie udać.\n\nUruchom grę ponownie, jeśli znów zobaczysz ten komunikat.",
	...
	"pack.dropRejected.message": "Następujące paczki były nieprawidłowe i nie zostały przekopiowane:\n %s",
	"pack.dropRejected.title": "Elementy spoza paczki",
	...
	"pack.incompatible.confirm.unknown": "Ta paczka jest uszkodzona lub stworzona dla nieznanej wersji Minecrafta i może nie działać poprawnie.",
	...
	"pack.incompatible.unknown": "(Zepsuta lub niekompatybilna)",
	...
	"painting.minecraft.backyard.title": "Podwórze",
	...
	"painting.minecraft.cavebird.title": "Ptak jaskiniowy",
	...
	"painting.minecraft.passage.title": "Przejście",
	...
	"particle.invalidOptions": "Nie można sparsować opcji cząsteczek: %s",
	...
	"realms.configuration.region.australia_east": "Nowa Południowa Walia, Australia",
	"realms.configuration.region.australia_southeast": "Wiktoria, Australia",
	"realms.configuration.region.brazil_south": "Brazylia",
	...
	"realms.configuration.region.east_us": "Wirginia, USA",
	"realms.configuration.region.east_us_2": "Karolina Północna, USA",
	"realms.configuration.region.france_central": "Francja",
	"realms.configuration.region.japan_east": "Wschodnia Japonia",
	"realms.configuration.region.japan_west": "Zachodnia Japonia",
	"realms.configuration.region.korea_central": "Korea Południowa",
	...
	"realms.configuration.region.sweden_central": "Szwecja",
	"realms.configuration.region.uae_north": "Zjednoczone Emiraty Arabskie (ZEA)",
	"realms.configuration.region.uk_south": "Południowa Anglia",
	"realms.configuration.region.west_central_us": "Utah, USA",
	"realms.configuration.region.west_europe": "Holandia",
	"realms.configuration.region.west_us": "Kalifornia, USA",
	"realms.configuration.region.west_us_2": "Waszyngton, USA",
	"realms.configuration.region_preference.automatic_owner": "Automatyczny (ping właściciela Realmu)",
	"realms.configuration.region_preference.automatic_player": "Automatyczny (pierwszy dołączający do sesji)",
	...
	"recipe.toast.title": "Odblokowano nowe receptury!",
	"record.nowPlaying": "Odtwarzanie: %s",
	"recover_world.bug_tracker": "Zgłoś błąd",
	"recover_world.button": "Spróbuj odzyskać",
	"recover_world.done.failed": "Nie udało się odzyskać z poprzedniego stanu.",
	"recover_world.done.success": "Pomyślnie odzyskano!",
	"recover_world.done.title": "Odzyskiwanie zakończone",
	"recover_world.issue.missing_file": "Brakujący plik",
	"recover_world.issue.none": "Brak problemów",
	"recover_world.message": "Podczas próby odczytania folderu świata „%s” napotkano następujące problemy.\nSpróbuj przywrócić poprzedni stan świata lub zgłoś błąd.",
	"recover_world.no_fallback": "Nie ma dostępnych stanów do odzyskania",
	"recover_world.restore": "Spróbuj przywrócić",
	"recover_world.restoring": "Próba przywrócenia świata…",
	"recover_world.state_entry": "Stan z %s: ",
	"recover_world.state_entry.unknown": "nieznany",
	"recover_world.title": "Nie udało się wczytać świata",
	"recover_world.warning": "Nie udało się załadować informacji o świecie",
	...
	"resourcePack.runtime_failure": "Wykryto błąd paczki zasobów",
	...
	"restrictions_screen.button": "Ograniczenia…",
	"restrictions_screen.permission.receive_player_messages.allowed": "Możesz otrzymywać wiadomości od graczy",
	"restrictions_screen.permission.receive_player_messages.denied": "Nie możesz otrzymywać wiadomości od graczy",
	"restrictions_screen.permission.receive_system_messages.allowed": "Możesz otrzymywać komunikaty systemowe z serwera",
	"restrictions_screen.permission.receive_system_messages.denied": "Nie możesz otrzymywać komunikatów systemowych z serwera",
	"restrictions_screen.permission.send_commands.allowed": "Możesz wysyłać polecenia",
	"restrictions_screen.permission.send_commands.denied": "Nie możesz wysyłać poleceń",
	"restrictions_screen.permission.send_messages.allowed": "Możesz wysyłać wiadomości na czacie",
	"restrictions_screen.permission.send_messages.denied": "Nie możesz wysyłać wiadomości na czacie",
	"restrictions_screen.title": "Ograniczenia",
	...
	"selectWorld.allowCommands.new": "Zezwalaj na polecenia",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Czy utworzyć kopię zapasową przed aktualizacją tego świata?",
	...
	"selectWorld.backupWarning.downgrade": "Ten świat był ostatnio otwierany w wersji %s, a obecnie używasz wersji %s. Obniżenie wersji świata może spowodować jego uszkodzenie — nie możemy zagwarantować, że się załaduje, ani że będzie działać. Wykonaj kopię zapasową!",
	...
	"selectWorld.backupWarning.file_fixing_required": "Ten świat musi zostać zaktualizowany, zanim będzie można na nim grać. Na wypadek uszkodzenia świata, przed kontynuowaniem radzimy utworzyć kopię zapasową.",
	...
	"selectWorld.commands": "Polecenia",
	...
	"selectWorld.incompatible.description": "Ten świat nie może zostać otwarty na tej wersji.\nOstatnio grano na nim na wersji %s.",
	"selectWorld.incompatible.info": "Niezgodna wersja: %s",
	"selectWorld.incompatible.title": "Niezgodna wersja",
	"selectWorld.incompatible.tooltip": "Nie można otworzyć tego świata, ponieważ został on stworzony przez niezgodną wersję.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Ze względu na zasadnicze zmiany w formacie świata, przed edytowaniem należy zaktualizować go do najnowszej wersji.",
	"selectWorld.requiresFileFixingTooltip.play": "Ze względu na zasadnicze zmiany w formacie świata, przed rozpoczęciem gry należy zaktualizować go do najnowszej wersji.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Ze względu na zasadnicze zmiany w formacie świata, przed odtworzeniem go należy zaktualizować go do najnowszej wersji.",
	"selectWorld.resource_load": "Przygotowywanie zasobów…",
	...
	"selectWorld.upgrade_and_play": "Zaktualizuj i graj",
	...
	"selectWorld.waitingForBackup.message": "W zależności od rozmiaru świata może to trochę potrwać. Nie zamykaj gry i nie wyłączaj urządzenia.",
	"selectWorld.waitingForBackup.title": "Tworzenie kopii zapasowej",
	...
	"selectWorld.warning.lowDiskSpace.description": "Na urządzeniu pozostało niewiele wolnego miejsca.\nWyczerpanie się miejsca na dysku podczas gry może doprowadzić do uszkodzenia świata.",
	"selectWorld.warning.lowDiskSpace.title": "Uwaga! Mało miejsca na dysku!",
	"selectWorld.world": "Świat",
	"selectWorld.world_gen_settings_access": "Nie można odczytać lub uzyskać dostępu do pliku ustawień generowania świata! %s",
	"selecteWorld.backupRequiredTooltip": "Przed wczytaniem świata należy utworzyć kopię zapasową",
	...
	"slot.only_single_allowed": "Dozwolone są tylko pojedyncze pola: otrzymano „%s”",
	"slot.unknown": "Nieznane pole: „%s”",
	"snbt.parser.empty_key": "Klucz nie może być pusty",
	"snbt.parser.expected_binary_numeral": "Oczekiwano liczby dwójkowej",
	"snbt.parser.expected_decimal_numeral": "Oczekiwano liczby dziesiętnej",
	"snbt.parser.expected_float_type": "Oczekiwano liczby zmiennoprzecinkowej",
	"snbt.parser.expected_hex_escape": "Oczekiwano literału znakowego o długości %s",
	"snbt.parser.expected_hex_numeral": "Oczekiwano liczby szesnastkowej",
	"snbt.parser.expected_integer_type": "Oczekiwano liczby całkowitej",
	"snbt.parser.expected_non_negative_number": "Oczekiwano liczby nieujemnej",
	"snbt.parser.expected_number_or_boolean": "Oczekiwano liczby lub wartości logicznej",
	"snbt.parser.expected_string_uuid": "Oczekiwano ciągu znaków reprezentującego prawidłowy UUID",
	"snbt.parser.expected_unquoted_string": "Oczekiwano prawidłowego ciągu bez cudzysłowu",
	"snbt.parser.infinity_not_allowed": "Niedozwolone są liczby nieskończone",
	"snbt.parser.invalid_array_element_type": "Nieprawidłowy typ elementu tablicy",
	"snbt.parser.invalid_character_name": "Nieprawidłowa nazwa znaku Unicode",
	"snbt.parser.invalid_codepoint": "Nieprawidłowa wartość znaku Unicode: %s",
	"snbt.parser.invalid_string_contents": "Nieprawidłowa zawartość ciągu",
	"snbt.parser.invalid_unquoted_start": "Ciągi bez cudzysłowu nie mogą zaczynać się od cyfr 0–9, + lub -",
	"snbt.parser.leading_zero_not_allowed": "Liczby dziesiętne nie mogą zaczynać się od 0",
	"snbt.parser.no_such_operation": "Brak takiej operacji: %s",
	"snbt.parser.number_parse_failure": "Nie udało się przeanalizować liczby: %s",
	"snbt.parser.undescore_not_allowed": "Znaki podkreślenia nie są dozwolone na początku ani końcu liczby",
	...
	"soundCategory.voice": "Narrator/Głos",
	...
	"stat.minecraft.aviate_one_cm": "Dystans przebyty szybując",
	"stat.minecraft.bell_ring": "Uderzeń w dzwon",
	"stat.minecraft.boat_one_cm": "Dystans przebyty łódką",
	...
	"stat.minecraft.climb_one_cm": "Dystans przebyty wspinając się",
	"stat.minecraft.crouch_one_cm": "Dystans przebyty skradając się",
	...
	"stat.minecraft.damage_dealt_absorbed": "Zadanych obrażeń (pochłoniętych)",
	...
	"stat.minecraft.fall_one_cm": "Dystans przebyty spadając",
	"stat.minecraft.fill_cauldron": "Wypełnionych kotłów",
	"stat.minecraft.fish_caught": "Złowionych ryb",
	"stat.minecraft.fly_one_cm": "Dystans przebyty lecąc",
	"stat.minecraft.happy_ghast_one_cm": "Odległość przebyta na wesołym ghaście",
	"stat.minecraft.horse_one_cm": "Dystans przebyty na koniu",
	...
	"stat.minecraft.minecart_one_cm": "Dystans przebyty w wagoniku",
	"stat.minecraft.mob_kills": "Zabitych stworzeń",
	"stat.minecraft.nautilus_one_cm": "Dystans przebyty na łodziku",
	...
	"stat.minecraft.pig_one_cm": "Dystans przebyty na świni",
	...
	"stat.minecraft.sprint_one_cm": "Dystans przebyty sprintując",
	"stat.minecraft.strider_one_cm": "Dystans przebyty na magmołazie",
	"stat.minecraft.swim_one_cm": "Dystans przebyty wpław",
	...
	"stat.minecraft.walk_on_water_one_cm": "Dystans przebyty idąc po wodzie",
	"stat.minecraft.walk_one_cm": "Dystans przebyty idąc",
	"stat.minecraft.walk_under_water_one_cm": "Dystans przebyty idąc pod wodą",
	...
	"structure_block.strict": "Ścisłe umieszczenie:",
	"structure_block.structure_name": "Nazwa struktury",
	"subtitles.ambient.cave": "Dziwny dźwięk",
	"subtitles.ambient.sound": "Niepokojący dźwięk",
	...
	"subtitles.block.candle.extinguish": "Świeca gaśnie",
	...
	"subtitles.block.copper_bulb.turn_off": "Miedziana lampa się wyłącza",
	"subtitles.block.copper_bulb.turn_on": "Miedziana lampa się włącza",
	"subtitles.block.copper_chest.close": "Skrzynia się zamyka",
	"subtitles.block.copper_chest.open": "Skrzynia się otwiera",
	"subtitles.block.copper_trapdoor.close": "Klapa się zamyka",
	"subtitles.block.copper_trapdoor.open": "Klapa się otwiera",
	"subtitles.block.crafter.craft": "Wytwarzacz wytworzył",
	"subtitles.block.crafter.fail": "Wytwarzacz nie zadziałał",
	"subtitles.block.creaking_heart.hurt": "Trzeszczące serce krzyczy",
	"subtitles.block.creaking_heart.idle": "Niepokojący dźwięk",
	"subtitles.block.creaking_heart.spawn": "Trzeszczące serce zbudza się",
	"subtitles.block.deadbush.idle": "Suche dźwięki",
	"subtitles.block.decorated_pot.insert": "Garniec napełnia się",
	"subtitles.block.decorated_pot.insert_fail": "Garniec się chwieje",
	"subtitles.block.decorated_pot.shatter": "Garniec rozbija się",
	...
	"subtitles.block.dried_ghast.ambient": "Dźwięki suchości",
	"subtitles.block.dried_ghast.ambient_water": "Wyschnięty ghast nawadnia się",
	"subtitles.block.dried_ghast.place_in_water": "Wyschnięty ghast namaka",
	"subtitles.block.dried_ghast.transition": "Wyschnięty ghast czuje się lepiej",
	"subtitles.block.dry_grass.ambient": "Wietrzne dźwięki",
	"subtitles.block.enchantment_table.use": "Użycie stołu do zaklinania",
	...
	"subtitles.block.eyeblossom.close": "Okrotka zamyka się",
	"subtitles.block.eyeblossom.idle": "Okrotka szepcze",
	"subtitles.block.eyeblossom.open": "Okrotka otwiera się",
	...
	"subtitles.block.firefly_bush.idle": "Świetliki świerczą",
	...
	"subtitles.block.generic.fall": "Coś spada na blok",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Znak chwieje się",
	...
	"subtitles.block.pale_hanging_moss.idle": "Niepokojący dźwięk",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Siarkowy gejzer wybucha",
	"subtitles.block.potent_sulfur.noxious_gas": "Szkodliwy gaz ulatnia się",
	...
	"subtitles.block.respawn_anchor.ambient": "Kotwica odrodzenia huczy",
	...
	"subtitles.block.sand.idle": "Piaszczyste dźwięki",
	"subtitles.block.sand.wind": "Wietrzne dźwięki",
	...
	"subtitles.block.sculk_sensor.clicking": "Sculkowy czujnik drga",
	...
	"subtitles.block.shelf.activate": "Aktywacja półki",
	"subtitles.block.shelf.deactivate": "Dezaktywacja półki",
	"subtitles.block.shelf.multi_swap": "Podmiana przedmiotów",
	"subtitles.block.shelf.place_item": "Umieszczenie przedmiotu",
	"subtitles.block.shelf.single_swap": "Podmiana przedmiotu",
	"subtitles.block.shelf.take_item": "Wzięto przedmiot",
	"subtitles.block.shulker_box.close": "Shulkerowa skrzynia zamyka się",
	"subtitles.block.shulker_box.open": "Shulkerowa skrzynia otwiera się",
	...
	"subtitles.block.sponge.absorb": "Gąbka nasiąka",
	"subtitles.block.sweet_berry_bush.pick_berries": "Zrywanie jagód",
	"subtitles.block.trapdoor.close": "Klapa się zamyka",
	"subtitles.block.trapdoor.open": "Klapa się otwiera",
	"subtitles.block.trapdoor.toggle": "Klapa skrzypi",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Przygotowanie złowieszczego przedmiotu",
	"subtitles.block.trial_spawner.ambient": "Przyzywacz prób trzaska",
	"subtitles.block.trial_spawner.ambient_charged": "Złowieszcze trzaskanie",
	"subtitles.block.trial_spawner.ambient_ominous": "Złowieszcze trzaskanie",
	"subtitles.block.trial_spawner.charge_activate": "Omen ogarnia przyzywacz prób",
	"subtitles.block.trial_spawner.close_shutter": "Przyzywacz prób zamyka się",
	"subtitles.block.trial_spawner.detect_player": "Przyzywacz prób ładuje się",
	"subtitles.block.trial_spawner.eject_item": "Przyzywacz prób wyrzuca przedmioty",
	"subtitles.block.trial_spawner.ominous_activate": "Omen ogarnia przyzywacz prób",
	"subtitles.block.trial_spawner.open_shutter": "Przyzywacz prób otwiera się",
	"subtitles.block.trial_spawner.spawn_item": "Złowieszczy przedmiot upada",
	"subtitles.block.trial_spawner.spawn_item_begin": "Złowieszczy przedmiot pojawia się",
	"subtitles.block.trial_spawner.spawn_mob": "Przyzywanie stworzenia",
	...
	"subtitles.block.vault.activate": "Skarbiec się zapala",
	"subtitles.block.vault.ambient": "Skarbiec trzaska",
	"subtitles.block.vault.close_shutter": "Skarbiec się zamyka",
	"subtitles.block.vault.deactivate": "Skarbiec gaśnie",
	"subtitles.block.vault.eject_item": "Skarbiec wyrzuca przedmiot",
	"subtitles.block.vault.insert_item": "Skarbiec się odblokowuje",
	"subtitles.block.vault.insert_item_fail": "Skarbiec odrzuca przedmiot",
	"subtitles.block.vault.open_shutter": "Skarbiec się otwiera",
	"subtitles.block.vault.reject_rewarded_player": "Skarbiec odrzuca gracza",
	"subtitles.block.water.ambient": "Woda płynie",
	"subtitles.block.wet_sponge.dries": "Gąbka wysycha",
	...
	"subtitles.entity.armadillo.ambient": "Pancernik chrząka",
	"subtitles.entity.armadillo.brush": "Szczotkowanie pancernika",
	"subtitles.entity.armadillo.death": "Pancernik ginie",
	"subtitles.entity.armadillo.eat": "Pancernik je",
	"subtitles.entity.armadillo.hurt": "Pancernik cierpi",
	"subtitles.entity.armadillo.hurt_reduced": "Pancernik broni się",
	"subtitles.entity.armadillo.land": "Pancernik upada",
	"subtitles.entity.armadillo.peek": "Pancernik zerka",
	"subtitles.entity.armadillo.roll": "Pancernik zwija się",
	"subtitles.entity.armadillo.scute_drop": "Pancernik upuszcza tarczkę",
	"subtitles.entity.armadillo.unroll_finish": "Pancernik rozwija się",
	"subtitles.entity.armadillo.unroll_start": "Pancernik zerka",
	...
	"subtitles.entity.baby_cat.ambient": "Kocię miauczy",
	"subtitles.entity.baby_cat.beg_for_food": "Kocię prosi",
	"subtitles.entity.baby_cat.death": "Kocię ginie",
	"subtitles.entity.baby_cat.eat": "Kocię je",
	"subtitles.entity.baby_cat.hiss": "Kocię syczy",
	"subtitles.entity.baby_cat.hurt": "Kocię cierpi",
	"subtitles.entity.baby_cat.purr": "Kocię mruczy",
	"subtitles.entity.baby_chicken.ambient": "Kurczątko piuka",
	"subtitles.entity.baby_chicken.death": "Kurczątko ginie",
	"subtitles.entity.baby_chicken.hurts": "Kurczątko cierpi",
	"subtitles.entity.baby_horse.ambient": "Źrebak rży",
	"subtitles.entity.baby_horse.angry": "Źrebak rży",
	"subtitles.entity.baby_horse.breathe": "Źrebak parska",
	"subtitles.entity.baby_horse.death": "Źrebak ginie",
	"subtitles.entity.baby_horse.eat": "Źrebak je",
	"subtitles.entity.baby_horse.hurt": "Źrebak cierpi",
	"subtitles.entity.baby_horse.land": "Źrebak upada",
	"subtitles.entity.baby_nautilus.ambient": "Mały łodzik popiskuje",
	"subtitles.entity.baby_nautilus.ambient_land": "Mały łodzik popiskuje",
	"subtitles.entity.baby_nautilus.death": "Mały łodzik ginie",
	"subtitles.entity.baby_nautilus.death_land": "Mały łodzik ginie",
	"subtitles.entity.baby_nautilus.eat": "Mały łodzik je",
	"subtitles.entity.baby_nautilus.hurt": "Mały łodzik cierpi",
	"subtitles.entity.baby_nautilus.hurt_land": "Mały łodzik cierpi",
	"subtitles.entity.baby_nautilus.swim": "Mały łodzik pływa",
	"subtitles.entity.baby_pig.ambient": "Prosiak chrumka",
	"subtitles.entity.baby_pig.death": "Prosiak ginie",
	"subtitles.entity.baby_pig.eat": "Prosiak je",
	"subtitles.entity.baby_pig.hurt": "Prosiak cierpi",
	"subtitles.entity.baby_wolf.ambient": "Szczeniak szczeka",
	"subtitles.entity.baby_wolf.death": "Szczeniak ginie",
	"subtitles.entity.baby_wolf.growl": "Szczeniak warczy",
	"subtitles.entity.baby_wolf.hurt": "Szczeniak cierpi",
	"subtitles.entity.baby_wolf.pant": "Szczeniak sapie",
	"subtitles.entity.baby_wolf.whine": "Szczeniak skomle",
	...
	"subtitles.entity.bogged.ambient": "Bagniak klekocze",
	"subtitles.entity.bogged.death": "Bagniak ginie",
	"subtitles.entity.bogged.hurt": "Bagniak cierpi",
	"subtitles.entity.breeze.charge": "Wichrzyk ładuje się",
	"subtitles.entity.breeze.death": "Wichrzyk ginie",
	"subtitles.entity.breeze.deflect": "Wichrzyk odbija",
	"subtitles.entity.breeze.hurt": "Wichrzyk cierpi",
	"subtitles.entity.breeze.idle_air": "Wichrzyk lata",
	"subtitles.entity.breeze.idle_ground": "Wichrzyk warkocze",
	"subtitles.entity.breeze.inhale": "Wichrzyk wdycha",
	"subtitles.entity.breeze.jump": "Wichrzyk skacze",
	"subtitles.entity.breeze.land": "Wichrzyk upada",
	"subtitles.entity.breeze.shoot": "Wichrzyk strzela",
	"subtitles.entity.breeze.slide": "Wichrzyk ślizga się",
	"subtitles.entity.breeze.whirl": "Wichrzyk wiruje",
	"subtitles.entity.breeze.wind_burst": "Wietrzna kula wybucha",
	...
	"subtitles.entity.camel_husk.ambient": "Wielbłąd-posuch burczy",
	"subtitles.entity.camel_husk.dash": "Wielbłąd-posuch susa",
	"subtitles.entity.camel_husk.dash_ready": "Wielbłąd-posuch nabiera sił",
	"subtitles.entity.camel_husk.death": "Wielbłąd-posuch ginie",
	"subtitles.entity.camel_husk.eat": "Wielbłąd-posuch je",
	"subtitles.entity.camel_husk.hurt": "Wielbłąd-posuch cierpi",
	"subtitles.entity.camel_husk.saddle": "Zakładanie siodła",
	"subtitles.entity.camel_husk.sit": "Wielbłąd-posuch siada",
	"subtitles.entity.camel_husk.stand": "Wielbłąd-posuch wstaje",
	...
	"subtitles.entity.copper_golem.death": "Miedziany golem ginie",
	"subtitles.entity.copper_golem.hurt": "Miedziany golem cierpi",
	"subtitles.entity.copper_golem.item_drop": "Miedziany golem umieszcza przedmiot",
	"subtitles.entity.copper_golem.item_no_drop": "Miedziany golem nie może umieścić przedmiotu",
	"subtitles.entity.copper_golem.no_item_get": "Miedziany golem podnosi przedmiot",
	"subtitles.entity.copper_golem.no_item_no_get": "Miedziany golem nie może podnieść przedmiotu",
	"subtitles.entity.copper_golem.spawn": "Miedziany golem pojawia się",
	"subtitles.entity.copper_golem.spin": "Miedziany golem obraca głową",
	"subtitles.entity.copper_golem_become_statue": "Miedziany golem kamienieje",
	"subtitles.entity.copper_golem_oxidized.death": "Miedziany golem ginie",
	"subtitles.entity.copper_golem_oxidized.hurt": "Miedziany golem cierpi",
	"subtitles.entity.copper_golem_oxidized.spin": "Miedziany golem obraca głową",
	"subtitles.entity.copper_golem_weathered.death": "Miedziany golem ginie",
	"subtitles.entity.copper_golem_weathered.hurt": "Miedziany golem cierpi",
	"subtitles.entity.copper_golem_weathered.spin": "Miedziany golem obraca głową",
	...
	"subtitles.entity.creaking.activate": "Trzeszcz patrzy",
	"subtitles.entity.creaking.ambient": "Trzeszcz trzeszczy",
	"subtitles.entity.creaking.attack": "Trzeszcz atakuje",
	"subtitles.entity.creaking.deactivate": "Trzeszcz uspokaja się",
	"subtitles.entity.creaking.death": "Trzeszcz rozpada się",
	"subtitles.entity.creaking.freeze": "Trzeszcz staje",
	"subtitles.entity.creaking.spawn": "Trzeszcz powstaje",
	"subtitles.entity.creaking.sway": "Trzeszcz chroni się",
	"subtitles.entity.creaking.twitch": "Trzeszcz drga",
	"subtitles.entity.creaking.unfreeze": "Trzeszcz idzie",
	...
	"subtitles.entity.donkey.jump": "Osioł skacze",
	...
	"subtitles.entity.ender_eye.launch": "Rzut okiem Endera",
	...
	"subtitles.entity.fish.swim": "Pluskanie",
	...
	"subtitles.entity.generic.wind_burst": "Wietrzna kula wybucha",
	...
	"subtitles.entity.ghastling.ambient": "Ghaściątko gaworzy",
	"subtitles.entity.ghastling.death": "Ghaściątko ginie",
	"subtitles.entity.ghastling.hurt": "Ghaściątko cierpi",
	"subtitles.entity.ghastling.spawn": "Ghaściątko pojawia się",
	"subtitles.entity.glow_item_frame.add_item": "Wypełnienie świecącej ramki na przedmiot",
	"subtitles.entity.glow_item_frame.break": "Lśniąca ramka na przedmiot niszczy się",
	...
	"subtitles.entity.happy_ghast.ambient": "Wesoły ghast nuci",
	"subtitles.entity.happy_ghast.death": "Wesoły ghast ginie",
	"subtitles.entity.happy_ghast.equip": "Zakładanie uprzęży",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Wesoły ghast w gotowości",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Wesoły ghast zatrzymuje się",
	"subtitles.entity.happy_ghast.hurt": "Wesoły ghast cierpi",
	"subtitles.entity.happy_ghast.unequip": "Zdejmowanie uprzęży",
	...
	"subtitles.entity.item_frame.break": "Ramka na przedmiot niszczy się",
	...
	"subtitles.entity.minecart.inside": "Wagonik pobrzękuje",
	"subtitles.entity.minecart.inside_underwater": "Wagonik pobrzękuje pod wodą",
	...
	"subtitles.entity.mule.jump": "Muł skacze",
	"subtitles.entity.nautilus.ambient": "Łodzik stuka",
	"subtitles.entity.nautilus.ambient_land": "Łodzik stuka",
	"subtitles.entity.nautilus.dash": "Łodzik mknie",
	"subtitles.entity.nautilus.dash_land": "Łodzik mknie",
	"subtitles.entity.nautilus.dash_ready": "Łodzik nabiera sił",
	"subtitles.entity.nautilus.dash_ready_land": "Łodzik nabiera sił",
	"subtitles.entity.nautilus.death": "Łodzik ginie",
	"subtitles.entity.nautilus.death_land": "Łodzik ginie",
	"subtitles.entity.nautilus.eat": "Łodzik je",
	"subtitles.entity.nautilus.hurt": "Łodzik cierpi",
	"subtitles.entity.nautilus.hurt_land": "Łodzik cierpi",
	"subtitles.entity.nautilus.swim": "Łodzik pływa",
	...
	"subtitles.entity.parched.ambient": "Oschlak klekocze",
	"subtitles.entity.parched.death": "Oschlak ginie",
	"subtitles.entity.parched.hurt": "Oschlak cierpi",
	...
	"subtitles.entity.parrot.imitate.bogged": "Papuga klekocze",
	"subtitles.entity.parrot.imitate.breeze": "Papuga warkocze",
	"subtitles.entity.parrot.imitate.camel_husk": "Papuga gdera",
	"subtitles.entity.parrot.imitate.creaking": "Papuga trzeszczy",
	...
	"subtitles.entity.parrot.imitate.parched": "Papuga klekocze",
	...
	"subtitles.entity.parrot.imitate.zombie": "Papuga charczy",
	"subtitles.entity.parrot.imitate.zombie_horse": "Papuga charczy",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Papuga bulgocze",
	...
	"subtitles.entity.pig.eat": "Świnia je",
	...
	"subtitles.entity.player.teleport": "Gracz teleportuje się",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Koń-szkielet skacze",
	...
	"subtitles.entity.sulfur_cube.absorb": "Kostka siarki pochłania",
	"subtitles.entity.sulfur_cube.bounce": "Kostka siarki odbija się",
	"subtitles.entity.sulfur_cube.death": "Kostka siarki ginie",
	"subtitles.entity.sulfur_cube.eject": "Blok wypada",
	"subtitles.entity.sulfur_cube.hit": "Kostka siarki zostaje uderzona",
	"subtitles.entity.sulfur_cube.hurt": "Kostka siarki cierpi",
	"subtitles.entity.sulfur_cube.push": "Kostka siarki zostaje pchnięta",
	"subtitles.entity.sulfur_cube.squish": "Kostka siarki odbija się",
	...
	"subtitles.entity.wind_charge.throw": "Wietrzna kula leci",
	"subtitles.entity.wind_charge.wind_burst": "Wietrzna kula wybucha",
	...
	"subtitles.entity.zombie_horse.angry": "Koń-zombie rży",
	"subtitles.entity.zombie_horse.death": "Koń-zombie ginie",
	"subtitles.entity.zombie_horse.eat": "Koń-zombie je",
	"subtitles.entity.zombie_horse.hurt": "Koń-zombie cierpi",
	"subtitles.entity.zombie_nautilus.ambient": "Łodzik-zombie bulgocze",
	"subtitles.entity.zombie_nautilus.ambient_land": "Łodzik-zombie bulgocze",
	"subtitles.entity.zombie_nautilus.dash": "Łodzik-zombie mknie",
	"subtitles.entity.zombie_nautilus.dash_land": "Łodzik-zombie mknie",
	"subtitles.entity.zombie_nautilus.dash_ready": "Łodzik-zombie nabiera sił",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Łodzik-zombie nabiera sił",
	"subtitles.entity.zombie_nautilus.death": "Łodzik-zombie ginie",
	"subtitles.entity.zombie_nautilus.death_land": "Łodzik-zombie ginie",
	"subtitles.entity.zombie_nautilus.eat": "Łodzik-zombie je",
	"subtitles.entity.zombie_nautilus.hurt": "Łodzik-zombie cierpi",
	"subtitles.entity.zombie_nautilus.hurt_land": "Łodzik-zombie cierpi",
	"subtitles.entity.zombie_nautilus.swim": "Łodzik-zombie pływa",
	...
	"subtitles.event.mob_effect.bad_omen": "Omen ogarnia gracza",
	"subtitles.event.mob_effect.raid_omen": "W pobliżu szykuje się najazd",
	"subtitles.event.mob_effect.trial_omen": "W pobliżu szykuje się złowieszcza próba",
	...
	"subtitles.item.armor.equip_copper": "Miedziana zbroja łomocze",
	...
	"subtitles.item.armor.equip_nautilus": "Zakładanie zbroi łodzika",
	"subtitles.item.armor.equip_netherite": "Netherytowa zbroja brzęczy",
	"subtitles.item.armor.equip_turtle": "Żółwia skorupa dudni",
	"subtitles.item.armor.equip_wolf": "Przymocowanie wilczej zbroi",
	"subtitles.item.armor.unequip_nautilus": "Zdejmowanie zbroi łodzika",
	"subtitles.item.armor.unequip_wolf": "Wilcza zbroja ześlizguje się",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Kostka siarki została zagarnięta",
	...
	"subtitles.item.bundle.insert_fail": "Pełna sakwa",
	...
	"subtitles.item.elytra.flying": "Szum",
	...
	"subtitles.item.golden_dandelion.unuse": "Złoty mlecz wznawia proces starzenia",
	"subtitles.item.golden_dandelion.use": "Złoty mlecz wstrzymuje proces starzenia",
	"subtitles.item.hoe.till": "Motyka orze",
	"subtitles.item.honey_bottle.drink": "Łykanie",
	"subtitles.item.honeycomb.wax_on": "Woskowanie",
	"subtitles.item.horse_armor.unequip": "Zbroja końska ześlizguje się",
	"subtitles.item.ink_sac.use": "Torbiel z atramentem barwi",
	"subtitles.item.lead.break": "Lina pęka",
	"subtitles.item.lead.tied": "Zawiązanie liny",
	"subtitles.item.lead.untied": "Odwiązanie liny",
	"subtitles.item.llama_carpet.unequip": "Dywan ześlizguje się",
	"subtitles.item.lodestone_compass.lock": "Magnetytowy kompas namierza magnetyt",
	"subtitles.item.mace.smash_air": "Buzdygan rozbija",
	"subtitles.item.mace.smash_ground": "Buzdygan rozbija",
	"subtitles.item.nautilus_saddle_equip": "Zakładanie siodła",
	"subtitles.item.nautilus_saddle_underwater_equip": "Zakładanie siodła",
	"subtitles.item.nether_wart.plant": "Zasadzenie brodawki",
	"subtitles.item.ominous_bottle.dispose": "Butelka się tłucze",
	"subtitles.item.saddle.unequip": "Siodło ześlizguje się",
	"subtitles.item.shears.shear": "Nożyce szczękają",
	"subtitles.item.shears.snip": "Nożyce tną",
	"subtitles.item.shield.block": "Tarcza blokuje",
	"subtitles.item.shovel.flatten": "Łopata wyrównuje teren",
	"subtitles.item.spear.attack": "Włócznia dźga",
	"subtitles.item.spear.hit": "Włócznia uderza",
	"subtitles.item.spear.lunge": "Pchnięcie włóczni",
	"subtitles.item.spear.use": "Naciera z włócznią",
	"subtitles.item.spear_wood.attack": "Włócznia dźga",
	"subtitles.item.spear_wood.hit": "Włócznia uderza",
	"subtitles.item.spear_wood.use": "Naciera z włócznią",
	...
	"subtitles.item.underwater_saddle.equip": "Założenie siodła",
	"subtitles.item.wolf_armor.break": "Wilcza zbroja się niszczy",
	"subtitles.item.wolf_armor.crack": "Wilcza zbroja pęka",
	"subtitles.item.wolf_armor.damage": "Wilcza zbroja otrzymuje obrażenia",
	"subtitles.item.wolf_armor.repair": "Naprawianie wilczej zbroi",
	"subtitles.particle.soul_escape": "Dusza ucieka",
	"subtitles.ui.cartography_table.take_result": "Przerysowanie mapy",
	"subtitles.ui.hud.bubble_pop": "Wskaźnik oddechu spada",
	"subtitles.ui.loom.take_result": "Użycie krosna",
	"subtitles.ui.stonecutter.take_result": "Użycie przecinarki",
	"subtitles.weather.end_flash": "Rozbłysk nieba Endu",
	"subtitles.weather.rain": "Pada deszcz",
	"symlink_warning.message": "Ładowanie światów z folderów zawierających dowiązania symboliczne może być niebezpieczne, jeżeli nie wiesz, co dokładnie robisz. Proszę odwiedzić %s w celu zapoznania się.",
	"symlink_warning.message.pack": "Ładowanie paczek z dowiązaniami symbolicznymi może być niebezpieczne, jeżeli nie wiesz, co dokładnie robisz. Odwiedź %s, aby dowiedzieć się więcej.",
	"symlink_warning.message.world": "Ładowanie światów z folderów z dowiązaniami symbolicznymi może być niebezpieczne, jeśli nie wiesz dokładnie, co robisz. Więcej informacji można znaleźć na stronie %s.",
	"symlink_warning.more_info": "Więcej informacji",
	"symlink_warning.title": "Folder świata zawiera dowiązania symboliczne",
	"symlink_warning.title.pack": "Dodane paczki zawierają dowiązania symboliczne",
	"symlink_warning.title.world": "Folder świata zawiera dowiązania symboliczne",
	...
	"telemetry.event.advancement_made.description": "Zrozumienie kontekstu stojącego za zdobywaniem postępów pozwala nam lepiej rozumieć i rozwijać grę.",
	"telemetry.event.advancement_made.title": "Postęp dokonany",
	"telemetry.event.game_load_times.description": "Ten parametr pomaga nam dostrzec, gdzie należy poprawić wydajność podczas ładowania gry.",
	"telemetry.event.game_load_times.title": "Czas ładowania gry",
	"telemetry.event.graphics_capabilities.description": "To zdarzenie dostarcza informacji o możliwościach urządzenia graficznego używanego do obsługi gry.",
	"telemetry.event.graphics_capabilities.title": "Możliwości graficzne",
	"telemetry.event.optional": "%s (nieobowiązkowe)",
	"telemetry.event.optional.disabled": "%s (opcjonalne) — wyłączone",
	...
	"telemetry.property.backend_failure_message.title": "Komunikat o błędzie tworzenia back-endu",
	"telemetry.property.backend_failure_missing_capabilities.title": "Brakujące możliwości przy błędzie tworzenia back-endu",
	"telemetry.property.backend_failure_reason.title": "Przyczyna błędu tworzenia back-endu",
	"telemetry.property.backend_name.title": "Nazwa API graficznego",
	...
	"telemetry_info.button.privacy_statement": "Oświadczenie o ochronie prywatności",
	"telemetry_info.button.show_data": "Otwórz moje dane",
	"telemetry_info.opt_in.description": "Wyrażam zgodę na przesyłanie opcjonalnych danych telemetrycznych",
	...
	"test.error.block_property_mismatch": "Oczekiwano, by właściwość %s miała wartość %s: była wartość %s",
	"test.error.block_property_missing": "Brakuje właściwości bloku. Oczekiwano właściwości %s jako %s",
	"test.error.entity_property": "Byt %s zawiódł test: %s",
	"test.error.entity_property_details": "Byt %s zawiódł test: %s. Oczekiwano %s: było %s",
	"test.error.expected_block": "Oczekiwano bloku %s: otrzymano %s",
	"test.error.expected_block_present": "Brak oczekiwanego bloku %s",
	"test.error.expected_block_tag": "Oczekiwano bloku objętego #%s: otrzymano %s",
	"test.error.expected_container_contents": "Pojemnik powinien zawierać: %s",
	"test.error.expected_container_contents_single": "Pojemnik powinien zawierać tylko jeden przedmiot typu %s",
	"test.error.expected_empty_container": "Pojemnik powinien być pusty",
	"test.error.expected_entity": "Oczekiwano: „%s”",
	"test.error.expected_entity_around": "Oczekiwano istnienia %s wokół %s, %s, %s",
	"test.error.expected_entity_count": "Oczekiwano %s bytów rodzaju %s: znaleziono %s",
	"test.error.expected_entity_data": "Oczekiwano, że dane bytu będą: %s, były: %s",
	"test.error.expected_entity_data_predicate": "Niezgodność danych jednostki dla predykatu %s",
	"test.error.expected_entity_effect": "Oczekiwano u bytu %s obecności efektu %s %s",
	"test.error.expected_entity_having": "Ekwipunek bytu powinien zawierać przedmiot: %s",
	"test.error.expected_entity_holding": "Byt powinien trzymać przedmiot: %s",
	"test.error.expected_entity_in_test": "Oczekiwano, że w teście będzie istnieć byt typu %s",
	"test.error.expected_entity_not_touching": "Nie oczekiwano nachodzenia %s na pozycję %s, %s, %s (względnie: %s, %s, %s)",
	"test.error.expected_entity_touching": "Oczekiwano nachodzenia %s na pozycję %s, %s, %s (względnie: %s, %s, %s)",
	"test.error.expected_item": "Oczekiwano elementu rodzaju %s",
	"test.error.expected_items_count": "Oczekiwano %s przedmiotów rodzaju %s; znaleziono %s",
	"test.error.fail": "Spełnione warunki niepowodzenia",
	"test.error.invalid_block_type": "Znaleziono nieoczekiwany rodzaj bloku: %s",
	"test.error.missing_block_entity": "Brakujący blok z danymi",
	"test.error.not_a_block_item": "Podany blok nie jest przedmiotem",
	"test.error.position": "%s na pozycji %s, %s, %s (względnie: %s, %s, %s) przy tiku %s",
	"test.error.sequence.condition_already_triggered": "Warunek został już spełniony o %s",
	"test.error.sequence.condition_not_triggered": "Nie spełniono warunku",
	"test.error.sequence.invalid_tick": "Powiodło się w nieprawidłowym tiku: oczekiwano %s",
	"test.error.sequence.minimum_tick": "Powiodło się przed oczekiwanym tikiem: oczekiwano %s",
	"test.error.sequence.not_completed": "Test przekroczył limit czasu przed ukończeniem sekwencji",
	"test.error.set_biome": "Nie udało się ustawić biomu przed testem",
	"test.error.spawn_failure": "Nie udało się stworzyć bytu %s",
	"test.error.state_not_equal": "Nieprawidłowy stan. Oczekiwano %s: było %s",
	"test.error.structure.failure": "Nie udało się umieścić struktury testowej dla %s",
	"test.error.tick": "%s przy tiku %s",
	"test.error.ticking_without_structure": "Test tików przed umieszczeniem struktury",
	"test.error.timeout.no_result": "Nie powiodło się w ciągu %s tików",
	"test.error.timeout.no_sequences_finished": "Brak sekwencji zakończonych w ciągu %s tików",
	"test.error.too_many_entities": "Oczekiwano, że wokół %[2]s, %[3]s, %[4]s będzie istnieć tylko jeden byt typu %[1]s, a znaleziono aż %[5]s",
	"test.error.unexpected_block": "Otrzymano nieoczekiwany blok: %s",
	"test.error.unexpected_entity": "Nie oczekiwano istnienia bytu %s",
	"test.error.unexpected_item": "Nie oczekiwano elementu rodzaju %s",
	"test.error.unknown": "Nieznany błąd wewnętrzny: %s",
	"test.error.value_not_equal": "Oczekiwano, że %s będzie %s: było %s",
	"test.error.value_not_in_between": "Oczekiwano, że wartość %s będzie mieścić się w przedziale od %s do %s: otrzymano %s",
	"test.error.wrong_block_entity": "Nieprawidłowy rodzaj bloku z danymi: %s",
	"test_block.error.missing": "Strukturze testowej brakuje bloku %s",
	"test_block.error.too_many": "Zbyt wiele bloków %s",
	"test_block.invalid_timeout": "Nieprawidłowy limit czasu (%s) — liczba tików musi być dodatnia",
	"test_block.message": "Wiadomość:",
	"test_block.mode.accept": "Zaliczenie",
	"test_block.mode.fail": "Niepowodzenie",
	"test_block.mode.log": "Rejestr",
	"test_block.mode.start": "Rozpoczęcie",
	"test_block.mode_info.accept": "Tryb „zaliczenie” — zalicza i przepuszcza test lub jego część",
	"test_block.mode_info.fail": "Tryb „niepowodzenie” — test jest niezaliczony",
	"test_block.mode_info.log": "Tryb „rejestr” — rejestrowanie wiadomości",
	"test_block.mode_info.start": "Tryb „rozpoczęcie” — miejsce rozpoczęcia testu",
	"test_instance.action.reset": "Zresetuj i wczytaj",
	"test_instance.action.run": "Wczytaj i uruchom",
	"test_instance.action.save": "Zapisz strukturę",
	"test_instance.description.batch": "Środowisko: %s",
	"test_instance.description.failed": "Niepowodzenie: %s",
	"test_instance.description.function": "Funkcja: %s",
	"test_instance.description.invalid_id": "Nieprawidłowy identyfikator testu.",
	"test_instance.description.no_test": "Nie ma takiego testu",
	"test_instance.description.structure": "Struktura: %s",
	"test_instance.description.type": "Rodzaj: %s",
	"test_instance.type.block_based": "Test oparty na blokach",
	"test_instance.type.function": "Wbudowany test funkcji",
	"test_instance_block.entities": "Byty:",
	"test_instance_block.error.no_test": "Nie można uruchomić wystąpienia testu znajdującego się na %s, %s, %s, gdyż brakuje w nim samego testu",
	"test_instance_block.error.no_test_structure": "Nie można uruchomić instancji testowej na %s, %s, %s, ponieważ nie ma struktury testowej.",
	"test_instance_block.error.unable_to_save": "Nie można zapisać szablonu struktury zarządzanego przez wystąpienie testu, który znajduje się na %s, %s, %s",
	"test_instance_block.invalid": "[nieprawidłowy]",
	"test_instance_block.reset_success": "Przywrócono test na pierwotne ustawienie: %s",
	"test_instance_block.rotation": "Rotacja:",
	"test_instance_block.size": "Rozmiar struktury testu",
	"test_instance_block.starting": "Rozpoczynanie testu %s",
	"test_instance_block.test_id": "Identyfikator instancji testowej",
	...
	"title.credits": "Prawa autorskie Mojang AB. Nie rozpowszechniać!",
	"title.multiplayer.disabled": "Tryb wieloosobowy został wyłączony; sprawdź ustawienia konta Microsoft.",
	"title.multiplayer.disabled.banned.name": "Musisz zmienić swoją nazwę użytkownika, zanim zagrasz online",
	...
	"title.multiplayer.online": "Tryb wieloosobowy (online)",
	...
	"trim_material.minecraft.resin": "Żywicowy materiał",
	"trim_pattern.minecraft.bolt": "Zdobienie zbroi „Nit”",
	...
	"trim_pattern.minecraft.flow": "Zdobienie zbroi „Nurt”",
	...
	"upgradeWorld.aborted.message": "Może się tak zdarzyć, jeśli inny program uzyskał dostęp do świata podczas aktualizacji.\nSpróbuj jeszcze raz po uruchomieniu komputera ponownie. Jeśli problem nadal występuje, rozważ zgłoszenie błędu.",
	"upgradeWorld.aborted.reportBug": "Zgłoś błąd",
	"upgradeWorld.aborted.title": "Nie udało się zaktualizować świata",
	"upgradeWorld.canceled.message": "Twój świat nie uległ zmianie.",
	"upgradeWorld.canceled.title": "Przerwano aktualizację świata",
	"upgradeWorld.done": "Zakończono aktualizację świata",
	"upgradeWorld.failed_cleanup.message": "Świat został pomyślnie zaktualizowany do bieżącej wersji i jest teraz dostępny na liście światów.\nPodczas usuwania przestarzałych danych wystąpiły problemy, dlatego nazwa folderu świata została zmieniona na %s.",
	"upgradeWorld.failed_cleanup.title": "Pomyślnie zaktualizowano świat",
	"upgradeWorld.info.converted": "Zaktualizowano: %s",
	"upgradeWorld.info.file_fix_stage": "Etap: %s/%s",
	"upgradeWorld.info.scanning": "Przeszukiwanie plików…",
	"upgradeWorld.info.total": "Razem: %s",
	"upgradeWorld.joinNow": "Czy chcesz teraz dołączyć do świata?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Przenoszenie plików",
	"upgradeWorld.progress.type.legacy_structures": "Aktualizowanie starszych struktur",
	"upgradeWorld.progress.type.region": "Aktualizowanie regionów",
	"upgradeWorld.symlink.message": "Wybrany świat zawiera dowiązania symboliczne.\nKroki wymagane do aktualizacji świata do bieżącej wersji nie obsługują dowiązań symbolicznych. Aby zaktualizować świat, należy najpierw rozwiązać lub usunąć te dowiązania.",
	"upgradeWorld.symlink.title": "Nie można zaktualizować świata",
	"upgradeWorld.title": "Aktualizowanie plików świata",
}
