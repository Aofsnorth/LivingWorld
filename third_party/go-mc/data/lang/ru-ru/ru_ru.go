// Code generated by tools/gen_lang.go from 26.1/ru_ru.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Специальные возможности...",
	"accessibility.onboarding.accessibility.button.narration": "Специальные возможности",
	...
	"advMode.notEnabled": "Командные блоки отключены",
	"advMode.notEnabled.spawner": "Рассадники отключены",
	"advMode.previousOutput": "Предыдущий вывод",
	"advMode.setCommand": "Задайте команду для блока",
	"advMode.setCommand.disabled": "Команда задана: %s, но командные блоки отключены",
	...
	"advancements.adventure.blowback.description": "Убейте вихря его же зарядом ветра",
	"advancements.adventure.blowback.title": "Не дуйся",
	"advancements.adventure.brush_armadillo.description": "Добудьте щитки броненосца при помощи кисти",
	"advancements.adventure.brush_armadillo.title": "Ласковый и беззащитный зверь",
	...
	"advancements.adventure.crafters_crafting_crafters.description": "Будьте около сборщика, собирающего сборщик",
	"advancements.adventure.crafters_crafting_crafters.title": "До чего дошёл прогресс",
	...
	"advancements.adventure.lighten_up.description": "Соскребите топором окись с медной лампы, чтобы сделать её ярче",
	"advancements.adventure.lighten_up.title": "Лампа Аладдина",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Войдите в дворец испытаний",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: пробное издание",
	"advancements.adventure.ol_betsy.description": "Выстрелите из арбалета",
	"advancements.adventure.ol_betsy.title": "Самострел",
	"advancements.adventure.overoverkill.description": "Нанесите 50 сердец урона одним ударом булавы",
	"advancements.adventure.overoverkill.title": "Есть пробитие!",
	...
	"advancements.adventure.revaulting.description": "Отоприте зловещее хранилище зловещим ключом испытаний",
	"advancements.adventure.revaulting.title": "Непросто ларчик открывался",
	...
	"advancements.adventure.salvage_sherd.title": "Крупицы истории",
	...
	"advancements.adventure.spear_many_mobs.description": "Поразите пять мобов таранным ударом копья",
	"advancements.adventure.spear_many_mobs.title": "Шашлык-мобшлык",
	...
	"advancements.adventure.trim_with_any_armor_pattern.description": "Нанесите отделку на броню на столе кузнеца",
	...
	"advancements.adventure.under_lock_and_key.description": "Отоприте хранилище ключом испытаний",
	"advancements.adventure.under_lock_and_key.title": "Золотой ключик",
	"advancements.adventure.use_lodestone.description": "Используйте компас на магнетите",
	"advancements.adventure.use_lodestone.title": "Путеводный камень",
	...
	"advancements.adventure.who_needs_rockets.description": "Используйте заряд ветра, чтобы подлететь вверх на 8 блоков",
	"advancements.adventure.who_needs_rockets.title": "Верхом на ветре",
	...
	"advancements.husbandry.feed_snifflet.title": "Нос не дорос",
	...
	"advancements.husbandry.obtain_sniffer_egg.title": "Легенда о нюхозавре",
	...
	"advancements.husbandry.silk_touch_nest.description": "С помощью «шёлкового касания» переместите пчелиное гнездо или улей с тремя пчёлами внутри",
	...
	"advancements.husbandry.uh_oh.description": "Дайте серному кубу поглотить динамит",
	"advancements.husbandry.uh_oh.title": "Ой-ой",
	...
	"argument.double.big": "Вещественное число двойной точности должно быть не больше %s; указано %s",
	"argument.double.low": "Вещественное число двойной точности должно быть не меньше %s; указано %s",
	...
	"argument.float.big": "Вещественное число должно быть не больше %s; указано %s",
	"argument.float.low": "Вещественное число должно быть не меньше %s; указано %s",
	"argument.gamemode.invalid": "Неизвестный режим игры: %s",
	"argument.hexcolor.invalid": "Неверный HEX-код цвета «%s»",
	"argument.id.invalid": "Неверный идентификатор",
	"argument.id.unknown": "Неизвестный идентификатор: %s",
	"argument.integer.big": "Целое число должно быть не больше %s; указано %s",
	"argument.integer.low": "Целое число должно быть не меньше %s; указано %s",
	"argument.item.id.invalid": "Неизвестный предмет «%s»",
	"argument.item.tag.disallowed": "Здесь нельзя использовать теги, укажите конкретный предмет",
	"argument.literal.incorrect": "Ожидался литерал %s",
	...
	"argument.message.too_long": "Сообщение чата было слишком длинным (%s > максимальное количество символов %s)",
	"argument.nbt.array.invalid": "Неверный тип массива «%s»",
	"argument.nbt.array.mixed": "Невозможно добавить %s в %s",
	"argument.nbt.expected.compound": "Ожидался составной тег",
	...
	"argument.pos.mixed": "Нельзя смешивать локальные и мировые координаты (используйте «^» везде или нигде)",
	...
	"argument.range.ints": "Разрешены только целые числа; не дробные",
	"argument.range.swapped": "Минимальное значение не может быть больше максимального",
	...
	"argument.resource_or_id.failed_to_parse": "Не удалось распознать строение: %s",
	"argument.resource_or_id.invalid": "Неверный идентификатор или тег",
	"argument.resource_or_id.no_such_element": "Не удалось найти элемент «%s» в реестре «%s»",
	"argument.resource_selector.not_found": "Нет совпадений для селектора «%s» типа «%s»",
	...
	"argument.style.invalid": "Неверный стиль: %s",
	...
	"argument.time.tick_count_too_low": "Задержка тактов не может быть меньше чем %s, обнаружено %s",
	"argument.uuid.invalid": "Неверный UUID",
	"argument.waypoint.invalid": "Выбранная сущность не является маркером",
	...
	"arguments.item.component.expected": "Ожидался компонент предмета",
	"arguments.item.component.malformed": "Неверный компонент «%s»: «%s»",
	"arguments.item.component.repeated": "Компонент предмета «%s» был повторён, но можно указать только одно значение",
	"arguments.item.component.unknown": "Неизвестный компонент предмета «%s»",
	"arguments.item.malformed": "Неверный предмет: «%s»",
	"arguments.item.overstacked": "%s может находиться в стопках только по %s шт.",
	"arguments.item.predicate.malformed": "Неверный предикат «%s»: «%s»",
	"arguments.item.predicate.unknown": "Неизвестный предикат предмета «%s»",
	...
	"attribute.name.air_drag_modifier": "Модификатор сопротивления воздуха",
	"attribute.name.armor": "Броня",
	"attribute.name.armor_toughness": "Твёрдость брони",
	"attribute.name.attack_damage": "Урон при атаке",
	"attribute.name.attack_knockback": "Отбрасывание при атаке",
	"attribute.name.attack_speed": "Скорость атаки",
	"attribute.name.below_name_distance": "Дальность видимости счёта под именем",
	"attribute.name.block_break_speed": "Скорость разрушения блоков",
	"attribute.name.block_interaction_range": "Дальность взаимодействия с блоками",
	"attribute.name.bounciness": "Упругость",
	"attribute.name.burning_time": "Время горения",
	"attribute.name.camera_distance": "Отдалённость камеры",
	"attribute.name.entity_interaction_range": "Дальность взаимодействия с сущностями",
	"attribute.name.explosion_knockback_resistance": "Сопротивление к отбрасыванию взрывом",
	"attribute.name.fall_damage_multiplier": "Множитель урона от падения",
	"attribute.name.flying_speed": "Скорость полёта",
	"attribute.name.follow_range": "Диапазон преследования моба",
	...
	"attribute.name.generic.attack_damage": "Урон при атаке",
	"attribute.name.generic.attack_knockback": "Отбрасывание при атаке",
	"attribute.name.generic.attack_speed": "Скорость атаки",
	"attribute.name.generic.block_interaction_range": "Дальность взаимодействия с блоками",
	"attribute.name.generic.burning_time": "Время горения",
	"attribute.name.generic.entity_interaction_range": "Дальность взаимодействия с сущностями",
	"attribute.name.generic.explosion_knockback_resistance": "Сопротивление к отбрасыванию взрывом",
	"attribute.name.generic.fall_damage_multiplier": "Множитель урона от падения",
	...
	"attribute.name.generic.knockback_resistance": "Сопротивление к отбрасыванию",
	"attribute.name.generic.luck": "Везение",
	"attribute.name.generic.max_absorption": "Предел поглощения",
	"attribute.name.generic.max_health": "Максимальное здоровье",
	"attribute.name.generic.movement_efficiency": "Эффективность передвижения",
	"attribute.name.generic.movement_speed": "Скорость",
	"attribute.name.generic.oxygen_bonus": "Бонус к кислороду",
	"attribute.name.generic.safe_fall_distance": "Безопасная высота падения",
	"attribute.name.generic.scale": "Размер",
	"attribute.name.generic.step_height": "Высота шага",
	"attribute.name.generic.water_movement_efficiency": "Эффективность передвижения в воде",
	...
	"attribute.name.knockback_resistance": "Сопротивление к отбрасыванию",
	"attribute.name.luck": "Везение",
	"attribute.name.max_absorption": "Предел поглощения",
	"attribute.name.max_health": "Максимальное здоровье",
	"attribute.name.mining_efficiency": "Эффективность добычи",
	"attribute.name.movement_efficiency": "Эффективность передвижения",
	"attribute.name.movement_speed": "Скорость",
	"attribute.name.nameplate_distance": "Дальность видимости имени",
	"attribute.name.oxygen_bonus": "Бонус к кислороду",
	"attribute.name.player.block_break_speed": "Скорость разрушения блоков",
	"attribute.name.player.block_interaction_range": "Дальность взаимодействия с блоками",
	"attribute.name.player.entity_interaction_range": "Дальность взаимодействия с сущностями",
	"attribute.name.player.mining_efficiency": "Эффективность добычи",
	"attribute.name.player.sneaking_speed": "Скорость подкрадывания",
	"attribute.name.player.submerged_mining_speed": "Скорость добычи под водой",
	"attribute.name.player.sweeping_damage_ratio": "Коэффициент разящего удара",
	"attribute.name.safe_fall_distance": "Безопасная высота падения",
	"attribute.name.scale": "Размер",
	"attribute.name.sneaking_speed": "Скорость подкрадывания",
	"attribute.name.spawn_reinforcements": "Подкрепление зомби",
	"attribute.name.step_height": "Высота шага",
	"attribute.name.submerged_mining_speed": "Скорость добычи под водой",
	"attribute.name.sweeping_damage_ratio": "Коэффициент разящего удара",
	"attribute.name.tempt_range": "Дальность приманивания",
	"attribute.name.water_movement_efficiency": "Эффективность передвижения в воде",
	"attribute.name.waypoint_receive_range": "Дальность обнаружения маркеров",
	"attribute.name.waypoint_transmit_range": "Дальность передачи маркера",
	...
	"block.minecraft.acacia_shelf": "Акациевая полка",
	...
	"block.minecraft.bamboo_shelf": "Бамбуковая полка",
	...
	"block.minecraft.banner.flow.black": "Чёрный поток",
	"block.minecraft.banner.flow.blue": "Синий поток",
	"block.minecraft.banner.flow.brown": "Коричневый поток",
	"block.minecraft.banner.flow.cyan": "Бирюзовый поток",
	"block.minecraft.banner.flow.gray": "Серый поток",
	"block.minecraft.banner.flow.green": "Зелёный поток",
	"block.minecraft.banner.flow.light_blue": "Голубой поток",
	"block.minecraft.banner.flow.light_gray": "Светло-серый поток",
	"block.minecraft.banner.flow.lime": "Лаймовый поток",
	"block.minecraft.banner.flow.magenta": "Пурпурный поток",
	"block.minecraft.banner.flow.orange": "Оранжевый поток",
	"block.minecraft.banner.flow.pink": "Розовый поток",
	"block.minecraft.banner.flow.purple": "Фиолетовый поток",
	"block.minecraft.banner.flow.red": "Красный поток",
	"block.minecraft.banner.flow.white": "Белый поток",
	"block.minecraft.banner.flow.yellow": "Жёлтый поток",
	...
	"block.minecraft.banner.guster.purple": "Фиолетовый вихрь",
	"block.minecraft.banner.guster.red": "Красный вихрь",
	"block.minecraft.banner.guster.white": "Белый вихрь",
	...
	"block.minecraft.birch_shelf": "Берёзовая полка",
	...
	"block.minecraft.cherry_shelf": "Вишнёвая полка",
	...
	"block.minecraft.chiseled_copper": "Точёный медный блок",
	...
	"block.minecraft.chiseled_tuff": "Резной туф",
	"block.minecraft.chiseled_tuff_bricks": "Резные туфовые кирпичи",
	...
	"block.minecraft.copper_bars": "Медные прутья",
	"block.minecraft.copper_block": "Медный блок",
	"block.minecraft.copper_bulb": "Медная лампа",
	"block.minecraft.copper_chain": "Медная цепь",
	"block.minecraft.copper_chest": "Медный сундук",
	"block.minecraft.copper_door": "Медная дверь",
	"block.minecraft.copper_golem_statue": "Статуя медного голема",
	"block.minecraft.copper_grate": "Медная решётка",
	"block.minecraft.copper_lantern": "Медный фонарь",
	"block.minecraft.copper_ore": "Медная руда",
	"block.minecraft.copper_torch": "Медный факел",
	"block.minecraft.copper_trapdoor": "Медный люк",
	"block.minecraft.copper_wall_torch": "Настенный медный факел",
	...
	"block.minecraft.crafter": "Сборщик",
	...
	"block.minecraft.crimson_shelf": "Багровая полка",
	...
	"block.minecraft.dark_oak_shelf": "Полка из тёмного дуба",
	...
	"block.minecraft.end_portal": "Портал Энда",
	"block.minecraft.end_portal_frame": "Рамка портала Энда",
	...
	"block.minecraft.exposed_chiseled_copper": "Потемневший точёный медный блок",
	"block.minecraft.exposed_copper": "Потемневший медный блок",
	"block.minecraft.exposed_copper_bars": "Потемневшие медные прутья",
	"block.minecraft.exposed_copper_bulb": "Потемневшая медная лампа",
	"block.minecraft.exposed_copper_chain": "Потемневшая медная цепь",
	"block.minecraft.exposed_copper_chest": "Потемневший медный сундук",
	"block.minecraft.exposed_copper_door": "Потемневшая медная дверь",
	"block.minecraft.exposed_copper_golem_statue": "Потемневшая статуя медного голема",
	"block.minecraft.exposed_copper_grate": "Потемневшая медная решётка",
	"block.minecraft.exposed_copper_lantern": "Потемневший медный фонарь",
	"block.minecraft.exposed_copper_trapdoor": "Потемневший медный люк",
	...
	"block.minecraft.exposed_lightning_rod": "Потемневший громоотвод",
	...
	"block.minecraft.golden_dandelion": "Золотой одуванчик",
	...
	"block.minecraft.heavy_core": "Навершие булавы",
	...
	"block.minecraft.horn_coral": "Роговый коралл",
	...
	"block.minecraft.iron_chain": "Железная цепь",
	...
	"block.minecraft.jungle_shelf": "Полка из тропического дерева",
	...
	"block.minecraft.mangrove_shelf": "Мангровая полка",
	...
	"block.minecraft.nether_portal": "Портал Незера",
	"block.minecraft.nether_quartz_ore": "Руда незерского кварца",
	...
	"block.minecraft.oak_shelf": "Дубовая полка",
	...
	"block.minecraft.oxidized_chiseled_copper": "Окисленный точёный медный блок",
	"block.minecraft.oxidized_copper": "Окисленный медный блок",
	"block.minecraft.oxidized_copper_bars": "Окисленные медные прутья",
	"block.minecraft.oxidized_copper_bulb": "Окисленная медная лампа",
	"block.minecraft.oxidized_copper_chain": "Окисленная медная цепь",
	"block.minecraft.oxidized_copper_chest": "Окисленный медный сундук",
	"block.minecraft.oxidized_copper_door": "Окисленная медная дверь",
	"block.minecraft.oxidized_copper_golem_statue": "Окисленная статуя медного голема",
	"block.minecraft.oxidized_copper_grate": "Окисленная медная решётка",
	"block.minecraft.oxidized_copper_lantern": "Окисленный медный фонарь",
	"block.minecraft.oxidized_copper_trapdoor": "Окисленный медный люк",
	...
	"block.minecraft.oxidized_lightning_rod": "Окисленный громоотвод",
	...
	"block.minecraft.pale_oak_shelf": "Полка из бледного дуба",
	...
	"block.minecraft.pale_oak_wall_hanging_sign": "Настенная подвесная табличка из бледного дуба",
	"block.minecraft.pale_oak_wall_sign": "Настенная табличка из бледного дуба",
	...
	"block.minecraft.polished_tuff": "Полированный туф",
	"block.minecraft.polished_tuff_slab": "Плита из полированного туфа",
	"block.minecraft.polished_tuff_stairs": "Ступеньки из полированного туфа",
	"block.minecraft.polished_tuff_wall": "Ограда из полированного туфа",
	...
	"block.minecraft.potted_golden_dandelion": "Золотой одуванчик в горшке",
	...
	"block.minecraft.redstone_lamp": "Редстоуновая лампа",
	...
	"block.minecraft.spruce_shelf": "Еловая полка",
	...
	"block.minecraft.test_block": "Блок-тестер",
	"block.minecraft.test_instance_block": "Блок-тестер экземпляра",
	...
	"block.minecraft.trial_spawner": "Рассадник испытаний",
	...
	"block.minecraft.tuff_brick_slab": "Плита из туфового кирпича",
	"block.minecraft.tuff_brick_stairs": "Ступеньки из туфового кирпича",
	"block.minecraft.tuff_brick_wall": "Ограда из туфового кирпича",
	"block.minecraft.tuff_bricks": "Туфовые кирпичи",
	"block.minecraft.tuff_slab": "Туфовая плита",
	"block.minecraft.tuff_stairs": "Туфовые ступеньки",
	...
	"block.minecraft.warped_shelf": "Искажённая полка",
	...
	"block.minecraft.waxed_chiseled_copper": "Вощёный точёный медный блок",
	"block.minecraft.waxed_copper_bars": "Вощёные медные прутья",
	"block.minecraft.waxed_copper_block": "Вощёный медный блок",
	"block.minecraft.waxed_copper_bulb": "Вощёная медная лампа",
	"block.minecraft.waxed_copper_chain": "Вощёная медная цепь",
	"block.minecraft.waxed_copper_chest": "Вощёный медный сундук",
	"block.minecraft.waxed_copper_door": "Вощёная медная дверь",
	"block.minecraft.waxed_copper_golem_statue": "Вощёная статуя медного голема",
	"block.minecraft.waxed_copper_grate": "Вощёная медная решётка",
	"block.minecraft.waxed_copper_lantern": "Вощёный медный фонарь",
	"block.minecraft.waxed_copper_trapdoor": "Вощёный медный люк",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Вощёный потемневший точёный медный блок",
	"block.minecraft.waxed_exposed_copper": "Вощёный потемневший медный блок",
	"block.minecraft.waxed_exposed_copper_bars": "Вощёные потемневшие медные прутья",
	"block.minecraft.waxed_exposed_copper_bulb": "Вощёная потемневшая медная лампа",
	"block.minecraft.waxed_exposed_copper_chain": "Вощёная потемневшая медная цепь",
	"block.minecraft.waxed_exposed_copper_chest": "Вощёный потемневший медный сундук",
	"block.minecraft.waxed_exposed_copper_door": "Вощёная потемневшая медная дверь",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Вощёная потемневшая статуя медного голема",
	"block.minecraft.waxed_exposed_copper_grate": "Вощёная потемневшая медная решётка",
	"block.minecraft.waxed_exposed_copper_lantern": "Вощёный потемневший медный фонарь",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Вощёный потемневший медный люк",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Вощёный потемневший громоотвод",
	"block.minecraft.waxed_lightning_rod": "Вощёный громоотвод",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Вощёный окисленный точёный медный блок",
	"block.minecraft.waxed_oxidized_copper": "Вощёный окисленный медный блок",
	"block.minecraft.waxed_oxidized_copper_bars": "Вощёные окисленные медные прутья",
	"block.minecraft.waxed_oxidized_copper_bulb": "Вощёная окисленная медная лампа",
	"block.minecraft.waxed_oxidized_copper_chain": "Вощёная окисленная медная цепь",
	"block.minecraft.waxed_oxidized_copper_chest": "Вощёный окисленный медный сундук",
	"block.minecraft.waxed_oxidized_copper_door": "Вощёная окисленная медная дверь",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Вощёная окисленная статуя медного голема",
	"block.minecraft.waxed_oxidized_copper_grate": "Вощёная окисленная медная решётка",
	"block.minecraft.waxed_oxidized_copper_lantern": "Вощёный окисленный медный фонарь",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Вощёный окисленный медный люк",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Вощёный окисленный громоотвод",
	"block.minecraft.waxed_weathered_chiseled_copper": "Вощёный состаренный точёный медный блок",
	"block.minecraft.waxed_weathered_copper": "Вощёный состаренный медный блок",
	"block.minecraft.waxed_weathered_copper_bars": "Вощёные состаренные медные прутья",
	"block.minecraft.waxed_weathered_copper_bulb": "Вощёная состаренная медная лампа",
	"block.minecraft.waxed_weathered_copper_chain": "Вощёная состаренная медная цепь",
	"block.minecraft.waxed_weathered_copper_chest": "Вощёный состаренный медный сундук",
	"block.minecraft.waxed_weathered_copper_door": "Вощёная состаренная медная дверь",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Вощёная состаренная статуя медного голема",
	"block.minecraft.waxed_weathered_copper_grate": "Вощёная состаренная медная решётка",
	"block.minecraft.waxed_weathered_copper_lantern": "Вощёный состаренный медный фонарь",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Вощёный состаренный медный люк",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Вощёный состаренный громоотвод",
	"block.minecraft.weathered_chiseled_copper": "Состаренный точёный медный блок",
	"block.minecraft.weathered_copper": "Состаренный медный блок",
	"block.minecraft.weathered_copper_bars": "Состаренные медные прутья",
	"block.minecraft.weathered_copper_bulb": "Состаренная медная лампа",
	"block.minecraft.weathered_copper_chain": "Состаренная медная цепь",
	"block.minecraft.weathered_copper_chest": "Состаренный медный сундук",
	"block.minecraft.weathered_copper_door": "Состаренная медная дверь",
	"block.minecraft.weathered_copper_golem_statue": "Состаренная статуя медного голема",
	"block.minecraft.weathered_copper_grate": "Состаренная медная решётка",
	"block.minecraft.weathered_copper_lantern": "Состаренный медный фонарь",
	"block.minecraft.weathered_copper_trapdoor": "Состаренный медный люк",
	...
	"block.minecraft.weathered_lightning_rod": "Состаренный громоотвод",
	...
	"book.edit.title": "Экран редактирования книги",
	...
	"book.page_button.next": "Следующая страница",
	"book.page_button.previous": "Предыдущая страница",
	"book.sign.title": "Экран подписания книги",
	"book.sign.titlebox": "Заголовок",
	"book.signButton": "Подписать",
	"book.view.title": "Экран просмотра книги",
	"build.spawn_protection": "%s под защитой точки возрождения мира",
	"build.tooHigh": "Ограничение строительства по высоте: %s",
	"build.tooLow": "Минимальная высота строительства составляет %s",
	"chat.cannotSend": "Не удалось отправить сообщение",
	...
	"chat.disabled.invalid_command_signature": "Команда имеет несовместимые или отсутствующие аргументы подписей.",
	"chat.disabled.invalid_signature": "Сообщение чата имеет неверную подпись. Попробуйте переподключиться.",
	...
	"chat.disabled.out_of_order_chat": "Нарушена очерёдность чата. Проверьте настройки системного времени.",
	...
	"chat.queue.tooltip": "Нажмите, чтобы отобразить следующее сообщение",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "Сервер отправил некорректное сообщение.",
	...
	"chat.validation_error": "Ошибка проверки чата",
	"chat_restriction.chat_and_commands_disabled_by_options": "Чат ограничен настройками клиента.",
	"chat_restriction.chat_disabled_by_options": "Чат игроков ограничен настройками клиента.",
	"chat_restriction.chat_disabled_by_options.action": "Перейти на экран «Настройки чата»",
	"chat_restriction.disabled_by_launcher": "Чат ограничен лаунчером",
	"chat_restriction.disabled_by_profile": "Чат ограничен настройками профиля.",
	"chat_restriction.disabled_by_profile.action": "Перейти к настройкам профиля",
	"chat_screen.commands_not_allowed": "Отправка команд запрещена",
	"chat_screen.message": "Сообщение для отправки: %s",
	"chat_screen.messages_not_allowed": "Отправка сообщений в чат запрещена",
	"chat_screen.restricted": "Чат ограничен. Нажмите это сообщение, чтобы узнать больше.",
	"chat_screen.restricted.narration": "Чат ограничен. Перейдите на экран «Ограничения» в настройках мира.",
	"chat_screen.title": "Чат",
	"chat_screen.usage": "Введите сообщение и нажмите клавишу Ввод, чтобы отправить",
	"chunk.toast.checkLog": "Смотрите подробнее в журнале",
	"chunk.toast.loadFailure": "Не удалось загрузить чанк на %s",
	"chunk.toast.lowDiskSpace": "Недостаточно места на диске!",
	"chunk.toast.lowDiskSpace.description": "Сохранение мира может оказаться невозможным.",
	"chunk.toast.saveFailure": "Не удалось сохранить чанк на %s",
	...
	"command.forkLimit": "Достигнуто максимальное количество контекстов (%s)",
	"command.trailing_data": "Обнаружены следующие данные: %s",
	...
	"commands.attribute.base_value.reset.success": "Базовое значение атрибута «%s» у сущности «%s» возвращено к %s",
	"commands.attribute.base_value.set.success": "Базовое значение атрибута %s для сущности %s установлено на %s",
	...
	"commands.attribute.modifier.value.get.success": "Значение модификатора %s на атрибут «%s» для сущности %s равно %s",
	...
	"commands.clone.failed": "Не удалось произвести копирование блоков",
	"commands.clone.overlap": "Области источника и места назначения не могут совпадать",
	"commands.clone.success": "Скопировано %s блоков",
	...
	"commands.datapack.create.already_exists": "Набор данных с названием «%s» уже существует",
	"commands.datapack.create.invalid_full_name": "Недопустимое название для нового набора данных: «%s»",
	"commands.datapack.create.invalid_name": "Недопустимые символы в названии набора «%s»",
	"commands.datapack.create.io_failure": "Не удалось создать набор с названием «%s», проверьте журнал",
	"commands.datapack.create.metadata_encode_failure": "Не удалось записать метаданные набора «%s»: %s",
	"commands.datapack.create.success": "Создан пустой набор данных «%s»",
	"commands.datapack.disable.failed": "Набор данных «%s» не включён!",
	"commands.datapack.disable.failed.feature": "Набор данных «%s» не может быть отключён, так как является частью включённого флага!",
	...
	"commands.datapack.modify.enable": "Включение набора данных %s",
	...
	"commands.debug.function.noReturnRun": "Трассировку невозможно использовать при наличии «return run»",
	...
	"commands.dialog.clear.multiple": "Убран диалог у %s игроков",
	"commands.dialog.clear.single": "Убраны диалоги у игрока %s",
	"commands.dialog.show.multiple": "Отображён диалог %s игрокам",
	"commands.dialog.show.single": "Отображён диалог игроку %s",
	...
	"commands.execute.conditional.fail": "Проверка неуспешна",
	"commands.execute.conditional.fail_count": "Проверка неуспешна; счётчик: %s",
	"commands.execute.conditional.pass": "Проверка пройдена",
	"commands.execute.conditional.pass_count": "Проверка пройдена; счётчик: %s",
	"commands.execute.function.instantiationFailure": "Не удалось запустить функцию «%s»: %s",
	"commands.experience.add.levels.success.multiple": "Выдано %s уровней опыта игрокам %s",
	"commands.experience.add.levels.success.single": "Выдано %s уровней опыта игроку %s",
	...
	"commands.experience.query.levels": "%s имеет %s уровней опыта",
	"commands.experience.query.points": "%s имеет %s единиц опыта",
	...
	"commands.fetchprofile.copy_component": "Копировать компонент",
	"commands.fetchprofile.copy_text": "Копировать %s",
	"commands.fetchprofile.entity.success": "Получен профиль сущности %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Не удалось сериализовать профиль: %s",
	"commands.fetchprofile.give_item": "Выдать предмет",
	"commands.fetchprofile.id.failure": "Не удалось получить профиль по идентификатору %s",
	"commands.fetchprofile.id.success": "Получен профиль по идентификатору %s: %s",
	"commands.fetchprofile.name.failure": "Не удалось получить профиль по имени %s",
	"commands.fetchprofile.name.success": "Получен профиль по имени %s: %s",
	"commands.fetchprofile.no_profile": "У сущности %s нет профиля",
	"commands.fetchprofile.summon_mannequin": "Призвать манекен",
	"commands.fill.failed": "Не удалось произвести заполнение блоками",
	"commands.fill.success": "Заполнено %s блоков",
	...
	"commands.fillbiome.success.count": "Биом был заменён у %s блоков между точками %s, %s, %s и %s, %s, %s",
	...
	"commands.function.error.argument_not_compound": "Недопустимый тип аргумента: %s, ожидался Compound",
	"commands.function.error.missing_argument": "Пропущен аргумент %[2]s в функции %[1]s",
	"commands.function.error.missing_arguments": "Нет подходящих аргументов к функции %s",
	"commands.function.error.parse": "При создании макроса «%s» команда «%s» вызвала ошибку: %s",
	"commands.function.instantiationFailure": "Не удалось запустить функцию «%s»: %s",
	"commands.function.result": "Функция «%s» вернула значение %s",
	"commands.function.scheduled.multiple": "Запущены функции: %s",
	"commands.function.scheduled.no_functions": "Функция «%s» не найдена",
	"commands.function.scheduled.single": "Запущена функция «%s»",
	...
	"commands.function.success.single.result": "Функция «%[2]s» вернула значение %[1]s",
	...
	"commands.kick.owner.failed": "Невозможно исключить владельца локального сервера",
	"commands.kick.singleplayer.failed": "Невозможно исключать в одиночной игре",
	"commands.kick.success": "Игрок %s исключён. Причина: %s",
	"commands.kill.success.multiple": "Убито %s сущностей",
	...
	"commands.profile_fetch.copy_component": "Копировать компонент",
	"commands.profile_fetch.failed_to_serialize": "Не удалось сериализовать профиль: %s",
	"commands.profile_fetch.give_item": "Выдать предмет",
	"commands.profile_fetch.id.failure": "Не удалось получить профиль по идентификатору %s",
	"commands.profile_fetch.id.success": "Получен профиль по идентификатору %s: %s",
	"commands.profile_fetch.name.failure": "Не удалось получить профиль по имени %s",
	"commands.profile_fetch.name.success": "Получен профиль по имени %s: %s",
	"commands.publish.alreadyPublished": "Сетевая игра уже запущена на порту %s",
	"commands.publish.alreadyPublished.lan": "Локальный сервер уже запущен на порту %s",
	"commands.publish.alreadyPublished.online": "Сетевая игра уже запущена",
	"commands.publish.failed": "Невозможно запустить локальный сервер",
	"commands.publish.started": "Порт локального сервера: %s",
	"commands.publish.started.lan": "Локальный сервер запущен на порту %s",
	"commands.publish.started.online": "Сетевая игра запущена",
	"commands.publish.success": "Сетевая игра запущена на порту %s",
	"commands.random.error.range_too_large": "Диапазон случайного значения не должен превышать 2147483646",
	"commands.random.error.range_too_small": "Диапазон случайного значения должен быть не менее 2",
	"commands.random.reset.all.success": "Сброшено %s случайных последовательностей",
	"commands.random.reset.success": "Сброшена случайная последовательность «%s»",
	"commands.random.roll": "У %s выпало %s (между %s и %s)",
	"commands.random.sample.success": "Случайное значение: %s",
	"commands.recipe.give.failed": "Ни один рецепт не выдан",
	"commands.recipe.give.success.multiple": "Выдан(о) %s рецепт(ов) %s игрокам",
	...
	"commands.rotate.success": "%s повёрнут",
	...
	"commands.schedule.macro": "Невозможно запланировать макрос",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Отключено автоматическое обновление отображения задачи %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Включено автоматическое обновление отображения задачи %s",
	"commands.scoreboard.objectives.modify.displayname": "Отображаемое название «%s» изменено на %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Формат числа задачи «%s» по умолчанию очищен",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Формат числа задачи «%s» по умолчанию изменён",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Отображаемое имя было изменено для %s сущностей в «%s»",
	"commands.scoreboard.players.display.name.clear.success.single": "Отображаемое имя было изменено для %s в «%s»",
	"commands.scoreboard.players.display.name.set.success.multiple": "Отображаемое имя было изменено на %s для %s сущностей в %s",
	"commands.scoreboard.players.display.name.set.success.single": "Отображаемое имя было изменено на %s для %s в %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Формат числа был очищен для %s сущностей в %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Формат числа очищен для %s в %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Формат числа изменён для %s сущностей в %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Формат числа изменён для %s на %s",
	...
	"commands.scoreboard.players.reset.specific.multiple": "Сброшен счёт задачи %s у %s сущностей",
	...
	"commands.setidletimeout.success.disabled": "Время ожидания бездействия игрока отключено",
	"commands.setworldspawn.failure.not_overworld": "Установить точку возрождения можно только в обычном мире",
	"commands.setworldspawn.success": "Установлена точка возрождения мира: %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Установлена точка возрождения мира на %s, %s, %s [%s, %s] в %s",
	"commands.spawnpoint.success.multiple": "Установлена точка возрождения %s, %s, %s [%s] в %s для %s игроков",
	"commands.spawnpoint.success.multiple.new": "Установлена точка возрождения на %s, %s, %s [%s, %s] в %s для %s игроков",
	"commands.spawnpoint.success.single": "Установлена точка возрождения %s, %s, %s [%s] в %s для %s",
	"commands.spawnpoint.success.single.new": "Установлена точка возрождения на %s, %s, %s [%s, %s] в %s для %s",
	"commands.spectate.cannot_spectate": "За %s нельзя наблюдать",
	...
	"commands.spreadplayers.success.entities": "Распределено %s сущностей вокруг точки %s, %s со средним расстоянием в %s блоков друг от друга",
	...
	"commands.stopwatch.already_exists": "Секундомер «%s» уже существует",
	"commands.stopwatch.create.success": "Создан секундомер «%s»",
	"commands.stopwatch.does_not_exist": "Секундомер «%s» не существует",
	"commands.stopwatch.query": "Секундомер «%s» работал в течение %s сек",
	"commands.stopwatch.remove.success": "Удалён секундомер «%s»",
	"commands.stopwatch.restart.success": "Перезапущен секундомер «%s»",
	"commands.summon.failed": "Не удалось создать сущность",
	"commands.summon.failed.peaceful": "Невозможно призывать монстров на мирной сложности",
	"commands.summon.failed.uuid": "Не удалось создать сущность из-за совпадающих UUID",
	"commands.summon.invalidPosition": "Неверная позиция для создания сущности",
	"commands.summon.success": "Сущность «%s» создана",
	"commands.swing.failed.notliving": "Сущность для взмаха не обнаружена",
	"commands.swing.success.multiple": "%s сущностей взмахнули руками",
	"commands.swing.success.single": "%s взмахнул рукой",
	...
	"commands.team.option.color.clear.success": "Убран цвет у команды %s",
	...
	"commands.test.batch.starting": "Запуск в среде %s, серия %s",
	"commands.test.clear.error.no_tests": "Не удалось найти тесты для очистки",
	"commands.test.clear.success": "Очищено %s конструкций",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Нажмите, чтобы скопировать в буфер обмена",
	"commands.test.create.success": "Создана тестовая среда для теста %s",
	"commands.test.error.no_test_containing_pos": "Не удалось найти тестовый экземпляр, содержащий точку %s, %s, %s",
	"commands.test.error.no_test_instances": "Тестовые экземпляры не найдены",
	"commands.test.error.non_existant_test": "Не удалось найти тест %s",
	"commands.test.error.structure_not_found": "Не удалось найти тестовую конструкцию %s",
	"commands.test.error.test_instance_not_found": "Не удалось найти блок-тестер экземпляра",
	"commands.test.error.test_instance_not_found.position": "Не удалось найти блок-сущность тестера экземпляра у теста в точке %s, %s, %s",
	"commands.test.error.too_large": "Размер конструкции должен быть менее %s блоков по каждой оси",
	"commands.test.locate.done": "Поиск завершён; найдено %s конструкций",
	"commands.test.locate.found": "Найдена конструкция в точке %s (расстояние: %s)",
	"commands.test.locate.started": "Начат поиск тестовых конструкций; это может занять некоторое время...",
	"commands.test.no_tests": "Нет тестов для запуска",
	"commands.test.relative_position": "Положение относительно %s: %s",
	"commands.test.reset.error.no_tests": "Не удалось найти тесты для сброса",
	"commands.test.reset.success": "Сброшено %s конструкций",
	"commands.test.run.no_tests": "Тесты не найдены",
	"commands.test.run.running": "Выполнение %s тестов...",
	"commands.test.summary": "Тестирование завершено! Выполнено %s тестов",
	"commands.test.summary.all_required_passed": "Все обязательные тесты пройдены :)",
	"commands.test.summary.failed": "%s обязательных тестов провалено :(",
	"commands.test.summary.optional_failed": "%s необязательных тестов провалено",
	"commands.tick.query.percentiles": "Процентили: P50: %sмс P95: %sмс P99: %sмс. Выборка: %s",
	"commands.tick.query.rate.running": "Целевая частота тактов в секунду: %s \nСреднее время такта: %s мс (Цель: %s мс)",
	"commands.tick.query.rate.sprinting": "Целевая частота тактов: %s в секунду (игнорируется, только для справки).\nСредняя длительность такта: %sмс",
	"commands.tick.rate.success": "Задана целевая частота тактов: %s в секунду",
	"commands.tick.sprint.report": "Перемотка завершена с %s тактами в секунду (%s мс за такт)",
	"commands.tick.sprint.stop.fail": "Перемотка тактов не запущена",
	"commands.tick.sprint.stop.success": "Перемотка тактов приостановлена",
	"commands.tick.status.frozen": "Игровой процесс приостановлен",
	"commands.tick.status.lagging": "Игра запущена, но не может поддерживать указанную частоту тактов",
	"commands.tick.status.running": "Игровой процесс работает в обычном режиме",
	"commands.tick.status.sprinting": "Игровой процесс перематывается",
	"commands.tick.step.fail": "Невозможно выполнить шаг — требуется приостановка игрового процесса",
	"commands.tick.step.stop.fail": "Выполняемые шаги тактов отсутствуют",
	"commands.tick.step.stop.success": "Запланированные шаги тактов прерваны",
	"commands.tick.step.success": "Шаг на %s тактов",
	"commands.time.no_default_clock": "В измерении %s нет часов по умолчанию",
	"commands.time.no_time_marker_found": "Временная отметка %s не существует для часов %s",
	"commands.time.pause": "Ход часов %s приостановлен",
	"commands.time.query": "Время: %s",
	"commands.time.query.absolute": "Часы %s находятся на отметке в %s тактов",
	"commands.time.query.gametime": "Игровое время составляет %s тактов",
	"commands.time.query.timeline": "Временная шкала %s находится на отметке в %s тактов",
	"commands.time.query.timeline.repetitions": "Временная шкала %s повторилась %s раз",
	"commands.time.rate": "Часы %s будут идти в %s раз быстрее обычного",
	"commands.time.resume": "Ход часов %s возобновлён",
	"commands.time.set": "Установлено время: %s",
	"commands.time.set.absolute": "Установлено %s на %s тактов",
	"commands.time.set.time_marker": "%s теперь на временной отметке %s",
	"commands.time.wrong_timeline_for_clock": "Временная шкала %s недействительна для часов %s",
	...
	"commands.transfer.success.multiple": "Перенос %s игроков на %s:%s",
	"commands.transfer.success.single": "Перенос %s на %s:%s",
	...
	"commands.unpublish.notPublished": "Сетевой игры нет",
	"commands.unpublish.success": "Сетевая игра теперь закрыта",
	...
	"commands.waypoint.list.empty": "Нет маркеров в %s",
	"commands.waypoint.list.success": "%s маркеров в %s: %s",
	"commands.waypoint.modify.color": "Цвет маркера теперь %s",
	"commands.waypoint.modify.color.reset": "Цвет маркера сброшен",
	"commands.waypoint.modify.style": "Стиль маркера изменён",
	...
	"compliance.playtime.hours": "Вы играете на протяжении %s часов",
	"compliance.playtime.message": "Чрезмерная игра может вредить обычной повседневной жизни",
	"component.profile.dynamic": "Динамический",
	...
	"connect.failed.transfer": "Ошибка подключения к новому серверу",
	"connect.joining": "Подключение к миру...",
	"connect.negotiating": "Соединение...",
	"connect.p2p.establishing": "Установка соединения...",
	"connect.p2p.failed.generic": "Не удалось подключиться к игроку",
	"connect.p2p.failed.signaling": "Ошибка подключения.\nПопробуйте позже.",
	"connect.p2p.failed.timeout": "Время подключения истекло",
	"connect.p2p.failed.unreachable": "Игрок недоступен",
	"connect.reconfiging": "Перенастройка...",
	"connect.reconfiguring": "Перенастройка...",
	"connect.transferring": "Переход на новый сервер...",
	"container.barrel": "Бочка",
	"container.beacon": "Маяк",
	"container.beehive.bees": "Пчёлы: %s / %s",
	"container.beehive.honey": "Мёд: %s / %s",
	...
	"container.upgrade.error_tooltip": "Предмет нельзя так улучшить",
	...
	"createWorld.customize.buffet.search": "Поиск...",
	"createWorld.customize.buffet.title": "Настройка одного биома",
	...
	"createWorld.customize.presets.share": "Хотите поделиться своим шаблоном? Используйте поле ниже!",
	...
	"credits_and_attribution.button.attribution": "Атрибуции",
	"credits_and_attribution.button.credits": "Титры",
	"credits_and_attribution.button.licenses": "Лицензии",
	"credits_and_attribution.screen.title": "Титры и атрибуции",
	"dataPack.bundle.description": "Включает экспериментальный предмет «Мешок»",
	"dataPack.bundle.name": "Мешки",
	"dataPack.locator_bar.description": "Показывать направление других игроков в сетевой игре",
	"dataPack.locator_bar.name": "Локатор",
	"dataPack.minecart_improvements.description": "Улучшенное движение вагонеток",
	"dataPack.minecart_improvements.name": "Улучшения вагонеток",
	"dataPack.redstone_experiments.description": "Экспериментальные изменения редстоуна",
	"dataPack.redstone_experiments.name": "Изменения редстоуна",
	"dataPack.title": "Выбор наборов данных",
	"dataPack.trade_rebalance.description": "Обновлённые сделки крестьян",
	"dataPack.trade_rebalance.name": "Балансировка торговли с крестьянами",
	"dataPack.update_1_20.description": "Новые возможности и контент Minecraft 1.20",
	"dataPack.update_1_20.name": "Обновление 1.20",
	"dataPack.update_1_21.description": "Новые возможности и контент Minecraft 1.21",
	"dataPack.update_1_21.name": "Обновление 1.21",
	...
	"dataPack.winter_drop.description": "Новые возможности и контент из зимнего дропа",
	"dataPack.winter_drop.name": "Зимний дроп",
	...
	"death.attack.arrow": "%[1]s был застрелен %[2]s",
	"death.attack.arrow.item": "%[1]s был застрелен %[2]s с помощью %[3]s",
	...
	"death.attack.cramming": "%[1]s был расплющен в лепёшку",
	"death.attack.cramming.player": "%[1]s был расплющен %[2]s",
	"death.attack.dragonBreath": "%[1]s сварился заживо в дыхании дракона",
	"death.attack.dragonBreath.player": "%[1]s сварился заживо в дыхании дракона из-за %[2]s",
	...
	"death.attack.fallingBlock": "%[1]s был раздавлен упавшим блоком",
	...
	"death.attack.fireball": "%[1]s был убит файерболом %[2]s",
	"death.attack.fireball.item": "%[1]s был убит файерболом %[2]s с помощью %[3]s",
	...
	"death.attack.inWall": "%[1]s был погребён заживо",
	...
	"death.attack.mace_smash": "%[1]s был сокрушён %[2]s",
	"death.attack.mace_smash.item": "%[1]s был сокрушён %[2]s с помощью %[3]s",
	"death.attack.magic": "%[1]s был убит магией",
	"death.attack.magic.player": "%[1]s был убит магией, убегая от %[2]s",
	...
	"death.attack.onFire.item": "%[1]s был сожжён дотла, пока боролся с %[2]s, держащим %[3]s",
	...
	"death.attack.sonic_boom.item": "%[1]s был уничтожен звуковым зарядом, спасаясь от %[2]s, держащего %[3]s",
	"death.attack.sonic_boom.player": "%[1]s был уничтожен звуковым зарядом, спасаясь от %[2]s",
	"death.attack.spear": "%[1]s был проткнут %[2]s",
	"death.attack.spear.item": "%[1]s был проткнут %[2]s с помощью %[3]s",
	"death.attack.stalagmite": "%[1]s был пронзён сталагмитом",
	...
	"death.attack.sting": "%[1]s был изжален до смерти",
	"death.attack.sting.item": "%[1]s был изжален до смерти %[2]s с помощью %[3]s",
	"death.attack.sting.player": "%[1]s был изжален до смерти %[2]s",
	"death.attack.sulfurCubeHot": "%[1]s обнаружил, что лавой может быть не только пол",
	"death.attack.sulfurCubeHot.player": "%[2]s показал %[1]s, что не только пол — это лава",
	...
	"death.attack.trident.item": "%[1]s был пронзён %[2]s с помощью %[3]s",
	"death.attack.wither": "%[1]s был иссушён",
	...
	"deathScreen.score.value": "Счёт: %s",
	...
	"debug.copy_location.help": "F3 + C = Скопировать координаты; удерживайте 10 секунд, чтобы вызвать сбой игры",
	...
	"debug.crash.message.rebindable": "Зажатие клавиш %s + %s. Приведёт к сбою игры, если не отпустить.",
	...
	"debug.entry.always": "Всегда",
	"debug.entry.currently.alwaysOn": "%s: В данный момент отображается всегда",
	"debug.entry.currently.inF3": "%s: В данный момент только в F3",
	"debug.entry.currently.inOverlay": "%s: В данный момент только на экране отладки",
	"debug.entry.currently.never": "%s: В данный момент выключен",
	"debug.entry.f3": "В F3",
	"debug.entry.overlay": "В отладке",
	...
	"debug.options.category.renderer": "Визуальная отладка",
	"debug.options.category.text": "Текст экрана отладки",
	"debug.options.help": "F3 + F6 = Редактировать параметры отладки",
	"debug.options.notAllowed.tooltip": "Не отображается при урезанном экране отладки",
	"debug.options.profile.default": "По умолчанию",
	"debug.options.profile.performance": "Отладка быстродействия",
	"debug.options.search": "Поиск...",
	"debug.options.title": "Параметры отладки",
	"debug.options.warning": "Данные настройки предназначены только для тестирования. Их изменение может привести к сбою игры, замедлению компьютера или съедению ковра на стене.",
	...
	"debug.profiling.start.rebindable": "%s-секундное профилирование запущено. Нажмите %s + %s, чтобы остановить",
	...
	"debug.version.header": "Версия клиента:",
	"debug.version.help": "F3 + V = Информация о версии клиента",
	...
	"demo.help.fullWrapped": "Демоверсия будет активна 5 игровых дней (около 1 часа 40 минут реального времени). Загляните в «Достижения», там есть подсказки! Удачи!",
	...
	"difficulty.lock.title": "Зафиксировать сложность",
	...
	"disconnect.loginFailedInfo.serversUnavailable": "Серверы аутентификации недоступны. Повторите попытку.",
	"disconnect.loginFailedInfo.userBanned": "Вам заблокирована сетевая игра",
	"disconnect.lost": "Соединение потеряно",
	"disconnect.packetError": "Ошибка сетевого протокола",
	"disconnect.spam": "Вы исключены за спам",
	"disconnect.timeout": "Превышено время ожидания",
	"disconnect.transfer": "Перенесён на другой сервер",
	"disconnect.unknownHost": "Неизвестный сервер",
	"download.pack.failed": "Не удалось загрузить %s из %s наборов",
	"download.pack.progress.bytes": "Загружено: %s (общий размер неизвестен)",
	"download.pack.progress.percent": "Загружено: %s%%",
	"download.pack.title": "Загрузка набора ресурсов %s/%s",
	"editGamerule.default": "По умолчанию: %s",
	"editGamerule.inGame.button": "Игровые правила...",
	"editGamerule.inGame.disabled.tooltip": "Для обновления игровых правил требуются права оператора.",
	"editGamerule.inGame.discardChanges.message": "Вы действительно хотите отменить изменения игровых правил?",
	"editGamerule.inGame.discardChanges.title": "Изменения игровых правил",
	"editGamerule.inGame.downloadingGamerules": "Загрузка игровых правил...",
	"editGamerule.title": "Настройка игровых правил",
	"effect.duration.infinite": "∞",
	"effect.minecraft.absorption": "Поглощение",
	"effect.minecraft.bad_omen": "Дурной знак",
	"effect.minecraft.blindness": "Слепота",
	"effect.minecraft.breath_of_the_nautilus": "Дыхание наутилуса",
	...
	"effect.minecraft.infested": "Заражение",
	...
	"effect.minecraft.raid_omen": "Знак рейда",
	...
	"effect.minecraft.trial_omen": "Знак испытаний",
	"effect.minecraft.unluck": "Невезение",
	"effect.minecraft.water_breathing": "Водное дыхание",
	"effect.minecraft.weakness": "Слабость",
	"effect.minecraft.weaving": "Плетение",
	"effect.minecraft.wind_charged": "Ветровой заряд",
	...
	"enchantment.minecraft.breach": "Пробитие",
	...
	"enchantment.minecraft.sweeping_edge": "Разящий клинок",
	...
	"enchantment.minecraft.wind_burst": "Порыв ветра",
	"entity.minecraft.acacia_boat": "Акациевая лодка",
	"entity.minecraft.acacia_chest_boat": "Акациевая грузовая лодка",
	...
	"entity.minecraft.bamboo_chest_raft": "Грузовой бамбуковый плот",
	"entity.minecraft.bamboo_raft": "Бамбуковый плот",
	...
	"entity.minecraft.bogged": "Болотник",
	"entity.minecraft.breeze": "Вихрь",
	"entity.minecraft.breeze_wind_charge": "Заряд ветра",
	"entity.minecraft.camel": "Верблюд",
	"entity.minecraft.camel_husk": "Верблюд-кадавр",
	...
	"entity.minecraft.copper_golem": "Медный голем",
	"entity.minecraft.cow": "Корова",
	"entity.minecraft.creaking": "Скрипун",
	"entity.minecraft.creaking_transient": "Скрипун",
	"entity.minecraft.creeper": "Крипер",
	"entity.minecraft.dark_oak_boat": "Лодка из тёмного дуба",
	"entity.minecraft.dark_oak_chest_boat": "Грузовая лодка из тёмного дуба",
	...
	"entity.minecraft.jungle_boat": "Лодка из тропического дерева",
	"entity.minecraft.jungle_chest_boat": "Грузовая лодка из тропического дерева",
	...
	"entity.minecraft.lingering_potion": "Туманное зелье",
	...
	"entity.minecraft.ominous_item_spawner": "Зловещий рассадник предметов",
	...
	"entity.minecraft.parched": "Пустынник",
	...
	"entity.minecraft.splash_potion": "Взрывное зелье",
	...
	"entity.minecraft.tropical_fish.predefined.1": "Зебрасома чёрная",
	...
	"entity.minecraft.wind_charge": "Заряд ветра",
	...
	"entity.minecraft.zombie_nautilus": "Наутилус-зомби",
	...
	"event.minecraft.raid.defeat.full": "Рейд — Поражение",
	"event.minecraft.raid.raiders_remaining": "Осталось нападающих: %s",
	"event.minecraft.raid.victory": "Победа",
	"event.minecraft.raid.victory.full": "Рейд — Победа",
	"filled_map.buried_treasure": "Карта клада",
	"filled_map.explorer_jungle": "Карта исследователя джунглей",
	"filled_map.explorer_swamp": "Карта исследователя болот",
	"filled_map.id": "№ %s",
	"filled_map.level": "(Уровень: %s/%s)",
	"filled_map.locked": "Неизменяема",
	"filled_map.mansion": "Карта исследователя лесов",
	"filled_map.monument": "Карта исследователя океанов",
	"filled_map.scale": "Масштаб 1:%s",
	"filled_map.trial_chambers": "Карта искателя испытаний",
	"filled_map.unknown": "Неизвестная карта",
	"filled_map.village_desert": "Карта пустынной деревни",
	"filled_map.village_plains": "Карта равнинной деревни",
	"filled_map.village_savanna": "Карта саванной деревни",
	"filled_map.village_snowy": "Карта заснеженной деревни",
	"filled_map.village_taiga": "Карта таёжной деревни",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Доступ в Незер",
	"gamerule.allowEnteringNetherUsingPortals.description": "Определяет, могут ли игроки входить в Незер",
	"gamerule.allowFireTicksAwayFromPlayer": "Обновление огня вдали от игроков",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Определяет, обновляются ли огонь и лава в радиусе более 8 чанков от каждого игрока",
	...
	"gamerule.commandBlocksEnabled": "Командные блоки",
	...
	"gamerule.disablePlayerMovementCheck": "Отключение проверки движения игрока",
	...
	"gamerule.doVinesSpread": "Распространение лианы",
	"gamerule.doVinesSpread.description": "Влияет на случайное распространение лиан по соседним блокам. Не затрагивает другие вьющиеся растения, такие как плакучие или вьющиеся лозы.",
	...
	"gamerule.enableCommandBlocks": "Использование командных блоков",
	"gamerule.enderPearlsVanishOnDeath": "Исчезновение брошенного эндер-жемчуга при смерти",
	"gamerule.enderPearlsVanishOnDeath.description": "Влияет на исчезновение брошенного эндер-жемчуга после смерти игрока.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Использование порталов сущностями с пассажирами",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Позволяет сущностям с пассажирами телепортироваться через порталы Незера, порталы Энда и врата Энда.",
	"gamerule.fallDamage": "Урон от падения",
	"gamerule.fireDamage": "Урон от огня",
	"gamerule.forgiveDeadPlayers": "Прощение умерших игроков",
	"gamerule.forgiveDeadPlayers.description": "Разозлённые нейтральные мобы перестают злиться на игрока, когда тот умирает неподалёку.",
	...
	"gamerule.lavaSourceConversion.description": "Окружённая двумя источниками текущая лава образует третий.",
	"gamerule.locatorBar": "Локатор игроков",
	"gamerule.locatorBar.description": "Когда включено, на экране отображается локатор, указывающий на расположение игроков.",
	"gamerule.logAdminCommands": "Запись команд администраторов",
	"gamerule.maxCommandChainLength": "Ограничение длины цепи команд",
	"gamerule.maxCommandChainLength.description": "Затрагивает цепочки командных блоков и функции.",
	"gamerule.maxCommandForkCount": "Ограничение контекста команд",
	"gamerule.maxCommandForkCount.description": "Максимальное количество контекстов, которые могут быть использованы командами вроде «execute as».",
	"gamerule.maxEntityCramming": "Предел сущностей в одном блоке",
	"gamerule.minecartMaxSpeed": "Максимальная скорость вагонетки",
	"gamerule.minecartMaxSpeed.description": "Максимальная базовая скорость движения вагонетки по земле.",
	"gamerule.minecraft.elytra_movement_check": "Проверка движения на элитрах",
	"gamerule.minecraft.fire_spread_radius_around_player": "Радиус распространения огня",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Радиус в блоках вокруг игрока, в котором может распространяться огонь",
	"gamerule.minecraft.player_movement_check": "Проверка движения игрока",
	"gamerule.minecraft.raids": "Рейды",
	"gamerule.minecraft.universal_anger.description": "Разозлённые нейтральные мобы будут нападать на любого игрока поблизости, а не на разозлившего их. Эффективнее, если правило forgive_dead_players выключено.",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Время прохождения портала Незера в творческом режиме",
	"gamerule.playersNetherPortalCreativeDelay.description": "Задержка перемещения при прохождении портала Незера игроками в творческом режиме (в тактах).",
	"gamerule.playersNetherPortalDefaultDelay": "Время прохождения портала Незера вне творческого режима",
	"gamerule.playersNetherPortalDefaultDelay.description": "Задержка перемещения при прохождении портала Незера игроками вне творческого режима (в тактах).",
	...
	"gamerule.projectilesCanBreakBlocks": "Снаряды могут разрушать блоки",
	"gamerule.projectilesCanBreakBlocks.description": "Регулирует, разрушаются ли определённые блоки от удара снаряда.",
	"gamerule.pvp": "PvP",
	"gamerule.pvp.description": "Определяет, могут ли игроки наносить урон другим игрокам",
	...
	"gamerule.spawnChunkRadius": "Радиус чанков возрождения мира",
	"gamerule.spawnChunkRadius.description": "Радиус невыгружаемой области вокруг точки возрождения мира.",
	"gamerule.spawnMonsters": "Появление монстров",
	"gamerule.spawnMonsters.description": "Определяет, появляются ли монстры сами по себе.",
	"gamerule.spawnRadius": "Радиус области возрождения",
	"gamerule.spawnRadius.description": "Радиус невыгружаемой области вокруг точек возрождения игроков.",
	"gamerule.spawnerBlocksEnabled": "Рассадники",
	"gamerule.spectatorsGenerateChunks": "Генерация мира наблюдателями",
	"gamerule.tntExplodes": "Активация и взрыв динамита",
	...
	"gui.abuseReport.attestation": "Отправляя жалобу, вы подтверждаете, что предоставленная вами информация является точной и полной.",
	"gui.abuseReport.comments": "Комментарии",
	"gui.abuseReport.describe": "Подробности помогут нам принять правильное решение.",
	"gui.abuseReport.discard.content": "При выходе текст жалобы и комментарии к ней будут утеряны.\nВы действительно хотите выйти?",
	"gui.abuseReport.discard.discard": "Выйти и отменить жалобу",
	"gui.abuseReport.discard.draft": "Сохранить черновик",
	"gui.abuseReport.discard.return": "Продолжить редактирование",
	"gui.abuseReport.discard.title": "Отменить жалобу и комментарии?",
	"gui.abuseReport.draft.content": "Продолжить редактирование существующей жалобы или отменить и создать новую?",
	"gui.abuseReport.draft.discard": "Отменить",
	"gui.abuseReport.draft.edit": "Продолжить редактирование",
	"gui.abuseReport.draft.quittotitle.content": "Продолжить редактирование или отменить?",
	"gui.abuseReport.draft.quittotitle.title": "У вас имеется черновик жалобы, который будет потерян, если вы выйдете",
	"gui.abuseReport.draft.title": "Редактировать черновик жалобы?",
	"gui.abuseReport.error.title": "Не удалось отправить жалобу",
	"gui.abuseReport.message": "Где вы столкнулись с неприемлемым поведением?\nЭто поможет нам в рассмотрении вашей жалобы.",
	"gui.abuseReport.more_comments": "Опишите произошедшее:",
	"gui.abuseReport.name.comment_box_label": "Опишите причину жалобы на имя:",
	"gui.abuseReport.name.reporting": "Вы жалуетесь на имя «%s».",
	"gui.abuseReport.name.title": "Жалоба на имя игрока",
	"gui.abuseReport.observed_what": "Почему вы отправляете жалобу?",
	"gui.abuseReport.read_info": "Узнать больше о системе жалоб",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Нанесение вреда чьей-либо репутации; например, распространение ложной информации, чтобы обмануть или запутать кого-либо.",
	"gui.abuseReport.reason.description": "Описание:",
	"gui.abuseReport.reason.false_reporting": "Ложные жалобы",
	"gui.abuseReport.reason.generic": "Я хочу пожаловаться на этого игрока",
	"gui.abuseReport.reason.generic.description": "Этот игрок разозлил меня / сделал то, что мне не нравится.",
	"gui.abuseReport.reason.harassment_or_bullying": "Домогательства или издевательства",
	...
	"gui.abuseReport.reason.imminent_harm": "Угрозы причинения вреда",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Членовредительство или самоубийство",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Сексуально неприемлемо",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Скины, изображающие действия сексуального характера, половые органы или сексуальное насилие.",
	...
	"gui.abuseReport.select_reason": "Выберите категорию жалобы",
	"gui.abuseReport.send": "Отправить жалобу",
	"gui.abuseReport.send.comment_too_long": "Сократите комментарий",
	...
	"gui.abuseReport.send.no_reason": "Выберите категорию жалобы",
	"gui.abuseReport.send.not_attested": "Прочтите текст выше и отметьте галочкой поле для отправки жалобы",
	...
	"gui.abuseReport.skin.title": "Жалоба на скин игрока",
	"gui.abuseReport.title": "Жалоба на игрока",
	"gui.abuseReport.type.chat": "Сообщения в чате",
	"gui.abuseReport.type.name": "Имя игрока",
	"gui.abuseReport.type.skin": "Скин игрока",
	...
	"gui.banned.name.description": "Ваше текущее имя, «\"%s\"», нарушает наши стандарты сообщества. Вы можете играть в одиночной игре, но вам нужно изменить имя, чтобы играть по сети.\n\nУзнать подробности или подать апелляцию можно по ссылке: %s",
	"gui.banned.name.title": "Имя запрещено для сетевой игры",
	...
	"gui.banned.reason.extreme_violence_or_gore": "Изображения реальной чрезмерной жестокости или крови",
	...
	"gui.banned.reason.harassment_or_bullying": "Оскорбительная лексика, направленная на причинение вреда",
	...
	"gui.banned.reason.imminent_harm_to_person_or_property": "Угрозы причинить вред людям или имуществу в реальной жизни",
	...
	"gui.banned.skin.description": "Ваш скин нарушает Стандарты сообщества. Вы можете играть со стандартным скином или выбрать другой.\n\nУзнать больше или отправить запрос на пересмотр решения можно по ссылке: %s",
	"gui.banned.skin.title": "Скин запрещён",
	...
	"gui.chatReport.discard.content": "При выходе текст жалобы и комментарии к ней будут утеряны.\nВы действительно хотите выйти?",
	...
	"gui.chatReport.read_info": "Узнать больше о системе жалоб",
	"gui.chatReport.report_sent_msg": "Мы получили вашу жалобу. Спасибо!\n\nНаша команда рассмотрит её как можно скорее.",
	"gui.chatReport.select_chat": "Выберите сообщения для жалобы",
	...
	"gui.chatReport.send.comments_too_long": "Сократите комментарий",
	...
	"gui.chatReport.title": "Жалоба на сообщения игрока",
	...
	"gui.chatSelection.selected": "Выбрано %s из %s сообщений",
	...
	"gui.fileDropFailure.detail": "Отклонено %s файлов",
	"gui.fileDropFailure.title": "Не удалось добавить файлы",
	"gui.friends.accept": "Принять",
	"gui.friends.button.loading": "Подождите...",
	"gui.friends.button.loading.invite_request_pending": "Ожидание подтверждения",
	"gui.friends.button.loading.join_request_pending": "Ожидание подтверждения",
	"gui.friends.cancel_request": "Отменить запрос",
	"gui.friends.confirm_title": "Подтвердить",
	"gui.friends.confirm_unfriend": "Вы действительно хотите удалить этого игрока из списка друзей?",
	"gui.friends.copy_to_clipboard": "Копировать в буфер обмена",
	"gui.friends.decline": "Отклонить",
	"gui.friends.empty_nickname": "Введите действительное имя профиля перед отправкой запроса в друзья",
	"gui.friends.empty_state": "Добавленные вами друзья будут отображаться здесь.\n\nУправление параметрами безопасности доступно через ваш %s.",
	"gui.friends.empty_state.link": "Аккаунт Microsoft",
	"gui.friends.enter_nickname": "Введите имя профиля",
	"gui.friends.error.connection_issue": "В настоящий момент список друзей не работает.\n\nПопробуйте позже.",
	"gui.friends.error.failed.message": "Не удалось отправить запрос в друзья",
	"gui.friends.error.forbidden.message": "Не удалось выполнить действие с другом. Возможно, это связано с настройками конфиденциальности учётной записи.",
	"gui.friends.error.generic": "Что-то пошло не так — с возможностью, не с друзьями!\n\nПопробуйте позже.",
	"gui.friends.error.rateLimited.message": "Слишком много взаимодействий со списком друзей. Подождите немного и попробуйте снова.",
	"gui.friends.error.temporary_unavailable": "В настоящий момент список друзей не работает.\n\nПопробуйте позже.",
	"gui.friends.error.unavailable.message": "Список друзей недоступен. Проверьте подключение к интернету и попробуйте позже.",
	"gui.friends.error.upgrade_needed": "Обновите игру, чтобы получить доступ к вашему списку друзей.",
	"gui.friends.error.user_may_lack_active_profile": "Игрока с таким именем не существует",
	"gui.friends.join": "Присоединиться",
	"gui.friends.loading_friends": "Загрузка списка друзей...",
	"gui.friends.loading_requests": "Загрузка запросов...",
	"gui.friends.manage_account_footer": "Управление параметрами безопасности доступно через ваш %s",
	"gui.friends.multiplayer.invite": "Пригласить",
	"gui.friends.multiplayer.invite_accept": "Принять",
	"gui.friends.multiplayer.invite_reject": "Отклонить",
	"gui.friends.multiplayer.join_request": "Запросить приглашение",
	"gui.friends.multiplayer.join_request_accept": "Принять",
	"gui.friends.multiplayer.join_request_reject": "Отклонить",
	"gui.friends.my_profile_name": "Имя моего профиля: ",
	"gui.friends.my_profile_name.narration": "Копировать имя профиля %s в буфер обмена",
	"gui.friends.narration.button.accept": "Нажмите Ввод, чтобы принять запрос %s в друзья",
	"gui.friends.narration.button.cancel_request": "Нажмите Ввод, чтобы отменить запрос в друзья игроку %s",
	"gui.friends.narration.button.decline": "Нажмите Ввод, чтобы отклонить запрос %s в друзья",
	"gui.friends.narration.button.unfriend": "Нажмите Ввод, чтобы удалить %s из списка друзей",
	"gui.friends.narration.entry.friend": "Друг %s",
	"gui.friends.narration.entry.incoming": "Входящий запрос в друзья от игрока %s",
	"gui.friends.narration.entry.outgoing": "Исходящий запрос в друзья игроку %s",
	"gui.friends.open": "Друзья",
	"gui.friends.open.narration": "Список друзей",
	"gui.friends.open.tooltip": "Друзья",
	"gui.friends.pending.empty": "Нет ожидающих запросов на добавление в друзья",
	"gui.friends.pending.received": "Полученные",
	"gui.friends.pending.sent": "Отправленные",
	"gui.friends.presence.status.offline": "Не в сети",
	"gui.friends.presence.status.online": "В сети",
	"gui.friends.presence.status.playing_hosted_server": "В сети (мир)",
	"gui.friends.presence.status.playing_offline": "В сети (мир)",
	"gui.friends.presence.status.playing_realms": "В сети (реалм)",
	"gui.friends.presence.status.playing_server": "В сети (сервер)",
	"gui.friends.requests_count": "Запросы (%s)",
	"gui.friends.send_request": "Отправить запрос в друзья",
	"gui.friends.tab_friends": "Друзья",
	"gui.friends.toast.friend_added.message": "%s принял запрос в друзья",
	"gui.friends.toast.friend_invited.message": "%s был приглашён в мир.",
	"gui.friends.toast.friend_removed.message": "%s был удалён из списка друзей",
	"gui.friends.toast.generic_error": "При обновлении списка друзей произошла непредвиденная ошибка. Попробуйте позже.",
	"gui.friends.toast.host_invite_expired.message": "Срок действия приглашения для %s на вход в этот мир истёк.",
	"gui.friends.toast.invite_from_friend.message": "Игрок %s пригласил вас в свой мир. Нажмите «%s», чтобы открыть список друзей и присоединиться",
	"gui.friends.toast.join_invite_expired.message": "Приглашение присоединиться к миру игрока %s истекло.",
	"gui.friends.toast.join_request.message": "%s хочет войти в ваш мир. Откройте список друзей нажатием «%s» или из меню игры.",
	"gui.friends.toast.request_accepted.message": "Теперь вы друзья с %s",
	"gui.friends.toast.request_received.message": "%s отправил запрос в друзья",
	"gui.friends.toast.request_sent.message": "Запрос в друзья отправлен игроку %s",
	"gui.friends.toast.request_to_join_friend.message": "Вы запросили подключение к миру %s",
	"gui.friends.toast.requests_accepted_multiple.message": "%s друзей приняли запрос",
	"gui.friends.toast.requests_received_multiple.message": "Вы получили %s запросов в друзья",
	"gui.friends.unfriend": "Удалить из друзей",
	"gui.game_rule.search": "Поиск...",
	"gui.hours": "%s часов",
	"gui.language.search": "Поиск...",
	...
	"gui.none": "Нет",
	"gui.ok": "OK",
	"gui.open_report_dir": "Открыть папку с отчётами",
	"gui.packSelection.search": "Поиск...",
	"gui.privacy_link.message": "Откройте эту ссылку для управления параметрами безопасности и конфиденциальности в интернете.",
	"gui.privacy_link.title": "Применение изменений в настройках Xbox может занять некоторое время.\n\nЕсли они не обновятся, перезапустите игру.",
	"gui.proceed": "Продолжить",
	"gui.recipebook.moreRecipes": "Ещё варианты — правый клик",
	"gui.recipebook.next_page": "Вперёд",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Назад",
	...
	"gui.remove": "Удалить",
	"gui.report_to_server": "Сообщить серверу",
	"gui.selectWorld.search": "Поиск...",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "На этого игрока нельзя пожаловаться, поскольку чат отключён или заблокирован",
	...
	"gui.stats.none_found": "Статистика не найдена.",
	"gui.toMenu": "К списку серверов",
	"gui.toRealms": "К списку Realms",
	"gui.toTitle": "В главное меню",
	"gui.toWorld": "К списку миров",
	"gui.togglable_slot": "Нажмите, чтобы отключить слот",
	"gui.up": "Вверх",
	"gui.waitingForResponse.button.inactive": "Назад (%s сек.)",
	"gui.waitingForResponse.title": "Ожидание ответа от сервера",
	"gui.yes": "Да",
	...
	"item.canUse.unknown": "Неизвестно",
	"item.color": "Цвет: %s",
	"item.components": "%s компонентов",
	"item.disabled": "Отключённый предмет",
	"item.durability": "Прочность: %s / %s",
	"item.dyed": "Крашеный",
	"item.intangible": "Неосязаемый",
	...
	"item.minecraft.armadillo_scute": "Щиток броненосца",
	...
	"item.minecraft.bolt_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Отделка «Ось»",
	"item.minecraft.bone": "Кость",
	"item.minecraft.bone_meal": "Костная мука",
	"item.minecraft.book": "Книга",
	"item.minecraft.bordure_indented_banner_pattern": "Узор флага «Зубчатая кайма»",
	"item.minecraft.bow": "Лук",
	"item.minecraft.bowl": "Миска",
	"item.minecraft.bread": "Хлеб",
	"item.minecraft.breeze_rod": "Вихревой стержень",
	...
	"item.minecraft.camel_husk_spawn_egg": "Яйцо призыва верблюда-кадавра",
	...
	"item.minecraft.chicken": "Сырая курица",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Отделка «Берег»",
	...
	"item.minecraft.copper_axe": "Медный топор",
	"item.minecraft.copper_boots": "Медные ботинки",
	"item.minecraft.copper_chestplate": "Медный нагрудник",
	"item.minecraft.copper_golem_spawn_egg": "Яйцо призыва медного голема",
	"item.minecraft.copper_helmet": "Медный шлем",
	"item.minecraft.copper_hoe": "Медная мотыга",
	"item.minecraft.copper_horse_armor": "Медная конская броня",
	"item.minecraft.copper_ingot": "Медный слиток",
	"item.minecraft.copper_leggings": "Медные поножи",
	"item.minecraft.copper_nautilus_armor": "Медная броня наутилуса",
	"item.minecraft.copper_nugget": "Кусочек меди",
	"item.minecraft.copper_pickaxe": "Медная кирка",
	"item.minecraft.copper_shovel": "Медная лопата",
	"item.minecraft.copper_spear": "Медное копьё",
	"item.minecraft.copper_sword": "Медный меч",
	...
	"item.minecraft.creeper_banner_pattern.new": "Узор флага «Крипер»",
	...
	"item.minecraft.crossbow.projectile.multiple": "Снаряд: %s × %s",
	...
	"item.minecraft.danger_pottery_sherd": "Глиняный черепок «Угроза»",
	...
	"item.minecraft.diamond_nautilus_armor": "Алмазная броня наутилуса",
	"item.minecraft.diamond_pickaxe": "Алмазная кирка",
	"item.minecraft.diamond_shovel": "Алмазная лопата",
	"item.minecraft.diamond_spear": "Алмазное копьё",
	...
	"item.minecraft.dragon_breath": "Дыхание дракона",
	"item.minecraft.dried_kelp": "Сушёная ламинария",
	"item.minecraft.drowned_spawn_egg": "Яйцо призыва утопленника",
	"item.minecraft.dune_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Отделка «Дюна»",
	...
	"item.minecraft.eye_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Отделка «Око»",
	"item.minecraft.feather": "Перо",
	"item.minecraft.fermented_spider_eye": "Маринованный паучий глаз",
	"item.minecraft.field_masoned_banner_pattern": "Узор флага «Муровка»",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Отделка «Поток»",
	"item.minecraft.flow_banner_pattern": "Узор флага",
	"item.minecraft.flow_banner_pattern.desc": "Поток",
	"item.minecraft.flow_banner_pattern.new": "Узор флага «Поток»",
	"item.minecraft.flow_pottery_sherd": "Глиняный черепок «Поток»",
	"item.minecraft.flower_banner_pattern": "Узор флага",
	"item.minecraft.flower_banner_pattern.desc": "Цветок",
	"item.minecraft.flower_banner_pattern.new": "Узор флага «Цветок»",
	...
	"item.minecraft.globe_banner_pattern.new": "Узор флага «Глобус»",
	...
	"item.minecraft.golden_nautilus_armor": "Золотая броня наутилуса",
	"item.minecraft.golden_pickaxe": "Золотая кирка",
	"item.minecraft.golden_shovel": "Золотая лопата",
	"item.minecraft.golden_spear": "Золотое копьё",
	...
	"item.minecraft.guster_banner_pattern": "Узор флага",
	"item.minecraft.guster_banner_pattern.desc": "Вихрь",
	"item.minecraft.guster_banner_pattern.new": "Узор флага «Вихрь»",
	"item.minecraft.guster_pottery_sherd": "Глиняный черепок «Вихрь»",
	"item.minecraft.happy_ghast_spawn_egg": "Яйцо призыва счастливого гаста",
	"item.minecraft.harness": "Упряжь",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.host_armor_trim_smithing_template.new": "Отделка «Вождь»",
	...
	"item.minecraft.iron_nautilus_armor": "Железная броня наутилуса",
	...
	"item.minecraft.iron_spear": "Железное копьё",
	...
	"item.minecraft.lingering_potion.effect.infested": "Туманное зелье заражения",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Туманное зелье слизистости",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Туманное зелье плетения",
	"item.minecraft.lingering_potion.effect.wind_charged": "Туманное зелье ветрового заряда",
	...
	"item.minecraft.mojang_banner_pattern.new": "Узор флага «Нечто»",
	...
	"item.minecraft.music_disc_bounce": "Пластинка",
	...
	"item.minecraft.music_disc_creator_music_box.desc": "Лена Рейн — Creator (Музыкальная шкатулка)",
	...
	"item.minecraft.nautilus_spawn_egg": "Яйцо призыва наутилуса",
	...
	"item.minecraft.netherite_horse_armor": "Незеритовая конская броня",
	"item.minecraft.netherite_ingot": "Незеритовый слиток",
	"item.minecraft.netherite_leggings": "Незеритовые поножи",
	"item.minecraft.netherite_nautilus_armor": "Незеритовая броня наутилуса",
	...
	"item.minecraft.netherite_spear": "Незеритовое копьё",
	"item.minecraft.netherite_sword": "Незеритовый меч",
	"item.minecraft.netherite_upgrade_smithing_template": "Кузнечный шаблон",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Незеритовое улучшение",
	...
	"item.minecraft.ominous_bottle": "Зловещая бутылочка",
	"item.minecraft.ominous_trial_key": "Зловещий ключ испытаний",
	...
	"item.minecraft.parched_spawn_egg": "Яйцо призыва пустынника",
	...
	"item.minecraft.piglin_banner_pattern.new": "Узор флага «Рыло»",
	...
	"item.minecraft.potion.effect.infested": "Зелье заражения",
	...
	"item.minecraft.potion.effect.oozing": "Зелье слизистости",
	...
	"item.minecraft.potion.effect.weaving": "Зелье плетения",
	"item.minecraft.potion.effect.wind_charged": "Зелье ветрового заряда",
	...
	"item.minecraft.quartz": "Незерский кварц",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Отделка «Собиратель»",
	...
	"item.minecraft.resin_clump": "Сгусток смолы",
	"item.minecraft.rib_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Отделка «Ребро»",
	...
	"item.minecraft.scrape_pottery_sherd": "Глиняный черепок «Обтёсывание»",
	"item.minecraft.scute": "Щиток",
	"item.minecraft.sentry_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Отделка «Страж»",
	"item.minecraft.shaper_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Отделка «Скульптор»",
	"item.minecraft.sheaf_pottery_shard": "Глиняный черепок «Сноп»",
	"item.minecraft.sheaf_pottery_sherd": "Глиняный черепок «Сноп»",
	"item.minecraft.shears": "Ножницы",
	"item.minecraft.sheep_spawn_egg": "Яйцо призыва овцы",
	"item.minecraft.shelter_pottery_shard": "Глиняный черепок «Укрытие»",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Отделка «Тишина»",
	...
	"item.minecraft.skull_banner_pattern.new": "Узор флага «Череп»",
	...
	"item.minecraft.snort_pottery_sherd": "Глиняный черепок «Шмыг»",
	"item.minecraft.snout_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Отделка «Рыло»",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Отделка «Шпиль»",
	...
	"item.minecraft.splash_potion.effect.infested": "Взрывное зелье заражения",
	...
	"item.minecraft.splash_potion.effect.oozing": "Взрывное зелье слизистости",
	...
	"item.minecraft.splash_potion.effect.weaving": "Взрывное зелье плетения",
	"item.minecraft.splash_potion.effect.wind_charged": "Взрывное зелье ветрового заряда",
	...
	"item.minecraft.stone_spear": "Каменное копьё",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Отделка «Прилив»",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Стрела заражения",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Стрела слизистости",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Стрела плетения",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Стрела ветрового заряда",
	...
	"item.minecraft.trial_key": "Ключ испытаний",
	...
	"item.minecraft.turtle_scute": "Черепаший щиток",
	"item.minecraft.turtle_spawn_egg": "Яйцо призыва черепахи",
	"item.minecraft.vex_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Отделка «Вредина»",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Отделка «Хранитель»",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Отделка «Искатель»",
	...
	"item.minecraft.wild_armor_trim_smithing_template": "Кузнечный шаблон",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Отделка «Дебри»",
	"item.minecraft.wind_charge": "Заряд ветра",
	...
	"item.minecraft.wooden_spear": "Деревянное копьё",
	...
	"item.minecraft.zombie_nautilus_spawn_egg": "Яйцо призыва наутилуса-зомби",
	...
	"item.modifiers.any": "Когда экипировано:",
	"item.modifiers.armor": "Когда надето:",
	"item.modifiers.body": "Когда надето:",
	"item.modifiers.chest": "Когда надето:",
	"item.modifiers.feet": "Когда обуто:",
	"item.modifiers.hand": "Когда в руке:",
	...
	"item.nbt_tags": "NBT: %s тегов",
	"item.op_block_warning.line1": "Внимание:",
	"item.op_block_warning.line2": "Использование этого предмета может повлечь за собой выполнение команд",
	"item.op_block_warning.line3": "Используйте, только если точно знаете его содержимое!",
	"item.spawn_egg.peaceful": "Отключено на мирной сложности",
	...
	"jigsaw_block.placement_priority": "Приоритет установки:",
	"jigsaw_block.placement_priority.tooltip": "Определяется порядок, в котором этот шаблон обрабатывается в рамках общей конструкции.\n\nПазлы будут обрабатываться в порядке убывания приоритета; при равных значениях, очерёдность будет определяться порядком вставки.",
	"jigsaw_block.pool": "Пул шаблонов:",
	"jigsaw_block.selection_priority": "Приоритет выбора:",
	"jigsaw_block.selection_priority.tooltip": "Порядок, в котором этот блок пазла будет пытаться связываться с соседними шаблонами.\n\nПазлы будут обрабатываться в порядке убывания приоритета; при равных значениях, очерёдность будет определяться случайным образом.",
	...
	"jukebox_song.minecraft.creator_music_box": "Лена Рейн — Creator (Музыкальная шкатулка)",
	...
	"key.categories.spectator": "Наблюдатель",
	"key.categories.ui": "Игровой интерфейс",
	"key.category.minecraft.creative": "Творческий режим",
	"key.category.minecraft.debug": "Отладка",
	"key.category.minecraft.gameplay": "Игровой процесс",
	"key.category.minecraft.inventory": "Инвентарь",
	"key.category.minecraft.misc": "Разное",
	"key.category.minecraft.movement": "Движение",
	"key.category.minecraft.multiplayer": "Сетевая игра",
	"key.category.minecraft.spectator": "Режим наблюдателя",
	"key.chat": "Открыть чат",
	"key.command": "Ввод команды",
	"key.debug.clearChat": "Очистить чат",
	"key.debug.copyLocation": "Копировать координаты",
	"key.debug.copyRecreateCommand": "Копировать данные",
	"key.debug.crash": "Отладочный сбой",
	"key.debug.debugOptions": "Параметры отладки",
	"key.debug.dumpDynamicTextures": "Сохранить динамические текстуры",
	"key.debug.dumpVersion": "Вывести информацию о версии",
	"key.debug.focusPause": "Переключить паузу при сворачивании",
	"key.debug.fpsCharts": "Графики FPS",
	"key.debug.lightmapTexture": "Карта освещения",
	"key.debug.modifier": "Клавиша-модификатор отладки",
	"key.debug.networkCharts": "Сетевые графики",
	"key.debug.overlay": "Переключить экран отладки",
	"key.debug.profiling": "Начать/остановить профилирование",
	"key.debug.profilingChart": "Диаграмма профилирования",
	"key.debug.reloadChunk": "Перезагрузить чанки",
	"key.debug.reloadResourcePacks": "Перезагрузить наборы ресурсов",
	"key.debug.showAdvancedTooltips": "Показывать расширенные подсказки",
	"key.debug.showChunkBorders": "Отображать границы чанков",
	"key.debug.showHitboxes": "Отображать хитбоксы",
	"key.debug.spectate": "Переключить режим наблюдателя",
	"key.debug.switchGameMode": "Переключатель режима игры",
	"key.drop": "Выбросить предмет",
	"key.forward": "Вперёд",
	"key.friends": "Экран друзей",
	...
	"key.spectatorHotbar": "Выбрать на хотбаре",
	"key.spectatorOutlines": "Подсветка игроков",
	"key.sprint": "Бег",
	"key.swapOffhand": "Заменить предмет во второй руке",
	"key.toggleGui": "Переключение интерфейса",
	"key.togglePerspective": "Переключить перспективу",
	"key.toggleSpectatorShaderEffects": "Переключение шейдеров наблюдения",
	"key.use": "Использовать/Установить",
	"known_server_link.announcements": "Объявления",
	...
	"known_server_link.report_bug": "Сообщить об ошибке сервера",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Добавление сервера",
	"manageServer.edit.title": "Информация о сервере",
	"manageServer.enterIp": "Адрес сервера",
	"manageServer.enterName": "Название сервера",
	"manageServer.resourcePack": "Наборы ресурсов",
	"manageServer.resourcePack.disabled": "Отключены",
	"manageServer.resourcePack.enabled": "Включены",
	"manageServer.resourcePack.prompt": "Запрашивать",
	"mco.account.privacy.info": "Подробнее о Mojang и законах о персональных данных",
	"mco.account.privacy.info.button": "Подробнее о GDPR",
	"mco.account.privacy.information": "Mojang использует определённые процедуры в целях защиты детей и их конфиденциальности, включая соблюдение закона О защите конфиденциальности детей в интернете (COPPA) и Общего регламента по защите данных (GDPR).\n\nВозможно, вам необходимо будет получить согласие родителей, прежде чем получить доступ к учётной записи Realms.",
	"mco.account.privacyinfo": "Mojang использует определённые процедуры в целях защиты детей и их конфиденциальности, включая соблюдение закона О защите конфиденциальности детей в интернете (COPPA) и Общего регламента по защите данных (GDPR).\n\nВозможно, вам необходимо будет получить согласие родителей, прежде чем получить доступ к аккаунту Realms.\n\nЕсли у вас старый аккаунт Minecraft (вы входите, используя имя пользователя), её необходимо обновить до аккаунта Mojang для получения доступа к Realms.",
	...
	"mco.backup.entry.enabledPack": "Активные наборы ресурсов",
	...
	"mco.backup.entry.worldType.adventureMap": "Приключенческая карта",
	"mco.backup.entry.worldType.experience": "Исследования",
	"mco.backup.entry.worldType.inspiration": "Вдохновение",
	"mco.backup.entry.worldType.minigame": "Мини-игра",
	"mco.backup.entry.worldType.normal": "Обычный",
	"mco.backup.entry.worldType.unknown": "Неизвестный",
	...
	"mco.client.incompatible.msg.line1": "Ваш клиент несовместим с Realms.",
	"mco.client.incompatible.msg.line2": "Воспользуйтесь самой последней версией Minecraft.",
	...
	"mco.client.outdated.stable.version": "Версия вашего клиента (%s) несовместима с Realms.\n\nИспользуйте самую последнюю версию Minecraft.",
	"mco.client.unsupported.snapshot.version": "Версия вашего клиента (%s) несовместима с Realms.\n\nRealms недоступны на этой предварительной версии.",
	"mco.compatibility.downgrade": "Откатить",
	"mco.compatibility.downgrade.description": "Последний раз этот мир запускался в версии %s; сейчас запущена версия %s. Смена версии мира на более старую может привести к его повреждению — мы не гарантируем, что он будет работать или загружаться. \n\nРезервная копия вашего мира будет сохранена во вкладке «Резервные копии». При необходимости вы сможете восстановить свой мир.",
	"mco.compatibility.incompatible.popup.title": "Несовместимая версия",
	"mco.compatibility.incompatible.releaseType.popup.message": "Мир, к которому вы пытаетесь присоединиться, несовместим с вашей версией клиента.",
	"mco.compatibility.incompatible.series.popup.message": "В последний раз этот мир запускался на версии %s; сейчас вы используете версию %s.\n\nЭти версии несовместимы друг с другом. Для игры в новой версии необходим новый мир.",
	"mco.compatibility.unverifiable.message": "Невозможно подтвердить версию, на которой запускался этот мир в последний раз. При обновлении или понижении версии мира резервная копия автоматически создаётся и сохраняется во вкладке «Резервные копии».",
	"mco.compatibility.unverifiable.title": "Невозможно подтвердить совместимость",
	"mco.compatibility.upgrade": "Обновить",
	"mco.compatibility.upgrade.description": "Последний раз этот мир запускался в версии %s; сейчас запущена версия %s.\n\nРезервная копия вашего мира будет сохранена во вкладке «Резервные копии». При необходимости вы сможете восстановить свой мир.",
	"mco.compatibility.upgrade.friend.description": "Последний раз этот мир запускался в версии %s; сейчас запущена версия %s.\n\nРезервная копия этого мира будет сохранена во вкладке «Резервные копии». При необходимости владелец реалма сможет восстановить этот мир.",
	"mco.compatibility.upgrade.title": "Вы действительно хотите обновить этот мир?",
	...
	"mco.configure.world.buttons.close": "Временно закрыть реалм",
	...
	"mco.configure.world.buttons.newworld": "Новый мир",
	"mco.configure.world.buttons.open": "Переоткрыть реалм",
	"mco.configure.world.buttons.options": "Параметры мира",
	"mco.configure.world.buttons.players": "Игроки",
	"mco.configure.world.buttons.region_preference": "Выбрать регион...",
	"mco.configure.world.buttons.resetworld": "Пересоздать мир",
	"mco.configure.world.buttons.save": "Сохранить",
	...
	"mco.configure.world.close.question.line1": "Вы можете временно закрыть свой реалм, предотвратив игру, пока вы вносите изменения. Откройте вновь, когда будете готовы.\n\nЭто не отменит вашу подписку Realms.",
	"mco.configure.world.close.question.line2": "Вы действительно хотите продолжить?",
	"mco.configure.world.close.question.title": "Нужно внести изменения без прерываний?",
	"mco.configure.world.closing": "Временно закрываем реалм...",
	...
	"mco.configure.world.delete.question.line2": "Вы действительно хотите продолжить?",
	...
	"mco.configure.world.edit.subscreen.experience": "Некоторые опции выключены, поскольку ваш мир в режиме исследований",
	...
	"mco.configure.world.leave.question.line2": "Вы действительно хотите продолжить?",
	"mco.configure.world.loading": "Загрузка реалма",
	...
	"mco.configure.world.name.validation.whitespace": "Не должно начинаться или заканчиваться на пробел. Название будет обрезано.",
	"mco.configure.world.opening": "Открытие реалма...",
	"mco.configure.world.players.error": "Игрока с указанным именем не существует",
	"mco.configure.world.players.invite.duplicate": "Игрок с указанным именем уже был приглашён в реалм",
	"mco.configure.world.players.inviting": "Приглашаем игрока...",
	"mco.configure.world.players.title": "Игроки",
	"mco.configure.world.pvp": "PvP",
	"mco.configure.world.region_preference": "Предпочтительный регион",
	"mco.configure.world.region_preference.title": "Выбор предпочтительного региона",
	"mco.configure.world.reset.question.line1": "Ваш мир будет пересоздан, а текущий будет удалён",
	"mco.configure.world.reset.question.line2": "Вы действительно хотите продолжить?",
	"mco.configure.world.resourcepack.question": "Необходим специальный набор ресурсов для игры в этом реалме\n\nХотите загрузить его и начать игру?",
	...
	"mco.configure.world.restore.question.line2": "Вы действительно хотите продолжить?",
	"mco.configure.world.settings.expired": "Вы не можете редактировать настройки просроченного реалма",
	...
	"mco.configure.world.slot.switch.question.line2": "Вы действительно хотите продолжить?",
	...
	"mco.configure.world.spawnAnimals": "Появление животных",
	"mco.configure.world.spawnMonsters": "Появление монстров",
	"mco.configure.world.spawnNPCs": "Появление NPC",
	...
	"mco.configure.world.subscription.remaining.months": "%[1]s мес.",
	"mco.configure.world.subscription.remaining.months.days": "%[1]s мес., %[2]s дн.",
	"mco.configure.world.subscription.start": "Дата начала",
	"mco.configure.world.subscription.tab": "Подписка",
	...
	"mco.configure.world.switch.slot.subtitle": "Этот мир пуст. Выберите, как создать ваш мир",
	"mco.configure.world.title": "Настройки реалма:",
	"mco.configure.world.uninvite.player": "Вы действительно хотите отозвать приглашение «%s»?",
	...
	"mco.download.confirmation.oversized": "Размер мира, который вы собираетесь загрузить, превышает %s\n\nВы не сможете снова загрузить этот мир в свой реалм",
	...
	"mco.error.invalid.session.message": "Попробуйте перезапустить Minecraft",
	"mco.error.invalid.session.title": "Недействительная сессия",
	...
	"mco.errorMessage.6005": "Мир заблокирован",
	"mco.errorMessage.6006": "Мир устарел",
	"mco.errorMessage.6007": "У игрока слишком много реалмов",
	"mco.errorMessage.6008": "Недопустимое название реалма",
	"mco.errorMessage.6009": "Недопустимое описание реалма",
	"mco.errorMessage.connectionFailure": "Произошла ошибка. Повторите попытку позже.",
	"mco.errorMessage.generic": "Произошла ошибка: ",
	"mco.errorMessage.initialize.failed": "Не удалось создать реалм",
	"mco.errorMessage.noDetails": "Подробности об ошибке не предоставлены",
	"mco.errorMessage.realmsService": "Произошла ошибка (%s):",
	"mco.errorMessage.realmsService.configurationError": "При редактировании параметров мира произошла непредвиденная ошибка",
	"mco.errorMessage.realmsService.connectivity": "Не удалось подключиться к Realms: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Не удалось проверить совместимую версию, получен ответ: %s",
	"mco.errorMessage.retry": "Повторите попытку",
	"mco.errorMessage.serviceBusy": "Realms полностью загружен.\nПопробуйте подключиться к своему реалму через пару минут.",
	...
	"mco.minigame.world.changeButton": "Выберите другую мини-игру",
	...
	"mco.minigame.world.noSelection": "Сделайте выбор",
	...
	"mco.minigame.world.restore.question.line2": "Вы действительно хотите продолжить?",
	"mco.minigame.world.selected": "Выбранная мини-игра:",
	"mco.minigame.world.slot.screen.title": "Смена мира...",
	...
	"mco.notification.transferSubscription.buttonText": "Перенести",
	"mco.notification.transferSubscription.message": "Подписка Java Realms переезжает в Microsoft Store. Сохраните свою подписку!\nПеренесите её сейчас и получите 30 дней бесплатно.\nУзнайте больше о переносе в своём профиле на minecraft.net.",
	"mco.notification.visitUrl.buttonText.default": "Открыть ссылку",
	"mco.notification.visitUrl.message.default": "Перейдите по ссылке ниже",
	"mco.onlinePlayers": "Игроки онлайн",
	"mco.play.button.realm.closed": "Реалм закрыт",
	"mco.question": "Вопрос",
	...
	"mco.reset.world.seed": "Ключ генератора (необязательно)",
	...
	"mco.selectServer.create.subtitle": "Выберите мир для вашего нового реалма",
	...
	"mco.selectServer.expiredTrial": "Пробный период завершён",
	...
	"mco.selectServer.loading": "Загрузка списка реалмов",
	...
	"mco.selectServer.noRealms": "Похоже, у вас нет реалмов. Добавьте новый, чтобы играть вместе с друзьями.",
	...
	"mco.selectServer.popup": "Realms — это безопасный и простой способ игры в Minecraft с друзьями (до десяти человек), поддерживающий мини-игры и уникальные миры. Только владелец платит за реалм.",
	...
	"mco.snapshot.createSnapshotPopup.text": "Вы собираетесь создать бесплатный реалм для предварительной версии, который будет связан с вашей платной подпиской Realms. Новый реалм будет доступен, пока подписка активна. Ваш основной реалм затронут не будет",
	"mco.snapshot.createSnapshotPopup.title": "Создать снапшотный реалм?",
	"mco.snapshot.creating": "Создаём снапшотный реалм...",
	"mco.snapshot.description": "Привязан к %s",
	"mco.snapshot.friendsRealm.downgrade": "Необходима версия %s для присоединения к этому реалму",
	"mco.snapshot.friendsRealm.upgrade": "%s требуется обновить версию реалма, прежде чем вы сможете играть на этой версии",
	"mco.snapshot.paired": "Этот снапшотный реалм связан с %s",
	"mco.snapshot.parent.tooltip": "Для посещения этого реалма вам требуется последний релиз Minecraft",
	"mco.snapshot.start": "Создать бесплатный снапшотный реалм",
	"mco.snapshot.subscription.info": "Это реалм для предварительной версии, который связан с подпиской вашего реалма «%s». Он будет доступен, пока подписка активна.",
	"mco.snapshot.tooltip": "Используйте реалмы для предварительных версий для ознакомления с предстоящими обновлениями Minecraft, где могут быть добавлены новые возможности и другие изменения.\n\nВы можете перейти к своим обычным реалмам в релизной версии игры.",
	"mco.snapshotRealmsPopup.message": "Начиная с версии 23w41a, Realms стал доступен и для снапшотов. Каждая подписка Realms включает в себя бесплатный реалм со снапшотом, отдельный от обычного реалма!",
	"mco.snapshotRealmsPopup.title": "Realms теперь доступен для предварительных версий",
	"mco.snapshotRealmsPopup.urlText": "Подробнее...",
	...
	"mco.template.info.tooltip": "Сайт издателя",
	...
	"mco.upload.close.failure": "Не удалось закрыть ваш реалм. Повторите позднее.",
	...
	"mco.upload.failed.too_big.description": "Выбранный мир слишком большой. Максимальный размер: %s.",
	"mco.upload.failed.too_big.title": "Мир слишком большой",
	"mco.upload.hardcore": "Миры в режиме Хардкор загружать нельзя!",
	"mco.upload.percent": "%s %%",
	"mco.upload.preparing": "Подготовка вашего мира",
	...
	"mco.upload.verifying": "Проверка вашего мира",
	"mco.version": "Версия: %s",
	"mco.warning": "Внимание!",
	"mco.worldSlot.minigame": "Мини-игра",
	"menu.custom_options": "Пользовательские настройки...",
	"menu.custom_options.title": "Пользовательские настройки",
	"menu.custom_options.tooltip": "Примечание: Пользовательские настройки предоставляются сторонними серверами и/или наборами данных.\nБудьте осторожны!",
	"menu.custom_screen_info.button_narration": "Это пользовательский экран. Узнать больше.",
	"menu.custom_screen_info.contents": "Содержимое этого экрана предоставляется сторонними серверами и картами, которые не принадлежат и не управляются Mojang Studios или Microsoft.\n\nБудьте осторожны! Внимательно переходите по ссылкам и не разглашайте свои личные данные (логины, пароли и т. п.).\n\nЕсли этот экран не даёт вам играть, вы также можете отключиться от текущего сервера, нажав на кнопку ниже.",
	"menu.custom_screen_info.disconnect": "Пользовательский экран отклонён",
	"menu.custom_screen_info.title": "Информация о пользовательских экранах",
	"menu.custom_screen_info.tooltip": "Это пользовательский экран. Нажмите, чтобы узнать больше.",
	...
	"menu.multiplayerOptions.applyChanges": "Применить",
	"menu.multiplayerOptions.button": "Сетевая игра...",
	"menu.multiplayerOptions.network": "Сетевая игра",
	"menu.multiplayerOptions.network.header": "Сеть",
	"menu.multiplayerOptions.network.lan": "Локальная сеть",
	"menu.multiplayerOptions.network.lan.tooltip": "Игроки из одной сети могут присоединиться.",
	"menu.multiplayerOptions.network.off": "Выкл",
	"menu.multiplayerOptions.network.off.tooltip": "Никто не может присоединиться.",
	"menu.multiplayerOptions.network.online": "В сети",
	"menu.multiplayerOptions.network.online.tooltip": "Друзья в сети могут присоединиться.",
	"menu.multiplayerOptions.otherPlayers.header": "Другие игроки",
	"menu.multiplayerOptions.publish.started.lan": "Этот мир теперь открыт для локальной сети. Порт: %s",
	"menu.multiplayerOptions.publish.started.online": "Этот мир теперь открыт для сетевой игры.",
	"menu.multiplayerOptions.publish.stopped": "Этот мир больше не открыт для сетевой игры",
	"menu.multiplayerOptions.title": "Настройки сетевой игры",
	...
	"menu.playerReporting.no_players": "В этом мире нет игроков, на которых можно пожаловаться",
	"menu.preparingSpawn": "Подготовка области возрождения: %s%%",
	"menu.quick_actions": "Быстрые действия...",
	"menu.quick_actions.title": "Быстрые действия",
	...
	"menu.server_links": "Ссылки сервера...",
	"menu.server_links.title": "Серверные ссылки",
	...
	"multiplayer.codeOfConduct.check": "Не уведомлять об этом кодексе поведения",
	"multiplayer.codeOfConduct.title": "Кодекс поведения сервера",
	"multiplayer.confirm_command.parse_errors": "Вы пытаетесь выполнить нераспознанную или недопустимую команду.\nВы уверены?\nКоманда: %s",
	"multiplayer.confirm_command.permissions_required": "Вы пытаетесь выполнить команду, которая требует права администратора.\nЭто может негативно повлиять на вашу игру.\nПродолжить?\nКоманда: %s",
	"multiplayer.confirm_command.run_command": "Выполнить команду",
	"multiplayer.confirm_command.signature_required": "Вы пытаетесь выполнить команду для отправки сообщений от вашего имени.\nЕё можно выполнить только из чата.\nКоманда: %s",
	"multiplayer.confirm_command.suggest_command": "Копировать в окно чата",
	"multiplayer.confirm_command.title": "Подтвердить выполнение команды",
	"multiplayer.disconnect.authservers_down": "Службы аутентификации отключены. Повторите попытку позже.",
	"multiplayer.disconnect.bad_chat_index": "Обнаружено пропущенное или внеочередное сообщение от сервера",
	...
	"multiplayer.disconnect.banned.reason.default": "Заблокирован оператором.",
	"multiplayer.disconnect.banned_ip.expiration": "\nВаша блокировка будет снята %s",
	"multiplayer.disconnect.banned_ip.reason": "Ваш IP-адрес заблокирован на этом сервере.\nПричина: %s",
	"multiplayer.disconnect.chat_validation_failed": "Ошибка проверки сообщения в чате",
	"multiplayer.disconnect.code_of_conduct": "Сервер требует принятия кодекса поведения",
	"multiplayer.disconnect.configuration_error": "Непредвиденная ошибка при конфигурации",
	...
	"multiplayer.disconnect.missing_tags": "Получен неполный набор тегов от сервера.\nПожалуйста, свяжитесь с оператором сервера.",
	...
	"multiplayer.disconnect.out_of_order_chat": "Нарушена очерёдность пакетов чата. Проверьте настройки системного времени.",
	...
	"multiplayer.player.list.hp": "%sоз",
	"multiplayer.player.list.narration": "Игроки онлайн: %s",
	"multiplayer.requiredTexturePrompt.disconnect": "Сервер требует пользовательский пакет ресурсов",
	...
	"multiplayer.status.anonymous_player": "Анонимный игрок",
	"multiplayer.status.cancelled": "Отменено",
	"multiplayer.status.cannot_connect": "Невозможно подключиться к серверу",
	"multiplayer.status.cannot_resolve": "Не удалось получить название узла",
	...
	"narration.checkbox.usage.focused.check": "Нажмите Ввод для выбора",
	"narration.checkbox.usage.focused.uncheck": "Нажмите Ввод для снятия выбора",
	"narration.checkbox.usage.hovered": "Чтобы переключить, кликните левой кнопкой мыши",
	"narration.checkbox.usage.hovered.check": "Нажмите левой кнопкой мыши для выбора",
	"narration.checkbox.usage.hovered.uncheck": "Нажмите левой кнопкой мыши для снятия выбора",
	...
	"narration.link.usage.focused": "Нажмите Ввод для перехода по ссылке",
	"narration.link.usage.hovered": "Нажмите на левую кнопку мыши для перехода по ссылке",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Нажмите клавишу Ввод, чтобы начать изменять значение ползунка",
	...
	"narrator.button.difficulty_lock": "Фиксация сложности",
	"narrator.button.difficulty_lock.locked": "Зафиксирована",
	"narrator.button.difficulty_lock.unlocked": "Не зафиксирована",
	...
	"narrator.select.world": "Выбран мир %s, последний запуск: %s, %s, %s, версия: %s",
	...
	"optimizeWorld.confirm.description": "Эта процедура позволит оптимизировать мир так, чтобы все его данные были сохранены в самом новом формате. В зависимости от величины мира, оптимизация может занять много времени. После завершения повысится скорость игры в этом мире, однако он больше не будет совместим со старыми версиями игры. Вы действительно хотите приступить к оптимизации?",
	"optimizeWorld.confirm.proceed": "Создать резервную копию и оптимизировать",
	...
	"optimizeWorld.stage.finished.chunks": "Завершение обновления чанков...",
	"optimizeWorld.stage.finished.entities": "Завершение обновления сущностей...",
	"optimizeWorld.stage.finished.poi": "Завершение обновления точек интереса...",
	"optimizeWorld.stage.upgrading": "Обновление чанков...",
	"optimizeWorld.stage.upgrading.chunks": "Обновление всех чанков...",
	"optimizeWorld.stage.upgrading.entities": "Обновление сущностей...",
	"optimizeWorld.stage.upgrading.poi": "Обновление точек интереса...",
	...
	"options.accessibility.high_contrast_block_outline": "Контрастная обводка блоков",
	"options.accessibility.high_contrast_block_outline.tooltip": "Улучшает видимость обводки при наведении на блок.",
	"options.accessibility.link": "Узнать больше",
	"options.accessibility.menu_background_blurriness": "Размытие фона",
	"options.accessibility.menu_background_blurriness.tooltip": "Изменяет степень размытия фона в меню.",
	"options.accessibility.narrator_hotkey": "Клавиша диктора",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Позволяет включать и выключать диктора нажатием Cmd + B",
	"options.accessibility.narrator_hotkey.tooltip": "Позволяет включать и выключать диктора нажатием Ctrl + B",
	...
	"options.accessibility.tooltip": "Специальные возможности",
	"options.allowCursorChanges": "Изменение курсора",
	"options.allowCursorChanges.tooltip": "Позволяет курсору мыши изменять форму при наведении на определённые элементы интерфейса.",
	"options.allowFriendRequests": "Разрешить запросы",
	"options.allowFriendRequests.tooltip": "Разрешить другим игрокам отправлять вам запросы в друзья",
	...
	"options.blocks": "%s блоков",
	"options.chat": "Настройки чата...",
	"options.chat.color": "Цвета",
	"options.chat.delay": "Задержка чата: %s сек.",
	"options.chat.delay_none": "Задержка чата: выкл.",
	"options.chat.drafts": "Сохранять черновики",
	"options.chat.drafts.tooltip": "Неотправленные сообщения сохранятся и могут быть отправлены при следующем открытии чата.",
	...
	"options.chunkFade": "Проявление чанков",
	"options.chunkFade.none": "Проявление чанков: Нет",
	"options.chunkFade.seconds": "Проявление чанков: %s сек.",
	"options.chunkFade.tooltip": "Длительность проявления чанков при их первой прогрузке.",
	"options.chunks": "%s чанков",
	"options.clouds.fancy": "Объёмные",
	"options.clouds.fast": "Упрощённые",
	"options.controls": "Управление...",
	"options.credits_and_attribution": "Титры и атрибуции...",
	"options.cutoutLeaves": "Просвечивающая листва",
	"options.cutoutLeaves.tooltip": "Позволяет видеть сквозь просветы в листьях. Отключение улучшает производительность.",
	...
	"options.exclusiveFullscreen": "Прямой вывод",
	"options.exclusiveFullscreen.warningTooltip": "Прямой вывод изображения в полноэкранном режиме может помешать работе некоторых методов ввода.",
	...
	"options.friendsList": "Список друзей",
	"options.friendsList.confirm.message": "Используйте список друзей, чтобы отправлять и принимать запросы.\n\nУправляйте настройками безопасности в сети через %s.",
	"options.friendsList.confirm.message.link": "Аккаунт Microsoft",
	"options.friendsList.confirm.title": "Список друзей",
	"options.friendsList.confirm.turnOff": "Выключить",
	"options.friendsList.confirm.turnOn": "Включить",
	"options.fullscreen": "Полноэкранный режим",
	"options.fullscreen.current": "Текущее",
	"options.fullscreen.entry": "%s×%s@%sГц (%sбит)",
	...
	"options.graphics.preset.tooltip": "Устанавливает настройки графики к оптимальным значениям в соответствии с желаемым качеством.",
	"options.graphics.warning.accept": "Всё равно продолжить",
	"options.graphics.warning.cancel": "Отмена",
	...
	"options.graphicsApi": "Графический API",
	"options.graphicsApi.default": "По умолчанию",
	"options.graphicsApi.opengl": "OpenGL",
	"options.graphicsApi.restart": "Перезапустите игру, чтобы сменить графический API.",
	"options.graphicsApi.tooltip": "Выбор графического API для рендеринга. Рекомендуется оставить значение по умолчанию, если у вас нет веской причины для изменений.",
	"options.graphicsApi.tooltip.vulkan": "Экспериментальная функция. Возможно снижение производительности или нестабильная работа на некоторых системах.",
	"options.graphicsApi.vulkan": "Vulkan (эксперименты)",
	"options.guiScale": "Интерфейс",
	"options.guiScale.auto": "Авто",
	"options.hidden": "Скрыт",
	"options.hideLightningFlashes": "Скрыть зарницы",
	"options.hideLightningFlashes.tooltip": "Предотвращает появление вспышек в небе во время ударов молнии или других эффектов окружения. Сами источники вспышек всё ещё будут видны.",
	...
	"options.hideSplashTexts": "Скрывать сплэши",
	"options.hideSplashTexts.tooltip": "Скрывает жёлтые всплывающие надписи в главном меню.",
	"options.improvedTransparency": "Улучшенная прозрачность",
	"options.improvedTransparency.tooltip": "Экспериментальный метод отрисовки погоды, облаков и частиц за полупрозрачными блоками и водой при помощи экранных шейдеров.\nПовлияет на быстродействие графического процессора.",
	"options.inGameNotification": "Внутриигровые уведомления",
	"options.inGameNotification.tooltip": "Оповещения от друзей",
	"options.inactivityFpsLimit": "Ограничение FPS",
	"options.inactivityFpsLimit.afk": "При бездействии",
	"options.inactivityFpsLimit.afk.tooltip": "Ограничивает частоту кадров до 30 спустя минуту ожидания действий со стороны игрока. Спустя ещё 9 минут ограничивает до 10.",
	"options.inactivityFpsLimit.minimized": "В фоне",
	"options.inactivityFpsLimit.minimized.tooltip": "Ограничивает частоту кадров только при сворачивании игры.",
	"options.invertMouse": "Инверсия мыши",
	"options.invertMouseX": "Инверсия оси мыши X",
	"options.invertMouseY": "Инверсия оси мыши Y",
	"options.japaneseGlyphVariants": "Японский стандарт иероглифов",
	"options.japaneseGlyphVariants.tooltip": "Применяет японский вариант восточноазиатских иероглифов в шрифте по умолчанию",
	"options.key.hold": "Удерживание",
	"options.key.toggle": "Переключение",
	"options.language": "Язык...",
	"options.language.narration": "Смена языка",
	"options.language.title": "Язык",
	"options.language.tooltip": "Смена языка",
	"options.languageAccuracyWarning": "(Переводы могут содержать ошибки)",
	...
	"options.maxAnisotropy": "Анизотропная фильтрация",
	"options.maxAnisotropy.tooltip": "Повышение выборки заметно улучшает чёткость текстур, значительно увеличивает расход видеопамяти и может повлиять на производительность. Фильтрация текстур должна быть установлена на «Анизотропная».",
	...
	"options.musicToast": "Оповещение о музыке",
	"options.musicToast.never": "Никогда",
	"options.musicToast.never.tooltip": "Оповещение о музыке не появляется.",
	"options.musicToast.pauseMenu": "В меню",
	"options.musicToast.pauseMenu.tooltip": "Оповещение о воспроизводимой музыке постоянно отображается в меню паузы.",
	"options.musicToast.pauseMenuAndToast": "В игре и меню",
	"options.musicToast.pauseMenuAndToast.tooltip": "Отображает оповещение при начале воспроизведения музыки. Такое же оповещение постоянно отображается в меню паузы.",
	"options.music_frequency": "Периодичность музыки",
	"options.music_frequency.constant": "Постоянная",
	"options.music_frequency.default": "По умолчанию",
	"options.music_frequency.frequent": "Частая",
	"options.music_frequency.tooltip": "Меняет периодичность воспроизведения музыки в игровом мире.",
	...
	"options.needsRestart": "Для применения настройки требуется перезапуск.",
	...
	"options.prioritizeChunkUpdates.byPlayer.tooltip": "Некоторые действия, включая размещение и ломание блоков, будут приводить к мгновенной пересборке чанка.",
	...
	"options.realmsNotifications.button": "Новости и приглашения",
	"options.realmsNotifications.tooltip": "Позволяет получать уведомления о новостях и приглашениях Realms в главном меню и отображает соответствующие значки на кнопке Realms.",
	"options.reducedDebugInfo": "Малый экран отладки",
	"options.renderClouds": "Облака",
	"options.renderCloudsDistance": "Дальность облаков",
	"options.renderDistance": "Прорисовка",
	"options.resourcepack": "Наборы ресурсов...",
	"options.restartRequired": "Для применения некоторых изменений требуется перезапуск игры.",
	"options.rotateWithMinecart": "Поворот с вагонеткой",
	"options.rotateWithMinecart.tooltip": "Должен ли взгляд игрока поворачиваться вместе с вагонеткой. Доступно только в мирах с включённым экспериментом «Улучшения вагонеток».",
	"options.screenEffectScale": "Эффекты укачивания",
	"options.screenEffectScale.tooltip": "Сила эффектов головокружения и искажения от портала Незера.\nПри низких значениях эффект головокружения заменяется зелёным подсвечиванием.",
	"options.sensitivity": "Чувствительность",
	"options.sensitivity.max": "СКОРОСТЬ!",
	"options.sensitivity.min": "не засни...",
	"options.sharePresence": "Статус",
	"options.sharePresence.all": "Видимый",
	"options.sharePresence.all.tooltip": "Статус виден друзьям. Вы отображаетесь в сети, а другие видят, чем вы заняты.",
	"options.sharePresence.limited": "Частичный",
	"options.sharePresence.limited.tooltip": "Статус ограничен. Вы отображаетесь в сети, но друзья не видят, чем вы заняты. Вы можете приглашать их в игру.",
	"options.sharePresence.none": "Невидимый",
	"options.sharePresence.none.tooltip": "Статус скрыт от друзей. Вы отображаетесь не в сети.",
	"options.showNowPlayingToast": "Оповещение о музыке",
	"options.showNowPlayingToast.tooltip": "Отображает оповещение при начале воспроизведения музыки. Такое же оповещение постоянно отображается в меню паузы.",
	"options.showSubtitles": "Субтитры",
	"options.showSubtitles.tooltip": "Включает отображение субтитров к звукам, воспроизводимым в игре.",
	...
	"options.sprintWindow": "Интервал разбега",
	"options.sprintWindow.tooltip": "Временной промежуток в тактах, в котором двойное нажатие клавиши «Вперёд» включает бег.",
	...
	"options.telemetry.disabled": "Телеметрия отключена.",
	"options.telemetry.state.all": "Всё",
	"options.telemetry.state.minimal": "Минимум",
	"options.telemetry.state.none": "Ничего",
	"options.textureFiltering": "Фильтрация текстур",
	"options.textureFiltering.anisotropic": "Анизотропная",
	"options.textureFiltering.anisotropic.tooltip": "Аппаратный метод фильтрации. Влияет на производительность и может существенно увеличить использование видеопамяти. Не поддерживается на некоторых устройствах.",
	"options.textureFiltering.none": "Выкл",
	"options.textureFiltering.none.tooltip": "Текстуры отображаются без фильтрации. При взгляде под углом блоки могут выглядеть размытыми.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Избыточная выборка со сдвинутой сеткой)\nМетод фильтрации на основе шейдера, который улучшает качество текстур с умеренным влиянием на производительность.",
	...
	"options.video.preferences.header": "Параметры",
	"options.video.quality.header": "Качество и производительность",
	"options.videoTitle": "Настройки графики",
	"options.viewBobbing": "Покачивание камеры",
	"options.vignette": "Виньетирование",
	"options.vignette.tooltip": "Малозаметная текстура, которая снижает яркость по краям экрана и предупреждает о близости границы мира.",
	"options.visible": "Показано",
	"options.vsync": "V-Sync",
	"options.weatherRadius": "Радиус эффектов погоды",
	"options.weatherRadius.tooltip": "Радиус отрисовки эффектов дождя и снега. Слабо влияет на производительность.",
	"options.worldOptions.button": "Настройки мира...",
	"options.worldOptions.title": "Настройки мира",
	"outOfMemory.message": "Недостаточно памяти для Minecraft.\n\nВозможно, произошла ошибка в игре, либо для виртуальной машины Java было выделено недостаточно памяти.\n\nЧтобы предотвратить повреждение мира, текущая игра была завершена. Была произведена попытка освободить память, чтобы можно было вернуться в главное меню и продолжить игру. Но это могло не сработать.\n\nПерезапустите игру, если вы снова увидите это сообщение.",
	...
	"pack.dropRejected.message": "Следующие элементы не являются действительными наборами и были пропущены:\n %s",
	"pack.dropRejected.title": "Недействительные наборы",
	...
	"pack.incompatible.confirm.unknown": "Этот набор неисправен или сделан для неизвестной версии Minecraft и может работать неправильно.",
	...
	"pack.incompatible.unknown": "(Неисправен или несовместим)",
	...
	"painting.minecraft.backyard.title": "Задний двор",
	...
	"painting.minecraft.changing.title": "Смена",
	...
	"painting.minecraft.endboss.title": "Финальный босс",
	...
	"painting.minecraft.kebab.title": "Кебаб и три пепперони",
	...
	"painting.minecraft.passage.title": "Переход",
	...
	"painting.minecraft.pointer.title": "Указующий перст",
	"painting.minecraft.pond.author": "Кристоффер Зеттерстранд",
	"painting.minecraft.pond.title": "Пруд",
	...
	"painting.minecraft.prairie_ride.title": "Скачки по прерии",
	...
	"painting.minecraft.tides.title": "Прилив",
	"painting.minecraft.unpacked.author": "Сара Бовинг",
	"painting.minecraft.unpacked.title": "Открытие",
	...
	"parsing.bool.invalid": "Неверное логическое значение: ожидалось «true» или «false», но обнаружено «%s»",
	...
	"particle.invalidOptions": "Не удалось распознать параметры частиц: %s",
	...
	"quickplay.error.invalid_identifier": "Не удалось найти мир с указанным идентификатором",
	"quickplay.error.realm_connect": "Не удалось подключиться к реалму",
	"quickplay.error.realm_permission": "У вас нет разрешения для подключения к этому реалму",
	"quickplay.error.title": "Не удалось подключиться к быстрой игре",
	"realms.configuration.region.australia_east": "Новый Южный Уэльс, Австралия",
	...
	"realms.configuration.region.east_us": "Вирджиния, США",
	"realms.configuration.region.east_us_2": "Северная Каролина, США",
	"realms.configuration.region.france_central": "Франция",
	"realms.configuration.region.japan_east": "Восточная Япония",
	"realms.configuration.region.japan_west": "Западная Япония",
	"realms.configuration.region.korea_central": "Южная Корея",
	"realms.configuration.region.north_central_us": "Иллинойс, США",
	...
	"realms.configuration.region.uae_north": "Объединённые Арабские Эмираты (ОАЭ)",
	"realms.configuration.region.uk_south": "Южная Англия",
	"realms.configuration.region.west_central_us": "Юта, США",
	"realms.configuration.region.west_europe": "Нидерланды",
	"realms.configuration.region.west_us": "Калифорния, США",
	"realms.configuration.region.west_us_2": "Вашингтон, США",
	"realms.configuration.region_preference.automatic_owner": "Автоматически (владелец реалма)",
	"realms.configuration.region_preference.automatic_player": "Автоматически (первый присоединившийся)",
	...
	"recover_world.bug_tracker": "Сообщить об ошибке",
	"recover_world.button": "Попытаться восстановить",
	"recover_world.done.failed": "Не удалось восстановить мир из прежнего состояния.",
	"recover_world.done.success": "Мир успешно восстановлен!",
	"recover_world.done.title": "Восстановление завершено",
	"recover_world.issue.missing_file": "Файл отсутствует",
	"recover_world.issue.none": "Проблем не обнаружено",
	"recover_world.message": "Во время чтения папки мира «%s» возникли следующие проблемы.\nВы можете попытаться восстановить мир из более ранних состояний или оповестить нас об этой проблеме на трекере ошибок.",
	"recover_world.no_fallback": "Нет состояний, доступных для восстановления",
	"recover_world.restore": "Восстановить мир",
	"recover_world.restoring": "Пытаемся восстановить мир...",
	"recover_world.state_entry": "Состояние от %s: ",
	"recover_world.state_entry.unknown": "неизвестно",
	"recover_world.title": "Не удалось загрузить мир",
	"recover_world.warning": "Не удалось загрузить данные о мире",
	...
	"resourcePack.runtime_failure": "Обнаружена ошибка набора ресурсов",
	...
	"restrictions_screen.button": "Ограничения...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Вы можете получать сообщения от игроков",
	"restrictions_screen.permission.receive_player_messages.denied": "Вы не можете получать сообщения от игроков",
	"restrictions_screen.permission.receive_system_messages.allowed": "Вы можете получать системные сообщения от сервера",
	"restrictions_screen.permission.receive_system_messages.denied": "Вы не можете получать системные сообщения от сервера",
	"restrictions_screen.permission.send_commands.allowed": "Вы можете отправлять команды",
	"restrictions_screen.permission.send_commands.denied": "Вы не можете отправлять команды",
	"restrictions_screen.permission.send_messages.allowed": "Вы можете отправлять сообщения в чат",
	"restrictions_screen.permission.send_messages.denied": "Вы не можете отправлять сообщения в чат",
	"restrictions_screen.title": "Ограничения",
	...
	"selectWorld.allowCommands.new": "Использование команд",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Создать резервную копию перед обновлением мира?",
	...
	"selectWorld.backupWarning.downgrade": "Последний раз в этот мир играли в версии %s; вы используете версию %s. Смена версии мира может привести к повреждению — мы не можем гарантировать, что он загрузится или будет работать. Если вы всё ещё хотите продолжить, сделайте резервную копию.",
	...
	"selectWorld.backupWarning.file_fixing_required": "Прежде чем начать игру, необходимо обновить этот мир. Чтобы избежать повреждения мира, мы настоятельно рекомендуем создать резервную копию.",
	"selectWorld.backupWarning.snapshot": "Этот мир сохранён в версии %s; вы используете версию %s. Создайте резервную копию, чтобы не потерять его!",
	"selectWorld.bonusItems": "Бонусный сундук",
	"selectWorld.cheats": "Читы",
	"selectWorld.commands": "Команды",
	...
	"selectWorld.gameMode.creative.line2": "мгновенное разрушение блоков",
	...
	"selectWorld.gameMode.spectator.info": "Смотреть можно, трогать нельзя.",
	...
	"selectWorld.incompatible.description": "Этот мир не может быть открыт в текущей версии игры.\nПоследний раз он запускался в версии %s.",
	"selectWorld.incompatible.info": "Несовместимая версия: %s",
	"selectWorld.incompatible.title": "Несовместимая версия",
	"selectWorld.incompatible.tooltip": "Невозможно открыть мир, так как он был создан в несовместимой версии игры.",
	...
	"selectWorld.locked": "Заблокировано другой запущенной копией Minecraft",
	...
	"selectWorld.moreWorldOptions": "Настройки мира...",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Прежде чем редактировать этот мир, необходимо обновить его до последней версии из-за изменений в формате мира.",
	"selectWorld.requiresFileFixingTooltip.play": "Прежде чем играть в этом мире, необходимо обновить его до последней версии из-за изменений в формате мира.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Прежде чем пересоздать этот мир, необходимо обновить его до последней версии из-за изменений в формате мира.",
	"selectWorld.resource_load": "Подготовка ресурсов...",
	...
	"selectWorld.tooltip.fromNewerVersion2": "загрузка этого мира может вызвать проблемы!",
	...
	"selectWorld.upgrade_and_play": "Обновить и играть",
	...
	"selectWorld.waitingForBackup.message": "В зависимости от размера мира это может занять некоторое время. Пожалуйста, не закрывайте игру и не выключайте компьютер.",
	"selectWorld.waitingForBackup.title": "Создание резервной копии",
	...
	"selectWorld.warning.lowDiskSpace.description": "На вашем устройстве осталось мало места.\nНехватка дискового пространства во время игры может привести к повреждению вашего мира.",
	"selectWorld.warning.lowDiskSpace.title": "Внимание! Недостаточно места на диске!",
	"selectWorld.world": "Мир",
	"selectWorld.world_gen_settings_access": "Не удалось прочитать или получить доступ к файлу настроек генератора мира! %s",
	"selecteWorld.backupRequiredTooltip": "Перед загрузкой мира необходимо создать резервную копию",
	...
	"slot.only_single_allowed": "Разрешены только одиночные слоты, получено «%s»",
	"slot.unknown": "Неизвестная ячейка «%s»",
	"snbt.parser.empty_key": "Ключ не может быть пустым",
	...
	"snbt.parser.expected_float_type": "Ожидалось число с плавающей запятой",
	"snbt.parser.expected_hex_escape": "Ожидался символьный литерал длиной %s",
	"snbt.parser.expected_hex_numeral": "Ожидалось шестнадцатеричное число",
	"snbt.parser.expected_integer_type": "Ожидалось целое число",
	"snbt.parser.expected_non_negative_number": "Ожидалось неотрицательное число",
	"snbt.parser.expected_number_or_boolean": "Ожидалось число или логическое значение",
	"snbt.parser.expected_string_uuid": "Ожидалось строковое представление UUID",
	"snbt.parser.expected_unquoted_string": "Ожидалась строка без кавычек",
	"snbt.parser.infinity_not_allowed": "Бесконечные числа недопустимы",
	"snbt.parser.invalid_array_element_type": "Недействительный тип элемента массива",
	"snbt.parser.invalid_character_name": "Недействительное название Unicode-символа",
	"snbt.parser.invalid_codepoint": "Недопустимое значение Unicode-символа: %s",
	"snbt.parser.invalid_string_contents": "Недопустимое содержимое строки",
	"snbt.parser.invalid_unquoted_start": "Строки без кавычек не могут начинаться с цифр 0-9, + или -",
	"snbt.parser.leading_zero_not_allowed": "Десятичное число не может начинаться с 0",
	"snbt.parser.no_such_operation": "Такой операции нет: %s",
	"snbt.parser.number_parse_failure": "Не удалось распознать число: %s",
	"snbt.parser.undescore_not_allowed": "Символы подчёркивания не допускаются в начале и конце числа",
	"soundCategory.ambient": "Окружение",
	"soundCategory.block": "Блоки",
	"soundCategory.hostile": "Враждебные мобы",
	"soundCategory.master": "Общая громкость",
	"soundCategory.music": "Музыка",
	"soundCategory.neutral": "Мирные мобы",
	"soundCategory.player": "Игроки",
	"soundCategory.record": "Музыкальные блоки",
	"soundCategory.ui": "Интерфейс",
	"soundCategory.voice": "Диктор/Голос",
	...
	"stat.minecraft.happy_ghast_one_cm": "Преодолено на счастливом гасте",
	"stat.minecraft.horse_one_cm": "Преодолено на лошади",
	"stat.minecraft.inspect_dispenser": "Раздатчиков осмотрено",
	"stat.minecraft.inspect_dropper": "Выбрасывателей осмотрено",
	"stat.minecraft.inspect_hopper": "Воронок осмотрено",
	...
	"stat.minecraft.mob_kills": "Убито мобов",
	"stat.minecraft.nautilus_one_cm": "Преодолено на наутилусе",
	...
	"stat.minecraft.pig_one_cm": "Преодолено на свинье",
	...
	"stat.minecraft.strider_one_cm": "Преодолено на лавомерке",
	...
	"stat_type.minecraft.killed_by": "%s убил вас %s раз",
	...
	"structure_block.detect_size": "Определить размер и расположение:",
	...
	"structure_block.integrity": "Целостность конструкции и ключ",
	...
	"structure_block.mode_info.corner": "Угол — маркер размещения и размера",
	...
	"structure_block.size": "Размер конструкции",
	...
	"structure_block.size_failure": "Не удалось определить размер конструкции. Добавьте углы с названием, соответствующим конструкции",
	"structure_block.size_success": "Рассчитан размер конструкции «%s»",
	"structure_block.strict": "Без обновлений:",
	"structure_block.structure_name": "Название конструкции",
	"subtitles.ambient.cave": "Жуткий шум",
	"subtitles.ambient.sound": "Жуткий шум",
	...
	"subtitles.block.anvil.use": "Наковальня использована",
	...
	"subtitles.block.candle.extinguish": "Свеча гаснет",
	"subtitles.block.chest.close": "Сундук закрывается",
	"subtitles.block.chest.locked": "Сундук заперт",
	"subtitles.block.chest.open": "Сундук открывается",
	"subtitles.block.chorus_flower.death": "Цветок хоруса увял",
	"subtitles.block.chorus_flower.grow": "Цветок хоруса растёт",
	...
	"subtitles.block.copper_bulb.turn_off": "Медная лампа выключается",
	"subtitles.block.copper_bulb.turn_on": "Медная лампа включается",
	"subtitles.block.copper_chest.close": "Сундук закрывается",
	"subtitles.block.copper_chest.open": "Сундук открывается",
	"subtitles.block.copper_trapdoor.close": "Люк закрывается",
	"subtitles.block.copper_trapdoor.open": "Люк открывается",
	"subtitles.block.crafter.craft": "Сборщик собрал",
	"subtitles.block.crafter.fail": "Сборщик не собрал",
	...
	"subtitles.block.deadbush.idle": "Шуршание",
	...
	"subtitles.block.dispenser.fail": "Раздатчик даёт холостой ход",
	"subtitles.block.door.toggle": "Дверь скрипит",
	"subtitles.block.dried_ghast.ambient": "Высохший гаст шипит",
	"subtitles.block.dried_ghast.ambient_water": "Высохший гаст впитывает влагу",
	...
	"subtitles.block.generic.break": "Блок сломан",
	"subtitles.block.generic.fall": "Что-то упало на блок",
	...
	"subtitles.block.honey_block.slide": "Скольжение вниз по блоку мёда",
	"subtitles.block.iron_trapdoor.close": "Люк закрывается",
	"subtitles.block.iron_trapdoor.open": "Люк открывается",
	...
	"subtitles.block.respawn_anchor.ambient": "Завывание якоря возрождения",
	...
	"subtitles.block.sand.wind": "Шум ветра",
	...
	"subtitles.block.shelf.activate": "Полка включается",
	"subtitles.block.shelf.deactivate": "Полка выключается",
	"subtitles.block.shelf.multi_swap": "Предметы заменены",
	"subtitles.block.shelf.place_item": "Предмет поставлен",
	"subtitles.block.shelf.single_swap": "Предмет заменён",
	"subtitles.block.shelf.take_item": "Предмет взят",
	"subtitles.block.shulker_box.close": "Шалкеровый ящик закрывается",
	"subtitles.block.shulker_box.open": "Шалкеровый ящик открывается",
	...
	"subtitles.block.sniffer_egg.hatch": "Нюхачонок вылупился",
	"subtitles.block.sniffer_egg.plop": "Нюхач снёс яйцо",
	"subtitles.block.sponge.absorb": "Губка впитывает",
	"subtitles.block.sweet_berry_bush.pick_berries": "Ягоды сорваны",
	"subtitles.block.trapdoor.close": "Люк закрывается",
	"subtitles.block.trapdoor.open": "Люк открывается",
	"subtitles.block.trapdoor.toggle": "Люк скрипит",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Зловещий предмет подготавливается",
	"subtitles.block.trial_spawner.ambient": "Рассадник испытаний потрескивает",
	"subtitles.block.trial_spawner.ambient_charged": "Зловещее потрескивание",
	"subtitles.block.trial_spawner.ambient_ominous": "Зловещее потрескивание",
	"subtitles.block.trial_spawner.charge_activate": "Знамение охватывает рассадник испытаний",
	"subtitles.block.trial_spawner.close_shutter": "Рассадник испытаний закрывается",
	"subtitles.block.trial_spawner.detect_player": "Рассадник испытаний заряжается",
	"subtitles.block.trial_spawner.eject_item": "Рассадник испытаний выбрасывает предметы",
	"subtitles.block.trial_spawner.ominous_activate": "Знамение охватывает рассадник испытаний",
	"subtitles.block.trial_spawner.open_shutter": "Рассадник испытаний раскрывается",
	"subtitles.block.trial_spawner.spawn_item": "Зловещий предмет выпадает",
	"subtitles.block.trial_spawner.spawn_item_begin": "Зловещий предмет появляется",
	"subtitles.block.trial_spawner.spawn_mob": "Моб появляется",
	"subtitles.block.tripwire.attach": "Растяжка натянута",
	"subtitles.block.tripwire.click": "Щелчок растяжки",
	"subtitles.block.tripwire.detach": "Растяжка снята",
	"subtitles.block.vault.activate": "Хранилище зажигается",
	"subtitles.block.vault.ambient": "Хранилище потрескивает",
	"subtitles.block.vault.close_shutter": "Хранилище закрывается",
	"subtitles.block.vault.deactivate": "Хранилище гаснет",
	"subtitles.block.vault.eject_item": "Хранилище выдаёт предмет",
	"subtitles.block.vault.insert_item": "Хранилище отпирается",
	"subtitles.block.vault.insert_item_fail": "Хранилище отвергает предмет",
	"subtitles.block.vault.open_shutter": "Хранилище открывается",
	"subtitles.block.vault.reject_rewarded_player": "Хранилище отвергает игрока",
	"subtitles.block.water.ambient": "Вода течёт",
	"subtitles.block.wet_sponge.dries": "Губка высыхает",
	...
	"subtitles.entity.armadillo.ambient": "Броненосец фыркает",
	"subtitles.entity.armadillo.brush": "Щиток счищен",
	"subtitles.entity.armadillo.death": "Броненосец погибает",
	"subtitles.entity.armadillo.eat": "Броненосец ест",
	"subtitles.entity.armadillo.hurt": "Броненосец ранен",
	"subtitles.entity.armadillo.hurt_reduced": "Броненосец защищается",
	"subtitles.entity.armadillo.land": "Броненосец приземляется",
	"subtitles.entity.armadillo.peek": "Броненосец выглядывает",
	"subtitles.entity.armadillo.roll": "Броненосец сворачивается",
	"subtitles.entity.armadillo.scute_drop": "Броненосец сбрасывает щиток",
	"subtitles.entity.armadillo.unroll_finish": "Броненосец разворачивается",
	"subtitles.entity.armadillo.unroll_start": "Броненосец выглядывает",
	...
	"subtitles.entity.baby_cat.ambient": "Котёнок мяукает",
	"subtitles.entity.baby_cat.beg_for_food": "Котёнок выпрашивает еду",
	"subtitles.entity.baby_cat.death": "Котёнок погибает",
	"subtitles.entity.baby_cat.eat": "Котёнок ест",
	"subtitles.entity.baby_cat.hiss": "Котёнок шипит",
	"subtitles.entity.baby_cat.hurt": "Котёнок ранен",
	"subtitles.entity.baby_cat.purr": "Котёнок мурлычет",
	"subtitles.entity.baby_chicken.ambient": "Цыплёнок пищит",
	"subtitles.entity.baby_chicken.death": "Цыплёнок погибает",
	"subtitles.entity.baby_chicken.hurts": "Цыплёнок ранен",
	"subtitles.entity.baby_horse.ambient": "Жеребёнок ржёт",
	"subtitles.entity.baby_horse.angry": "Жеребёнок ржёт",
	"subtitles.entity.baby_horse.breathe": "Жеребёнок пыхтит",
	"subtitles.entity.baby_horse.death": "Жеребёнок погибает",
	"subtitles.entity.baby_horse.eat": "Жеребёнок ест",
	"subtitles.entity.baby_horse.hurt": "Жеребёнок ранен",
	"subtitles.entity.baby_horse.land": "Жеребёнок приземляется",
	"subtitles.entity.baby_nautilus.ambient": "Маленький наутилус щебечет",
	"subtitles.entity.baby_nautilus.ambient_land": "Маленький наутилус щебечет",
	"subtitles.entity.baby_nautilus.death": "Маленький наутилус погибает",
	"subtitles.entity.baby_nautilus.death_land": "Маленький наутилус погибает",
	"subtitles.entity.baby_nautilus.eat": "Маленький наутилус ест",
	"subtitles.entity.baby_nautilus.hurt": "Маленький наутилус ранен",
	"subtitles.entity.baby_nautilus.hurt_land": "Маленький наутилус ранен",
	"subtitles.entity.baby_nautilus.swim": "Маленький наутилус плывёт",
	"subtitles.entity.baby_pig.ambient": "Поросёнок хрюкает",
	"subtitles.entity.baby_pig.death": "Поросёнок погибает",
	"subtitles.entity.baby_pig.eat": "Поросёнок ест",
	"subtitles.entity.baby_pig.hurt": "Поросёнок ранен",
	"subtitles.entity.baby_wolf.ambient": "Волчонок тявкает",
	"subtitles.entity.baby_wolf.death": "Волчонок погибает",
	"subtitles.entity.baby_wolf.growl": "Волчонок рычит",
	"subtitles.entity.baby_wolf.hurt": "Волчонок ранен",
	"subtitles.entity.baby_wolf.pant": "Волчонок фыркает",
	"subtitles.entity.baby_wolf.whine": "Волчонок скулит",
	...
	"subtitles.entity.bat.takeoff": "Летучая мышь взлетает",
	...
	"subtitles.entity.blaze.shoot": "Всполох выстрелил",
	"subtitles.entity.boat.paddle_land": "Вёсла гребут",
	"subtitles.entity.boat.paddle_water": "Вёсла гребут",
	"subtitles.entity.bogged.ambient": "Болотник стучит костями",
	"subtitles.entity.bogged.death": "Болотник погибает",
	"subtitles.entity.bogged.hurt": "Болотник ранен",
	"subtitles.entity.breeze.charge": "Вихрь копит заряд",
	"subtitles.entity.breeze.death": "Вихрь погибает",
	"subtitles.entity.breeze.deflect": "Вихрь отражает",
	"subtitles.entity.breeze.hurt": "Вихрь ранен",
	"subtitles.entity.breeze.idle_air": "Вихрь летит",
	"subtitles.entity.breeze.idle_ground": "Вихрь шумит",
	"subtitles.entity.breeze.inhale": "Вихрь вдыхает",
	"subtitles.entity.breeze.jump": "Вихрь взмывает",
	"subtitles.entity.breeze.land": "Вихрь приземляется",
	"subtitles.entity.breeze.shoot": "Вихрь выстрелил",
	"subtitles.entity.breeze.slide": "Вихрь скользит",
	"subtitles.entity.breeze.whirl": "Вихрь завертелся",
	"subtitles.entity.breeze.wind_burst": "Заряд ветра взрывается",
	...
	"subtitles.entity.camel_husk.ambient": "Верблюд-кадавр хрипит",
	"subtitles.entity.camel_husk.dash": "Рывок верблюда-кадавра",
	"subtitles.entity.camel_husk.dash_ready": "Верблюд-кадавр отдохнул",
	"subtitles.entity.camel_husk.death": "Верблюд-кадавр погибает",
	"subtitles.entity.camel_husk.eat": "Верблюд-кадавр ест",
	"subtitles.entity.camel_husk.hurt": "Верблюд-кадавр ранен",
	"subtitles.entity.camel_husk.saddle": "Верблюд-кадавр осёдлан",
	"subtitles.entity.camel_husk.sit": "Верблюд-кадавр садится",
	"subtitles.entity.camel_husk.stand": "Верблюд-кадавр встаёт",
	...
	"subtitles.entity.copper_golem.death": "Медный голем погибает",
	"subtitles.entity.copper_golem.hurt": "Медный голем ранен",
	"subtitles.entity.copper_golem.item_drop": "Медный голем кладёт предмет",
	"subtitles.entity.copper_golem.item_no_drop": "Медный голем не может положить предмет",
	"subtitles.entity.copper_golem.no_item_get": "Медный голем берёт предмет",
	"subtitles.entity.copper_golem.no_item_no_get": "Медный голем не может взять предмет",
	"subtitles.entity.copper_golem.spawn": "Медный голем появляется",
	"subtitles.entity.copper_golem.spin": "Медный голем крутит головой",
	"subtitles.entity.copper_golem_become_statue": "Медный голем замер",
	"subtitles.entity.copper_golem_oxidized.death": "Медный голем погибает",
	"subtitles.entity.copper_golem_oxidized.hurt": "Медный голем ранен",
	"subtitles.entity.copper_golem_oxidized.spin": "Медный голем крутит головой",
	"subtitles.entity.copper_golem_weathered.death": "Медный голем погибает",
	"subtitles.entity.copper_golem_weathered.hurt": "Медный голем ранен",
	"subtitles.entity.copper_golem_weathered.spin": "Медный голем крутит головой",
	...
	"subtitles.entity.creaking.freeze": "Скрипун замирает",
	"subtitles.entity.creaking.spawn": "Скрипун появляется",
	"subtitles.entity.creaking.sway": "Скрипун хрустнул",
	"subtitles.entity.creaking.twitch": "Скрипун дёргается",
	...
	"subtitles.entity.donkey.angry": "Осёл ржёт",
	...
	"subtitles.entity.donkey.jump": "Осёл прыгает",
	...
	"subtitles.entity.egg.throw": "Яйцо летит",
	...
	"subtitles.entity.elder_guardian.flop": "Древний страж плещется",
	...
	"subtitles.entity.ender_eye.launch": "Око Эндера брошено",
	"subtitles.entity.ender_pearl.throw": "Эндер-жемчуг летит",
	...
	"subtitles.entity.experience_orb.pickup": "Опыт получен",
	...
	"subtitles.entity.generic.extinguish_fire": "Огонь гаснет",
	...
	"subtitles.entity.generic.wind_burst": "Заряд ветра взрывается",
	...
	"subtitles.entity.ghast.shoot": "Гаст выстрелил",
	...
	"subtitles.entity.goat.long_jump": "Коза прыгает",
	...
	"subtitles.entity.guardian.flop": "Страж плещется",
	...
	"subtitles.entity.hoglin.angry": "Хоглин сердито ревёт",
	...
	"subtitles.entity.horse.ambient": "Лошадь ржёт",
	"subtitles.entity.horse.angry": "Лошадь ржёт",
	"subtitles.entity.horse.armor": "Конская броня надета",
	"subtitles.entity.horse.breathe": "Лошадь пыхтит",
	...
	"subtitles.entity.horse.jump": "Лошадь прыгает",
	...
	"subtitles.entity.item.break": "Предмет сломан",
	"subtitles.entity.item.pickup": "Предмет подобран",
	...
	"subtitles.entity.minecart.inside": "Вагонетка гремит",
	"subtitles.entity.minecart.inside_underwater": "Вагонетка гремит под водой",
	"subtitles.entity.minecart.riding": "Вагонетка катится",
	"subtitles.entity.mooshroom.convert": "Муушрум трансформируется",
	"subtitles.entity.mooshroom.eat": "Муушрум ест",
	"subtitles.entity.mooshroom.milk": "Муушрум подоен",
	"subtitles.entity.mooshroom.suspicious_milk": "Муушрум подоен загадочно",
	"subtitles.entity.mule.ambient": "Мул ревёт",
	"subtitles.entity.mule.angry": "Мул ржёт",
	...
	"subtitles.entity.mule.jump": "Мул прыгает",
	"subtitles.entity.nautilus.ambient": "Наутилус стрекочет",
	"subtitles.entity.nautilus.ambient_land": "Наутилус стрекочет",
	"subtitles.entity.nautilus.dash": "Рывок наутилуса",
	"subtitles.entity.nautilus.dash_land": "Рывок наутилуса",
	"subtitles.entity.nautilus.dash_ready": "Наутилус отдохнул",
	"subtitles.entity.nautilus.dash_ready_land": "Наутилус отдохнул",
	"subtitles.entity.nautilus.death": "Наутилус погибает",
	"subtitles.entity.nautilus.death_land": "Наутилус погибает",
	"subtitles.entity.nautilus.eat": "Наутилус ест",
	"subtitles.entity.nautilus.hurt": "Наутилус ранен",
	"subtitles.entity.nautilus.hurt_land": "Наутилус ранен",
	"subtitles.entity.nautilus.swim": "Наутилус плывёт",
	...
	"subtitles.entity.parched.ambient": "Пустынник стучит костями",
	"subtitles.entity.parched.death": "Пустынник погибает",
	"subtitles.entity.parched.hurt": "Пустынник ранен",
	...
	"subtitles.entity.parrot.imitate.blaze": "Попугай подражает всполоху",
	"subtitles.entity.parrot.imitate.bogged": "Попугай подражает болотнику",
	"subtitles.entity.parrot.imitate.breeze": "Попугай подражает вихрю",
	"subtitles.entity.parrot.imitate.camel_husk": "Попугай хрипит как верблюд-кадавр",
	"subtitles.entity.parrot.imitate.creaking": "Попугай подражает скрипуну",
	...
	"subtitles.entity.parrot.imitate.parched": "Попугай подражает пустыннику",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Попугай стонет как лошадь-зомби",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Попугай булькает как наутилус-зомби",
	"subtitles.entity.parrot.imitate.zombie_villager": "Попугай стонет как крестьянин-зомби",
	"subtitles.entity.phantom.ambient": "Фантом визжит",
	...
	"subtitles.entity.pig.eat": "Свинья ест",
	...
	"subtitles.entity.player.death": "Игрок погибает",
	...
	"subtitles.entity.player.teleport": "Телепортация игрока",
	"subtitles.entity.polar_bear.ambient": "Белый медведь ревёт",
	"subtitles.entity.polar_bear.ambient_baby": "Белый медвежонок ворчит",
	"subtitles.entity.polar_bear.death": "Белый медведь погибает",
	"subtitles.entity.polar_bear.hurt": "Белый медведь ранен",
	"subtitles.entity.polar_bear.warning": "Белый медведь рычит",
	"subtitles.entity.potion.splash": "Бутылочка разбивается",
	"subtitles.entity.potion.throw": "Бутылочка брошена",
	...
	"subtitles.entity.rabbit.jump": "Кролик прыгает",
	...
	"subtitles.entity.shulker.close": "Шалкер закрывается",
	"subtitles.entity.shulker.death": "Шалкер погибает",
	"subtitles.entity.shulker.hurt": "Шалкер ранен",
	"subtitles.entity.shulker.open": "Шалкер открывается",
	"subtitles.entity.shulker.shoot": "Шалкер выстрелил",
	"subtitles.entity.shulker.teleport": "Шалкер телепортируется",
	"subtitles.entity.shulker_bullet.hit": "Снаряд шалкера разрывается",
	"subtitles.entity.shulker_bullet.hurt": "Снаряд шалкера разбит",
	...
	"subtitles.entity.skeleton.shoot": "Скелет выстрелил",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Лошадь-скелет прыгает",
	...
	"subtitles.entity.snowball.throw": "Снежок летит",
	...
	"subtitles.entity.sulfur_cube.push": "Серный куб сдвинут",
	"subtitles.entity.sulfur_cube.squish": "Серный куб прыгает",
	...
	"subtitles.entity.turtle.egg_crack": "Черепашье яйцо треснуло",
	...
	"subtitles.entity.vex.charge": "Вредина вопит",
	...
	"subtitles.entity.vindicator.ambient": "Поборник бормочет",
	...
	"subtitles.entity.wind_charge.throw": "Заряд ветра летит",
	"subtitles.entity.wind_charge.wind_burst": "Заряд ветра взрывается",
	"subtitles.entity.witch.ambient": "Ведьма хихикает",
	...
	"subtitles.entity.wolf.pant": "Волк фыркает",
	...
	"subtitles.entity.zoglin.angry": "Зоглин сердито ревёт",
	...
	"subtitles.entity.zombie.destroy_egg": "Черепашье яйцо растоптано",
	...
	"subtitles.entity.zombie_horse.angry": "Лошадь-зомби ржёт",
	"subtitles.entity.zombie_horse.death": "Лошадь-зомби погибает",
	"subtitles.entity.zombie_horse.eat": "Лошадь-зомби ест",
	"subtitles.entity.zombie_horse.hurt": "Лошадь-зомби ранена",
	"subtitles.entity.zombie_nautilus.ambient": "Наутилус-зомби булькает",
	"subtitles.entity.zombie_nautilus.ambient_land": "Наутилус-зомби булькает",
	"subtitles.entity.zombie_nautilus.dash": "Рывок наутилуса-зомби",
	"subtitles.entity.zombie_nautilus.dash_land": "Рывок наутилуса-зомби",
	"subtitles.entity.zombie_nautilus.dash_ready": "Наутилус-зомби отдохнул",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Наутилус-зомби отдохнул",
	"subtitles.entity.zombie_nautilus.death": "Наутилус-зомби погибает",
	"subtitles.entity.zombie_nautilus.death_land": "Наутилус-зомби погибает",
	"subtitles.entity.zombie_nautilus.eat": "Наутилус-зомби ест",
	"subtitles.entity.zombie_nautilus.hurt": "Наутилус-зомби ранен",
	"subtitles.entity.zombie_nautilus.hurt_land": "Наутилус-зомби ранен",
	"subtitles.entity.zombie_nautilus.swim": "Наутилус-зомби плывёт",
	...
	"subtitles.event.mob_effect.bad_omen": "Знамение сбылось",
	"subtitles.event.mob_effect.raid_omen": "Рейд приближается",
	"subtitles.event.mob_effect.trial_omen": "Зловещее испытание приближается",
	"subtitles.event.raid.horn": "Рёв зловещего рога",
	"subtitles.item.armor.equip": "Снаряжение надето",
	"subtitles.item.armor.equip_chain": "Звяканье кольчуги",
	"subtitles.item.armor.equip_copper": "Треньканье медной брони",
	...
	"subtitles.item.armor.equip_nautilus": "Броня наутилуса надета",
	"subtitles.item.armor.equip_netherite": "Лязг незеритовой брони",
	"subtitles.item.armor.equip_turtle": "Черепаший панцирь стучит",
	"subtitles.item.armor.equip_wolf": "Волчья броня надета",
	"subtitles.item.armor.unequip_nautilus": "Броня наутилуса снята",
	...
	"subtitles.item.bucket.empty": "Ведро опустошено",
	"subtitles.item.bucket.fill": "Ведро наполнено",
	...
	"subtitles.item.elytra.flying": "Свист ветра",
	...
	"subtitles.item.golden_dandelion.unuse": "Золотой одуванчик возобновляет взросление",
	"subtitles.item.golden_dandelion.use": "Золотой одуванчик останавливает взросление",
	...
	"subtitles.item.horse_armor.unequip": "Конская броня снята",
	"subtitles.item.ink_sac.use": "Чернила нанесены",
	"subtitles.item.lead.break": "Поводок порвался",
	"subtitles.item.lead.tied": "Поводок привязан",
	"subtitles.item.lead.untied": "Поводок развязан",
	"subtitles.item.llama_carpet.unequip": "Ковёр снят",
	"subtitles.item.lodestone_compass.lock": "Намагниченный компас нацелен на магнетит",
	"subtitles.item.mace.smash_air": "Булава сокрушает",
	"subtitles.item.mace.smash_ground": "Булава сокрушает",
	"subtitles.item.nautilus_saddle_equip": "Наутилус осёдлан",
	"subtitles.item.nautilus_saddle_underwater_equip": "Наутилус осёдлан",
	"subtitles.item.nether_wart.plant": "Росток посажен",
	"subtitles.item.ominous_bottle.dispose": "Бутылочка разбивается",
	"subtitles.item.saddle.unequip": "Седло снято",
	"subtitles.item.shears.shear": "Щелчок ножниц",
	"subtitles.item.shears.snip": "Лязг ножниц",
	"subtitles.item.shield.block": "Удар по щиту",
	"subtitles.item.shovel.flatten": "Рытьё лопатой",
	"subtitles.item.spear.attack": "Тычок копьём",
	"subtitles.item.spear.hit": "Удар копьём",
	"subtitles.item.spear.lunge": "Рывок с копьём",
	"subtitles.item.spear.use": "Выставление копья",
	"subtitles.item.spear_wood.attack": "Тычок копьём",
	"subtitles.item.spear_wood.hit": "Удар копьём",
	"subtitles.item.spear_wood.use": "Выставление копья",
	...
	"subtitles.item.underwater_saddle.equip": "Седло надето",
	"subtitles.item.wolf_armor.break": "Волчья броня сломана",
	"subtitles.item.wolf_armor.crack": "Волчья броня трескается",
	"subtitles.item.wolf_armor.damage": "Волчья броня поглощает урон",
	...
	"subtitles.ui.hud.bubble_pop": "Запас воздуха убывает",
	"subtitles.ui.loom.take_result": "Ткацкий станок использован",
	"subtitles.ui.stonecutter.take_result": "Камнерез использован",
	"subtitles.weather.end_flash": "Рокот зарницы Энда",
	"subtitles.weather.rain": "Дождь идёт",
	"symlink_warning.message": "Загрузка миров из папок с символическими ссылками может повлечь за собой негативные последствия, если вы не до конца понимаете, что делаете. Посетите %s, чтобы узнать больше.",
	"symlink_warning.message.pack": "Загрузка наборов данных с символическими ссылками может повлечь за собой негативные последствия, если вы не до конца понимаете, что делаете. Посетите %s, чтобы узнать больше.",
	"symlink_warning.message.world": "Загрузка миров из папок с символическими ссылками может повлечь за собой негативные последствия, если вы не до конца понимаете, что делаете. Посетите %s, чтобы узнать больше.",
	"symlink_warning.more_info": "Дополнительная информация",
	"symlink_warning.title": "Папка мира содержит символические ссылки",
	"symlink_warning.title.pack": "Добавленные наборы содержат символические ссылки",
	"symlink_warning.title.world": "Папка мира содержит символические ссылки",
	...
	"telemetry.event.graphics_capabilities.description": "Это событие сообщает о возможностях используемого графического устройства.",
	"telemetry.event.graphics_capabilities.title": "Возможности графического устройства",
	"telemetry.event.optional": "%s (необязательно)",
	"telemetry.event.optional.disabled": "%s (необязательно) — Отключено",
	"telemetry.event.p2p_connection.description": "Этот параметр помогает нам оценить надёжность и производительность одноранговых (P2P) соединений между игроками. Он фиксирует успешность подключения, тип используемого кандидата ICE (протокола для установки P2P-соединений), а также время, затраченное на установку соединения.",
	"telemetry.event.p2p_connection.title": "Одноранговое соединение",
	...
	"telemetry.event.world_unloaded.description": "В паре с «Загрузка мира» это событие позволяет оценить продолжительность игровой сессии.\nПродолжительность (в секундах и тактах) определяется при завершении игры (отключение от сервера, возвращение в главное меню).",
	...
	"telemetry.property.backend_failure_message.title": "Ошибка инициализации графического API: подробности",
	"telemetry.property.backend_failure_missing_capabilities.title": "Ошибка инициализации графического API: отсутствующие возможности",
	"telemetry.property.backend_failure_reason.title": "Ошибка инициализации графического API: причина",
	"telemetry.property.backend_name.title": "Название графического API",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "Этап отказа",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Время установления интерактивного соединения (ICE) в миллисекундах",
	"telemetry.property.p2p_connection_ice_path.title": "Маршрут установления интерактивного соединения (ICE)",
	"telemetry.property.p2p_connection_local_candidate_type.title": "Тип локального кандидата",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Тип удалённого кандидата",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Время установления соединения (миллисекунды)",
	"telemetry.property.p2p_connection_successful.title": "Подключение успешно",
	"telemetry.property.p2p_connection_total_time_ms.title": "Общее время подключения (в миллисекундах)",
	"telemetry.property.platform.title": "Платформа",
	"telemetry.property.realms_map_content.title": "Карта Realms (название мини-игры)",
	...
	"telemetry_info.button.privacy_statement": "Заявление о конфиденциальности",
	"telemetry_info.button.show_data": "Мои данные",
	"telemetry_info.opt_in.description": "Я даю согласие на отправку дополнительных телеметрических данных",
	...
	"test.error.block_property_mismatch": "Ожидалось свойство %s со значением %s; получено: %s",
	"test.error.block_property_missing": "Свойство блока отсутствует; ожидалось свойство %s со значением %s",
	"test.error.entity_property": "Сущность %s провалила тест: %s",
	"test.error.entity_property_details": "Сущность %s провалила тест: %s; ожидалось: %s; получено: %s",
	"test.error.expected_block": "Ожидался блок %s; получено: %s",
	"test.error.expected_block_present": "Ожидалось наличие блока %s",
	"test.error.expected_block_tag": "Ожидался блок из #%s, получено: %s",
	"test.error.expected_container_contents": "Контейнер должен содержать: %s",
	"test.error.expected_container_contents_single": "Контейнер должен содержать один %s",
	"test.error.expected_empty_container": "Контейнер должен быть пустым",
	"test.error.expected_entity": "Ожидался %s",
	"test.error.expected_entity_around": "Ожидалось %s возле точки %s, %s, %s",
	"test.error.expected_entity_count": "Ожидалось %s сущностей типа %s; обнаружено %s",
	"test.error.expected_entity_data": "Ожидались данные сущности со значением %s; получено: %s",
	"test.error.expected_entity_data_predicate": "Несоответствие данных сущности %s",
	"test.error.expected_entity_effect": "Ожидался %s с эффектом «%s» %s",
	"test.error.expected_entity_having": "Инвентарь сущности должен содержать %s",
	"test.error.expected_entity_holding": "Сущность должна держать %s",
	"test.error.expected_entity_in_test": "Ожидалось присутствие %s в тесте",
	"test.error.expected_entity_not_touching": "Не ожидалось соприкосновение %s с точкой %s, %s, %s (относительно: %s, %s, %s)",
	"test.error.expected_entity_touching": "Ожидалось соприкосновение %s с точкой %s, %s, %s (относительно: %s, %s, %s)",
	"test.error.expected_item": "Ожидался предмет типа %s",
	"test.error.expected_items_count": "Ожидалось %s предметов типа %s; обнаружено %s",
	"test.error.fail": "Выполнены условия провала",
	"test.error.invalid_block_type": "Найден неожиданный тип блока: %s",
	"test.error.missing_block_entity": "Отсутствует блок-сущность",
	"test.error.not_a_block_item": "Указанный блок не имеет соответствующего ему предмета",
	"test.error.position": "%s в точке %s, %s, %s (относительно: %s, %s, %s) в такте %s",
	"test.error.sequence.condition_already_triggered": "Условие уже задействовано в такте %s",
	"test.error.sequence.condition_not_triggered": "Условие не задействовано",
	"test.error.sequence.invalid_tick": "Ошибка в недопустимом такте: ожидается %s",
	"test.error.sequence.minimum_tick": "Завершено до указанного такта: ожидалось прождать %s",
	"test.error.sequence.not_completed": "Тест завершился по таймеру до завершения последовательности",
	"test.error.set_biome": "Не удалось задать биом для теста",
	"test.error.spawn_failure": "Не удалось создать сущность %s",
	"test.error.state_not_equal": "Неверное состояние. Ожидалось: %s; получено: %s",
	"test.error.structure.failure": "Не удалось разместить тестовую конструкцию для %s",
	"test.error.tick": "%s в такте %s",
	"test.error.ticking_without_structure": "Проверка хода тактов перед установкой конструкции",
	"test.error.timeout.no_result": "Не получено результатов в течение %s тактов",
	"test.error.timeout.no_sequences_finished": "Ни одна последовательность не завершилась в течение %s тактов",
	"test.error.too_many_entities": "Ожидалась одна сущность типа %s рядом с точкой %s, %s, %s; обнаружено %s",
	"test.error.unexpected_block": "Не ожидался блок %s",
	"test.error.unexpected_entity": "Не ожидался %s",
	"test.error.unexpected_item": "Не ожидался предмет типа %s",
	"test.error.unknown": "Неизвестная внутренняя ошибка: %s",
	"test.error.value_not_equal": "Ожидалось %s со значением %s; получено: %s",
	"test.error.value_not_in_between": "Ожидалось %s со значением между %s и %s; получено: %s",
	"test.error.wrong_block_entity": "Неверный тип блока-сущности: %s",
	"test_block.error.missing": "В тестовой конструкции отсутствует блок «%s»",
	"test_block.error.too_many": "Слишком много блоков %s",
	"test_block.invalid_timeout": "Неверное время ожидания (%s); должно быть положительное число тактов",
	"test_block.message": "Сообщение:",
	"test_block.mode.accept": "Успех",
	"test_block.mode.fail": "Отказ",
	"test_block.mode.log": "Журнал",
	"test_block.mode.start": "Запуск",
	"test_block.mode_info.accept": "Режим успеха — достижение успеха для (части) теста",
	"test_block.mode_info.fail": "Режим отказа — тестирование на ошибку",
	"test_block.mode_info.log": "Режим журнала — запись сообщения в журнал",
	"test_block.mode_info.start": "Режим запуска — начальная точка теста",
	"test_instance.action.reset": "Сбросить и загрузить",
	"test_instance.action.run": "Загрузить и запустить",
	"test_instance.action.save": "Сохранить конструкцию",
	"test_instance.description.batch": "Окружение: %s",
	"test_instance.description.failed": "Провал: %s",
	"test_instance.description.function": "Функция: %s",
	"test_instance.description.invalid_id": "Неверный идентификатор теста",
	"test_instance.description.no_test": "Нет такого теста",
	"test_instance.description.structure": "Конструкция: %s",
	"test_instance.description.type": "Тип: %s",
	"test_instance.type.block_based": "Тест на блоках",
	"test_instance.type.function": "Тест встроенной функции",
	"test_instance_block.entities": "Сущности:",
	"test_instance_block.error.no_test": "Невозможно выполнить тестовый экземпляр в точке %s, %s, %s: тест не определён",
	"test_instance_block.error.no_test_structure": "Невозможно запустить тестовый экземпляр в точке %s, %s, %s: тестовая конструкция отсутствует",
	"test_instance_block.error.unable_to_save": "Невозможно сохранить шаблон тестовой конструкции у тестового экземпляра в точке %s, %s, %s",
	"test_instance_block.invalid": "[недействительно]",
	"test_instance_block.reset_success": "Сброшен тест %s",
	"test_instance_block.rotation": "Поворот:",
	"test_instance_block.size": "Размер тестовой конструкции",
	"test_instance_block.starting": "Запуск теста %s",
	"test_instance_block.test_id": "Идентификатор тестового экземпляра",
	"title.32bit.deprecation": "Обнаружена 32-разрядная система. В будущем запуск игры станет невозможен, потребуется 64-разрядная система!",
	...
	"title.credits": "© Mojang AB. Распространение запрещено!",
	"title.multiplayer.disabled": "Сетевая игра отключена. Проверьте настройки своего аккаунта Microsoft.",
	"title.multiplayer.disabled.banned.name": "Вы должны сменить имя, прежде чем снова играть по сети",
	...
	"title.multiplayer.online": "Сетевая игра (онлайн)",
	...
	"upgradeWorld.aborted.message": "Это могло произойти, если во время обновления доступ к миру получила другая программа. Попробуйте перезагрузить компьютер и повторить попытку. Если проблема сохранится, сообщите об ошибке.",
	"upgradeWorld.aborted.reportBug": "Сообщить об ошибке",
	"upgradeWorld.aborted.title": "Не удалось обновить мир",
	"upgradeWorld.canceled.message": "Мир остаётся таким, каким был прежде.",
	"upgradeWorld.canceled.title": "Обновление мира отменено",
	"upgradeWorld.done": "Обновление мира завершено",
	"upgradeWorld.failed_cleanup.message": "Мир был успешно обновлён до текущей версии и теперь доступен в списке миров. При очистке устаревших данных возникли проблемы, поэтому название папки мира было изменено на %s.",
	"upgradeWorld.failed_cleanup.title": "Мир успешно обновлён",
	"upgradeWorld.info.converted": "Обновлено: %s",
	"upgradeWorld.info.file_fix_stage": "Этап: %s/%s",
	"upgradeWorld.info.scanning": "Сканирование файлов...",
	"upgradeWorld.info.total": "Всего: %s",
	"upgradeWorld.joinNow": "Хотите присоединиться к миру сейчас?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Перемещение файлов",
	"upgradeWorld.progress.type.legacy_structures": "Обновление устаревших строений",
	"upgradeWorld.progress.type.region": "Обновление регионов",
	"upgradeWorld.symlink.message": "Выбранный мир содержит символьные ссылки.\nНекоторые шаги, требуемые для обновления мира до текущей версии, не поддерживают использование символьных ссылок. Чтобы обновить мир, сначала замените ссылки реальными файлами.",
	"upgradeWorld.symlink.title": "Невозможно обновить мир",
	"upgradeWorld.title": "Обновление файлов мира",
}
