// Code generated by tools/gen_lang.go from 26.1/li_li.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"accessibility.onboarding.screen.narrator": "Druk op enter um de verteller in te schakele",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Maak ein gedecoreerde pot van veer aerdewerksjerve",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Met zurg gerestaureerd",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Laes de stroumsterkte van ein bewerkte bokekas aaf met ein vergelieker",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Sterke verhaole",
	...
	"advancements.adventure.salvage_sherd.description": "Borstel ein verdach blok um ein aerdewerksjerf te kriege",
	"advancements.adventure.salvage_sherd.title": "Archeologisch onderzeuk",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Gebroek de volgende smeedssjablone ten minste éín kier: piek, snoet, rib, hoeder, stilte, ergernis, getieje, paadvinder",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Modieus",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Maak ein versierd stuk harnas in ein smeedstaofel",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Niej oeterlik",
	...
	"advancements.husbandry.feed_snifflet.description": "Voor ein snuffelaertje",
	...
	"advancements.husbandry.obtain_sniffer_egg.description": "Verkrieg ein snuffelaersei",
	...
	"advancements.husbandry.plant_any_sniffer_seed.description": "Plant ein snuffelaerszaad",
	"advancements.husbandry.plant_any_sniffer_seed.title": "Telen van 't verleje",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Gebroek ein kampveur um honing oet ein biejekorf te verzamele met ein glazen fles, zonder det de bieje van slag rake",
	...
	"argument.time.tick_count_too_low": "Aantal ticks meug neet lieger zien dan %s, %s gevonde",
	...
	"attribute.name.generic.max_absorption": "Max",
	...
	"biome.minecraft.cherry_grove": "Keseboumgaard",
	...
	"block.minecraft.cherry_button": "Kesehouten knop",
	"block.minecraft.cherry_door": "Kesehouten duuer",
	"block.minecraft.cherry_fence": "Kesehouten hek",
	"block.minecraft.cherry_fence_gate": "Kesehouten peurtje",
	"block.minecraft.cherry_hanging_sign": "Kesehouten hangbord",
	"block.minecraft.cherry_leaves": "Keseblajere",
	"block.minecraft.cherry_log": "Keseboumstam",
	"block.minecraft.cherry_planks": "Kesehouten plenk",
	"block.minecraft.cherry_pressure_plate": "Kesehouten drukplaat",
	"block.minecraft.cherry_sapling": "Kesekiemplant",
	"block.minecraft.cherry_shelf": "Cherry Shelf",
	"block.minecraft.cherry_sign": "Kesehouten bord",
	"block.minecraft.cherry_slab": "Kesehouten plaat",
	"block.minecraft.cherry_stairs": "Kesehouten traeje",
	"block.minecraft.cherry_trapdoor": "Kesehouten valloek",
	"block.minecraft.cherry_wall_hanging_sign": "Kesehouten oethangbord",
	"block.minecraft.cherry_wall_sign": "Kesehouten bord aon moor",
	"block.minecraft.cherry_wood": "Kesehout",
	...
	"block.minecraft.pink_petals": "Roze bleumblajere",
	...
	"block.minecraft.pitcher_crop": "Baekerplantgewas",
	"block.minecraft.pitcher_plant": "Baekerplant",
	...
	"block.minecraft.potted_cherry_sapling": "Opgepotte kesekiemplant",
	...
	"block.minecraft.potted_torchflower": "Opgepotte fakkelbloom",
	...
	"block.minecraft.sniffer_egg": "Snuffelaersei",
	...
	"block.minecraft.stripped_cherry_log": "Gestripte keseboumstam",
	"block.minecraft.stripped_cherry_wood": "Gestript kesehout",
	...
	"block.minecraft.suspicious_gravel": "Verdach grind",
	"block.minecraft.suspicious_sand": "Verdach zand",
	...
	"block.minecraft.torchflower": "Fakkelbloom",
	"block.minecraft.torchflower_crop": "Fakkelbloomgewas",
	...
	"chat.disabled.launcher": "Kann net, kann net.",
	...
	"chat.queue": "[+%s lien(e) in aafwachting]",
	...
	"commands.banip.info": "Deze blokkade haet invlood op %s speuler(s): %s",
	...
	"commands.clear.success.multiple": "%s veurwerp(e) oet d'n inventaris van %s speulers verwiederd",
	"commands.clear.success.single": "%s veurwerp(e) oet d'n inventaris van %s verwiederd",
	"commands.clear.test.multiple": "%s euvereinkomend(e) veurwerp(e) gevonde in d'n inventaris van %s speulers",
	"commands.clear.test.single": "%s euvereinkomend(e) veurwerp(e) gevonde in d'n inventaris van %s",
	...
	"commands.damage.invulnerable": "Doelwit is onaantastbaar veur 't opgegaeve type schaje",
	"commands.damage.success": "%s schajepunten toegebrach aan %s",
	...
	"commands.data.modify.expected_value": "Waarde verwach: %s gekrege",
	...
	"commands.datapack.list.enabled.success": "Packs(s) packs",
	...
	"commands.debug.function.success.multiple": "%s opdracht(e) van %s functies opgespoord en geplaatst in bestand %s",
	"commands.debug.function.success.single": "%s opdracht(e) van functie '%s' opgespoord en geplaatst in bestand %s",
	...
	"commands.fill.success": "Blok(ken) succesvol gevuld)",
	...
	"commands.function.success.multiple": "%s opdracht(e) van %s functies oetgevoord",
	"commands.function.success.multiple.result": "%s functies oetgevoerd",
	"commands.function.success.single": "%s opdracht(e) van functie '%s' oetgevoord",
	...
	"commands.perf.stopped": "Prestatieprofilering gestopt nao %s seconde en %s tick(s) (%s tick(s) per seconde)",
	...
	"commands.ride.already_riding": "%s beriedt %s al",
	"commands.ride.dismount.success": "%s stopte %s te berieje",
	"commands.ride.mount.failure.cant_ride_players": "Speulers kinne neet waere bereje",
	"commands.ride.mount.failure.generic": "%s kon %s neet berieje",
	"commands.ride.mount.failure.loop": "Entiteit kin zichzelf of zien passagiers neet berieje",
	"commands.ride.mount.failure.wrong_dimension": "Kin entiteit neet berieje in andere dimensie",
	"commands.ride.mount.success": "%s begon %s te berieje",
	"commands.ride.not_riding": "%s beriedt gen voertuig",
	...
	"commands.schedule.cleared.success": "%s planning(e) met ID %s verwiederd",
	"commands.schedule.created.function": "Functie '%s' gepland nao %s tick(s) op speltied %s",
	...
	"commands.setidletimeout.success": "Maximale tied dea ein speuler inactief meug zien ingesteld op %s minuut/minuten",
	...
	"commands.spreadplayers.failed.entities": "%s entiteit(e) rondum %s, %s verspreije misluk (te vuul entiteite veur de ruumte - probeer ein verspreijing van maximaal %s)",
	...
	"commands.spreadplayers.failed.teams": "%s team(s) rondum %s, %s verspreije misluk (te vuul entiteite veur de ruumte - probeer ein verspreijing van maximaal %s)",
	"commands.spreadplayers.success.entities": "%s speuler(s) verspreid euver %s, %s, met ein gemiddelde aafstand van %s blök tussen speulers",
	"commands.spreadplayers.success.teams": "%s team(s) verspreid euver %s, %s, met ein gemiddelde aafstand van %s blök tussen teams",
	...
	"commands.worldborder.damage.buffer.success": "Waereldgrensschadebuffer ingesteld op %s blök",
	"commands.worldborder.get": "D'n waereldgrens is momenteel %s blök breid",
	...
	"commands.worldborder.set.immediate": "Waereldgrens ingesteld op %s blök breid",
	"commands.worldborder.set.shrink": "Waereldgrens wuurd euver %[2]s seconde verkleind tot ein breidte van %[1]s blök",
	"commands.worldborder.warning.distance.failed": "Niks gewijzigd, ómdet de weltgrenswaarschuwingsafstand al deze aafsjtandj is",
	"commands.worldborder.warning.distance.success": "Waereldgrenswaarschuwingaafstand ingesteld op %s blök",
	"commands.worldborder.warning.time.failed": "Niks gewijzigd, ómdet de wereldgrenswaarschuwingstijd al deze tijd is",
	"commands.worldborder.warning.time.success": "Waereldgrenswaarschuwingstied ingesteld op %s seconde",
	...
	"container.upgrade.error_tooltip": "Veurwerp kin op dees manier neet geüpgrade waere",
	"container.upgrade.missing_template_tooltip": "Smeedssjabloen toevoege",
	"controls.keybinds": "Toetsbindinge...",
	"controls.keybinds.duplicateKeybinds": "Deze toets is ouk in gebroek veur:\n%s",
	...
	"createWorld.tab.more.title": "Mier",
	"createWorld.tab.world.title": "Waereld",
	"credits_and_attribution.button.attribution": "Attributie",
	"credits_and_attribution.button.credits": "Vermeldinge",
	"credits_and_attribution.button.licenses": "Licenties",
	"credits_and_attribution.screen.title": "Vermeldinge en attributie",
	...
	"datapackFailure.safeMode.failed.description": "Deze waereld bevat ongeldige of beschajigde gegaeves.",
	"datapackFailure.safeMode.failed.title": "Lade van waereld in veilige modus misluk.",
	...
	"death.attack.dragonBreath": "Drakenaom roesterde %[1]s",
	"death.attack.dragonBreath.player": "Drakenaom van %[2]s roesterde %[1]s",
	...
	"death.attack.genericKill": "%[1]s woar gedoed",
	"death.attack.genericKill.player": "%[1]s woar gedoed tiedens 't vechte mit %[2]s",
	...
	"death.attack.mace_smash": "%[1]s woar geklapt door %[2]s",
	"death.attack.mace_smash.item": "%[1]s woar geklapt door %[2]s mit %[3]s",
	...
	"death.attack.message_too_long": "Eigenlik is 't berich te langk um volledig te toene. Sorry! Heej is d'n verkleinde versie: %s",
	...
	"debug.creative_spectator.error": "Neet meugelik um van sjpelmodus te verandere; gên toestemming",
	"debug.creative_spectator.help": "F3 + N = Cycle previous game mode <-> spectator",
	"debug.dump_dynamic_textures": "Dynamische texture opgeslage in %s",
	"debug.dump_dynamic_textures.help": "F3 + S = Dynamische texture dumpen",
	...
	"entity.minecraft.item_display": "Veurwerpweergave",
	...
	"entity.minecraft.oak_boat": "Eikehoute boeat",
	...
	"entity.minecraft.sniffer": "Snuffelaer",
	...
	"gamerule.commandModificationBlockLimit": "Blokkelimiet modificatie-opdrachte",
	"gamerule.commandModificationBlockLimit.description": "Aantal blokke det in éín kier kin waere aangepas door ein opdrach zoeas /fill of /clone.",
	...
	"gamerule.doVinesSpread": "Liane verspreije zich",
	"gamerule.doVinesSpread.description": "Bepaolt of liane zich willekeurig verspreije naor aangrenzende blokke. Haet gen effect op andere liaansoorte zoeas hangende en verwikkelde klimop.",
	...
	"gui.abuseReport.comments": "Opmerkinge",
	...
	"gui.abuseReport.discard.draft": "Opslaon as klad",
	"gui.abuseReport.discard.return": "Verder bewerke",
	"gui.abuseReport.discard.title": "Melding en beschrieving weggoeie?",
	"gui.abuseReport.draft.content": "Wilse de bestaonde melding verder bewerke of weggoeie en ein nieje maken?",
	"gui.abuseReport.draft.discard": "Weggoeie",
	"gui.abuseReport.draft.edit": "Verder bewerke",
	...
	"gui.abuseReport.name.reporting": "Doe gifs \"%s\" aan",
	"gui.abuseReport.name.title": "Report Inappropriate Player Name",
	"gui.abuseReport.observed_what": "Woveur gifse dit aan?",
	"gui.abuseReport.read_info": "Mier euver aangeve",
	...
	"gui.abuseReport.reason.generic": "Ich wil eun aangeve",
	"gui.abuseReport.reason.generic.description": "Ich erger mich aan dun / de hubbe get gedoan wat ich neet leuk vinj.",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Seksueel neet gepast",
	...
	"gui.abuseReport.title": "Speuler aangeve",
	...
	"gui.banned.name.title": "Noam Maag Neet in Multiplayer",
	"gui.banned.reason.defamation_impersonation_false_information": "Identiteitsfraude of informatie deile um andere oet te buite of te misleiden",
	"gui.banned.reason.drugs": "Verwiezinge naor illegale drugs",
	"gui.banned.reason.extreme_violence_or_gore": "Aafbeeldinge van excessief geweld of blojerige beelden",
	"gui.banned.reason.false_reporting": "Euvermatige valse of onnauwkeurige meldinge",
	"gui.banned.reason.fraud": "Frauduleus verkriege of gebroeke van inhald",
	"gui.banned.reason.generic_violation": "Schending van gemeinschapsrichtlienen",
	"gui.banned.reason.harassment_or_bullying": "Beledigend taolgebroek op ein gerichte, schajelike manier",
	"gui.banned.reason.hate_speech": "Haatzaaije of discriminatie",
	"gui.banned.reason.hate_terrorism_notorious_figure": "Verwiezinge naor haatgroepe, terroristische organisaties of beruchte figuren",
	"gui.banned.reason.imminent_harm_to_person_or_property": "Intentie um schaje toe te bringe aan echte persoeane of eigendommen",
	"gui.banned.reason.nudity_or_pornography": "Ontuchtig of pornografisch materiaal weergaeve",
	"gui.banned.reason.sexually_inappropriate": "Onderwerpe of inhald van seksuele aard",
	...
	"gui.chatReport.title": "Speuler aangeve",
	...
	"gui.remove": "Remove",
	"gui.report_to_server": "Aangeve aan d'r Server",
	...
	"gui.toRealms": "Trök naor de Realmsliest",
	"gui.toTitle": "Trök noa 't titelscherm",
	"gui.toWorld": "Trök naor de waereldliest",
	...
	"item.minecraft.angler_pottery_sherd": "Aerdewerksjerf 'visser'",
	"item.minecraft.apple": "Appel",
	"item.minecraft.archer_pottery_shard": "Archer Pottery Shard",
	"item.minecraft.archer_pottery_sherd": "Aerdewerksjerf 'baogsjötter'",
	...
	"item.minecraft.arms_up_pottery_sherd": "Aerdewerksjerf 'gehaeve erm'",
	...
	"item.minecraft.blade_pottery_sherd": "Aerdewerksjerf 'zjwaard'",
	...
	"item.minecraft.brewer_pottery_sherd": "Aerdewerksjerf 'broewer'",
	...
	"item.minecraft.burn_pottery_sherd": "Aerdewerksjerf 'branje'",
	...
	"item.minecraft.cherry_boat": "Kesehouten boeat",
	"item.minecraft.cherry_chest_boat": "Kesehouten boeat met kis",
	...
	"item.minecraft.danger_pottery_sherd": "Aerdewerksjerf 'gevaor'",
	...
	"item.minecraft.explorer_pottery_sherd": "Aerdewerksjerf 'ontdekker'",
	...
	"item.minecraft.friend_pottery_sherd": "Aerdewerksjerf 'vrind'",
	...
	"item.minecraft.heart_pottery_sherd": "Aerdewerksjerf 'hert'",
	"item.minecraft.heartbreak_pottery_shard": "Heartbreak Pottery Shard",
	"item.minecraft.heartbreak_pottery_sherd": "Aerdewerksjerf 'gebraoke hert'",
	...
	"item.minecraft.howl_pottery_sherd": "Aerdewerksjerf 'bäöke'",
	...
	"item.minecraft.miner_pottery_sherd": "Aerdewerksjerf 'mienwirker'",
	...
	"item.minecraft.mourner_pottery_sherd": "Aerdewerksjerf 'roew'",
	...
	"item.minecraft.music_disc_relic": "Meziekplaat",
	...
	"item.minecraft.pitcher_plant": "Baekerplant",
	"item.minecraft.pitcher_pod": "Baekerplantbaeker",
	"item.minecraft.plenty_pottery_shard": "Plenty Pottery Shard",
	"item.minecraft.plenty_pottery_sherd": "Aerdewerksjerf 'euvervloed'",
	...
	"item.minecraft.prize_pottery_sherd": "Aerdewerksjerf 'pries'",
	...
	"item.minecraft.sheaf_pottery_sherd": "Aerdewerksjerf 'schoef'",
	...
	"item.minecraft.shelter_pottery_sherd": "Aerdewerksjerf 'sjoelplaats'",
	...
	"item.minecraft.skull_pottery_sherd": "Aerdewerksjerf 'schedel'",
	...
	"item.minecraft.smithing_template.armor_trim.additions_slot_description": "Staaf of kristal toevoge",
	"item.minecraft.smithing_template.armor_trim.applies_to": "Harnas",
	"item.minecraft.smithing_template.armor_trim.base_slot_description": "Harnasstuk toevoge",
	"item.minecraft.smithing_template.armor_trim.ingredients": "Staave en kristalle",
	"item.minecraft.smithing_template.ingredients": "Ingrediënte:",
	"item.minecraft.smithing_template.netherite_upgrade.additions_slot_description": "Netherietstaaf toevoge",
	"item.minecraft.smithing_template.netherite_upgrade.applies_to": "Diamante oetrusting",
	"item.minecraft.smithing_template.netherite_upgrade.base_slot_description": "Diamanten harnas, waape of gereidschap toevoge",
	...
	"item.minecraft.sniffer_spawn_egg": "Snuffelaerspawnei",
	"item.minecraft.snort_pottery_shard": "Snort Pottery Shard",
	"item.minecraft.snort_pottery_sherd": "Aerdewerksjerf 'snuffele'",
	...
	"item.minecraft.torchflower_seeds": "Fakkelbloemzaaije",
	...
	"mco.account.privacyinfo": "Mojang implementeert bepaalde procedures om kinderen te beschermen en hun privacy te waarborgen, woeonder 't naleven van de Children's Online Privacy Protection Act (COPPA) en de Algemene verordening gegevensbescherming (AVG).\n\nJe moet misschien toestemming vaan dien ouder(s)/verzorger(s) vraogen vóórdat je dien Realmsaccount gaat gebruiken.\n\nAls je een ouder Minecraftaccount gebruikt waarbij je je aanmeldt met d'n gebroekersnaam, moet je dit account migreren nao een Mojangaccount om Realms te gebruiken.",
	"mco.account.update": "Account beejwerken",
	"mco.activity.noactivity": "Gen activiteit in d'n aafgeloupe %s daag",
	...
	"mco.brokenworld.nonowner.error": "Wacht op de eigenaar van de Realm om de waereldj te herkriege",
	...
	"mco.configure.world.edit.slot.name": "Weltnaam",
	...
	"mco.configure.world.invite.narration": "De hebs %s nieje oetnuudiginge",
	...
	"mco.configure.world.subscription.recurring.info": "Veranderinge aan dien Realmsabonnement, zoeas 't verlenge d'rvan of 't oetschakele van terugkierend facturere, wuurd neet getoend tot d'n volgende factureringsdatum.",
	...
	"mco.error.invalid.session.title": "Ging goeje id",
	...
	"mco.invites.pending": "Nieje oetnuudiginge!",
	...
	"mco.notification.dismiss": "Sloeten",
	...
	"mco.notification.visitUrl.buttonText.default": "Link aopene",
	"mco.notification.visitUrl.message.default": "Bezeuk onderstaonde link",
	...
	"mco.snapshotRealmsPopup.urlText": "Leer Mier",
	...
	"mco.time.daysAgo": "%[1]s dag(e) truk",
	"mco.time.hoursAgo": "%[1]s sjtond(e) truk",
	"mco.time.minutesAgo": "%[1]s minut(e) truk",
	"mco.time.now": "noe",
	"mco.time.secondsAgo": "%[1]s sekonde() truk",
	...
	"mco.upload.failed.too_big.title": "Welt te groet",
	...
	"multiplayer.disconnect.invalid_public_key_signature.new": "Ongeldige handteikening veur aopebare profielsleutel.\nProbeer dien spel opniej te starte.",
	...
	"multiplayer.lan.server_found": "Nieje server gevonde: %s",
	...
	"multiplayer.player.list.narration": "Speulers online: %s",
	...
	"narration.tab_navigation.usage": "Druk op Ctrl en Tab um van tabblaad te wissele",
	...
	"narrator.position.tab": "Tabblaad %s van %s geselecteerd",
	"narrator.ready_to_play": "Klaor um te speule",
	...
	"options.accessibility.high_contrast": "Hoeg contrast",
	"options.accessibility.high_contrast.error.tooltip": "Bronpakket veur hoeg contrast neet beschikbaar",
	"options.accessibility.high_contrast.tooltip": "Verhuugt 't contrast van interface-elementen",
	...
	"options.accessibility.title": "Toegankelijksheids Instellingen...",
	...
	"options.credits_and_attribution": "Vermeldinge en attributie",
	...
	"options.damageTiltStrength": "Schajekanteling",
	"options.damageTiltStrength.tooltip": "Wievuul de camera kantelt wannierse gewond raks.",
	...
	"options.difficulty.easy.info": "Vijandige waezes spawnen, maar deenen minder schaje toe. De hongerbalk rak laeg en vermindert dan dien gezondheid tot vief hartjes.",
	"options.difficulty.hard": "Meujelik",
	"options.difficulty.hard.info": "Vijandige waezes spawnen en deenen mier schaje toe. D'n hongerbalk rak laeg en vermindert dan al dien gezondheid.",
	"options.difficulty.hardcore": "Hardcore",
	"options.difficulty.normal": "Normaal",
	"options.difficulty.normal.info": "Vijandige waezes spawnen en deenen de standaardaantal schaje toe. D'n hongerbalk rak laeg en vermindert dan dien gezondheid tot ein half hartje.",
	"options.difficulty.online": "Servermoeilijkheidsgraad",
	"options.difficulty.peaceful": "Vredig",
	"options.difficulty.peaceful.info": "Gen vijandige waezes en allein sommige neutrale waezes spawnen. De hongerbalk rak noeit laeg en gezondheid wuurd met d'n tied beejgevuld.",
	...
	"options.glintSpeed.tooltip": "Bepaolt wie snel 't glanseffect bewaegt euver betoverde veurwerpe.",
	"options.glintStrength": "Glanssterkte",
	"options.glintStrength.tooltip": "Bepaolt d'n transparantie van 't glanseffect op betoverde veurwerpe.",
	...
	"options.notifications.display_time": "Meldingsdeur",
	"options.notifications.display_time.tooltip": "Bepaolt wie lang meldinge op 't scherm zichtbaar blieve.",
	"options.off": "UIT",
	...
	"options.realmsNotifications": "Realmsniejs en -oetnuudiginge",
	...
	"quickplay.error.invalid_identifier": "Gen waereld gevonde met d'n opgegaeve identiteit",
	"quickplay.error.realm_connect": "Kin gen verbinding met de Realm make",
	"quickplay.error.realm_permission": "Gen toestemming um met deze Realm te verbinde",
	"quickplay.error.title": "Snel speule misluk",
	...
	"resourcePack.high_contrast.name": "Hoeg contrast",
	...
	"selectWorld.experimental.message": "Waes veurzichtig!\nDeze configuratie veriest functies die nog in ontwikkeling zien. De waereld kin crashen, kapotgaon of gen toekomstige versies ondersteune.",
	"selectWorld.experimental.title": "Waarsjoewing: experimentele functies",
	"selectWorld.experiments": "Experimenten",
	"selectWorld.experiments.info": "Experimenten zien potentiële nieje functies. Waes veurzichtig, want d'r kinne dinge misgaon. Experimenten kinne neet waere oetgeschakeld nao 't creëre van d'n waereld.",
	...
	"selectWorld.gameMode.adventure.info": "Net wie d'n euverlevingsmodus, maar de kins blök neet plaatsen of verwiedere.",
	...
	"selectWorld.gameMode.creative.info": "Maak, bouw en ontdek ongelimiteerd. De kins vlege, hebs eindeloze materiale en de kins neet gewond rake door monsters.",
	...
	"selectWorld.gameMode.hardcore.info": "Net wie d'n euverlevingsmodus, maar vastgezet op niveau 'moeilijk'. De kins neet respawnen wannierse sterfs.",
	...
	"selectWorld.gameMode.spectator.info": "De kins kieke, maar neet aanrake.",
	"selectWorld.gameMode.spectator.line1": "De kins kieke, maar neet aanrake",
	"selectWorld.gameMode.survival": "Euverlaeve",
	"selectWorld.gameMode.survival.info": "Ontdek mysterieuze waerelde waorse bouws, verzamels, maks en taege monsters vechs.",
	...
	"selectWorld.locked": "Vergrendeld deur een andere instantie van Minecraft",
	"selectWorld.mapFeatures": "Structuren gînnereren",
	"selectWorld.mapFeatures.info": "Dörpe, scheepswrakke en mier",
	...
	"selectWorld.targetFolder": "Wuurdt opgeslaage in: %s",
	...
	"stat.minecraft.interact_with_smithing_table": "Interacties met smeedstaofel",
	...
	"subtitles.block.smithing_table.use": "Smeedstaofel wuurd gebroek",
	"subtitles.block.smoker.smoke": "Rauker raukt",
	"subtitles.block.sniffer_egg.crack": "Snuffelaersei braekt",
	"subtitles.block.sniffer_egg.hatch": "Snuffelaersei kump oet",
	"subtitles.block.sniffer_egg.plop": "Snuffelaer plopt",
	...
	"subtitles.entity.sniffer.death": "Snuffelaer sterft",
	"subtitles.entity.sniffer.digging": "Snuffelaer graaft",
	"subtitles.entity.sniffer.digging_stop": "Snuffelaer steit op",
	"subtitles.entity.sniffer.drop_seed": "Snuffelaer luut zaod valle",
	"subtitles.entity.sniffer.eat": "Snuffelaer aet",
	"subtitles.entity.sniffer.egg_crack": "Sniffer Egg cracks",
	"subtitles.entity.sniffer.egg_hatch": "Sniffer Egg hatches",
	"subtitles.entity.sniffer.happy": "Snuffelaer geneet",
	"subtitles.entity.sniffer.hurt": "Snuffelaer rak gewond",
	"subtitles.entity.sniffer.idle": "Snuffelaer knort",
	"subtitles.entity.sniffer.scenting": "Snuffelaer ruukt",
	"subtitles.entity.sniffer.searching": "Snuffelaer zeukt",
	"subtitles.entity.sniffer.sniffing": "Snuffelaer snuft",
	"subtitles.entity.sniffer.step": "Snuffelaer loupt",
	...
	"subtitles.item.brush.brushing.gravel": "Grind waerd geborsteld",
	"subtitles.item.brush.brushing.gravel.complete": "Grind weggeborsteld",
	"subtitles.item.brush.brushing.sand": "Zand wuurd geborsteld",
	...
	"trim_material.minecraft.copper": "Kaupermateriaal",
	"trim_material.minecraft.diamond": "Diamantmateriaal",
	"trim_material.minecraft.emerald": "Smaragdmateriaal",
	"trim_material.minecraft.gold": "Goldmateriaal",
	"trim_material.minecraft.iron": "Iezermateriaal",
	"trim_material.minecraft.lapis": "Lapismateriaal",
	...
	"trim_pattern.minecraft.coast": "Kustharnasversiering",
	"trim_pattern.minecraft.dune": "Duinharnasversiering",
	"trim_pattern.minecraft.eye": "Ougharnasversiering",
	"trim_pattern.minecraft.flow": "Flow Armor Trim",
	"trim_pattern.minecraft.host": "Harnasversiering 'gasthieër'",
	"trim_pattern.minecraft.raiser": "Harnasversiering 'fokker'",
	"trim_pattern.minecraft.rib": "Ribharnasversiering",
	"trim_pattern.minecraft.sentry": "Sjildwachtharnasversiering",
	"trim_pattern.minecraft.shaper": "Harnasversiering 'vormer'",
	"trim_pattern.minecraft.silence": "Harnasversiering 'stilte'",
	"trim_pattern.minecraft.snout": "Snoetharnasversiering",
	"trim_pattern.minecraft.spire": "Piekharnasversiering",
	"trim_pattern.minecraft.tide": "Getiejeharnasversiering",
	"trim_pattern.minecraft.vex": "Ergernisharnasversiering",
	"trim_pattern.minecraft.ward": "Hoederharnasversiering",
	"trim_pattern.minecraft.wayfinder": "Harnasversiering 'paadvinder'",
	"trim_pattern.minecraft.wild": "Verwilderde harnasversiering",
	...
	"upgrade.minecraft.netherite_upgrade": "Netheriete upgrade",
