// Code generated by tools/gen_lang.go from 26.1/nl_nl.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Toegankelijkheidsinstellingen",
	"accessibility.onboarding.accessibility.button.narration": "Toegankelijkheidsinstellingen",
	...
	"addServer.resourcePack": "Serverbronpakketten",
	...
	"advMode.notEnabled": "Opdrachtblokken zijn niet ingeschakeld",
	"advMode.notEnabled.spawner": "Monsterkooien zijn niet ingeschakeld",
	"advMode.previousOutput": "Vorige uitvoer",
	"advMode.setCommand": "Consoleopdracht voor blok instellen",
	"advMode.setCommand.disabled": "Opdracht ingesteld: %s, maar opdrachtblokken zijn nog uitgeschakeld",
	...
	"advancements.adventure.avoid_vibration.description": "Sluip in de buurt van een sculksensor of hoeder, zodat ze jou niet opmerken",
	"advancements.adventure.avoid_vibration.title": "Wereldrecord sluipen",
	"advancements.adventure.blowback.description": "Dood een vlaag met een door een vlaag afgevuurde windvlaag",
	"advancements.adventure.blowback.title": "Zware tegenslag",
	"advancements.adventure.brush_armadillo.description": "Gebruik een borstel om een hoornplaat van een gordeldier te krijgen",
	"advancements.adventure.brush_armadillo.title": "Wat een plaatje",
	"advancements.adventure.bullseye.description": "Raak de roos van een doelwit op ten minste 30 meter afstand",
	...
	"advancements.adventure.crafters_crafting_crafters.description": "Sta in de buurt van een vervaardigingsmachine die een vervaardigingsmachine vervaardigt",
	"advancements.adventure.crafters_crafting_crafters.title": "Autoproductie",
	...
	"advancements.adventure.heart_transplanter.title": "Hartenter",
	...
	"advancements.adventure.lighten_up.description": "Verhelder een koperen lamp door de oxidatie eraf te schrapen met een bijl",
	"advancements.adventure.lighten_up.title": "Een lichter vooruitzicht",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Betreed een beproevingskamer",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Beproevingseditie",
	"advancements.adventure.ol_betsy.description": "Schiet met een kruisboog",
	"advancements.adventure.ol_betsy.title": "Ouwe trouwe",
	"advancements.adventure.overoverkill.description": "Breng vijftig hartjes schade toe in één knotsslag",
	"advancements.adventure.overoverkill.title": "Veel te veel van het goede",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Lees de stroomsterkte van een bewerkte boekenkast uit met een vergelijker",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Sterke verhalen",
	"advancements.adventure.revaulting.description": "Haal een onheilspellende kluis van het slot met een onheilspellende beproevingssleutel",
	"advancements.adventure.revaulting.title": "De verschrikking overwonnen",
	...
	"advancements.adventure.spear_many_mobs.description": "Raak vijf wezens in één charge met een speer",
	"advancements.adventure.spear_many_mobs.title": "Monsterkebab",
	...
	"advancements.adventure.under_lock_and_key.description": "Open een kluis met een beproevingssleutel",
	"advancements.adventure.under_lock_and_key.title": "Achter slot en grendel",
	"advancements.adventure.use_lodestone.description": "Gebruik een kompas op een zeilsteen",
	"advancements.adventure.use_lodestone.title": "Op eigen kompas zeilen",
	...
	"advancements.adventure.who_needs_rockets.description": "Gebruik een windvlaag om jezelf zeven blokken te lanceren",
	"advancements.adventure.who_needs_rockets.title": "Zonder vleugels!",
	...
	"advancements.end.levitate.description": "Zweef vijftig blokken omhoog door een aanval van een Shulker",
	"advancements.end.levitate.title": "Wat een uitzicht!",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Plaats een uitgedroogd Ghastblok in water",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Pappen en nathouden",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Gebruik een schaar om wolvenharnas van een wolf te verwijderen",
	"advancements.husbandry.remove_wolf_armor.title": "Knippel, knabbel, knuisje",
	"advancements.husbandry.repair_wolf_armor.description": "Gebruik gordeldierhoornplaten om een wolvenharnas volledig te repareren",
	"advancements.husbandry.repair_wolf_armor.title": "Zo goed als nieuw",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Gebruik een kampvuur om honing uit een bijenkorf te verzamelen met een glazen fles, zonder dat de bijen van slag raken",
	"advancements.husbandry.safely_harvest_honey.title": "Kom er maar bij",
	"advancements.husbandry.silk_touch_nest.description": "Verplaats een bijennest of -korf met drie bijen erin door gebruik te maken van zijden streling",
	...
	"advancements.husbandry.tadpole_in_a_bucket.title": "Als een kikker op een kluitje",
	...
	"advancements.husbandry.uh_oh.description": "Laat een zwavelkubus een blok TNT absorberen",
	"advancements.husbandry.uh_oh.title": "Oh nee...",
	...
	"advancements.husbandry.whole_pack.description": "Tem elk van de wolvenvarianten",
	"advancements.husbandry.whole_pack.title": "De roedel compleet",
	...
	"advancements.nether.root.description": "Neem zomerkleren mee",
	...
	"argument.entity.selector.nearestEntity": "Dichtsbijzijnde entiteit",
	...
	"argument.float.big": "Zwevendekommagetal mag niet hoger zijn dan %s: %s gevonden",
	"argument.float.low": "Zwevendekommagetal mag niet lager zijn dan %s: %s gevonden",
	"argument.gamemode.invalid": "Onbekende spelmodus: %s",
	"argument.hexcolor.invalid": "Ongeldige hexadecimale kleurcode '%s'",
	...
	"argument.message.too_long": "Chatbericht was te lang (%s tekens, meer dan de limiet van %s)",
	"argument.nbt.array.invalid": "Lijsttype '%s' is ongeldig",
	"argument.nbt.array.mixed": "'%s' toevoegen aan '%s' mislukt",
	"argument.nbt.expected.compound": "Verwachtte samengestelde eigenschap",
	...
	"argument.nbt.trailing": "Onverwachte extra gegevens",
	...
	"argument.resource_or_id.failed_to_parse": "Constructie '%s' verwerken mislukt",
	"argument.resource_or_id.invalid": "Ongeldig ID of ongeldige eigenschap",
	"argument.resource_or_id.no_such_element": "Element '%s' niet gevonden in register '%s'",
	"argument.resource_selector.not_found": "Geen overeenkomsten voor selecteerder '%s' van type '%s'",
	...
	"argument.style.invalid": "Ongeldige stijl: %s",
	...
	"argument.waypoint.invalid": "Geselecteerde entiteit is geen wegwijzer",
	...
	"arguments.item.component.malformed": "Component '%s' is ongeldig: %s",
	"arguments.item.component.repeated": "Voorwerpcomponent '%s' werd herhaald, maar slechts één waarde kan gebruikt worden",
	"arguments.item.component.unknown": "Voorwerpcomponent '%s' is onbekend",
	"arguments.item.malformed": "Voorwerp is ongelding: %s",
	"arguments.item.overstacked": "'%s' kan gestapeld worden tot maximaal %s",
	"arguments.item.predicate.malformed": "Predicaat '%s' is ongeldig: %s",
	"arguments.item.predicate.unknown": "Voorwerppredicaat '%s' is onbekend",
	...
	"attribute.name.air_drag_modifier": "luchtweerstand",
	"attribute.name.armor": "harnaspunten",
	"attribute.name.armor_toughness": "harnashardheid",
	"attribute.name.attack_damage": "aanvalsschade",
	"attribute.name.attack_knockback": "aanvalsterugslag",
	"attribute.name.attack_speed": "aanvalssnelheid",
	"attribute.name.below_name_distance": "Weergaveafstand scoreballon",
	"attribute.name.block_break_speed": "blokbreeksnelheid",
	"attribute.name.block_interaction_range": "blokinteractiebereik",
	"attribute.name.bounciness": "veerkracht",
	"attribute.name.burning_time": "brandtijd",
	"attribute.name.camera_distance": "camera-afstand",
	"attribute.name.entity_interaction_range": "entiteitinteractiebereik",
	"attribute.name.explosion_knockback_resistance": "explosieterugslagsweerstand",
	"attribute.name.fall_damage_multiplier": "valschadevermenigvuldiger",
	"attribute.name.flying_speed": "vliegsnelheid",
	"attribute.name.follow_range": "wezenvolgbereik",
	"attribute.name.friction_modifier": "wrijving",
	...
	"attribute.name.generic.block_interaction_range": "blokinteractiebereik",
	"attribute.name.generic.burning_time": "brandtijd",
	"attribute.name.generic.entity_interaction_range": "entiteitinteractiebereik",
	"attribute.name.generic.explosion_knockback_resistance": "explosieterugslagsweerstand",
	"attribute.name.generic.fall_damage_multiplier": "valschadevermenigvuldiger",
	"attribute.name.generic.flying_speed": "vliegsnelheid",
	"attribute.name.generic.follow_range": "wezenvolgbereik",
	"attribute.name.generic.gravity": "zwaartekracht",
	"attribute.name.generic.jump_strength": "springkracht",
	"attribute.name.generic.knockback_resistance": "terugslagweerstand",
	"attribute.name.generic.luck": "geluk",
	"attribute.name.generic.max_absorption": "maximumabsorptie",
	"attribute.name.generic.max_health": "maximumgezondheid",
	"attribute.name.generic.movement_efficiency": "bewegingsefficiëntie",
	"attribute.name.generic.movement_speed": "snelheid",
	"attribute.name.generic.oxygen_bonus": "zuurstofbonus",
	"attribute.name.generic.safe_fall_distance": "veilige valafstand",
	"attribute.name.generic.scale": "schaal",
	"attribute.name.generic.step_height": "staphoogte",
	"attribute.name.generic.water_movement_efficiency": "waterbewegingsefficiëntie",
	"attribute.name.gravity": "zwaartekracht",
	"attribute.name.horse.jump_strength": "paardensprongsterkte",
	"attribute.name.jump_strength": "springkracht",
	"attribute.name.knockback_resistance": "terugslagsweerstand",
	"attribute.name.luck": "geluk",
	"attribute.name.max_absorption": "maximumabsorptie",
	"attribute.name.max_health": "maximumgezondheid",
	"attribute.name.mining_efficiency": "mijnefficiëntie",
	"attribute.name.movement_efficiency": "bewegingsefficiëntie",
	"attribute.name.movement_speed": "snelheid",
	"attribute.name.nameplate_distance": "Weergaveafstand naamballon",
	"attribute.name.oxygen_bonus": "zuurstofbonus",
	"attribute.name.player.block_break_speed": "blokbreeksnelheid",
	"attribute.name.player.block_interaction_range": "blokinteractiebereik",
	"attribute.name.player.entity_interaction_range": "entiteitinteractiebereik",
	"attribute.name.player.mining_efficiency": "mijnefficiëntie",
	"attribute.name.player.sneaking_speed": "sluipsnelheid",
	"attribute.name.player.submerged_mining_speed": "mijnsnelheid onderwater",
	"attribute.name.player.sweeping_damage_ratio": "verscherpingsschaderatio",
	"attribute.name.safe_fall_distance": "veilige valafstand",
	"attribute.name.scale": "schaal",
	"attribute.name.sneaking_speed": "sluipsnelheid",
	"attribute.name.spawn_reinforcements": "zombieversterkingen",
	"attribute.name.step_height": "staphoogte",
	"attribute.name.submerged_mining_speed": "mijnsnelheid onderwater",
	"attribute.name.sweeping_damage_ratio": "verscherpingsschaderatio",
	"attribute.name.tempt_range": "wezenlokbereik",
	"attribute.name.water_movement_efficiency": "waterbewegingsefficiëntie",
	"attribute.name.waypoint_receive_range": "wegwijzerontvangstbereik",
	"attribute.name.waypoint_transmit_range": "wegwijzeruitzendbereik",
	...
	"biome.minecraft.pale_garden": "Bleke tuin",
	...
	"biome.minecraft.sulfur_caves": "Zwavelgrotten",
	...
	"block.minecraft.acacia_sapling": "Acaciazaailing",
	"block.minecraft.acacia_shelf": "Acaciahouten schap",
	...
	"block.minecraft.bamboo_shelf": "Bamboeschap",
	...
	"block.minecraft.banner.flow.black": "Zwarte windstroming",
	"block.minecraft.banner.flow.blue": "Blauwe windstroming",
	"block.minecraft.banner.flow.brown": "Bruine windstroming",
	"block.minecraft.banner.flow.cyan": "Turquoise windstroming",
	"block.minecraft.banner.flow.gray": "Grijze windstroming",
	"block.minecraft.banner.flow.green": "Groene windstroming",
	"block.minecraft.banner.flow.light_blue": "Lichtblauwe windstroming",
	"block.minecraft.banner.flow.light_gray": "Lichtgrijze windstroming",
	"block.minecraft.banner.flow.lime": "Lichtgroene windstroming",
	"block.minecraft.banner.flow.magenta": "Magenta windstroming",
	"block.minecraft.banner.flow.orange": "Oranje windstroming",
	"block.minecraft.banner.flow.pink": "Roze windstroming",
	"block.minecraft.banner.flow.purple": "Paarse windstroming",
	"block.minecraft.banner.flow.red": "Rode windstroming",
	"block.minecraft.banner.flow.white": "Witte windstroming",
	"block.minecraft.banner.flow.yellow": "Gele windstroming",
	...
	"block.minecraft.banner.guster.black": "Zwarte rukwind",
	"block.minecraft.banner.guster.blue": "Blauwe rukwind",
	"block.minecraft.banner.guster.brown": "Bruine rukwind",
	"block.minecraft.banner.guster.cyan": "Turquoise rukwind",
	"block.minecraft.banner.guster.gray": "Grijze rukwind",
	"block.minecraft.banner.guster.green": "Groene rukwind",
	"block.minecraft.banner.guster.light_blue": "Lichtblauwe rukwind",
	"block.minecraft.banner.guster.light_gray": "Lichtgrijze rukwind",
	"block.minecraft.banner.guster.lime": "Lichtgroene rukwind",
	"block.minecraft.banner.guster.magenta": "Magenta rukwind",
	"block.minecraft.banner.guster.orange": "Oranje rukwind",
	"block.minecraft.banner.guster.pink": "Roze rukwind",
	"block.minecraft.banner.guster.purple": "Paarse rukwind",
	"block.minecraft.banner.guster.red": "Rode rukwind",
	"block.minecraft.banner.guster.white": "Witte rukwind",
	"block.minecraft.banner.guster.yellow": "Gele rukwind",
	...
	"block.minecraft.birch_sapling": "Berkenzaailing",
	"block.minecraft.birch_shelf": "Berkenhouten schap",
	...
	"block.minecraft.bush": "Struik",
	"block.minecraft.cactus": "Cactus",
	"block.minecraft.cactus_flower": "Cactusbloem",
	...
	"block.minecraft.cherry_shelf": "Kersenhouten schap",
	...
	"block.minecraft.chiseled_cinnabar": "Gebeiteld cinnaber",
	"block.minecraft.chiseled_copper": "Bewerkt koperblok",
	...
	"block.minecraft.chiseled_resin_bricks": "Gebeitelde harsbakstenen",
	"block.minecraft.chiseled_sandstone": "Gebeiteld zandsteen",
	"block.minecraft.chiseled_stone_bricks": "Gebeitelde blokstenen",
	"block.minecraft.chiseled_sulfur": "Gebeiteld zwavel",
	"block.minecraft.chiseled_tuff": "Gebeiteld tufsteen",
	"block.minecraft.chiseled_tuff_bricks": "Gebeitelde tufstenen blokstenen",
	"block.minecraft.chorus_flower": "Chorusbloem",
	"block.minecraft.chorus_plant": "Chorusplant",
	"block.minecraft.cinnabar": "Cinnaber",
	"block.minecraft.cinnabar_brick_slab": "Cinnaberblokstenen plaat",
	"block.minecraft.cinnabar_brick_stairs": "Cinnaberblokstenen trap",
	"block.minecraft.cinnabar_brick_wall": "Cinnaberblokstenen muur",
	"block.minecraft.cinnabar_bricks": "Cinnaberblokstenen",
	"block.minecraft.cinnabar_slab": "Cinnaberplaat",
	"block.minecraft.cinnabar_stairs": "Cinnabertrap",
	"block.minecraft.cinnabar_wall": "Cinnabermuur",
	"block.minecraft.clay": "Klei",
	"block.minecraft.closed_eyeblossom": "Gesloten gluurbloesem",
	...
	"block.minecraft.copper_bars": "Koperen tralies",
	"block.minecraft.copper_block": "Koperblok",
	"block.minecraft.copper_bulb": "Koperen lamp",
	"block.minecraft.copper_chain": "Koperen ketting",
	"block.minecraft.copper_chest": "Koperen kist",
	"block.minecraft.copper_door": "Koperen deur",
	"block.minecraft.copper_golem_statue": "Kopergolemstandbeeld",
	"block.minecraft.copper_grate": "Koperen rooster",
	"block.minecraft.copper_lantern": "Koperen lantaarn",
	"block.minecraft.copper_ore": "Kopererts",
	"block.minecraft.copper_torch": "Koperfakkel",
	"block.minecraft.copper_trapdoor": "Koperen valluik",
	"block.minecraft.copper_wall_torch": "Koperfakkel aan muur",
	...
	"block.minecraft.crafter": "Vervaardigingsmachine",
	"block.minecraft.crafting_table": "Werkbank",
	"block.minecraft.creaking_heart": "Schorswakerhart",
	...
	"block.minecraft.crimson_shelf": "Helrood houten schap",
	...
	"block.minecraft.crimson_wall_sign": "Helrood houten bord aan muur",
	...
	"block.minecraft.dark_oak_button": "Donkere eikenhouten knop",
	"block.minecraft.dark_oak_door": "Donkere eikenhouten deur",
	"block.minecraft.dark_oak_fence": "Donker eikenhouten hek",
	"block.minecraft.dark_oak_fence_gate": "Donkere eikenhouten poort",
	"block.minecraft.dark_oak_hanging_sign": "Donker eikenhouten hangbord",
	"block.minecraft.dark_oak_leaves": "Donkere eikenbladeren",
	"block.minecraft.dark_oak_log": "Donkere eikenstam",
	"block.minecraft.dark_oak_planks": "Donkere eikenhouten planken",
	"block.minecraft.dark_oak_pressure_plate": "Donkere eikenhouten drukplaat",
	"block.minecraft.dark_oak_sapling": "Donkere eikenzaailing",
	"block.minecraft.dark_oak_shelf": "Donker eikenhouten schap",
	"block.minecraft.dark_oak_sign": "Donker eikenhouten bord",
	"block.minecraft.dark_oak_slab": "Donkere eikenhouten plaat",
	"block.minecraft.dark_oak_stairs": "Donkere eikenhouten trap",
	"block.minecraft.dark_oak_trapdoor": "Donker eikenhouten valluik",
	"block.minecraft.dark_oak_wall_hanging_sign": "Donker eikenhouten uithangbord",
	"block.minecraft.dark_oak_wall_sign": "Donker eikenhouten bord aan muur",
	"block.minecraft.dark_oak_wood": "Donker eikenhout",
	...
	"block.minecraft.deepslate_bricks": "Wrevelstenen blokstenen",
	...
	"block.minecraft.dried_ghast": "Uitgedroogde Ghast",
	...
	"block.minecraft.exposed_chiseled_copper": "Blootgesteld bewerkt koperblok",
	"block.minecraft.exposed_copper": "Blootgesteld koperblok",
	"block.minecraft.exposed_copper_bars": "Blootgestelde koperen tralies",
	"block.minecraft.exposed_copper_bulb": "Blootgestelde koperen lamp",
	"block.minecraft.exposed_copper_chain": "Blootgestelde koperen ketting",
	"block.minecraft.exposed_copper_chest": "Blootgestelde koperen kist",
	"block.minecraft.exposed_copper_door": "Blootgestelde koperen deur",
	"block.minecraft.exposed_copper_golem_statue": "Blootgesteld kopergolemstandbeeld",
	"block.minecraft.exposed_copper_grate": "Blootgesteld koperen rooster",
	"block.minecraft.exposed_copper_lantern": "Blootgestelde koperen lantaarn",
	"block.minecraft.exposed_copper_trapdoor": "Blootgesteld koperen valluik",
	...
	"block.minecraft.exposed_lightning_rod": "Blootgestelde bliksemafleider",
	...
	"block.minecraft.firefly_bush": "Vuurvliegjesstruik",
	...
	"block.minecraft.golden_dandelion": "Gouden paardenbloem",
	...
	"block.minecraft.heavy_core": "Zware kern",
	...
	"block.minecraft.iron_bars": "IJzeren tralies",
	"block.minecraft.iron_block": "IJzerblok",
	"block.minecraft.iron_chain": "IJzeren ketting",
	...
	"block.minecraft.jungle_sapling": "Oerwoudzaailing",
	"block.minecraft.jungle_shelf": "Oerwoudhouten schap",
	...
	"block.minecraft.leaf_litter": "Dode bladeren",
	...
	"block.minecraft.mangrove_shelf": "Mangrovehouten schap",
	...
	"block.minecraft.oak_sapling": "Eikenzaailing",
	"block.minecraft.oak_shelf": "Eikenhouten schap",
	...
	"block.minecraft.open_eyeblossom": "Geopende gluurbloesem",
	...
	"block.minecraft.oxidized_chiseled_copper": "Geoxideerd bewerkt koperblok",
	"block.minecraft.oxidized_copper": "Geoxideerd koperblok",
	"block.minecraft.oxidized_copper_bars": "Geoxideerde koperen tralies",
	"block.minecraft.oxidized_copper_bulb": "Geoxideerde koperen lamp",
	"block.minecraft.oxidized_copper_chain": "Geoxideerde koperen ketting",
	"block.minecraft.oxidized_copper_chest": "Geoxideerde koperen kist",
	"block.minecraft.oxidized_copper_door": "Geoxideerde koperen deur",
	"block.minecraft.oxidized_copper_golem_statue": "Geoxideerd kopergolemstandbeeld",
	"block.minecraft.oxidized_copper_grate": "Geoxideerd koperen rooster",
	"block.minecraft.oxidized_copper_lantern": "Geoxideerde koperen lantaarn",
	"block.minecraft.oxidized_copper_trapdoor": "Geoxideerd koperen valluik",
	...
	"block.minecraft.oxidized_lightning_rod": "Geoxideerde bliksemafleider",
	"block.minecraft.packed_ice": "Pakijs",
	"block.minecraft.packed_mud": "Pakmodder",
	"block.minecraft.pale_hanging_moss": "Bleek hangend mos",
	"block.minecraft.pale_moss_block": "Bleek mosblok",
	"block.minecraft.pale_moss_carpet": "Bleek mostapijt",
	"block.minecraft.pale_oak_button": "Bleke eikenhouten knop",
	"block.minecraft.pale_oak_door": "Bleke eikenhouten deur",
	"block.minecraft.pale_oak_fence": "Bleek eikenhouten hek",
	"block.minecraft.pale_oak_fence_gate": "Bleke eikenhouten poort",
	"block.minecraft.pale_oak_hanging_sign": "Bleek eikenhouten hangbord",
	"block.minecraft.pale_oak_leaves": "Bleke eikenbladeren",
	"block.minecraft.pale_oak_log": "Bleke eikenstam",
	"block.minecraft.pale_oak_planks": "Bleke eikenhouten planken",
	"block.minecraft.pale_oak_pressure_plate": "Bleke eikenhouten drukplaat",
	"block.minecraft.pale_oak_sapling": "Bleke eikenzaailing",
	"block.minecraft.pale_oak_shelf": "Bleek eikenhouten schap",
	"block.minecraft.pale_oak_sign": "Bleek eikenhouten bord",
	"block.minecraft.pale_oak_slab": "Bleke eikenhouten plaat",
	"block.minecraft.pale_oak_stairs": "Bleke eikenhouten trap",
	"block.minecraft.pale_oak_trapdoor": "Bleke eikenhouten valluik",
	"block.minecraft.pale_oak_wall_hanging_sign": "Bleek eikenhouten uithangbord",
	"block.minecraft.pale_oak_wall_sign": "Bleek eikenhouten bord aan muur",
	"block.minecraft.pale_oak_wood": "Bleek eikenhout",
	...
	"block.minecraft.polished_cinnabar": "Gepolijst cinnaber",
	"block.minecraft.polished_cinnabar_slab": "Gepolijste cinnaberplaat",
	"block.minecraft.polished_cinnabar_stairs": "Gepolijste cinnabertrap",
	"block.minecraft.polished_cinnabar_wall": "Gepolijste cinnabermuur",
	...
	"block.minecraft.polished_sulfur": "Gepolijst zwavel",
	"block.minecraft.polished_sulfur_slab": "Gepolijste zwavelplaat",
	"block.minecraft.polished_sulfur_stairs": "Gepolijste zwaveltrap",
	"block.minecraft.polished_sulfur_wall": "Gepolijste zwavelmuur",
	"block.minecraft.polished_tuff": "Gepolijst tufsteen",
	"block.minecraft.polished_tuff_slab": "Gepolijste tufstenen plaat",
	"block.minecraft.polished_tuff_stairs": "Gepolijste tufstenen trap",
	"block.minecraft.polished_tuff_wall": "Gepolijste tufstenen muur",
	"block.minecraft.poppy": "Klaproos",
	"block.minecraft.potatoes": "Aardappels",
	"block.minecraft.potent_sulfur": "Reactief zwavel",
	"block.minecraft.potted_acacia_sapling": "Opgepotte acaciazaailing",
	...
	"block.minecraft.potted_birch_sapling": "Opgepotte berkenzaailing",
	...
	"block.minecraft.potted_closed_eyeblossom": "Opgepotte gesloten gluurbloesem",
	...
	"block.minecraft.potted_dark_oak_sapling": "Opgepotte donkere eikenzaailing",
	...
	"block.minecraft.potted_golden_dandelion": "Opgepotte gouden paardenbloem",
	"block.minecraft.potted_jungle_sapling": "Opgepotte oerwoudzaailing",
	...
	"block.minecraft.potted_oak_sapling": "Opgepotte eikenzaailing",
	"block.minecraft.potted_open_eyeblossom": "Opgepotte geopende gluurbloesem",
	"block.minecraft.potted_orange_tulip": "Opgepotte oranje tulp",
	"block.minecraft.potted_oxeye_daisy": "Opgepotte margriet",
	"block.minecraft.potted_pale_oak_sapling": "Opgepotte bleke eikenzaailing",
	...
	"block.minecraft.potted_spruce_sapling": "Opgepotte sparrenzaailing",
	...
	"block.minecraft.resin_block": "Harsblok",
	"block.minecraft.resin_brick_slab": "Harsbakstenen plaat",
	"block.minecraft.resin_brick_stairs": "Harsbakstenen trap",
	"block.minecraft.resin_brick_wall": "Harsbakstenen muur",
	"block.minecraft.resin_bricks": "Harsbakstenen",
	"block.minecraft.resin_clump": "Harsdruppels",
	...
	"block.minecraft.short_dry_grass": "Kort droog gras",
	...
	"block.minecraft.spruce_sapling": "Sparrenzaailing",
	"block.minecraft.spruce_shelf": "Sparrenhouten schap",
	...
	"block.minecraft.stripped_dark_oak_log": "Gestripte donkere eikenstam",
	"block.minecraft.stripped_dark_oak_wood": "Gestript donker eikenhout",
	...
	"block.minecraft.stripped_pale_oak_log": "Gestripte bleke eikenstam",
	"block.minecraft.stripped_pale_oak_wood": "Gestript bleek eikenhout",
	...
	"block.minecraft.sulfur": "Zwavel",
	"block.minecraft.sulfur_brick_slab": "Zwavelblokstenen plaat",
	"block.minecraft.sulfur_brick_stairs": "Zwavelblokstenen trap",
	"block.minecraft.sulfur_brick_wall": "Zwavelblokstenen muur",
	"block.minecraft.sulfur_bricks": "Zwavelblokstenen",
	"block.minecraft.sulfur_slab": "Zwavelplaat",
	"block.minecraft.sulfur_spike": "Zwaveldruipsteen",
	"block.minecraft.sulfur_stairs": "Zwaveltrap",
	"block.minecraft.sulfur_wall": "Zwavelmuur",
	...
	"block.minecraft.tall_dry_grass": "Hoog droog gras",
	...
	"block.minecraft.test_instance_block": "Testinstantieblok",
	"block.minecraft.tinted_glass": "Getint glas",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "TNT-explosies zijn uitgeschakeld",
	...
	"block.minecraft.trial_spawner": "Beproevingskooi",
	...
	"block.minecraft.tuff_brick_slab": "Tufstenen blokstenen plaat",
	"block.minecraft.tuff_brick_stairs": "Tufstenen blokstenen trap",
	"block.minecraft.tuff_brick_wall": "Tufstenen blokstenen muur",
	"block.minecraft.tuff_bricks": "Tufstenen blokstenen",
	"block.minecraft.tuff_slab": "Tufstenen plaat",
	"block.minecraft.tuff_stairs": "Tufstenen trap",
	"block.minecraft.tuff_wall": "Tufstenen muur",
	...
	"block.minecraft.warped_shelf": "Spookachtig houten schap",
	...
	"block.minecraft.warped_wall_sign": "Spookachtig houten bord aan muur",
	...
	"block.minecraft.waxed_chiseled_copper": "Ingewassen bewerkt koperblok",
	"block.minecraft.waxed_copper_bars": "Ingewassen koperen tralies",
	"block.minecraft.waxed_copper_block": "Ingewassen koperblok",
	"block.minecraft.waxed_copper_bulb": "Ingewassen koperen lamp",
	"block.minecraft.waxed_copper_chain": "Ingewassen koperen ketting",
	"block.minecraft.waxed_copper_chest": "Ingewassen koperen kist",
	"block.minecraft.waxed_copper_door": "Ingewassen koperen deur",
	"block.minecraft.waxed_copper_golem_statue": "Ingewassen kopergolemstandbeeld",
	"block.minecraft.waxed_copper_grate": "Ingewassen koperen rooster",
	"block.minecraft.waxed_copper_lantern": "Ingewassen koperen lantaarn",
	"block.minecraft.waxed_copper_trapdoor": "Ingewassen koperen valluik",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Ingewassen blootgesteld bewerkt koperblok",
	"block.minecraft.waxed_exposed_copper": "Ingewassen blootgesteld koperblok",
	"block.minecraft.waxed_exposed_copper_bars": "Ingewassen blootgestelde koperen tralies",
	"block.minecraft.waxed_exposed_copper_bulb": "Ingewassen blootgestelde koperen lamp",
	"block.minecraft.waxed_exposed_copper_chain": "Ingewassen blootgestelde koperen ketting",
	"block.minecraft.waxed_exposed_copper_chest": "Ingewassen blootgestelde koperen kist",
	"block.minecraft.waxed_exposed_copper_door": "Ingewassen blootgestelde koperen deur",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Ingewassen blootgesteld kopergolemstandbeeld",
	"block.minecraft.waxed_exposed_copper_grate": "Ingewassen blootgesteld koperen rooster",
	"block.minecraft.waxed_exposed_copper_lantern": "Ingewassen blootgestelde koperen lantaarn",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Ingewassen blootgesteld koperen valluik",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Ingewassen blootgestelde bliksemafleider",
	"block.minecraft.waxed_lightning_rod": "Ingewassen bliksemafleider",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Ingewassen geoxideerd bewerkt koperblok",
	"block.minecraft.waxed_oxidized_copper": "Ingewassen geoxideerd koperblok",
	"block.minecraft.waxed_oxidized_copper_bars": "Ingewassen geoxideerde koperen tralies",
	"block.minecraft.waxed_oxidized_copper_bulb": "Ingewassen geoxideerde koperen lamp",
	"block.minecraft.waxed_oxidized_copper_chain": "Ingewassen geoxideerde koperen ketting",
	"block.minecraft.waxed_oxidized_copper_chest": "Ingewassen geoxideerde koperen kist",
	"block.minecraft.waxed_oxidized_copper_door": "Ingewassen geoxideerde koperen deur",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Ingewassen geoxideerd kopergolemstandbeeld",
	"block.minecraft.waxed_oxidized_copper_grate": "Ingewassen geoxideerd koperen rooster",
	"block.minecraft.waxed_oxidized_copper_lantern": "Ingewassen geoxideerde koperen lantaarn",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Ingewassen geoxideerd koperen valluik",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Ingewassen geoxideerde bliksemafleider",
	"block.minecraft.waxed_weathered_chiseled_copper": "Ingewassen verweerd bewerkt koperblok",
	"block.minecraft.waxed_weathered_copper": "Ingewassen verweerd koperblok",
	"block.minecraft.waxed_weathered_copper_bars": "Ingewassen verweerde koperen tralies",
	"block.minecraft.waxed_weathered_copper_bulb": "Ingewassen verweerde koperen lamp",
	"block.minecraft.waxed_weathered_copper_chain": "Ingewassen verweerde koperen ketting",
	"block.minecraft.waxed_weathered_copper_chest": "Ingewassen verweerde koperen kist",
	"block.minecraft.waxed_weathered_copper_door": "Ingewassen verweerde koperen deur",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Ingewassen verweerd kopergolemstandbeeld",
	"block.minecraft.waxed_weathered_copper_grate": "Ingewassen verweerd koperen rooster",
	"block.minecraft.waxed_weathered_copper_lantern": "Ingewassen verweerde koperen lantaarn",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Ingewassen verweerd koperen valluik",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Ingewassen verweerde bliksemafleider",
	"block.minecraft.weathered_chiseled_copper": "Verweerd bewerkt koperblok",
	"block.minecraft.weathered_copper": "Verweerd koperblok",
	"block.minecraft.weathered_copper_bars": "Verweerde koperen tralies",
	"block.minecraft.weathered_copper_bulb": "Verweerde koperen lamp",
	"block.minecraft.weathered_copper_chain": "Verweerde koperen ketting",
	"block.minecraft.weathered_copper_chest": "Verweerde koperen kist",
	"block.minecraft.weathered_copper_door": "Verweerde koperen deur",
	"block.minecraft.weathered_copper_golem_statue": "Verweerd kopergolemstandbeeld",
	"block.minecraft.weathered_copper_grate": "Verweerd koperen rooster",
	"block.minecraft.weathered_copper_lantern": "Verweerde koperen lantaarn",
	"block.minecraft.weathered_copper_trapdoor": "Verweerd koperen valluik",
	...
	"block.minecraft.weathered_lightning_rod": "Verweerde bliksemafleider",
	...
	"block.minecraft.wildflowers": "Wilde bloemen",
	...
	"book.edit.title": "Boekbewerkingsmenu",
	...
	"book.invalid.tag": "* ongeldige boekeigenschap *",
	"book.pageIndicator": "pagina %[1]s van %[2]s",
	"book.page_button.next": "Volgende pagina",
	"book.page_button.previous": "Vorige pagina",
	"book.sign.title": "Boeksigneringsmenu",
	"book.sign.titlebox": "Titel",
	"book.signButton": "Signeren",
	"book.view.title": "Boekweergavemenu",
	"build.spawn_protection": "%s valt onder spawnbescherming",
	"build.tooHigh": "Hoogtelimiet voor bouwen is %s",
	"build.tooLow": "Minimumhoogte voor bouwen is %s",
	...
	"chat.disabled.chain_broken": "Chat uitgeschakeld door een onderbroken keten. Probeer opnieuw verbinding te maken.",
	...
	"chat.disabled.invalid_command_signature": "Opdracht bevatte onverwachte of ontbrekende opdrachtargumenthandtekeningen.",
	"chat.disabled.invalid_signature": "Chat heeft een ongeldige handtekening. Probeer opnieuw verbinding te maken.",
	...
	"chat.disabled.out_of_order_chat": "Chatberichten niet op volgorde ontvangen. Is je systeemtijd veranderd?",
	...
	"chat.queue": "[+%s regel(s) in de wachtrij]",
	"chat.queue.tooltip": "Klik om volgende bericht te tonen",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "De server verzond een ongeldig bericht.",
	...
	"chat.validation_error": "Chatvalidatiefout",
	"chat_restriction.chat_and_commands_disabled_by_options": "Chat is beperkt in spelinstellingen.",
	"chat_restriction.chat_disabled_by_options": "Spelerschat is beperkt in spelinstellingen.",
	"chat_restriction.chat_disabled_by_options.action": "Chatinstellingen openen",
	"chat_restriction.disabled_by_launcher": "Chat is beperkt door de launcher.",
	"chat_restriction.disabled_by_profile": "Chat is beperkt door profielinstellingen.",
	"chat_restriction.disabled_by_profile.action": "Profielinstellingen openen",
	"chat_screen.commands_not_allowed": "Opdrachten versturen is niet toegestaan",
	"chat_screen.message": "Bericht om te versturen: %s",
	"chat_screen.messages_not_allowed": "Chatberichten sturen is niet toegestaan",
	"chat_screen.restricted": "Chat is beperkt. Klik op dit bericht voor informatie.",
	"chat_screen.restricted.narration": "Chat is beperkt. Ga naar het beperkingenmenu in de wereldinstellingen.",
	"chat_screen.title": "Chatscherm",
	"chat_screen.usage": "Voer bericht in en druk op Enter om te versturen",
	"chunk.toast.checkLog": "Bekijk het logboek voor meer informatie",
	"chunk.toast.loadFailure": "Chunk laden mislukt op %s",
	"chunk.toast.lowDiskSpace": "Opslagruimte bijna vol!",
	"chunk.toast.lowDiskSpace.description": "De wereld kan mogelijk niet worden opgeslagen.",
	"chunk.toast.saveFailure": "Chunk opslaan mislukt op %s",
	...
	"command.expected.separator": "Witruimte verwacht om een argument te beëindigen, maar trof extra gegevens aan",
	"command.failed": "Er trad een onverwachte fout op tijdens het uitvoeren van deze opdracht",
	"command.forkLimit": "Maximumaantal contexten (%s) bereikt",
	"command.trailing_data": "Nakomende gegevens gevonden: %s",
	...
	"commands.attribute.base_value.reset.success": "Basiswaarde voor attribuut %s voor entiteit %s is teruggezet naar standaardwaarde %s",
	...
	"commands.data.block.modified": "Blokgegevens op positie %s, %s, %s aangepast",
	"commands.data.block.query": "%s, %s, %s heeft de volgende blokgegevens: %s",
	"commands.data.entity.get": "'%s' van %s na schalingsfactor %s is %s",
	"commands.data.entity.invalid": "Spelergegevens aanpassen mislukt",
	"commands.data.entity.modified": "Entiteitgegevens van %s aangepast",
	"commands.data.entity.query": "%s heeft de volgende entiteitgegevens: %s",
	...
	"commands.data.modify.invalid_substring": "Ongeldige subtekenreeksindexen: %s tot %s",
	...
	"commands.datapack.create.already_exists": "Pakket met de naam '%s' bestaat al",
	"commands.datapack.create.invalid_full_name": "Nieuwe datapakketnaam '%s' ongeldig",
	"commands.datapack.create.invalid_name": "Ongeldige karakters in nieuwe pakketnaam '%s'",
	"commands.datapack.create.io_failure": "Pakket met naam '%s' maken mislukt. Bekijk de logboeken.",
	"commands.datapack.create.metadata_encode_failure": "Metadata encoderen mislukt voor pakket met naam '%s': %s",
	"commands.datapack.create.success": "Leeg pakket met naam '%s' gemaakt",
	"commands.datapack.disable.failed": "Gegevenspakket '%s' is niet ingeschakeld!",
	"commands.datapack.disable.failed.feature": "Pakket '%s' kan niet worden uitgeschakeld, omdat het onderdeel is van een ingeschakelde optie!",
	"commands.datapack.enable.failed": "Gegevenspakket '%s' is al ingeschakeld!",
	...
	"commands.datapack.list.available.none": "Er zijn geen gegevenspakketten meer beschikbaar",
	"commands.datapack.list.available.success": "Er is/zijn %s gegevenspakket(ten) beschikbaar: %s",
	"commands.datapack.list.enabled.none": "Er zijn geen gegevenspakketten ingeschakeld",
	"commands.datapack.list.enabled.success": "Er is/zijn %s gegevenspakket(ten) ingeschakeld: %s",
	"commands.datapack.modify.disable": "Gegevenspakket %s wordt uitgeschakeld",
	"commands.datapack.modify.enable": "Gegevenspakket %s wordt ingeschakeld",
	"commands.datapack.unknown": "Gegevenspakket '%s' is onbekend",
	...
	"commands.debug.function.noReturnRun": "Opsporen niet mogelijk bij /return run",
	...
	"commands.dialog.clear.multiple": "Dialoogvenster voor %s spelers gewist",
	"commands.dialog.clear.single": "Dialoogvenster voor %s gewist",
	"commands.dialog.show.multiple": "Dialoogvenster aan %s spelers getoond",
	"commands.dialog.show.single": "Dialoogvenster aan %s getoond",
	...
	"commands.drop.no_loot_table.block": "Blok %s heeft geen buittabel",
	...
	"commands.execute.function.instantiationFailure": "Functie %s instantiëren mislukt: %s",
	...
	"commands.fetchprofile.copy_component": "component kopiëren",
	"commands.fetchprofile.copy_text": "%s kopiëren",
	"commands.fetchprofile.entity.success": "Profiel van entiteit %s opgehaald: %s",
	"commands.fetchprofile.failed_to_serialize": "Profiel serialiseren mislukt: %s",
	"commands.fetchprofile.give_item": "voorwerp geven",
	"commands.fetchprofile.id.failure": "Profiel ophalen voor ID %s mislukt",
	"commands.fetchprofile.id.success": "Profiel van ID %s opgehaald: %s",
	"commands.fetchprofile.name.failure": "Profiel ophalen voor naam %s mislukt",
	"commands.fetchprofile.name.success": "Profiel van naam %s opgehaald: %s",
	"commands.fetchprofile.no_profile": "Entiteit %s heeft geen profiel",
	"commands.fetchprofile.summon_mannequin": "mannequin oproepen",
	...
	"commands.fillbiome.success.count": "%s klimaat/klimaten ingesteld tussen %s, %s, %s en %s, %s, %s",
	...
	"commands.function.error.argument_not_compound": "Ongeldige argumentsoort: %s. COMPOUND verwacht",
	"commands.function.error.missing_argument": "Argument %[2]s van functie %[1]s ontbreekt",
	"commands.function.error.missing_arguments": "Argumenten van functie %s ontbreken",
	"commands.function.error.parse": "Tijdens het instantiëren van macro %s veroorzaakte de opdracht '%s' een fout: %s",
	"commands.function.instantiationFailure": "Functie %s instantiëren mislukt: %s",
	"commands.function.result": "Functie %s retourneerde %s",
	"commands.function.scheduled.multiple": "Functies %s gestart",
	"commands.function.scheduled.no_functions": "Kon functies met naam '%s' niet vinden",
	"commands.function.scheduled.single": "Functie %s gestart",
	...
	"commands.kick.owner.failed": "Kan servereigenaar in LAN-spel niet uit het spel zetten",
	"commands.kick.singleplayer.failed": "Spelers kunnen niet uit het spel worden gezet als je offline alleen speelt",
	...
	"commands.place.feature.invalid": "Kenmerktype '%s' bestaat niet",
	"commands.place.feature.success": "'%s' geplaatst op %s, %s, %s",
	...
	"commands.profile_fetch.copy_component": "component kopiëren",
	"commands.profile_fetch.failed_to_serialize": "Profiel serialiseren mislukt: %s",
	"commands.profile_fetch.give_item": "voorwerp geven",
	"commands.profile_fetch.id.failure": "Profiel ophalen voor ID %s mislukt",
	"commands.profile_fetch.id.success": "Profiel van ID %s opgehaald: %s",
	"commands.profile_fetch.name.failure": "Profiel ophalen voor naam %s mislukt",
	"commands.profile_fetch.name.success": "Profiel van naam %s opgehaald: %s",
	"commands.publish.alreadyPublished": "Samen spelen wordt al gehost op poort %s",
	"commands.publish.alreadyPublished.lan": "Lokaal spel wordt al gehost op poort %s",
	"commands.publish.alreadyPublished.online": "Online spel wordt al gehost",
	"commands.publish.failed": "Lokaal spel hosten mislukt",
	"commands.publish.started": "Lokaal spel wordt gehost op poort %s",
	"commands.publish.started.lan": "Lokaal spel wordt gehost op poort %s",
	"commands.publish.started.online": "Online spel wordt gehost",
	"commands.publish.success": "Samen spelen wordt gehost op poort %s",
	"commands.random.error.range_too_large": "Bereik om willekeurige waarde uit te kiezen mag niet groter dan 2147483646 zijn",
	"commands.random.error.range_too_small": "Bereik om willekeurige waarde uit te kiezen mag niet kleiner dan 2 zijn",
	"commands.random.reset.all.success": "%s willekeurige reeks(en) gereset",
	"commands.random.reset.success": "Willekeurige reeks %s gereset",
	"commands.random.roll": "%s wierp %s (tussen %s en %s)",
	"commands.random.sample.success": "Willekeurige waarde: %s",
	"commands.recipe.give.failed": "Geen nieuwe recepten geleerd",
	"commands.recipe.give.success.multiple": "%s recept(en) vrijgespeeld voor %s spelers",
	"commands.recipe.give.success.single": "%s recept(en) vrijgespeeld voor %s",
	"commands.recipe.take.failed": "Geen nieuwe recepten werden afgenomen",
	"commands.recipe.take.success.multiple": "%s recept(en) teruggenomen van %s spelers",
	"commands.recipe.take.success.single": "%s recept(en) teruggenomen van %s",
	"commands.reload.failure": "Herladen mislukt; oude gegevens worden behouden",
	...
	"commands.rotate.success": "%s gedraaid",
	...
	"commands.schedule.created.tag": "Eigenschap '%s' gepland na %s tick(s) op speltijd %s",
	"commands.schedule.macro": "Een macro kon niet ingepland worden",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Doel %s wordt niet langer automatisch bijgewerkt",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Doel %s wordt vanaf nu automatisch bijgewerkt",
	"commands.scoreboard.objectives.modify.displayname": "Weergavenaam van '%s' naar '%s' veranderd",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Standaardgetalindeling gewist van doel %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Standaardgetalindeling gewijzigd van doel %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Weergavenaam gewist van %s entiteiten in %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Weergavenaam gewist van %s in %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Weergavenaam van %[2]s entiteiten in %[3]s gewijzigd naar %[1]s",
	"commands.scoreboard.players.display.name.set.success.single": "Weergavenaam van %[2]s in %[3]s gewijzigd naar %[1]s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Getalindeling gewist voor %s entiteiten in %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Getalindeling gewist voor %s in %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Getalindeling gewijzigd voor %s entiteiten in %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Getalindeling gewijzigd voor %s in %s",
	...
	"commands.setidletimeout.success.disabled": "De maximale tijd dat een speler inactief mag zijn uitgeschakeld",
	"commands.setworldspawn.failure.not_overworld": "Het wereldspawnpunt kan alleen worden ingesteld in de bovenwereld",
	"commands.setworldspawn.success": "Wereldspawnpunt ingesteld op %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Wereldspawnpunt ingesteld op %s, %s, %s [%s, %s] in %s",
	"commands.spawnpoint.success.multiple": "Spawnpunt van %[6]s spelers ingesteld op %[1]s, %[2]s, %[3]s [%[4]s] in %[5]s",
	"commands.spawnpoint.success.multiple.new": "Spawnpunt van %[7]s spelers ingesteld op %[1]s, %[2]s, %[3]s [%[4]s, %[5]s] in %[6]s",
	"commands.spawnpoint.success.single": "Spawnpunt van %[6]s ingesteld op %[1]s, %[2]s, %[3]s [%[4]s] in %[5]s",
	"commands.spawnpoint.success.single.new": "Spawnpunt van %[7]s ingesteld op %[1]s, %[2]s, %[3]s [%[4]s, %[5]s] in %[6]s",
	"commands.spectate.cannot_spectate": "%s kan niet toegeschouwd worden",
	...
	"commands.spreadplayers.success.entities": "%s entiteit(en) verspreid over %s, %s, met een gemiddelde afstand van %s blok(ken) tussen entiteit",
	"commands.spreadplayers.success.teams": "%s team(s) verspreid over %s, %s, met een gemiddelde afstand van %s blok(ken) tussen teams",
	...
	"commands.stopwatch.already_exists": "Tijdmeter '%s' bestaat al",
	"commands.stopwatch.create.success": "Tijdmeter '%s' gestart",
	"commands.stopwatch.does_not_exist": "Tijdmeter '%s' bestaat niet",
	"commands.stopwatch.query": "Tijdmeter '%s' heeft %ss gelopen",
	"commands.stopwatch.remove.success": "Tijdmeter '%s' verwijderd",
	"commands.stopwatch.restart.success": "Tijdmeter '%s' opnieuw gestart",
	"commands.summon.failed": "Entiteit oproepen mislukt",
	"commands.summon.failed.peaceful": "Monsters kunnen niet opgeroepen worden in het vredige niveau",
	...
	"commands.swing.failed.notliving": "Geen levende entiteiten gevonden die met hun arm konden zwaaien",
	"commands.swing.success.multiple": "%s entiteiten zwaaiden met hun arm",
	"commands.swing.success.single": "%s zwaaide met een arm",
	...
	"commands.team.option.color.clear.success": "Kleur van team %s gewist",
	...
	"commands.test.batch.starting": "Omgeving %s groep %s starten",
	"commands.test.clear.error.no_tests": "Geen te wissen testen gevonden",
	"commands.test.clear.success": "%s constructie(s) gewist",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Klik om naar klembord te kopiëren",
	"commands.test.create.success": "Testopstelling gemaakt voor test %s",
	"commands.test.error.no_test_containing_pos": "Kon geen testinstantie vinden die %s, %s, %s bevat",
	"commands.test.error.no_test_instances": "Geen testinstanties gevonden",
	"commands.test.error.non_existant_test": "Kon test %s niet vinden",
	"commands.test.error.structure_not_found": "Kon testconstructie %s niet vinden",
	"commands.test.error.test_instance_not_found": "Kon testinstantieblokentiteit niet vinden",
	"commands.test.error.test_instance_not_found.position": "Kon geen testinstantieblokentiteit voor test op %s, %s, %s vinden",
	"commands.test.error.too_large": "De constructiegrootte moet kleiner zijn dan %s blokken in iedere richting",
	"commands.test.locate.done": "Lokaliseren afgerond: %s gevonden constructie(s)",
	"commands.test.locate.found": "Constructie op %s gevonden (afstand: %s)",
	"commands.test.locate.started": "Testconstructies lokaliseren gestart. Dit kan even duren...",
	"commands.test.no_tests": "Geen testen om uit te voeren",
	"commands.test.relative_position": "Relatieve positie tot %s: %s",
	"commands.test.reset.error.no_tests": "Geen testen gevonden om te resetten",
	"commands.test.reset.success": "%s constructie(s) gereset",
	"commands.test.run.no_tests": "Geen testen gevonden",
	"commands.test.run.running": "%s test(en) uitvoeren...",
	"commands.test.summary": "Speltest afgerond! %s test(en) uitgevoerd",
	"commands.test.summary.all_required_passed": "Alle vereiste testen geslaagd :)",
	"commands.test.summary.failed": "%s vereiste test(en) mislukt :(",
	"commands.test.summary.optional_failed": "%s optionele test(en) mislukt",
	"commands.tick.query.percentiles": "Percentielen: 50e: %sms; 95e: %sms; 99e: %sms. Datasetgrootte: %s",
	"commands.tick.query.rate.running": "Tickfrequentiedoel: %s per seconde.\nGemiddelde tijd tussen ticks: %sms (doel: %sms)",
	"commands.tick.query.rate.sprinting": "Tickfrequentiedoel: %s per seconde (genegeerd, alleen ter referentie).\nGemiddelde tijd tussen ticks: %sms",
	"commands.tick.rate.success": "Tickfrequentiedoel op %s per seconde gezet",
	"commands.tick.sprint.report": "Sprint voltooid met %s ticks per seconde (%sms per tick)",
	"commands.tick.sprint.stop.fail": "Er is op dit moment geen ticksprint bezig",
	"commands.tick.sprint.stop.success": "Een ticksprint werd onderbroken",
	"commands.tick.status.frozen": "Het spel is bevroren",
	"commands.tick.status.lagging": "Het spel draait, maar kan het ingestelde tickfrequentiedoel niet halen",
	"commands.tick.status.running": "Het spel draait zoals verwacht",
	"commands.tick.status.sprinting": "Het spel sprint",
	"commands.tick.step.fail": "Kon het spel niet stappen. Het spel moet eerst bevroren worden.",
	"commands.tick.step.stop.fail": "Er is op dit moment geen tickstap bezig",
	"commands.tick.step.stop.success": "Een tickstap werd onderbroken",
	"commands.tick.step.success": "%s tick(s) worden gestapt",
	"commands.time.no_default_clock": "Dimensie %s heeft geen standaardklok",
	"commands.time.no_time_marker_found": "Klok %[2]s heeft tijdstempel %[1]s niet",
	"commands.time.pause": "Klok %s gepauzeerd",
	"commands.time.query": "De tijd is %s",
	"commands.time.query.absolute": "Klok %s staat op %s tick(s)",
	"commands.time.query.gametime": "De speltijd is %s tick(s)",
	"commands.time.query.timeline": "Tijdlijn %s staat op %s tick(s)",
	"commands.time.query.timeline.repetitions": "Tijdlijn %s is %s keer herhaald",
	"commands.time.rate": "Klok %s gaat nu %s× de normale snelheid",
	"commands.time.resume": "Klok %s hervat",
	"commands.time.set": "Tijd verzet naar %s",
	"commands.time.set.absolute": "%s op %s tick(s) gezet",
	"commands.time.set.time_marker": "%s op tijdstempel %s gezet",
	"commands.time.wrong_timeline_for_clock": "Tijdlijn %s is ongeldig voor klok %s",
	...
	"commands.transfer.error.no_players": "Geef ten minste één speler op om door te sturen",
	"commands.transfer.success.multiple": "%s spelers doorgestuurd naar %s:%s",
	"commands.transfer.success.single": "%s doorgestuurd naar %s:%s",
	...
	"commands.unpublish.notPublished": "Geen samen spelen-spel gepubliceerd",
	"commands.unpublish.success": "Samen spelen-spel is nu gesloten",
	...
	"commands.waypoint.list.empty": "Geen wegwijzers in %s",
	"commands.waypoint.list.success": "%s wegwijzer(s) in %s: %s",
	"commands.waypoint.modify.color": "Wegwijzerkleur is nu %s",
	"commands.waypoint.modify.color.reset": "Wegwijzerkleur gereset",
	"commands.waypoint.modify.style": "Wegwijzerstijl gewijzigd",
	...
	"connect.failed.transfer": "Verbinding maken mislukt tijdens het doorsturen naar de server",
	"connect.joining": "Wereld bezoeken...",
	"connect.negotiating": "Onderhandelen...",
	"connect.p2p.establishing": "Verbinding maken...",
	"connect.p2p.failed.generic": "Verbinding maken met speler mislukt",
	"connect.p2p.failed.signaling": "Het is nu niet mogelijk om een verbinding tot stand te brengen.\nProbeer het later opnieuw.",
	"connect.p2p.failed.timeout": "Verbindingsverzoek verlopen",
	"connect.p2p.failed.unreachable": "Speler niet bereikbaar",
	"connect.reconfiging": "Opnieuw instellen...",
	"connect.reconfiguring": "Opnieuw instellen...",
	"connect.transferring": "Doorsturen naar nieuwe server...",
	"container.barrel": "Vat",
	"container.beacon": "Baken",
	"container.beehive.bees": "Bijen: %s/%s",
	"container.beehive.honey": "Honing: %s/%s",
	...
	"container.crafter": "Vervaardigingsmachine",
	...
	"createWorld.customize.buffet.search": "Zoeken...",
	...
	"createWorld.customize.presets.list": "Hier zijn ook een paar die wij hebben gemaakt!",
	...
	"dataPack.locator_bar.description": "De richting van anderen weergeven tijdens het samen spelen",
	"dataPack.locator_bar.name": "Opsporingsbalk",
	"dataPack.minecart_improvements.description": "Verbeterde voortbeweging van mijnkarren",
	"dataPack.minecart_improvements.name": "Mijnkarverbeteringen",
	"dataPack.redstone_experiments.description": "Experimentele Redstonewijzigingen",
	"dataPack.redstone_experiments.name": "Redstone-experimenten",
	"dataPack.title": "Gegevenspakketten selecteren",
	"dataPack.trade_rebalance.description": "Veranderd handelswaar van dorpelingen",
	"dataPack.trade_rebalance.name": "Herijking van dorpelingenhandel",
	"dataPack.update_1_20.description": "Nieuwe functies en inhoud voor Minecraft 1.20",
	"dataPack.update_1_20.name": "Update 1.20",
	"dataPack.update_1_21.description": "Nieuwe functies en inhoud voor Minecraft 1.21",
	"dataPack.update_1_21.name": "Update 1.21",
	"dataPack.validation.back": "Terug",
	"dataPack.validation.failed": "Gegevenspakketvalidatie mislukt!",
	"dataPack.validation.reset": "Standaardpakket gebruiken",
	"dataPack.validation.working": "Geselecteerde gegevenspakketten valideren...",
	"dataPack.vanilla.description": "De standaardgegevens van Minecraft",
	"dataPack.vanilla.name": "Standaard",
	"dataPack.winter_drop.description": "Nieuwe functionaliteit en inhoud voor de kleine winterupdate",
	"dataPack.winter_drop.name": "Kleine winterupdate",
	...
	"datapackFailure.title": "Door fouten in de momenteel geselecteerde gegevenspakketten kon de wereld niet worden geladen.\nJe kunt proberen de wereld te laden met alleen het standaardgegevenspakket ('veilige modus') of je kunt teruggaan naar het hoofdmenu en het handmatig oplossen.",
	"death.attack.anvil": "Een vallend aambeeld plette %[1]s",
	"death.attack.anvil.player": "Een aambeeld plette %[1]s tijdens een gevecht met %[2]s",
	"death.attack.arrow": "%[2]s schoot %[1]s dood",
	"death.attack.arrow.item": "%[2]s schoot %[1]s dood met %[3]s",
	"death.attack.badRespawnPoint.link": "intentioneel spelontwerp",
	"death.attack.badRespawnPoint.message": "%[2]s doodde %[1]s",
	"death.attack.cactus": "%[1]s werd doodgeprikt",
	"death.attack.cactus.player": "%[1]s liep tegen een cactus tijdens het vluchten voor %[2]s",
	"death.attack.cramming": "%[1]s werd te veel geplet",
	"death.attack.cramming.player": "%[2]s verpletterde %[1]s",
	...
	"death.attack.drown.player": "%[1]s verdronk tijdens het vluchten voor %[2]s",
	"death.attack.dryout": "%[1]s droogde uit",
	"death.attack.dryout.player": "%[1]s droogde uit tijdens het vluchten voor %[2]s",
	"death.attack.even_more_magic": "Heel veel magie doodde %[1]s",
	"death.attack.explosion": "%[1]s blies op",
	"death.attack.explosion.player": "%[2]s blies %[1]s op",
	"death.attack.explosion.player.item": "%[2]s blies %[1]s op met %[3]s",
	"death.attack.fall": "%[1]s viel te pletter",
	"death.attack.fall.player": "%[1]s viel te pletter tijdens het vluchten voor %[2]s",
	"death.attack.fallingBlock": "Een vallend blok plette %[1]s",
	"death.attack.fallingBlock.player": "Een vallend blok plette %[1]s tijdens een gevecht met %[2]s",
	"death.attack.fallingStalactite": "Een vallende stalactiet spietste %[1]s",
	"death.attack.fallingStalactite.player": "Een vallende stalactiet spietste %[1]s tijdens een gevecht met %[2]s",
	"death.attack.fireball": "%[2]s doodde %[1]s met een vuurbal",
	"death.attack.fireball.item": "%[2]s met %[3]s doodde %[1]s met een vuurbal",
	"death.attack.fireworks": "%[1]s ging af met een knal",
	"death.attack.fireworks.item": "%[1]s ging af met een knal vanwege vuurwerk afgevuurd van %[3]s door %[2]s",
	"death.attack.fireworks.player": "%[1]s ging af met een knal tijdens een gevecht met %[2]s",
	"death.attack.flyIntoWall": "%[1]s ervoer kinetische energie",
	"death.attack.flyIntoWall.player": "%[1]s ervoer kinetische energie tijdens het vluchten voor %[2]s",
	"death.attack.freeze": "%[1]s bevroor",
	"death.attack.freeze.player": "%[2]s bevroor %[1]s",
	"death.attack.generic": "%[1]s stierf",
	"death.attack.generic.player": "%[1]s stierf vanwege %[2]s",
	"death.attack.genericKill": "%[1]s werd gedood",
	"death.attack.genericKill.player": "%[1]s werd gedood tijdens een gevecht met %[2]s",
	...
	"death.attack.inWall.player": "%[1]s stikte in een muur tijdens een gevecht met %[2]s",
	"death.attack.indirectMagic": "%[2]s doodde %[1]s met magie",
	"death.attack.indirectMagic.item": "%[2]s doodde %[1]s met %[3]s",
	...
	"death.attack.lightningBolt": "Bliksem trof %[1]s",
	"death.attack.lightningBolt.player": "Bliksem trof %[1]s tijdens een gevecht met %[2]s",
	"death.attack.mace_smash": "%[2]s plette %[1]s",
	"death.attack.mace_smash.item": "%[2]s plette %[1]s met %[3]s",
	"death.attack.magic": "Magie doodde %[1]s",
	"death.attack.magic.player": "Magie doodde %[1]s tijdens het vluchten voor %[2]s",
	"death.attack.message_too_long": "Eigenlijk is het bericht te lang om volledig te tonen. Sorry! Hier is de verkleinde versie: %s",
	"death.attack.mob": "%[2]s vermoordde %[1]s",
	"death.attack.mob.item": "%[2]s vermoordde %[1]s met %[3]s",
	"death.attack.onFire": "%[1]s verbrandde levend",
	"death.attack.onFire.item": "%[1]s verbrandde levend tijdens een gevecht met %[2]s hanterende %[3]s",
	"death.attack.onFire.player": "%[1]s verbrandde levend tijdens een gevecht met %[2]s",
	"death.attack.outOfWorld": "%[1]s viel uit de wereld",
	"death.attack.outOfWorld.player": "%[1]s wilde niet in de wereld van %[2]s wonen",
	"death.attack.outsideBorder": "%[1]s verliet de begrenzingen van de wereld",
	"death.attack.outsideBorder.player": "%[1]s verliet de begrenzingen van de wereld tijdens een gevecht met %[2]s",
	...
	"death.attack.spear": "%[2]s doorboorde %[1]s",
	"death.attack.spear.item": "%[2]s doorboorde %[1]s met %[3]s",
	"death.attack.stalagmite": "Een stalagmiet spietste %[1]s",
	"death.attack.stalagmite.player": "Een stalagmiet spietste %[1]s tijdens een gevecht met %[2]s",
	"death.attack.starve": "%[1]s verhongerde",
	"death.attack.starve.player": "%[1]s verhongerde tijdens een gevecht met %[2]s",
	"death.attack.sting": "%[1]s werd doodgestoken",
	"death.attack.sting.item": "%[2]s stak %[1]s dood met %[3]s",
	"death.attack.sting.player": "%[2]s stak %[1]s dood",
	"death.attack.sulfurCubeHot": "%[1]s stierf, want niet alleen de vloer is lava",
	"death.attack.sulfurCubeHot.player": "%[2]s liet %[1]s zien dat niet alleen de vloer lava is",
	"death.attack.sweetBerryBush": "Een zoetbesstruik prikte %[1]s dood",
	"death.attack.sweetBerryBush.player": "Een zoetbesstruik prikte %[1]s dood tijdens het vluchten voor %[2]s",
	...
	"death.attack.thrown": "%[2]s takelde %[1]s toe",
	"death.attack.thrown.item": "%[2]s met %[3]s takelde %[1]s toe",
	"death.attack.trident": "%[2]s spietste %[1]s",
	"death.attack.trident.item": "%[2]s spietste %[1]s met %[3]s",
	"death.attack.wither": "%[1]s verschrompelde",
	"death.attack.wither.player": "%[1]s verschrompelde tijdens een gevecht met %[2]s",
	"death.attack.witherSkull": "Een schedel van %[2]s schoot %[1]s dood",
	"death.attack.witherSkull.item": "Een schedel van %[2]s schoot %[1]s dood met %[3]s",
	...
	"death.fell.assist": "%[2]s doemde %[1]s tot vallen",
	"death.fell.assist.item": "%[2]s doemde %[1]s tot vallen met %[3]s",
	...
	"debug.copy_location.help": "F3 + C = Locatie als /tp-opdracht kopiëren. Houd F3 + C voor tien seconden ingedrukt om het spel te crashen.",
	...
	"debug.crash.message.rebindable": "%s + %s wordt ingedrukt gehouden. Dit crasht het spel, tenzij de toetsen worden losgelaten.",
	...
	"debug.entry.always": "Altijd",
	"debug.entry.currently.alwaysOn": "%s: nu altijd aan",
	"debug.entry.currently.inF3": "%s: nu alleen in F3-scherm",
	"debug.entry.currently.inOverlay": "%s: nu alleen in debugoverlay",
	"debug.entry.currently.never": "%s: nu uit",
	...
	"debug.inspect.client.block": "Blokgegevens van cliënt naar klembord gekopieerd",
	"debug.inspect.client.entity": "Entiteitgegevens van cliënt naar klembord gekopieerd",
	"debug.inspect.help": "F3 + I = Entiteit- of blokgegevens kopiëren",
	"debug.inspect.server.block": "Blokgegevens van de server naar klembord gekopieerd",
	"debug.inspect.server.entity": "Entiteitgegevens van de server naar klembord gekopieerd",
	"debug.options.category.renderer": "Debugweergaven",
	"debug.options.category.text": "Debugschermtekst",
	"debug.options.help": "F3 + F6 = Debuginstellingen bewerken",
	"debug.options.notAllowed.tooltip": "Niet zichtbaar bij verminderde debuginformatie",
	"debug.options.profile.default": "Standaardprofiel",
	"debug.options.profile.performance": "Prestatieprofiel",
	"debug.options.search": "Zoeken...",
	"debug.options.title": "Debuginstellingen",
	"debug.options.warning": "Deze instellingen zijn alleen bestemd voor testdoeleinden. Ze kunnen je computer vertragen, het spel crashen of je fiets op het dak gooien.",
	...
	"debug.profiling.start.rebindable": "Profileren gestart voor %s seconden. Gebruik %s + %s om vroegtijdig te stoppen",
	...
	"debug.version.header": "Spelversie-informatie:",
	"debug.version.help": "F3 + V = Spelversie-informatie",
	...
	"disconnect.exceeded_packet_rate": "Uit de server gezet voor het overschrijden van de gegevenslimiet",
	"disconnect.genericReason": "%s",
	"disconnect.ignoring_status_request": "Statusverzoek negeren",
	...
	"disconnect.packetError": "Netwerkprotocolfout",
	"disconnect.spam": "Eruit gezet voor spammen",
	"disconnect.timeout": "Geen antwoord",
	"disconnect.transfer": "Doorgestuurd naar andere server",
	"disconnect.unknownHost": "Onbekende host",
	"download.pack.failed": "%s van %s pakketten konden niet gedownload worden",
	"download.pack.progress.bytes": "Voortgang: %s (totale grootte onbekend)",
	"download.pack.progress.percent": "Voortgang: %s%%",
	"download.pack.title": "Bronpakket %s van %s downloaden",
	"editGamerule.default": "Standaard: %s",
	"editGamerule.inGame.button": "Spelregels bewerken",
	"editGamerule.inGame.disabled.tooltip": "Je moet een beheerder zijn om spelregels te bewerken.",
	"editGamerule.inGame.discardChanges.message": "Weet je zeker dat je de openstaande spelregelwijzigingen wilt annuleren?",
	"editGamerule.inGame.discardChanges.title": "Spelregelwijzigingen",
	"editGamerule.inGame.downloadingGamerules": "Spelregels ophalen...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Nautilusadem",
	...
	"effect.minecraft.infested": "Infestatie",
	...
	"effect.minecraft.oozing": "Slijmerigheid",
	"effect.minecraft.poison": "Vergif",
	"effect.minecraft.raid_omen": "Overvalsonheil",
	...
	"effect.minecraft.trial_omen": "Beproevingsonheil",
	"effect.minecraft.unluck": "Pech",
	"effect.minecraft.water_breathing": "Wateradem",
	"effect.minecraft.weakness": "Zwakheid",
	"effect.minecraft.weaving": "Weven",
	"effect.minecraft.wind_charged": "Jagende wind",
	...
	"enchantment.minecraft.breach": "Bres",
	"enchantment.minecraft.channeling": "Supergeleiding",
	"enchantment.minecraft.density": "Dichtheid",
	...
	"enchantment.minecraft.lunge": "Stoot",
	...
	"enchantment.minecraft.sweeping_edge": "Verscherping",
	...
	"enchantment.minecraft.wind_burst": "Valwind",
	"entity.minecraft.acacia_boat": "Acaciahouten boot",
	"entity.minecraft.acacia_chest_boat": "Acaciahouten boot met kist",
	"entity.minecraft.allay": "Helper",
	"entity.minecraft.area_effect_cloud": "Gebiedseffectwolk",
	"entity.minecraft.armadillo": "Gordeldier",
	"entity.minecraft.armor_stand": "Harnashouder",
	"entity.minecraft.arrow": "Pijl",
	"entity.minecraft.axolotl": "Axolotl",
	"entity.minecraft.bamboo_chest_raft": "Bamboevlot met kist",
	"entity.minecraft.bamboo_raft": "Bamboevlot",
	"entity.minecraft.bat": "Vleermuis",
	"entity.minecraft.bee": "Bij",
	"entity.minecraft.birch_boat": "Berkenhouten boot",
	"entity.minecraft.birch_chest_boat": "Berkenhouten boot met kist",
	"entity.minecraft.blaze": "Blaze",
	"entity.minecraft.block_display": "Blokweergave",
	"entity.minecraft.boat": "Boot",
	"entity.minecraft.bogged": "Zomper",
	"entity.minecraft.breeze": "Vlaag",
	"entity.minecraft.breeze_wind_charge": "Windvlaag",
	"entity.minecraft.camel": "Dromedaris",
	"entity.minecraft.camel_husk": "Dromedarismummie",
	"entity.minecraft.cat": "Kat",
	"entity.minecraft.cave_spider": "Grottenspin",
	"entity.minecraft.cherry_boat": "Kersenhouten boot",
	"entity.minecraft.cherry_chest_boat": "Kersenhouten boot met kist",
	...
	"entity.minecraft.copper_golem": "Kopergolem",
	"entity.minecraft.cow": "Koe",
	"entity.minecraft.creaking": "Schorswaker",
	"entity.minecraft.creaking_transient": "Schorswaker",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Donkere eikenhouten boot",
	"entity.minecraft.dark_oak_chest_boat": "Donkere eikenhouten boot met kist",
	...
	"entity.minecraft.happy_ghast": "Vrolijke Ghast",
	...
	"entity.minecraft.jungle_boat": "Oerwoudhouten boot",
	"entity.minecraft.jungle_chest_boat": "Oerwoudhouten boot met kist",
	...
	"entity.minecraft.lingering_potion": "Aanhoudende drank",
	"entity.minecraft.llama": "Lama",
	"entity.minecraft.llama_spit": "Lamaspuug",
	"entity.minecraft.magma_cube": "Magmakubus",
	"entity.minecraft.mangrove_boat": "Mangrovehouten boot",
	"entity.minecraft.mangrove_chest_boat": "Mangrovehouten boot met kist",
	...
	"entity.minecraft.oak_boat": "Eikenhouten boot",
	"entity.minecraft.oak_chest_boat": "Eikenhouten boot met kist",
	"entity.minecraft.ocelot": "Ocelot",
	"entity.minecraft.ominous_item_spawner": "Onheilspellende voorwerpspawner",
	"entity.minecraft.painting": "Schilderij",
	"entity.minecraft.pale_oak_boat": "Bleke eikenhouten boot",
	"entity.minecraft.pale_oak_chest_boat": "Bleke eikenhouten boot met kist",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Zoor",
	...
	"entity.minecraft.splash_potion": "Spattende drank",
	"entity.minecraft.spruce_boat": "Sparrenhouten boot",
	"entity.minecraft.spruce_chest_boat": "Sparrenhouten boot met kist",
	"entity.minecraft.squid": "Inktvis",
	"entity.minecraft.stray": "Verdwaalde",
	"entity.minecraft.strider": "Lavarijder",
	"entity.minecraft.sulfur_cube": "Zwavelkubus",
	"entity.minecraft.sulfur_cube.content": "Bevat: %s",
	...
	"entity.minecraft.wind_charge": "Windvlaag",
	...
	"event.minecraft.raid.defeat.full": "Overval - verloren",
	"event.minecraft.raid.raiders_remaining": "%s overvaller(s) over",
	"event.minecraft.raid.victory": "Overwinning",
	"event.minecraft.raid.victory.full": "Overval - overwinning",
	...
	"filled_map.trial_chambers": "Beproevingskamerkaart",
	"filled_map.unknown": "Onbekende kaart",
	"filled_map.village_desert": "Woestijndorpkaart",
	"filled_map.village_plains": "Veldendorpkaart",
	"filled_map.village_savanna": "Savannedorpkaart",
	"filled_map.village_snowy": "Besneeuwddorpkaart",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Netherportalen",
	"gamerule.allowEnteringNetherUsingPortals.description": "Bepaalt of spelers Netherportalen kunnen gebruiken om naar de Nether te kunnen.",
	"gamerule.allowFireTicksAwayFromPlayer": "Tick vuur op een afstand van de speler",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Bepaalt of vuur en lava getickt kunnen worden op een afstand van meer dan acht chunks van een speler.",
	...
	"gamerule.disableElytraMovementCheck": "Dekschildbewegingscontrole uitschakelen",
	"gamerule.disablePlayerMovementCheck": "Spelerbewegingscontrole uitschakelen",
	...
	"gamerule.doVinesSpread.description": "Bepaalt of lianen zich willekeurig verspreiden naar aangrenzende blokken. Heeft geen effect op andere liaansoorten zoals de hangende of verwikkelde klimop.",
	...
	"gamerule.enableCommandBlocks": "Opdrachtblokken toestaan",
	"gamerule.enderPearlsVanishOnDeath": "Gegooide Enderparels verdwijnen bij dood",
	"gamerule.enderPearlsVanishOnDeath.description": "Of door een speler gegooide Enderparels verdwijnen wanneer die speler doodgaat.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Entiteiten met passagiers kunnen portalen gebruiken",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Entiteiten met passagiers kunnen door Nether-, End- en Endpoortportalen teleporteren.",
	...
	"gamerule.forgiveDeadPlayers.description": "Boosgemaakte wezens zijn niet langer boos wanneer hun doelspeler in de buurt sterft.",
	...
	"gamerule.locatorBar": "Speleropsporingsbalk inschakelen",
	"gamerule.locatorBar.description": "Als dit ingeschakeld is, wordt een balk weergegeven die de richting van spelers aangeeft.",
	...
	"gamerule.maxCommandForkCount": "Opdrachtcontextlimiet",
	"gamerule.maxCommandForkCount.description": "Maximumaantal contexten die gebruikt kunnen worden door opdrachten als 'execute as'.",
	"gamerule.maxEntityCramming": "Entiteitsoppropdrempelwaarde",
	"gamerule.minecartMaxSpeed": "Maximale snelheid mijnkar",
	"gamerule.minecartMaxSpeed.description": "De maximale standaardsnelheid van een voortbewegende mijnkar op land.",
	"gamerule.minecraft.elytra_movement_check": "Dekschildbewegingscontrole uitvoeren",
	"gamerule.minecraft.fire_spread_radius_around_player": "Vuurverspreidingsradius",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Het aantal blokken om de speler waarin vuur zich kan verspreiden",
	"gamerule.minecraft.player_movement_check": "Spelerbewegingscontrole uitvoeren",
	"gamerule.minecraft.raids": "Overvallen",
	"gamerule.minecraft.universal_anger.description": "Boosgemaakte neutrale wezens vallen iedere speler in de buurt aan, niet alleen de speler die hen boos gemaakt heeft. Werkt het beste als 'forgive_dead_players' uit staat.",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Netherportaalvertraging in de creatieve modus",
	"gamerule.playersNetherPortalCreativeDelay.description": "Tijd in ticks hoelang een speler in de creatieve modus in een Netherportaal moet staan voordat van dimensies gewisseld wordt.",
	"gamerule.playersNetherPortalDefaultDelay": "Netherportaalvertraging in een niet-creatieve modus",
	"gamerule.playersNetherPortalDefaultDelay.description": "Tijd in ticks hoelang een speler in een niet-creatieve modus in een Netherportaal moet staan voordat van dimensies gewisseld wordt.",
	...
	"gamerule.projectilesCanBreakBlocks": "Projectielen kunnen blokken breken",
	"gamerule.projectilesCanBreakBlocks.description": "Bepaalt of projectielen bij impact blokken kunnen breken die door projectielen gebroken kunnen worden.",
	"gamerule.pvp": "PvP inschakelen",
	"gamerule.pvp.description": "Bepaalt of spelers andere spelers kunnen verwonden.",
	"gamerule.randomTickSpeed": "Willekeurige ticksnelheid",
	"gamerule.reducedDebugInfo": "Verminderde debuginformatie",
	...
	"gamerule.spawnChunkRadius": "Spawnchunkradius",
	"gamerule.spawnChunkRadius.description": "Het aantal chunks rondom het wereldspawnpunt dat ingeladen moet blijven.",
	"gamerule.spawnMonsters": "Monsters spawnen",
	"gamerule.spawnMonsters.description": "Bepaalt of monsters van nature spawnen.",
	"gamerule.spawnRadius": "Respawnlocatieradius",
	"gamerule.spawnRadius.description": "Bepaalt de grootte van het gebied rondom het wereldspawnpunt waarin spelers kunnen beginnen.",
	"gamerule.spawnerBlocksEnabled": "Monsterkooien toestaan",
	"gamerule.spectatorsGenerateChunks": "Toeschouwers kunnen terrein generen",
	"gamerule.tntExplodes": "Bepaalt of TNT aangestoken kan worden en kan exploderen",
	...
	"gamerule.universalAnger.description": "Boosgemaakte neutrale wezens vallen iedere speler in de buurt aan, niet alleen de speler die hen boos gemaakt heeft. Werkt het beste als 'forgiveDeadPlayers' uit staat.",
	...
	"generator.minecraft.single_biome_surface": "één klimaat",
	"generator.single_biome_caves": "grotten",
	"generator.single_biome_floating_islands": "zwevende eilanden",
	"gui.abuseReport.attestation": "Door deze melding te versturen, bevestig je dat de aangedragen informatie, voor zover mogelijk, nauwkeurig en compleet is.",
	"gui.abuseReport.comments": "Opmerkingen",
	"gui.abuseReport.describe": "Door details te delen, kunnen wij een geïnformeerd besluit maken.",
	"gui.abuseReport.discard.content": "Als je dit scherm verlaat, verlies je deze melding en je beschrijving.\nWeet je zeker dat je dit scherm wilt sluiten?",
	"gui.abuseReport.discard.discard": "Sluiten en melding weggooien",
	"gui.abuseReport.discard.draft": "Opslaan als klad",
	"gui.abuseReport.discard.return": "Bewerken",
	"gui.abuseReport.discard.title": "Melding en beschrijving weggooien?",
	"gui.abuseReport.draft.content": "Wil je de bestaande melding bewerken of deze weggooien en een nieuwe maken?",
	"gui.abuseReport.draft.discard": "Weggooien",
	"gui.abuseReport.draft.edit": "Bewerken",
	"gui.abuseReport.draft.quittotitle.content": "Wil je de melding bewerken of weggooien?",
	"gui.abuseReport.draft.quittotitle.title": "Je hebt een kladversie van een melding. Deze zal verdwijnen als je je afmeldt.",
	"gui.abuseReport.draft.title": "Kladversie van melding bewerken?",
	"gui.abuseReport.error.title": "Er trad een probleem op bij het sturen van jouw melding",
	"gui.abuseReport.message": "Waar heb je dit wangedrag waargenomen?\nDeze informatie helpt ons bij het onderzoeken.",
	"gui.abuseReport.more_comments": "Beschrijf wat er gebeurd is:",
	"gui.abuseReport.name.comment_box_label": "Beschrijf waarom je deze naam wilt melden:",
	"gui.abuseReport.name.reporting": "Je maakt een melding over '%s'.",
	"gui.abuseReport.name.title": "Spelersnaam melden",
	"gui.abuseReport.observed_what": "Waarom meld je dit?",
	"gui.abuseReport.read_info": "Meer over melden",
	...
	"gui.abuseReport.reason.generic": "Ik wil deze speler melden",
	"gui.abuseReport.reason.generic.description": "Deze speler irriteert mij of heeft iets gedaan wat mij niet bevalt.",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Seksueel onaanvaardbaar",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Skins van grafische natuur met betrekking tot geslachtsorganen, seksueel geweld en seksuele handelingen.",
	...
	"gui.abuseReport.select_reason": "Meldingscategorie selecteren",
	"gui.abuseReport.send": "Melding sturen",
	"gui.abuseReport.send.comment_too_long": "De opmerking is te lang",
	...
	"gui.abuseReport.send.no_reason": "Selecteer een meldingscategorie",
	"gui.abuseReport.send.not_attested": "Lees, voordat je de melding kan versturen, bovenstaande tekst en kruis het vakje aan",
	...
	"gui.abuseReport.skin.title": "Spelersskin melden",
	"gui.abuseReport.title": "Speler melden",
	"gui.abuseReport.type.chat": "Chatberichten",
	"gui.abuseReport.type.name": "Spelersnaam",
	"gui.abuseReport.type.skin": "Spelersskin",
	...
	"gui.banned.description.reason": "We hebben een melding ontvangen van slecht gedrag afkomstig van jouw account. Onze moderatoren hebben de zaak bekeken en het geïdentificeerd als %s. Dit gaat tegen de gemeenschapsstandaarden van Minecraft in.",
	...
	"gui.banned.description.unknownreason": "We hebben een melding ontvangen van slecht gedrag afkomstig van jouw account. Onze moderatoren hebben de zaak bekeken en bepaald dat het tegen de gemeenschapsstandaarden van Minecraft gaat.",
	"gui.banned.name.description": "Je huidige naam - '%s' - overtreedt onze gemeenschapsstandaarden. Je kunt alleen spelen, maar je moet je naam veranderen om online te kunnen spelen.\n\nLees meer hierover of dien een herzieningsverzoek in op %s",
	"gui.banned.name.title": "Naam online niet toegestaan",
	...
	"gui.banned.skin.description": "Je huidige skin overtreedt onze gemeenschapsstandaarden. Je kunt met een standaardskin spelen of een nieuwe uploaden.\n\nLees meer hierover of dien een herzieningsverzoek in op %s",
	"gui.banned.skin.title": "Skin niet toegestaan",
	"gui.banned.title.permanent": "Account permanent geblokkeerd",
	"gui.banned.title.temporary": "Account tijdelijk geblokkeerd",
	...
	"gui.copy_link_to_clipboard": "Kopiëren",
	"gui.days": "%s dag(en)",
	"gui.done": "Gereed",
	"gui.down": "Omlaag",
	"gui.entity_tooltip.type": "Type: %s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "%s geweigerde bestanden",
	"gui.fileDropFailure.title": "Bestanden toevoegen mislukt",
	"gui.friends.accept": "Accepteren",
	"gui.friends.button.loading": "Wachten...",
	"gui.friends.button.loading.invite_request_pending": "Wachten op bevestiging",
	"gui.friends.button.loading.join_request_pending": "Wachten op bevestiging",
	"gui.friends.cancel_request": "Verzoek annuleren",
	"gui.friends.confirm_title": "Bevestigen",
	"gui.friends.confirm_unfriend": "Weet je zeker dat je deze speler uit je vriendenlijst wil verwijderen?",
	"gui.friends.copy_to_clipboard": "Kopiëren",
	"gui.friends.decline": "Afwijzen",
	"gui.friends.empty_nickname": "Voer een geldige profielnaam in voordat je een vriendschapsverzoek verstuurt",
	"gui.friends.empty_state": "Vrienden die je toevoegt zullen hier verschijnen.\n\nBeheer online veiligheid met je %s.",
	"gui.friends.empty_state.link": "Microsoftaccount",
	"gui.friends.enter_nickname": "Profielnaam zoeken...",
	"gui.friends.error.connection_issue": "De vriendenlijst kon niet geladen worden.\n\nControleer je internetverbinding en probeer het opnieuw.",
	"gui.friends.error.failed.message": "Vriendschapsverzoek sturen mislukt",
	"gui.friends.error.forbidden.message": "Deze vriendenactie uitvoeren mislukte. Dat kan door de privacyinstellingen van het account.",
	"gui.friends.error.generic": "Iets is fout gegaan met deze functionaliteit, niet met je vrienden!\n\nProbeer het later opnieuw.",
	"gui.friends.error.rateLimited.message": "Je voert vriendenlijstacties te snel uit. Wacht even en probeer opnieuw.",
	"gui.friends.error.temporary_unavailable": "De vriendenlijst werkt nu niet.\n\nProbeer het later opnieuw.",
	"gui.friends.error.unavailable.message": "De vriedenlijstdienst is nu niet beschikbaar. Controleer je internetverbinding en probeer het later opnieuw.",
	"gui.friends.error.upgrade_needed": "Update het spel om toegang to je vriendenlijst te krijgen.",
	"gui.friends.error.user_may_lack_active_profile": "Er is geen speler met deze profielnaam",
	"gui.friends.join": "Bezoeken",
	"gui.friends.loading_friends": "Vriendenlijst laden...",
	"gui.friends.loading_requests": "Verzoeken laden...",
	"gui.friends.manage_account_footer": "Beheer je online veiligheid met je %s",
	"gui.friends.multiplayer.invite": "Uitnodigen",
	"gui.friends.multiplayer.invite_accept": "Accepteren",
	"gui.friends.multiplayer.invite_reject": "Afwijzen",
	"gui.friends.multiplayer.join_request": "Vragen te bezoeken",
	"gui.friends.multiplayer.join_request_accept": "Accepteren",
	"gui.friends.multiplayer.join_request_reject": "Afwijzen",
	"gui.friends.my_profile_name": "Mijn profielnaam: ",
	"gui.friends.my_profile_name.narration": "Profielnaam %s kopiëren",
	"gui.friends.narration.button.accept": "Druk op Enter om het vriendschapsverzoek van %s te accepteren",
	"gui.friends.narration.button.cancel_request": "Druk op Enter om het vriendschapsverzoek aan %s te annuleren",
	"gui.friends.narration.button.decline": "Druk op Enter om het vriendschapsverzoek van %s af te wijzen",
	"gui.friends.narration.button.unfriend": "Druk op Enter om %s uit je vriendenlijst te verwijderen",
	"gui.friends.narration.entry.friend": "Vriend %s",
	"gui.friends.narration.entry.incoming": "Inkomend vriendschapsverzoek van %s",
	"gui.friends.narration.entry.outgoing": "Uitgaand vriendschapsverzoek naar %s",
	"gui.friends.open": "Vrienden",
	"gui.friends.open.narration": "Vriendenlijst",
	"gui.friends.open.tooltip": "Vrienden",
	"gui.friends.pending.empty": "Geen openstaande vriendschapsverzoeken",
	"gui.friends.pending.received": "Ontvangen",
	"gui.friends.pending.sent": "Verzonden",
	"gui.friends.presence.status.offline": "Offline",
	"gui.friends.presence.status.online": "Online",
	"gui.friends.presence.status.playing_hosted_server": "Online (wereld)",
	"gui.friends.presence.status.playing_offline": "Online (wereld)",
	"gui.friends.presence.status.playing_realms": "Online (Realm)",
	"gui.friends.presence.status.playing_server": "Online (server)",
	"gui.friends.requests_count": "Verzoeken (%s)",
	"gui.friends.send_request": "Vriendschapsverzoek versturen",
	"gui.friends.tab_friends": "Vrienden",
	"gui.friends.toast.friend_added.message": "%s heeft je vriendschapsverzoek geaccepteerd",
	"gui.friends.toast.friend_invited.message": "%s uitgenodigd om jouw wereld te bezoeken.",
	"gui.friends.toast.friend_removed.message": "%s verwijderd van je vriendenlijst.",
	"gui.friends.toast.generic_error": "Een onverwachte fout trad op tijdens het bijwerken van je vriendenlijst. Probeer het later opnieuw.",
	"gui.friends.toast.host_invite_expired.message": "Uinodiging aan %s om deze wereld te bezoeken verlopen.",
	"gui.friends.toast.invite_from_friend.message": "%s heeft jou uitgenodigd om diens wereld te bezoeken. Open daarvoor de vriendenlijst door op \"%s\" te drukken.",
	"gui.friends.toast.join_invite_expired.message": "Uinodiging om de wereld van %s te bezoeken verlopen.",
	"gui.friends.toast.join_request.message": "%s wilt je wereld bezoeken. Open de vriendenlijst door op \"%s\" te drukken of via het spelmenu.",
	"gui.friends.toast.request_accepted.message": "Je bent nu vrienden met %s",
	"gui.friends.toast.request_received.message": "%s heeft je een vriendschapsverzoek gestuurd",
	"gui.friends.toast.request_sent.message": "Vriendschapsverzoek gestuurd naar %s",
	"gui.friends.toast.request_to_join_friend.message": "Je hebt gevraagd de wereld van %s te bezoeken",
	"gui.friends.toast.requests_accepted_multiple.message": "%s vrienden hebben je vriendschapsverzoek geaccepteerd",
	"gui.friends.toast.requests_received_multiple.message": "Je hebt %s vriendschapsverzoeken ontvangen",
	"gui.friends.unfriend": "Vriend verwijderen",
	"gui.game_rule.search": "Zoeken...",
	"gui.hours": "%s uur",
	"gui.language.search": "Zoeken...",
	"gui.loadingMinecraft": "Minecraft laden...",
	...
	"gui.none": "Geen",
	"gui.ok": "Oké",
	"gui.open_report_dir": "Meldingenmap openen",
	"gui.packSelection.search": "Zoeken...",
	"gui.privacy_link.message": "Open de volgende link om je privacy en online veiligheid te beheren.",
	"gui.privacy_link.title": "Het kan even duren voordat wijzigingen aan Xboxinstellingen worden toegepast.\n\nStart het spel opnieuw als ze niet bijgewerkt worden.",
	"gui.proceed": "Doorgaan",
	"gui.recipebook.moreRecipes": "Klik op de rechtermuisknop voor meer",
	"gui.recipebook.next_page": "Volgende pagina",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Vorige pagina",
	...
	"gui.remove": "Verwijderen",
	"gui.report_to_server": "Melden aan server",
	"gui.selectWorld.search": "Zoeken...",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Deze speler kan niet worden gemeld, omdat de chat is uitgeschakeld of geblokkeerd",
	...
	"gui.stats.none_found": "Geen statistieken gevonden.",
	...
	"gui.togglable_slot": "Klik om vak uit te schakelen",
	"gui.up": "Omhoog",
	"gui.waitingForResponse.button.inactive": "Terug (%ss)",
	"gui.waitingForResponse.title": "Wachten op server",
	"gui.yes": "Ja",
	...
	"item.minecraft.armadillo_scute": "Gordeldierhoornplaat",
	"item.minecraft.armadillo_spawn_egg": "Gordeldierenspawnei",
	...
	"item.minecraft.black_bundle": "Zwarte bundel",
	"item.minecraft.black_dye": "Zwarte kleurstof",
	"item.minecraft.black_harness": "Zwart tuig",
	...
	"item.minecraft.blue_bundle": "Blauwe bundel",
	"item.minecraft.blue_dye": "Blauwe kleurstof",
	"item.minecraft.blue_egg": "Blauw ei",
	"item.minecraft.blue_harness": "Blauw tuig",
	"item.minecraft.bogged_spawn_egg": "Zomperspawnei",
	"item.minecraft.bolt_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Harnasversiering 'bout'",
	"item.minecraft.bone": "Bot",
	"item.minecraft.bone_meal": "Beendermeel",
	"item.minecraft.book": "Boek",
	"item.minecraft.bordure_indented_banner_pattern": "Ingesprongenzoombanierpatroon",
	"item.minecraft.bow": "Boog",
	"item.minecraft.bowl": "Kom",
	"item.minecraft.bread": "Brood",
	"item.minecraft.breeze_rod": "Vlaagstaf",
	"item.minecraft.breeze_spawn_egg": "Vlagenspawnei",
	...
	"item.minecraft.brown_bundle": "Bruine bundel",
	"item.minecraft.brown_dye": "Bruine kleurstof",
	"item.minecraft.brown_egg": "Bruin ei",
	"item.minecraft.brown_harness": "Bruin tuig",
	"item.minecraft.brush": "Borstel",
	"item.minecraft.bucket": "Emmer",
	"item.minecraft.bundle": "Bundel",
	"item.minecraft.bundle.empty": "Leeg",
	"item.minecraft.bundle.empty.description": "Kan een stapel van verschillende voorwerpen vasthouden",
	...
	"item.minecraft.camel_husk_spawn_egg": "Dromedarismummiespawnei",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Harnasversiering 'kust'",
	...
	"item.minecraft.copper_axe": "Koperen bijl",
	"item.minecraft.copper_boots": "Koperen laarzen",
	"item.minecraft.copper_chestplate": "Koperen borstplaat",
	"item.minecraft.copper_golem_spawn_egg": "Kopergolemspawnei",
	"item.minecraft.copper_helmet": "Koperen helm",
	"item.minecraft.copper_hoe": "Koperen schoffel",
	"item.minecraft.copper_horse_armor": "Koperen paardenharnas",
	"item.minecraft.copper_ingot": "Koperstaaf",
	"item.minecraft.copper_leggings": "Koperen beenstukken",
	"item.minecraft.copper_nautilus_armor": "Koperen nautilusharnas",
	"item.minecraft.copper_nugget": "Koperklompje",
	"item.minecraft.copper_pickaxe": "Koperen houweel",
	"item.minecraft.copper_shovel": "Koperen schep",
	"item.minecraft.copper_spear": "Koperen speer",
	"item.minecraft.copper_sword": "Koperen zwaard",
	"item.minecraft.cow_spawn_egg": "Koeienspawnei",
	"item.minecraft.creaking_spawn_egg": "Schorswakerspawnei",
	"item.minecraft.creeper_banner_pattern": "Banierpatroon",
	"item.minecraft.creeper_banner_pattern.desc": "Creeperwapen",
	"item.minecraft.creeper_banner_pattern.new": "Creeperwapenbanierpatroon",
	...
	"item.minecraft.crossbow.projectile.multiple": "Projectiel: %s × %s",
	"item.minecraft.crossbow.projectile.single": "Projectiel: %s",
	"item.minecraft.cyan_bundle": "Turquoise bundel",
	"item.minecraft.cyan_dye": "Turquoise kleurstof",
	"item.minecraft.cyan_harness": "Turquoise tuig",
	"item.minecraft.danger_pottery_shard": "Aardewerkscherf 'gevaar'",
	"item.minecraft.danger_pottery_sherd": "Aardewerkscherf 'gevaar'",
	"item.minecraft.dark_oak_boat": "Donkere eikenhouten boot",
	"item.minecraft.dark_oak_chest_boat": "Donkere eikenhouten boot met kist",
	...
	"item.minecraft.diamond_nautilus_armor": "Diamanten nautilusharnas",
	"item.minecraft.diamond_pickaxe": "Diamanten houweel",
	"item.minecraft.diamond_shovel": "Diamanten schep",
	"item.minecraft.diamond_spear": "Diamanten speer",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Harnasversiering 'duin'",
	...
	"item.minecraft.eye_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Harnasversiering 'oog'",
	"item.minecraft.feather": "Veer",
	"item.minecraft.fermented_spider_eye": "Gefermenteerd spinnenoog",
	"item.minecraft.field_masoned_banner_pattern": "Metselwerkbanierpatroon",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Harnasversiering 'windstroming'",
	"item.minecraft.flow_banner_pattern": "Banierpatroon",
	"item.minecraft.flow_banner_pattern.desc": "Windstroming",
	"item.minecraft.flow_banner_pattern.new": "Windstromingbanierpatroon",
	"item.minecraft.flow_pottery_sherd": "Aardewerkscherf 'windstroming'",
	"item.minecraft.flower_banner_pattern": "Banierpatroon",
	"item.minecraft.flower_banner_pattern.desc": "Bloemwapen",
	"item.minecraft.flower_banner_pattern.new": "Bloemwapenbanierpatroon",
	...
	"item.minecraft.globe_banner_pattern.new": "Globebanierpatroon",
	...
	"item.minecraft.golden_nautilus_armor": "Gouden nautilusharnas",
	"item.minecraft.golden_pickaxe": "Gouden houweel",
	"item.minecraft.golden_shovel": "Gouden schep",
	"item.minecraft.golden_spear": "Gouden speer",
	"item.minecraft.golden_sword": "Gouden zwaard",
	"item.minecraft.gray_bundle": "Grijze bundel",
	"item.minecraft.gray_dye": "Grijze kleurstof",
	"item.minecraft.gray_harness": "Grijs tuig",
	"item.minecraft.green_bundle": "Groene bundel",
	"item.minecraft.green_dye": "Groene kleurstof",
	"item.minecraft.green_harness": "Groen tuig",
	"item.minecraft.guardian_spawn_egg": "Bewakerspawnei",
	"item.minecraft.gunpowder": "Buskruit",
	"item.minecraft.guster_banner_pattern": "Banierpatroon",
	"item.minecraft.guster_banner_pattern.desc": "Rukwind",
	"item.minecraft.guster_banner_pattern.new": "Rukwindbanierpatroon",
	"item.minecraft.guster_pottery_sherd": "Aardewerkscherf 'rukwind'",
	"item.minecraft.happy_ghast_spawn_egg": "Vrolijkeghastspawnei",
	"item.minecraft.harness": "Tuig",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.host_armor_trim_smithing_template.new": "Harnasversiering 'gastheer'",
	...
	"item.minecraft.iron_nautilus_armor": "IJzeren nautilusharnas",
	...
	"item.minecraft.iron_spear": "IJzeren speer",
	...
	"item.minecraft.light_blue_bundle": "Lichtblauwe bundel",
	"item.minecraft.light_blue_dye": "Lichtblauwe kleurstof",
	"item.minecraft.light_blue_harness": "Lichtblauw tuig",
	"item.minecraft.light_gray_bundle": "Lichtgrijze bundel",
	"item.minecraft.light_gray_dye": "Lichtgrijze kleurstof",
	"item.minecraft.light_gray_harness": "Lichtgrijs tuig",
	"item.minecraft.lime_bundle": "Lichtgroene bundel",
	"item.minecraft.lime_dye": "Lichtgroene kleurstof",
	"item.minecraft.lime_harness": "Lichtgroen tuig",
	...
	"item.minecraft.lingering_potion.effect.infested": "Aanhoudende drank der infestatie",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Aanhoudende drank der slijmerigheid",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Aanhoudende drank der weven",
	"item.minecraft.lingering_potion.effect.wind_charged": "Aanhoudende drank des jagende winds",
	"item.minecraft.llama_spawn_egg": "Lamaspawnei",
	"item.minecraft.lodestone_compass": "Kompas wijzend naar zeilsteen",
	"item.minecraft.mace": "Knots",
	"item.minecraft.magenta_bundle": "Magenta bundel",
	"item.minecraft.magenta_dye": "Magenta kleurstof",
	"item.minecraft.magenta_harness": "Magenta tuig",
	...
	"item.minecraft.mojang_banner_pattern.new": "Mojanglogobanierpatroon",
	...
	"item.minecraft.music_disc_bounce": "Muziekplaat",
	...
	"item.minecraft.music_disc_creator": "Muziekplaat",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Muziekplaat",
	...
	"item.minecraft.music_disc_lava_chicken": "Muziekplaat",
	...
	"item.minecraft.music_disc_precipice": "Muziekplaat",
	...
	"item.minecraft.music_disc_tears": "Muziekplaat",
	...
	"item.minecraft.nautilus_spawn_egg": "Nautilusspawnei",
	...
	"item.minecraft.netherite_spear": "Netherieten speer",
	"item.minecraft.netherite_sword": "Netherieten zwaard",
	"item.minecraft.netherite_upgrade_smithing_template": "Smeedssjabloon",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Netherietupgrade",
	...
	"item.minecraft.ominous_bottle": "Onheilspellende fles",
	"item.minecraft.ominous_trial_key": "Onheilspellende beproevingssleutel",
	"item.minecraft.orange_bundle": "Oranje bundel",
	"item.minecraft.orange_dye": "Oranje kleurstof",
	"item.minecraft.orange_harness": "Oranje tuig",
	"item.minecraft.painting": "Schilderij",
	"item.minecraft.pale_oak_boat": "Bleke eikenhouten boot",
	"item.minecraft.pale_oak_chest_boat": "Bleke eikenhouten boot met kist",
	"item.minecraft.panda_spawn_egg": "Pandaspawnei",
	"item.minecraft.paper": "Papier",
	"item.minecraft.parched_spawn_egg": "Zorenspawnei",
	...
	"item.minecraft.piglin_banner_pattern.new": "Snoetbanierpatroon",
	...
	"item.minecraft.pink_bundle": "Roze bundel",
	"item.minecraft.pink_dye": "Roze kleurstof",
	"item.minecraft.pink_harness": "Roze tuig",
	"item.minecraft.pitcher_plant": "Bekerplant",
	"item.minecraft.pitcher_pod": "Bekerplantpeul",
	...
	"item.minecraft.potion.effect.infested": "Drank der infestatie",
	...
	"item.minecraft.potion.effect.oozing": "Drank der slijmerigheid",
	...
	"item.minecraft.potion.effect.weaving": "Drank der weven",
	"item.minecraft.potion.effect.wind_charged": "Drank des jagende winds",
	"item.minecraft.pottery_shard_archer": "Aardewerkscherf 'boogschutter'",
	"item.minecraft.pottery_shard_arms_up": "Aardewerkscherf 'geheven armen'",
	"item.minecraft.pottery_shard_prize": "Aardewerkscherf 'prijs'",
	"item.minecraft.pottery_shard_skull": "Aardewerkscherf 'schedel'",
	...
	"item.minecraft.purple_bundle": "Paarse bundel",
	"item.minecraft.purple_dye": "Paarse kleurstof",
	"item.minecraft.purple_harness": "Paars tuig",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Harnasversiering 'fokker'",
	...
	"item.minecraft.red_bundle": "Rode bundel",
	"item.minecraft.red_dye": "Rode kleurstof",
	"item.minecraft.red_harness": "Rood tuig",
	"item.minecraft.redstone": "Redstonestof",
	"item.minecraft.resin_brick": "Harsbaksteen",
	"item.minecraft.resin_clump": "Harsdruppel",
	"item.minecraft.rib_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Harnasversiering 'rib'",
	...
	"item.minecraft.scrape_pottery_sherd": "Aardewerkscherf 'schrapen'",
	"item.minecraft.scute": "Hoornschild",
	"item.minecraft.sentry_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Harnasversiering 'schildwacht'",
	"item.minecraft.shaper_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Harnasversiering 'vormer'",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Harnasversiering 'stilte'",
	...
	"item.minecraft.skull_banner_pattern.new": "Schedelwapenbanierpatroon",
	...
	"item.minecraft.snout_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Harnasversiering 'snoet'",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Harnasversiering 'piek'",
	...
	"item.minecraft.splash_potion.effect.infested": "Spattende drank der infestatie",
	...
	"item.minecraft.splash_potion.effect.oozing": "Spattende drank der slijmerigheid",
	...
	"item.minecraft.splash_potion.effect.weaving": "Spattende drank der weven",
	"item.minecraft.splash_potion.effect.wind_charged": "Spattende drank des jagende winds",
	...
	"item.minecraft.stone_spear": "Stenen speer",
	...
	"item.minecraft.sulfur_cube_bucket": "Emmer zwavelkubus",
	"item.minecraft.sulfur_cube_spawn_egg": "Zwavelkubusspawnei",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Harnasversiering 'getijde'",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Pijl der infestatie",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Pijl der slijmerigheid",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Pijl der weven",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Pijl des jagende winds",
	...
	"item.minecraft.trial_key": "Beproevingssleutel",
	...
	"item.minecraft.turtle_scute": "Schildpadhoornschild",
	"item.minecraft.turtle_spawn_egg": "Schildpaddenspawnei",
	"item.minecraft.vex_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Harnasversiering 'ergernis'",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Harnasversiering 'hoeder'",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Harnasversiering 'padvinder'",
	"item.minecraft.wheat": "Tarwe",
	"item.minecraft.wheat_seeds": "Tarwezaden",
	"item.minecraft.white_bundle": "Witte bundel",
	"item.minecraft.white_dye": "Witte kleurstof",
	"item.minecraft.white_harness": "Wit tuig",
	"item.minecraft.wild_armor_trim_smithing_template": "Smeedssjabloon",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Harnasversiering 'verwilderd'",
	"item.minecraft.wind_charge": "Windvlaag",
	...
	"item.minecraft.wolf_armor": "Wolvenharnas",
	...
	"item.minecraft.wooden_spear": "Houten speer",
	...
	"item.modifiers.any": "Wanneer aangetrokken:",
	"item.modifiers.armor": "Wanneer gedragen:",
	"item.modifiers.body": "Wanneer aangetrokken:",
	"item.modifiers.chest": "Wanneer op de borst:",
	"item.modifiers.feet": "Wanneer op de voeten:",
	"item.modifiers.hand": "Wanneer vastgehouden:",
	...
	"item.modifiers.saddle": "Wanneer gezadeld:",
	"item.nbt_tags": "NBT: %s label(s)",
	"item.op_block_warning.line1": "Waarschuwing:",
	"item.op_block_warning.line2": "Gebruik van dit voorwerp kan leiden tot de uitvoer van opdrachten.",
	"item.op_block_warning.line3": "Gebruik het niet, tenzij je de exacte inhoud ervan kent!",
	"item.spawn_egg.peaceful": "Uitgeschakeld op vredige niveau",
	...
	"jigsaw_block.placement_priority": "Plaatsingsprioriteit:",
	"jigsaw_block.placement_priority.tooltip": "Dit is de volgorde waarin dit puzzelstuk wordt behandeld bij verbindingen in de bredere constructie wanneer het aansluit bij een ander stuk.\n\nStukken worden in aflopende prioriteit behandeld, waar het moment van toevoeging wordt gebruikt in geval van gelijke prioriteit.",
	"jigsaw_block.pool": "Bronpoel:",
	"jigsaw_block.selection_priority": "Selectieprioriteit:",
	"jigsaw_block.selection_priority.tooltip": "Dit is de volgorde waarin dit puzzelblok probeert zich te verbinden met het doelstuk bij het behandelen van de verbindingen van het doelstuk.\n\nPuzzelblokken worden in aflopende prioriteit behandeld, waarbij een willekeurig bepaalde volgorde wordt gebruikt in geval van gelijke prioriteit.",
	...
	"key.categories.spectator": "Toeschouwermodus",
	"key.categories.ui": "Spelinterface",
	"key.category.minecraft.creative": "Creatieve modus",
	"key.category.minecraft.debug": "Debuggen",
	"key.category.minecraft.gameplay": "Spel",
	"key.category.minecraft.inventory": "Inventaris",
	"key.category.minecraft.misc": "Diversen",
	"key.category.minecraft.movement": "Beweging",
	"key.category.minecraft.multiplayer": "Samen spelen",
	"key.category.minecraft.spectator": "Toeschouwer",
	"key.chat": "Chat openen",
	"key.command": "Opdrachtregel openen",
	"key.debug.clearChat": "Chat legen",
	"key.debug.copyLocation": "Locatie kopiëren",
	"key.debug.copyRecreateCommand": "Gegevens kopiëren",
	"key.debug.crash": "Debugcrash",
	"key.debug.debugOptions": "Debuginstellingen",
	"key.debug.dumpDynamicTextures": "Dynamische texturen dumpen",
	"key.debug.dumpVersion": "Versie-informatie dumpen",
	"key.debug.focusPause": "Pauzeren bij focusverlies in-/uitschakelen",
	"key.debug.fpsCharts": "FPS-grafieken",
	"key.debug.lightmapTexture": "Belichtingstextuur",
	"key.debug.modifier": "Debugcombinatietoets",
	"key.debug.networkCharts": "Netwerkgrafieken",
	"key.debug.overlay": "Overlay in-/uitschakelen",
	"key.debug.profiling": "Profilering starten/stoppen",
	"key.debug.profilingChart": "Profileringsgrafiek",
	"key.debug.reloadChunk": "Chunks herladen",
	"key.debug.reloadResourcePacks": "Bronpakketten herladen",
	"key.debug.showAdvancedTooltips": "Geavanceerde tekstwolken tonen",
	"key.debug.showChunkBorders": "Chunkgrenzen tonen",
	"key.debug.showHitboxes": "Contactvelden tonen",
	"key.debug.spectate": "Van toeschouwer wisselen",
	"key.debug.switchGameMode": "Spelmoduswisselaar",
	"key.drop": "Geselecteerd voorwerp laten vallen",
	"key.forward": "Vooruit",
	"key.friends": "Vriendenscherm",
	...
	"key.left": "Zijwaarts links",
	"key.loadToolbarActivator": "Plaktoets werkbalk laden",
	"key.mouse": "Knop %[1]s",
	...
	"key.quickActions": "Snelle acties",
	"key.right": "Zijwaarts rechts",
	"key.saveToolbarActivator": "Plaktoets werkbalk opslaan",
	...
	"key.spectatorHotbar": "Op werkbalk selecteren",
	"key.spectatorOutlines": "Spelers markeren (toeschouwers)",
	"key.sprint": "Rennen",
	"key.swapOffhand": "Voorwerp van hand wisselen",
	"key.toggleGui": "GUI weergeven/verbergen",
	"key.togglePerspective": "Perspectief omschakelen",
	"key.toggleSpectatorShaderEffects": "Toeschouwershadereffecten in-/uitschakelen",
	"key.use": "Voorwerp gebruiken/blok plaatsen",
	"known_server_link.announcements": "Aankondigingen",
	"known_server_link.community": "Gemeenschap",
	"known_server_link.community_guidelines": "Richtlijnen",
	"known_server_link.feedback": "Feedback",
	"known_server_link.forums": "Fora",
	"known_server_link.news": "Nieuws",
	"known_server_link.report_bug": "Serverbug melden",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Server toevoegen",
	"manageServer.edit.title": "Serverinformatie bewerken",
	"manageServer.enterIp": "Serveradres",
	"manageServer.enterName": "Servernaam",
	"manageServer.resourcePack": "Serverbronpakketten",
	"manageServer.resourcePack.disabled": "uitgeschakeld",
	"manageServer.resourcePack.enabled": "ingeschakeld",
	"manageServer.resourcePack.prompt": "vragen",
	"mco.account.privacy.info": "Lees meer over Mojang en de privacywetten",
	"mco.account.privacy.info.button": "Meer lezen over de AVG",
	"mco.account.privacy.information": "Mojang implementeert bepaalde procedures om kinderen te beschermen en hun privacy te waarborgen, waaronder het naleven van de Children's Online Privacy Protection Act (COPPA) en de Algemene verordening gegevensbescherming (AVG).\n\nJe moet misschien toestemming van jouw ouder(s)/verzorger(s) vragen vóórdat je jouw Realmsaccount gaat gebruiken.",
	...
	"mco.backup.entry": "Back-up (%s)",
	"mco.backup.entry.description": "Beschrijving",
	"mco.backup.entry.enabledPack": "Ingeschakeld(e) pakket(ten)",
	"mco.backup.entry.gameDifficulty": "Spelniveau",
	"mco.backup.entry.gameMode": "Spelmodus",
	"mco.backup.entry.gameServerVersion": "Serverversie",
	"mco.backup.entry.name": "Naam",
	"mco.backup.entry.seed": "Startwaarde",
	"mco.backup.entry.templateName": "Sjabloonnaam",
	"mco.backup.entry.undefined": "Ongedefinieerde wijziging",
	"mco.backup.entry.uploaded": "Geüpload",
	"mco.backup.entry.worldType": "Wereldtype",
	"mco.backup.entry.worldType.adventureMap": "Avontuurwereld",
	"mco.backup.entry.worldType.experience": "Ervaring",
	"mco.backup.entry.worldType.inspiration": "Inspiratie",
	"mco.backup.entry.worldType.minigame": "Minispel",
	"mco.backup.entry.worldType.normal": "Normaal",
	"mco.backup.entry.worldType.unknown": "Onbekend",
	"mco.backup.generate.world": "Wereld genereren",
	"mco.backup.info.title": "Wijzigingen sinds laatste back-up",
	"mco.backup.narration": "Back-up van %s",
	...
	"mco.brokenworld.minigame.title": "Dit minispel wordt niet langer ondersteund",
	"mco.brokenworld.nonowner.error": "Wacht tot de eigenaar van de Realm de wereld reset",
	...
	"mco.client.outdated.stable.version": "Je clientversie (%s) is niet compatibel met Realms.\n\nGebruik de recentste versie van Minecraft.",
	"mco.client.unsupported.snapshot.version": "Je clientversie (%s) is niet compatibel met Realms.\n\nRealms is niet beschikbaar in deze snapshotversie.",
	"mco.compatibility.downgrade": "Downgraden",
	"mco.compatibility.downgrade.description": "Deze wereld werd voor het laatst gespeeld in %s; je gebruikt versie %s. Downgraden kan een wereld beschadigen - we kunnen niet garanderen dat het zal laden of werken.\n\nEen back-up van je wereld wordt opgeslagen onder \"Wereldback-ups\". Herstel je wereld als dat nodig is.",
	"mco.compatibility.incompatible.popup.title": "Incompatibele versie",
	"mco.compatibility.incompatible.releaseType.popup.message": "De wereld die je probeert te bezoeken is niet compatibel met de versie waarin je speelt.",
	"mco.compatibility.incompatible.series.popup.message": "Deze wereld is voor het laatst bezocht in versie %s; je speelt nu in versie %s.\n\nDeze versies zijn niet compatibel met elkaar. Om in deze versie te spelen, heb je een nieuwe wereld nodig.",
	"mco.compatibility.unverifiable.message": "De versie waarin deze wereld voor het laatst gespeeld werd, kon niet geverifieerd worden. Als deze wereld wordt geüpgraded of gedowngraded, wordt een back-up automatisch gemaakt en opgeslagen onder \"Wereldback-ups\".",
	"mco.compatibility.unverifiable.title": "Compatibiliteit niet verifieerbaar",
	"mco.compatibility.upgrade": "Upgraden",
	"mco.compatibility.upgrade.description": "Deze wereld werd voor het laatst gespeeld in %s; je gebruikt %s.\n\nEen back-up van je wereld wordt opgeslagen onder \"Wereldback-ups\".\n\nHerstel je wereld wanneer dat nodig is.",
	"mco.compatibility.upgrade.friend.description": "Deze wereld werd voor het laatst gespeeld in %s; je gebruikt %s.\n\nEen back-up van de wereld wordt opgeslagen onder \"Wereldback-ups\".\n\nDe eigenaar van de Realm kan, wanneer nodig, de wereld herstellen.",
	"mco.compatibility.upgrade.title": "Wil je deze wereld echt upgraden?",
	...
	"mco.configure.world.buttons.close": "Realm tijdelijk sluiten",
	...
	"mco.configure.world.buttons.newworld": "Nieuwe wereld",
	"mco.configure.world.buttons.open": "Realm heropenen",
	"mco.configure.world.buttons.options": "Wereldinstellingen",
	"mco.configure.world.buttons.players": "Spelers",
	"mco.configure.world.buttons.region_preference": "Regio kiezen",
	"mco.configure.world.buttons.resetworld": "Realm resetten",
	"mco.configure.world.buttons.save": "Opslaan",
	"mco.configure.world.buttons.settings": "Instellingen",
	"mco.configure.world.buttons.subscription": "Abonnement",
	"mco.configure.world.buttons.switchminigame": "Minispel wisselen",
	"mco.configure.world.close.question.line1": "Je kunt je Realm tijdelijk sluiten. Hierop kun je dan niet spelen terwijl je aanpassingen doorvoert. Heropen hem wanneer je klaar bent.\n\nDit annuleert je Realmsabonnement niet.",
	"mco.configure.world.close.question.line2": "Weet je zeker dat je dit wilt doen?",
	"mco.configure.world.close.question.title": "Wijzigingen maken zonder onderbrekingen te veroorzaken?",
	"mco.configure.world.closing": "Realm tijdelijk sluiten...",
	"mco.configure.world.commandBlocks": "Opdrachtblokken",
	"mco.configure.world.delete.button": "Realm verwijderen",
	"mco.configure.world.delete.question.line1": "Je Realm wordt permanent verwijderd",
	"mco.configure.world.delete.question.line2": "Weet je zeker dat je dit wilt doen?",
	"mco.configure.world.description": "Realmbeschrijving",
	...
	"mco.configure.world.invited.number": "Uitgenodigd (%s)",
	...
	"mco.configure.world.leave.question.line1": "Als je deze Realm verlaat, zie je hem niet meer, tenzij je opnieuw uitgenodigd wordt.",
	"mco.configure.world.leave.question.line2": "Weet je zeker dat je dit wilt doen?",
	"mco.configure.world.loading": "Realm laden",
	"mco.configure.world.location": "Locatie",
	"mco.configure.world.minigame": "Huidig: %s",
	"mco.configure.world.name": "Realmnaam",
	"mco.configure.world.name.validation.whitespace": "Mag niet beginnen of eindigen met witruimte. Dit zal worden verwijderd.",
	"mco.configure.world.opening": "Realm openen...",
	"mco.configure.world.players.error": "Een speler met de gegeven naam bestaat niet",
	"mco.configure.world.players.invite.duplicate": "Een speler met deze naam is al uitgenodigd tot deze Realm",
	"mco.configure.world.players.inviting": "Speler uitnodigen...",
	"mco.configure.world.players.title": "Spelers",
	"mco.configure.world.pvp": "PvP",
	"mco.configure.world.region_preference": "Regiovoorkeur",
	"mco.configure.world.region_preference.title": "Regiovoorkeur",
	...
	"mco.configure.world.resourcepack.question": "Deze Realm vereist het gebruik van een aangepast bronpakket.\n\nWil je deze downloaden en gaan spelen?",
	"mco.configure.world.resourcepack.question.line1": "Deze Realm heeft een aangepast bronpakket nodig.",
	...
	"mco.configure.world.settings.expired": "Je kunt de instellingen van een verlopen Realm niet bewerken",
	"mco.configure.world.settings.title": "Instellingen",
	"mco.configure.world.slot": "Wereld %s",
	"mco.configure.world.slot.empty": "Leeg",
	"mco.configure.world.slot.switch.question.line1": "Je Realm wordt overgeschakeld naar een andere wereld.",
	...
	"mco.configure.world.slot.tooltip.minigame": "Overschakelen naar minispel",
	...
	"mco.configure.world.subscription.remaining.days": "%[1]s dag(en)",
	"mco.configure.world.subscription.remaining.months": "%[1]s maand(en)",
	"mco.configure.world.subscription.remaining.months.days": "%[1]s maand(en) en %[2]s dag(en)",
	...
	"mco.configure.world.title": "Realm configureren:",
	"mco.configure.world.uninvite.player": "Weet je zeker dat je de uitnodiging aan '%s' wilt intrekken?",
	...
	"mco.connect.failed": "Verbinden met de Realm mislukt",
	"mco.connect.region": "Serverregio: %s",
	"mco.connect.success": "Gereed",
	"mco.create.world": "Creëren",
	"mco.create.world.error": "Je moet een naam invoeren!",
	"mco.create.world.failed": "Wereld aanmaken mislukt!",
	...
	"mco.download.confirmation.line2": "Het is niet meer mogelijk deze wereld te uploaden naar je Realm",
	"mco.download.confirmation.oversized": "Je staat op het punt een wereld te downloaden die groter is dan %s\n\nJe kunt deze wereld niet weer uploaden naar je Realm",
	...
	"mco.download.resourcePack.fail": "Bronpakket downloaden mislukt!",
	...
	"mco.errorMessage.6005": "Wereld vergrendeld",
	"mco.errorMessage.6006": "Verouderde wereld",
	"mco.errorMessage.6007": "Gebruiker is lid van te veel Realms",
	"mco.errorMessage.6008": "Realmnaam ongeldig",
	"mco.errorMessage.6009": "Realmbeschrijving ongeldig",
	"mco.errorMessage.connectionFailure": "Er trad een fout op. Probeer het later opnieuw.",
	"mco.errorMessage.generic": "Er trad een fout op: ",
	"mco.errorMessage.initialize.failed": "Realm initiailiseren mislukt",
	"mco.errorMessage.noDetails": "Geen details voor fout gegeven",
	"mco.errorMessage.realmsService": "Er trad een fout op (%s):",
	"mco.errorMessage.realmsService.configurationError": "Er trad een onverwachte fout op tijdens het bewerken van wereldinstellingen",
	"mco.errorMessage.realmsService.connectivity": "Kan geen verbinding met Realms maken: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Kan niet op compatibele versie controleren. Antwoord: %s",
	"mco.errorMessage.retry": "Probeer opnieuw",
	...
	"mco.gui.ok": "Oké",
	"mco.info": "Informatie!",
	"mco.invited.player.narration": "Speler %s uitgenodigd",
	...
	"mco.minigame.world.changeButton": "Ander minispel kiezen",
	"mco.minigame.world.info.line1": "Je wereld wordt tijdelijk vervangen door een minispel!",
	...
	"mco.minigame.world.restore": "Minispel beëindigen...",
	"mco.minigame.world.restore.question.line1": "Het minispel wordt beëindigd en je Realm wordt hersteld.",
	"mco.minigame.world.restore.question.line2": "Weet je zeker dat je dit wilt doen?",
	"mco.minigame.world.selected": "Geselecteerd minispel:",
	"mco.minigame.world.slot.screen.title": "Wereld overschakelen...",
	"mco.minigame.world.startButton": "Overschakelen",
	"mco.minigame.world.starting.screen.title": "Minispel starten...",
	"mco.minigame.world.stopButton": "Minispel beëindigen",
	"mco.minigame.world.switch.new": "Ander minispel kiezen?",
	"mco.minigame.world.switch.title": "Minispel wijzigen",
	"mco.minigame.world.title": "Realm omschakelen naar minispel",
	"mco.news": "Realmsnieuws",
	"mco.notification.dismiss": "Sluiten",
	"mco.notification.transferSubscription.buttonText": "Nu overzetten",
	"mco.notification.transferSubscription.message": "Javarealmsabonnementen worden verplaatst naar de Microsoft Store. Laat je abonnement niet verlopen!\nZet 'm nu over en krijg dertig dagen Realms gratis.\nGa naar je profiel op minecraft.net en zet je abonnement over.",
	...
	"mco.play.button.realm.closed": "Realm is gesloten",
	"mco.question": "Vraag",
	...
	"mco.reset.world.warning": "Dit vervangt je huidige Realmwereld voorgoed",
	"mco.selectServer.buy": "Koop een Realm!",
	"mco.selectServer.close": "Sluiten",
	"mco.selectServer.closed": "Gedeactiveerde Realm",
	"mco.selectServer.closeserver": "Realm sluiten",
	"mco.selectServer.configure": "Configureren",
	"mco.selectServer.configureRealm": "Realm instellen",
	"mco.selectServer.create": "Realm maken",
	"mco.selectServer.create.subtitle": "Selecteer welke wereld je op je nieuwe Realm wilt zetten",
	...
	"mco.selectServer.loading": "Realmslijst laden",
	...
	"mco.selectServer.minigameNotSupportedInVersion": "Dit minispel kan niet gespeeld worden in %s",
	"mco.selectServer.noRealms": "Het lijkt erop dat je geen Realm hebt. Voeg een Realm toe om met je vrienden samen te spelen.",
	...
	"mco.selectServer.popup": "Realms is een veilige en makkelijke manier om een onlinewereld met tot wel tien vrienden te delen. Er zijn veel minispellen en meer dan genoeg aangepaste werelden! Alleen de eigenaar van de Realm hoeft te betalen.",
	"mco.selectServer.purchase": "Realm toevoegen",
	"mco.selectServer.trial": "Neem een proefperiode!",
	"mco.selectServer.uninitialized": "Klik om een nieuwe Realm te beginnen!",
	"mco.snapshot.createSnapshotPopup.text": "Je gaat een gratis snapshotrealm maken die deel uitmaakt van je Realmsabonnement. Deze nieuwe snapshotrealm blijft toegankelijk zolang je abonnement actief is. Dit heeft geen effect op je betaalde Realm.",
	"mco.snapshot.createSnapshotPopup.title": "Snapshotrealm maken?",
	"mco.snapshot.creating": "Snapshotrealm maken...",
	"mco.snapshot.description": "Maakt deel uit van %s",
	"mco.snapshot.friendsRealm.downgrade": "Je moet %s gebruiken om op deze Realm te spelen",
	"mco.snapshot.friendsRealm.upgrade": "%s moet hun Realm upgraden voordat je met deze snapshot erop kan spelen",
	"mco.snapshot.paired": "Deze snapshotrealm maakt deel uit van %s",
	"mco.snapshot.parent.tooltip": "Gebruik de nieuwste release van Minecraft om op deze Realm te spelen",
	"mco.snapshot.start": "Gratis snapshotrealm beginnen",
	"mco.snapshot.subscription.info": "Deze snapshotrealm maakt deel uit van het abonnement van Realm '%s'. Het blijft actief zolang de Realm waar het deel van uitmaakt actief is.",
	"mco.snapshot.tooltip": "Gebruik snapshotrealms om een voorproefje te krijgen van toekomstige Minecraftversies. Deze kunnen nieuwe functionaliteiten en veranderingen bevatten.\n\nJe kunt je gewone Realms vinden in de releaseversie van het spel.",
	"mco.snapshotRealmsPopup.message": "Vanaf 23w41a kun je in een snapshot op Realms spelen. Elk Realmsabonnement heeft een gratis snapshotrealm die apart staat van je normale Realm!",
	"mco.snapshotRealmsPopup.title": "Realms nu beschikbaar in snapshots",
	"mco.snapshotRealmsPopup.urlText": "Meer lezen",
	...
	"mco.template.title.minigame": "Minispellen",
	...
	"mco.time.daysAgo": "%[1]s dag(en) geleden",
	"mco.time.hoursAgo": "%[1]s uur geleden",
	"mco.time.minutesAgo": "%[1]s minu(u)t(en) geleden",
	"mco.time.now": "zojuist",
	"mco.time.secondsAgo": "%[1]s seconde(n) geleden",
	...
	"mco.upload.failed.too_big.description": "De geselecteerde wereld is te groot. De maximaal toegestane grootte is %s.",
	"mco.upload.failed.too_big.title": "Wereld te groot",
	...
	"mco.version": "Versie: %s",
	"mco.warning": "Waarschuwing!",
	"mco.worldSlot.minigame": "Minispel",
	"menu.custom_options": "Aangepaste instellingen",
	"menu.custom_options.title": "Aangepaste instellingen",
	"menu.custom_options.tooltip": "Opmerking: Aangepaste instellingen zijn afkomstig van servers en/of inhoud van een derde partij.\nWees voorzichtig!",
	"menu.custom_screen_info.button_narration": "Dit is een aangepast scherm. Meer weten.",
	"menu.custom_screen_info.contents": "De inhoud van dit scherm wordt beheerd door servers en werelden van een derde partij die niet eigendom is van, beheerd wordt door of onder toezicht staat van Mojang Studios of Microsoft.\n\nWees voorzichtig! Wees terughoudend bij het volgen van links en geef nooit zomaar je persoonlijke informatie, inclusief aanmeldgegevens, weg.\n\nAls dit scherm voorkomt dat je kunt spelen, kun je ook de verbinding met de server verbreken met onderstaande knop.",
	"menu.custom_screen_info.disconnect": "Aangepast scherm afgewezen",
	"menu.custom_screen_info.title": "Opmerking over aangepaste schermen",
	"menu.custom_screen_info.tooltip": "Dit is een aangepast scherm. Klik hier om meer te lezen.",
	...
	"menu.multiplayerOptions.applyChanges": "Wijzigingen toepassen",
	"menu.multiplayerOptions.button": "Samen spelen",
	"menu.multiplayerOptions.network": "Samen spelen",
	"menu.multiplayerOptions.network.header": "Netwerk",
	"menu.multiplayerOptions.network.lan": "LAN",
	"menu.multiplayerOptions.network.lan.tooltip": "Spelers op hetzelfde netwerk kunnen deelnemen.",
	"menu.multiplayerOptions.network.off": "UIT",
	"menu.multiplayerOptions.network.off.tooltip": "Niemand kan jouw wereld bezoeken.",
	"menu.multiplayerOptions.network.online": "Online",
	"menu.multiplayerOptions.network.online.tooltip": "Online vrienden kunnen deelnemen.",
	"menu.multiplayerOptions.otherPlayers.header": "Andere spelers",
	"menu.multiplayerOptions.publish.started.lan": "Deze wereld is opengestelt voor LAN op poortnummer %s.",
	"menu.multiplayerOptions.publish.started.online": "De wereld is opengesteld om online samen te spelen.",
	"menu.multiplayerOptions.publish.stopped": "Deze wereld is nu gesloten voor samen spelen",
	"menu.multiplayerOptions.title": "Instellingen voor samen spelen",
	...
	"menu.playerReporting.no_players": "Er zijn geen spelers in deze wereld om te rapporteren",
	"menu.preparingSpawn": "Spawngebied voorbereiden: %s%%",
	"menu.quick_actions": "Snelle acties",
	"menu.quick_actions.title": "Snelle acties",
	...
	"multiplayer.codeOfConduct.check": "Toon deze gedragscode niet meer",
	"multiplayer.codeOfConduct.title": "Servergedragscode",
	"multiplayer.confirm_command.parse_errors": "Je probeert een onbekende of ongeldige opdracht uit te voeren.\nWeet je het zeker?\nOpdracht: %s",
	"multiplayer.confirm_command.permissions_required": "Je probeert een opdracht uit te voeren die extra toestemmingen vereist.\nDit kan je spel negatief beïnvloeden.\nWeet je het zeker?\nOpdracht: %s",
	"multiplayer.confirm_command.run_command": "Opdracht uitvoeren",
	"multiplayer.confirm_command.signature_required": "Je probeert een opdracht uit te voeren die een chatbericht stuurt op jouw naam.\nZe kan alleen vanuit het chatscherm worden uitgevoerd.\nOpdracht: %s",
	"multiplayer.confirm_command.suggest_command": "Naar chatscherm kopiëren",
	"multiplayer.confirm_command.title": "Opdracht uitvoeren bevestigen",
	"multiplayer.disconnect.authservers_down": "Verificatieservers werken niet. Probeer het later opnieuw!",
	"multiplayer.disconnect.bad_chat_index": "Ontbrekend of opnieuw geordend chatbericht van de server gedetecteerd",
	...
	"multiplayer.disconnect.banned.reason.default": "Geblokkeerd door een beheerder.",
	...
	"multiplayer.disconnect.code_of_conduct": "Server vereist het accepteren van de gedragscode",
	"multiplayer.disconnect.configuration_error": "Onverwachte fout tijdens configureren",
	...
	"multiplayer.disconnect.invalid_packet": "De server stuurde ongeldige gegevens",
	"multiplayer.disconnect.invalid_player_data": "Ongeldige spelergegevens",
	"multiplayer.disconnect.invalid_player_movement": "Ongeldige gegevens voor bewegende speler ontvangen",
	...
	"multiplayer.disconnect.invalid_vehicle_movement": "Ongeldige gegevens voor bewegend voertuig ontvangen",
	...
	"multiplayer.disconnect.out_of_order_chat": "Chatpakket in verkeerde volgorde ontvangen. Is je systeemtijd veranderd?",
	...
	"multiplayer.disconnect.slow_login": "Het aanmelden duurde te lang",
	"multiplayer.disconnect.too_many_pending_chats": "Te veel niet-erkende chatberichten",
	"multiplayer.disconnect.transfers_disabled": "Server staat doorsturen niet toe",
	"multiplayer.disconnect.unexpected_query_response": "Onverwachte aangepaste gegevens van cliënt",
	...
	"multiplayer.message_not_delivered": "Chatbericht kon niet worden verzonden. Controleer de serverlogboeken: %s",
	...
	"multiplayer.status.anonymous_player": "Anonieme speler",
	...
	"multiplayer.status.old": "Verouderd",
	...
	"narration.checkbox.usage.focused.check": "Selecteer met Enter",
	"narration.checkbox.usage.focused.uncheck": "Deselecteer met Enter",
	"narration.checkbox.usage.hovered": "Klik op de linkermuisknop om te wisselen",
	"narration.checkbox.usage.hovered.check": "Selecteer met linkermuisknop",
	"narration.checkbox.usage.hovered.uncheck": "Deselecteer met linkermuisknop",
	...
	"narration.link.usage.focused": "Druk op Enter om de link te volgen",
	"narration.link.usage.hovered": "Druk op de linkermuisknop om de link te volgen",
	...
	"narration.selection.usage": "Druk op toetsen omhoog en omlaag om een ander item te selecteren",
	"narration.slider.usage.focused": "Gebruik toetsen links en rechts om waarde te wijzigen",
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Druk op Enter om de schuifwaarde te kunnen veranderen",
	"narration.slider.usage.hovered": "Sleep de schuifregelaar om waarde te wijzigen",
	"narration.suggestion": "Suggestie %s van %s geselecteerd: %s",
	"narration.suggestion.tooltip": "Suggestie %s van %s geselecteerd: %s (%s)",
	"narration.suggestion.usage.cycle.fixed": "Druk op Tab om naar de volgende suggestie te gaan",
	"narration.suggestion.usage.cycle.hidable": "Druk op Tab om naar de volgende suggestie te gaan of op Escape om de suggesties te verlaten",
	"narration.suggestion.usage.fill.fixed": "Druk op Tab om de suggestie te gebruiken",
	"narration.suggestion.usage.fill.hidable": "Druk op Tab om de suggestie te gebruiken of op Escape om de suggesties te verlaten",
	...
	"narrator.select.world": "%s geselecteerd; laatst gespeeld: %s om %s in spelmodus %s; versie: %s",
	"narrator.select.world_info": "%s geselecteerd; laatst gespeeld: %s om %s",
	"narrator.toast.disabled": "Verteller uitgeschakeld",
	"narrator.toast.enabled": "Verteller ingeschakeld",
	"optimizeWorld.confirm.description": "Hiermee zal geprobeerd worden je wereld te optimaliseren, zodat alle gegevens in het recentste spelformaat wordt opgeslagen. Dit kan heel lang duren, afhankelijk van de wereld. Wanneer dit klaar is, kan de wereld sneller zijn, maar is het niet langer compatibel met oudere versies van het spel. Weet je zeker dat je verder wilt gaan?",
	"optimizeWorld.confirm.proceed": "Back-up maken en optimaliseren",
	...
	"optimizeWorld.stage.finished": "Afronden...",
	"optimizeWorld.stage.finished.chunks": "Upgraden van chunks afronden...",
	"optimizeWorld.stage.finished.entities": "Upgraden van entiteiten afronden...",
	"optimizeWorld.stage.finished.poi": "Upgraden van herkenningspunten afronden...",
	"optimizeWorld.stage.upgrading": "Chunks upgraden...",
	"optimizeWorld.stage.upgrading.chunks": "Chunks upgraden...",
	"optimizeWorld.stage.upgrading.entities": "Entiteiten upgraden...",
	"optimizeWorld.stage.upgrading.poi": "Herkenningspunten upgraden...",
	"optimizeWorld.title": "Wereld '%s' optimaliseren",
	"options.accessibility": "Toegankelijkheidsinstellingen",
	...
	"options.accessibility.high_contrast_block_outline": "Hoog contrast blokomlijning",
	"options.accessibility.high_contrast_block_outline.tooltip": "Verhoogt het blokomlijningscontrast van het aangekeken blok.",
	"options.accessibility.link": "Toegankelijkheidsgids",
	"options.accessibility.menu_background_blurriness": "Wazigheid menu-achtergrond",
	"options.accessibility.menu_background_blurriness.tooltip": "Past de wazigheid aan van menu-achtergronden",
	"options.accessibility.narrator_hotkey": "Vertellersneltoets",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Met ⌘ + B de verteller in- en uitschakelen.",
	"options.accessibility.narrator_hotkey.tooltip": "Met Ctrl + B de verteller in- en uitschakelen.",
	...
	"options.accessibility.text_background_opacity": "Achtergronddoorzichtigheid",
	"options.accessibility.title": "Toegankelijkheidsinstellingen",
	"options.accessibility.tooltip": "Toegankelijkheidsinstellingen",
	"options.allowCursorChanges": "Veranderende muisaanwijzer",
	"options.allowCursorChanges.tooltip": "Bepaalt of de muisaanwijzer bij bepaalde interface-elementen van vorm kan veranderen.",
	"options.allowFriendRequests": "Vriendschapsverzoeken",
	"options.allowFriendRequests.tooltip": "Vriendschapsverzoeken van andere spelers toestaan",
	...
	"options.blocks": "%s blokken",
	"options.chat": "Chatinstellingen",
	"options.chat.color": "Kleuren",
	"options.chat.delay": "Chatvertraging: %s second(en)",
	"options.chat.delay_none": "Chatvertraging: geen",
	"options.chat.drafts": "Niet-verzonden chats opslaan",
	"options.chat.drafts.tooltip": "Niet-verzonden berichten worden opgeslagen en kunnen verstuurd worden wanneer de chat weer geopend wordt.",
	...
	"options.chat.links.prompt": "Hyperlinkmelding",
	...
	"options.chunkFade": "Chunkverschijningstijd",
	"options.chunkFade.none": "Chunkverschijning: meteen",
	"options.chunkFade.seconds": "Chunkverschijning: %s seconde(n)",
	"options.chunkFade.tooltip": "Hoe lang chunks erover doen om te verschijnen wanneer ze voor het eerst worden weergegeven.",
	...
	"options.cutoutLeaves": "Doorzichtige bladeren",
	"options.cutoutLeaves.tooltip": "Bepaalt of je door de ruimtes tussen bladeren heen kunt kijken. Prestaties kunnen verbeteren als je dit uitzet.",
	...
	"options.difficulty.online": "Serverniveau",
	...
	"options.exclusiveFullscreen": "Exclusief volledig scherm",
	"options.exclusiveFullscreen.warningTooltip": "Deze instelling kan de werking van sommige invoermethoden voorkomen.",
	"options.font": "Lettertype-instellingen",
	"options.font.title": "Lettertype-instellingen",
	...
	"options.friendsList": "Vriendenlijst",
	"options.friendsList.confirm.message": "Gebruik je vriendenlijst op vriendschapsverzoeken te sturen en te ontvangen.\n\nBeheer onlineveiligheidsinstellingen in je %s.",
	"options.friendsList.confirm.message.link": "Microsoftaccount",
	"options.friendsList.confirm.title": "Vriendenlijst",
	"options.friendsList.confirm.turnOff": "Uitschakelen",
	"options.friendsList.confirm.turnOn": "Inschakelen",
	"options.fullscreen": "Volledig scherm",
	"options.fullscreen.current": "huidig",
	"options.fullscreen.entry": "%s×%s@%s (%s-bit)",
	...
	"options.graphics": "Weergave",
	"options.graphics.custom": "aangepast",
	...
	"options.graphics.preset": "voorinstelling",
	"options.graphics.preset.tooltip": "Past standaardwaarden toe op kwaliteits- en prestatie-instellingen overeenkomstig de gewenste kwaliteit.",
	...
	"options.graphicsApi": "Voorkeur grafische API",
	"options.graphicsApi.default": "standaard",
	"options.graphicsApi.opengl": "OpenGL",
	"options.graphicsApi.restart": "Je moet het spel opnieuw starten om de grafische API te veranderen.",
	"options.graphicsApi.tooltip": "De bij het renderen gebruikte grafische API. Laat dit op standaard, tenzij je dit móét veranderen!",
	"options.graphicsApi.tooltip.vulkan": "Experimenteel. Kan prestaties verminderen of instabiliteit veroorzaken op sommige systemen.",
	"options.graphicsApi.vulkan": "Vulkan (experimenteel)",
	"options.guiScale": "GUI-schaal",
	"options.guiScale.auto": "automatisch",
	"options.hidden": "verborgen",
	"options.hideLightningFlashes": "Luchtflitsen verbergen",
	"options.hideLightningFlashes.tooltip": "Voorkomt dat bliksemschichten en andere omgevingseffecten de lucht laten oplichten. De bronnen van de flitsen zijn nog steeds zichtbaar.",
	"options.hideMatchedNames": "Op naam verbergen",
	"options.hideMatchedNames.tooltip": "Servers van derden kunnen chatberichten sturen in een afwijkend format.\nDoor deze instelling in te schakelen, worden spelers in chat verborgen op basis van afzender.",
	"options.hideSplashTexts": "Splashtekst verbergen",
	"options.hideSplashTexts.tooltip": "Verbergt de gele splashtekst in het hoofdmenu.",
	"options.improvedTransparency": "Verbeterde doorzichtigheid",
	"options.improvedTransparency.tooltip": "Een experimentele methode die schermshaders gebruikt om weer, wolken en deeltjes achter doorzichtige blokken en water te tekenen. Dit heeft invloed op grafische prestaties.",
	"options.inGameNotification": "Melding in het spel",
	"options.inGameNotification.tooltip": "Vriendenberichten in het spel tonen",
	"options.inactivityFpsLimit": "FPS verminderen wanneer",
	"options.inactivityFpsLimit.afk": "AFK",
	"options.inactivityFpsLimit.afk.tooltip": "Limiteert de framerate tot dertig wanneer het spel geen invoer van een speler krijgt voor langer dan een minuut. Na negen minuten wordt dit gelimiteerd tot tien.",
	"options.inactivityFpsLimit.minimized": "geminimaliseerd",
	"options.inactivityFpsLimit.minimized.tooltip": "Limiteert de framerate alleen wanneer het spel geminimaliseerd is.",
	"options.invertMouse": "Muis spiegelen",
	"options.invertMouseX": "X-as muis spiegelen",
	"options.invertMouseY": "Y-as muis spiegelen",
	"options.japaneseGlyphVariants": "Japanse karaktervarianten",
	"options.japaneseGlyphVariants.tooltip": "Gebruikt de Japanse varianten van de CJK-karakters in het standaardlettertype",
	"options.key.hold": "vasthouden",
	"options.key.toggle": "omschakelen",
	"options.language": "Taal",
	"options.language.narration": "Taal veranderen",
	"options.language.title": "Taal",
	"options.language.tooltip": "Taal veranderen",
	"options.languageAccuracyWarning": "(vertalingen zijn mogelijk onnauwkeurig)",
	...
	"options.maxAnisotropy": "Anisotropische filter",
	"options.maxAnisotropy.tooltip": "Ieder niveau verbetert significant de soepelheid van texturen, maar beïnvloedt de prestaties en videogeheugengebruik sterk. Vereist dat de textuurfilter op anisotropisch is gezet.",
	...
	"options.musicToast": "Muziektekstwolk",
	"options.musicToast.never": "nooit",
	"options.musicToast.never.tooltip": "Een muziektekstwolk wordt niet getoond.",
	"options.musicToast.pauseMenu": "pauzemenu",
	"options.musicToast.pauseMenu.tooltip": "Er wordt een blijvende muziektekstwolk getoond in het pauzemenu terwijl muziek speelt.",
	"options.musicToast.pauseMenuAndToast": "pauzemenu en tekstwolk",
	"options.musicToast.pauseMenuAndToast.tooltip": "Toont een tekstwolk als muziek begint te spelen. Indien ingeschakeld, wordt deze tekstwolk continu getoond in het pauzemenu terwijl muziek speelt.",
	"options.music_frequency": "Muziekfrequentie",
	"options.music_frequency.constant": "constant",
	"options.music_frequency.default": "standaard",
	"options.music_frequency.frequent": "vaak",
	"options.music_frequency.tooltip": "Bepaalt hoe vaak muziek speelt wanneer je in een wereld bent.",
	...
	"options.needsRestart": "Deze instelling wordt toegepast na het spel opnieuw te starten.",
	...
	"options.realmsNotifications.button": "Nieuws en uitnodigingen",
	"options.realmsNotifications.tooltip": "Haalt Realmsnieuws en -uitnodigingen op in het titelscherm en toont hun respectievelijke icoontjes op de Realmsknop.",
	"options.reducedDebugInfo": "Minder debuginformatie",
	"options.renderClouds": "Wolken",
	"options.renderCloudsDistance": "Wolkenafstand",
	"options.renderDistance": "Weergavebereik",
	"options.resourcepack": "Bronpakketten",
	"options.restartRequired": "Sommige van je wijzigingen worden toegepast nadat je het spel opnieuw start.",
	"options.rotateWithMinecart": "Met mijnkarren draaien",
	"options.rotateWithMinecart.tooltip": "Of het zichtveld van de speler mee moet draaien met een draaiende mijnkar. Alleen beschikbaar in werelden waar de experimentele instelling 'Mijnkarverbeteringen' ingeschakeld is.",
	...
	"options.sharePresence": "Activiteit",
	"options.sharePresence.all": "iedereen",
	"options.sharePresence.all.tooltip": "Activiteit wordt gedeelt met je vrienden. Je status verandert in online en je deelt wat je doet.",
	"options.sharePresence.limited": "beperkt",
	"options.sharePresence.limited.tooltip": "Activiteit wordt beperkt gedeeld. Je status verandert in online, maar je deelt niet wat je doet. Je kan nog steeds vrienden uitnodigen om je wereld te bezoeken.",
	"options.sharePresence.none": "geen",
	"options.sharePresence.none.tooltip": "Activiteit wordt niet gedeeld. Je status is offline.",
	"options.showNowPlayingToast": "Muziektekstwolk tonen",
	"options.showNowPlayingToast.tooltip": "Toont een tekstwolk wanneer muziek begint te spelen. Indien ingeschakeld, wordt deze tekstwolk continu getoond in het pauzemenu terwijl muziek speelt.",
	"options.showSubtitles": "Ondertiteling",
	"options.showSubtitles.tooltip": "Ondertiteling voor geluiden in het spel inschakelen.",
	...
	"options.sprintWindow": "Reninterval",
	"options.sprintWindow.tooltip": "Tijdinterval in ticks waarin rennen wordt geactiveerd bij dubbel drukken op de vooruitknop.",
	...
	"options.telemetry.disabled": "Dataverzameling uitgeschakeld.",
	"options.telemetry.state.all": "alles",
	"options.telemetry.state.minimal": "minimaal",
	"options.telemetry.state.none": "geen",
	"options.textureFiltering": "Textuurfilter",
	"options.textureFiltering.anisotropic": "anisotropisch",
	"options.textureFiltering.anisotropic.tooltip": "Een hardwarefiltermethode die prestaties en videogeheugengebruik sterk beïnvloedt. Wordt mogelijk niet op alle apparatuur ondersteund.",
	"options.textureFiltering.none": "geen",
	"options.textureFiltering.none.tooltip": "Texturen worden zonder filter getoond. Blokken kunnen er wazig uitzien wanneer ze vanuit een hoek bekeken worden.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nEen shaderfiltermethode die de textuurkwaliteit verbetert met een gemiddelde invloed op prestaties.",
	"options.title": "Instellingen",
	"options.touchscreen": "Touchscreenmodus",
	"options.value": "%s",
	"options.video": "Grafische instellingen",
	"options.video.display.header": "Weergave",
	"options.video.interface.header": "Interface",
	"options.video.preferences.header": "Voorkeuren",
	"options.video.quality.header": "Kwaliteit en prestaties",
	"options.videoTitle": "Grafische instellingen",
	"options.viewBobbing": "Loopbeweging",
	"options.vignette": "Vignette tonen",
	"options.vignette.tooltip": "Dit is een onopvallende textuur aan de randen van het scherm die de helderheid daar vermindert en waarschuwt bij de wereldgrens.",
	"options.visible": "zichtbaar",
	"options.vsync": "VSync",
	"options.weatherRadius": "Weereffectradius",
	"options.weatherRadius.tooltip": "Radius waarbinnen regen- en sneeuweffecten zichtbaar zijn. Zeer kleine invloed op prestaties.",
	"options.worldOptions.button": "Wereldinstellingen",
	"options.worldOptions.title": "Wereldinstellingen",
	...
	"pack.dropRejected.message": "De volgende lijst bevat ongeldige pakketten en werden niet gekopieerd:\n %s",
	"pack.dropRejected.title": "Elementen die geen pakket zijn",
	...
	"pack.incompatible.confirm.unknown": "Dit pakket is defect of gemaakt voor een onbekende Minecraftversie en werkt mogelijk niet goed.",
	...
	"pack.incompatible.unknown": "(defect of incompatibel)",
	...
	"painting.minecraft.backyard.title": "Binnenplaats",
	...
	"painting.minecraft.cavebird.title": "Grottenvogel",
	...
	"painting.minecraft.lowmist.title": "Lage nevel",
	...
	"painting.minecraft.owlemons.title": "Citruil",
	"painting.minecraft.passage.author": "Kristoffer Zetterstrand",
	"painting.minecraft.passage.title": "Galerij",
	...
	"parsing.bool.expected": "Booleaanse waarde verwacht",
	"parsing.bool.invalid": "Ongeldige booleaanse waarde: 'true' of 'false' verwacht, maar '%s' gevonden",
	...
	"parsing.float.expected": "Zwevendekommagetal verwacht",
	"parsing.float.invalid": "Zwevendekommagetal '%s' is ongeldig",
	...
	"parsing.quote.escape": "Ongeldige ontsnappingssequentie '\\%s' in de gequoteerde tekenreeks",
	"parsing.quote.expected.end": "Ongesloten gequoteerde tekenreeks",
	"parsing.quote.expected.start": "Aanhalingsteken om een tekenreeks te beginnen verwacht",
	"particle.invalidOptions": "Deeltjesopties '%s' verwerken mislukt",
	...
	"realms.configuration.region.australia_east": "New South Wales, Australië",
	"realms.configuration.region.australia_southeast": "Victoria, Australië",
	"realms.configuration.region.brazil_south": "Brazilië",
	"realms.configuration.region.central_india": "India",
	"realms.configuration.region.central_us": "Iowa, Verenigde Staten",
	"realms.configuration.region.east_asia": "Hongkong",
	"realms.configuration.region.east_us": "Virginia, Verenigde Staten",
	"realms.configuration.region.east_us_2": "Noord-Carolina, Verenigde Staten",
	"realms.configuration.region.france_central": "Frankrijk",
	"realms.configuration.region.japan_east": "Oost-Japan",
	"realms.configuration.region.japan_west": "West-Japan",
	"realms.configuration.region.korea_central": "Zuid-Korea",
	"realms.configuration.region.north_central_us": "Illinois, Verenigde Staten",
	"realms.configuration.region.north_europe": "Ierland",
	"realms.configuration.region.south_central_us": "Texas, Verenigde Staten",
	"realms.configuration.region.southeast_asia": "Singapore",
	"realms.configuration.region.sweden_central": "Zweden",
	"realms.configuration.region.uae_north": "Verenigde Arabische Emiraten",
	"realms.configuration.region.uk_south": "Zuid-Engeland",
	"realms.configuration.region.west_central_us": "Utah, Verenigde Staten",
	"realms.configuration.region.west_europe": "Nederland",
	"realms.configuration.region.west_us": "Californië, Verenigde Staten",
	"realms.configuration.region.west_us_2": "Washington, Verenigde Staten",
	"realms.configuration.region_preference.automatic_owner": "Automatisch (ping van Realmeigenaar)",
	"realms.configuration.region_preference.automatic_player": "Automatisch (ping van eerste speler in sessie)",
	...
	"recipe.toast.title": "Nieuw(e) recept(en) vrijgespeeld!",
	"record.nowPlaying": "Nu aan het spelen: %s",
	"recover_world.bug_tracker": "Bug rapporteren",
	"recover_world.button": "Proberen te herstellen",
	"recover_world.done.failed": "Kon niet herstellen van een vorige toestand.",
	"recover_world.done.success": "Herstel succesvol!",
	"recover_world.done.title": "Herstel gereed",
	"recover_world.issue.missing_file": "Bestand ontbreekt",
	"recover_world.issue.none": "Geen problemen",
	"recover_world.message": "De volgende problemen traden op bij het proberen te lezen van wereldmap \"%s\".\nJe kunt proberen de wereld te herstellen via een vorige toestand of je kunt dit probleem rapporteren op de bugtracker.",
	"recover_world.no_fallback": "Geen toestand om van te herstellen beschikbaar",
	"recover_world.restore": "Proberen te herstellen",
	"recover_world.restoring": "Wereld proberen te herstellen...",
	"recover_world.state_entry": "Toestand van %s: ",
	"recover_world.state_entry.unknown": "onbekend",
	"recover_world.title": "Wereld laden mislukt",
	"recover_world.warning": "Wereldsamenvatting laden mislukt",
	...
	"resourcePack.runtime_failure": "Fout in bronpakket gedetecteerd",
	...
	"restrictions_screen.button": "Beperkingen",
	"restrictions_screen.permission.receive_player_messages.allowed": "Je kunt berichten van spelers ontvangen",
	"restrictions_screen.permission.receive_player_messages.denied": "Je kunt berichten van spelers niet ontvangen",
	"restrictions_screen.permission.receive_system_messages.allowed": "Je kunt systeemberichten van de server ontvangen",
	"restrictions_screen.permission.receive_system_messages.denied": "Je kunt systeemberichten van de server niet ontvangen",
	"restrictions_screen.permission.send_commands.allowed": "Je kunt opdrachten versturen",
	"restrictions_screen.permission.send_commands.denied": "Je kunt opdrachten niet versturen",
	"restrictions_screen.permission.send_messages.allowed": "Je kunt chatberichten sturen",
	"restrictions_screen.permission.send_messages.denied": "Je kunt chatberichten niet sturen",
	"restrictions_screen.title": "Beperkingen",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Back-up maken voordat de upgrade wordt uitgevoerd?",
	...
	"selectWorld.backupWarning.downgrade": "Deze wereld werd voor het laatst gespeeld in %s; je gebruikt versie %s. Downgraden kan een wereld beschadigen - we kunnen niet garanderen dat het zal laden of werken. Als je nog steeds door wilt gaan, maak dan een back-up!",
	"selectWorld.backupWarning.experimental": "Deze wereld gebruikt experimentele instellingen die op elk moment kunnen stoppen met functioneren. We kunnen niet garanderen dat deze wereld laadt of werkt. Bezoek op eigen risico!",
	"selectWorld.backupWarning.file_fixing_required": "Deze wereld moet worden geüpgraded voor je deze speelt. Het vooraf maken van een back-up wordt aangeraden voor het geval de wereld beschadigd raakt.",
	...
	"selectWorld.commands": "Opdrachten",
	...
	"selectWorld.dataPacks": "Gegevenspakketten",
	"selectWorld.data_read": "Wereldgegevens lezen...",
	...
	"selectWorld.edit.resetIcon": "Pictogram resetten",
	...
	"selectWorld.incompatible.description": "Deze wereld kan niet geopend worden in deze versie.\nHet werd voor het laatst gespeeld in %s.",
	"selectWorld.incompatible.info": "Incompatibele versie: %s",
	"selectWorld.incompatible.title": "Incompatibele versie",
	"selectWorld.incompatible.tooltip": "Deze wereld kan niet geopend worden omdat het gemaakt werd in een incompatibele versie.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Deze wereld heeft een upgrade naar de nieuwste versie nodig voor je kunt bewerken, vanwege onderliggende wijzigingen aan de bestandsindeling.",
	"selectWorld.requiresFileFixingTooltip.play": "Deze wereld heeft een upgrade naar de nieuwste versie nodig voor je kunt spelen, vanwege onderliggende wijzigingen aan de bestandsindeling.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Deze wereld heeft een upgrade naar de nieuwste versie nodig voor je kunt hercreëren, vanwege onderliggende wijzigingen aan de bestandsindeling.",
	"selectWorld.resource_load": "Bronnen voorbereiden...",
	...
	"selectWorld.upgrade_and_play": "Upgraden en spelen",
	...
	"selectWorld.waitingForBackup.message": "Dit kan even duren afhankelijk van de grootte van je wereld. Sluit het spel niet af en zet je apparaat niet uit.",
	"selectWorld.waitingForBackup.title": "Back-up maken...",
	...
	"selectWorld.warning.lowDiskSpace.description": "Er is niet veel opslagruimte over.\nEen volle schijf kan leiden tot schade aan je wereld wanneer je speelt.",
	"selectWorld.warning.lowDiskSpace.title": "Waarschuwing! Opslagruimte bijna vol!",
	"selectWorld.world": "Wereld",
	"selectWorld.world_gen_settings_access": "Kan wereldgeneratie-instellingenbestand niet lezen! %s",
	"selecteWorld.backupRequiredTooltip": "Maak eerst een back-up om deze wereld te laden",
	...
	"slot.only_single_allowed": "Alleen enkelvoudige vakken zijn toegestaan: '%s' gekregen",
	"slot.unknown": "Vak '%s' is onbekend",
	"snbt.parser.empty_key": "Sleutel mag niet leeg zijn",
	"snbt.parser.expected_binary_numeral": "Binair getal verwacht",
	"snbt.parser.expected_decimal_numeral": "Decimaal getal verwacht",
	"snbt.parser.expected_float_type": "Zwevendekommagetal verwacht",
	"snbt.parser.expected_hex_escape": "Karakterliteraal met lengte %s verwacht",
	"snbt.parser.expected_hex_numeral": "Hexadecimaal getal verwacht",
	"snbt.parser.expected_integer_type": "Geheel getal verwacht",
	"snbt.parser.expected_non_negative_number": "Niet-negatief getal verwacht",
	"snbt.parser.expected_number_or_boolean": "Getal of booleaanse waarde verwacht",
	"snbt.parser.expected_string_uuid": "Geldige UUID als tekenreeks verwacht",
	"snbt.parser.expected_unquoted_string": "Geldige tekenreeks zonder aanhalingstekens verwacht",
	"snbt.parser.infinity_not_allowed": "Oneindige getallen zijn niet toegestaan",
	"snbt.parser.invalid_array_element_type": "Ongeldig lijstelementtype",
	"snbt.parser.invalid_character_name": "Ongeldige Unicodekarakternaam",
	"snbt.parser.invalid_codepoint": "Ongeldige Unicodekarakterwaarde: %s",
	"snbt.parser.invalid_string_contents": "Ongeldige tekenreeksinhoud",
	"snbt.parser.invalid_unquoted_start": "Tekenreeksen zonder aanhalingstekens mogen niet beginnen met de tekens 0-9, + of -",
	"snbt.parser.leading_zero_not_allowed": "Decimale getallen mogen niet beginnen met 0",
	"snbt.parser.no_such_operation": "Niet-bestaande bewerking: %s",
	"snbt.parser.number_parse_failure": "Getal '%s' verwerken mislukt",
	"snbt.parser.undescore_not_allowed": "Getallen mogen niet beginnen of eindigen met een laag streepje",
	...
	"soundCategory.voice": "Verteller/stem",
	...
	"stat.minecraft.happy_ghast_one_cm": "Afstand per vrolijke Ghast",
	...
	"stat.minecraft.nautilus_one_cm": "Afstand per nautilus",
	...
	"stat.minecraft.sprint_one_cm": "Afstand gerend",
	...
	"structure_block.custom_data": "Aangepaste gegevenseigenschapsnaam",
	"structure_block.detect_size": "Detecteer grootte en positie van constructie:",
	"structure_block.hover.corner": "Hoek: %s",
	"structure_block.hover.data": "Gegevens: %s",
	"structure_block.hover.load": "Laden: %s",
	"structure_block.hover.save": "Opslaan: %s",
	"structure_block.include_entities": "Entiteiten meerekenen:",
	...
	"structure_block.mode_info.data": "Gegevensmodus - spellogicamarkeerder",
	...
	"subtitles.block.candle.extinguish": "Kaars dooft",
	...
	"subtitles.block.copper_bulb.turn_off": "Koperen lamp gaat uit",
	"subtitles.block.copper_bulb.turn_on": "Koperen lamp gaat aan",
	"subtitles.block.copper_chest.close": "Kist sluit",
	"subtitles.block.copper_chest.open": "Kist opent",
	"subtitles.block.copper_trapdoor.close": "Valluik sluit",
	"subtitles.block.copper_trapdoor.open": "Valluik opent",
	"subtitles.block.crafter.craft": "Vervaardigingsmachine vervaardigt",
	"subtitles.block.crafter.fail": "Vervaardigingsmachine vervaardigde niets",
	"subtitles.block.creaking_heart.hurt": "Schorswakerhart gromt",
	"subtitles.block.creaking_heart.idle": "Griezelig geluid",
	"subtitles.block.creaking_heart.spawn": "Schorswakerhart ontwaakt",
	"subtitles.block.deadbush.idle": "Droge geluiden",
	"subtitles.block.decorated_pot.insert": "Versierde pot wordt gevuld",
	"subtitles.block.decorated_pot.insert_fail": "Versierde pot wiebelt",
	"subtitles.block.decorated_pot.shatter": "Versierde pot sneuvelt",
	...
	"subtitles.block.dried_ghast.ambient": "Uitgedroogde Ghast puft",
	"subtitles.block.dried_ghast.ambient_water": "Uitgedroogde Ghast rehydrateert",
	"subtitles.block.dried_ghast.place_in_water": "Uitgedroogde Ghast wordt doordrenkt",
	"subtitles.block.dried_ghast.transition": "Uitgedroogde Ghast voelt zich beter",
	"subtitles.block.dry_grass.ambient": "Windgeluiden",
	...
	"subtitles.block.eyeblossom.close": "Gluurbloesem sluit",
	"subtitles.block.eyeblossom.idle": "Gluurbloesem fluistert",
	"subtitles.block.eyeblossom.open": "Gluurbloesem opent",
	"subtitles.block.fence_gate.toggle": "Poort kraakt",
	"subtitles.block.fire.ambient": "Vuur knettert",
	"subtitles.block.fire.extinguish": "Vuur dooft",
	"subtitles.block.firefly_bush.idle": "Vuurvliegjes zoemen",
	...
	"subtitles.block.generic.fall": "Iets valt op een blok",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Bord wiebelt",
	...
	"subtitles.block.pale_hanging_moss.idle": "Griezelig geluid",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Geiser barst uit",
	"subtitles.block.potent_sulfur.noxious_gas": "Giftig gas verschijnt",
	...
	"subtitles.block.sand.idle": "Zandgeluiden",
	"subtitles.block.sand.wind": "Windgeluiden",
	...
	"subtitles.block.shelf.activate": "Schap activeert",
	"subtitles.block.shelf.deactivate": "Schap deactiveert",
	"subtitles.block.shelf.multi_swap": "Voorwerpen wisselen",
	"subtitles.block.shelf.place_item": "Voorwerp wordt geplaatst",
	"subtitles.block.shelf.single_swap": "Voorwerp wisselt",
	"subtitles.block.shelf.take_item": "Voorwerp wordt gepakt",
	...
	"subtitles.block.sponge.absorb": "Spons absorbeert",
	"subtitles.block.sweet_berry_bush.pick_berries": "Bessen worden geplukt",
	"subtitles.block.trapdoor.close": "Valluik sluit",
	"subtitles.block.trapdoor.open": "Valluik opent",
	"subtitles.block.trapdoor.toggle": "Valluik kraakt",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Onheilspellende beproevingskooi bereidt zich voor",
	"subtitles.block.trial_spawner.ambient": "Beproevingskooi knettert",
	"subtitles.block.trial_spawner.ambient_charged": "Onheilspellende beproevingskooi knettert",
	"subtitles.block.trial_spawner.ambient_ominous": "Onheilspellende beproevingskooi knettert",
	"subtitles.block.trial_spawner.charge_activate": "Onheil neemt de beproevingskooi in bezit",
	"subtitles.block.trial_spawner.close_shutter": "Beproevingskooi sluit",
	"subtitles.block.trial_spawner.detect_player": "Beproevingskooi laadt op",
	"subtitles.block.trial_spawner.eject_item": "Beproevingskooi spuwt voorwerpen uit",
	"subtitles.block.trial_spawner.ominous_activate": "Onheil neemt beproevingskooi in bezit",
	"subtitles.block.trial_spawner.open_shutter": "Beproevingskooi opent",
	"subtitles.block.trial_spawner.spawn_item": "Onheilspellend voorwerp valt",
	"subtitles.block.trial_spawner.spawn_item_begin": "Onheilspellend voorwerp verschijnt",
	"subtitles.block.trial_spawner.spawn_mob": "Beproevingskooi spawnt een wezen",
	...
	"subtitles.block.vault.activate": "Kluis ontvlamt",
	"subtitles.block.vault.ambient": "Kluis knettert",
	"subtitles.block.vault.close_shutter": "Kluis sluit",
	"subtitles.block.vault.deactivate": "Kluis dooft",
	"subtitles.block.vault.eject_item": "Kluis werpt voorwerp uit",
	"subtitles.block.vault.insert_item": "Kluis ontgrendelt",
	"subtitles.block.vault.insert_item_fail": "Kluis blijft op slot",
	"subtitles.block.vault.open_shutter": "Kluis opent",
	"subtitles.block.vault.reject_rewarded_player": "Kluis wijst al beloonde speler af",
	"subtitles.block.water.ambient": "Water stroomt",
	"subtitles.block.wet_sponge.dries": "Spons droogt op",
	...
	"subtitles.entity.armadillo.ambient": "Gordeldier gromt",
	"subtitles.entity.armadillo.brush": "Gordeldier schuurt",
	"subtitles.entity.armadillo.death": "Gordeldier sterft",
	"subtitles.entity.armadillo.eat": "Gordeldier eet",
	"subtitles.entity.armadillo.hurt": "Gordeldier raakt gewond",
	"subtitles.entity.armadillo.hurt_reduced": "Gordeldier beschermt zichzelf",
	"subtitles.entity.armadillo.land": "Gordeldier landt",
	"subtitles.entity.armadillo.peek": "Gordeldier gluurt",
	"subtitles.entity.armadillo.roll": "Gordeldier rolt op",
	"subtitles.entity.armadillo.scute_drop": "Gordeldierhoornplaat valt",
	"subtitles.entity.armadillo.unroll_finish": "Gordeldier ontrolt",
	"subtitles.entity.armadillo.unroll_start": "Gordeldier gluurt",
	...
	"subtitles.entity.baby_cat.ambient": "Kitten miauwt",
	"subtitles.entity.baby_cat.beg_for_food": "Kitten smeekt",
	"subtitles.entity.baby_cat.death": "Kitten sterft",
	"subtitles.entity.baby_cat.eat": "Kitten eet",
	"subtitles.entity.baby_cat.hiss": "Kitten blaast",
	"subtitles.entity.baby_cat.hurt": "Kitten raakt gewond",
	"subtitles.entity.baby_cat.purr": "Kitten spint",
	"subtitles.entity.baby_chicken.ambient": "Kuiken piept",
	"subtitles.entity.baby_chicken.death": "Kuiken sterft",
	"subtitles.entity.baby_chicken.hurts": "Kuiken raakt gewond",
	"subtitles.entity.baby_horse.ambient": "Veulen hinnikt",
	"subtitles.entity.baby_horse.angry": "Veulen hinnikt",
	"subtitles.entity.baby_horse.breathe": "Veulen ademt",
	"subtitles.entity.baby_horse.death": "Veulen sterft",
	"subtitles.entity.baby_horse.eat": "Veulen eet",
	"subtitles.entity.baby_horse.hurt": "Veulen raakt gewond",
	"subtitles.entity.baby_horse.land": "Veulen landt",
	"subtitles.entity.baby_nautilus.ambient": "Babynautilus piept",
	"subtitles.entity.baby_nautilus.ambient_land": "Babynautilus piept",
	"subtitles.entity.baby_nautilus.death": "Babynautilus sterft",
	"subtitles.entity.baby_nautilus.death_land": "Babynautilus sterft",
	"subtitles.entity.baby_nautilus.eat": "Babynautilus eet",
	"subtitles.entity.baby_nautilus.hurt": "Babynautilus raakt gewond",
	"subtitles.entity.baby_nautilus.hurt_land": "Babynautilus raakt gewond",
	"subtitles.entity.baby_nautilus.swim": "Babynautilus zwemt",
	"subtitles.entity.baby_pig.ambient": "Biggetje knort",
	"subtitles.entity.baby_pig.death": "Biggetje sterft",
	"subtitles.entity.baby_pig.eat": "Biggetje eet",
	"subtitles.entity.baby_pig.hurt": "Biggetje raakt gewond",
	"subtitles.entity.baby_wolf.ambient": "Puppy keft",
	"subtitles.entity.baby_wolf.death": "Puppy sterft",
	"subtitles.entity.baby_wolf.growl": "Puppy gromt",
	"subtitles.entity.baby_wolf.hurt": "Puppy raakt gewond",
	"subtitles.entity.baby_wolf.pant": "Puppy hijgt",
	"subtitles.entity.baby_wolf.whine": "Puppy jammert",
	...
	"subtitles.entity.bogged.ambient": "Zomper ratelt",
	"subtitles.entity.bogged.death": "Zomper sterft",
	"subtitles.entity.bogged.hurt": "Zomper raakt gewond",
	"subtitles.entity.breeze.charge": "Vlaag blaast",
	"subtitles.entity.breeze.death": "Vlaag sterft",
	"subtitles.entity.breeze.deflect": "Vlaag kaatst af",
	"subtitles.entity.breeze.hurt": "Vlaag raakt gewond",
	"subtitles.entity.breeze.idle_air": "Vlaag vliegt",
	"subtitles.entity.breeze.idle_ground": "Vlaag briest",
	"subtitles.entity.breeze.inhale": "Vlaag ademt in",
	"subtitles.entity.breeze.jump": "Vlaag springt",
	"subtitles.entity.breeze.land": "Vlaag landt",
	"subtitles.entity.breeze.shoot": "Vlaag schiet",
	"subtitles.entity.breeze.slide": "Vlaag schuift",
	"subtitles.entity.breeze.whirl": "Vlaag wervelt",
	"subtitles.entity.breeze.wind_burst": "Windvlaag barst los",
	...
	"subtitles.entity.camel_husk.ambient": "Dromedarismummie gromt",
	"subtitles.entity.camel_husk.dash": "Dromedarismummie sprint",
	"subtitles.entity.camel_husk.dash_ready": "Dromedarismummie herstelt",
	"subtitles.entity.camel_husk.death": "Dromedarismummie sterft",
	"subtitles.entity.camel_husk.eat": "Dromedarismummie eet",
	"subtitles.entity.camel_husk.hurt": "Dromedarismummie raakt gewond",
	"subtitles.entity.camel_husk.saddle": "Zadel wordt opgelegd",
	"subtitles.entity.camel_husk.sit": "Dromedarismummie zit",
	"subtitles.entity.camel_husk.stand": "Dromedarismummie staat op",
	...
	"subtitles.entity.copper_golem.death": "Kopergolem sterft",
	"subtitles.entity.copper_golem.hurt": "Kopergolem raakt gewond",
	"subtitles.entity.copper_golem.item_drop": "Kopergolem plaatst een voorwerp",
	"subtitles.entity.copper_golem.item_no_drop": "Kopergolem kan voorwerp niet plaatsen",
	"subtitles.entity.copper_golem.no_item_get": "Kopergolem pakt voorwerp op",
	"subtitles.entity.copper_golem.no_item_no_get": "Kopergolem kan voorwerp niet oppakken",
	"subtitles.entity.copper_golem.spawn": "Kopergolem verschijnt",
	"subtitles.entity.copper_golem.spin": "Kopergolemhoofd draait",
	"subtitles.entity.copper_golem_become_statue": "Kopergolem versteent",
	"subtitles.entity.copper_golem_oxidized.death": "Kopergolem sterft",
	"subtitles.entity.copper_golem_oxidized.hurt": "Kopergolem raakt gewond",
	"subtitles.entity.copper_golem_oxidized.spin": "Kopergolemhoofd draait",
	"subtitles.entity.copper_golem_weathered.death": "Kopergolem sterft",
	"subtitles.entity.copper_golem_weathered.hurt": "Kopergolem raakt gewond",
	"subtitles.entity.copper_golem_weathered.spin": "Kopergolemhoofd draait",
	...
	"subtitles.entity.creaking.activate": "Schorswaker kijkt",
	"subtitles.entity.creaking.ambient": "Schorswaker kraakt",
	"subtitles.entity.creaking.attack": "Schorswaker valt aan",
	"subtitles.entity.creaking.deactivate": "Schorswaker kalmeert",
	"subtitles.entity.creaking.death": "Schorswaker verkruimelt",
	"subtitles.entity.creaking.freeze": "Schorswaker stopt",
	"subtitles.entity.creaking.spawn": "Schorswaker manifesteert",
	"subtitles.entity.creaking.sway": "Schorswaker wordt geraakt",
	"subtitles.entity.creaking.twitch": "Schorswaker stuiptrekt",
	"subtitles.entity.creaking.unfreeze": "Schorswaker beweegt",
	...
	"subtitles.entity.donkey.jump": "Ezel springt",
	...
	"subtitles.entity.fish.swim": "Gespetter",
	...
	"subtitles.entity.generic.extinguish_fire": "Vuur dooft",
	...
	"subtitles.entity.generic.wind_burst": "Windvlaag vlaagt",
	...
	"subtitles.entity.ghastling.ambient": "Ghastje piept",
	"subtitles.entity.ghastling.death": "Ghastje sterft",
	"subtitles.entity.ghastling.hurt": "Ghastje raakt gewond",
	"subtitles.entity.ghastling.spawn": "Ghastje verschijnt",
	...
	"subtitles.entity.happy_ghast.ambient": "Vrolijke Ghast koert",
	"subtitles.entity.happy_ghast.death": "Vrolijke Ghast sterft",
	"subtitles.entity.happy_ghast.equip": "Tuig wordt aangedaan",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Vrolijke Ghast staat klaar",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Vrolijke Ghast stopt",
	"subtitles.entity.happy_ghast.hurt": "Vrolijke Ghast raakt gewond",
	"subtitles.entity.happy_ghast.unequip": "Tuig wordt uitgedaan",
	...
	"subtitles.entity.minecart.inside": "Mijnkar rammelt",
	"subtitles.entity.minecart.inside_underwater": "Mijnkar rammelt onderwater",
	...
	"subtitles.entity.mule.jump": "Muilezel springt",
	"subtitles.entity.nautilus.ambient": "Nautilus klikt",
	"subtitles.entity.nautilus.ambient_land": "Nautilus klikt",
	"subtitles.entity.nautilus.dash": "Nautilus spuit",
	"subtitles.entity.nautilus.dash_land": "Nautilus spuit",
	"subtitles.entity.nautilus.dash_ready": "Nautilus herstelt",
	"subtitles.entity.nautilus.dash_ready_land": "Nautilus herstelt",
	"subtitles.entity.nautilus.death": "Nautilus sterft",
	"subtitles.entity.nautilus.death_land": "Nautilus sterft",
	"subtitles.entity.nautilus.eat": "Nautilus eet",
	"subtitles.entity.nautilus.hurt": "Nautilus raakt gewond",
	"subtitles.entity.nautilus.hurt_land": "Nautilus raakt gewond",
	"subtitles.entity.nautilus.swim": "Nautilus zwemt",
	...
	"subtitles.entity.parched.ambient": "Zoor knispert",
	"subtitles.entity.parched.death": "Zoor sterft",
	"subtitles.entity.parched.hurt": "Zoor raakt gewond",
	...
	"subtitles.entity.parrot.imitate.bogged": "Papegaai ratelt",
	"subtitles.entity.parrot.imitate.breeze": "Papegaai briest",
	"subtitles.entity.parrot.imitate.camel_husk": "Papegaai gromt",
	"subtitles.entity.parrot.imitate.creaking": "Papegaai kraakt",
	...
	"subtitles.entity.parrot.imitate.parched": "Papegaai knispert",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Papegaai kreunt",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Papegaai gorgelt",
	...
	"subtitles.entity.pig.eat": "Varken eet",
	...
	"subtitles.entity.player.teleport": "Speler teleporteert",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Skeletpaard springt",
	...
	"subtitles.entity.sulfur_cube.absorb": "Zwavelkubus wordt gevuld",
	"subtitles.entity.sulfur_cube.bounce": "Zwavelkubus stuitert",
	"subtitles.entity.sulfur_cube.death": "Zwavelkubus sterft",
	"subtitles.entity.sulfur_cube.eject": "Zwavelkubus wordt geleegd",
	"subtitles.entity.sulfur_cube.hit": "Zwavelkubus wordt geraakt",
	"subtitles.entity.sulfur_cube.hurt": "Zwavelkubus raakt gewond",
	"subtitles.entity.sulfur_cube.push": "Zwavelkubus wordt geduwd",
	"subtitles.entity.sulfur_cube.squish": "Zwavelkubus stuitert",
	...
	"subtitles.entity.wind_charge.throw": "Windvlaag jaagt",
	"subtitles.entity.wind_charge.wind_burst": "Windvlaag barst los",
	...
	"subtitles.entity.wolf.bark": "Wolf blaft",
	...
	"subtitles.entity.wolf.pant": "Wolf hijgt",
	"subtitles.entity.wolf.shake": "Wolf schudt",
	"subtitles.entity.wolf.whine": "Wolf jammert",
	...
	"subtitles.entity.zombie_horse.angry": "Zombiepaard hinnikt",
	"subtitles.entity.zombie_horse.death": "Zombiepaard sterft",
	"subtitles.entity.zombie_horse.eat": "Zombiepaard eet",
	"subtitles.entity.zombie_horse.hurt": "Zombiepaard raakt gewond",
	"subtitles.entity.zombie_nautilus.ambient": "Zombienautilus bubbelt",
	"subtitles.entity.zombie_nautilus.ambient_land": "Zombienautilus bubbelt",
	"subtitles.entity.zombie_nautilus.dash": "Zombienautilus spuit",
	"subtitles.entity.zombie_nautilus.dash_land": "Zombienautilus spuit",
	"subtitles.entity.zombie_nautilus.dash_ready": "Zombienautilus herstelt",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Zombienautilus herstelt",
	"subtitles.entity.zombie_nautilus.death": "Zombienautilus sterft",
	"subtitles.entity.zombie_nautilus.death_land": "Zombienautilus sterft",
	"subtitles.entity.zombie_nautilus.eat": "Zombienautilus eet",
	"subtitles.entity.zombie_nautilus.hurt": "Zombienautilus raakt gewond",
	"subtitles.entity.zombie_nautilus.hurt_land": "Zombienautilus raakt gewond",
	"subtitles.entity.zombie_nautilus.swim": "Zombienautilus zwemt",
	...
	"subtitles.event.mob_effect.bad_omen": "Onheil neemt in bezit",
	"subtitles.event.mob_effect.raid_omen": "Een overval ligt op de loer",
	"subtitles.event.mob_effect.trial_omen": "Een onheilspellende beproeving ligt op de loer",
	...
	"subtitles.item.armor.equip_copper": "Koperen harnas rammelt",
	...
	"subtitles.item.armor.equip_nautilus": "Nautilusharnas wordt aangedaan",
	"subtitles.item.armor.equip_netherite": "Netherieten harnas klettert",
	"subtitles.item.armor.equip_turtle": "Schildpadschild bonkt",
	"subtitles.item.armor.equip_wolf": "Wolvenharnas wordt aangetrokken",
	"subtitles.item.armor.unequip_nautilus": "Nautilusharnas wordt uitgedaan",
	"subtitles.item.armor.unequip_wolf": "Wolvenharnas wordt uitgetrokken",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Zwavelkubus wordt opgeschept",
	...
	"subtitles.item.bundle.insert_fail": "Volle bundel",
	...
	"subtitles.item.elytra.flying": "Gesuis",
	...
	"subtitles.item.golden_dandelion.unuse": "Gouden paardenbloem start het opgroeien",
	"subtitles.item.golden_dandelion.use": "Gouden paardenbloem stopt het opgroeien",
	...
	"subtitles.item.horse_armor.unequip": "Paardenharnas wordt uitgetrokken",
	"subtitles.item.ink_sac.use": "Inktzak smeert",
	"subtitles.item.lead.break": "Leidtouw knapt",
	"subtitles.item.lead.tied": "Leidtouw wordt vastgebonden",
	"subtitles.item.lead.untied": "Leidtouw wordt losgemaakt",
	"subtitles.item.llama_carpet.unequip": "Tapijt wordt afgelegd",
	"subtitles.item.lodestone_compass.lock": "Kompas past zich aan aan zeilsteen",
	"subtitles.item.mace.smash_air": "Knots zwaait",
	"subtitles.item.mace.smash_ground": "Knots plet",
	"subtitles.item.nautilus_saddle_equip": "Zadel wordt opgelegd",
	"subtitles.item.nautilus_saddle_underwater_equip": "Zadel wordt opgelegd",
	"subtitles.item.nether_wart.plant": "Netherkruid wordt geplant",
	"subtitles.item.ominous_bottle.dispose": "Fles breekt",
	"subtitles.item.saddle.unequip": "Zadel wordt afgelegd",
	"subtitles.item.shears.shear": "Schaar knipt",
	"subtitles.item.shears.snip": "Schaar knipt",
	"subtitles.item.shield.block": "Schild blokkeert",
	"subtitles.item.shovel.flatten": "Schep plet",
	"subtitles.item.spear.attack": "Speer steekt",
	"subtitles.item.spear.hit": "Speer raakt",
	"subtitles.item.spear.lunge": "Speer stoot",
	"subtitles.item.spear.use": "Charge met speer",
	"subtitles.item.spear_wood.attack": "Speer steekt",
	"subtitles.item.spear_wood.hit": "Speer raakt",
	"subtitles.item.spear_wood.use": "Charge met speer",
	...
	"subtitles.item.underwater_saddle.equip": "Zadel wordt opgelegd",
	"subtitles.item.wolf_armor.break": "Wolvenharnas breekt",
	"subtitles.item.wolf_armor.crack": "Wolvenharnas kraakt",
	"subtitles.item.wolf_armor.damage": "Wolvenharnas loopt schade op",
	"subtitles.item.wolf_armor.repair": "Wolvenharnas werd gerepareerd",
	"subtitles.particle.soul_escape": "Ziel ontsnapt",
	"subtitles.ui.cartography_table.take_result": "Kaart wordt getekend",
	"subtitles.ui.hud.bubble_pop": "Zuurstofmeter daalt",
	"subtitles.ui.loom.take_result": "Weefgetouw wordt gebruikt",
	"subtitles.ui.stonecutter.take_result": "Steenzaag wordt gebruikt",
	"subtitles.weather.end_flash": "Endflits rommelt",
	"subtitles.weather.rain": "Regen valt",
	"symlink_warning.message": "Werelden uit mappen laden met symbolische links kan onveilig zijn als je niet weet wat je doet. Lees meer op %s.",
	"symlink_warning.message.pack": "Pakketten met symbolische links laden kan onveilig zijn als je niet weet wat je doet. Lees meer op %s.",
	"symlink_warning.message.world": "Werelden uit mappen laden met symbolische links kan onveilig zijn als je niet weet wat je doet. Lees meer op %s.",
	"symlink_warning.more_info": "Meer informatie",
	"symlink_warning.title": "Wereldmap bevat symbolische links",
	"symlink_warning.title.pack": "Toegevoegd(e) pakket(ten) bevat(ten) symbolische links",
	"symlink_warning.title.world": "Wereldmap bevat symbolische links",
	...
	"telemetry.event.graphics_capabilities.description": "Deze gebeurtenis informeert ons over de grafische functionaliteit van het apparaat waarop het spel gespeeld wordt.",
	"telemetry.event.graphics_capabilities.title": "Grafische functionaliteit",
	"telemetry.event.optional": "%s (optioneel)",
	"telemetry.event.optional.disabled": "%s (optioneel) - uitgeschakeld",
	"telemetry.event.p2p_connection.description": "Deze gebeurtenis helpt ons bij het bepalen van de betrouwbaarheid en prestaties van peer-to-peerverbindingen tussen spelers. Er wordt bijgehouden of het maken van verbinding succesvol verliep, de gebruikte Interactive Connectivity Establishment-kandidaat (ICE; het protocol dat we gebruiken om peer-to-peerverbindingen tot stand te laten komen) en hoe lang het duurde voor de verbinding tot stand kwam.",
	"telemetry.event.p2p_connection.title": "Peer-to-peerverbinding",
	...
	"telemetry.event.world_load_times.description": "Het is voor ons belangrijk te weten hoelang het duurt om een wereld te laden en hoe dat met de tijd verandert. Wanneer we bijvoorbeeld nieuwe functies toevoegen of grote technische wijzigingen uitvoeren, moeten we zien welke impact dit heeft op de laadtijd.",
	...
	"telemetry.event.world_loaded.title": "Wereld laden",
	...
	"telemetry.property.backend_failure_message.title": "Bericht foutmelding grafische API",
	"telemetry.property.backend_failure_missing_capabilities.title": "Ontbrekende functionaliteit van grafische API",
	"telemetry.property.backend_failure_reason.title": "Reden foutmelding grafische API",
	"telemetry.property.backend_name.title": "Gebruikte grafische API",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "Punt van mislukking",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Verbindingstijd (milliseconden) Interactive Connectivity Establishment (ICE)",
	"telemetry.property.p2p_connection_ice_path.title": "Pad Interactive Connectivity Establishment (ICE)",
	"telemetry.property.p2p_connection_local_candidate_type.title": "Soort lokale optie",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Soort externe optie",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Verbindingstijd (milliseconden) signaal",
	"telemetry.property.p2p_connection_successful.title": "Succesvol verbonden",
	"telemetry.property.p2p_connection_total_time_ms.title": "Totale verbindingstijd (milliseconden)",
	"telemetry.property.platform.title": "Platform",
	"telemetry.property.realms_map_content.title": "Realmswereldinhoud (naam minispel)",
	...
	"telemetry_info.button.privacy_statement": "Privacyinformatie",
	"telemetry_info.button.show_data": "Gegevens bekijken",
	"telemetry_info.opt_in.description": "Ik ga akkoord met het versturen van verzamelde optionele gegevens",
	...
	"test.error.block_property_mismatch": "Verwachtte dat eigenschap %s %s was; %s aangetroffen",
	"test.error.block_property_missing": "Blokeigenschap ontbreekt. Verwachtte %[2]s voor eigenschap %[1]s.",
	"test.error.entity_property": "Entiteit %s faalde test: %s",
	"test.error.entity_property_details": "Entiteit %s faalde test: %s. Verwachtte %s; %s aangetroffen",
	"test.error.expected_block": "Verwachtte blok %s: %s aangetroffen",
	"test.error.expected_block_present": "Verwachtte dat blok %s aanwezig was",
	"test.error.expected_block_tag": "Verwachtte blok in #%s: %s aangetroffen",
	"test.error.expected_container_contents": "Inventaris dient te bevatten: %s",
	"test.error.expected_container_contents_single": "Inventaris dient eenmaal te bevatten: %s",
	"test.error.expected_empty_container": "Inventaris dient leeg te zijn",
	"test.error.expected_entity": "Verwachtte %s",
	"test.error.expected_entity_around": "Verwachtte dat %s bestond rondom %s, %s, %s",
	"test.error.expected_entity_count": "Verwachtte %s entiteiten van type %s; %s aangetroffen",
	"test.error.expected_entity_data": "Verwachtte entiteitdata %s: %s aangetroffen",
	"test.error.expected_entity_data_predicate": "Entiteitdata komt niet overeen voor %s",
	"test.error.expected_entity_effect": "Verwachtte dat %s effect %s %s had",
	"test.error.expected_entity_having": "Entiteitsinventaris moet %s bevatten",
	"test.error.expected_entity_holding": "Entiteit zou %s moeten vasthouden",
	"test.error.expected_entity_in_test": "Verwachtte dat %s bestond in test",
	"test.error.expected_entity_not_touching": "Verwachtte niet dat %s op %s, %s, %s (relatief: %s, %s, %s) aanraakte",
	"test.error.expected_entity_touching": "Verwachtte dat %s op %s, %s, %s (relatief: %s, %s, %s) aanraakte",
	"test.error.expected_item": "Verwachtte voorwerp van type %s",
	"test.error.expected_items_count": "Verwachtte %s voorwerpen van type %s; %s aangetroffen",
	"test.error.fail": "Aan mislukkingsvoorwaarden voldaan",
	"test.error.invalid_block_type": "Onverwacht bloktype gevonden: %s",
	"test.error.missing_block_entity": "Ontbrekend blokentiteit",
	"test.error.not_a_block_item": "Gegeven blok is geen blokvoorwerp",
	"test.error.position": "%s op %s, %s, %s (relatief: %s, %s, %s) om tick %s",
	"test.error.sequence.condition_already_triggered": "Aan voorwaarde al voldaan op %s",
	"test.error.sequence.condition_not_triggered": "Aan voorwaarde niet voldaan",
	"test.error.sequence.invalid_tick": "Gelukt tijdens ongeldige tick: verwachtte %s",
	"test.error.sequence.minimum_tick": "Geslaagd vóór verwachte tick: verwachtte %s te wachten",
	"test.error.sequence.not_completed": "Test eindigde voordat de reeks werd afgerond",
	"test.error.set_biome": "Klimaat instellen voor test mislukt",
	"test.error.spawn_failure": "Entiteit %s maken mislukt",
	"test.error.state_not_equal": "Incorrecte status. Verwachtte %s; %s aangetroffen",
	"test.error.structure.failure": "Testconstructie plaatsen voor %s mislukt",
	"test.error.tick": "%s om tick %s",
	"test.error.ticking_without_structure": "Tickende test voordat een constructie werd geplaatst",
	"test.error.timeout.no_result": "Test niet geslaagd of mislukt binnen %s ticks",
	"test.error.timeout.no_sequences_finished": "Geen reeksen binnen %s ticks afgerond",
	"test.error.too_many_entities": "Verwachtte dat slechts één %s bestond rondom %s, %s, %s; %s aangetroffen",
	"test.error.unexpected_block": "Verwachtte niet dat het blok %s was",
	"test.error.unexpected_entity": "Verwachtte niet dat %s bestond",
	"test.error.unexpected_item": "Verwachtte geen voorwerp van type %s",
	"test.error.unknown": "Onbekende interne fout: %s",
	"test.error.value_not_equal": "Verwachtte dat %s %s was; %s aangetroffen",
	"test.error.value_not_in_between": "Verwachtte %s tussen %s en %s: was %s",
	"test.error.wrong_block_entity": "Incorrect blokentiteittype: %s",
	"test_block.error.missing": "In testconstructie ontbreekt blok %s",
	"test_block.error.too_many": "Te veel %s-blokken",
	"test_block.invalid_timeout": "Ongeldige time-out (%s): dit moet een postief aantal ticks zijn",
	"test_block.message": "Bericht:",
	"test_block.mode.accept": "Accepteren",
	"test_block.mode.fail": "Mislukken",
	"test_block.mode.log": "Logboek",
	"test_block.mode.start": "Starten",
	"test_block.mode_info.accept": "Acceptatiemodus: accepteert succes voor (een deel van) een test",
	"test_block.mode_info.fail": "Mislukkingsmodus: de test mislukt",
	"test_block.mode_info.log": "Logboekmodus: leg een bericht vast",
	"test_block.mode_info.start": "Startmodus: het begin van een test",
	"test_instance.action.reset": "Resetten en laden",
	"test_instance.action.run": "Laden en uitvoeren",
	"test_instance.action.save": "Constructie opslaan",
	"test_instance.description.batch": "Omgeving: %s",
	"test_instance.description.failed": "Mislukt: %s",
	"test_instance.description.function": "Functie: %s",
	"test_instance.description.invalid_id": "Ongeldige test-ID",
	"test_instance.description.no_test": "Niet-bestaande test",
	"test_instance.description.structure": "Constructie: %s",
	"test_instance.description.type": "Type: %s",
	"test_instance.type.block_based": "Blokgebaseerde test",
	"test_instance.type.function": "Ingebouwde functietest",
	"test_instance_block.entities": "Entiteiten:",
	"test_instance_block.error.no_test": "Testinstantie uitvoeren op %s, %s, %s onmogelijk omdat deze geen vastgelegde test heeft",
	"test_instance_block.error.no_test_structure": "Testinstantie uitvoeren op %s, %s, %s onmogelijk omdat deze geen testconstructie heeft",
	"test_instance_block.error.unable_to_save": "Testconstructiesjabloon voor testinstantie op %s, %s, %s opslaan mislukt",
	"test_instance_block.invalid": "[ongeldig]",
	"test_instance_block.reset_success": "Test succesvol gereset voor %s",
	"test_instance_block.rotation": "Rotatie:",
	"test_instance_block.size": "Testconstructuegrootte",
	"test_instance_block.starting": "Test %s starten",
	"test_instance_block.test_id": "Testinstantie-ID",
	...
	"title.credits": "© Mojang AB. Alle rechten voorbehouden.",
	"title.multiplayer.disabled": "Samen spelen is uitgeschakeld. Controleer je Microsoftaccountinstellingen.",
	"title.multiplayer.disabled.banned.name": "Je moet je naam veranderen voordat je online kan spelen",
	...
	"title.multiplayer.online": "Samen spelen (online)",
	...
	"trim_material.minecraft.resin": "Harsmateriaal",
	"trim_pattern.minecraft.bolt": "Harnasversiering 'bout'",
	...
	"trim_pattern.minecraft.flow": "Harnasversiering 'windstroming'",
	...
	"upgrade.minecraft.netherite_upgrade": "Netherietupgrade",
	"upgradeWorld.aborted.message": "Dit kan gebeuren als een ander programma toegang verkreeg tot de wereld tijdens de upgrade.\nHet kan helpen als je je computer opnieuw opstart en het daarna probeert. Als dit probleem aanhoudt, overweeg dan dit te melden.",
	"upgradeWorld.aborted.reportBug": "Bug rapporteren",
	"upgradeWorld.aborted.title": "De wereld kon niet worden geüpgraded",
	"upgradeWorld.canceled.message": "Je wereld blijft onveranderd.",
	"upgradeWorld.canceled.title": "Wereldupgrade geannuleerd",
	"upgradeWorld.done": "Wereldupgrade voltooid",
	"upgradeWorld.failed_cleanup.message": "De wereld is succesvol geüpgraded naar de huidige versie en is nu beschikbaar in de wereldlijst.\nWe zijn problemen tegengekomen bij het opschonen van verouderde gegevens. Daarom is de naam van de wereldmap gewijzigd naar %s.",
	"upgradeWorld.failed_cleanup.title": "Wereld succesvol geüpgraded",
	"upgradeWorld.info.converted": "Geüpgraded: %s",
	"upgradeWorld.info.file_fix_stage": "Fase: %s/%s",
	"upgradeWorld.info.scanning": "Bestanden scannen...",
	"upgradeWorld.info.total": "Totaal: %s",
	"upgradeWorld.joinNow": "Wil je de wereld nu bezoeken?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Bestanden verplaatsen...",
	"upgradeWorld.progress.type.legacy_structures": "Oude constructies upgraden...",
	"upgradeWorld.progress.type.region": "Regio's upgraden...",
	"upgradeWorld.symlink.message": "De geselecteerde wereld bevat symbolische links. Het wereldupgradeproces ondersteunt deze niet. Om de wereld te upgraden, moeten de links eerst voluit worden geschreven.",
	"upgradeWorld.symlink.title": "Kan wereld niet upgraden",
	"upgradeWorld.title": "Wereldbestanden upgraden...",
}
