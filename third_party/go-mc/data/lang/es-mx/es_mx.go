// Code generated by tools/gen_lang.go from 26.1/es_mx.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"accessibility.onboarding.screen.narrator": "Presiona Enter para activar la narración",
	"accessibility.onboarding.screen.title": "¡Bienvenido a Minecraft!\n\n¿Quieres activar la narración o ver las opciones de accesibilidad?",
	...
	"advancements.adventure.blowback.description": "Mata un breeze devolviéndole su misma carga de viento",
	"advancements.adventure.blowback.title": "Contrarresto",
	"advancements.adventure.brush_armadillo.description": "Consigue escamas de armadillo usando una brocha",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Fabrica un jarrón con 4 fragmentos de cerámica",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Restauración meticulosa",
	"advancements.adventure.crafters_crafting_crafters.description": "Mantente cerca de un fabricador cuando fabrique un fabricador",
	"advancements.adventure.crafters_crafting_crafters.title": "Máquinas haciendo máquinas",
	...
	"advancements.adventure.heart_transplanter.description": "Coloca un corazón de crepitante en la alineación correcta entre dos troncos de roble pálido",
	"advancements.adventure.heart_transplanter.title": "Trasplante de corazón",
	"advancements.adventure.hero_of_the_village.description": "Defiende una aldea de una invasión exitosamente",
	...
	"advancements.adventure.lighten_up.description": "Raspa una bombilla de cobre con un hacha para hacer que brille más",
	"advancements.adventure.lighten_up.title": "El resplandor",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Entra a una cámara de desafío",
	"advancements.adventure.minecraft_trials_edition.title": "¡Comienza el juego!",
	...
	"advancements.adventure.overoverkill.title": "Golpe de gracia",
	...
	"advancements.adventure.revaulting.description": "Abre un arcón siniestro con una llave de desafío siniestra",
	...
	"advancements.adventure.spear_many_mobs.description": "Golpea a cinco criaturas con el mismo ataque cargado usando la lanza",
	"advancements.adventure.spear_many_mobs.title": "Brocheta criaturesca",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Aplica estas plantillas de herrería al menos una vez: agujas, hocico, costillas, guardián, silencio, vex, mareas, buscacaminos",
	...
	"advancements.adventure.under_lock_and_key.description": "Abre un arcón con una llave de desafío",
	"advancements.adventure.under_lock_and_key.title": "Bajo llave",
	"advancements.adventure.use_lodestone.description": "Imanta una brújula a un bloque de magnetita",
	...
	"advancements.husbandry.obtain_sniffer_egg.description": "Consigue un huevo de sniffer",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Quítale la armadura a un lobo usando tijeras",
	"advancements.husbandry.remove_wolf_armor.title": "¡A la moda!",
	...
	"advancements.husbandry.silk_touch_nest.description": "Mueve una colmena o un apiario con 3 abejas usando toque de seda",
	...
	"advancements.husbandry.uh_oh.title": "Ups",
	...
	"advancements.husbandry.whole_pack.title": "La manada completa",
	...
	"argument.block.tag.disallowed": "Las etiquetas no están permitidas aquí; solo bloques reales",
	...
	"argument.item.tag.disallowed": "Las etiquetas no están permitidas aquí; solo ítems reales",
	...
	"argument.nbt.array.invalid": "Tipo de arreglo no válido: %s",
	...
	"argument.time.tick_count_too_low": "El número de tics no puede ser menor que %s: encontrado %s",
	"argument.uuid.invalid": "UUID no válido",
	"argument.waypoint.invalid": "La entidad seleccionada no es un waypoint",
	...
	"arguments.item.component.expected": "Se requiere un componente de ítem",
	"arguments.item.component.malformed": "Componente \"%s\" mal formado: %s",
	"arguments.item.component.repeated": "El compontente \"%s\" está repetido, solo se puede especificar un valor",
	"arguments.item.component.unknown": "Componente de ítem desconocido: %s",
	"arguments.item.malformed": "Ítem mal formado: %s",
	"arguments.item.overstacked": "%s solo puede apilarse hasta %s",
	"arguments.item.predicate.malformed": "Predicado \"%s\" mal formado: %s",
	"arguments.item.predicate.unknown": "Predicado de ítem desconocido: %s",
	...
	"attribute.name.attack_damage": "Daño por golpe",
	"attribute.name.attack_knockback": "Empuje",
	"attribute.name.attack_speed": "Velocidad de ataque",
	"attribute.name.below_name_distance": "Distancia del marcador de puntaje",
	"attribute.name.block_break_speed": "Velocidad al minar",
	...
	"attribute.name.explosion_knockback_resistance": "Resistencia al empuje por explosiones",
	...
	"attribute.name.generic.jump_strength": "Fuerza de salto",
	...
	"attribute.name.generic.water_movement_efficiency": "Eficiencia de movimiento en agua",
	...
	"attribute.name.nameplate_distance": "Distancia del nombre del jugador",
	...
	"attribute.name.player.sweeping_damage_ratio": "Razón de daño de barrido",
	...
	"attribute.name.sweeping_damage_ratio": "Razón de daño de barrido",
	...
	"attribute.name.waypoint_receive_range": "Alcance de detección del waypoint",
	"attribute.name.waypoint_transmit_range": "Alcance de transmisión del waypoint",
	...
	"block.minecraft.acacia_shelf": "Repisa de acacia",
	...
	"block.minecraft.bamboo_shelf": "Repisa de bambú",
	...
	"block.minecraft.banner.creeper.cyan": "Creeper cian",
	"block.minecraft.banner.creeper.gray": "Creeper gris",
	"block.minecraft.banner.creeper.green": "Creeper verde",
	"block.minecraft.banner.creeper.light_blue": "Creeper azul claro",
	...
	"block.minecraft.banner.creeper.pink": "Creeper rosa",
	...
	"block.minecraft.banner.flow.cyan": "Espiral cian",
	...
	"block.minecraft.banner.flow.purple": "Espiral morada",
	"block.minecraft.banner.flow.red": "Espiral roja",
	"block.minecraft.banner.flow.white": "Espiral blanca",
	"block.minecraft.banner.flow.yellow": "Espiral amarilla",
	...
	"block.minecraft.banner.flower.light_blue": "Flor azul claro",
	...
	"block.minecraft.banner.skull.light_blue": "Calavera azul claro",
	"block.minecraft.banner.skull.light_gray": "Calavera gris claro",
	...
	"block.minecraft.birch_shelf": "Repisa de abedul",
	...
	"block.minecraft.cherry_shelf": "Repisa de cerezo",
	...
	"block.minecraft.chiseled_cinnabar": "Cinabrio grabado",
	"block.minecraft.chiseled_copper": "Cobre grabado",
	...
	"block.minecraft.chiseled_resin_bricks": "Ladrillos de resina grabados",
	"block.minecraft.chiseled_sandstone": "Arenisca grabada",
	"block.minecraft.chiseled_stone_bricks": "Ladrillos de piedra grabados",
	"block.minecraft.chiseled_sulfur": "Azufre grabado",
	"block.minecraft.chiseled_tuff": "Toba grabada",
	"block.minecraft.chiseled_tuff_bricks": "Ladrillos de toba grabados",
	...
	"block.minecraft.cinnabar_brick_wall": "Pared de cinabrio",
	...
	"block.minecraft.copper_bulb": "Bombilla de cobre",
	...
	"block.minecraft.crimson_shelf": "Repisa carmesí",
	...
	"block.minecraft.dark_oak_shelf": "Repisa de roble oscuro",
	...
	"block.minecraft.dripstone_block": "Caliza",
	...
	"block.minecraft.exposed_chiseled_copper": "Cobre grabado expuesto",
	"block.minecraft.exposed_copper": "Cobre expuesto",
	"block.minecraft.exposed_copper_bars": "Barras de cobre expuesto",
	"block.minecraft.exposed_copper_bulb": "Bombilla de cobre expuesto",
	...
	"block.minecraft.jungle_shelf": "Repisa de jungla",
	...
	"block.minecraft.mangrove_shelf": "Repisa de mangle",
	...
	"block.minecraft.oak_shelf": "Repisa de roble",
	...
	"block.minecraft.oxidized_chiseled_copper": "Cobre grabado oxidado",
	"block.minecraft.oxidized_copper": "Cobre oxidado",
	"block.minecraft.oxidized_copper_bars": "Barras de cobre oxidado",
	"block.minecraft.oxidized_copper_bulb": "Bombilla de cobre oxidado",
	...
	"block.minecraft.pale_oak_shelf": "Repisa de roble pálido",
	...
	"block.minecraft.spruce_shelf": "Repisa de abeto",
	...
	"block.minecraft.tnt.disabled": "Las explosiones con TNT están desactivadas",
	...
	"block.minecraft.warped_shelf": "Repisa distorsionada",
	...
	"block.minecraft.waxed_chiseled_copper": "Cobre grabado encerado",
	"block.minecraft.waxed_copper_bars": "Barras de cobre encerado",
	"block.minecraft.waxed_copper_block": "Bloque de cobre encerado",
	"block.minecraft.waxed_copper_bulb": "Bombilla de cobre encerado",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Cobre grabado expuesto encerado",
	...
	"block.minecraft.waxed_exposed_copper_bulb": "Bombilla de cobre expuesto encerado",
	...
	"block.minecraft.waxed_oxidized_chiseled_copper": "Cobre grabado oxidado encerado",
	...
	"block.minecraft.waxed_oxidized_copper_bulb": "Bombilla de cobre oxidado encerado",
	...
	"block.minecraft.waxed_weathered_chiseled_copper": "Cobre grabado degradado encerado",
	...
	"block.minecraft.waxed_weathered_copper_bulb": "Bombilla de cobre degradado encerado",
	...
	"block.minecraft.weathered_chiseled_copper": "Cobre grabado degradado",
	"block.minecraft.weathered_copper": "Cobre degradado",
	"block.minecraft.weathered_copper_bars": "Barras de cobre degradado",
	"block.minecraft.weathered_copper_bulb": "Bombilla de cobre degradado",
	...
	"book.view.title": "Pantalla de lectura del libro",
	"build.spawn_protection": "%s está bajo protección de aparición",
	...
	"chat.disabled.invalid_signature": "El chat tiene una firma inválida. Intenta reconectarte.",
	"chat.disabled.launcher": "Chat desactivado en las opciones del launcher. No se puede enviar mensaje.",
	...
	"chat.disabled.out_of_order_chat": "El chat está fuera de servicio. ¿Tu fecha del sistema cambió?",
	...
	"chat.queue": "[Líneas pendientes: +%s]",
	"chat.queue.tooltip": "Haz clic para mostrar el siguiente mensaje",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "El servidor envió un mensaje no válido.",
	...
	"chat.validation_error": "Error al validar el chat",
	"chat_restriction.chat_and_commands_disabled_by_options": "El chat está restringido en la configuración del cliente.",
	"chat_restriction.chat_disabled_by_options": "El chat de jugadores está restringido en la configuración del cliente.",
	"chat_restriction.chat_disabled_by_options.action": "Ir a pantalla Opciones de chat",
	"chat_restriction.disabled_by_launcher": "Chat restringido por el lanzador",
	"chat_restriction.disabled_by_profile": "Chat restringido por la configuración del perfil.",
	"chat_restriction.disabled_by_profile.action": "Ve a la configuración del perfil",
	...
	"chunk.toast.checkLog": "Más información en el registro del juego",
	"chunk.toast.loadFailure": "Error al cargar chunk en %s",
	...
	"command.forkLimit": "Número máximo de contextos alcanzado (%s)",
	...
	"commands.attribute.base_value.reset.success": "El valor base del atributo %s para la entidad %s fue reestablecido a %s",
	"commands.attribute.base_value.set.success": "El valor base del atributo %s de la entidad %s fue establecido a %s",
	...
	"commands.banlist.list": "Hay %s jugador(es) bloqueado(s):",
	...
	"commands.bossbar.get.players.some": "La barra de jefe personalizada %s tiene %s jugador(es) actualmente conectados: %s",
	...
	"commands.bossbar.list.bars.some": "Hay %s barra(s) de jefe personalizada(s) activa(s): %s",
	...
	"commands.bossbar.set.visibility.unchanged.visible": "Nada cambió. La barra de jefe ya es visible",
	...
	"commands.clear.success.multiple": "%s ítem(s) eliminado(s) de %s jugadores",
	"commands.clear.success.single": "%s ítem(s) eliminado(s) de %s",
	...
	"commands.clone.success": "%s bloque(s) clonado(s) con éxito",
	"commands.clone.toobig": "Hay demasiados bloques en el área especificada (el máximo es %s, se especificaron %s)",
	"commands.damage.invulnerable": "El objetivo es invulnerable al tipo de daño",
	...
	"commands.data.modify.expected_list": "Se requiere una lista: se obtuvo %s",
	"commands.data.modify.expected_object": "Se requiere un objeto: se obtuvo %s",
	...
	"commands.datapack.create.invalid_full_name": "El nombre \"%s\" no es válido",
	"commands.datapack.create.invalid_name": "Hay caracteres no válidos en el nombre \"%s\"",
	"commands.datapack.create.io_failure": "No se pudo crear un paquete con el nombre \"%s\", revisa los registros",
	"commands.datapack.create.metadata_encode_failure": "Error al codificar los metadatos del paquete \"%s\": %s",
	"commands.datapack.create.success": "Paquete de datos \"%s\" creado",
	...
	"commands.debug.function.success.multiple": "%s comando(s) rastreado(s) de %s funciones al archivo resultante %s",
	"commands.debug.function.success.single": "%s comando(s) rastreado(s) de la función \"%s\" al archivo resultante %s",
	...
	"commands.debug.stopped": "Análisis de tics detenido tras %s segundo(s) y %s tic(s) (%s tic(s) por segundo)",
	...
	"commands.dialog.clear.multiple": "Diálogo cerrado a %s jugadores",
	"commands.dialog.clear.single": "Diálogo cerrado a %s",
	"commands.dialog.show.multiple": "Diálogo mostrado a %s jugadores",
	"commands.dialog.show.single": "Diálogo mostrado a %s",
	...
	"commands.fetchprofile.give_item": "Dar ítem",
	"commands.fetchprofile.id.failure": "Error al resolver el perfil para la id. %s",
	"commands.fetchprofile.id.success": "Perfil resuelto para la id. %s: %s",
	"commands.fetchprofile.name.failure": "Error al resolver el perfil para el nombre %s",
	...
	"commands.fill.success": "%s bloque(s) llenado(s) con éxito",
	...
	"commands.function.result": "La función %s devolvió el valor %s",
	"commands.function.scheduled.multiple": "Funciones en ejecución %s",
	"commands.function.scheduled.no_functions": "No se pudieron encontrar funciones con el nombre %s",
	"commands.function.scheduled.single": "Función en ejecución %s",
	"commands.function.success.multiple": "%s comando(s) de %s funciones ejecutado(s)",
	"commands.function.success.multiple.result": "%s funciones ejecutadas",
	"commands.function.success.single": "%s comando(s) de la función \"%s\" ejecutado(s)",
	...
	"commands.item.block.set.success": "Espacio en %s, %s, %s reemplazado con %s",
	"commands.item.entity.set.success.multiple": "Espacio en %s entidades reemplazado con %s",
	"commands.item.entity.set.success.single": "Espacio en %s reemplazado con %s",
	...
	"commands.item.target.no_changed.known_item": "Ningún objetivo aceptó el ítem %s en el espacio %s",
	...
	"commands.op.failed": "Nada cambió. El/la jugador(a) ya es operador(a)",
	...
	"commands.perf.stopped": "Análisis de rendimiento detenido tras %s segundo(s) y %s tic(s) (%s tic(s) por segundo)",
	...
	"commands.profile_fetch.give_item": "Dar ítem",
	"commands.profile_fetch.id.failure": "Error al resolver el perfil para la id. %s",
	...
	"commands.random.error.range_too_large": "El intervalo del valor aleatorio no puede ser mayor que 2147483646",
	"commands.random.error.range_too_small": "El intervalo del valor aleatorio no puede ser menor que 2",
	...
	"commands.random.roll": "%s sacó un %s (entre %s y %s)",
	"commands.random.sample.success": "Valor aleatorio: %s",
	"commands.recipe.give.failed": "No se aprendieron nuevas recetas",
	"commands.recipe.give.success.multiple": "%s receta(s) desbloqueada(s) a %s jugadores",
	"commands.recipe.give.success.single": "%s receta(s) desbloqueada(s) a %s",
	"commands.recipe.take.failed": "No hay recetas olvidables",
	"commands.recipe.take.success.multiple": "%s receta(s) borrada(s) de %s jugadores",
	"commands.recipe.take.success.single": "%s receta(s) borrada(s) de %s",
	...
	"commands.rotate.success": "%s rotado/a",
	...
	"commands.schedule.cleared.success": "%s tarea(s) programada(s) eliminada(s) con ID %s",
	"commands.schedule.created.function": "Función \"%s\" programada en %s tic(s) (hora de juego: %s)",
	"commands.schedule.created.tag": "Etiqueta \"%s\" programada en %s tic(s), en el tiempo de juego: %s",
	...
	"commands.scoreboard.objectives.display.set": "El espacio %s mostrará el objetivo %s",
	"commands.scoreboard.objectives.list.empty": "No hay objetivos",
	"commands.scoreboard.objectives.list.success": "Hay %s objetivo(s): %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Actualización automática del nombre del objetivo %s desactivada",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Actualización automática del nombre del objetivo %s activada",
	"commands.scoreboard.objectives.modify.displayname": "Nombre a mostrar del objetivo %s cambiado a %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Formato numérico del objetivo %s limpiado",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Formato numérico del objetivo %s cambiado",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Nombre a mostrar de %s entidades eliminado en %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Nombre a mostrar de %s eliminado en %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Nombre a mostrar de %[2]s entidades cambiado a %[1]s en %[3]s",
	"commands.scoreboard.players.display.name.set.success.single": "Nombre a mostrar de %[2]s cambiado a %[1]s en %[3]s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Formato numérico de %s entidades eliminado en %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Formato numérico de %s eliminado en %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Formato numérico de %s entidades cambiado en %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Formato numérico de %s cambiado en %s",
	...
	"commands.scoreboard.players.list.entity.success": "%s tiene %s puntaje(s):",
	...
	"commands.setidletimeout.success": "Tiempo máximo de espera por inactividad cambiado a %s minuto(s)",
	"commands.setidletimeout.success.disabled": "Tiempo máximo de inactividad desactivado",
	...
	"commands.setworldspawn.success.new": "El punto de aparición del mundo fue establecido en %s, %s, %s [%s, %s] en %s",
	...
	"commands.spawnpoint.success.multiple.new": "El punto de reaparición fue establecido en %s, %s, %s [%s, %s] en %s para %s jugadores",
	"commands.spawnpoint.success.single": "El punto de reaparición de %[6]s en la dimensión %[5]s fue establecido en %[1]s, %[2]s, %[3]s [%[4]s]",
	"commands.spawnpoint.success.single.new": "El punto de reaparición fue establecido en %s, %s, %s [%s, %s] en %s para %s",
	...
	"commands.spreadplayers.failed.entities": "No se pudo repartir %s entidad(es) alrededor de %s, %s (son demasiadas entidades para ese espacio; prueba repartirlas al menos a %s)",
	...
	"commands.spreadplayers.failed.teams": "No se pudo repartir %s equipo(s) alrededor de %s, %s (son demasiadas entidades para ese espacio; prueba repartirlas al menos a %s)",
	"commands.spreadplayers.success.entities": "%s entidades(es) esparcida(s) alrededor de %s, %s con una distancia de %s bloque(s) entre ellos",
	"commands.spreadplayers.success.teams": "%s equipo(s) esparcido(s) alrededor de %s, %s con una distancia promedio de %s bloque(s) entre ellos",
	...
	"commands.stopwatch.create.success": "Cronómetro \"%s\" creado",
	"commands.stopwatch.does_not_exist": "El cronómetro \"%s\" no existe",
	"commands.stopwatch.query": "El cronómetro \"%s\" ha estado activo durante %s s",
	"commands.stopwatch.remove.success": "Cronómetro \"%s\" removido",
	"commands.stopwatch.restart.success": "Cronómetro \"%s\" reiniciado",
	"commands.summon.failed": "No se pudo generar la entidad",
	"commands.summon.failed.peaceful": "El monstruo no puede generarse en la dificultad pacífico",
	"commands.summon.failed.uuid": "No se pudo generar la entidad debido a UUID duplicados",
	"commands.summon.invalidPosition": "Posición no válida para generar",
	"commands.summon.success": "Entidad %s generada",
	"commands.swing.failed.notliving": "No se encontró ninguna entidad con vida que sea compatible",
	...
	"commands.team.empty.success": "%s miembro(s) eliminado(s) del equipo %s",
	...
	"commands.team.option.collisionRule.unchanged": "Nada cambió. La regla de colisión ya tiene este valor",
	"commands.team.option.color.clear.success": "Se borró el color para el equipo %s",
	...
	"commands.test.clear.error.no_tests": "No se encontró ninguna prueba para eliminar",
	"commands.test.clear.success": "%s estructura(s) eliminada(s)",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Haz clic para copiar al portapapeles",
	"commands.test.create.success": "Se creó el entorno para la prueba %s",
	"commands.test.error.no_test_containing_pos": "No se pudo encontrar ninguna instancia de prueba que contenga %s, %s, %s",
	"commands.test.error.no_test_instances": "No encontraron ningún caso de prueba",
	"commands.test.error.non_existant_test": "No se pudo encontrar la prueba %s",
	"commands.test.error.structure_not_found": "No se encontró la estructura para la prueba %s",
	...
	"commands.test.error.too_large": "El tamaño de la estructura debe ser inferior a %s bloques a lo largo de cada eje",
	"commands.test.locate.done": "Búsqueda terminada, estructuras encontradas: %s",
	"commands.test.locate.found": "Estructura encontrada en: %s (distancia: %s)",
	...
	"commands.test.reset.error.no_tests": "No se encontró ninguna prueba para reiniciar",
	"commands.test.reset.success": "%s estructura(s) reiniciada(s)",
	"commands.test.run.no_tests": "No se encontraron pruebas",
	"commands.test.run.running": "Ejecutando %s prueba(s)...",
	"commands.test.summary": "¡Prueba del juego finalizada! Se ejecutaron %s prueba(s)",
	...
	"commands.tick.query.rate.running": "Tasa de tics objetiva: %s por segundo.\nTiempo promedio por tic: %s ms (objetivo: %s ms)",
	"commands.tick.query.rate.sprinting": "Tasa de tics objetiva: %s por segundo (ignorado, solo como referencia).\nTiempo por cada tic: %s ms",
	"commands.tick.rate.success": "Tasa de tics objetiva establecida a %s por segundo",
	...
	"commands.tick.sprint.stop.success": "Se interrumpió la aceleración de tics",
	"commands.tick.status.frozen": "El juego está congelado",
	"commands.tick.status.lagging": "El juego se está ejecutando, pero no puede mantenerse a la tasa de tics objetiva",
	...
	"commands.tick.step.stop.success": "Se interrumpió el avance de tics a velocidad normal",
	...
	"commands.time.pause": "Reloj %s en pausa",
	"commands.time.query": "Hora: %s",
	"commands.time.query.absolute": "El reloj %s está en %s tic(s)",
	"commands.time.query.gametime": "El tiempo del juego es de %s tic(s)",
	...
	"commands.unpublish.success": "El juego multijugador ya no está publicado",
	"commands.version.build_time": "build_time = %s",
	"commands.version.data": "data = %s",
	"commands.version.header": "Versión del servidor:",
	...
	"commands.waypoint.list.empty": "No hay waypoints en %s",
	"commands.waypoint.list.success": "%s waypoint(s) en %s: %s",
	"commands.waypoint.modify.color": "Color del waypoint cambiado a %s",
	"commands.waypoint.modify.color.reset": "Color del waypoint restablecido",
	"commands.waypoint.modify.style": "Estilo del waypoint modificado",
	...
	"commands.whitelist.remove.failed": "El/La jugador(a) no está en la lista blanca",
	...
	"commands.worldborder.damage.buffer.success": "Zona segura fuera del borde del mundo establecida a %s bloque(s)",
	...
	"commands.worldborder.set.immediate": "Borde del mundo establecido a %s bloque(s) de largo",
	...
	"commands.worldborder.warning.distance.success": "Distancia de aviso del borde del mundo establecida a %s bloque(s)",
	"commands.worldborder.warning.time.failed": "Nada cambió: el aviso del borde del mundo ya duraba esta cantidad de tiempo",
	"commands.worldborder.warning.time.success": "Tiempo de aviso del borde del mundo establecido en %s segundo(s)",
	...
	"container.upgrade.error_tooltip": "Este ítem no se puede mejorar de esta manera",
	"container.upgrade.missing_template_tooltip": "Coloca una plantilla de herrería",
	...
	"createWorld.customize.buffet.title": "Personalización de un solo bioma",
	...
	"dataPack.trade_rebalance.name": "Rebalanceo al comercio con aldeanos",
	...
	"datapackFailure.safeMode.failed.description": "Este mundo contiene datos no válidos o corruptos.",
	"datapackFailure.safeMode.failed.title": "Error al cargar el mundo en modo seguro.",
	"datapackFailure.title": "Varios errores en los paquetes de datos seleccionados han impedido que se cargue el mundo.\nPuedes intentar cargarlo solo con el paquete de datos vainilla (\"modo seguro\") o volver a la pantalla de título y arreglarlo manualmente.",
	"death.attack.anvil": "%[1]s fue aplastado/a por un yunque",
	"death.attack.anvil.player": "%[1]s fue aplastado/a por un yunque mientras peleaba con %[2]s",
	...
	"death.attack.dragonBreath": "%[1]s fue rostizado/a por el aliento de dragón",
	"death.attack.dragonBreath.player": "%[1]s fue rostizado/a por el aliento de dragón de %[2]s",
	...
	"death.attack.fallingBlock.player": "%[1]s fue aplastado/a por un bloque mientras peleaba con %[2]s",
	"death.attack.fallingStalactite": "%[1]s fue atravesado/a por la caída de una estalactita",
	"death.attack.fallingStalactite.player": "%[1]s fue atravesado/a por una estalactita mientras peleaba con %[2]s",
	...
	"death.attack.genericKill": "%[1]s murió",
	"death.attack.genericKill.player": "%[1]s murió mientras peleaba con %[2]s",
	"death.attack.hotFloor": "%[1]s descubrió que el suelo era lava",
	"death.attack.hotFloor.player": "%[1]s descubrió que el suelo era lava por culpa de %[2]s",
	...
	"death.attack.indirectMagic": "%[1]s murió por %[2]s con su magia",
	"death.attack.indirectMagic.item": "%[1]s murió por %[2]s con su %[3]s",
	"death.attack.lava": "%[1]s intentó nadar en lava",
	"death.attack.lava.player": "%[1]s intentó nadar en lava para escapar de %[2]s",
	"death.attack.lightningBolt": "%[1]s fue impactado/a por un rayo",
	"death.attack.lightningBolt.player": "%[1]s fue impactado/a por un rayo mientras peleaba con %[2]s",
	"death.attack.mace_smash": "%[1]s fue aplastado/a por %[2]s",
	"death.attack.mace_smash.item": "%[1]s fue aplastado/a por %[2]s con su %[3]s",
	...
	"death.attack.message_too_long": "El mensaje era demasiado largo para mostrarse completo. ¡Lo sentimos! Esta es la versión abreviada: %s",
	...
	"death.attack.outsideBorder.player": "%[1]s dejó los confines de este mundo mientras peleaba con %[2]s",
	...
	"death.attack.spear.item": "%[1]s fue ensartado por %[2]s con su %[3]s",
	"death.attack.stalagmite": "%[1]s cayó a una estalagmita",
	"death.attack.stalagmite.player": "%[1]s cayó a una estalagmita mientras peleaba con %[2]s",
	"death.attack.starve": "%[1]s se murió de hambre",
	"death.attack.starve.player": "%[1]s se murió de hambre mientras peleaba contra %[2]s",
	...
	"death.attack.sulfurCubeHot": "%[1]s murió debido a que no solo el suelo es lava",
	...
	"death.attack.thorns": "%[1]s murió cuando intentó golpear a %[2]s",
	"death.attack.thorns.item": "%[1]s murió por %[3]s cuando intentó golpear a %[2]s",
	...
	"debug.copy_location.help": "F3 + C = Copiar la ubicación como comando /tp o mantenlas 10 segundos para forzar el cierre del juego",
	...
	"debug.crash.message.rebindable": "Estás presionando %s + %s. Si no las sueltas, el juego dejará de funcionar.",
	...
	"debug.entry.overlay": "En superpos.",
	...
	"debug.options.profile.default": "Perfil predeterminado",
	...
	"debug.options.warning": "Estas opciones son solo para propósitos de prueba. Podrían ralentizar tu computadora, bloquear el juego o comerse a tu roca mascota.",
	...
	"download.pack.failed": "Error al descargar %s de %s paquete(s)",
	...
	"editGamerule.inGame.disabled.tooltip": "Actualizar las reglas del juego requiere de permisos de operador.",
	"editGamerule.inGame.discardChanges.message": "¿Seguro que quieres descartar tus cambios?",
	"editGamerule.inGame.discardChanges.title": "Reglas del juego",
	...
	"effect.minecraft.fire_resistance": "Resistencia al fuego",
	...
	"effect.minecraft.wind_charged": "Vendaval",
	...
	"entity.minecraft.ominous_item_spawner": "Generador de ítems siniestro",
	...
	"entity.minecraft.spruce_chest_boat": "Bote de abeto con cofre",
	...
	"filled_map.explorer_jungle": "Mapa de exploración de la jungla",
	"filled_map.explorer_swamp": "Mapa de exploración del pantano",
	"filled_map.id": "ID #%s",
	"filled_map.level": "(Nivel %s/%s)",
	"filled_map.locked": "Bloqueado",
	"filled_map.mansion": "Mapa de exploración del bosque oscuro",
	...
	"filled_map.village_desert": "Mapa de aldea del desierto",
	"filled_map.village_plains": "Mapa de aldea de la llanura",
	"filled_map.village_savanna": "Mapa de aldea de la sabana",
	"filled_map.village_snowy": "Mapa de aldea de la llanura nevada",
	"filled_map.village_taiga": "Mapa de aldea de la taiga",
	...
	"gamerule.commandModificationBlockLimit.description": "Cantidad de bloques que pueden ser modificados a la vez por un comando, como \"/fill\" o \"/clone\".",
	...
	"gamerule.doLimitedCrafting.description": "Al activarse, solo se podrán crear recetas desbloqueadas.",
	"gamerule.doMobLoot": "Soltar ítems al matar criaturas",
	"gamerule.doMobLoot.description": "Permite que las criaturas suelten ítems y orbes de experiencia.",
	...
	"gamerule.enderPearlsVanishOnDeath.description": "Las perlas de ender lanzadas por un jugador desaparecerán cuando ese jugador muera.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Las entidades con pasajeros pueden atravesar portales",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Permite a las entidades con pasajeros teletransportarse a través de los portales del Nether, del End y nexos del End.",
	...
	"gamerule.lavaSourceConversion.description": "Cuando un flujo de lava es rodeado en dos lados por fuentes de lava, se convierte en una fuente.",
	"gamerule.locatorBar": "Barra de localización de jugadores",
	"gamerule.locatorBar.description": "Mostrar una barra que marca la dirección de otros jugadores.",
	...
	"gamerule.minecartMaxSpeed": "Velocidad máxima de vagones",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Demora del portal del Nether en modo creativo",
	...
	"gamerule.playersNetherPortalDefaultDelay": "Demora del portal del Nether en modos que no sean creativo",
	"gamerule.playersNetherPortalDefaultDelay.description": "Tiempo (en ciclos) que necesita pasar un jugador sobre el portal en modos que no sean creativo para cambiar de dimensión.",
	...
	"gamerule.projectilesCanBreakBlocks.description": "Controla si el impacto de proyectiles podrá destruir bloques los cuales normalmente puede destruir.",
	"gamerule.pvp": "Permitir JcJ",
	...
	"gamerule.spawnChunkRadius": "Radio de los chunks de reaparición",
	"gamerule.spawnChunkRadius.description": "Cantidad de chunks que se mantienen cargados alrededor del punto de aparición del mundo.",
	...
	"gamerule.tntExplodes": "Permitir que la TNT se active y explote",
	...
	"gamerule.universalAnger.description": "Al activarse, las criaturas neutrales que estén enojadas atacarán a cualquier jugador cercano, no solo al que las hizo enojar.\nFunciona mejor si la regla \"Perdonar jugadores muertos\" se desactiva.",
	"gamerule.waterSourceConversion": "Convertir agua en fuente",
	"gamerule.waterSourceConversion.description": "Cuando un flujo de agua es rodeado en dos lados por fuentes de agua, se convierte en una fuente.",
	...
	"gui.abuseReport.attestation": "Al enviar este reporte, confirmas que la información proporcionada es correcta y completa.",
	"gui.abuseReport.comments": "Comentarios",
	"gui.abuseReport.describe": "Al compartir detalles, nos ayudarás a tomar una decisión adecuada.",
	"gui.abuseReport.discard.content": "Si sales, perderás este reporte y tus comentarios.\n¿Quieres salir?",
	...
	"gui.abuseReport.discard.title": "¿Descartar el reporte y los comentarios?",
	"gui.abuseReport.draft.content": "¿Quieres seguir editando el reporte existente o descartarlo y crear uno nuevo?",
	...
	"gui.abuseReport.message": "¿Dónde observaste este mal comportamiento?\nEsto nos ayuda a investigar tu caso.",
	"gui.abuseReport.more_comments": "Describe lo que sucedió:",
	...
	"gui.abuseReport.name.title": "Reportar nombre inapropiado",
	"gui.abuseReport.observed_what": "¿Por qué estás reportando esto?",
	"gui.abuseReport.read_info": "Más inf. sobre reportes",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Alguien está dañando tu reputación o la de otra persona, suplantando la identidad de alguien o compartiendo información falsa con el objetivo de aprovecharse o engañar a otros.",
	...
	"gui.abuseReport.report_sent_msg": "Hemos recibimos tu reporte. ¡Gracias!\n\nNuestro equipo lo revisará lo más pronto posible.",
	"gui.abuseReport.select_reason": "Seleccionar categoría de reporte",
	"gui.abuseReport.send": "Enviar reporte",
	"gui.abuseReport.send.comment_too_long": "Acorta el comentario",
	...
	"gui.abuseReport.send.not_attested": "Lee el texto y comprueba que marcaste la caja de verificación para enviar el reporte",
	"gui.abuseReport.send.service_unavailable": "No se pudo contactar con el servicio de reportes. Por favor, asegúrate de tener conexión y vuelve a intentarlo.",
	"gui.abuseReport.sending.title": "Enviando tu reporte...",
	"gui.abuseReport.sent.title": "Tu reporte ha sido enviado",
	"gui.abuseReport.skin.title": "Reportar aspecto del jugador",
	...
	"gui.banned.description.permanent": "Tu cuenta fue bloqueada permanentemente, esto significa que no podrás jugar en línea ni unirte a Realms.",
	...
	"gui.banned.description.temporary": "%s hasta entonces, no podrás jugar en línea ni unirte en Realms.",
	...
	"gui.banned.name.description": "Tu nombre actual (\"%s\") no cumple con los estándares de la comunidad. Puedes jugar en modo un jugador pero deberás cambiar tu nombre para poder jugar en línea.\n\nPara más información o para una revisión a tu caso, consulta este enlace: %s",
	...
	"gui.banned.skin.description": "Tu aspecto actual no cumple con los estándares de la comunidad. Puedes jugar con un aspecto por defecto o elegir uno nuevo.\n\nPara más información o para una revisión a tu caso, consulta este enlace: %s",
	"gui.banned.skin.title": "Aspecto no permitido",
	"gui.banned.title.permanent": "Cuenta baneada de por vida",
	...
	"gui.copy_link_to_clipboard": "Copiar enlace",
	"gui.days": "%s día(s)",
	"gui.done": "Aceptar",
	"gui.down": "Abajo",
	...
	"gui.friends.error.generic": "Algo salió mal... ¡con esta opción, no con tus amigos! \n\nInténtalo más tarde.",
	...
	"gui.friends.multiplayer.join_request": "Solicitar unirse",
	...
	"gui.friends.narration.button.accept": "Presiona Enter para aceptar la solicitud de amistad de %s",
	...
	"gui.friends.toast.join_invite_expired.message": "La invitación para unirte al mundo de %s's expiró.",
	...
	"gui.none": "Nada",
	"gui.ok": "Aceptar",
	"gui.open_report_dir": "Abrir directorio de reportes",
	"gui.packSelection.search": "Buscar...",
	"gui.privacy_link.message": "Abre este enlace para administrar tu privacidad y configuración de seguridad en línea.",
	"gui.privacy_link.title": "Los cambios en la configuración de Xbox pueden tardar un tiempo en aplicarse.\n\nSi no se actualizan, reinicia el juego.",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Este jugador no puede ser reportado porque el chat está deshabilitado o bloqueado",
	...
	"gui.waitingForResponse.title": "Esperando por el servidor",
	"gui.yes": "Sí",
	...
	"item.disabled": "Ítem desactivado",
	...
	"item.minecraft.arms_up_pottery_shard": "Fragmento de cerámica de silueta",
	"item.minecraft.arms_up_pottery_sherd": "Fragmento de cerámica de silueta",
	...
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Ornamento de remaches",
	...
	"item.minecraft.brown_harness": "Arnés café",
	"item.minecraft.brush": "Brocha",
	"item.minecraft.bucket": "Cubeta",
	"item.minecraft.bundle": "Saco",
	"item.minecraft.bundle.empty": "Vacío",
	"item.minecraft.bundle.empty.description": "Puede contener una pila mixta de ítems",
	...
	"item.minecraft.coast_armor_trim_smithing_template.new": "Ornamento de costa",
	...
	"item.minecraft.copper_helmet": "Yelmo de cobre",
	...
	"item.minecraft.crossbow.projectile.multiple": "Proyectil: %s × %s",
	...
	"item.minecraft.dune_armor_trim_smithing_template.new": "Ornamento de dunas",
	...
	"item.minecraft.eye_armor_trim_smithing_template.new": "Ornamento de ojo",
	...
	"item.minecraft.flow_armor_trim_smithing_template.new": "Ornamento de espiral",
	...
	"item.minecraft.guster_pottery_sherd": "Fragmento de cerámica de torbellino",
	...
	"item.minecraft.host_armor_trim_smithing_template.new": "Ornamento de anfitrión",
	"item.minecraft.howl_pottery_shard": "Fragmento de cerámica de aullido",
	"item.minecraft.howl_pottery_sherd": "Fragmento de cerámica de aullido",
	...
	"item.minecraft.lingering_potion.effect.wind_charged": "Poción persistente de vendaval",
	...
	"item.minecraft.music_disc_bounce": "Disco",
	...
	"item.minecraft.pitcher_pod": "Espiga de planta odre",
	...
	"item.minecraft.potion.effect.wind_charged": "Poción de vendaval",
	"item.minecraft.pottery_shard_archer": "Fragmento de cerámica de arquero",
	"item.minecraft.pottery_shard_arms_up": "Fragmento de cerámica de silueta",
	...
	"item.minecraft.powder_snow_bucket": "Cubeta de nieve en polvo",
	...
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Ornamento de elevación",
	...
	"item.minecraft.rib_armor_trim_smithing_template.new": "Ornamento de costillas",
	...
	"item.minecraft.scrape_pottery_sherd": "Fragmento de cerámica de rasguño",
	"item.minecraft.scute": "Escama",
	"item.minecraft.sentry_armor_trim_smithing_template": "Plantilla de herrería",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Ornamento de centinela",
	"item.minecraft.shaper_armor_trim_smithing_template": "Plantilla de herrería",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Ornamento de modelador",
	...
	"item.minecraft.silence_armor_trim_smithing_template.new": "Ornamento de silencio",
	...
	"item.minecraft.smithing_template.armor_trim.base_slot_description": "Coloca una pieza de armadura",
	...
	"item.minecraft.smithing_template.netherite_upgrade.additions_slot_description": "Coloca un ligote de netherita",
	...
	"item.minecraft.snout_armor_trim_smithing_template.new": "Ornamento de hocico",
	...
	"item.minecraft.spire_armor_trim_smithing_template.new": "Ornamento de agujas",
	...
	"item.minecraft.splash_potion.effect.wind_charged": "Poción arrojadiza de vendaval",
	...
	"item.minecraft.sulfur_cube_bucket": "Cubeta con cubo de azufre",
	...
	"item.minecraft.tide_armor_trim_smithing_template.new": "Ornamento de mareas",
	...
	"item.minecraft.tipped_arrow.effect.wind_charged": "Flecha de vendaval",
	...
	"item.minecraft.vex_armor_trim_smithing_template.new": "Ornamento de vex",
	...
	"item.minecraft.ward_armor_trim_smithing_template.new": "Ornamento de guardián",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Ornamento de buscacaminos",
	...
	"item.minecraft.wild_armor_trim_smithing_template.new": "Ornamento de salvaje",
	...
	"item.modifiers.saddle": "Al ensillar:",
	...
	"key.category.minecraft.misc": "Misceláneo",
	...
	"key.spectatorHotbar": "Seleccionar en la barra de ítems",
	...
	"key.toggleSpectatorShaderEffects": "Alternar efectos al observar",
	"key.use": "Usar/Colocar",
	...
	"known_server_link.feedback": "Comentarios",
	"known_server_link.forums": "Foros",
	"known_server_link.news": "Novedades",
	"known_server_link.report_bug": "Reportar error del servidor",
	...
	"mco.backup.entry": "Respaldo (%s)",
	"mco.backup.entry.description": "Descripción",
	"mco.backup.entry.enabledPack": "Paquete(s) activado(s)",
	...
	"mco.backup.entry.uploaded": "Cargado",
	...
	"mco.backup.narration": "Respaldo de %s",
	...
	"mco.compatibility.downgrade.description": "Este mundo se jugó por última vez en la versión %s; estás usando la %s. \nForzar el mundo a adaptarse a una versión antigua podría dañarlo, por lo que no podemos garantizar que llegue a cargar o funcionar correctamente.\n\nSe guardará un respaldo del mundo en \"Respaldos\".\nPor favor, restaura el mundo si es necesario.",
	...
	"mco.compatibility.incompatible.series.popup.message": "Este mundo de jugó por última vez en la versión %s y la tuya es %s.\n\nEstas series no son compatibles. Necesitas un nuevo mundo para poder jugar en esta versión.",
	"mco.compatibility.unverifiable.message": "La versión en la que se jugó este mundo por última vez no se pudo verificar. Si actualizas o desactualizas el mundo, se creará un respaldo y quedará guardado en \"Respaldos\".",
	"mco.compatibility.unverifiable.title": "No se puede verificar la compatibilidad",
	"mco.compatibility.upgrade": "Actualizar",
	"mco.compatibility.upgrade.description": "Este mundo se jugó por última vez en la versión %s; estás usando la %s.\n\nSe guardará un respaldo del mundo en \"Respaldos\".\nPor favor, restaura el mundo si es necesario.",
	"mco.compatibility.upgrade.friend.description": "Este mundo fue jugado por última vez con la versión %s. Estás en la versión %s.\n\nSe guardará una copia de seguridad del mundo en \"Respaldos\".\n\nEl dueño del Realm puede restaurar el mundo si es necesario.",
	"mco.compatibility.upgrade.title": "¿Quieres actualizar el mundo?",
	...
	"mco.configure.world.close.question.line1": "Puedes cerrar temporalmente tu Realm, haciendo que nadie pueda jugar. Vuelve a abrirlo cuando lo tengas todo preparado.\n\nEsto no cancela tu suscripción de Minecraft Realms.",
	...
	"mco.configure.world.invited.number": "Invitado/a (%s)",
	...
	"mco.configure.world.name.validation.whitespace": "No puede empezar o acabar con un espacio en blanco. Se recortará.",
	...
	"mco.configure.world.players.inviting": "Invitando jugador(a)...",
	...
	"mco.configure.world.settings.expired": "No puedes editar las opciones de un Realm caducado",
	...
	"mco.configure.world.spawn_toggle.message": "Al desactivar esta opción, se eliminarán todas las entidades del mismo tipo",
	"mco.configure.world.spawn_toggle.message.npc": "Al desactivar esta opción, se eliminarán todas las entidades del mismo tipo, como los aldeanos",
	...
	"mco.configure.world.uninvite.player": "¿Quieres anular la invitación a %s?",
	...
	"mco.errorMessage.realmsService": "Se produjo un error (%s):",
	"mco.errorMessage.realmsService.configurationError": "Error inesperado al intentar editar las opciones del mundo",
	...
	"mco.errorMessage.realmsService.unknownCompatibility": "No se pudo comprobar la versión compatible. Respuesta obtenida: %s",
	...
	"mco.notification.transferSubscription.message": "Las suscripciones de Realms para Java se han movido a la Microsoft Store. ¡No dejes que tu suscripción expire!\nTransfiérela ahora y obtén 30 días de Realms gratis. Ve a tu perfil en minecraft.net para transferir tu suscripción.",
	...
	"mco.selectServer.create.subtitle": "Elige el mundo que quieres poner en tu nuevo Realm",
	...
	"mco.selectServer.leave": "Abandonar",
	...
	"mco.selectServer.noRealms": "Al parecer, no tienes un Realm. Agrega uno para jugar con tus amigos.",
	...
	"mco.selectServer.popup": "Realms es una forma simple y segura de jugar Minecraft con hasta diez amigos a la vez. ¡Soporta minijuegos y mundos personalizados! Solo tiene que pagar el dueño del Realm.",
	...
	"mco.snapshot.createSnapshotPopup.text": "Estás a punto de crear un Realm para versiones de prueba gratuito que estará vinculado a tu suscripción de Realms de pago. A este nuevo Realm para versiones de prueba lo podrás acceder siempre y cuando la suscripción esté activa. Tu Realm de pago no será afectado.",
	"mco.snapshot.createSnapshotPopup.title": "¿Crear un Realm para snapshots?",
	"mco.snapshot.creating": "Creando Realm para snapshots...",
	"mco.snapshot.description": "Vinculado a %s",
	"mco.snapshot.friendsRealm.downgrade": "Necesitas estar en la versión %s para unirte a este Realm",
	"mco.snapshot.friendsRealm.upgrade": "%s necesita actualizar su Realm antes de que puedas jugar desde esta versión",
	"mco.snapshot.paired": "Este Realm para versiones de prueba está vinculado a %s",
	"mco.snapshot.parent.tooltip": "Usa la última versión estable de Minecraft para jugar en este Realm",
	...
	"mco.snapshot.tooltip": "Usa los Realms para versiones de prueba para echar un vistazo a las próximas versiones, que podrían incluir nuevas características y otros cambios.\n\nTus Realms normales permanecerán en la versión estable del juego.",
	"mco.snapshotRealmsPopup.message": "Realms ahora está disponible en versiones de prueba a partir de la snapshot 23w41a. ¡Todas las suscripciones a Realms vienen con un Realm de snapshots gratuita que viene por separado de tu Realm normal!",
	"mco.snapshotRealmsPopup.title": "Realms ahora está disponible en versiones de prueba",
	...
	"mco.time.daysAgo": "Hace %[1]s dìa(s)",
	...
	"menu.custom_screen_info.contents": "El contenido de esta pantalla está controlado por servidores y mapas de terceros que no están revisados, ni operados ni son propiedad de Mojang Studios ni Microsoft.\n\n¡Ten cuidado! Evita abrir enlaces y nunca compartas tu información personal ni tus datos de inicio de sesión.\n\nSi prefieres no jugar en este servidor, puedes desconectarte usando el botón de abajo.",
	...
	"menu.feedback.title": "Comentarios",
	"menu.game": "Menú",
	...
	"menu.multiplayerOptions.network.online.tooltip": "Los amigos en línea pueden unirse.",
	...
	"multiplayer.confirm_command.permissions_required": "Estás intentando ejecutar un comando que requiere permisos superiores.\nPodría afectar negativamente a tu partida.\n¿Quieres continuar?\nComando: %s",
	...
	"multiplayer.confirm_command.title": "Confirmar ejecución de comando",
	...
	"multiplayer.disconnect.banned.reason.default": "Bloqueado/a por un(a) operador(a).",
	...
	"multiplayer.disconnect.out_of_order_chat": "Se detectó un paquete de chat fuera de servicio. ¿Tu fecha del sistema cambió?",
	...
	"narration.checkbox.usage.focused.check": "Presiona Enter para marcar",
	"narration.checkbox.usage.focused.uncheck": "Presiona Enter para desmarcar",
	...
	"narration.slider.usage.hovered": "Arrastra la barra de desplazamiento para cambiar el valor",
	...
	"narration.suggestion.usage.cycle.fixed": "Presiona tabulador para pasar a la siguiente sugerencia",
	"narration.suggestion.usage.cycle.hidable": "Presiona tabulador para pasar a la siguiente sugerencia, o Esc para salir de las sugerencias",
	"narration.suggestion.usage.fill.fixed": "Presiona tabulador para usar la sugerencia",
	"narration.suggestion.usage.fill.hidable": "Presiona tabulador para usar la sugerencia, o Esc para salir de las sugerencias",
	...
	"narrator.select.world_info": "Mundo \"%s\" seleccionado, jugado por última vez: %s, %s",
	...
	"options.accessibility.menu_background_blurriness": "Desenfoque de fondo",
	"options.accessibility.menu_background_blurriness.tooltip": "Controla el desenfoque del fondo del menú.",
	"options.accessibility.narrator_hotkey": "Atajo para la narración",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Permite activar o desactivar la narración con \"Cmd + B\".",
	"options.accessibility.narrator_hotkey.tooltip": "Permite activar o desactivar la narración con \"Ctrl + B\".",
	...
	"options.allowCursorChanges.tooltip": "Permite que el cursor del mouse cambie de forma cuando se pasa por encima de ciertos elementos de la interfaz de usuario.",
	...
	"options.biomeBlendRadius.11": "11×11 (extremo)",
	"options.biomeBlendRadius.13": "13×13 (exagerado)",
	"options.biomeBlendRadius.15": "15×15 (máximo)",
	"options.biomeBlendRadius.3": "3×3 (rápido)",
	"options.biomeBlendRadius.5": "5×5 (normal)",
	"options.biomeBlendRadius.7": "7×7 (detallado)",
	"options.biomeBlendRadius.9": "9×9 (muy detallado)",
	...
	"options.chunkFade.seconds": "Difuminado de chunks: %ss",
	"options.chunkFade.tooltip": "Tiempo que tardan los chunks en aparecer al renderizarse por primera vez (en segundos).",
	...
	"options.cutoutLeaves.tooltip": "Permite ver a través de las hojas de los árboles.\nDesactivar esta opción mejora el rendimiento.",
	...
	"options.difficulty.easy.info": "Aparecen criaturas hostiles pero hacen menos daño. La barra de hambre se agota y puede reducir la vida hasta 5 corazones.",
	"options.difficulty.hard": "Difícil",
	"options.difficulty.hard.info": "Aparecen criaturas hostiles y hacen más daño. La barra de hambre se agota y puede reducir toda la vida.",
	"options.difficulty.hardcore": "Extremo",
	"options.difficulty.normal": "Normal",
	"options.difficulty.normal.info": "Aparecen criaturas hostiles y hacen daño estándar. La barra de hambre se agota y puede reducir la vida hasta medio corazón.",
	"options.difficulty.online": "Dificultad del servidor",
	"options.difficulty.peaceful": "Pacífico",
	"options.difficulty.peaceful.info": "No aparecen criaturas hostiles, solo algunas criaturas neutrales. La barra de hambre no se agota y la vida se regenera con el tiempo.",
	...
	"options.font": "Fuente...",
	"options.font.title": "Opciones de fuente",
	...
	"options.fullscreen.entry": "%s×%s a %s Hz (%s bits)",
	...
	"options.graphics.preset.tooltip": "Establece las opciones de \"Calidad y rendimiento\" en valores razonables que se corresponden con la calidad deseada.",
	...
	"options.graphicsApi.restart": "Debes reiniciar el juego para cambiar la API gráfica.",
	"options.graphicsApi.tooltip": "Qué API gráfica usar para el renderizado. ¡Déjalo por defecto a menos que necesites cambiarlo por una necesidad específica! Los cambios se aplicarán la próxima vez que inicies el juego.",
	"options.graphicsApi.tooltip.vulkan": "Experimental. Puede reducir el rendimiento o causar inestabilidad en algunos sistemas.",
	"options.graphicsApi.vulkan": "Vulkan (experimental)",
	"options.guiScale": "Tamaño de interfaz",
	"options.guiScale.auto": "Auto.",
	"options.hidden": "Oculto",
	"options.hideLightningFlashes": "Ocultar relámpagos",
	"options.hideLightningFlashes.tooltip": "Evita que los rayos iluminen el cielo. Aun así, los rayos seguirán visibles.",
	...
	"options.hideSplashTexts.tooltip": "Oculta los textos aleatorios amarillos en el menú principal.",
	"options.improvedTransparency": "Transparencia mejorada",
	"options.improvedTransparency.tooltip": "Un enfoque experimental que usa un shader de pantalla para renderizar el tiempo atmosférico, las nubes y las partículas detrás de bloques transparentes y agua. \nEsta opción afecta al rendimiento de la GPU.",
	...
	"options.inactivityFpsLimit.afk": "Al ausentarse",
	...
	"options.inactivityFpsLimit.minimized.tooltip": "Solo se reducirán los FPS cuando el juego esté minimizado.",
	"options.invertMouse": "Invertir mouse",
	"options.invertMouseX": "Invertir eje X del mouse",
	"options.invertMouseY": "Invertir eje Y del mouse",
	"options.japaneseGlyphVariants": "Vars. de glifos japoneses",
	...
	"options.maxAnisotropy.tooltip": "Cada nivel mejora significativamente la suavidad de las texturas, pero puede afectar al rendimiento y al uso de la memoria de video. Requiere usar filtro anisotrópico.",
	...
	"options.musicToast.never.tooltip": "No se muestra información sobre la música.",
	"options.musicToast.pauseMenu": "Al pausar",
	"options.musicToast.pauseMenu.tooltip": "Muestra un mensaje permanente en el menú de pausa cuando suena música.",
	"options.musicToast.pauseMenuAndToast": "SÍ",
	"options.musicToast.pauseMenuAndToast.tooltip": "Muestra un aviso cuando empieza a sonar música.\nEste aviso se mantiene en el menú de pausa mientras tanto.",
	"options.music_frequency": "Música",
	"options.music_frequency.constant": "Constante",
	"options.music_frequency.default": "Por defecto",
	"options.music_frequency.frequent": "Rara vez",
	"options.music_frequency.tooltip": "Cambia la frecuencia con la que se reproduce música al jugar.",
	...
	"options.online.xboxSettings": "Opciones de Xbox...",
	...
	"options.prioritizeChunkUpdates.none.tooltip": "Los chunks cercanos se compilan en hilos paralelos. Esto puede mostrar breves agujeros visuales al destruir bloques.",
	...
	"options.realmsNotifications.tooltip": "Busca noticias e invitaciones de Realms en el menú principal y muestra sus respectivos íconos en el botón de Realms.",
	...
	"options.rotateWithMinecart": "Girar en vagones",
	"options.rotateWithMinecart.tooltip": "Controla si la cámara debería rotar al montar en un vagón. Solo disponible en mundos con la opción experimental \"Mejoras de vagones\" activada.",
	...
	"options.showNowPlayingToast.tooltip": "Muestra un aviso cuando empieza a sonar música.\nEste aviso se mantiene en el menú de pausa mientras tanto.",
	"options.showSubtitles": "Subtítulos descriptivos",
	...
	"options.sprintWindow.tooltip": "Intervalo de tiempo en tics necesario para empezar a correr cuando se presiona dos veces la tecla de avanzar.",
	...
	"options.textureFiltering.anisotropic.tooltip": "Un método de filtrado basado en hardware, pero que afecta al rendimiento y uso de la memoria de video de forma significativa. Puede no ser compatible con todos los dispositivos.",
	...
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nMétodo de filtrado basado en sombreado que mejora la calidad de texturas con un impacto moderado en el rendimiento.",
	...
	"options.vignette.tooltip": "Una textura sutil que hace los bordes de la pantalla más oscuros y que advierte sobre el límite del mundo.",
	"options.visible": "Visible",
	"options.vsync": "VSync",
	"options.weatherRadius": "Radio del clima",
	"options.weatherRadius.tooltip": "Radio del área donde se muestran los efectos de la lluvia y la nieve. El impacto en el rendimiento es prácticamente imperceptible.",
	...
	"pack.dropRejected.title": "Registros que no son paquete",
	...
	"painting.minecraft.cavebird.title": "Pájaro de cuevas",
	...
	"particle.invalidOptions": "No se pudo analizar las opciones de la partícula: %s",
	...
	"quickplay.error.invalid_identifier": "No se pudo encontrar el mundo con el identificador utilizado",
	"quickplay.error.realm_connect": "No se pudo conectar al realm",
	"quickplay.error.realm_permission": "No tienes permiso para entrar a este Realm",
	...
	"realms.configuration.region.uae_north": "Emiratos Árabes Unidos",
	...
	"realms.configuration.region_preference.automatic_owner": "Automática (mejor ping para el dueño)",
	"realms.configuration.region_preference.automatic_player": "Automática (mejor ping para el que se conecte primero)",
	...
	"recover_world.message": "Los siguientes problemas ocurrieron al intentar leer la carpeta del mundo \"%s\".\nQuizá sea posible restaurar el mundo desde un estado anterior o reportar este error en el registro de errores.",
	...
	"selectWorld.backupWarning.file_fixing_required": "Este mundo debe actualizarse antes de poder jugar. Recomendamos encarecidamente crear una copia de seguridad antes de continuar, en caso de experimentar corrupciones en el mundo.",
	...
	"selectWorld.experimental.message": "¡Cuidado!\nEsta configuración requiere de funciones que aún están en desarrollo. Tu mundo puede cerrarse, corromporse o no funcionar con futuras actualizaciones.",
	...
	"selectWorld.gameMode.creative.info": "Crea, construye y explora sin límites. Puedes volar, cuentas con materiales infinitos y no puedes recibir daño por los monstruos.",
	...
	"selectWorld.warning.lowDiskSpace.title": "¡Advertencia! ¡Queda poco espacio en el disco!",
	"selectWorld.world": "Mundo",
	"selectWorld.world_gen_settings_access": "¡No es posible leer ni acceder al archivo de configuración de generación del mundo! %s",
	"selecteWorld.backupRequiredTooltip": "Se requiere crear una copia de seguridad para cargar el mundo",
	...
	"snbt.parser.expected_binary_numeral": "Se requiere un número binario",
	"snbt.parser.expected_decimal_numeral": "Se requiere un número decimal",
	"snbt.parser.expected_float_type": "Se requiere un número en punto flotante",
	"snbt.parser.expected_hex_escape": "Se requiere una cadena de longitud %s",
	"snbt.parser.expected_hex_numeral": "Se requiere un número hexadecimal",
	"snbt.parser.expected_integer_type": "Se requiere un número entero",
	"snbt.parser.expected_non_negative_number": "Se requiere un número no negativo",
	"snbt.parser.expected_number_or_boolean": "Se requiere un número o un booleano",
	"snbt.parser.expected_string_uuid": "Se requiere una cadena con un valor UUID válido",
	...
	"snbt.parser.invalid_array_element_type": "Tipo de elemento de lista no válido",
	...
	"snbt.parser.invalid_unquoted_start": "Las cadenas sin comillas no pueden empezar con 0-9, +, o -",
	"snbt.parser.leading_zero_not_allowed": "Los números decimales no pueden empezar con 0",
	"snbt.parser.no_such_operation": "No existe esta operación: %s",
	"snbt.parser.number_parse_failure": "Error al analizar el número: %s",
	"snbt.parser.undescore_not_allowed": "Los guiones bajos no están permitidos al principio o al final de un número",
	...
	"structure_block.mode_info.corner": "Modo esquina: colócalo en esquinas para marcarlas",
	"structure_block.mode_info.data": "Modo datos: usa la lógica del juego",
	"structure_block.mode_info.load": "Modo cargar: carga desde el archivo",
	"structure_block.mode_info.save": "Modo guardar: guarda en el archivo",
	...
	"subtitles.ambient.sound": "Sonido inquietante",
	"subtitles.block.amethyst_block.chime": "Amatista tintineando",
	"subtitles.block.amethyst_block.resonate": "Amatista resonando",
	...
	"subtitles.block.copper_bulb.turn_off": "Bombilla de cobre apagada",
	"subtitles.block.copper_bulb.turn_on": "Bombilla de cobre encendida",
	"subtitles.block.copper_chest.close": "Cofre cerrado",
	"subtitles.block.copper_chest.open": "Cofre abierto",
	"subtitles.block.copper_trapdoor.close": "Trampilla cerrada",
	"subtitles.block.copper_trapdoor.open": "Trampilla abierta",
	"subtitles.block.crafter.craft": "Fabricador fabricando",
	"subtitles.block.crafter.fail": "Fabricador fallando",
	"subtitles.block.creaking_heart.hurt": "Corazón de crepitante gruñiendo",
	"subtitles.block.creaking_heart.idle": "Sonido inquietante",
	"subtitles.block.creaking_heart.spawn": "Corazón de crepitante despertándose",
	"subtitles.block.deadbush.idle": "Sonidos secos",
	"subtitles.block.decorated_pot.insert": "Jarrón llenándose",
	"subtitles.block.decorated_pot.insert_fail": "Jarrón tambaleándose",
	...
	"subtitles.block.dried_ghast.ambient": "Ghast seco resollando",
	"subtitles.block.dried_ghast.ambient_water": "Ghast seco rehidratándose",
	"subtitles.block.dried_ghast.place_in_water": "Ghast seco remojándose",
	"subtitles.block.dried_ghast.transition": "Ghast seco sintiéndose mejor",
	...
	"subtitles.block.eyeblossom.close": "Miraflor cerrada",
	"subtitles.block.eyeblossom.idle": "Miraflor susurrando",
	"subtitles.block.eyeblossom.open": "Miraflor abierta",
	...
	"subtitles.block.firefly_bush.idle": "Luciérnagas zumbando",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Letrero tambaleándose",
	...
	"subtitles.block.pale_hanging_moss.idle": "Sonido inquietante",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Manantial de azufre brotando",
	"subtitles.block.potent_sulfur.noxious_gas": "Gas nocivo apareciendo",
	...
	"subtitles.block.shelf.activate": "Repisa activada",
	"subtitles.block.shelf.deactivate": "Repisa desactivada",
	"subtitles.block.shelf.multi_swap": "Ítems intercambiados",
	"subtitles.block.shelf.place_item": "Ítem colocado",
	"subtitles.block.shelf.single_swap": "Ítem intercambiado",
	"subtitles.block.shelf.take_item": "Ítem recogido",
	"subtitles.block.shulker_box.close": "Caja de shulker cerrada",
	"subtitles.block.shulker_box.open": "Caja de shulker abierta",
	"subtitles.block.sign.waxed_interact_fail": "Letrero tambaleándose",
	"subtitles.block.smithing_table.use": "Mesa de herrería usada",
	"subtitles.block.smoker.smoke": "Ahumador echando humo",
	"subtitles.block.sniffer_egg.crack": "Huevo de sniffer resquebrajándose",
	"subtitles.block.sniffer_egg.hatch": "Huevo de sniffer eclosionando",
	"subtitles.block.sniffer_egg.plop": "Sniffer poniendo un huevo",
	"subtitles.block.sponge.absorb": "Esponja absorbiendo",
	"subtitles.block.sweet_berry_bush.pick_berries": "Bayas sacadas",
	"subtitles.block.trapdoor.close": "Trampilla cerrada",
	"subtitles.block.trapdoor.open": "Trampilla abierta",
	"subtitles.block.trapdoor.toggle": "Crujido de trampilla",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Ítem siniestro preparándose",
	"subtitles.block.trial_spawner.ambient": "Chispas de generador de desafío",
	"subtitles.block.trial_spawner.ambient_charged": "Chispas siniestras",
	"subtitles.block.trial_spawner.ambient_ominous": "Chispas siniestras",
	"subtitles.block.trial_spawner.charge_activate": "Presagio envolviendo un generador de desafío",
	"subtitles.block.trial_spawner.close_shutter": "Generador de desafío cerrado",
	"subtitles.block.trial_spawner.detect_player": "Generador de desafío cargándose",
	"subtitles.block.trial_spawner.eject_item": "Generador de desafío lanzando ítems",
	"subtitles.block.trial_spawner.ominous_activate": "Presagio envolviendo un generador de desafío",
	"subtitles.block.trial_spawner.open_shutter": "Generador de desafío abierto",
	"subtitles.block.trial_spawner.spawn_item": "Ítem siniestro soltado",
	"subtitles.block.trial_spawner.spawn_item_begin": "Ítem siniestro apareciendo",
	"subtitles.block.trial_spawner.spawn_mob": "Generador de desafío generando",
	...
	"subtitles.block.vault.activate": "Arcón activado",
	"subtitles.block.vault.ambient": "Chispas de arcón",
	"subtitles.block.vault.close_shutter": "Arcón cerrado",
	"subtitles.block.vault.deactivate": "Arcón desactivado",
	"subtitles.block.vault.eject_item": "Arcón soltando objetos",
	"subtitles.block.vault.insert_item": "Arcón desbloqueado",
	"subtitles.block.vault.insert_item_fail": "Arcón rechazando ítem",
	"subtitles.block.vault.open_shutter": "Arcón abierto",
	"subtitles.block.vault.reject_rewarded_player": "Arcón rechazando jugador",
	"subtitles.block.water.ambient": "Corriente de agua",
	"subtitles.block.wet_sponge.dries": "Esponja secándose",
	...
	"subtitles.entity.armadillo.ambient": "Gruñido de armadillo",
	"subtitles.entity.armadillo.brush": "Armadillo cepillado",
	"subtitles.entity.armadillo.death": "Armadillo muerto",
	"subtitles.entity.armadillo.eat": "Armadillo comiendo",
	"subtitles.entity.armadillo.hurt": "Armadillo herido",
	"subtitles.entity.armadillo.hurt_reduced": "Armadillo protegiéndose",
	"subtitles.entity.armadillo.land": "Armadillo aterrizando",
	"subtitles.entity.armadillo.peek": "Armadillo asomándose",
	"subtitles.entity.armadillo.roll": "Armadillo enrollándose",
	"subtitles.entity.armadillo.scute_drop": "Armadillo soltando una escama",
	"subtitles.entity.armadillo.unroll_finish": "Armadillo desenrollándose",
	"subtitles.entity.armadillo.unroll_start": "Armadillo asomándose",
	...
	"subtitles.entity.baby_cat.beg_for_food": "Gatito pidiendo comida",
	"subtitles.entity.baby_cat.death": "Gatito muerto",
	"subtitles.entity.baby_cat.eat": "Gatito comiendo",
	"subtitles.entity.baby_cat.hiss": "Bufido de gatito",
	...
	"subtitles.entity.baby_chicken.death": "Pollito muerto",
	...
	"subtitles.entity.baby_horse.death": "Potro muerto",
	"subtitles.entity.baby_horse.eat": "Potro comiendo",
	"subtitles.entity.baby_horse.hurt": "Potro herido",
	"subtitles.entity.baby_horse.land": "Potro aterrizando",
	"subtitles.entity.baby_nautilus.ambient": "Cría de nautilo chillando",
	"subtitles.entity.baby_nautilus.ambient_land": "Cría de nautilo chillando",
	"subtitles.entity.baby_nautilus.death": "Cría de nautilo muerta",
	"subtitles.entity.baby_nautilus.death_land": "Cría de nautilo muerta",
	"subtitles.entity.baby_nautilus.eat": "Cría de nautilo comiendo",
	"subtitles.entity.baby_nautilus.hurt": "Cría de nautilo herida",
	"subtitles.entity.baby_nautilus.hurt_land": "Cría de nautilo herida",
	"subtitles.entity.baby_nautilus.swim": "Cría de nautilo nadando",
	"subtitles.entity.baby_pig.ambient": "Gruñido de cerdito",
	"subtitles.entity.baby_pig.death": "Cerdito muerto",
	"subtitles.entity.baby_pig.eat": "Cerdito comiendo",
	"subtitles.entity.baby_pig.hurt": "Cerdito herido",
	"subtitles.entity.baby_wolf.ambient": "Cachorro ladrando",
	"subtitles.entity.baby_wolf.death": "Cachorro muerto",
	...
	"subtitles.entity.baby_wolf.whine": "Cachorro lloriqueando",
	...
	"subtitles.entity.bogged.ambient": "Traqueteo de ciénago",
	"subtitles.entity.bogged.death": "Ciénago muerto",
	"subtitles.entity.bogged.hurt": "Ciénago herido",
	"subtitles.entity.breeze.charge": "Breeze cargando",
	"subtitles.entity.breeze.death": "Breeze muerto",
	"subtitles.entity.breeze.deflect": "Breeze desviando",
	"subtitles.entity.breeze.hurt": "Breeze herido",
	"subtitles.entity.breeze.idle_air": "Breeze volando",
	"subtitles.entity.breeze.idle_ground": "Breeze zumbando",
	"subtitles.entity.breeze.inhale": "Breeze inhalando",
	"subtitles.entity.breeze.jump": "Breeze saltando",
	"subtitles.entity.breeze.land": "Breeze aterrizando",
	"subtitles.entity.breeze.shoot": "Breeze disparando",
	"subtitles.entity.breeze.slide": "Breeze deslizándose",
	"subtitles.entity.breeze.whirl": "Breeze ululando",
	"subtitles.entity.breeze.wind_burst": "Ráfaga de viento",
	...
	"subtitles.entity.camel_husk.ambient": "Gruñido de camello disecado",
	"subtitles.entity.camel_husk.dash": "Camello disecado lanzándose",
	"subtitles.entity.camel_husk.dash_ready": "Camello disecado recuperándose",
	"subtitles.entity.camel_husk.death": "Camello disecado muerto",
	"subtitles.entity.camel_husk.eat": "Camello disecado comiendo",
	"subtitles.entity.camel_husk.hurt": "Camello disecado herido",
	"subtitles.entity.camel_husk.saddle": "Silla de montar equipada",
	"subtitles.entity.camel_husk.sit": "Camello disecado sentándose",
	"subtitles.entity.camel_husk.stand": "Camello disecado levantándose",
	...
	"subtitles.entity.copper_golem.death": "Gólem de cobre muerto",
	"subtitles.entity.copper_golem.hurt": "Gólem de cobre herido",
	"subtitles.entity.copper_golem.item_drop": "Gólem de cobre colocando un ítem",
	"subtitles.entity.copper_golem.item_no_drop": "Gólem de cobre incapaz de colocar un ítem",
	"subtitles.entity.copper_golem.no_item_get": "Gólem de cobre recogiendo un ítem",
	"subtitles.entity.copper_golem.no_item_no_get": "Gólem de cobre incapaz de recoger un ítem",
	"subtitles.entity.copper_golem.spawn": "Gólem de cobre apareciendo",
	"subtitles.entity.copper_golem.spin": "Cabeza de gólem de cobre girando",
	"subtitles.entity.copper_golem_become_statue": "Gólem de cobre petrificándose",
	"subtitles.entity.copper_golem_oxidized.death": "Gólem de cobre muerto",
	"subtitles.entity.copper_golem_oxidized.hurt": "Gólem de cobre herido",
	"subtitles.entity.copper_golem_oxidized.spin": "Cabeza de gólem de cobre girando",
	"subtitles.entity.copper_golem_weathered.death": "Gólem de cobre muerto",
	"subtitles.entity.copper_golem_weathered.hurt": "Gólem de cobre herido",
	"subtitles.entity.copper_golem_weathered.spin": "Cabeza de gólem de cobre girando",
	...
	"subtitles.entity.creaking.activate": "Crepitante observando",
	"subtitles.entity.creaking.ambient": "Crepitante crujiendo",
	"subtitles.entity.creaking.attack": "Crepitante atacando",
	"subtitles.entity.creaking.deactivate": "Crepitante calmándose",
	"subtitles.entity.creaking.death": "Crepitante muerto",
	"subtitles.entity.creaking.freeze": "Crepitante deteniéndose",
	"subtitles.entity.creaking.spawn": "Crepitante apareciendo",
	"subtitles.entity.creaking.sway": "Crepitante golpeado",
	"subtitles.entity.creaking.twitch": "Crepitante retorciéndose",
	"subtitles.entity.creaking.unfreeze": "Crepitante moviéndose",
	...
	"subtitles.entity.donkey.jump": "Burro saltando",
	...
	"subtitles.entity.generic.hurt": "Algo es herido",
	"subtitles.entity.generic.small_fall": "Algo tropezó",
	"subtitles.entity.generic.splash": "Salpicadura",
	"subtitles.entity.generic.swim": "Nadando",
	"subtitles.entity.generic.wind_burst": "Ráfaga de viento",
	...
	"subtitles.entity.ghastling.ambient": "Ghastling arrullándose",
	"subtitles.entity.ghastling.death": "Ghastling muerto",
	"subtitles.entity.ghastling.hurt": "Ghastling herido",
	"subtitles.entity.ghastling.spawn": "Ghastling apareciendo",
	"subtitles.entity.glow_item_frame.add_item": "Ítem colocado en un marco brillante",
	"subtitles.entity.glow_item_frame.break": "Marco brillante destruido",
	...
	"subtitles.entity.glow_squid.death": "Calamar luminoso muerto",
	"subtitles.entity.glow_squid.hurt": "Calamar luminoso herido",
	"subtitles.entity.glow_squid.squirt": "Calamar luminoso tirando tinta",
	...
	"subtitles.entity.happy_ghast.ambient": "Ghast feliz canturreando",
	"subtitles.entity.happy_ghast.death": "Ghast feliz muerto",
	"subtitles.entity.happy_ghast.equip": "Arnés equipado",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Ghast feliz listo",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Ghast feliz deteniéndose",
	...
	"subtitles.entity.husk.ambient": "Gruñido de disecado",
	"subtitles.entity.husk.converted_to_zombie": "Disecado desconvirtiéndose",
	"subtitles.entity.husk.death": "Disecado muerto",
	...
	"subtitles.entity.leash_knot.break": "Nudo de correa destruido",
	"subtitles.entity.leash_knot.place": "Nudo de correa atado",
	...
	"subtitles.entity.minecart.inside": "Chirrido de vagón",
	"subtitles.entity.minecart.inside_underwater": "Chirrido de vagón bajo el agua",
	...
	"subtitles.entity.mule.jump": "Mula saltando",
	"subtitles.entity.nautilus.ambient": "Nautilo chasqueando",
	"subtitles.entity.nautilus.ambient_land": "Nautilo chasqueando",
	"subtitles.entity.nautilus.dash": "Nautilo propulsándose",
	"subtitles.entity.nautilus.dash_land": "Nautilo propulsándose",
	"subtitles.entity.nautilus.dash_ready": "Nautilo recuperándose",
	"subtitles.entity.nautilus.dash_ready_land": "Nautilo recuperándose",
	"subtitles.entity.nautilus.death": "Nautilo muerto",
	"subtitles.entity.nautilus.death_land": "Nautilo muerto",
	"subtitles.entity.nautilus.eat": "Nautilo comiendo",
	"subtitles.entity.nautilus.hurt": "Nautilo herido",
	"subtitles.entity.nautilus.hurt_land": "Nautilo herido",
	"subtitles.entity.nautilus.swim": "Nautilo nadando",
	...
	"subtitles.entity.parched.ambient": "Traqueteo de momificado",
	"subtitles.entity.parched.death": "Momificado muerto",
	...
	"subtitles.entity.parrot.imitate.bogged": "Loro imitando a un ciénago",
	"subtitles.entity.parrot.imitate.breeze": "Loro imitando a un breeze",
	"subtitles.entity.parrot.imitate.camel_husk": "Loro imitando a un camello disecado",
	"subtitles.entity.parrot.imitate.creaking": "Loro imitando a un crepitante",
	...
	"subtitles.entity.parrot.imitate.husk": "Loro imitando a un disecado",
	...
	"subtitles.entity.parrot.imitate.parched": "Loro imitando a un momificado",
	...
	"subtitles.entity.parrot.imitate.stray": "Loro imitando a un errante",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Loro imitando a un caballo zombi",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Loro imitando a un nautilo zombi",
	...
	"subtitles.entity.pig.eat": "Cerdo comiendo",
	...
	"subtitles.entity.player.teleport": "Jugador(a) teletransportándose",
	"subtitles.entity.polar_bear.ambient": "Gruñido de oso polar",
	"subtitles.entity.polar_bear.ambient_baby": "Cría de oso polar zumbando",
	...
	"subtitles.entity.skeleton.converted_to_stray": "Esqueleto convirtiéndose en errante",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Caballo esquelético saltando",
	...
	"subtitles.entity.sniffer.egg_crack": "Huevo de sniffer resquebrajándose",
	"subtitles.entity.sniffer.egg_hatch": "Huevo de sniffer eclosionando",
	...
	"subtitles.entity.stray.ambient": "Traqueteo de errante",
	"subtitles.entity.stray.death": "Errante muerto",
	...
	"subtitles.entity.sulfur_cube.death": "Cubo de azufre muerto",
	...
	"subtitles.entity.villager.work_farmer": "Agricultor trabajando",
	...
	"subtitles.entity.wind_charge.wind_burst": "Ráfaga de viento",
	...
	"subtitles.entity.wolf.bark": "Lobo ladrando",
	...
	"subtitles.entity.wolf.whine": "Lobo lloriqueando",
	...
	"subtitles.entity.zombie_horse.angry": "Caballo zombi relinchando",
	"subtitles.entity.zombie_horse.death": "Caballo zombi muerto",
	"subtitles.entity.zombie_horse.eat": "Caballo zombi comiendo",
	"subtitles.entity.zombie_horse.hurt": "Caballo zombi herido",
	"subtitles.entity.zombie_nautilus.ambient": "Nautilo zombi balbuceando",
	"subtitles.entity.zombie_nautilus.ambient_land": "Nautilo zombi balbuceando",
	"subtitles.entity.zombie_nautilus.dash": "Nautilo zombi propulsándose",
	"subtitles.entity.zombie_nautilus.dash_land": "Nautilo zombi propulsándose",
	"subtitles.entity.zombie_nautilus.dash_ready": "Nautilo zombi recuperándose",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Nautilo zombi recuperándose",
	"subtitles.entity.zombie_nautilus.death": "Nautilo zombi muerto",
	"subtitles.entity.zombie_nautilus.death_land": "Nautilo zombi muerto",
	"subtitles.entity.zombie_nautilus.eat": "Nautilo zombi comiendo",
	...
	"subtitles.entity.zombie_nautilus.swim": "Nautilo zombi nadando",
	...
	"subtitles.event.mob_effect.bad_omen": "Afianzando un presagio",
	"subtitles.event.mob_effect.raid_omen": "Invasión avecinándose",
	"subtitles.event.mob_effect.trial_omen": "Desafío siniestro avecinándose",
	...
	"subtitles.item.firecharge.use": "Carga de fuego lanzada",
	...
	"subtitles.item.horse_armor.unequip": "Armadura para caballo desequipada",
	"subtitles.item.ink_sac.use": "Saco de tinta manchando",
	"subtitles.item.lead.break": "Correa rota",
	"subtitles.item.lead.tied": "Correa atada",
	"subtitles.item.lead.untied": "Correa desatada",
	"subtitles.item.llama_carpet.unequip": "Alfombra desequipada",
	"subtitles.item.lodestone_compass.lock": "Brújula magnetizada con magnetita",
	"subtitles.item.mace.smash_air": "Mazo impactando",
	"subtitles.item.mace.smash_ground": "Mazo impactando",
	"subtitles.item.nautilus_saddle_equip": "Silla de montar equipada",
	"subtitles.item.nautilus_saddle_underwater_equip": "Silla de montar equipada",
	"subtitles.item.nether_wart.plant": "Verruga cultivada",
	"subtitles.item.ominous_bottle.dispose": "Botella rompiéndose",
	"subtitles.item.saddle.unequip": "Silla de montar desequipada",
	...
	"subtitles.item.spear.attack": "Lanza pinchando",
	"subtitles.item.spear.hit": "Impacto de lanza",
	"subtitles.item.spear.lunge": "Estocada de lanza",
	"subtitles.item.spear.use": "Carga de lanza",
	"subtitles.item.spear_wood.attack": "Lanza pinchando",
	"subtitles.item.spear_wood.hit": "Impacto de lanza",
	"subtitles.item.spear_wood.use": "Carga de lanza",
	...
	"subtitles.item.underwater_saddle.equip": "Silla de montar equipada",
	"subtitles.item.wolf_armor.break": "Armadura para lobo rota",
	"subtitles.item.wolf_armor.crack": "Armadura para lobo agrietada",
	...
	"subtitles.ui.hud.bubble_pop": "Oxígeno agotándose",
	"subtitles.ui.loom.take_result": "Telar usado",
	"subtitles.ui.stonecutter.take_result": "Cortapiedras usado",
	"subtitles.weather.end_flash": "Destello del End resonando",
	"subtitles.weather.rain": "Lluvia",
	"symlink_warning.message": "Cargar mundos desde carpetas con enlaces simbólicos puede ser poco seguro si no sabes exactamente lo que estás haciendo. Por favor, visita %s para más información.",
	"symlink_warning.message.pack": "Cargar paquetes con enlaces simbólicos puede ser poco seguro si no sabes exactamente lo que estás haciendo. Por favor, visita %s para más información.",
	"symlink_warning.message.world": "Cargar mundos desde carpetas con enlaces simbólicos puede ser poco seguro si no sabes exactamente lo que estás haciendo. Por favor, visita %s para más información.",
	...
	"telemetry.event.game_load_times.description": "Este evento puede ayudarnos a determinar dónde se necesitan mejoras en el rendimiento de inicio calculando los tiempos de ejecución.",
	"telemetry.event.game_load_times.title": "Tiempos de carga del juego",
	"telemetry.event.graphics_capabilities.description": "Este evento nos informa acerca de las capacidades del dispositivo gráfico utilizado en el juego.",
	...
	"telemetry.event.world_load_times.description": "Es importante que sepamos cuánto tiempo se tarda en entrar en un mundo y cómo cambia eso con el tiempo. Por ejemplo, cuando agregamos nuevas características o realizamos cambios técnicos grandes, necesitamos ver qué impacto tienen en los tiempos de carga.",
	...
	"telemetry.property.backend_failure_message.title": "Fallo en la creación de la API",
	"telemetry.property.backend_failure_missing_capabilities.title": "Fallo en la creación de la API: Capacidades faltantes",
	"telemetry.property.backend_failure_reason.title": "Motivo del fallo al crear la API",
	"telemetry.property.backend_name.title": "Nombre de la API",
	...
	"test.error.block_property_missing": "Falta la propiedad del bloque. Se requiere que la propiedad %s sea %s",
	...
	"test.error.expected_block_tag": "Se requiere un bloque en #%s: se obtuvo %s",
	...
	"test.error.expected_item": "Se requiere un ítem del tipo %s",
	"test.error.expected_items_count": "Se requieren %s ítems del tipo %s: encontrados %s",
	"test.error.fail": "Condiciones de falla cumplidas",
	...
	"test.error.not_a_block_item": "El bloque proporcionado no es un ítem de bloque",
	"test.error.position": "%s en %s, %s, %s (relativo a: %s,%s, %s) en el tic %s",
	...
	"test.error.set_biome": "Error al establecer el bioma para la prueba",
	"test.error.spawn_failure": "Error al crear la entidad %s",
	...
	"test.error.ticking_without_structure": "Prueba de actualización antes de colocar la estructura",
	"test.error.timeout.no_result": "No hubo ningún resultado durante %s tics",
	"test.error.timeout.no_sequences_finished": "Ninguna secuencia finalizó durante %s tics",
	...
	"test.error.unexpected_item": "No se esperaba el tipo de ítem %s",
	...
	"test_block.error.too_many": "Demasiados bloques de %s",
	"test_block.invalid_timeout": "El tiempo de espera no válido (%s): el número de tics debe ser positivo",
	...
	"test_block.mode_info.accept": "Modo aceptar: acepta el éxito de (parte de) una prueba",
	...
	"test_instance_block.error.no_test": "No se pudo ejecutar el caso de prueba en %s, %s, %s porque no está definido",
	"test_instance_block.error.no_test_structure": "No se pudo ejecutar el caso de prueba en %s, %s, %s porque no tiene estructura de prueba",
	...
	"test_instance_block.reset_success": "Reinicio para la prueba %s con éxito",
	...
	"title.multiplayer.disabled.banned.name": "Debes cambiar tu nombre de usuario para jugar en línea",
	...
	"trim_pattern.minecraft.bolt": "Ornamento de remaches",
	...
	"trim_pattern.minecraft.flow": "Ornamento de espiral",
	...
	"upgradeWorld.aborted.message": "Esto puede suceder si otro programa accedió al mundo durante la actualización.\nPuede ser útil reiniciar el ordenador e intentarlo de nuevo. Si el problema persiste, considera informar del error.",
