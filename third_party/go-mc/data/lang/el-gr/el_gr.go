// Code generated by tools/gen_lang.go from 26.1/el_gr.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Ρυθμίσεις Προσβασιμότητας...",
	"accessibility.onboarding.accessibility.button.narration": "Ρυθμίσεις Προσβασιμότητας",
	"accessibility.onboarding.screen.narrator": "Πάτησε enter για να ενεργοποιήσεις τον αφηγητή",
	"accessibility.onboarding.screen.title": "Καλώς ήρθες στο Minecraft!\n\nΘα ήθελες να ενεργοποιήσεις τον Αφηγητή ή να επισκεφτείς τις Ρυθμίσεις Προσβασιμότητας;",
	"addServer.add": "Τέλος",
	...
	"advMode.notEnabled": "Οι κύβοι εντολής δεν είναι ενεργοποιημένοι",
	"advMode.notEnabled.spawner": "Οι κύβοι γεννήτριας δεν είναι ενεργοποιημένοι",
	"advMode.previousOutput": "Προηγούμενη Έξοδος",
	"advMode.setCommand": "Ορισμός Εντολής Τερματικού για τον Κύβο",
	"advMode.setCommand.disabled": "Εντολή που τέθηκε: %s, αλλά οι κύβοι εντολής είναι ακόμη απενεργοποιημένοι",
	"advMode.setCommand.success": "Εντολή που τέθηκε: %s",
	"advMode.trackOutput": "Εντοπισμός εξόδου",
	"advMode.triggering": "Ενεργοποίηση",
	"advMode.type": "Τύπος",
	"advancement.advancementNotFound": "Άγνωστη εξέλιξη: %s",
	"advancements.adventure.adventuring_time.description": "Ανακάλυψε κάθε τοπίο",
	"advancements.adventure.adventuring_time.title": "Ώρα για Περιπέτεια",
	"advancements.adventure.arbalistic.description": "Σκότωσε πέντε διαφορετικά όντα με μία βολή βαλλίστρας",
	"advancements.adventure.arbalistic.title": "Βαλλιστικό",
	"advancements.adventure.avoid_vibration.description": "Σκύψε κοντά σε έναν Αισθητήρα Σκαλκ ή Φύλακα για να τον αποτρέψεις από το να σε ανιχνεύσει",
	"advancements.adventure.avoid_vibration.title": "Σκύψιμο 100",
	"advancements.adventure.blowback.description": "Σκότωσε έναν Ανεμοστρόβιλο με ένα εκτροπισμένο Φορτίο Ανέμου από Ανεμοστρόβιλο",
	"advancements.adventure.blowback.title": "Ανεμοστροφή",
	"advancements.adventure.brush_armadillo.description": "Απόκτησε Φολίδες Αρμαδίλου από έναν Αρμαδίλο χρησιμοποιώντας ένα Ξεσκονιστήρι",
	"advancements.adventure.brush_armadillo.title": "Ξεσκόνισμα Αρμαδίλου",
	"advancements.adventure.bullseye.description": "Χτύπησε το κέντρο ενός κύβου Στόχου από τουλάχιστον 30 μέτρα μακριά",
	"advancements.adventure.bullseye.title": "Διάνα",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Φτιάξε ένα Διακοσμημένο Αγγείο από 4 Θραύσματα Αγγειοπλαστικής",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Προσεκτική Αποκατάσταση",
	"advancements.adventure.crafters_crafting_crafters.description": "Είσαι κοντά σε έναν Κατασκευαστή όταν κατασκευάζει έναν Κατασκευαστή",
	"advancements.adventure.crafters_crafting_crafters.title": "Κατασκευαστές Κατασκευάζουν Κατασκευαστές",
	"advancements.adventure.fall_from_world_height.description": "Κάνε ελεύθερη πτώση από την κορυφή του κόσμου (όριο χτισίματος) μέχρι τον πάτο του κόσμου και επιβίωσε",
	"advancements.adventure.fall_from_world_height.title": "Σπήλαια & Γκρεμοί",
	"advancements.adventure.heart_transplanter.description": "Τοποθέτησε μια Καρδιά Τριξιτή με τη σωστή ευθυγράμμιση μεταξύ δύο κύβων Κορμού Λευκής Βελανιδιάς",
	"advancements.adventure.heart_transplanter.title": "Μεταμοσχευτής Καρδιάς",
	"advancements.adventure.hero_of_the_village.description": "Προστάτεψε ένα χωριό από επιδρομή με επιτυχία",
	"advancements.adventure.hero_of_the_village.title": "Ήρωας του Χωριού",
	"advancements.adventure.honey_block_slide.description": "Πήδηξε σε έναν Κύβο Μελιού για να κόψεις την πτώση σου",
	"advancements.adventure.honey_block_slide.title": "Αλεξίπτωτος",
	"advancements.adventure.kill_a_mob.description": "Σκότωσε ένα εχθρικό τέρας",
	"advancements.adventure.kill_a_mob.title": "Κυνηγός Τεράτων",
	"advancements.adventure.kill_all_mobs.description": "Σκότωσε ένα από κάθε εχθρικό τέρας",
	"advancements.adventure.kill_all_mobs.title": "Κυνηγημένα Τέρατα",
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Σκότωσε ένα ον κοντά σε έναν Καταλύτη Σκαλκ",
	"advancements.adventure.kill_mob_near_sculk_catalyst.title": "Εξαπλώνεται",
	"advancements.adventure.lighten_up.description": "Ξύσε μια Λάμπα Χαλκού με ένα Τσεκούρι για να την κάνεις λαμπερότερη",
	"advancements.adventure.lighten_up.title": "Λάμψε",
	"advancements.adventure.lightning_rod_with_villager_no_fire.description": "Προστάτεψε έναν Χωρικό από ανεπιθύμητο σοκ χωρίς να ξεκινήσεις φωτιά",
	"advancements.adventure.lightning_rod_with_villager_no_fire.title": "Αλεξικέραυνος",
	"advancements.adventure.minecraft_trials_edition.description": "Πάτησε σε έναν Θάλαμο Δοκιμασίας",
	"advancements.adventure.minecraft_trials_edition.title": "Δωρεάν Δοκιμασία",
	"advancements.adventure.ol_betsy.description": "Στόχευσε με μια Βαλλίστρα",
	"advancements.adventure.ol_betsy.title": "Ρομπέν των Δασών",
	"advancements.adventure.overoverkill.description": "Προκάλεσε ζημιά 50 καρδιών σε ένα χτύπημα χρησιμοποιώντας το Απελατίκι",
	"advancements.adventure.overoverkill.title": "Υπέρ-Υπερβολή",
	"advancements.adventure.play_jukebox_in_meadows.description": "Ζωντάνεψε τα Λιβάδια με τη μελωδία από ένα Τζούκμποξ",
	"advancements.adventure.play_jukebox_in_meadows.title": "Μελωδία της Ευτυχίας",
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Μέτρησε το σήμα δύναμης μιας Λαξευμένης Βιβλιοθήκης χρησιμοποιώντας έναν Συγκριτή",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Η Δύναμη των Βιβλίων",
	"advancements.adventure.revaulting.description": "Ξεκλείδωσε ένα Δυσοίωνο Θησαυροφυλάκιο με ένα Κλειδί Δυσοίωνης Δοκιμασίας",
	"advancements.adventure.revaulting.title": "Κουτί της Πανδώρας",
	"advancements.adventure.root.description": "Περιπέτεια, εξερεύνηση και μάχη",
	"advancements.adventure.root.title": "Περιπέτεια",
	"advancements.adventure.salvage_sherd.description": "Ξεσκόνισε έναν Ύποπτο κύβο για να αποκτήσεις ένα Θραύσμα Αγγειοπλαστικής",
	"advancements.adventure.salvage_sherd.title": "Σεβόμενοι τα Απομεινάρια",
	"advancements.adventure.shoot_arrow.description": "Στόχευσε κάτι με ένα Βέλος",
	"advancements.adventure.shoot_arrow.title": "Στόχευσε",
	"advancements.adventure.sleep_in_bed.description": "Κοιμήσου σε ένα Κρεβάτι για να αλλάξεις το σημείο αναγέννησής σου",
	"advancements.adventure.sleep_in_bed.title": "Όνειρα Γλυκά",
	"advancements.adventure.sniper_duel.description": "Σκότωσε έναν Σκελετό από τουλάχιστον 50 μέτρα μακριά",
	"advancements.adventure.sniper_duel.title": "Μονομαχία Ελεύθερων Σκοπευτών",
	"advancements.adventure.spear_many_mobs.description": "Χτύπα πέντε όντα στην ίδια επίθεση Φόρτισης χρησιμοποιώντας το Δόρυ",
	"advancements.adventure.spear_many_mobs.title": "Καλαμάκι",
	"advancements.adventure.spyglass_at_dragon.description": "Κοίταξε τον Δράκο Έντερ μέσα από ένα Μονοκυάλι",
	"advancements.adventure.spyglass_at_dragon.title": "Είναι Αεροπλάνο;",
	"advancements.adventure.spyglass_at_ghast.description": "Κοίταξε ένα Γκαστ μέσα από ένα Μονοκυάλι",
	"advancements.adventure.spyglass_at_ghast.title": "Είναι Μπαλόνι;",
	"advancements.adventure.spyglass_at_parrot.description": "Κοίταξε έναν Παπαγάλο μέσα από ένα Μονοκυάλι",
	"advancements.adventure.spyglass_at_parrot.title": "Είναι Πουλί;",
	"advancements.adventure.summon_iron_golem.description": "Εμφάνισε ένα Γκόλεμ Σιδήρου για να βοηθήσει στην προστασία ενός χωριού",
	"advancements.adventure.summon_iron_golem.title": "Πρόσληψη Βοηθού",
	"advancements.adventure.throw_trident.description": "Πέταξε μια Τρίαινα σε κάτι.\nΣημείωση: Το να πετάξεις το μόνο σου όπλο δεν είναι καλή ιδέα.",
	"advancements.adventure.throw_trident.title": "Ένα Άστοχο Αστείο",
	"advancements.adventure.totem_of_undying.description": "Χρησιμοποίησε ένα Τοτέμ της Αθανασίας για να ξεγελάσεις τον θάνατο",
	"advancements.adventure.totem_of_undying.title": "Μεταθανάτιος",
	"advancements.adventure.trade.description": "Αντάλλαξε με έναν Χωρικό με επιτυχία",
	"advancements.adventure.trade.title": "Τι Συμφωνία!",
	"advancements.adventure.trade_at_world_height.description": "Αντάλλαξε με έναν Χωρικό στο όριο ύψους χτισίματος",
	"advancements.adventure.trade_at_world_height.title": "Ο Έμπορος των Άστρων",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Εφάρμοσε αυτά τα πρότυπα μεταλλουργίας τουλάχιστον μία φορά: Κορυφής, Μουσούδας, Σκελετού, Φύλακα, Ησυχίας, Διαταράκτη, Παλίρροιας, Οδηγού",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Μεταλλουργία με Στιλ",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Κατασκεύασε επενδυμένη πανοπλία σε ένα Τραπέζι Μεταλλουργίας",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Κατασκευάζοντας μια Νέα Εμφάνιση",
	"advancements.adventure.two_birds_one_arrow.description": "Σκότωσε δύο Φαντάσματα με ένα διαπεραστικό Βέλος",
	"advancements.adventure.two_birds_one_arrow.title": "Με Ένα Βέλος Δύο Τρυγόνια",
	"advancements.adventure.under_lock_and_key.description": "Ξεκλείδωσε ένα Θησαυροφυλάκιο με ένα Κλειδί Δοκιμασίας",
	"advancements.adventure.under_lock_and_key.title": "Δοκιμασία Κλειδιού",
	"advancements.adventure.use_lodestone.description": "Χρησιμοποίησε μια Πυξίδα σε έναν Μαγνητίτη",
	"advancements.adventure.use_lodestone.title": "Μαγνητίτη, Πήγαινέ με Σπίτι",
	"advancements.adventure.very_very_frightening.description": "Χτύπησε έναν Χωρικό με κεραυνό",
	"advancements.adventure.very_very_frightening.title": "Πολύ Πολύ Τρομακτικό",
	"advancements.adventure.voluntary_exile.description": "Σκότωσε έναν αρχηγό επιδρομής.\nΣκέψου ίσως να μείνεις μακριά από χωριά για την ώρα...",
	"advancements.adventure.voluntary_exile.title": "Αυτοεξορία",
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.description": "Περπάτησε πάνω σε Φρέσκο Χιόνι... χωρίς να βουλιάξεις σε αυτό",
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.title": "Ελαφρύς σαν Κουνέλι",
	"advancements.adventure.who_needs_rockets.description": "Χρησιμοποίησε ένα Φορτίο Ανέμου για να εκτοξεύσεις τον εαυτό σου 8 κύβους ψηλά",
	"advancements.adventure.who_needs_rockets.title": "Ποιος Χρειάζεται Πυραύλους;",
	"advancements.adventure.whos_the_pillager_now.description": "Δώσε σε έναν Λεηλάτη μια δόση από το δικό του φάρμακο",
	...
	"advancements.end.dragon_breath.description": "Σύλλεξε Αναπνοή Δράκου σε ένα Γυάλινο Μπουκάλι",
	"advancements.end.dragon_breath.title": "Χρειάζεσαι μια Μέντα",
	"advancements.end.dragon_egg.description": "Κράτησε το Αβγό Δράκου",
	"advancements.end.dragon_egg.title": "Η Επόμενη Γενιά",
	"advancements.end.elytra.description": "Βρες Έλυτρα",
	"advancements.end.elytra.title": "Ο Ουρανός Είναι το Όριο",
	"advancements.end.enter_end_gateway.description": "Δραπέτευσε από το νησί",
	"advancements.end.enter_end_gateway.title": "Απομακρυσμένη Απόδραση",
	"advancements.end.find_end_city.description": "Πήγαινε, τι θα μπορούσε να συμβεί;",
	"advancements.end.find_end_city.title": "Η Πόλη στο «End» του Παιχνιδιού",
	"advancements.end.kill_dragon.description": "Καλή τύχη",
	"advancements.end.kill_dragon.title": "Απελευθέρωσε το Εντ",
	"advancements.end.levitate.description": "Ανυψώσου 50 κύβους ψηλά από τις επιθέσεις ενός Σάλκερ",
	"advancements.end.levitate.title": "Τέλεια Θέα από Εδώ Πάνω",
	"advancements.end.respawn_dragon.description": "Αναγέννησε τον Δράκο Έντερ",
	"advancements.end.respawn_dragon.title": "Το «End»... Ξανά...",
	"advancements.end.root.description": "Ή η αρχή;",
	"advancements.end.root.title": "Το Εντ",
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Βάλε έναν Κατευναστή να ρίξει μια Τούρτα σε έναν Κύβο Νότας",
	"advancements.husbandry.allay_deliver_cake_to_note_block.title": "Τραγούδι Γενεθλίων",
	"advancements.husbandry.allay_deliver_item_to_player.description": "Βάλε έναν Κατευναστή να σου παραδώσει αντικείμενα",
	"advancements.husbandry.allay_deliver_item_to_player.title": "Εγώ κι Εσύ Μαζί",
	"advancements.husbandry.axolotl_in_a_bucket.description": "Πιάσε ένα Αξολότλ σε έναν Κουβά",
	"advancements.husbandry.axolotl_in_a_bucket.title": "Ο πιο Χαριτωμένος Θηρευτής",
	"advancements.husbandry.balanced_diet.description": "Φάε ό,τι είναι φαγώσιμο, ακόμη και αν δεν είναι καλό για εσένα",
	"advancements.husbandry.balanced_diet.title": "Μια Ισορροπημένη Διατροφή",
	"advancements.husbandry.breed_all_animals.description": "Ζευγάρωσε όλα τα ζώα!",
	"advancements.husbandry.breed_all_animals.title": "Ανά Δύο",
	"advancements.husbandry.breed_an_animal.description": "Ζευγάρωσε δύο ζώα μαζί",
	"advancements.husbandry.breed_an_animal.title": "Οι Παπαγάλοι και οι Νυχτερίδες",
	"advancements.husbandry.complete_catalogue.description": "Εξημέρωσε όλα τα είδη Γάτας!",
	"advancements.husbandry.complete_catalogue.title": "Ένας Πλήρης Γατάλογος",
	"advancements.husbandry.feed_snifflet.description": "Τάισε ένα Οσφρητάκι",
	"advancements.husbandry.feed_snifflet.title": "Μικρά Οσφρίσματα",
	"advancements.husbandry.fishy_business.description": "Πιάσε ένα ψάρι",
	"advancements.husbandry.fishy_business.title": "Ψαροδουλειές",
	"advancements.husbandry.froglights.description": "Έχε όλα τα βατραχόφωτα στα αποθέματά σου",
	"advancements.husbandry.froglights.title": "Με τις Δυνάμεις μας Ενωμένες!",
	"advancements.husbandry.kill_axolotl_target.description": "Συνεργάσου με ένα Αξολότλ και νίκησε μια μάχη",
	"advancements.husbandry.kill_axolotl_target.title": "Η Θεραπευτική Δύναμη της Φιλίας!",
	"advancements.husbandry.leash_all_frog_variants.description": "Βάλε κάθε είδος Βατράχου σε ένα Λουρί",
	"advancements.husbandry.leash_all_frog_variants.title": "Όταν η Ομάδα Ξεπηδάει",
	"advancements.husbandry.make_a_sign_glow.description": "Κάνε το κείμενο μιας οποιασδήποτε πινακίδας να λάμπει",
	"advancements.husbandry.make_a_sign_glow.title": "Λάμψε και Αντίκρισε!",
	"advancements.husbandry.netherite_hoe.description": "Χρησιμοποίησε μια Ράβδο Νεδερίτη για να αναβαθμίσεις μια Τσάπα, και μετά επαναξιολόγησε τις επιλογές της ζωής σου",
	"advancements.husbandry.netherite_hoe.title": "Σοβαρή Αφοσίωση",
	"advancements.husbandry.obtain_sniffer_egg.description": "Απόκτησε ένα Αβγό Οσφρητή",
	"advancements.husbandry.obtain_sniffer_egg.title": "Μυρίζει Περίεργα",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Τοποθέτησε έναν κύβο Αφυδατωμένου Γκαστ σε νερό",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Νερό στον Ξερό!",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Φύτεψε έναν σπόρο Οσφρητή",
	"advancements.husbandry.plant_any_sniffer_seed.title": "Φυτεύοντας το Παρελθόν",
	"advancements.husbandry.plant_seed.description": "Φύτεψε έναν σπόρο και παρακολούθησέ τον να μεγαλώνει",
	"advancements.husbandry.plant_seed.title": "Φυτεύοντας Σπόρους",
	"advancements.husbandry.remove_wolf_armor.description": "Αφαίρεσε Πανοπλία Λύκου από έναν Λύκο χρησιμοποιώντας μια Ψαλίδα",
	"advancements.husbandry.remove_wolf_armor.title": "Ιππότης Χωρίς Πανοπλία",
	"advancements.husbandry.repair_wolf_armor.description": "Επισκεύασε πλήρως κατεστραμμένη Πανοπλία Λύκου χρησιμοποιώντας Φολίδες Αρμαδίλου",
	"advancements.husbandry.repair_wolf_armor.title": "Σαν Καινούργια",
	"advancements.husbandry.ride_a_boat_with_a_goat.description": "Μπες σε μια Βάρκα και επίπλευσε με μια Κατσίκα",
	"advancements.husbandry.ride_a_boat_with_a_goat.title": "Πλωτή Κατσίκα!",
	"advancements.husbandry.root.description": "Ο κόσμος είναι γεμάτος με φίλους και φαγητό",
	"advancements.husbandry.root.title": "Γεωργία",
	"advancements.husbandry.safely_harvest_honey.description": "Χρησιμοποίησε μια Φωτιά Κατασκήνωσης για να συλλέξεις Μέλι από μια Κυψέλη χρησιμοποιώντας ένα Γυάλινο Μπουκάλι χωρίς να εξαγριώσεις τις Μέλισσες",
	"advancements.husbandry.safely_harvest_honey.title": "Μελισσοκομία Χωρίς Νοσοκομεία",
	"advancements.husbandry.silk_touch_nest.description": "Μετακίνησε μια Μελισσοφωλιά ή Κυψέλη, με 3 Μέλισσες μέσα, χρησιμοποιώντας Μεταξένιο Άγγιγμα",
	"advancements.husbandry.silk_touch_nest.title": "Μελισσοκόμιση",
	"advancements.husbandry.tactical_fishing.description": "Πιάσε ένα Ψάρι... χωρίς Καλάμι Ψαρέματος!",
	"advancements.husbandry.tactical_fishing.title": "Στρατηγικό Ψάρεμα",
	"advancements.husbandry.tadpole_in_a_bucket.description": "Πιάσε έναν γυρίνο σε έναν κουβά",
	"advancements.husbandry.tadpole_in_a_bucket.title": "Κουβάτραχος",
	"advancements.husbandry.tame_an_animal.description": "Εξημέρωσε ένα ζώο",
	...
	"advancements.husbandry.uh_oh.title": "Ωχ Όχι",
	"advancements.husbandry.wax_off.description": "Ξύσε Κερί από έναν κύβο Χαλκού!",
	"advancements.husbandry.wax_off.title": "Αφαίρεση Κεριού",
	"advancements.husbandry.wax_on.description": "Πρόσθεσε Κηρήθρα σε έναν κύβο Χαλκού!",
	"advancements.husbandry.wax_on.title": "Προσθήκη Κεριού",
	"advancements.husbandry.whole_pack.description": "Εξημέρωσε έναν από κάθε είδος Λύκου",
	"advancements.husbandry.whole_pack.title": "Όλη η Αγέλη",
	"advancements.nether.all_effects.description": "Έχε όλες τις επιδράσεις εφαρμοσμένες την ίδια στιγμή",
	"advancements.nether.all_effects.title": "Πώς Καταλήξαμε Εδώ;",
	"advancements.nether.all_potions.description": "Έχε όλες τις επιδράσεις φίλτρων εφαρμοσμένες την ίδια στιγμή",
	"advancements.nether.all_potions.title": "Ένα Έντονο Μίγμα",
	"advancements.nether.brew_potion.description": "Παρασκεύασε ένα Φίλτρο",
	"advancements.nether.brew_potion.title": "Τοπικό Παρασκευαστήριο",
	"advancements.nether.charge_respawn_anchor.description": "Φόρτισε μια Άγκυρα Αναγέννησης στο μέγιστο",
	"advancements.nether.charge_respawn_anchor.title": "Όχι Ακριβώς «Εννιά» Ζωές",
	"advancements.nether.create_beacon.description": "Κατασκεύασε και τοποθέτησε έναν Φάρο",
	"advancements.nether.create_beacon.title": "Φέρε Σπίτι τον Φάρο",
	"advancements.nether.create_full_beacon.description": "Φέρε έναν Φάρο σε πλήρη δύναμη",
	"advancements.nether.create_full_beacon.title": "Φαροκατασκευαστής",
	"advancements.nether.distract_piglin.description": "Απόσπασε Πίγκλιν με χρυσό",
	"advancements.nether.distract_piglin.title": "Ωχ Λαμπερό",
	"advancements.nether.explore_nether.description": "Εξερεύνησε όλα τα τοπία του Νέδερ",
	"advancements.nether.explore_nether.title": "Καυτοί Τουριστικοί Προορισμοί",
	"advancements.nether.fast_travel.description": "Χρησιμοποίησε το Νέδερ για να ταξιδέψεις 7 χλμ στον Κανονικό Κόσμο",
	"advancements.nether.fast_travel.title": "Υποχώρια Φυσαλίδα",
	"advancements.nether.find_bastion.description": "Μπες σε ένα Απομεινάρι Προμαχώνα",
	"advancements.nether.find_bastion.title": "Αυτές Ήταν οι Μέρες",
	"advancements.nether.find_fortress.description": "Παραβίασε ένα Οχυρό Νέδερ",
	"advancements.nether.find_fortress.title": "Ένα Τρομερό Οχυρό",
	"advancements.nether.get_wither_skull.description": "Απόκτησε ένα Κρανίο Σκελετού Ουίδερ",
	"advancements.nether.get_wither_skull.title": "Παράξενος Τρομακτικός Σκελετός",
	"advancements.nether.loot_bastion.description": "Λεηλάτησε ένα Σεντούκι σε ένα Απομεινάρι Προμαχώνα",
	"advancements.nether.loot_bastion.title": "Πολεμικά Γουρούνια",
	"advancements.nether.netherite_armor.description": "Απόκτησε μια πλήρη στολή από πανοπλία Νεδερίτη",
	"advancements.nether.netherite_armor.title": "Κάλυψέ με σε Συντρίμμια",
	"advancements.nether.obtain_ancient_debris.description": "Απόκτησε Αρχαία Συντρίμμια",
	"advancements.nether.obtain_ancient_debris.title": "Κρυμμένο στα Βάθη",
	"advancements.nether.obtain_blaze_rod.description": "Απάλλαξε έναν Πυροστρόβιλο από τη ράβδο του",
	"advancements.nether.obtain_blaze_rod.title": "Μέσα στην Πυρά",
	"advancements.nether.obtain_crying_obsidian.description": "Απόκτησε Δακρυσμένο Οψιδιανό",
	"advancements.nether.obtain_crying_obsidian.title": "Ποιος Κόβει Κρεμμύδια;",
	"advancements.nether.return_to_sender.description": "Κατάστρεψε ένα Γκαστ με μια πύρινη μπάλα",
	"advancements.nether.return_to_sender.title": "Επιστροφή στον Αποστολέα",
	"advancements.nether.ride_strider.description": "Καβάλησε έναν Δρασκελιστή με έναν Στρεβλωμένο Μύκητα σε Ξυλάκι",
	"advancements.nether.ride_strider.title": "Αυτή η Βάρκα Έχει Πόδια",
	"advancements.nether.ride_strider_in_overworld_lava.description": "Πάρε έναν Δρασκελιστή για ένα μακρύυυυ ταξίδι σε μια λίμνη λάβας στον Κανονικό Κόσμο",
	"advancements.nether.ride_strider_in_overworld_lava.title": "Όπως στο Σπίτι",
	"advancements.nether.root.description": "Φέρε καλοκαιρινά ρούχα",
	"advancements.nether.root.title": "Νέδερ",
	"advancements.nether.summon_wither.description": "Εμφάνισε το Ουίδερ",
	"advancements.nether.summon_wither.title": "Ο Σύγχρονος Προμηθέας",
	"advancements.nether.uneasy_alliance.description": "Σώσε ένα Γκαστ από το Νέδερ, φέρε το στον Κανονικό Κόσμο με ασφάλεια... και μετά σκότωσέ το",
	"advancements.nether.uneasy_alliance.title": "Αβέβαιη Συμμαχία",
	"advancements.nether.use_lodestone.description": "Χρησιμοποίησε μια Πυξίδα σε έναν Μαγνητίτη",
	"advancements.nether.use_lodestone.title": "Μαγνητίτη, Πήγαινέ με Σπίτι",
	"advancements.progress": "%s/%s",
	"advancements.sad_label": ":(",
	"advancements.story.cure_zombie_villager.description": "Αποδυνάμωσε και μετά γιάτρεψε έναν Χωρικό Ζόμπι",
	"advancements.story.cure_zombie_villager.title": "Γιατρός Ζόμπι",
	"advancements.story.deflect_arrow.description": "Έκτρεψε ένα βλήμα με μια Ασπίδα",
	"advancements.story.deflect_arrow.title": "Όχι Σήμερα, Ευχαριστώ",
	"advancements.story.enchant_item.description": "Μάγεψε ένα αντικείμενο σε ένα Τραπέζι Μαγέματος",
	"advancements.story.enchant_item.title": "Μάγος",
	"advancements.story.enter_the_end.description": "Μπες στην Πύλη Εντ",
	"advancements.story.enter_the_end.title": "Το «End»;",
	"advancements.story.enter_the_nether.description": "Χτίσε, άναψε, και μπες σε μια Πύλη Νέδερ",
	"advancements.story.enter_the_nether.title": "Πρέπει να Πάμε Βαθύτερα",
	"advancements.story.follow_ender_eye.description": "Ακολούθησε ένα Μάτι του Έντερ",
	"advancements.story.follow_ender_eye.title": "Μάτι του Εξερευνητή",
	"advancements.story.form_obsidian.description": "Απόκτησε έναν κύβο από Οψιδιανό",
	"advancements.story.form_obsidian.title": "Πρόκληση Παγωμένου Κουβά",
	"advancements.story.iron_tools.description": "Αναβάθμισε την Αξίνα σου",
	"advancements.story.iron_tools.title": "Σιδερένια Αξίνα Δεν Είναι",
	"advancements.story.lava_bucket.description": "Γέμισε έναν Κουβά με λάβα",
	"advancements.story.lava_bucket.title": "Καυτό Πράγμα",
	"advancements.story.mine_diamond.description": "Απόκτησε διαμάντια",
	"advancements.story.mine_diamond.title": "Διαμάντια!",
	"advancements.story.mine_stone.description": "Σύλλεξε Πέτρα με τη νέα σου Αξίνα",
	"advancements.story.mine_stone.title": "Λίθινη Εποχή",
	"advancements.story.obtain_armor.description": "Προστάτεψε τον εαυτό σου με ένα κομμάτι σιδερένιας πανοπλίας",
	"advancements.story.obtain_armor.title": "Ντύσου",
	"advancements.story.root.description": "Η καρδιά και η ιστορία του παιχνιδιού",
	...
	"advancements.story.smelt_iron.description": "Λιώσε μια Ράβδο Σιδήρου",
	"advancements.story.smelt_iron.title": "Μεταλλουργία",
	"advancements.story.upgrade_tools.description": "Κατασκεύασε μια καλύτερη Αξίνα",
	"advancements.story.upgrade_tools.title": "Αποκτώντας μια Αναβάθμιση",
	"advancements.toast.challenge": "Πρόκληση Ολοκληρώθηκε!",
	"advancements.toast.goal": "Επίτευξη Στόχου!",
	"advancements.toast.task": "Απόκτηση Εξέλιξης!",
	...
	"argument.double.big": "Ο αριθμός κινητής υποδιαστολής διπλής ακρίβειας δεν πρέπει να είναι πάνω από %s: βρέθηκε η τιμή %s",
	"argument.double.low": "Ο αριθμός κινητής υποδιαστολής διπλής ακρίβειας δεν πρέπει να είναι κάτω από %s: βρέθηκε η τιμή %s",
	...
	"argument.entity.selector.missing": "Λείπει ο τύπος του διαλογέα",
	"argument.entity.selector.nearestEntity": "Πλησιέστερη οντότητα",
	...
	"argument.float.big": "Ο αριθμός κινητής υποδιαστολής απλής ακρίβειας δεν πρέπει να είναι πάνω από %s: βρέθηκε η τιμή %s",
	"argument.float.low": "Ο αριθμός κινητής υποδιαστολής απλής ακρίβειας δεν πρέπει να είναι κάτω από %s: βρέθηκε η τιμή %s",
	"argument.gamemode.invalid": "Άγνωστη λειτουργία παιχνιδιού: %s",
	"argument.hexcolor.invalid": "Μη έγκυρος δεκαεξαδικός κωδικός χρώματος «%s»",
	...
	"argument.message.too_long": "Το μήνυμα συνομιλίας ήταν πολύ μεγάλο (%s > μέγιστο %s χαρακτήρων)",
	"argument.nbt.array.invalid": "Μη έγκυρος τύπος πίνακα «%s»",
	"argument.nbt.array.mixed": "Δεν μπορεί να εισαχθεί %s σε %s",
	"argument.nbt.expected.compound": "Αναμενόταν ετικέτα λεξικού",
	...
	"argument.resource_or_id.failed_to_parse": "Απέτυχε η ανάλυση της δομής: %s",
	"argument.resource_or_id.invalid": "Μη έγκυρο αναγνωριστικό ή ετικέτα",
	"argument.resource_or_id.no_such_element": "Δεν μπορεί να βρεθεί το στοιχείο «%s» στο μητρώο «%s»",
	"argument.resource_selector.not_found": "Καμία αντιστοίχηση για τον διαλογέα «%s» τύπου «%s»",
	...
	"argument.style.invalid": "Μη έγκυρο στιλ: %s",
	...
	"argument.waypoint.invalid": "Η επιλεγμένη οντότητα δεν είναι δείκτης",
	...
	"arguments.item.component.expected": "Αναμενόταν στοιχείο αντικειμένου",
	"arguments.item.component.malformed": "Ακατάλληλο στοιχείο αντικειμένου «%s»: «%s»",
	"arguments.item.component.repeated": "Το στοιχείο αντικειμένου «%s» επαναλήφθηκε, αλλά μόνο μία τιμή μπορεί να επιλεχθεί",
	"arguments.item.component.unknown": "Άγνωστο στοιχείο αντικειμένου «%s»",
	"arguments.item.malformed": "Ακατάλληλο αντικείμενο: «%s»",
	"arguments.item.overstacked": "Το αντικείμενο %s μπορεί να τοποθετηθεί έως και %s φορές ανά υποδοχή",
	"arguments.item.predicate.malformed": "Ακατάλληλη συνθήκη αντικειμένου «%s»: «%s»",
	"arguments.item.predicate.unknown": "Άγνωστη συνθήκη αντικειμένου «%s»",
	...
	"arguments.swizzle.invalid": "Μη έγκυρος συνδυασμός: αναμενόταν συνδυασμός των «x», «y» και «z»",
	...
	"attribute.name.air_drag_modifier": "Τροποποίηση Αντίστασης Αέρα",
	"attribute.name.armor": "Πανοπλία",
	"attribute.name.armor_toughness": "Ανθεκτικότητα Πανοπλίας",
	"attribute.name.attack_damage": "Ζημιά Επίθεσης",
	"attribute.name.attack_knockback": "Απώθηση Επίθεσης",
	"attribute.name.attack_speed": "Ταχύτητα Επίθεσης",
	"attribute.name.below_name_distance": "Απόσταση Σκορ Ετικέτας Ονόματος",
	"attribute.name.block_break_speed": "Ταχύτητα Σπασίματος Κύβων",
	"attribute.name.block_interaction_range": "Εμβέλεια Επαφής Κύβων",
	"attribute.name.bounciness": "Αναπήδηση",
	"attribute.name.burning_time": "Χρόνος Καύσης",
	"attribute.name.camera_distance": "Απόσταση Κάμερας",
	"attribute.name.entity_interaction_range": "Εμβέλεια Επαφής Οντοτήτων",
	"attribute.name.explosion_knockback_resistance": "Αντίσταση Απώθησης Εκρήξεων",
	"attribute.name.fall_damage_multiplier": "Πολλαπλασιαστής Ζημιάς Πτώσης",
	"attribute.name.flying_speed": "Ταχύτητα Πτήσης",
	"attribute.name.follow_range": "Εμβέλεια Ακολούθησης Όντων",
	"attribute.name.friction_modifier": "Τροποποίηση Τριβής",
	...
	"attribute.name.generic.block_interaction_range": "Εμβέλεια Επαφής Κύβων",
	"attribute.name.generic.burning_time": "Χρόνος Καύσης",
	"attribute.name.generic.entity_interaction_range": "Εμβέλεια Επαφής Οντοτήτων",
	"attribute.name.generic.explosion_knockback_resistance": "Αντίσταση Απώθησης Εκρήξεων",
	"attribute.name.generic.fall_damage_multiplier": "Πολλαπλασιαστής Ζημιάς Πτώσης",
	"attribute.name.generic.flying_speed": "Ταχύτητα Πτήσης",
	"attribute.name.generic.follow_range": "Εμβέλεια Ακολούθησης Όντων",
	"attribute.name.generic.gravity": "Βαρύτητα",
	"attribute.name.generic.jump_strength": "Ισχύς Άλματος",
	"attribute.name.generic.knockback_resistance": "Αντίσταση Απώθησης",
	"attribute.name.generic.luck": "Τύχη",
	"attribute.name.generic.max_absorption": "Μέγιστη Απορρόφηση",
	"attribute.name.generic.max_health": "Μέγιστη Ζωή",
	"attribute.name.generic.movement_efficiency": "Αποδοτικότητα Κίνησης",
	"attribute.name.generic.movement_speed": "Ταχύτητα",
	"attribute.name.generic.oxygen_bonus": "Επιπλέον Οξυγόνο",
	"attribute.name.generic.safe_fall_distance": "Απόσταση Ασφαλούς Πτώσης",
	"attribute.name.generic.scale": "Κλίμακα",
	"attribute.name.generic.step_height": "Ύψος Βήματος",
	"attribute.name.generic.water_movement_efficiency": "Αποδοτικότητα Κίνησης Νερού",
	"attribute.name.gravity": "Βαρύτητα",
	"attribute.name.horse.jump_strength": "Ισχύς Άλματος Αλόγου",
	"attribute.name.jump_strength": "Ισχύς Άλματος",
	"attribute.name.knockback_resistance": "Αντίσταση Απώθησης",
	"attribute.name.luck": "Τύχη",
	"attribute.name.max_absorption": "Μέγιστη Απορρόφηση",
	"attribute.name.max_health": "Μέγιστη Ζωή",
	"attribute.name.mining_efficiency": "Αποδοτικότητα Εξόρυξης",
	"attribute.name.movement_efficiency": "Αποδοτικότητα Κίνησης",
	"attribute.name.movement_speed": "Ταχύτητα",
	"attribute.name.nameplate_distance": "Απόσταση Ετικέτας Ονόματος",
	"attribute.name.oxygen_bonus": "Επιπλέον Οξυγόνο",
	"attribute.name.player.block_break_speed": "Ταχύτητα Σπασίματος Κύβων",
	"attribute.name.player.block_interaction_range": "Εμβέλεια Επαφής Κύβων",
	"attribute.name.player.entity_interaction_range": "Εμβέλεια Επαφής Οντοτήτων",
	"attribute.name.player.mining_efficiency": "Αποδοτικότητα Εξόρυξης",
	"attribute.name.player.sneaking_speed": "Ταχύτητα Σκυψίματος",
	"attribute.name.player.submerged_mining_speed": "Ταχύτητα Υποβρύχιας Εξόρυξης",
	"attribute.name.player.sweeping_damage_ratio": "Αναλογία Σαρωτικής Ζημιάς",
	"attribute.name.safe_fall_distance": "Απόσταση Ασφαλούς Πτώσης",
	"attribute.name.scale": "Κλίμακα",
	"attribute.name.sneaking_speed": "Ταχύτητα Σκυψίματος",
	"attribute.name.spawn_reinforcements": "Ενισχύσεις Ζόμπι",
	"attribute.name.step_height": "Ύψος Βήματος",
	"attribute.name.submerged_mining_speed": "Ταχύτητα Υποβρύχιας Εξόρυξης",
	"attribute.name.sweeping_damage_ratio": "Αναλογία Σαρωτικής Ζημιάς",
	"attribute.name.tempt_range": "Εμβέλεια Δελεασμού Όντων",
	"attribute.name.water_movement_efficiency": "Αποδοτικότητα Κίνησης Νερού",
	"attribute.name.waypoint_receive_range": "Εύρος Λήψης Δείκτη",
	"attribute.name.waypoint_transmit_range": "Εύρος Μετάδοσης Δείκτη",
	...
	"biome.minecraft.pale_garden": "Λευκό Δάσος",
	...
	"biome.minecraft.sulfur_caves": "Σπηλιές Θείου",
	...
	"biome.minecraft.warped_forest": "Στρεβλωμένο Δάσος",
	...
	"block.minecraft.acacia_shelf": "Ράφι Ακακίας",
	...
	"block.minecraft.bamboo_shelf": "Ράφι Μπαμπού",
	...
	"block.minecraft.banner.flow.black": "Μαύρη Ροή",
	"block.minecraft.banner.flow.blue": "Μπλε Ροή",
	"block.minecraft.banner.flow.brown": "Καφέ Ροή",
	"block.minecraft.banner.flow.cyan": "Κυανή Ροή",
	"block.minecraft.banner.flow.gray": "Γκρίζα Ροή",
	"block.minecraft.banner.flow.green": "Πράσινη Ροή",
	"block.minecraft.banner.flow.light_blue": "Γαλάζια Ροή",
	"block.minecraft.banner.flow.light_gray": "Ανοιχτή Γκρίζα Ροή",
	"block.minecraft.banner.flow.lime": "Λαχανί Ροή",
	"block.minecraft.banner.flow.magenta": "Φούξια Ροή",
	"block.minecraft.banner.flow.orange": "Πορτοκαλί Ροή",
	"block.minecraft.banner.flow.pink": "Ροζ Ροή",
	"block.minecraft.banner.flow.purple": "Μοβ Ροή",
	"block.minecraft.banner.flow.red": "Κόκκινη Ροή",
	"block.minecraft.banner.flow.white": "Λευκή Ροή",
	"block.minecraft.banner.flow.yellow": "Κίτρινη Ροή",
	...
	"block.minecraft.banner.guster.black": "Μαύρη Ριπή",
	"block.minecraft.banner.guster.blue": "Μπλε Ριπή",
	"block.minecraft.banner.guster.brown": "Καφέ Ριπή",
	"block.minecraft.banner.guster.cyan": "Κυανή Ριπή",
	"block.minecraft.banner.guster.gray": "Γκρίζα Ριπή",
	"block.minecraft.banner.guster.green": "Πράσινη Ριπή",
	"block.minecraft.banner.guster.light_blue": "Γαλάζια Ριπή",
	"block.minecraft.banner.guster.light_gray": "Ανοιχτή Γκρίζα Ριπή",
	"block.minecraft.banner.guster.lime": "Λαχανί Ριπή",
	"block.minecraft.banner.guster.magenta": "Φούξια Ριπή",
	"block.minecraft.banner.guster.orange": "Πορτοκαλί Ριπή",
	"block.minecraft.banner.guster.pink": "Ροζ Ριπή",
	"block.minecraft.banner.guster.purple": "Μοβ Ριπή",
	"block.minecraft.banner.guster.red": "Κόκκινη Ριπή",
	"block.minecraft.banner.guster.white": "Λευκή Ριπή",
	"block.minecraft.banner.guster.yellow": "Κίτρινη Ριπή",
	...
	"block.minecraft.bed.no_sleep": "Μπορείς να κοιμηθείς μόνο τη νύχτα ή κατά τη διάρκεια καταιγίδων",
	"block.minecraft.bed.not_safe": "Δεν μπορείς να κοιμηθείς τώρα· υπάρχουν τέρατα κοντά",
	...
	"block.minecraft.bed.too_far_away": "Δεν μπορείς να κοιμηθείς τώρα· το κρεβάτι βρίσκεται πολύ μακριά",
	...
	"block.minecraft.birch_shelf": "Ράφι Σημύδας",
	...
	"block.minecraft.bush": "Θάμνος",
	"block.minecraft.cactus": "Κάκτος",
	"block.minecraft.cactus_flower": "Άνθος Κάκτου",
	...
	"block.minecraft.cherry_shelf": "Ράφι Κερασιάς",
	...
	"block.minecraft.chiseled_cinnabar": "Λαξευμένος Κινναβαρίτης",
	"block.minecraft.chiseled_copper": "Λαξευμένος Χαλκός",
	...
	"block.minecraft.chiseled_resin_bricks": "Λαξευμένα Τούβλα Ρητίνης",
	"block.minecraft.chiseled_sandstone": "Λαξευμένη Αμμόπετρα",
	"block.minecraft.chiseled_stone_bricks": "Λαξευμένα Τούβλα Πέτρας",
	"block.minecraft.chiseled_sulfur": "Λαξευμένο Θείο",
	"block.minecraft.chiseled_tuff": "Λαξευμένος Τόφος",
	"block.minecraft.chiseled_tuff_bricks": "Λαξευμένα Τούβλα Τόφου",
	"block.minecraft.chorus_flower": "Χορικό Άνθος",
	"block.minecraft.chorus_plant": "Χορικό Φυτό",
	"block.minecraft.cinnabar": "Κινναβαρίτης",
	"block.minecraft.cinnabar_brick_slab": "Πλάκα Τούβλων Κινναβαρίτη",
	"block.minecraft.cinnabar_brick_stairs": "Σκάλες Τούβλων Κινναβαρίτη",
	"block.minecraft.cinnabar_brick_wall": "Τοίχος Τούβλων Κινναβαρίτη",
	"block.minecraft.cinnabar_bricks": "Τούβλα Κινναβαρίτη",
	"block.minecraft.cinnabar_slab": "Πλάκα Κινναβαρίτη",
	"block.minecraft.cinnabar_stairs": "Σκάλες Κινναβαρίτη",
	"block.minecraft.cinnabar_wall": "Τοίχος Κινναβαρίτη",
	"block.minecraft.clay": "Πηλός",
	"block.minecraft.closed_eyeblossom": "Κλειστός Οφθάλμανθος",
	...
	"block.minecraft.copper_bars": "Κάγκελα Χαλκού",
	"block.minecraft.copper_block": "Κύβος Χαλκού",
	"block.minecraft.copper_bulb": "Λάμπα Χαλκού",
	"block.minecraft.copper_chain": "Αλυσίδα Χαλκού",
	"block.minecraft.copper_chest": "Σεντούκι Χαλκού",
	"block.minecraft.copper_door": "Πόρτα Χαλκού",
	"block.minecraft.copper_golem_statue": "Άγαλμα Γκόλεμ Χαλκού",
	"block.minecraft.copper_grate": "Σχάρα Χαλκού",
	"block.minecraft.copper_lantern": "Φανάρι Χαλκού",
	"block.minecraft.copper_ore": "Μετάλλευμα Χαλκού",
	"block.minecraft.copper_torch": "Πυρσός Χαλκού",
	"block.minecraft.copper_trapdoor": "Καταπακτή Χαλκού",
	"block.minecraft.copper_wall_torch": "Πυρσός Τοίχου Χαλκού",
	...
	"block.minecraft.crafter": "Κατασκευαστής",
	"block.minecraft.crafting_table": "Τραπέζι Κατασκευής",
	"block.minecraft.creaking_heart": "Καρδιά Τριξιτή",
	...
	"block.minecraft.crimson_shelf": "Ερυθρό Ράφι",
	...
	"block.minecraft.dark_oak_shelf": "Ράφι Σκούρας Βελανιδιάς",
	...
	"block.minecraft.dried_ghast": "Αφυδατωμένο Γκαστ",
	...
	"block.minecraft.exposed_chiseled_copper": "Εκτεθειμένος Λαξευμένος Χαλκός",
	"block.minecraft.exposed_copper": "Εκτεθειμένος Χαλκός",
	"block.minecraft.exposed_copper_bars": "Κάγκελα Εκτεθειμένου Χαλκού",
	"block.minecraft.exposed_copper_bulb": "Λάμπα Εκτεθειμένου Χαλκού",
	"block.minecraft.exposed_copper_chain": "Αλυσίδα Εκτεθειμένου Χαλκού",
	"block.minecraft.exposed_copper_chest": "Σεντούκι Εκτεθειμένου Χαλκού",
	"block.minecraft.exposed_copper_door": "Πόρτα Εκτεθειμένου Χαλκού",
	"block.minecraft.exposed_copper_golem_statue": "Άγαλμα Γκόλεμ Εκτεθειμένου Χαλκού",
	"block.minecraft.exposed_copper_grate": "Σχάρα Εκτεθειμένου Χαλκού",
	"block.minecraft.exposed_copper_lantern": "Φανάρι Εκτεθειμένου Χαλκού",
	"block.minecraft.exposed_copper_trapdoor": "Καταπακτή Εκτεθειμένου Χαλκού",
	...
	"block.minecraft.exposed_lightning_rod": "Εκτεθειμένο Αλεξικέραυνο",
	...
	"block.minecraft.firefly_bush": "Θάμνος Πυγολαμπίδων",
	...
	"block.minecraft.golden_dandelion": "Χρυσή Πικραλίδα",
	...
	"block.minecraft.hay_block": "Δεμάτι Σανού",
	"block.minecraft.heavy_core": "Βαρύς Πυρήνας",
	...
	"block.minecraft.iron_chain": "Αλυσίδα Σιδήρου",
	...
	"block.minecraft.jungle_shelf": "Ράφι Ζούγκλας",
	...
	"block.minecraft.leaf_litter": "Στρώμα Φύλλων",
	...
	"block.minecraft.mangrove_shelf": "Ράφι Μαγκροβίου",
	...
	"block.minecraft.moss_carpet": "Στρώμα Βρύων",
	...
	"block.minecraft.oak_shelf": "Ράφι Βελανιδιάς",
	...
	"block.minecraft.open_eyeblossom": "Ανοιχτός Οφθάλμανθος",
	...
	"block.minecraft.orange_glazed_terracotta": "Πορτοκαλί Γυαλισμένη Τερακότα",
	...
	"block.minecraft.oxidized_chiseled_copper": "Οξειδωμένος Λαξευμένος Χαλκός",
	"block.minecraft.oxidized_copper": "Οξειδωμένος Χαλκός",
	"block.minecraft.oxidized_copper_bars": "Κάγκελα Οξειδωμένου Χαλκού",
	"block.minecraft.oxidized_copper_bulb": "Λάμπα Οξειδωμένου Χαλκού",
	"block.minecraft.oxidized_copper_chain": "Αλυσίδα Οξειδωμένου Χαλκού",
	"block.minecraft.oxidized_copper_chest": "Σεντούκι Οξειδωμένου Χαλκού",
	"block.minecraft.oxidized_copper_door": "Πόρτα Οξειδωμένου Χαλκού",
	"block.minecraft.oxidized_copper_golem_statue": "Άγαλμα Γκόλεμ Οξειδωμένου Χαλκού",
	"block.minecraft.oxidized_copper_grate": "Σχάρα Οξειδωμένου Χαλκού",
	"block.minecraft.oxidized_copper_lantern": "Φανάρι Οξειδωμένου Χαλκού",
	"block.minecraft.oxidized_copper_trapdoor": "Καταπακτή Οξειδωμένου Χαλκού",
	...
	"block.minecraft.oxidized_lightning_rod": "Οξειδωμένο Αλεξικέραυνο",
	"block.minecraft.packed_ice": "Συμπιεσμένος Πάγος",
	"block.minecraft.packed_mud": "Συμπιεσμένη Λάσπη",
	"block.minecraft.pale_hanging_moss": "Λευκά Κρεμαστά Βρύα",
	"block.minecraft.pale_moss_block": "Κύβος Λευκών Βρύων",
	"block.minecraft.pale_moss_carpet": "Στρώμα Λευκών Βρύων",
	"block.minecraft.pale_oak_button": "Κουμπί Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_door": "Πόρτα Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_fence": "Φράχτης Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_fence_gate": "Πύλη Φράχτη Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_hanging_sign": "Κρεμαστή Πινακίδα Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_leaves": "Φύλλα Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_log": "Κορμός Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_planks": "Σανίδες Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_pressure_plate": "Πλάκα Πίεσης Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_sapling": "Βλαστάρι Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_shelf": "Ράφι Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_sign": "Πινακίδα Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_slab": "Πλάκα Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_stairs": "Σκάλες Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_trapdoor": "Καταπακτή Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_wall_hanging_sign": "Κρεμαστή Πινακίδα Τοίχου Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_wall_sign": "Πινακίδα Τοίχου Λευκής Βελανιδιάς",
	"block.minecraft.pale_oak_wood": "Ξύλο Λευκής Βελανιδιάς",
	...
	"block.minecraft.polished_cinnabar": "Γυαλισμένος Κινναβαρίτης",
	"block.minecraft.polished_cinnabar_slab": "Πλάκα Γυαλισμένου Κινναβαρίτη",
	"block.minecraft.polished_cinnabar_stairs": "Σκάλες Γυαλισμένου Κινναβαρίτη",
	"block.minecraft.polished_cinnabar_wall": "Τοίχος Γυαλισμένου Κινναβαρίτη",
	...
	"block.minecraft.polished_sulfur": "Γυαλισμένο Θείο",
	"block.minecraft.polished_sulfur_slab": "Πλάκα Γυαλισμένου Θείου",
	"block.minecraft.polished_sulfur_stairs": "Σκάλες Γυαλισμένου Θείου",
	"block.minecraft.polished_sulfur_wall": "Τοίχος Γυαλισμένου Θείου",
	"block.minecraft.polished_tuff": "Γυαλισμένος Τόφος",
	"block.minecraft.polished_tuff_slab": "Πλάκα Γυαλισμένου Τόφου",
	"block.minecraft.polished_tuff_stairs": "Σκάλες Γυαλισμένου Τόφου",
	"block.minecraft.polished_tuff_wall": "Τοίχος Γυαλισμένου Τόφου",
	"block.minecraft.poppy": "Παπαρούνα",
	"block.minecraft.potatoes": "Πατάτες",
	"block.minecraft.potent_sulfur": "Δραστικό Θείο",
	...
	"block.minecraft.potted_closed_eyeblossom": "Κλειστός Οφθάλμανθος σε Γλάστρα",
	...
	"block.minecraft.potted_golden_dandelion": "Χρυσή Πικραλίδα σε Γλάστρα",
	...
	"block.minecraft.potted_open_eyeblossom": "Ανοιχτός Οφθάλμανθος σε Γλάστρα",
	"block.minecraft.potted_orange_tulip": "Πορτοκαλί Τουλίπα σε Γλάστρα",
	"block.minecraft.potted_oxeye_daisy": "Μαργαρίτα σε Γλάστρα",
	"block.minecraft.potted_pale_oak_sapling": "Βλαστάρι Λευκής Βελανιδιάς σε Γλάστρα",
	...
	"block.minecraft.potted_torchflower": "Πύρσανθος σε Γλάστρα",
	"block.minecraft.potted_warped_fungus": "Στρεβλωμένος Μύκητας σε Γλάστρα",
	"block.minecraft.potted_warped_roots": "Στρεβλωμένες Ρίζες σε Γλάστρα",
	...
	"block.minecraft.redstone_wall_torch": "Πυρσός Τοίχου Ρέντστοουν",
	...
	"block.minecraft.resin_block": "Κύβος Ρητίνης",
	"block.minecraft.resin_brick_slab": "Πλάκα Τούβλων Ρητίνης",
	"block.minecraft.resin_brick_stairs": "Σκάλες Τούβλων Ρητίνης",
	"block.minecraft.resin_brick_wall": "Τοίχος Τούβλων Ρητίνης",
	"block.minecraft.resin_bricks": "Τούβλα Ρητίνης",
	"block.minecraft.resin_clump": "Συστάδα Ρητίνης",
	...
	"block.minecraft.short_dry_grass": "Κοντό Ξερό Γρασίδι",
	"block.minecraft.short_grass": "Κοντό Γρασίδι",
	...
	"block.minecraft.skeleton_wall_skull": "Κρανίο Τοίχου Σκελετού",
	...
	"block.minecraft.soul_wall_torch": "Πυρσός Τοίχου Ψυχών",
	"block.minecraft.spawn.not_valid": "Δεν έχεις κρεβάτι ή φορτισμένη άγκυρα αναγέννησης, ή ήταν παρεμποδισμένα",
	...
	"block.minecraft.spruce_shelf": "Ράφι Ελάτου",
	...
	"block.minecraft.stripped_pale_oak_log": "Αποφλοιωμένος Κορμός Λευκής Βελανιδιάς",
	"block.minecraft.stripped_pale_oak_wood": "Αποφλοιωμένο Ξύλο Λευκής Βελανιδιάς",
	...
	"block.minecraft.stripped_warped_hyphae": "Αποφλοιωμένες Στρεβλωμένες Υφές",
	"block.minecraft.stripped_warped_stem": "Αποφλοιωμένος Στρεβλωμένος Βλαστός",
	...
	"block.minecraft.sulfur": "Θείο",
	"block.minecraft.sulfur_brick_slab": "Πλάκα Τούβλων Θείου",
	"block.minecraft.sulfur_brick_stairs": "Σκάλες Τούβλων Θείου",
	"block.minecraft.sulfur_brick_wall": "Τοίχος Τούβλων Θείου",
	"block.minecraft.sulfur_bricks": "Τούβλα Θείου",
	"block.minecraft.sulfur_slab": "Πλάκα Θείου",
	"block.minecraft.sulfur_spike": "Καρφί Θείου",
	"block.minecraft.sulfur_stairs": "Σκάλες Θείου",
	"block.minecraft.sulfur_wall": "Τοίχος Θείου",
	...
	"block.minecraft.tall_dry_grass": "Ψηλό Ξερό Γρασίδι",
	...
	"block.minecraft.test_block": "Κύβος Δοκιμής",
	"block.minecraft.test_instance_block": "Κύβος Παρουσίας Δοκιμής",
	"block.minecraft.tinted_glass": "Φιμέ Γυαλί",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "Οι εκρήξεις TNT είναι απενεργοποιημένες",
	"block.minecraft.torch": "Πυρσός",
	"block.minecraft.torchflower": "Πύρσανθος",
	"block.minecraft.torchflower_crop": "Καλλιέργεια Πυρσάνθου",
	"block.minecraft.trapped_chest": "Σεντούκι Παγίδα",
	"block.minecraft.trial_spawner": "Γεννήτρια Δοκιμασίας",
	...
	"block.minecraft.tuff_brick_slab": "Πλάκα Τούβλων Τόφου",
	"block.minecraft.tuff_brick_stairs": "Σκάλες Τούβλων Τόφου",
	"block.minecraft.tuff_brick_wall": "Τοίχος Τούβλων Τόφου",
	"block.minecraft.tuff_bricks": "Τούβλα Τόφου",
	"block.minecraft.tuff_slab": "Πλάκα Τόφου",
	"block.minecraft.tuff_stairs": "Σκάλες Τόφου",
	"block.minecraft.tuff_wall": "Τοίχος Τόφου",
	...
	"block.minecraft.vault": "Θησαυροφυλάκιο",
	...
	"block.minecraft.warped_button": "Στρεβλωμένο Κουμπί",
	"block.minecraft.warped_door": "Στρεβλωμένη Πόρτα",
	"block.minecraft.warped_fence": "Στρεβλωμένος Φράχτης",
	"block.minecraft.warped_fence_gate": "Στρεβλωμένη Πύλη Φράχτη",
	"block.minecraft.warped_fungus": "Στρεβλωμένος Μύκητας",
	"block.minecraft.warped_hanging_sign": "Στρεβλωμένη Κρεμαστή Πινακίδα",
	"block.minecraft.warped_hyphae": "Στρεβλωμένες Υφές",
	"block.minecraft.warped_nylium": "Στρεβλωμένο Νύλιο",
	"block.minecraft.warped_planks": "Στρεβλωμένες Σανίδες",
	"block.minecraft.warped_pressure_plate": "Στρεβλωμένη Πλάκα Πίεσης",
	"block.minecraft.warped_roots": "Στρεβλωμένες Ρίζες",
	"block.minecraft.warped_shelf": "Στρεβλωμένο Ράφι",
	"block.minecraft.warped_sign": "Στρεβλωμένη Πινακίδα",
	"block.minecraft.warped_slab": "Στρεβλωμένη Πλάκα",
	"block.minecraft.warped_stairs": "Στρεβλωμένες Σκάλες",
	"block.minecraft.warped_stem": "Στρεβλωμένος Βλαστός",
	"block.minecraft.warped_trapdoor": "Στρεβλωμένη Καταπακτή",
	"block.minecraft.warped_wall_hanging_sign": "Στρεβλωμένη Κρεμαστή Πινακίδα Τοίχου",
	"block.minecraft.warped_wall_sign": "Στρεβλωμένη Πινακίδα Τοίχου",
	"block.minecraft.warped_wart_block": "Κύβος Στρεβλωμένου Στίγματος",
	"block.minecraft.water": "Νερό",
	"block.minecraft.water_cauldron": "Καζάνι Νερού",
	"block.minecraft.waxed_chiseled_copper": "Κερωμένος Λαξευμένος Χαλκός",
	"block.minecraft.waxed_copper_bars": "Κερωμένα Κάγκελα Χαλκού",
	"block.minecraft.waxed_copper_block": "Κερωμένος Κύβος Χαλκού",
	"block.minecraft.waxed_copper_bulb": "Κερωμένη Λάμπα Χαλκού",
	"block.minecraft.waxed_copper_chain": "Κερωμένη Αλυσίδα Χαλκού",
	"block.minecraft.waxed_copper_chest": "Κερωμένο Σεντούκι Χαλκού",
	"block.minecraft.waxed_copper_door": "Κερωμένη Πόρτα Χαλκού",
	"block.minecraft.waxed_copper_golem_statue": "Κερωμένο Άγαλμα Γκόλεμ Χαλκού",
	"block.minecraft.waxed_copper_grate": "Κερωμένη Σχάρα Χαλκού",
	"block.minecraft.waxed_copper_lantern": "Κερωμένο Φανάρι Χαλκού",
	"block.minecraft.waxed_copper_trapdoor": "Κερωμένη Καταπακτή Χαλκού",
	"block.minecraft.waxed_cut_copper": "Κερωμένος Κομμένος Χαλκός",
	"block.minecraft.waxed_cut_copper_slab": "Κερωμένη Πλάκα Κομμένου Χαλκού",
	"block.minecraft.waxed_cut_copper_stairs": "Κερωμένες Σκάλες Κομμένου Χαλκού",
	"block.minecraft.waxed_exposed_chiseled_copper": "Κερωμένος Εκτεθειμένος Λαξευμένος Χαλκός",
	"block.minecraft.waxed_exposed_copper": "Κερωμένος Εκτεθειμένος Χαλκός",
	"block.minecraft.waxed_exposed_copper_bars": "Κερωμένα Κάγκελα Εκτεθειμένου Χαλκού",
	"block.minecraft.waxed_exposed_copper_bulb": "Κερωμένη Λάμπα Εκτεθειμένου Χαλκού",
	"block.minecraft.waxed_exposed_copper_chain": "Κερωμένη Αλυσίδα Εκτεθειμένου Χαλκού",
	"block.minecraft.waxed_exposed_copper_chest": "Κερωμένο Σεντούκι Εκτεθειμένου Χαλκού",
	"block.minecraft.waxed_exposed_copper_door": "Κερωμένη Πόρτα Εκτεθειμένου Χαλκού",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Κερωμένο Άγαλμα Γκόλεμ Εκτεθειμένου Χαλκού",
	"block.minecraft.waxed_exposed_copper_grate": "Κερωμένη Σχάρα Εκτεθειμένου Χαλκού",
	"block.minecraft.waxed_exposed_copper_lantern": "Κερωμένο Φανάρι Εκτεθειμένου Χαλκού",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Κερωμένη Καταπακτή Εκτεθειμένου Χαλκού",
	"block.minecraft.waxed_exposed_cut_copper": "Κερωμένος Εκτεθειμένος Κομμένος Χαλκός",
	"block.minecraft.waxed_exposed_cut_copper_slab": "Κερωμένη Πλάκα Εκτεθειμένου Κομμένου Χαλκού",
	"block.minecraft.waxed_exposed_cut_copper_stairs": "Κερωμένες Σκάλες Εκτεθειμένου Κομμένου Χαλκού",
	"block.minecraft.waxed_exposed_lightning_rod": "Κερωμένο Εκτεθειμένο Αλεξικέραυνο",
	"block.minecraft.waxed_lightning_rod": "Κερωμένο Αλεξικέραυνο",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Κερωμένος Οξειδωμένος Λαξευμένος Χαλκός",
	"block.minecraft.waxed_oxidized_copper": "Κερωμένος Οξειδωμένος Χαλκός",
	"block.minecraft.waxed_oxidized_copper_bars": "Κερωμένα Κάγκελα Οξειδωμένου Χαλκού",
	"block.minecraft.waxed_oxidized_copper_bulb": "Κερωμένη Λάμπα Οξειδωμένου Χαλκού",
	"block.minecraft.waxed_oxidized_copper_chain": "Κερωμένη Αλυσίδα Οξειδωμένου Χαλκού",
	"block.minecraft.waxed_oxidized_copper_chest": "Κερωμένο Σεντούκι Οξειδωμένου Χαλκού",
	"block.minecraft.waxed_oxidized_copper_door": "Κερωμένη Πόρτα Οξειδωμένου Χαλκού",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Κερωμένο Άγαλμα Γκόλεμ Οξειδωμένου Χαλκού",
	"block.minecraft.waxed_oxidized_copper_grate": "Κερωμένη Σχάρα Οξειδωμένου Χαλκού",
	"block.minecraft.waxed_oxidized_copper_lantern": "Κερωμένο Φανάρι Οξειδωμένου Χαλκού",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Κερωμένη Καταπακτή Οξειδωμένου Χαλκού",
	"block.minecraft.waxed_oxidized_cut_copper": "Κερωμένος Οξειδωμένος Κομμένος Χαλκός",
	"block.minecraft.waxed_oxidized_cut_copper_slab": "Κερωμένη Πλάκα Οξειδωμένου Κομμένου Χαλκού",
	"block.minecraft.waxed_oxidized_cut_copper_stairs": "Κερωμένες Σκάλες Οξειδωμένου Κομμένου Χαλκού",
	"block.minecraft.waxed_oxidized_lightning_rod": "Κερωμένο Οξειδωμένο Αλεξικέραυνο",
	"block.minecraft.waxed_weathered_chiseled_copper": "Κερωμένος Φθαρμένος Λαξευμένος Χαλκός",
	"block.minecraft.waxed_weathered_copper": "Κερωμένος Φθαρμένος Χαλκός",
	"block.minecraft.waxed_weathered_copper_bars": "Κερωμένα Κάγκελα Φθαρμένου Χαλκού",
	"block.minecraft.waxed_weathered_copper_bulb": "Κερωμένη Λάμπα Φθαρμένου Χαλκού",
	"block.minecraft.waxed_weathered_copper_chain": "Κερωμένη Αλυσίδα Φθαρμένου Χαλκού",
	"block.minecraft.waxed_weathered_copper_chest": "Κερωμένο Σεντούκι Φθαρμένου Χαλκού",
	"block.minecraft.waxed_weathered_copper_door": "Κερωμένη Πόρτα Φθαρμένου Χαλκού",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Κερωμένο Άγαλμα Γκόλεμ Φθαρμένου Χαλκού",
	"block.minecraft.waxed_weathered_copper_grate": "Κερωμένη Σχάρα Φθαρμένου Χαλκού",
	"block.minecraft.waxed_weathered_copper_lantern": "Κερωμένο Φανάρι Φθαρμένου Χαλκού",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Κερωμένη Καταπακτή Φθαρμένου Χαλκού",
	"block.minecraft.waxed_weathered_cut_copper": "Κερωμένος Φθαρμένος Κομμένος Χαλκός",
	"block.minecraft.waxed_weathered_cut_copper_slab": "Κερωμένη Πλάκα Φθαρμένου Κομμένου Χαλκού",
	"block.minecraft.waxed_weathered_cut_copper_stairs": "Κερωμένες Σκάλες Φθαρμένου Κομμένου Χαλκού",
	"block.minecraft.waxed_weathered_lightning_rod": "Κερωμένο Φθαρμένο Αλεξικέραυνο",
	"block.minecraft.weathered_chiseled_copper": "Φθαρμένος Λαξευμένος Χαλκός",
	"block.minecraft.weathered_copper": "Φθαρμένος Χαλκός",
	"block.minecraft.weathered_copper_bars": "Κάγκελα Φθαρμένου Χαλκού",
	"block.minecraft.weathered_copper_bulb": "Λάμπα Φθαρμένου Χαλκού",
	"block.minecraft.weathered_copper_chain": "Αλυσίδα Φθαρμένου Χαλκού",
	"block.minecraft.weathered_copper_chest": "Σεντούκι Φθαρμένου Χαλκού",
	"block.minecraft.weathered_copper_door": "Πόρτα Φθαρμένου Χαλκού",
	"block.minecraft.weathered_copper_golem_statue": "Άγαλμα Γκόλεμ Φθαρμένου Χαλκού",
	"block.minecraft.weathered_copper_grate": "Σχάρα Φθαρμένου Χαλκού",
	"block.minecraft.weathered_copper_lantern": "Φανάρι Φθαρμένου Χαλκού",
	"block.minecraft.weathered_copper_trapdoor": "Καταπακτή Φθαρμένου Χαλκού",
	...
	"block.minecraft.weathered_lightning_rod": "Φθαρμένο Αλεξικέραυνο",
	...
	"block.minecraft.wildflowers": "Αγριολούλουδα",
	"block.minecraft.wither_rose": "Τριαντάφυλλο Ουίδερ",
	"block.minecraft.wither_skeleton_skull": "Κρανίο Σκελετού Ουίδερ",
	"block.minecraft.wither_skeleton_wall_skull": "Κρανίο Τοίχου Σκελετού Ουίδερ",
	...
	"book.edit.title": "Οθόνη Επεξεργασίας Βιβλίου",
	"book.editTitle": "Εισήγαγε Τίτλο Βιβλίου:",
	"book.finalizeButton": "Υπογραφή",
	"book.finalizeWarning": "Προσοχή! Όταν υπογράψεις το βιβλίο, δε θα είναι πλέον επεξεργάσιμο.",
	...
	"book.page_button.next": "Επόμενη Σελίδα",
	"book.page_button.previous": "Προηγούμενη Σελίδα",
	"book.sign.title": "Οθόνη Υπογραφής Βιβλίου",
	"book.sign.titlebox": "Τίτλος",
	"book.signButton": "Υπογραφή",
	"book.view.title": "Οθόνη Εμφάνισης Βιβλίου",
	"build.spawn_protection": "Η θέση %s είναι υπό προστασία τοποθεσίας γέννησης",
	"build.tooHigh": "Το όριο ύψους για χτίσιμο είναι %s",
	"build.tooLow": "Το ελάχιστο ύψος για χτίσιμο είναι %s",
	"chat.cannotSend": "Δεν μπορεί να σταλθεί το μήνυμα συνομιλίας",
	...
	"chat.disabled.chain_broken": "Η συνομιλία είναι απενεργοποιημένη λόγω σπασμένης αλυσίδας. Παρακαλώ δοκίμασε να επανασυνδεθείς.",
	"chat.disabled.expiredProfileKey": "Η συνομιλία είναι απενεργοποιημένη λόγω ληγμένου δημοσίου κλειδιού προφίλ. Παρακαλώ δοκίμασε να επανασυνδεθείς.",
	"chat.disabled.invalid_command_signature": "Η εντολή είχε μη αναμενόμενες ή απούσες υπογραφές ορίσματος εντολής.",
	"chat.disabled.invalid_signature": "Η συνομιλία είχε μια μη έγκυρη υπογραφή. Παρακαλώ δοκίμασε να επανασυνδεθείς.",
	"chat.disabled.launcher": "Η συνομιλία είναι απενεργοποιημένη από επιλογή του προγράμματος εκκίνησης. Δεν μπορεί να σταλθεί το μήνυμα.",
	"chat.disabled.missingProfileKey": "Η συνομιλία είναι απενεργοποιημένη λόγω απουσίας δημοσίου κλειδιού προφίλ. Παρακαλώ δοκίμασε να επανασυνδεθείς.",
	"chat.disabled.options": "Η συνομιλία είναι απενεργοποιημένη στις επιλογές του προγράμματος πελάτη.",
	"chat.disabled.out_of_order_chat": "Λήφθηκε συνομιλία εκτός σειράς. Άλλαξε η ώρα συστήματός σου;",
	"chat.disabled.profile": "Η συνομιλία δεν επιτρέπεται από τις ρυθμίσεις λογαριασμού. Πάτησε «%s» ξανά για περισσότερες πληροφορίες.",
	"chat.disabled.profile.moreInfo": "Η συνομιλία δεν επιτρέπεται από τις ρυθμίσεις λογαριασμού. Δεν μπορείς να στείλεις ή να δεις μηνύματα.",
	"chat.editBox": "συνομιλία",
	"chat.filtered": "Έχει φιλτραριστεί από τον διακομιστή.",
	"chat.filtered_full": "Ο διακομιστής έχει κρύψει το μήνυμά σου για ορισμένους παίκτες.",
	"chat.link.confirm": "Είσαι βέβαιος/βέβαιη ότι θέλεις να ανοίξεις τον ακόλουθο ιστότοπο;",
	"chat.link.confirmTrusted": "Θέλεις να ανοίξεις αυτόν τον σύνδεσμο ή να τον αντιγράψεις στο πρόχειρό σου;",
	"chat.link.open": "Άνοιγμα στο Πρόγραμμα Περιήγησης",
	"chat.link.warning": "Ποτέ μην ανοίγεις συνδέσμους από άτομα που δεν εμπιστεύεσαι!",
	"chat.queue": "[+%s εκκρεμής γραμμή/εκκρεμείς γραμμές]",
	"chat.queue.tooltip": "Κλικ για εμφάνιση επόμενου μηνύματος",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "Ο διακομιστής έστειλε μη έγκυρο μήνυμα.",
	...
	"chat.type.advancement.goal": "Ο παίκτης %s έχει πετύχει τον στόχο %s",
	...
	"chat.validation_error": "Σφάλμα επικύρωσης συνομιλίας",
	"chat_restriction.chat_and_commands_disabled_by_options": "Η συνομιλία είναι περιορισμένη στις ρυθμίσεις του προγράμματος πελάτη.",
	"chat_restriction.chat_disabled_by_options": "Η συνομιλία παίκτη είναι περιορισμένη στις ρυθμίσεις του προγράμματος πελάτη.",
	"chat_restriction.chat_disabled_by_options.action": "Μεταφορά στην οθόνη Ρυθμίσεων Συνομιλίας",
	"chat_restriction.disabled_by_launcher": "Η συνομιλία είναι περιορισμένη από το πρόγραμμα εκκίνησης.",
	"chat_restriction.disabled_by_profile": "Η συνομιλία είναι περιορισμένη από τις ρυθμίσεις του προφίλ.",
	"chat_restriction.disabled_by_profile.action": "Μεταφορά στις ρυθμίσεις του προφίλ σου",
	"chat_screen.commands_not_allowed": "Η αποστολή εντολών δεν επιτρέπεται",
	"chat_screen.message": "Μήνυμα για αποστολή: %s",
	"chat_screen.messages_not_allowed": "Η αποστολή μηνυμάτων συνομιλίας δεν επιτρέπεται",
	"chat_screen.restricted": "Η συνομιλία είναι περιορισμένη. Κάνε κλικ σε αυτό το μήνυμα για λεπτομέρειες.",
	"chat_screen.restricted.narration": "Η συνομιλία είναι περιορισμένη. Πήγαινε στην οθόνη Περιορισμών στις Επιλογές Κόσμου.",
	"chat_screen.title": "Οθόνη συνομιλίας",
	"chat_screen.usage": "Εισαγωγή μηνύματος και πάτημα Enter για αποστολή",
	"chunk.toast.checkLog": "Δες το αρχείο καταγραφής για περισσότερες λεπτομέρειες",
	"chunk.toast.loadFailure": "Απέτυχε η φόρτωση του τμήματος στη θέση %s",
	"chunk.toast.lowDiskSpace": "Χαμηλή χωρητικότητα δίσκου!",
	"chunk.toast.lowDiskSpace.description": "Ίσως να μην μπορείς να αποθηκεύσεις αυτόν τον κόσμο.",
	"chunk.toast.saveFailure": "Απέτυχε η αποθήκευση του τμήματος στη θέση %s",
	...
	"command.expected.separator": "Αναμενόταν κενό για να τελειώσει ένα όρισμα, αλλά βρέθηκαν ακολουθούμενα δεδομένα",
	"command.failed": "Προέκυψε ένα μη αναμενόμενο σφάλμα κατά την εκτέλεση αυτής της εντολής",
	"command.forkLimit": "Επιτεύχθηκε ο μέγιστος αριθμός περιβαλλόντων (%s)",
	"command.trailing_data": "Ακολουθούμενα δεδομένα που βρέθηκαν: %s",
	"command.unknown.argument": "Μη έγκυρο όρισμα για την εντολή",
	"command.unknown.command": "Άγνωστη ή ανολοκλήρωτη εντολή. Δες παρακάτω για το σφάλμα",
	...
	"commands.attribute.base_value.reset.success": "Η βασική τιμή για το χαρακτηριστικό %s για την οντότητα %s επαναφέρθηκε στην προεπιλεγμένη %s",
	...
	"commands.attribute.failed.modifier_already_present": "Η τροποποίηση %s υπάρχει ήδη στο χαρακτηριστικό %s για την οντότητα %s",
	"commands.attribute.failed.no_attribute": "Η οντότητα %s δεν έχει το χαρακτηριστικό %s",
	"commands.attribute.failed.no_modifier": "Το χαρακτηριστικό %s για την οντότητα %s δεν έχει την τροποποίηση %s",
	"commands.attribute.modifier.add.success": "Προστέθηκε η τροποποίηση %s στο χαρακτηριστικό %s για την οντότητα %s",
	"commands.attribute.modifier.remove.success": "Καταργήθηκε η τροποποίηση %s από το χαρακτηριστικό %s για την οντότητα %s",
	"commands.attribute.modifier.value.get.success": "Η τιμή της τροποποίησης %s στο χαρακτηριστικό %s για την οντότητα %s είναι %s",
	...
	"commands.banlist.entry.unknown": "(Άγνωστη)",
	...
	"commands.bossbar.get.players.none": "Η προσαρμοσμένη μπάρα %s δεν έχει τώρα συνδεδεμένους παίκτες",
	"commands.bossbar.get.players.some": "Η προσαρμοσμένη μπάρα %s έχει τώρα %s συνδεδεμένο παίκτη/συνδεδεμένους παίκτες: %s",
	...
	"commands.bossbar.list.bars.some": "Υπάρχει/Υπάρχουν %s ενεργή προσαρμοσμένη μπάρα/ενεργές προσαρμοσμένες μπάρες: %s",
	...
	"commands.bossbar.set.players.success.some": "Η προσαρμοσμένη μπάρα %s τώρα έχει %s παίκτη/παίκτες: %s",
	...
	"commands.clone.success": "Αντιγράφηκε/Αντιγράφηκαν %s κύβος/κύβοι με επιτυχία",
	"commands.clone.toobig": "Πάρα πολλοί κύβοι στην επιλεγμένη περιοχή (μέγιστο %s, αλλά επιλέχθηκαν %s)",
	...
	"commands.data.block.invalid": "Ο κύβος στόχος δεν είναι οντότητα κύβος",
	...
	"commands.data.modify.expected_list": "Αναμενόταν μια λίστα: λήφθηκε %s",
	"commands.data.modify.expected_object": "Αναμενόταν ένα αντικείμενο: λήφθηκε %s",
	"commands.data.modify.expected_value": "Αναμενόταν μια τιμή: λήφθηκε %s",
	"commands.data.modify.invalid_index": "Μη έγκυρο ευρετήριο λίστας: %s",
	"commands.data.modify.invalid_substring": "Μη έγκυρα ευρετήρια υποσυμβολοσειράς: %s έως %s",
	...
	"commands.datapack.create.already_exists": "Υπάρχει ήδη ένα πακέτο με το όνομα «%s»",
	"commands.datapack.create.invalid_full_name": "Μη έγκυρο όνομα νέου πακέτου «%s»",
	"commands.datapack.create.invalid_name": "Μη έγκυροι χαρακτήρες στο όνομα του νέου πακέτου «%s»",
	"commands.datapack.create.io_failure": "Δεν μπορεί να δημιουργηθεί το πακέτο με το όνομα «%s». Έλεγξε τα αρχεία",
	"commands.datapack.create.metadata_encode_failure": "Απέτυχε η κωδικοποίηση των μεταδεδομένων για το πακέτο με το όνομα «%s»: %s",
	"commands.datapack.create.success": "Δημιουργήθηκε ένα νέο κενό πακέτο με το όνομα «%s»",
	"commands.datapack.disable.failed": "Το πακέτο «%s» δεν είναι ενεργοποιημένο!",
	"commands.datapack.disable.failed.feature": "Το πακέτο «%s» δεν μπορεί να απενεργοποιηθεί, διότι είναι μέρος μιας ενεργοποιημένης σημαίας!",
	...
	"commands.datapack.list.available.success": "Υπάρχει/Υπάρχουν %s διαθέσιμο πακέτο/διαθέσιμα πακέτα δεδομένων: %s",
	"commands.datapack.list.enabled.none": "Δεν υπάρχουν ενεργοποιημένα πακέτα δεδομένων",
	"commands.datapack.list.enabled.success": "Υπάρχει/Υπάρχουν %s ενεργοποιημένο πακέτο/ενεργοποιημένα πακέτα δεδομένων: %s",
	...
	"commands.debug.function.noReturnRun": "Η ανίχνευση δεν μπορεί να χρησιμοποιηθεί με το return run",
	...
	"commands.debug.stopped": "Σταμάτησε η καταγραφή τικ μετά από %s δευτερόλεπτο/δευτερόλεπτα και %s τικ (%s τικ ανά δευτερόλεπτο)",
	...
	"commands.dialog.clear.multiple": "Εκκαθαρίστηκε το παράθυρο διαλόγου για %s παίκτες",
	"commands.dialog.clear.single": "Εκκαθαρίστηκε το παράθυρο διαλόγου για τον παίκτη %s",
	"commands.dialog.show.multiple": "Εμφανίστηκε το παράθυρο διαλόγου σε %s παίκτες",
	"commands.dialog.show.single": "Εμφανίστηκε το παράθυρο διαλόγου στον παίκτη %s",
	...
	"commands.drop.no_loot_table.block": "Ο κύβος %s δεν έχει πίνακα λαφύρων",
	...
	"commands.effect.give.failed": "Δεν ήταν δυνατή η εφαρμογή αυτής της επίδρασης (ο στόχος είναι είτε απρόσβλητος από επιδράσεις, είτε έχει κάτι δυνατότερο)",
	...
	"commands.enchant.failed": "Τίποτα δεν άλλαξε. Οι στόχοι είτε δεν έχουν κανένα αντικείμενο στα χέρια τους είτε το μάγεμα δεν μπόρεσε να εφαρμοστεί",
	...
	"commands.execute.blocks.toobig": "Πάρα πολλοί κύβοι στην επιλεγμένη περιοχή (μέγιστο %s, αλλά επιλέχθηκαν %s)",
	...
	"commands.execute.function.instantiationFailure": "Απέτυχε η εκτέλεση της εντολής %s: %s",
	...
	"commands.fetchprofile.copy_component": "Αντιγραφή Στοιχείου",
	"commands.fetchprofile.copy_text": "Αντιγραφή %s",
	"commands.fetchprofile.entity.success": "Επιλύθηκε το προφίλ για την οντότητα %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Απέτυχε η σειριοποίηση του προφίλ: %s",
	"commands.fetchprofile.give_item": "Λήψη Αντικειμένου",
	"commands.fetchprofile.id.failure": "Απέτυχε η επίλυση του προφίλ για το αναγνωριστικό %s",
	"commands.fetchprofile.id.success": "Επιλύθηκε το προφίλ για το αναγνωριστικό %s: %s",
	"commands.fetchprofile.name.failure": "Απέτυχε η επίλυση του προφίλ για το όνομα %s",
	"commands.fetchprofile.name.success": "Επιλύθηκε το προφίλ για το όνομα %s: %s",
	"commands.fetchprofile.no_profile": "Η οντότητα %s δεν έχει προφίλ",
	"commands.fetchprofile.summon_mannequin": "Εμφάνιση Μανεκέν",
	"commands.fill.failed": "Δεν τοποθετήθηκαν κύβοι",
	"commands.fill.success": "Τοποθετήθηκε/Τοποθετήθηκαν %s κύβος/κύβοι με επιτυχία",
	"commands.fill.toobig": "Πάρα πολλοί κύβοι στην επιλεγμένη περιοχή (μέγιστο %s, αλλά επιλέχθηκαν %s)",
	"commands.fillbiome.success": "Τέθηκαν τοπία μεταξύ των θέσεων %s, %s, %s και %s, %s, %s",
	"commands.fillbiome.success.count": "Τέθηκε/Τέθηκαν %s καταχώριση/καταχωρίσεις τοπίου μεταξύ των θέσεων %s, %s, %s και %s, %s, %s",
	"commands.fillbiome.toobig": "Πάρα πολλοί κύβοι στην επιλεγμένη περιοχή (μέγιστο %s, αλλά επιλέχθηκαν %s)",
	...
	"commands.forceload.toobig": "Πάρα πολλά τμήματα στην επιλεγμένη περιοχή (μέγιστο %s, αλλά επιλέχθηκαν %s)",
	"commands.function.error.argument_not_compound": "Μη έγκυρος τύπος ορίσματος: %s. Αναμενόταν Λεξικό",
	"commands.function.error.missing_argument": "Λείπει το όρισμα %[2]s στη συνάρτηση %[1]s",
	"commands.function.error.missing_arguments": "Λείπουν ορίσματα στη συνάρτηση %s",
	"commands.function.error.parse": "Κατά την εκτέλεση της μακροεντολής %s: Η εντολή «%s» προκάλεσε σφάλμα: %s",
	"commands.function.instantiationFailure": "Απέτυχε η εκτέλεση της εντολής %s: %s",
	"commands.function.result": "Η συνάρτηση %s επέστρεψε την τιμή %s",
	"commands.function.scheduled.multiple": "Εκτελούνται οι συναρτήσεις %s",
	"commands.function.scheduled.no_functions": "Δεν μπόρεσαν να βρεθούν συναρτήσεις για το όνομα %s",
	"commands.function.scheduled.single": "Εκτελείται η συνάρτηση %s",
	"commands.function.success.multiple": "Εκτελέστηκε/Εκτελέστηκαν %s εντολή/εντολές από %s συναρτήσεις",
	"commands.function.success.multiple.result": "Εκτελέστηκαν %s συναρτήσεις",
	"commands.function.success.single": "Εκτελέστηκε/Εκτελέστηκαν %s εντολή/εντολές από τη συνάρτηση «%s»",
	"commands.function.success.single.result": "Η συνάρτηση «%[2]s» επέστρεψε την τιμή %[1]s",
	"commands.gamemode.success.other": "Τέθηκε η λειτουργία παιχνιδιού του παίκτη %s σε %s",
	"commands.gamemode.success.self": "Τέθηκε η λειτουργία παιχνιδιού σου σε %s",
	...
	"commands.jfr.dump.failed": "Απέτυχε η αποθήκευση της καταγραφής JFR: %s",
	"commands.jfr.start.failed": "Απέτυχε η εκκίνηση της καταγραφής JFR",
	"commands.jfr.started": "Η καταγραφή JFR ξεκίνησε",
	"commands.jfr.stopped": "Η καταγραφή JFR σταμάτησε και αποθηκεύτηκε στη διαδρομή %s",
	"commands.kick.owner.failed": "Δεν μπορεί να αποβληθεί ο ιδιοκτήτης του διακομιστή σε παιχνίδι LAN",
	"commands.kick.singleplayer.failed": "Δεν μπορεί να γίνει αποβολή σε παιχνίδι ενός παίκτη εκτός σύνδεσης",
	...
	"commands.locate.biome.not_found": "Δεν μπόρεσε να βρεθεί τοπίο τύπου «%s» σε λογική απόσταση",
	"commands.locate.biome.success": "Το κοντινότερο τοπίο %s είναι στη θέση %s (%s κύβοι μακριά)",
	"commands.locate.poi.not_found": "Δεν μπόρεσε να βρεθεί σημείο ενδιαφέροντος τύπου «%s» σε λογική απόσταση",
	...
	"commands.locate.structure.not_found": "Δεν μπόρεσε να βρεθεί δομή τύπου «%s» κοντά",
	"commands.locate.structure.success": "Η κοντινότερη δομή %s είναι στη θέση %s (%s κύβοι μακριά)",
	"commands.message.display.incoming": "Ο παίκτης %s σου ψιθυρίζει: %s",
	"commands.message.display.outgoing": "Ψιθυρίζεις στον παίκτη %s: %s",
	...
	"commands.pardon.success": "Καταργήθηκε ο αποκλεισμός του παίκτη %s",
	...
	"commands.pardonip.success": "Καταργήθηκε ο αποκλεισμός της IP %s",
	...
	"commands.perf.started": "Ξεκίνησε εκτέλεση καταγραφής απόδοσης 10 δευτερολέπτων (χρησιμοποίησε «/perf stop» για να σταματήσεις νωρίς)",
	"commands.perf.stopped": "Σταμάτησε η καταγραφή απόδοσης μετά από %s δευτερόλεπτο/δευτερόλεπτα και %s τικ (%s τικ ανά δευτερόλεπτο)",
	...
	"commands.profile_fetch.copy_component": "Αντιγραφή Στοιχείου",
	"commands.profile_fetch.failed_to_serialize": "Απέτυχε η σειριοποίηση του προφίλ: %s",
	"commands.profile_fetch.give_item": "Λήψη Αντικειμένου",
	"commands.profile_fetch.id.failure": "Απέτυχε η επίλυση του προφίλ για το αναγνωριστικό %s",
	"commands.profile_fetch.id.success": "Επιλύθηκε το προφίλ για το αναγνωριστικό %s: %s",
	"commands.profile_fetch.name.failure": "Απέτυχε η επίλυση του προφίλ για το όνομα %s",
	"commands.profile_fetch.name.success": "Επιλύθηκε το προφίλ για το όνομα %s: %s",
	...
	"commands.random.error.range_too_large": "Το εύρος της τυχαίας τιμής πρέπει να είναι το πολύ 2147483646",
	"commands.random.error.range_too_small": "Το εύρος της τυχαίας τιμής πρέπει να είναι τουλάχιστον 2",
	"commands.random.reset.all.success": "Επαναφέρθηκε/Επαναφέρθηκαν %s τυχαία ακολουθία/τυχαίες ακολουθίες",
	"commands.random.reset.success": "Επαναφέρθηκε η τυχαία ακολουθία %s",
	"commands.random.roll": "Η οντότητα/Ο Κύβος Εντολής %s έριξε %s (από %s μέχρι %s)",
	"commands.random.sample.success": "Τυχαιοποιημένη τιμή: %s",
	"commands.recipe.give.failed": "Δεν έγινε εκμάθηση νέων συνταγών",
	"commands.recipe.give.success.multiple": "Ξεκλειδώθηκε/Ξεκλειδώθηκαν %s συνταγή/συνταγές για %s παίκτες",
	"commands.recipe.give.success.single": "Ξεκλειδώθηκε/Ξεκλειδώθηκαν %s συνταγή/συνταγές για τον παίκτη %s",
	"commands.recipe.take.failed": "Καμία συνταγή δεν μπόρεσε να ξεχαστεί",
	"commands.recipe.take.success.multiple": "Καταργήθηκε/Καταργήθηκαν %s συνταγή/συνταγές από %s παίκτες",
	"commands.recipe.take.success.single": "Καταργήθηκε/Καταργήθηκαν %s συνταγή/συνταγές από τον παίκτη %s",
	...
	"commands.rotate.success": "Περιστράφηκε η οντότητα %s",
	...
	"commands.schedule.cleared.failure": "Κανένας προγραμματισμός με αναγνωριστικό %s",
	...
	"commands.schedule.macro": "Δεν μπορεί να προγραμματιστεί μια μακροεντολή",
	...
	"commands.scoreboard.objectives.list.success": "Υπάρχει/Υπάρχουν %s στόχος/στόχοι: %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Απενεργοποιήθηκε η αυτόματη ενημέρωση εμφάνισης για τον στόχο %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Ενεργοποιήθηκε η αυτόματη ενημέρωση εμφάνισης για τον στόχο %s",
	"commands.scoreboard.objectives.modify.displayname": "Άλλαξε το εμφανιζόμενο όνομα του %s σε %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Εκκαθαρίστηκε η προεπιλεγμένη μορφή αριθμών του στόχου %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Άλλαξε η προεπιλεγμένη μορφή αριθμών του στόχου %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Εκκαθαρίστηκε το όνομα εμφάνισης για %s οντότητες στον στόχο %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Εκκαθαρίστηκε το όνομα εμφάνισης για την καταχώριση %s στον στόχο %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Άλλαξε το όνομα εμφάνισης σε %s για %s οντότητες στον στόχο %s",
	"commands.scoreboard.players.display.name.set.success.single": "Άλλαξε το όνομα εμφάνισης σε %s για την καταχώριση %s στον στόχο %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Εκκαθαρίστηκε η μορφή αριθμών για %s οντότητες στον στόχο %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Εκκαθαρίστηκε η μορφή αριθμών για την καταχώριση %s στον στόχο %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Άλλαξε η μορφή αριθμών για %s οντότητες στον στόχο %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Άλλαξε η μορφή αριθμών για την καταχώριση %s στον στόχο %s",
	...
	"commands.scoreboard.players.get.null": "Δεν μπορεί να ληφθεί η τιμή από την καταχώριση %s για το σκορ %s· καμία δεν έχει τεθεί",
	...
	"commands.scoreboard.players.list.success": "Εντοπίστηκε/Εντοπίστηκαν %s οντότητα/οντότητες: %s",
	...
	"commands.setidletimeout.success.disabled": "Το χρονικό όριο αδράνειας παικτών είναι τώρα απενεργοποιημένο",
	"commands.setworldspawn.failure.not_overworld": "Μπορεί να τεθεί τοποθεσία γέννησης μόνο στον κανονικό κόσμο",
	"commands.setworldspawn.success": "Τέθηκε το σημείο γέννησης του κόσμου στη θέση %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Τέθηκε το σημείο γέννησης του κόσμου στη θέση %s, %s, %s [%s, %s] στη διάσταση %s",
	"commands.spawnpoint.success.multiple": "Τέθηκε σημείο γέννησης στη θέση %s, %s, %s [%s] στη διάσταση %s για %s παίκτες",
	"commands.spawnpoint.success.multiple.new": "Τέθηκε το σημείο γέννησης στη θέση %s, %s, %s [%s, %s] στη διάσταση %s για %s παίκτες",
	"commands.spawnpoint.success.single": "Τέθηκε σημείο γέννησης στη θέση %s, %s, %s [%s] στη διάσταση %s για τον παίκτη %s",
	"commands.spawnpoint.success.single.new": "Τέθηκε το σημείο γέννησης στη θέση %s, %s, %s [%s, %s] στη διάσταση %s για τον παίκτη %s",
	"commands.spectate.cannot_spectate": "Η οντότητα %s δεν μπορεί να παρακολουθηθεί",
	"commands.spectate.not_spectator": "Ο παίκτης %s δεν είναι σε λειτουργία θεατή",
	"commands.spectate.self": "Δεν μπορείς να παρακολουθήσεις τον εαυτό σου",
	"commands.spectate.success.started": "Τώρα παρακολουθείς την οντότητα %s",
	"commands.spectate.success.stopped": "Δεν παρακολουθείς πλέον οντότητα",
	"commands.spreadplayers.failed.entities": "Δεν μπόρεσε να κατανεμηθεί/Δεν μπόρεσαν να κατανεμηθούν %s οντότητα/οντότητες γύρω από τη θέση %s, %s (πάρα πολλές οντότητες για τον χώρο - δοκίμασε να χρησιμοποιήσεις κατανομή το πολύ %s)",
	...
	"commands.spreadplayers.failed.teams": "Δεν μπόρεσε να κατανεμηθεί/Δεν μπόρεσαν να κατανεμηθούν %s ομάδα/ομάδες γύρω από τη θέση %s, %s (πάρα πολλές οντότητες για τον χώρο - δοκίμασε να χρησιμοποιήσεις κατανομή το πολύ %s)",
	"commands.spreadplayers.success.entities": "Κατανεμήθηκε/Κατανεμήθηκαν %s οντότητα/οντότητες γύρω από τη θέση %s, %s με μέση μεταξύ τους απόσταση %s κύβος/κύβοι",
	"commands.spreadplayers.success.teams": "Κατανεμήθηκε/Κατανεμήθηκαν %s ομάδα/ομάδες γύρω από τη θέση %s, %s με μέση μεταξύ τους απόσταση %s κύβος/κύβοι",
	"commands.stop.stopping": "Τερματισμός του διακομιστή",
	"commands.stopsound.success.source.any": "Σταμάτησαν όλοι οι ήχοι «%s»",
	"commands.stopsound.success.source.sound": "Σταμάτησε ο ήχος «%s» στην πηγή «%s»",
	"commands.stopsound.success.sourceless.any": "Σταμάτησαν όλοι οι ήχοι",
	"commands.stopsound.success.sourceless.sound": "Σταμάτησε ο ήχος «%s»",
	"commands.stopwatch.already_exists": "Το Χρονόμετρο «%s» υπάρχει ήδη",
	"commands.stopwatch.create.success": "Δημιουργήθηκε το Χρονόμετρο «%s»",
	"commands.stopwatch.does_not_exist": "Το Χρονόμετρο «%s» δεν υπάρχει",
	"commands.stopwatch.query": "Το Χρονόμετρο «%s» έχει τρέξει για %ss",
	"commands.stopwatch.remove.success": "Καταργήθηκε το Χρονόμετρο «%s»",
	"commands.stopwatch.restart.success": "Επανεκκινήθηκε το Χρονόμετρο «%s»",
	"commands.summon.failed": "Δεν ήταν δυνατή η εμφάνιση της οντότητας",
	"commands.summon.failed.peaceful": "Τα τέρατα δεν μπορούν να εμφανιστούν στην Ειρηνική δυσκολία",
	...
	"commands.swing.failed.notliving": "Δε βρέθηκαν ζωντανές οντότητες για κούνημα χεριών",
	"commands.swing.success.multiple": "Κουνήθηκαν τα χέρια %s οντοτήτων",
	"commands.swing.success.single": "Κουνήθηκε ένα χέρι της οντότητας %s",
	...
	"commands.team.empty.success": "Καταργήθηκε/Καταργήθηκαν %s μέλος/μέλη από την ομάδα %s",
	...
	"commands.team.list.members.success": "Η ομάδα %s έχει %s μέλος/μέλη: %s",
	"commands.team.list.teams.empty": "Δεν υπάρχουν ομάδες",
	"commands.team.list.teams.success": "Υπάρχει/Υπάρχουν %s ομάδα/ομάδες: %s",
	...
	"commands.team.option.color.clear.success": "Εκκαθαρίστηκε το χρώμα για την ομάδα %s",
	...
	"commands.teammsg.failed.noteam": "Πρέπει να είσαι σε ομάδα για να στείλεις μήνυμα στην ομάδα σου",
	...
	"commands.test.batch.starting": "Εκκίνηση περιβάλλοντος %s δέσμης %s",
	"commands.test.clear.error.no_tests": "Δεν μπόρεσαν να βρεθούν δοκιμές για εκκαθάριση",
	"commands.test.clear.success": "Εκκαθαρίστηκε/Εκκαθαρίστηκαν %s δομή/δομές",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Κλικ για αντιγραφή στο πρόχειρο",
	"commands.test.create.success": "Δημιουργήθηκε εγκατάσταση δοκιμής για τη δοκιμή %s",
	"commands.test.error.no_test_containing_pos": "Δεν μπορεί να βρεθεί παρουσία δοκιμής που να περιέχει τη θέση %s, %s, %s",
	"commands.test.error.no_test_instances": "Δε βρέθηκαν παρουσίες δοκιμής",
	"commands.test.error.non_existant_test": "Δε βρέθηκε η δοκιμή %s",
	"commands.test.error.structure_not_found": "Δε βρέθηκε η δομή δοκιμής %s",
	"commands.test.error.test_instance_not_found": "Δε βρέθηκε η οντότητα κύβος της παρουσίας δοκιμής",
	"commands.test.error.test_instance_not_found.position": "Δε βρέθηκε η οντότητα κύβος της παρουσίας δοκιμής για τη δοκιμή στη θέση %s, %s, %s",
	"commands.test.error.too_large": "Το μέγεθος της δομής πρέπει να είναι λιγότερο από %s κύβους κατά μήκος κάθε άξονα",
	"commands.test.locate.done": "Ολοκληρώθηκε ο εντοπισμός: βρέθηκε/βρέθηκαν %s δομή/δομές",
	"commands.test.locate.found": "Βρέθηκε η δομή στη θέση: %s (απόσταση: %s)",
	"commands.test.locate.started": "Ξεκίνησε ο εντοπισμός των δομών δοκιμής. Αυτό μπορεί να πάρει χρόνο...",
	"commands.test.no_tests": "Καμία δοκιμή για εκτέλεση",
	"commands.test.relative_position": "Θέση σε σχέση με την οντότητα %s: %s",
	"commands.test.reset.error.no_tests": "Δεν μπόρεσαν να βρεθούν δοκιμές για επαναφορά",
	"commands.test.reset.success": "Επαναφέρθηκε/Επαναφέρθηκαν %s δομή/δομές",
	"commands.test.run.no_tests": "Δε βρέθηκαν δοκιμές",
	"commands.test.run.running": "Εκτελείται/Εκτελούνται %s δοκιμή/δοκιμές...",
	"commands.test.summary": "Η Δοκιμή Παιχνιδιού ολοκληρώθηκε! %s δοκιμή εκτελέστηκε/δοκιμές εκτελέστηκαν",
	"commands.test.summary.all_required_passed": "Όλες οι απαιτούμενες δοκιμές πέρασαν :)",
	"commands.test.summary.failed": "%s απαιτούμενη δοκιμή απέτυχε/απαιτούμενες δοκιμές απέτυχαν :(",
	"commands.test.summary.optional_failed": "%s προαιρετική δοκιμή απέτυχε/προαιρετικές δοκιμές απέτυχαν",
	"commands.tick.query.percentiles": "Εκατοστημόρια: P50: %sms P95: %sms P99: %sms. Δείγμα: %s",
	"commands.tick.query.rate.running": "Ρυθμός τικ στόχος: %s ανά δευτερόλεπτο.\nΜέσος χρόνος ανά τικ: %sms (Στόχος: %sms)",
	"commands.tick.query.rate.sprinting": "Ρυθμός τικ στόχος: %s ανά δευτερόλεπτο (αγνοήθηκε, αναφορά μόνο).\nΜέσος χρόνος ανά τικ: %sms",
	"commands.tick.rate.success": "Τέθηκε ο ρυθμός τικ στόχος σε %s ανά δευτερόλεπτο",
	"commands.tick.sprint.report": "Το τρέξιμο ολοκληρώθηκε με %s τικ ανά δευτερόλεπτο, ή %s ms ανά τικ",
	"commands.tick.sprint.stop.fail": "Κανένα τρέξιμο τικ σε εξέλιξη",
	"commands.tick.sprint.stop.success": "Διακόπηκε το τρέχον τρέξιμο τικ",
	"commands.tick.status.frozen": "Το παιχνίδι είναι παγωμένο",
	"commands.tick.status.lagging": "Το παιχνίδι τρέχει, αλλά δεν μπορεί να φτάσει τον ρυθμό τικ στόχο",
	"commands.tick.status.running": "Το παιχνίδι τρέχει κανονικά",
	"commands.tick.status.sprinting": "Το παιχνίδι τρέχει γρήγορα",
	"commands.tick.step.fail": "Δεν ήταν δυνατός ο βηματισμός του παιχνιδιού - το παιχνίδι πρέπει να είναι παγωμένο πρώτα",
	"commands.tick.step.stop.fail": "Κανένα βήμα τικ σε εξέλιξη",
	"commands.tick.step.stop.success": "Διακόπηκε το τρέχον βήμα τικ",
	"commands.tick.step.success": "Βηματισμός %s τικ",
	"commands.time.no_default_clock": "Δεν υπάρχει προεπιλεγμένο ρολόι στη διάσταση %s",
	"commands.time.no_time_marker_found": "Ο δείκτης χρόνου %s δεν υπάρχει για το ρολόι %s",
	"commands.time.pause": "Έγινε παύση του ρολογιού %s",
	"commands.time.query": "Η ώρα είναι %s",
	"commands.time.query.absolute": "Το ρολόι %s είναι σε %s τικ",
	"commands.time.query.gametime": "Ο χρόνος παιχνιδιού είναι %s τικ",
	"commands.time.query.timeline": "Το χρονολόγιο %s είναι σε %s τικ",
	"commands.time.query.timeline.repetitions": "Το χρονολόγιο %s έχει περάσει %s επανάληψη/επαναλήψεις",
	"commands.time.rate": "Το ρολόι %s θα εξελίσσεται τώρα σε κανονικό ρυθμό %sx",
	"commands.time.resume": "Συνεχίστηκε το ρολόι %s",
	"commands.time.set": "Τέθηκε η ώρα σε %s",
	"commands.time.set.absolute": "Τέθηκε το ρολόι %s σε %s τικ",
	"commands.time.set.time_marker": "Τέθηκε το ρολόι %s στον δείκτη χρόνου %s",
	"commands.time.wrong_timeline_for_clock": "Το χρονολόγιο %s δεν είναι έγκυρο για το ρολόι %s",
	...
	"commands.transfer.error.no_players": "Πρέπει να επιλεχθεί τουλάχιστον ένας παίκτης για μεταφορά",
	"commands.transfer.success.multiple": "Μεταφέρονται %s παίκτες στον διακομιστή %s:%s",
	"commands.transfer.success.single": "Μεταφέρεται ο παίκτης %s στον διακομιστή %s:%s",
	"commands.trigger.add.success": "Πυροδοτήθηκε το σκορ %s (προστέθηκε %s στην τιμή)",
	"commands.trigger.failed.invalid": "Μπορείς να πυροδοτήσεις μόνο στόχους που είναι τύπου «trigger»",
	"commands.trigger.failed.unprimed": "Δεν μπορείς να πυροδοτήσεις αυτόν τον στόχο ακόμη",
	...
	"commands.waypoint.list.empty": "Κανένας δείκτης στη διάσταση %s",
	"commands.waypoint.list.success": "%s δείκτης/δείκτες στη διάσταση %s: %s",
	"commands.waypoint.modify.color": "Το χρώμα του δείκτη είναι τώρα %s",
	"commands.waypoint.modify.color.reset": "Επαναφέρθηκε το χρώμα του δείκτη",
	"commands.waypoint.modify.style": "Το στιλ του δείκτη άλλαξε",
	...
	"compliance.playtime.greaterThan24Hours": "Παίζεις για περισσότερο από 24 ώρες",
	"compliance.playtime.hours": "Παίζεις για %s ώρα/ώρες",
	"compliance.playtime.message": "Το εκτεταμένο παιχνίδι μπορεί να παρεμβαίνει στην κανονική καθημερινή ζωή",
	"component.profile.dynamic": "Δυναμικό",
	...
	"connect.failed.transfer": "Η σύνδεση απέτυχε κατά τη μεταφορά στον διακομιστή",
	...
	"connect.reconfiging": "Αναδιαμόρφωση...",
	"connect.reconfiguring": "Αναδιαμόρφωση...",
	"connect.transferring": "Μεταφορά σε νέο διακομιστή...",
	"container.barrel": "Βαρέλι",
	"container.beacon": "Φάρος",
	"container.beehive.bees": "Μέλισσες: %s / %s",
	"container.beehive.honey": "Μέλι: %s / %s",
	...
	"container.crafter": "Κατασκευαστής",
	...
	"container.upgrade.missing_template_tooltip": "Πρόσθεσε Πρότυπο Μεταλλουργίας",
	...
	"createWorld.customize.buffet.biome": "Παρακαλώ επίλεξε ένα τοπίο",
	"createWorld.customize.buffet.search": "Αναζήτηση...",
	"createWorld.customize.buffet.title": "Προσαρμογή Ενός Τοπίου",
	...
	"createWorld.customize.presets.share": "Θέλεις να κοινοποιήσεις την προκαθορισμένη σου ρύθμισή με κάποιον; Χρησιμοποίησε το παρακάτω πλαίσιο!",
	...
	"credits_and_attribution.screen.title": "Εύσημα και Απόδοση",
	"dataPack.bundle.description": "Ενεργοποιεί το πειραματικό αντικείμενο Δέμα",
	"dataPack.bundle.name": "Δέματα",
	"dataPack.locator_bar.description": "Εμφάνιση της κατεύθυνσης των άλλων παικτών στο παιχνίδι πολλαπλών παικτών",
	"dataPack.locator_bar.name": "Μπάρα Εντοπισμού",
	"dataPack.minecart_improvements.description": "Βελτιωμένη κίνηση για τα Βαγονέτα",
	"dataPack.minecart_improvements.name": "Βελτιώσεις Βαγονέτου",
	"dataPack.redstone_experiments.description": "Πειραματικές αλλαγές Ρέντστοουν",
	"dataPack.redstone_experiments.name": "Πειράματα Ρέντστοουν",
	"dataPack.title": "Επιλογή Πακέτων Δεδομένων",
	"dataPack.trade_rebalance.description": "Νέες ανταλλαγές για τους Χωρικούς",
	"dataPack.trade_rebalance.name": "Επανεξισορρόπηση Ανταλλαγών Χωρικών",
	...
	"dataPack.update_1_21.description": "Νέες λειτουργίες και περιεχόμενο για το Minecraft 1.21",
	"dataPack.update_1_21.name": "Ενημέρωση 1.21",
	"dataPack.validation.back": "Επιστροφή",
	...
	"dataPack.winter_drop.description": "Νέες λειτουργίες και περιεχόμενο για την Ενημέρωση Χειμώνα",
	"dataPack.winter_drop.name": "Ενημέρωση Χειμώνα",
	...
	"datapackFailure.title": "Σφάλματα στο τρέχον επιλεγμένο πακέτο/στα τρέχοντα επιλεγμένα πακέτα δεδομένων απέτρεψαν τη φόρτωση του κόσμου.\nΜπορείς είτε να προσπαθήσεις να τον φορτώσεις με μόνο το προεπιλεγμένο πακέτο δεδομένων («Λειτουργία Ασφαλείας»), είτε να πας πίσω στην οθόνη τίτλου και να το διορθώσεις εσύ.",
	"death.attack.anvil": "Ο παίκτης/το ον %[1]s συνθλίφτηκε από ένα αμόνι που έπεσε",
	"death.attack.anvil.player": "Ο παίκτης/το ον %[1]s συνθλίφτηκε από ένα αμόνι που έπεσε ενώ πολεμούσε τον παίκτη/το ον %[2]s",
	"death.attack.arrow": "Ο παίκτης/το ον %[1]s στοχεύτηκε από τον παίκτη/το ον %[2]s",
	"death.attack.arrow.item": "Ο παίκτης/το ον %[1]s στοχεύτηκε από τον παίκτη/το ον %[2]s με το αντικείμενο %[3]s",
	...
	"death.attack.cramming.player": "Ο παίκτης/το ον %[1]s συνθλίφτηκε από τον παίκτη/το ον %[2]s",
	"death.attack.dragonBreath": "Ο παίκτης/το ον %[1]s ψήθηκε σε αναπνοή δράκου",
	"death.attack.dragonBreath.player": "Ο παίκτης/το ον %[1]s ψήθηκε σε αναπνοή δράκου από τον παίκτη/το ον %[2]s",
	...
	"death.attack.explosion.player.item": "Ο παίκτης/το ον %[1]s ανατινάχτηκε από τον παίκτη/το ον %[2]s με το αντικείμενο %[3]s",
	...
	"death.attack.fallingBlock": "Ο παίκτης/το ον %[1]s συνθλίφτηκε από έναν κύβο που έπεσε",
	"death.attack.fallingBlock.player": "Ο παίκτης/το ον %[1]s συνθλίφτηκε από έναν κύβο που έπεσε ενώ πολεμούσε τον παίκτη/το ον %[2]s",
	...
	"death.attack.fireball.item": "Ο παίκτης/το ον %[1]s στοχεύτηκε με πύρινη μπάλα από τον παίκτη/το ον %[2]s με το αντικείμενο %[3]s",
	...
	"death.attack.genericKill": "Ο παίκτης/το ον %[1]s σκοτώθηκε",
	"death.attack.genericKill.player": "Ο παίκτης/το ον %[1]s σκοτώθηκε ενώ πολεμούσε τον παίκτη/το ον %[2]s",
	...
	"death.attack.indirectMagic.item": "Ο παίκτης/το ον %[1]s σκοτώθηκε από τον παίκτη/το ον %[2]s με το αντικείμενο %[3]s",
	...
	"death.attack.lightningBolt": "Ο παίκτης/το ον %[1]s χτυπήθηκε από κεραυνό",
	"death.attack.lightningBolt.player": "Ο παίκτης/το ον %[1]s χτυπήθηκε από κεραυνό ενώ πολεμούσε τον παίκτη/το ον %[2]s",
	"death.attack.mace_smash": "Ο παίκτης/το ον %[1]s συνθλίφτηκε από τον παίκτη/το ον %[2]s",
	"death.attack.mace_smash.item": "Ο παίκτης/το ον %[1]s συνθλίφτηκε από τον παίκτη/το ον %[2]s με το αντικείμενο %[3]s",
	...
	"death.attack.mob.item": "Ο παίκτης/το ον %[1]s φονεύθηκε από το ον %[2]s με το αντικείμενο %[3]s",
	...
	"death.attack.outsideBorder": "Ο παίκτης/το ον %[1]s βγήκε από τα σύνορα αυτού του κόσμου",
	"death.attack.outsideBorder.player": "Ο παίκτης/το ον %[1]s βγήκε από τα σύνορα αυτού του κόσμου ενώ πολεμούσε τον παίκτη/το ον %[2]s",
	"death.attack.player": "Ο παίκτης/το ον %[1]s φονεύθηκε από τον παίκτη %[2]s",
	"death.attack.player.item": "Ο παίκτης/το ον %[1]s φονεύθηκε από τον παίκτη %[2]s με το αντικείμενο %[3]s",
	...
	"death.attack.spear": "Ο παίκτης/το ον %[1]s κεντρίστηκε από τον παίκτη/το ον %[2]s",
	"death.attack.spear.item": "Ο παίκτης/το ον %[1]s κεντρίστηκε από τον παίκτη/το ον %[2]s με το αντικείμενο %[3]s",
	...
	"death.attack.sting.item": "Ο παίκτης/το ον %[1]s τσιμπήθηκε μέχρι θανάτου από τον παίκτη/το ον %[2]s με το αντικείμενο %[3]s",
	...
	"death.attack.thorns": "Ο παίκτης/το ον %[1]s σκοτώθηκε ενώ προσπαθούσε να τραυματίσει τον παίκτη/το ον %[2]s",
	"death.attack.thorns.item": "Ο παίκτης/το ον %[1]s σκοτώθηκε από το αντικείμενο %[3]s ενώ προσπαθούσε να τραυματίσει τον παίκτη/το ον %[2]s",
	"death.attack.thrown": "Ο παίκτης/το ον %[1]s γρονθοκοπήθηκε από τον παίκτη/το ον %[2]s",
	"death.attack.thrown.item": "Ο παίκτης/το ον %[1]s γρονθοκοπήθηκε από τον παίκτη/το ον %[2]s με το αντικείμενο %[3]s",
	...
	"death.attack.witherSkull.item": "Ο παίκτης/το ον %[1]s στοχεύτηκε από ένα κρανίο από τον παίκτη/το ον %[2]s με το αντικείμενο %[3]s",
	...
	"death.fell.assist.item": "Ο παίκτης/το ον %[1]s ήταν καταδικασμένος/ο να πέσει από τον παίκτη/το ον %[2]s με το αντικείμενο %[3]s",
	"death.fell.finish": "Ο παίκτης/το ον %[1]s έπεσε πολύ δυνατά και αποτελειώθηκε από τον παίκτη/το ον %[2]s",
	"death.fell.finish.item": "Ο παίκτης/το ον %[1]s έπεσε πολύ δυνατά και αποτελειώθηκε από τον παίκτη/το ον %[2]s με το αντικείμενο %[3]s",
	"death.fell.killer": "Ο παίκτης/το ον %[1]s ήταν καταδικασμένος/ο να πέσει",
	"deathScreen.quit.confirm": "Είσαι βέβαιος/βέβαιη ότι θέλεις να φύγεις;",
	"deathScreen.respawn": "Αναγέννηση",
	"deathScreen.score": "Σκορ",
	"deathScreen.score.value": "Σκορ: %s",
	...
	"debug.advanced_tooltips.help": "F3 + H = Προηγμένες υπομνήσεις",
	"debug.advanced_tooltips.off": "Προηγμένες υπομνήσεις: κρυμμένες",
	"debug.advanced_tooltips.on": "Προηγμένες υπομνήσεις: ορατές",
	...
	"debug.copy_location.help": "F3 + C = Αντιγραφή τοποθεσίας ως εντολή /tp, ή κράτημα για 10 δευτερόλεπτα για κρασάρισμα του παιχνιδιού",
	"debug.copy_location.message": "Αντιγράφηκε η τοποθεσία στο πρόχειρο",
	"debug.crash.message": "Τα πλήκτρα F3 + C είναι κρατημένα. Αυτό θα κρασάρει το παιχνίδι εκτός αν αφεθούν.",
	"debug.crash.message.rebindable": "Τα πλήκτρα %s + %s είναι κρατημένα. Αυτό θα κρασάρει το παιχνίδι εκτός αν αφεθούν.",
	...
	"debug.creative_spectator.help": "F3 + N = Αλλαγή προηγούμενης λειτουργίας παιχνιδιού <-> θεατή",
	"debug.dump_dynamic_textures": "Οι δυναμικές υφές αποθηκεύτηκαν στη διαδρομή %s",
	"debug.dump_dynamic_textures.help": "F3 + S = Αποθήκευση δυναμικών υφών",
	"debug.entry.always": "Πάντα",
	"debug.entry.currently.alwaysOn": "%s: Τώρα πάντα ενεργοποιημένη",
	"debug.entry.currently.inF3": "%s: Τώρα μόνο στο F3",
	"debug.entry.currently.inOverlay": "%s: Τώρα μόνο στο επίστρωμα επικάλυψης αποσφαλμάτωσης",
	"debug.entry.currently.never": "%s: Τώρα απενεργοποιημένη",
	"debug.entry.f3": "Στο F3",
	"debug.entry.overlay": "Στο Επίστρωμα Επικάλυψης",
	...
	"debug.inspect.client.block": "Αντιγράφηκαν τα δεδομένα κύβου από τη μεριά του προγράμματος πελάτη στο πρόχειρο",
	"debug.inspect.client.entity": "Αντιγράφηκαν τα δεδομένα οντότητας από τη μεριά του προγράμματος πελάτη στο πρόχειρο",
	...
	"debug.options.category.renderer": "Απόδοση Αποσφαλμάτωσης",
	"debug.options.category.text": "Κείμενο Οθόνης Αποσφαλμάτωσης",
	"debug.options.help": "F3 + F6 = Επεξεργασία επιλογών αποσφαλμάτωσης",
	"debug.options.notAllowed.tooltip": "Δεν είναι ορατή όταν οι πληροφορίες αποσφαλμάτωσης είναι μειωμένες",
	"debug.options.profile.default": "Προεπιλεγμένο Προφίλ",
	"debug.options.profile.performance": "Προφίλ Απόδοσης",
	"debug.options.search": "Αναζήτηση...",
	"debug.options.title": "Επιλογές Αποσφαλμάτωσης",
	"debug.options.warning": "Αυτές οι επιλογές είναι για δοκιμαστικούς σκοπούς μόνο. Μπορεί να επιβαρύνουν τον υπολογιστή σου, να κρασάρουν το παιχνίδι, ή να καλέσουν τον Herobrine.",
	...
	"debug.profiling.help": "F3 + L = Εκκίνηση/διακοπή καταγραφής",
	"debug.profiling.start": "Η καταγραφή ξεκίνησε για %s δευτερόλεπτα. Χρησιμοποίησε F3 + L για να σταματήσεις νωρίς",
	"debug.profiling.start.rebindable": "Η καταγραφή ξεκίνησε για %s δευτερόλεπτα. Χρησιμοποίησε %s + %s για να σταματήσεις νωρίς",
	"debug.profiling.stop": "Η καταγραφή τελείωσε. Τα αποτελέσματα αποθηκεύτηκαν στη διαδρομή %s",
	...
	"debug.version.header": "Πληροφορίες έκδοσης προγράμματος πελάτη:",
	"debug.version.help": "F3 + V = Πληροφορίες έκδοσης προγράμματος πελάτη",
	"demo.day.1": "Αυτή η επίδειξη θα διαρκέσει πέντε ημέρες παιχνιδιού, κάνε ό,τι μπορείς!",
	"demo.day.2": "Ημέρα Δεύτερη",
	"demo.day.3": "Ημέρα Τρίτη",
	"demo.day.4": "Ημέρα Τέταρτη",
	"demo.day.5": "Αυτή είναι η τελευταία σου ημέρα!",
	"demo.day.6": "Έχεις περάσει την πέμπτη σου ημέρα. Χρησιμοποίησε το %s για να αποθηκεύσεις ένα στιγμιότυπο οθόνης της δημιουργίας σου.",
	"demo.day.warning": "Ο χρόνος σου έχει σχεδόν τελειώσει!",
	"demo.demoExpired": "Τέλος χρόνου επίδειξης!",
	"demo.help.buy": "Αγορά Τώρα!",
	"demo.help.fullWrapped": "Αυτή η επίδειξη θα διαρκέσει 5 ημέρες στο παιχνίδι (περίπου 1 ώρα και 40 λεπτά πραγματικού χρόνου). Δες τις εξελίξεις για καθοδήγηση! Καλή διασκέδαση!",
	"demo.help.inventory": "Χρησιμοποίησε το πλήκτρο %[1]s για να ανοίξεις τα αποθέματά σου",
	"demo.help.jump": "Πήδηξε πατώντας το πλήκτρο %[1]s",
	"demo.help.later": "Συνέχεια Παιχνιδιού!",
	"demo.help.movement": "Χρησιμοποίησε τα πλήκτρα %[1]s, %[2]s, %[3]s,%[4]s και το ποντίκι για να μετακινηθείς",
	"demo.help.movementMouse": "Κοίταξε γύρω σου χρησιμοποιώντας το ποντίκι",
	"demo.help.movementShort": "Κινήσου πατώντας τα πλήκτρα %[1]s, %[2]s, %[3]s, %[4]s",
	"demo.help.title": "Λειτουργία Επίδειξης Minecraft",
	"demo.remainingTime": "Χρόνος που απομένει: %s",
	"demo.reminder": "Ο χρόνος επίδειξης έχει λήξει. Αγόρασε το παιχνίδι για να συνεχίσεις ή ξεκίνησε έναν νέο κόσμο!",
	"difficulty.lock.question": "Είσαι βέβαιος/βέβαιη ότι θέλεις να κλειδώσεις τη δυσκολία αυτού του κόσμου; Αυτό θα κλειδώσει τον κόσμο στην %[1]s, και δε θα μπορείς ποτέ να την αλλάξεις ξανά.",
	"difficulty.lock.title": "Κλείδωμα Δυσκολίας Κόσμου",
	"disconnect.endOfStream": "Τερματισμός ροής",
	"disconnect.exceeded_packet_rate": "Αποβλήθηκες για υπέρβαση του ορίου αποστολής πακέτων",
	"disconnect.genericReason": "%s",
	"disconnect.ignoring_status_request": "Παράλειψη αίτησης κατάστασης",
	"disconnect.loginFailedInfo": "Απέτυχε η σύνδεση: %s",
	"disconnect.loginFailedInfo.insufficientPrivileges": "Το Παιχνίδι Πολλαπλών Παικτών είναι απενεργοποιημένο. Παρακαλώ έλεγξε τις ρυθμίσεις του λογαριασμού σου Microsoft.",
	"disconnect.loginFailedInfo.invalidSession": "Μη έγκυρη συνεδρία (Δοκίμασε να επανεκκινήσεις το παιχνίδι και το πρόγραμμα εκκίνησης)",
	"disconnect.loginFailedInfo.serversUnavailable": "Οι διακομιστές ελέγχου ταυτότητας δεν είναι τώρα προσβάσιμοι. Παρακαλώ δοκίμασε ξανά.",
	"disconnect.loginFailedInfo.userBanned": "Είσαι αποκλεισμένος/αποκλεισμένη από το διαδικτυακό παιχνίδι",
	"disconnect.lost": "Χάθηκε η Σύνδεση",
	"disconnect.packetError": "Σφάλμα Πρωτοκόλλου Δικτύου",
	"disconnect.spam": "Αποβλήθηκες για σπαμ",
	"disconnect.timeout": "Τέλος χρονικού ορίου",
	"disconnect.transfer": "Έγινε μεταφορά σε άλλον διακομιστή",
	"disconnect.unknownHost": "Άγνωστος διακομιστής",
	"download.pack.failed": "%s από %s πακέτο απέτυχε/πακέτα απέτυχαν στη λήψη",
	"download.pack.progress.bytes": "Πρόοδος: %s (άγνωστο συνολικό μέγεθος)",
	"download.pack.progress.percent": "Πρόοδος: %s%%",
	"download.pack.title": "Λήψη πακέτου πόρων %s/%s",
	"editGamerule.default": "Προεπιλογή: %s",
	"editGamerule.inGame.button": "Επεξεργασία Κανόνων Παιχνιδιού...",
	"editGamerule.inGame.disabled.tooltip": "Η ενημέρωση κανόνων παιχνιδιού απαιτεί άδειες διαχειριστή.",
	"editGamerule.inGame.discardChanges.message": "Είσαι βέβαιος/βέβαιη ότι θέλεις να απορρίψεις τις εκκρεμείς σου αλλαγές κανόνων παιχνιδιού;",
	"editGamerule.inGame.discardChanges.title": "Αλλαγές Κανόνων Παιχνιδιού",
	"editGamerule.inGame.downloadingGamerules": "Ανάκτηση κανόνων παιχνιδιού...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Αναπνοή του Ναυτίλου",
	"effect.minecraft.conduit_power": "Δύναμη Αγωγού",
	...
	"effect.minecraft.infested": "Μόλυνση",
	...
	"effect.minecraft.oozing": "Γλιτσοροή",
	"effect.minecraft.poison": "Δηλητήριο",
	"effect.minecraft.raid_omen": "Οιωνός Επιδρομής",
	...
	"effect.minecraft.strength": "Ισχύς",
	"effect.minecraft.trial_omen": "Οιωνός Δοκιμασίας",
	"effect.minecraft.unluck": "Κακή Τύχη",
	"effect.minecraft.water_breathing": "Υποβρύχια Αναπνοή",
	"effect.minecraft.weakness": "Αδυναμία",
	"effect.minecraft.weaving": "Πλέξιμο",
	"effect.minecraft.wind_charged": "Ανεμοφορία",
	...
	"enchantment.minecraft.breach": "Παραβίαση",
	"enchantment.minecraft.channeling": "Διοχέτευση",
	"enchantment.minecraft.density": "Πυκνότητα",
	...
	"enchantment.minecraft.lunge": "Ορμή",
	...
	"enchantment.minecraft.sweeping_edge": "Σαρωτική Λεπίδα",
	...
	"enchantment.minecraft.wind_burst": "Έκρηξη Ανέμου",
	"entity.minecraft.acacia_boat": "Βάρκα Ακακίας",
	"entity.minecraft.acacia_chest_boat": "Βάρκα Ακακίας με Σεντούκι",
	"entity.minecraft.allay": "Κατευναστής",
	"entity.minecraft.area_effect_cloud": "Νέφος Επίδρασης Περιοχής",
	"entity.minecraft.armadillo": "Αρμαδίλος",
	"entity.minecraft.armor_stand": "Πάγκος Πανοπλίας",
	"entity.minecraft.arrow": "Βέλος",
	"entity.minecraft.axolotl": "Αξολότλ",
	"entity.minecraft.bamboo_chest_raft": "Σχεδία Μπαμπού με Σεντούκι",
	"entity.minecraft.bamboo_raft": "Σχεδία Μπαμπού",
	"entity.minecraft.bat": "Νυχτερίδα",
	"entity.minecraft.bee": "Μέλισσα",
	"entity.minecraft.birch_boat": "Βάρκα Σημύδας",
	"entity.minecraft.birch_chest_boat": "Βάρκα Σημύδας με Σεντούκι",
	"entity.minecraft.blaze": "Πυροστρόβιλος",
	"entity.minecraft.block_display": "Εμφάνιση Κύβου",
	"entity.minecraft.boat": "Βάρκα",
	"entity.minecraft.bogged": "Βαλτωμένος",
	"entity.minecraft.breeze": "Ανεμοστρόβιλος",
	"entity.minecraft.breeze_wind_charge": "Φορτίο Ανέμου",
	"entity.minecraft.camel": "Καμήλα",
	"entity.minecraft.camel_husk": "Μούμια Καμήλα",
	"entity.minecraft.cat": "Γάτα",
	"entity.minecraft.cave_spider": "Αράχνη Σπηλιάς",
	"entity.minecraft.cherry_boat": "Βάρκα Κερασιάς",
	"entity.minecraft.cherry_chest_boat": "Βάρκα Κερασιάς με Σεντούκι",
	...
	"entity.minecraft.copper_golem": "Γκόλεμ Χαλκού",
	"entity.minecraft.cow": "Αγελάδα",
	"entity.minecraft.creaking": "Τριξιτής",
	"entity.minecraft.creaking_transient": "Τριξιτής",
	"entity.minecraft.creeper": "Κρίπερ",
	"entity.minecraft.dark_oak_boat": "Βάρκα Σκούρας Βελανιδιάς",
	"entity.minecraft.dark_oak_chest_boat": "Βάρκα Σκούρας Βελανιδιάς με Σεντούκι",
	...
	"entity.minecraft.egg": "Αβγό σε Πτήση",
	...
	"entity.minecraft.ender_pearl": "Μαργαριτάρι Έντερ σε Πτήση",
	...
	"entity.minecraft.experience_bottle": "Μπουκάλι Μαγέματος σε Πτήση",
	...
	"entity.minecraft.firework_rocket": "Φωτοβολίδα Πυροτεχνήματος",
	...
	"entity.minecraft.jungle_boat": "Βάρκα Ζούγκλας",
	"entity.minecraft.jungle_chest_boat": "Βάρκα Ζούγκλας με Σεντούκι",
	...
	"entity.minecraft.lingering_potion": "Φίλτρο Διαρκείας",
	"entity.minecraft.llama": "Λάμα",
	"entity.minecraft.llama_spit": "Φτυσιά Λάμα",
	"entity.minecraft.magma_cube": "Γλίτσα Μάγματος",
	"entity.minecraft.mangrove_boat": "Βάρκα Μαγκροβίου",
	"entity.minecraft.mangrove_chest_boat": "Βάρκα Μαγκροβίου με Σεντούκι",
	"entity.minecraft.mannequin": "Μανεκέν",
	...
	"entity.minecraft.nautilus": "Ναυτίλος",
	"entity.minecraft.oak_boat": "Βάρκα Βελανιδιάς",
	"entity.minecraft.oak_chest_boat": "Βάρκα Βελανιδιάς με Σεντούκι",
	"entity.minecraft.ocelot": "Οσελότος",
	"entity.minecraft.ominous_item_spawner": "Γεννήτρια Δυσοίωνων Αντικειμένων",
	"entity.minecraft.painting": "Πίνακας",
	"entity.minecraft.pale_oak_boat": "Βάρκα Λευκής Βελανιδιάς",
	"entity.minecraft.pale_oak_chest_boat": "Βάρκα Λευκής Βελανιδιάς με Σεντούκι",
	"entity.minecraft.panda": "Πάντα",
	"entity.minecraft.parched": "Αφυδατωμένος",
	...
	"entity.minecraft.splash_potion": "Φίλτρο Πιτσιλιάς",
	"entity.minecraft.spruce_boat": "Βάρκα Ελάτου",
	"entity.minecraft.spruce_chest_boat": "Βάρκα Ελάτου με Σεντούκι",
	"entity.minecraft.squid": "Καλαμάρι",
	"entity.minecraft.stray": "Περιπλανώμενος",
	"entity.minecraft.strider": "Δρασκελιστής",
	"entity.minecraft.sulfur_cube": "Γλίτσα Θείου",
	"entity.minecraft.sulfur_cube.content": "Περιέχει: %s",
	...
	"entity.minecraft.wind_charge": "Φορτίο Ανέμου",
	...
	"entity.minecraft.zombie_nautilus": "Ναυτίλος Ζόμπι",
	...
	"event.minecraft.raid.defeat.full": "Επιδρομή - Ήττα",
	"event.minecraft.raid.raiders_remaining": "Επιδρομείς που Απομένουν: %s",
	"event.minecraft.raid.victory": "Νίκη",
	"event.minecraft.raid.victory.full": "Επιδρομή - Νίκη",
	"filled_map.buried_treasure": "Χάρτης Θαμμένου Θησαυρού",
	"filled_map.explorer_jungle": "Χάρτης Εξερευνητή Ζούγκλας",
	"filled_map.explorer_swamp": "Χάρτης Εξερευνητή Βάλτου",
	"filled_map.id": "Αναγνωριστικό #%s",
	"filled_map.level": "(Επίπεδο %s/%s)",
	"filled_map.locked": "Κλειδωμένος",
	"filled_map.mansion": "Χάρτης Εξερευνητή Δάσους",
	"filled_map.monument": "Χάρτης Εξερευνητή Ωκεανού",
	"filled_map.scale": "Κλίμακα 1:%s",
	"filled_map.trial_chambers": "Χάρτης Εξερευνητή Δοκιμασίας",
	"filled_map.unknown": "Άγνωστος Χάρτης",
	"filled_map.village_desert": "Χάρτης Χωριού Ερήμου",
	"filled_map.village_plains": "Χάρτης Χωριού Πεδιάδας",
	"filled_map.village_savanna": "Χάρτης Χωριού Σαβάνας",
	"filled_map.village_snowy": "Χάρτης Χιονισμένου Χωριού",
	"filled_map.village_taiga": "Χάρτης Χωριού Τάιγκας",
	...
	"gameMode.changed": "Η λειτουργία παιχνιδιού σου έχει ενημερωθεί σε %s",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Επίτρεψη Νέδερ",
	"gamerule.allowEnteringNetherUsingPortals.description": "Ελέγχει αν οι παίκτες επιτρέπεται να μπουν στο Νέδερ.",
	"gamerule.allowFireTicksAwayFromPlayer": "Καύση μακριά από παίκτες",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Ελέγχει αν η φωτιά και η λάβα πρέπει να μπορούν να καίνε μακρύτερα από 8 τμήματα μακριά από οποιονδήποτε παίκτη.",
	...
	"gamerule.category.misc": "Διάφοροι",
	...
	"gamerule.commandBlocksEnabled": "Ενεργοποίηση Κύβων Εντολής",
	"gamerule.commandModificationBlockLimit": "Όριο κύβων τροποποίησης εντολών",
	"gamerule.commandModificationBlockLimit.description": "Ο αριθμός των κύβων που μπορούν να αλλάξουν ταυτόχρονα με μία εντολή, όπως fill ή clone.",
	"gamerule.disableElytraMovementCheck": "Απενεργοποίηση ελέγχου μετακίνησης με έλυτρα",
	"gamerule.disablePlayerMovementCheck": "Απενεργοποίηση ελέγχου μετακίνησης παικτών",
	...
	"gamerule.doLimitedCrafting.description": "Αν είναι ενεργοποιημένος, οι παίκτες θα μπορούν να κατασκευάζουν μόνο ξεκλειδωμένες συνταγές.",
	...
	"gamerule.enableCommandBlocks": "Ενεργοποίηση Κύβων Εντολής",
	"gamerule.enderPearlsVanishOnDeath": "Εξαφάνιση Μαργαριταριών Έντερ σε Πτήση κατά τον θάνατο",
	"gamerule.enderPearlsVanishOnDeath.description": "Αν τα Μαργαριτάρια Έντερ πεταμένα από έναν παίκτη εξαφανίζονται όταν ο παίκτης πεθαίνει.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Οντότητες με επιβάτες μπορούν να χρησιμοποιήσουν πύλες",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Επιτρέπει στις οντότητες με επιβάτες να τηλεμεταφέρονται μέσα από Πύλες Νέδερ, Πύλες Εντ, και Πύλες Μεταφοράς Εντ.",
	...
	"gamerule.locatorBar": "Ενεργοποίηση Μπάρας Εντοπισμού παικτών",
	"gamerule.locatorBar.description": "Όταν είναι ενεργοποιημένος, μια μπάρα εμφανίζεται στην οθόνη για να δείχνει την κατεύθυνση των παικτών.",
	...
	"gamerule.maxCommandForkCount": "Όριο περιβαλλόντων εντολών",
	"gamerule.maxCommandForkCount.description": "Μέγιστος αριθμός περιβαλλόντων που μπορούν να χρησιμοποιηθούν από εντολές όπως «execute as».",
	"gamerule.maxEntityCramming": "Όριο συνωστισμού οντοτήτων",
	"gamerule.minecartMaxSpeed": "Μέγιστη ταχύτητα Βαγονέτου",
	"gamerule.minecartMaxSpeed.description": "Μέγιστη προεπιλεγμένη ταχύτητα ενός κινούμενου Βαγονέτου στη στεριά.",
	"gamerule.minecraft.elytra_movement_check": "Έλεγχος μετακίνησης με έλυτρα",
	"gamerule.minecraft.fire_spread_radius_around_player": "Ακτίνα εξάπλωσης φωτιάς",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Η ακτίνα σε κύβους γύρω από έναν παίκτη στην οποία μπορεί να εξαπλωθεί η φωτιά",
	"gamerule.minecraft.player_movement_check": "Έλεγχος μετακίνησης παικτών",
	"gamerule.minecraft.raids": "Επιδρομές",
	"gamerule.minecraft.universal_anger.description": "Τα θυμωμένα ουδέτερα όντα επιτίθενται σε οποιονδήποτε κοντινό παίκτη, όχι μόνο στον παίκτη που τα εξόργισε. Λειτουργεί καλύτερα αν ο κανόνας forgive_dead_players είναι απενεργοποιημένος.",
	...
	"gamerule.mobGriefing": "Επίτρεψη καταστροφικών ενεργειών όντων",
	"gamerule.naturalRegeneration": "Αναπλήρωση ζωής",
	"gamerule.playersNetherPortalCreativeDelay": "Καθυστέρηση Πύλης Νέδερ παίκτη σε λειτουργία δημιουργίας",
	"gamerule.playersNetherPortalCreativeDelay.description": "Χρόνος (σε τικ) που χρειάζεται ένας παίκτης σε λειτουργία δημιουργίας να σταθεί σε μια Πύλη Νέδερ πριν αλλάξει διαστάσεις.",
	"gamerule.playersNetherPortalDefaultDelay": "Καθυστέρηση Πύλης Νέδερ παίκτη εκτός λειτουργίας δημιουργίας",
	"gamerule.playersNetherPortalDefaultDelay.description": "Χρόνος (σε τικ) που χρειάζεται ένας παίκτης εκτός λειτουργίας δημιουργίας να σταθεί σε μια Πύλη Νέδερ πριν αλλάξει διαστάσεις.",
	...
	"gamerule.projectilesCanBreakBlocks": "Δυνατότητα σπασίματος κύβων από βλήματα",
	"gamerule.projectilesCanBreakBlocks.description": "Ελέγχει αν τα βλήματα πρόσκρουσης θα καταστρέψουν κύβους που μπορούν να καταστραφούν από αυτά.",
	"gamerule.pvp": "Ενεργοποίηση pvp",
	"gamerule.pvp.description": "Ελέγχει αν οι παίκτες επιτρέπεται να προκαλέσουν ζημιά σε άλλους παίκτες.",
	"gamerule.randomTickSpeed": "Ρυθμός ταχύτητας τυχαίων τικ",
	...
	"gamerule.spawnChunkRadius": "Ακτίνα τμημάτων τοποθεσίας γέννησης",
	"gamerule.spawnChunkRadius.description": "Ο αριθμός των τμημάτων που παραμένουν φορτωμένα γύρω από τη θέση γέννησης του κανονικού κόσμου.",
	"gamerule.spawnMonsters": "Γέννηση Τεράτων",
	"gamerule.spawnMonsters.description": "Ελέγχει αν τα τέρατα γεννιούνται φυσικά.",
	"gamerule.spawnRadius": "Ακτίνα τοποθεσίας αναγέννησης",
	"gamerule.spawnRadius.description": "Ελέγχει το μέγεθος της περιοχής γύρω από το σημείο γέννησης μέσα στην οποία οι παίκτες μπορούν να γεννηθούν.",
	"gamerule.spawnerBlocksEnabled": "Ενεργοποίηση Κύβων Γεννήτριας",
	"gamerule.spectatorsGenerateChunks": "Επίτρεψη δημιουργίας εδάφους από θεατές",
	"gamerule.tntExplodes": "Επίτρεψη ενεργοποίησης και έκρηξης TNT",
	...
	"generator.minecraft.debug_all_block_states": "Λειτουργία Αποσφαλμάτωσης",
	"generator.minecraft.flat": "Επίπεδος",
	"generator.minecraft.large_biomes": "Μεγάλα Τοπία",
	"generator.minecraft.normal": "Προεπιλεγμένος",
	"generator.minecraft.single_biome_surface": "Ένα Τοπίο",
	"generator.single_biome_caves": "Σπηλιές",
	"generator.single_biome_floating_islands": "Αιωρούμενα Νησιά",
	"gui.abuseReport.attestation": "Υποβάλλοντας αυτήν την αναφορά, επιβεβαιώνεις ότι οι πληροφορίες που έχεις παράσχει είναι ακριβείς και πλήρεις σύμφωνα με όσα γνωρίζεις.",
	"gui.abuseReport.comments": "Σχόλια",
	"gui.abuseReport.describe": "Η κοινοποίηση πληροφοριών θα μας βοηθήσει να λάβουμε μια καλά ενημερωμένη απόφαση.",
	"gui.abuseReport.discard.content": "Αν φύγεις, θα χάσεις αυτήν την αναφορά και τα σχόλιά σου.\nΕίσαι βέβαιος/βέβαιη ότι θέλεις να φύγεις;",
	"gui.abuseReport.discard.discard": "Έξοδος και Απόρριψη Αναφοράς",
	"gui.abuseReport.discard.draft": "Αποθήκευση ως Πρόχειρο",
	"gui.abuseReport.discard.return": "Συνέχεια Επεξεργασίας",
	"gui.abuseReport.discard.title": "Απόρριψη Αναφοράς και Σχολίων;",
	"gui.abuseReport.draft.content": "Θα ήθελες να συνεχίσεις να επεξεργάζεσαι την υπάρχουσα αναφορά ή να την απορρίψεις και να δημιουργήσεις μια νέα;",
	"gui.abuseReport.draft.discard": "Απόρριψη",
	"gui.abuseReport.draft.edit": "Συνέχεια Επεξεργασίας",
	"gui.abuseReport.draft.quittotitle.content": "Θα ήθελες να συνεχίσεις να την επεξεργάζεσαι ή να την απορρίψεις;",
	"gui.abuseReport.draft.quittotitle.title": "Έχεις μια πρόχειρη αναφορά συνομιλίας η οποία θα χαθεί αν φύγεις",
	"gui.abuseReport.draft.title": "Επεξεργασία Πρόχειρης Αναφοράς Συνομιλίας;",
	"gui.abuseReport.error.title": "Πρόβλημα Κατά την Αποστολή της Αναφοράς σου",
	"gui.abuseReport.message": "Πού παρατήρησες την κακή συμπεριφορά;\nΑυτό θα μας βοηθήσει στη διερεύνηση της υπόθεσής σου.",
	"gui.abuseReport.more_comments": "Παρακαλώ περίγραψε τι συνέβη:",
	"gui.abuseReport.name.comment_box_label": "Παρακαλώ περίγραψε γιατί θέλεις να αναφέρεις αυτό το όνομα:",
	"gui.abuseReport.name.reporting": "Αναφέρεις τον παίκτη «%s».",
	"gui.abuseReport.name.title": "Αναφορά Ακατάλληλου Ονόματος Παίκτη",
	"gui.abuseReport.observed_what": "Γιατί το αναφέρεις αυτό;",
	"gui.abuseReport.read_info": "Πληροφορίες για Αναφορές",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Δυσφήμηση",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Κάποιος καταστρέφει τη φήμη σου ή κάποιου άλλου, για παράδειγμα η κοινοποίηση ψευδών πληροφοριών με στόχο την εκμετάλλευση ή παραπλάνηση άλλων.",
	"gui.abuseReport.reason.description": "Περιγραφή:",
	"gui.abuseReport.reason.false_reporting": "Ψευδής Αναφορά",
	"gui.abuseReport.reason.generic": "Θέλω να τον/την αναφέρω",
	"gui.abuseReport.reason.generic.description": "Με έχει ενοχλήσει / έχει κάνει κάτι που δε μου αρέσει.",
	"gui.abuseReport.reason.harassment_or_bullying": "Παρενόχληση ή εκφοβισμός",
	"gui.abuseReport.reason.harassment_or_bullying.description": "Κάποιος εξευτελίζει, επιτίθεται σε, ή εκφοβίζει εσένα ή κάποιον άλλον. Αυτό περιλαμβάνει περιπτώσεις όταν κάποιος προσπαθεί επανειλημμένα να επικοινωνήσει με εσένα ή κάποιον άλλον χωρίς συναίνεση ή δημοσιοποιεί προσωπικές πληροφορίες για εσένα ή κάποιον άλλον χωρίς συναίνεση («doxing»).",
	"gui.abuseReport.reason.hate_speech": "Έκφραση μίσους",
	"gui.abuseReport.reason.hate_speech.description": "Κάποιος επιτίθεται σε εσάς ή σε άλλον παίκτη με βάση χαρακτηριστικά της ταυτότητάς του, όπως θρήσκευμα, φύλο, ή σεξουαλικότητα.",
	"gui.abuseReport.reason.imminent_harm": "Απειλή βλάβης άλλων",
	...
	"gui.abuseReport.reason.non_consensual_intimate_imagery": "Ευαίσθητες φωτογραφίες χωρίς συναίνεση",
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "Κάποιος συζητάει για, κοινοποιεί, ή αλλιώς προάγει προσωπικές και ευαίσθητες φωτογραφίες.",
	"gui.abuseReport.reason.self_harm_or_suicide": "Αυτοβλάβη ή αυτοκτονία",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Σεξουαλικά ακατάλληλη",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Αμφιέσεις που είναι γραφικές σε φύση σχετική με σεξουαλικές πράξεις, σεξουαλικά όργανα, και σεξουαλική βία.",
	...
	"gui.abuseReport.report_sent_msg": "Έχουμε λάβει την αναφορά σου με επιτυχία. Σε ευχαριστούμε!\n\nΗ ομάδα μας θα την εξετάσει το συντομότερο δυνατόν.",
	"gui.abuseReport.select_reason": "Επιλογή Κατηγορίας Αναφοράς",
	"gui.abuseReport.send": "Αποστολή Αναφοράς",
	"gui.abuseReport.send.comment_too_long": "Παρακαλώ συμπύκνωσε το σχόλιο",
	"gui.abuseReport.send.error_message": "Επιστράφηκε ένα σφάλμα κατά την αποστολή της αναφοράς σου:\n«%s»",
	"gui.abuseReport.send.generic_error": "Αντιμετωπίσαμε ένα μη αναμενόμενο σφάλμα κατά την αποστολή της αναφοράς σου.",
	"gui.abuseReport.send.http_error": "Προέκυψε ένα μη αναμενόμενο σφάλμα HTTP κατά την αποστολή της αναφοράς σου.",
	"gui.abuseReport.send.json_error": "Αντιμετωπίσαμε ακατάλληλο ωφέλιμο φορτίο κατά την αποστολή της αναφοράς σου.",
	"gui.abuseReport.send.no_reason": "Παρακαλώ επίλεξε μια κατηγορία αναφοράς",
	"gui.abuseReport.send.not_attested": "Παρακαλώ διάβασε το παραπάνω κείμενο και κάνε τικ στο πλαίσιο ελέγχου για να μπορείς να στείλεις την αναφορά",
	"gui.abuseReport.send.service_unavailable": "Δεν ήταν δυνατή η σύνδεση με την υπηρεσία Αναφοράς Κακομεταχείρισης. Παρακαλώ βεβαιώσου ότι είσαι συνδεδεμένος/συνδεδεμένη στο διαδίκτυο και δοκίμασε ξανά.",
	"gui.abuseReport.sending.title": "Αποστολή της Αναφοράς σου...",
	"gui.abuseReport.sent.title": "Η Αναφορά Στάλθηκε",
	"gui.abuseReport.skin.title": "Αναφορά Αμφίεσης Παίκτη",
	"gui.abuseReport.title": "Αναφορά Παίκτη",
	"gui.abuseReport.type.chat": "Μηνύματα Συνομιλίας",
	"gui.abuseReport.type.name": "Όνομα Παίκτη",
	"gui.abuseReport.type.skin": "Αμφίεση Παίκτη",
	"gui.acknowledge": "Αποδοχή",
	"gui.advancements": "Εξελίξεις",
	"gui.all": "Όλα",
	"gui.back": "Πίσω",
	"gui.banned.description": "%s\n\n%s\n\nΜάθε περισσότερα στον ακόλουθο σύνδεσμο: %s",
	"gui.banned.description.permanent": "Ο λογαριασμός σου είναι οριστικά αποκλεισμένος, που σημαίνει ότι δεν μπορείς να παίξεις διαδικτυακά ή να συνδεθείς σε Realm.",
	"gui.banned.description.reason": "Πρόσφατα λάβαμε μια αναφορά για κακή συμπεριφορά από τον λογαριασμό σου. Οι επόπτες μας έχουν τώρα ερευνήσει την υπόθεσή σου και αναγνωρίσει αυτήν ως %s, που αντιτίθεται στα Πρότυπα Κοινότητας Minecraft.",
	"gui.banned.description.reason_id": "Κωδικός: %s",
	"gui.banned.description.reason_id_message": "Κωδικός: %s - %s",
	"gui.banned.description.temporary": "%s Μέχρι τότε, δεν μπορείς να παίξεις διαδικτυακά ή να συνδεθείς σε Realm.",
	"gui.banned.description.temporary.duration": "Ο λογαριασμός σου είναι προσωρινά σε αναστολή και θα ενεργοποιηθεί ξανά σε %s.",
	"gui.banned.description.unknownreason": "Πρόσφατα λάβαμε μια αναφορά για κακή συμπεριφορά από τον λογαριασμό σου. Οι επόπτες μας έχουν τώρα ερευνήσει την υπόθεσή σου και αναγνωρίσει ότι αυτή αντιτίθεται στα Πρότυπα Κοινότητας Minecraft.",
	"gui.banned.name.description": "Το τρέχον σου όνομα - «%s» - παραβιάζει τα Πρότυπα Κοινότητάς μας. Μπορείς να παίξεις παιχνίδι ενός παίκτη, αλλά θα χρειαστεί να αλλάξεις το όνομά σου για να παίξεις διαδικτυακά.\n\nΜάθε περισσότερα ή υπόβαλε μια εξέταση υπόθεσης στον ακόλουθο σύνδεσμο: %s",
	"gui.banned.name.title": "Το Όνομα Δεν Επιτρέπεται στο Παιχνίδι Πολλαπλών Παικτών",
	...
	"gui.banned.skin.description": "Η τρέχουσά σου αμφίεση παραβιάζει τα Πρότυπα Κοινότητάς μας. Μπορείς ακόμη να παίξεις με μια προεπιλεγμένη αμφίεση, ή να επιλέξεις μια νέα.\n\nΜάθε περισσότερα ή υπόβαλε μια εξέταση υπόθεσης στον ακόλουθο σύνδεσμο: %s",
	"gui.banned.skin.title": "Η Αμφίεση Δεν Επιτρέπεται",
	"gui.banned.title.permanent": "Λογαριασμός Οριστικά Αποκλεισμένος",
	"gui.banned.title.temporary": "Λογαριασμός Προσωρινά σε Αναστολή",
	"gui.cancel": "Ακύρωση",
	...
	"gui.chatReport.discard.content": "Αν φύγεις, θα χάσεις αυτήν την αναφορά και τα σχόλιά σου.\nΕίσαι βέβαιος/βέβαιη ότι θέλεις να φύγεις;",
	"gui.chatReport.discard.discard": "Έξοδος και Απόρριψη Αναφοράς",
	...
	"gui.chatReport.draft.content": "Θα ήθελες να συνεχίσεις να επεξεργάζεσαι την υπάρχουσα αναφορά ή να την απορρίψεις και να δημιουργήσεις μια νέα;",
	"gui.chatReport.draft.discard": "Απόρριψη",
	"gui.chatReport.draft.edit": "Συνέχεια Επεξεργασίας",
	"gui.chatReport.draft.quittotitle.content": "Θα ήθελες να συνεχίσεις να την επεξεργάζεσαι ή να την απορρίψεις;",
	"gui.chatReport.draft.quittotitle.title": "Έχεις μια πρόχειρη αναφορά συνομιλίας η οποία θα χαθεί αν φύγεις",
	"gui.chatReport.draft.title": "Επεξεργασία Πρόχειρης Αναφοράς Συνομιλίας;",
	"gui.chatReport.more_comments": "Παρακαλώ περίγραψε τι συνέβη:",
	"gui.chatReport.observed_what": "Γιατί το αναφέρεις αυτό;",
	"gui.chatReport.read_info": "Πληροφορίες για Αναφορές",
	"gui.chatReport.report_sent_msg": "Έχουμε λάβει την αναφορά σου με επιτυχία. Σε ευχαριστούμε!\n\nΗ ομάδα μας θα την εξετάσει το συντομότερο δυνατόν.",
	...
	"gui.chatReport.selected_chat": "%s Μήνυμα/Μηνύματα Συνομιλίας Επιλεγμένο/Επιλεγμένα για Αναφορά",
	"gui.chatReport.send": "Αποστολή Αναφοράς",
	"gui.chatReport.send.comments_too_long": "Παρακαλώ συμπύκνωσε το σχόλιο",
	"gui.chatReport.send.no_reason": "Παρακαλώ επίλεξε μια κατηγορία αναφοράς",
	"gui.chatReport.send.no_reported_messages": "Παρακαλώ επίλεξε τουλάχιστον ένα μήνυμα συνομιλίας για αναφορά",
	"gui.chatReport.send.too_many_messages": "Προσπάθεια συμπερίληψης πάρα πολλών μηνυμάτων στην αναφορά",
	"gui.chatReport.title": "Αναφορά Συνομιλίας Παίκτη",
	...
	"gui.chatSelection.fold": "%s κρυμμένο μήνυμα/κρυμμένα μηνύματα",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.join": "Ο παίκτης %s συνδέθηκε στη συνομιλία",
	"gui.chatSelection.message.narrate": "Ο παίκτης %s είπε: %s %s",
	"gui.chatSelection.selected": "%s/%s επιλεγμένο μήνυμα/επιλεγμένα μηνύματα",
	"gui.chatSelection.title": "Επιλογή Μηνυμάτων Συνομιλίας για Αναφορά",
	"gui.continue": "Συνέχεια",
	"gui.copy_link_to_clipboard": "Αντιγραφή Συνδέσμου στο Πρόχειρο",
	"gui.days": "%s ημέρα/ημέρες",
	"gui.done": "Τέλος",
	"gui.down": "Κάτω",
	"gui.entity_tooltip.type": "Τύπος: %s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "Απορρίφθηκαν %s αρχεία",
	"gui.fileDropFailure.title": "Απέτυχε η προσθήκη των αρχείων",
	"gui.friends.accept": "Αποδοχή",
	"gui.friends.button.loading": "Περίμενε...",
	...
	"gui.friends.cancel_request": "Ακύρωση αιτήματος",
	"gui.friends.confirm_title": "Επιβεβαίωση",
	"gui.friends.confirm_unfriend": "Are you sure you want to remove this player from your Friends List?",
	"gui.friends.copy_to_clipboard": "Αντιγραφή στο Πρόχειρο",
	"gui.friends.decline": "Απόρριψη",
	...
	"gui.friends.empty_state.link": "Λογαριασμός Microsoft",
	"gui.friends.enter_nickname": "Εισήγαγε Όνομα Προφίλ",
	...
	"gui.friends.join": "Σύνδεση",
	"gui.friends.loading_friends": "Φόρτωση Λίστας Φίλων...",
	"gui.friends.loading_requests": "Φόρτωση αιτημάτων...",
	"gui.friends.manage_account_footer": "Manage online safety with your %s",
	"gui.friends.multiplayer.invite": "Πρόσκληση",
	"gui.friends.multiplayer.invite_accept": "Αποδοχή",
	"gui.friends.multiplayer.invite_reject": "Απόρριψη",
	"gui.friends.multiplayer.join_request": "Ask to join",
	"gui.friends.multiplayer.join_request_accept": "Αποδοχή",
	"gui.friends.multiplayer.join_request_reject": "Απόρριψη",
	"gui.friends.my_profile_name": "Το όνομα προφίλ μου: ",
	...
	"gui.friends.open": "Φίλοι",
	"gui.friends.open.narration": "Λίστα Φίλων",
	"gui.friends.open.tooltip": "Φίλοι",
	"gui.friends.pending.empty": "No pending friend requests",
	"gui.friends.pending.received": "Received",
	"gui.friends.pending.sent": "Sent",
	"gui.friends.presence.status.offline": "Εκτός Σύνδεσης",
	"gui.friends.presence.status.online": "Σε Σύνδεση",
	"gui.friends.presence.status.playing_hosted_server": "Σε Σύνδεση (Κόσμος)",
	"gui.friends.presence.status.playing_offline": "Σε Σύνδεση (Κόσμος)",
	"gui.friends.presence.status.playing_realms": "Σε Σύνδεση (Realm)",
	"gui.friends.presence.status.playing_server": "Σε Σύνδεση (Διακομιστής)",
	"gui.friends.requests_count": "Αιτήματα (%s)",
	"gui.friends.send_request": "Αποστολή αιτήματος φιλίας",
	"gui.friends.tab_friends": "Φίλοι",
	...
	"gui.friends.toast.requests_accepted_multiple.message": "%s φίλοι δέχτηκαν τα αιτήματά σου φιλίας",
	"gui.friends.toast.requests_received_multiple.message": "Έχεις λάβει %s αιτήματα φιλίας",
	"gui.friends.unfriend": "Remove Friend",
	"gui.game_rule.search": "Αναζήτηση...",
	"gui.hours": "%s ώρα/ώρες",
	"gui.language.search": "Αναζήτηση...",
	"gui.loadingMinecraft": "Φόρτωση του Minecraft",
	...
	"gui.none": "Κανένα",
	"gui.ok": "Εντάξει",
	"gui.open_report_dir": "Άνοιγμα Καταλόγου Αναφορών",
	"gui.packSelection.search": "Αναζήτηση...",
	...
	"gui.recipebook.next_page": "Επόμενη Σελίδα",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Προηγούμενη Σελίδα",
	...
	"gui.remove": "Κατάργηση",
	"gui.report_to_server": "Αναφορά Στον Διακομιστή",
	"gui.selectWorld.search": "Αναζήτηση...",
	...
	"gui.socialInteractions.search_empty": "Δεν μπόρεσαν να βρεθούν παίκτες με αυτό το όνομα",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Αυτός ο παίκτης δεν μπορεί να αναφερθεί επειδή η συνομιλία είναι απενεργοποιημένη ή αποκλεισμένη",
	...
	"gui.stats.none_found": "Δε βρέθηκαν στατιστικά.",
	"gui.toMenu": "Πίσω στη Λίστα Διακομιστών",
	"gui.toRealms": "Πίσω στη Λίστα Realm",
	"gui.toTitle": "Πίσω στην Οθόνη Τίτλου",
	"gui.toWorld": "Πίσω στη Λίστα Κόσμων",
	"gui.togglable_slot": "Κλικ για απενεργοποίηση υποδοχής",
	"gui.up": "Πάνω",
	"gui.waitingForResponse.button.inactive": "Πίσω (%ss)",
	"gui.waitingForResponse.title": "Αναμονή Διακομιστή",
	"gui.yes": "Ναι",
	...
	"inventory.hotbarInfo": "Αποθήκευσε την μπάρα αντικειμένων με %[1]s + %[2]s",
	...
	"item.canUse.unknown": "Άγνωστο",
	"item.color": "Χρώμα: %s",
	"item.components": "%s στοιχείο/στοιχεία",
	"item.disabled": "Απενεργοποιημένο αντικείμενο",
	"item.durability": "Ανθεκτικότητα: %s / %s",
	"item.dyed": "Βαμμένο",
	"item.intangible": "Άυλο",
	...
	"item.minecraft.angler_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Ψαρά",
	"item.minecraft.apple": "Μήλο",
	"item.minecraft.archer_pottery_shard": "Θραύσμα Αγγειοπλαστικής Τοξότη",
	"item.minecraft.archer_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Τοξότη",
	"item.minecraft.armadillo_scute": "Φολίδα Αρμαδίλου",
	"item.minecraft.armadillo_spawn_egg": "Αβγό Γέννησης Αρμαδίλου",
	...
	"item.minecraft.arms_up_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Ανυψωμένων Χεριών",
	...
	"item.minecraft.black_bundle": "Μαύρο Δέμα",
	"item.minecraft.black_dye": "Μαύρη Βαφή",
	"item.minecraft.black_harness": "Μαύρη Σαγή",
	"item.minecraft.blade_pottery_shard": "Θραύσμα Αγγειοπλαστικής Λεπίδας",
	"item.minecraft.blade_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Λεπίδας",
	...
	"item.minecraft.blue_bundle": "Μπλε Δέμα",
	"item.minecraft.blue_dye": "Μπλε Βαφή",
	"item.minecraft.blue_egg": "Μπλε Αβγό",
	"item.minecraft.blue_harness": "Μπλε Σαγή",
	"item.minecraft.bogged_spawn_egg": "Αβγό Γέννησης Βαλτωμένου",
	"item.minecraft.bolt_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Κοχλία",
	"item.minecraft.bone": "Οστό",
	"item.minecraft.bone_meal": "Οστεάλευρο",
	"item.minecraft.book": "Βιβλίο",
	"item.minecraft.bordure_indented_banner_pattern": "Σχέδιο Λάβαρου Οδοντωτής Περιμετρικής Λωρίδας",
	"item.minecraft.bow": "Τόξο",
	"item.minecraft.bowl": "Μπολ",
	"item.minecraft.bread": "Ψωμί",
	"item.minecraft.breeze_rod": "Ράβδος Ανεμοστρόβιλου",
	"item.minecraft.breeze_spawn_egg": "Αβγό Γέννησης Ανεμοστρόβιλου",
	"item.minecraft.brewer_pottery_shard": "Θραύσμα Αγγειοπλαστικής Παρασκευαστή",
	"item.minecraft.brewer_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Παρασκευαστή",
	"item.minecraft.brewing_stand": "Πάγκος Παρασκευής",
	"item.minecraft.brick": "Τούβλο",
	"item.minecraft.brown_bundle": "Καφέ Δέμα",
	"item.minecraft.brown_dye": "Καφέ Βαφή",
	"item.minecraft.brown_egg": "Καφέ Αβγό",
	"item.minecraft.brown_harness": "Καφέ Σαγή",
	"item.minecraft.brush": "Ξεσκονιστήρι",
	"item.minecraft.bucket": "Κουβάς",
	"item.minecraft.bundle": "Δέμα",
	"item.minecraft.bundle.empty": "Άδειο",
	"item.minecraft.bundle.empty.description": "Μπορεί να κρατήσει έναν μικτό συνδυασμό αντικειμένων",
	"item.minecraft.bundle.full": "Γεμάτο",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "Θραύσμα Αγγειοπλαστικής Φωτιάς",
	"item.minecraft.burn_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Φωτιάς",
	"item.minecraft.camel_husk_spawn_egg": "Αβγό Γέννησης Μούμιας Καμήλας",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Ακτής",
	...
	"item.minecraft.copper_axe": "Χάλκινο Τσεκούρι",
	"item.minecraft.copper_boots": "Χάλκινες Μπότες",
	"item.minecraft.copper_chestplate": "Χάλκινος Θώρακας",
	"item.minecraft.copper_golem_spawn_egg": "Αβγό Γέννησης Γκόλεμ Χαλκού",
	"item.minecraft.copper_helmet": "Χάλκινο Κράνος",
	"item.minecraft.copper_hoe": "Χάλκινη Τσάπα",
	"item.minecraft.copper_horse_armor": "Χάλκινη Πανοπλία Αλόγου",
	"item.minecraft.copper_ingot": "Ράβδος Χαλκού",
	"item.minecraft.copper_leggings": "Χάλκινες Περικνημίδες",
	"item.minecraft.copper_nautilus_armor": "Χάλκινη Πανοπλία Ναυτίλου",
	"item.minecraft.copper_nugget": "Σβώλος Χαλκού",
	"item.minecraft.copper_pickaxe": "Χάλκινη Αξίνα",
	"item.minecraft.copper_shovel": "Χάλκινο Φτυάρι",
	"item.minecraft.copper_spear": "Χάλκινο Δόρυ",
	"item.minecraft.copper_sword": "Χάλκινο Σπαθί",
	"item.minecraft.cow_spawn_egg": "Αβγό Γέννησης Αγελάδας",
	"item.minecraft.creaking_spawn_egg": "Αβγό Γέννησης Τριξιτή",
	"item.minecraft.creeper_banner_pattern": "Σχέδιο Λάβαρου",
	"item.minecraft.creeper_banner_pattern.desc": "Σήμα Κρίπερ",
	"item.minecraft.creeper_banner_pattern.new": "Σχέδιο Λάβαρου Σήματος Κρίπερ",
	...
	"item.minecraft.crossbow.projectile.multiple": "Βλήμα: %s x %s",
	"item.minecraft.crossbow.projectile.single": "Βλήμα: %s",
	"item.minecraft.cyan_bundle": "Κυανό Δέμα",
	"item.minecraft.cyan_dye": "Κυανή Βαφή",
	"item.minecraft.cyan_harness": "Κυανή Σαγή",
	"item.minecraft.danger_pottery_shard": "Θραύσμα Αγγειοπλαστικής Κινδύνου",
	"item.minecraft.danger_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Κινδύνου",
	...
	"item.minecraft.diamond_nautilus_armor": "Διαμαντένια Πανοπλία Ναυτίλου",
	"item.minecraft.diamond_pickaxe": "Διαμαντένια Αξίνα",
	"item.minecraft.diamond_shovel": "Διαμαντένιο Φτυάρι",
	"item.minecraft.diamond_spear": "Διαμαντένιο Δόρυ",
	...
	"item.minecraft.dragon_breath": "Αναπνοή Δράκου",
	"item.minecraft.dried_kelp": "Αποξηραμένο Φύκι",
	"item.minecraft.drowned_spawn_egg": "Αβγό Γέννησης Πνιγμένου",
	"item.minecraft.dune_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Αμμόλοφου",
	...
	"item.minecraft.explorer_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Εξερευνητή",
	"item.minecraft.eye_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Ματιού",
	"item.minecraft.feather": "Φτερό",
	"item.minecraft.fermented_spider_eye": "Ζυμωμένο Μάτι Αράχνης",
	"item.minecraft.field_masoned_banner_pattern": "Σχέδιο Λάβαρου Φόντου Τούβλων",
	"item.minecraft.filled_map": "Χάρτης",
	"item.minecraft.fire_charge": "Φορτίο Φωτιάς",
	"item.minecraft.firework_rocket": "Φωτοβολίδα Πυροτεχνήματος",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Ροής",
	"item.minecraft.flow_banner_pattern": "Σχέδιο Λάβαρου",
	"item.minecraft.flow_banner_pattern.desc": "Ροή",
	"item.minecraft.flow_banner_pattern.new": "Σχέδιο Λάβαρου Ροής",
	"item.minecraft.flow_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Ροής",
	"item.minecraft.flower_banner_pattern": "Σχέδιο Λάβαρου",
	"item.minecraft.flower_banner_pattern.desc": "Σήμα Άνθους",
	"item.minecraft.flower_banner_pattern.new": "Σχέδιο Λάβαρου Σήματος Άνθους",
	...
	"item.minecraft.friend_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Φίλου",
	...
	"item.minecraft.globe_banner_pattern.new": "Σχέδιο Λάβαρου Υδρογείου",
	...
	"item.minecraft.golden_nautilus_armor": "Χρυσή Πανοπλία Ναυτίλου",
	"item.minecraft.golden_pickaxe": "Χρυσή Αξίνα",
	"item.minecraft.golden_shovel": "Χρυσό Φτυάρι",
	"item.minecraft.golden_spear": "Χρυσό Δόρυ",
	"item.minecraft.golden_sword": "Χρυσό Σπαθί",
	"item.minecraft.gray_bundle": "Γκρίζο Δέμα",
	"item.minecraft.gray_dye": "Γκρίζα Βαφή",
	"item.minecraft.gray_harness": "Γκρίζα Σαγή",
	"item.minecraft.green_bundle": "Πράσινο Δέμα",
	"item.minecraft.green_dye": "Πράσινη Βαφή",
	"item.minecraft.green_harness": "Πράσινη Σαγή",
	"item.minecraft.guardian_spawn_egg": "Αβγό Γέννησης Προστάτη",
	"item.minecraft.gunpowder": "Πυρίτιδα",
	"item.minecraft.guster_banner_pattern": "Σχέδιο Λάβαρου",
	"item.minecraft.guster_banner_pattern.desc": "Ριπή",
	"item.minecraft.guster_banner_pattern.new": "Σχέδιο Λάβαρου Ριπής",
	"item.minecraft.guster_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Ριπής",
	"item.minecraft.happy_ghast_spawn_egg": "Αβγό Γέννησης Ευτυχισμένου Γκαστ",
	"item.minecraft.harness": "Σαγή",
	"item.minecraft.heart_of_the_sea": "Καρδιά της Θάλασσας",
	"item.minecraft.heart_pottery_shard": "Θραύσμα Αγγειοπλαστικής Καρδιάς",
	"item.minecraft.heart_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Καρδιάς",
	"item.minecraft.heartbreak_pottery_shard": "Θραύσμα Αγγειοπλαστικής Σπαραγμού",
	"item.minecraft.heartbreak_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Σπαραγμού",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.host_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Οικοδεσπότη",
	"item.minecraft.howl_pottery_shard": "Θραύσμα Αγγειοπλαστικής Ουρλιαχτού",
	"item.minecraft.howl_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Ουρλιαχτού",
	"item.minecraft.husk_spawn_egg": "Αβγό Γέννησης Μούμιας",
	...
	"item.minecraft.iron_nautilus_armor": "Σιδερένια Πανοπλία Ναυτίλου",
	...
	"item.minecraft.iron_spear": "Σιδερένιο Δόρυ",
	...
	"item.minecraft.light_blue_bundle": "Γαλάζιο Δέμα",
	"item.minecraft.light_blue_dye": "Γαλάζια Βαφή",
	"item.minecraft.light_blue_harness": "Ανοιχτή Μπλε Σαγή",
	"item.minecraft.light_gray_bundle": "Ανοιχτό Γκρίζο Δέμα",
	"item.minecraft.light_gray_dye": "Ανοιχτή Γκρίζα Βαφή",
	"item.minecraft.light_gray_harness": "Ανοιχτή Γκρίζα Σαγή",
	"item.minecraft.lime_bundle": "Λαχανί Δέμα",
	"item.minecraft.lime_dye": "Λαχανί Βαφή",
	"item.minecraft.lime_harness": "Λαχανί Σαγή",
	...
	"item.minecraft.lingering_potion.effect.infested": "Φίλτρο Διαρκείας Μόλυνσης",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Φίλτρο Διαρκείας Γλιτσοροής",
	...
	"item.minecraft.lingering_potion.effect.strength": "Φίλτρο Διαρκείας Ισχύος",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Φίλτρο Διαρκείας Πλεξίματος",
	"item.minecraft.lingering_potion.effect.wind_charged": "Φίλτρο Διαρκείας Ανεμοφορίας",
	"item.minecraft.llama_spawn_egg": "Αβγό Γέννησης Λάμα",
	"item.minecraft.lodestone_compass": "Μαγνητισμένη Πυξίδα",
	"item.minecraft.mace": "Απελατίκι",
	"item.minecraft.magenta_bundle": "Φούξια Δέμα",
	"item.minecraft.magenta_dye": "Φούξια Βαφή",
	"item.minecraft.magenta_harness": "Φούξια Σαγή",
	"item.minecraft.magma_cream": "Κρέμα Μάγματος",
	"item.minecraft.magma_cube_spawn_egg": "Αβγό Γέννησης Γλίτσας Μάγματος",
	...
	"item.minecraft.miner_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Μεταλλωρύχου",
	"item.minecraft.mojang_banner_pattern": "Σχέδιο Λάβαρου",
	"item.minecraft.mojang_banner_pattern.desc": "Πράγμα",
	"item.minecraft.mojang_banner_pattern.new": "Σχέδιο Λάβαρου Πράγματος",
	...
	"item.minecraft.mourner_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Πενθόντος",
	...
	"item.minecraft.music_disc_bounce": "Μουσικός Δίσκος",
	...
	"item.minecraft.music_disc_creator": "Μουσικός Δίσκος",
	"item.minecraft.music_disc_creator.desc": "Λένα Ρέιν - Creator",
	"item.minecraft.music_disc_creator_music_box": "Μουσικός Δίσκος",
	"item.minecraft.music_disc_creator_music_box.desc": "Λένα Ρέιν - Creator (Μουσικό Κουτί)",
	"item.minecraft.music_disc_far": "Μουσικός Δίσκος",
	"item.minecraft.music_disc_far.desc": "C418 - far",
	"item.minecraft.music_disc_lava_chicken": "Μουσικός Δίσκος",
	...
	"item.minecraft.music_disc_precipice": "Μουσικός Δίσκος",
	"item.minecraft.music_disc_precipice.desc": "Άαρον Σέροφ - Precipice",
	"item.minecraft.music_disc_relic": "Μουσικός Δίσκος",
	"item.minecraft.music_disc_relic.desc": "Άαρον Σέροφ - Relic",
	"item.minecraft.music_disc_stal": "Μουσικός Δίσκος",
	"item.minecraft.music_disc_stal.desc": "C418 - stal",
	"item.minecraft.music_disc_strad": "Μουσικός Δίσκος",
	"item.minecraft.music_disc_strad.desc": "C418 - strad",
	"item.minecraft.music_disc_tears": "Μουσικός Δίσκος",
	"item.minecraft.music_disc_tears.desc": "Έιμος Ρόντι - Tears",
	...
	"item.minecraft.nautilus_shell": "Κέλυφος Ναυτίλου",
	"item.minecraft.nautilus_spawn_egg": "Αβγό Γέννησης Ναυτίλου",
	...
	"item.minecraft.netherite_horse_armor": "Πανοπλία Αλόγου Νεδερίτη",
	"item.minecraft.netherite_ingot": "Ράβδος Νεδερίτη",
	"item.minecraft.netherite_leggings": "Περικνημίδες Νεδερίτη",
	"item.minecraft.netherite_nautilus_armor": "Πανοπλία Ναυτίλου Νεδερίτη",
	...
	"item.minecraft.netherite_spear": "Δόρυ Νεδερίτη",
	"item.minecraft.netherite_sword": "Σπαθί Νεδερίτη",
	"item.minecraft.netherite_upgrade_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Αναβάθμιση Νεδερίτη",
	...
	"item.minecraft.ominous_bottle": "Δυσοίωνο Μπουκάλι",
	"item.minecraft.ominous_trial_key": "Κλειδί Δυσοίωνης Δοκιμασίας",
	"item.minecraft.orange_bundle": "Πορτοκαλί Δέμα",
	"item.minecraft.orange_dye": "Πορτοκαλί Βαφή",
	"item.minecraft.orange_harness": "Πορτοκαλί Σαγή",
	"item.minecraft.painting": "Πίνακας",
	"item.minecraft.pale_oak_boat": "Βάρκα Λευκής Βελανιδιάς",
	"item.minecraft.pale_oak_chest_boat": "Βάρκα Λευκής Βελανιδιάς με Σεντούκι",
	"item.minecraft.panda_spawn_egg": "Αβγό Γέννησης Πάντα",
	"item.minecraft.paper": "Χαρτί",
	"item.minecraft.parched_spawn_egg": "Αβγό Γέννησης Αφυδατωμένου",
	...
	"item.minecraft.piglin_banner_pattern.new": "Σχέδιο Λάβαρου Μουσούδας",
	...
	"item.minecraft.pink_bundle": "Ροζ Δέμα",
	"item.minecraft.pink_dye": "Ροζ Βαφή",
	"item.minecraft.pink_harness": "Ροζ Σαγή",
	...
	"item.minecraft.plenty_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Αφθονίας",
	...
	"item.minecraft.potion.effect.infested": "Φίλτρο Μόλυνσης",
	...
	"item.minecraft.potion.effect.oozing": "Φίλτρο Γλιτσοροής",
	...
	"item.minecraft.potion.effect.strength": "Φίλτρο Ισχύος",
	...
	"item.minecraft.potion.effect.weaving": "Φίλτρο Πλεξίματος",
	"item.minecraft.potion.effect.wind_charged": "Φίλτρο Ανεμοφορίας",
	"item.minecraft.pottery_shard_archer": "Θραύσμα Αγγειοπλαστικής Τοξότη",
	"item.minecraft.pottery_shard_arms_up": "Θραύσμα Αγγειοπλαστικής Ανυψωμένων Χεριών",
	"item.minecraft.pottery_shard_prize": "Θραύσμα Αγγειοπλαστικής Βραβείου",
	"item.minecraft.pottery_shard_skull": "Θραύσμα Αγγειοπλαστικής Κρανίου",
	...
	"item.minecraft.prize_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Βραβείου",
	...
	"item.minecraft.purple_bundle": "Μοβ Δέμα",
	"item.minecraft.purple_dye": "Μοβ Βαφή",
	"item.minecraft.purple_harness": "Μοβ Σαγή",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Εκτροφέα",
	...
	"item.minecraft.red_bundle": "Κόκκινο Δέμα",
	"item.minecraft.red_dye": "Κόκκινη Βαφή",
	"item.minecraft.red_harness": "Κόκκινη Σαγή",
	"item.minecraft.redstone": "Σκόνη Ρέντστοουν",
	"item.minecraft.resin_brick": "Τούβλο Ρητίνης",
	"item.minecraft.resin_clump": "Συστάδα Ρητίνης",
	"item.minecraft.rib_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Σκελετού",
	...
	"item.minecraft.scrape_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Ξυσίματος",
	"item.minecraft.scute": "Φολίδα",
	"item.minecraft.sentry_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Φρουρού",
	"item.minecraft.shaper_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Διαμορφωτή",
	"item.minecraft.sheaf_pottery_shard": "Θραύσμα Αγγειοπλαστικής Δεματιού",
	"item.minecraft.sheaf_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Δεματιού",
	...
	"item.minecraft.shelter_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Καταφυγίου",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Ησυχίας",
	...
	"item.minecraft.skull_banner_pattern.new": "Σχέδιο Λάβαρου Σήματος Κρανίου",
	"item.minecraft.skull_pottery_shard": "Θραύσμα Αγγειοπλαστικής Κρανίου",
	"item.minecraft.skull_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Κρανίου",
	...
	"item.minecraft.smithing_template.armor_trim.additions_slot_description": "Πρόσθεσε ράβδο ή κρύσταλλο",
	"item.minecraft.smithing_template.armor_trim.applies_to": "Πανοπλία",
	"item.minecraft.smithing_template.armor_trim.base_slot_description": "Πρόσθεσε κομμάτι πανοπλίας",
	...
	"item.minecraft.smithing_template.netherite_upgrade.additions_slot_description": "Πρόσθεσε Ράβδο Νεδερίτη",
	"item.minecraft.smithing_template.netherite_upgrade.applies_to": "Διαμαντένιος Εξοπλισμός",
	"item.minecraft.smithing_template.netherite_upgrade.base_slot_description": "Πρόσθεσε διαμαντένια πανοπλία, όπλο, ή εργαλείο",
	...
	"item.minecraft.snort_pottery_sherd": "Θραύσμα Αγγειοπλαστικής Όσφρησης",
	"item.minecraft.snout_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Μουσούδας",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Κορυφής",
	...
	"item.minecraft.splash_potion.effect.infested": "Φίλτρο Πιτσιλιάς Μόλυνσης",
	...
	"item.minecraft.splash_potion.effect.oozing": "Φίλτρο Πιτσιλιάς Γλιτσοροής",
	...
	"item.minecraft.splash_potion.effect.strength": "Φίλτρο Πιτσιλιάς Ισχύος",
	...
	"item.minecraft.splash_potion.effect.weaving": "Φίλτρο Πιτσιλιάς Πλεξίματος",
	"item.minecraft.splash_potion.effect.wind_charged": "Φίλτρο Πιτσιλιάς Ανεμοφορίας",
	...
	"item.minecraft.stone_spear": "Πέτρινο Δόρυ",
	...
	"item.minecraft.sulfur_cube_bucket": "Κουβάς με Γλίτσα Θείου",
	"item.minecraft.sulfur_cube_spawn_egg": "Αβγό Γέννησης Γλίτσας Θείου",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Παλίρροιας",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Βέλος Μόλυνσης",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Βέλος Γλιτσοροής",
	...
	"item.minecraft.tipped_arrow.effect.strength": "Βέλος Ισχύος",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Βέλος Πλεξίματος",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Βέλος Ανεμοφορίας",
	"item.minecraft.tnt_minecart": "Βαγονέτο με TNT",
	"item.minecraft.torchflower_seeds": "Σπόροι Πυρσάνθου",
	"item.minecraft.totem_of_undying": "Τοτέμ της Αθανασίας",
	"item.minecraft.trader_llama_spawn_egg": "Αβγό Γέννησης Λάμα Εμπόρου",
	"item.minecraft.trial_key": "Κλειδί Δοκιμασίας",
	...
	"item.minecraft.turtle_helmet": "Κέλυφος Χελώνας",
	"item.minecraft.turtle_scute": "Φολίδα Χελώνας",
	"item.minecraft.turtle_spawn_egg": "Αβγό Γέννησης Χελώνας",
	"item.minecraft.vex_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Διαταράκτη",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Φύλακα",
	"item.minecraft.warden_spawn_egg": "Αβγό Γέννησης Φύλακα",
	"item.minecraft.warped_fungus_on_a_stick": "Στρεβλωμένος Μύκητας σε Ξυλάκι",
	"item.minecraft.water_bucket": "Κουβάς Νερού",
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Οδηγού",
	"item.minecraft.wheat": "Σιτάρι",
	"item.minecraft.wheat_seeds": "Σπόροι Σιταριού",
	"item.minecraft.white_bundle": "Λευκό Δέμα",
	"item.minecraft.white_dye": "Λευκή Βαφή",
	"item.minecraft.white_harness": "Λευκή Σαγή",
	"item.minecraft.wild_armor_trim_smithing_template": "Πρότυπο Μεταλλουργίας",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Επένδυση Πανοπλίας Ζούγκλας",
	"item.minecraft.wind_charge": "Φορτίο Ανέμου",
	...
	"item.minecraft.wolf_armor": "Πανοπλία Λύκου",
	...
	"item.minecraft.wooden_spear": "Ξύλινο Δόρυ",
	...
	"item.modifiers.any": "Όταν φοριέται:",
	"item.modifiers.armor": "Όταν φοριέται:",
	"item.modifiers.body": "Όταν φοριέται:",
	"item.modifiers.chest": "Όταν Είναι στο Σώμα:",
	"item.modifiers.feet": "Όταν είναι στις Πατούσες:",
	"item.modifiers.hand": "Όταν κρατείται:",
	...
	"item.modifiers.offhand": "Όταν είναι στο Δευτερεύον Χέρι:",
	"item.modifiers.saddle": "Όταν φοριέται:",
	"item.nbt_tags": "NBT: %s ετικέτα/ετικέτες",
	"item.op_block_warning.line1": "Προσοχή:",
	"item.op_block_warning.line2": "Η χρήση αυτού του αντικειμένου μπορεί να οδηγήσει σε εκτέλεση εντολής.",
	"item.op_block_warning.line3": "Μην κάνεις χρήση εκτός αν γνωρίζεις τα ακριβή περιεχόμενα!",
	"item.spawn_egg.peaceful": "Απενεργοποιημένο στην Ειρηνική",
	...
	"item_modifier.unknown": "Άγνωστη τροποποίηση αντικειμένου: %s",
	...
	"jigsaw_block.placement_priority": "Προτεραιότητα Τοποθέτησης:",
	"jigsaw_block.placement_priority.tooltip": "Όταν αυτός ο κύβος Παζλ συνδέεται σε ένα κομμάτι, αυτή είναι η σειρά με την οποία αυτό το κομμάτι υφίσταται επεξεργασία για συνδέσεις στην ευρύτερη δομή.\n\nΤα κομμάτια θα υποστούν επεξεργασία σε φθίνουσα προτεραιότητα με τη σειρά εισαγωγής να σπάει δεσμούς.",
	"jigsaw_block.pool": "Σύνολο Στόχου:",
	"jigsaw_block.selection_priority": "Προτεραιότητα Επιλογής:",
	"jigsaw_block.selection_priority.tooltip": "Όταν το γονικό κομμάτι υφίσταται επεξεργασία για συνδέσεις, αυτή είναι η σειρά με την οποία αυτός ο κύβος Παζλ προσπαθεί να συνδεθεί με το κομμάτι στόχο του.\n\nΤα Παζλ θα υποστούν επεξεργασία σε φθίνουσα προτεραιότητα με την τυχαία διάταξη να σπάει δεσμούς.",
	"jigsaw_block.target": "Όνομα Στόχου:",
	"jukebox_song.minecraft.11": "C418 - 11",
	"jukebox_song.minecraft.13": "C418 - 13",
	"jukebox_song.minecraft.5": "Σάμουελ Όμπεργκ - 5",
	...
	"jukebox_song.minecraft.creator": "Λένα Ρέιν - Creator",
	"jukebox_song.minecraft.creator_music_box": "Λένα Ρέιν - Creator (Μουσικό Κουτί)",
	...
	"jukebox_song.minecraft.otherside": "Λένα Ρέιν - otherside",
	"jukebox_song.minecraft.pigstep": "Λένα Ρέιν - Pigstep",
	"jukebox_song.minecraft.precipice": "Άαρον Σέροφ - Precipice",
	"jukebox_song.minecraft.relic": "Άαρον Σέροφ - Relic",
	"jukebox_song.minecraft.stal": "C418 - stal",
	"jukebox_song.minecraft.strad": "C418 - strad",
	"jukebox_song.minecraft.tears": "Έιμος Ρόντι - Tears",
	...
	"key.categories.spectator": "Λειτουργία Θεατή",
	"key.categories.ui": "Διεπαφή Παιχνιδιού",
	"key.category.minecraft.creative": "Λειτουργία Δημιουργίας",
	"key.category.minecraft.debug": "Αποσφαλμάτωση",
	"key.category.minecraft.gameplay": "Παιχνίδι",
	"key.category.minecraft.inventory": "Αποθέματα",
	"key.category.minecraft.misc": "Διάφορα",
	"key.category.minecraft.movement": "Κίνηση",
	"key.category.minecraft.multiplayer": "Παιχνίδι Πολλαπλών Παικτών",
	"key.category.minecraft.spectator": "Λειτουργία Θεατή",
	"key.chat": "Άνοιγμα Συνομιλίας",
	"key.command": "Άνοιγμα Εντολής",
	"key.debug.clearChat": "Εκκαθάριση Συνομιλίας",
	"key.debug.copyLocation": "Αντιγραφή Τοποθεσίας",
	"key.debug.copyRecreateCommand": "Αντιγραφή Δεδομένων",
	"key.debug.crash": "Κρασάρισμα Αποσφαλμάτωσης",
	"key.debug.debugOptions": "Επιλογές Αποσφαλμάτωσης",
	"key.debug.dumpDynamicTextures": "Αποθήκευση Δυναμικών Υφών",
	"key.debug.dumpVersion": "Αποθήκευση Πληροφοριών Έκδοσης",
	"key.debug.focusPause": "Αλλαγή Παύσης Χαμένης Εστίασης",
	"key.debug.fpsCharts": "Διαγράμματα FPS",
	"key.debug.lightmapTexture": "Υφή Lightmap",
	"key.debug.modifier": "Πλήκτρο Τροποποίησης Αποσφαλμάτωσης",
	"key.debug.networkCharts": "Διαγράμματα Δικτύου",
	"key.debug.overlay": "Αλλαγή Επιστρώματος Επικάλυψης",
	"key.debug.profiling": "Εκκίνηση/Διακοπή Καταγραφής",
	"key.debug.profilingChart": "Διάγραμμα Καταγραφής",
	"key.debug.reloadChunk": "Επαναφόρτωση Τμημάτων",
	"key.debug.reloadResourcePacks": "Επαναφόρτωση Πακέτων Πόρων",
	"key.debug.showAdvancedTooltips": "Εμφάνιση Προηγμένων Υπομνήσεων",
	"key.debug.showChunkBorders": "Εμφάνιση Ορίων Τμημάτων",
	"key.debug.showHitboxes": "Εμφάνιση Πλαισίων Οντότητας",
	"key.debug.spectate": "Αλλαγή Λειτουργίας Θεατή",
	"key.debug.switchGameMode": "Αλλαγή Λειτουργίας Παιχνιδιού",
	"key.drop": "Ρίψη Επιλεγμένου Αντικειμένου",
	"key.forward": "Βάδισμα Μπροστά",
	"key.friends": "Οθόνη Φίλων",
	...
	"key.quickActions": "Γρήγορες Ενέργειες",
	...
	"key.spectatorHotbar": "Επιλογή Στην Μπάρα Αντικειμένων",
	"key.spectatorOutlines": "Εμφάνιση Παικτών",
	"key.sprint": "Τρέξιμο",
	"key.swapOffhand": "Αλλαγή Αντικειμένου με Δευτερεύον Χέρι",
	"key.toggleGui": "Αλλαγή GUI",
	"key.togglePerspective": "Αλλαγή Κάμερας",
	"key.toggleSpectatorShaderEffects": "Αλλαγή Εφέ Σκιάστρου Οθόνης Θεατή",
	"key.use": "Χρήση Αντικειμένου/Τοποθέτηση Κύβου",
	"known_server_link.announcements": "Ανακοινώσεις",
	"known_server_link.community": "Κοινότητα",
	"known_server_link.community_guidelines": "Οδηγίες Κοινότητας",
	"known_server_link.feedback": "Σχόλια",
	"known_server_link.forums": "Συζητήσεις",
	"known_server_link.news": "Ειδήσεις",
	"known_server_link.report_bug": "Αναφορά Σφάλματος Διακομιστή",
	"known_server_link.status": "Κατάσταση",
	"known_server_link.support": "Υποστήριξη",
	"known_server_link.website": "Ιστότοπος",
	"lanServer.otherPlayers": "Ρυθμίσεις για Άλλους Παίκτες",
	"lanServer.port": "Αριθμός Θύρας",
	"lanServer.port.invalid": "Άφησε το πλαίσιο επεξεργασίας κενό ή εισήγαγε έναν αριθμό μεταξύ 1024 και 65535.",
	"lanServer.port.invalid.new": "Μη έγκυρη θύρα.\nΆφησε το πλαίσιο επεξεργασίας κενό ή εισήγαγε έναν αριθμό μεταξύ %s και %s.",
	"lanServer.port.unavailable": "Η θύρα δεν είναι διαθέσιμη.\nΆφησε το πλαίσιο επεξεργασίας κενό ή εισήγαγε έναν διαφορετικό αριθμό μεταξύ 1024 και 65535.",
	"lanServer.port.unavailable.new": "Η θύρα δεν είναι διαθέσιμη.\nΆφησε το πλαίσιο επεξεργασίας κενό ή εισήγαγε έναν διαφορετικό αριθμό μεταξύ %s και %s.",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Προσθήκη Διακομιστή",
	"manageServer.edit.title": "Επεξεργασία Πληροφοριών Διακομιστή",
	"manageServer.enterIp": "Διεύθυνση Διακομιστή",
	"manageServer.enterName": "Όνομα Διακομιστή",
	"manageServer.resourcePack": "Πακέτα Πόρων Διακομιστή",
	"manageServer.resourcePack.disabled": "Απενεργοποιημένο",
	"manageServer.resourcePack.enabled": "Ενεργοποιημένο",
	"manageServer.resourcePack.prompt": "Με Υπόδειξη",
	"mco.account.privacy.info": "Διάβασε περισσότερα για τη Mojang και τους νόμους περί απορρήτου",
	"mco.account.privacy.info.button": "Διάβασε περισσότερα για τον ΓΚΠΔ",
	"mco.account.privacy.information": "Η Mojang εφαρμόζει ορισμένες διαδικασίες για να συμβάλλει στην προστασία των παιδιών και του απορρήτου τους συμπεριλαμβανομένης της συμμόρφωσης με τον Νόμο για την Προστασία του Απορρήτου των Παιδιών στο Διαδίκτυο (ΝΠΑΠΔ) και τον Γενικό Κανονισμό για την Προστασία των Δεδομένων (ΓΚΠΔ).\n\nΜπορεί να χρειαστεί να λάβεις γονική συναίνεση πριν αποκτήσεις πρόσβαση στον λογαριασμό σου Realms.",
	"mco.account.privacyinfo": "Η Mojang εφαρμόζει ορισμένες διαδικασίες για να συμβάλλει στην προστασία των παιδιών και του απορρήτου τους συμπεριλαμβανομένης της συμμόρφωσης με τον Νόμο για την Προστασία του Απορρήτου των Παιδιών στο Διαδίκτυο (ΝΠΑΠΔ) και τον Γενικό Κανονισμό για την Προστασία των Δεδομένων (ΓΚΠΔ).\n\nΜπορεί να χρειαστεί να λάβεις γονική συναίνεση πριν αποκτήσεις πρόσβαση στον λογαριασμό σου Realms.\n\nΑν έχεις έναν παλιότερο λογαριασμό Minecraft (συνδέεσαι με το όνομα χρήστη σου), θα πρέπει να μετεγκαταστήσεις τον λογαριασμό σε έναν λογαριασμό Mojang προκειμένου να έχεις πρόσβαση στα Realms.",
	"mco.account.update": "Ενημέρωση λογαριασμού",
	"mco.activity.noactivity": "Καμία δραστηριότητα για την τελευταία/τις τελευταίες %s ημέρα/ημέρες",
	...
	"mco.backup.entry": "Αντίγραφο Ασφαλείας (%s)",
	"mco.backup.entry.description": "Περιγραφή",
	"mco.backup.entry.enabledPack": "Ενεργοποιημένο Πακέτο/Ενεργοποιημένα Πακέτα",
	"mco.backup.entry.gameDifficulty": "Δυσκολία Παιχνιδιού",
	"mco.backup.entry.gameMode": "Λειτουργία Παιχνιδιού",
	"mco.backup.entry.gameServerVersion": "Έκδοση Διακομιστή Παιχνιδιού",
	"mco.backup.entry.name": "Όνομα",
	"mco.backup.entry.seed": "Seed",
	"mco.backup.entry.templateName": "Όνομα Προτύπου",
	"mco.backup.entry.undefined": "Αόριστη Αλλαγή",
	"mco.backup.entry.uploaded": "Ανεβασμένο",
	"mco.backup.entry.worldType": "Τύπος Κόσμου",
	"mco.backup.entry.worldType.adventureMap": "Κόσμος Περιπέτεια",
	"mco.backup.entry.worldType.experience": "Εμπειρία",
	"mco.backup.entry.worldType.inspiration": "Έμπνευση",
	"mco.backup.entry.worldType.minigame": "Μίνι-Παιχνίδι",
	"mco.backup.entry.worldType.normal": "Κανονικός",
	"mco.backup.entry.worldType.unknown": "Άγνωστος",
	"mco.backup.generate.world": "Δημιουργία κόσμου",
	"mco.backup.info.title": "Αλλαγές από το Τελευταίο Αντίγραφο Ασφαλείας",
	"mco.backup.narration": "Αντίγραφο ασφαλείας από %s",
	"mco.backup.nobackups": "Αυτό το Realm δεν έχει αντίγραφα ασφαλείας τώρα.",
	"mco.backup.restoring": "Επαναφορά του Realm σου",
	"mco.backup.unknown": "ΑΓΝΩΣΤΟ",
	"mco.brokenworld.download": "Λήψη",
	"mco.brokenworld.downloaded": "Κατεβασμένος",
	"mco.brokenworld.message.line1": "Παρακαλώ κάνε επαναφορά ή επίλεξε άλλον κόσμο.",
	"mco.brokenworld.message.line2": "Μπορείς επίσης να επιλέξεις να κατεβάσεις τον κόσμο στο παιχνίδι ενός παίκτη.",
	"mco.brokenworld.minigame.title": "Αυτό το μίνι-παιχνίδι δεν υποστηρίζεται πλέον",
	"mco.brokenworld.nonowner.error": "Παρακαλώ περίμενε ο ιδιοκτήτης του Realm να επαναφέρει τον κόσμο",
	...
	"mco.brokenworld.title": "Ο τρέχων σου κόσμος δεν υποστηρίζεται πλέον",
	"mco.client.incompatible.msg.line1": "Το πρόγραμμα πελάτη σου δεν είναι συμβατό με τα Realms.",
	"mco.client.incompatible.msg.line2": "Παρακαλώ χρησιμοποίησε την πιο πρόσφατη έκδοση του Minecraft.",
	"mco.client.incompatible.msg.line3": "Τα Realms δεν είναι συμβατά με εκδόσεις στιγμιότυπα.",
	"mco.client.incompatible.title": "Μη συμβατό πρόγραμμα πελάτη!",
	"mco.client.outdated.stable.version": "Η έκδοσή του προγράμματος πελάτη σου (%s) δεν είναι συμβατή με τα Realms.\n\nΠαρακαλώ χρησιμοποίησε την πιο πρόσφατη έκδοση του Minecraft.",
	"mco.client.unsupported.snapshot.version": "Η έκδοσή του προγράμματος πελάτη σου (%s) δεν είναι συμβατή με τα Realms.\n\nΤα Realms δεν είναι διαθέσιμα για αυτήν την έκδοση στιγμιότυπο.",
	"mco.compatibility.downgrade": "Υποβάθμιση",
	"mco.compatibility.downgrade.description": "Αυτός ο κόσμος παίχτηκε τελευταία φορά στην έκδοση %s· είσαι στην έκδοση %s. Η υποβάθμιση ενός κόσμου μπορεί να προκαλέσει αλλοίωση - δεν μπορούμε να εγγυηθούμε ότι θα φορτώσει ή θα λειτουργήσει.\n\nΈνα αντίγραφο ασφαλείας το κόσμου σου θα αποθηκευτεί στον φάκελο «World Backups». Παρακαλώ επανάφερε τον κόσμο σου αν χρειαστεί.",
	"mco.compatibility.incompatible.popup.title": "Μη συμβατή έκδοση",
	"mco.compatibility.incompatible.releaseType.popup.message": "Ο κόσμος στον οποίον προσπαθείς να συνδεθείς είναι μη συμβατός με την έκδοση στην οποία είσαι.",
	"mco.compatibility.incompatible.series.popup.message": "Αυτός ο κόσμος παίχτηκε τελευταία φορά στην έκδοση %s· είσαι στην έκδοση %s.\n\nΑυτές οι σειρές δεν είναι συμβατές μεταξύ τους. Χρειάζεται ένας νέος κόσμος για να παίξεις σε αυτήν την έκδοση.",
	"mco.compatibility.unverifiable.message": "Η έκδοση στην οποία αυτός ο κόσμος παίχτηκε τελευταία φορά δεν μπόρεσε να επαληθευτεί. Αν ο κόσμος αναβαθμιστεί ή υποβαθμιστεί, ένα αντίγραφο ασφαλείας θα δημιουργηθεί και θα αποθηκευτεί αυτόματα στον φάκελο «World Backups».",
	"mco.compatibility.unverifiable.title": "Η συμβατότητα δεν είναι επαληθεύσιμη",
	"mco.compatibility.upgrade": "Αναβάθμιση",
	"mco.compatibility.upgrade.description": "Αυτός ο κόσμος παίχτηκε τελευταία φορά στην έκδοση %s· είσαι στην έκδοση %s.\n\nΈνα αντίγραφο ασφαλείας το κόσμου σου θα αποθηκευτεί στον φάκελο «World backups».\n\nΠαρακαλώ επανάφερε τον κόσμο σου αν χρειαστεί.",
	"mco.compatibility.upgrade.friend.description": "Αυτός ο κόσμος παίχτηκε τελευταία φορά στην έκδοση %s· είσαι στην έκδοση %s.\n\nΈνα αντίγραφο ασφαλείας του κόσμου θα αποθηκευτεί στον φάκελο «World backups».\n\nΟ ιδιοκτήτης του Realm μπορεί να επαναφέρει τον κόσμο αν χρειαστεί.",
	"mco.compatibility.upgrade.title": "Είσαι βέβαιος/βέβαιη ότι θέλεις να αναβαθμίσεις αυτόν τον κόσμο;",
	...
	"mco.configure.world.backup": "Αντίγραφα Ασφαλείας Κόσμου",
	"mco.configure.world.buttons.activity": "Δραστηριότητα παίκτη",
	"mco.configure.world.buttons.close": "Προσωρινό Κλείσιμο Realm",
	...
	"mco.configure.world.buttons.newworld": "Νέος Κόσμος",
	"mco.configure.world.buttons.open": "Επανάνοιγμα Realm",
	"mco.configure.world.buttons.options": "Επιλογές Κόσμου",
	"mco.configure.world.buttons.players": "Παίκτες",
	"mco.configure.world.buttons.region_preference": "Επιλογή Περιοχής...",
	"mco.configure.world.buttons.resetworld": "Επαναφορά Κόσμου",
	"mco.configure.world.buttons.save": "Αποθήκευση",
	"mco.configure.world.buttons.settings": "Ρυθμίσεις",
	"mco.configure.world.buttons.subscription": "Συνδρομή",
	"mco.configure.world.buttons.switchminigame": "Αλλαγή Μίνι-Παιχνιδιού",
	"mco.configure.world.close.question.line1": "Μπορείς προσωρινά να κλείσεις το Realm σου, αποτρέποντας το παιχνίδι ενώ κάνεις προσαρμογές. Άνοιξέ το ξανά όταν είσαι έτοιμος/έτοιμη. \n\nΑυτό δεν ακυρώνει τη Συνδρομή σου Realms.",
	"mco.configure.world.close.question.line2": "Είσαι βέβαιος/βέβαιη ότι θέλεις να συνεχίσεις;",
	"mco.configure.world.close.question.title": "Πρέπει να κάνεις αλλαγές χωρίς αναστάτωση;",
	"mco.configure.world.closing": "Προσωρινό κλείσιμο του Realm...",
	"mco.configure.world.commandBlocks": "Κύβοι Εντολής",
	"mco.configure.world.delete.button": "Διαγραφή Realm",
	"mco.configure.world.delete.question.line1": "Το Realm σου θα διαγραφεί οριστικά",
	"mco.configure.world.delete.question.line2": "Είσαι βέβαιος/βέβαιη ότι θέλεις να συνεχίσεις;",
	"mco.configure.world.description": "Περιγραφή Realm",
	"mco.configure.world.edit.slot.name": "Όνομα Κόσμου",
	"mco.configure.world.edit.subscreen.adventuremap": "Ορισμένες ρυθμίσεις είναι απενεργοποιημένες διότι ο τρέχων σου κόσμος είναι περιπέτεια",
	"mco.configure.world.edit.subscreen.experience": "Ορισμένες ρυθμίσεις είναι απενεργοποιημένες διότι ο τρέχων σου κόσμος είναι εμπειρία",
	"mco.configure.world.edit.subscreen.inspiration": "Ορισμένες ρυθμίσεις είναι απενεργοποιημένες διότι ο τρέχων σου κόσμος είναι έμπνευση",
	"mco.configure.world.forceGameMode": "Επιβολή Λειτουργίας Παιχνιδιού",
	"mco.configure.world.invite.narration": "Έχεις %s νέα πρόσκληση/νέες προσκλήσεις",
	"mco.configure.world.invite.profile.name": "Όνομα",
	"mco.configure.world.invited": "Προσκεκλημένοι",
	"mco.configure.world.invited.number": "Προσκεκλημένοι (%s)",
	...
	"mco.configure.world.leave.question.line1": "Αν φύγεις από αυτό το Realm, δε θα το βλέπεις εκτός αν σε προσκαλέσουν ξανά",
	"mco.configure.world.leave.question.line2": "Είσαι βέβαιος/βέβαιη ότι θέλεις να συνεχίσεις;",
	"mco.configure.world.loading": "Φόρτωση Realm",
	"mco.configure.world.location": "Τοποθεσία",
	"mco.configure.world.minigame": "Τρέχον: %s",
	"mco.configure.world.name": "Όνομα Realm",
	"mco.configure.world.name.validation.whitespace": "Δεν πρέπει να ξεκινάει ή να τελειώνει με κενό. Θα αφαιρεθεί.",
	...
	"mco.configure.world.players.invite.duplicate": "Έχει ήδη προσκληθεί στο Realm ένας παίκτης με το όνομα που δόθηκε",
	"mco.configure.world.players.inviting": "Πρόσκληση παίκτη...",
	"mco.configure.world.players.title": "Παίκτες",
	"mco.configure.world.pvp": "PVP",
	"mco.configure.world.region_preference": "Προτίμηση Περιοχής",
	"mco.configure.world.region_preference.title": "Επιλογή Προτίμησης Περιοχής",
	"mco.configure.world.reset.question.line1": "Ο κόσμος σου θα αναδημιουργηθεί και ο τρέχων σου κόσμος θα χαθεί",
	"mco.configure.world.reset.question.line2": "Είσαι βέβαιος/βέβαιη ότι θέλεις να συνεχίσεις;",
	"mco.configure.world.resourcepack.question": "Χρειάζεσαι ένα προσαρμοσμένο πακέτο πόρων για να παίξεις σε αυτό το Realm\n\nΘέλεις να το κατεβάσεις και να παίξεις;",
	"mco.configure.world.resourcepack.question.line1": "Χρειάζεσαι ένα προσαρμοσμένο πακέτο πόρων για να παίξεις σε αυτό το Realm",
	"mco.configure.world.resourcepack.question.line2": "Θέλεις να το κατεβάσεις και να παίξεις;",
	"mco.configure.world.restore.download.question.line1": "Ο κόσμος θα κατέβει και θα προστεθεί στους κόσμους σου παιχνιδιού ενός παίκτη.",
	"mco.configure.world.restore.download.question.line2": "Θέλεις να συνεχίσεις;",
	"mco.configure.world.restore.question.line1": "Ο κόσμος σου θα επαναφερθεί στην ημερομηνία «%s» (%s)",
	"mco.configure.world.restore.question.line2": "Είσαι βέβαιος/βέβαιη ότι θέλεις να συνεχίσεις;",
	"mco.configure.world.settings.expired": "Δεν μπορείς να αλλάξεις τις ρυθμίσεις ενός ληγμένου Realm",
	"mco.configure.world.settings.title": "Ρυθμίσεις",
	"mco.configure.world.slot": "Κόσμος %s",
	"mco.configure.world.slot.empty": "Κενός",
	"mco.configure.world.slot.switch.question.line1": "Το Realm σου θα αλλάξει σε άλλον κόσμο",
	"mco.configure.world.slot.switch.question.line2": "Είσαι βέβαιος/βέβαιη ότι θέλεις να συνεχίσεις;",
	...
	"mco.configure.world.spawnProtection": "Προστασία Τοποθεσίας Γέννησης",
	"mco.configure.world.spawn_toggle.message": "Η απενεργοποίηση αυτής της επιλογής θα καταργήσει όλες τις υπάρχουσες οντότητες αυτού του τύπου",
	"mco.configure.world.spawn_toggle.message.npc": "Η απενεργοποίηση αυτής της επιλογής θα καταργήσει όλες τις υπάρχουσες οντότητες αυτού του τύπου, όπως Χωρικοί",
	...
	"mco.configure.world.subscription.expired": "Ληγμένη",
	"mco.configure.world.subscription.extend": "Επέκταση Συνδρομής",
	...
	"mco.configure.world.subscription.recurring.info": "Οι αλλαγές που γίνονται στη συνδρομή σου Realms όπως ο επιπλέον χρόνος ή η απενεργοποίηση της περιοδικής χρέωσης δε θα αντικατοπτρίζονται μέχρι την επόμενή σου ημερομηνία χρέωσης.",
	"mco.configure.world.subscription.remaining.days": "%[1]s ημέρα/ημέρες",
	"mco.configure.world.subscription.remaining.months": "%[1]s μήνας/μήνες",
	"mco.configure.world.subscription.remaining.months.days": "%[1]s μήνας/μήνες, %[2]s ημέρα/ημέρες",
	"mco.configure.world.subscription.start": "Ημερομηνία Έναρξης",
	"mco.configure.world.subscription.tab": "Συνδρομή",
	"mco.configure.world.subscription.timeleft": "Χρόνος που Απομένει",
	"mco.configure.world.subscription.title": "Η Συνδρομή σου",
	"mco.configure.world.subscription.unknown": "Άγνωστη",
	"mco.configure.world.switch.slot": "Δημιουργία Κόσμου",
	"mco.configure.world.switch.slot.subtitle": "Αυτός ο κόσμος είναι κενός. Επίλεξε πώς να δημιουργήσεις τον κόσμο σου",
	"mco.configure.world.title": "Διαμόρφωση Realm:",
	"mco.configure.world.uninvite.player": "Είσαι βέβαιος/βέβαιη ότι θέλεις να καταργήσεις την πρόσκληση του παίκτη «%s»;",
	"mco.configure.world.uninvite.question": "Είσαι βέβαιος/βέβαιη ότι θέλεις να καταργήσεις την πρόσκληση του παίκτη",
	...
	"mco.connect.region": "Περιοχή διακομιστή: %s",
	"mco.connect.success": "Τέλος",
	"mco.create.world": "Δημιουργία",
	"mco.create.world.error": "Πρέπει να εισαγάγεις ένα όνομα!",
	"mco.create.world.failed": "Απέτυχε η δημιουργία του κόσμου!",
	"mco.create.world.reset.title": "Δημιουργία κόσμου...",
	"mco.create.world.skip": "Παράλειψη",
	"mco.create.world.subtitle": "Προαιρετικά, επίλεξε ποιον κόσμο να τοποθετήσεις στο νέο σου Realm",
	...
	"mco.download.confirmation.line2": "Δε θα μπορείς να ανεβάσεις αυτόν τον κόσμο στο Realm σου ξανά",
	"mco.download.confirmation.oversized": "Ο κόσμος που θα κατεβάσεις είναι μεγαλύτερος από %s\n\nΔε θα μπορείς να ανεβάσεις αυτόν τον κόσμο στο Realm σου ξανά",
	...
	"mco.download.resourcePack.fail": "Απέτυχε η λήψη του πακέτου πόρων!",
	"mco.download.speed": "(%s/s)",
	"mco.download.speed.narration": "%s/s",
	"mco.download.title": "Λήψη Τελευταίου Κόσμου",
	"mco.error.invalid.session.message": "Παρακαλώ δοκίμασε να επανεκκινήσεις το Minecraft",
	"mco.error.invalid.session.title": "Μη Έγκυρη Συνεδρία",
	"mco.errorMessage.6001": "Μη ενημερωμένο πρόγραμμα πελάτη",
	"mco.errorMessage.6002": "Οι όροι παροχής υπηρεσιών δεν έγιναν αποδεκτοί",
	"mco.errorMessage.6003": "Επιτεύχθηκε το όριο λήψεων",
	"mco.errorMessage.6004": "Επιτεύχθηκε το όριο μεταφορτώσεων",
	"mco.errorMessage.6005": "Κλειδωμένος κόσμος",
	"mco.errorMessage.6006": "Ο κόσμος είναι μη ενημερωμένος",
	"mco.errorMessage.6007": "Ο χρήστης είναι σε πάρα πολλά Realm",
	"mco.errorMessage.6008": "Μη έγκυρο όνομα Realm",
	"mco.errorMessage.6009": "Μη έγκυρη περιγραφή Realm",
	"mco.errorMessage.connectionFailure": "Προέκυψε ένα σφάλμα. Παρακαλώ δοκίμασε ξανά αργότερα.",
	"mco.errorMessage.generic": "Προέκυψε ένα σφάλμα: ",
	"mco.errorMessage.initialize.failed": "Απέτυχε η προετοιμασία του Realm",
	"mco.errorMessage.noDetails": "Δε δόθηκαν λεπτομέρειες σφάλματος",
	"mco.errorMessage.realmsService": "Προέκυψε ένα σφάλμα (%s):",
	"mco.errorMessage.realmsService.configurationError": "Προέκυψε ένα μη αναμενόμενο σφάλμα κατά την επεξεργασία του επιλογών του κόσμου",
	"mco.errorMessage.realmsService.connectivity": "Δεν μπόρεσε να γίνει σύνδεση στα Realms: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Δεν μπόρεσε να ελεγχθεί η συμβατή έκδοση. Λήφθηκε η απόκριση: %s",
	"mco.errorMessage.retry": "Επαναδοκιμή διαδικασίας",
	"mco.errorMessage.serviceBusy": "Τα Realms είναι απασχολημένα αυτήν τη στιγμή.\nΠαρακαλώ δοκίμασε να συνδεθείς στο Realm σου ξανά σε λίγα λεπτά.",
	"mco.gui.button": "Κουμπί",
	"mco.gui.ok": "Εντάξει",
	"mco.info": "Πληροφορίες!",
	"mco.invited.player.narration": "Προσκλήθηκε ο παίκτης %s",
	...
	"mco.minigame.world.info.line1": "Αυτό θα αντικαταστήσει προσωρινά τον κόσμο σου με ένα μίνι-παιχνίδι!",
	"mco.minigame.world.info.line2": "Μπορείς να επιστρέψεις αργότερα στον αρχικό σου κόσμο χωρίς να χάσεις τίποτα.",
	"mco.minigame.world.noSelection": "Παρακαλώ κάνε μια επιλογή",
	"mco.minigame.world.restore": "Τερματισμός Μίνι-Παιχνιδιού...",
	"mco.minigame.world.restore.question.line1": "Το μίνι-παιχνίδι θα τερματιστεί και το Realm σου θα επαναφερθεί.",
	"mco.minigame.world.restore.question.line2": "Είσαι βέβαιος/βέβαιη ότι θέλεις να συνεχίσεις;",
	...
	"mco.news": "Ειδήσεις των Realms",
	"mco.notification.dismiss": "Κλείσιμο",
	"mco.notification.transferSubscription.buttonText": "Μεταφορά Τώρα",
	"mco.notification.transferSubscription.message": "Οι συνδρομές Java Realms μεταφέρονται στο Microsoft Store. Μην αφήσεις τη συνδρομή σου να λήξει!\nΚάνε μεταφορά τώρα και απόκτησε 30 ημέρες Realms δωρεάν.\nΠήγαινε στο Προφίλ στο minecraft.net για να μεταφέρεις τη συνδρομή σου.",
	"mco.notification.visitUrl.buttonText.default": "Άνοιγμα Συνδέσμου",
	"mco.notification.visitUrl.message.default": "Παρακαλώ επισκέψου τον παρακάτω σύνδεσμο",
	"mco.onlinePlayers": "Συνδεδεμένοι Παίκτες",
	"mco.play.button.realm.closed": "Το Realm είναι κλειστό",
	"mco.question": "Ερώτηση",
	...
	"mco.reset.world.warning": "Αυτή η ενέργεια θα διαγράψει μόνιμα τον τρέχοντα κόσμο του Realm σου",
	"mco.selectServer.buy": "Αγορά ενός Realm!",
	"mco.selectServer.close": "Κλείσιμο",
	"mco.selectServer.closed": "Απενεργοποιημένο Realm",
	...
	"mco.selectServer.create.subtitle": "Επίλεξε ποιον κόσμο να τοποθετήσεις στο νέο σου Realm",
	"mco.selectServer.expired": "Ληγμένο Realm",
	"mco.selectServer.expiredList": "Η συνδρομή σου έχει λήξει",
	"mco.selectServer.expiredRenew": "Ανανέωση",
	"mco.selectServer.expiredSubscribe": "Εγγραφή",
	"mco.selectServer.expiredTrial": "Η δοκιμή σου έχει τελειώσει",
	...
	"mco.selectServer.loading": "Φόρτωση Λίστας Realm",
	...
	"mco.selectServer.minigameName": "Μίνι-παιχνίδι: %s",
	"mco.selectServer.minigameNotSupportedInVersion": "Δεν μπορείς να παίξεις αυτό το μίνι-παιχνίδι στην έκδοση %s",
	"mco.selectServer.noRealms": "Δε φαίνεται να έχεις Realm. Πρόσθεσε ένα Realm για να παίξεις μαζί με τους φίλους σου.",
	...
	"mco.selectServer.popup": "Τα Realms είναι ένας ασφαλής, απλός τρόπος να απολαύσεις έναν διαδικτυακό κόσμο Minecraft με έως και δέκα φίλους τη φορά. Υποστηρίζουν πολλά μίνι-παιχνίδια και αρκετούς προσαρμοσμένους κόσμους! Μόνο ο ιδιοκτήτης του Realm πρέπει να πληρώσει.",
	"mco.selectServer.purchase": "Προσθήκη Realm",
	"mco.selectServer.trial": "Δωρεάν Δοκιμή!",
	"mco.selectServer.uninitialized": "Κάνε κλικ για να ξεκινήσεις το νέο σου Realm!",
	"mco.snapshot.createSnapshotPopup.text": "Πρόκειται να δημιουργήσεις ένα δωρεάν Realm Στιγμιότυπων που θα είναι συνδεδεμένο με την πληρωμένη σου συνδρομή Realms. Αυτό το νέο Realm Στιγμιότυπων θα είναι προσβάσιμο για όσο η πληρωμένη συνδρομή είναι ενεργή. Το πληρωμένο σου Realm δε θα επηρεαστεί.",
	"mco.snapshot.createSnapshotPopup.title": "Δημιουργία Realm Στιγμιότυπων;",
	"mco.snapshot.creating": "Δημιουργία Realm Στιγμιότυπων...",
	"mco.snapshot.description": "Συνδεδεμένο με το Realm «%s»",
	"mco.snapshot.friendsRealm.downgrade": "Πρέπει να είσαι στην έκδοση %s για να συνδεθείς σε αυτό το Realm",
	"mco.snapshot.friendsRealm.upgrade": "Ο παίκτης %s πρέπει να αναβαθμίσει το Realm του πριν μπορέσεις να παίξεις από αυτήν την έκδοση",
	"mco.snapshot.paired": "Αυτό το Realm Στιγμιότυπων είναι συνδεδεμένο με το Realm «%s»",
	"mco.snapshot.parent.tooltip": "Χρησιμοποίησε την τελευταία κυκλοφορία του Minecraft για να παίξεις σε αυτό το Realm",
	"mco.snapshot.start": "Εκκίνηση δωρεάν Realm Στιγμιότυπων",
	"mco.snapshot.subscription.info": "Αυτό είναι ένα Realm Στιγμιότυπων που είναι συνδεδεμένο στη συνδρομή του Realm σου «%s». Θα παραμείνει ενεργό για όσο θα είναι το συνδεδεμένο του Realm.",
	"mco.snapshot.tooltip": "Χρησιμοποίησε τα Realms Στιγμιότυπων για να αποκτήσεις μια πρώτη μάτια στις προσεχείς εκδόσεις του Minecraft, οι οποίες μπορεί να περιλαμβάνουν νέο περιεχόμενο και άλλες αλλαγές.\n\nΜπορείς να βρεις τα κανονικά σου Realms στην έκδοση κυκλοφορία του παιχνιδιού.",
	"mco.snapshotRealmsPopup.message": "Τα Realms είναι τώρα διαθέσιμα σε Στιγμιότυπα ξεκινώντας με το Στιγμιότυπο 23w41a. Κάθε συνδρομή Realms έρχεται με ένα δωρεάν Realm Στιγμιότυπων που είναι ξεχωριστό από το κανονικό σου Realm Java!",
	"mco.snapshotRealmsPopup.title": "Τα Realms είναι τώρα διαθέσιμα σε Στιγμιότυπα",
	"mco.snapshotRealmsPopup.urlText": "Περισσότερες Πληροφορίες",
	...
	"mco.template.info.tooltip": "Ιστότοπος εκδότη",
	"mco.template.name": "Πρότυπο",
	"mco.template.select.failure": "Δεν μπορέσαμε να ανακτήσουμε τη λίστα του περιεχομένου για αυτήν την κατηγορία.\nΠαρακαλώ έλεγξε τη σύνδεσή σου στο διαδίκτυο, ή δοκίμασε ξανά αργότερα.",
	"mco.template.select.narrate.authors": "Δημιουργοί: %s",
	"mco.template.select.narrate.version": "έκδοση %s",
	"mco.template.select.none": "Ωχ, φαίνεται ότι αυτή η κατηγορία περιεχομένου είναι τώρα κενή.\nΠαρακαλώ, έλεγξε ξανά αργότερα για νέο περιεχόμενο, ή αν είσαι δημιουργός,\n%s.",
	"mco.template.select.none.linkTitle": "σκέψου να υποβάλεις κάτι εσύ ο ίδιος/η ίδια",
	...
	"mco.time.daysAgo": "%[1]s ημέρα/ημέρες πριν",
	"mco.time.hoursAgo": "%[1]s ώρα/ώρες πριν",
	"mco.time.minutesAgo": "%[1]s λεπτό/λεπτά πριν",
	"mco.time.now": "αμέσως τώρα",
	"mco.time.secondsAgo": "%[1]s δευτερόλεπτο/δευτερόλεπτα πριν",
	"mco.trial.message.line1": "Θέλεις να αποκτήσεις το δικό σου Realm;",
	"mco.trial.message.line2": "Κάνε κλικ εδώ για περισσότερες πληροφορίες!",
	"mco.upload.button.name": "Μεταφόρτωση",
	"mco.upload.cancelled": "Η μεταφόρτωση ακυρώθηκε",
	"mco.upload.close.failure": "Δεν μπόρεσε να κλείσει το Realm σου. Παρακαλώ δοκίμασε ξανά αργότερα.",
	...
	"mco.upload.failed.too_big.description": "Ο επιλεγμένος κόσμος είναι πολύ μεγάλος. Το μέγιστο επιτρεπτό μέγεθος είναι %s.",
	"mco.upload.failed.too_big.title": "Ο κόσμος είναι πολύ μεγάλος",
	"mco.upload.hardcore": "Οι σκληροπυρηνικοί κόσμοι δεν μπορούν να ανέβουν!",
	"mco.upload.percent": "%s %%",
	"mco.upload.preparing": "Προετοιμασία του κόσμου σου",
	"mco.upload.select.world.none": "Δε βρέθηκαν κόσμοι παιχνιδιού ενός παίκτη!",
	"mco.upload.select.world.subtitle": "Παρακαλώ επίλεξε έναν κόσμο παιχνιδιού ενός παίκτη για να ανεβάσεις",
	...
	"mco.upload.verifying": "Επαλήθευση του κόσμου σου",
	"mco.version": "Έκδοση: %s",
	"mco.warning": "Προσοχή!",
	"mco.worldSlot.minigame": "Μίνι-Παιχνίδι",
	"menu.custom_options": "Προσαρμοσμένες Επιλογές...",
	"menu.custom_options.title": "Προσαρμοσμένες Επιλογές",
	"menu.custom_options.tooltip": "Σημείωση: Οι προσαρμοσμένες επιλογές παρέχονται από διακομιστές και/ή περιεχόμενο τρίτων.\nΧειρίζεσαι με προσοχή!",
	"menu.custom_screen_info.button_narration": "Αυτή είναι μια προσαρμοσμένη οθόνη. Μάθε περισσότερα.",
	"menu.custom_screen_info.contents": "Τα περιεχόμενα αυτής της οθόνης ελέγχονται από διακομιστές τρίτων οι οποίοι δεν κατέχονται, τυγχάνουν διαχείρισης, ή επιβλέπονται από τη Mojang Studios ή τη Microsoft.\n\nΧειρίζεσαι με προσοχή! Πάντα να προσέχεις όταν ακολουθείς συνδέσμους και ποτέ μη δίνεις τις προσωπικές σου πληροφορίες, συμπεριλαμβανομένων των στοιχείων σύνδεσης.\n\nΑν αυτή η οθόνη σε αποτρέπει από το να παίζεις, μπορείς επίσης να αποσυνδεθείς από τον τρέχοντα διακομιστή χρησιμοποιώντας το παρακάτω κουμπί.",
	"menu.custom_screen_info.disconnect": "Η προσαρμοσμένη οθόνη απορρίφθηκε",
	"menu.custom_screen_info.title": "Σημείωση για τις προσαρμοσμένες οθόνες",
	"menu.custom_screen_info.tooltip": "Αυτή είναι μια προσαρμοσμένη οθόνη. Κάνε κλικ εδώ για να μάθεις περισσότερα.",
	"menu.disconnect": "Αποσύνδεση",
	"menu.feedback": "Σχόλια...",
	"menu.feedback.title": "Σχόλια",
	"menu.game": "Μενού Παιχνιδιού",
	"menu.modded": " (Τροποποιημένο)",
	"menu.multiplayer": "Παιχνίδι Πολλαπλών Παικτών",
	"menu.multiplayerOptions.applyChanges": "Εφαρμογή Αλλαγών",
	"menu.multiplayerOptions.button": "Παιχνίδι Πολλαπλών Παικτών...",
	"menu.multiplayerOptions.network": "Παιχνίδι Πολλαπλών Παικτών",
	"menu.multiplayerOptions.network.header": "Δίκτυο",
	"menu.multiplayerOptions.network.lan": "LAN",
	"menu.multiplayerOptions.network.lan.tooltip": "Οι παίκτες στο ίδιο δίκτυο μπορούν να συνδεθούν.",
	"menu.multiplayerOptions.network.off": "ΟΧΙ",
	"menu.multiplayerOptions.network.off.tooltip": "Κανένας δεν μπορεί να συνδεθεί.",
	"menu.multiplayerOptions.network.online": "Διαδικτυακό",
	"menu.multiplayerOptions.network.online.tooltip": "Οι φίλοι μπορούν να συνδεθούν διαδικτυακά.",
	"menu.multiplayerOptions.otherPlayers.header": "Άλλοι Παίκτες",
	...
	"menu.multiplayerOptions.title": "Επιλογές Παιχνιδιού Πολλαπλών Παικτών",
	...
	"menu.quick_actions": "Γρήγορες Ενέργειες...",
	"menu.quick_actions.title": "Γρήγορες Ενέργειες",
	...
	"menu.server_links": "Σύνδεσμοι Διακομιστή...",
	"menu.server_links.title": "Σύνδεσμοι Διακομιστή",
	...
	"multiplayer.codeOfConduct.check": "Να μη γίνει ειδοποίηση ξανά για αυτόν τον Κώδικα Δεοντολογίας",
	"multiplayer.codeOfConduct.title": "Κώδικας Δεοντολογίας Διακομιστή",
	"multiplayer.confirm_command.parse_errors": "Προσπαθείς να εκτελέσεις μια μη αναγνωρισμένη ή μη έγκυρη εντολή.\nΕίσαι βέβαιος;\nΕντολή: %s",
	"multiplayer.confirm_command.permissions_required": "Προσπαθείς να εκτελέσεις μια εντολή που απαιτεί αυξημένες άδειες.\nΑυτό μπορεί να επηρεάσει αρνητικά το παιχνίδι σου.\nΕίσαι βέβαιος;\nΕντολή: %s",
	"multiplayer.confirm_command.run_command": "Εκτέλεση Εντολής",
	"multiplayer.confirm_command.signature_required": "Προσπαθείς να εκτελέσεις μια εντολή που θα στείλει μηνύματα συνομιλίας χρησιμοποιώντας το όνομά σου.\nΜπορεί να εκτελεστεί μόνο από την οθόνη συνομιλίας\nΕντολή: %s",
	"multiplayer.confirm_command.suggest_command": "Αντιγραφή στην Οθόνη Συνομιλίας",
	"multiplayer.confirm_command.title": "Επιβεβαίωση Εκτέλεσης Εντολής",
	"multiplayer.disconnect.authservers_down": "Οι διακομιστές ελέγχου ταυτότητας είναι εκτός λειτουργίας. Παρακαλώ δοκίμασε ξανά αργότερα. Συγγνώμη!",
	"multiplayer.disconnect.bad_chat_index": "Ανιχνεύθηκε ένα χαμένο ή επανατοποθετημένο μήνυμα συνομιλίας από τον διακομιστή",
	"multiplayer.disconnect.banned": "Έχεις αποκλειστεί από αυτόν τον διακομιστή",
	"multiplayer.disconnect.banned.expiration": "\nΟ αποκλεισμός σου θα καταργηθεί %s",
	"multiplayer.disconnect.banned.reason": "Έχεις αποκλειστεί από αυτόν τον διακομιστή.\nΑιτία: %s",
	"multiplayer.disconnect.banned.reason.default": "Αποκλείστηκες από έναν διαχειριστή.",
	"multiplayer.disconnect.banned_ip.expiration": "\nΟ αποκλεισμός σου θα καταργηθεί %s",
	"multiplayer.disconnect.banned_ip.reason": "Η διεύθυνσή σου IP έχει αποκλειστεί από αυτόν τον διακομιστή.\nΑιτία: %s",
	"multiplayer.disconnect.chat_validation_failed": "Αποτυχία επικύρωσης μηνύματος συνομιλίας",
	"multiplayer.disconnect.code_of_conduct": "Ο διακομιστής απαιτεί την αποδοχή του Κώδικα Δεοντολογίας",
	"multiplayer.disconnect.configuration_error": "Μη αναμενόμενο σφάλμα κατά τη διαμόρφωση",
	"multiplayer.disconnect.duplicate_login": "Συνδέθηκες από άλλη τοποθεσία",
	"multiplayer.disconnect.expired_public_key": "Ληγμένο δημόσιο κλειδί προφίλ. Επαλήθευσε ότι η ώρα συστήματός σου είναι συγχρονισμένη, και δοκίμασε να επανεκκινήσεις το παιχνίδι σου.",
	"multiplayer.disconnect.flying": "Η πτήση δεν είναι ενεργοποιημένη σε αυτόν τον διακομιστή",
	"multiplayer.disconnect.generic": "Αποσυνδέθηκες",
	"multiplayer.disconnect.idling": "Έχεις μείνει σε αδράνεια για πολύ χρόνο!",
	"multiplayer.disconnect.illegal_characters": "Μη έγκυροι χαρακτήρες στη συνομιλία",
	"multiplayer.disconnect.incompatible": "Μη συμβατό πρόγραμμα πελάτη! Παρακαλώ χρησιμοποίησε την έκδοση %s",
	...
	"multiplayer.disconnect.invalid_public_key_signature": "Μη έγκυρη υπογραφή για δημόσιο κλειδί προφίλ.\nΔοκίμασε να επανεκκινήσεις το παιχνίδι σου.",
	"multiplayer.disconnect.invalid_public_key_signature.new": "Μη έγκυρη υπογραφή για δημόσιο κλειδί προφίλ.\nΔοκίμασε να επανεκκινήσεις το παιχνίδι σου.",
	"multiplayer.disconnect.invalid_vehicle_movement": "Λήφθηκε μη έγκυρο πακέτο κίνησης οχήματος",
	"multiplayer.disconnect.ip_banned": "Η διεύθυνσή σου IP έχει αποκλειστεί από αυτόν τον διακομιστή",
	"multiplayer.disconnect.kicked": "Αποβλήθηκες από έναν διαχειριστή",
	"multiplayer.disconnect.missing_tags": "Λήφθηκε ανολοκλήρωτο σύνολο ετικετών από τον διακομιστή.\nΠαρακαλώ επικοινώνησε με έναν διαχειριστή του διακομιστή.",
	"multiplayer.disconnect.name_taken": "Αυτό το όνομα χρησιμοποιείται ήδη",
	"multiplayer.disconnect.not_whitelisted": "Δεν είσαι στη λευκή λίστα αυτού του διακομιστή!",
	"multiplayer.disconnect.out_of_order_chat": "Λήφθηκε πακέτο συνομιλίας εκτός σειράς. Άλλαξε η ώρα συστήματός σου;",
	"multiplayer.disconnect.outdated_client": "Μη συμβατό πρόγραμμα πελάτη! Παρακαλώ χρησιμοποίησε την έκδοση %s",
	"multiplayer.disconnect.outdated_server": "Μη συμβατό πρόγραμμα πελάτη! Παρακαλώ χρησιμοποίησε την έκδοση %s",
	...
	"multiplayer.disconnect.slow_login": "Χρειάστηκε πολύς χρόνος για να συνδεθείς",
	"multiplayer.disconnect.too_many_pending_chats": "Πάρα πολλά μη επιβεβαιωμένα μηνύματα συνομιλίας",
	"multiplayer.disconnect.transfers_disabled": "Αυτός ο διακομιστής δε δέχεται μεταφορές",
	"multiplayer.disconnect.unexpected_query_response": "Μη αναμενόμενα προσαρμοσμένα δεδομένα από το πρόγραμμα πελάτη",
	"multiplayer.disconnect.unsigned_chat": "Λήφθηκε ένα πακέτο συνομιλίας με απούσα ή μη έγκυρη υπογραφή.",
	...
	"multiplayer.message_not_delivered": "Δεν μπορεί να σταλθεί το μήνυμα συνομιλίας· έλεγξε τα αρχεία του διακομιστή: %s",
	...
	"multiplayer.player.list.hp": "%s ζωή",
	"multiplayer.player.list.narration": "Συνδεδεμένοι παίκτες: %s",
	"multiplayer.requiredTexturePrompt.disconnect": "Αυτός ο διακομιστής απαιτεί ένα προσαρμοσμένο πακέτο πόρων",
	"multiplayer.requiredTexturePrompt.line1": "Αυτός ο διακομιστής απαιτεί τη χρήση ενός προσαρμοσμένου πακέτου πόρων.",
	"multiplayer.requiredTexturePrompt.line2": "Η απόρριψη αυτού του προσαρμοσμένου πακέτου πόρων θα σε αποσυνδέσει από αυτόν τον διακομιστή.",
	...
	"multiplayer.status.anonymous_player": "Ανώνυμος Παίκτης",
	...
	"multiplayer.status.finished": "Ολοκληρώθηκε",
	...
	"multiplayer.status.online": "Σε Σύνδεση",
	...
	"multiplayer.texturePrompt.line2": "Θα ήθελες να το κατεβάσεις και να το εγκαταστήσεις αυτόματα;",
	...
	"multiplayer.unsecureserver.toast.title": "Τα μηνύματα δεν επαληθεύονται",
	...
	"multiplayerWarning.message": "Προσοχή: Το διαδικτυακό παιχνίδι παρέχεται από διακομιστές τρίτων οι οποίοι δεν κατέχονται, τυγχάνουν διαχείρισης, ή επιβλέπονται από τη Mojang Studios ή τη Microsoft. Κατά τη διάρκεια του διαδικτυακού παιχνιδιού, μπορεί να εκτεθείς σε μη ελεγχόμενα μηνύματα συνομιλίας ή άλλα είδη περιεχομένου δημιουργημένο από χρήστες που μπορεί να μην είναι κατάλληλο για όλους.",
	"music.game.a_familiar_room": "Άαρον Σέροφ - A Familiar Room",
	"music.game.an_ordinary_day": "Κούμι Τανιόκα - An Ordinary Day",
	"music.game.ancestry": "Λένα Ρέιν - Ancestry",
	"music.game.below_and_above": "Έιμος Ρόντι - Below and Above",
	"music.game.broken_clocks": "Έιμος Ρόντι - Broken Clocks",
	"music.game.bromeliad": "Άαρον Σέροφ - Bromeliad",
	"music.game.clark": "C418 - Clark",
	"music.game.comforting_memories": "Κούμι Τανιόκα - Comforting Memories",
	...
	"music.game.crescent_dunes": "Άαρον Σέροφ - Crescent Dunes",
	"music.game.danny": "C418 - Danny",
	"music.game.deeper": "Λένα Ρέιν - Deeper",
	"music.game.dry_hands": "C418 - Dry Hands",
	"music.game.ebb": "fingerspit - Ebb",
	"music.game.echo_in_the_wind": "Άαρον Σέροφ - Echo in the Wind",
	"music.game.eld_unknown": "Λένα Ρέιν - Eld Unknown",
	"music.game.end.alpha": "C418 - Alpha",
	"music.game.end.boss": "C418 - Boss",
	"music.game.end.the_end": "C418 - The End",
	"music.game.endless": "Λένα Ρέιν - Endless",
	"music.game.featherfall": "Άαρον Σέροφ - Featherfall",
	"music.game.fireflies": "Έιμος Ρόντι - Fireflies",
	"music.game.floating_dream": "Κούμι Τανιόκα - Floating Dream",
	"music.game.haggstrom": "C418 - Haggstrom",
	"music.game.home": "fingerspit - Home",
	"music.game.infinite_amethyst": "Λένα Ρέιν - Infinite Amethyst",
	"music.game.key": "C418 - Key",
	"music.game.komorebi": "Κούμι Τανιόκα - komorebi",
	"music.game.left_to_bloom": "Λένα Ρέιν - Left to Bloom",
	"music.game.lilypad": "Έιμος Ρόντι - Lilypad",
	...
	"music.game.nether.crimson_forest.chrysopoeia": "Λένα Ρέιν - Chrysopoeia",
	"music.game.nether.dead_voxel": "C418 - Dead Voxel",
	"music.game.nether.nether_wastes.rubedo": "Λένα Ρέιν - Rubedo",
	"music.game.nether.soulsand_valley.so_below": "Λένα Ρέιν - So Below",
	"music.game.nether.warmth": "C418 - Warmth",
	"music.game.nightly": "fingerspit - Nightly",
	"music.game.one_more_day": "Λένα Ρέιν - One More Day",
	"music.game.os_piano": "Έιμος Ρόντι - O's Piano",
	"music.game.oxygene": "C418 - Oxygène",
	"music.game.pokopoko": "Κούμι Τανιόκα - pokopoko",
	"music.game.puzzlebox": "Άαρον Σέροφ - Puzzlebox",
	"music.game.shores": "fingerspit - Shores",
	"music.game.stand_tall": "Λένα Ρέιν - Stand Tall",
	"music.game.subwoofer_lullaby": "C418 - Subwoofer Lullaby",
	"music.game.swamp.aerie": "Λένα Ρέιν - Aerie",
	"music.game.swamp.firebugs": "Λένα Ρέιν - Firebugs",
	"music.game.swamp.labyrinthine": "Λένα Ρέιν - Labyrinthine",
	"music.game.sweden": "C418 - Sweden",
	"music.game.watcher": "Άαρον Σέροφ - Watcher",
	"music.game.water.axolotl": "C418 - Axolotl",
	"music.game.water.dragon_fish": "C418 - Dragon Fish",
	"music.game.water.shuniji": "C418 - Shuniji",
	"music.game.wending": "Λένα Ρέιν - Wending",
	"music.game.wet_hands": "C418 - Wet Hands",
	"music.game.yakusoku": "Κούμι Τανιόκα - yakusoku",
	...
	"narration.button.usage.focused": "Πάτημα Enter για ενεργοποίηση",
	"narration.button.usage.hovered": "Αριστερό κλικ για ενεργοποίηση",
	"narration.checkbox": "Πλαίσιο ελέγχου: %s",
	"narration.checkbox.usage.focused": "Πάτημα Enter για αλλαγή",
	"narration.checkbox.usage.focused.check": "Πάτημα Enter για προσθήκη τικ",
	"narration.checkbox.usage.focused.uncheck": "Πάτημα Enter για κατάργηση τικ",
	"narration.checkbox.usage.hovered": "Αριστερό κλικ για αλλαγή",
	"narration.checkbox.usage.hovered.check": "Αριστερό κλικ για προσθήκη τικ",
	"narration.checkbox.usage.hovered.uncheck": "Αριστερό κλικ για κατάργηση τικ",
	"narration.component_list.usage": "Πάτημα Tab για μετάβαση στο επόμενο στοιχείο",
	"narration.cycle_button.usage.focused": "Πάτημα Enter για αλλαγή στην επιλογή %s",
	"narration.cycle_button.usage.hovered": "Αριστερό κλικ για αλλαγή στην επιλογή %s",
	"narration.edit_box": "Πλαίσιο επεξεργασίας: %s",
	"narration.item": "Αντικείμενο: %s",
	...
	"narration.recipe.usage": "Αριστερό κλικ για επιλογή",
	"narration.recipe.usage.more": "Δεξί κλικ για εμφάνιση περισσότερων συνταγών",
	"narration.selection.usage": "Πάτημα των πάνω και κάτω κουμπιών για μετάβαση σε άλλη καταχώριση",
	"narration.slider.usage.focused": "Πάτημα του αριστερού ή δεξιού κουμπιού του πληκτρολογίου για αλλαγή της τιμής",
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Πάτημα Enter για ξεκίνημα αλλαγής της τιμής του διακόπτη",
	"narration.slider.usage.hovered": "Σύρσιμο του διακόπτη για αλλαγή της τιμής του",
	"narration.suggestion": "Επιλεγμένη πρόταση %s από %s: %s",
	"narration.suggestion.tooltip": "Επιλεγμένη πρόταση %s από %s: %s (%s)",
	"narration.suggestion.usage.cycle.fixed": "Πάτημα Tab για αλλαγή στην επόμενη πρόταση",
	"narration.suggestion.usage.cycle.hidable": "Πάτημα Tab για αλλαγή στην επόμενη πρόταση, ή Escape για εγκατάλειψη των προτάσεων",
	"narration.suggestion.usage.fill.fixed": "Πάτημα Tab για χρήση της πρότασης",
	"narration.suggestion.usage.fill.hidable": "Πάτημα Tab για χρήση της πρότασης, ή Escape για εγκατάλειψη των προτάσεων",
	"narration.tab_navigation.usage": "Πάτημα Ctrl και Tab για αλλαγή μεταξύ καρτελών",
	...
	"narrator.screen.title": "Οθόνη Τίτλου",
	"narrator.screen.usage": "Χρήση κέρσορα του ποντικιού ή κουμπιού Tab για επιλογή στοιχείου",
	"narrator.select": "Επιλογή: %s",
	"narrator.select.world": "Επιλογή %s, τελευταίο παιχνίδι: %s, %s, %s, έκδοση: %s",
	"narrator.select.world_info": "Επιλογή %s, τελευταίο παιχνίδι: %s, %s",
	"narrator.toast.disabled": "Απενεργοποίηση Αφηγητή",
	"narrator.toast.enabled": "Ενεργοποίηση Αφηγητή",
	"optimizeWorld.confirm.description": "Το παιχνίδι θα προσπαθήσει να βελτιστοποιήσει τον κόσμο σου επιβεβαιώνοντας ότι όλα τα δεδομένα είναι αποθηκευμένα στην πιο πρόσφατη μορφή παιχνιδιού. Αυτό μπορεί να πάρει αρκετή ώρα, ανάλογα με τον κόσμο σου. Όταν ολοκληρωθεί, ο κόσμος σου μπορεί να παίζεται ταχύτερα αλλά δε θα είναι πλέον συμβατός με παλιότερες εκδόσεις του παιχνιδιού. Είσαι βέβαιος/βέβαιη ότι επιθυμείς να συνεχίσεις;",
	"optimizeWorld.confirm.proceed": "Δημιουργία Αντιγράφου Ασφαλείας και Βελτιστοποίηση",
	...
	"optimizeWorld.stage.finished.chunks": "Ολοκλήρωση αναβάθμισης τμημάτων...",
	"optimizeWorld.stage.finished.entities": "Ολοκλήρωση αναβάθμισης οντοτήτων...",
	"optimizeWorld.stage.finished.poi": "Ολοκλήρωση αναβάθμισης σημείων ενδιαφέροντος...",
	"optimizeWorld.stage.upgrading": "Αναβάθμιση όλων των τμημάτων...",
	"optimizeWorld.stage.upgrading.chunks": "Αναβάθμιση όλων των τμημάτων...",
	"optimizeWorld.stage.upgrading.entities": "Αναβάθμιση όλων των οντοτήτων...",
	"optimizeWorld.stage.upgrading.poi": "Αναβάθμιση όλων των σημείων ενδιαφέροντος...",
	"optimizeWorld.title": "Βελτιστοποίηση Κόσμου «%s»",
	"options.accessibility": "Ρυθμίσεις Προσβασιμότητας...",
	...
	"options.accessibility.high_contrast.tooltip": "Αυξάνει την αντίθεση των στοιχείων του UI.",
	"options.accessibility.high_contrast_block_outline": "Περιγράμματα Κύβου Υψηλής Αντίθεσης",
	"options.accessibility.high_contrast_block_outline.tooltip": "Ενισχύει την αντίθεση του περιγράμματος κύβου του στοχοποιημένου κύβου.",
	"options.accessibility.link": "Οδηγός Προσβασιμότητας",
	"options.accessibility.menu_background_blurriness": "Θολότητα Φόντου Μενού",
	"options.accessibility.menu_background_blurriness.tooltip": "Αλλάζει τη θολότητα των φόντων μενού.",
	"options.accessibility.narrator_hotkey": "Πλήκτρο Πρόσβασης Εκκινητή",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Επιτρέπει την ενεργοποίηση και απενεργοποίηση του Αφηγητή με «Cmd + B».",
	"options.accessibility.narrator_hotkey.tooltip": "Επιτρέπει την ενεργοποίηση και απενεργοποίηση του Αφηγητή με «Ctrl + B».",
	...
	"options.accessibility.tooltip": "Ρυθμίσεις Προσβασιμότητας",
	"options.allowCursorChanges": "Επίτρεψη Αλλαγών Κέρσορα",
	"options.allowCursorChanges.tooltip": "Επιτρέπει στον κέρσορα του ποντικιού να αλλάζει σχήμα όταν είναι πάνω από ορισμένα στοιχεία περιβάλλοντος χρήστη.",
	"options.allowFriendRequests": "Επίτρεψη Αιτημάτων",
	"options.allowFriendRequests.tooltip": "Allow other players to send you friend requests",
	"options.allowServerListing": "Επίτρεψη Καταχωρίσεων Διακομιστών",
	"options.allowServerListing.tooltip": "Οι διακομιστές μπορούν να καταχωρίσουν συνδεδεμένους παίκτες ως μέρος της δημόσιας κατάστασής τους.\nΜε αυτήν την επιλογή απενεργοποιημένη, το όνομά σου δε θα εμφανίζεται σε τέτοιες καταχωρίσεις.",
	...
	"options.autosaveIndicator": "Δείκτης Αυτόματης Αποθήκευσης",
	...
	"options.blocks": "%s Κύβοι",
	"options.chat": "Ρυθμίσεις Συνομιλίας...",
	"options.chat.color": "Χρώματα",
	"options.chat.delay": "Καθυστέρηση Συνομιλίας: %s δευτερόλεπτο/δευτερόλεπτα",
	"options.chat.delay_none": "Καθυστέρηση Συνομιλίας: Καθόλου",
	"options.chat.drafts": "Αποθήκευση Μη Σταλμένων Συνομιλιών",
	"options.chat.drafts.tooltip": "Τα μη σταλμένα μηνύματα θα αποθηκευτούν και μπορούν να σταλθούν την επόμενη φορά που θα ανοιχτεί η συνομιλία.",
	...
	"options.chunkFade": "Χρόνος Σταδιακής Εμφάνισης Τμημάτων",
	"options.chunkFade.none": "Σταδιακή Εμφάνιση Τμημάτων: Καθόλου",
	"options.chunkFade.seconds": "Σταδιακή Εμφάνιση Τμημάτων: %s δευτερόλεπτο/δευτερόλεπτα",
	"options.chunkFade.tooltip": "Σε πόσο χρόνο σε δευτερόλεπτα πρέπει να εμφανίζονται σταδιακά τα τμήματα όταν αποδίδονται πρώτη φορά, αν καθόλου.",
	...
	"options.cutoutLeaves": "Διαφανή Φύλλα",
	"options.cutoutLeaves.tooltip": "Σου επιτρέπει να βλέπεις μέσα από κενά στα φύλλα. Η απενεργοποίηση βελτιώνει την απόδοση.",
	"options.damageTiltStrength": "Κλίση από Ζημιά",
	...
	"options.difficulty.hard.info": "Γεννιούνται εχθρικά όντα και προκαλούν περισσότερη ζημιά. Η μπάρα πείνας εξαντλείται και αδειάζει όλη τη ζωή.",
	...
	"options.difficulty.peaceful.info": "Δε γεννιούνται εχθρικά όντα και μόνο ορισμένα ουδέτερα. Η μπάρα πείνας δεν εξαντλείται και η ζωή αναπληρώνεται με τον χρόνο.",
	"options.directionalAudio": "Ήχος Κατεύθυνσης",
	"options.directionalAudio.off.tooltip": "Κλασικός Στερεοφωνικός ήχος.",
	"options.directionalAudio.on.tooltip": "Χρησιμοποιεί ήχο κατεύθυνσης HRTF για τη βελτίωση της προσομοίωσης ήχου τριών διαστάσεων. Απαιτεί υλισμικό ήχου συμβατό με HRTF, και απολαμβάνεται καλύτερα με ακουστικά.",
	...
	"options.exclusiveFullscreen": "Αποκλειστική Πλήρης Οθόνη",
	"options.exclusiveFullscreen.warningTooltip": "Αυτή η επιλογή μπορεί να αποτρέψει ορισμένες μεθόδους εισόδου από το να λειτουργούν.",
	"options.font": "Ρυθμίσεις Γραμματοσειράς...",
	"options.font.title": "Ρυθμίσεις Γραμματοσειράς",
	"options.forceUnicodeFont": "Γραμματοσειρά Unicode",
	"options.fov": "Πεδίο Ορατότητας",
	"options.fov.max": "Επαγγελματία Quake",
	"options.fov.min": "Κανονικό",
	"options.fovEffectScale": "Εφέ Πεδίου Ορατότητας",
	"options.fovEffectScale.tooltip": "Ελέγχει πόσο μπορεί να αλλάξει το πεδίο ορατότητας με επιδράσεις παιχνιδιού.",
	"options.framerate": "%s fps",
	"options.framerateLimit": "Μέγιστος Ρυθμός Καρέ",
	"options.framerateLimit.max": "Απεριόριστος",
	"options.friendsList": "Λίστα Φίλων",
	...
	"options.friendsList.confirm.message.link": "Λογαριασμός Microsoft",
	"options.friendsList.confirm.title": "Λίστα Φίλων",
	"options.friendsList.confirm.turnOff": "Απενεργοποίηση",
	"options.friendsList.confirm.turnOn": "Ενεργοποίηση",
	...
	"options.graphics.preset": "Προεπιλεγμένα",
	"options.graphics.preset.tooltip": "Θέτει τις ρυθμίσεις «Ποιότητας & Απόδοσης» σε λογικές προεπιλογές που να αντιστοιχούν με την επιθυμητή ποιότητα.",
	"options.graphics.warning.accept": "Συνέχεια Χωρίς Υποστήριξη",
	"options.graphics.warning.cancel": "Πήγαινέ με Πίσω",
	"options.graphics.warning.message": "Η συσκευή γραφικών σου εντοπίζεται ως μη υποστηριζόμενη για την επιλογή αυτών των γραφικών.\n\nΜπορείς να το αγνοήσεις αυτό και να συνεχίσεις, ωστόσο δε θα παρέχεται υποστήριξη για τη συσκευή σου αν επιλέξεις να χρησιμοποιήσεις %s γραφικά.",
	"options.graphics.warning.renderer": "Εντοπισμένη απόδοση: [%s]",
	...
	"options.graphicsApi": "API Γραφικών",
	"options.graphicsApi.default": "Προεπιλεγμένο",
	"options.graphicsApi.opengl": "Προτίμηση OpenGL",
	"options.graphicsApi.restart": "Πρέπει να επανεκκινήσεις το παιχνίδι σου για να αλλάξεις το API γραφικών.",
	"options.graphicsApi.tooltip": "Ποιο API γραφικών να χρησιμοποιείται για απόδοση. Άφησέ το ως Προεπιλεγμένο εκτός και αν έχεις μια συγκεκριμένη ανάγκη για να το αλλάξεις!",
	"options.graphicsApi.tooltip.vulkan": "Experimental. Might reduce performance or cause instability on some systems.",
	"options.graphicsApi.vulkan": "Προτίμηση Vulkan (Πειραματική)",
	"options.guiScale": "Κλίμακα GUI",
	"options.guiScale.auto": "Αυτόματη",
	"options.hidden": "Κρυμμένο",
	"options.hideLightningFlashes": "Απόκρυψη Λάμψεων Ουρανού",
	"options.hideLightningFlashes.tooltip": "Αποτρέπει τους Κεραυνούς ή άλλα περιβαλλοντικά φαινόμενα από το να κάνουν τον ουρανό να λάμπει. Οι ίδιες οι πηγές των λάμψεων θα είναι ακόμη ορατές.",
	"options.hideMatchedNames": "Απόκρυψη Αντίστοιχων Ονομάτων",
	"options.hideMatchedNames.tooltip": "Οι Διακομιστές Τρίτων μπορεί να στέλνουν μηνύματα συνομιλίας σε μη τυπικές μορφές.\nΜε αυτήν την επιλογή ενεργοποιημένη, οι κρυμμένοι παίκτες θα αντιστοιχίζονται με βάση τα ονόματα των αποστολέων της συνομιλίας.",
	"options.hideSplashTexts": "Απόκρυψη Κειμένων Οθόνης Τίτλου",
	"options.hideSplashTexts.tooltip": "Κρύβει το κίτρινο κείμενο στο κύριο μενού.",
	"options.improvedTransparency": "Βελτιωμένη Διαφάνεια",
	"options.improvedTransparency.tooltip": "Μια πειραματική προσέγγιση που χρησιμοποιεί σκίαστρα οθόνης για τον σχηματισμό καιρού, σύννεφων, και σωματιδίων πίσω από ημιδιαφανείς κύβους και νερό.\nΑυτό θα επηρεάσει την απόδοση της GPU.",
	"options.inGameNotification": "Ειδοποίηση στο Παιχνίδι",
	"options.inGameNotification.tooltip": "Εμφάνιση ειδοποιήσεων Φίλων στο παιχνίδι",
	"options.inactivityFpsLimit": "Μείωση FPS όταν είσαι",
	"options.inactivityFpsLimit.afk": "Εκτός Πληκτρολογίου",
	"options.inactivityFpsLimit.afk.tooltip": "Περιορίζει τον ρυθμό καρέ σε 30 όταν το παιχνίδι δε λαμβάνει καμία είσοδο παίκτη για περισσότερο από ένα λεπτό. Τον περιορίζει περαιτέρω σε 10 μετά από 9 παραπάνω λεπτά.",
	"options.inactivityFpsLimit.minimized": "Σε Ελαχιστοποίηση",
	"options.inactivityFpsLimit.minimized.tooltip": "Περιορίζει τον ρυθμό καρέ μόνο όταν το παράθυρο του παιχνιδιού είναι ελαχιστοποιημένο.",
	"options.invertMouse": "Αντιστροφή Ποντικιού",
	"options.invertMouseX": "Αντιστροφή Ποντικιού X",
	"options.invertMouseY": "Αντιστροφή Ποντικιού Y",
	"options.japaneseGlyphVariants": "Ιαπωνικές Παραλλαγές Συμβόλων",
	"options.japaneseGlyphVariants.tooltip": "Χρησιμοποιεί ιαπωνικές παραλλαγές των χαρακτήρων CJK στην προεπιλεγμένη γραμματοσειρά.",
	"options.key.hold": "Με Κράτημα",
	"options.key.toggle": "Με Αλλαγή",
	"options.language": "Γλώσσα...",
	"options.language.narration": "Αλλαγή Γλώσσας",
	"options.language.title": "Γλώσσα",
	"options.language.tooltip": "Αλλαγή Γλώσσας",
	"options.languageAccuracyWarning": "(Οι μεταφράσεις γλωσσών μπορεί να μην είναι 100%% ακριβείς)",
	"options.languageWarning": "Οι μεταφράσεις γλωσσών μπορεί να μην είναι 100%% ακριβείς",
	"options.mainHand": "Κύριο Χέρι",
	"options.mainHand.left": "Αριστερό",
	"options.mainHand.right": "Δεξί",
	"options.maxAnisotropy": "Ανισότροπο Φιλτράρισμα",
	"options.maxAnisotropy.tooltip": "Κάθε επίπεδο βελτιώνει σημαντικά πώς φαίνονται οι ομαλές υφές, αλλά επηρεάζει την απόδοση και επηρεάζει σημαντικά τη χρήση μνήμης βίντεο. Απαιτεί το Φιλτράρισμα Υφών να έχει τεθεί σε Ανισότροπο.",
	...
	"options.multiplayer.title": "Επιλογές Παιχνιδιού Πολλαπλών Παικτών...",
	"options.multiplier": "%sx",
	"options.musicToast": "Ειδοποίηση Μουσικής",
	"options.musicToast.never": "Ποτέ",
	"options.musicToast.never.tooltip": "Δεν εμφανίζεται ειδοποίηση μουσικής.",
	"options.musicToast.pauseMenu": "Μενού Παύσης",
	"options.musicToast.pauseMenu.tooltip": "Μια ειδοποίηση μουσικής εμφανίζεται συνεχώς στο μενού παύσης στο παιχνίδι ενώ παίζει ένα κομμάτι.",
	"options.musicToast.pauseMenuAndToast": "Μενού Παύσης και Ειδοποίηση",
	"options.musicToast.pauseMenuAndToast.tooltip": "Εμφανίζει μια ειδοποίηση όταν ένα κομμάτι ξεκινάει να παίζει. Η ίδια ειδοποίηση εμφανίζεται συνεχώς στο μενού παύσης στο παιχνίδι ενώ παίζει ένα κομμάτι.",
	"options.music_frequency": "Συχνότητα Μουσικής",
	"options.music_frequency.constant": "Σταθερή",
	"options.music_frequency.default": "Προεπιλεγμένη",
	"options.music_frequency.frequent": "Συχνή",
	"options.music_frequency.tooltip": "Αλλάζει πόσο συχνά παίζει μουσική σε έναν κόσμο παιχνιδιού.",
	...
	"options.needsRestart": "Απαιτεί επανεκκίνηση του παιχνιδιού για να εφαρμοστεί.",
	...
	"options.online.friends.header": "Λίστα Φίλων",
	"options.online.realms.header": "Realms",
	"options.online.servers.header": "Διακομιστές",
	"options.online.title": "Επιλογές Διαδικτυακού Παιχνιδιού",
	"options.online.xboxSettings": "Ρυθμίσεις Xbox...",
	...
	"options.realmsNotifications": "Ειδήσεις των Realms & Προσκλήσεις",
	"options.realmsNotifications.button": "Νέα & Προσκλήσεις",
	"options.realmsNotifications.tooltip": "Λαμβάνει ειδήσεις των Realms και προσκλήσεις στην οθόνη τίτλου και εμφανίζει το ανάλογό τους εικονίδιο στο κουμπί Realms.",
	"options.reducedDebugInfo": "Μειωμένες Πληροφορίες Αποσφαλμάτωσης",
	"options.renderClouds": "Σύννεφα",
	"options.renderCloudsDistance": "Απόσταση Σύννεφων",
	...
	"options.rotateWithMinecart": "Περιστροφή με Βαγονέτα",
	"options.rotateWithMinecart.tooltip": "Αν το πεδίο ορατότητας του παίκτη πρέπει να περιστρέφεται με ένα στρεφόμενο Βαγονέτο. Μόνο διαθέσιμο σε κόσμους με την πειραματική ρύθμιση «Βελτιώσεις Βαγονέτου» ενεργοποιημένη.",
	"options.screenEffectScale": "Εφέ Παραμόρφωσης",
	"options.screenEffectScale.tooltip": "Ισχύς των εφέ παραμόρφωσης οθόνης Ναυτίας και Πύλης Νέδερ.\nΣε χαμηλότερες τιμές, η επίδραση της Ναυτίας αντικαθίσταται με ένα πράσινο επίστρωμα επικάλυψης.",
	"options.sensitivity": "Ευαισθησία",
	"options.sensitivity.max": "ΥΠΕΡΤΑΧΥΤΗΤΑ!!!",
	"options.sensitivity.min": "*χασμουρητό*",
	"options.sharePresence": "Παρουσία",
	"options.sharePresence.all": "Όλα",
	...
	"options.sharePresence.limited": "Περιορισμένη",
	...
	"options.sharePresence.none": "Καθόλου",
	"options.sharePresence.none.tooltip": "Not sharing any presence. Appearing as offline.",
	"options.showNowPlayingToast": "Εμφάνιση Ειδοποίησης Μουσικής",
	"options.showNowPlayingToast.tooltip": "Εμφανίζει μια ειδοποίηση όταν ένα κομμάτι ξεκινάει να παίζει. Η ίδια ειδοποίηση εμφανίζεται συνεχώς στο μενού παύσης στο παιχνίδι ενώ παίζει ένα κομμάτι.",
	"options.showSubtitles": "Υπότιτλοι",
	"options.showSubtitles.tooltip": "Ενεργοποιεί υπότιτλους για ήχους που παίζονται στο παιχνίδι.",
	...
	"options.sprintWindow": "Περιθώριο Τρεξίματος",
	"options.sprintWindow.tooltip": "Χρονικό περιθώριο σε τικ όπου το διπλό πάτημα του πλήκτρου βαδίσματος μπροστά ενεργοποιεί το τρέξιμο.",
	...
	"options.telemetry.disabled": "Η τηλεμετρία είναι απενεργοποιημένη.",
	"options.telemetry.state.all": "Όλων",
	"options.telemetry.state.minimal": "Ελάχιστων",
	"options.telemetry.state.none": "Καθόλου",
	"options.textureFiltering": "Φιλτράρισμα Υφών",
	"options.textureFiltering.anisotropic": "Ανισότροπο",
	"options.textureFiltering.anisotropic.tooltip": "Μια μέθοδος φιλτραρίσματος υλισμικού, αλλά επηρεάζει την απόδοση και επηρεάζει σημαντικά τη χρήση μνήμης βίντεο. Μπορεί να μην υποστηρίζεται σε όλα τα υλισμικά.",
	"options.textureFiltering.none": "Καθόλου",
	"options.textureFiltering.none.tooltip": "Οι υφές εμφανίζονται χωρίς κανένα φιλτράρισμα. Οι κύβοι μπορεί να φαίνονται θολοί από γωνία.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nΜια μέθοδος φιλτραρίσματος σκίαστρου που βελτιώνει σημαντικά την ποιότητα υφών με μια μέτρια επίδραση στην απόδοση.",
	"options.title": "Επιλογές",
	"options.touchscreen": "Λειτουργία Οθόνης Αφής",
	"options.value": "%s",
	"options.video": "Ρυθμίσεις Βίντεο...",
	"options.video.display.header": "Εμφάνιση",
	"options.video.interface.header": "Διεπαφή",
	"options.video.preferences.header": "Προτιμήσεις",
	"options.video.quality.header": "Ποιότητα & Απόδοση",
	"options.videoTitle": "Ρυθμίσεις Βίντεο",
	"options.viewBobbing": "Κούνημα Πεδίου Ορατότητας",
	"options.vignette": "Εμφάνιση Βινιέτας",
	"options.vignette.tooltip": "Αυτή είναι μια ήπια υφή πάνω από την οθόνη του παιχνιδιού που χρησιμοποιείται για τη μείωση της φωτεινότητας κοντά στις άκρες της οθόνης και την προειδοποίηση για τα σύνορα του κόσμου.",
	"options.visible": "Ορατό",
	"options.vsync": "VSync",
	"options.weatherRadius": "Ακτίνα Καιρικών Φαινομένων",
	"options.weatherRadius.tooltip": "Ακτίνα της περιοχής όπου τα φαινόμενα βροχής και χιονιού είναι ορατά. Πολύ χαμηλή επίδραση στην απόδοση.",
	"options.worldOptions.button": "Επιλογές Κόσμου...",
	"options.worldOptions.title": "Επιλογές Κόσμου",
	"outOfMemory.message": "Το Minecraft έχει ξεμείνει από μνήμη.\n\nΑυτό μπορεί να προκλήθηκε από ένα σφάλμα στο παιχνίδι ή από τη μη διάθεση αρκετής μνήμης στην Εικονική Μηχανή Java.\n\nΓια την αποτροπή αλλοίωσης κόσμου, έγινε έξοδος από το τρέχον παιχνίδι. Προσπαθήσαμε να διαθέσουμε αρκετή μνήμη για να σου επιτρέψουμε να πας πίσω στο κύριο μενού και να συνεχίσεις να παίζεις, αλλά αυτό μπορεί να μη λειτούργησε.\n\nΠαρακαλώ επανεκκίνησε το παιχνίδι αν δεις ξανά αυτό το μήνυμα.",
	"outOfMemory.title": "Δεν υπάρχει μνήμη!",
	"pack.available.title": "Διαθέσιμα",
	"pack.copyFailure": "Απέτυχε η αντιγραφή",
	"pack.dropConfirm": "Θέλεις να προσθέσεις τα ακόλουθα πακέτα στο Minecraft;",
	"pack.dropInfo": "Σύρε και τοποθέτησε αρχεία σε αυτό το παράθυρο για να προσθέσεις πακέτα",
	"pack.dropRejected.message": "Οι ακόλουθες καταχωρίσεις δεν ήταν έγκυρα πακέτα και δεν αντιγράφηκαν:\n %s",
	"pack.dropRejected.title": "Καταχωρίσεις που δεν είναι πακέτα",
	"pack.folderInfo": "(Τοποθέτησε τα αρχεία πακέτων εδώ)",
	"pack.incompatible": "Μη συμβατό",
	"pack.incompatible.confirm.new": "Αυτό το πακέτο δημιουργήθηκε για μια νεότερη έκδοση του Minecraft και μπορεί να μη λειτουργεί σωστά.",
	...
	"pack.incompatible.confirm.title": "Είσαι βέβαιος/βέβαιη ότι θέλεις να φορτώσεις αυτό το πακέτο;",
	"pack.incompatible.confirm.unknown": "Αυτό το πακέτο είναι αλλοιωμένο ή δημιουργήθηκε για μια άγνωστη έκδοση του Minecraft και μπορεί να μη λειτουργεί σωστά.",
	...
	"pack.incompatible.unknown": "(Αλλοιωμένο ή μη συμβατό)",
	...
	"painting.minecraft.backyard.author": "Κρίστοφερ Ζέτερστραντ",
	"painting.minecraft.backyard.title": "Backyard",
	"painting.minecraft.baroque.author": "Σάρα Μπόουβινγκ",
	...
	"painting.minecraft.bouquet.author": "Κρίστοφερ Ζέτερστραντ",
	...
	"painting.minecraft.cavebird.author": "Κρίστοφερ Ζέτερστραντ",
	"painting.minecraft.cavebird.title": "Cavebird",
	"painting.minecraft.changing.author": "Κρίστοφερ Ζέτερστραντ",
	"painting.minecraft.changing.title": "Changing",
	"painting.minecraft.cotan.author": "Κρίστοφερ Ζέτερστραντ",
	...
	"painting.minecraft.dennis.author": "Σάρα Μπόουβινγκ",
	...
	"painting.minecraft.endboss.author": "Κρίστοφερ Ζέτερστραντ",
	"painting.minecraft.endboss.title": "Endboss",
	"painting.minecraft.fern.author": "Κρίστοφερ Ζέτερστραντ",
	...
	"painting.minecraft.finding.author": "Κρίστοφερ Ζέτερστραντ",
	...
	"painting.minecraft.humble.author": "Σάρα Μπόουβινγκ",
	...
	"painting.minecraft.lowmist.author": "Κρίστοφερ Ζέτερστραντ",
	...
	"painting.minecraft.meditative.author": "Σάρα Μπόουβινγκ",
	"painting.minecraft.meditative.title": "Meditative",
	"painting.minecraft.orb.author": "Κρίστοφερ Ζέτερστραντ",
	"painting.minecraft.orb.title": "Orb",
	"painting.minecraft.owlemons.author": "Κρίστοφερ Ζέτερστραντ",
	"painting.minecraft.owlemons.title": "Owlemons",
	"painting.minecraft.passage.author": "Κρίστοφερ Ζέτερστραντ",
	...
	"painting.minecraft.pond.author": "Κρίστοφερ Ζέτερστραντ",
	...
	"painting.minecraft.prairie_ride.author": "Σάρα Μπόουβινγκ",
	...
	"painting.minecraft.sunflowers.author": "Κρίστοφερ Ζέτερστραντ",
	...
	"painting.minecraft.tides.author": "Κρίστοφερ Ζέτερστραντ",
	"painting.minecraft.tides.title": "Tides",
	"painting.minecraft.unpacked.author": "Σάρα Μπόουβινγκ",
	...
	"parsing.double.expected": "Αναμενόταν αριθμός κινητής υποδιαστολής διπλής ακρίβειας",
	"parsing.double.invalid": "Μη έγκυρος αριθμός κινητής υποδιαστολής διπλής ακρίβειας «%s»",
	"parsing.expected": "Αναμενόταν «%s»",
	"parsing.float.expected": "Αναμενόταν αριθμός κινητής υποδιαστολής απλής ακρίβειας",
	"parsing.float.invalid": "Μη έγκυρος αριθμός κινητής υποδιαστολής απλής ακρίβειας «%s»",
	...
	"particle.invalidOptions": "Δεν μπορούν να αναλυθούν οι επιλογές του σωματιδίου: %s",
	...
	"quickplay.error.invalid_identifier": "Δεν μπόρεσε να βρεθεί κόσμος με το αναγνωριστικό που δόθηκε",
	"quickplay.error.realm_connect": "Δεν μπόρεσε να γίνει σύνδεση στο Realm",
	"quickplay.error.realm_permission": "Λείπει η άδεια σύνδεσης σε αυτό το Realm",
	"quickplay.error.title": "Απέτυχε το Γρήγορο Παιχνίδι",
	"realms.configuration.region.australia_east": "Νέα Νότια Ουαλία, Αυστραλία",
	"realms.configuration.region.australia_southeast": "Βικτώρια, Αυστραλία",
	"realms.configuration.region.brazil_south": "Βραζιλία",
	"realms.configuration.region.central_india": "Ινδία",
	"realms.configuration.region.central_us": "Άιοβα, ΗΠΑ",
	"realms.configuration.region.east_asia": "Χονγκ Κονγκ",
	"realms.configuration.region.east_us": "Βιρτζίνια, ΗΠΑ",
	"realms.configuration.region.east_us_2": "Βόρεια Καρολίνα, ΗΠΑ",
	"realms.configuration.region.france_central": "Γαλλία",
	"realms.configuration.region.japan_east": "Ανατολική Ιαπωνία",
	"realms.configuration.region.japan_west": "Δυτική Ιαπωνία",
	"realms.configuration.region.korea_central": "Νότια Κορέα",
	"realms.configuration.region.north_central_us": "Ιλινόι, ΗΠΑ",
	"realms.configuration.region.north_europe": "Ιρλανδία",
	"realms.configuration.region.south_central_us": "Τέξας, ΗΠΑ",
	"realms.configuration.region.southeast_asia": "Σιγκαπούρη",
	"realms.configuration.region.sweden_central": "Σουηδία",
	"realms.configuration.region.uae_north": "Ηνωμένα Αραβικά Εμιράτα (ΗΑΕ)",
	"realms.configuration.region.uk_south": "Νότια Αγγλία",
	"realms.configuration.region.west_central_us": "Γιούτα, ΗΠΑ",
	"realms.configuration.region.west_europe": "Ολλανδία",
	"realms.configuration.region.west_us": "Καλιφόρνια, ΗΠΑ",
	"realms.configuration.region.west_us_2": "Ουάσινγκτον, ΗΠΑ",
	"realms.configuration.region_preference.automatic_owner": "Αυτόματη (σύνδεση ιδιοκτήτη Realm)",
	"realms.configuration.region_preference.automatic_player": "Αυτόματη (πρώτος που συνδέεται στη συνεδρία)",
	"realms.missing.snapshot.error.text": "Τα Realms δεν υποστηρίζονται τώρα σε στιγμιότυπα",
	"recipe.notFound": "Άγνωστη συνταγή: %s",
	"recipe.toast.description": "Δες τις συνταγές",
	"recipe.toast.title": "Νέα Συνταγή Ξεκλειδώθηκε/Νέες Συνταγές Ξεκλειδώθηκαν!",
	"record.nowPlaying": "Τώρα Παίζει: %s",
	"recover_world.bug_tracker": "Αναφορά Ενός Σφάλματος",
	"recover_world.button": "Προσπάθεια Ανάκτησης",
	"recover_world.done.failed": "Απέτυχε η ανάκτηση από προηγούμενη κατάσταση.",
	"recover_world.done.success": "Η ανάκτηση ήταν επιτυχής!",
	"recover_world.done.title": "Η ανάκτηση ολοκληρώθηκε",
	"recover_world.issue.missing_file": "Λείπει το αρχείο",
	"recover_world.issue.none": "Κανένα πρόβλημα",
	"recover_world.message": "Τα ακόλουθα προβλήματα προέκυψαν κατά την προσπάθεια ανάγνωσης του φακέλου κόσμου «%s».\nΜπορεί να είναι δυνατό να επαναφέρεις τον κόσμο από μια παλιότερη κατάσταση ή μπορείς να αναφέρεις αυτό το πρόβλημα στον ανιχνευτή σφαλμάτων.",
	"recover_world.no_fallback": "Καμία κατάσταση για ανάκτηση διαθέσιμη",
	"recover_world.restore": "Προσπάθεια Επαναφοράς",
	"recover_world.restoring": "Προσπάθεια επαναφοράς κόσμου...",
	"recover_world.state_entry": "Κατάσταση από %s: ",
	"recover_world.state_entry.unknown": "άγνωστο",
	"recover_world.title": "Απέτυχε η φόρτωση του κόσμου",
	"recover_world.warning": "Απέτυχε η φόρτωση της περίληψης του κόσμου",
	...
	"resourcePack.runtime_failure": "Εντοπίστηκε σφάλμα πακέτου πόρων",
	"resourcePack.server.name": "Πόροι Ανά Κόσμο",
	"resourcePack.title": "Επιλογή Πακέτων Πόρων",
	"resourcePack.vanilla.description": "Η προεπιλεγμένη εμφάνιση και αίσθηση του Minecraft",
	...
	"restrictions_screen.button": "Περιορισμοί...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Μπορείς να λάβεις μηνύματα από παίκτες",
	"restrictions_screen.permission.receive_player_messages.denied": "Δεν μπορείς να λάβεις μηνύματα από παίκτες",
	"restrictions_screen.permission.receive_system_messages.allowed": "Μπορείς να λάβεις μηνύματα συστήματος από τον διακομιστή",
	"restrictions_screen.permission.receive_system_messages.denied": "Δεν μπορείς να λάβεις μηνύματα συστήματος από τον διακομιστή",
	"restrictions_screen.permission.send_commands.allowed": "Μπορείς να στείλεις εντολές",
	"restrictions_screen.permission.send_commands.denied": "Δεν μπορείς να στείλεις εντολές",
	"restrictions_screen.permission.send_messages.allowed": "Μπορείς να στείλεις μηνύματα συνομιλίας",
	"restrictions_screen.permission.send_messages.denied": "Δεν μπορείς να στείλεις μηνύματα συνομιλίας",
	"restrictions_screen.title": "Περιορισμοί",
	...
	"selectServer.deleteQuestion": "Είσαι βέβαιος/βέβαιη ότι θέλεις να καταργήσεις αυτόν τον διακομιστή;",
	...
	"selectServer.select": "Σύνδεση στον Διακομιστή",
	"selectWorld.access_failure": "Απέτυχε η πρόσβαση στον κόσμο",
	"selectWorld.allowCommands": "Επίτρεψη Αδειών Διαχειριστή",
	"selectWorld.allowCommands.info": "Εντολές όπως /gamemode, /experience",
	"selectWorld.allowCommands.new": "Επίτρεψη Εντολών",
	"selectWorld.backupEraseCache": "Διαγραφή Αποθηκευμένων Δεδομένων",
	"selectWorld.backupJoinConfirmButton": "Δημιουργία Αντιγράφου Ασφαλείας και Φόρτωση",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Δημιουργία ενός αντιγράφου ασφαλείας πριν την αναβάθμιση αυτού του κόσμου;",
	"selectWorld.backupQuestion.snapshot": "Είσαι βέβαιος/βέβαιη ότι θέλεις να φορτώσεις αυτόν τον κόσμο;",
	...
	"selectWorld.backupWarning.downgrade": "Αυτός ο κόσμος παίχτηκε τελευταία φορά στην έκδοση %s· είσαι στην έκδοση %s. Η υποβάθμιση ενός κόσμου μπορεί να προκαλέσει αλλοίωση - δεν μπορούμε να εγγυηθούμε ότι θα φορτώσει ή θα λειτουργήσει. Αν ακόμη θέλεις να συνεχίσεις, παρακαλώ δημιούργησε ένα αντίγραφο ασφαλείας.",
	"selectWorld.backupWarning.experimental": "Αυτός ο κόσμος χρησιμοποιεί πειραματικές ρυθμίσεις οι οποίες μπορεί να σταματήσουν να λειτουργούν οποιαδήποτε στιγμή. Δεν μπορούμε να εγγυηθούμε ότι θα φορτώσει ή θα λειτουργήσει. Προσοχή!",
	"selectWorld.backupWarning.file_fixing_required": "Αυτός ο κόσμος πρέπει να αναβαθμιστεί πριν μπορέσεις να τον παίξεις. Προτείνουμε ανεπιφύλακτα τη δημιουργία ενός αντιγράφου ασφαλείας πριν συνεχίσεις σε περίπτωση που αντιμετωπίσεις αλλοίωση κόσμου.",
	"selectWorld.backupWarning.snapshot": "Αυτός ο κόσμος παίχτηκε τελευταία φορά στην έκδοση %s· είσαι στην έκδοση %s. Παρακαλώ δημιούργησε ένα αντίγραφο ασφαλείας σε περίπτωση που αντιμετωπίσεις αλλοίωση κόσμου.",
	"selectWorld.bonusItems": "Επιπλέον Σεντούκι",
	"selectWorld.cheats": "Άδειες Διαχειριστή",
	"selectWorld.commands": "Εντολές",
	...
	"selectWorld.data_read": "Ανάγνωση δεδομένων κόσμου...",
	"selectWorld.delete": "Διαγραφή",
	"selectWorld.deleteButton": "Διαγραφή",
	"selectWorld.deleteQuestion": "Είσαι βέβαιος/βέβαιη ότι θέλεις να διαγράψεις αυτόν τον κόσμο;",
	"selectWorld.deleteWarning": "Ο κόσμος «%s» θα χαθεί για πάντα! (Πολύς καιρός!)",
	"selectWorld.delete_failure": "Απέτυχε η διαγραφή του κόσμου",
	...
	"selectWorld.edit.backupFolder": "Άνοιγμα Φακέλου Αντιγράφων Ασφαλείας Κόσμου",
	...
	"selectWorld.enterSeed": "Seed για τον δημιουργό κόσμων",
	...
	"selectWorld.experimental.message": "Προσοχή!\nΑυτή η διαμόρφωση απαιτεί λειτουργίες που είναι ακόμη υπό ανάπτυξη. Ο κόσμος σου μπορεί να κρασάρει, χαλάσει, ή να μη λειτουργεί με μελλοντικές ενημερώσεις.",
	"selectWorld.experimental.title": "Προειδοποίηση Πειραματικών Λειτουργιών",
	"selectWorld.experiments": "Πειράματα",
	"selectWorld.experiments.info": "Τα Πειράματα είναι πιθανές νέες λειτουργίες. Να προσέχεις επειδή ορισμένα πράγματα μπορεί να χαλάσουν. Τα Πειράματα δεν μπορούν να απενεργοποιηθούν μετά τη δημιουργία κόσμου.",
	...
	"selectWorld.gameMode.creative.info": "Δημιουργείς, χτίζεις, και εξερευνάς χωρίς όρια. Μπορείς να πετάξεις, να έχεις απεριόριστα υλικά, και δεν μπορείς να τραυματιστείς από τέρατα.",
	...
	"selectWorld.gameMode.hardcore.info": "Λειτουργία Επιβίωσης κλειδωμένη στη «Δύσκολη» δυσκολία. Δεν μπορείς να αναγεννηθείς αν πεθάνεις.",
	...
	"selectWorld.gameMode.spectator.info": "Μπορείς να δεις αλλά δεν αγγίζεις.",
	"selectWorld.gameMode.spectator.line1": "Μπορείς να δεις αλλά δεν αγγίζεις",
	"selectWorld.gameMode.survival": "Επιβίωσης",
	"selectWorld.gameMode.survival.info": "Εξερευνάς έναν μυστηριώδη κόσμο όπου χτίζεις, συλλέγεις, κατασκευάζεις, και πολεμάς τέρατα.",
	"selectWorld.gameMode.survival.line1": "Αναζητάς πόρους, κατασκευάζεις, αποκτάς",
	...
	"selectWorld.incompatible.description": "Αυτός ο κόσμος δεν μπορεί να ανοιχτεί σε αυτήν την έκδοση.\nΠαίχτηκε τελευταία φορά στην έκδοση %s.",
	"selectWorld.incompatible.info": "Μη συμβατή έκδοση: %s",
	"selectWorld.incompatible.title": "Μη συμβατή έκδοση",
	"selectWorld.incompatible.tooltip": "Αυτός ο κόσμος δεν μπορεί να ανοιχτεί επειδή δημιουργήθηκε από μια μη συμβατή έκδοση.",
	...
	"selectWorld.locked": "Κλειδωμένος από άλλη παρουσία του Minecraft που τρέχει.",
	...
	"selectWorld.recreate.customized.text": "Οι προσαρμοσμένοι κόσμοι δεν υποστηρίζονται πλέον σε αυτήν την έκδοση του Minecraft. Μπορούμε να προσπαθήσουμε να τον αναδημιουργήσουμε με ίδιο seed και ιδιότητες, αλλά οποιαδήποτε προσαρμογή εδάφους θα χαθεί. Συγγνώμη για την αναστάτωση!",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Αυτός ο κόσμος πρέπει να αναβαθμιστεί στην τελευταία έκδοση πριν μπορέσεις να τον επεξεργαστείς λόγω υποκείμενων αλλαγών στη μορφή του κόσμου.",
	"selectWorld.requiresFileFixingTooltip.play": "Αυτός ο κόσμος πρέπει να αναβαθμιστεί στην τελευταία έκδοση πριν μπορέσεις να τον παίξεις λόγω υποκείμενων αλλαγών στη μορφή του κόσμου.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Αυτός ο κόσμος πρέπει να αναβαθμιστεί στην τελευταία έκδοση πριν μπορέσεις να τον αναδημιουργήσεις λόγω υποκείμενων αλλαγών στη μορφή του κόσμου.",
	"selectWorld.resource_load": "Προετοιμασία Πόρων...",
	"selectWorld.resultFolder": "Θα αποθηκευτεί στον φάκελο:",
	"selectWorld.search": "αναζήτηση για κόσμους",
	"selectWorld.seedInfo": "Άφησε κενό για ένα τυχαίο seed",
	...
	"selectWorld.tooltip.snapshot1": "Μην ξεχάσεις να δημιουργήσεις αντίγραφο ασφαλείας αυτού του κόσμου",
	"selectWorld.tooltip.snapshot2": "πριν τον φορτώσεις σε αυτό το στιγμιότυπο.",
	"selectWorld.unable_to_load": "Δεν ήταν δυνατή η φόρτωση των κόσμων",
	"selectWorld.upgrade_and_play": "Αναβάθμιση και Παιχνίδι",
	"selectWorld.version": "Έκδοση:",
	"selectWorld.versionJoinButton": "Φόρτωση Ούτως ή Άλλως",
	"selectWorld.versionQuestion": "Είσαι βέβαιος/βέβαιη ότι θέλεις να φορτώσεις αυτόν τον κόσμο;",
	"selectWorld.versionUnknown": "άγνωστη",
	"selectWorld.versionWarning": "Αυτός ο κόσμος παίχτηκε τελευταία φορά στην έκδοση %s και η φόρτωσή του σε αυτήν την έκδοση θα μπορούσε να προκαλέσει αλλοίωση!",
	"selectWorld.waitingForBackup.message": "Ανάλογα με το μέγεθος του κόσμου σου, αυτό μπορεί να πάρει χρόνο. Παρακαλώ μην κλείσεις το παιχνίδι ή τη συσκευή σου.",
	"selectWorld.waitingForBackup.title": "Δημιουργία Αντιγράφου Ασφαλείας",
	"selectWorld.warning.deprecated.question": "Ορισμένες λειτουργίες που χρησιμοποιούνται είναι απαρχαιωμένες και θα σταματήσουν να λειτουργούν στο μέλλον. Επιθυμείς να συνεχίσεις;",
	"selectWorld.warning.deprecated.title": "Προσοχή! Αυτές οι ρυθμίσεις χρησιμοποιούν απαρχαιωμένες λειτουργίες",
	"selectWorld.warning.experimental.question": "Αυτές οι ρυθμίσεις είναι πειραματικές και θα μπορούσαν μια μέρα να σταματήσουν να λειτουργούν. Επιθυμείς να συνεχίσεις;",
	"selectWorld.warning.experimental.title": "Προσοχή! Αυτές οι ρυθμίσεις χρησιμοποιούν πειραματικές λειτουργίες",
	"selectWorld.warning.lowDiskSpace.description": "Δεν απομένει πολύς χώρος στη συσκευή σου.\nΗ εξάντληση του χώρου δίσκου κατά τη διάρκεια του παιχνιδιού μπορεί να οδηγήσει σε αλλοίωση του κόσμου σου.",
	"selectWorld.warning.lowDiskSpace.title": "Προσοχή! Χαμηλή χωρητικότητα δίσκου!",
	"selectWorld.world": "Κόσμος",
	"selectWorld.world_gen_settings_access": "Δεν ήταν δυνατή η ανάγνωση ή πρόσβαση του αρχείου ρυθμίσεων δημιουργίας κόσμου! %s",
	"selecteWorld.backupRequiredTooltip": "Η φόρτωση του κόσμου απαιτεί τη λήψη ενός αντιγράφου ασφαλείας πρώτα",
	...
	"slot.only_single_allowed": "Μόνο μία θέση επιτρέπεται: λήφθηκαν «%s»",
	"slot.unknown": "Άγνωστη υποδοχή «%s»",
	"snbt.parser.empty_key": "Το κλειδί δεν μπορεί να είναι κενό",
	"snbt.parser.expected_binary_numeral": "Αναμενόταν ένας δυαδικός αριθμός",
	"snbt.parser.expected_decimal_numeral": "Αναμενόταν ένας δεκαδικός αριθμός",
	"snbt.parser.expected_float_type": "Αναμενόταν ένας αριθμός κινητής υποδιαστολής απλής ακρίβειας",
	"snbt.parser.expected_hex_escape": "Αναμενόταν ένα λεκτικό χαρακτήρων μήκους %s",
	"snbt.parser.expected_hex_numeral": "Αναμενόταν ένας δεκαεξαδικός αριθμός",
	"snbt.parser.expected_integer_type": "Αναμενόταν ένας ακέραιος αριθμός",
	"snbt.parser.expected_non_negative_number": "Αναμενόταν ένας μη αρνητικός αριθμός",
	"snbt.parser.expected_number_or_boolean": "Αναμενόταν ένας αριθμός ή μια δυαδική τιμή",
	"snbt.parser.expected_string_uuid": "Αναμενόταν μια συμβολοσειρά που να αντιπροσωπεύει ένα έγκυρο αναγνωριστικό",
	"snbt.parser.expected_unquoted_string": "Αναμενόταν μια έγκυρη συμβολοσειρά χωρίς εισαγωγικά",
	"snbt.parser.infinity_not_allowed": "Δεν επιτρέπονται μη πεπερασμένοι αριθμοί",
	"snbt.parser.invalid_array_element_type": "Μη έγκυρος τύπος στοιχείου πίνακα",
	"snbt.parser.invalid_character_name": "Μη έγκυρο όνομα χαρακτήρα Unicode",
	"snbt.parser.invalid_codepoint": "Μη έγκυρη τιμή χαρακτήρα Unicode: %s",
	"snbt.parser.invalid_string_contents": "Μη έγκυρα περιεχόμενα συμβολοσειράς",
	"snbt.parser.invalid_unquoted_start": "Οι συμβολοσειρές χωρίς εισαγωγικά δεν μπορούν να ξεκινούν με τα ψηφία 0-9, + ή -",
	"snbt.parser.leading_zero_not_allowed": "Οι δεκαδικοί αριθμοί δεν μπορούν να ξεκινούν με 0",
	"snbt.parser.no_such_operation": "Καμία τέτοια πράξη: %s",
	"snbt.parser.number_parse_failure": "Απέτυχε η ανάλυση του αριθμού: %s",
	"snbt.parser.undescore_not_allowed": "Οι χαρακτήρες υπογράμμισης δεν επιτρέπονται στην αρχή ή στο τέλος ενός αριθμού",
	"soundCategory.ambient": "Περιβάλλων Χώρος",
	"soundCategory.block": "Κύβοι",
	"soundCategory.hostile": "Εχθρικά Όντα",
	"soundCategory.master": "Κύρια Ένταση Ήχου",
	"soundCategory.music": "Μουσική",
	"soundCategory.neutral": "Φιλικά Όντα",
	"soundCategory.player": "Παίκτες",
	"soundCategory.record": "Τζούκμποξ/Κύβοι Νότας",
	"soundCategory.ui": "UI",
	"soundCategory.voice": "Αφηγητής/Φωνή",
	...
	"spectatorMenu.root.prompt": "Πάτησε ένα πλήκτρο για να επιλέξεις μια εντολή, και ξανά για να την εκτελέσεις.",
	"spectatorMenu.team_teleport": "Τηλεμεταφορά σε Μέλος Ομάδας",
	"spectatorMenu.team_teleport.prompt": "Επίλεξε μια ομάδα για να τηλεμεταφερθείς σε αυτήν",
	"spectatorMenu.teleport": "Τηλεμεταφορά σε Παίκτη",
	"spectatorMenu.teleport.prompt": "Επίλεξε έναν παίκτη για να τηλεμεταφερθείς σε αυτόν",
	...
	"stat.minecraft.damage_dealt_absorbed": "Ζημιά που Προκλήθηκε (Απορροφήθηκε)",
	"stat.minecraft.damage_dealt_resisted": "Ζημιά που Προκλήθηκε (Εμποδίστηκε)",
	"stat.minecraft.damage_resisted": "Ζημιά που Εμποδίστηκε",
	"stat.minecraft.damage_taken": "Ζημιά που Πάρθηκε",
	...
	"stat.minecraft.happy_ghast_one_cm": "Απόσταση με Ευτυχισμένο Γκαστ",
	...
	"stat.minecraft.interact_with_anvil": "Επαφές με Αμόνι",
	"stat.minecraft.interact_with_beacon": "Επαφές με Φάρο",
	"stat.minecraft.interact_with_blast_furnace": "Επαφές με Υψικάμινο",
	"stat.minecraft.interact_with_brewingstand": "Επαφές με Πάγκο Παρασκευής",
	"stat.minecraft.interact_with_campfire": "Επαφές με Φωτιά Κατασκήνωσης",
	"stat.minecraft.interact_with_cartography_table": "Επαφές με Τραπέζι Χαρτογραφίας",
	"stat.minecraft.interact_with_crafting_table": "Επαφές με Τραπέζι Κατασκευής",
	"stat.minecraft.interact_with_furnace": "Επαφές με Φούρνο",
	"stat.minecraft.interact_with_grindstone": "Επαφές με Ακονόπετρα",
	"stat.minecraft.interact_with_lectern": "Επαφές με Αναλόγιο",
	"stat.minecraft.interact_with_loom": "Επαφές με Αργαλειό",
	"stat.minecraft.interact_with_smithing_table": "Επαφές με Τραπέζι Σιδηρουργίας",
	"stat.minecraft.interact_with_smoker": "Επαφές με Καπνιστήρι",
	"stat.minecraft.interact_with_stonecutter": "Επαφές με Πετροκόπτη",
	...
	"stat.minecraft.nautilus_one_cm": "Απόσταση με Ναυτίλο",
	...
	"stat.minecraft.time_since_death": "Χρόνος σπό τον Τελευταίο Θάνατο",
	...
	"stat.minecraft.trigger_trapped_chest": "Σεντούκια Παγίδες που Ενεργοποιήθηκαν",
	...
	"stat.minecraft.walk_under_water_one_cm": "Απόσταση Περπατώντας Υποβρυχίως",
	...
	"stat_type.minecraft.killed": "Σκότωσες %s φορά/φορές το ον %s",
	"stat_type.minecraft.killed.none": "Δεν έχεις σκοτώσει ποτέ το ον %s",
	"stat_type.minecraft.killed_by": "Το ον %s σε σκότωσε %s φορά/φορές",
	"stat_type.minecraft.killed_by.none": "Δεν έχεις σκοτωθεί ποτέ από το ον %s",
	...
	"structure_block.size_failure": "Δεν ήταν δυνατή η ανίχνευση του μεγέθους δομής. Πρόσθεσε γωνίες με αντίστοιχα ονόματα δομών",
	"structure_block.size_success": "Το μέγεθος ανιχνεύτηκε για τη δομή «%s» με επιτυχία",
	"structure_block.strict": "Αυστηρή Τοποθέτηση:",
	"structure_block.structure_name": "Όνομα Δομής",
	"subtitles.ambient.cave": "Απόκοσμος θόρυβος",
	"subtitles.ambient.sound": "Απόκοσμος θόρυβος",
	...
	"subtitles.block.anvil.land": "Αμόνι προσγειώθηκε",
	...
	"subtitles.block.candle.extinguish": "Κερί σβήνει",
	"subtitles.block.chest.close": "Σεντούκι κλείνει",
	"subtitles.block.chest.locked": "Κλειδωμένο Σεντούκι",
	...
	"subtitles.block.copper_bulb.turn_off": "Λάμπα Χαλκού σβήνει",
	"subtitles.block.copper_bulb.turn_on": "Λάμπα Χαλκού ανάβει",
	"subtitles.block.copper_chest.close": "Σεντούκι κλείνει",
	"subtitles.block.copper_chest.open": "Σεντούκι ανοίγει",
	"subtitles.block.copper_trapdoor.close": "Καταπακτή κλείνει",
	"subtitles.block.copper_trapdoor.open": "Καταπακτή ανοίγει",
	"subtitles.block.crafter.craft": "Κατασκευαστής κατασκευάζει",
	"subtitles.block.crafter.fail": "Κατασκευαστής αποτυγχάνει στην κατασκευή",
	"subtitles.block.creaking_heart.hurt": "Καρδιά Τριξιτή μουγκρίζει",
	"subtitles.block.creaking_heart.idle": "Απόκοσμος θόρυβος",
	"subtitles.block.creaking_heart.spawn": "Καρδιά Τριξιτή ξυπνάει",
	"subtitles.block.deadbush.idle": "Ξεροί ήχοι",
	"subtitles.block.decorated_pot.insert": "Διακοσμημένο Αγγείο γεμίζει",
	"subtitles.block.decorated_pot.insert_fail": "Διακοσμημένο Αγγείο κουνιέται",
	"subtitles.block.decorated_pot.shatter": "Διακοσμημένο Αγγείο θρυμματίζεται",
	...
	"subtitles.block.dried_ghast.ambient": "Ήχοι ξηρασίας",
	"subtitles.block.dried_ghast.ambient_water": "Αφυδατωμένο Γκαστ ενυδατώνεται ξανά",
	"subtitles.block.dried_ghast.place_in_water": "Αφυδατωμένο Γκαστ μουσκεύεται",
	"subtitles.block.dried_ghast.transition": "Αφυδατωμένο Γκαστ αισθάνεται καλύτερα",
	"subtitles.block.dry_grass.ambient": "Ανεμώδεις ήχοι",
	...
	"subtitles.block.eyeblossom.close": "Οφθάλμανθος κλείνει",
	"subtitles.block.eyeblossom.idle": "Οφθάλμανθος ψιθυρίζει",
	"subtitles.block.eyeblossom.open": "Οφθάλμανθος ανοίγει",
	...
	"subtitles.block.firefly_bush.idle": "Πυγολαμπίδες βουίζουν",
	...
	"subtitles.block.generic.fall": "Κάτι πέφτει πάνω σε έναν κύβο",
	"subtitles.block.generic.footsteps": "Βήματα",
	"subtitles.block.generic.hit": "Κύβος σπάει",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Πινακίδα κουνιέται",
	...
	"subtitles.block.pale_hanging_moss.idle": "Απόκοσμος θόρυβος",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Πηγή Θείου εκρήγνυται",
	"subtitles.block.potent_sulfur.noxious_gas": "Βλαβερό αέριο εμφανίζεται",
	...
	"subtitles.block.respawn_anchor.ambient": "Άγκυρα Αναγέννησης βουίζει",
	...
	"subtitles.block.sand.idle": "Αμμώδεις ήχοι",
	"subtitles.block.sand.wind": "Ανεμώδεις ήχοι",
	...
	"subtitles.block.sculk_sensor.clicking": "Αισθητήρας Σκαλκ κάνει κλικ",
	...
	"subtitles.block.shelf.activate": "Ράφι ενεργοποιείται",
	"subtitles.block.shelf.deactivate": "Ράφι απενεργοποιείται",
	"subtitles.block.shelf.multi_swap": "Αντικείμενα αλλάζουν",
	"subtitles.block.shelf.place_item": "Αντικείμενο τοποθετείται",
	"subtitles.block.shelf.single_swap": "Αντικείμενο αλλάζει",
	"subtitles.block.shelf.take_item": "Αντικείμενο αφαιρείται",
	"subtitles.block.shulker_box.close": "Κιβώτιο Σάλκερ κλείνει",
	"subtitles.block.shulker_box.open": "Κιβώτιο Σάλκερ ανοίγει",
	"subtitles.block.sign.waxed_interact_fail": "Πινακίδα κουνιέται",
	"subtitles.block.smithing_table.use": "Τραπέζι Μεταλλουργίας χρησιμοποιείται",
	"subtitles.block.smoker.smoke": "Καπνιστήρι καπνίζει",
	"subtitles.block.sniffer_egg.crack": "Αβγό Οσφρητή ραγίζει",
	"subtitles.block.sniffer_egg.hatch": "Αβγό Οσφρητή εκκολάπτεται",
	"subtitles.block.sniffer_egg.plop": "Οσφρητής γεννάει αβγό",
	"subtitles.block.sponge.absorb": "Σφουγγάρι απορροφάει",
	"subtitles.block.sweet_berry_bush.pick_berries": "Μούρα πέφτουν",
	"subtitles.block.trapdoor.close": "Καταπακτή κλείνει",
	"subtitles.block.trapdoor.open": "Καταπακτή ανοίγει",
	"subtitles.block.trapdoor.toggle": "Καταπακτή τρίζει",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Δυσοίωνο αντικείμενο προετοιμάζεται",
	"subtitles.block.trial_spawner.ambient": "Γεννήτρια Δοκιμασίας κροταλίζει",
	"subtitles.block.trial_spawner.ambient_charged": "Δυσοίωνο κροτάλισμα",
	"subtitles.block.trial_spawner.ambient_ominous": "Δυσοίωνο κροτάλισμα",
	"subtitles.block.trial_spawner.charge_activate": "Οιωνός καλύπτει Γεννήτρια Δοκιμασίας",
	"subtitles.block.trial_spawner.close_shutter": "Γεννήτρια Δοκιμασίας κλείνει",
	"subtitles.block.trial_spawner.detect_player": "Γεννήτρια Δοκιμασίας φορτίζει",
	"subtitles.block.trial_spawner.eject_item": "Γεννήτρια Δοκιμασίας βγάζει αντικείμενα",
	"subtitles.block.trial_spawner.ominous_activate": "Οιωνός καλύπτει Γεννήτρια Δοκιμασίας",
	"subtitles.block.trial_spawner.open_shutter": "Γεννήτρια Δοκιμασίας ανοίγει",
	"subtitles.block.trial_spawner.spawn_item": "Δυσοίωνο αντικείμενο ρίχνεται",
	"subtitles.block.trial_spawner.spawn_item_begin": "Δυσοίωνο αντικείμενο εμφανίζεται",
	"subtitles.block.trial_spawner.spawn_mob": "Γεννήτρια Δοκιμασίας γεννάει ένα ον",
	...
	"subtitles.block.vault.activate": "Θησαυροφυλάκιο ανάβει",
	"subtitles.block.vault.ambient": "Θησαυροφυλάκιο κροταλίζει",
	"subtitles.block.vault.close_shutter": "Θησαυροφυλάκιο κλείνει",
	"subtitles.block.vault.deactivate": "Θησαυροφυλάκιο σβήνει",
	"subtitles.block.vault.eject_item": "Θησαυροφυλάκιο βγάζει αντικείμενο",
	"subtitles.block.vault.insert_item": "Θησαυροφυλάκιο ξεκλειδώνει",
	"subtitles.block.vault.insert_item_fail": "Θησαυροφυλάκιο απορρίπτει αντικείμενο",
	"subtitles.block.vault.open_shutter": "Θησαυροφυλάκιο ανοίγει",
	"subtitles.block.vault.reject_rewarded_player": "Θησαυροφυλάκιο απορρίπτει παίκτη",
	"subtitles.block.water.ambient": "Νερό ρέει",
	"subtitles.block.wet_sponge.dries": "Σφουγγάρι στεγνώνει",
	...
	"subtitles.entity.armadillo.ambient": "Αρμαδίλος γρυλίζει",
	"subtitles.entity.armadillo.brush": "Φολίδα ξεσκονίζεται",
	"subtitles.entity.armadillo.death": "Αρμαδίλος πεθαίνει",
	"subtitles.entity.armadillo.eat": "Αρμαδίλος τρώει",
	"subtitles.entity.armadillo.hurt": "Αρμαδίλος τραυματίζεται",
	"subtitles.entity.armadillo.hurt_reduced": "Αρμαδίλος προστατεύεται",
	"subtitles.entity.armadillo.land": "Αρμαδίλος προσγειώνεται",
	"subtitles.entity.armadillo.peek": "Αρμαδίλος κρυφοκοιτάζει",
	"subtitles.entity.armadillo.roll": "Αρμαδίλος τυλίγεται",
	"subtitles.entity.armadillo.scute_drop": "Αρμαδίλος αποβάλλει φολίδα",
	"subtitles.entity.armadillo.unroll_finish": "Αρμαδίλος ξετυλίγεται",
	"subtitles.entity.armadillo.unroll_start": "Αρμαδίλος κρυφοκοιτάζει",
	"subtitles.entity.armor_stand.fall": "Κάτι έπεσε",
	"subtitles.entity.arrow.hit": "Βέλος χτυπάει",
	"subtitles.entity.arrow.hit_player": "Παίκτης χτυπιέται",
	...
	"subtitles.entity.baby_cat.ambient": "Γατάκι νιαουρίζει",
	"subtitles.entity.baby_cat.beg_for_food": "Γατάκι ζητιανεύει",
	"subtitles.entity.baby_cat.death": "Γατάκι πεθαίνει",
	"subtitles.entity.baby_cat.eat": "Γατάκι τρώει",
	"subtitles.entity.baby_cat.hiss": "Γατάκι συρίζει",
	"subtitles.entity.baby_cat.hurt": "Γατάκι τραυματίζεται",
	"subtitles.entity.baby_cat.purr": "Γατάκι γουργουρίζει",
	"subtitles.entity.baby_chicken.ambient": "Κλωσσόπουλο τιτιβίζει",
	"subtitles.entity.baby_chicken.death": "Κλωσσόπουλο πεθαίνει",
	"subtitles.entity.baby_chicken.hurts": "Κλωσσόπουλο τραυματίζεται",
	"subtitles.entity.baby_horse.ambient": "Πουλάρι χλιμιντρίζει",
	"subtitles.entity.baby_horse.angry": "Πουλάρι χλιμιντρίζει",
	"subtitles.entity.baby_horse.breathe": "Πουλάρι αναπνέει",
	"subtitles.entity.baby_horse.death": "Πουλάρι πεθαίνει",
	"subtitles.entity.baby_horse.eat": "Πουλάρι τρώει",
	"subtitles.entity.baby_horse.hurt": "Πουλάρι τραυματίζεται",
	"subtitles.entity.baby_horse.land": "Πουλάρι προσγειώνεται",
	"subtitles.entity.baby_nautilus.ambient": "Μωρό Ναυτίλος τιτιβίζει",
	"subtitles.entity.baby_nautilus.ambient_land": "Μωρό Ναυτίλος τιτιβίζει",
	"subtitles.entity.baby_nautilus.death": "Μωρό Ναυτίλος πεθαίνει",
	"subtitles.entity.baby_nautilus.death_land": "Μωρό Ναυτίλος πεθαίνει",
	"subtitles.entity.baby_nautilus.eat": "Μωρό Ναυτίλος τρώει",
	"subtitles.entity.baby_nautilus.hurt": "Μωρό Ναυτίλος τραυματίζεται",
	"subtitles.entity.baby_nautilus.hurt_land": "Μωρό Ναυτίλος τραυματίζεται",
	"subtitles.entity.baby_nautilus.swim": "Μωρό Ναυτίλος κολυμπάει",
	"subtitles.entity.baby_pig.ambient": "Μωρό Γουρούνι γρυλίζει",
	"subtitles.entity.baby_pig.death": "Μωρό Γουρούνι πεθαίνει",
	"subtitles.entity.baby_pig.eat": "Μωρό Γουρούνι τρώει",
	"subtitles.entity.baby_pig.hurt": "Μωρό Γουρούνι τραυματίζεται",
	"subtitles.entity.baby_wolf.ambient": "Κουτάβι γαβγίζει",
	"subtitles.entity.baby_wolf.death": "Κουτάβι πεθαίνει",
	"subtitles.entity.baby_wolf.growl": "Κουτάβι γρυλίζει",
	"subtitles.entity.baby_wolf.hurt": "Κουτάβι τραυματίζεται",
	"subtitles.entity.baby_wolf.pant": "Κουτάβι γαβγίζει",
	"subtitles.entity.baby_wolf.whine": "Κουτάβι βογκάει",
	...
	"subtitles.entity.bogged.ambient": "Βαλτωμένος κροταλίζει",
	"subtitles.entity.bogged.death": "Βαλτωμένος πεθαίνει",
	"subtitles.entity.bogged.hurt": "Βαλτωμένος τραυματίζεται",
	"subtitles.entity.breeze.charge": "Ανεμοστρόβιλος ορμάει",
	"subtitles.entity.breeze.death": "Ανεμοστρόβιλος πεθαίνει",
	"subtitles.entity.breeze.deflect": "Ανεμοστρόβιλος εκτρέπει",
	"subtitles.entity.breeze.hurt": "Ανεμοστρόβιλος τραυματίζεται",
	"subtitles.entity.breeze.idle_air": "Ανεμοστρόβιλος πετάει",
	"subtitles.entity.breeze.idle_ground": "Ανεμοστρόβιλος βουίζει",
	"subtitles.entity.breeze.inhale": "Ανεμοστρόβιλος εισπνέει",
	"subtitles.entity.breeze.jump": "Ανεμοστρόβιλος πηδάει",
	"subtitles.entity.breeze.land": "Ανεμοστρόβιλος προσγειώνεται",
	"subtitles.entity.breeze.shoot": "Ανεμοστρόβιλος στοχεύει",
	"subtitles.entity.breeze.slide": "Ανεμοστρόβιλος κυλάει",
	"subtitles.entity.breeze.whirl": "Ανεμοστρόβιλος στροβιλίζεται",
	"subtitles.entity.breeze.wind_burst": "Φορτίο Ανέμου εκρήγνυται",
	...
	"subtitles.entity.camel_husk.ambient": "Μούμια Καμήλα μουγκρίζει",
	"subtitles.entity.camel_husk.dash": "Μούμια Καμήλα ορμάει",
	"subtitles.entity.camel_husk.dash_ready": "Μούμια Καμήλα ανακάμπτει",
	"subtitles.entity.camel_husk.death": "Μούμια Καμήλα πεθαίνει",
	"subtitles.entity.camel_husk.eat": "Μούμια Καμήλα τρώει",
	"subtitles.entity.camel_husk.hurt": "Μούμια Καμήλα τραυματίζεται",
	"subtitles.entity.camel_husk.saddle": "Σέλα φοριέται",
	"subtitles.entity.camel_husk.sit": "Μούμια Καμήλα κάθεται",
	"subtitles.entity.camel_husk.stand": "Μούμια Καμήλα σηκώνεται",
	...
	"subtitles.entity.copper_golem.death": "Γκόλεμ Χαλκού πεθαίνει",
	"subtitles.entity.copper_golem.hurt": "Γκόλεμ Χαλκού τραυματίζεται",
	"subtitles.entity.copper_golem.item_drop": "Γκόλεμ Χαλκού τοποθετεί ένα αντικείμενο",
	"subtitles.entity.copper_golem.item_no_drop": "Γκόλεμ Χαλκού δεν μπορεί να τοποθετήσει αντικείμενο",
	"subtitles.entity.copper_golem.no_item_get": "Γκόλεμ Χαλκού μαζεύει αντικείμενο",
	"subtitles.entity.copper_golem.no_item_no_get": "Γκόλεμ Χαλκού δεν μπορεί να μαζέψει αντικείμενο",
	"subtitles.entity.copper_golem.spawn": "Γκόλεμ Χαλκού εμφανίζεται",
	"subtitles.entity.copper_golem.spin": "Κεφάλι Γκόλεμ Χαλκού περιστρέφεται",
	"subtitles.entity.copper_golem_become_statue": "Γκόλεμ Χαλκού απολιθώνεται",
	"subtitles.entity.copper_golem_oxidized.death": "Γκόλεμ Χαλκού πεθαίνει",
	"subtitles.entity.copper_golem_oxidized.hurt": "Γκόλεμ Χαλκού τραυματίζεται",
	"subtitles.entity.copper_golem_oxidized.spin": "Κεφάλι Γκόλεμ Χαλκού περιστρέφεται",
	"subtitles.entity.copper_golem_weathered.death": "Γκόλεμ Χαλκού πεθαίνει",
	"subtitles.entity.copper_golem_weathered.hurt": "Γκόλεμ Χαλκού τραυματίζεται",
	"subtitles.entity.copper_golem_weathered.spin": "Κεφάλι Γκόλεμ Χαλκού περιστρέφεται",
	...
	"subtitles.entity.creaking.activate": "Τριξιτής παρακολουθεί",
	"subtitles.entity.creaking.ambient": "Τριξιτής τρίζει",
	"subtitles.entity.creaking.attack": "Τριξιτής επιτίθεται",
	"subtitles.entity.creaking.deactivate": "Τριξιτής ηρεμεί",
	"subtitles.entity.creaking.death": "Τριξιτής θρυμματίζεται",
	"subtitles.entity.creaking.freeze": "Τριξιτής σταματάει",
	"subtitles.entity.creaking.spawn": "Τριξιτής φανερώνεται",
	"subtitles.entity.creaking.sway": "Τριξιτής χτυπιέται",
	"subtitles.entity.creaking.twitch": "Τριξιτής τινάζεται",
	"subtitles.entity.creaking.unfreeze": "Τριξιτής κινείται",
	...
	"subtitles.entity.donkey.jump": "Γάιδαρος πηδάει",
	...
	"subtitles.entity.egg.throw": "Αβγό εκτοξεύεται",
	...
	"subtitles.entity.ender_eye.launch": "Μάτι του Έντερ εκτοξεύεται",
	"subtitles.entity.ender_pearl.throw": "Μαργαριτάρι Έντερ εκτοξεύεται",
	...
	"subtitles.entity.fish.swim": "Πιτσιλιές",
	...
	"subtitles.entity.fishing_bobber.throw": "Αγκίστρι πετάγεται",
	...
	"subtitles.entity.fox.sniff": "Αλεπού οσφραίνεται",
	...
	"subtitles.entity.generic.wind_burst": "Φορτίο Ανέμου εκρήγνυται",
	...
	"subtitles.entity.ghastling.ambient": "Γκαστάκι γουργουρίζει",
	"subtitles.entity.ghastling.death": "Γκαστάκι πεθαίνει",
	"subtitles.entity.ghastling.hurt": "Γκαστάκι τραυματίζεται",
	"subtitles.entity.ghastling.spawn": "Γκαστάκι εμφανίζεται",
	...
	"subtitles.entity.glow_squid.squirt": "Λαμπερό Καλαμάρι εκτοξεύει μελάνι",
	...
	"subtitles.entity.happy_ghast.ambient": "Ευτυχισμένο Γκαστ σιγοτραγουδάει",
	"subtitles.entity.happy_ghast.death": "Ευτυχισμένο Γκαστ πεθαίνει",
	"subtitles.entity.happy_ghast.equip": "Σαγή φοριέται",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Ευτυχισμένο Γκαστ είναι έτοιμο",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Ευτυχισμένο Γκαστ σταματάει",
	"subtitles.entity.happy_ghast.hurt": "Ευτυχισμένο Γκαστ τραυματίζεται",
	"subtitles.entity.happy_ghast.unequip": "Σαγή αφαιρείται",
	...
	"subtitles.entity.husk.ambient": "Μούμια βογκάει",
	"subtitles.entity.husk.converted_to_zombie": "Μούμια μετατρέπεται σε Ζόμπι",
	"subtitles.entity.husk.death": "Μούμια πεθαίνει",
	"subtitles.entity.husk.hurt": "Μούμια τραυματίζεται",
	...
	"subtitles.entity.leash_knot.break": "Κόμπος Λουριού κόβεται",
	"subtitles.entity.leash_knot.place": "Κόμπος Λουριού δένεται",
	"subtitles.entity.lightning_bolt.impact": "Κεραυνός χτυπάει",
	"subtitles.entity.lightning_bolt.thunder": "Κεραυνός βροντάει",
	...
	"subtitles.entity.magma_cube.death": "Γλίτσα Μάγματος πεθαίνει",
	"subtitles.entity.magma_cube.hurt": "Γλίτσα Μάγματος τραυματίζεται",
	"subtitles.entity.magma_cube.squish": "Γλίτσα Μάγματος ζουλιέται",
	"subtitles.entity.minecart.inside": "Βαγονέτο κουδουνίζει",
	"subtitles.entity.minecart.inside_underwater": "Βαγονέτο κουδουνίζει υποβρυχίως",
	...
	"subtitles.entity.mule.jump": "Μουλάρι πηδάει",
	"subtitles.entity.nautilus.ambient": "Ναυτίλος κροταλίζει",
	"subtitles.entity.nautilus.ambient_land": "Ναυτίλος κροταλίζει",
	"subtitles.entity.nautilus.dash": "Ναυτίλος ξεπηδάει",
	"subtitles.entity.nautilus.dash_land": "Ναυτίλος ξεπηδάει",
	"subtitles.entity.nautilus.dash_ready": "Ναυτίλος ανακάμπτει",
	"subtitles.entity.nautilus.dash_ready_land": "Ναυτίλος ανακάμπτει",
	"subtitles.entity.nautilus.death": "Ναυτίλος πεθαίνει",
	"subtitles.entity.nautilus.death_land": "Ναυτίλος πεθαίνει",
	"subtitles.entity.nautilus.eat": "Ναυτίλος τρώει",
	"subtitles.entity.nautilus.hurt": "Ναυτίλος τραυματίζεται",
	"subtitles.entity.nautilus.hurt_land": "Ναυτίλος τραυματίζεται",
	"subtitles.entity.nautilus.swim": "Ναυτίλος κολυμπάει",
	...
	"subtitles.entity.parched.ambient": "Αφυδατωμένος κροταλίζει",
	"subtitles.entity.parched.death": "Αφυδατωμένος πεθαίνει",
	"subtitles.entity.parched.hurt": "Αφυδατωμένος τραυματίζεται",
	...
	"subtitles.entity.parrot.imitate.bogged": "Παπαγάλος κροταλίζει",
	"subtitles.entity.parrot.imitate.breeze": "Παπαγάλος βουίζει",
	"subtitles.entity.parrot.imitate.camel_husk": "Παπαγάλος μουγκρίζει",
	"subtitles.entity.parrot.imitate.creaking": "Παπαγάλος τρίζει",
	...
	"subtitles.entity.parrot.imitate.parched": "Παπαγάλος κροταλίζει",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Παπαγάλος βογκάει",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Παπαγάλος γαργαρίζει",
	...
	"subtitles.entity.pig.eat": "Γουρούνι τρώει",
	...
	"subtitles.entity.player.teleport": "Παίκτης τηλεμεταφέρεται",
	"subtitles.entity.polar_bear.ambient": "Πολική Αρκούδα βογκάει",
	"subtitles.entity.polar_bear.ambient_baby": "Μωρό Πολική Αρκούδα βουίζει",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Άλογο Σκελετός πηδάει",
	...
	"subtitles.entity.snowball.throw": "Χιονόμπαλα εκτοξεύεται",
	...
	"subtitles.entity.squid.squirt": "Καλαμάρι εκτοξεύει μελάνι",
	...
	"subtitles.entity.sulfur_cube.absorb": "Γεμάτη Γλίτσα Θείου",
	"subtitles.entity.sulfur_cube.bounce": "Γλίτσα Θείου αναπηδάει",
	"subtitles.entity.sulfur_cube.death": "Γλίτσα Θείου πεθαίνει",
	"subtitles.entity.sulfur_cube.eject": "Κύβος αφαιρείται",
	"subtitles.entity.sulfur_cube.hit": "Γλίτσα Θείου χτυπιέται",
	"subtitles.entity.sulfur_cube.hurt": "Γλίτσα Θείου τραυματίζεται",
	"subtitles.entity.sulfur_cube.push": "Γλίτσα Θείου σπρώχνεται",
	"subtitles.entity.sulfur_cube.squish": "Γλίτσα Θείου αναπηδάει",
	...
	"subtitles.entity.turtle.death_baby": "Μωρό Χελώνα πεθαίνει",
	...
	"subtitles.entity.turtle.hurt_baby": "Μωρό Χελώνα τραυματίζεται",
	"subtitles.entity.turtle.lay_egg": "Χελώνα γεννάει αβγό",
	"subtitles.entity.turtle.shamble": "Χελώνα σέρνεται",
	"subtitles.entity.turtle.shamble_baby": "Μωρό Χελώνα σέρνεται",
	...
	"subtitles.entity.warden.sniff": "Φύλακας οσφραίνεται",
	...
	"subtitles.entity.wind_charge.throw": "Φορτίο Ανέμου εκτοξεύεται",
	"subtitles.entity.wind_charge.wind_burst": "Φορτίο Ανέμου εκρήγνυται",
	...
	"subtitles.entity.wolf.bark": "Λύκος γαβγίζει",
	...
	"subtitles.entity.wolf.pant": "Λύκος γαβγίζει",
	"subtitles.entity.wolf.shake": "Λύκος ταρακουνιέται",
	"subtitles.entity.wolf.whine": "Λύκος βογκάει",
	...
	"subtitles.entity.zombie_horse.angry": "Άλογο Ζόμπι χλιμιντρίζει",
	"subtitles.entity.zombie_horse.death": "Άλογο Ζόμπι πεθαίνει",
	"subtitles.entity.zombie_horse.eat": "Άλογο Ζόμπι τρώει",
	"subtitles.entity.zombie_horse.hurt": "Άλογο Ζόμπι τραυματίζεται",
	"subtitles.entity.zombie_nautilus.ambient": "Ναυτίλος Ζόμπι μουρμουρίζει",
	"subtitles.entity.zombie_nautilus.ambient_land": "Ναυτίλος Ζόμπι μουρμουρίζει",
	"subtitles.entity.zombie_nautilus.dash": "Ναυτίλος Ζόμπι ξεπηδάει",
	"subtitles.entity.zombie_nautilus.dash_land": "Ναυτίλος Ζόμπι ξεπηδάει",
	"subtitles.entity.zombie_nautilus.dash_ready": "Ναυτίλος Ζόμπι ανακάμπτει",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Ναυτίλος Ζόμπι ανακάμπτει",
	"subtitles.entity.zombie_nautilus.death": "Ναυτίλος Ζόμπι πεθαίνει",
	"subtitles.entity.zombie_nautilus.death_land": "Ναυτίλος Ζόμπι πεθαίνει",
	"subtitles.entity.zombie_nautilus.eat": "Ναυτίλος Ζόμπι τρώει",
	"subtitles.entity.zombie_nautilus.hurt": "Ναυτίλος Ζόμπι τραυματίζεται",
	"subtitles.entity.zombie_nautilus.hurt_land": "Ναυτίλος Ζόμπι τραυματίζεται",
	"subtitles.entity.zombie_nautilus.swim": "Ναυτίλος Ζόμπι κολυμπάει",
	...
	"subtitles.event.mob_effect.bad_omen": "Οιωνός καθιερώνεται",
	"subtitles.event.mob_effect.raid_omen": "Επιδρομή παραμονεύει κοντά",
	"subtitles.event.mob_effect.trial_omen": "Δυσοίωνη δοκιμασία παραμονεύει κοντά",
	"subtitles.event.raid.horn": "Δυσοίωνο κέρατο στριγκλίζει",
	"subtitles.item.armor.equip": "Πανοπλία φοριέται",
	"subtitles.item.armor.equip_chain": "Αλυσιδωτή πανοπλία φοριέται",
	"subtitles.item.armor.equip_copper": "Χάλκινη πανοπλία φοριέται",
	"subtitles.item.armor.equip_diamond": "Διαμαντένια πανοπλία φοριέται",
	"subtitles.item.armor.equip_elytra": "Έλυτρα φοριούνται",
	"subtitles.item.armor.equip_gold": "Χρυσή πανοπλία φοριέται",
	"subtitles.item.armor.equip_iron": "Σιδερένια πανοπλία φοριέται",
	"subtitles.item.armor.equip_leather": "Δερμάτινη πανοπλία φοριέται",
	"subtitles.item.armor.equip_nautilus": "Πανοπλία Ναυτίλου φοριέται",
	"subtitles.item.armor.equip_netherite": "Πανοπλία Νεδερίτη φοριέται",
	"subtitles.item.armor.equip_turtle": "Κέλυφος Χελώνας φοριέται",
	"subtitles.item.armor.equip_wolf": "Πανοπλία Λύκου φοριέται",
	"subtitles.item.armor.unequip_nautilus": "Πανοπλία Ναυτίλου αφαιρείται",
	"subtitles.item.armor.unequip_wolf": "Πανοπλία Λύκου αφαιρείται",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Γλίτσα Θείου τοποθετείται",
	...
	"subtitles.item.bundle.insert_fail": "Γεμάτο Δέμα",
	...
	"subtitles.item.elytra.flying": "Βούισμα",
	...
	"subtitles.item.golden_dandelion.unuse": "Χρυσή Πικραλίδα ξεκινάει την ανάπτυξη",
	"subtitles.item.golden_dandelion.use": "Χρυσή Πικραλίδα σταματάει την ανάπτυξη",
	...
	"subtitles.item.horse_armor.unequip": "Πανοπλία Αλόγου αφαιρείται",
	"subtitles.item.ink_sac.use": "Θύλακας Μελανιού βάφει",
	"subtitles.item.lead.break": "Λουρί σπάει",
	"subtitles.item.lead.tied": "Λουρί δένεται",
	"subtitles.item.lead.untied": "Λουρί λύνεται",
	"subtitles.item.llama_carpet.unequip": "Χαλί αφαιρείται",
	"subtitles.item.lodestone_compass.lock": "Μαγνητισμένη Πυξίδα κλειδώνει σε Μαγνητίτη",
	"subtitles.item.mace.smash_air": "Απελατίκι χτυπάει",
	"subtitles.item.mace.smash_ground": "Απελατίκι χτυπάει",
	"subtitles.item.nautilus_saddle_equip": "Σέλα φοριέται",
	"subtitles.item.nautilus_saddle_underwater_equip": "Σέλα φοριέται",
	"subtitles.item.nether_wart.plant": "Καλλιέργεια φυτεύεται",
	"subtitles.item.ominous_bottle.dispose": "Μπουκάλι σπάει",
	"subtitles.item.saddle.unequip": "Σέλα αφαιρείται",
	"subtitles.item.shears.shear": "Ψαλίδα κάνει κλικ",
	"subtitles.item.shears.snip": "Ψαλίδα κόβει",
	"subtitles.item.shield.block": "Ασπίδα εμποδίζει",
	"subtitles.item.shovel.flatten": "Φτυάρι ισοπεδώνεi",
	"subtitles.item.spear.attack": "Δόρυ καρφώνει",
	"subtitles.item.spear.hit": "Δόρυ χτυπάει",
	"subtitles.item.spear.lunge": "Δόρυ ορμάει",
	"subtitles.item.spear.use": "Δόρυ σε ετοιμότητα",
	"subtitles.item.spear_wood.attack": "Δόρυ καρφώνει",
	"subtitles.item.spear_wood.hit": "Δόρυ χτυπάει",
	"subtitles.item.spear_wood.use": "Δόρυ σε ετοιμότητα",
	...
	"subtitles.item.underwater_saddle.equip": "Σέλα φοριέται",
	"subtitles.item.wolf_armor.break": "Πανοπλία Λύκου σπάει",
	"subtitles.item.wolf_armor.crack": "Πανοπλία Λύκου ραγίζει",
	"subtitles.item.wolf_armor.damage": "Πανοπλία Λύκου παίρνει ζημιά",
	"subtitles.item.wolf_armor.repair": "Πανοπλία Λύκου επισκευάζεται",
	"subtitles.particle.soul_escape": "Ψυχή δραπετεύει",
	"subtitles.ui.cartography_table.take_result": "Χάρτης χαράζεται",
	"subtitles.ui.hud.bubble_pop": "Πτώση μετρητή αναπνοής",
	"subtitles.ui.loom.take_result": "Αργαλειός χρησιμοποιείται",
	"subtitles.ui.stonecutter.take_result": "Πετροκόπτης χρησιμοποιείται",
	"subtitles.weather.end_flash": "Λάμψη Εντ βροντάει",
	"subtitles.weather.rain": "Βροχή πέφτει",
	"symlink_warning.message": "Η φόρτωση κόσμων από φακέλους με συμβολικές συνδέσεις μπορεί να είναι μη ασφαλής αν δε γνωρίζεις ακριβώς τι κάνεις. Παρακαλώ επισκέψου το %s για να μάθεις περισσότερα.",
	"symlink_warning.message.pack": "Η φόρτωση πακέτων με συμβολικές συνδέσεις μπορεί να είναι μη ασφαλής αν δε γνωρίζεις ακριβώς τι κάνεις. Παρακαλώ επισκέψου το %s για να μάθεις περισσότερα.",
	"symlink_warning.message.world": "Η φόρτωση κόσμων από φακέλους με συμβολικές συνδέσεις μπορεί να είναι μη ασφαλής αν δε γνωρίζεις ακριβώς τι κάνεις. Παρακαλώ επισκέψου το %s για να μάθεις περισσότερα.",
	"symlink_warning.more_info": "Περισσότερες Πληροφορίες",
	"symlink_warning.title": "Ο φάκελος κόσμου περιέχει συμβολικές συνδέσεις",
	"symlink_warning.title.pack": "Το πακέτο που προστέθηκε περιέχει/Τα πακέτα που προστέθηκαν περιέχουν συμβολικές συνδέσεις",
	"symlink_warning.title.world": "Ο φάκελος κόσμου περιέχει συμβολικές συνδέσεις",
	...
	"telemetry.event.advancement_made.description": "Η κατανόηση του γενικού πλαισίου πίσω από τη λήψη μιας εξέλιξης μπορεί να μας βοηθήσει να καταλάβουμε καλύτερα και να βελτιώσουμε τη σειρά του παιχνιδιού.",
	"telemetry.event.advancement_made.title": "Απόκτηση Εξέλιξης",
	"telemetry.event.game_load_times.description": "Αυτό το συμβάν μπορεί να μας βοηθήσει να καταλάβουμε πού χρειάζονται βελτιώσεις στην απόδοση εκκίνησης μετρώντας τους χρόνους εκτέλεσης των φάσεων εκκίνησης.",
	"telemetry.event.game_load_times.title": "Χρόνοι Φόρτωσης Παιχνιδιού",
	"telemetry.event.graphics_capabilities.description": "Αυτό το συμβάν μας ενημερώνει για τις δυνατότητες της συσκευής γραφικών που χρησιμοποιείται για να παίξει το παιχνίδι.",
	"telemetry.event.graphics_capabilities.title": "Δυνατότητες Γραφικών",
	"telemetry.event.optional": "%s (Προαιρετικό)",
	"telemetry.event.optional.disabled": "%s (Προαιρετικό) - Απενεργοποιημένο",
	...
	"telemetry.event.world_load_times.description": "Είναι σημαντική για εμάς η κατανόηση του χρόνου που χρειάζεται για να συνδεθείς σε έναν κόσμο, και πώς αυτό αλλάζει με τον χρόνο. Για παράδειγμα, όταν προσθέτουμε νέες λειτουργίες ή κάνουμε μεγαλύτερες τεχνικές αλλαγές, πρέπει να δούμε τι επίδραση είχε στους χρόνους φόρτωσης.",
	"telemetry.event.world_load_times.title": "Χρόνοι Φόρτωσης Κόσμου",
	"telemetry.event.world_loaded.description": "Η γνώση του πώς οι παίκτες παίζουν Minecraft (όπως Λειτουργία Παιχνιδιού, τροποποιημένο πρόγραμμα πελάτη ή διακομιστής, και έκδοση παιχνιδιού) μας επιτρέπει να εστιάσουμε ενημερώσεις παιχνιδιού στη βελτίωση τομέων για τους οποίους οι παίκτες ενδιαφέρονται περισσότερο.\nΤο συμβάν Φόρτωσης Κόσμου συνδυάζεται με το συμβάν Εκφόρτωσης Κόσμου για να υπολογιστεί η διάρκεια της συνεδρίας παιχνιδιού.",
	...
	"telemetry.property.advancement_game_time.title": "Χρόνος Παιχνιδιού (Τικ)",
	"telemetry.property.advancement_id.title": "Αναγνωριστικό Εξέλιξης",
	"telemetry.property.backend_failure_message.title": "Μήνυμα Αποτυχίας Δημιουργίας Παρασκηνίου",
	"telemetry.property.backend_failure_missing_capabilities.title": "Ελλιπείς Δυνατότητες Αποτυχίας Δημιουργίας Παρασκηνίου",
	"telemetry.property.backend_failure_reason.title": "Αιτία Αποτυχίας Δημιουργίας Παρασκηνίου",
	"telemetry.property.backend_name.title": "Όνομα Παρασκηνίου",
	"telemetry.property.client_id.title": "Αναγνωριστικό Προγράμματος Πελάτη",
	"telemetry.property.client_modded.title": "Τροποποιημένο Πρόγραμμα Πελάτη",
	...
	"telemetry.property.launcher_name.title": "Όνομα Προγράμματος Εκκίνησης",
	"telemetry.property.load_time_bootstrap_ms.title": "Χρόνος Εκκίνησης (Χιλιοστά του Δευτερολέπτου)",
	"telemetry.property.load_time_loading_overlay_ms.title": "Χρόνος στην Οθόνη Φόρτωσης (Χιλιοστά του Δευτερολέπτου)",
	"telemetry.property.load_time_pre_window_ms.title": "Χρόνος Πριν Άνοιγμα Παραθύρου (Χιλιοστά του Δευτερολέπτου)",
	"telemetry.property.load_time_total_time_ms.title": "Συνολικός Χρόνος Φόρτωσης (Χιλιοστά του Δευτερολέπτου)",
	...
	"telemetry.property.opt_in.title": "Συναίνεση",
	...
	"telemetry.property.realms_map_content.title": "Περιεχόμενο Κόσμου Realms (Όνομα Μίνι-Παιχνιδιού)",
	...
	"telemetry_info.button.privacy_statement": "Δήλωση Προστασίας Προσωπικών Δεδομένων",
	"telemetry_info.button.show_data": "Εμφάνιση των Δεδομένων Μου",
	"telemetry_info.opt_in.description": "Συναινώ στην αποστολή προαιρετικών δεδομένων τηλεμετρίας",
	"telemetry_info.property_title": "Συμπεριλαμβανόμενα Δεδομένα",
	"telemetry_info.screen.description": "Η συλλογή αυτών των δεδομένων μας βοηθάει να βελτιώσουμε το Minecraft καθοδηγώντας μας σε κατευθύνσεις που είναι σχετικές με τους παίκτες μας.\nΜπορείς επίσης να στείλεις επιπλέον σχόλια για να μας βοηθήσεις στη συνεχή βελτίωση του Minecraft.",
	"telemetry_info.screen.title": "Συλλογή Δεδομένων Τηλεμετρίας",
	"test.error.block_property_mismatch": "Αναμενόταν η ιδιότητα %s να είναι %s: ήταν %s",
	"test.error.block_property_missing": "Λείπει η ιδιότητα του κύβου. Αναμενόταν η ιδιότητα %s να είναι %s",
	"test.error.entity_property": "Η οντότητα %s απέτυχε τη δοκιμή: %s",
	"test.error.entity_property_details": "Η οντότητα %s απέτυχε τη δοκιμή: %s. Αναμενόταν %s: ήταν: %s",
	"test.error.expected_block": "Αναμενόταν ο κύβος %s: λήφθηκε ο κύβος %s",
	"test.error.expected_block_present": "Αναμενόταν ο κύβος %s να είναι παρών",
	"test.error.expected_block_tag": "Αναμενόταν κύβος στην ετικέτα #%s: λήφθηκε ο κύβος %s",
	"test.error.expected_container_contents": "Το δοχείο πρέπει να περιέχει: %s",
	"test.error.expected_container_contents_single": "Το δοχείο πρέπει να περιέχει ένα αντικείμενο: %s",
	"test.error.expected_empty_container": "Το δοχείο πρέπει να είναι άδειο",
	"test.error.expected_entity": "Αναμενόταν η οντότητα %s",
	"test.error.expected_entity_around": "Αναμενόταν η οντότητα %s να υπάρχει γύρω από τη θέση %s, %s, %s",
	"test.error.expected_entity_count": "Αναμένονταν %s οντότητες τύπου %s: βρέθηκε/βρέθηκαν %s",
	"test.error.expected_entity_data": "Αναμένονταν τα δεδομένα οντότητας να είναι %s: ήταν: %s",
	"test.error.expected_entity_data_predicate": "Ασυμφωνία δεδομένων οντότητας για την οντότητα %s",
	"test.error.expected_entity_effect": "Αναμενόταν η οντότητα %s να έχει την επίδραση %s %s",
	"test.error.expected_entity_having": "Τα αποθέματα της οντότητας πρέπει να περιέχουν το αντικείμενο %s",
	"test.error.expected_entity_holding": "Η οντότητα πρέπει να κρατάει το αντικείμενο %s",
	"test.error.expected_entity_in_test": "Αναμενόταν η οντότητα %s να υπάρχει στη δοκιμή",
	"test.error.expected_entity_not_touching": "Δεν αναμενόταν η οντότητα %s να αγγίζει τη θέση %s, %s, %s (σχετική: %s, %s, %s)",
	"test.error.expected_entity_touching": "Αναμενόταν η οντότητα %s να αγγίζει τη θέση %s, %s, %s (σχετική: %s, %s, %s)",
	"test.error.expected_item": "Αναμενόταν αντικείμενο τύπου %s",
	"test.error.expected_items_count": "Αναμένονταν %s αντικείμενα τύπου %s: βρέθηκε/βρέθηκαν %s",
	"test.error.fail": "Τηρήθηκαν οι συνθήκες αποτυχίας",
	"test.error.invalid_block_type": "Βρέθηκε μη αναμενόμενος τύπος κύβου: %s",
	"test.error.missing_block_entity": "Λείπει η οντότητα κύβος",
	"test.error.not_a_block_item": "Ο κύβος που δόθηκε δεν είναι αντικείμενο κύβος",
	"test.error.position": "%s στη θέση %s, %s, %s (σχετική: %s, %s, %s) στο τικ %s",
	"test.error.sequence.condition_already_triggered": "Η συνθήκη έχει ήδη ενεργοποιηθεί στο %s",
	"test.error.sequence.condition_not_triggered": "Η συνθήκη δεν ενεργοποιήθηκε",
	"test.error.sequence.invalid_tick": "Ήταν επιτυχής σε μη έγκυρο τικ: αναμενόταν %s",
	"test.error.sequence.minimum_tick": "Ήταν επιτυχής πριν το αναμενόμενο τικ: αναμενόταν η αναμονή %s",
	"test.error.sequence.not_completed": "Έληξε το χρονικό όριο της δοκιμής πριν ολοκληρωθεί η ακολουθία",
	"test.error.set_biome": "Απέτυχε ο ορισμός τοπίου για τη δοκιμή",
	"test.error.spawn_failure": "Απέτυχε η δημιουργία της οντότητας %s",
	"test.error.state_not_equal": "Μη έγκυρη κατάσταση. Αναμενόταν %s: ήταν %s",
	"test.error.structure.failure": "Απέτυχε η τοποθέτηση της δομής δοκιμής για τη δοκιμή %s",
	"test.error.tick": "%s στο τικ %s",
	"test.error.ticking_without_structure": "Εκτελούμενη δοκιμή πριν την τοποθέτηση της δομής",
	"test.error.timeout.no_result": "Δεν ήταν επιτυχής ή απέτυχε εντός %s τικ",
	"test.error.timeout.no_sequences_finished": "Καμία ακολουθία δεν ολοκληρώθηκε εντός %s τικ",
	"test.error.too_many_entities": "Αναμενόταν μόνο μία οντότητα %s να υπάρχει γύρω από τη θέση %s, %s, %s αλλά βρέθηκαν %s",
	"test.error.unexpected_block": "Δεν αναμενόταν ο κύβος να είναι %s",
	"test.error.unexpected_entity": "Δεν αναμενόταν η οντότητα %s να υπάρχει",
	"test.error.unexpected_item": "Δεν αναμενόταν αντικείμενο τύπου %s",
	"test.error.unknown": "Άγνωστο εσωτερικό σφάλμα: %s",
	"test.error.value_not_equal": "Αναμενόταν η τιμή %s να είναι %s: ήταν %s",
	"test.error.value_not_in_between": "Αναμενόταν η τιμή %s να είναι μεταξύ %s και %s: ήταν %s",
	"test.error.wrong_block_entity": "Λάθος τύπος οντότητας κύβου: %s",
	"test_block.error.missing": "Λείπει ο κύβος %s από τη δομή δοκιμής",
	"test_block.error.too_many": "Πάρα πολλοί κύβοι %s",
	"test_block.invalid_timeout": "Μη έγκυρο χρονικό όριο (%s) - πρέπει να είναι ένας θετικός αριθμός τικ",
	"test_block.message": "Μήνυμα:",
	"test_block.mode.accept": "Αποδοχή",
	"test_block.mode.fail": "Αποτυχία",
	"test_block.mode.log": "Καταγραφή",
	"test_block.mode.start": "Εκκίνηση",
	"test_block.mode_info.accept": "Λειτουργία Αποδοχής - Αποδοχή επιτυχίας για μια δοκιμή ή μέρος της",
	"test_block.mode_info.fail": "Λειτουργία Αποτυχίας - Αποτυχία της δοκιμής",
	"test_block.mode_info.log": "Λειτουργία Καταγραφής - Καταγραφή ενός μηνύματος",
	"test_block.mode_info.start": "Λειτουργία Εκκίνησης - Το σημείο εκκίνησης για μια δοκιμή",
	"test_instance.action.reset": "Επαναφορά και Φόρτωση",
	"test_instance.action.run": "Φόρτωση και Εκτέλεση",
	"test_instance.action.save": "Αποθήκευση Δομής",
	"test_instance.description.batch": "Περιβάλλον: %s",
	"test_instance.description.failed": "Απέτυχε: %s",
	"test_instance.description.function": "Συνάρτηση: %s",
	"test_instance.description.invalid_id": "Μη έγκυρο αναγνωριστικό δοκιμής",
	"test_instance.description.no_test": "Καμία τέτοια δοκιμή",
	"test_instance.description.structure": "Δομή: %s",
	"test_instance.description.type": "Τύπος: %s",
	"test_instance.type.block_based": "Δοκιμή Κύβου",
	"test_instance.type.function": "Δοκιμή Ενσωματωμένης Συνάρτησης",
	"test_instance_block.entities": "Οντότητες:",
	"test_instance_block.error.no_test": "Δεν ήταν δυνατή η εκτέλεση της παρουσίας δοκιμής στη θέση %s, %s, %s διότι έχει μια αόριστη δοκιμή",
	"test_instance_block.error.no_test_structure": "Δεν ήταν δυνατή η εκτέλεση της παρουσίας δοκιμής στη θέση %s, %s, %s διότι δεν έχει δομή δοκιμής",
	"test_instance_block.error.unable_to_save": "Δεν ήταν δυνατή η αποθήκευση του πρότυπου της δομής δοκιμής για την παρουσία δοκιμής στη θέση %s, %s, %s",
	"test_instance_block.invalid": "[μη έγκυρο]",
	"test_instance_block.reset_success": "Η επαναφορά ήταν επιτυχής για τη δοκιμή: %s",
	"test_instance_block.rotation": "Κατεύθυνση:",
	"test_instance_block.size": "Μέγεθος Δομής Δοκιμής",
	"test_instance_block.starting": "Εκκίνηση δοκιμής %s",
	"test_instance_block.test_id": "Αναγνωριστικό Παρουσίας Δοκιμής",
	"title.32bit.deprecation": "Εντοπίστηκε σύστημα 32-bit: αυτό μπορεί να σε αποτρέψει από το να παίζεις στο μέλλον καθώς θα απαιτείται σύστημα 64-bit!",
	"title.32bit.deprecation.realms": "Το Minecraft σύντομα θα απαιτεί σύστημα 64-bit, το οποίο θα σε αποτρέψει από το να παίζεις ή να χρησιμοποιείς τα Realms σε αυτήν τη συσκευή. Θα χρειαστεί να ακυρώσεις εσύ οποιαδήποτε συνδρομή Realms.",
	...
	"title.credits": "Πνευματικά δικαιώματα Mojang AB. Απαγορεύεται η διανομή!",
	"title.multiplayer.disabled": "Το Παιχνίδι Πολλαπλών Παικτών είναι απενεργοποιημένο. Παρακαλώ έλεγξε τις ρυθμίσεις του λογαριασμού σου Microsoft.",
	"title.multiplayer.disabled.banned.name": "Πρέπει να αλλάξεις το όνομά σου πριν μπορέσεις να παίξεις διαδικτυακά",
	"title.multiplayer.disabled.banned.permanent": "Ο λογαριασμός σου είναι οριστικά σε αναστολή από το διαδικτυακό παιχνίδι",
	"title.multiplayer.disabled.banned.temporary": "Ο λογαριασμός σου είναι προσωρινά σε αναστολή από το διαδικτυακό παιχνίδι",
	"title.multiplayer.lan": "Παιχνίδι Πολλαπλών Παικτών (LAN)",
	"title.multiplayer.online": "Παιχνίδι Πολλαπλών Παικτών (Διαδικτυακό)",
	...
	"trim_material.minecraft.resin": "Υλικό Ρητίνης",
	"trim_pattern.minecraft.bolt": "Επένδυση Πανοπλίας Κοχλία",
	...
	"trim_pattern.minecraft.flow": "Επένδυση Πανοπλίας Ροής",
	...
	"tutorial.bundleInsert.description": "Δεξί Κλικ για προσθήκη αντικειμένων",
	"tutorial.bundleInsert.title": "Χρησιμοποίησε ένα Δέμα",
	"tutorial.craft_planks.description": "Το βιβλίο συνταγών μπορεί να βοηθήσει",
	"tutorial.craft_planks.title": "Κατασκεύασε ξύλινες σανίδες",
	"tutorial.find_tree.description": "Βάρεσέ το για να συλλέξεις ξύλο",
	"tutorial.find_tree.title": "Βρες ένα δέντρο",
	"tutorial.look.description": "Χρησιμοποίησε το ποντίκι σου για να στρίψεις",
	"tutorial.look.title": "Κοίταξε γύρω σου",
	"tutorial.move.description": "Πήδηξε με %s",
	"tutorial.move.title": "Κινήσου με %s, %s %s και %s",
	"tutorial.open_inventory.description": "Πάτησε %s",
	"tutorial.open_inventory.title": "Άνοιξε τα αποθέματά σου",
	"tutorial.punch_tree.description": "Κράτησε %s",
	"tutorial.punch_tree.title": "Κατάστρεψε το δέντρο",
	"tutorial.socialInteractions.description": "Πάτησε %s για άνοιγμα",
	"tutorial.socialInteractions.title": "Κοινωνικές Επαφές",
	"upgrade.minecraft.netherite_upgrade": "Αναβάθμιση Νεδερίτη",
	"upgradeWorld.aborted.message": "Αυτό μπορεί να συμβεί αν ένα άλλο πρόγραμμα απέκτησε πρόσβαση στον κόσμο κατά την αναβάθμιση.\nΜπορεί να βοηθήσει να επανεκκινήσεις τον υπολογιστή σου και να δοκιμάσεις ξανά. Αν το πρόβλημα παραμένει, παρακαλώ σκέψου να αναφέρεις ένα σφάλμα.",
	"upgradeWorld.aborted.reportBug": "Αναφορά Ενός Σφάλματος",
	"upgradeWorld.aborted.title": "Απέτυχε η αναβάθμιση του κόσμου",
	"upgradeWorld.canceled.message": "Ο κόσμος σου παραμένει όπως ήταν πριν.",
	"upgradeWorld.canceled.title": "Η αναβάθμιση του κόσμου ακυρώθηκε",
	"upgradeWorld.done": "Η Αναβάθμιση Κόσμου Ολοκληρώθηκε",
	"upgradeWorld.failed_cleanup.message": "Ο κόσμος αναβαθμίστηκε με επιτυχία στην τρέχουσα έκδοση και είναι τώρα διαθέσιμος στη λίστα κόσμων.\nΑντιμετωπίσαμε προβλήματα κατά την εκκαθάριση μη ενημερωμένων δεδομένων, επομένως το όνομα του φακέλου κόσμου έχει αλλάξει σε %s.",
	"upgradeWorld.failed_cleanup.title": "Ο κόσμος αναβαθμίστηκε με επιτυχία",
	"upgradeWorld.info.converted": "Αναβαθμίστηκαν: %s",
	"upgradeWorld.info.file_fix_stage": "Στάδιο: %s/%s",
	"upgradeWorld.info.scanning": "Σάρωση αρχείων...",
	"upgradeWorld.info.total": "Σύνολο: %s",
	"upgradeWorld.joinNow": "Θέλεις να μπεις στον κόσμο τώρα;",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Μετακίνηση αρχείων",
	"upgradeWorld.progress.type.legacy_structures": "Αναβάθμιση παλιών δομών",
	"upgradeWorld.progress.type.region": "Αναβάθμιση περιοχών",
	"upgradeWorld.symlink.message": "Ο επιλεγμένος κόσμος περιέχει συμβολικές συνδέσεις.\nΤα απαιτούμενα βήματα για την αναβάθμιση του κόσμου στην τρέχουσα έκδοση δεν υποστηρίζουν τη χρήση συμβολικών συνδέσεων. Για να αναβαθμίσεις τον κόσμο, οι σύνδεσμοι πρέπει να επιλυθούν πρώτα.",
	"upgradeWorld.symlink.title": "Δεν μπορεί να γίνει η αναβάθμιση του κόσμου",
	"upgradeWorld.title": "Αναβάθμιση Αρχείων Κόσμου",
}
