// Code generated by tools/gen_lang.go from 26.1/fr_ch.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advMode.notEnabled": "Les bloc de commande ne sont pas activés",
	...
	"advancements.adventure.avoid_vibration.description": "Avancez furtivement près d'un capteur sculk ou d'un Warden pour éviter qu'il ne vous détecte",
	"advancements.adventure.avoid_vibration.title": "Sans un bruit",
	"advancements.adventure.blowback.description": "Tuez un Brise en lui renvoyant de ses une charge de vent.",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Fabriquez un vase décoré à partir de 4 tessons de poterie",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Le passé recomposé",
	"advancements.adventure.crafters_crafting_crafters.description": "Soyez à proximité d'un fabricateur lorsqu'il fabrique un fabricateur",
	"advancements.adventure.crafters_crafting_crafters.title": "Méta-fabrication",
	"advancements.adventure.fall_from_world_height.description": "Survivez à une chute depuis le point le plus haut du monde (à la limite de construction) jusqu'au point le plus bas",
	...
	"advancements.adventure.hero_of_the_village.description": "Repoussez une invasion d'un village avec succès",
	...
	"advancements.adventure.kill_all_mobs.description": "Tuez un exemplaire de chaque créature hostile",
	...
	"advancements.adventure.lightning_rod_with_villager_no_fire.description": "Protégez un villageois d'une décharge électrique indésirable sans provoquer d'incendie",
	...
	"advancements.adventure.play_jukebox_in_meadows.description": "Faites revivre les prairies avec la mélodie d'un jukebox",
	"advancements.adventure.play_jukebox_in_meadows.title": "La mélodie du bonheur",
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Captez le signal de puissance d'une bibliothèque sculptée à l'aide d'un comparateur",
	...
	"advancements.adventure.spyglass_at_dragon.description": "Observez l'Ender Dragon à l'aide d'une longue-vue",
	"advancements.adventure.spyglass_at_dragon.title": "Est-ce le plus gros des oiseaux ?",
	"advancements.adventure.spyglass_at_ghast.description": "Observez un Ghast à l'aide d'une longue-vue",
	"advancements.adventure.spyglass_at_ghast.title": "Est-ce un gros oiseau ?",
	"advancements.adventure.spyglass_at_parrot.description": "Observez un perroquet à l'aide d'une longue-vue",
	...
	"advancements.adventure.trade_at_world_height.description": "Échangez avec un villageois à la hauteur maximale de construction",
	"advancements.adventure.trade_at_world_height.title": "Un commerce à la hauteur",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Appliquez chaque modèles de forge au moins une fois : des tours, des groins, des côtes, des abîmes, du silence, des Vex, des marées et des éclaireurs",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "La classe de la cuirasse",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Fabriquez une pièce d'armure ornée à une table de forge",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Motif de jalousie",
	"advancements.adventure.two_birds_one_arrow.description": "Tuez deux Spectres avec une flèche perforante",
	...
	"advancements.empty": "Il semblerait qu'il n'y ait rien ici...",
	"advancements.end.dragon_breath.description": "Collectez du souffle de dragon à l'aide d'une fiole",
	...
	"advancements.end.levitate.description": "Lévitez de 50 blocs de hauteur grâce aux attaques d'un Shulker",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Faites en sorte qu'un Allay jette un gâteau à un bloc musical",
	...
	"advancements.husbandry.breed_all_animals.description": "Faites se reproduire tous les animaux !",
	...
	"advancements.husbandry.silk_touch_nest.description": "Déplacez un nid d'abeilles ou une ruche avec 3 abeilles à l'intérieur en utilisant Toucher de soie",
	...
	"advancements.husbandry.tadpole_in_a_bucket.description": "Capturez un têtard dans un seau",
	...
	"advancements.husbandry.uh_oh.description": "Faites absorber un bloc de TNT par un cube de soufre",
	"advancements.husbandry.uh_oh.title": "Soufre qui peut !",
	...
	"advancements.nether.explore_nether.title": "Voyage au centre de la Terre",
	...
	"advancements.story.deflect_arrow.description": "Déviez un projectile avec un bouclier",
	"advancements.story.deflect_arrow.title": "Pas aujourd'hui, merci",
	"advancements.story.enchant_item.description": "Enchantez un objet à une table d'enchantement",
	...
	"argument.block.tag.disallowed": "Les tags ne sont pas autorisés ici, uniquement les véritables blocs le sont",
	...
	"argument.entity.options.mode.invalid": "Mode de jeu invalide ou inconnu : %s",
	...
	"argument.entity.options.x_rotation.description": "Rotation de l'entité sur l'axe x",
	"argument.entity.options.y.description": "Position y",
	"argument.entity.options.y_rotation.description": "Rotation de l'entité sur l'axe y",
	...
	"argument.entity.toomany": "Seulement une entité est autorisée, mais le sélecteur fourni en permet plusieurs",
	"argument.enum.invalid": "Valeur invalide : %s",
	"argument.float.big": "La variable de type float ne doit pas dépasser %s, valeur trouvée : %s",
	...
	"argument.hexcolor.invalid": "Code couleur hexadécimal invalide : %s",
	...
	"argument.item.tag.disallowed": "Les tags ne sont pas autorisés ici, uniquement de véritables objets le sont",
	...
	"argument.message.too_long": "Le message est trop long (%s > maximum de %s caractères)",
	...
	"argument.player.toomany": "Seulement un seul joueur est autorisé, mais le sélecteur fourni en autorise plusieurs",
	...
	"arguments.item.component.repeated": "Le composant d'objet \"%s\" a été répété, mais uniquement une valeur peut être spécifiée",
	...
	"arguments.nbtpath.nothing_found": "Aucun élément menant à %s n'a été trouvé",
	...
	"attribute.name.generic.scale": "Échelle",
	...
	"attribute.name.waypoint_receive_range": "Portée de réception des points de repère",
	...
	"biome.minecraft.deep_lukewarm_ocean": "Océan profond tiède",
	...
	"biome.minecraft.end_barrens": "Terres désolées de l'End",
	"biome.minecraft.end_highlands": "Hauts plateaux de l'End",
	...
	"block.minecraft.acacia_slab": "Dalle d'acacia",
	"block.minecraft.acacia_stairs": "Escaliers d'acacia",
	...
	"block.minecraft.activator_rail": "Rails activateur",
	...
	"block.minecraft.andesite_slab": "Dalle d'andésité",
	...
	"block.minecraft.bamboo_slab": "Dalle de bambou",
	"block.minecraft.bamboo_stairs": "Escaliers de bambou",
	...
	"block.minecraft.banner.straight_cross.cyan": "Croix cyan",
	...
	"block.minecraft.big_dripleaf": "Grande feuille goutte",
	"block.minecraft.big_dripleaf_stem": "Tige de grande feuille goutte",
	...
	"block.minecraft.birch_slab": "Dalle de bouleau",
	"block.minecraft.birch_stairs": "Escaliers de bouleau",
	...
	"block.minecraft.black_concrete_powder": "Poudre de béton noir",
	...
	"block.minecraft.blackstone_stairs": "Escaliers de roche noire",
	...
	"block.minecraft.blue_concrete_powder": "Poudre de béton bleu",
	...
	"block.minecraft.brown_concrete_powder": "Poudre de béton marron",
	...
	"block.minecraft.cherry_slab": "Dalle de cerisier",
	"block.minecraft.cherry_stairs": "Escaliers de cerisier",
	...
	"block.minecraft.chiseled_deepslate": "Ardoise profonde ciselée",
	"block.minecraft.chiseled_nether_bricks": "Briques du Nether ciselées",
	"block.minecraft.chiseled_polished_blackstone": "Roche noire polie ciselée",
	"block.minecraft.chiseled_quartz_block": "Bloc de quartz ciselé",
	...
	"block.minecraft.cobbled_deepslate": "Pierres profonde",
	"block.minecraft.cobbled_deepslate_slab": "Dalle de pierres profonde",
	"block.minecraft.cobbled_deepslate_stairs": "Escaliers de pierres d'ardoise profonde",
	"block.minecraft.cobbled_deepslate_wall": "Muret de pierres profonde",
	"block.minecraft.cobblestone": "Pierres",
	"block.minecraft.cobblestone_slab": "Dalle de pierres",
	"block.minecraft.cobblestone_stairs": "Escaliers de pierres",
	...
	"block.minecraft.cracked_deepslate_bricks": "Briques d'ardoise profonde craquelées",
	"block.minecraft.cracked_deepslate_tiles": "Tuiles d'ardoise profonde craquelées",
	"block.minecraft.cracked_nether_bricks": "Briques du Nether craquelées",
	"block.minecraft.cracked_polished_blackstone_bricks": "Briques de pierre noire polie craquelées",
	...
	"block.minecraft.crimson_wall_hanging_sign": "Pancarte suspendue cramoisie murale",
	...
	"block.minecraft.cyan_concrete_powder": "Poudre de béton cyan",
	...
	"block.minecraft.dark_oak_slab": "Dalle de chêne noir",
	"block.minecraft.dark_oak_stairs": "Escaliers de chêne noir",
	...
	"block.minecraft.deepslate": "Ardoise profonde",
	"block.minecraft.deepslate_brick_slab": "Dalle de briques d'ardoise profonde",
	"block.minecraft.deepslate_brick_stairs": "Escaliers de briques d'ardoise profonde",
	"block.minecraft.deepslate_brick_wall": "Muret de briques d'ardoise profonde",
	"block.minecraft.deepslate_bricks": "Briques d'ardoise profonde",
	"block.minecraft.deepslate_coal_ore": "Minerai de charbon profond",
	"block.minecraft.deepslate_copper_ore": "Minerai de cuivre profond",
	"block.minecraft.deepslate_diamond_ore": "Minerai de diamant profond",
	"block.minecraft.deepslate_emerald_ore": "Minerai d'émeraude profond",
	"block.minecraft.deepslate_gold_ore": "Minerai d'or profond",
	"block.minecraft.deepslate_iron_ore": "Minerai de fer profond",
	"block.minecraft.deepslate_lapis_ore": "Minerai de lapis-lazuli profond",
	"block.minecraft.deepslate_redstone_ore": "Minerai de redstone profond",
	"block.minecraft.deepslate_tile_slab": "Dalle de tuiles d'ardoise profonde",
	"block.minecraft.deepslate_tile_stairs": "Escaliers de tuiles d'ardoise profonde",
	"block.minecraft.deepslate_tile_wall": "Muret de tuiles d'ardoise profonde",
	...
	"block.minecraft.gray_concrete_powder": "Poudre de béton gris",
	...
	"block.minecraft.green_concrete_powder": "Poudre de béton vert",
	...
	"block.minecraft.jungle_slab": "Dalle d'acajou",
	"block.minecraft.jungle_stairs": "Escaliers d'acajou",
	...
	"block.minecraft.kelp_plant": "Plant d'algue",
	...
	"block.minecraft.light_blue_concrete_powder": "Poudre de béton bleu clair",
	...
	"block.minecraft.light_gray_concrete_powder": "Poudre de béton gris clair",
	...
	"block.minecraft.lime_concrete_powder": "Poudre de béton ver clair",
	...
	"block.minecraft.magenta_concrete_powder": "Poudre de béton magenta",
	...
	"block.minecraft.mangrove_slab": "Dalle de palétuvier",
	"block.minecraft.mangrove_stairs": "Escaliers de palétuvier",
	...
	"block.minecraft.mossy_cobblestone_stairs": "Escaliers de pierres moussues",
	...
	"block.minecraft.mossy_stone_brick_stairs": "Escaliers de briques de pierre moussue",
	...
	"block.minecraft.mud_brick_stairs": "Escaliers de briques de terre crue",
	...
	"block.minecraft.oak_fence": "Porte de clôture en chêne",
	"block.minecraft.oak_fence_gate": "Clôture en chêne",
	...
	"block.minecraft.oak_slab": "Dalle de chêne",
	"block.minecraft.oak_stairs": "Escaliers de chêne",
	...
	"block.minecraft.orange_concrete_powder": "Poudre de béton orange",
	...
	"block.minecraft.pale_oak_fence": "Clôture en chêne pâle",
	"block.minecraft.pale_oak_fence_gate": "Porte de clôture en chêne pâle",
	...
	"block.minecraft.pale_oak_slab": "Dalle de chêne pâle",
	"block.minecraft.pale_oak_stairs": "Escaliers de chêne pâle",
	...
	"block.minecraft.petrified_oak_slab": "Dalle de chêne pétrifiée",
	...
	"block.minecraft.pink_concrete_powder": "Poudre de béton rose",
	...
	"block.minecraft.polished_blackstone": "Roche noire polie",
	"block.minecraft.polished_blackstone_brick_slab": "Dalle de briques de pierre noire polie",
	"block.minecraft.polished_blackstone_brick_stairs": "Escaliers de briques de pierre noire polie",
	"block.minecraft.polished_blackstone_brick_wall": "Muret de briques de pierre noire polie",
	"block.minecraft.polished_blackstone_bricks": "Briques de pierre noire polie",
	"block.minecraft.polished_blackstone_button": "Bouton en roche noire polie",
	"block.minecraft.polished_blackstone_pressure_plate": "Plaque de pression en roche noire polie",
	"block.minecraft.polished_blackstone_slab": "Dalle de roche noire polie",
	"block.minecraft.polished_blackstone_stairs": "Escaliers de roche noire polie",
	"block.minecraft.polished_blackstone_wall": "Muret de roche noire polie",
	...
	"block.minecraft.polished_deepslate_stairs": "Escaliers d'ardoise profonde polie",
	"block.minecraft.polished_deepslate_wall": "Muret d'ardoise profonde polie",
	...
	"block.minecraft.purple_concrete_powder": "Poudre de béton violet",
	...
	"block.minecraft.red_concrete_powder": "Poudre de béton rouge",
	...
	"block.minecraft.reinforced_deepslate": "Ardoise profonde renforcée",
	...
	"block.minecraft.small_dripleaf": "Petite feuille goutte",
	...
	"block.minecraft.spawner": "Générateur de monstres",
	...
	"block.minecraft.spruce_fence": "Clôture en sapin",
	"block.minecraft.spruce_fence_gate": "Porte de clôture en sapin",
	...
	"block.minecraft.spruce_slab": "Dalle de sapin",
	"block.minecraft.spruce_stairs": "Escaliers de sapin",
	...
	"block.minecraft.stone_pressure_plate": "Plaque de pression en roche",
	"block.minecraft.stone_slab": "Dalle de roche",
	"block.minecraft.stone_stairs": "Escaliers de roche",
	...
	"block.minecraft.sulfur_spike": "Pic de soufre",
	...
	"block.minecraft.warped_fence": "Clôture biscornue",
	"block.minecraft.warped_fence_gate": "Porte de clôture biscornue",
	...
	"block.minecraft.warped_stairs": "Escaliers biscornus",
	...
	"block.minecraft.waxed_weathered_copper": "Cuivre patiné ciré",
	...
	"block.minecraft.weathered_copper": "Cuivre patiné",
	...
	"block.minecraft.wet_sponge": "Éponge humide",
	...
	"block.minecraft.white_concrete_powder": "Poudre de béton blanc",
	...
	"block.minecraft.yellow_concrete_powder": "Poudre de béton jaune",
	...
	"book.finalizeWarning": "Attention ! Une fois signé, le livre n'est plus modifiable.",
	...
	"chat.cannotSend": "Impossible d'envoyer de message dans le tchat",
	"chat.coordinates": "%s, %s, %s",
	"chat.coordinates.tooltip": "Cliquez pour vous y téléporter",
	"chat.copy": "Copier dans le presse-papiers",
	"chat.copy.click": "Cliquez pour copier dans le presse-papiers",
	"chat.deleted_marker": "Ce message du tchat a été supprimé par le serveur.",
	"chat.disabled.chain_broken": "Tchat désactivé à cause d'une chaîne brisée. Veuillez essayer de vous reconnecter.",
	"chat.disabled.expiredProfileKey": "Le tchat est désactivé en raison de l'expiration de la clé publique du profil. Veuillez essayer de vous reconnecter.",
	"chat.disabled.invalid_command_signature": "La commande comportait des signatures d'argument de commande inattendues ou manquantes.",
	"chat.disabled.invalid_signature": "La signature du chat était invalide. Veuillez essayer de vous reconnecter.",
	"chat.disabled.launcher": "Tchat désactivé dans les options du Launcher. Impossible d'envoyer de message.",
	"chat.disabled.missingProfileKey": "Chat désactivé en raison d'une clé publique manquante. Veuillez essayer de vous reconnecter.",
	...
	"chat.disabled.profile": "Le tchat est désactivé dans les paramètres du compte. Rappuyez sur \"%s\" pour plus d'informations.",
	"chat.disabled.profile.moreInfo": "Le tchat est désactivé dans les paramètres du compte. Impossible d'envoyer ou de consulter les messages.",
	"chat.editBox": "du tchat",
	"chat.filtered": "Filtré par le serveur.",
	"chat.filtered_full": "Le serveur a masqué votre message pour certains joueurs.",
	...
	"chat_screen.usage": "Écrivez votre message et appuyez sur Entrée pour l'envoyer",
	...
	"clear.failed.multiple": "Aucun objet n'a été trouvé sur les %s joueurs",
	...
	"commands.advancement.grant.criterion.to.many.failure": "Impossible d'accorder le critère \"%s\" du progrès %s à %s joueurs parce qu'ils le possèdent déjà",
	"commands.advancement.grant.criterion.to.many.success": "Le critère \"%s\" du progrès %s a été accordé à %s joueurs",
	"commands.advancement.grant.criterion.to.one.failure": "Impossible d'accorder le critère \"%s\" du progrès %s à %s parce que ce joueur le possède déjà",
	"commands.advancement.grant.criterion.to.one.success": "Le critère \"%s\" du progrès %s a été accordé à %s",
	"commands.advancement.grant.many.to.many.failure": "Impossible d'accorder %s progrès à %s joueurs parce qu'ils les possèdent déjà",
	"commands.advancement.grant.many.to.many.success": "%s progrès ont été accordés à %s joueurs",
	"commands.advancement.grant.many.to.one.failure": "Impossible d'accorder %s progrès à %s parce que ce joueur les possède déjà",
	"commands.advancement.grant.many.to.one.success": "%s progrès ont été accordés à %s",
	"commands.advancement.grant.one.to.many.failure": "Impossible d'accorder le progrès %s à %s joueurs parce qu'ils le possèdent déjà",
	"commands.advancement.grant.one.to.many.success": "Le progrès %s a été accordé à %s joueurs",
	"commands.advancement.grant.one.to.one.failure": "Impossible d'accorder le progrès %s à %s parce que ce joueur le possède déjà",
	"commands.advancement.grant.one.to.one.success": "Le progrès %s a été accordé à %s",
	...
	"commands.advancement.revoke.criterion.to.one.failure": "Impossible de révoquer le critère \"%s\" du progrès %s de %s parce que ce joueur ne le possède pas",
	...
	"commands.advancement.revoke.many.to.one.failure": "Impossible de retirer %s progrès de %s car ce joueur ne les possède pas",
	...
	"commands.advancement.revoke.one.to.one.failure": "Impossible de retirer le progrès %s de %s parce que ce joueur ne le possède pas",
	...
	"commands.attribute.base_value.set.success": "La valeur de base de l'attribut %s del'entité %s a été définie à %s",
	...
	"commands.clone.overlap": "Les zones source et de destination ne peuvent pas se chevaucher",
	"commands.clone.success": "Clonage de %s bloc(s) avec succès",
	"commands.clone.toobig": "Trop de blocs dans la zone spécifiée (%s au maximum, mais %s spécifiés)",
	...
	"commands.data.block.get": "%s sur le bloc en %s, %s, %s après un facteur d'échelle de %s est de %s",
	...
	"commands.data.entity.get": "%s sur %s après un facteur d'échelle de %s est de %s",
	...
	"commands.data.storage.get": "%s dans le stockage %s après un facteur d'échelle de %s est de %s",
	...
	"commands.datapack.create.success": "Nouveau pack vide sous le nom \"%s\" a été créé",
	...
	"commands.defaultgamemode.success": "Le mode de jeu par défaut est maintenant : %s",
	...
	"commands.difficulty.failure": "La difficulté n'a pas changé, elle est déjà définie sur %s",
	...
	"commands.effect.clear.everything.failed": "La cible ne possède aucun effet à retirer",
	...
	"commands.effect.clear.specific.failed": "La cible ne possède pas l'effet demandé",
	...
	"commands.effect.give.failed": "Impossible d'appliquer cet effet (la cible est soit immunisée aux effets, soit possède un effet plus puissant)",
	...
	"commands.execute.blocks.toobig": "Trop de blocs dans la zone spécifiée (%s au maximum, mais %s spécifiés)",
	...
	"commands.experience.add.levels.success.multiple": "%[2]s joueurs ont reçu %[1]s niveau(x) d'expérience",
	"commands.experience.add.levels.success.single": "%[2]s a reçu %[1]s niveau(x) d'expérience",
	"commands.experience.add.points.success.multiple": "%[2]s joueurs ont reçu %[1]s point(s) d'expérience",
	"commands.experience.add.points.success.single": "%[2]s a reçu %[1]s point(s) d'expérience",
	"commands.experience.query.levels": "%s a %s niveau(x) d'expérience",
	"commands.experience.query.points": "%s a %s point(s) d'expérience",
	"commands.experience.set.levels.success.multiple": "%[2]s ont été définis à %[1]s niveau(x) d'expérience",
	"commands.experience.set.levels.success.single": "%[2]s ont été définis à %[1]s niveau(x) d'expérience",
	"commands.experience.set.points.invalid": "Impossible de définir des points d'expérience au-delà du maximum autorisé pour le niveau actuel du joueur",
	"commands.experience.set.points.success.multiple": "%[2]s ont été définis à %[1]s point(s) d'expérience",
	"commands.experience.set.points.success.single": "%[2]s a été défini à %[1]s point(s) d'expérience",
	...
	"commands.fill.toobig": "Trop de blocs dans la zone spécifiée (%s au maximum, mais %s spécifiés)",
	...
	"commands.fillbiome.toobig": "Trop de blocs dans le volume spécifié (%s au maximum, mais %s spécifiés)",
	...
	"commands.forceload.toobig": "Trop de chunks dans la zone spécifiée (%s au maximum, mais %s spécifiés)",
	"commands.function.error.argument_not_compound": "Type d'argument invalide : %s. Composé attendu",
	...
	"commands.give.success.multiple": "%[3]s joueurs ont reçu %[1]s %[2]s",
	"commands.give.success.single": "%[3]s a reçu %[1]s %[2]s",
	...
	"commands.jfr.dump.failed": "Échec de l'export de l'enregistrement JFR : %s",
	"commands.jfr.start.failed": "Échec du démarrage du profilage JFR",
	"commands.jfr.started": "Démarrage du profilage JFR",
	"commands.jfr.stopped": "Arrêt du profilage JFR et export dans %s",
	...
	"commands.kill.success.multiple": "%s entités ont été tuées",
	"commands.kill.success.single": "%s a été tué(e)",
	...
	"commands.locate.biome.success": "Le biome \"%s\" le plus proche se trouve en %s (à %s blocs de distance)",
	"commands.locate.poi.not_found": "Impossible de trouver un point d'intérêt de type \"%s\" à une distance raisonnable",
	"commands.locate.poi.success": "La structure \"%s\" la plus proche se trouve en %s (à %s blocs de distance)",
	"commands.locate.structure.invalid": "Il n'y a pas de structure de type \"%s\"",
	"commands.locate.structure.not_found": "Impossible de trouver une structure de type \"%s\" à proximité",
	"commands.locate.structure.success": "La structure \"%s\" la plus proche se trouve en %s (à %s blocs de distance)",
	...
	"commands.perf.started": "Démarrage d'une session de profilage des performances de 10 secondes (utilisez \"/perf stop\" pour l'interrompre)",
	...
	"commands.place.jigsaw.invalid": "Il n'y a pas d'ensemble de modèles de type \"%s\"",
	"commands.place.jigsaw.success": "Le puzzle a été généré en %s, %s, %s",
	"commands.place.structure.failed": "Échec de placement de la structure",
	"commands.place.structure.invalid": "Il n'y a pas de structure de type \"%s\"",
	...
	"commands.rotate.success": "%s a été orienté(e)",
	...
	"commands.save.saving": "Sauvegarde de la partie... (cela peut prendre un petit moment !)",
	...
	"commands.scoreboard.players.add.success.multiple": "Le score de %[3]s a été augmenter de %[1]s pour l'objectif %[2]s",
	"commands.scoreboard.players.add.success.single": "Le score de %[3]s a été augmenter de %[1]s pour l'objectif %[2]s (il est maintenant de %s)",
	...
	"commands.scoreboard.players.enable.success.multiple": "%[2]s entités bénéficients désormais du déclencheur %[1]s",
	"commands.scoreboard.players.enable.success.single": "%[2]s bénéficit désormais du déclencheur %[1]s",
	"commands.scoreboard.players.get.null": "Impossible d'obtenir la valeur de %[2]s pour l'objectif %[1]s parce qu'aucune n'a été définie",
	"commands.scoreboard.players.get.success": "Le score de %s est de %s pour l'objectif %s",
	...
	"commands.scoreboard.players.operation.success.multiple": "Le score de %[2]s entités ont été mis à jour pour l'objectf %[1]s",
	"commands.scoreboard.players.operation.success.single": "Le score de %[2]s a été défini sur %[3]s pour l'objectif %[1]s",
	"commands.scoreboard.players.remove.success.multiple": "Le score de %[3]s entités a été réduit de %[1]s pour l'objectif %[2]s",
	"commands.scoreboard.players.remove.success.single": "Le score de %[3]s a été réduit de %[1]s pour l'objectif %[2]s (il est maintenant de %[4]s)",
	...
	"commands.scoreboard.players.reset.specific.multiple": "Le score de %[2]s entités a été réinitialisé pour l'objectif %[1]s",
	"commands.scoreboard.players.reset.specific.single": "Le score de %[2]s a été réinitialisé pour l'objectif %[1]s",
	"commands.scoreboard.players.set.success.multiple": "Le score de %[2]s entités a été défini sur %[3]s pour l'objectif %[1]s",
	"commands.scoreboard.players.set.success.single": "Le score de %[2]s a été défini sur %[3]s pour l'objectif %[1]s",
	...
	"commands.spectate.cannot_spectate": "%s ne peut pas être observé(e)",
	...
	"commands.spreadplayers.success.entities": "Répartition de %s entité(s) autour de %s, %s sur une distance moyenne de %s bloc(s) entre elles",
	...
	"commands.stopwatch.query": "Le chronomètre \"%s\" a tourné pendant %s seconde(s)",
	...
	"commands.swing.success.multiple": "%s entités ont agités leur bras",
	...
	"commands.team.option.color.clear.success": "La couleur de l'équipe %s a été retirée",
	"commands.team.option.color.success": "La couleur de l'équipe %s est maintenant %s",
	"commands.team.option.color.unchanged": "Rien n'a changé. Cette équipe est déjà de cette couleur",
	...
	"commands.team.option.friendlyfire.alreadyEnabled": "Rien n'a changé. Le tir alié est déjà activé pour cette équipe",
	...
	"commands.team.option.prefix.success": "Le préfixe d'équipe a été défini sur %s",
	...
	"commands.team.option.suffix.success": "Le suffixe d'équipe a été défini sur %s",
	...
	"commands.test.create.success": "Configuration de test créée pour le test %s",
	...
	"commands.test.error.non_existant_test": "Le test %s n'a pas pu être trouvé",
	"commands.test.error.structure_not_found": "La structure de test %s n'a pas pu être trouvée",
	"commands.test.error.test_instance_not_found": "L'entité de bloc d'instance de test n'a pas pu être trouvée",
	"commands.test.error.test_instance_not_found.position": "L'entité de bloc d'instance de test n'a pas pu être trouvée pour le test en %s, %s, %s",
	...
	"commands.time.query": "Le temps est de %s tick(s)",
	"commands.time.query.absolute": "L'horloge %s est à %s tick(s)",
	"commands.time.query.gametime": "Le temps de jeu est de %s tick(s)",
	"commands.time.query.timeline": "La chronologie %s est à %s tick(s)",
	"commands.time.query.timeline.repetitions": "La chronologie %s s'est répétée %s fois",
	"commands.time.rate": "L'horloge %s avancera désormais à %s fois la vitesse normale",
	...
	"commands.time.wrong_timeline_for_clock": "La chronologie %s n'est pas valide pour l'horloge %s",
	...
	"commands.weather.set.rain": "Ça se met à roiller",
	"commands.weather.set.thunder": "Ça se met à roiller, avec de l'orage",
	...
	"compliance.playtime.message": "Un temps de jeu excessif peut interférer avec votre vie quotidienne",
	...
	"connect.encrypting": "Chiffrement...",
	...
	"connect.p2p.failed.signaling": "Il n'est pas possible de se connecter pour le moment. Veuillez réessayer plus tard.",
	...
	"container.creative": "Sélection d'objets",
	...
	"createWorld.customize.buffet.title": "Personnalisation d'un biome unique",
	...
	"createWorld.customize.presets.list": "Sinon, en voici quelques-uns créés au préalable !",
	...
	"dataPack.trade_rebalance.name": "Rééquilibrage des échanges des villageois",
	...
	"death.attack.anvil.player": "%[1]s s'est fait écraser par une enclume lors d'un combat contre (un(e)) %[2]s",
	...
	"death.attack.cactus.player": "%[1]s s'est pris un cactus en tentant de fuir (un(e)) %[2]s",
	"death.attack.cramming": "%[1]s a subis trop de pression",
	"death.attack.cramming.player": " %[1]s a subis trop de pression par (un(e)) %[2]s",
	...
	"death.attack.fallingBlock.player": "%[1]s s'est fait écraser par un bloc lors d'un combat contre (un(e)) %[2]s",
	"death.attack.fallingStalactite": "%[1]s s'est fait transpercer par une stalactite",
	"death.attack.fallingStalactite.player": "%[1]s s'est fait transpercer par une stalactite lors d'un combat contre (un(e)) %[2]s",
	...
	"death.attack.fireworks.player": "%[1]s s'est fait pulvériser dans un feu d'artifice lors d'un combat contre (un(e)) %[2]s",
	...
	"death.attack.freeze": "%[1]s est mort gelé(e)",
	"death.attack.freeze.player": "%[1]s est mort gelé(e) par %[2]s",
	...
	"death.attack.genericKill.player": "%[1]s est mort lors d'un combat contre %[2]s",
	...
	"death.attack.inFire": "%[1]s s'est fait carboniser",
	"death.attack.inFire.player": "%[1]s a marché dans le feu lors d'un combat contre (un(e)) %[2]s",
	"death.attack.inWall": "%[1]s a suffoqué dans un mur",
	"death.attack.inWall.player": "%[1]s a suffoqué dans un mur lors d'un combat contre (un(e)) %[2]s",
	"death.attack.indirectMagic": "%[1]s s'est fait tuer par (un(e)) %[2]s en utilisant de la magie",
	"death.attack.indirectMagic.item": "%[1]s s'est fait tuer par (une(e)) %%[2]s avec %[3]s",
	...
	"death.attack.lightningBolt.player": "%[1]s s'est fait frapper par la foudre lors d'un combat contre (un(e)) %[1]s",
	"death.attack.mace_smash": "%[1]s s'est fait aplatir par (un(e)) %[2]s",
	"death.attack.mace_smash.item": "%[1]s s'est fait aplatir par (un(e)) %[2]s avec %[3]s",
	...
	"death.attack.mob.item": "%[1]s s'est fait tuer par un(e) %[2]s en utilisant %[3]s",
	"death.attack.onFire": "%[1]s s'est fait carboniser à mort",
	"death.attack.onFire.item": "%[1]s s'est fait réduire en cendres lors d'un combat contre (un(e)) %[2]s brandissant %[3]s",
	"death.attack.onFire.player": "%[1]s s'est fait réduire en cendres lors d'un combat contre (un(e)) %[2]s",
	"death.attack.outOfWorld": "%[1]s est tombé hors du monde",
	...
	"death.attack.outsideBorder.player": "%[1]s a quitté les confins de ce monde lors d'un combat contre (un(e)) %[2]s",
	"death.attack.player": "%[1]s s'est fait tuer par %[2]s",
	"death.attack.player.item": "%[1]s s'est fait tuer par %[2]s en utilisant %[3]s",
	"death.attack.sonic_boom": "%[1]s s'est fait pulvérisé par une onde supersonique",
	"death.attack.sonic_boom.item": "%[1]s s'est fait pulvérisé par une onde supersonique en tentant de fuir (un(e)) %[2]s brandissant %[3]s",
	"death.attack.sonic_boom.player": "%[1]s s'est fait pulvérisé par une onde supersonique en tentant de fuir (un(e)) %[2]s",
	"death.attack.spear": "%[1]s s'est fait transpercer par (un(e)) %[2]s",
	"death.attack.spear.item": "%[1]s s'est fait transpercer par (un(e)) %[2]s en utilisant %[3]s",
	"death.attack.stalagmite": "%[1]s s'est fait empaler sur une stalagmite",
	"death.attack.stalagmite.player": "%[1]s s'est fait empaler sur une stalagmite lors d'un combat contre (un(e)) %[2]s",
	"death.attack.starve": "%[1]s est mort(e) de faim",
	"death.attack.starve.player": "%[1]s est mort(e) de faim lors d'un combat contre (un(e)) %[2]s",
	"death.attack.sting": " %[1]s s'est fait piquer à mort",
	"death.attack.sting.item": "%[1]s a s'est fait piqué à mort par (un(e)) %[2]s en utilisant %[3]s",
	...
	"death.attack.wither.player": "%[1]s est mort(e) de décomposition lors d'un combat contre (un(e)) %[2]s",
	...
	"death.fell.accident.vines": "%[1]s est tombé(e) de lianes",
	"death.fell.accident.weeping_vines": "%[1]s est tombé(e) de lianes pleureuses",
	...
	"deathScreen.spectate": "Observer le monde",
	"deathScreen.title": "Vous êtes mort(e) !",
	"deathScreen.title.hardcore": "Partie terminée !",
	...
	"debug.clear_chat.help": "F3 + D = Nettoyer le tchat",
	"debug.copy_location.help": "F3 + C = Copier la position sous forme de commande /tp, ou maintenir 10 secondes pour faire planter le jeu",
	...
	"debug.dump_dynamic_textures.help": "F3 + S = Exporter l'atlas des textures dynamiques",
	"debug.entry.always": "Oui",
	"debug.entry.currently.alwaysOn": "%s : actuellement toujours visible",
	"debug.entry.currently.inF3": "%s : actuellement uniquement dans le menu F3",
	"debug.entry.currently.inOverlay": "%s : actuellement visible uniquement dans l'overlay de débogage",
	...
	"debug.inspect.client.block": "Les données du bloc côté client ont été copiées dans le presse-papiers",
	"debug.inspect.client.entity": "Les données de l'entité côté client ont été copiées dans le presse-papiers",
	"debug.inspect.help": "F3 + I = Copier les données d'entité ou de bloc dans le presse-papiers",
	"debug.inspect.server.block": "Les données du bloc côté serveur ont été copiées dans le presse-papiers",
	"debug.inspect.server.entity": "Les données de l'entité côté serveur ont été copiées dans le presse-papiers",
	...
	"debug.pause.help": "F3 + Échap = Mettre en pause sans afficher le menu (si c'est possible)",
	...
	"demo.day.1": "Cette démo durera cinq jours de jeu. Faites de votre mieux !",
	"demo.day.2": "Deuxième jour",
	"demo.day.3": "Troisième jour",
	"demo.day.4": "Quatrième jour",
	"demo.day.5": "C'est votre dernier jour !",
	"demo.day.6": "Votre cinquième jour s'est écoulé. Utilisez %s pour prendre une capture d'écran de votre création.",
	"demo.day.warning": "La démo est presque terminée !",
	"demo.demoExpired": "Démo terminée !",
	"demo.help.buy": "Acheter maintenant !",
	"demo.help.fullWrapped": "Cette démo durera 5 jours en jeu (environ 1 ht 40 en temps réel). Consultez les progrès pour obtenir des conseils ! Amusez-vous bien !",
	...
	"demo.help.movementMouse": "Regardez autour de vous à l'aide de la souris",
	...
	"demo.reminder": "La démo est terminée. Achetez le jeu pour continuer ou commencez un nouveau monde !",
	...
	"editGamerule.inGame.discardChanges.message": "Voulez vous vraiment abandonner vos modifications des règles de jeu en cours ?",
	...
	"effect.minecraft.glowing": "Luminescence",
	...
	"effect.minecraft.jump_boost": "Saut amélioré",
	...
	"entity.minecraft.block_display": "Bloc d'affichage",
	...
	"entity.minecraft.glow_item_frame": "Cadre brillant",
	"entity.minecraft.glow_squid": "Poulpe luminescent",
	"entity.minecraft.goat": "Chèvre",
	"entity.minecraft.guardian": "Gardien",
	"entity.minecraft.happy_ghast": "Ghast content",
	...
	"entity.minecraft.item_display": "Objet d'affichage",
	...
	"entity.minecraft.parched": "Déserteur",
	"entity.minecraft.parrot": "Perroquet",
	"entity.minecraft.phantom": "Spectre",
	...
	"entity.minecraft.snow_golem": "Bonhomme de neige",
	"entity.minecraft.snowball": "Boule de neige",
	"entity.minecraft.spawner_minecart": "Wagonnet avec générateur de monstres",
	...
	"entity.minecraft.text_display": "Texte d'affichage",
	...
	"entity.minecraft.tropical_fish.predefined.0": "Anémone",
	"entity.minecraft.tropical_fish.predefined.1": "Chirurgien à rostre",
	"entity.minecraft.tropical_fish.predefined.10": "Idole des maures",
	...
	"entity.minecraft.tropical_fish.predefined.8": "Empereur rouge",
	"entity.minecraft.tropical_fish.predefined.9": "Rouget",
	"entity.minecraft.tropical_fish.type.betty": "Betty",
	"entity.minecraft.tropical_fish.type.blockfish": "Poisson-bloc",
	"entity.minecraft.tropical_fish.type.brinely": "Salinette",
	"entity.minecraft.tropical_fish.type.clayfish": "Argileux",
	...
	"entity.minecraft.tropical_fish.type.sunstreak": "Soleillé",
	...
	"flat_world_preset.minecraft.classic_flat": "Plat classique",
	...
	"gamerule.category.updates": "Actualisation du monde",
	"gamerule.commandBlockOutput": "Affichage des sorties des blocs de commande",
	...
	"gamerule.commandModificationBlockLimit.description": "Le nombre de blocs pouvant être modifiés à la fois par une commande, telle que /fill ou /clone.",
	...
	"gamerule.doDaylightCycle": "Avancement du cycle jour-nuit",
	"gamerule.doEntityDrops": "Lâcher les objets d'entités",
	...
	"gamerule.doInsomnia": "Apparition des Spectres",
	"gamerule.doLimitedCrafting": "Recette requise pour la fabrication",
	"gamerule.doLimitedCrafting.description": "Si activée, les joueurs ne pourront fabriquer qu'à partir des recettes déjà débloquées.",
	"gamerule.doMobLoot": "Lacher le butin des créatures",
	"gamerule.doMobLoot.description": "Contrôle les butins des créatures, incluant les orbes d'expériences.",
	...
	"gamerule.doTileDrops.description": "Contrôle les butins des blocs, incluant les orbes d'expériences.",
	"gamerule.doTraderSpawning": "Apparition de marchands ambulants",
	"gamerule.doVinesSpread": "Propagation des lianes",
	"gamerule.doVinesSpread.description": "Contrôle l'activation de la propagation aléatoire des lianes sur les blocs adjacents. Cela n'affecte pas les autres types de lianes tels que les lianes pleureuses, les lianes torsadées, etc.",
	...
	"gamerule.enderPearlsVanishOnDeath.description": "Contrôle si les perles de l'Ender lancées par un joueur mort disparaissent.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Utilisation d'un portail par une entité avec un passager",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Permet aux entités avec des passagers d'utiliser les portails du Nether, de l'End ou des passerelles de l'End.",
	"gamerule.fallDamage": "Dégâts de chute",
	"gamerule.fireDamage": "Dégâts de feu",
	"gamerule.forgiveDeadPlayers": "Pardon des joueurs morts",
	...
	"gamerule.globalSoundEvents": "Évènements sonores globaux",
	...
	"gamerule.locatorBar.description": "Si activée, une barre indiquant la position des joueurs est affichée.",
	"gamerule.logAdminCommands": "Affichage des commandes d'administrateur",
	...
	"gamerule.minecartMaxSpeed.description": "La vitesse maximale par défaut d'un wagonnet en mouvement sur la terre ferme.",
	...
	"gamerule.minecraft.universal_anger.description": "Les créatures neutres en colère attaquent n'importe quel joueur à proximité, pas seulement celui qui les a provoquées. Fonctionne mieux lorsque la règle \"forgive_dead_players\" est désactivée.",
	"gamerule.mobExplosionDropDecay": "Perte de blocs dans les explosions de créatures",
	"gamerule.mobExplosionDropDecay.description": "Lors d'une explosion de créature certains blocs peuvent être perdus.",
	...
	"gamerule.playersNetherPortalCreativeDelay.description": "Le temps (en ticks) pendant lequel un joueur en mode Créatif doit attendre en restant dans un portail du nether avant de changer de dimension.",
	"gamerule.playersNetherPortalDefaultDelay": "Délai du portail du Nether",
	"gamerule.playersNetherPortalDefaultDelay.description": "Le temps (en ticks) pendant lequel un joueur qui n'est pas en mode Créatif doit rester dans un portail du Nether avant de changer de dimension.",
	...
	"gamerule.snowAccumulationHeight.description": "Lorsqu'il neige, des couches de neige se forment au sol jusqu'à cette hauteur.",
	"gamerule.spawnChunkRadius": "Rayon des chunks d'apparition",
	"gamerule.spawnChunkRadius.description": "Le nombre de chunks qui restent chargés autour du point d'apparition de l'Overworld.",
	...
	"gamerule.spawnerBlocksEnabled": "Activer les générateurs",
	...
	"gamerule.tntExplosionDropDecay": "Lors des explosions de TNT, certains blocs ne lâcheront pas leur butin",
	"gamerule.tntExplosionDropDecay.description": "Une partie des objets lâchés par les blocs détruits par des explosions causées par de la TNT est perdue dans l'explosion.",
	"gamerule.universalAnger": "Colère universelle",
	"gamerule.universalAnger.description": "Les créatures neutres en colère attaquent tous les joueurs à proximité, pas seulement celui qui les a provoquées. Plus efficace lorsque la règle \"forgiveDeadPlayers\" est désactivée.",
	"gamerule.waterSourceConversion": "Transformation de l'eau en source",
	"gamerule.waterSourceConversion.description": "Lorsqu'un écoulement d'eau est entouré par deux sources d'eau, il se transforme en source.",
	"generator.custom": "Personnalisé",
	"generator.customized": "Personnalisé (ancien)",
	"generator.minecraft.amplified": "AMPLIFIÉ",
	"generator.minecraft.amplified.info": "Remarque : juste pour le fun ! Nécéssite un ordinateur puissant.",
	"generator.minecraft.debug_all_block_states": "Mode de débogage",
	"generator.minecraft.flat": "Monde plat",
	"generator.minecraft.large_biomes": "Biomes vastes",
	"generator.minecraft.normal": "Défaut",
	...
	"gui.abuseReport.attestation": "En soumettant ce signalement, vous confirmez que les informations que vous avez fournies sont exactes et complètes à votre connaissance.",
	...
	"gui.abuseReport.discard.content": "Si vous quittez cette page, vous perdrez ce signalement et vos commentaires.\nÊtes-vous sûr de vouloir quitter cette page ?",
	"gui.abuseReport.discard.discard": "Quitter et abandonner",
	"gui.abuseReport.discard.draft": "Enregistrer comme brouillon",
	...
	"gui.abuseReport.draft.content": "Souhaitez-vous continuer à modifier le signalement existant ou le supprimer et en créer un nouveau ?",
	...
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse.description": "Quelqu'un parle ou encourage d'une manière ou d'une autre un comportement impliquant des enfants.",
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Diffamation",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Quelqu'un porte atteinte à votre réputation ou à celle d'une autre personne, par exemple en partageant de fausses informations dans le but d'exploiter ou de tromper autrui.",
	...
	"gui.abuseReport.reason.generic.description": "Ils m'énervent / ils ont fait quelque chose qui ne me plaît pas.",
	"gui.abuseReport.reason.harassment_or_bullying": "Harcèlement ou intimidation",
	"gui.abuseReport.reason.harassment_or_bullying.description": "Quelqu'un vous humilie, vous agresse ou vous intimide, vous ou quelqu'un d'autre. Cela inclut le fait qu'une personne tente à plusieurs reprises de vous contacter ou de contacter quelqu'un d'autre sans votre consentement, ou publie des informations personnelles privées vous concernant ou concernant quelqu'un d'autre sans votre consentement (\"doxing\").",
	"gui.abuseReport.reason.hate_speech": "Propos haineux",
	"gui.abuseReport.reason.hate_speech.description": "Quelqu'un vous attaque ou attaque un autre joueur en raison de caractéristiques liées à son identité, telles que sa religion, son origine ethnique ou son orientation sexuelle.",
	...
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "Quelqu'un parle, partage ou diffuse de quelque manière que ce soit des images privées et intimes.",
	"gui.abuseReport.reason.self_harm_or_suicide": "Suicide ou automutilation",
	...
	"gui.abuseReport.reason.title": "Sélectionner une catégorie de signalement",
	...
	"gui.abuseReport.send.json_error": "Une charge utile malformée a été rencontrée lors de l'envoi de votre signalement.",
	"gui.abuseReport.send.no_reason": "Sélectionnez une catégorie de signalement",
	"gui.abuseReport.send.not_attested": "Veuillez lire le texte ci-dessus et cocher la case pour pouvoir envoyer le signalement",
	"gui.abuseReport.send.service_unavailable": "Impossible d'accéder au service de signalement des abus. Veuillez vous assurer que vous êtes connecté à Internet et réessayez.",
	...
	"gui.banned.description.unknownreason": "Nous avons récemment reçu un signalement concernant un comportement inapproprié de votre part. Nos modérateurs ont examiné votre cas et ont déterminé qu'il enfreignait les normes communautaires de Minecraft.",
	"gui.banned.name.description": "Votre nom d'utilisateur actuel, \"%s\", enfreint les standards de la communauté. Vous pouvez jouer en solo, mais vous devrez changer de nom pour pouvoir jouer en ligne.\n\nDécouvrez-en plus ou demandez une révision de votre cas grâce au lien suivant : %s",
	...
	"gui.banned.reason.extreme_violence_or_gore": "Dépiction réelle de violence excessive ou de contenu sanglant",
	...
	"gui.chatReport.discard.discard": "Quitter et abandonner le signalement",
	"gui.chatReport.discard.draft": "Enregistrer comme brouillon",
	...
	"gui.chatReport.selected_chat": "%s message(s) sélectionné(s) à signaler",
	"gui.chatReport.send": "Envoyer",
	"gui.chatReport.send.comments_too_long": "Veuillez raccourcir le commentaire",
	"gui.chatReport.send.no_reason": "Veuillez sélectionner une catégorie",
	...
	"gui.copy_link_to_clipboard": "Copier le lien dans le presse-papiers",
	"gui.days": "%s jour(s)",
	"gui.done": "Terminé",
	"gui.down": "Bas",
	...
	"gui.friends.button.loading.join_request_pending": "En attente de la confirmation de %s",
	...
	"gui.friends.copy_to_clipboard": "Copier dans le presse-papiers",
	...
	"gui.friends.error.connection_issue": "La liste d'amis est actuellement indisponible.\n\nVeuillez vérifier votre connexion Internet puis réessayez.",
	"gui.friends.error.failed.message": "Envoi de demande d'ami actuellement impossible",
	"gui.friends.error.forbidden.message": "Échec de l'action. Cela peut être dû aux paramètres de confidentialité du compte.",
	"gui.friends.error.generic": "Quelque chose cloche... avec cette fonctionnalité, pas vos amis !\n\nRéessayez plus tard.",
	...
	"gui.friends.error.unavailable.message": "Le service de liste d'amis est actuellement indisponible. Veuillez vérifier votre connexion Internet et réessayez plus tard.",
	"gui.friends.error.upgrade_needed": "Mettez le jeu à jour pour accéder à votre liste d'amis.",
	"gui.friends.error.user_may_lack_active_profile": "Il n'y a pas de joueur avec ce nom de profil",
	...
	"gui.friends.multiplayer.invite_reject": "Rejeter l'invitation à rejoindre le monde",
	"gui.friends.multiplayer.join_request": "Proposer de rejoindre le monde",
	"gui.friends.multiplayer.join_request_accept": "Accepter la proposition pour rejoindre le monde",
	...
	"gui.friends.narration.entry.incoming": "Vous avez reçu une demande d'ami de %s",
	...
	"gui.friends.toast.host_invite_expired.message": "L'invitation de %s à rejoindre ce monde a expiré.",
	...
	"gui.friends.toast.request_accepted.message": "Vous êtes désormais ami(e) avec %s",
	...
	"gui.friends.toast.request_to_join_friend.message": "La demande pour rejoindre le monde a été envoyée à %s",
	"gui.friends.toast.requests_accepted_multiple.message": "%s amis ont accepté vos demandes d'ami",
	...
	"gui.socialInteractions.empty_blocked": "Aucun joueur n'est bloqué dans le tchat",
	...
	"item.minecraft.beetroot": "Carotte rouge",
	"item.minecraft.beetroot_seeds": "Graines de carotte rouge",
	"item.minecraft.beetroot_soup": "Soupe de carotte rouge",
	...
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Décoration d'armure des boulons",
	...
	"item.minecraft.breeze_rod": "Bâton de Brise",
	"item.minecraft.breeze_spawn_egg": "Oeuf d'apparition de Brise",
	...
	"item.minecraft.cave_spider_spawn_egg": "Oeuf d'apparition d'araignée des cavernes",
	"item.minecraft.chainmail_boots": "Bottes de mailles",
	"item.minecraft.chainmail_chestplate": "Cotte de mailles",
	"item.minecraft.chainmail_helmet": "Casque de maille",
	...
	"item.minecraft.clock": "Montre à gousset",
	"item.minecraft.coal": "Charbon",
	"item.minecraft.coast_armor_trim_smithing_template": "Modèle de forge",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Décoration d'armure des littoraux",
	...
	"item.minecraft.command_block_minecart": "Wagonnet avec un bloc de commande",
	...
	"item.minecraft.copper_shovel": "Bêche en cuivre",
	...
	"item.minecraft.diamond_shovel": "Bêche en diamant",
	...
	"item.minecraft.dune_armor_trim_smithing_template.new": "Décoration d'armure des dunes",
	"item.minecraft.echo_shard": "Fragment d'écho",
	...
	"item.minecraft.eye_armor_trim_smithing_template.new": "Décoration d'armure de l'oeil",
	...
	"item.minecraft.firework_star.cyan": "du Cyan",
	"item.minecraft.firework_star.fade_to": "Fondu en",
	"item.minecraft.firework_star.flicker": "Étincelles",
	"item.minecraft.firework_star.gray": "Gris",
	"item.minecraft.firework_star.green": "du Vert",
	"item.minecraft.firework_star.light_blue": "du Bleu clair",
	...
	"item.minecraft.flow_armor_trim_smithing_template.new": "Décoration d'armure des tourbillons",
	...
	"item.minecraft.glow_ink_sac": "Poche d'encre luminescent",
	"item.minecraft.glow_item_frame": "Cadre luminescent",
	"item.minecraft.glow_squid_spawn_egg": "Oeuf d'apparition de poulpe luminescent",
	...
	"item.minecraft.golden_shovel": "Bêche en or",
	...
	"item.minecraft.happy_ghast_spawn_egg": "Oeuf d'apparition de Ghast heureux",
	...
	"item.minecraft.host_armor_trim_smithing_template.new": "Décoration d'armure des hôtes",
	"item.minecraft.howl_pottery_shard": "Tesson de poterie d'hurlement",
	"item.minecraft.howl_pottery_sherd": "Tesson de poterie d'hurlement",
	...
	"item.minecraft.iron_shovel": "Bêche en fer",
	...
	"item.minecraft.leather_helmet": "Couvre-chef en cuir",
	...
	"item.minecraft.lingering_potion.effect.mundane": "Potion ordinaire persistante",
	"item.minecraft.lingering_potion.effect.night_vision": "Potion de vision nocturne persistante",
	"item.minecraft.lingering_potion.effect.oozing": "Potion de gluante persistante",
	...
	"item.minecraft.lingering_potion.effect.thick": "Potion concentrée persistante",
	...
	"item.minecraft.lodestone_compass": "Compas magnétisée",
	...
	"item.minecraft.mourner_pottery_shard": "Tesson de poterie de deuil",
	"item.minecraft.mourner_pottery_sherd": "Tesson de poterie de deuil",
	...
	"item.minecraft.netherite_shovel": "Bêche en Netherite",
	...
	"item.minecraft.parched_spawn_egg": "Oeuf d'apparition de déserteur",
	"item.minecraft.parrot_spawn_egg": "Oeuf d'apparition de perroquet",
	"item.minecraft.phantom_membrane": "Membrane de Spectre",
	"item.minecraft.phantom_spawn_egg": "Oeuf d'apparition de Spectre",
	...
	"item.minecraft.piglin_brute_spawn_egg": "Oeuf d'apparition de Piglin brute",
	...
	"item.minecraft.poisonous_potato": "Patate empoisonnée",
	"item.minecraft.polar_bear_spawn_egg": "Oeuf d'apparition d'ours polaire",
	...
	"item.minecraft.potion.effect.mundane": "Potion ordinaire",
	...
	"item.minecraft.potion.effect.thick": "Potion concentrée",
	...
	"item.minecraft.prismarine_shard": "Fragment de prismarine",
	...
	"item.minecraft.pufferfish_bucket": "Fugu dans un seau",
	"item.minecraft.pufferfish_spawn_egg": "Oeuf d'apparition de fugu",
	...
	"item.minecraft.recovery_compass": "Compas de récupération",
	...
	"item.minecraft.snow_golem_spawn_egg": "Oeuf d'apparition de bonhomme de neige",
	...
	"item.minecraft.splash_potion.effect.awkward": "Potion bizarre jetable",
	...
	"item.minecraft.splash_potion.effect.mundane": "Potion ordinaire jetable",
	"item.minecraft.splash_potion.effect.night_vision": "Potion de vision nocturne jetable",
	"item.minecraft.splash_potion.effect.oozing": "Potion gluante jetable",
	...
	"item.minecraft.splash_potion.effect.thick": "Potion concentrée jetable",
	...
	"item.minecraft.stone_shovel": "Bêche en pierre",
	...
	"item.minecraft.tipped_arrow": "Flèche imprégnée",
	...
	"item.minecraft.tipped_arrow.effect.mundane": "Flèche à eau ordinaire",
	...
	"item.minecraft.ward_armor_trim_smithing_template.new": "Ornement d'armure des abîmes",
	"item.minecraft.warden_spawn_egg": "Oeuf d'apparition de Warden",
	"item.minecraft.warped_fungus_on_a_stick": "Champigon biscornu sur un bâton",
	"item.minecraft.water_bucket": "Seau d'eau",
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Modèle de forge",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Ornement d'armure des éclaireurs",
	...
	"item.minecraft.wooden_shovel": "Bêche en bois",
	...
	"item.spawn_egg.peaceful": "Désactivité en Paisible",
	...
	"itemGroup.spawnEggs": "Oeufs d'apparition",
	...
	"jigsaw_block.placement_priority.tooltip": "Lorsque ce bloc de puzzle se connecte à une pièce, cela définit l'ordre dans lequel cette pièce est traitée pour les connexions au sein de la structure globale.\n\nLes pièces seront traitées dans l'ordre décroissant, en suivant l'ordre d'insertion en cas d'égalité.",
	"jigsaw_block.pool": "Ensemble d'éléments cible :",
	"jigsaw_block.selection_priority": "Prio. de séléction :",
	"jigsaw_block.selection_priority.tooltip": "Lorsque la pièce parente est traitée pour les connexions, cela définit l'ordre dans lequel ce bloc de puzzle tente de se connecter à sa pièce cible.\n\nLes blocs de puzzle seront traités dans l'ordre décroissant, ou de manière aléatoire en cas d'égalité.",
	...
	"key.debug.copyLocation": "Copier votre position",
	...
	"key.debug.profilingChart": "Graphe de profilage",
	"key.debug.reloadChunk": "Recharger les chunks",
	"key.debug.reloadResourcePacks": "Recharger les pack de ressources",
	...
	"key.keyboard.keypad.enter": "Num Entrée",
	...
	"key.keyboard.minus": "-",
	"key.keyboard.num.lock": "Num Verr.",
	...
	"key.keyboard.scroll.lock": "Verr. défil",
	...
	"key.smoothCamera": "Mettre en mode cinématique",
	...
	"known_server_link.news": "Actualités",
	...
	"lanServer.port.invalid": "Port non valide.\nLaissez la champ de saisie vide ou entrez un numéro compris entre 1024 et 65535.",
	...
	"language.code": "fra_CH",
	"language.name": "Français",
	"language.region": "Suisse",
	...
	"mco.account.privacy.info": "En savoir plus sur Mojang et les lois sur la protection de la vie privée",
	"mco.account.privacy.info.button": "En savoir plus sur le RGPD",
	"mco.account.privacy.information": "Mojang met en œuvre certaines procédures pour protéger les enfants et leur vie privée, notamment en se conformant au Children's Online Privacy Protection Act (COPPA) et au Règlement général sur la protection des données (RGPD).\n\nVous devrez peut-être obtenir le consentement parental avant d'accéder à votre compte Realms.",
	"mco.account.privacyinfo": "Mojang met en œuvre certaines procédures pour protéger les enfants et leur vie privée, notamment en se conformant au Children's Online Privacy Protection Act (COPPA) et au Règlement général sur la protection des données (RGPD).\n\nVous devrez peut-être obtenir le consentement parental avant d'accéder à votre compte Realms.\n\nSi vous avez un ancien compte Minecraft (en vous connectant avec votre nom d'utilisateur), vous devez migrer le compte vers un compte Mojang afin d'accéder à Realms.",
	"mco.account.update": "Migrer le compte",
	"mco.activity.noactivity": "Aucune activité au cours des %s dernier(s) jour(s)",
	...
	"mco.backup.button.upload": "Importer un monde",
	...
	"mco.backup.entry.uploaded": "importé",
	...
	"mco.backup.info.title": "Modifications depuis la dernière sauvegarde",
	...
	"mco.client.incompatible.msg.line1": "Votre client n'est pas comptaible avec Realms.",
	...
	"mco.compatibility.downgrade.description": "Ce monde a été ouvert pour la dernière fois avec la version %s, or vous utilisez la version %s. Revenir à une version antérieure peut entraîner une corruption et nous ne pouvons pas garantir qu'il se chargera ou fonctionnera.\n\nUne sauvegarde de votre monde sera enregistrée dans \"Sauvegardes du monde\". Veuillez restaurer votre monde si nécessaire.",
	"mco.compatibility.incompatible.popup.title": "Version incompatible",
	"mco.compatibility.incompatible.releaseType.popup.message": "Le monde que vous essayez de rejoindre est incompatible avec la version que vous utilisez.",
	...
	"mco.compatibility.unverifiable.message": "La version dans laquelle ce monde a été ouvert pour la dernière fois n'a pas pu être vérifiée. Si le monde est mis à niveau ou rétrogradé, une sauvegarde sera automatiquement créée et enregistrée sous \"Sauvegardes\".",
	...
	"mco.configure.world.close.question.line1": "Vous pouvez fermer temporairement votre Realms, empêchant les joueurs de jouer lorsque vous apportez des modifications. Ouvrez-le à nouveau lorsque vous êtes prêt.\n\nCeci n'annule en aucun cas votre abonnement Realms.",
	...
	"mco.configure.world.leave.question.line1": "Si vous quittez ce Realm, vous en perdrez l'accès à moins d'y être réinvité(e)",
	...
	"mco.configure.world.players.error": "Il n'existe aucun joueur sous ce nom",
	"mco.configure.world.players.invite.duplicate": "Un joueur sous ce nom a déjà été invité sur le Realm",
	...
	"mco.configure.world.spawnAnimals": "Apparition des animaux",
	"mco.configure.world.spawnMonsters": "Apparition des monstres",
	"mco.configure.world.spawnNPCs": "Apparition des villageois",
	"mco.configure.world.spawnProtection": "Protection de la zone d'apparition",
	...
	"mco.configure.world.switch.slot.subtitle": "Ce monde est vide. Choisissez comment façonner votre monde",
	...
	"mco.configure.world.uninvite.question": "Voulez-vous vraiment retirer l'invitation",
	...
	"mco.create.world.subtitle": "Additionnellement, sélectionnez le monde que vous souhaitez mettre sur votre nouveau Realm",
	...
	"mco.download.confirmation.line2": "Vous ne pourrez plus importer ce monde sur votre Realm",
	...
	"mco.errorMessage.6004": "La limite d'importation a été atteinte",
	...
	"mco.minigame.world.info.line1": "Cela remplacera temporairement votre monde par un mini-jeu !",
	"mco.minigame.world.info.line2": "Vous pourrez revenir plus tard à votre monde d'origine sans rien perdre.",
	...
	"mco.reset.world.seed": "Graine du monde (facultative)",
	"mco.reset.world.template": "Modèles de monde",
	"mco.reset.world.title": "Réinitialisation du monde",
	"mco.reset.world.upload": "Importer un monde",
	"mco.reset.world.warning": "Cela remplacera le monde actuel de votre Realm",
	...
	"mco.selectServer.popup": "Realms est une façon sûre et simple de profiter d'un monde Minecraft en ligne avec jusqu'à dix de vos amis en même temps. Plein de mini-jeux et de mondes personnalisés sont inclus ! Seul le propriétaire du Realm a besoin de payer.",
	...
	"mco.snapshot.createSnapshotPopup.title": "Créer un Realm en snapshot ?",
	...
	"mco.snapshot.friendsRealm.upgrade": "%s doit mettre à niveau son Realm avant que vous puissiez jouer depuis cette version",
	...
	"mco.snapshot.tooltip": "Utilisez les Realms de snapshot pour avoir un apercu des prochaines versions de Minecraft, pouvant inclure de nouvelles fonctionnalites et d'autres changements.\n\nVous pouvez accéder à vos Realms normaux dans la version officielle du jeu.",
	...
	"mco.template.info.tooltip": "Site web des créateurs",
	...
	"mco.template.select.none.linkTitle": "envisagez de nous soumettre quelque de chose vous-même",
	...
	"mco.upload.hardcore": "Les mondes Hardcore ne peuvent être importés !",
	...
	"mco.upload.select.world.subtitle": "Veuillez sélectionner un monde solo à importer",
	"mco.upload.select.world.title": "Importation du monde",
	...
	"menu.multiplayerOptions.publish.started.lan": "Ce monde est maintenant ouvert au LAN. Port : %s",
	"menu.multiplayerOptions.publish.started.online": "Ce monde est désormais ouvert en multijoueur. Port : %s",
	"menu.multiplayerOptions.publish.stopped": "Ce monde n'est plus ouvert en multijoueur",
	"menu.multiplayerOptions.title": "Paramètres multijoueur",
	"menu.online": "Minecraft Realms",
	"menu.options": "Options...",
	"menu.paused": "Jeu en pause",
	"menu.playdemo": "Jouer dans le monde de démo",
	"menu.playerReporting": "Signalements",
	...
	"menu.server_links": "Liens serveur...",
	"menu.server_links.title": "Liens serveur",
	...
	"multiplayer.confirm_command.parse_errors": "Vous êtes sur le point d'exécuter une commande non reconnue ou invalide.\nVoulez-vous continuer ?\nCommande : %s",
	"multiplayer.confirm_command.permissions_required": "Vous tentez d'exécuter une commande qui nécéssite des permissions élevées.\nCela pourrait avoir un impact négatif sur votre jeu.\nVouslez-vous continuer ?\nCommande : %s",
	...
	"multiplayer.disconnect.duplicate_login": "Vous êtes déja connecté(e) depuis un autre endroit",
	...
	"multiplayer.disconnect.illegal_characters": "Caratères illégaux dans le tchat",
	...
	"multiplayer.disconnect.slow_login": "La connexion a mis trop de temps à s'établir",
	...
	"multiplayer.disconnect.unsigned_chat": "Un paquet de tchat avec une signature manquante ou invalide a été reçu.",
	...
	"multiplayer.requiredTexturePrompt.disconnect": "Ce serveur nécessite un pack de ressources personnalisé",
	"multiplayer.requiredTexturePrompt.line1": "Ce serveur nécessite l'utilisation d'un pack de ressources personnalisé.",
	"multiplayer.requiredTexturePrompt.line2": "Rejeter le pack de ressources personnalisé vous déconnectera de ce serveur.",
	"multiplayer.socialInteractions.not_available": "Les interactions sociales sont uniquement disponibles dans les mondes multijoueurs",
	"multiplayer.status.and_more": "... et %s de plus...",
	"multiplayer.status.anonymous_player": "Joueurs anonyme",
	...
	"multiplayer.texturePrompt.failure.line2": "Toute fonctionnalité nécessitant des ressources personnalisées peut ne pas fonctionner comme prévu.",
	...
	"multiplayerWarning.message": "Attention : le jeu en ligne est proposé par des serveurs tiers qui ne sont ni détenus, ni exploités, ni supervisés par Mojang Studios ou Microsoft. Lors de vos sessions en ligne, vous pouvez être exposé(e) à des messages de discussion non modérés ou à d'autres contenus générés par les utilisateurs qui peuvent ne pas convenir à tous.",
	...
	"narration.suggestion.usage.cycle.fixed": "Appuyez sur Tab pour pour passer à la suggestion suivante",
	...
	"narration.tab_navigation.usage": "Appuyez sur Ctrl et Tab pour changer d'onglet",
	...
	"narrator.button.difficulty_lock.unlocked": "Déverouillé",
	...
	"narrator.select.world_info": "%s sélectionné, ouvert pour la dernière fois le : %s, %s",
	"narrator.toast.disabled": "Narrateur désactivé",
	"narrator.toast.enabled": "Narrateur activé",
	"optimizeWorld.confirm.description": "Cette opération essayera d'optimiser votre monde en s'assurant que toutes les données sont stockées dans le format de jeu le plus récent. Cela peut prendre un long moment en fonction de la taille de votre monde. Une fois l'opération terminée, votre monde devrait fonctionner plus rapidement, mais ne sera plus compatible avec les anciennes versions du jeu. Voulez-vous vraiment continuer ?",
	"optimizeWorld.confirm.proceed": "Faire une sauvegarder et optimiser",
	...
	"optimizeWorld.stage.upgrading.poi": "Mise à jour des tous les points d'intérêt...",
	"optimizeWorld.title": "Optimisation de monde \"%s\"",
	...
	"options.accessibility.high_contrast_block_outline": "Constraste élevé du contour des blocs",
	...
	"options.accessibility.narrator_hotkey.mac.tooltip": "Permet au narrateur d'être activé ou désactivé avec 'Cmd + B'.",
	"options.accessibility.narrator_hotkey.tooltip": "Permet au narrateur d'être activé ou désactivé avec 'Ctrl + B'.",
	...
	"options.allowCursorChanges.tooltip": "Permet au curseur de la souris de changer de forme lorsqu'il survole certains éléments de l'interface utilisateur.",
	"options.allowFriendRequests": "Autoriser les demandes d'amis",
	"options.allowFriendRequests.tooltip": "Autorise les autres joueurs à vous envoyer des demandes d'ami",
	"options.allowServerListing": "Autorise un répertoire sur les serveurs",
	...
	"options.autoSuggestCommands": "Auto-complétion",
	"options.autosaveIndicator": "Indicateur de sauvegarde",
	"options.biomeBlendRadius": "Transition des biomes",
	"options.biomeBlendRadius.1": "Désactivée (plus rapide)",
	...
	"options.chat.drafts": "Sauvegarde des brouillons",
	...
	"options.chunkFade.tooltip": "Durée en secondes, pendant laquelle les chunks doivent apparaître en fondu lors de leur premier rendu.",
	...
	"options.darknessEffectScale.tooltip": "Contrôle la quantité de pulsations de l'effet d'obscurité quand vous la recevez d'un Warden ou d'un hurleur sculk.",
	...
	"options.directionalAudio.on.tooltip": "Utilise l'audio directionnel basé sur le HRTF afin d'améliorer la simulation de la spatialisation sonore. Nécessite un matériel audio compatible HRTF et s'apprécie pleinement avec un casque audio.",
	...
	"options.fullscreen.resolution": "Résolution de plein écran",
	...
	"options.graphics.preset.tooltip": "Règle les paramètres de \"Qualité et performance\" sur des valeurs par défaut adaptées à la qualité désirée.",
	"options.graphics.warning.accept": "Continuer sans assistance",
	"options.graphics.warning.cancel": "Revenir en arrière",
	"options.graphics.warning.message": "Votre périphérique graphique a été détecté comme étant incompatible avec l'option graphique \"%s\".\n\nVous pouvez ignorer cet avertissement et continuer, cependant aucune prise en charge ne sera fournie pour\nvotre périphérique si vous choisissez d'utiliser les graphismes \"%s\".",
	...
	"options.graphicsApi.tooltip": "Définit l'API graphique à utiliser pour le rendu. Laissez sur \"Par défaut\" sauf si vous avez une raison spécifique pour changer cela ! Le changement sera appliqué au prochain démarrage du jeu.",
	...
	"options.graphicsApi.vulkan": "Préférer Vulkan",
	...
	"options.improvedTransparency.tooltip": "Une approche expérimentale utilisant des shaders d'écran pour dessiner la météo, les nuages et les particules derrière les blocs translucides et l'eau.\nCela aura un impact sur les performances de votre carte graphique.",
	...
	"options.mouse_settings": "Souris...",
	"options.mouse_settings.title": "Options de la souris",
	"options.multiplayer.title": "Multijoueur...",
	...
	"options.music_frequency.tooltip": "Change à quelle fréquence la musique est jouée dans un monde.",
	...
	"options.needsRestart": "L'option sera appliquée après le redémarrage.",
	...
	"options.prioritizeChunkUpdates.nearby.tooltip": "Les chunks à proximité sont toujours compilés immédiatement ce qui pourrait affecter les performances du jeu lorsque des blocs sont placés ou détruits.",
	...
	"options.restartRequired": "Certaines modifications nécessitent un redémarrage du jeu pour être appliquées.",
	...
	"options.sharePresence.all": "Oui",
	"options.sharePresence.all.tooltip": "Votre présence est partagée avec vos amis. Vous apparaissez en ligne et ce que vous faites est visible.",
	...
	"options.sharePresence.none": "Non",
	"options.sharePresence.none.tooltip": "Aucune présence n'est partagée. Vous apparaissez hors ligne.",
	"options.showNowPlayingToast": "Notification musicale",
	"options.showNowPlayingToast.tooltip": "Affiche une notification quand une musique commence à jouer. Cette même notification est constamment affichée dans le menu de pause pendant que la musique se joue.",
	...
	"options.telemetry.disabled": "La téléémétrie est désactivée.",
	...
	"options.videoTitle": "Graphismes",
	"options.viewBobbing": "Mouvement de tête",
	"options.vignette": "Vignettage",
	"options.vignette.tooltip": "Il s'agit d'une texture subtile appliquée à l'écran de jeu pour réduire la luminosité vers les bords de la vision et indiquer au joueur qu'il approche de la bordure du monde.",
	"options.visible": "Visible",
	"options.vsync": "Synchro verticale",
	"options.weatherRadius": "Rayon des effets météo",
	"options.weatherRadius.tooltip": "Rayon de la zone où les effets de pluie et de neige sont visibles. Impact très négligeable sur les performances.",
	"options.worldOptions.button": "Options du monde...",
	"options.worldOptions.title": "Options du monde",
	"outOfMemory.message": "Minecraft est à court de mémoire.\n\nCela peut être dû à un bug dans le jeu ou à une allocation insuffisante de mémoire pour la machine virtuelle Java.\n\nPour éviter toute corruption du monde, la partie en cours a été fermé. Nous avons essayé de libérer suffisamment de mémoire pour vous permettre de revenir au menu principal et de reprendre le jeu, mais cela n'a peut-être pas fonctionné.\n\nVeuillez redémarrer le jeu si ce message s'affiche à nouveau.",
	...
	"painting.minecraft.pigscene.title": "Le Portrait du cochon",
	...
	"parsing.bool.invalid": "Booléen invalide : %s (\"true\" ou \"false\" attendu)",
	...
	"parsing.quote.expected.end": "Chaîne entre guillemets non fermée",
	"parsing.quote.expected.start": "Guillemets attendus au début de la chaîne de caractères",
	...
	"resourcePack.vanilla.description": "L'apparence et la convivialité par défaut de Minecraft",
	...
	"selectServer.deleteQuestion": "Vous-vous vraiment supprimer ce serveur ?",
	"selectServer.deleteWarning": "\"%s\" sera perdu pour toujours ! (Une durée non négligeable !)",
	...
	"selectWorld.allowCommands.new": "Autoriser les commandes",
	"selectWorld.backupEraseCache": "Effacer les données mises en cache",
	"selectWorld.backupJoinConfirmButton": "Faire une sauvegarde et ouvrir",
	...
	"selectWorld.backupQuestion.downgrade": "Rétrograder un monde dans une version antérieure n'est pas pris en charge",
	...
	"selectWorld.backupWarning.customized": "Malheureusement, nous ne prenons pas en charge les mondes personnalisés dans cette version de Minecraft. Nous pouvons tout de même charger ce monde et le garder en l'état, mais tout terrain nouvellement généré ne sera plus personnalisé. Nous sommes désolés pour le dérangement !",
	"selectWorld.backupWarning.downgrade": "Ce monde a été ouvert pour la dernière fois en version %s; vous êtes en version %s. Rétrograder un monde vers une version antérieure pourrait entraîner sa corruption et nous ne pouvons pas garantir qu'il se chargera ou fonctionnera. Si vous voulez quand même continuer, faites une sauvegarde.",
	"selectWorld.backupWarning.experimental": "Ce monde utilise des paramètres expérimentaux qui pourraient arrêter de fonctionner à tout moment. Nous ne pouvons pas garantir que celui-ci se chargera ou fonctionnera. À vos risques et périls !",
	"selectWorld.backupWarning.file_fixing_required": "Ce monde doit être mis à niveau avant que vous puissiez y jouer. Nous vous recommandons vivement de créer une sauvegarde avant de continuer au cas où vous rencontreriez une corruption de votre monde.",
	...
	"selectWorld.deleteWarning": "\"%s\" sera perdu pour toujours ! (Une durée non négligeable !)",
	...
	"selectWorld.experimental.details.entry": "Nécéssite les fonctionnalités expérimentales : %s",
	"selectWorld.experimental.details.title": "Exigences des fonctionnalités expérimentales",
	"selectWorld.experimental.message": "Soyez prudent !\nCette configuration nécessite des fonctionnalités encore en cours de développement. Votre monde pourrait planter, être corrompu ou ne plus fonctionner avec de futures mises à jour.",
	...
	"selectWorld.experiments.info": "Les expérimentations sont des possibles nouvelles fonctionnalités. Faites attention, car certaines choses peuvent ne plus fonctionner. Les expérimentations ne peuvent plus être désactivées après la création du monde.",
	"selectWorld.futureworld.error.text": "Une erreur s'est produite lors du chargement du monde depuis une version future. Il s'agissait d'une opération risquée, désolé que ça n'ait pas fonctionné.",
	...
	"selectWorld.gameMode.adventure.line2": "être placés our retirés",
	...
	"selectWorld.gameMode.survival.info": "Explorez un monde mystérieux dans lequel vous pouvez construire, collecter, fabriquer et combattre des monstres.",
	"selectWorld.gameMode.survival.line1": "Collectez des ressources, fabriquez,",
	"selectWorld.gameMode.survival.line2": "gagnez des niveaux et restez en vie",
	...
	"selectWorld.recreate.customized.text": "Les mondes personnalisés ne sont plus supportés dans cette version de Minecraft. Nous pouvons essayer de le recréer avec la même graine et les mêmes propriétés, mais toute personnalisation du terrain sera perdue. Nous sommes désolés pour le dérangement !",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Ce monde doit être mis à niveau vers la dernière version avant que vous puissiez le modifier en raison de changements structurels apportés au format du monde.",
	"selectWorld.requiresFileFixingTooltip.play": "Ce monde doit être mis à niveau vers la dernière version avant que vous puissiez y jouer en raison de changements structurels apportés au format du monde.",
	...
	"selectWorld.tooltip.snapshot1": "N'oubliez pas de faire une sauvegarde de ce monde",
	...
	"selectWorld.warning.deprecated.question": "Certaines fonctionnalités utilisées sont obsolètes et ne fonctionneront plus à l'avenir. Voulez-vous continuer ?",
	...
	"selecteWorld.backupRequiredTooltip": "Le chargement du monde nécessite d'effectuer une sauvegarde au préalable",
	"sign.edit": "Texte de la pancarte :",
	"sleep.not_possible": "Aucun repos ne saurait passer cette nuit",
	...
	"snbt.parser.expected_float_type": "Nombre à virgule flottant attendu",
	...
	"snbt.parser.invalid_string_contents": "Contenu de la chaîne invalide",
	"snbt.parser.invalid_unquoted_start": "Les chaînes de caractères sans guillemets ne peuvent pas commencer par les chiffres de 0 à 9, ou un signe + ou -",
	...
	"stat.minecraft.drop": "Objets lâchés",
	...
	"stat.minecraft.play_record": "Disque de musique joués",
	"stat.minecraft.play_time": "Temps de jeu",
	"stat.minecraft.player_kills": "Joueur(s) tué(s)",
	"stat.minecraft.pot_flower": "Plantes mises dans un pot",
	"stat.minecraft.raid_trigger": "Invasions déclenchées",
	"stat.minecraft.raid_win": "Invasions gagnées",
	"stat.minecraft.sleep_in_bed": "Nombre de fois passées dans un lit",
	...
	"stat.minecraft.time_since_rest": "Temps passé depuis le dernier repos",
	...
	"stat.minecraft.trigger_trapped_chest": "Coffres piégés activés",
	...
	"stat_type.minecraft.dropped": "Quantité lâchée",
	"stat_type.minecraft.killed": "Vous en avez tué %s",
	"stat_type.minecraft.killed.none": "Vous n'en avez jamais tué",
	"stat_type.minecraft.killed_by": "Cette créature vous a déjà tué %s fois",
	"stat_type.minecraft.killed_by.none": "Vous n'avez jamais été tué(e) par un(e) %s",
	"stat_type.minecraft.mined": "Quantité minée",
	"stat_type.minecraft.picked_up": "Quantité ramassée",
	"stat_type.minecraft.used": "Nomnre d'utilisations",
	"stats.none": "-",
	...
	"structure_block.integrity": "Intégrité et graine de la structure",
	...
	"structure_block.load_prepare": "Position de la structure '%s' préparée",
	...
	"subtitles.block.anvil.destroy": "Enclume détruite",
	"subtitles.block.anvil.land": "Enclume qui s'écrase",
	...
	"subtitles.block.beacon.activate": "Activation de la balise",
	"subtitles.block.beacon.ambient": "Vrombissement de balise",
	"subtitles.block.beacon.deactivate": "Désactivation de la balise",
	"subtitles.block.beacon.power_select": "Pouvoir de balise sélectionné",
	"subtitles.block.beehive.drip": "Miel qui coule",
	...
	"subtitles.block.big_dripleaf.tilt_down": "Feuille goutte qui fléchit",
	"subtitles.block.big_dripleaf.tilt_up": "Feuille goutte qui se redresse",
	...
	"subtitles.block.button.click": "Bouton activé",
	...
	"subtitles.block.conduit.ambient": "Conduit qui pulse",
	"subtitles.block.conduit.attack.target": "Conduit qui attaque",
	...
	"subtitles.block.decorated_pot.insert_fail": "Vase décoré qui tremble",
	"subtitles.block.decorated_pot.shatter": "Vase décoré qui se casse",
	...
	"subtitles.block.fence_gate.toggle": "Porte de clôture qui claque",
	"subtitles.block.fire.ambient": "Feu qui crépite",
	"subtitles.block.fire.extinguish": "Feu qui s'éteint",
	...
	"subtitles.block.generic.fall": "Quelque chose qui tombe sur un bloc",
	...
	"subtitles.block.honey_block.slide": "Glissade contre un bloc de miel",
	...
	"subtitles.block.pale_hanging_moss.idle": "Bruit étrange",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Jaillissements de source de soufre",
	"subtitles.block.potent_sulfur.noxious_gas": "Gaz toxique qui apparaît",
	...
	"subtitles.block.respawn_anchor.charge": "Ancre de réapparition qui se charge",
	"subtitles.block.respawn_anchor.deplete": "Ancre de réapparition qui s'épuise",
	"subtitles.block.respawn_anchor.set_spawn": "Ancre de réapparition qui s'active",
	...
	"subtitles.block.sculk_shrieker.shriek": "Hurleur sculk qui hurle",
	...
	"subtitles.block.trial_spawner.charge_activate": "Présage qui engloutit un générateur des épreuves",
	...
	"subtitles.block.trial_spawner.eject_item": "Générateur des épreuves qui éjecte un objet",
	"subtitles.block.trial_spawner.ominous_activate": "Présage qui engloutit un générateur des épreuves",
	...
	"subtitles.block.trial_spawner.spawn_mob": "Générateur des épreuves qui génère une créature",
	...
	"subtitles.block.vault.reject_rewarded_player": "Coffre-fort qui rejette le joueur",
	...
	"subtitles.entity.allay.ambient_without_item": "Allay qui se languit",
	...
	"subtitles.entity.armadillo.land": "Tatou qui atterit",
	"subtitles.entity.armadillo.peek": "Tatou qui surveille",
	...
	"subtitles.entity.baby_cat.hiss": "Feulement de chaton",
	...
	"subtitles.entity.baby_horse.breathe": "Soufflement de poulain",
	...
	"subtitles.entity.bat.ambient": "Sifflement de chauve-souris",
	...
	"subtitles.entity.bee.loop_aggressive": "Bourdonnement joyeux d'abeille",
	...
	"subtitles.entity.boat.paddle_land": "Ramage",
	"subtitles.entity.boat.paddle_water": "Ramage",
	...
	"subtitles.entity.breeze.charge": "Brise qui charge",
	"subtitles.entity.breeze.death": "Brise qui meurt",
	"subtitles.entity.breeze.deflect": "Brise qui dévie",
	"subtitles.entity.breeze.hurt": "Brise blessé",
	"subtitles.entity.breeze.idle_air": "Brise qui vole",
	"subtitles.entity.breeze.idle_ground": "Vrombissement de Brise",
	"subtitles.entity.breeze.inhale": "Brise qui aspire",
	"subtitles.entity.breeze.jump": "Brise qui saute",
	"subtitles.entity.breeze.land": "Brise qui atterrit",
	"subtitles.entity.breeze.shoot": "Brise qui tire",
	"subtitles.entity.breeze.slide": "Brise qui glisse",
	"subtitles.entity.breeze.whirl": "Brise qui tourbillonne",
	...
	"subtitles.entity.cat.purr": "Chat qui ronronne",
	...
	"subtitles.entity.copper_golem.item_no_drop": "Golem de cuivre qui n'arrive pas à déposer un objet",
	"subtitles.entity.copper_golem.no_item_get": "Golem de cuivre qui récupère un objet",
	"subtitles.entity.copper_golem.no_item_no_get": "Golem de cuivre qui ne trouve pas d'objet à récuperer",
	"subtitles.entity.copper_golem.spawn": "Golem de cuivre qui apparaît",
	"subtitles.entity.copper_golem.spin": "Golem de cuivre qui tournoie sa tête",
	...
	"subtitles.entity.copper_golem_oxidized.spin": "Golem de cuivre qui tournoie sa tête",
	...
	"subtitles.entity.copper_golem_weathered.spin": "Golem de cuivre qui tournoie sa tête",
	"subtitles.entity.cow.ambient": "Vache qui meugle",
	"subtitles.entity.cow.death": "Vache qui meurt",
	"subtitles.entity.cow.hurt": "Vache blessée",
	"subtitles.entity.cow.milk": "Vache se faisant traiter",
	...
	"subtitles.entity.creaking.sway": "Grinceur qui se fait attaquer",
	...
	"subtitles.entity.creeper.primed": "Creeper qui siffle",
	"subtitles.entity.dolphin.ambient": "Dauphin qui grince",
	...
	"subtitles.entity.donkey.angry": "Âne qui brait",
	"subtitles.entity.donkey.chest": "Équipement d'un coffre sur un âne",
	...
	"subtitles.entity.enderman.scream": "Enderman qui crie",
	...
	"subtitles.entity.evoker.ambient": "Évocateur qui murmure",
	...
	"subtitles.entity.experience_orb.pickup": "Exprérience obtenue",
	"subtitles.entity.firework_rocket.blast": "Feu d'artifice qui explose",
	...
	"subtitles.entity.fishing_bobber.throw": "Canne à pêche lancée",
	"subtitles.entity.fox.aggro": "Renard enragé",
	"subtitles.entity.fox.ambient": "Glapissement de renard",
	"subtitles.entity.fox.bite": "Renard qui mort",
	...
	"subtitles.entity.ghastling.ambient": "Ghastelin qui gazouille",
	...
	"subtitles.entity.glow_item_frame.add_item": "Cadre luminescent rempli",
	"subtitles.entity.glow_item_frame.break": "Cadre luminescent détruit",
	"subtitles.entity.glow_item_frame.place": "Cadre luminescent placé",
	"subtitles.entity.glow_item_frame.remove_item": "Objet retiré d'un cadre luminescent",
	"subtitles.entity.glow_item_frame.rotate_item": "Objet encadré qui pivote",
	"subtitles.entity.glow_squid.ambient": "Poulpe luminescent qui nage",
	"subtitles.entity.glow_squid.death": "Poulpe luminescent qui meurt",
	"subtitles.entity.glow_squid.hurt": "Poulpe luminescent blessé",
	"subtitles.entity.glow_squid.squirt": "Poulpe luminescent qui crache de l'encre",
	...
	"subtitles.entity.happy_ghast.ambient": "Fredonnement de Ghast heureux",
	"subtitles.entity.happy_ghast.death": "Ghast heureux qui meurt",
	"subtitles.entity.happy_ghast.equip": "Harnais équipé",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Ghast heureux qui est prêt",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Ghast heureux qui s'arrête",
	"subtitles.entity.happy_ghast.hurt": "Ghast heureux blessé",
	"subtitles.entity.happy_ghast.unequip": "Harnais retiré",
	"subtitles.entity.hoglin.ambient": "Hoglin qui grogne",
	"subtitles.entity.hoglin.angry": "Hoglin qui grogne furieusement",
	"subtitles.entity.hoglin.attack": "Hoglin qui attaque",
	"subtitles.entity.hoglin.converted_to_zombified": "Hoglin qui se convertit en Zoglin",
	...
	"subtitles.entity.illusioner.mirror_move": "Illusionniste qui se clone",
	...
	"subtitles.entity.item_frame.add_item": "Objet encadré",
	...
	"subtitles.entity.item_frame.rotate_item": "Objet éncadré qui pivote",
	...
	"subtitles.entity.lightning_bolt.thunder": "Grondement du tonnerre",
	"subtitles.entity.llama.ambient": "Bêlement de lama",
	"subtitles.entity.llama.angry": "Bêlement furieux de lama",
	"subtitles.entity.llama.chest": "Coffre équipé sur une lama",
	...
	"subtitles.entity.minecart.inside": "Minecart qui tangue",
	"subtitles.entity.minecart.inside_underwater": "Minecart immergé qui tangue",
	...
	"subtitles.entity.painting.break": "Tableau décroché",
	...
	"subtitles.entity.parched.ambient": "Craquement de déserteur",
	"subtitles.entity.parched.death": "Déserteur qui meurt",
	"subtitles.entity.parched.hurt": "Déserteur blessé",
	...
	"subtitles.entity.parrot.imitate.blaze": "Perroquet qui imite un Blaze",
	"subtitles.entity.parrot.imitate.bogged": "Perroquet qui imite un embourbé",
	"subtitles.entity.parrot.imitate.breeze": "Perroquet qui imite un Brise",
	"subtitles.entity.parrot.imitate.camel_husk": "Perroquet qui imite un dromadaire momifié",
	"subtitles.entity.parrot.imitate.creaking": "Perroquet qui imite un grinceur",
	"subtitles.entity.parrot.imitate.creeper": "Perroquet qui imite un Creeper",
	"subtitles.entity.parrot.imitate.drowned": "Perroquet qui imite un noyé",
	"subtitles.entity.parrot.imitate.elder_guardian": "Perroquet qui imite un gardien",
	"subtitles.entity.parrot.imitate.ender_dragon": "Perroquet qui imite l'Ender Dragon",
	"subtitles.entity.parrot.imitate.endermite": "Perroquet qui imite un Endermite",
	"subtitles.entity.parrot.imitate.evoker": "Perroquet qui imite un évocateur",
	"subtitles.entity.parrot.imitate.ghast": "Perroquet qui imite un Ghast",
	"subtitles.entity.parrot.imitate.guardian": "Perroquet qui imite un gardien",
	"subtitles.entity.parrot.imitate.hoglin": "Perroquet qui imite un Hoglin",
	"subtitles.entity.parrot.imitate.husk": "Perroquet qui imite un momifié",
	"subtitles.entity.parrot.imitate.illusioner": "Perroquet qui imite un illusionniste",
	"subtitles.entity.parrot.imitate.magma_cube": "Perroquet qui imite un cube de magma",
	"subtitles.entity.parrot.imitate.parched": "Perroquet qui imite un déserteur",
	"subtitles.entity.parrot.imitate.phantom": "Perroquet qui imite un Spectre",
	"subtitles.entity.parrot.imitate.piglin": "Perroquet qui imite un Piglin",
	"subtitles.entity.parrot.imitate.piglin_brute": "Perroquet qui imite un Piglin brute",
	"subtitles.entity.parrot.imitate.pillager": "Perroquet qui imite un pillard",
	"subtitles.entity.parrot.imitate.ravager": "Perroquet qui imite un ravageur",
	"subtitles.entity.parrot.imitate.shulker": "Perroquet qui imite un Shulker",
	"subtitles.entity.parrot.imitate.silverfish": "Perroquet qui imite un poisson d'argent",
	"subtitles.entity.parrot.imitate.skeleton": "Perroquet qui imite un squelette",
	"subtitles.entity.parrot.imitate.slime": "Perroquet qui imite un Slime",
	"subtitles.entity.parrot.imitate.spider": "Perroquet qui imite une araignée",
	"subtitles.entity.parrot.imitate.stray": "Perroquet qui imite un vagabond",
	"subtitles.entity.parrot.imitate.vex": "Perroquet qui imite un Vex",
	"subtitles.entity.parrot.imitate.vindicator": "Perroquet qui imite un vindicateur",
	"subtitles.entity.parrot.imitate.warden": "Perroquet qui imite un Warden",
	"subtitles.entity.parrot.imitate.witch": "Perroquet qui imite une sorcière",
	"subtitles.entity.parrot.imitate.wither": "Perroquet qui imite un Wither",
	"subtitles.entity.parrot.imitate.wither_skeleton": "Perroquet qui imite un Wither squelette",
	"subtitles.entity.parrot.imitate.zoglin": "Perroquet qui imite un Zoglin",
	"subtitles.entity.parrot.imitate.zombie": "Perroquet qui imite un zombie",
	"subtitles.entity.parrot.imitate.zombie_horse": "Perroquet qui imite un cheval-zombie",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Perroquet qui imite un nautile-zombie",
	"subtitles.entity.parrot.imitate.zombie_villager": "Perroquet qui imite un zombie-villageois",
	"subtitles.entity.phantom.ambient": "Hurlement de Spectre",
	"subtitles.entity.phantom.bite": "Spectre qui mord",
	"subtitles.entity.phantom.death": "Spectre qui meurt",
	"subtitles.entity.phantom.flap": "Spectre qui bat des ailes",
	"subtitles.entity.phantom.hurt": "Spectre blessé",
	"subtitles.entity.phantom.swoop": "Spectre qui charge",
	"subtitles.entity.pig.ambient": "Cochon qui grouine",
	...
	"subtitles.entity.piglin.ambient": "Groinement de Piglin",
	"subtitles.entity.piglin.angry": "Groinement furieux de Piglin",
	...
	"subtitles.entity.piglin_brute.ambient": "Grouinement de Piglin enragé",
	"subtitles.entity.piglin_brute.angry": "Grouinement furieux de Piglin enragé",
	"subtitles.entity.piglin_brute.converted_to_zombified": "Piglin enragé converti en Piglin zombifié",
	"subtitles.entity.piglin_brute.death": "Piglin enragé qui meurt",
	"subtitles.entity.piglin_brute.hurt": "Piglin barbare blessé",
	"subtitles.entity.piglin_brute.step": "Piglin enragé qui marche",
	...
	"subtitles.entity.player.attack.sweep": "Attaque de balayage",
	...
	"subtitles.entity.potion.splash": "Fiole qui se brise",
	...
	"subtitles.entity.puffer_fish.flop": "Fugu qui sautiille",
	"subtitles.entity.puffer_fish.hurt": "Fugu blessé",
	"subtitles.entity.puffer_fish.sting": "Fugu qui pique",
	"subtitles.entity.rabbit.ambient": "Gémissement de lapin",
	...
	"subtitles.entity.sniffer.egg_hatch": "Œuf de renifleur qui se éclot",
	...
	"subtitles.entity.snow_golem.death": "Bonhomme de neige qui meurt",
	"subtitles.entity.snow_golem.hurt": "Bonhomme de neige blessé",
	...
	"subtitles.entity.squid.squirt": "Poulpe qui crache de l'encre",
	...
	"subtitles.entity.strider.idle": "Gazouillement d'arpenteur",
	"subtitles.entity.strider.retreat": "Arpenteur qui fuit",
	"subtitles.entity.sulfur_cube.absorb": "Cube de soufre qui avale",
	...
	"subtitles.entity.turtle.shamble": "Tortue qui rampe",
	"subtitles.entity.turtle.shamble_baby": "Bébé tortue qui rampe",
	...
	"subtitles.entity.villager.work_weaponsmith": "Forgeron qui travaille",
	"subtitles.entity.villager.yes": "Villageois qui accepete",
	...
	"subtitles.entity.warden.roar": "Warden qui rugit",
	"subtitles.entity.warden.sniff": "Warden qui renifle",
	"subtitles.entity.warden.sonic_boom": "Onde supersonique de Warden",
	...
	"subtitles.entity.witch.ambient": "Sorcière qui ricane",
	...
	"subtitles.entity.witch.throw": "Sorcière qui lance une potion",
	...
	"subtitles.entity.wolf.growl": "Loup qui grogne",
	...
	"subtitles.entity.zoglin.ambient": "Zoglin qui grogne",
	"subtitles.entity.zoglin.angry": "Zoglin qui grogne furieusement",
	...
	"subtitles.entity.zombie_horse.ambient": "Cheval-zombie qui crie",
	...
	"subtitles.event.mob_effect.raid_omen": "Une invasion se profile dans les environs",
	"subtitles.event.mob_effect.trial_omen": "Une épreuve funeste se profile dans les environs",
	"subtitles.event.raid.horn": "Retentissement de cor funeste",
	"subtitles.item.armor.equip": "Armure équipée",
	"subtitles.item.armor.equip_chain": "Équipement d'armure en mailles",
	"subtitles.item.armor.equip_copper": "Équipement d'armure en cuivre",
	"subtitles.item.armor.equip_diamond": "Équipement d'armure en diamant",
	"subtitles.item.armor.equip_elytra": "Équipement d'élytres",
	"subtitles.item.armor.equip_gold": "Équipement d'une armure en or",
	"subtitles.item.armor.equip_iron": "Équipement d'une armure en fer",
	"subtitles.item.armor.equip_leather": "Équipement d'une armure en cuir",
	"subtitles.item.armor.equip_nautilus": "Armure pour nautile équipée",
	"subtitles.item.armor.equip_netherite": "Équipement d'une armure en Netherite",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Cube de soufre récupréré",
	...
	"subtitles.item.golden_dandelion.unuse": "Pissenlit doré qui ne fait plus effet",
	"subtitles.item.golden_dandelion.use": "Pissenlit doré consommé",
	...
	"subtitles.item.trident.hit": "Coup de trident",
	"subtitles.item.trident.hit_ground": "Vibration de trident",
	"subtitles.item.trident.return": "Trident qui revient",
	"subtitles.item.trident.riptide": "Propulsion de trident",
	...
	"symlink_warning.message": "Charger des mondes provenant de dossiers contenant des liens symboliques peut être risqué si vous ne savez pas ce que vous faites. Veuillez visiter %s pour en apprendre davantage.",
	"symlink_warning.message.pack": "Charger des packs contenant des liens symboliques peut être risqué si vous ne savez pas ce que vous faites. Veuillez visiter %s pour en apprendre davantage.",
	"symlink_warning.message.world": "Charger des mondes provenant de dossiers contenant des liens symboliques peut être risqué si vous ne savez pas ce que vous faites. Veuillez visiter %s pour en apprendre davantage.",
	"symlink_warning.more_info": "Plus d'informations",
	"symlink_warning.title": "Dossier du monde contenant des liens symboliques",
	...
	"telemetry.event.game_load_times.description": "Cet évènement peut nous aider à déterminer où des améliorations de performances au démarrage sont nécessaires en mesurant le temps d'exécution des phases de démarrage.",
	"telemetry.event.game_load_times.title": "Temps de chargement du jeu",
	"telemetry.event.graphics_capabilities.description": "Cet évènement nous informe des capacités du matériel graphique utilisé pour jouer au jeu.",
	...
	"telemetry.event.world_loaded.description": "En apprendre davantage sur la manière dont les joueurs jouent à Minecraft (comme le mode de jeu, si le client ou le serveur est moddé, sous quelle version) nous permet de nous concentrer sur les aspects qui ont le plus d'importance pour les joueurs.\nL'événement \"Monde chargé\" est associé à l'événement \"Monde déchargé\" pour calculer la durée de la session de jeu.",
	"telemetry.event.world_loaded.title": "Monde chargé",
	"telemetry.event.world_unloaded.description": "Cet événement est associé à l'événement \"Monde chargé\" pour calculer la durée de la session de jeu.\nLa durée (en secondes et en ticks) est mesurée lorsqu'une session de jeu se termine (en retournant au menu principal ou en se déconnectant d'un serveur).",
	...
	"telemetry.property.backend_failure_message.title": "Message d'échec de la création de l'API graphique",
	"telemetry.property.backend_failure_missing_capabilities.title": "Capacités manquantes lors de l'échec de la création de l'API graphique",
	...
	"telemetry.property.event_timestamp_utc.title": "Horodatage de l'évènement (UTC)",
	...
	"telemetry.property.load_time_loading_overlay_ms.title": "Temps passé devant l'écran de chargement (en millisecondes)",
	...
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Type de candidat restant",
	...
	"telemetry_info.screen.description": "La collecte de ces données nous aide à améliorer Minecraft en nous guidant dans des directions pertinentes pour nos joueurs.\nVous pouvez également nous donner votre avis pour nous aider à continuer d'améliorer Minecraft.",
	...
	"test.error.entity_property": "L'entité %s a échoué au test : %s",
	"test.error.entity_property_details": "L'entité %s a échoué au test : %s. Attendu(e) %s : était %s",
	...
	"test.error.expected_container_contents": "Le conteneur devrait contenir l'objet : %s",
	"test.error.expected_container_contents_single": "Le conteneur devrait contenir un seul objet : %s",
	...
	"test.error.expected_entity_data_predicate": "Les données de l'entité %s ne correspondent pas",
	...
	"test.error.position": "%s en %s, %s, %s (relatif : %s, %s, %s) au tick %s",
	...
	"test.error.timeout.no_result": "Aucune réussite ou échec durant les %s ticks",
	"test.error.timeout.no_sequences_finished": "Aucune séquence ne s'est terminée durant les %s ticks",
	"test.error.too_many_entities": "Une seule entité %s attendue autour de %s, %s, %s mais %s ont été trouvés",
	...
	"test_block.invalid_timeout": "Délai d'expiration invalide (%s) - doit être un nombre positif de ticks",
	...
	"test_block.mode_info.fail": "Mode Échec - Échouer le test",
	...
	"test_instance_block.error.unable_to_save": "Impossible d'enregistrer le modèle de structure de test pour l'instance en %s, %s, %s",
	...
	"title.32bit.deprecation": "Système 32 bits détecté : cela pourra vous empêcher de jouer à l'avenir car un système 64 bits sera requis !",
	...
	"title.multiplayer.disabled.banned.permanent": "Votre compte est définitivement suspendu du jeu en ligne",
	...
	"translation.test.none": "Bonjour, le monde !",
	...
	"trim_pattern.minecraft.bolt": "Décoration d'armure des boulons",
	"trim_pattern.minecraft.coast": "Décoration d'armure des littoraux",
	"trim_pattern.minecraft.dune": "Décoration d'armure des dunes",
	"trim_pattern.minecraft.eye": "Décoration d'armure de l'oeil",
	"trim_pattern.minecraft.flow": "Décoration d'armure des tourbillons",
	"trim_pattern.minecraft.host": "Décoration d'armure des hôtes",
	"trim_pattern.minecraft.raiser": "Décoration d'armure des éleveurs",
	"trim_pattern.minecraft.rib": "Ornement d'armure des côtes",
	"trim_pattern.minecraft.sentry": "Décoration d'armure des sentinelles",
	"trim_pattern.minecraft.shaper": "Décoration d'armure des façonneurs",
	...
	"trim_pattern.minecraft.ward": "Ornement d'armure des abîmes",
	"trim_pattern.minecraft.wayfinder": "Ornement d'armure des éclaireurs",
	"trim_pattern.minecraft.wild": "Décoration d'armure sauvage",
	"tutorial.bundleInsert.description": "Faites un clic droit",
	"tutorial.bundleInsert.title": "Remplissez un sac",
	"tutorial.craft_planks.description": "Ouvrir le livre de recettes",
	"tutorial.craft_planks.title": "Fabriquez des planches",
	"tutorial.find_tree.description": "Frappez-le pour récolter du bois",
	...
	"tutorial.open_inventory.title": "Ouvez votre inventaire",
	...
	"upgradeWorld.symlink.message": "Le monde sélectionné contient des liens symboliques.\nLes étapes requises pour mettre à niveau le monde vers la version actuelle ne prennent pas en charge l'utilisation de liens symboliques. Pour mettre à niveau le monde, les liens doivent d'abord être résolus.",
