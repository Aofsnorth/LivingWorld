// Code generated by tools/gen_lang.go from 26.1/fy_nl.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Tagonklikheidsynstellingen…",
	"accessibility.onboarding.accessibility.button.narration": "Accessibility Settings",
	"accessibility.onboarding.screen.narrator": "Druk op enter om de ferteller yn te skeakeljen",
	"accessibility.onboarding.screen.title": "Wolkom in Minecraft!\n\nWolsto de ferteller ynskeakelje of de tagonklikheidsopsjes besykje?",
	"addServer.add": "Klear",
	...
	"advancements.adventure.blowback.title": "Swiere tsjinslach",
	"advancements.adventure.brush_armadillo.description": "Brûk in boarstel om in hoarnplaat fan in goardelbist te krijen",
	"advancements.adventure.brush_armadillo.title": "Wat in plaatsje",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Meitsje in dekorearre pot fan fjouwer ierdewurk diggels",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Mei soarch restaurearre",
	"advancements.adventure.crafters_crafting_crafters.description": "Stean yn de buert fan in ferfeardigingsmasine dy’t in ferfeardigingsmasine ferfeardiget",
	"advancements.adventure.crafters_crafting_crafters.title": "Autoproduksje",
	...
	"advancements.adventure.heart_transplanter.title": "Herttransplantearder",
	...
	"advancements.adventure.lighten_up.description": "Ferhelderje in koperen lampe troch de oksidaasje der ôf te skrabjen mei in bile",
	"advancements.adventure.lighten_up.title": "In ljochter foarútsjoch",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Betrêdzje in beproevingskeamer",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Proefedysje",
	"advancements.adventure.ol_betsy.description": "Sjit mei in krúsbôge",
	"advancements.adventure.ol_betsy.title": "Arbalest",
	"advancements.adventure.overoverkill.description": "Bring fyftich hertsjes skea ta yn ien knotsslach",
	"advancements.adventure.overoverkill.title": "Fiersten tefolle fan it goede",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Lês de streamsterkte fan in bewurke boekekast ôf mei in fergeliker",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Sterke ferhalen",
	"advancements.adventure.revaulting.description": "Helje in ûnheimige klûs fan it slot mei in ûnheimige beproevingskaai",
	"advancements.adventure.revaulting.title": "De ferskrikking oerwûn",
	"advancements.adventure.root.description": "Aventoer, ûntdekking en gefjocht",
	"advancements.adventure.root.title": "Aventoer",
	"advancements.adventure.salvage_sherd.description": "Boarstel in fertocht blok om in ierdewurk diggel te krijen",
	"advancements.adventure.salvage_sherd.title": "Archeologysk ûndersyk",
	...
	"advancements.adventure.spear_many_mobs.title": "Meunsterkebab",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Brûk de folgjende smeisjabloanen op syn minst ien kear: ergernis, it tij, hoeder, paadfiner, pyk, ribbe, snoet en stilte",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Smeie mei styl",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Meitsje in fersierd stik harnas yn in smeitafel",
	"advancements.adventure.trim_with_any_armor_pattern.title": "It meitsjen fan in nij uterlik",
	...
	"advancements.adventure.under_lock_and_key.description": "Iepenje in klûs mei in beproevingskaai",
	"advancements.adventure.under_lock_and_key.title": "Efter slot en skoattel",
	"advancements.adventure.use_lodestone.description": "Brük en magneetstiinj ma e kumpas",
	"advancements.adventure.use_lodestone.title": "Op eigen kompas sile",
	...
	"advancements.adventure.who_needs_rockets.description": "Brûk in wynpûst om dysels 8 blokken te lansearjen",
	"advancements.adventure.who_needs_rockets.title": "Wa hat dochs raketten nedich?",
	...
	"advancements.husbandry.feed_snifflet.description": "Fier in sneupertsje",
	"advancements.husbandry.feed_snifflet.title": "Sneupertsjes",
	...
	"advancements.husbandry.obtain_sniffer_egg.description": "Krij in sneupersaai",
	"advancements.husbandry.obtain_sniffer_egg.title": "Ynteressante lucht",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Pleats in útdrûge Ghastblok yn wetter",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Pappe en wiethâlde!",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Plant in sneuperssied",
	"advancements.husbandry.plant_any_sniffer_seed.title": "Telen fan it ferline",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Fuortsmite wolf pânser út in wolf mei help fan skeare",
	"advancements.husbandry.remove_wolf_armor.title": "Knibbel, knabbel, knuisje",
	"advancements.husbandry.repair_wolf_armor.description": "Fully repair damaged Wolf Armor using Armadillo Scutes",
	"advancements.husbandry.repair_wolf_armor.title": "Sa goed as nij",
	...
	"advancements.husbandry.whole_pack.title": "De keppel kompleet",
	...
	"argument.entity.selector.nearestEntity": "Meast tichteby entiteit",
	...
	"argument.gamemode.invalid": "Unbekende spielmodus: %s",
	"argument.hexcolor.invalid": "Unjildige heksadesimale kleurekoade ‘%s’",
	...
	"argument.message.too_long": "Chatberjocht wie te lang (%s tekens, mear as de limyt fan %s)",
	"argument.nbt.array.invalid": "Rigeltype ‘%s’ is ûnjildich",
	"argument.nbt.array.mixed": "‘%s’ kin net oan ‘%s’ tafoege wurde",
	"argument.nbt.expected.compound": "Ferwachte gearstalde eigenskip",
	...
	"argument.resource_or_id.failed_to_parse": "Konstruksje ferwurkjen mislearre: %s",
	"argument.resource_or_id.invalid": "Unjildich ID of ûnjildige eigenskip",
	...
	"argument.style.invalid": "Unjildige styl: %s",
	"argument.time.invalid_tick_count": "Tickoantal moat net-negatyf wêze",
	"argument.time.invalid_unit": "Unjildige ienheid",
	"argument.time.tick_count_too_low": "Oantal ticks mei net leger wêze as %s, %s fûn",
	...
	"arguments.item.malformed": "Misfoarme item: '%s'",
	...
	"attribute.name.armor": "Wapenrêsting",
	"attribute.name.armor_toughness": "Wapenrêstingrobústens",
	"attribute.name.attack_damage": "Oanfalsskea",
	"attribute.name.attack_knockback": "Oanfalsweromslach",
	"attribute.name.attack_speed": "Oanfalsfaasje",
	"attribute.name.below_name_distance": "Name Tag Score Distance",
	"attribute.name.block_break_speed": "Blokbreksnelheid",
	"attribute.name.block_interaction_range": "Blokynteraksjeberik",
	"attribute.name.bounciness": "Bounciness",
	"attribute.name.burning_time": "Brântiid",
	"attribute.name.camera_distance": "Kameraôfstân",
	"attribute.name.entity_interaction_range": "Entiteitynteraksjeberik",
	"attribute.name.explosion_knockback_resistance": "Eksploazjeweromslachwjerstân",
	"attribute.name.fall_damage_multiplier": "Falskeafermenigfuldiger",
	"attribute.name.flying_speed": "Fleansnelheid",
	"attribute.name.follow_range": "Mob-folchberik",
	...
	"attribute.name.generic.block_interaction_range": "Blokynteraksjeberik",
	"attribute.name.generic.burning_time": "Brântiid",
	"attribute.name.generic.entity_interaction_range": "Entiteitynteraksjeberik",
	"attribute.name.generic.explosion_knockback_resistance": "Eksploazjeweromslachwjerstân",
	"attribute.name.generic.fall_damage_multiplier": "Falskeafermenigfuldiger",
	"attribute.name.generic.flying_speed": "Fleansnelheid",
	"attribute.name.generic.follow_range": "Mob-folchberik",
	"attribute.name.generic.gravity": "Swiertekrêft",
	"attribute.name.generic.jump_strength": "Ljepkrêft",
	"attribute.name.generic.knockback_resistance": "Tebekslachbeskerming",
	"attribute.name.generic.luck": "Gelok",
	"attribute.name.generic.max_absorption": "Maksimum absorpsje",
	"attribute.name.generic.max_health": "Maksimale sûnens",
	"attribute.name.generic.movement_efficiency": "Bewegingseffisjinsje",
	"attribute.name.generic.movement_speed": "Snelheid",
	"attribute.name.generic.oxygen_bonus": "Soerstofbonus",
	"attribute.name.generic.safe_fall_distance": "Feilige falôfstân",
	"attribute.name.generic.scale": "Skaal",
	"attribute.name.generic.step_height": "Staphichte",
	"attribute.name.generic.water_movement_efficiency": "Wetterbewegingseffisjinsje",
	"attribute.name.gravity": "Swiertekrêft",
	"attribute.name.horse.jump_strength": "Sterkte hynstesprong",
	"attribute.name.jump_strength": "Ljepkrêft",
	"attribute.name.knockback_resistance": "Weromslachbeskerming",
	"attribute.name.luck": "Lok",
	"attribute.name.max_absorption": "Maksimum absorpsje",
	"attribute.name.max_health": "Maksimale sûnens",
	"attribute.name.mining_efficiency": "Myneffisjinsjie",
	"attribute.name.movement_efficiency": "Bewegingseffisjinsje",
	"attribute.name.movement_speed": "Snelheid",
	"attribute.name.nameplate_distance": "Name Tag Distance",
	"attribute.name.oxygen_bonus": "Soerstofbonus",
	"attribute.name.player.block_break_speed": "Blokbreksnelheid",
	"attribute.name.player.block_interaction_range": "Blokynteraksjeberik",
	"attribute.name.player.entity_interaction_range": "Entity Interaction Range",
	"attribute.name.player.mining_efficiency": "Myneffisjinsje",
	"attribute.name.player.sneaking_speed": "Slûpsnelheid",
	...
	"attribute.name.sneaking_speed": "Slûpsnelheid",
	"attribute.name.spawn_reinforcements": "Zombie Reinforcements",
	"attribute.name.step_height": "Staphichte",
	...
	"attribute.name.water_movement_efficiency": "Wetterbewegingseffisjinsje",
	...
	"biome.minecraft.cherry_grove": "Kersehôf",
	...
	"block.minecraft.andesite_stairs": "Andesiten trep",
	...
	"block.minecraft.banner.base.magenta": "Folslein maginta fjild",
	...
	"block.minecraft.banner.border.magenta": "Maginta seam",
	...
	"block.minecraft.banner.bricks.magenta": "Maginta mitsele fjild",
	...
	"block.minecraft.banner.circle.magenta": "Maginta rozet",
	...
	"block.minecraft.banner.creeper.magenta": "Maginta Creeperwapen",
	...
	"block.minecraft.banner.cross.magenta": "Maginta andreäskrús",
	...
	"block.minecraft.banner.curly_border.magenta": "Maginta ynkepe seam",
	...
	"block.minecraft.banner.diagonal_left.magenta": "Maginta links ôfskeane",
	...
	"block.minecraft.banner.diagonal_right.magenta": "Maginta rjochts ôfskeane",
	...
	"block.minecraft.banner.diagonal_up_left.magenta": "Maginta omkeard rjochts ôfskeane",
	...
	"block.minecraft.banner.diagonal_up_right.magenta": "Maginta omkeard links ôfskeane",
	...
	"block.minecraft.banner.flower.magenta": "Maginta blomsymboal",
	...
	"block.minecraft.banner.globe.magenta": "Maginta globe",
	...
	"block.minecraft.banner.gradient.magenta": "Maginta hege gradiïnt",
	...
	"block.minecraft.banner.gradient_up.magenta": "Maginta lege gradiïnt",
	...
	"block.minecraft.banner.half_horizontal.magenta": "Maginta dwersbalke",
	...
	"block.minecraft.banner.half_horizontal_bottom.magenta": "Maginta omkearde dwersbalke",
	...
	"block.minecraft.banner.half_vertical.magenta": "Maginta peal",
	...
	"block.minecraft.banner.half_vertical_right.magenta": "Maginta omkearde peal",
	...
	"block.minecraft.banner.mojang.magenta": "Maginta Mojang-symboal",
	...
	"block.minecraft.banner.rhombus.magenta": "Maginta rút",
	...
	"block.minecraft.banner.skull.magenta": "Maginta deadskop",
	...
	"block.minecraft.banner.small_stripes.magenta": "Maginta peallen",
	...
	"block.minecraft.banner.square_bottom_left.magenta": "Maginta kanton rjochts ûnder",
	...
	"block.minecraft.banner.square_bottom_right.magenta": "Maginta kanton links ûnder",
	...
	"block.minecraft.banner.square_top_left.magenta": "Maginta kanton rjochts boppe",
	...
	"block.minecraft.banner.square_top_right.magenta": "Maginta kanton lofts boppe",
	...
	"block.minecraft.banner.straight_cross.magenta": "Maginta krús",
	...
	"block.minecraft.banner.stripe_bottom.magenta": "Maginta basis",
	...
	"block.minecraft.banner.stripe_center.magenta": "Maginta peal",
	...
	"block.minecraft.banner.stripe_downleft.magenta": "Maginta baan links",
	...
	"block.minecraft.banner.stripe_downright.magenta": "Maginta baan",
	...
	"block.minecraft.banner.stripe_left.magenta": "Maginta peal rjochts",
	...
	"block.minecraft.banner.stripe_middle.magenta": "Maginta dwersbalke",
	...
	"block.minecraft.banner.stripe_right.magenta": "Maginta peal lofts",
	...
	"block.minecraft.banner.stripe_top.magenta": "Maginta top",
	...
	"block.minecraft.banner.triangle_bottom.magenta": "Maginta keper",
	...
	"block.minecraft.banner.triangle_top.magenta": "Maginta omkearde keper",
	...
	"block.minecraft.banner.triangles_bottom.magenta": "Maginta ynkepe basis",
	...
	"block.minecraft.calibrated_sculk_sensor": "Kalibrearre sculksensor",
	...
	"block.minecraft.cherry_button": "Kersehouten knop",
	"block.minecraft.cherry_door": "Kersehouten doar",
	"block.minecraft.cherry_fence": "Kersehouten stek",
	"block.minecraft.cherry_fence_gate": "Kersehouten stekpoarte",
	"block.minecraft.cherry_hanging_sign": "Kersehouten hingjend boerd",
	"block.minecraft.cherry_leaves": "Kerseblêden",
	"block.minecraft.cherry_log": "Kersehout",
	"block.minecraft.cherry_planks": "Kersehouten planken",
	"block.minecraft.cherry_pressure_plate": "Kersehouten drukplaat",
	"block.minecraft.cherry_sapling": "Kersesiedling",
	"block.minecraft.cherry_shelf": "Cherry Shelf",
	"block.minecraft.cherry_sign": "Kersehouten boerd",
	"block.minecraft.cherry_slab": "Kersehouten plaat",
	"block.minecraft.cherry_stairs": "Kersehouten trep",
	"block.minecraft.cherry_trapdoor": "Kersehouten fallûk",
	"block.minecraft.cherry_wall_hanging_sign": "Kersehouten úthingboerd",
	"block.minecraft.cherry_wall_sign": "Kersehouten muorreboerd",
	"block.minecraft.cherry_wood": "Kersehout",
	...
	"block.minecraft.chiseled_copper": "Bewurke koperblok",
	...
	"block.minecraft.chiseled_tuff": "Beitele dowestien",
	"block.minecraft.chiseled_tuff_bricks": "Beitele dowestienblokstiennen",
	...
	"block.minecraft.copper_bulb": "Koperen lampe",
	"block.minecraft.copper_chain": "Copper Chain",
	"block.minecraft.copper_chest": "Koperen kiste",
	"block.minecraft.copper_door": "Koperen doar",
	"block.minecraft.copper_golem_statue": "Kopergolemstânbyld",
	"block.minecraft.copper_grate": "Koperen roaster",
	...
	"block.minecraft.copper_trapdoor": "Koperen fallûk",
	...
	"block.minecraft.crafter": "Makker",
	...
	"block.minecraft.decorated_pot": "Fersierde pot",
	...
	"block.minecraft.exposed_chiseled_copper": "Bleatsteld bewurke koperblok",
	"block.minecraft.exposed_copper": "Bleatsteld koperblok",
	"block.minecraft.exposed_copper_bars": "Exposed Copper Bars",
	"block.minecraft.exposed_copper_bulb": "Bleatstelde koperen lampe",
	"block.minecraft.exposed_copper_chain": "Exposed Copper Chain",
	"block.minecraft.exposed_copper_chest": "Exposed Copper Chest",
	"block.minecraft.exposed_copper_door": "Bleatstelde koperen doar",
	"block.minecraft.exposed_copper_golem_statue": "Bleatsteld kopergolemstânbyld",
	"block.minecraft.exposed_copper_grate": "Bleatstelde koperen roaster",
	"block.minecraft.exposed_copper_lantern": "Exposed Copper Lantern",
	"block.minecraft.exposed_copper_trapdoor": "Bleatstelde koperen fallûk",
	...
	"block.minecraft.iron_chain": "Izeren ketting",
	...
	"block.minecraft.magenta_banner": "Maginta banier",
	"block.minecraft.magenta_bed": "Maginta bêd",
	"block.minecraft.magenta_candle": "Maginta kears",
	"block.minecraft.magenta_candle_cake": "Taart mei in maginta kears",
	"block.minecraft.magenta_carpet": "Maginta tapyt",
	"block.minecraft.magenta_concrete": "Maginta beton",
	"block.minecraft.magenta_concrete_powder": "Maginta semint",
	"block.minecraft.magenta_glazed_terracotta": "Maginta glazuere terrakotta",
	"block.minecraft.magenta_shulker_box": "Maginta Shulker-doaze",
	"block.minecraft.magenta_stained_glass": "Maginta kleurd glês",
	"block.minecraft.magenta_stained_glass_pane": "Maginta kleurd glês",
	"block.minecraft.magenta_terracotta": "Maginta terrakotta",
	"block.minecraft.magenta_wool": "Maginta wol",
	...
	"block.minecraft.oxidized_chiseled_copper": "Oksidearre bewurke koperblok",
	"block.minecraft.oxidized_copper": "Oksidearre koperblok",
	"block.minecraft.oxidized_copper_bars": "Oxidized Copper Bars",
	"block.minecraft.oxidized_copper_bulb": "Oksidearre koperen lampe",
	"block.minecraft.oxidized_copper_chain": "Oxidized Copper Chain",
	"block.minecraft.oxidized_copper_chest": "Oxidized Copper Chest",
	"block.minecraft.oxidized_copper_door": "Oksidearre koperen doar",
	"block.minecraft.oxidized_copper_golem_statue": "Oksidearre kopergolemstânbyld",
	"block.minecraft.oxidized_copper_grate": "Oksidearre koperen roaster",
	"block.minecraft.oxidized_copper_lantern": "Oxidized Copper Lantern",
	"block.minecraft.oxidized_copper_trapdoor": "Oksidearre koperen fallûk",
	...
	"block.minecraft.pink_petals": "Rôze blombledsjes",
	...
	"block.minecraft.pitcher_crop": "Bekerplantgewaaks",
	...
	"block.minecraft.polished_tuff": "Polyste dowestien",
	"block.minecraft.polished_tuff_slab": "Polyste dowestiennen plaat",
	"block.minecraft.polished_tuff_stairs": "Polyste dowestiennen trep",
	"block.minecraft.polished_tuff_wall": "Polyste dowestiennen muorre",
	...
	"block.minecraft.potted_cherry_sapling": "Oppotte kersesiedling",
	...
	"block.minecraft.potted_torchflower": "Oppotte fakkelblom",
	...
	"block.minecraft.short_grass": "Koart gers",
	...
	"block.minecraft.smooth_stone_slab": "Glêde stiennen plaat",
	"block.minecraft.sniffer_egg": "Sneupersaai",
	...
	"block.minecraft.stripped_cherry_log": "Stripte kersehouten stam",
	"block.minecraft.stripped_cherry_wood": "Stripte kersehout",
	...
	"block.minecraft.suspicious_gravel": "Fertocht grint",
	"block.minecraft.suspicious_sand": "Fertocht sân",
	"block.minecraft.sweet_berry_bush": "Swietbesstrúk",
	"block.minecraft.tall_dry_grass": "Heech drûch gers",
	...
	"block.minecraft.test_instance_block": "Testynstânsjeblok",
	...
	"block.minecraft.torchflower": "Fakkelblom",
	"block.minecraft.torchflower_crop": "Fakkelblomwaaks",
	"block.minecraft.trapped_chest": "Kiste mei falstrik",
	"block.minecraft.trial_spawner": "Beproevingskoai",
	...
	"block.minecraft.tuff_brick_slab": "Dowestiennen blokstiennen plaat",
	"block.minecraft.tuff_brick_stairs": "Dowestiennen blokstiennen trep",
	"block.minecraft.tuff_brick_wall": "Dowestiennen blokstiennen muorre",
	"block.minecraft.tuff_bricks": "Dowestiennen blokstiennen",
	"block.minecraft.tuff_slab": "Dowestiennen plaat",
	"block.minecraft.tuff_stairs": "Dowestiennen trep",
	"block.minecraft.tuff_wall": "Dowestiennen muorre",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Wakst bleatsteld bewurke koperblok",
	...
	"block.minecraft.waxed_exposed_copper_bulb": "Wakst bleatstelde koperen lampe",
	...
	"block.minecraft.waxed_exposed_copper_door": "Wakst bleatstelde koperen doar",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Waxed Exposed Copper Golem Statue",
	"block.minecraft.waxed_exposed_copper_grate": "Wakst bleatstelde koperen roaster",
	"block.minecraft.waxed_exposed_copper_lantern": "Waxed Exposed Copper Lantern",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Wakst bleatstelde koperen fallûk",
	...
	"block.minecraft.waxed_oxidized_chiseled_copper": "Wakst oksidearre bewurke koperblok",
	...
	"block.minecraft.waxed_oxidized_copper_bulb": "Wakst oksidearre koperen lampe",
	...
	"block.minecraft.waxed_oxidized_copper_door": "Wakst oksidearre koperen doar",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Waxed Oxidized Copper Golem Statue",
	"block.minecraft.waxed_oxidized_copper_grate": "Wakst oksidearre koperen roaster",
	"block.minecraft.waxed_oxidized_copper_lantern": "Waxed Oxidized Copper Lantern",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Wakst oksidearre koperen fallûk",
	...
	"block.minecraft.waxed_weathered_chiseled_copper": "Wakst ferware bewurke koperblok",
	...
	"block.minecraft.waxed_weathered_copper_bulb": "Wakst ferware koperen lampe",
	...
	"block.minecraft.waxed_weathered_copper_door": "Wakst ferware koperen doar",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Waxed Weathered Copper Golem Statue",
	"block.minecraft.waxed_weathered_copper_grate": "Wakst ferware koperen roaster",
	"block.minecraft.waxed_weathered_copper_lantern": "Waxed Weathered Copper Lantern",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Wakst ferware koperen fallûk",
	...
	"block.minecraft.weathered_chiseled_copper": "Ferware bewurke koperblok",
	"block.minecraft.weathered_copper": "Ferware koper",
	"block.minecraft.weathered_copper_bars": "Weathered Copper Bars",
	"block.minecraft.weathered_copper_bulb": "Ferware koperen lampe",
	...
	"block.minecraft.weathered_copper_door": "Ferware koperen doar",
	"block.minecraft.weathered_copper_golem_statue": "Weathered Copper Golem Statue",
	"block.minecraft.weathered_copper_grate": "Ferware koperen roaster",
	"block.minecraft.weathered_copper_lantern": "Weathered Copper Lantern",
	"block.minecraft.weathered_copper_trapdoor": "Ferware koperen fallûk",
	...
	"book.page_button.next": "Folgjende side",
	"book.page_button.previous": "Foarige side",
	...
	"chat.disabled.launcher": "Chat útskeakele troch launcheropsje. It berjocht koe net ferstjoerd wurde.",
	...
	"chat.queue": "[+%s rigel(s) yn wachrige]",
	"chat.queue.tooltip": "Click to display next message",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "De server ferstjoerde in ûnjildich berjocht.",
	...
	"chat.validation_error": "Chatfalidaasjeflater",
	...
	"color.minecraft.magenta": "Maginta",
	...
	"command.forkLimit": "Maksimum oantal konteksten (%s) berikke",
	...
	"commands.banip.info": "Dizze ferballing hat ynfloed op %s spiler(s): %s",
	...
	"commands.banlist.entry.unknown": "(Unbekend)",
	"commands.banlist.list": "%s speler(s) is/binne blokkearre:",
	...
	"commands.bossbar.get.players.some": "Oanpaste baasbalke %s hat %s spiler(s) op dit stuit online: %s",
	...
	"commands.bossbar.list.bars.some": "Der is/binne %s oanpaste baasbalk(en) aktyf: %s",
	...
	"commands.clear.success.single": "%s foarwerp(en) fan spiler %s fuortsmiten",
	...
	"commands.damage.invulnerable": "Doel is ûnoantaastber foar it opjûne type skea",
	"commands.damage.success": "%s skeapunten tabrocht oan %s",
	...
	"commands.data.modify.expected_value": "Wearde ferwachte; %s ûntfongen",
	"commands.data.modify.invalid_index": "Unjildige listyndeks: %s",
	"commands.data.modify.invalid_substring": "Unjildige subtekenyndeksen: %s oant %s",
	...
	"commands.datapack.list.available.success": "Der is/binne %s gegevenspakket(en) beskikber: %s",
	"commands.datapack.list.enabled.none": "Der binne gjin datapakketten ynskeakele",
	"commands.datapack.list.enabled.success": "Der is/binne %s gegevenspakket(en) ynskeakele: %s",
	...
	"commands.debug.function.noReturnRun": "Opspoaren net mooglik by /return run",
	"commands.debug.function.success.multiple": "%s opdracht(en) fan %s funksjes opspoard en pleatst yn bestân %s",
	"commands.debug.function.success.single": "%s opdracht(en) fan funksje ‘%s’ opspoard en pleatst yn bestân %s",
	...
	"commands.drop.no_loot_table.block": "Blok %s hat gjin búttabel",
	...
	"commands.execute.function.instantiationFailure": "Funksje %s ynstansjearjen mislearre: %s",
	...
	"commands.fetchprofile.copy_component": "Komponint kopiearje",
	"commands.fetchprofile.copy_text": "%s kopiearje",
	...
	"commands.fetchprofile.give_item": "Foarwerp jaan",
	...
	"commands.fill.success": "%s blok(en) mei sukses folle",
	...
	"commands.function.error.argument_not_compound": "Unjildige argumintsoart: %s; COMPOUND ferwachte",
	"commands.function.error.missing_argument": "Argumint %[2]s fan funksje %[1]s ûntbrekt",
	"commands.function.error.missing_arguments": "Arguminten fan funksje %s ûntbrekke",
	"commands.function.error.parse": "Wylst it meitsjen fan macro %s feroarsake de opdracht ‘%s’ in flater: %s",
	"commands.function.instantiationFailure": "Funksje %s ynstansjearjen mislearre: %s",
	"commands.function.result": "Funksje %s joech %s werom",
	"commands.function.scheduled.multiple": "Funksjes %s start",
	"commands.function.scheduled.no_functions": "Koe funksje mei namme %s net fine",
	"commands.function.scheduled.single": "Funksje %s start",
	"commands.function.success.multiple": "%s opdracht(en) fan %s funksjes útfierd",
	"commands.function.success.multiple.result": "%s funksjes útfierd",
	"commands.function.success.single": "%s opdracht(en) fan funksje ‘%s’ útfierd",
	"commands.function.success.single.result": "Funksje ‘%[2]s’ joech %[1]s werom",
	...
	"commands.kick.owner.failed": "Kin servereigener yn LAN-spul net út it spul sette",
	"commands.kick.singleplayer.failed": "Spilers kinne net út it spul set wurde asto offline allinnich spilest",
	...
	"commands.profile_fetch.copy_component": "Komponint kopiearje",
	"commands.profile_fetch.failed_to_serialize": "Failed to serialize profile: %s",
	"commands.profile_fetch.give_item": "Foarwerp jaan",
	...
	"commands.random.error.range_too_large": "It berik om samar in wearde út te kiezen, mei net grutter wêze as 2147483646",
	"commands.random.error.range_too_small": "It berik om samar in wearde út te kiezen, mei net lytser wêze as 2",
	"commands.random.reset.all.success": "%s ferskate rige(n) opnij ynsteld",
	"commands.random.reset.success": "%s ferskate rige opnij ynsteld",
	"commands.random.roll": "%s rolle %s (fan %s nei %s)",
	"commands.random.sample.success": "Samar in wearde: %s",
	...
	"commands.ride.already_riding": "%s rydt al op %s",
	"commands.ride.dismount.success": "%s is stoppe op %s te riden",
	"commands.ride.mount.failure.cant_ride_players": "Op spilers kinsto net ride",
	"commands.ride.mount.failure.generic": "%s koe net op %s ride",
	"commands.ride.mount.failure.loop": "Entiteit kin net op harrensels of passazjiers ride",
	"commands.ride.mount.failure.wrong_dimension": "Kin entiteit net beride yn oare diminsje",
	"commands.ride.mount.success": "%s begûn op %s te riden",
	"commands.ride.not_riding": "%s rydt nearne op",
	...
	"commands.schedule.created.function": "Funksje ‘%s’ pland nei %s tick(s) op spultiid %s",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Doel %s wurdt net langer automatysk bywurke",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Doel %s wurdt fan no ôf automatysk bywurke",
	"commands.scoreboard.objectives.modify.displayname": "Werjeftenamme fan ‘%s’ nei ‘%s’ wizige",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Standertgetalyndieling fan doel %s wiske",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Standertgetalyndieling fan doel %s wizige",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Werjeftenamme fan %s entiteiten yn %s wiske",
	"commands.scoreboard.players.display.name.clear.success.single": "Werjeftenamme fan %s yn %s wiske",
	"commands.scoreboard.players.display.name.set.success.multiple": "Werjeftenamme fan %[2]s entiteiten yn %[3]s wizige nei %[1]s",
	"commands.scoreboard.players.display.name.set.success.single": "Werjeftenamme fan %[2]s yn %[3]s wizige nei %[1]s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Getalyndieling foar %s entiteiten yn %s wiske",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Getalyndieling foar %s yn %s wiske",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Getalyndieling foar %s entiteiten yn %s wizige",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Getalyndieling foar %s yn %s wizige",
	...
	"commands.scoreboard.players.list.success": "Der is/binne %s folge entiteit(en): %s",
	...
	"commands.spreadplayers.success.entities": "%s spiler(s) ferspraad oer %s, %s, mei in gemiddelde ôfstân fan %s blokken dertusken",
	"commands.spreadplayers.success.teams": "%s team(s) ferspraad oer %s, %s, mei in gemiddelde ôfstân fan %s blokken dertusken",
	...
	"commands.team.empty.success": "%s lid/leden út team %s fuortsmiten",
	...
	"commands.worldborder.get": "De wrâldgrins is op it stuit %s blok(ken) wiid",
	...
	"commands.worldborder.set.immediate": "Wrâldgrins is ynsteld op %s blok(ken) wiid",
	"commands.worldborder.set.shrink": "Wrâldgrins wurdt yn %s sekonde(n) ferlytse nei %s blok(ken) wiid",
	...
	"commands.worldborder.warning.time.success": "Wrâldgrinswarskôgingstiid ynsteld op %s sekonde(n)",
	...
	"component.profile.dynamic": "Dynamysk",
	...
	"connect.reconfiging": "Opnij ynstelle…",
	"connect.reconfiguring": "Opnij ynstelle…",
	...
	"container.upgrade.error_tooltip": "Foarwerp kin op dizze manier net bywurke wurde",
	"container.upgrade.missing_template_tooltip": "Smeisjabloan tafoegje",
	"controls.keybinds": "Tawizen toetsen…",
	"controls.keybinds.duplicateKeybinds": "Dizze toets is ek yn gebrûk foar:\n%s",
	...
	"createWorld.customize.buffet.search": "Sykje...",
	...
	"createWorld.tab.game.title": "Spylje",
	"createWorld.tab.more.title": "Mear",
	"createWorld.tab.world.title": "Wrâld",
	"credits_and_attribution.button.attribution": "Erkenning",
	"credits_and_attribution.button.credits": "Fermeldingen",
	"credits_and_attribution.button.licenses": "Lisinsjes",
	"credits_and_attribution.screen.title": "Fermeldingen en erkenning",
	...
	"dataPack.trade_rebalance.description": "Wizige hannelswaar fan doarpelingen",
	"dataPack.trade_rebalance.name": "Nije ijking fan doarpelingenhannel",
	"dataPack.update_1_20.description": "Nije funksjes en ynhâld foar Minecraft 1.20",
	"dataPack.update_1_20.name": "Update 1.20",
	"dataPack.update_1_21.description": "Nije funksjes en ynhâld foar Minecraft 1.21",
	"dataPack.update_1_21.name": "Fernijing 1.21",
	...
	"datapackFailure.safeMode.failed.description": "Dizze wrâld befettet ûnjildige of skansearre gegevens.",
	"datapackFailure.safeMode.failed.title": "Laden fan wrâld yn feilige modus mislearre.",
	"datapackFailure.title": "Flaters yn op dit stuit selektearre gegevenspakketten hawwe opkeard dat de wrâld laden wurde koe.\nDo kinst probearje allinnich te laden mei it standert gegevenspakket (‘feilige modus’) of gean werom nei it haadmenu en reparearje it mei de hân.",
	...
	"death.attack.dragonBreath": "%[1]s is roastere troch drake-azem",
	...
	"death.attack.genericKill": "%[1]s waard deamakke",
	"death.attack.genericKill.player": "%[1]s waard deamakke troch in gefjocht mei %[2]s",
	...
	"death.attack.onFire.player": "%[1]s wie ferbaarnd fjochtsjend mei %[2]s",
	"death.attack.outOfWorld": "%[1]s is út de wrâld fallen",
	"death.attack.outOfWorld.player": "%[1]s woe net yn de wrâld fan %[2]s wenje",
	"death.attack.outsideBorder": "%[1]s hat de begrinzingen fan de wrâld ferlitten",
	"death.attack.outsideBorder.player": "%[1]s hat de begrinzingen fan de wrâld wylst in gefjocht mei %[2]s ferlitten",
	...
	"deathScreen.score.value": "Skoare: %s",
	...
	"debug.creative_spectator.error": "Spulmodus wikseljen mislearre. Gjin tastimming",
	"debug.creative_spectator.help": "F3 + N = Tusken foarige modus en taskôgermodus wikselje",
	"debug.dump_dynamic_textures": "Dynamyske tekstueren bewarre yn %s",
	"debug.dump_dynamic_textures.help": "F3 + S = Dynamyske tekstueren dumpe",
	"debug.entry.always": "Altyd",
	"debug.entry.currently.alwaysOn": "%s: no altyd oan",
	"debug.entry.currently.inF3": "%s: Currently only in F3",
	"debug.entry.currently.inOverlay": "%s: Currently only in debug overlay",
	"debug.entry.currently.never": "%s: no út",
	...
	"disconnect.ignoring_status_request": "Statusfersyk negearje",
	...
	"download.pack.progress.bytes": "Fuortgong: %s (totale grutte ûnbekend)",
	"download.pack.progress.percent": "Fuortgong: %s%%",
	"download.pack.title": "Downloading resource pack %s/%s",
	"editGamerule.default": "Standert: %s",
	"editGamerule.inGame.button": "Spulrigels bewurkje...",
	...
	"editGamerule.inGame.downloadingGamerules": "Spulrigels ophelje...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Nautilusazem",
	...
	"enchantment.minecraft.breach": "Trochbraak",
	"enchantment.minecraft.channeling": "Superlieding",
	"enchantment.minecraft.density": "Tichtens",
	...
	"enchantment.minecraft.sweeping_edge": "Feegjende râne",
	...
	"enchantment.minecraft.wind_burst": "Wynstjit",
	"entity.minecraft.acacia_boat": "Akasiahouten boat",
	"entity.minecraft.acacia_chest_boat": "Akaciahouten boat mei kiste",
	"entity.minecraft.allay": "Helper",
	"entity.minecraft.area_effect_cloud": "Gebietseffektwolk",
	"entity.minecraft.armadillo": "Goardelbist",
	"entity.minecraft.armor_stand": "Harnashâlder",
	"entity.minecraft.arrow": "Pylk",
	"entity.minecraft.axolotl": "Axolotl",
	"entity.minecraft.bamboo_chest_raft": "Bamboeflot mei kiste",
	"entity.minecraft.bamboo_raft": "Bamboeflot",
	"entity.minecraft.bat": "Flearmûs",
	"entity.minecraft.bee": "Bij",
	"entity.minecraft.birch_boat": "Bjirkehouten boat",
	"entity.minecraft.birch_chest_boat": "Bjirkehouten boat mei kiste",
	"entity.minecraft.blaze": "Blaze",
	"entity.minecraft.block_display": "Blokwerjefte",
	"entity.minecraft.boat": "Boat",
	"entity.minecraft.bogged": "Somper",
	"entity.minecraft.breeze": "Flaach",
	"entity.minecraft.breeze_wind_charge": "Wynflaach",
	...
	"entity.minecraft.cherry_boat": "Kersehouten boat",
	"entity.minecraft.cherry_chest_boat": "Kersehouten boat mei kiste",
	...
	"entity.minecraft.creaking": "Kreakend",
	"entity.minecraft.creaking_transient": "Kreakend",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Dûnkere ikehouten boat",
	"entity.minecraft.dark_oak_chest_boat": "Donkerikehouten boat mei kiste",
	...
	"entity.minecraft.falling_block_type": "Delgeande %s",
	...
	"entity.minecraft.interaction": "Ynteraksje",
	"entity.minecraft.iron_golem": "Izeren golem",
	"entity.minecraft.item": "Foarwerp",
	"entity.minecraft.item_display": "Foarwerpwerjefte",
	"entity.minecraft.item_frame": "Foarwerplist",
	"entity.minecraft.jungle_boat": "Oerwâldhouten boat",
	"entity.minecraft.jungle_chest_boat": "Oerwâldhouten boat mei kiste",
	...
	"entity.minecraft.mangrove_boat": "Mangrovehouten boat",
	"entity.minecraft.mangrove_chest_boat": "Mangrovehouten boat mei kiste",
	...
	"entity.minecraft.oak_boat": "Ikehouten boat",
	"entity.minecraft.oak_chest_boat": "Ikehouten boat mei kiste",
	...
	"entity.minecraft.pale_oak_boat": "Bleke ikehouten boat",
	"entity.minecraft.pale_oak_chest_boat": "Bleke ikehouten boat mei kiste",
	...
	"entity.minecraft.sniffer": "Sneuper",
	...
	"entity.minecraft.spruce_boat": "Spjirrehouten boat",
	"entity.minecraft.spruce_chest_boat": "Sparrehouten boat mei kiste",
	...
	"entity.minecraft.text_display": "Tekstwerjefte",
	...
	"entity.minecraft.wind_charge": "Wynflaach",
	...
	"entity.minecraft.zombie_nautilus": "Sombynautilus",
	...
	"event.minecraft.raid.defeat.full": "Oerfal – ferlern",
	"event.minecraft.raid.raiders_remaining": "%s oerfaller(s) oer",
	"event.minecraft.raid.victory": "Oerwinning",
	"event.minecraft.raid.victory.full": "Oerfal – oerwinning",
	"filled_map.buried_treasure": "Skatkaart",
	"filled_map.explorer_jungle": "Oerwâldferkennerskaart",
	"filled_map.explorer_swamp": "Moerasferkennerskaart",
	"filled_map.id": "Nr. %s",
	...
	"filled_map.trial_chambers": "Beproevingskeamerkaart",
	"filled_map.unknown": "Unbekende kaart",
	"filled_map.village_desert": "Woestinedoarpkaart",
	"filled_map.village_plains": "Fjildendoarpkaart",
	"filled_map.village_savanna": "Savannedoarpkaart",
	"filled_map.village_snowy": "Sniedoarpkaart",
	"filled_map.village_taiga": "Taigadoarpkaart",
	...
	"gameMode.hardcore": "Dreege oerlibjemoadus!",
	...
	"gamerule.commandModificationBlockLimit": "Bloklimyt modifikaasje-opdrachten",
	"gamerule.commandModificationBlockLimit.description": "Oantal blokken dat yn ien kear oanpast wurde kin troch ien opdracht, lykas mei fill of clone.",
	...
	"gamerule.doVinesSpread": "Lianen ferspriede harren",
	"gamerule.doVinesSpread.description": "Bepaalt of lianen harren willekeurich ferspriede nei njonken lizzende blokken. Hat gjin effekt op oare liaansoarten, lykas klimop.",
	...
	"gamerule.enderPearlsVanishOnDeath": "Smiten Ender-pearels ferdwine by dea",
	"gamerule.enderPearlsVanishOnDeath.description": "Of de troch in spiler smiten Ender-pearels ferdwine wannear dy spiler deagiet.",
	...
	"gamerule.maxCommandForkCount": "Opdrachtkontekstlimyt",
	...
	"gamerule.minecraft.raids": "Oerfallen",
	...
	"gamerule.spawnMonsters": "Meunsters spawne",
	...
	"gui.abuseReport.describe": "It dielen fan details sil ús helpe om in goed ynformearre beslút te nimmen.",
	"gui.abuseReport.discard.content": "Asto dit skerm ferlitst, rekkesto dizze melding en dyn beskriuwing kwyt.\nBisto wis datsto dit skerm slute wolst?",
	"gui.abuseReport.discard.discard": "Slute en rapport fuortsmite",
	"gui.abuseReport.discard.draft": "As konsept bewarje",
	"gui.abuseReport.discard.return": "Fierder bewurkje",
	"gui.abuseReport.discard.title": "Melding en beskriuwing fuortsmite?",
	"gui.abuseReport.draft.content": "Wolsto it besteande rapport fierder bewurkje of fuortsmite en in nije meitsje?",
	"gui.abuseReport.draft.discard": "Fuortsmite",
	"gui.abuseReport.draft.edit": "Fierder bewurkje",
	"gui.abuseReport.draft.quittotitle.content": "Wolsto it rapport bewurkje of fuortsmite?",
	"gui.abuseReport.draft.quittotitle.title": "Do hast in konseptferzje fan in rapport. Dizze sil ferdwine asto dy ôfmeldst",
	"gui.abuseReport.draft.title": "Konseptferzje fan rapport bewurkje?",
	"gui.abuseReport.error.title": "Der is in probleem bard by it stjoeren fan dyn rapport",
	"gui.abuseReport.message": "Wêr hasto dit wangedrach sjoen?\nDizze ynformaasje helpt ús by it ûndersykjen.",
	"gui.abuseReport.more_comments": "Beskriuw wat der bard is:",
	"gui.abuseReport.name.comment_box_label": "Please describe why you want to report this name:",
	"gui.abuseReport.name.reporting": "Do rapportearrest oer ‘%s’.",
	"gui.abuseReport.name.title": "Spilernamme rapportearje",
	"gui.abuseReport.observed_what": "Wêrom meldesto dit?",
	"gui.abuseReport.read_info": "Mear oer rapportearjen",
	...
	"gui.abuseReport.reason.generic": "Ik wol dizze spiler rapportearje",
	"gui.abuseReport.reason.generic.description": "Dizze spiler yrritearret my of hat wat dien wat my net befalt.",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Seksueel ûnakseptabel",
	...
	"gui.abuseReport.report_sent_msg": "Wy hawwe dyn melding ûntfongen. Tankewol!\n\nUs team sjocht der sa gau as mooglik nei.",
	"gui.abuseReport.select_reason": "Rapportkategory selektearje",
	"gui.abuseReport.send": "Rapport ferstjoere",
	"gui.abuseReport.send.comment_too_long": "Meitsje de opmerking koarter",
	...
	"gui.abuseReport.send.no_reason": "Selektearje in rapportkategory",
	...
	"gui.abuseReport.skin.title": "Spilerskin rapportearje",
	"gui.abuseReport.title": "Spiler rapportearje",
	"gui.abuseReport.type.chat": "Chatberjochten",
	"gui.abuseReport.type.name": "Spilersnamme",
	"gui.abuseReport.type.skin": "Spilerskin",
	"gui.acknowledge": "Begrepen",
	"gui.advancements": "Foarútgongen",
	"gui.all": "Alle",
	"gui.back": "Tebek",
	"gui.banned.description": "%s\n\n%s\n\nLês mear fia de folgjende keppeling: %s",
	"gui.banned.description.permanent": "Dyn account is permanint blokkearre, wat betsjut datsto net online of yn Realms meidwaan.",
	...
	"gui.banned.name.description": "Dyn aktuele namme – ‘%s’ – komt net oerien mei ús mienskipsstanderts. Do kinst allinnich spylje, mar do moatst dyn namme wizigje om online spylje te kinnen.\n\nLês mear hjiroer of tsjinje in wersjenningsfersyk yn op %s",
	"gui.banned.name.title": "Namme online net tastien",
	"gui.banned.reason.defamation_impersonation_false_information": "Imitaasje of it dielen fan ynformaasje om oaren te eksploitearjen of te mislieden",
	"gui.banned.reason.drugs": "Ferwizingen nei yllegale drugs",
	"gui.banned.reason.extreme_violence_or_gore": "Ofbyldingen fan eksessyf geweld of goare dingen út it echte libben",
	"gui.banned.reason.false_reporting": "Oermjittige, falske of ûnsekuere meldingen",
	"gui.banned.reason.fraud": "Frauduleuze krijen of brûken fan ynhâld",
	"gui.banned.reason.generic_violation": "Skeining fan de mienskipsnoarmen",
	"gui.banned.reason.harassment_or_bullying": "Beledigjend taalgebrûk op in rjochte, skealike wize",
	"gui.banned.reason.hate_speech": "Haatsiedzje of diskriminaasje",
	"gui.banned.reason.hate_terrorism_notorious_figure": "Ferwizing nei haatgroepen, terroristyske organisaasjes of beruchte figueren",
	"gui.banned.reason.imminent_harm_to_person_or_property": "Yntinsje om yn it echte libben skea ta te bringen oan persoanen of guod",
	"gui.banned.reason.nudity_or_pornography": "It werjaan fan ûntuchtich of pornografysk materiaal",
	"gui.banned.reason.sexually_inappropriate": "Underwerpen of ynhâld fan seksuele dingen",
	"gui.banned.reason.spam_or_advertising": "Spam of reklame",
	"gui.banned.skin.description": "Dyn aktuele skin komt net oerien mei ús mienskipsstanderts. Do kinst mei in standert skin spylje, of in nije oplade.\n\nLês mear hjiroer of tsjinje in wersjenningsfersyk yn op %s",
	"gui.banned.skin.title": "Skin net tastien",
	...
	"gui.continue": "Trochgean",
	"gui.copy_link_to_clipboard": "Keppeling nei klamboerd kopiearje",
	...
	"gui.game_rule.search": "Sykje...",
	"gui.hours": "%s oere(n)",
	"gui.language.search": "Sykje...",
	"gui.loadingMinecraft": "Minecraft lade",
	...
	"gui.narrate.tab": "%s-ljepblêd",
	"gui.no": "Nee",
	"gui.none": "Gjin",
	"gui.ok": "OK",
	"gui.open_report_dir": "Open Report Directory",
	"gui.packSelection.search": "Sykje...",
	...
	"gui.recipebook.next_page": "Folgjende side",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Foarige side",
	...
	"gui.toRealms": "Werom nei de Realmslist",
	"gui.toTitle": "Werom nei it haadmenu",
	"gui.toWorld": "Werom nei de wrâldlist",
	"gui.togglable_slot": "Klik om fek út te skeakeljen",
	"gui.up": "Omheech",
	"gui.waitingForResponse.button.inactive": "Werom (%ss)",
	...
	"item.minecraft.angler_pottery_shard": "Ierdewurkskerf ‘fisker’",
	"item.minecraft.angler_pottery_sherd": "Ierdewurk diggel fisker",
	"item.minecraft.apple": "Appel",
	"item.minecraft.archer_pottery_shard": "Ierdewurkskerf ‘bôgeskutter’",
	"item.minecraft.archer_pottery_sherd": "Ierdewurk diggel bôgeskutter",
	"item.minecraft.armadillo_scute": "Gurdledier hoarnplaat",
	"item.minecraft.armadillo_spawn_egg": "Gurdledierspawnaai",
	"item.minecraft.armor_stand": "Wapenhâlder",
	"item.minecraft.arms_up_pottery_shard": "Ierdewurkskerf ‘earms omheech’",
	"item.minecraft.arms_up_pottery_sherd": "Ierdewurk diggel earms omheech",
	...
	"item.minecraft.blade_pottery_shard": "Ierdewurkskerf ‘swurd’",
	"item.minecraft.blade_pottery_sherd": "Ierdewurk diggel swurd",
	...
	"item.minecraft.blue_egg": "Blau aai",
	...
	"item.minecraft.brewer_pottery_shard": "Ierdewurkskerf ‘brouwer’",
	"item.minecraft.brewer_pottery_sherd": "Ierdewurk diggel brouwer",
	...
	"item.minecraft.brown_egg": "Brún aai",
	"item.minecraft.brown_harness": "Brown Harness",
	"item.minecraft.brush": "Boarstel",
	"item.minecraft.bucket": "Amer",
	"item.minecraft.bundle": "Bondel",
	"item.minecraft.bundle.empty": "Leech",
	"item.minecraft.bundle.empty.description": "Can hold a mixed stack of items",
	"item.minecraft.bundle.full": "Fol",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "Ierdewurkskerf ‘flammen’",
	"item.minecraft.burn_pottery_sherd": "Ierdewurk diggel flammen",
	...
	"item.minecraft.cherry_boat": "Kersehouten boat",
	"item.minecraft.cherry_chest_boat": "Kersehouten boat mei kiste",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Smeisjabloan",
	...
	"item.minecraft.copper_axe": "Koperen bile",
	"item.minecraft.copper_boots": "Koperen learzens",
	"item.minecraft.copper_chestplate": "Koperen boarstplaat",
	"item.minecraft.copper_golem_spawn_egg": "Kopergolemspawnaai",
	"item.minecraft.copper_helmet": "Koperen helm",
	"item.minecraft.copper_hoe": "Koperen skoffel",
	"item.minecraft.copper_horse_armor": "Koperen hynsteharnas",
	"item.minecraft.copper_ingot": "Koperstêf",
	"item.minecraft.copper_leggings": "Koperen boksen",
	...
	"item.minecraft.copper_spear": "Koperen spear",
	...
	"item.minecraft.danger_pottery_shard": "Ierdewurkskerf ‘gefaar’",
	"item.minecraft.danger_pottery_sherd": "Ierdewurk diggel gefaar",
	...
	"item.minecraft.diamond_spear": "Diamanten spear",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Smeisjabloan",
	...
	"item.minecraft.explorer_pottery_shard": "Ierdewurkskerf ‘ûntdekker’",
	"item.minecraft.explorer_pottery_sherd": "Ierdewurk diggel ûntdekker",
	"item.minecraft.eye_armor_trim_smithing_template": "Smeisjabloan",
	...
	"item.minecraft.firework_star.magenta": "Maginta",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Smeisjabloan",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Flow Armor Trim",
	"item.minecraft.flow_banner_pattern": "Banierpatroan",
	...
	"item.minecraft.friend_pottery_shard": "Ierdewurkskerf ‘freon’",
	"item.minecraft.friend_pottery_sherd": "Ierdewurk diggel freon",
	...
	"item.minecraft.golden_spear": "Gouden spear",
	...
	"item.minecraft.heart_pottery_shard": "Ierdewurkskerf ‘hert’",
	"item.minecraft.heart_pottery_sherd": "Ierdewurk diggel hert",
	"item.minecraft.heartbreak_pottery_shard": "Ierdewurkskerf ‘brutsen hert’",
	"item.minecraft.heartbreak_pottery_sherd": "Ierdewurk diggel brutsen hert",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Smeisjabloan",
	"item.minecraft.host_armor_trim_smithing_template.new": "Host Armor Trim",
	"item.minecraft.howl_pottery_shard": "Ierdewurkskerf ‘gûle’",
	"item.minecraft.howl_pottery_sherd": "Ierdewurk diggel gûle",
	...
	"item.minecraft.iron_spear": "Izeren spear",
	...
	"item.minecraft.mace": "Knodze",
	"item.minecraft.magenta_bundle": "Magenta Bundle",
	"item.minecraft.magenta_dye": "Maginta kleurstof",
	...
	"item.minecraft.miner_pottery_shard": "Ierdewurkskerf ‘mynwurker’",
	"item.minecraft.miner_pottery_sherd": "Ierdewurk diggel mynwurker",
	...
	"item.minecraft.mourner_pottery_shard": "Ierdewurkskerf ‘rou’",
	"item.minecraft.mourner_pottery_sherd": "Ierdewurk diggel rou",
	...
	"item.minecraft.music_disc_creator": "Muzykplaat",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Muzykplaat",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Creator (Muzykdoaze)",
	"item.minecraft.music_disc_far": "Muzykplaat",
	"item.minecraft.music_disc_far.desc": "C418 - far",
	"item.minecraft.music_disc_lava_chicken": "Muzykplaat",
	...
	"item.minecraft.music_disc_precipice": "Muzykplaat",
	"item.minecraft.music_disc_precipice.desc": "Aaron Cherof - Precipice",
	"item.minecraft.music_disc_relic": "Muzykplaat",
	...
	"item.minecraft.music_disc_tears": "Muzykplaat",
	...
	"item.minecraft.nautilus_spawn_egg": "Nautilusspawnaai",
	...
	"item.minecraft.netherite_spear": "Netheryt-spear",
	"item.minecraft.netherite_sword": "Netheryt-swurd",
	"item.minecraft.netherite_upgrade_smithing_template": "Smeisjabloan",
	...
	"item.minecraft.plenty_pottery_shard": "Ierdewurkskerf ‘oerfloed’",
	"item.minecraft.plenty_pottery_sherd": "Ierdewurk diggel oerfloed",
	...
	"item.minecraft.pottery_shard_archer": "Ierdewurkskerf ‘bôgeskutter’",
	"item.minecraft.pottery_shard_arms_up": "Ierdewurkskerf ‘earms omheech’",
	"item.minecraft.pottery_shard_prize": "Ierdewurkskerf ‘beleaning’",
	"item.minecraft.pottery_shard_skull": "Ierdewurkskerf ‘deadskop’",
	...
	"item.minecraft.prize_pottery_shard": "Ierdewurkskerf ‘priis’",
	"item.minecraft.prize_pottery_sherd": "Ierdewurk diggel priis",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Smeisjabloan",
	...
	"item.minecraft.rib_armor_trim_smithing_template": "Smeisjabloan",
	...
	"item.minecraft.sentry_armor_trim_smithing_template": "Smeisjabloan",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Sentry Armor Trim",
	"item.minecraft.shaper_armor_trim_smithing_template": "Smeisjabloan",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Shaper Armor Trim",
	"item.minecraft.sheaf_pottery_shard": "Ierdewurkskerf ‘skeaf’",
	"item.minecraft.sheaf_pottery_sherd": "Ierdewurk diggel skeaf",
	"item.minecraft.shears": "Skjirre",
	"item.minecraft.sheep_spawn_egg": "Skiepespawnaai",
	"item.minecraft.shelter_pottery_shard": "Ierdewurkskerf ‘skûlplak’",
	"item.minecraft.shelter_pottery_sherd": "Ierdewurk diggel skûlplak",
	...
	"item.minecraft.shield.magenta": "Maginta skyld",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Smeisjabloan",
	...
	"item.minecraft.skull_pottery_shard": "Ierdewurkskerf ‘deadskop’",
	"item.minecraft.skull_pottery_sherd": "Ierdewurk diggel deadskop",
	"item.minecraft.slime_ball": "Slymbal",
	"item.minecraft.slime_spawn_egg": "Slymkubusspawnaai",
	"item.minecraft.smithing_template": "Smeisjabloan",
	"item.minecraft.smithing_template.applies_to": "Fan tapassing op:",
	"item.minecraft.smithing_template.armor_trim.additions_slot_description": "Staf of kristal tafoegje",
	"item.minecraft.smithing_template.armor_trim.applies_to": "Wapenrêsting",
	"item.minecraft.smithing_template.armor_trim.base_slot_description": "Harnasstik tafoegje",
	"item.minecraft.smithing_template.armor_trim.ingredients": "Staven en kristallen",
	"item.minecraft.smithing_template.ingredients": "Yngrediïnten:",
	"item.minecraft.smithing_template.netherite_upgrade.additions_slot_description": "Netheryt-stêf tafoegje",
	"item.minecraft.smithing_template.netherite_upgrade.applies_to": "Diamanten útris",
	"item.minecraft.smithing_template.netherite_upgrade.base_slot_description": "Diamanten harnas, wapen of ark tafoegje",
	"item.minecraft.smithing_template.netherite_upgrade.ingredients": "Netheryt-stêf",
	"item.minecraft.smithing_template.upgrade": "Fernije: ",
	"item.minecraft.sniffer_spawn_egg": "Sneuperspawnaai",
	"item.minecraft.snort_pottery_shard": "Ierdewurkskerf ‘sneupje’",
	"item.minecraft.snort_pottery_sherd": "Ierdewurk diggel sneupje",
	"item.minecraft.snout_armor_trim_smithing_template": "Smeisjabloan",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Smeisjabloan",
	...
	"item.minecraft.stone_spear": "Stiennen spear",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Smeisjabloan",
	...
	"item.minecraft.torchflower_seeds": "Fakkelblomsiedsjes",
	...
	"item.minecraft.vex_armor_trim_smithing_template": "Smeisjabloan",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Smeisjabloan",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Smeisjabloan",
	...
	"item.minecraft.wild_armor_trim_smithing_template": "Smeisjabloan",
	...
	"item.minecraft.wooden_spear": "Houten spear",
	...
	"item.minecraft.zombie_nautilus_spawn_egg": "Sombynautilusspawnaai",
	...
	"item.op_block_warning.line1": "Warskôging:",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine - Creator (Muzykdoaze)",
	...
	"key.keyboard.unknown": "Net ynsteld",
	...
	"known_server_link.news": "Nijs",
	"known_server_link.report_bug": "Serverbug melde",
	"known_server_link.status": "Status",
	"known_server_link.support": "Stipe",
	...
	"mco.account.privacy.info.button": "Mear ynfo oer GDPR",
	...
	"mco.activity.noactivity": "Neat barre yn de ôfrûne %s dei/dagen",
	"mco.activity.title": "Spileraktiviteit",
	"mco.backup.button.download": "Download de nijste",
	...
	"mco.backup.entry": "Reservekopy (%s)",
	"mco.backup.entry.description": "Beskriuwing",
	"mco.backup.entry.enabledPack": "Ynskeakele pakket(ten)",
	"mco.backup.entry.gameDifficulty": "Swierichheidsgraad",
	"mco.backup.entry.gameMode": "Spulmodus",
	"mco.backup.entry.gameServerVersion": "Serverferzje",
	"mco.backup.entry.name": "Namme",
	"mco.backup.entry.seed": "Startwearde",
	"mco.backup.entry.templateName": "Sjabloannamme",
	"mco.backup.entry.undefined": "Net definiearre wiziging",
	"mco.backup.entry.uploaded": "Opladen",
	"mco.backup.entry.worldType": "Wrâldtype",
	"mco.backup.entry.worldType.adventureMap": "Adventure Map",
	"mco.backup.entry.worldType.experience": "Experience",
	"mco.backup.entry.worldType.inspiration": "Ynspiraasje",
	"mco.backup.entry.worldType.minigame": "Minigame",
	"mco.backup.entry.worldType.normal": "Normaal",
	"mco.backup.entry.worldType.unknown": "Ûnbekend",
	"mco.backup.generate.world": "Wrâld generearje",
	"mco.backup.info.title": "Wizigingen sûnt lêste reservekopy",
	...
	"mco.compatibility.upgrade": "Fernije",
	...
	"mco.configure.world.close.question.line1": "Dyn Realm sil ûnbeskikber wurde.",
	...
	"mco.configure.world.invite.narration": "Do hast %s nije útnûging(en)",
	"mco.configure.world.invite.profile.name": "Namme",
	"mco.configure.world.invited": "Utnûge",
	"mco.configure.world.invited.number": "Utnûge (%s)",
	...
	"mco.configure.world.leave.question.line1": "Asto dizze Realm ferlitst silsto dizze net wer sjen, of do moast opnij útnoege wurde",
	...
	"mco.configure.world.minigame": "Aktueel: %s",
	...
	"mco.configure.world.players.inviting": "Spiler útnûgje…",
	...
	"mco.configure.world.resourcepack.question.line1": "Dizze Realm easket in oanpast boarnepakket.",
	"mco.configure.world.resourcepack.question.line2": "Wolsto it downloade en spylje?",
	"mco.configure.world.restore.download.question.line1": "De wrâld sil ynladen wurde en tafoege wurde oan dyn singleplayer-wrâlden.",
	...
	"mco.configure.world.spawnAnimals": "Bisten spawne",
	"mco.configure.world.spawnMonsters": "Spawn Monsters",
	"mco.configure.world.spawnNPCs": "Spawn-NSP's",
	"mco.configure.world.spawnProtection": "Spawnbeskerming",
	...
	"mco.configure.world.subscription.recurring.info": "Wizigingen oan dyn Realms-abonnemint, lykas it ferlingen derfan of it útskeakeljen fan weromkearend fakturearjen, wurde net toand oant de folgjende fakturearringsdatum.",
	"mco.configure.world.subscription.remaining.days": "%[1]s dei/dagen",
	"mco.configure.world.subscription.remaining.months": "%[1]s moanne(n)",
	"mco.configure.world.subscription.remaining.months.days": "%[1]s moanne(n) en %[2]s dei/dagen",
	"mco.configure.world.subscription.start": "Begjindatum",
	"mco.configure.world.subscription.tab": "Abonnemint",
	"mco.configure.world.subscription.timeleft": "Tiid oer",
	"mco.configure.world.subscription.title": "Dyn abonnemint",
	"mco.configure.world.subscription.unknown": "Unbekend",
	"mco.configure.world.switch.slot": "Wrâld meitsje",
	"mco.configure.world.switch.slot.subtitle": "Dizze wrâld is leech, kies wat te dwaan",
	"mco.configure.world.title": "Realm ynstelle:",
	"mco.configure.world.uninvite.player": "Bisto der wis fan datsto de útnûging oan ‘%s’ ynlûke wolst'?",
	...
	"mco.download.confirmation.line2": "Do silst dizze wrâld net opnij oplade kinne nei Realms",
	...
	"mco.download.resourcePack.fail": "Boarnepakket downloade mislearre!",
	...
	"mco.errorMessage.6005": "Wrâld beskoattele",
	"mco.errorMessage.6006": "Wrâld is ferâldere",
	"mco.errorMessage.6007": "Brûker is lid fan te folle Realms",
	"mco.errorMessage.6008": "Realm-namme net jildich",
	"mco.errorMessage.6009": "Realm-beskriuwing net jildich",
	"mco.errorMessage.connectionFailure": "Der hat him in flater foardien, besykje it letter opnij.",
	"mco.errorMessage.generic": "Der is in flater bard: ",
	"mco.errorMessage.initialize.failed": "Failed to initialize Realm",
	"mco.errorMessage.noDetails": "Gjin details foar flater jûn",
	"mco.errorMessage.realmsService": "Der is in flater bard (%s):",
	"mco.errorMessage.realmsService.configurationError": "An unexpected error occurred while editing world options",
	"mco.errorMessage.realmsService.connectivity": "Koe gjin ferbining mei de Realm meitsje: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Kin net op kompatibele ferzje kontrolearje: %s",
	"mco.errorMessage.retry": "Opnij probearje",
	...
	"mco.invites.pending": "Nije útnûging(en)!",
	...
	"mco.minigame.world.restore": "Spultsje einigje...",
	...
	"mco.minigame.world.slot.screen.title": "Wrâld omsette...",
	...
	"mco.notification.dismiss": "Slute",
	"mco.notification.transferSubscription.buttonText": "Transfer Now",
	"mco.notification.transferSubscription.message": "Java Realms-abonneminten wurde ferpleatst nei de Microsoft Store. Lit dyn abonnemint net ferrinne!\nSet it no oer en krij oant 30 dagen Realms fergees.\nGean nei dyn profyl op minecraft.net en set dyn abonnemint oer.",
	"mco.notification.visitUrl.buttonText.default": "Keppeling iepenje",
	"mco.notification.visitUrl.message.default": "Besykje ûndersteande keppeling",
	"mco.onlinePlayers": "Spilers online",
	...
	"mco.reset.world.warning": "Dit sil de notiidske wrâld fan dyn Realm fuortsmite!",
	...
	"mco.selectServer.create.subtitle": "Selektearje hokker wrâld do op dyn nije Realm sette wolst",
	"mco.selectServer.expired": "Ferrûne Realm",
	...
	"mco.selectServer.loading": "Realmslist lade",
	...
	"mco.selectServer.noRealms": "It liket derop datsto gjin Realm hast. Foegje in Realm ta om tegearre mei dyn freonen te spyljen.",
	...
	"mco.selectServer.uninitialized": "Klik om in Realm te meitsjen!",
	...
	"mco.snapshotRealmsPopup.message": "Fan 23w41a ôf kinsto yn in snapshot op Realms spylje. Elk Realmsabonnemint hat in fergees snapshotrealm dy’t apart stiet fan dyn normale Realm!",
	"mco.snapshotRealmsPopup.title": "Realms no beskikber yn snapshots",
	"mco.snapshotRealmsPopup.urlText": "Mear ynfo",
	...
	"mco.time.daysAgo": "%[1]s dei/dagen lyn",
	"mco.time.hoursAgo": "%[1]s oere(n) lyn",
	"mco.time.minutesAgo": "%[1]s minút/minuten lyn",
	"mco.time.now": "sa krekt",
	"mco.time.secondsAgo": "%[1]s sekonde(n) lyn",
	...
	"mco.upload.close.failure": "Koe dyn Realm net slute, besykje it letter opnij",
	...
	"mco.upload.failed.too_big.title": "Wrâld te grut",
	...
	"mco.version": "Ferzje: %s",
	"mco.warning": "Warskôging!",
	...
	"menu.server_links": "Serverkeppelingen…",
	"menu.server_links.title": "Serverkeppelingen",
	...
	"multiplayer.disconnect.invalid_packet": "Server stjoerde in ûnjildich pakket",
	...
	"multiplayer.disconnect.invalid_public_key_signature.new": "Unjildige hantekening foar iepenbiere profylkaai.\nProbearje dyn spul opnij te starten.",
	...
	"multiplayer.lan.server_found": "Nije server fûn: %s",
	...
	"multiplayer.player.list.narration": "Spilers online: %s",
	"multiplayer.requiredTexturePrompt.disconnect": "Server fereasket in oanpast boarne pakket",
	...
	"multiplayer.status.version.narration": "Serverferzje: %s",
	...
	"narration.selection.usage": "Druk op de knoppen omheech en omleech om nei in oare yngong te gean",
	"narration.slider.usage.focused": "Druk op lofts of rjochts toetseboerdknoppen om wearde te feroarjen",
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Press Enter to start changing the slider value",
	"narration.slider.usage.hovered": "Sleep de skúf om de wearde te feroarjen",
	"narration.suggestion": "Suggestje %s fan %s selektearre: %s",
	"narration.suggestion.tooltip": "Suggestje %s fan %s selektearre: %s (%s)",
	"narration.suggestion.usage.cycle.fixed": "Druk op de Tab-toets om nei de folgjende suggestje te gean",
	"narration.suggestion.usage.cycle.hidable": "Druk op de Tab-toets om nei de folgjende suggestje te gean of op de Escape-toets om de suggestjes te ferlitten",
	"narration.suggestion.usage.fill.fixed": "Druk op de Tab-toets om de suggestje te brûken",
	"narration.suggestion.usage.fill.hidable": "Druk op de Tab-toets om de suggestje te brûken of op de Escape-toets om de suggestjes te ferlitten",
	"narration.tab_navigation.usage": "Druk op Ctrl en Tab om te skeakeljen tusken ljepblêden",
	...
	"narrator.position.tab": "Ljepblêd %s fan %s selektearre",
	"narrator.ready_to_play": "Klear om te spyljen",
	...
	"narrator.select.world_info": "%s selektearre; lêst spile: %s om %s",
	...
	"options.accessibility": "Tagonklikheidsynstellingen…",
	"options.accessibility.high_contrast": "Heech kontrast",
	"options.accessibility.high_contrast.error.tooltip": "Boarnepakket mei heech kontrast is net beskikber",
	"options.accessibility.high_contrast.tooltip": "Ferbetteret it kontrast fan UI-eleminten",
	...
	"options.accessibility.narrator_hotkey": "Fertellerfluchtoets",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Allows the Narrator to be toggled on and off with 'Cmd + B'.",
	"options.accessibility.narrator_hotkey.tooltip": "Mei Ctrl + B de ferteller yn- en útskeakelje",
	...
	"options.chat": "Chatynstellingen…",
	"options.chat.color": "Kleuren",
	"options.chat.delay": "Spraakfertraging: %s sekonde(n)",
	...
	"options.credits_and_attribution": "Fermeldingen en erkenning…",
	...
	"options.damageTiltStrength": "Skeakanteling",
	"options.damageTiltStrength.tooltip": "Hoefolle de kamera kantelet wannear’tsto pine hast.",
	...
	"options.difficulty.easy.info": "Fijannige wêzens spawne, mar meitsje minder skea. De hongerbalke rekket leech en ferminderet dan dyn sûnens oant fiif hertsjes.",
	"options.difficulty.hard": "Dreech",
	"options.difficulty.hard.info": "Fijannige wêzens spawne, mar meitsje mear skea. De hongerbalke rekket leech en ferminderet dan al dyn sûnens.",
	"options.difficulty.hardcore": "Hardcore",
	"options.difficulty.normal": "Normaal",
	"options.difficulty.normal.info": "Fijannige wêzens spawne, mar meitsje standert hoemannichte skea. De hongerbalke rekket leech en ferminderet dan dyn sûnens oant in heal hertsje.",
	"options.difficulty.online": "Serverswierrichheid",
	"options.difficulty.peaceful": "Fredich",
	"options.difficulty.peaceful.info": "Gjin fijannige wêzens en allinnich guon neutrale wêzens spawne. De hongerbalke rekket nea leech en sûnens wurdt mei de tiid byfolle.",
	...
	"options.glintSpeed": "Glânssnelheid",
	"options.glintSpeed.tooltip": "Bepaalt hoe fluch it glânseffekt beweecht oer betsjoene foarwerpen.",
	"options.glintStrength": "Glânssterkte",
	"options.glintStrength.tooltip": "Bepaalt de transparantsje fan it glânseffekt op betsjoene foarwerpen.",
	"options.graphics": "Grafysk",
	"options.graphics.custom": "Oanpast",
	...
	"options.graphics.warning.cancel": "Tebek",
	...
	"options.inactivityFpsLimit.minimized": "Minimalisearre",
	...
	"options.languageAccuracyWarning": "(Oersettingen binne miskien net 100%% sekuer)",
	...
	"options.modelPart.left_pants_leg": "Linker bokse",
	...
	"options.music_frequency.default": "Standert",
	"options.music_frequency.frequent": "Faak",
	...
	"options.notifications.display_time": "Meldingstiid",
	"options.notifications.display_time.tooltip": "Bepaalt hoe lang meldingen op it skerm sichtber bliuwe.",
	"options.off": "ÚT",
	...
	"options.realmsNotifications": "Realms Nijs & Utnûgingen",
	...
	"options.renderCloudsDistance": "Wolkenôfstân",
	...
	"options.showSubtitles": "Lit ûndertiteling sjen",
	...
	"options.textureFiltering.anisotropic": "Anisotropysk",
	...
	"options.textureFiltering.none": "Gjin",
	...
	"options.video.display.header": "Werjefte",
	"options.video.interface.header": "Interface",
	"options.video.preferences.header": "Foarkaren",
	...
	"pack.dropRejected.message": "De folgjende list befettet ûnjildige pakketten en waarden net kopiearre:\n %s",
	"pack.dropRejected.title": "Eleminten dy’t gjin pakket binne",
	...
	"painting.minecraft.backyard.title": "Eftertún",
	...
	"painting.minecraft.cavebird.title": "Grottenfûgel",
	...
	"painting.minecraft.humble.title": "Nederich",
	...
	"painting.minecraft.meditative.title": "Meditatyf",
	...
	"painting.minecraft.tides.title": "Tij",
	...
	"painting.random": "Tafallige fariant",
	...
	"quickplay.error.invalid_identifier": "Gjin wrâld fûn mei de opjûne identiteit",
	"quickplay.error.realm_connect": "Koe gjin ferbining mei de Realm meitsje",
	"quickplay.error.realm_permission": "Gjin tastimming om mei dizze Realm te ferbinen",
	"quickplay.error.title": "Fluch spyljen mislearre",
	"realms.configuration.region.australia_east": "Nij-Súd-Wales, Austraalje",
	"realms.configuration.region.australia_southeast": "Fiktoaria, Austraalje",
	"realms.configuration.region.brazil_south": "Brazilië",
	"realms.configuration.region.central_india": "Yndia",
	"realms.configuration.region.central_us": "Iowa, Feriene Steaten",
	"realms.configuration.region.east_asia": "Hongkong",
	"realms.configuration.region.east_us": "Firginia, Feriene Steaten",
	"realms.configuration.region.east_us_2": "Noard-Karolina, Feriene Steaten",
	"realms.configuration.region.france_central": "Frankryk",
	"realms.configuration.region.japan_east": "East-Japan",
	"realms.configuration.region.japan_west": "West-Japan",
	"realms.configuration.region.korea_central": "Súd-Koreä",
	"realms.configuration.region.north_central_us": "Illinois, Feriene Steaten",
	"realms.configuration.region.north_europe": "Ierlân",
	"realms.configuration.region.south_central_us": "Teksas, Feriene Steaten",
	"realms.configuration.region.southeast_asia": "Singapoer",
	"realms.configuration.region.sweden_central": "Sweden",
	"realms.configuration.region.uae_north": "Feriene Arabyske Emiraten",
	"realms.configuration.region.uk_south": "Súd-Ingelân",
	"realms.configuration.region.west_central_us": "Utah, Feriene Steaten",
	"realms.configuration.region.west_europe": "Nederlân",
	"realms.configuration.region.west_us": "Kalifornje, Feriene Steaten",
	"realms.configuration.region.west_us_2": "Washington, Feriene Steaten",
	...
	"recover_world.state_entry.unknown": "ûnbekend",
	...
	"selectWorld.experimental.message": "Wês foarsichtich!\nDizze konfiguraasje fereasket funksjes dy’t noch ûntwikkele wurde. Dyn wrâld kin ferûngelokje, kapot gean of net wurkje troch takomstige updates.",
	"selectWorld.experimental.title": "Warskôging: eksperimintele funksjes",
	"selectWorld.experiments": "Eksperiminten",
	"selectWorld.experiments.info": "Eksperiminten binne potinsjele nije funksjes. Wês foarsichtich, want der kinne dingen misgean. Eksperiminten kinne net útskeakele wurde nei it kreëarjen fan de wrâld.",
	...
	"selectWorld.gameMode.adventure.info": "Krekt as de oerlibbingsmodus, mar do kinst blokken net pleatse of fuortsmite.",
	...
	"selectWorld.gameMode.creative.info": "Meitsje, bou en ûntdek sûnder beheining. Do kinst fleane, hast in ûneinich tal materialen en do kinst net ferwûne reitsje troch meunsters.",
	...
	"selectWorld.gameMode.hardcore.info": "Krekt as de oerlibbingsmodus, mar fêstset op nivo ‘swier’. Do kinst net respawne wannear’tsto stjerst.",
	...
	"selectWorld.gameMode.spectator.info": "Do meist sjen, mar neat oanreitsje.",
	"selectWorld.gameMode.spectator.line1": "Do meist sjen, mar neat oanreitsje",
	"selectWorld.gameMode.survival": "Oerlibje",
	"selectWorld.gameMode.survival.info": "Untdek mysterieuze wrâlden dêr’tsto boust, sammelest, makkest en tsjin meunsters fjochtest.",
	...
	"selectWorld.mapFeatures.info": "Doarpen, skipswrakken en mear",
	...
	"selectWorld.targetFolder": "Wurdt bewarre yn: %s",
	"selectWorld.title": "Wrâld selektearje",
	"selectWorld.tooltip.fromNewerVersion1": "Wrâld is bewarre yn in nijere ferzje,",
	"selectWorld.tooltip.fromNewerVersion2": "dizze wrâld iepenje kin saken bringen!",
	...
	"structure_block.detect_size": "Grutte en posysje fan konstruksje detektearje:",
	...
	"structure_block.include_entities": "Entiteiten meirekkenje:",
	...
	"subtitles.block.amethyst_block.resonate": "Ametist resonearret",
	...
	"subtitles.block.decorated_pot.shatter": "Fersiere pot sneuvelet",
	...
	"subtitles.block.sign.waxed_interact_fail": "Boerd wibelet",
	"subtitles.block.smithing_table.use": "Smidstafel wurdt brûkt",
	"subtitles.block.smoker.smoke": "Smoker smookt",
	"subtitles.block.sniffer_egg.crack": "Sneupersaai brekt",
	"subtitles.block.sniffer_egg.hatch": "Sneupersaai komt út",
	"subtitles.block.sniffer_egg.plop": "Sneuper leit aai",
	"subtitles.block.sponge.absorb": "Spûns absorbearret",
	...
	"subtitles.entity.armadillo.death": "Gurdledier giet dea",
	"subtitles.entity.armadillo.eat": "Gurdledier yt",
	"subtitles.entity.armadillo.hurt": "Gurdledier rekket ferwûne",
	...
	"subtitles.entity.baby_cat.hurt": "Jongkat rekket ferwûne",
	"subtitles.entity.baby_cat.purr": "Kitten purrs",
	"subtitles.entity.baby_chicken.ambient": "Pykje pipet",
	"subtitles.entity.baby_chicken.death": "Pykje giet dea",
	"subtitles.entity.baby_chicken.hurts": "Pykje rekket ferwûne",
	...
	"subtitles.entity.baby_horse.death": "Fôle giet dea",
	"subtitles.entity.baby_horse.eat": "Fôle yt",
	"subtitles.entity.baby_horse.hurt": "Fôle rekket ferwûne",
	...
	"subtitles.entity.baby_nautilus.death": "Babynautilus giet dea",
	"subtitles.entity.baby_nautilus.death_land": "Babynautilus giet dea",
	"subtitles.entity.baby_nautilus.eat": "Babynautilus yt",
	"subtitles.entity.baby_nautilus.hurt": "Babynautilus rekket ferwûne",
	"subtitles.entity.baby_nautilus.hurt_land": "Babynautilus rekket ferwûne",
	"subtitles.entity.baby_nautilus.swim": "Babynautilus swimt",
	...
	"subtitles.entity.baby_wolf.hurt": "Wolfke rekket ferwûne",
	...
	"subtitles.entity.copper_golem.death": "Kopergolem giet dea",
	"subtitles.entity.copper_golem.hurt": "Kopergolem rekket ferwûne",
	...
	"subtitles.entity.copper_golem.spawn": "Kopergolem ferskynt",
	...
	"subtitles.entity.copper_golem_oxidized.death": "Kopergolem giet dea",
	"subtitles.entity.copper_golem_oxidized.hurt": "Kopergolem rekket ferwûne",
	"subtitles.entity.copper_golem_oxidized.spin": "Copper Golem's head spins",
	"subtitles.entity.copper_golem_weathered.death": "Kopergolem giet dea",
	"subtitles.entity.copper_golem_weathered.hurt": "Kopergolem rekket ferwûne",
	...
	"subtitles.entity.leash_knot.break": "Riemknoop brekt",
	...
	"subtitles.entity.mule.jump": "Mûlezel springt",
	...
	"subtitles.entity.nautilus.death": "Nautilus giet dea",
	"subtitles.entity.nautilus.death_land": "Nautilus giet dea",
	"subtitles.entity.nautilus.eat": "Nautilus yt",
	"subtitles.entity.nautilus.hurt": "Nautilus rekket ferwûne",
	"subtitles.entity.nautilus.hurt_land": "Nautilus rekket ferwûne",
	"subtitles.entity.nautilus.swim": "Nautilus swimt",
	...
	"subtitles.entity.polar_bear.ambient_baby": "Iisbearbaby brommet",
	...
	"subtitles.entity.sniffer.death": "Sneuper giet dea",
	"subtitles.entity.sniffer.digging": "Sneuper graaft",
	"subtitles.entity.sniffer.digging_stop": "Sneuper stiet op",
	"subtitles.entity.sniffer.drop_seed": "Sneuper lit sied falle",
	"subtitles.entity.sniffer.eat": "Sneuper yt",
	"subtitles.entity.sniffer.egg_crack": "Sneupersaai brekt",
	"subtitles.entity.sniffer.egg_hatch": "Sneupersaai komt út",
	"subtitles.entity.sniffer.happy": "Sneuper geniet",
	"subtitles.entity.sniffer.hurt": "Sneuper hat pine",
	"subtitles.entity.sniffer.idle": "Sneuper grommet",
	"subtitles.entity.sniffer.scenting": "Sneuper rûket",
	"subtitles.entity.sniffer.searching": "Sneuper siket",
	"subtitles.entity.sniffer.sniffing": "Sneuper rûkt",
	"subtitles.entity.sniffer.step": "Sneuper rint",
	...
	"subtitles.entity.zombie_horse.eat": "Sombyhynder yt",
	...
	"subtitles.entity.zombie_nautilus.death": "Sombynautilus giet dea",
	"subtitles.entity.zombie_nautilus.death_land": "Sombynautilus giet dea",
	"subtitles.entity.zombie_nautilus.eat": "Sombynautilus yt",
	"subtitles.entity.zombie_nautilus.hurt": "Sombynautilus rekket ferwûne",
	"subtitles.entity.zombie_nautilus.hurt_land": "Sombynautilus rekket ferwûne",
	"subtitles.entity.zombie_nautilus.swim": "Sombynautilus swimt",
	...
	"subtitles.item.brush.brushing.generic": "Boarstelje",
	"subtitles.item.brush.brushing.gravel": "Grint wurdt boarstele",
	"subtitles.item.brush.brushing.gravel.complete": "Grint fuortboarstele",
	"subtitles.item.brush.brushing.sand": "Sân wurdt boarstele",
	"subtitles.item.brush.brushing.sand.complete": "Sân fuortboarstele",
	...
	"subtitles.item.spear.attack": "Spear stekt",
	"subtitles.item.spear.hit": "Spear rekket",
	"subtitles.item.spear.lunge": "Spear lunges",
	"subtitles.item.spear.use": "Charges with Spear",
	"subtitles.item.spear_wood.attack": "Spear stekt",
	"subtitles.item.spear_wood.hit": "Spear rekket",
	...
	"symlink_warning.message": "Wrâlden út mappen lade mei symboalyske keppelingen kin ûnfeilich wêze asto net witst watsto dochst. Lês mear op %s.",
	"symlink_warning.message.pack": "Pakketten mei symboalyske keppelingen lade kin ûnfeilich wêze asto net witst watsto dochst. Lês mear op %s.",
	"symlink_warning.message.world": "Wrâlden út mappen lade mei symboalyske keppelingen kin ûnfeilich wêze asto net witst watsto dochst. Lês mear op %s.",
	"symlink_warning.more_info": "More Information",
	"symlink_warning.title": "Wrâldmap befettet symboalyske keppelingen",
	"symlink_warning.title.pack": "Tafoege pakket(ten) befetsje symboalyske keppelingen",
	"symlink_warning.title.world": "Wrâldmap befettet symboalyske keppelingen",
	...
	"telemetry.event.advancement_made.description": "Troch de kontekst by it boeken fan foarútgong te begripen, kinne wy de foarútgong fan it spul better begripe en ferbetterje.",
	"telemetry.event.advancement_made.title": "Foarútgong makke",
	"telemetry.event.game_load_times.description": "Dit barren helpt ús fêst te stellen wêr’t de ferbetterpunten lizze by it opstarten troch de útfiertiid fan opstartfasen te mjitten.",
	"telemetry.event.game_load_times.title": "Spullaadtiden",
	...
	"telemetry.property.advancement_game_time.title": "Spultiid (ticks)",
	"telemetry.property.advancement_id.title": "Foarútgongs-ID",
	...
	"telemetry.property.launcher_name.title": "Launchernamme",
	"telemetry.property.load_time_bootstrap_ms.title": "Bootstraptiid (millisekonden)",
	"telemetry.property.load_time_loading_overlay_ms.title": "Tiid yn laadskerm (millisekonden)",
	"telemetry.property.load_time_pre_window_ms.title": "Tiid oant iepenjen finster (millisekonden)",
	"telemetry.property.load_time_total_time_ms.title": "Totale laadtiid (millisekonden)",
	...
	"telemetry.property.realms_map_content.title": "Realmswrâldynhâld (namme minigame)",
	...
	"telemetry_info.button.privacy_statement": "Privacyferklearring",
	...
	"test_block.mode.accept": "Akseptearje",
	"test_block.mode.fail": "Mislearje",
	"test_block.mode.log": "Log",
	"test_block.mode.start": "Starte",
	...
	"test_instance.description.failed": "Mislearre: %s",
	"test_instance.description.function": "Funksje: %s",
	...
	"test_instance_block.invalid": "[ûnjildich]",
	"test_instance_block.reset_success": "Reset succeeded for test: %s",
	"test_instance_block.rotation": "Rotaasje:",
	...
	"title.credits": "© Mojang AB. Alle rjochten foarbehâlden!",
	"title.multiplayer.disabled": "Multi-player is útskeakele. Kontrolearje dyn Microsoft-accountynstellingen.",
	"title.multiplayer.disabled.banned.name": "Do moatst dyn namme wizigje eardatsto online spylje kinst",
	...
	"trim_material.minecraft.amethyst": "Ametistmateriaal",
	...
	"trim_material.minecraft.iron": "Izermateriaal",
	"trim_material.minecraft.lapis": "Lapislazulimateriaal",
	"trim_material.minecraft.netherite": "Netheryt-materiaal",
	...
	"trim_pattern.minecraft.coast": "Kustharnasfersiering",
	"trim_pattern.minecraft.dune": "Dúnharnasfersiering",
	"trim_pattern.minecraft.eye": "Eachharnasfersiering",
	"trim_pattern.minecraft.flow": "Flow Armor Trim",
	"trim_pattern.minecraft.host": "Harnasfersiering ‘gasthear’",
	"trim_pattern.minecraft.raiser": "Harnasfersiering ‘fokker’",
	"trim_pattern.minecraft.rib": "Ribharnasfersiering",
	"trim_pattern.minecraft.sentry": "Skyldwachtharnasfersiering",
	"trim_pattern.minecraft.shaper": "Harnasfersiering ‘foarmer’",
	"trim_pattern.minecraft.silence": "Harnasfersiering ‘stilte’",
	"trim_pattern.minecraft.snout": "Snútharnasfersiering",
	"trim_pattern.minecraft.spire": "Pykharnasversiering",
	"trim_pattern.minecraft.tide": "Tijharnasfersiering",
	"trim_pattern.minecraft.vex": "Ergernisharnasfersiering",
	"trim_pattern.minecraft.ward": "Hoederharnasfersiering",
	"trim_pattern.minecraft.wayfinder": "Harnasfersiering ‘paadfiner’",
	"trim_pattern.minecraft.wild": "Ferwyldere harnasfersiering",
	...
	"upgrade.minecraft.netherite_upgrade": "Netheryt-fernijing",
