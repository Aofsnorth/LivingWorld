// Code generated by tools/gen_lang.go from 26.1/ko_kr.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"accessibility.onboarding.accessibility.button.narration": "접근성 설정",
	...
	"advMode.notEnabled": "명령 블록을 사용할 수 없습니다",
	"advMode.notEnabled.spawner": "생성기 블록 사용이 제한되어 있습니다",
	"advMode.previousOutput": "이전 출력",
	"advMode.setCommand": "블록에 콘솔 명령어 설정",
	"advMode.setCommand.disabled": "명령어 설정: %s, 하지만 명령 블록은 여전히 꺼져 있습니다",
	...
	"advancements.adventure.heart_transplanter.description": "창백한 참나무 원목 두 개 사이에 크리킹 심장을 올바른 방향으로 설치하세요",
	"advancements.adventure.heart_transplanter.title": "심장 이식 수술",
	...
	"advancements.adventure.overoverkill.description": "철퇴를 휘둘러 한 번에 하트 50개만큼 피해를 입히세요",
	...
	"advancements.adventure.spear_many_mobs.description": "창으로 한 번 돌격해 몹 다섯 마리를 맞히세요",
	"advancements.adventure.spear_many_mobs.title": "몹 꼬치",
	...
	"advancements.adventure.use_lodestone.description": "자석석에 나침반을 사용하세요",
	"advancements.adventure.use_lodestone.title": "집으로 이끌려가네",
	...
	"advancements.end.dragon_egg.description": "드래곤 알을 손에 넣으세요",
	...
	"advancements.husbandry.feed_snifflet.description": "새끼 스니퍼에게 먹이를 주세요",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "마른 가스트 블록을 물속에 설치하세요",
	"advancements.husbandry.place_dried_ghast_in_water.title": "수분 충전!",
	...
	"advancements.husbandry.repair_wolf_armor.description": "아르마딜로 인갑을 사용해 손상된 늑대 갑옷을 완전히 수리하세요",
	...
	"advancements.husbandry.silk_touch_nest.description": "벌 세 마리가 들어 있는 벌집이나 벌통을 섬세한 손길을 사용해 옮기세요",
	...
	"advancements.husbandry.uh_oh.description": "유황 큐브가 TNT 블록을 흡수하게 하세요",
	"advancements.husbandry.uh_oh.title": "폭탄 받아라",
	...
	"argument.entity.selector.nearestEntity": "가장 가까운 개체",
	...
	"argument.hexcolor.invalid": "'%s'은(는) 잘못된 십육진 색 부호입니다",
	...
	"argument.item.tag.disallowed": "여기선 태그 대신 실제 아이템만 허용됩니다",
	...
	"argument.message.too_long": "대화 메시지가 너무 깁니다 (%s > 최대 %s글자)",
	"argument.nbt.array.invalid": "'%s'은(는) 잘못된 배열 유형입니다",
	"argument.nbt.array.mixed": "%s을(를) %s에 넣을 수 없습니다",
	"argument.nbt.expected.compound": "복합 태그가 필요합니다",
	...
	"argument.resource_or_id.failed_to_parse": "구조물 해석에 실패했습니다: %s",
	"argument.resource_or_id.invalid": "잘못된 ID 또는 태그입니다",
	"argument.resource_or_id.no_such_element": "'%s' 요소를 레지스트리 '%s'에서 찾을 수 없습니다",
	"argument.resource_selector.not_found": "'%[2]s' 유형의 '%[1]s' 선택자와 일치하는 항목이 없습니다",
	...
	"argument.waypoint.invalid": "선택한 개체는 경로점이 아닙니다",
	...
	"arguments.item.component.expected": "아이템 구성 요소가 필요합니다",
	"arguments.item.component.malformed": "'%s' 구성 요소가 잘못되었습니다: '%s'",
	"arguments.item.component.repeated": "한 개만 지정할 수 있는 아이템 구성 요소 '%s'가 반복되었습니다",
	"arguments.item.component.unknown": "'%s'은(는) 알 수 없는 아이템 구성 요소입니다",
	"arguments.item.malformed": "아이템이 잘못되었습니다: '%s'",
	"arguments.item.overstacked": "%s은(는) %s개까지만 포갤 수 있습니다",
	"arguments.item.predicate.malformed": "'%s' 술어가 잘못되었습니다: '%s'",
	"arguments.item.predicate.unknown": "알 수 없는 아이템 술어입니다: '%s'",
	...
	"attribute.name.air_drag_modifier": "공기 저항력 변경자",
	"attribute.name.armor": "방어",
	"attribute.name.armor_toughness": "방어 강도",
	"attribute.name.attack_damage": "공격 피해",
	"attribute.name.attack_knockback": "공격 밀침 세기",
	"attribute.name.attack_speed": "공격 속도",
	"attribute.name.below_name_distance": "이름표 점수 거리",
	"attribute.name.block_break_speed": "블록 파괴 속도",
	"attribute.name.block_interaction_range": "블록 상호 작용 범위",
	"attribute.name.bounciness": "탄성력",
	"attribute.name.burning_time": "연소 시간",
	"attribute.name.camera_distance": "카메라 거리",
	"attribute.name.entity_interaction_range": "개체 상호 작용 범위",
	"attribute.name.explosion_knockback_resistance": "폭발 밀침 저항",
	"attribute.name.fall_damage_multiplier": "낙하 피해 배수",
	"attribute.name.flying_speed": "비행 속도",
	"attribute.name.follow_range": "몹 따름 범위",
	"attribute.name.friction_modifier": "마찰력 변경자",
	...
	"attribute.name.generic.block_interaction_range": "블록 상호 작용 범위",
	"attribute.name.generic.burning_time": "연소 시간",
	"attribute.name.generic.entity_interaction_range": "개체 상호 작용 범위",
	"attribute.name.generic.explosion_knockback_resistance": "폭발 밀침 저항",
	"attribute.name.generic.fall_damage_multiplier": "낙하 피해 배수",
	"attribute.name.generic.flying_speed": "비행 속도",
	"attribute.name.generic.follow_range": "몹 따름 범위",
	"attribute.name.generic.gravity": "중력",
	"attribute.name.generic.jump_strength": "점프 세기",
	"attribute.name.generic.knockback_resistance": "밀침 저항",
	"attribute.name.generic.luck": "행운",
	"attribute.name.generic.max_absorption": "최대 흡수",
	"attribute.name.generic.max_health": "최대 생명력",
	"attribute.name.generic.movement_efficiency": "이동 효율",
	"attribute.name.generic.movement_speed": "속도",
	"attribute.name.generic.oxygen_bonus": "산소 추가",
	"attribute.name.generic.safe_fall_distance": "안전 낙하 거리",
	"attribute.name.generic.scale": "배율",
	"attribute.name.generic.step_height": "걸음 높이",
	"attribute.name.generic.water_movement_efficiency": "수중 이동 효율",
	"attribute.name.gravity": "중력",
	"attribute.name.horse.jump_strength": "말 점프 강도",
	"attribute.name.jump_strength": "점프 세기",
	"attribute.name.knockback_resistance": "밀침 저항",
	"attribute.name.luck": "행운",
	"attribute.name.max_absorption": "최대 흡수",
	"attribute.name.max_health": "최대 생명력",
	"attribute.name.mining_efficiency": "채굴 효율",
	"attribute.name.movement_efficiency": "이동 효율",
	"attribute.name.movement_speed": "속도",
	"attribute.name.nameplate_distance": "이름표 거리",
	"attribute.name.oxygen_bonus": "산소 추가",
	"attribute.name.player.block_break_speed": "블록 파괴 속도",
	"attribute.name.player.block_interaction_range": "블록 상호 작용 범위",
	"attribute.name.player.entity_interaction_range": "개체 상호 작용 범위",
	"attribute.name.player.mining_efficiency": "채굴 효율",
	"attribute.name.player.sneaking_speed": "웅크렸을 때 속도",
	"attribute.name.player.submerged_mining_speed": "수중 채굴 속도",
	"attribute.name.player.sweeping_damage_ratio": "휩쓸기 피해 비율",
	"attribute.name.safe_fall_distance": "안전 낙하 거리",
	"attribute.name.scale": "크기",
	"attribute.name.sneaking_speed": "웅크렸을 때 속도",
	"attribute.name.spawn_reinforcements": "좀비 증원",
	"attribute.name.step_height": "걸음 높이",
	"attribute.name.submerged_mining_speed": "수중 채굴 속도",
	"attribute.name.sweeping_damage_ratio": "휩쓸기 피해 비율",
	"attribute.name.tempt_range": "몹 유인 범위",
	"attribute.name.water_movement_efficiency": "수중 이동 효율",
	"attribute.name.waypoint_receive_range": "경로점 수신 범위",
	"attribute.name.waypoint_transmit_range": "경로점 발신 범위",
	...
	"biome.minecraft.pale_garden": "창백한 정원",
	...
	"biome.minecraft.sulfur_caves": "유황 동굴",
	...
	"block.minecraft.acacia_shelf": "아카시아나무 선반",
	...
	"block.minecraft.bamboo_shelf": "대나무 선반",
	...
	"block.minecraft.banner.flow.black": "검은색 흐름",
	"block.minecraft.banner.flow.blue": "파란색 흐름",
	"block.minecraft.banner.flow.brown": "갈색 흐름",
	"block.minecraft.banner.flow.cyan": "청록색 흐름",
	"block.minecraft.banner.flow.gray": "회색 흐름",
	"block.minecraft.banner.flow.green": "초록색 흐름",
	"block.minecraft.banner.flow.light_blue": "하늘색 흐름",
	"block.minecraft.banner.flow.light_gray": "회백색 흐름",
	"block.minecraft.banner.flow.lime": "연두색 흐름",
	"block.minecraft.banner.flow.magenta": "자홍색 흐름",
	"block.minecraft.banner.flow.orange": "주황색 흐름",
	"block.minecraft.banner.flow.pink": "분홍색 흐름",
	"block.minecraft.banner.flow.purple": "보라색 흐름",
	"block.minecraft.banner.flow.red": "빨간색 흐름",
	"block.minecraft.banner.flow.white": "하얀색 흐름",
	"block.minecraft.banner.flow.yellow": "노란색 흐름",
	...
	"block.minecraft.banner.guster.black": "검은색 소용돌이",
	"block.minecraft.banner.guster.blue": "파란색 소용돌이",
	"block.minecraft.banner.guster.brown": "갈색 소용돌이",
	"block.minecraft.banner.guster.cyan": "청록색 소용돌이",
	"block.minecraft.banner.guster.gray": "회색 소용돌이",
	"block.minecraft.banner.guster.green": "초록색 소용돌이",
	"block.minecraft.banner.guster.light_blue": "하늘색 소용돌이",
	"block.minecraft.banner.guster.light_gray": "회백색 소용돌이",
	"block.minecraft.banner.guster.lime": "연두색 소용돌이",
	"block.minecraft.banner.guster.magenta": "자홍색 소용돌이",
	"block.minecraft.banner.guster.orange": "주황색 소용돌이",
	"block.minecraft.banner.guster.pink": "분홍색 소용돌이",
	"block.minecraft.banner.guster.purple": "보라색 소용돌이",
	"block.minecraft.banner.guster.red": "빨간색 소용돌이",
	"block.minecraft.banner.guster.white": "하얀색 소용돌이",
	"block.minecraft.banner.guster.yellow": "노란색 소용돌이",
	...
	"block.minecraft.birch_shelf": "자작나무 선반",
	...
	"block.minecraft.bush": "덤불",
	"block.minecraft.cactus": "선인장",
	"block.minecraft.cactus_flower": "선인장 꽃",
	...
	"block.minecraft.cherry_shelf": "벚나무 선반",
	...
	"block.minecraft.chiseled_cinnabar": "조각된 진사",
	...
	"block.minecraft.cinnabar": "진사",
	"block.minecraft.cinnabar_brick_slab": "진사 벽돌 반 블록",
	"block.minecraft.cinnabar_brick_stairs": "진사 벽돌 계단",
	"block.minecraft.cinnabar_brick_wall": "진사 벽돌 담장",
	"block.minecraft.cinnabar_bricks": "진사 벽돌",
	"block.minecraft.cinnabar_slab": "진사 반 블록",
	"block.minecraft.cinnabar_stairs": "진사 계단",
	"block.minecraft.cinnabar_wall": "진사 담장",
	"block.minecraft.clay": "점토",
	"block.minecraft.closed_eyeblossom": "감은 눈망울꽃",
	...
	"block.minecraft.copper_bars": "구리 창살",
	"block.minecraft.copper_block": "구리 블록",
	"block.minecraft.copper_bulb": "구리 전구",
	"block.minecraft.copper_chain": "구리 사슬",
	"block.minecraft.copper_chest": "구리 상자",
	"block.minecraft.copper_door": "구리 문",
	"block.minecraft.copper_golem_statue": "구리 골렘 동상",
	"block.minecraft.copper_grate": "구리 격자",
	"block.minecraft.copper_lantern": "구리 랜턴",
	"block.minecraft.copper_ore": "구리 광석",
	"block.minecraft.copper_torch": "구리 횃불",
	"block.minecraft.copper_trapdoor": "구리 다락문",
	"block.minecraft.copper_wall_torch": "구리 벽 횃불",
	...
	"block.minecraft.creaking_heart": "크리킹 심장",
	...
	"block.minecraft.crimson_shelf": "진홍빛 선반",
	...
	"block.minecraft.dark_oak_shelf": "짙은 참나무 선반",
	...
	"block.minecraft.dried_ghast": "마른 가스트",
	...
	"block.minecraft.exposed_copper_bars": "약간 녹슨 구리 창살",
	"block.minecraft.exposed_copper_bulb": "약간 녹슨 구리 전구",
	"block.minecraft.exposed_copper_chain": "약간 녹슨 구리 사슬",
	"block.minecraft.exposed_copper_chest": "약간 녹슨 구리 상자",
	"block.minecraft.exposed_copper_door": "약간 녹슨 구리 문",
	"block.minecraft.exposed_copper_golem_statue": "약간 녹슨 구리 골렘 동상",
	"block.minecraft.exposed_copper_grate": "약간 녹슨 구리 격자",
	"block.minecraft.exposed_copper_lantern": "약간 녹슨 구리 랜턴",
	...
	"block.minecraft.exposed_lightning_rod": "약간 녹슨 피뢰침",
	...
	"block.minecraft.firefly_bush": "반딧불이 덤불",
	...
	"block.minecraft.golden_dandelion": "황금 민들레",
	...
	"block.minecraft.heavy_core": "무거운 코어",
	...
	"block.minecraft.iron_bars": "철 창살",
	"block.minecraft.iron_block": "철 블록",
	"block.minecraft.iron_chain": "철 사슬",
	...
	"block.minecraft.jungle_shelf": "정글나무 선반",
	...
	"block.minecraft.leaf_litter": "낙엽",
	...
	"block.minecraft.mangrove_shelf": "맹그로브나무 선반",
	...
	"block.minecraft.oak_shelf": "참나무 선반",
	...
	"block.minecraft.open_eyeblossom": "뜬 눈망울꽃",
	...
	"block.minecraft.oxidized_copper_bars": "산화된 구리 창살",
	"block.minecraft.oxidized_copper_bulb": "산화된 구리 전구",
	"block.minecraft.oxidized_copper_chain": "산화된 구리 사슬",
	"block.minecraft.oxidized_copper_chest": "산화된 구리 상자",
	"block.minecraft.oxidized_copper_door": "산화된 구리 문",
	"block.minecraft.oxidized_copper_golem_statue": "산화된 구리 골렘 동상",
	"block.minecraft.oxidized_copper_grate": "산화된 구리 격자",
	"block.minecraft.oxidized_copper_lantern": "산화된 구리 랜턴",
	...
	"block.minecraft.oxidized_lightning_rod": "산화된 피뢰침",
	"block.minecraft.packed_ice": "꽁꽁 언 얼음",
	"block.minecraft.packed_mud": "단단한 진흙",
	"block.minecraft.pale_hanging_moss": "창백한 매달린 이끼",
	"block.minecraft.pale_moss_block": "창백한 이끼 블록",
	"block.minecraft.pale_moss_carpet": "창백한 이끼 바닥",
	"block.minecraft.pale_oak_button": "창백한 참나무 버튼",
	"block.minecraft.pale_oak_door": "창백한 참나무 문",
	"block.minecraft.pale_oak_fence": "창백한 참나무 울타리",
	"block.minecraft.pale_oak_fence_gate": "창백한 참나무 울타리 문",
	"block.minecraft.pale_oak_hanging_sign": "창백한 참나무 매다는 표지판",
	"block.minecraft.pale_oak_leaves": "창백한 참나무 잎",
	"block.minecraft.pale_oak_log": "창백한 참나무 원목",
	"block.minecraft.pale_oak_planks": "창백한 참나무 판자",
	"block.minecraft.pale_oak_pressure_plate": "창백한 참나무 압력판",
	"block.minecraft.pale_oak_sapling": "창백한 참나무 묘목",
	"block.minecraft.pale_oak_shelf": "창백한 참나무 선반",
	"block.minecraft.pale_oak_sign": "창백한 참나무 표지판",
	"block.minecraft.pale_oak_slab": "창백한 참나무 반 블록",
	"block.minecraft.pale_oak_stairs": "창백한 참나무 계단",
	"block.minecraft.pale_oak_trapdoor": "창백한 참나무 다락문",
	"block.minecraft.pale_oak_wall_hanging_sign": "창백한 참나무 벽 매다는 표지판",
	"block.minecraft.pale_oak_wall_sign": "창백한 참나무 벽 표지판",
	"block.minecraft.pale_oak_wood": "창백한 참나무",
	...
	"block.minecraft.piston_head": "피스톤 머리",
	...
	"block.minecraft.polished_cinnabar": "윤나는 진사",
	"block.minecraft.polished_cinnabar_slab": "윤나는 진사 반 블록",
	"block.minecraft.polished_cinnabar_stairs": "윤나는 진사 계단",
	"block.minecraft.polished_cinnabar_wall": "윤나는 진사 담장",
	...
	"block.minecraft.polished_sulfur": "윤나는 유황",
	"block.minecraft.polished_sulfur_slab": "윤나는 유황 반 블록",
	"block.minecraft.polished_sulfur_stairs": "윤나는 유황 계단",
	"block.minecraft.polished_sulfur_wall": "윤나는 유황 담장",
	...
	"block.minecraft.potent_sulfur": "독한 유황",
	"block.minecraft.potted_acacia_sapling": "화분에 심은 아카시아나무 묘목",
	"block.minecraft.potted_allium": "화분에 심은 알리움",
	...
	"block.minecraft.potted_closed_eyeblossom": "화분에 심은 감은 눈망울꽃",
	...
	"block.minecraft.potted_golden_dandelion": "화분에 심은 황금 민들레",
	...
	"block.minecraft.potted_open_eyeblossom": "화분에 심은 뜬 눈망울꽃",
	"block.minecraft.potted_orange_tulip": "화분에 심은 주황색 튤립",
	"block.minecraft.potted_oxeye_daisy": "화분에 심은 데이지",
	"block.minecraft.potted_pale_oak_sapling": "화분에 심은 창백한 참나무 묘목",
	...
	"block.minecraft.resin_block": "수지 블록",
	"block.minecraft.resin_brick_slab": "수지 벽돌 반 블록",
	"block.minecraft.resin_brick_stairs": "수지 벽돌 계단",
	"block.minecraft.resin_brick_wall": "수지 벽돌 담장",
	"block.minecraft.resin_bricks": "수지 벽돌",
	"block.minecraft.resin_clump": "수지 덩어리",
	...
	"block.minecraft.short_dry_grass": "키 작은 마른 잔디",
	...
	"block.minecraft.spruce_shelf": "가문비나무 선반",
	...
	"block.minecraft.stripped_pale_oak_log": "껍질 벗긴 창백한 참나무 원목",
	"block.minecraft.stripped_pale_oak_wood": "껍질 벗긴 창백한 참나무",
	...
	"block.minecraft.sulfur": "유황",
	"block.minecraft.sulfur_brick_slab": "유황 벽돌 반 블록",
	"block.minecraft.sulfur_brick_stairs": "유황 벽돌 계단",
	"block.minecraft.sulfur_brick_wall": "유황 벽돌 담장",
	"block.minecraft.sulfur_bricks": "유황 벽돌",
	"block.minecraft.sulfur_slab": "유황 반 블록",
	"block.minecraft.sulfur_spike": "유황 가시",
	"block.minecraft.sulfur_stairs": "유황 계단",
	"block.minecraft.sulfur_wall": "유황 담장",
	...
	"block.minecraft.tall_dry_grass": "키 큰 마른 잔디",
	...
	"block.minecraft.test_block": "테스트 블록",
	"block.minecraft.test_instance_block": "테스트 인스턴스 블록",
	"block.minecraft.tinted_glass": "차광 유리",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "TNT 폭발이 꺼져 있습니다",
	...
	"block.minecraft.warped_shelf": "뒤틀린 선반",
	...
	"block.minecraft.waxed_copper_bars": "밀랍칠한 구리 창살",
	"block.minecraft.waxed_copper_block": "밀랍칠한 구리 블록",
	"block.minecraft.waxed_copper_bulb": "밀랍칠한 구리 전구",
	"block.minecraft.waxed_copper_chain": "밀랍칠한 구리 사슬",
	"block.minecraft.waxed_copper_chest": "밀랍칠한 구리 상자",
	"block.minecraft.waxed_copper_door": "밀랍칠한 구리 문",
	"block.minecraft.waxed_copper_golem_statue": "밀랍칠한 구리 골렘 동상",
	"block.minecraft.waxed_copper_grate": "밀랍칠한 구리 격자",
	"block.minecraft.waxed_copper_lantern": "밀랍칠한 구리 랜턴",
	...
	"block.minecraft.waxed_exposed_copper_bars": "밀랍칠한 약간 녹슨 구리 창살",
	"block.minecraft.waxed_exposed_copper_bulb": "밀랍칠한 약간 녹슨 구리 전구",
	"block.minecraft.waxed_exposed_copper_chain": "밀랍칠한 약간 녹슨 구리 사슬",
	"block.minecraft.waxed_exposed_copper_chest": "밀랍칠한 약간 녹슨 구리 상자",
	"block.minecraft.waxed_exposed_copper_door": "밀랍칠한 약간 녹슨 구리 문",
	"block.minecraft.waxed_exposed_copper_golem_statue": "밀랍칠한 약간 녹슨 구리 골렘 동상",
	"block.minecraft.waxed_exposed_copper_grate": "밀랍칠한 약간 녹슨 구리 격자",
	"block.minecraft.waxed_exposed_copper_lantern": "밀랍칠한 약간 녹슨 구리 랜턴",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "밀랍칠한 약간 녹슨 피뢰침",
	"block.minecraft.waxed_lightning_rod": "밀랍칠한 피뢰침",
	"block.minecraft.waxed_oxidized_chiseled_copper": "밀랍칠한 산화된 조각된 구리",
	"block.minecraft.waxed_oxidized_copper": "밀랍칠한 산화된 구리",
	"block.minecraft.waxed_oxidized_copper_bars": "밀랍칠한 산화된 구리 창살",
	"block.minecraft.waxed_oxidized_copper_bulb": "밀랍칠한 산화된 구리 전구",
	"block.minecraft.waxed_oxidized_copper_chain": "밀랍칠한 산화된 구리 사슬",
	"block.minecraft.waxed_oxidized_copper_chest": "밀랍칠한 산화된 구리 상자",
	"block.minecraft.waxed_oxidized_copper_door": "밀랍칠한 산화된 구리 문",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "밀랍칠한 산화된 구리 골렘 동상",
	"block.minecraft.waxed_oxidized_copper_grate": "밀랍칠한 산화된 구리 격자",
	"block.minecraft.waxed_oxidized_copper_lantern": "밀랍칠한 산화된 구리 랜턴",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "밀랍칠한 산화된 피뢰침",
	"block.minecraft.waxed_weathered_chiseled_copper": "밀랍칠한 녹슨 조각된 구리",
	"block.minecraft.waxed_weathered_copper": "밀랍칠한 녹슨 구리",
	"block.minecraft.waxed_weathered_copper_bars": "밀랍칠한 녹슨 구리 창살",
	"block.minecraft.waxed_weathered_copper_bulb": "밀랍칠한 녹슨 구리 전구",
	"block.minecraft.waxed_weathered_copper_chain": "밀랍칠한 녹슨 구리 사슬",
	"block.minecraft.waxed_weathered_copper_chest": "밀랍칠한 녹슨 구리 상자",
	"block.minecraft.waxed_weathered_copper_door": "밀랍칠한 녹슨 구리 문",
	"block.minecraft.waxed_weathered_copper_golem_statue": "밀랍칠한 녹슨 구리 골렘 동상",
	"block.minecraft.waxed_weathered_copper_grate": "밀랍칠한 녹슨 구리 격자",
	"block.minecraft.waxed_weathered_copper_lantern": "밀랍칠한 녹슨 구리 랜턴",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "밀랍칠한 녹슨 피뢰침",
	"block.minecraft.weathered_chiseled_copper": "녹슨 조각된 구리",
	"block.minecraft.weathered_copper": "녹슨 구리",
	"block.minecraft.weathered_copper_bars": "녹슨 구리 창살",
	"block.minecraft.weathered_copper_bulb": "녹슨 구리 전구",
	"block.minecraft.weathered_copper_chain": "녹슨 구리 사슬",
	"block.minecraft.weathered_copper_chest": "녹슨 구리 상자",
	"block.minecraft.weathered_copper_door": "녹슨 구리 문",
	"block.minecraft.weathered_copper_golem_statue": "녹슨 구리 골렘 동상",
	"block.minecraft.weathered_copper_grate": "녹슨 구리 격자",
	"block.minecraft.weathered_copper_lantern": "녹슨 구리 랜턴",
	...
	"block.minecraft.weathered_lightning_rod": "녹슨 피뢰침",
	...
	"block.minecraft.wildflowers": "들꽃",
	...
	"book.page_button.next": "다음 페이지",
	"book.page_button.previous": "이전 페이지",
	"book.sign.title": "책 서명 화면",
	"book.sign.titlebox": "제목",
	"book.signButton": "서명하기",
	"book.view.title": "책 보기 화면",
	"build.spawn_protection": "%s은(는) 생성 영역으로 보호받고 있습니다",
	"build.tooHigh": "건축 높이 제한은 %s입니다",
	"build.tooLow": "건축 최소 높이는 %s입니다",
	...
	"chat.disabled.invalid_command_signature": "명령어에 예기치 않았거나 누락된 명령어 인수 서명이 있습니다.",
	"chat.disabled.invalid_signature": "대화의 서명이 잘못되었습니다. 다시 접속해 보세요.",
	...
	"chat.disabled.out_of_order_chat": "수신한 대화의 순서가 잘못되었습니다. 시스템 시간이 변경되었나요?",
	...
	"chat.queue": "[+%s줄 대기 중]",
	"chat.queue.tooltip": "다음 메시지를 표시하려면 클릭",
	...
	"chat_restriction.chat_and_commands_disabled_by_options": "클라이언트 설정에서 대화가 제한되어 있습니다.",
	"chat_restriction.chat_disabled_by_options": "클라이언트 설정에서 플레이어 대화가 제한되어 있습니다.",
	"chat_restriction.chat_disabled_by_options.action": "대화 설정 화면으로 이동하기",
	"chat_restriction.disabled_by_launcher": "런처에서 대화가 제한되어 있습니다",
	"chat_restriction.disabled_by_profile": "프로필 설정에서 대화가 제한되어 있습니다.",
	"chat_restriction.disabled_by_profile.action": "프로필 설정으로 이동하기",
	"chat_screen.commands_not_allowed": "명령어 전송이 금지되어 있습니다",
	"chat_screen.message": "전송하려는 메시지: %s",
	"chat_screen.messages_not_allowed": "대화 메시지 전송이 금지되어 있습니다",
	"chat_screen.restricted": "대화가 제한되어 있습니다. 더 자세한 정보를 확인하려면 이 메시지를 클릭하세요.",
	"chat_screen.restricted.narration": "대화가 제한되어 있습니다. 세계 설정의 제한 화면을 확인하세요.",
	"chat_screen.title": "대화 화면",
	"chat_screen.usage": "메시지를 입력하고 Enter를 눌러 전송하세요",
	"chunk.toast.checkLog": "로그에서 더 자세한 정보를 확인하세요",
	"chunk.toast.loadFailure": "%s에 있는 청크를 불러오는 데 실패했습니다",
	"chunk.toast.lowDiskSpace": "디스크 공간 적음!",
	"chunk.toast.lowDiskSpace.description": "세계를 저장하지 못할 수 있습니다.",
	"chunk.toast.saveFailure": "%s에 있는 청크를 저장하는 데 실패했습니다",
	...
	"command.failed": "명령어를 실행하려고 시도하는 중 예상치 못한 오류가 발생했습니다",
	"command.forkLimit": "맥락의 최대 개수(%s)에 도달했습니다",
	"command.trailing_data": "후행 데이터가 있습니다: %s",
	...
	"commands.attribute.base_value.reset.success": "%[2]s 개체의 %[1]s 특성 기초 값을 기본값 %[3]s(으)로 초기화했습니다",
	...
	"commands.attribute.modifier.value.get.success": "%[3]s 개체의 %[2]s 특성의 %[1]s 변경자 값은 %[4]s입니다",
	...
	"commands.data.block.get": "블록 %[2]s, %[3]s, %[4]s의 %[1]s에 배율 %[5]s을(를) 곱하면 %[6]s입니다",
	...
	"commands.data.entity.get": "%[2]s의 %[1]s에 배율 %[3]s을(를) 곱하면 %[4]s입니다",
	...
	"commands.data.storage.get": "%[2]s 저장소의 %[1]s에 배율 %[3]s을(를) 곱하면 %[4]s입니다",
	"commands.data.storage.modified": "%s 저장소를 수정했습니다",
	"commands.data.storage.query": "%s 저장소의 내용은 다음과 같습니다: %s",
	"commands.datapack.create.already_exists": "이름이 '%s'인 팩이 이미 존재합니다",
	"commands.datapack.create.invalid_full_name": "새로운 팩 이름 '%s'(이)가 잘못되었습니다",
	"commands.datapack.create.invalid_name": "새로운 팩 이름 '%s'에 잘못된 문자가 있습니다",
	"commands.datapack.create.io_failure": "이름이 '%s'인 팩을 만들 수 없습니다. 로그를 확인하세요",
	"commands.datapack.create.metadata_encode_failure": "이름이 '%s'인 팩의 메타데이터 인코딩에 실패했습니다: %s",
	"commands.datapack.create.success": "이름이 '%s'인 비어 있는 팩을 생성했습니다",
	...
	"commands.debug.stopped": "%s초 및 %s틱 동안 실행되던 틱 프로파일링을 중지했습니다 (초당 %s틱)",
	...
	"commands.dialog.clear.multiple": "플레이어 %s명에게 표시되는 대화 상자를 제거했습니다",
	"commands.dialog.clear.single": "%s에게 표시되는 대화 상자를 제거했습니다",
	"commands.dialog.show.multiple": "플레이어 %s명에게 대화 상자를 표시했습니다",
	"commands.dialog.show.single": "%s에게 대화 상자를 표시했습니다",
	...
	"commands.execute.conditional.fail_count": "테스트에 실패했습니다. 개수: %s",
	"commands.execute.conditional.pass": "테스트가 통과했습니다",
	"commands.execute.conditional.pass_count": "테스트에 통과했습니다. 개수: %s",
	...
	"commands.fetchprofile.copy_component": "구성 요소 복사하기",
	"commands.fetchprofile.copy_text": "%s 복사",
	"commands.fetchprofile.entity.success": "%s 개체의 프로필을 확인했습니다: %s",
	"commands.fetchprofile.failed_to_serialize": "프로필을 직렬화하는 데 실패했습니다: %s",
	"commands.fetchprofile.give_item": "아이템 주기",
	"commands.fetchprofile.id.failure": "ID %s의 프로필을 확인하는 데 실패했습니다",
	"commands.fetchprofile.id.success": "ID %s의 프로필을 확인했습니다: %s",
	"commands.fetchprofile.name.failure": "이름 %s의 프로필을 확인하는 데 실패했습니다",
	"commands.fetchprofile.name.success": "이름 %s의 프로필을 확인했습니다: %s",
	"commands.fetchprofile.no_profile": "%s 개체는 프로필이 없습니다",
	"commands.fetchprofile.summon_mannequin": "마네킹 소환하기",
	...
	"commands.profile_fetch.copy_component": "구성 요소 복사하기",
	"commands.profile_fetch.failed_to_serialize": "프로필을 직렬화하는 데 실패했습니다: %s",
	"commands.profile_fetch.give_item": "아이템 주기",
	"commands.profile_fetch.id.failure": "ID %s의 프로필을 확인하는 데 실패했습니다",
	"commands.profile_fetch.id.success": "ID %s의 프로필을 확인했습니다: %s",
	"commands.profile_fetch.name.failure": "이름 %s의 프로필을 확인하는 데 실패했습니다",
	"commands.profile_fetch.name.success": "이름 %s의 프로필을 확인했습니다: %s",
	"commands.publish.alreadyPublished": "멀티플레이 게임이 이미 %s번 포트에서 호스트되고 있습니다",
	"commands.publish.alreadyPublished.lan": "로컬 게임이 이미 %s번 포트에서 호스트되고 있습니다",
	"commands.publish.alreadyPublished.online": "온라인 게임이 이미 호스트되고 있습니다",
	"commands.publish.failed": "로컬 게임을 호스트할 수 없습니다",
	"commands.publish.started": "로컬 게임을 %s번 포트에서 호스트합니다",
	"commands.publish.started.lan": "로컬 게임을 %s번 포트에서 호스트합니다",
	"commands.publish.started.online": "온라인 게임을 호스트합니다",
	...
	"commands.random.reset.all.success": "난수 수열 %s개를 초기화했습니다",
	...
	"commands.setworldspawn.success.new": "세계 스폰 지점을 %[6]s의 %[1]s, %[2]s, %[3]s [%[4]s, %[5]s](으)로 설정했습니다",
	"commands.spawnpoint.success.multiple": "플레이어 %[6]s명의 스폰 지점을 %[5]s의 %[1]s, %[2]s, %[3]s [%[4]s](으)로 설정했습니다",
	"commands.spawnpoint.success.multiple.new": "플레이어 %[7]s명의 스폰 지점을 %[6]s의 %[1]s, %[2]s, %[3]s [%[4]s, %[5]s](으)로 설정했습니다",
	"commands.spawnpoint.success.single": "%[6]s의 스폰 지점을 %[5]s의 %[1]s, %[2]s, %[3]s [%[4]s](으)로 설정했습니다",
	"commands.spawnpoint.success.single.new": "%[7]s의 스폰 지점을 %[6]s의 %[1]s, %[2]s, %[3]s [%[4]s, %[5]s](으)로 설정했습니다",
	"commands.spectate.cannot_spectate": "%s을(를) 관전할 수 없습니다",
	...
	"commands.stopwatch.already_exists": "초시계 '%s'이(가) 이미 존재합니다",
	"commands.stopwatch.create.success": "초시계 '%s'을(를) 만들었습니다",
	"commands.stopwatch.does_not_exist": "초시계 '%s'이(가) 존재하지 않습니다",
	"commands.stopwatch.query": "초시계 '%s'은(는) %s초 동안 작동했습니다",
	"commands.stopwatch.remove.success": "초시계 '%s'을(를) 제거했습니다",
	"commands.stopwatch.restart.success": "초시계 '%s'을(를) 처음부터 다시 시작했습니다",
	"commands.summon.failed": "개체를 소환할 수 없습니다",
	"commands.summon.failed.peaceful": "몬스터는 평화로움 난이도에서 소환할 수 없습니다",
	...
	"commands.swing.failed.notliving": "팔을 휘두르게 할 살아있는 개체를 찾을 수 없습니다",
	"commands.swing.success.multiple": "개체 %s개가 팔을 휘두르게 했습니다",
	"commands.swing.success.single": "%s이(가) 팔을 휘두르게 했습니다",
	...
	"commands.team.option.color.clear.success": "팀 %s의 색을 제거했습니다",
	...
	"commands.team.option.friendlyfire.disabled": "%s 팀의 아군 공격을 껐습니다",
	...
	"commands.test.batch.starting": "환경 %s 배치 %s을(를) 시작합니다",
	"commands.test.clear.error.no_tests": "비울 테스트를 찾을 수 없습니다",
	"commands.test.clear.success": "구조물 %s개를 비웠습니다",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "클립보드에 복사하려면 클릭",
	"commands.test.create.success": "테스트 %s에 대한 테스트 설비를 생성했습니다",
	"commands.test.error.no_test_containing_pos": "%s, %s, %s을(를) 포함하는 테스트 인스턴스를 찾을 수 없습니다",
	"commands.test.error.no_test_instances": "테스트 인스턴스를 찾을 수 없습니다",
	"commands.test.error.non_existant_test": "테스트 %s을(를) 찾을 수 없습니다",
	"commands.test.error.structure_not_found": "테스트 구조물 %s을(를) 찾을 수 없습니다",
	"commands.test.error.test_instance_not_found": "테스트 인스턴스 블록 개체를 찾을 수 없습니다",
	"commands.test.error.test_instance_not_found.position": "%s, %s, %s에서 테스트를 위한 테스트 인스턴스 블록 개체를 찾을 수 없습니다",
	"commands.test.error.too_large": "구조물 크기는 각 축마다 %s블록 미만이어야 합니다",
	"commands.test.locate.done": "탐색을 완료했습니다. 구조물 %s개를 찾았습니다",
	"commands.test.locate.found": "구조물을 찾았습니다: %s (거리: %s)",
	"commands.test.locate.started": "테스트 구조물을 찾기 시작했습니다. 시간이 다소 걸릴 수 있습니다...",
	"commands.test.no_tests": "실행할 테스트가 없습니다",
	"commands.test.relative_position": "%s에 대한 상대 위치: %s",
	"commands.test.reset.error.no_tests": "초기화할 테스트를 찾을 수 없습니다",
	"commands.test.reset.success": "구조물 %s개를 초기화했습니다",
	"commands.test.run.no_tests": "테스트를 찾을 수 없습니다",
	"commands.test.run.running": "테스트 %s개 실행 중...",
	"commands.test.summary": "게임 테스트 완료! 테스트 %s개를 실행했습니다",
	"commands.test.summary.all_required_passed": "모든 필수 테스트가 통과했습니다 :)",
	"commands.test.summary.failed": "필수 테스트 %s개가 실패했습니다 :(",
	"commands.test.summary.optional_failed": "선택적 테스트 %s개가 실패했습니다",
	...
	"commands.time.no_default_clock": "차원 %s에 기본 시계가 없습니다",
	"commands.time.no_time_marker_found": "시간 표지 %s이(가) 시계 %s에 존재하지 않습니다",
	"commands.time.pause": "시계 %s을(를) 멈췄습니다",
	"commands.time.query": "현재 시간은 %s입니다",
	"commands.time.query.absolute": "시계 %s의 위치는 %s틱입니다",
	"commands.time.query.gametime": "게임 시간은 %s틱입니다",
	"commands.time.query.timeline": "시간선 %s의 위치는 %s틱입니다",
	"commands.time.query.timeline.repetitions": "시간선 %s은(는) %s번의 반복을 지났습니다",
	"commands.time.rate": "시계 %s은(는) 이제 정상 속도의 %s배로 진행됩니다",
	"commands.time.resume": "시계 %s을(를) 재개했습니다",
	"commands.time.set": "시간을 %s(으)로 설정했습니다",
	"commands.time.set.absolute": "%s을(를) %s틱으로 설정했습니다",
	"commands.time.set.time_marker": "%s을(를) 시간 표지 %s(으)로 설정했습니다",
	"commands.time.wrong_timeline_for_clock": "시간선 %s은(는) 시계 %s에 유효하지 않습니다",
	...
	"commands.title.show.actionbar.multiple": "플레이어 %s명에게 새로운 액션바 제목을 보여 줍니다",
	"commands.title.show.actionbar.single": "%s에게 새로운 액션바 제목을 보여 줍니다",
	"commands.title.show.subtitle.multiple": "플레이어 %s명에게 새로운 부제를 보여 줍니다",
	"commands.title.show.subtitle.single": "%s에게 새로운 부제를 보여 줍니다",
	"commands.title.show.title.multiple": "플레이어 %s명에게 새로운 제목을 보여 줍니다",
	"commands.title.show.title.single": "%s에게 새로운 제목을 보여 줍니다",
	...
	"commands.unpublish.notPublished": "공개된 멀티플레이 게임이 없습니다",
	"commands.unpublish.success": "멀티플레이 게임이 이제 비공개됩니다",
	"commands.version.build_time": "build_time = %s",
	"commands.version.data": "data = %s",
	"commands.version.header": "서버 버전 정보:",
	...
	"commands.waypoint.list.empty": "%s에는 경로점이 없습니다",
	"commands.waypoint.list.success": "%[1]s에는 경로점 %[2]s개가 있습니다: %[3]s",
	"commands.waypoint.modify.color": "경로점 색은 이제 %s입니다",
	"commands.waypoint.modify.color.reset": "경로점 색을 초기화했습니다",
	"commands.waypoint.modify.style": "경로점 스타일을 바꿨습니다",
	...
	"component.profile.dynamic": "동적",
	"connect.aborted": "중단됨",
	"connect.authorizing": "로그인 중...",
	"connect.connecting": "서버에 접속하는 중...",
	"connect.encrypting": "암호화 중...",
	"connect.failed": "서버 접속에 실패했습니다",
	"connect.failed.transfer": "다른 서버로 이송되는 중 연결에 실패했습니다",
	"connect.joining": "세계 참여 중...",
	"connect.negotiating": "협상 중...",
	"connect.p2p.establishing": "연결 구축 중...",
	"connect.p2p.failed.generic": "플레이어와 연결할 수 없습니다",
	"connect.p2p.failed.signaling": "지금은 연결할 수 없습니다.\n나중에 다시 시도해 주세요.",
	"connect.p2p.failed.timeout": "연결 요청 시간이 초과되었습니다",
	"connect.p2p.failed.unreachable": "플레이어에게 연결할 수 없습니다",
	"connect.reconfiging": "재설정 중...",
	"connect.reconfiguring": "재설정 중...",
	"connect.transferring": "새 서버로 이송되는 중...",
	"container.barrel": "통",
	"container.beacon": "신호기",
	"container.beehive.bees": "꿀벌: %s / %s",
	"container.beehive.honey": "꿀: %s / %s",
	...
	"createWorld.customize.buffet.search": "검색...",
	"createWorld.customize.buffet.title": "단일 생물 군계 사용자 지정",
	...
	"dataPack.locator_bar.description": "멀티플레이에서 다른 플레이어가 있는 방향을 보여 줍니다",
	"dataPack.locator_bar.name": "위치 표시 바",
	"dataPack.minecart_improvements.description": "광산 수레 움직임을 개선합니다",
	"dataPack.minecart_improvements.name": "광산 수레 개선",
	"dataPack.redstone_experiments.description": "실험적 레드스톤 변경 사항",
	"dataPack.redstone_experiments.name": "레드스톤 실험",
	...
	"dataPack.winter_drop.description": "겨울 드롭의 새 기능 및 콘텐츠",
	"dataPack.winter_drop.name": "겨울 드롭",
	...
	"death.attack.cramming": "%[1]s이(가) 으깨져 버렸습니다",
	...
	"death.attack.mace_smash": "%[1]s이(가) %[2]s에게 강타당했습니다",
	"death.attack.mace_smash.item": "%[1]s이(가) %[3]s을(를) 사용한 %[2]s에게 강타당했습니다",
	...
	"death.attack.spear": "%[1]s이(가) %[2]s에게 창으로 찔렸습니다",
	"death.attack.spear.item": "%[1]s이(가) %[3]s을(를) 사용한 %[2]s에게 창으로 찔렸습니다",
	...
	"death.attack.sulfurCubeHot": "%[1]s이(가) 바닥만 용암인 것이 아니었기 때문에 죽었습니다",
	"death.attack.sulfurCubeHot.player": "%[2]s이(가) %[1]s에게 바닥만 용암인 것이 아니었음을 보여주었습니다",
	...
	"debug.copy_location.help": "F3 + C = 위치를 /tp 명령어로 복사, 10초 동안 누르고 있으면 게임에 크래시를 발생시킴",
	"debug.copy_location.message": "위치를 클립보드에 복사했습니다",
	"debug.crash.message": "F3 + C가 눌려 있습니다. 놓지 않으면 게임에 크래시를 발생시킵니다.",
	"debug.crash.message.rebindable": "%s + %s이(가) 눌려 있습니다. 놓지 않으면 게임에 잠시 후 크래시를 일으킵니다.",
	...
	"debug.entry.always": "항상",
	"debug.entry.currently.alwaysOn": "%s: 현재 항상 켜짐",
	"debug.entry.currently.inF3": "%s: 현재 F3에서만 켜짐",
	"debug.entry.currently.inOverlay": "%s: 현재 디버그 오버레이에서만 켜짐",
	"debug.entry.currently.never": "%s: 현재 꺼짐",
	"debug.entry.f3": "F3에서",
	"debug.entry.overlay": "오버레이에서",
	...
	"debug.options.category.renderer": "디버그 렌더러",
	"debug.options.category.text": "디버그 화면 문구",
	"debug.options.help": "F3 + F6 = 디버그 설정 편집",
	"debug.options.notAllowed.tooltip": "디버그 정보가 축소되었을 때 표시되지 않습니다",
	"debug.options.profile.default": "기본 프로필",
	"debug.options.profile.performance": "성능 프로필",
	"debug.options.search": "검색...",
	"debug.options.title": "디버그 설정",
	"debug.options.warning": "이 설정들은 테스트 전용입니다. 컴퓨터를 느려지게 하거나, 게임에 크래시를 내거나, 당신의 애완 돌을 먹어 버릴 수도 있습니다.",
	...
	"debug.profiling.start.rebindable": "%s초 프로파일링을 시작했습니다. %s + %s(으)로 조기 종료할 수 있습니다",
	...
	"debug.version.header": "클라이언트 버전 정보:",
	"debug.version.help": "F3 + V = 클라이언트 버전 정보",
	...
	"disconnect.packetError": "네트워크 프로토콜 오류",
	"disconnect.spam": "스팸으로 인해 추방당함",
	"disconnect.timeout": "시간 초과",
	"disconnect.transfer": "다른 서버로 이송됐습니다",
	...
	"editGamerule.inGame.button": "게임 규칙 편집...",
	"editGamerule.inGame.disabled.tooltip": "게임 규칙을 갱신하려면 관리자 권한이 필요합니다.",
	"editGamerule.inGame.discardChanges.message": "저장하지 않은 게임 규칙 변경 사항을 폐기하시겠습니까?",
	"editGamerule.inGame.discardChanges.title": "게임 규칙 변경 사항",
	"editGamerule.inGame.downloadingGamerules": "게임 규칙 받아오는 중...",
	"editGamerule.title": "게임 규칙 수정",
	"effect.duration.infinite": "∞",
	"effect.minecraft.absorption": "흡수",
	"effect.minecraft.bad_omen": "흉조",
	"effect.minecraft.blindness": "실명",
	"effect.minecraft.breath_of_the_nautilus": "앵무조개의 숨결",
	...
	"effect.minecraft.infested": "벌레 먹음",
	...
	"effect.minecraft.oozing": "점액화",
	"effect.minecraft.poison": "독",
	"effect.minecraft.raid_omen": "습격 징조",
	...
	"enchantment.minecraft.breach": "격파",
	"enchantment.minecraft.channeling": "집전",
	"enchantment.minecraft.density": "육중",
	...
	"enchantment.minecraft.lunge": "돌진",
	...
	"enchantment.minecraft.sweeping_edge": "휩쓸기",
	...
	"enchantment.minecraft.wind_burst": "돌풍",
	"entity.minecraft.acacia_boat": "아카시아나무 보트",
	"entity.minecraft.acacia_chest_boat": "상자가 실린 아카시아나무 보트",
	...
	"entity.minecraft.bamboo_chest_raft": "상자가 실린 대나무 뗏목",
	"entity.minecraft.bamboo_raft": "대나무 뗏목",
	"entity.minecraft.bat": "박쥐",
	"entity.minecraft.bee": "꿀벌",
	"entity.minecraft.birch_boat": "자작나무 보트",
	"entity.minecraft.birch_chest_boat": "상자가 실린 자작나무 보트",
	...
	"entity.minecraft.camel_husk": "낙타 허스크",
	"entity.minecraft.cat": "고양이",
	"entity.minecraft.cave_spider": "동굴 거미",
	"entity.minecraft.cherry_boat": "벚나무 보트",
	"entity.minecraft.cherry_chest_boat": "상자가 실린 벚나무 보트",
	...
	"entity.minecraft.copper_golem": "구리 골렘",
	"entity.minecraft.cow": "소",
	"entity.minecraft.creaking": "크리킹",
	"entity.minecraft.creaking_transient": "크리킹",
	"entity.minecraft.creeper": "크리퍼",
	"entity.minecraft.dark_oak_boat": "짙은 참나무 보트",
	"entity.minecraft.dark_oak_chest_boat": "상자가 실린 짙은 참나무 보트",
	...
	"entity.minecraft.happy_ghast": "행복한 가스트",
	...
	"entity.minecraft.jungle_boat": "정글나무 보트",
	"entity.minecraft.jungle_chest_boat": "상자가 실린 정글나무 보트",
	"entity.minecraft.killer_bunny": "살인 토끼",
	"entity.minecraft.leash_knot": "끈 매듭",
	"entity.minecraft.lightning_bolt": "벼락",
	"entity.minecraft.lingering_potion": "잔류형 물약",
	"entity.minecraft.llama": "라마",
	"entity.minecraft.llama_spit": "라마 침",
	"entity.minecraft.magma_cube": "마그마 큐브",
	"entity.minecraft.mangrove_boat": "맹그로브나무 보트",
	"entity.minecraft.mangrove_chest_boat": "상자가 실린 맹그로브나무 보트",
	"entity.minecraft.mannequin": "마네킹",
	...
	"entity.minecraft.nautilus": "앵무조개",
	"entity.minecraft.oak_boat": "참나무 보트",
	"entity.minecraft.oak_chest_boat": "상자가 실린 참나무 보트",
	"entity.minecraft.ocelot": "오실롯",
	"entity.minecraft.ominous_item_spawner": "불길한 아이템 생성기",
	"entity.minecraft.painting": "그림",
	"entity.minecraft.pale_oak_boat": "창백한 참나무 보트",
	"entity.minecraft.pale_oak_chest_boat": "상자가 실린 창백한 참나무 보트",
	"entity.minecraft.panda": "판다",
	"entity.minecraft.parched": "파치트",
	...
	"entity.minecraft.splash_potion": "투척용 물약",
	"entity.minecraft.spruce_boat": "가문비나무 보트",
	"entity.minecraft.spruce_chest_boat": "상자가 실린 가문비나무 보트",
	"entity.minecraft.squid": "오징어",
	"entity.minecraft.stray": "스트레이",
	"entity.minecraft.strider": "스트라이더",
	"entity.minecraft.sulfur_cube": "유황 큐브",
	"entity.minecraft.sulfur_cube.content": "내용물: %s",
	...
	"entity.minecraft.zombie_nautilus": "좀비 앵무조개",
	...
	"filled_map.trial_chambers": "시련 탐험가 지도",
	...
	"gamerule.allowEnteringNetherUsingPortals": "네더 허용",
	"gamerule.allowEnteringNetherUsingPortals.description": "플레이어의 네더 진입 가능 여부를 제어합니다.",
	"gamerule.allowFireTicksAwayFromPlayer": "플레이어로부터 떨어진 불 틱",
	"gamerule.allowFireTicksAwayFromPlayer.description": "플레이어로부터 청크 8개 이상 떨어진 불과 용암의 틱 여부를 제어합니다.",
	"gamerule.announceAdvancements": "발전 과제 알림",
	"gamerule.blockExplosionDropDecay": "블록 사용에 의한 폭발에서, 몇몇 블록이 노획물을 떨어뜨리지 않음",
	...
	"gamerule.commandBlocksEnabled": "명령 블록 켜기",
	...
	"gamerule.disablePlayerMovementCheck": "플레이어 움직임 확인 끄기",
	...
	"gamerule.doVinesSpread.description": "덩굴이 인접한 블록으로 무작위하게 퍼지는지 여부를 제어합니다. 늘어진 덩굴이나 휘어진 덩굴 등 다른 종류의 덩굴 블록에는 영향을 주지 않습니다.",
	"gamerule.doWardenSpawning": "워든 생성",
	"gamerule.doWeatherCycle": "날씨 갱신",
	"gamerule.drowningDamage": "익사 피해",
	"gamerule.enableCommandBlocks": "명령 블록 켜기",
	...
	"gamerule.entitiesWithPassengersCanUsePortals": "탑승자가 있는 개체의 차원문 사용 허용",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "탑승자가 있는 개체가 네더 차원문, 엔드 차원문, 엔드 관문을 통해 이동할 수 있도록 합니다.",
	...
	"gamerule.lavaSourceConversion.description": "흐르는 용암의 두 면이 용암 원천으로 둘러싸일 때, 그 블록이 원천으로 바뀝니다.",
	"gamerule.locatorBar": "플레이어 위치 표시 바 켜기",
	"gamerule.locatorBar.description": "켜져 있으면 플레이어가 있는 방향을 알려 주는 바를 화면에 표시합니다.",
	...
	"gamerule.minecartMaxSpeed": "광산 수레 최고 속도",
	"gamerule.minecartMaxSpeed.description": "땅에서 광산 수레가 움직일 때 최고 기본 속도",
	"gamerule.minecraft.elytra_movement_check": "겉날개 움직임 확인하기",
	"gamerule.minecraft.fire_spread_radius_around_player": "불 확산 반지름",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "플레이어를 중심으로 불이 확산될 수 있는 블록 단위의 반경",
	"gamerule.minecraft.player_movement_check": "플레이어 움직임 확인하기",
	"gamerule.minecraft.raids": "습격 켜기",
	"gamerule.minecraft.universal_anger.description": "분노한 중립 몹이 자신을 화나게 한 플레이어뿐만 아니라 주변의 모든 플레이어를 공격합니다. forgive_dead_players가 비활성화되어 있을 때 가장 잘 작동합니다.",
	"gamerule.mobExplosionDropDecay": "몹 폭발에서, 몇몇 블록이 노획물을 떨어뜨리지 않음",
	...
	"gamerule.playersNetherPortalCreativeDelay": "크리에이티브 모드인 플레이어의 네더 차원문 지연 시간",
	...
	"gamerule.pvp": "pvp 켜기",
	"gamerule.pvp.description": "플레이어가 다른 플레이어에게 피해를 입힐 수 있는지 여부를 제어합니다.",
	...
	"gamerule.spawnChunkRadius": "스폰 청크 반지름",
	"gamerule.spawnChunkRadius.description": "오버월드 스폰 위치 주변에 항상 불러와진 상태를 유지하는 청크의 양.",
	"gamerule.spawnMonsters": "몬스터 생성",
	"gamerule.spawnMonsters.description": "몬스터의 자연적 생성 여부를 제어합니다.",
	"gamerule.spawnRadius": "리스폰 위치 반지름",
	"gamerule.spawnRadius.description": "스폰 지점 주위, 플레이어들이 스폰할 수 있는 영역의 크기를 제어합니다.",
	"gamerule.spawnerBlocksEnabled": "생성기 블록 켜기",
	"gamerule.spectatorsGenerateChunks": "관전자의 지형 생성 허용",
	"gamerule.tntExplodes": "TNT의 점화 및 폭발 허용",
	"gamerule.tntExplosionDropDecay": "TNT 폭발에서, 몇몇 블록이 노획물을 떨어뜨리지 않음",
	...
	"gamerule.waterSourceConversion.description": "흐르는 물의 두 면이 물 원천으로 둘러싸일 때, 그 블록이 원천으로 바뀝니다.",
	...
	"gui.abuseReport.attestation": "신고를 제출함으로써, 제공하는 정보가 본인이 아는 한 정확하고 완전함을 확인합니다.",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "성적으로 부적절",
	"gui.abuseReport.reason.sexually_inappropriate.description": "성행위, 성기, 성폭력과 관련된 내용이 사실적으로 표현된 스킨",
	...
	"gui.abuseReport.report_sent_msg": "신고가 성공적으로 접수되었습니다. 감사합니다!\n\n저희 팀이 가능한 한 빨리 검토하겠습니다.",
	...
	"gui.abuseReport.send.not_attested": "신고를 제출하려면 위의 글을 읽고 체크상자에 표시해 주세요",
	...
	"gui.fileDropFailure.detail": "파일 %s개 거부됨",
	"gui.fileDropFailure.title": "파일 추가에 실패했습니다",
	"gui.friends.accept": "수락",
	"gui.friends.button.loading": "기다리세요...",
	"gui.friends.button.loading.invite_request_pending": "승인을 기다리는 중",
	"gui.friends.button.loading.join_request_pending": "승인을 기다리는 중",
	"gui.friends.cancel_request": "요청 취소",
	"gui.friends.confirm_title": "확인",
	"gui.friends.confirm_unfriend": "정말로 이 플레이어를 친구 목록에서 제거하시겠습니까?",
	"gui.friends.copy_to_clipboard": "클립보드에 복사",
	"gui.friends.decline": "거절",
	"gui.friends.empty_nickname": "친구 요청을 보내기 전에 올바른 프로필 이름을 입력하세요",
	"gui.friends.empty_state": "추가한 친구는 여기에 표시됩니다.\n\n귀하의 %s으로 온라인 안전을 관리하세요.",
	"gui.friends.empty_state.link": "Microsoft 계정",
	"gui.friends.enter_nickname": "프로필 이름 입력",
	"gui.friends.error.connection_issue": "지금은 친구 목록을 표시할 수 없습니다.\n\n인터넷 연결을 확인하고 다시 시도해 주세요.",
	"gui.friends.error.failed.message": "지금은 친구 요청을 보낼 수 없습니다",
	"gui.friends.error.forbidden.message": "이 친구 작업을 수행하는 데 실패했습니다. 계정의 개인정보 보호 설정 때문일 수 있습니다.",
	"gui.friends.error.generic": "문제가 발생했습니다(당신의 친구가 아니라, 이 기능에요)!\n\n나중에 다시 시도해 주세요.",
	"gui.friends.error.rateLimited.message": "친구 목록 작업을 너무 빨리 수행하고 있습니다. 잠시 기다린 후 다시 시도해 주세요.",
	"gui.friends.error.temporary_unavailable": "지금은 친구 목록을 표시할 수 없습니다.\n\n나중에 다시 시도해 주세요.",
	"gui.friends.error.unavailable.message": "현재 친구 목록 서비스를 사용할 수 없습니다. 연결 상태를 확인하고 나중에 다시 시도해 주세요.",
	"gui.friends.error.upgrade_needed": "친구 목록을 보려면 게임을 업데이트하세요.",
	"gui.friends.error.user_may_lack_active_profile": "\u200b이 프로필 이름을 가진 플레이어가 없습니다",
	"gui.friends.join": "참여",
	"gui.friends.loading_friends": "친구 목록을 불러오는 중...",
	"gui.friends.loading_requests": "요청을 불러오는 중...",
	"gui.friends.manage_account_footer": "귀하의 %s으로 온라인 안전을 관리하세요",
	"gui.friends.multiplayer.invite": "초대",
	"gui.friends.multiplayer.invite_accept": "수락",
	"gui.friends.multiplayer.invite_reject": "거절",
	"gui.friends.multiplayer.join_request": "참여 요청",
	"gui.friends.multiplayer.join_request_accept": "수락",
	"gui.friends.multiplayer.join_request_reject": "거절",
	"gui.friends.my_profile_name": "내 프로필 이름: ",
	"gui.friends.my_profile_name.narration": "클립보드에 프로필 이름 %s 복사",
	"gui.friends.narration.button.accept": "%s의 친구 요청을 수락하려면 Enter를 누르세요",
	"gui.friends.narration.button.cancel_request": "%s에게 보낸 친구 요청을 취소하려면 Enter를 누르세요",
	"gui.friends.narration.button.decline": "%s의 친구 요청을 거절하려면 Enter를 누르세요",
	"gui.friends.narration.button.unfriend": "친구 목록에서 %s을(를) 제거하려면 Enter를 누르세요",
	"gui.friends.narration.entry.friend": "친구 %s",
	"gui.friends.narration.entry.incoming": "%s에게서 받은 친구 요청",
	"gui.friends.narration.entry.outgoing": "%s에게 보낸 친구 요청",
	"gui.friends.open": "친구",
	"gui.friends.open.narration": "친구 목록",
	"gui.friends.open.tooltip": "친구",
	"gui.friends.pending.empty": "대기 중인 친구 요청이 없습니다",
	"gui.friends.pending.received": "받음",
	"gui.friends.pending.sent": "보냄",
	"gui.friends.presence.status.offline": "오프라인",
	"gui.friends.presence.status.online": "온라인",
	"gui.friends.presence.status.playing_hosted_server": "온라인 (세계)",
	"gui.friends.presence.status.playing_offline": "온라인 (세계)",
	"gui.friends.presence.status.playing_realms": "온라인 (Realm)",
	"gui.friends.presence.status.playing_server": "온라인 (서버)",
	"gui.friends.requests_count": "요청 (%s)",
	"gui.friends.send_request": "친구 요청 보내기",
	"gui.friends.tab_friends": "친구",
	"gui.friends.toast.friend_added.message": "%s이(가) 당신의 친구 요청을 수락했습니다",
	"gui.friends.toast.friend_invited.message": "%s을(를) 당신의 세계에 초대했습니다.",
	"gui.friends.toast.friend_removed.message": "%s이(가) 당신의 친구 목록에서 제거되었습니다",
	"gui.friends.toast.generic_error": "친구 목록을 업데이트하는 중 예기치 않은 오류가 발생했습니다. 나중에 다시 시도해 주세요.",
	"gui.friends.toast.host_invite_expired.message": "%s에게 보낸 이 세계의 참여 초대가 만료되었습니다.",
	"gui.friends.toast.invite_from_friend.message": "%s이(가) 당신을 자신의 세계에 초대했습니다. \"%s\"을(를) 눌러 친구 목록을 열고 참여하세요",
	"gui.friends.toast.join_invite_expired.message": "%s의 세계 참여 초대가 만료되었습니다.",
	"gui.friends.toast.join_request.message": "%s이(가) 당신의 세계에 참여를 요청했습니다. \"%s\"을(를) 눌러 친구 목록을 열거나 게임 메뉴를 통해 확인하세요.",
	"gui.friends.toast.request_accepted.message": "이제 %s와(과) 친구입니다",
	"gui.friends.toast.request_received.message": "%s이(가) 친구 요청을 보냈습니다",
	"gui.friends.toast.request_sent.message": "%s에게 친구 요청을 보냈습니다",
	"gui.friends.toast.request_to_join_friend.message": "%s에게 세계 참여 요청을 보냈습니다",
	"gui.friends.toast.requests_accepted_multiple.message": "%s명이 당신의 친구 요청을 수락했습니다",
	"gui.friends.toast.requests_received_multiple.message": "%s개의 친구 요청을 받았습니다",
	"gui.friends.unfriend": "친구 삭제",
	"gui.game_rule.search": "검색...",
	"gui.hours": "%s시간",
	"gui.language.search": "검색...",
	...
	"gui.none": "없음",
	"gui.ok": "확인",
	"gui.open_report_dir": "보고서 디렉터리 열기",
	"gui.packSelection.search": "검색...",
	"gui.privacy_link.message": "개인정보 보호 및 온라인 보호 설정을 관리하려면 이 링크를 여세요.",
	"gui.privacy_link.title": "Xbox 설정 변경 사항이 적용되는 데 시간이 걸릴 수 있습니다.\n\n설정이 업데이트되지 않는다면, 게임을 다시 시작해 주세요.",
	"gui.proceed": "진행",
	"gui.recipebook.moreRecipes": "더 보려면 우클릭하세요",
	"gui.recipebook.next_page": "다음 페이지",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "이전 페이지",
	...
	"gui.remove": "제거하기",
	"gui.report_to_server": "서버에 신고하기",
	"gui.selectWorld.search": "검색...",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "이 플레이어는 대화가 꺼져 있거나 차단되어 있어 신고할 수 없습니다",
	...
	"gui.stats": "통계",
	"gui.stats.none_found": "통계를 찾을 수 없습니다.",
	...
	"gui.up": "위로",
	"gui.waitingForResponse.button.inactive": "뒤로 (%s초)",
	"gui.waitingForResponse.title": "서버를 기다리는 중",
	"gui.yes": "예",
	...
	"item.minecraft.armadillo_scute": "아르마딜로 인갑",
	"item.minecraft.armadillo_spawn_egg": "아르마딜로 생성 알",
	...
	"item.minecraft.black_bundle": "검은색 꾸러미",
	"item.minecraft.black_dye": "검은색 염료",
	"item.minecraft.black_harness": "검은색 하네스",
	...
	"item.minecraft.blue_bundle": "파란색 꾸러미",
	"item.minecraft.blue_dye": "파란색 염료",
	"item.minecraft.blue_egg": "파란색 달걀",
	"item.minecraft.blue_harness": "파란색 하네스",
	"item.minecraft.bogged_spawn_egg": "보그드 생성 알",
	"item.minecraft.bolt_armor_trim_smithing_template": "대장장이 형판",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "나사 갑옷 장식",
	"item.minecraft.bone": "뼈다귀",
	"item.minecraft.bone_meal": "뼛가루",
	"item.minecraft.book": "책",
	"item.minecraft.bordure_indented_banner_pattern": "톱니 테두리 현수막 무늬",
	"item.minecraft.bow": "활",
	"item.minecraft.bowl": "그릇",
	"item.minecraft.bread": "빵",
	"item.minecraft.breeze_rod": "브리즈 막대기",
	...
	"item.minecraft.brown_bundle": "갈색 꾸러미",
	"item.minecraft.brown_dye": "갈색 염료",
	"item.minecraft.brown_egg": "갈색 달걀",
	"item.minecraft.brown_harness": "갈색 하네스",
	"item.minecraft.brush": "솔",
	"item.minecraft.bucket": "양동이",
	"item.minecraft.bundle": "꾸러미",
	"item.minecraft.bundle.empty": "비어 있음",
	"item.minecraft.bundle.empty.description": "여러 종류의 아이템을 섞어 한 묶음 보관할 수 있습니다",
	"item.minecraft.bundle.full": "꽉 참",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "불탐 도자기 조각",
	"item.minecraft.burn_pottery_sherd": "불탐 도자기 조각",
	"item.minecraft.camel_husk_spawn_egg": "낙타 허스크 생성 알",
	...
	"item.minecraft.coast_armor_trim_smithing_template.new": "해안 갑옷 장식",
	...
	"item.minecraft.copper_axe": "구리 도끼",
	"item.minecraft.copper_boots": "구리 부츠",
	"item.minecraft.copper_chestplate": "구리 흉갑",
	"item.minecraft.copper_golem_spawn_egg": "구리 골렘 생성 알",
	"item.minecraft.copper_helmet": "구리 투구",
	"item.minecraft.copper_hoe": "구리 괭이",
	"item.minecraft.copper_horse_armor": "구리 말 갑옷",
	"item.minecraft.copper_ingot": "구리 주괴",
	"item.minecraft.copper_leggings": "구리 레깅스",
	"item.minecraft.copper_nautilus_armor": "구리 앵무조개 갑옷",
	"item.minecraft.copper_nugget": "구리 조각",
	"item.minecraft.copper_pickaxe": "구리 곡괭이",
	"item.minecraft.copper_shovel": "구리 삽",
	"item.minecraft.copper_spear": "구리 창",
	"item.minecraft.copper_sword": "구리 검",
	"item.minecraft.cow_spawn_egg": "소 생성 알",
	"item.minecraft.creaking_spawn_egg": "크리킹 생성 알",
	"item.minecraft.creeper_banner_pattern": "현수막 무늬",
	"item.minecraft.creeper_banner_pattern.desc": "크리퍼 모양",
	"item.minecraft.creeper_banner_pattern.new": "크리퍼 모양 현수막 무늬",
	"item.minecraft.creeper_spawn_egg": "크리퍼 생성 알",
	"item.minecraft.crossbow": "쇠뇌",
	"item.minecraft.crossbow.projectile": "발사체:",
	"item.minecraft.crossbow.projectile.multiple": "발사체: %s x %s",
	"item.minecraft.crossbow.projectile.single": "발사체: %s",
	"item.minecraft.cyan_bundle": "청록색 꾸러미",
	"item.minecraft.cyan_dye": "청록색 염료",
	"item.minecraft.cyan_harness": "청록색 하네스",
	...
	"item.minecraft.dune_armor_trim_smithing_template.new": "사구 갑옷 장식",
	...
	"item.minecraft.eye_armor_trim_smithing_template.new": "눈 갑옷 장식",
	"item.minecraft.feather": "깃털",
	"item.minecraft.fermented_spider_eye": "발효된 거미 눈",
	"item.minecraft.field_masoned_banner_pattern": "벽돌 현수막 무늬",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "대장장이 형판",
	"item.minecraft.flow_armor_trim_smithing_template.new": "흐름 갑옷 장식",
	"item.minecraft.flow_banner_pattern": "현수막 무늬",
	"item.minecraft.flow_banner_pattern.desc": "흐름",
	"item.minecraft.flow_banner_pattern.new": "흐름 현수막 무늬",
	"item.minecraft.flow_pottery_sherd": "흐름 도자기 조각",
	"item.minecraft.flower_banner_pattern": "현수막 무늬",
	"item.minecraft.flower_banner_pattern.desc": "꽃 모양",
	"item.minecraft.flower_banner_pattern.new": "꽃 모양 현수막 무늬",
	...
	"item.minecraft.globe_banner_pattern.new": "지구 모양 현수막 무늬",
	...
	"item.minecraft.golden_nautilus_armor": "금 앵무조개 갑옷",
	"item.minecraft.golden_pickaxe": "금 곡괭이",
	"item.minecraft.golden_shovel": "금 삽",
	"item.minecraft.golden_spear": "금 창",
	"item.minecraft.golden_sword": "금 검",
	"item.minecraft.gray_bundle": "회색 꾸러미",
	"item.minecraft.gray_dye": "회색 염료",
	"item.minecraft.gray_harness": "회색 하네스",
	"item.minecraft.green_bundle": "초록색 꾸러미",
	"item.minecraft.green_dye": "초록색 염료",
	"item.minecraft.green_harness": "초록색 하네스",
	"item.minecraft.guardian_spawn_egg": "가디언 생성 알",
	"item.minecraft.gunpowder": "화약",
	"item.minecraft.guster_banner_pattern": "현수막 무늬",
	"item.minecraft.guster_banner_pattern.desc": "소용돌이",
	"item.minecraft.guster_banner_pattern.new": "소용돌이 현수막 무늬",
	"item.minecraft.guster_pottery_sherd": "소용돌이 도자기 조각",
	"item.minecraft.happy_ghast_spawn_egg": "행복한 가스트 생성 알",
	"item.minecraft.harness": "하네스",
	...
	"item.minecraft.host_armor_trim_smithing_template.new": "주인 갑옷 장식",
	...
	"item.minecraft.light_blue_bundle": "하늘색 꾸러미",
	"item.minecraft.light_blue_dye": "하늘색 염료",
	"item.minecraft.light_blue_harness": "하늘색 하네스",
	"item.minecraft.light_gray_bundle": "회백색 꾸러미",
	"item.minecraft.light_gray_dye": "회백색 염료",
	"item.minecraft.light_gray_harness": "회백색 하네스",
	"item.minecraft.lime_bundle": "연두색 꾸러미",
	"item.minecraft.lime_dye": "연두색 염료",
	"item.minecraft.lime_harness": "연두색 하네스",
	...
	"item.minecraft.lingering_potion.effect.infested": "잔류형 벌레 먹음의 물약",
	...
	"item.minecraft.lingering_potion.effect.oozing": "잔류형 점액화 물약",
	...
	"item.minecraft.lingering_potion.effect.weaving": "잔류형 방적의 물약",
	"item.minecraft.lingering_potion.effect.wind_charged": "잔류형 돌풍의 물약",
	"item.minecraft.llama_spawn_egg": "라마 생성 알",
	"item.minecraft.lodestone_compass": "자석석 나침반",
	"item.minecraft.mace": "철퇴",
	"item.minecraft.magenta_bundle": "자홍색 꾸러미",
	"item.minecraft.magenta_dye": "자홍색 염료",
	"item.minecraft.magenta_harness": "자홍색 하네스",
	...
	"item.minecraft.mojang_banner_pattern.new": "무언가 현수막 무늬",
	...
	"item.minecraft.music_disc_bounce": "음반",
	...
	"item.minecraft.music_disc_creator": "음반",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "음반",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Creator (오르골)",
	"item.minecraft.music_disc_far": "음반",
	"item.minecraft.music_disc_far.desc": "C418 - far",
	"item.minecraft.music_disc_lava_chicken": "음반",
	...
	"item.minecraft.music_disc_precipice": "음반",
	...
	"item.minecraft.music_disc_tears": "음반",
	...
	"item.minecraft.nautilus_spawn_egg": "앵무조개 생성 알",
	...
	"item.minecraft.piglin_banner_pattern.desc": "돼지 코",
	"item.minecraft.piglin_banner_pattern.new": "돼지 코 현수막 무늬",
	...
	"item.minecraft.pink_bundle": "분홍색 꾸러미",
	"item.minecraft.pink_dye": "분홍색 염료",
	"item.minecraft.pink_harness": "분홍색 하네스",
	...
	"item.minecraft.potion.effect.infested": "벌레 먹음의 물약",
	...
	"item.minecraft.potion.effect.oozing": "점액화 물약",
	...
	"item.minecraft.potion.effect.weaving": "방적의 물약",
	"item.minecraft.potion.effect.wind_charged": "돌풍의 물약",
	...
	"item.minecraft.purple_bundle": "보라색 꾸러미",
	"item.minecraft.purple_dye": "보라색 염료",
	"item.minecraft.purple_harness": "보라색 하네스",
	...
	"item.minecraft.raiser_armor_trim_smithing_template.new": "사육사 갑옷 장식",
	...
	"item.minecraft.red_bundle": "빨간색 꾸러미",
	"item.minecraft.red_dye": "빨간색 염료",
	"item.minecraft.red_harness": "빨간색 하네스",
	"item.minecraft.redstone": "레드스톤 가루",
	"item.minecraft.resin_brick": "수지 벽돌",
	"item.minecraft.resin_clump": "수지 덩어리",
	"item.minecraft.rib_armor_trim_smithing_template": "대장장이 형판",
	"item.minecraft.rib_armor_trim_smithing_template.new": "갈비뼈 갑옷 장식",
	...
	"item.minecraft.scrape_pottery_sherd": "긁개 도자기 조각",
	"item.minecraft.scute": "인갑",
	"item.minecraft.sentry_armor_trim_smithing_template": "대장장이 형판",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "보초 갑옷 장식",
	"item.minecraft.shaper_armor_trim_smithing_template": "대장장이 형판",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "조형가 갑옷 장식",
	...
	"item.minecraft.silence_armor_trim_smithing_template.new": "고요 갑옷 장식",
	...
	"item.minecraft.skull_banner_pattern.new": "해골 모양 현수막 무늬",
	...
	"item.minecraft.snout_armor_trim_smithing_template.new": "돼지 코 갑옷 장식",
	...
	"item.minecraft.spire_armor_trim_smithing_template.new": "첨탑 갑옷 장식",
	...
	"item.minecraft.splash_potion.effect.infested": "투척용 벌레 먹음의 물약",
	...
	"item.minecraft.splash_potion.effect.oozing": "투척용 점액화 물약",
	...
	"item.minecraft.splash_potion.effect.weaving": "투척용 방적의 물약",
	"item.minecraft.splash_potion.effect.wind_charged": "투척용 돌풍의 물약",
	...
	"item.minecraft.stone_spear": "돌 창",
	...
	"item.minecraft.sulfur_cube_bucket": "유황 큐브가 담긴 양동이",
	"item.minecraft.sulfur_cube_spawn_egg": "유황 큐브 생성 알",
	...
	"item.minecraft.tide_armor_trim_smithing_template.new": "물결 갑옷 장식",
	...
	"item.minecraft.tipped_arrow.effect.infested": "벌레 먹음의 화살",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "점액화 화살",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "방적의 화살",
	"item.minecraft.tipped_arrow.effect.wind_charged": "돌풍의 화살",
	...
	"item.minecraft.ward_armor_trim_smithing_template.new": "파수 갑옷 장식",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "길잡이 갑옷 장식",
	"item.minecraft.wheat": "밀",
	"item.minecraft.wheat_seeds": "밀 씨앗",
	"item.minecraft.white_bundle": "하얀색 꾸러미",
	"item.minecraft.white_dye": "하얀색 염료",
	"item.minecraft.white_harness": "하얀색 하네스",
	"item.minecraft.wild_armor_trim_smithing_template": "대장장이 형판",
	"item.minecraft.wild_armor_trim_smithing_template.new": "야생 갑옷 장식",
	"item.minecraft.wind_charge": "돌풍구",
	...
	"item.minecraft.wolf_armor": "늑대 갑옷",
	...
	"item.modifiers.any": "장비했을 때:",
	"item.modifiers.armor": "입었을 때:",
	"item.modifiers.body": "장비했을 때:",
	"item.modifiers.chest": "흉부에 있을 때:",
	"item.modifiers.feet": "발에 있을 때:",
	"item.modifiers.hand": "들었을 때:",
	...
	"item.modifiers.saddle": "안장을 얹었을 때:",
	"item.nbt_tags": "NBT: 태그 %s개",
	"item.op_block_warning.line1": "경고:",
	"item.op_block_warning.line2": "이 아이템을 사용하면 명령어가 실행될 수 있습니다.",
	"item.op_block_warning.line3": "정확한 내용을 모른다면 사용하지 마세요!",
	"item.spawn_egg.peaceful": "평화로움에서는 사용할 수 없습니다",
	...
	"jukebox_song.minecraft.bounce": "fingerspit - Home",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine - Creator (오르골)",
	...
	"key.categories.spectator": "관전자",
	"key.categories.ui": "게임 인터페이스",
	"key.category.minecraft.creative": "크리에이티브 모드",
	"key.category.minecraft.debug": "디버그",
	"key.category.minecraft.gameplay": "게임플레이",
	"key.category.minecraft.inventory": "보관함",
	"key.category.minecraft.misc": "기타",
	"key.category.minecraft.movement": "이동",
	"key.category.minecraft.multiplayer": "멀티플레이",
	"key.category.minecraft.spectator": "관전자",
	"key.chat": "대화 열기",
	"key.command": "명령어 열기",
	"key.debug.clearChat": "대화 내용 지우기",
	"key.debug.copyLocation": "위치 복사",
	"key.debug.copyRecreateCommand": "데이터 복사",
	"key.debug.crash": "디버그 크래시",
	"key.debug.debugOptions": "디버그 설정",
	"key.debug.dumpDynamicTextures": "동적 텍스처 저장",
	"key.debug.dumpVersion": "버전 정보 저장",
	"key.debug.focusPause": "창이 포커스를 잃었을 때 일시 정지 전환",
	"key.debug.fpsCharts": "FPS 통계",
	"key.debug.lightmapTexture": "라이트맵 텍스처",
	"key.debug.modifier": "디버그 변경자 키",
	"key.debug.networkCharts": "네트워크 통계",
	"key.debug.overlay": "오버레이 전환",
	"key.debug.profiling": "프로파일링 시작/종료",
	"key.debug.profilingChart": "프로파일링 통계",
	"key.debug.reloadChunk": "청크 새로 고침",
	"key.debug.reloadResourcePacks": "리소스 팩 새로 고침",
	"key.debug.showAdvancedTooltips": "고급 도구 설명 표시",
	"key.debug.showChunkBorders": "청크 경계 표시",
	"key.debug.showHitboxes": "히트박스 표시",
	"key.debug.spectate": "관전 모드 변경",
	"key.debug.switchGameMode": "게임 모드 전환기",
	...
	"key.spectatorHotbar": "단축 바에서 선택하기",
	"key.spectatorOutlines": "플레이어 강조",
	"key.sprint": "달리기",
	"key.swapOffhand": "다른 손과 아이템 맞바꾸기",
	"key.toggleGui": "GUI 전환",
	"key.togglePerspective": "시점 전환",
	"key.toggleSpectatorShaderEffects": "관전자 셰이더 효과 전환",
	"key.use": "아이템 사용/블록 놓기",
	"known_server_link.announcements": "공지",
	"known_server_link.community": "커뮤니티",
	"known_server_link.community_guidelines": "커뮤니티 지침",
	"known_server_link.feedback": "피드백",
	"known_server_link.forums": "포럼",
	"known_server_link.news": "소식",
	"known_server_link.report_bug": "서버 버그 제보",
	"known_server_link.status": "상태",
	"known_server_link.support": "지원",
	"known_server_link.website": "웹사이트",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "서버 추가",
	"manageServer.edit.title": "서버 정보 편집",
	"manageServer.enterIp": "서버 주소",
	"manageServer.enterName": "서버 이름",
	"manageServer.resourcePack": "서버 리소스 팩",
	"manageServer.resourcePack.disabled": "사용하지 않음",
	"manageServer.resourcePack.enabled": "사용",
	"manageServer.resourcePack.prompt": "물어보기",
	...
	"mco.backup.entry.worldType.adventureMap": "모험 맵",
	"mco.backup.entry.worldType.experience": "체험",
	"mco.backup.entry.worldType.inspiration": "영감을 주는 것",
	"mco.backup.entry.worldType.minigame": "미니게임",
	"mco.backup.entry.worldType.normal": "일반",
	"mco.backup.entry.worldType.unknown": "알 수 없음",
	"mco.backup.generate.world": "세계 생성",
	"mco.backup.info.title": "마지막 백업부터의 변화",
	"mco.backup.narration": "%s의 백업",
	"mco.backup.nobackups": "이 Realm은 현재 백업이 없습니다.",
	"mco.backup.restoring": "Realm을 복원하는 중",
	...
	"mco.client.outdated.stable.version": "클라이언트 버전(%s)이 Realms와 호환되지 않습니다.\n\n최신 버전의 Minecraft를 사용해 주세요.",
	"mco.client.unsupported.snapshot.version": "클라이언트 버전(%s)이 Realms와 호환되지 않습니다.\n\nRealms는 이 스냅숏 버전에서 사용할 수 없습니다.",
	...
	"mco.compatibility.incompatible.popup.title": "호환되지 않는 버전",
	"mco.compatibility.incompatible.releaseType.popup.message": "참여하려는 세계가 현재 사용 중인 버전과 호환되지 않습니다.",
	"mco.compatibility.incompatible.series.popup.message": "이 세계는 %s 버전에서 마지막으로 플레이되었으며, 사용 중인 버전은 %s입니다.\n\n두 버전은 서로 호환되지 않습니다. 이 버전에서 플레이하려면 새로운 세계가 필요합니다.",
	"mco.compatibility.unverifiable.message": "마지막으로 이 세계를 플레이했던 버전을 확인할 수 없습니다. 만일 이 세계가 업그레이드 혹은 다운그레이드 되면, 이 세계는 \"세계 백업\" 안에 자동으로 백업이 생성되고 저장됩니다.",
	"mco.compatibility.unverifiable.title": "호환성 확인 불가",
	"mco.compatibility.upgrade": "업그레이드",
	"mco.compatibility.upgrade.description": "이 세계는 %s 버전에서 마지막으로 플레이되었으며, 사용 중인 버전은 %s입니다.\n\n\"세계 백업\"에 세계의 백업이 저장됩니다. 필요하다면 세계를 복원해 주세요.",
	"mco.compatibility.upgrade.friend.description": "이 세계는 %s 버전에서 마지막으로 플레이되었으며, 사용 중인 버전은 %s입니다.\n\n\"세계 백업\"에 세계의 백업이 저장됩니다.\n\nRealm의 주인은 필요한 경우 세계를 복원할 수 있습니다.",
	...
	"mco.configure.world.buttons.close": "Realm 임시로 닫기",
	...
	"mco.configure.world.buttons.newworld": "새로운 세계",
	"mco.configure.world.buttons.open": "Realm 다시 열기",
	"mco.configure.world.buttons.options": "세계 설정",
	"mco.configure.world.buttons.players": "플레이어",
	"mco.configure.world.buttons.region_preference": "지역 선택...",
	"mco.configure.world.buttons.resetworld": "세계 초기화",
	"mco.configure.world.buttons.save": "저장",
	...
	"mco.configure.world.close.question.line1": "수정하는 동안 플레이할 수 없도록 Realm을 임시로 닫을 수 있습니다. 준비가 완료되면 다시 여십시오. \n\nRealms 구독이 취소되지 않습니다.",
	"mco.configure.world.close.question.line2": "정말로 계속하시겠습니까?",
	"mco.configure.world.close.question.title": "중단 없이 변경해야 합니까?",
	"mco.configure.world.closing": "Realm을 임시로 닫는 중...",
	"mco.configure.world.commandBlocks": "명령 블록",
	"mco.configure.world.delete.button": "Realm 삭제",
	"mco.configure.world.delete.question.line1": "당신의 Realm을 영구적으로 삭제합니다",
	...
	"mco.configure.world.loading": "Realm을 불러오는 중",
	"mco.configure.world.location": "위치",
	"mco.configure.world.minigame": "현재: %s",
	"mco.configure.world.name": "Realm 이름",
	"mco.configure.world.name.validation.whitespace": "공백으로 시작하거나 끝날 수 없습니다. 해당 공백은 제거됩니다.",
	"mco.configure.world.opening": "Realm을 여는 중...",
	"mco.configure.world.players.error": "해당 이름의 플레이어는 존재하지 않습니다",
	"mco.configure.world.players.invite.duplicate": "해당 이름을 가진 플레이어가 이미 Realm에 초대되었습니다",
	"mco.configure.world.players.inviting": "플레이어 초대 중...",
	"mco.configure.world.players.title": "플레이어",
	"mco.configure.world.pvp": "플레이어 대 플레이어",
	"mco.configure.world.region_preference": "지역 설정",
	"mco.configure.world.region_preference.title": "지역 선택",
	"mco.configure.world.reset.question.line1": "세계를 재생성하고 현재의 세계를 지웁니다",
	"mco.configure.world.reset.question.line2": "정말로 계속하시겠습니까?",
	"mco.configure.world.resourcepack.question": "이 Realm에서 플레이하려면 사용자 지정 리소스 팩이 필요합니다\n\n다운로드하고 플레이하시겠습니까?",
	...
	"mco.configure.world.restore.download.question.line1": "세계를 다운로드하고 싱글 플레이에 추가합니다",
	"mco.configure.world.restore.download.question.line2": "진행하시겠습니까?",
	"mco.configure.world.restore.question.line1": "세계를 '%s' (%s) 때로 복원합니다",
	"mco.configure.world.restore.question.line2": "정말로 계속하시겠습니까?",
	"mco.configure.world.settings.expired": "만료된 Realm의 설정을 수정할 수 없습니다",
	"mco.configure.world.settings.title": "설정",
	"mco.configure.world.slot": "세계 %s",
	"mco.configure.world.slot.empty": "비어 있음",
	"mco.configure.world.slot.switch.question.line1": "Realm을 다른 세계로 전환합니다",
	...
	"mco.configure.world.subscription.tab": "구독",
	...
	"mco.configure.world.switch.slot.subtitle": "이 세계는 비어 있습니다. 세계를 생성할 방법을 선택해 주세요",
	...
	"mco.download.confirmation.oversized": "다운로드하려는 세계가 %s보다 큽니다.\n\n이 세계를 Realm에 다시 업로드할 수 없습니다",
	...
	"mco.errorMessage.initialize.failed": "Realm 초기화에 실패했습니다",
	"mco.errorMessage.noDetails": "오류에 대한 상세 정보가 없습니다",
	"mco.errorMessage.realmsService": "오류가 발생했습니다 (%s):",
	"mco.errorMessage.realmsService.configurationError": "세계 설정 변경 중 예상치 못한 오류가 발생했습니다",
	...
	"mco.gui.ok": "확인",
	"mco.info": "정보!",
	"mco.invited.player.narration": "플레이어 %s을(를) 초대했습니다",
	...
	"mco.onlinePlayers": "접속 중인 플레이어",
	"mco.play.button.realm.closed": "Realm이 닫혔습니다",
	"mco.question": "질문",
	...
	"mco.selectServer.closed": "비활성화된 Realm",
	...
	"mco.upload.failed.too_big.description": "선택된 세계가 너무 큽니다. 최대 허용 크기는 %s입니다.",
	"mco.upload.failed.too_big.title": "세계가 너무 큽니다",
	...
	"mco.upload.size.failure.line2": "크기가 %s입니다. 최대 허용 크기는 %s입니다.",
	"mco.upload.uploading": "'%s' 업로드 중",
	"mco.upload.verifying": "세계 확인 중",
	"mco.version": "버전: %s",
	"mco.warning": "경고!",
	"mco.worldSlot.minigame": "미니게임",
	"menu.custom_options": "사용자 지정 설정...",
	"menu.custom_options.title": "사용자 지정 설정",
	"menu.custom_options.tooltip": "주의: 사용자 지정 설정은 제삼자 서버나 컨텐츠에 의해 제공됩니다.\n조작에 유의하세요!",
	"menu.custom_screen_info.button_narration": "이 화면은 사용자 지정 화면입니다. 자세히 알아보기.",
	"menu.custom_screen_info.contents": "이 화면의 내용은 Mojang Studios나 Microsoft가 소유, 운영 및 감독하지 않는 제삼자 서버와 맵이 제어하는 것입니다.\n\n링크를 클릭할 때 항상 조심하시고, 로그인 정보를 포함하여 개인 정보는 절대 제공하지 마세요.\n\n이 화면으로 인해 플레이가 불가능하다면, 아래 버튼으로 현재 서버에서 연결을 끊을 수 있습니다.",
	"menu.custom_screen_info.disconnect": "사용자 지정 화면 거부됨",
	"menu.custom_screen_info.title": "사용자 지정 화면에 대한 안내",
	"menu.custom_screen_info.tooltip": "이 화면은 사용자 지정 화면입니다. 여기를 클릭해서 자세히 알아보세요.",
	"menu.disconnect": "연결 끊기",
	"menu.feedback": "피드백...",
	"menu.feedback.title": "피드백",
	"menu.game": "게임 메뉴",
	"menu.modded": " (모드)",
	"menu.multiplayer": "멀티플레이",
	"menu.multiplayerOptions.applyChanges": "변경 사항 적용하기",
	"menu.multiplayerOptions.button": "멀티플레이...",
	"menu.multiplayerOptions.network": "멀티플레이",
	"menu.multiplayerOptions.network.header": "네트워크",
	"menu.multiplayerOptions.network.lan": "LAN",
	"menu.multiplayerOptions.network.lan.tooltip": "같은 네트워크에 있는 플레이어가 참여할 수 있습니다.",
	"menu.multiplayerOptions.network.off": "꺼짐",
	"menu.multiplayerOptions.network.off.tooltip": "아무도 참여할 수 없습니다.",
	"menu.multiplayerOptions.network.online": "온라인",
	"menu.multiplayerOptions.network.online.tooltip": "온라인 상태의 친구가 참여할 수 있습니다.",
	"menu.multiplayerOptions.otherPlayers.header": "다른 플레이어",
	"menu.multiplayerOptions.publish.started.lan": "이 세계는 이제 LAN에 공개됩니다. 포트 번호는 %s입니다",
	"menu.multiplayerOptions.publish.started.online": "이 세계는 이제 멀티플레이에 공개됩니다. 포트 번호는 %s입니다",
	"menu.multiplayerOptions.publish.stopped": "이 세계는 더 이상 멀티플레이에 공개되지 않습니다",
	"menu.multiplayerOptions.title": "멀티플레이 설정",
	"menu.online": "Minecraft Realms",
	"menu.options": "설정...",
	"menu.paused": "게임 일시 정지",
	"menu.playdemo": "체험판 세계 플레이",
	"menu.playerReporting": "플레이어 신고",
	"menu.playerReporting.no_players": "이 세계에는 신고할 플레이어가 없습니다",
	"menu.preparingSpawn": "스폰 영역 준비 중: %s%%",
	"menu.quick_actions": "빠른 행동...",
	"menu.quick_actions.title": "빠른 행동",
	"menu.quit": "게임 종료",
	...
	"menu.server_links": "서버 링크...",
	"menu.server_links.title": "서버 링크",
	...
	"multiplayer.codeOfConduct.check": "이 행동 강령에 대해서는 더 이상 알림을 보내지 않기",
	"multiplayer.codeOfConduct.title": "서버 행동 강령",
	"multiplayer.confirm_command.parse_errors": "인식되지 않았거나 잘못된 명령어를 실행하려 합니다.\n그럼에도 실행할까요?\n명령어: %s",
	"multiplayer.confirm_command.permissions_required": "상위 권한이 필요한 명령어를 실행하려 합니다.\n이는 게임에 부정적인 영향을 줄 수 있습니다.\n그럼에도 실행할까요?\n명령어: %s",
	"multiplayer.confirm_command.run_command": "명령어 실행",
	"multiplayer.confirm_command.signature_required": "당신의 이름을 사용해서 대화 메시지를 보내는 명령어를 실행하려고 합니다.\n대화 화면에서만 실행할 수 있습니다\n명령어: %s",
	"multiplayer.confirm_command.suggest_command": "대화 화면으로 복사하기",
	"multiplayer.confirm_command.title": "명령어 실행 확인",
	"multiplayer.disconnect.authservers_down": "지금은 인증 서버를 사용할 수 없습니다. 나중에 다시 시도해 주세요. 죄송합니다!",
	"multiplayer.disconnect.bad_chat_index": "서버에서 오는 대화 메시지가 누락되거나 순서가 바뀐 것을 감지했습니다",
	"multiplayer.disconnect.banned": "서버에서 차단되었습니다",
	"multiplayer.disconnect.banned.expiration": "\n차단은 %s에 해제됩니다",
	"multiplayer.disconnect.banned.reason": "서버에서 차단되었습니다.\n사유: %s",
	"multiplayer.disconnect.banned.reason.default": "관리자에게 차단당했습니다.",
	...
	"multiplayer.disconnect.code_of_conduct": "서버에 접속하려면 행동 강령에 동의해야 합니다",
	"multiplayer.disconnect.configuration_error": "설정 중 예상치 못한 오류가 발생했습니다",
	...
	"multiplayer.disconnect.transfers_disabled": "이 서버는 전송을 수락하지 않습니다",
	"multiplayer.disconnect.unexpected_query_response": "클라이언트로부터 예기치 않은 사용자 지정 데이터를 수신했습니다",
	"multiplayer.disconnect.unsigned_chat": "서명이 없거나 유효하지 않은 대화 패킷을 받았습니다.",
	...
	"multiplayer.requiredTexturePrompt.disconnect": "이 서버는 사용자 지정 리소스 팩 사용을 요구합니다",
	...
	"multiplayer.status.anonymous_player": "익명 플레이어",
	...
	"music.game.creative.taswell": "C418 - Haunt Muskie",
	...
	"narration.checkbox.usage.focused.check": "체크하려면 Enter를 누르세요",
	"narration.checkbox.usage.focused.uncheck": "체크를 해제하려면 Enter를 누르세요",
	"narration.checkbox.usage.hovered": "바꾸려면 좌클릭하세요",
	"narration.checkbox.usage.hovered.check": "체크하려면 좌클릭하세요",
	"narration.checkbox.usage.hovered.uncheck": "체크를 해제하려면 좌클릭하세요",
	...
	"narration.item": "아이템: %s",
	"narration.link.usage.focused": "링크를 열려면 Enter를 누르세요",
	"narration.link.usage.hovered": "링크를 열려면 좌클릭하세요",
	...
	"narration.slider.usage.focused": "값을 조절하려면 왼쪽 또는 오른쪽 방향키를 누르세요",
	"narration.slider.usage.focused.keyboard_cannot_change_value": "슬라이더 값을 변경하려면 Enter를 누르세요",
	"narration.slider.usage.hovered": "값을 변경하려면 슬라이더를 끌으세요",
	...
	"optimizeWorld.confirm.proceed": "백업 생성 및 최적화",
	...
	"optimizeWorld.stage.finished": "마무리하는 중...",
	"optimizeWorld.stage.finished.chunks": "청크 변환을 마무리하는 중...",
	"optimizeWorld.stage.finished.entities": "개체 변환을 마무리하는 중...",
	"optimizeWorld.stage.finished.poi": "관심 지점 변환을 마무리하는 중...",
	"optimizeWorld.stage.upgrading": "모든 청크를 변환하는 중...",
	"optimizeWorld.stage.upgrading.chunks": "모든 청크를 변환하는 중...",
	"optimizeWorld.stage.upgrading.entities": "모든 개체를 변환하는 중...",
	"optimizeWorld.stage.upgrading.poi": "모든 관심 지점을 변환하는 중...",
	...
	"options.accessibility.high_contrast_block_outline": "고대비 블록 테두리",
	"options.accessibility.high_contrast_block_outline.tooltip": "대상 블록의 블록 테두리 대비를 높입니다.",
	"options.accessibility.link": "접근성 안내",
	"options.accessibility.menu_background_blurriness": "메뉴 배경 흐림",
	"options.accessibility.menu_background_blurriness.tooltip": "메뉴 배경의 흐릿함 정도를 조절합니다.",
	...
	"options.accessibility.tooltip": "접근성 설정",
	"options.allowCursorChanges": "커서 변화 허용",
	"options.allowCursorChanges.tooltip": "특정 UI 요소에서 마우스 커서의 모양 변화를 허용합니다.",
	"options.allowFriendRequests": "요청 허용하기",
	"options.allowFriendRequests.tooltip": "다른 플레이어가 당신에게 친구 요청을 보낼 수 있게 합니다",
	...
	"options.chat.drafts": "보내지 않은 대화 저장",
	"options.chat.drafts.tooltip": "보내지 않은 메시지가 저장되며 다음에 대화를 열었을 때 보낼 수 있습니다.",
	...
	"options.chunkFade": "청크가 나타나는 시간",
	"options.chunkFade.none": "청크가 나타나는 시간: 없음",
	"options.chunkFade.seconds": "청크가 나타나는 시간: %s초",
	"options.chunkFade.tooltip": "청크가 처음 렌더될 때 서서히 나타나는 데 걸리는 초 단위 시간입니다.",
	"options.chunks": "청크 %s개",
	"options.clouds.fancy": "화려하게",
	"options.clouds.fast": "빠르게",
	"options.controls": "조작...",
	"options.credits_and_attribution": "제작진 및 이용 저작물...",
	"options.cutoutLeaves": "나뭇잎 너머 보임",
	"options.cutoutLeaves.tooltip": "나뭇잎 사이를 넘어서 볼 수 있게 됩니다. 껐을 때 성능이 개선될 수 있습니다.",
	...
	"options.directionalAudio.on.tooltip": "3차원 소리를 구현하기 위해 HRTF 기반 지향성 오디오를 사용합니다. HRTF 호환 오디오 장치가 필요하며, 헤드폰에서 사용하는 것이 가장 좋습니다.",
	"options.discrete_mouse_scroll": "별도 스크롤",
	"options.entityDistanceScaling": "개체 거리",
	"options.entityShadows": "개체 그림자",
	"options.exclusiveFullscreen": "독점 전체 화면",
	"options.exclusiveFullscreen.warningTooltip": "이 설정으로 인해 일부 입력 방식이 작동하지 않을 수 있습니다.",
	"options.font": "글꼴 설정...",
	"options.font.title": "글꼴 설정",
	...
	"options.friendsList": "친구 목록",
	"options.friendsList.confirm.message": "친구 목록을 사용하여 친구 요청을 보내고 받으세요.\n\n귀하의 %s으로 온라인 안전 설정을 관리하세요.",
	"options.friendsList.confirm.message.link": "Microsoft 계정",
	"options.friendsList.confirm.title": "친구 목록",
	"options.friendsList.confirm.turnOff": "끄기",
	"options.friendsList.confirm.turnOn": "켜기",
	...
	"options.graphics.custom": "사용자 지정",
	...
	"options.graphics.preset": "사전 설정",
	"options.graphics.preset.tooltip": "\"품질 및 성능\" 설정이 원하는 품질에 알맞는 기본 설정값들로 설정됩니다.",
	...
	"options.graphicsApi": "그래픽 API",
	"options.graphicsApi.default": "기본",
	"options.graphicsApi.opengl": "OpenGL 우선",
	"options.graphicsApi.restart": "그래픽 API를 바꾸려면 게임을 다시 시작해야 합니다.",
	"options.graphicsApi.tooltip": "렌더링에 사용할 그래픽 API입니다. 특별히 바꿀 이유가 없다면 기본으로 두세요!",
	"options.graphicsApi.tooltip.vulkan": "실험적 기능입니다. 일부 시스템의 성능을 저하시키거나 시스템을 불안정하게 만들 수 있습니다.",
	"options.graphicsApi.vulkan": "Vulkan 우선 (실험적 기능)",
	"options.guiScale": "GUI 배율",
	"options.guiScale.auto": "자동",
	"options.hidden": "숨김",
	"options.hideLightningFlashes": "하늘 번쩍임 숨기기",
	"options.hideLightningFlashes.tooltip": "벼락이나 다른 환경적 효과로 인해 하늘이 번쩍이지 않습니다. 번쩍임의 근원 자체는 여전히 보입니다.",
	...
	"options.improvedTransparency": "개선된 투명도",
	"options.improvedTransparency.tooltip": "실험적 기능이며, 화면 셰이더를 사용해서 반투명한 블록과 물 뒤에 날씨, 구름 및 입자를 그립니다.\n이 설정은 GPU 성능에 영향을 줍니다.",
	"options.inGameNotification": "인게임 알림",
	"options.inGameNotification.tooltip": "친구 알림을 인게임에서 표시합니다",
	"options.inactivityFpsLimit": "FPS를 제한할 조건",
	"options.inactivityFpsLimit.afk": "자리 비움",
	"options.inactivityFpsLimit.afk.tooltip": "플레이어 입력이 1분 이상 없는 경우 프레임률을 30으로 제한합니다. 9분이 더 지나면 10으로 더욱 제한합니다.",
	"options.inactivityFpsLimit.minimized": "최소화",
	"options.inactivityFpsLimit.minimized.tooltip": "게임 창이 최소화된 경우에만 프레임률을 제한합니다.",
	"options.invertMouse": "마우스 반전",
	"options.invertMouseX": "마우스 X 반전",
	"options.invertMouseY": "마우스 Y 반전",
	"options.japaneseGlyphVariants": "일본식 자형",
	"options.japaneseGlyphVariants.tooltip": "기본 글꼴에서 한자를 일본식 자형으로 씁니다",
	"options.key.hold": "홀드",
	"options.key.toggle": "토글",
	"options.language": "언어...",
	"options.language.narration": "언어 변경",
	"options.language.title": "언어",
	"options.language.tooltip": "언어 변경",
	...
	"options.maxAnisotropy": "이방성 필터링",
	"options.maxAnisotropy.tooltip": "부드러운 텍스처가 보이는 방식이 크게 향상되지만, 성능에 영향을 주고 비디오 메모리 사용량이 크게 증가합니다. 텍스처 필터링을 이방성으로 설정해야 합니다.",
	...
	"options.musicToast": "음악 알림",
	"options.musicToast.never": "표시하지 않음",
	"options.musicToast.never.tooltip": "음악 알림이 표시되지 않습니다.",
	"options.musicToast.pauseMenu": "일시 정지 메뉴",
	"options.musicToast.pauseMenu.tooltip": "노래가 재생되는 동안에 게임 내 일시 정지 메뉴에서 음악 알림이 상시 표시됩니다.",
	"options.musicToast.pauseMenuAndToast": "일시 정지 메뉴 및 토스트",
	"options.musicToast.pauseMenuAndToast.tooltip": "노래가 재생을 시작했을 때 알림을 표시합니다. 노래가 재생되는 동안에는 게임 내 일시 정지 메뉴에서 동일한 알림이 상시 표시됩니다.",
	"options.music_frequency": "음악 빈도",
	"options.music_frequency.constant": "항상",
	"options.music_frequency.default": "기본",
	"options.music_frequency.frequent": "자주",
	"options.music_frequency.tooltip": "게임 세계 안에서 음악이 재생되는 빈도를 바꿉니다.",
	...
	"options.needsRestart": "설정이 적용되려면 게임을 다시 시작해야 합니다.",
	...
	"options.online": "온라인...",
	"options.online.friends.header": "친구 목록",
	"options.online.realms.header": "Realms",
	"options.online.servers.header": "서버",
	"options.online.title": "온라인 설정",
	"options.online.xboxSettings": "Xbox 설정...",
	...
	"options.realmsNotifications.button": "소식 및 초대",
	"options.realmsNotifications.tooltip": "Realms 소식과 초대를 타이틀 화면에 가져와서 해당 아이콘을 Realms 버튼 위에 표시합니다.",
	"options.reducedDebugInfo": "디버그 정보 축소",
	"options.renderClouds": "구름",
	"options.renderCloudsDistance": "구름 거리",
	"options.renderDistance": "렌더 거리",
	"options.resourcepack": "리소스 팩...",
	"options.restartRequired": "일부 변경 사항은 게임을 다시 시작해야 적용됩니다.",
	"options.rotateWithMinecart": "광산 수레와 함께 회전",
	"options.rotateWithMinecart.tooltip": "광산 수레가 회전할 때 플레이어 시야도 함께 회전할지 여부입니다. '광산 수레 개선' 실험적 기능이 켜진 세계에서만 사용 가능합니다.",
	...
	"options.sharePresence": "상태 표시",
	"options.sharePresence.all": "모두",
	"options.sharePresence.all.tooltip": "상태를 친구와 공유합니다.\n온라인으로 표시되고 당신의 활동을 공유합니다.",
	"options.sharePresence.limited": "제한적",
	"options.sharePresence.limited.tooltip": "상태를 제한적으로 공유합니다. 온라인으로 표시되지만, 활동은 공유하지 않습니다. 이 상태에서도 친구를 당신의 게임에 초대할 수 있습니다.",
	"options.sharePresence.none": "없음",
	"options.sharePresence.none.tooltip": "상태를 공유하지 않습니다. 오프라인으로 표시됩니다.",
	"options.showNowPlayingToast": "음악 알림 표시",
	"options.showNowPlayingToast.tooltip": "노래가 재생을 시작했을 때 알림을 표시합니다. 노래가 재생되는 동안에는 게임 내 일시 정지 메뉴에서 동일한 알림이 상시 표시됩니다.",
	"options.showSubtitles": "자막 표시",
	"options.showSubtitles.tooltip": "게임에서 재생되는 소리의 자막을 표시합니다.",
	...
	"options.sprintWindow": "달리기 시간 간격",
	"options.sprintWindow.tooltip": "앞으로 걷기 키를 두 번 눌렀을 때 달리기가 활성화되는 틱 단위의 시간 간격.",
	"options.telemetry": "원격 측정 데이터...",
	"options.telemetry.button": "데이터 수집",
	"options.telemetry.button.tooltip": "\"%s\"은(는) 필수 데이터만 포함합니다.\n\"%s\"은(는) 필수 데이터뿐만 아니라 선택적 데이터도 포함합니다.",
	"options.telemetry.disabled": "원격 측정이 꺼져 있습니다.",
	"options.telemetry.state.all": "모두",
	"options.telemetry.state.minimal": "최소",
	"options.telemetry.state.none": "없음",
	"options.textureFiltering": "텍스처 필터링",
	"options.textureFiltering.anisotropic": "이방성",
	"options.textureFiltering.anisotropic.tooltip": "하드웨어 기반 필터링 방식이지만, 성능에 영향을 주고 비디오 메모리 사용량이 크게 증가합니다. 일부 하드웨어에서는 지원되지 않을 수 있습니다.",
	"options.textureFiltering.none": "없음",
	"options.textureFiltering.none.tooltip": "필터링 없이 텍스처가 표시됩니다. 블록을 비스듬히 볼 때 흐릿하게 보일 수 있습니다.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(회전 그리드 슈퍼 샘플링)\n중간 정도의 성능 저하로 텍스처 품질을 개선하는 셰이더 기반 필터링 방식입니다.",
	"options.title": "설정",
	"options.touchscreen": "터치스크린 모드",
	"options.value": "%s",
	"options.video": "비디오 설정...",
	"options.video.display.header": "화면",
	"options.video.interface.header": "인터페이스",
	"options.video.preferences.header": "설정",
	"options.video.quality.header": "품질 및 성능",
	"options.videoTitle": "비디오 설정",
	"options.viewBobbing": "화면 흔들림",
	"options.vignette": "비네트 표시",
	"options.vignette.tooltip": "게임 화면의 모서리 부분의 밝기를 줄이고 세계 경계를 경고하는 데 사용되는 옅은 텍스처입니다.",
	"options.visible": "표시",
	"options.vsync": "수직 동기화",
	"options.weatherRadius": "날씨 효과 반지름",
	"options.weatherRadius.tooltip": "비와 눈 효과의 가시거리의 반경입니다. 성능에 미치는 영향은 미미합니다.",
	"options.worldOptions.button": "세계 설정...",
	"options.worldOptions.title": "세계 설정",
	"outOfMemory.message": "Minecraft가 메모리를 전부 사용해 버렸습니다.\n\nJava 가상 머신이 메모리를 충분하게 할당받지 못했거나, 게임의 버그로 인해 발생한 일일 수 있습니다.\n\n세계 손상을 방지하기 위해 진행 중이던 게임을 중단했습니다. 메인 메뉴로 돌아가 플레이를 이어가실 수 있도록 메모리를 충분히 확보하려 노력했으나, 잘 되지 않았을 수도 있습니다.\n\n이 메시지를 다시 보신다면 게임을 다시 시작해 주세요.",
	...
	"pack.incompatible.confirm.unknown": "이 팩은 손상되었거나 알 수 없는 버전의 Minecraft를 위해 만들어졌기에 정상적으로 작동하지 않을 수 있습니다.",
	"pack.incompatible.new": "(상위 Minecraft 버전용)",
	"pack.incompatible.old": "(이전 Minecraft 버전용)",
	"pack.incompatible.unknown": "(손상되거나 호환되지 않음)",
	...
	"parsing.bool.invalid": "잘못된 boolean입니다. 'true' 또는 'false'가 필요하지만 '%s'이(가) 입력되었습니다",
	...
	"particle.invalidOptions": "입자 설정을 해석하는 데 실패했습니다: %s",
	...
	"realms.configuration.region.australia_east": "호주 뉴사우스웨일스",
	"realms.configuration.region.australia_southeast": "호주 빅토리아",
	"realms.configuration.region.brazil_south": "브라질",
	"realms.configuration.region.central_india": "인도",
	"realms.configuration.region.central_us": "미국 아이오와",
	"realms.configuration.region.east_asia": "홍콩",
	"realms.configuration.region.east_us": "미국 버지니아",
	"realms.configuration.region.east_us_2": "미국 노스캐롤라이나",
	"realms.configuration.region.france_central": "프랑스",
	"realms.configuration.region.japan_east": "일본 동부",
	"realms.configuration.region.japan_west": "일본 서부",
	"realms.configuration.region.korea_central": "대한민국",
	"realms.configuration.region.north_central_us": "미국 일리노이",
	"realms.configuration.region.north_europe": "아일랜드",
	"realms.configuration.region.south_central_us": "미국 텍사스",
	"realms.configuration.region.southeast_asia": "싱가포르",
	"realms.configuration.region.sweden_central": "스웨덴",
	"realms.configuration.region.uae_north": "아랍에미리트 (UAE)",
	"realms.configuration.region.uk_south": "잉글랜드 남부",
	"realms.configuration.region.west_central_us": "미국 유타",
	"realms.configuration.region.west_europe": "네덜란드",
	"realms.configuration.region.west_us": "미국 캘리포니아",
	"realms.configuration.region.west_us_2": "미국 워싱턴",
	"realms.configuration.region_preference.automatic_owner": "자동 (Realm 소유자 핑)",
	"realms.configuration.region_preference.automatic_player": "자동 (최초 세션 접속자)",
	...
	"restrictions_screen.button": "제한...",
	"restrictions_screen.permission.receive_player_messages.allowed": "플레이어로부터 메시지를 받을 수 있습니다",
	"restrictions_screen.permission.receive_player_messages.denied": "플레이어로부터 메시지를 받을 수 없습니다",
	"restrictions_screen.permission.receive_system_messages.allowed": "서버로부터 시스템 메시지를 받을 수 있습니다",
	"restrictions_screen.permission.receive_system_messages.denied": "서버로부터 시스템 메시지를 받을 수 없습니다",
	"restrictions_screen.permission.send_commands.allowed": "명령어를 보낼 수 있습니다",
	"restrictions_screen.permission.send_commands.denied": "명령어를 보낼 수 없습니다",
	"restrictions_screen.permission.send_messages.allowed": "대화 메시지를 보낼 수 있습니다",
	"restrictions_screen.permission.send_messages.denied": "대화 메시지를 보낼 수 없습니다",
	"restrictions_screen.title": "제한",
	...
	"selectWorld.allowCommands.new": "명령어 허용",
	...
	"selectWorld.backupQuestion.file_fixing_required": "세계를 업그레이드하기 전에 백업을 만드시겠습니까?",
	...
	"selectWorld.backupWarning.file_fixing_required": "이 세계는 플레이하기 전에 상위 버전으로 업그레이드되어야 합니다. 세계가 손상될 수 있으니 진행하기 전 백업을 만드는 것을 강력히 권장합니다.",
	...
	"selectWorld.gameMode.adventure.info": "서바이벌 모드와 같지만, 블록을 놓거나 부술 수 없습니다.",
	...
	"selectWorld.gameMode.survival.line2": "레벨, 생명력, 배고픔이 있습니다",
	...
	"selectWorld.locked": "실행 중인 다른 Minecraft 인스턴스에 의해 잠겼습니다.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "이 세계는 세계 형식의 내부 변경 사항으로 인해 편집하려면 최신 버전으로 업그레이드해야 합니다.",
	"selectWorld.requiresFileFixingTooltip.play": "이 세계는 세계 형식의 내부 변경 사항으로 인해 플레이하려면 최신 버전으로 업그레이드해야 합니다.",
	"selectWorld.requiresFileFixingTooltip.recreate": "이 세계는 세계 형식의 내부 변경 사항으로 인해 다시 만드려면 최신 버전으로 업그레이드해야 합니다.",
	...
	"selectWorld.upgrade_and_play": "업그레이드 후 플레이",
	...
	"selectWorld.waitingForBackup.message": "세계의 크기에 따라 시간이 다소 걸릴 수 있습니다. 게임을 종료하거나 기기의 전원을 끄지 마세요.",
	"selectWorld.waitingForBackup.title": "백업 생성 중",
	...
	"selectWorld.warning.lowDiskSpace.description": "기기에 남은 공간이 별로 없습니다.\n게임 중 디스크 공간을 다 쓰면 세계가 손상될 수 있습니다.",
	"selectWorld.warning.lowDiskSpace.title": "경고! 디스크 공간 부족!",
	"selectWorld.world": "세계",
	"selectWorld.world_gen_settings_access": "세계 생성 설정 파일을 읽거나 파일에 접근할 수 없습니다! %s",
	"selecteWorld.backupRequiredTooltip": "세계를 불러오려면 먼저 백업을 만들어야 합니다",
	"sign.edit": "표지판 문구 편집",
	"sleep.not_possible": "아무리 휴식을 취해도 오늘 밤을 넘길 수 없습니다",
	"sleep.players_sleeping": "%s/%s 플레이어들이 잠듦",
	"sleep.skipping_night": "잠을 자서 밤을 보냅니다",
	"slot.only_single_allowed": "단일 슬롯이 필요한데, '%s'이(가) 입력되었습니다",
	"slot.unknown": "'%s'은(는) 알 수 없는 슬롯입니다",
	"snbt.parser.empty_key": "키는 비어 있을 수 없습니다",
	"snbt.parser.expected_binary_numeral": "이진수가 필요합니다",
	"snbt.parser.expected_decimal_numeral": "십진수가 필요합니다",
	"snbt.parser.expected_float_type": "부동 소수점 수가 필요합니다",
	"snbt.parser.expected_hex_escape": "길이가 %s인 문자 리터럴이 필요합니다",
	"snbt.parser.expected_hex_numeral": "십육진수가 필요합니다",
	"snbt.parser.expected_integer_type": "정수가 필요합니다",
	"snbt.parser.expected_non_negative_number": "음이 아닌 수가 필요합니다",
	"snbt.parser.expected_number_or_boolean": "수나 불 값이 필요합니다",
	"snbt.parser.expected_string_uuid": "올바른 UUID를 나타내는 문자열이 필요합니다",
	"snbt.parser.expected_unquoted_string": "올바른, 따옴표로 감싸지 않은 문자열이 필요합니다",
	"snbt.parser.infinity_not_allowed": "유한하지 않은 수는 사용할 수 없습니다",
	"snbt.parser.invalid_array_element_type": "잘못된 배열 요소 유형입니다",
	"snbt.parser.invalid_character_name": "잘못된 유니코드 문자 이름입니다",
	"snbt.parser.invalid_codepoint": "잘못된 유니코드 문자 값입니다: %s",
	"snbt.parser.invalid_string_contents": "잘못된 문자열 내용입니다",
	"snbt.parser.invalid_unquoted_start": "따옴표로 감싸지 않은 문자열은 숫자 0-9나 +, -로 시작할 수 없습니다",
	"snbt.parser.leading_zero_not_allowed": "십진수는 0으로 시작할 수 없습니다",
	"snbt.parser.no_such_operation": "연산이 없습니다: %s",
	"snbt.parser.number_parse_failure": "수 해석에 실패했습니다: %s",
	"snbt.parser.undescore_not_allowed": "수의 시작이나 끝에 밑줄 문자는 사용할 수 없습니다",
	"soundCategory.ambient": "분위기/환경",
	"soundCategory.block": "블록",
	"soundCategory.hostile": "적대적 몹",
	"soundCategory.master": "전체 음량",
	"soundCategory.music": "음악",
	"soundCategory.neutral": "친화적 몹",
	"soundCategory.player": "플레이어",
	"soundCategory.record": "주크박스/소리 블록",
	"soundCategory.ui": "UI",
	"soundCategory.voice": "내레이터/음성",
	...
	"stat.minecraft.happy_ghast_one_cm": "행복한 가스트를 타고 이동한 거리",
	...
	"stat.minecraft.nautilus_one_cm": "앵무조개를 타고 이동한 거리",
	...
	"structure_block.mode_info.corner": "모서리 모드 - 설치 및 크기 표지",
	...
	"structure_block.show_boundingbox": "경계 상자 표시:",
	...
	"structure_block.strict": "엄격한 설치:",
	"structure_block.structure_name": "구조물 이름",
	"subtitles.ambient.cave": "오싹한 소리",
	"subtitles.ambient.sound": "오싹한 소리",
	...
	"subtitles.block.campfire.crackle": "모닥불이 타닥거림",
	"subtitles.block.candle.crackle": "초가 타닥거림",
	"subtitles.block.candle.extinguish": "초가 꺼짐",
	...
	"subtitles.block.copper_chest.close": "상자가 닫힘",
	"subtitles.block.copper_chest.open": "상자가 열림",
	...
	"subtitles.block.creaking_heart.hurt": "크리킹의 심장이 울림",
	"subtitles.block.creaking_heart.idle": "오싹한 소리",
	"subtitles.block.creaking_heart.spawn": "크리킹의 심장이 깨어남",
	"subtitles.block.deadbush.idle": "메마른 소리",
	...
	"subtitles.block.dried_ghast.ambient": "말라붙은 소리",
	"subtitles.block.dried_ghast.ambient_water": "마른 가스트가 수분을 흡수함",
	"subtitles.block.dried_ghast.place_in_water": "마른 가스트를 물에 담금",
	"subtitles.block.dried_ghast.transition": "마른 가스트가 기분이 좋아짐",
	"subtitles.block.dry_grass.ambient": "바람 소리",
	...
	"subtitles.block.eyeblossom.close": "눈망울꽃이 눈을 감음",
	"subtitles.block.eyeblossom.idle": "눈망울꽃이 속삭임",
	"subtitles.block.eyeblossom.open": "눈망울꽃이 눈을 뜸",
	"subtitles.block.fence_gate.toggle": "울타리 문이 삐걱거림",
	"subtitles.block.fire.ambient": "불이 타오름",
	"subtitles.block.fire.extinguish": "불이 꺼짐",
	"subtitles.block.firefly_bush.idle": "반딧불이들이 윙윙거림",
	...
	"subtitles.block.generic.fall": "무언가가 블록 위로 떨어짐",
	"subtitles.block.generic.footsteps": "발소리",
	"subtitles.block.generic.hit": "블록이 부서지고 있음",
	"subtitles.block.generic.place": "블록이 놓임",
	...
	"subtitles.block.pale_hanging_moss.idle": "오싹한 소리",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "유황 샘이 분출함",
	"subtitles.block.potent_sulfur.noxious_gas": "유독 가스가 올라옴",
	...
	"subtitles.block.respawn_anchor.ambient": "리스폰 정박기가 웅웅거림",
	"subtitles.block.respawn_anchor.charge": "리스폰 정박기가 충전됨",
	"subtitles.block.respawn_anchor.deplete": "리스폰 정박기가 고갈됨",
	"subtitles.block.respawn_anchor.set_spawn": "리스폰 정박기가 스폰 지점을 설정함",
	"subtitles.block.sand.idle": "모래 소리",
	"subtitles.block.sand.wind": "바람 소리",
	...
	"subtitles.block.sculk_sensor.clicking": "스컬크 감지체가 반응함",
	"subtitles.block.sculk_sensor.clicking_stop": "스컬크 감지체가 반응을 멈춤",
	"subtitles.block.sculk_shrieker.shriek": "스컬크 비명체가 비명을 지름",
	"subtitles.block.shelf.activate": "선반이 활성화됨",
	"subtitles.block.shelf.deactivate": "선반이 비활성화됨",
	"subtitles.block.shelf.multi_swap": "아이템들이 교체됨",
	"subtitles.block.shelf.place_item": "아이템이 배치됨",
	"subtitles.block.shelf.single_swap": "아이템이 교체됨",
	"subtitles.block.shelf.take_item": "아이템을 빼냄",
	"subtitles.block.shulker_box.close": "셜커 상자가 닫힘",
	"subtitles.block.shulker_box.open": "셜커 상자가 열림",
	...
	"subtitles.block.trapdoor.close": "다락문이 닫힘",
	"subtitles.block.trapdoor.open": "다락문이 열림",
	"subtitles.block.trapdoor.toggle": "다락문이 삐걱거림",
	"subtitles.block.trial_spawner.about_to_spawn_item": "불길한 아이템이 준비됨",
	"subtitles.block.trial_spawner.ambient": "시련 생성기가 타오름",
	"subtitles.block.trial_spawner.ambient_charged": "불길한 시련 생성기가 타오름",
	"subtitles.block.trial_spawner.ambient_ominous": "불길한 시련 생성기가 타오름",
	"subtitles.block.trial_spawner.charge_activate": "시련 생성기가 징조에 휩싸임",
	...
	"subtitles.block.trial_spawner.ominous_activate": "시련 생성기가 징조에 휩싸임",
	"subtitles.block.trial_spawner.open_shutter": "시련 생성기가 열림",
	"subtitles.block.trial_spawner.spawn_item": "불길한 아이템이 떨어짐",
	"subtitles.block.trial_spawner.spawn_item_begin": "불길한 아이템이 나타남",
	"subtitles.block.trial_spawner.spawn_mob": "시련 생성기가 몹을 생성함",
	...
	"subtitles.block.vault.activate": "금고에 불이 붙음",
	"subtitles.block.vault.ambient": "금고가 타닥거림",
	"subtitles.block.vault.close_shutter": "금고가 닫힘",
	"subtitles.block.vault.deactivate": "금고의 불이 꺼짐",
	"subtitles.block.vault.eject_item": "금고에서 아이템이 튀어나옴",
	"subtitles.block.vault.insert_item": "금고의 잠금이 풀림",
	"subtitles.block.vault.insert_item_fail": "금고가 아이템을 거부함",
	"subtitles.block.vault.open_shutter": "금고가 열림",
	"subtitles.block.vault.reject_rewarded_player": "금고가 플레이어를 거부함",
	"subtitles.block.water.ambient": "물 흐르는 소리",
	"subtitles.block.wet_sponge.dries": "스펀지가 마름",
	...
	"subtitles.entity.armadillo.ambient": "아르마딜로가 그르렁댐",
	"subtitles.entity.armadillo.brush": "솔질로 인갑을 떨어뜨림",
	"subtitles.entity.armadillo.death": "아르마딜로가 죽음",
	"subtitles.entity.armadillo.eat": "아르마딜로가 먹음",
	"subtitles.entity.armadillo.hurt": "아르마딜로가 상처를 입음",
	"subtitles.entity.armadillo.hurt_reduced": "아르마딜로가 방어함",
	"subtitles.entity.armadillo.land": "아르마딜로가 착지함",
	"subtitles.entity.armadillo.peek": "아르마딜로가 주위를 살핌",
	"subtitles.entity.armadillo.roll": "아르마딜로가 몸을 맒",
	"subtitles.entity.armadillo.scute_drop": "아르마딜로 인갑이 떨어짐",
	"subtitles.entity.armadillo.unroll_finish": "아르마딜로가 몸을 풂",
	"subtitles.entity.armadillo.unroll_start": "아르마딜로가 주위를 살핌",
	...
	"subtitles.entity.baby_cat.ambient": "새끼 고양이가 욺",
	"subtitles.entity.baby_cat.beg_for_food": "새끼 고양이가 구걸함",
	"subtitles.entity.baby_cat.death": "새끼 고양이가 죽음",
	"subtitles.entity.baby_cat.eat": "새끼 고양이가 먹음",
	"subtitles.entity.baby_cat.hiss": "새끼 고양이가 쉬익거림",
	"subtitles.entity.baby_cat.hurt": "새끼 고양이가 상처를 입음",
	"subtitles.entity.baby_cat.purr": "새끼 고양이가 가르랑거림",
	"subtitles.entity.baby_chicken.ambient": "병아리가 삐약거림",
	"subtitles.entity.baby_chicken.death": "병아리가 죽음",
	"subtitles.entity.baby_chicken.hurts": "병아리가 상처를 입음",
	"subtitles.entity.baby_horse.ambient": "망아지가 히이잉거림",
	"subtitles.entity.baby_horse.angry": "망아지가 히이잉거림",
	"subtitles.entity.baby_horse.breathe": "망아지가 숨을 들이쉼",
	"subtitles.entity.baby_horse.death": "망아지가 죽음",
	"subtitles.entity.baby_horse.eat": "망아지가 먹음",
	"subtitles.entity.baby_horse.hurt": "망아지가 상처를 입음",
	"subtitles.entity.baby_horse.land": "망아지가 착지함",
	"subtitles.entity.baby_nautilus.ambient": "새끼 앵무조개가 지저귐",
	"subtitles.entity.baby_nautilus.ambient_land": "새끼 앵무조개가 지저귐",
	"subtitles.entity.baby_nautilus.death": "새끼 앵무조개가 죽음",
	"subtitles.entity.baby_nautilus.death_land": "새끼 앵무조개가 죽음",
	"subtitles.entity.baby_nautilus.eat": "새끼 앵무조개가 먹음",
	"subtitles.entity.baby_nautilus.hurt": "새끼 앵무조개가 상처를 입음",
	"subtitles.entity.baby_nautilus.hurt_land": "새끼 앵무조개가 상처를 입음",
	"subtitles.entity.baby_nautilus.swim": "새끼 앵무조개가 헤엄침",
	"subtitles.entity.baby_pig.ambient": "새끼 돼지가 꿀꿀거림",
	"subtitles.entity.baby_pig.death": "새끼 돼지가 죽음",
	"subtitles.entity.baby_pig.eat": "새끼 돼지가 먹음",
	"subtitles.entity.baby_pig.hurt": "새끼 돼지가 상처를 입음",
	"subtitles.entity.baby_wolf.ambient": "새끼 늑대가 욺",
	"subtitles.entity.baby_wolf.death": "새끼 늑대가 죽음",
	"subtitles.entity.baby_wolf.growl": "새끼 늑대가 으르렁거림",
	"subtitles.entity.baby_wolf.hurt": "새끼 늑대가 상처를 입음",
	"subtitles.entity.baby_wolf.pant": "새끼 늑대가 헐떡임",
	"subtitles.entity.baby_wolf.whine": "새끼 늑대가 낑낑거림",
	...
	"subtitles.entity.bogged.ambient": "보그드가 달그락거림",
	"subtitles.entity.bogged.death": "보그드가 죽음",
	"subtitles.entity.bogged.hurt": "보그드가 상처를 입음",
	"subtitles.entity.breeze.charge": "브리즈가 바람을 모음",
	"subtitles.entity.breeze.death": "브리즈가 죽음",
	"subtitles.entity.breeze.deflect": "브리즈가 튕겨냄",
	...
	"subtitles.entity.breeze.whirl": "브리즈가 소용돌이침",
	"subtitles.entity.breeze.wind_burst": "돌풍구가 터짐",
	...
	"subtitles.entity.camel_husk.ambient": "낙타 허스크가 으르렁거림",
	"subtitles.entity.camel_husk.dash": "낙타 허스크가 돌진함",
	"subtitles.entity.camel_husk.dash_ready": "낙타 허스크가 회복함",
	"subtitles.entity.camel_husk.death": "낙타 허스크가 죽음",
	"subtitles.entity.camel_husk.eat": "낙타 허스크가 먹음",
	"subtitles.entity.camel_husk.hurt": "낙타 허스크가 상처를 입음",
	"subtitles.entity.camel_husk.saddle": "안장을 장착함",
	"subtitles.entity.camel_husk.sit": "낙타 허스크가 앉음",
	"subtitles.entity.camel_husk.stand": "낙타 허스크가 일어섬",
	...
	"subtitles.entity.copper_golem.death": "구리 골렘이 죽음",
	"subtitles.entity.copper_golem.hurt": "구리 골렘이 상처를 입음",
	"subtitles.entity.copper_golem.item_drop": "구리 골렘이 아이템을 넣고 있음",
	"subtitles.entity.copper_golem.item_no_drop": "구리 골렘이 아이템을 넣지 못함",
	"subtitles.entity.copper_golem.no_item_get": "구리 골렘이 아이템을 집음",
	"subtitles.entity.copper_golem.no_item_no_get": "구리 골렘이 아이템을 집지 못함",
	"subtitles.entity.copper_golem.spawn": "구리 골렘이 나타남",
	"subtitles.entity.copper_golem.spin": "구리 골렘의 머리가 회전함",
	"subtitles.entity.copper_golem_become_statue": "구리 골렘이 굳음",
	"subtitles.entity.copper_golem_oxidized.death": "구리 골렘이 죽음",
	"subtitles.entity.copper_golem_oxidized.hurt": "구리 골렘이 상처를 입음",
	"subtitles.entity.copper_golem_oxidized.spin": "구리 골렘의 머리가 회전함",
	"subtitles.entity.copper_golem_weathered.death": "구리 골렘이 죽음",
	"subtitles.entity.copper_golem_weathered.hurt": "구리 골렘이 상처를 입음",
	"subtitles.entity.copper_golem_weathered.spin": "구리 골렘의 머리가 회전함",
	...
	"subtitles.entity.creaking.activate": "크리킹이 주시함",
	"subtitles.entity.creaking.ambient": "크리킹이 삐걱거림",
	"subtitles.entity.creaking.attack": "크리킹이 공격함",
	"subtitles.entity.creaking.deactivate": "크리킹이 잠잠해짐",
	"subtitles.entity.creaking.death": "크리킹이 부서짐",
	"subtitles.entity.creaking.freeze": "크리킹이 멈춤",
	"subtitles.entity.creaking.spawn": "크리킹이 나타남",
	"subtitles.entity.creaking.sway": "크리킹이 공격을 받음",
	"subtitles.entity.creaking.twitch": "크리킹이 덜덜 떪",
	"subtitles.entity.creaking.unfreeze": "크리킹이 움직임",
	...
	"subtitles.entity.donkey.jump": "당나귀가 뜀",
	...
	"subtitles.entity.fish.swim": "첨벙거리는 소리",
	...
	"subtitles.entity.ghastling.ambient": "가스틀링이 옹알거림",
	"subtitles.entity.ghastling.death": "가스틀링이 죽음",
	"subtitles.entity.ghastling.hurt": "가스틀링이 상처를 입음",
	"subtitles.entity.ghastling.spawn": "가스틀링이 나타남",
	...
	"subtitles.entity.happy_ghast.ambient": "행복한 가스트가 흥얼거림",
	"subtitles.entity.happy_ghast.death": "행복한 가스트가 죽음",
	"subtitles.entity.happy_ghast.equip": "하네스를 씌움",
	"subtitles.entity.happy_ghast.harness_goggles_down": "행복한 가스트가 준비됨",
	"subtitles.entity.happy_ghast.harness_goggles_up": "행복한 가스트가 멈춤",
	"subtitles.entity.happy_ghast.hurt": "행복한 가스트가 상처를 입음",
	"subtitles.entity.happy_ghast.unequip": "하네스를 벗김",
	...
	"subtitles.entity.minecart.inside": "광산 수레가 덜컹거림",
	"subtitles.entity.minecart.inside_underwater": "광산 수레가 물 속에서 덜컹거림",
	...
	"subtitles.entity.mule.jump": "노새가 뜀",
	"subtitles.entity.nautilus.ambient": "앵무조개가 딱딱 소리를 냄",
	"subtitles.entity.nautilus.ambient_land": "앵무조개가 딱딱 소리를 냄",
	"subtitles.entity.nautilus.dash": "앵무조개가 빠르게 나아감",
	"subtitles.entity.nautilus.dash_land": "앵무조개가 빠르게 나아감",
	"subtitles.entity.nautilus.dash_ready": "앵무조개가 회복함",
	"subtitles.entity.nautilus.dash_ready_land": "앵무조개가 회복함",
	"subtitles.entity.nautilus.death": "앵무조개가 죽음",
	"subtitles.entity.nautilus.death_land": "앵무조개가 죽음",
	"subtitles.entity.nautilus.eat": "앵무조개가 먹음",
	"subtitles.entity.nautilus.hurt": "앵무조개가 상처를 입음",
	"subtitles.entity.nautilus.hurt_land": "앵무조개가 상처를 입음",
	"subtitles.entity.nautilus.swim": "앵무조개가 헤엄침",
	...
	"subtitles.entity.parched.ambient": "파치트가 달그락거림",
	"subtitles.entity.parched.death": "파치트가 죽음",
	"subtitles.entity.parched.hurt": "파치트가 상처를 입음",
	...
	"subtitles.entity.parrot.imitate.bogged": "앵무새가 달그락거리는 소리를 흉내 냄",
	"subtitles.entity.parrot.imitate.breeze": "앵무새가 돌아가는 소리를 흉내 냄",
	"subtitles.entity.parrot.imitate.camel_husk": "앵무새가 으르렁거리는 소리를 흉내 냄",
	"subtitles.entity.parrot.imitate.creaking": "앵무새가 삐걱거리는 소리를 흉내 냄",
	...
	"subtitles.entity.parrot.imitate.parched": "앵무새가 달그락거리는 소리를 흉내 냄",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "앵무새가 그르렁거리는 소리를 흉내 냄",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "앵무새가 보글보글 소리를 흉내 냄",
	...
	"subtitles.entity.pig.eat": "돼지가 먹음",
	...
	"subtitles.entity.piglin.jealous": "피글린이 부러운 듯 욺",
	...
	"subtitles.entity.polar_bear.ambient_baby": "새끼 북극곰이 흥얼거림",
	...
	"subtitles.entity.skeleton_horse.jump_water": "스켈레톤 말이 뜀",
	...
	"subtitles.entity.sulfur_cube.absorb": "유황 큐브가 참",
	"subtitles.entity.sulfur_cube.bounce": "유황 큐브가 튕김",
	"subtitles.entity.sulfur_cube.death": "유황 큐브가 죽음",
	"subtitles.entity.sulfur_cube.eject": "블록을 제거함",
	"subtitles.entity.sulfur_cube.hit": "유황 큐브를 밀침",
	"subtitles.entity.sulfur_cube.hurt": "유황 큐브가 상처를 입음",
	"subtitles.entity.sulfur_cube.push": "유황 큐브가 밀려남",
	"subtitles.entity.sulfur_cube.squish": "유황 큐브가 튕김",
	...
	"subtitles.entity.turtle.death_baby": "새끼 거북이 죽음",
	...
	"subtitles.entity.turtle.hurt_baby": "새끼 거북이 상처를 입음",
	"subtitles.entity.turtle.lay_egg": "거북이 알을 낳음",
	"subtitles.entity.turtle.shamble": "거북이 어기적거림",
	"subtitles.entity.turtle.shamble_baby": "새끼 거북이 어기적거림",
	...
	"subtitles.entity.wind_charge.throw": "돌풍구가 날아감",
	"subtitles.entity.wind_charge.wind_burst": "돌풍구가 터짐",
	...
	"subtitles.entity.zombie_horse.angry": "좀비 말이 히이잉거림",
	"subtitles.entity.zombie_horse.death": "좀비 말이 죽음",
	"subtitles.entity.zombie_horse.eat": "좀비 말이 먹음",
	"subtitles.entity.zombie_horse.hurt": "좀비 말이 상처를 입음",
	"subtitles.entity.zombie_nautilus.ambient": "좀비 앵무조개가 보글보글 소리를 냄",
	"subtitles.entity.zombie_nautilus.ambient_land": "좀비 앵무조개가 보글보글 소리를 냄",
	"subtitles.entity.zombie_nautilus.dash": "좀비 앵무조개가 빠르게 나아감",
	"subtitles.entity.zombie_nautilus.dash_land": "좀비 앵무조개가 빠르게 나아감",
	"subtitles.entity.zombie_nautilus.dash_ready": "좀비 앵무조개가 회복함",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "좀비 앵무조개가 회복함",
	"subtitles.entity.zombie_nautilus.death": "좀비 앵무조개가 죽음",
	"subtitles.entity.zombie_nautilus.death_land": "좀비 앵무조개가 죽음",
	"subtitles.entity.zombie_nautilus.eat": "좀비 앵무조개가 먹음",
	"subtitles.entity.zombie_nautilus.hurt": "좀비 앵무조개가 상처를 입음",
	"subtitles.entity.zombie_nautilus.hurt_land": "좀비 앵무조개가 상처를 입음",
	"subtitles.entity.zombie_nautilus.swim": "좀비 앵무조개가 헤엄침",
	...
	"subtitles.event.mob_effect.bad_omen": "징조가 나타남",
	"subtitles.event.mob_effect.raid_omen": "습격이 근처에 나타남",
	"subtitles.event.mob_effect.trial_omen": "불길한 시련이 근처에 나타남",
	"subtitles.event.raid.horn": "불길한 나팔 소리가 울려 퍼짐",
	"subtitles.item.armor.equip": "장비를 장착함",
	"subtitles.item.armor.equip_chain": "사슬 갑옷이 짤랑거림",
	"subtitles.item.armor.equip_copper": "구리 갑옷이 덜컹거림",
	...
	"subtitles.item.armor.equip_nautilus": "앵무조개 갑옷을 장착함",
	"subtitles.item.armor.equip_netherite": "네더라이트 갑옷이 철커덕거림",
	"subtitles.item.armor.equip_turtle": "거북 등딱지가 턱 소리를 냄",
	"subtitles.item.armor.equip_wolf": "늑대 갑옷을 입힘",
	"subtitles.item.armor.unequip_nautilus": "앵무조개 갑옷을 벗김",
	"subtitles.item.armor.unequip_wolf": "늑대 갑옷을 벗김",
	...
	"subtitles.item.brush.brushing.gravel": "자갈 솔질",
	"subtitles.item.brush.brushing.gravel.complete": "자갈 솔질을 끝냄",
	"subtitles.item.brush.brushing.sand": "모래 솔질",
	"subtitles.item.brush.brushing.sand.complete": "모래 솔질을 끝냄",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "유황 큐브를 퍼냄",
	...
	"subtitles.item.bundle.insert_fail": "꾸러미가 꽉 참",
	...
	"subtitles.item.elytra.flying": "쌩하는 소리",
	...
	"subtitles.item.goat_horn.play": "염소 뿔이 울림",
	"subtitles.item.golden_dandelion.unuse": "황금 민들레로 성장을 재개함",
	"subtitles.item.golden_dandelion.use": "황금 민들레로 성장을 멈춤",
	"subtitles.item.hoe.till": "괭이로 땅을 갊",
	"subtitles.item.honey_bottle.drink": "꿀을 마심",
	"subtitles.item.honeycomb.wax_on": "밀랍칠함",
	"subtitles.item.horse_armor.unequip": "말 갑옷을 벗김",
	"subtitles.item.ink_sac.use": "먹물 주머니를 묻힘",
	"subtitles.item.lead.break": "끈이 끊어짐",
	"subtitles.item.lead.tied": "끈을 묶음",
	"subtitles.item.lead.untied": "끈을 풂",
	"subtitles.item.llama_carpet.unequip": "양탄자를 벗김",
	"subtitles.item.lodestone_compass.lock": "자석석 나침반이 자석석에 고정됨",
	"subtitles.item.mace.smash_air": "철퇴로 내려침",
	"subtitles.item.mace.smash_ground": "철퇴로 내려침",
	"subtitles.item.nautilus_saddle_equip": "안장을 장착함",
	"subtitles.item.nautilus_saddle_underwater_equip": "안장을 장착함",
	"subtitles.item.nether_wart.plant": "작물을 심음",
	"subtitles.item.ominous_bottle.dispose": "병이 부서짐",
	"subtitles.item.saddle.unequip": "안장을 벗김",
	"subtitles.item.shears.shear": "가위가 찰칵함",
	"subtitles.item.shears.snip": "가위가 싹둑거림",
	"subtitles.item.shield.block": "방패로 막음",
	"subtitles.item.shovel.flatten": "삽으로 땅을 다짐",
	"subtitles.item.spear.attack": "창으로 찌름",
	"subtitles.item.spear.hit": "창이 적중함",
	"subtitles.item.spear.lunge": "창으로 돌진함",
	"subtitles.item.spear.use": "창을 겨눔",
	"subtitles.item.spear_wood.attack": "창으로 찌름",
	"subtitles.item.spear_wood.hit": "창이 적중함",
	"subtitles.item.spear_wood.use": "창을 겨눔",
	...
	"subtitles.item.underwater_saddle.equip": "안장을 장착함",
	"subtitles.item.wolf_armor.break": "늑대 갑옷이 부서짐",
	"subtitles.item.wolf_armor.crack": "늑대 갑옷에 금이 감",
	"subtitles.item.wolf_armor.damage": "늑대 갑옷이 피해를 입음",
	"subtitles.item.wolf_armor.repair": "늑대 갑옷을 수리함",
	"subtitles.particle.soul_escape": "영혼이 빠져나감",
	"subtitles.ui.cartography_table.take_result": "지도를 작성함",
	"subtitles.ui.hud.bubble_pop": "호흡 수치가 떨어짐",
	"subtitles.ui.loom.take_result": "베틀이 사용됨",
	"subtitles.ui.stonecutter.take_result": "석재 절단기가 사용됨",
	"subtitles.weather.end_flash": "엔드 섬광이 번쩍거림",
	...
	"telemetry.event.graphics_capabilities.description": "이 이벤트는 게임 플레이에 사용하는 그래픽 장치의 사양을 보고합니다.",
	"telemetry.event.graphics_capabilities.title": "그래픽 지원 사양",
	"telemetry.event.optional": "%s (선택적)",
	"telemetry.event.optional.disabled": "%s (선택적) - 꺼짐",
	"telemetry.event.p2p_connection.description": "이 이벤트는 플레이어 간 P2P 연결의 신뢰성과 성능을 파악하는 데 사용됩니다. 연결 성공 여부, 상호 연결 구축 (ICE, P2P 연결 구축에 사용하는 프로토콜) 후보 유형 및 연결에 소요된 시간을 기록합니다.",
	"telemetry.event.p2p_connection.title": "P2P 연결",
	...
	"telemetry.property.backend_failure_message.title": "백엔드 생성 실패 메시지",
	"telemetry.property.backend_failure_missing_capabilities.title": "백엔드 생성 실패 누락 기능",
	"telemetry.property.backend_failure_reason.title": "백엔드 생성 실패 이유",
	"telemetry.property.backend_name.title": "백엔드 이름",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "실패 단계",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "상호 연결 구축 (ICE) 연결 시간 (밀리초)",
	"telemetry.property.p2p_connection_ice_path.title": "상호 연결 구축 (ICE) 경로",
	"telemetry.property.p2p_connection_local_candidate_type.title": "로컬 후보 유형",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "원격 후보 유형",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "신호 연결 시간 (밀리초)",
	"telemetry.property.p2p_connection_successful.title": "연결 성공",
	"telemetry.property.p2p_connection_total_time_ms.title": "총합 연결 시간 (밀리초)",
	...
	"test.error.block_property_mismatch": "%s 속성이 %s(이)어야 하는데, %s(이)었습니다",
	"test.error.block_property_missing": "블록 속성이 누락됐습니다. %s 속성이 %s이어야 합니다",
	"test.error.entity_property": "%s 개체가 테스트에 실패했습니다: %s",
	"test.error.entity_property_details": "%s 개체가 테스트에 실패했습니다: %s. %s이(가) 필요한데, %s(이)었습니다",
	"test.error.expected_block": "%s 블록이 필요한데, %s(이)었습니다",
	"test.error.expected_block_present": "블록 %s이(가) 존재해야 합니다",
	"test.error.expected_block_tag": "#%s에 속하는 블록이 필요한데, %s(이)었습니다",
	"test.error.expected_container_contents": "용기가 다음을 포함해야 합니다: %s",
	"test.error.expected_container_contents_single": "용기가 다음을 하나 포함해야 합니다: %s",
	"test.error.expected_empty_container": "용기가 비어 있어야 합니다",
	"test.error.expected_entity": "%s이(가) 필요합니다",
	"test.error.expected_entity_around": "%[2]s, %[3]s, %[4]s 주변에 %1$이(가) 있어야 합니다",
	"test.error.expected_entity_count": "%[2]s 유형의 개체 %[1]s개가 필요한데, %[3]s개가 있었습니다",
	"test.error.expected_entity_data": "개체 데이터가 %s(이)어야 하는데, %s(이)었습니다",
	"test.error.expected_entity_data_predicate": "%s의 개체 데이터가 일치하지 않았습니다",
	"test.error.expected_entity_effect": "%s이(가) %s %s 효과를 갖고 있어야 합니다",
	"test.error.expected_entity_having": "개체 보관함이 %s을(를) 포함해아 합니다",
	"test.error.expected_entity_holding": "개체가 %s을(를) 들고 있어야 합니다",
	"test.error.expected_entity_in_test": "테스트 안에 %s이(가) 있어야 합니다",
	"test.error.expected_entity_not_touching": "%s이(가) %s, %s, %s (상대 좌표: %s, %s, %s)에 닿아 있으면 안 됩니다",
	"test.error.expected_entity_touching": "%s이(가) %s, %s, %s (상대 좌표: %s, %s, %s)에 닿아 있어야 합니다",
	"test.error.expected_item": "%s 유형의 아이템이 필요합니다",
	"test.error.expected_items_count": "%[2]s 유형의 아이템 %[1]s개가 필요한데, %[3]s개가 있었습니다",
	"test.error.fail": "실패 조건을 충족했습니다",
	"test.error.invalid_block_type": "예기치 않은 블록 유형입니다: %s",
	"test.error.missing_block_entity": "블록 개체가 누락되었습니다",
	"test.error.not_a_block_item": "주어진 블록은 블록 아이템이 아닙니다",
	"test.error.position": "%s (절대 좌표: %s, %s, %s. 상대 좌표: %s, %s, %s. 틱 %s)",
	"test.error.sequence.condition_already_triggered": "조건이 %s에 이미 발동했습니다",
	"test.error.sequence.condition_not_triggered": "조건이 발동하지 않았습니다",
	"test.error.sequence.invalid_tick": "%s이(가) 아닌 잘못된 틱에 성공했습니다",
	"test.error.sequence.minimum_tick": "예상된 %s보다 빨리 성공했습니다",
	"test.error.sequence.not_completed": "시퀀스가 완료되기 전에 테스트가 시간 초과되었습니다",
	"test.error.set_biome": "테스트를 위해 생물 군계를 설정하는 데 실패했습니다",
	"test.error.spawn_failure": "%s 개체 생성에 실패했습니다",
	"test.error.state_not_equal": "잘못된 상태입니다. %s이(가) 필요한데, %s(이)었습니다",
	"test.error.structure.failure": "%s의 테스트 구조물 설치에 실패했습니다",
	"test.error.tick": "%s (틱 %s)",
	"test.error.ticking_without_structure": "구조물 설치 전에 테스트를 틱하려 했습니다",
	"test.error.timeout.no_result": "%s틱 안에 성공하거나 실패하지 않았습니다",
	"test.error.timeout.no_sequences_finished": "%s틱 안에 끝난 시퀀스가 없습니다",
	"test.error.too_many_entities": "%[2]s, %[3]s, %[4]s 주위에 %[1]s이(가) 하나 있어야 하는데, %[5]s개가 있었습니다",
	"test.error.unexpected_block": "%s 블록이 있으면 안 됩니다",
	"test.error.unexpected_entity": "%s이(가) 있으면 안 됩니다",
	"test.error.unexpected_item": "%s 유형의 아이템이 있으면 안 됩니다",
	"test.error.unknown": "알 수 없는 내부 오류: %s",
	"test.error.value_not_equal": "%s이(가) %s(이)어야 하는데, %s(이)었습니다",
	"test.error.value_not_in_between": "%s이(가) %s과(와) %s 사이에 있어야 하는데, %s이었습니다",
	"test.error.wrong_block_entity": "잘못된 블록 개체 유형입니다: %s",
	"test_block.error.missing": "테스트 구조물에 %s 블록이 없습니다",
	"test_block.error.too_many": "%s 블록이 너무 많습니다",
	"test_block.invalid_timeout": "잘못된 타임아웃입니다 (%s) - 양수 틱이어야 합니다",
	"test_block.message": "메시지:",
	"test_block.mode.accept": "인정",
	"test_block.mode.fail": "실패",
	"test_block.mode.log": "기록",
	"test_block.mode.start": "시작",
	"test_block.mode_info.accept": "인정 모드 - 테스트 (일부)의 성공을 인정합니다",
	"test_block.mode_info.fail": "실패 모드 - 테스트를 실패시킵니다",
	"test_block.mode_info.log": "기록 모드 - 메시지를 기록합니다",
	"test_block.mode_info.start": "시작 모드 - 테스트의 시작 지점입니다",
	"test_instance.action.reset": "초기화하고 불러오기",
	"test_instance.action.run": "불러오고 실행",
	"test_instance.action.save": "구조물 저장",
	"test_instance.description.batch": "환경: %s",
	"test_instance.description.failed": "실패: %s",
	"test_instance.description.function": "함수: %s",
	"test_instance.description.invalid_id": "잘못된 테스트 ID입니다",
	"test_instance.description.no_test": "해당하는 테스트 없음",
	"test_instance.description.structure": "구조물: %s",
	"test_instance.description.type": "유형: %s",
	"test_instance.type.block_based": "블록 기반 테스트",
	"test_instance.type.function": "내장 함수 테스트",
	"test_instance_block.entities": "개체:",
	"test_instance_block.error.no_test": "정의되지 않은 테스트를 가지고 있어 %s, %s, %s에 있는 테스트 인스턴스를 실행할 수 없습니다",
	"test_instance_block.error.no_test_structure": "테스트 구조물이 없어 %s, %s, %s에 있는 테스트 인스턴스를 실행할 수 없습니다",
	"test_instance_block.error.unable_to_save": "%s, %s, %s에 있는 테스트 인스턴스의 테스트 구조물 템플릿을 저장할 수 없습니다",
	"test_instance_block.invalid": "[잘못됨]",
	"test_instance_block.reset_success": "테스트 %s을(를) 초기화하는 데 성공했습니다",
	"test_instance_block.rotation": "회전:",
	"test_instance_block.size": "테스트 구조물 크기",
	"test_instance_block.starting": "테스트 %s을(를) 시작합니다",
	"test_instance_block.test_id": "테스트 인스턴스 ID",
	...
	"title.multiplayer.online": "멀티플레이 (온라인)",
	...
	"trim_material.minecraft.resin": "수지 소재",
	"trim_pattern.minecraft.bolt": "나사 갑옷 장식",
	"trim_pattern.minecraft.coast": "해안 갑옷 장식",
	"trim_pattern.minecraft.dune": "사구 갑옷 장식",
	"trim_pattern.minecraft.eye": "눈 갑옷 장식",
	"trim_pattern.minecraft.flow": "흐름 갑옷 장식",
	...
	"upgradeWorld.aborted.message": "세계 업그레이드 중 다른 프로그램이 세계에 접근했을 때 발생할 수 있습니다.\n컴퓨터를 재시작한 후 다시 시도하면 해결될 수 있습니다. 문제가 계속 발생한다면, 버그를 제보해 주세요.",
	"upgradeWorld.aborted.reportBug": "버그 제보하기",
	"upgradeWorld.aborted.title": "세계를 업그레이드하는 데 실패했습니다",
	"upgradeWorld.canceled.message": "세계가 이전과 같이 유지됩니다.",
	"upgradeWorld.canceled.title": "세계 업그레이드가 취소되었습니다",
	"upgradeWorld.done": "세계 업그레이드 완료",
	"upgradeWorld.failed_cleanup.message": "성공적으로 세계를 현재 버전으로 업그레이드 되었으며, 이제 세계 목록에서 사용할 수 있습니다.\n구 버전 데이터를 정리하던 중 문제가 발생하여, 세계 폴더의 이름이 %s(으)로 변경되었습니다.",
	"upgradeWorld.failed_cleanup.title": "성공적으로 세계를 업그레이드 했습니다",
	"upgradeWorld.info.converted": "업그레이드: %s",
	"upgradeWorld.info.file_fix_stage": "단계: %s/%s",
	"upgradeWorld.info.scanning": "파일 스캔 중...",
	"upgradeWorld.info.total": "전체: %s개",
	"upgradeWorld.joinNow": "세계에 바로 참여하시겠습니까?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "파일 이동 중",
	"upgradeWorld.progress.type.legacy_structures": "기존 구조물 업그레이드 중",
	"upgradeWorld.progress.type.region": "지역 업그레이드 중",
	"upgradeWorld.symlink.message": "선택한 세계에 심볼릭 링크가 있습니다.\n세계를 현재 버전으로 업그레이드하는 데 필요한 절차에서는 심볼릭 링크를 지원하지 않습니다. 세계를 업그레이드하려면, 먼저 링크 문제를 해결해야 합니다.",
	"upgradeWorld.symlink.title": "세계를 업그레이드할 수 없습니다",
	"upgradeWorld.title": "세계 파일 업그레이드 중",
}
