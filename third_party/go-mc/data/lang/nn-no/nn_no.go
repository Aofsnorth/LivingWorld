// Code generated by tools/gen_lang.go from 26.1/nn_no.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"addServer.resourcePack.enabled": "Påslege",
	...
	"advMode.notEnabled.spawner": "Skapningsframkallarar er ikkje slegne på på denne tenaren",
	"advMode.previousOutput": "Førre utgjæv",
	"advMode.setCommand": "Set konsollkommando for blokk",
	"advMode.setCommand.disabled": "Kommando vart sett: %s, men kommandoblokker er framleis slege av",
	...
	"advancements.adventure.arbalistic.description": "Drep fem særskilde skapningar med eitt låsbogeskot",
	"advancements.adventure.arbalistic.title": "Låsbogeskytar",
	...
	"advancements.adventure.blowback.description": "Drep eit vindskrømt med ei bægd vindkule frå eit vindskrømt",
	"advancements.adventure.blowback.title": "Atterblåster",
	"advancements.adventure.brush_armadillo.description": "Få skjoldplater frå eit beltedyr ved å bruke ei børste",
	"advancements.adventure.brush_armadillo.title": "Skjoldan vare",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Gjer ei prydd potte med 4 skålbrot",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Varsam vøling",
	"advancements.adventure.crafters_crafting_crafters.description": "Ver nær ein emnar når han emnar ein emnar",
	"advancements.adventure.crafters_crafting_crafters.title": "Emnarar emnar emnarar",
	...
	"advancements.adventure.fall_from_world_height.title": "Hòler og hamrar",
	"advancements.adventure.heart_transplanter.description": "Set ned eit knirkehjarta med den rette oppsetnaden mellom to bleikeikestomnar",
	"advancements.adventure.heart_transplanter.title": "Med hjarta på rette staden",
	...
	"advancements.adventure.lighten_up.description": "Skrap ei koparpære med ei øks for å gjera henne ljosare",
	"advancements.adventure.lighten_up.title": "Opplysande",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Ta deg inn i eit røynerom",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Røyneutgåva",
	"advancements.adventure.ol_betsy.description": "Skyt med låsboge",
	"advancements.adventure.ol_betsy.title": "Skytaren",
	"advancements.adventure.overoverkill.description": "Påfør skade på 50 hjarto med eitt einskilt stridsklubbeslag",
	"advancements.adventure.overoverkill.title": "Over-overmål",
	...
	"advancements.adventure.revaulting.description": "Lås opp eit illevarande kvelv med ein illevarande røynelykel",
	"advancements.adventure.revaulting.title": "Ikkje så kvelvmeint",
	"advancements.adventure.root.description": "Eventyr, utforsking, og strid",
	"advancements.adventure.root.title": "Eventyr",
	"advancements.adventure.salvage_sherd.description": "Kosta ei mistenkjeleg blokk for å få tak i skålbrot",
	...
	"advancements.adventure.spear_many_mobs.description": "Høv fem skapningar i eitt og same spjutkast",
	"advancements.adventure.spear_many_mobs.title": "Grillspjut",
	...
	"advancements.adventure.throw_trident.description": "Kasta ei ljoster åt noko.\nHugsa: Å kasta bort det einaste våpenet ditt er ikkje særleg klokt.",
	...
	"advancements.adventure.trim_with_any_armor_pattern.description": "Laga ei prydd rustning på eit smiebord",
	...
	"advancements.adventure.under_lock_and_key.description": "Bruka ei røynelykel på eit kvelv",
	"advancements.adventure.under_lock_and_key.title": "Bak lås og slå",
	"advancements.adventure.use_lodestone.description": "Bruka eit kompass på ein leidarstein",
	...
	"advancements.adventure.who_needs_rockets.description": "Bruka ei vindlading til å skyta deg opp 7 blokker",
	"advancements.adventure.who_needs_rockets.title": "Kven treng rakettar?",
	...
	"advancements.husbandry.netherite_hoe.description": "Bruk ein netherittbarre til å betra ein ljå, og tenk på ny over livsvala dine",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Plasser ei uttørka ghast-blokk i vatn",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Sløkk tørsten!",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Fjern ulverustning frå ein ulv med ei saks",
	"advancements.husbandry.remove_wolf_armor.title": "Klippande genialt",
	"advancements.husbandry.repair_wolf_armor.description": "Reparer skadd ulverustning med beltedyrskjoldplater",
	...
	"advancements.husbandry.uh_oh.title": "Dette såg ikkje bra ut",
	...
	"advancements.husbandry.whole_pack.description": "Tem ein varg av kvart slag",
	...
	"advancements.nether.ride_strider.description": "Ri på ein stegar med ein vridesopp på stong",
	...
	"argument.entity.selector.nearestEntity": "Næraste eining",
	...
	"argument.message.too_long": "Nettpratsmelding var for lang (%s > høgst %s teikn)",
	"argument.nbt.array.invalid": "«%s» er eit ugildt slag tabell",
	"argument.nbt.array.mixed": "Kan ikkje setja inn %s i %s",
	"argument.nbt.expected.compound": "Forventa compound-tagg",
	...
	"argument.resource_or_id.failed_to_parse": "Kunne ikkje tolka bygnad: %s",
	"argument.resource_or_id.invalid": "Ugild ID eller tagg",
	"argument.resource_or_id.no_such_element": "Kan ikke finne element '%s' i register '%s'",
	"argument.resource_selector.not_found": "Ingen funn for utveljar '%s' av type '%s'",
	...
	"argument.scoreHolder.empty": "Ingen relevante skòretalshaldarar vart funne",
	...
	"argument.waypoint.invalid": "Valt eining er ikkje ein varde",
	...
	"arguments.item.component.expected": "Venta gjenstandskomponent",
	"arguments.item.component.malformed": "Feilaktig '%s'-komponent: '%s'",
	"arguments.item.component.repeated": "Gjenstandskomponent «%s» ble gjenteke, men berre éin verdi kan bli oppgjeve",
	"arguments.item.component.unknown": "Ukjent gjenstandskomponent '%s'",
	"arguments.item.malformed": "Feilforma gjenstand '%s'",
	...
	"arguments.objective.readonly": "Målet «%s» på skòretavla er skriveverna",
	...
	"attribute.name.armor_toughness": "Rustningsherdigheit",
	"attribute.name.attack_damage": "Angrepsskade",
	"attribute.name.attack_knockback": "Angrepstilbakeslag",
	"attribute.name.attack_speed": "Åtakssnøggleik",
	"attribute.name.below_name_distance": "Undernavneskiltsavstand",
	"attribute.name.block_break_speed": "Gravesnøggleik",
	"attribute.name.block_interaction_range": "Rekkevidd for samhandling med blokker",
	"attribute.name.bounciness": "Sprettleik",
	"attribute.name.burning_time": "Fyrtid",
	"attribute.name.camera_distance": "Kameraavstand",
	"attribute.name.entity_interaction_range": "Rekkevidd for einingssamhandling",
	"attribute.name.explosion_knockback_resistance": "Sprengingstilbakeslagsmotstand",
	"attribute.name.fall_damage_multiplier": "Faktor for fallskade",
	"attribute.name.flying_speed": "Flygesnøggleik",
	...
	"attribute.name.generic.attack_knockback": "Atterslag på åtak",
	"attribute.name.generic.attack_speed": "Åtakssnøggleik",
	"attribute.name.generic.block_interaction_range": "Rekkevidd for blokksamhandling",
	"attribute.name.generic.burning_time": "Fyrtid",
	"attribute.name.generic.entity_interaction_range": "Rekkevidd for einingssamhandling",
	"attribute.name.generic.explosion_knockback_resistance": "Sprengingstilbakeslagsmotstand",
	"attribute.name.generic.fall_damage_multiplier": "Faktor for fallskade",
	...
	"attribute.name.generic.max_absorption": "Høgst oppsuging",
	...
	"attribute.name.generic.safe_fall_distance": "Trygg fallhøgde",
	"attribute.name.generic.scale": "Storleik",
	"attribute.name.generic.step_height": "Steghøgd",
	...
	"attribute.name.max_health": "Høgst helse",
	"attribute.name.mining_efficiency": "Graveferdighet",
	"attribute.name.movement_efficiency": "Fremkommelighet",
	"attribute.name.movement_speed": "Snøggleik",
	"attribute.name.nameplate_distance": "Navneskiltsavstand",
	"attribute.name.oxygen_bonus": "Oksygenbonus",
	"attribute.name.player.block_break_speed": "Blokkgravarfart",
	"attribute.name.player.block_interaction_range": "Rekkevidd for blokksamhandling",
	"attribute.name.player.entity_interaction_range": "Rekkevidd for einingssamhandling",
	"attribute.name.player.mining_efficiency": "Gravesnøggleik",
	"attribute.name.player.sneaking_speed": "Snikesnøggleik",
	"attribute.name.player.submerged_mining_speed": "Undervassgravesnøggleik",
	"attribute.name.player.sweeping_damage_ratio": "Sveipeskaderate",
	"attribute.name.safe_fall_distance": "Trygg fallhøgde",
	"attribute.name.scale": "Skala",
	"attribute.name.sneaking_speed": "Snikesnøggleik",
	"attribute.name.spawn_reinforcements": "Zombieforsterkninger",
	"attribute.name.step_height": "Steghøgd",
	"attribute.name.submerged_mining_speed": "Undervassgravesnøggleik",
	...
	"attribute.name.waypoint_receive_range": "Rekkevidd for vardemottaking",
	"attribute.name.waypoint_transmit_range": "Rekkevidd for vardekringkasting",
	...
	"biome.minecraft.deep_dark": "Djupe mørkret",
	...
	"biome.minecraft.pale_garden": "Bleikhage",
	...
	"biome.minecraft.warped_forest": "Vrideskog",
	...
	"block.minecraft.banner.flow.black": "Svart flod",
	"block.minecraft.banner.flow.blue": "Blå flod",
	"block.minecraft.banner.flow.brown": "Brun flod",
	"block.minecraft.banner.flow.cyan": "Blågrøn flod",
	"block.minecraft.banner.flow.gray": "Grå flod",
	"block.minecraft.banner.flow.green": "Grøn flod",
	"block.minecraft.banner.flow.light_blue": "Ljosblå flod",
	"block.minecraft.banner.flow.light_gray": "Ljosgrå flod",
	"block.minecraft.banner.flow.lime": "Limegrøn flod",
	"block.minecraft.banner.flow.magenta": "Ljoslilla flod",
	"block.minecraft.banner.flow.orange": "Oransje flod",
	"block.minecraft.banner.flow.pink": "Rosa flod",
	"block.minecraft.banner.flow.purple": "Lilla flod",
	"block.minecraft.banner.flow.red": "Raud flod",
	"block.minecraft.banner.flow.white": "Kvit flod",
	"block.minecraft.banner.flow.yellow": "Gul flod",
	...
	"block.minecraft.cactus_flower": "Kaktusblome",
	...
	"block.minecraft.cherry_shelf": "Kissebærhylle",
	...
	"block.minecraft.chiseled_copper": "Forma kopar",
	...
	"block.minecraft.chiseled_resin_bricks": "Forma kvaetegl",
	...
	"block.minecraft.chiseled_tuff": "Forma tuff",
	"block.minecraft.chiseled_tuff_bricks": "Forma tufftegl",
	...
	"block.minecraft.copper_bars": "Kopargitter",
	"block.minecraft.copper_block": "Koparblokk",
	"block.minecraft.copper_bulb": "Koparpære",
	"block.minecraft.copper_chain": "Koparlenkje",
	"block.minecraft.copper_chest": "Koparkiste",
	"block.minecraft.copper_door": "Kopardør",
	"block.minecraft.copper_golem_statue": "Koparkallstytte",
	"block.minecraft.copper_grate": "Koparrist",
	"block.minecraft.copper_lantern": "Koparlykt",
	"block.minecraft.copper_ore": "Koparmalm",
	"block.minecraft.copper_torch": "Koparfakkel",
	"block.minecraft.copper_trapdoor": "Koparlem",
	"block.minecraft.copper_wall_torch": "Koparveggfakkel",
	...
	"block.minecraft.crafting_table": "Emningsbord",
	"block.minecraft.creaking_heart": "Knirkehjarta",
	...
	"block.minecraft.crimson_shelf": "Blodhylle",
	...
	"block.minecraft.dried_ghast": "Utturka ghast",
	...
	"block.minecraft.exposed_chiseled_copper": "Utsett forma kopar",
	"block.minecraft.exposed_copper": "Utsett kopar",
	"block.minecraft.exposed_copper_bars": "Utsett kopargitter",
	"block.minecraft.exposed_copper_bulb": "Utsett koparpære",
	"block.minecraft.exposed_copper_chain": "Utsett koparlenkje",
	"block.minecraft.exposed_copper_chest": "Utsett koparkiste",
	"block.minecraft.exposed_copper_door": "Utsett kopardør",
	"block.minecraft.exposed_copper_golem_statue": "Utsett koparkallstytte",
	"block.minecraft.exposed_copper_grate": "Utsett koparrist",
	"block.minecraft.exposed_copper_lantern": "Utsett koparlykt",
	...
	"block.minecraft.exposed_lightning_rod": "Utsett lynavleiar",
	...
	"block.minecraft.firefly_bush": "Eldflugebusk",
	...
	"block.minecraft.golden_dandelion": "Gull-løvetann",
	...
	"block.minecraft.iron_chain": "Jarnlenkje",
	...
	"block.minecraft.moss_carpet": "Mosebreisle",
	...
	"block.minecraft.oxidized_chiseled_copper": "Eira forma kopar",
	"block.minecraft.oxidized_copper": "Eira koparblokk",
	"block.minecraft.oxidized_copper_bars": "Eira kopargitter",
	"block.minecraft.oxidized_copper_bulb": "Eira koparpære",
	"block.minecraft.oxidized_copper_chain": "Eira koparlenkje",
	"block.minecraft.oxidized_copper_chest": "Eira koparkiste",
	"block.minecraft.oxidized_copper_door": "Eira kopardør",
	"block.minecraft.oxidized_copper_golem_statue": "Eira koparkallstytte",
	"block.minecraft.oxidized_copper_grate": "Eira koparrist",
	"block.minecraft.oxidized_copper_lantern": "Eira koparlykt",
	"block.minecraft.oxidized_copper_trapdoor": "Eira koparlem",
	...
	"block.minecraft.oxidized_lightning_rod": "Eira lynavleiar",
	"block.minecraft.packed_ice": "Pakkis",
	"block.minecraft.packed_mud": "Pakkgjørme",
	"block.minecraft.pale_hanging_moss": "Hengande bleikmose",
	"block.minecraft.pale_moss_block": "Bleikmoseblokk",
	"block.minecraft.pale_moss_carpet": "Bleikmoseteppe",
	"block.minecraft.pale_oak_button": "Bleikeikeknapp",
	"block.minecraft.pale_oak_door": "Bleikeikedør",
	"block.minecraft.pale_oak_fence": "Bleikeikegard",
	"block.minecraft.pale_oak_fence_gate": "Bleikeikegrind",
	"block.minecraft.pale_oak_hanging_sign": "Hengande bleikeikeskilt",
	"block.minecraft.pale_oak_leaves": "Bleikeikelauv",
	"block.minecraft.pale_oak_log": "Bleikeikestomn",
	"block.minecraft.pale_oak_planks": "Bleikeikeplankar",
	"block.minecraft.pale_oak_pressure_plate": "Bleikeiketrykkplate",
	"block.minecraft.pale_oak_sapling": "Bleikeikerenning",
	"block.minecraft.pale_oak_shelf": "Bleikeikehylle",
	"block.minecraft.pale_oak_sign": "Bleikeikeskilt",
	"block.minecraft.pale_oak_slab": "Bleikeikehelle",
	"block.minecraft.pale_oak_stairs": "Bleikeiketrapp",
	"block.minecraft.pale_oak_trapdoor": "Bleikeikelem",
	"block.minecraft.pale_oak_wall_hanging_sign": "Hengande bleikeikeskilt på vegg",
	"block.minecraft.pale_oak_wall_sign": "Bleikeikeveggskilt",
	"block.minecraft.pale_oak_wood": "Bleikeiketre",
	...
	"block.minecraft.pitcher_plant": "Kanneberar",
	...
	"block.minecraft.polished_tuff": "Finpussa tuff",
	"block.minecraft.polished_tuff_slab": "Helle av finpussa tuff",
	"block.minecraft.polished_tuff_stairs": "Trapp av finpussa tuff",
	"block.minecraft.polished_tuff_wall": "Mur av finpussa tuff",
	...
	"block.minecraft.potted_closed_eyeblossom": "Attlaten augblom i potte",
	...
	"block.minecraft.potted_golden_dandelion": "Gull-løvetann i potte",
	...
	"block.minecraft.potted_warped_fungus": "Vridesopp i potte",
	"block.minecraft.potted_warped_roots": "Vriderøter i potte",
	...
	"block.minecraft.smooth_quartz_slab": "Helle av glatt kvarts",
	...
	"block.minecraft.stripped_mangrove_log": "Slinda mangrovestomn",
	...
	"block.minecraft.stripped_pale_oak_log": "Slinda bleikeikestomn",
	"block.minecraft.stripped_pale_oak_wood": "Slinda bleikeiketre",
	"block.minecraft.stripped_spruce_log": "Slinda granstomn",
	"block.minecraft.stripped_spruce_wood": "Slinda granved",
	"block.minecraft.stripped_warped_hyphae": "Slinda vridehyfar",
	"block.minecraft.stripped_warped_stem": "Slinda vridestomn",
	...
	"block.minecraft.test_instance_block": "Testinstansblokk",
	"block.minecraft.tinted_glass": "Sverta glas",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "TNT-eksplosjonar er avslege",
	...
	"block.minecraft.trial_spawner": "Røyneframkallar",
	...
	"block.minecraft.tuff_brick_slab": "Helle av tufftegl",
	"block.minecraft.tuff_brick_stairs": "Trapp av tufftegl",
	"block.minecraft.tuff_brick_wall": "Tuffteglmur",
	"block.minecraft.tuff_bricks": "Tufftegl",
	"block.minecraft.tuff_slab": "Tuffhelle",
	"block.minecraft.tuff_stairs": "Tufftrapp",
	...
	"block.minecraft.warped_button": "Vrideknapp",
	"block.minecraft.warped_door": "Vridedør",
	"block.minecraft.warped_fence": "Vridegjerde",
	"block.minecraft.warped_fence_gate": "Vridegrind",
	"block.minecraft.warped_fungus": "Vridesopp",
	"block.minecraft.warped_hanging_sign": "Hengande vrideskilt",
	"block.minecraft.warped_hyphae": "Vridehyfar",
	"block.minecraft.warped_nylium": "Vridenycel",
	"block.minecraft.warped_planks": "Vrideplankar",
	"block.minecraft.warped_pressure_plate": "Vridetrykkplate",
	"block.minecraft.warped_roots": "Vriderøter",
	"block.minecraft.warped_shelf": "Vridehylle",
	"block.minecraft.warped_sign": "Vrideskilt",
	"block.minecraft.warped_slab": "Vridehelle",
	"block.minecraft.warped_stairs": "Vridetrapp",
	"block.minecraft.warped_stem": "Vridestomn",
	"block.minecraft.warped_trapdoor": "Vridelem",
	"block.minecraft.warped_wall_hanging_sign": "Hengande vrideskilt på vegg",
	"block.minecraft.warped_wall_sign": "Vrideveggskilt",
	"block.minecraft.warped_wart_block": "Vridevorteblokk",
	"block.minecraft.water": "Vatn",
	"block.minecraft.water_cauldron": "Vassgryte",
	"block.minecraft.waxed_chiseled_copper": "Voksa forma kopar",
	"block.minecraft.waxed_copper_bars": "Voksa kopargitter",
	"block.minecraft.waxed_copper_block": "Voksa koparblokk",
	"block.minecraft.waxed_copper_bulb": "Voksa koparpære",
	"block.minecraft.waxed_copper_chain": "Voksa koparlenkje",
	"block.minecraft.waxed_copper_chest": "Voksa koparkiste",
	"block.minecraft.waxed_copper_door": "Voksa kopardør",
	"block.minecraft.waxed_copper_golem_statue": "Voksa koparkallstytte",
	"block.minecraft.waxed_copper_grate": "Voksa koparrist",
	"block.minecraft.waxed_copper_lantern": "Voksa koparlykt",
	"block.minecraft.waxed_copper_trapdoor": "Voksa koparlem",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Voksa utsett forma kopar",
	"block.minecraft.waxed_exposed_copper": "Voksa utsett kopar",
	"block.minecraft.waxed_exposed_copper_bars": "Voksa utsett kopargitter",
	"block.minecraft.waxed_exposed_copper_bulb": "Voksa utsett koparpære",
	"block.minecraft.waxed_exposed_copper_chain": "Voksa utsett koparlenkje",
	"block.minecraft.waxed_exposed_copper_chest": "Voksa utsett koparkiste",
	"block.minecraft.waxed_exposed_copper_door": "Voksa utsett kopardør",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Voksa utsett koparkallstytte",
	"block.minecraft.waxed_exposed_copper_grate": "Voksa utsett koparrist",
	"block.minecraft.waxed_exposed_copper_lantern": "Voksa utsett koparlykt",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Voksa utsett koparlem",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Voksa utsett lynavleiar",
	"block.minecraft.waxed_lightning_rod": "Voksa lynavleiar",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Voksa eira forma kopar",
	"block.minecraft.waxed_oxidized_copper": "Voksa eira kopar",
	"block.minecraft.waxed_oxidized_copper_bars": "Voksa eira kopargitter",
	"block.minecraft.waxed_oxidized_copper_bulb": "Voksa eira koparpære",
	"block.minecraft.waxed_oxidized_copper_chain": "Voksa eira koparlenkje",
	"block.minecraft.waxed_oxidized_copper_chest": "Voksa eira koparkiste",
	"block.minecraft.waxed_oxidized_copper_door": "Voksa eira kopardør",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Voksa eira koparkallstytte",
	"block.minecraft.waxed_oxidized_copper_grate": "Voksa eira koparrist",
	"block.minecraft.waxed_oxidized_copper_lantern": "Voksa eira koparlykt",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Voksa eira koparlem",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Voksa eira lynavleiar",
	"block.minecraft.waxed_weathered_chiseled_copper": "Voksa vêrbiten forma kopar",
	"block.minecraft.waxed_weathered_copper": "Voksa vêrbiten kopar",
	"block.minecraft.waxed_weathered_copper_bars": "Voksa vêrbite kopargitter",
	"block.minecraft.waxed_weathered_copper_bulb": "Voksa vêrbita koparpære",
	"block.minecraft.waxed_weathered_copper_chain": "Voksa vêrbiten koparlenkje",
	"block.minecraft.waxed_weathered_copper_chest": "Voksa vêrbita koparkiste",
	"block.minecraft.waxed_weathered_copper_door": "Voksa vêrbita kopardør",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Voksa vêrbita koparkallstytte",
	"block.minecraft.waxed_weathered_copper_grate": "Voksa vêrbita koparrist",
	"block.minecraft.waxed_weathered_copper_lantern": "Voksa vêrbiten koparlykt",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Voksa vêrbiten koparlem",
	"block.minecraft.waxed_weathered_cut_copper": "Voksa vêrbiten skoren kopar",
	"block.minecraft.waxed_weathered_cut_copper_slab": "Voksa vêrbita helle av skoren kopar",
	"block.minecraft.waxed_weathered_cut_copper_stairs": "Voksa vêrbita trapp av skoren kopar",
	"block.minecraft.waxed_weathered_lightning_rod": "Voksa vêrbiten lynavleiar",
	"block.minecraft.weathered_chiseled_copper": "Vêrbiten forma kopar",
	"block.minecraft.weathered_copper": "Vêrbiten kopar",
	"block.minecraft.weathered_copper_bars": "Vêrbite kopargitter",
	"block.minecraft.weathered_copper_bulb": "Vêrbita koparpære",
	"block.minecraft.weathered_copper_chain": "Vêrbiten koparlenkje",
	"block.minecraft.weathered_copper_chest": "Vêrbita koparkiste",
	"block.minecraft.weathered_copper_door": "Vêrbita kopardør",
	"block.minecraft.weathered_copper_golem_statue": "Vêrbita koparkallstytte",
	"block.minecraft.weathered_copper_grate": "Vêrbita koparrist",
	"block.minecraft.weathered_copper_lantern": "Vêrbiten koparlykt",
	"block.minecraft.weathered_copper_trapdoor": "Vêrbiten koparlem",
	"block.minecraft.weathered_cut_copper": "Vêrbiten skoren kopar",
	"block.minecraft.weathered_cut_copper_slab": "Vêrbita helle av skoren kopar",
	"block.minecraft.weathered_cut_copper_stairs": "Vêrbita trapp av skoren kopar",
	"block.minecraft.weathered_lightning_rod": "Vêrbiten lynavleiar",
	...
	"block.minecraft.white_carpet": "Kvit rye",
	...
	"book.page_button.previous": "Førre side",
	...
	"build.tooHigh": "Høgdegrensa for byggjing er %s",
	...
	"chat.disabled.invalid_command_signature": "Kommandoen hadde uforventa eller manglande kommandoargument-signaturar.",
	...
	"chat.queue.tooltip": "Klikk for å visa neste melding",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "Tenar sende ugild melding.",
	...
	"chat.validation_error": "Kunne ikkje validera nettprat",
	...
	"chat_restriction.chat_disabled_by_options.action": "Gå til prateinstillingsskjermen",
	...
	"chat_restriction.disabled_by_profile.action": "Gå til profilinstillingane dine",
	...
	"chat_screen.restricted": "Nettprat er avgrensa. Trykk på denne meldinga for detaljar.",
	...
	"chunk.toast.checkLog": "Sjå loggen for fleire detaljar",
	"chunk.toast.loadFailure": "Verdsbit kunne ikkje verte lasta inn ved %s",
	"chunk.toast.lowDiskSpace": "Lite diskplass!",
	"chunk.toast.lowDiskSpace.description": "Kan henda verda di ikkje vinn lagrast.",
	"chunk.toast.saveFailure": "Verdsbit kunne ikkje verte lagra ved %s",
	...
	"command.forkLimit": "Høgste tal på samanhengen (%s) nått",
	...
	"commands.attribute.base_value.reset.success": "Grunnverdet for eigenskapen %s for eininga %s er sett attende til førevalet %s",
	...
	"commands.bossbar.get.players.some": "Eigenlaga fiendsmålar %s har %s spelar(ar) pålogga for augneblinken: %s",
	...
	"commands.bossbar.list.bars.some": "Det er %s eigenlaga fiendsmålar(ar) slegne på: %s",
	...
	"commands.bossbar.set.players.success.some": "Eigenlaga fiendsmålar %s har no %s spelar(ar): %s",
	...
	"commands.clone.success": "Klona %s blokk(er)",
	...
	"commands.data.modify.invalid_substring": "Ugilde understrengindeksar: %s til %s",
	...
	"commands.datapack.create.already_exists": "Det finst allereie ei pakke med namn '%s'",
	...
	"commands.datapack.list.available.success": "Det er %s datapakke/ar tilgjengelege: %s",
	"commands.datapack.list.enabled.none": "Det er ingen datapakkar slegne på",
	"commands.datapack.list.enabled.success": "Det er %s datapakke/ar påslegne: %s",
	...
	"commands.debug.function.noReturnRun": "Kan ikkje bruka sporing med /return run",
	...
	"commands.drop.no_loot_table.block": "Blokk %s har ikkje nokon plyndringstabell",
	...
	"commands.execute.function.instantiationFailure": "Mislykkast med å instansiere funksjon %s: %s",
	...
	"commands.fetchprofile.give_item": "Gjev gjenstand",
	...
	"commands.fill.success": "Fylling av %s blokk(er) var vellukka",
	...
	"commands.fillbiome.success.count": "Gjorde om %s landskapsoppføring(ar) mellom %s, %s, %s og %s, %s, %s",
	...
	"commands.function.error.argument_not_compound": "Ugildt argumentslag: %s; venta samansetjing",
	"commands.function.error.missing_argument": "Vantar argument %[2]s til funksjonen %[1]s",
	"commands.function.error.missing_arguments": "Vantar argument til funksjon %s",
	"commands.function.error.parse": "Under instansiering av makro %s: forårsaka kommandoen '%s' feil: %s",
	"commands.function.instantiationFailure": "Mislykka instansiering av funksjon %s: %s",
	"commands.function.result": "Funksjon %s returnerte %s",
	"commands.function.scheduled.multiple": "Køyrande funksjonar %s",
	"commands.function.scheduled.no_functions": "Kan ikkje finna nokon funksjonar for namn %s",
	"commands.function.scheduled.single": "Køyrer funksjon %s",
	...
	"commands.kick.owner.failed": "Kan ikkje kasta ut eigaren av tenar i LAN-spel",
	"commands.kick.singleplayer.failed": "Kan ikkje kasta ut spelarar i eit fråkopla einspelarspel",
	...
	"commands.pardonip.failed": "Ingenting gjord om. Denne IPen er ikkje bannlyst",
	...
	"commands.profile_fetch.give_item": "Gjev gjenstand",
	...
	"commands.random.error.range_too_large": "Rekkevidda til den tilfeldige verdien kan maks vere 2147483646",
	"commands.random.error.range_too_small": "Rekkevidda av den tilfeldige verdien må vere minst 2",
	"commands.random.reset.all.success": "Sette %s tilfelleleg sekvens(ar)",
	"commands.random.reset.success": "Sette tilfelleleg sekvens %s",
	"commands.random.roll": "%s rulla %s (frå %s til %s)",
	"commands.random.sample.success": "Tilfelleleg verde: %s",
	...
	"commands.rotate.success": "Roterte %s",
	...
	"commands.scoreboard.objectives.list.success": "Det er %s målsetjing(ar): %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Deaktiverte vising av automatisk oppdatering for målsetjing %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Aktiverte vising av automatisk oppdatering for målsetjing %s",
	"commands.scoreboard.objectives.modify.displayname": "Endra visingsnamnet for %s til %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Reinska standardnummerformatet for målet %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Gjorde om standardnummerformatet for målet %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Reinska visningsnamnet til %s einingar i %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Reinska visningsnamnet til %s i %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Gjorde visningsnamnet om til %s for %s einingar i %s",
	"commands.scoreboard.players.display.name.set.success.single": "Gjorde visningsnamnet om til %s for %s i %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Reinska nummerformatet til %s einingar i %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Reinska nummerformatet til %s i %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Gjorde om nummerformatet til %s einingar i %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Gjorde om nummerformatet til %s i %s",
	...
	"commands.scoreboard.players.list.entity.empty": "%s har ingen skòretal å visa",
	"commands.scoreboard.players.list.entity.entry": "%s: %s",
	"commands.scoreboard.players.list.entity.success": "%s har %s skòretal:",
	"commands.scoreboard.players.list.success": "Det er %s spora eining(ar): %s",
	...
	"commands.scoreboard.players.reset.all.multiple": "Sette attende alle skòretal for %s einingar",
	"commands.scoreboard.players.reset.all.single": "Sette attende alle skòretal for %s",
	...
	"commands.setworldspawn.failure.not_overworld": "Kan berre setja byrjestad for oververda",
	"commands.setworldspawn.success": "Set byrjestaden i verda til %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Sette byrjestaden i verda til %s, %s, %s [%s, %s] i %s",
	"commands.spawnpoint.success.multiple": "Set byrjestaden til %s, %s, %s [%s] i %s for %s spelarar",
	"commands.spawnpoint.success.multiple.new": "Sette byrjestaden til %s, %s, %s [%s, %s] i %s for %s spelarar",
	"commands.spawnpoint.success.single": "Set byrjestaden til %s, %s, %s [%s] i %s for %s",
	"commands.spawnpoint.success.single.new": "Sette byrjestaden til %s, %s, %s [%s, %s] i %s for %s",
	"commands.spectate.cannot_spectate": "%s kan ikkje verte skoda",
	...
	"commands.spreadplayers.failed.invalid.height": "Ugild maxHeight %s; venta høgre enn verdsminiimum %s",
	...
	"commands.team.empty.success": "Tok bort %s medlem(er) frå lag %s",
	...
	"commands.team.list.members.success": "Lag %s har %s medlem(er): %s",
	...
	"commands.test.locate.found": "Fann bygnad ved: %s (avstand: %s)",
	...
	"commands.tick.query.percentiles": "Prosentar: P50: %sms P95: %sms P99: %sms, prøver: %s",
	"commands.tick.query.rate.running": "Målverde for tikksnøggleik: %s per sekund.\nGjennomsnittleg tid per tikk: %sms (Mål: %sms)",
	"commands.tick.query.rate.sprinting": "Målverde for tikksnøggleik: %s per sekund (ignorert, einast til opplysing).\nGjennomsnittleg tid per tikk: %sms",
	"commands.tick.rate.success": "Sette målverdet for tikksnøggleiken til %s per sekund",
	"commands.tick.sprint.report": "Sprang fullført med %s tikk per sekund, eller %s ms per tikk",
	"commands.tick.sprint.stop.fail": "Inkje tikksprang er på gang",
	"commands.tick.sprint.stop.success": "Eit tikksprang vart avbrote",
	"commands.tick.status.frozen": "Spele er frose",
	"commands.tick.status.lagging": "Spelet køyrer, men kan ikkje nå målverdet for tikksnøggleik",
	"commands.tick.status.running": "Spelet køyrer som normalt",
	"commands.tick.status.sprinting": "Spelet spring",
	"commands.tick.step.fail": "Kunne ikkje stega spelet – spelet må verta frose fyrst",
	"commands.tick.step.stop.fail": "Inkje tikksteg er på gang",
	"commands.tick.step.stop.success": "Eit tikksteg vart avbrote",
	"commands.tick.step.success": "Stig %s tikk",
	...
	"commands.transfer.error.no_players": "Må peika ut minst éin spelar å overføra",
	"commands.transfer.success.multiple": "Overfører %s spelarar til %s:%s",
	...
	"commands.waypoint.list.empty": "Ingen vardar i %s",
	"commands.waypoint.list.success": "%s vard(e/ar) i %s: %s",
	"commands.waypoint.modify.color": "Vardefarge er no %s",
	"commands.waypoint.modify.color.reset": "Sett attende vardefarge",
	"commands.waypoint.modify.style": "Vardestil endra",
	...
	"commands.worldborder.damage.buffer.success": "Sette skadeområdet åt verdsgrensa til %s blokk(er)",
	...
	"connect.failed.transfer": "Tilkopling mislykkast under overføring til serveren",
	...
	"connect.transferring": "Fører over til ny tenar...",
	...
	"container.repair": "Vøl og gjev namn",
	...
	"container.upgrade.error_tooltip": "Kan ikkje betra utbunaden slik",
	...
	"createWorld.customize.presets.list": "Til alternativ er her nokre me har laga tidlegare!",
	...
	"dataPack.locator_bar.description": "Peik ut kva retning andre spelarar oppheld seg i fleirspelar",
	"dataPack.locator_bar.name": "Retningsvisar",
	...
	"dataPack.trade_rebalance.description": "Oppdaterte byte for bygdefolk",
	"dataPack.trade_rebalance.name": "Ombalanserte bygdebubyte",
	"dataPack.update_1_20.description": "Nye funksjonar og innehald til Minecraft 1.20",
	"dataPack.update_1_20.name": "Oppdatering 1.20",
	"dataPack.update_1_21.description": "Nye funksjonar og innehald til Minecraft 1.21",
	...
	"dataPack.winter_drop.description": "Nye funksjonar og innehald i vettersleppet",
	...
	"datapackFailure.safeMode.failed.title": "Kunne ikkje lasta verda i trygg-modus.",
	"datapackFailure.title": "Feil i dei valde datapakkane hindra verda frå å lasta.\nDu kan anten freista å lasta med vanleg datapakke («trygg-modus») eller gå attende til hovudmenyen og retta det opp for hand.",
	...
	"death.attack.genericKill": "%[1]s vart drepen",
	"death.attack.genericKill.player": "%[1]s vart drepen i strid med %[2]s",
	...
	"death.attack.mace_smash": "%[1]s vart smadra av %[2]s",
	"death.attack.mace_smash.item": "%[1]s vart smadra av %[2]s med %[3]s",
	...
	"death.attack.outsideBorder": "%[1]s hamna utanføre verdsgrensa",
	"death.attack.outsideBorder.player": "%[1]s hamna utanføre verdsgrensa i strid med %[2]s",
	...
	"death.attack.spear": "%[1]s vart spidda av %[2]s",
	"death.attack.spear.item": "%[1]s vart spidda av %[2]s med %[3]s",
	...
	"debug.gamemodes.error": "Kunne ikkje opna spelmodusskiftar; manglar løyve",
	...
	"debug.options.warning": "Desse vala er berre til utprøving. Dei kann seinka datamaskina di, få spelet til å kræsja, eller eta kjælesteinen din.",
	...
	"disconnect.ignoring_status_request": "Ignorerer statusførespurnad",
	...
	"disconnect.transfer": "Overført til ein annan tenar",
	"disconnect.unknownHost": "Ukjend vert",
	"download.pack.failed": "Kunne ikkje lasta ned %s av %s pakkar",
	"download.pack.progress.bytes": "Framgang: %s (total storleik ukjend)",
	"download.pack.progress.percent": "Framgang: %s%%",
	"download.pack.title": "Lastar ned tilfangspakke %s/%s",
	...
	"effect.minecraft.dolphins_grace": "Delfinlukke",
	...
	"effect.minecraft.raid_omen": "Herjingsjartegn",
	...
	"effect.minecraft.trial_omen": "Røynejartegn",
	"effect.minecraft.unluck": "Vanlukke",
	"effect.minecraft.water_breathing": "Vassanding",
	"effect.minecraft.weakness": "Veikskap",
	"effect.minecraft.weaving": "Veving",
	"effect.minecraft.wind_charged": "Vindlada",
	...
	"enchantment.minecraft.aqua_affinity": "Vassvyrk",
	"enchantment.minecraft.bane_of_arthropods": "Leddyrsbane",
	"enchantment.minecraft.binding_curse": "Bindingstrolldom",
	"enchantment.minecraft.blast_protection": "Sprengingssvern",
	"enchantment.minecraft.breach": "Gjennombrudd",
	"enchantment.minecraft.channeling": "Lynleiar",
	"enchantment.minecraft.density": "Tettleik",
	"enchantment.minecraft.depth_strider": "Dyptegangar",
	"enchantment.minecraft.efficiency": "Dugleik",
	...
	"enchantment.minecraft.fortune": "Rikdom",
	...
	"enchantment.minecraft.luck_of_the_sea": "Fiskelukke",
	"enchantment.minecraft.lunge": "Støyt",
	...
	"enchantment.minecraft.riptide": "Sjøgang",
	...
	"enchantment.minecraft.sweeping_edge": "Sveipande knivsegg",
	...
	"enchantment.minecraft.wind_burst": "Vindstøyt",
	...
	"entity.minecraft.bamboo_chest_raft": "Bambusbåt med kiste",
	...
	"entity.minecraft.bogged": "Myrdraug",
	"entity.minecraft.breeze": "Vindskrømt",
	"entity.minecraft.breeze_wind_charge": "Vindkule",
	"entity.minecraft.camel": "Dromedar",
	"entity.minecraft.camel_husk": "Dromedar-skaldauding",
	"entity.minecraft.cat": "Katt",
	"entity.minecraft.cave_spider": "Hòlevevkjerring",
	"entity.minecraft.cherry_boat": "Kissebærbåt",
	"entity.minecraft.cherry_chest_boat": "Kissebærbåt med kiste",
	...
	"entity.minecraft.copper_golem": "Koparkall",
	"entity.minecraft.cow": "Ku",
	"entity.minecraft.creaking": "Knirk",
	"entity.minecraft.creaking_transient": "Knirk",
	...
	"entity.minecraft.happy_ghast": "Gladghast",
	...
	"entity.minecraft.jungle_boat": "Jungelbåt",
	"entity.minecraft.jungle_chest_boat": "Jungelbåt med kiste",
	...
	"entity.minecraft.lingering_potion": "Dvelande brygg",
	...
	"entity.minecraft.pale_oak_chest_boat": "Bleikeikebåt med kiste",
	"entity.minecraft.panda": "Pandabjørn",
	"entity.minecraft.parched": "Turring",
	...
	"entity.minecraft.zombie_nautilus": "Perlebåtdauding",
	...
	"filled_map.explorer_jungle": "Oppdagarkart over jungel",
	"filled_map.explorer_swamp": "Oppdagarkart over våtmyr",
	"filled_map.id": "Id #%s",
	"filled_map.level": "(Steg %s/%s)",
	"filled_map.locked": "Låst",
	"filled_map.mansion": "Skoggranskingskart",
	"filled_map.monument": "Sjøgranskingskart",
	"filled_map.scale": "Skalering på 1:%s",
	"filled_map.trial_chambers": "Oppdagarkart over røyningar",
	"filled_map.unknown": "Ukjent kart",
	"filled_map.village_desert": "Ørkenbygdekart",
	"filled_map.village_plains": "Slettebygdekart",
	"filled_map.village_savanna": "Savannebygdekart",
	"filled_map.village_snowy": "Snøbygdekart",
	"filled_map.village_taiga": "Barskogbygdekart",
	...
	"gamerule.blockExplosionDropDecay": "I sprengingar frå blokksamhandling slepper nokre blokker ikkje alltid utbyte",
	"gamerule.blockExplosionDropDecay.description": "Noko av utbytet frå blokker øydelagde av sprenginga valda av blokkpåverknad kverv i sprenginga.",
	...
	"gamerule.commandModificationBlockLimit.description": "Mengd av blokker som vert omgjorde samstundes av éin kommando, t.d. fill eller clone.",
	"gamerule.disableElytraMovementCheck": "Slå av vengerørslesjekk",
	"gamerule.disablePlayerMovementCheck": "Slå av rørslesjekk for spelarar",
	...
	"gamerule.doLimitedCrafting": "Krev oppskrifter til emning",
	"gamerule.doLimitedCrafting.description": "Om påslege kan spelarar berre emna med opplåste oppskrifter.",
	"gamerule.doMobLoot": "Slepp gode frå skapning",
	"gamerule.doMobLoot.description": "Styrer tilfangsslepp frå skapnader, som òg gjeld for galdrepoeng.",
	"gamerule.doMobSpawning": "Framkall skapningar",
	"gamerule.doMobSpawning.description": "Somme einingar kan ha særskilde reglar.",
	"gamerule.doPatrolSpawning": "Framkall plyndrarpatruljar",
	"gamerule.doTileDrops": "Slepp blokker",
	"gamerule.doTileDrops.description": "Styrer tilfangsslepp frå blokker, som òg gjeld for galdrepoeng.",
	...
	"gamerule.enderPearlsVanishOnDeath": "Kasta enderperler kverv når ein døyr",
	"gamerule.enderPearlsVanishOnDeath.description": "Om enderperler kasta av ein spelar kverv når spelaren døyr.",
	...
	"gamerule.maxCommandChainLength.description": "Gjeld kjeder av kommandoblokker og verksemder.",
	"gamerule.maxCommandForkCount": "Grense for kommando-samanheng",
	"gamerule.maxCommandForkCount.description": "Maksimum antal kontekstar som kan brukast av kommandar som 'execute as'.",
	"gamerule.maxEntityCramming": "Grense for stappa einingar",
	"gamerule.minecartMaxSpeed": "Maksfart for gruvevogner",
	"gamerule.minecartMaxSpeed.description": "Høgast vanleg snøggleik for gruvevogner i rørsle på land",
	"gamerule.minecraft.elytra_movement_check": "Gjennomfør vengerørslesjekk",
	"gamerule.minecraft.fire_spread_radius_around_player": "Brannspreiingsradius",
	...
	"gamerule.mobExplosionDropDecay": "I skapnings-sprengingar slepper nokre blokker ikkje alltid utbyte",
	"gamerule.mobExplosionDropDecay.description": "Noko av utbytet frå blokker øydelagde av sprengingar valda av skapningar kverv i sprenginga.",
	"gamerule.mobGriefing": "Tillat øydelegging frå skapningar",
	"gamerule.naturalRegeneration": "Få att liv",
	"gamerule.playersNetherPortalCreativeDelay": "Spelarens forseinking i netherportalar i skaparmodus",
	"gamerule.playersNetherPortalCreativeDelay.description": "Tid (i tikk) som ein spelar i skaparmodus må stå i ein netherportal før spelaren skiftar dimensjon.",
	"gamerule.playersNetherPortalDefaultDelay": "Spelarens forseinking i netherportalar utanom skaparmodus",
	"gamerule.playersNetherPortalDefaultDelay.description": "Tid (i tikk) ein spelar som ikkje er i skaparmodus må stå i ein netherportal før spelaren skiftar dimensjon.",
	...
	"gamerule.projectilesCanBreakBlocks": "Prosjektil kan øydeleggja blokkar",
	"gamerule.projectilesCanBreakBlocks.description": "Kontrollerar om prosjektilar vil øydeleggja blokkar som kan øydeleggjast av dei.",
	...
	"gamerule.reducedDebugInfo.description": "Grensar av innehaldet på feilsøkjingsskjermen.",
	...
	"gamerule.spawnChunkRadius": "Byrjestadsverdbitradius",
	...
	"gamerule.spawnerBlocksEnabled": "Slå på skapningsframkallarar",
	"gamerule.spectatorsGenerateChunks": "Lat tilskodarar skapa landskap",
	"gamerule.tntExplodes": "Lèt TNT tennast og sprengja",
	"gamerule.tntExplosionDropDecay": "I TNT-sprengingar slepper nokre blokker ikkje alltid utbyte",
	"gamerule.tntExplosionDropDecay.description": "Noko av utbytet frå blokker øydelagde av sprengingar valda av TNT kverv i sprenginga.",
	...
	"gui.abuseReport.comments": "Kommentarar",
	"gui.abuseReport.describe": "Å dela detaljar hjelper oss med å gjera ei velgrunna avgjerd.",
	"gui.abuseReport.discard.content": "Om du fer misser du denne rapporten og kommentarane dine.\nEr du trygg på at du vil fara?",
	"gui.abuseReport.discard.discard": "Gå ut og kast rapporten",
	"gui.abuseReport.discard.draft": "Lagra som utkast",
	"gui.abuseReport.discard.return": "Haldt fram med å skriva",
	"gui.abuseReport.discard.title": "Kasta rapporten og kommentarar?",
	"gui.abuseReport.draft.content": "Vil du halda fram med å skriva på den gjeldande rapporten eller kasta honom og skriva ein ny?",
	"gui.abuseReport.draft.discard": "Kasta bort",
	"gui.abuseReport.draft.edit": "Haldt fram med å skriva",
	"gui.abuseReport.draft.quittotitle.content": "Vil du halda fram med å skriva eller kasta honom?",
	"gui.abuseReport.draft.quittotitle.title": "Du har eit utkast som kverv om du fer",
	"gui.abuseReport.draft.title": "Skriva meir på utkastet?",
	"gui.abuseReport.error.title": "Kunne ikkje senda rapporten din",
	"gui.abuseReport.message": "Kvar såg du den vonde framferda?\nDetta hjelper oss med å undersøkja saka di.",
	"gui.abuseReport.more_comments": "Skildra kva som hende:",
	...
	"gui.abuseReport.name.title": "Rapporter spelarnamn",
	"gui.abuseReport.observed_what": "Kvifor rapporterer du dette?",
	"gui.abuseReport.read_info": "Lær meir om rapportering",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Nokon skader omdømet ditt eller omdømet åt ein annan, lyg om å vera ein annan, eller breier usanningar med føremålet å villeia andre.",
	"gui.abuseReport.reason.description": "Utgreiing:",
	"gui.abuseReport.reason.false_reporting": "Misbruk av rapporteringsfunksjonen",
	"gui.abuseReport.reason.generic": "Eg vil rapportera honom/henne",
	"gui.abuseReport.reason.generic.description": "Han/ho plagar meg / har gjort noko eg ikkje likar.",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Sjølvskading eller sjølvmord",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Seksuelt upassande",
	...
	"gui.abuseReport.report_sent_msg": "Me har motteke rapporten din. Takk!\n\nLaget vårt ser på honom so fort som råd.",
	"gui.abuseReport.select_reason": "Vel rapportkategori",
	"gui.abuseReport.send": "Send rapport",
	"gui.abuseReport.send.comment_too_long": "Gjer kommentaren stuttare",
	...
	"gui.abuseReport.send.json_error": "Fann skadd nyttelast då du skulde senda rapporten din.",
	"gui.abuseReport.send.no_reason": "Vel ein rapportkategori",
	...
	"gui.abuseReport.skin.title": "Rapporter spelarham",
	"gui.abuseReport.title": "Rapporter spelar",
	"gui.abuseReport.type.chat": "Meldingar i nettprat",
	"gui.abuseReport.type.name": "Spelarnamn",
	"gui.abuseReport.type.skin": "Spelarham",
	...
	"gui.banned.name.description": "Det gjeldande namnet ditt - «%s» - strider imot samfunnsstandardane våre. Du kan spela på einspelar, men må gjera om på namnet ditt om du vil spela på nett.\n\nLær meir eller send saka til vurdering med den fylgjande lenkja: %s",
	"gui.banned.name.title": "Namnet er ikkje tillate i fleirspelar",
	...
	"gui.banned.skin.description": "Den gjeldande hamen din strider imot samfunnsstandardane våre. Du kan enno spela med ein standardham, eller velja ein ny.\n\nLær meir eller send saka til vurdering med den fylgjande lenkja: %s",
	"gui.banned.skin.title": "Hamen er ikkje tillaten",
	...
	"gui.chatReport.discard.return": "Haldt fram med å skriva",
	...
	"gui.chatReport.title": "Rapportér spelar i nettpraten",
	...
	"gui.copy_link_to_clipboard": "Kopiér lenkje til utklippstavla",
	"gui.days": "%s dag(ar)",
	"gui.done": "Ferdig",
	"gui.down": "Ned",
	...
	"gui.fileDropFailure.title": "Kunne ikkje leggja til filer",
	...
	"gui.loadingMinecraft": "Lastar Minecraft",
	...
	"gui.none": "Ingen",
	"gui.ok": "Greitt",
	"gui.open_report_dir": "Opne rapporteringsmappe",
	...
	"gui.recipebook.previous_page": "Førre side",
	...
	"gui.socialInteractions.hide": "Gøym i nettprat",
	"gui.socialInteractions.narration.hide": "Gøym meldingar frå %s",
	...
	"gui.socialInteractions.tooltip.hide": "Gøym meldingar",
	...
	"gui.toRealms": "Attende til Realms-lista",
	"gui.toTitle": "Attende til hovudmenyen",
	"gui.toWorld": "Attende til verdslista",
	"gui.togglable_slot": "Klikk for å slå av bås",
	"gui.up": "Opp",
	"gui.waitingForResponse.button.inactive": "Attende (%ss)",
	"gui.waitingForResponse.title": "Ventar på tenar",
	"gui.yes": "Ja",
	...
	"inventory.hotbarInfo": "Lagra verktøyline med %[1]s+%[2]s",
	"inventory.hotbarSaved": "Gjenstandsverktøyline lagra (henta opp att med %[1]s+%[2]s)",
	...
	"item.minecraft.armadillo_scute": "Beltedyrskjel",
	"item.minecraft.armadillo_spawn_egg": "Framkalleegg for beltedyr",
	"item.minecraft.armor_stand": "Rustningstativ",
	"item.minecraft.arms_up_pottery_shard": "Skålbrot med armane opp",
	"item.minecraft.arms_up_pottery_sherd": "Skålbrot med armane opp",
	...
	"item.minecraft.beef": "Rått oksekjøt",
	...
	"item.minecraft.bogged_spawn_egg": "Framkallingsegg for myrdraug",
	...
	"item.minecraft.breeze_spawn_egg": "Framkalleegg for vindskrømt",
	...
	"item.minecraft.bundle.empty.description": "Kan halda ein blanda hop av gjenstandar",
	"item.minecraft.bundle.full": "Full",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "Skålbrot med eldtunge",
	"item.minecraft.burn_pottery_sherd": "Skålbrot med eldtunge",
	"item.minecraft.camel_husk_spawn_egg": "Framkalleegg for dromedar-skaldauding",
	...
	"item.minecraft.cooked_beef": "Oksesteik",
	"item.minecraft.cooked_chicken": "Steikt høne",
	"item.minecraft.cooked_cod": "Kokt torsk",
	"item.minecraft.cooked_mutton": "Steikt sauekjøt",
	...
	"item.minecraft.copper_axe": "Koparøks",
	"item.minecraft.copper_boots": "Koparstøvlar",
	"item.minecraft.copper_chestplate": "Brystplate av kopar",
	"item.minecraft.copper_golem_spawn_egg": "Framkallingsegg for koparkall",
	"item.minecraft.copper_helmet": "Koparhjelm",
	"item.minecraft.copper_hoe": "Kopargrev",
	"item.minecraft.copper_horse_armor": "Koparhesterustning",
	"item.minecraft.copper_ingot": "Koparbarre",
	"item.minecraft.copper_leggings": "Beinplater av kopar",
	"item.minecraft.copper_nautilus_armor": "Koparperlebåtrustning",
	"item.minecraft.copper_nugget": "Koparklump",
	"item.minecraft.copper_pickaxe": "Koparhakke",
	"item.minecraft.copper_shovel": "Koparspade",
	"item.minecraft.copper_spear": "Koparspjut",
	"item.minecraft.copper_sword": "Koparsverd",
	"item.minecraft.cow_spawn_egg": "Framkalleegg for ku",
	"item.minecraft.creaking_spawn_egg": "Framkalleegg for knirkande",
	...
	"item.minecraft.crossbow.projectile.multiple": "Prosjektil: %s x %s",
	...
	"item.minecraft.cyan_harness": "Blågrønt seletøy",
	...
	"item.minecraft.explorer_pottery_shard": "Skålbrot med kart",
	"item.minecraft.explorer_pottery_sherd": "Skålbrot med kart",
	...
	"item.minecraft.friend_pottery_shard": "Skålbrot med venlegt andlet",
	"item.minecraft.friend_pottery_sherd": "Skålbrot med venlegt andlet",
	...
	"item.minecraft.golden_spear": "Gullspjut",
	...
	"item.minecraft.guster_banner_pattern": "Fanemønster",
	"item.minecraft.guster_banner_pattern.desc": "Vindskrømt",
	"item.minecraft.guster_banner_pattern.new": "Vindkaster-bannermønster",
	"item.minecraft.guster_pottery_sherd": "Skålbrot med vindskrømt",
	"item.minecraft.happy_ghast_spawn_egg": "Framkalleegg for gladghast",
	...
	"item.minecraft.heartbreak_pottery_shard": "Skålbrot med brote hjarta",
	"item.minecraft.heartbreak_pottery_sherd": "Skålbrot med brote hjarta",
	...
	"item.minecraft.howl_pottery_shard": "Skålbrot med varg",
	"item.minecraft.howl_pottery_sherd": "Skålbrot med varg",
	...
	"item.minecraft.light_blue_harness": "Ljosblått seletøy",
	"item.minecraft.light_gray_bundle": "Ljosgrå sekk",
	"item.minecraft.light_gray_dye": "Ljosgrålet",
	"item.minecraft.light_gray_harness": "Ljosgrått seletøy",
	"item.minecraft.lime_bundle": "Limegrøn sekk",
	...
	"item.minecraft.lingering_potion.effect.infested": "Dvelande fengjebrygg",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Dvelande tytebrygg",
	...
	"item.minecraft.lingering_potion.effect.slow_falling": "Dvelande seinfallsbrygg",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Dvelande verebrygg",
	"item.minecraft.lingering_potion.effect.wind_charged": "Dvelande vindladingsbrygg",
	...
	"item.minecraft.magenta_bundle": "Ljoslilla sekk",
	"item.minecraft.magenta_dye": "Ljoslillalet",
	"item.minecraft.magenta_harness": "Ljoslilla seletøy",
	...
	"item.minecraft.miner_pottery_shard": "Skålbrot med hakke",
	"item.minecraft.miner_pottery_sherd": "Skålbrot med hakke",
	...
	"item.minecraft.mourner_pottery_sherd": "Skålbrot med vord",
	"item.minecraft.mule_spawn_egg": "Framkalleegg for muldyr",
	"item.minecraft.mushroom_stew": "Soppgryte",
	...
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Creator (Speledåse)",
	...
	"item.minecraft.nautilus_shell": "Perlebåthus",
	"item.minecraft.nautilus_spawn_egg": "Framkalleegg for perlebåt",
	...
	"item.minecraft.netherite_boots": "Netherittstøvlar",
	...
	"item.minecraft.netherite_spear": "Netherittspjut",
	...
	"item.minecraft.ominous_trial_key": "Illevarande røynelykel",
	"item.minecraft.orange_bundle": "Oransje sekk",
	...
	"item.minecraft.pale_oak_chest_boat": "Bleikeikebåt med kiste",
	...
	"item.minecraft.pink_bundle": "Rosa sekk",
	"item.minecraft.pink_dye": "Rosalet",
	"item.minecraft.pink_harness": "Rosa seletøy",
	"item.minecraft.pitcher_plant": "Kanneberar",
	"item.minecraft.pitcher_pod": "Krukkefrø",
	"item.minecraft.plenty_pottery_shard": "Skålbrot med kiste",
	"item.minecraft.plenty_pottery_sherd": "Skålbrot med kiste",
	...
	"item.minecraft.potion.effect.empty": "Ulageleg brygg",
	...
	"item.minecraft.potion.effect.wind_charged": "Vindladingsbrygg",
	"item.minecraft.pottery_shard_archer": "Skålbrot med bogeskyttar",
	"item.minecraft.pottery_shard_arms_up": "Skålbrot med armane opp",
	...
	"item.minecraft.purple_bundle": "Lilla sekk",
	...
	"item.minecraft.rabbit_stew": "Haregryte",
	...
	"item.minecraft.red_harness": "Raudt seletøy",
	"item.minecraft.redstone": "Redstone-pulver",
	"item.minecraft.resin_brick": "Kvaetegl",
	...
	"item.minecraft.sheaf_pottery_shard": "Skålbrot med avling",
	"item.minecraft.sheaf_pottery_sherd": "Skålbrot med avling",
	...
	"item.minecraft.splash_potion.effect.empty": "Ulageleg kastebrygg",
	...
	"item.minecraft.splash_potion.effect.infested": "Kasteleg fengjebrygg",
	...
	"item.minecraft.splash_potion.effect.oozing": "Kasteleg tytebrygg",
	...
	"item.minecraft.splash_potion.effect.weaving": "Kasteleg vevebrygg",
	"item.minecraft.splash_potion.effect.wind_charged": "Kasteleg vindladingsbrygg",
	...
	"item.minecraft.stone_spear": "Steinspjut",
	...
	"item.minecraft.tipped_arrow.effect.empty": "Ulageleg duppa pil",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Fengjepil",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Tytepil",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Vevepil",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Vindladingspil",
	...
	"item.minecraft.turtle_scute": "Skjelpaddeskjel",
	...
	"item.minecraft.white_harness": "Kvitt seletøy",
	...
	"item.minecraft.wind_charge": "Vindkule",
	...
	"item.minecraft.zombie_nautilus_spawn_egg": "Framkalleegg for perlebåtdauding",
	...
	"item.modifiers.any": "Når påteke:",
	"item.modifiers.armor": "Når påkledd(e):",
	"item.modifiers.body": "Når påteke:",
	"item.modifiers.chest": "Når på kroppen:",
	"item.modifiers.feet": "Når på føtene:",
	"item.modifiers.hand": "Når halde(n):",
	...
	"item.op_block_warning.line2": "Å setja ned denne gjenstanden kann føra til at kommandoar vert sette i verk",
	"item.op_block_warning.line3": "Ikkje bruka om ikkje du kjenner innehaldet vel!",
	...
	"key.categories.spectator": "Tilskodar",
	"key.categories.ui": "Spelgrensesnitt",
	"key.category.minecraft.creative": "Skaparmodus",
	...
	"key.category.minecraft.multiplayer": "Fleirspelar",
	"key.category.minecraft.spectator": "Tilskodar",
	...
	"key.debug.reloadChunk": "Last inn verdsbitar på ny",
	...
	"key.quickActions": "Snarhandlingar",
	...
	"known_server_link.announcements": "Kunngjeringar",
	"known_server_link.community": "Samfunn",
	"known_server_link.community_guidelines": "Samfunnsretningslinjer",
	"known_server_link.feedback": "Tilbakemelding",
	"known_server_link.forums": "Drøftestadar",
	"known_server_link.news": "Nyhende",
	"known_server_link.report_bug": "Rapporter serverfeil",
	"known_server_link.status": "Stode",
	"known_server_link.support": "Stønad",
	...
	"manageServer.resourcePack.enabled": "Påslegen",
	"manageServer.resourcePack.prompt": "Spør",
	"mco.account.privacy.info": "Les meir om Mojang og personvernlover",
	"mco.account.privacy.info.button": "Les meir om GDPR",
	"mco.account.privacy.information": "Mojang set i verk visse framgangsmåtar for å hjelpa born og personvernet deira, inkludert fylgjing av den amerikanske lova Children’s Online Privacy Protection Act (COPPA) og personvernforordninga åt EU (GDPR).\n\nDet kan henda du må få løyve av ein forelder/verje før du får tilgang til Realms-kontoen din.",
	"mco.account.privacyinfo": "Mojang set i verk visse framgangsmåtar for å hjelpa born og personvernet deira, inkludert fylgjing av den amerikanske lova Children’s Online Privacy Protection Act (COPPA) og personvernforordninga åt EU (GDPR).\n\nDet kan henda du må få løyve av ein forelder/verje før du får tilgang til Realms-kontoen din.\n\nOm du har ein eldre Minecraft-konto (du loggar inn med brukarnamnet ditt), må du overføra kontoen din til ein Mojang-konto for å få tilgang til Realms.",
	...
	"mco.backup.entry": "Tryggjingsavrit (%s)",
	"mco.backup.entry.description": "Skildring",
	"mco.backup.entry.enabledPack": "Slo på datapakken",
	"mco.backup.entry.gameDifficulty": "Spelvandleik",
	"mco.backup.entry.gameMode": "Spelmodus",
	"mco.backup.entry.gameServerVersion": "Speltenarutgåve",
	"mco.backup.entry.name": "Namn",
	"mco.backup.entry.seed": "Seed",
	"mco.backup.entry.templateName": "Malnamn",
	"mco.backup.entry.undefined": "Udefinert omgjerd",
	"mco.backup.entry.uploaded": "Lasta opp",
	"mco.backup.entry.worldType": "Verdsslag",
	...
	"mco.backup.entry.worldType.unknown": "Ukjend",
	...
	"mco.compatibility.downgrade": "Nedgradér",
	"mco.compatibility.downgrade.description": "Denne verda var sist spela i utgåva %s. Du brukar utgåva %s. Å nedgradera ei verd kan føra til øydelegging. Det er uvisst om ho vil lasta inn eller verka som ho skal.\n\nEit tryggjingsavrit av verda di vert lagra i «World backups». Du kan atterskapa verda di om det trengst.",
	...
	"mco.compatibility.unverifiable.title": "Kompatibiliteten kan ikkje verifiserast",
	"mco.compatibility.upgrade": "Oppgradér",
	"mco.compatibility.upgrade.description": "Denne verda var sist spela i utgåva %s. Du brukar utgåva %s.\n\nEit tryggjingsavrit av verda di vert lagra i «World backups». Du kan atterskapa verda di om det trengst.",
	...
	"mco.configure.world.buttons.newworld": "Ny verd",
	...
	"mco.configure.world.buttons.region_preference": "Vel region...",
	"mco.configure.world.buttons.resetworld": "Set attende verd",
	"mco.configure.world.buttons.save": "Lagra",
	...
	"mco.configure.world.name": "Realmsnamn",
	...
	"mco.configure.world.players.inviting": "Byd inn spelar...",
	...
	"mco.configure.world.slot.switch.question.line1": "Realmen din vil verta bytt til ei onnor verd",
	...
	"mco.configure.world.subscription.start": "Byrjingsdag",
	"mco.configure.world.subscription.tab": "Tinging",
	...
	"mco.configure.world.uninvite.player": "Er du trygg på at du vil oppheva innbydinga åt «%s»?",
	...
	"mco.create.world.failed": "Skaping av verd var mislukka!",
	...
	"mco.download.resourcePack.fail": "Kunne ikkje lasta ned tilfangspakken!",
	...
	"mco.errorMessage.6005": "Verd låst",
	"mco.errorMessage.6006": "Verda er utdatert",
	"mco.errorMessage.6007": "Brukar i for mange Realmar",
	"mco.errorMessage.6008": "Ugildt Realm-namn",
	"mco.errorMessage.6009": "Ugild Realm-skildring",
	"mco.errorMessage.connectionFailure": "Noko gjekk gale. Freista att seinare.",
	"mco.errorMessage.generic": "Noko gjekk gale: ",
	"mco.errorMessage.initialize.failed": "Mislyktes i å initialisere Realm",
	"mco.errorMessage.noDetails": "Ingen detaljar gjeve om feilen",
	"mco.errorMessage.realmsService": "Noko gjekk gale (%s):",
	"mco.errorMessage.realmsService.configurationError": "En uforventet feil oppsto under endring av verdensinnstillinger",
	"mco.errorMessage.realmsService.connectivity": "Kunne ikkje kopla til Realms: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Kunne ikkje sjå på kompatibel utgåve; fekk svar: %s",
	...
	"mco.invited.player.narration": "Baud inn spelar %s",
	...
	"mco.notification.transferSubscription.buttonText": "Før over no",
	...
	"mco.onlinePlayers": "Spelarar på nett",
	...
	"mco.selectServer.loading": "Lastar inn Realm-liste",
	...
	"mco.selectServer.noRealms": "Du ser ikkje ut til å ha ein Realm. Legg til ein Realm for å spela med venene dine.",
	...
	"mco.selectServer.trial": "Få ei prøveutgåve!",
	...
	"mco.snapshot.createSnapshotPopup.title": "Laga utviklingsutgåve-Realm?",
	"mco.snapshot.creating": "Lagar utviklingsutgåve-Realm...",
	"mco.snapshot.description": "Samankopla med «%s»",
	"mco.snapshot.friendsRealm.downgrade": "Du må vera på utgåva %s for å verta med i denne Realmen",
	...
	"mco.snapshot.parent.tooltip": "Bruk den nyaste versjonen av Minecraft for å spele denne Realmen",
	"mco.snapshot.start": "Set opp kostnadsfri utviklingsutgåve-Realm",
	"mco.snapshot.subscription.info": "Dette er ein utviklingsversjons-Realm som er para med abonnementet '%s'. Den vil vere aktiv så lenge den para Realmen er aktiv.",
	"mco.snapshot.tooltip": "Bruk utviklginsversjons-Realmar for å få ein sniktitt på kommande versjonar av Minecraft, som kan innehalde nytt innhald eller andre endringar.\n\nDu kan finne dei normale Realmane dine i fullversjonen av spelet.",
	"mco.snapshotRealmsPopup.message": "Realms er no tilgjengeleg i utviklingsutgåver frå og med 23w41a. Kvar Realms-tinging kjem med ein kostnadsfri utviklingsutgåve-Realm som er skild frå den vanlege Java-Realmen!",
	"mco.snapshotRealmsPopup.title": "Realms er no tilgjengeleg i utviklingsutgåver",
	"mco.snapshotRealmsPopup.urlText": "Finn ut meir",
	...
	"mco.time.hoursAgo": "%[1]s time/timar sidan",
	"mco.time.minutesAgo": "%[1]s minutt sidan",
	"mco.time.now": "nett no",
	"mco.time.secondsAgo": "%[1]s sekund sidan",
	...
	"mco.upload.failed.too_big.description": "Den valde verda er for stor. Høgaste tillatne storleik er %s.",
	"mco.upload.failed.too_big.title": "Verd for stor",
	...
	"menu.quick_actions": "Snarhandlingar...",
	"menu.quick_actions.title": "Snarhandlingar",
	"menu.quit": "Enda spel",
	...
	"multiplayer.confirm_command.run_command": "Køyr kommando",
	...
	"multiplayer.disconnect.bad_chat_index": "Oppdaga ei overhoppa eller omstokka nettpratsmelding frå serveren",
	...
	"multiplayer.disconnect.banned.reason.default": "Bannlyst av ein operatør.",
	...
	"multiplayer.disconnect.invalid_packet": "Tenaren sende ein ugyldig pakke",
	...
	"multiplayer.disconnect.out_of_order_chat": "Nettpratspakke vart motteken i gala rekkjefylgje. Er systemtida di omgjord?",
	...
	"multiplayer.disconnect.transfers_disabled": "Tenaren godtek ikkje overføringar",
	...
	"multiplayer.message_not_delivered": "Kan ikkje senda melding. Sjå tenarloggen: %s",
	...
	"multiplayer.requiredTexturePrompt.disconnect": "Serveren krev ein eigen tilpassa ressurspakke",
	...
	"multiplayer.status.anonymous_player": "Anonym spelar",
	...
	"multiplayerWarning.message": "Åtvaring: Nettspel er tilbode av tredjeparts-tenarar som Mojang Studios eller Microsoft korkje eig, styrer, eller tilser. Når du spelar på nett kan du møta på umoderert nettprat eller andre former for brukarskapa innehald som ikkje alltid høver for alle.",
	...
	"narration.checkbox.usage.hovered.check": "Venstreklikk for å hake av",
	"narration.checkbox.usage.hovered.uncheck": "Venstreklikk for å fjerna haken",
	...
	"narration.slider.usage.focused": "Trykk på tastaturknappane for venstre eller høgre for å gjera om på verdiane",
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Trykk på Enter for å begynne å endre gliderverdien",
	"narration.slider.usage.hovered": "Drag glidaren for å gjera om på verdien",
	"narration.suggestion": "Valde framlegg %s av %s: %s",
	"narration.suggestion.tooltip": "Valde framlegg %s av %s: %s (%s)",
	"narration.suggestion.usage.cycle.fixed": "Trykk Tab for å koma deg til neste framlegg",
	"narration.suggestion.usage.cycle.hidable": "Trykk Tab for å koma deg til neste framlegg, eller Escape for å gå bort frå framlegga",
	"narration.suggestion.usage.fill.fixed": "Trykk Tab for å bruka framlegg",
	"narration.suggestion.usage.fill.hidable": "Trykk Tab for å bruka framlegg, eller Escape for å gå bort frå framlegga",
	...
	"narrator.select.world_info": "Valde %s, sist spela %s,%s",
	...
	"optimizeWorld.stage.finished.chunks": "Avsluttar oppgradering av verdsbitar...",
	"optimizeWorld.stage.finished.entities": "Avsluttar oppgradering av einingar...",
	"optimizeWorld.stage.finished.poi": "Avsluttar oppgradering av interessepunkt...",
	"optimizeWorld.stage.upgrading": "Oppgraderer alle verdsbitar...",
	"optimizeWorld.stage.upgrading.chunks": "Oppgraderer alle verdsbitar...",
	"optimizeWorld.stage.upgrading.entities": "Oppgraderer alle einingane...",
	"optimizeWorld.stage.upgrading.poi": "Oppgraderer alle interessepunktar...",
	"optimizeWorld.title": "Optimaliserer verda «%s»",
	"options.accessibility": "Innstillingar for tilgjenge...",
	...
	"options.accessibility.high_contrast_block_outline": "Høgkontrast på blokk-kant",
	"options.accessibility.high_contrast_block_outline.tooltip": "Styrkjer blokk-kantkontrasten på målblokki.",
	"options.accessibility.link": "Vegvisar for tilgjenge",
	"options.accessibility.menu_background_blurriness": "Bakgrunnsklårleik i menyen",
	"options.accessibility.menu_background_blurriness.tooltip": "Gjer om på klårleiken av menybakgrunnar",
	"options.accessibility.narrator_hotkey": "Snartast for forteljar",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Tillèt at forteljaren vert påslegen og avslegen med «Cmd+B»",
	"options.accessibility.narrator_hotkey.tooltip": "Tillèt at forteljaren vert påslegen og avslegen med «Ctrl+B»",
	...
	"options.chat": "Prateinstillingar...",
	"options.chat.color": "Leter",
	"options.chat.delay": "Samtaledrygjing: %s sekund",
	"options.chat.delay_none": "Samtaledrygjing: inga",
	...
	"options.chat.title": "Prateinstillingar...",
	...
	"options.chunkFade.tooltip": "Kor mange sekunder det vil taka for verdsbiter å koma til syne når dei fyrst vert skildra, om i det heile teke.",
	...
	"options.cutoutLeaves": "Gjennomsynlege lauv",
	...
	"options.darkMojangStudiosBackgroundColor": "Einleta logo",
	...
	"options.font": "Skriftval...",
	"options.font.title": "Skriftval",
	...
	"options.hideSplashTexts": "Gøym hovudmenytekster",
	"options.hideSplashTexts.tooltip": "Gøymer den gule hovudmenyteksta.",
	...
	"options.inactivityFpsLimit": "Set ned FPS når",
	...
	"options.inactivityFpsLimit.minimized.tooltip": "Avgrensar biletrate berre når spel-vindauget er lagt ned.",
	"options.invertMouse": "Spegelvend museretning",
	"options.invertMouseX": "Spegelvend datamusas x-akse",
	"options.invertMouseY": "Spegelvend datamusas y-akse",
	"options.japaneseGlyphVariants": "Japanske teiknvariantar",
	"options.japaneseGlyphVariants.tooltip": "Brukar japanske variantar av CJK-teikn i standardskrifttypen",
	...
	"options.languageAccuracyWarning": "(Det kan hende omsetjingane ikkje er 100%% rette)",
	...
	"options.music_frequency": "Musikkførekomst",
	...
	"options.renderCloudsDistance": "Skyfråstand",
	...
	"options.rotateWithMinecart": "Sving i lag med gruvevogner",
	...
	"options.screenEffectScale": "Rengjingsverknader",
	...
	"options.showSubtitles.tooltip": "Slår på undertekster for spela ljodar i spelet.",
	...
	"options.worldOptions.button": "Verdsval...",
	"options.worldOptions.title": "Verdsval",
	...
	"pack.dropRejected.message": "Fylgjande oppføringar var ugilde pakkar og vart ikkje kopierte:\n %s",
	"pack.dropRejected.title": "Oppføringar som ikkje er pakkar",
	...
	"painting.minecraft.changing.title": "Gjer om på",
	...
	"painting.minecraft.endboss.title": "Endeboss",
	...
	"painting.minecraft.finding.title": "Leitar",
	...
	"painting.minecraft.unpacked.title": "Pakka ut",
	...
	"realms.configuration.region.australia_east": "Ny-Sud-Wales, Australia",
	"realms.configuration.region.australia_southeast": "Viktoria, Australia",
	...
	"realms.configuration.region.east_us_2": "Nord-Karolina, USA",
	"realms.configuration.region.france_central": "Frankrike",
	"realms.configuration.region.japan_east": "Aust-Japan",
	"realms.configuration.region.japan_west": "Vest-Japan",
	"realms.configuration.region.korea_central": "Sud-Korea",
	...
	"realms.configuration.region.uae_north": "Dei sameinte arabiske emirata (UAE)",
	"realms.configuration.region.uk_south": "Sud-England",
	...
	"realms.configuration.region_preference.automatic_owner": "Automatisk (eigaren av Realmen)",
	"realms.configuration.region_preference.automatic_player": "Automatisk (fyrste som vert med i øykt)",
	...
	"recover_world.bug_tracker": "Meld ifrå om feil",
	"recover_world.button": "Freista å få attende",
	"recover_world.done.failed": "Kunne ikkje atterskape frå førre tilstand.",
	"recover_world.done.success": "Gjenoppretting lykkast!",
	"recover_world.done.title": "Berging ferdig",
	"recover_world.issue.missing_file": "Manglande fil",
	"recover_world.issue.none": "Inga vandemål",
	"recover_world.message": "Fylgjande problem hende medan spelet prøvde lesa verdsmappa «%s».\nDet kan vera mogeleg å skipa verda opp att frå ein eldre tilstand, eller so kan du melda ifrå om problemet i feilsporaren.",
	"recover_world.no_fallback": "Ingen tilstand å retta opp frå er tilgjengeleg",
	"recover_world.restore": "Freista å retta opp att",
	"recover_world.restoring": "Freistar å retta opp att verda...",
	"recover_world.state_entry": "Tilstand frå %s: ",
	"recover_world.state_entry.unknown": "ukjent",
	"recover_world.title": "Kunne ikkje lasta verd",
	"recover_world.warning": "Kunne ikkje lasta verdsaamandrag",
	...
	"restrictions_screen.button": "Avgrensingar...",
	...
	"restrictions_screen.title": "Avgrensingar",
	...
	"selectWorld.allowCommands.new": "Tillat fusk",
	...
	"selectWorld.commands": "Kommandoar",
	...
	"selectWorld.edit.resetIcon": "Set attende bilete",
	...
	"selectWorld.gameMode.survival.line1": "Leit etter tilfang, emna, auk i",
	...
	"selectWorld.incompatible.description": "Kan ikkje opna denne verda i denne utgåva.\nHo var sist spela i utgåve %s.",
	"selectWorld.incompatible.info": "Uhøvande utgåve: %s",
	"selectWorld.incompatible.title": "Uhøvande utgåve",
	"selectWorld.incompatible.tooltip": "Kan ikkje opna denne verda fordi ho var laga av ei uhøvande utgåve.",
	...
	"selectWorld.resource_load": "Førebur tilfang...",
	...
	"selectWorld.versionWarning": "Denne verda vart sist spela i utgåva %s og å lasta henne inn i denne utgåva kan valda øydelegging!",
	...
	"selectWorld.warning.lowDiskSpace.description": "Det er ikkje mykje plass att på eininga di. Å gå tom for diskplass medan du spelar kan føra til at verda di vert skada.",
	...
	"snbt.parser.expected_decimal_numeral": "Venta eit desimaltal",
	...
	"snbt.parser.leading_zero_not_allowed": "Desimaltal kan ikkje byrja med 0",
	...
	"stat.minecraft.happy_ghast_one_cm": "Veglengd på gladghast",
	...
	"stat.minecraft.interact_with_crafting_table": "Verksemd med emningsbord",
	...
	"stat.minecraft.nautilus_one_cm": "Veglengd på perlebåt",
	...
	"stat_type.minecraft.crafted": "Gonger emna",
	...
	"structure_block.detect_size": "Oppdag bygnadstorleik og stad:",
	...
	"subtitles.ambient.sound": "Nifs ljod",
	...
	"subtitles.block.candle.extinguish": "Voksljos sløkk",
	...
	"subtitles.block.copper_bulb.turn_off": "Koparpære vert slega av",
	"subtitles.block.copper_bulb.turn_on": "Koparpære vert slega på",
	"subtitles.block.copper_chest.close": "Kiste vert laten att",
	"subtitles.block.copper_chest.open": "Kiste vert opna",
	"subtitles.block.copper_trapdoor.close": "Lem vert laten att",
	"subtitles.block.copper_trapdoor.open": "Lem vert opna",
	"subtitles.block.crafter.craft": "Emnar emnar",
	"subtitles.block.crafter.fail": "Emnar var mislukka",
	"subtitles.block.creaking_heart.hurt": "Knirkehjarta brakar",
	"subtitles.block.creaking_heart.idle": "Nifs ljod",
	"subtitles.block.creaking_heart.spawn": "Knirkehjarta vaknar",
	"subtitles.block.deadbush.idle": "Turrleiksljodar",
	"subtitles.block.decorated_pot.insert": "Prydd potte vert fylt",
	"subtitles.block.decorated_pot.insert_fail": "Prydd potte vinglar",
	...
	"subtitles.block.dried_ghast.ambient": "Tørre ljodar",
	"subtitles.block.dried_ghast.ambient_water": "Tørka ghast rehydrerast",
	"subtitles.block.dried_ghast.place_in_water": "Uttørka ghast vert bløytlagt",
	"subtitles.block.dried_ghast.transition": "Uttørka ghast kjenner seg betre",
	"subtitles.block.dry_grass.ambient": "Susande ljodar",
	...
	"subtitles.block.generic.fall": "Noko fell på ei blokk",
	...
	"subtitles.block.pale_hanging_moss.idle": "Nifs ljos",
	...
	"subtitles.block.respawn_anchor.ambient": "Oppstodeanker svirrar",
	...
	"subtitles.block.sand.idle": "Sandljodar",
	"subtitles.block.sand.wind": "Vindljodar",
	...
	"subtitles.block.sculk_sensor.clicking": "Sculkemerkar byrjar å klikka",
	...
	"subtitles.block.shelf.activate": "Hylle vert slegen på",
	"subtitles.block.shelf.deactivate": "Hylle vert slegen av",
	"subtitles.block.shelf.multi_swap": "Gjenstandar vert bytt",
	"subtitles.block.shelf.place_item": "Gjenstand vert sett ned",
	"subtitles.block.shelf.single_swap": "Gjenstand vert bytt",
	"subtitles.block.shelf.take_item": "Gjenstand vert teken",
	...
	"subtitles.block.trapdoor.close": "Lem vert laten att",
	"subtitles.block.trapdoor.open": "Fallem åpnes",
	"subtitles.block.trapdoor.toggle": "Lem knirkar",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Illevarande gjenstand vert budd",
	"subtitles.block.trial_spawner.ambient": "Røyneframkallar sprakar",
	"subtitles.block.trial_spawner.ambient_charged": "Illevarande spraking",
	"subtitles.block.trial_spawner.ambient_ominous": "Illevarande spraking",
	"subtitles.block.trial_spawner.charge_activate": "Jartegn kringset røyneframkallar",
	"subtitles.block.trial_spawner.close_shutter": "Røyneframkallar stengjer",
	"subtitles.block.trial_spawner.detect_player": "Røyneframkallar lader opp",
	"subtitles.block.trial_spawner.eject_item": "Røyneframkallar slepp gjenstandar",
	"subtitles.block.trial_spawner.ominous_activate": "Jærtegn omfavner prøvelsesfremkaller",
	"subtitles.block.trial_spawner.open_shutter": "Røyneframkallar opnar",
	"subtitles.block.trial_spawner.spawn_item": "Illevarande gjenstand vert sloppen",
	"subtitles.block.trial_spawner.spawn_item_begin": "Illevarande gjenstand ovrar seg",
	"subtitles.block.trial_spawner.spawn_mob": "Skapning vert framkalla",
	...
	"subtitles.block.vault.close_shutter": "Kvelv lèt seg att",
	"subtitles.block.vault.deactivate": "Kvelv sløkk",
	"subtitles.block.vault.eject_item": "Kvelv slepp gjenstand",
	"subtitles.block.vault.insert_item": "Kvelv vert låst opp",
	"subtitles.block.vault.insert_item_fail": "Kvelv vert ikkje låst opp",
	"subtitles.block.vault.open_shutter": "Kvelv opnar seg",
	"subtitles.block.vault.reject_rewarded_player": "Kvelv avviser spelar",
	...
	"subtitles.entity.armadillo.ambient": "Beltedyr gryntar",
	"subtitles.entity.armadillo.brush": "Beltedyr vert kosta",
	...
	"subtitles.entity.armadillo.scute_drop": "Skjel fell av",
	"subtitles.entity.armadillo.unroll_finish": "Beltedyr rullar ut",
	...
	"subtitles.entity.baby_cat.ambient": "Kjetling mjauar",
	"subtitles.entity.baby_cat.beg_for_food": "Kjetling tigg",
	"subtitles.entity.baby_cat.death": "Kjetling døyr",
	"subtitles.entity.baby_cat.eat": "Kjetling et",
	"subtitles.entity.baby_cat.hiss": "Kjetling kveser",
	"subtitles.entity.baby_cat.hurt": "Kjetling verkjer",
	"subtitles.entity.baby_cat.purr": "Kjetling mel",
	"subtitles.entity.baby_chicken.ambient": "Kjukling pip",
	"subtitles.entity.baby_chicken.death": "Kjukling døyr",
	"subtitles.entity.baby_chicken.hurts": "Kjukling verkjer",
	"subtitles.entity.baby_horse.ambient": "Føl kneggjar",
	"subtitles.entity.baby_horse.angry": "Føl kneggjar",
	"subtitles.entity.baby_horse.breathe": "Føl pustar",
	"subtitles.entity.baby_horse.death": "Føl døyr",
	"subtitles.entity.baby_horse.eat": "Føl et",
	"subtitles.entity.baby_horse.hurt": "Føl verkjer",
	"subtitles.entity.baby_horse.land": "Fole landar",
	"subtitles.entity.baby_nautilus.ambient": "Perlebåtunge kvitrer",
	"subtitles.entity.baby_nautilus.ambient_land": "Perlebåtunge kvitrer",
	"subtitles.entity.baby_nautilus.death": "Perlebåtunge døyr",
	"subtitles.entity.baby_nautilus.death_land": "Perlebåtunge døyr",
	"subtitles.entity.baby_nautilus.eat": "Perlebåtunge et",
	"subtitles.entity.baby_nautilus.hurt": "Perlebåtunge verkjer",
	"subtitles.entity.baby_nautilus.hurt_land": "Perlebåtunge verkjer",
	"subtitles.entity.baby_nautilus.swim": "Perlebåtunge sym",
	"subtitles.entity.baby_pig.ambient": "Grisunge gryntar",
	"subtitles.entity.baby_pig.death": "Grisunge døyr",
	"subtitles.entity.baby_pig.eat": "Grisunge et",
	"subtitles.entity.baby_pig.hurt": "Grisunge verkjer",
	"subtitles.entity.baby_wolf.ambient": "Kvelp bjeffar",
	"subtitles.entity.baby_wolf.death": "Kvelp døyr",
	"subtitles.entity.baby_wolf.growl": "Kvelp knurrar",
	"subtitles.entity.baby_wolf.hurt": "Kvelp verkjer",
	"subtitles.entity.baby_wolf.pant": "Kvelp pesar",
	"subtitles.entity.baby_wolf.whine": "Kvelp kvin",
	...
	"subtitles.entity.bogged.ambient": "Myrdraug ranglar",
	"subtitles.entity.bogged.death": "Myrdraug døyr",
	"subtitles.entity.bogged.hurt": "Myrdraug verkjer",
	"subtitles.entity.breeze.charge": "Vindskrømt lader opp",
	"subtitles.entity.breeze.death": "Vindskrømt døyr",
	"subtitles.entity.breeze.deflect": "Vindskrømt bægjer",
	"subtitles.entity.breeze.hurt": "Vindskrømt verkjer",
	"subtitles.entity.breeze.idle_air": "Vindskrømt flyg",
	"subtitles.entity.breeze.idle_ground": "Vindskrømt svirrar",
	"subtitles.entity.breeze.inhale": "Vindskrømt andar inn",
	"subtitles.entity.breeze.jump": "Vindskrømt hoppar",
	"subtitles.entity.breeze.land": "Vindskrømt landar",
	"subtitles.entity.breeze.shoot": "Vindskrømt skyt",
	"subtitles.entity.breeze.slide": "Vindskrømt glid",
	"subtitles.entity.breeze.whirl": "Vindskrømt kvervlar",
	"subtitles.entity.breeze.wind_burst": "Vindkule brestar",
	...
	"subtitles.entity.camel_husk.ambient": "Dromedar-skaldauding gryntar",
	"subtitles.entity.camel_husk.dash": "Dromedar-skaldauding hoppar",
	"subtitles.entity.camel_husk.dash_ready": "Dromedar-skaldauding kjem seg",
	"subtitles.entity.camel_husk.death": "Dromedar-skaldauding døyr",
	"subtitles.entity.camel_husk.eat": "Dromedar-skaldauding et",
	"subtitles.entity.camel_husk.hurt": "Dromedar-skaldauding verkjer",
	"subtitles.entity.camel_husk.saddle": "Dromedar-skaldauding vert ikledd sâl",
	...
	"subtitles.entity.copper_golem.death": "Koparkall døyr",
	"subtitles.entity.copper_golem.hurt": "Koparkall verkjer",
	"subtitles.entity.copper_golem.item_drop": "Koparkall set ned gjenstand",
	"subtitles.entity.copper_golem.item_no_drop": "Koparkall kan ikkje setja ned gjenstand",
	"subtitles.entity.copper_golem.no_item_get": "Koparkall tek opp gjenstand",
	"subtitles.entity.copper_golem.no_item_no_get": "Koparkall kan ikkje ta opp gjenstand",
	"subtitles.entity.copper_golem.spawn": "Koparkall vert til",
	"subtitles.entity.copper_golem.spin": "Hovudet åt koparkall går rundt",
	"subtitles.entity.copper_golem_become_statue": "Koparkall hardnar",
	"subtitles.entity.copper_golem_oxidized.death": "Koparkall døyr",
	"subtitles.entity.copper_golem_oxidized.hurt": "Koparkall verkjer",
	"subtitles.entity.copper_golem_oxidized.spin": "Hovudet åt koparkall går rundt",
	"subtitles.entity.copper_golem_weathered.death": "Koparkall døyr",
	"subtitles.entity.copper_golem_weathered.hurt": "Koparkall verkjer",
	"subtitles.entity.copper_golem_weathered.spin": "Hovudet åt koparkall går rundt",
	...
	"subtitles.entity.creaking.activate": "Knirk ser",
	"subtitles.entity.creaking.ambient": "Knirk knirkar",
	"subtitles.entity.creaking.attack": "Knirk åtek",
	"subtitles.entity.creaking.deactivate": "Knirk roar seg",
	"subtitles.entity.creaking.death": "Knirk dett i hop",
	"subtitles.entity.creaking.freeze": "Knirk stansar",
	"subtitles.entity.creaking.spawn": "Knirk syner seg",
	"subtitles.entity.creaking.sway": "Knirk vert slegen",
	"subtitles.entity.creaking.twitch": "Knirk kipper",
	"subtitles.entity.creaking.unfreeze": "Knirk røyver seg",
	...
	"subtitles.entity.donkey.jump": "Asen hoppar",
	...
	"subtitles.entity.drowned.shoot": "Draug kastar ljoster",
	...
	"subtitles.entity.generic.wind_burst": "Vindlading sprengjer",
	...
	"subtitles.entity.ghastling.ambient": "Vesleghast kurrar",
	"subtitles.entity.ghastling.death": "Vesleghast døyr",
	"subtitles.entity.ghastling.hurt": "Vesleghast verkjer",
	"subtitles.entity.ghastling.spawn": "Vesleghast dukkar opp",
	...
	"subtitles.entity.happy_ghast.ambient": "Gladghast kurrar",
	"subtitles.entity.happy_ghast.death": "Gladghast døyr",
	"subtitles.entity.happy_ghast.equip": "Seletøy takast på",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Gladghast er klar",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Gladghast stoppar",
	"subtitles.entity.happy_ghast.hurt": "Gladghast verkjer",
	"subtitles.entity.happy_ghast.unequip": "Seletøy takast av",
	...
	"subtitles.entity.minecart.inside": "Gruvevogn ranglar",
	"subtitles.entity.minecart.inside_underwater": "Gruvevogn vaggar under vatn",
	...
	"subtitles.entity.nautilus.ambient": "Perlebåt klakkar",
	"subtitles.entity.nautilus.ambient_land": "Perlebåt klakkar",
	"subtitles.entity.nautilus.dash": "Perlebåt strålar fram",
	"subtitles.entity.nautilus.dash_land": "Perlebåt strålar fram",
	"subtitles.entity.nautilus.dash_ready": "Perlebåt kjem seg",
	"subtitles.entity.nautilus.dash_ready_land": "Perlebåt kjem seg",
	"subtitles.entity.nautilus.death": "Perlebåt døyr",
	"subtitles.entity.nautilus.death_land": "Perlebåt døyr",
	"subtitles.entity.nautilus.eat": "Perlebåt et",
	"subtitles.entity.nautilus.hurt": "Perlebåt verkjer",
	"subtitles.entity.nautilus.hurt_land": "Perlebåt verkjer",
	"subtitles.entity.nautilus.swim": "Perlebåt sym",
	...
	"subtitles.entity.parched.death": "Turring døyr",
	"subtitles.entity.parched.hurt": "Turring verkjer",
	...
	"subtitles.entity.parrot.imitate.bogged": "Papegøye ranglar",
	"subtitles.entity.parrot.imitate.breeze": "Papegøye svirrar",
	"subtitles.entity.parrot.imitate.camel_husk": "Papegøye surmuler",
	"subtitles.entity.parrot.imitate.creaking": "Papegøye knirkar",
	...
	"subtitles.entity.pig.eat": "Gris et",
	...
	"subtitles.entity.player.teleport": "Spelar teleporterer",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Hestebeinrangel hoppar",
	...
	"subtitles.entity.sniffer.egg_crack": "Moldnaseegg sprekk",
	"subtitles.entity.sniffer.egg_hatch": "Moldnaseegg klekkjer",
	...
	"subtitles.entity.turtle.death_baby": "Skjelpaddeunge døyr",
	...
	"subtitles.entity.turtle.hurt": "Skjelpadde verkjer",
	...
	"subtitles.entity.zombie_horse.angry": "Hestedauding kneggjar",
	"subtitles.entity.zombie_horse.death": "Hestedauding døyr",
	"subtitles.entity.zombie_horse.eat": "Hestedauding et",
	...
	"subtitles.entity.zombie_nautilus.dash": "Perlebåtdauding stålar fram",
	"subtitles.entity.zombie_nautilus.dash_land": "Perlebåtdauding stålar fram",
	"subtitles.entity.zombie_nautilus.dash_ready": "Perlebåtdauding kjem seg",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Perlebåtdauding kjem seg",
	"subtitles.entity.zombie_nautilus.death": "Perlebåtdauding døyr",
	"subtitles.entity.zombie_nautilus.death_land": "Perlebåtdauding døyr",
	"subtitles.entity.zombie_nautilus.eat": "Perlebåtdauding et",
	"subtitles.entity.zombie_nautilus.hurt": "Perlebåtdauding verkjer",
	"subtitles.entity.zombie_nautilus.hurt_land": "Perlebåtdauding verkjer",
	"subtitles.entity.zombie_nautilus.swim": "Perlebåtdauding et",
	...
	"subtitles.event.mob_effect.bad_omen": "Jartegn slår rot",
	"subtitles.event.mob_effect.raid_omen": "Herjing ruvar i nærleiken",
	"subtitles.event.mob_effect.trial_omen": "Illevarande røyning ruvar i nærleiken",
	...
	"subtitles.item.armor.equip_nautilus": "Perlebåt vert ikledd rustning",
	...
	"subtitles.item.armor.equip_wolf": "Vargrustning vert teken på",
	"subtitles.item.armor.unequip_nautilus": "Perlebåtrustning takast av",
	"subtitles.item.armor.unequip_wolf": "Vargrustning glid av",
	...
	"subtitles.item.bundle.insert_fail": "Sekken er full",
	...
	"subtitles.item.crossbow.charge": "Låsboge vert spend",
	"subtitles.item.crossbow.hit": "Pil høver",
	"subtitles.item.crossbow.load": "Låsboge vert ladd",
	...
	"subtitles.item.golden_dandelion.unuse": "Gull-løvetann set i gang aldring",
	"subtitles.item.golden_dandelion.use": "Gull-løvetann stansar aldring",
	...
	"subtitles.item.mace.smash_air": "Stridsklubbe vert slengd",
	"subtitles.item.mace.smash_ground": "Stridsklubbe slår ned",
	"subtitles.item.nautilus_saddle_equip": "Perlebåt vert ikledd sâl",
	...
	"subtitles.item.spear.attack": "Spjut stikk",
	"subtitles.item.spear.hit": "Spjut høver",
	"subtitles.item.spear.lunge": "Spjut flyg",
	"subtitles.item.spear.use": "Fyk fram med spjut",
	"subtitles.item.spear_wood.attack": "Spjut stikk",
	"subtitles.item.spear_wood.hit": "Spjut høver",
	"subtitles.item.spear_wood.use": "Fyk fram med spjut",
	...
	"subtitles.item.trident.hit": "Ljoster stikk",
	"subtitles.item.trident.hit_ground": "Ljoster bivrar",
	...
	"subtitles.item.trident.thunder": "Ljostretore brakar",
	"subtitles.item.underwater_saddle.equip": "Skapning sales under vann",
	"subtitles.item.wolf_armor.break": "Vargrustning går sund",
	"subtitles.item.wolf_armor.crack": "Vargrustning slår sprekkar",
	"subtitles.item.wolf_armor.damage": "Vargrustning tek skade",
	"subtitles.item.wolf_armor.repair": "Vargrustning er vølt",
	"subtitles.particle.soul_escape": "Sjel flyr",
	"subtitles.ui.cartography_table.take_result": "Kart vert teikna",
	"subtitles.ui.hud.bubble_pop": "Andemålar søkk",
	...
	"symlink_warning.message": "Å lasta verder frå mapper med symbolske lenkjer kan vera utrygt om ein ikkje veit kva ein gjer. Vitja %s for å læra meir.",
	"symlink_warning.message.pack": "Å lasta inn pakker frå mapper med symbolske lenkjer kan vera utrygt om du ikkje veit kva du gjer. Gjer vel og vitja %s for å læra meir.",
	"symlink_warning.message.world": "Å lasta inn verder frå mapper med symbolske lenkjer kan vera utrygt om du ikkje veit kva du gjer. Gjer vel og vitja %s for å læra meir.",
	"symlink_warning.more_info": "Fleire opplysingar",
	"symlink_warning.title": "Mappa med verder inneheld symbolske lenkjer",
	"symlink_warning.title.pack": "Pakke/-ane som er lagd(e) til inneheld symbolske lenkjer",
	"symlink_warning.title.world": "Mappa med verder inneheld symbolske lenkjer",
	...
	"telemetry.event.advancement_made.description": "Ved å skjøna samanhengen bak å vinna seg bragder kan ein lettare skjøna og betra framgangen i spelet.",
	"telemetry.event.advancement_made.title": "Bragd gjord",
	"telemetry.event.game_load_times.description": "Denne hendinga kan hjelpa med å finna ut kvar ein skal betra oppstartsytinga ved å måla tida på utføringa under oppstart.",
	...
	"telemetry.event.optional.disabled": "%s (Valfritt) - Avslege",
	...
	"telemetry.event.performance_metrics.description": "Å kjenna til den overordna ytingsprofilen åt Minecraft hjelper oss med å tilmåta og optimalisera spelet for eit breitt utval maskinspesifikasjonar og operativsystem. Spelutgåve fylgjer med for å hjelpa oss å jamføra ytingsprofilane åt nyare utgåver av Minecraft.",
	"telemetry.event.performance_metrics.title": "Ytingsmål",
	"telemetry.event.required": "%s (påkravd)",
	"telemetry.event.world_load_times.description": "Det er viktig for oss å skjøna kor lang tid det tek å verta med i ei verd, og korleis det skifter over tid. Til dømes, når me legg inn nye funksjonar eller gjer store tekniske omgjerder treng me sjå kva påverknad det har på lastingstida.",
	...
	"telemetry.event.world_unloaded.description": "Denne hendinga er kopla saman med World Loaded-hendinga for å rekna ut kor lenge økta åt verda har vart. Varigna (i sekund eller tikk) er målt når økta åt verda har enda (går attende til hovudmenyen, koplar frå ein tenar).",
	"telemetry.event.world_unloaded.title": "Verd avlasta",
	...
	"telemetry_info.button.privacy_statement": "Personvernsfråsegn",
	"telemetry_info.button.show_data": "Vis dataa mine",
	"telemetry_info.opt_in.description": "Eg samtykkjer til at valfrie telemetridata vert sende",
	"telemetry_info.property_title": "Inneheldt data",
	"telemetry_info.screen.description": "Å samla desse dataa hjelper oss med å betra Minecraft ved å føra oss i dei leiene som er relevante for spelarane våre.\nDu kan òg senda inn særskilt atterbod for å hjelpa oss i arbeidet.",
	...
	"test.error.expected_block_present": "Venta at blokk %s skulle vere til stades",
	...
	"test.error.expected_entity_around": "Venta %s å finnast i kring %s, %s, %s",
	"test.error.expected_entity_count": "Venta %s einingar av slag %s: fann %s",
	...
	"test.error.expected_entity_in_test": "Venta at %s fanst i test",
	...
	"test.error.expected_item": "Venta gjenstand av slag %s",
	"test.error.expected_items_count": "Venta %s gjenstandar av slag %s: fann %s",
	"test.error.fail": "Feilbetingelser møtte",
	"test.error.invalid_block_type": "Uventa blokkslag funne: %s",
	"test.error.missing_block_entity": "Saknar blokkeining",
	...
	"test.error.too_many_entities": "Venta berre éin %s å finnast i kring %s, %s, %s, men fann %s",
	"test.error.unexpected_block": "Venta ikkje at blokka var %s",
	"test.error.unexpected_entity": "Venta ikkje at %s fanst",
	"test.error.unexpected_item": "Venta ikkje gjenstand av slag %s",
	"test.error.unknown": "Ukjend indre feil: %s",
	"test.error.value_not_equal": "Venta at %s var %s: var %s",
	"test.error.value_not_in_between": "Forventet at %s var mellom %s og %s: var %s",
	"test.error.wrong_block_entity": "Feil blokkeiningsslag: %s",
	...
	"title.credits": "Opphavsrett Mojang AB. Ikkje distribuer!",
	"title.multiplayer.disabled": "Fleirspelar er avslege. Sjå til innstillingane for Microsoft-kontoen din.",
	"title.multiplayer.disabled.banned.name": "Du må gjera om på namnet ditt før du kan spela på nett",
	...
	"trim_material.minecraft.resin": "Kvaeemne",
	"trim_pattern.minecraft.bolt": "Tore-rustningspryd",
	...
	"trim_pattern.minecraft.flow": "Kvervlande rustningspryd",
	...
	"tutorial.craft_planks.title": "Emna treplankar",
	...
	"upgradeWorld.aborted.reportBug": "Meld ein feil",
