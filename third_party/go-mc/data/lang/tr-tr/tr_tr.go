// Code generated by tools/gen_lang.go from 26.1/tr_tr.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Erişilebilirlik Ayarları...",
	"accessibility.onboarding.accessibility.button.narration": "Erişilebilirlik Ayarları",
	"accessibility.onboarding.screen.narrator": "Metin okuyucuyu etkinleştirmek için enter tuşuna basın",
	"accessibility.onboarding.screen.title": "Minecraft’a hoş geldiniz!\n\nMetin okuyucuyu açmak veya Erişilebilirlik Ayarlarını ziyaret etmek ister misiniz?",
	"addServer.add": "Bitti",
	...
	"advMode.notEnabled": "Komut blokları açık değil",
	"advMode.notEnabled.spawner": "Çağırıcı bloklar etkin değil",
	"advMode.previousOutput": "Önceki Çıktı",
	"advMode.setCommand": "Blok için Konsol Komutu Ayarla",
	"advMode.setCommand.disabled": "Komut ayarlandı: %s, ama komut blokları hâla kapalı",
	...
	"advancements.adventure.arbalistic.description": "Beş farklı canlıyı tek arbalet vuruşu ile öldürün",
	"advancements.adventure.arbalistic.title": "Arbalistik",
	"advancements.adventure.avoid_vibration.description": "Sizi fark etmesini önlemek için bir sculk sensörünün veya muhafızın yakınlarında eğilin",
	"advancements.adventure.avoid_vibration.title": "Sinsilik: 100",
	"advancements.adventure.blowback.description": "Esintinin göndermiş olduğu bir rüzgâr topunu saptırarak esintiyi öldürün",
	"advancements.adventure.blowback.title": "Geri Tepme",
	"advancements.adventure.brush_armadillo.description": "Fırça kullanarak bir armadillodan pul elde edin",
	"advancements.adventure.brush_armadillo.title": "Alla Beni Pulla Beni",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "4 çömlek parçasından süslü bir çömlek yapın",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Özenli Onarım",
	"advancements.adventure.crafters_crafting_crafters.description": "Bir üretici, üretici ürettiğinde üreticinin yanında olun",
	"advancements.adventure.crafters_crafting_crafters.title": "Üreticiler Üretici Üretiyor",
	...
	"advancements.adventure.fall_from_world_height.title": "Nereden Nereye",
	"advancements.adventure.heart_transplanter.description": "Bir gıcırtı kalbini iki soluk meşe kütüğü bloğu arasına doğru biçimde yerleştir",
	"advancements.adventure.heart_transplanter.title": "Kalp Nakli",
	...
	"advancements.adventure.honey_block_slide.title": "Bala Bastık",
	"advancements.adventure.kill_a_mob.description": "Herhangi bir saldırgan canavarı öldürün",
	...
	"advancements.adventure.kill_all_mobs.title": "Canavar Bükücü",
	...
	"advancements.adventure.lighten_up.description": "Bir bakır ampulünü parlatmak için onu baltayla kazıyın",
	"advancements.adventure.lighten_up.title": "Yüzün Gözün Açılsın",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Bir sınama zindanına ayak basın",
	"advancements.adventure.minecraft_trials_edition.title": "Sınama Başlasın!",
	"advancements.adventure.ol_betsy.description": "Arbaleti ateşleyin",
	"advancements.adventure.ol_betsy.title": "Gez Göz Arpacık",
	"advancements.adventure.overoverkill.description": "Gürz kullanarak tek vuruşta 50 kalp hasar verin",
	"advancements.adventure.overoverkill.title": "Vur Dedik Öldürdün",
	"advancements.adventure.play_jukebox_in_meadows.description": "Çayırları bir müzik kutusundan gelen müzik ile canlandırın",
	"advancements.adventure.play_jukebox_in_meadows.title": "Çayır Çimen Geze Geze",
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Karşılaştırıcı kullanarak yontulmuş kitaplığın güç sinyalini okuyun",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Kitapların Gücü",
	"advancements.adventure.revaulting.description": "Uğursuz sınama anahtarı kullanarak bir uğursuz kasayı açın",
	"advancements.adventure.revaulting.title": "Kasabada Başkaldırı",
	"advancements.adventure.root.description": "Macera, keşif ve savaş",
	"advancements.adventure.root.title": "Macera",
	"advancements.adventure.salvage_sherd.description": "Bir çömlek parçası elde etmek için Şüpheli bir bloğu fırçalayın",
	"advancements.adventure.salvage_sherd.title": "Kalıntılara Saygı Duymak",
	...
	"advancements.adventure.spear_many_mobs.description": "Beş canlıyı tek mızrak hücum saldırısı ile vurun",
	"advancements.adventure.spear_many_mobs.title": "Şiş Kebap",
	"advancements.adventure.spyglass_at_dragon.description": "Dürbünle Ender ejderhasına bakın",
	"advancements.adventure.spyglass_at_dragon.title": "O Bir Uçak Mı?",
	"advancements.adventure.spyglass_at_ghast.description": "Dürbünle bir Ghast’a bakın",
	"advancements.adventure.spyglass_at_ghast.title": "O Bir Balon Mu?",
	"advancements.adventure.spyglass_at_parrot.description": "Dürbünle bir papağana bakın",
	"advancements.adventure.spyglass_at_parrot.title": "O Bir Kuş Mu?",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Bu demirci şablonlarını en az bir kez uygulayın: Sarmal, Domuz Burnu, Kaburga, Koğuş, Sessizlik, Sinirbozan, Gelgit, Yol Bulucu",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Özgün Tarzlı Demircilik",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Demirci masasında süslenmiş bir zırh üretin",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Şimdi Daha Şık!",
	"advancements.adventure.two_birds_one_arrow.description": "Delici bir okla iki kâbus öldürün",
	"advancements.adventure.two_birds_one_arrow.title": "Bir Okla İki Kuş",
	"advancements.adventure.under_lock_and_key.description": "Sınama anahtarı ile bir kasayı açın",
	"advancements.adventure.under_lock_and_key.title": "Kilit Nokta",
	"advancements.adventure.use_lodestone.description": "Manyetit üzerinde bir pusula kullanın",
	"advancements.adventure.use_lodestone.title": "Beni Evime İt, Ey Manyetit",
	...
	"advancements.adventure.who_needs_rockets.description": "Rüzgâr topu kullanarak kendinizi 8 blok yukarı fırlatın",
	"advancements.adventure.who_needs_rockets.title": "Fişeği Kim Ne Yapsın?",
	...
	"advancements.end.respawn_dragon.description": "Ender ejderhasını diriltin",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Bir huzurveren'in, nota bloğuna pasta bırakmasını sağlayın",
	"advancements.husbandry.allay_deliver_cake_to_note_block.title": "Doğum Günü Şarkısı",
	"advancements.husbandry.allay_deliver_item_to_player.description": "Bir huzurveren'in size eşya getirmesini sağlayın",
	...
	"advancements.husbandry.complete_catalogue.title": "Pisi Pisikopatı",
	"advancements.husbandry.feed_snifflet.description": "Bir koklarca yavrusu besleyin",
	"advancements.husbandry.feed_snifflet.title": "Küçük Koklamalar",
	...
	"advancements.husbandry.make_a_sign_glow.title": "Işıl Işıl!",
	"advancements.husbandry.netherite_hoe.description": "Bir çapayı geliştirmek için bir netherit külçesi kullanın ve hayat tercihlerinizi bir gözden geçirin",
	"advancements.husbandry.netherite_hoe.title": "Ciddi Düşkünlük",
	"advancements.husbandry.obtain_sniffer_egg.description": "Bir Koklarca Yumurtası elde edin",
	"advancements.husbandry.obtain_sniffer_egg.title": "İlginç Kokuyor",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Bir kurumuş ghast bloğunu suya yerleştirin",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Su Hayattır!",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Herhangi bir Koklarca tohumu ekin",
	"advancements.husbandry.plant_any_sniffer_seed.title": "Geçmişin Ekilişi",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Makas kullanarak bir kurdun zırhını çıkarın",
	"advancements.husbandry.remove_wolf_armor.title": "Keskin Zekâ",
	"advancements.husbandry.repair_wolf_armor.description": "Armadillo pulu kullanarak hasarlı bir kurt zırhını tamamen onarın",
	"advancements.husbandry.repair_wolf_armor.title": "Yeni Gibi",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Arıları sinirlendirmeden kovanlarından bir cam şişe ve kamp ateşi kullanarak bal toplayın",
	"advancements.husbandry.safely_harvest_honey.title": "Arımıza Hoş Geldin",
	...
	"advancements.husbandry.tactical_fishing.description": "Bir balık yakalayın... ama olta kullanmadan!",
	...
	"advancements.husbandry.tame_an_animal.title": "Sadık Dost",
	"advancements.husbandry.uh_oh.description": "Bir Sülfür Küpünün içine TNT almasını sağlayın",
	"advancements.husbandry.uh_oh.title": "Ayvayı Yedik",
	"advancements.husbandry.wax_off.description": "Bir bakır bloğundan bal mumunu kazıyın!",
	"advancements.husbandry.wax_off.title": "Parlat",
	"advancements.husbandry.wax_on.description": "Bir bakır bloğuna bal peteği sürün!",
	"advancements.husbandry.wax_on.title": "Cilala",
	"advancements.husbandry.whole_pack.description": "Bütün kurt türlerini evcilleştirin",
	"advancements.husbandry.whole_pack.title": "Bir Sürü Kurt",
	...
	"advancements.nether.brew_potion.title": "Yerel İksirevi",
	"advancements.nether.charge_respawn_anchor.description": "Bir dirilticiyi tamamen şarj edin",
	...
	"advancements.nether.create_full_beacon.title": "Işıkların Gücü Adına!",
	...
	"advancements.nether.fast_travel.title": "Uzun İnce Yol",
	"advancements.nether.find_bastion.description": "Bir burç kalıntısına girin",
	"advancements.nether.find_bastion.title": "Hey Gidi Günler",
	"advancements.nether.find_fortress.description": "Bir Nether kalesine girin",
	"advancements.nether.find_fortress.title": "Berbat Bir Kale",
	"advancements.nether.get_wither_skull.description": "Bir Wither iskeletinin kafatasını elde edin",
	...
	"advancements.nether.loot_bastion.title": "Domuzdan Kıl Koparmak",
	...
	"advancements.nether.obtain_blaze_rod.description": "Bir Blaze’in çubuğunu alın",
	"advancements.nether.obtain_blaze_rod.title": "Alevlerin İçine",
	"advancements.nether.obtain_crying_obsidian.description": "Ağlayan obsidiyen edinin",
	"advancements.nether.obtain_crying_obsidian.title": "Kim Soğan Kesiyor?",
	"advancements.nether.return_to_sender.description": "Bir Ghast’ı ateş topuyla öldürün",
	...
	"advancements.nether.ride_strider_in_overworld_lava.description": "Lavgezer ile dünyadaki bir lav gölünde uzuuuun bir yolculuğa çıkın",
	...
	"advancements.nether.uneasy_alliance.description": "Nether’dan bir Ghast kurtarın, dünyaya güvenlice getirin... ve onu öldürün",
	...
	"advancements.story.follow_ender_eye.title": "Gözünü Dört Aç",
	...
	"advancements.story.lava_bucket.title": "Ateşle Oynama",
	...
	"advancements.story.root.description": "Oyunun kalbi ve hikâyesi",
	...
	"advancements.story.smelt_iron.title": "İşleyen Demir Işıldar",
	...
	"argument.block.tag.disallowed": "Etiketler burada kullanılamaz; sadece gerçek bloklar kullanılır",
	...
	"argument.double.big": "Ondalık sayı %s sayısından büyük olmamalı, şu anki %s",
	"argument.double.low": "Ondalık sayı %s sayısından küçük olmamalı, şu anki %s",
	...
	"argument.entity.options.limit.description": "Dönülecek en fazla varlık sayısı",
	...
	"argument.entity.options.predicate.description": "Özelleştirilmiş koşul",
	...
	"argument.entity.selector.nearestEntity": "En yakın varlık",
	...
	"argument.float.big": "Kayan noktalı sayı %s sayısından büyük olmamalı, şu anki %s",
	"argument.float.low": "Kayan noktalı sayı %s sayısından küçük olmamalı, şu anki %s",
	"argument.gamemode.invalid": "Bilinmeyen oyun modu: %s",
	"argument.hexcolor.invalid": "Geçersiz hex renk kodu '%s'",
	"argument.id.invalid": "Geçersiz Kimlik",
	"argument.id.unknown": "Bilinmeyen ID: %s",
	"argument.integer.big": "Tam sayı %s sayısından büyük olmamalı, şu anki %s",
	"argument.integer.low": "Tam sayı %s sayısından küçük olmamalı, şu anki %s",
	"argument.item.id.invalid": "Bilinmeyen eşya '%s'",
	"argument.item.tag.disallowed": "Etiketler burada kullanılamaz, sadece gerçek eşyalar kullanılır",
	"argument.literal.incorrect": "Hazır bilgi %s bekleniyor",
	"argument.long.big": "Uzun tam sayı %s sayısından büyük olmamalı, şu anki %s",
	"argument.long.low": "Uzun tam sayı %s sayısından küçük olmamalı, şu anki %s",
	"argument.message.too_long": "Sohbet mesajı çok uzun (%s > en fazla %s karakter)",
	"argument.nbt.array.invalid": "Geçersiz dizilim türü '%s'",
	"argument.nbt.array.mixed": "%[2]s içerisinde %[1]s barındıramaz",
	"argument.nbt.expected.compound": "Bileşik etiketi bekleniyor",
	...
	"argument.nbt.trailing": "Beklenmeyen takip eden veri",
	...
	"argument.range.ints": "Sadece tam sayılar kullanılabilir, ondalıklı sayılar değil",
	"argument.range.swapped": "En az değer en fazladan büyük olamaz",
	"argument.resource.invalid_type": "'%s' ögesi yanlış '%s' türüne sahip (beklenen '%s')",
	"argument.resource.not_found": "'%[2]s' türünde '%[1]s' ögesi bulunamadı",
	"argument.resource_or_id.failed_to_parse": "Yapı ayrıştırılamadı: %s",
	"argument.resource_or_id.invalid": "Geçersiz kimlik veya etiket",
	"argument.resource_or_id.no_such_element": "'%[2]s' kaydında '%[1]s' ögesi bulunamadı",
	"argument.resource_selector.not_found": "'%s' seçicisine '%s' türünde eşleşme bulunamadı",
	...
	"argument.style.invalid": "Geçersiz stil: %s",
	"argument.time.invalid_tick_count": "Birim zaman miktarı negatif olmamalı",
	"argument.time.invalid_unit": "Geçersiz birim",
	"argument.time.tick_count_too_low": "Birim zaman %s sayısından küçük olmamalı, şu anki %s",
	"argument.uuid.invalid": "Geçersiz UUID",
	"argument.waypoint.invalid": "Seçilen varlık bir yol noktası değil",
	"arguments.block.tag.unknown": "Bilinmeyen blok etiketi '%s'",
	"arguments.function.tag.unknown": "Bilinmeyen fonksiyon etiketi '%s'",
	"arguments.function.unknown": "Bilinmeyen fonksiyon %s",
	"arguments.item.component.expected": "Beklenen eşya bileşeni",
	"arguments.item.component.malformed": "Hatalı biçimlendirilmiş '%s' bileşeni: '%s'",
	"arguments.item.component.repeated": "Eşya bileşeni '%s' tekrarlandı ancak yalnızca bir değer belirtilebilir",
	"arguments.item.component.unknown": "Bilinmeyen eşya bileşeni '%s'",
	"arguments.item.malformed": "Hatalı biçimlendirilmiş eşya: '%s'",
	"arguments.item.overstacked": "En fazla %[2]s %[1]s yığınlanabilir",
	"arguments.item.predicate.malformed": "Hatalı biçimlendirilmiş '%s' koşulu: '%s'",
	"arguments.item.predicate.unknown": "Bilinmeyen eşya koşulu '%s'",
	...
	"arguments.swizzle.invalid": "Geçersiz vektör, ’x’, ’y’ ve ’z’nin kombinasyonu bekleniyordu",
	...
	"attribute.name.air_drag_modifier": "Hava Direnci Niteleyici",
	"attribute.name.armor": "Zırh",
	"attribute.name.armor_toughness": "Zırh Sertliği",
	"attribute.name.attack_damage": "Saldırı Hasarı",
	"attribute.name.attack_knockback": "Saldırı Savurması",
	"attribute.name.attack_speed": "Saldırı Hızı",
	"attribute.name.below_name_distance": "Ad Göstergesi Puan Mesafesi",
	"attribute.name.block_break_speed": "Blok Kırma Hızı",
	"attribute.name.block_interaction_range": "Blok Etkileşim Mesafesi",
	"attribute.name.bounciness": "Sekme",
	"attribute.name.burning_time": "Yanma Süresi",
	"attribute.name.camera_distance": "Kamera Mesafesi",
	"attribute.name.entity_interaction_range": "Varlık Etkileşim Mesafesi",
	"attribute.name.explosion_knockback_resistance": "Patlama Savrulması Direnci",
	"attribute.name.fall_damage_multiplier": "Düşme Hasarı Çarpanı",
	"attribute.name.flying_speed": "Uçuş Hızı",
	"attribute.name.follow_range": "Canlı Takip Mesafesi",
	"attribute.name.friction_modifier": "Sürtünme Düzenleyici",
	...
	"attribute.name.generic.block_interaction_range": "Blok Etkileşim Mesafesi",
	"attribute.name.generic.burning_time": "Yanma Süresi",
	"attribute.name.generic.entity_interaction_range": "Varlık Etkileşim Mesafesi",
	"attribute.name.generic.explosion_knockback_resistance": "Patlama Savrulması Direnci",
	"attribute.name.generic.fall_damage_multiplier": "Düşme Hasarı Çarpanı",
	"attribute.name.generic.flying_speed": "Uçma Hızı",
	"attribute.name.generic.follow_range": "Canlı Takip Menzili",
	"attribute.name.generic.gravity": "Yer Çekimi",
	"attribute.name.generic.jump_strength": "Zıplama Gücü",
	"attribute.name.generic.knockback_resistance": "Savrulma Direnci",
	"attribute.name.generic.luck": "Şans",
	"attribute.name.generic.max_absorption": "En Fazla Emilim",
	"attribute.name.generic.max_health": "En Fazla Sağlık",
	"attribute.name.generic.movement_efficiency": "Hareket Verimliliği",
	"attribute.name.generic.movement_speed": "Hız",
	"attribute.name.generic.oxygen_bonus": "Oksijen Takviyesi",
	"attribute.name.generic.safe_fall_distance": "Güvenli Düşüş Mesafesi",
	"attribute.name.generic.scale": "Ölçek",
	"attribute.name.generic.step_height": "Adım Yüksekliği",
	"attribute.name.generic.water_movement_efficiency": "Suda Hareket Verimliliği",
	"attribute.name.gravity": "Yer Çekimi",
	"attribute.name.horse.jump_strength": "At Zıplama Gücü",
	"attribute.name.jump_strength": "Zıplama Gücü",
	"attribute.name.knockback_resistance": "Savrulma Direnci",
	"attribute.name.luck": "Şans",
	"attribute.name.max_absorption": "En Fazla Emilim",
	"attribute.name.max_health": "En Fazla Sağlık",
	"attribute.name.mining_efficiency": "Kazım Verimliliği",
	"attribute.name.movement_efficiency": "Hareket Verimliliği",
	"attribute.name.movement_speed": "Hız",
	"attribute.name.nameplate_distance": "Ad Göstergesi Mesafesi",
	"attribute.name.oxygen_bonus": "Oksijen Takviyesi",
	"attribute.name.player.block_break_speed": "Blok Kırma Hızı",
	"attribute.name.player.block_interaction_range": "Blok Etkileşim Mesafesi",
	"attribute.name.player.entity_interaction_range": "Varlık Etkileşim Mesafesi",
	"attribute.name.player.mining_efficiency": "Kazım Verimliliği",
	"attribute.name.player.sneaking_speed": "Eğilme Hızı",
	"attribute.name.player.submerged_mining_speed": "Su Altında Kazım Hızı",
	"attribute.name.player.sweeping_damage_ratio": "Geniş Saldırı Hasar Oranı",
	"attribute.name.safe_fall_distance": "Güvenli Düşüş Mesafesi",
	"attribute.name.scale": "Ölçek",
	"attribute.name.sneaking_speed": "Eğilirken Hareket Hızı",
	"attribute.name.spawn_reinforcements": "Zombi Takviyesi",
	"attribute.name.step_height": "Adım Yüksekliği",
	"attribute.name.submerged_mining_speed": "Su Altında Kazım Hızı",
	"attribute.name.sweeping_damage_ratio": "Geniş Saldırı Hasar Oranı",
	"attribute.name.tempt_range": "Canlı Fark Etme Mesafesi",
	"attribute.name.water_movement_efficiency": "Suda Hareket Verimliliği",
	"attribute.name.waypoint_receive_range": "Yol Noktası Alma Mesafesi",
	"attribute.name.waypoint_transmit_range": "Yol Noktası İletme Mesafesi",
	...
	"biome.minecraft.pale_garden": "Solgun Bahçe",
	...
	"biome.minecraft.sulfur_caves": "Sülfür Mağaraları",
	...
	"block.minecraft.acacia_shelf": "Akasya Raf",
	...
	"block.minecraft.bamboo_shelf": "Bambu Raf",
	...
	"block.minecraft.banner.flow.black": "Siyah Akış",
	"block.minecraft.banner.flow.blue": "Mavi Akış",
	"block.minecraft.banner.flow.brown": "Kahverengi Akış",
	"block.minecraft.banner.flow.cyan": "Camgöbeği Akış",
	"block.minecraft.banner.flow.gray": "Gri Akış",
	"block.minecraft.banner.flow.green": "Yeşil Akış",
	"block.minecraft.banner.flow.light_blue": "Açık Mavi Akış",
	"block.minecraft.banner.flow.light_gray": "Açık Gri Akış",
	"block.minecraft.banner.flow.lime": "Açık Yeşil Akış",
	"block.minecraft.banner.flow.magenta": "Eflatun Akış",
	"block.minecraft.banner.flow.orange": "Turuncu Akış",
	"block.minecraft.banner.flow.pink": "Pembe Akış",
	"block.minecraft.banner.flow.purple": "Mor Akış",
	"block.minecraft.banner.flow.red": "Kırmızı Akış",
	"block.minecraft.banner.flow.white": "Beyaz Akış",
	"block.minecraft.banner.flow.yellow": "Sarı Akış",
	...
	"block.minecraft.banner.guster.black": "Siyah Fırtına",
	"block.minecraft.banner.guster.blue": "Mavi Fırtına",
	"block.minecraft.banner.guster.brown": "Kahverengi Fırtına",
	"block.minecraft.banner.guster.cyan": "Camgöbeği Fırtına",
	"block.minecraft.banner.guster.gray": "Gri Fırtına",
	"block.minecraft.banner.guster.green": "Yeşil Fırtına",
	"block.minecraft.banner.guster.light_blue": "Açık Mavi Fırtına",
	"block.minecraft.banner.guster.light_gray": "Açık Gri Fırtına",
	"block.minecraft.banner.guster.lime": "Açık Yeşil Fırtına",
	"block.minecraft.banner.guster.magenta": "Eflatun Fırtına",
	"block.minecraft.banner.guster.orange": "Turuncu Fırtına",
	"block.minecraft.banner.guster.pink": "Pembe Fırtına",
	"block.minecraft.banner.guster.purple": "Mor Fırtına",
	"block.minecraft.banner.guster.red": "Kırmızı Fırtına",
	"block.minecraft.banner.guster.white": "Beyaz Fırtına",
	"block.minecraft.banner.guster.yellow": "Sarı Fırtına",
	...
	"block.minecraft.birch_shelf": "Huş Raf",
	...
	"block.minecraft.blackstone": "Karataş",
	"block.minecraft.blackstone_slab": "Karataş Basamak",
	"block.minecraft.blackstone_stairs": "Karataş Merdiven",
	"block.minecraft.blackstone_wall": "Karataş Duvar",
	...
	"block.minecraft.brewing_stand": "İksir Tezgâhı",
	...
	"block.minecraft.bush": "Çalı",
	"block.minecraft.cactus": "Kaktüs",
	"block.minecraft.cactus_flower": "Kaktüs Çiçeği",
	"block.minecraft.cake": "Pasta",
	"block.minecraft.calcite": "Kireç Taşı",
	"block.minecraft.calibrated_sculk_sensor": "Ayarlanmış Sculk Sensörü",
	...
	"block.minecraft.cherry_shelf": "Kiraz Ağacı Raf",
	...
	"block.minecraft.chiseled_cinnabar": "Yontulmuş Zincifre",
	"block.minecraft.chiseled_copper": "Yontulmuş Bakır",
	"block.minecraft.chiseled_deepslate": "Yontulmuş Kayrak Taşı",
	"block.minecraft.chiseled_nether_bricks": "Yontulmuş Nether Tuğlası",
	"block.minecraft.chiseled_polished_blackstone": "Yontulmuş Cilalı Karataş",
	...
	"block.minecraft.chiseled_resin_bricks": "Yontulmuş Reçine Tuğla",
	"block.minecraft.chiseled_sandstone": "Yontulmuş Kum Taşı",
	"block.minecraft.chiseled_stone_bricks": "Yontulmuş Taş Tuğla",
	"block.minecraft.chiseled_sulfur": "Yontulmuş Sülfür",
	"block.minecraft.chiseled_tuff": "Yontulmuş Tüf",
	"block.minecraft.chiseled_tuff_bricks": "Yontulmuş Tüf Tuğla",
	"block.minecraft.chorus_flower": "Nakarat Çiçeği",
	"block.minecraft.chorus_plant": "Nakarat Bitkisi",
	"block.minecraft.cinnabar": "Zincifre",
	"block.minecraft.cinnabar_brick_slab": "Zincifre Tuğla Basamak",
	"block.minecraft.cinnabar_brick_stairs": "Zincifre Tuğla Merdiven",
	"block.minecraft.cinnabar_brick_wall": "Zincifre Tuğla Duvar",
	"block.minecraft.cinnabar_bricks": "Zincifre Tuğla",
	"block.minecraft.cinnabar_slab": "Zincifre Basamak",
	"block.minecraft.cinnabar_stairs": "Zincifre Merdiven",
	"block.minecraft.cinnabar_wall": "Zincifre Duvar",
	"block.minecraft.clay": "Kil",
	"block.minecraft.closed_eyeblossom": "Kapalı Göz Çiçeği",
	...
	"block.minecraft.copper_bars": "Bakır Parmaklık",
	"block.minecraft.copper_block": "Bakır Bloğu",
	"block.minecraft.copper_bulb": "Bakır Ampul",
	"block.minecraft.copper_chain": "Bakır Zincir",
	"block.minecraft.copper_chest": "Bakır Sandık",
	"block.minecraft.copper_door": "Bakır Kapı",
	"block.minecraft.copper_golem_statue": "Bakır Golem Heykeli",
	"block.minecraft.copper_grate": "Bakır Izgara",
	"block.minecraft.copper_lantern": "Bakır Fener",
	"block.minecraft.copper_ore": "Bakır Cevheri",
	"block.minecraft.copper_torch": "Bakır Meşale",
	"block.minecraft.copper_trapdoor": "Bakır Tuzak Kapısı",
	"block.minecraft.copper_wall_torch": "Duvarda Bakır Meşale",
	...
	"block.minecraft.cracked_polished_blackstone_bricks": "Çatlak Cilalı Karataş Tuğlası",
	"block.minecraft.cracked_stone_bricks": "Çatlak Taş Tuğlası",
	"block.minecraft.crafter": "Üretici",
	"block.minecraft.crafting_table": "Çalışma Masası",
	"block.minecraft.creaking_heart": "Gıcırtı Kalbi",
	...
	"block.minecraft.crimson_nylium": "Kızıl Niselyum",
	...
	"block.minecraft.crimson_shelf": "Kızıl Raf",
	...
	"block.minecraft.dark_oak_shelf": "Koyu Meşe Raf",
	...
	"block.minecraft.dried_ghast": "Kurumuş Ghast",
	...
	"block.minecraft.exposed_chiseled_copper": "Açıkta Kalmış Yontulmuş Bakır",
	"block.minecraft.exposed_copper": "Açıkta Kalmış Bakır",
	"block.minecraft.exposed_copper_bars": "Açıkta Kalmış Bakır Parmaklık",
	"block.minecraft.exposed_copper_bulb": "Açıkta Kalmış Bakır Ampul",
	"block.minecraft.exposed_copper_chain": "Açıkta Kalmış Bakır Zincir",
	"block.minecraft.exposed_copper_chest": "Açıkta Kalmış Bakır Sandık",
	"block.minecraft.exposed_copper_door": "Açıkta Kalmış Bakır Kapı",
	"block.minecraft.exposed_copper_golem_statue": "Açıkta Kalmış Bakır Golem Heykeli",
	"block.minecraft.exposed_copper_grate": "Açıkta Kalmış Bakır Izgara",
	"block.minecraft.exposed_copper_lantern": "Açıkta Kalmış Bakır Fener",
	"block.minecraft.exposed_copper_trapdoor": "Açıkta Kalmış Bakır Tuzak Kapısı",
	...
	"block.minecraft.exposed_lightning_rod": "Açıkta Kalmış Paratoner",
	"block.minecraft.farmland": "Tarım Arazisi",
	"block.minecraft.fern": "Eğrelti otu",
	...
	"block.minecraft.firefly_bush": "Ateş Böceği Çalısı",
	...
	"block.minecraft.gilded_blackstone": "Yaldızlı Karataş",
	...
	"block.minecraft.golden_dandelion": "Altın Karahindiba",
	...
	"block.minecraft.heavy_core": "Ağır Çekirdek",
	...
	"block.minecraft.infested_chiseled_stone_bricks": "İstila Edilmiş Yontulmuş Taş Tuğla",
	"block.minecraft.infested_cobblestone": "İstila Edilmiş Kırık Taş",
	"block.minecraft.infested_cracked_stone_bricks": "İstila Edilmiş Çatlak Taş Tuğla",
	"block.minecraft.infested_deepslate": "İstila Edilmiş Kayrak Taşı",
	"block.minecraft.infested_mossy_stone_bricks": "İstila Edilmiş Yosunlu Taş Tuğla",
	"block.minecraft.infested_stone": "İstila Edilmiş Taş",
	"block.minecraft.infested_stone_bricks": "İstila Edilmiş Taş Tuğla",
	"block.minecraft.iron_bars": "Demir Parmaklık",
	"block.minecraft.iron_block": "Demir Bloğu",
	"block.minecraft.iron_chain": "Demir Zincir",
	...
	"block.minecraft.jungle_shelf": "Orman Ağacı Raf",
	...
	"block.minecraft.large_fern": "Büyük Eğrelti Otu",
	"block.minecraft.lava": "Lav",
	"block.minecraft.lava_cauldron": "Lav Kazanı",
	"block.minecraft.leaf_litter": "Kuru Yapraklar",
	...
	"block.minecraft.loom": "Dokuma Tezgâhı",
	...
	"block.minecraft.mangrove_shelf": "Mangrov Raf",
	...
	"block.minecraft.oak_shelf": "Meşe Raf",
	...
	"block.minecraft.open_eyeblossom": "Açık Göz Çiçeği",
	...
	"block.minecraft.oxidized_chiseled_copper": "Oksitlenmiş Yontulmuş Bakır",
	"block.minecraft.oxidized_copper": "Oksitlenmiş Bakır",
	"block.minecraft.oxidized_copper_bars": "Oksitlenmiş Bakır Parmaklık",
	"block.minecraft.oxidized_copper_bulb": "Oksitlenmiş Bakır Ampul",
	"block.minecraft.oxidized_copper_chain": "Oksitlenmiş Bakır Zincir",
	"block.minecraft.oxidized_copper_chest": "Oksitlenmiş Bakır Sandık",
	"block.minecraft.oxidized_copper_door": "Oksitlenmiş Bakır Kapı",
	"block.minecraft.oxidized_copper_golem_statue": "Oksitlenmiş Bakır Golem Heykeli",
	"block.minecraft.oxidized_copper_grate": "Oksitlenmiş Bakır Izgara",
	"block.minecraft.oxidized_copper_lantern": "Oksitlenmiş Bakır Fener",
	"block.minecraft.oxidized_copper_trapdoor": "Oksitlenmiş Bakır Tuzak Kapısı",
	...
	"block.minecraft.oxidized_lightning_rod": "Oksitlenmiş Paratoner",
	"block.minecraft.packed_ice": "Sert Buz",
	"block.minecraft.packed_mud": "Kerpiç",
	"block.minecraft.pale_hanging_moss": "Soluk Sarkan Yosun",
	"block.minecraft.pale_moss_block": "Soluk Yosun Bloğu",
	"block.minecraft.pale_moss_carpet": "Soluk Yosun Halı",
	"block.minecraft.pale_oak_button": "Soluk Meşe Düğme",
	"block.minecraft.pale_oak_door": "Soluk Meşe Kapı",
	"block.minecraft.pale_oak_fence": "Soluk Meşe Çit",
	"block.minecraft.pale_oak_fence_gate": "Soluk Meşe Çit Kapısı",
	"block.minecraft.pale_oak_hanging_sign": "Asılı Soluk Meşe Tabela",
	"block.minecraft.pale_oak_leaves": "Soluk Meşe Yaprakları",
	"block.minecraft.pale_oak_log": "Soluk Meşe Kütüğü",
	"block.minecraft.pale_oak_planks": "Soluk Meşe Tahtası",
	"block.minecraft.pale_oak_pressure_plate": "Soluk Meşe Basınç Plakası",
	"block.minecraft.pale_oak_sapling": "Soluk Meşe Fidanı",
	"block.minecraft.pale_oak_shelf": "Soluk Meşe Raf",
	"block.minecraft.pale_oak_sign": "Soluk Meşe Tabela",
	"block.minecraft.pale_oak_slab": "Soluk Meşe Basamak",
	"block.minecraft.pale_oak_stairs": "Soluk Meşe Merdiven",
	"block.minecraft.pale_oak_trapdoor": "Soluk Meşe Tuzak Kapısı",
	"block.minecraft.pale_oak_wall_hanging_sign": "Asılı Soluk Meşe Duvar Tabelası",
	"block.minecraft.pale_oak_wall_sign": "Soluk Meşe Duvar Tabelası",
	"block.minecraft.pale_oak_wood": "Soluk Meşe Odunu",
	...
	"block.minecraft.pitcher_crop": "Sürahi Ekini",
	"block.minecraft.pitcher_plant": "Sürahi Bitkisi",
	...
	"block.minecraft.polished_blackstone": "Cilalı Karataş",
	"block.minecraft.polished_blackstone_brick_slab": "Cilalı Karataş Tuğlası Basamak",
	"block.minecraft.polished_blackstone_brick_stairs": "Cilalı Karataş Tuğlası Merdiven",
	"block.minecraft.polished_blackstone_brick_wall": "Cilalı Karataş Tuğlası Duvar",
	"block.minecraft.polished_blackstone_bricks": "Cilalı Karataş Tuğlası",
	"block.minecraft.polished_blackstone_button": "Cilalı Karataş Düğme",
	"block.minecraft.polished_blackstone_pressure_plate": "Cilalı Karataş Basınç Plakası",
	"block.minecraft.polished_blackstone_slab": "Cilalı Karataş Basamak",
	"block.minecraft.polished_blackstone_stairs": "Cilalı Karataş Merdiven",
	"block.minecraft.polished_blackstone_wall": "Cilalı Karataş Duvar",
	"block.minecraft.polished_cinnabar": "Cilalı Zincifre",
	"block.minecraft.polished_cinnabar_slab": "Cilalı Zincifre Basamak",
	"block.minecraft.polished_cinnabar_stairs": "Cilalı Zincifre Merdiven",
	"block.minecraft.polished_cinnabar_wall": "Cilalı Zincifre Duvar",
	...
	"block.minecraft.polished_sulfur": "Cilalı Sülfür",
	"block.minecraft.polished_sulfur_slab": "Cilalı Sülfür Basamağı",
	"block.minecraft.polished_sulfur_stairs": "Cilalı Sülfür Merdiven",
	"block.minecraft.polished_sulfur_wall": "Cilalı Sülfür Duvar",
	"block.minecraft.polished_tuff": "Cilalı Tüf",
	"block.minecraft.polished_tuff_slab": "Cilalı Tüf Basamak",
	"block.minecraft.polished_tuff_stairs": "Cilalı Tüf Merdiven",
	"block.minecraft.polished_tuff_wall": "Cilalı Tüf Duvar",
	"block.minecraft.poppy": "Gelincik",
	"block.minecraft.potatoes": "Patatesler",
	"block.minecraft.potent_sulfur": "Reaktif Sülfür",
	...
	"block.minecraft.potted_closed_eyeblossom": "Kapalı Göz Çiçeği Saksısı",
	...
	"block.minecraft.potted_fern": "Eğrelti Otu Saksısı",
	"block.minecraft.potted_flowering_azalea_bush": "Çiçekli Açelya Saksısı",
	"block.minecraft.potted_golden_dandelion": "Altın Karahindiba Saksısı",
	...
	"block.minecraft.potted_open_eyeblossom": "Açık Göz Çiçeği Saksısı",
	"block.minecraft.potted_orange_tulip": "Turuncu Lale Saksısı",
	"block.minecraft.potted_oxeye_daisy": "Papatya Saksısı",
	"block.minecraft.potted_pale_oak_sapling": "Soluk Meşe Fidanı Saksısı",
	...
	"block.minecraft.resin_block": "Reçine Bloğu",
	"block.minecraft.resin_brick_slab": "Reçine Tuğla Basamak",
	"block.minecraft.resin_brick_stairs": "Reçine Tuğla Merdiven",
	"block.minecraft.resin_brick_wall": "Reçine Tuğla Duvarı",
	"block.minecraft.resin_bricks": "Reçine Tuğla",
	"block.minecraft.resin_clump": "Reçine Yığını",
	"block.minecraft.respawn_anchor": "Diriltici",
	...
	"block.minecraft.short_dry_grass": "Kısa Kuru Çimen",
	"block.minecraft.short_grass": "Kısa Çimen",
	...
	"block.minecraft.smooth_sandstone": "Düz Kum Taşı",
	...
	"block.minecraft.sniffer_egg": "Koklarca Yumurtası",
	...
	"block.minecraft.spawn.not_valid": "Yatağınız veya yüklenmiş bir dirilticiniz yok veya sıkışmış",
	...
	"block.minecraft.spruce_shelf": "Ladin Raf",
	...
	"block.minecraft.stripped_pale_oak_log": "Soyulmuş Soluk Meşe Kütüğü",
	"block.minecraft.stripped_pale_oak_wood": "Soyulmuş Soluk Meşe Odunu",
	...
	"block.minecraft.sulfur": "Sülfür",
	"block.minecraft.sulfur_brick_slab": "Sülfür Tuğla Basamak",
	"block.minecraft.sulfur_brick_stairs": "Sülfür Tuğla Merdiven",
	"block.minecraft.sulfur_brick_wall": "Sülfür Tuğla Duvar",
	"block.minecraft.sulfur_bricks": "Sülfür Tuğla",
	"block.minecraft.sulfur_slab": "Sülfür Basamak",
	"block.minecraft.sulfur_spike": "Sülfür Dikit",
	"block.minecraft.sulfur_stairs": "Sülfür Merdiven",
	"block.minecraft.sulfur_wall": "Sülfür Duvar",
	"block.minecraft.sunflower": "Ayçiçeği",
	"block.minecraft.suspicious_gravel": "Şüpheli Çakıl",
	"block.minecraft.suspicious_sand": "Şüpheli Kum",
	"block.minecraft.sweet_berry_bush": "Tatlı Orman Meyvesi Çalısı",
	"block.minecraft.tall_dry_grass": "Uzun Kuru Çimen",
	...
	"block.minecraft.test_block": "Test Bloğu",
	"block.minecraft.test_instance_block": "Test Birim Bloğu",
	"block.minecraft.tinted_glass": "Gölgeli Cam",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "TNT patlamaları devre dışı",
	...
	"block.minecraft.trial_spawner": "Sınama Çağırıcısı",
	...
	"block.minecraft.tuff_brick_slab": "Tüf Tuğla Basamak",
	"block.minecraft.tuff_brick_stairs": "Tüf Tuğla Merdiven",
	"block.minecraft.tuff_brick_wall": "Tüf Tuğla Duvarı",
	"block.minecraft.tuff_bricks": "Tüf Tuğla",
	"block.minecraft.tuff_slab": "Tüf Basamak",
	"block.minecraft.tuff_stairs": "Tüf Merdiven",
	"block.minecraft.tuff_wall": "Tüf Duvar",
	...
	"block.minecraft.warped_shelf": "Çarpık Raf",
	...
	"block.minecraft.waxed_chiseled_copper": "Cilalı Yontulmuş Bakır",
	"block.minecraft.waxed_copper_bars": "Cilalı Bakır Parmaklık",
	"block.minecraft.waxed_copper_block": "Cilalı Bakır Bloğu",
	"block.minecraft.waxed_copper_bulb": "Cilalı Bakır Ampul",
	"block.minecraft.waxed_copper_chain": "Cilalı Bakır Zincir",
	"block.minecraft.waxed_copper_chest": "Cilalı Bakır Sandık",
	"block.minecraft.waxed_copper_door": "Cilalı Bakır Kapı",
	"block.minecraft.waxed_copper_golem_statue": "Cilalı Bakır Golem Heykeli",
	"block.minecraft.waxed_copper_grate": "Cilalı Bakır Izgara",
	"block.minecraft.waxed_copper_lantern": "Cilalı Bakır Fener",
	"block.minecraft.waxed_copper_trapdoor": "Cilalı Bakır Tuzak Kapısı",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Cilalı Açıkta Kalmış Yontulmuş Bakır",
	"block.minecraft.waxed_exposed_copper": "Cilalı Açıkta Kalmış Bakır",
	"block.minecraft.waxed_exposed_copper_bars": "Cilalı Açıkta Kalmış Bakır Parmaklık",
	"block.minecraft.waxed_exposed_copper_bulb": "Cilalı Açıkta Kalmış Bakır Ampul",
	"block.minecraft.waxed_exposed_copper_chain": "Cilalı Açıkta Kalmış Bakır Zincir",
	"block.minecraft.waxed_exposed_copper_chest": "Cilalı Açıkta Kalmış Bakır Sandık",
	"block.minecraft.waxed_exposed_copper_door": "Cilalı Açıkta Kalmış Bakır Kapı",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Cilalı Açıkta Kalmış Bakır Golem Heykeli",
	"block.minecraft.waxed_exposed_copper_grate": "Cilalı Açıkta Kalmış Bakır Izgara",
	"block.minecraft.waxed_exposed_copper_lantern": "Cilalı Açıkta Kalmış Bakır Fener",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Cilalı Açıkta Kalmış Bakır Tuzak Kapısı",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Cilalı Açıkta Kalmış Paratoner",
	"block.minecraft.waxed_lightning_rod": "Cilalı Paratoner",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Cilalı Oksitlenmiş Yontulmuş Bakır",
	"block.minecraft.waxed_oxidized_copper": "Cilalı Oksitlenmiş Bakır",
	"block.minecraft.waxed_oxidized_copper_bars": "Cilalı Oksitlenmiş Bakır Parmaklık",
	"block.minecraft.waxed_oxidized_copper_bulb": "Cilalı Oksitlenmiş Bakır Ampul",
	"block.minecraft.waxed_oxidized_copper_chain": "Cilalı Oksitlenmiş Bakır Zincir",
	"block.minecraft.waxed_oxidized_copper_chest": "Cilalı Oksitlenmiş Bakır Sandık",
	"block.minecraft.waxed_oxidized_copper_door": "Cilalı Oksitlenmiş Bakır Kapı",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Cilalı Oksitlenmiş Bakır Golem Heykeli",
	"block.minecraft.waxed_oxidized_copper_grate": "Cilalı Oksitlenmiş Bakır Izgara",
	"block.minecraft.waxed_oxidized_copper_lantern": "Cilalı Oksitlenmiş Bakır Fener",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Cilalı Oksitlenmiş Bakır Tuzak Kapısı",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Cilalı Oksitlenmiş Paratoner",
	"block.minecraft.waxed_weathered_chiseled_copper": "Cilalı Yıpranmış Yontulmuş Bakır",
	"block.minecraft.waxed_weathered_copper": "Cilalı Yıpranmış Bakır",
	"block.minecraft.waxed_weathered_copper_bars": "Cilalı Yıpranmış Bakır Parmaklık",
	"block.minecraft.waxed_weathered_copper_bulb": "Cilalı Yıpranmış Bakır Ampul",
	"block.minecraft.waxed_weathered_copper_chain": "Cilalı Yıpranmış Bakır Zincir",
	"block.minecraft.waxed_weathered_copper_chest": "Cilalı Yıpranmış Bakır Sandık",
	"block.minecraft.waxed_weathered_copper_door": "Cilalı Yıpranmış Bakır Kapı",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Cilalı Yıpranmış Bakır Golem Heykeli",
	"block.minecraft.waxed_weathered_copper_grate": "Cilalı Yıpranmış Bakır Izgara",
	"block.minecraft.waxed_weathered_copper_lantern": "Cilalı Yıpranmış Bakır Fener",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Cilalı Yıpranmış Bakır Tuzak Kapısı",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Cilalı Yıpranmış Paratoner",
	"block.minecraft.weathered_chiseled_copper": "Yıpranmış Yontulmuş Bakır",
	"block.minecraft.weathered_copper": "Yıpranmış Bakır",
	"block.minecraft.weathered_copper_bars": "Yıpranmış Bakır Parmaklık",
	"block.minecraft.weathered_copper_bulb": "Yıpranmış Bakır Ampul",
	"block.minecraft.weathered_copper_chain": "Yıpranmış Bakır Zincir",
	"block.minecraft.weathered_copper_chest": "Yıpranmış Bakır Sandık",
	"block.minecraft.weathered_copper_door": "Yıpranmış Bakır Kapı",
	"block.minecraft.weathered_copper_golem_statue": "Yıpranmış Bakır Golem Heykeli",
	"block.minecraft.weathered_copper_grate": "Yıpranmış Bakır Izgara",
	"block.minecraft.weathered_copper_lantern": "Yıpranmış Bakır Fener",
	"block.minecraft.weathered_copper_trapdoor": "Yıpranmış Bakır Tuzak Kapısı",
	...
	"block.minecraft.weathered_lightning_rod": "Yıpranmış Paratoner",
	...
	"block.minecraft.wildflowers": "Kır Çiçekleri",
	...
	"book.edit.title": "Kitap Düzenleme Ekranı",
	...
	"book.page_button.next": "Sonraki Sayfa",
	"book.page_button.previous": "Önceki Sayfa",
	"book.sign.title": "Kitap İmzalama Ekranı",
	"book.sign.titlebox": "Başlık",
	"book.signButton": "İmzala",
	"book.view.title": "Kitap Görüntüleme Ekranı",
	"build.spawn_protection": "%s doğum noktası koruması altında",
	"build.tooHigh": "İnşa için yükseklik sınırı %s bloktur",
	"build.tooLow": "İnşa için alçaklık sınırı %s bloktur",
	...
	"chat.disabled.invalid_command_signature": "Komut, beklenmeyen veya eksik değişken imzasına sahip.",
	"chat.disabled.invalid_signature": "Sohbet geçersiz bir imzaya sahip. Yeniden bağlanmayı deneyin.",
	"chat.disabled.launcher": "Sohbet, başlatıcı ayarlarından devre dışı bırakılmış. Mesaj gönderilemiyor.",
	...
	"chat.disabled.options": "Sohbet, istemci ayarlarında kapalı.",
	"chat.disabled.out_of_order_chat": "Sıra dışı sohbet alındı. Sistem zamanınız mı değişti?",
	"chat.disabled.profile": "Hesap ayarlarından dolayı sohbet kullanılamıyor. Daha fazla bilgi için '%s' tuşuna tekrar basın.",
	...
	"chat.queue.tooltip": "Sonraki mesajı göstermek için tıklayın",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "Sunucu geçersiz ileti gönderdi.",
	...
	"chat.validation_error": "Sohbet doğrulama hatası",
	"chat_restriction.chat_and_commands_disabled_by_options": "Sohbet istemci ayarlarında kısıtlanmıştır.",
	"chat_restriction.chat_disabled_by_options": "Oyuncu sohbeti istemci ayarlarında kısıtlanmıştır.",
	"chat_restriction.chat_disabled_by_options.action": "Sohbet Ayarları ekranına git",
	"chat_restriction.disabled_by_launcher": "Sohbet başlatıcı tarafından kısıtlanmıştır",
	"chat_restriction.disabled_by_profile": "Sohbet profil ayarları tarafından kısıtlanmıştır.",
	"chat_restriction.disabled_by_profile.action": "Profil ayarlarına git",
	"chat_screen.commands_not_allowed": "Komut gönderme izni yok",
	"chat_screen.message": "Gönderilecek ileti: %s",
	"chat_screen.messages_not_allowed": "Sohbet mesajı gönderme izni yok",
	"chat_screen.restricted": "Kısıtlanmış sohbet. Detaylar için mesaja tıklayın.",
	"chat_screen.restricted.narration": "Kısıtlanmış sohbet. Dünya ayarlarında ''Kısıtlamalar'' sayfasına git.",
	"chat_screen.title": "Sohbet ekranı",
	"chat_screen.usage": "İleti girin ve göndermek için Enter tuşuna basın",
	"chunk.toast.checkLog": "Daha fazla ayrıntı için günlüğe bakın",
	"chunk.toast.loadFailure": "%s konumundaki yığın yüklenemedi",
	"chunk.toast.lowDiskSpace": "Düşük disk alanı!",
	"chunk.toast.lowDiskSpace.description": "Dünyayı kaydetmek mümkün olmayabilir.",
	"chunk.toast.saveFailure": "%s konumundaki yığın kaydedilemedi",
	"clear.failed.multiple": "%s oyuncuda hiçbir eşya bulunamadı",
	"clear.failed.single": "%s oyuncusunda hiçbir eşya bulunamadı",
	...
	"command.forkLimit": "Maksimum bağlam sayısına (%s) ulaşıldı",
	"command.trailing_data": "Takip eden veri bulundu: %s",
	...
	"commands.advancement.grant.criterion.to.one.success": "%[3]s oyuncusuna %[2]s gelişiminin '%[1]s' kriteri verildi",
	...
	"commands.advancement.revoke.criterion.to.one.success": "%[3]s oyuncusundan %[2]s gelişiminin '%[1]s' kriteri alındı",
	"commands.advancement.revoke.many.to.many.failure": "%s gelişim %s oyuncudan zaten sahip olmadıkları için alınamadı",
	"commands.advancement.revoke.many.to.many.success": "%[2]s oyuncudan %[1]s gelişim geri alındı",
	"commands.advancement.revoke.many.to.one.failure": "%s gelişim %s oyuncusu zaten sahip olmadığı için alınamadı",
	"commands.advancement.revoke.many.to.one.success": "%[2]s oyuncusundan %[1]s adet gelişim geri alındı",
	"commands.advancement.revoke.one.to.many.failure": "%s gelişimi %s oyuncudan zaten sahip olmadıkları için alınamadı",
	"commands.advancement.revoke.one.to.many.success": "%[2]s oyuncudan '%[1]s' gelişimi geri alındı",
	"commands.advancement.revoke.one.to.one.failure": "%s gelişimi %s oyuncusu zaten sahip olmadığı için alınamadı",
	"commands.advancement.revoke.one.to.one.success": "%[2]s oyuncusundan '%[1]s' gelişimi geri alındı",
	"commands.attribute.base_value.get.success": "%[2]s varlığının %[1]s niteliğinin temel değeri %[3]s",
	"commands.attribute.base_value.reset.success": "%[2]s varlığının %[1]s niteliğinin temel değeri varsayılan %[3]s değerine sıfırlandı",
	"commands.attribute.base_value.set.success": "%[2]s varlığının %[1]s niteliğinin temel değeri %[3]s olarak ayarlandı",
	...
	"commands.attribute.modifier.value.get.success": "%[3]s varlığının %[2]s niteliğindeki %[1]s niteleyicisinin değeri %[4]s",
	"commands.attribute.value.get.success": "%[2]s varlığının %[1]s niteliğinin değeri %[3]s",
	...
	"commands.banlist.entry.unknown": "(Bilinmeyen)",
	"commands.banlist.list": "%s yasaklı oyuncu var:",
	"commands.banlist.none": "Hiçbir yasaklama yok",
	"commands.bossbar.create.failed": "Kimliği '%s' olan bir boss çubuğu zaten mevcut",
	"commands.bossbar.create.success": "Özel boss çubuğu %s oluşturuldu",
	"commands.bossbar.get.max": "Özel boss çubuğu %s, %s sınır değerine sahip",
	"commands.bossbar.get.players.none": "Özel boss çubuğu %s, şu anda hiçbir çevrim içi oyuncuya gösterilmiyor",
	"commands.bossbar.get.players.some": "Özel boss çubuğu %s, çevrim içi %s oyuncuya gösteriliyor: %s",
	"commands.bossbar.get.value": "Özel boss çubuğu %s, %s değerine sahip",
	"commands.bossbar.get.visible.hidden": "Özel boss çubuğu %s, şu anda gizli",
	"commands.bossbar.get.visible.visible": "Özel boss çubuğu %s, şu anda görünür",
	"commands.bossbar.list.bars.none": "Aktif özel boss çubuğu yok",
	"commands.bossbar.list.bars.some": "Aktif %s boss çubuğu var: %s",
	"commands.bossbar.remove.success": "Özel boss çubuğu %s kaldırıldı",
	"commands.bossbar.set.color.success": "Özel boss çubuğu %s, renk değiştirdi",
	"commands.bossbar.set.color.unchanged": "Bir şey değişmedi, boss çubuğunun rengi zaten bu",
	"commands.bossbar.set.max.success": "Özel boss çubuğu %s, artık %s sınır değerine sahip",
	"commands.bossbar.set.max.unchanged": "Bir şey değişmedi, boss çubuğunun sınır değeri zaten bu",
	"commands.bossbar.set.name.success": "Özel boss çubuğu %s, yeniden adlandırıldı",
	"commands.bossbar.set.name.unchanged": "Bir şey değişmedi, boss çubuğunun adı zaten bu",
	"commands.bossbar.set.players.success.none": "Özel boss çubuğu %s, artık hiçbir oyuncuya gösterilmiyor",
	"commands.bossbar.set.players.success.some": "Özel boss çubuğu %s, artık %s oyuncuya gösteriliyor: %s",
	"commands.bossbar.set.players.unchanged": "Bir şey değişmedi. Boss çubuğu zaten o oyunculara gösteriliyor, eklenecek veya kaldırılacak kimse yok",
	"commands.bossbar.set.style.success": "Özel boss çubuğu %s, stil değiştirdi",
	"commands.bossbar.set.style.unchanged": "Bir şey değişmedi, boss çubuğunun stili zaten bu",
	"commands.bossbar.set.value.success": "Özel boss çubuğu %s, değeri %s olarak değiştirildi",
	"commands.bossbar.set.value.unchanged": "Bir şey değişmedi, boss çubuğunun değeri zaten bu",
	"commands.bossbar.set.visibility.unchanged.hidden": "Bir şey değişmedi, boss çubuğu zaten gizli",
	"commands.bossbar.set.visibility.unchanged.visible": "Bir şey değişmedi, boss çubuğu zaten görünür",
	"commands.bossbar.set.visible.success.hidden": "Özel boss çubuğu %s, artık gizli",
	"commands.bossbar.set.visible.success.visible": "Özel boss çubuğu %s, artık görünür",
	"commands.bossbar.unknown": "Kimliği '%s' olan bir boss çubuğu mevcut değil",
	"commands.clear.success.multiple": "%[2]s oyuncudan %[1]s adet eşya silindi",
	"commands.clear.success.single": "%[2]s oyuncusundan %[1]s adet eşya silindi",
	"commands.clear.test.multiple": "%[2]s oyuncuda %[1]s eşleşen eşya bulundu",
	"commands.clear.test.single": "%[2]s oyuncusunda %[1]s adet eşleşen eşya bulundu",
	...
	"commands.clone.toobig": "Belirtilen alanda çok fazla blok var (en fazla %s, belirtilen %s)",
	...
	"commands.data.block.get": "%[2]s, %[3]s, %[4]s bloğundaki %[1]s değeri, %[5]s ölçeği uygulandıktan sonra %[6]s olur",
	...
	"commands.data.entity.get": "%[2]s üzerindeki %[1]s değeri, %[3]s ölçeği uygulandıktan sonra %[4]s olur",
	...
	"commands.data.get.multiple": "Bu değişken sadece tek bir NBT değeri kabul ediyor",
	"commands.data.get.unknown": "%s alınamıyor, etiket mevcut değil",
	"commands.data.merge.failed": "Hiçbir şey değişmedi. Belirtilen özellikler zaten bu değerlere sahip",
	...
	"commands.data.modify.expected_value": "Değer bekleniyor; alınan: %s",
	"commands.data.modify.invalid_index": "Geçersiz liste: %s",
	"commands.data.modify.invalid_substring": "%s’den %s’ye Geçersiz alt dizini",
	"commands.data.storage.get": "%[2]s içindeki %[1]s değeri, %[3]s ölçeği uygulandıktan sonra %[4]s olur",
	"commands.data.storage.modified": "%s deposu düzenlendi",
	"commands.data.storage.query": "%s içerisinde şunlar bulunmaktadır: %s",
	"commands.datapack.create.already_exists": "'%s' adında paket zaten mevcut",
	"commands.datapack.create.invalid_full_name": "Geçersiz yeni paket adı '%s'",
	"commands.datapack.create.invalid_name": "Yeni paket '%s' adında geçersiz karakterler",
	"commands.datapack.create.io_failure": "'%s' adında paket oluşturulamıyor, günlükleri kontrol edin",
	"commands.datapack.create.metadata_encode_failure": "'%s' adında paket için metaveri kodlaması başarısız: %s",
	"commands.datapack.create.success": "'%s' adında yeni boş paket oluşturuldu",
	"commands.datapack.disable.failed": "'%s' paketi açık değil!",
	"commands.datapack.disable.failed.feature": "Aktif bir özelliğin parçası olduğundan '%s' paketi devre dışı bırakılamıyor!",
	...
	"commands.datapack.list.available.success": "%s kullanılabilir veri paketi var: %s",
	"commands.datapack.list.enabled.none": "Açık veri paketi yok",
	"commands.datapack.list.enabled.success": "%s etkinleştirilmiş veri paketi var: %s",
	...
	"commands.debug.alreadyRunning": "Birim zaman ayrımlama zaten başlamış",
	"commands.debug.function.noRecursion": "Fonksiyonun içinde bulunamadı",
	"commands.debug.function.noReturnRun": "İzleme, return run ile birlikte kullanılamaz",
	"commands.debug.function.success.multiple": "%[2]s fonksiyondan %[1]s komut %[3]s çıktı dosyasına kaydedildi",
	"commands.debug.function.success.single": "'%[2]s' fonksiyonundan %[1]s komut %[3]s çıktı dosyasına kaydedildi",
	"commands.debug.function.traceFailed": "Fonksiyon izlenemedi",
	...
	"commands.dialog.clear.multiple": "%s oyuncu için diyalog temizlendi",
	"commands.dialog.clear.single": "%s için diyalog temizlendi",
	"commands.dialog.show.multiple": "%s oyuncuya diyalog gösterildi",
	"commands.dialog.show.single": "%s için diyalog gösterildi",
	...
	"commands.drop.no_loot_table": "%s varlığının ganimet tablosu yok",
	"commands.drop.no_loot_table.block": "%s bloğunun ganimet tablosu yok",
	"commands.drop.success.multiple": "%s eşya düşürüldü",
	"commands.drop.success.multiple_with_table": "%[2]s ganimet tablosundan %[1]s adet eşya düşürüldü",
	"commands.drop.success.single": "%s %s düşürüldü",
	"commands.drop.success.single_with_table": "%[3]s ganimet tablosundan %[1]s adet %[2]s düşürüldü",
	...
	"commands.execute.conditional.fail_count": "Deneme başarısız. Miktar: %s",
	"commands.execute.conditional.pass": "Deneme geçti",
	"commands.execute.conditional.pass_count": "Deneme başarılı. Miktar: %s",
	"commands.execute.function.instantiationFailure": "%s fonksiyonunu örneklendirme başarısız: %s",
	...
	"commands.experience.query.levels": "%s oyuncusunun %s tecrübe seviyesi var",
	"commands.experience.query.points": "%s oyuncusunun %s tecrübe puanı var",
	"commands.experience.set.levels.success.multiple": "%[2]s oyuncunun tecrübe seviyesi %[1]s olarak ayarlandı",
	"commands.experience.set.levels.success.single": "%[2]s oyuncusunun tecrübe seviyesi %[1]s olarak ayarlandı",
	...
	"commands.experience.set.points.success.single": "%[2]s oyuncusunun tecrübe puanı %[1]s olarak ayarlandı",
	"commands.fetchprofile.copy_component": "Bileşeni Kopyala",
	"commands.fetchprofile.copy_text": "Kopyala %s",
	"commands.fetchprofile.entity.success": "%s varlığı için profil çözümlendi: %s",
	"commands.fetchprofile.failed_to_serialize": "Profil serileştirme başarısız: %s",
	"commands.fetchprofile.give_item": "Eşya Ver",
	"commands.fetchprofile.id.failure": "%s kimlikli profil çözümlenemedi",
	"commands.fetchprofile.id.success": "%s kimlikli profil çözümlendi: %s",
	"commands.fetchprofile.name.failure": "%s isimli profil çözümlenemedi",
	"commands.fetchprofile.name.success": "%s isimli profil çözümlendi: %s",
	"commands.fetchprofile.no_profile": "%s varlığının profili yok",
	"commands.fetchprofile.summon_mannequin": "Manken Çağır",
	...
	"commands.fillbiome.success": "%s, %s, %s, ve %s, %s, %s arasındaki biyomlar ayarlandı",
	"commands.fillbiome.success.count": "%s biyom girişi %s, %s, %s ile %s, %s, %s arasına yerleştirildi",
	"commands.fillbiome.toobig": "Belirtilen alanda çok fazla blok bulunuyor (maksimum %s, belirtilen %s)",
	"commands.forceload.added.failure": "Hiçbir yığın zorla yükleme için işaretlenemedi",
	"commands.forceload.added.multiple": "%[2]s boyutunda, %[3]s ile %[4]s arasındaki %[1]s yığın zorla yüklenecek şekilde işaretlendi",
	"commands.forceload.added.none": "%s boyutunda zorla yüklenmiş yığın bulunamadı",
	"commands.forceload.added.single": "%[2]s boyutundaki, %[1]s yığını zorla yüklenecek şekilde işaretlendi",
	"commands.forceload.list.multiple": "%[2]s boyutunda, %[3]s konumlarında %[1]s adet zorla yüklenmiş yığın bulundu",
	"commands.forceload.list.single": "%[1]s boyutunda, %[2]s konumunda zorla yüklenmiş bir yığın bulundu",
	"commands.forceload.query.failure": "%[2]s boyutunda, %[1]s konumundaki yığın yüklenmeye zorlanacak şekilde işaretlenemedi",
	"commands.forceload.query.success": "%[2]s boyutunda, %[1]s konumundaki yığın yüklenmeye zorlanacak şekilde işaretlendi",
	"commands.forceload.removed.all": "%s boyutundaki hiçbir yığın yüklenmeye zorlanmayacak",
	"commands.forceload.removed.failure": "Hiçbir yığın zorunlu yüklemeden çıkarılamadı",
	"commands.forceload.removed.multiple": "%[2]s boyutunda, %[3]s ile %[4]s arasındaki %[1]s yığın yüklenmeye zorlanmayacak",
	"commands.forceload.removed.single": "%[2]s boyutundaki, %[1]s yığını yüklenmeye zorlanmayacak",
	"commands.forceload.toobig": "Seçilen alanda çok fazla yığın var (en fazla %s, belirtilen %s)",
	"commands.function.error.argument_not_compound": "Geçersiz argüman türü: %s. Bileşik bekleniyor",
	"commands.function.error.missing_argument": "%[1]s fonksiyonunda %[2]s değişkeni eksik",
	"commands.function.error.missing_arguments": "%s fonksiyonu için değişkenler eksik",
	"commands.function.error.parse": "Makro %s örneklendirilirken: '%s' komutu hataya sebep oldu: %s",
	"commands.function.instantiationFailure": "%s fonksiyonunu örneklendirme başarısız: %s",
	"commands.function.result": "%s fonksiyonu %s döndürdü",
	"commands.function.scheduled.multiple": "%s fonksiyonları yürütülüyor",
	"commands.function.scheduled.no_functions": "%s adında bir fonksiyon bulunamadı",
	"commands.function.scheduled.single": "%s fonksiyonu yürütülüyor",
	"commands.function.success.multiple": "%[2]s fonksiyondan %[1]s komut çalıştırıldı",
	"commands.function.success.multiple.result": "%s fonksiyon çalıştırıldı",
	"commands.function.success.single": "'%[2]s' fonksiyonundan %[1]s komut çalıştırıldı",
	"commands.function.success.single.result": "'%[2]s' fonksiyonu %[1]s döndürdü",
	...
	"commands.give.failed.toomanyitems": "%[2]s ögesi %[1]s taneden fazla verilemez",
	...
	"commands.item.block.set.success": "%s, %s, %s pozisyonundaki yuva %s ile değiştirildi",
	"commands.item.entity.set.success.multiple": "%s varlıktaki yuva %s ile değiştirildi",
	...
	"commands.item.source.not_a_container": "%s, %s, %s konumundaki kaynak, bir depo değil",
	"commands.item.target.no_changed.known_item": "Hiçbir hedef %s eşyasını %s yuvasına kabul etmedi",
	"commands.item.target.no_changes": "Hiçbir hedef %s yuvasına eşya kabul etmedi",
	"commands.item.target.no_such_slot": "Hedef %s yuvasına sahip değil",
	"commands.item.target.not_a_container": "%s, %s, %s konumundaki hedef, bir depo değil",
	"commands.jfr.dump.failed": "JFR kaydı dökümlenemedi: %s",
	"commands.jfr.start.failed": "JFR profili oluşturma başlatılamadı",
	"commands.jfr.started": "JFR ayrımlama başlatıldı",
	"commands.jfr.stopped": "JFR ayrımlama durduruldu ve %s konumuna aktarıldı",
	"commands.kick.owner.failed": "Yerel ağda sunucu sahibini oyundan atamazsınız",
	"commands.kick.singleplayer.failed": "Çevrim dışı tek oyunculu oyundan birini atamazsınız",
	...
	"commands.locate.biome.not_found": "Makul bir uzaklık içinde “%s” türünden bir biyom bulunamadı",
	"commands.locate.biome.success": "En yakın %s, %s konumunda (%s blok uzaklıkta)",
	"commands.locate.poi.not_found": "Uygun mesafe dâhilinde “%s” türünde ilgi noktası bulunamadı",
	...
	"commands.particle.success": "%s parçacığı gösteriliyor",
	"commands.perf.alreadyRunning": "Performans ayrımlama zaten başlamış",
	"commands.perf.notRunning": "Performans ayrımlama henüz başlamadı",
	"commands.perf.reportFailed": "Hata ayıklama raporu oluşturulamadı",
	"commands.perf.reportSaved": "Hata ayıklama raporu şu konuma kaydedildi: %s",
	"commands.perf.started": "10 saniyelik performans ayrımlama başlatıldı (erken sonlandırmak için ’/perf stop’ kullan)",
	"commands.perf.stopped": "%s saniye ve %s birim zamandan sonra performans ayrımlama durduruldu (saniye başına %s birim zaman)",
	"commands.place.feature.failed": "Özellik yerleştirilemedi",
	"commands.place.feature.invalid": "“%s” türünde belirli bir özellik yok",
	"commands.place.feature.success": "\"%s” %s,%s,%s konumuna yerleştirildi",
	"commands.place.jigsaw.failed": "Yapboz oluşturulamadı",
	"commands.place.jigsaw.invalid": "“%s” türünde bir şablon havuzu bulunamadı",
	...
	"commands.profile_fetch.copy_component": "Bileşeni Kopyala",
	"commands.profile_fetch.failed_to_serialize": "Profil serileştirme başarısız: %s",
	"commands.profile_fetch.give_item": "Eşya Ver",
	"commands.profile_fetch.id.failure": "%s kimlikli profil çözümlenemedi",
	"commands.profile_fetch.id.success": "%s kimlikli profil çözümlendi: %s",
	"commands.profile_fetch.name.failure": "%s isimli profil çözümlenemedi",
	"commands.profile_fetch.name.success": "%s isimli profil çözümlendi: %s",
	"commands.publish.alreadyPublished": "Çok oyunculu oyun zaten %s bağlantı noktasından sunuluyor",
	"commands.publish.alreadyPublished.lan": "Yerel oyun zaten %s bağlantı noktasından sunuluyor",
	"commands.publish.alreadyPublished.online": "Çok oyunculu oyun zaten sunuluyor",
	"commands.publish.failed": "Yerel oyun başlatılamıyor",
	"commands.publish.started": "Yerel oyun %s bağlantı noktasından sunuluyor",
	"commands.publish.started.lan": "Yerel oyun %s bağlantı noktasından sunuluyor",
	"commands.publish.started.online": "Sunulan çok oyunculu oyun",
	"commands.publish.success": "Çok oyunculu oyunun barındırıldığı bağlantı noktası %s",
	"commands.random.error.range_too_large": "Rastgele değer aralığı en fazla 2157483646 olabilir",
	"commands.random.error.range_too_small": "Rastgele değer aralığı en az 2 olmalıdır",
	"commands.random.reset.all.success": "%s rastgele dizi sıfırlandı",
	"commands.random.reset.success": "Rastgele %s dizisi sıfırlandı",
	"commands.random.roll": "%s, %s yuvarladı (%s ile %s arasında)",
	"commands.random.sample.success": "Rastgele değer: %s",
	...
	"commands.rotate.success": "%s döndürüldü",
	...
	"commands.save.failed": "Oyun kaydedilemedi (yeterli depolama alanı olmayabilir)",
	"commands.save.saving": "Oyun kaydediliyor (bu biraz zaman alabilir)",
	"commands.save.success": "Oyun kaydedildi",
	"commands.schedule.cleared.failure": "%s kimlikli zamanlı fonksiyon yok",
	"commands.schedule.cleared.success": "%s kimliğine sahip %s zamanlı fonksiyon kaldırıldı",
	"commands.schedule.created.function": "'%[1]s' fonksiyonu, %[3]s oyun zamanı için %[2]s birim zaman sonrasına zamanlandı",
	"commands.schedule.created.tag": "'%[1]s' etiketi, %[3]s oyun zamanı için %[2]s birim zaman sonrasına zamanlandı",
	"commands.schedule.macro": "Makro zamanlanamıyor",
	"commands.schedule.same_tick": "Geçerli birim zamanda planlayamazsınız",
	"commands.scoreboard.objectives.add.duplicate": "Bu ada sahip bir görev zaten var",
	...
	"commands.scoreboard.objectives.display.cleared": "%s üzerinde bulunan görevler kaldırıldı",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "%s görevi için otomatik görüntü güncellemesi devre dışı bırakıldı",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "%s görevi için otomatik güncelleme görüntülenmesi etkinleştirildi",
	"commands.scoreboard.objectives.modify.displayname": "%s tablosunun görünen adı %s olarak değiştirildi",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "%s görevinin varsayılan sayı biçimi temizlendi",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "%s görevinin varsayılan sayı biçimi değiştirildi",
	"commands.scoreboard.objectives.modify.rendertype": "%s görevinin görüntülenme türü değiştirildi",
	...
	"commands.scoreboard.players.add.success.single": "%[3]s adlı oyuncunun %[2]s skoruna %[1]s eklendi (yeni değer: %[4]s)",
	"commands.scoreboard.players.display.name.clear.success.multiple": "%[2]s tablosunda %[1]s varlığın görünen adı temizlendi",
	"commands.scoreboard.players.display.name.clear.success.single": "%[2]s tablosunda %[1]s varlığının görünen adı temizlendi",
	"commands.scoreboard.players.display.name.set.success.multiple": "%[3]s içindeki %[2]s adet varlığın görünen adı %[1]s olarak değiştirildi",
	"commands.scoreboard.players.display.name.set.success.single": "%[3]s içindeki %[2]s varlığının görünen adı %[1]s olarak değiştirildi",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "%[2]s görevinde %[1]s varlık için sayı biçimi temizlendi",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "%[2]s görevinde %[1]s için sayı biçimi temizlendi",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "%[2]s görevinde %[1]s varlık için sayı biçimi değiştirildi",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "%[2]s görevinde %[1]s için sayı biçimi değiştirildi",
	"commands.scoreboard.players.enable.failed": "Bir şey değişmedi, tetikleyici zaten açık",
	"commands.scoreboard.players.enable.invalid": "Etkinleştir, yalnızca tetikleme görevlerinde çalışır",
	...
	"commands.scoreboard.players.remove.success.multiple": "%[3]s adet varlığın %[2]s skorundan %[1]s eksiltildi",
	"commands.scoreboard.players.remove.success.single": "%[3]s için %[1]s, %[2]s üzerinden kaldırıldı (yeni değer %[4]s)",
	...
	"commands.setblock.success": "%s, %s, %s konumundaki blok ayarlandı",
	"commands.setidletimeout.success": "Oyuncu boşta kalma zaman aşımı artık %s dakika",
	"commands.setidletimeout.success.disabled": "Oyuncu hareketsiz durma süresi artık kapalı",
	"commands.setworldspawn.failure.not_overworld": "Başlangıç noktası yalnızca Dünya‘da ayarlanabilir",
	"commands.setworldspawn.success": "Dünya başlangıç noktası %s, %s, %s, [%s] olarak ayarlandı",
	"commands.setworldspawn.success.new": "Dünya başlangıç noktası %[6]s boyutunda %[1]s, %[2]s, %[3]s, [%[4]s, %[5]s] olarak ayarlandı",
	"commands.spawnpoint.success.multiple": "%[6]s oyuncu için %[5]s boyutundaki başlangıç noktası %[1]s,%[2]s,%[3]s [%[4]s] olarak ayarlandı",
	"commands.spawnpoint.success.multiple.new": "%[7]s oyuncu için %[6]s boyutundaki başlangıç noktası %[1]s, %[2]s, %[3]s, [%[4]s, %[5]s] olarak ayarlandı",
	"commands.spawnpoint.success.single": "%[6]s için %[5]s boyutundaki başlangıç noktası %[1]s,%[2]s,%[3]s [%[4]s] olarak ayarlandı",
	"commands.spawnpoint.success.single.new": "%[7]s için %[6]s boyutundaki başlangıç noktası %[1]s, %[2]s, %[3]s, [%[4]s, %[5]s] olarak ayarlandı",
	"commands.spectate.cannot_spectate": "%s seyredilemez",
	...
	"commands.spreadplayers.failed.entities": "%s varlık %s, %s etrafına yayılamadı (yer için çok fazla varlık var - en fazla %s dağıtmayı kullanmayı deneyin)",
	"commands.spreadplayers.failed.invalid.height": "Geçersiz maxHeight %s; dünya alt sınırından (%s) daha yüksek bekleniyor",
	"commands.spreadplayers.failed.teams": "%s takım %s, %s etrafına yayılamadı (yer için çok fazla varlık - en fazla %s dağılım kullanmayı deneyin)",
	"commands.spreadplayers.success.entities": "%s varlık %s, %s etrafına ortalama %s blok mesafeyle dağıtıldı",
	"commands.spreadplayers.success.teams": "%s takım %s, %s çevresine ortalama %s blok mesafeyle dağıtıldı",
	"commands.stop.stopping": "Sunucu durduruluyor",
	"commands.stopsound.success.source.any": "Tüm '%s' sesleri durduruldu",
	"commands.stopsound.success.source.sound": "'%s' sesi '%s' kaynağında durduruldu",
	"commands.stopsound.success.sourceless.any": "Tüm sesler susturuldu",
	"commands.stopsound.success.sourceless.sound": "'%s' sesi susturuldu",
	"commands.stopwatch.already_exists": "'%s' kronometresi zaten mevcut",
	"commands.stopwatch.create.success": "'%s' kronometresi oluşturuldu",
	"commands.stopwatch.does_not_exist": "'%s' kronometresi mevcut değil",
	"commands.stopwatch.query": "Kronometre '%s' %s saniyedir çalışıyor",
	"commands.stopwatch.remove.success": "'%s' kronometresi kaldırıldı",
	"commands.stopwatch.restart.success": "'%s' kronometresi yeniden başlatıldı",
	"commands.summon.failed": "Varlık çağrılamadı",
	"commands.summon.failed.peaceful": "Canavarlar Barışçıl zorlukta çağrılamaz",
	"commands.summon.failed.uuid": "Yinelenen UUID’ler nedeniyle varlık çağrılamıyor",
	"commands.summon.invalidPosition": "Çağırma için geçersiz konum",
	"commands.summon.success": "Yeni bir %s çağrıldı",
	"commands.swing.failed.notliving": "Kolu sallatılacak yaşayan varlık bulunamadı",
	"commands.swing.success.multiple": "%s varlığın kollarını sallaması sağlandı",
	"commands.swing.success.single": "%s varlığının kolu sallatıldı",
	...
	"commands.team.empty.success": "%s üye %s takımından çıkarıldı",
	...
	"commands.team.list.members.success": "%s takımının %s üyesi var: %s",
	"commands.team.list.teams.empty": "Hiç takım yok",
	"commands.team.list.teams.success": "%s tane takım var: %s",
	...
	"commands.team.option.color.clear.success": "%s takımının rengi temizlendi",
	...
	"commands.team.option.name.success": "%s takımının adı güncellendi",
	...
	"commands.team.option.seeFriendlyInvisibles.alreadyDisabled": "Hiçbir şey değişmedi, o takım zaten görünmez olan takım arkadaşlarını göremez",
	...
	"commands.teleport.success.location.single": "%s; %s, %s, %s konumuna ışınlandı",
	"commands.test.batch.starting": "%s çevresi %s yığını başlatılıyor",
	"commands.test.clear.error.no_tests": "Temizlenecek hiçbir test bulunamadı",
	"commands.test.clear.success": "%s yapı temizlendi",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Panoya kopyalamak için tıkla",
	"commands.test.create.success": "%s testi için test hazırlığı oluşturuldu",
	"commands.test.error.no_test_containing_pos": "%s, %s, %s içeren test birimi bulunamadı",
	"commands.test.error.no_test_instances": "Hiçbir test birimi bulunamadı",
	"commands.test.error.non_existant_test": "%s testi bulunamadı",
	"commands.test.error.structure_not_found": "%s test yapısı bulunamadı",
	"commands.test.error.test_instance_not_found": "Test birimi blok varlığı bulunamadı",
	"commands.test.error.test_instance_not_found.position": "%s, %s, %s konumunda test birimi blok varlığı bulunamadı",
	"commands.test.error.too_large": "Yapı boyutu her eksen boyunca %s bloktan küçük olmalı",
	"commands.test.locate.done": "Yer bulma tamamlandı, %s yapı bulundu",
	"commands.test.locate.found": "Şurada yapı bulundu: %s (uzaklık: %s)",
	"commands.test.locate.started": "Test yapılarını bulma başladı, bu biraz zaman alabilir…",
	"commands.test.no_tests": "Yürütülecek test yok",
	"commands.test.relative_position": "%s’e göre konum: %s",
	"commands.test.reset.error.no_tests": "Sıfırlanacak hiçbir test bulunamadı",
	"commands.test.reset.success": "%s yapı sıfırlandı",
	"commands.test.run.no_tests": "Hiçbir test bulunamadı",
	"commands.test.run.running": "%s test yürütülüyor…",
	"commands.test.summary": "Oyun Testi tamamlandı! %s test yürütüldü",
	"commands.test.summary.all_required_passed": "Tüm zorunlu testler geçildi :)",
	"commands.test.summary.failed": "%s zorunlu test başarısız oldu :(",
	"commands.test.summary.optional_failed": "%s isteğe bağlı test başarısız oldu",
	"commands.tick.query.percentiles": "Yüzdelikler: P50: %sms P95: %sms P99: %sms, örnek: %s",
	"commands.tick.query.rate.running": "Hedef birim zaman oranı: saniyede %s.\nBirim zaman başına ortalama süre: %sms (Hedef: %sms)",
	"commands.tick.query.rate.sprinting": "Hedef birim zaman oranı: saniyede %s (okunmaz, referans içindir).\nBirim zaman başına ortalama süre: %sms",
	"commands.tick.rate.success": "Hedef birim zaman oranı saniyede %s olarak belirlendi",
	"commands.tick.sprint.report": "Hızlandırma saniyede %s tıklama veya tıklama başına %s ms ile tamamlandı",
	"commands.tick.sprint.stop.fail": "Süren birim zaman koşusu yok",
	"commands.tick.sprint.stop.success": "Birim zaman koşusu kesintiye uğratıldı",
	"commands.tick.status.frozen": "Oyun donduruldu",
	"commands.tick.status.lagging": "Oyun çalışıyor ancak hedef birim zaman hızına yetişilemiyor",
	"commands.tick.status.running": "Oyun normal çalışıyor",
	"commands.tick.status.sprinting": "Oyun koşuyor",
	"commands.tick.step.fail": "Oyun ilerletilemiyor - önce oyunun dondurulması gerekiyor",
	"commands.tick.step.stop.fail": "Süren birim zaman ilerlemesi yok",
	"commands.tick.step.stop.success": "Birim zaman ilerlemesi kesintiye uğratıldı",
	"commands.tick.step.success": "%s birim zaman ilerleniyor",
	"commands.time.no_default_clock": "%s boyutunda bir varsayılan saat yok",
	"commands.time.no_time_marker_found": "%s zaman noktası, %s saatinde bulunmuyor",
	"commands.time.pause": "%s saati durduruldu",
	"commands.time.query": "Zaman %s",
	"commands.time.query.absolute": "%s saati %s zaman biriminde",
	"commands.time.query.gametime": "Oyun zamanı %s zaman biriminde",
	"commands.time.query.timeline": "%s zaman çizelgesi %s zaman biriminde",
	"commands.time.query.timeline.repetitions": "%s zaman çizelgesi %s döngüden geçti",
	"commands.time.rate": "Saat %s artık normal hızın %sx katında ilerleyecek",
	"commands.time.resume": "%s geri başlatıldı",
	"commands.time.set": "Zaman %s olarak ayarlandı",
	"commands.time.set.absolute": "%s, %s zaman birimine ayarlandı",
	"commands.time.set.time_marker": "%s, %s zaman noktasına ayarlandı",
	"commands.time.wrong_timeline_for_clock": "%s zaman çizelgesi %s saati için geçerli değil",
	...
	"commands.title.show.actionbar.single": "%s için yeni araç çubuğu başlığı gösteriliyor",
	"commands.title.show.subtitle.multiple": "%s oyuncu için yeni alt yazı gösteriliyor",
	"commands.title.show.subtitle.single": "%s için yeni alt yazı gösteriliyor",
	"commands.title.show.title.multiple": "%s oyuncu için yeni bir başlık gösteriliyor",
	"commands.title.show.title.single": "%s için yeni başlık gösteriliyor",
	...
	"commands.transfer.error.no_players": "Aktarılacak en az bir oyuncu belirtilmelidir",
	"commands.transfer.success.multiple": "%s oyuncu %s:%s sunucusuna aktarılıyor",
	"commands.transfer.success.single": "%s, %s:%s sunucusuna aktarılıyor",
	"commands.trigger.add.success": "%s tetiklendi (değere %s eklendi)",
	"commands.trigger.failed.invalid": "Yalnızca ’trigger’ türündeki görevleri tetikleyebilirsiniz",
	...
	"commands.unpublish.notPublished": "Çok oyunculu oyun sunulmuyor",
	"commands.unpublish.success": "Çok oyunculu oyun artık sunulmuyor",
	"commands.version.build_time": "build_time = %s",
	"commands.version.data": "data = %s",
	"commands.version.header": "Sunucu sürümü bilgisi:",
	...
	"commands.waypoint.list.empty": "%s listesinde yol noktası yok",
	"commands.waypoint.list.success": "%s yol noktası %s listesinde: %s",
	"commands.waypoint.modify.color": "Yol noktası rengi artık %s",
	"commands.waypoint.modify.color.reset": "Yol noktası rengi sıfırlandı",
	"commands.waypoint.modify.style": "Yol noktası stili değiştirildi",
	...
	"commands.whitelist.list": "Beyaz listeye alınmış %s oyuncu var: %s",
	...
	"commands.worldborder.damage.buffer.success": "Dünya sınırı hasar mesafesi %s bloğa ayarlandı",
	...
	"commands.worldborder.set.failed.far": "Dünya sınırı merkezden %s bloktan daha uzakta olamaz",
	...
	"commands.worldborder.warning.distance.success": "Dünya sınırı uyarı mesafesi %s bloğa ayarlandı",
	...
	"connect.failed.transfer": "Sunucuya aktarılırken bağlantı başarısız oldu",
	"connect.joining": "Dünyaya katılınıyor...",
	"connect.negotiating": "Anlaşma yapılıyor...",
	"connect.p2p.establishing": "Bağlantı kuruluyor...",
	"connect.p2p.failed.generic": "Oyuncuya bağlanılamadı",
	"connect.p2p.failed.signaling": "Şu anda bağlantı kurmak mümkün değil.\nDaha sonra tekrar deneyin.",
	"connect.p2p.failed.timeout": "Bağlantı isteğinin süresi doldu",
	"connect.p2p.failed.unreachable": "Oyuncuya ulaşılamıyor",
	"connect.reconfiging": "Yeniden Yapılandırılıyor...",
	"connect.reconfiguring": "Yeniden Yapılandırılıyor...",
	"connect.transferring": "Yeni sunucuya aktarılıyor...",
	"container.barrel": "Fıçı",
	"container.beacon": "Fener",
	"container.beehive.bees": "Arı: %s / %s",
	"container.beehive.honey": "Bal: %s / %s",
	"container.blast_furnace": "Maden Eritme Ocağı",
	"container.brewing": "İksir Tezgâhı",
	"container.cartography_table": "Haritacı Masası",
	"container.chest": "Sandık",
	"container.chestDouble": "Geniş Sandık",
	"container.crafter": "Üretici",
	...
	"container.stonecutter": "Taş Yontma Makinesi",
	"container.upgrade": "Alet geliştir",
	"container.upgrade.error_tooltip": "Eşya bu şekilde yükseltilemez",
	"container.upgrade.missing_template_tooltip": "Demirci Şablonu ekleyin",
	...
	"createWorld.customize.buffet.search": "Ara...",
	"createWorld.customize.buffet.title": "Tek Biyom Özelleştirme",
	...
	"createWorld.tab.more.title": "Dahası",
	"createWorld.tab.world.title": "Dünya",
	"credits_and_attribution.button.attribution": "Atıflar",
	"credits_and_attribution.button.credits": "Katkıda Bulunanlar",
	"credits_and_attribution.button.licenses": "Lisanslar",
	"credits_and_attribution.screen.title": "Katkıda Bulunanlar ve Atıflar",
	"dataPack.bundle.description": "Deneysel Kese eşyasını etkinleştirir",
	"dataPack.bundle.name": "Paketler",
	"dataPack.locator_bar.description": "Çok oyunculuda diğer oyuncuların yönünü gösterir",
	"dataPack.locator_bar.name": "Konum Çubuğu",
	"dataPack.minecart_improvements.description": "Geliştirilmiş Vagon hareketleri",
	"dataPack.minecart_improvements.name": "Vagon Geliştirmeleri",
	"dataPack.redstone_experiments.description": "Deneysel Redstone değişiklikleri",
	"dataPack.redstone_experiments.name": "Redstone Deneyleri",
	"dataPack.title": "Veri Paketlerini Seçin",
	"dataPack.trade_rebalance.description": "Köylüler için güncellenmiş teklifler",
	"dataPack.trade_rebalance.name": "Köylü Teklifleri Dengelenmesi",
	...
	"dataPack.update_1_21.description": "Minecraft 1.21 için yeni özellikler ve içerikler",
	"dataPack.update_1_21.name": "1.21 Güncellemesi",
	...
	"dataPack.winter_drop.description": "Kış Yaması için yeni özellik ve içerikler",
	"dataPack.winter_drop.name": "Kış Yaması",
	...
	"death.attack.dragonBreath.player": "%[1]s, %[2]s tarafından ejderha nefesinde kavruldu",
	...
	"death.attack.even_more_magic": "%[1]s daha da fazla büyü kullanılarak öldürüldü",
	...
	"death.attack.genericKill": "%[1]s öldürüldü",
	"death.attack.genericKill.player": "%[1]s, %[2]s ile savaşırken öldürüldü",
	...
	"death.attack.inWall.player": "%[1]s, %[2]s ile savaşırken duvarın içinde sıkıştı",
	...
	"death.attack.mace_smash": "%[1]s, %[2]s tarafından parçalandı",
	"death.attack.mace_smash.item": "%[1]s, %[2]s tarafından %[3]s ile ezildi",
	...
	"death.attack.message_too_long": "Aslında, ileti tam hâliyle iletilebilmek için çok uzundu. Üzgünüz! İşte kısa hâli: %s",
	...
	"death.attack.onFire.item": "%[1]s, %[3]s kullanan %[2]s ile savaşırken yanarak kül oldu",
	...
	"death.attack.outsideBorder": "%[1]s bu dünyanın sınırlarını terk etti",
	"death.attack.outsideBorder.player": "%[1]s, %[2]s ile savaşırken bu dünyanın sınırlarını terk etti",
	...
	"death.attack.spear": "%[1]s, %[2]s tarafından mızraklandı",
	"death.attack.spear.item": "%[1]s, %[2]s tarafından %[3]s kullanılarak mızraklandı",
	...
	"death.attack.sulfurCubeHot": "%[1]s öldü çünkü sadece zemin lav değildi",
	...
	"death.attack.thorns": "%[1]s, %[2]s varlığına zarar vermeye çalışırken öldürüldü",
	"death.attack.thorns.item": "%[1]s, %[2]s varlığına zarar vermeye çalışırken %[3]s tarafından öldürüldü",
	"death.attack.thrown": "%[1]s, %[2]s tarafından vuruldu",
	"death.attack.thrown.item": "%[1]s, %[2]s tarafından %[3]s kullanılarak vuruldu",
	...
	"deathScreen.score.value": "Puan: %s",
	...
	"debug.copy_location.help": "F3 + C = Konumu /tp komutu olarak kopyala, ya da 10 saniye basılı tutarak oyunu çökert",
	...
	"debug.crash.message.rebindable": "%s + %s basılı tutuluyor. Eğer bırakılmazsa oyun çökecek.",
	"debug.crash.warning": "Çökmeye %s...",
	"debug.creative_spectator.error": "Yetki olmadığı için oyun modu değiştirilemiyor",
	"debug.creative_spectator.help": "F3 + N = Önceki oyun modu <-> seyirci arasında geçiş yap",
	...
	"debug.entry.always": "Her Zaman",
	"debug.entry.currently.alwaysOn": "%s: Şuan sürekli açık",
	"debug.entry.currently.inF3": "%s: Şuan sadece F3'de",
	"debug.entry.currently.inOverlay": "%s: Şu an hata ayıklama önyüzünde",
	"debug.entry.currently.never": "%s: Şuan kapalı",
	"debug.entry.f3": "F3'te",
	"debug.entry.overlay": "Önyüzde",
	...
	"debug.options.category.renderer": "Hata Ayıklama Görüntü Oluşturucuları",
	"debug.options.category.text": "Hata Ayıklama Ekran Yazısı",
	"debug.options.help": "F3 + F6 = Hata ayıklama ayarlarını düzenle",
	"debug.options.notAllowed.tooltip": "Hata ayıklama bilgisi azaltıldığında görünmez",
	"debug.options.profile.default": "Varsayılan profil",
	"debug.options.profile.performance": "Performans profili",
	"debug.options.search": "Ara...",
	"debug.options.title": "Hata Ayıklama Seçenekleri",
	"debug.options.warning": "Bu seçenekler sadece test amaçlıdır. Bilgisayarınızı yavaşlatabilir, oyununuzu çökertebilir veya evcil taşınızı mideye indirebilirler.",
	...
	"debug.profiling.start.rebindable": "Ayrımlama %s saniye için başlatıldı. Erken bitirmek için %s + %s tuşlarını kullanın",
	...
	"debug.version.header": "İstemci sürüm bilgisi:",
	"debug.version.help": "F3 + V = İstemci sürüm bilgisi",
	...
	"disconnect.ignoring_status_request": "Durum isteği yok sayılıyor",
	...
	"disconnect.packetError": "Ağ Protokolü Hatası",
	"disconnect.spam": "Spam nedeniyle atıldın",
	"disconnect.timeout": "Zaman aşımına uğradı",
	"disconnect.transfer": "Başka bir sunucuya aktarıldı",
	"disconnect.unknownHost": "Bilinmeyen sunucu",
	"download.pack.failed": "%[2]s paketten %[1]s tanesi indirilemedi",
	"download.pack.progress.bytes": "İlerleme: %s (toplam boyut bilinmiyor)",
	"download.pack.progress.percent": "İlerleme: %s%%",
	"download.pack.title": "%s/%s kaynak paketi indiriliyor",
	"editGamerule.default": "Varsayılan: %s",
	"editGamerule.inGame.button": "Oyun Kurallarını Düzenle...",
	"editGamerule.inGame.disabled.tooltip": "Oyun kurallarını değiştirmek yönetici yetkisi gerektirir.",
	"editGamerule.inGame.discardChanges.message": "Beklenen oyun kuralı değişikliklerinizi iptal etmek istediğinizden emin misiniz?",
	"editGamerule.inGame.discardChanges.title": "Dünya kuralları Değişiklikleri",
	"editGamerule.inGame.downloadingGamerules": "Oyun kuralları alınıyor",
	...
	"effect.minecraft.breath_of_the_nautilus": "Notilus Nefesi",
	...
	"effect.minecraft.infested": "İstila Edilmiş",
	...
	"effect.minecraft.oozing": "Sızma",
	"effect.minecraft.poison": "Zehir",
	"effect.minecraft.raid_omen": "Baskın Kehaneti",
	...
	"effect.minecraft.trial_omen": "Sınama Kehaneti",
	...
	"effect.minecraft.weaving": "Örme",
	"effect.minecraft.wind_charged": "Rüzgâr Dolu",
	...
	"enchantment.minecraft.breach": "Aşma",
	"enchantment.minecraft.channeling": "Yıldırım Yönlendirmesi",
	"enchantment.minecraft.density": "Yoğunluk",
	...
	"enchantment.minecraft.lunge": "Atılma",
	"enchantment.minecraft.lure": "Yemleme",
	...
	"enchantment.minecraft.projectile_protection": "Uzun Menzil Koruması",
	...
	"enchantment.minecraft.wind_burst": "Rüzgâr Patlaması",
	"entity.minecraft.acacia_boat": "Akasya Tekne",
	"entity.minecraft.acacia_chest_boat": "Sandıklı Akasya Tekne",
	"entity.minecraft.allay": "Huzurveren",
	...
	"entity.minecraft.bamboo_chest_raft": "Sandıklı Bambu Sal",
	"entity.minecraft.bamboo_raft": "Bambu Sal",
	"entity.minecraft.bat": "Yarasa",
	"entity.minecraft.bee": "Arı",
	"entity.minecraft.birch_boat": "Huş Tekne",
	"entity.minecraft.birch_chest_boat": "Sandıklı Huş Tekne",
	"entity.minecraft.blaze": "Blaze",
	"entity.minecraft.block_display": "Blok Gösterici",
	"entity.minecraft.boat": "Tekne",
	"entity.minecraft.bogged": "Batık",
	"entity.minecraft.breeze": "Esinti",
	"entity.minecraft.breeze_wind_charge": "Rüzgâr Topu",
	"entity.minecraft.camel": "Deve",
	"entity.minecraft.camel_husk": "Kalıntı Deve",
	"entity.minecraft.cat": "Kedi",
	"entity.minecraft.cave_spider": "Mağara Örümceği",
	"entity.minecraft.cherry_boat": "Kiraz Ağacı Tekne",
	"entity.minecraft.cherry_chest_boat": "Sandıklı Kiraz Ağacı Tekne",
	...
	"entity.minecraft.copper_golem": "Bakır Golem",
	"entity.minecraft.cow": "İnek",
	"entity.minecraft.creaking": "Gıcırtı",
	"entity.minecraft.creaking_transient": "Gıcırdayan",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Koyu Meşe Tekne",
	"entity.minecraft.dark_oak_chest_boat": "Sandıklı Koyu Meşe Tekne",
	...
	"entity.minecraft.item_display": "Eşya Gösterici",
	"entity.minecraft.item_frame": "Eşya Çerçevesi",
	"entity.minecraft.jungle_boat": "Orman Ağacı Tekne",
	"entity.minecraft.jungle_chest_boat": "Sandıklı Orman Ağacı Tekne",
	...
	"entity.minecraft.lingering_potion": "Kalıcı İksir",
	"entity.minecraft.llama": "Lama",
	"entity.minecraft.llama_spit": "Lama Tükürüğü",
	"entity.minecraft.magma_cube": "Magma Küpü",
	"entity.minecraft.mangrove_boat": "Mangrov Tekne",
	"entity.minecraft.mangrove_chest_boat": "Sandıklı Mangrov Tekne",
	"entity.minecraft.mannequin": "Manken",
	...
	"entity.minecraft.nautilus": "Notilus",
	"entity.minecraft.oak_boat": "Meşe Tekne",
	"entity.minecraft.oak_chest_boat": "Sandıklı Meşe Tekne",
	"entity.minecraft.ocelot": "Oselo",
	"entity.minecraft.ominous_item_spawner": "Uğursuz Eşya Çağırıcısı",
	"entity.minecraft.painting": "Tablo",
	"entity.minecraft.pale_oak_boat": "Soluk Meşe Tekne",
	"entity.minecraft.pale_oak_chest_boat": "Sandıklı Soluk Meşe Tekne",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Kavruk",
	"entity.minecraft.parrot": "Papağan",
	"entity.minecraft.phantom": "Kâbus",
	...
	"entity.minecraft.sniffer": "Koklarca",
	...
	"entity.minecraft.splash_potion": "Patlayıcı İksir",
	"entity.minecraft.spruce_boat": "Ladin Tekne",
	"entity.minecraft.spruce_chest_boat": "Sandıklı Ladin Tekne",
	"entity.minecraft.squid": "Mürekkep Balığı",
	"entity.minecraft.stray": "Serseri",
	"entity.minecraft.strider": "Lavgezer",
	"entity.minecraft.sulfur_cube": "Sülfür Küpü",
	"entity.minecraft.sulfur_cube.content": "İçeriği: %s",
	"entity.minecraft.tadpole": "İribaş",
	"entity.minecraft.text_display": "Yazı Gösterici",
	...
	"entity.minecraft.wind_charge": "Rüzgâr Topu",
	...
	"entity.minecraft.zombie_nautilus": "Zombi Notilus",
	...
	"event.minecraft.raid.defeat.full": "Baskın - Mağlubiyet",
	"event.minecraft.raid.raiders_remaining": "Kalan Yağmacılar: %s",
	"event.minecraft.raid.victory": "Zafer",
	"event.minecraft.raid.victory.full": "Baskın - Galibiyet",
	"filled_map.buried_treasure": "Gömülü Hazine Haritası",
	"filled_map.explorer_jungle": "Yağmur Ormanı Kâşifi Haritası",
	"filled_map.explorer_swamp": "Bataklık Kâşifi Haritası",
	"filled_map.id": "ID: #%s",
	"filled_map.level": "(Seviye %s/%s)",
	"filled_map.locked": "Kilitli",
	"filled_map.mansion": "Kara Orman Kâşifi Haritası",
	"filled_map.monument": "Okyanus Kâşifi Haritası",
	"filled_map.scale": "Ölçek: 1:%s",
	"filled_map.trial_chambers": "Sınama Kâşifi Haritası",
	"filled_map.unknown": "Bilinmeyen Harita",
	"filled_map.village_desert": "Çöl Köyü Haritası",
	"filled_map.village_plains": "Ova Köyü Haritası",
	"filled_map.village_savanna": "Savan Köyü Haritası",
	"filled_map.village_snowy": "Karlı Köy Haritası",
	"filled_map.village_taiga": "Tayga Köyü Haritası",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Nether'a İzin Ver",
	"gamerule.allowEnteringNetherUsingPortals.description": "Oyuncuların Nether'a girebilmesini kontrol eder.",
	"gamerule.allowFireTicksAwayFromPlayer": "Oyunculardan uzakta ateş yayılabilsin",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Ateş ve lavın herhangi oyuncudan 8 yığın uzakta yayılabilmesini kontrol eder.",
	...
	"gamerule.blockExplosionDropDecay.description": "Blok etkileşimlerinin neden olduğu patlamalarla yok edilen bloklardan düşen ögelerin bir kısmı patlamada kaybolur.",
	...
	"gamerule.commandBlocksEnabled": "Komut Bloklarını Etkinleştir",
	"gamerule.commandModificationBlockLimit": "Komut değişikliği blok sınırı",
	...
	"gamerule.disablePlayerMovementCheck": "Oyuncu hareket denetimini kapat",
	"gamerule.disableRaids": "Baskınları kapat",
	"gamerule.doDaylightCycle": "Gece-gündüz döngüsü olsun",
	"gamerule.doEntityDrops": "Varlık ekipmanı düşsün",
	"gamerule.doEntityDrops.description": "Maden arabalarından (envanterleri dâhil olmak üzere), eşya çerçevelerinden, botlardan vb. düşen eşyaları kontrol eder.",
	"gamerule.doFireTick": "Ateş yayılabilsin",
	"gamerule.doImmediateRespawn": "Anında yeniden canlanma",
	"gamerule.doInsomnia": "Kâbuslar oluşsun",
	"gamerule.doLimitedCrafting": "Üretim için tarif gereksin",
	"gamerule.doLimitedCrafting.description": "Etkinleştirildiğinde oyuncular yalnızca kilidi açılmış tarifleri üretebilecek.",
	"gamerule.doMobLoot": "Canlı ganimeti düşsün",
	"gamerule.doMobLoot.description": "Tecrübe küreleri de dâhil olmak üzere yaratıklardan düşen kaynakları kontrol eder.",
	...
	"gamerule.doTileDrops.description": "Tecrübe küreleri de dâhil olmak üzere bloklardan düşen kaynakları kontrol eder.",
	"gamerule.doTraderSpawning": "Seyyar Tüccarlar oluşsun",
	"gamerule.doVinesSpread": "Sarmaşıklar yayılsın",
	"gamerule.doVinesSpread.description": "Sarmaşık bloğunun bitişik bloklara rastgele yayılabilmesini kontrol eder. Ağlayan Sarmaşık, Bükük Sarmaşık gibi diğer sarmaşık blok türlerini etkilemez.",
	...
	"gamerule.enableCommandBlocks": "Komut Bloklarını Etkinleştir",
	"gamerule.enderPearlsVanishOnDeath": "Atılan Ender İncileri ölünce yok olurlar",
	"gamerule.enderPearlsVanishOnDeath.description": "Bir oyuncu tarafından atılan Ender İncilerinin o oyuncu ölürse yok olup olmayacağı.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Yolcusu olan varlıklar geçitlerden geçebilir",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Yolcuları olan varlıkların Nether Portalları, End Portalları ve End Geçitlerinden geçmelerine izin verir.",
	...
	"gamerule.locatorBar": "Oyuncu Konum Çubuğunu aç",
	"gamerule.locatorBar.description": "Açıldığında ekranda diğer oyuncuların yönünü gösteren bir çubuk gösterilir.",
	"gamerule.logAdminCommands": "Yönetici komutları gösterilsin",
	"gamerule.maxCommandChainLength": "Komut zinciri uzunluk sınırı",
	"gamerule.maxCommandChainLength.description": "Komut bloğu zincirleri ve fonksiyonlar için geçerli.",
	"gamerule.maxCommandForkCount": "Komut bağlam limiti",
	"gamerule.maxCommandForkCount.description": "’execute as’ gibi komutların kullanabildiği tavan bağlam sayısı.",
	"gamerule.maxEntityCramming": "Varlık sıkışması alt sınırı",
	"gamerule.minecartMaxSpeed": "En yüksek vagon hızı",
	"gamerule.minecartMaxSpeed.description": "Karada hareket eden bir Vagonun varsayılan en fazla hareket hızı.",
	"gamerule.minecraft.elytra_movement_check": "Elitra hareketini denetle",
	"gamerule.minecraft.fire_spread_radius_around_player": "Ateş yayılma yarıçapı",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Oyuncu etrafında ateş yayılabilen blok yarıçapı",
	"gamerule.minecraft.player_movement_check": "Oyuncu hareketini denetle",
	"gamerule.minecraft.raids": "Baskınlar olsun",
	"gamerule.minecraft.universal_anger.description": "Öfkeli tarafsız canlılar sadece onları öfkelendiren oyuncuya değil, yakındaki tüm oyunculara saldırır. forgive_dead_players kapatıldığında daha iyi çalışır.",
	"gamerule.mobExplosionDropDecay": "Canlı patlamalarında, bazı bloklar düşmesin",
	"gamerule.mobExplosionDropDecay.description": "Canlıların neden olduğu patlamalarla yok edilen bloklardan düşen ögelerin bir kısmı patlamada kaybolur.",
	"gamerule.mobGriefing": "Canlıların yıkıcı etkilerine izin verilsin",
	"gamerule.naturalRegeneration": "Sağlık yenilensin",
	"gamerule.playersNetherPortalCreativeDelay": "Yaratıcı modda oyuncunun Nether Geçidi gecikmesi",
	"gamerule.playersNetherPortalCreativeDelay.description": "Boyut değiştirmeden önce yaratıcı moddaki bir oyuncunun Nether Geçidinde beklemesi gereken süre (birim zaman).",
	"gamerule.playersNetherPortalDefaultDelay": "Yaratıcı olmayan modlarda oyuncunun Nether Geçidi gecikmesi",
	"gamerule.playersNetherPortalDefaultDelay.description": "Boyut değiştirmeden önce yaratıcı modda olmayan bir oyuncunun Nether Geçidinde beklemesi gereken süre (birim zaman).",
	...
	"gamerule.projectilesCanBreakBlocks": "Atılabilirler blokları kırabilir",
	"gamerule.projectilesCanBreakBlocks.description": "Atılabilirlerin kendileri tarafından kırılabilen blokları kırıp kıramayacağını kontrol eder.",
	"gamerule.pvp": "Pvp'yi etkinleştir",
	"gamerule.pvp.description": "Oyuncuların diğer oyunculara hasar verebilmesini kontrol eder.",
	...
	"gamerule.spawnChunkRadius": "Başlangıç yığınları yarıçapı",
	"gamerule.spawnChunkRadius.description": "Dünya başlangıç noktasında sürekli yüklenecek yığınların miktarı.",
	"gamerule.spawnMonsters": "Canavarlar Oluşsun",
	"gamerule.spawnMonsters.description": "Canavarların doğal olarak oluşabilmesini kontrol eder.",
	"gamerule.spawnRadius": "Yeniden canlanma yeri çevresi",
	"gamerule.spawnRadius.description": "Oyuncuların doğabileceği başlangıç noktası çevresindeki alanın boyutunu kontrol eder.",
	"gamerule.spawnerBlocksEnabled": "Çağırıcı Bloklarını Etkinleştir",
	"gamerule.spectatorsGenerateChunks": "Seyircilerin arazi oluşturmasına izin verilsin",
	"gamerule.tntExplodes": "TNT’nin etkinleştirilmesine ve patlamasına izin ver",
	"gamerule.tntExplosionDropDecay": "TNT patlamalarında, bazı bloklar düşmesin",
	"gamerule.tntExplosionDropDecay.description": "TNT’nin neden olduğu patlamalarla yok edilen bloklardan düşen ögelerin bir kısmı patlamada kaybolur.",
	...
	"gui.abuseReport.attestation": "Bu bildiriyi göndererek sağladığınız bilgilerin bildiğiniz kadarıyla doğru ve eksiksiz olduğunu onaylamış olursunuz.",
	"gui.abuseReport.comments": "Yorumlar",
	"gui.abuseReport.describe": "Ayrıntıları paylaşmanız tutarlı bir karar vermemize yardımcı olacaktır.",
	"gui.abuseReport.discard.content": "Ayrılırsanız bu bildiriyi ve yorumlarınızı kaybedeceksiniz.\nÇıkmak istediğinizden emin misiniz?",
	"gui.abuseReport.discard.discard": "Ayrıl ve Raporu İptal Et",
	"gui.abuseReport.discard.draft": "Taslak Olarak Kaydet",
	"gui.abuseReport.discard.return": "Düzenlemeye Devam Et",
	"gui.abuseReport.discard.title": "Bildiri ve Yorumlar Silinsin Mi?",
	"gui.abuseReport.draft.content": "Mevcut bildiriyi düzenlemeyi sürdürmek mi yoksa yeni bildiri oluşturmak mı istiyorsunuz?",
	"gui.abuseReport.draft.discard": "İptal Et",
	"gui.abuseReport.draft.edit": "Düzenlemeye Devam Et",
	"gui.abuseReport.draft.quittotitle.content": "Düzenlemeye devam etmek mi yoksa iptal etmek mi istiyorsunuz?",
	"gui.abuseReport.draft.quittotitle.title": "Taslak olarak kaydedilmiş bir sohbet bildiriniz var. Ayrılırsanız bu bildiri silinecektir",
	"gui.abuseReport.draft.title": "Sohbet Bildirisi Taslağını Düzenle?",
	"gui.abuseReport.error.title": "Raporunuz Gönderilirken Sorun Yaşandı",
	"gui.abuseReport.message": "Kötü davranışı nerede gözlemlediniz?\nBu, olayı incelememize yardımcı olacak.",
	"gui.abuseReport.more_comments": "Lütfen ne yaşandığını açıklayın:",
	"gui.abuseReport.name.comment_box_label": "Lütfen neden bu adı bildirmek istediğinizi açıklayın:",
	"gui.abuseReport.name.reporting": "“%s” adlı oyuncuyu bildiriyorsunuz.",
	"gui.abuseReport.name.title": "Uygunsuz Oyuncu Adını Bildir",
	"gui.abuseReport.observed_what": "Bunu bildirme sebebiniz nedir?",
	"gui.abuseReport.read_info": "Bildirme Hakkında Bilgi Edinin",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Birisi sizin veya başkasının itibarına zarar veriyor, örnek olarak diğerlerini yanlış yönlendirmek veya kötüye kullanma amacıyla sahte bilgi paylaşıyor.",
	"gui.abuseReport.reason.description": "Açıklama:",
	"gui.abuseReport.reason.false_reporting": "Yanlış Bildiri",
	"gui.abuseReport.reason.generic": "Onu bildirmek istiyorum",
	"gui.abuseReport.reason.generic.description": "Ondan rahatsız oldum / hoşlanmadığım bir şey yaptı.",
	...
	"gui.abuseReport.reason.imminent_harm": "Başkalarına zarar vermeye yönelik tehdit",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Kendine zarar verme veya intihar",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Cinsel açıdan uygunsuz",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Grafik nitelikte olan; cinsel eylemler, cinsel organlar ve cinsel şiddetle ilgili görünümler.",
	...
	"gui.abuseReport.report_sent_msg": "Raporunuzu başarıyla aldık. Teşekkür ederiz!\n\nEkibimiz mümkün olan en kısa sürede inceleyecektir.",
	"gui.abuseReport.select_reason": "Bildiri Kategorisini Seç",
	"gui.abuseReport.send": "Bildiriyi Gönder",
	"gui.abuseReport.send.comment_too_long": "Lütfen yorumunuzu kısaltın",
	...
	"gui.abuseReport.send.no_reason": "Lütfen bir bildiri kategorisi seçin",
	"gui.abuseReport.send.not_attested": "Lütfen yukarıdaki yazıyı okuyun ve bildiriyi gönderebilmek için onay kutucuğunu işaretleyin",
	...
	"gui.abuseReport.sending.title": "Bildiriliyor...",
	"gui.abuseReport.sent.title": "Bildirildi",
	"gui.abuseReport.skin.title": "Oyuncu Görünümünü Bildir",
	"gui.abuseReport.title": "Oyuncuyu Bildir",
	"gui.abuseReport.type.chat": "Sohbet İletileri",
	"gui.abuseReport.type.name": "Oyuncu Adı",
	"gui.abuseReport.type.skin": "Oyuncu Dış Görünümü",
	...
	"gui.banned.description.temporary": "%s O zamana kadar çevrim içi oynayamaz veya Realms’e katılamazsınız.",
	...
	"gui.banned.name.description": "Kullanıcı adınız - “%s” - Topluluk Kurallarımıza aykırı. Tek oyunculu olarak oynayabilirsiniz ancak çevrim içi oynamak için adını değiştirmeniz gerekecek.\n\nBu bağlantıdan daha fazlasını öğrenebilir ya da durum incelemesi talep edebilirsiniz: %s",
	"gui.banned.name.title": "Kullanıcı Adı Çok Oyunculuda Yasak",
	...
	"gui.banned.reason.generic_violation": "Topluluk Standartlarını İhlal Etmek",
	...
	"gui.banned.skin.description": "Dış görünümünüz Topluluk Kurallarımıza aykırı. Yine de varsayılan bir görünümle oynayabilir veya yeni bir görünüm seçebilirsiniz.\n\nBu bağlantıdan daha fazlasını öğrenebilir ya da durum incelemesi talep edebilirsiniz: %s",
	"gui.banned.skin.title": "Yasaklı Görünüm",
	...
	"gui.chatReport.discard.title": "Rapor ve yorumları sil?",
	...
	"gui.chatReport.title": "Oyuncu konuşmasını bildir",
	...
	"gui.continue": "Devam",
	"gui.copy_link_to_clipboard": "Bağlantıyı Panoya Kopyala",
	"gui.days": "%s gün",
	"gui.done": "Bitti",
	"gui.down": "Aşağı",
	"gui.entity_tooltip.type": "Tür: %s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "%s dosya reddedildi",
	"gui.fileDropFailure.title": "Dosyalar eklenemedi",
	"gui.friends.accept": "Kabul Et",
	"gui.friends.button.loading": "Bekleyin...",
	"gui.friends.button.loading.invite_request_pending": "Onay bekleniyor",
	"gui.friends.button.loading.join_request_pending": "%s Tarafından onay bekleniyor",
	"gui.friends.cancel_request": "Reddet",
	"gui.friends.confirm_title": "Onayla",
	"gui.friends.confirm_unfriend": "Bu oyuncuyu arkadaş listenizden kaldırmak istediğinizden emin misiniz?",
	"gui.friends.copy_to_clipboard": "Panoya Kopyala",
	"gui.friends.decline": "Reddet",
	"gui.friends.empty_nickname": "Arkadaşlık isteği göndermeden önce bir profil adı girin",
	"gui.friends.empty_state": "Eklediğiniz arkadaşlar burada listelenecek.\n\n%s ile çevrim için güvenliğinizi yönetin.",
	"gui.friends.empty_state.link": "Microsoft hesabı",
	"gui.friends.enter_nickname": "Profil İsmini Girin",
	"gui.friends.error.connection_issue": "Arkadaşlar Listesi şuan çalışmıyor.\n\nİnternet bağlantınızı kontrol edip tekrar deneyin.",
	"gui.friends.error.failed.message": "Arkadaşlık isteği gönderilemedi",
	"gui.friends.error.forbidden.message": "Bu arkadaşlık isteği gönderme işlemi başarısız oldu. Bunun nedeni hesabın gizlilik ayarları olabilir.",
	"gui.friends.error.generic": "Bir sorun var — bu özellikte bir sorun var, yani arkadaşlarınızda değil!\n\nLütfen daha sonra tekrar deneyin.",
	"gui.friends.error.rateLimited.message": "Arkadaş Listesi işlemlerini çok hızlı gerçekleştiriyorsunuz. Lütfen bekleyin ve tekrar deneyin.",
	"gui.friends.error.temporary_unavailable": "Arkadaş listesi şu anda çalışmıyor.\n\nLütfen daha sonra tekrar deneyin.",
	"gui.friends.error.unavailable.message": "Arkadaş Listesi hizmeti şu anda kullanılamıyor. Lütfen bağlantınızı kontrol edin ve daha sonra tekrar deneyin.",
	"gui.friends.error.upgrade_needed": "Arkadaş Listesine ulaşmak için oyun sürümünüzü güncelleyin.",
	"gui.friends.error.user_may_lack_active_profile": "Bu profil adına sahip bir oyuncu yok",
	"gui.friends.join": "Katıl",
	"gui.friends.loading_friends": "Arkadaşlar Listesi Yükleniyor...",
	"gui.friends.loading_requests": "İstekler yükleniyor...",
	"gui.friends.manage_account_footer": "%s ile çevrim için güvenliğinizi yönetin",
	"gui.friends.multiplayer.invite": "Dünyaya davet et",
	"gui.friends.multiplayer.invite_accept": "Dünyaya katılma davetini kabul et",
	"gui.friends.multiplayer.invite_reject": "Dünyaya katılma davetini reddet",
	"gui.friends.multiplayer.join_request": "Dünyaya katılma isteği gönder",
	"gui.friends.multiplayer.join_request_accept": "Dünyaya katılma isteğini kabul et",
	"gui.friends.multiplayer.join_request_reject": "Dünyaya katılma isteğini reddet",
	"gui.friends.my_profile_name": "Profil adım: ",
	"gui.friends.my_profile_name.narration": "%s profil ismi panoya kopyalandı",
	"gui.friends.narration.button.accept": "%s Oyuncusunun arkadaşlık isteğini kabul etmek için Enter tuşuna basın",
	"gui.friends.narration.button.cancel_request": "%s için arkadaşlık isteğini iptal etmek için enter tuşuna basın",
	"gui.friends.narration.button.decline": "%s Oyuncusunun arkadaşlık isteğini reddetmek için Enter tuşuna basın",
	"gui.friends.narration.button.unfriend": "Arkadaş listesinden %s oyuncusunu kaldırmak için Enter tuşuna basın",
	"gui.friends.narration.entry.friend": "Arkadaş %s",
	"gui.friends.narration.entry.incoming": "Gelen arkadaş isteği: %s",
	"gui.friends.narration.entry.outgoing": "Giden arkadaş isteği: %s",
	"gui.friends.open": "Arkadaşlar",
	"gui.friends.open.narration": "Arkadaş Listesi",
	"gui.friends.open.tooltip": "Arkadaşlar",
	"gui.friends.pending.empty": "Bekleyen arkadaşlık isteği yok",
	"gui.friends.pending.received": "Alındı",
	"gui.friends.pending.sent": "Gönderildi",
	"gui.friends.presence.status.offline": "Çevrim dışı",
	"gui.friends.presence.status.online": "Çevrim içi",
	"gui.friends.presence.status.playing_hosted_server": "Girilebilir bir dünyada",
	"gui.friends.presence.status.playing_offline": "bir dünyada",
	"gui.friends.presence.status.playing_realms": "Bir Realm'de",
	"gui.friends.presence.status.playing_server": "Bir sunucuda",
	"gui.friends.requests_count": "İstekler (%s)",
	"gui.friends.send_request": "Arkadaşlık isteği gönder",
	"gui.friends.tab_friends": "Arkadaşlar",
	"gui.friends.toast.friend_added.message": "%s, arkadaşlık isteğinizi kabul etti",
	"gui.friends.toast.friend_invited.message": "%s, dünyanıza davet edildi.",
	"gui.friends.toast.friend_removed.message": "%s, arkadaşlık listenizden çıkarıldı",
	"gui.friends.toast.generic_error": "Arkadaş Listeni güncellerken beklenmedik bir hata ile karşılaşıldı. Lütfen sonra tekrar deneyin.",
	"gui.friends.toast.host_invite_expired.message": "%s için gönderilen dünya davetinin süresi doldu.",
	"gui.friends.toast.invite_from_friend.message": "%s, sizi dünyasına davet etti. Katılmak için \"%s\" tuşu ile arkadaş listenizi açın",
	"gui.friends.toast.join_invite_expired.message": "%s dünya davetinin süresi doldu.",
	"gui.friends.toast.join_request.message": "%s, dünyanıza katılmak istiyor. \"%s\" tuşu ile veya oyun menüsünden arkadaş listenizi açabilirsiniz.",
	"gui.friends.toast.request_accepted.message": "%s ile artık arkadaşsınız",
	"gui.friends.toast.request_received.message": "%s, sana arkadaşlık isteği gönderdi",
	"gui.friends.toast.request_sent.message": "Arkadaşlık isteği gönderildi: %s",
	"gui.friends.toast.request_to_join_friend.message": "Dünyaya katılma isteği %s için gönderildi",
	"gui.friends.toast.requests_accepted_multiple.message": "%s arkadaş isteğinizi kabul etti",
	"gui.friends.toast.requests_received_multiple.message": "%s arkadaşlık isteğiniz var",
	"gui.friends.unfriend": "Arkadaşı Çıkar",
	"gui.game_rule.search": "Ara...",
	"gui.hours": "%s saat",
	"gui.language.search": "Ara...",
	"gui.loadingMinecraft": "Minecraft Yükleniyor",
	...
	"gui.none": "Hiçbiri",
	"gui.ok": "Tamam",
	"gui.open_report_dir": "Bildiri Dizinini Aç",
	"gui.packSelection.search": "Ara...",
	"gui.privacy_link.message": "Gizlilik ve çevrim içi güvenlik ayarlarınızı düzenlemek için bu linki açın.",
	"gui.privacy_link.title": "Xbox ayarlarına yapılan değişikliklerin uygulanması biraz zaman alabilir.\n\nYenilenmez ise oyunu yeniden başlatın.",
	"gui.proceed": "Devam et",
	"gui.recipebook.moreRecipes": "Dahası için Sağ Tıklayın",
	"gui.recipebook.next_page": "Sonraki Sayfa",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Önceki Sayfa",
	...
	"gui.remove": "Kaldır",
	"gui.report_to_server": "Sunucuya Bildir",
	"gui.selectWorld.search": "Ara...",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Bu oyuncu sohbet dever dışı olduğu veya engellendiği için bildirilemez",
	...
	"gui.stats.none_found": "İstatistik bulunamadı.",
	"gui.toMenu": "Sunucu Listesine Dön",
	"gui.toRealms": "Realms listesine dön",
	"gui.toTitle": "Ana Menüye Dön",
	"gui.toWorld": "Dünyalar listesine dön",
	"gui.togglable_slot": "Yuvayı devre dışı bırakmak için tıklayın",
	"gui.up": "Yukarı",
	"gui.waitingForResponse.button.inactive": "Geri Dön (%ss)",
	"gui.waitingForResponse.title": "Sunucu Bekleniyor",
	"gui.yes": "Evet",
	...
	"item.canUse.unknown": "Bilinmeyen",
	"item.color": "Renk: %s",
	"item.components": "%s bileşen",
	"item.disabled": "Devre dışı bırakılmış öge",
	"item.durability": "Dayanıklılık: %s / %s",
	"item.dyed": "Boyalı",
	"item.intangible": "Soyut",
	"item.minecraft.acacia_boat": "Akasya Tekne",
	"item.minecraft.acacia_chest_boat": "Sandıklı Akasya Tekne",
	"item.minecraft.allay_spawn_egg": "Huzurveren Çağırma Yumurtası",
	"item.minecraft.amethyst_shard": "Ametist Parçası",
	"item.minecraft.angler_pottery_shard": "Fener Çömlek Parçası",
	"item.minecraft.angler_pottery_sherd": "Balıkçı Çömlek Parçası",
	"item.minecraft.apple": "Elma",
	"item.minecraft.archer_pottery_shard": "Okçu Çömlek Parçası",
	"item.minecraft.archer_pottery_sherd": "Okçu Çömlek Parçası",
	"item.minecraft.armadillo_scute": "Armadillo Pulu",
	"item.minecraft.armadillo_spawn_egg": "Armadillo Çağırma Yumurtası",
	"item.minecraft.armor_stand": "Zırh Askısı",
	"item.minecraft.arms_up_pottery_shard": "Kollar Yukarı Çömlek Parçası",
	"item.minecraft.arms_up_pottery_sherd": "Eller Yukarı Çömlek Parçası",
	...
	"item.minecraft.black_bundle": "Siyah Kese",
	"item.minecraft.black_dye": "Siyah Boya",
	"item.minecraft.black_harness": "Siyah Dizgin",
	"item.minecraft.blade_pottery_shard": "Bıçak Çömlek Parçası",
	"item.minecraft.blade_pottery_sherd": "Bıçak Çömlek Parçası",
	...
	"item.minecraft.blue_bundle": "Mavi Kese",
	"item.minecraft.blue_dye": "Mavi Boya",
	"item.minecraft.blue_egg": "Mavi Yumurta",
	"item.minecraft.blue_harness": "Mavi Dizgin",
	"item.minecraft.bogged_spawn_egg": "Batık Çağırma Yumurtası",
	"item.minecraft.bolt_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Şimşek Zırh Süslemesi",
	"item.minecraft.bone": "Kemik",
	"item.minecraft.bone_meal": "Kemik Tozu",
	"item.minecraft.book": "Kitap",
	"item.minecraft.bordure_indented_banner_pattern": "Testere Dişi Çerçeve Sancak Deseni",
	"item.minecraft.bow": "Yay",
	"item.minecraft.bowl": "Kâse",
	"item.minecraft.bread": "Ekmek",
	"item.minecraft.breeze_rod": "Esinti Çubuğu",
	"item.minecraft.breeze_spawn_egg": "Esinti Çağırma Yumurtası",
	"item.minecraft.brewer_pottery_shard": "İksirci Çömlek Parçası",
	"item.minecraft.brewer_pottery_sherd": "İksirci Çömlek Parçası",
	"item.minecraft.brewing_stand": "İksir Tezgâhı",
	"item.minecraft.brick": "Tuğla",
	"item.minecraft.brown_bundle": "Kahverengi Kese",
	"item.minecraft.brown_dye": "Kahverengi Boya",
	"item.minecraft.brown_egg": "Kahverengi Yumurta",
	"item.minecraft.brown_harness": "Kahverengi Dizgin",
	"item.minecraft.brush": "Fırça",
	"item.minecraft.bucket": "Kova",
	"item.minecraft.bundle": "Kese",
	"item.minecraft.bundle.empty": "Boş",
	"item.minecraft.bundle.empty.description": "Çeşitli eşyalardan bir yığın taşıyabilir",
	"item.minecraft.bundle.full": "Dolu",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "Yanma Çömlek Parçası",
	"item.minecraft.burn_pottery_sherd": "Yanma Çömlek Parçası",
	"item.minecraft.camel_husk_spawn_egg": "Kalıntı Deve Çağırma Yumurtası",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Kıyı Zırh Süslemesi",
	...
	"item.minecraft.copper_axe": "Bakır Balta",
	"item.minecraft.copper_boots": "Bakır Çizme",
	"item.minecraft.copper_chestplate": "Bakır Göğüslük",
	"item.minecraft.copper_golem_spawn_egg": "Bakır Golem Çağırma Yumurtası",
	"item.minecraft.copper_helmet": "Bakır Miğfer",
	"item.minecraft.copper_hoe": "Bakır Çapa",
	"item.minecraft.copper_horse_armor": "Bakır At Zırhı",
	"item.minecraft.copper_ingot": "Bakır Külçesi",
	"item.minecraft.copper_leggings": "Bakır Tozluk",
	"item.minecraft.copper_nautilus_armor": "Bakır Notilus Zırhı",
	"item.minecraft.copper_nugget": "Bakır Parçası",
	"item.minecraft.copper_pickaxe": "Bakır Kazma",
	"item.minecraft.copper_shovel": "Bakır Kürek",
	"item.minecraft.copper_spear": "Bakır Mızrak",
	"item.minecraft.copper_sword": "Bakır Kılıç",
	"item.minecraft.cow_spawn_egg": "İnek Çağırma Yumurtası",
	"item.minecraft.creaking_spawn_egg": "Gıcırtı Çağırma Yumurtası",
	"item.minecraft.creeper_banner_pattern": "Sancak Deseni",
	"item.minecraft.creeper_banner_pattern.desc": "Creeper Şekli",
	"item.minecraft.creeper_banner_pattern.new": "Creeper Şekli Sancak Deseni",
	...
	"item.minecraft.crossbow.projectile.multiple": "Cephane: %s x %s",
	"item.minecraft.crossbow.projectile.single": "Cephane: %s",
	"item.minecraft.cyan_bundle": "Camgöbeği Kese",
	"item.minecraft.cyan_dye": "Camgöbeği Boya",
	"item.minecraft.cyan_harness": "Camgöbeği Dizgin",
	"item.minecraft.danger_pottery_shard": "Tehlike Çömlek Parçası",
	"item.minecraft.danger_pottery_sherd": "Tehlike Çömlek Parçası",
	...
	"item.minecraft.diamond_nautilus_armor": "Elmas Notilus Zırhı",
	"item.minecraft.diamond_pickaxe": "Elmas Kazma",
	"item.minecraft.diamond_shovel": "Elmas Kürek",
	"item.minecraft.diamond_spear": "Elmas Mızrak",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Kumul Zırh Süslemesi",
	...
	"item.minecraft.explorer_pottery_shard": "Kâşif Çömlek Parçası",
	"item.minecraft.explorer_pottery_sherd": "Kâşif Çömlek Parçası",
	"item.minecraft.eye_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Göz Zırh Süslemesi",
	"item.minecraft.feather": "Tüy",
	"item.minecraft.fermented_spider_eye": "Mayalı Örümcek Gözü",
	"item.minecraft.field_masoned_banner_pattern": "Tuğla Sancak Deseni",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Akış Zırh Süslemesi",
	"item.minecraft.flow_banner_pattern": "Sancak Deseni",
	"item.minecraft.flow_banner_pattern.desc": "Akış",
	"item.minecraft.flow_banner_pattern.new": "Akış Sancak Deseni",
	"item.minecraft.flow_pottery_sherd": "Akış Çömlek Parçası",
	"item.minecraft.flower_banner_pattern": "Sancak Deseni",
	"item.minecraft.flower_banner_pattern.desc": "Çiçek Şekli",
	"item.minecraft.flower_banner_pattern.new": "Çiçek Şekli Sancak Deseni",
	"item.minecraft.flower_pot": "Saksı",
	"item.minecraft.fox_spawn_egg": "Tilki Çağırma Yumurtası",
	"item.minecraft.friend_pottery_shard": "Arkadaş Çömlek Parçası",
	"item.minecraft.friend_pottery_sherd": "Arkadaş Çömlek Parçası",
	...
	"item.minecraft.globe_banner_pattern.new": "Dünya Sancak Deseni",
	...
	"item.minecraft.golden_nautilus_armor": "Altın Notilus Zırhı",
	"item.minecraft.golden_pickaxe": "Altın Kazma",
	"item.minecraft.golden_shovel": "Altın Kürek",
	"item.minecraft.golden_spear": "Altın Mızrak",
	"item.minecraft.golden_sword": "Altın Kılıç",
	"item.minecraft.gray_bundle": "Gri Kese",
	"item.minecraft.gray_dye": "Gri Boya",
	"item.minecraft.gray_harness": "Gri Dizgin",
	"item.minecraft.green_bundle": "Yeşil Kese",
	"item.minecraft.green_dye": "Yeşil Boya",
	"item.minecraft.green_harness": "Yeşil Dizgin",
	"item.minecraft.guardian_spawn_egg": "Gardiyan Çağırma Yumurtası",
	"item.minecraft.gunpowder": "Barut",
	"item.minecraft.guster_banner_pattern": "Sancak Deseni",
	"item.minecraft.guster_banner_pattern.desc": "Fırtına",
	"item.minecraft.guster_banner_pattern.new": "Fırtına Sancak Deseni",
	"item.minecraft.guster_pottery_sherd": "Fırtına Çömlek Parçası",
	"item.minecraft.happy_ghast_spawn_egg": "Mutlu Ghast Çağırma Yumurtası",
	"item.minecraft.harness": "Dizgin",
	"item.minecraft.heart_of_the_sea": "Denizin Kalbi",
	"item.minecraft.heart_pottery_shard": "Kalp Çömlek Parçası",
	"item.minecraft.heart_pottery_sherd": "Kalp Çömlek Parçası",
	"item.minecraft.heartbreak_pottery_shard": "Kırık Kalp Çömlek Parçası",
	"item.minecraft.heartbreak_pottery_sherd": "Kırık Kalp Çömlek Parçası",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.host_armor_trim_smithing_template.new": "Ev Sahibi Zırh Süslemesi",
	"item.minecraft.howl_pottery_shard": "Uluma Çömlek Parçası",
	"item.minecraft.howl_pottery_sherd": "Uluma Çömlek Parçası",
	"item.minecraft.husk_spawn_egg": "Kalıntı Çağırma Yumurtası",
	...
	"item.minecraft.light_blue_bundle": "Açık Mavi Kese",
	"item.minecraft.light_blue_dye": "Açık Mavi Boya",
	"item.minecraft.light_blue_harness": "Açık Mavi Dizgin",
	"item.minecraft.light_gray_bundle": "Açık Gri Kese",
	"item.minecraft.light_gray_dye": "Açık Gri Boya",
	"item.minecraft.light_gray_harness": "Açık Gri Dizgin",
	"item.minecraft.lime_bundle": "Açık Yeşil Kese",
	"item.minecraft.lime_dye": "Açık Yeşil Boya",
	"item.minecraft.lime_harness": "Açık Yeşil Dizgin",
	...
	"item.minecraft.lingering_potion.effect.infested": "Kalıcı Enfeksiyon İksiri",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Kalıcı Sızma İksiri",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Kalıcı Örme İksiri",
	"item.minecraft.lingering_potion.effect.wind_charged": "Kalıcı Rüzgâr Dolu İksir",
	"item.minecraft.llama_spawn_egg": "Lama Çağırma Yumurtası",
	"item.minecraft.lodestone_compass": "Manyetit Pusulası",
	"item.minecraft.mace": "Gürz",
	"item.minecraft.magenta_bundle": "Eflatun Kese",
	"item.minecraft.magenta_dye": "Eflatun Boya",
	"item.minecraft.magenta_harness": "Eflatun Dizgin",
	...
	"item.minecraft.miner_pottery_shard": "Madenci Çömlek Parçası",
	"item.minecraft.miner_pottery_sherd": "Madenci Çömlek Parçası",
	"item.minecraft.mojang_banner_pattern": "Sancak Deseni",
	"item.minecraft.mojang_banner_pattern.desc": "Şey",
	"item.minecraft.mojang_banner_pattern.new": "Şey Sancak Deseni",
	"item.minecraft.mooshroom_spawn_egg": "Mooshroom Çağırma Yumurtası",
	"item.minecraft.mourner_pottery_shard": "Ağıtçı Çömlek Parçası",
	"item.minecraft.mourner_pottery_sherd": "Ağıtçı Çömlek Parçası",
	"item.minecraft.mule_spawn_egg": "Katır Çağırma Yumurtası",
	"item.minecraft.mushroom_stew": "Mantar Güveci",
	...
	"item.minecraft.music_disc_bounce": "Müzik Diski",
	...
	"item.minecraft.music_disc_creator": "Müzik Diski",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Müzik Diski",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Creator (Müzik Kutusu)",
	"item.minecraft.music_disc_far": "Müzik Diski",
	"item.minecraft.music_disc_far.desc": "C418 - far",
	"item.minecraft.music_disc_lava_chicken": "Müzik Diski",
	...
	"item.minecraft.music_disc_precipice": "Müzik Diski",
	"item.minecraft.music_disc_precipice.desc": "Aaron Cherof - Precipice",
	"item.minecraft.music_disc_relic": "Müzik Diski",
	...
	"item.minecraft.music_disc_tears": "Müzik Diski",
	...
	"item.minecraft.nautilus_spawn_egg": "Notilus Çağırma Yumurtası",
	...
	"item.minecraft.netherite_helmet": "Netherit Miğfer",
	"item.minecraft.netherite_hoe": "Netherit Çapa",
	"item.minecraft.netherite_horse_armor": "Netherit At Zırhı",
	"item.minecraft.netherite_ingot": "Netherit Külçesi",
	"item.minecraft.netherite_leggings": "Netherit Tozluk",
	"item.minecraft.netherite_nautilus_armor": "Netherit Notilus Zırhı",
	...
	"item.minecraft.netherite_spear": "Netherit Mızrak",
	"item.minecraft.netherite_sword": "Netherit Kılıç",
	"item.minecraft.netherite_upgrade_smithing_template": "Demirci Şablonu",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Netherit Yükseltmesi",
	...
	"item.minecraft.ominous_bottle": "Uğursuz Şişe",
	"item.minecraft.ominous_trial_key": "Uğursuz Sınama Anahtarı",
	"item.minecraft.orange_bundle": "Turuncu Kese",
	"item.minecraft.orange_dye": "Turuncu Boya",
	"item.minecraft.orange_harness": "Turuncu Dizgin",
	"item.minecraft.painting": "Tablo",
	"item.minecraft.pale_oak_boat": "Soluk Meşe Tekne",
	"item.minecraft.pale_oak_chest_boat": "Sandıklı Soluk Meşe Tekne",
	"item.minecraft.panda_spawn_egg": "Panda Çağırma Yumurtası",
	"item.minecraft.paper": "Kâğıt",
	"item.minecraft.parched_spawn_egg": "Kavruk Çağırma Yumurtası",
	"item.minecraft.parrot_spawn_egg": "Papağan Çağırma Yumurtası",
	"item.minecraft.phantom_membrane": "Kâbus Zarı",
	"item.minecraft.phantom_spawn_egg": "Kâbus Çağırma Yumurtası",
	...
	"item.minecraft.piglin_banner_pattern.new": "Domuz Burnu Sancak Deseni",
	...
	"item.minecraft.pink_bundle": "Pembe Kese",
	"item.minecraft.pink_dye": "Pembe Boya",
	"item.minecraft.pink_harness": "Pembe Dizgin",
	"item.minecraft.pitcher_plant": "Sürahi Bitkisi",
	"item.minecraft.pitcher_pod": "Sürahi Bitkisi Tohum Zarfı",
	"item.minecraft.plenty_pottery_shard": "Bereket Çömlek Parçası",
	"item.minecraft.plenty_pottery_sherd": "Güzel Çömlek Parçası",
	...
	"item.minecraft.potion.effect.infested": "Enfeksiyon İksiri",
	...
	"item.minecraft.potion.effect.oozing": "Sızma İksiri",
	...
	"item.minecraft.potion.effect.weaving": "Örme İksiri",
	"item.minecraft.potion.effect.wind_charged": "Rüzgâr Dolu İksir",
	"item.minecraft.pottery_shard_archer": "Okçu Çömlek Parçası",
	"item.minecraft.pottery_shard_arms_up": "Eller Yukarı Çömlek Parçası",
	...
	"item.minecraft.prize_pottery_shard": "Ödül Çömlek Parçası",
	"item.minecraft.prize_pottery_sherd": "Ödül Çömlek Parçası",
	...
	"item.minecraft.purple_bundle": "Mor Kese",
	"item.minecraft.purple_dye": "Mor Boya",
	"item.minecraft.purple_harness": "Mor Dizgin",
	...
	"item.minecraft.rabbit_stew": "Tavşan Güveci",
	"item.minecraft.raiser_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Yükseltici Zırh Süslemesi",
	...
	"item.minecraft.red_bundle": "Kırmızı Kese",
	"item.minecraft.red_dye": "Kırmızı Boya",
	"item.minecraft.red_harness": "Kırmızı Dizgin",
	"item.minecraft.redstone": "Redstone Tozu",
	"item.minecraft.resin_brick": "Reçine Tuğla",
	"item.minecraft.resin_clump": "Reçine Yığını",
	"item.minecraft.rib_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Kaburga Zırh Süslemesi",
	...
	"item.minecraft.scrape_pottery_sherd": "Kazıma Çömlek Parçası",
	"item.minecraft.scute": "Pul",
	"item.minecraft.sentry_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Nöbetçi Zırh Süslemesi",
	"item.minecraft.shaper_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Şekillendirici Zırh Süslemesi",
	"item.minecraft.sheaf_pottery_shard": "Demet Çömlek Parçası",
	"item.minecraft.sheaf_pottery_sherd": "Demet Çömlek Parçası",
	"item.minecraft.shears": "Makas",
	"item.minecraft.sheep_spawn_egg": "Koyun Çağırma Yumurtası",
	"item.minecraft.shelter_pottery_shard": "Barınak Çömlek Parçası",
	"item.minecraft.shelter_pottery_sherd": "Barınak Çömlek Parçası",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Sessizlik Zırh Süslemesi",
	...
	"item.minecraft.skull_banner_pattern.new": "Kuru Kafa Şekli Sancak Deseni",
	"item.minecraft.skull_pottery_shard": "Kafatası Çömlek Parçası",
	"item.minecraft.skull_pottery_sherd": "Kafatası Çömlek Parçası",
	...
	"item.minecraft.smithing_template.armor_trim.additions_slot_description": "Külçe veya kristal ekleyin",
	"item.minecraft.smithing_template.armor_trim.applies_to": "Zırh",
	"item.minecraft.smithing_template.armor_trim.base_slot_description": "Bir zırh parçası ekleyin",
	...
	"item.minecraft.smithing_template.netherite_upgrade.additions_slot_description": "Netherit Külçesi ekleyin",
	"item.minecraft.smithing_template.netherite_upgrade.applies_to": "Elmas Ekipman",
	"item.minecraft.smithing_template.netherite_upgrade.base_slot_description": "Elmas zırh, silah veya alet ekleyin",
	"item.minecraft.smithing_template.netherite_upgrade.ingredients": "Netherit Külçesi",
	"item.minecraft.smithing_template.upgrade": "Yükseltme: ",
	"item.minecraft.sniffer_spawn_egg": "Koklarca Çağırma Yumurtası",
	"item.minecraft.snort_pottery_shard": "Koklama Çömlek Parçası",
	"item.minecraft.snort_pottery_sherd": "Horlayan Çömlek Parçası",
	"item.minecraft.snout_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Domuz Burnu Zırh Süslemesi",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Sarmal Zırh Süslemesi",
	...
	"item.minecraft.splash_potion.effect.infested": "Patlayıcı Enfeksiyon İksiri",
	...
	"item.minecraft.splash_potion.effect.oozing": "Patlayıcı Sızma İksiri",
	...
	"item.minecraft.splash_potion.effect.weaving": "Patlayıcı Örme İksiri",
	"item.minecraft.splash_potion.effect.wind_charged": "Rüzgâr Dolu Patlayıcı İksir",
	...
	"item.minecraft.stone_spear": "Taş Mızrak",
	...
	"item.minecraft.sulfur_cube_bucket": "Sülfür Küpü Kovası",
	"item.minecraft.sulfur_cube_spawn_egg": "Sülfür Küpü Çağırma Yumurtası",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Gelgit Zırh Süslemesi",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Enfeksiyon Oku",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Sızma Oku",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Örme Oku",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Rüzgârla Doldurma Oku",
	...
	"item.minecraft.trial_key": "Sınama Anahtarı",
	...
	"item.minecraft.turtle_scute": "Kaplumbağa Pulu",
	"item.minecraft.turtle_spawn_egg": "Kaplumbağa Çağırma Yumurtası",
	"item.minecraft.vex_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Sinirbozan Zırh Süslemesi",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Koğuş Zırh Süslemesi",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Yol Bulucu Zırh Süslemesi",
	"item.minecraft.wheat": "Buğday",
	"item.minecraft.wheat_seeds": "Buğday Tohumu",
	"item.minecraft.white_bundle": "Beyaz Kese",
	"item.minecraft.white_dye": "Beyaz Boya",
	"item.minecraft.white_harness": "Beyaz Dizgin",
	"item.minecraft.wild_armor_trim_smithing_template": "Demirci Şablonu",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Yabani Zırh Süslemesi",
	"item.minecraft.wind_charge": "Rüzgâr Topu",
	...
	"item.minecraft.wolf_armor": "Kurt Zırhı",
	...
	"item.minecraft.wooden_spear": "Tahta Mızrak",
	...
	"item.modifiers.any": "Kuşanıldığında:",
	"item.modifiers.armor": "Giyildiğinde:",
	"item.modifiers.body": "Kuşanıldığında:",
	"item.modifiers.chest": "Göğüsteyken:",
	"item.modifiers.feet": "Ayaktayken:",
	"item.modifiers.hand": "Tutulduğunda:",
	...
	"item.modifiers.saddle": "Eyerlendiğinde:",
	"item.nbt_tags": "NBT: %s etiket",
	"item.op_block_warning.line1": "Uyarı:",
	"item.op_block_warning.line2": "Bu eşyanın kullanılması belirli komutlar çalıştırabilir.",
	"item.op_block_warning.line3": "İçeriğini tamamen bilmiyorsanız kullanmayın!",
	"item.spawn_egg.peaceful": "Barışçıl zorlukta devre dışı",
	...
	"jigsaw_block.placement_priority": "Yerleştirme Önceliği:",
	"jigsaw_block.placement_priority.tooltip": "Bu Yapboz bloğu bir parçaya bağlandığında, o parçanın daha geniş yapıdaki bağlantılar için işlenme sırası böyledir.\nParçalar azalan sırayla girilme sırası eşitlikleri bozacak şekilde işlenecek.",
	"jigsaw_block.pool": "Hedef Havuzu:",
	"jigsaw_block.selection_priority": "Seçim Önceliği:",
	"jigsaw_block.selection_priority.tooltip": "Üst parça bağlantılar için işlenirken, bu Yapboz bloğunun hedef parçasına bağlanmaya çalıştığı sıra budur.\n\nYapbozlar, azalan öncelikle rastgele eşitlik kırılarak işlenecektir.",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine - Creator (Müzik Kutusu)",
	...
	"key.categories.spectator": "Seyirci",
	"key.categories.ui": "Oyun Arayüzü",
	"key.category.minecraft.creative": "Yaratıcı Mod",
	"key.category.minecraft.debug": "Hata Ayıklama",
	"key.category.minecraft.gameplay": "Oynanış",
	"key.category.minecraft.inventory": "Envanter",
	"key.category.minecraft.misc": "Çeşitli",
	"key.category.minecraft.movement": "Hareket",
	"key.category.minecraft.multiplayer": "Çok Oyunculu",
	"key.category.minecraft.spectator": "Seyirci",
	"key.chat": "Sohbeti Açma",
	"key.command": "Komutu Açma",
	"key.debug.clearChat": "Sohbeti Temizle",
	"key.debug.copyLocation": "Konumu Kopyala",
	"key.debug.copyRecreateCommand": "Veriyi Kopyala",
	"key.debug.crash": "Çökme İçin Hata Ayıkla",
	"key.debug.debugOptions": "Hata Ayıklama Seçenekleri",
	"key.debug.dumpDynamicTextures": "Dinamik Dokuları Boşalt",
	"key.debug.dumpVersion": "Sürüm Bilgisini Boşalt",
	"key.debug.focusPause": "Odak Kaybı Duraklatmasını Aç/Kapa",
	"key.debug.fpsCharts": "FPS Grafikleri",
	"key.debug.lightmapTexture": "Işık Haritası Dokusu",
	"key.debug.modifier": "Hata Ayıklama Niteleyici Anahtarı",
	"key.debug.networkCharts": "Ağ Grafikleri",
	"key.debug.overlay": "Önyüzü Aç/Kapa",
	"key.debug.profiling": "Ayrımlamayı Başlat/Durdur",
	"key.debug.profilingChart": "Ayrımlama Grafiği",
	"key.debug.reloadChunk": "Yığınları Yeniden Yükle",
	"key.debug.reloadResourcePacks": "Kaynak Paketlerini Yeniden Yükle",
	"key.debug.showAdvancedTooltips": "Gelişmiş Araç İpuçlarını Göster",
	"key.debug.showChunkBorders": "Yığın Sınırılarını Göster",
	"key.debug.showHitboxes": "Vurma Kutularını Göster",
	"key.debug.spectate": "Seyirci Geçişi",
	"key.debug.switchGameMode": "Oyun Modu Değiştirici",
	"key.drop": "Seçili Eşyayı Bırakma",
	"key.forward": "İleri Yürüme",
	"key.friends": "Arkadaş Menüsü",
	...
	"key.quickActions": "Hızlı Eylemler",
	...
	"key.spectatorHotbar": "Araç Çubuğunda Seçin",
	"key.spectatorOutlines": "Oyuncuları Vurgula",
	"key.sprint": "Koşma",
	"key.swapOffhand": "Eşyayı Elden Ele Değiştirme",
	"key.toggleGui": "Arayüzü Aç/Kapa",
	"key.togglePerspective": "Görüş Açısını Değiştirme",
	"key.toggleSpectatorShaderEffects": "Seyirci Gölgelendirme Efektlerini Aç/Kapa",
	"key.use": "Eşyayı Kullanma/Blok Koyma",
	"known_server_link.announcements": "Duyurular",
	"known_server_link.community": "Topluluk",
	"known_server_link.community_guidelines": "Topluluk Kuralları",
	"known_server_link.feedback": "Geri Bildirim",
	"known_server_link.forums": "Forumlar",
	"known_server_link.news": "Haberler",
	"known_server_link.report_bug": "Sunucu Hatası Bildir",
	"known_server_link.status": "Durum",
	"known_server_link.support": "Destek",
	"known_server_link.website": "İnternet Sitesi",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Sunucu Ekle",
	"manageServer.edit.title": "Sunucu Bilgilerini Düzenle",
	"manageServer.enterIp": "Sunucu Adresi",
	"manageServer.enterName": "Sunucu Adı",
	"manageServer.resourcePack": "Sunucu Kaynak Paketleri",
	"manageServer.resourcePack.disabled": "Kapalı",
	"manageServer.resourcePack.enabled": "Açık",
	"manageServer.resourcePack.prompt": "Sor",
	"mco.account.privacy.info": "Mojang ve gizlilik yasaları hakkında daha fazlasını okuyun",
	"mco.account.privacy.info.button": "GDPR/GVKT üzerine daha fazla bilgi",
	"mco.account.privacy.information": "Mojang, Çocukların Çevrim İçi Gizliliğini Koruma Yasası’na (COPPA) ve Genel Veri Koruma Yönetmeliğine (GDPR) uygun olarak çocukların korunmasına ve gizliliğine yardımcı olmak için belirli prosedürleri uygulamaktadır.\n\nRealms hesabınıza erişmeden önce ebeveyn izni almanız gerekebilir.",
	...
	"mco.backup.button.download": "En Günceli İndir",
	...
	"mco.backup.entry": "Yedek (%s)",
	"mco.backup.entry.description": "Açıklama",
	"mco.backup.entry.enabledPack": "Aktif Paket(ler)",
	"mco.backup.entry.gameDifficulty": "Oyun Zorluğu",
	"mco.backup.entry.gameMode": "Oyun Modu",
	"mco.backup.entry.gameServerVersion": "Oyun Sunucusu Sürümü",
	"mco.backup.entry.name": "Ad",
	"mco.backup.entry.seed": "Dünya Oluşturucusu Kodu",
	"mco.backup.entry.templateName": "Şablon adı",
	"mco.backup.entry.undefined": "Tanımlanmamış Değişiklik",
	"mco.backup.entry.uploaded": "Yüklendi",
	"mco.backup.entry.worldType": "Dünya Türü",
	"mco.backup.entry.worldType.adventureMap": "Macera Haritası",
	"mco.backup.entry.worldType.experience": "Deneyim",
	"mco.backup.entry.worldType.inspiration": "İlham",
	"mco.backup.entry.worldType.minigame": "Mini Oyun",
	"mco.backup.entry.worldType.normal": "Normal",
	"mco.backup.entry.worldType.unknown": "Bilinmeyen",
	"mco.backup.generate.world": "Dünya oluştur",
	"mco.backup.info.title": "Son yedeklemeden kalan değişiklikler",
	"mco.backup.narration": "%s kaynağından yedekle",
	"mco.backup.nobackups": "Bu Realm’in şu anda hiçbir yedeği yok.",
	"mco.backup.restoring": "Realm’iniz Onarılıyor",
	"mco.backup.unknown": "BİLİNMEYEN",
	...
	"mco.client.incompatible.msg.line3": "Realms, test sürümleriyle uyumlu değildir.",
	"mco.client.incompatible.title": "İstemci uyumsuz!",
	"mco.client.outdated.stable.version": "İstemci sürümünüz (%s) Realms ile uyumlu değil.\n\nLütfen Minecraft’ın en yeni sürümünü kullanın.",
	"mco.client.unsupported.snapshot.version": "İstemcinizin sürümü (%s) Realms ile uyumlu değil.\n\nRealms bu test sürümünde desteklenmiyor.",
	"mco.compatibility.downgrade": "Düşür",
	"mco.compatibility.downgrade.description": "Bu dünya en son %s sürümünde oynandı; şu an %s sürümündesiniz. Dünyanın sürümünü düşürmek dünya üzerinde bozulmalara neden olabilir - yüklenmesi veya çalışması kesin değildir.\n\nDünyanızın bir yedeği “Dünya Yedekleri” altında kaydedilecek. Gerektiğinde dünyanızı onarabilirsiniz.",
	"mco.compatibility.incompatible.popup.title": "Uyumsuz sürüm",
	"mco.compatibility.incompatible.releaseType.popup.message": "Girmeye çalıştığınız dünya, bulunduğunuz sürüm ile uyumlu değil.",
	"mco.compatibility.incompatible.series.popup.message": "Bu dünya en son %s sürümünde oynandı, siz %s sürümündesiniz.\n\nBu ikisi birbiri ile uyumlu değil. Bu sürümde oynamak için yeni bir dünyaya ihtiyacınız var.",
	"mco.compatibility.unverifiable.message": "Bu dünyanın en son hangi sürümde oynandığı doğrulanamıyor. Eğer dünyanın sürümü yükseltilirse veya düşürülürse, bir yedeği oluşturulacak ve “Dünya Yedekleri” altında kaydedilecek.",
	"mco.compatibility.unverifiable.title": "Uyumluluk doğrulanabilir değil",
	"mco.compatibility.upgrade": "Yükselt",
	"mco.compatibility.upgrade.description": "Bu dünya en son %s sürümünde oynandı; şu an %s sürümündesiniz.\n\nDünyanızın bir yedeği “Dünya Yedekleri” altında kaydedilecek. \n\nGerektiğinde dünyanızı onarabilirsiniz.",
	"mco.compatibility.upgrade.friend.description": "Bu dünya en son %s sürümünde oynandı; şu an %s sürümündesiniz.\n\nDünyanın bir yedeği “Dünya Yedekleri” altında kaydedilecek. \n\nGerektiğinde Realm sahibi dünyayı onarabilir.",
	"mco.compatibility.upgrade.title": "Bu dünyayı yükseltmek istediğinizden emin misiniz?",
	...
	"mco.configure.world.buttons.close": "Geçici Olarak Realm’i Kapat",
	...
	"mco.configure.world.buttons.newworld": "Yeni Dünya",
	"mco.configure.world.buttons.open": "Realm’i Yeniden Aç",
	"mco.configure.world.buttons.options": "Dünya Seçenekleri",
	"mco.configure.world.buttons.players": "Oyuncular",
	"mco.configure.world.buttons.region_preference": "Bölge Seç...",
	"mco.configure.world.buttons.resetworld": "Dünyayı Sıfırla",
	"mco.configure.world.buttons.save": "Kaydet",
	...
	"mco.configure.world.close.question.line1": "Realm'inizi geçici olarak kapatabilirsiniz, siz ayar yaparken oynamayı engeller. Hazır olduğunuzda tekrar açabilirsiniz.\n\nBu Realms Aboneliğinizi iptal etmez.",
	"mco.configure.world.close.question.line2": "Devam etmek istediğinizden emin misiniz?",
	"mco.configure.world.close.question.title": "Kesintisiz değişiklik mi yapmanız lazım?",
	"mco.configure.world.closing": "Realm geçici olarak kapatılıyor...",
	...
	"mco.configure.world.invited.number": "Davetli (%s)",
	...
	"mco.configure.world.loading": "Realm Yükleniyor",
	"mco.configure.world.location": "Yer",
	"mco.configure.world.minigame": "Şu anda: %s",
	"mco.configure.world.name": "Realm Adı",
	"mco.configure.world.name.validation.whitespace": "Boşluk karakteriyle başlamamalı ya da sona ermemelidir. Kırpılacaktır.",
	"mco.configure.world.opening": "Realm Açılıyor...",
	"mco.configure.world.players.error": "Belirtilen ada sahip bir oyuncu mevcut değil",
	"mco.configure.world.players.invite.duplicate": "Verilen isme sahip bir oyuncu zaten Realm'e davet edilmiş",
	"mco.configure.world.players.inviting": "Oyuncu davet ediliyor...",
	"mco.configure.world.players.title": "Oyuncular",
	"mco.configure.world.pvp": "PvP",
	"mco.configure.world.region_preference": "Bölge Tercihi",
	"mco.configure.world.region_preference.title": "Bölge Tercihi Seçimi",
	...
	"mco.configure.world.resourcepack.question": "Bu Realm’de oynamak için özel bir doku paketine ihtiyacınız var\n\nİndirip oynamak istiyor musunuz?",
	...
	"mco.configure.world.restore.question.line1": "Realm’iniz '%s' (%s) tarihindeki hâline getirilecek",
	"mco.configure.world.restore.question.line2": "Devam etmek istediğinizden emin misiniz?",
	"mco.configure.world.settings.expired": "Süresi dolmuş bir Realm'in ayarlarını düzenleyemezsiniz",
	...
	"mco.configure.world.subscription.recurring.info": "Realms aboneliğinizde yaptığınız zaman istiflemesi veya yenilenen faturalandırmayı kapatma gibi değişiklikler sonraki faturalandırma tarihine kadar size yansımayacak.",
	"mco.configure.world.subscription.remaining.days": "%[1]s gün",
	"mco.configure.world.subscription.remaining.months": "%[1]s ay",
	"mco.configure.world.subscription.remaining.months.days": "%[1]s ay, %[2]s gün",
	"mco.configure.world.subscription.start": "Başlangıç Tarihi",
	"mco.configure.world.subscription.tab": "Abonelik",
	...
	"mco.configure.world.switch.slot.subtitle": "Bu dünya boş. Dünyanı nasıl oluşturacağını seç",
	"mco.configure.world.title": "Realm’i Yapılandır:",
	"mco.configure.world.uninvite.player": "'%s' adlı oyuncuya olan davetiyeyi kaldırmak istediğinize emin misiniz?",
	...
	"mco.connect.region": "Sunucu bölgesi: %s",
	"mco.connect.success": "Tamam",
	"mco.create.world": "Oluştur",
	"mco.create.world.error": "Bir ad girmelisiniz!",
	"mco.create.world.failed": "Dünya oluşturulamadı!",
	"mco.create.world.reset.title": "Dünya oluşturuluyor...",
	"mco.create.world.skip": "Atla",
	"mco.create.world.subtitle": "İsterseniz, yeni Realm’inize koymak istediğiniz dünyayı seçin",
	...
	"mco.download.confirmation.oversized": "İndireceğiniz dünya %s boyutundan daha büyük\n\nRealm’inize bu dünyayı bir daha yükleyemeyeceksiniz",
	...
	"mco.download.resourcePack.fail": "Kaynak paketi indirilemedi!",
	"mco.download.speed": "(%s/s)",
	"mco.download.speed.narration": "%s/s",
	"mco.download.title": "En Son Dünya İndiriliyor",
	...
	"mco.errorMessage.6002": "Hizmet koşulları kabul edilmedi",
	"mco.errorMessage.6003": "İndirme sınırına ulaşıldı",
	"mco.errorMessage.6004": "Yükleme sınırına ulaşıldı",
	"mco.errorMessage.6005": "Dünya kilitli",
	"mco.errorMessage.6006": "Dünyan güncel değil",
	"mco.errorMessage.6007": "Oyuncu çok fazla Realm’in içinde",
	"mco.errorMessage.6008": "Yanlış Realm adı",
	"mco.errorMessage.6009": "Geçersiz Realm tanımı",
	"mco.errorMessage.connectionFailure": "Bir hata oluştu. Lütfen daha sonra tekrar deneyin.",
	"mco.errorMessage.generic": "Bir hata oluştu: ",
	"mco.errorMessage.initialize.failed": "Realm oluşturulamadı",
	"mco.errorMessage.noDetails": "Hata ayrıntıları sağlanmadı",
	"mco.errorMessage.realmsService": "Bir hata oluştu (%s):",
	"mco.errorMessage.realmsService.configurationError": "Dünya ayarlarını düzenlerken beklenmedik bir hata oluştu",
	"mco.errorMessage.realmsService.connectivity": "Realms’e bağlanılamadı: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Uygun sürüm kontrol edilemedi. Alınan yanıt: %s",
	"mco.errorMessage.retry": "İşlemi tekrar dene",
	...
	"mco.gui.ok": "Tamam",
	"mco.info": "Bilgi!",
	"mco.invited.player.narration": "%s oyuncusu davet edildi",
	...
	"mco.minigame.world.switch.title": "Mini Oyuna Çevir",
	"mco.minigame.world.title": "Realm’i Mini Oyuna Çevir",
	"mco.news": "Realms haberleri",
	"mco.notification.dismiss": "Yok say",
	"mco.notification.transferSubscription.buttonText": "Şimdi Aktar",
	"mco.notification.transferSubscription.message": "Java Realms abonelikleri Microsoft Store’a taşınıyor. Aboneliğinizin sona ermesine izin vermeyin! \nŞimdi transfer edin ve 30 günlük ücretsiz Realms edinin. \nAboneliğinizi aktarmak için minecraft.net’teki Profil’e gidin.",
	...
	"mco.onlinePlayers": "Çevrim içi Oyuncular",
	"mco.play.button.realm.closed": "Realm kapalı",
	"mco.question": "Soru",
	...
	"mco.selectServer.closed": "Devre Dışı Realm",
	...
	"mco.selectServer.create.subtitle": "Yeni Realm’inize koymak istediğiniz dünyayı seçin",
	...
	"mco.selectServer.leave": "Realm’den Ayrıl",
	"mco.selectServer.loading": "Realm Listesi Yükleniyor",
	"mco.selectServer.mapOnlySupportedForVersion": "%s bu haritayı desteklemiyor",
	"mco.selectServer.minigame": "Mini Oyun:",
	"mco.selectServer.minigameName": "Mini Oyun: %s",
	"mco.selectServer.minigameNotSupportedInVersion": "Bu mini oyunu %s sürümünde oynayamazsınız",
	"mco.selectServer.noRealms": "Görünüşe göre hiç Realm’iniz yok. Arkadaşlarınızla beraber oynamak için bir Realm ekleyin.",
	"mco.selectServer.note": "Not:",
	"mco.selectServer.open": "Açık Realm",
	"mco.selectServer.openserver": "Realm’i Aç",
	"mco.selectServer.play": "Oyna",
	"mco.selectServer.popup": "Realms, bir Minecraft dünyasını on kişiye kadar aynı anda oynamanızı sağlayan basit ve güvenli bir yoldur. Onlarca mini oyun ve yüzlerce özel dünya taşır. Yalnızca Realm sahibinin para ödemesi gerekir.",
	"mco.selectServer.purchase": "Realm Ekle",
	"mco.selectServer.trial": "Deneme Sürümü Alın!",
	"mco.selectServer.uninitialized": "Realm oluşturmak için tıkla!",
	"mco.snapshot.createSnapshotPopup.text": "Ücretli Realms aboneliğinizle eşleştirilecek ücretsiz bir Test Sürümü Realm’i oluşturmak üzeresiniz. Bu yeni Test Sürümü Realm’i ücretli aboneliğiniz etkin olduğu sürece erişilebilir olacaktır. Ücretli Realm’iniz etkilenmeyecektir.",
	"mco.snapshot.createSnapshotPopup.title": "Test Sürümü Realm’i Oluşturulsun mu?",
	"mco.snapshot.creating": "Snapshot Realm’i Oluşturuluyor...",
	"mco.snapshot.description": "“%s” ile eşleştirildi",
	"mco.snapshot.friendsRealm.downgrade": "Bu Realm’e katılabilmek için %s sürümünde olmanız gerekiyor",
	"mco.snapshot.friendsRealm.upgrade": "Bu sürümden oynayabilmeniz için %s, Realm'ini güncellemelidir",
	"mco.snapshot.paired": "Bu Test Sürümü Realm’i “%s” ile eşleştirildi",
	"mco.snapshot.parent.tooltip": "Bu Realm’de oynayabilmek için Minecraft’ın en yeni sürümünü kullanın",
	"mco.snapshot.start": "Ücretsiz Test Sürümü Realm’i başlatın",
	"mco.snapshot.subscription.info": "Bu Test Sürümü Realm’i '%s' Realm’i aboneliğinizle eşleştirilmiştir. Eşleştirildiği Realm etkin oldukça etkin kalacaktır.",
	"mco.snapshot.tooltip": "Test Sürümü Realm’lerini kullanarak Minecraft’ın gelecek sürümlerine göz atın, yeni özellikler ve diğer değişiklikler içerebilir.\n\nNormal Realms’inizi oyunun stabil sürümünde bulabilirsiniz.",
	"mco.snapshotRealmsPopup.message": "Test Sürümü 23w41a'dan itibaren Realms Test Sürümlerinde mevcut. Tüm Realms abonelikleri normal Java Realm’inizden ayrı ücretsiz bir Test Sürümü Realm'i ile gelir!",
	"mco.snapshotRealmsPopup.title": "Realms artık Test Sürümlerinde mevcut",
	"mco.snapshotRealmsPopup.urlText": "Daha Fazla Bilgi",
	...
	"mco.time.daysAgo": "%[1]s gün önce",
	"mco.time.hoursAgo": "%[1]s saat önce",
	"mco.time.minutesAgo": "%[1]s dakika önce",
	"mco.time.now": "tam şimdi",
	"mco.time.secondsAgo": "%[1]s saniye önce",
	...
	"mco.upload.failed.too_big.description": "Seçilen dünya çok büyük. Boyut en fazla %s olabilir.",
	"mco.upload.failed.too_big.title": "Dünya çok büyük",
	...
	"mco.upload.select.world.subtitle": "Lütfen yüklemek için tek oyunculu bir dünya seçin",
	...
	"mco.version": "Sürüm: %s",
	"mco.warning": "Uyarı!",
	"mco.worldSlot.minigame": "Mini Oyun",
	"menu.custom_options": "Özel Ayarlar...",
	"menu.custom_options.title": "Özel Ayarlar",
	"menu.custom_options.tooltip": "Not: Özel ayarlar üçüncü-parti sunucular ve/veya içerik tarafından eklenir.\nDikkatli kullanın!",
	"menu.custom_screen_info.button_narration": "Bu bir özel ekran. Daha fazla öğren.",
	"menu.custom_screen_info.contents": "Bu ekranın içerikleri Mojang Studios veya Microsoft tarafından sahip olunmayan, gözetilmeyen ve yürütülmeyen üçüncü taraf sunucular veya haritalar tarafından kontrol edilmektedir.\n\nBağlantılara tıklarken dikkatli olun ve kişisel verilerinizi, giriş detaylarınız dâhil, asla vermeyin.\n\nEğer bu ekran oynamanızı engelliyorsa aşağıdaki düğme ile sunucudan bağlantınızı kesebilirsiniz.",
	"menu.custom_screen_info.disconnect": "Özel ekran reddedildi",
	"menu.custom_screen_info.title": "Özel ekranlarla ilgili not",
	"menu.custom_screen_info.tooltip": "Bu özel bir ekran. Daha fazla bilgi için tıklayın.",
	"menu.disconnect": "Bağlantıyı Kes",
	"menu.feedback": "Geri Bildirim...",
	"menu.feedback.title": "Geri Bildirim",
	"menu.game": "Oyun menüsü",
	"menu.modded": " (Modlu)",
	"menu.multiplayer": "Çok Oyunculu",
	"menu.multiplayerOptions.applyChanges": "Değişiklikleri Uygula",
	"menu.multiplayerOptions.button": "Çok Oyunculu...",
	"menu.multiplayerOptions.network": "Çok Oyunculu",
	"menu.multiplayerOptions.network.header": "Ağ",
	"menu.multiplayerOptions.network.lan": "Yerel Ağ",
	"menu.multiplayerOptions.network.lan.tooltip": "Aynı ağdaki oyuncular girebilir.",
	"menu.multiplayerOptions.network.off": "KAPALI",
	"menu.multiplayerOptions.network.off.tooltip": "Kimse giremez.",
	"menu.multiplayerOptions.network.online": "Çevrim içi",
	"menu.multiplayerOptions.network.online.tooltip": "Çevrim içi arkadaşlar girebilir.",
	"menu.multiplayerOptions.otherPlayers.header": "Diğer Oyuncular",
	"menu.multiplayerOptions.publish.started.lan": "Bu dünya artık yerel ağa açık. Port numarası %s",
	"menu.multiplayerOptions.publish.started.online": "Bu dünya artık çok oyunculuya açık. Port numarası %s",
	"menu.multiplayerOptions.publish.stopped": "Bu dünya artık çok oyunculuya açık değil",
	"menu.multiplayerOptions.title": "Çok Oyunculu Ayarları",
	...
	"menu.playerReporting.no_players": "Bu dünyada bildirilebilecek oyuncu yok",
	"menu.preparingSpawn": "Başlangıç alanı hazırlanıyor: %%%s",
	"menu.quick_actions": "Hızlı Eylemler…",
	"menu.quick_actions.title": "Hızlı Eylemler",
	...
	"menu.server_links": "Sunucu Adresleri...",
	"menu.server_links.title": "Sunucu Adresleri",
	...
	"multiplayer.codeOfConduct.check": "Bu Davranış Kurallarını tekrar gösterme",
	"multiplayer.codeOfConduct.title": "Sunucu Davranış Kuralları",
	"multiplayer.confirm_command.parse_errors": "Tanınmayan veya geçersiz bir komut yürütmeye çalışıyorsunuz.\nEmin misiniz?\nKomut: %s",
	"multiplayer.confirm_command.permissions_required": "Yüksek yetki gerektiren bir komut yürütmeye çalışıyorsunuz.\nBu oyununuzu kötü etkileyebilir.\nEmin misiniz?\nKomut: %s",
	"multiplayer.confirm_command.run_command": "Komutu Çalıştır",
	"multiplayer.confirm_command.signature_required": "Adınızda sohbet iletisi gönderecek bir komut yürütmeye çalışıyorsunuz.\nBu sadece sohbet ekranından çalıştırılabilir\nKomut: %s",
	"multiplayer.confirm_command.suggest_command": "Sohbeti Ekrana Kopyala",
	"multiplayer.confirm_command.title": "Komut Çalıştırılması Doğrulama",
	"multiplayer.disconnect.authservers_down": "Kimlik doğrulama sunucuları kapalı. Lütfen daha sonra tekrar deneyin. Üzgünüz!",
	"multiplayer.disconnect.bad_chat_index": "Sunucudan kaçırılmış veya yeniden sıralanmış sohbet iletisi algılandı",
	...
	"multiplayer.disconnect.banned.reason.default": "Bir yönetici tarafından sunucuya girmen yasaklandı.",
	...
	"multiplayer.disconnect.code_of_conduct": "Sunucu, Davranış Kurallarını kabul etmeyi gerektirmektedir",
	"multiplayer.disconnect.configuration_error": "Yapılandırmada beklenmeyen hata oluştu",
	...
	"multiplayer.disconnect.invalid_public_key_signature.new": "Profil açık anahtarı için geçersiz imza.\nOyununuzu yeniden başlatmayı deneyin.",
	...
	"multiplayer.disconnect.missing_tags": "Sunucudan eksik etiket listesi alındı.\nLütfen bir sunucu yöneticisiyle irtibata geçin.",
	...
	"multiplayer.disconnect.transfers_disabled": "Bu sunucu aktarımları kabul etmiyor",
	...
	"multiplayer.message_not_delivered": "Sohbet mesajı gönderilemedi, sunucu kayıtlarını kontrol edin: %s",
	...
	"multiplayer.status.anonymous_player": "Anonim Oyuncu",
	...
	"multiplayerWarning.message": "Dikkat: Çevrim içi oyunlar hiçbir şekilde Mojang Studios veya Microsoft tarafından denetlenmemektedir. Çevrim içi oyun sırasında farklı oyuncular tarafından oluşturulmuş herkes için uygun olmayan içerik ve iletilerle karşılaşabilirsiniz.",
	...
	"narration.checkbox.usage.focused.check": "Seçmek için Enter tuşuna basın",
	"narration.checkbox.usage.focused.uncheck": "Seçiminizi kaldırmak için Enter'a basın",
	"narration.checkbox.usage.hovered": "Açmak için sol tıklayın",
	"narration.checkbox.usage.hovered.check": "Seçmek için sol tıklayın",
	"narration.checkbox.usage.hovered.uncheck": "Seçiminizi kaldırmak için sol tıklayın",
	"narration.component_list.usage": "Sonraki ögeye geçmek için Tab tuşuna basın",
	...
	"narration.item": "Eşya: %s",
	"narration.link.usage.focused": "Bağlantıyı takip etmek için Enter tuşuna basın",
	"narration.link.usage.hovered": "Bağlantıyı takip etmek için sol tıklayın",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Çubuğun değerini değiştirmek için Enter tuşuna basın",
	"narration.slider.usage.hovered": "Değeri değiştirmek için çubuğu kaydırın",
	"narration.suggestion": "%[2]s öneriden %[1]s. seçildi: %[3]s",
	"narration.suggestion.tooltip": "%[2]s öneriden %[1]s. seçildi: %[3]s (%[4]s)",
	"narration.suggestion.usage.cycle.fixed": "Sonraki öneriye geçmek için Tab tuşuna basın",
	"narration.suggestion.usage.cycle.hidable": "Sonraki öneriye geçmek için Tab tuşuna basın, önerilerden çıkmak için ise Escape tuşuna basın",
	"narration.suggestion.usage.fill.fixed": "Öneriyi kullanmak için Tab tuşuna basın",
	"narration.suggestion.usage.fill.hidable": "Öneriyi kabul etmek ve kullanmak için Tab tuşuna basın, önerilerden çıkmak için Escape tuşuna basın",
	...
	"narrator.position.object_list": "Seçilen satır ögesi %s/%s",
	"narrator.position.screen": "Ekran ögesi %s/%s",
	"narrator.position.tab": "Sekme %s/%s seçildi",
	"narrator.ready_to_play": "Oynamaya Hazır",
	"narrator.screen.title": "Ana Menü",
	"narrator.screen.usage": "Öge seçmek için fare imlecini veya Tab tuşunu kullanın",
	"narrator.select": "Seçili: %s",
	"narrator.select.world": "%s seçildi, en son oynama: %s, %s, %s, sürüm: %s",
	"narrator.select.world_info": "Seçilen %s, son oynanma: %s, %s",
	...
	"optimizeWorld.confirm.proceed": "Yedek Oluştur ve İyileştir",
	"optimizeWorld.confirm.title": "Dünyayı Akıcı Duruma Getir",
	...
	"optimizeWorld.stage.finished.chunks": "Yığınların güncellenmesi tamamlanıyor…",
	"optimizeWorld.stage.finished.entities": "Varlıkların güncellenmesi tamamlanıyor...",
	"optimizeWorld.stage.finished.poi": "İlgi çekici noktaların güncellenmesi tamamlanıyor...",
	"optimizeWorld.stage.upgrading": "Tüm yığınlar güncelleniyor…",
	"optimizeWorld.stage.upgrading.chunks": "Tüm yığınlar güncelleniyor…",
	"optimizeWorld.stage.upgrading.entities": "Tüm varlıklar güncelleniyor...",
	"optimizeWorld.stage.upgrading.poi": "Tüm ilgi çekici noktalar güncelleniyor...",
	"optimizeWorld.title": "Dünya: '%s' akıcı hale getiriliyor",
	"options.accessibility": "Erişilebilirlik Ayarları...",
	"options.accessibility.high_contrast": "Yüksek Karşıtlık",
	"options.accessibility.high_contrast.error.tooltip": "Yüksek Kontrast kaynak paketi mevcut değil.",
	"options.accessibility.high_contrast.tooltip": "Arayüz ögelerinin kontrastını arttırır.",
	"options.accessibility.high_contrast_block_outline": "Yüksek Kontrast Blok Vurguları",
	"options.accessibility.high_contrast_block_outline.tooltip": "Hedef alınan bloğun vurgu kontrastını iyileştirir.",
	"options.accessibility.link": "Erişilebilirlik Kılavuzu",
	"options.accessibility.menu_background_blurriness": "Menü Arka Plan Bulanıklığı",
	"options.accessibility.menu_background_blurriness.tooltip": "Menü arka planlarının bulanıklığını değiştirir.",
	"options.accessibility.narrator_hotkey": "Ekran Okuyucu Kısayolu",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Metin Okuyucunun ’Cmd+B’ ile açılıp kapatılmasına izin verir.",
	"options.accessibility.narrator_hotkey.tooltip": "Metin Okuyucunun ’Ctrl+B’ ile açılıp kapatılabilmesine izin verir.",
	...
	"options.accessibility.tooltip": "Erişilebilirlik Ayarları",
	"options.allowCursorChanges": "İmleç Değişikliklerine İzin Ver",
	"options.allowCursorChanges.tooltip": "Fare imlecinin belirli arayüz ögeleri üzerinde şekil değiştirmesine izin verir.",
	"options.allowFriendRequests": "İsteklere İzin Ver",
	"options.allowFriendRequests.tooltip": "Diğerlerinin sana arkadaşlık isteği göndermesine izin ver",
	...
	"options.chat": "Sohbet Ayarları...",
	"options.chat.color": "Renkler",
	"options.chat.delay": "Sohbet Gecikmesi: %s saniye",
	"options.chat.delay_none": "Sohbet Gecikmesi: Yok",
	"options.chat.drafts": "Gönderilmemiş Mesajları Kaydet",
	"options.chat.drafts.tooltip": "Gönderilmemiş mesajlar kaydedilir ve sohbet tekrar açıldığında gönderilebilirler.",
	...
	"options.chunkFade": "Yığın Belirme Süresi",
	"options.chunkFade.none": "Yığın Belirmesi: Kapalı",
	"options.chunkFade.seconds": "Yığın Belirmesi: %s saniye",
	"options.chunkFade.tooltip": "Yığınlar ilk oluştuklarında kaç saniyede belirmeli, eğer belireceklerse.",
	"options.chunks": "%s Yığın",
	"options.clouds.fancy": "Şahane",
	"options.clouds.fast": "Hızlı",
	"options.controls": "Kontroller...",
	"options.credits_and_attribution": "Katkıda Bulunanlar ve Atıflar...",
	"options.cutoutLeaves": "Arasından Bakmalı Yapraklar",
	"options.cutoutLeaves.tooltip": "Yaprakların arasındaki boşluklardan görmeyi sağlar. Kapatmak performansı arttırır.",
	...
	"options.difficulty.easy.info": "Saldırgan canlılar oluşur ama daha az hasar verir. Açlık çubuğu tükenir ve sağlığı 5 kalbe kadar boşaltır.",
	"options.difficulty.hard": "Zor",
	"options.difficulty.hard.info": "Saldırgan canlılar oluşur ve daha fazla hasar verir. Açlık çubuğu tükenir ve tüm sağlığı boşaltır.",
	"options.difficulty.hardcore": "Zorlayıcı",
	"options.difficulty.normal": "Normal",
	"options.difficulty.normal.info": "Saldırgan canlılar oluşur ve normal hasar verir. Açlık çubuğu tükenir ve sağlığı yarım kalbe kadar boşaltır.",
	"options.difficulty.online": "Sunucu Zorluğu",
	"options.difficulty.peaceful": "Barışçıl",
	"options.difficulty.peaceful.info": "Saldırgan canlılar oluşmaz ve sadece bazı tarafsız canlılar oluşur. Açlık çubuğu tükenmez ve sağlık zamanla yenilenir.",
	"options.directionalAudio": "Yönlü Ses",
	"options.directionalAudio.off.tooltip": "Klasik Stereo ses.",
	...
	"options.exclusiveFullscreen": "Tam Ekrana Özel",
	"options.exclusiveFullscreen.warningTooltip": "Bu ayar bazı girdi yöntemlerinin çalışmasını engelleyebilir.",
	"options.font": "Yazı Tipi Ayarları...",
	"options.font.title": "Yazı Tipi Ayarları",
	...
	"options.fovEffectScale.tooltip": "Görüş alanının oynanış etkileriyle ne kadar değişebileceğini kontrol eder.",
	"options.framerate": "%s fps",
	"options.framerateLimit": "En Fazla Kare Hızı",
	"options.framerateLimit.max": "Sınırsız",
	"options.friendsList": "Arkadaş Listesi",
	"options.friendsList.confirm.message": "Arkadaş Listesi \"Xbox dışında sohbet edebilir\" ayarı \"Arkadaşlar\"a ayarlıyken kimle sohbet edebileceğini kontrol eder.\n\nBu ayarı Microsoft hesabınla düzenleyebilirsin.\n\nArkadaş Listesi AÇIKKEN diğer oyuncular sana arkadaşlık isteği gönderebilir. Arkadaşlık isteklerini veya Arkadaş Listesini herhangi zaman kapatabilirsin.",
	"options.friendsList.confirm.message.link": "Microsoft hesabı",
	"options.friendsList.confirm.title": "Arkadaş Listesini AÇ?",
	"options.friendsList.confirm.turnOff": "KAPA",
	"options.friendsList.confirm.turnOn": "AÇ",
	...
	"options.graphics.preset": "Hazır Ayar",
	"options.graphics.preset.tooltip": "\"Kalite & Performans\" ayarlarını istenilen kaliteye göre makul varsayılanlara ayarlar.",
	"options.graphics.warning.accept": "Destek olmadan devam et",
	"options.graphics.warning.cancel": "Beni Geri Götür",
	"options.graphics.warning.message": "Görüntüleme aygıtınız, %s grafik ayarları için desteklenmiyor olarak saptandı.\n\nBunu görmezden gelip devam edebilirsiniz ancak %s grafik ayarlarını kullanmayı seçerseniz aygıtınız için destek sağlanmayacaktır.",
	...
	"options.graphicsApi": "Grafik API'ı",
	"options.graphicsApi.default": "Varsayılan",
	"options.graphicsApi.opengl": "OpenGL'i Tercih Et",
	"options.graphicsApi.restart": "Grafik API'ını değiştirmek için oyunu yeniden başlatmalısınız.",
	"options.graphicsApi.tooltip": "Görüntü işlemesi için kullanılacak grafik API'ı. Bunu değiştirmeniz için özel bir nedeniniz yoksa Varsayılan olarak bırakın! Oyunu bir sonraki sefer başlattığınızda geçerli olacaktır.",
	"options.graphicsApi.tooltip.vulkan": "Deneysel. Bazı sistemlerde performans düşüşüne yol açabilir veya sistemin kararsız çalışmasına neden olabilir.",
	"options.graphicsApi.vulkan": "Vulkan'ı Tercih Et",
	"options.guiScale": "Arayüz Ölçeği",
	"options.guiScale.auto": "Otomatik",
	"options.hidden": "Gizli",
	"options.hideLightningFlashes": "Gök Işımalarını Gizle",
	"options.hideLightningFlashes.tooltip": "Yıldırımların veya diğer çevresel efektlerin gökyüzünü parlatmasını engeller. Işıkların kaynakları yine de görünecektir.",
	...
	"options.hideSplashTexts": "Logo Altındaki Metinleri Gizle",
	"options.hideSplashTexts.tooltip": "Ana menüdeki sarı yapıştırma metinlerini gizler.",
	"options.improvedTransparency": "Geliştirilmiş Şeffaflık",
	"options.improvedTransparency.tooltip": "Hava durumunu, bulutları ve parçacıkları şeffaf bloklar ve su arkasına çizmek için ekran gölgelendirmeleri kullanan deneysel bir yaklaşım.\nGPU performansını etkiler.",
	"options.inGameNotification": "Oyun-içi Bildirimler",
	"options.inGameNotification.tooltip": "Oyun içinde Arkadaş bildirimlerini göster",
	"options.inactivityFpsLimit": "Kare hızı düşürülsün",
	"options.inactivityFpsLimit.afk": "Klavye başında değilken",
	"options.inactivityFpsLimit.afk.tooltip": "Oyun bir dakikadan fazla bir süre boyunca oyuncu girdisi almazsa kare hızını 30’a sınırlar.\nBu durum 9 dakika daha sürerse kare hızı 10’a sınırlanır.",
	"options.inactivityFpsLimit.minimized": "Arka plana alındığında",
	"options.inactivityFpsLimit.minimized.tooltip": "Kare hızını sadece oyun penceresi küçültülmüşken sınırlar.",
	"options.invertMouse": "Ters Fare Kontrolleri",
	"options.invertMouseX": "Fare X Eksenini Ters Çevir",
	"options.invertMouseY": "Fare Y Eksenini Ters Çevir",
	"options.japaneseGlyphVariants": "Japon Glif Çeşitleri",
	"options.japaneseGlyphVariants.tooltip": "Varsayılan yazı tipinde CJK karakterlerinin Japonca çeşitlerini kullanır.",
	"options.key.hold": "Basılı tut",
	"options.key.toggle": "Aç/Kapat",
	"options.language": "Dil...",
	"options.language.narration": "Dili Değiştir",
	"options.language.title": "Dil",
	"options.language.tooltip": "Dili Değiştir",
	"options.languageAccuracyWarning": "(Çeviriler %%100 doğru olmayabilir)",
	...
	"options.maxAnisotropy": "Eşyönsüz Süzme",
	"options.maxAnisotropy.tooltip": "Her seviye, düz dokuların görünümünü önemli ölçüde iyileştirir ancak performansı ve önemli ölçüde video belleği kullanımını etkiler. Doku Süzmesi'nin Eşyönsüz olarak ayarlanması gerekir.",
	...
	"options.modelPart.left_pants_leg": "Pantolonun Sol Bacağı",
	"options.modelPart.left_sleeve": "Sol Kol",
	"options.modelPart.right_pants_leg": "Pantolonun Sağ Bacağı",
	...
	"options.musicToast": "Müzik Bildirimi",
	"options.musicToast.never": "Asla",
	"options.musicToast.never.tooltip": "Müzik bildirimleri gösterilmez.",
	"options.musicToast.pauseMenu": "Duraklatma Menüsü",
	"options.musicToast.pauseMenu.tooltip": "Müzik çalarken müzik bildirimi duraklatma menüsünde sürekli gösterilir.",
	"options.musicToast.pauseMenuAndToast": "Duraklatma Menüsü ve Bildirim",
	"options.musicToast.pauseMenuAndToast.tooltip": "Müzik çalmaya başladığında bildirim gösterilir. Aynı bildirim duraklatma menüsünde sürekli gösterilir.",
	"options.music_frequency": "Müzik Sıklığı",
	"options.music_frequency.constant": "Sürekli",
	"options.music_frequency.default": "Varsayılan",
	"options.music_frequency.frequent": "Sık",
	"options.music_frequency.tooltip": "Oyun dünyasındayken müziğin ne sıklıkla çalacağını değiştirir.",
	...
	"options.needsRestart": "Ayar, yeniden başlatıldıktan sonra uygulanacak.",
	...
	"options.online.friends.header": "Arkadaş Listesi",
	"options.online.realms.header": "Realms",
	"options.online.servers.header": "Sunucular",
	"options.online.title": "Çevrim içi Seçenekleri",
	"options.online.xboxSettings": "Xbox Ayarları...",
	...
	"options.realmsNotifications.button": "Haberler & Davetler",
	"options.realmsNotifications.tooltip": "Ana ekrana Realms haberlerini ve davetlerini getirir ayrıca Realms düğmesinde ilgili simgeyi görüntüler.",
	"options.reducedDebugInfo": "Hata Ayıklamayı Azalt",
	"options.renderClouds": "Bulutlar",
	"options.renderCloudsDistance": "Bulut Mesafesi",
	"options.renderDistance": "Görüş Mesafesi",
	"options.resourcepack": "Kaynak Paketleri...",
	"options.restartRequired": "Bazı değişikliklerin uygulanması için oyunun yeniden başlatılması gerekiyor.",
	"options.rotateWithMinecart": "Vagonlarla dön",
	"options.rotateWithMinecart.tooltip": "Dönen bir Vagonda oyuncunun bakış açısının dönüp dönmemesi. Sadece ’Vagon Geliştirmeleri’ deneysel ayarları açık olan dünyalarda kullanılabilir.",
	"options.screenEffectScale": "Çarpıtma Efektleri",
	"options.screenEffectScale.tooltip": "Bulantı ve Nether portalı ekran çarpıtma efekt şiddetleri.\nDüşük seviyelerde bulantı efekti yerini yeşil bir önyüze bırakır.",
	"options.sensitivity": "Hassasiyet",
	"options.sensitivity.max": "YÜKSEK HIZ!!!",
	"options.sensitivity.min": "*esneme*",
	"options.sharePresence": "Durum",
	"options.sharePresence.all": "Tam",
	"options.sharePresence.all.tooltip": "Durum arkadaşlarınla paylaşılır. Çevrim içi görünürsün ve ne yaptığın paylaşılır.",
	"options.sharePresence.limited": "Limitli",
	"options.sharePresence.limited.tooltip": "Durum sınırlı paylaşılır. Çevrim içi görünürsün ama ne yaptığın paylaşılmaz. Arkadaşlarını oyununa davet edebilirsin.",
	"options.sharePresence.none": "Hiçbiri",
	"options.sharePresence.none.tooltip": "Hiç bir durum paylaşılmaz. Çevrim dışı görünürsün.",
	"options.showNowPlayingToast": "Müzik Bildirimini Göster",
	"options.showNowPlayingToast.tooltip": "Herhangi bir şarkı çalmaya başladığında bildirim gösterilir. Aynı bildirim şarkı çalarken oyun içi duraklatma menüsünde sürekli gösterilir.",
	"options.showSubtitles": "Alt Yazılar",
	"options.showSubtitles.tooltip": "Oyun içi sesler için alt yazıyı etkinleştirir.",
	"options.simulationDistance": "Simülasyon Mesafesi",
	...
	"options.sprintWindow": "Koşma Zaman Aralığı",
	"options.sprintWindow.tooltip": "Birim zaman formatında ileri tuşuna çift-basmanın koşmayı etkinleştirdiği zaman aralığı.",
	...
	"options.telemetry.disabled": "Telemetri kapalı.",
	"options.telemetry.state.all": "Tümü",
	"options.telemetry.state.minimal": "En az",
	"options.telemetry.state.none": "Hiç",
	"options.textureFiltering": "Doku Filtreleme",
	"options.textureFiltering.anisotropic": "Eşyönsüz",
	"options.textureFiltering.anisotropic.tooltip": "Donanım-tabanlı bir süzme yöntemidir ancak performansı ve video belleği kullanımını önemli ölçüde etkiler. Tüm donanımlarda desteklenmeyebilir.",
	"options.textureFiltering.none": "Yok",
	"options.textureFiltering.none.tooltip": "Dokular herhangi bir süzme olmadan görüntülenir. Bloklar açılı olarak bakıldığında bulanık görünebilir.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling/Döndürülmüş Izgara Süper Örneklemesi)\nOrta düzeyde performans etkisiyle doku kalitesini arttıran gölgelendirici-tabanlı bir süzme yöntemi.",
	"options.title": "Ayarlar",
	"options.touchscreen": "Dokunmatik Ekran Modu",
	"options.value": "%s",
	"options.video": "Görüntü Ayarları...",
	"options.video.display.header": "Görüntü",
	"options.video.interface.header": "Arayüz",
	"options.video.preferences.header": "Tercihler",
	"options.video.quality.header": "Kalite & Performans",
	"options.videoTitle": "Görüntü Ayarları",
	"options.viewBobbing": "Sarsılmayı Göster",
	"options.vignette": "Vinyeti Göster",
	"options.vignette.tooltip": "Ekranın kenarlarına doğru parlaklığı azaltmak ve dünya sınırı uyarısı için kullanılan oyun ekranı üzerinde göze çarpmayan bir doku.",
	"options.visible": "Göster",
	"options.vsync": "Dikey Senkronizasyon",
	"options.weatherRadius": "Hava Durumu Etkisi Yarıçapı",
	"options.weatherRadius.tooltip": "Yağmur ve kar etkilerinin görülebilir olduğu yarıçap. Performansı çok az etkiler.",
	"options.worldOptions.button": "Dünya Seçenekleri...",
	"options.worldOptions.title": "Dünya Seçenekleri",
	"outOfMemory.message": "Minecraft’ın belleği tükendi.\n\nBu, oyundaki bir hatadan veya Java Sanal Makinesine yeterli bellek atanmamasından kaynaklanmış olabilir.\n\nDünya bozulmasını önlemek için geçerli oyun kapatıldı. Ana menüye geri dönüp oynamayı sürdürebilmeniz için yeterli bellek boşaltmaya çalıştık ancak işe yaramamış olabilir.\n\nBu iletiyi tekrar görürseniz lütfen oyunu yeniden başlatın.",
	...
	"pack.dropRejected.message": "Aşağıdaki girdiler geçerli paketlerden değildi ve kopyalanmadı:\n %s",
	"pack.dropRejected.title": "Paketsiz girdiler",
	...
	"pack.incompatible.confirm.unknown": "Bu paket bozuk veya bilinmeyen bir Minecraft sürümü için yapılmış ve doğru çalışmayabilir.",
	...
	"pack.incompatible.unknown": "(Bozuk veya uyumsuz)",
	"pack.nameAndSource": "%s (%s)",
	"pack.openFolder": "Paket Klasörünü Aç",
	"pack.selected.title": "Seçili",
	"pack.source.builtin": "dâhilî",
	...
	"painting.minecraft.fern.title": "Eğrelti Otu",
	...
	"painting.minecraft.humble.title": "Mütevazı",
	...
	"painting.minecraft.orb.title": "Küre",
	...
	"painting.minecraft.pond.title": "Gölet",
	...
	"particle.invalidOptions": "Parçacık seçenekleri ayrıştırılamadı: %s",
	...
	"predicate.unknown": "Bilinmeyen koşul: %s",
	"quickplay.error.invalid_identifier": "Sağlanan kimliğe sahip bir dünya bulunamadı",
	"quickplay.error.realm_connect": "Realm’e bağlanılamadı",
	"quickplay.error.realm_permission": "Bu Realm’e katılmak için gerekli yetkiniz yok",
	"quickplay.error.title": "Hızlı Oynatılamadı",
	"realms.configuration.region.australia_east": "Yeni Güney Galler, Avustralya",
	"realms.configuration.region.australia_southeast": "Victoria, Avustralya",
	"realms.configuration.region.brazil_south": "Brezilya",
	"realms.configuration.region.central_india": "Hindistan",
	"realms.configuration.region.central_us": "Iowa, ABD",
	"realms.configuration.region.east_asia": "Hong Kong",
	"realms.configuration.region.east_us": "Virginia, ABD",
	"realms.configuration.region.east_us_2": "Kuzey Karolina, ABD",
	"realms.configuration.region.france_central": "Fransa",
	"realms.configuration.region.japan_east": "Doğu Japonya",
	"realms.configuration.region.japan_west": "Batı Japonya",
	"realms.configuration.region.korea_central": "Güney Kore",
	"realms.configuration.region.north_central_us": "Illinois, ABD",
	"realms.configuration.region.north_europe": "İrlanda",
	"realms.configuration.region.south_central_us": "Teksas, ABD",
	"realms.configuration.region.southeast_asia": "Singapur",
	"realms.configuration.region.sweden_central": "İşveç",
	"realms.configuration.region.uae_north": "Birleşik Arap Emirlikleri (BAE)",
	"realms.configuration.region.uk_south": "Güney İngiltere",
	"realms.configuration.region.west_central_us": "Utah, ABD",
	"realms.configuration.region.west_europe": "Hollanda",
	"realms.configuration.region.west_us": "Kaliforniya, ABD",
	"realms.configuration.region.west_us_2": "Washington, ABD",
	"realms.configuration.region_preference.automatic_owner": "Otomatik (Realm sahibi gecikmesi)",
	"realms.configuration.region_preference.automatic_player": "Otomatik (ilk katılan)",
	...
	"recipe.toast.title": "Yeni Tarif(ler) Açıldı!",
	"record.nowPlaying": "Şimdi Çalan: %s",
	"recover_world.bug_tracker": "Hata Bildirin",
	"recover_world.button": "Kurtarma Girişimi",
	"recover_world.done.failed": "Önceki durumdan kurtarma başarısız.",
	"recover_world.done.success": "Kurtarma başarılı!",
	"recover_world.done.title": "Kurtarma tamamlandı",
	"recover_world.issue.missing_file": "Eksik dosya",
	"recover_world.issue.none": "Sorun yok",
	"recover_world.message": "“%s” dünya klasörü okunurken hatalar oluştu.\nEski bir halinden dünyayı onarabilir veya bug tracker üzerinden hatayı bildirebilirsiniz.",
	"recover_world.no_fallback": "Kurtarılma yapılacak bir durum mevcut değil",
	"recover_world.restore": "Onarmaya Çalış",
	"recover_world.restoring": "Dünya onarılıyor...",
	"recover_world.state_entry": "%s kaynaklı durum: ",
	"recover_world.state_entry.unknown": "bilinmeyen",
	"recover_world.title": "Dünya yüklemesi başarısız",
	"recover_world.warning": "Dünya özeti yüklemesi başarısız",
	"resourcePack.broken_assets": "BOZUK DOSYALAR TESPİT EDİLDİ",
	"resourcePack.high_contrast.name": "Yüksek Karşıtlık",
	"resourcePack.load_fail": "Kaynak yeniden yükleme başarısız oldu",
	"resourcePack.programmer_art.name": "Programcı Sanatı",
	"resourcePack.runtime_failure": "Kaynak paketi hatası saptandı",
	...
	"restrictions_screen.button": "Sınırlamalar...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Oyunculardan mesaj alabilirsiniz",
	"restrictions_screen.permission.receive_player_messages.denied": "Oyunculardan mesaj alamazsınız",
	"restrictions_screen.permission.receive_system_messages.allowed": "Sunucudan sistem mesajı alabilirsiniz",
	"restrictions_screen.permission.receive_system_messages.denied": "Sunucudan sistem mesajı alamazsınız",
	"restrictions_screen.permission.send_commands.allowed": "Komut gönderebilirsiniz",
	"restrictions_screen.permission.send_commands.denied": "Komut gönderemezsiniz",
	"restrictions_screen.permission.send_messages.allowed": "Sohbet mesajı gönderebilirsiniz",
	"restrictions_screen.permission.send_messages.denied": "Sohbet mesajı gönderemezsiniz",
	"restrictions_screen.title": "Sınırlamalar",
	...
	"selectWorld.allowCommands.new": "Komutlara İzin Ver",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Dünyayı güncellemeden önce yedekleyin?",
	"selectWorld.backupQuestion.snapshot": "Bu dünyayı yüklemek istediğinizden emin misiniz?",
	"selectWorld.backupWarning.customized": "Maalesef, özelleştirilmiş dünyaları Minecraft’ın bu sürümünde desteklemiyoruz. Bu dünyayı hâlâ yükleyebilir ve her şeyi olduğu gibi tutabiliriz ancak yeni oluşturulan araziler özelleştirilmiş olmayacak. Rahatsızlıktan dolayı özür dileriz.",
	"selectWorld.backupWarning.downgrade": "Bu dünya en son %s versiyonunda oynandı; siz %s versiyonundasınız. Bir dünyanın sürümünü düşürmek dünya üzerinde bozulmalara neden olur - yüklenmesine veya çalışmasına garanti veremeyiz. Eğer hâlâ devam etmek istiyorsanız, dünyanın bir yedeğini alın!",
	...
	"selectWorld.backupWarning.file_fixing_required": "Bu dünyanın oynamadan önce güncellenmesi gerekiyor. Lütfen dünyanın bozulma olasılığına karşın dünyanızı yedekleyin.",
	"selectWorld.backupWarning.snapshot": "Bu dünya en son %s sürümünde oynanmış ama %s sürümündesiniz. Lütfen dünyanın bozulma olasılığına karşın dünyanızı yedekleyin.",
	"selectWorld.bonusItems": "Bonus Sandık",
	"selectWorld.cheats": "Hileler",
	"selectWorld.commands": "Komutlar",
	...
	"selectWorld.edit.export_worldgen_settings": "Dünya Oluşum Ayarlarını Dışa Aktar",
	...
	"selectWorld.experimental.message": "Dikkatli ol!\nBu yapılandırma hâlâ geliştirilmekte olan bir özelliği gerektirir. Dünyanız çökebilir, bozulabilir, veya gelecek güncellemeler ile çalışmayabilir.",
	...
	"selectWorld.gameMode.survival.info": "Bir şeyler inşa ettiğiniz, topladığınız, ürettiğiniz ve canavarlara savaştığınız gizemli bir dünyayı keşfedin.",
	...
	"selectWorld.incompatible.description": "Bu dünya bu sürümde açılamaz.\nEn son %s sürümünde oynanmıştır.",
	"selectWorld.incompatible.info": "Uyumsuz sürüm: %s",
	"selectWorld.incompatible.title": "Uyumsuz sürüm",
	"selectWorld.incompatible.tooltip": "Bu dünya açılamıyor çünkü uyumsuz bir sürümle yaratılmıştır.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Dünya formatına yapılan altyapısal değişiklerden dolayı dünyayı düzenlemeden önce, dünyayı en yeni sürüme güncellemen gerekiyor.",
	"selectWorld.requiresFileFixingTooltip.play": "Dünya formatına yapılan altyapısal değişiklerden dolayı dünyayı oynamadan önce, dünyayı en yeni sürüme güncellemen gerekiyor.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Dünya formatına yapılan altyapısal değişiklerden dolayı dünyayı tekrar oluşturmadan önce, dünyayı en yeni sürüme güncellemen gerekiyor.",
	"selectWorld.resource_load": "Kaynaklar Hazırlanıyor...",
	...
	"selectWorld.upgrade_and_play": "Güncelle ve Oyna",
	...
	"selectWorld.waitingForBackup.message": "Dünyanızın boyutuna göre bu bir süre sürebilir. Lütfen oyunu veya cihazınızı kapatmayın.",
	"selectWorld.waitingForBackup.title": "Yedek Oluşturuluyor",
	...
	"selectWorld.warning.lowDiskSpace.description": "Cihazınızda fazla yer kalmadı.\nOyun sırasında disk alanının tükenmesi dünyanızın zarar görmesine neden olabilir.",
	"selectWorld.warning.lowDiskSpace.title": "Uyarı! Düşük disk alanı!",
	"selectWorld.world": "Dünya",
	"selectWorld.world_gen_settings_access": "Dünya oluşumu ayarları dosyası okunamıyor veya erişilemiyor! %s",
	"selecteWorld.backupRequiredTooltip": "Dünyayı yüklemek için yedek oluşturmanız gerek",
	...
	"slot.only_single_allowed": "Yalnızca tek slotlara izin veriliyor, '%s' bulundu",
	"slot.unknown": "Bilinmeyen yuva '%s'",
	"snbt.parser.empty_key": "Anahtar boş olamaz",
	"snbt.parser.expected_binary_numeral": "Binary sayı bekleniyor",
	"snbt.parser.expected_decimal_numeral": "Ondalık sayı bekleniyor",
	"snbt.parser.expected_float_type": "Kayan noktalı sayı bekleniyor",
	"snbt.parser.expected_hex_escape": "%s uzunluğunda karakter bilgisi bekleniyor",
	"snbt.parser.expected_hex_numeral": "Hexadecimal sayı bekleniyor",
	"snbt.parser.expected_integer_type": "Tam sayı bekleniyor",
	"snbt.parser.expected_non_negative_number": "Negatif olmayan sayı bekleniyor",
	"snbt.parser.expected_number_or_boolean": "Sayı veya mantıksal değer bekleniyor",
	"snbt.parser.expected_string_uuid": "Geçerli UUID temsil eden dizgi bekleniyor",
	"snbt.parser.expected_unquoted_string": "Tırnağa alınmamış geçerli dizgi bekleniyor",
	"snbt.parser.infinity_not_allowed": "Sınırlı olmayan sayılara izin verilmiyor",
	"snbt.parser.invalid_array_element_type": "Geçersiz dizilim öge türü",
	"snbt.parser.invalid_character_name": "Geçersiz Unicode karakter adı",
	"snbt.parser.invalid_codepoint": "Geçersiz Unicode karakter değeri: %s",
	"snbt.parser.invalid_string_contents": "Geçersiz dizgi içeriği",
	"snbt.parser.invalid_unquoted_start": "Tırnağa alınmamış dizgiler 0-9 rakamları, + veya - ile başlayamaz",
	"snbt.parser.leading_zero_not_allowed": "Ondalık sayılar 0 ile başlayamaz",
	"snbt.parser.no_such_operation": "Böyle bir işlem bulunmuyor: %s",
	"snbt.parser.number_parse_failure": "Sayı ayrıştırma başarısız oldu: %s",
	"snbt.parser.undescore_not_allowed": "Altı çizili karakterlere sayının başı veya sonunda izin verilmez",
	"soundCategory.ambient": "Çevresel",
	"soundCategory.block": "Bloklar",
	"soundCategory.hostile": "Saldırgan Canlılar",
	...
	"soundCategory.ui": "Arayüz",
	"soundCategory.voice": "Metin Okuyucu/Konuşma",
	...
	"stat.minecraft.happy_ghast_one_cm": "Mutlu Ghastla Alınan Yol",
	...
	"stat.minecraft.interact_with_brewingstand": "İksir Tezgâhı ile etkileşimler",
	...
	"stat.minecraft.interact_with_loom": "Dokuma Tezgâhı ile etkileşimler",
	...
	"stat.minecraft.nautilus_one_cm": "Notilusla Alınan Yol",
	"stat.minecraft.open_barrel": "Açılan Fıçılar",
	"stat.minecraft.open_chest": "Açılan Sandıklar",
	"stat.minecraft.open_enderchest": "Açılan Ender Sandıkları",
	...
	"structure_block.include_entities": "Varlıkları Dâhil Et:",
	...
	"structure_block.mode_info.corner": "Köşe Modu - Konum ve boyut işaretleyici",
	"structure_block.mode_info.data": "Veri Modu - Oyun mantığı işaretleyici",
	"structure_block.mode_info.load": "Yükleme Modu - Dosyadan yükle",
	"structure_block.mode_info.save": "Kayıt Modu - Dosyaya yaz",
	...
	"subtitles.block.brewing_stand.brew": "İksir Tezgâhı köpürüyor",
	...
	"subtitles.block.candle.extinguish": "Mum söndü",
	...
	"subtitles.block.copper_bulb.turn_off": "Bakır Ampul kapandı",
	"subtitles.block.copper_bulb.turn_on": "Bakır Ampul açıldı",
	"subtitles.block.copper_chest.close": "Sandık kapandı",
	"subtitles.block.copper_chest.open": "Sandık açıldı",
	"subtitles.block.copper_trapdoor.close": "Tuzak Kapısı kapandı",
	"subtitles.block.copper_trapdoor.open": "Tuzak Kapısı açıldı",
	"subtitles.block.crafter.craft": "Üretici üretti",
	"subtitles.block.crafter.fail": "Üretici üretemedi",
	"subtitles.block.creaking_heart.hurt": "Gıcırtı Kalbi homurdanıyor",
	"subtitles.block.creaking_heart.idle": "Ürpertici ses",
	"subtitles.block.creaking_heart.spawn": "Gıcırtı Kalbi uyandı",
	"subtitles.block.deadbush.idle": "Kuru sesler",
	"subtitles.block.decorated_pot.insert": "Süslü Çömlek dolduruldu",
	"subtitles.block.decorated_pot.insert_fail": "Süslü Çömlek titredi",
	"subtitles.block.decorated_pot.shatter": "Süslü Çömlek parçalandı",
	...
	"subtitles.block.dried_ghast.ambient": "Kuru sesler",
	"subtitles.block.dried_ghast.ambient_water": "Kurumuş Ghast tekrar nemlendi",
	"subtitles.block.dried_ghast.place_in_water": "Kurumuş Ghast ıslandı",
	"subtitles.block.dried_ghast.transition": "Kurumuş Ghast daha iyi hissediyor",
	"subtitles.block.dry_grass.ambient": "Rüzgâr sesleri",
	...
	"subtitles.block.eyeblossom.close": "Göz Çiçeği kapandı",
	"subtitles.block.eyeblossom.idle": "Göz Çiçeği fısıldadı",
	"subtitles.block.eyeblossom.open": "Göz Çiçeği açıldı",
	...
	"subtitles.block.firefly_bush.idle": "Ateş Böcekleri vızıldıyor",
	...
	"subtitles.block.generic.fall": "Bir şey bloğa düştü",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Tabela titredi",
	...
	"subtitles.block.pale_hanging_moss.idle": "Ürpertici ses",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Sülfür kaynağı püskürüyor",
	"subtitles.block.potent_sulfur.noxious_gas": "Bulandırıcı gaz beliriyor",
	...
	"subtitles.block.respawn_anchor.ambient": "Diriltici Vızıldıyor",
	"subtitles.block.respawn_anchor.charge": "Diriltici yüklendi",
	"subtitles.block.respawn_anchor.deplete": "Diriltici tükeniyor",
	"subtitles.block.respawn_anchor.set_spawn": "Diriltici yeniden doğma yerini ayarladı",
	"subtitles.block.sand.idle": "Kumul sesler",
	"subtitles.block.sand.wind": "Rüzgâr sesleri",
	"subtitles.block.sculk.charge": "Sculk köpürüyor",
	"subtitles.block.sculk.spread": "Sculk yayılıyor",
	"subtitles.block.sculk_catalyst.bloom": "Sculk Katalizörü saçıldı",
	"subtitles.block.sculk_sensor.clicking": "Sculk Sensörü tıkırdadı",
	...
	"subtitles.block.shelf.activate": "Raf etkinleşti",
	"subtitles.block.shelf.deactivate": "Raf kapandı",
	"subtitles.block.shelf.multi_swap": "Eşyalar değişti",
	"subtitles.block.shelf.place_item": "Eşya kondu",
	"subtitles.block.shelf.single_swap": "Eşya değiştirildi",
	"subtitles.block.shelf.take_item": "Eşya alındı",
	"subtitles.block.shulker_box.close": "Shulker kutusu kapandı",
	"subtitles.block.shulker_box.open": "Shulker kutusu açıldı",
	"subtitles.block.sign.waxed_interact_fail": "Tabela titredi",
	"subtitles.block.smithing_table.use": "Demirci Masası kullanıldı",
	"subtitles.block.smoker.smoke": "Duman Fırını duman çıkarıyor",
	"subtitles.block.sniffer_egg.crack": "Koklarca Yumurtası çatlıyor",
	"subtitles.block.sniffer_egg.hatch": "Koklarca yumurtadan çıkıyor",
	"subtitles.block.sniffer_egg.plop": "Koklarca yumurtladı",
	"subtitles.block.sponge.absorb": "Sünger emdi",
	"subtitles.block.sweet_berry_bush.pick_berries": "Orman meyvesi toplandı",
	"subtitles.block.trapdoor.close": "Tuzak Kapısı kapandı",
	"subtitles.block.trapdoor.open": "Tuzak Kapısı açıldı",
	"subtitles.block.trapdoor.toggle": "Tuzak Kapısı gıcırdadı",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Uğursuz eşya hazırlanıyor",
	"subtitles.block.trial_spawner.ambient": "Sınama Çağırıcısı çatırdıyor",
	"subtitles.block.trial_spawner.ambient_charged": "Uğursuz çatırdama",
	"subtitles.block.trial_spawner.ambient_ominous": "Uğursuz çatırdama",
	"subtitles.block.trial_spawner.charge_activate": "Kehanet Sınama Çağırıcısını ele geçiriyor",
	"subtitles.block.trial_spawner.close_shutter": "Sınama Çağırıcısı kapandı",
	"subtitles.block.trial_spawner.detect_player": "Sınama Çağırıcısı hazırlanıyor",
	"subtitles.block.trial_spawner.eject_item": "Sınama Çağırıcısı eşyaları çıkardı",
	"subtitles.block.trial_spawner.ominous_activate": "Kehanet, Sınama Çağırıcısını ele geçiriyor",
	"subtitles.block.trial_spawner.open_shutter": "Sınama Çağırıcısı açıldı",
	"subtitles.block.trial_spawner.spawn_item": "Uğursuz eşya düştü",
	"subtitles.block.trial_spawner.spawn_item_begin": "Uğursuz eşya belirdi",
	"subtitles.block.trial_spawner.spawn_mob": "Sınama Çağırıcısı canavar çağırdı",
	...
	"subtitles.block.vault.activate": "Kasa alevlendi",
	"subtitles.block.vault.ambient": "Kasa çatırdıyor",
	"subtitles.block.vault.close_shutter": "Kasa kapandı",
	"subtitles.block.vault.deactivate": "Kasa söndü",
	"subtitles.block.vault.eject_item": "Kasa eşya çıkardı",
	"subtitles.block.vault.insert_item": "Kasa kilidi açıldı",
	"subtitles.block.vault.insert_item_fail": "Kasa eşyayı reddetti",
	"subtitles.block.vault.open_shutter": "Kasa açıldı",
	"subtitles.block.vault.reject_rewarded_player": "Kasa oyuncuyu reddetti",
	"subtitles.block.water.ambient": "Su akıyor",
	"subtitles.block.wet_sponge.dries": "Sünger kurudu",
	...
	"subtitles.entity.allay.ambient_with_item": "Huzurveren arıyor",
	"subtitles.entity.allay.ambient_without_item": "Huzurveren özlüyor",
	"subtitles.entity.allay.death": "Huzurveren öldü",
	"subtitles.entity.allay.hurt": "Huzurveren hasar aldı",
	"subtitles.entity.allay.item_given": "Huzurveren kıkırdıyor",
	"subtitles.entity.allay.item_taken": "Huzurveren huzur veriyor",
	"subtitles.entity.allay.item_thrown": "Huzurveren fırlattı",
	"subtitles.entity.armadillo.ambient": "Armadillo homurdandı",
	"subtitles.entity.armadillo.brush": "Pul fırçayla çıkarıldı",
	"subtitles.entity.armadillo.death": "Armadillo öldü",
	"subtitles.entity.armadillo.eat": "Armadillo yiyor",
	"subtitles.entity.armadillo.hurt": "Armadillo hasar aldı",
	"subtitles.entity.armadillo.hurt_reduced": "Armadillo kabuğuna girdi",
	"subtitles.entity.armadillo.land": "Armadillo oturdu",
	"subtitles.entity.armadillo.peek": "Armadillo göz atıyor",
	"subtitles.entity.armadillo.roll": "Armodillo yuvarlanıyor",
	"subtitles.entity.armadillo.scute_drop": "Armadillo pul döküyor",
	"subtitles.entity.armadillo.unroll_finish": "Armadillo kabuğundan çıkıyor",
	"subtitles.entity.armadillo.unroll_start": "Armadillo göz atıyor",
	...
	"subtitles.entity.baby_cat.ambient": "Yavru Kedi miyavlıyor",
	"subtitles.entity.baby_cat.beg_for_food": "Yavru Kedi istiyor",
	"subtitles.entity.baby_cat.death": "Yavru Kedi öldü",
	"subtitles.entity.baby_cat.eat": "Yavru Kedi yedi",
	"subtitles.entity.baby_cat.hiss": "Yavru Kedi tıslıyor",
	"subtitles.entity.baby_cat.hurt": "Yavru Kedi hasar aldı",
	"subtitles.entity.baby_cat.purr": "Yavru Kedi mırlıyor",
	"subtitles.entity.baby_chicken.ambient": "Civciv ciyakladı",
	"subtitles.entity.baby_chicken.death": "Civciv öldü",
	"subtitles.entity.baby_chicken.hurts": "Civciv hasar aldı",
	"subtitles.entity.baby_horse.ambient": "Tay kişniyor",
	"subtitles.entity.baby_horse.angry": "Tay kişniyor",
	"subtitles.entity.baby_horse.breathe": "Tay nefes alıyor",
	"subtitles.entity.baby_horse.death": "Tay öldü",
	"subtitles.entity.baby_horse.eat": "Tay yiyor",
	"subtitles.entity.baby_horse.hurt": "Tay hasar aldı",
	"subtitles.entity.baby_horse.land": "Tay düştü",
	"subtitles.entity.baby_nautilus.ambient": "Bebek Notilus cıvıldıyor",
	"subtitles.entity.baby_nautilus.ambient_land": "Bebek Notilus cıvıldıyor",
	"subtitles.entity.baby_nautilus.death": "Bebek Notilus öldü",
	"subtitles.entity.baby_nautilus.death_land": "Bebek Notilus öldü",
	"subtitles.entity.baby_nautilus.eat": "Bebek Notilus yiyor",
	"subtitles.entity.baby_nautilus.hurt": "Bebek Notilus hasar aldı",
	"subtitles.entity.baby_nautilus.hurt_land": "Bebek Notilus hasar aldı",
	"subtitles.entity.baby_nautilus.swim": "Bebek Notilus yüzüyor",
	"subtitles.entity.baby_pig.ambient": "Bebek Domuz nefes alıyor",
	"subtitles.entity.baby_pig.death": "Bebek Domuz öldü",
	"subtitles.entity.baby_pig.eat": "Bebek Domuz yiyor",
	"subtitles.entity.baby_pig.hurt": "Bebek Domuz hasar aldı",
	"subtitles.entity.baby_wolf.ambient": "Yavru Köpek havladı",
	"subtitles.entity.baby_wolf.death": "Yavru Köpek öldü",
	"subtitles.entity.baby_wolf.growl": "Yavru Köpek hırladı",
	"subtitles.entity.baby_wolf.hurt": "Yavru Köpek hasar aldı",
	"subtitles.entity.baby_wolf.pant": "Yavru Köpek nefes nefese",
	"subtitles.entity.baby_wolf.whine": "Yavru Köpek ağlıyor",
	...
	"subtitles.entity.bogged.ambient": "Batık takırdıyor",
	"subtitles.entity.bogged.death": "Batık öldü",
	"subtitles.entity.bogged.hurt": "Batık hasar aldı",
	"subtitles.entity.breeze.charge": "Esinti atıldı",
	"subtitles.entity.breeze.death": "Esinti öldü",
	"subtitles.entity.breeze.deflect": "Esinti saptırdı",
	"subtitles.entity.breeze.hurt": "Esinti hasar aldı",
	"subtitles.entity.breeze.idle_air": "Esinti uçuyor",
	"subtitles.entity.breeze.idle_ground": "Esinti vınlıyor",
	"subtitles.entity.breeze.inhale": "Esinti hava çekiyor",
	"subtitles.entity.breeze.jump": "Esinti zıpladı",
	"subtitles.entity.breeze.land": "Esinti düştü",
	"subtitles.entity.breeze.shoot": "Esinti ateş etti",
	"subtitles.entity.breeze.slide": "Esinti kaydı",
	"subtitles.entity.breeze.whirl": "Esinti dönüyor",
	"subtitles.entity.breeze.wind_burst": "Rüzgâr Topu patladı",
	"subtitles.entity.camel.ambient": "Deve hırıldıyor",
	"subtitles.entity.camel.dash": "Deve ileriye sıçradı",
	...
	"subtitles.entity.camel_husk.ambient": "Kalıntı Deve homurdanıyor",
	"subtitles.entity.camel_husk.dash": "Kalıntı Deve ileriye sıçradı",
	"subtitles.entity.camel_husk.dash_ready": "Kalıntı Deve toparlandı",
	"subtitles.entity.camel_husk.death": "Kalıntı Deve öldü",
	"subtitles.entity.camel_husk.eat": "Kalıntı Deve yiyor",
	"subtitles.entity.camel_husk.hurt": "Kalıntı Deve hasar aldı",
	"subtitles.entity.camel_husk.saddle": "Eyer kuşanıldı",
	"subtitles.entity.camel_husk.sit": "Kalıntı Deve oturuyor",
	"subtitles.entity.camel_husk.stand": "Kalıntı Deve ayağa kalktı",
	...
	"subtitles.entity.copper_golem.death": "Bakır Golem öldü",
	"subtitles.entity.copper_golem.hurt": "Bakır Golem hasar aldı",
	"subtitles.entity.copper_golem.item_drop": "Bakır Golem bir eşya yerleştiriyor",
	"subtitles.entity.copper_golem.item_no_drop": "Bakır Golem eşya yerleştiremiyor",
	"subtitles.entity.copper_golem.no_item_get": "Bakır Golem eşya alıyor",
	"subtitles.entity.copper_golem.no_item_no_get": "Bakır Golem eşya alamıyor",
	"subtitles.entity.copper_golem.spawn": "Bakır Golem belirdi",
	"subtitles.entity.copper_golem.spin": "Bakır Golem başını çeviriyor",
	"subtitles.entity.copper_golem_become_statue": "Bakır Golem taş kesildi",
	"subtitles.entity.copper_golem_oxidized.death": "Bakır Golem öldü",
	"subtitles.entity.copper_golem_oxidized.hurt": "Bakır Golem hasar aldı",
	"subtitles.entity.copper_golem_oxidized.spin": "Bakır Golem başını çeviriyor",
	"subtitles.entity.copper_golem_weathered.death": "Bakır Golem öldü",
	"subtitles.entity.copper_golem_weathered.hurt": "Bakır Golem hasar aldı",
	"subtitles.entity.copper_golem_weathered.spin": "Bakır Golem başını çeviriyor",
	...
	"subtitles.entity.creaking.activate": "Gıcırtı izliyor",
	"subtitles.entity.creaking.ambient": "Gıcırtı gıcırdadı",
	"subtitles.entity.creaking.attack": "Gıcırtı saldırdı",
	"subtitles.entity.creaking.deactivate": "Gıcırtı sakinleşti",
	"subtitles.entity.creaking.death": "Gıcırtı kırıldı",
	"subtitles.entity.creaking.freeze": "Gıcırtı durdu",
	"subtitles.entity.creaking.spawn": "Gıcırtı oluştu",
	"subtitles.entity.creaking.sway": "Gıcırtı vuruldu",
	"subtitles.entity.creaking.twitch": "Gıcırtı seğiriyor",
	"subtitles.entity.creaking.unfreeze": "Gıcırtı hareket etti",
	...
	"subtitles.entity.donkey.jump": "Eşek zıpladı",
	...
	"subtitles.entity.elder_guardian.curse": "Yaşlı Gardiyan lanetliyor",
	...
	"subtitles.entity.fish.swim": "Şapırtı",
	...
	"subtitles.entity.frog.lay_spawn": "Kurbağa yumurtladı",
	...
	"subtitles.entity.generic.wind_burst": "Rüzgâr Topu patladı",
	...
	"subtitles.entity.ghastling.ambient": "Ghastçık mırıldandı",
	"subtitles.entity.ghastling.death": "Ghastçık öldü",
	"subtitles.entity.ghastling.hurt": "Ghastçık hasar aldı",
	"subtitles.entity.ghastling.spawn": "Ghastçık belirdi",
	...
	"subtitles.entity.guardian.ambient_land": "Gardiyan çırpınıyor",
	...
	"subtitles.entity.happy_ghast.ambient": "Mutlu Ghast mırıldandı",
	"subtitles.entity.happy_ghast.death": "Mutlu Ghast öldü",
	"subtitles.entity.happy_ghast.equip": "Dizgin kuşanıldı",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Mutlu Ghast hazır",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Mutlu Ghast durdu",
	"subtitles.entity.happy_ghast.hurt": "Mutlu Ghast hasar aldı",
	"subtitles.entity.happy_ghast.unequip": "Dizgin çıkarıldı",
	...
	"subtitles.entity.husk.ambient": "Kalıntı sızlanıyor",
	"subtitles.entity.husk.converted_to_zombie": "Kalıntı, Zombi’ye dönüştü",
	"subtitles.entity.husk.death": "Kalıntı öldü",
	"subtitles.entity.husk.hurt": "Kalıntı hasar aldı",
	...
	"subtitles.entity.illusioner.mirror_move": "Hokkabaz yer değiştiriyor",
	"subtitles.entity.illusioner.prepare_blindness": "Hokkabaz körlük hazırlıyor",
	"subtitles.entity.illusioner.prepare_mirror": "Hokkabaz yansımalarını hazırlıyor",
	...
	"subtitles.entity.leash_knot.break": "Kayış Düğümü koptu",
	"subtitles.entity.leash_knot.place": "Kayış Düğümü bağlandı",
	...
	"subtitles.entity.magma_cube.squish": "Magma Küpü sıkındı",
	"subtitles.entity.minecart.inside": "Vagon sallanıyor",
	"subtitles.entity.minecart.inside_underwater": "Vagon su altında sallanıyor",
	...
	"subtitles.entity.mule.jump": "Katır zıpladı",
	"subtitles.entity.nautilus.ambient": "Notilus takırdıyor",
	"subtitles.entity.nautilus.ambient_land": "Notilus takırdıyor",
	"subtitles.entity.nautilus.dash": "Notilus fırladı",
	"subtitles.entity.nautilus.dash_land": "Notilus fırladı",
	"subtitles.entity.nautilus.dash_ready": "Notilus toparlandı",
	"subtitles.entity.nautilus.dash_ready_land": "Notilus toparlandı",
	"subtitles.entity.nautilus.death": "Notilus öldü",
	"subtitles.entity.nautilus.death_land": "Notilus öldü",
	"subtitles.entity.nautilus.eat": "Notilus yiyor",
	"subtitles.entity.nautilus.hurt": "Notilus hasar aldı",
	"subtitles.entity.nautilus.hurt_land": "Notilus hasar aldı",
	"subtitles.entity.nautilus.swim": "Notilus yüzüyor",
	...
	"subtitles.entity.parched.ambient": "Kavruk çatırdıyor",
	"subtitles.entity.parched.death": "Kavruk öldü",
	"subtitles.entity.parched.hurt": "Kavruk hasar aldı",
	...
	"subtitles.entity.parrot.imitate.bogged": "Papağan takırdıyor",
	"subtitles.entity.parrot.imitate.breeze": "Papağan vınlıyor",
	"subtitles.entity.parrot.imitate.camel_husk": "Papağan homurdanıyor",
	"subtitles.entity.parrot.imitate.creaking": "Papağan gıcırdadı",
	...
	"subtitles.entity.parrot.imitate.magma_cube": "Papağan sıkındı",
	"subtitles.entity.parrot.imitate.parched": "Papağan çatırdıyor",
	...
	"subtitles.entity.parrot.imitate.slime": "Papağan sıkındı",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Papağan sızlanıyor",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Papağan gargara yapıyor",
	"subtitles.entity.parrot.imitate.zombie_villager": "Papağan sızlanıyor",
	"subtitles.entity.phantom.ambient": "Kâbus bağırıyor",
	"subtitles.entity.phantom.bite": "Kâbus ısırdı",
	"subtitles.entity.phantom.death": "Kâbus öldü",
	"subtitles.entity.phantom.flap": "Kâbus kanat çırptı",
	"subtitles.entity.phantom.hurt": "Kâbus hasar aldı",
	"subtitles.entity.phantom.swoop": "Kâbus saldırdı",
	"subtitles.entity.pig.ambient": "Domuz ses çıkarıyor",
	"subtitles.entity.pig.death": "Domuz öldü",
	"subtitles.entity.pig.eat": "Domuz yiyor",
	...
	"subtitles.entity.player.attack.knockback": "Savurucu saldırı",
	...
	"subtitles.entity.player.teleport": "Oyuncu ışınlandı",
	"subtitles.entity.polar_bear.ambient": "Kutup Ayısı sızlanıyor",
	"subtitles.entity.polar_bear.ambient_baby": "Yavru Kutup Ayısı uğulduyor",
	...
	"subtitles.entity.sheep.ambient": "Koyun meledi",
	...
	"subtitles.entity.skeleton_horse.jump_water": "İskelet At zıpladı",
	...
	"subtitles.entity.slime.squish": "Balçık sıkındı",
	"subtitles.entity.sniffer.death": "Koklarca öldü",
	"subtitles.entity.sniffer.digging": "Koklarca kazıyor",
	"subtitles.entity.sniffer.digging_stop": "Koklarca ayağa kalktı",
	"subtitles.entity.sniffer.drop_seed": "Koklarca tohum bıraktı",
	"subtitles.entity.sniffer.eat": "Koklarca yiyor",
	"subtitles.entity.sniffer.egg_crack": "Koklarca Yumurtası çatlıyor",
	"subtitles.entity.sniffer.egg_hatch": "Koklarca yumurtadan çıkıyor",
	"subtitles.entity.sniffer.happy": "Koklarca mutlu oldu",
	"subtitles.entity.sniffer.hurt": "Koklarca hasar aldı",
	"subtitles.entity.sniffer.idle": "Koklarca hırıldıyor",
	"subtitles.entity.sniffer.scenting": "Koklarca koku aldı",
	"subtitles.entity.sniffer.searching": "Koklarca arıyor",
	"subtitles.entity.sniffer.sniffing": "Koklarca kokluyor",
	"subtitles.entity.sniffer.step": "Koklarca yürüyor",
	...
	"subtitles.entity.strider.happy": "Lavgezer cıvıldadı",
	...
	"subtitles.entity.sulfur_cube.absorb": "Sülfür Küpü doldu",
	"subtitles.entity.sulfur_cube.bounce": "Sülfür Küpü sekti",
	"subtitles.entity.sulfur_cube.death": "Sülfür Küpü öldü",
	"subtitles.entity.sulfur_cube.eject": "Blok kaldırıldı",
	"subtitles.entity.sulfur_cube.hit": "Sülfür Küpü darbe aldı",
	"subtitles.entity.sulfur_cube.hurt": "Sülfür Küpü hasar aldı",
	"subtitles.entity.sulfur_cube.push": "Sülfür Küpü itildi",
	"subtitles.entity.sulfur_cube.squish": "Sülfür Küpü sekti",
	...
	"subtitles.entity.turtle.egg_hatch": "Kaplumbağa yumurtası çatlıyor",
	...
	"subtitles.entity.villager.no": "Köylü reddediyor",
	...
	"subtitles.entity.villager.yes": "Köylü onaylıyor",
	...
	"subtitles.entity.warden.heartbeat": "Muhafızın kalbi atıyor",
	...
	"subtitles.entity.warden.tendril_clicks": "Muhafızın antenleri tıkırdıyor",
	"subtitles.entity.wind_charge.throw": "Rüzgâr Topu fırlatıldı",
	"subtitles.entity.wind_charge.wind_burst": "Rüzgâr Topu patladı",
	...
	"subtitles.entity.witch.drink": "Cadı içiyor",
	"subtitles.entity.witch.hurt": "Cadı hasar aldı",
	"subtitles.entity.witch.throw": "Cadı fırlattı",
	...
	"subtitles.entity.wolf.bark": "Kurt havladı",
	"subtitles.entity.wolf.death": "Kurt öldü",
	"subtitles.entity.wolf.growl": "Kurt hırladı",
	"subtitles.entity.wolf.hurt": "Kurt hasar aldı",
	"subtitles.entity.wolf.pant": "Kurt nefes alıyor",
	"subtitles.entity.wolf.shake": "Kurt silkelendi",
	"subtitles.entity.wolf.whine": "Kurt sızlanıyor",
	...
	"subtitles.entity.zombie_horse.angry": "Zombi At kişniyor",
	"subtitles.entity.zombie_horse.death": "Zombi At öldü",
	"subtitles.entity.zombie_horse.eat": "Zombi At yiyor",
	"subtitles.entity.zombie_horse.hurt": "Zombi At hasar aldı",
	"subtitles.entity.zombie_nautilus.ambient": "Zombi Notilus mırıldanıyor",
	"subtitles.entity.zombie_nautilus.ambient_land": "Zombi Notilus mırıldanıyor",
	"subtitles.entity.zombie_nautilus.dash": "Zombi Notilus fırladı",
	"subtitles.entity.zombie_nautilus.dash_land": "Zombi Notilus fırladı",
	"subtitles.entity.zombie_nautilus.dash_ready": "Zombi Notilus toparlandı",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Zombi Notilus toparlandı",
	"subtitles.entity.zombie_nautilus.death": "Zombi Notilus öldü",
	"subtitles.entity.zombie_nautilus.death_land": "Zombi Notilus öldü",
	"subtitles.entity.zombie_nautilus.eat": "Zombi Notilus yiyor",
	"subtitles.entity.zombie_nautilus.hurt": "Zombi Notilus hasar aldı",
	"subtitles.entity.zombie_nautilus.hurt_land": "Zombi Notilus hasar aldı",
	"subtitles.entity.zombie_nautilus.swim": "Zombi Notilus yüzüyor",
	...
	"subtitles.event.mob_effect.bad_omen": "Kehanet etki gösteriyor",
	"subtitles.event.mob_effect.raid_omen": "Baskın yakınlarda hissediliyor",
	"subtitles.event.mob_effect.trial_omen": "Uğursuz sınama yakınlarda hissediliyor",
	"subtitles.event.raid.horn": "Uğursuz borazan sesleri",
	"subtitles.item.armor.equip": "Zırh kuşanıldı",
	"subtitles.item.armor.equip_chain": "Zincir zırh şıngırdadı",
	"subtitles.item.armor.equip_copper": "Bakır zırh tıngırdıyor",
	...
	"subtitles.item.armor.equip_iron": "Demir zırh tangırdadı",
	"subtitles.item.armor.equip_leather": "Deri zırh hışırdadı",
	"subtitles.item.armor.equip_nautilus": "Notilus Zırhı kuşanıldı",
	...
	"subtitles.item.armor.equip_wolf": "Kurt Zırhı iliklendi",
	"subtitles.item.armor.unequip_nautilus": "Notilus Zırhı çıkarıldı",
	"subtitles.item.armor.unequip_wolf": "Kurt Zırhı çıkarıldı",
	...
	"subtitles.item.brush.brushing.generic": "Fırçalanıyor",
	"subtitles.item.brush.brushing.gravel": "Çakıl fırçalanıyor",
	"subtitles.item.brush.brushing.gravel.complete": "Çakıl fırçalandı",
	"subtitles.item.brush.brushing.sand": "Kum fırçalanıyor",
	"subtitles.item.brush.brushing.sand.complete": "Kum fırçalandı",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Sülfür Küp yakalandı",
	"subtitles.item.bucket.fill_tadpole": "İribaş yakalandı",
	"subtitles.item.bundle.drop_contents": "Kese boşaltıldı",
	"subtitles.item.bundle.insert": "Keseye konuldu",
	"subtitles.item.bundle.insert_fail": "Kese dolu",
	"subtitles.item.bundle.remove_one": "Keseden çıkarıldı",
	...
	"subtitles.item.elytra.flying": "Vızıltı",
	...
	"subtitles.item.goat_horn.play": "Keçi Boynuzu çalıyor",
	"subtitles.item.golden_dandelion.unuse": "Altın Karahindiba büyümeyi başlattı",
	"subtitles.item.golden_dandelion.use": "Altın Karahindiba büyümeyi durdurdu",
	...
	"subtitles.item.horse_armor.unequip": "At Zırhı çıkarıldı",
	"subtitles.item.ink_sac.use": "Mürekkep Kesesi boyadı",
	"subtitles.item.lead.break": "Kayış koptu",
	"subtitles.item.lead.tied": "Kayış bağlandı",
	"subtitles.item.lead.untied": "Kayış bağı çözüldü",
	"subtitles.item.llama_carpet.unequip": "Halı çıkarıldı",
	"subtitles.item.lodestone_compass.lock": "Manyetit Pusulası, Manyetite kilitlendi",
	"subtitles.item.mace.smash_air": "Gürz parçaladı",
	"subtitles.item.mace.smash_ground": "Gürz parçaladı",
	"subtitles.item.nautilus_saddle_equip": "Eyer kuşanıldı",
	"subtitles.item.nautilus_saddle_underwater_equip": "Eyer kuşanıldı",
	"subtitles.item.nether_wart.plant": "Ekin ekildi",
	"subtitles.item.ominous_bottle.dispose": "Şişe kırıldı",
	"subtitles.item.saddle.unequip": "Eyer çıkarıldı",
	"subtitles.item.shears.shear": "Makas kırptı",
	"subtitles.item.shears.snip": "Makas kırptı",
	"subtitles.item.shield.block": "Kalkan engelliyor",
	"subtitles.item.shovel.flatten": "Kürek düzleştiriyor",
	"subtitles.item.spear.attack": "Mızrak sapladı",
	"subtitles.item.spear.hit": "Mızrak vurdu",
	"subtitles.item.spear.lunge": "Mızrakla atılındı",
	"subtitles.item.spear.use": "Mızrak ile hücum ediyor",
	"subtitles.item.spear_wood.attack": "Mızrak sapladı",
	"subtitles.item.spear_wood.hit": "Mızrak vurdu",
	"subtitles.item.spear_wood.use": "Mızrak ile hücum ediyor",
	...
	"subtitles.item.underwater_saddle.equip": "Eyer kuşanıldı",
	"subtitles.item.wolf_armor.break": "Kurt Zırhı kırıldı",
	"subtitles.item.wolf_armor.crack": "Kurt Zırhı çatırdadı",
	"subtitles.item.wolf_armor.damage": "Kurt Zırhı hasar aldı",
	"subtitles.item.wolf_armor.repair": "Kurt Zırhı onarıldı",
	"subtitles.particle.soul_escape": "Ruh kaçıyor",
	"subtitles.ui.cartography_table.take_result": "Harita çizildi",
	"subtitles.ui.hud.bubble_pop": "Nefes çubuğu düşüyor",
	"subtitles.ui.loom.take_result": "Dokuma tezgâhı kullanıldı",
	"subtitles.ui.stonecutter.take_result": "Taş Yontma Makinesi kullanıldı",
	"subtitles.weather.end_flash": "End Işıkları gürledi",
	"subtitles.weather.rain": "Yağmur yağıyor",
	"symlink_warning.message": "Ne yaptığınız bilmiyorsanız sembolik bağlantılar içeren klasörlerden dünya yüklemek, tehlikeli olabilir. Ayrıntılı bilgi için %s adresini ziyaret edin.",
	"symlink_warning.message.pack": "Eğer yaptığınız işlemden emin değilseniz sembolik bağlantılar içeren paketleri yüklemek, tehlikeli olabilir. Ayrıntılı bilgi için %s adresini ziyaret edin.",
	"symlink_warning.message.world": "Ne yaptığınız bilmiyorsanız sembolik bağlantılar içeren klasörlerden dünya yüklemek, tehlikeli olabilir. Ayrıntılı bilgi için %s adresini ziyaret edin.",
	"symlink_warning.more_info": "Daha Fazla Bilgi",
	"symlink_warning.title": "Dünya klasörü sembolik bağlantılar içeriyor",
	"symlink_warning.title.pack": "Eklenen paket(ler) sembolik bağlantılar içeriyor",
	"symlink_warning.title.world": "Dünya klasörü sembolik bağlantılar içeriyor",
	...
	"telemetry.event.advancement_made.description": "Bir gelişim elde etmenin ardındaki mantığı anlamak, oyunun ilerlemesini daha iyi anlamamıza ve iyileştirmemize yardımcı olabilir.",
	"telemetry.event.advancement_made.title": "Gelişim Yapıldı",
	"telemetry.event.game_load_times.description": "Bu durum bize başlangıç aşamalarının yürütüm zamanlarını ölçerek nerede performans iyileştirmelerinin gerekli olduğunu anlamamıza yardımcı olabilir.",
	"telemetry.event.game_load_times.title": "Oyun Yükleme Süreleri",
	"telemetry.event.graphics_capabilities.description": "Bu eylem oyunu çalıştırmak için kullanılan grafik aygıtının özellikleri hakkında bilgi verir.",
	"telemetry.event.graphics_capabilities.title": "Grafik Özellikleri",
	"telemetry.event.optional": "%s (İsteğe Bağlı)",
	"telemetry.event.optional.disabled": "%s (İsteğe Bağlı) - Devre Dışı",
	"telemetry.event.p2p_connection.description": "Bu etkinlik oyuncular arasındaki eşler arası bağlantıların güvenilirlik ve performansını anlamamıza yardımcı oluyor. Bağlantının başarılı olup olmadığını, Etkileşimli Bağlantı Kuruluşu (ICE, eşler arası bağlantılar kurmak için kullandığımız protokol) adayının türünü ve bağlantıyı kurmanın ne kadar sürdüğünü kaydeder.",
	"telemetry.event.p2p_connection.title": "Peer-to-peer Bağlantı",
	"telemetry.event.performance_metrics.description": "Minecraft’ın genel performans profilini bilmek, oyunu çeşitli aygıt özellikleri ve işletim sistemleri için ayarlamamıza ve iyileştirmemize yardımcı olur. \nYeni sürümlerin performans profilini karşılaştırmamıza yardımcı olmak için oyun sürümü dâhil edilmiştir.",
	...
	"telemetry.property.advancement_game_time.title": "Oyun Süresi (Birim Zaman)",
	"telemetry.property.advancement_id.title": "Gelişim Kimliği",
	"telemetry.property.backend_failure_message.title": "Arka Uç Oluşturma Hatası Mesajı",
	"telemetry.property.backend_failure_missing_capabilities.title": "Arka Uç Oluşturma Hatası Eksik Özellikler",
	"telemetry.property.backend_failure_reason.title": "Arka Uç Oluşturma Hatası Nedeni",
	"telemetry.property.backend_name.title": "Arka Uç Adı",
	"telemetry.property.client_id.title": "İstemci Kimliği",
	"telemetry.property.client_modded.title": "Modlanmış İstemci",
	"telemetry.property.dedicated_memory_kb.title": "Ayrılmış Bellek (kB)",
	...
	"telemetry.property.launcher_name.title": "Başlatıcı Adı",
	"telemetry.property.load_time_bootstrap_ms.title": "Önyükleme Süresi (Milisaniye)",
	"telemetry.property.load_time_loading_overlay_ms.title": "Yükleme Ekranında Geçen Süre (Milisaniye)",
	"telemetry.property.load_time_pre_window_ms.title": "Pencere Açılmadan Önceki Süre (Milisaniye)",
	"telemetry.property.load_time_total_time_ms.title": "Toplam Yükleme Süresi (Milisaniye)",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "Başarısızlık Aşaması",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Etkileşimli Bağlantı Kuruluşu (ICE) Bağlantı Süresi (Milisaniye)",
	"telemetry.property.p2p_connection_ice_path.title": "Etkileşimli Bağlantı Kuruluşu (ICE) Yolu",
	"telemetry.property.p2p_connection_local_candidate_type.title": "Yerel Aday Tipi",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Uzak Aday Tipi",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Bağlantı Süresi (Milisaniye)",
	"telemetry.property.p2p_connection_successful.title": "Bağlantı Başarılı",
	"telemetry.property.p2p_connection_total_time_ms.title": "Toplam Bağlanma Süresi (Milisaniye)",
	"telemetry.property.platform.title": "Platform",
	"telemetry.property.realms_map_content.title": "Realms Harita İçeriği (Mini Oyun Adı)",
	...
	"telemetry_info.button.privacy_statement": "Gizlilik Beyanı",
	"telemetry_info.button.show_data": "Verilerimi Görüntüle",
	"telemetry_info.opt_in.description": "İsteğe bağlı telemetri verilerinin gönderilmesine izin veriyorum",
	...
	"test.error.block_property_mismatch": "%s durumunun %s olması beklendi, %s bulundu",
	"test.error.block_property_missing": "Blok durumu eksik, %s durumunun %s olması beklendi",
	"test.error.entity_property": "%s varlığı testte başarısız oldu: %s",
	"test.error.entity_property_details": "%s varlığı testte başarısız oldu: %s. %s beklendi: %s bulundu",
	"test.error.expected_block": "%s bloğu beklendi, %s bulundu",
	"test.error.expected_block_present": "%s bloğunun mevcut olması bekleniyor",
	"test.error.expected_block_tag": "#%s etiketinde blok beklendi, %s bulundu",
	"test.error.expected_container_contents": "Depo şu eşyayı barındırmalı: %s",
	"test.error.expected_container_contents_single": "Depo şu eşyadan bir tane barındırmalı: %s",
	"test.error.expected_empty_container": "Depo boş olmalı",
	"test.error.expected_entity": "%s beklendi",
	"test.error.expected_entity_around": "%s varlığının %s, %s, %s civarında var olması beklendi",
	"test.error.expected_entity_count": "%s türünden %s varlık beklendi, %s bulundu",
	"test.error.expected_entity_data": "Varlık verisinin: %s olması beklendi, %s bulundu",
	"test.error.expected_entity_data_predicate": "%s için varlık verisi uyumsuzluğu",
	"test.error.expected_entity_effect": "%s varlığının %s %s etkisine sahip olması beklendi",
	"test.error.expected_entity_having": "Varlığın envanteri %s barındırmalı",
	"test.error.expected_entity_holding": "Varlık %s tutmalı",
	"test.error.expected_entity_in_test": "%s varlığının testte var olması beklendi",
	"test.error.expected_entity_not_touching": "%s tarafından %s, %s, %s'ya dokunulması beklenmiyordu (göreceliliği: %s, %s, %s)",
	"test.error.expected_entity_touching": "%s tarafından %s, %s, %s'ya dokunulması bekleniyordu (göreceliliği: %s, %s, %s)",
	"test.error.expected_item": "%s türünde eşya beklendi",
	"test.error.expected_items_count": "%[2]s türü %[1]s eşya beklendi, %[3]s bulundu",
	"test.error.fail": "Başarısızlık şartları karşılandı",
	"test.error.invalid_block_type": "Beklenmeyen blok türü bulundu: %s",
	"test.error.missing_block_entity": "Blok varlık eksik",
	"test.error.not_a_block_item": "Verilen blok bir blok eşyası değil",
	"test.error.position": "%s, %s, %s, %s'de (göreceliliği: %s, %s, %s) %s birim zamanında",
	"test.error.sequence.condition_already_triggered": "Şart %s birim zamanda zaten tetiklendi",
	"test.error.sequence.condition_not_triggered": "Şart tetiklenmedi",
	"test.error.sequence.invalid_tick": "Geçersiz birim zamanda başarıldı: %s beklendi",
	"test.error.sequence.minimum_tick": "Beklenen tick'den önce başarıldı: beklenen tick %s",
	"test.error.sequence.not_completed": "Test, dizi tamamlanmadan zaman aşımına uğradı",
	"test.error.set_biome": "Test için biyom değiştirilemedi",
	"test.error.spawn_failure": "%s varlığı oluşturulamadı",
	"test.error.state_not_equal": "Geçersiz durum. %s beklendi, %s bulundu",
	"test.error.structure.failure": "%s için olan test yapısı yerleştirilemedi",
	"test.error.tick": "%[2]s birim zamanda %[1]s",
	"test.error.ticking_without_structure": "Yapı yerleştirilmeden test yürütüldü",
	"test.error.timeout.no_result": "%s birim zaman içinde başarılı veya başarısız olunmadı",
	"test.error.timeout.no_sequences_finished": "Hiçbir dizi, %s birim zaman içinde tamamlanmadı",
	"test.error.too_many_entities": "%[2]s, %[3]s, %[4]s etrafında yalnızca bir %[1]s olması beklenirken %[5]s tane bulundu",
	"test.error.unexpected_block": "Bloğun %s olması beklenmedi",
	"test.error.unexpected_entity": "%s varlığının var olması beklenmedi",
	"test.error.unexpected_item": "%s eşya tipi beklenmedi",
	"test.error.unknown": "Bilinmeyen dâhilî hata: %s",
	"test.error.value_not_equal": "%s değerinin %s olması beklendi, %s bulundu",
	"test.error.value_not_in_between": "%s için değerin %s ile %s arasında olması bekleniyor: %s bulundu",
	"test.error.wrong_block_entity": "Yanlış blok varlık türü: %s",
	"test_block.error.missing": "Test yapısında %s bloğu eksik",
	"test_block.error.too_many": "Çok fazla %s bloğu",
	"test_block.invalid_timeout": "Geçersiz zaman aşımı (%s) - birim zaman pozitif değerde olmalı",
	"test_block.message": "İleti:",
	"test_block.mode.accept": "Onayla",
	"test_block.mode.fail": "Başarısız et",
	"test_block.mode.log": "Günlüğe Yaz",
	"test_block.mode.start": "Başlat",
	"test_block.mode_info.accept": "Onay Modu - Bir testin (parçasının) başarısını onaylama",
	"test_block.mode_info.fail": "Başarısız Etme Modu - Testi başarısızlığa uğrat",
	"test_block.mode_info.log": "Günlük Modu - İletiyi çıktı günlüğüne yazdır",
	"test_block.mode_info.start": "Yürütme Modu - Bir testin başlama noktası",
	"test_instance.action.reset": "Sıfırla ve Yükle",
	"test_instance.action.run": "Yükle ve Yürüt",
	"test_instance.action.save": "Yapıyı Kaydet",
	"test_instance.description.batch": "Çevre: %s",
	"test_instance.description.failed": "Başarısız: %s",
	"test_instance.description.function": "Fonksiyon: %s",
	"test_instance.description.invalid_id": "Geçersiz test kimliği",
	"test_instance.description.no_test": "Böyle bir test yok",
	"test_instance.description.structure": "Yapı: %s",
	"test_instance.description.type": "Tür: %s",
	"test_instance.type.block_based": "Block Tabanlı Test",
	"test_instance.type.function": "Dâhilî Fonksiyon Testi",
	"test_instance_block.entities": "Varlıklar:",
	"test_instance_block.error.no_test": "Tanımlanmamış teste sahip olduğundan %s, %s, %s konumundaki test birimi yürütülemedi",
	"test_instance_block.error.no_test_structure": "Test yapısına sahip olmadığından %s, %s, %s konumundaki test yürütülemedi",
	"test_instance_block.error.unable_to_save": "Test yapı şablonu %s, %s, %s konumundaki test birimi için kaydedilemedi",
	"test_instance_block.invalid": "[geçersiz]",
	"test_instance_block.reset_success": "Test sıfırlama başarılı oldu: %s",
	"test_instance_block.rotation": "Yön:",
	"test_instance_block.size": "Test Yapısı Boyutu",
	"test_instance_block.starting": "%s testi yürütülüyor",
	"test_instance_block.test_id": "Test Birimi Kimliği",
	...
	"title.credits": "Telif Hakları Sahibi Mojang AB. Tekrar Dağıtmayın!",
	"title.multiplayer.disabled": "Çok oyunculu oyun kapalı. Lütfen Microsoft hesap ayarlarınızı kontrol edin.",
	"title.multiplayer.disabled.banned.name": "Çevrim içi oynamadan önce adını değiştirmelisin",
	...
	"title.multiplayer.online": "Çok Oyunculu (Çevrim İçi)",
	...
	"trim_material.minecraft.resin": "Reçine Materyal",
	"trim_pattern.minecraft.bolt": "Şimşek Zırh Süslemesi",
	...
	"trim_pattern.minecraft.flow": "Akış Zırh Süslemesi",
	"trim_pattern.minecraft.host": "Ev Sahibi Zırh Süslemesi",
	"trim_pattern.minecraft.raiser": "Yükseltici Zırh Süslemesi",
	"trim_pattern.minecraft.rib": "Kaburga Zırh Süslemesi",
	"trim_pattern.minecraft.sentry": "Nöbetçi Zırh Süslemesi",
	"trim_pattern.minecraft.shaper": "Şekillendirici Zırh Süslemesi",
	"trim_pattern.minecraft.silence": "Sessizlik Zırh Süslemesi",
	...
	"upgradeWorld.aborted.message": "Bu başka bir program yükseltme sırasında dünyaya erişmiş ise yaşanabilir.\nBilgisiyarınızı yeniden başlatıp tekrar denemek yardımcı olabilir. Sorun devam ederse, lütfen bir hata bildirimi yapmayı düşünün.",
	"upgradeWorld.aborted.reportBug": "Hata Bildirin",
	"upgradeWorld.aborted.title": "Dünya güncellenemedi",
	"upgradeWorld.canceled.message": "Dünyanız eski halinde.",
	"upgradeWorld.canceled.title": "Dünya güncellemesi iptal edildi",
	"upgradeWorld.done": "Dünya Güncellemesi Tamamlandı",
	"upgradeWorld.failed_cleanup.message": "Dünya başarıyla şu anki sürüme güncellendi ve dünya listesinde mevcut. Eski verileri temizlerken sorunlar ile karşılaştık, bu yüzden dosyanın ismi %s olarak değiştirildi.",
	"upgradeWorld.failed_cleanup.title": "Dünya başarıyla güncellendi",
	"upgradeWorld.info.converted": "Güncellendi: %s",
	"upgradeWorld.info.file_fix_stage": "Aşama: %s/%s",
	"upgradeWorld.info.scanning": "Dosyalar taranıyor...",
	"upgradeWorld.info.total": "Toplam: %s",
	"upgradeWorld.joinNow": "Dünyaya şimdi girmek istiyor musunuz?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Dosyalar taşınıyor",
	"upgradeWorld.progress.type.legacy_structures": "Eski yapılar güncelleniyor",
	"upgradeWorld.progress.type.region": "Bölgeler güncelleniyor",
	"upgradeWorld.symlink.message": "Şeçili dünya sembolik bağlantılar içeriyor.\nDünyayı şu anki sürüme güncellemek için gerekli aşamalar sembolik bağlantıları desteklemiyor. Dünyanın güncellenmesi için önce bağlantıların çözümlenmesi gerekecek.",
	"upgradeWorld.symlink.title": "Dünya güncellenemedi",
	"upgradeWorld.title": "Dünya Dosyaları Güncelleniyor",
}
