// Code generated by tools/gen_lang.go from 26.1/rpr.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"accessibility.onboarding.accessibility.button.narration": "Спеціальныя возможности",
	...
	"advMode.notEnabled": "Ариѳмометры отключены",
	"advMode.notEnabled.spawner": "Разсадники отключены",
	"advMode.previousOutput": "Предыдущій выводъ",
	"advMode.setCommand": "Задайте приказъ для блока",
	"advMode.setCommand.disabled": "Приказъ заданъ: %s, но ариѳмометры отключены",
	...
	"advancements.adventure.heart_transplanter.description": "Размѣстите скрипцевину между двухъ брёвенъ блѣднаго дуба въ правильномъ положеніи",
	"advancements.adventure.heart_transplanter.title": "Скрипя сердцемъ",
	...
	"advancements.adventure.spear_many_mobs.description": "Поразите пять тварей тараннымъ ударомъ копья",
	"advancements.adventure.spear_many_mobs.title": "Твари на шампурѣ",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Помѣстите изсохшаго гаста въ воду",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Гастепріимство!",
	...
	"advancements.husbandry.uh_oh.description": "Дайте сѣрному кубу поглотить динамитъ",
	"advancements.husbandry.uh_oh.title": "Спрячьте спички!",
	...
	"argument.hexcolor.invalid": "Невѣрный HEX-шифръ цвѣта «%s»",
	"argument.id.invalid": "Невѣрный опознаватель",
	"argument.id.unknown": "Неизвѣстный опознаватель: %s",
	"argument.integer.big": "Цѣлое число должно быть не больше %s; указано %s",
	"argument.integer.low": "Цѣлое число должно быть не меньше %s; указано %s",
	"argument.item.id.invalid": "Неизвѣстная вещь «%s»",
	"argument.item.tag.disallowed": "Здѣсь нельзя использовать мѣтки, укажите конкретную вещь",
	...
	"argument.resource_or_id.no_such_element": "Не вышло найти элементъ «%s» въ реестрѣ «%s»",
	...
	"argument.waypoint.invalid": "Выбранная сущность не является отмѣткой",
	...
	"attribute.name.air_drag_modifier": "Модификаторъ сопротивленія воздуха",
	...
	"attribute.name.below_name_distance": "Дальность видимости счёта подъ именемъ",
	...
	"attribute.name.friction_modifier": "Модификаторъ тренія",
	...
	"attribute.name.waypoint_receive_range": "Дальность обнаруженія отмѣтокъ",
	"attribute.name.waypoint_transmit_range": "Дальность передачи отмѣтки",
	...
	"biome.minecraft.sulfur_caves": "Сѣрныя пещеры",
	...
	"block.minecraft.acacia_shelf": "Акаціевая полка",
	...
	"block.minecraft.chiseled_cinnabar": "Рѣзная киноварь",
	...
	"block.minecraft.chiseled_sulfur": "Рѣзная сѣра",
	...
	"block.minecraft.cinnabar_brick_slab": "Плита изъ киноварнаго кирпича",
	"block.minecraft.cinnabar_brick_stairs": "Ступеньки изъ киноварнаго кирпича",
	"block.minecraft.cinnabar_brick_wall": "Ограда изъ киноварнаго кирпича",
	"block.minecraft.cinnabar_bricks": "Киноварные кирпичи",
	"block.minecraft.cinnabar_slab": "Киноварная плита",
	"block.minecraft.cinnabar_stairs": "Киноварныя ступеньки",
	...
	"block.minecraft.copper_bars": "Мѣдные прутья",
	"block.minecraft.copper_block": "Мѣдный блокъ",
	"block.minecraft.copper_bulb": "Мѣдная лампа",
	"block.minecraft.copper_chain": "Мѣдная цѣпь",
	"block.minecraft.copper_chest": "Мѣдный сундукъ",
	"block.minecraft.copper_door": "Мѣдная дверь",
	"block.minecraft.copper_golem_statue": "Статуя мѣднаго домовёнка",
	"block.minecraft.copper_grate": "Мѣдная рѣшётка",
	"block.minecraft.copper_lantern": "Мѣдный фонарь",
	"block.minecraft.copper_ore": "Мѣдная руда",
	"block.minecraft.copper_torch": "Мѣдный факелъ",
	"block.minecraft.copper_trapdoor": "Мѣдный люкъ",
	"block.minecraft.copper_wall_torch": "Настѣнный мѣдный факелъ",
	...
	"block.minecraft.dark_oak_shelf": "Полка изъ тёмнаго дуба",
	...
	"block.minecraft.dried_ghast": "Изсохшiй гастъ",
	...
	"block.minecraft.end_portal": "Порталъ Энда",
	...
	"block.minecraft.exposed_copper_bars": "Патиновые мѣдные прутья",
	"block.minecraft.exposed_copper_bulb": "Патиновая мѣдная лампа",
	"block.minecraft.exposed_copper_chain": "Патиновая мѣдная цѣпь",
	"block.minecraft.exposed_copper_chest": "Патиновый мѣдный сундукъ",
	"block.minecraft.exposed_copper_door": "Патиновая мѣдная дверь",
	"block.minecraft.exposed_copper_golem_statue": "Патиновая статуя мѣднаго домовёнка",
	"block.minecraft.exposed_copper_grate": "Патиновая мѣдная рѣшётка",
	"block.minecraft.exposed_copper_lantern": "Патиновый мѣдный фонарь",
	...
	"block.minecraft.exposed_lightning_rod": "Патиновый громоотводъ",
	...
	"block.minecraft.golden_dandelion": "Золотой одуванчикъ",
	...
	"block.minecraft.iron_chain": "Желѣзная цѣпь",
	...
	"block.minecraft.jungle_shelf": "Полка изъ тропическаго дерева",
	...
	"block.minecraft.nether_portal": "Порталъ Нѣдра",
	...
	"block.minecraft.oxidized_copper_bars": "Окисленные мѣдные прутья",
	"block.minecraft.oxidized_copper_bulb": "Окисленная мѣдная лампа",
	"block.minecraft.oxidized_copper_chain": "Окисленная мѣдная цѣпь",
	"block.minecraft.oxidized_copper_chest": "Окисленный мѣдный сундукъ",
	"block.minecraft.oxidized_copper_door": "Окисленная мѣдная дверь",
	"block.minecraft.oxidized_copper_golem_statue": "Окисленная статуя мѣднаго домовёнка",
	"block.minecraft.oxidized_copper_grate": "Окисленная мѣдная рѣшётка",
	"block.minecraft.oxidized_copper_lantern": "Окисленный мѣдный фонарь",
	...
	"block.minecraft.oxidized_lightning_rod": "Окисленный громоотводъ",
	...
	"block.minecraft.pale_oak_shelf": "Полка изъ блѣднаго дуба",
	...
	"block.minecraft.polished_cinnabar_slab": "Плита изъ полированной киновари",
	"block.minecraft.polished_cinnabar_stairs": "Ступеньки изъ полированной киновари",
	"block.minecraft.polished_cinnabar_wall": "Ограда изъ полированной киновари",
	...
	"block.minecraft.polished_sulfur": "Полированная сѣра",
	"block.minecraft.polished_sulfur_slab": "Плита изъ полированной сѣры",
	"block.minecraft.polished_sulfur_stairs": "Ступеньки изъ полированной сѣры",
	"block.minecraft.polished_sulfur_wall": "Ограда изъ полированной сѣры",
	...
	"block.minecraft.potent_sulfur": "Активная сѣра",
	...
	"block.minecraft.potted_golden_dandelion": "Золотой одуванчикъ въ горшкѣ",
	...
	"block.minecraft.sulfur": "Сѣра",
	"block.minecraft.sulfur_brick_slab": "Плита изъ сѣрнаго кирпича",
	"block.minecraft.sulfur_brick_stairs": "Ступеньки изъ сѣрнаго кирпича",
	"block.minecraft.sulfur_brick_wall": "Ограда изъ сѣрнаго кирпича",
	"block.minecraft.sulfur_bricks": "Сѣрные кирпичи",
	"block.minecraft.sulfur_slab": "Сѣрная плита",
	"block.minecraft.sulfur_spike": "Сѣрный шипъ",
	"block.minecraft.sulfur_stairs": "Сѣрныя ступеньки",
	"block.minecraft.sulfur_wall": "Сѣрная ограда",
	...
	"block.minecraft.waxed_copper_bars": "Вощёные мѣдные прутья",
	"block.minecraft.waxed_copper_block": "Вощёный мѣдный блокъ",
	"block.minecraft.waxed_copper_bulb": "Вощёная мѣдная лампа",
	"block.minecraft.waxed_copper_chain": "Вощёная мѣдная цѣпь",
	"block.minecraft.waxed_copper_chest": "Вощёный мѣдный сундукъ",
	"block.minecraft.waxed_copper_door": "Вощёная мѣдная дверь",
	"block.minecraft.waxed_copper_golem_statue": "Вощёная статуя мѣднаго домовёнка",
	"block.minecraft.waxed_copper_grate": "Вощёная мѣдная рѣшётка",
	"block.minecraft.waxed_copper_lantern": "Вощёный мѣдный фонарь",
	...
	"block.minecraft.waxed_exposed_copper_bars": "Вощёные патиновые мѣдные прутья",
	"block.minecraft.waxed_exposed_copper_bulb": "Вощёная патиновая мѣдная лампа",
	"block.minecraft.waxed_exposed_copper_chain": "Вощёная патиновая мѣдная цѣпь",
	"block.minecraft.waxed_exposed_copper_chest": "Вощёный патиновый мѣдный сундукъ",
	"block.minecraft.waxed_exposed_copper_door": "Вощёная патиновая мѣдная дверь",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Вощёная патиновая статуя мѣднаго домовёнка",
	"block.minecraft.waxed_exposed_copper_grate": "Вощёная патиновая мѣдная рѣшётка",
	"block.minecraft.waxed_exposed_copper_lantern": "Вощёный патиновый мѣдный фонарь",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Вощёный патиновый громоотводъ",
	"block.minecraft.waxed_lightning_rod": "Вощёный громоотводъ",
	...
	"block.minecraft.waxed_oxidized_copper_bars": "Вощёные окисленные мѣдные прутья",
	"block.minecraft.waxed_oxidized_copper_bulb": "Вощёная окисленная мѣдная лампа",
	"block.minecraft.waxed_oxidized_copper_chain": "Вощёная окисленная мѣдная цѣпь",
	"block.minecraft.waxed_oxidized_copper_chest": "Вощёный окисленный мѣдный сундукъ",
	"block.minecraft.waxed_oxidized_copper_door": "Вощёная окисленная мѣдная дверь",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Вощёная окисленная статуя мѣднаго домовёнка",
	"block.minecraft.waxed_oxidized_copper_grate": "Вощёная окисленная мѣдная рѣшётка",
	"block.minecraft.waxed_oxidized_copper_lantern": "Вощёный окисленный мѣдный фонарь",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Вощёный окисленный громоотводъ",
	...
	"block.minecraft.waxed_weathered_copper_bars": "Вощёные состаренные мѣдные прутья",
	"block.minecraft.waxed_weathered_copper_bulb": "Вощёная состаренная мѣдная лампа",
	"block.minecraft.waxed_weathered_copper_chain": "Вощёная состаренная мѣдная цѣпь",
	"block.minecraft.waxed_weathered_copper_chest": "Вощёный состаренный мѣдный сундукъ",
	"block.minecraft.waxed_weathered_copper_door": "Вощёная состаренная мѣдная дверь",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Вощёная состаренная статуя мѣднаго домовёнка",
	"block.minecraft.waxed_weathered_copper_grate": "Вощёная состаренная мѣдная рѣшётка",
	"block.minecraft.waxed_weathered_copper_lantern": "Вощёный состаренный мѣдный фонарь",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Вощёный состаренный громоотводъ",
	...
	"block.minecraft.weathered_copper_bars": "Состаренные мѣдные прутья",
	"block.minecraft.weathered_copper_bulb": "Состаренная мѣдная лампа",
	"block.minecraft.weathered_copper_chain": "Состаренная мѣдная цѣпь",
	"block.minecraft.weathered_copper_chest": "Состаренный мѣдный сундукъ",
	"block.minecraft.weathered_copper_door": "Состаренная мѣдная дверь",
	"block.minecraft.weathered_copper_golem_statue": "Состаренная статуя мѣднаго домовёнка",
	"block.minecraft.weathered_copper_grate": "Состаренная мѣдная рѣшётка",
	"block.minecraft.weathered_copper_lantern": "Состаренный мѣдный фонарь",
	...
	"block.minecraft.weathered_lightning_rod": "Состаренный громоотводъ",
	...
	"book.page_button.next": "Слѣдующая страница",
	...
	"build.spawn_protection": "%s подъ защитой начальной точки",
	"build.tooHigh": "Ограниченіе строительства по высотѣ: %s",
	"build.tooLow": "Наименьшая высота строительства составляетъ %s",
	...
	"chat.queue.tooltip": "Нажмите, чтобы отобразить слѣдующее письмо",
	...
	"chat_restriction.chat_and_commands_disabled_by_options": "Бесѣда ограничена настройками кліента.",
	"chat_restriction.chat_disabled_by_options": "Бесѣда игрока ограничена настройками кліента.",
	"chat_restriction.chat_disabled_by_options.action": "Перейти на экранъ «Настройки бесѣды»",
	"chat_restriction.disabled_by_launcher": "Бесѣда ограничена лаунчеромъ",
	"chat_restriction.disabled_by_profile": "Бесѣда ограничена настройками профиля.",
	"chat_restriction.disabled_by_profile.action": "Перейти къ настройкамъ профиля",
	"chat_screen.commands_not_allowed": "Отправка приказовъ запрещена",
	"chat_screen.message": "Письмо для отправки: %s",
	"chat_screen.messages_not_allowed": "Отправка писемъ въ бесѣду запрещена",
	"chat_screen.restricted": "Бесѣда ограничена. Нажмите сіе письмо, чтобы узнать больше.",
	"chat_screen.restricted.narration": "Бесѣда ограничена. Перейдите на экранъ «Ограниченія» въ настройкахъ міра.",
	...
	"command.trailing_data": "Обнаружены слѣдующія данныя: %s",
	...
	"commands.datapack.create.already_exists": "Наборъ данныхъ съ названіемъ «%s» уже существуетъ",
	"commands.datapack.create.invalid_full_name": "Недопустимое названіе для новаго набора данныхъ: «%s»",
	"commands.datapack.create.invalid_name": "Недопустимые символы въ названіи набора «%s»",
	"commands.datapack.create.io_failure": "Не вышло создать наборъ съ названіемъ «%s», провѣрьте журналъ",
	"commands.datapack.create.metadata_encode_failure": "Не вышло записать метаданныя набора «%s»: %s",
	"commands.datapack.create.success": "Созданъ пустой наборъ данныхъ «%s»",
	...
	"commands.dialog.clear.multiple": "Убранъ діалогъ у %s игроковъ",
	"commands.dialog.clear.single": "Убранъ діалогъ у %s",
	"commands.dialog.show.multiple": "Отображёнъ діалогъ %s игрокамъ",
	"commands.dialog.show.single": "Отображёнъ діалогъ для %s",
	...
	"commands.execute.conditional.fail_count": "Провѣрка неуспѣшна; счётчикъ: %s",
	"commands.execute.conditional.pass": "Условіе выполнено",
	"commands.execute.conditional.pass_count": "Провѣрка пройдена; счётчикъ: %s",
	...
	"commands.fetchprofile.copy_component": "Копировать компонентъ",
	"commands.fetchprofile.copy_text": "Копировать %s",
	"commands.fetchprofile.entity.success": "Полученъ профиль сущности %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Не вышло серіализовать профиль: %s",
	"commands.fetchprofile.give_item": "Выдать вещь",
	"commands.fetchprofile.id.failure": "Не вышло получить профиль по опознавателю %s",
	"commands.fetchprofile.id.success": "Полученъ профиль по опознавателю %s: %s",
	"commands.fetchprofile.name.failure": "Не вышло получить профиль по имени %s",
	"commands.fetchprofile.name.success": "Полученъ профиль по имени %s: %s",
	"commands.fetchprofile.no_profile": "У сущности %s нѣтъ профиля",
	"commands.fetchprofile.summon_mannequin": "Призвать манекенъ",
	...
	"commands.help.failed": "Неизвѣстный приказъ, или недостаточно полномочій",
	...
	"commands.profile_fetch.copy_component": "Копировать компонентъ",
	"commands.profile_fetch.failed_to_serialize": "Не вышло серіализовать профиль: %s",
	"commands.profile_fetch.give_item": "Выдать вещь",
	"commands.profile_fetch.id.failure": "Не вышло получить профиль по опознавателю %s",
	"commands.profile_fetch.id.success": "Полученъ профиль по опознавателю %s: %s",
	"commands.profile_fetch.name.failure": "Не вышло получить профиль по имени %s",
	"commands.profile_fetch.name.success": "Полученъ профиль по имени %s: %s",
	"commands.publish.alreadyPublished": "Игра въ компаніи уже запущена на порту %s",
	"commands.publish.alreadyPublished.lan": "Локальный салонъ уже запущенъ на порту %s",
	"commands.publish.alreadyPublished.online": "Игра въ компаніи уже запущена",
	"commands.publish.failed": "Невозможно запустить локальный салонъ",
	"commands.publish.started": "Портъ локальнаго салона: %s",
	"commands.publish.started.lan": "Локальный салонъ запущенъ на порту %s",
	"commands.publish.started.online": "Игра въ компаніи запущена",
	...
	"commands.setworldspawn.success.new": "Установлена точка возрожденія міра на %s, %s, %s [%s, %s] в %s",
	"commands.spawnpoint.success.multiple": "Установлена точка воскрешенія %s, %s, %s [%s] въ %s для %s игроковъ",
	"commands.spawnpoint.success.multiple.new": "Установлена точка возрожденія на %s, %s, %s [%s, %s] въ %s для %s игроковъ",
	"commands.spawnpoint.success.single": "Установлена точка воскрешенія %s, %s, %s [%s] въ %s для %s",
	"commands.spawnpoint.success.single.new": "Установлена точка возрожденія на %s, %s, %s [%s, %s] въ %s для %s",
	...
	"commands.stopwatch.already_exists": "Секундомѣръ «%s» уже существуетъ",
	"commands.stopwatch.create.success": "Созданъ секундомѣръ «%s»",
	"commands.stopwatch.does_not_exist": "Секундомѣръ «%s» не существуетъ",
	"commands.stopwatch.query": "Секундомѣръ «%s» работалъ въ теченіе %ss",
	"commands.stopwatch.remove.success": "Удалёнъ секундомѣръ «%s»",
	"commands.stopwatch.restart.success": "Перезапущенъ секундомѣръ «%s»",
	"commands.summon.failed": "Не вышло создать сущность",
	"commands.summon.failed.peaceful": "Невозможно призывать тварей на мирной сложности",
	...
	"commands.swing.success.single": "%s взмахнулъ рукой",
	...
	"commands.team.option.color.clear.success": "Убранъ цвѣтъ у союза %s",
	...
	"commands.test.error.no_test_instances": "Провѣрочные образцы не найдены",
	...
	"commands.test.error.test_instance_not_found.position": "Не вышло найти блокъ-сущность анализатора экземпляра у отладки въ точкѣ %s, %s, %s",
	...
	"commands.test.no_tests": "Нѣтъ провѣрокъ для запуска",
	"commands.test.relative_position": "Положеніе относительно %s: %s",
	"commands.test.reset.error.no_tests": "Не вышло найти провѣрки для сброса",
	"commands.test.reset.success": "Сброшено %s конструкцій",
	"commands.test.run.no_tests": "Провѣрки не найдены",
	"commands.test.run.running": "Выполненіе %s провѣрокъ...",
	"commands.test.summary": "Отладка завершена! Выполнено %s отладокъ",
	"commands.test.summary.all_required_passed": "Всѣ обязательные тесты пройдены :)",
	"commands.test.summary.failed": "%s обязательныхъ провѣрокъ провалены :(",
	"commands.test.summary.optional_failed": "%s необязательныхъ провѣрокъ провалены",
	...
	"commands.time.no_default_clock": "Въ измѣреніи %s нѣтъ часовъ по умолчанію",
	"commands.time.no_time_marker_found": "Временная отмѣтка %s не существуетъ для часовъ %s",
	"commands.time.pause": "Ходъ часовъ %s пріостановленъ",
	"commands.time.query": "Время: %s",
	"commands.time.query.absolute": "Часы %s находятся на отмѣткѣ въ %s тактовъ",
	"commands.time.query.gametime": "Игровое время составляетъ %s тактовъ",
	"commands.time.query.timeline": "Временная шкала %s находится на отмѣткѣ въ %s тактовъ",
	"commands.time.query.timeline.repetitions": "Временная шкала %s повторилась %s разъ",
	"commands.time.rate": "Часы %s будутъ итти въ %s разъ быстрѣе обычнаго",
	"commands.time.resume": "Ходъ часовъ %s возобновлёнъ",
	"commands.time.set": "Установлено время: %s",
	"commands.time.set.absolute": "Установлено %s на %s тактовъ",
	"commands.time.set.time_marker": "%s теперь на временной отмѣткѣ %s",
	"commands.time.wrong_timeline_for_clock": "Временная шкала %s недѣйствительна для часовъ %s",
	...
	"commands.unpublish.notPublished": "Игры въ компаніи нѣтъ",
	"commands.unpublish.success": "Игра въ компаніи теперь закрыта",
	...
	"commands.waypoint.list.empty": "Нѣтъ отмѣтокъ въ %s",
	"commands.waypoint.list.success": "%s отмѣтокъ въ %s: %s",
	"commands.waypoint.modify.color": "Цвѣтъ отмѣтки теперь %s",
	"commands.waypoint.modify.color.reset": "Цвѣтъ отмѣтки сброшенъ",
	"commands.waypoint.modify.style": "Стиль отмѣтки измѣнёнъ",
	...
	"component.profile.dynamic": "Динамическій",
	...
	"connect.p2p.establishing": "Установка соединенія...",
	"connect.p2p.failed.generic": "Не вышло присоединиться къ игроку",
	"connect.p2p.failed.signaling": "Ошибка подключенія.\nПопробуйте позже.",
	"connect.p2p.failed.timeout": "Время подключенія истекло",
	"connect.p2p.failed.unreachable": "Игрокъ недоступенъ",
	...
	"createWorld.customize.buffet.search": "Поискъ...",
	...
	"dataPack.locator_bar.description": "Показывать направленія другихъ игроковъ въ игрѣ въ компаніи",
	"dataPack.locator_bar.name": "Локаторъ",
	...
	"death.attack.spear": "%[1]s былъ проткнутъ %[2]s",
	"death.attack.spear.item": "%[1]s былъ проткнутъ %[2]s съ помощью %[3]s",
	...
	"death.attack.sulfurCubeHot": "%[1]s обнаружилъ, что лавой можетъ быть не только полъ",
	"death.attack.sulfurCubeHot.player": "%[2]s показалъ %[1]s, что лавой можетъ быть не только полъ",
	...
	"debug.copy_location.help": "F3 + C = Скопировать координаты; удерживайте 10 секундъ, чтобы вызвать сбой игры",
	...
	"debug.crash.message.rebindable": "Зажатіе клавишъ %s + %s. Приведётъ къ сбою игры, если не отпустить.",
	...
	"debug.entry.currently.alwaysOn": "%s: Въ данный моментъ отображается всегда",
	"debug.entry.currently.inF3": "%s: Въ данный моментъ только въ F3",
	"debug.entry.currently.inOverlay": "%s: Въ данный моментъ только на экранѣ отладки",
	"debug.entry.currently.never": "%s: Въ данный моментъ выключенъ",
	"debug.entry.f3": "Въ F3",
	"debug.entry.overlay": "Въ отладкѣ",
	...
	"debug.options.category.text": "Текстъ экрана отладки",
	"debug.options.help": "F3 + F6 = Редактировать настройки отладки",
	"debug.options.notAllowed.tooltip": "Не отображается при урѣзанномъ экранѣ отладки",
	"debug.options.profile.default": "По умолчанію",
	"debug.options.profile.performance": "Отладка быстродѣйствія",
	"debug.options.search": "Поискъ...",
	"debug.options.title": "Настройки отладки",
	"debug.options.warning": "Сіи настройки предназначены только для отладки. Ихъ измѣненіе можетъ привести къ сбою игры, замедленію вычислителя или съѣденію ковра на стѣнѣ.",
	...
	"debug.profiling.start.rebindable": "%s-секундное профилированіе запущено. Нажмите %s + %s, чтобы остановить",
	...
	"debug.version.header": "Свѣдѣнія о версіи кліента:",
	"debug.version.help": "F3 + V = Свѣдѣнія о версіи кліента",
	...
	"editGamerule.inGame.button": "Игровые законы...",
	"editGamerule.inGame.disabled.tooltip": "Для обновленія игровыхъ законовъ требуются права управляющаго.",
	"editGamerule.inGame.discardChanges.message": "Вы дѣйствительно хотите отмѣнить измѣненія игровыхъ законовъ?",
	"editGamerule.inGame.discardChanges.title": "Измѣненіе игровыхъ законовъ",
	"editGamerule.inGame.downloadingGamerules": "Загрузка игровыхъ законовъ...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Дыханіе наутилуса",
	...
	"enchantment.minecraft.lunge": "Рывокъ",
	...
	"entity.minecraft.camel_husk": "Верблюдъ-кадавръ",
	...
	"entity.minecraft.copper_golem": "Мѣдный домовёнокъ",
	...
	"entity.minecraft.happy_ghast": "Счастливый гастъ",
	...
	"entity.minecraft.mannequin": "Манекенъ",
	"entity.minecraft.mannequin.label": "N.P.C.",
	...
	"entity.minecraft.nautilus": "Наутилусъ",
	...
	"entity.minecraft.parched": "Пустынникъ",
	...
	"entity.minecraft.sulfur_cube": "Сѣрный кубъ",
	"entity.minecraft.sulfur_cube.content": "Содержитъ: %s",
	...
	"entity.minecraft.zombie_nautilus": "Наутилусъ-мертвецъ",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Доступъ въ Нѣдръ",
	"gamerule.allowEnteringNetherUsingPortals.description": "Опредѣляетъ, могутъ ли игроки входить въ Нѣдръ",
	...
	"gamerule.commandBlocksEnabled": "Ариѳмометры",
	...
	"gamerule.enableCommandBlocks": "Ариѳмометры",
	...
	"gamerule.locatorBar": "Локаторъ игроковъ",
	"gamerule.locatorBar.description": "Когда включено, на экранѣ отображается локаторъ, указывающій на расположеніе игроковъ.",
	...
	"gamerule.minecraft.elytra_movement_check": "Провѣрка движенія на надкрыльяхъ",
	"gamerule.minecraft.fire_spread_radius_around_player": "Радіусъ распространенія огня",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Радіусъ въ блокахъ вокругъ игрока, въ которомъ можетъ распространяться огонь",
	"gamerule.minecraft.player_movement_check": "Провѣрка движенія игрока",
	"gamerule.minecraft.raids": "Набѣги",
	"gamerule.minecraft.universal_anger.description": "Разозлённыя нейтральныя твари будутъ нападать на любого игрока поблизости, а не на разозлившаго ихъ. Работаетъ лучше, если правило forgive_dead_players выключено.",
	...
	"gamerule.pvp": "P.v.P.",
	"gamerule.pvp.description": "Опредѣляетъ, могутъ ли игроки наносить уронъ инымъ игрокамъ",
	...
	"gamerule.spawnMonsters": "Появленіе тварей",
	"gamerule.spawnMonsters.description": "Опредѣляетъ, появляются ли твари",
	...
	"gamerule.spawnerBlocksEnabled": "Разсадники",
	...
	"gui.friends.button.loading.invite_request_pending": "Ожиданіе подтвержденія",
	"gui.friends.button.loading.join_request_pending": "Ожиданіе подтвержденія",
	"gui.friends.cancel_request": "Отмѣнить запросъ",
	"gui.friends.confirm_title": "Подтвердить",
	"gui.friends.confirm_unfriend": "Вы дѣйствительно хотите удалить сего игрока изъ списка друзей?",
	"gui.friends.copy_to_clipboard": "Копировать въ буферъ обмѣна",
	"gui.friends.decline": "Отклонить",
	"gui.friends.empty_nickname": "Введите дѣйствительное имя профиля передъ отправкой запроса въ друзья",
	"gui.friends.empty_state": "Добавленные вами друзья будутъ отображаться здѣсь.\n\nУправленіе настройками безопасности доступно черезъ вашъ %s.",
	"gui.friends.empty_state.link": "Учётная запись Microsoft",
	"gui.friends.enter_nickname": "Ввести имя профиля",
	"gui.friends.error.connection_issue": "В настоящій моментъ списокъ друзей не работаетъ.\n\nПопробуйте позже.",
	"gui.friends.error.failed.message": "Не вышло отправить запросъ въ друзья",
	"gui.friends.error.forbidden.message": "Не вышло выполнить дѣйствіе съ другомъ. Возможно, сіе связано съ настройками конфиденціальности учётной записи.",
	"gui.friends.error.generic": "Что-то пошло не такъ — съ возможностью, не съ друзьями!\n\nПопробуйте позже.",
	"gui.friends.error.rateLimited.message": "Слишкомъ много взаимодѣйствій со спискомъ друзей. Ожидайте момента и попробуйте снова.",
	"gui.friends.error.temporary_unavailable": "В настоящій моментъ списокъ друзей не работаетъ.\n\nПопробуйте позже.",
	"gui.friends.error.unavailable.message": "Списокъ друзей недоступенъ. Провѣрьте подключеніе къ сѣти и попробуйте позже.",
	"gui.friends.error.upgrade_needed": "Обновите игру, чтобы получить доступъ къ списку друзей.",
	"gui.friends.error.user_may_lack_active_profile": "Игрока съ такимъ именемъ не существуетъ",
	"gui.friends.join": "Присоединиться",
	"gui.friends.loading_friends": "Загрузка списка друзей...",
	"gui.friends.loading_requests": "Загрузка запросовъ...",
	"gui.friends.manage_account_footer": "Управленіе настройками безопасности доступно черезъ вашъ %s",
	...
	"gui.friends.narration.button.cancel_request": "Нажмите Ввод, чтобы отменить запрос в друзья %s",
	...
	"gui.friends.pending.empty": "Нѣтъ ожидающихъ запросовъ на добавленіе въ друзья",
	"gui.friends.pending.received": "Полученные",
	"gui.friends.pending.sent": "Отправленные",
	"gui.friends.presence.status.offline": "Внѣ сѣти",
	"gui.friends.presence.status.online": "Въ сѣти",
	"gui.friends.presence.status.playing_hosted_server": "В сѣти (міръ)",
	"gui.friends.presence.status.playing_offline": "Въ сѣти (міръ)",
	"gui.friends.presence.status.playing_realms": "Въ сѣти (реалмъ)",
	"gui.friends.presence.status.playing_server": "Въ сѣти (салонъ)",
	"gui.friends.requests_count": "Запросы (%s)",
	"gui.friends.send_request": "Отправить запросъ въ друзья",
	"gui.friends.tab_friends": "Друзья",
	"gui.friends.toast.friend_added.message": "%s принялъ запросъ въ друзья",
	"gui.friends.toast.friend_invited.message": "%s былъ приглашёнъ въ міръ.",
	"gui.friends.toast.friend_removed.message": "%s былъ удалёнъ изъ списка друзей",
	"gui.friends.toast.generic_error": "При обновленіи списка друзей произошла непредвидѣнная ошибка. Попробуйте позже.",
	"gui.friends.toast.host_invite_expired.message": "Срокъ дѣйствія приглашенія для %s на входъ въ сей міръ истёкъ.",
	"gui.friends.toast.invite_from_friend.message": "Игрокъ %s пригласилъ васъ въ свой міръ. Нажмите «%s», чтобы открыть списокъ друзей и присоединиться",
	"gui.friends.toast.join_invite_expired.message": "Приглашеніе присоединиться къ міру игрока %s истекло.",
	"gui.friends.toast.join_request.message": "%s хочетъ войти въ вашъ міръ. Откройте списокъ друзей нажатіемъ «%s» или изъ меню игры.",
	"gui.friends.toast.request_accepted.message": "Теперь вы друзья съ %s",
	"gui.friends.toast.request_received.message": "%s отправилъ запросъ въ друзья",
	"gui.friends.toast.request_sent.message": "Запросъ въ друзья отправленъ игроку %s",
	"gui.friends.toast.request_to_join_friend.message": "Вы запросили присоединеніе къ міру %s",
	"gui.friends.toast.requests_accepted_multiple.message": "%s друзей приняли запросъ",
	"gui.friends.toast.requests_received_multiple.message": "Вы получили %s запросовъ въ друзья",
	"gui.friends.unfriend": "Удалить изъ друзей",
	"gui.game_rule.search": "Поискъ...",
	"gui.hours": "%s часъ(овъ)",
	"gui.language.search": "Поискъ...",
	...
	"gui.packSelection.search": "Поискъ...",
	"gui.privacy_link.message": "Откройте сію ссылку для управленія настройками безопасности и конфиденціальности въ сѣти.",
	"gui.privacy_link.title": "Примѣненіе измѣненій въ настройкахъ Xbox можетъ занять нѣкоторое время.\n\nЕсли они не обновятся, перезапустите игру.",
	"gui.proceed": "Продолжить",
	"gui.recipebook.moreRecipes": "Ещё варіанты — правый щелчокъ",
	"gui.recipebook.next_page": "Вперёдъ",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Назадъ",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "На сего игрока нельзя пожаловаться, поскольку бесѣда отключена или заперта",
	...
	"gui.up": "Вверхъ",
	"gui.waitingForResponse.button.inactive": "Назадъ (%s сек.)",
	"gui.waitingForResponse.title": "Ожиданіе отвѣта отъ салона",
	"gui.yes": "Да",
	...
	"item.minecraft.blue_harness": "Лазурная упряжь",
	...
	"item.minecraft.copper_axe": "Мѣдный топоръ",
	"item.minecraft.copper_boots": "Мѣдные ботинки",
	"item.minecraft.copper_chestplate": "Мѣдный нагрудникъ",
	"item.minecraft.copper_golem_spawn_egg": "Яйцо призыва мѣднаго витязя",
	"item.minecraft.copper_helmet": "Мѣдный шлемъ",
	"item.minecraft.copper_hoe": "Мѣдная мотыга",
	"item.minecraft.copper_horse_armor": "Мѣдная конская броня",
	"item.minecraft.copper_ingot": "Мѣдный слитокъ",
	"item.minecraft.copper_leggings": "Мѣдные поножи",
	"item.minecraft.copper_nautilus_armor": "Мѣдная броня наутилуса",
	"item.minecraft.copper_nugget": "Кусочекъ мѣди",
	"item.minecraft.copper_pickaxe": "Мѣдная кирка",
	"item.minecraft.copper_shovel": "Мѣдная лопата",
	"item.minecraft.copper_spear": "Мѣдное копьё",
	"item.minecraft.copper_sword": "Мѣдный мечъ",
	...
	"item.minecraft.diamond_nautilus_armor": "Діамантовая броня наутилуса",
	"item.minecraft.diamond_pickaxe": "Діамантовая кирка",
	"item.minecraft.diamond_shovel": "Діамантовая лопата",
	"item.minecraft.diamond_spear": "Діамантовое копьё",
	...
	"item.minecraft.gray_harness": "Сѣрая упряжь",
	...
	"item.minecraft.happy_ghast_spawn_egg": "Яйцо призыва счастливаго гаста",
	...
	"item.minecraft.iron_nautilus_armor": "Желѣзная броня наутилуса",
	...
	"item.minecraft.iron_spear": "Желѣзное копьё",
	...
	"item.minecraft.light_gray_harness": "Свѣтлосѣрая упряжь",
	"item.minecraft.lime_bundle": "Яркозелёный мѣшокъ",
	"item.minecraft.lime_dye": "Яркозелёный краситель",
	"item.minecraft.lime_harness": "Яркозелёная упряжь",
	...
	"item.minecraft.music_disc_tears.desc": "Эймосъ Родди — Tears",
	...
	"item.minecraft.netherite_horse_armor": "Нѣдритовая конская броня",
	"item.minecraft.netherite_ingot": "Нѣдритовый слитокъ",
	"item.minecraft.netherite_leggings": "Нѣдритовые поножи",
	"item.minecraft.netherite_nautilus_armor": "Нѣдритовая броня наутилуса",
	...
	"item.minecraft.netherite_spear": "Нѣдритовое копьё",
	...
	"item.minecraft.purple_harness": "Фіолетовая упряжь",
	...
	"item.minecraft.red_harness": "Червонная упряжь",
	...
	"item.minecraft.sulfur_cube_bucket": "Сѣрный кубъ въ ведрѣ",
	"item.minecraft.sulfur_cube_spawn_egg": "Яйцо призыва сѣрнаго куба",
	...
	"item.minecraft.white_harness": "Бѣлая упряжь",
	...
	"item.minecraft.zombie_nautilus_spawn_egg": "Яйцо призыва наутилуса-мертвеца",
	...
	"jukebox_song.minecraft.tears": "Эймосъ Родди — Tears",
	...
	"key.categories.spectator": "Смотритель",
	"key.categories.ui": "Игровой интерфейсъ",
	"key.category.minecraft.creative": "Творческій режимъ",
	"key.category.minecraft.debug": "Отладка",
	"key.category.minecraft.gameplay": "Ходъ игры",
	"key.category.minecraft.inventory": "Инвентарь",
	"key.category.minecraft.misc": "Всякое",
	"key.category.minecraft.movement": "Движеніе",
	"key.category.minecraft.multiplayer": "Игра въ компаніи",
	"key.category.minecraft.spectator": "Режимъ смотрителя",
	"key.chat": "Открыть бесѣду",
	"key.command": "Вводъ приказа",
	"key.debug.clearChat": "Очистить бесѣду",
	"key.debug.copyLocation": "Копировать координаты",
	"key.debug.copyRecreateCommand": "Копировать данныя",
	"key.debug.crash": "Отладочный сбой",
	"key.debug.debugOptions": "Настройки отладки",
	"key.debug.dumpDynamicTextures": "Сохранить динамическія текстуры",
	"key.debug.dumpVersion": "Вывести свѣдѣнія о версіи",
	"key.debug.focusPause": "Пауза при сворачиваніи",
	"key.debug.fpsCharts": "Графики F.P.S.",
	"key.debug.lightmapTexture": "Карта освѣщенія",
	"key.debug.modifier": "Клавиша-модификаторъ отладки",
	"key.debug.networkCharts": "Сѣтевые графики",
	"key.debug.overlay": "Экранъ отладки",
	"key.debug.profiling": "Запускъ/остановка профилированія",
	"key.debug.profilingChart": "Діаграмма профилированія",
	"key.debug.reloadChunk": "Перезагрузить участки",
	"key.debug.reloadResourcePacks": "Перезагрузить наборы вещей",
	"key.debug.showAdvancedTooltips": "Показывать расширенныя подсказки",
	"key.debug.showChunkBorders": "Отображать границы участковъ",
	"key.debug.showHitboxes": "Отображать области уязвимости",
	"key.debug.spectate": "Переключить режимъ смотрителя",
	"key.debug.switchGameMode": "Переключатель режима игры",
	"key.drop": "Выбросить вещь",
	"key.forward": "Вперёдъ",
	"key.friends": "Экранъ друзей",
	...
	"key.quickActions": "Быстрыя дѣйствія",
	"key.right": "Вправо",
	...
	"key.spectatorHotbar": "Выбрать на панели",
	"key.spectatorOutlines": "Подсвѣтка игроковъ",
	"key.sprint": "Бѣгъ",
	"key.swapOffhand": "Замѣнить вещь во второй рукѣ",
	"key.toggleGui": "Переключеніе интерфейса",
	"key.togglePerspective": "Переключить перспективу",
	"key.toggleSpectatorShaderEffects": "Переключеніе эффектовъ шейдеровъ",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Добавленіе салона",
	"manageServer.edit.title": "Свѣдѣнія о салонѣ",
	"manageServer.enterIp": "Адресъ салона",
	"manageServer.enterName": "Названіе салона",
	"manageServer.resourcePack": "Наборы вещей",
	...
	"mco.backup.entry.worldType.experience": "Изслѣдованія",
	"mco.backup.entry.worldType.inspiration": "Вдохновеніе",
	"mco.backup.entry.worldType.minigame": "Мини-игра",
	"mco.backup.entry.worldType.normal": "Обычный",
	"mco.backup.entry.worldType.unknown": "Неизвѣстный",
	...
	"mco.configure.world.buttons.close": "Временно закрыть реалмъ",
	...
	"mco.configure.world.buttons.newworld": "Новый міръ",
	"mco.configure.world.buttons.open": "Переоткрыть реалмъ",
	"mco.configure.world.buttons.options": "Настройки міра",
	"mco.configure.world.buttons.players": "Игроки",
	"mco.configure.world.buttons.region_preference": "Выбрать регіонъ...",
	...
	"mco.configure.world.close.question.line1": "Вы можете временно закрыть свой реалмъ, предотвративъ игру, пока вы вносите измѣненія. Откройте вновь, когда будете готовы.\n\nСіе не отмѣнитъ вашу подписку Realms.",
	"mco.configure.world.close.question.line2": "Вы увѣрены, что хотите продолжить?",
	"mco.configure.world.close.question.title": "Нужно внести измѣненія безъ прерываній?",
	"mco.configure.world.closing": "Временно закрываемъ реалмъ...",
	...
	"mco.configure.world.name.validation.whitespace": "Не должно начинаться или заканчиваться на пробѣлъ. Названіе будетъ обрѣзано.",
	"mco.configure.world.opening": "Открытіе реалма...",
	"mco.configure.world.players.error": "Игрока съ указаннымъ именемъ не существуетъ",
	"mco.configure.world.players.invite.duplicate": "Игрокъ съ указаннымъ именемъ уже былъ приглашёнъ въ реалмъ",
	...
	"mco.configure.world.region_preference": "Предпочтительный регіонъ",
	"mco.configure.world.region_preference.title": "Выборъ предпочтительнаго регіона",
	...
	"mco.configure.world.settings.expired": "Вы не можете редактировать настройки просроченнаго реалма",
	...
	"mco.configure.world.spawnMonsters": "Появленіе тварей",
	...
	"mco.configure.world.switch.slot.subtitle": "Сей міръ пустъ. Выберите, какъ создать вашъ міръ",
	...
	"mco.connect.region": "Регіонъ салона: %s",
	...
	"mco.download.confirmation.line1": "Міръ, который вы хотите скачать, вѣситъ больше, чѣмъ %s",
	...
	"mco.errorMessage.realmsService.configurationError": "При редактированіи настроекъ міра произошла непредвидѣнная ошибка",
	...
	"mco.play.button.realm.closed": "Реалмъ закрытъ",
	...
	"menu.custom_options": "Пользовательскія настройки...",
	"menu.custom_options.title": "Пользовательскія настройки",
	"menu.custom_options.tooltip": "Примѣчаніе: Пользовательскія настройки предоставляются сторонними салонами и/или наборами данныхъ.\nБудьте осторожны!",
	"menu.custom_screen_info.button_narration": "Сие пользовательский экран. Узнать больше.",
	"menu.custom_screen_info.contents": "Содержимое сего экрана предоставляется сторонними салонами и картами, которыя не принадлежатъ и не управляются Mojang Studios или Microsoft.\n\nБудьте осторожны! Внимательно переходите по ссылкамъ и не разглашайте свои личныя данныя (входы, ключъ-фразы и т. п.).\n\nЕсли сей экранъ не даётъ вамъ играть, вы также можете отключиться отъ текущаго салона, нажавъ на кнопку ниже.",
	"menu.custom_screen_info.disconnect": "Пользовательскій экранъ отклонёнъ",
	"menu.custom_screen_info.title": "Свѣдѣнія о пользовательскихъ экранахъ",
	"menu.custom_screen_info.tooltip": "Сіе пользовательскій экранъ. Нажмите, чтобы узнать больше.",
	...
	"menu.multiplayerOptions.applyChanges": "Примѣнить",
	"menu.multiplayerOptions.button": "Игра въ компаніи...",
	"menu.multiplayerOptions.network": "Игра въ компаніи",
	"menu.multiplayerOptions.network.header": "Сѣть",
	"menu.multiplayerOptions.network.lan": "Локальная сѣть",
	"menu.multiplayerOptions.network.lan.tooltip": "Игроки изъ одной сѣти могутъ присоединиться.",
	"menu.multiplayerOptions.network.off": "Выкл.",
	"menu.multiplayerOptions.network.off.tooltip": "Никто не можетъ присоединиться.",
	"menu.multiplayerOptions.network.online": "Въ сѣти",
	"menu.multiplayerOptions.network.online.tooltip": "Друзья въ сѣти могутъ присоединиться.",
	"menu.multiplayerOptions.otherPlayers.header": "Иные игроки",
	"menu.multiplayerOptions.publish.started.lan": "Сей міръ теперь открытъ для локальной сѣти. Портъ: %s",
	"menu.multiplayerOptions.publish.started.online": "Сей міръ теперь открытъ для игры въ компаніи.",
	"menu.multiplayerOptions.publish.stopped": "Сей міръ болѣе не открытъ для игры въ компаніи",
	"menu.multiplayerOptions.title": "Настройки игры въ компаніи",
	...
	"menu.playerReporting.no_players": "Въ сёмъ мірѣ нѣтъ игроковъ, на которыхъ можно пожаловаться",
	"menu.preparingSpawn": "Подготовка области возрожденія: %s%%",
	"menu.quick_actions": "Быстрыя дѣйствія...",
	"menu.quick_actions.title": "Быстрыя дѣйствія",
	...
	"multiplayer.codeOfConduct.check": "Не увѣдомлять о сёмъ кодексѣ поведенія",
	"multiplayer.codeOfConduct.title": "Кодексъ поведенія салона",
	"multiplayer.confirm_command.parse_errors": "Вы пытаетесь выполнить нераспознанный или недопустимый приказъ.\nВы увѣрены?\nПриказъ: %s",
	"multiplayer.confirm_command.permissions_required": "Вы пытаетесь выполнить приказъ, требующій повышенныхъ полномочій.\nСіе можетъ негативно повліять на вашу игру.\nВы увѣрены?\nПриказъ: %s",
	"multiplayer.confirm_command.run_command": "Выполнить приказъ",
	"multiplayer.confirm_command.signature_required": "Вы пытаетесь выполнить приказъ для отправки писемъ отъ вашего имени.\nЕго можно выполнить только изъ бесѣды.\nПриказъ: %s",
	"multiplayer.confirm_command.suggest_command": "Копировать въ окно бесѣды",
	"multiplayer.confirm_command.title": "Подтвердить выполненіе приказа",
	"multiplayer.disconnect.authservers_down": "Службы провѣрки подлинности отключены. Повторите попытку позже.",
	"multiplayer.disconnect.bad_chat_index": "Обнаружено пропущенное или внѣочередное письмо отъ салона",
	...
	"multiplayer.disconnect.banned.reason.default": "Выгнанъ управляющимъ.",
	...
	"multiplayer.disconnect.code_of_conduct": "Салонъ требуетъ принятія кодекса поведенія",
	"multiplayer.disconnect.configuration_error": "Непредвидѣнная ошибка при конфигураціи",
	...
	"multiplayer.message_not_delivered": "Не вышло доставить письмо, провѣрьте журналъ сервера: %s",
	...
	"multiplayer.status.anonymous_player": "Анонимный игрокъ",
	...
	"music.game.a_familiar_room": "Ааронъ Шерофъ — A Familiar Room",
	"music.game.an_ordinary_day": "Куми Таніока — An Ordinary Day",
	"music.game.ancestry": "Лена Рейнъ — Ancestry",
	"music.game.below_and_above": "Эймосъ Родди — Below and Above",
	"music.game.broken_clocks": "Эймосъ Родди — Broken Clocks",
	"music.game.bromeliad": "Ааронъ Шерофъ — Bromeliad",
	"music.game.clark": "C418 — Clark",
	"music.game.comforting_memories": "Куми Таніока — Comforting Memories",
	...
	"music.game.crescent_dunes": "Ааронъ Шерофъ — Crescent Dunes",
	"music.game.danny": "C418 — Danny",
	"music.game.deeper": "Лена Рейнъ — Deeper",
	"music.game.dry_hands": "C418 — Dry Hands",
	"music.game.ebb": "fingerspit — Ebb",
	"music.game.echo_in_the_wind": "Ааронъ Шерофъ — Echo in the Wind",
	"music.game.eld_unknown": "Лена Рейнъ — Eld Unknown",
	"music.game.end.alpha": "C418 — Alpha",
	"music.game.end.boss": "C418 — Boss",
	"music.game.end.the_end": "C418 — The End",
	"music.game.endless": "Лена Рейнъ — Endless",
	"music.game.featherfall": "Ааронъ Шерофъ — Featherfall",
	"music.game.fireflies": "Эймосъ Родди — Fireflies",
	"music.game.floating_dream": "Куми Таніока — Floating Dream",
	"music.game.haggstrom": "C418 — Haggstrom",
	"music.game.home": "fingerspit — Home",
	"music.game.infinite_amethyst": "Лена Рейнъ — Infinite Amethyst",
	"music.game.key": "C418 — Key",
	"music.game.komorebi": "Куми Таніока — komorebi",
	"music.game.left_to_bloom": "Лена Рейнъ — Left to Bloom",
	"music.game.lilypad": "Эймосъ Родди — Lilypad",
	...
	"music.game.nether.crimson_forest.chrysopoeia": "Лена Рейнъ — Chrysopoeia",
	"music.game.nether.dead_voxel": "C418 — Dead Voxel",
	"music.game.nether.nether_wastes.rubedo": "Лена Рейнъ — Rubedo",
	"music.game.nether.soulsand_valley.so_below": "Лена Рейнъ — So Below",
	"music.game.nether.warmth": "C418 — Warmth",
	"music.game.nightly": "fingerspit — Nightly",
	"music.game.one_more_day": "Лена Рейнъ — One More Day",
	"music.game.os_piano": "Эймосъ Родди — O's Piano",
	"music.game.oxygene": "C418 — Oxygène",
	"music.game.pokopoko": "Куми Таніока — pokopoko",
	"music.game.puzzlebox": "Ааронъ Шерофъ — Puzzlebox",
	"music.game.shores": "fingerspit — Shores",
	"music.game.stand_tall": "Лена Рейнъ — Stand Tall",
	"music.game.subwoofer_lullaby": "C418 — Subwoofer Lullaby",
	"music.game.swamp.aerie": "Лена Рейнъ — Aerie",
	"music.game.swamp.firebugs": "Лена Рейнъ — Firebugs",
	"music.game.swamp.labyrinthine": "Лена Рейнъ — Labyrinthine",
	"music.game.sweden": "C418 — Sweden",
	"music.game.watcher": "Ааронъ Шерофъ — Watcher",
	"music.game.water.axolotl": "C418 — Axolotl",
	"music.game.water.dragon_fish": "C418 — Dragon Fish",
	"music.game.water.shuniji": "C418 — Shuniji",
	"music.game.wending": "Лена Рейнъ — Wending",
	"music.game.wet_hands": "C418 — Wet Hands",
	"music.game.yakusoku": "Куми Таніока — yakusoku",
	...
	"options.accessibility.tooltip": "Спеціальныя возможности",
	"options.allowCursorChanges": "Измѣненіе курсора",
	"options.allowCursorChanges.tooltip": "Позволяетъ курсору мыши измѣнять форму при наведеніи на опредѣлённые элементы интерфейса.",
	"options.allowFriendRequests": "Разрѣшить запросы",
	"options.allowFriendRequests.tooltip": "Разрѣшить инымъ игрокамъ отправлять вамъ запросы въ друзья",
	...
	"options.chat.drafts": "Сохранять наброски",
	"options.chat.drafts.tooltip": "Неотправленныя письма сохранятся и могутъ быть отправлены при слѣдующемъ открытіи бесѣды.",
	...
	"options.chunkFade": "Проявленіе участковъ",
	"options.chunkFade.none": "Проявленіе участковъ: Нѣтъ",
	"options.chunkFade.seconds": "Проявленіе участковъ: %s сек.",
	"options.chunkFade.tooltip": "Длительность проявленія участковъ при ихъ первой прогрузкѣ.",
	...
	"options.cutoutLeaves": "Прозрачные листья",
	"options.cutoutLeaves.tooltip": "Позволяетъ видѣть сквозь промежутки въ листьяхъ. Отключеніе улучшаетъ производительность.",
	...
	"options.exclusiveFullscreen": "Прямой выводъ",
	"options.exclusiveFullscreen.warningTooltip": "Прямой выводъ изображенія въ полноэкранномъ режимѣ можетъ помѣшать работѣ нѣкоторыхъ методовъ ввода.",
	...
	"options.friendsList": "Списокъ друзей",
	"options.friendsList.confirm.message": "Используйте списокъ друзей, чтобы отправлять и принимать запросы.\n\nУправляйте настройками безопасности въ сѣти черезъ %s.",
	"options.friendsList.confirm.message.link": "Учётная запись Microsoft",
	"options.friendsList.confirm.title": "Списокъ друзей",
	...
	"options.graphics.custom": "Пользовательскій",
	...
	"options.graphics.preset.tooltip": "Устанавливаетъ настройки изображенія къ оптимальнымъ значеніямъ въ соотвѣтствіи съ желаемымъ качествомъ.",
	...
	"options.graphicsApi": "Изображающій A.P.I.",
	"options.graphicsApi.default": "По умолчанію",
	"options.graphicsApi.opengl": "OpenG.L.",
	"options.graphicsApi.restart": "Вы должны перезапустить игру, чтобы измѣнить изображающій A.P.I.",
	"options.graphicsApi.tooltip": "Выборъ изображающаго A.P.I. для отрисовки. Рекомендуется оставить значеніе по умолчанію, если у васъ нѣтъ вѣской причины для измѣненій.",
	"options.graphicsApi.tooltip.vulkan": "Пробная возможность. Возможно сниженіе производительности или нестабильная работа на нѣкоторыхъ системахъ.",
	"options.graphicsApi.vulkan": "Vulkan (опыты)",
	"options.guiScale": "Интерфейсъ",
	"options.guiScale.auto": "Авто.",
	"options.hidden": "Скрытъ",
	"options.hideLightningFlashes": "Скрыть зарницы",
	"options.hideLightningFlashes.tooltip": "Предотвращаетъ появленіе вспышекъ въ небѣ во время ударовъ молніи или иныхъ эффектовъ окруженія. Сами источники вспышекъ всё ещё будутъ видны.",
	...
	"options.improvedTransparency.tooltip": "Пробный подходъ, использующій экранные шейдеры для отрисовки погоды, облаковъ и частицъ за полупрозрачными блоками и водой.\nСіе повліяетъ на производительность изображаемаго процессора.",
	"options.inGameNotification": "Внутріигровыя увѣдомленія",
	"options.inGameNotification.tooltip": "Увѣдомленія отъ друзей",
	...
	"options.invertMouseX": "Инверсія оси мыши X",
	"options.invertMouseY": "Инверсія оси мыши Y",
	...
	"options.language.tooltip": "Смѣна языка",
	...
	"options.maxAnisotropy": "Анизотропная фильтрація",
	"options.maxAnisotropy.tooltip": "Повышеніе выборки замѣтно улучшаетъ чёткость текстуръ, значительно увеличиваетъ расходъ видеопамяти и можетъ повліять на производительность. Затрагиваетъ работу анизотропной фильтраціи.",
	...
	"options.musicToast": "Оповѣщеніе о мелодіи",
	"options.musicToast.never": "Никогда",
	"options.musicToast.never.tooltip": "Оповѣщеніе о мелодіи не появляется.",
	"options.musicToast.pauseMenu": "Въ меню",
	"options.musicToast.pauseMenu.tooltip": "Оповѣщеніе о воспроизводимой мелодіи постоянно отображается въ меню паузы.",
	"options.musicToast.pauseMenuAndToast": "Въ игрѣ и меню",
	"options.musicToast.pauseMenuAndToast.tooltip": "Отображаетъ оповѣщеніе при началѣ воспроизведенія мелодіи. Такое же оповѣщеніе постоянно отображается въ меню паузы.",
	"options.music_frequency": "Періодичность мелодіи",
	"options.music_frequency.constant": "Постоянная",
	"options.music_frequency.default": "По умолчанію",
	"options.music_frequency.frequent": "Частая",
	"options.music_frequency.tooltip": "Мѣняетъ періодичность воспроизведенія мелодіи въ игровомъ мірѣ.",
	...
	"options.needsRestart": "Для примѣненія настройки требуется перезапускъ.",
	...
	"options.online.friends.header": "Списокъ друзей",
	"options.online.realms.header": "Realms",
	"options.online.servers.header": "Салоны",
	...
	"options.realmsNotifications.button": "Новости и приглашенія",
	...
	"options.renderCloudsDistance": "Дальность облаковъ",
	"options.renderDistance": "Прорисовка",
	"options.resourcepack": "Наборы вещей...",
	"options.restartRequired": "Для примѣненія нѣкоторыхъ измѣненій требуется перезапускъ игры.",
	...
	"options.screenEffectScale.tooltip": "Сила эффектовъ головокруженія и искаженія отъ портала Нѣдра.\nПри низкихъ значеніяхъ эффектъ головокруженія замѣняется зелёнымъ подсвѣчиваніемъ.",
	"options.sensitivity": "Чувствительность",
	"options.sensitivity.max": "УХХХХХХЪ!!!",
	"options.sensitivity.min": "не засни...",
	"options.sharePresence": "Состояніе",
	"options.sharePresence.all": "Видимое",
	"options.sharePresence.all.tooltip": "Состояніе видно друзьямъ. Вы отображаетесь въ сѣти, а иные видятъ, чѣмъ вы заняты.",
	"options.sharePresence.limited": "Частичное",
	"options.sharePresence.limited.tooltip": "Состояніе частичное. Вы отображаетесь въ сѣти, но друзья не видятъ, чѣмъ вы заняты. Вы можете приглашать ихъ въ игру.",
	"options.sharePresence.none": "Невидимое",
	"options.sharePresence.none.tooltip": "Состояніе скрыто отъ друзей. Вы отображаетесь внѣ сѣти.",
	"options.showNowPlayingToast": "Оповѣщеніе о мелодіи",
	"options.showNowPlayingToast.tooltip": "Отображаетъ оповѣщеніе при началѣ воспроизведенія мелодіи. Такое же оповѣщеніе постоянно отображается въ меню паузы.",
	"options.showSubtitles": "Субтитры",
	"options.showSubtitles.tooltip": "Включаетъ отображеніе субтитровъ къ звукамъ, воспроизводимымъ въ игрѣ.",
	...
	"options.sprintWindow": "Интервалъ разбѣга",
	"options.sprintWindow.tooltip": "Временной промежутокъ въ тактахъ, въ которомъ двойное нажатіе клавиши «Вперёдъ» включаетъ бѣгъ.",
	...
	"options.textureFiltering": "Фильтрація текстуръ",
	"options.textureFiltering.anisotropic": "Анизотропная",
	"options.textureFiltering.anisotropic.tooltip": "Аппаратный методъ фильтраціи. Вліяетъ на производительность и можетъ существенно увеличить использованіе видеопамяти. Не поддерживается на нѣкоторыхъ устройствахъ.",
	"options.textureFiltering.none": "Выкл.",
	"options.textureFiltering.none.tooltip": "Текстуры отображаются безъ фильтраціи. При взглядѣ подъ угломъ блоки могутъ выглядѣть размытыми.",
	"options.textureFiltering.rgss": "R.G.S.S.",
	"options.textureFiltering.rgss.tooltip": "(Избыточная выборка со сдвинутой сѣткой)\nМетодъ фильтраціи на основѣ шейдера, который улучшаетъ качество текстуръ съ умѣреннымъ вліяніемъ на производительность.",
	"options.title": "Настройки",
	"options.touchscreen": "Сенсорный режимъ",
	"options.value": "%s",
	"options.video": "Настройки изображенія...",
	"options.video.display.header": "Экранъ",
	"options.video.interface.header": "Интерфейсъ",
	"options.video.preferences.header": "Предпочтенія",
	...
	"options.vignette": "Виньетированіе",
	"options.vignette.tooltip": "Малозамѣтная текстура, которая снижаетъ свѣтлость по краямъ экрана въ тёмныхъ мѣстахъ и предупреждаетъ о близости границы міра.",
	"options.visible": "Показано",
	"options.vsync": "V-Sync",
	"options.weatherRadius": "Эффекты погоды",
	"options.weatherRadius.tooltip": "Радіусъ отрисовки эффектовъ дождя и снѣга. Слабо вліяетъ на производительность.",
	"options.worldOptions.button": "Настройки міра...",
	"options.worldOptions.title": "Настройки міра",
	...
	"pack.incompatible.confirm.unknown": "Сей наборъ неисправенъ или сдѣланъ для неизвѣстной версіи Minecraft и можетъ работать неправильно.",
	...
	"pack.incompatible.unknown": "(Неисправенъ или несовмѣстимъ)",
	...
	"painting.minecraft.dennis.author": "Сара Бовингъ",
	"painting.minecraft.dennis.title": "Деннисъ",
	...
	"realms.configuration.region.australia_east": "Новый Южный Уэльсъ, Австралія",
	"realms.configuration.region.australia_southeast": "Викторія, Австралія",
	"realms.configuration.region.brazil_south": "Бразилія",
	"realms.configuration.region.central_india": "Индія",
	"realms.configuration.region.central_us": "Айова, С.Ш.А.",
	"realms.configuration.region.east_asia": "Гонконгъ",
	"realms.configuration.region.east_us": "Вирджинія, С.Ш.А.",
	"realms.configuration.region.east_us_2": "Сѣверная Каролина, С.Ш.А.",
	"realms.configuration.region.france_central": "Франція",
	"realms.configuration.region.japan_east": "Восточная Японія",
	"realms.configuration.region.japan_west": "Западная Японія",
	"realms.configuration.region.korea_central": "Южная Корея",
	"realms.configuration.region.north_central_us": "Иллинойсъ, С.Ш.А.",
	"realms.configuration.region.north_europe": "Ирландія",
	"realms.configuration.region.south_central_us": "Техасъ, С.Ш.А.",
	"realms.configuration.region.southeast_asia": "Сингапуръ",
	"realms.configuration.region.sweden_central": "Швеція",
	"realms.configuration.region.uae_north": "Объединённые Арабскіе Эмираты (О.А.Э.)",
	"realms.configuration.region.uk_south": "Южная Англія",
	"realms.configuration.region.west_central_us": "Юта, С.Ш.А.",
	"realms.configuration.region.west_europe": "Голандія",
	"realms.configuration.region.west_us": "Калифорнія, С.Ш.А.",
	"realms.configuration.region.west_us_2": "Вашингтонъ, С.Ш.А.",
	"realms.configuration.region_preference.automatic_owner": "Автоматически (владѣлецъ реалма)",
	"realms.configuration.region_preference.automatic_player": "Автоматически (первый присоединившійся)",
	...
	"restrictions_screen.button": "Ограниченія...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Вы можете получать письма отъ игроковъ",
	"restrictions_screen.permission.receive_player_messages.denied": "Вы не можете получать письма отъ игроковъ",
	"restrictions_screen.permission.receive_system_messages.allowed": "Вы можете получать системныя письма отъ салона",
	"restrictions_screen.permission.receive_system_messages.denied": "Вы не можете получать системныя письма отъ салона",
	"restrictions_screen.permission.send_commands.allowed": "Вы можете отправлять приказы",
	"restrictions_screen.permission.send_commands.denied": "Вы не можете отправлять приказы",
	"restrictions_screen.permission.send_messages.allowed": "Вы можете отправлять письма въ бесѣду",
	"restrictions_screen.permission.send_messages.denied": "Вы не можете отправлять письма въ бесѣду",
	"restrictions_screen.title": "Ограниченія",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Создать резервную копію передъ обновленіемъ міра?",
	...
	"selectWorld.backupWarning.file_fixing_required": "Прежде чѣмъ начать игру, необходимо обновить сей міръ. Чтобы избѣжать поврежденія міра, мы настоятельно рекомендуемъ создать резервную копію.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Прежде чѣмъ редактировать сей міръ, необходимо обновить его до послѣдней версіи изъ-за измѣненій въ форматѣ міра.",
	"selectWorld.requiresFileFixingTooltip.play": "Прежде чѣмъ играть въ сёмъ мірѣ, необходимо обновить его до послѣдней версіи изъ-за измѣненій въ форматѣ міра.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Прежде чѣмъ пересоздать сей міръ, необходимо обновить его до послѣдней версіи изъ-за измѣненій въ форматѣ міра.",
	...
	"selectWorld.waitingForBackup.message": "В зависимости от размѣра міра сіе можетъ занять нѣкоторое время. Не закрывайте игру и не выключайте вычислитель.",
	"selectWorld.waitingForBackup.title": "Созданіе резервной копіи",
	...
	"selectWorld.world_gen_settings_access": "Не вышло прочитать или получить доступъ къ файлу настроекъ агрегата созданія міра! %s",
	"selecteWorld.backupRequiredTooltip": "Передъ загрузкой міра необходимо создать резервную копію",
	...
	"soundCategory.ui": "Интерфейсъ",
	"soundCategory.voice": "Дикторъ/Голосъ",
	...
	"stat.minecraft.happy_ghast_one_cm": "Преодолено на счастливомъ гастѣ",
	...
	"stat.minecraft.nautilus_one_cm": "Преодолено на наутилусѣ",
	...
	"subtitles.block.copper_chest.close": "Сундукъ закрывается",
	"subtitles.block.copper_chest.open": "Сундукъ открывается",
	...
	"subtitles.block.deadbush.idle": "Шуршаніе",
	...
	"subtitles.block.dried_ghast.ambient": "Изсохшiй гастъ шипитъ",
	"subtitles.block.dried_ghast.ambient_water": "Изсохшій гастъ впитываетъ влагу",
	"subtitles.block.dried_ghast.place_in_water": "Изсохшiй гастъ взмоченъ",
	"subtitles.block.dried_ghast.transition": "Изсохшему гасту стало лучше",
	"subtitles.block.dry_grass.ambient": "Шумъ вѣтра",
	"subtitles.block.enchantment_table.use": "Чародѣйскій алтарь использованъ",
	"subtitles.block.end_portal.spawn": "Порталъ Энда открытъ",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Сѣрный источникъ извергается",
	"subtitles.block.potent_sulfur.noxious_gas": "Ядовитый газъ выдѣляется",
	...
	"subtitles.block.shelf.multi_swap": "Вещи замѣнены",
	"subtitles.block.shelf.place_item": "Вещь поставлена",
	"subtitles.block.shelf.single_swap": "Вещь замѣнена",
	"subtitles.block.shelf.take_item": "Вещь взята",
	...
	"subtitles.block.trapdoor.close": "Люкъ закрывается",
	"subtitles.block.trapdoor.open": "Люкъ открывается",
	...
	"subtitles.entity.baby_cat.ambient": "Котёнокъ мяукаетъ",
	"subtitles.entity.baby_cat.beg_for_food": "Котёнокъ выпрашиваетъ ѣду",
	"subtitles.entity.baby_cat.death": "Котёнокъ погибаетъ",
	"subtitles.entity.baby_cat.eat": "Котёнокъ ѣстъ",
	"subtitles.entity.baby_cat.hiss": "Котёнокъ шипитъ",
	"subtitles.entity.baby_cat.hurt": "Котёнокъ раненъ",
	"subtitles.entity.baby_cat.purr": "Котёнокъ мурлычетъ",
	"subtitles.entity.baby_chicken.ambient": "Цыплёнокъ пищитъ",
	"subtitles.entity.baby_chicken.death": "Цыплёнокъ погибаетъ",
	"subtitles.entity.baby_chicken.hurts": "Цыплёнокъ раненъ",
	"subtitles.entity.baby_horse.ambient": "Жеребёнокъ ржётъ",
	"subtitles.entity.baby_horse.angry": "Жеребёнокъ ржётъ",
	"subtitles.entity.baby_horse.breathe": "Жеребёнокъ пыхтитъ",
	"subtitles.entity.baby_horse.death": "Жеребёнокъ погибаетъ",
	"subtitles.entity.baby_horse.eat": "Жеребёнокъ ѣстъ",
	"subtitles.entity.baby_horse.hurt": "Жеребёнокъ раненъ",
	"subtitles.entity.baby_horse.land": "Жеребёнокъ приземляется",
	"subtitles.entity.baby_nautilus.ambient": "Маленькій наутилусъ щебечетъ",
	"subtitles.entity.baby_nautilus.ambient_land": "Маленькій наутилусъ щебечетъ",
	"subtitles.entity.baby_nautilus.death": "Маленькій наутилусъ погибаетъ",
	"subtitles.entity.baby_nautilus.death_land": "Маленькій наутилусъ погибаетъ",
	"subtitles.entity.baby_nautilus.eat": "Маленькій наутилусъ ѣстъ",
	"subtitles.entity.baby_nautilus.hurt": "Маленькій наутилусъ раненъ",
	"subtitles.entity.baby_nautilus.hurt_land": "Маленькій наутилусъ раненъ",
	"subtitles.entity.baby_nautilus.swim": "Маленькій наутилусъ плывётъ",
	"subtitles.entity.baby_pig.ambient": "Поросёнокъ хрюкаетъ",
	"subtitles.entity.baby_pig.death": "Поросёнокъ погибаетъ",
	"subtitles.entity.baby_pig.eat": "Поросёнокъ ѣстъ",
	"subtitles.entity.baby_pig.hurt": "Поросёнокъ раненъ",
	"subtitles.entity.baby_wolf.ambient": "Волчёнокъ тявкаетъ",
	"subtitles.entity.baby_wolf.death": "Волчёнокъ погибаетъ",
	"subtitles.entity.baby_wolf.growl": "Волчёнокъ рычитъ",
	"subtitles.entity.baby_wolf.hurt": "Волчёнокъ раненъ",
	"subtitles.entity.baby_wolf.pant": "Волчёнокъ фыркаетъ",
	"subtitles.entity.baby_wolf.whine": "Волчёнокъ скулитъ",
	...
	"subtitles.entity.camel_husk.ambient": "Верблюдъ-кадавръ хрипитъ",
	"subtitles.entity.camel_husk.dash": "Рывокъ верблюда-кадавра",
	"subtitles.entity.camel_husk.dash_ready": "Верблюдъ-кадавръ отдохнулъ",
	"subtitles.entity.camel_husk.death": "Верблюдъ-кадавръ погибаетъ",
	"subtitles.entity.camel_husk.eat": "Верблюдъ-кадавръ ѣстъ",
	"subtitles.entity.camel_husk.hurt": "Верблюдъ-кадавръ раненъ",
	"subtitles.entity.camel_husk.saddle": "Верблюдъ-кадавръ осѣдланъ",
	"subtitles.entity.camel_husk.sit": "Верблюдъ-кадавръ садится",
	"subtitles.entity.camel_husk.stand": "Верблюдъ-кадавръ встаётъ",
	...
	"subtitles.entity.copper_golem.death": "Мѣдный домовёнокъ погибаетъ",
	"subtitles.entity.copper_golem.hurt": "Мѣдный домовёнокъ раненъ",
	"subtitles.entity.copper_golem.item_drop": "Мѣдный домовёнокъ кладётъ вещь",
	"subtitles.entity.copper_golem.item_no_drop": "Мѣдный домовёнокъ не можетъ положить вещь",
	"subtitles.entity.copper_golem.no_item_get": "Мѣдный домовёнокъ берётъ вещь",
	"subtitles.entity.copper_golem.no_item_no_get": "Мѣдный домовёнокъ не можетъ взять вещь",
	"subtitles.entity.copper_golem.spawn": "Мѣдный домовёнокъ появляется",
	"subtitles.entity.copper_golem.spin": "Мѣдный домовёнокъ крутитъ головой",
	"subtitles.entity.copper_golem_become_statue": "Мѣдный домовёнокъ замеръ",
	"subtitles.entity.copper_golem_oxidized.death": "Мѣдный домовёнокъ погибаетъ",
	"subtitles.entity.copper_golem_oxidized.hurt": "Мѣдный домовёнокъ раненъ",
	"subtitles.entity.copper_golem_oxidized.spin": "Мѣдный домовёнокъ крутитъ головой",
	"subtitles.entity.copper_golem_weathered.death": "Мѣдный домовёнокъ погибаетъ",
	"subtitles.entity.copper_golem_weathered.hurt": "Мѣдный домовёнокъ раненъ",
	"subtitles.entity.copper_golem_weathered.spin": "Мѣдный домовёнокъ крутитъ головой",
	...
	"subtitles.entity.ghastling.ambient": "Гастёнокъ воркуетъ",
	"subtitles.entity.ghastling.death": "Гастёнокъ погибаетъ",
	"subtitles.entity.ghastling.hurt": "Гастёнокъ раненъ",
	"subtitles.entity.ghastling.spawn": "Гастёнокъ появляется",
	...
	"subtitles.entity.happy_ghast.ambient": "Счастливый гастъ напѣваетъ",
	"subtitles.entity.happy_ghast.death": "Счастливый гастъ погибаетъ",
	"subtitles.entity.happy_ghast.equip": "Упряжь надѣта",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Счастливый гастъ готовъ",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Счастливый гастъ останавливается",
	"subtitles.entity.happy_ghast.hurt": "Счастливый гастъ раненъ",
	...
	"subtitles.entity.nautilus.ambient": "Наутилусъ стрекочетъ",
	"subtitles.entity.nautilus.ambient_land": "Наутилусъ стрекочетъ",
	"subtitles.entity.nautilus.dash": "Рывокъ наутилуса",
	"subtitles.entity.nautilus.dash_land": "Рывокъ наутилуса",
	"subtitles.entity.nautilus.dash_ready": "Наутилусъ отдохнулъ",
	"subtitles.entity.nautilus.dash_ready_land": "Наутилусъ отдохнулъ",
	"subtitles.entity.nautilus.death": "Наутилусъ погибаетъ",
	"subtitles.entity.nautilus.death_land": "Наутилусъ погибаетъ",
	"subtitles.entity.nautilus.eat": "Наутилусъ ѣстъ",
	"subtitles.entity.nautilus.hurt": "Наутилусъ раненъ",
	"subtitles.entity.nautilus.hurt_land": "Наутилусъ раненъ",
	"subtitles.entity.nautilus.swim": "Наутилусъ плывётъ",
	...
	"subtitles.entity.parched.ambient": "Пустынникъ хруститъ костями",
	"subtitles.entity.parched.death": "Пустынникъ погибаетъ",
	"subtitles.entity.parched.hurt": "Пустынникъ раненъ",
	...
	"subtitles.entity.parrot.imitate.camel_husk": "Попугай хрипитъ какъ верблюдъ-кадавръ",
	...
	"subtitles.entity.parrot.imitate.parched": "Попугай подражаетъ пустыннику",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Попугай стонетъ какъ лошадь-мертвецъ",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Попугай булькаетъ какъ наутилусъ-мертвецъ",
	...
	"subtitles.entity.pig.eat": "Свинья ѣстъ",
	...
	"subtitles.entity.sulfur_cube.absorb": "Сѣрный кубъ заполненъ",
	"subtitles.entity.sulfur_cube.bounce": "Сѣрный кубъ отскакиваетъ",
	"subtitles.entity.sulfur_cube.death": "Сѣрный кубъ погибаетъ",
	"subtitles.entity.sulfur_cube.eject": "Блокъ извлечёнъ",
	"subtitles.entity.sulfur_cube.hit": "Ударъ по сѣрному кубу",
	"subtitles.entity.sulfur_cube.hurt": "Сѣрный кубъ раненъ",
	"subtitles.entity.sulfur_cube.push": "Сѣрный кубъ сдвинутъ",
	"subtitles.entity.sulfur_cube.squish": "Сѣрный кубъ прыгаетъ",
	...
	"subtitles.entity.zombie_horse.angry": "Лошадь-мертвецъ ржётъ",
	"subtitles.entity.zombie_horse.death": "Лошадь-мертвецъ погибаетъ",
	"subtitles.entity.zombie_horse.eat": "Лошадь-мертвецъ ѣстъ",
	"subtitles.entity.zombie_horse.hurt": "Лошадь-мертвецъ ранена",
	"subtitles.entity.zombie_nautilus.ambient": "Наутилусъ-мертвецъ булькаетъ",
	"subtitles.entity.zombie_nautilus.ambient_land": "Наутилусъ-мертвецъ булькаетъ",
	"subtitles.entity.zombie_nautilus.dash": "Рывокъ наутилуса-мертвеца",
	"subtitles.entity.zombie_nautilus.dash_land": "Рывокъ наутилуса-мертвеца",
	"subtitles.entity.zombie_nautilus.dash_ready": "Наутилусъ-мертвецъ отдохнулъ",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Наутилусъ-мертвецъ отдохнулъ",
	"subtitles.entity.zombie_nautilus.death": "Наутилусъ-мертвецъ погибаетъ",
	"subtitles.entity.zombie_nautilus.death_land": "Наутилусъ-мертвецъ погибаетъ",
	"subtitles.entity.zombie_nautilus.eat": "Наутилусъ-мертвецъ ѣстъ",
	"subtitles.entity.zombie_nautilus.hurt": "Наутилусъ-мертвецъ раненъ",
	"subtitles.entity.zombie_nautilus.hurt_land": "Наутилусъ-мертвецъ раненъ",
	"subtitles.entity.zombie_nautilus.swim": "Наутилусъ-мертвецъ плывётъ",
	...
	"subtitles.item.armor.equip_copper": "Треньканье мѣдной брони",
	...
	"subtitles.item.armor.equip_nautilus": "Броня наутилуса надѣта",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Сѣрный кубъ пойманъ",
	...
	"subtitles.item.golden_dandelion.unuse": "Золотой одуванчикъ возобновляетъ ростъ",
	"subtitles.item.golden_dandelion.use": "Золотой одуванчикъ останавливаетъ ростъ",
	...
	"subtitles.item.lead.break": "Поводокъ порвался",
	"subtitles.item.lead.tied": "Поводокъ привязанъ",
	"subtitles.item.lead.untied": "Поводокъ развязанъ",
	"subtitles.item.llama_carpet.unequip": "Ковёръ снятъ",
	...
	"subtitles.item.nautilus_saddle_equip": "Наутилусъ осѣдланъ",
	"subtitles.item.nautilus_saddle_underwater_equip": "Наутилусъ осѣдланъ",
	"subtitles.item.nether_wart.plant": "Ростокъ посаженъ",
	"subtitles.item.ominous_bottle.dispose": "Бутылочка разбивается",
	"subtitles.item.saddle.unequip": "Сѣдло снято",
	"subtitles.item.shears.shear": "Щелчокъ ножницъ",
	"subtitles.item.shears.snip": "Лязгъ ножницъ",
	"subtitles.item.shield.block": "Ударъ по щиту",
	"subtitles.item.shovel.flatten": "Рытьё лопатой",
	"subtitles.item.spear.attack": "Тычокъ копьёмъ",
	"subtitles.item.spear.hit": "Ударъ копьёмъ",
	"subtitles.item.spear.lunge": "Рывокъ съ копьёмъ",
	"subtitles.item.spear.use": "Выставленіе копья",
	"subtitles.item.spear_wood.attack": "Тычокъ копьёмъ",
	"subtitles.item.spear_wood.hit": "Ударъ копьёмъ",
	"subtitles.item.spear_wood.use": "Выставленіе копья",
	...
	"subtitles.item.underwater_saddle.equip": "Сѣдло надѣто",
	...
	"subtitles.weather.end_flash": "Рокотъ зарницы Энда",
	...
	"telemetry.event.graphics_capabilities.description": "Сiе событiе сообщаетъ о возможностяхъ используемаго изображающаго устройства.",
	"telemetry.event.graphics_capabilities.title": "Возможности изображающаго устройства",
	"telemetry.event.optional": "%s (необязательно)",
	"telemetry.event.optional.disabled": "%s (необязательно) — Отключено",
	"telemetry.event.p2p_connection.description": "Сіе событіе помогаетъ намъ оцѣнить надёжность и производительность одноранговыхъ (P.2.P.) соединеній между игроками. Оно фиксируетъ успѣшность подключенія, типъ используемаго кандидата I.C.E. (протокола для установки P.2.P.-соединеній), а также время, затраченное на установку соединенія.",
	"telemetry.event.p2p_connection.title": "Одноранговое соединеніе",
	...
	"telemetry.property.backend_failure_message.title": "Ошибка обработки изображающаго A.P.I.: подробности",
	"telemetry.property.backend_failure_missing_capabilities.title": "Ошибка обработки изображающаго A.P.I.: отсутствующія возможности",
	"telemetry.property.backend_failure_reason.title": "Ошибка обработки изображающаго A.P.I.: причина",
	"telemetry.property.backend_name.title": "Названіе изображающаго A.P.I.",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "Этапъ отказа",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Время установленія интерактивнаго соединенія (I.C.E.) въ миллисекундахъ",
	"telemetry.property.p2p_connection_ice_path.title": "Маршрутъ установленія интерактивнаго соединенія (I.C.E.)",
	"telemetry.property.p2p_connection_local_candidate_type.title": "Типъ локальнаго кандидата",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Типъ удалённаго кандидата",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Время установленія соединенія (въ миллисекундахъ)",
	"telemetry.property.p2p_connection_successful.title": "Успѣшность подключенія",
	"telemetry.property.p2p_connection_total_time_ms.title": "Общее время подключенія (въ миллисекундахъ)",
	...
	"test.error.block_property_mismatch": "Ожидалось свойство %s со значеніемъ %s; получено: %s",
	...
	"test.error.expected_block_present": "Ожидалось наличіе блока %s",
	...
	"test.error.invalid_block_type": "Найденъ неожиданный типъ блока: %s",
	"test.error.missing_block_entity": "Ожидался блокъ-сущность",
	"test.error.not_a_block_item": "Указанный блокъ не имѣетъ подходящей ему вещи",
	...
	"test.error.sequence.minimum_tick": "Завершено до указаннаго такта: ожидалось прождать %s",
	"test.error.sequence.not_completed": "Время отладки истекло до завершенія послѣдовательности",
	"test.error.set_biome": "Не вышло задать біомъ для отладки",
	...
	"test.error.value_not_in_between": "Ожидалось %s между %s и %s, получено %s",
	...
	"test_instance.action.reset": "Остановить и загрузить",
	"test_instance.action.run": "Загрузить и запустить",
	"test_instance.action.save": "Сохранить конструкцію",
	"test_instance.description.batch": "Среда: %s",
	"test_instance.description.failed": "Ошибка: %s",
	...
	"test_instance_block.size": "Размѣръ отладочной конструкціи",
	...
	"title.multiplayer.online": "Игра въ компаніи (въ сѣти)",
	...
	"upgradeWorld.aborted.message": "Сіе можетъ произойти, если иная программа имѣла доступъ къ міру во время обновленія. Перезапустите вычислитель и повторите попытку. Если проблема не устраняется, сообщите объ ошибкѣ.",
	"upgradeWorld.aborted.reportBug": "Сообщить объ ошибкѣ",
	"upgradeWorld.aborted.title": "Не вышло обновить міръ",
	"upgradeWorld.canceled.message": "Міръ остаётся такимъ, какимъ былъ прежде.",
	"upgradeWorld.canceled.title": "Обновленіе міра отмѣнено",
	"upgradeWorld.done": "Обновленіе міра завершено",
	"upgradeWorld.failed_cleanup.message": "Міръ успѣшно обновлёнъ до текущей версіи и теперь доступенъ въ спискѣ міровъ. Мы столкнулись съ проблемами при очисткѣ устарѣвшихъ данныхъ, поэтому названіе папки міра было измѣнено на %s.",
	"upgradeWorld.failed_cleanup.title": "Міръ успѣшно обновлёнъ",
	"upgradeWorld.info.converted": "Обновлено: %s",
	"upgradeWorld.info.file_fix_stage": "Этапъ: %s/%s",
	"upgradeWorld.info.scanning": "Сканированіе файловъ...",
	"upgradeWorld.info.total": "Всего: %s",
	"upgradeWorld.joinNow": "Хотите присоединиться к міру сейчасъ?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Перемѣщеніе файловъ",
	"upgradeWorld.progress.type.legacy_structures": "Обновленіе устарѣвшихъ строеній",
	"upgradeWorld.progress.type.region": "Обновленіе регіоновъ",
	"upgradeWorld.symlink.message": "Выбранный міръ содержитъ символьныя ссылки.\nНѣкоторые шаги, требуемые для обновленія міра до текущей версіи, не поддерживаютъ использованіе символьныхъ ссылокъ. Чтобы обновить міръ, сначала замѣните ссылки реальными файлами.",
	"upgradeWorld.symlink.title": "Невозможно обновить міръ",
	"upgradeWorld.title": "Обновленіе файловъ міра",
}
