// Code generated by tools/gen_lang.go from 26.1/oc_fr.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advancements.adventure.blowback.description": "Aucís un ventolet amb siá pròpria carga de vent.",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Aplicatz aquelas ondraduras almens un còp : de las torres, dels morres, de las còstelas, dels abisses, del silenci, dels vex, de las marèas e dels correires.",
	...
	"argument.entity.options.dx.description": "Entitas entre x e x + dx",
	"argument.entity.options.dy.description": "Entitas entre y e y + dy",
	"argument.entity.options.dz.description": "Entitas entre z e z + dz",
	...
	"argument.pos.mixed": "Impossible de mesclar de las coordenadas localas e de mond (tot deu utilizar ^ o non)",
	...
	"argument.resource_or_id.no_such_element": "Se pòt pas trobar l'element \"%s\" dins lo registre \"%s\"",
	...
	"arguments.swizzle.invalid": "Combinacion dels axes pas valid, combinacion de \"x\", \"y\" e \"z\" esperada",
	...
	"block.minecraft.acacia_shelf": "Estaudèla en cacièr",
	...
	"block.minecraft.bamboo_shelf": "Estaudèla en bambó",
	...
	"block.minecraft.birch_shelf": "Estaudèla en bèç",
	...
	"block.minecraft.cherry_shelf": "Estaudèla en cerièis",
	...
	"block.minecraft.crimson_shelf": "Estaudèla cremesina",
	...
	"block.minecraft.dark_oak_shelf": "Estaudèla en euse escur",
	...
	"block.minecraft.jungle_shelf": "Estaudèla de jungla",
	...
	"block.minecraft.mangrove_shelf": "Estaudèla en manglièr",
	...
	"block.minecraft.oak_shelf": "Estaudèla en euse",
	...
	"block.minecraft.pale_oak_shelf": "Estaudèla en euse palle",
	...
	"block.minecraft.spruce_shelf": "Estaudèla en avet",
	...
	"block.minecraft.warped_shelf": "Estaudèla bescornuda",
	...
	"block.minecraft.weathered_copper_chain": "Cadena de Coire Usada",
	...
	"block.minecraft.weathered_copper_golem_statue": "Estatua de Golèm de Coire Usada",
	...
	"book.edit.title": "Ecran de modificacion del libre",
	...
	"book.page_button.next": "Pagina Seguenta",
	"book.page_button.previous": "Pagina Precedenta",
	"book.sign.title": "Ecran de signatura del libre",
	"book.sign.titlebox": "Títol",
	"book.signButton": "Signar",
	"book.view.title": "Ecran de lectura del libre",
	...
	"commands.datapack.create.invalid_full_name": "Novèl nom de pack '%s' non valid",
	...
	"commands.dialog.clear.multiple": "Los dialògs son estats esfaçats per %s jogaires",
	"commands.dialog.clear.single": "Los dialògs son estats esfaçats per %s",
	"commands.dialog.show.multiple": "Lo dialòg es estat afichat per %s jogaires",
	"commands.dialog.show.single": "Lo dialòg es estat afichat per %s",
	...
	"commands.kick.singleplayer.failed": "Se pòt pas expulsar un jogador d'una partida pas en linha",
	...
	"commands.perf.stopped": "Arrèst del profilador tecnic après %s segonda(s) e %s cicle(s) (%s cicle(s) per segonda)",
	...
	"commands.waypoint.modify.style": "Estile del punt de repèr",
	...
	"gamerule.locatorBar": "Activar la barra de posicion dels jogaires",
	"gamerule.locatorBar.description": "Quand es activat, una barra s'aficha sus l'ecran per indicar la direccion dels jogaires.",
	...
	"gui.up": "Amont",
	"gui.waitingForResponse.button.inactive": "Tornar (%ss)",
	"gui.waitingForResponse.title": "En espèra del Servidor",
	"gui.yes": "Òc",
	...
	"item.minecraft.music_disc_lava_chicken": "Disc de musica",
	...
	"item.minecraft.music_disc_tears": "Disc de musica",
	...
	"item.minecraft.smithing_template.armor_trim.ingredients": "Lingòts e cristaus",
	...
	"jigsaw_block.placement_priority.tooltip": "Òrdre dins lo qual la pèça sus la quala se connecta aquel bloc de puzzle es tractada demest los ligams d'una estructura mai larga.\n\nLo processús se desròtla dins l'òrdre descreissent, en seguent l'òrdre d'insercion se i a egalitat.",
	"jigsaw_block.pool": "Lista de cèls:",
	"jigsaw_block.selection_priority": "Prioritat de seleccion:",
	"jigsaw_block.selection_priority.tooltip": "Òrdre dins lo qual aquel bloc de puzzle ensaja de se connectar a sa pèça cibla quand la pèça parenta es tractada pels connexions.\n\nLo processús se desròtla dins l'òrdre descreissent, o de biais aleatòri se i a egalitat.",
	...
	"key.quickActions": "Accions Rapidas",
	...
	"known_server_link.community_guidelines": "Directivas de la comunitat",
	...
	"mco.backup.entry.gameServerVersion": "Version del servidor de jòc",
	"mco.backup.entry.name": "Nom",
	"mco.backup.entry.seed": "Grana",
	"mco.backup.entry.templateName": "Nom del modèl",
	"mco.backup.entry.undefined": "Cambiament indefinit",
	...
	"mco.backup.info.title": "Cambiaments dempuèi lo darrièr rescat",
	...
	"mco.client.outdated.stable.version": "La version de vòstre client (%s) es pas compatibla amb Realms.\nMercé d'utilizar la version mai recente de Minecraft.",
	"mco.client.unsupported.snapshot.version": "La version de vòstre client (%s) es pas compatibla amb Realms.\n\nRealms es pas disponible per aquesta version de Snapshot.",
	"mco.compatibility.downgrade": "Retrogradation",
	"mco.compatibility.downgrade.description": "Aqueste mond foguèt jogat per darrièra còp amb la version %s; sètz en version %s. Retrogradar un mond pòt causat de corrupcion - nos pòdem pas garantir qu'el se cargarà o funcionarà.\nUna còpia de seguretat de vòstre mond serà enregistrada dins \"Còpias de seguretat del mond\". Mercé de restaurar vòstre mond se es necessari.",
	"mco.compatibility.incompatible.popup.title": "Version incompatibla",
	"mco.compatibility.incompatible.releaseType.popup.message": "Lo mond al qual volètz participar es incompatibla amb la version que sètz.",
	"mco.compatibility.incompatible.series.popup.message": "Aqueste mond foguèt jogat l'ultima vegada amb la version %s; vos sètz sus la version %s.\n\nAquestas sèrias son pas compatiblas entre elas. Cal un nau mond per jogar amb aquesta version.",
	"mco.compatibility.unverifiable.message": "La version amb la quala aqueste mond foguèt jogat l'ultima vegada pòt pas èsser verificada. Se lo mond es actualizat o retrogradat, una còpia de seguretat serà creada automaticament e guardada dins « Còpias de seguretat dels monds ».",
	"mco.compatibility.unverifiable.title": "La compatibilitat pòt pas èsser verificada",
	"mco.compatibility.upgrade": "Melhorament",
	"mco.compatibility.upgrade.description": "Aqueste mond foguèt jogat per darrièra còp amb la version %s, sètz en version %s.\n\nUna còpia de seguretat de vòstre mond serà enregistrada dins \"Còpias de seguretat del mond\".\n\nMercé de restaurar vòstre mond se es necessari.",
	"mco.compatibility.upgrade.friend.description": "Aqueste mond foguèt jogat per darrièra còp amb la version %s, sètz en version %s.\n\nUna còpia de seguretat de vòstre mond serà enregistrada dins \"Còpias de seguretat del mond\".\n\nLo proprietari del Realm pòt restaurar lo mond se es necessari.",
	"mco.compatibility.upgrade.title": "Volètz realament actualizar aqueste mond ?",
	...
	"mco.configure.world.buttons.newworld": "Nau Mond",
	...
	"mco.configure.world.buttons.region_preference": "Seleccionar la region...",
	"mco.configure.world.buttons.resetworld": "Reinicializar lo monde",
	"mco.configure.world.buttons.save": "Enregistrar",
	...
	"mco.configure.world.close.question.line1": "Pòdes barrar temporàriament ton Realm per empachar los jogaires d'i jogar del temps que fas d'ajustaments. Torna-o obrir quand ès prèst.\n\nAquò anulla pas ton abonament a Realms.",
	"mco.configure.world.close.question.line2": "Sètz segur de voler far aquò ?",
	"mco.configure.world.close.question.title": "Cal modificar sens interrompre ?",
	...
	"mco.configure.world.loading": "Cargament del Realm",
	...
	"mco.configure.world.players.inviting": "Convidant jogador...",
	"mco.configure.world.players.title": "Jogaires",
	"mco.configure.world.pvp": "PVP",
	"mco.configure.world.region_preference": "Preferéncia de region",
	"mco.configure.world.region_preference.title": "Seleccion de region",
	...
	"mco.configure.world.resourcepack.question": "Avètz besonh d'un paquet de ressorsas personalizat per jogar sus aqueste Reialme.\n\nVòlez telecargar-lo e jogar ?",
	...
	"mco.configure.world.settings.expired": "Podètz pas modificar los paramètres d'un Realm expirat",
	...
	"mco.configure.world.subscription.recurring.info": "Los cambiaments fachs al vòstre abonament a Realms, coma la prolongacion o la desactivacion de la facturacion periodica, seràn pas tenguts en compte abans la data de facturacion que ven.",
	...
	"mco.connect.region": "Region del servidor : %s",
	...
	"mco.download.confirmation.oversized": "Lo mond que volètz telecargar a una talha mai granda que %s\n\nPoiretz pas mai mandar aquel mond sul vòstre Realm",
	...
	"mco.errorMessage.6005": "Mond blocat",
	"mco.errorMessage.6006": "Lo mond es pas a jorn",
	"mco.errorMessage.6007": "Utilizaire dins tròp de Realms",
	...
	"mco.errorMessage.initialize.failed": "Impossible d’inicializar lo Realm",
	"mco.errorMessage.noDetails": "Detalhs de l’error pas provesits",
	"mco.errorMessage.realmsService": "Se a produch un error (%s) :",
	"mco.errorMessage.realmsService.configurationError": "Edicion d’un emplaçament de Realm pas actiu e imprevist",
	...
	"mco.errorMessage.realmsService.unknownCompatibility": "Se pòt pas verificar la version compatible, responsa obtenguda : %s",
	"mco.errorMessage.retry": "Tornar ensajar l'operacion",
	"mco.errorMessage.serviceBusy": "Realms es ocupat d'aquesta passa.\nEnsaja de te reconnecter a ton Realm dins qualques minutas.",
	"mco.gui.button": "Boton",
	"mco.gui.ok": "D'acòrdi",
	"mco.info": "Informacions !",
	"mco.invited.player.narration": "Convit enviat a %s",
	...
	"mco.notification.transferSubscription.message": "Los subrescrits a Java Realms son transferidas cap al Microsoft Store. Daisses pas ton subrescrit expirar !\nTransferís-la ara e profiècha de 30 jorns gratuits sus Realms.\nTorna-te sus ton Perfil sus minecraft.net per transferir ton subrescrit.",
	...
	"mco.play.button.realm.closed": "Lo Realm es estat barrat",
	...
	"mco.selectServer.create.subtitle": "Selecciona qual mond metre dins ton novèl Realm.",
	...
	"mco.selectServer.noRealms": "As pas l'aire d'aver de Realm. Ajusta un Realm per jogar amb tos amics.",
	...
	"mco.snapshot.createSnapshotPopup.text": "Ès a mand de crear un Realm del Snapshot gratuit que serà associat a ton subrescrit Realms pagant. Aquel novèl Realm del Snapshot serà accessible tant que lo subrescrit pagant es actiu. Ton Realm pagant serà pas afectat.",
	"mco.snapshot.createSnapshotPopup.title": "Vòles crear un Realm del Snapshot ?",
	"mco.snapshot.creating": "Creacion del Realm del Snapshot...",
	"mco.snapshot.description": "Associat a \"%s\"",
	"mco.snapshot.friendsRealm.downgrade": "Deves èsser sus la version %s per rejónher aiceste Realm",
	"mco.snapshot.friendsRealm.upgrade": "%s deu actualizar son Realm abans que pòscas jogar a partir d'aquela version",
	"mco.snapshot.paired": "Aiceste Realm del Snapshot es associat a \"%s\"",
	"mco.snapshot.parent.tooltip": "Utiliza la darrièra version de Minecraft per jogar sus aiceste Realm",
	"mco.snapshot.start": "Comença un Realm del Snapshot gratuit",
	"mco.snapshot.subscription.info": "Aiçò es un Realm del Snapshot associat a lo subrescrit de ton Realm '%s'. Demorarà actiu tant que son Realm associat o serà.",
	"mco.snapshot.tooltip": "Utiliza los Realms del Snapshot per aver un apercebut de las versions venentas de Minecraft, que poirián inclure de novèlas foncionalitats e d'autres cambiaments.\n\nPòdes trobar tos Realms normals dins la version oficiala del jòc.",
	"mco.snapshotRealmsPopup.message": "Los Realms son d'ara enlà disponibles dins los Snapshots a partir del Snapshot 23w41a. Cada subrescrit Realms compren un Realms del Snapshot gratuit, distint de tos Realms Java abituals !",
	"mco.snapshotRealmsPopup.title": "Los Realms son d'ara enlà disponibles dins las versions de desvolopament",
	...
	"mco.upload.failed.too_big.description": "Lo mond causit es tròp voluminós. La talha maximala autorisada es %s.",
	...
	"menu.custom_options": "Opcions personalisadas...",
	"menu.custom_options.title": "Opcions personalisadas",
	"menu.custom_options.tooltip": "Nòta : Las opcions personalizadas son provesidas per servidors et/o contengut tèrç.\nFatz atencion !",
	"menu.custom_screen_info.button_narration": "Aquò es un ecran personalizat. Ne saber mai.",
	"menu.custom_screen_info.contents": "Lo contengut d'aquel ecran es controlat per de servidors e de cartas tèrças que son pas detenguts, espleitats o supervisats per Mojang Studios o Microsoft.\n\nAtencion ! Fasètz mòstra de prudéncia quand seguissètz de ligams et partejatz pas las vòstras informacions personalas, informacions de connexion compresas.\n\nSe aquel ecran vos empacha de jogar, podètz vos desconnectar del servidor actual en clicant lo boton çai-jos.",
	"menu.custom_screen_info.disconnect": "Ecran personalizat fòragetat",
	"menu.custom_screen_info.title": "Nòta a prepaus dels ecrans personalizats",
	"menu.custom_screen_info.tooltip": "Aquò es un ecran personalizat. Clicatz aicí per ne saber mai.",
	...
	"menu.quick_actions": "Accions Rapidas...",
	"menu.quick_actions.title": "Accions Rapidas",
	...
	"multiplayer.confirm_command.parse_errors": "Ensajatz d’executar una comanda desconeguda o invalida.\nSètz segur\u202f ?\nComanda : %s",
	...
	"multiplayer.disconnect.incompatible": "Client incompatible! Se vos plai, utilizatz %s",
	...
	"multiplayer.disconnect.outdated_client": "Client incompatible! Se vos plai, utilizatz %s",
	"multiplayer.disconnect.outdated_server": "Client incompatible! Se vos plai, utilizatz %s",
	...
	"multiplayer.requiredTexturePrompt.line2": "Fòragetar aquel paquet de ressorsa personalizat vos desconnectarà d'aquel servidor.",
	...
	"multiplayer.status.motd.narration": "Messatge del jorn : %s",
	...
	"multiplayer.status.player_count.narration": "%s jogaires sus %s en linha",
	...
	"multiplayer.status.version.narration": "Version del servidor : %s",
	"multiplayer.stopSleeping": "Sortir dau lièch",
	"multiplayer.texturePrompt.failure.line1": "Se pòt pas aplicar lo paquet de ressorsas del servidor.",
	...
	"narrator.position.tab": "Onglet %s sus %s",
	...
	"narrator.select.world_info": "%s seleccionat, jogat pel darrièr còp lo : %s, %s",
	...
	"optimizeWorld.stage.upgrading.chunks": "Mesa a jorn de totes los tròces...",
	"optimizeWorld.stage.upgrading.entities": "Mesa a jorn de totes las entitats...",
	"optimizeWorld.stage.upgrading.poi": "Mesa a jorn de totes los ponches d'interès...",
	"optimizeWorld.title": "Optimizant lo monde \"%s\"",
	"options.accessibility": "Configuracion d'Accessibilitat...",
	"options.accessibility.high_contrast": "Contrast naut",
	...
	"options.accessibility.high_contrast_block_outline": "Contrast naut del contorn dels blòcs",
	...
	"options.accessibility.narrator_hotkey.mac.tooltip": "Permet al narrador d'èsser (des)activat amb \"Cmd + B\".",
	"options.accessibility.narrator_hotkey.tooltip": "Permet al narrador d'èsser (des)activat amb \"Ctrl + B\".",
	...
	"options.graphics.fast.tooltip": "Los grafismes \"rapids\" redusisson la qualitat de la pluèja e de la nèu visibles al ecran.\nLos efièches de tranparéncia son desactivats per d'unes blocs, tal coma las fuèlhas.",
	...
	"options.hideLightningFlashes": "Amagar la lutz daus fólzers",
	...
	"options.inactivityFpsLimit.afk": "Inactiu",
	...
	"options.music_frequency": "Frequéncia de la musica",
	"options.music_frequency.constant": "En continú",
	"options.music_frequency.default": "Per defaut",
	"options.music_frequency.frequent": "Frequenta",
	"options.music_frequency.tooltip": "Cambia la frequéncia a laquala la musica es jogada dins un mond.",
	...
	"options.operatorItemsTab": "Inventari d'operator",
	...
	"options.screenEffectScale.tooltip": "Intensitat dels efièches de distorsion del ecran provocats pel souslèu e los portaus dau Nether.\nSe la valor es flaca, l'efièch de souslèu es remplaçat per un contorn verd.",
	...
	"options.showNowPlayingToast": "Notificacion musicala",
	...
	"pack.dropRejected.message": "Las entradas seguentas èran pas de paquets valids e son pas estats copiats : %s",
	"pack.dropRejected.title": "Entradas fòra de paquet",
	...
	"particle.invalidOptions": "Mèuca de l'analisi sintaxi de las opcions de particulas : %s",
	...
	"realms.configuration.region.australia_east": "Australia (Nòva Galas del Sud)",
	"realms.configuration.region.australia_southeast": "Australia (Victòria)",
	"realms.configuration.region.brazil_south": "Brasil",
	"realms.configuration.region.central_india": "Índia",
	"realms.configuration.region.central_us": "Estats Units (Iowa)",
	"realms.configuration.region.east_asia": "Hong Kong",
	"realms.configuration.region.east_us": "Estats Units (Virgínia)",
	"realms.configuration.region.east_us_2": "Estats Units (Carolina del Nòrd)",
	...
	"realms.configuration.region.korea_central": "Corèa del Sud",
	"realms.configuration.region.north_central_us": "Estats Units (Illinois)",
	"realms.configuration.region.north_europe": "Irlanda",
	"realms.configuration.region.south_central_us": "Estats Units (Tèxas)",
	"realms.configuration.region.southeast_asia": "Singapor",
	"realms.configuration.region.sweden_central": "Suècia",
	"realms.configuration.region.uae_north": "Emirats Arabis Units",
	"realms.configuration.region.uk_south": "Anglatèrra meridionala",
	"realms.configuration.region.west_central_us": "Estats Units (Utah)",
	"realms.configuration.region.west_europe": "Païses Basses",
	"realms.configuration.region.west_us": "Estats Units (Califòrnia)",
	"realms.configuration.region.west_us_2": "Estats Units (Washington)",
	"realms.configuration.region_preference.automatic_owner": "Automatic (ping del proprietari del servidor)",
	"realms.configuration.region_preference.automatic_player": "Automatic (primièr a rejónher lo servidor)",
	"realms.missing.snapshot.error.text": "Los Realms son pas pres en carga per ara dins las versions de desvolopament",
	...
	"resourcePack.high_contrast.name": "Contrast naut",
	...
	"resourcePack.vanilla.name": "Per deca",
	...
	"selectWorld.backupQuestion.snapshot": "Volètz de verai cargar aquèste monde ?",
	...
	"selectWorld.experiments": "Experimentacions",
	...
	"selectWorld.gameMode.hardcore.info": "Coma lo mòde subrevida, mai verrolhat sus la dificultat \"malaisida\". Podètz pas reaparéisser se morissètz.",
	...
	"selectWorld.incompatible.info": "Version incompatibla : %s",
	"selectWorld.incompatible.title": "Version incompatibla",
	...
	"selectWorld.loading_list": "Cargament de la lista dels monds",
	"selectWorld.locked": "Ja obèrt dins una autra instància de Minecraft",
	"selectWorld.mapFeatures": "Estructuras",
	"selectWorld.mapFeatures.info": "Vilatges, varatges, etc.",
	...
	"symlink_warning.message": "Cargar dels monds a comptar de dossièrs contenant dels ligams simbolics pòt presentar un risc se sabètz pas exactament çò que fasètz. Se vos plai, consultatz %s per ne saber mai.",
	"symlink_warning.message.pack": "Cargar dels packs amb ligams simbolics pòt presentar un risc se sabètz pas exactament çò que fasètz. Se vos plai, consultatz %s per ne saber mai.",
	"symlink_warning.message.world": "Cargar dels monds a comptar de dossièrs contenant dels ligams simbolics pòt presentar un risc se sabètz pas exactament çò que fasètz. Se vos plai, consultatz %s per ne saber mai.",
	"symlink_warning.more_info": "Mai d'informacions",
	...
	"telemetry.property.game_version.title": "Version de jòc",
