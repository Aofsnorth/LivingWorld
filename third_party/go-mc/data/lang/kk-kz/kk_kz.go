// Code generated by tools/gen_lang.go from 26.1/kk_kz.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advMode.notEnabled": "Пәрмен блоктары қосылмаған",
	"advMode.notEnabled.spawner": "Жаратқыштар қосылмаған",
	"advMode.previousOutput": "Алдыңғы шығыс",
	"advMode.setCommand": "Блокқа консоль пәрменін беріңіз",
	"advMode.setCommand.disabled": "Пәрмен орнатылды: %s, бірақ пәрмен блоктары өшірулі",
	...
	"advancements.adventure.heart_transplanter.description": "Сықырлаған Жүректі екі Ашық Емен Журегі блогының арасына дұрыс бағытта орналастырыңыз",
	"advancements.adventure.heart_transplanter.title": "Таяқ сүйектен өтеді, найза жүректен өтеді",
	...
	"advancements.adventure.spear_many_mobs.description": "Бес мобты найзаласып бір ұр",
	"advancements.adventure.spear_many_mobs.title": "Шәшлигім-ай!",
	...
	"advancements.adventure.use_lodestone.title": "Қайтамын үйге, көңілді күйде",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Құрғақ гәстті суға сал",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Сергітеді!",
	...
	"advancements.nether.distract_piglin.title": "Алтыным сол!",
	...
	"argument.hexcolor.invalid": "Жарамсыз оналтылық түс коды: '%s'",
	"argument.id.invalid": "Жарамсыз ID",
	"argument.id.unknown": "Белгісіз ID: %s",
	"argument.integer.big": "Бүтін сан %s-н аспауы керек: %s табылды",
	"argument.integer.low": "Бүтін сан кемінде %s болуы керек: %s табылды",
	...
	"argument.resource_or_id.no_such_element": "Элемент '%s' тіркелім '%s' ішінен табылмады",
	...
	"argument.waypoint.invalid": "Таңдалған нысан бағдар нүктесі емес",
	...
	"attribute.name.waypoint_receive_range": "Бағдар нүктесін қабылдау қашықтығы",
	"attribute.name.waypoint_transmit_range": "Бағдар нүктесін жіберу қашықтығы",
	...
	"block.minecraft.acacia_shelf": "Акация сөре",
	...
	"block.minecraft.bamboo_shelf": "Бамбук сөре",
	...
	"block.minecraft.birch_shelf": "Қайың сөре",
	...
	"block.minecraft.cherry_shelf": "Шие сөре",
	...
	"block.minecraft.copper_bars": "Мыс шыбық",
	"block.minecraft.copper_block": "Мыс блок",
	"block.minecraft.copper_bulb": "Мыс шам",
	"block.minecraft.copper_chain": "Мыс шынжыр",
	"block.minecraft.copper_chest": "Мыс сандық",
	"block.minecraft.copper_door": "Мыс есік",
	"block.minecraft.copper_golem_statue": "Мыс големінің мүсіні",
	"block.minecraft.copper_grate": "Мыс тор",
	"block.minecraft.copper_lantern": "Мыс шам",
	"block.minecraft.copper_ore": "Мыс кені",
	"block.minecraft.copper_torch": "Мыс шырақ",
	"block.minecraft.copper_trapdoor": "Мыс қақпақ",
	"block.minecraft.copper_wall_torch": "Дуалдағы мыс шырақ",
	...
	"block.minecraft.crimson_shelf": "Қырмызы сөре",
	...
	"block.minecraft.dark_oak_shelf": "Қара емен сөре",
	...
	"block.minecraft.exposed_copper_bars": "Тозық мыс шыбық",
	"block.minecraft.exposed_copper_bulb": "Тозық мыс шам",
	"block.minecraft.exposed_copper_chain": "Тозық мыс шынжыр",
	"block.minecraft.exposed_copper_chest": "Тозық мыс сандық",
	"block.minecraft.exposed_copper_door": "Тозық мыс есік",
	"block.minecraft.exposed_copper_golem_statue": "Тозық мыс големнің мүсіні",
	"block.minecraft.exposed_copper_grate": "Тозық мыс тор",
	"block.minecraft.exposed_copper_lantern": "Тозық мыс шам",
	...
	"block.minecraft.exposed_lightning_rod": "Тозық жайтартқыш",
	...
	"block.minecraft.golden_dandelion": "Алтын бақбақ",
	...
	"block.minecraft.iron_chain": "Темір шынжыр",
	...
	"block.minecraft.jungle_shelf": "Тропик сөре",
	...
	"block.minecraft.mangrove_shelf": "Мангр сөресі",
	...
	"block.minecraft.oak_shelf": "Емен сөре",
	...
	"block.minecraft.oxidized_copper_bars": "Тотық мыс шыбық",
	"block.minecraft.oxidized_copper_bulb": "Тотық мыс шам",
	"block.minecraft.oxidized_copper_chain": "Тотық мыс шынжыр",
	"block.minecraft.oxidized_copper_chest": "Тотық мыс сандық",
	"block.minecraft.oxidized_copper_door": "Тотық мыс қақпақ",
	"block.minecraft.oxidized_copper_golem_statue": "Тотық мыс големнің мүсіні",
	"block.minecraft.oxidized_copper_grate": "Тотық мыс тор",
	"block.minecraft.oxidized_copper_lantern": "Тотық мыс шам",
	...
	"block.minecraft.oxidized_lightning_rod": "Тотық жайтартқыш",
	...
	"block.minecraft.pale_oak_shelf": "Қу емен сөре",
	...
	"block.minecraft.potted_golden_dandelion": "Құмырадағы алтын бақбақ",
	...
	"block.minecraft.spruce_shelf": "Шырша сөре",
	...
	"block.minecraft.warped_shelf": "Теріс сөре",
	...
	"block.minecraft.waxed_copper_bars": "Балауызды мыс шыбық",
	"block.minecraft.waxed_copper_block": "Балауызды мыс блок",
	"block.minecraft.waxed_copper_bulb": "Балауызды мыс шам",
	"block.minecraft.waxed_copper_chain": "Балауызды мыс шынжыр",
	"block.minecraft.waxed_copper_chest": "Балауызды мыс сандық",
	"block.minecraft.waxed_copper_door": "Балауызды мыс есік",
	"block.minecraft.waxed_copper_golem_statue": "Балауызды мыс големінің мүсіні",
	"block.minecraft.waxed_copper_grate": "Балауызды мыс тор",
	"block.minecraft.waxed_copper_lantern": "Балауызды мыс шам",
	...
	"block.minecraft.waxed_exposed_copper_bars": "Балауызды тозық мыс шыбық",
	"block.minecraft.waxed_exposed_copper_bulb": "Балауызды тозық мыс шам",
	"block.minecraft.waxed_exposed_copper_chain": "Балауызды тозық мыс шынжыр",
	"block.minecraft.waxed_exposed_copper_chest": "Балауызды тозық мыс сандық",
	"block.minecraft.waxed_exposed_copper_door": "Балауызды тозық мыс есік",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Балауызды тозық мыс големнің мүсіні",
	"block.minecraft.waxed_exposed_copper_grate": "Балауызды тозық мыс тор",
	"block.minecraft.waxed_exposed_copper_lantern": "Балауызды тозық мыс шамдал",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Балауызды тозық жайтартқыш",
	"block.minecraft.waxed_lightning_rod": "Балауызды жайтартқыш",
	...
	"block.minecraft.waxed_oxidized_copper_bars": "Балауызды тотық мыс шыбық",
	"block.minecraft.waxed_oxidized_copper_bulb": "Балауызды тотық мыс шам",
	"block.minecraft.waxed_oxidized_copper_chain": "Балауызды тотық мыс шынжыр",
	"block.minecraft.waxed_oxidized_copper_chest": "Балауызды тотық мыс сандық",
	"block.minecraft.waxed_oxidized_copper_door": "Балауызды тотық мыс есік",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Балауызды тотық мыс големнің мүсіні",
	"block.minecraft.waxed_oxidized_copper_grate": "Балауызды тотық мыс тор",
	"block.minecraft.waxed_oxidized_copper_lantern": "Балауызды тотық мыс шамдал",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Балауызды тотық жайтартқыш",
	...
	"block.minecraft.waxed_weathered_copper_bars": "Балауызды көгерген мыс шыбық",
	"block.minecraft.waxed_weathered_copper_bulb": "Балауызды көгерген мыс шам",
	"block.minecraft.waxed_weathered_copper_chain": "Балауызды көгерген мыс шынжыр",
	"block.minecraft.waxed_weathered_copper_chest": "Балауызды көгерген мыс сандық",
	"block.minecraft.waxed_weathered_copper_door": "Балауызды көгерген мыс есік",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Балауызды көгерген мыс големнің мүсіні",
	"block.minecraft.waxed_weathered_copper_grate": "Балауызды көгерген мыс тор",
	"block.minecraft.waxed_weathered_copper_lantern": "Балауызды көгерген мыс шамдал",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Балауызды көгерген жайтартқыш",
	"block.minecraft.weathered_chiseled_copper": "Көгерген оюлы мыс",
	"block.minecraft.weathered_copper": "Көгерген мыс",
	"block.minecraft.weathered_copper_bars": "Көгерген мыс шыбық",
	"block.minecraft.weathered_copper_bulb": "Көгерген мыс шам",
	"block.minecraft.weathered_copper_chain": "Көгерген мыс шынжыр",
	"block.minecraft.weathered_copper_chest": "Көгерген мыс сандық",
	"block.minecraft.weathered_copper_door": "Көгерген мыс есік",
	"block.minecraft.weathered_copper_golem_statue": "Көгерген мыс големнің мүсіні",
	"block.minecraft.weathered_copper_grate": "Көгерген мыс тор",
	"block.minecraft.weathered_copper_lantern": "Көгерген мыс шамдал",
	...
	"block.minecraft.weathered_lightning_rod": "Көгерген жайтартқыш",
	...
	"book.edit.title": "Кітап өңдеу экраны",
	...
	"book.page_button.next": "Келесі бет",
	"book.page_button.previous": "Алдыңғы бет",
	"book.sign.title": "Кітапқа қол қою экраны",
	"book.sign.titlebox": "Тақырып",
	"book.signButton": "Қол қою",
	"book.view.title": "Кітап көру экраны",
	...
	"chat.queue.tooltip": "Келесі хабарды көру үшін бас",
	...
	"commands.datapack.create.already_exists": "«%s» атты жинақ бұрыннан бар",
	"commands.datapack.create.invalid_full_name": "Жаңа жинақтың аты «%s» бола алмайды",
	"commands.datapack.create.invalid_name": "«%s» жинағының атында жарамсыз таңба бар",
	"commands.datapack.create.io_failure": "«%s» атты жинақ жасау мүмкін емес. Жорналды тексеріңіз",
	"commands.datapack.create.metadata_encode_failure": "«%s» жинағының метадеректерін кодтау сәтсіз аяқталды: %s",
	"commands.datapack.create.success": "Жаңадан «%s» жинағы жасалды",
	...
	"commands.dialog.clear.multiple": "%s ойыншына диалог жойылды",
	"commands.dialog.clear.single": "%s нысанына диалог жойылды",
	"commands.dialog.show.multiple": "%s ойыншыға көрсетілген диалог",
	"commands.dialog.show.single": "%s нысанына көрсетілген диалог",
	...
	"commands.fetchprofile.copy_component": "Компонентті көшіру",
	"commands.fetchprofile.copy_text": "%s көшіру",
	"commands.fetchprofile.entity.success": "Resolved profile for entity %s: %s",
	"commands.fetchprofile.failed_to_serialize": "«%s» бейіні сериаланбай қалды",
	"commands.fetchprofile.give_item": "Затты беру",
	"commands.fetchprofile.id.failure": "ID %s бейін табылған жоқ",
	"commands.fetchprofile.id.success": "ID %s бейіні табылды: %s",
	"commands.fetchprofile.name.failure": "«%s» атты бейін табылған жоқ",
	"commands.fetchprofile.name.success": "«%s» атты бейін табылды: %s",
	"commands.fetchprofile.no_profile": "Entity %s has no profile",
	"commands.fetchprofile.summon_mannequin": "Қуыршақ жарату",
	...
	"commands.profile_fetch.copy_component": "Компонентті көшіру",
	"commands.profile_fetch.failed_to_serialize": "«%s» бейіні сериаланбай қалды",
	"commands.profile_fetch.give_item": "Затты беру",
	"commands.profile_fetch.id.failure": "ID %s бейін табылған жоқ",
	"commands.profile_fetch.id.success": "ID %s бейіні табылды: %s",
	"commands.profile_fetch.name.failure": "«%s» атты бейін табылған жоқ",
	"commands.profile_fetch.name.success": "«%s» атты бейін табылды: %s",
	...
	"commands.recipe.give.success.multiple": "%s ойыншыға %s ресеп ашылды",
	...
	"commands.setworldspawn.success.new": "%[6]s әлемінің тірілу нүктесі %[1]s, %[2]s, %[3]s [%[4]s, %[5]s] нүктесінде орнатылды",
	"commands.spawnpoint.success.multiple": "%[6]s ойыншының %[5]s тірілу нүктесі %[1]s, %[2]s, %[3]s [%[4]s] нүктесіне орнатылды",
	"commands.spawnpoint.success.multiple.new": "%[7]s ойыншының %[6]s тірілу нүктесі %[1]s, %[2]s, %[3]s [%[4]s, %[5]s] нүктесіне орнатылды",
	"commands.spawnpoint.success.single": "%[6]s деген ойыншының %[5]s тірілу нүктесі %[1]s, %[2]s, %[3]s [%[4]s] нүктесіне орнатылды",
	"commands.spawnpoint.success.single.new": "%[7]s үшін %[6]s тірілу нүктесі %[1]s, %[2]s, %[3]s [%[4]s, %[5]s] нүктесіне орнатылды",
	"commands.spectate.cannot_spectate": "«%s» бақыланбайды",
	...
	"commands.stopwatch.already_exists": "«%s» секунд өлшеуіші онсыз да бар",
	"commands.stopwatch.create.success": "«%s» секунд өлшеуіші құрылды",
	"commands.stopwatch.does_not_exist": "«%s» секунд өлшеуіші жоқ",
	"commands.stopwatch.query": "«%s» секунд өлшеуіші %s сек бойы соғып тұрды",
	"commands.stopwatch.remove.success": "«%s» секунд өлшеуіші жойылды",
	"commands.stopwatch.restart.success": "«%s» секунд өлшеуіші басынан қосылды",
	"commands.summon.failed": "Нысан пайда болмады",
	"commands.summon.failed.peaceful": "Бейбіт ойында құбыжық жаратылмайды",
	...
	"commands.swing.failed.notliving": "Бұлғайтын нысан табылмады",
	"commands.swing.success.multiple": "%s нысандарының қолын бұлғатты",
	"commands.swing.success.single": "%s қолын бұлғатты",
	...
	"commands.test.clear.error.no_tests": "Тазаратын тест табылған жоқ",
	"commands.test.clear.success": "%s құрылыс тазартылды",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Түртсең, көшіріп аласың",
	...
	"commands.time.no_default_clock": "%s өлшемінде әдепкі сағат жоқ",
	"commands.time.no_time_marker_found": "Time marker %s does not exist for clock %s",
	"commands.time.pause": "%s сағаты тоқтатылды",
	...
	"commands.waypoint.list.empty": "%s бойынша бағдар нүктесі жоқ",
	"commands.waypoint.list.success": "%s бойынша %s бағдар нүктесі: %s",
	"commands.waypoint.modify.color": "Бағдар нүктесінің түсі енді %s",
	"commands.waypoint.modify.color.reset": "Бағдар нүктесінің түсін арылту",
	"commands.waypoint.modify.style": "Бағдар нүктесінің стилі өзгертілді",
	...
	"component.profile.dynamic": "Серпінді",
	...
	"createWorld.customize.buffet.search": "Іздеу...",
	...
	"dataPack.locator_bar.description": "Бірге ойнау кезінде басқа ойыншылардың бағытын көрсетеді",
	"dataPack.locator_bar.name": "Бағыттау жолағы",
	...
	"death.attack.spear": "%[1]s дегенді %[2]s шаншып тастады",
	"death.attack.spear.item": "%[1]s дегенді %[3]s ұстаған %[2]s шаншып тастады",
	...
	"debug.crash.message.rebindable": "%s + %s басылып тұр. Жібермесеңіз, ойын іркіліп қалады.",
	...
	"debug.entry.always": "Әрқашан",
	"debug.entry.currently.alwaysOn": "%s: Қазір әрқашан қосылған",
	"debug.entry.currently.inF3": "%s: Қазір тек F3-те",
	"debug.entry.currently.inOverlay": "%s: Қазір тек оңдау оверлейде",
	"debug.entry.currently.never": "%s: Қазір өшірілген",
	"debug.entry.f3": "F3-те",
	"debug.entry.overlay": "Оверлей режимінде",
	...
	"debug.options.category.renderer": "Бейнелеуіш оңдау",
	"debug.options.category.text": "Оңдау терезесіндегі мәтін",
	"debug.options.help": "F3 + F6 = Оңдау опциясын өңдеу",
	"debug.options.notAllowed.tooltip": "Оңдау ақпары ықшамдалғанда көрінбес",
	"debug.options.profile.default": "Әдепкі профиль",
	"debug.options.profile.performance": "Өнімділік профилі",
	"debug.options.search": "Іздеу...",
	"debug.options.title": "Оңдау опциясы",
	"debug.options.warning": "Бұл баптау сынап көруге ғана арналған. Ол компьютеріңді баяулатып, ойыннан шығарып жіберіп, тақияңды жеп қоюы мүмкін.",
	...
	"debug.profiling.start.rebindable": "%s секундқа профайлиң басталды. %s + %s қолданып ертерек тоқтат",
	...
	"debug.version.header": "Клиент нұсқасы:",
	"debug.version.help": "F3 + V = Клиент нұсқа ақпары",
	...
	"effect.minecraft.breath_of_the_nautilus": "Наутилустың тынысы",
	...
	"enchantment.minecraft.lunge": "Сермеу",
	...
	"entity.minecraft.camel_husk": "Түйе мәйіті",
	...
	"entity.minecraft.copper_golem": "Мыс голем",
	...
	"entity.minecraft.mannequin": "Қуыршақ",
	...
	"entity.minecraft.parched": "Кебір",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Незер болсын",
	"gamerule.allowEnteringNetherUsingPortals.description": "Ойыншылардың Незерге кіре алар-алмасын қадағалайды.",
	...
	"gamerule.commandBlocksEnabled": "Пәрмен блоктары болсын",
	...
	"gamerule.enableCommandBlocks": "Пәрмен блоктары қосылсын",
	...
	"gamerule.locatorBar": "Бағыттау жолағы қосылсын",
	"gamerule.locatorBar.description": "Қосулы кезде, экрандағы жолақ басқа ойыншылардың бағытын белгілейді.",
	...
	"gamerule.minecraft.elytra_movement_check": "Элитра қозғалысы тексерілсін",
	"gamerule.minecraft.fire_spread_radius_around_player": "Оттың жайылу радиусы",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Ойыншы айналасында блоктардағы оттың жайылу радиусы",
	"gamerule.minecraft.player_movement_check": "Ойыншы қозғалысын тексер",
	"gamerule.minecraft.raids": "Шапқын болсын",
	"gamerule.minecraft.universal_anger.description": "Бейтарап моб ашуланса, кінәлі ойыншыны ғана емес, айналасындағы ойыншының бәріне тиісе береді; forgiveDeadPlayers ережесін өшіріп қойса, тіптен жақсы істейді.",
	...
	"gamerule.playersNetherPortalCreativeDelay.description": "Жасампаз режімде Незер порталынан өтуге кететін уақыт (тик).",
	"gamerule.playersNetherPortalDefaultDelay": "Шығармашылықтан басқа режімде Незер порталына кетер уақыт",
	"gamerule.playersNetherPortalDefaultDelay.description": "Жасампаздан басқа режімде Незер порталынан өтуге кететін уақыт (тик).",
	...
	"gamerule.pvp": "PvP болсын",
	"gamerule.pvp.description": "Ойыншылар бірін-бірі зақымдай алар-алмасын қадағалайды.",
	...
	"gamerule.spawnMonsters": "Құбыжықтар болсын",
	"gamerule.spawnMonsters.description": "Құбыжықтырдың болар-болмасын қадағалайды.",
	...
	"gamerule.spawnerBlocksEnabled": "Құбыжық жаратқыш болсын",
	"gamerule.spectatorsGenerateChunks": "Бақылаушы жер бедерін құра алсын",
	"gamerule.tntExplodes": "Динамит жаққанда жарылсын",
	...
	"gui.abuseReport.discard.title": "Шағым‐пікірді жойғыңыз келе ме?",
	...
	"gui.game_rule.search": "Іздеу...",
	"gui.hours": "%s сағат",
	"gui.language.search": "Іздеу...",
	...
	"gui.packSelection.search": "Іздеу...",
	...
	"gui.recipebook.next_page": "Келесі бет",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Алғы бет",
	...
	"gui.stats": "Есеп",
	"gui.stats.none_found": "Статистика табылған жоқ.",
	...
	"gui.up": "Жоғары",
	"gui.waitingForResponse.button.inactive": "Артқа (%s сек.)",
	"gui.waitingForResponse.title": "Серверді күтіп тұрмыз",
	"gui.yes": "Иә",
	...
	"inventory.hotbarInfo": "%[1]s+%[2]s арқылы хотбар сақтау",
	...
	"item.minecraft.black_harness": "Қара жүген",
	...
	"item.minecraft.blue_harness": "Көк жүген",
	...
	"item.minecraft.brown_harness": "Қоңыр жүген",
	...
	"item.minecraft.camel_husk_spawn_egg": "Түйе мәйітінің тұқымы",
	...
	"item.minecraft.copper_axe": "Мыс балта",
	"item.minecraft.copper_boots": "Мыс етік",
	"item.minecraft.copper_chestplate": "Мыс кеудеше",
	"item.minecraft.copper_golem_spawn_egg": "Мыс голем тұқымы",
	"item.minecraft.copper_helmet": "Мыс дулыға",
	"item.minecraft.copper_hoe": "Мыс кетпен",
	"item.minecraft.copper_horse_armor": "Мыс атсауыт",
	"item.minecraft.copper_ingot": "Мыс құйма",
	"item.minecraft.copper_leggings": "Мыс шалбар",
	"item.minecraft.copper_nautilus_armor": "Мыс наутилус сауыты",
	"item.minecraft.copper_nugget": "Мыс кесегі",
	"item.minecraft.copper_pickaxe": "Мыс қайла",
	"item.minecraft.copper_shovel": "Мыс күрек",
	"item.minecraft.copper_spear": "Мыс найза",
	"item.minecraft.copper_sword": "Мыс қылыш",
	...
	"item.minecraft.cyan_harness": "Көкзеңгір жүген",
	...
	"item.minecraft.diamond_nautilus_armor": "Алмас наутилус сауыты",
	"item.minecraft.diamond_pickaxe": "Алмас қайла",
	"item.minecraft.diamond_shovel": "Алмас күрек",
	"item.minecraft.diamond_spear": "Алмас найза",
	...
	"item.minecraft.magenta_harness": "Қызылкүрең жүген",
	...
	"item.minecraft.music_disc_lava_chicken": "Күйтабақ",
	...
	"item.minecraft.music_disc_tears": "Күйтабақ",
	"item.minecraft.music_disc_tears.desc": "Eймос Родди — Tears",
	...
	"item.minecraft.nautilus_spawn_egg": "Наутилус тұқымы",
	...
	"item.minecraft.netherite_horse_armor": "Незерит атсауыт",
	"item.minecraft.netherite_ingot": "Незерит құйма",
	"item.minecraft.netherite_leggings": "Незерит шалбар",
	"item.minecraft.netherite_nautilus_armor": "Незерит наутилус сауыты",
	...
	"item.minecraft.netherite_spear": "Незерит найза",
	...
	"item.minecraft.orange_harness": "Сарғыш жүген",
	...
	"item.minecraft.parched_spawn_egg": "Кебір тұқымы",
	...
	"item.minecraft.pink_harness": "Қызғылт жүген",
	...
	"item.minecraft.purple_harness": "Күлгін жүген",
	...
	"item.minecraft.red_harness": "Қызыл жүген",
	...
	"item.minecraft.stone_spear": "Тас найза",
	...
	"item.minecraft.white_harness": "Ақ жүген",
	...
	"item.minecraft.wooden_spear": "Ағаш найза",
	...
	"item.minecraft.yellow_harness": "Сары жүген",
	"item.minecraft.zoglin_spawn_egg": "Зоглин тұқымы",
	"item.minecraft.zombie_horse_spawn_egg": "Зомби ат тұқымы",
	"item.minecraft.zombie_nautilus_spawn_egg": "Зомби наутилус тұқымы",
	...
	"item.spawn_egg.peaceful": "Бейбіт ойында жоқ",
	...
	"jukebox_song.minecraft.tears": "Еймос Родди – Tears",
	...
	"key.categories.spectator": "Бақылаушы",
	"key.categories.ui": "Ойын интерфейсі",
	"key.category.minecraft.creative": "Шығармашылық режім",
	"key.category.minecraft.debug": "Оңдау",
	"key.category.minecraft.gameplay": "Ойын барысы",
	"key.category.minecraft.inventory": "Инвентар",
	"key.category.minecraft.misc": "Әртүрлі",
	"key.category.minecraft.movement": "Қозғалыс",
	"key.category.minecraft.multiplayer": "Бірге ойнау",
	"key.category.minecraft.spectator": "Бақылаушы",
	"key.chat": "Чатты ашу",
	"key.command": "Пәрмен ашу",
	"key.debug.clearChat": "Чатты тазарту",
	"key.debug.copyLocation": "Координатын көшіріп алу",
	"key.debug.copyRecreateCommand": "Деректі көшіріп алу",
	"key.debug.crash": "Оңдап іркілуі",
	"key.debug.debugOptions": "Оңдау опциясы",
	"key.debug.dumpDynamicTextures": "Серпінді текстураларды сақтау",
	"key.debug.dumpVersion": "Нұсқа ақпарын сақтау",
	"key.debug.focusPause": "Ойын назарсыз қалғанда тоқтасын",
	"key.debug.fpsCharts": "FPS кестесі",
	"key.debug.lightmapTexture": "Жарық карта текстурасы",
	"key.debug.modifier": "Оңдау модификатор пернесі",
	"key.debug.networkCharts": "Желі кестесі",
	"key.debug.overlay": "Оверлей түрту",
	"key.debug.profiling": "Профайлиң бастау/тоқтату",
	"key.debug.profilingChart": "Профайлиң кестесі",
	"key.debug.reloadChunk": "Чанктерді қайта жүктеу",
	"key.debug.reloadResourcePacks": "Ресурс жинағын қайта жүктеу",
	"key.debug.showAdvancedTooltips": "Кеңейген кестені көрсету",
	"key.debug.showChunkBorders": "Чанк шекарасын көрсету",
	"key.debug.showHitboxes": "Хитбокс көрсету",
	"key.debug.spectate": "Бақылау",
	"key.debug.switchGameMode": "Ойын режімін ауыстырғыш",
	...
	"key.spectatorHotbar": "Хотбардан таңдау",
	"key.spectatorOutlines": "Ойыншыларды жарқырату",
	"key.sprint": "Жүгіру",
	"key.swapOffhand": "Екінші қолдағы затты ауыстыру",
	"key.toggleGui": "GUI ауыстыру",
	"key.togglePerspective": "Перспектива ауыстыру",
	"key.toggleSpectatorShaderEffects": "Бақылаушы шейдер әсері",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Сервер қосу",
	"manageServer.edit.title": "Сервер ақпарын өңдеу",
	"manageServer.enterIp": "Сервер мекенжайы",
	"manageServer.enterName": "Сервер атауы",
	"manageServer.resourcePack": "Сервер ресурс жинағы",
	"manageServer.resourcePack.disabled": "Өшірулі",
	"manageServer.resourcePack.enabled": "Қосулы",
	"manageServer.resourcePack.prompt": "Сұралсын",
	...
	"mco.backup.entry.worldType.adventureMap": "Саяхат картасы",
	"mco.backup.entry.worldType.experience": "Сынау",
	"mco.backup.entry.worldType.inspiration": "Шабыт",
	"mco.backup.entry.worldType.minigame": "Миниойын",
	"mco.backup.entry.worldType.normal": "Қалыпты",
	"mco.backup.entry.worldType.unknown": "Белгісіз",
	...
	"mco.configure.world.buttons.newworld": "Жаңа Әлем",
	...
	"mco.configure.world.buttons.region_preference": "Аймақты таңдаңыз...",
	"mco.configure.world.buttons.resetworld": "Әлемді арылту",
	"mco.configure.world.buttons.save": "Сақтау",
	...
	"mco.configure.world.close.question.title": "Үзіліссіз өзгерістер енгізгіңіз келе ме?",
	...
	"mco.configure.world.loading": "Реалм жүктеліп жатыр",
	"mco.configure.world.location": "Орны",
	"mco.configure.world.minigame": "Қазіргі: %s",
	"mco.configure.world.name": "Реалмнің аты",
	"mco.configure.world.name.validation.whitespace": "Басы мен аяқ жағында бос орын тұрмасын. Қысқарып қалады.",
	"mco.configure.world.opening": "Реалм ашып...",
	"mco.configure.world.players.error": "Ондай ойыншы жоқ",
	"mco.configure.world.players.invite.duplicate": "Аты жазылған ойыншы реалмға шақырылып қойған",
	"mco.configure.world.players.inviting": "Ойыншы шақырып...",
	"mco.configure.world.players.title": "Ойыншылар",
	"mco.configure.world.pvp": "PVP",
	"mco.configure.world.region_preference": "Аймақ Таңдау",
	"mco.configure.world.region_preference.title": "Өңір таңдау",
	...
	"mco.configure.world.restore.download.question.line1": "Оңаша әлемдеріңіздің қатарына жүктеп алынады.",
	...
	"mco.configure.world.settings.expired": "Мерзімі өткен ойын әлемінің баптауларын өзгерте алмайсыз",
	...
	"mco.configure.world.spawnMonsters": "Құбыжық болсын",
	"mco.configure.world.spawnNPCs": "NPC жарату",
	"mco.configure.world.spawnProtection": "Бастау нүктесін қорғау",
	"mco.configure.world.spawn_toggle.message": "Бұл баптауды қоссаң, сол түрдің барлық нысаны жойылады",
	"mco.configure.world.spawn_toggle.message.npc": "Бұл баптауды өшірсең, сол түрдің барлық нысаны жойылады (мысалы: шаруа)",
	...
	"mco.configure.world.subscription.tab": "Жазылым",
	...
	"mco.connect.region": "Сервердің аймағы",
	...
	"mco.errorMessage.realmsService.configurationError": "Әлем баптауын өңдегеп жатқанда күтпеген ақау шықты",
	...
	"mco.play.button.realm.closed": "Реалм жабық",
	"mco.question": "Сұрақ",
	...
	"menu.custom_options": "Жеке баптау...",
	"menu.custom_options.title": "Жеке баптау",
	"menu.custom_options.tooltip": "Ескерту: Жеке баптау үшінші тарап серверлері я дерек арқылы ұсынылады.\nАбайлап қолдан!",
	"menu.custom_screen_info.button_narration": "Бұл жеке экран. Көбірек біл.",
	"menu.custom_screen_info.contents": "Бұл экранның мазмұны Mojang Studios немесе Microsoft компанияларына тиесілі емес және олармен басқарылмайтын, қадағаланбайтын үшінші тарап серверлері мен карталары арқылы бекітіледі.\n\nСақ бол! Сілтемелерді ашқанда әрқашан абай бол және ешқашан жеке ақпаратыңмен, соның ішінде тіркелгіге кіру деректеріңмен бөліспе.\n\nЕгер бұл экран ойнауға кедергі келтірсе, төмендегі батырманы пайдаланып осы серверден шыға аласың.",
	"menu.custom_screen_info.disconnect": "Жеке экран қабылданбады",
	"menu.custom_screen_info.title": "Жеке экран туралы ескерту",
	"menu.custom_screen_info.tooltip": "Бұл жеке экран. Көбірек білейін десең мұнда бас.",
	...
	"menu.quick_actions": "Тез әрекет...",
	"menu.quick_actions.title": "Тез әрекет",
	"menu.quit": "Шығу",
	...
	"multiplayer.codeOfConduct.check": "Осы әдеп кодексін қайтадан мәлімдеме",
	"multiplayer.codeOfConduct.title": "Сервердің әдеп кодексі",
	"multiplayer.confirm_command.parse_errors": "Бейтаныс я жарамсыз пәрменді орындамақшысың.\nСенімдісің бе?\nПәрмен: %s",
	"multiplayer.confirm_command.permissions_required": "Әкімшінің рұқсатын қажет ететін пәрменді орындамақшысың.\nОл ойныңа кері әсер беруі мүмкін.\nСенімдісің бе?\nПәрмен: %s",
	"multiplayer.confirm_command.run_command": "Пәрменді іске қосу",
	"multiplayer.confirm_command.signature_required": "Чатқа сенің атыңнан жазатын пәрменді орындамақшысың.\nОл чат арқылы ғана орындалады.\nПәрмен: %s",
	"multiplayer.confirm_command.suggest_command": "Чат экранына көшіру",
	"multiplayer.confirm_command.title": "Пәрмен орындалуын растау",
	...
	"multiplayer.disconnect.banned.reason.default": "Оператор бұғаттап тастады.",
	...
	"multiplayer.disconnect.code_of_conduct": "Сервер әдеп кодексін қабылдауын талап етеді",
	"multiplayer.disconnect.configuration_error": "Конфигурация барысында күтпеген ақау шықты",
	...
	"multiplayer.status.anonymous_player": "Аноним ойыншы",
	...
	"music.game.below_and_above": "Еймос Родди — Below and Above",
	"music.game.broken_clocks": "Еймос Родди — Broken Clocks",
	...
	"music.game.fireflies": "Еймос Родди — Fireflies",
	...
	"music.game.lilypad": "Еймос Родди — Lilypad",
	...
	"music.game.os_piano": "Еймос Родди — O's Piano",
	...
	"narration.checkbox.usage.focused.check": "Enter-ді басып таңдайсың",
	"narration.checkbox.usage.focused.uncheck": "Enter-ді бассаң, таңдауды ап тастайсың",
	"narration.checkbox.usage.hovered": "Ауыстыру үшін сол клик",
	"narration.checkbox.usage.hovered.check": "Сол кликпен таңдайсың",
	"narration.checkbox.usage.hovered.uncheck": "Сол кликпен таңдауыңды ап тастайсың",
	"narration.component_list.usage": "Tab-ты басып келесі элементке өтесің",
	...
	"narration.selection.usage": "Жоғарғы-төменгі батырмаларды басып келесі жазбаға өтесің",
	"narration.slider.usage.focused": "Оң мен сол жақ батырмаларды басып мәнін өзгертесің",
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Enter-ді басып сырғытпаны қозғалтасың",
	"narration.slider.usage.hovered": "Сырғытпаны әрі-бері жылжыта аласың",
	...
	"narration.suggestion.usage.fill.fixed": "Tab-ты басып ұсынысты қолданасың",
	"narration.suggestion.usage.fill.hidable": "Ұсынысты қолдану үшін Tab-ты бас, шығамын десең Escape-ті бас",
	...
	"options.accessibility.narrator_hotkey.mac.tooltip": "«Cmd+B» арқылы дикторды қосып‐өшіруге мүмкіндік береді.",
	"options.accessibility.narrator_hotkey.tooltip": "«Ctrl+B» арқылы дикторды қосып‐өшіруге мүмкіндік береді.",
	...
	"options.allowCursorChanges": "Курсор өзгерсін",
	"options.allowCursorChanges.tooltip": "Тінтуірді интерфейстің белгілі бір бөліктеріне нұсқағанда курсордың пішінін өзгертеді.",
	...
	"options.chat.drafts": "Жөнелтпеген хабарды сақтау",
	"options.chat.drafts.tooltip": "Жөнелтпеген хабар сақталып, чатты келесі ашқанда дайын тұрады.",
	...
	"options.chunkFade": "Чанк айығатын уақыт",
	"options.chunkFade.none": "Чанк көрсетілуі: Жоқ",
	"options.chunkFade.seconds": "Чанк көрсетілуі: %s секунд",
	"options.chunkFade.tooltip": "Бірінші бейнеленген чанк неше секундта көрсетілсін, егер көрсетілсе.",
	"options.chunks": "%s ч.",
	...
	"options.cutoutLeaves": "Көз өтер жапырақтар",
	"options.cutoutLeaves.tooltip": "Жапырақтардың арасынан көруге мүмкіндік береді. Өшіргенде өнімділік артуы мүмкін.",
	...
	"options.graphics.custom": "Баптаулы",
	...
	"options.graphics.preset": "Үлгі",
	"options.graphics.preset.tooltip": "«Сапа мен өнімділік» баптауын қажетті сапаға сәйкес келетін орынды әдепкі мәндерге орнатады.",
	...
	"options.improvedTransparency": "Мөлдірлігі жақсарды",
	"options.improvedTransparency.tooltip": "Ауа райын, бұлттарды және бөлшектерді мөлдір блоктар мен судың артында бейнелеу үшін экран шейдерлерін қолданатын эксперименттік тәсіл.\nГрафикалық процессордың өнімділігіне әсер етеді.",
	...
	"options.inactivityFpsLimit.minimized.tooltip": "Ойын терезесі кішірейсе ғана кадр жиілігін кемітеді.",
	"options.invertMouse": "Тінтуір инверсиясы",
	"options.invertMouseX": "Тінтуірді терістету X",
	"options.invertMouseY": "Тінтуірді терістету Y",
	...
	"options.maxAnisotropy": "Антизатропик филтериң",
	"options.maxAnisotropy.tooltip": "Әрбір деңгей текстуралардың тегіс көрінісін айтарлықтай жақсартады, бірақ өнімділікке әсер етіп, бейнежадты пайдалануды едәуір арттырады. Текстура сүзгілеуін анизотропты режимге қою қажет.",
	"options.mipmapLevels": "Тиянақтау деңгейі",
	"options.modelPart.cape": "Желбегей",
	...
	"options.multiplayer.title": "Баптап алу...",
	"options.multiplier": "%sx",
	"options.musicToast": "Музыка білімпазы",
	"options.musicToast.never": "Ешқашан",
	"options.musicToast.never.tooltip": "Музыка білімпазы көрінеді.",
	"options.musicToast.pauseMenu": "Мәзірді тоқтату",
	...
	"options.musicToast.pauseMenuAndToast": "Мәзірді тоқтатып музыка білімпазы ашылады",
	...
	"options.music_frequency": "Әуен жиілігі",
	"options.music_frequency.constant": "Тұрақты мән",
	"options.music_frequency.default": "Әдепкі",
	"options.music_frequency.frequent": "Жиі",
	"options.music_frequency.tooltip": "Әлемдегі әуен жиілігін өзгертеді.",
	...
	"options.renderCloudsDistance": "Бұлт қашықтығы",
	...
	"options.showNowPlayingToast": "Ойнап жатқан әуенді көрсету",
	...
	"options.showSubtitles.tooltip": "Ойында естілетін дыбыстарға субтитр қосады.",
	...
	"options.sprintWindow": "Sprint уақыт аралығы",
	...
	"options.textureFiltering": "Текстура фильтрі",
	...
	"options.textureFiltering.none": "Жоқ",
	"options.textureFiltering.none.tooltip": "Текстуралар ешқандай сүзгілеусіз бейнеленген. Блоктар бұрыштан қараған бұлдыр көрінуі мүмкін.",
	...
	"options.video.display.header": "Көрсету",
	"options.video.interface.header": "Интерфейс",
	"options.video.preferences.header": "Бапталым",
	"options.video.quality.header": "Сапа мен өнімділік",
	"options.videoTitle": "Графика баптау",
	"options.viewBobbing": "Теңселу",
	"options.vignette": "Виньетті көрсету",
	...
	"options.vsync": "VSync",
	"options.weatherRadius": "Ауа-райы әсері радиусы",
	"options.weatherRadius.tooltip": "Жауын мен қар әсері көрінетін аймақ радиусы. Өнімділікке әсері тым аз.",
	"options.worldOptions.button": "Әлемді баптау...",
	"options.worldOptions.title": "Әлемді баптау",
	...
	"pack.incompatible.confirm.unknown": "Бұл жинақ белгісіз Minecraft нұсқасына жасалған я сынған және дұрыстап жұмыс істемеуі мүмкін.",
	"pack.incompatible.new": "(Жаңарақ Minecraft нұсқасына арналған)",
	"pack.incompatible.old": "(Ескірек Minecraft нұсқасына арналған)",
	"pack.incompatible.unknown": "(Сынды я үйлеспейді)",
	...
	"painting.minecraft.dennis.author": "Сара Бовиң",
	...
	"realms.configuration.region.australia_east": "Жаңа Оңтүстік Уэльс, Аустралия",
	"realms.configuration.region.australia_southeast": "Виктория, Аустралия",
	"realms.configuration.region.brazil_south": "Бразилия",
	"realms.configuration.region.central_india": "Үндістан",
	"realms.configuration.region.central_us": "Айова, АҚШ",
	"realms.configuration.region.east_asia": "Гонконг",
	"realms.configuration.region.east_us": "Вирджиния, АҚШ",
	"realms.configuration.region.east_us_2": "Солтүстік Каролина, АҚШ",
	"realms.configuration.region.france_central": "Франция",
	"realms.configuration.region.japan_east": "Шығыс Жапония",
	"realms.configuration.region.japan_west": "Батыс Жапония",
	"realms.configuration.region.korea_central": "Оңтүстік Корея",
	"realms.configuration.region.north_central_us": "Иллинойс, АҚШ",
	"realms.configuration.region.north_europe": "Ирландия",
	"realms.configuration.region.south_central_us": "Техас, АҚШ",
	"realms.configuration.region.southeast_asia": "Сингапур",
	"realms.configuration.region.sweden_central": "Швеция",
	"realms.configuration.region.uae_north": "Біріккен Араб Әмірліктері (БАӘ)",
	"realms.configuration.region.uk_south": "Оңтүстік Англия",
	"realms.configuration.region.west_central_us": "Юта, АҚШ",
	"realms.configuration.region.west_europe": "Нидерланд",
	"realms.configuration.region.west_us": "Калифорния, АҚШ",
	"realms.configuration.region.west_us_2": "Уошиңтон, АҚШ",
	"realms.configuration.region_preference.automatic_owner": "Аутоматты түрде (Realm иесі)",
	"realms.configuration.region_preference.automatic_player": "Аутоматты түрде (сессияға бірінші қосылған)",
	...
	"snbt.parser.invalid_array_element_type": "Жарамсыз массивтің элемент түрі",
	"snbt.parser.invalid_character_name": "Жарамсыз Unicode символының аты",
	"snbt.parser.invalid_codepoint": "Жарамсыз Unicode символының мәні: %s",
	"snbt.parser.invalid_string_contents": "Жарамсыз тырнақша мазмұны",
	"snbt.parser.invalid_unquoted_start": "Тырнақшасыз жолдар 0-9 цифр, + я - деп бастай алмас",
	"snbt.parser.leading_zero_not_allowed": "Ондық сандар 0-ден бастала алмайды",
	"snbt.parser.no_such_operation": "«%s» секілді еш операция жоқ",
	"snbt.parser.number_parse_failure": "%s нөмірі талдалмай қалды",
	...
	"soundCategory.hostile": "Жауыз мобтар",
	"soundCategory.master": "Жалпы",
	"soundCategory.music": "Әуен",
	"soundCategory.neutral": "Бейбіт мобтар",
	"soundCategory.player": "Ойыншылар",
	"soundCategory.record": "Күйсандықтар",
	"soundCategory.ui": "Интерфейс",
	"soundCategory.voice": "Диктор/Дауыс",
	...
	"stat.minecraft.happy_ghast_one_cm": "Бақытты гәстке мініп өткен жер",
	...
	"stat.minecraft.nautilus_one_cm": "Наутилус үстінде өтілген",
	...
	"subtitles.block.copper_chest.close": "Сандық жабылды",
	"subtitles.block.copper_chest.open": "Сандық ашылды",
	...
	"subtitles.block.deadbush.idle": "Шықыр",
	...
	"subtitles.block.dried_ghast.ambient": "Құрғақ үн",
	"subtitles.block.dried_ghast.ambient_water": "Құрғақ гәст су сіңіріп жатыр",
	"subtitles.block.dried_ghast.place_in_water": "Құрғақ гәст жібіді",
	"subtitles.block.dried_ghast.transition": "Құрғақ гәст тәуір болды",
	"subtitles.block.dry_grass.ambient": "Желдің лебі",
	...
	"subtitles.block.firefly_bush.idle": "Жарқырауық қоңыздар шуылдайды",
	...
	"subtitles.block.shelf.activate": "Сөре белсенді",
	"subtitles.block.shelf.deactivate": "Сөре өшті",
	"subtitles.block.shelf.multi_swap": "Заттар алмасты",
	"subtitles.block.shelf.place_item": "Зат қойылды",
	"subtitles.block.shelf.single_swap": "Зат алмасты",
	"subtitles.block.shelf.take_item": "Зат алынды",
	...
	"subtitles.block.trapdoor.close": "Қақпақ жабылды",
	"subtitles.block.trapdoor.open": "Қақпақ ашылды",
	...
	"subtitles.entity.armadillo.eat": "Кіреукей жеді",
	...
	"subtitles.entity.baby_nautilus.ambient": "Наутилустың төлі шыр етті",
	"subtitles.entity.baby_nautilus.ambient_land": "Наутилыстың төлі шыр етті",
	"subtitles.entity.baby_nautilus.death": "Наутилустың төлі өлді",
	"subtitles.entity.baby_nautilus.death_land": "Наутилустың төлі өлді",
	"subtitles.entity.baby_nautilus.eat": "Наутилустың төлі жеді",
	"subtitles.entity.baby_nautilus.hurt": "Наутилустың төлі жараланды",
	"subtitles.entity.baby_nautilus.hurt_land": "Наутилустың төлі жараланды",
	"subtitles.entity.baby_nautilus.swim": "Наутилустың төлі жүзіп жүр",
	...
	"subtitles.entity.camel_husk.ambient": "Түйе мәйіті қыр етті",
	"subtitles.entity.camel_husk.dash": "Түйе мәйіті жұлқынды",
	"subtitles.entity.camel_husk.dash_ready": "Түйе мәйіті суыды",
	"subtitles.entity.camel_husk.death": "Түйе мәйіті өлді",
	"subtitles.entity.camel_husk.eat": "Түйе мәйіті жем жеді",
	"subtitles.entity.camel_husk.hurt": "Түйе мәйіті жараланды",
	"subtitles.entity.camel_husk.saddle": "Ер салынды",
	"subtitles.entity.camel_husk.sit": "Түйе мәйіті шөкті",
	"subtitles.entity.camel_husk.stand": "Түйе мәйіті түрегелді",
	...
	"subtitles.entity.copper_golem.death": "Мыс голем өлді",
	"subtitles.entity.copper_golem.hurt": "Мыс голем жараланды",
	"subtitles.entity.copper_golem.item_drop": "Мыс голем затты қойды",
	"subtitles.entity.copper_golem.item_no_drop": "Мыс голем затты қоя алмайды",
	"subtitles.entity.copper_golem.no_item_get": "Мыс голем затты алды",
	"subtitles.entity.copper_golem.no_item_no_get": "Мыс голем затты ала алмайды",
	"subtitles.entity.copper_golem.spawn": "Мыс голем пайда болды",
	"subtitles.entity.copper_golem.spin": "Мыс големінің басы айналды",
	"subtitles.entity.copper_golem_become_statue": "Мыс голем қатып қалды",
	"subtitles.entity.copper_golem_oxidized.death": "Мыс голем өлді",
	"subtitles.entity.copper_golem_oxidized.hurt": "Мыс голем жараланды",
	"subtitles.entity.copper_golem_oxidized.spin": "Мыс големінің басы айналды",
	"subtitles.entity.copper_golem_weathered.death": "Мыс голем өлді",
	"subtitles.entity.copper_golem_weathered.hurt": "Мыс голем жараланды",
	"subtitles.entity.copper_golem_weathered.spin": "Мыс големінің басы айналды",
	...
	"subtitles.entity.ghastling.spawn": "Гәсттің төлі пайда болды",
	...
	"subtitles.entity.happy_ghast.equip": "Жүген тағылды",
	...
	"subtitles.entity.happy_ghast.unequip": "Жүген шешілді",
	...
	"subtitles.entity.nautilus.ambient": "Наутилус үп етті",
	"subtitles.entity.nautilus.ambient_land": "Наутилус үп етті",
	"subtitles.entity.nautilus.dash": "Наутилус жұлқынды",
	"subtitles.entity.nautilus.dash_land": "Наутилус жұлқынды",
	"subtitles.entity.nautilus.dash_ready": "Наутилус демалып алды",
	"subtitles.entity.nautilus.dash_ready_land": "Наутилус демалып алды",
	"subtitles.entity.nautilus.death": "Наутилус өлді",
	"subtitles.entity.nautilus.death_land": "Наутилус өлді",
	"subtitles.entity.nautilus.eat": "Наутилус жеді",
	"subtitles.entity.nautilus.hurt": "Наутилус жараланды",
	"subtitles.entity.nautilus.hurt_land": "Наутилус жараланды",
	"subtitles.entity.nautilus.swim": "Наутилус жүзіп жүр",
	...
	"subtitles.entity.parched.ambient": "Кебір шырт етті",
	"subtitles.entity.parched.death": "Кебір өлді",
	"subtitles.entity.parched.hurt": "Кебір жараланды",
	...
	"subtitles.entity.parrot.imitate.camel_husk": "Тоты қыр-қыр етті",
	...
	"subtitles.entity.parrot.imitate.parched": "Тоты шырт-шырт етті",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Тоты ырс етті",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Тоты бүлк-бүлк етті",
	...
	"subtitles.entity.sniffer.eat": "Тіміскі жеді",
	...
	"subtitles.entity.zombie_horse.angry": "Зомби ат кісінеді",
	"subtitles.entity.zombie_horse.death": "Зомби ат өлді",
	"subtitles.entity.zombie_horse.eat": "Зомби ат жеді",
	"subtitles.entity.zombie_horse.hurt": "Зомби ат жараланды",
	"subtitles.entity.zombie_nautilus.ambient": "Зомби наутилус бүлкілдеді",
	"subtitles.entity.zombie_nautilus.ambient_land": "Зомби наутилус бүлкілдеді",
	"subtitles.entity.zombie_nautilus.dash": "Зомби наутилус жұлқынды",
	"subtitles.entity.zombie_nautilus.dash_land": "Зомби наутилус жұлқынды",
	"subtitles.entity.zombie_nautilus.dash_ready": "Зомби наутилус демалып алды",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Зомби наутилус демалып алды",
	"subtitles.entity.zombie_nautilus.death": "Зомби наутилус өлді",
	"subtitles.entity.zombie_nautilus.death_land": "Зомби наутилус өлді",
	"subtitles.entity.zombie_nautilus.eat": "Зомби наутилус төлі жеді",
	"subtitles.entity.zombie_nautilus.hurt": "Зомби наутилус жараланды",
	"subtitles.entity.zombie_nautilus.hurt_land": "Зомби наутилус жараланды",
	"subtitles.entity.zombie_nautilus.swim": "Зомби наутилус жүзіп жүр",
	...
	"subtitles.item.armor.equip_copper": "Мыс голем дыңғырлады",
	...
	"subtitles.item.armor.equip_nautilus": "Наутилус сауыт тақты",
	...
	"subtitles.item.armor.unequip_nautilus": "Наутилус сауытын шешті",
	...
	"subtitles.item.horse_armor.unequip": "Ат сауыты шешілді",
	"subtitles.item.ink_sac.use": "Сия шолп етті",
	"subtitles.item.lead.break": "Бау жыртылды",
	"subtitles.item.lead.tied": "Бау байланды",
	"subtitles.item.lead.untied": "Бау шешілді",
	"subtitles.item.llama_carpet.unequip": "Кілем шешілді",
	...
	"subtitles.item.nautilus_saddle_equip": "Ер салынды",
	"subtitles.item.nautilus_saddle_underwater_equip": "Ер салынды",
	"subtitles.item.nether_wart.plant": "Егу",
	"subtitles.item.ominous_bottle.dispose": "Құты шағылды",
	"subtitles.item.saddle.unequip": "Ер шешілді",
	"subtitles.item.shears.shear": "Қайшы шерт етті",
	"subtitles.item.shears.snip": "Қайшы қырықты",
	"subtitles.item.shield.block": "Қалқан тосты",
	"subtitles.item.shovel.flatten": "Күрек қазды",
	"subtitles.item.spear.attack": "Найза түйреді",
	"subtitles.item.spear.hit": "Найза тиді",
	"subtitles.item.spear.lunge": "Найзаны сермеді",
	"subtitles.item.spear.use": "Найзамен шапты",
	"subtitles.item.spear_wood.attack": "Найза түйреді",
	"subtitles.item.spear_wood.hit": "Найза тиді",
	"subtitles.item.spear_wood.use": "Найзамен шапты",
	...
	"subtitles.item.underwater_saddle.equip": "Ер салынды",
	...
	"subtitles.weather.end_flash": "Енд жарқылы гүрілдеді",
	...
	"test.error.block_property_mismatch": "%s деп күткен сипат %s: %s болды",
	"test.error.block_property_missing": "Блок сипаты жоқ. Сипат %s %s болуын күтеді",
	"test.error.entity_property": "%s нысанының шарты орындалмады: %s",
	"test.error.entity_property_details": "%s нысанының шарты орындалмады: %s. Күткен %s: %s болды",
	"test.error.expected_block": "Күткен блок %s: %s алды",
	"test.error.expected_block_present": "Күткен блок %s болмақ",
	"test.error.expected_block_tag": "#%s ішінде күткен блок: %s алды",
	"test.error.expected_container_contents": "Контейнерде болуы керек: %s",
	"test.error.expected_container_contents_single": "Контейнерде тек бір %s болуы керек",
	"test.error.expected_empty_container": "Контейнер бос болуы керек",
	"test.error.expected_entity": "%s күтілді",
	"test.error.expected_entity_around": "%s, %s,%s аралығында %s бар болуы күтілді",
	"test.error.expected_entity_count": "%s түрінің %s нысаны күтілді; %s табылды",
	"test.error.expected_entity_data": "%s деп күткен нысан деректері: %s болды",
	"test.error.expected_entity_data_predicate": "Нысан деректері мен %s сәйкес келмеді",
	"test.error.expected_entity_effect": "%s әсері %s %s деп күтілді",
	"test.error.expected_entity_having": "Нысан инвентарінде %s болуы керек",
	"test.error.expected_entity_holding": "Нысан %s ұстап тұруы керек",
	"test.error.expected_entity_in_test": "Тестте %s бар болуы күтілді",
	"test.error.expected_entity_not_touching": "%s мен %s, %s, %s қиылысуы күтілмеді (салыстырмалы: %s, %s, %s)",
	"test.error.expected_entity_touching": "%s мен %s, %s,%s қиылысуы күтілді (салыстырмалы: %s, %s, %s)",
	"test.error.expected_item": "Күткен нысан түрі %s",
	...
	"test.error.sequence.invalid_tick": "Жарамсыз тик орындалды: күткен %s",
	"test.error.sequence.minimum_tick": "Succeeded before expected tick: expected to wait %s",
	"test.error.sequence.not_completed": "Тізбек аяқталмай-ақ тест уақыты бітті",
	"test.error.set_biome": "Тестілеуге биом салынбай қалды ",
	"test.error.spawn_failure": "%s нысаны құрылмай қалды",
	"test.error.state_not_equal": "Бұрыс күй. Күткен %s: %s болды",
	"test.error.structure.failure": "%s тест құрылысы орнатылмады",
	"test.error.tick": "%s такте %s",
	"test.error.ticking_without_structure": "Құрылымды орналастырмас бұрын сынау",
	"test.error.timeout.no_result": "%s тик ішінде болмай қалды",
	"test.error.timeout.no_sequences_finished": "%s тик ішінде тізбек аяқталмады",
	"test.error.too_many_entities": "%s, %s, %s аралығында тек бір %s бар болуын күтіліп %s табылды",
	"test.error.unexpected_block": "Блоктін %s болуы күтілмеді",
	"test.error.unexpected_entity": "%s бар болуы күтілмеді",
	...
	"test_instance.description.batch": "Ая: %s",
	...
	"test_instance_block.error.no_test": "Сынағы анықталмағандықтан, %s, %s, %s жердегі сынақ нұсқасын іске қосу мүмкін емес",
	"test_instance_block.error.no_test_structure": "Тест құрылысы жоқтығынан %s, %s, %s жердегі тест нұсқасын іске қосу мүмкін емес",
	"test_instance_block.error.unable_to_save": "%s, %s, %s, жердегі тест нұсқасының тест құрылысы үлгісін сақтау мүмкін емес",
	"test_instance_block.invalid": "[жарамсыз]",
	"test_instance_block.reset_success": "%s тесті сәтті арылтты",
	"test_instance_block.rotation": "Бұру:",
	"test_instance_block.size": "Тест-құрылыс көлемі",
	"test_instance_block.starting": "%s тесті басталып жатыр",
	...
	"upgradeWorld.done": "Әлем жаңарып болды",
	...
	"upgradeWorld.info.converted": "Жаңарту: %s",
	"upgradeWorld.info.file_fix_stage": "Stage: %s/%s",
	"upgradeWorld.info.scanning": "Файлдар сканерленіп...",
	"upgradeWorld.info.total": "Бары: %s",
	"upgradeWorld.joinNow": "Әлемге қазір кіресің бе?",
