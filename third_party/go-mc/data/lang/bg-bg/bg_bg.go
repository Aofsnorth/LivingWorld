// Code generated by tools/gen_lang.go from 26.1/bg_bg.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"accessibility.onboarding.accessibility.button.narration": "Настройки за достъпност",
	...
	"advMode.notEnabled.spawner": "Блоковете за размножаване не са включени",
	"advMode.previousOutput": "Предишен отговор",
	"advMode.setCommand": "Задаване на команда",
	"advMode.setCommand.disabled": "Поставена команда: %s, но командните блокове все още са изключени",
	...
	"advancements.adventure.heart_transplanter.description": "Поставете скърцащо сърце с правилната нагласа между два дънера от блед дъб",
	"advancements.adventure.heart_transplanter.title": "Сърдечен хирург",
	...
	"advancements.adventure.spear_many_mobs.description": "Уцели 5 създания в една атака, използвайки копие",
	"advancements.adventure.spear_many_mobs.title": "На шиш",
	...
	"advancements.adventure.use_lodestone.title": "Провинциална паплач, Заведи Ме Вкъщи",
	...
	"advancements.husbandry.feed_snifflet.description": "Нахранете малък душач",
	"advancements.husbandry.feed_snifflet.title": "Малки душачи",
	...
	"advancements.husbandry.leash_all_frog_variants.description": "Вземете всеки вид жаба на каишка",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Поставете изсушен гаст във вода",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Останете хидратирани!",
	...
	"advancements.husbandry.uh_oh.description": "Накарайте сулфаден куб да погълне блок ТНТ",
	"advancements.husbandry.uh_oh.title": "О, не",
	...
	"argument.hexcolor.invalid": "Невалиден шестнадесетичен код на цвета %s",
	...
	"argument.range.ints": "Позволени са само цели числа",
	...
	"argument.resource_or_id.no_such_element": "Не може да намери елемент %s в регистър %s",
	...
	"argument.waypoint.invalid": "Избраният обект не е пътна точка",
	...
	"attribute.name.air_drag_modifier": "Въздух Плъзгане Модификация",
	...
	"attribute.name.below_name_distance": "Табела Резултат Разстояние",
	...
	"attribute.name.bounciness": "Скокливост",
	"attribute.name.burning_time": "Време за горене",
	"attribute.name.camera_distance": "Разстояние от камерата",
	...
	"attribute.name.friction_modifier": "Модифициране на вибрации",
	...
	"attribute.name.nameplate_distance": "Табела разстояние",
	...
	"attribute.name.waypoint_receive_range": "Обхват на приемане на пътна точка",
	"attribute.name.waypoint_transmit_range": "Обхват на излъчване на пътна точка",
	...
	"biome.minecraft.sulfur_caves": "Сулфадни пещери",
	...
	"block.minecraft.acacia_shelf": "Акациев рафт",
	...
	"block.minecraft.bamboo_shelf": "Бамбуков рафт",
	...
	"block.minecraft.birch_shelf": "Брезов рафт",
	...
	"block.minecraft.cherry_shelf": "Черешов рафт",
	...
	"block.minecraft.chiseled_cinnabar": "Гладък цинабар",
	"block.minecraft.chiseled_copper": "Издялана мед",
	...
	"block.minecraft.chiseled_sulfur": "Насечен Сулфад",
	...
	"block.minecraft.cinnabar": "Цинабар",
	"block.minecraft.cinnabar_brick_slab": "Цинабарен тухлен под",
	"block.minecraft.cinnabar_brick_stairs": "Цинабарни тухлени стъпала",
	"block.minecraft.cinnabar_brick_wall": "Цинабарена тухлена стена",
	"block.minecraft.cinnabar_bricks": "Цинабарени тухли",
	"block.minecraft.cinnabar_slab": "Цинабарен под",
	"block.minecraft.cinnabar_stairs": "Цинабарени стъпала",
	"block.minecraft.cinnabar_wall": "Цинабарена стена",
	...
	"block.minecraft.copper_bars": "Медни решетки",
	"block.minecraft.copper_block": "Блок от мед",
	"block.minecraft.copper_bulb": "Медна крушка",
	"block.minecraft.copper_chain": "Меднa веригa",
	"block.minecraft.copper_chest": "Меден сандък",
	"block.minecraft.copper_door": "Медна врата",
	"block.minecraft.copper_golem_statue": "Статуя на меден голем",
	"block.minecraft.copper_grate": "Медна решетка",
	"block.minecraft.copper_lantern": "Меден фенер",
	"block.minecraft.copper_ore": "Медна руда",
	"block.minecraft.copper_torch": "Медна факла",
	"block.minecraft.copper_trapdoor": "Меден люк",
	"block.minecraft.copper_wall_torch": "Медна стенна факла",
	...
	"block.minecraft.crimson_shelf": "Пурпурен рафт",
	...
	"block.minecraft.dark_oak_shelf": "Чернодъбов рафт",
	...
	"block.minecraft.dried_ghast": "Изсушен Гаст",
	...
	"block.minecraft.exposed_chiseled_copper": "Изложена издялана мед",
	"block.minecraft.exposed_copper": "Изложена мед",
	"block.minecraft.exposed_copper_bars": "Оголени медни решетки",
	"block.minecraft.exposed_copper_bulb": "Изложена медна крушка",
	"block.minecraft.exposed_copper_chain": "Оголена медна верига",
	"block.minecraft.exposed_copper_chest": "Изложен меден сандък",
	"block.minecraft.exposed_copper_door": "Оголена медна врата",
	"block.minecraft.exposed_copper_golem_statue": "Изложена статуя на меден голем",
	"block.minecraft.exposed_copper_grate": "Оголена медна решетка",
	"block.minecraft.exposed_copper_lantern": "Оголен меден фенер",
	"block.minecraft.exposed_copper_trapdoor": "Изложен меден люк",
	"block.minecraft.exposed_cut_copper": "Изложена сечена мед",
	"block.minecraft.exposed_cut_copper_slab": "Изложена плоча от сечена мед",
	"block.minecraft.exposed_cut_copper_stairs": "Изложени стъпала от сечена мед",
	"block.minecraft.exposed_lightning_rod": "Незащитен мълниеотвод",
	...
	"block.minecraft.golden_dandelion": "Златно глухарче",
	...
	"block.minecraft.iron_chain": "Железна верига",
	...
	"block.minecraft.jungle_shelf": "Джунглов рафт",
	...
	"block.minecraft.mangrove_shelf": "Мангров рафт",
	...
	"block.minecraft.netherite_block": "Недърайт блок",
	...
	"block.minecraft.oak_shelf": "Дъбов рафт",
	...
	"block.minecraft.oxidized_chiseled_copper": "Окислена издялана мед",
	"block.minecraft.oxidized_copper": "Окислена мед",
	"block.minecraft.oxidized_copper_bars": "Окислени медни решетки",
	"block.minecraft.oxidized_copper_bulb": "Окислена медна крушка",
	"block.minecraft.oxidized_copper_chain": "Окислена медна верига",
	"block.minecraft.oxidized_copper_chest": "Окислен меден сандък",
	"block.minecraft.oxidized_copper_door": "Окислена медна врата",
	"block.minecraft.oxidized_copper_golem_statue": "Окислена статуя на меден голем",
	"block.minecraft.oxidized_copper_grate": "Окислена медна решетка",
	"block.minecraft.oxidized_copper_lantern": "Окислен меден фенер",
	...
	"block.minecraft.oxidized_lightning_rod": "Окислен мълниеотвод",
	...
	"block.minecraft.pale_oak_shelf": "Бледодъбов рафт",
	...
	"block.minecraft.polished_cinnabar": "Гладък цинабар",
	"block.minecraft.polished_cinnabar_slab": "Гладък цинабарен под",
	"block.minecraft.polished_cinnabar_stairs": "Гладки цинабарени стълби",
	"block.minecraft.polished_cinnabar_wall": "Гладка цинабарена стена",
	...
	"block.minecraft.polished_sulfur": "Полиран сулфаден блок",
	"block.minecraft.polished_sulfur_slab": "Полиран сулфаден под",
	"block.minecraft.polished_sulfur_stairs": "Полирани сулфадни стълби",
	"block.minecraft.polished_sulfur_wall": "Полирана сулфадна стена",
	...
	"block.minecraft.potent_sulfur": "Мощен сулфад",
	...
	"block.minecraft.potted_golden_dandelion": "Саксия със златно глухарче",
	...
	"block.minecraft.sculk_vein": "Скълк жили",
	...
	"block.minecraft.spruce_shelf": "Смърчов рафт",
	...
	"block.minecraft.sulfur": "Сулфад",
	"block.minecraft.sulfur_brick_slab": "Сулфаден тухленен под",
	"block.minecraft.sulfur_brick_stairs": "Сулфадни тухлени стълбо",
	"block.minecraft.sulfur_brick_wall": "Сулфадна тухлена стена",
	"block.minecraft.sulfur_bricks": "Сулфадни тухли",
	"block.minecraft.sulfur_slab": "Сулфаден под",
	"block.minecraft.sulfur_spike": "Сулфурен шип",
	"block.minecraft.sulfur_stairs": "Сулфадни стъпала",
	"block.minecraft.sulfur_wall": "Сулфадна стена",
	...
	"block.minecraft.wall_torch": "Стенна факла",
	...
	"block.minecraft.warped_shelf": "Шантав рафт",
	...
	"block.minecraft.waxed_chiseled_copper": "Ваксирана издялана мед",
	"block.minecraft.waxed_copper_bars": "Запечатани медни решетки",
	"block.minecraft.waxed_copper_block": "Запечатан блок от мед",
	"block.minecraft.waxed_copper_bulb": "Ваксирана медна крушка",
	"block.minecraft.waxed_copper_chain": "Запечатана медна верига",
	"block.minecraft.waxed_copper_chest": "Ваксиран меден сандък",
	"block.minecraft.waxed_copper_door": "Ваксирана медна врата",
	"block.minecraft.waxed_copper_golem_statue": "Ваксирана статуя на меден голем",
	"block.minecraft.waxed_copper_grate": "Ваксирана медна решетка",
	"block.minecraft.waxed_copper_lantern": "Запечатан меден фенер",
	"block.minecraft.waxed_copper_trapdoor": "Ваксиран меден люк",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Ваксирана изложена издялана мед",
	"block.minecraft.waxed_exposed_copper": "Ваксирана изложена мед",
	"block.minecraft.waxed_exposed_copper_bars": "Запечатани оголени медни решетки",
	"block.minecraft.waxed_exposed_copper_bulb": "Ваксирана изложена медна крушка",
	"block.minecraft.waxed_exposed_copper_chain": "Запечатана оголена медна верига",
	"block.minecraft.waxed_exposed_copper_chest": "Ваксиран изложен меден сандък",
	"block.minecraft.waxed_exposed_copper_door": "Ваксирана изложена медна врата",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Ваксирана изложена статуя на меден голем",
	"block.minecraft.waxed_exposed_copper_grate": "Ваксирана изложена медна решетка",
	"block.minecraft.waxed_exposed_copper_lantern": "Запечатан оголен меден фенер",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Ваксиран изложен меден люк",
	"block.minecraft.waxed_exposed_cut_copper": "Ваксирана изложена сечена мед",
	"block.minecraft.waxed_exposed_cut_copper_slab": "Ваксирана изложена плоча от сечена мед",
	"block.minecraft.waxed_exposed_cut_copper_stairs": "Ваксирани изложени стъпала от сечена мед",
	"block.minecraft.waxed_exposed_lightning_rod": "Запечатан незащитен мълниеотвод",
	"block.minecraft.waxed_lightning_rod": "Незащитен мълниеотвод",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Ваксирана окислена издялана мед",
	"block.minecraft.waxed_oxidized_copper": "Запечатана окислена мед",
	"block.minecraft.waxed_oxidized_copper_bars": "Запечатани окислени медни решетки",
	"block.minecraft.waxed_oxidized_copper_bulb": "Ваксирана окислена медна крушка",
	"block.minecraft.waxed_oxidized_copper_chain": "Запечатана окислена медна верига",
	"block.minecraft.waxed_oxidized_copper_chest": "Ваксиран окислен меден сандък",
	"block.minecraft.waxed_oxidized_copper_door": "Ваксирана окислена медна врата",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Ваксирана окислена статуя на меден голем",
	"block.minecraft.waxed_oxidized_copper_grate": "Ваксирана окислена медна решетка",
	"block.minecraft.waxed_oxidized_copper_lantern": "Запечатан окислен меден фенер",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Ваксиран окислен меден люк",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Запечатан окислен мълниеотвод",
	"block.minecraft.waxed_weathered_chiseled_copper": "Ваксирана изветряла издялана мед",
	"block.minecraft.waxed_weathered_copper": "Запечатана ръждясала мед",
	"block.minecraft.waxed_weathered_copper_bars": "Запечатани ръждясали медни решетки",
	"block.minecraft.waxed_weathered_copper_bulb": "Ваксирана изветряла медна крушка",
	"block.minecraft.waxed_weathered_copper_chain": "Запечатана ръждясала медна верига",
	"block.minecraft.waxed_weathered_copper_chest": "Ваксиран изветрял меден сандък",
	"block.minecraft.waxed_weathered_copper_door": "Ваксирана изветряла медна врата",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Ваксирана изветряла статуя на меден голем",
	"block.minecraft.waxed_weathered_copper_grate": "Ваксирана изветряла медна решетка",
	"block.minecraft.waxed_weathered_copper_lantern": "Запечатан ръждясал меден фенер",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Ваксиран изветрял меден люк",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Запечатана ръждясал мълниеотвод",
	"block.minecraft.weathered_chiseled_copper": "Изветряла издялана мед",
	"block.minecraft.weathered_copper": "Ръждясала мед",
	"block.minecraft.weathered_copper_bars": "Ръждясали медни решетки",
	"block.minecraft.weathered_copper_bulb": "Изветряла медна крушка",
	"block.minecraft.weathered_copper_chain": "Ръждясала медна верига",
	"block.minecraft.weathered_copper_chest": "Изветрял меден сандък",
	"block.minecraft.weathered_copper_door": "Изветряла медна врата",
	"block.minecraft.weathered_copper_golem_statue": "Изветряла статуя на меден голем",
	"block.minecraft.weathered_copper_grate": "Изветряла медна решетка",
	"block.minecraft.weathered_copper_lantern": "Ръждясал меден фенер",
	"block.minecraft.weathered_copper_trapdoor": "Изветрял меден люк",
	...
	"block.minecraft.weathered_lightning_rod": "Ръждясал мълниеотвод",
	...
	"book.edit.title": "Екран за редактиране на книга",
	...
	"book.page_button.next": "Следваща страница",
	"book.page_button.previous": "Предишна страница",
	"book.sign.title": "Екран за подписване на книга",
	"book.sign.titlebox": "Заглавие",
	"book.signButton": "Подписване",
	"book.view.title": "Екран за преглед на книга",
	"build.spawn_protection": "%s е под защита на появяване",
	"build.tooHigh": "Максималната височина за строене е %s",
	"build.tooLow": "Минималната височина за строене е %s",
	...
	"chat.queue.tooltip": "Натиснете за да покажете следващото съобщение",
	...
	"chat_restriction.chat_and_commands_disabled_by_options": "Чатът е ограничен в настройките на клиента.",
	"chat_restriction.chat_disabled_by_options": "Чатът на играчите е ограничен в настройките на клиента.",
	"chat_restriction.chat_disabled_by_options.action": "Отидете на екрана настройки на чата",
	"chat_restriction.disabled_by_launcher": "Чатът е ограничен от стартиращата програма",
	"chat_restriction.disabled_by_profile": "Чатът е ограничен от настройките на профила.",
	"chat_restriction.disabled_by_profile.action": "Отидете в настройки на профила си",
	"chat_screen.commands_not_allowed": "Изпращането на команди не е позволено",
	"chat_screen.message": "Съобщение за изпращане: %s",
	"chat_screen.messages_not_allowed": "Изпращането на чат съобщения не е позволено",
	"chat_screen.restricted": "Чатът е ограничен. Натиснете съобщението за повече детайли.",
	"chat_screen.restricted.narration": "Чатът е ограничен. Отидете на екрана Ограничения в Опции на света.",
	...
	"command.trailing_data": "Намерени неописани данни: %s",
	...
	"commands.data.modify.expected_list": "Очаква се списък, получено: %s",
	"commands.data.modify.expected_object": "Очаква се обект, получено: %s",
	...
	"commands.datapack.create.already_exists": "Пакет с име %s вече съществува",
	"commands.datapack.create.invalid_full_name": "Невалидно име на новия пакет %s",
	"commands.datapack.create.invalid_name": "Невалидни символи в името на новия пакет %s",
	"commands.datapack.create.io_failure": "Не може да създаде пакет с име %s, провери регистрите",
	"commands.datapack.create.metadata_encode_failure": "Неуспешно кодиране на метаданни за пакет с име „%s“: %s",
	"commands.datapack.create.success": "Създаде нов пакет с име %s",
	...
	"commands.dialog.clear.multiple": "Изчистен диалог за %s играчите",
	"commands.dialog.clear.single": "Изчистен диалог за %s",
	"commands.dialog.show.multiple": "Изключен диалог за %s играчи",
	"commands.dialog.show.single": "Изключен диалог за %s",
	...
	"commands.fetchprofile.copy_component": "Копиране на елемент",
	"commands.fetchprofile.copy_text": "Копиране на %s",
	"commands.fetchprofile.entity.success": "Разрешен профил за обект %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Неуспешно сериализиране на профила: %s",
	"commands.fetchprofile.give_item": "Дай предмет",
	"commands.fetchprofile.id.failure": "Неуспешно разрешаване на профила за ID %s",
	"commands.fetchprofile.id.success": "Разрешен профил за ID %s: %s",
	"commands.fetchprofile.name.failure": "Неуспешно разрешаване на профила за името %s",
	"commands.fetchprofile.name.success": "Разрешен профил за името %s: %s",
	"commands.fetchprofile.no_profile": "Обект %s няма профил",
	"commands.fetchprofile.summon_mannequin": "Призоваване на Манекен",
	...
	"commands.profile_fetch.copy_component": "Копиране на компонент",
	"commands.profile_fetch.failed_to_serialize": "Неуспешна сериализация на профила: %s",
	"commands.profile_fetch.give_item": "Дай предмет",
	"commands.profile_fetch.id.failure": "Неуспешно разрешаване на профила за id %s",
	"commands.profile_fetch.id.success": "Разрешен профил за id %s: %s",
	"commands.profile_fetch.name.failure": "Неуспешно разрешаване на профила за името %s",
	"commands.profile_fetch.name.success": "Разрешен профил за името %s: %s",
	...
	"commands.setworldspawn.success.new": "Точката на появяване на света беше зададена на %s, %s, %s [%s] в %s",
	"commands.spawnpoint.success.multiple": "Началната точка е зададена на %s, %s, %s [%s] в %s за %s играча",
	"commands.spawnpoint.success.multiple.new": "Задаена начална точка на %s,%s,%s [%s,%s] в%s за%s играча",
	"commands.spawnpoint.success.single": "Началната точка е зададена на %s, %s, %s [%s] в %s за %s",
	"commands.spawnpoint.success.single.new": "Зададена начална точка на %s,%s,%s [%s,%s] в %s за %s",
	"commands.spectate.cannot_spectate": "%s не може да бъде гледан",
	...
	"commands.stopwatch.already_exists": "Хронометър '%s' вече съществува",
	"commands.stopwatch.create.success": "Създаден Хронометър '%s'",
	"commands.stopwatch.does_not_exist": "Хронометър '%s' не съществува",
	"commands.stopwatch.query": "Хронометър '%s' работи за %s",
	"commands.stopwatch.remove.success": "Премахнат Хронометър '%s'",
	"commands.stopwatch.restart.success": "Възстановен Хронометър '%s'",
	"commands.summon.failed": "Обектът не можеше да бъде създаден",
	"commands.summon.failed.peaceful": "Чудовище не може да бъде призовано при мирна трудност",
	...
	"commands.swing.failed.notliving": "Не бяха открити живи обекти за размахване",
	"commands.swing.success.multiple": "Направени %s обекти да размахват ръцете си",
	"commands.swing.success.single": "Направени %s да размахът ръка",
	...
	"commands.team.option.color.clear.success": "Изчистен беше цветът за отбор %s",
	...
	"commands.time.no_default_clock": "Няма часовник по подразбиране в измерение %s",
	"commands.time.no_time_marker_found": "Времевият маркер %s не съществува за часовник %s",
	"commands.time.pause": "Паузиране на часовник %s",
	"commands.time.query": "Времето е %s",
	"commands.time.query.absolute": "Часовник %s е на %s тик(а)",
	"commands.time.query.gametime": "Времето на играта е %s тик(а)",
	"commands.time.query.timeline": "Времевата линия %s е на %s тик(а)",
	"commands.time.query.timeline.repetitions": "Времевата линия %s е преминала %s повторения",
	"commands.time.rate": "Часовник %s сега ще работи в %sx нормална скорост",
	"commands.time.resume": "Възобновен часовник %s",
	"commands.time.set": "Времето беше зададено на %s",
	"commands.time.set.absolute": "Задаване %s на %s тик(а)",
	"commands.time.set.time_marker": "Задаване %s на времеви маркер %s",
	"commands.time.wrong_timeline_for_clock": "Времевата линия %s не е валидна за часовник %s",
	...
	"commands.version.build_time": "време_за_изграждане = %s",
	"commands.version.data": "данни = %s",
	"commands.version.header": "Информация за версията на сървъра:",
	"commands.version.id": "номер = %s",
	"commands.version.name": "име = %s",
	"commands.version.pack.data": "пакетни_данни = %s",
	"commands.version.pack.resource": "пакетни_ресурси = %s",
	...
	"commands.waypoint.list.empty": "Няма пътни точки в %s",
	"commands.waypoint.list.success": "%s пътна(и) точка(и) в %s: %s",
	"commands.waypoint.modify.color": "Цветът на пътната точка вече е %s",
	"commands.waypoint.modify.color.reset": "Възстановяване на цвета на пътната точка",
	"commands.waypoint.modify.style": "Промяна на стила на пътната точка",
	...
	"component.profile.dynamic": "Динамика",
	...
	"connect.p2p.establishing": "Установяване на връзка...",
	"connect.p2p.failed.generic": "Не може да се установи връзка с играч",
	"connect.p2p.failed.signaling": "В момента не е възможно да се свържете.\nОпитайте отново по-късно.",
	"connect.p2p.failed.timeout": "Изтече времето за изчакване на заявката за свързване",
	"connect.p2p.failed.unreachable": "Играчът не е достъпен",
	...
	"createWorld.customize.buffet.search": "Търсене...",
	...
	"dataPack.locator_bar.description": "Показване посоката на другите играчи в мултиплейър",
	"dataPack.locator_bar.name": "Бар за локатор",
	...
	"death.attack.spear": "%[1]s беше пронизан от %[2]s",
	"death.attack.spear.item": "%[1]s беше пронизан от %[2]s използвайки %[3]s",
	...
	"death.fell.accident.scaffolding": "%[1]s падна от скеле",
	...
	"debug.crash.message.rebindable": "%s + %s се задържат натиснати. Това ще разпадне играта, освен ако не бъдат отпуснати.",
	...
	"debug.entry.always": "Винаги",
	"debug.entry.currently.alwaysOn": "%s: В момента е винаги включено",
	"debug.entry.currently.inF3": "%s: В момента само във F3",
	"debug.entry.currently.inOverlay": "%s: Моментно само в надстройка за отстраняване на грешки",
	"debug.entry.currently.never": "%s: В момента изключено",
	"debug.entry.f3": "Във F3",
	"debug.entry.overlay": "В наслагване",
	...
	"debug.options.category.renderer": "Отстраняването на грешки в рендърите",
	"debug.options.category.text": "Текст на екрана за отстраняване на грешки",
	"debug.options.help": "F3 + F5 = Редактиране на опциите за отстраняване на грешки",
	"debug.options.notAllowed.tooltip": "Не се вижда, когато информацията за отстраняване на грешки е намалена",
	"debug.options.profile.default": "Профил по подразбиране",
	"debug.options.profile.performance": "Профил на изпълнение",
	"debug.options.search": "Tърсене на опции",
	"debug.options.title": "Опции за отстраняване на грешки",
	"debug.options.warning": "Тези опции са само за тестови цели. Те могат да забавят компютъра ви, да сринат играта или да изядат домашния ви любимец камък.",
	...
	"debug.profiling.start.rebindable": "Профилирането е започнато за %s секунди. Използвайте %s + %s за да прекратите по-рано",
	...
	"debug.version.header": "Информация за версията на клиента:",
	"debug.version.help": "F3 + V = информация за версията на клиента",
	...
	"editGamerule.inGame.button": "Редактиране на правилата на играта...",
	"editGamerule.inGame.disabled.tooltip": "За обновяването на правилата на играта са нужни права на оператор.",
	"editGamerule.inGame.discardChanges.message": "Сигурни ли сте, че искате да отхвърлите предстоящите промени в правилата на играта?",
	"editGamerule.inGame.discardChanges.title": "Промени в правилата на играта",
	"editGamerule.inGame.downloadingGamerules": "Извличане на правилата на играта...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Дъх от наутилус",
	...
	"enchantment.minecraft.lunge": "Нахвърляне",
	...
	"entity.minecraft.camel_husk": "Изсъхнала камила",
	...
	"entity.minecraft.copper_golem": "Меден голем",
	...
	"entity.minecraft.happy_ghast": "Щастлив гаст",
	...
	"entity.minecraft.mannequin.label": "НИП",
	...
	"entity.minecraft.parched": "Пресъхнал скелет",
	...
	"entity.minecraft.sulfur_cube": "Сулфаден Куб",
	"entity.minecraft.sulfur_cube.content": "Съдържа: %s",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Разреши Недъра",
	"gamerule.allowEnteringNetherUsingPortals.description": "Определя дали играчите имат право да влизат в Недъра или не",
	...
	"gamerule.commandBlocksEnabled": "Командните блокове са включени",
	...
	"gamerule.enableCommandBlocks": "Включване на командните блокове",
	...
	"gamerule.locatorBar": "Включване на лентата за локация на играча",
	"gamerule.locatorBar.description": "Когато е включено, на екрана се показва лента, която показва посоката на играчите.",
	...
	"gamerule.minecraft.elytra_movement_check": "Направи проверка за движение на криле",
	"gamerule.minecraft.fire_spread_radius_around_player": "Радиус на разпространие на огън",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Радиусът в блокове около играч, в който може да се разпространи огън",
	"gamerule.minecraft.player_movement_check": "Направи проверка за движение на играч",
	"gamerule.minecraft.raids": "Прави нападения",
	"gamerule.minecraft.universal_anger.description": "Ядосани неутрални чудовища нападат всеки близък играч, не само този, който ги е ядосал. Работи най-добре, ако forgive_dead_players е изключено.",
	...
	"gamerule.pvp": "Разреши PvP",
	"gamerule.pvp.description": "Контролира дали играчите имат право да нанасят щети на други играчи или не",
	...
	"gamerule.spawnMonsters": "Поява на чудовища",
	"gamerule.spawnMonsters.description": "Контролира дали чудовищата се появяват естествено или не",
	...
	"gamerule.spawnerBlocksEnabled": "Блокове за съживяване включени",
	...
	"gamerule.tntExplosionDropDecay.description": "Някои от падналите предмети при унищожаване на блокове при експлозия причинена от TNT се губят в експлозията.",
	...
	"gui.friends.accept": "Приемане",
	"gui.friends.button.loading": "Изчакване...",
	"gui.friends.button.loading.invite_request_pending": "Waiting for confirmation",
	"gui.friends.button.loading.join_request_pending": "Изчакване на потвърждение от %s",
	"gui.friends.cancel_request": "Отказване на заявката",
	"gui.friends.confirm_title": "Потвърждаване",
	"gui.friends.confirm_unfriend": "Сигурни ли сте, че искате да премахнете този играч от списъка си приятели?",
	"gui.friends.copy_to_clipboard": "Копиране на връзката",
	"gui.friends.decline": "Отказване",
	"gui.friends.empty_nickname": "Въведете валидно име на профил, преди да изпратите покана за приятелство",
	"gui.friends.empty_state": "Приятели, които добавите, ще се показват тук.\n\nУправлявайте онлйан безопасността с вашия %s.",
	"gui.friends.empty_state.link": "Microsoft акаунт",
	"gui.friends.enter_nickname": "Въведете име на профила",
	"gui.friends.error.connection_issue": "Списъкът с приятели не работи в момента.\n\nПроверете интернет връзката си и опитайте отново.",
	"gui.friends.error.failed.message": "В момента невъзможно да изпратите заявка за приятелство",
	"gui.friends.error.forbidden.message": "Не успяхме да изпъкни това действие, свързано с приятел. Вероятно това се дължи на настройки за поверителност на профила.",
	"gui.friends.error.generic": "Има проблем - с тази функция, не с приятелите ти!\n\nОпитай отново по-късно.",
	"gui.friends.error.rateLimited.message": "Извършвате действия със списъка с приятели прекалено бързо. Моля, изчакайте малко и опитайте отново.",
	"gui.friends.error.temporary_unavailable": "Списъкът с приятели не работи в момента.\n\nОпитайте отново по-късно.",
	"gui.friends.error.unavailable.message": "Услугата Списък с приятели в момента не е достъпна. Моля, проверете интернет връзката си и опитайте отново по-късно.",
	"gui.friends.error.upgrade_needed": "Актуализирай играта, за да имаш достъп до списъка си с приятели.",
	"gui.friends.error.user_may_lack_active_profile": "Няма играч с това име на профил",
	"gui.friends.join": "Присъединете се",
	"gui.friends.loading_friends": "Зареждане на списъкът с приятели...",
	"gui.friends.loading_requests": "Зареждане на заявки...",
	"gui.friends.manage_account_footer": "Управлявайте онлайн безопасността с вашия %s",
	"gui.friends.multiplayer.invite": "Покана към света",
	"gui.friends.multiplayer.invite_accept": "Приемане поканата да се присъединиш към света",
	"gui.friends.multiplayer.invite_reject": "Отказване на поканата да се присъединиш към света",
	"gui.friends.multiplayer.join_request": "Заявка за присъединяване към света",
	"gui.friends.multiplayer.join_request_accept": "Приеми заявката за приесъединяване към света",
	"gui.friends.multiplayer.join_request_reject": "Откажи заявката за присъединяване към света",
	"gui.friends.my_profile_name": "Името на профила ми ",
	"gui.friends.my_profile_name.narration": "Копиране на името на профила %s",
	"gui.friends.narration.button.accept": "Натиснете Enter, за да приемете поканата за приятелство от %s",
	"gui.friends.narration.button.cancel_request": "Натиснете Enter, за да отмените заявката за приятелство към %s",
	"gui.friends.narration.button.decline": "Натиснете Enter, за да отхвърлите заявка за приятелство от %s",
	"gui.friends.narration.button.unfriend": "Натиснете Enter, за да премахнете %s от списъка с приятели",
	"gui.friends.narration.entry.friend": "Приятел %s",
	"gui.friends.narration.entry.incoming": "Получена покана за приятелство от %s",
	"gui.friends.narration.entry.outgoing": "Изпратена заявка за приятелство към %s",
	"gui.friends.open": "Приятели",
	"gui.friends.open.narration": "Списък с приятели",
	"gui.friends.open.tooltip": "Приятели",
	"gui.friends.pending.empty": "Няма чакащи покани за приятелство",
	"gui.friends.pending.received": "Получени",
	"gui.friends.pending.sent": "Ипратени",
	"gui.friends.presence.status.offline": "Извън линия",
	"gui.friends.presence.status.online": "На линия",
	"gui.friends.presence.status.playing_hosted_server": "В отворен за присъединяване свят",
	"gui.friends.presence.status.playing_offline": "В свят",
	"gui.friends.presence.status.playing_realms": "В Realm",
	"gui.friends.presence.status.playing_server": "На сървър",
	"gui.friends.requests_count": "Заявки (%s)",
	"gui.friends.send_request": "Изпрати заявка за приятелство",
	"gui.friends.tab_friends": "Приятели",
	"gui.friends.toast.friend_added.message": "%s прие вашата заявка за приятелство",
	"gui.friends.toast.friend_invited.message": "%s беше поканен да се присъедини към вашият свят.",
	"gui.friends.toast.friend_removed.message": "%s беше премахнат от вашият списък с приятели",
	"gui.friends.toast.generic_error": "Възникна неочаквана грешка при актуализирането на списъка Ви с приятели. Моля опитайте по-късно.",
	"gui.friends.toast.host_invite_expired.message": "Поканата към %s да се присъедини към този свят е изтекла.",
	"gui.friends.toast.invite_from_friend.message": "%s ви покани да се присъедините към неговият свят. Отвори списъка с приятели, като натиснеш \"%s\" за да се присъединиш",
	"gui.friends.toast.join_invite_expired.message": "Поканата за присъединяване към света на %s е изтекла.",
	"gui.friends.toast.join_request.message": "%s е подал заявка за присъединяване към твоя свят. Отвори списъка с приятели, като натиснеш \"%s\", или го отвори чрез менюто на играта.",
	"gui.friends.toast.request_accepted.message": "Вече сте приятели с %s",
	"gui.friends.toast.request_received.message": "%s ви изпрати заявка за приятелство",
	"gui.friends.toast.request_sent.message": "Изпратена заявка за приятелство до %s",
	"gui.friends.toast.request_to_join_friend.message": "Заявка за присъединяване към света е изпратена до %s",
	"gui.friends.toast.requests_accepted_multiple.message": "%s приятели са приели вашите заявки за приятелство",
	"gui.friends.toast.requests_received_multiple.message": "Получили сте %s заявки за приятелство",
	"gui.friends.unfriend": "Премахне на приятел",
	"gui.game_rule.search": "Търсене...",
	"gui.hours": "%s час(а)",
	"gui.language.search": "Търсене...",
	...
	"gui.packSelection.search": "Търсене...",
	"gui.privacy_link.message": "Отворете тази връзка, за да управлявате настройките си за поверителност и онлайн безопасност.",
	"gui.privacy_link.title": "Прилагането на промени в настройките на Xbox може да отнеме известно време.\n\nАко промените не се отразят, рестартирайте играта.",
	"gui.proceed": "Продължаване",
	"gui.recipebook.moreRecipes": "Десен бутон за още",
	"gui.recipebook.next_page": "Следваща страница",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Предишна страница",
	...
	"gui.remove": "Премахване",
	"gui.report_to_server": "Докладвай на Сървъра",
	"gui.selectWorld.search": "Търсене...",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Този играч не може да бъде докладван, защото чатът е деактивиран или блокиран",
	...
	"gui.stats.none_found": "Няма намерени статистики.",
	...
	"gui.up": "Нагоре",
	"gui.waitingForResponse.button.inactive": "Обратно (%ss)",
	"gui.waitingForResponse.title": "Изчакване на сървър",
	"gui.yes": "Да",
	...
	"item.minecraft.black_harness": "Черна сбруя",
	...
	"item.minecraft.blue_harness": "Синя сбруя",
	...
	"item.minecraft.brown_harness": "Кафява сбруя",
	...
	"item.minecraft.camel_husk_spawn_egg": "Яйце на изсъхнала камила",
	...
	"item.minecraft.copper_axe": "Медна брадва",
	"item.minecraft.copper_boots": "Медни ботуши",
	"item.minecraft.copper_chestplate": "Меден нагръдник",
	"item.minecraft.copper_golem_spawn_egg": "Яйце на меден голем",
	"item.minecraft.copper_helmet": "Меден шлем",
	"item.minecraft.copper_hoe": "Медна мотика",
	"item.minecraft.copper_horse_armor": "Медна конска броня",
	"item.minecraft.copper_ingot": "Медно кюлче",
	"item.minecraft.copper_leggings": "Медни панталони",
	"item.minecraft.copper_nautilus_armor": "Медна наутилус броня",
	"item.minecraft.copper_nugget": "Меден къшей",
	"item.minecraft.copper_pickaxe": "Медна кирка",
	"item.minecraft.copper_shovel": "Медна лопата",
	"item.minecraft.copper_spear": "Медно копие",
	"item.minecraft.copper_sword": "Меден меч",
	...
	"item.minecraft.cyan_harness": "Цианова сбруя",
	...
	"item.minecraft.diamond_nautilus_armor": "Диамантена наутилус броня",
	"item.minecraft.diamond_pickaxe": "Диамантена кирка",
	"item.minecraft.diamond_shovel": "Диамантена лопата",
	"item.minecraft.diamond_spear": "Диамантено копие",
	...
	"item.minecraft.happy_ghast_spawn_egg": "Яйце на Щастлив гаст",
	"item.minecraft.harness": "Сбруя",
	...
	"item.minecraft.iron_nautilus_armor": "Желязна наутилус броня",
	...
	"item.minecraft.iron_spear": "Желязно копие",
	...
	"item.minecraft.magenta_harness": "Магентова сбруя",
	...
	"item.minecraft.music_disc_bounce": "Музикална плоча",
	...
	"item.minecraft.music_disc_lava_chicken": "Музикален плоча",
	...
	"item.minecraft.music_disc_tears": "Музикална плоча",
	...
	"item.minecraft.nautilus_spawn_egg": "Яйце на наутилус",
	...
	"item.minecraft.netherite_axe": "Недърайт брадва",
	"item.minecraft.netherite_boots": "Недърайт ботуши",
	"item.minecraft.netherite_chestplate": "Недърайт нагръдник",
	"item.minecraft.netherite_helmet": "Недърайт шлем",
	"item.minecraft.netherite_hoe": "Недърайт мотика",
	"item.minecraft.netherite_horse_armor": "Недеритена броня на кон",
	"item.minecraft.netherite_ingot": "Недърайт кюлче",
	"item.minecraft.netherite_leggings": "Недърайт панталони",
	"item.minecraft.netherite_nautilus_armor": "Недърайт наутилус броня",
	"item.minecraft.netherite_pickaxe": "Недърайт кирка",
	"item.minecraft.netherite_scrap": "Късче Недърайт",
	"item.minecraft.netherite_shovel": "Недърайт лопата",
	"item.minecraft.netherite_spear": "Недърайт копие",
	"item.minecraft.netherite_sword": "Недърайт меч",
	...
	"item.minecraft.orange_harness": "Оранжева сбруя",
	...
	"item.minecraft.parched_spawn_egg": "Яйце на пресъхнал скелет",
	...
	"item.minecraft.pink_harness": "Розова сбруя",
	...
	"item.minecraft.purple_harness": "Лилава сбруя",
	...
	"item.minecraft.red_harness": "Червена сбруя",
	...
	"item.minecraft.smithing_template.netherite_upgrade.additions_slot_description": "Добавете Недърайт кюлче",
	...
	"item.minecraft.smithing_template.netherite_upgrade.ingredients": "Недърайт кюлче",
	...
	"item.minecraft.stone_spear": "Каменно копие",
	...
	"item.minecraft.sulfur_cube_bucket": "Кофа с сулфаден куб",
	"item.minecraft.sulfur_cube_spawn_egg": "Яйце на сулфаден куб",
	...
	"item.minecraft.white_harness": "Бяла сбруя",
	...
	"item.minecraft.wooden_spear": "Дървено копие",
	...
	"item.minecraft.yellow_harness": "Жълта сбруя",
	"item.minecraft.zoglin_spawn_egg": "Яйце на зоглин",
	"item.minecraft.zombie_horse_spawn_egg": "Яйце на кон зомби",
	"item.minecraft.zombie_nautilus_spawn_egg": "Яйце на наутилус зомби",
	...
	"item.spawn_egg.peaceful": "Изключено в Мирна трудност",
	...
	"itemGroup.functional": "Функционални блокове",
	...
	"itemGroup.redstone": "Червенокаменни блокове",
	"itemGroup.search": "Търсене",
	"itemGroup.spawnEggs": "Призоваващи яйца",
	...
	"key.categories.spectator": "Зрител",
	"key.categories.ui": "Игрален интерфейс",
	"key.category.minecraft.creative": "Творчески Режим",
	"key.category.minecraft.debug": "Отстраняване на грешки",
	"key.category.minecraft.gameplay": "Перспектива на играта",
	"key.category.minecraft.inventory": "Инвентар",
	"key.category.minecraft.misc": "Разнообразни",
	"key.category.minecraft.movement": "Движение",
	"key.category.minecraft.multiplayer": "Множествена игра",
	"key.category.minecraft.spectator": "Наблюдател",
	"key.chat": "Отваряне на чат",
	"key.command": "Отваряне на команди",
	"key.debug.clearChat": "Изчисти чата",
	"key.debug.copyLocation": "Копиране на местоположение",
	"key.debug.copyRecreateCommand": "Копиране на данни",
	"key.debug.crash": "Отстраняване на грешки при разпадане",
	"key.debug.debugOptions": "Опции за отстраняване на грешки",
	"key.debug.dumpDynamicTextures": "Изхвърляне на динамични текстури",
	"key.debug.dumpVersion": "Изхвърляне на информация за версията",
	"key.debug.focusPause": "Превключване на пауза при загуба на втренчване",
	"key.debug.fpsCharts": "FPS диаграми",
	"key.debug.lightmapTexture": "Текстури на светлинна карта",
	"key.debug.modifier": "Клавиш за отстраняване на грешки",
	"key.debug.networkCharts": "Мрежови диаграми",
	"key.debug.overlay": "Превключване на надстройка",
	"key.debug.profiling": "Започване/Прекратяване на профилирането",
	"key.debug.profilingChart": "Диаграма за профилиране",
	"key.debug.reloadChunk": "Презареждане на части",
	"key.debug.reloadResourcePacks": "Презареждане на пакети с ресурси",
	"key.debug.showAdvancedTooltips": "Показване на разширени надписи",
	"key.debug.showChunkBorders": "Показване на границите на частите",
	"key.debug.showHitboxes": "Показване на ударна кутия",
	"key.debug.spectate": "Обиколи наблюдателите",
	"key.debug.switchGameMode": "Превключвател на режим на игра",
	"key.drop": "Хвърляне на избрания елемент",
	"key.forward": "Вървене напред",
	"key.friends": "Екран \"Приятели\"",
	...
	"key.quickActions": "Бързи действия",
	...
	"key.spectatorHotbar": "Избор от бърза лента",
	"key.spectatorOutlines": "Подчертаване на играчи (зрители)",
	"key.sprint": "Бягане",
	"key.swapOffhand": "Премести предмет в другата си ръка",
	"key.toggleGui": "Превключване на графичен интерфейс",
	"key.togglePerspective": "Превключване перспектива",
	"key.toggleSpectatorShaderEffects": "Превключване на ефектите на зрителните светлинни отражения",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Добавяне на сървър",
	"manageServer.edit.title": "Редактиране на информация на сървъра",
	"manageServer.enterIp": "Адрес на сървъра",
	"manageServer.enterName": "Име на сървъра",
	"manageServer.resourcePack": "Сървърни ресурсни пакети",
	"manageServer.resourcePack.disabled": "Изкл.",
	"manageServer.resourcePack.enabled": "Вкл.",
	"manageServer.resourcePack.prompt": "Питай",
	...
	"mco.backup.entry.worldType.adventureMap": "Приключенска карта",
	"mco.backup.entry.worldType.experience": "Преживяване",
	"mco.backup.entry.worldType.inspiration": "Вдъхновение",
	"mco.backup.entry.worldType.minigame": "Мини игра",
	"mco.backup.entry.worldType.normal": "Обикновен",
	"mco.backup.entry.worldType.unknown": "Неизвестен",
	...
	"mco.configure.world.buttons.region_preference": "Избери регион...",
	"mco.configure.world.buttons.resetworld": "Пресъздаване на света",
	"mco.configure.world.buttons.save": "Запази",
	...
	"mco.configure.world.close.question.title": "Трябва да направите промени без прекъсване?",
	"mco.configure.world.closing": "Светът се затваря...",
	"mco.configure.world.commandBlocks": "Блокове за Действие",
	...
	"mco.configure.world.loading": "Зареждане на Realm",
	"mco.configure.world.location": "Позиция",
	"mco.configure.world.minigame": "Текущо: %s",
	"mco.configure.world.name": "Име на Realm",
	"mco.configure.world.name.validation.whitespace": "Не трябва да започва или да завършва с празно място. То ще бъде отрязано.",
	"mco.configure.world.opening": "Светът се отваря...",
	"mco.configure.world.players.error": "Играч със зададеното име не съществува",
	"mco.configure.world.players.invite.duplicate": "Играч с предоставеното име вече е бил поканен в Realm",
	...
	"mco.configure.world.region_preference": "Предпочитание за регион",
	"mco.configure.world.region_preference.title": "Избор на предпочитание за регион",
	...
	"mco.configure.world.settings.expired": "Не можете да редактирате настройки на изтекъл Realm",
	...
	"mco.configure.world.spawn_toggle.message.npc": "Изключването на тази опция ще премахне всички съществуващи обекти от този тип, като Селяни",
	...
	"mco.configure.world.subscription.tab": "Абонамент",
	...
	"mco.connect.region": "Регион на сървъра: %s",
	...
	"mco.errorMessage.realmsService.configurationError": "Възникна неочаквана грешка повреме на редакцията на опциите на света",
	...
	"mco.play.button.realm.closed": "Realm е затворен",
	"mco.question": "Въпрос",
	...
	"menu.custom_options": "Персонализирани настройки...",
	"menu.custom_options.title": "Персонализирани опции",
	"menu.custom_options.tooltip": "Бележка: Потребителските опции се предоставят от външни сървъри и/или съдържание.\nРаботете внимателно!",
	"menu.custom_screen_info.button_narration": "Това е персонализиран екран. Научете повече.",
	"menu.custom_screen_info.contents": "Съдържанието на този екран се контролира от сървъри и карти на външни лица, които не са собственост, не се управляват или контролират от Mojang Studios или Microsoft.\n\nРаботете внимателно! Винаги бъдете внимателни, когато следвате линкове, и никога не предоставяйте личната си информация, включително данни за достъп.\n\nАко този екран ви пречи да играете, можете също така да се изключите от текущия сървър, като използвате бутона по-долу.",
	"menu.custom_screen_info.disconnect": "Персонализираният екран е отхвърлен",
	"menu.custom_screen_info.title": "Бележка за персонализираните екрани",
	"menu.custom_screen_info.tooltip": "Това е персонализиран екран. Натиснете тук, за да научите повече.",
	...
	"menu.multiplayerOptions.applyChanges": "Приложи промените",
	"menu.multiplayerOptions.button": "Групова игра...",
	"menu.multiplayerOptions.network": "Групова игра",
	"menu.multiplayerOptions.network.header": "Мрежа",
	"menu.multiplayerOptions.network.lan": "Локална мрежа",
	"menu.multiplayerOptions.network.lan.tooltip": "Могат да се присъединят играчи от същата мрежа.",
	"menu.multiplayerOptions.network.off": "Изключено",
	"menu.multiplayerOptions.network.off.tooltip": "Никой не може да се присъедини.",
	"menu.multiplayerOptions.network.online": "На линия",
	"menu.multiplayerOptions.network.online.tooltip": "Приятели на линия могат да се присъединят.",
	"menu.multiplayerOptions.otherPlayers.header": "Други играчи",
	"menu.multiplayerOptions.publish.started.lan": "Този свят вече е отворен за Локална мрежа. Номерът на порта е %s",
	"menu.multiplayerOptions.publish.started.online": "Този свят вече е отворен за Групова игра. Номерът на порта е %s",
	"menu.multiplayerOptions.publish.stopped": "Този свят вече не е достъпен за групова игра",
	"menu.multiplayerOptions.title": "Опции за груповата игра",
	...
	"menu.playerReporting.no_players": "В този свят няма играчи, за които да се докладва",
	"menu.preparingSpawn": "Подготвяне на стартовата зона: %s%%",
	"menu.quick_actions": "Бързи действия...",
	"menu.quick_actions.title": "Бързи действия",
	...
	"multiplayer.codeOfConduct.check": "Не уведомявайте отново за този Правилник за поведение",
	"multiplayer.codeOfConduct.title": "Правилник за поведение на сървъра",
	"multiplayer.confirm_command.parse_errors": "Опитвате се да изпълните неразпозната или невалидна команда.\nСигурни ли сте?\nКоманда: %s",
	"multiplayer.confirm_command.permissions_required": "Опитвате се да изпълните команда, която изисква по-високи права.\nТова може да се отрази негативно на играта ви.\nСигурни ли сте?\nКоманда: %s",
	"multiplayer.confirm_command.run_command": "Изпълняване на команда",
	"multiplayer.confirm_command.signature_required": "Опитвате се да изпълните команда, която ще изпрати съобщения в чат използвайки вашето име.\nТо може да бъде изпълнено единствено от екрана за чат. \nКоманда: %s",
	"multiplayer.confirm_command.suggest_command": "Копирайте в екран за чат",
	"multiplayer.confirm_command.title": "Потвърждаване на изпълнението на командата",
	...
	"multiplayer.disconnect.banned.reason.default": "Бяхте баннат от оператор.",
	...
	"multiplayer.disconnect.code_of_conduct": "Сървърът изисква приемане на Правилника за поведение",
	"multiplayer.disconnect.configuration_error": "Неочаквана грешка по време на конфигурирането",
	...
	"multiplayer.status.anonymous_player": "Анонимен играч",
	...
	"music.game.a_familiar_room": "Арън Чероф - Позната стая",
	"music.game.an_ordinary_day": "Куми Таниок - Един обикновен ден",
	...
	"music.game.featherfall": "Aaron Cherof - Featherfal",
	...
	"music.game.wet_hands": "C418 - Мокри ръце",
	"music.game.yakusoku": "Kumi Tanioka - Обещание",
	"music.menu.beginning_2": "C418 - Начало 2",
	"music.menu.floating_trees": "C418 - Плаващи дървета",
	"music.menu.moog_city_2": "C418 - Муг сити 2",
	"music.menu.mutation": "C418 - Мутация",
	...
	"narration.checkbox.usage.focused.check": "Натиснете Enter, за да отбележите",
	"narration.checkbox.usage.focused.uncheck": "Натиснете Enter, за да отмените отметката",
	"narration.checkbox.usage.hovered": "Ляв бутон, за да изберете",
	"narration.checkbox.usage.hovered.check": "Натиснете Ляв бутон, за да отбележите",
	"narration.checkbox.usage.hovered.uncheck": "Натиснете Ляв бутон, за да премахнете отметката",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Натиснете Enter, за да започнете да променяте стойността на плъзгача",
	...
	"options.accessibility.tooltip": "Настройки за достъпност",
	"options.allowCursorChanges": "Разрешаване на промени на курсора",
	"options.allowCursorChanges.tooltip": "Позволява на курсора на мишката да променя формата си при посочване на определени елементи от интерфейса.",
	"options.allowFriendRequests": "Позволете заявки",
	"options.allowFriendRequests.tooltip": "Позволете други играчи да ви изпращат заявки за приятелство",
	...
	"options.chat.drafts": "Запазване на неизпратени чатове",
	"options.chat.drafts.tooltip": "Неизпратените съобщения ще бъдат запазени и ще могат да се изпратят следващият път когато чатът е отворен.",
	...
	"options.chunkFade": "Време за избледняване на части",
	"options.chunkFade.none": "Избледняване на част: Няма",
	"options.chunkFade.seconds": "Избледняване на част: %s секунда(и)",
	"options.chunkFade.tooltip": "Колко дълго в секунди трябва да избледнеят частите, когато се визуализират за първи път, ако изобщо трябва да избледнеят.",
	...
	"options.cutoutLeaves": "Прозрачни листа",
	"options.cutoutLeaves.tooltip": "Позволява поглед през дупки в листа. Изключването може да подобри производителността.",
	...
	"options.darknessEffectScale.tooltip": "Контролира силата на пулсиране от ефекта Пулсираща тъмнина, когато е получен от Надзирател или Скълк ларинкс.",
	...
	"options.exclusiveFullscreen": "Ексклузивен цял екран",
	"options.exclusiveFullscreen.warningTooltip": "Тази опция може да предодврати някои методи за въвеждане да работят.",
	...
	"options.friendsList": "Списък с приятели",
	"options.friendsList.confirm.message": "Списъкът с приятели управлява с кого може да пишете, когато опцията \"Може да общува извън Xbox\" е настроена на \"Приятели\".\n\nУправлявайте тази настройка в своя акаунт в Microsoft.\n\nКогато списъкът с приятели е ВКЛЮЧЕН, другите играчи могат да ви изпращат покани за приятелство. Може да ИЗКЛЮЧИТЕ поканите за приятелство или списъка с приятели по всяко време.",
	"options.friendsList.confirm.message.link": "Microsoft account",
	"options.friendsList.confirm.title": "Да се включи списъкът с приятели?",
	"options.friendsList.confirm.turnOff": "Изключи",
	"options.friendsList.confirm.turnOn": "Включи",
	...
	"options.graphics.custom": "Персонализиран",
	...
	"options.graphics.preset": "Предварително зададени настройки",
	"options.graphics.preset.tooltip": "Задава настройките за \"Качество и Производителност\" на разумни по подразбиране, съответстващи на желаното качество.",
	...
	"options.graphicsApi": "Графичен API",
	"options.graphicsApi.default": "Обикновен",
	"options.graphicsApi.opengl": "Препоръчителен OpenGl",
	"options.graphicsApi.restart": "Трябва да рестартираш играта за да пресмениш графичния API.",
	"options.graphicsApi.tooltip": "Който графичен API се ползва за рендериране. Поставете го като Обикновен освен ако нямате нужда от промяната му! Ще ефектира следващото ви пускане на игра.",
	"options.graphicsApi.tooltip.vulkan": "Experimental. Might reduce performance or cause instability on some systems.",
	"options.graphicsApi.vulkan": "Препоръчан Vulkan",
	...
	"options.improvedTransparency": "Подобрена прозрачност",
	"options.improvedTransparency.tooltip": "Експериментален подход, който използва екранни сенки за изчертаване на времето, облаците, и частиците зад прозрачни блокове вода.\nТова ще повлияе върху производителността на графичния процесор.",
	"options.inGameNotification": "Уведомление в играта",
	"options.inGameNotification.tooltip": "Показване на уведомленията от приятели в играта",
	...
	"options.invertMouseX": "Инверсия на мишката X",
	"options.invertMouseY": "Инверсия на мишката Y",
	...
	"options.language.narration": "Промяна на езика",
	"options.language.title": "Език",
	"options.language.tooltip": "Промяна на езика",
	...
	"options.maxAnisotropy": "Анизотропно филтриране",
	"options.maxAnisotropy.tooltip": "Значително подобрява гладкостта на текстурите, но влияе на производителността и значително се отразява на използването на видео паметта. Възможно е да не се поддържа от всички хардуерни конфигурации.",
	...
	"options.musicToast": "Музикален тост",
	"options.musicToast.never": "Никога",
	"options.musicToast.never.tooltip": "Не се показва музикален тост.",
	"options.musicToast.pauseMenu": "Меню Пауза",
	"options.musicToast.pauseMenu.tooltip": "Музикален тост се показва непрекъснато в менюто за пауза в играта докато се възпроизвежда песен.",
	"options.musicToast.pauseMenuAndToast": "Меню Пауза и Тост",
	"options.musicToast.pauseMenuAndToast.tooltip": "Показване на тост когато започне възпроизвеждането на песен. Същият тост се показва постоянно в менюто за пауза на играта докато се възпроизвежда песен.",
	"options.music_frequency": "Честота на музиката",
	"options.music_frequency.constant": "Постоянно",
	"options.music_frequency.default": "По подразбиране",
	"options.music_frequency.frequent": "Често",
	"options.music_frequency.tooltip": "Променя честотата на възпроизвеждане на музика, докато сте в игровия свят.",
	...
	"options.needsRestart": "Опцията ще бъде приложена след рестарт.",
	...
	"options.renderCloudsDistance": "Разстояние на облаците",
	"options.renderDistance": "Видимост",
	"options.resourcepack": "Ресурсни пакети...",
	"options.restartRequired": "За да влязат в сила някой от промените, които сте направили, е необходимо да рестартирате играта.",
	...
	"options.sharePresence": "Присъствие",
	"options.sharePresence.all": "Всички",
	"options.sharePresence.all.tooltip": "Статусът ви се споделя с приятелите ви. Позакзвате се на линия и споделяте какво праивте.",
	"options.sharePresence.limited": "Ограничено",
	"options.sharePresence.limited.tooltip": "Ограничено присъствие. Показвате се на линия, но не споделяте какво правите. Все пак можете да каните приятели в играта си.",
	"options.sharePresence.none": "Никакво",
	"options.sharePresence.none.tooltip": "Не показвате никакво присъствие. Изглежда като извън линия.",
	"options.showNowPlayingToast": "Показвай музикално известие",
	"options.showNowPlayingToast.tooltip": "Показва тост всеки път, когато започне да се възпроизвежда песен. Същият тост се показва постоянно в менюто за пауза в играта, докато се възпроизвежда песен.",
	"options.showSubtitles": "Показване на субтитри",
	"options.showSubtitles.tooltip": "Активира субтитри за звуците в играта.",
	...
	"options.sprintWindow": "Прозорец за бягане",
	"options.sprintWindow.tooltip": "Времеви прозорец в тикове, при който двойното натискане на клавиша напред активира бягане.",
	...
	"options.textureFiltering": "Филтриране на текстури",
	"options.textureFiltering.anisotropic": "Анизотропен",
	"options.textureFiltering.anisotropic.tooltip": "Метод за филтриране, базиран на хардуера, но оказва влияние върху производителността и значително се отразява на видео паметта. Възможно е да не се поддържа от всички хардуерни устройства.",
	"options.textureFiltering.none": "Няма",
	"options.textureFiltering.none.tooltip": "Текстурите се показват без никакво филтриране. Блоковете може да изглеждат размазани, когато се погледнат под ъгъл.",
	"options.textureFiltering.rgss": "Супер филтриране с въртяща се мрежа",
	"options.textureFiltering.rgss.tooltip": "(Супер филтриране с въртяща се мрежа)\nМетод за филтриране на базата на шейдър, който подобрява качеството на текстурата с умерено влияние върху производителността.",
	"options.title": "Настройки",
	"options.touchscreen": "Режим за тъчскрийн",
	"options.value": "%s",
	"options.video": "Видео настройки...",
	"options.video.display.header": "Представяне",
	"options.video.interface.header": "Интерфейс",
	"options.video.preferences.header": "Предпочитания",
	"options.video.quality.header": "Качество и Производителност",
	"options.videoTitle": "Видео настройки",
	"options.viewBobbing": "Клатене при ходене",
	"options.vignette": "Показване на Затъмняване",
	"options.vignette.tooltip": "Това е фина текстура върху екрана на играта използвана за намаляване на яркостта към краищата на екрана и предупреждение за границите на света.",
	"options.visible": "Показани",
	"options.vsync": "VSync",
	"options.weatherRadius": "Радиус на въздействие на времето",
	"options.weatherRadius.tooltip": "Радиусът на зоната, в която са видими ефектите от дъжд и сняг. Много ниско въздействие върху производителността.",
	"options.worldOptions.button": "Настройки на света...",
	"options.worldOptions.title": "Настройки на света",
	...
	"pack.incompatible.confirm.unknown": "Този пакет е повреден или направен за неизвестна версия на Minecraft и може да не работи правилно.",
	...
	"pack.incompatible.unknown": "(Повредени или несъвместими)",
	...
	"painting.minecraft.dennis.author": "Сара Боевинг",
	...
	"realms.configuration.region.australia_east": "Нов Южен Уелс, Австралия",
	...
	"realms.configuration.region.central_us": "Айова, САЩ",
	"realms.configuration.region.east_asia": "Хонг Конг",
	"realms.configuration.region.east_us": "Вирджиния, САЩ",
	"realms.configuration.region.east_us_2": "Северна Каролина, САЩ",
	...
	"realms.configuration.region.north_central_us": "Илинойс, САЩ",
	"realms.configuration.region.north_europe": "Ирландия",
	"realms.configuration.region.south_central_us": "Тексас, САЩ",
	"realms.configuration.region.southeast_asia": "Сингапур",
	"realms.configuration.region.sweden_central": "Швеция",
	"realms.configuration.region.uae_north": "Обединени арабски емирства (ОАЕ)",
	"realms.configuration.region.uk_south": "Южна Англия",
	"realms.configuration.region.west_central_us": "Юта, САЩ",
	"realms.configuration.region.west_europe": "Нидерландия",
	"realms.configuration.region.west_us": "Калифорния, САЩ",
	"realms.configuration.region.west_us_2": "Вашингтон, САЩ",
	"realms.configuration.region_preference.automatic_owner": "Автоматично (ping на собственика на Realm)",
	"realms.configuration.region_preference.automatic_player": "Автоматично (първият, който се присъедини към сесията)",
	...
	"restrictions_screen.permission.receive_player_messages.allowed": "Можете да получавате съобщения от играчи",
	"restrictions_screen.permission.receive_player_messages.denied": "Не може да получавате съобщеният от играчи",
	"restrictions_screen.permission.receive_system_messages.allowed": "Можете да получавате системни съобщения от сървъра",
	"restrictions_screen.permission.receive_system_messages.denied": "Не можете да получавате системни съобщения от сървъра",
	"restrictions_screen.permission.send_commands.allowed": "Може да изпращате команди",
	"restrictions_screen.permission.send_commands.denied": "Не можете да изпращате команди",
	"restrictions_screen.permission.send_messages.allowed": "Може да изпращате чат съобщения",
	"restrictions_screen.permission.send_messages.denied": "Не може да изпращате чат съобщения",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Създайте копие преди да обновите този свят?",
	...
	"selectWorld.backupWarning.file_fixing_required": "Този свят трябва да бъде надграден, преди да можете да играете в него. Препоръчваме ви да създадете резервно копие, преди да продължите, в случай че се появят проблеми със света.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Този свят трябва да бъде надграден до най-новата версия, преди да можете да го редактирате, поради основни промени във формата на света.",
	"selectWorld.requiresFileFixingTooltip.play": "Този свят трябва да бъде надграден до най-новата версия, преди да можете да играете в него, поради основни промени във формата на света.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Този свят трябва да бъде надграден до най-новата версия, преди да можете да можете да го пресъздадете, поради основни промени във формата на света.",
	...
	"selectWorld.tooltip.fromNewerVersion2": "Зареждането на този свят ще причини проблеми!",
	...
	"selectWorld.upgrade_and_play": "Надграждане и Игра",
	...
	"selectWorld.waitingForBackup.message": "В зависимост от размера на вашия свят, това може да отнеме известно време. Моля, не затваряйте играта и не изключвайте устройството си.",
	"selectWorld.waitingForBackup.title": "Създай резервно копие",
	...
	"selectWorld.world_gen_settings_access": "Не е възможно да се прочете или да се получи достъп до файла с настройките за генериране на света! %s",
	"selecteWorld.backupRequiredTooltip": "Зареждането на света изисква първо да се направи резервно копие",
	...
	"stat.minecraft.happy_ghast_one_cm": "Разстояние от Щастлив гаст",
	...
	"stat.minecraft.nautilus_one_cm": "Разстояние от наутилус",
	...
	"subtitles.block.copper_chest.close": "Сандък се затваря",
	"subtitles.block.copper_chest.open": "Сандък се отваря",
	"subtitles.block.copper_trapdoor.close": "Люк се затваря",
	"subtitles.block.copper_trapdoor.open": "Люк се отваря",
	"subtitles.block.crafter.craft": "Създател създава",
	"subtitles.block.crafter.fail": "Създателят не успя да изработи",
	...
	"subtitles.block.dried_ghast.ambient": "Звуци на сухота",
	"subtitles.block.dried_ghast.ambient_water": "Изсушен гаст се рехидратира",
	"subtitles.block.dried_ghast.place_in_water": "Изсушен гаст се накисва",
	"subtitles.block.dried_ghast.transition": "Изсушен гаст се чувства по-добре",
	"subtitles.block.dry_grass.ambient": "Ветровити звуци",
	"subtitles.block.enchantment_table.use": "Магическа маса се използва",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Сулфаден извор изригва",
	"subtitles.block.potent_sulfur.noxious_gas": "Поява на замайващ газ",
	...
	"subtitles.block.sculk.charge": "Скълк бълбука",
	"subtitles.block.sculk.spread": "Скълк се разпространява",
	"subtitles.block.sculk_catalyst.bloom": "Скълк стимулатор цъфти",
	"subtitles.block.sculk_sensor.clicking": "Скълк сензор щрака",
	...
	"subtitles.block.shelf.activate": "Рафтът се активира",
	"subtitles.block.shelf.deactivate": "Рафтът се деактивира",
	"subtitles.block.shelf.multi_swap": "Предмети се разменят",
	"subtitles.block.shelf.place_item": "Предмет е поставен",
	"subtitles.block.shelf.single_swap": "Предмет се разменя",
	"subtitles.block.shelf.take_item": "Предмет взет",
	...
	"subtitles.block.trapdoor.close": "Люк се затваря",
	"subtitles.block.trapdoor.open": "Люк се отваря",
	...
	"subtitles.entity.armadillo.hurt": "Нараняване на броненосец",
	...
	"subtitles.entity.baby_cat.ambient": "Котенце мяука",
	"subtitles.entity.baby_cat.beg_for_food": "Котенце се моли",
	"subtitles.entity.baby_cat.death": "Котенце умира",
	"subtitles.entity.baby_cat.eat": "Котенце яде",
	"subtitles.entity.baby_cat.hiss": "Котенце съска",
	"subtitles.entity.baby_cat.hurt": "Нараняване на котенце",
	"subtitles.entity.baby_cat.purr": "Котенце мърка",
	"subtitles.entity.baby_chicken.ambient": "Пиленце писука",
	"subtitles.entity.baby_chicken.death": "Пиленце умира",
	"subtitles.entity.baby_chicken.hurts": "Нараняване на пиленце",
	"subtitles.entity.baby_horse.ambient": "Жребче цвили",
	"subtitles.entity.baby_horse.angry": "Жребче цвили гневно",
	"subtitles.entity.baby_horse.breathe": "Жребче диша",
	"subtitles.entity.baby_horse.death": "Жребче умира",
	"subtitles.entity.baby_horse.eat": "Жребче яде",
	"subtitles.entity.baby_horse.hurt": "Нараняване на жребче",
	"subtitles.entity.baby_horse.land": "Жребче се приземява",
	"subtitles.entity.baby_nautilus.ambient": "Бебе наутилус чурулика",
	"subtitles.entity.baby_nautilus.ambient_land": "Бебе наутилус чурулика",
	"subtitles.entity.baby_nautilus.death": "Наутилус умира",
	"subtitles.entity.baby_nautilus.death_land": "Бебе Наутилус умира",
	"subtitles.entity.baby_nautilus.eat": "Наутилус яде",
	"subtitles.entity.baby_nautilus.hurt": "Нараняване на Наутилус",
	"subtitles.entity.baby_nautilus.hurt_land": "Нараняване на наутилус",
	"subtitles.entity.baby_nautilus.swim": "Наутилус плува",
	"subtitles.entity.baby_pig.ambient": "Бебе прасенце грухти",
	"subtitles.entity.baby_pig.death": "Бебе прасенце умира",
	"subtitles.entity.baby_pig.eat": "Бебе прасенце яде",
	"subtitles.entity.baby_pig.hurt": "Нараняване на бебе прасенце",
	"subtitles.entity.baby_wolf.ambient": "Кученце лае",
	"subtitles.entity.baby_wolf.death": "Кученце умира",
	"subtitles.entity.baby_wolf.growl": "Кученце ръмжи",
	"subtitles.entity.baby_wolf.hurt": "Нараняване на кученце",
	"subtitles.entity.baby_wolf.pant": "Кученце диша",
	"subtitles.entity.baby_wolf.whine": "Кученце скимти",
	...
	"subtitles.entity.camel_husk.ambient": "Изсъхнала камила пръхти",
	"subtitles.entity.camel_husk.dash": "Изсъхнала камила се изхвърля",
	"subtitles.entity.camel_husk.dash_ready": "Изсъхнала камила се възстановява",
	"subtitles.entity.camel_husk.death": "Изсъхнала камила загива",
	"subtitles.entity.camel_husk.eat": "Изсъхнала камила яде",
	"subtitles.entity.camel_husk.hurt": "Нараняване на изсъхнала камила",
	"subtitles.entity.camel_husk.saddle": "Екипиране на седло",
	"subtitles.entity.camel_husk.sit": "Изсъхнала камила сяда",
	"subtitles.entity.camel_husk.stand": "Изсъхнала камила се изправя",
	...
	"subtitles.entity.copper_golem.death": "Меден голем умира",
	"subtitles.entity.copper_golem.hurt": "Нараняване на меден голем",
	"subtitles.entity.copper_golem.item_drop": "Меден голем поставя предмет",
	"subtitles.entity.copper_golem.item_no_drop": "Меден голем не може да постави предмет",
	"subtitles.entity.copper_golem.no_item_get": "Меден голем взима предмет",
	"subtitles.entity.copper_golem.no_item_no_get": "Меден голем не може да вземе предмет",
	"subtitles.entity.copper_golem.spawn": "Меден голем се появява",
	"subtitles.entity.copper_golem.spin": "Главата на меден голем се върти",
	"subtitles.entity.copper_golem_become_statue": "Меден голем е вкаменен",
	"subtitles.entity.copper_golem_oxidized.death": "Меден голем умира",
	"subtitles.entity.copper_golem_oxidized.hurt": "Нараняване на меден голем",
	"subtitles.entity.copper_golem_oxidized.spin": "Главата на меден голем се върти",
	"subtitles.entity.copper_golem_weathered.death": "Меден голем умира",
	"subtitles.entity.copper_golem_weathered.hurt": "Нараняване на меден голем",
	"subtitles.entity.copper_golem_weathered.spin": "Главата на меден голем се върти",
	...
	"subtitles.entity.ghastling.ambient": "Гастлинг гука",
	"subtitles.entity.ghastling.death": "Гастлинг умира",
	"subtitles.entity.ghastling.hurt": "Нараняване на Гастлинг",
	"subtitles.entity.ghastling.spawn": "Гастлинг се появява",
	...
	"subtitles.entity.happy_ghast.ambient": "Щастлив гаст пее",
	"subtitles.entity.happy_ghast.death": "Щастлив гаст умира",
	"subtitles.entity.happy_ghast.equip": "Поставяне на сбруя",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Щастлив гаст е готов",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Щастлив гаст спира",
	"subtitles.entity.happy_ghast.hurt": "Нараняване на Щастлив гаст",
	"subtitles.entity.happy_ghast.unequip": "Сваляне на сбруя",
	...
	"subtitles.entity.nautilus.ambient": "Наутилус прищраква",
	"subtitles.entity.nautilus.ambient_land": "Наутилус прищраква",
	"subtitles.entity.nautilus.dash": "Наутилус се изстрелва",
	"subtitles.entity.nautilus.dash_land": "Наутилус се изстрелва",
	"subtitles.entity.nautilus.dash_ready": "Наутилус се възстановява",
	"subtitles.entity.nautilus.dash_ready_land": "Наутилус се възстановява",
	"subtitles.entity.nautilus.death": "Наутилус умира",
	"subtitles.entity.nautilus.death_land": "Наутилус умира",
	"subtitles.entity.nautilus.eat": "Наутилус яде",
	"subtitles.entity.nautilus.hurt": "Нараняване на Наутилус",
	"subtitles.entity.nautilus.hurt_land": "Нараняване на наутилус",
	"subtitles.entity.nautilus.swim": "Наутилус плува",
	...
	"subtitles.entity.parched.ambient": "Скелет скитник трака",
	"subtitles.entity.parched.death": "Скелет скитник умира",
	"subtitles.entity.parched.hurt": "Скелет скитник се наранява",
	...
	"subtitles.entity.parrot.imitate.camel_husk": "Папагал пръхти",
	...
	"subtitles.entity.parrot.imitate.parched": "Папагал трака",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Папагал стене",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Папагал гъргори",
	...
	"subtitles.entity.pig.eat": "Прасе яде",
	...
	"subtitles.entity.polar_bear.ambient_baby": "Бяло меченце мънка",
	...
	"subtitles.entity.sniffer.happy": "Снифър е щастлив",
	...
	"subtitles.entity.sulfur_cube.absorb": "Пълен сулфаден куб",
	"subtitles.entity.sulfur_cube.bounce": "Подскачане на сулфаден куб",
	"subtitles.entity.sulfur_cube.death": "Умираме на сулфаден куб",
	"subtitles.entity.sulfur_cube.eject": "Блокът е премахнат",
	"subtitles.entity.sulfur_cube.hit": "Удряне на сулфаден куб",
	"subtitles.entity.sulfur_cube.hurt": "Нараняване на сулфаден куб",
	"subtitles.entity.sulfur_cube.push": "Пускане на сулфаден куб",
	"subtitles.entity.sulfur_cube.squish": "Подскачане на сулфаден куб",
	...
	"subtitles.entity.warden.angry": "Надзирател беснее",
	...
	"subtitles.entity.warden.heartbeat": "Сърцето на надзирател тупти",
	"subtitles.entity.warden.hurt": "Нараняване на Надзирател",
	...
	"subtitles.entity.warden.nearby_close": "Надзирател идва",
	"subtitles.entity.warden.nearby_closer": "Надзирател напредва",
	"subtitles.entity.warden.nearby_closest": "Надзирател се приближава",
	"subtitles.entity.warden.roar": "Надзирател реве",
	"subtitles.entity.warden.sniff": "Надзирател подушва",
	"subtitles.entity.warden.sonic_boom": "Надзирател реве",
	"subtitles.entity.warden.sonic_charge": "Надзирателят се втурва",
	"subtitles.entity.warden.step": "Стъпки на Надзирател",
	...
	"subtitles.entity.zoglin.hurt": "Нараняване на Зоглин",
	...
	"subtitles.entity.zombie_horse.angry": "Кон зомби цвили",
	"subtitles.entity.zombie_horse.death": "Кон зомби умира",
	"subtitles.entity.zombie_horse.eat": "Кон зомби яде",
	"subtitles.entity.zombie_horse.hurt": "Нараняване на зомби кон",
	"subtitles.entity.zombie_nautilus.ambient": "Наутилус зомби бълбука",
	"subtitles.entity.zombie_nautilus.ambient_land": "Наутилус зомби бълбука",
	"subtitles.entity.zombie_nautilus.dash": "Наутилус зомби се изстрелва",
	"subtitles.entity.zombie_nautilus.dash_land": "Наутилус зомби се изстрелва",
	"subtitles.entity.zombie_nautilus.dash_ready": "Нежив Наутилус се възстановява",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Наутилус зомби се възстановява",
	"subtitles.entity.zombie_nautilus.death": "Наутилус зомби умира",
	"subtitles.entity.zombie_nautilus.death_land": "Наутилус зомби умира",
	"subtitles.entity.zombie_nautilus.eat": "Наутилус зомби яде",
	"subtitles.entity.zombie_nautilus.hurt": "Нараняване на Наутилус зомби",
	"subtitles.entity.zombie_nautilus.hurt_land": "Нараняване на наутилус зомби",
	"subtitles.entity.zombie_nautilus.swim": "Наутилус зомби плува",
	...
	"subtitles.item.armor.equip_copper": "Медна броня дрънчи",
	...
	"subtitles.item.armor.equip_nautilus": "Екипиране на наутилус броня",
	...
	"subtitles.item.armor.unequip_nautilus": "Сваляне на наутилус броня",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Загребване на сулфаден куб",
	...
	"subtitles.item.golden_dandelion.unuse": "Златно глухарче започва да старее",
	"subtitles.item.golden_dandelion.use": "Златно глухарче спира да старее",
	...
	"subtitles.item.horse_armor.unequip": "Конска броня е отрязана",
	"subtitles.item.ink_sac.use": "Мастило пльоква",
	"subtitles.item.lead.break": "Повод се къса",
	"subtitles.item.lead.tied": "Повод се завързва",
	"subtitles.item.lead.untied": "Повод се развързва",
	"subtitles.item.llama_carpet.unequip": "Килим е отрязан",
	...
	"subtitles.item.nautilus_saddle_equip": "Екипиране на седло",
	"subtitles.item.nautilus_saddle_underwater_equip": "Екипиране на седло под вода",
	"subtitles.item.nether_wart.plant": "Посаждане на растение",
	"subtitles.item.ominous_bottle.dispose": "Стъкленица се счупва",
	"subtitles.item.saddle.unequip": "Седло е отрязано",
	"subtitles.item.shears.shear": "Щракване на ножици",
	"subtitles.item.shears.snip": "Ножици режат",
	"subtitles.item.shield.block": "Блокиране с щит",
	"subtitles.item.shovel.flatten": "Изравняване с лопата",
	"subtitles.item.spear.attack": "Копие се забива",
	"subtitles.item.spear.hit": "Промушване от копие",
	"subtitles.item.spear.lunge": "Пробождане с копие",
	"subtitles.item.spear.use": "Нападение с копие",
	"subtitles.item.spear_wood.attack": "Копие се забива",
	"subtitles.item.spear_wood.hit": "Промушване от копие",
	"subtitles.item.spear_wood.use": "Нападение с копие",
	...
	"subtitles.item.underwater_saddle.equip": "Екипиране на седло",
	...
	"subtitles.weather.end_flash": "Проблясък от Края трещи",
	...
	"telemetry.event.graphics_capabilities.description": "Това събитие ни предоставя информира за възможностите на графичното устройство, използване за игране на играта.",
	"telemetry.event.graphics_capabilities.title": "Графични възможности",
	"telemetry.event.optional": "%s (По желание)",
	"telemetry.event.optional.disabled": "%s (Желателно) - Деактивирано",
	"telemetry.event.p2p_connection.description": "Това събитие ни помага да разберем надеждността и производителността на връзките от тип \"играч-до-играч\" между играчите. То записва дали връзката е била успешна, какъв кандидат по протокола ICE (Interactive Connectivity Establishment - протоколът, който използваме за установяване на връзка от тип \"играч-до-играч\") е бил използван и колко време е отнело установяването на връзка.",
	"telemetry.event.p2p_connection.title": "Връзка от тип играч-до-играч",
	...
	"telemetry.property.backend_failure_message.title": "Съобщение за грешка при създаване на бекенд",
	"telemetry.property.backend_failure_missing_capabilities.title": "Грешка при създаване на бекенд: липсват функции",
	"telemetry.property.backend_failure_reason.title": "Причина за неуспешно създаване на бекенед",
	"telemetry.property.backend_name.title": "Име на бекенд",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "Етап на неуспех",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Време за установяване на интерактивна връзка (ICE) (в милисекунди)",
	"telemetry.property.p2p_connection_ice_path.title": "Път за установяване на интерактивна връзка (ICE)",
	"telemetry.property.p2p_connection_local_candidate_type.title": "Тип на локален кандидат",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Тип на отдалечен кандидат",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Време за установяване на връзка (в милисекунди)",
	"telemetry.property.p2p_connection_successful.title": "Успешно свързване",
	"telemetry.property.p2p_connection_total_time_ms.title": "Общо време на връзката (в милисекунди)",
	...
	"test.error.expected_block_present": "Очаква се наличието на блок %s",
	...
	"test.error.not_a_block_item": "Дадения блок не е блоков елемент",
	...
	"test.error.sequence.minimum_tick": "Успешно преди очаквана отметка: очаквано изчакване %s",
	...
	"test.error.value_not_in_between": "Очакван %s да бъде между %s и %s: беше %s",
	...
	"test_block.mode_info.log": "Режим на регистриране - Регистриране на съобщение",
	...
	"title.multiplayer.online": "Групова игра (На линия)",
	...
	"upgradeWorld.aborted.message": "Това може да се случи, ако друга програма е имала достъп до света по време на актуализацията.\nМоже да помогне да рестартирате компютъра си и да опитате отново. Ако проблемът продължава, моля, обмислете да докладвате грешка.",
	"upgradeWorld.aborted.reportBug": "Докладвайте за грешка",
	"upgradeWorld.aborted.title": "Неуспешно обновяване на свят",
	"upgradeWorld.canceled.message": "Вашият свят остава такъв, какъвто беще преди.",
	"upgradeWorld.canceled.title": "Надграждането на света е отменено",
	"upgradeWorld.done": "Надграждането на света завършено",
	"upgradeWorld.failed_cleanup.message": "Светът беше успешно надграден до текущата версия и вече е достъпен в списъка със светове.\nСрещнахме проблеми при почистването на остарели данни, поради което името на папката със света се промени на %s.",
	"upgradeWorld.failed_cleanup.title": "Успешно надграждане на света",
	"upgradeWorld.info.converted": "Надграден: %s",
	"upgradeWorld.info.file_fix_stage": "Етап: %s/%s",
	"upgradeWorld.info.scanning": "Сканиране на файлове...",
	"upgradeWorld.info.total": "Общо: %s",
	"upgradeWorld.joinNow": "Искате ли да се присъедините към света сега?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Преместване на файлове",
	"upgradeWorld.progress.type.legacy_structures": "Надграждане на стари конструкции",
	"upgradeWorld.progress.type.region": "Надграждане на регионите",
	"upgradeWorld.symlink.message": "Избраният свят съдържа символни връзки.\nНеобходимите стъпки за надграждане на света до текущата версия не поддържат използването на символни връзки. За да надградите света, първо трябва да разрешите връзките.",
	"upgradeWorld.symlink.title": "Не може да се надгради света",
	"upgradeWorld.title": "Надграждане на файловете на света",
}
