// Code generated by tools/gen_lang.go from 26.1/is_is.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Aðgengisstillingar...",
	"accessibility.onboarding.accessibility.button.narration": "Aðgengisstillingar",
	...
	"advMode.notAllowed": "Leikmaður verður að stjórnandi og skapandi",
	"advMode.notEnabled": "Forritunarkubbar eru ekki virkir á þessum þjóni",
	"advMode.notEnabled.spawner": "Kveikjukubbar eru ekki virkir",
	"advMode.previousOutput": "Síðustu skilaboð",
	"advMode.setCommand": "Setja skipun í kubb",
	"advMode.setCommand.disabled": "Þessi skipun var gefin: %s, en skipanakubbar eru enn óvirkir",
	...
	"advancements.adventure.adventuring_time.title": "Ævintýramennska",
	...
	"advancements.adventure.avoid_vibration.description": "Laumast nærri skelksnema eða verði svo þeir skynji þig ekki",
	"advancements.adventure.avoid_vibration.title": "Þögull sem gröfin",
	"advancements.adventure.blowback.description": "Banaðu golu með snúnu goluskotnu vindhnetti",
	"advancements.adventure.blowback.title": "Afturkast",
	"advancements.adventure.brush_armadillo.description": "Fáðu beltisdýrahreistur frá beltisdýri með bursta",
	"advancements.adventure.brush_armadillo.title": "Hreistu það af þér!",
	"advancements.adventure.bullseye.description": "Skjóttu í miðdepil skotmarks úr a.m.k. 30 metra fjarlægð",
	"advancements.adventure.bullseye.title": "Beint í mark",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Búa til skreytt leirker úr 4 leirkersbrotum",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Rækileg forvarsla",
	"advancements.adventure.crafters_crafting_crafters.description": "Vertu nálægt smið er hann smíðar smið",
	"advancements.adventure.crafters_crafting_crafters.title": "Smiður smíða smiði",
	...
	"advancements.adventure.heart_transplanter.description": "Setja brakandahjarta á réttan hátt á milli tveggja föleikardrumba",
	"advancements.adventure.heart_transplanter.title": "Hjartaígræðsla",
	"advancements.adventure.hero_of_the_village.description": "Ná að verja þorp fyrir árás",
	"advancements.adventure.hero_of_the_village.title": "Hvunndagshetja",
	...
	"advancements.adventure.kill_a_mob.description": "Dreptu óvinveitt skrímsli",
	"advancements.adventure.kill_a_mob.title": "Skrímslabani",
	"advancements.adventure.kill_all_mobs.description": "Dreptu eitt af hverju óvinveittu skrímsli",
	...
	"advancements.adventure.lighten_up.description": "Skafðu koparperu með öxi til að gera hana bjartari",
	"advancements.adventure.lighten_up.title": "Verði ljós",
	"advancements.adventure.lightning_rod_with_villager_no_fire.description": "Verja þorpsbúa fyrir raflosti án þess að eldur brjótist út",
	"advancements.adventure.lightning_rod_with_villager_no_fire.title": "Yfirspennuvörn",
	"advancements.adventure.minecraft_trials_edition.description": "Farðu inn í þrautarklefa",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: þrautarútgáfa",
	"advancements.adventure.ol_betsy.description": "Skjóttu með lásboga",
	"advancements.adventure.ol_betsy.title": "Gamla brýnið",
	"advancements.adventure.overoverkill.description": "Gerðu 50 hjarta skaða í einu höggi með sleggjunni",
	"advancements.adventure.overoverkill.title": "Einum of mikið",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Lestu skotmáttinn frá meitlaðri bókahillu með samanburðarrofa",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Mennt er máttur",
	"advancements.adventure.revaulting.description": "Opnaðu váboðahvelfingu með váboðaþrautalykli",
	"advancements.adventure.revaulting.title": "Ógn og hvelfing",
	"advancements.adventure.root.description": "Ævintýri, landkönnun og bardagar",
	"advancements.adventure.root.title": "Ævintýri",
	"advancements.adventure.salvage_sherd.description": "Sópa grunsamlega einingu til að fá leirkersbrot",
	"advancements.adventure.salvage_sherd.title": "Virðing fyrir fortíðinni",
	...
	"advancements.adventure.sleep_in_bed.description": "Sofðu í rúmi til að færa endurlífgunarstaðinn þinn",
	...
	"advancements.adventure.spear_many_mobs.description": "Hæfðu fimm verur í sömu árás með spjótinu",
	"advancements.adventure.spear_many_mobs.title": "Skrímslaverður",
	"advancements.adventure.spyglass_at_dragon.description": "Horfðu á endadrekann í gegnum sjónauka",
	"advancements.adventure.spyglass_at_dragon.title": "Er þetta flugvél?",
	"advancements.adventure.spyglass_at_ghast.description": "Horfðu á vom í gegnum sjónauka",
	"advancements.adventure.spyglass_at_ghast.title": "Er þetta blaðra?",
	"advancements.adventure.spyglass_at_parrot.description": "Horfðu á páfagauk í gegnum sjónauka",
	...
	"advancements.adventure.summon_iron_golem.title": "Til þjónustu reiðubúinn",
	"advancements.adventure.throw_trident.description": "Kastaðu þríforki að einhverju.\nMundu: Það er ekki góð hugmynd að kasta frá sér eina vopninu sínu.",
	"advancements.adventure.throw_trident.title": "Forkastanleg fyndni",
	"advancements.adventure.totem_of_undying.description": "Notaðu verndargrip tilverunnar til að svíkja undan dauðanum",
	...
	"advancements.adventure.trade_at_world_height.description": "Versla við þorpsbúa á efstu mörkum byggjanlegs heims",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Smíðað með glæsibrag",
	...
	"advancements.adventure.under_lock_and_key.description": "Notaðu þrautalykil á hvelfingu",
	"advancements.adventure.under_lock_and_key.title": "Bak við lás og slá",
	"advancements.adventure.use_lodestone.description": "Nota áttavita á vörðu",
	"advancements.adventure.use_lodestone.title": "Ber varðan mig heim, um breiðan veg",
	...
	"advancements.adventure.voluntary_exile.description": "Drepa árásarforingja.\nKannski ættirðu að halda þig frá þorpum í bili...",
	...
	"advancements.adventure.who_needs_rockets.description": "Notaðu vindhnött til að skjóta þig upp um 8 kubba",
	"advancements.adventure.who_needs_rockets.title": "Hver þarf rakettur?",
	"advancements.adventure.whos_the_pillager_now.description": "Láta ruplara finna fyrir eigin aðferðum",
	...
	"advancements.end.dragon_breath.description": "Safnaðu anda drekans í glerflösku",
	"advancements.end.dragon_breath.title": "Þig vantar mintu",
	"advancements.end.dragon_egg.description": "Haltu á drekaegginu",
	"advancements.end.dragon_egg.title": "Hin næsta kynslóð",
	"advancements.end.elytra.description": "Nældu þér í þekjuvængi",
	"advancements.end.elytra.title": "Eins og fuglinn flýr!",
	...
	"advancements.end.kill_dragon.title": "Falla fjötrarnir af endaheiminum",
	"advancements.end.levitate.description": "Svífa upp 50 einingar eftir árás skálks",
	"advancements.end.levitate.title": "Ég sé húsið mitt héðan",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Fá hjálpara til að kasta köku að nótnakubb",
	"advancements.husbandry.allay_deliver_cake_to_note_block.title": "Afmælissöngur",
	"advancements.husbandry.allay_deliver_item_to_player.description": "Láttu hjálpara koma með hluti handa þér",
	"advancements.husbandry.allay_deliver_item_to_player.title": "Ég er sko vinur þinn",
	...
	"advancements.husbandry.breed_all_animals.description": "Ræktaðu öll dýrin!",
	"advancements.husbandry.breed_all_animals.title": "Tvö og tvö",
	"advancements.husbandry.breed_an_animal.description": "Láttu tvö dýr æxlast",
	"advancements.husbandry.breed_an_animal.title": "Páfagaukarnir og leðurblökurnar",
	"advancements.husbandry.complete_catalogue.description": "Temdu öll kattarafbrigðin!",
	"advancements.husbandry.complete_catalogue.title": "Allsherjarlisti",
	"advancements.husbandry.feed_snifflet.description": "Fóðraðu þefling",
	"advancements.husbandry.feed_snifflet.title": "Litlir þefarar",
	"advancements.husbandry.fishy_business.description": "Veiddu fisk",
	"advancements.husbandry.fishy_business.title": "Veiðivafstur",
	"advancements.husbandry.froglights.description": "Hafðu allar froskaluktir í bakpokanum",
	"advancements.husbandry.froglights.title": "Með sameinuðum kröftum okkar!",
	"advancements.husbandry.kill_axolotl_target.description": "Stofnaðu til samstarfs við tálknamöndru og sigraðu í bardaga",
	"advancements.husbandry.kill_axolotl_target.title": "Græðandi afl vináttu!",
	"advancements.husbandry.leash_all_frog_variants.description": "Náðu öllum afbrigðum frosks með taumi",
	"advancements.husbandry.leash_all_frog_variants.title": "Þegar liðið hoppar í bæinn",
	"advancements.husbandry.make_a_sign_glow.description": "Láttu texta á hvers konar skiltum glóa",
	"advancements.husbandry.make_a_sign_glow.title": "Lýsa og lesa!",
	"advancements.husbandry.netherite_hoe.description": "Notaðu heljarmálmshleif til að uppfæra plóg, og endurmettu svo lífið þitt",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Setja kubb af þurrkuðum vom í vatn",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Þetta kemur allt með kalda vatninu!",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Taktu úlfsbrynjuna af úlfi með skærum",
	"advancements.husbandry.remove_wolf_armor.title": "Skærljómandi",
	"advancements.husbandry.repair_wolf_armor.description": "Gerðu við skaddaða úlfsbrynju með beltisdýrahreistri",
	"advancements.husbandry.repair_wolf_armor.title": "Eins og nýr",
	"advancements.husbandry.ride_a_boat_with_a_goat.description": "Fara í bát og fljóta með geit",
	"advancements.husbandry.ride_a_boat_with_a_goat.title": "Hafhafur!",
	"advancements.husbandry.root.description": "Heimurinn er morandi í vinum og fæðu",
	"advancements.husbandry.root.title": "Landbúnaður",
	"advancements.husbandry.safely_harvest_honey.description": "Notaðu varðeld til þess að safna hunangi úr býflugnabúi án þess að reita býflugurnar til reiði",
	...
	"advancements.husbandry.uh_oh.description": "Láttu brennisteinskubb gleypa sprengiefni",
	...
	"advancements.husbandry.wax_on.description": "Bera vaxköku á koparkubb!",
	"advancements.husbandry.wax_on.title": "Vax á",
	"advancements.husbandry.whole_pack.description": "Temdu einn af öllum úlfategundunum",
	"advancements.husbandry.whole_pack.title": "Allur pakkinn",
	...
	"advancements.nether.create_beacon.title": "Að leiðarljósi",
	...
	"advancements.nether.distract_piglin.title": "Það glitrar!",
	"advancements.nether.explore_nether.description": "Kanna öll landslög Heljar",
	"advancements.nether.explore_nether.title": "Heitir ferðamannastaðir",
	"advancements.nether.fast_travel.description": "Notfæra sér Hel til þess að ferðast 7 km í yfirheiminum",
	...
	"advancements.nether.find_bastion.title": "Sú var tíðin",
	...
	"advancements.nether.netherite_armor.description": "Vertu fullklæddur heljarmálmsherklæðum",
	...
	"advancements.nether.uneasy_alliance.description": "Bjarga vomi frá Hel, ná honum í yfirheimin... og drepa hann",
	"advancements.nether.uneasy_alliance.title": "Banvænt bandalag",
	"advancements.nether.use_lodestone.description": "Nota áttavita á vörðu",
	"advancements.nether.use_lodestone.title": "Ber varðan mig heim, um breiðan veg",
	...
	"advancements.story.cure_zombie_villager.title": "Skottulæknir",
	"advancements.story.deflect_arrow.description": "Verðu skotfæri með Skildi",
	"advancements.story.deflect_arrow.title": "Kannski í næsta lífi, takk fyrir",
	...
	"advancements.story.follow_ender_eye.title": "Gefur augaleið",
	...
	"advancements.story.obtain_armor.description": "Verndaðu þig með járnbrynklæðum",
	...
	"advancements.story.smelt_iron.description": "Bræddu hráttjárn í járnhleif",
	...
	"argument.entity.selector.nearestEntity": "Næsta eining",
	...
	"argument.hexcolor.invalid": "Ógilt hex litagildi '%s'",
	...
	"argument.message.too_long": "Skilaboð of löng (%s > hámark %s stafir)",
	...
	"argument.resource_or_id.failed_to_parse": "Ekki tekist að byggja virkið: %s",
	"argument.resource_or_id.invalid": "Ógilt auðkenni eða merki",
	"argument.resource_or_id.no_such_element": "Einingin '%s' finnst ekki í skránni '%s'",
	"argument.resource_selector.not_found": "Ekkert passar við valið '%s' af gerðinni '%s'",
	...
	"argument.style.invalid": "Ógildur stíll: %s",
	...
	"argument.waypoint.invalid": "Valið einindi er ekki leiðarpunktur",
	...
	"arguments.item.component.expected": "Búist við atriði bútar",
	"arguments.item.component.malformed": "Villa'%s'hluti: '%s'",
	"arguments.item.component.repeated": "Liður hluta '%s' var endurtekið, en bara er hægt að tilgreina eitt gildi",
	"arguments.item.component.unknown": "Óþekktur liður hluts '%s'",
	"arguments.item.malformed": "Vanskapaður hlutur: '%s'",
	"arguments.item.overstacked": "%s er aðeins hægt að stafla upp í %s",
	"arguments.item.predicate.malformed": "Creeper",
	"arguments.item.predicate.unknown": "Creeper",
	...
	"attribute.name.air_drag_modifier": "Loftmótstöðubreytir",
	"attribute.name.armor": "Brynja",
	"attribute.name.armor_toughness": "Brynjustyrkleiki",
	"attribute.name.attack_damage": "Árásarskaði",
	"attribute.name.attack_knockback": "Árásarafturkast",
	"attribute.name.attack_speed": "Árásarhraði",
	"attribute.name.below_name_distance": "Fjarlægð nafnplötuskors",
	"attribute.name.block_break_speed": "Hraði kubbabrots",
	"attribute.name.block_interaction_range": "Víxlverkunarsvið kubbs",
	"attribute.name.bounciness": "Fjöðrun",
	"attribute.name.burning_time": "Brennslutími",
	"attribute.name.camera_distance": "Fjarlægð myndavélar",
	"attribute.name.entity_interaction_range": "Aðgerðarsvið kubbs",
	"attribute.name.explosion_knockback_resistance": "Sprengju Afturkasts Viðnám",
	"attribute.name.fall_damage_multiplier": "Fallskaða margfaldari",
	"attribute.name.flying_speed": "Flughraði",
	"attribute.name.follow_range": "Fylgisvið vera",
	"attribute.name.friction_modifier": "Núningsbreytir",
	"attribute.name.generic.armor": "Brynja",
	"attribute.name.generic.armor_toughness": "Styrkleiki brynju",
	"attribute.name.generic.attack_damage": "Árásarskaði",
	"attribute.name.generic.attack_knockback": "Afturkast árásar",
	"attribute.name.generic.attack_speed": "Árásarhraði",
	"attribute.name.generic.block_interaction_range": "Víxlverkunarsvið Blokks",
	"attribute.name.generic.burning_time": "Brennslutími",
	"attribute.name.generic.entity_interaction_range": "Víxlverkunarsvið Einingar",
	"attribute.name.generic.explosion_knockback_resistance": "Sprengju Afturkasts Viðnám",
	"attribute.name.generic.fall_damage_multiplier": "Fallskaðamargfaldari",
	"attribute.name.generic.flying_speed": "Flughraði",
	"attribute.name.generic.follow_range": "Fylgisvið vera",
	"attribute.name.generic.gravity": "Þyngdarafl",
	"attribute.name.generic.jump_strength": "Stökkkraftur",
	"attribute.name.generic.knockback_resistance": "Afturkasts vörn",
	"attribute.name.generic.luck": "Heppni",
	"attribute.name.generic.max_absorption": "Hámark ísogs",
	"attribute.name.generic.max_health": "Hámarks heilsa",
	"attribute.name.generic.movement_efficiency": "Hreyfingar dugnaður",
	"attribute.name.generic.movement_speed": "Hraði",
	"attribute.name.generic.oxygen_bonus": "Súrefnisbót",
	"attribute.name.generic.safe_fall_distance": "Örugg fallhæð",
	"attribute.name.generic.scale": "Stærð",
	"attribute.name.generic.step_height": "Klifurhæð",
	"attribute.name.generic.water_movement_efficiency": "Vatnshreyfingar dugnaður",
	"attribute.name.gravity": "Þyngdarafl",
	"attribute.name.horse.jump_strength": "Stökkkraftur hests",
	"attribute.name.jump_strength": "Stökkkraftur",
	"attribute.name.knockback_resistance": "Afturkasts vörn",
	"attribute.name.luck": "Heppni",
	"attribute.name.max_absorption": "Hámarks gleyping",
	"attribute.name.max_health": "Hámarks heilsa",
	"attribute.name.mining_efficiency": "Námumoksturs dugnaður",
	"attribute.name.movement_efficiency": "Hreyfingar dugnaður",
	"attribute.name.movement_speed": "Hraði",
	"attribute.name.nameplate_distance": "Fjarlægð nafnplötu",
	"attribute.name.oxygen_bonus": "Súrefnisbót",
	"attribute.name.player.block_break_speed": "Hraði kubbabrots",
	"attribute.name.player.block_interaction_range": "Víxlverkunarsvið Blokks",
	"attribute.name.player.entity_interaction_range": "Víxlverkunarsvið Einingar",
	"attribute.name.player.mining_efficiency": "Námumoksturs dugnaður",
	"attribute.name.player.sneaking_speed": "Læðu hraði",
	"attribute.name.player.submerged_mining_speed": "Námumoksturs skilvirkni á kafi",
	"attribute.name.player.sweeping_damage_ratio": "Hlutfall sveiflu árás",
	"attribute.name.safe_fall_distance": "Örugg fallhæð",
	"attribute.name.scale": "Stærð",
	"attribute.name.sneaking_speed": "Laumu hraði",
	"attribute.name.spawn_reinforcements": "Liðsauki uppvakninga",
	"attribute.name.step_height": "Skrefhæð",
	"attribute.name.submerged_mining_speed": "Námumoksturs skilvirkni á kafi",
	"attribute.name.sweeping_damage_ratio": "Hlutfall Sveifluskaða",
	"attribute.name.tempt_range": "Veru freistingar fjarlægð",
	"attribute.name.water_movement_efficiency": "Vatnshreyfingar dugnaður",
	"attribute.name.waypoint_receive_range": "Móttökufjarlægð leiðarpunkts",
	"attribute.name.waypoint_transmit_range": "Sendingarfjarlægð leiðarpunkts",
	"attribute.name.zombie.spawn_reinforcements": "Liðsauki uppvakninga",
	"biome.minecraft.badlands": "Eyðilendur",
	"biome.minecraft.bamboo_jungle": "Bambusskógur",
	"biome.minecraft.basalt_deltas": "Basaltósar",
	...
	"biome.minecraft.lukewarm_ocean": "Djúpt volgt úthaf",
	"biome.minecraft.lush_caves": "Grónir hellar",
	"biome.minecraft.mangrove_swamp": "Leiruviðarfen",
	"biome.minecraft.meadow": "Tún",
	"biome.minecraft.mushroom_fields": "Sveppatún",
	...
	"biome.minecraft.pale_garden": "Fölvagarður",
	"biome.minecraft.plains": "Slétta",
	"biome.minecraft.river": "Á",
	"biome.minecraft.savanna": "Staktrjáaslétta",
	"biome.minecraft.savanna_plateau": "Staktrjáaháslétta",
	...
	"biome.minecraft.sulfur_caves": "Brennisteinshellar",
	...
	"biome.minecraft.warm_ocean": "Hlýr sjór",
	"biome.minecraft.warped_forest": "Brenglmygliskógur",
	...
	"biome.minecraft.windswept_savanna": "Vindrofin staktrjáaslétta",
	...
	"block.minecraft.acacia_shelf": "Akasíuhilla",
	...
	"block.minecraft.bamboo_shelf": "Bambushilla",
	...
	"block.minecraft.banner.border.gray": "Grár Rammi",
	...
	"block.minecraft.banner.flow.black": "Svart Flæði",
	"block.minecraft.banner.flow.blue": "Blátt Flæði",
	"block.minecraft.banner.flow.brown": "\x7fBrúnt Flæði",
	"block.minecraft.banner.flow.cyan": "Blágrænnt Flæði",
	"block.minecraft.banner.flow.gray": "Grátt Flæði",
	"block.minecraft.banner.flow.green": "Grænt Flæði",
	"block.minecraft.banner.flow.light_blue": "Ljósblátt Flæði",
	"block.minecraft.banner.flow.light_gray": "Ljósgrátt Flæði",
	"block.minecraft.banner.flow.lime": "Ljósgrænt flæði",
	"block.minecraft.banner.flow.magenta": "Vínrautt Flæði",
	"block.minecraft.banner.flow.orange": "Appelsínugult Flæði",
	"block.minecraft.banner.flow.pink": "Bleikt Flæði",
	"block.minecraft.banner.flow.purple": "Fjólublátt Flæði",
	"block.minecraft.banner.flow.red": "Rautt Flæði",
	"block.minecraft.banner.flow.white": "Hvítt Flæði",
	"block.minecraft.banner.flow.yellow": "Gult Flæði",
	...
	"block.minecraft.banner.guster.black": "Svartur Gustur",
	"block.minecraft.banner.guster.blue": "Blár Gustur",
	"block.minecraft.banner.guster.brown": "Brúnn Gustur",
	"block.minecraft.banner.guster.cyan": "Blágrænn Gustur",
	"block.minecraft.banner.guster.gray": "Grár Gustur",
	"block.minecraft.banner.guster.green": "Grænn Gustur",
	"block.minecraft.banner.guster.light_blue": "Ljósblár Gustur",
	"block.minecraft.banner.guster.light_gray": "Ljósgrár Gustur",
	"block.minecraft.banner.guster.lime": "Ljósgrænn Gustur",
	"block.minecraft.banner.guster.magenta": "Vínrauður Gustur",
	"block.minecraft.banner.guster.orange": "Appelsínugulur Gustur",
	"block.minecraft.banner.guster.pink": "Bleikur Gustur",
	"block.minecraft.banner.guster.purple": "Fjólublár Gustur",
	"block.minecraft.banner.guster.red": "Rauður Gustur",
	"block.minecraft.banner.guster.white": "Hvítur Gustur",
	"block.minecraft.banner.guster.yellow": "Gulur Gustur",
	...
	"block.minecraft.beacon": "Leiðarljós",
	...
	"block.minecraft.bee_nest": "Býflugnahreiður",
	...
	"block.minecraft.bush": "Runni",
	"block.minecraft.cactus": "Kaktus",
	"block.minecraft.cactus_flower": "Kaktusblóm",
	...
	"block.minecraft.chain": "Járnkeðja",
	...
	"block.minecraft.cherry_shelf": "Kirsuberjahilla",
	...
	"block.minecraft.chiseled_cinnabar": "Tilhoggið sinnóber",
	"block.minecraft.chiseled_copper": "Meitlaður kopar",
	"block.minecraft.chiseled_deepslate": "Meitlað djúpberg",
	...
	"block.minecraft.chiseled_resin_bricks": "Meitlaðir kvoðusteinar",
	"block.minecraft.chiseled_sandstone": "Útskorinn sandsteinn",
	"block.minecraft.chiseled_stone_bricks": "Útskorinn steinmúr",
	"block.minecraft.chiseled_sulfur": "Tilhogginn brennisteinn",
	"block.minecraft.chiseled_tuff": "Meitlað móberg",
	"block.minecraft.chiseled_tuff_bricks": "Meitlaðir móbergssteinar",
	"block.minecraft.chorus_flower": "Kórblóm",
	"block.minecraft.chorus_plant": "Kórplanta",
	"block.minecraft.cinnabar": "Sinnóber",
	"block.minecraft.cinnabar_brick_slab": "Sinnóbersmúrhella",
	"block.minecraft.cinnabar_brick_stairs": "Sinnóbersmúrtröppur",
	"block.minecraft.cinnabar_brick_wall": "Sinnóbersmúrveggur",
	"block.minecraft.cinnabar_bricks": "Sinnóbersmúrsteinar",
	"block.minecraft.cinnabar_slab": "Sinnóbershella",
	"block.minecraft.cinnabar_stairs": "Sinnóberströppur",
	"block.minecraft.cinnabar_wall": "Sinnóbersveggur",
	"block.minecraft.clay": "Leir",
	"block.minecraft.closed_eyeblossom": "Lokað augnablóm",
	"block.minecraft.coal_block": "Kolakubbur",
	"block.minecraft.coal_ore": "Kolagrýti",
	"block.minecraft.coarse_dirt": "Gróf mold",
	"block.minecraft.cobbled_deepslate": "Djúpgrýti",
	"block.minecraft.cobbled_deepslate_slab": "Djúpgrýtishellur",
	"block.minecraft.cobbled_deepslate_stairs": "Djúpgrýtiströppur",
	"block.minecraft.cobbled_deepslate_wall": "Djúpgrýtisveggur",
	...
	"block.minecraft.copper_bars": "Koparrimlar",
	"block.minecraft.copper_block": "Koparkubbur",
	"block.minecraft.copper_bulb": "Koparpera",
	"block.minecraft.copper_chain": "Koparkeðja",
	"block.minecraft.copper_chest": "Koparkista",
	"block.minecraft.copper_door": "Koparhurð",
	"block.minecraft.copper_golem_statue": "Koparþjarkar stytta",
	"block.minecraft.copper_grate": "Kopargrind",
	"block.minecraft.copper_lantern": "Koparlukt",
	"block.minecraft.copper_ore": "Kopargrýti",
	"block.minecraft.copper_torch": "Koparkyndill",
	"block.minecraft.copper_trapdoor": "Koparhleri",
	"block.minecraft.copper_wall_torch": "Koparkyndill á vegg",
	"block.minecraft.cornflower": "Garðakornblóm",
	"block.minecraft.cracked_deepslate_bricks": "Brotinn djúpbergsmúr",
	"block.minecraft.cracked_deepslate_tiles": "Brotnar djúpbergshellur",
	...
	"block.minecraft.crafter": "Smiðja",
	"block.minecraft.crafting_table": "Vinnubekkur",
	"block.minecraft.creaking_heart": "Brakandahjarta",
	...
	"block.minecraft.crimson_shelf": "Hárauðirhilla",
	...
	"block.minecraft.dark_oak_shelf": "Dökkeikarhilla",
	...
	"block.minecraft.deepslate": "Djúpberg",
	"block.minecraft.deepslate_brick_slab": "Djúpbergsmúrhella",
	"block.minecraft.deepslate_brick_stairs": "Djúpbergsmúrtröppur",
	"block.minecraft.deepslate_brick_wall": "Djúpbergsmúrveggur",
	"block.minecraft.deepslate_bricks": "Djúpbergsmúr",
	...
	"block.minecraft.deepslate_tile_slab": "Djúpbergsflísahella",
	"block.minecraft.deepslate_tile_stairs": "Djúpbergsflísatröppur",
	"block.minecraft.deepslate_tile_wall": "Djúpbergsflísaveggur",
	"block.minecraft.deepslate_tiles": "Djúpbergsflísar",
	...
	"block.minecraft.dried_ghast": "Þurrvomur",
	...
	"block.minecraft.exposed_chiseled_copper": "Óvarinn meitlaður kopar",
	"block.minecraft.exposed_copper": "Óvarinn kopar",
	"block.minecraft.exposed_copper_bars": "Óvarnir koparrimlar",
	"block.minecraft.exposed_copper_bulb": "Óvarin koparpera",
	"block.minecraft.exposed_copper_chain": "Óvarin koparkeðja",
	"block.minecraft.exposed_copper_chest": "Óvarin koparkista",
	"block.minecraft.exposed_copper_door": "Óvarin koparhurð",
	"block.minecraft.exposed_copper_golem_statue": "Óvarin koparþjarkar stytta",
	"block.minecraft.exposed_copper_grate": "Óvarið kopargrind",
	"block.minecraft.exposed_copper_lantern": "Óvarin koparlukt",
	"block.minecraft.exposed_copper_trapdoor": "Óvarinn koparhleri",
	...
	"block.minecraft.exposed_lightning_rod": "Óvarinn eldingavari",
	...
	"block.minecraft.firefly_bush": "Blysbjöllurunni",
	...
	"block.minecraft.golden_dandelion": "Gullfífill",
	...
	"block.minecraft.heavy_core": "Þungkjarni",
	...
	"block.minecraft.infested_deepslate": "Sýkt djúpberg",
	...
	"block.minecraft.iron_chain": "Járnkeðja",
	...
	"block.minecraft.jungle_button": "Frumskógarviðarhnappur",
	"block.minecraft.jungle_door": "Frumskógarviðarhurð",
	"block.minecraft.jungle_fence": "Frumskógarviðargirðing",
	"block.minecraft.jungle_fence_gate": "Frumskógarviðarhlið",
	"block.minecraft.jungle_hanging_sign": "Hangandi frumskógarviðarskilti",
	...
	"block.minecraft.jungle_shelf": "Frumskógarhilla",
	"block.minecraft.jungle_sign": "Frumskógarviðarskilti",
	...
	"block.minecraft.jungle_wall_sign": "Frumskógarviðarskilti á vegg",
	...
	"block.minecraft.leaf_litter": "Hálmur",
	...
	"block.minecraft.mangrove_shelf": "Leiruviðarhilla",
	...
	"block.minecraft.mossy_cobblestone": "Mosagrjót",
	"block.minecraft.mossy_cobblestone_slab": "Mosavaxin götusteinshella",
	"block.minecraft.mossy_cobblestone_stairs": "Mosavaxnar Grjóttröppur",
	"block.minecraft.mossy_cobblestone_wall": "Mosagjrótveggur",
	...
	"block.minecraft.oak_shelf": "Eikarhilla",
	...
	"block.minecraft.ominous_banner": "Váboðafáni",
	"block.minecraft.open_eyeblossom": "Opið augnablóm",
	...
	"block.minecraft.oxidized_chiseled_copper": "Oxaður meitlaður kopar",
	"block.minecraft.oxidized_copper": "Oxaður kopar",
	"block.minecraft.oxidized_copper_bars": "Oxaðir koparrimlar",
	"block.minecraft.oxidized_copper_bulb": "Oxuð koparpera",
	"block.minecraft.oxidized_copper_chain": "Oxuð koparkeðja",
	"block.minecraft.oxidized_copper_chest": "Oxuð koparkista",
	"block.minecraft.oxidized_copper_door": "Oxað koparhurð",
	"block.minecraft.oxidized_copper_golem_statue": "Oxuð koparþjarkar stytta",
	"block.minecraft.oxidized_copper_grate": "Oxuð kopargrind",
	"block.minecraft.oxidized_copper_lantern": "Oxuð koparlukt",
	"block.minecraft.oxidized_copper_trapdoor": "Oxað koparhleri",
	...
	"block.minecraft.oxidized_lightning_rod": "Oxaður eldingavari",
	"block.minecraft.packed_ice": "Þjappaður ís",
	"block.minecraft.packed_mud": "Þjöppuð leðja",
	"block.minecraft.pale_hanging_moss": "Fölleitur hangandi mosi",
	"block.minecraft.pale_moss_block": "Fölleitur mosakubbur",
	"block.minecraft.pale_moss_carpet": "Fölleit mosabreiða",
	"block.minecraft.pale_oak_button": "Föleikarhnappur",
	"block.minecraft.pale_oak_door": "Ljós eikarhurð",
	"block.minecraft.pale_oak_fence": "Föleikargirðing",
	"block.minecraft.pale_oak_fence_gate": "Föleikarhlið",
	"block.minecraft.pale_oak_hanging_sign": "Hangandi föleikarskilti",
	"block.minecraft.pale_oak_leaves": "Föleikarlauf",
	"block.minecraft.pale_oak_log": "Föleikardrumbur",
	"block.minecraft.pale_oak_planks": "Föleikarplankar",
	"block.minecraft.pale_oak_pressure_plate": "Þrýstihella úr föleik",
	"block.minecraft.pale_oak_sapling": "Föleikargræðlingur",
	"block.minecraft.pale_oak_shelf": "Föleikarhilla",
	"block.minecraft.pale_oak_sign": "Föleikarskilti",
	"block.minecraft.pale_oak_slab": "Föleikarplata",
	"block.minecraft.pale_oak_stairs": "Föleikartröppur",
	"block.minecraft.pale_oak_trapdoor": "Föleikarhleri",
	"block.minecraft.pale_oak_wall_hanging_sign": "Vegghangandi föleikarskilti",
	"block.minecraft.pale_oak_wall_sign": "Föleikarskilti á vegg",
	"block.minecraft.pale_oak_wood": "Föleikarviður",
	...
	"block.minecraft.polished_cinnabar": "Slípað sinnóber",
	"block.minecraft.polished_cinnabar_slab": "Slípuð sinnóbershella",
	"block.minecraft.polished_cinnabar_stairs": "Slípaðar sinnóberströppur",
	"block.minecraft.polished_cinnabar_wall": "Slípaður sinnóbersveggur",
	"block.minecraft.polished_deepslate": "Slípað djúpberg",
	"block.minecraft.polished_deepslate_slab": "Slípuð djúpbergshella",
	"block.minecraft.polished_deepslate_stairs": "Slípaðar djúpbergströppur",
	"block.minecraft.polished_deepslate_wall": "Slípaður djúpbergsveggur",
	...
	"block.minecraft.polished_sulfur": "Slípaður brennisteinn",
	"block.minecraft.polished_sulfur_slab": "Slípuð brennisteinshella",
	"block.minecraft.polished_sulfur_stairs": "Slípaðar brennisteinströppur",
	"block.minecraft.polished_sulfur_wall": "Slípaður brennisteinsveggur",
	"block.minecraft.polished_tuff": "Slípað móberg",
	"block.minecraft.polished_tuff_slab": "Slípað móbergshella",
	"block.minecraft.polished_tuff_stairs": "Slípað móbergströppur",
	"block.minecraft.polished_tuff_wall": "Slípað móbergsveggur",
	"block.minecraft.poppy": "Valmúi",
	"block.minecraft.potatoes": "Kartöflur",
	"block.minecraft.potent_sulfur": "Kröftugur brennisteinn",
	...
	"block.minecraft.potted_closed_eyeblossom": "Lokað augnablóm í potti",
	...
	"block.minecraft.potted_golden_dandelion": "Gullfífill í blómapotti",
	...
	"block.minecraft.potted_mangrove_propagule": "Leiruviðaræxlikorn í potti",
	"block.minecraft.potted_oak_sapling": "Pottsettur eikargræðlingur",
	"block.minecraft.potted_open_eyeblossom": "Opið augnablóm í potti",
	"block.minecraft.potted_orange_tulip": "Appelsínugulur túlípani í potti",
	"block.minecraft.potted_oxeye_daisy": "Freyjubrá í potti",
	"block.minecraft.potted_pale_oak_sapling": "Pottsettur föleikargræðlingur",
	...
	"block.minecraft.powder_snow": "Lausamjöll",
	...
	"block.minecraft.reinforced_deepslate": "Styrkt djúpberg",
	"block.minecraft.repeater": "Roðsteinsmagnari",
	"block.minecraft.repeating_command_block": "Endurtakandi forritunarkubbur",
	"block.minecraft.resin_block": "Kvoðublokk",
	"block.minecraft.resin_brick_slab": "Kvoðusteinshella",
	"block.minecraft.resin_brick_stairs": "Kvoðusteinströppur",
	"block.minecraft.resin_brick_wall": "Kvoðusteinsveggur",
	"block.minecraft.resin_bricks": "Kvoðusteinar",
	"block.minecraft.resin_clump": "Kvoðuköggull",
	...
	"block.minecraft.scaffolding": "Vinnupallur",
	...
	"block.minecraft.short_dry_grass": "Lágt þurrt gras",
	"block.minecraft.short_grass": "Lágt gras",
	...
	"block.minecraft.soul_lantern": "Sálarlukt",
	...
	"block.minecraft.spruce_shelf": "Grenihilla",
	...
	"block.minecraft.stripped_pale_oak_log": "Heflaður föleikardrumbur",
	"block.minecraft.stripped_pale_oak_wood": "Heflaður föleikarviður",
	...
	"block.minecraft.structure_void": "Tómarúmsbygging",
	"block.minecraft.sugar_cane": "Sykurreyr",
	"block.minecraft.sulfur": "Brennisteinn",
	"block.minecraft.sulfur_brick_slab": "Brennisteinsmúrhella",
	"block.minecraft.sulfur_brick_stairs": "Brennisteinsmúrtröppur",
	"block.minecraft.sulfur_brick_wall": "Brennisteinsmúrveggur",
	"block.minecraft.sulfur_bricks": "Brennisteinsmúrsteinar",
	"block.minecraft.sulfur_slab": "Brennisteinshella",
	"block.minecraft.sulfur_spike": "Brennisteinsgaddur",
	"block.minecraft.sulfur_stairs": "Brennisteinströppur",
	"block.minecraft.sulfur_wall": "Brennisteinsveggur",
	...
	"block.minecraft.tall_dry_grass": "Hátt þurrt gras",
	...
	"block.minecraft.test_block": "Prufukubbur",
	"block.minecraft.test_instance_block": "Prufutilvikskubbur",
	"block.minecraft.tinted_glass": "Litað gler",
	"block.minecraft.tnt": "Sprengiefni",
	"block.minecraft.tnt.disabled": "Íkveikja sprengiefna er óvirk",
	...
	"block.minecraft.trial_spawner": "Þrautaframkallari",
	...
	"block.minecraft.tuff_brick_slab": "Móbergsmúrshella",
	"block.minecraft.tuff_brick_stairs": "Móbergsmúrströppur",
	"block.minecraft.tuff_brick_wall": "Móbergsmúrsveggur",
	"block.minecraft.tuff_bricks": "Móbergssteinar",
	"block.minecraft.tuff_slab": "Móbergshella",
	"block.minecraft.tuff_stairs": "Móbergströppur",
	"block.minecraft.tuff_wall": "Móbergsveggur",
	...
	"block.minecraft.vault": "Hvelfing",
	"block.minecraft.verdant_froglight": "Skrúðgræn frosklugt",
	"block.minecraft.vine": "Klifurjurt",
	"block.minecraft.void_air": "Tómaloft",
	"block.minecraft.wall_torch": "Kyndill á vegg",
	...
	"block.minecraft.waxed_chiseled_copper": "Vaxborinn meitlaður kopar",
	"block.minecraft.waxed_copper_bars": "Vaxbornir koparrimlar",
	"block.minecraft.waxed_copper_block": "Vaxhúðaður kubbur af kopar",
	"block.minecraft.waxed_copper_bulb": "Vaxborin koparpera",
	"block.minecraft.waxed_copper_chain": "Vaxborin koparkeðja",
	"block.minecraft.waxed_copper_chest": "Vaxborin koparkista",
	"block.minecraft.waxed_copper_door": "Vaxborin koparhurð",
	"block.minecraft.waxed_copper_golem_statue": "Vaxborin koparþjarkar stytta",
	"block.minecraft.waxed_copper_grate": "Vaxborin kopargrind",
	"block.minecraft.waxed_copper_lantern": "Vaxborin koparlukt",
	"block.minecraft.waxed_copper_trapdoor": "Vaxborinn koparhleri",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Vaxborinn óvarinn meitlaður kopar",
	"block.minecraft.waxed_exposed_copper": "Vaxborinn óvarinn kopar",
	"block.minecraft.waxed_exposed_copper_bars": "Vaxbornir óvarnir koparrimlar",
	"block.minecraft.waxed_exposed_copper_bulb": "Vaxborin óvarin koparpera",
	"block.minecraft.waxed_exposed_copper_chain": "Vaxborin óvarin koparkeðja",
	"block.minecraft.waxed_exposed_copper_chest": "Vaxborin óvarin koparkista",
	"block.minecraft.waxed_exposed_copper_door": "Vaxborin óvarin koparhurð",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Vaxborin óvarin koparþjarkar stytta",
	"block.minecraft.waxed_exposed_copper_grate": "Vaxborin óvarin kopargrind",
	"block.minecraft.waxed_exposed_copper_lantern": "Vaxborin óvarin koparlukt",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Vaxborinn óvarinn koparhleri",
	"block.minecraft.waxed_exposed_cut_copper": "Vaxborinn óvarinn skorin kopar",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Vaxborinn óvarinn eldingavari",
	"block.minecraft.waxed_lightning_rod": "Vaxborinn eldingavari",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Vaxborinn oxaður meitlaður kopar",
	"block.minecraft.waxed_oxidized_copper": "Vaxborinn oxaður kopar",
	"block.minecraft.waxed_oxidized_copper_bars": "Vaxbornir oxaðir koparrimlar",
	"block.minecraft.waxed_oxidized_copper_bulb": "Vaxborin oxuð koparpera",
	"block.minecraft.waxed_oxidized_copper_chain": "Vaxborin oxuð koparkeðja",
	"block.minecraft.waxed_oxidized_copper_chest": "Vaxborin oxuð koparkista",
	"block.minecraft.waxed_oxidized_copper_door": "Vaxborin oxuð koparhurð",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Vaxborin oxuð koparþjarkar stytta",
	"block.minecraft.waxed_oxidized_copper_grate": "Vaxborin oxuð kopargind",
	"block.minecraft.waxed_oxidized_copper_lantern": "Vaxborin oxuð koparlukt",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Vaxborinn oxaður koparhleri",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Vaxborinn oxaður eldingavari",
	"block.minecraft.waxed_weathered_chiseled_copper": "Vaxborinn veðraður meitlaður kopar",
	"block.minecraft.waxed_weathered_copper": "Vaxborinn veðraður kopar",
	"block.minecraft.waxed_weathered_copper_bars": "Vaxbornir veðrarið koparrimlar",
	"block.minecraft.waxed_weathered_copper_bulb": "Vaxborin veðruð koparpera",
	"block.minecraft.waxed_weathered_copper_chain": "Vaxborin veðruð koparkeðja",
	"block.minecraft.waxed_weathered_copper_chest": "Vaxborin veðruð koparkista",
	"block.minecraft.waxed_weathered_copper_door": "Vaxborin veðruð koparhurð",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Vaxborin veðruð koparþjarkar stytta",
	"block.minecraft.waxed_weathered_copper_grate": "Vaxborin veðruð kopargrind",
	"block.minecraft.waxed_weathered_copper_lantern": "Vaxborin veðruð koparlukt",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Vaxborinn veðraður koparhleri",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Vaxborinn veðraður eldingavari",
	"block.minecraft.weathered_chiseled_copper": "Veðraður meitlaður kopar",
	"block.minecraft.weathered_copper": "Veðraður kopar",
	"block.minecraft.weathered_copper_bars": "Veðrarið koparrimlar",
	"block.minecraft.weathered_copper_bulb": "Veðruð koparpera",
	"block.minecraft.weathered_copper_chain": "Veðruð koparkeðja",
	"block.minecraft.weathered_copper_chest": "Veðruð koparkista",
	"block.minecraft.weathered_copper_door": "Veðruð koparhurð",
	"block.minecraft.weathered_copper_golem_statue": "Veðruð koparþjarkar stytta",
	"block.minecraft.weathered_copper_grate": "Veðruð kopargrind",
	"block.minecraft.weathered_copper_lantern": "Veðruð koparlukt",
	"block.minecraft.weathered_copper_trapdoor": "Veðraður Koparhleri",
	...
	"block.minecraft.weathered_lightning_rod": "Veðraður eldingavari",
	...
	"block.minecraft.wildflowers": "Villiblóm",
	...
	"block.minecraft.zombie_wall_head": "Uppvakningshaus á vegg",
	"book.byAuthor": "eftir %[1]s",
	"book.edit.title": "Breyta bók",
	...
	"book.page_button.next": "Næsta síða",
	"book.page_button.previous": "Fyrri síða",
	"book.sign.title": "Árita bók",
	"book.sign.titlebox": "Heiti",
	"book.signButton": "Kvitta",
	"book.view.title": "Skoða bók",
	"build.spawn_protection": "%s er með kveikjuvörn",
	"build.tooHigh": "Hæðarmörk til að byggja eru %s kubbar",
	"build.tooLow": "Lágmarkshæð byggingar er %s",
	...
	"chat.disabled.invalid_command_signature": "Skipun vantaði færibreytu eða innhélt færibreytu sem það átti ekki von á.",
	"chat.disabled.invalid_signature": "Spjallið var með ógilda undirskrift. Reyndu að tengjast aftur.",
	...
	"chat.disabled.out_of_order_chat": "Spjall barst út af röð. Breyttist tími kerfisins?",
	...
	"chat.queue.tooltip": "Smelltu til að birta næstu skilaboð",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "Þjónninn sendi ógild skilaboð.",
	...
	"chat.validation_error": "Ekki tókst að sannreyna spjall",
	"chat_restriction.chat_and_commands_disabled_by_options": "Spjall er bannað í stillingum forrits.",
	"chat_restriction.chat_disabled_by_options": "Spjall milli spilara er bannað í stillingum forrits.",
	"chat_restriction.chat_disabled_by_options.action": "Opna Stillingar Spjalls",
	"chat_restriction.disabled_by_launcher": "Spjall er bannað af ræsiforriti",
	"chat_restriction.disabled_by_profile": "Spjall er bannað í stillingum prófíls.",
	"chat_restriction.disabled_by_profile.action": "Opna stillingar prófíls þíns",
	"chat_screen.commands_not_allowed": "Að senda skipanir er ekki leyft",
	"chat_screen.message": "Þessi skilaboð verða send: %s",
	"chat_screen.messages_not_allowed": "Að senda spjallskilaboð er ekki leyft",
	"chat_screen.restricted": "Spjall er bannað. Smelltu á þessi skilaboð til að fá upplýsingar.",
	"chat_screen.restricted.narration": "Spjall er bannað. Opnaðu skjáinn Bönn í Valkostum Heims.",
	"chat_screen.title": "Spjallskjár",
	"chat_screen.usage": "Skrifaðu skilaboð og ýttu á Enter til að senda",
	"chunk.toast.checkLog": "Sjá dagbók fyrir nánari upplýsingar",
	"chunk.toast.loadFailure": "Ekki tókst að hlaða klunk á %s",
	"chunk.toast.lowDiskSpace": "Lítið pláss á disknum!",
	"chunk.toast.lowDiskSpace.description": "Mögulega gæti heimurinn ekki vistast.",
	"chunk.toast.saveFailure": "Ekki tókst að vista klunk á %s",
	...
	"command.forkLimit": "Hámarksfjöldi kvísla (%s) náð",
	"command.trailing_data": "Óvænt endagögn fundust: %s",
	...
	"commands.attribute.base_value.reset.success": "Grunngildi eiginleika %s fyrir atriðið %s var stillt á sjálfgefið %s",
	...
	"commands.banlist.entry.unknown": "(Óþekkt)",
	"commands.banlist.list": "Það er/eru %s bann(bönn):",
	...
	"commands.bossbar.list.bars.some": "Það er (eru) %s sérsniðin (sérsniðnar) lífrendur virkar: %s",
	...
	"commands.datapack.create.already_exists": "Pakki sem heitir '%s' er þegar til",
	"commands.datapack.create.invalid_full_name": "Ógilt heiti á nýjum pakka '%s'",
	"commands.datapack.create.invalid_name": "Ógildir stafir í nýju heiti pakkans '%s'",
	"commands.datapack.create.io_failure": "Ekki hægt að búa til pakka með heitinu '%s', athugaðu atvikaskrár",
	"commands.datapack.create.metadata_encode_failure": "Tókst ekki að kóða lýsigögn fyrir pakkann '%s': %s",
	"commands.datapack.create.success": "Bjó til tóman pakka með heitinu '%s'",
	"commands.datapack.disable.failed": "Pakki '%s' er ekki virkjaður!",
	"commands.datapack.disable.failed.feature": "Pakkanum ‚%s‘ er ekki hægt að slökkva á þar sem hann er hluti af virkum stöðuvísi!",
	...
	"commands.datapack.list.available.success": "Það eru %s gagnapakki (gagnapakkar) tiltækir: %s",
	...
	"commands.debug.function.noReturnRun": "Ekki er hægt að nota rakningu með \"return run\" skipun",
	...
	"commands.dialog.clear.multiple": "Fjarlægði spjall hjá %s spilurum",
	"commands.dialog.clear.single": "Fjarlægði spjall hjá %s",
	"commands.dialog.show.multiple": "Sýndi %s spilurum spjall",
	"commands.dialog.show.single": "Sýndi %s spjall",
	...
	"commands.drop.no_loot_table.block": "Kubbur %s hefur ekki fengtöflu",
	...
	"commands.execute.function.instantiationFailure": "Tókst ekki að hefja aðgerð %s: %s",
	...
	"commands.fetchprofile.copy_component": "Afrita hlut",
	"commands.fetchprofile.copy_text": "Afrita %s",
	"commands.fetchprofile.entity.success": "Greindi prófíl fyrir einindi %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Tókst ekki að textagera prófíl: %s",
	"commands.fetchprofile.give_item": "Gefa hlut",
	"commands.fetchprofile.id.failure": "Tókst ekki að greina prófíl fyrir ID %s",
	"commands.fetchprofile.id.success": "Greindi prófíl fyrir ID %s: %s",
	"commands.fetchprofile.name.failure": "Tókst ekki að greina prófíl fyrir nafnið %s",
	"commands.fetchprofile.name.success": "Greindi prófíl fyrir nafnið %s: %s",
	"commands.fetchprofile.no_profile": "Einindin %s hefur ekki prófíl",
	"commands.fetchprofile.summon_mannequin": "Kalla fram gínu",
	...
	"commands.forceload.added.failure": "Engir klunkar voru valdir til skylduhleðslu",
	"commands.forceload.added.multiple": "%s Klunkar valdir í %s vídd frá %s til %s til skylduhleðslu",
	"commands.forceload.added.none": "Engir skylduklunkar voru fundnir í %s",
	"commands.forceload.added.single": "Valinn klunkur %s í vídd %s verður að skylduklunki",
	"commands.forceload.list.multiple": "%s skylduklunkar were voru fundnir í %s vídd við: %s",
	"commands.forceload.list.single": "Skylduklunkur var fundinn í %s vídd við: %s",
	"commands.forceload.query.failure": "Klunkur við %s í %s vídd er ekki valinn til skylduhleðslu",
	"commands.forceload.query.success": "Klunkur við %s í %s vídd er valinn til skylduhleðslu",
	"commands.forceload.removed.all": "Allir skylduklunkar afvaldir í %s",
	"commands.forceload.removed.failure": "Engir klunkar voru fjarlægðir úr skylduhleðslu",
	"commands.forceload.removed.multiple": "%s Klunkar í %s vídd frá %s til %s afvaldir til skylduhleðslu",
	"commands.forceload.removed.single": "Klunkur við %s í %s vídd, afvalinn til skylduhleðslu",
	"commands.forceload.toobig": "Of margir klunkar í völdu svæði (hámark %s, valið %s)",
	"commands.function.error.argument_not_compound": "Ógild tegund breytu: %s, bjóst við COMPOUND",
	"commands.function.error.missing_argument": "Vantar breytuna %[2]s fyrir fallið %[1]s",
	"commands.function.error.missing_arguments": "Vantar breytur fyrir fallið %s",
	"commands.function.error.parse": "Við túlkun fjölvans %s: Skipunin '%s' leiddi til villu: %s",
	"commands.function.instantiationFailure": "Tókst ekki að hefja aðgerð %s: %s",
	"commands.function.result": "Aðgerðin %s skilaði %s",
	"commands.function.scheduled.multiple": "Keyri aðgerðir %s",
	"commands.function.scheduled.no_functions": "Finn engar aðgerðir með nafninu \"%s\"",
	"commands.function.scheduled.single": "Keyri aðgerðina %s",
	...
	"commands.kick.owner.failed": "Ekki er hægt að henda út eiganda í staðarnetsleik",
	"commands.kick.singleplayer.failed": "Ekki hægt að henda út í einspilunarleik sem er ekki nettengdur",
	...
	"commands.op.success": "Gerði %s að netþjóns stjórnanda",
	...
	"commands.profile_fetch.copy_component": "Afrita hlut",
	"commands.profile_fetch.failed_to_serialize": "Tókst ekki að birta prófíl sem texta: %s",
	"commands.profile_fetch.give_item": "Gefa hlut",
	"commands.profile_fetch.id.failure": "Tókst ekki að greina prófíl fyrir auðkenni %s",
	"commands.profile_fetch.id.success": "Greindi prófíl fyrir auðkenni %s: %s",
	"commands.profile_fetch.name.failure": "Tókst ekki að greina prófíl fyrir nafnið %s",
	"commands.profile_fetch.name.success": "Greindi prófíl fyrir nafnið %s: %s",
	...
	"commands.random.error.range_too_large": "Gildi slembitölu má ekki vera stærra en 2147483646",
	"commands.random.error.range_too_small": "Gildi slembitölu má ekki vera minna en 2",
	"commands.random.reset.all.success": "Endurstilla %s slembiröð/slembiraðir",
	"commands.random.reset.success": "Endurstilla slembiröð %s",
	"commands.random.roll": "%s kastaði %s (á milli %s og %s)",
	"commands.random.sample.success": "Slembigildi: %s",
	...
	"commands.rotate.success": "Snúið %s",
	...
	"commands.schedule.macro": "Get ekki skipulagt flýtiskipanir",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Slökkt á birtingu sjálfvirkrar uppfærslu fyrir markmið %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Kveikt á birtingu sjálfvirkrar uppfærslu fyrir markmið %s",
	"commands.scoreboard.objectives.modify.displayname": "Breytti sýnilegu nafni úr %s í %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Fjarlægði sjálfgefið talnasnið af viðfangi %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Fjarlægði sjálfgefið talnasnið af viðfangi %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Fjarlægði sýnilegt nafn af %s atriðum í %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Fjarlægði sýnilegt nafn fyrir %s í %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Breytti sýnilegu nafni í %s fyrir %s atriði í %s",
	"commands.scoreboard.players.display.name.set.success.single": "Breytti sýnilegu nafni í %s fyrir %s í %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Fjarlægði talnasnið af %s atriðum í %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Hreynsaði númerasvið fyrir %s í %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Breytt um númerasvið fyrir %s einingar í %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Breytt um númerasvið fyrir %s í %s",
	...
	"commands.setidletimeout.success.disabled": "Tímamörk óvirks spilara eru nú óvirk",
	"commands.setworldspawn.failure.not_overworld": "Getur aðeins sett upphafsstaðsetningu fyrir yfirheimin",
	"commands.setworldspawn.success": "Stillti upphafspunkt heims á %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Stilla upphafspunkt heims á %s, %s, %s [%s, %s] í %s",
	"commands.spawnpoint.success.multiple": "Stillti lífgunarstað á %s, %s, %s [%s] í %s fyrir %s spilara",
	"commands.spawnpoint.success.multiple.new": "Stillti lífgunarstað á %s, %s, %s [%s,%s] í %s fyrir %s spilara",
	"commands.spawnpoint.success.single": "Stillti lífgunarstað á %s, %s, %s [%s] í %s fyrir %s",
	"commands.spawnpoint.success.single.new": "Stillti lífgunarstað á %s, %s, %s [%s,%s] í %s fyrir %s",
	"commands.spectate.cannot_spectate": "%s er ekki að skoða sem áhorfandi",
	...
	"commands.stopwatch.already_exists": "Skeiðklukkan '%s' er til",
	"commands.stopwatch.create.success": "Bjó til skeiðklukku '%s'",
	"commands.stopwatch.does_not_exist": "Skeiðklukkan '%s' er ekki til",
	"commands.stopwatch.query": "Skeiðklukkan '%s' hefur gengið %ss",
	"commands.stopwatch.remove.success": "Fjarlægði skeiðklukku '%s'",
	"commands.stopwatch.restart.success": "Endurræsti skeiðklukku '%s'",
	"commands.summon.failed": "Tókst ekki að boða veru",
	"commands.summon.failed.peaceful": "Ekki hægt að framkalla skrímsli í friðsælu erfiðleikastigi",
	...
	"commands.swing.failed.notliving": "Engin lifandi vera fannst sem gæti sveiflað",
	"commands.swing.success.multiple": "Lét %s verur sveifla handleggjunum",
	"commands.swing.success.single": "Lét %s sveifla handlegg",
	...
	"commands.team.option.color.clear.success": "Fjarlægði litinn fyrir lið %s",
	...
	"commands.test.batch.starting": "Ræsi umhverfi %s lotu %s",
	"commands.test.clear.error.no_tests": "Fann engin próf til að fjarlægja",
	"commands.test.clear.success": "Cleared %s structure(s)",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Smelltu til að afrita á klippiborð",
	"commands.test.create.success": "Búið til prófuppsetningu fyrir prófið %s",
	"commands.test.error.no_test_containing_pos": "Get ekki fundið prófunartilvik sem inniheldur %s, %s, %s",
	"commands.test.error.no_test_instances": "Fann engin prófunartilvik",
	"commands.test.error.non_existant_test": "Prófið %s fannst ekki",
	"commands.test.error.structure_not_found": "Prófskipulag %s fannst ekki",
	...
	"commands.test.no_tests": "Engin próf til að keyra",
	...
	"commands.test.run.no_tests": "Engin próf fundust",
	"commands.test.run.running": "Keyri %s próf...",
	"commands.test.summary": "Leikja Prófun lokið! %s próf voru keyrð",
	"commands.test.summary.all_required_passed": "Öll nauðsynleg próf stóðust :)",
	"commands.test.summary.failed": "%s required test(s) failed :(",
	"commands.test.summary.optional_failed": "%s optional test(s) failed",
	"commands.tick.query.percentiles": "Prósentur: P50: %sms P95: %sms P99: %sms, sýnishorn: %s",
	"commands.tick.query.rate.running": "Marktíðni tifa: %s á sekúndu.\nMeðaltími á tif: %sms (Markmið: %sms)",
	"commands.tick.query.rate.sprinting": "Tiftíðni sem stefnt er að: %s á sek. (hunsað, aðeins til viðmiðunar).\nMeðaltími á hvert tif: %sms",
	"commands.tick.rate.success": "Stillti tíðni tifa á %s á sekúndu",
	"commands.tick.sprint.report": "Spretti lokið með %s tif á sekúndu, eða %s ms á tif",
	"commands.tick.sprint.stop.fail": "Tifsprettur ekki í gangi",
	"commands.tick.sprint.stop.success": "Tifsprettur truflaður",
	"commands.tick.status.frozen": "Leikurinn er frosinn",
	"commands.tick.status.lagging": "Leikurinn er í gangi, en nær ekki að halda tiftíðninni sem stefnt er að",
	"commands.tick.status.running": "Leikurinn keyrir venjulega",
	"commands.tick.status.sprinting": "Leikur er í sprettum",
	"commands.tick.step.fail": "Getur ekki tifað leikinn - fyrst verður að frjósa leikinn",
	"commands.tick.step.stop.fail": "Tifskref ekki í gangi",
	"commands.tick.step.stop.success": "Tifskref truflað",
	"commands.tick.step.success": "Stígur %s tif",
	...
	"commands.time.pause": "Klukka í pásu %s",
	...
	"commands.time.rate": "Klukka %s mun nú tifa á %sx venjulegum hraða",
	...
	"commands.transfer.error.no_players": "Verður að tilgreina minnst einn spilara til að flytja",
	"commands.transfer.success.multiple": "Færi %s leikmenn í %s %s",
	"commands.transfer.success.single": "Flytja %s yfir í %s:%s",
	...
	"commands.version.header": "Útgáfa netþjóns:",
	...
	"commands.waypoint.list.empty": "Engir leiðarpunktar í %s",
	"commands.waypoint.list.success": "%s leiðarpunktur/punktar í %s: %s",
	"commands.waypoint.modify.color": "Litur leiðarpunkts er nú %s",
	"commands.waypoint.modify.color.reset": "Endurstilla lit leiðarpunkts",
	"commands.waypoint.modify.style": "Stíll leiðarpunkts breyttist",
	...
	"commands.whitelist.list": "Það eru (er) %s hvítlistaðir (hvítlistaður) spilarar (spilari): %s",
	...
	"component.profile.dynamic": "Kviklegt",
	...
	"connect.failed.transfer": "Nettenging brást í miðjum flutningi á þjóninn",
	...
	"connect.reconfiging": "Breyti samskipan...",
	"connect.reconfiguring": "Endurstillir...",
	"connect.transferring": "Flytur yfir á nýjan þjón...",
	"container.barrel": "Tunna",
	"container.beacon": "Leiðarljós",
	"container.beehive.bees": "Býflugur: %s / %s",
	"container.beehive.honey": "Hunang: %s / %s",
	...
	"container.repair.cost": "Reynslukostnaður: %[1]s",
	...
	"createWorld.customize.buffet.search": "Leita...",
	...
	"dataPack.bundle.description": "Virkjar knippi tilraunaatriði",
	"dataPack.bundle.name": "Knippi",
	"dataPack.locator_bar.description": "Sýna í hvaða átt aðrir spilarar eru ef í netspilun",
	"dataPack.locator_bar.name": "Staðsetningarstika",
	"dataPack.minecart_improvements.description": "Betri hreyfingar fyrir Námuvagna",
	"dataPack.minecart_improvements.name": "Námuvagns Umbætur",
	"dataPack.redstone_experiments.description": "Tilraunir með breyttan roðstein",
	"dataPack.redstone_experiments.name": "Roðassteins Tilraunir",
	"dataPack.title": "Veldu gagnapakka",
	"dataPack.trade_rebalance.description": "Uppfærð viðskipti þorpsbúa",
	"dataPack.trade_rebalance.name": "Uppfærsla á viðskiptakjörum þorpsbúa",
	...
	"dataPack.update_1_21.description": "Nýir eiginleikar og innihald í Minecraft 1.21",
	"dataPack.update_1_21.name": "Uppfærsla 1.21",
	...
	"dataPack.winter_drop.description": "Nýir eiginleikar og nýtt innihald í WInter Drop ábótinni",
	"dataPack.winter_drop.name": "Winter Drop ábótin",
	...
	"death.attack.fallingStalactite.player": "%[1]s var stungin(n) til bana af hraunstrái á meðan barist var við %[2]s",
	...
	"death.attack.mace_smash": "%[1]s var mölvaður af %[2]s",
	"death.attack.mace_smash.item": "%[1]s var mölvaður af %[2]s með %[3]s",
	...
	"death.attack.stalagmite.player": "%[1]s var stungin(n) til bana af dropsteini á meðan barist var við %[2]s",
	...
	"death.attack.sting.item": "%[1]s var stungin(n) til bana af %[2]s sem notaði %[3]s",
	...
	"death.attack.thorns.item": "%[1]s var drepin(n) af %[3]s þegar hann/hún reyndi að meiða %[2]s",
	...
	"debug.chunk_boundaries.help": "F3 + G = Sýna mörk klunka",
	"debug.chunk_boundaries.off": "Klunkamörk: falin",
	"debug.chunk_boundaries.on": "Klunkamörk: sýnd",
	...
	"debug.entry.always": "Alltaf",
	"debug.entry.currently.alwaysOn": "%s: Núna alltaf í gangi",
	...
	"debug.entry.f3": "Í F3",
	"debug.entry.overlay": "Í yfirlögn",
	...
	"debug.options.help": "F3 + F5 = Breyta villuleitarvalkostum",
	"debug.options.notAllowed.tooltip": "Ekki sýnilegt þegar upplýsingar um villuleit eru minnkaðar",
	"debug.options.profile.default": "Sjálfgefið mat",
	"debug.options.profile.performance": "Afkastamat",
	"debug.options.search": "Leita...",
	"debug.options.title": "Valkostir villugreiningar",
	"debug.options.warning": "Þessir valkostir eru eingöngu ætlaðir í tilraunaskyni. Þeir gætu hægt á tölvunni þinni, látið leikinn frjósa eða étið eftirlætissteininn þinn.",
	...
	"debug.reload_chunks.help": "F3 + A = Endurhlaða klunka",
	...
	"debug.show_hitboxes.help": "F3 + B = Sýna hæfingakassa",
	"debug.show_hitboxes.off": "Hæfingakassar: faldir",
	"debug.show_hitboxes.on": "Hæfingakassar: sýndir",
	"debug.version.header": "Útgáfa forrits:",
	"debug.version.help": "F3 + V = Sýna útgáfu forrits",
	...
	"disconnect.packetError": "Villa í netsamskiptareglum",
	"disconnect.spam": "Rekinn fyrir að blaðra",
	"disconnect.timeout": "Þjónn svarar ekki",
	"disconnect.transfer": "Flutt yfir á annan netþjón",
	"disconnect.unknownHost": "Óþekkt hýsingarhólf",
	"download.pack.failed": "Niðurhal %s pakka af %s mistókst",
	"download.pack.progress.bytes": "Framvinda: %s (heildarstærð óþekkt)",
	"download.pack.progress.percent": "Framvinda: %s%%",
	"download.pack.title": "Sæki efnispakka %s/%s",
	"editGamerule.default": "Sjálfgildi: %s",
	"editGamerule.inGame.button": "Breyta Leikreglum...",
	"editGamerule.inGame.disabled.tooltip": "Uppfærsla á leikreglum þarfnast stjórnanda heimilda.",
	"editGamerule.inGame.discardChanges.message": "Are you sure you want to discard your pending game rule changes?",
	"editGamerule.inGame.discardChanges.title": "Leikreglu Breytingar",
	"editGamerule.inGame.downloadingGamerules": "Næ í leikreglur...",
	...
	"effect.minecraft.infested": "Smitun",
	...
	"effect.minecraft.oozing": "Slíma",
	"effect.minecraft.poison": "Eitur",
	"effect.minecraft.raid_omen": "Árásarboði",
	...
	"effect.minecraft.trial_omen": "Þrautaboði",
	"effect.minecraft.unluck": "Óheppni",
	"effect.minecraft.water_breathing": "Köfun",
	"effect.minecraft.weakness": "Veiklun",
	"effect.minecraft.weaving": "Vefnaður",
	"effect.minecraft.wind_charged": "Vindhleðsla",
	...
	"enchantment.minecraft.breach": "Skarð",
	"enchantment.minecraft.channeling": "Leiðandi",
	"enchantment.minecraft.density": "Eðlisþyngd",
	...
	"enchantment.minecraft.lunge": "Lag",
	...
	"enchantment.minecraft.sweeping_edge": "Sveiflandi Sverðseggur",
	...
	"enchantment.minecraft.wind_burst": "Vindhríð",
	"entity.minecraft.acacia_boat": "Akasíubátur",
	"entity.minecraft.acacia_chest_boat": "Akasíubátur með kistu",
	"entity.minecraft.allay": "Hjálpari",
	"entity.minecraft.area_effect_cloud": "Áhrifasvæðisský",
	"entity.minecraft.armadillo": "Beltisdýr",
	"entity.minecraft.armor_stand": "Brynjustandur",
	"entity.minecraft.arrow": "Ör",
	"entity.minecraft.axolotl": "Vatnamandra",
	"entity.minecraft.bamboo_chest_raft": "Bambusfleki með kistu",
	"entity.minecraft.bamboo_raft": "Bambusfleki",
	"entity.minecraft.bat": "Leðurblaka",
	"entity.minecraft.bee": "Býfluga",
	"entity.minecraft.birch_boat": "Birkibátur",
	"entity.minecraft.birch_chest_boat": "Birkibátur með kistu",
	"entity.minecraft.blaze": "Logi",
	"entity.minecraft.block_display": "Kubbabirting",
	"entity.minecraft.boat": "Bátur",
	"entity.minecraft.bogged": "Votungur",
	"entity.minecraft.breeze": "Gola",
	"entity.minecraft.breeze_wind_charge": "Vindhnöttur",
	"entity.minecraft.camel": "Úlfaldi",
	"entity.minecraft.camel_husk": "Úlfaldahyski",
	"entity.minecraft.cat": "Köttur",
	"entity.minecraft.cave_spider": "Hellakönguló",
	"entity.minecraft.cherry_boat": "Kirsuberjabátur",
	"entity.minecraft.cherry_chest_boat": "Kirsuberjabátur með kistu",
	...
	"entity.minecraft.copper_golem": "Koparþjarki",
	"entity.minecraft.cow": "Kýr",
	"entity.minecraft.creaking": "Brakandi",
	"entity.minecraft.creaking_transient": "Brakandi",
	"entity.minecraft.creeper": "Laumupúki",
	"entity.minecraft.dark_oak_boat": "Dökkeikarbátur",
	"entity.minecraft.dark_oak_chest_boat": "Dökkeikarbátur með kistu",
	"entity.minecraft.dolphin": "Höfrungur",
	"entity.minecraft.donkey": "Asni",
	"entity.minecraft.dragon_fireball": "Eldhnöttur dreka",
	"entity.minecraft.drowned": "Sjódraugur",
	...
	"entity.minecraft.jungle_chest_boat": "Frumskógarbátur með kistu",
	"entity.minecraft.killer_bunny": "Banakanínan",
	"entity.minecraft.leash_knot": "Taumahnútur",
	"entity.minecraft.lightning_bolt": "Elding",
	"entity.minecraft.lingering_potion": "Langvarandi seyði",
	"entity.minecraft.llama": "Lamadýr",
	"entity.minecraft.llama_spit": "Lamadýrshráka",
	"entity.minecraft.magma_cube": "Kvikukubbur",
	"entity.minecraft.mangrove_boat": "Leiruviðarbátur",
	"entity.minecraft.mangrove_chest_boat": "Leiruviðarbátur með kistu",
	"entity.minecraft.mannequin": "Gína",
	...
	"entity.minecraft.nautilus": "Perlusnekkja",
	"entity.minecraft.oak_boat": "Eikarbátur",
	"entity.minecraft.oak_chest_boat": "Eikarbátur með kistu",
	"entity.minecraft.ocelot": "Pardusköttur",
	"entity.minecraft.ominous_item_spawner": "Váboðahlutaframkallari",
	"entity.minecraft.painting": "Málverk",
	"entity.minecraft.pale_oak_boat": "Föleikarbátur",
	"entity.minecraft.pale_oak_chest_boat": "Föleikarbátur með kistu",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Þurrdrumbur",
	...
	"entity.minecraft.spawner_minecart": "Námuvagn með skrímslabúr",
	"entity.minecraft.spectral_arrow": "Litróf ör",
	"entity.minecraft.spider": "Könguló",
	"entity.minecraft.splash_potion": "Skvettiseyði",
	"entity.minecraft.spruce_boat": "Grenibátur",
	"entity.minecraft.spruce_chest_boat": "Grenibátur með kistu",
	"entity.minecraft.squid": "Smokkfiskur",
	"entity.minecraft.stray": "Frávillingur",
	"entity.minecraft.strider": "Röltari",
	"entity.minecraft.sulfur_cube": "Brennisteinskubbur",
	"entity.minecraft.sulfur_cube.content": "Inniheldur: %s",
	"entity.minecraft.tadpole": "Halakarta",
	"entity.minecraft.text_display": "Textabirting",
	"entity.minecraft.tnt": "Virkt sprengiefni",
	"entity.minecraft.tnt_minecart": "Námuvagn með sprengiefni",
	"entity.minecraft.trader_llama": "Lamadýr farandsölumanns",
	...
	"entity.minecraft.wind_charge": "Vindhnöttur",
	"entity.minecraft.witch": "Norn",
	"entity.minecraft.wither": "Viðrini",
	"entity.minecraft.wither_skeleton": "Viðrinisbeinagrind",
	"entity.minecraft.wither_skull": "Viðrinishauskúpa",
	...
	"entity.minecraft.zombie_nautilus": "Perlusnekkjuuppvakningur",
	...
	"event.minecraft.raid.defeat.full": "Árás - Ósigur",
	"event.minecraft.raid.raiders_remaining": "Árásarmenn á lífi: %s",
	"event.minecraft.raid.victory": "Sigur",
	"event.minecraft.raid.victory.full": "Árás - Sigur",
	"filled_map.buried_treasure": "Fjársjóðskort",
	"filled_map.explorer_jungle": "Frumskógakönnuðarkort",
	"filled_map.explorer_swamp": "Fenjakönnuðarkort",
	"filled_map.id": "Id #%s",
	...
	"filled_map.trial_chambers": "Þrautaherbergjakort",
	"filled_map.unknown": "Óþekkt kort",
	"filled_map.village_desert": "Eyðimerkurþorpskort",
	"filled_map.village_plains": "Sléttuþorpskort",
	"filled_map.village_savanna": "Gresjuþorpskort",
	"filled_map.village_snowy": "Snjósléttuþorpskort",
	"filled_map.village_taiga": "Barrskógabeltisþorpskort",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Leyfa Hel",
	"gamerule.allowEnteringNetherUsingPortals.description": "Stjórnar hvort spilarar mega fara í Hel eða ekki",
	"gamerule.allowFireTicksAwayFromPlayer": "Eldur tifar í burtu frá spilurum",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Stjórnar því hvort eldur og hraun eigi að geta tifað lengra en 8 klunka frá hvaða spilara sem er",
	...
	"gamerule.commandBlocksEnabled": "Virkja skipanakubba",
	...
	"gamerule.disablePlayerMovementCheck": "Slökkva á athugun hreyfinga spilara",
	...
	"gamerule.enableCommandBlocks": "Virkja forritunarkubba",
	"gamerule.enderPearlsVanishOnDeath": "Kastaðar endaperlur hverfa við dauða",
	"gamerule.enderPearlsVanishOnDeath.description": "Hvort endaperlur, sem spilari kastar frá sér, hverfi við dauða spilarans.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Einindir með farðega geta notað farðega gáttir",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Leyfa einindum með farþega að fjarflytjast í gegnum Heljargáttir, Endagáttir, og Endagáttir.",
	...
	"gamerule.globalSoundEvents.description": "Þegar tilteknir leikjaviðburðir eiga sér stað, eins og yfirboðari að framkallast, heyrist hljóðið alls staðar.",
	"gamerule.keepInventory": "Halda bakpoka eftir dauða",
	"gamerule.lavaSourceConversion": "Hraun breytist í uppsprettu",
	"gamerule.lavaSourceConversion.description": "Þegar rennandi hraun er umkringt á tveimur hliðum af hraunuppsprettum breytist það í uppsprettu.",
	"gamerule.locatorBar": "Virkja staðsetningarstiku spilara",
	"gamerule.locatorBar.description": "Ef stikan er virk, sést hún á skjánum og sýnir í hvaða átt aðrir spilarar eru.",
	...
	"gamerule.maxCommandForkCount": "Takmörk á skipun kvísla",
	"gamerule.maxCommandForkCount.description": "Hámarksfjöldi kvísla sem hægt er að nota með skipunum eins og „execute as“.",
	"gamerule.maxEntityCramming": "Hámarkstroðningur vera",
	"gamerule.minecartMaxSpeed": "Hámarks hraði námuvagns",
	"gamerule.minecartMaxSpeed.description": "Hámarks sjálfgefinn hraði á námuvagni á ferð á landi.",
	"gamerule.minecraft.elytra_movement_check": "Gera prófun á hreyfingum þekjuvængs",
	"gamerule.minecraft.fire_spread_radius_around_player": "Radíus á útbreiðslu elds",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Radíus hrings talið í kubbum út frá spilara sem eldur getur breiðst út",
	"gamerule.minecraft.player_movement_check": "Gera prófun á hreyfingum spilara",
	"gamerule.minecraft.raids": "Gera árásir",
	"gamerule.minecraft.universal_anger.description": "Hlutlausar verur, sem reiðast, ráðast á nálægan spilara, ekki bara spilarann sem angraði þær. Virkar best ef \"Fyrirgefa dauðum spilurum\" er óvirkt.",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Neðrigáttartöf spilara í skapandi ham",
	"gamerule.playersNetherPortalCreativeDelay.description": "Tíminn (í tifum) sem spilari í skapandi ham þarf að standa í Neðri gátt áður en hann færist á milli.",
	"gamerule.playersNetherPortalDefaultDelay": "Neðrigáttartöf spilara þegar ekki í skapandi ham",
	"gamerule.playersNetherPortalDefaultDelay.description": "Tíminn (í tifum) sem spilari sem er ekki í skapandi ham þarf að standa í Neðri gátt áður en hann færist á milli.",
	...
	"gamerule.projectilesCanBreakBlocks": "Skot geta brotið blokkir",
	"gamerule.projectilesCanBreakBlocks.description": "Stjórnar því hvort skot sem hitta muni eyða blokkum sem þau geta eytt.",
	"gamerule.pvp": "Virkja PVP",
	"gamerule.pvp.description": "Stjórnar hvort spilarar mega skaða aðra spilara eða ekki",
	...
	"gamerule.spawnChunkRadius": "Framköllunarklunkasvæði",
	"gamerule.spawnChunkRadius.description": "Magn klunga sem eru enn hlaðnir í kringum upphafsstaðsetningu yfirheims.",
	"gamerule.spawnMonsters": "Kveikja skrímsli",
	"gamerule.spawnMonsters.description": "Stjórnar hvort skrímsli kvikna af sjálfu sér eða ekki",
	"gamerule.spawnRadius": "Radíus endurlífgunarsvæðis",
	"gamerule.spawnRadius.description": "Stjórnar stærð þess svæðis í kringum upphafspunktinn sem spilari getur framkallast á.",
	"gamerule.spawnerBlocksEnabled": "Virkja kveikjukubba",
	"gamerule.spectatorsGenerateChunks": "Leyfa áhorfendum að skapa landslag",
	"gamerule.tntExplodes": "Leyfa íkveikju sprengiefna og sprengingu þeirra",
	"gamerule.tntExplosionDropDecay": "Við sprengingar af völdum sprengiefna munu sumir kubbar ekki gefa feng",
	...
	"gamerule.waterSourceConversion": "Vatn breytist í uppsprettu",
	"gamerule.waterSourceConversion.description": "Þegar rennandi vatn er umkringt á tveimur hliðum af vatnsuppsprettum breytist það í uppsprett.",
	...
	"generator.single_biome_floating_islands": "Lofteyjur",
	"gui.abuseReport.attestation": "Með því að tilkynna þetta, þá staðfestir þú að upplýsingarnar sem þú hefur sett fram eru nákvæmar og fullgerðar eftir þinni bestu þekkingu.",
	"gui.abuseReport.comments": "Athugasemdir",
	"gui.abuseReport.describe": "Upplýsingar sem þú deilir hjálpa okkur að taka upplýsta ákvörðun.",
	"gui.abuseReport.discard.content": "Ef þú hættir mun þessi tilkynning eyðast.\nErtu viss um að þú viljir hætta?",
	"gui.abuseReport.discard.discard": "Hætta og fleygja tilkynningu",
	"gui.abuseReport.discard.draft": "Vista sem drög",
	"gui.abuseReport.discard.return": "Halda áfram að skrifa",
	"gui.abuseReport.discard.title": "Fleygja tilkynningu og athugasemdum?",
	"gui.abuseReport.draft.content": "Viltu halda áfram að skrifa fyrri tilkynningu eða henda henni og búa til nýja?",
	"gui.abuseReport.draft.discard": "Fleygja",
	"gui.abuseReport.draft.edit": "Halda áfram að skrifa",
	"gui.abuseReport.draft.quittotitle.content": "Viltu halda áfram að skrifa hana eða henda henni?",
	"gui.abuseReport.draft.quittotitle.title": "Þú ert með drög að spjalltilkynningu sem eyðist ef þú hættir",
	"gui.abuseReport.draft.title": "Breyta drögum að spjalltilkynningu?",
	"gui.abuseReport.error.title": "Vandamál við að senda tilkynninguna þína",
	"gui.abuseReport.message": "Hvar tókstu eftir þessari slæmu hegðun?\nÞetta aðstoðar okkur við úrlausn málsins.",
	"gui.abuseReport.more_comments": "Vinsamlegast lýstu því sem gerðist:",
	"gui.abuseReport.name.comment_box_label": "Vinsamlegast lýsið því hvers vegna þið viljið tilkynna þetta nafn:",
	"gui.abuseReport.name.reporting": "Þú ert að tilkynna „%s“.",
	"gui.abuseReport.name.title": "Tilkynna nafna spilara",
	"gui.abuseReport.observed_what": "Hvers vegna ertu að tilkynna þetta?",
	"gui.abuseReport.read_info": "Lærðu um tilkynningargerð",
	...
	"gui.abuseReport.reason.generic": "Ég vil tilkynna þá",
	"gui.abuseReport.reason.generic.description": "Þau pirra mig / gerðu eitthvað sem mér líkar illa við.",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Kynferðislega óviðeigandi",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Ásýndir sem eru myndræn á þann hátt sem tengist kynferðislegum gjörðum, kynfærum, og kynferðislegu ofbeldi.",
	...
	"gui.abuseReport.report_sent_msg": "Við höfum móttekið tilkynninguna þína. Þakka þér fyrir!\n\nTeymið okkar mun fara yfir hana eins fljótt og hægt er.",
	"gui.abuseReport.select_reason": "Velja flokk tilkynningar",
	"gui.abuseReport.send": "Senda tilkynningu",
	"gui.abuseReport.send.comment_too_long": "Vinsamlegast styttu athugasemdina",
	...
	"gui.abuseReport.send.no_reason": "Veldu flokk fyrir tilkynninguna",
	"gui.abuseReport.send.not_attested": "Vinsamlegast lesið textan fyrir ofan og hakið við gátreitinn til þess að geta sent skýrsluna",
	...
	"gui.abuseReport.skin.title": "Tilkynna ásýnd spilara",
	"gui.abuseReport.title": "Tilkynna spilara",
	"gui.abuseReport.type.chat": "Spjallskilaboð",
	"gui.abuseReport.type.name": "Nafn spilara",
	"gui.abuseReport.type.skin": "Ásýnd spilara",
	...
	"gui.banned.name.description": "Núverandi nafnið þitt - „%s“ - brýtur í bága við samfélagsstaðla okkar. Þú getur spilað einn, nema mun þurfa að breyta nafni þínu til að spila á netinu.\n\nFræddu þig um þetta eða sendu umsögn um mál á eftirfarandi tengli: %s",
	"gui.banned.name.title": "Nafn er ekki leyft í netspilun",
	...
	"gui.banned.reason.generic_violation": "Brot á samfélagsstöðlum",
	...
	"gui.banned.skin.description": "Núverandi ásynd þín brýtur í bága við samfélagsstaðla okkar. Þú getur enn spilað með sjálfgefnu ásýnd, eða valið nýja.\n\nFræddu þig um þetta eða sendu umsögn um mál á eftirfarandi tengli: %s",
	"gui.banned.skin.title": "Ásýnd ekki leyfð",
	...
	"gui.chatReport.title": "Tilkynna skilaboð frá spilara",
	...
	"gui.copy_link_to_clipboard": "Afrita tengil í Klippiborðið",
	"gui.days": "%s dagur(dagar)",
	"gui.done": "Búið",
	"gui.down": "Niður",
	"gui.entity_tooltip.type": "Tegund: %s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "Hafnaði %s skrám",
	"gui.fileDropFailure.title": "Ekki tókst að bæta við skrám",
	...
	"gui.game_rule.search": "Leita...",
	"gui.hours": "%s klukkutími(klukkutímar)",
	"gui.language.search": "Leita...",
	"gui.loadingMinecraft": "Hleður inn Minecraft",
	...
	"gui.none": "Ekkert",
	"gui.ok": "Í lagi",
	"gui.open_report_dir": "Opna Skýrslu Möppu",
	"gui.packSelection.search": "Leita...",
	...
	"gui.recipebook.next_page": "Næsta síða",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Fyrri síða",
	...
	"gui.remove": "Remove",
	"gui.report_to_server": "Skýrsla til þjóns",
	"gui.selectWorld.search": "Leita...",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Ekki hægt að tilkynna þennan spilara vegna þess að spjall er óvirkt eða bannað",
	...
	"gui.stats": "Tölfræði",
	"gui.stats.none_found": "Engin tölfræði fannst.",
	...
	"gui.togglable_slot": "Smella til gera rauf óvirka",
	"gui.up": "Upp",
	"gui.waitingForResponse.button.inactive": "Til baka (%ss)",
	"gui.waitingForResponse.title": "Beðið eftir þjóni",
	"gui.yes": "Já",
	...
	"item.canUse.unknown": "Óþekkt",
	"item.color": "Litur: %s",
	"item.components": "%s íhlut(ir)",
	"item.disabled": "Óvirkur hlutur",
	"item.durability": "Ending: %s / %s",
	"item.dyed": "Litaðar",
	"item.intangible": "Ósnertanlegt",
	...
	"item.minecraft.armadillo_scute": "Beltisdýrahreistur",
	"item.minecraft.armadillo_spawn_egg": "Beltisdýrsframköllunaregg",
	...
	"item.minecraft.black_bundle": "Svart knippi",
	"item.minecraft.black_dye": "Svart litarefni",
	"item.minecraft.black_harness": "Svartur vomasöðull",
	...
	"item.minecraft.blue_bundle": "Blátt knippi",
	"item.minecraft.blue_dye": "Blátt litarefni",
	"item.minecraft.blue_egg": "Blátt egg",
	"item.minecraft.blue_harness": "Blár vomasöðull",
	"item.minecraft.bogged_spawn_egg": "Votungsframköllunaregg",
	"item.minecraft.bolt_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Herklæða mynstur - Skrúfboltar",
	"item.minecraft.bone": "Bein",
	"item.minecraft.bone_meal": "Beinamjöl",
	"item.minecraft.book": "Bók",
	"item.minecraft.bordure_indented_banner_pattern": "Skörðóttur rammi fánamynstur",
	"item.minecraft.bow": "Bogi",
	"item.minecraft.bowl": "Skál",
	"item.minecraft.bread": "Brauð",
	"item.minecraft.breeze_rod": "Goluteinn",
	"item.minecraft.breeze_spawn_egg": "Goluframköllunaregg",
	...
	"item.minecraft.brown_bundle": "Brúnt knippi",
	"item.minecraft.brown_dye": "Brúnt litarefni",
	"item.minecraft.brown_egg": "Brúnt egg",
	"item.minecraft.brown_harness": "Brúnn vomasöðull",
	"item.minecraft.brush": "Sópur",
	"item.minecraft.bucket": "Fata",
	"item.minecraft.bundle": "Knippi",
	"item.minecraft.bundle.empty": "Tómt",
	"item.minecraft.bundle.empty.description": "Getur haldið á blönduðum stafla af hlutum",
	"item.minecraft.bundle.full": "Fullt",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "Brunabrot",
	"item.minecraft.burn_pottery_sherd": "Brunabrot",
	"item.minecraft.camel_husk_spawn_egg": "Kveikjuegg úlfaldahyskis",
	"item.minecraft.camel_spawn_egg": "Úlfaldaframköllunaregg",
	...
	"item.minecraft.chainmail_leggings": "Hringabrynjulegghlífar",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Herklæða mynstur - Strönd",
	...
	"item.minecraft.copper_axe": "Koparöxi",
	"item.minecraft.copper_boots": "Koparstígvél",
	"item.minecraft.copper_chestplate": "Koparbrynja",
	"item.minecraft.copper_golem_spawn_egg": "Koparþjarkaframköllunaregg",
	"item.minecraft.copper_helmet": "Koparhjálmur",
	"item.minecraft.copper_hoe": "Koparplógur",
	"item.minecraft.copper_horse_armor": "Koparhestabrynja",
	"item.minecraft.copper_ingot": "Koparhleifur",
	"item.minecraft.copper_leggings": "Koparlegghlífar",
	"item.minecraft.copper_nautilus_armor": "Koparperlusnekkjubrynja",
	"item.minecraft.copper_nugget": "Koparmoli",
	"item.minecraft.copper_pickaxe": "Koparhaki",
	"item.minecraft.copper_shovel": "Koparskófla",
	"item.minecraft.copper_spear": "Koparspjót",
	"item.minecraft.copper_sword": "Koparsverð",
	"item.minecraft.cow_spawn_egg": "Kýrframköllunaregg",
	"item.minecraft.creaking_spawn_egg": "Framköllunaregg brakanda",
	"item.minecraft.creeper_banner_pattern": "Fánamynstur",
	"item.minecraft.creeper_banner_pattern.desc": "Laumupúkamynstur",
	"item.minecraft.creeper_banner_pattern.new": "Laumupúka fánamynstur",
	...
	"item.minecraft.crossbow.projectile.multiple": "Skeyti: %s x %s",
	"item.minecraft.crossbow.projectile.single": "Skeyti: %s",
	"item.minecraft.cyan_bundle": "Blágrænt knippi",
	"item.minecraft.cyan_dye": "Lillablár litur",
	"item.minecraft.cyan_harness": "Heiðblár vomasöðull",
	...
	"item.minecraft.diamond_nautilus_armor": "Demantsperlusnekkjubrynja",
	"item.minecraft.diamond_pickaxe": "Demantshaki",
	"item.minecraft.diamond_shovel": "Demantsskófla",
	"item.minecraft.diamond_spear": "Demantsspjót",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Herklæða mynstur - Sandhólar",
	...
	"item.minecraft.ender_dragon_spawn_egg": "Endadrekaframköllunaregg",
	...
	"item.minecraft.endermite_spawn_egg": "Endamaursframköllunaregg",
	...
	"item.minecraft.eye_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Herklæða mynstur - Augað",
	"item.minecraft.feather": "Fjöður",
	"item.minecraft.fermented_spider_eye": "Kæst köngulóarauga",
	"item.minecraft.field_masoned_banner_pattern": "Akur borða fánamynstur",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Herklæða mynstur - Flæði",
	"item.minecraft.flow_banner_pattern": "Fánamynstur",
	"item.minecraft.flow_banner_pattern.desc": "Flæði",
	"item.minecraft.flow_banner_pattern.new": "Rennslisfánamynstur",
	"item.minecraft.flow_pottery_sherd": "Flæðibrot",
	"item.minecraft.flower_banner_pattern": "Fána mynnstur",
	"item.minecraft.flower_banner_pattern.desc": "Blómamynstur",
	"item.minecraft.flower_banner_pattern.new": "Blómatáknsfánamynstur",
	"item.minecraft.flower_pot": "Blóma Pottur",
	"item.minecraft.fox_spawn_egg": "Refsframköllunaregg",
	...
	"item.minecraft.globe_banner_pattern.new": "Hnattar fánamynstur",
	...
	"item.minecraft.golden_hoe": "Gullplógur",
	"item.minecraft.golden_horse_armor": "Gullhestabrynja",
	"item.minecraft.golden_leggings": "Gulllegghlífar",
	"item.minecraft.golden_nautilus_armor": "Gullperlusnekkjubrynja",
	"item.minecraft.golden_pickaxe": "Gullhaki",
	"item.minecraft.golden_shovel": "Gullskófla",
	"item.minecraft.golden_spear": "Gullspjót",
	"item.minecraft.golden_sword": "Gullsverð",
	"item.minecraft.gray_bundle": "Grátt knippi",
	"item.minecraft.gray_dye": "Grár litur",
	"item.minecraft.gray_harness": "Grár vomasöðull",
	"item.minecraft.green_bundle": "Grænt knippi",
	"item.minecraft.green_dye": "Grænt litarefni",
	"item.minecraft.green_harness": "Grænn vomasöðull",
	"item.minecraft.guardian_spawn_egg": "Verndara framköllunaregg",
	"item.minecraft.gunpowder": "Byssupúður",
	"item.minecraft.guster_banner_pattern": "Fánamynstur",
	"item.minecraft.guster_banner_pattern.desc": "Gustur",
	"item.minecraft.guster_banner_pattern.new": "Gustur fánamynstur",
	"item.minecraft.guster_pottery_sherd": "Gustabrot",
	"item.minecraft.happy_ghast_spawn_egg": "Framköllunaregg hamingjusams voms",
	"item.minecraft.harness": "Vomasöðull",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.host_armor_trim_smithing_template.new": "Herklæða mynstur - Gestgafi",
	"item.minecraft.howl_pottery_shard": "Gólsbrot",
	"item.minecraft.howl_pottery_sherd": "Gólsbrot",
	"item.minecraft.husk_spawn_egg": "Sandvakningsframköllunaregg",
	...
	"item.minecraft.iron_golem_spawn_egg": "Járnþjarkaframköllunaregg",
	...
	"item.minecraft.leather_horse_armor": "Leðurhestabrynja",
	"item.minecraft.leather_leggings": "Leðurbuxur",
	"item.minecraft.light_blue_bundle": "Ljósblátt knippi",
	"item.minecraft.light_blue_dye": "Ljósblár litur",
	"item.minecraft.light_blue_harness": "Ljósblár vomasöðull",
	"item.minecraft.light_gray_bundle": "Ljósgrátt knippi",
	"item.minecraft.light_gray_dye": "Ljósgrár litur",
	"item.minecraft.light_gray_harness": "Ljósgrár vomasöðull",
	"item.minecraft.lime_bundle": "Ljósgrænt knippi",
	"item.minecraft.lime_dye": "Ljósgrænn litur",
	"item.minecraft.lime_harness": "Gulgrænn vomasöðull",
	...
	"item.minecraft.lingering_potion.effect.infested": "Langvinnt Seyði Sýkingar",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Langvinnt seyði slímu",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Langvinnt seyði vefnaðar",
	"item.minecraft.lingering_potion.effect.wind_charged": "Langvinnt seyði vindhleðslu",
	...
	"item.minecraft.magenta_bundle": "Vínrautt knippi",
	"item.minecraft.magenta_dye": "Vínrauður litur",
	"item.minecraft.magenta_harness": "Vínrauður vomasöðull",
	...
	"item.minecraft.mojang_banner_pattern.new": "Hluts fánamynstur",
	...
	"item.minecraft.mule_spawn_egg": "Múlasnaframköllunaregg",
	"item.minecraft.mushroom_stew": "Sveppasúpa",
	"item.minecraft.music_disc_11": "Hljómplata",
	"item.minecraft.music_disc_11.desc": "C418 - 11",
	"item.minecraft.music_disc_13": "Hljómplata",
	"item.minecraft.music_disc_13.desc": "C418 - 13",
	"item.minecraft.music_disc_5": "Hljómplata",
	"item.minecraft.music_disc_5.desc": "Samuel Åberg - 5",
	"item.minecraft.music_disc_blocks": "Hljómplata",
	"item.minecraft.music_disc_blocks.desc": "C418 - blocks",
	"item.minecraft.music_disc_bounce": "Music Disc",
	"item.minecraft.music_disc_bounce.desc": "fingerspit - Bounce",
	"item.minecraft.music_disc_cat": "Hljómplata",
	"item.minecraft.music_disc_cat.desc": "C418 - cat",
	"item.minecraft.music_disc_chirp": "Hljómplata",
	"item.minecraft.music_disc_chirp.desc": "C418 - chirp",
	"item.minecraft.music_disc_creator": "Hljómplata",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Hljómplata",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Creator (Music Box)",
	"item.minecraft.music_disc_far": "Hljómplata",
	"item.minecraft.music_disc_far.desc": "C418 - far",
	"item.minecraft.music_disc_lava_chicken": "Hljómplata",
	"item.minecraft.music_disc_lava_chicken.desc": "Hyper Potions - Lava Chicken",
	"item.minecraft.music_disc_mall": "Hljómplata",
	"item.minecraft.music_disc_mall.desc": "C418 - mall",
	"item.minecraft.music_disc_mellohi": "Hljómplata",
	"item.minecraft.music_disc_mellohi.desc": "C418 - mellohi",
	"item.minecraft.music_disc_otherside": "Hljómplata",
	"item.minecraft.music_disc_otherside.desc": "Lena Raine - otherside",
	"item.minecraft.music_disc_pigstep": "Hljómplata",
	"item.minecraft.music_disc_pigstep.desc": "Lena Raine - Pigstep",
	"item.minecraft.music_disc_precipice": "Hljómplata",
	"item.minecraft.music_disc_precipice.desc": "Aaron Cherof - Precipice",
	"item.minecraft.music_disc_relic": "Hljómplata",
	"item.minecraft.music_disc_relic.desc": "Aaron Cherof - Relic",
	"item.minecraft.music_disc_stal": "Hljómplata",
	"item.minecraft.music_disc_stal.desc": "C418 - stal",
	"item.minecraft.music_disc_strad": "Hljómplata",
	"item.minecraft.music_disc_strad.desc": "C418 - strad",
	"item.minecraft.music_disc_tears": "Hljómplata",
	"item.minecraft.music_disc_tears.desc": "Amos Roddy - Tears",
	"item.minecraft.music_disc_wait": "Hljómplata",
	"item.minecraft.music_disc_wait.desc": "C418 - wait",
	"item.minecraft.music_disc_ward": "Hljómplata",
	...
	"item.minecraft.nautilus_spawn_egg": "Perlusnekkjuframköllunaregg",
	...
	"item.minecraft.netherite_horse_armor": "Heljarmálmshestabrynja",
	"item.minecraft.netherite_ingot": "Heljarmálmshleifur",
	"item.minecraft.netherite_leggings": "Heljarmálmslegghlífar",
	"item.minecraft.netherite_nautilus_armor": "Heljarmálmsperlusnekkjubrynja",
	...
	"item.minecraft.netherite_spear": "Heljarmálmsspjót",
	"item.minecraft.netherite_sword": "Heljarmálmssverð",
	"item.minecraft.netherite_upgrade_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Heljarmálmsuppfærsla",
	...
	"item.minecraft.ominous_bottle": "Váboðaflaska",
	"item.minecraft.ominous_trial_key": "Váboðaþrautalykill",
	"item.minecraft.orange_bundle": "Appelsínugult knippi",
	"item.minecraft.orange_dye": "Appelsínugulur litur",
	"item.minecraft.orange_harness": "Appelsínugulur vomasöðull",
	"item.minecraft.painting": "Málverk",
	"item.minecraft.pale_oak_boat": "Föleikarbátur",
	"item.minecraft.pale_oak_chest_boat": "Föleikarbátur með kistu",
	"item.minecraft.panda_spawn_egg": "Pöndu framköllunaregg",
	"item.minecraft.paper": "Blað",
	"item.minecraft.parched_spawn_egg": "Þurrdrumbsframköllunaregg",
	"item.minecraft.parrot_spawn_egg": "Páfagauksframköllunaregg",
	"item.minecraft.phantom_membrane": "Vofuhimna",
	"item.minecraft.phantom_spawn_egg": "Vofu framköllunaregg",
	"item.minecraft.pig_spawn_egg": "Svínsframköllunaregg",
	"item.minecraft.piglin_banner_pattern": "Fána mynnstur",
	"item.minecraft.piglin_banner_pattern.desc": "Trýni",
	"item.minecraft.piglin_banner_pattern.new": "Trýnisfánamynstur",
	...
	"item.minecraft.pink_bundle": "Bleikt knippi",
	"item.minecraft.pink_dye": "Bleikur litur",
	"item.minecraft.pink_harness": "Bleikur vomasöðull",
	...
	"item.minecraft.polar_bear_spawn_egg": "Ísbjarnarframköllunaregg",
	...
	"item.minecraft.potion.effect.infested": "Sýkingaseyði",
	...
	"item.minecraft.potion.effect.oozing": "Seyði slímu",
	...
	"item.minecraft.potion.effect.weaving": "Vefnaðarseyði",
	"item.minecraft.potion.effect.wind_charged": "Seyði Vindhleðslu",
	...
	"item.minecraft.powder_snow_bucket": "Lausamjallarfata",
	...
	"item.minecraft.pufferfish_spawn_egg": "Kúlufisksframköllunaregg",
	"item.minecraft.pumpkin_pie": "Graskersbaka",
	"item.minecraft.pumpkin_seeds": "Graskersfræ",
	"item.minecraft.purple_bundle": "Fjólublátt knippi",
	"item.minecraft.purple_dye": "Fjólublár litur",
	"item.minecraft.purple_harness": "Fjólublár vomasöðull",
	...
	"item.minecraft.rabbit_spawn_egg": "Kanínuframköllunaregg",
	"item.minecraft.rabbit_stew": "Kanínukássa",
	"item.minecraft.raiser_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Herklæða mynstur - Upprísandi",
	...
	"item.minecraft.red_bundle": "Rautt knippi",
	"item.minecraft.red_dye": "Rautt litarefni",
	"item.minecraft.red_harness": "Rauður vomasöðull",
	"item.minecraft.redstone": "Roðsteinsduft",
	"item.minecraft.resin_brick": "Kvoðusteinn",
	"item.minecraft.resin_clump": "Kvoðuköggull",
	"item.minecraft.rib_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Herklæða mynstur - Rifbein",
	...
	"item.minecraft.salmon_spawn_egg": "Laxframköllunaregg",
	"item.minecraft.scrape_pottery_sherd": "Skrapbrot",
	"item.minecraft.scute": "Hreistur",
	"item.minecraft.sentry_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Herklæða mynstur - Varðmaður",
	"item.minecraft.shaper_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Herklæða mynstur - Mótari",
	"item.minecraft.sheaf_pottery_shard": "Kippubrot",
	"item.minecraft.sheaf_pottery_sherd": "Kippubrot",
	"item.minecraft.shears": "Klippur",
	"item.minecraft.sheep_spawn_egg": "Kindarframköllunaregg",
	...
	"item.minecraft.shulker_shell": "Skálksskel",
	"item.minecraft.shulker_spawn_egg": "Framköllunaregg skálks",
	"item.minecraft.sign": "Skilti",
	"item.minecraft.silence_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Herklæða mynstur - Kyrrð",
	"item.minecraft.silverfish_spawn_egg": "Silfurskottu framköllunaregg",
	"item.minecraft.skeleton_horse_spawn_egg": "Beinagandsframköllunaregg",
	"item.minecraft.skeleton_spawn_egg": "Beinagrindarframköllunaregg",
	"item.minecraft.skull_banner_pattern": "Fána mynnstur",
	"item.minecraft.skull_banner_pattern.desc": "Hauskúpumynstur",
	"item.minecraft.skull_banner_pattern.new": "Hauskúpu fánamynstur",
	...
	"item.minecraft.snout_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Herklæða mynstur - Snoppa",
	"item.minecraft.snow_golem_spawn_egg": "Sjókarlsframköllunaregg",
	"item.minecraft.snowball": "Snjóbolti",
	"item.minecraft.spectral_arrow": "Draugaör",
	"item.minecraft.spider_eye": "Köngulóarauga",
	"item.minecraft.spider_spawn_egg": "Köngulóarframköllunaregg",
	"item.minecraft.spire_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Herklæða mynstur - Spírall",
	"item.minecraft.splash_potion": "Skvettiseyði",
	...
	"item.minecraft.splash_potion.effect.infested": "Skvettiseyði sýkingar",
	...
	"item.minecraft.splash_potion.effect.oozing": "Skvettiseyði slímu",
	...
	"item.minecraft.splash_potion.effect.weaving": "Skvettiseyði vefa",
	"item.minecraft.splash_potion.effect.wind_charged": "Skvettiseyði vindhleðslu",
	...
	"item.minecraft.stone_spear": "Steinspjót",
	"item.minecraft.stone_sword": "Steinsverð",
	"item.minecraft.stray_spawn_egg": "Útburðarframköllunaregg",
	"item.minecraft.strider_spawn_egg": "Röltara framköllunaregg",
	"item.minecraft.string": "Snæri",
	"item.minecraft.sugar": "Sykur",
	"item.minecraft.sulfur_cube_bucket": "Fata með brennisteinskubbi",
	"item.minecraft.sulfur_cube_spawn_egg": "Lífegg brennisteinskubbs",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Herklæða mynstur - Sjávarföll",
	...
	"item.minecraft.tipped_arrow.effect.fire_resistance": "Ör eldþols",
	"item.minecraft.tipped_arrow.effect.harming": "Ör skaða",
	"item.minecraft.tipped_arrow.effect.healing": "Ör lækningar",
	"item.minecraft.tipped_arrow.effect.infested": "Ör sýkingar",
	"item.minecraft.tipped_arrow.effect.invisibility": "Ör ósýnileika",
	"item.minecraft.tipped_arrow.effect.leaping": "Ör risastökks",
	"item.minecraft.tipped_arrow.effect.levitation": "Ör svifs",
	"item.minecraft.tipped_arrow.effect.luck": "Ör heppni",
	"item.minecraft.tipped_arrow.effect.mundane": "Dýfð ör",
	"item.minecraft.tipped_arrow.effect.night_vision": "Ör nætursýnar",
	"item.minecraft.tipped_arrow.effect.oozing": "Ör slímu",
	"item.minecraft.tipped_arrow.effect.poison": "Ör eiturs",
	"item.minecraft.tipped_arrow.effect.regeneration": "Ör endurnýjunar",
	"item.minecraft.tipped_arrow.effect.slow_falling": "Ör hægfara falls",
	"item.minecraft.tipped_arrow.effect.slowness": "Ör hægferðar",
	"item.minecraft.tipped_arrow.effect.strength": "Ör styrks",
	"item.minecraft.tipped_arrow.effect.swiftness": "Ör léttleika",
	"item.minecraft.tipped_arrow.effect.thick": "Dýfð ör",
	"item.minecraft.tipped_arrow.effect.turtle_master": "Ör skjaldbökumeistarans",
	"item.minecraft.tipped_arrow.effect.water": "Ör busls",
	"item.minecraft.tipped_arrow.effect.water_breathing": "Ör köfunar",
	"item.minecraft.tipped_arrow.effect.weakness": "Ör veikleika",
	"item.minecraft.tipped_arrow.effect.weaving": "Ör vefnaðar",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Ör vindhleðslu",
	"item.minecraft.tnt_minecart": "Námuvagn með sprengiefni",
	"item.minecraft.torchflower_seeds": "Kyndilblómsfræ",
	"item.minecraft.totem_of_undying": "Verndargripur tilverunnar",
	"item.minecraft.trader_llama_spawn_egg": "Sölumannslamadýrs framköllunaregg",
	"item.minecraft.trial_key": "Þrautalykill",
	...
	"item.minecraft.tropical_fish_spawn_egg": "Hitabeltisfisksframköllunaregg",
	"item.minecraft.turtle_helmet": "Skjaldbökuskel",
	"item.minecraft.turtle_scute": "Hreistur skjaldböku",
	"item.minecraft.turtle_spawn_egg": "Skjaldbökuframköllunaregg",
	"item.minecraft.vex_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Herklæða mynstur - Gremja",
	"item.minecraft.vex_spawn_egg": "Ergisframköllunaregg",
	"item.minecraft.villager_spawn_egg": "Þorpsbúaframköllunaregg",
	"item.minecraft.vindicator_spawn_egg": "Hakkaraframköllunaregg",
	"item.minecraft.wandering_trader_spawn_egg": "Farandsölumannsframköllunaregg",
	"item.minecraft.ward_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Herklæða mynstur - Vörður",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Herklæða mynstur - Leiðarvísir",
	"item.minecraft.wheat": "Hveiti",
	"item.minecraft.wheat_seeds": "Hveitifræ",
	"item.minecraft.white_bundle": "Hvítt knippi",
	"item.minecraft.white_dye": "Hvítt litarefni",
	"item.minecraft.white_harness": "Hvítur vomasöðull",
	"item.minecraft.wild_armor_trim_smithing_template": "Járnsmíðasniðmát",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Herklæða mynstur - Villingur",
	"item.minecraft.wind_charge": "Vindhnöttur",
	"item.minecraft.witch_spawn_egg": "Nornarframköllunaregg",
	"item.minecraft.wither_skeleton_spawn_egg": "Viðrinisbeinagrindar framköllunaregg",
	"item.minecraft.wither_spawn_egg": "Viðrinisframköllunaregg",
	"item.minecraft.wolf_armor": "Úlfsbrynja",
	"item.minecraft.wolf_spawn_egg": "Úlfsframköllunaregg",
	...
	"item.minecraft.wooden_spear": "Viðarspjót",
	...
	"item.minecraft.yellow_bundle": "Gult knippi",
	"item.minecraft.yellow_dye": "Gult litarefni",
	"item.minecraft.yellow_harness": "Gulur vomasöðull",
	"item.minecraft.zoglin_spawn_egg": "Nágaltar framköllunaregg",
	"item.minecraft.zombie_horse_spawn_egg": "Uppvakningshestsframköllunaregg",
	"item.minecraft.zombie_nautilus_spawn_egg": "Perlusnekkjuuppvakningsframköllunaregg",
	"item.minecraft.zombie_spawn_egg": "Uppvakningsframköllunaregg",
	...
	"item.modifiers.any": "Þegar sett er á:",
	"item.modifiers.armor": "Þegar notað er:",
	"item.modifiers.body": "Þegar búnaður:",
	"item.modifiers.chest": "Hvenær á líkamanum:",
	"item.modifiers.feet": "Hvenær á fætur:",
	"item.modifiers.hand": "Þegar haldið er á:",
	...
	"item.modifiers.saddle": "Þegar hnakkur er lagður á:",
	"item.nbt_tags": "NBT: %s merki",
	"item.op_block_warning.line1": "Aðvörun:",
	"item.op_block_warning.line2": "Að setja þennan hlut gæti orsakað framkvæmd skipunar",
	"item.op_block_warning.line3": "Ekki nota nema þú þekkir innihaldið vel!",
	"item.spawn_egg.peaceful": "Virkar ekki með friðsæld",
	...
	"jigsaw_block.placement_priority": "Staðsetningarforgangur:",
	"jigsaw_block.placement_priority.tooltip": "Þegar þessi púsl kubbur tengist við hluta, þetta er röðin sem þessi hluti er athugaður fyrir tengingum við heildar bygginguna.",
	"jigsaw_block.pool": "Efniviður púsls:",
	"jigsaw_block.selection_priority": "Valforgangur:",
	"jigsaw_block.selection_priority.tooltip": "Þegar forhlutur er í vinnslu fyrir tengingum, þetta er röðin sem þessi Púsl kubbur reynir að tengjast við markmiðs hlutanum sínum.\n\nUnnið verður úr Púslkubbum í lækkandi forgangi með handahófskendri röð rjúfandi tengja.",
	...
	"jukebox_song.minecraft.cat": "C418 - köttur",
	"jukebox_song.minecraft.chirp": "C418 - tíst",
	"jukebox_song.minecraft.creator": "Lena Raine - Skapari",
	"jukebox_song.minecraft.creator_music_box": "Lena Raine - Creator (Spiladós)",
	"jukebox_song.minecraft.far": "C418 - far",
	"jukebox_song.minecraft.lava_chicken": "Hyper Potions - Hraunhænur",
	"jukebox_song.minecraft.mall": "C418 - mall",
	"jukebox_song.minecraft.mellohi": "C418 - mellohi",
	"jukebox_song.minecraft.otherside": "Lena Raine - hinhliðin",
	"jukebox_song.minecraft.pigstep": "Lena Raine - Svínskref",
	...
	"jukebox_song.minecraft.tears": "Amos Roddy - Tár",
	...
	"key.categories.spectator": "Áhorfandi",
	"key.categories.ui": "Leik viðmót",
	"key.category.minecraft.creative": "Skapandi leikur",
	"key.category.minecraft.debug": "Villuleit (Debug)",
	"key.category.minecraft.gameplay": "Tegund leiks",
	"key.category.minecraft.inventory": "Bakpoki",
	"key.category.minecraft.misc": "Ýmislegt",
	"key.category.minecraft.movement": "Hreyfingar",
	"key.category.minecraft.multiplayer": "Netspilun",
	"key.category.minecraft.spectator": "Áhorfandi",
	"key.chat": "Opna spjall",
	"key.command": "Opna skipun",
	"key.debug.clearChat": "Hreinsa spjall",
	"key.debug.copyLocation": "Afrita staðsetningu",
	"key.debug.copyRecreateCommand": "Afrita gögn",
	"key.debug.crash": "Villugreina hrun",
	"key.debug.debugOptions": "Valkostir villugreiningar",
	"key.debug.dumpDynamicTextures": "Demba virkum áferðum",
	"key.debug.dumpVersion": "Demba útgáfuupplýsingum",
	"key.debug.focusPause": "Pása við misstan fókus af/á",
	"key.debug.fpsCharts": "FPS myndrit",
	"key.debug.lightmapTexture": "Birtukortsáferð",
	"key.debug.modifier": "Villugreina breytilykil",
	"key.debug.networkCharts": "Myndrit netkerfis",
	"key.debug.overlay": "Yfirlögn af/á",
	"key.debug.profiling": "Hefja/stöðva gerð lýsingar",
	"key.debug.profilingChart": "Myndrit lýsingar",
	"key.debug.reloadChunk": "Endurhlaða stæður",
	"key.debug.reloadResourcePacks": "Endurhlaða efnispakka",
	"key.debug.showAdvancedTooltips": "Sýna ítarlega áhaldahjálp",
	"key.debug.showChunkBorders": "Sýna mörk stæðna",
	"key.debug.showHitboxes": "Sýna hæfingakassa",
	...
	"key.quickActions": "Flýtiaðgerðir",
	...
	"known_server_link.announcements": "Tilkynningar",
	"known_server_link.community": "Samfélag",
	"known_server_link.community_guidelines": "Reglur samfélagsins",
	"known_server_link.feedback": "Endurgjöf",
	"known_server_link.forums": "Spjallþræðir",
	"known_server_link.news": "Fréttir",
	"known_server_link.report_bug": "Tilkynna vandamál",
	"known_server_link.status": "Staða",
	"known_server_link.support": "Hjálp",
	"known_server_link.website": "Vefsetur",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Bæta við Leikjaþjóni",
	"manageServer.edit.title": "Breyta Upplýsingum Leikjaþjóns",
	"manageServer.enterIp": "Vistfang Leikjaþjóns",
	"manageServer.enterName": "Nafn Leikjaþjóns",
	"manageServer.resourcePack": "Efnispakkar þjóns",
	"manageServer.resourcePack.disabled": "Óvirkt",
	"manageServer.resourcePack.enabled": "Virkt",
	"manageServer.resourcePack.prompt": "Spyrja",
	"mco.account.privacy.info": "Lesa meira um Mojang og persónuverndarlög",
	"mco.account.privacy.info.button": "Lesa meira um GDPR",
	"mco.account.privacy.information": "Mojang framfylgir vissum aðferðum sem stuðla að verndun barna og einkalífs þeirra, þar á meðal að fylgja COPPA lögum um verndun barna á netinu og GDPR reglugerð um almennt gagnaöryggi.",
	...
	"mco.backup.entry.worldType.adventureMap": "Ævintýrakort",
	"mco.backup.entry.worldType.experience": "Upplifun",
	"mco.backup.entry.worldType.inspiration": "Innblástur",
	"mco.backup.entry.worldType.minigame": "Smáleikur",
	"mco.backup.entry.worldType.normal": "Venjulegur",
	"mco.backup.entry.worldType.unknown": "Óþekktur",
	"mco.backup.generate.world": "Gera heim",
	"mco.backup.info.title": "Breytingar frá síðustu afritun",
	"mco.backup.narration": "Afrit frá %s",
	...
	"mco.client.outdated.stable.version": "Þín biðils útgáfa (%s) er ekki samhæf Ríkjunum.",
	"mco.client.unsupported.snapshot.version": "Þín biðils útgáfa (%s) er ekki samhæf Ríkjunum.\n\nRíkin eru ekki aðgengileg fyrir þessa skjáskots útgáfu.",
	"mco.compatibility.downgrade": "Niðurfæra",
	"mco.compatibility.downgrade.description": "Þessi heimur var síðast spilaður í %s útgáfunni; þú ert með %s útgáfuna. Að lækka útgáfu heims getur valdið spillingu - við getum ekki borið ábyrgð á hvort hann mun hlaðast eða virka.",
	"mco.compatibility.incompatible.popup.title": "Ósamræmd útgáfa",
	"mco.compatibility.incompatible.releaseType.popup.message": "Heimurinn sem að þú ert að reyna að tengjast við virkar ekki með útgáfunni sem þú ert á.",
	"mco.compatibility.incompatible.series.popup.message": "Þessi heimur var seinast spilaður á útgáfu %s; þú ert á útgáfu %s.",
	"mco.compatibility.unverifiable.message": "Útgáfan sem þessi heimur var seinast spilaður á gat ekki verið staðfest. Ef að heimurinn verður uppfærður eða niðurfærður, þá verður öryggisafrit sjálfkrafa búið til og vistað undir \"World Backups\".",
	"mco.compatibility.unverifiable.title": "Ekki hægt að staðfesta samhæfni",
	"mco.compatibility.upgrade": "Uppfæra",
	"mco.compatibility.upgrade.description": "Þessi heimur var seinast spilaður á útgáfu %s; þú ert á útgáfu %s.\n\nþað verður öryggisafrit sjálfkrafa búið til og vistað undir \"World Backups\".\n\nEndurheimtu heiminn þinn ef þörf krefur.",
	"mco.compatibility.upgrade.friend.description": "Þessi heimur var seinast spilaður á útgáfu %s; þú ert á útgáfu %s.\n\nþað verður öryggisafrit sjálfkrafa búið til og vistað undir \"World Backups\".\n\nEigandinn af Realminu getur endurheimt heiminn ef þörf krefur.",
	"mco.compatibility.upgrade.title": "Ertu viss um að þú villt upfærra þennan heim?",
	...
	"mco.configure.world.buttons.newworld": "Nýr Heimur",
	...
	"mco.configure.world.buttons.region_preference": "Velja svæði...",
	"mco.configure.world.buttons.resetworld": "Endurstilla heim",
	"mco.configure.world.buttons.save": "Vista",
	...
	"mco.configure.world.close.question.title": "Þarftu að gera breytingar án þess að rjúfa spilun?",
	"mco.configure.world.closing": "Loka ríkinu...",
	"mco.configure.world.commandBlocks": "Forritunar Kubbar",
	...
	"mco.configure.world.loading": "Hleð inn ríki",
	"mco.configure.world.location": "Staðsetning",
	"mco.configure.world.minigame": "Nú: %s",
	"mco.configure.world.name": "Heiti ríkis",
	"mco.configure.world.name.validation.whitespace": "Má hvorki byrja né enda á bili. Það verður klippt burt.",
	...
	"mco.configure.world.players.inviting": "Býður spilara...",
	"mco.configure.world.players.title": "Spilarar",
	"mco.configure.world.pvp": "PVP",
	"mco.configure.world.region_preference": "Æskilegt svæði",
	"mco.configure.world.region_preference.title": "Val á svæði",
	...
	"mco.configure.world.resourcepack.question": "Þú þarft sérsniðinn efnispakka til að spila á þessu Realm\n\nViltu niðurhlaða því og spila?",
	...
	"mco.configure.world.settings.expired": "Þú getur ekki breytt stillingum fyrir útrunnið ríki",
	...
	"mco.configure.world.subscription.tab": "Áskrift",
	...
	"mco.create.world.wait": "Skapa ríki...",
	...
	"mco.download.confirmation.oversized": "Heimurinn sem að þú ert að fara að niðurhlaða er stærri en %s\n\nÞú munnt ekki geta hlaðað upp þennan heim í Realm aftur",
	...
	"mco.errorMessage.generic": "Það kom upp villa: ",
	"mco.errorMessage.initialize.failed": "Tókst ekki að setja upp ríki",
	"mco.errorMessage.noDetails": "Engar upplýsingar gefnar um villuna",
	"mco.errorMessage.realmsService": "Það kom upp villa (%s):",
	"mco.errorMessage.realmsService.configurationError": "Verið að breyta realms plássi sem óvænt er óvirkt",
	"mco.errorMessage.realmsService.connectivity": "Ekki tókst að tengjast Realms: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Ekki tókst að athuga með samhæfða útgáfu, þetta svar fékkst: %s",
	"mco.errorMessage.retry": "Reyni aðgerð aftur",
	...
	"mco.invited.player.narration": "Boðinn spilari %s",
	...
	"mco.notification.transferSubscription.buttonText": "Færa núna",
	"mco.notification.transferSubscription.message": "Java Realms áskriftir eru að færast til Microsoft Store. Ekki láta áskriftina þína renna út!\nFærðu þig núna og fáðu 30 daga af Realms frítt.\nFarðu á Profile á minecraft.net til að færa áskriftina þína.",
	...
	"mco.onlinePlayers": "Online Leikmenn",
	"mco.play.button.realm.closed": "Ríki er lokað",
	...
	"mco.selectServer.create.subtitle": "Veldu heim til að hlaða á nýja nethýsingu",
	...
	"mco.selectServer.trial": "Náðu þraut!",
	"mco.selectServer.uninitialized": "Smelltu til að búa til ríki!",
	"mco.snapshot.createSnapshotPopup.text": "Þú ert að fara búa til ókeypis Skjáskots Ríki sem verður parað við Ríkis áskriftina sem þú borgar fyrir. Þetta nýja Skjáskots Ríki mun vera aðgengilegt eins lengi og áskriftin sem borguð er fyrir er virk. Ríkið sem þú borgar fyrir verður ekki fyrir neinum áhrifum.",
	"mco.snapshot.createSnapshotPopup.title": "Búa til tilraunarútgáfu Ríkis?",
	"mco.snapshot.creating": "Bý til tilraunarútgáfu Ríkis...",
	"mco.snapshot.description": "Í samræmi við \"%s\"",
	"mco.snapshot.friendsRealm.downgrade": "Þú þarft að vera í útgáfu %s til þess að tengjast þessu ríki",
	"mco.snapshot.friendsRealm.upgrade": "%s þarf að uppfæra Ríkið sitt áður en þú getur spilað með þessari útgáfu",
	"mco.snapshot.paired": "Þetta Skjáskots Ríki er parað við\"%s\"",
	"mco.snapshot.parent.tooltip": "Notaðu nýjustu útgáfu Minecraft til að spila á þessum Realm",
	"mco.snapshot.start": "Byrja frítt Skjáskots Ríki",
	"mco.snapshot.subscription.info": "Þetta er Skjáskots Ríki sem hefur verið parað við áskriftina að Ríkinu þínu '%s'. Það verður áfram virkt jafn lengi og Ríkið sem það er parað við.",
	"mco.snapshot.tooltip": "Notaðu Skjáskots Ríkin til að kíkja á næstkomandi útgáfur af Minecraft, sem gæti innihaldið nýja virkni og aðrar breytingar.\n\nÞú getur fundið venjulegu Ríkin þín í aðal útgáfunni af leiknum.",
	"mco.snapshotRealmsPopup.message": "Ríkin eru núna aðgengileg í Skjáskotum frá og með Skjáskoti 23w41a. Hver Ríkis áskrift kemur með ókeypis Skjáskots Ríki sem er aðskilið frá venjulega Java Ríkinu þínu!",
	"mco.snapshotRealmsPopup.title": "Ríkin eru nú aðgengileg í Skjáskotum",
	"mco.snapshotRealmsPopup.urlText": "Læra meira",
	...
	"mco.upload.failed.too_big.description": "Valinn heimur er of stór. Leyfð hámarksstærð er %s.",
	"mco.upload.failed.too_big.title": "Heimur of stór",
	...
	"mco.version": "Útgáfa: %s",
	"mco.warning": "Varúð!",
	"mco.worldSlot.minigame": "Smáleikur",
	"menu.custom_options": "Sérsniðnir valkostir...",
	"menu.custom_options.title": "Sérsniðnir valkostir",
	"menu.custom_options.tooltip": "Taktu eftir: Sérsniðnir valkostir eru frá þjónum og/eða innihaldi þriðju aðila.\nNotist með varúð!",
	"menu.custom_screen_info.button_narration": "Þetta er sérsniðin skjámynd. Nánar.",
	"menu.custom_screen_info.contents": "Innihaldi þessarar skjámyndar er stjórnað af þjónum og kortum þriðja aðila sem eru ekki í eigu, undir stjórn eða eftirliti Mojang Studios eða Microsoft.\n\nEf þessi skjámynd kemur í veg fyrir að þú getir spilað, getur þú aftengst þjóninum með því að nota hnappinn hér fyrir neðan.",
	"menu.custom_screen_info.disconnect": "Sérsniðinni skjámynd hafnað",
	"menu.custom_screen_info.title": "Athugasemd um sérsniðnar skjámyndir",
	"menu.custom_screen_info.tooltip": "Þetta er sérsniðin skjámynd. Smelltu hér til að fá upplýsingar.",
	"menu.disconnect": "Aftengjast",
	"menu.feedback": "Afturverkun...",
	"menu.feedback.title": "Afturverkun",
	...
	"menu.quick_actions": "Flýtiaðgerðir...",
	"menu.quick_actions.title": "Flýtiaðgerðir",
	...
	"menu.server_links": "Tenglar þjóns...",
	"menu.server_links.title": "Tenglar þjóns",
	...
	"multiplayer.codeOfConduct.check": "Ekki bera upp þessar hátternisreglur aftur",
	"multiplayer.codeOfConduct.title": "Hátternisreglur þjóns",
	"multiplayer.confirm_command.parse_errors": "Þú ert að reyna framkvæma óþekkta eða ógilda skipun.\nErtu viss?\nSkipunin: %s",
	"multiplayer.confirm_command.permissions_required": "Þú ert að reyna að framkvæma skipun sem þarf meiri heimildir.\nÞetta getur haft neikvæð áhrif á leikinn.\nErtu viss?\nSkipunin: %s",
	"multiplayer.confirm_command.run_command": "Keyra Skipun",
	...
	"multiplayer.confirm_command.suggest_command": "Afrita í Spjall Glugga",
	"multiplayer.confirm_command.title": "Staðfesta framkvæmd skipunar",
	"multiplayer.disconnect.authservers_down": "Auðkenningarnetþjónar liggja niðri. Afsakið þetta en vinsamlegast reynið síðar!",
	"multiplayer.disconnect.bad_chat_index": "Fékk ólesin eða breytt spjallskilaboð frá netþjóni",
	...
	"multiplayer.disconnect.banned.reason.default": "Bannað af stjórnanda.",
	...
	"multiplayer.disconnect.code_of_conduct": "Þjónn krefst þess að hátternisreglurnar séu samþykktar",
	...
	"multiplayer.disconnect.transfers_disabled": "Miðlari samþykkir ekki millifærslur",
	...
	"multiplayer.message_not_delivered": "Get ekki sent skilaboð úr spjalli, ath. atvikaskrár þjóns: %s",
	...
	"multiplayer.status.anonymous_player": "Nafnleyndur Leikspilari",
	...
	"music.game.deeper": "Lena Raine - Dýpra",
	"music.game.dry_hands": "C418 - Dry Hands",
	"music.game.ebb": "fingerspit - Ebb",
	"music.game.echo_in_the_wind": "Aaron Cherof - Bergmál í vindi",
	...
	"narration.suggestion.usage.cycle.fixed": "Ýttu á Tab til að sjá næstu uppástungu",
	"narration.suggestion.usage.cycle.hidable": "Ýttu á Tab til að sjá næstu uppástungu, eða Escape til að hætta",
	"narration.suggestion.usage.fill.fixed": "Ýttu á Tab til að nota uppástungu",
	"narration.suggestion.usage.fill.hidable": "Ýttu á Tab til að nota uppástungu, eða Escape til að hætta",
	...
	"narrator.ready_to_play": "Tilbúið til spilunar",
	...
	"narrator.select.world_info": "Val %s, síðasta spilun: %s, %s",
	...
	"optimizeWorld.confirm.proceed": "Búa til öryggisafrit og hagræða",
	"optimizeWorld.confirm.title": "Hagræðing á heimi",
	"optimizeWorld.info.converted": "Uppfærsla á klunkum: %s",
	"optimizeWorld.info.skipped": "Slepptir klunkar: %s",
	"optimizeWorld.info.total": "Samtals klunkar: %s",
	...
	"optimizeWorld.stage.finished.chunks": "Er að klára að uppfæra klunka...",
	"optimizeWorld.stage.finished.entities": "Er að klára að uppfæra verur...",
	"optimizeWorld.stage.finished.poi": "Er að klára að uppfæra áhugaverða punkta...",
	"optimizeWorld.stage.upgrading": "Uppfærir alla klunka...",
	"optimizeWorld.stage.upgrading.chunks": "Uppfærir alla klunka...",
	"optimizeWorld.stage.upgrading.entities": "Uppfærir öll einindi...",
	"optimizeWorld.stage.upgrading.poi": "Uppfæri alla áhugaverða punkta...",
	"optimizeWorld.title": "Hagræðing á heimi '%s'",
	"options.accessibility": "Aðgengisstillingar...",
	...
	"options.accessibility.high_contrast_block_outline": "Háskerpuútlínur kubba",
	"options.accessibility.high_contrast_block_outline.tooltip": "Skerpir útlínur kubbsins sem átt er við.",
	"options.accessibility.link": "Aðgengisleiðbeiningar",
	"options.accessibility.menu_background_blurriness": "Bakgrunnur valmyndar Afskerping",
	"options.accessibility.menu_background_blurriness.tooltip": "Breytir óskýrleika á bakgrunn á valmynd.",
	"options.accessibility.narrator_hotkey": "Flýtihnappur talgervils",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Kveikir og slekkur á Talgervli með '⌘+B'",
	"options.accessibility.narrator_hotkey.tooltip": "Kveikir og slekkur á talgervli með 'Ctrl+B'",
	...
	"options.allowCursorChanges": "Leyfa breytingar á músarbendli",
	"options.allowCursorChanges.tooltip": "Leyfir að músarbendillinn breyti um lögun á vissum atriðum í skjámynd.",
	...
	"options.attackIndicator": "Árásarmælir",
	...
	"options.chat.title": "Spjallstillingar...",
	...
	"options.chunkFade": "Dofnunartími svæðis",
	"options.chunkFade.none": "Dofnun svæðis: Engin",
	"options.chunkFade.seconds": "Dofnun svæðis: %s sek.",
	...
	"options.cutoutLeaves": "Gegnsæ laufblöð",
	...
	"options.darknessEffectScale.tooltip": "Stjórnar hversu mikið myrkursáhrifin sveiflast þegar vörður eða skelksskrækir leggur þau á þig.",
	...
	"options.difficulty.peaceful.info": "Engar óvinaverur birtast og aðeins sumar hlutlausar verur. Hungurstikan minnkar ekki og heilsa endurheimtist með tímanum.",
	...
	"options.exclusiveFullscreen": "Einkaheilskjár",
	"options.exclusiveFullscreen.warningTooltip": "Þessi stilling gæti komið í veg fyrir sumar ílagsaðferðir.",
	"options.font": "Stillingar leturgerða...",
	"options.font.title": "Stillingar leturgerða",
	...
	"options.graphics.custom": "Sérsnið",
	...
	"options.graphics.preset": "Forstilling",
	...
	"options.graphicsApi": "Forritunarviðmót grafíkur",
	"options.graphicsApi.default": "Sjálfgefið",
	"options.graphicsApi.opengl": "Kýs OpenGL",
	"options.graphicsApi.restart": "Þú verður að endurræsa leikinn til að breyta forritunarviðmóti grafíkur.",
	"options.graphicsApi.tooltip": "Hvaða forritunarviðmót grafíkur á að nota fyrir myndsetningu. Láttu vera Sjálfgefið nema þú hafir sérstaka ástæðu til að breyta! Virkjast næst þegar þú ræsir leikinn.",
	"options.graphicsApi.tooltip.vulkan": "Experimental. Might reduce performance or cause instability on some systems.",
	"options.graphicsApi.vulkan": "Kýs Vulkan",
	...
	"options.hideSplashTexts": "Fela gular textalínur",
	"options.hideSplashTexts.tooltip": "Felur gular textalínur á aðalvalmynd.",
	"options.improvedTransparency": "Bætt gegnsæi",
	...
	"options.inactivityFpsLimit": "Minnka FPS þegar",
	"options.inactivityFpsLimit.afk": "Ekki Við Tölvuna",
	"options.inactivityFpsLimit.afk.tooltip": "Takmarkar rammahraða við 30 þegar spilari er ekki að gera neitt í leiknum í lengur en mínútu. Takmarkar niður í 10 ramma eftir meira en 9 mínútur.",
	"options.inactivityFpsLimit.minimized": "Falinn",
	"options.inactivityFpsLimit.minimized.tooltip": "Takmarkar rammahraða einungis þegar leik glugginn er falinn.",
	"options.invertMouse": "Snúa mús við",
	"options.invertMouseX": "Snúa við X-ás músar",
	"options.invertMouseY": "Snúa við Y-ás músar",
	"options.japaneseGlyphVariants": "Japönsk tákn afbrigði",
	"options.japaneseGlyphVariants.tooltip": "Notar japönsk afbrigði af CJK stöfum í sjálfgefnu leturgerðinni.",
	"options.key.hold": "Halda niðri",
	"options.key.toggle": "Rofi",
	"options.language": "Tungumál...",
	"options.language.narration": "Change Language",
	"options.language.title": "Tungumál",
	"options.language.tooltip": "Change Language",
	"options.languageAccuracyWarning": "(Þýðingar gætu verið ónákvæmar)",
	...
	"options.maxAnisotropy": "Stefnussíun",
	...
	"options.musicToast": "Tónlistarskilaboð",
	"options.musicToast.never": "Aldrei",
	"options.musicToast.never.tooltip": "Tónlistarskilaboð eru ekki sýnd.",
	"options.musicToast.pauseMenu": "Valmynd hlés",
	"options.musicToast.pauseMenu.tooltip": "Tónlistarskilaboð eru stöðugt sýnd í hlévalmynd leiks á meðan lag spilar.",
	"options.musicToast.pauseMenuAndToast": "Hlévalmynd og skilaboð",
	"options.musicToast.pauseMenuAndToast.tooltip": "Sýnir skilaboð þegar lag byrjar að spila. Sömu skilaboð sjást í hlévalmynd leiks á meðan lagið er að spilast.",
	"options.music_frequency": "Tíðni tónlistar",
	"options.music_frequency.constant": "Stöðug",
	"options.music_frequency.default": "Sjálfgefið",
	"options.music_frequency.frequent": "Oft",
	"options.music_frequency.tooltip": "Breytir því hve oft tónlist spilast í leikveröld.",
	...
	"options.needsRestart": "Stilling verður virk eftir endurræsingu.",
	...
	"options.prioritizeChunkUpdates.nearby.tooltip": "Nálægir klunkar eru alltaf byggðir strax. Þetta getur haft áhrif á keyrslutíma leiksins þegar kubbar eru settir niður eða eyðilagðir.",
	...
	"options.realmsNotifications.tooltip": "Sækja Ríkisfréttir og boð á titilskjá og birtir viðkomandi táknmynd á takkanum fyrir Ríkin.",
	"options.reducedDebugInfo": "Stytt villuleitargögn",
	"options.renderClouds": "Ský",
	"options.renderCloudsDistance": "Fjarlægð skýja",
	...
	"options.rotateWithMinecart": "Snúast með Námuvögnum",
	"options.rotateWithMinecart.tooltip": "Hvort sjón leikspilara eigi að snúast með námuvagni í beygjum. Einungis í boði fyrir heima sem hafa kveikt á 'Námuvagns Umbætur' tilraunar stillingunni.",
	...
	"options.showNowPlayingToast": "Sína tónlista skilaboð",
	"options.showNowPlayingToast.tooltip": "Sýnir skilaboð í hvert skipti sem lag byrjar að spila. Sama skilaboðið er stöðugt sýnt í hlévalmynd leiksins á meðan lagið spilar.",
	"options.showSubtitles": "Hljóðtexti",
	"options.showSubtitles.tooltip": "Virkir skjátexta fyrir hljóð sem spilast í leiknum.",
	...
	"options.telemetry.disabled": "Fjarmæling er óvirkt.",
	"options.telemetry.state.all": "Allt",
	"options.telemetry.state.minimal": "Í lágmarki",
	"options.telemetry.state.none": "Ekkert",
	"options.textureFiltering": "Síun áferða",
	"options.textureFiltering.anisotropic": "Stefnuvirkt",
	"options.textureFiltering.anisotropic.tooltip": "Síunaraðferð í vélbúnaði, sem dregur úr afköstum og hefur veruleg áhrif á notkun skjáminnis. Ekki víst að allur vélbúnaður hafi þessa aðferð.",
	"options.textureFiltering.none": "Ekkert",
	"options.textureFiltering.none.tooltip": "Áferðir eru birtar án nokkurrar síunar. Kubbar gætu virst þokukenndir séðir frá hlið.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nSíunaraðferð sem notar skjáskyggnur (shaders) til að bæta gæði áferða án mikilla áhrifa á afköst.",
	"options.title": "Stillingar",
	"options.touchscreen": "Fyrir snertiskjái",
	"options.value": "%s",
	"options.video": "Myndstillingar...",
	"options.video.display.header": "Skjár",
	"options.video.interface.header": "Viðmót",
	"options.video.preferences.header": "Persónustillingar",
	"options.video.quality.header": "Gæði og afköst",
	"options.videoTitle": "Myndstillingar",
	"options.viewBobbing": "Sjá skopp",
	"options.vignette": "Sýna hvarfrasta",
	...
	"options.worldOptions.button": "Stillingar Heims...",
	"options.worldOptions.title": "Stillingar Heims",
	...
	"pack.dropRejected.message": "Eftirfarandi færslur voru ekki gildir pakkar og voru ekki afritaðar:\n %s",
	"pack.dropRejected.title": "Færslur sem ekki eru pakkar",
	...
	"pack.incompatible.unknown": "(Brotið eða ósamhæfandi)",
	...
	"painting.minecraft.bouquet.title": "Blómvöndur",
	...
	"painting.minecraft.cavebird.title": "Hellisfugl",
	"painting.minecraft.changing.author": "Kristoffer Zetterstrand",
	"painting.minecraft.changing.title": "Breyting",
	...
	"realms.configuration.region.australia_east": "Nýja Suður-Wales, Ástralíu",
	"realms.configuration.region.australia_southeast": "Viktoría, Ástralíu",
	"realms.configuration.region.brazil_south": "Brasilía",
	"realms.configuration.region.central_india": "Indland",
	"realms.configuration.region.central_us": "Iowa, BNA",
	"realms.configuration.region.east_asia": "Hong Kong",
	"realms.configuration.region.east_us": "Virginia, BNA",
	"realms.configuration.region.east_us_2": "Norður-Karolína, BNA",
	"realms.configuration.region.france_central": "Frakkland",
	"realms.configuration.region.japan_east": "Austur-Japan",
	"realms.configuration.region.japan_west": "Vestur-Japan",
	"realms.configuration.region.korea_central": "Suður-Kórea",
	"realms.configuration.region.north_central_us": "Illinois, BNA",
	"realms.configuration.region.north_europe": "Írland",
	"realms.configuration.region.south_central_us": "Texas, BNA",
	"realms.configuration.region.southeast_asia": "Singapúr",
	"realms.configuration.region.sweden_central": "Svíþjóð",
	"realms.configuration.region.uae_north": "Sameinuðu arabísku furstadæmin (UAE)",
	"realms.configuration.region.uk_south": "Suður-England",
	"realms.configuration.region.west_central_us": "Utah, BNA",
	"realms.configuration.region.west_europe": "Holland",
	"realms.configuration.region.west_us": "Kalifornía, BNA",
	"realms.configuration.region.west_us_2": "Washington, BNA",
	"realms.configuration.region_preference.automatic_owner": "Sjálfvirkt (ping á Realm eiganda)",
	"realms.configuration.region_preference.automatic_player": "Sjálfvirkt (fyrsti þátttakandi)",
	"realms.missing.snapshot.error.text": "Realms styður ekki notkun \"snapshots\"",
	"recipe.notFound": "Óþekkt uppskrift: %s",
	"recipe.toast.description": "Kíktu í uppskriftabókina",
	"recipe.toast.title": "Nýjar uppskriftir tiltækar!",
	"record.nowPlaying": "Er að spila: %s",
	"recover_world.bug_tracker": "Tilkynna villu",
	"recover_world.button": "Reyna að endurheimta",
	"recover_world.done.failed": "Ekki tókst að endurheimta frá fyrri stöðu.",
	"recover_world.done.success": "Endurheimt tókst!",
	"recover_world.done.title": "Endurheimt lokið",
	"recover_world.issue.missing_file": "Skrá vantar",
	"recover_world.issue.none": "Engin vandamál",
	"recover_world.message": "Eftirfarandi málefni komu upp meðan verið var að reyna lesa heimsmöppuna \"%s\".\nÞað gæti verið mögulegt að endurgera heiminn frá eldra ástandi eða þú getur tilkynnt þetta mál á villu fylgdinni.",
	"recover_world.no_fallback": "Engin staða í boði til að endurheimta frá",
	"recover_world.restore": "Tilraun til að endurheimta",
	"recover_world.restoring": "Reyni að endurheimta heiminn...",
	"recover_world.state_entry": "Staða frá %s: ",
	"recover_world.state_entry.unknown": "óþekkt",
	"recover_world.title": "Tókst ekki að hlaða heim",
	"recover_world.warning": "Tókst ekki að hlaða heimsupplýsingar",
	...
	"resourcePack.runtime_failure": "Villa fannst í efnispakka",
	...
	"restrictions_screen.button": "Bönn...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Þú getur fengið skilaboð frá spilurum",
	"restrictions_screen.permission.receive_player_messages.denied": "Þú getur ekki fengið skilaboð frá spilurum",
	"restrictions_screen.permission.receive_system_messages.allowed": "Þú getur fengið skilaboð um kerfi frá netþjóni",
	"restrictions_screen.permission.receive_system_messages.denied": "Þú getur ekki fengið skilaboð um kerfi frá netþjóni",
	"restrictions_screen.permission.send_commands.allowed": "Þú getur sent skipanir",
	"restrictions_screen.permission.send_commands.denied": "Þú getur ekki sent skipanir",
	"restrictions_screen.permission.send_messages.allowed": "Þú getur sent spjallskilaboð",
	"restrictions_screen.permission.send_messages.denied": "Þú getur ekki sent spjallskilaboð",
	"restrictions_screen.title": "Bönn",
	...
	"selectWorld.allowCommands.new": "Leyfa svindl",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Búa til afrit áður en þessi heimur er uppfærður?",
	...
	"selectWorld.backupWarning.file_fixing_required": "Þennan heim þarf að uppfæra áður en þú getur spilað hann. Við mælum sterklega með að búa til afrit áður ef heimurinn skyldi skemmast við uppfærsluna.",
	...
	"selectWorld.incompatible.description": "Ekki er hægt að opna þennan heim í þessari útgáfu.\nSíðast var spilað í útgáfu %s.",
	"selectWorld.incompatible.info": "Ósamhæf útgáfa: %s",
	"selectWorld.incompatible.title": "Ósamhæf útgáfa",
	"selectWorld.incompatible.tooltip": "Ekki er hægt að opna þennan heim vegna þess að hann var gerður í ósamhæfðri útgáfu.",
	...
	"selectWorld.resource_load": "Undirbýr tilföng...",
	...
	"selectWorld.upgrade_and_play": "Uppfæra og Spila",
	...
	"selectWorld.waitingForBackup.title": "Bý til afrit",
	...
	"selectWorld.warning.lowDiskSpace.description": "Það er ekki mikið pláss eftir á tækinu þínu.\nAð verða uppiskroppa með diskapláss í miðjum leik getur orsakað það að heimurinn þinn skemmist.",
	"selectWorld.warning.lowDiskSpace.title": "Viðvörun! Lítið diskpláss!",
	"selectWorld.world": "Heimur",
	"selectWorld.world_gen_settings_access": "Unable to read or access the world gen settings file! %s",
	"selecteWorld.backupRequiredTooltip": "Til að geta hlaðið heiminum þarf að taka afrit fyrst",
	...
	"slot.only_single_allowed": "Einungis stök hólf leyfileg, hefur '%s'",
	"slot.unknown": "Óþekkt hólf '%s'",
	"snbt.parser.empty_key": "Lykill má ekki vera tómur",
	"snbt.parser.expected_binary_numeral": "Bjóst við tvíundatölu",
	"snbt.parser.expected_decimal_numeral": "Bjóst við tugflokkunartölu",
	"snbt.parser.expected_float_type": "Bjóst við hlaupakommutölu",
	"snbt.parser.expected_hex_escape": "Bjóst við lesgildi bókstafs á lengdinni %s",
	"snbt.parser.expected_hex_numeral": "Bjóst við sextándakerfistölu",
	"snbt.parser.expected_integer_type": "Bjóst við heiltölu",
	"snbt.parser.expected_non_negative_number": "Bjóst við jákvæðri tölu",
	"snbt.parser.expected_number_or_boolean": "Bjóst við tölu eða já/nei gildi",
	"snbt.parser.expected_string_uuid": "Bjóst við stafarunu sem er gilt UUID auðkenni",
	"snbt.parser.expected_unquoted_string": "Bjóst við gildum streng án gæsalappa",
	"snbt.parser.infinity_not_allowed": "Tölur með óendanlega aukastafi eru ekki leyfðar",
	"snbt.parser.invalid_array_element_type": "Ógild gerð fylkisstaks",
	"snbt.parser.invalid_character_name": "Ógilt Unicode-stafaheiti",
	"snbt.parser.invalid_codepoint": "Ógilt Unicode stafagildi: %s",
	...
	"snbt.parser.no_such_operation": "Þessi aðgerð er ekki til: %s",
	...
	"stat.minecraft.happy_ghast_one_cm": "Vegalengd flogin á gaðvomu",
	...
	"stat.minecraft.pig_one_cm": "Vegalengd á svínbaki",
	"stat.minecraft.play_noteblock": "Nótnakubbar spilaðir",
	"stat.minecraft.play_record": "Hljómplötur spilaðar",
	...
	"subtitles.block.beacon.activate": "Leiðarljós virkjast",
	"subtitles.block.beacon.ambient": "Leiðarljós suðar",
	"subtitles.block.beacon.deactivate": "Leiðarljós óvirkjast",
	...
	"subtitles.block.candle.extinguish": "Kerti slokknar",
	...
	"subtitles.block.copper_bulb.turn_off": "Koparpera slokknar",
	"subtitles.block.copper_bulb.turn_on": "Koparpera kviknar",
	"subtitles.block.copper_chest.close": "Kista lokast",
	"subtitles.block.copper_chest.open": "Kista opnast",
	"subtitles.block.copper_trapdoor.close": "Hleri lokast",
	"subtitles.block.copper_trapdoor.open": "Hleri opnast",
	"subtitles.block.crafter.craft": "Smiðja smíðar",
	"subtitles.block.crafter.fail": "Smiðja mistekst að smíða",
	"subtitles.block.creaking_heart.hurt": "Brakandahjarta æpir",
	"subtitles.block.creaking_heart.idle": "Óhugnaðarhljóð",
	"subtitles.block.creaking_heart.spawn": "Brakandahjarta vaknar",
	"subtitles.block.deadbush.idle": "Hljóð þurrks",
	"subtitles.block.decorated_pot.insert": "Skreyttur pottur fylltur",
	"subtitles.block.decorated_pot.insert_fail": "Skreyttur pottur vaggar",
	...
	"subtitles.block.dried_ghast.ambient": "Þurr hljóð",
	"subtitles.block.dried_ghast.ambient_water": "Þurrkaður vomur endurvökvast",
	"subtitles.block.dried_ghast.place_in_water": "Þurrkaður vomur blotnar",
	"subtitles.block.dried_ghast.transition": "Þurrkuðum vomi líður betur",
	"subtitles.block.dry_grass.ambient": "Vindgnauð",
	...
	"subtitles.block.eyeblossom.close": "Augnablóm lokast",
	"subtitles.block.eyeblossom.idle": "Augnablóm hvíslar",
	"subtitles.block.eyeblossom.open": "Augnablóm opnast",
	...
	"subtitles.block.firefly_bush.idle": "Blysbjöllur suða",
	...
	"subtitles.block.generic.fall": "Eitthvað dettur á blokk",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Skilti kjagar",
	...
	"subtitles.block.pale_hanging_moss.idle": "Óhugnaðarhljóð",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Brennisteinshver gýs",
	"subtitles.block.potent_sulfur.noxious_gas": "Eitrað gas birtist",
	...
	"subtitles.block.sand.idle": "Sandhljóð",
	"subtitles.block.sand.wind": "Vindgnauð",
	...
	"subtitles.block.shelf.activate": "Hilla virkjast",
	"subtitles.block.shelf.deactivate": "Hilla óvirkjast",
	"subtitles.block.shelf.multi_swap": "Hlutum skipt",
	"subtitles.block.shelf.place_item": "Huttur settur",
	"subtitles.block.shelf.single_swap": "Hluti skiptist",
	"subtitles.block.shelf.take_item": "Hlutur tekinn",
	...
	"subtitles.block.sponge.absorb": "Svampur sogar",
	"subtitles.block.sweet_berry_bush.pick_berries": "Ber smella",
	"subtitles.block.trapdoor.close": "Hleri lokast",
	"subtitles.block.trapdoor.open": "Hleri opnast",
	"subtitles.block.trapdoor.toggle": "Hleri ískrar",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Váboðahlutur undirbýr",
	"subtitles.block.trial_spawner.ambient": "Tilraunaframkallari snarkar",
	"subtitles.block.trial_spawner.ambient_charged": "Váboða snark",
	"subtitles.block.trial_spawner.ambient_ominous": "Váboða snark",
	"subtitles.block.trial_spawner.charge_activate": "Fyrirboði gleypir þrautaframkallara",
	"subtitles.block.trial_spawner.close_shutter": "Þrautaframkallari lokast",
	"subtitles.block.trial_spawner.detect_player": "Þrautaframkallari spennist",
	"subtitles.block.trial_spawner.eject_item": "Þrautaframkallari kastar hlutum út",
	"subtitles.block.trial_spawner.ominous_activate": "Fyrirboði gleypir þrautaframkallara",
	"subtitles.block.trial_spawner.open_shutter": "Þrautaframkallari opnast",
	"subtitles.block.trial_spawner.spawn_item": "Váboðahlutur dettur",
	"subtitles.block.trial_spawner.spawn_item_begin": "Váboðahlutur birtist",
	"subtitles.block.trial_spawner.spawn_mob": "Skrímsli framkallaðist",
	...
	"subtitles.block.vault.activate": "Hvelfing opnast",
	"subtitles.block.vault.ambient": "Hvelfing snarkar",
	"subtitles.block.vault.close_shutter": "Hvelfing lokast",
	"subtitles.block.vault.deactivate": "Hvelfing lokast",
	"subtitles.block.vault.eject_item": "Hvelfing kastar úr sér hlut",
	"subtitles.block.vault.insert_item": "Hvelfing opnast",
	"subtitles.block.vault.insert_item_fail": "Hvelfing hafnar hlut",
	"subtitles.block.vault.open_shutter": "Hvelfing opnast",
	"subtitles.block.vault.reject_rewarded_player": "Hvelfing hafnar spilara",
	"subtitles.block.water.ambient": "Vatn flæðir",
	"subtitles.block.wet_sponge.dries": "Svampur þornar",
	...
	"subtitles.entity.allay.hurt": "Hjálpari særist",
	...
	"subtitles.entity.armadillo.ambient": "Beltisdýr rymur",
	"subtitles.entity.armadillo.brush": "Hreistur burstað burt",
	"subtitles.entity.armadillo.death": "Beltisdýr deyr",
	"subtitles.entity.armadillo.eat": "Beltisdýr borðar",
	"subtitles.entity.armadillo.hurt": "Beltisdýr særist",
	"subtitles.entity.armadillo.hurt_reduced": "Beltisdýr ver sig",
	"subtitles.entity.armadillo.land": "Beltisdýr lendir",
	"subtitles.entity.armadillo.peek": "Beltisdýr kíkir",
	"subtitles.entity.armadillo.roll": "Beltisdýr rúllar sér upp",
	"subtitles.entity.armadillo.scute_drop": "Beltisdýr fellir hreistur",
	"subtitles.entity.armadillo.unroll_finish": "Beltisdýr opnar sig",
	"subtitles.entity.armadillo.unroll_start": "Beltisdýr kíkir",
	...
	"subtitles.entity.baby_cat.ambient": "Kettlingur mjálmar",
	"subtitles.entity.baby_cat.beg_for_food": "Kettlingur betlar",
	"subtitles.entity.baby_cat.death": "Kettlingur deyr",
	"subtitles.entity.baby_cat.eat": "Kettlingur borðar",
	"subtitles.entity.baby_cat.hiss": "Kettlingur kvæsir",
	"subtitles.entity.baby_cat.hurt": "Kettlingur meiðist",
	"subtitles.entity.baby_cat.purr": "Kettlingur malar",
	"subtitles.entity.baby_chicken.ambient": "Ungi tístir",
	"subtitles.entity.baby_chicken.death": "Ungi deyr",
	"subtitles.entity.baby_chicken.hurts": "Ungi meiðist",
	"subtitles.entity.baby_horse.ambient": "Folald hneggjar",
	...
	"subtitles.entity.baby_horse.land": "Folald lendir",
	"subtitles.entity.baby_nautilus.ambient": "Perlusnekkjuungi tístir",
	"subtitles.entity.baby_nautilus.ambient_land": "Perlusnekkjusungi tístir",
	"subtitles.entity.baby_nautilus.death": "Perlusnekkjuungi deyr",
	"subtitles.entity.baby_nautilus.death_land": "Perlusnekkjuungi deyr",
	"subtitles.entity.baby_nautilus.eat": "Perlusnekkjuungi borðar",
	"subtitles.entity.baby_nautilus.hurt": "Perlusnekkjuungi meiðist",
	"subtitles.entity.baby_nautilus.hurt_land": "Perlusnekkjuungi meiðist",
	"subtitles.entity.baby_nautilus.swim": "Perlusnekkjuungi syndir",
	"subtitles.entity.baby_pig.ambient": "Gríslingur hrínir",
	"subtitles.entity.baby_pig.death": "Gríslíngur deyr",
	"subtitles.entity.baby_pig.eat": "Grís étur",
	"subtitles.entity.baby_pig.hurt": "Gríslingur meiðist",
	"subtitles.entity.baby_wolf.ambient": "Hvolpur geltir",
	"subtitles.entity.baby_wolf.death": "Hvolpur deyr",
	"subtitles.entity.baby_wolf.growl": "Hvolpur urrar",
	"subtitles.entity.baby_wolf.hurt": "Hvolpur meiðist",
	"subtitles.entity.baby_wolf.pant": "Puppy pants",
	"subtitles.entity.baby_wolf.whine": "Hvolpur vælir",
	...
	"subtitles.entity.bogged.ambient": "Votungur skröltir",
	"subtitles.entity.bogged.death": "Votungur deyr",
	"subtitles.entity.bogged.hurt": "Votungur særist",
	"subtitles.entity.breeze.charge": "Gola hleður",
	"subtitles.entity.breeze.death": "Gola deyr",
	"subtitles.entity.breeze.deflect": "Gola víkur frá",
	"subtitles.entity.breeze.hurt": "Gola særist",
	"subtitles.entity.breeze.idle_air": "Gola flýgur",
	"subtitles.entity.breeze.idle_ground": "Gola suðar",
	"subtitles.entity.breeze.inhale": "Gola andar að sér",
	"subtitles.entity.breeze.jump": "Gola hoppar",
	"subtitles.entity.breeze.land": "Gola lendir",
	"subtitles.entity.breeze.shoot": "Gola skýtur",
	"subtitles.entity.breeze.slide": "Gola rennur",
	"subtitles.entity.breeze.whirl": "Gola hvirflar",
	"subtitles.entity.breeze.wind_burst": "Vindhnöttur springur",
	...
	"subtitles.entity.cat.hurt": "Köttur særist",
	...
	"subtitles.entity.copper_golem.death": "Koparþjarki deyr",
	"subtitles.entity.copper_golem.hurt": "Koparþjarki særist",
	"subtitles.entity.copper_golem.item_drop": "Koparþjarki setur hlut",
	"subtitles.entity.copper_golem.item_no_drop": "Koparþjarki getur ekki sett hlut",
	"subtitles.entity.copper_golem.no_item_get": "Koparþjarki tekur upp hlut",
	"subtitles.entity.copper_golem.no_item_no_get": "Koparþjarki getur ekki tekið upp hlut",
	"subtitles.entity.copper_golem.spawn": "Koparþjarki byrtist",
	"subtitles.entity.copper_golem.spin": "Koparþjarki snýr hausnum",
	"subtitles.entity.copper_golem_become_statue": "Koparþjarki harnar",
	"subtitles.entity.copper_golem_oxidized.death": "Koparþjarki deyr",
	"subtitles.entity.copper_golem_oxidized.hurt": "Koparþjarki særist",
	"subtitles.entity.copper_golem_oxidized.spin": "Koparþjarki snýr hausnum",
	"subtitles.entity.copper_golem_weathered.death": "Koparþjarki deyr",
	"subtitles.entity.copper_golem_weathered.hurt": "Koparþjarki særist",
	"subtitles.entity.copper_golem_weathered.spin": "Koparþjarki snýr hausnum",
	...
	"subtitles.entity.creaking.activate": "Marrari verður óvirkur",
	"subtitles.entity.creaking.ambient": "Brakandi brakar",
	"subtitles.entity.creaking.attack": "Brakandi gerir árás",
	"subtitles.entity.creaking.deactivate": "Brakandi verður óvirkur",
	"subtitles.entity.creaking.death": "Brakandi deyr",
	"subtitles.entity.creaking.freeze": "Brakandi stansar",
	"subtitles.entity.creaking.spawn": "Brakandi lifir",
	"subtitles.entity.creaking.sway": "Brakandi er varinn",
	"subtitles.entity.creaking.twitch": "Brakandi kippist til",
	"subtitles.entity.creaking.unfreeze": "Brakandi hreyfir sig",
	"subtitles.entity.creeper.death": "Laumupúki deyr",
	"subtitles.entity.creeper.hurt": "Laumupúki særist",
	...
	"subtitles.entity.donkey.jump": "Asni hoppar",
	"subtitles.entity.drowned.ambient": "Sjódraugur gutlar",
	"subtitles.entity.drowned.ambient_water": "Sjódraugur gutlar",
	"subtitles.entity.drowned.death": "Sjódraugur deyr",
	"subtitles.entity.drowned.hurt": "Sjódraugur særist",
	"subtitles.entity.drowned.shoot": "Sjódraugur kastar þríforki",
	"subtitles.entity.drowned.step": "Sjódraugur stígur",
	"subtitles.entity.drowned.swim": "Sjódraugur syndir",
	...
	"subtitles.entity.elder_guardian.hurt": "Öldungavörður særist",
	...
	"subtitles.entity.ender_pearl.throw": "Endaperla flýgur",
	"subtitles.entity.enderman.ambient": "Endamaður vúppar",
	"subtitles.entity.enderman.death": "Endamaður deyr",
	"subtitles.entity.enderman.hurt": "Endamaður særist",
	...
	"subtitles.entity.fish.swim": "Skvettur",
	...
	"subtitles.entity.frog.hurt": "Froskur særist",
	...
	"subtitles.entity.generic.hurt": "Eitthvað særist",
	...
	"subtitles.entity.generic.wind_burst": "Vindhnöttur springur",
	...
	"subtitles.entity.ghastling.ambient": "Vomlingur kurrar",
	"subtitles.entity.ghastling.death": "Vomlingur deyr",
	"subtitles.entity.ghastling.hurt": "Vomlingur særist",
	"subtitles.entity.ghastling.spawn": "Vomlingur birtist",
	...
	"subtitles.entity.guardian.hurt": "Vörður særist",
	"subtitles.entity.happy_ghast.ambient": "Glaðvomur sönglar",
	"subtitles.entity.happy_ghast.death": "Glaðvomur deyr",
	"subtitles.entity.happy_ghast.equip": "Vomasöðull settur á",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Glaðvomur er tilbúinn",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Glaðvomur stöðvast",
	"subtitles.entity.happy_ghast.hurt": "Glaður vomur særist",
	"subtitles.entity.happy_ghast.unequip": "Vomasöðull tekinn af",
	...
	"subtitles.entity.husk.ambient": "Nár stynur",
	"subtitles.entity.husk.converted_to_zombie": "Nár breytist í uppvakning",
	"subtitles.entity.husk.death": "Nár deyr",
	"subtitles.entity.husk.hurt": "Nár særist",
	...
	"subtitles.entity.illusioner.hurt": "Blekkjari særist",
	...
	"subtitles.entity.magma_cube.squish": "Kvikuslím skvampast",
	"subtitles.entity.minecart.inside": "Námuvagn glamrar",
	"subtitles.entity.minecart.inside_underwater": "Námuvagn glamrar í kafi",
	...
	"subtitles.entity.mooshroom.milk": "Baulsveppur er mjólkaður",
	"subtitles.entity.mooshroom.suspicious_milk": "Baulsveppur er mjólkaður grunsamlega",
	...
	"subtitles.entity.mule.jump": "Múlasni hoppar",
	"subtitles.entity.nautilus.ambient": "Nautilus clacks",
	"subtitles.entity.nautilus.ambient_land": "Perlusnekkja glamrar",
	"subtitles.entity.nautilus.dash": "Nautilus jets",
	"subtitles.entity.nautilus.dash_land": "Perlusnekkja þýtur",
	"subtitles.entity.nautilus.dash_ready": "Nautilus recovers",
	"subtitles.entity.nautilus.dash_ready_land": "Perlusnekkja batnar",
	"subtitles.entity.nautilus.death": "Perlusnekkja deyr",
	"subtitles.entity.nautilus.death_land": "Perlusnekkja deyr",
	"subtitles.entity.nautilus.eat": "Perlusnekkja borðar",
	"subtitles.entity.nautilus.hurt": "Perlusnekkja meiðist",
	"subtitles.entity.nautilus.hurt_land": "Perlusnekkja meiðist",
	"subtitles.entity.nautilus.swim": "Perlusnekkja syndir",
	...
	"subtitles.entity.panda.hurt": "Panda særist",
	...
	"subtitles.entity.parrot.imitate.bogged": "Páfagaukur skröltir",
	"subtitles.entity.parrot.imitate.breeze": "Páfagaukur suðar",
	"subtitles.entity.parrot.imitate.camel_husk": "Parrot grumphs",
	"subtitles.entity.parrot.imitate.creaking": "Páfagaukur hermir brak",
	"subtitles.entity.parrot.imitate.creeper": "Páfagaukur hvæsir",
	"subtitles.entity.parrot.imitate.drowned": "Páfagaukur gutlar",
	...
	"subtitles.entity.parrot.imitate.magma_cube": "Páfagaukur hermir eftir kvikuslími",
	...
	"subtitles.entity.parrot.imitate.zombie": "Páfagaukur stynur",
	...
	"subtitles.entity.pig.eat": "Svín étur",
	...
	"subtitles.entity.piglin_brute.hurt": "Svínahrotti særist",
	...
	"subtitles.entity.pillager.hurt": "Ruplari særist",
	...
	"subtitles.entity.player.teleport": "Spilari fjarflytur sig",
	...
	"subtitles.entity.ravager.hurt": "Rústari særist",
	...
	"subtitles.entity.skeleton.converted_to_stray": "Beinagrind breytist í Útburð",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Beinagrindarhross stekkur",
	...
	"subtitles.entity.snow_golem.death": "Sjókarl deyr",
	"subtitles.entity.snow_golem.hurt": "Sjókarl meiðist",
	...
	"subtitles.entity.stray.ambient": "Útburður skröltir",
	"subtitles.entity.stray.death": "Útburður deyr",
	"subtitles.entity.stray.hurt": "Útburður særist",
	...
	"subtitles.entity.sulfur_cube.absorb": "Brennisteinskubbur fullhlaðinn",
	"subtitles.entity.sulfur_cube.bounce": "Brennisteinskubbur hoppar",
	"subtitles.entity.sulfur_cube.death": "Brennisteinskubbur deyr",
	"subtitles.entity.sulfur_cube.eject": "Kubbur fjarlægður",
	"subtitles.entity.sulfur_cube.hit": "Brennisteinskubbur skotinn",
	"subtitles.entity.sulfur_cube.hurt": "Brennisteinskubbur meiðist",
	"subtitles.entity.sulfur_cube.push": "Brennisteinskubbi ýtt",
	"subtitles.entity.sulfur_cube.squish": "Brennisteinskubbur hoppar",
	...
	"subtitles.entity.wind_charge.throw": "Vindhnöttur flýgur",
	"subtitles.entity.wind_charge.wind_burst": "Vindhnöttur springur",
	...
	"subtitles.entity.wither_skeleton.ambient": "Viðrinisbeinagrind skröltir",
	"subtitles.entity.wither_skeleton.death": "Viðrinisbeinagrind deyr",
	"subtitles.entity.wither_skeleton.hurt": "Viðrinisbeinagrind meiðist",
	"subtitles.entity.wolf.ambient": "Úlfur másar",
	"subtitles.entity.wolf.bark": "Úlfur geltir",
	"subtitles.entity.wolf.death": "Úlfur deyr",
	"subtitles.entity.wolf.growl": "Úlfur urrar",
	"subtitles.entity.wolf.hurt": "Úlfur særist",
	"subtitles.entity.wolf.pant": "Úlfur másar",
	"subtitles.entity.wolf.shake": "Úlfur hristir sig",
	"subtitles.entity.wolf.whine": "Úlfur vælir",
	...
	"subtitles.entity.zombie.converted_to_drowned": "Uppvakningi breytt í sjódraug",
	...
	"subtitles.entity.zombie_horse.eat": "Uppvakningshross étur",
	"subtitles.entity.zombie_horse.hurt": "Nádrasill særist",
	"subtitles.entity.zombie_nautilus.ambient": "Zombie Nautilus burbles",
	"subtitles.entity.zombie_nautilus.ambient_land": "Perluskelsuppvakningur gutlar",
	"subtitles.entity.zombie_nautilus.dash": "Zombie Nautilus jets",
	"subtitles.entity.zombie_nautilus.dash_land": "Perlusnekkjuuppvakningur þýtur",
	"subtitles.entity.zombie_nautilus.dash_ready": "Zombie Nautilus recovers",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Perlusnekkkjuuppvakningi batnar",
	"subtitles.entity.zombie_nautilus.death": "Zombie Nautilus dies",
	"subtitles.entity.zombie_nautilus.death_land": "Perlusnekkjuuppvakningur deyr",
	"subtitles.entity.zombie_nautilus.eat": "Zombie Nautilus eats",
	"subtitles.entity.zombie_nautilus.hurt": "Zombie Nautilus hurts",
	"subtitles.entity.zombie_nautilus.hurt_land": "Perlusnekkjuuppvakningur meiðist",
	...
	"subtitles.event.mob_effect.bad_omen": "Fyrirboði tekur völdum",
	"subtitles.event.mob_effect.raid_omen": "Árás er í vændum",
	"subtitles.event.mob_effect.trial_omen": "Yfirvofandi váboðaþraut nálægt",
	...
	"subtitles.item.armor.equip_copper": "Koparbrynklæði glymja",
	...
	"subtitles.item.armor.equip_wolf": "Úlfabrynja hefur verið fest",
	"subtitles.item.armor.unequip_nautilus": "Nautilus Armor unequips",
	"subtitles.item.armor.unequip_wolf": "Úlfabrynja klippt í burtu",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Brennisteinskubbur háfaður",
	...
	"subtitles.item.bundle.insert_fail": "Knippi fullt",
	...
	"subtitles.item.elytra.flying": "Þekjuvængir þjóta",
	...
	"subtitles.item.hoe.till": "Plogur yrkir",
	"subtitles.item.honey_bottle.drink": "Þambar",
	"subtitles.item.honeycomb.wax_on": "Vax á",
	"subtitles.item.horse_armor.unequip": "Hestabrynja klippt í burtu",
	"subtitles.item.ink_sac.use": "Blekpoki skvettir",
	"subtitles.item.lead.break": "Taumur slitnar",
	"subtitles.item.lead.tied": "Taumur bundinn",
	"subtitles.item.lead.untied": "Taumur losaður",
	"subtitles.item.llama_carpet.unequip": "Teppi klippt í burtu",
	"subtitles.item.lodestone_compass.lock": "Vörðuáttaviti tengist vörðu",
	"subtitles.item.mace.smash_air": "Sleggja mölvar",
	"subtitles.item.mace.smash_ground": "Sleggja mölvar",
	"subtitles.item.nautilus_saddle_equip": "Hnakkur festur",
	"subtitles.item.nautilus_saddle_underwater_equip": "Hnakkur festur",
	"subtitles.item.nether_wart.plant": "Fóðurjurt gróðursett",
	"subtitles.item.ominous_bottle.dispose": "Flaska brotnar",
	"subtitles.item.saddle.unequip": "Hnakkur klipptur í burtu",
	"subtitles.item.shears.shear": "Skæri smella",
	"subtitles.item.shears.snip": "Skæri klippa",
	"subtitles.item.shield.block": "Skjöldur ver",
	"subtitles.item.shovel.flatten": "Skófla sléttar",
	"subtitles.item.spear.attack": "Spjóti beitt",
	"subtitles.item.spear.hit": "Spjót stingur",
	"subtitles.item.spear.lunge": "Lagt til með spjóti",
	"subtitles.item.spear.use": "Áhlaup með spjóti",
	"subtitles.item.spear_wood.attack": "Spjóti beitt",
	"subtitles.item.spear_wood.hit": "Spjót stingur",
	"subtitles.item.spear_wood.use": "Áhlaup með spjóti",
	...
	"subtitles.item.underwater_saddle.equip": "Hnakkur festur",
	"subtitles.item.wolf_armor.break": "Úlfabrynja brotnar",
	"subtitles.item.wolf_armor.crack": "Úlfabrynja fær sprungu",
	"subtitles.item.wolf_armor.damage": "Úlfabrynja tekur skaða",
	"subtitles.item.wolf_armor.repair": "Úlfabrynja hefur verið viðgerð",
	"subtitles.particle.soul_escape": "Sál flýr",
	"subtitles.ui.cartography_table.take_result": "Kort teiknað",
	"subtitles.ui.hud.bubble_pop": "Öndunarmælir lækkar",
	...
	"symlink_warning.message": "Það getur verið óöruggt að hlaða heimi úr möppu með sýndartenglum ef þú veist ekki nákvæmlega hvað þú ert að gera. Nánari upplýsingar um þetta á %s.",
	"symlink_warning.message.pack": "Það getur verið óöruggt að hlaða pökkum með sýndartenglum ef þú veist ekki nákvæmlega hvað þú ert að gera. Nánari upplýsingar um þetta á %s.",
	"symlink_warning.message.world": "Það getur verið óöruggt að hlaða heimum úr möppum með sýndartenglum ef þú veist ekki nákvæmlega hvað þú ert að gera. Nánari upplýsingar um þetta á %s.",
	"symlink_warning.more_info": "Nánari upplýsingar",
	"symlink_warning.title": "Mappa heimsins inniheldur sýndartengla",
	"symlink_warning.title.pack": "Það eru sýndartenglar í viðbættum pakka/pökkum",
	"symlink_warning.title.world": "Mappa heimsins inniheldur sýndartengla",
	...
	"telemetry.event.graphics_capabilities.description": "Þetta atvik segir til um getu grafíska búnaðarins sem leikurinn notar.",
	"telemetry.event.graphics_capabilities.title": "Grafísk geta",
	"telemetry.event.optional": "%s (val)",
	"telemetry.event.optional.disabled": "%s (Valfrjálst) - Óvirkt",
	...
	"telemetry.property.backend_failure_message.title": "Boð um að gerð bakenda mistókst",
	"telemetry.property.backend_failure_missing_capabilities.title": "Gerð bakenda místókst vegna ónógrar getu",
	"telemetry.property.backend_failure_reason.title": "Ástæða þess að gerð bakenda místókst",
	"telemetry.property.backend_name.title": "Heiti bakenda",
	...
	"telemetry_info.button.privacy_statement": "Yfirlýsing um persónuvernd",
	"telemetry_info.button.show_data": "Opna gögn mín",
	"telemetry_info.opt_in.description": "Ég samþykki að senda valfrjáls fjarmælingargögn",
	"telemetry_info.property_title": "Innifalin gögn",
	"telemetry_info.screen.description": "Með því að safna þessum gögnum getum við bætt Minecraft og leiðbeint okkur í þá átt sem skiptir máli fyrir leikmenn okkar. Þú getur einnig sent inn aukalega endurgjöf til að styðja okkur í að bæta Minecraft enn frekar.",
	...
	"test.error.expected_block_present": "Gerði ráð fyrir að kubbur %s væri til staðar",
	...
	"test.error.expected_entity": "Bjóst við %s",
	...
	"test.error.not_a_block_item": "Uppgefin kubbur telst ekki vera kubbur",
	...
	"test.error.sequence.minimum_tick": "Tókst áður en kom að áætluðu tifi: bjóst við að bíða %s",
	...
	"test.error.unknown": "Óþekkt villa innan við: %s",
	...
	"test_block.error.missing": "Tilraunabyggingu vantar %s kubb",
	"test_block.error.too_many": "Of margir %s kubbar",
	"test_block.invalid_timeout": "Invalid timeout (%s) - must be a positive number of ticks",
	"test_block.message": "Skilaboð:",
	"test_block.mode.accept": "Samþykkja",
	"test_block.mode.fail": "Fella",
	"test_block.mode.log": "Atvikaskrá",
	...
	"test_instance.action.reset": "Endurstilla og Hlaða",
	"test_instance.action.run": "Hlaða og Keyra",
	"test_instance.action.save": "Vista Byggingu",
	"test_instance.description.batch": "Environment: %s",
	"test_instance.description.failed": "Misheppnaðist: %s",
	"test_instance.description.function": "Function: %s",
	"test_instance.description.invalid_id": "Ógilt próf ID",
	"test_instance.description.no_test": "Engin slík próf",
	"test_instance.description.structure": "Bygging: %s",
	"test_instance.description.type": "Týpa: %s",
	"test_instance.type.block_based": "Block-Based Test",
	"test_instance.type.function": "Built-in Function Test",
	"test_instance_block.entities": "Einindi:",
	...
	"test_instance_block.invalid": "[ógilt]",
	"test_instance_block.reset_success": "Reset succeeded for test: %s",
	"test_instance_block.rotation": "Snúningur:",
	...
	"title.credits": "Höfundarréttur Mojang AB. Dreifing er óheimil!",
	"title.multiplayer.disabled": "Netspil er óvirkt. Vinsamlegast skoðaðu stillingarnar á Microsoft reikninginum þinum.",
	"title.multiplayer.disabled.banned.name": "Þú verður að breyta nafni þínu áður en þú getur spilað á netinu",
	...
	"trim_material.minecraft.resin": "Kvoðuefni",
	"trim_pattern.minecraft.bolt": "Eldingarbrynjuútlit",
	...
	"trim_pattern.minecraft.flow": "Flæðibrynjuútlit",
	...
	"tutorial.open_inventory.description": "Ýttu á %s",
	...
	"upgradeWorld.aborted.message": "Þetta getur gerst ef annað forrit opnar heiminn í miðri uppfærslu. Það gæti hjálpað að endurræsa tölvuna og reyna aftur. Ef vandamálið heldur áfram, skaltu íhuga að tilkynna forritsvillu.",
	"upgradeWorld.aborted.reportBug": "Tilkynna forritsvillu",
	"upgradeWorld.aborted.title": "Tókst ekki að uppfæra heiminn",
	"upgradeWorld.canceled.message": "Heimurinn þinn hefur ekkert breyst.",
	"upgradeWorld.canceled.title": "Hætt við uppfærslu heims",
	"upgradeWorld.done": "Uppfærslu heims lokið",
	"upgradeWorld.failed_cleanup.message": "Heimurinn var uppfærður í nýjustu útgáfu og er nú aðgengilegur í listanum yfir heima.\nVið lentum í vandamálum við að fjarlægja úrelt gögn og þess vegna hefur heiti möppunnar fyrir heiminn verið breytt í %s.",
	"upgradeWorld.failed_cleanup.title": "Það tókst að uppfæra heiminn",
	"upgradeWorld.info.converted": "Uppfærði: %s",
	"upgradeWorld.info.file_fix_stage": "Stig: %s/%s",
	"upgradeWorld.info.scanning": "Fer í gegnum skrár...",
	"upgradeWorld.info.total": "Samtals: %s",
	"upgradeWorld.joinNow": "Viltu spila þennan heim núna strax?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Flyt skrár",
	"upgradeWorld.progress.type.legacy_structures": "Uppfæri forn mannvirki",
	"upgradeWorld.progress.type.region": "Uppfæri svæði",
	...
	"upgradeWorld.symlink.title": "Ekki hægt að uppfæra þennan heim",
	"upgradeWorld.title": "Uppfæri veraldargögn",
}
