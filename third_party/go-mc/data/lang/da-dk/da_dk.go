// Code generated by tools/gen_lang.go from 26.1/da_dk.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Tilgængelighedsindstillinger...",
	"accessibility.onboarding.accessibility.button.narration": "Tilgængelighedsindstillinger",
	"accessibility.onboarding.screen.narrator": "Tryk enter for at aktivere oplæseren",
	...
	"advMode.notEnabled": "Kommandoblokke er ikke aktiveret",
	"advMode.notEnabled.spawner": "Spawnerblokke er ikke aktiveret",
	"advMode.previousOutput": "tidligere udtryk",
	"advMode.setCommand": "Sæt konsolkommando for blok",
	"advMode.setCommand.disabled": "Kommando indstillet: %s, men kommandoblokke er stadig deaktiveret",
	...
	"advancements.adventure.blowback.description": "Dræb et vindvæsen ved at afbøje dets vindladede skud",
	"advancements.adventure.blowback.title": "Modvind",
	"advancements.adventure.brush_armadillo.description": "Få bæltedyrsskæl fra et bæltedyr ved brug af en børste",
	"advancements.adventure.brush_armadillo.title": "Er det en skald?",
	"advancements.adventure.bullseye.description": "Ram pletskuddet på en målblok fra mindst 30 meter væk",
	"advancements.adventure.bullseye.title": "Pletskud",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Lav en dekoreret potte ud af 4 potteskår",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Forsigtig restaurering",
	"advancements.adventure.crafters_crafting_crafters.description": "Vær i nærheden af \u200b\u200ben fabrikant, når den fabrikerer en fabrikant",
	"advancements.adventure.crafters_crafting_crafters.title": "Fabrikanter fabrikerer fabrikanter",
	"advancements.adventure.fall_from_world_height.description": "Overlev et frit fald fra toppen af verden (bygningsgrænse) til bunden af verden",
	"advancements.adventure.fall_from_world_height.title": "Grotter & Klipper",
	"advancements.adventure.heart_transplanter.description": "Placer et knirkende hjerte med den rette opstilling mellem to blege egestamme-blokke",
	"advancements.adventure.heart_transplanter.title": "Hjertet på det rette sted",
	"advancements.adventure.hero_of_the_village.description": "Forsvar succesfuldt en landsby mod en plyndring",
	...
	"advancements.adventure.lighten_up.description": "Skrab en kobberpære med en økse for at gøre den lysere",
	"advancements.adventure.lighten_up.title": "Lys op",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Træd ind i et prøvelseskammer",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Prøve(lses)udgave",
	"advancements.adventure.ol_betsy.description": "Affyr en armbrøst",
	"advancements.adventure.ol_betsy.title": "Gamle Betsy",
	"advancements.adventure.overoverkill.description": "Giv 50 hjerter i skade med ét slag ved brug af hammeren",
	"advancements.adventure.overoverkill.title": "Over-overdrevent",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Aflæs strømsignalet fra en mejslet bogreol ved hjælp af en komparator",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Bøgernes kraft",
	"advancements.adventure.revaulting.description": "Lås op for en ildevarslende boks med en ildevarslende prøvelsesnøgle",
	"advancements.adventure.revaulting.title": "Træsværd? Nej, noget bedre",
	"advancements.adventure.root.description": "Eventyr, udforskning og kamp",
	"advancements.adventure.root.title": "Eventyr",
	"advancements.adventure.salvage_sherd.description": "Børst en mistænkelig blok for at skaffe et potteskår",
	"advancements.adventure.salvage_sherd.title": "Respekt for resterne",
	...
	"advancements.adventure.sniper_duel.description": "Dræb et skelet fra mindst 50 meter væk",
	"advancements.adventure.sniper_duel.title": "Snigskytteduel",
	"advancements.adventure.spear_many_mobs.description": "Ram fem væsener i det samme stormangreb ved brug af spyddet",
	"advancements.adventure.spear_many_mobs.title": "Alle på et spyd",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Anvend disse smedeskabeloner mindst én gang: Spir, snude, ribben, ward, stilhed, vex, tidevands, vejfinder",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Smedning med stil",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Fremstil en trimmet rustning ved et smedebord",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Et nyt udseende",
	...
	"advancements.adventure.under_lock_and_key.description": "Lås en boks op med en prøvelsesnøgle",
	"advancements.adventure.under_lock_and_key.title": "Bag lås og slå",
	"advancements.adventure.use_lodestone.description": "Brug et kompas på en ledesten",
	"advancements.adventure.use_lodestone.title": "Ledesten, led mig hjem",
	...
	"advancements.adventure.who_needs_rockets.description": "Brug en vindladning til at kaste dig selv 8 blokke op",
	"advancements.adventure.who_needs_rockets.title": "Hvem har brug for raketter?",
	...
	"advancements.end.enter_end_gateway.title": "Tilflugtssted",
	"advancements.end.find_end_city.description": "Gå bare ind, hvad kunne gå galt?",
	...
	"advancements.end.levitate.title": "Fantastisk udsigt heroppefra",
	...
	"advancements.husbandry.balanced_diet.title": "En balanceret kost",
	...
	"advancements.husbandry.feed_snifflet.description": "Fodr en snifflet",
	"advancements.husbandry.feed_snifflet.title": "Små snus",
	...
	"advancements.husbandry.leash_all_frog_variants.description": "Sæt hver frøvariant i snor",
	"advancements.husbandry.leash_all_frog_variants.title": "Når banden hopper ind i byen",
	"advancements.husbandry.make_a_sign_glow.description": "Få teksten på hvilket som helst slags skilt til at gløde",
	...
	"advancements.husbandry.obtain_sniffer_egg.description": "Skaf et snifferæg",
	"advancements.husbandry.obtain_sniffer_egg.title": "Lugter interessant",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Placer en udtørret ghast-blok i vand",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Hold dig hydreret!",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Plant et hvilket som helst Sniffer frø",
	"advancements.husbandry.plant_any_sniffer_seed.title": "Plantning af fortiden",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Fjern ulverustning fra en ulv ved brug af en saks",
	"advancements.husbandry.remove_wolf_armor.title": "Klip klip!",
	"advancements.husbandry.repair_wolf_armor.description": "Reparer en beskadiget ulverustning ved brug af et bæltedyrs skæl",
	"advancements.husbandry.repair_wolf_armor.title": "Så god som ny",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Brug et bål til at indsamle honning fra en bikube ved hjælp af en glasflaske uden at irritere bierne",
	"advancements.husbandry.safely_harvest_honey.title": "Honning med ingen bi-virkninger",
	"advancements.husbandry.silk_touch_nest.description": "Flyt en bikube eller bistade med 3 bier indeni, ved hjælp af silkeberøring",
	...
	"advancements.husbandry.uh_oh.description": "Få en svovlkube til at absorbere en TNT-blok",
	"advancements.husbandry.uh_oh.title": "Åh åh",
	...
	"advancements.husbandry.whole_pack.description": "Tæm en af hver ulvevariant",
	"advancements.husbandry.whole_pack.title": "Hele flokken",
	...
	"advancements.nether.all_potions.description": "Ha' alle eliksireffekter på samme tid",
	...
	"advancements.nether.find_fortress.description": "Ødelæg dig vej ind i en netherfæstning",
	...
	"advancements.story.cure_zombie_villager.description": "Svæk og derefter helbred en zombielandsbyboer",
	...
	"advancements.story.enter_the_end.description": "Gå ind i endportalen",
	"advancements.story.enter_the_end.title": "Enden?",
	"advancements.story.enter_the_nether.description": "Byg, tænd og gå ind i en netherportal",
	...
	"advancements.story.obtain_armor.description": "Beskyt dig selv med et stykke jernrustning",
	...
	"argument.block.id.invalid": "Ukendt bloktype '%s'",
	"argument.block.property.duplicate": "Egenskaben '%s' kan kun sættes en gang for blokken %s",
	"argument.block.property.invalid": "Blokken %s accepterer ikke '%s' som %s egenskab",
	...
	"argument.block.tag.disallowed": "Mærker er ikke tilladte her; kun rigtige blokke",
	...
	"argument.entity.options.limit.description": "Maksimalt antal objekter, der skal returneres",
	...
	"argument.entity.options.sort.irreversible": "Ugyldig eller ukendt sorteringstype '%s'",
	...
	"argument.entity.options.type.invalid": "Ugyldig eller ukendt objekttype '%s'",
	...
	"argument.entity.selector.nearestEntity": "Nærmeste objekt",
	...
	"argument.float.big": "Float må ikke være mere end %s: fandt %s",
	"argument.float.low": "Float må ikke være mindre end %s: fandt %s",
	"argument.gamemode.invalid": "Ukendt spiltilstand: %s",
	"argument.hexcolor.invalid": "Ugyldig hex-farvekode '%s'",
	...
	"argument.item.tag.disallowed": "Mærker er ikke tilladte her; kun rigtige genstande",
	...
	"argument.message.too_long": "Chatbesked var for lang (%s > maksimum %s tegn)",
	"argument.nbt.array.invalid": "Ugyldig matrix type '%s'",
	"argument.nbt.array.mixed": "Kan ikke indsætte %s ind i %s",
	"argument.nbt.expected.compound": "Forventet sammensat mærke",
	...
	"argument.player.entities": "Kun spillere bliver påvirket af denne kommando, men den angivne vælger inkluderer objekter",
	...
	"argument.pos.mixed": "Kan ikke blande verdens- og lokale koordinater (alt skal enten bruge ^ eller lade vær)",
	...
	"argument.range.swapped": "Minimum kan ikke være højere end maksimum",
	"argument.resource.invalid_type": "Element '%s' har fejltype '%s' (forventede '%s')",
	"argument.resource.not_found": "Kunne ikke finde element '%s' af typen '%s'",
	"argument.resource_or_id.failed_to_parse": "Kunne ikke fortolke struktur: %s",
	"argument.resource_or_id.invalid": "Ugyldigt ID eller tag",
	"argument.resource_or_id.no_such_element": "Kan ikke finde element '%s' i registreret '%s'",
	"argument.resource_selector.not_found": "Intet match for vælgeren '%s' af type '%s",
	"argument.resource_tag.invalid_type": "Mærke '%s' har den forkerte type '%s' (forventede '%s')",
	"argument.resource_tag.not_found": "Kan ikke finde mærke '%s' af typen '%s'",
	"argument.rotation.incomplete": "Ukomplet (forventede 2 koordinater)",
	"argument.scoreHolder.empty": "Ingen relavante scoreholdere kunne blive fundet",
	"argument.scoreboardDisplaySlot.invalid": "Ukendt målvisningsfelt '%s'",
	"argument.style.invalid": "Ugyldig stil: %s",
	"argument.time.invalid_tick_count": "Tik antallet skal være ikke-negativt",
	"argument.time.invalid_unit": "Ugyldig enhed",
	"argument.time.tick_count_too_low": "Tik antallet må ikke være mindre end %s: fandt %s",
	"argument.uuid.invalid": "Ugyldig UUID",
	"argument.waypoint.invalid": "Valgt objekt er ikke et rutepunkt",
	...
	"arguments.item.component.expected": "Forventet genstandskomponent",
	"arguments.item.component.malformed": "Misdannet '%s' komponent: '%s'",
	"arguments.item.component.repeated": "Genstandskomponent '%s' blev gentaget, men kun én værdi kan specificeres",
	"arguments.item.component.unknown": "Ukendt genstandskomponent '%s'",
	"arguments.item.malformed": "Misdannet genstand: '%s'",
	"arguments.item.overstacked": "%s kan kun stables op til %s",
	"arguments.item.predicate.malformed": "Misdannet '%s' prædikat: '%s'",
	"arguments.item.predicate.unknown": "Ukendt genstandsprædikat '%s'",
	...
	"arguments.swizzle.invalid": "Ugyldig aksekombination, forventede kombination af 'x', 'y' og 'z'",
	...
	"attribute.name.air_drag_modifier": "Luftmodstandsmodifikator",
	"attribute.name.armor": "Rustning",
	"attribute.name.armor_toughness": "Rustningshårdhed",
	"attribute.name.attack_damage": "Angrebsstyrke",
	"attribute.name.attack_knockback": "Angreb tilbageslag",
	"attribute.name.attack_speed": "Angrebshastighed",
	"attribute.name.below_name_distance": "Scoreafstand for navneskilte",
	"attribute.name.block_break_speed": "Blokødelæggelses-hastighed",
	"attribute.name.block_interaction_range": "Blok-interaktionsrækkevidde",
	"attribute.name.bounciness": "Hoppeevne",
	"attribute.name.burning_time": "Brændetid",
	"attribute.name.camera_distance": "Kameraafstand",
	"attribute.name.entity_interaction_range": "Objekt-interaktionsrækkevidde",
	"attribute.name.explosion_knockback_resistance": "Eksplosions-tilbageslagsbeskyttelse",
	"attribute.name.fall_damage_multiplier": "Faldskade multiplikator",
	"attribute.name.flying_speed": "Flyvehastighed",
	"attribute.name.follow_range": "Væsenfølgeradius",
	"attribute.name.friction_modifier": "Friktionsmodifikator",
	"attribute.name.generic.armor": "Beskyttelse",
	"attribute.name.generic.armor_toughness": "Rustningshårdhed",
	...
	"attribute.name.generic.block_interaction_range": "Blok-interaktionsrækkevidde",
	"attribute.name.generic.burning_time": "Brændetid",
	"attribute.name.generic.entity_interaction_range": "Objekt-interaktionsrækkevidde",
	"attribute.name.generic.explosion_knockback_resistance": "Eksplosions-tilbageslagsbeskyttelse",
	"attribute.name.generic.fall_damage_multiplier": "Faldskade multiplikator",
	"attribute.name.generic.flying_speed": "Flyvehastighed",
	"attribute.name.generic.follow_range": "Væsenfølgeradius",
	"attribute.name.generic.gravity": "Tyngdekraft",
	"attribute.name.generic.jump_strength": "Springstyrke",
	"attribute.name.generic.knockback_resistance": "Tilbageslagsbeskyttelse",
	"attribute.name.generic.luck": "Held",
	"attribute.name.generic.max_absorption": "Maksimum absorbering",
	"attribute.name.generic.max_health": "Maksimum helbred",
	"attribute.name.generic.movement_efficiency": "Bevægelseseffektivitet",
	"attribute.name.generic.movement_speed": "Hastighed",
	"attribute.name.generic.oxygen_bonus": "Iltbonus",
	"attribute.name.generic.safe_fall_distance": "Sikker falddistance",
	"attribute.name.generic.scale": "Skala",
	"attribute.name.generic.step_height": "Stigningshøjde",
	"attribute.name.generic.water_movement_efficiency": "Vandbevægelses effektivitet",
	"attribute.name.gravity": "Tyngdekraft",
	"attribute.name.horse.jump_strength": "Hestespringstyrke",
	"attribute.name.jump_strength": "Springstyrke",
	"attribute.name.knockback_resistance": "Tilbageslagsbeskyttelse",
	"attribute.name.luck": "Held",
	"attribute.name.max_absorption": "Maksimum absorbering",
	"attribute.name.max_health": "Maksimum helbred",
	"attribute.name.mining_efficiency": "Mineeffektivitet",
	"attribute.name.movement_efficiency": "Bevægelseseffektivitet",
	"attribute.name.movement_speed": "Hastighed",
	"attribute.name.nameplate_distance": "Navneskiltets afstand",
	"attribute.name.oxygen_bonus": "Iltbonus",
	"attribute.name.player.block_break_speed": "Blokødelæggelses hastighed",
	"attribute.name.player.block_interaction_range": "Blok‐interaktionsrækkevidde",
	"attribute.name.player.entity_interaction_range": "Objekt-interaktionsrækkevidde",
	"attribute.name.player.mining_efficiency": "Mineeffektivitet",
	"attribute.name.player.sneaking_speed": "Snigehastighed",
	"attribute.name.player.submerged_mining_speed": "Minehastighed under vand",
	"attribute.name.player.sweeping_damage_ratio": "Fejende skadesforhold",
	"attribute.name.safe_fall_distance": "Sikker falddistance",
	"attribute.name.scale": "Skala",
	"attribute.name.sneaking_speed": "Snigehastighed",
	"attribute.name.spawn_reinforcements": "Zombieforstærkninger",
	"attribute.name.step_height": "Stigningshøjde",
	"attribute.name.submerged_mining_speed": "Minehastighed under vand",
	"attribute.name.sweeping_damage_ratio": "Fejende skadesforhold",
	"attribute.name.tempt_range": "Væsners lokkeafstand",
	"attribute.name.water_movement_efficiency": "Vandbevægelses effektivitet",
	"attribute.name.waypoint_receive_range": "Rutepunkt-modtagelsesrækkevidde",
	"attribute.name.waypoint_transmit_range": "Rutepunkt-transmissionsrækkevidde",
	...
	"biome.minecraft.cold_ocean": "Koldt hav",
	"biome.minecraft.crimson_forest": "Karmoisinskov",
	"biome.minecraft.dark_forest": "Mørkskov",
	"biome.minecraft.deep_cold_ocean": "Dybt koldt hav",
	"biome.minecraft.deep_dark": "Mørke dyb",
	"biome.minecraft.deep_frozen_ocean": "Dybfrossen hav",
	"biome.minecraft.deep_lukewarm_ocean": "Dybt lunkent hav",
	"biome.minecraft.deep_ocean": "Dybt hav",
	...
	"biome.minecraft.frozen_river": "Frossen flod",
	...
	"biome.minecraft.pale_garden": "Bleg have",
	...
	"biome.minecraft.sulfur_caves": "Svovlgrotter",
	...
	"block.minecraft.acacia_shelf": "Akaciehylde",
	...
	"block.minecraft.acacia_wall_hanging_sign": "Væghængende akacieskilt",
	...
	"block.minecraft.bamboo_shelf": "Bambushylde",
	...
	"block.minecraft.bamboo_wall_hanging_sign": "Væghængende bambusskilt",
	"block.minecraft.bamboo_wall_sign": "Bambusvægskilt",
	...
	"block.minecraft.banner.border.magenta": "Magenta ramme",
	...
	"block.minecraft.banner.bricks.magenta": "Magenta murstensmønster",
	...
	"block.minecraft.banner.circle.magenta": "Magenta cirkel",
	...
	"block.minecraft.banner.creeper.black": "Sort creepersymbol",
	"block.minecraft.banner.creeper.blue": "Blåt creepersymbol",
	"block.minecraft.banner.creeper.brown": "Brunt creepersymbol",
	"block.minecraft.banner.creeper.cyan": "Turkis creepersymbol",
	"block.minecraft.banner.creeper.gray": "Gråt creepersymbol",
	"block.minecraft.banner.creeper.green": "Grønt creepersymbol",
	"block.minecraft.banner.creeper.light_blue": "Lyseblåt creepersymbol",
	"block.minecraft.banner.creeper.light_gray": "Lysegråt creepersymbol",
	"block.minecraft.banner.creeper.lime": "Limegrønt creepersymbol",
	"block.minecraft.banner.creeper.magenta": "Magenta creepersymbol",
	"block.minecraft.banner.creeper.orange": "Orange creepersymbol",
	"block.minecraft.banner.creeper.pink": "Lyserødt creepersymbol",
	"block.minecraft.banner.creeper.purple": "Lilla creepersymbol",
	"block.minecraft.banner.creeper.red": "Rødt creepersymbol",
	"block.minecraft.banner.creeper.white": "Hvidt creepersymbol",
	"block.minecraft.banner.creeper.yellow": "Gult creepersymbol",
	...
	"block.minecraft.banner.cross.magenta": "Magenta kryds",
	...
	"block.minecraft.banner.curly_border.magenta": "Magenta takket ramme",
	...
	"block.minecraft.banner.diagonal_left.magenta": "Magenta øvre højrebåndshalvdel",
	...
	"block.minecraft.banner.diagonal_right.magenta": "Magenta øvre venstrebåndshalvdel",
	...
	"block.minecraft.banner.diagonal_up_left.magenta": "Magenta nedre venstrebåndshalvdel",
	...
	"block.minecraft.banner.diagonal_up_right.magenta": "Magenta nedre højrebåndshalvdel",
	...
	"block.minecraft.banner.flow.black": "Sort hvirvel",
	"block.minecraft.banner.flow.blue": "Blå hvirvel",
	"block.minecraft.banner.flow.brown": "Brun hvirvel",
	"block.minecraft.banner.flow.cyan": "Turkis hvirvel",
	"block.minecraft.banner.flow.gray": "Grå hvirvel",
	"block.minecraft.banner.flow.green": "Grøn hvirvel",
	"block.minecraft.banner.flow.light_blue": "Lyseblå hvirvel",
	"block.minecraft.banner.flow.light_gray": "Lysegrå hvirvel",
	"block.minecraft.banner.flow.lime": "Limegrøn hvirvel",
	"block.minecraft.banner.flow.magenta": "Magenta hvirvel",
	"block.minecraft.banner.flow.orange": "Orange hvirvel",
	"block.minecraft.banner.flow.pink": "Lyserød hvirvel",
	"block.minecraft.banner.flow.purple": "Lilla hvirvel",
	"block.minecraft.banner.flow.red": "Rød hvirvel",
	"block.minecraft.banner.flow.white": "Hvid hvirvel",
	"block.minecraft.banner.flow.yellow": "Gul hvirvel",
	"block.minecraft.banner.flower.black": "Sort blomstersymbol",
	"block.minecraft.banner.flower.blue": "Blåt blomstersymbol",
	"block.minecraft.banner.flower.brown": "Brunt blomstersymbol",
	"block.minecraft.banner.flower.cyan": "Turkis blomstersymbol",
	"block.minecraft.banner.flower.gray": "Gråt blomstersymbol",
	"block.minecraft.banner.flower.green": "Grønt blomstersymbol",
	"block.minecraft.banner.flower.light_blue": "Lyseblåt blomstersymbol",
	"block.minecraft.banner.flower.light_gray": "Lysegråt blomstersymbol",
	"block.minecraft.banner.flower.lime": "Limegrønt blomstersymbol",
	"block.minecraft.banner.flower.magenta": "Magenta blomstersymbol",
	"block.minecraft.banner.flower.orange": "Orange blomstersymbol",
	"block.minecraft.banner.flower.pink": "Lyserødt blomstersymbol",
	"block.minecraft.banner.flower.purple": "Lilla blomstersymbol",
	"block.minecraft.banner.flower.red": "Rødt blomstersymbol",
	"block.minecraft.banner.flower.white": "Hvidt blomstersymbol",
	"block.minecraft.banner.flower.yellow": "Gult blomstersymbol",
	...
	"block.minecraft.banner.gradient.magenta": "Øvre faldne magenta",
	...
	"block.minecraft.banner.gradient_up.magenta": "Nedre faldne magenta",
	...
	"block.minecraft.banner.guster.black": "Sort vindvæsen",
	"block.minecraft.banner.guster.blue": "Blåt vindvæsen",
	"block.minecraft.banner.guster.brown": "Brunt vindvæsen",
	"block.minecraft.banner.guster.cyan": "Turkis vindvæsen",
	"block.minecraft.banner.guster.gray": "Gråt vindvæsen",
	"block.minecraft.banner.guster.green": "Grønt vindvæsen",
	"block.minecraft.banner.guster.light_blue": "Lyseblåt vindvæsen",
	"block.minecraft.banner.guster.light_gray": "Lysegråt vindvæsen",
	"block.minecraft.banner.guster.lime": "Limegrønt vindvæsen",
	"block.minecraft.banner.guster.magenta": "Magenta vindvæsen",
	"block.minecraft.banner.guster.orange": "Orange vindvæsen",
	"block.minecraft.banner.guster.pink": "Lyserødt vindvæsen",
	"block.minecraft.banner.guster.purple": "Lillat vindvæsen",
	"block.minecraft.banner.guster.red": "Rødt vindvæsen",
	"block.minecraft.banner.guster.white": "Hvidt vindvæsen",
	"block.minecraft.banner.guster.yellow": "Gult vindvæsen",
	...
	"block.minecraft.banner.half_horizontal.magenta": "Magenta øvre halvdel",
	...
	"block.minecraft.banner.half_horizontal_bottom.magenta": "Magenta nedre halvdel",
	...
	"block.minecraft.banner.half_vertical.magenta": "Magenta venstreside",
	...
	"block.minecraft.banner.half_vertical_right.magenta": "Magenta højre halvdel",
	...
	"block.minecraft.banner.mojang.magenta": "Magenta ting",
	...
	"block.minecraft.banner.piglin.magenta": "Magenta snude",
	...
	"block.minecraft.banner.rhombus.magenta": "Magenta rombe",
	...
	"block.minecraft.banner.skull.black": "Sort kraniumsymbol",
	"block.minecraft.banner.skull.blue": "Blåt kraniumsymbol",
	"block.minecraft.banner.skull.brown": "Brunt kraniumsymbol",
	"block.minecraft.banner.skull.cyan": "Turkis kraniumsymbol",
	"block.minecraft.banner.skull.gray": "Gråt kraniumsymbol",
	"block.minecraft.banner.skull.green": "Grønt kraniumsymbol",
	"block.minecraft.banner.skull.light_blue": "Lyseblåt kraniumsymbol",
	"block.minecraft.banner.skull.light_gray": "Lysegråt kraniumsymbol",
	"block.minecraft.banner.skull.lime": "Limegrønt kraniumsymbol",
	"block.minecraft.banner.skull.magenta": "Magenta kraniumsymbol",
	"block.minecraft.banner.skull.orange": "Orange kraniumsymbol",
	"block.minecraft.banner.skull.pink": "Lyserødt kraniumsymbol",
	"block.minecraft.banner.skull.purple": "Lilla kraniumsymbol",
	"block.minecraft.banner.skull.red": "Rødt kraniumsymbol",
	"block.minecraft.banner.skull.white": "Hvidt kraniumsymbol",
	"block.minecraft.banner.skull.yellow": "Gult kraniumsymbol",
	...
	"block.minecraft.banner.small_stripes.magenta": "Magenta gitter",
	...
	"block.minecraft.banner.square_bottom_left.magenta": "Magenta firkant nederst til venstre",
	...
	"block.minecraft.banner.square_bottom_right.magenta": "Magenta firkant nede til højre",
	...
	"block.minecraft.banner.square_top_left.magenta": "Magenta firkant oppe til venstre",
	...
	"block.minecraft.banner.square_top_right.magenta": "Magenta firkant oppe til højre",
	...
	"block.minecraft.banner.straight_cross.magenta": "Magenta kors",
	...
	"block.minecraft.banner.stripe_center.magenta": "Magenta pæl",
	...
	"block.minecraft.banner.stripe_downleft.magenta": "Magenta højrebånd",
	...
	"block.minecraft.banner.stripe_downright.magenta": "Magenta venstrebånd",
	...
	"block.minecraft.banner.stripe_left.magenta": "Magenta venstre pæl",
	...
	"block.minecraft.banner.stripe_middle.magenta": "Magenta bjælke",
	...
	"block.minecraft.banner.stripe_right.magenta": "Magenta højre pæl",
	...
	"block.minecraft.banner.triangle_bottom.magenta": "Magenta nedre trekant",
	...
	"block.minecraft.banner.triangle_top.magenta": "Magenta øvre trekant",
	...
	"block.minecraft.banner.triangles_bottom.magenta": "Magenta bundpigge",
	...
	"block.minecraft.banner.triangles_top.light_blue": "Lyseblå toppigge",
	"block.minecraft.banner.triangles_top.light_gray": "Lysegrå toppigge",
	"block.minecraft.banner.triangles_top.lime": "Limegrønne toppigge",
	"block.minecraft.banner.triangles_top.magenta": "Magenta toppigge",
	"block.minecraft.banner.triangles_top.orange": "Orange toppigge",
	"block.minecraft.banner.triangles_top.pink": "Lyserøde toppigge",
	...
	"block.minecraft.birch_shelf": "Birkehylde",
	...
	"block.minecraft.birch_wall_hanging_sign": "Væghængende birkeskilt",
	...
	"block.minecraft.black_concrete_powder": "Sort betonpulver",
	"block.minecraft.black_glazed_terracotta": "Sort glaseret terrakotta",
	"block.minecraft.black_shulker_box": "Sort shulkerboks",
	...
	"block.minecraft.blue_concrete_powder": "Blåt betonpulver",
	...
	"block.minecraft.brown_concrete_powder": "Brunt betonpulver",
	...
	"block.minecraft.bush": "Busk",
	"block.minecraft.cactus": "Kaktus",
	"block.minecraft.cactus_flower": "Kaktusblomst",
	"block.minecraft.cake": "Kage",
	"block.minecraft.calcite": "Calcit",
	"block.minecraft.calibrated_sculk_sensor": "Kalibreret sculk-sensor",
	...
	"block.minecraft.cherry_hanging_sign": "Hængende kirsebærskilt",
	...
	"block.minecraft.cherry_shelf": "Kirsebærhylde",
	"block.minecraft.cherry_sign": "Kirsebærtræsskilt",
	"block.minecraft.cherry_slab": "Kirsebærplade",
	"block.minecraft.cherry_stairs": "Kirsebærtrappe",
	"block.minecraft.cherry_trapdoor": "Kirsebærlem",
	"block.minecraft.cherry_wall_hanging_sign": "Væghængende kirsebærskilt",
	"block.minecraft.cherry_wall_sign": "Kirsebærsvægskilt",
	"block.minecraft.cherry_wood": "Kirsebærtræ",
	"block.minecraft.chest": "Kiste",
	"block.minecraft.chipped_anvil": "Hakket ambolt",
	"block.minecraft.chiseled_bookshelf": "Mejslet bogreol",
	"block.minecraft.chiseled_cinnabar": "Mejslet cinnober",
	"block.minecraft.chiseled_copper": "Mejslet kobber",
	"block.minecraft.chiseled_deepslate": "Mejslet dybskifer",
	"block.minecraft.chiseled_nether_bricks": "Mejslet nethermursten",
	...
	"block.minecraft.chiseled_resin_bricks": "Mejslet harpiksmursten",
	"block.minecraft.chiseled_sandstone": "Mejslet sandsten",
	"block.minecraft.chiseled_stone_bricks": "Mejslede stenmursten",
	"block.minecraft.chiseled_sulfur": "Mejslet svovl",
	"block.minecraft.chiseled_tuff": "Mejslet tuf",
	"block.minecraft.chiseled_tuff_bricks": "Mejslet tufmursten",
	"block.minecraft.chorus_flower": "Omkvædsblomst",
	"block.minecraft.chorus_plant": "Omkvædsplante",
	"block.minecraft.cinnabar": "Cinnober",
	"block.minecraft.cinnabar_brick_slab": "Cinnober-murstensflise",
	"block.minecraft.cinnabar_brick_stairs": "Cinnober-murstenstrappe",
	"block.minecraft.cinnabar_brick_wall": "Cinnober-murstensvæg",
	"block.minecraft.cinnabar_bricks": "Cinnobermursten",
	"block.minecraft.cinnabar_slab": "Cinnoberflise",
	"block.minecraft.cinnabar_stairs": "Cinnobertrappe",
	"block.minecraft.cinnabar_wall": "Cinnobervæg",
	"block.minecraft.clay": "Ler",
	"block.minecraft.closed_eyeblossom": "Lukket øjeblomst",
	...
	"block.minecraft.copper_bars": "Kobbertremmer",
	"block.minecraft.copper_block": "Blok af kobber",
	"block.minecraft.copper_bulb": "Kobberpære",
	"block.minecraft.copper_chain": "Kobberkæde",
	"block.minecraft.copper_chest": "Kobberkiste",
	"block.minecraft.copper_door": "Kobberdør",
	"block.minecraft.copper_golem_statue": "Kobbergolemstatue",
	"block.minecraft.copper_grate": "Kobberrist",
	"block.minecraft.copper_lantern": "Kobberlanterne",
	"block.minecraft.copper_ore": "Kobbermalm",
	"block.minecraft.copper_torch": "Kobberfakkel",
	"block.minecraft.copper_trapdoor": "Kobberlem",
	"block.minecraft.copper_wall_torch": "Kobbervægfakkel",
	...
	"block.minecraft.cracked_nether_bricks": "Revnede nethermursten",
	...
	"block.minecraft.crafter": "Fabrikant",
	"block.minecraft.crafting_table": "Arbejdsbord",
	"block.minecraft.creaking_heart": "Knirkende hjerte",
	"block.minecraft.creeper_head": "Creeper-hoved",
	"block.minecraft.creeper_wall_head": "Creeper-væghoved",
	...
	"block.minecraft.crimson_shelf": "Karmoisinhylde",
	...
	"block.minecraft.crimson_wall_hanging_sign": "Væghængende karmoisinskilt",
	...
	"block.minecraft.cyan_concrete_powder": "Turkis betonpulver",
	...
	"block.minecraft.dark_oak_hanging_sign": "Hængende mørk egetræsskilt",
	...
	"block.minecraft.dark_oak_shelf": "Mørk egehylde",
	...
	"block.minecraft.dark_oak_wall_hanging_sign": "Væghængende mørk egetræsskilt",
	...
	"block.minecraft.decorated_pot": "Dekoreret krukke",
	...
	"block.minecraft.dragon_wall_head": "Drage-væghoved",
	"block.minecraft.dried_ghast": "Udtørret ghast",
	...
	"block.minecraft.exposed_chiseled_copper": "Blotlagt mejlset kobber",
	"block.minecraft.exposed_copper": "Blotlagt kobber",
	"block.minecraft.exposed_copper_bars": "Blotlagt kobbertremmer",
	"block.minecraft.exposed_copper_bulb": "Blotlagt kobberpære",
	"block.minecraft.exposed_copper_chain": "Blotlagt kobberkæde",
	"block.minecraft.exposed_copper_chest": "Blotlagt kobberkiste",
	"block.minecraft.exposed_copper_door": "Blotlagt kobberdør",
	"block.minecraft.exposed_copper_golem_statue": "Blotlagt kobbergolemstatue",
	"block.minecraft.exposed_copper_grate": "Blotlagt kobberrist",
	"block.minecraft.exposed_copper_lantern": "Blotlagt kobberlanterne",
	"block.minecraft.exposed_copper_trapdoor": "Blotlagt kobberlem",
	...
	"block.minecraft.exposed_lightning_rod": "Blotlagt lynafleder",
	...
	"block.minecraft.firefly_bush": "Ildflue busk",
	...
	"block.minecraft.golden_dandelion": "Gylden mælkebøtte",
	...
	"block.minecraft.gray_concrete_powder": "Gråt betonpulver",
	...
	"block.minecraft.green_concrete_powder": "Grønt betonpulver",
	...
	"block.minecraft.heavy_core": "Tung kerne",
	...
	"block.minecraft.iron_chain": "Jernkæde",
	...
	"block.minecraft.jungle_shelf": "Junglehylde",
	...
	"block.minecraft.jungle_wall_hanging_sign": "Væghængende jungleskilt",
	...
	"block.minecraft.leaf_litter": "Førne",
	...
	"block.minecraft.light_blue_concrete_powder": "Lyseblåt betonpulver",
	...
	"block.minecraft.light_gray_concrete_powder": "Lysegråt betonpulver",
	...
	"block.minecraft.lime_concrete_powder": "Limegrønt betonpulver",
	...
	"block.minecraft.magenta_bed": "Magenta seng",
	"block.minecraft.magenta_candle": "Magenta stearinlys",
	"block.minecraft.magenta_candle_cake": "Kage med magenta stearinlys",
	"block.minecraft.magenta_carpet": "Magenta tæppe",
	"block.minecraft.magenta_concrete": "Magenta beton",
	"block.minecraft.magenta_concrete_powder": "Magenta betonpulver",
	"block.minecraft.magenta_glazed_terracotta": "Magenta glaseret terrakotta",
	"block.minecraft.magenta_shulker_box": "Magenta shulkerboks",
	"block.minecraft.magenta_stained_glass": "Magenta farvet glas",
	"block.minecraft.magenta_stained_glass_pane": "Magenta farvet glaspanel",
	"block.minecraft.magenta_terracotta": "Magenta terrakotta",
	"block.minecraft.magenta_wool": "Magenta uld",
	...
	"block.minecraft.mangrove_propagule": "Mangrove skud",
	"block.minecraft.mangrove_roots": "Mangroverødder",
	"block.minecraft.mangrove_shelf": "Mangrovehylde",
	...
	"block.minecraft.mangrove_wall_hanging_sign": "Væghængende mangroveskilt",
	...
	"block.minecraft.oak_shelf": "Egehylde",
	...
	"block.minecraft.oak_wall_hanging_sign": "Væghængende egeskilt",
	...
	"block.minecraft.open_eyeblossom": "Åben øjeblomst",
	...
	"block.minecraft.orange_concrete_powder": "Orange betonpulver",
	"block.minecraft.orange_glazed_terracotta": "Orange glaseret terrakotta",
	"block.minecraft.orange_shulker_box": "Orange shulkerboks",
	...
	"block.minecraft.oxidized_chiseled_copper": "Oxideret mejslet kobber",
	"block.minecraft.oxidized_copper": "Oxideret kobber",
	"block.minecraft.oxidized_copper_bars": "Oxideret kobbertremmer",
	"block.minecraft.oxidized_copper_bulb": "Oxideret kobberpære",
	"block.minecraft.oxidized_copper_chain": "Oxideret kobberkæde",
	"block.minecraft.oxidized_copper_chest": "Oxideret kobberkiste",
	"block.minecraft.oxidized_copper_door": "Oxideret kobberdør",
	"block.minecraft.oxidized_copper_golem_statue": "Oxideret kobbergolemstatue",
	"block.minecraft.oxidized_copper_grate": "Oxideret kobberrist",
	"block.minecraft.oxidized_copper_lantern": "Oxideret kobberlanterne",
	"block.minecraft.oxidized_copper_trapdoor": "Oxideret kobberlem",
	...
	"block.minecraft.oxidized_lightning_rod": "Oxideret lynafleder",
	"block.minecraft.packed_ice": "Sammenpresset is",
	"block.minecraft.packed_mud": "Sammenpresset mudder",
	"block.minecraft.pale_hanging_moss": "Hængende blegt mos",
	"block.minecraft.pale_moss_block": "Bleg mosblok",
	"block.minecraft.pale_moss_carpet": "Blegt mostæppe",
	"block.minecraft.pale_oak_button": "Bleg egeknap",
	"block.minecraft.pale_oak_door": "Bleg egedør",
	"block.minecraft.pale_oak_fence": "Blegt egetræshegn",
	"block.minecraft.pale_oak_fence_gate": "Bleg egetræshegnslåge",
	"block.minecraft.pale_oak_hanging_sign": "Hængende blegt egetræsskilt",
	"block.minecraft.pale_oak_leaves": "Blegt egeløv",
	"block.minecraft.pale_oak_log": "Bleg egestamme",
	"block.minecraft.pale_oak_planks": "Blege egeplanker",
	"block.minecraft.pale_oak_pressure_plate": "Bleg egetrykplade",
	"block.minecraft.pale_oak_sapling": "Ungt blegt egetræ",
	"block.minecraft.pale_oak_shelf": "Bleg egehylde",
	"block.minecraft.pale_oak_sign": "Blegt egetræsskilt",
	"block.minecraft.pale_oak_slab": "Bleg egeplade",
	"block.minecraft.pale_oak_stairs": "Bleg egetrappe",
	"block.minecraft.pale_oak_trapdoor": "Bleg egelem",
	"block.minecraft.pale_oak_wall_hanging_sign": "Væghængende blegt egetræsskilt",
	"block.minecraft.pale_oak_wall_sign": "Blegt egetræsvægskilt",
	"block.minecraft.pale_oak_wood": "Blegt egetræ",
	...
	"block.minecraft.piglin_wall_head": "Piglin-væghoved",
	...
	"block.minecraft.player_head": "Spillerhoved",
	"block.minecraft.player_head.named": "%ss hoved",
	"block.minecraft.player_wall_head": "Spiller-væghoved",
	...
	"block.minecraft.polished_cinnabar": "Poleret cinnober",
	"block.minecraft.polished_cinnabar_slab": "Poleret cinnoberflise",
	"block.minecraft.polished_cinnabar_stairs": "Poleret cinnobertrappe",
	"block.minecraft.polished_cinnabar_wall": "Poleret cinnobervæg",
	...
	"block.minecraft.polished_sulfur": "Poleret svovl",
	"block.minecraft.polished_sulfur_slab": "Poleret svovlflise",
	"block.minecraft.polished_sulfur_stairs": "Poleret svovltrappe",
	"block.minecraft.polished_sulfur_wall": "Poleret svovlvæg",
	"block.minecraft.polished_tuff": "Poleret tuf",
	"block.minecraft.polished_tuff_slab": "Poleret tufplade",
	"block.minecraft.polished_tuff_stairs": "Poleret tuftrappe",
	"block.minecraft.polished_tuff_wall": "Poleret tufvæg",
	"block.minecraft.poppy": "Valmue",
	"block.minecraft.potatoes": "Kartofler",
	"block.minecraft.potent_sulfur": "Potent svovl",
	...
	"block.minecraft.potted_cherry_sapling": "Ungt kirsebærtræ potteplante",
	"block.minecraft.potted_closed_eyeblossom": "Lukket øjenblomst potteplante",
	...
	"block.minecraft.potted_golden_dandelion": "Gylden mælkebøtte potteplante",
	...
	"block.minecraft.potted_mangrove_propagule": "Mangrove skud potteplante",
	"block.minecraft.potted_oak_sapling": "Ungt egetræ potteplante",
	"block.minecraft.potted_open_eyeblossom": "Åben øjenblomst potteplante",
	...
	"block.minecraft.potted_pale_oak_sapling": "Ungt blegt egetræ potteplante",
	...
	"block.minecraft.potted_torchflower": "Fakkelblomst potteplante",
	...
	"block.minecraft.purple_concrete_powder": "Lilla betonpulver",
	...
	"block.minecraft.red_concrete_powder": "Rødt betonpulver",
	...
	"block.minecraft.red_nether_bricks": "Røde nethermursten",
	...
	"block.minecraft.resin_block": "Blok af harpiks",
	"block.minecraft.resin_brick_slab": "Harpiksmurstensflise",
	"block.minecraft.resin_brick_stairs": "Harpiks-murstenstrappe",
	"block.minecraft.resin_brick_wall": "Harpiks-murstensvæg",
	"block.minecraft.resin_bricks": "Harpiksmursten",
	"block.minecraft.resin_clump": "Harpiksklump",
	...
	"block.minecraft.short_dry_grass": "Kort tørt græs",
	"block.minecraft.short_grass": "Kort græs",
	"block.minecraft.shroomlight": "Svampelys",
	"block.minecraft.shulker_box": "Shulkerboks",
	"block.minecraft.skeleton_skull": "Kranium",
	"block.minecraft.skeleton_wall_skull": "Vægkranie",
	...
	"block.minecraft.sniffer_egg": "Snifferæg",
	...
	"block.minecraft.spruce_shelf": "Granhylde",
	...
	"block.minecraft.spruce_wall_hanging_sign": "Væghængende granskilt",
	...
	"block.minecraft.stripped_bamboo_block": "Afbarket blok af bambus",
	"block.minecraft.stripped_birch_log": "Afbarket birkestamme",
	"block.minecraft.stripped_birch_wood": "Afbarket birketræ",
	"block.minecraft.stripped_cherry_log": "Afbarket kirsebærstamme",
	"block.minecraft.stripped_cherry_wood": "Afbarket kirsebærtræ",
	...
	"block.minecraft.stripped_pale_oak_log": "Afbarket bleg egestamme",
	"block.minecraft.stripped_pale_oak_wood": "Afbarket blegt egetræ",
	...
	"block.minecraft.sulfur": "Svovl",
	"block.minecraft.sulfur_brick_slab": "Svovl-murstensflise",
	"block.minecraft.sulfur_brick_stairs": "Svovl-murstenstrappe",
	"block.minecraft.sulfur_brick_wall": "Svovl-murstensvæg",
	"block.minecraft.sulfur_bricks": "Svovlmursten",
	"block.minecraft.sulfur_slab": "Svovlplade",
	"block.minecraft.sulfur_spike": "Svovlpig",
	"block.minecraft.sulfur_stairs": "Svovltrappe",
	"block.minecraft.sulfur_wall": "Svovlvæg",
	"block.minecraft.sunflower": "Solsikke",
	"block.minecraft.suspicious_gravel": "Mistænkeligt grus",
	"block.minecraft.suspicious_sand": "Mistænkeligt sand",
	"block.minecraft.sweet_berry_bush": "Sød bærbusk",
	"block.minecraft.tall_dry_grass": "Højt tørt græs",
	...
	"block.minecraft.test_block": "Testblok",
	"block.minecraft.test_instance_block": "Testinstansblok",
	"block.minecraft.tinted_glass": "Tonet glas",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "TNT-eksplosioner er deaktiveret",
	"block.minecraft.torch": "Fakkel",
	"block.minecraft.torchflower": "Fakkelblomst",
	"block.minecraft.torchflower_crop": "Fakkelblomst afgrøde",
	"block.minecraft.trapped_chest": "Fældekiste",
	"block.minecraft.trial_spawner": "Prøvelsesspawner",
	...
	"block.minecraft.tuff_brick_slab": "Tuf-murstensflise",
	"block.minecraft.tuff_brick_stairs": "Tuf-murstenstrappe",
	"block.minecraft.tuff_brick_wall": "Tuf-murstensvæg",
	"block.minecraft.tuff_bricks": "Tufmursten",
	"block.minecraft.tuff_slab": "Tufplade",
	"block.minecraft.tuff_stairs": "Tuftrappe",
	"block.minecraft.tuff_wall": "Tufvæg",
	...
	"block.minecraft.warped_shelf": "Forskruet hylde",
	...
	"block.minecraft.warped_wall_hanging_sign": "Væghængende forskruet skilt",
	...
	"block.minecraft.waxed_chiseled_copper": "Vokset mejslet kobber",
	"block.minecraft.waxed_copper_bars": "Vokset kobbertremmer",
	"block.minecraft.waxed_copper_block": "Vokset blok af kobber",
	"block.minecraft.waxed_copper_bulb": "Vokset kobberpære",
	"block.minecraft.waxed_copper_chain": "Vokset kobberkæde",
	"block.minecraft.waxed_copper_chest": "Vokset kobberkiste",
	"block.minecraft.waxed_copper_door": "Vokset kobberdør",
	"block.minecraft.waxed_copper_golem_statue": "Vokset kobbergolemstatue",
	"block.minecraft.waxed_copper_grate": "Vokset kobberrist",
	"block.minecraft.waxed_copper_lantern": "Vokset kobberlanterne",
	"block.minecraft.waxed_copper_trapdoor": "Vokset kobberlem",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Vokset blotlagt mejslet kobber",
	"block.minecraft.waxed_exposed_copper": "Vokset blotlagt kobber",
	"block.minecraft.waxed_exposed_copper_bars": "Vokset blotlagt kobbertremmer",
	"block.minecraft.waxed_exposed_copper_bulb": "Vokset blotlagt kobberpære",
	"block.minecraft.waxed_exposed_copper_chain": "Vokset blotlagt kobberkæde",
	"block.minecraft.waxed_exposed_copper_chest": "Vokset blotlagt kobberkiste",
	"block.minecraft.waxed_exposed_copper_door": "Vokset blotlagt kobberdør",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Vokset blotlagt kobbergolemstatue",
	"block.minecraft.waxed_exposed_copper_grate": "Vokset blotlagt kobberrist",
	"block.minecraft.waxed_exposed_copper_lantern": "Vokset blotlagt kobberlanterne",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Vokset blotlagt kobberlem",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Vokset blotlagt lynafleder",
	"block.minecraft.waxed_lightning_rod": "Vokset lynafleder",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Vokset oxideret mejslet kobber",
	"block.minecraft.waxed_oxidized_copper": "Vokset oxideret kobber",
	"block.minecraft.waxed_oxidized_copper_bars": "Vokset oxideret kobbertremmer",
	"block.minecraft.waxed_oxidized_copper_bulb": "Vokset oxideret kobberpære",
	"block.minecraft.waxed_oxidized_copper_chain": "Vokset oxideret kobberkæde",
	"block.minecraft.waxed_oxidized_copper_chest": "Vokset oxideret kobberkiste",
	"block.minecraft.waxed_oxidized_copper_door": "Vokset oxideret kobberdør",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Vokset oxideret kobbergolemstatue",
	"block.minecraft.waxed_oxidized_copper_grate": "Vokset oxideret kobberrist",
	"block.minecraft.waxed_oxidized_copper_lantern": "Vokset oxideret kobberlanterne",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Vokset oxideret kobberlem",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Vokset oxideret lynafleder",
	"block.minecraft.waxed_weathered_chiseled_copper": "Vokset forvitret kobber",
	"block.minecraft.waxed_weathered_copper": "Vokset forvitret kobber",
	"block.minecraft.waxed_weathered_copper_bars": "Vokset forvitret kobbertremmer",
	"block.minecraft.waxed_weathered_copper_bulb": "Vokset forvitret kobberpære",
	"block.minecraft.waxed_weathered_copper_chain": "Vokset forvitret kobberkæde",
	"block.minecraft.waxed_weathered_copper_chest": "Vokset forvitret kobberkiste",
	"block.minecraft.waxed_weathered_copper_door": "Vokset forvitret kobberdør",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Vokset forvitret kobbergolemstatue",
	"block.minecraft.waxed_weathered_copper_grate": "Vokset forvitret kobberrist",
	"block.minecraft.waxed_weathered_copper_lantern": "Vokset forvitret kobberlanterne",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Vokset forvitret kobberlem",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Vokset forvitret lynafleder",
	"block.minecraft.weathered_chiseled_copper": "Forvitret mejslet kobber",
	"block.minecraft.weathered_copper": "Forvitret kobber",
	"block.minecraft.weathered_copper_bars": "Forvitret kobbertremmer",
	"block.minecraft.weathered_copper_bulb": "Forvitret kobberpære",
	"block.minecraft.weathered_copper_chain": "Forvitret kobberkæde",
	"block.minecraft.weathered_copper_chest": "Forvitret kobberkiste",
	"block.minecraft.weathered_copper_door": "Forvitret kobberdør",
	"block.minecraft.weathered_copper_golem_statue": "Forvitret kobbergolemstatue",
	"block.minecraft.weathered_copper_grate": "Forvitret kobberrist",
	"block.minecraft.weathered_copper_lantern": "Forvitret kobberlanterne",
	"block.minecraft.weathered_copper_trapdoor": "Forvitret kobberlem",
	...
	"block.minecraft.weathered_lightning_rod": "Forvitret lynafleder",
	...
	"block.minecraft.white_concrete_powder": "Hvidt betonpulver",
	"block.minecraft.white_glazed_terracotta": "Hvid glaseret terrakotta",
	"block.minecraft.white_shulker_box": "Hvid shulkerboks",
	...
	"block.minecraft.wildflowers": "Vildblomster",
	"block.minecraft.wither_rose": "Wither rose",
	"block.minecraft.wither_skeleton_skull": "Witherskeletkranium",
	"block.minecraft.wither_skeleton_wall_skull": "Wither vægkranie",
	...
	"block.minecraft.yellow_concrete_powder": "Gult betonpulver",
	...
	"block.minecraft.zombie_wall_head": "Zombie-væghoved",
	"book.byAuthor": "af %[1]s",
	"book.edit.title": "Bog-redigeringsvindue",
	...
	"book.page_button.next": "Næste side",
	"book.page_button.previous": "Forrige side",
	"book.sign.title": "Bog-signeringsvindue",
	"book.sign.titlebox": "Titel",
	"book.signButton": "Underskriv",
	"book.view.title": "Bog-visningsvindue",
	"build.spawn_protection": "%s er under spawnbeskyttelse",
	"build.tooHigh": "Højdegrænsen for byggeri er %s",
	"build.tooLow": "Minimumshøjden for byggeri er %s",
	...
	"chat.disabled.chain_broken": "Chat deaktiveret grundet kædebrud. Prøv venligst at forbinde igen.",
	"chat.disabled.expiredProfileKey": "Chat deaktiveret grundet udløbet offentlig profilnøgle. Prøv venligst at forbinde igen.",
	"chat.disabled.invalid_command_signature": "Kommandoen havde uventede eller manglende kommandoargument-signaturer.",
	"chat.disabled.invalid_signature": "Chat havde en ugyldig signatur. Prøv venligst at forbinde igen.",
	"chat.disabled.launcher": "Chat deaktiveret af starterindstilling. Kan ikke sende besked.",
	"chat.disabled.missingProfileKey": "Chat deaktiveret grundet manglende offentlig profilnøgle. Prøv venligst at forbinde igen.",
	"chat.disabled.options": "Chat er slået fra i klientindstillinger.",
	"chat.disabled.out_of_order_chat": "Chat modtaget i forkert orden. Ændrede dit system tid?",
	"chat.disabled.profile": "Chat er ikke tilladt i kontoindstillingerne. Tryk '%s' igen for mere information.",
	...
	"chat.filtered_full": "Serveren har skjult din besked for visse spillere.",
	...
	"chat.queue": "[+%s afventende linje(r)]",
	"chat.queue.tooltip": "Klik for at vise næste besked",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "Server sendte ugyldig besked.",
	"chat.tag.modified": "Besked ændret af serveren. Oprindeligt:",
	"chat.tag.not_secure": "Ubekræftet besked. Kan ikke rapporteres.",
	"chat.tag.system": "Serverbesked. Kan ikke rapporteres.",
	...
	"chat.validation_error": "Chat-valideringsfejl",
	"chat_restriction.chat_and_commands_disabled_by_options": "Chatten er begrænset i klientindstillingerne.",
	"chat_restriction.chat_disabled_by_options": "Spillerchat er begrænset i klientindstillinger.",
	"chat_restriction.chat_disabled_by_options.action": "Gå til chatindstillingsskærmen",
	"chat_restriction.disabled_by_launcher": "Chatten er begrænset af starteren",
	"chat_restriction.disabled_by_profile": "Chatten er begrænset af profilindstillinger.",
	"chat_restriction.disabled_by_profile.action": "Gå til dine profilindstillinger",
	"chat_screen.commands_not_allowed": "Det er ikke tilladt at sende kommandoer",
	"chat_screen.message": "Besked, der skal sendes: %s",
	"chat_screen.messages_not_allowed": "Det er ikke tilladt at sende chatbeskeder",
	"chat_screen.restricted": "Chatten er begrænset. Klik på denne besked for flere detaljer.",
	"chat_screen.restricted.narration": "Chatten er begrænset. Gå til begrænsningsskærmen i verdensindstillinger.",
	"chat_screen.title": "Chatskærm",
	"chat_screen.usage": "Indtast besked, og tryk på Enter for at sende",
	"chunk.toast.checkLog": "Se loggen for flere detaljer",
	"chunk.toast.loadFailure": "Kunne ikke indlæse klods ved %s",
	"chunk.toast.lowDiskSpace": "Lav diskplads!",
	"chunk.toast.lowDiskSpace.description": "Muligvis ikke i stand til at gemme verdenen.",
	"chunk.toast.saveFailure": "Kunne ikke gemme klods ved %s",
	...
	"command.failed": "En uventet fejl opstod i forsøget på at udføre den kommando",
	"command.forkLimit": "Maksimalt antal af kontekster (%s) nået",
	"command.trailing_data": "Efterfølgende data fundet: %s",
	"command.unknown.argument": "Ukorrekt argument for kommando",
	"command.unknown.command": "Ukendt eller ufuldstændig kommando, se nedenfor for fejl",
	...
	"commands.advancement.grant.criterion.to.many.success": "Tildelte kriteriet '%s' for fremskridtet %s til %s spillere",
	...
	"commands.advancement.grant.criterion.to.one.success": "Tildelte kriteriet '%s' for fremskridtet %s til %s",
	...
	"commands.advancement.grant.many.to.one.failure": "Kunne ikke tildele %s fremskridt til %s, fordi de allerede har det",
	...
	"commands.attribute.base_value.reset.success": "Basisværdi af attribut %s for objekt %s er nulstillet til standard %s",
	"commands.attribute.base_value.set.success": "Basisværdi af attribut %s for objekt %s sat til %s",
	"commands.attribute.failed.entity": "%s er ikke et gyldigt objekt for denne kommando",
	...
	"commands.attribute.modifier.value.get.success": "Værdien af modificereren %s på attributten %s for objekt %s er %s",
	"commands.attribute.value.get.success": "Værdien af attributten %s for objekt %s er %s",
	"commands.ban.failed": "Intet ændret. Spilleren er allerede bandlyst",
	"commands.ban.success": "Bandlyste %s: %s",
	"commands.banip.failed": "Intet ændret. Den IP er allerede bandlyst",
	"commands.banip.info": "Denne bandlysning påvirker %s spiller(e): %s",
	...
	"commands.banlist.entry.unknown": "(Ukendt)",
	"commands.banlist.list": "Der er %s bandlysning(er):",
	...
	"commands.bossbar.get.players.some": "Brugerdefineret bossbar %s har i øjeblikket %s spiller(e) online: %s",
	...
	"commands.bossbar.list.bars.some": "Der er %s brugerdefinerede bossbar(er) aktive: %s",
	...
	"commands.bossbar.set.color.unchanged": "Intet ændret. Det er allerede farven på den bossbar",
	"commands.bossbar.set.max.success": "Brugerdefineret bossbar %s har ændret maksimum til %s",
	"commands.bossbar.set.max.unchanged": "Intet ændret. Det er allerede maksimum for bossbaren",
	"commands.bossbar.set.name.success": "Brugerdefineret bossbar %s er blevet omdøbt",
	"commands.bossbar.set.name.unchanged": "Intet ændret. Det er allerede navnet på den bossbar",
	"commands.bossbar.set.players.success.none": "Brugerdefineret bossbar %s har ikke længere nogen spillere",
	"commands.bossbar.set.players.success.some": "Brugerdefineret bossbar %s har nu %s spiller(e): %s",
	"commands.bossbar.set.players.unchanged": "Intet ændret. Disse spillere er allerede på bossbaren, ingen blev sat på eller fjernet",
	"commands.bossbar.set.style.success": "Brugerdefineret bossbar %s har ændret stil",
	"commands.bossbar.set.style.unchanged": "Intet ændret. Det er allerede udseendet for bossbaren",
	"commands.bossbar.set.value.success": "Brugerdefineret bossbar %s har ændret værdi til %s",
	"commands.bossbar.set.value.unchanged": "Intet ændret. Det er allerede værdien for bossbaren",
	"commands.bossbar.set.visibility.unchanged.hidden": "Intet ændret. Bossbaren er allerede skjult",
	"commands.bossbar.set.visibility.unchanged.visible": "Intet ændret. Bossbaren er allerede synlig",
	...
	"commands.clear.success.multiple": "Fjernede %s genstand(e) fra %s spillere",
	"commands.clear.success.single": "Fjernede %s genstand(e) fra spiller %s",
	"commands.clear.test.multiple": "Fandt %s matchende genstand(e) på %s spillere",
	"commands.clear.test.single": "Fandt %s matchende genstand(e) på spiller %s",
	...
	"commands.clone.success": "Klonede %s blok(ke) succesfuldt",
	"commands.clone.toobig": "For mange blokke i det angivne område (maksimalt %s, men angav %s",
	"commands.damage.invulnerable": "Målet er usårligt mod den givne skadestype",
	"commands.damage.success": "Påførte %s skade på %s",
	...
	"commands.data.entity.invalid": "Kunne ikke modificere spillerdata",
	...
	"commands.data.get.multiple": "Dette argument accepterer en enkel NBT-værdi",
	...
	"commands.data.modify.expected_list": "Forventede en liste: fik: %s",
	"commands.data.modify.expected_object": "Forventede et objekt: fik %s",
	"commands.data.modify.expected_value": "Forventede en værdi: fik %s",
	"commands.data.modify.invalid_index": "Invalid list index: %s",
	"commands.data.modify.invalid_substring": "Ugyldige indeks for delstrenge: %s til %s",
	...
	"commands.datapack.create.already_exists": "Pakke med navnet '%s' eksisterer allerede",
	"commands.datapack.create.invalid_full_name": "Ugyldigt nyt pakkenavn '%s'",
	"commands.datapack.create.invalid_name": "Ugyldige tegn i nyt pakkenavn '%s'",
	"commands.datapack.create.io_failure": "Kan ikke oprette pakke med navnet '%s'. Tjek logfiler",
	"commands.datapack.create.metadata_encode_failure": "Kunne ikke kode metadata for pakken med navnet '%s': %s",
	"commands.datapack.create.success": "Oprettede ny tom pakke med navnet '%s'",
	"commands.datapack.disable.failed": "Pakken '%s' er ikke aktiv!",
	"commands.datapack.disable.failed.feature": "Pakke '%s' kan ikke blive deaktiveret, da den er en del af et aktiveret flag!",
	"commands.datapack.enable.failed": "Pakken '%s' er allerede aktiv!",
	"commands.datapack.enable.failed.no_flags": "Pakke '%s' kan ikke aktiveres, da de påkrævede flag ikke er slået til i denne verden: %s!",
	"commands.datapack.list.available.none": "Der er ikke flere datapakker tilgængelig",
	"commands.datapack.list.available.success": "Der er %s datapakke(r) tilgængelig: %s",
	"commands.datapack.list.enabled.none": "Der er ingen datapakker aktiveret",
	"commands.datapack.list.enabled.success": "Der er %s datapakke(r) aktiveret: %s",
	...
	"commands.debug.function.noReturnRun": "Sporing kan ikke bruges med return run",
	"commands.debug.function.success.multiple": "Sporede %s kommando(er) fra %s funktioner til output fil %s",
	"commands.debug.function.success.single": "Sporede %s kommando(er) fra funktion '%s' til output fil %s",
	...
	"commands.debug.stopped": "Stoppede tikprofilering efter %s sekund(er) og %s tik(s) (%s tik(s) pr. sekund)",
	"commands.defaultgamemode.success": "Den standarde spiltilstand er nu %s",
	"commands.deop.failed": "Intet ændret. Spilleren er ikke en operatør",
	"commands.deop.success": "%s er ikke længere en server operatør",
	"commands.dialog.clear.multiple": "Ryddede dialog for %s spillere",
	"commands.dialog.clear.single": "Ryddede dialog for %s",
	"commands.dialog.show.multiple": "Viste dialog til %s spillere",
	"commands.dialog.show.single": "Viste dialog til %s",
	...
	"commands.drop.no_loot_table.block": "Blok %s har ikke en skattetabel",
	...
	"commands.drop.success.single_with_table": "Smed %s %s fra skattetabel %s",
	...
	"commands.enchant.failed": "Intet ændret. Mål har enten ingen genstand i sine hænder eller fortryllelsen kunne ikke bliver tilføjet",
	...
	"commands.execute.blocks.toobig": "For mange blokke i det angivne område (maksimalt %s, men angav %s)",
	...
	"commands.execute.function.instantiationFailure": "Kunne ikke instantiere funktionen %s: %s",
	...
	"commands.fetchprofile.copy_component": "Kopier komponent",
	"commands.fetchprofile.copy_text": "Kopier %s",
	"commands.fetchprofile.entity.success": "Profil fundet for objekt %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Kunne ikke serialisere profil: %s",
	"commands.fetchprofile.give_item": "Giv genstand",
	"commands.fetchprofile.id.failure": "Kunne ikke finde profil for id %s",
	"commands.fetchprofile.id.success": "Profil fundet for id %s: %s",
	"commands.fetchprofile.name.failure": "Kunne ikke finde profil for navnet %s",
	"commands.fetchprofile.name.success": "Profil fundet for navnet %s: %s",
	"commands.fetchprofile.no_profile": "Objekt %s har ingen profil",
	"commands.fetchprofile.summon_mannequin": "Fremkald mannequin",
	"commands.fill.failed": "Ingen blokke blev fyldt",
	"commands.fill.success": "Fyldte %s blok(ke) succesfuldt",
	"commands.fill.toobig": "For mange blokke i det angivne område (maksimalt %s, men angav %s)",
	"commands.fillbiome.success": "Biomer indstillet mellem %s, %s, %s og %s, %s, %s",
	"commands.fillbiome.success.count": "%s biome indgang/indgange sat mellem %s, %s, %s og %s, %s, %s",
	"commands.fillbiome.toobig": "For mange blokke i det angivne rum (maksimalt %s, men angav %s)",
	...
	"commands.forceload.toobig": "For mange klodser i det angivne område (maksimalt %s, men angav %s)",
	"commands.function.error.argument_not_compound": "Ugyldig argumenttype: %s. Forventet sammensætning",
	"commands.function.error.missing_argument": "Mangler argument %[2]s til funktionen %[1]s",
	"commands.function.error.missing_arguments": "Mangler argumenter til funktion %s",
	"commands.function.error.parse": "Under instansiering af makro %s: kommando '%s' forårsagede fejl: %s",
	"commands.function.instantiationFailure": "Kunne ikke instantiere funktionen %s: %s",
	"commands.function.result": "Funktion %s returnerede %s",
	"commands.function.scheduled.multiple": "Kører funktionerne %s",
	"commands.function.scheduled.no_functions": "Kan ikke finde nogen funktioner med navnet %s",
	"commands.function.scheduled.single": "Kører funktion %s",
	"commands.function.success.multiple": "Udførte %s kommando(er) fra %s funktioner",
	"commands.function.success.multiple.result": "Udførte %s funktioner",
	"commands.function.success.single": "Udførte %s kommando(er) fra funktion '%s'",
	"commands.function.success.single.result": "Funktion '%[2]s' returnerede %[1]s",
	...
	"commands.kick.owner.failed": "Serverejeren kan ikke smides ud i et LAN-spil",
	"commands.kick.singleplayer.failed": "Kan ikke smide ud i et offline singleplayer spil",
	...
	"commands.locate.poi.not_found": "Kunne ikke finde et interessepunkt af typen \"%s\" indenfor en rimelig afstand",
	"commands.locate.poi.success": "Den nærmeste %s er ved %s (%s blokke væk)",
	"commands.locate.structure.invalid": "Der er ingen struktur af typen \"%s\"",
	...
	"commands.op.failed": "Intet ændret. Spilleren er allerede en operatør",
	"commands.op.success": "Gjorde %s til en server operatør",
	"commands.pardon.failed": "Intet ændret. Spilleren er ikke bandlyst",
	"commands.pardon.success": "Fjernede bandlysning %s",
	"commands.pardonip.failed": "Intet ændret. Den IP er ikke bandlyst",
	...
	"commands.place.structure.invalid": "Der er ingen struktur af typen \"%s\"",
	...
	"commands.profile_fetch.copy_component": "Kopier komponent",
	"commands.profile_fetch.failed_to_serialize": "Kunne ikke serialisere profil: %s",
	"commands.profile_fetch.give_item": "Giv genstand",
	"commands.profile_fetch.id.failure": "Kunne ikke finde profil for ID %s",
	"commands.profile_fetch.id.success": "Profil fundet for ID %s: %s",
	"commands.profile_fetch.name.failure": "Kunne ikke finde profil for navnet %s",
	"commands.profile_fetch.name.success": "Profil fundet for navnet %s: %s",
	"commands.publish.alreadyPublished": "Multiplayer spil er allerede hostet på port %s",
	"commands.publish.alreadyPublished.lan": "Lokalt spil hostes allerede på port %s",
	"commands.publish.alreadyPublished.online": "Et online spil er allerede hostet",
	"commands.publish.failed": "Kan ikke lave et lokalt spil",
	"commands.publish.started": "Lokalt spil hostet på port %s",
	"commands.publish.started.lan": "Lokalt spil hostet på port %s",
	"commands.publish.started.online": "Online spil hostes",
	"commands.publish.success": "Multiplayer spil er nu hostet på port %s",
	"commands.random.error.range_too_large": "Rækkevidden for den tilfældige værdi må højst være 2147483646",
	"commands.random.error.range_too_small": "Rækkevidden for den tilfældige værdi skal mindst være 2",
	"commands.random.reset.all.success": "Nulstillede %s tilfældige sekvens(er)",
	"commands.random.reset.success": "Nulstillede tilfældig sekvens %s",
	"commands.random.roll": "%s rullede %s (fra %s til %s)",
	"commands.random.sample.success": "Tilfældig værdi: %s",
	"commands.recipe.give.failed": "Ingen nye opskrifter lært",
	"commands.recipe.give.success.multiple": "Oplåste %s opskrift(er) for %s spillere",
	"commands.recipe.give.success.single": "Oplåste %s opskrift(er) for %s",
	"commands.recipe.take.failed": "Ingen opskrifter kunne blive glemt",
	"commands.recipe.take.success.multiple": "Tog %s opskrift(er) fra %s spillere",
	"commands.recipe.take.success.single": "Tog %s opskrift(er) fra %s",
	"commands.reload.failure": "Genindlæsning fejlede, beholder gammelt data",
	"commands.reload.success": "Genindlæser!",
	"commands.ride.already_riding": "%s rider allerede på %s",
	"commands.ride.dismount.success": "%s stoppede med at ride på %s",
	...
	"commands.ride.mount.failure.loop": "Objektet kan ikke bestige sig selv eller nogen af sine passagerer",
	"commands.ride.mount.failure.wrong_dimension": "Kan ikke bestige objekt i en anden dimension",
	"commands.ride.mount.success": "%s begyndte at ride %s",
	"commands.ride.not_riding": "%s rider ikke på noget køretøj",
	"commands.rotate.success": "Roteret %s",
	...
	"commands.schedule.cleared.success": "Fjernede %s tidsplan(er) med ID %s",
	"commands.schedule.created.function": "Planlagt funktion '%s' om '%s' tik(s) ved spilletidspunkt %s",
	"commands.schedule.created.tag": "Planlagt mærke '%s' om %s tik(s) ved spilletidspunkt %s",
	"commands.schedule.macro": "Kan ikke planlægge en makro",
	...
	"commands.scoreboard.objectives.display.alreadyEmpty": "Intet ændret. Det målvisningsfelt er allerede tomt",
	"commands.scoreboard.objectives.display.alreadySet": "Intet ændret. Det målvisningsfelt viser allerede den målsætning",
	...
	"commands.scoreboard.objectives.list.success": "Der er %s målsætning(er): %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Automatisk visning for målet %s er blevet deaktiveret",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Automatisk visning for målet %s er blevet aktiveret",
	"commands.scoreboard.objectives.modify.displayname": "Skiftede visningsnavnet af %s til %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Ryddede standardnummerformat for målet %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Ændrede standardnummerformat for målet %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Visningsnavnet for %s objekter i %s er blevet ryddet",
	"commands.scoreboard.players.display.name.clear.success.single": "Ryddede visningsnavnet for %s i %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Ændrede visningsnavnet til %s for %s objekter i %s",
	"commands.scoreboard.players.display.name.set.success.single": "Ændrede visningsnavnet til %s for %s i %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Ryddede nummerformatet for %s objekter i %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Ryddede nummerformatet for %s i %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Ændrede nummerformatet for %s objekter i %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Ændrede nummerformatet for %s i %s",
	"commands.scoreboard.players.enable.failed": "Intet ændret. Den udløser er allerede aktiveret",
	...
	"commands.scoreboard.players.list.entity.success": "%s har %s score(r):",
	"commands.scoreboard.players.list.success": "Der er %s registrerede objekt/objekter: %s",
	...
	"commands.setidletimeout.success": "Spillerens timeout for inaktivitet er nu %s minut(ter)",
	"commands.setidletimeout.success.disabled": "Spillerens timeout for inaktivitet er nu deaktiveret",
	"commands.setworldspawn.failure.not_overworld": "Kan kun sætte verdens startpunkt for oververdenen",
	"commands.setworldspawn.success": "Satte verdens startpunkt til %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Satte verdens startpunkt til %s, %s, %s [%s, %s] i %s",
	"commands.spawnpoint.success.multiple": "Sæt startpunkt til %s, %s, %s [%s] i %s for %s spillere",
	"commands.spawnpoint.success.multiple.new": "Sæt startpunkt til %s, %s, %s [%s, %s] i %s for %s spillere",
	"commands.spawnpoint.success.single": "Satte startpunkt til %s, %s, %s [%s] i %s for %s",
	"commands.spawnpoint.success.single.new": "Satte startpunkt til %s, %s, %s [%s, %s] i %s for %s",
	"commands.spectate.cannot_spectate": "%s kan ikke observeres",
	...
	"commands.spreadplayers.failed.entities": "Kunne ikke sprede %s objekt/objekter rundt %s, %s (for mange objekter for pladsen - forsøg en spredning ved maksimalt %s)",
	"commands.spreadplayers.failed.invalid.height": "Ugyldig maxHeight %s; forventes højere end verdens minimumshøjde %s",
	"commands.spreadplayers.failed.teams": "Kunne ikke sprede %s hold rundt %s, %s (for mange objekter for pladsen - forsøg en spredning ved maksimalt %s)",
	"commands.spreadplayers.success.entities": "Spred %s objekt/objekter rundt %s, %s med en gennemsntlig afstand på %s blok(ke)",
	"commands.spreadplayers.success.teams": "Spred %s hold rundt %s, %s med en gennemsnitlig afstand på %s blok(ke)",
	...
	"commands.stopwatch.already_exists": "Stopuret '%s' eksisterer allerede",
	"commands.stopwatch.create.success": "Oprettede stopuret '%s'",
	"commands.stopwatch.does_not_exist": "Stopuret '%s' eksisterer ikke",
	"commands.stopwatch.query": "Stopuret '%s' har kørt i %ss",
	"commands.stopwatch.remove.success": "Fjernede stopuret '%s'",
	"commands.stopwatch.restart.success": "Genstartede stopuret '%s'",
	"commands.summon.failed": "Ikke i stand til at påkalde objekt",
	"commands.summon.failed.peaceful": "Monstre kan ikke fremkaldes i fredelig sværhedsgrad",
	...
	"commands.swing.failed.notliving": "Ingen levende objekter blev fundet til at svinge",
	"commands.swing.success.multiple": "Fik %s objekter til at svinge deres arme",
	"commands.swing.success.single": "Fik %s til at svinge en arm",
	...
	"commands.team.empty.success": "Fjernede %s medlem(mer) fra hold %s",
	"commands.team.empty.unchanged": "Intet ændret. Dette hold er allerede tomt",
	...
	"commands.team.list.members.success": "Holdet %s har %s medlem(mer): %s",
	...
	"commands.team.option.collisionRule.unchanged": "Intet ændret. Kollisionsregl er allerede den værdi",
	"commands.team.option.color.clear.success": "Nulstillede farven for hold %s",
	"commands.team.option.color.success": "Opdaterede farven for hold %s til %s",
	"commands.team.option.color.unchanged": "Intet ændret. Det hold har allerede den farve",
	"commands.team.option.deathMessageVisibility.success": "Dødsbeskeder synlighed for hold %s er nu \"%s\"",
	"commands.team.option.deathMessageVisibility.unchanged": "Intet ændret. Dødsbeskedsynlighed er allerede den værdi",
	"commands.team.option.friendlyfire.alreadyDisabled": "Intet ændret. Egenbeskydning er allerede slået fra for det hold",
	"commands.team.option.friendlyfire.alreadyEnabled": "Intet ændret. Egenbeskydning er allerede slået til for det hold",
	...
	"commands.team.option.name.unchanged": "Intet ændret. Det hold har allerede det navn",
	"commands.team.option.nametagVisibility.success": "Navneskilt synlighed for hold %s er nu \"%s\"",
	"commands.team.option.nametagVisibility.unchanged": "Intet ændret. Navneskilt synlighed er allerede den værdi",
	"commands.team.option.prefix.success": "Hold præfiks sat til %s",
	"commands.team.option.seeFriendlyInvisibles.alreadyDisabled": "Intet ændret. Det hold kan allerede ikke se usynlige holdkammerater",
	"commands.team.option.seeFriendlyInvisibles.alreadyEnabled": "Intet ændret. Det hold kan allerede se usynlige holdkammerater",
	...
	"commands.test.batch.starting": "Starter miljø %s batch %s",
	"commands.test.clear.error.no_tests": "Kunne ikke finde nogen tests at rydde",
	"commands.test.clear.success": "Ryddede %s struktur(er)",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Klik for at kopiere til udklipsholder",
	"commands.test.create.success": "Oprettede testopsætning for test %s",
	"commands.test.error.no_test_containing_pos": "Kan ikke finde en testinstans der indeholder %s, %s, %s",
	"commands.test.error.no_test_instances": "Fandt ingen testinstanser",
	"commands.test.error.non_existant_test": "Test %s kunne ikke findes",
	"commands.test.error.structure_not_found": "Teststruktur %s kunne ikke findes",
	"commands.test.error.test_instance_not_found": "Objekt for testinstansblok kunne ikke findes",
	"commands.test.error.test_instance_not_found.position": "Objekt for testinstansblok kunne ikke blive fundet for testen ved %s, %s, %s",
	"commands.test.error.too_large": "Strukturstørrelsen skal være mindre end %s blokke lang hver akse",
	"commands.test.locate.done": "Lokalisering fuldført: fandt %s struktur(er)",
	"commands.test.locate.found": "Fandt struktur ved: %s (afstand: %s)",
	"commands.test.locate.started": "Påbegyndte lokaliseringen af teststrukturer. Det kan tage et stykke tid...",
	"commands.test.no_tests": "Ingen tests at køre",
	"commands.test.relative_position": "Position relativ til %s: %s",
	"commands.test.reset.error.no_tests": "Kunne ikke finde nogen tests at nulstille",
	"commands.test.reset.success": "Nulstil %s struktur(er)",
	"commands.test.run.no_tests": "Ingen tests fundet",
	"commands.test.run.running": "Kører %s test(e)...",
	"commands.test.summary": "Spiltest færdig! %s test(e) blev kørt",
	"commands.test.summary.all_required_passed": "Alle nødvendige tests bestået :)",
	"commands.test.summary.failed": "%s nødvendige test(e) fejlede :(",
	"commands.test.summary.optional_failed": "%s valgfrie test(s) fejlede",
	"commands.tick.query.percentiles": "Percentiler: P50: %sms P95: %sms P99: %sms. Prøve: %s",
	"commands.tick.query.rate.running": "Tikratemål: %s pr. sekund.\nGennemsnitlig tid pr. tik: %sms (mål: %sms)",
	"commands.tick.query.rate.sprinting": "Tikratemål: %s pr. sekund (ignoreret, kun reference).\nGennemsnitlig tid pr. tik: %sms",
	"commands.tick.rate.success": "Satte måltickraten til %s per sekund",
	"commands.tick.sprint.report": "Sprint fuldført med %s tiks pr. sekund, eller %s ms pr. tik",
	"commands.tick.sprint.stop.fail": "Ingen tikspring i gang",
	"commands.tick.sprint.stop.success": "Afbrød det aktuelle tiksprint",
	"commands.tick.status.frozen": "Spillet er frosset",
	"commands.tick.status.lagging": "Spillet kører, men kan ikke følge med den målsatte tikrate",
	"commands.tick.status.running": "Spillet kører normalt",
	"commands.tick.status.sprinting": "Spillet sprinter",
	"commands.tick.step.fail": "Kunne ikke skridte spillet - spillet skal være frosset først",
	"commands.tick.step.stop.fail": "Ingen tikskridt i gang",
	"commands.tick.step.stop.success": "Afbrød det aktuelle tikskridt",
	"commands.tick.step.success": "Stiger %s tik(s)",
	"commands.time.no_default_clock": "Der findes intet standardur i dimension %s",
	"commands.time.no_time_marker_found": "Tidsmarkøren %s eksisterer ikke for ur %s",
	"commands.time.pause": "Pausede ur %s",
	"commands.time.query": "Klokken er %s",
	"commands.time.query.absolute": "Uret %s er på %s tik(s)",
	"commands.time.query.gametime": "Spiltiden er %s tik(s)",
	"commands.time.query.timeline": "Tidslinjen %s er på %s tik(s)",
	"commands.time.query.timeline.repetitions": "Tidslinjen %s har passeret %s gentagelse(r)",
	"commands.time.rate": "Uret %s vil nu gå %sx hurtigere end normalt",
	"commands.time.resume": "Genoptog ur %s",
	"commands.time.set": "Satte tiden til %s",
	"commands.time.set.absolute": "Satte %s til %s tik(s)",
	"commands.time.set.time_marker": "Satte %s som tidsmarkør %s",
	"commands.time.wrong_timeline_for_clock": "Tidslinjen %s er ikke gyldig for uret %s",
	...
	"commands.transfer.error.no_players": "Mindst en spiller skal specificeres for overførsel",
	"commands.transfer.success.multiple": "Overfører %s spillere til %s:%s",
	"commands.transfer.success.single": "Overfører %s til %s:%s",
	...
	"commands.unpublish.notPublished": "Intet multiplayer spil er tilgængeligt",
	"commands.unpublish.success": "Multiplayer spillet er nu utilgængeligt",
	...
	"commands.waypoint.list.empty": "Ingen rutepunkter i %s",
	"commands.waypoint.list.success": "%s rutepunkt(er) i %s: %s",
	"commands.waypoint.modify.color": "Rutepunktsfarve er nu %s",
	"commands.waypoint.modify.color.reset": "Nulstil rutepunktsfarve",
	"commands.waypoint.modify.style": "Rutepunktsstil ændret",
	...
	"commands.whitelist.list": "Der er %s whitelistet spiller(e): %s",
	...
	"commands.worldborder.center.failed": "Intet ændret. Verdensgrænsen er allerede centreret der",
	"commands.worldborder.center.success": "Sat midten af verdengrænsen til %s, %s",
	"commands.worldborder.damage.amount.failed": "Intet ændret. Verdensgrænseskadebufferen er allerede den mændge",
	"commands.worldborder.damage.amount.success": "Sæt verdengrænsens skade til %s per blok hvert sekund",
	"commands.worldborder.damage.buffer.failed": "Intet ændret. Verdensgrænseskadebufferen er allerede den afstand",
	"commands.worldborder.damage.buffer.success": "Sæt verdensgrænsens skade buffer til %s blok(ke)",
	"commands.worldborder.get": "Verdengrænsen er i øjeblikket %s blok(ke) bred",
	...
	"commands.worldborder.set.failed.nochange": "Intet ændret. Verdensgrænsen er allerede den størrelse",
	...
	"commands.worldborder.set.immediate": "Sat verdengrænsen til %s blok(ke) bred",
	"commands.worldborder.set.shrink": "Formindsker verdengrænsen til %s blok(ke) bred over %s sekund(er)",
	"commands.worldborder.warning.distance.failed": "Intet ændret. Verdensgrænseadvarslen er allerede den afstand",
	"commands.worldborder.warning.distance.success": "Sæt verdensgrænsens advarselsafstand til %s blok(ke)",
	"commands.worldborder.warning.time.failed": "Intet ændret. Verdensgrænseadvarslen er allerede den tidsmængde",
	"commands.worldborder.warning.time.success": "Sæt verdensgrænsens advarselstid til %s sekund(er)",
	...
	"component.profile.dynamic": "Dynamisk",
	...
	"connect.failed.transfer": "Forbindelsen mislykkedes under overførslen til serveren",
	"connect.joining": "Tilslutter verden...",
	"connect.negotiating": "Forhandler...",
	"connect.p2p.establishing": "Opretter forbindelse...",
	"connect.p2p.failed.generic": "Kunne ikke oprette forbindelse til spilleren",
	"connect.p2p.failed.signaling": "Det er ikke muligt at oprette forbindelse lige nu.\nPrøv igen senere.",
	"connect.p2p.failed.timeout": "Forbindelsesanmodning udløb",
	"connect.p2p.failed.unreachable": "Spilleren kan ikke nås",
	"connect.reconfiging": "Rekonfigurerer...",
	"connect.reconfiguring": "Rekonfigurerer...",
	"connect.transferring": "Overfører til ny server...",
	"container.barrel": "Tønde",
	"container.beacon": "Signallys",
	"container.beehive.bees": "Bier: %s/%s",
	"container.beehive.honey": "Honning: %s / %s",
	...
	"container.enchant.level.many": "%s fortryllelsesniveauer",
	...
	"container.upgrade.missing_template_tooltip": "Tilføj smedeskabelon",
	"controls.keybinds": "Tastebindinger...",
	"controls.keybinds.duplicateKeybinds": "Denne tast bruges også til:\n%s",
	...
	"createWorld.customize.buffet.search": "Søg...",
	"createWorld.customize.buffet.title": "Enkeltbiome tilpasning",
	...
	"createWorld.customize.presets.list": "Alternativt, her er nogle vi lavede tidligere!",
	...
	"credits_and_attribution.screen.title": "Medvirkende og tilskrivning",
	"dataPack.bundle.description": "Slår eksperimentelt bundt-genstand til",
	"dataPack.bundle.name": "Bundter",
	"dataPack.locator_bar.description": "Vis retningen for andre spillere i multiplayer",
	"dataPack.locator_bar.name": "Lokaliseringsbar",
	"dataPack.minecart_improvements.description": "Forbedret minevognsbevægelser",
	"dataPack.minecart_improvements.name": "Minevognsforbedringer",
	"dataPack.redstone_experiments.description": "Eksperimentelle redstoneændringer",
	"dataPack.redstone_experiments.name": "Redstone eksperimenter",
	"dataPack.title": "Vælg datapakker",
	"dataPack.trade_rebalance.description": "Opdaterede handler for landsbyboerer",
	"dataPack.trade_rebalance.name": "Rebalancering af landsbyboerhandel",
	"dataPack.update_1_20.description": "Nye funktioner og indhold i Minecraft 1.20",
	"dataPack.update_1_20.name": "Opdatering 1.20",
	"dataPack.update_1_21.description": "Nye funktioner og indhold i Minecraft 1.21",
	"dataPack.update_1_21.name": "Opdatering 1.21",
	...
	"dataPack.winter_drop.description": "Nye funktioner samt indhold for vinterdroppet",
	"dataPack.winter_drop.name": "Vinter drop",
	"datapackFailure.safeMode": "Fejlsikret tilstand",
	"datapackFailure.safeMode.failed.description": "Denne verden indeholder ugyldigt eller beskadiget gemt data.",
	"datapackFailure.safeMode.failed.title": "Kunne ikke indlæse verden i fejlsikret tilstand.",
	"datapackFailure.title": "Fejl i de nuværende valgte datapakke(r) forhindrede verdenen i at indlæse.\nDu kan enten forsøge at indlæse den med kun standard datapakken (\"fejlsikret tilstand\"), eller gå tilbage til hovedmenuen og fikse det manuelt.",
	...
	"death.attack.dragonBreath": "%[1]s blev stegt i dragens ånde",
	"death.attack.dragonBreath.player": "%[1]s blev stegt i dragens ånde af %[2]s",
	...
	"death.attack.fallingStalactite.player": "%[1]s blev spiddet af en faldende stalaktit i kampen mod %[2]s",
	...
	"death.attack.fireworks.player": "%[1]s gik ud med et brag i kampen mod %[2]s",
	...
	"death.attack.genericKill": "%[1]s blev dræbt",
	"death.attack.genericKill.player": "%[1]s blev dræbt i kampen mod %[2]s",
	...
	"death.attack.inFire.player": "%[1]s gik ind i ild i kampen mod %[2]s",
	"death.attack.inWall": "%[1]s blev most i en væg",
	"death.attack.inWall.player": "%[1]s blev most i en væg i kampen mod %[2]s",
	...
	"death.attack.lightningBolt.player": "%[1]s blev ramt af lyn i kampen mod %[2]s",
	"death.attack.mace_smash": "%[1]s blev knust af %[2]s",
	"death.attack.mace_smash.item": "%[1]s blev knust af %[2]s med %[3]s",
	"death.attack.magic": "%[1]s blev dræbt af magi",
	"death.attack.magic.player": "%[1]s blev dræbt af magi i et forsøg på at undslippe %[2]s",
	"death.attack.message_too_long": "Faktisk, så var beskeden for lang til at levere fuldt ud. Beklager! Her er en forkortet version: %s",
	...
	"death.attack.outsideBorder": "%[1]s forlod denne verdens grænser",
	"death.attack.outsideBorder.player": "%[1]s forlod denne verdens grænser i kampen mod %[2]s",
	...
	"death.attack.spear": "%[1]s blev spiddet af %[2]s",
	"death.attack.spear.item": "%[1]s blev spiddet af %[2]s ved hjælp af %[3]s",
	...
	"death.attack.starve.player": "%[1]s sultede ihjel, i kamp mod %[2]s",
	...
	"death.attack.sulfurCubeHot": "%[1]s døde, fordi det ikke kun er gulvet, der er lava",
	"death.attack.sulfurCubeHot.player": "%[2]s viste %[1]s, at det ikke kun er gulvet, der er lava",
	"death.attack.sweetBerryBush": "%[1]s blev stukket ihjel af en sød bærbusk",
	"death.attack.sweetBerryBush.player": "%[1]s blev stukket ihjel af en sød bærbusk, i forsøget på at undslippe %[2]s",
	"death.attack.thorns": "%[1]s blev dræbt i forsøget på at skade %[2]s",
	"death.attack.thorns.item": "%[1]s blev dræbt af %[3]s i forsøget på at skade %[2]s",
	...
	"deathScreen.spectate": "Observer verden",
	...
	"debug.chunk_boundaries.off": "Klodsgrænser: skjult",
	"debug.chunk_boundaries.on": "Klodsgrænser: vist",
	"debug.clear_chat.help": "F3 + D = Ryd chat",
	"debug.copy_location.help": "F3 + C = kopier lokation som en /tp kommando, eller hold nede i 10 sekunder for at lave et spilnedbrud",
	...
	"debug.crash.message.rebindable": "%s + %s er holdt nede. Dette vil foråsage et spilnedbrud med mindre du giver slip.",
	"debug.crash.warning": "Spilnedbrud om %s...",
	"debug.creative_spectator.error": "Kunne ikke skifte spiltilstand; ingen tilladelse",
	"debug.creative_spectator.help": "F3 + N = Veksel forrige spiltilstand <-> tilskuer",
	"debug.dump_dynamic_textures": "Gemte dynamiske teksturer i %s",
	"debug.dump_dynamic_textures.help": "F3 + S = Gem dynamiske teksturer",
	"debug.entry.always": "Altid",
	"debug.entry.currently.alwaysOn": "%s: i øjeblikket altid på",
	"debug.entry.currently.inF3": "%s: i øjeblikket kun i F3",
	"debug.entry.currently.inOverlay": "%s: i øjeblikket kun i fejlfindingsoverlay",
	"debug.entry.currently.never": "%s: i øjeblikket slået fra",
	"debug.entry.f3": "I F3",
	"debug.entry.overlay": "I overlay",
	...
	"debug.options.category.renderer": "Fejlfindingsrenderere",
	"debug.options.category.text": "Fejlfindingsskærmtekst",
	"debug.options.help": "F3 + F6 = Rediger fejlfindingsindstillinger",
	"debug.options.notAllowed.tooltip": "Ikke synlig når fejlfindingsinformation er reduceret",
	"debug.options.profile.default": "Standardprofil",
	"debug.options.profile.performance": "Ydelsesprofil",
	"debug.options.search": "Søg...",
	"debug.options.title": "Fejlfindingsindstillinger",
	"debug.options.warning": "Disse muligheder er kun til testformål. De kan gøre din computer langsommere, få spillet til at nedbryde eller spise din kæledyrssten.",
	...
	"debug.profiling.start.rebindable": "Profilering startede for %s sekunder. Brug %s + %s for at stoppe tidligt",
	...
	"debug.reload_resourcepacks.help": "F3 + T = Genindlæs ressourcepakker",
	"debug.reload_resourcepacks.message": "Genindlæs ressourcepakker",
	"debug.show_hitboxes.help": "F3 + B = Vis hitbokse",
	"debug.show_hitboxes.off": "Hitbokse: skjulte",
	"debug.show_hitboxes.on": "Hitbokse: vist",
	"debug.version.header": "Information om klientversion:",
	"debug.version.help": "F3 + V = Information om klientversion",
	...
	"disconnect.ignoring_status_request": "Ignorerer status anmodning",
	...
	"disconnect.loginFailedInfo.userBanned": "Du er bandlyst fra at spille online",
	"disconnect.lost": "Forbindelse tabt",
	"disconnect.packetError": "Fejl i netværksprotokol",
	"disconnect.spam": "Blev smidt ud pga. spamming",
	"disconnect.timeout": "Udløbet",
	"disconnect.transfer": "Overført til en anden server",
	"disconnect.unknownHost": "Ukendt vært",
	"download.pack.failed": "%s ud af %s pakkedownloads mislykkedes",
	"download.pack.progress.bytes": "Fremgang: %s (samlet størrelse ukendt)",
	"download.pack.progress.percent": "Status: %s%%",
	"download.pack.title": "Downloader resourcepakke %s/%s",
	"editGamerule.default": "Standard: %s",
	"editGamerule.inGame.button": "Rediger spilleregler...",
	"editGamerule.inGame.disabled.tooltip": "Opdatering af spilleregler kræver operatørtilladelser.",
	"editGamerule.inGame.discardChanges.message": "Er du sikker på, at du vil kassere dine afventende ændringer i spillereglerne?",
	"editGamerule.inGame.discardChanges.title": "Spilleregel ændres",
	"editGamerule.inGame.downloadingGamerules": "Indhenter spilleregler...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Nautils’ ånde",
	...
	"effect.minecraft.infested": "Inficeret",
	...
	"effect.minecraft.oozing": "Siver",
	"effect.minecraft.poison": "Gift",
	"effect.minecraft.raid_omen": "Plyndringstegn",
	...
	"effect.minecraft.trial_omen": "Prøvelsestegn",
	"effect.minecraft.unluck": "Uheld",
	"effect.minecraft.water_breathing": "Gæller",
	"effect.minecraft.weakness": "Svaghed",
	"effect.minecraft.weaving": "Vævning",
	"effect.minecraft.wind_charged": "Vindladet",
	...
	"enchantment.minecraft.breach": "Gennembrud",
	"enchantment.minecraft.channeling": "Kanalisering",
	"enchantment.minecraft.density": "Densitet",
	...
	"enchantment.minecraft.lunge": "Fremstød",
	...
	"enchantment.minecraft.sweeping_edge": "Større klinge",
	...
	"enchantment.minecraft.wind_burst": "Vindstød",
	"entity.minecraft.acacia_boat": "Akaciebåd",
	"entity.minecraft.acacia_chest_boat": "Akaciebåd med kiste",
	"entity.minecraft.allay": "Hjælpeånd",
	"entity.minecraft.area_effect_cloud": "Område effekt sky",
	"entity.minecraft.armadillo": "Bæltedyr",
	"entity.minecraft.armor_stand": "Brynjeholder",
	"entity.minecraft.arrow": "Pil",
	"entity.minecraft.axolotl": "Axolotl",
	"entity.minecraft.bamboo_chest_raft": "Bambusflåde med kiste",
	"entity.minecraft.bamboo_raft": "Bambusflåde",
	"entity.minecraft.bat": "Flagermus",
	"entity.minecraft.bee": "Bi",
	"entity.minecraft.birch_boat": "Birkebåd",
	"entity.minecraft.birch_chest_boat": "Birkebåd med kiste",
	"entity.minecraft.blaze": "Blaze",
	"entity.minecraft.block_display": "Blokfremviser",
	"entity.minecraft.boat": "Båd",
	"entity.minecraft.bogged": "Sumpskelet",
	"entity.minecraft.breeze": "Vindvæsen",
	"entity.minecraft.breeze_wind_charge": "Vindladning",
	"entity.minecraft.camel": "Kamel",
	"entity.minecraft.camel_husk": "Udtørret kamel",
	"entity.minecraft.cat": "Kat",
	"entity.minecraft.cave_spider": "Huleedderkop",
	"entity.minecraft.cherry_boat": "Kirsebærbåd",
	"entity.minecraft.cherry_chest_boat": "Kirsebærbåd med kiste",
	...
	"entity.minecraft.copper_golem": "Kobbergolem",
	"entity.minecraft.cow": "Ko",
	"entity.minecraft.creaking": "Knirken",
	"entity.minecraft.creaking_transient": "Knirken",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Mørk egetræsbåd",
	"entity.minecraft.dark_oak_chest_boat": "Mørk egetræsbåd med kiste",
	...
	"entity.minecraft.falling_block_type": "Faldende %s",
	...
	"entity.minecraft.happy_ghast": "Glad ghast",
	...
	"entity.minecraft.item_display": "Genstandsfremviser",
	"entity.minecraft.item_frame": "Genstandsramme",
	"entity.minecraft.jungle_boat": "Junglebåd",
	"entity.minecraft.jungle_chest_boat": "Junglebåd med kiste",
	"entity.minecraft.killer_bunny": "Dræberkaninen",
	"entity.minecraft.leash_knot": "Snorknude",
	"entity.minecraft.lightning_bolt": "Lyn",
	"entity.minecraft.lingering_potion": "Vedvarende eliksir",
	"entity.minecraft.llama": "Lama",
	"entity.minecraft.llama_spit": "Lamaspyt",
	"entity.minecraft.magma_cube": "Magmakube",
	"entity.minecraft.mangrove_boat": "Mangrovebåd",
	"entity.minecraft.mangrove_chest_boat": "Mangrovebåd med kiste",
	...
	"entity.minecraft.nautilus": "Nautil",
	"entity.minecraft.oak_boat": "Egetræsbåd",
	"entity.minecraft.oak_chest_boat": "Egetræsbåd med kiste",
	"entity.minecraft.ocelot": "Ozelot",
	"entity.minecraft.ominous_item_spawner": "Ildevarslende genstandsspawner",
	"entity.minecraft.painting": "Maleri",
	"entity.minecraft.pale_oak_boat": "Bleg egetræsbåd",
	"entity.minecraft.pale_oak_chest_boat": "Bleg egetræsbåd med kiste",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Udtørret skelet",
	...
	"entity.minecraft.splash_potion": "Sprøjtende eliksir",
	"entity.minecraft.spruce_boat": "Granbåd",
	"entity.minecraft.spruce_chest_boat": "Granbåd med kiste",
	"entity.minecraft.squid": "Blæksprutte",
	"entity.minecraft.stray": "Omstrejfer",
	"entity.minecraft.strider": "Lavavandrer",
	"entity.minecraft.sulfur_cube": "Svovlkube",
	"entity.minecraft.sulfur_cube.content": "Indeholder: %s",
	"entity.minecraft.tadpole": "Haletudse",
	"entity.minecraft.text_display": "Tekstfremviser",
	...
	"entity.minecraft.wind_charge": "Vindladning",
	...
	"entity.minecraft.zombie_nautilus": "Zombienautil",
	"entity.minecraft.zombie_villager": "Zombielandsbyboer",
	"entity.minecraft.zombified_piglin": "Zombificeret piglin",
	"entity.not_summonable": "Kan ikke fremkalde objekt af typen %s",
	"event.minecraft.raid": "Plyndring",
	"event.minecraft.raid.defeat": "Nederlag",
	"event.minecraft.raid.defeat.full": "Plyndring - Nederlag",
	"event.minecraft.raid.raiders_remaining": "Plyndrere tilbage: %s",
	"event.minecraft.raid.victory": "Sejr",
	"event.minecraft.raid.victory.full": "Plyndring - Sejr",
	"filled_map.buried_treasure": "Begravet skat kort",
	"filled_map.explorer_jungle": "Jungleopdagelseskort",
	"filled_map.explorer_swamp": "Sumpopdagelseskort",
	"filled_map.id": "ID #%s",
	"filled_map.level": "(Niveau %s/%s)",
	"filled_map.locked": "Låst",
	"filled_map.mansion": "Skovopdagelseskort",
	"filled_map.monument": "Havopdagelseskort",
	"filled_map.scale": "Skalering på 1:%s",
	"filled_map.trial_chambers": "Prøvelsesopdagelseskort",
	"filled_map.unknown": "Ukendt kort",
	"filled_map.village_desert": "Ørken landsbykort",
	"filled_map.village_plains": "Eng landsbykort",
	"filled_map.village_savanna": "Savanne landsbykort",
	"filled_map.village_snowy": "Sne landsbykort",
	"filled_map.village_taiga": "Tajga landsbykort",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Tillad nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Kontrollerer om spillere har tilladelse til at gå ind i nether eller ej.",
	"gamerule.allowFireTicksAwayFromPlayer": "Tik ild væk fra spillere",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Kontrollerer om ild og lava skal kunne tikke længere end 8 klodser væk fra en hvilken som helst spiller.",
	"gamerule.announceAdvancements": "Annoncer fremskridt",
	"gamerule.blockExplosionDropDecay": "I blokinteraktions-eksplosioner, vil ikke alle blokke smides",
	"gamerule.blockExplosionDropDecay.description": "Nogle af de tabte genstande fra blokke ødelagt af eksplosioner forårsaget af blokinterkationer går tabt i eksplosionen.",
	...
	"gamerule.commandBlocksEnabled": "Aktiver kommandoblokke",
	"gamerule.commandModificationBlockLimit": "Blokgrænse for modificerede kommandoer",
	"gamerule.commandModificationBlockLimit.description": "Antallet af blokke der kan ændres på én gang, med én kommando, såsom fyld eller klon.",
	"gamerule.disableElytraMovementCheck": "Deaktiver bevægelseskontrol for elytra",
	"gamerule.disablePlayerMovementCheck": "Deaktiver spillerbevægelsestjek",
	"gamerule.disableRaids": "Deaktiver plyndringer",
	"gamerule.doDaylightCycle": "Tiden på dagen går",
	"gamerule.doEntityDrops": "Smid objektudstyr",
	"gamerule.doEntityDrops.description": "Kontrollerer genstandstab fra minevogne (inklusiv taske), genstandsrammer, både, osv.",
	...
	"gamerule.doLimitedCrafting.description": "Hvis aktiveret, kan spillere kun fremstille oplåste opskrifter.",
	"gamerule.doMobLoot": "Smid væsen skatte",
	"gamerule.doMobLoot.description": "Kontrollerer ressourcedrops fra væsener, inklusiv erfaringskugler.",
	...
	"gamerule.doTileDrops.description": "Kontrollerer ressourcedrops fra blokke, inklusiv erfaringskugler.",
	"gamerule.doTraderSpawning": "Fremkald handelsrejsende",
	"gamerule.doVinesSpread": "Lianer spreder sig",
	"gamerule.doVinesSpread.description": "Kontrollerer om lianblokke spredes tilfældigt til tilgrænsende blokke. Påvirker ikke andre typer lianeblokke såsom grædende lianer, snoede lianer osv.",
	"gamerule.doWardenSpawning": "Fremkald vogtere",
	"gamerule.doWeatherCycle": "Opdater vejr",
	"gamerule.drowningDamage": "Drukningsskade",
	"gamerule.enableCommandBlocks": "Aktiver kommandoblokke",
	"gamerule.enderPearlsVanishOnDeath": "Kastede ender-perler forsvinder ved død",
	"gamerule.enderPearlsVanishOnDeath.description": "Om ender-perler kastet af en spiller forsvinder når den spiller dør.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Objekter med passagerer kan benytte portaler",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Tillad objekter med passagerer at teleportere gennem netherportaler, endportaler og end porte.",
	...
	"gamerule.globalSoundEvents.description": "Når bestemte spilbegivenheder sker, som f. eks. en boss fremkaldes, kan lyden høres overalt.",
	"gamerule.keepInventory": "Behold taske efter dødsfald",
	"gamerule.lavaSourceConversion": "Lava omdannes til kilde",
	"gamerule.lavaSourceConversion.description": "Når flydende lava bliver omringet på to sider af lavakilder, omdannes det til en kilde.",
	"gamerule.locatorBar": "Aktiver spiller-lokaliseringsbar",
	"gamerule.locatorBar.description": "Når aktiveret, vises en bar på skærmen der angiver andre spilleres retning.",
	...
	"gamerule.maxCommandForkCount": "Grænse for kommandokontekst",
	"gamerule.maxCommandForkCount.description": "Maksimal antal kontekser, der kan bruges af kommandoer som 'execute as'.",
	"gamerule.maxEntityCramming": "Objekt proppetærskel",
	"gamerule.minecartMaxSpeed": "Maks. hastighed for minevogn",
	"gamerule.minecartMaxSpeed.description": "Maksimal standardhastighed for en bevægende minevogn på land.",
	"gamerule.minecraft.elytra_movement_check": "Udfør bevægelseskontrol for elytra",
	"gamerule.minecraft.fire_spread_radius_around_player": "Ildspredningsradius",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Radiusen i blokke omkring en spiller, hvor ild kan sprede sig",
	"gamerule.minecraft.player_movement_check": "Udfør spillerbevægelsestjek",
	"gamerule.minecraft.raids": "Tillad plyndringer",
	"gamerule.minecraft.universal_anger.description": "Ophidsede neutrale væsener angriber hvilken som helst spiller i nærheden, ikke kun spilleren som ophidsede dem. Virker bedst hvis forgive_dead_players er deaktiveret.",
	"gamerule.mobExplosionDropDecay": "Ved væseneksplosioner, vil ikke alle blokke smides",
	"gamerule.mobExplosionDropDecay.description": "Nogle af de tabte genstande fra blokke, som er ødelagt af eksplosioner forsaget af væsener, går tabt i eksplosionen.",
	"gamerule.mobGriefing": "Tillad destruktive væsenhandlinger",
	"gamerule.naturalRegeneration": "Regenerer helbred",
	"gamerule.playersNetherPortalCreativeDelay": "Spillerens netherportal-forsinkelse i kreativ",
	"gamerule.playersNetherPortalCreativeDelay.description": "Tid (i tiks), som en kreativ-spiller behøver at stå i en netherportal før de ændrer dimensioner.",
	"gamerule.playersNetherPortalDefaultDelay": "Spillerens netherportal-forsinkelse i ikke-kreativ",
	"gamerule.playersNetherPortalDefaultDelay.description": "Tid (i tiks), som en ikke-kreativ spiller behøver at stå i en netherportal før de ændrer dimensioner.",
	...
	"gamerule.projectilesCanBreakBlocks": "Projektiler kan ødelægge blokke",
	"gamerule.projectilesCanBreakBlocks.description": "Bestemmer, om projektiler kan ødelægge projektil-destruerbare blokke.",
	"gamerule.pvp": "Aktiver pvp",
	"gamerule.pvp.description": "Kontrollerer om spillere må skade andre spillere eller ej.",
	"gamerule.randomTickSpeed": "Tilfældig tikhastighed",
	"gamerule.reducedDebugInfo": "Reducer fejlfindingsinformation",
	"gamerule.reducedDebugInfo.description": "Begrænser indholdet af fejlsøgningsskærmen.",
	"gamerule.sendCommandFeedback": "Send kommando-tilbagemeldinger",
	"gamerule.showDeathMessages": "Vis dødsbeskeder",
	"gamerule.snowAccumulationHeight": "Sneakkumulationshøjde",
	"gamerule.snowAccumulationHeight.description": "Når det sner, dannes der lag af sne på jorden op til højst dette antal lag.",
	"gamerule.spawnChunkRadius": "Startpunkts-klodsradius",
	"gamerule.spawnChunkRadius.description": "Mængden af klodser som forbliver indlæst omkring oververdenens startpunkt.",
	"gamerule.spawnMonsters": "Fremkald monstre",
	"gamerule.spawnMonsters.description": "Kontrollerer om monstre naturligt fremkaldes eller ej.",
	"gamerule.spawnRadius": "Radius for genoplivelsesområde",
	"gamerule.spawnRadius.description": "Kontrollerer størrelsen på området omkring startpunktet, som spillere kan spawne i.",
	"gamerule.spawnerBlocksEnabled": "Aktiver spawnerblokke",
	"gamerule.spectatorsGenerateChunks": "Tillad tilskuere at generere terræn",
	"gamerule.tntExplodes": "Tillad TNT at blive aktiveret og eksplodere",
	"gamerule.tntExplosionDropDecay": "Ved TNT-ekplosioner, vil ikke alle blokke smides",
	"gamerule.tntExplosionDropDecay.description": "Nogle af de tabte genstande fra blokke ødelagt af eksplosioner forårsaget af TNT går tabt i eksplosionen.",
	...
	"gamerule.waterSourceConversion": "Vand omdannes til kilde",
	"gamerule.waterSourceConversion.description": "Når flydende vand bliver omringet på to sider af vandkilder, omdannes det til en kilde.",
	...
	"gui.abuseReport.attestation": "Ved at indsende denne rapport bekræfter du, at de oplysninger, du har givet, er nøjagtige og fuldstændige efter bedste evne.",
	"gui.abuseReport.comments": "Kommentarer",
	"gui.abuseReport.describe": "Ved at dele detaljer, vil du hjælpe os med at træffe en velinformeret beslutning.",
	"gui.abuseReport.discard.content": "Hvis du afslutter, vil du miste denne rapport og dine kommentarer.\nEr du sikker på du vil afslutte?",
	"gui.abuseReport.discard.discard": "Forlad og kassér rapport",
	"gui.abuseReport.discard.draft": "Gem som udkast",
	"gui.abuseReport.discard.return": "Fortsæt redigering",
	"gui.abuseReport.discard.title": "Kasser rapport og kommentarer?",
	"gui.abuseReport.draft.content": "Vil du fortsætte med at redigere den eksisterende rapport, eller vil du kassere den og oprette en ny?",
	"gui.abuseReport.draft.discard": "Kassér",
	"gui.abuseReport.draft.edit": "Fortsæt redigering",
	"gui.abuseReport.draft.quittotitle.content": "Vil du fortsætte med at redigere den eller kassere den?",
	"gui.abuseReport.draft.quittotitle.title": "Du har en chatrapport kladde der vil gå tabt, hvis du afslutter",
	"gui.abuseReport.draft.title": "Rediger udkast af chatrapport?",
	"gui.abuseReport.error.title": "Problem med at indsende din rapport",
	"gui.abuseReport.message": "Hvor observerede du den dårlige opførsel?\nDette vil hjælpe os med at undersøge din sag.",
	"gui.abuseReport.more_comments": "Beskriv venligst hvad der skete:",
	"gui.abuseReport.name.comment_box_label": "Beskriv venligst, hvorfor du vil rapportere dette navn:",
	"gui.abuseReport.name.reporting": "Du rapporterer \"%s\".",
	"gui.abuseReport.name.title": "Rapporter upassende spillernavn",
	"gui.abuseReport.observed_what": "Hvorfor rapporterer du dette?",
	"gui.abuseReport.read_info": "Lær omkring rapportering",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Æreskrænkelse",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Nogen skader dit eller andres omdømme, f.eks. ved at dele falske oplysninger med det formål at udnytte eller vildlede andre.",
	"gui.abuseReport.reason.description": "Beskrivelse:",
	"gui.abuseReport.reason.false_reporting": "Falsk rapportering",
	"gui.abuseReport.reason.generic": "Jeg vil gerne rapportere dem",
	"gui.abuseReport.reason.generic.description": "Jeg er irriteret på dem / de har gjort noget, jeg ikke kan lide.",
	"gui.abuseReport.reason.harassment_or_bullying": "Chikane eller mobning",
	"gui.abuseReport.reason.harassment_or_bullying.description": "Nogen udskammer, angriber, eller mobber dig eller en anden. Dette inkludere også når nogen gentageligt prøver at kontakte dig eller en anden uden samtykke eller opslår privat personlig information om dig eller en anden uden samtykke (\"doxing\").",
	...
	"gui.abuseReport.reason.imminent_harm": "Trussel om skade på andre",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Selvskade eller selvmord",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Seksuelt upassende",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Skins, der er grafiske af natur i relation til seksuelle handlinger, kønsorganer og seksuel vold.",
	"gui.abuseReport.reason.terrorism_or_violent_extremism": "Terrorisme eller voldelig ekstremisme",
	"gui.abuseReport.reason.terrorism_or_violent_extremism.description": "Nogen taler om, fremmer eller truer med at begå terrorhandlinger eller voldelig ekstremisme for politiske, religiøse, ideologiske, eller andre grunde.",
	"gui.abuseReport.reason.title": "Vælg rapporteringskategori",
	"gui.abuseReport.report_sent_msg": "Vi har modtaget din rapport succesfuldt. Tak!\n\nVores hold vil gennemgå den snarest muligt.",
	"gui.abuseReport.select_reason": "Vælg rapporteringskategori",
	"gui.abuseReport.send": "Send rapport",
	"gui.abuseReport.send.comment_too_long": "Forkort venligst kommentaren",
	"gui.abuseReport.send.error_message": "En fejl opstod under afsendelsen af din rapport:\n'%s'",
	...
	"gui.abuseReport.send.json_error": "Stødte på misdannet data under indsendingen af din rapport.",
	"gui.abuseReport.send.no_reason": "Vælg venligst en rapporteringskategori",
	"gui.abuseReport.send.not_attested": "Læs venligst teksten ovenfor, og tik afkrydsningsfeltet for at kunne sende rapporten",
	"gui.abuseReport.send.service_unavailable": "Kunne ikke nå misbrugsrapporteringstjenesten. Venligst vær sikker på du er forbundet til internet og prøv igen.",
	"gui.abuseReport.sending.title": "Indsender din rapport...",
	"gui.abuseReport.sent.title": "Rapport indsendt",
	"gui.abuseReport.skin.title": "Rapporter spillerskin",
	"gui.abuseReport.title": "Rapporter spiller",
	"gui.abuseReport.type.chat": "Chatbeskeder",
	"gui.abuseReport.type.name": "Spillernavn",
	"gui.abuseReport.type.skin": "Spillerskin",
	"gui.acknowledge": "Forstået",
	"gui.advancements": "Fremskridt",
	"gui.all": "Alle",
	"gui.back": "Tilbage",
	"gui.banned.description": "%s\n\n%s\n\nLær mere på følgende link: %s",
	"gui.banned.description.permanent": "Din konto er bandlyst permanent, hvilket betyder, at du ikke kan spille online eller tilslutte Realms.",
	"gui.banned.description.reason": "Vi har for nyligt modtaget en rapport angående dårlig opførsel af din konto. Vores moderatorer har nu gennemgået din sag og identificeret den som %s, hvilket er imod Minecraft-fællesskabsstandarderne.",
	...
	"gui.banned.description.unknownreason": "Vi har for nyligt modtaget en rapport angående dårlig opførsel af din konto. Vores moderatorer har nu gennemgået din sag og identificeret at den er mod Minecraft-fællesskabsstandarderne.",
	"gui.banned.name.description": "Dit nuværende navn - \"%s\" - overtræder vores fællesskabsstandarder. Du kan spille singleplayer, men skal ændre navnet for at spille online.\n\nLær mere eller indsend en sagsgennemgang på følgende link: %s",
	"gui.banned.name.title": "Navn ikke tilladt i multiplayer",
	"gui.banned.reason.defamation_impersonation_false_information": "Identitetsforfalskning eller deling af oplysninger for at udnytte eller vildlede andre",
	"gui.banned.reason.drugs": "Referencer til ulovlige stoffer",
	"gui.banned.reason.extreme_violence_or_gore": "Afbildninger af overdreven vold eller blodige scener fra det virkelige liv",
	"gui.banned.reason.false_reporting": "Overdreven falske eller unøjagtige rapporter",
	"gui.banned.reason.fraud": "Bedragerisk erhvervelse eller brug af indhold",
	"gui.banned.reason.generic_violation": "Overtrædelse af fællesskabsstandarder",
	"gui.banned.reason.harassment_or_bullying": "Fornærmende sprogbrug brugt på en rettet, skadelig måde",
	"gui.banned.reason.hate_speech": "Hadefulde ytringer eller diskrimination",
	"gui.banned.reason.hate_terrorism_notorious_figure": "Referencer til hadegrupper, terrororganisationer eller berygtede personer",
	"gui.banned.reason.imminent_harm_to_person_or_property": "Hensigt om at forårsage virkelig skade på personer eller ejendom",
	"gui.banned.reason.nudity_or_pornography": "Visning af uanstændigt eller pornografisk materiale",
	"gui.banned.reason.sexually_inappropriate": "Emner eller indhold af seksuel karakter",
	"gui.banned.reason.spam_or_advertising": "Spam eller reklamering",
	"gui.banned.skin.description": "Dit nuværende skin overtræder vores fællesskabsstandarder. Du kan stadig spille med et standard skin eller vælge en ny.\n\nLær mere eller indsend en sagsgennemgang på følgende link: %s",
	"gui.banned.skin.title": "Skin ikke tilladt",
	"gui.banned.title.permanent": "Konto permanent bandlyst",
	...
	"gui.chatReport.draft.content": "Vil du fortsætte med at redigere den eksisterende rapport, eller vil du kassere den og oprette en ny?",
	"gui.chatReport.draft.discard": "Kassér",
	"gui.chatReport.draft.edit": "Fortsæt med at redigere",
	"gui.chatReport.draft.quittotitle.content": "Vil du fortsætte med at redigere den eller kassere den?",
	"gui.chatReport.draft.quittotitle.title": "Du har en chatrapport kladde, der vil gå tabt hvis du afslutter",
	"gui.chatReport.draft.title": "Rediger udkast af chatrapport?",
	"gui.chatReport.more_comments": "Beskriv venligst hvad der skete:",
	"gui.chatReport.observed_what": "Hvorfor anmelder du dette?",
	"gui.chatReport.read_info": "Lær omkring rapportering",
	"gui.chatReport.report_sent_msg": "Vi har modtaget din rapport succesfuldt. Tak!\n\nVores hold vil gennemgå den snarest muligt.",
	"gui.chatReport.select_chat": "Vælg chatbeskeder at rapporterer",
	"gui.chatReport.select_reason": "Vælg rapporteringskategori",
	...
	"gui.chatReport.send.no_reason": "Vælg venligst en rapporteringskategori",
	"gui.chatReport.send.no_reported_messages": "Vælg venligst mindst én chatbesked, der skal rapporteres",
	"gui.chatReport.send.too_many_messages": "Prøver at inkludere for mange beskeder i rapporten",
	"gui.chatReport.title": "Rapporter spillerchat",
	"gui.chatSelection.context": "Beskederne omkring dette valg vil blive inkluderet for at give ekstra kontekst",
	...
	"gui.chatSelection.title": "Vælg chatbeskeder at anmelde",
	"gui.continue": "Fortsæt",
	"gui.copy_link_to_clipboard": "Kopier link til udklipsholder",
	"gui.days": "%s dag(e)",
	"gui.done": "Færdig",
	"gui.down": "Ned",
	"gui.entity_tooltip.type": "Type: %s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "Afviste %s filer",
	"gui.fileDropFailure.title": "Kunne ikke tilføje filer",
	"gui.friends.accept": "Accepter",
	"gui.friends.button.loading": "Vent...",
	"gui.friends.button.loading.invite_request_pending": "Venter på bekræftelse",
	"gui.friends.button.loading.join_request_pending": "Venter på bekræftelse",
	"gui.friends.cancel_request": "Annuller anmodning",
	"gui.friends.confirm_title": "Bekræft",
	"gui.friends.confirm_unfriend": "Er du sikker på, at du vil fjerne denne spiller fra din venneliste?",
	"gui.friends.copy_to_clipboard": "Kopier link",
	"gui.friends.decline": "Afvis",
	"gui.friends.empty_nickname": "Indtast et gyldigt profilnavn, før du sender en venneanmodning",
	"gui.friends.empty_state": "Venner du tilføjer vil blive vist her.\n\nAdministrer onlinesikkerhed med din %s.",
	"gui.friends.empty_state.link": "Microsoft-konto",
	"gui.friends.enter_nickname": "Indtast profilnavn",
	"gui.friends.error.connection_issue": "Vennelisten virker ikke lige nu.\n\nTjek din internetforbindelse og prøv igen.",
	"gui.friends.error.failed.message": "Kan ikke sende din venneanmodning lige nu",
	"gui.friends.error.forbidden.message": "Kunne ikke udføre denne vennehandling. Det kan skyldes kontoens privatlivsindstillinger.",
	"gui.friends.error.generic": "Der er noget galt - med denne funktion, ikke dine venner!\n\nPrøv igen senere.",
	"gui.friends.error.rateLimited.message": "Du udfører handlinger i vennelisten for hurtigt. Vent venligst et øjeblik og prøv igen.",
	"gui.friends.error.temporary_unavailable": "Vennelisten virker ikke lige nu.\n\nPrøv igen senere.",
	"gui.friends.error.unavailable.message": "Venneliste-tjenesten er i øjeblikket utilgængelig. Tjen venligst din forbindelse, og prøv igen senere.",
	"gui.friends.error.upgrade_needed": "Opdater spillet for at få adgang til din venneliste.",
	"gui.friends.error.user_may_lack_active_profile": "Der findes ingen spiller med dette profilnavn",
	"gui.friends.join": "Tilslut",
	"gui.friends.loading_friends": "Indlæser venneliste...",
	"gui.friends.loading_requests": "Indlæser anmodninger...",
	"gui.friends.manage_account_footer": "Administrer onlinesikkerhed med din %s",
	"gui.friends.multiplayer.invite": "Inviter",
	"gui.friends.multiplayer.invite_accept": "Accepter",
	"gui.friends.multiplayer.invite_reject": "Afvis",
	"gui.friends.multiplayer.join_request": "Anmod om at deltage",
	"gui.friends.multiplayer.join_request_accept": "Accepter",
	"gui.friends.multiplayer.join_request_reject": "Afvis",
	"gui.friends.my_profile_name": "Mit profilnavn: ",
	"gui.friends.my_profile_name.narration": "Kopier profilnavn %s til udklipsholderen",
	"gui.friends.narration.button.accept": "Tryk Enter for at acceptere venneanmodningen fra %s",
	"gui.friends.narration.button.cancel_request": "Tryk Enter for at annullere venneanmodningen til %s",
	"gui.friends.narration.button.decline": "Tryk Enter for at afvise venneanmodningen fra %s",
	"gui.friends.narration.button.unfriend": "Tryk Enter for at fjerne %s fra vennelisten",
	"gui.friends.narration.entry.friend": "Ven %s",
	"gui.friends.narration.entry.incoming": "Indgående venneanmodning fra %s",
	"gui.friends.narration.entry.outgoing": "Udgående venneanmodning til %s",
	"gui.friends.open": "Venner",
	"gui.friends.open.narration": "Venneliste",
	"gui.friends.open.tooltip": "Venner",
	"gui.friends.pending.empty": "Ingen ventende venneanmodninger",
	"gui.friends.pending.received": "Modtaget",
	"gui.friends.pending.sent": "Sendt",
	"gui.friends.presence.status.offline": "Offline",
	"gui.friends.presence.status.online": "Online",
	"gui.friends.presence.status.playing_hosted_server": "Online (verden)",
	"gui.friends.presence.status.playing_offline": "Online (verden)",
	"gui.friends.presence.status.playing_realms": "Online (Realm)",
	"gui.friends.presence.status.playing_server": "Online (server)",
	"gui.friends.requests_count": "Anmodninger (%s)",
	"gui.friends.send_request": "Send venneanmodning",
	"gui.friends.tab_friends": "Venner",
	"gui.friends.toast.friend_added.message": "%s accepterede din venneanmodning",
	"gui.friends.toast.friend_invited.message": "%s er blevet inviteret til at deltage i din verden.",
	"gui.friends.toast.friend_removed.message": "%s er blevet fjernet fra din venneliste",
	"gui.friends.toast.generic_error": "Der opstod en uventet fejl under opdateringen af din venneliste. Prøv venligst igen senere.",
	"gui.friends.toast.host_invite_expired.message": "Invitationen til %s om at deltage i denne verden er udløbet.",
	"gui.friends.toast.invite_from_friend.message": "%s Inviterede dig til at deltage i deres verden. Åbn vennelisten ved at trykke på ''%s'' for at deltage",
	"gui.friends.toast.join_invite_expired.message": "Invitationen til at deltage i %s's verden er udløbet.",
	"gui.friends.toast.join_request.message": "%s ønsker at deltage i din verden. Åbn vennelisten ved at trykke på ''%s'', eller fra spilmenuen.",
	"gui.friends.toast.request_accepted.message": "Du er nu venner med %s",
	"gui.friends.toast.request_received.message": "%s sendte dig en venneanmodning",
	"gui.friends.toast.request_sent.message": "Venneanmodning sendt til %s",
	"gui.friends.toast.request_to_join_friend.message": "Du har anmodet om at deltage i %s's verden",
	"gui.friends.toast.requests_accepted_multiple.message": "%s venner accepterede dine venneanmodninger",
	"gui.friends.toast.requests_received_multiple.message": "Du har modtaget %s venneanmodninger",
	"gui.friends.unfriend": "Fjern ven",
	"gui.game_rule.search": "Søg...",
	"gui.hours": "%s time(r)",
	"gui.language.search": "Søg...",
	"gui.loadingMinecraft": "Indlæser Minecraft",
	...
	"gui.none": "Ingen",
	"gui.ok": "Ok",
	"gui.open_report_dir": "Åbn rapportkatalog",
	"gui.packSelection.search": "Søg...",
	"gui.privacy_link.message": "Åbn dette link for at administrere dine privatlivs- og onlinesikkerhedsindstillinger.",
	"gui.privacy_link.title": "Ændringer i Xbox-indstillinger kan tage lidt tid om at træde i kraft.\n\nHvis de ikke opdateres, genstart spillet.",
	"gui.proceed": "Fortsæt",
	"gui.recipebook.moreRecipes": "Højreklik for mere",
	"gui.recipebook.next_page": "Næste side",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Forrige side",
	...
	"gui.remove": "Fjern",
	"gui.report_to_server": "Rapport til server",
	"gui.selectWorld.search": "Søg...",
	...
	"gui.socialInteractions.narration.report": "Anmeld spiller %s",
	"gui.socialInteractions.narration.show": "Vis beskeder fra %s",
	"gui.socialInteractions.report": "Anmeld",
	...
	"gui.socialInteractions.tooltip.report": "Anmeld spiller",
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Denne spiller kan ikke rapporteres, fordi chatten er deaktiveret eller blokeret",
	"gui.socialInteractions.tooltip.report.disabled": "Rapporteringstjenesten er utilgængelig",
	"gui.socialInteractions.tooltip.report.no_messages": "Ingen rapportbare beskeder fra spilleren %s",
	"gui.socialInteractions.tooltip.report.not_reportable": "Denne spiller kan ikke rapporteres, da deres chatbeskeder ikke kan bekræftes på denne server",
	"gui.socialInteractions.tooltip.show": "Vis beskeder",
	"gui.stats": "Statistikker",
	"gui.stats.none_found": "Ingen statistikker fundet.",
	"gui.toMenu": "Tilbage til serverlisten",
	"gui.toRealms": "Tilbage til Realms-listen",
	"gui.toTitle": "Tilbage til hovedmenuen",
	"gui.toWorld": "Tilbage til verdensliste",
	"gui.togglable_slot": "Klik for at deaktivere felt",
	"gui.up": "Op",
	"gui.waitingForResponse.button.inactive": "Tilbage (%ss)",
	"gui.waitingForResponse.title": "Venter på server",
	"gui.yes": "Ja",
	...
	"item.canUse.unknown": "Ukendt",
	"item.color": "Farve: %s",
	"item.components": "%s komponent(er)",
	"item.disabled": "Deaktiveret genstand",
	"item.durability": "Holdbarhed: %s / %s",
	"item.dyed": "Farvet",
	"item.intangible": "Immateriel",
	...
	"item.minecraft.angler_pottery_shard": "Lystfisker keramikskår",
	"item.minecraft.angler_pottery_sherd": "Lystfisker keramikfragment",
	"item.minecraft.apple": "Æble",
	"item.minecraft.archer_pottery_shard": "Bueskytte keramikskår",
	"item.minecraft.archer_pottery_sherd": "Bueskytte keramikfragment",
	"item.minecraft.armadillo_scute": "Bæltedyrs skæl",
	"item.minecraft.armadillo_spawn_egg": "Bæltedyr fremkaldningsæg",
	"item.minecraft.armor_stand": "Brynjeholder",
	"item.minecraft.arms_up_pottery_shard": "Armene op keramikskår",
	"item.minecraft.arms_up_pottery_sherd": "Armene oppe keramikfragment",
	...
	"item.minecraft.black_bundle": "Sort bundt",
	"item.minecraft.black_dye": "Sort farvestof",
	"item.minecraft.black_harness": "Sort seletøj",
	"item.minecraft.blade_pottery_shard": "Klinge keramikskår",
	"item.minecraft.blade_pottery_sherd": "Klinge keramikfragment",
	...
	"item.minecraft.blue_bundle": "Blåt bundt",
	"item.minecraft.blue_dye": "Blåt farvestof",
	"item.minecraft.blue_egg": "Blåt æg",
	"item.minecraft.blue_harness": "Blåt seletøj",
	"item.minecraft.bogged_spawn_egg": "Sumpskelet fremkaldningsæg",
	"item.minecraft.bolt_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Bolt rustningspynt",
	"item.minecraft.bone": "Knogle",
	"item.minecraft.bone_meal": "Benmel",
	"item.minecraft.book": "Bog",
	"item.minecraft.bordure_indented_banner_pattern": "Takket bannermønster",
	"item.minecraft.bow": "Bue",
	"item.minecraft.bowl": "Skål",
	"item.minecraft.bread": "Brød",
	"item.minecraft.breeze_rod": "Vindvæsen-stav",
	"item.minecraft.breeze_spawn_egg": "Vindvæsen fremkaldningsæg",
	"item.minecraft.brewer_pottery_shard": "Brygger keramikskår",
	"item.minecraft.brewer_pottery_sherd": "Brygger keramikfragment",
	"item.minecraft.brewing_stand": "Bryggestand",
	"item.minecraft.brick": "Mursten",
	"item.minecraft.brown_bundle": "Brunt bundt",
	"item.minecraft.brown_dye": "Brunt farvestof",
	"item.minecraft.brown_egg": "Brunt æg",
	"item.minecraft.brown_harness": "Brunt seletøj",
	"item.minecraft.brush": "Børste",
	"item.minecraft.bucket": "Spand",
	"item.minecraft.bundle": "Bundt",
	"item.minecraft.bundle.empty": "Tom",
	"item.minecraft.bundle.empty.description": "Kan holde en blandet stak af genstande",
	"item.minecraft.bundle.full": "Fuld",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "Brænd keramikskår",
	"item.minecraft.burn_pottery_sherd": "Brænd keramikfragment",
	"item.minecraft.camel_husk_spawn_egg": "Udtørret kamel fremkaldningsæg",
	...
	"item.minecraft.cherry_boat": "Kirsebærbåd",
	"item.minecraft.cherry_chest_boat": "Kirsebærbåd med kiste",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Kyst rustningspynt",
	...
	"item.minecraft.cooked_cod": "Bagt torsk",
	"item.minecraft.cooked_mutton": "Stegt fårekød",
	"item.minecraft.cooked_porkchop": "Stegt svinekotelet",
	"item.minecraft.cooked_rabbit": "Stegt kanin",
	"item.minecraft.cooked_salmon": "Bagt laks",
	"item.minecraft.cookie": "Småkage",
	"item.minecraft.copper_axe": "Kobberøkse",
	"item.minecraft.copper_boots": "Kobberstøvler",
	"item.minecraft.copper_chestplate": "Kobberbrystplade",
	"item.minecraft.copper_golem_spawn_egg": "Kobbergolem fremkaldningsæg",
	"item.minecraft.copper_helmet": "Kobberhjelm",
	"item.minecraft.copper_hoe": "Kobberlugejern",
	"item.minecraft.copper_horse_armor": "Kobberhestearmering",
	"item.minecraft.copper_ingot": "Kobberbarre",
	"item.minecraft.copper_leggings": "Kobberbukser",
	"item.minecraft.copper_nautilus_armor": "Kobbernautilarmering",
	"item.minecraft.copper_nugget": "Kobberklump",
	"item.minecraft.copper_pickaxe": "Kobberhakke",
	"item.minecraft.copper_shovel": "Kobberspade",
	"item.minecraft.copper_spear": "Kobberspyd",
	"item.minecraft.copper_sword": "Kobbersværd",
	"item.minecraft.cow_spawn_egg": "Ko fremkaldningsæg",
	"item.minecraft.creaking_spawn_egg": "Knirker fremkaldningsæg",
	"item.minecraft.creeper_banner_pattern": "Bannermønster",
	"item.minecraft.creeper_banner_pattern.desc": "Creepersymbol",
	"item.minecraft.creeper_banner_pattern.new": "Creepersymbol bannermønster",
	...
	"item.minecraft.cyan_bundle": "Turkis bundt",
	"item.minecraft.cyan_dye": "Turkis farvestof",
	"item.minecraft.cyan_harness": "Turkis seletøj",
	"item.minecraft.danger_pottery_shard": "Fare keramikskår",
	"item.minecraft.danger_pottery_sherd": "Fare keramikfragment",
	...
	"item.minecraft.diamond_nautilus_armor": "Diamantnautilarmering",
	"item.minecraft.diamond_pickaxe": "Diamanthakke",
	"item.minecraft.diamond_shovel": "Diamantspade",
	"item.minecraft.diamond_spear": "Diamantspyd",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Ødemark rustningspynt",
	...
	"item.minecraft.explorer_pottery_shard": "Opdagelsesrejsende keramikskår",
	"item.minecraft.explorer_pottery_sherd": "Opdagelsesrejsende keramikfragment",
	"item.minecraft.eye_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Øje rustningspynt",
	"item.minecraft.feather": "Fjer",
	"item.minecraft.fermented_spider_eye": "Fermenteret edderkoppeøje",
	"item.minecraft.field_masoned_banner_pattern": "Murstensmønster bannermønster",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Hvirvel rustningspynt",
	"item.minecraft.flow_banner_pattern": "Bannermønster",
	"item.minecraft.flow_banner_pattern.desc": "Hvirvel",
	"item.minecraft.flow_banner_pattern.new": "Hvirvel bannermønster",
	"item.minecraft.flow_pottery_sherd": "Hvirvel-potteskår",
	"item.minecraft.flower_banner_pattern": "Bannermønster",
	"item.minecraft.flower_banner_pattern.desc": "Blomstersymbol",
	"item.minecraft.flower_banner_pattern.new": "Blomstersymbol bannermønster",
	"item.minecraft.flower_pot": "Blomsterkrukke",
	"item.minecraft.fox_spawn_egg": "Ræv fremkaldningsæg",
	"item.minecraft.friend_pottery_shard": "Ven keramikskår",
	"item.minecraft.friend_pottery_sherd": "Ven keramikfragment",
	...
	"item.minecraft.globe_banner_pattern.new": "Globus bannermønster",
	...
	"item.minecraft.golden_nautilus_armor": "Guldnautilarmering",
	"item.minecraft.golden_pickaxe": "Guldhakke",
	"item.minecraft.golden_shovel": "Guldspade",
	"item.minecraft.golden_spear": "Guldspyd",
	"item.minecraft.golden_sword": "Guldsværd",
	"item.minecraft.gray_bundle": "Gråt bundt",
	"item.minecraft.gray_dye": "Gråt farvestof",
	"item.minecraft.gray_harness": "Gråt seletøj",
	"item.minecraft.green_bundle": "Grønt bundt",
	"item.minecraft.green_dye": "Grønt farvestof",
	"item.minecraft.green_harness": "Grønt seletøj",
	"item.minecraft.guardian_spawn_egg": "Beskytter fremkaldningsæg",
	"item.minecraft.gunpowder": "Krudt",
	"item.minecraft.guster_banner_pattern": "Bannermønster",
	"item.minecraft.guster_banner_pattern.desc": "Vindvæsen",
	"item.minecraft.guster_banner_pattern.new": "Vindvæsen bannermønster",
	"item.minecraft.guster_pottery_sherd": "Vindvæsen keramikfragment",
	"item.minecraft.happy_ghast_spawn_egg": "Glad ghast fremkaldningsæg",
	"item.minecraft.harness": "Seletøj",
	"item.minecraft.heart_of_the_sea": "Havets hjerte",
	"item.minecraft.heart_pottery_shard": "Hjerte keramikskår",
	"item.minecraft.heart_pottery_sherd": "Hjerte keramikfragment",
	"item.minecraft.heartbreak_pottery_shard": "Hjertesorg keramikskår",
	"item.minecraft.heartbreak_pottery_sherd": "Hjertesorg keramikfragment",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.host_armor_trim_smithing_template.new": "Vært rustningspynt",
	"item.minecraft.howl_pottery_shard": "Hyl keramikskår",
	"item.minecraft.howl_pottery_sherd": "Hyl keramikfragment",
	...
	"item.minecraft.light_blue_bundle": "Lyseblåt bundt",
	"item.minecraft.light_blue_dye": "Lyseblåt farvestof",
	"item.minecraft.light_blue_harness": "Lyseblåt seletøj",
	"item.minecraft.light_gray_bundle": "Lysegråt bundt",
	"item.minecraft.light_gray_dye": "Lysegråt farvestof",
	"item.minecraft.light_gray_harness": "Lysegråt seletøj",
	"item.minecraft.lime_bundle": "Limegrønt bundt",
	"item.minecraft.lime_dye": "Limegrønt farvestof",
	"item.minecraft.lime_harness": "Limegrønt seletøj",
	"item.minecraft.lingering_potion": "Vedvarende eliksir",
	"item.minecraft.lingering_potion.effect.awkward": "Vedvarende akavet eliksir",
	"item.minecraft.lingering_potion.effect.empty": "Ulavelig vedvarende eliksir",
	"item.minecraft.lingering_potion.effect.fire_resistance": "Vedvarende ildmodstandseliksir",
	"item.minecraft.lingering_potion.effect.harming": "Vedvarende skadeeliksir",
	"item.minecraft.lingering_potion.effect.healing": "Vedvarende helbredseliksir",
	"item.minecraft.lingering_potion.effect.infested": "Vedvarende infestationseliksir",
	"item.minecraft.lingering_potion.effect.invisibility": "Vedvarende usynlighedseliksir",
	"item.minecraft.lingering_potion.effect.leaping": "Vedvarende springeliksir",
	"item.minecraft.lingering_potion.effect.levitation": "Vedvarende levitationseliksir",
	"item.minecraft.lingering_potion.effect.luck": "Vedvarende heldeliksir",
	"item.minecraft.lingering_potion.effect.mundane": "Vedvarende banal eliksir",
	"item.minecraft.lingering_potion.effect.night_vision": "Vedvarende nattesynseliksir",
	"item.minecraft.lingering_potion.effect.oozing": "Vedvarende siveeliksir",
	"item.minecraft.lingering_potion.effect.poison": "Vedvarende gifteliksir",
	"item.minecraft.lingering_potion.effect.regeneration": "Vedvarende regenereringseliksir",
	"item.minecraft.lingering_potion.effect.slow_falling": "Vedvarende langsom fald eliksir",
	"item.minecraft.lingering_potion.effect.slowness": "Vedvarende langsomhedseliksir",
	"item.minecraft.lingering_potion.effect.strength": "Vedvarende styrkeeliksir",
	"item.minecraft.lingering_potion.effect.swiftness": "Vedvarende hurtighedseliksir",
	"item.minecraft.lingering_potion.effect.thick": "Vedvarende tyk eliksir",
	"item.minecraft.lingering_potion.effect.turtle_master": "Vedvarende skildpaddemestereliksir",
	"item.minecraft.lingering_potion.effect.water": "Vedvarende vandflaske",
	"item.minecraft.lingering_potion.effect.water_breathing": "Vedvarende gælleeliksir",
	"item.minecraft.lingering_potion.effect.weakness": "Vedvarende svaghedseliksir",
	"item.minecraft.lingering_potion.effect.weaving": "Vedvarende vævningseliksir",
	"item.minecraft.lingering_potion.effect.wind_charged": "Vedvarende vindladningseliksir",
	"item.minecraft.llama_spawn_egg": "Lama fremkaldningsæg",
	"item.minecraft.lodestone_compass": "Ledestenkompas",
	"item.minecraft.mace": "Kølle",
	"item.minecraft.magenta_bundle": "Magenta bundt",
	"item.minecraft.magenta_dye": "Magenta farvestof",
	"item.minecraft.magenta_harness": "Magenta seletøj",
	...
	"item.minecraft.miner_pottery_shard": "Minearbejder keramikskår",
	"item.minecraft.miner_pottery_sherd": "Minearbejder keramikfragment",
	"item.minecraft.mojang_banner_pattern": "Bannermønster",
	"item.minecraft.mojang_banner_pattern.desc": "Ting",
	"item.minecraft.mojang_banner_pattern.new": "Ting bannermønster",
	"item.minecraft.mooshroom_spawn_egg": "Mooshroom fremkaldningsæg",
	"item.minecraft.mourner_pottery_shard": "Sørgende keramikskår",
	"item.minecraft.mourner_pottery_sherd": "Sørgende keramikfragment",
	...
	"item.minecraft.music_disc_bounce": "Musikplade",
	...
	"item.minecraft.music_disc_creator": "Musikplade",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Musikplade",
	...
	"item.minecraft.music_disc_lava_chicken": "Musikplade",
	...
	"item.minecraft.music_disc_precipice": "Musikplade",
	"item.minecraft.music_disc_precipice.desc": "Aaron Cherof - Precipice",
	"item.minecraft.music_disc_relic": "Musikplade",
	...
	"item.minecraft.music_disc_tears": "Musikplade",
	...
	"item.minecraft.nautilus_spawn_egg": "Nautil fremkaldningsæg",
	...
	"item.minecraft.netherite_horse_armor": "Netherrithestearmering",
	"item.minecraft.netherite_ingot": "Netherritbarre",
	"item.minecraft.netherite_leggings": "Netherritbukser",
	"item.minecraft.netherite_nautilus_armor": "Netherritnautilarmering",
	...
	"item.minecraft.netherite_spear": "Netherritspyd",
	"item.minecraft.netherite_sword": "Netherritsværd",
	"item.minecraft.netherite_upgrade_smithing_template": "Smedeskabelon",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Netherritopgradering",
	...
	"item.minecraft.ominous_bottle": "Ildevarslende flaske",
	"item.minecraft.ominous_trial_key": "Ildevarslende prøvelsesnøgle",
	"item.minecraft.orange_bundle": "Orange bundt",
	"item.minecraft.orange_dye": "Orange farvestof",
	"item.minecraft.orange_harness": "Orange seletøj",
	"item.minecraft.painting": "Maleri",
	"item.minecraft.pale_oak_boat": "Bleg egetræsbåd",
	"item.minecraft.pale_oak_chest_boat": "Bleg egetræsbåd med kiste",
	"item.minecraft.panda_spawn_egg": "Panda fremkaldningsæg",
	"item.minecraft.paper": "Papir",
	"item.minecraft.parched_spawn_egg": "Udtørret skelet fremkaldningsæg",
	...
	"item.minecraft.piglin_banner_pattern.new": "Snude bannermønster",
	...
	"item.minecraft.pink_bundle": "Lyserødt bundt",
	"item.minecraft.pink_dye": "Lyserødt farvestof",
	"item.minecraft.pink_harness": "Lyserødt seletøj",
	"item.minecraft.pitcher_plant": "Kandeplante",
	"item.minecraft.pitcher_pod": "Kandefrø-skal",
	"item.minecraft.plenty_pottery_shard": "Rigdom keramikskår",
	"item.minecraft.plenty_pottery_sherd": "Rigdom keramikfragment",
	...
	"item.minecraft.potion.effect.infested": "Infestationseliksir",
	...
	"item.minecraft.potion.effect.oozing": "Siveeliksir",
	...
	"item.minecraft.potion.effect.weaving": "Vævningseliksir",
	"item.minecraft.potion.effect.wind_charged": "Vindladningseliksir",
	"item.minecraft.pottery_shard_archer": "Bueskytte keramikskår",
	"item.minecraft.pottery_shard_arms_up": "Armene op keramikskår",
	"item.minecraft.pottery_shard_prize": "Præmie keramikskår",
	"item.minecraft.pottery_shard_skull": "Kranium keramikskår",
	...
	"item.minecraft.prize_pottery_shard": "Præmie keramikskår",
	"item.minecraft.prize_pottery_sherd": "Præmie keramikfragment",
	...
	"item.minecraft.purple_bundle": "Lilla bundt",
	"item.minecraft.purple_dye": "Lilla farvestof",
	"item.minecraft.purple_harness": "Lilla seletøj",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Opdrætter rustningspynt",
	...
	"item.minecraft.red_bundle": "Rødt bundt",
	"item.minecraft.red_dye": "Rødt farvestof",
	"item.minecraft.red_harness": "Rødt seletøj",
	"item.minecraft.redstone": "Redstonestøv",
	"item.minecraft.resin_brick": "Harpiksmursten",
	"item.minecraft.resin_clump": "Harpiksklump",
	"item.minecraft.rib_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Ribben rustningspynt",
	...
	"item.minecraft.scrape_pottery_sherd": "Økse keramikfragment",
	"item.minecraft.scute": "Skæl",
	"item.minecraft.sentry_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Vagt rustningspynt",
	"item.minecraft.shaper_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Formgiver rustningspynt",
	"item.minecraft.sheaf_pottery_shard": "Hvede keramikskår",
	"item.minecraft.sheaf_pottery_sherd": "Hvede keramikfragment",
	"item.minecraft.shears": "Saks",
	"item.minecraft.sheep_spawn_egg": "Får fremkaldningsæg",
	"item.minecraft.shelter_pottery_shard": "Ly keramikskår",
	"item.minecraft.shelter_pottery_sherd": "Ly keramikfragment",
	...
	"item.minecraft.shield.magenta": "Magenta skjold",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Stilhed rustningspynt",
	...
	"item.minecraft.skull_banner_pattern.desc": "Kraniumsymbol",
	"item.minecraft.skull_banner_pattern.new": "Kraniumsymbol bannermønster",
	"item.minecraft.skull_pottery_shard": "Kranium keramikskår",
	"item.minecraft.skull_pottery_sherd": "Kranium keramikfragment",
	"item.minecraft.slime_ball": "Slimbold",
	"item.minecraft.slime_spawn_egg": "Slimklump fremkaldningsæg",
	"item.minecraft.smithing_template": "Smedeskabelon",
	"item.minecraft.smithing_template.applies_to": "Gælder for:",
	"item.minecraft.smithing_template.armor_trim.additions_slot_description": "Tilføj barre eller krystal",
	"item.minecraft.smithing_template.armor_trim.applies_to": "Rustning",
	"item.minecraft.smithing_template.armor_trim.base_slot_description": "Tilføj et stykke rustning",
	...
	"item.minecraft.smithing_template.netherite_upgrade.additions_slot_description": "Tilføj netherritbarre",
	"item.minecraft.smithing_template.netherite_upgrade.applies_to": "Diamantudstyr",
	"item.minecraft.smithing_template.netherite_upgrade.base_slot_description": "Tilføj diamantrustning, -våben eller -værktøj",
	"item.minecraft.smithing_template.netherite_upgrade.ingredients": "Netherritbarre",
	"item.minecraft.smithing_template.upgrade": "Opgradering: ",
	"item.minecraft.sniffer_spawn_egg": "Sniffer fremkaldningsæg",
	"item.minecraft.snort_pottery_shard": "Prust keramikskår",
	"item.minecraft.snort_pottery_sherd": "Prust keramikfragment",
	"item.minecraft.snout_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Snude rustningspynt",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Spir rustningspynt",
	...
	"item.minecraft.splash_potion.effect.infested": "Sprøjtende infestationseliksir",
	...
	"item.minecraft.splash_potion.effect.oozing": "Sprøjtende siveeliksir",
	...
	"item.minecraft.splash_potion.effect.weaving": "Spøjtende vævningseliksir",
	"item.minecraft.splash_potion.effect.wind_charged": "Sprøjtende vindladningseliksir",
	...
	"item.minecraft.stone_spear": "Stenspyd",
	...
	"item.minecraft.sulfur_cube_bucket": "Spand med svovlkube",
	"item.minecraft.sulfur_cube_spawn_egg": "Svovlkube fremkaldningsæg",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Tidevand rustningspynt",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Pil af infestation",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Pil af sivning",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Pil af vævning",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Pil af vindladning",
	...
	"item.minecraft.trial_key": "Prøvelsesnøgle",
	...
	"item.minecraft.turtle_scute": "Skildpaddeskæl",
	"item.minecraft.turtle_spawn_egg": "Skildpadde fremkaldningsæg",
	"item.minecraft.vex_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Vex rustningspynt",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Ward rustningspynt",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Vejfinder rustningspynt",
	"item.minecraft.wheat": "Hvede",
	"item.minecraft.wheat_seeds": "Hvede frø",
	"item.minecraft.white_bundle": "Hvidt bundt",
	"item.minecraft.white_dye": "Hvidt farvestof",
	"item.minecraft.white_harness": "Hvidt seletøj",
	"item.minecraft.wild_armor_trim_smithing_template": "Smedeskabelon",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Vild rustningspynt",
	"item.minecraft.wind_charge": "Vindladning",
	"item.minecraft.witch_spawn_egg": "Heks fremkaldningsæg",
	"item.minecraft.wither_skeleton_spawn_egg": "Witherskelet fremkaldningsæg",
	"item.minecraft.wither_spawn_egg": "Wither fremkaldningsæg",
	"item.minecraft.wolf_armor": "Ulverustning",
	...
	"item.modifiers.saddle": "Når sadlet:",
	"item.nbt_tags": "NBT: %s mærke(r)",
	"item.op_block_warning.line1": "Advarsel:",
	"item.op_block_warning.line2": "Brug af denne genstand kan lede til kommandoudførelse.",
	"item.op_block_warning.line3": "Brug ikke, medmindre du kender det præcise indhold!",
	"item.spawn_egg.peaceful": "Deaktiveret i fredelig sværhedsgrad",
	...
	"itemGroup.consumables": "Forbrugsvarer",
	"itemGroup.crafting": "Fremstilling",
	"itemGroup.foodAndDrink": "Mad & drikkevarer",
	"itemGroup.functional": "Funktionelle blokke",
	...
	"jigsaw_block.placement_priority": "Placeringsprioritet:",
	"jigsaw_block.placement_priority.tooltip": "Når denne puslespilsblok forbindes til et stykke, er dette rækkefølgen, hvori det pågældende stykke behandles for forbindelser i den bredere struktur.\n\nStykker behandles i faldende prioritet, hvor indsætningsrækkefølgen anvendes ved uafgjorte situationer.",
	"jigsaw_block.pool": "Målfond:",
	"jigsaw_block.selection_priority": "Udvalgsprioritet:",
	"jigsaw_block.selection_priority.tooltip": "Når det overordnede stykke behandles for forbindelser, er dette rækkefølgen, hvori denne puslespilsblok forsøger at forbinde til sit målstykke.\n\nPuslespilblokke behandles i faldende prioritet, hvor en tilfældig rækkefølge anvendes ved uafgjorte situationer.",
	...
	"key.categories.spectator": "Tilskuer",
	"key.categories.ui": "Spil interface",
	"key.category.minecraft.creative": "Kreativ",
	"key.category.minecraft.debug": "Fejlfinding",
	"key.category.minecraft.gameplay": "Spil mekanik",
	"key.category.minecraft.inventory": "Inventar",
	"key.category.minecraft.misc": "Diverse",
	"key.category.minecraft.movement": "Bevægelse",
	"key.category.minecraft.multiplayer": "Multiplayer",
	"key.category.minecraft.spectator": "Tilskuer",
	"key.chat": "Åben chat",
	"key.command": "Åben kommando",
	"key.debug.clearChat": "Ryd chat",
	"key.debug.copyLocation": "Kopier lokation",
	"key.debug.copyRecreateCommand": "Kopier data",
	"key.debug.crash": "Spilnedbrudsfejlfinding",
	"key.debug.debugOptions": "Fejlfindingsindstillinger",
	"key.debug.dumpDynamicTextures": "Gem dynamiske teksturer",
	"key.debug.dumpVersion": "Gem version info",
	"key.debug.focusPause": "Slå pause ved tab af fokus til/fra",
	"key.debug.fpsCharts": "FPS-diagrammer",
	"key.debug.lightmapTexture": "Lyskort-tekstur",
	"key.debug.modifier": "Fejlfindings-modifikatortast",
	"key.debug.networkCharts": "Netværksdiagrammer",
	"key.debug.overlay": "Slå overlay til/fra",
	"key.debug.profiling": "Start/stop profilering",
	"key.debug.profilingChart": "Profileringsdiagram",
	"key.debug.reloadChunk": "Genindlæs klodser",
	"key.debug.reloadResourcePacks": "Genindlæs ressourcepakker",
	"key.debug.showAdvancedTooltips": "Vis avanceret værktøjstips",
	"key.debug.showChunkBorders": "Vis klodsgrænser",
	"key.debug.showHitboxes": "Vis hitbokse",
	"key.debug.spectate": "Veksel tilskuer",
	"key.debug.switchGameMode": "Spiltilstand skifter",
	"key.drop": "Drop markerede genstand",
	"key.forward": "Gå fremad",
	"key.friends": "Vennemenu",
	...
	"key.quickActions": "Hurtige handlinger",
	...
	"key.spectatorHotbar": "Vælg på værktøjslinje",
	"key.spectatorOutlines": "Fremhæv spillere",
	"key.sprint": "Løb",
	"key.swapOffhand": "Byt genstand med anden hånd",
	"key.toggleGui": "Slå grafisk brugerflade til/fra",
	"key.togglePerspective": "Skift perspektiv",
	"key.toggleSpectatorShaderEffects": "Slå shadereffekter for tilskuere til/fra",
	"key.use": "Brug ting/placér blok",
	"known_server_link.announcements": "Annonceringer",
	"known_server_link.community": "Fællesskab",
	"known_server_link.community_guidelines": "Fællesskabsretningslinjer",
	"known_server_link.feedback": "Tilbagemelding",
	"known_server_link.forums": "Forumer",
	"known_server_link.news": "Nyheder",
	"known_server_link.report_bug": "Rapporter serverfejl",
	"known_server_link.status": "Status",
	"known_server_link.support": "Støtte",
	"known_server_link.website": "Hjemmeside",
	"lanServer.otherPlayers": "Indstillinger for andre spillere",
	"lanServer.port": "Portnummer",
	"lanServer.port.invalid": "Ikke en gyldig port.\nLad redigeringsboksen stå tom eller tast et tal mellem 1024 og 65535.",
	"lanServer.port.invalid.new": "Ugyldig port.\nLad redigeringsboksen stå tom eller tast et tal mellem %s og %s.",
	"lanServer.port.unavailable": "Port utilgængelig.\nLad redigeringsboksen stå tom eller tast et tilfældigt tal mellem 1024 og 65535.",
	"lanServer.port.unavailable.new": "Port utilgængelig.\nLad redigeringsboksen stå tom eller tast et tilfældigt tal mellem %s og %s.",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Tilføj server",
	"manageServer.edit.title": "Rediger serverinformation",
	"manageServer.enterIp": "Serveradresse",
	"manageServer.enterName": "Servernavn",
	"manageServer.resourcePack": "Server ressourcepakker",
	"manageServer.resourcePack.disabled": "Deaktiveret",
	"manageServer.resourcePack.enabled": "Aktiveret",
	"manageServer.resourcePack.prompt": "Spørg",
	"mco.account.privacy.info": "Læs mere om Mojang og privatlivslove",
	"mco.account.privacy.info.button": "Læs mere om GDPR",
	"mco.account.privacy.information": "Mojang implementerer visse procedurer for at beskytte børn og deres privatliv, herunder at overholde Forordning om Børns Online-privatlivbeskyttelse (COPPA) og Generel Databeskyttelsesforordning (GDPR).\n\nDu skal muligvis få forældres samtykke, inden du får adgang til din Realms-konto.",
	"mco.account.privacyinfo": "Mojang implementerer visse procedurer for at beskytte børn og deres privatliv, herunder at overholde Forordning om Børns Online-privatlivbeskyttelse (COPPA) og Generel Databeskyttelsesforordning (GDPR).\n\nDu skal muligvis få forældres samtykke, inden du får adgang til din Realms-konto.\n\nHvis du har en ældre Minecraft-konto (du logger ind med dit brugernavn), skal du migrer kontoen til en Mojang-konto for at få adgang til Realms.",
	"mco.account.update": "Opdater konto",
	"mco.activity.noactivity": "Ingen aktivitet de sidste %s dag(e)",
	...
	"mco.backup.entry": "Sikkerhedskopi (%s)",
	"mco.backup.entry.description": "Beskrivelse",
	"mco.backup.entry.enabledPack": "Aktiverede pakke(r)",
	"mco.backup.entry.gameDifficulty": "Spillets sværhedsgrad",
	"mco.backup.entry.gameMode": "Spiltilstand",
	"mco.backup.entry.gameServerVersion": "Spil-serverversion",
	"mco.backup.entry.name": "Navn",
	"mco.backup.entry.seed": "Seed",
	"mco.backup.entry.templateName": "Skabelonnavn",
	"mco.backup.entry.undefined": "Udefineret ændring",
	"mco.backup.entry.uploaded": "Uploadet",
	"mco.backup.entry.worldType": "Verdenstype",
	"mco.backup.entry.worldType.adventureMap": "Eventyr",
	"mco.backup.entry.worldType.experience": "Oplevelse",
	"mco.backup.entry.worldType.inspiration": "Inspiration",
	"mco.backup.entry.worldType.minigame": "Mini-spil",
	"mco.backup.entry.worldType.normal": "Normal",
	"mco.backup.entry.worldType.unknown": "Ukendt",
	"mco.backup.generate.world": "Generer verden",
	"mco.backup.info.title": "Ændringer fra sidste sikkerhedskopi",
	"mco.backup.narration": "Sikkerhedskopi fra %s",
	"mco.backup.nobackups": "Dennee Realm har i øjeblikket ingen sikkerhedskopier.",
	"mco.backup.restoring": "Genskaber din Realm",
	"mco.backup.unknown": "UKENDT",
	...
	"mco.brokenworld.message.line2": "Du kan også vælge at downloade verdenen til singleplayer.",
	"mco.brokenworld.minigame.title": "Dette minigame er ikke længere understøttet",
	"mco.brokenworld.nonowner.error": "Vent venligst på, at Realm ejeren nulstiller verdenen",
	...
	"mco.client.outdated.stable.version": "Din klientversion (%s) er ikke kompatibel med Realms.\n\nBrug venligst den seneste version af Minecraft.",
	"mco.client.unsupported.snapshot.version": "Din klientversion (%s) er ikke kompatibel med Realms.\n\nRealms er ikke tilgængelig for denne snapshot version.",
	"mco.compatibility.downgrade": "Nedgrader",
	"mco.compatibility.downgrade.description": "Denne verden var sidst spillet i version %s, du er på version %s. Nedgradering af en verden kan forårsage korruption - vi kan ikke garantere at den vil indlæse eller virke. \n\nEn backup af din verden vil blive gemt under \"Sikkerhedskopier\". Gendan venligst din verden om nødvendigt.",
	"mco.compatibility.incompatible.popup.title": "Inkompatibel version",
	"mco.compatibility.incompatible.releaseType.popup.message": "Verdenen du forsøger at tilslutte er inkompatibel med den version du er på.",
	"mco.compatibility.incompatible.series.popup.message": "Denne verden blev sidst spillet i version %s; du er på version %s.\n\nDisse serier er ikke kompatible med hinanden. En ny verden er nødvendig for at spille på denne version.",
	"mco.compatibility.unverifiable.message": "Versionen, som denne verden sidst blev spillet i, kunne ikke blive bekræftet. Hvis verdenen opgraderes eller nedgraderes, oprettes der automatisk en sikkerhedskopi, som gemmes under \"Sikkerhedskopier\".",
	"mco.compatibility.unverifiable.title": "Kompatibilitet er ikke verificerbar",
	"mco.compatibility.upgrade": "Opgrader",
	"mco.compatibility.upgrade.description": "Denne verden blev sidst spillet i version %s; du er på version %s.\n\nEn sikkerhedskopi af din verden vil blive gemt under \"Verdenssikkerhedskopier\". \n\nGendan venligst din verden om nødvendigt.",
	"mco.compatibility.upgrade.friend.description": "Denne verden blev sidst spillet i version %s; du er på version %s.\n\nEn sikkerhedskopi af verdenen vil blive gemt under \"Sikkerhedskopier\".\n\nEjeren af denne Realm kan gendanne verdenen hvis om nødvendigt.",
	"mco.compatibility.upgrade.title": "Ønsker du virkelig at opgraderer denne verden?",
	...
	"mco.configure.world.buttons.close": "Luk midlertidigt Realmen",
	...
	"mco.configure.world.buttons.newworld": "Ny verden",
	"mco.configure.world.buttons.open": "Genåbn Realm",
	"mco.configure.world.buttons.options": "Verdensindstillinger",
	"mco.configure.world.buttons.players": "Spillere",
	"mco.configure.world.buttons.region_preference": "Vælg region...",
	"mco.configure.world.buttons.resetworld": "Nulstil verden",
	"mco.configure.world.buttons.save": "Gem",
	...
	"mco.configure.world.close.question.line1": "Du kan midlertidigt lukke din Realm for at forhindre aktivitet mens du foretager justeringer. Åbn den op igen, når du er klar. \n\nDette opsiger ikke dit Realms-abonnement.",
	"mco.configure.world.close.question.line2": "Er du sikker på, at du vil gøre dette?",
	"mco.configure.world.close.question.title": "Har du brug for at foretage ændringer uden afbrydelser?",
	"mco.configure.world.closing": "Lukker midlertidigt Realmen...",
	"mco.configure.world.commandBlocks": "Kommandoblokke",
	"mco.configure.world.delete.button": "Slet Realm",
	"mco.configure.world.delete.question.line1": "Din Realm vil blive permanent slettet",
	...
	"mco.configure.world.forceGameMode": "Gennemtving spiltilstand",
	"mco.configure.world.invite.narration": "Du har %s nye invitation(er)",
	"mco.configure.world.invite.profile.name": "Navn",
	"mco.configure.world.invited": "Inviteret",
	"mco.configure.world.invited.number": "Inviterede (%s)",
	...
	"mco.configure.world.leave.question.line1": "Hvis du forlader denne Realm kan du ikke se den medmindre du inviteres igen",
	"mco.configure.world.leave.question.line2": "Er du sikker på, at du vil gøre dette?",
	"mco.configure.world.loading": "Indlæser Realm",
	"mco.configure.world.location": "Placering",
	"mco.configure.world.minigame": "Nuværende: %s",
	"mco.configure.world.name": "Realm navn",
	"mco.configure.world.name.validation.whitespace": "Må ikke starte eller slutte med et mellemrum. Det vil blive fjernet.",
	"mco.configure.world.opening": "Åbner Realmen...",
	"mco.configure.world.players.error": "En spiller med det angivne navn findes ikke",
	"mco.configure.world.players.invite.duplicate": "En spiller med det angivne navn er allerede blevet inviteret til Realmen",
	"mco.configure.world.players.inviting": "Inviterer spiller...",
	"mco.configure.world.players.title": "Spillere",
	"mco.configure.world.pvp": "PVP",
	"mco.configure.world.region_preference": "Regionspræference",
	"mco.configure.world.region_preference.title": "Valg af regionspræference",
	...
	"mco.configure.world.resourcepack.question": "Du skal have en tilpasset ressourcepakke for at spille på denne Realm. \n\nØnsker du at downloade den og spille?",
	"mco.configure.world.resourcepack.question.line1": "Denne Realm kræver en tilpasset ressourcepakke for at spille",
	...
	"mco.configure.world.settings.expired": "Du kan ikke redigere indstillingerne af en udløbet Realm",
	"mco.configure.world.settings.title": "Indstillinger",
	"mco.configure.world.slot": "Verden %s",
	"mco.configure.world.slot.empty": "Tom",
	"mco.configure.world.slot.switch.question.line1": "Din Realm vil blive skiftet til en anden verden",
	...
	"mco.configure.world.spawnAnimals": "Fremkald dyr",
	"mco.configure.world.spawnMonsters": "Fremkald monstre",
	"mco.configure.world.spawnNPCs": "Spawn NPC'er",
	"mco.configure.world.spawnProtection": "Spawnbeskyttelse",
	"mco.configure.world.spawn_toggle.message": "Slås denne indstilling fra, vil alle eksisterende objekter af den type fjernes",
	"mco.configure.world.spawn_toggle.message.npc": "Slås denne indstilling fra, vil alle eksisterende objekter af den type fjernes, såsom landsbyboere",
	...
	"mco.configure.world.subscription.recurring.info": "Ændringer foretaget til dit Realms-abonnement, såsom stabletid eller deaktivering af tilbagevendende fakturering, afspejles ikke før din næste faktureringsdato.",
	"mco.configure.world.subscription.remaining.days": "%[1]s dag(e)",
	"mco.configure.world.subscription.remaining.months": "%[1]s måned(er)",
	"mco.configure.world.subscription.remaining.months.days": "%[1]s måned(er), %[2]s dag(e)",
	...
	"mco.configure.world.subscription.title": "Dit abonnement",
	"mco.configure.world.subscription.unknown": "Ukendt",
	"mco.configure.world.switch.slot": "Opret verden",
	"mco.configure.world.switch.slot.subtitle": "Denne verden er tom. Vælg hvordan du vil lave din verden",
	"mco.configure.world.title": "Konfigurer Realm:",
	"mco.configure.world.uninvite.player": "Er du sikker på, at du vil annullere invitationen til %s'?",
	...
	"mco.connect.connecting": "Forbinder til Realmen...",
	"mco.connect.failed": "Kunne ikke oprette forbindelse til Realmen",
	...
	"mco.create.world.failed": "Kunne ikke oprette verdenen!",
	"mco.create.world.reset.title": "Opretter verden...",
	"mco.create.world.skip": "Spring over",
	"mco.create.world.subtitle": "Valgfrit, vælg hvilken verden der skal sættes på din nye Realm",
	...
	"mco.download.confirmation.oversized": "Verdenen du kommer til at downloade er større end %s\n\nDu vil ikke kunne uploade denne verden til din Realm igen",
	...
	"mco.download.resourcePack.fail": "Kunne ikke downloade ressourcepakke!",
	...
	"mco.error.invalid.session.title": "Ugyldig session",
	...
	"mco.errorMessage.6006": "Verden er forældet",
	"mco.errorMessage.6007": "Bruger i for mange Realms",
	"mco.errorMessage.6008": "Ugyldigt Realm navn",
	"mco.errorMessage.6009": "Ugyldig Realm beskrivelse",
	"mco.errorMessage.connectionFailure": "En fejl opstod. Prøv venligst igen senere.",
	"mco.errorMessage.generic": "Der skete en fejl: ",
	"mco.errorMessage.initialize.failed": "Kunne ikke initialisere Realm",
	"mco.errorMessage.noDetails": "Ingen fejloplysninger opgivet",
	"mco.errorMessage.realmsService": "Der skete en fejl (%s):",
	"mco.errorMessage.realmsService.configurationError": "En uventet fejl opstod under redigering af verdensindstillinger",
	"mco.errorMessage.realmsService.connectivity": "Kunne ikke forbinde til Realms: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Kunne ikke tjekke kompatibel version. Fik respons: %s",
	"mco.errorMessage.retry": "Prøv operationen igen",
	...
	"mco.minigame.world.restore": "Aflutter mini-spil...",
	"mco.minigame.world.restore.question.line1": "Mini-spillet vil slutte og din Realm vil blive genoprettet.",
	...
	"mco.minigame.world.stopButton": "Afslut mini-spillet",
	...
	"mco.notification.transferSubscription.buttonText": "Overfør nu",
	"mco.notification.transferSubscription.message": "Java Realms-abonnementer flyttes til Microsoft Store. Lad ikke dit abonnement udløbe!\nOverfør nu og få 30 dage med Realms gratis. \nGå til \"Profil\" på minecraft.net for at overføre dit abonnement.",
	...
	"mco.onlinePlayers": "Online spillere",
	"mco.play.button.realm.closed": "Realmen er lukket",
	"mco.question": "Spørgsmål",
	...
	"mco.reset.world.template": "Verdensskabeloner",
	"mco.reset.world.title": "Nulstil verden",
	"mco.reset.world.upload": "Upload verden",
	"mco.reset.world.warning": "Dette vil erstatte den nuværende verden på din Realm",
	"mco.selectServer.buy": "Køb en Realm!",
	"mco.selectServer.close": "Luk",
	"mco.selectServer.closed": "Deaktiveret Realm",
	...
	"mco.selectServer.create.subtitle": "Vælg hvilken verden som skal bruges på din nye Realm",
	...
	"mco.selectServer.loading": "Indlæser Realmsliste",
	"mco.selectServer.mapOnlySupportedForVersion": "Denne verden er ikke understøttet i %s",
	"mco.selectServer.minigame": "Mini-spil:",
	"mco.selectServer.minigameName": "Mini-spil: %s",
	"mco.selectServer.minigameNotSupportedInVersion": "Kan ikke spille dette mini-spil i %s",
	"mco.selectServer.noRealms": "Det ser ud til du ikke har en Realm. Tilføj en Realm for at spille sammen med dine venner.",
	...
	"mco.selectServer.popup": "Realms er en sikker, simpel måde at nyde en online Minecraft-verden med op til ti venner ad gangen. Det understøtter en masse mini-spil og forskellige spillerskabte verdener! Kun ejeren af Realmen skal betale.",
	"mco.selectServer.purchase": "Tilføj Realm",
	"mco.selectServer.trial": "Få en prøveperiode!",
	"mco.selectServer.uninitialized": "Klik for at starte din nye Realm!",
	"mco.snapshot.createSnapshotPopup.text": "Du er ved at oprette en gratis snapshot Realm, som vil blive parret med dit betalte Realmsabonnement. Denne nye snapshot Realm vil være tilgængelig, så længe det betalte abonnement er aktivt. Din betalte Realm vil ikke blive påvirket.",
	"mco.snapshot.createSnapshotPopup.title": "Opret snapshot realm?",
	"mco.snapshot.creating": "Opretter snapshot Realm...",
	"mco.snapshot.description": "Parret med ''%s''",
	"mco.snapshot.friendsRealm.downgrade": "Du skal være på version %s for at tilslutte denne Realm",
	"mco.snapshot.friendsRealm.upgrade": "%s skal opgradere deres Realm før du kan spille fra denne version",
	"mco.snapshot.paired": "Denne snapshot Realm er parret med %s",
	"mco.snapshot.parent.tooltip": "Brug den seneste udgivelse af Minecraft for at spille på denne Realm",
	"mco.snapshot.start": "Start gratis snapshot Realm",
	"mco.snapshot.subscription.info": "Dette er en snapshot Realm der er parret med abonnementet på din Realm '%s'. Den forbliver aktiv så længe dens parret Realm er.",
	"mco.snapshot.tooltip": "Brug snapshot Realms til at få et smugkig på kommende versioner af Minecraft, der muligvis indeholder nye funktioner og andre ændringer.\n\nDu kan finde dine normale Realms i den udgivet version af spillet.",
	"mco.snapshotRealmsPopup.message": "Realms er nu tilgængelige i snapshots fra snapshot 23w41a. Hver Realms-abonnement kommer med en gratis snapshot Realm der er adskilt fra din normale Java Realm!",
	"mco.snapshotRealmsPopup.title": "Realms er nu tilgængelig i snapshots",
	"mco.snapshotRealmsPopup.urlText": "Lær mere",
	...
	"mco.time.daysAgo": "%[1]s dag(e) siden",
	"mco.time.hoursAgo": "%[1]s time(r) siden",
	"mco.time.minutesAgo": "%[1]s minut(ter) siden",
	"mco.time.now": "lige nu",
	"mco.time.secondsAgo": "%[1]s sekund(er) siden",
	"mco.trial.message.line1": "Vil du have din egen Realm?",
	"mco.trial.message.line2": "Klik her for mere info!",
	"mco.upload.button.name": "Upload",
	"mco.upload.cancelled": "Upload annulleret",
	"mco.upload.close.failure": "Kunne ikke lukke din Realm, prøv venligst igen senere.",
	...
	"mco.upload.failed.too_big.description": "Den valgte verden er for stor. Den maksimalt tilladte størrelse er %s.",
	"mco.upload.failed.too_big.title": "Verdenen er for stor",
	...
	"mco.upload.select.world.subtitle": "Vælg venligst en singleplayer-verden at uploade",
	...
	"mco.worldSlot.minigame": "Mini-spil",
	"menu.custom_options": "Tilpassede indstillinger...",
	"menu.custom_options.title": "Tilpassede indstillinger",
	"menu.custom_options.tooltip": "Bemærk: Tilpassede indstillinger leveres af tredjepartsservere og/eller -indhold.\nHåndter med omhu!",
	"menu.custom_screen_info.button_narration": "Dette er en brugerdefineret skærm. Lær mere.",
	"menu.custom_screen_info.contents": "Indholdet på denne skærm styres af tredjepartsservere og -baner, som ikke ejes, drives eller overvåges af Mojang Studios eller Microsoft.\n\nHåndter med omhu! Vær altid forsigtig når du følger links, og giv aldrig dine personlige oplysninger væk, herunder login-oplysninger.\n\nHvis denne skærm forhindrer dig i at spille, kan du også afbryde fra den aktuelle server ved at bruge knappen nedenfor.",
	"menu.custom_screen_info.disconnect": "Brugerdefineret skærm afvist",
	"menu.custom_screen_info.title": "Bemærkning om brugerdefinerede skærme",
	"menu.custom_screen_info.tooltip": "Dette er en brugerdefineret skærm. Klik her for at lære mere.",
	"menu.disconnect": "Afbryd",
	"menu.feedback": "Tilbagemelding...",
	"menu.feedback.title": "Tilbagemelding",
	"menu.game": "Spil menu",
	"menu.modded": " (Moddet)",
	"menu.multiplayer": "Multiplayer",
	"menu.multiplayerOptions.applyChanges": "Anvend ændringer",
	"menu.multiplayerOptions.button": "Multiplayer...",
	"menu.multiplayerOptions.network": "Multiplayer",
	"menu.multiplayerOptions.network.header": "Netværk",
	"menu.multiplayerOptions.network.lan": "LAN",
	"menu.multiplayerOptions.network.lan.tooltip": "Spillere på det samme netværk kan tilslutte.",
	"menu.multiplayerOptions.network.off": "FRA",
	"menu.multiplayerOptions.network.off.tooltip": "Ingen kan deltage.",
	"menu.multiplayerOptions.network.online": "Online",
	"menu.multiplayerOptions.network.online.tooltip": "Venner online kan deltage.",
	"menu.multiplayerOptions.otherPlayers.header": "Andre spillere",
	"menu.multiplayerOptions.publish.started.lan": "Denne verden er nu åben for LAN. Portnummeret er %s",
	"menu.multiplayerOptions.publish.started.online": "Denne verden er nu åben for multiplayer.",
	"menu.multiplayerOptions.publish.stopped": "Denne verden er ikke længere åben for multiplayer",
	"menu.multiplayerOptions.title": "Indstillinger for multiplayer",
	...
	"menu.playerReporting.no_players": "Der er ingen spillere at rapportere i denne verden",
	"menu.preparingSpawn": "Klargører spawnposition: %s%%",
	"menu.quick_actions": "Hurtige handlinger...",
	"menu.quick_actions.title": "Hurtige handlinger",
	...
	"menu.server_links": "Serverlinks...",
	"menu.server_links.title": "Serverlinks",
	...
	"multiplayer.codeOfConduct.check": "Underret ikke igen om dette adfærdskodeks",
	"multiplayer.codeOfConduct.title": "Serveradfærdskodeks",
	"multiplayer.confirm_command.parse_errors": "Du forsøger at udføre en ukendt eller ugyldig kommando.\nEr du sikker?\nKommando: %s",
	"multiplayer.confirm_command.permissions_required": "Du forsøger at udføre en kommando der kræver udvidede tilladelser.\nDette kan muligvis påvirke dit spil negativt.\nEr du sikker?\nKommando: %s",
	"multiplayer.confirm_command.run_command": "Kør kommando",
	"multiplayer.confirm_command.signature_required": "Du forsøger at udføre en kommando der vil sende chatbeskeder i dit navn.\nDette kan kun køres fra chatskærmen.\nKommando: %s",
	"multiplayer.confirm_command.suggest_command": "Kopier til chatskærm",
	"multiplayer.confirm_command.title": "Bekræft kommandoudførelse",
	"multiplayer.disconnect.authservers_down": "Godkendelsesservere er nede. Prøv venligst igen senere. Beklager!",
	"multiplayer.disconnect.bad_chat_index": "Registrerede en manglende eller reorganiseret chatbesked fra serveren",
	...
	"multiplayer.disconnect.banned.reason.default": "Bandlyst af en operatør.",
	...
	"multiplayer.disconnect.code_of_conduct": "Serveren kræver, at adfærdskodekset accepteres",
	"multiplayer.disconnect.configuration_error": "Uventet fejl under konfigurationen",
	...
	"multiplayer.disconnect.invalid_public_key_signature.new": "Ugyldig signatur for offentlig profilnøgle.\nPrøv at genstarte dit spil.",
	...
	"multiplayer.disconnect.missing_tags": "Ukomplet sæt af mærker modtaget fra serveren.\nKontakt venligst en server operatør.",
	...
	"multiplayer.disconnect.out_of_order_chat": "Den modtaget chat-pakke er ude af rækkefølge. Har din systemtid ændret sig?",
	...
	"multiplayer.disconnect.transfers_disabled": "Denne server accepterer ikke overførsler",
	"multiplayer.disconnect.unexpected_query_response": "Uventede brugerdefinerede data fra klienten",
	"multiplayer.disconnect.unsigned_chat": "Modtog en chat-pakke med en manglende eller ugyldig signatur.",
	...
	"multiplayer.requiredTexturePrompt.disconnect": "Denne server påkræver en tilpasset ressourcepakke",
	...
	"multiplayer.status.anonymous_player": "Anonym spiller",
	...
	"multiplayer.texturePrompt.line1": "Denne server anbefaler brug af en tilpasset ressourcepakke.",
	...
	"multiplayerWarning.header": "Advarsel: onlinespil fra tredjeparter",
	"multiplayerWarning.message": "Advarsel: Onlinespil er tilbudt af tredjeparts servere som ikke er ejet, opereret eller overvåget af Mojang Studios eller Microsoft. Under online spil kan du muligvis blive udsat for umodererede chatbeskeder eller andre typer af brugergenereret indhold, som muligvis ikke er egnet til alle.",
	...
	"narration.checkbox.usage.focused.check": "Tryk Enter for at markere",
	"narration.checkbox.usage.focused.uncheck": "Tryk Enter for at afmarkere",
	"narration.checkbox.usage.hovered": "Venstre klik for at aktivere",
	"narration.checkbox.usage.hovered.check": "Venstreklik for at markere",
	"narration.checkbox.usage.hovered.uncheck": "Venstreklik for at afmarkere",
	"narration.component_list.usage": "Tryk på Tab for at navigere til det næste element",
	...
	"narration.item": "Genstand: %s",
	"narration.link.usage.focused": "Tryk Enter for at følge linket",
	"narration.link.usage.hovered": "Venstreklik for at følge linket",
	...
	"narration.slider.usage.focused": "Tryk på venstre eller højre tastaturknapper for at skifte værdien",
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Tryk Enter for at begynde at ændre skyderens værdi",
	"narration.slider.usage.hovered": "Træk skyderen for at ændre dens værdi",
	"narration.suggestion": "Valgte forslag %s ud af %s: %s",
	"narration.suggestion.tooltip": "Valgte forslag %s ud af %s: %s (%s)",
	"narration.suggestion.usage.cycle.fixed": "Tryk på Tab for at skifte til næste forslag",
	"narration.suggestion.usage.cycle.hidable": "Tryk på Tab for at skifte til næste forslag, eller Escape for at forlade forslagene",
	"narration.suggestion.usage.fill.fixed": "Tryk på Tab for at bruge forslaget",
	"narration.suggestion.usage.fill.hidable": "Tryk på Tab for at bruge forslaget, eller Escape for at forlade forslagene",
	"narration.tab_navigation.usage": "Tryk Ctrl og Tab for at skifte mellem faner",
	...
	"narrator.position.tab": "Valgte fane %s ud af %s",
	...
	"narrator.select.world": "Valgte %s, sidst spillet: %s, %s, %s, version: %s",
	"narrator.select.world_info": "Valgte %s, spillet sidst: %s, %s",
	"narrator.toast.disabled": "Oplæser deaktiveret",
	"narrator.toast.enabled": "Oplæser slået til",
	"optimizeWorld.confirm.description": "Dette vil forsøge at optimere din verden ved at sikre, at alt data gemmes i det nyeste spilformat. Dette kan tage meget lang tid, afhængigt af din verden. Når færdig, kører din verden muligvis hurtigere, men den vil ikke længere være kompatibel med ældre versioner af spillet. Er du sikker på, at du vil fortsætte?",
	"optimizeWorld.confirm.proceed": "Opret sikkerhedskopi og optimer",
	...
	"optimizeWorld.stage.finished": "Færdiggører...",
	"optimizeWorld.stage.finished.chunks": "Færdiggører opgraderingen af klodser...",
	"optimizeWorld.stage.finished.entities": "Færdiggører opgraderingen af objekter...",
	"optimizeWorld.stage.finished.poi": "Færdiggører opgraderingen af interessepunkter...",
	"optimizeWorld.stage.upgrading": "Opgraderer alle klodser...",
	"optimizeWorld.stage.upgrading.chunks": "Opgraderer alle klodser...",
	"optimizeWorld.stage.upgrading.entities": "Opgraderer alle objekter...",
	"optimizeWorld.stage.upgrading.poi": "Opgraderer alle interessepunkter...",
	"optimizeWorld.title": "Optimerer verden '%s'",
	"options.accessibility": "Tilgængelighedsindstillinger...",
	"options.accessibility.high_contrast": "Høj kontrast",
	"options.accessibility.high_contrast.error.tooltip": "Højkontrast-ressourcepakke er ikke tilgængelig.",
	"options.accessibility.high_contrast.tooltip": "Forbedrer kontrasten af UI-elementer.",
	"options.accessibility.high_contrast_block_outline": "Højkontrast-blokomrids",
	"options.accessibility.high_contrast_block_outline.tooltip": "Forbedrer kontrasten af blokomridset for den valgte blok.",
	"options.accessibility.link": "Tilgængelighedsguide",
	"options.accessibility.menu_background_blurriness": "Sløring af menubaggrund",
	"options.accessibility.menu_background_blurriness.tooltip": "Ændrer slørringen af menubaggrunde.",
	"options.accessibility.narrator_hotkey": "Oplæser genvejstast",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Tillader, at oplæseren kan slås til og fra med 'Cmd + B'.",
	"options.accessibility.narrator_hotkey.tooltip": "Tillader, at oplæseren kan slås til og fra med 'Ctrl + B'.",
	"options.accessibility.panorama_speed": "Panorama-rullehastighed",
	...
	"options.accessibility.tooltip": "Tilgængelighedsindstillinger",
	"options.allowCursorChanges": "Tillad markørændringer",
	"options.allowCursorChanges.tooltip": "Tillader, at musemarkøren ændrer form, når den holdes over bestemte grænsefladeelementer.",
	"options.allowFriendRequests": "Tillad anmodninger",
	"options.allowFriendRequests.tooltip": "Tillad andre spillere at sende dig venneanmodninger",
	"options.allowServerListing": "Tillad serverlistning",
	"options.allowServerListing.tooltip": "Servere kan angive online spillere som en del af deres offentlige status.\nMed denne indstilling slået fra, vises dit navn ikke på sådanne lister.",
	...
	"options.blocks": "%s blokke",
	"options.chat": "Chatindstillinger...",
	"options.chat.color": "Farver",
	"options.chat.delay": "Chatforsinkelse: %s sekund(er)",
	"options.chat.delay_none": "Chatforsinkelse: ingen",
	"options.chat.drafts": "Gem usendte chats",
	"options.chat.drafts.tooltip": "Usendte beskeder gemmes og kan sendes næste gang chatten åbnes.",
	...
	"options.chunkFade": "Klodsudtoningstid",
	"options.chunkFade.none": "Klodsudtoning: ingen",
	"options.chunkFade.seconds": "Klodsudtoning: %s sekund(er)",
	"options.chunkFade.tooltip": "Hvor lang tid i sekunder klodser skal tone ind, når de først renderes, hvis overhovedet.",
	"options.chunks": "%s klodser",
	"options.clouds.fancy": "Flot",
	"options.clouds.fast": "Hurtig",
	"options.controls": "Styring...",
	"options.credits_and_attribution": "Medvirkende og tilskrivning...",
	"options.cutoutLeaves": "Gennemsigtigt løv",
	"options.cutoutLeaves.tooltip": "Gør det muligt at se gennem mellemrum i løv. Deaktivering forbedrer ydeevnen.",
	"options.damageTiltStrength": "Skadehældning",
	...
	"options.darkMojangStudiosBackgroundColor.tooltip": "Ændrer baggrundsfarven på Mojang Studios indlæsningsskærm til sort.",
	...
	"options.difficulty.easy.info": "Fjendtlige væsener opstår men forårsager mindre skade. Sult tømmer og dræner dit helbred ned til 5 hjerter.",
	"options.difficulty.hard": "Svær",
	"options.difficulty.hard.info": "Fjendtlige væsener opstår og forårsager mere skade. Sult tømmer og dræner alt helbred.",
	"options.difficulty.hardcore": "Hardcore",
	"options.difficulty.normal": "Normal",
	"options.difficulty.normal.info": "Fjendtlige væsener opstår og forårsager normal skade. Sult tømmer og dræner dit helbred ned til halvandet hjerte.",
	"options.difficulty.online": "Server sværhedsgrad",
	"options.difficulty.peaceful": "Fredelig",
	"options.difficulty.peaceful.info": "Ingen fjendtlige væsener, kun neutrale væsener opstår. Du sulter aldrig ihjel og dit helbred fylder gradvist op med tiden.",
	...
	"options.exclusiveFullscreen": "Eksklusiv fuldskærm",
	"options.exclusiveFullscreen.warningTooltip": "Denne indstilling kan forhindre nogle inputmetoder i at fungere.",
	"options.font": "Skrifttypeindstillinger...",
	"options.font.title": "Skrifttypeindstillinger",
	...
	"options.friendsList": "Venneliste",
	"options.friendsList.confirm.message": "Brug din venneliste til at sende og modtage venneanmodninger.\n\nAdministrer dine online-sikkerhedsindstillinger med din %s.",
	"options.friendsList.confirm.message.link": "Microsoft-konto",
	"options.friendsList.confirm.title": "Venneliste",
	"options.friendsList.confirm.turnOff": "Slå FRA",
	"options.friendsList.confirm.turnOn": "Slå TIL",
	...
	"options.glintSpeed.tooltip": "Kontrollerer hvor hurtigt glimmeret bevæger sig over fortryllede genstande.",
	"options.glintStrength": "Glimmerstyrke",
	"options.glintStrength.tooltip": "Kontrollerer hvor gennemsigtigt glimmeret er på fortryllede genstande.",
	"options.graphics": "Grafik",
	"options.graphics.custom": "Brugerdefineret",
	"options.graphics.fabulous": "Fabelagtig!",
	"options.graphics.fabulous.tooltip": "%s grafik bruger skærmshadere til at tegne vejr, skyer og partikler bag gennemsigtige blokke og vand.\nDette kan have en stor indvirkning på ydeevnen for bærbare enheder og 4K-skærme.",
	...
	"options.graphics.preset": "Forudindstilling",
	"options.graphics.preset.tooltip": "Indstiller ''kvalitet & ydeevne''-indstillingerne til passende standarder i forhold til den ønskede kvalitet.",
	"options.graphics.warning.accept": "Fortsæt uden støtte",
	"options.graphics.warning.cancel": "Bring mig tilbage",
	...
	"options.graphicsApi.opengl": "Foretræk OpenGL",
	"options.graphicsApi.restart": "Du skal genstarte dit spil for at ændre grafik-API'en.",
	"options.graphicsApi.tooltip": "Hvilken grafik-API der skal bruges til rendering. Efterlad som standard medmindre du har et specifikt behov for at ændre dette!",
	"options.graphicsApi.tooltip.vulkan": "Eksperimentel. Kan reducere ydeevnen eller forårsage ustabilitet på visse systemer.",
	"options.graphicsApi.vulkan": "Foretræk Vulkan (eksperimentelt)",
	"options.guiScale": "GUI-skalering",
	"options.guiScale.auto": "Automatisk",
	"options.hidden": "Skjult",
	"options.hideLightningFlashes": "Skjul himmelglimt",
	"options.hideLightningFlashes.tooltip": "Forhindrer lyn eller andre miljøeffekter i at få himmelen til at blinke. Kilderne til blinkene vil stadig være synlige.",
	...
	"options.hideSplashTexts": "Skjul splash-tekster",
	"options.hideSplashTexts.tooltip": "Skjuler den gule splash-tekst i hovedmenuen.",
	"options.improvedTransparency": "Forbedret gennemsigtighed",
	"options.improvedTransparency.tooltip": "En eksperimentel tilgang, som anvender skærmshadere til at tegne vejr, skyer og partikler bag gennemsigtige blokke og vand.\nDette vil påvirke GPU-ydelsen.",
	"options.inGameNotification": "Spilnotifikation",
	"options.inGameNotification.tooltip": "Vis vennenotifikationer i spillet",
	"options.inactivityFpsLimit": "Reducer FPS, når",
	"options.inactivityFpsLimit.afk": "AFK",
	"options.inactivityFpsLimit.afk.tooltip": "Begrænser framerate til 30, når der ikke er nogen spillerinput i spillet i mere end et minut. Begrænses yderligere til 10 efter 9 minutter mere.",
	"options.inactivityFpsLimit.minimized": "Minimeret",
	"options.inactivityFpsLimit.minimized.tooltip": "Begrænser kun framerate, når spilvinduet er minimeret.",
	"options.invertMouse": "Spejlvend mus",
	"options.invertMouseX": "Inverter musens X-akse",
	"options.invertMouseY": "Inverter musens Y-akse",
	"options.japaneseGlyphVariants": "Japanske glyfvarianter",
	"options.japaneseGlyphVariants.tooltip": "Bruger japanske varianter af CJK-tegn i standardskrifttypen.",
	"options.key.hold": "Hold",
	"options.key.toggle": "Skift",
	"options.language": "Sprog...",
	"options.language.narration": "Skift sprog",
	"options.language.title": "Sprog",
	"options.language.tooltip": "Skift sprog",
	"options.languageAccuracyWarning": "(Oversættelserne er muligvis ikke 100%% nøjagtige)",
	...
	"options.maxAnisotropy": "Anisotropisk filtrering",
	"options.maxAnisotropy.tooltip": "Hvert niveau forbedrer markant, hvordan glatte teksturer ser ud, men påvirker ydeevnen og øger videohukommelsesforbruget betydeligt. Kræver, at teksturfiltrering sættes til anisotropisk.",
	...
	"options.musicToast": "Musiknotifikation",
	"options.musicToast.never": "Aldrig",
	"options.musicToast.never.tooltip": "Ingen musiknotifikation vises.",
	"options.musicToast.pauseMenu": "Pausemenu",
	"options.musicToast.pauseMenu.tooltip": "En musiknotifikation vises altid i pausemenuen i spillet, mens en sang afspilles.",
	"options.musicToast.pauseMenuAndToast": "Pausemenu og notifikationer",
	"options.musicToast.pauseMenuAndToast.tooltip": "Viser en notifikation, når en sang begynder at spille. Den samme notifikation vises altid i pausemenuen i spillet, mens en sang afspilles.",
	"options.music_frequency": "Musikhyppighed",
	"options.music_frequency.constant": "Konstant",
	"options.music_frequency.default": "Standard",
	"options.music_frequency.frequent": "Ofte",
	"options.music_frequency.tooltip": "Ændrer, hvor ofte musik afspilles i en spilverden.",
	...
	"options.needsRestart": "Kræver genstart af spillet for at træde i kraft.",
	"options.notifications.display_time": "Notifikationstid",
	...
	"options.online.friends.header": "Venneliste",
	"options.online.realms.header": "Realms",
	"options.online.servers.header": "Servere",
	"options.online.title": "Online indstillinger",
	"options.online.xboxSettings": "Xbox-indstillinger...",
	...
	"options.prioritizeChunkUpdates.nearby.tooltip": "Nærliggende klodser kompileres altid med det samme. Dette kan påvirke spillets ydeevne, når blokke placeres eller ødelægges.",
	...
	"options.realmsNotifications.button": "Nyheder og invitationer",
	"options.realmsNotifications.tooltip": "Henter Realms-nyheder og -invitationer på titelskærmen og viser deres respektive ikoner på Realms-knappen.",
	"options.reducedDebugInfo": "Mindsket fejlfindingsinfo",
	"options.renderClouds": "Skyer",
	"options.renderCloudsDistance": "Skyafstand",
	"options.renderDistance": "Synslængde",
	"options.resourcepack": "Ressourcepakker...",
	"options.restartRequired": "Nogle af dine ændringer kræver, at spillet genstartes for at træde i kraft.",
	"options.rotateWithMinecart": "Roter med minevogne",
	"options.rotateWithMinecart.tooltip": "Om spillerens synsfelt skal rotere med en drejende minevogn. Kun tilgængelig i verdener med den eksperimentelle indstilling 'Minevogns forbedringer' slået til.",
	...
	"options.sharePresence": "Tilstedeværelse",
	"options.sharePresence.all": "Alle",
	"options.sharePresence.all.tooltip": "Din tilstedeværelse deles med dine venner. Du vises som online og deler, hvad du laver.",
	"options.sharePresence.limited": "Begrænset",
	"options.sharePresence.limited.tooltip": "Deler begrænset tilstedeværelse. Du vises som online, men deler ikke, hvad du laver. Du kan stadig invitere venner til dit spil.",
	"options.sharePresence.none": "Ingen",
	"options.sharePresence.none.tooltip": "Deler ingen tilstedeværelse. Du vises som offline.",
	"options.showNowPlayingToast": "Vis musiknotifikation",
	"options.showNowPlayingToast.tooltip": "Viser en notifikation, når en sang begynder at spille. Den samme notifikation vises altid i pausemenuen i spillet, mens en sang afspilles.",
	"options.showSubtitles": "Undertekster",
	"options.showSubtitles.tooltip": "Aktiverer undertekster for lyde afspillet i spillet.",
	"options.simulationDistance": "Simuleringsafstand",
	"options.skinCustomisation": "Tilpas skin...",
	"options.skinCustomisation.title": "Tilpas skin",
	"options.sounds": "Musik & lyde...",
	"options.sounds.title": "Musik & lydindstillinger",
	"options.sprintWindow": "Sprintvindue",
	"options.sprintWindow.tooltip": "Tidsvindue i tiks hvor dobbelttryk på fremad-tasten aktiverer sprint.",
	...
	"options.telemetry.disabled": "Telemetri er deaktiveret.",
	"options.telemetry.state.all": "Alt",
	"options.telemetry.state.minimal": "Minimalt",
	"options.telemetry.state.none": "Intet",
	"options.textureFiltering": "Teksturfiltrering",
	"options.textureFiltering.anisotropic": "Anisotropisk",
	"options.textureFiltering.anisotropic.tooltip": "En hardwarebaseret filtreringsmetode, men den påvirker ydeevnen og øger videohukommelsesforbruget markant. Understøttes muligvis ikke på al hardware.",
	"options.textureFiltering.none": "Ingen",
	"options.textureFiltering.none.tooltip": "Teksturer vises uden filtrering. Blokke kan se slørede ud, når de ses fra en vinkel.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nEn shaderbaseret filtreringsmetode, der forbedrer teksturkvaliteten med en moderat påvirkning på ydeevnen.",
	"options.title": "Indstillinger",
	"options.touchscreen": "Touchscreen-tilstand",
	"options.value": "%s",
	"options.video": "Videoindstillinger...",
	"options.video.display.header": "Skærmvisning",
	"options.video.interface.header": "Interface",
	"options.video.preferences.header": "Præferencer",
	"options.video.quality.header": "Kvalitet & ydeevne",
	"options.videoTitle": "Videoindstillinger",
	"options.viewBobbing": "Vis gangbevægelse",
	"options.vignette": "Vis vignet",
	"options.vignette.tooltip": "Dette er en diskret tekstur over spilskærmen, som bruges til at reducere lysstyrken mod skærmens kanter og advare om verdensgrænsen.",
	"options.visible": "Vist",
	"options.vsync": "VSync",
	"options.weatherRadius": "Vejreffekt-radius",
	"options.weatherRadius.tooltip": "Radius af det område, hvor regn- og sneeffekter er synlige. Meget lille indvirkning på ydeevnen.",
	"options.worldOptions.button": "Verdensindstillinger...",
	"options.worldOptions.title": "Verdensindstillinger",
	...
	"pack.dropRejected.message": "Følgende indgange var ikke gyldige pakker og blev ikke kopieret:\n%s",
	"pack.dropRejected.title": "Ikke-pakke indgange",
	...
	"pack.incompatible.confirm.unknown": "Denne pakke er defekt eller lavet til en ukendt version af Minecraft og fungerer muligvis ikke korrekt.",
	...
	"pack.incompatible.unknown": "(Ødelagt eller inkompatibel)",
	...
	"painting.minecraft.endboss.title": "Slutboss",
	"painting.minecraft.fern.author": "Kristoffer Zetterstrand",
	"painting.minecraft.fern.title": "Bregne",
	"painting.minecraft.fighters.author": "Kristoffer Zetterstrand",
	"painting.minecraft.fighters.title": "Kæmpere",
	"painting.minecraft.finding.author": "Kristoffer Zetterstrand",
	"painting.minecraft.finding.title": "Fund",
	"painting.minecraft.fire.author": "Mojang",
	"painting.minecraft.fire.title": "Ild",
	"painting.minecraft.graham.author": "Kristoffer Zetterstrand",
	"painting.minecraft.graham.title": "Graham",
	"painting.minecraft.humble.author": "Sarah Boeving",
	"painting.minecraft.humble.title": "Ydmyg",
	...
	"painting.minecraft.match.title": "Tændstik",
	...
	"painting.minecraft.orb.title": "Kugle",
	...
	"painting.minecraft.pigscene.title": "Grisescene",
	"painting.minecraft.plant.author": "Kristoffer Zetterstrand",
	"painting.minecraft.plant.title": "Paradisträd",
	"painting.minecraft.pointer.author": "Kristoffer Zetterstrand",
	"painting.minecraft.pointer.title": "Pegefinger",
	...
	"parsing.bool.invalid": "Ugyldig sandhedsværdi: forventede 'true' eller 'false' men fandt '%s'",
	...
	"particle.invalidOptions": "Kan ikke fortolke partikelindstillinger: %s",
	...
	"quickplay.error.invalid_identifier": "Kunne ikke finde verden med den angivet identifikator",
	"quickplay.error.realm_connect": "Kunne ikke forbinde til Realm",
	"quickplay.error.realm_permission": "Mangler tilladelse til at forbinde til denne Realm",
	"quickplay.error.title": "Hurtigt-spil mislykkedes",
	"realms.configuration.region.australia_east": "New South Wales, Australien",
	"realms.configuration.region.australia_southeast": "Victoria, Australien",
	"realms.configuration.region.brazil_south": "Brasilien",
	"realms.configuration.region.central_india": "Indien",
	...
	"realms.configuration.region.france_central": "Frankrig",
	"realms.configuration.region.japan_east": "Østjapan",
	"realms.configuration.region.japan_west": "Vestjapan",
	"realms.configuration.region.korea_central": "Sydkorea",
	...
	"realms.configuration.region.sweden_central": "Sverige",
	"realms.configuration.region.uae_north": "Forenede Arabiske Emirater (FAE)",
	"realms.configuration.region.uk_south": "Sydengland",
	...
	"realms.configuration.region_preference.automatic_owner": "Automatisk (Realm-ejerens ping)",
	"realms.configuration.region_preference.automatic_player": "Automatisk (første til at tilslutte sessionen)",
	...
	"recipe.toast.title": "Nye opskrift(er) oplåst!",
	"record.nowPlaying": "Spiller nu: %s",
	"recover_world.bug_tracker": "Rapporter en fejl",
	"recover_world.button": "Forsøg at gendanne",
	"recover_world.done.failed": "Kunne ikke gendanne fra tidligere tilstand.",
	"recover_world.done.success": "Gendannelsen lykkedes!",
	"recover_world.done.title": "Gendannelse færdig",
	"recover_world.issue.missing_file": "Mangler fil",
	"recover_world.issue.none": "Ingen problemer",
	"recover_world.message": "Følgende problemer opstod da der blev forsøgt at læse verdensmappen \"%s\". \nDet kan være muligt at gendanne verden fra en ældre tilstand, eller du kan rapporterer dette problem på bug trackeren.",
	"recover_world.no_fallback": "Ingen tilgængelig tilstand at gendanne fra",
	"recover_world.restore": "Forsøg at gendan",
	"recover_world.restoring": "Forsøger at gendanne verden...",
	"recover_world.state_entry": "Tilstand fra %s: ",
	"recover_world.state_entry.unknown": "ukendt",
	"recover_world.title": "Kunne ikke indlæse verden",
	"recover_world.warning": "Kunne ikke indlæse verdensresumé",
	...
	"resourcePack.runtime_failure": "Ressourcepakkefejl registreret",
	"resourcePack.server.name": "Verdenspecifikke ressourcer",
	"resourcePack.title": "Vælg ressourcepakke",
	"resourcePack.vanilla.description": "Minecrafts standardudseende og -fornemmelse",
	"resourcePack.vanilla.name": "Standard",
	"resourcepack.downloading": "Downloader ressourcepakke",
	"resourcepack.progress": "Henter fil (%s MB)...",
	"resourcepack.requesting": "Laver forspørgelse...",
	"restrictions_screen.button": "Begrænsninger...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Du kan modtage beskeder fra spillere",
	"restrictions_screen.permission.receive_player_messages.denied": "Du kan ikke modtage beskeder fra spillere",
	"restrictions_screen.permission.receive_system_messages.allowed": "Du kan modtage systemmeddelelser fra serveren",
	"restrictions_screen.permission.receive_system_messages.denied": "Du kan ikke modtage systemmeddelelser fra serveren",
	"restrictions_screen.permission.send_commands.allowed": "Du kan sende kommandoer",
	"restrictions_screen.permission.send_commands.denied": "Du kan ikke sende kommandoer",
	"restrictions_screen.permission.send_messages.allowed": "Du kan sende chatbeskeder",
	"restrictions_screen.permission.send_messages.denied": "Du kan ikke sende chatbeskeder",
	"restrictions_screen.title": "Begrænsninger",
	...
	"selectWorld.allowCommands.new": "Tillad kommandoer",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Opret en sikkerhedskopi før denne verden opdateres?",
	...
	"selectWorld.backupWarning.downgrade": "Denne verden blev sidst spillet i version %s; du er på version %s. Nedgradering af en verden kan forårsage korruption - vi kan ikke garantere at den vil indlæse eller virke. Hvis du stadig vil fortsætte, så lav venligst en sikkerhedskopi.",
	...
	"selectWorld.backupWarning.file_fixing_required": "Denne verden skal opdateres før du kan spille den. Vi anbefaler kraftigt, at oprette en sikkerhedskopi før du fortsætter, i tilfælde af at din verden skulle blive beskadiget.",
	"selectWorld.backupWarning.snapshot": "Denne verden blev sidst spillet i version %s; du er på version %s. Opret venligst en sikkerhedskopi i tilfælde af, at din verden skulle blive beskadiget.",
	"selectWorld.bonusItems": "Bonus-kiste",
	"selectWorld.cheats": "Snyd",
	"selectWorld.commands": "Kommandoer",
	...
	"selectWorld.experimental.details.title": "Eksperimentelle funktions-krav",
	"selectWorld.experimental.message": "Vær forsigtig!\nDenne konfiguration kræver funktioner, der stadig er under udvikling. Din verden kan nedbryde, gå i stykker, eller ikke fungere med fremtidige opdateringer.",
	...
	"selectWorld.gameMode.adventure.info": "Det samme som Overlevelse, men blokke kan ikke placeres eller fjernes.",
	...
	"selectWorld.gameMode.creative.info": "Skab, byg og udforsk uden grænser. Du kan flyve, have uendelige materialer og kan ikke skades af monstre.",
	...
	"selectWorld.gameMode.hardcore.info": "Overlevelsestilstand låst til \"Svær\" sværhedsgrad. Du kan ikke genopstå hvis du dør.",
	...
	"selectWorld.gameMode.spectator.info": "Du kan se, men ikke røre.",
	"selectWorld.gameMode.spectator.line1": "Du kan se, men ikke røre",
	"selectWorld.gameMode.survival": "Overlevelse",
	"selectWorld.gameMode.survival.info": "Udforsk en mystisk verden, hvor du bygger, indsamler, fremstiller og bekæmper monstre.",
	...
	"selectWorld.incompatible.description": "Denne verden kan ikke åbnes i denne version.\nDen blev sidst spillet i version %s.",
	"selectWorld.incompatible.info": "Inkompatibel version: %s",
	"selectWorld.incompatible.title": "Inkompatibel version",
	"selectWorld.incompatible.tooltip": "Denne verden kan ikke åbnes, fordi den blev oprettet af en inkompatibel version.",
	...
	"selectWorld.recreate.customized.text": "Brugertilpasset verdener er ikke længere understøttet i denne version af Minecraft. Vi kan forsøge at genskabe den med samme seed og egenskaber, men alle terræntilpasninger vil gå tabt. Vi beklager ulejligheden!",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Denne verden skal opdateres til den seneste version før du kan redigere den, på grund af underlæggene ændringer i verdensformatet.",
	"selectWorld.requiresFileFixingTooltip.play": "Denne verden skal opdateres til den seneste version før du kan spille den, på grund af underlæggene ændringer i verdensformatet.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Denne verden skal opdateres til den seneste version før du kan genskabe den, på grund af underlæggene ændringer i verdensformatet.",
	"selectWorld.resource_load": "Forbereder ressourcer...",
	...
	"selectWorld.tooltip.fromNewerVersion2": "og indlæsning af det kan forårsage problemer!",
	...
	"selectWorld.upgrade_and_play": "Opdater og spil",
	...
	"selectWorld.waitingForBackup.message": "Afhængigt af størrelsen på din verden kan dette tage noget tid. Luk venligst ikke spillet eller sluk din enhed.",
	"selectWorld.waitingForBackup.title": "Opretter sikkerhedskopi",
	...
	"selectWorld.warning.lowDiskSpace.description": "Din enhed er ved at løbe tør for diskplads.\nHvis du løber tør for diskplads mens spillet kører, kan det medføre, at din verden bliver beskadiget.",
	"selectWorld.warning.lowDiskSpace.title": "Advarsel! Lav diskplads!",
	"selectWorld.world": "Verden",
	"selectWorld.world_gen_settings_access": "Filen med verdensgenereringsindstillinger kunne ikke læses eller tilgås! %s",
	"selecteWorld.backupRequiredTooltip": "Indlæsning af verdenen kræver, at der først oprettes en sikkerhedskopi",
	...
	"slot.only_single_allowed": "Kun enkelte felter tilladt: fik '%s'",
	"slot.unknown": "Ukendt plads '%s'",
	"snbt.parser.empty_key": "Nøgle kan ikke være tom",
	"snbt.parser.expected_binary_numeral": "Forventede et binært tal",
	"snbt.parser.expected_decimal_numeral": "Forventede et decimaltal",
	"snbt.parser.expected_float_type": "Forventede et flydende pointtal",
	"snbt.parser.expected_hex_escape": "Forventede et bogstav af længden %s",
	"snbt.parser.expected_hex_numeral": "Forventede et hexadecimalttal",
	"snbt.parser.expected_integer_type": "Forventede et heltal",
	"snbt.parser.expected_non_negative_number": "Forventede et ikke-negativt tal",
	"snbt.parser.expected_number_or_boolean": "Forventede et tal eller en boolsk værdi",
	"snbt.parser.expected_string_uuid": "Forventede en streng, der repræsenterer et gyldigt UUID",
	"snbt.parser.expected_unquoted_string": "Forventede en gyldig streng uden anførelsestegn",
	"snbt.parser.infinity_not_allowed": "Uendelige tal er ikke tilladt",
	"snbt.parser.invalid_array_element_type": "Ugyldig arrayelement-type",
	"snbt.parser.invalid_character_name": "Ugyldig unicode-karakternavn",
	"snbt.parser.invalid_codepoint": "Ugyldig unicode-karakterværdi: %s",
	"snbt.parser.invalid_string_contents": "Ugyldigt strengindhold",
	"snbt.parser.invalid_unquoted_start": "Strenge uden anførelsestegn kan ikke starte med cifrene 0-9, + eller -",
	"snbt.parser.leading_zero_not_allowed": "Decimaltal kan ikke starte med 0",
	"snbt.parser.no_such_operation": "Sådan en operation findes ikke: %s",
	"snbt.parser.number_parse_failure": "Kunne ikke fortolke nummer: %s",
	"snbt.parser.undescore_not_allowed": "Understreget bogstaver er ikke tilladt i starten, eller slutningen, af et nummer",
	...
	"soundCategory.ui": "Brugergrænseflade",
	"soundCategory.voice": "Oplæser/stemme",
	...
	"stat.minecraft.clean_shulker_box": "Shulkerbokse rengjort",
	...
	"stat.minecraft.happy_ghast_one_cm": "Afstand fløjet med glad ghast",
	...
	"stat.minecraft.nautilus_one_cm": "Afstand på nautil",
	...
	"stat.minecraft.open_shulker_box": "Shulkerbokse åbnet",
	...
	"structure_block.custom_data": "Brugerdefineret datamærke navn",
	"structure_block.detect_size": "Identificer strukturstørrelse og position:",
	...
	"structure_block.include_entities": "Inkluder objekter:",
	...
	"structure_block.mode_info.data": "Datatilstand - Spil logikmarkering",
	"structure_block.mode_info.load": "Indlæsetilstand - Indlæs fra fil",
	"structure_block.mode_info.save": "Gemmetilstand - skriv til fil",
	...
	"structure_block.size_failure": "Kunne ikke finde strukturens størrelse. Tilføj hjørner med matchende strukturnavn",
	"structure_block.size_success": "Størrelse registreret for '%s'",
	"structure_block.strict": "Streng placering:",
	"structure_block.structure_name": "Strukturnavn",
	"subtitles.ambient.cave": "Uhyggelig lyd",
	"subtitles.ambient.sound": "Uhyggelig lyd",
	"subtitles.block.amethyst_block.chime": "Ametyst klinger",
	"subtitles.block.amethyst_block.resonate": "Ametyst ringer",
	...
	"subtitles.block.candle.extinguish": "Stearinlys slukkes",
	...
	"subtitles.block.copper_bulb.turn_off": "Kobberpære slukkes",
	"subtitles.block.copper_bulb.turn_on": "Kobberpære tændes",
	"subtitles.block.copper_chest.close": "Kiste lukker",
	"subtitles.block.copper_chest.open": "Kiste åbner",
	"subtitles.block.copper_trapdoor.close": "Lem lukker",
	"subtitles.block.copper_trapdoor.open": "Lem åbner",
	"subtitles.block.crafter.craft": "Fabrikant fabrikerer",
	"subtitles.block.crafter.fail": "Fabrikant fejler fabrikationen",
	"subtitles.block.creaking_heart.hurt": "Knirkende hjerte brummer",
	"subtitles.block.creaking_heart.idle": "Uhyggelig lyd",
	"subtitles.block.creaking_heart.spawn": "Knirkende hjerte vågner",
	"subtitles.block.deadbush.idle": "Tørre lyde",
	"subtitles.block.decorated_pot.insert": "Dekoreret potte fyldes",
	"subtitles.block.decorated_pot.insert_fail": "Dekoreret potte vakler",
	"subtitles.block.decorated_pot.shatter": "Dekoreret potte knuser",
	...
	"subtitles.block.dried_ghast.ambient": "Tørre lyde",
	"subtitles.block.dried_ghast.ambient_water": "Udtørret ghast hydreres",
	"subtitles.block.dried_ghast.place_in_water": "Udtørret ghast optager vand",
	"subtitles.block.dried_ghast.transition": "Udtørret ghast får det bedre",
	"subtitles.block.dry_grass.ambient": "Vindlyde",
	...
	"subtitles.block.eyeblossom.close": "Øjeblomst lukker",
	"subtitles.block.eyeblossom.idle": "Øjeblomst hvisker",
	"subtitles.block.eyeblossom.open": "Øjeblomst åbner",
	...
	"subtitles.block.firefly_bush.idle": "Ildfluer summer",
	...
	"subtitles.block.generic.fall": "Noget falder på en blok",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Skilt vakler",
	...
	"subtitles.block.pale_hanging_moss.idle": "Uhyggelig lyd",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Svovlkilde går i udbrud",
	"subtitles.block.potent_sulfur.noxious_gas": "Giftig gas dukker op",
	...
	"subtitles.block.respawn_anchor.ambient": "Genoplivelsesanker suser",
	...
	"subtitles.block.sand.idle": "Sandet lyde",
	"subtitles.block.sand.wind": "Blæsende lyde",
	...
	"subtitles.block.sculk_sensor.clicking": "Sculk-sensor klikker",
	...
	"subtitles.block.shelf.activate": "Hylde aktiveres",
	"subtitles.block.shelf.deactivate": "Hylde deaktiveres",
	"subtitles.block.shelf.multi_swap": "Genstande byttes",
	"subtitles.block.shelf.place_item": "Genstand placeret",
	"subtitles.block.shelf.single_swap": "Genstand byttes",
	"subtitles.block.shelf.take_item": "Genstand taget",
	"subtitles.block.shulker_box.close": "Shulkerboks lukker",
	"subtitles.block.shulker_box.open": "Shulkerboks åbner",
	"subtitles.block.sign.waxed_interact_fail": "Skilt vakler",
	"subtitles.block.smithing_table.use": "Smedebord brugt",
	"subtitles.block.smoker.smoke": "Rygeovn ryger",
	"subtitles.block.sniffer_egg.crack": "Snifferæg revner",
	"subtitles.block.sniffer_egg.hatch": "Snifferæg udklækkes",
	"subtitles.block.sniffer_egg.plop": "Sniffer plopper",
	"subtitles.block.sponge.absorb": "Svamp suger",
	"subtitles.block.sweet_berry_bush.pick_berries": "Bær plukkes",
	"subtitles.block.trapdoor.close": "Lem lukker",
	"subtitles.block.trapdoor.open": "Lem åbner",
	"subtitles.block.trapdoor.toggle": "Lem knirker",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Ildevarslende genstand forberedes",
	"subtitles.block.trial_spawner.ambient": "Prøvelsesspawner knitrer",
	"subtitles.block.trial_spawner.ambient_charged": "Ildevarslende knitren",
	"subtitles.block.trial_spawner.ambient_ominous": "Ildevarslende knitren",
	"subtitles.block.trial_spawner.charge_activate": "Tegn omslutter prøvelsesspawner",
	"subtitles.block.trial_spawner.close_shutter": "Prøvelsesspawner lukker",
	"subtitles.block.trial_spawner.detect_player": "Prøvelsesspawner lader op",
	"subtitles.block.trial_spawner.eject_item": "Prøvelsesspawner udløser genstand",
	"subtitles.block.trial_spawner.ominous_activate": "Tegn omslutter prøvelsesspawner",
	"subtitles.block.trial_spawner.open_shutter": "Prøvelsesspawner åbner",
	"subtitles.block.trial_spawner.spawn_item": "Ildevarslende genstand udløses",
	"subtitles.block.trial_spawner.spawn_item_begin": "Ildevarslende genstand dukker op",
	"subtitles.block.trial_spawner.spawn_mob": "Prøvelsesspawner fremkalder et væsen",
	...
	"subtitles.block.vault.activate": "Boks antændes",
	"subtitles.block.vault.ambient": "Boks knitrer",
	"subtitles.block.vault.close_shutter": "Boks lukker",
	"subtitles.block.vault.deactivate": "Boks slukkes",
	"subtitles.block.vault.eject_item": "Boks udløser genstand",
	"subtitles.block.vault.insert_item": "Boks låses op",
	"subtitles.block.vault.insert_item_fail": "Boks afviser genstand",
	"subtitles.block.vault.open_shutter": "Boks åbner",
	"subtitles.block.vault.reject_rewarded_player": "Boks afviser spiller",
	"subtitles.block.water.ambient": "Vand løber",
	"subtitles.block.wet_sponge.dries": "Svamp tørrer",
	"subtitles.chiseled_bookshelf.insert": "Bog placeret",
	"subtitles.chiseled_bookshelf.insert_enchanted": "Fortryllet bog placeret",
	"subtitles.chiseled_bookshelf.take": "Bog taget ud",
	"subtitles.chiseled_bookshelf.take_enchanted": "Fortryllet bog taget",
	...
	"subtitles.entity.armadillo.ambient": "Bæltedyr grynter",
	"subtitles.entity.armadillo.brush": "Skæl børstes af",
	"subtitles.entity.armadillo.death": "Bæltedyr dør",
	"subtitles.entity.armadillo.eat": "Bæltedyr spiser",
	"subtitles.entity.armadillo.hurt": "Bæltedyr skades",
	"subtitles.entity.armadillo.hurt_reduced": "Bæltedyr skærmer sig selv",
	"subtitles.entity.armadillo.land": "Bæltedyr lander",
	"subtitles.entity.armadillo.peek": "Bæltedyr kigger",
	"subtitles.entity.armadillo.roll": "Bæltedyr ruller sammen",
	"subtitles.entity.armadillo.scute_drop": "Bæltedyr fælder skæl",
	"subtitles.entity.armadillo.unroll_finish": "Bæltedyr ruller ud",
	"subtitles.entity.armadillo.unroll_start": "Bæltedyr kigger",
	...
	"subtitles.entity.baby_cat.ambient": "Katteunge mijaver",
	"subtitles.entity.baby_cat.beg_for_food": "Katteunge tigger",
	"subtitles.entity.baby_cat.death": "Katteunge dør",
	"subtitles.entity.baby_cat.eat": "Katteunge spiser",
	"subtitles.entity.baby_cat.hiss": "Katteunge hvæser",
	"subtitles.entity.baby_cat.hurt": "Katteunge skades",
	"subtitles.entity.baby_cat.purr": "Katteunge spinder",
	"subtitles.entity.baby_chicken.ambient": "Kyllingeunge pipper",
	"subtitles.entity.baby_chicken.death": "Kyllingeunge dør",
	"subtitles.entity.baby_chicken.hurts": "Kyllingeunge skades",
	"subtitles.entity.baby_horse.ambient": "Føl vrinsker",
	"subtitles.entity.baby_horse.angry": "Føl vrinsker",
	"subtitles.entity.baby_horse.breathe": "Føl ånder",
	"subtitles.entity.baby_horse.death": "Føl dør",
	"subtitles.entity.baby_horse.eat": "Føl spiser",
	"subtitles.entity.baby_horse.hurt": "Føl skades",
	"subtitles.entity.baby_horse.land": "Føl lander",
	"subtitles.entity.baby_nautilus.ambient": "Nautilunge knitrer",
	"subtitles.entity.baby_nautilus.ambient_land": "Nautilunge knitrer",
	"subtitles.entity.baby_nautilus.death": "Nautilunge dør",
	"subtitles.entity.baby_nautilus.death_land": "Nautilunge dør",
	"subtitles.entity.baby_nautilus.eat": "Nautilunge spiser",
	"subtitles.entity.baby_nautilus.hurt": "Nautilunge skades",
	"subtitles.entity.baby_nautilus.hurt_land": "Nautilunge skades",
	"subtitles.entity.baby_nautilus.swim": "Nautilunge svømmer",
	"subtitles.entity.baby_pig.ambient": "Griseunge øffer",
	"subtitles.entity.baby_pig.death": "Griseunge dør",
	"subtitles.entity.baby_pig.eat": "Griseunge spiser",
	"subtitles.entity.baby_pig.hurt": "Griseunge skades",
	"subtitles.entity.baby_wolf.ambient": "Hvalp piver",
	"subtitles.entity.baby_wolf.death": "Hvalp dør",
	"subtitles.entity.baby_wolf.growl": "Hvalp knurrer",
	"subtitles.entity.baby_wolf.hurt": "Hvalp skades",
	"subtitles.entity.baby_wolf.pant": "Hvalp gisper",
	"subtitles.entity.baby_wolf.whine": "Hvalp jamre",
	...
	"subtitles.entity.bogged.ambient": "Sumpskelet rasler",
	"subtitles.entity.bogged.death": "Sumpskelet dør",
	"subtitles.entity.bogged.hurt": "Sumpskelet skades",
	"subtitles.entity.breeze.charge": "Vindvæsen lader op",
	"subtitles.entity.breeze.death": "Vindvæsen dør",
	"subtitles.entity.breeze.deflect": "Vindvæsen afværger",
	"subtitles.entity.breeze.hurt": "Vindvæsen skades",
	"subtitles.entity.breeze.idle_air": "Vindvæsen flyver",
	"subtitles.entity.breeze.idle_ground": "Vindvæsen hviner",
	"subtitles.entity.breeze.inhale": "Vindvæsen inhalerer",
	"subtitles.entity.breeze.jump": "Vindvæsen hopper",
	"subtitles.entity.breeze.land": "Vindvæsen lander",
	"subtitles.entity.breeze.shoot": "Vindvæsen skyder",
	"subtitles.entity.breeze.slide": "Vindvæsen glider",
	"subtitles.entity.breeze.whirl": "Vindvæsen hvirvler",
	"subtitles.entity.breeze.wind_burst": "Vindladning brister",
	...
	"subtitles.entity.camel_husk.ambient": "Udtørret kamel brummer",
	"subtitles.entity.camel_husk.dash": "Udtørret kamel suser frem",
	"subtitles.entity.camel_husk.dash_ready": "Udtørret kamel kommer sig",
	"subtitles.entity.camel_husk.death": "Udtørret kamel dør",
	"subtitles.entity.camel_husk.eat": "Udtørret kamel spiser",
	"subtitles.entity.camel_husk.hurt": "Udtørret kamel skades",
	"subtitles.entity.camel_husk.saddle": "Sadle udstyres",
	"subtitles.entity.camel_husk.sit": "Udtørret kamel sætter sig",
	"subtitles.entity.camel_husk.stand": "Udtørret kamel rejser sig",
	...
	"subtitles.entity.copper_golem.death": "Kobbergolem dør",
	"subtitles.entity.copper_golem.hurt": "Kobbergolem skades",
	"subtitles.entity.copper_golem.item_drop": "Kobbergolem placerer en genstand",
	"subtitles.entity.copper_golem.item_no_drop": "Kobbergolem kan ikke placere genstand",
	"subtitles.entity.copper_golem.no_item_get": "Kobbergolem samler genstand op",
	"subtitles.entity.copper_golem.no_item_no_get": "Kobbergolem kan ikke samle genstand op",
	"subtitles.entity.copper_golem.spawn": "Kobbergolem dukker op",
	"subtitles.entity.copper_golem.spin": "Kobbergolemens hoved drejer",
	"subtitles.entity.copper_golem_become_statue": "Kobbergolem er forstenet",
	"subtitles.entity.copper_golem_oxidized.death": "Kobbergolem dør",
	"subtitles.entity.copper_golem_oxidized.hurt": "Kobbergolem skades",
	"subtitles.entity.copper_golem_oxidized.spin": "Kobbergolemens hoved drejer",
	"subtitles.entity.copper_golem_weathered.death": "Kobbergolem dør",
	"subtitles.entity.copper_golem_weathered.hurt": "Kobbergolem skades",
	"subtitles.entity.copper_golem_weathered.spin": "Kobbergolemens hoved drejer",
	...
	"subtitles.entity.creaking.activate": "Knirkeren ser på",
	"subtitles.entity.creaking.ambient": "Knirkeren knirker",
	"subtitles.entity.creaking.attack": "Knirkeren angriber",
	"subtitles.entity.creaking.deactivate": "Knirkeren beroliger",
	"subtitles.entity.creaking.death": "Knirkeren smuldrer",
	"subtitles.entity.creaking.freeze": "Knirkeren stopper",
	"subtitles.entity.creaking.spawn": "Knirken manifesterer",
	"subtitles.entity.creaking.sway": "Knirkeren er ramt",
	"subtitles.entity.creaking.twitch": "Knirkeren rykker",
	"subtitles.entity.creaking.unfreeze": "Knirkeren bevæger sig",
	...
	"subtitles.entity.donkey.jump": "Æsel hopper",
	...
	"subtitles.entity.enderman.scream": "Enderman skriger",
	...
	"subtitles.entity.fish.swim": "Plask",
	...
	"subtitles.entity.generic.wind_burst": "Vindladning brister",
	...
	"subtitles.entity.ghastling.ambient": "Ghastling kurrer",
	"subtitles.entity.ghastling.death": "Ghastling dør",
	"subtitles.entity.ghastling.hurt": "Ghastling skades",
	"subtitles.entity.ghastling.spawn": "Ghastling dukker op",
	...
	"subtitles.entity.happy_ghast.ambient": "Glad ghast synger",
	"subtitles.entity.happy_ghast.death": "Glad ghast dør",
	"subtitles.entity.happy_ghast.equip": "Seletøj udstyres",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Glad ghast er klar",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Glad ghast stopper",
	"subtitles.entity.happy_ghast.hurt": "Glad ghast skades",
	"subtitles.entity.happy_ghast.unequip": "Seletøj tages af",
	...
	"subtitles.entity.leash_knot.break": "Snorknude ødelagt",
	"subtitles.entity.leash_knot.place": "Snorknude bundet",
	...
	"subtitles.entity.minecart.inside": "Minevogn skramler",
	"subtitles.entity.minecart.inside_underwater": "Minevogn skramler under vandet",
	...
	"subtitles.entity.mule.chest": "Kiste sat på muldyr",
	"subtitles.entity.mule.death": "Muldyr dør",
	"subtitles.entity.mule.eat": "Muldyr spiser",
	"subtitles.entity.mule.hurt": "Muldyr skades",
	"subtitles.entity.mule.jump": "Muldyr hopper",
	"subtitles.entity.nautilus.ambient": "Nautil klikker",
	"subtitles.entity.nautilus.ambient_land": "Nautil klikker",
	"subtitles.entity.nautilus.dash": "Nautil suser frem",
	"subtitles.entity.nautilus.dash_land": "Nautil suser frem",
	"subtitles.entity.nautilus.dash_ready": "Nautil kommer sig",
	"subtitles.entity.nautilus.dash_ready_land": "Nautil kommer sig",
	"subtitles.entity.nautilus.death": "Nautil dør",
	"subtitles.entity.nautilus.death_land": "Nautil dør",
	"subtitles.entity.nautilus.eat": "Nautil spiser",
	"subtitles.entity.nautilus.hurt": "Nautil skades",
	"subtitles.entity.nautilus.hurt_land": "Nautil skades",
	"subtitles.entity.nautilus.swim": "Nautil svømmer",
	"subtitles.entity.painting.break": "Maleri ødelagt",
	...
	"subtitles.entity.parched.ambient": "Udtørret skelet rasler",
	"subtitles.entity.parched.death": "Udtørret skelet dør",
	"subtitles.entity.parched.hurt": "Udtørret skelet skades",
	...
	"subtitles.entity.parrot.imitate.bogged": "Papegøje rasler",
	"subtitles.entity.parrot.imitate.breeze": "Papegøje hviner",
	"subtitles.entity.parrot.imitate.camel_husk": "Papegøje brummer",
	"subtitles.entity.parrot.imitate.creaking": "Papegøje knager",
	...
	"subtitles.entity.parrot.imitate.parched": "Papegøje knitrer",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Papegøje stønner",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Papegøje gurgler",
	...
	"subtitles.entity.pig.eat": "Gris spiser",
	...
	"subtitles.entity.player.teleport": "Spiller teleporterer",
	"subtitles.entity.polar_bear.ambient": "Isbjørn stønner",
	"subtitles.entity.polar_bear.ambient_baby": "Isbjørneunge brummer",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Skelethest hopper",
	...
	"subtitles.entity.sniffer.death": "Sniffer dør",
	"subtitles.entity.sniffer.digging": "Sniffer graver",
	"subtitles.entity.sniffer.digging_stop": "Sniffer rejser sig",
	"subtitles.entity.sniffer.drop_seed": "Sniffer smider frø",
	"subtitles.entity.sniffer.eat": "Sniffer spiser",
	"subtitles.entity.sniffer.egg_crack": "Snifferæg revner",
	"subtitles.entity.sniffer.egg_hatch": "Snifferæg udklækkes",
	"subtitles.entity.sniffer.happy": "Sniffer frydes",
	"subtitles.entity.sniffer.hurt": "Sniffer skades",
	"subtitles.entity.sniffer.idle": "Sniffer grynter",
	"subtitles.entity.sniffer.scenting": "Sniffer dufter",
	"subtitles.entity.sniffer.searching": "Sniffer søger",
	"subtitles.entity.sniffer.sniffing": "Sniffer snuser",
	"subtitles.entity.sniffer.step": "Sniffer går",
	...
	"subtitles.entity.sulfur_cube.absorb": "Svovlkube fuld",
	"subtitles.entity.sulfur_cube.bounce": "Svovlkube hopper",
	"subtitles.entity.sulfur_cube.death": "Svovlkube dør",
	"subtitles.entity.sulfur_cube.eject": "Blok fjernet",
	"subtitles.entity.sulfur_cube.hit": "Svovlkube ramt",
	"subtitles.entity.sulfur_cube.hurt": "Svovlkube skades",
	"subtitles.entity.sulfur_cube.push": "Svovlkube skubbes",
	"subtitles.entity.sulfur_cube.squish": "Svovlkube hopper",
	...
	"subtitles.entity.villager.work_armorer": "Rustningssmed arbejder",
	...
	"subtitles.entity.wind_charge.throw": "Vindladning flyver",
	"subtitles.entity.wind_charge.wind_burst": "Vindladning brister",
	...
	"subtitles.entity.zombie_horse.angry": "Zombiehest vrinsker",
	"subtitles.entity.zombie_horse.death": "Zombiehest dør",
	"subtitles.entity.zombie_horse.eat": "Zombiehest spiser",
	"subtitles.entity.zombie_horse.hurt": "Zombiehest skades",
	"subtitles.entity.zombie_nautilus.ambient": "Zombienautil bobler",
	"subtitles.entity.zombie_nautilus.ambient_land": "Zombienautil bobler",
	"subtitles.entity.zombie_nautilus.dash": "Zombienautil suser frem",
	"subtitles.entity.zombie_nautilus.dash_land": "Zombienautil suser frem",
	"subtitles.entity.zombie_nautilus.dash_ready": "Zombienautil kommer sig",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Zombienautil kommer sig",
	"subtitles.entity.zombie_nautilus.death": "Zombienautil dør",
	"subtitles.entity.zombie_nautilus.death_land": "Zombienautil dør",
	"subtitles.entity.zombie_nautilus.eat": "Zombienautil spiser",
	"subtitles.entity.zombie_nautilus.hurt": "Zombienautil skades",
	"subtitles.entity.zombie_nautilus.hurt_land": "Zombienautil skades",
	"subtitles.entity.zombie_nautilus.swim": "Zombienautil svømmer",
	...
	"subtitles.event.mob_effect.bad_omen": "Tegnet tager over",
	"subtitles.event.mob_effect.raid_omen": "Plyndring lurer i nærheden",
	"subtitles.event.mob_effect.trial_omen": "Ildevarslende prøvelse lurer i nærheden",
	...
	"subtitles.item.armor.equip_copper": "Kobberrustning dunker",
	...
	"subtitles.item.armor.equip_nautilus": "Nautilrustning udstyres",
	"subtitles.item.armor.equip_netherite": "Netherritrustning skramler",
	"subtitles.item.armor.equip_turtle": "Skildpaddeskjold dunker",
	"subtitles.item.armor.equip_wolf": "Ulverustning er fastspændt",
	"subtitles.item.armor.unequip_nautilus": "Nautilrustning tages af",
	"subtitles.item.armor.unequip_wolf": "Ulverustning klippes af",
	...
	"subtitles.item.brush.brushing.generic": "Børster",
	"subtitles.item.brush.brushing.gravel": "Børster grus",
	"subtitles.item.brush.brushing.gravel.complete": "Grusbørstning fuldført",
	"subtitles.item.brush.brushing.sand": "Børster sand",
	"subtitles.item.brush.brushing.sand.complete": "Sandbørstning fuldført",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Svovlkube opsamlet",
	...
	"subtitles.item.bundle.insert_fail": "Bundt fuldt",
	...
	"subtitles.item.golden_dandelion.unuse": "Gylden mælkebøtte begynder at ældes",
	"subtitles.item.golden_dandelion.use": "Gylden mælkebøtte stopper med at ældes",
	...
	"subtitles.item.horse_armor.unequip": "Hestearmering klippes af",
	"subtitles.item.ink_sac.use": "Blækpose splatter",
	"subtitles.item.lead.break": "Snor knækker",
	"subtitles.item.lead.tied": "Snor bundet",
	"subtitles.item.lead.untied": "Snor løsnet",
	"subtitles.item.llama_carpet.unequip": "Tæppe klippes af",
	"subtitles.item.lodestone_compass.lock": "Ledestenkompas låses fast på ledesten",
	"subtitles.item.mace.smash_air": "Kølle smadrer",
	"subtitles.item.mace.smash_ground": "Kølle smadrer",
	"subtitles.item.nautilus_saddle_equip": "Sadle udstyres",
	"subtitles.item.nautilus_saddle_underwater_equip": "Sadle udstyres",
	"subtitles.item.nether_wart.plant": "Afgrøde plantet",
	"subtitles.item.ominous_bottle.dispose": "Flaske ødelægges",
	"subtitles.item.saddle.unequip": "Sadel klippes af",
	"subtitles.item.shears.shear": "Saks klikker",
	"subtitles.item.shears.snip": "Saks klipper",
	"subtitles.item.shield.block": "Skjold blokerer",
	"subtitles.item.shovel.flatten": "Skovl flader",
	"subtitles.item.spear.attack": "Spyd stikker",
	"subtitles.item.spear.hit": "Spyd ramte",
	"subtitles.item.spear.lunge": "Spydstød",
	"subtitles.item.spear.use": "Stormer frem med spyd",
	"subtitles.item.spear_wood.attack": "Spyd stikker",
	"subtitles.item.spear_wood.hit": "Spyd ramte",
	"subtitles.item.spear_wood.use": "Stormer frem med spyd",
	...
	"subtitles.item.underwater_saddle.equip": "Sadle udstyres",
	"subtitles.item.wolf_armor.break": "Ulverustning ødelægges",
	"subtitles.item.wolf_armor.crack": "Ulverustning revner",
	"subtitles.item.wolf_armor.damage": "Ulverustning tager skade",
	"subtitles.item.wolf_armor.repair": "Ulverustning er repareret",
	"subtitles.particle.soul_escape": "Sjæl undslipper",
	"subtitles.ui.cartography_table.take_result": "Kort tegnes",
	"subtitles.ui.hud.bubble_pop": "Åndedrætsmåler falder",
	"subtitles.ui.loom.take_result": "Væv bruges",
	"subtitles.ui.stonecutter.take_result": "Stenskærer bruges",
	"subtitles.weather.end_flash": "Endglimt rumler",
	"subtitles.weather.rain": "Regn falder",
	"symlink_warning.message": "Indlæsning af verdener fra mapper med symbolske links kan være usikkert, hvis du ikke præcist ved, hvad du laver. Besøg venligst %s for at lære mere.",
	"symlink_warning.message.pack": "Indlæsning af pakker med symbolske links kan være usikkert, hvis du ikke præcist ved, hvad du laver. Besøg venligst %s for at lære mere.",
	"symlink_warning.message.world": "Indlæsning af verdener fra mapper med symbolske links kan være usikkert, hvis du ikke præcist ved, hvad du laver. Besøg venligst %s for at lære mere.",
	"symlink_warning.more_info": "Mere information",
	"symlink_warning.title": "Verdensmappe indeholder symbolske links",
	"symlink_warning.title.pack": "Tilføjede pakke(r) indeholder symbolske links",
	"symlink_warning.title.world": "Verdensmappen indeholder symbolske links",
	...
	"telemetry.event.advancement_made.description": "Forståelse af konteksten bag modtagelsen af et fremskridt kan hjælpe os med bedre at forstå, og forbedre, spillets udvikling.",
	"telemetry.event.advancement_made.title": "Fremskridt opnået",
	"telemetry.event.game_load_times.description": "Denne begivenhed kan hjælpe os med at finde ud af, hvor opstartsforbedringer er behøvet ved at måle udførelsestiden for opstartsfaserne.",
	"telemetry.event.game_load_times.title": "Spillets indlæsningstid",
	"telemetry.event.graphics_capabilities.description": "Denne hændelse informerer os om egenskaberne for den grafikenhed, der bruges til at spille spillet.",
	"telemetry.event.graphics_capabilities.title": "Grafikegenskaber",
	"telemetry.event.optional": "%s (valgfrit)",
	"telemetry.event.optional.disabled": "%s (Valgfrit) - Deaktiveret",
	"telemetry.event.p2p_connection.description": "Denne hændelse hjælper os med at forstå pålideligheden og ydeevnen af peer-to-peer-forbindelser mellem spillere. Den registrerer, om forbindelsen var vellykket, hvilken type af Interactive Connectivity Establishment (ICE, den protokol vi bruger til at etablere peer-to-peer-forbindelser) kandidat der blev brugt, samt hvor lang tid det tog at etablere forbindelsen.",
	"telemetry.event.p2p_connection.title": "Peer-to-peer-forbindelse",
	"telemetry.event.performance_metrics.description": "Kendskab til Minecrafts overordnede præstationsprofil hjælper os med at indstille og optimere spillet til en bred vifte af maskinespecifikationer og operativsystemer.\nSpilversionen er inkluderet for at hjælpe os med at sammenligne præstationsprofilen for nye versioner af Minecraft.",
	"telemetry.event.performance_metrics.title": "Ydelsesmål",
	"telemetry.event.required": "%s (påkrævet)",
	"telemetry.event.world_load_times.description": "Det er vigtigt for os at vide hvor længe det tager at tilslutte en verden, og hvordan det ændrer sig over tid. F. eks. når vi tilføjer nye funktioner eller større tekniske forandringer, bliver vi nødt til at se hvilken indvirkning det havde på indlæsningstiderne.",
	...
	"telemetry.event.world_unloaded.description": "Denne begivenhed er parret med verden-indlæst-begivenheden for at beregne hvor længe verdens sessionen har varet. \nVarigheden (i sekunder og tiks) måles når en verdenssession er afsluttet (afslutning til hovedmenu, afbryde forbindelsen til en server).",
	"telemetry.event.world_unloaded.title": "Verden aflæsset",
	"telemetry.property.advancement_game_time.title": "Spiltid (tik)",
	"telemetry.property.advancement_id.title": "Fremskridts-ID",
	"telemetry.property.backend_failure_message.title": "Fejlmeddelelse ved oprettelse af backend",
	"telemetry.property.backend_failure_missing_capabilities.title": "Manglende egenskaber ved oprettelse af backend",
	"telemetry.property.backend_failure_reason.title": "Årsag til fejl ved oprettelse af backend",
	"telemetry.property.backend_name.title": "Backend-navn",
	"telemetry.property.client_id.title": "Klient-ID",
	"telemetry.property.client_modded.title": "Modificeret klient",
	"telemetry.property.dedicated_memory_kb.title": "Dedikeret hukommelse (kB)",
	"telemetry.property.event_timestamp_utc.title": "Begivenheds-tidsstempel (UTC)",
	...
	"telemetry.property.launcher_name.title": "Starter navn",
	"telemetry.property.load_time_bootstrap_ms.title": "Opstartstid (millisekunder)",
	"telemetry.property.load_time_loading_overlay_ms.title": "Tid på indlæsningsskærm (millisekunder)",
	"telemetry.property.load_time_pre_window_ms.title": "Tid før vindue åbnes (millisekunder)",
	"telemetry.property.load_time_total_time_ms.title": "Total indlæsningstid (millisekunder)",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "Fejlstadie",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Interactive Connectivity Establishment (ICE) forbindelsestid (millisekunder)",
	"telemetry.property.p2p_connection_ice_path.title": "Interactive Connectivity Establishment (ICE) sti",
	"telemetry.property.p2p_connection_local_candidate_type.title": "Lokal kandidattype",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Fjernkandidattype",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Signaleringsforbindelsestid (millisekunder)",
	"telemetry.property.p2p_connection_successful.title": "Forbindelse vellykket",
	"telemetry.property.p2p_connection_total_time_ms.title": "Samlet forbindelsestid (millisekunder)",
	"telemetry.property.platform.title": "Platform",
	"telemetry.property.realms_map_content.title": "Realms verden indhold (mini-spil navn)",
	"telemetry.property.render_distance.title": "Synslængde",
	"telemetry.property.render_time_samples.title": "Prøver for renderingstid",
	...
	"telemetry_info.button.privacy_statement": "Fortrolighedserklæring",
	"telemetry_info.button.show_data": "Vis min data",
	"telemetry_info.opt_in.description": "Jeg samtykker til at sende valgfrie telemetridata",
	"telemetry_info.property_title": "Inkluderet data",
	"telemetry_info.screen.description": "Indsamling af denne data hjælper os med at forbedre Minecraft ved at lede os i retninger der er relevante for vores spillere.\nDu kan også indsende yderligere tilbagemeldinger for at hjælpe os med at forbedre Minecraft.",
	"telemetry_info.screen.title": "Indsamling af telemetridata",
	"test.error.block_property_mismatch": "Forventede egenskaben %s at være %s: var %s",
	"test.error.block_property_missing": "Blokegenskab mangler. Forventede egenskaben %s at være %s",
	"test.error.entity_property": "Objekt %s fejlede testen: %s",
	"test.error.entity_property_details": "Objekt %s fejlede testen: %s. Forventede %s: var %s",
	"test.error.expected_block": "Forventede blok %s: fik %s",
	"test.error.expected_block_present": "Forventede at blokken %s var til stede",
	"test.error.expected_block_tag": "Forventede blok i #%s: fik %s",
	"test.error.expected_container_contents": "Beholderen burde indeholde: %s",
	"test.error.expected_container_contents_single": "Beholderen burde indeholde en enkelt: %s",
	"test.error.expected_empty_container": "Beholderen burde være tom",
	"test.error.expected_entity": "Forventede: %s",
	"test.error.expected_entity_around": "Forventede at %s eksisterede omkring %s, %s, %s",
	"test.error.expected_entity_count": "Forventede %s objekter af type %s: fandt %s",
	"test.error.expected_entity_data": "Forventede objektdata at være %s: var %s",
	"test.error.expected_entity_data_predicate": "Objektdata stemmer ikke overens med %s",
	"test.error.expected_entity_effect": "Forventede %s at have effekten %s %s",
	"test.error.expected_entity_having": "Objektets taske burde indeholde %s",
	"test.error.expected_entity_holding": "Objekt burde holde: %s",
	"test.error.expected_entity_in_test": "Forventede %s at eksistere i testen",
	"test.error.expected_entity_not_touching": "Forventede ikke at %s ville røre %s, %s, %s (relativt: %s, %s, %s)",
	"test.error.expected_entity_touching": "Forventede at %s ville røre %s, %s, %s (relativt: %s, %s, %s)",
	"test.error.expected_item": "Forventede genstand af type %s",
	"test.error.expected_items_count": "Forventede %s genstande af type %s: fandt %s",
	"test.error.fail": "Fejlbetingelser opfyldt",
	"test.error.invalid_block_type": "Uforventet bloktype fundet: %s",
	"test.error.missing_block_entity": "Mangler blokobjekt",
	"test.error.not_a_block_item": "Den angivne blok er ikke en blokgenstand",
	"test.error.position": "%s ved %s, %s, %s (relativt: %s, %s, %s) på tik %s",
	"test.error.sequence.condition_already_triggered": "Betingelse allerede udløst ved %s",
	"test.error.sequence.condition_not_triggered": "Betingelse ikke udløst",
	"test.error.sequence.invalid_tick": "Lykkedes i ugyldig tik: forventede %s",
	"test.error.sequence.minimum_tick": "Lykkedes før forventet tik: forventede at vente %s",
	"test.error.sequence.not_completed": "Testen udløb før sekvensen blev færdiggjort",
	"test.error.set_biome": "Kunne ikke sætte biome for testen",
	"test.error.spawn_failure": "Kunne ikke oprette objekt %s",
	"test.error.state_not_equal": "Forkert tilstand. Forventede %s: var %s",
	"test.error.structure.failure": "Kunne ikke placere teststruktur for: %s",
	"test.error.tick": "%s på tik %s",
	"test.error.ticking_without_structure": "Tiking test før placering af struktur",
	"test.error.timeout.no_result": "Lykkedes eller fejlede ikke inden for %s tiks",
	"test.error.timeout.no_sequences_finished": "Ingen sekvenser blev fuldført inden for %s tiks",
	"test.error.too_many_entities": "Forventede kun en %s at eksisterer omkring %s, %s, %s men fandt %s",
	"test.error.unexpected_block": "Forventede ikke at blokken var %s",
	"test.error.unexpected_entity": "Forventede ikke, at %s eksisterede",
	"test.error.unexpected_item": "Forventede ikke genstand af type %s",
	"test.error.unknown": "Ukendt intern fejl: %s",
	"test.error.value_not_equal": "Forventede %s at være %s: var %s",
	"test.error.value_not_in_between": "Forventede %s at være mellem %s og %s: var %s",
	"test.error.wrong_block_entity": "Forkert blok objekttype: %s",
	"test_block.error.missing": "Teststruktur mangler %s blok",
	"test_block.error.too_many": "For mange %s blokke",
	"test_block.invalid_timeout": "Ugyldig timeout (%s) - skal være et positivt antal tiks",
	"test_block.message": "Besked:",
	"test_block.mode.accept": "Accepter",
	"test_block.mode.fail": "Fejl",
	"test_block.mode.log": "Log",
	"test_block.mode.start": "Start",
	"test_block.mode_info.accept": "Accept tilstand - Accepter succes for (en del af) en test",
	"test_block.mode_info.fail": "Fejl tilstand - Fejl testen",
	"test_block.mode_info.log": "Log tilstand - Log en besked",
	"test_block.mode_info.start": "Start tilstand - Startpunktet for en test",
	"test_instance.action.reset": "Nulstil og indlæs",
	"test_instance.action.run": "Indlæs og kør",
	"test_instance.action.save": "Gem struktur",
	"test_instance.description.batch": "Miljø: %s",
	"test_instance.description.failed": "Fejlede: %s",
	"test_instance.description.function": "Funktion: %s",
	"test_instance.description.invalid_id": "Ugyldigt test-ID",
	"test_instance.description.no_test": "Sådan en test findes ikke",
	"test_instance.description.structure": "Struktur: %s",
	"test_instance.description.type": "Type: %s",
	"test_instance.type.block_based": "Blokbaseret test",
	"test_instance.type.function": "Indbygget funktionstest",
	"test_instance_block.entities": "Objekter:",
	"test_instance_block.error.no_test": "Kan ikke køre testinstans ved %s, %s, %s da den har en udefineret test",
	"test_instance_block.error.no_test_structure": "Kan ikke køre testinstansen ved %s, %s, %s da den ikke har nogen teststruktur",
	"test_instance_block.error.unable_to_save": "Kan ikke gemme teststruktur skabelonen for testinstans ved %s, %s, %s",
	"test_instance_block.invalid": "[ugyldig]",
	"test_instance_block.reset_success": "Nulstilling lykkedes for test: %s",
	"test_instance_block.rotation": "Rotation:",
	"test_instance_block.size": "Test strukturstørrelse",
	"test_instance_block.starting": "Starter test %s",
	"test_instance_block.test_id": "Testinstans-ID",
	...
	"title.32bit.deprecation.realms": "Minecraft vil snart kræve et 64-bit system, hvilket vil forhindre dig i at spille eller bruge Realms på denne enhed. Du skal manuelt opsige ethvert Realms-abonnement.",
	...
	"title.credits": "Ophavsret Mojang AB. Må ikke distribueres!",
	"title.multiplayer.disabled": "Multiplayer er deaktiveret. Tjek venligst dine indstillinger for din Microsoft-konto.",
	"title.multiplayer.disabled.banned.name": "Du skal ændre dit navn, før du kan spille online",
	...
	"trim_material.minecraft.gold": "Guldmateriale",
	"trim_material.minecraft.iron": "Jernmateriale",
	"trim_material.minecraft.lapis": "Lapismateriale",
	"trim_material.minecraft.netherite": "Netherritmateriale",
	"trim_material.minecraft.quartz": "Kvartsmateriale",
	"trim_material.minecraft.redstone": "Redstonemateriale",
	"trim_material.minecraft.resin": "Harpiksmateriale",
	"trim_pattern.minecraft.bolt": "Boltfyldt rustningspynt",
	"trim_pattern.minecraft.coast": "Kyst rustningspynt",
	"trim_pattern.minecraft.dune": "Ødemark rustningspynt",
	"trim_pattern.minecraft.eye": "Øjedekoreret rustningspynt",
	"trim_pattern.minecraft.flow": "Hvirvelende rustningspynt",
	"trim_pattern.minecraft.host": "Værtens rustningspynt",
	"trim_pattern.minecraft.raiser": "Avlerens rustningspynt",
	"trim_pattern.minecraft.rib": "Ribbens rustningspynt",
	"trim_pattern.minecraft.sentry": "Vogterens rustningspynt",
	"trim_pattern.minecraft.shaper": "Formgiverens rustningspynt",
	"trim_pattern.minecraft.silence": "Stilhedens rustningspynt",
	"trim_pattern.minecraft.snout": "Snude rustningspynt",
	"trim_pattern.minecraft.spire": "Spir rustningspynt",
	"trim_pattern.minecraft.tide": "Tidevands rustningspynt",
	"trim_pattern.minecraft.vex": "Vex rustningspynt",
	"trim_pattern.minecraft.ward": "Vogter rustningspynt",
	"trim_pattern.minecraft.wayfinder": "Vejvisers rustningspynt",
	"trim_pattern.minecraft.wild": "Vild rustningspynt",
	...
	"upgrade.minecraft.netherite_upgrade": "Netherritopgradering",
	"upgradeWorld.aborted.message": "Dette kan ske, hvis et andet program har haft adgang til verdenen under opdateringen.\nDet kan hjælpe at genstarte computeren og prøve igen. Hvis problemet fortsætter, kan du overveje at rapporterer en fejl.",
	"upgradeWorld.aborted.reportBug": "Rapporter en fejl",
	"upgradeWorld.aborted.title": "Kunne ikke opdatere verdenen",
	"upgradeWorld.canceled.message": "Din verden forbliver som den var før.",
	"upgradeWorld.canceled.title": "Verdensopdatering annulleret",
	"upgradeWorld.done": "Opdatering af verden fuldført",
	"upgradeWorld.failed_cleanup.message": "Verdenen blev opdateret succesfuldt til den nyeste version og er nu tilgængelig på verdenslisten.\n\nVi stødte på problemer under oprydningen af forældede data, derfor er navnet på verdensmappen ændret til %s.",
	"upgradeWorld.failed_cleanup.title": "Opdaterede verdenen succesfuldt",
	"upgradeWorld.info.converted": "Opdaterede: %s",
	"upgradeWorld.info.file_fix_stage": "Trin: %s/%s",
	"upgradeWorld.info.scanning": "Gennemsøger filer...",
	"upgradeWorld.info.total": "I alt: %s",
	"upgradeWorld.joinNow": "Vil du tilslutte dig verdenen nu?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Flytter filer",
	"upgradeWorld.progress.type.legacy_structures": "Opdaterer forældede strukturer",
	"upgradeWorld.progress.type.region": "Opdaterer regioner",
	"upgradeWorld.symlink.message": "Den valgte verden indeholder symbolske links.\nDe nødvendige trin for at opgradere verden til den aktuelle version understøtter ikke brugen af symbolske links. For at opdatere verden skal linkene først afklares.",
	"upgradeWorld.symlink.title": "Kunne ikke opdatere verden",
	"upgradeWorld.title": "Opdaterer verdensfiler",
}
