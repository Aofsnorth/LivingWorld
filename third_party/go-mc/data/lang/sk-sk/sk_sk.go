// Code generated by tools/gen_lang.go from 26.1/sk_sk.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Zjednodušenie ovládania...",
	"accessibility.onboarding.accessibility.button.narration": "Zjednodušenie ovládania",
	...
	"advMode.notEnabled.spawner": "Liahne na tomto serveri nie sú povolené",
	"advMode.previousOutput": "Predchádzajúci výstup",
	"advMode.setCommand": "Nastav konzolový príkaz pre kocku",
	"advMode.setCommand.disabled": "Príkaz nastavený: %s, ale príkazové kocky sú stále zakázané",
	...
	"advancements.adventure.blowback.description": "Zabi víchra odrazením jeho vlastného veterného náboja",
	"advancements.adventure.blowback.title": "Kto seje vietor, žne búrku",
	"advancements.adventure.brush_armadillo.description": "Získaj doštičku pásavca pomocou metličky",
	"advancements.adventure.brush_armadillo.title": "Máš lupiny?",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Vyrob ozdobný džbán zo štyroch hlinených črepov",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Piplačka",
	"advancements.adventure.crafters_crafting_crafters.description": "Buď pri výrobníku keď vyrobí výrobník",
	"advancements.adventure.crafters_crafting_crafters.title": "Výrobníky vyrábajú výrobníky",
	...
	"advancements.adventure.heart_transplanter.description": "Polož správne otočené srdce škripotu medzi dva kmene bledého dubu",
	"advancements.adventure.heart_transplanter.title": "Transplantácia srdca",
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Zabi tvora pri sculkovom katalyzátore",
	"advancements.adventure.kill_mob_near_sculk_catalyst.title": "Šíri sa to",
	"advancements.adventure.lighten_up.description": "Zoškrab hrdzu z medenej lampy s pomocou sekery pre jej rozjasnenie",
	"advancements.adventure.lighten_up.title": "Zažni",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Vkroč do skúškových katakomb",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Skúšková edícia",
	"advancements.adventure.ol_betsy.description": "Vystreľ z kuše",
	"advancements.adventure.ol_betsy.title": "Samostrel",
	"advancements.adventure.overoverkill.description": "Uber 50 srdiečok jediným úderom palcátu",
	"advancements.adventure.overoverkill.title": "Jedna veľká mucha jednou ranou",
	...
	"advancements.adventure.revaulting.description": "Odomkni zlovestnú pokladnicu zlovestným kľúčom skúšky",
	"advancements.adventure.revaulting.title": "Pandorina skrinka",
	...
	"advancements.adventure.spear_many_mobs.description": "Zasiahni päť tvorov jedným útokom kopije",
	"advancements.adventure.spear_many_mobs.title": "Bojový špíz",
	...
	"advancements.adventure.two_birds_one_arrow.description": "Zabi dva prízraky jedným šípom s priestrelom",
	"advancements.adventure.two_birds_one_arrow.title": "Dve muchy jednou ranou",
	"advancements.adventure.under_lock_and_key.description": "Odomkni pokladnicu kľúčom skúšky",
	"advancements.adventure.under_lock_and_key.title": "Pod zámkom",
	"advancements.adventure.use_lodestone.description": "Použi Kompas na Navigačný Kameň",
	"advancements.adventure.use_lodestone.title": "Ukáž mi cestu",
	...
	"advancements.adventure.who_needs_rockets.description": "Vyfúkni sa pomocou veterného náboja do výšky 7 kociek",
	"advancements.adventure.who_needs_rockets.title": "Načo by mi boli krídla?",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Polož vyschnutého ghasta do vody",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Pitný režim",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Zobleč vlkovi brnenie pomocou nožníc",
	"advancements.husbandry.remove_wolf_armor.title": "Šmykom dole!",
	"advancements.husbandry.repair_wolf_armor.description": "Oprav poškodené vlčie brnenie pomocou doštičky pásavca",
	"advancements.husbandry.repair_wolf_armor.title": "Ako nové",
	...
	"advancements.husbandry.silk_touch_nest.description": "Presuň včelie hniezdo alebo úľ s tromi včelami za pomoci nežného dotyku",
	...
	"advancements.husbandry.uh_oh.description": "Pomôž sírovcovi pohltiť kocku TNT",
	"advancements.husbandry.uh_oh.title": "Ajaj",
	...
	"advancements.husbandry.whole_pack.description": "Skroť si každý druh vlka",
	"advancements.husbandry.whole_pack.title": "Celá svorka",
	...
	"advancements.nether.fast_travel.description": "Využi Nether na precestovanie 7 km v obyčajnom svete",
	...
	"argument.entity.selector.nearestEntity": "Najbližšia entita",
	...
	"argument.hexcolor.invalid": "Neplatný kód farby \"%s\"",
	...
	"argument.message.too_long": "Správa bola príliš dlhá (%s > maximálne %s znakov)",
	"argument.nbt.array.invalid": "Neplatný typ poľa \"%s\"",
	"argument.nbt.array.mixed": "Nie je možné vložiť %s do %s",
	"argument.nbt.expected.compound": "Očakáva sa compound",
	...
	"argument.resource_or_id.failed_to_parse": "Nepodarilo sa spracovať štruktúru: %s",
	"argument.resource_or_id.invalid": "Neplatné ID alebo tag",
	"argument.resource_or_id.no_such_element": "Nepodarilo sa nájsť prvok \"%s\" v registri \"%s\"",
	"argument.resource_selector.not_found": "Žiadne zhody pre selektor \"%s\" typu \"%s\"",
	...
	"argument.style.invalid": "Neplatný štýl: %s",
	...
	"argument.waypoint.invalid": "Vybraná entita nie je orientačný bod",
	...
	"arguments.item.component.expected": "Očakáva sa komponent typu Predmet",
	"arguments.item.component.malformed": "Chybný komponent typu \"%s\": \"%s\"",
	"arguments.item.component.repeated": "Komponent typu Predmet \"%s\" sa opakuje, no zadaná môže byť len jedna hodnota",
	"arguments.item.component.unknown": "Neznámy komponent typu Predmet \"%s\"",
	"arguments.item.malformed": "Chybný predmet: \"%s\"",
	"arguments.item.overstacked": "%s sa môže maximálne nahromadiť po %s",
	"arguments.item.predicate.malformed": "Chybný predikát typu \"%s\": \"%s\"",
	"arguments.item.predicate.unknown": "Neznámy predikát predmetu: \"%s\"",
	...
	"attribute.name.air_drag_modifier": "Činiteľ odporu vzduchu",
	"attribute.name.armor": "Brnenie",
	"attribute.name.armor_toughness": "Odolnosť brnenia",
	"attribute.name.attack_damage": "Sila útoku",
	"attribute.name.attack_knockback": "Odrazenie pri útoku",
	"attribute.name.attack_speed": "Rýchlosť útoku",
	"attribute.name.below_name_distance": "Vzdialenosť skóre menovky",
	"attribute.name.block_break_speed": "Rýchlosť ničenia kociek",
	"attribute.name.block_interaction_range": "Dosah interakcií s kockami",
	"attribute.name.bounciness": "Skákavosť",
	"attribute.name.burning_time": "Čas horenia",
	"attribute.name.camera_distance": "Vzdialenosť kamery",
	"attribute.name.entity_interaction_range": "Dosah interakcií s entitami",
	"attribute.name.explosion_knockback_resistance": "Odolnosť voči odrazu výbuchom",
	"attribute.name.fall_damage_multiplier": "Násobiteľ poranenia pádom",
	"attribute.name.flying_speed": "Rýchlosť lietania",
	"attribute.name.follow_range": "Dosah prenasledovania tvormi",
	"attribute.name.friction_modifier": "Činiteľ trenia",
	...
	"attribute.name.generic.block_interaction_range": "Dosah interakcií s kockami",
	"attribute.name.generic.burning_time": "Dĺžka horenia",
	"attribute.name.generic.entity_interaction_range": "Dosah interakcií s entitami",
	"attribute.name.generic.explosion_knockback_resistance": "Odolnosť voči odrazu výbuchom",
	"attribute.name.generic.fall_damage_multiplier": "Násobiteľ poranenia pádom",
	"attribute.name.generic.flying_speed": "Rýchlosť lietania",
	"attribute.name.generic.follow_range": "Dosah prenasledovania tvorov",
	"attribute.name.generic.gravity": "Gravitácia",
	"attribute.name.generic.jump_strength": "Sila skoku",
	"attribute.name.generic.knockback_resistance": "Odolnosť proti odrazeniu",
	"attribute.name.generic.luck": "Šťastie",
	"attribute.name.generic.max_absorption": "Maximálna imunita",
	"attribute.name.generic.max_health": "Maximálne zdravie",
	"attribute.name.generic.movement_efficiency": "Efektívnosť pohybu",
	"attribute.name.generic.movement_speed": "Rýchlosť",
	"attribute.name.generic.oxygen_bonus": "Kyslíkový bonus",
	"attribute.name.generic.safe_fall_distance": "Bezpečná hĺbka pádu",
	"attribute.name.generic.scale": "Mierka",
	"attribute.name.generic.step_height": "Výška kroku",
	"attribute.name.generic.water_movement_efficiency": "Efektívnosť pohybu vo vode",
	"attribute.name.gravity": "Gravitácia",
	"attribute.name.horse.jump_strength": "Sila výskoku koňa",
	"attribute.name.jump_strength": "Sila skoku",
	"attribute.name.knockback_resistance": "Odolnosť proti odrazeniu",
	"attribute.name.luck": "Šťastie",
	"attribute.name.max_absorption": "Maximálna imunita",
	"attribute.name.max_health": "Maximálne zdravie",
	"attribute.name.mining_efficiency": "Efektívnosť ťažby",
	"attribute.name.movement_efficiency": "Efektívnosť pohybu",
	"attribute.name.movement_speed": "Rýchlosť",
	"attribute.name.nameplate_distance": "Vzdialenosť menovky",
	"attribute.name.oxygen_bonus": "Kyslíkový bonus",
	"attribute.name.player.block_break_speed": "Rýchlosť ničenia kociek",
	"attribute.name.player.block_interaction_range": "Dosah interakcií s kockami",
	"attribute.name.player.entity_interaction_range": "Dosah interakcií s entitami",
	"attribute.name.player.mining_efficiency": "Efektívnosť ťažby",
	"attribute.name.player.sneaking_speed": "Rýchlosť zakrádania",
	"attribute.name.player.submerged_mining_speed": "Efektívnosť ťažby pod vodou",
	"attribute.name.player.sweeping_damage_ratio": "Miera svištivého poranenia",
	"attribute.name.safe_fall_distance": "Bezpečná hĺbka pádu",
	"attribute.name.scale": "Mierka",
	"attribute.name.sneaking_speed": "Rýchlosť zakrádania",
	"attribute.name.spawn_reinforcements": "Zombie posily",
	"attribute.name.step_height": "Výška kroku",
	"attribute.name.submerged_mining_speed": "Efektívnosť ťažby pod hladinou",
	"attribute.name.sweeping_damage_ratio": "Miera svištivého poranenia",
	"attribute.name.tempt_range": "Dosah lákania tvorov",
	"attribute.name.water_movement_efficiency": "Efektívnosť pohybu vo vode",
	"attribute.name.waypoint_receive_range": "Dosah príjmu orientačného bodu",
	"attribute.name.waypoint_transmit_range": "Dosah prenosu orientačného bodu",
	...
	"biome.minecraft.pale_garden": "Bledý háj",
	...
	"biome.minecraft.sulfur_caves": "Sírové jaskyne",
	...
	"block.minecraft.acacia_shelf": "Akáciová polička",
	...
	"block.minecraft.bamboo_shelf": "Bambusová polička",
	...
	"block.minecraft.banner.flow.black": "Čierny tok",
	"block.minecraft.banner.flow.blue": "Modrý tok",
	"block.minecraft.banner.flow.brown": "Hnedý tok",
	"block.minecraft.banner.flow.cyan": "Tyrkysový tok",
	"block.minecraft.banner.flow.gray": "Sivý tok",
	"block.minecraft.banner.flow.green": "Zelený tok",
	"block.minecraft.banner.flow.light_blue": "Svetlomodrý tok",
	"block.minecraft.banner.flow.light_gray": "Svetlosivý tok",
	"block.minecraft.banner.flow.lime": "Svetlozelený tok",
	"block.minecraft.banner.flow.magenta": "Purpurový tok",
	"block.minecraft.banner.flow.orange": "Oranžový tok",
	"block.minecraft.banner.flow.pink": "Ružový tok",
	"block.minecraft.banner.flow.purple": "Fialový tok",
	"block.minecraft.banner.flow.red": "Červený tok",
	"block.minecraft.banner.flow.white": "Biely tok",
	"block.minecraft.banner.flow.yellow": "Žltý tok",
	...
	"block.minecraft.banner.guster.black": "Čierny fujak",
	"block.minecraft.banner.guster.blue": "Modrý fujak",
	"block.minecraft.banner.guster.brown": "Hnedý fujak",
	"block.minecraft.banner.guster.cyan": "Tyrkysový fujak",
	"block.minecraft.banner.guster.gray": "Sivý fujak",
	"block.minecraft.banner.guster.green": "Zelený fujak",
	"block.minecraft.banner.guster.light_blue": "Svetlomodrý fujak",
	"block.minecraft.banner.guster.light_gray": "Svetlosivý fujak",
	"block.minecraft.banner.guster.lime": "Svetlozelený fujak",
	"block.minecraft.banner.guster.magenta": "Purpurový fujak",
	"block.minecraft.banner.guster.orange": "Oranžový fujak",
	"block.minecraft.banner.guster.pink": "Ružový fujak",
	"block.minecraft.banner.guster.purple": "Fialový fujak",
	"block.minecraft.banner.guster.red": "Červený fujak",
	"block.minecraft.banner.guster.white": "Biely fujak",
	"block.minecraft.banner.guster.yellow": "Žltý fujak",
	...
	"block.minecraft.birch_shelf": "Brezová polička",
	...
	"block.minecraft.bush": "Krík",
	"block.minecraft.cactus": "Kaktus",
	"block.minecraft.cactus_flower": "Kaktusový kvet",
	...
	"block.minecraft.cherry_shelf": "Čerešňová polička",
	...
	"block.minecraft.chiseled_cinnabar": "Otesaná rumelka",
	"block.minecraft.chiseled_copper": "Otesaná meď",
	...
	"block.minecraft.chiseled_resin_bricks": "Otesané živicové tehly",
	"block.minecraft.chiseled_sandstone": "Otesaný pieskovec",
	"block.minecraft.chiseled_stone_bricks": "Otesané kamenné tehly",
	"block.minecraft.chiseled_sulfur": "Otesaná síra",
	"block.minecraft.chiseled_tuff": "Otesaný tuf",
	"block.minecraft.chiseled_tuff_bricks": "Otesané tufové tehly",
	"block.minecraft.chorus_flower": "Chorusový kvet",
	"block.minecraft.chorus_plant": "Chorusová rastlina",
	"block.minecraft.cinnabar": "Rumelka",
	"block.minecraft.cinnabar_brick_slab": "Stupienok z rumelkových tehál",
	"block.minecraft.cinnabar_brick_stairs": "Schody z rumelkových tehál",
	"block.minecraft.cinnabar_brick_wall": "Múr z rumelkových tehál",
	"block.minecraft.cinnabar_bricks": "Rumelkové tehly",
	"block.minecraft.cinnabar_slab": "Rumelkový stupienok",
	"block.minecraft.cinnabar_stairs": "Rumelkové schody",
	"block.minecraft.cinnabar_wall": "Rumelkový múr",
	"block.minecraft.clay": "Íl",
	"block.minecraft.closed_eyeblossom": "Zatvorená zornička",
	...
	"block.minecraft.copper_bars": "Medené mreže",
	"block.minecraft.copper_block": "Kocka medi",
	"block.minecraft.copper_bulb": "Medená žiarovka",
	"block.minecraft.copper_chain": "Medená reťaz",
	"block.minecraft.copper_chest": "Medená truhlica",
	"block.minecraft.copper_door": "Medené dvere",
	"block.minecraft.copper_golem_statue": "Soška medeného golema",
	"block.minecraft.copper_grate": "Medená mriežka",
	"block.minecraft.copper_lantern": "Medený lampáš",
	"block.minecraft.copper_ore": "Medená ruda",
	"block.minecraft.copper_torch": "Medená fakľa",
	"block.minecraft.copper_trapdoor": "Medený poklop",
	"block.minecraft.copper_wall_torch": "Nástenná medená fakľa",
	...
	"block.minecraft.crafter": "Výrobník",
	"block.minecraft.crafting_table": "Pracovný stôl",
	"block.minecraft.creaking_heart": "Srdce škripotu",
	...
	"block.minecraft.crimson_shelf": "Karmínová polička",
	...
	"block.minecraft.dark_oak_shelf": "Polička z tmavého dubu",
	...
	"block.minecraft.dead_bush": "Suchý krík",
	...
	"block.minecraft.decorated_pot": "Ozdobný džbán",
	...
	"block.minecraft.dried_ghast": "Vyschnutý ghast",
	...
	"block.minecraft.exposed_chiseled_copper": "Zájdená otesaná meď",
	"block.minecraft.exposed_copper": "Zájdená meď",
	"block.minecraft.exposed_copper_bars": "Zájdené medené mreže",
	"block.minecraft.exposed_copper_bulb": "Zájdená medená žiarovka",
	"block.minecraft.exposed_copper_chain": "Zájdená medená reťaz",
	"block.minecraft.exposed_copper_chest": "Zájdená medená truhlica",
	"block.minecraft.exposed_copper_door": "Zájdené medené dvere",
	"block.minecraft.exposed_copper_golem_statue": "Zájdená soška medeného golema",
	"block.minecraft.exposed_copper_grate": "Zájdená medená mriežka",
	"block.minecraft.exposed_copper_lantern": "Zájdený medený lampáš",
	"block.minecraft.exposed_copper_trapdoor": "Zájdený medený poklop",
	...
	"block.minecraft.exposed_lightning_rod": "Zájdený bleskozvod",
	...
	"block.minecraft.firefly_bush": "Krík so svetluškami",
	...
	"block.minecraft.golden_dandelion": "Zlatá púpava",
	...
	"block.minecraft.heavy_core": "Ťažké jadro",
	...
	"block.minecraft.iron_chain": "Železná reťaz",
	...
	"block.minecraft.jungle_shelf": "Džungľová polička",
	...
	"block.minecraft.leaf_litter": "Opadané lístie",
	...
	"block.minecraft.mangrove_shelf": "Mangrovová polička",
	...
	"block.minecraft.oak_shelf": "Dubová polička",
	...
	"block.minecraft.open_eyeblossom": "Otvorená zornička",
	...
	"block.minecraft.oxidized_chiseled_copper": "Skorodovaná otesaná meď",
	"block.minecraft.oxidized_copper": "Skorodovaná meď",
	"block.minecraft.oxidized_copper_bars": "Skorodované medené mreže",
	"block.minecraft.oxidized_copper_bulb": "Skorodovaná medená žiarovka",
	"block.minecraft.oxidized_copper_chain": "Skorodovaná medená reťaz",
	"block.minecraft.oxidized_copper_chest": "Skorodovaná medená truhlica",
	"block.minecraft.oxidized_copper_door": "Skorodované medené dvere",
	"block.minecraft.oxidized_copper_golem_statue": "Skorodovaná soška medeného golema",
	"block.minecraft.oxidized_copper_grate": "Skorodovaná medená mriežka",
	"block.minecraft.oxidized_copper_lantern": "Skorodovaný medený lampáš",
	"block.minecraft.oxidized_copper_trapdoor": "Skorodovaný medený poklop",
	...
	"block.minecraft.oxidized_lightning_rod": "Skorodovaný bleskozvod",
	"block.minecraft.packed_ice": "Tvrdý ľad",
	"block.minecraft.packed_mud": "Stvrdnuté blato",
	"block.minecraft.pale_hanging_moss": "Visiaci bledý mach",
	"block.minecraft.pale_moss_block": "Kocka bledého machu",
	"block.minecraft.pale_moss_carpet": "Koberec z bledého machu",
	"block.minecraft.pale_oak_button": "Tlačidlo z bledého dubu",
	"block.minecraft.pale_oak_door": "Dvere z bledého dubu",
	"block.minecraft.pale_oak_fence": "Plot z bledého dubu",
	"block.minecraft.pale_oak_fence_gate": "Bránka z bledého dubu",
	"block.minecraft.pale_oak_hanging_sign": "Závesná ceduľa z bledého dubu",
	"block.minecraft.pale_oak_leaves": "Listy bledého dubu",
	"block.minecraft.pale_oak_log": "Kmeň bledého dubu",
	"block.minecraft.pale_oak_planks": "Dosky z bledého dubu",
	"block.minecraft.pale_oak_pressure_plate": "Nášľapná doska z bledého dubu",
	"block.minecraft.pale_oak_sapling": "Sadenica bledého dubu",
	"block.minecraft.pale_oak_shelf": "Polička z bledého dubu",
	"block.minecraft.pale_oak_sign": "Ceduľa z bledého dubu",
	"block.minecraft.pale_oak_slab": "Stupienok z bledého dubu",
	"block.minecraft.pale_oak_stairs": "Schody z bledého dubu",
	"block.minecraft.pale_oak_trapdoor": "Poklop z bledého dubu",
	"block.minecraft.pale_oak_wall_hanging_sign": "Nástenná závesná ceduľa z bledého dubu",
	"block.minecraft.pale_oak_wall_sign": "Nástenná ceduľa z bledého dubu",
	"block.minecraft.pale_oak_wood": "Drevo z bledého dubu",
	...
	"block.minecraft.polished_cinnabar": "Leštená rumelka",
	"block.minecraft.polished_cinnabar_slab": "Stupienok z leštenej rumelky",
	"block.minecraft.polished_cinnabar_stairs": "Schody z leštenej rumelky",
	"block.minecraft.polished_cinnabar_wall": "Múr z leštenej rumelky",
	...
	"block.minecraft.polished_sulfur": "Leštená síra",
	"block.minecraft.polished_sulfur_slab": "Stupienok z leštenej síry",
	"block.minecraft.polished_sulfur_stairs": "Schody z leštenej síry",
	"block.minecraft.polished_sulfur_wall": "Múr z leštenej síry",
	"block.minecraft.polished_tuff": "Leštený tuf",
	"block.minecraft.polished_tuff_slab": "Stupienok z lešteného tufu",
	"block.minecraft.polished_tuff_stairs": "Schody z lešteného tufu",
	"block.minecraft.polished_tuff_wall": "Múr z lešteného tufu",
	"block.minecraft.poppy": "Vlčí mak",
	"block.minecraft.potatoes": "Zemiaky",
	"block.minecraft.potent_sulfur": "Koncentrovaná síra",
	...
	"block.minecraft.potted_closed_eyeblossom": "Zatvorená zornička v kvetináči",
	...
	"block.minecraft.potted_dead_bush": "Suchý krík v kvetináči",
	"block.minecraft.potted_fern": "Papraď v kvetináči",
	"block.minecraft.potted_flowering_azalea_bush": "Kvitnúca azalka v kvetináči",
	"block.minecraft.potted_golden_dandelion": "Zlatá púpava v kvetináči",
	...
	"block.minecraft.potted_open_eyeblossom": "Otvorená zornička v kvetináči",
	"block.minecraft.potted_orange_tulip": "Oranžový tulipán v kvetináči",
	"block.minecraft.potted_oxeye_daisy": "Margaréta v kvetináči",
	"block.minecraft.potted_pale_oak_sapling": "Sadenica bledého dubu v kvetináči",
	...
	"block.minecraft.resin_block": "Kocka živice",
	"block.minecraft.resin_brick_slab": "Schodík zo živicových tehál",
	"block.minecraft.resin_brick_stairs": "Schody zo živicových tehál",
	"block.minecraft.resin_brick_wall": "Múr zo živicových tehál",
	"block.minecraft.resin_bricks": "Živicové tehly",
	"block.minecraft.resin_clump": "Hrudka živice",
	...
	"block.minecraft.short_dry_grass": "Nízka suchá tráva",
	"block.minecraft.short_grass": "Nízka tráva",
	...
	"block.minecraft.spruce_shelf": "Smreková polička",
	...
	"block.minecraft.stripped_pale_oak_log": "Olúpaný kmeň bledého dubu",
	"block.minecraft.stripped_pale_oak_wood": "Olúpané drevo z bledého dubu",
	...
	"block.minecraft.sulfur": "Síra",
	"block.minecraft.sulfur_brick_slab": "Stupienok zo sírových tehál",
	"block.minecraft.sulfur_brick_stairs": "Schody zo sírových tehál",
	"block.minecraft.sulfur_brick_wall": "Múr zo sírových tehál",
	"block.minecraft.sulfur_bricks": "Sírové tehly",
	"block.minecraft.sulfur_slab": "Sírový stupienok",
	"block.minecraft.sulfur_spike": "Sírový špic",
	"block.minecraft.sulfur_stairs": "Sírové schody",
	"block.minecraft.sulfur_wall": "Sírový múr",
	...
	"block.minecraft.tall_dry_grass": "Vysoká suchá tráva",
	...
	"block.minecraft.test_block": "Testovacia kocka",
	"block.minecraft.test_instance_block": "Kocka testovacej inštancie",
	"block.minecraft.tinted_glass": "Tmavé sklo",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "Výbuchy TNT sú vypnuté",
	...
	"block.minecraft.trial_spawner": "Skúšková liaheň",
	...
	"block.minecraft.tuff_brick_slab": "Stupienok z tufových tehál",
	"block.minecraft.tuff_brick_stairs": "Schody z tufových tehál",
	"block.minecraft.tuff_brick_wall": "Múr z tufových tehál",
	"block.minecraft.tuff_bricks": "Tufové tehly",
	"block.minecraft.tuff_slab": "Tufový stupienok",
	"block.minecraft.tuff_stairs": "Tufové schody",
	"block.minecraft.tuff_wall": "Tufový múr",
	...
	"block.minecraft.vault": "Pokladnica",
	...
	"block.minecraft.warped_shelf": "Prízračná polička",
	...
	"block.minecraft.waxed_chiseled_copper": "Navoskovaná otesaná meď",
	"block.minecraft.waxed_copper_bars": "Navoskované medené mreže",
	"block.minecraft.waxed_copper_block": "Navoskovaná kocka medi",
	"block.minecraft.waxed_copper_bulb": "Navoskovaná medená žiarovka",
	"block.minecraft.waxed_copper_chain": "Navoskovaná medená reťaz",
	"block.minecraft.waxed_copper_chest": "Navoskovaná medená truhlica",
	"block.minecraft.waxed_copper_door": "Navoskované medené dvere",
	"block.minecraft.waxed_copper_golem_statue": "Navoskovaná soška medeného golema",
	"block.minecraft.waxed_copper_grate": "Navoskovaná medená mriežka",
	"block.minecraft.waxed_copper_lantern": "Navoskovaný medený lampáš",
	"block.minecraft.waxed_copper_trapdoor": "Navoskovaný medený poklop",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Navoskovaná zájdená otesaná meď",
	"block.minecraft.waxed_exposed_copper": "Navoskovaná zájdená meď",
	"block.minecraft.waxed_exposed_copper_bars": "Navoskované zájdené medené mreže",
	"block.minecraft.waxed_exposed_copper_bulb": "Navoskovaná zájdená medená žiarovka",
	"block.minecraft.waxed_exposed_copper_chain": "Navoskovaná zájdená medená reťaz",
	"block.minecraft.waxed_exposed_copper_chest": "Navoskovaná zájdená medená truhlica",
	"block.minecraft.waxed_exposed_copper_door": "Navoskované zájdené medené dvere",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Navoskovaná zájdená soška medeného golema",
	"block.minecraft.waxed_exposed_copper_grate": "Navoskovaná zájdená medená mriežka",
	"block.minecraft.waxed_exposed_copper_lantern": "Navoskovaný zájdený medený lampáš",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Navoskovaný zájdený medený poklop",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Navoskovaný zájdený bleskozvod",
	"block.minecraft.waxed_lightning_rod": "Navoskovaný bleskozvod",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Navoskovaná skorodovaná otesaná meď",
	"block.minecraft.waxed_oxidized_copper": "Navoskovaná skorodovaná meď",
	"block.minecraft.waxed_oxidized_copper_bars": "Navoskované skorodované medené mreže",
	"block.minecraft.waxed_oxidized_copper_bulb": "Navoskovaná skorodovaná medená žiarovka",
	"block.minecraft.waxed_oxidized_copper_chain": "Navoskovaná skorodovaná medená reťaz",
	"block.minecraft.waxed_oxidized_copper_chest": "Navoskovaná skorodovaná medená truhlica",
	"block.minecraft.waxed_oxidized_copper_door": "Navoskované skorodované medené dvere",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Navoskovaná skorodovaná soška medeného golema",
	"block.minecraft.waxed_oxidized_copper_grate": "Navoskovaná skorodovaná medená mriežka",
	"block.minecraft.waxed_oxidized_copper_lantern": "Navoskovaný skorodovaný medený lampáš",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Navoskovaný skorodovaný medený poklop",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Navoskovaný skorodovaný bleskozvod",
	"block.minecraft.waxed_weathered_chiseled_copper": "Navoskovaná zelenkavá otesaná meď",
	"block.minecraft.waxed_weathered_copper": "Navoskovaná zelenkavá meď",
	"block.minecraft.waxed_weathered_copper_bars": "Navoskované zelenkavé medené mreže",
	"block.minecraft.waxed_weathered_copper_bulb": "Navoskovaná zelenkavá medená žiarovka",
	"block.minecraft.waxed_weathered_copper_chain": "Navoskovaná zelenkavá medená reťaz",
	"block.minecraft.waxed_weathered_copper_chest": "Navoskovaná zelenkavá medená truhlica",
	"block.minecraft.waxed_weathered_copper_door": "Navoskované zelenkavé medené dvere",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Navoskovaná zelenkavá soška medeného golema",
	"block.minecraft.waxed_weathered_copper_grate": "Navoskovaná zelenkavá medená mriežka",
	"block.minecraft.waxed_weathered_copper_lantern": "Navoskovaný zelenkavý medený lampáš",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Navoskovaný zelenkavý medený poklop",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Navoskovaný zelenkavý bleskozvod",
	"block.minecraft.weathered_chiseled_copper": "Zelenkavá otesaná meď",
	"block.minecraft.weathered_copper": "Zelenkavá meď",
	"block.minecraft.weathered_copper_bars": "Zelenkavé medené mreže",
	"block.minecraft.weathered_copper_bulb": "Zelenkavá medená žiarovka",
	"block.minecraft.weathered_copper_chain": "Zelenkavá medená reťaz",
	"block.minecraft.weathered_copper_chest": "Zelenkavá medená truhlica",
	"block.minecraft.weathered_copper_door": "Zelenkavé medené dvere",
	"block.minecraft.weathered_copper_golem_statue": "Zelenkavá soška medeného golema",
	"block.minecraft.weathered_copper_grate": "Zelenkavá medená mriežka",
	"block.minecraft.weathered_copper_lantern": "Zelenkavý medený lampáš",
	"block.minecraft.weathered_copper_trapdoor": "Zelenkavý medený poklop",
	...
	"block.minecraft.weathered_lightning_rod": "Zelenkavý bleskozvod",
	...
	"block.minecraft.wildflowers": "Divé kvety",
	...
	"book.edit.title": "Obrazovka upravovania knihy",
	...
	"book.page_button.next": "Nasledujúca strana",
	"book.page_button.previous": "Predchádzajúca strana",
	"book.sign.title": "Obrazovka podpisovania knihy",
	"book.sign.titlebox": "Názov",
	"book.signButton": "Podpísať",
	"book.view.title": "Obrazovka zobrazenia knihy",
	"build.spawn_protection": "%s spadá pod ochranu rodiska",
	"build.tooHigh": "Výškový limit pre stavanie je %s",
	"build.tooLow": "Minimálna výška pre stavanie je %s",
	...
	"chat.disabled.invalid_command_signature": "Príkaz mal neočakávané alebo chýbajúce podpisy argumentov.",
	"chat.disabled.invalid_signature": "Chat mal neplatný podpis. Skús sa znovu pripojiť.",
	...
	"chat.disabled.out_of_order_chat": "Chat neprišiel v správnom poradí. Zmenil sa čas tvojho operačného systému?",
	...
	"chat.queue.tooltip": "Klikni pre zobrazenie ďalšej správy",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "Server poslal neplatnú správu.",
	...
	"chat.validation_error": "Chyba v overení chatu",
	"chat_restriction.chat_and_commands_disabled_by_options": "Chat je blokovaný v nastaveniach klienta.",
	"chat_restriction.chat_disabled_by_options": "Chat pre hráčov je blokovaný v nastaveniach klienta.",
	"chat_restriction.chat_disabled_by_options.action": "Prejsť do nastavení chatu",
	"chat_restriction.disabled_by_launcher": "Chat je blokovaný spúšťačom",
	"chat_restriction.disabled_by_profile": "Chat je blokovaný v nastaveniach profilu.",
	"chat_restriction.disabled_by_profile.action": "Prejsť do nastavení profilu",
	"chat_screen.commands_not_allowed": "Používanie príkazov nie je povolené",
	"chat_screen.message": "Správa na odoslanie: %s",
	"chat_screen.messages_not_allowed": "Posielanie správ nie je povolené",
	"chat_screen.restricted": "Chat je zablokovaný. Pre viac informácií klikni na túto správu.",
	"chat_screen.restricted.narration": "Chat je zablokovaný. Prejdi do menu obmedzení v nastaveniach sveta.",
	"chat_screen.title": "Obrazovka chatu",
	"chat_screen.usage": "Napíš správu a stlač enter pre odoslanie",
	"chunk.toast.checkLog": "Pozri záznam pre viac informácií",
	"chunk.toast.loadFailure": "Nepodarilo sa načítať chunk na pozícii %s",
	"chunk.toast.lowDiskSpace": "Nedostatok miesta na disku!",
	"chunk.toast.lowDiskSpace.description": "Je možné, že sa svet neuloží správne.",
	"chunk.toast.saveFailure": "Nepodarilo sa uložiť chunk na pozícii %s",
	...
	"command.forkLimit": "Maximálny počet kontextov (%s) prekročený",
	"command.trailing_data": "Neočakávané dáta: %s",
	...
	"commands.attribute.base_value.reset.success": "Základná hodnota atribútu %s entity %s bola obnovená na %s",
	...
	"commands.banlist.entry.unknown": "(Neznámy)",
	...
	"commands.data.modify.expected_list": "Očakával sa zoznam, zadané bolo: %s",
	"commands.data.modify.expected_object": "Očakával sa objekt, zadané bolo: %s",
	"commands.data.modify.expected_value": "Očakávala sa hodnota, zadané bolo: %s",
	...
	"commands.datapack.create.already_exists": "Balíček s menom \"%s\" už existuje",
	"commands.datapack.create.invalid_full_name": "Neplatný názov nového balíčka \"%s\"",
	"commands.datapack.create.invalid_name": "Neplatné znaky v novom názve balíčka \"%s\"",
	"commands.datapack.create.io_failure": "Nepodarilo sa vytvoriť balíček s názvom \"%s\", pozri záznam",
	"commands.datapack.create.metadata_encode_failure": "Nepodarilo sa zakódovať metadáta pre balíček s názvom \"%s\": %s",
	"commands.datapack.create.success": "Bol vytvorený nový prázdny balíček s názvom \"%s\"",
	"commands.datapack.disable.failed": "Balík \"%s\" nie je zapnutý!",
	"commands.datapack.disable.failed.feature": "Balík \"%s\" nie je možné vypnúť, pretože je súčasťou aktívneho nastavenia!",
	...
	"commands.debug.function.noReturnRun": "Sledovanie nie je možné použiť s príkazom return run",
	...
	"commands.dialog.clear.multiple": "Dialóg bol zmazaný pre %s hráčov",
	"commands.dialog.clear.single": "Dialóg bol zmazaný pre %s",
	"commands.dialog.show.multiple": "Dialóg bol zobrazený pre %s hráčov",
	"commands.dialog.show.single": "Dialóg bol zobrazený pre %s",
	...
	"commands.drop.no_loot_table.block": "Kocka %s nemá žiadnu tabuľku obsahu",
	...
	"commands.execute.function.instantiationFailure": "Nepodarilo sa spustiť funkciu %s: %s",
	"commands.experience.add.levels.success.multiple": "%s úrovní skúsenosti bolo pridaných %s hráčom",
	"commands.experience.add.levels.success.single": "%s úrovní skúsenosti bolo pridaných hráčovi %s",
	...
	"commands.experience.query.levels": "%s má %s úrovní skúsenosti",
	...
	"commands.fetchprofile.copy_component": "Skopírovať komponent",
	"commands.fetchprofile.copy_text": "Skopírovať %s",
	"commands.fetchprofile.entity.success": "Profil pre entitu %s rozlíšený: %s",
	"commands.fetchprofile.failed_to_serialize": "Nepodarilo sa serializovať profil: %s",
	"commands.fetchprofile.give_item": "Dať predmet",
	"commands.fetchprofile.id.failure": "Nepodarilo sa rozlíšiť profil s ID %s",
	"commands.fetchprofile.id.success": "Profil s ID %s rozlíšený: %s",
	"commands.fetchprofile.name.failure": "Nepodarilo sa rozlíšiť profil s menom %s",
	"commands.fetchprofile.name.success": "Profil s menom %s rozlíšený: %s",
	"commands.fetchprofile.no_profile": "Entita %s nemá žiadny profil",
	"commands.fetchprofile.summon_mannequin": "Vyvolať figurínu",
	...
	"commands.function.error.argument_not_compound": "Neplatný typ argumentu: %s, očakáva sa compound",
	"commands.function.error.missing_argument": "Chýba argument %[2]s ku funkcii %[1]s",
	"commands.function.error.missing_arguments": "Chýbajú argumenty k funkcii %s",
	"commands.function.error.parse": "Pri inštancii makra \"%s\" príkaz \"%s\" spôsobil chybu: %s",
	"commands.function.instantiationFailure": "Nepodarilo sa spustiť funkciu %s: %s",
	"commands.function.result": "Funkcia %s vrátila %s",
	"commands.function.scheduled.multiple": "Bežia funkcie %s",
	"commands.function.scheduled.no_functions": "Nenašla sa žiadna funkcia s menom %s",
	"commands.function.scheduled.single": "Beží funkcia %s",
	...
	"commands.kick.owner.failed": "Pri LAN hre nie je možné vykopnúť vlastníka",
	"commands.kick.singleplayer.failed": "V offline hre jedného hráča nie je možné nikoho vyhodiť",
	"commands.kick.success": "Hráč %s bol vykopnutý: %s",
	...
	"commands.profile_fetch.copy_component": "Skopírovať komponent",
	"commands.profile_fetch.failed_to_serialize": "Nepodarilo sa serializovať profil: %s",
	"commands.profile_fetch.give_item": "Dať predmet",
	"commands.profile_fetch.id.failure": "Nepodarilo sa rozlíšiť profil s ID %s",
	"commands.profile_fetch.id.success": "Profil s ID %s rozlíšený: %s",
	"commands.profile_fetch.name.failure": "Nepodarilo sa rozlíšiť profil s menom %s",
	"commands.profile_fetch.name.success": "Profil s menom %s rozlíšený: %s",
	"commands.publish.alreadyPublished": "Hra viacerých hráčov už beží na porte %s",
	"commands.publish.alreadyPublished.lan": "Lokálna hra už beží na porte %s",
	"commands.publish.alreadyPublished.online": "Online hra už beží",
	"commands.publish.failed": "Nepodarilo sa spustiť lokálnu hru",
	"commands.publish.started": "Lokálna hra hostovaná na porte %s",
	"commands.publish.started.lan": "Lokálna hra spustená na porte %s",
	"commands.publish.started.online": "Online hra spustená",
	"commands.publish.success": "Hra viacerých hráčov beží na porte %s",
	"commands.random.error.range_too_large": "Rozsah náhodnej hodnoty nemôže byť väčší ako 2147483646",
	"commands.random.error.range_too_small": "Rozsah náhodnej hodnoty nemôže byť menší ako 2",
	"commands.random.reset.all.success": "%s náhodných sekvencií bolo obnovených",
	"commands.random.reset.success": "Bola obnovená náhodná sekvencia %s",
	"commands.random.roll": "Hráč %s náhodne vygeneroval číslo %s spomedzi %s a %s",
	"commands.random.sample.success": "Náhodná hodnota: %s",
	...
	"commands.rotate.success": "Otočené: %s",
	...
	"commands.schedule.macro": "Nie je možné naplánovať makro",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Automatické aktualizovanie zobrazovania cieľa %s bolo vypnuté",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Automatické aktualizovanie zobrazovania cieľa %s bolo zapnuté",
	"commands.scoreboard.objectives.modify.displayname": "Zobrazovaný názov úlohy %s bol zmenený na %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Predvolený číselný formát cieľa %s bol odstránený",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Predvolený číselný formát cieľa %s bol zmenený",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Zobrazovacie meno bolo odstránené pre %s entít v %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Zobrazovacie meno bolo odstránené pre %s v %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Zobrazovacie meno %[2]s entít v %[3]s bolo zmenené na %[1]s",
	"commands.scoreboard.players.display.name.set.success.single": "Zobrazovacie meno %[2]s v %[3]s bolo zmenené na %[1]s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Číselný formát bol odstránený pre %s entít v %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Číselný formát bol odstránený pre %s v %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Číselný formát bol zmenený pre %s entít v %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Číselný formát bol zmenený pre %s v %s",
	...
	"commands.setidletimeout.success.disabled": "Maximálny čas nečinnosti hráča bol vypnutý",
	"commands.setworldspawn.failure.not_overworld": "Bod zrodenia je možné nastaviť len pre obyčajný svet",
	"commands.setworldspawn.success": "Bod zrodenia pre tento svet bol nastavený na %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Bod zrodenia v dimenzii %[6]s bol pre tento svet nastavený na %[1]s, %[2]s, %[3]s [%[4]s, %[5]s]",
	"commands.spawnpoint.success.multiple": "Bod zrodenia v dimenzii %[5]s bol nastavený na %[1]s, %[2]s, %[3]s [%[4]s] pre %[6]s hráčov",
	"commands.spawnpoint.success.multiple.new": "Bod zrodenia v dimenzii %[6]s bol nastavený na %[1]s, %[2]s, %[3]s [%[4]s, %[5]s] pre %[7]s hráčov",
	"commands.spawnpoint.success.single": "Bod zrodenia pre %[6]s v dimenzii %[5]s bol nastavený na %[1]s, %[2]s, %[3]s [%[4]s]",
	"commands.spawnpoint.success.single.new": "Bod zrodenia v dimenzii %[6]s bol nastavený na %[1]s, %[2]s, %[3]s [%[4]s, %[5]s] pre %[7]s",
	"commands.spectate.cannot_spectate": "%s sa nedá pozorovať",
	...
	"commands.stopwatch.already_exists": "Stopky \"%s\" už existujú",
	"commands.stopwatch.create.success": "Stopky \"%s\" boli vytvorené",
	"commands.stopwatch.does_not_exist": "Stopky \"%s\" neexistujú",
	"commands.stopwatch.query": "Stopky \"%s\" bežali %s sekúnd",
	"commands.stopwatch.remove.success": "Stopky \"%s\" boli odstránené",
	"commands.stopwatch.restart.success": "Stopky \"%s\" boli reštartované",
	"commands.summon.failed": "Entitu nebolo možné vyvolať",
	"commands.summon.failed.peaceful": "Príšery nemožno vyvolať na mierumilovnej obtiažnosti",
	...
	"commands.swing.failed.notliving": "Nenašli sa žiadne entity na spustenie animácie švihnutia ruky",
	"commands.swing.success.multiple": "Animácia švihnutia ruky spustená na %s entitách",
	"commands.swing.success.single": "Animácia švihnutia ruky spustená na entite %s",
	...
	"commands.team.option.color.clear.success": "Farba pre tím %s bola odstránená",
	...
	"commands.test.batch.starting": "Spúšťa sa várka %[2]s prostredia %[1]s",
	"commands.test.clear.error.no_tests": "Neboli nájdené žiadne testy na vymazanie",
	"commands.test.clear.success": "%s štruktúr bolo vymazaných",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Klikni pre skopírovanie do schránky",
	"commands.test.create.success": "Vytvorený testovací plán pre test %s",
	"commands.test.error.no_test_containing_pos": "Nebola nájdená žiadna testovacia inštancia, ktorá obsahuje %s, %s, %s",
	"commands.test.error.no_test_instances": "Nenašli sa žiadne testovacie inštancie",
	"commands.test.error.non_existant_test": "Test %s nebol nájdený",
	"commands.test.error.structure_not_found": "Testovacia štruktúra %s nebola nájdená",
	"commands.test.error.test_instance_not_found": "Kocka s dátami testovacej inštancie nebola nájdená",
	"commands.test.error.test_instance_not_found.position": "Kocka s dátami testovacej inštancie nebola nájdená pre test na %s, %s, %s",
	"commands.test.error.too_large": "Veľkosť štruktúry musí byť menšia než %s na každej osi",
	"commands.test.locate.done": "Hľadanie dokončené, našlo sa %s štruktúr",
	"commands.test.locate.found": "Našla sa štruktúra na %s (vzdialenosť: %s)",
	"commands.test.locate.started": "Hľadajú sa testovacie štruktúry, môže to chvíľu trvať...",
	"commands.test.no_tests": "Nenašli sa žiadne testy na spustenie",
	"commands.test.relative_position": "Pozícia relatívna voči %s: %s",
	"commands.test.reset.error.no_tests": "Nenašli sa žiadne testy na resetovanie",
	"commands.test.reset.success": "%s štruktúr bolo resetovaných",
	"commands.test.run.no_tests": "Žiadne testy neboli nájdené",
	"commands.test.run.running": "Beží %s testov...",
	"commands.test.summary": "Test hry hotový! Bolo spustených %s testov",
	"commands.test.summary.all_required_passed": "Všetky povinné testy boli splnené :)",
	"commands.test.summary.failed": "%s povinných testov zlyhalo :(",
	"commands.test.summary.optional_failed": "%s voliteľných testov zlyhalo",
	"commands.tick.query.percentiles": "Percentily: P50: %s ms P95: %s ms P99: %s ms, vzorka: %s",
	"commands.tick.query.rate.running": "Cieľová frekvencia tikov: %s za sekundu.\nPriemerný čas za tik: %s ms (cieľ: %s ms)",
	"commands.tick.query.rate.sprinting": "Cieľová frekvencia tikov: %s za sekundu (ignorované, iba referencia).\nPriemerný čas za tik: %s ms",
	"commands.tick.rate.success": "Cieľová hodnota frekvencie tikov nastavená na %s za sekundu",
	"commands.tick.sprint.report": "Šprint bol dokončený s %s tikmi za sekundu alebo %s ms za tik",
	"commands.tick.sprint.stop.fail": "Žiadny tikový šprint nebeží",
	"commands.tick.sprint.stop.success": "Šprint tikov prerušený",
	"commands.tick.status.frozen": "Hra je práve zmrazená",
	"commands.tick.status.lagging": "Hra beží, ale nestíha udržiavať cieľovú frekvenciu tikov",
	"commands.tick.status.running": "Hra práve beží normálne",
	"commands.tick.status.sprinting": "Hra práve šprintuje",
	"commands.tick.step.fail": "Nepodarilo sa krokovať hru - treba ju najprv zmraziť",
	"commands.tick.step.stop.fail": "Žiadne krokovanie tikov nebeží",
	"commands.tick.step.stop.success": "Krokovanie tikov prerušené",
	"commands.tick.step.success": "Krokovanie %s tikov",
	"commands.time.no_default_clock": "Dimenzia %s nemá nastavený predvolený časomer",
	"commands.time.no_time_marker_found": "Časový bod %s neexistuje v časomere %s",
	"commands.time.pause": "Časomer %s pozastavený",
	"commands.time.query": "Čas je %s",
	"commands.time.query.absolute": "Časomer %s je práve na %s. tiku",
	"commands.time.query.gametime": "Doba chodu sveta je %s tikov",
	"commands.time.query.timeline": "Časová os %s je práve na %s. tiku",
	"commands.time.query.timeline.repetitions": "Časová os %s bola opakovaná už %s ráz",
	"commands.time.rate": "Časomer %s bude odteraz bežať %s-násobkom štandardnej rýchlosti",
	"commands.time.resume": "Časomer %s spustený",
	"commands.time.set": "Čas nastavený na %s",
	"commands.time.set.absolute": "Časomer %s nastavený na %s tikov",
	"commands.time.set.time_marker": "Časomer %s nastavený na časový bod %s",
	"commands.time.wrong_timeline_for_clock": "Časová os %s nie je platná pre časomer %s",
	...
	"commands.transfer.error.no_players": "Na prenos je potrebné špecifikovať aspoň jedného hráča",
	"commands.transfer.success.multiple": "%s hráčov sa prenáša do %s:%s",
	"commands.transfer.success.single": "Hráč %s sa prenáša do %s:%s",
	...
	"commands.unpublish.notPublished": "Žiadna hra viacerých hráčov nie je publikovaná",
	"commands.unpublish.success": "Hra viacerých hráčov už nie je publikovaná",
	"commands.version.build_time": "build_time = %s",
	"commands.version.data": "data = %s",
	"commands.version.header": "Informácie o verzii servera:",
	...
	"commands.waypoint.list.empty": "%s nemá žiadne orientačné body",
	"commands.waypoint.list.success": "%[2]s má %[1]s orientačných bodov: %[3]s",
	"commands.waypoint.modify.color": "Farba orientačného bodu je odteraz %s",
	"commands.waypoint.modify.color.reset": "Farba orientačného bodu bola obnovená",
	"commands.waypoint.modify.style": "Štýl orientačného bodu zmenené",
	...
	"component.profile.dynamic": "Dynamický",
	...
	"connect.failed.transfer": "Pri prenose na server zlyhalo pripojenie",
	"connect.joining": "Pripája sa k svetu...",
	"connect.negotiating": "Vyjednáva sa spojenie...",
	"connect.p2p.establishing": "Nadväzovanie spojenia...",
	"connect.p2p.failed.generic": "Nepodarilo sa pripojiť k hráčovi",
	"connect.p2p.failed.signaling": "Teraz nie je možné sa pripojiť.\nSkús to znovu neskôr.",
	"connect.p2p.failed.timeout": "Žiadosť o pripojenie vypršala",
	"connect.p2p.failed.unreachable": "Hráč nie je dostupný",
	"connect.reconfiging": "Prenastavovanie...",
	"connect.reconfiguring": "Prenastavovanie...",
	"connect.transferring": "Prebieha prenos na nový server...",
	"container.barrel": "Sud",
	"container.beacon": "Maják",
	"container.beehive.bees": "Počet včiel: %s/%s",
	"container.beehive.honey": "Úroveň medu: %s/%s",
	...
	"container.enchant.lapis.many": "%s kúsky lazuritu",
	"container.enchant.lapis.one": "1 kúsok lazuritu",
	"container.enchant.level.many": "%s úrovne očarovania",
	...
	"createWorld.customize.buffet.search": "Hľadať...",
	...
	"dataPack.locator_bar.description": "Ukáže smer k ostatným hráčom",
	"dataPack.locator_bar.name": "Lišta lokátora",
	"dataPack.minecart_improvements.description": "Vylepšený pohyb vozíkov",
	"dataPack.minecart_improvements.name": "Vylepšenia vozíkov",
	"dataPack.redstone_experiments.description": "Experimentálne zmeny redstonu",
	"dataPack.redstone_experiments.name": "Redstonové experimenty",
	"dataPack.title": "Vybrať dátové balíky",
	"dataPack.trade_rebalance.description": "Upravuje obchody u osadníkov",
	"dataPack.trade_rebalance.name": "Vyváženie obchodovania osadníkov",
	"dataPack.update_1_20.description": "Nové funkcie a obsah pre Minecraft 1.20",
	"dataPack.update_1_20.name": "Minecraft 1.20",
	"dataPack.update_1_21.description": "Nové funkcie a obsah pre Minecraft 1.21",
	"dataPack.update_1_21.name": "Aktualizácia 1.21",
	...
	"dataPack.winter_drop.description": "Nové funkcie a obsah pre Zimnú nádielku",
	"dataPack.winter_drop.name": "Zimná nádielka",
	...
	"death.attack.fallingStalactite.player": "Hráč %[1]s bol napichnutý padajúcim stalaktitom počas boja s %[2]s",
	...
	"death.attack.mace_smash": "Hráč %[2]s spravil z hráča %[1]s palacinku",
	"death.attack.mace_smash.item": "Hráč %[2]s spravil z hráča %[1]s palacinku s pomocou %[3]s",
	...
	"death.attack.spear": "Hráča %[1]s prebodol %[2]s",
	"death.attack.spear.item": "Hráča %[1]s prebodol %[2]s pomocou %[3]s",
	"death.attack.stalagmite": "Hráč %[1]s sa napichol na stalagmit",
	"death.attack.stalagmite.player": "Hráč %[1]s bol napichnutý na stalagmit počas boja s %[2]s",
	...
	"death.attack.sulfurCubeHot": "Hráč %[1]s dostal hrejivé objatie",
	"death.attack.sulfurCubeHot.player": "Hráč %[1]s dostal hrejivé objatie vďaka hráčovi %[2]s",
	...
	"death.attack.wither.player": "Hráč %[1]s sa vyparil pri boji s %[2]s",
	...
	"deathScreen.score.value": "Skóre: %s",
	...
	"debug.crash.message.rebindable": "Klávesy %s + %s sú stlačené. Ak nebudú uvoľnené, spôsobí to zlyhanie hry.",
	...
	"debug.entry.always": "Vždy",
	"debug.entry.currently.alwaysOn": "%s: Aktuálne vždy zapnuté",
	"debug.entry.currently.inF3": "%s: Aktuálne len v F3",
	"debug.entry.currently.inOverlay": "%s: Aktuálne len na ladiacom prekryve",
	"debug.entry.currently.never": "%s: Aktuálne vypnuté",
	"debug.entry.f3": "V F3",
	"debug.entry.overlay": "Na prekryve",
	...
	"debug.options.category.renderer": "Ladiace vykresľovače",
	"debug.options.category.text": "Text ladiacej obrazovky",
	"debug.options.help": "F3 + F6 = Upraviť možnosti ladenia",
	"debug.options.notAllowed.tooltip": "Neviditeľné pri stručných ladiacich informáciách",
	"debug.options.profile.default": "Predvolený profil",
	"debug.options.profile.performance": "Profil výkonu",
	"debug.options.search": "Hľadať...",
	"debug.options.title": "Možnosti ladenia",
	"debug.options.warning": "Tieto možnosti slúžia iba pre testovacie účely. Môžu spomaliť tvoj počítač, spôsobiť pád hry alebo zožrať tvoju domácu úlohu.",
	"debug.pause.help": "F3 + Esc = Pauza bez menu (ak je pauza možná)",
	"debug.pause_focus.help": "F3 + P = Pozastavenie hry, keď je na pozadí",
	"debug.pause_focus.off": "Pozastaviť hru na pozadí: nie",
	"debug.pause_focus.on": "Pozastaviť hru na pozadí: áno",
	...
	"debug.profiling.start.rebindable": "Profilovanie spustené na %s sekúnd. Použi %s + %s pre predčasné zastavenie",
	...
	"debug.version.header": "Informácie o verzii klienta:",
	"debug.version.help": "F3 + V = Informácie o verzii klienta",
	...
	"disconnect.packetError": "Chyba sieťového protokolu",
	"disconnect.spam": "Vykopnutý za spamovanie",
	"disconnect.timeout": "Časový limit vypršal",
	"disconnect.transfer": "Prenos na nový server prebehol úspešne",
	"disconnect.unknownHost": "Neznámy hostiteľ",
	"download.pack.failed": "%s z %s balíčkov sa nepodarilo stiahnuť",
	"download.pack.progress.bytes": "Priebeh: %s (celková veľkosť neznáma)",
	"download.pack.progress.percent": "Priebeh: %s%%",
	"download.pack.title": "Sťahovanie zdrojového balíka %s z %s",
	"editGamerule.default": "Predvolené: %s",
	"editGamerule.inGame.button": "Upraviť herné pravidlá...",
	"editGamerule.inGame.disabled.tooltip": "Úprava herných pravidiel vyžaduje operátorské práva.",
	"editGamerule.inGame.discardChanges.message": "Určite chceš zahodiť neuložené zmeny herných pravidiel?",
	"editGamerule.inGame.discardChanges.title": "Zmeny herných pravidiel",
	"editGamerule.inGame.downloadingGamerules": "Získavajú sa herné pravidlá...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Dych lodienky",
	...
	"effect.minecraft.infested": "Zamorenie",
	...
	"effect.minecraft.oozing": "Vytekanie",
	"effect.minecraft.poison": "Otrava",
	"effect.minecraft.raid_omen": "Znamenie nájazdu",
	...
	"effect.minecraft.trial_omen": "Znamenie skúšky",
	"effect.minecraft.unluck": "Smola",
	"effect.minecraft.water_breathing": "Dýchanie pod vodou",
	"effect.minecraft.weakness": "Slabosť",
	"effect.minecraft.weaving": "Tkanie",
	"effect.minecraft.wind_charged": "Veterné nabitie",
	...
	"enchantment.minecraft.breach": "Prerážanie",
	"enchantment.minecraft.channeling": "Vedenie",
	"enchantment.minecraft.density": "Hustota",
	...
	"enchantment.minecraft.lunge": "Výpad",
	...
	"enchantment.minecraft.piercing": "Priestrel",
	...
	"enchantment.minecraft.sweeping_edge": "Svištivé ostrie",
	...
	"enchantment.minecraft.wind_burst": "Veterná strela",
	"entity.minecraft.acacia_boat": "Akáciový čln",
	"entity.minecraft.acacia_chest_boat": "Akáciový čln s truhlicou",
	"entity.minecraft.allay": "Alík",
	"entity.minecraft.area_effect_cloud": "Oblak oblasti efektu",
	"entity.minecraft.armadillo": "Pásavec",
	"entity.minecraft.armor_stand": "Stojan na brnenie",
	"entity.minecraft.arrow": "Šíp",
	"entity.minecraft.axolotl": "Axolotl",
	"entity.minecraft.bamboo_chest_raft": "Bambusová plť s truhlicou",
	"entity.minecraft.bamboo_raft": "Bambusová plť",
	"entity.minecraft.bat": "Netopier",
	"entity.minecraft.bee": "Včela",
	"entity.minecraft.birch_boat": "Brezový čln",
	"entity.minecraft.birch_chest_boat": "Brezový čln s truhlicou",
	"entity.minecraft.blaze": "Ohnivák",
	"entity.minecraft.block_display": "Hologram kocky",
	"entity.minecraft.boat": "Čln",
	"entity.minecraft.bogged": "Vodník",
	"entity.minecraft.breeze": "Víchor",
	"entity.minecraft.breeze_wind_charge": "Veterný náboj",
	"entity.minecraft.camel": "Ťava",
	"entity.minecraft.camel_husk": "Ťaví zdochliak",
	"entity.minecraft.cat": "Mačka",
	"entity.minecraft.cave_spider": "Jaskynný pavúk",
	"entity.minecraft.cherry_boat": "Čerešňový čln",
	"entity.minecraft.cherry_chest_boat": "Čerešňový čln s truhlicou",
	...
	"entity.minecraft.copper_golem": "Medený golem",
	"entity.minecraft.cow": "Krava",
	"entity.minecraft.creaking": "Škripot",
	"entity.minecraft.creaking_transient": "Škripot",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Čln z tmavého dubu",
	"entity.minecraft.dark_oak_chest_boat": "Čln z tmavého dubu s truhlicou",
	...
	"entity.minecraft.happy_ghast": "Šťastný ghast",
	...
	"entity.minecraft.jungle_boat": "Džungľový čln",
	"entity.minecraft.jungle_chest_boat": "Džungľový čln s truhlicou",
	...
	"entity.minecraft.lingering_potion": "Plynný elixír",
	"entity.minecraft.llama": "Lama",
	"entity.minecraft.llama_spit": "Slina lamy",
	"entity.minecraft.magma_cube": "Magmový slizák",
	"entity.minecraft.mangrove_boat": "Mangrovový čln",
	"entity.minecraft.mangrove_chest_boat": "Mangrovový čln s truhlicou",
	"entity.minecraft.mannequin": "Figurína",
	...
	"entity.minecraft.nautilus": "Lodienka",
	"entity.minecraft.oak_boat": "Dubový čln",
	"entity.minecraft.oak_chest_boat": "Dubový čln s truhlicou",
	"entity.minecraft.ocelot": "Ocelot",
	"entity.minecraft.ominous_item_spawner": "Zlovestná liaheň predmetov",
	"entity.minecraft.painting": "Obraz",
	"entity.minecraft.pale_oak_boat": "Čln z bledého dubu",
	"entity.minecraft.pale_oak_chest_boat": "Čln z bledého dubu s truhlicou",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Suchár",
	...
	"entity.minecraft.splash_potion": "Hádzací elixír",
	"entity.minecraft.spruce_boat": "Smrekový čln",
	"entity.minecraft.spruce_chest_boat": "Smrekový čln s truhlicou",
	"entity.minecraft.squid": "Chobotnica",
	"entity.minecraft.stray": "Tulák",
	"entity.minecraft.strider": "Lávochod",
	"entity.minecraft.sulfur_cube": "Sírovec",
	"entity.minecraft.sulfur_cube.content": "Obsahuje: %s",
	...
	"entity.minecraft.tropical_fish.predefined.1": "Tŕňovec čierny",
	...
	"entity.minecraft.tropical_fish.predefined.2": "Tŕňovec pestrý",
	"entity.minecraft.tropical_fish.predefined.20": "Pleskozubec žltochvostý",
	"entity.minecraft.tropical_fish.predefined.21": "Tŕňovec žltý",
	...
	"entity.minecraft.wind_charge": "Veterný náboj",
	...
	"entity.minecraft.zombie_nautilus": "Zombie lodienka",
	...
	"event.minecraft.raid.defeat.full": "Nájazd - Porážka",
	"event.minecraft.raid.raiders_remaining": "Zostávajúcich nájazdníkov: %s",
	"event.minecraft.raid.victory": "Víťazstvo",
	"event.minecraft.raid.victory.full": "Nájazd - Víťazstvo",
	"filled_map.buried_treasure": "Mapa zakopaného pokladu",
	"filled_map.explorer_jungle": "Mapa na prieskum džungle",
	"filled_map.explorer_swamp": "Mapa na prieskum močiara",
	"filled_map.id": "ID #%s",
	...
	"filled_map.trial_chambers": "Mapa skúškových katakomb",
	"filled_map.unknown": "Neznáma mapa",
	"filled_map.village_desert": "Mapa púštnej dediny",
	"filled_map.village_plains": "Mapa dediny na pláni",
	"filled_map.village_savanna": "Mapa dediny v savane",
	"filled_map.village_snowy": "Mapa zasneženej dediny",
	"filled_map.village_taiga": "Mapa dediny v tajge",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Povoliť Nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Určuje, či smú hráči vstúpiť do Netheru alebo nie.",
	"gamerule.allowFireTicksAwayFromPlayer": "Šírenie ohňa bez hráčov",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Určuje, či sa oheň bude vytvárať alebo rozširovať ďalej ako 8 chunkov od hráčov",
	...
	"gamerule.commandBlocksEnabled": "Povoliť príkazové kocky",
	...
	"gamerule.disablePlayerMovementCheck": "Vypnúť kontrolu pohybu hráča",
	...
	"gamerule.enableCommandBlocks": "Povoliť príkazové kocky",
	"gamerule.enderPearlsVanishOnDeath": "Hodené Ender perly po smrti zmiznú",
	"gamerule.enderPearlsVanishOnDeath.description": "Určuje, či Ender perly hodené hráčom majú po jeho smrti zmiznúť.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Entity s pasažiermi môžu používať portály",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Umožniť entitám, nesúcim pasažierov, teleportovať sa cez Nether portály, portály do Endu a brány do Endu.",
	...
	"gamerule.locatorBar": "Použiť lištu lokátora hráčov",
	"gamerule.locatorBar.description": "Zobrazí indikátor polohy ostatných hráčov.",
	...
	"gamerule.maxCommandForkCount": "Limit kontextov príkazov",
	"gamerule.maxCommandForkCount.description": "Maximálny počet kontextov, ktoré môžu byť použité v príkazoch ako napríklad \"execute as\".",
	"gamerule.maxEntityCramming": "Limit natlačenia entít",
	"gamerule.minecartMaxSpeed": "Maximálna rýchlosť vozíka",
	"gamerule.minecartMaxSpeed.description": "Maximálna štandardná rýchlosť vozíka na súši.",
	"gamerule.minecraft.elytra_movement_check": "Kontrolovať pohyb na krovkách",
	"gamerule.minecraft.fire_spread_radius_around_player": "Dosah šírenia ohňa",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Polomer okolo hráča v kockách, v ktorom sa môže šíriť oheň",
	"gamerule.minecraft.player_movement_check": "Kontrolovať pohyb hráčov",
	"gamerule.minecraft.raids": "Spúšťať nájazdy",
	"gamerule.minecraft.universal_anger.description": "Rozhnevané neutrálne tvory útočia na každého hráča v blízkosti, nielen toho, ktorý ich rozhneval. Najlepšie to funguje pri vypnutom forgive_dead_players.",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Oneskorenie prechodu cez Nether portál v tvorivej hre",
	"gamerule.playersNetherPortalCreativeDelay.description": "Čas (v tikoch) potrebný na prechod medzi dimenziami, počas ktorého musí hráč v tvorivej hre stáť v Nether portáli.",
	"gamerule.playersNetherPortalDefaultDelay": "Oneskorenie prechodu cez Nether portál v inej ako tvorivej hre",
	"gamerule.playersNetherPortalDefaultDelay.description": "Čas (v tikoch) potrebný na prechod medzi dimenziami, počas ktorého musí hráč v inej ako tvorivej hre stáť v Nether portáli.",
	...
	"gamerule.projectilesCanBreakBlocks": "Projektily môžu rozbíjať kocky",
	"gamerule.projectilesCanBreakBlocks.description": "Určuje, či nárazy projektilov budú rozbíjať kocky, ktoré môžu rozbiť.",
	"gamerule.pvp": "Povoliť PvP",
	"gamerule.pvp.description": "Určuje, či smú hráči útočiť na iných hráčov alebo nie.",
	...
	"gamerule.spawnChunkRadius": "Polomer chunkov okolo bodu zrodenia",
	"gamerule.spawnChunkRadius.description": "Množstvo chunkov okolo bodu zrodenia v obyčajnom svete, ktoré zostanú načítané.",
	"gamerule.spawnMonsters": "Zrodiť príšery",
	"gamerule.spawnMonsters.description": "Určuje, či sa príšery prirodzene vyskytujú alebo nie.",
	"gamerule.spawnRadius": "Polomer polohy oživenia",
	"gamerule.spawnRadius.description": "Určuje veľkosť územia okolo bodu zrodenia, v ktorom sa môžu hráči objaviť.",
	"gamerule.spawnerBlocksEnabled": "Povoliť liahne",
	"gamerule.spectatorsGenerateChunks": "Povoliť divákom generovať terén",
	"gamerule.tntExplodes": "Umožniť, aby sa TNT aktivovalo a vybuchlo",
	...
	"gui.abuseReport.attestation": "Odoslaním tohto hlásenia potvrdzuješ, že poskytnuté informácie sú podľa tvojho najlepšieho vedomia presné a úplné.",
	"gui.abuseReport.comments": "Komentáre",
	"gui.abuseReport.describe": "Detailnejšie informácie nám pomôžu lepšie rozhodnúť.",
	"gui.abuseReport.discard.content": "Ak odídeš, tvoje hlásenie a komentáre budú stratené.\nUrčite chceš odísť?",
	"gui.abuseReport.discard.discard": "Odísť a zahodiť hlásenie",
	"gui.abuseReport.discard.draft": "Uložiť ako koncept",
	"gui.abuseReport.discard.return": "Pokračovať v úpravách",
	"gui.abuseReport.discard.title": "Zahodiť hlásenie a komentáre?",
	"gui.abuseReport.draft.content": "Chceš pokračovať v úpravách tohto hlásenia, alebo ho zahodiť a vytvoriť nové?",
	"gui.abuseReport.draft.discard": "Zahodiť",
	"gui.abuseReport.draft.edit": "Pokračovať v úpravách",
	"gui.abuseReport.draft.quittotitle.content": "Chceš pokračovať v úpravách, alebo ho zahodiť?",
	"gui.abuseReport.draft.quittotitle.title": "Máš rozpísaný koncept hlásenia o nevhodnom chate, ktorý sa neuloží, ak sa odpojíš",
	"gui.abuseReport.draft.title": "Upraviť koncept hlásenia o nevhodnom chate?",
	"gui.abuseReport.error.title": "Pri odosielaní tvojho hlásenia sa vyskytol problém",
	"gui.abuseReport.message": "Kde sa nevhodné správanie odohralo?\nMôže nám to pomôcť v preskúmaní tvojho prípadu.",
	"gui.abuseReport.more_comments": "Prosím, opíš, čo sa stalo:",
	"gui.abuseReport.name.comment_box_label": "Udaj dôvod, pre ktorý chceš nahlásiť toto meno:",
	"gui.abuseReport.name.reporting": "Nahlasuješ hráča \"%s\".",
	"gui.abuseReport.name.title": "Nahlásiť hráčovu prezývku",
	"gui.abuseReport.observed_what": "Prečo toto nahlasuješ?",
	"gui.abuseReport.read_info": "Zisti viac o nahlasovaní",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Očierňovanie",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Niekto poškodzuje povesť teba alebo niekoho iného, napríklad šíri nepravdivé informácie s cieľom zneužívať alebo zavádzať ostatných.",
	"gui.abuseReport.reason.description": "Popis:",
	"gui.abuseReport.reason.false_reporting": "Nepravdivé hlásenie",
	"gui.abuseReport.reason.generic": "Chcem nahlásiť tohto hráča",
	"gui.abuseReport.reason.generic.description": "Obťažuje ma / urobil niečo, čo sa mi nepáči.",
	...
	"gui.abuseReport.reason.imminent_harm": "Hrozba ublíženia niekomu",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Sebapoškodzovanie alebo samovražda",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Sexuálne nevhodné",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Skiny, ktoré graficky znázorňujú pohlavné orgány, akty alebo násilie.",
	...
	"gui.abuseReport.report_sent_msg": "Tvoje hlásenie bolo úspešne prijaté. Vďaka!\n\nNáš tím sa mu bude venovať čo najskôr.",
	"gui.abuseReport.select_reason": "Vyber kategóriu hlásenia",
	"gui.abuseReport.send": "Odoslať hlásenie",
	"gui.abuseReport.send.comment_too_long": "Prosím, skráť svoj komentár",
	...
	"gui.abuseReport.send.no_reason": "Prosím, vyber kategóriu hlásenia",
	"gui.abuseReport.send.not_attested": "Prečítaj si horeuvedený text a potvrď ho začiarknutím, aby bolo možné odoslať hlásenie",
	...
	"gui.abuseReport.skin.title": "Nahlásiť hráčov skin",
	"gui.abuseReport.title": "Nahlásiť hráča",
	"gui.abuseReport.type.chat": "Správy v chate",
	"gui.abuseReport.type.name": "Hráčova prezývka",
	"gui.abuseReport.type.skin": "Hráčov skin",
	"gui.acknowledge": "Prijať",
	"gui.advancements": "Pokroky",
	"gui.all": "Všetky",
	"gui.back": "Späť",
	"gui.banned.description": "%s\n\n%s\n\nViac informácií na nasledujúcom odkaze: %s",
	"gui.banned.description.permanent": "Tvoj účet je trvalo zablokovaný, preto nemôžeš hrať online, ani sa pripojiť k službe Realms.",
	...
	"gui.banned.description.temporary": "%s Dovtedy nemôžeš hrať online, ani sa pripojiť k službe Realms.",
	...
	"gui.banned.name.description": "Tvoja súčasná prezývka - \"%s\" - porušuje naše štandardy komunity. Môžeš hrať len hru jedného hráča pokým si nezmeníš prezývku.\n\nPre viac informácií alebo pre žiadosť o preverenie sťažnosti prejdi na %s",
	"gui.banned.name.title": "Táto prezývka nie je povolená v hre viacerých hráčov",
	...
	"gui.banned.skin.description": "Tvoj súčasný skin porušuje naše štandardy komunity. Môžeš hrať s predvoleným skinom alebo si môžeš zvoliť nový.\n\nPre viac informácií alebo pre žiadosť o preverenie sťažnosti prejdi na %s",
	"gui.banned.skin.title": "Tento skin nie je povolený",
	...
	"gui.chatReport.title": "Nahlásiť hráčove správy",
	...
	"gui.chatSelection.selected": "%s z %s vybraných správ",
	"gui.chatSelection.title": "Vyber správy na nahlásenie",
	"gui.continue": "Pokračovať",
	"gui.copy_link_to_clipboard": "Skopírovať odkaz do schránky",
	"gui.days": "%s d.",
	"gui.done": "Hotovo",
	"gui.down": "Dole",
	"gui.entity_tooltip.type": "Typ: %s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "%s súborov bolo odmietnutých",
	"gui.fileDropFailure.title": "Nepodarilo sa pridať súbory",
	"gui.friends.accept": "Prijať",
	"gui.friends.button.loading": "Čakaj...",
	"gui.friends.button.loading.invite_request_pending": "Čaká sa na potvrdenie",
	"gui.friends.button.loading.join_request_pending": "Čaká sa na potvrdenie",
	"gui.friends.cancel_request": "Zrušiť žiadosť",
	"gui.friends.confirm_title": "Potvrdiť",
	"gui.friends.confirm_unfriend": "Určite chceš zrušiť priateľstvo s týmto hráčom?",
	"gui.friends.copy_to_clipboard": "Skopírovať do schránky",
	"gui.friends.decline": "Zamietnuť",
	"gui.friends.empty_nickname": "Predtým, ako pošleš žiadosť o priateľstvo, zadaj platné meno profilu",
	"gui.friends.empty_state": "Hráči, s ktorými sa spriatelíš sa zobrazia tu.\n\nSpravovať online bezpečnosť s tvojím %s.",
	"gui.friends.empty_state.link": "Microsoft účtom",
	"gui.friends.enter_nickname": "Zadaj meno profilu",
	"gui.friends.error.connection_issue": "Zoznam priateľov momentálne nefunguje.",
	"gui.friends.error.failed.message": "Momentálne nie je možné odoslať tvoju žiadosť o priateľstvo",
	"gui.friends.error.forbidden.message": "Túto akciu sa nepodarilo vykonať. Môže to byť spôsobené nastaveniami súkromia účtu.",
	"gui.friends.error.generic": "Niečo nie je v poriadku — s touto funkciou, nie s tvojimi priateľmi!\n\nSkús to znova neskôr.",
	"gui.friends.error.rateLimited.message": "Pracuješ so zoznamom priateľov príliš rýchlo. Chvíľu počkaj a potom to skús znova.",
	"gui.friends.error.temporary_unavailable": "Zoznam priateľov momentálne nie je funkčný.\n\nSkús to znovu neskôr.",
	"gui.friends.error.unavailable.message": "Služba zoznam priateľov teraz nie je dostupná. Prosím skontroluj svoje pripojenie a skús to znovu neskôr.",
	"gui.friends.error.upgrade_needed": "Aktualizuj svoju hru pre prístup k tvojmu zoznamu priateľov.",
	"gui.friends.error.user_may_lack_active_profile": "Neexistuje hráč s týmto menom profilu",
	"gui.friends.join": "Pripojiť sa",
	"gui.friends.loading_friends": "Načítavanie zoznamu priateľov...",
	"gui.friends.loading_requests": "Načítavanie žiadostí...",
	"gui.friends.manage_account_footer": "Spravovať online bezpečnosť s tvojím %s",
	"gui.friends.multiplayer.invite": "Pozvať",
	"gui.friends.multiplayer.invite_accept": "Prijať",
	"gui.friends.multiplayer.invite_reject": "Odmietnuť",
	"gui.friends.multiplayer.join_request": "Požiadať o pridanie",
	"gui.friends.multiplayer.join_request_accept": "Prijať",
	"gui.friends.multiplayer.join_request_reject": "Odmietnuť",
	"gui.friends.my_profile_name": "Meno môjho profilu: ",
	"gui.friends.my_profile_name.narration": "Kopírovať meno profilu %s do schránky",
	"gui.friends.narration.button.accept": "Stlač enter pre prijatie žiadosti o priateľstvo od hráča %s",
	"gui.friends.narration.button.cancel_request": "Stlač enter pre zrušenie žiadosti o priateľstvo pre hráča %s",
	"gui.friends.narration.button.decline": "Stlač enter pre zamietnutie žiadosti o priateľstvo od hráča %s",
	"gui.friends.narration.button.unfriend": "Stlač enter pre zrušenie priateľstva s hráčom %s",
	"gui.friends.narration.entry.friend": "Priateľ %s",
	"gui.friends.narration.entry.incoming": "Prichádzajúca žiadosť od hráča %s",
	"gui.friends.narration.entry.outgoing": "Žiadosť odoslaná hráčovi %s",
	"gui.friends.open": "Priatelia",
	"gui.friends.open.narration": "Zoznam priateľov",
	"gui.friends.open.tooltip": "Priatelia",
	"gui.friends.pending.empty": "Žiadne čakajúce žiadosti o priateľstvo",
	"gui.friends.pending.received": "Doručené",
	"gui.friends.pending.sent": "Odoslané",
	"gui.friends.presence.status.offline": "Offline",
	"gui.friends.presence.status.online": "Online",
	"gui.friends.presence.status.playing_hosted_server": "Online (svet)",
	"gui.friends.presence.status.playing_offline": "Online (svet)",
	"gui.friends.presence.status.playing_realms": "Online (Realm)",
	"gui.friends.presence.status.playing_server": "Online (server)",
	"gui.friends.requests_count": "Žiadosti (%s)",
	"gui.friends.send_request": "Odoslať žiadosť o priateľstvo",
	"gui.friends.tab_friends": "Priatelia",
	"gui.friends.toast.friend_added.message": "Hráč %s prijal tvoju žiadosť o prijateľstvo",
	"gui.friends.toast.friend_invited.message": "Hráč %s bol pozvaný do tvojho sveta.",
	"gui.friends.toast.friend_removed.message": "Hráč %s bol odstránený z tvojho zoznamu priateľov",
	"gui.friends.toast.generic_error": "Pri aktualizovaní tvojho zoznamu priateľov nastala neočakávaná chyba. Prosím, skús to neskôr.",
	"gui.friends.toast.host_invite_expired.message": "Pozvánka pre hráča %s na pripojenie do tohto sveta vypršala.",
	"gui.friends.toast.invite_from_friend.message": "Hráč %s ťa pozval do svojho sveta. Otvor zoznam priateľov stlačením \"%s\" pre pripojenie",
	"gui.friends.toast.join_invite_expired.message": "Pozvánka na pripojenie do sveta hráča %s vypršala.",
	"gui.friends.toast.join_request.message": "%s sa chce pripojiť do tvojho sveta. Otvor zoznam priateľov stlačením \"%s\" alebo cez herné menu.",
	"gui.friends.toast.request_accepted.message": "Ty a %s ste odteraz priatelia",
	"gui.friends.toast.request_received.message": "Hráč %s ti poslal žiadosť o priateľstvo",
	"gui.friends.toast.request_sent.message": "Žiadosť o priateľstvo bola odoslaná hráčovi %s",
	"gui.friends.toast.request_to_join_friend.message": "Žiadosť o pripojenie do sveta hráča %s bola odoslaná",
	"gui.friends.toast.requests_accepted_multiple.message": "%s priateľov akceptovalo tvoju žiadosť o priateľstvo",
	"gui.friends.toast.requests_received_multiple.message": "%s hráčov ti posiela žiadosť o priateľstvo",
	"gui.friends.unfriend": "Odstrániť priateľa",
	"gui.game_rule.search": "Hľadať...",
	"gui.hours": "%s hod.",
	"gui.language.search": "Hľadať...",
	"gui.loadingMinecraft": "Minecraft sa načítava",
	"gui.minutes": "%s min.",
	...
	"gui.none": "Žiadny",
	"gui.ok": "Ok",
	"gui.open_report_dir": "Otvoriť adresár s hláseniami",
	"gui.packSelection.search": "Hľadať...",
	"gui.privacy_link.message": "Otvor tento odkaz pre spravovanie nastavenia súkromia a online bezpečnosti.",
	"gui.privacy_link.title": "Aplikovanie zmien v Xbox nastaveniach môže chvíľu trvať.\n\nAk sa neaktualizujú, reštartuj hru.",
	"gui.proceed": "Pokračovať",
	"gui.recipebook.moreRecipes": "Klikni pravým tlačidlom pre ďalšie",
	"gui.recipebook.next_page": "Nasledujúca strana",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Predchádzajúca strana",
	...
	"gui.remove": "Odstrániť",
	"gui.report_to_server": "Nahlásiť serveru",
	"gui.selectWorld.search": "Hľadať...",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Tento hráč nemôže byť nahlásený, pretože chat je vypnutý alebo zablokovaný",
	...
	"gui.stats.none_found": "Nenašli sa žiadne štatistiky.",
	...
	"gui.togglable_slot": "Klikni pre deaktiváciu pozície",
	"gui.up": "Hore",
	"gui.waitingForResponse.button.inactive": "Späť (%ss)",
	"gui.waitingForResponse.title": "Čaká sa na server",
	"gui.yes": "Áno",
	...
	"item.canUse.unknown": "Neznáme",
	"item.color": "Farba: %s",
	"item.components": "%s komponent(ov)",
	"item.disabled": "Nepovolený predmet",
	"item.durability": "Životnosť: %s/%s",
	"item.dyed": "Zafarbené",
	"item.intangible": "Nehmotný",
	...
	"item.minecraft.armadillo_scute": "Doštička pásavca",
	"item.minecraft.armadillo_spawn_egg": "Vajíčko s pásavcom",
	...
	"item.minecraft.black_bundle": "Čierny balíček",
	"item.minecraft.black_dye": "Čierne farbivo",
	"item.minecraft.black_harness": "Čierny postroj",
	...
	"item.minecraft.blue_bundle": "Modrý balíček",
	"item.minecraft.blue_dye": "Modré farbivo",
	"item.minecraft.blue_egg": "Modré vajce",
	"item.minecraft.blue_harness": "Modrý postroj",
	"item.minecraft.bogged_spawn_egg": "Vajíčko s vodníkom",
	"item.minecraft.bolt_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Ornament matice",
	"item.minecraft.bone": "Kosť",
	"item.minecraft.bone_meal": "Kostná múčka",
	"item.minecraft.book": "Kniha",
	"item.minecraft.bordure_indented_banner_pattern": "Vzor zástavy: lem",
	"item.minecraft.bow": "Luk",
	"item.minecraft.bowl": "Miska",
	"item.minecraft.bread": "Chlieb",
	"item.minecraft.breeze_rod": "Tyč Víchra",
	"item.minecraft.breeze_spawn_egg": "Vajíčko s víchrom",
	...
	"item.minecraft.brown_bundle": "Hnedý balíček",
	"item.minecraft.brown_dye": "Hnedé farbivo",
	"item.minecraft.brown_egg": "Hnedé vajce",
	"item.minecraft.brown_harness": "Hnedý postroj",
	"item.minecraft.brush": "Metlička",
	"item.minecraft.bucket": "Vedro",
	"item.minecraft.bundle": "Balíček",
	"item.minecraft.bundle.empty": "Prázdny",
	"item.minecraft.bundle.empty.description": "Môže obsahovať zmiešanú hromadu predmetov",
	"item.minecraft.bundle.full": "Plný",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "Črep s plameňom",
	"item.minecraft.burn_pottery_sherd": "Črep s plameňom",
	"item.minecraft.camel_husk_spawn_egg": "Vajíčko s ťavím zdochliakom",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Ornament pobrežia",
	...
	"item.minecraft.copper_axe": "Medená sekera",
	"item.minecraft.copper_boots": "Medené topánky",
	"item.minecraft.copper_chestplate": "Medené brnenie",
	"item.minecraft.copper_golem_spawn_egg": "Vajíčko s medeným golemom",
	"item.minecraft.copper_helmet": "Medená prilba",
	"item.minecraft.copper_hoe": "Medená motyka",
	"item.minecraft.copper_horse_armor": "Medená konská zbroj",
	"item.minecraft.copper_ingot": "Medená tehlička",
	"item.minecraft.copper_leggings": "Medené nohavice",
	"item.minecraft.copper_nautilus_armor": "Medené brnenie lodienky",
	"item.minecraft.copper_nugget": "Medený nuget",
	"item.minecraft.copper_pickaxe": "Medený krompáč",
	"item.minecraft.copper_shovel": "Medená lopata",
	"item.minecraft.copper_spear": "Medená kopija",
	"item.minecraft.copper_sword": "Medený meč",
	"item.minecraft.cow_spawn_egg": "Vajíčko s kravou",
	"item.minecraft.creaking_spawn_egg": "Vajíčko so škripotom",
	"item.minecraft.creeper_banner_pattern": "Vzor zástavy",
	"item.minecraft.creeper_banner_pattern.desc": "Creeper",
	"item.minecraft.creeper_banner_pattern.new": "Vzor zástavy: creeper",
	...
	"item.minecraft.cyan_bundle": "Tyrkysový balíček",
	"item.minecraft.cyan_dye": "Tyrkysové farbivo",
	"item.minecraft.cyan_harness": "Tyrkysový postroj",
	...
	"item.minecraft.diamond_nautilus_armor": "Diamantové brnenie lodienky",
	"item.minecraft.diamond_pickaxe": "Diamantový krompáč",
	"item.minecraft.diamond_shovel": "Diamantová lopata",
	"item.minecraft.diamond_spear": "Diamantová kopija",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Ornament duny",
	...
	"item.minecraft.eye_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Ornament oka",
	"item.minecraft.feather": "Pierko",
	"item.minecraft.fermented_spider_eye": "Kvasené pavúčie oko",
	"item.minecraft.field_masoned_banner_pattern": "Vzor zástavy: murované pole",
	...
	"item.minecraft.firework_star.fade_to": "Prechod do",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Ornament toku",
	"item.minecraft.flow_banner_pattern": "Vzor zástavy",
	"item.minecraft.flow_banner_pattern.desc": "Tok",
	"item.minecraft.flow_banner_pattern.new": "Vzor zástavy: tok",
	"item.minecraft.flow_pottery_sherd": "Črep toku",
	"item.minecraft.flower_banner_pattern": "Vzor zástavy",
	"item.minecraft.flower_banner_pattern.desc": "Kvet",
	"item.minecraft.flower_banner_pattern.new": "Vzor zástavy: kvet",
	...
	"item.minecraft.globe_banner_pattern.new": "Vzor zástavy: glóbus",
	...
	"item.minecraft.golden_nautilus_armor": "Zlaté brnenie lodienky",
	"item.minecraft.golden_pickaxe": "Zlatý krompáč",
	"item.minecraft.golden_shovel": "Zlatá lopata",
	"item.minecraft.golden_spear": "Zlatá kopija",
	"item.minecraft.golden_sword": "Zlatý meč",
	"item.minecraft.gray_bundle": "Sivý balíček",
	"item.minecraft.gray_dye": "Sivé farbivo",
	"item.minecraft.gray_harness": "Sivý postroj",
	"item.minecraft.green_bundle": "Zelený balíček",
	"item.minecraft.green_dye": "Zelené farbivo",
	"item.minecraft.green_harness": "Zelený postroj",
	"item.minecraft.guardian_spawn_egg": "Vajíčko so strážcom",
	"item.minecraft.gunpowder": "Pušný prach",
	"item.minecraft.guster_banner_pattern": "Vzor zástavy",
	"item.minecraft.guster_banner_pattern.desc": "Fujak",
	"item.minecraft.guster_banner_pattern.new": "Vzor zástavy: fujak",
	"item.minecraft.guster_pottery_sherd": "Črep s fujakom",
	"item.minecraft.happy_ghast_spawn_egg": "Vajíčko so šťastným ghastom",
	"item.minecraft.harness": "Postroj",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.host_armor_trim_smithing_template.new": "Ornament hostiteľa",
	...
	"item.minecraft.iron_nautilus_armor": "Železné brnenie lodienky",
	...
	"item.minecraft.iron_spear": "Železná kopija",
	...
	"item.minecraft.light_blue_bundle": "Svetlomodrý balíček",
	"item.minecraft.light_blue_dye": "Svetlomodré farbivo",
	"item.minecraft.light_blue_harness": "Svetlomodrý postroj",
	"item.minecraft.light_gray_bundle": "Svetlosivý balíček",
	"item.minecraft.light_gray_dye": "Svetlosivé farbivo",
	"item.minecraft.light_gray_harness": "Svetlosivý postroj",
	"item.minecraft.lime_bundle": "Svetlozelený balíček",
	"item.minecraft.lime_dye": "Svetlozelené farbivo",
	"item.minecraft.lime_harness": "Svetlozelený postroj",
	...
	"item.minecraft.lingering_potion.effect.infested": "Plynný elixír zamorenia",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Plynný elixír vytekania",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Plynný elixír tkania",
	"item.minecraft.lingering_potion.effect.wind_charged": "Plynný elixír veterného nabitia",
	"item.minecraft.llama_spawn_egg": "Vajíčko s lamou",
	"item.minecraft.lodestone_compass": "Zmagnetizovaný kompas",
	"item.minecraft.mace": "Palcát",
	"item.minecraft.magenta_bundle": "Purpurový balíček",
	"item.minecraft.magenta_dye": "Purpurové farbivo",
	"item.minecraft.magenta_harness": "Purpurový postroj",
	...
	"item.minecraft.mojang_banner_pattern.new": "Vzor zástavy: vecička",
	...
	"item.minecraft.music_disc_bounce": "Hudobná platňa",
	...
	"item.minecraft.music_disc_creator": "Hudobná platňa",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Hudobná platňa",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Creator (Hracia skrinka)",
	"item.minecraft.music_disc_far": "Hudobná platňa",
	"item.minecraft.music_disc_far.desc": "C418 - far",
	"item.minecraft.music_disc_lava_chicken": "Hudobná platňa",
	...
	"item.minecraft.music_disc_precipice": "Hudobná platňa",
	...
	"item.minecraft.music_disc_tears": "Hudobná platňa",
	...
	"item.minecraft.nautilus_spawn_egg": "Vajíčko s lodienkou",
	...
	"item.minecraft.netherite_horse_armor": "Netheritová konská zbroj",
	"item.minecraft.netherite_ingot": "Netheritová tehlička",
	"item.minecraft.netherite_leggings": "Netheritové nohavice",
	"item.minecraft.netherite_nautilus_armor": "Netheritové brnenie lodienky",
	...
	"item.minecraft.netherite_spear": "Netheritová kopija",
	"item.minecraft.netherite_sword": "Netheritový meč",
	"item.minecraft.netherite_upgrade_smithing_template": "Kováčska predloha",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Netheritové vylepšenie",
	...
	"item.minecraft.ominous_bottle": "Zlovestná fľaša",
	"item.minecraft.ominous_trial_key": "Zlovestný kľúč skúšky",
	"item.minecraft.orange_bundle": "Oranžový balíček",
	"item.minecraft.orange_dye": "Oranžové farbivo",
	"item.minecraft.orange_harness": "Oranžový postroj",
	"item.minecraft.painting": "Obraz",
	"item.minecraft.pale_oak_boat": "Čln z bledého dubu",
	"item.minecraft.pale_oak_chest_boat": "Čln z bledého dubu s truhlicou",
	"item.minecraft.panda_spawn_egg": "Vajíčko s pandou",
	"item.minecraft.paper": "Papier",
	"item.minecraft.parched_spawn_egg": "Vajíčko so suchárom",
	...
	"item.minecraft.piglin_banner_pattern.new": "Vzor zástavy: rypák",
	...
	"item.minecraft.pink_bundle": "Ružový balíček",
	"item.minecraft.pink_dye": "Ružové farbivo",
	"item.minecraft.pink_harness": "Ružový postroj",
	...
	"item.minecraft.potion.effect.infested": "Elixír zamorenia",
	...
	"item.minecraft.potion.effect.oozing": "Elixír vytekania",
	...
	"item.minecraft.potion.effect.weaving": "Elixír tkania",
	"item.minecraft.potion.effect.wind_charged": "Elixír veterného nabitia",
	...
	"item.minecraft.purple_bundle": "Fialový balíček",
	"item.minecraft.purple_dye": "Fialové farbivo",
	"item.minecraft.purple_harness": "Fialový postroj",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Ornament chovateľa",
	...
	"item.minecraft.red_bundle": "Červený balíček",
	"item.minecraft.red_dye": "Červené farbivo",
	"item.minecraft.red_harness": "Červený postroj",
	"item.minecraft.redstone": "Redstonový prach",
	"item.minecraft.resin_brick": "Živicová tehla",
	"item.minecraft.resin_clump": "Hrudka živice",
	"item.minecraft.rib_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Ornament rebra",
	...
	"item.minecraft.scrape_pottery_sherd": "Črep so sekerou",
	"item.minecraft.scute": "Doštička",
	"item.minecraft.sentry_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Ornament stráže",
	"item.minecraft.shaper_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Ornament ohýbača",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Ornament ticha",
	...
	"item.minecraft.skull_banner_pattern.new": "Vzor zástavy: lebka",
	...
	"item.minecraft.smithing_template.upgrade": "Vylepšenie: ",
	...
	"item.minecraft.snout_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Ornament rypáka",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Ornament veže",
	...
	"item.minecraft.splash_potion.effect.infested": "Hádzací elixír zamorenia",
	...
	"item.minecraft.splash_potion.effect.oozing": "Hádzací elixír vytekania",
	...
	"item.minecraft.splash_potion.effect.weaving": "Hádzací elixír tkania",
	"item.minecraft.splash_potion.effect.wind_charged": "Hádzací elixír veterného nabitia",
	...
	"item.minecraft.stone_spear": "Kamenná kopija",
	...
	"item.minecraft.sulfur_cube_bucket": "Vedro so sírovcom",
	"item.minecraft.sulfur_cube_spawn_egg": "Vajíčko so sírovcom",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Ornament prílivu",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Šíp zamorenia",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Šíp vytekania",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Šíp tkania",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Šíp veterného nabitia",
	...
	"item.minecraft.trial_key": "Kľúč skúšky",
	...
	"item.minecraft.turtle_scute": "Korytnačia doštička",
	"item.minecraft.turtle_spawn_egg": "Vajíčko s korytnačkou",
	"item.minecraft.vex_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Ornament škodcu",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Ornament chránenca",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Ornament sprievodcu",
	"item.minecraft.wheat": "Pšenica",
	"item.minecraft.wheat_seeds": "Semienka pšenice",
	"item.minecraft.white_bundle": "Biely balíček",
	"item.minecraft.white_dye": "Biele farbivo",
	"item.minecraft.white_harness": "Biely postroj",
	"item.minecraft.wild_armor_trim_smithing_template": "Kováčska predloha",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Ornament divočiny",
	"item.minecraft.wind_charge": "Veterný náboj",
	...
	"item.minecraft.wolf_armor": "Vlčie brnenie",
	...
	"item.minecraft.wooden_spear": "Drevená kopija",
	...
	"item.minecraft.yellow_bundle": "Žltý balíček",
	"item.minecraft.yellow_dye": "Žlté farbivo",
	"item.minecraft.yellow_harness": "Žltý postroj",
	"item.minecraft.zoglin_spawn_egg": "Vajíčko so zoglinom",
	"item.minecraft.zombie_horse_spawn_egg": "Vajíčko so zombie koňom",
	"item.minecraft.zombie_nautilus_spawn_egg": "Vajíčko so zombie lodienkou",
	...
	"item.modifiers.any": "Pri nasadení:",
	"item.modifiers.armor": "Pri nosení:",
	"item.modifiers.body": "Pri nasadení:",
	"item.modifiers.chest": "Na tele:",
	"item.modifiers.feet": "Na chodidlách:",
	"item.modifiers.hand": "Pri držaní:",
	...
	"item.modifiers.saddle": "Pri osedlaní:",
	"item.nbt_tags": "NBT: %s tag(ov)",
	"item.op_block_warning.line1": "Pozor:",
	"item.op_block_warning.line2": "Použitie tohto predmetu môže viesť k spusteniu príkazu.",
	"item.op_block_warning.line3": "Nepoužívaj ho, pokiaľ s istotou nepoznáš jeho obsah!",
	"item.spawn_egg.peaceful": "Vypnuté na mierumilovnej obtiažnosti",
	...
	"jigsaw_block.placement_priority": "Priorita ukladania:",
	"jigsaw_block.placement_priority.tooltip": "Keď sa táto skladačková kocka pripojí ku kúsku skladačky, toto je poradie, v ktorom sa ten kúsok bude spracovávať pre ďalšie spojenia.\n\nKúsky budú spracované zostupne podľa priority a s náhodným poradím kúskov s rovnakou prioritou.",
	"jigsaw_block.pool": "Zdrojový fond:",
	"jigsaw_block.selection_priority": "Priorita výberu:",
	"jigsaw_block.selection_priority.tooltip": "Keď sa spracováva nadradený kúsok skladačky pre možné pripojenia, toto je poradie, v ktorom sa skladačková kocka pokúsi pripojiť ku cieľovému kúsku.\n\nSkladačky budú spracované zostupne podľa priority a s náhodným poradím kúskov s rovnakou prioritou.",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine - Creator (Hracia skrinka)",
	...
	"key.categories.spectator": "Divák",
	"key.categories.ui": "Herné rozhranie",
	"key.category.minecraft.creative": "Tvorivá hra",
	"key.category.minecraft.debug": "Ladenie",
	"key.category.minecraft.gameplay": "Hlavné",
	"key.category.minecraft.inventory": "Inventár",
	"key.category.minecraft.misc": "Rôzne",
	"key.category.minecraft.movement": "Pohyb",
	"key.category.minecraft.multiplayer": "Hra viacerých hráčov",
	"key.category.minecraft.spectator": "Divácky režim",
	"key.chat": "Otvoriť chat",
	"key.command": "Otvoriť príkazový riadok",
	"key.debug.clearChat": "Vymazať chat",
	"key.debug.copyLocation": "Skopírovať polohu",
	"key.debug.copyRecreateCommand": "Skopírovať dáta",
	"key.debug.crash": "Ladiť zlyhanie hry",
	"key.debug.debugOptions": "Možnosti ladenia",
	"key.debug.dumpDynamicTextures": "Vytvoriť výpis dynamických textúr",
	"key.debug.dumpVersion": "Vytvoriť výpis informácií o verzii",
	"key.debug.focusPause": "Prepnúť pauzu pri hre na pozadí",
	"key.debug.fpsCharts": "Grafy FPS",
	"key.debug.lightmapTexture": "Textúra lightmapy",
	"key.debug.modifier": "Tlačidlo prepínača ladenia",
	"key.debug.networkCharts": "Grafy siete",
	"key.debug.overlay": "Prepnúť prekryv",
	"key.debug.profiling": "Spustiť/zastaviť profilovanie",
	"key.debug.profilingChart": "Graf profilovania",
	"key.debug.reloadChunk": "Znova načítať chunky",
	"key.debug.reloadResourcePacks": "Znova načítať zdrojové balíky",
	"key.debug.showAdvancedTooltips": "Zobraziť pokročilé popisy",
	"key.debug.showChunkBorders": "Zobraziť hranice chunku",
	"key.debug.showHitboxes": "Zobraziť hitboxy",
	"key.debug.spectate": "Prepnúť z/na diváka",
	"key.debug.switchGameMode": "Prepínač herného režimu",
	"key.drop": "Odhodiť vybraný predmet",
	"key.forward": "Ísť dopredu",
	"key.friends": "Obrazovka priateľov",
	...
	"key.spectatorHotbar": "Vybrať na lište",
	"key.spectatorOutlines": "Zvýrazniť hráčov (divákov)",
	"key.sprint": "Behať",
	"key.swapOffhand": "Prehodiť predmet do vedľajšej ruky",
	"key.toggleGui": "Prepnúť GUI",
	"key.togglePerspective": "Prepnúť pohľad",
	"key.toggleSpectatorShaderEffects": "Prepnúť tieňovače diváka",
	"key.use": "Použiť predmet/položiť kocku",
	"known_server_link.announcements": "Oznamy",
	"known_server_link.community": "Komunita",
	"known_server_link.community_guidelines": "Pravidlá komunity",
	"known_server_link.feedback": "Spätná väzba",
	"known_server_link.forums": "Fórum",
	"known_server_link.news": "Novinky",
	"known_server_link.report_bug": "Nahlásiť chybu servera",
	"known_server_link.status": "Stav",
	"known_server_link.support": "Podpora",
	"known_server_link.website": "Web",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Pridať server",
	"manageServer.edit.title": "Upraviť informácie o serveri",
	"manageServer.enterIp": "Adresa servera",
	"manageServer.enterName": "Názov servera",
	"manageServer.resourcePack": "Serverové zdrojové balíky",
	"manageServer.resourcePack.disabled": "Zakázané",
	"manageServer.resourcePack.enabled": "Povolené",
	"manageServer.resourcePack.prompt": "Opýtať sa",
	"mco.account.privacy.info": "Viac informácií o Mojang a o zákonoch o ochrane osobných údajov",
	"mco.account.privacy.info.button": "Prečítať viac o GDPR",
	"mco.account.privacy.information": "Mojang prijíma určité postupy pre ochranu detí a ich súkromia v súlade so Zákonom na ochranu osobných údajov detí online (COPPA) a s Všeobecným nariadením o ochrane údajov (GDPR).\n\nPred prístupom k tvojmu Realms účtu od teba môže byť vyžadovaný súhlas zákonného zástupcu (rodiča).",
	...
	"mco.backup.entry.worldType.adventureMap": "Dobrodružná mapa",
	"mco.backup.entry.worldType.experience": "Zážitok",
	"mco.backup.entry.worldType.inspiration": "Inšpirácia",
	"mco.backup.entry.worldType.minigame": "Minihra",
	"mco.backup.entry.worldType.normal": "Normálny",
	"mco.backup.entry.worldType.unknown": "Neznámy",
	"mco.backup.generate.world": "Vygenerovať svet",
	"mco.backup.info.title": "Zmeny od poslednej zálohy",
	"mco.backup.narration": "Záloha z %s",
	...
	"mco.client.outdated.stable.version": "Verzia tvojho klienta (%s) nie je kompatibilná so službou Realms.\n\nProsím, použi najnovšiu verziu Minecraftu.",
	"mco.client.unsupported.snapshot.version": "Verzia tvojho klienta (%s) nie je kompatibilná so službou Realms.\n\nSlužba Realms nie je dostupná pre tento snapshot.",
	"mco.compatibility.downgrade": "Prechod na staršiu verziu",
	"mco.compatibility.downgrade.description": "Tento svet bol naposledy načítaný na verzii %s, ty si na verzii %s. Prechod na staršiu verziu môže spôsobiť poškodenie a nemôžeme zaručiť, že svet bude možné načítať a že bude správne fungovať.\n\nZáloha tohto sveta bude uložená pod \"Zálohy svetov\". V prípade potreby môžeš svoj svet obnoviť.",
	"mco.compatibility.incompatible.popup.title": "Nekompatibilná verzia",
	"mco.compatibility.incompatible.releaseType.popup.message": "Svet, ku ktorému sa snažíš pripojiť, nie je kompatibilný s tvojou verziou.",
	"mco.compatibility.incompatible.series.popup.message": "Tento svet bol naposledy otvorený na verzii %s, tvoja verzia je %s.\n\nTieto verzie nie sú navzájom kompatibilné. Pre hranie na tejto verzii je nutné vytvoriť nový svet.",
	"mco.compatibility.unverifiable.message": "Tento svet bol naposledy načítaný na verzii, ktorú nebolo možné overiť. Ak sa tento svet prevedie na novšiu alebo staršiu verziu, bude automaticky zálohovaný a uložený pod \"Zálohy svetov\".",
	"mco.compatibility.unverifiable.title": "Kompatibilita nie je overiteľná",
	"mco.compatibility.upgrade": "Prechod na novšiu verziu",
	"mco.compatibility.upgrade.description": "Tento svet bol naposledy načítaný na verzii %s, ty si na verzii %s.\n\nZáloha tohto sveta bude uložená pod \"Zálohy sveta\". V prípade potreby môžeš tento svet obnoviť.",
	"mco.compatibility.upgrade.friend.description": "Tento svet bol naposledy načítaný na verzii %s, ty si na verzii %s.\n\nZáloha tohto sveta bude uložená pod \"Zálohy sveta\".\n\nV prípade potreby môže vlastník Realmu tento svet obnoviť.",
	"mco.compatibility.upgrade.title": "Naozaj chceš tento svet previesť na novšiu verziu?",
	...
	"mco.configure.world.buttons.close": "Dočasne zatvoriť Realm",
	...
	"mco.configure.world.buttons.newworld": "Nový svet",
	"mco.configure.world.buttons.open": "Znovu otvoriť Realm",
	"mco.configure.world.buttons.options": "Nastavenia sveta",
	"mco.configure.world.buttons.players": "Hráči",
	"mco.configure.world.buttons.region_preference": "Vyber región...",
	"mco.configure.world.buttons.resetworld": "Resetovať svet",
	"mco.configure.world.buttons.save": "Uložiť",
	...
	"mco.configure.world.close.question.line1": "Môžeš dočasne zatvoriť tvoj Realm. Počas tvojich úprav na ňom nikto nebude môcť hrať. Keď bude pripravený, môžeš ho znovu otvoriť.\n\nToto nezruší tvoje predplatné služby Realms.",
	"mco.configure.world.close.question.line2": "Naozaj chceš pokračovať?",
	"mco.configure.world.close.question.title": "Potrebuješ vykonať zmeny bez vyrušovania?",
	"mco.configure.world.closing": "Dočasné zatváranie Realmu...",
	...
	"mco.configure.world.loading": "Načítavanie Realmu",
	"mco.configure.world.location": "Umiestnenie",
	"mco.configure.world.minigame": "Aktuálna: %s",
	"mco.configure.world.name": "Názov Realmu",
	"mco.configure.world.name.validation.whitespace": "Nesmie sa začínať ani končiť medzerou. Tieto medzery budú odstránené.",
	"mco.configure.world.opening": "Otváranie Realmu...",
	"mco.configure.world.players.error": "Hráč s týmto menom neexistuje",
	"mco.configure.world.players.invite.duplicate": "Hráč s daným menom už bol pozvaný do Realmu",
	"mco.configure.world.players.inviting": "Pozvánka sa odosiela...",
	"mco.configure.world.players.title": "Hráči",
	"mco.configure.world.pvp": "PVP",
	"mco.configure.world.region_preference": "Preferovaný región",
	"mco.configure.world.region_preference.title": "Výber preferovaného regiónu",
	...
	"mco.configure.world.resourcepack.question": "Tento Realm vyžaduje vlastný zdrojový balík\n\nChceš ho stiahnuť a hrať?",
	"mco.configure.world.resourcepack.question.line1": "Tento Realm vyžaduje vlastný zdrojový balík",
	...
	"mco.configure.world.settings.expired": "Nemôžeš upravovať nastavenia vypršaného Realmu",
	...
	"mco.configure.world.subscription.tab": "Predplatné",
	...
	"mco.download.confirmation.oversized": "Svet, ktorý sa chystáš stiahnuť, je väčší než %s\n\nNahrať ho naspať na Realms nebude možné",
	...
	"mco.errorMessage.initialize.failed": "Nepodarilo sa inicializovať Realm",
	"mco.errorMessage.noDetails": "Neboli získané žiadne detaily o chybe",
	"mco.errorMessage.realmsService": "Nastala chyba (%s):",
	"mco.errorMessage.realmsService.configurationError": "Pri upravovaní nastavení sveta nastala neočakávaná chyba",
	"mco.errorMessage.realmsService.connectivity": "Nepodarilo sa pripojiť k Realms: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Nepodarilo sa skontrolovať kompatibilnú verziu. Získaná odpoveď: %s",
	"mco.errorMessage.retry": "Skúsiť znova",
	...
	"mco.gui.ok": "Ok",
	"mco.info": "Informácie!",
	"mco.invited.player.narration": "Hráč %s bol pozvaný",
	...
	"mco.notification.transferSubscription.buttonText": "Preniesť teraz",
	"mco.notification.transferSubscription.message": "Predplatné Java Realms sa presúva do obchodu Microsoft Store. Nenechaj svoje predplatné vypršať!\nPrenes si ho a získaj 30 dní Realms zadarmo.\nPrenos predplatného môžeš uskutočniť vo svojom profile na minecraft.net.",
	...
	"mco.onlinePlayers": "Online hráči",
	"mco.play.button.realm.closed": "Realm je zatvorený",
	"mco.question": "Otázka",
	...
	"mco.reset.world.warning": "Toto nahradí aktuálny svet v tvojom Realme",
	"mco.selectServer.buy": "Kúp si Realm!",
	"mco.selectServer.close": "Zatvoriť",
	"mco.selectServer.closed": "Deaktivovaný Realm",
	...
	"mco.selectServer.create.subtitle": "Vyber si, aký svet chceš použiť vo svojom novom Realme",
	...
	"mco.selectServer.loading": "Načítava sa zoznam Realmov",
	"mco.selectServer.mapOnlySupportedForVersion": "Táto mapa nie je podporovaná v %s",
	"mco.selectServer.minigame": "Minihra:",
	"mco.selectServer.minigameName": "Minihra: %s",
	"mco.selectServer.minigameNotSupportedInVersion": "Túto minihru nie je možné hrať vo verzii %s",
	"mco.selectServer.noRealms": "Zdá sa, že nemáš žiadny Realm. Pridaj si Realm a hraj spolu s priateľmi.",
	"mco.selectServer.note": "Poznámka:",
	"mco.selectServer.open": "Otvorený Realm",
	"mco.selectServer.openserver": "Otvoriť Realm",
	"mco.selectServer.play": "Hrať",
	"mco.selectServer.popup": "Realms je bezpečný a jednoduchý spôsob, ako si užiť online Minecraft svet až s desiatimi hráčmi naraz. Podporuje množstvo minihier a vlastných svetov! Platí iba vlastník Realmu.",
	"mco.selectServer.purchase": "Pridať Realm",
	"mco.selectServer.trial": "Vyskúšať!",
	"mco.selectServer.uninitialized": "Klikni pre spustenie nového Realmu!",
	"mco.snapshot.createSnapshotPopup.text": "Chystáš sa vytvoriť bezplatný snapshotový Realm, ktorý bude spárovaný s tvojím predplatným. Tento Realm bude dostupný pokým bude toto predplatné aktívne. Tvoj platený Realm nebude ovplyvnený.",
	"mco.snapshot.createSnapshotPopup.title": "Vytvoriť snapshotový Realm?",
	"mco.snapshot.creating": "Vytvára sa snapshotový Realm...",
	"mco.snapshot.description": "Spárované s %s",
	"mco.snapshot.friendsRealm.downgrade": "Pre pripojenie na tento Realm musíš byť na verzii %s",
	"mco.snapshot.friendsRealm.upgrade": "Hráč %s musí previesť svoj Realm na novšiu verziu, aby si mohol hrať na tomto snapshote",
	"mco.snapshot.paired": "Tento snapshotový Realm je spárovaný s \"%s\"",
	"mco.snapshot.parent.tooltip": "Tento Realm je dostupný iba v najnovšom vydaní Minecraftu",
	"mco.snapshot.start": "Vytvor bezplatný snapshotový Realm",
	"mco.snapshot.subscription.info": "Toto je snapshotový Realm, ktorý je spárovaný s tvojim predplatným Realms '%s' a bude aktívny pokým je aktívne aj toto predplatné.",
	"mco.snapshot.tooltip": "Použi snapshotové Realms a prehliadni si nadchádzajúce funkcie a zmeny v nasledujúcich vydaniach Minecraftu.\n\nNormálne Realms môžeš nájsť v hlavnom vydaní hry.",
	"mco.snapshotRealmsPopup.message": "Služba Realms je dostupná v snapshotoch od vydania snapshotu 23w41a. Každé predplatné Realms prichádza s bezplatným Snapshot Realmom. Tento Realm je oddelený od tvojho štandardného Java Realmu.",
	"mco.snapshotRealmsPopup.title": "Služba Realms je teraz dostupná v snapshotoch",
	"mco.snapshotRealmsPopup.urlText": "Zistiť viac",
	...
	"mco.upload.close.failure": "Nepodarilo sa zatvoriť tvoj Realm, skús to znova neskôr",
	...
	"mco.upload.failed.too_big.description": "Vybraný svet je príliš veľký. Maximálna povolená veľkosť je %s.",
	"mco.upload.failed.too_big.title": "Svet je príliš veľký",
	...
	"mco.version": "Verzia: %s",
	"mco.warning": "Pozor!",
	"mco.worldSlot.minigame": "Minihra",
	"menu.custom_options": "Možnosti tretích strán...",
	"menu.custom_options.title": "Možnosti tretích strán",
	"menu.custom_options.tooltip": "Poznámka: Tieto možnosti sú poskytované servermi a dátovými balíkmi tretích strán.\nZaobchádzaj s nimi opatrne!",
	"menu.custom_screen_info.button_narration": "Toto je vlastná obrazovka. Zisti viac.",
	"menu.custom_screen_info.contents": "Obsah tejto obrazovky je riadený servermi a mapami tretích strán, ktoré nevlastní, neprevádzkuje ani na ne nedohliada spoločnosť Mojang Studios ani Microsoft.\n\nZaobchádzaj s ním opatrne! Pri otváraní odkazov si zachovaj ostražitosť a nikdy neodovzdávaj svoje súkromné informácie, vrátane prihlasovacích údajov.\n\nAk ti táto obrazovka bráni v hraní, môžeš sa od servera odpojiť pomocou tlačidla nižšie.",
	"menu.custom_screen_info.disconnect": "Vlastná obrazovka odmietnutá",
	"menu.custom_screen_info.title": "Poznámka k vlastným obrazovkám",
	"menu.custom_screen_info.tooltip": "Toto je vlastná obrazovka. Kliknutím sem sa dozvieš viac.",
	"menu.disconnect": "Odpojiť sa",
	"menu.feedback": "Spätná väzba...",
	"menu.feedback.title": "Spätná väzba",
	"menu.game": "Herné menu",
	"menu.modded": " (S použitím modifikácií)",
	"menu.multiplayer": "Hra viacerých hráčov",
	"menu.multiplayerOptions.applyChanges": "Aplikovať zmeny",
	"menu.multiplayerOptions.button": "Hra viacerých hráčov...",
	"menu.multiplayerOptions.network": "Hra viacerých hráčov",
	"menu.multiplayerOptions.network.header": "Sieť",
	"menu.multiplayerOptions.network.lan": "LAN",
	"menu.multiplayerOptions.network.lan.tooltip": "Hráči v rovnakej sieti sa môžu pripojiť.",
	"menu.multiplayerOptions.network.off": "VYP",
	"menu.multiplayerOptions.network.off.tooltip": "Nikto sa nemôže pripojiť.",
	"menu.multiplayerOptions.network.online": "Online",
	"menu.multiplayerOptions.network.online.tooltip": "Online priatelia sa môžu pripojiť.",
	"menu.multiplayerOptions.otherPlayers.header": "Ostatní hráči",
	"menu.multiplayerOptions.publish.started.lan": "Tento svet je teraz otvorený pre LAN. Číslo portu je %s",
	"menu.multiplayerOptions.publish.started.online": "Tento server je teraz otvorený pre online hru viacerých hráčov.",
	"menu.multiplayerOptions.publish.stopped": "Tento svet už nie je otvorený pre online hru viacerých hráčov",
	"menu.multiplayerOptions.title": "Nastavenia hry viacerých hráčov",
	"menu.online": "Minecraft Realms",
	"menu.options": "Možnosti...",
	"menu.paused": "Hra pozastavená",
	"menu.playdemo": "Hrať demo svet",
	"menu.playerReporting": "Nahlásenie hráča",
	"menu.playerReporting.no_players": "V tomto svete nie sú žiadni hráči na nahlásenie",
	"menu.preparingSpawn": "Pripravuje sa oblasť rodiska: %s%%",
	"menu.quick_actions": "Rýchle akcie...",
	"menu.quick_actions.title": "Rýchle akcie",
	...
	"menu.server_links": "Serverové odkazy...",
	"menu.server_links.title": "Serverové odkazy",
	...
	"multiplayer.codeOfConduct.check": "Na tieto pravidlá správania viac neupozorňovať",
	"multiplayer.codeOfConduct.title": "Pravidlá správania na serveri",
	"multiplayer.confirm_command.parse_errors": "Pokúšaš sa zadať nerozpoznaný alebo neplatný príkaz.\nUrčite to chceš urobiť?\nPríkaz: %s",
	"multiplayer.confirm_command.permissions_required": "Pokúšaš sa zadať príkaz, ktorý vyžaduje vyššie oprávnenia.\nMôže to mať negatívny vplyv na tvoju hru.\nUrčite to chceš urobiť?\nPríkaz: %s",
	"multiplayer.confirm_command.run_command": "Spustiť príkaz",
	"multiplayer.confirm_command.signature_required": "Pokúšaš sa zadať príkaz, ktorý odošle správu v tvojom mene.\nToto môžeš urobiť len v chate\nPríkaz: %s",
	"multiplayer.confirm_command.suggest_command": "Skopírovať do chatu",
	"multiplayer.confirm_command.title": "Potvrdenie zadania príkazu",
	"multiplayer.disconnect.authservers_down": "Overovacie servery sú mimo prevádzky. Skús to, prosím, neskôr.",
	"multiplayer.disconnect.bad_chat_index": "Chatové správy zo servera boli neočakávane zoradené alebo neboli správne prijaté",
	...
	"multiplayer.disconnect.banned.reason.default": "Zablokovaný operátorom.",
	...
	"multiplayer.disconnect.code_of_conduct": "Server vyžaduje prijatie pravidiel správania",
	"multiplayer.disconnect.configuration_error": "Počas konfigurácie nastala neočakávaná chyba",
	...
	"multiplayer.disconnect.transfers_disabled": "Server neprijíma prenosy hráčov",
	...
	"multiplayer.status.anonymous_player": "Anonymný hráč",
	...
	"multiplayer.unsecureserver.toast": "Správy na tomto serveri môžu byť pozmenené a nemusia zodpovedať pôvodným správam",
	...
	"narration.checkbox.usage.focused.check": "Stlač enter pre zapnutie",
	"narration.checkbox.usage.focused.uncheck": "Stlač enter pre vypnutie",
	"narration.checkbox.usage.hovered": "Ľavý klik pre prepnutie",
	"narration.checkbox.usage.hovered.check": "Ľavý klik pre zaškrtnutie",
	"narration.checkbox.usage.hovered.uncheck": "Ľavý klik pre odškrtnutie",
	...
	"narration.item": "Položka: %s",
	"narration.link.usage.focused": "Stlač Enter pre nasledovanie odkazu",
	"narration.link.usage.hovered": "Ľavý klik pre nasledovanie odkazu",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Stlačením enteru začni meniť hodnotu posuvníka",
	"narration.slider.usage.hovered": "Potiahni bežcom pre zmenu nastavenia",
	"narration.suggestion": "Vybraný návrh %s z %s: %s",
	"narration.suggestion.tooltip": "Vybraný návrh %s z %s: %s (%s)",
	"narration.suggestion.usage.cycle.fixed": "Stlač Tab pre prechod na ďalší návrh",
	"narration.suggestion.usage.cycle.hidable": "Stlač Tab pre prechod na ďalší návrh, alebo Esc pre opustenie návrhov",
	"narration.suggestion.usage.fill.fixed": "Stlač Tab pre použitie návrhu",
	"narration.suggestion.usage.fill.hidable": "Stlač Tab pre použitie návrhu, alebo Esc pre opustenie návrhov",
	...
	"narrator.select.world_info": "Vybraný svet %s, naposledy hraný: %s, %s",
	...
	"optimizeWorld.confirm.proceed": "Zálohovať a optimalizovať",
	...
	"optimizeWorld.stage.finished.chunks": "Aktualizácia chunkov sa dokončuje...",
	"optimizeWorld.stage.finished.entities": "Aktualizácia entít sa dokončuje...",
	"optimizeWorld.stage.finished.poi": "Aktualizácia bodov záujmu sa dokončuje...",
	"optimizeWorld.stage.upgrading": "Aktualizujú sa všetky chunky...",
	"optimizeWorld.stage.upgrading.chunks": "Aktualizujú sa všetky chunky...",
	"optimizeWorld.stage.upgrading.entities": "Aktualizujú sa všetky entity...",
	"optimizeWorld.stage.upgrading.poi": "Aktualizujú sa všetky body záujmu...",
	"optimizeWorld.title": "Optimalizácia sveta \"%s\"",
	"options.accessibility": "Zjednodušenie ovládania...",
	...
	"options.accessibility.high_contrast_block_outline": "Vysoko kontrastné obrysy kociek",
	"options.accessibility.high_contrast_block_outline.tooltip": "Zvyšuje kontrast obrysov zameranej kocky.",
	"options.accessibility.link": "Sprievodca zjednodušením",
	"options.accessibility.menu_background_blurriness": "Rozmazanie pozadia menu",
	"options.accessibility.menu_background_blurriness.tooltip": "Mení intenzitu rozmazania pozadia",
	"options.accessibility.narrator_hotkey": "Klávesová skratka rozprávača",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Umožňuje vypínať a zapínať rozprávača pomocou \"⌘+B\"",
	"options.accessibility.narrator_hotkey.tooltip": "Umožňuje prepínať rozprávača pomocou \"Ctrl+B\"",
	...
	"options.accessibility.tooltip": "Zjednodušenie ovládania",
	"options.allowCursorChanges": "Povoliť zmeny kurzoru",
	"options.allowCursorChanges.tooltip": "Povoľuje zmeny tvaru kurzoru myši v niektorých prvkoch používateľského rozhrania.",
	"options.allowFriendRequests": "Povoliť žiadosti",
	"options.allowFriendRequests.tooltip": "Povoliť ostatným hráčom posielať ti žiadosti o priateľstvo",
	"options.allowServerListing": "Meno na zoznamoch",
	"options.allowServerListing.tooltip": "Servery môžu uvádzať zoznam online hráčov ako súčasť ich verejného statusu.\nAk je táto možnosť vypnutá, tvoje meno sa v takýchto zoznamoch nezobrazí.",
	...
	"options.blocks": "%s kociek",
	"options.chat": "Nastavenia chatu...",
	"options.chat.color": "Farby",
	"options.chat.delay": "Oneskorenie chatu: %s sekúnd",
	"options.chat.delay_none": "Oneskorenie chatu: Žiadne",
	"options.chat.drafts": "Uložiť neodoslané správy",
	"options.chat.drafts.tooltip": "Neodoslané správy budú uložené a môžu byť odoslané pri najbližšom otvorení chatu.",
	...
	"options.chunkFade": "Trvanie zjavenia chunkov",
	"options.chunkFade.none": "Zjavenie chunkov: Okamžité",
	"options.chunkFade.seconds": "Zjavenie chunkov: %s sekúnd",
	"options.chunkFade.tooltip": "Koľko má chunkom trvať zjavenie, keď sa prvýkrát objavia, ak vôbec.",
	...
	"options.cutoutLeaves": "Priehľadné listy",
	"options.cutoutLeaves.tooltip": "Umožňuje vidieť cez medzery v listoch. Vypnutie zlepšuje výkon.",
	...
	"options.exclusiveFullscreen": "Vyhradená celá obrazovka",
	"options.exclusiveFullscreen.warningTooltip": "Pri tejto možnosti nemusia fungovať niektoré metódy vstupu.",
	"options.font": "Nastavenia písma...",
	"options.font.title": "Nastavenia písma",
	...
	"options.friendsList": "Zoznam priateľov",
	"options.friendsList.confirm.message": "Použi svoj zoznam priateľov na posielanie a prijímanie žiadostí o priateľstvo.\n\nNastavenia online bezpečnosti možeš spravovať pomocou svojho %s.",
	"options.friendsList.confirm.message.link": "Microsoft účtu",
	"options.friendsList.confirm.title": "Zoznam priateľov",
	"options.friendsList.confirm.turnOff": "Vypnúť",
	"options.friendsList.confirm.turnOn": "Zapnúť",
	...
	"options.glintStrength.tooltip": "Určuje úroveň priehľadnosti ligotania na očarovaných predmetoch.",
	"options.graphics": "Grafika",
	"options.graphics.custom": "Vlastná",
	...
	"options.graphics.preset": "Predvoľba",
	"options.graphics.preset.tooltip": "Nastavuje kvalitu a výkon na rozumné štandardné hodnoty, zodpovedajúce žiadanej kvalite.",
	...
	"options.graphicsApi": "Grafické API",
	"options.graphicsApi.default": "Predvolené",
	"options.graphicsApi.opengl": "Prioritne OpenGL",
	"options.graphicsApi.restart": "Pre zmenu grafického API musíš reštartovať hru.",
	"options.graphicsApi.tooltip": "Ktoré grafické API sa má používať. Nechaj Predvolené, pokiaľ nemáš špecifický dôvod zmeniť ho. Zmena sa prejaví po reštartovaní hry.",
	"options.graphicsApi.tooltip.vulkan": "Experimentálne. Môže zhoršiť výkon alebo oslabiť stabilitu na niektorých systémoch.",
	"options.graphicsApi.vulkan": "Prioritne Vulkan (experimentálne)",
	"options.guiScale": "Veľkosť GUI",
	"options.guiScale.auto": "Automatická",
	"options.hidden": "Skrytý",
	"options.hideLightningFlashes": "Skryť záblesky oblohy",
	...
	"options.hideSplashTexts": "Skryť úvodný text",
	"options.hideSplashTexts.tooltip": "Skryje žltý úvodný text v hlavnej ponuke.",
	"options.improvedTransparency": "Vylepšená priehľadnosť",
	"options.improvedTransparency.tooltip": "Experimentálny prístup, využívajúci tieňovače pre vykreslenie počasia, oblakov a častíc za priehľadnými kockami a vodou.\nToto nastavenie má vplyv na výkon GPU.",
	"options.inGameNotification": "Herné oznámenia",
	"options.inGameNotification.tooltip": "Ukazovať oznámenia o priateľoch v hre",
	"options.inactivityFpsLimit": "Obmedziť FPS pri",
	"options.inactivityFpsLimit.afk": "AFK",
	"options.inactivityFpsLimit.afk.tooltip": "Obmedzí frekvenciu snímok na 30 keď hra neregistruje vstup z ovládača aspoň minútu. Po 9 minútach ju obmedzí na 10.",
	"options.inactivityFpsLimit.minimized": "Minimalizovaní",
	"options.inactivityFpsLimit.minimized.tooltip": "Obmedzí frekvenciu snímok len keď je hra minimalizovaná.",
	"options.invertMouse": "Invertovať myš",
	"options.invertMouseX": "Invertovať myš horizontálne",
	"options.invertMouseY": "Invertovať myš vertikálne",
	"options.japaneseGlyphVariants": "Varianty japonských glyfov",
	"options.japaneseGlyphVariants.tooltip": "Používa japonské varianty písmen CJK v predvolenom písme",
	"options.key.hold": "Držaním",
	"options.key.toggle": "Prepnutím",
	"options.language": "Jazyk...",
	"options.language.narration": "Zmeniť jazyk",
	"options.language.title": "Jazyk",
	"options.language.tooltip": "Zmeniť jazyk",
	"options.languageAccuracyWarning": "(Preklady nemusia byť na 100%% presné)",
	...
	"options.maxAnisotropy": "Anizotropné filtrovanie",
	"options.maxAnisotropy.tooltip": "Každá úroveň výrazne zlepšuje hladkosť textúr, no ovplyvňuje výkon a významne ovplyvňuje využitie grafickej pamäte.",
	...
	"options.musicToast": "Názov skladby",
	"options.musicToast.never": "Nikdy",
	"options.musicToast.never.tooltip": "Žiadne oznámenie o prehrávanej skladbe sa nezobrazí.",
	"options.musicToast.pauseMenu": "Len v pauze",
	"options.musicToast.pauseMenu.tooltip": "Oznámenie je neustále zobrazené počas pauzy v hernom menu, ak sa prehráva hudba.",
	"options.musicToast.pauseMenuAndToast": "V pauze aj oznámení",
	"options.musicToast.pauseMenuAndToast.tooltip": "Zobrazí oznámenie vždy, keď sa začne prehrávať skladba. Rovnaké oznámenie je neustále zobrazené počas pauzy v hernom menu, ak sa prehráva hudba.",
	"options.music_frequency": "Prehrávanie hudby",
	"options.music_frequency.constant": "Stále",
	"options.music_frequency.default": "Štandardné",
	"options.music_frequency.frequent": "Časté",
	"options.music_frequency.tooltip": "Určuje, ako často bude hrať hudba v hernom svete.",
	...
	"options.needsRestart": "Nastavenie sa prejaví po reštarte.",
	...
	"options.online.friends.header": "Zoznam priateľov",
	"options.online.realms.header": "Realms",
	"options.online.servers.header": "Servery",
	"options.online.title": "Online možnosti",
	"options.online.xboxSettings": "Nastavenia Xbox...",
	...
	"options.realmsNotifications.button": "Novinky a pozvánky",
	"options.realmsNotifications.tooltip": "Prevezme novinky a pozvánky z Realms na úvodnej obrazovke a zobrazí ich príslušné ikony na tlačidle Realms.",
	"options.reducedDebugInfo": "Stručné ladiace info",
	"options.renderClouds": "Oblaky",
	"options.renderCloudsDistance": "Dohľadnosť oblakov",
	"options.renderDistance": "Dohľadnosť",
	"options.resourcepack": "Zdrojové balíky...",
	"options.restartRequired": "Niektoré zmeny sa prejavia až po reštartovaní hry.",
	"options.rotateWithMinecart": "Otáčanie kamery vo vozíkoch",
	"options.rotateWithMinecart.tooltip": "Určuje, či sa má pohľad hráča otáčať spolu s vozíkom. Dostupné len vo svetoch, kde je zapnuté experimentálne nastavenie \"Vylepšenia vozíkov\".",
	...
	"options.sharePresence": "Prítomnosť",
	"options.sharePresence.all": "Všetka",
	"options.sharePresence.all.tooltip": "Tvoja prítomnosť je zdieľaná s tvojimi priateľmi. Tvoji priatelia vidia, či si online a v akom svete hráš.",
	"options.sharePresence.limited": "Limitovaná",
	"options.sharePresence.limited.tooltip": "Zdieľa sa limitovaná prítomnosť. Tvoji priatelia vidia, že si online, ale nevidia, čo robíš. Stále ich môžeš pozývať do svojej hry.",
	"options.sharePresence.none": "Žiadna",
	"options.sharePresence.none.tooltip": "Nezdieľa sa žiadna tvoja prítomnosť. Vyzeráš offline.",
	"options.showNowPlayingToast": "Zobraziť oznámenie o hudbe",
	"options.showNowPlayingToast.tooltip": "Zobrazí oznámenie vždy, keď sa začne prehrávať hudba. Rovnaké oznámenie je neustále zobrazené počas pauzy v hernom menu, ak sa prehráva hudba.",
	"options.showSubtitles": "Zobraziť titulky",
	"options.showSubtitles.tooltip": "Zapne titulky pre zvuky prehrávané v hre.",
	...
	"options.sounds.title": "Možnosti hudby a zvuku",
	"options.sprintWindow": "Interval behu",
	"options.sprintWindow.tooltip": "Časový interval v tikoch, v ktorom dvojité stlačenie klávesu pre pohyb vpred aktivuje beh.",
	...
	"options.telemetry.disabled": "Telemetria je vypnutá.",
	"options.telemetry.state.all": "Úplný",
	"options.telemetry.state.minimal": "Minimálny",
	"options.telemetry.state.none": "Žiadny",
	"options.textureFiltering": "Filtrovanie textúr",
	"options.textureFiltering.anisotropic": "Anizotropné",
	"options.textureFiltering.anisotropic.tooltip": "Hardvérová filtrovacia metóda, ktorá má vplyv na výkon a významne ovplyvňuje využitie grafickej pamäte. Nemusí byť podporovaná na každom hardvéri.",
	"options.textureFiltering.none": "Žiadne",
	"options.textureFiltering.none.tooltip": "Textúry sa vykreslia bez filtrovania a môžu vyzerať rozmazane z ostrých uhlov pohľadu.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nFiltrovacia metóda založená na tieňovačoch. Zlepšuje kvalitu textúr, no ovplyvňuje výkon.",
	"options.title": "Možnosti",
	"options.touchscreen": "Dotykový režim",
	"options.value": "%s",
	"options.video": "Nastavenia obrazu...",
	"options.video.display.header": "Zobrazenie",
	"options.video.interface.header": "Rozhranie",
	"options.video.preferences.header": "Predvoľby",
	"options.video.quality.header": "Kvalita a výkon",
	"options.videoTitle": "Nastavenia obrazu",
	"options.viewBobbing": "Kolísanie pri chôdzi",
	"options.vignette": "Zobraziť vinetu",
	"options.vignette.tooltip": "Nenápadná textúra, prekrývajúca hernú obrazovku, ktorá znižuje jas pri okrajoch obrazovky a varuje pri dosiahnutí hranice sveta.",
	"options.visible": "Viditeľný",
	"options.vsync": "VSync",
	"options.weatherRadius": "Dohľadnosť efektov počasia",
	"options.weatherRadius.tooltip": "Polomer okolia, v ktorom vidno dážď a sneh. Veľmi malý dopad na výkon.",
	"options.worldOptions.button": "Možnosti sveta...",
	"options.worldOptions.title": "Možnosti sveta",
	...
	"pack.dropRejected.message": "Nasledujúce položky nie sú platné balíčky a neboli skopírované:\n %s",
	"pack.dropRejected.title": "Položky mimo balíčka",
	...
	"pack.incompatible.confirm.unknown": "Tento balík je pokazený alebo vytvorený pre neznámu verziu Minecraftu a nemusí fungovať správne.",
	...
	"pack.incompatible.unknown": "(Pokazený alebo nekompatibilný)",
	...
	"painting.minecraft.backyard.title": "Dvor",
	...
	"painting.minecraft.bouquet.title": "Kytica",
	...
	"painting.minecraft.cavebird.title": "Jaskynný vták",
	"painting.minecraft.changing.author": "Kristoffer Zetterstrand",
	"painting.minecraft.changing.title": "Zmena",
	...
	"painting.minecraft.passage.title": "Prechod",
	...
	"particle.invalidOptions": "Nie je možné spracovať možnosti: %s",
	...
	"realms.configuration.region.australia_east": "Nový Južný Wales",
	"realms.configuration.region.australia_southeast": "Viktória, Austrália",
	"realms.configuration.region.brazil_south": "Brazília",
	"realms.configuration.region.central_india": "India",
	"realms.configuration.region.central_us": "Iowa, Spojené štáty americké",
	"realms.configuration.region.east_asia": "Hong Kong",
	"realms.configuration.region.east_us": "Virgínia, Spojené štáty americké",
	"realms.configuration.region.east_us_2": "Severná Karolína, Spojené štáty americké",
	"realms.configuration.region.france_central": "Francúzsko",
	"realms.configuration.region.japan_east": "Východné Japonsko",
	"realms.configuration.region.japan_west": "Západné Japonsko",
	"realms.configuration.region.korea_central": "Južná Kórea",
	"realms.configuration.region.north_central_us": "Illinois, Spojené štáty americké",
	"realms.configuration.region.north_europe": "Írsko",
	"realms.configuration.region.south_central_us": "Texas, Spojené štáty americké",
	"realms.configuration.region.southeast_asia": "Singapur",
	"realms.configuration.region.sweden_central": "Švédsko",
	"realms.configuration.region.uae_north": "Spojené arabské emiráty",
	"realms.configuration.region.uk_south": "Južné Anglicko",
	"realms.configuration.region.west_central_us": "Utah, Spojené štáty americké",
	"realms.configuration.region.west_europe": "Holandsko",
	"realms.configuration.region.west_us": "Kalifornia, Spojené štáty americké",
	"realms.configuration.region.west_us_2": "Washington, Spojené štáty americké",
	"realms.configuration.region_preference.automatic_owner": "Automatický (podľa vlastníka realmu)",
	"realms.configuration.region_preference.automatic_player": "Automatický (podľa prvého pripojeného hráča)",
	...
	"recover_world.bug_tracker": "Nahlásiť chybu",
	"recover_world.button": "Pokúsiť sa o obnovenie",
	"recover_world.done.failed": "Nepodarilo sa obnoviť predošlý stav.",
	"recover_world.done.success": "Obnovenie bolo úspešné!",
	"recover_world.done.title": "Obnovenie hotové",
	"recover_world.issue.missing_file": "Chýbajúci súbor",
	"recover_world.issue.none": "Žiadne problémy",
	"recover_world.message": "Pri pokuse o načítanie zložky \"%s\" sa vyskytli nasledujúce chyby.\nMôžeš skúsiť obnoviť svet zo staršej zálohy, alebo nám túto chybu nahlásiť.",
	"recover_world.no_fallback": "Nie je k dispozícii žiadny stav pre obnovenie",
	"recover_world.restore": "Pokúsiť sa o obnovenie",
	"recover_world.restoring": "Prebieha pokus o obnovenie sveta...",
	"recover_world.state_entry": "Stav z %s: ",
	"recover_world.state_entry.unknown": "neznámy",
	"recover_world.title": "Nepodarilo sa načítať svet",
	"recover_world.warning": "Nepodarilo sa načítať informácie o svete",
	...
	"resourcePack.runtime_failure": "V zdrojovom balíku sa vyskytla chyba",
	...
	"restrictions_screen.button": "Obmedzenia...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Môžeš dostávať správy od iných hráčov",
	"restrictions_screen.permission.receive_player_messages.denied": "Nemôžeš dostávať správy od iných hráčov",
	"restrictions_screen.permission.receive_system_messages.allowed": "Môžeš dostávať systémové správy zo servera",
	"restrictions_screen.permission.receive_system_messages.denied": "Nemôžeš dostávať systémové správy zo servera",
	"restrictions_screen.permission.send_commands.allowed": "Môžeš používať príkazy",
	"restrictions_screen.permission.send_commands.denied": "Nemôžeš používať príkazy",
	"restrictions_screen.permission.send_messages.allowed": "Môžeš posielať správy do chatu",
	"restrictions_screen.permission.send_messages.denied": "Nemôžeš posielať správy do chatu",
	"restrictions_screen.title": "Obmedzenia",
	...
	"selectWorld.allowCommands.new": "Povoliť príkazy",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Vytvoriť zálohu pred aktualizovaním sveta?",
	...
	"selectWorld.backupWarning.file_fixing_required": "Pre hranie v tomto svete je potrebné ho najprv aktualizovať. Odporúčame ho pred tým zálohovať pre prípad, že sa v procese aktualizácie vyskytnú problémy.",
	"selectWorld.backupWarning.snapshot": "Tento svet bol naposledy hraný na verzii %s, ty si na verzii %s. Prosím, vytvor si zálohu pre prípad poškodenia sveta.",
	"selectWorld.bonusItems": "Bonusová truhlica",
	"selectWorld.cheats": "Cheaty",
	"selectWorld.commands": "Príkazy",
	...
	"selectWorld.incompatible.description": "Tento svet nemôže byť otvorený na tejto verzii.\nNaposledy bol hraný na verzii %s.",
	"selectWorld.incompatible.info": "Nekompatibilná verzia: %s",
	"selectWorld.incompatible.title": "Nekompatibilná verzia",
	"selectWorld.incompatible.tooltip": "Tento svet nie je možné otvoriť, pretože bol vytvorený na nekompatibilnej verzii.",
	...
	"selectWorld.moreWorldOptions": "Viac možností sveta...",
	"selectWorld.newWorld": "Nový svet",
	"selectWorld.recreate": "Opätovne vytvoriť",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Pre úpravy tohto sveta je potrebné ho najprv aktualizovať na najnovšiu verziu, vzhľadom na zmeny vo formáte sveta.",
	"selectWorld.requiresFileFixingTooltip.play": "Pre hranie v tomto svete je potrebné ho najprv aktualizovať na najnovšiu verziu, vzhľadom na zmeny vo formáte sveta.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Pre opätovné vytvorenie tohto sveta je potrebné ho najprv aktualizovať na najnovšiu verziu, vzhľadom na zmeny vo formáte sveta.",
	"selectWorld.resource_load": "Pripravujú sa zdroje...",
	...
	"selectWorld.upgrade_and_play": "Aktualizovať a hrať",
	...
	"selectWorld.waitingForBackup.message": "V závislosti na veľkosti sveta to môže chvíľu trvať. Počas trvania tohto procesu nevypínaj hru ani počítač.",
	"selectWorld.waitingForBackup.title": "Vytvára sa záloha",
	...
	"selectWorld.warning.lowDiskSpace.description": "Na disku nezostáva veľa miesta.\nAk sa disk zaplní počas hry, môže to poškodiť svet.",
	"selectWorld.warning.lowDiskSpace.title": "Pozor! Málo miesta na disku!",
	"selectWorld.world": "Svet",
	"selectWorld.world_gen_settings_access": "Nepodarilo sa získať prístup k súboru nastavení generácie sveta! %s",
	"selecteWorld.backupRequiredTooltip": "Pred načítaním sveta je potrebné ho najprv zálohovať",
	"sign.edit": "Upraviť text na ceduli",
	"sleep.not_possible": "Túto noc nie je možné prespať",
	"sleep.players_sleeping": "Spí %s z %s hráčov",
	"sleep.skipping_night": "Túto noc spíme",
	"slot.only_single_allowed": "Povolené sú len jednotlivé pozície, zadané bolo \"%s\"",
	"slot.unknown": "Neznáma pozícia \"%s\"",
	"snbt.parser.empty_key": "Kľúč nemôže byť prázdny",
	"snbt.parser.expected_binary_numeral": "Očakávalo sa číslo v dvojkovej sústave",
	"snbt.parser.expected_decimal_numeral": "Očakávalo sa číslo v desiatkovej sústave",
	"snbt.parser.expected_float_type": "Očakávalo sa číslo s desatinnou čiarkou",
	"snbt.parser.expected_hex_escape": "Očakávalo sa znakový literál o dĺžke %s",
	"snbt.parser.expected_hex_numeral": "Očakávalo sa číslo v šestnástkovej sústave",
	"snbt.parser.expected_integer_type": "Očakávalo sa celé číslo",
	"snbt.parser.expected_non_negative_number": "Očakávalo sa nezáporné číslo",
	"snbt.parser.expected_number_or_boolean": "Očakávalo sa číslo alebo boolean",
	"snbt.parser.expected_string_uuid": "Očakával sa reťazec predstavujúci platné UUID",
	"snbt.parser.expected_unquoted_string": "Očakával sa reťazec neoznačený úvodzovkami",
	"snbt.parser.infinity_not_allowed": "Nekonečné čísla nie sú povolené",
	"snbt.parser.invalid_array_element_type": "Neplatný typ prvku poľa",
	"snbt.parser.invalid_character_name": "Neplatný názov Unicode znaku",
	"snbt.parser.invalid_codepoint": "Neplatná hodnota Unicode znaku: %s",
	"snbt.parser.invalid_string_contents": "Neplatný obsah reťazca",
	"snbt.parser.invalid_unquoted_start": "Reťazce neoznačené úvodzovkami nemôžu začínať číslicami, ani znakmi + alebo -",
	"snbt.parser.leading_zero_not_allowed": "Čísla v desiatkovej sústave sa nemôžu začínať nulou",
	"snbt.parser.no_such_operation": "Neexistujúca operácia: %s",
	"snbt.parser.number_parse_failure": "Nepodarilo sa spracovať číslo: %s",
	"snbt.parser.undescore_not_allowed": "Podčiarkovníky nie sú povolené na začiatku ani na konci čísla",
	...
	"soundCategory.ui": "Menu",
	"soundCategory.voice": "Hlas a reč",
	...
	"stat.minecraft.happy_ghast_one_cm": "Vzdialenosť na šťastnom ghastovi",
	...
	"stat.minecraft.nautilus_one_cm": "Vzdialenosť na lodienke",
	...
	"subtitles.block.candle.extinguish": "Vyhasnutie sviečky",
	...
	"subtitles.block.copper_bulb.turn_off": "Vypnutie medenej žiarovky",
	"subtitles.block.copper_bulb.turn_on": "Zapnutie medenej žiarovky",
	"subtitles.block.copper_chest.close": "Zatváranie truhlice",
	"subtitles.block.copper_chest.open": "Otváranie truhlice",
	"subtitles.block.copper_trapdoor.close": "Zatvorenie poklopu",
	"subtitles.block.copper_trapdoor.open": "Otvorenie poklopu",
	"subtitles.block.crafter.craft": "Vyrábanie výrobníkom",
	"subtitles.block.crafter.fail": "Zlyhanie výrobníka",
	"subtitles.block.creaking_heart.hurt": "Mrmlanie srdca škripotu",
	"subtitles.block.creaking_heart.idle": "Tajomný zvuk",
	"subtitles.block.creaking_heart.spawn": "Prebúdzanie srdca škripotu",
	"subtitles.block.deadbush.idle": "Suchý šum",
	"subtitles.block.decorated_pot.insert": "Naplnenie džbánu",
	"subtitles.block.decorated_pot.insert_fail": "Zachvenie džbánu",
	...
	"subtitles.block.dried_ghast.ambient": "Suchý šum",
	"subtitles.block.dried_ghast.ambient_water": "Rehydratovanie vyschnutého ghasta",
	"subtitles.block.dried_ghast.place_in_water": "Namočenie vyschnutého ghasta",
	"subtitles.block.dried_ghast.transition": "Oživenie vyschnutého ghasta",
	"subtitles.block.dry_grass.ambient": "Veterný šum",
	...
	"subtitles.block.eyeblossom.close": "Zatváranie zorničky",
	"subtitles.block.eyeblossom.idle": "Šepot zorničky",
	"subtitles.block.eyeblossom.open": "Otváranie zorničky",
	...
	"subtitles.block.firefly_bush.idle": "Bzučanie svetlušiek",
	...
	"subtitles.block.generic.fall": "Niečo dopadlo na kocku",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Zachvenie cedule",
	...
	"subtitles.block.pale_hanging_moss.idle": "Tajomný zvuk",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Vystreknutie sírového prameňa",
	"subtitles.block.potent_sulfur.noxious_gas": "Objavenie jedovatého plynu",
	...
	"subtitles.block.sand.idle": "Piesočný šum",
	"subtitles.block.sand.wind": "Veterný šum",
	...
	"subtitles.block.shelf.activate": "Aktivácia poličky",
	"subtitles.block.shelf.deactivate": "Deaktivácia poličky",
	"subtitles.block.shelf.multi_swap": "Výmena predmetov",
	"subtitles.block.shelf.place_item": "Uloženie predmetu",
	"subtitles.block.shelf.single_swap": "Výmena predmetu",
	"subtitles.block.shelf.take_item": "Vybratie predmetu",
	"subtitles.block.shulker_box.close": "Zatváranie shulker schránky",
	"subtitles.block.shulker_box.open": "Otváranie shulker schránky",
	...
	"subtitles.block.sponge.absorb": "Nasávanie špongie",
	"subtitles.block.sweet_berry_bush.pick_berries": "Odtrhnutie bobúľ",
	"subtitles.block.trapdoor.close": "Zatvorenie poklopu",
	"subtitles.block.trapdoor.open": "Otvorenie poklopu",
	"subtitles.block.trapdoor.toggle": "Vŕzganie poklopu",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Príprava zlovestného predmetu",
	"subtitles.block.trial_spawner.ambient": "Praskanie skúškovej liahne",
	"subtitles.block.trial_spawner.ambient_charged": "Zlovestné praskanie",
	"subtitles.block.trial_spawner.ambient_ominous": "Zlovestné praskanie",
	"subtitles.block.trial_spawner.charge_activate": "Pohltenie skúšobnej liahne znamením",
	"subtitles.block.trial_spawner.close_shutter": "Zatvorenie skúškovej liahne",
	"subtitles.block.trial_spawner.detect_player": "Nabitie skúškovej liahne",
	"subtitles.block.trial_spawner.eject_item": "Vyhadzovanie predmetov skúškovou liahňou",
	"subtitles.block.trial_spawner.ominous_activate": "Pohltenie skúšobnej liahne znamením",
	"subtitles.block.trial_spawner.open_shutter": "Otvorenie skúškovej liahne",
	"subtitles.block.trial_spawner.spawn_item": "Vypadnutie zlovestného predmetu",
	"subtitles.block.trial_spawner.spawn_item_begin": "Objavenie sa zlovestného predmetu",
	"subtitles.block.trial_spawner.spawn_mob": "Liahnutie tvora skúškovou liahňou",
	...
	"subtitles.block.vault.activate": "Zapálenie pokladnice",
	"subtitles.block.vault.ambient": "Praskanie pokladnice",
	"subtitles.block.vault.close_shutter": "Zatvorenie pokladnice",
	"subtitles.block.vault.deactivate": "Vyhasnutie pokladnice",
	"subtitles.block.vault.eject_item": "Vyhodenie predmetu pokladnicou",
	"subtitles.block.vault.insert_item": "Odomykanie pokladnice",
	"subtitles.block.vault.insert_item_fail": "Odmietnutie predmetu pokladnicou",
	"subtitles.block.vault.open_shutter": "Otvorenie pokladnice",
	"subtitles.block.vault.reject_rewarded_player": "Odmietnutie hráča pokladnicou",
	"subtitles.block.water.ambient": "Tok vody",
	"subtitles.block.wet_sponge.dries": "Vyschnutie špongie",
	...
	"subtitles.entity.armadillo.ambient": "Vrčanie pásavca",
	"subtitles.entity.armadillo.brush": "Strasenie doštičky",
	"subtitles.entity.armadillo.death": "Umieranie pásavca",
	"subtitles.entity.armadillo.eat": "Žranie pásavca",
	"subtitles.entity.armadillo.hurt": "Poranenie pásavca",
	"subtitles.entity.armadillo.hurt_reduced": "Bránenie pásavca",
	"subtitles.entity.armadillo.land": "Dopadnutie pásavca",
	"subtitles.entity.armadillo.peek": "Vykuknutie pásavca",
	"subtitles.entity.armadillo.roll": "Zvinutie pásavca",
	"subtitles.entity.armadillo.scute_drop": "Zhodenie doštičky pásavcom",
	"subtitles.entity.armadillo.unroll_finish": "Rozvinutie pásavca",
	"subtitles.entity.armadillo.unroll_start": "Vykuknutie pásavca",
	...
	"subtitles.entity.baby_cat.ambient": "Mňaukanie mačaťa",
	"subtitles.entity.baby_cat.beg_for_food": "Prosenie mačaťa",
	"subtitles.entity.baby_cat.death": "Umieranie mačaťa",
	"subtitles.entity.baby_cat.eat": "Žranie mačaťa",
	"subtitles.entity.baby_cat.hiss": "Syčanie mačaťa",
	"subtitles.entity.baby_cat.hurt": "Poranenie mačaťa",
	"subtitles.entity.baby_cat.purr": "Pradenie mačaťa",
	"subtitles.entity.baby_chicken.ambient": "Pípanie kuriatka",
	"subtitles.entity.baby_chicken.death": "Umieranie kuriatka",
	"subtitles.entity.baby_chicken.hurts": "Poranenie kuriatka",
	"subtitles.entity.baby_horse.ambient": "Erdžanie žriebäťa",
	"subtitles.entity.baby_horse.angry": "Erdžanie žriebäťa",
	"subtitles.entity.baby_horse.breathe": "Dýchanie žriebäťa",
	"subtitles.entity.baby_horse.death": "Umieranie žriebäťa",
	"subtitles.entity.baby_horse.eat": "Žranie žriebäťa",
	"subtitles.entity.baby_horse.hurt": "Poranenie žriebäťa",
	"subtitles.entity.baby_horse.land": "Dopadnutie žriebäťa",
	"subtitles.entity.baby_nautilus.ambient": "Cvrlikanie mláďaťa lodienky",
	"subtitles.entity.baby_nautilus.ambient_land": "Cvrlikanie mláďaťa lodienky",
	"subtitles.entity.baby_nautilus.death": "Umieranie mláďaťa lodienky",
	"subtitles.entity.baby_nautilus.death_land": "Umieranie mláďaťa lodienky",
	"subtitles.entity.baby_nautilus.eat": "Žranie mláďaťa lodienky",
	"subtitles.entity.baby_nautilus.hurt": "Poranenie mláďaťa lodienky",
	"subtitles.entity.baby_nautilus.hurt_land": "Poranenie mláďaťa lodienky",
	"subtitles.entity.baby_nautilus.swim": "Plávanie mláďaťa lodienky",
	"subtitles.entity.baby_pig.ambient": "Krochkanie prasiatka",
	"subtitles.entity.baby_pig.death": "Umieranie prasiatka",
	"subtitles.entity.baby_pig.eat": "Žranie prasiatka",
	"subtitles.entity.baby_pig.hurt": "Poranenie prasiatka",
	"subtitles.entity.baby_wolf.ambient": "Štekanie vĺčaťa",
	"subtitles.entity.baby_wolf.death": "Umieranie vĺčaťa",
	"subtitles.entity.baby_wolf.growl": "Vrčanie vĺčaťa",
	"subtitles.entity.baby_wolf.hurt": "Poranenie vĺčaťa",
	"subtitles.entity.baby_wolf.pant": "Dychčanie vĺčaťa",
	"subtitles.entity.baby_wolf.whine": "Kňučanie vĺčaťa",
	...
	"subtitles.entity.bogged.ambient": "Hrkot vodníka",
	"subtitles.entity.bogged.death": "Umieranie vodníka",
	"subtitles.entity.bogged.hurt": "Poranenie vodníka",
	"subtitles.entity.breeze.charge": "Výpad víchra",
	"subtitles.entity.breeze.death": "Umieranie víchra",
	"subtitles.entity.breeze.deflect": "Odrazenie víchra",
	"subtitles.entity.breeze.hurt": "Poranenie víchra",
	"subtitles.entity.breeze.idle_air": "Lietanie víchra",
	"subtitles.entity.breeze.idle_ground": "Fučanie víchra",
	"subtitles.entity.breeze.inhale": "Nadychovanie víchra",
	"subtitles.entity.breeze.jump": "Skok víchra",
	"subtitles.entity.breeze.land": "Pristátie víchra",
	"subtitles.entity.breeze.shoot": "Útočenie víchra",
	"subtitles.entity.breeze.slide": "Kĺzanie víchra",
	"subtitles.entity.breeze.whirl": "Vírenie víchra",
	"subtitles.entity.breeze.wind_burst": "Výbuch veterného náboja",
	"subtitles.entity.camel.ambient": "Vrčanie ťavy",
	"subtitles.entity.camel.dash": "Skok ťavy",
	"subtitles.entity.camel.dash_ready": "Oddýchnutie ťavy",
	...
	"subtitles.entity.camel_husk.ambient": "Bručanie ťavieho zdochliaka",
	"subtitles.entity.camel_husk.dash": "Skok ťavieho zdochliaka",
	"subtitles.entity.camel_husk.dash_ready": "Oddýchnutie ťavieho zdochliaka",
	"subtitles.entity.camel_husk.death": "Umieranie ťavieho zdochliaka",
	"subtitles.entity.camel_husk.eat": "Žranie ťavieho zdochliaka",
	"subtitles.entity.camel_husk.hurt": "Poranenie ťavieho zdochliaka",
	"subtitles.entity.camel_husk.saddle": "Nasadenie sedla",
	"subtitles.entity.camel_husk.sit": "Sadnutie ťavieho zdochliaka",
	"subtitles.entity.camel_husk.stand": "Vstávanie ťavieho zdochliaka",
	...
	"subtitles.entity.copper_golem.death": "Umieranie medeného golema",
	"subtitles.entity.copper_golem.hurt": "Poranenie medeného golema",
	"subtitles.entity.copper_golem.item_drop": "Ukladanie predmetu medeným golemom",
	"subtitles.entity.copper_golem.item_no_drop": "Rozmýšľanie medeného golema",
	"subtitles.entity.copper_golem.no_item_get": "Zdvíhanie predmetu medeným golemom",
	"subtitles.entity.copper_golem.no_item_no_get": "Rozmýšľanie medeného golema",
	"subtitles.entity.copper_golem.spawn": "Objavenie medeného golema",
	"subtitles.entity.copper_golem.spin": "Točenie hlavy medeného golema",
	"subtitles.entity.copper_golem_become_statue": "Skamenenie medeného golema",
	"subtitles.entity.copper_golem_oxidized.death": "Umieranie medeného golema",
	"subtitles.entity.copper_golem_oxidized.hurt": "Poranenie medeného golema",
	"subtitles.entity.copper_golem_oxidized.spin": "Točenie hlavy medeného golema",
	"subtitles.entity.copper_golem_weathered.death": "Umieranie medeného golema",
	"subtitles.entity.copper_golem_weathered.hurt": "Poranenie medeného golema",
	"subtitles.entity.copper_golem_weathered.spin": "Točenie hlavy medeného golema",
	...
	"subtitles.entity.creaking.activate": "Striehnutie škripotu",
	"subtitles.entity.creaking.ambient": "Škripot škripotu",
	"subtitles.entity.creaking.attack": "Útok škripotu",
	"subtitles.entity.creaking.deactivate": "Upokojenie škripotu",
	"subtitles.entity.creaking.death": "Rozpad škripotu",
	"subtitles.entity.creaking.freeze": "Zastavenie škripotu",
	"subtitles.entity.creaking.spawn": "Prejav škripotu",
	"subtitles.entity.creaking.sway": "Zasiahnutie škripotu",
	"subtitles.entity.creaking.twitch": "Šklbnutie škripotu",
	"subtitles.entity.creaking.unfreeze": "Pohyb škripotu",
	...
	"subtitles.entity.dolphin.jump": "Skok delfína",
	...
	"subtitles.entity.donkey.jump": "Skok somára",
	...
	"subtitles.entity.fish.swim": "Šplechot",
	...
	"subtitles.entity.frog.long_jump": "Skok žaby",
	...
	"subtitles.entity.generic.wind_burst": "Výbuch veterného náboja",
	...
	"subtitles.entity.ghastling.ambient": "Vrkot ghastíka",
	"subtitles.entity.ghastling.death": "Umieranie ghastíka",
	"subtitles.entity.ghastling.hurt": "Poranenie ghastíka",
	"subtitles.entity.ghastling.spawn": "Objavenie ghastíka",
	"subtitles.entity.glow_item_frame.add_item": "Vloženie do žiariaceho rámu",
	"subtitles.entity.glow_item_frame.break": "Rozbitie svietiaceho rámu",
	...
	"subtitles.entity.happy_ghast.ambient": "Vrkot šťastného ghasta",
	"subtitles.entity.happy_ghast.death": "Umieranie šťastného ghasta",
	"subtitles.entity.happy_ghast.equip": "Nasadenie postroja",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Pripravenie šťastného ghasta",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Zastavenie šťastného ghasta",
	"subtitles.entity.happy_ghast.hurt": "Poranenie šťastného ghasta",
	"subtitles.entity.happy_ghast.unequip": "Zloženie postroja",
	...
	"subtitles.entity.horse.jump": "Skok koňa",
	"subtitles.entity.horse.saddle": "Nasadenie sedla",
	"subtitles.entity.husk.ambient": "Stonanie zdochliaka",
	...
	"subtitles.entity.lightning_bolt.impact": "Úder blesku",
	...
	"subtitles.entity.minecart.inside": "Hrkot vozíka",
	"subtitles.entity.minecart.inside_underwater": "Hrkot vozíka pod vodou",
	...
	"subtitles.entity.mule.jump": "Skok mulice",
	"subtitles.entity.nautilus.ambient": "Cvakanie lodienky",
	"subtitles.entity.nautilus.ambient_land": "Cvakanie lodienky",
	"subtitles.entity.nautilus.dash": "Prúdenie lodienky",
	"subtitles.entity.nautilus.dash_land": "Prúdenie lodienky",
	"subtitles.entity.nautilus.dash_ready": "Oddýchnutie lodienky",
	"subtitles.entity.nautilus.dash_ready_land": "Oddýchnutie lodienky",
	"subtitles.entity.nautilus.death": "Umieranie lodienky",
	"subtitles.entity.nautilus.death_land": "Umieranie lodienky",
	"subtitles.entity.nautilus.eat": "Žranie lodienky",
	"subtitles.entity.nautilus.hurt": "Poranenie lodienky",
	"subtitles.entity.nautilus.hurt_land": "Poranenie lodienky",
	"subtitles.entity.nautilus.swim": "Plávanie lodienky",
	"subtitles.entity.painting.break": "Rozbitie obrazu",
	...
	"subtitles.entity.parched.ambient": "Praskot suchára",
	"subtitles.entity.parched.death": "Umieranie suchára",
	"subtitles.entity.parched.hurt": "Poranenie suchára",
	...
	"subtitles.entity.parrot.imitate.bogged": "Hrkot papagája",
	"subtitles.entity.parrot.imitate.breeze": "Fučanie papagája",
	"subtitles.entity.parrot.imitate.camel_husk": "Bručanie papagája",
	"subtitles.entity.parrot.imitate.creaking": "Škripot papagája",
	...
	"subtitles.entity.parrot.imitate.wither_skeleton": "Hrkot papagája",
	"subtitles.entity.parrot.imitate.zoglin": "Vrčanie papagája",
	"subtitles.entity.parrot.imitate.zombie": "Stonanie papagája",
	"subtitles.entity.parrot.imitate.zombie_horse": "Stonanie papagája",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Kloktanie papagája",
	"subtitles.entity.parrot.imitate.zombie_villager": "Stonanie papagája",
	...
	"subtitles.entity.pig.eat": "Žranie prasaťa",
	...
	"subtitles.entity.player.teleport": "Teleportovanie hráča",
	"subtitles.entity.polar_bear.ambient": "Stonanie ľadového medveďa",
	...
	"subtitles.entity.skeleton.ambient": "Hrkot kostlivca",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Výskok kostlivého koňa",
	...
	"subtitles.entity.sulfur_cube.absorb": "Naplnenie sírovca",
	"subtitles.entity.sulfur_cube.bounce": "Odrážanie sírovca",
	"subtitles.entity.sulfur_cube.death": "Umieranie sírovca",
	"subtitles.entity.sulfur_cube.eject": "Odstránenie kocky",
	"subtitles.entity.sulfur_cube.hit": "Zasiahnutie sírovca",
	"subtitles.entity.sulfur_cube.hurt": "Poranenie sírovca",
	"subtitles.entity.sulfur_cube.push": "Odstrčenie sírovca",
	"subtitles.entity.sulfur_cube.squish": "Odrážanie sírovca",
	...
	"subtitles.entity.wind_charge.throw": "Let veterného náboja",
	"subtitles.entity.wind_charge.wind_burst": "Výbuch veterného náboja",
	...
	"subtitles.entity.wolf.bark": "Štekanie vlka",
	...
	"subtitles.entity.wolf.pant": "Dychčanie vlka",
	"subtitles.entity.wolf.shake": "Trasenie vlka",
	"subtitles.entity.wolf.whine": "Kňučanie vlka",
	...
	"subtitles.entity.zombie_horse.angry": "Erdžanie zombie koňa",
	"subtitles.entity.zombie_horse.death": "Umieranie zombie koňa",
	"subtitles.entity.zombie_horse.eat": "Žranie zombie koňa",
	"subtitles.entity.zombie_horse.hurt": "Poranenie zombie koňa",
	"subtitles.entity.zombie_nautilus.ambient": "Bublanie zombie lodienky",
	"subtitles.entity.zombie_nautilus.ambient_land": "Bublanie zombie lodienky",
	"subtitles.entity.zombie_nautilus.dash": "Prúdenie zombie lodienky",
	"subtitles.entity.zombie_nautilus.dash_land": "Prúdenie zombie lodienky",
	"subtitles.entity.zombie_nautilus.dash_ready": "Oddýchnutie zombie lodienky",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Oddýchnutie zombie lodienky",
	"subtitles.entity.zombie_nautilus.death": "Umieranie zombie lodienky",
	"subtitles.entity.zombie_nautilus.death_land": "Umieranie zombie lodienky",
	"subtitles.entity.zombie_nautilus.eat": "Žranie zombie lodienky",
	"subtitles.entity.zombie_nautilus.hurt": "Poranenie zombie lodienky",
	"subtitles.entity.zombie_nautilus.hurt_land": "Poranenie zombie lodienky",
	"subtitles.entity.zombie_nautilus.swim": "Plávanie zombie lodienky",
	...
	"subtitles.event.mob_effect.bad_omen": "Posadnutie znamením",
	"subtitles.event.mob_effect.raid_omen": "Priblíženie sa nájazdu",
	"subtitles.event.mob_effect.trial_omen": "Priblíženie sa zlovestnej skúšky",
	...
	"subtitles.item.armor.equip_copper": "Cinkot medeného brnenia",
	...
	"subtitles.item.armor.equip_nautilus": "Nasadenie brnenia lodienky",
	"subtitles.item.armor.equip_netherite": "Cenganie netheritového brnenia",
	"subtitles.item.armor.equip_turtle": "Nasadenie panciera",
	"subtitles.item.armor.equip_wolf": "Nasadenie vlčieho brnenia",
	"subtitles.item.armor.unequip_nautilus": "Zloženie brnenia lodienky",
	"subtitles.item.armor.unequip_wolf": "Strhnutie vlčieho brnenia",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Nabranie sírovca do vedra",
	"subtitles.item.bucket.fill_tadpole": "Chytenie žubrienky",
	"subtitles.item.bundle.drop_contents": "Balíček vyprázdnený",
	"subtitles.item.bundle.insert": "Zabalenie predmetu",
	"subtitles.item.bundle.insert_fail": "Balíček je plný",
	"subtitles.item.bundle.remove_one": "Vybalenie predmetu",
	...
	"subtitles.item.elytra.flying": "Svišťanie",
	...
	"subtitles.item.golden_dandelion.unuse": "Starnutie zlatou púpavou",
	"subtitles.item.golden_dandelion.use": "Zastavenie starnutia zlatou púpavou",
	...
	"subtitles.item.horse_armor.unequip": "Odstrihnutie konskej zbroje",
	"subtitles.item.ink_sac.use": "Šplechnutie atramentového váčku",
	"subtitles.item.lead.break": "Odtrhnutie vôdzky",
	"subtitles.item.lead.tied": "Priviazanie vôdzky",
	"subtitles.item.lead.untied": "Rozviazanie vôdzky",
	"subtitles.item.llama_carpet.unequip": "Odstrihnutie koberca",
	"subtitles.item.lodestone_compass.lock": "Magnetizovanie kompasu navigačným kameňom",
	"subtitles.item.mace.smash_air": "Mlátenie palcátom",
	"subtitles.item.mace.smash_ground": "Mlátenie palcátom",
	"subtitles.item.nautilus_saddle_equip": "Nasadenie sedla",
	"subtitles.item.nautilus_saddle_underwater_equip": "Nasadenie sedla",
	"subtitles.item.nether_wart.plant": "Zasadenie plodiny",
	"subtitles.item.ominous_bottle.dispose": "Rozbitie fľašky",
	"subtitles.item.saddle.unequip": "Odstrihnutie sedla",
	"subtitles.item.shears.shear": "Cvaknutie nožníc",
	"subtitles.item.shears.snip": "Strihanie",
	"subtitles.item.shield.block": "Blokovanie štítom",
	"subtitles.item.shovel.flatten": "Zarovnanie lopatou",
	"subtitles.item.spear.attack": "Bodnutie kopije",
	"subtitles.item.spear.hit": "Zásah kopije",
	"subtitles.item.spear.lunge": "Výpad kopije",
	"subtitles.item.spear.use": "Útok kopije",
	"subtitles.item.spear_wood.attack": "Bodnutie kopije",
	"subtitles.item.spear_wood.hit": "Zásah kopije",
	"subtitles.item.spear_wood.use": "Útok kopije",
	...
	"subtitles.item.underwater_saddle.equip": "Nasadenie sedla",
	"subtitles.item.wolf_armor.break": "Rozbitie vlčieho brnenia",
	"subtitles.item.wolf_armor.crack": "Prasknutie vlčieho brnenia",
	"subtitles.item.wolf_armor.damage": "Poškodenie vlčieho brnenia",
	"subtitles.item.wolf_armor.repair": "Opravenie vlčieho brnenia",
	"subtitles.particle.soul_escape": "Únik duše",
	"subtitles.ui.cartography_table.take_result": "Nakreslenie mapy",
	"subtitles.ui.hud.bubble_pop": "Klesanie ukazovateľa dychu",
	"subtitles.ui.loom.take_result": "Použitie krosien",
	"subtitles.ui.stonecutter.take_result": "Použitie píly na kameň",
	"subtitles.weather.end_flash": "Hrmot zábleskov Endu",
	"subtitles.weather.rain": "Dážď",
	"symlink_warning.message": "Načítanie svetov z priečinkov so symbolickými odkazmi môže byť nebezpečné, ak presne nevieš, čo to znamená. Ak sa chceš dozvedieť viac, prejdi na %s.",
	"symlink_warning.message.pack": "Načítanie balíčkov so symbolickými odkazmi môže byť nebezpečné, ak presne nevieš, čo to znamená. Ak sa chceš dozvedieť viac, prejdi na %s.",
	"symlink_warning.message.world": "Načítanie svetov z priečinkov so symbolickými odkazmi môže byť nebezpečné, ak presne nevieš, čo to znamená. Ak sa chceš dozvedieť viac, prejdi na %s.",
	"symlink_warning.more_info": "Viac informácií",
	"symlink_warning.title": "Priečinok so svetom obsahuje symbolické odkazy",
	"symlink_warning.title.pack": "Pridané balíčky obsahujú symbolické odkazy",
	"symlink_warning.title.world": "Priečinok so svetom obsahuje symbolické odkazy",
	...
	"telemetry.event.graphics_capabilities.description": "Táto udalosť nás informuje o možnostiach grafického adaptéra, používaného na hranie hry.",
	"telemetry.event.graphics_capabilities.title": "Grafické možnosti",
	"telemetry.event.optional": "%s (nepovinné)",
	"telemetry.event.optional.disabled": "%s (nepovinné) - zakázané",
	"telemetry.event.p2p_connection.description": "Táto udalosť nám pomáha posúdiť spoľahlivosť a výkonnosť peer-to-peer pripojení medzi hráčmi. Zaznamenáva úspešnosť pripojenia, typ použitého kandidáta ICE (Interactive Connectivity Establishment - protokol, ktorý používame na nadviazanie peer-to-peer pripojenia) a čas, ktorý bol potrebný na nadviazanie spojenia.",
	"telemetry.event.p2p_connection.title": "Peer-to-peer pripojenie",
	...
	"telemetry.property.backend_failure_message.title": "Správa o zlyhaní vytvorenia backendu",
	"telemetry.property.backend_failure_missing_capabilities.title": "Chýbajúce možnosti pri zlyhaní vytvorenia backendu",
	"telemetry.property.backend_failure_reason.title": "Dôvod zlyhania vytvorenia backendu",
	"telemetry.property.backend_name.title": "Názov backendu",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "Fáza zlyhania",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Čas (v milisekundách) pre nadviazanie interaktívneho pripojenia (ICE)",
	"telemetry.property.p2p_connection_ice_path.title": "Cesta nadviazania interaktívneho pripojenia (ICE)",
	"telemetry.property.p2p_connection_local_candidate_type.title": "Typ miestneho kandidáta",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Typ vzdialeného kandidáta",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Dĺžka signalizačného pripojenia (v milisekundách)",
	"telemetry.property.p2p_connection_successful.title": "Pripojenie úspešné",
	"telemetry.property.p2p_connection_total_time_ms.title": "Celkový čas spojenia (v milisekundách)",
	...
	"telemetry_info.button.privacy_statement": "Vyhlásenie o ochrane súkromia",
	"telemetry_info.button.show_data": "Otvoriť moje dáta",
	"telemetry_info.opt_in.description": "Súhlasím s odosielaním nepovinnej telemetrie",
	...
	"test.error.block_property_mismatch": "Očakávalo sa, že vlastnosť %s bude %s, ale bola %s",
	"test.error.block_property_missing": "Vlastnosť kocky nenájdená. Očakáva sa, že vlastnosť %s je %s",
	"test.error.entity_property": "Zlyhal test entity %s: %s",
	"test.error.entity_property_details": "Zlyhal test entity %s: %s, očakávalo sa %s, ale bolo %s",
	"test.error.expected_block": "Očakávala sa kocka %s, ale našla sa kocka %s",
	"test.error.expected_block_present": "Očakávala sa prítomnosť kocky %s",
	"test.error.expected_block_tag": "Očakáva sa kocka značky #%s, ale našlo sa %s",
	"test.error.expected_container_contents": "Kocka má obsahovať predmet %s",
	"test.error.expected_container_contents_single": "Kocka má obsahovať iba jeden predmet %s",
	"test.error.expected_empty_container": "Kocka má byť prázdna",
	"test.error.expected_entity": "Očakávalo sa %s",
	"test.error.expected_entity_around": "Očakávala sa existencia %s okolo %s, %s, %s",
	"test.error.expected_entity_count": "Očakávalo sa %s entít typu %s, ale bolo nájdených %s",
	"test.error.expected_entity_data": "Očakávalo sa, že dáta entity budú %s, ale boli %s",
	"test.error.expected_entity_data_predicate": "Dáta entity nesplnili podmienku %s",
	"test.error.expected_entity_effect": "Očakávalo sa, že %s bude mať efekt %s %s",
	"test.error.expected_entity_having": "Inventár entity by mal obsahovať %s",
	"test.error.expected_entity_holding": "Entita by mala držať %s",
	"test.error.expected_entity_in_test": "Očakávala sa existencia %s v teste",
	"test.error.expected_entity_not_touching": "Neočakávala sa entita %s dotýkajúca sa %s, %s, %s (relatívne: %s, %s, %s)",
	"test.error.expected_entity_touching": "Očakávala sa entita %s dotýkajúca sa %s, %s, %s (relatívne: %s, %s, %s)",
	"test.error.expected_item": "Očakával sa predmet typu %s",
	"test.error.expected_items_count": "Očakávalo sa %s predmetov typu %s, ale bolo nájdených %s",
	"test.error.fail": "Podmienky zlyhania splnené",
	"test.error.invalid_block_type": "Nájdený neočakávaný typ kocky: %s",
	"test.error.missing_block_entity": "Kocka s dátami nenájdená",
	"test.error.not_a_block_item": "Daná kocka nie je predmet",
	"test.error.position": "%s na %s, %s, %s (relatívne: %s, %s, %s) v tiku %s",
	"test.error.sequence.condition_already_triggered": "Podmienka už bola splnená v %s",
	"test.error.sequence.condition_not_triggered": "Podmienka nebola splnená",
	"test.error.sequence.invalid_tick": "Splnenie v neplatnom tiku: očakávalo sa %s",
	"test.error.sequence.minimum_tick": "Splnenie pred očakávaným tikom: očakávalo sa čakanie %s",
	"test.error.sequence.not_completed": "Test presiahol časový limit pred dokončením sekvencie",
	"test.error.set_biome": "Nepodarilo sa nastaviť bióm pre test",
	"test.error.spawn_failure": "Nepodarilo sa vytvoriť entitu %s",
	"test.error.state_not_equal": "Nesprávny stav. Očakával sa %s, ale bol %s",
	"test.error.structure.failure": "Nepodarilo sa položiť testovaciu štruktúru pre %s",
	"test.error.tick": "%s v tiku %s",
	"test.error.ticking_without_structure": "Test bol spustený pred položením štruktúry",
	"test.error.timeout.no_result": "Neboli dosiahnuté žiadne výsledky do %s tikov",
	"test.error.timeout.no_sequences_finished": "Žiadne sekvencie neboli dokončené do %s tikov",
	"test.error.too_many_entities": "Očakávala sa existencia len jedného %s okolo %s, %s, %s, ale našlo sa %s",
	"test.error.unexpected_block": "Neočakávala sa kocka %s",
	"test.error.unexpected_entity": "Neočakávala sa existencia %s",
	"test.error.unexpected_item": "Neočakával sa predmet typu %s",
	"test.error.unknown": "Neznáma interná chyba: %s",
	"test.error.value_not_equal": "Očakávalo sa, že %s bude %s, ale hodnota bola %s",
	"test.error.value_not_in_between": "Hodnota %s sa očakávala medzi %s a %s, no bola %s",
	"test.error.wrong_block_entity": "Nesprávny typ kocky s dátami: %s",
	"test_block.error.missing": "Testovacej štruktúre chýba kocka typu %s",
	"test_block.error.too_many": "Príliš mnoho kociek typu %s",
	"test_block.invalid_timeout": "Neplatný časový limit (%s) - limit musí byť kladný počet tikov",
	"test_block.message": "Správa:",
	"test_block.mode.accept": "Prijatie",
	"test_block.mode.fail": "Zlyhanie",
	"test_block.mode.log": "Záznam",
	"test_block.mode.start": "Spustenie",
	"test_block.mode_info.accept": "Režim prijatia - prijme splnenie (časti) testu",
	"test_block.mode_info.fail": "Režim zlyhania - test zlyhá",
	"test_block.mode_info.log": "Režim záznamu - zaznamená správu",
	"test_block.mode_info.start": "Režim spustenia - počiatočný bod testovania",
	"test_instance.action.reset": "Resetovať a načítať",
	"test_instance.action.run": "Načítať a spustiť",
	"test_instance.action.save": "Uložiť štruktúru",
	"test_instance.description.batch": "Várka: %s",
	"test_instance.description.failed": "Zlyhanie: %s",
	"test_instance.description.function": "Funkcia: %s",
	"test_instance.description.invalid_id": "Neplatné ID testu",
	"test_instance.description.no_test": "Test nenájdený",
	"test_instance.description.structure": "Štruktúra: %s",
	"test_instance.description.type": "Typ: %s",
	"test_instance.type.block_based": "Test pre kocky",
	"test_instance.type.function": "Vstavaný test funkcie",
	"test_instance_block.entities": "Entity:",
	"test_instance_block.error.no_test": "Nepodarilo sa spustiť inštanciu na %s, %s, %s, pretože má nedefinovaný test",
	"test_instance_block.error.no_test_structure": "Nepodarilo sa spustiť inštanciu na %s, %s, %s, pretože nemá testovaciu štruktúru",
	"test_instance_block.error.unable_to_save": "Nepodarilo sa uložiť predlohu štruktúry pre inštanciu testu na %s, %s, %s",
	"test_instance_block.invalid": "[neplatné]",
	"test_instance_block.reset_success": "Resetovanie testu %s úspešné",
	"test_instance_block.rotation": "Otočenie:",
	"test_instance_block.size": "Veľkosť testovacej štruktúry",
	"test_instance_block.starting": "Spúšťa sa test %s",
	"test_instance_block.test_id": "ID inštancie testu",
	...
	"title.credits": "© Mojang AB. Všetky práva vyhradené.",
	"title.multiplayer.disabled": "Hra viacerých hráčov je vypnutá, skontroluj nastavenia tvojho Microsoft účtu.",
	"title.multiplayer.disabled.banned.name": "Pred hraním online si musíš zmeniť prezývku",
	...
	"title.multiplayer.online": "Hra viacerých hráčov (Online)",
	...
	"trim_material.minecraft.resin": "Živicový materiál",
	"trim_pattern.minecraft.bolt": "Ornament matice",
	...
	"trim_pattern.minecraft.flow": "Ornament toku",
	...
	"upgradeWorld.aborted.message": "Toto môže nastať, keď iný program zasahuje do súborov sveta počas aktualizácie.\nMôžeš skúsiť reštartovať zariadenie a aktualizovať znovu. Ak problém pretrváva, môžeš nám to nahlásiť.",
	"upgradeWorld.aborted.reportBug": "Nahlásiť chybu",
	"upgradeWorld.aborted.title": "Nepodarilo sa aktualizovať súbory sveta",
	"upgradeWorld.canceled.message": "Tvoj svet zostáva bez zmeny.",
	"upgradeWorld.canceled.title": "Aktualizácia sveta zrušená",
	"upgradeWorld.done": "Aktualizácia súborov sveta dokončená",
	"upgradeWorld.failed_cleanup.message": "Svet bol úspešne aktualizovaný na aktuálnu verziu a už je dostupný v zozname svetov.\nPri čistení starých údajov nastala chyba a názov priečinka sveta sa preto zmenil na %s.",
	"upgradeWorld.failed_cleanup.title": "Súbory sveta boli úspešne aktualizované",
	"upgradeWorld.info.converted": "Aktualizované: %s",
	"upgradeWorld.info.file_fix_stage": "Krok: %s/%s",
	"upgradeWorld.info.scanning": "Skenovanie súborov...",
	"upgradeWorld.info.total": "Celkom: %s",
	"upgradeWorld.joinNow": "Chceš sa pripojiť do tohto sveta?",
	"upgradeWorld.progress.percentage": "%s %%",
	"upgradeWorld.progress.type.files": "Presúvanie súborov",
	"upgradeWorld.progress.type.legacy_structures": "Aktualizovanie zastaraných štruktúr",
	"upgradeWorld.progress.type.region": "Aktualizovanie regiónov",
	"upgradeWorld.symlink.message": "Vybraný svet obsahuje symbolické odkazy.\nPotrebné kroky k aktualizovaniu súborov sveta nepodporujú použitie symbolických odkazov. Pred aktualizovaním musia byť tieto odkazy najprv odstránené.",
	"upgradeWorld.symlink.title": "Súbory sveta nie je možné aktualizovať",
	"upgradeWorld.title": "Aktualizovanie súborov sveta",
}
