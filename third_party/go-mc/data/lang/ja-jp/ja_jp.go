// Code generated by tools/gen_lang.go from 26.1/ja_jp.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "アクセシビリティ設定…",
	"accessibility.onboarding.accessibility.button.narration": "アクセシビリティ設定",
	...
	"advMode.notEnabled": "コマンドブロックが有効になっていません",
	"advMode.notEnabled.spawner": "スポナーが有効になっていません",
	"advMode.previousOutput": "前回の実行結果",
	"advMode.setCommand": "コマンドブロックが実行するコンソールコマンド",
	"advMode.setCommand.disabled": "コマンドを設定しました：%s（コマンドブロックは現在無効です）",
	...
	"advancements.adventure.blowback.description": "ブリーズの放ったウィンドチャージを打ち返して倒す",
	"advancements.adventure.blowback.title": "逆風",
	"advancements.adventure.brush_armadillo.description": "アルマジロにブラシを使い、アルマジロのウロコを手に入れる",
	"advancements.adventure.brush_armadillo.title": "可鱗でしょう？",
	...
	"advancements.adventure.crafters_crafting_crafters.description": "自動作業台が自動作業台を作る様子を観察する",
	"advancements.adventure.crafters_crafting_crafters.title": "自動作業台製自動作業台",
	...
	"advancements.adventure.heart_transplanter.description": "クリーキングの心臓を2つのペールオークの原木の間に正しい向きで配置する",
	"advancements.adventure.heart_transplanter.title": "心臓移植者",
	...
	"advancements.adventure.lighten_up.description": "斧で銅の電球の錆をとる",
	"advancements.adventure.lighten_up.title": "明るくなーれ",
	...
	"advancements.adventure.minecraft_trials_edition.description": "試練の間に足を踏み入れる",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: トライアル版",
	"advancements.adventure.ol_betsy.description": "クロスボウを撃つ",
	"advancements.adventure.ol_betsy.title": "おてんば",
	"advancements.adventure.overoverkill.description": "メイスを使って一撃でハート50個分のダメージを与える",
	"advancements.adventure.overoverkill.title": "超・やり過ぎ",
	...
	"advancements.adventure.revaulting.description": "不吉な試練の鍵を使って不吉な宝物庫を解錠する",
	"advancements.adventure.revaulting.title": "怪錠",
	...
	"advancements.adventure.spear_many_mobs.description": "槍を構えて突撃し、5体のMobを一気に貫く",
	"advancements.adventure.spear_many_mobs.title": "Mobケバブ",
	...
	"advancements.adventure.trade_at_world_height.description": "建築限界高度で村人と取引をする",
	...
	"advancements.adventure.under_lock_and_key.description": "試練の鍵を使って宝物庫を解錠する",
	"advancements.adventure.under_lock_and_key.title": "錠と鍵に隠されしもの",
	"advancements.adventure.use_lodestone.description": "コンパスの指し示す先をロードストーンに固定する",
	"advancements.adventure.use_lodestone.title": "この道をずっとゆけば",
	...
	"advancements.adventure.who_needs_rockets.description": "ウィンドチャージを使って8ブロック以上飛び上がる",
	"advancements.adventure.who_needs_rockets.title": "ロケットいらず",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "乾燥したガストを水中に設置する",
	"advancements.husbandry.place_dried_ghast_in_water.title": "水分補給を忘れずに！",
	...
	"advancements.husbandry.remove_wolf_armor.description": "ハサミを使ってオオカミから鎧を外す",
	"advancements.husbandry.remove_wolf_armor.title": "キレがいいね",
	"advancements.husbandry.repair_wolf_armor.description": "アルマジロのウロコを使って損傷したオオカミの鎧を修復する",
	"advancements.husbandry.repair_wolf_armor.title": "まるで新品",
	...
	"advancements.husbandry.safely_harvest_honey.description": "焚き火を利用して、ミツバチを怒らせずにガラス瓶にハチミツを採取する",
	"advancements.husbandry.safely_harvest_honey.title": "秘蜜の晩餐会",
	"advancements.husbandry.silk_touch_nest.description": "シルクタッチを使用して、3匹のミツバチが中に入っているミツバチの巣または養蜂箱を移動する",
	"advancements.husbandry.silk_touch_nest.title": "綿蜜な引越し",
	...
	"advancements.husbandry.uh_oh.description": "サルファーキューブにTNTブロックを吸収させる",
	"advancements.husbandry.uh_oh.title": "あ、まずい",
	...
	"advancements.husbandry.whole_pack.description": "すべての種類のオオカミを手懐ける",
	"advancements.husbandry.whole_pack.title": "ワンチーム",
	...
	"argument.anchor.invalid": "「%s」は無効なエンティティのアンカー位置です",
	...
	"argument.block.property.invalid": "ブロック%[1]sのプロパティ%[3]sに「%[2]s」は設定できません",
	...
	"argument.block.tag.disallowed": "タグは使用できません、ブロックを指定してください",
	...
	"argument.entity.selector.nearestEntity": "最も近いエンティティ",
	...
	"argument.enum.invalid": "「%s」は無効な値です",
	...
	"argument.hexcolor.invalid": "「%s」は無効な16進数カラーコードです",
	...
	"argument.item.tag.disallowed": "タグは使用できません、アイテムを指定してください",
	...
	"argument.message.too_long": "チャットメッセージが長すぎます（上限%[2]s文字に対し%[1]s文字）",
	"argument.nbt.array.invalid": "「%s」は無効な配列です",
	"argument.nbt.array.mixed": "%sを%sの中に挿入できません",
	"argument.nbt.expected.compound": "Compoundタグが必要です",
	...
	"argument.range.ints": "小数値ではなく整数値のみ入力できます",
	...
	"argument.resource_or_id.failed_to_parse": "構造の解析に失敗しました：%s",
	"argument.resource_or_id.invalid": "不正なIDあるいはタグです",
	"argument.resource_or_id.no_such_element": "レジストリ「%[2]s」の要素「%[1]s」が見つかりませんでした",
	"argument.resource_selector.not_found": "タイプ「%[2]s」のセレクター「%[1]s」に一致する要素がありません",
	...
	"argument.style.invalid": "無効なスタイルです：%s",
	"argument.time.invalid_tick_count": "ティック値は正の値である必要があります",
	"argument.time.invalid_unit": "無効な単位です",
	"argument.time.tick_count_too_low": "このティック値は%s以上でなくてはならないため、%sは適しません",
	"argument.uuid.invalid": "無効なUUIDです",
	"argument.waypoint.invalid": "選択したエンティティはウェイポイントではありません",
	...
	"arguments.item.component.expected": "アイテムコンポーネントが必要です",
	"arguments.item.component.malformed": "不正な「%s」のコンポーネントの形式です：%s",
	"arguments.item.component.repeated": "アイテムコンポーネント「%s」は一つしか指定できませんが、複数回指定されています",
	"arguments.item.component.unknown": "「%s」は不明なアイテムコンポーネントです",
	"arguments.item.malformed": "不正なアイテムの形式です：%s",
	"arguments.item.overstacked": "%sは%sまでしかスタックができません",
	"arguments.item.predicate.malformed": "不正な「%s」の条件の形式です：%s",
	"arguments.item.predicate.unknown": "「%s」は不明なアイテム条件です",
	...
	"arguments.swizzle.invalid": "「x」「y」「z」の組み合わせが必要です",
	...
	"attribute.name.air_drag_modifier": "空気抵抗係数",
	"attribute.name.armor": "防御力",
	"attribute.name.armor_toughness": "防具強度",
	"attribute.name.attack_damage": "攻撃力",
	"attribute.name.attack_knockback": "ノックバック力",
	"attribute.name.attack_speed": "攻撃速度",
	"attribute.name.below_name_distance": "ネームタグ下のスコアの表示距離",
	"attribute.name.block_break_speed": "ブロック破壊速度",
	"attribute.name.block_interaction_range": "ブロック操作範囲",
	"attribute.name.bounciness": "弾性係数",
	"attribute.name.burning_time": "炎上時間",
	"attribute.name.camera_distance": "カメラ距離",
	"attribute.name.entity_interaction_range": "エンティティ操作範囲",
	"attribute.name.explosion_knockback_resistance": "爆発ノックバック耐性",
	"attribute.name.fall_damage_multiplier": "落下ダメージ倍率",
	"attribute.name.flying_speed": "飛行速度",
	"attribute.name.follow_range": "Mobの追跡範囲",
	"attribute.name.friction_modifier": "摩擦係数",
	"attribute.name.generic.armor": "防御力",
	...
	"attribute.name.generic.block_interaction_range": "ブロック操作範囲",
	"attribute.name.generic.burning_time": "炎上時間",
	"attribute.name.generic.entity_interaction_range": "エンティティ操作範囲",
	"attribute.name.generic.explosion_knockback_resistance": "爆発ノックバック耐性",
	"attribute.name.generic.fall_damage_multiplier": "落下ダメージ倍率",
	...
	"attribute.name.generic.max_absorption": "衝撃吸収レベルの上限",
	"attribute.name.generic.max_health": "最大体力",
	"attribute.name.generic.movement_efficiency": "移動効率",
	"attribute.name.generic.movement_speed": "移動速度",
	"attribute.name.generic.oxygen_bonus": "酸素ボーナス",
	"attribute.name.generic.safe_fall_distance": "安全落下高度",
	"attribute.name.generic.scale": "サイズ",
	"attribute.name.generic.step_height": "段差上限",
	"attribute.name.generic.water_movement_efficiency": "水中移動効率",
	"attribute.name.gravity": "重力",
	"attribute.name.horse.jump_strength": "ウマの跳躍力",
	"attribute.name.jump_strength": "跳躍力",
	"attribute.name.knockback_resistance": "ノックバック耐性",
	"attribute.name.luck": "運",
	"attribute.name.max_absorption": "衝撃吸収レベルの上限",
	"attribute.name.max_health": "最大体力",
	"attribute.name.mining_efficiency": "採掘効率",
	"attribute.name.movement_efficiency": "移動効率",
	"attribute.name.movement_speed": "移動速度",
	"attribute.name.nameplate_distance": "ネームタグの表示距離",
	"attribute.name.oxygen_bonus": "酸素ボーナス",
	"attribute.name.player.block_break_speed": "ブロック破壊速度",
	"attribute.name.player.block_interaction_range": "ブロック操作範囲",
	"attribute.name.player.entity_interaction_range": "エンティティ操作範囲",
	"attribute.name.player.mining_efficiency": "採掘効率",
	"attribute.name.player.sneaking_speed": "スニーク速度",
	"attribute.name.player.submerged_mining_speed": "水中採掘速度",
	"attribute.name.player.sweeping_damage_ratio": "なぎ払いダメージの比率",
	"attribute.name.safe_fall_distance": "安全落下高度",
	"attribute.name.scale": "大きさ",
	"attribute.name.sneaking_speed": "スニーク速度",
	"attribute.name.spawn_reinforcements": "ゾンビの増援",
	"attribute.name.step_height": "段差上限",
	"attribute.name.submerged_mining_speed": "水中採掘速度",
	"attribute.name.sweeping_damage_ratio": "なぎ払いダメージの比率",
	"attribute.name.tempt_range": "Mobの誘引される範囲",
	"attribute.name.water_movement_efficiency": "水中移動効率",
	"attribute.name.waypoint_receive_range": "ウェイポイント受信距離",
	"attribute.name.waypoint_transmit_range": "ウェイポイント伝達距離",
	...
	"biome.minecraft.pale_garden": "ペールガーデン",
	...
	"biome.minecraft.sulfur_caves": "硫黄の洞窟",
	...
	"block.minecraft.acacia_shelf": "アカシアの棚",
	...
	"block.minecraft.bamboo_shelf": "竹の棚",
	...
	"block.minecraft.banner.flow.black": "黒色の渦巻き模様",
	"block.minecraft.banner.flow.blue": "青色の渦巻き模様",
	"block.minecraft.banner.flow.brown": "茶色の渦巻き模様",
	"block.minecraft.banner.flow.cyan": "青緑色の渦巻き模様",
	"block.minecraft.banner.flow.gray": "灰色の渦巻き模様",
	"block.minecraft.banner.flow.green": "緑色の渦巻き模様",
	"block.minecraft.banner.flow.light_blue": "空色の渦巻き模様",
	"block.minecraft.banner.flow.light_gray": "薄灰色の渦巻き模様",
	"block.minecraft.banner.flow.lime": "黄緑色の渦巻き模様",
	"block.minecraft.banner.flow.magenta": "赤紫色の渦巻き模様",
	"block.minecraft.banner.flow.orange": "橙色の渦巻き模様",
	"block.minecraft.banner.flow.pink": "桃色の渦巻き模様",
	"block.minecraft.banner.flow.purple": "紫色の渦巻き模様",
	"block.minecraft.banner.flow.red": "赤色の渦巻き模様",
	"block.minecraft.banner.flow.white": "白色の渦巻き模様",
	"block.minecraft.banner.flow.yellow": "黄色の渦巻き模様",
	...
	"block.minecraft.banner.globe.cyan": "青緑色の地球の模様",
	...
	"block.minecraft.banner.guster.black": "黒色の風巻く者の模様",
	"block.minecraft.banner.guster.blue": "青色の風巻く者の模様",
	"block.minecraft.banner.guster.brown": "茶色の風巻く者の模様",
	"block.minecraft.banner.guster.cyan": "青緑色の風巻く者の模様",
	"block.minecraft.banner.guster.gray": "灰色の風巻く者の模様",
	"block.minecraft.banner.guster.green": "緑色の風巻く者の模様",
	"block.minecraft.banner.guster.light_blue": "空色の風巻く者の模様",
	"block.minecraft.banner.guster.light_gray": "薄灰色の風巻く者の模様",
	"block.minecraft.banner.guster.lime": "黄緑色の風巻く者の模様",
	"block.minecraft.banner.guster.magenta": "赤紫色の風巻く者の模様",
	"block.minecraft.banner.guster.orange": "橙色の風巻く者の模様",
	"block.minecraft.banner.guster.pink": "桃色の風巻く者の模様",
	"block.minecraft.banner.guster.purple": "紫色の風巻く者の模様",
	"block.minecraft.banner.guster.red": "赤色の風巻く者の模様",
	"block.minecraft.banner.guster.white": "白色の風巻く者の模様",
	"block.minecraft.banner.guster.yellow": "黄色の風巻く者の模様",
	...
	"block.minecraft.banner.triangles_bottom.blue": "下端に青色の上向き山形波",
	...
	"block.minecraft.birch_shelf": "シラカバの棚",
	...
	"block.minecraft.black_candle_cake": "黒色のろうそくが立てられたケーキ",
	...
	"block.minecraft.blue_candle_cake": "青色のろうそくが立てられたケーキ",
	...
	"block.minecraft.brown_candle_cake": "茶色のろうそくが立てられたケーキ",
	...
	"block.minecraft.bush": "茂み",
	"block.minecraft.cactus": "サボテン",
	"block.minecraft.cactus_flower": "サボテンの花",
	...
	"block.minecraft.cherry_shelf": "サクラの棚",
	...
	"block.minecraft.chiseled_cinnabar": "模様入りの辰砂",
	"block.minecraft.chiseled_copper": "模様入りの銅",
	...
	"block.minecraft.chiseled_resin_bricks": "模様入りの樹脂レンガ",
	"block.minecraft.chiseled_sandstone": "模様入りの砂岩",
	"block.minecraft.chiseled_stone_bricks": "模様入りの石レンガ",
	"block.minecraft.chiseled_sulfur": "模様入りの硫黄",
	"block.minecraft.chiseled_tuff": "模様入りの凝灰岩",
	"block.minecraft.chiseled_tuff_bricks": "模様入りの凝灰岩レンガ",
	"block.minecraft.chorus_flower": "コーラスフラワー",
	"block.minecraft.chorus_plant": "コーラスプラント",
	"block.minecraft.cinnabar": "辰砂",
	"block.minecraft.cinnabar_brick_slab": "辰砂レンガのハーフブロック",
	"block.minecraft.cinnabar_brick_stairs": "辰砂レンガの階段",
	"block.minecraft.cinnabar_brick_wall": "辰砂レンガの塀",
	"block.minecraft.cinnabar_bricks": "辰砂レンガ",
	"block.minecraft.cinnabar_slab": "辰砂のハーフブロック",
	"block.minecraft.cinnabar_stairs": "辰砂の階段",
	"block.minecraft.cinnabar_wall": "辰砂の塀",
	"block.minecraft.clay": "粘土",
	"block.minecraft.closed_eyeblossom": "閉じたヒトミソウ",
	...
	"block.minecraft.copper_bars": "銅格子",
	"block.minecraft.copper_block": "銅ブロック",
	"block.minecraft.copper_bulb": "銅の電球",
	"block.minecraft.copper_chain": "銅の鎖",
	"block.minecraft.copper_chest": "銅のチェスト",
	"block.minecraft.copper_door": "銅のドア",
	"block.minecraft.copper_golem_statue": "カッパーゴーレムの像",
	"block.minecraft.copper_grate": "銅の金網",
	"block.minecraft.copper_lantern": "銅のランタン",
	"block.minecraft.copper_ore": "銅鉱石",
	"block.minecraft.copper_torch": "銅の松明",
	"block.minecraft.copper_trapdoor": "銅のトラップドア",
	"block.minecraft.copper_wall_torch": "壁に付けられた銅の松明",
	...
	"block.minecraft.cracked_polished_blackstone_bricks": "ひび割れた磨かれたブラックストーンレンガ",
	"block.minecraft.cracked_stone_bricks": "ひび割れた石レンガ",
	"block.minecraft.crafter": "自動作業台",
	"block.minecraft.crafting_table": "作業台",
	"block.minecraft.creaking_heart": "クリーキングの心臓",
	...
	"block.minecraft.crimson_shelf": "真紅の棚",
	...
	"block.minecraft.cyan_candle_cake": "青緑色のろうそくが立てられたケーキ",
	...
	"block.minecraft.dark_oak_shelf": "ダークオークの棚",
	...
	"block.minecraft.dried_ghast": "乾燥したガスト",
	...
	"block.minecraft.exposed_chiseled_copper": "風化した模様入りの銅",
	"block.minecraft.exposed_copper": "風化した銅",
	"block.minecraft.exposed_copper_bars": "風化した銅格子",
	"block.minecraft.exposed_copper_bulb": "風化した銅の電球",
	"block.minecraft.exposed_copper_chain": "風化した銅の鎖",
	"block.minecraft.exposed_copper_chest": "風化した銅のチェスト",
	"block.minecraft.exposed_copper_door": "風化した銅のドア",
	"block.minecraft.exposed_copper_golem_statue": "風化したカッパーゴーレムの像",
	"block.minecraft.exposed_copper_grate": "風化した銅の金網",
	"block.minecraft.exposed_copper_lantern": "風化した銅のランタン",
	"block.minecraft.exposed_copper_trapdoor": "風化した銅のトラップドア",
	...
	"block.minecraft.exposed_lightning_rod": "風化した避雷針",
	...
	"block.minecraft.firefly_bush": "ホタルの茂み",
	...
	"block.minecraft.golden_dandelion": "金のタンポポ",
	...
	"block.minecraft.gray_candle_cake": "灰色のろうそくが立てられたケーキ",
	...
	"block.minecraft.green_candle_cake": "緑色のろうそくが立てられたケーキ",
	...
	"block.minecraft.heavy_core": "ヘビーコア",
	...
	"block.minecraft.iron_chain": "鉄の鎖",
	...
	"block.minecraft.jungle_shelf": "ジャングルの棚",
	...
	"block.minecraft.leaf_litter": "落ち葉",
	...
	"block.minecraft.light_blue_candle_cake": "空色のろうそくが立てられたケーキ",
	...
	"block.minecraft.light_gray_candle_cake": "薄灰色のろうそくが立てられたケーキ",
	...
	"block.minecraft.lime_candle_cake": "黄緑色のろうそくが立てられたケーキ",
	...
	"block.minecraft.magenta_candle_cake": "赤紫色のろうそくが立てられたケーキ",
	...
	"block.minecraft.mangrove_shelf": "マングローブの棚",
	...
	"block.minecraft.oak_shelf": "オークの棚",
	...
	"block.minecraft.oxidized_chiseled_copper": "酸化した模様入りの銅",
	"block.minecraft.oxidized_copper": "酸化した銅",
	"block.minecraft.oxidized_copper_bars": "酸化した銅格子",
	"block.minecraft.oxidized_copper_bulb": "酸化した銅の電球",
	"block.minecraft.oxidized_copper_chain": "酸化した銅の鎖",
	"block.minecraft.oxidized_copper_chest": "酸化した銅のチェスト",
	"block.minecraft.oxidized_copper_door": "酸化した銅のドア",
	"block.minecraft.oxidized_copper_golem_statue": "酸化したカッパーゴーレムの像",
	"block.minecraft.oxidized_copper_grate": "酸化した銅の金網",
	"block.minecraft.oxidized_copper_lantern": "酸化した銅のランタン",
	"block.minecraft.oxidized_copper_trapdoor": "酸化した銅のトラップドア",
	...
	"block.minecraft.oxidized_lightning_rod": "酸化した避雷針",
	"block.minecraft.packed_ice": "氷塊",
	"block.minecraft.packed_mud": "固めた泥",
	"block.minecraft.pale_hanging_moss": "色あせた垂れ苔",
	"block.minecraft.pale_moss_block": "色あせた苔ブロック",
	"block.minecraft.pale_moss_carpet": "色あせた苔のカーペット",
	"block.minecraft.pale_oak_button": "ペールオークのボタン",
	"block.minecraft.pale_oak_door": "ペールオークのドア",
	"block.minecraft.pale_oak_fence": "ペールオークのフェンス",
	"block.minecraft.pale_oak_fence_gate": "ペールオークのフェンスゲート",
	"block.minecraft.pale_oak_hanging_sign": "ペールオークの吊り看板",
	"block.minecraft.pale_oak_leaves": "ペールオークの葉",
	"block.minecraft.pale_oak_log": "ペールオークの原木",
	"block.minecraft.pale_oak_planks": "ペールオークの板材",
	"block.minecraft.pale_oak_pressure_plate": "ペールオークの感圧板",
	"block.minecraft.pale_oak_sapling": "ペールオークの苗木",
	"block.minecraft.pale_oak_shelf": "ペールオークの棚",
	"block.minecraft.pale_oak_sign": "ペールオークの看板",
	"block.minecraft.pale_oak_slab": "ペールオークのハーフブロック",
	"block.minecraft.pale_oak_stairs": "ペールオークの階段",
	"block.minecraft.pale_oak_trapdoor": "ペールオークのトラップドア",
	"block.minecraft.pale_oak_wall_hanging_sign": "壁に付けられたペールオークの吊り看板",
	"block.minecraft.pale_oak_wall_sign": "壁に付けられたペールオークの看板",
	"block.minecraft.pale_oak_wood": "ペールオークの木",
	...
	"block.minecraft.pink_candle_cake": "桃色のろうそくが立てられたケーキ",
	...
	"block.minecraft.pitcher_crop": "ウツボカズラ",
	...
	"block.minecraft.polished_cinnabar": "磨かれた辰砂",
	"block.minecraft.polished_cinnabar_slab": "磨かれた辰砂のハーフブロック",
	"block.minecraft.polished_cinnabar_stairs": "磨かれた辰砂の階段",
	"block.minecraft.polished_cinnabar_wall": "磨かれた辰砂の塀",
	...
	"block.minecraft.polished_sulfur": "磨かれた硫黄",
	"block.minecraft.polished_sulfur_slab": "磨かれた硫黄のハーフブロック",
	"block.minecraft.polished_sulfur_stairs": "磨かれた硫黄の階段",
	"block.minecraft.polished_sulfur_wall": "磨かれた硫黄の塀",
	"block.minecraft.polished_tuff": "磨かれた凝灰岩",
	"block.minecraft.polished_tuff_slab": "磨かれた凝灰岩のハーフブロック",
	"block.minecraft.polished_tuff_stairs": "磨かれた凝灰岩の階段",
	"block.minecraft.polished_tuff_wall": "磨かれた凝灰岩の塀",
	"block.minecraft.poppy": "ポピー",
	"block.minecraft.potatoes": "ジャガイモ",
	"block.minecraft.potent_sulfur": "強力な硫黄",
	"block.minecraft.potted_acacia_sapling": "アカシアの苗木入り植木鉢",
	"block.minecraft.potted_allium": "アリウム入り植木鉢",
	"block.minecraft.potted_azalea_bush": "ツツジ入り植木鉢",
	"block.minecraft.potted_azure_bluet": "ヒナソウ入り植木鉢",
	"block.minecraft.potted_bamboo": "竹入り植木鉢",
	"block.minecraft.potted_birch_sapling": "シラカバの苗木入り植木鉢",
	"block.minecraft.potted_blue_orchid": "ヒスイラン入り植木鉢",
	"block.minecraft.potted_brown_mushroom": "茶色のキノコ入り植木鉢",
	"block.minecraft.potted_cactus": "サボテン入り植木鉢",
	"block.minecraft.potted_cherry_sapling": "サクラの苗木入り植木鉢",
	"block.minecraft.potted_closed_eyeblossom": "閉じたヒトミソウ入り植木鉢",
	"block.minecraft.potted_cornflower": "ヤグルマギク入り植木鉢",
	"block.minecraft.potted_crimson_fungus": "真紅のキノコ入り植木鉢",
	"block.minecraft.potted_crimson_roots": "真紅の根入り植木鉢",
	"block.minecraft.potted_dandelion": "タンポポ入り植木鉢",
	"block.minecraft.potted_dark_oak_sapling": "ダークオークの苗木入り植木鉢",
	"block.minecraft.potted_dead_bush": "枯れ木入り植木鉢",
	"block.minecraft.potted_fern": "シダ入り植木鉢",
	"block.minecraft.potted_flowering_azalea_bush": "開花したツツジ入り植木鉢",
	"block.minecraft.potted_golden_dandelion": "金のタンポポ入り植木鉢",
	"block.minecraft.potted_jungle_sapling": "ジャングルの苗木入り植木鉢",
	"block.minecraft.potted_lily_of_the_valley": "スズラン入り植木鉢",
	"block.minecraft.potted_mangrove_propagule": "マングローブの芽入り植木鉢",
	"block.minecraft.potted_oak_sapling": "オークの苗木入り植木鉢",
	"block.minecraft.potted_open_eyeblossom": "開いたヒトミソウ入り植木鉢",
	"block.minecraft.potted_orange_tulip": "橙色のチューリップ入り植木鉢",
	"block.minecraft.potted_oxeye_daisy": "フランスギク入り植木鉢",
	"block.minecraft.potted_pale_oak_sapling": "ペールオークの苗木入り植木鉢",
	"block.minecraft.potted_pink_tulip": "桃色のチューリップ入り植木鉢",
	"block.minecraft.potted_poppy": "ポピー入り植木鉢",
	"block.minecraft.potted_red_mushroom": "赤色のキノコ入り植木鉢",
	"block.minecraft.potted_red_tulip": "赤色のチューリップ入り植木鉢",
	"block.minecraft.potted_spruce_sapling": "トウヒの苗木入り植木鉢",
	"block.minecraft.potted_torchflower": "トーチフラワー入り植木鉢",
	"block.minecraft.potted_warped_fungus": "歪んだキノコ入り植木鉢",
	"block.minecraft.potted_warped_roots": "歪んだ根入り植木鉢",
	"block.minecraft.potted_white_tulip": "白色のチューリップ入り植木鉢",
	"block.minecraft.potted_wither_rose": "ウィザーローズ入り植木鉢",
	...
	"block.minecraft.purple_candle_cake": "紫色のろうそくが立てられたケーキ",
	...
	"block.minecraft.red_candle_cake": "赤色のろうそくが立てられたケーキ",
	...
	"block.minecraft.resin_block": "樹脂ブロック",
	"block.minecraft.resin_brick_slab": "樹脂レンガのハーフブロック",
	"block.minecraft.resin_brick_stairs": "樹脂レンガの階段",
	"block.minecraft.resin_brick_wall": "樹脂レンガの塀",
	"block.minecraft.resin_bricks": "樹脂レンガ",
	"block.minecraft.resin_clump": "樹脂の塊",
	...
	"block.minecraft.short_dry_grass": "背の低い枯れ草",
	"block.minecraft.short_grass": "背の低い草",
	...
	"block.minecraft.spruce_shelf": "トウヒの棚",
	...
	"block.minecraft.stripped_pale_oak_log": "樹皮を剥いだペールオークの原木",
	"block.minecraft.stripped_pale_oak_wood": "樹皮を剥いだペールオークの木",
	...
	"block.minecraft.sulfur": "硫黄",
	"block.minecraft.sulfur_brick_slab": "硫黄レンガのハーフブロック",
	"block.minecraft.sulfur_brick_stairs": "硫黄レンガの階段",
	"block.minecraft.sulfur_brick_wall": "硫黄レンガの塀",
	"block.minecraft.sulfur_bricks": "硫黄レンガ",
	"block.minecraft.sulfur_slab": "硫黄のハーフブロック",
	"block.minecraft.sulfur_spike": "尖った硫黄",
	"block.minecraft.sulfur_stairs": "硫黄の階段",
	"block.minecraft.sulfur_wall": "硫黄の塀",
	...
	"block.minecraft.tall_dry_grass": "背の高い枯れ草",
	...
	"block.minecraft.test_block": "テストブロック",
	"block.minecraft.test_instance_block": "テストインスタンスブロック",
	"block.minecraft.tinted_glass": "遮光ガラス",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "TNTの爆発は無効化されています",
	...
	"block.minecraft.trial_spawner": "試練のスポナー",
	...
	"block.minecraft.tuff_brick_slab": "凝灰岩レンガのハーフブロック",
	"block.minecraft.tuff_brick_stairs": "凝灰岩レンガの階段",
	"block.minecraft.tuff_brick_wall": "凝灰岩レンガの塀",
	"block.minecraft.tuff_bricks": "凝灰岩レンガ",
	"block.minecraft.tuff_slab": "凝灰岩のハーフブロック",
	"block.minecraft.tuff_stairs": "凝灰岩の階段",
	"block.minecraft.tuff_wall": "凝灰岩の塀",
	"block.minecraft.turtle_egg": "カメの卵",
	"block.minecraft.twisting_vines": "ねじれツタ",
	"block.minecraft.twisting_vines_plant": "ねじれツタのつる",
	"block.minecraft.vault": "宝物庫",
	...
	"block.minecraft.warped_shelf": "歪んだ棚",
	...
	"block.minecraft.waxed_chiseled_copper": "錆止めされた模様入りの銅",
	"block.minecraft.waxed_copper_bars": "錆止めされた銅格子",
	"block.minecraft.waxed_copper_block": "錆止めされた銅ブロック",
	"block.minecraft.waxed_copper_bulb": "錆止めされた銅の電球",
	"block.minecraft.waxed_copper_chain": "錆止めされた銅の鎖",
	"block.minecraft.waxed_copper_chest": "錆止めされた銅のチェスト",
	"block.minecraft.waxed_copper_door": "錆止めされた銅のドア",
	"block.minecraft.waxed_copper_golem_statue": "錆止めされたカッパーゴーレムの像",
	"block.minecraft.waxed_copper_grate": "錆止めされた銅の金網",
	"block.minecraft.waxed_copper_lantern": "錆止めされた銅のランタン",
	"block.minecraft.waxed_copper_trapdoor": "錆止めされた銅のトラップドア",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "錆止めされた風化した模様入りの銅",
	"block.minecraft.waxed_exposed_copper": "錆止めされた風化した銅",
	"block.minecraft.waxed_exposed_copper_bars": "錆止めされた風化した銅格子",
	"block.minecraft.waxed_exposed_copper_bulb": "錆止めされた風化した銅の電球",
	"block.minecraft.waxed_exposed_copper_chain": "錆止めされた風化した銅の鎖",
	"block.minecraft.waxed_exposed_copper_chest": "錆止めされた風化した銅のチェスト",
	"block.minecraft.waxed_exposed_copper_door": "錆止めされた風化した銅のドア",
	"block.minecraft.waxed_exposed_copper_golem_statue": "錆止めされた風化したカッパーゴーレムの像",
	"block.minecraft.waxed_exposed_copper_grate": "錆止めされた風化した銅の金網",
	"block.minecraft.waxed_exposed_copper_lantern": "錆止めされた風化した銅のランタン",
	"block.minecraft.waxed_exposed_copper_trapdoor": "錆止めされた風化した銅のトラップドア",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "錆止めされた風化した避雷針",
	"block.minecraft.waxed_lightning_rod": "錆止めされた避雷針",
	"block.minecraft.waxed_oxidized_chiseled_copper": "錆止めされた酸化した模様入りの銅",
	"block.minecraft.waxed_oxidized_copper": "錆止めされた酸化した銅",
	"block.minecraft.waxed_oxidized_copper_bars": "錆止めされた酸化した銅格子",
	"block.minecraft.waxed_oxidized_copper_bulb": "錆止めされた酸化した銅の電球",
	"block.minecraft.waxed_oxidized_copper_chain": "錆止めされた酸化した銅の鎖",
	"block.minecraft.waxed_oxidized_copper_chest": "錆止めされた酸化した銅のチェスト",
	"block.minecraft.waxed_oxidized_copper_door": "錆止めされた酸化した銅のドア",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "錆止めされた酸化したカッパーゴーレムの像",
	"block.minecraft.waxed_oxidized_copper_grate": "錆止めされた酸化した銅の金網",
	"block.minecraft.waxed_oxidized_copper_lantern": "錆止めされた酸化した銅のランタン",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "錆止めされた酸化した銅のトラップドア",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "錆止めされた酸化した避雷針",
	"block.minecraft.waxed_weathered_chiseled_copper": "錆止めされた錆びた模様入りの銅",
	"block.minecraft.waxed_weathered_copper": "錆止めされた錆びた銅",
	"block.minecraft.waxed_weathered_copper_bars": "錆止めされた錆びた銅格子",
	"block.minecraft.waxed_weathered_copper_bulb": "錆止めされた錆びた銅の電球",
	"block.minecraft.waxed_weathered_copper_chain": "錆止めされた錆びた銅の鎖",
	"block.minecraft.waxed_weathered_copper_chest": "錆止めされた錆びた銅のチェスト",
	"block.minecraft.waxed_weathered_copper_door": "錆止めされた錆びた銅のドア",
	"block.minecraft.waxed_weathered_copper_golem_statue": "錆止めされた錆びたカッパーゴーレムの像",
	"block.minecraft.waxed_weathered_copper_grate": "錆止めされた錆びた銅の金網",
	"block.minecraft.waxed_weathered_copper_lantern": "錆止めされた錆びた銅のランタン",
	"block.minecraft.waxed_weathered_copper_trapdoor": "錆止めされた錆びた銅のトラップドア",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "錆止めされた錆びた避雷針",
	"block.minecraft.weathered_chiseled_copper": "錆びた模様入りの銅",
	"block.minecraft.weathered_copper": "錆びた銅",
	"block.minecraft.weathered_copper_bars": "錆びた銅格子",
	"block.minecraft.weathered_copper_bulb": "錆びた銅の電球",
	"block.minecraft.weathered_copper_chain": "錆びた銅の鎖",
	"block.minecraft.weathered_copper_chest": "錆びた銅のチェスト",
	"block.minecraft.weathered_copper_door": "錆びた銅のドア",
	"block.minecraft.weathered_copper_golem_statue": "錆びたカッパーゴーレムの像",
	"block.minecraft.weathered_copper_grate": "錆びた銅の金網",
	"block.minecraft.weathered_copper_lantern": "錆びた銅のランタン",
	"block.minecraft.weathered_copper_trapdoor": "錆びた銅のトラップドア",
	...
	"block.minecraft.weathered_lightning_rod": "錆びた避雷針",
	...
	"block.minecraft.white_candle_cake": "白色のろうそくが立てられたケーキ",
	...
	"block.minecraft.wildflowers": "野花",
	...
	"block.minecraft.yellow_candle_cake": "黄色のろうそくが立てられたケーキ",
	...
	"book.page_button.next": "次のページ",
	"book.page_button.previous": "前のページ",
	"book.sign.title": "本の署名画面",
	"book.sign.titlebox": "タイトル",
	"book.signButton": "署名",
	"book.view.title": "本の閲覧画面",
	"build.spawn_protection": "%sはリスポーン地点の保護下にあります",
	"build.tooHigh": "建築高度上限は%sです",
	"build.tooLow": "建築高度下限は%sです",
	...
	"chat.disabled.invalid_command_signature": "コマンドに予期しない引数のシグネチャーあるいは欠落した引数のシグネチャーがあります。",
	"chat.disabled.invalid_signature": "チャットに無効な署名が含まれています。再接続してください。",
	...
	"chat.disabled.out_of_order_chat": "受け取ったチャットの順序が乱れています。システムの時間が変更されていませんか？",
	...
	"chat.queue.tooltip": "クリックして次のメッセージを表示します",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "サーバーが無効なメッセージを送信しました。",
	"chat.tag.modified": "このメッセージはサーバーによって変更されています。原文：",
	"chat.tag.not_secure": "安全性が確認されていないメッセージです。このメッセージを報告することはできません。",
	...
	"chat.validation_error": "チャットの検証エラー",
	"chat_restriction.chat_and_commands_disabled_by_options": "クライアント側の設定でチャットが制限されています。",
	"chat_restriction.chat_disabled_by_options": "プレイヤーのチャットがクライアント側の設定によって制限されています。",
	"chat_restriction.chat_disabled_by_options.action": "チャット設定へ移動",
	"chat_restriction.disabled_by_launcher": "ランチャー側でチャットが制限されています",
	"chat_restriction.disabled_by_profile": "プロフィール設定でチャットが制限されています。",
	"chat_restriction.disabled_by_profile.action": "プロフィール設定へ移動",
	"chat_screen.commands_not_allowed": "コマンドの送信は許可されていません",
	"chat_screen.message": "メッセージ送信内容：%s",
	"chat_screen.messages_not_allowed": "チャットメッセージの送信は許可されていません",
	"chat_screen.restricted": "チャットが制限されています。詳細を確認するには、このメッセージをクリックしてください。",
	"chat_screen.restricted.narration": "チャットが制限されています。ここからワールド設定の「制限」画面に移動できます。",
	"chat_screen.title": "チャット画面",
	"chat_screen.usage": "メッセージを入力し、Enterキーを押して送信",
	"chunk.toast.checkLog": "詳細はログをご確認ください",
	"chunk.toast.loadFailure": "%sにあるチャンクの読み込みに失敗しました",
	"chunk.toast.lowDiskSpace": "ディスクの空き容量が不足しています！",
	"chunk.toast.lowDiskSpace.description": "ワールドを保存できない可能性があります。",
	"chunk.toast.saveFailure": "%sにあるチャンクの保存に失敗しました",
	...
	"command.forkLimit": "実行文脈数の上限（%s）に達しました",
	"command.trailing_data": "末尾の余分なデータが検出されました：%s",
	...
	"commands.attribute.base_value.reset.success": "エンティティ「%[2]s」の属性「%[1]s」の基本値をデフォルト値「%[3]s」に戻しました",
	"commands.attribute.base_value.set.success": "エンティティ%sの属性%sの基本値を%sに設定しました",
	...
	"commands.banlist.entry.unknown": "（不明）",
	...
	"commands.damage.invulnerable": "指定のダメージタイプは対象には効果がありません",
	...
	"commands.datapack.create.already_exists": "名前「%s」のパックはすでに存在します",
	"commands.datapack.create.invalid_full_name": "「%s」は無効なパック名です",
	"commands.datapack.create.invalid_name": "新しいパック名「%s」に使用できない文字があります",
	"commands.datapack.create.io_failure": "名前「%s」としてパックを作成できません。ログを確認してください",
	"commands.datapack.create.metadata_encode_failure": "名前「%s」のパック用メタデータのエンコードに失敗しました：%s",
	"commands.datapack.create.success": "新しい空のパックを、名前「%s」として作成しました",
	"commands.datapack.disable.failed": "データパック「%s」は有効ではありません",
	"commands.datapack.disable.failed.feature": "有効化されたフラグの一部であるため、パック「%s」は無効化できません！",
	...
	"commands.debug.function.noReturnRun": "return runを含む関数の追跡はできません",
	...
	"commands.dialog.clear.multiple": "%s人のプレイヤーからダイアログを消去しました",
	"commands.dialog.clear.single": "%sからダイアログを消去しました",
	"commands.dialog.show.multiple": "%s人のプレイヤーにダイアログを表示しました",
	"commands.dialog.show.single": "%sにダイアログを表示しました",
	...
	"commands.drop.no_loot_table.block": "ブロック「%s」にはルートテーブルがありません",
	...
	"commands.execute.function.instantiationFailure": "関数「%s」への変数の代入に失敗しました：%s",
	...
	"commands.fetchprofile.copy_component": "コンポーネントをコピー",
	"commands.fetchprofile.copy_text": "%sをコピー",
	"commands.fetchprofile.entity.success": "エンティティ%sのプロファイルを解釈しました：%s",
	"commands.fetchprofile.failed_to_serialize": "プロファイルのシリアライズに失敗しました：%s",
	"commands.fetchprofile.give_item": "アイテムを取得",
	"commands.fetchprofile.id.failure": "ID %sのプロファイルの解釈に失敗しました",
	"commands.fetchprofile.id.success": "ID %sのプロファイルを解釈しました：%s",
	"commands.fetchprofile.name.failure": "プレイヤー名%sのプロファイルの解釈に失敗しました",
	"commands.fetchprofile.name.success": "プレイヤー名%sのプロファイルを解釈しました：%s",
	"commands.fetchprofile.no_profile": "エンティティ%sにはプロファイルがありません",
	"commands.fetchprofile.summon_mannequin": "マネキンを召喚",
	...
	"commands.forceload.list.multiple": "%[2]s内に強制的に読み込まれるチャンクが%[1]s個見つかりました：%[3]s",
	...
	"commands.function.error.argument_not_compound": "%sは無効な引数のタイプです。ここには複合型が必要です",
	"commands.function.error.missing_argument": "関数「%[1]s」に引数%[2]sが不足しています",
	"commands.function.error.missing_arguments": "関数「%s」に引数が不足しています",
	"commands.function.error.parse": "マクロ「%[1]s」の変数に値を代入する過程でコマンド「%[2]s」にエラーが発生しました：%[3]s",
	"commands.function.instantiationFailure": "関数「%s」への変数の代入に失敗しました：%s",
	"commands.function.result": "関数「%s」が戻り値%sを返しました",
	"commands.function.scheduled.multiple": "関数「%s」を実行中です",
	"commands.function.scheduled.no_functions": "「%s」という名前の関数が見つかりませんでした",
	"commands.function.scheduled.single": "関数「%s」を実行中です",
	...
	"commands.kick.owner.failed": "LANゲームではサーバーの所有者を退出させることはできません",
	"commands.kick.singleplayer.failed": "オフラインのシングルプレイではプレイヤーを退出させることはできません",
	...
	"commands.locate.biome.not_found": "所定の距離内に「%s」で指定されたバイオームは見つかりませんでした",
	...
	"commands.locate.structure.invalid": "「%s」という種類の構造物は存在しません",
	...
	"commands.place.structure.invalid": "「%s」という種類の構造物は存在しません",
	"commands.place.structure.success": "構造物「%s」を%s, %s, %sに生成しました",
	"commands.place.template.failed": "テンプレートの配置に失敗しました",
	...
	"commands.profile_fetch.copy_component": "コンポーネントをコピー",
	"commands.profile_fetch.failed_to_serialize": "プロファイルのシリアライズに失敗しました：%s",
	"commands.profile_fetch.give_item": "アイテムを取得",
	"commands.profile_fetch.id.failure": "ID %sのプロファイルの解釈に失敗しました",
	"commands.profile_fetch.id.success": "ID %sのプロファイルを解釈しました：%s",
	"commands.profile_fetch.name.failure": "プレイヤー名%sのプロファイルの解釈に失敗しました",
	"commands.profile_fetch.name.success": "プレイヤー名%sのプロファイルを解釈しました：%s",
	"commands.publish.alreadyPublished": "マルチプレイは既にポート%sで開始されています",
	"commands.publish.alreadyPublished.lan": "既にローカルゲームがポート%sでホストされています",
	"commands.publish.alreadyPublished.online": "既にオンラインゲームがホストされています",
	"commands.publish.failed": "ローカルゲームをホストできません",
	"commands.publish.started": "ポート%sでローカルゲームをホストしました",
	"commands.publish.started.lan": "ポート%sでローカルゲームをホストしました",
	"commands.publish.started.online": "オンラインゲームをホストしました",
	"commands.publish.success": "ポート%sでマルチプレイが開始されました",
	"commands.random.error.range_too_large": "乱数の範囲は2147483646以下である必要があります",
	"commands.random.error.range_too_small": "乱数の範囲は2以上である必要があります",
	"commands.random.reset.all.success": "%s個の乱数列をリセットしました",
	"commands.random.reset.success": "乱数列%sをリセットしました",
	"commands.random.roll": "%sは%sを引きました（値の範囲は%sから%s）",
	"commands.random.sample.success": "乱数：%s",
	...
	"commands.rotate.success": "%sを回転させました",
	"commands.save.alreadyOff": "オートセーブは既に無効です",
	"commands.save.alreadyOn": "オートセーブは既に有効です",
	...
	"commands.schedule.cleared.failure": "ID「%s」のスケジュールはありません",
	"commands.schedule.cleared.success": "ID「%s」のスケジュールを%s個削除しました",
	...
	"commands.schedule.macro": "マクロ関数は実行予約できません",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "オブジェクト%sの表示の自動更新を無効化しました",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "オブジェクト%sの表示の自動更新を有効化しました",
	"commands.scoreboard.objectives.modify.displayname": "オブジェクト%sの表示名を%sに変更しました",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "オブジェクト%sにおけるデフォルトの数値表示形式を消去しました",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "オブジェクト%sにおけるデフォルトの数値表示形式を変更しました",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "%[2]s内の%[1]s体のエンティティの表示名を消去しました",
	"commands.scoreboard.players.display.name.clear.success.single": "%[2]s内での%[1]sの表示名を変更しました",
	"commands.scoreboard.players.display.name.set.success.multiple": "%[3]s内の%[2]s体のエンティティの表示名を%[1]sに変更しました",
	"commands.scoreboard.players.display.name.set.success.single": "%[3]s内での%[2]sの表示名を%[1]sに変更しました",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "%[2]s内の%[1]s体のエンティティの数値表示形式を消去しました",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "%[2]s内での%[1]sの数値表示形式を消去しました",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "%[2]s内の%[1]s体のエンティティの数値表示形式を変更しました",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "%[2]s内での%[1]sの数値表示形式を変更しました",
	...
	"commands.scoreboard.players.get.success": "%[1]sの%[3]sの値は%[2]sです",
	...
	"commands.setidletimeout.success.disabled": "無操作時のタイムアウトが無効化されました",
	"commands.setworldspawn.failure.not_overworld": "ワールドのスポーン地点はオーバーワールドにのみ設定できます",
	"commands.setworldspawn.success": "%s, %s, %s [%s]をワールドのスポーン地点に設定しました",
	"commands.setworldspawn.success.new": "%[6]sでのワールドのスポーン地点を%[1]s, %[2]s, %[3]s [%[4]s, %[5]s]に設定しました",
	"commands.spawnpoint.success.multiple": "%[6]s人のプレイヤーの%[5]sでのスポーン地点を%[1]s, %[2]s, %[3]s [%[4]s]に設定しました",
	"commands.spawnpoint.success.multiple.new": "%[7]s人のプレイヤーの%[6]sでのスポーン地点を%[1]s, %[2]s, %[3]s [%[4]s, %[5]s] に設定しました",
	"commands.spawnpoint.success.single": "%[6]sの%[5]sでのスポーン地点を%[1]s, %[2]s, %[3]s [%[4]s]に設定しました",
	"commands.spawnpoint.success.single.new": "%[7]sの%[6]sでのスポーン地点を%[1]s, %[2]s, %[3]s [%[4]s, %[5]s] に設定しました",
	"commands.spectate.cannot_spectate": "%sを観察することはできません",
	...
	"commands.spreadplayers.success.teams": "%s個のチームを%s, %sを中心に平均%sブロックの範囲で散開しました",
	...
	"commands.stopwatch.already_exists": "「%s」というストップウォッチは既に存在します",
	"commands.stopwatch.create.success": "ストップウォッチ「%s」を作成しました",
	"commands.stopwatch.does_not_exist": "「%s」というストップウォッチは存在しません",
	"commands.stopwatch.query": "ストップウォッチ「%s」の現在の値は%s秒です",
	"commands.stopwatch.remove.success": "ストップウォッチ「%s」を削除しました",
	"commands.stopwatch.restart.success": "ストップウォッチ「%s」を再始動しました",
	"commands.summon.failed": "エンティティを召喚できませんでした",
	"commands.summon.failed.peaceful": "難易度ピースフルではモンスターは召喚できません",
	...
	"commands.swing.failed.notliving": "腕を振らせたい生物エンティティが見つかりませんでした",
	"commands.swing.success.multiple": "%s体のエンティティの腕を振らせました",
	"commands.swing.success.single": "%sの腕を振らせました",
	...
	"commands.team.empty.success": "%s人のメンバーをチーム%sから削除しました",
	...
	"commands.team.option.color.clear.success": "チーム%sの色を消去しました",
	...
	"commands.test.batch.starting": "環境%sのバッチ%sを開始します",
	"commands.test.clear.error.no_tests": "削除するテストが見つかりませんでした",
	"commands.test.clear.success": "%s個の構造物を消去しました",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "クリックしてクリップボードにコピー",
	"commands.test.create.success": "テスト%sのセットアップを作成しました",
	"commands.test.error.no_test_containing_pos": "%s, %s, %sを含むテストインスタンスがありません",
	"commands.test.error.no_test_instances": "テストインスタンスが見つかりませんでした",
	"commands.test.error.non_existant_test": "テスト%sが見つかりませんでした",
	"commands.test.error.structure_not_found": "テスト構造物%sが見つかりませんでした",
	"commands.test.error.test_instance_not_found": "テストインスタンスブロックエンティティが見つかりませんでした",
	"commands.test.error.test_instance_not_found.position": "%s, %s, %sを含むテストにテストインスタンスブロックエンティティが見つかりませんでした",
	"commands.test.error.too_large": "構造物のサイズはすべての軸で%sブロック以内でなければいけません",
	"commands.test.locate.done": "捜索が完了し、%s個の構造物が見つかりました",
	"commands.test.locate.found": "構造物が%sに見つかりました（距離：%s）",
	"commands.test.locate.started": "テスト構造物の捜索を開始します。これにはしばらくかかる場合があります…",
	"commands.test.no_tests": "実行するテストがありません",
	"commands.test.relative_position": "%sからの相対位置：%s",
	"commands.test.reset.error.no_tests": "リセットするテストが見つかりませんでした",
	"commands.test.reset.success": "%s個の構造物をリセットしました",
	"commands.test.run.no_tests": "テストが見つかりませんでした",
	"commands.test.run.running": "%s件のテストを実行中です…",
	"commands.test.summary": "ゲームテストが完了しました。%s件のテストが実行されました",
	"commands.test.summary.all_required_passed": "すべての必須テストが通過しました (`･ω･´)",
	"commands.test.summary.failed": "%s件の必須テストが失敗しました (´･ω･`)",
	"commands.test.summary.optional_failed": "%s件の任意テストが失敗しました",
	"commands.tick.query.percentiles": "パーセンタイル：P50：%sミリ秒、P95：%sミリ秒、P99：%sミリ秒、サンプル数：%s",
	"commands.tick.query.rate.running": "対象のティック速度：%sティック／秒\n1ティックの平均所要時間：%sミリ秒（対象：%sミリ秒）",
	"commands.tick.query.rate.sprinting": "対象のティック速度：毎秒%sティック（無視、参照のみ）\n1ティックの平均所要時間：%sミリ秒",
	"commands.tick.rate.success": "対象のティック速度を%sティック毎秒に設定しました",
	"commands.tick.sprint.report": "ティック速度無制限での処理は、%sティック毎秒、または1ティック当たり%sミリ秒で完了しました",
	"commands.tick.sprint.stop.fail": "ティック速度無制限での処理が行われていません",
	"commands.tick.sprint.stop.success": "ティック速度無制限での処理を中断しました",
	"commands.tick.status.frozen": "ゲームを停止しました",
	"commands.tick.status.lagging": "ゲームは実行されていますが、目標のティック速度を維持できていません",
	"commands.tick.status.running": "ゲームの実行を通常通りに戻しました",
	"commands.tick.status.sprinting": "ティック速度無制限でゲームを実行中です",
	"commands.tick.step.fail": "一時的なティック処理を行うには、まずゲームをフリーズさせてください",
	"commands.tick.step.stop.fail": "一時的なティック処理が行われていません",
	"commands.tick.step.stop.success": "一時的なティック処理を中断しました",
	"commands.tick.step.success": "%sティック分処理を実行します",
	"commands.time.no_default_clock": "ディメンション「%s」にはデフォルトの時計がありません",
	"commands.time.no_time_marker_found": "タイムマーカー「%s」は時計「%s」に存在しません",
	"commands.time.pause": "時計「%s」を一時停止しました",
	"commands.time.query": "現在の時刻は%sです",
	"commands.time.query.absolute": "時計「%s」は%sティックです",
	"commands.time.query.gametime": "ゲーム時間は%sティックです",
	"commands.time.query.timeline": "タイムライン「%s」は%sティックです",
	"commands.time.query.timeline.repetitions": "タイムライン「%s」は%s回繰り返されています",
	"commands.time.rate": "時計「%s」の進行速度を通常の%s倍に変更しました",
	"commands.time.resume": "時計「%s」を再開しました",
	"commands.time.set": "時刻を%sに設定しました",
	"commands.time.set.absolute": "%sを%sティックに設定しました",
	"commands.time.set.time_marker": "%sをタイムマーカー「%s」に設定しました",
	"commands.time.wrong_timeline_for_clock": "タイムライン「%s」は時計「%s」に対して無効です",
	...
	"commands.transfer.error.no_players": "転送するプレイヤーを一人以上指定する必要があります",
	"commands.transfer.success.multiple": "%s人のプレイヤーを%sへ転送しています：%s",
	"commands.transfer.success.single": "%sを%sへ転送しています：%s",
	...
	"commands.unpublish.notPublished": "公開されているマルチプレイはありません",
	"commands.unpublish.success": "マルチプレイを非公開にしました",
	"commands.version.build_time": "build_time = %s",
	"commands.version.data": "data = %s",
	"commands.version.header": "サーバーのバージョン情報：",
	...
	"commands.waypoint.list.empty": "%sにウェイポイントがありません",
	"commands.waypoint.list.success": "%[2]sに%[1]s個のウェイポイントがあります：%[3]s",
	"commands.waypoint.modify.color": "ウェイポイントの色を%sにしました",
	"commands.waypoint.modify.color.reset": "ウェイポイントの色をリセットしました",
	"commands.waypoint.modify.style": "ウェイポイントのスタイルが変更されました",
	...
	"connect.failed.transfer": "サーバーへの転送中に接続が切断されました",
	"connect.joining": "ワールドに接続中…",
	"connect.negotiating": "通信を確立中…",
	"connect.p2p.establishing": "接続を確立中…",
	"connect.p2p.failed.generic": "プレイヤーに接続できませんでした",
	"connect.p2p.failed.signaling": "現在、接続できません。\n後でもう一度お試しください。",
	"connect.p2p.failed.timeout": "接続リクエストがタイムアウトしました",
	"connect.p2p.failed.unreachable": "プレイヤーに到達できません",
	"connect.reconfiging": "再構成中…",
	"connect.reconfiguring": "再構成中…",
	"connect.transferring": "新しいサーバーに転送中...",
	"container.barrel": "樽",
	"container.beacon": "ビーコン",
	"container.beehive.bees": "ミツバチの数：%s／%s",
	"container.beehive.honey": "ハチミツ：%s／%s",
	...
	"container.shulkerBox.itemCount": "%s %s個",
	...
	"createWorld.customize.buffet.search": "検索…",
	"createWorld.customize.buffet.title": "シングルバイオームのカスタマイズ",
	...
	"dataPack.locator_bar.description": "マルチプレイにおいて、他のプレイヤーの方向を表示します",
	"dataPack.locator_bar.name": "方向バー",
	"dataPack.minecart_improvements.description": "トロッコの挙動を改善します",
	"dataPack.minecart_improvements.name": "トロッコの改善",
	"dataPack.redstone_experiments.description": "レッドストーンに関する実験的な変更",
	"dataPack.redstone_experiments.name": "レッドストーンの実験的要素",
	"dataPack.title": "データパックの選択",
	"dataPack.trade_rebalance.description": "村人との新たな取引",
	"dataPack.trade_rebalance.name": "村人の取引の再調整",
	"dataPack.update_1_20.description": "Minecraft 1.20に向けた新要素",
	"dataPack.update_1_20.name": "1.20のアップデート",
	"dataPack.update_1_21.description": "Minecraft 1.21に向けた新要素",
	"dataPack.update_1_21.name": "1.21のアップデート",
	...
	"dataPack.winter_drop.description": "冬季の小規模アップデートに向けた新要素",
	"dataPack.winter_drop.name": "冬季の小規模アップデート",
	...
	"datapackFailure.title": "現在選択されているデータパックのエラーにより、ワールドを読み込めませんでした。\nバニラデータパックのみ読み込む（「セーフモード」）か、タイトル画面に戻って手動で修正することができます。",
	...
	"death.attack.cactus.player": "%[1]sは%[2]sから逃れようとしてサボテンにぶつかった",
	...
	"death.attack.mace_smash": "%[1]sは%[2]sに叩き潰された",
	"death.attack.mace_smash.item": "%[1]sは%[2]sの%[3]sで叩き潰された",
	...
	"death.attack.spear": "%[1]sは%[2]sに突き刺された",
	"death.attack.spear.item": "%[1]sは%[2]sの%[3]sで突き刺された",
	...
	"death.attack.sulfurCubeHot": "%[1]sは溶岩は床だけではなかったと気付いた",
	"death.attack.sulfurCubeHot.player": "%[2]sは%[1]sに溶岩は床だけではないことを思い知らせた",
	"death.attack.sweetBerryBush": "%[1]sはスイートベリーの棘が刺さって死んだ",
	"death.attack.sweetBerryBush.player": "%[1]sは%[2]sから逃れようとしてスイートベリーの棘が刺さって死んだ",
	...
	"debug.copy_location.help": "F3 + C = /tpコマンドとして座標をコピー、10秒間長押しでゲームをクラッシュ",
	"debug.copy_location.message": "クリップボードに座標をコピーしました",
	"debug.crash.message": "F3 + Cが押されています。離さないとゲームをクラッシュさせます。",
	"debug.crash.message.rebindable": "%s + %sが押されています。離さない限り、ゲームをクラッシュさせます。",
	...
	"debug.entry.always": "常に表示",
	"debug.entry.currently.alwaysOn": "%sは現在「常に表示」に設定されています",
	"debug.entry.currently.inF3": "%sは現在「F3画面でのみ表示」に設定されています",
	"debug.entry.currently.inOverlay": "%s：デバッグオーバーレイでのみ表示",
	"debug.entry.currently.never": "%sは現在オフになっています",
	"debug.entry.f3": "F3のみ",
	"debug.entry.overlay": "オーバーレイ上",
	...
	"debug.options.category.renderer": "デバッグ用レンダラー",
	"debug.options.category.text": "デバッグ画面のテキスト",
	"debug.options.help": "F3 + F6 = デバッグ設定を編集",
	"debug.options.notAllowed.tooltip": "デバッグ情報が制限されている状態では表示できません",
	"debug.options.profile.default": "デフォルトの設定",
	"debug.options.profile.performance": "パフォーマンス確認用設定",
	"debug.options.search": "検索…",
	"debug.options.title": "デバッグ設定",
	"debug.options.warning": "これらの設定はあくまでテスト目的のものです。処理速度の低下やゲームのクラッシュ、その他予期せぬ問題を引き起こすおそれがあります。",
	...
	"debug.profiling.start.rebindable": "プロファイリングを%s秒間行います。%s + %sによって中断できます",
	...
	"debug.version.header": "クライアントのバージョン情報：",
	"debug.version.help": "F3 + V = クライアントのバージョン情報",
	...
	"disconnect.exceeded_packet_rate": "パケット量が規定値を超えたため退出させられました",
	"disconnect.genericReason": "%s",
	"disconnect.ignoring_status_request": "ステータスのリクエストの無視",
	...
	"disconnect.loginFailedInfo.userBanned": "オンラインプレイが禁止されています",
	"disconnect.lost": "接続を維持できません",
	"disconnect.packetError": "ネットワークプロトコルのエラーが発生しました",
	"disconnect.spam": "スパム行為のために退出させられました",
	"disconnect.timeout": "タイムアウトしました",
	"disconnect.transfer": "別のサーバーに転送しました",
	"disconnect.unknownHost": "不明なホストです",
	"download.pack.failed": "%[2]s個中%[1]s個のパックのダウンロードに失敗しました",
	"download.pack.progress.bytes": "進捗：%s（総サイズ不明）",
	"download.pack.progress.percent": "進捗：%s%%",
	"download.pack.title": "リソースパックをダウンロード中 %s／%s",
	"editGamerule.default": "デフォルト値：%s",
	"editGamerule.inGame.button": "ゲームルールを編集…",
	"editGamerule.inGame.disabled.tooltip": "ゲームルールの更新には管理者権限が必要です。",
	"editGamerule.inGame.discardChanges.message": "編集中のゲームルールの変更を破棄してもよろしいですか？",
	"editGamerule.inGame.discardChanges.title": "ゲームルールの変更",
	"editGamerule.inGame.downloadingGamerules": "ゲームルールを取得中…",
	...
	"effect.minecraft.breath_of_the_nautilus": "オウムガイの息吹",
	...
	"effect.minecraft.oozing": "滲出",
	"effect.minecraft.poison": "毒",
	"effect.minecraft.raid_omen": "襲撃の予感",
	...
	"enchantment.minecraft.breach": "防具貫通",
	"enchantment.minecraft.channeling": "召雷",
	"enchantment.minecraft.density": "重撃",
	...
	"enchantment.minecraft.sweeping_edge": "範囲ダメージ増加",
	...
	"enchantment.minecraft.wind_burst": "ウィンドバースト",
	"entity.minecraft.acacia_boat": "アカシアのボート",
	"entity.minecraft.acacia_chest_boat": "チェスト付きのアカシアのボート",
	"entity.minecraft.allay": "アレイ",
	"entity.minecraft.area_effect_cloud": "エリアエフェクトクラウド",
	"entity.minecraft.armadillo": "アルマジロ",
	"entity.minecraft.armor_stand": "防具立て",
	"entity.minecraft.arrow": "矢",
	"entity.minecraft.axolotl": "ウーパールーパー",
	"entity.minecraft.bamboo_chest_raft": "チェスト付きの竹のイカダ",
	"entity.minecraft.bamboo_raft": "竹のイカダ",
	"entity.minecraft.bat": "コウモリ",
	"entity.minecraft.bee": "ミツバチ",
	"entity.minecraft.birch_boat": "シラカバのボート",
	"entity.minecraft.birch_chest_boat": "チェスト付きのシラカバのボート",
	"entity.minecraft.blaze": "ブレイズ",
	"entity.minecraft.block_display": "ブロック表示エンティティ",
	"entity.minecraft.boat": "ボート",
	"entity.minecraft.bogged": "ボグド",
	"entity.minecraft.breeze": "ブリーズ",
	"entity.minecraft.breeze_wind_charge": "ウィンドチャージ",
	"entity.minecraft.camel": "ラクダ",
	"entity.minecraft.camel_husk": "ラクダハスク",
	"entity.minecraft.cat": "ネコ",
	"entity.minecraft.cave_spider": "洞窟グモ",
	"entity.minecraft.cherry_boat": "サクラのボート",
	"entity.minecraft.cherry_chest_boat": "チェスト付きのサクラのボート",
	...
	"entity.minecraft.copper_golem": "カッパーゴーレム",
	"entity.minecraft.cow": "ウシ",
	"entity.minecraft.creaking": "クリーキング",
	"entity.minecraft.creaking_transient": "クリーキング",
	"entity.minecraft.creeper": "クリーパー",
	"entity.minecraft.dark_oak_boat": "ダークオークのボート",
	"entity.minecraft.dark_oak_chest_boat": "チェスト付きのダークオークのボート",
	...
	"entity.minecraft.happy_ghast": "ハッピーガスト",
	...
	"entity.minecraft.jungle_boat": "ジャングルのボート",
	"entity.minecraft.jungle_chest_boat": "チェスト付きのジャングルのボート",
	"entity.minecraft.killer_bunny": "殺人ウサギ",
	"entity.minecraft.leash_knot": "リードの結び目",
	"entity.minecraft.lightning_bolt": "雷",
	"entity.minecraft.lingering_potion": "残留ポーション",
	"entity.minecraft.llama": "ラマ",
	"entity.minecraft.llama_spit": "ラマの唾",
	"entity.minecraft.magma_cube": "マグマキューブ",
	"entity.minecraft.mangrove_boat": "マングローブのボート",
	"entity.minecraft.mangrove_chest_boat": "チェスト付きのマングローブのボート",
	"entity.minecraft.mannequin": "マネキン",
	...
	"entity.minecraft.nautilus": "オウムガイ",
	"entity.minecraft.oak_boat": "オークのボート",
	"entity.minecraft.oak_chest_boat": "チェスト付きのオークのボート",
	"entity.minecraft.ocelot": "ヤマネコ",
	"entity.minecraft.ominous_item_spawner": "不吉なアイテムスポナー",
	"entity.minecraft.painting": "絵画",
	"entity.minecraft.pale_oak_boat": "ペールオークのボート",
	"entity.minecraft.pale_oak_chest_boat": "チェスト付きのペールオークのボート",
	"entity.minecraft.panda": "パンダ",
	"entity.minecraft.parched": "パーチド",
	...
	"entity.minecraft.splash_potion": "スプラッシュポーション",
	"entity.minecraft.spruce_boat": "トウヒのボート",
	"entity.minecraft.spruce_chest_boat": "チェスト付きのトウヒのボート",
	"entity.minecraft.squid": "イカ",
	"entity.minecraft.stray": "ストレイ",
	"entity.minecraft.strider": "ストライダー",
	"entity.minecraft.sulfur_cube": "サルファーキューブ",
	"entity.minecraft.sulfur_cube.content": "中身：%s",
	...
	"entity.minecraft.wind_charge": "ウィンドチャージ",
	...
	"entity.minecraft.zombie_nautilus": "ゾンビオウムガイ",
	...
	"event.minecraft.raid.defeat.full": "襲撃 - 敗北",
	"event.minecraft.raid.raiders_remaining": "残り%s体",
	"event.minecraft.raid.victory": "勝利",
	"event.minecraft.raid.victory.full": "襲撃 - 勝利",
	"filled_map.buried_treasure": "宝の地図",
	"filled_map.explorer_jungle": "ジャングル探検家の地図",
	"filled_map.explorer_swamp": "沼地探検家の地図",
	"filled_map.id": "ID #%s",
	...
	"filled_map.trial_chambers": "試練の間の地図",
	"filled_map.unknown": "不明な地図",
	"filled_map.village_desert": "砂漠の村の地図",
	"filled_map.village_plains": "平原の村の地図",
	"filled_map.village_savanna": "サバンナの村の地図",
	"filled_map.village_snowy": "雪原の村の地図",
	"filled_map.village_taiga": "タイガの村の地図",
	...
	"gamerule.allowEnteringNetherUsingPortals": "ネザーの許可",
	"gamerule.allowEnteringNetherUsingPortals.description": "プレイヤーがネザーに入ることができるかどうかを設定できます",
	"gamerule.allowFireTicksAwayFromPlayer": "プレイヤーから遠い炎のティック処理",
	"gamerule.allowFireTicksAwayFromPlayer.description": "どのプレイヤーからも8チャンク以上離れた位置の炎・溶岩がティック処理を受けることができるかどうかを設定できます",
	"gamerule.announceAdvancements": "進捗達成の通知",
	"gamerule.blockExplosionDropDecay": "ブロックの操作による爆発時にブロックがドロップアイテムを落とさない可能性",
	"gamerule.blockExplosionDropDecay.description": "オンにすると、ブロックへの作用による爆発で破壊されたブロックのドロップアイテムが一部消失するようになります。",
	...
	"gamerule.commandBlocksEnabled": "コマンドブロックの有効化",
	...
	"gamerule.disablePlayerMovementCheck": "プレイヤーの速度チェックの無効化",
	"gamerule.disableRaids": "襲撃の無効化",
	"gamerule.doDaylightCycle": "ゲーム内時刻の進行",
	"gamerule.doEntityDrops": "設備エンティティのドロップ",
	...
	"gamerule.enableCommandBlocks": "コマンドブロックの有効化",
	"gamerule.enderPearlsVanishOnDeath": "プレイヤー死亡時のエンダーパールの消滅",
	"gamerule.enderPearlsVanishOnDeath.description": "プレイヤーの投げたエンダーパールが、投げたプレイヤーが死亡したときに消滅するかを設定できます。",
	"gamerule.entitiesWithPassengersCanUsePortals": "何かが乗っているエンティティのポータル使用可否",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "何かが乗っているエンティティが、ネザーポータル、エンドポータル、エンドゲートウェイを通過してテレポートするかを設定できます。",
	...
	"gamerule.locatorBar": "プレイヤーの方向バーの有効化",
	"gamerule.locatorBar.description": "有効にすると、他のプレイヤーの方向を示すバーが画面に表示されます。",
	...
	"gamerule.maxCommandForkCount": "コマンドの最大実行文脈数",
	"gamerule.maxCommandForkCount.description": "「execute as」などのコマンドで使用できる実行文脈の最大数",
	"gamerule.maxEntityCramming": "エンティティの最大密集数",
	"gamerule.minecartMaxSpeed": "トロッコの最高速度",
	"gamerule.minecartMaxSpeed.description": "地上を走るトロッコのデフォルトの最高速度",
	"gamerule.minecraft.elytra_movement_check": "エリトラの速度チェック",
	"gamerule.minecraft.fire_spread_radius_around_player": "炎の延焼が起こる半径",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "プレイヤーの周囲の炎の延焼が発生しうる範囲の半径（ブロック）",
	"gamerule.minecraft.player_movement_check": "プレイヤーの速度チェック",
	"gamerule.minecraft.raids": "襲撃の発生",
	"gamerule.minecraft.universal_anger.description": "敵対状態になった中立Mob が、敵対させた本人だけでなく他のプレイヤーにも攻撃するかを設定できます。forgive_dead_playersが無効になっている際に最適です。",
	"gamerule.mobExplosionDropDecay": "Mob爆発時にブロックがドロップアイテムを落とさない可能性",
	"gamerule.mobExplosionDropDecay.description": "Mobによる爆発で破壊されたブロックからのドロップアイテムの一部が、その爆発によって消失するかを設定できます。",
	"gamerule.mobGriefing": "Mobの破壊行動の許可",
	"gamerule.naturalRegeneration": "体力の自動回復",
	"gamerule.playersNetherPortalCreativeDelay": "クリエイティブモードでのネザーポータルの待機時間",
	"gamerule.playersNetherPortalCreativeDelay.description": "クリエイティブモードのプレイヤーがディメンションを移動するまでにネザーポータル内に立っている必要のある時間（ティック）",
	"gamerule.playersNetherPortalDefaultDelay": "非クリエイティブモードでのネザーポータルの待機時間",
	"gamerule.playersNetherPortalDefaultDelay.description": "クリエイティブモード以外のプレイヤーがディメンションを移動するまでにネザーポータル内に立っている必要のある時間（ティック）",
	...
	"gamerule.projectilesCanBreakBlocks": "飛び道具によるブロック破壊の可否",
	"gamerule.projectilesCanBreakBlocks.description": "飛び道具の着弾によって破壊されうるブロックが実際に破壊されるかどうかを設定できます。",
	"gamerule.pvp": "PvPの有効化",
	"gamerule.pvp.description": "プレイヤーが他のプレイヤーに対してダメージを与えることができるかどうかを設定できます",
	...
	"gamerule.spawnChunkRadius.description": "オーバーワールドのスポーン地点周辺の、常に読み込まれているチャンクの量。",
	"gamerule.spawnMonsters": "モンスターのスポーン",
	"gamerule.spawnMonsters.description": "モンスターが自然にスポーンするかどうかを設定できます",
	"gamerule.spawnRadius": "リスポーン地点の半径",
	"gamerule.spawnRadius.description": "スポーン地点を中心とした、プレイヤーがスポーンする可能性のある範囲の大きさを調整できます。",
	"gamerule.spawnerBlocksEnabled": "スポナーの有効化",
	"gamerule.spectatorsGenerateChunks": "スペクテイターモードのプレイヤーによる地形生成の許可",
	"gamerule.tntExplodes": "TNTの点火及び爆発の許可",
	...
	"gui.abuseReport.attestation": "通報する上で、報告する情報があなたの知る限り正確で不足はないことを確認します。",
	"gui.abuseReport.comments": "コメント",
	"gui.abuseReport.describe": "ご記入いただいた詳細な情報は、処分決定の上での判断の一助とさせていただきます。",
	"gui.abuseReport.discard.content": "この画面を閉じると、この通報内容とコメントは破棄されます。\n本当に閉じますか？",
	"gui.abuseReport.discard.discard": "通報の内容を破棄して閉じる",
	"gui.abuseReport.discard.draft": "下書きとして保存",
	"gui.abuseReport.discard.return": "編集を続ける",
	"gui.abuseReport.discard.title": "通報内容とコメントを破棄しますか？",
	"gui.abuseReport.draft.content": "既存の通報の編集を続けますか？それとも破棄して新しい通報を作成しますか？",
	"gui.abuseReport.draft.discard": "破棄",
	"gui.abuseReport.draft.edit": "編集を続ける",
	"gui.abuseReport.draft.quittotitle.content": "編集を続けますか？それとも破棄しますか？",
	"gui.abuseReport.draft.quittotitle.title": "退出するとチャットの通報の下書きが破棄されます",
	"gui.abuseReport.draft.title": "チャットの通報の下書きを編集しますか？",
	"gui.abuseReport.error.title": "通報の送信中に問題が発生しました",
	"gui.abuseReport.message": "問題のある振る舞いを発見した場所を教えてください。\nご記入いただいた情報は通報の内容を精査するために使用されます。",
	"gui.abuseReport.more_comments": "その時の状況を以下に入力してください",
	"gui.abuseReport.name.comment_box_label": "この名前を通報する理由を教えてください。",
	"gui.abuseReport.name.reporting": "「%s」を通報しようとしています",
	"gui.abuseReport.name.title": "プレイヤー名の通報",
	"gui.abuseReport.observed_what": "通報する理由を選択してください。",
	"gui.abuseReport.read_info": "通報について",
	...
	"gui.abuseReport.reason.generic": "その他の理由",
	"gui.abuseReport.reason.generic.description": "他の理由には該当しないが、不快な行為を行うプレイヤーがいる。",
	...
	"gui.abuseReport.reason.imminent_harm": "他者への危害を及ぼす内容の脅迫",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "性的に不適切",
	"gui.abuseReport.reason.sexually_inappropriate.description": "性行為や性器、および性暴力に関する生々しいスキン。",
	...
	"gui.abuseReport.report_sent_msg": "通報を受理しました。ありがとうございます。\n\n私達のチームはできるだけ早く、寄せられた通報を確認いたします。",
	"gui.abuseReport.select_reason": "通報カテゴリを選択",
	"gui.abuseReport.send": "通報する",
	"gui.abuseReport.send.comment_too_long": "コメントを短くしてください",
	...
	"gui.abuseReport.send.no_reason": "通報カテゴリを選択してください",
	"gui.abuseReport.send.not_attested": "上記の文章を読み、チェックボックスにチェックを入れると通報できます",
	...
	"gui.abuseReport.skin.title": "プレイヤーのスキンの通報",
	"gui.abuseReport.title": "プレイヤーの通報",
	"gui.abuseReport.type.chat": "チャットのメッセージ",
	"gui.abuseReport.type.name": "プレイヤー名",
	"gui.abuseReport.type.skin": "プレイヤーのスキン",
	"gui.acknowledge": "了解",
	"gui.advancements": "進捗",
	"gui.all": "すべて",
	"gui.back": "戻る",
	...
	"gui.banned.name.description": "あなたの名前「%s」は、コミュニティ規定に違反しています。シングルプレイは引き続きプレイしていただくことができますが、オンラインでプレイするには名前を変えていただく必要があります。\n\n詳しい情報および通報された内容は次のリンクを参照ください：%s",
	"gui.banned.name.title": "この名前はマルチプレイでは使用できません",
	...
	"gui.banned.reason.generic_violation": "暴力に関するコミュニティ規定への違反",
	...
	"gui.banned.skin.description": "あなたの現在のスキンは、コミュニティ規定に違反しています。デフォルトのスキンを使用するか、新しいスキンを選択してください。\n\n詳しい情報および通報された内容は次のリンクを参照ください：%s",
	"gui.banned.skin.title": "このスキンは使用できません",
	...
	"gui.chatReport.discard.discard": "通報内容を破棄して閉じる",
	...
	"gui.continue": "続ける",
	"gui.copy_link_to_clipboard": "リンクをクリップボードにコピー",
	"gui.days": "%s日",
	"gui.done": "完了",
	"gui.down": "下",
	"gui.entity_tooltip.type": "タイプ：%s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "%sのファイルが拒否されました",
	"gui.fileDropFailure.title": "ファイルの追加に失敗しました",
	"gui.friends.accept": "承諾",
	"gui.friends.button.loading": "お待ちください…",
	"gui.friends.button.loading.invite_request_pending": "確認を待機中",
	"gui.friends.button.loading.join_request_pending": "確認を待機中",
	"gui.friends.cancel_request": "申請をキャンセル",
	"gui.friends.confirm_title": "確認",
	"gui.friends.confirm_unfriend": "このプレイヤーをフレンドリストから削除しますか？",
	"gui.friends.copy_to_clipboard": "クリップボードにコピー",
	"gui.friends.decline": "拒否",
	"gui.friends.empty_nickname": "フレンド申請を送信するには、有効なプロフィール名を入力してください",
	"gui.friends.empty_state": "追加したフレンドはここに表示されます。\n\n%sでオンラインの安全設定を管理できます。",
	"gui.friends.empty_state.link": "Microsoftアカウント",
	"gui.friends.enter_nickname": "プロフィール名を入力",
	"gui.friends.error.connection_issue": "現在、フレンドリストは機能していません。\n\nインターネットの接続をご確認の上、もう一度お試しください。",
	"gui.friends.error.failed.message": "現在、フレンド申請を送信できません",
	"gui.friends.error.forbidden.message": "ただいまのフレンドに関するアクションは失敗しました。アカウントのプライバシー設定が原因の可能性があります。",
	"gui.friends.error.generic": "何らかの問題が発生しました。— これはフレンド側ではなく機能側の問題です。\n\n後でもう一度試してください。",
	"gui.friends.error.rateLimited.message": "フレンドリストの操作間隔が短すぎます。時間をおいて再度お試しください。",
	"gui.friends.error.temporary_unavailable": "現在、フレンドリストは機能していません。\n\n後でもう一度お試しください。",
	"gui.friends.error.unavailable.message": "現在、フレンドリストのサービスが利用不能になっています。接続を確認し、後でもう一度試してください。",
	"gui.friends.error.upgrade_needed": "フレンドリストを利用するには、ゲームをアップデートしてください。",
	"gui.friends.error.user_may_lack_active_profile": "そのようなプロフィール名のプレイヤーは存在しません",
	"gui.friends.join": "参加",
	"gui.friends.loading_friends": "フレンドリストを読み込み中…",
	"gui.friends.loading_requests": "申請を読み込み中…",
	"gui.friends.manage_account_footer": "%sでオンラインの安全設定を管理できます",
	"gui.friends.multiplayer.invite": "招待",
	"gui.friends.multiplayer.invite_accept": "承諾",
	"gui.friends.multiplayer.invite_reject": "拒否",
	"gui.friends.multiplayer.join_request": "参加をリクエスト",
	"gui.friends.multiplayer.join_request_accept": "承諾",
	"gui.friends.multiplayer.join_request_reject": "拒否",
	"gui.friends.my_profile_name": "自分のプロフィール名：",
	"gui.friends.my_profile_name.narration": "プロフィール名%sをクリップボードにコピー",
	"gui.friends.narration.button.accept": "エンターキーで%sからのフレンド申請を受諾します",
	"gui.friends.narration.button.cancel_request": "エンターキーで%sへのフレンド申請を取り消します",
	"gui.friends.narration.button.decline": "エンターキーで%sからのフレンド申請を拒否します",
	"gui.friends.narration.button.unfriend": "エンターキーで%sをフレンドリストから削除します",
	"gui.friends.narration.entry.friend": "フレンド %s",
	"gui.friends.narration.entry.incoming": "%sからのフレンド申請",
	"gui.friends.narration.entry.outgoing": "%sへのフレンド申請",
	"gui.friends.open": "フレンド",
	"gui.friends.open.narration": "フレンドリスト",
	"gui.friends.open.tooltip": "フレンド",
	"gui.friends.pending.empty": "保留中のフレンド申請はありません",
	"gui.friends.pending.received": "受信済み",
	"gui.friends.pending.sent": "送信済み",
	"gui.friends.presence.status.offline": "オフライン",
	"gui.friends.presence.status.online": "オンライン",
	"gui.friends.presence.status.playing_hosted_server": "オンライン（ワールド）",
	"gui.friends.presence.status.playing_offline": "オンライン（ワールド）",
	"gui.friends.presence.status.playing_realms": "オンライン（Realm）",
	"gui.friends.presence.status.playing_server": "オンライン（サーバー）",
	"gui.friends.requests_count": "申請（%s）",
	"gui.friends.send_request": "フレンド申請を送信",
	"gui.friends.tab_friends": "フレンド",
	"gui.friends.toast.friend_added.message": "%sがあなたのフレンド申請を受諾しました",
	"gui.friends.toast.friend_invited.message": "%sがあなたのワールド参加に招待されました。",
	"gui.friends.toast.friend_removed.message": "%sがフレンドリストから削除されました",
	"gui.friends.toast.generic_error": "フレンドリストの更新中に予期せぬエラーが発生しました。時間をおいて再度お試しください。",
	"gui.friends.toast.host_invite_expired.message": "%sへのこのワールドへの招待が失効しました。",
	"gui.friends.toast.invite_from_friend.message": "%sからワールド参加への招待が来ています。フレンドリストは「%s」から開くことができます",
	"gui.friends.toast.join_invite_expired.message": "%sのワールドへの招待が失効しました。",
	"gui.friends.toast.join_request.message": "%sがあなたのワールドへの参加をリクエストしています。「%s」を押すかゲームメニューからフレンドリストを開くことができます。",
	"gui.friends.toast.request_accepted.message": "%sとフレンドになりました",
	"gui.friends.toast.request_received.message": "%sからフレンド申請が来ています",
	"gui.friends.toast.request_sent.message": "%sにフレンド申請を送信しました",
	"gui.friends.toast.request_to_join_friend.message": "%sのワールドへの参加をリクエストしました",
	"gui.friends.toast.requests_accepted_multiple.message": "%s人のフレンドがフレンド申請を受諾しました",
	"gui.friends.toast.requests_received_multiple.message": "フレンド申請が%s件届いています",
	"gui.friends.unfriend": "フレンドを削除",
	"gui.game_rule.search": "検索…",
	"gui.hours": "%s時間",
	"gui.language.search": "検索…",
	"gui.loadingMinecraft": "Minecraftを読み込み中",
	"gui.minutes": "%s分",
	...
	"gui.none": "なし",
	"gui.ok": "OK",
	"gui.open_report_dir": "レポートフォルダを開く",
	"gui.packSelection.search": "検索…",
	"gui.privacy_link.message": "プライバシーとオンラインの安全設定を管理するには、このリンクを開いてください。",
	"gui.privacy_link.title": "Xboxの設定への変更は反映に時間がかかる場合があります。\n\n更新されない場合はゲームを再起動してください。",
	"gui.proceed": "続ける",
	"gui.recipebook.moreRecipes": "右クリックで詳細を表示",
	"gui.recipebook.next_page": "次のページ",
	"gui.recipebook.page": "%s／%s",
	"gui.recipebook.previous_page": "前のページ",
	...
	"gui.remove": "削除",
	"gui.report_to_server": "サーバーに報告",
	"gui.selectWorld.search": "検索…",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "チャットが無効化またはブロックされているため、このプレイヤーを通報できません",
	...
	"gui.stats": "統計",
	"gui.stats.none_found": "統計情報がありません。",
	"gui.toMenu": "サーバーリストへ戻る",
	"gui.toRealms": "Realms一覧へ戻る",
	"gui.toTitle": "タイトル画面へ戻る",
	"gui.toWorld": "ワールド一覧へ戻る",
	"gui.togglable_slot": "クリックでスロットを無効化",
	"gui.up": "上",
	"gui.waitingForResponse.button.inactive": "戻る（%s秒）",
	"gui.waitingForResponse.title": "サーバーを待機中",
	"gui.yes": "はい",
	...
	"item.canBreak": "破壊可能：",
	"item.canPlace": "設置可能：",
	"item.canUse.unknown": "不明",
	"item.color": "色：%s",
	"item.components": "%s個のコンポーネント",
	"item.disabled": "無効なアイテム",
	"item.durability": "耐久値：%s／%s",
	"item.dyed": "染色済み",
	"item.intangible": "回収不可",
	...
	"item.minecraft.armadillo_scute": "アルマジロのウロコ",
	"item.minecraft.armadillo_spawn_egg": "アルマジロのスポーンエッグ",
	...
	"item.minecraft.black_bundle": "黒色のバンドル",
	"item.minecraft.black_dye": "黒色の染料",
	"item.minecraft.black_harness": "黒色のハーネス",
	...
	"item.minecraft.blue_bundle": "青色のバンドル",
	"item.minecraft.blue_dye": "青色の染料",
	"item.minecraft.blue_egg": "青色の卵",
	"item.minecraft.blue_harness": "青色のハーネス",
	"item.minecraft.bogged_spawn_egg": "ボグドのスポーンエッグ",
	"item.minecraft.bolt_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "ネジ止め風の装飾",
	"item.minecraft.bone": "骨",
	"item.minecraft.bone_meal": "骨粉",
	"item.minecraft.book": "本",
	"item.minecraft.bordure_indented_banner_pattern": "山形波の縁取りの旗の模様",
	"item.minecraft.bow": "弓",
	"item.minecraft.bowl": "ボウル",
	"item.minecraft.bread": "パン",
	"item.minecraft.breeze_rod": "ブリーズロッド",
	"item.minecraft.breeze_spawn_egg": "ブリーズのスポーンエッグ",
	...
	"item.minecraft.brown_bundle": "茶色のバンドル",
	"item.minecraft.brown_dye": "茶色の染料",
	"item.minecraft.brown_egg": "茶色の卵",
	"item.minecraft.brown_harness": "茶色のハーネス",
	"item.minecraft.brush": "ブラシ",
	"item.minecraft.bucket": "バケツ",
	"item.minecraft.bundle": "バンドル",
	"item.minecraft.bundle.empty": "空",
	"item.minecraft.bundle.empty.description": "複数種類のアイテムを1スタック分まで一緒にしまうことができます",
	"item.minecraft.bundle.full": "満杯",
	"item.minecraft.bundle.fullness": "%s／%s",
	"item.minecraft.burn_pottery_shard": "炎の壺の欠片",
	"item.minecraft.burn_pottery_sherd": "炎の壺の欠片",
	"item.minecraft.camel_husk_spawn_egg": "ラクダハスクのスポーンエッグ",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.coast_armor_trim_smithing_template.new": "海洋風の装飾",
	...
	"item.minecraft.copper_axe": "銅の斧",
	"item.minecraft.copper_boots": "銅のブーツ",
	"item.minecraft.copper_chestplate": "銅のチェストプレート",
	"item.minecraft.copper_golem_spawn_egg": "カッパーゴーレムのスポーンエッグ",
	"item.minecraft.copper_helmet": "銅のヘルメット",
	"item.minecraft.copper_hoe": "銅のクワ",
	"item.minecraft.copper_horse_armor": "銅の馬鎧",
	"item.minecraft.copper_ingot": "銅インゴット",
	"item.minecraft.copper_leggings": "銅のレギンス",
	"item.minecraft.copper_nautilus_armor": "銅のオウムガイの鎧",
	"item.minecraft.copper_nugget": "銅塊",
	"item.minecraft.copper_pickaxe": "銅のツルハシ",
	"item.minecraft.copper_shovel": "銅のシャベル",
	"item.minecraft.copper_spear": "銅の槍",
	"item.minecraft.copper_sword": "銅の剣",
	"item.minecraft.cow_spawn_egg": "ウシのスポーンエッグ",
	"item.minecraft.creaking_spawn_egg": "クリーキングのスポーンエッグ",
	"item.minecraft.creeper_banner_pattern": "旗の模様",
	"item.minecraft.creeper_banner_pattern.desc": "クリーパー模様",
	"item.minecraft.creeper_banner_pattern.new": "クリーパーの旗の模様",
	"item.minecraft.creeper_spawn_egg": "クリーパーのスポーンエッグ",
	"item.minecraft.crossbow": "クロスボウ",
	"item.minecraft.crossbow.projectile": "発射物：",
	"item.minecraft.crossbow.projectile.multiple": "発射物：%[2]s x %[1]s",
	"item.minecraft.crossbow.projectile.single": "発射物：%s",
	"item.minecraft.cyan_bundle": "青緑色のバンドル",
	"item.minecraft.cyan_dye": "青緑色の染料",
	"item.minecraft.cyan_harness": "青緑色のハーネス",
	...
	"item.minecraft.diamond_nautilus_armor": "ダイヤモンドのオウムガイの鎧",
	"item.minecraft.diamond_pickaxe": "ダイヤモンドのツルハシ",
	"item.minecraft.diamond_shovel": "ダイヤモンドのシャベル",
	"item.minecraft.diamond_spear": "ダイヤモンドの槍",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.dune_armor_trim_smithing_template.new": "砂丘風の装飾",
	...
	"item.minecraft.eye_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.eye_armor_trim_smithing_template.new": "エンダーアイ風の装飾",
	"item.minecraft.feather": "羽根",
	"item.minecraft.fermented_spider_eye": "発酵したクモの目",
	"item.minecraft.field_masoned_banner_pattern": "レンガの旗の模様",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.flow_armor_trim_smithing_template.new": "旋風の装飾",
	"item.minecraft.flow_banner_pattern": "旗の模様",
	"item.minecraft.flow_banner_pattern.desc": "渦巻き模様",
	"item.minecraft.flow_banner_pattern.new": "渦巻きの旗の模様",
	"item.minecraft.flow_pottery_sherd": "渦巻きの壺の欠片",
	"item.minecraft.flower_banner_pattern": "旗の模様",
	"item.minecraft.flower_banner_pattern.desc": "花模様",
	"item.minecraft.flower_banner_pattern.new": "花の旗の模様",
	...
	"item.minecraft.globe_banner_pattern.new": "地球の旗の模様",
	...
	"item.minecraft.golden_nautilus_armor": "金のオウムガイの鎧",
	"item.minecraft.golden_pickaxe": "金のツルハシ",
	"item.minecraft.golden_shovel": "金のシャベル",
	"item.minecraft.golden_spear": "金の槍",
	"item.minecraft.golden_sword": "金の剣",
	"item.minecraft.gray_bundle": "灰色のバンドル",
	"item.minecraft.gray_dye": "灰色の染料",
	"item.minecraft.gray_harness": "灰色のハーネス",
	"item.minecraft.green_bundle": "緑色のバンドル",
	"item.minecraft.green_dye": "緑色の染料",
	"item.minecraft.green_harness": "緑色のハーネス",
	"item.minecraft.guardian_spawn_egg": "ガーディアンのスポーンエッグ",
	"item.minecraft.gunpowder": "火薬",
	"item.minecraft.guster_banner_pattern": "旗の模様",
	"item.minecraft.guster_banner_pattern.desc": "風巻く者の模様",
	"item.minecraft.guster_banner_pattern.new": "風巻く者の旗の模様",
	"item.minecraft.guster_pottery_sherd": "風巻く者の壺の欠片",
	"item.minecraft.happy_ghast_spawn_egg": "ハッピーガストのスポーンエッグ",
	"item.minecraft.harness": "ハーネス",
	"item.minecraft.heart_of_the_sea": "海洋の心",
	"item.minecraft.heart_pottery_shard": "心の壺の欠片",
	"item.minecraft.heart_pottery_sherd": "心の壺の欠片",
	"item.minecraft.heartbreak_pottery_shard": "傷心の壺の欠片",
	"item.minecraft.heartbreak_pottery_sherd": "傷心の壺の欠片",
	...
	"item.minecraft.host_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.host_armor_trim_smithing_template.new": "主人風の装飾",
	...
	"item.minecraft.light_blue_bundle": "空色のバンドル",
	"item.minecraft.light_blue_dye": "空色の染料",
	"item.minecraft.light_blue_harness": "空色のハーネス",
	"item.minecraft.light_gray_bundle": "薄灰色のバンドル",
	"item.minecraft.light_gray_dye": "薄灰色の染料",
	"item.minecraft.light_gray_harness": "薄灰色のハーネス",
	"item.minecraft.lime_bundle": "黄緑色のバンドル",
	"item.minecraft.lime_dye": "黄緑色の染料",
	"item.minecraft.lime_harness": "黄緑色のハーネス",
	...
	"item.minecraft.lingering_potion.effect.infested": "虫食いの残留ポーション",
	...
	"item.minecraft.lingering_potion.effect.oozing": "滲出の残留ポーション",
	...
	"item.minecraft.lingering_potion.effect.weaving": "巣張りの残留ポーション",
	"item.minecraft.lingering_potion.effect.wind_charged": "蓄風の残留ポーション",
	"item.minecraft.llama_spawn_egg": "ラマのスポーンエッグ",
	"item.minecraft.lodestone_compass": "ロードストーンコンパス",
	"item.minecraft.mace": "メイス",
	"item.minecraft.magenta_bundle": "赤紫色のバンドル",
	"item.minecraft.magenta_dye": "赤紫色の染料",
	"item.minecraft.magenta_harness": "赤紫色のハーネス",
	...
	"item.minecraft.mojang_banner_pattern.new": "何かの旗の模様",
	...
	"item.minecraft.music_disc_bounce": "レコード",
	...
	"item.minecraft.music_disc_creator": "レコード",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "レコード",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Creator（オルゴール）",
	"item.minecraft.music_disc_far": "レコード",
	"item.minecraft.music_disc_far.desc": "C418 - far",
	"item.minecraft.music_disc_lava_chicken": "レコード",
	...
	"item.minecraft.music_disc_precipice": "レコード",
	...
	"item.minecraft.music_disc_tears": "レコード",
	...
	"item.minecraft.nautilus_spawn_egg": "オウムガイのスポーンエッグ",
	...
	"item.minecraft.netherite_horse_armor": "ネザライトの馬鎧",
	"item.minecraft.netherite_ingot": "ネザライトインゴット",
	"item.minecraft.netherite_leggings": "ネザライトのレギンス",
	"item.minecraft.netherite_nautilus_armor": "ネザライトのオウムガイの鎧",
	...
	"item.minecraft.netherite_spear": "ネザライトの槍",
	"item.minecraft.netherite_sword": "ネザライトの剣",
	"item.minecraft.netherite_upgrade_smithing_template": "鍛冶型",
	"item.minecraft.netherite_upgrade_smithing_template.new": "ネザライト強化",
	"item.minecraft.oak_boat": "オークのボート",
	"item.minecraft.oak_chest_boat": "チェスト付きのオークのボート",
	"item.minecraft.ocelot_spawn_egg": "ヤマネコのスポーンエッグ",
	"item.minecraft.ominous_bottle": "不吉な瓶",
	"item.minecraft.ominous_trial_key": "不吉な試練の鍵",
	"item.minecraft.orange_bundle": "橙色のバンドル",
	"item.minecraft.orange_dye": "橙色の染料",
	"item.minecraft.orange_harness": "橙色のハーネス",
	"item.minecraft.painting": "絵画",
	"item.minecraft.pale_oak_boat": "ペールオークのボート",
	"item.minecraft.pale_oak_chest_boat": "チェスト付きのペールオークのボート",
	"item.minecraft.panda_spawn_egg": "パンダのスポーンエッグ",
	"item.minecraft.paper": "紙",
	"item.minecraft.parched_spawn_egg": "パーチドのスポーンエッグ",
	...
	"item.minecraft.piglin_banner_pattern.new": "ブタの鼻の旗の模様",
	...
	"item.minecraft.pink_bundle": "桃色のバンドル",
	"item.minecraft.pink_dye": "桃色の染料",
	"item.minecraft.pink_harness": "桃色のハーネス",
	"item.minecraft.pitcher_plant": "ウツボカズラ",
	"item.minecraft.pitcher_pod": "ウツボカズラのさや",
	"item.minecraft.plenty_pottery_shard": "富の壺の欠片",
	...
	"item.minecraft.potion.effect.infested": "虫食いのポーション",
	...
	"item.minecraft.potion.effect.oozing": "滲出のポーション",
	...
	"item.minecraft.potion.effect.weaving": "巣張りのポーション",
	"item.minecraft.potion.effect.wind_charged": "蓄風のポーション",
	...
	"item.minecraft.purple_bundle": "紫色のバンドル",
	"item.minecraft.purple_dye": "紫色の染料",
	"item.minecraft.purple_harness": "紫色のハーネス",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "牧者風の装飾",
	...
	"item.minecraft.red_bundle": "赤色のバンドル",
	"item.minecraft.red_dye": "赤色の染料",
	"item.minecraft.red_harness": "赤色のハーネス",
	"item.minecraft.redstone": "レッドストーンダスト",
	"item.minecraft.resin_brick": "樹脂レンガ",
	"item.minecraft.resin_clump": "樹脂の塊",
	"item.minecraft.rib_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.rib_armor_trim_smithing_template.new": "あばら模様の装飾",
	...
	"item.minecraft.scrape_pottery_sherd": "斧の壺の欠片",
	"item.minecraft.scute": "カメのウロコ",
	"item.minecraft.sentry_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "略奪者風の装飾",
	"item.minecraft.shaper_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "職人風の装飾",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.silence_armor_trim_smithing_template.new": "静寂の装飾",
	...
	"item.minecraft.skull_banner_pattern.new": "骸骨の旗の模様",
	...
	"item.minecraft.smithing_template.netherite_upgrade.applies_to": "ダイヤモンドの装備品",
	...
	"item.minecraft.snout_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.snout_armor_trim_smithing_template.new": "ブタの鼻風の装飾",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.spire_armor_trim_smithing_template.new": "尖塔風の装飾",
	...
	"item.minecraft.splash_potion.effect.infested": "虫食いのスプラッシュポーション",
	...
	"item.minecraft.splash_potion.effect.oozing": "滲出のスプラッシュポーション",
	...
	"item.minecraft.splash_potion.effect.weaving": "巣張りのスプラッシュポーション",
	"item.minecraft.splash_potion.effect.wind_charged": "蓄風のスプラッシュポーション",
	...
	"item.minecraft.stone_spear": "石の槍",
	...
	"item.minecraft.sulfur_cube_bucket": "サルファーキューブ入りバケツ",
	"item.minecraft.sulfur_cube_spawn_egg": "サルファーキューブのスポーンエッグ",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.tide_armor_trim_smithing_template.new": "潮流風の装飾",
	...
	"item.minecraft.tipped_arrow.effect.infested": "虫食いの矢",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "滲出の矢",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "巣張りの矢",
	"item.minecraft.tipped_arrow.effect.wind_charged": "蓄風の矢",
	...
	"item.minecraft.turtle_scute": "カメのウロコ",
	"item.minecraft.turtle_spawn_egg": "カメのスポーンエッグ",
	"item.minecraft.vex_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.vex_armor_trim_smithing_template.new": "ヴェックス風の装飾",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.ward_armor_trim_smithing_template.new": "監獄風の装飾",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "先駆者風の装飾",
	"item.minecraft.wheat": "小麦",
	"item.minecraft.wheat_seeds": "小麦の種",
	"item.minecraft.white_bundle": "白色のバンドル",
	"item.minecraft.white_dye": "白色の染料",
	"item.minecraft.white_harness": "白色のハーネス",
	"item.minecraft.wild_armor_trim_smithing_template": "鍛冶型",
	"item.minecraft.wild_armor_trim_smithing_template.new": "大自然風の装飾",
	"item.minecraft.wind_charge": "ウィンドチャージ",
	...
	"item.minecraft.wolf_armor": "オオカミの鎧",
	...
	"item.modifiers.any": "装備したとき：",
	"item.modifiers.armor": "装着したとき：",
	"item.modifiers.body": "装備したとき：",
	"item.modifiers.chest": "胴体に装備したとき：",
	"item.modifiers.feet": "足に装備したとき：",
	"item.modifiers.hand": "手に持ったとき：",
	...
	"item.modifiers.saddle": "鞍として装備したとき：",
	"item.nbt_tags": "NBTタグ：%s",
	"item.op_block_warning.line1": "警告：",
	"item.op_block_warning.line2": "このアイテムを使用すると、コマンドが実行される可能性があります",
	"item.op_block_warning.line3": "正確な内容を知らない場合は使用を避けてください！",
	"item.spawn_egg.peaceful": "ピースフルでは無効",
	...
	"jigsaw_block.placement_priority": "設置優先度：",
	"jigsaw_block.placement_priority.tooltip": "この値は、大きな構造物の生成におけるこのジグソーブロックに接続するピースの処理の優先度です。\n\n構造物のピースはこの値が大きい順に処理されます。同じ値のピースの処理順はランダムです。",
	"jigsaw_block.pool": "構成要素プール：",
	"jigsaw_block.selection_priority": "選択優先度：",
	"jigsaw_block.selection_priority.tooltip": "この値は、一つ前のピースの接続相手の選択時におけるこのジグソーブロックの接続試行の優先度です。\n\n構造物のピースはこの値が大きい順に処理されます。同じ値のピースの処理順はランダムです。",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine - Creator（オルゴール）",
	...
	"key.categories.spectator": "スペクテイター",
	"key.categories.ui": "インターフェース",
	"key.category.minecraft.creative": "クリエイティブモード",
	"key.category.minecraft.debug": "デバッグ",
	"key.category.minecraft.gameplay": "ゲームプレイ",
	"key.category.minecraft.inventory": "インベントリ",
	"key.category.minecraft.misc": "その他",
	"key.category.minecraft.movement": "移動",
	"key.category.minecraft.multiplayer": "マルチプレイ",
	"key.category.minecraft.spectator": "スペクテイター",
	"key.chat": "チャットを開く",
	"key.command": "コマンドラインを開く",
	"key.debug.clearChat": "チャット欄のクリア",
	"key.debug.copyLocation": "座標のコピー",
	"key.debug.copyRecreateCommand": "データのコピー",
	"key.debug.crash": "デバッグ用クラッシュ",
	"key.debug.debugOptions": "デバッグ設定",
	"key.debug.dumpDynamicTextures": "ダイナミックテクスチャの出力",
	"key.debug.dumpVersion": "バージョン情報の出力",
	"key.debug.focusPause": "非アクティブ時の一時停止の切り替え",
	"key.debug.fpsCharts": "FPSグラフ",
	"key.debug.lightmapTexture": "ライトマップテクスチャ",
	"key.debug.modifier": "デバッグ修飾キー",
	"key.debug.networkCharts": "ネットワークグラフ",
	"key.debug.overlay": "オーバーレイの切り替え",
	"key.debug.profiling": "プロファイリングの開始／停止",
	"key.debug.profilingChart": "プロファイラグラフ",
	"key.debug.reloadChunk": "チャンクの再読み込み",
	"key.debug.reloadResourcePacks": "リソースパックの再読み込み",
	"key.debug.showAdvancedTooltips": "高度なツールチップ情報の表示",
	"key.debug.showChunkBorders": "チャンク境界の表示",
	"key.debug.showHitboxes": "当たり判定の表示",
	"key.debug.spectate": "スペクテイターモードの切り替え",
	"key.debug.switchGameMode": "ゲームモード切り替え画面",
	"key.drop": "アイテムを捨てる",
	"key.forward": "前進",
	"key.friends": "フレンド画面",
	...
	"known_server_link.announcements": "お知らせ",
	"known_server_link.community": "コミュニティ",
	"known_server_link.community_guidelines": "コミュニティガイドライン",
	"known_server_link.feedback": "フィードバック",
	"known_server_link.forums": "フォーラム",
	"known_server_link.news": "ニュース",
	"known_server_link.report_bug": "サーバーのバグを報告",
	"known_server_link.status": "状態",
	"known_server_link.support": "サポート",
	"known_server_link.website": "ウェブサイト",
	...
	"lanServer.port.unavailable": "このポートは利用できません。\n編集ボックスを空にするか、1024から65535までの別の数値を入力してください。",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "サーバーを追加",
	"manageServer.edit.title": "サーバー情報の編集",
	"manageServer.enterIp": "サーバーアドレス",
	"manageServer.enterName": "サーバー名",
	"manageServer.resourcePack": "サーバーリソースパック",
	"manageServer.resourcePack.disabled": "無効",
	"manageServer.resourcePack.enabled": "有効",
	"manageServer.resourcePack.prompt": "毎回確認",
	"mco.account.privacy.info": "Mojangと個人情報保護法について",
	"mco.account.privacy.info.button": "一般データ保護規則について",
	"mco.account.privacy.information": "Mojangは児童オンライン保護法（COPPA）と一般データ保護規則（GDPR）に基づく、こどもとそのプライバシーを保護するための手続きを履行しています。\n\nRealmsアカウントにアクセスするには保護者の同意が必要となる場合があります。",
	"mco.account.privacyinfo": "Mojangは児童オンライン保護法（COPPA）と一般データ保護規則（GDPR）に基づく、こどもとそのプライバシーを保護するための手続きを履行しています。\n\nRealmsアカウントにアクセスするには保護者の同意が必要となる場合があります。\n\n古いMinecraftアカウント（ユーザー名でログインする形式）を所有している場合、RealmsにアクセスするにはMojangアカウントに移行する必要があります。",
	...
	"mco.backup.entry.worldType.adventureMap": "アドベンチャーマップ",
	"mco.backup.entry.worldType.experience": "体験",
	"mco.backup.entry.worldType.inspiration": "インスピレーション",
	"mco.backup.entry.worldType.minigame": "ミニゲーム",
	"mco.backup.entry.worldType.normal": "ノーマル",
	"mco.backup.entry.worldType.unknown": "不明",
	"mco.backup.generate.world": "ワールドを生成",
	"mco.backup.info.title": "最後のバックアップからの変更",
	"mco.backup.narration": "%sからのバックアップ",
	...
	"mco.client.outdated.stable.version": "お使いのクライアントバージョン%sはRealmsと互換性がありません。\n\n最新版のMinecraftをご利用ください。",
	"mco.client.unsupported.snapshot.version": "お使いのクライアントバージョン%sはRealmsと互換性がありません。\n\nRealmsはこのスナップショットではご利用いただけません。",
	"mco.compatibility.downgrade": "ダウングレード",
	"mco.compatibility.downgrade.description": "このワールドを最後にプレイしたバージョンは%sです。現在のバージョンは%sのためダウングレードする必要があります。ダウングレードするとワールドの破損や正常な読み込みがされない恐れがあり、動作の保証ができません。\n\nダウングレードの際には「ワールドのバックアップ」にワールドのバックアップが作成されます。必要な場合はバックアップを使ってワールドを復元してください。",
	"mco.compatibility.incompatible.popup.title": "互換性のないバージョンです",
	"mco.compatibility.incompatible.releaseType.popup.message": "参加しようとしているワールドは現在お使いのバージョンと互換性がありません。",
	"mco.compatibility.incompatible.series.popup.message": "現在のバージョンは%[2]sですが、このワールドを最後にプレイしたバージョンは%[1]sです。\n\nこれらのシリーズには互換性がありません。このバージョンでプレイするには新しいワールドが必要です。",
	"mco.compatibility.unverifiable.message": "このワールドを最後にプレイしたバージョンが確認できません。ワールドがアップグレード・ダウングレートされた場合はバックアップが「ワールドのバックアップ」に自動的に作成されます。",
	"mco.compatibility.unverifiable.title": "互換性を確認できません",
	"mco.compatibility.upgrade": "アップグレード",
	"mco.compatibility.upgrade.description": "現在のバージョンは%[2]sですが、このワールドを最後にプレイしたバージョンは%[1]sです。\n\n「ワールドのバックアップ」にワールドのバックアップが作成されています。\n\n必要であればワールドを復元してください。",
	"mco.compatibility.upgrade.friend.description": "現在のバージョンは%[2]sですが、このワールドを最後にプレイしたバージョンは%[1]sです。\n\n「ワールドのバックアップ」にワールドのバックアップが作成されています。\n\nRealmの所有者は必要であればワールドを復元することができます。",
	"mco.compatibility.upgrade.title": "このワールドをアップグレードしますか？",
	...
	"mco.configure.world.close.question.line1": "調整のためRealmを一時的に閉じ、プレイを不可能にすることができます。準備が完了したら、再度開いてください。\n\nRealmの契約がキャンセルされることはありません。",
	"mco.configure.world.close.question.line2": "本当に続行しますか？",
	"mco.configure.world.close.question.title": "中断せずに変更を行う必要がありますか？",
	"mco.configure.world.closing": "Realmを一時的に閉じています…",
	...
	"mco.configure.world.leave.question.line1": "この Realm から退出した場合、再び招待されるまで入ることはできません",
	"mco.configure.world.leave.question.line2": "本当に続行しますか？",
	"mco.configure.world.loading": "Realmを読み込んでいます",
	"mco.configure.world.location": "場所",
	"mco.configure.world.minigame": "現在：%s",
	"mco.configure.world.name": "Realmの名前",
	"mco.configure.world.name.validation.whitespace": "先頭および末尾の空白は許容されていません。除去した上で使用されます。",
	"mco.configure.world.opening": "Realmを開いています...",
	"mco.configure.world.players.error": "指定された名前のプレイヤーは存在しません",
	"mco.configure.world.players.invite.duplicate": "指定の名前のプレイヤーは既にそのRealmに招待されています",
	"mco.configure.world.players.inviting": "プレイヤーを招待中...",
	"mco.configure.world.players.title": "プレイヤー",
	"mco.configure.world.pvp": "PvP",
	"mco.configure.world.region_preference": "地域設定",
	"mco.configure.world.region_preference.title": "地域選択",
	"mco.configure.world.reset.question.line1": "ワールドが再生成され、このワールドは失われます",
	"mco.configure.world.reset.question.line2": "本当に続行しますか？",
	"mco.configure.world.resourcepack.question": "このRealmにはカスタムリソースパックが必要です。\n\n自動的にダウンロードし、インストールしますか？",
	"mco.configure.world.resourcepack.question.line1": "このRealmにはカスタムリソースパックが必要です",
	"mco.configure.world.resourcepack.question.line2": "自動的にダウンロードし、インストールしますか？",
	"mco.configure.world.restore.download.question.line1": "ワールドをダウンロードし、シングルプレイに追加します",
	...
	"mco.configure.world.settings.expired": "期限切れのRealmの設定を編集することはできません",
	...
	"mco.configure.world.subscription.tab": "契約",
	...
	"mco.configure.world.uninvite.player": "「%s」への招待を取り消しますか？",
	...
	"mco.connect.connecting": "Realm に接続中…",
	"mco.connect.failed": "Realm への接続に失敗しました",
	"mco.connect.region": "サーバーの地域：%s",
	"mco.connect.success": "完了",
	"mco.create.world": "作成",
	"mco.create.world.error": "名前を入力してください！",
	"mco.create.world.failed": "ワールドの作成に失敗しました！",
	"mco.create.world.reset.title": "ワールドを作成中…",
	"mco.create.world.skip": "スキップ",
	"mco.create.world.subtitle": "これは任意ですが、新しいRealmで使用するワールドを選択することができます",
	...
	"mco.download.confirmation.line2": "このワールドを Realm に再度アップロードすることはできません",
	"mco.download.confirmation.oversized": "ダウンロードしようとしているワールドは%sよりも大きいです。\n\nこのワールドをRealmに再度アップロードできない恐れがあります。",
	...
	"mco.errorMessage.initialize.failed": "Realmの初期化に失敗しました",
	"mco.errorMessage.noDetails": "エラーの詳細はありません",
	"mco.errorMessage.realmsService": "エラーが発生しました（%s）：",
	"mco.errorMessage.realmsService.configurationError": "ワールド設定を編集中に予期せぬエラーが発生しました",
	"mco.errorMessage.realmsService.connectivity": "Realmに接続できませんでした：%s",
	"mco.errorMessage.realmsService.realmsError": "Realms（%s）：",
	"mco.errorMessage.realmsService.unknownCompatibility": "互換性のあるバージョンを確認できませんでした。取得した応答：%s",
	"mco.errorMessage.retry": "操作を再試行",
	"mco.errorMessage.serviceBusy": "現在Realmsは混雑しています。\n数分後にもう一度、Realmへの接続をお試しください。",
	"mco.gui.button": "ボタン",
	"mco.gui.ok": "OK",
	"mco.info": "情報！",
	"mco.invited.player.narration": "%sを招待しました",
	...
	"mco.minigame.world.restore.question.line1": "ミニゲームが終了され、あなたの Realm は復元されます。",
	...
	"mco.notification.transferSubscription.buttonText": "今すぐ移行する",
	"mco.notification.transferSubscription.message": "Java版Realmsの契約はMicrosoftストアへ移行します。契約が失効しないようご注意を！\n今すぐ移行すると、30日間無料でRealmをご利用いただけます。\nminecraft.netのプロフィールにアクセスし、契約を移行しましょう。",
	"mco.notification.visitUrl.buttonText.default": "リンクを開く",
	"mco.notification.visitUrl.message.default": "以下のリンクを確認してください",
	"mco.onlinePlayers": "オンラインのプレイヤー",
	"mco.play.button.realm.closed": "Realmは閉鎖されています",
	"mco.question": "質問",
	...
	"mco.reset.world.warning": "この Realm のワールドが完全に削除されます！",
	"mco.selectServer.buy": "Realmを購入しよう！",
	"mco.selectServer.close": "閉じる",
	"mco.selectServer.closed": "このRealmsは現在停止しています",
	"mco.selectServer.closeserver": "Realmを閉じる",
	"mco.selectServer.configure": "Realmの設定",
	"mco.selectServer.configureRealm": "Realmの設定",
	"mco.selectServer.create": "Realmの作成",
	"mco.selectServer.create.subtitle": "新しいRealmで使用するワールドを選択してください",
	...
	"mco.selectServer.leave": "Realmから退出する",
	"mco.selectServer.loading": "Realmsリストを読み込み中",
	"mco.selectServer.mapOnlySupportedForVersion": "このマップはバージョン%sではサポートされていません",
	"mco.selectServer.minigame": "ミニゲーム：",
	"mco.selectServer.minigameName": "ミニゲーム：%s",
	"mco.selectServer.minigameNotSupportedInVersion": "このミニゲームはバージョン%sではプレイできません",
	"mco.selectServer.noRealms": "Realmを所有していないようです。Realmを追加してフレンドと一緒にプレイしましょう。",
	"mco.selectServer.note": "注意：",
	"mco.selectServer.open": "Realmを開く",
	"mco.selectServer.openserver": "Realmを開く",
	"mco.selectServer.play": "プレイ",
	"mco.selectServer.popup": "Realmsは、一度に最大10人までのプレイヤーとMinecraftのオンラインを楽しめる、安全で簡単にサーバーを作成できるシステムです。たくさんのカスタムワールドやミニゲームのプレイができます。ただし、Realmのオーナーだけは料金を支払う必要があります。",
	"mco.selectServer.purchase": "Realmを追加",
	"mco.selectServer.trial": "試してみる！",
	"mco.selectServer.uninitialized": "クリックしてRealmを作る！",
	"mco.snapshot.createSnapshotPopup.text": "無料のスナップショット用Realmを作成しようとしています。このスナップショット用Realmはご利用中のRealmsの契約に結び付けられているため、この契約が有効の間ご利用になれます。この作成によってご契約中のRealmが影響を受けることはありません。",
	"mco.snapshot.createSnapshotPopup.title": "スナップショット用Realmを作成しますか？",
	"mco.snapshot.creating": "スナップショット用Realmを作成中…",
	"mco.snapshot.description": "作成したRealmは%sが有効な限り利用できます",
	"mco.snapshot.friendsRealm.downgrade": "このRealmに参加するには、バージョン%sで実行する必要があります",
	"mco.snapshot.friendsRealm.upgrade": "このスナップショットでこのRealmをプレイするためには、%sがRealmをアップグレードする必要があります",
	"mco.snapshot.paired": "このスナップショット用Realmは%sに結び付けられています",
	"mco.snapshot.parent.tooltip": "このRealmをプレイするには、最新のMinecraftのリリースを使用してください",
	"mco.snapshot.start": "無料のスナップショット用Realmを開始する",
	"mco.snapshot.subscription.info": "これはご契約中のRealm「%s」に結び付けられているスナップショット用Realmです。ご契約中のRealmが有効である間はこのRealmもご利用になれます。",
	"mco.snapshot.tooltip": "スナップショット用Realmを使用すると、開発中のMinecraftの新バージョンに含まれる新要素やその他の変更を先行体験できます。\n\n通常のRealmは正式リリースバージョンでのみご利用になれます。",
	"mco.snapshotRealmsPopup.message": "23w41a以降、スナップショットでもRealmsが利用可能になりました。Realmsを購入していれば、通常のJava EditionのRealmとは別に無料でスナップショット用Realmを使用できます。",
	"mco.snapshotRealmsPopup.title": "Realmsがスナップショットでも利用可能になりました",
	"mco.snapshotRealmsPopup.urlText": "詳細を確認",
	...
	"mco.upload.close.failure": "Realm を閉じる事ができません。もう一度試してください。",
	...
	"mco.upload.failed.too_big.description": "選択されたワールドは大きすぎます。最大サイズは%sです。",
	"mco.upload.failed.too_big.title": "ワールドが大きすぎます",
	...
	"menu.custom_options": "カスタム設定…",
	"menu.custom_options.title": "カスタム設定",
	"menu.custom_options.tooltip": "注意：カスタム設定はサードパーティ製のサーバーまたはコンテンツによって提供されています。\n慎重に設定してください！",
	"menu.custom_screen_info.button_narration": "これはカスタムスクリーンです。詳細はこちら。",
	"menu.custom_screen_info.contents": "この画面のコンテンツはMojang StudiosやMicrosoftの所有・運営・管理下にないサードパーティー製サーバーやマップによって制御されています。\n\n慎重に取り扱ってください！リンクをたどる際は常に注意し、ログイン情報を含む個人情報は絶対に教えないでください。\n\nこの画面がプレイを妨げる場合は、下にあるボタンで現在のサーバーから切断することもできます。",
	"menu.custom_screen_info.disconnect": "カスタムスクリーンが拒否されました",
	"menu.custom_screen_info.title": "カスタムスクリーンとは",
	"menu.custom_screen_info.tooltip": "これはカスタムスクリーンです。ここをクリックして詳しい情報を確認できます。",
	"menu.disconnect": "切断",
	"menu.feedback": "フィードバック…",
	"menu.feedback.title": "フィードバック",
	"menu.game": "ゲームメニュー",
	"menu.modded": "（Mod導入済み）",
	"menu.multiplayer": "マルチプレイ",
	"menu.multiplayerOptions.applyChanges": "変更を適用",
	"menu.multiplayerOptions.button": "マルチプレイ…",
	"menu.multiplayerOptions.network": "マルチプレイ",
	"menu.multiplayerOptions.network.header": "ネットワーク",
	"menu.multiplayerOptions.network.lan": "LAN",
	"menu.multiplayerOptions.network.lan.tooltip": "同じネットワーク上のプレイヤーが参加できます。",
	"menu.multiplayerOptions.network.off": "オフ",
	"menu.multiplayerOptions.network.off.tooltip": "誰も参加できません。",
	"menu.multiplayerOptions.network.online": "オンライン",
	"menu.multiplayerOptions.network.online.tooltip": "オンラインのフレンドが参加できます。",
	"menu.multiplayerOptions.otherPlayers.header": "他のプレイヤーのための設定",
	"menu.multiplayerOptions.publish.started.lan": "このワールドはLANに公開されました。ポート番号は%sです",
	"menu.multiplayerOptions.publish.started.online": "このワールドはオンラインマルチプレイに公開されました。",
	"menu.multiplayerOptions.publish.stopped": "このワールドのマルチプレイへの公開を停止しました",
	"menu.multiplayerOptions.title": "マルチプレイ設定",
	"menu.online": "Minecraft Realms",
	"menu.options": "設定…",
	"menu.paused": "ゲームを一時停止中",
	"menu.playdemo": "デモワールドで遊ぶ",
	"menu.playerReporting": "プレイヤーの通報",
	"menu.playerReporting.no_players": "このワールドには通報するプレイヤーがいません",
	"menu.preparingSpawn": "スポーン地点を準備中：%s%%",
	"menu.quick_actions": "クイックアクション…",
	"menu.quick_actions.title": "クイックアクション",
	"menu.quit": "終了",
	...
	"menu.server_links": "サーバーリンク…",
	"menu.server_links.title": "サーバーリンク",
	...
	"multiplayer.codeOfConduct.check": "この行動規範について二度と通知しない",
	"multiplayer.codeOfConduct.title": "サーバーの行動規範",
	"multiplayer.confirm_command.parse_errors": "認識できないか無効なコマンドを実行しようとしています。\nよろしいですか？\nコマンド：%s",
	"multiplayer.confirm_command.permissions_required": "高い権限が必要なコマンドを実行しようとしています。\nこれはゲームに悪影響をもたらす可能性があります。\nよろしいですか？\nコマンド：%s",
	"multiplayer.confirm_command.run_command": "コマンドを実行",
	"multiplayer.confirm_command.signature_required": "あなたの名前でチャットメッセージを送信するコマンドを実行しようとしています。\nこのコマンドはチャット欄からしか実行できません。\nコマンド：%s",
	"multiplayer.confirm_command.suggest_command": "チャット欄にコピー",
	"multiplayer.confirm_command.title": "コマンドの実行確認",
	"multiplayer.disconnect.authservers_down": "認証サーバーがダウンしています。後でもう一度お試しください。",
	"multiplayer.disconnect.bad_chat_index": "サーバーから欠けていた、あるいは再送信されたチャットメッセージを検出しました",
	"multiplayer.disconnect.banned": "このサーバーへのアクセスは禁止されています",
	"multiplayer.disconnect.banned.expiration": "\nアクセスの禁止は%sに解除されます",
	"multiplayer.disconnect.banned.reason": "このサーバーへのアクセスは禁止されています。\n理由：%s",
	"multiplayer.disconnect.banned.reason.default": "管理者によりアクセスが禁止されました。",
	...
	"multiplayer.disconnect.code_of_conduct": "このサーバーでは行動規範に同意する必要があります",
	"multiplayer.disconnect.configuration_error": "構成中に予期せぬエラーが発生しました",
	...
	"multiplayer.disconnect.missing_tags": "サーバーから不完全なタグのセットが受信されました。\nサーバーの管理者にお問い合わせください。",
	...
	"multiplayer.disconnect.transfers_disabled": "サーバーが転送を受け付けていません",
	...
	"multiplayer.player.list.hp": "HP：%s",
	...
	"multiplayer.status.anonymous_player": "匿名のプレイヤー",
	...
	"multiplayer.status.player_count.narration": "%[2]s人のうち%[1]s人のプレイヤーがオンラインです",
	...
	"narration.button.usage.focused": "エンターキーを押して選択します",
	"narration.button.usage.hovered": "左クリックで選択します",
	"narration.checkbox": "チェックボックス：%s",
	"narration.checkbox.usage.focused": "Enterを押して切り替えます",
	"narration.checkbox.usage.focused.check": "エンターキーを押してチェックを入れます",
	"narration.checkbox.usage.focused.uncheck": "エンターキーを押してチェックを外します",
	"narration.checkbox.usage.hovered": "左クリックで切り替えます",
	"narration.checkbox.usage.hovered.check": "左クリックでチェックを入れます",
	"narration.checkbox.usage.hovered.uncheck": "左クリックでチェックを外します",
	"narration.component_list.usage": "タブキーを押して次の要素に移動します",
	...
	"narration.item": "アイテム：%s",
	"narration.link.usage.focused": "エンターキーでリンクを開きます",
	"narration.link.usage.hovered": "左クリックでリンクを開きます",
	"narration.recipe": "%sのレシピ",
	"narration.recipe.usage": "左クリックで選択します",
	"narration.recipe.usage.more": "右クリックで他のレシピを表示します",
	"narration.selection.usage": "上下の方向キーを押して別の項目に移動します",
	"narration.slider.usage.focused": "左右の方向キーを押して数値を変更します",
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Enterを押してスライダーの値の操作に移ります",
	"narration.slider.usage.hovered": "スライダーを左右に移動させて数値を変更します",
	"narration.suggestion": "%[2]s個のうち%[1]s番目の候補%[3]sが選択されました",
	"narration.suggestion.tooltip": "%[2]s個のうち%[1]s番目の候補%[3]s、%[4]sが選択されました",
	"narration.suggestion.usage.cycle.fixed": "次の候補に切り替えるにはタブキーを押してください",
	"narration.suggestion.usage.cycle.hidable": "次の候補に切り替えるにはタブキーを、予測入力をやめるにはエスケープキーを押してください",
	"narration.suggestion.usage.fill.fixed": "予測入力を使用する場合、Tabを押してください",
	"narration.suggestion.usage.fill.hidable": "予測入力を使用する場合はタブキーを押し、予測入力をやめるにはエスケープキーを押してください",
	...
	"narrator.button.difficulty_lock.unlocked": "固定されていません",
	...
	"narrator.position.list": "%[2]s行のリストのうち%[1]s行目が選択されました",
	...
	"narrator.ready_to_play": "プレイの準備が整いました",
	...
	"narrator.select.world_info": "ワールドの名前が「%s」、最終プレイが%s、%sのワールド",
	...
	"optimizeWorld.confirm.proceed": "バックアップを作成し最適化します",
	...
	"optimizeWorld.stage.finished.chunks": "チャンクのアップグレートがまもなく完了します…",
	"optimizeWorld.stage.finished.entities": "エンティティのアップグレードがまもなく完了します…",
	"optimizeWorld.stage.finished.poi": "関心地点のアップグレードがまもなく完了します…",
	"optimizeWorld.stage.upgrading": "すべてのチャンクをアップグレード中…",
	"optimizeWorld.stage.upgrading.chunks": "すべてのチャンクをアップグレード中…",
	"optimizeWorld.stage.upgrading.entities": "すべてのエンティティをアップグレード中…",
	"optimizeWorld.stage.upgrading.poi": "すべての関心地点をアップグレード中…",
	"optimizeWorld.title": "ワールド「%s」を最適化中",
	"options.accessibility": "アクセシビリティ設定…",
	...
	"options.accessibility.high_contrast_block_outline": "ブロック輪郭のコントラスト強化",
	"options.accessibility.high_contrast_block_outline.tooltip": "視点を合わせたブロックの輪郭のコントラストを強調します。",
	"options.accessibility.link": "アクセシビリティについて",
	"options.accessibility.menu_background_blurriness": "メニュー背景のぼかし具合",
	"options.accessibility.menu_background_blurriness.tooltip": "メニュー背景のぼかし具合を変更します。",
	"options.accessibility.narrator_hotkey": "音声読み上げのホットキー",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Cmd+Bで音声読み上げのオン・オフを切り替えられるようになります",
	"options.accessibility.narrator_hotkey.tooltip": "Ctrl+Bで音声読み上げのオン・オフを切り替えられるようになります",
	...
	"options.accessibility.tooltip": "アクセシビリティ設定",
	"options.allowCursorChanges": "カーソルの変更を許可",
	"options.allowCursorChanges.tooltip": "マウスカーソルが特定のUI要素上にある際、形状を変更します。",
	"options.allowFriendRequests": "申請の許可",
	"options.allowFriendRequests.tooltip": "他のプレイヤーのあなたへのフレンド申請を許可します",
	...
	"options.blocks": "%sブロック",
	"options.chat": "チャット設定…",
	"options.chat.color": "色",
	"options.chat.delay": "チャットの遅延間隔：%s秒",
	"options.chat.delay_none": "チャットの遅延間隔：なし",
	"options.chat.drafts": "未送信のチャットの保存",
	"options.chat.drafts.tooltip": "未送信のメッセージを保存し、次にチャット欄を開いた際に送れるようにします。",
	...
	"options.chunkFade": "チャンクのフェード時間",
	"options.chunkFade.none": "チャンクのフェード：なし",
	"options.chunkFade.seconds": "チャンクのフェード：%s秒",
	"options.chunkFade.tooltip": "チャンクの描画開始時のフェードイン効果の有無、およびその時間を設定します。",
	...
	"options.cutoutLeaves": "葉ブロックの透過",
	"options.cutoutLeaves.tooltip": "葉ブロックの隙間から向こうを見ることができるようにします。無効化するとパフォーマンスが向上する可能性があります。",
	...
	"options.exclusiveFullscreen": "排他的フルスクリーン",
	"options.exclusiveFullscreen.warningTooltip": "この設定は、一部の入力メソッドの機能を阻害するおそれがあります。",
	"options.font": "フォント設定…",
	"options.font.title": "フォント設定",
	...
	"options.friendsList": "フレンドリスト",
	"options.friendsList.confirm.message": "フレンドリストからフレンド申請の送受信ができます。\n\nオンラインの安全設定は%sで管理できます。",
	"options.friendsList.confirm.message.link": "Microsoftアカウント",
	"options.friendsList.confirm.title": "フレンドリストを有効にしますか？",
	"options.friendsList.confirm.turnOff": "無効にする",
	"options.friendsList.confirm.turnOn": "有効にする",
	"options.fullscreen": "フルスクリーン",
	"options.fullscreen.current": "現在の設定",
	"options.fullscreen.entry": "%sx%s@%s (%sビット)",
	...
	"options.graphics.preset": "プリセット",
	"options.graphics.preset.tooltip": "「映像の質とパフォーマンス」の設定を、指定の質に適したデフォルト値に設定します。",
	...
	"options.graphicsApi": "グラフィックスAPI",
	"options.graphicsApi.default": "デフォルト",
	"options.graphicsApi.opengl": "OpenGLを優先",
	"options.graphicsApi.restart": "グラフィックスAPIを変更するにはゲームを再起動してください。",
	"options.graphicsApi.tooltip": "レンダリングに使用するグラフィックスAPIを選択します。特に変更する必要が無い限りはデフォルトのままにしてください！この変更は次回起動時に反映されます。",
	"options.graphicsApi.tooltip.vulkan": "実験的機能です。一部のシステムではパフォーマンス低下や動作の不安定化を引き起こす可能性があります。",
	"options.graphicsApi.vulkan": "Vulkanを優先（実験的）",
	"options.guiScale": "GUIの大きさ",
	"options.guiScale.auto": "自動",
	"options.hidden": "非表示",
	"options.hideLightningFlashes": "空の明滅の非表示",
	"options.hideLightningFlashes.tooltip": "落雷やその他の環境エフェクトに伴う空の明滅をなくします。これらのエフェクトそのものは引き続き表示されます。",
	...
	"options.hideSplashTexts": "スプラッシュテキストの非表示",
	"options.hideSplashTexts.tooltip": "メインメニューの黄色いスプラッシュテキストを非表示にします。",
	"options.improvedTransparency": "透明物の描画の改良",
	"options.improvedTransparency.tooltip": "半透明なブロックや水の後ろに描画される天候・雲・パーティクルに対してスクリーンシェーダーを使用する実験的な仕様です。\nGPUのパフォーマンスに影響を及ぼす可能性があります。",
	"options.inGameNotification": "ゲーム内通知",
	"options.inGameNotification.tooltip": "ゲーム内でフレンドに関する通知を表示します",
	"options.inactivityFpsLimit": "FPS制限の条件",
	"options.inactivityFpsLimit.afk": "放置時",
	"options.inactivityFpsLimit.afk.tooltip": "プレイヤーからの入力が1分以上無い場合にフレームレートを30に制限します。さらに9分経過するとフレームレートを10に制限します。",
	"options.inactivityFpsLimit.minimized": "最小化時",
	"options.inactivityFpsLimit.minimized.tooltip": "ゲームウィンドウを最小化したときにフレームレートを制限します。",
	"options.invertMouse": "マウス操作の反転",
	"options.invertMouseX": "横方向のマウス操作の反転",
	"options.invertMouseY": "縦方向のマウス操作の反転",
	"options.japaneseGlyphVariants": "日本語用フォント",
	"options.japaneseGlyphVariants.tooltip": "デフォルトのフォントで、CJK文字に日本語用のフォントを使用します",
	"options.key.hold": "固定",
	"options.key.toggle": "切り替え",
	"options.language": "言語設定…",
	"options.language.narration": "言語の変更",
	"options.language.title": "言語設定",
	"options.language.tooltip": "言語の変更",
	"options.languageAccuracyWarning": "（正確な翻訳が行われていない可能性があります）",
	"options.languageWarning": "正確な翻訳が行われていない可能性があります",
	"options.mainHand": "利き手",
	"options.mainHand.left": "左手",
	"options.mainHand.right": "右手",
	"options.maxAnisotropy": "異方性フィルタリング",
	"options.maxAnisotropy.tooltip": "テクスチャの見た目の滑らかさを大きく改善しますが、パフォーマンス、そして特にビデオメモリの使用量に大きな影響があります。一部のハードウェアでは対応していない場合があります。",
	...
	"options.musicToast": "BGMのトースト",
	"options.musicToast.never": "なし",
	"options.musicToast.never.tooltip": "BGMの情報を表示しません。",
	"options.musicToast.pauseMenu": "一時停止メニュー",
	"options.musicToast.pauseMenu.tooltip": "BGMが再生されている間、ゲームの一時停止メニュー上にBGMのトーストを常に表示します。",
	"options.musicToast.pauseMenuAndToast": "一時停止メニューとトースト表示",
	"options.musicToast.pauseMenuAndToast.tooltip": "BGMの再生開始時に曲名・作曲者名を表示します。またゲーム内の一時停止メニューでは、BGMが再生されている間同じ情報が常に表示されます。",
	"options.music_frequency": "BGMの頻度",
	"options.music_frequency.constant": "常時",
	"options.music_frequency.default": "デフォルト",
	"options.music_frequency.frequent": "頻繁",
	"options.music_frequency.tooltip": "ゲームワールド内でBGMが再生される頻度を変更します。",
	...
	"options.needsRestart": "設定は再起動後に適用されます。",
	...
	"options.online.friends.header": "フレンドリスト",
	"options.online.realms.header": "Realms",
	"options.online.servers.header": "サーバー",
	"options.online.title": "オンライン設定",
	"options.online.xboxSettings": "Xboxの設定…",
	...
	"options.realmsNotifications.button": "ニュースと招待",
	"options.realmsNotifications.tooltip": "タイトル画面でRealmsニュースおよび招待を受け取り、それぞれのアイコンをRealmsボタンに表示します。",
	"options.reducedDebugInfo": "デバッグ情報を減らす",
	"options.renderClouds": "雲の表示",
	"options.renderCloudsDistance": "雲の距離",
	"options.renderDistance": "描画距離",
	"options.resourcepack": "リソースパック…",
	"options.restartRequired": "一部の変更は反映に再起動が必要です。",
	"options.rotateWithMinecart": "トロッコに合わせた視点移動",
	"options.rotateWithMinecart.tooltip": "トロッコが向きを変えるのに合わせてプレイヤーの視点も変えるかどうか。「トロッコの改善」の実験的機能が有効なワールドでのみ利用可能です。",
	...
	"options.sharePresence": "オンライン状態",
	"options.sharePresence.all": "すべて",
	"options.sharePresence.all.tooltip": "オンライン状態がフレンドに共有されます。「オンライン」として表示されるとともに、何をしているかが共有されます。",
	"options.sharePresence.limited": "一部",
	"options.sharePresence.limited.tooltip": "オンライン状態を一部共有します。「オンライン」として表示はされますが、今何をしているのかは共有されません。ゲームへのフレンドの招待に支障はありません。",
	"options.sharePresence.none": "なし",
	"options.sharePresence.none.tooltip": "一切の状態を共有しません。「オフライン」として表示されます。",
	"options.showNowPlayingToast": "BGMのトースト表示",
	"options.showNowPlayingToast.tooltip": "BGMの再生開始時に曲名、作曲者名を表示します。BGMが再生されている間は、ゲーム内の一時停止メニューにて常に表示されます。",
	"options.showSubtitles": "字幕の表示",
	"options.showSubtitles.tooltip": "ゲーム内で再生されるサウンドに字幕を表示します。",
	...
	"options.sprintWindow": "ダッシュ操作の間隔",
	"options.sprintWindow.tooltip": "前進キーの2回入力でダッシュが発動する時間の間隔をティック単位で指定します。",
	...
	"options.telemetry.disabled": "データの遠隔収集は無効になっています。",
	"options.telemetry.state.all": "すべて",
	"options.telemetry.state.minimal": "最小",
	"options.telemetry.state.none": "なし",
	"options.textureFiltering": "テクスチャフィルタリング",
	"options.textureFiltering.anisotropic": "異方性",
	"options.textureFiltering.anisotropic.tooltip": "ハードウェアベースのテクスチャフィルタリングの方法です。パフォーマンスへの影響のほか、ビデオメモリの使用率に大きな影響を及ぼします。ハードウェアが対応していない場合があります。",
	"options.textureFiltering.none": "なし",
	"options.textureFiltering.none.tooltip": "フィルタリングなしでテクスチャを表示します。角度によってはブロックの見た目がぼやけます。",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nパフォーマンスへの影響を抑え、テクスチャの品質を向上させるシェーダーベースのテクスチャフィルタリングの方法です。",
	"options.title": "設定",
	"options.touchscreen": "タッチスクリーンモード",
	"options.value": "%s",
	"options.video": "ビデオ設定…",
	"options.video.display.header": "ディスプレイ",
	"options.video.interface.header": "インターフェース",
	"options.video.preferences.header": "その他の調整",
	"options.video.quality.header": "映像の質とパフォーマンス",
	"options.videoTitle": "ビデオ設定",
	"options.viewBobbing": "画面の揺れ",
	"options.vignette": "ビネット効果",
	"options.vignette.tooltip": "ゲーム画面に重ねて表示される淡いテクスチャで、画面端を暗くする効果やワールドボーダーの警告に使用されます。",
	"options.visible": "表示",
	"options.vsync": "垂直同期",
	"options.weatherRadius": "天候エフェクトの半径",
	"options.weatherRadius.tooltip": "雨や雪の降るエフェクトが見える範囲の半径です。パフォーマンスへの影響はかなり低いです。",
	"options.worldOptions.button": "ワールド設定…",
	"options.worldOptions.title": "ワールド設定",
	...
	"pack.dropRejected.message": "以下の項目は有効なパックではないため、コピーされませんでした\n %s",
	"pack.dropRejected.title": "パックでない項目",
	...
	"pack.incompatible.confirm.unknown": "このパックは破損しているか未知のバージョンのMinecraft向けに作られたもので、正常に動作しない可能性があります。",
	"pack.incompatible.new": "（新バージョン向けに制作）",
	"pack.incompatible.old": "（旧バージョン向けに制作）",
	"pack.incompatible.unknown": "（破損または非対応）",
	...
	"parsing.bool.invalid": "「%s」は不正な真偽値です。「true」もしくは「false」である必要があります",
	...
	"realms.configuration.region.australia_east": "オーストラリア・ニューサウスウェールズ州",
	"realms.configuration.region.australia_southeast": "オーストラリア・ビクトリア州",
	"realms.configuration.region.brazil_south": "ブラジル",
	"realms.configuration.region.central_india": "インド",
	"realms.configuration.region.central_us": "アメリカ合衆国・アイオワ州",
	"realms.configuration.region.east_asia": "香港",
	"realms.configuration.region.east_us": "アメリカ合衆国・バージニア州",
	"realms.configuration.region.east_us_2": "アメリカ合衆国・ノースカロライナ州",
	"realms.configuration.region.france_central": "フランス",
	"realms.configuration.region.japan_east": "東日本",
	"realms.configuration.region.japan_west": "西日本",
	"realms.configuration.region.korea_central": "韓国",
	"realms.configuration.region.north_central_us": "アメリカ合衆国・イリノイ州",
	"realms.configuration.region.north_europe": "アイルランド",
	"realms.configuration.region.south_central_us": "アメリカ合衆国・テキサス州",
	"realms.configuration.region.southeast_asia": "シンガポール",
	"realms.configuration.region.sweden_central": "スウェーデン",
	"realms.configuration.region.uae_north": "アラブ首長国連邦",
	"realms.configuration.region.uk_south": "南イギリス",
	"realms.configuration.region.west_central_us": "アメリカ合衆国・ユタ州",
	"realms.configuration.region.west_europe": "オランダ",
	"realms.configuration.region.west_us": "アメリカ合衆国・カリフォルニア州",
	"realms.configuration.region.west_us_2": "アメリカ合衆国・ワシントン州",
	"realms.configuration.region_preference.automatic_owner": "自動設定（Realm所有者の遅延情報から）",
	"realms.configuration.region_preference.automatic_player": "自動設定（最初の参加者から）",
	...
	"recover_world.bug_tracker": "バグを報告する",
	"recover_world.button": "復元を試みる",
	"recover_world.done.failed": "以前の状態からの復元に失敗しました。",
	"recover_world.done.success": "復元に成功しました！",
	"recover_world.done.title": "復元完了",
	"recover_world.issue.missing_file": "ファイルが不足しています",
	"recover_world.issue.none": "問題なし",
	"recover_world.message": "ワールドフォルダー「%s」の読み込み中に以下の問題が発生しました。\n以前の状態からワールドを復元できるかもしれません。またこの問題をバグトラッカーで報告していただくことも可能です。",
	"recover_world.no_fallback": "復元元として利用可能な状態がありません",
	"recover_world.restore": "修復を試みる",
	"recover_world.restoring": "ワールドを修復中…",
	"recover_world.state_entry": "%sからの状態：",
	"recover_world.state_entry.unknown": "不明な日時",
	"recover_world.title": "ワールドの読み込みに失敗しました",
	"recover_world.warning": "ワールドの概要の読み込みに失敗しました",
	...
	"resourcePack.runtime_failure": "リソースパックのエラーを検出しました",
	...
	"restrictions_screen.button": "制限…",
	"restrictions_screen.permission.receive_player_messages.allowed": "他プレイヤーからのメッセージの受信：可",
	"restrictions_screen.permission.receive_player_messages.denied": "他プレイヤーからのメッセージの受信：不可",
	"restrictions_screen.permission.receive_system_messages.allowed": "サーバーからのシステムメッセージの受信：可",
	"restrictions_screen.permission.receive_system_messages.denied": "サーバーからのシステムメッセージの受信：不可",
	"restrictions_screen.permission.send_commands.allowed": "コマンドの送信：可",
	"restrictions_screen.permission.send_commands.denied": "コマンドの送信：不可",
	"restrictions_screen.permission.send_messages.allowed": "チャットメッセージの送信：可",
	"restrictions_screen.permission.send_messages.denied": "チャットメッセージの送信：不可",
	"restrictions_screen.title": "制限",
	...
	"selectWorld.allowCommands.new": "コマンドの許可",
	...
	"selectWorld.backupQuestion.file_fixing_required": "ワールドをアップグレードする前にバックアップを作成しますか？",
	...
	"selectWorld.backupWarning.file_fixing_required": "このワールドをプレイするにはアップグレードが必要です。ワールドが破損してしまった場合のために、バックアップを作成してから続行することを強く推奨します。",
	...
	"selectWorld.incompatible.description": "このワールドはこのバージョンでは開けません。\nこのワールドを最後にプレイしたバージョンは%sです。",
	"selectWorld.incompatible.info": "互換性のないバージョン：%s",
	"selectWorld.incompatible.title": "互換性のないバージョン",
	"selectWorld.incompatible.tooltip": "このワールドは互換性のないバージョンで作成されているため開くことができません。",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "ワールドのフォーマットに根本的な変更があったため、このワールドを編集するには最新のバージョンにアップグレードする必要があります。",
	"selectWorld.requiresFileFixingTooltip.play": "ワールドのフォーマットに根本的な変更があったため、このワールドをプレイするには最新のバージョンにアップグレードする必要があります。",
	"selectWorld.requiresFileFixingTooltip.recreate": "ワールドのフォーマットに根本的な変更があったため、このワールドを再生成するには最新のバージョンにアップグレードする必要があります。",
	"selectWorld.resource_load": "リソースを準備中…",
	"selectWorld.resultFolder": "保存先：",
	"selectWorld.search": "ワールドの検索",
	"selectWorld.seedInfo": "空白でランダムシード値",
	"selectWorld.select": "選択したワールドで遊ぶ",
	"selectWorld.targetFolder": "保存先：%s",
	...
	"selectWorld.upgrade_and_play": "アップグレードしてプレイ",
	...
	"selectWorld.waitingForBackup.message": "ワールドのサイズによっては、この処理には少し時間がかかる場合があります。ゲームを閉じたり、デバイスの電源を切ったりしないでください。",
	"selectWorld.waitingForBackup.title": "バックアップを作成中",
	...
	"selectWorld.warning.lowDiskSpace.description": "お使いのデバイスに十分な空き容量がありません。\nゲーム中にディスク容量を使い切ると、ワールドが破損するおそれがあります。",
	"selectWorld.warning.lowDiskSpace.title": "警告！ディスクの空き容量が不足しています！",
	"selectWorld.world": "ワールド",
	"selectWorld.world_gen_settings_access": "ワールド生成設定ファイルの読み取りまたはアクセスに失敗しました！%s",
	"selecteWorld.backupRequiredTooltip": "このワールドを読み込むにはバックアップの作成が必要です",
	"sign.edit": "看板の編集",
	"sleep.not_possible": "就寝しても夜を過ごすことはできません",
	"sleep.players_sleeping": "%s／%s人のプレイヤーが就寝中",
	"sleep.skipping_night": "夜が過ごされます",
	"slot.only_single_allowed": "スロットは一つしか指定できませんが、「%s」が渡されました",
	"slot.unknown": "「%s」は不明なスロットです",
	"snbt.parser.empty_key": "キーは空にできません",
	"snbt.parser.expected_binary_numeral": "2進数が必要です",
	"snbt.parser.expected_decimal_numeral": "10進数が必要です",
	"snbt.parser.expected_float_type": "浮動小数点数が必要です",
	"snbt.parser.expected_hex_escape": "長さ%sの文字リテラルが必要です",
	"snbt.parser.expected_hex_numeral": "16進数が必要です",
	"snbt.parser.expected_integer_type": "整数が必要です",
	"snbt.parser.expected_non_negative_number": "非負整数が必要です",
	"snbt.parser.expected_number_or_boolean": "数値かブーリアン値が必要です",
	"snbt.parser.expected_string_uuid": "UUIDとしての文字列が必要です",
	"snbt.parser.expected_unquoted_string": "有効な引用符無しの文字列が必要です",
	"snbt.parser.infinity_not_allowed": "無限数は使用できません",
	"snbt.parser.invalid_array_element_type": "無効な配列の要素の型です",
	"snbt.parser.invalid_character_name": "無効なUnicode文字名です",
	"snbt.parser.invalid_codepoint": "無効なUnicode文字の値です：%s",
	"snbt.parser.invalid_string_contents": "無効な文字列の内容です",
	"snbt.parser.invalid_unquoted_start": "引用符で囲まれていない文字列を数字0-9や+、-で始めることはできません",
	"snbt.parser.leading_zero_not_allowed": "10進数を0から始めることはできません",
	"snbt.parser.no_such_operation": "次のような演算はありません：%s",
	"snbt.parser.number_parse_failure": "数値の解析に失敗しました：%s",
	"snbt.parser.undescore_not_allowed": "数値の先頭や末尾にアンダーバーを付けることはできません",
	"soundCategory.ambient": "環境音",
	"soundCategory.block": "ブロック",
	"soundCategory.hostile": "敵対的Mob",
	"soundCategory.master": "主音量",
	"soundCategory.music": "BGM",
	"soundCategory.neutral": "友好的Mob",
	"soundCategory.player": "プレイヤー",
	"soundCategory.record": "ジュークボックス／音符ブロック",
	"soundCategory.ui": "UI",
	"soundCategory.voice": "音声読み上げ／声",
	...
	"stat.minecraft.fill_cauldron": "大釜を満たした回数",
	"stat.minecraft.fish_caught": "魚を釣った回数",
	"stat.minecraft.fly_one_cm": "空中を移動した距離",
	"stat.minecraft.happy_ghast_one_cm": "ハッピーガストで移動した距離",
	...
	"stat.minecraft.nautilus_one_cm": "オウムガイで移動した距離",
	...
	"structure_block.detect_size": "構造物の大きさと位置を検出：",
	...
	"structure_block.integrity": "構造物の完全性とシード値",
	"structure_block.integrity.integrity": "構造物の完全性",
	"structure_block.integrity.seed": "構造物のシード値",
	"structure_block.invalid_structure_name": "「%s」は無効な構造物名です",
	"structure_block.load_not_found": "構造物「%s」は利用できません",
	"structure_block.load_prepare": "構造物「%s」の位置が準備されました",
	"structure_block.load_success": "「%s」から構造物を読み込みました",
	"structure_block.mode.corner": "コーナー",
	"structure_block.mode.data": "データ",
	"structure_block.mode.load": "ロード",
	"structure_block.mode.save": "セーブ",
	"structure_block.mode_info.corner": "コーナーモード - 構造物のサイズと位置を標識します",
	"structure_block.mode_info.data": "データモード - 構造物ごとに固有の処理をマーキングします",
	...
	"structure_block.save_failure": "構造物「%s」を保存できません",
	"structure_block.save_success": "構造物が「%s」として保存されました",
	"structure_block.show_air": "見えないブロックを表示する：",
	"structure_block.show_boundingbox": "境界線を表示する：",
	"structure_block.size": "構造物のサイズ",
	"structure_block.size.x": "X軸方向の構造物のサイズ",
	"structure_block.size.y": "Y軸方向の構造物のサイズ",
	"structure_block.size.z": "Z軸方向の構造物のサイズ",
	"structure_block.size_failure": "構造物のサイズを検出できません。同じ構造物名を入力した「コーナー」モードのストラクチャーブロックを設置してください。",
	"structure_block.size_success": "「%s」のサイズが正常に検出されました",
	"structure_block.strict": "厳密な配置：",
	"structure_block.structure_name": "構造物名",
	"subtitles.ambient.cave": "不気味な音が鳴る",
	"subtitles.ambient.sound": "不気味な音が鳴る",
	...
	"subtitles.block.candle.extinguish": "ろうそくの火が消える",
	...
	"subtitles.block.copper_bulb.turn_off": "銅の電球が消える",
	"subtitles.block.copper_bulb.turn_on": "銅の電球が点く",
	"subtitles.block.copper_chest.close": "チェストが閉じる",
	"subtitles.block.copper_chest.open": "チェストが開く",
	"subtitles.block.copper_trapdoor.close": "トラップドアが閉じる",
	"subtitles.block.copper_trapdoor.open": "トラップドアが開く",
	"subtitles.block.crafter.craft": "自動作業台がクラフトする",
	"subtitles.block.crafter.fail": "自動作業台がクラフトに失敗する",
	"subtitles.block.creaking_heart.hurt": "クリーキングの心臓が唸る",
	"subtitles.block.creaking_heart.idle": "不気味な音が鳴る",
	"subtitles.block.creaking_heart.spawn": "クリーキングの心臓が目覚める",
	"subtitles.block.deadbush.idle": "乾いた音が鳴る",
	"subtitles.block.decorated_pot.insert": "飾り壺にアイテムが入れられる",
	"subtitles.block.decorated_pot.insert_fail": "飾り壺が揺れる",
	"subtitles.block.decorated_pot.shatter": "飾り壺が砕け散る",
	...
	"subtitles.block.dried_ghast.ambient": "渇いた音が鳴る",
	"subtitles.block.dried_ghast.ambient_water": "乾燥したガストが潤いを取り戻す",
	"subtitles.block.dried_ghast.place_in_water": "乾燥したガストが水に浸かる",
	"subtitles.block.dried_ghast.transition": "乾燥したガストの気分が和らぐ",
	"subtitles.block.dry_grass.ambient": "風が吹く",
	...
	"subtitles.block.eyeblossom.close": "ヒトミソウが閉じる",
	"subtitles.block.eyeblossom.idle": "ヒトミソウがささやく",
	"subtitles.block.eyeblossom.open": "ヒトミソウが開く",
	"subtitles.block.fence_gate.toggle": "フェンスゲートが開閉する",
	"subtitles.block.fire.ambient": "炎が燃える",
	"subtitles.block.fire.extinguish": "炎が消える",
	"subtitles.block.firefly_bush.idle": "ホタルが羽音を立てる",
	...
	"subtitles.block.generic.fall": "何かがブロックに落ちる",
	...
	"subtitles.block.growing_plant.crop": "植物が刈りこまれる",
	"subtitles.block.hanging_sign.waxed_interact_fail": "看板が揺れる",
	...
	"subtitles.block.pale_hanging_moss.idle": "不気味な音が鳴る",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "硫黄泉が噴き出す",
	"subtitles.block.potent_sulfur.noxious_gas": "有毒なガスが発生する",
	"subtitles.block.pressure_plate.click": "感圧板が踏まれる",
	"subtitles.block.pumpkin.carve": "ハサミでくり抜く",
	"subtitles.block.redstone_torch.burnout": "トーチが焼き切れる",
	"subtitles.block.respawn_anchor.ambient": "リスポーンアンカーが響く",
	...
	"subtitles.block.sand.idle": "砂の音が鳴る",
	"subtitles.block.sand.wind": "風が吹く",
	"subtitles.block.sculk.charge": "スカルクの泡が弾ける",
	"subtitles.block.sculk.spread": "スカルクが侵食する",
	"subtitles.block.sculk_catalyst.bloom": "スカルクカタリストが開花する",
	"subtitles.block.sculk_sensor.clicking": "スカルクセンサーが作動する",
	"subtitles.block.sculk_sensor.clicking_stop": "スカルクセンサーが作動を停止する",
	"subtitles.block.sculk_shrieker.shriek": "スカルクシュリーカーが悲鳴を上げる",
	"subtitles.block.shelf.activate": "棚に動力が加わる",
	"subtitles.block.shelf.deactivate": "棚の動力が切れる",
	"subtitles.block.shelf.multi_swap": "アイテムが入れ替えられる",
	"subtitles.block.shelf.place_item": "アイテムが置かれる",
	"subtitles.block.shelf.single_swap": "アイテムが入れ替えられる",
	"subtitles.block.shelf.take_item": "アイテムが取り出される",
	"subtitles.block.shulker_box.close": "シュルカーボックスが閉じる",
	"subtitles.block.shulker_box.open": "シュルカーボックスが開く",
	"subtitles.block.sign.waxed_interact_fail": "看板が揺れる",
	...
	"subtitles.block.sponge.absorb": "スポンジが吸収する",
	"subtitles.block.sweet_berry_bush.pick_berries": "ベリーが収穫される",
	"subtitles.block.trapdoor.close": "トラップドアが閉じる",
	"subtitles.block.trapdoor.open": "トラップドアが開く",
	"subtitles.block.trapdoor.toggle": "トラップドアが開閉する",
	"subtitles.block.trial_spawner.about_to_spawn_item": "不吉なアイテムが用意される",
	"subtitles.block.trial_spawner.ambient": "試練のスポナーが燃える",
	"subtitles.block.trial_spawner.ambient_charged": "不吉なパチパチ音がする",
	"subtitles.block.trial_spawner.ambient_ominous": "不吉なパチパチ音がする",
	"subtitles.block.trial_spawner.charge_activate": "不吉な予感が試練のスポナーを飲み込む",
	"subtitles.block.trial_spawner.close_shutter": "試練のスポナーが閉じる",
	"subtitles.block.trial_spawner.detect_player": "試練のスポナーが作動する",
	"subtitles.block.trial_spawner.eject_item": "試練のスポナーがアイテムを出す",
	"subtitles.block.trial_spawner.ominous_activate": "不吉な予感が試練のスポナーを飲み込む",
	"subtitles.block.trial_spawner.open_shutter": "試練のスポナーが開く",
	"subtitles.block.trial_spawner.spawn_item": "不吉なアイテムが落ちる",
	"subtitles.block.trial_spawner.spawn_item_begin": "不吉なアイテムが出現する",
	"subtitles.block.trial_spawner.spawn_mob": "試練のスポナーがMobを召喚する",
	...
	"subtitles.block.vault.activate": "宝物庫が燃え上がる",
	"subtitles.block.vault.ambient": "宝物庫が燃える",
	"subtitles.block.vault.close_shutter": "宝物庫が閉じる",
	"subtitles.block.vault.deactivate": "宝物庫が鎮まる",
	"subtitles.block.vault.eject_item": "宝物庫がアイテムを出す",
	"subtitles.block.vault.insert_item": "宝物庫が解錠される",
	"subtitles.block.vault.insert_item_fail": "宝物庫の解錠に失敗する",
	"subtitles.block.vault.open_shutter": "宝物庫が開く",
	"subtitles.block.vault.reject_rewarded_player": "宝物庫がプレイヤーを拒絶する",
	"subtitles.block.water.ambient": "水が流れる",
	"subtitles.block.wet_sponge.dries": "スポンジが乾く",
	...
	"subtitles.entity.armadillo.ambient": "アルマジロが唸る",
	"subtitles.entity.armadillo.brush": "アルマジロのウロコを払う",
	"subtitles.entity.armadillo.death": "アルマジロが死ぬ",
	"subtitles.entity.armadillo.eat": "アルマジロが食べる",
	"subtitles.entity.armadillo.hurt": "アルマジロがダメージを受ける",
	"subtitles.entity.armadillo.hurt_reduced": "アルマジロが身を守る",
	"subtitles.entity.armadillo.land": "アルマジロが着地する",
	"subtitles.entity.armadillo.peek": "アルマジロが外を覗く",
	"subtitles.entity.armadillo.roll": "アルマジロが丸まる",
	"subtitles.entity.armadillo.scute_drop": "ウロコが落ちる",
	"subtitles.entity.armadillo.unroll_finish": "アルマジロが元に戻る",
	"subtitles.entity.armadillo.unroll_start": "アルマジロが頭を出す",
	...
	"subtitles.entity.baby_cat.ambient": "子ネコが鳴く",
	"subtitles.entity.baby_cat.beg_for_food": "子ネコが甘える",
	"subtitles.entity.baby_cat.death": "子ネコが死ぬ",
	"subtitles.entity.baby_cat.eat": "子ネコが食べる",
	"subtitles.entity.baby_cat.hiss": "子ネコが威嚇する",
	"subtitles.entity.baby_cat.hurt": "子ネコがダメージを受ける",
	"subtitles.entity.baby_cat.purr": "子ネコがのどを鳴らす",
	"subtitles.entity.baby_chicken.ambient": "ヒヨコが鳴く",
	"subtitles.entity.baby_chicken.death": "ヒヨコが死ぬ",
	"subtitles.entity.baby_chicken.hurts": "ヒヨコがダメージを受ける",
	"subtitles.entity.baby_horse.ambient": "子ウマがいななく",
	"subtitles.entity.baby_horse.angry": "子ウマがいななく",
	"subtitles.entity.baby_horse.breathe": "子ウマが呼吸をする",
	"subtitles.entity.baby_horse.death": "子ウマが死ぬ",
	"subtitles.entity.baby_horse.eat": "子ウマが食べる",
	"subtitles.entity.baby_horse.hurt": "子ウマがダメージを受ける",
	"subtitles.entity.baby_horse.land": "子ウマが着地する",
	"subtitles.entity.baby_nautilus.ambient": "子どものオウムガイがさえずる",
	"subtitles.entity.baby_nautilus.ambient_land": "子どものオウムガイがさえずる",
	"subtitles.entity.baby_nautilus.death": "子どものオウムガイが死ぬ",
	"subtitles.entity.baby_nautilus.death_land": "子どものオウムガイが死ぬ",
	"subtitles.entity.baby_nautilus.eat": "子どものオウムガイが食べる",
	"subtitles.entity.baby_nautilus.hurt": "子どものオウムガイがダメージを受ける",
	"subtitles.entity.baby_nautilus.hurt_land": "子どものオウムガイがダメージを受ける",
	"subtitles.entity.baby_nautilus.swim": "子どものオウムガイが泳ぐ",
	"subtitles.entity.baby_pig.ambient": "子ブタが鳴く",
	"subtitles.entity.baby_pig.death": "子ブタが死ぬ",
	"subtitles.entity.baby_pig.eat": "子ブタが食べる",
	"subtitles.entity.baby_pig.hurt": "子ブタがダメージを受ける",
	"subtitles.entity.baby_wolf.ambient": "子どものオオカミが吠える",
	"subtitles.entity.baby_wolf.death": "子どものオオカミが死ぬ",
	"subtitles.entity.baby_wolf.growl": "子どものオオカミが唸る",
	"subtitles.entity.baby_wolf.hurt": "子どものオオカミがダメージを受ける",
	"subtitles.entity.baby_wolf.pant": "子どものオオカミが息を切らす",
	"subtitles.entity.baby_wolf.whine": "子どものオオカミが鼻を鳴らす",
	...
	"subtitles.entity.bogged.ambient": "ボグドが骨を鳴らす",
	"subtitles.entity.bogged.death": "ボグドが死ぬ",
	"subtitles.entity.bogged.hurt": "ボグドがダメージを受ける",
	"subtitles.entity.breeze.charge": "ブリーズが力を溜める",
	"subtitles.entity.breeze.death": "ブリーズが死ぬ",
	"subtitles.entity.breeze.deflect": "ブリーズが弾き返す",
	"subtitles.entity.breeze.hurt": "ブリーズがダメージを受ける",
	"subtitles.entity.breeze.idle_air": "ブリーズが飛ぶ",
	"subtitles.entity.breeze.idle_ground": "ブリーズが風の音を立てる",
	"subtitles.entity.breeze.inhale": "ブリーズが息を吸い込む",
	"subtitles.entity.breeze.jump": "ブリーズが跳ぶ",
	"subtitles.entity.breeze.land": "ブリーズが着地する",
	"subtitles.entity.breeze.shoot": "ブリーズが発射する",
	"subtitles.entity.breeze.slide": "ブリーズが地面を滑る",
	"subtitles.entity.breeze.whirl": "ブリーズの風が渦を巻く",
	"subtitles.entity.breeze.wind_burst": "ウィンドチャージが炸裂する",
	...
	"subtitles.entity.camel_husk.ambient": "ラクダハスクが唸る",
	"subtitles.entity.camel_husk.dash": "ラクダハスクが跳躍する",
	"subtitles.entity.camel_husk.dash_ready": "ラクダハスクの脚力が回復する",
	"subtitles.entity.camel_husk.death": "ラクダハスクが死ぬ",
	"subtitles.entity.camel_husk.eat": "ラクダハスクが食べる",
	"subtitles.entity.camel_husk.hurt": "ラクダハスクがダメージを受ける",
	"subtitles.entity.camel_husk.saddle": "鞍が装着される",
	"subtitles.entity.camel_husk.sit": "ラクダハスクが座り込む",
	"subtitles.entity.camel_husk.stand": "ラクダハスクが立ち上がる",
	...
	"subtitles.entity.copper_golem.death": "カッパーゴーレムが死ぬ",
	"subtitles.entity.copper_golem.hurt": "カッパーゴーレムがダメージを受ける",
	"subtitles.entity.copper_golem.item_drop": "カッパーゴーレムがアイテムをしまう",
	"subtitles.entity.copper_golem.item_no_drop": "カッパーゴーレムがアイテムをしまうのに失敗する",
	"subtitles.entity.copper_golem.no_item_get": "カッパーゴーレムがアイテムを取る",
	"subtitles.entity.copper_golem.no_item_no_get": "カッパーゴーレムがアイテムを取るのに失敗する",
	"subtitles.entity.copper_golem.spawn": "カッパーゴーレムが生まれる",
	"subtitles.entity.copper_golem.spin": "カッパーゴーレムの頭が回る",
	"subtitles.entity.copper_golem_become_statue": "カッパーゴーレムが動かなくなる",
	"subtitles.entity.copper_golem_oxidized.death": "カッパーゴーレムが死ぬ",
	"subtitles.entity.copper_golem_oxidized.hurt": "カッパーゴーレムがダメージを受ける",
	"subtitles.entity.copper_golem_oxidized.spin": "カッパーゴーレムの頭が回る",
	"subtitles.entity.copper_golem_weathered.death": "カッパーゴーレムが死ぬ",
	"subtitles.entity.copper_golem_weathered.hurt": "カッパーゴーレムがダメージを受ける",
	"subtitles.entity.copper_golem_weathered.spin": "カッパーゴーレムの頭が回る",
	...
	"subtitles.entity.creaking.activate": "クリーキングが見つめる",
	"subtitles.entity.creaking.ambient": "クリーキングがきしむ",
	"subtitles.entity.creaking.attack": "クリーキングが攻撃をする",
	"subtitles.entity.creaking.deactivate": "クリーキングが静まる",
	"subtitles.entity.creaking.death": "クリーキングが崩れる",
	"subtitles.entity.creaking.freeze": "クリーキングが止まる",
	"subtitles.entity.creaking.spawn": "クリーキングが現れる",
	"subtitles.entity.creaking.sway": "クリーキングが攻撃を受ける",
	"subtitles.entity.creaking.twitch": "クリーキングが痙攣する",
	"subtitles.entity.creaking.unfreeze": "クリーキングが動き出す",
	...
	"subtitles.entity.donkey.jump": "ロバが跳ぶ",
	...
	"subtitles.entity.fish.swim": "水しぶき",
	...
	"subtitles.entity.generic.wind_burst": "ウィンドチャージが炸裂する",
	...
	"subtitles.entity.ghastling.ambient": "ガスリンが鳴く",
	"subtitles.entity.ghastling.death": "ガスリンが死ぬ",
	"subtitles.entity.ghastling.hurt": "ガスリンがダメージを受ける",
	"subtitles.entity.ghastling.spawn": "ガスリンが生まれる",
	...
	"subtitles.entity.happy_ghast.ambient": "ハッピーガストが優しく歌う",
	"subtitles.entity.happy_ghast.death": "ハッピーガストが死ぬ",
	"subtitles.entity.happy_ghast.equip": "ハーネスが装着される",
	"subtitles.entity.happy_ghast.harness_goggles_down": "ハッピーガストの準備が整う",
	"subtitles.entity.happy_ghast.harness_goggles_up": "ハッピーガストが止まる",
	"subtitles.entity.happy_ghast.hurt": "ハッピーガストがダメージを受ける",
	"subtitles.entity.happy_ghast.unequip": "ハーネスが取り外される",
	...
	"subtitles.entity.leash_knot.break": "リードが解ける",
	...
	"subtitles.entity.minecart.inside": "トロッコが騒音を立てる",
	"subtitles.entity.minecart.inside_underwater": "トロッコが水中で騒音を立てる",
	...
	"subtitles.entity.mule.jump": "ラバが跳ぶ",
	"subtitles.entity.nautilus.ambient": "オウムガイが鳴く",
	"subtitles.entity.nautilus.ambient_land": "オウムガイが鳴く",
	"subtitles.entity.nautilus.dash": "オウムガイが加速する",
	"subtitles.entity.nautilus.dash_land": "オウムガイが加速する",
	"subtitles.entity.nautilus.dash_ready": "オウムガイの加速力が回復する",
	"subtitles.entity.nautilus.dash_ready_land": "オウムガイの加速力が回復する",
	"subtitles.entity.nautilus.death": "オウムガイが死ぬ",
	"subtitles.entity.nautilus.death_land": "オウムガイが死ぬ",
	"subtitles.entity.nautilus.eat": "オウムガイが食べる",
	"subtitles.entity.nautilus.hurt": "オウムガイがダメージを受ける",
	"subtitles.entity.nautilus.hurt_land": "オウムガイがダメージを受ける",
	"subtitles.entity.nautilus.swim": "オウムガイが泳ぐ",
	"subtitles.entity.painting.break": "絵画が破壊される",
	...
	"subtitles.entity.parched.ambient": "パーチドが骨を鳴らす",
	"subtitles.entity.parched.death": "パーチドが死ぬ",
	"subtitles.entity.parched.hurt": "パーチドがダメージを受ける",
	...
	"subtitles.entity.parrot.imitate.bogged": "オウムがボグドの骨を鳴らす音を真似る",
	"subtitles.entity.parrot.imitate.breeze": "オウムがブリーズの風の音を真似る",
	"subtitles.entity.parrot.imitate.camel_husk": "オウムがラクダハスクの唸り声を真似る",
	"subtitles.entity.parrot.imitate.creaking": "オウムがクリーキングのきしむ音を真似る",
	...
	"subtitles.entity.parrot.imitate.parched": "オウムがパーチドの骨を鳴らす音を真似る",
	...
	"subtitles.entity.parrot.imitate.ravager": "オウムがラヴェジャーのうめき声を真似る",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "オウムがゾンビホースの鳴き声を真似る",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "オウムがゾンビオウムガイの泡音を真似る",
	...
	"subtitles.entity.pig.eat": "ブタが食べる",
	...
	"subtitles.entity.player.teleport": "プレイヤーがテレポートする",
	"subtitles.entity.polar_bear.ambient": "シロクマがうめく",
	"subtitles.entity.polar_bear.ambient_baby": "子どものシロクマが鳴く",
	...
	"subtitles.entity.skeleton_horse.jump_water": "スケルトンホースが跳ぶ",
	...
	"subtitles.entity.sulfur_cube.absorb": "サルファーキューブがブロックを吸収する",
	"subtitles.entity.sulfur_cube.bounce": "サルファーキューブが弾む",
	"subtitles.entity.sulfur_cube.death": "サルファーキューブが死ぬ",
	"subtitles.entity.sulfur_cube.eject": "ブロックが取り除かれる",
	"subtitles.entity.sulfur_cube.hit": "サルファーキューブが叩かれる",
	"subtitles.entity.sulfur_cube.hurt": "サルファーキューブがダメージを受ける",
	"subtitles.entity.sulfur_cube.push": "サルファーキューブが押される",
	"subtitles.entity.sulfur_cube.squish": "サルファーキューブが跳ねる",
	...
	"subtitles.entity.wandering_trader.yes": "行商人が取引に応じる",
	...
	"subtitles.entity.wind_charge.throw": "ウィンドチャージが投げられる",
	"subtitles.entity.wind_charge.wind_burst": "ウィンドチャージが炸裂する",
	...
	"subtitles.entity.zombie_horse.angry": "ゾンビホースがいななく",
	"subtitles.entity.zombie_horse.death": "ゾンビホースが死ぬ",
	"subtitles.entity.zombie_horse.eat": "ゾンビホースが食べる",
	"subtitles.entity.zombie_horse.hurt": "ゾンビホースがダメージを受ける",
	"subtitles.entity.zombie_nautilus.ambient": "ゾンビオウムガイが泡音を立てる",
	"subtitles.entity.zombie_nautilus.ambient_land": "ゾンビオウムガイが泡音を立てる",
	"subtitles.entity.zombie_nautilus.dash": "ゾンビオウムガイが加速する",
	"subtitles.entity.zombie_nautilus.dash_land": "ゾンビオウムガイが加速する",
	"subtitles.entity.zombie_nautilus.dash_ready": "ゾンビオウムガイの加速力が回復する",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "ゾンビオウムガイの加速力が回復する",
	"subtitles.entity.zombie_nautilus.death": "ゾンビオウムガイが死ぬ",
	"subtitles.entity.zombie_nautilus.death_land": "ゾンビオウムガイが死ぬ",
	"subtitles.entity.zombie_nautilus.eat": "ゾンビオウムガイが食べる",
	"subtitles.entity.zombie_nautilus.hurt": "ゾンビオウムガイがダメージを受ける",
	"subtitles.entity.zombie_nautilus.hurt_land": "ゾンビオウムガイがダメージを受ける",
	"subtitles.entity.zombie_nautilus.swim": "ゾンビオウムガイが泳ぐ",
	...
	"subtitles.event.mob_effect.bad_omen": "不吉な予感に囚われる",
	"subtitles.event.mob_effect.raid_omen": "襲撃が差し迫る",
	"subtitles.event.mob_effect.trial_omen": "不吉な試練が差し迫る",
	"subtitles.event.raid.horn": "不気味な角笛が鳴り響く",
	"subtitles.item.armor.equip": "装備が装着される",
	"subtitles.item.armor.equip_chain": "チェーンの防具が装着される",
	"subtitles.item.armor.equip_copper": "銅の防具が装着される",
	...
	"subtitles.item.armor.equip_nautilus": "オウムガイの鎧が装着される",
	"subtitles.item.armor.equip_netherite": "ネザライトの防具が装着される",
	"subtitles.item.armor.equip_turtle": "カメの甲羅が装着される",
	"subtitles.item.armor.equip_wolf": "オオカミの鎧を着せる",
	"subtitles.item.armor.unequip_nautilus": "オウムガイの鎧が取り外される",
	"subtitles.item.armor.unequip_wolf": "オオカミの鎧を脱がす",
	"subtitles.item.axe.scrape": "斧でこすり落とす",
	"subtitles.item.axe.strip": "斧で剥がす",
	"subtitles.item.axe.wax_off": "蝋を落とす",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "サルファーキューブがバケツですくわれる",
	...
	"subtitles.item.bundle.insert_fail": "バンドルがいっぱいになる",
	...
	"subtitles.item.elytra.flying": "風を切る",
	...
	"subtitles.item.golden_dandelion.unuse": "金のタンポポが成長を再開させる",
	"subtitles.item.golden_dandelion.use": "金のタンポポが成長を止める",
	"subtitles.item.hoe.till": "クワで耕す",
	"subtitles.item.honey_bottle.drink": "飲み干す",
	"subtitles.item.honeycomb.wax_on": "蝋を引く",
	"subtitles.item.horse_armor.unequip": "馬鎧を外す",
	"subtitles.item.ink_sac.use": "イカスミで染める",
	"subtitles.item.lead.break": "リードがちぎれる",
	"subtitles.item.lead.tied": "リードが結ばれる",
	"subtitles.item.lead.untied": "リードが解かれる",
	"subtitles.item.llama_carpet.unequip": "カーペットを外す",
	"subtitles.item.lodestone_compass.lock": "ロードストーンコンパスがロードストーンに紐付く",
	"subtitles.item.mace.smash_air": "メイスが振り下ろされる",
	"subtitles.item.mace.smash_ground": "メイスが振り下ろされる",
	"subtitles.item.nautilus_saddle_equip": "鞍が装着される",
	"subtitles.item.nautilus_saddle_underwater_equip": "鞍が装着される",
	"subtitles.item.nether_wart.plant": "作物が植えられる",
	"subtitles.item.ominous_bottle.dispose": "瓶が割れる",
	"subtitles.item.saddle.unequip": "鞍を外す",
	"subtitles.item.shears.shear": "ハサミで刈る",
	"subtitles.item.shears.snip": "ハサミで切る",
	"subtitles.item.shield.block": "盾で防御する",
	"subtitles.item.shovel.flatten": "シャベルで均す",
	"subtitles.item.spear.attack": "槍で突く",
	"subtitles.item.spear.hit": "槍が当たる",
	"subtitles.item.spear.lunge": "槍で突進する",
	"subtitles.item.spear.use": "槍を構える",
	"subtitles.item.spear_wood.attack": "槍で突く",
	"subtitles.item.spear_wood.hit": "槍が当たる",
	"subtitles.item.spear_wood.use": "槍を構える",
	...
	"subtitles.item.underwater_saddle.equip": "鞍が装着される",
	"subtitles.item.wolf_armor.break": "オオカミの鎧が破壊される",
	"subtitles.item.wolf_armor.crack": "オオカミの鎧にひびが入る",
	"subtitles.item.wolf_armor.damage": "オオカミの鎧がダメージを受ける",
	"subtitles.item.wolf_armor.repair": "オオカミの鎧が修復される",
	"subtitles.particle.soul_escape": "魂が抜け出る",
	"subtitles.ui.cartography_table.take_result": "地図が描かれる",
	"subtitles.ui.hud.bubble_pop": "酸素ゲージが減る",
	"subtitles.ui.loom.take_result": "機織り機が使用される",
	"subtitles.ui.stonecutter.take_result": "石切台が使用される",
	"subtitles.weather.end_flash": "エンドの閃光が轟音を立てる",
	"subtitles.weather.rain": "雨が降る",
	"symlink_warning.message": "シンボリックリンクのあるフォルダからワールドを読み込む場合は、安全のため十分な理解のもと実行してください。詳細は%sからご確認いただけます。",
	"symlink_warning.message.pack": "シンボリックリンクのあるフォルダからパックを読み込む場合は、安全のため十分な理解のもと実行してください。詳細は%sからご確認いただけます。",
	"symlink_warning.message.world": "シンボリックリンクのあるフォルダからワールドを読み込む場合は、安全のため十分な理解のもと実行してください。詳細は%sからご確認いただけます。",
	"symlink_warning.more_info": "詳細な情報",
	"symlink_warning.title": "シンボリックリンクを含むワールドフォルダ",
	"symlink_warning.title.pack": "追加されたパックにシンボリックリンクが含まれています",
	"symlink_warning.title.world": "ワールドフォルダにシンボリックリンクが含まれています",
	...
	"telemetry.event.game_load_times.description": "このイベントは、起動フェーズの実行時間を測定し、起動性能の改善が必要な箇所を把握するためのものです。",
	"telemetry.event.game_load_times.title": "ゲームの読み込み時間",
	"telemetry.event.graphics_capabilities.description": "このイベントは、ゲームのプレイに使用されているグラフィックデバイスの性能に関する情報を把握するためのものです。",
	"telemetry.event.graphics_capabilities.title": "グラフィック性能",
	"telemetry.event.optional": "%s（任意）",
	"telemetry.event.optional.disabled": "%s（任意） - 無効",
	"telemetry.event.p2p_connection.description": "このイベントは、プレイヤー間のP2P接続の信頼性とパフォーマンスを把握するためのものです。接続の成功の是非、使用されたInteractive Connectivity Establishment（ICE：本ゲームのP2P接続に採用されているプロトコル）の候補の種類、および接続確立に掛かった時間を記録します。",
	"telemetry.event.p2p_connection.title": "P2P接続",
	...
	"telemetry.event.world_load_times.description": "ワールドの読み込みにかかる時間、および開発過程でそれがどのように変化するかを理解することは重要です。例えば、新しい要素の追加や技術的に大きな変更を行った場合に、これらが読み込み時間に対してどのような影響を及ぼすかを確認する必要があります。",
	"telemetry.event.world_load_times.title": "ワールド読み込み時間",
	...
	"telemetry.property.backend_failure_message.title": "バックエンド作成失敗時のメッセージ",
	"telemetry.property.backend_failure_missing_capabilities.title": "バックエンド作成失敗時の不足していた性能情報",
	"telemetry.property.backend_failure_reason.title": "バックエンド作成失敗の原因",
	"telemetry.property.backend_name.title": "バックエンド名",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "失敗の起きた段階",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Interactive Connectivity Establishment（ICE）接続時間（ミリ秒）",
	"telemetry.property.p2p_connection_ice_path.title": "Interactive Connectivity Establishment（ICE）パス",
	"telemetry.property.p2p_connection_local_candidate_type.title": "ローカル候補タイプ",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "リモート候補タイプ",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "シグナリング接続時間（ミリ秒）",
	"telemetry.property.p2p_connection_successful.title": "接続の成功の是非",
	"telemetry.property.p2p_connection_total_time_ms.title": "総接続時間（ミリ秒）",
	"telemetry.property.platform.title": "プラットフォーム",
	"telemetry.property.realms_map_content.title": "Realmsのマップコンテンツ（ミニゲームの名前）",
	...
	"telemetry_info.button.privacy_statement": "プライバシーに関する声明",
	"telemetry_info.button.show_data": "自分のデータを確認する",
	"telemetry_info.opt_in.description": "任意の遠隔測定データを送信することに同意する",
	"telemetry_info.property_title": "含まれるデータ",
	"telemetry_info.screen.description": "これらのデータを収集することにより、プレイヤーの傾向を導き出し、Minecraftの改善に活かすことができます。\nまた、Minecraftの継続的な改善のために、追加のフィードバックを送信することもできます。",
	"telemetry_info.screen.title": "データの遠隔収集",
	"test.error.block_property_mismatch": "プロパティ%sが%sであることが必要ですが、%sでした",
	"test.error.block_property_missing": "ブロックプロパティが存在しません。プロパティ%sは%sでなければなりません",
	"test.error.entity_property": "エンティティ%sがテストに失敗しました：%s",
	"test.error.entity_property_details": "エンティティ%sがテストに失敗しました：%s、%sが必要ですが、%sでした",
	"test.error.expected_block": "ブロック%sが必要ですが、%sが検出されました",
	"test.error.expected_block_present": "ブロック%sが存在する必要があります",
	"test.error.expected_block_tag": "#%sに含まれるブロックが必要ですが、%sが検出されました",
	"test.error.expected_container_contents": "コンテナには%sが入っている必要があります",
	"test.error.expected_container_contents_single": "コンテナには単一の%sが入っている必要があります",
	"test.error.expected_empty_container": "コンテナは空である必要があります",
	"test.error.expected_entity": "%sが必要です",
	"test.error.expected_entity_around": "%sが%s, %s, %sの周囲に存在することが必要です",
	"test.error.expected_entity_count": "タイプ%[2]sのエンティティ%[1]s体が必要ですが、%[3]sが検出されました",
	"test.error.expected_entity_data": "エンティティデータは%sでなければなりませんが、%sでした",
	"test.error.expected_entity_data_predicate": "エンティティデータが%sに合致しません",
	"test.error.expected_entity_effect": "%sには効果%s %sが付与されている必要があります",
	"test.error.expected_entity_having": "エンティティのインベントリには%sが入っている必要があります",
	"test.error.expected_entity_holding": "エンティティは%sを手に持っている必要があります",
	"test.error.expected_entity_in_test": "%sがテスト内に存在している必要があります",
	"test.error.expected_entity_not_touching": "%sが%s, %s, %sに接触していない必要があります（相対位置：%s, %s, %s）",
	"test.error.expected_entity_touching": "%sが%s, %s, %sに接触している必要があります（相対位置：%s, %s, %s）",
	"test.error.expected_item": "タイプ%sのアイテムが必要です",
	"test.error.expected_items_count": "タイプ%[2]sのアイテム%[1]s個が必要ですが、%[3]sが検出されました",
	"test.error.fail": "失敗条件が満たされました",
	"test.error.invalid_block_type": "予期せぬブロックタイプが検出されました：%s",
	"test.error.missing_block_entity": "ブロックエンティティが不足しています",
	"test.error.not_a_block_item": "指定のブロックはブロックアイテムではありません",
	"test.error.position": "ティック%[8]s時点で、%[2]s, %[3]s, %[4]s（相対位置：%[5]s, %[6]s, %[7]s）において%[1]s",
	"test.error.sequence.condition_already_triggered": "条件がすでに%sでトリガーされています",
	"test.error.sequence.condition_not_triggered": "条件がトリガーされていません",
	"test.error.sequence.invalid_tick": "無効なティックにおいて成功しました。%sでなければなりません",
	"test.error.sequence.minimum_tick": "予定のティックより早く成功しました。予想された待ち時間は%sでした",
	"test.error.sequence.not_completed": "シーケンスが完了する前にテストがタイムアウトしました",
	"test.error.set_biome": "テストに向けたバイオームの設定に失敗しました",
	"test.error.spawn_failure": "エンティティ%sの作成に失敗しました",
	"test.error.state_not_equal": "状態が間違っています。%sであることが必要ですが、%sでした",
	"test.error.structure.failure": "%sのテスト構造物の設置に失敗しました",
	"test.error.tick": "%[2]sティック時点で%[1]s",
	"test.error.ticking_without_structure": "構造物が未設置の状態でティック処理が実行されました",
	"test.error.timeout.no_result": "%sティック以内に成功も失敗もしませんでした。",
	"test.error.timeout.no_sequences_finished": "%sティック以内にシーケンスが終了しませんでした",
	"test.error.too_many_entities": "ただ1体の%sが%s, %s, %sの周囲に存在することが必要ですが、%s体が検出されました",
	"test.error.unexpected_block": "ブロックが%sであることは予期されていません",
	"test.error.unexpected_entity": "%sが存在することは予期されていません",
	"test.error.unexpected_item": "タイプ%sのアイテムは予期されていません",
	"test.error.unknown": "不明な内部エラーです：%s",
	"test.error.value_not_equal": "%sが%sであることが必要ですが、%sでした",
	"test.error.value_not_in_between": "%sは%sから%sの間であることが必要ですが、%sでした",
	"test.error.wrong_block_entity": "ブロックエンティティタイプが間違っています：%s",
	"test_block.error.missing": "テスト構造物に%sブロックがありません",
	"test_block.error.too_many": "%sブロックが多すぎます",
	"test_block.invalid_timeout": "%sは無効なタイムアウト時間です。正の整数でティック数を指定してください",
	"test_block.message": "メッセージ：",
	"test_block.mode.accept": "認証",
	"test_block.mode.fail": "失敗",
	"test_block.mode.log": "ログ",
	"test_block.mode.start": "開始",
	"test_block.mode_info.accept": "認証モード - テスト（の一部）の成功を認証します",
	"test_block.mode_info.fail": "失敗モード - テストを失敗させます",
	"test_block.mode_info.log": "ログモード - メッセージをログに出力します",
	"test_block.mode_info.start": "開始モード - テストの起点となります",
	"test_instance.action.reset": "リセットして読み込む",
	"test_instance.action.run": "読み込んで実行",
	"test_instance.action.save": "構造物を保存",
	"test_instance.description.batch": "環境：%s",
	"test_instance.description.failed": "失敗：%s",
	"test_instance.description.function": "関数：%s",
	"test_instance.description.invalid_id": "無効なテストID",
	"test_instance.description.no_test": "そのテストは存在しません",
	"test_instance.description.structure": "構造物：%s",
	"test_instance.description.type": "タイプ：%s",
	"test_instance.type.block_based": "ブロックベース型テスト",
	"test_instance.type.function": "ビルトイン関数型テスト",
	"test_instance_block.entities": "エンティティ：",
	"test_instance_block.error.no_test": "未定義のテストが存在しているため、%s, %s, %sでテストインスタンスを実行できません",
	"test_instance_block.error.no_test_structure": "テスト構造物が設定されていないため、%s, %s, %sにあるテストインスタンスを実行できません",
	"test_instance_block.error.unable_to_save": "%s, %s, %sにあるテストインスタンスのテスト構造物テンプレートを保存できません",
	"test_instance_block.invalid": "[無効]",
	"test_instance_block.reset_success": "テストのリセットが成功しました：%s",
	"test_instance_block.rotation": "回転：",
	"test_instance_block.size": "テスト構造物のサイズ",
	"test_instance_block.starting": "テスト%sを開始します",
	"test_instance_block.test_id": "テストインスタンスID",
	...
	"title.credits": "Copyright Mojang AB. 配布禁止！",
	"title.multiplayer.disabled": "マルチプレイが無効になっています。Microsoftアカウントの設定をご確認ください。",
	"title.multiplayer.disabled.banned.name": "オンラインでプレイするには名前の変更が必要です",
	...
	"title.multiplayer.online": "マルチプレイ（オンライン）",
	...
	"trim_material.minecraft.amethyst": "アメジスト素材",
	"trim_material.minecraft.copper": "銅素材",
	"trim_material.minecraft.diamond": "ダイヤモンド素材",
	"trim_material.minecraft.emerald": "エメラルド素材",
	"trim_material.minecraft.gold": "金素材",
	"trim_material.minecraft.iron": "鉄素材",
	"trim_material.minecraft.lapis": "ラピスラズリ素材",
	"trim_material.minecraft.netherite": "ネザライト素材",
	"trim_material.minecraft.quartz": "ネザークォーツ素材",
	"trim_material.minecraft.redstone": "レッドストーン素材",
	"trim_material.minecraft.resin": "樹脂素材",
	"trim_pattern.minecraft.bolt": "ネジ止め風の装飾",
	"trim_pattern.minecraft.coast": "海洋風の装飾",
	"trim_pattern.minecraft.dune": "砂丘風の装飾",
	"trim_pattern.minecraft.eye": "エンダーアイ風の装飾",
	"trim_pattern.minecraft.flow": "旋風の装飾",
	...
	"trim_pattern.minecraft.wild": "大自然風の装飾",
	"tutorial.bundleInsert.description": "右クリックでアイテムを収納します",
	"tutorial.bundleInsert.title": "バンドルを使ってみましょう",
	...
	"tutorial.socialInteractions.description": "%sで開きます",
	"tutorial.socialInteractions.title": "社交設定",
	"upgrade.minecraft.netherite_upgrade": "ネザライト強化",
	"upgradeWorld.aborted.message": "これはアップグレード中に別のプログラムがワールドにアクセスした場合に発生する可能性があります。\nコンピューターを再起動して、もう一度試してみてください。それでも問題が解決しない場合は、不具合の報告をご検討ください。",
	"upgradeWorld.aborted.reportBug": "バグを報告",
	"upgradeWorld.aborted.title": "ワールドのアップグレードに失敗しました",
	"upgradeWorld.canceled.message": "ワールドは元の状態のままになります。",
	"upgradeWorld.canceled.title": "ワールドのアップグレードがキャンセルされました",
	"upgradeWorld.done": "ワールドアップグレード完了",
	"upgradeWorld.failed_cleanup.message": "ワールドの現在のバージョンへのアップグレードが完了し、ワールド一覧から利用できるようになりました。\n古いデータの削除時に問題が発生したため、ワールドのフォルダ名は%sに変更されました。",
	"upgradeWorld.failed_cleanup.title": "ワールドをアップグレードしました",
	"upgradeWorld.info.converted": "アップグレード済み：%s",
	"upgradeWorld.info.file_fix_stage": "段階：%s／%s",
	"upgradeWorld.info.scanning": "ファイルをスキャン中…",
	"upgradeWorld.info.total": "総数：%s",
	"upgradeWorld.joinNow": "このままワールドに入りますか？",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "ファイルを移動中",
	"upgradeWorld.progress.type.legacy_structures": "旧型式の構造物をアップグレード中",
	"upgradeWorld.progress.type.region": "リージョンをアップグレード中",
	"upgradeWorld.symlink.message": "選択されたワールドにはシンボリックリンクが含まれています。\n現在のバージョンへのワールドのアップグレードに必要なステップは、シンボリックリンクの使用に対応していません。ワールドをアップグレードするには、先にリンクを解決してください。",
	"upgradeWorld.symlink.title": "ワールドをアップグレードできません",
	"upgradeWorld.title": "ワールドをアップグレード中",
}
