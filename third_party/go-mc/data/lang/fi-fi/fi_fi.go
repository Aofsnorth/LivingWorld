// Code generated by tools/gen_lang.go from 26.1/fi_fi.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Esteettömyysasetukset...",
	"accessibility.onboarding.accessibility.button.narration": "Saavutettavuusasetukset",
	...
	"advMode.notEnabled": "Komentokuutio ei ole käytössä",
	"advMode.notEnabled.spawner": "Luojakuutiot eivät ole käytössä",
	"advMode.previousOutput": "Edellinen suorite",
	"advMode.setCommand": "Aseta kuutiolle konsolikomento",
	"advMode.setCommand.disabled": "Komento asetettu: %s, mutta komentokuutiot eivät silti ole käytössä",
	...
	"advancements.adventure.blowback.description": "Tapa viima torjumalla sen itsensä ampuma puhuripallo sitä päin",
	"advancements.adventure.blowback.title": "Suuri puhallus",
	"advancements.adventure.brush_armadillo.description": "Hanki suomuja vyötiäiseltä käyttämällä sivellintä",
	"advancements.adventure.brush_armadillo.title": "Suo mulle suomuja",
	...
	"advancements.adventure.crafters_crafting_crafters.description": "Ole työstimen lähellä, kun se työstää työstimen",
	"advancements.adventure.crafters_crafting_crafters.title": "Työstimet työstämässä työstimiä",
	"advancements.adventure.fall_from_world_height.description": "Putoa maailman korkeimmasta kohdasta (rakentamisen korkeusrajalta) matalimpaan kuolematta",
	"advancements.adventure.fall_from_world_height.title": "Luolat ja jyrkänteet",
	"advancements.adventure.heart_transplanter.description": "Aseta narahteleva sydän oikeaan asentoon kahden kalvastammihalon väliin",
	"advancements.adventure.heart_transplanter.title": "Sydämensiirtäjä",
	...
	"advancements.adventure.lighten_up.description": "Raaputa kuparilamppua kirveellä tehdäksesi siitä kirkkaamman",
	"advancements.adventure.lighten_up.title": "Tulkoon valo",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Astu Koetuksen kammioon",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Koetusversio",
	"advancements.adventure.ol_betsy.description": "Ammu varsijousella",
	"advancements.adventure.ol_betsy.title": "Vanha Betsy",
	"advancements.adventure.overoverkill.description": "Tee 50 sydämen verran vahinkoa yhdellä nuijan iskulla",
	"advancements.adventure.overoverkill.title": "Ylilyöntien ylilyönti",
	...
	"advancements.adventure.revaulting.description": "Avaa pahaenteinen holvi pahaenteisellä koetuksen avaimella",
	"advancements.adventure.revaulting.title": "Holvi? Ei, jotain parempaa",
	"advancements.adventure.root.description": "Seikkailua, tutkimista ja taistelua",
	"advancements.adventure.root.title": "Seikkailu",
	"advancements.adventure.salvage_sherd.description": "Harjaa epäilyttävää kuutiota saadaksesi ruukunsirpaleen",
	...
	"advancements.adventure.spear_many_mobs.description": "Osu viiteen olentoon samalla keihään iskulla",
	"advancements.adventure.spear_many_mobs.title": "Keihäsvarras",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Käytä tornin, kärsäin, kylkiluiden, wardenin, hiljaisuuden, piinan, vuorovetten sekä tiennäyttäjän haarniskakoristeiden taontamalleja vähintään kerran",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Taontaa tyylillä",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Työstä koristeltu haarniska takomispöydällä",
	...
	"advancements.adventure.under_lock_and_key.description": "Avaa holvi koetuksen avaimella",
	"advancements.adventure.under_lock_and_key.title": "Lukkojen takana",
	"advancements.adventure.use_lodestone.description": "Käytä kompassia magneettikiveen",
	"advancements.adventure.use_lodestone.title": "Anna mun ajaa mökkitie",
	...
	"advancements.adventure.who_needs_rockets.description": "Käytä puhuripalloa laukaistaksesi itsesi 8 kuutiota ylöspäin",
	"advancements.adventure.who_needs_rockets.title": "Kuka tarvitsee raketteja?",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Aseta kuivunut ghast veteen",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Pysy nesteytettynä!",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Poista sudelta haarniska käyttämällä keritsimiä",
	"advancements.husbandry.remove_wolf_armor.title": "Nips, naps!",
	"advancements.husbandry.repair_wolf_armor.description": "Korjaa vahingoittunut suden haarniska vyötiäisen suomuilla",
	"advancements.husbandry.repair_wolf_armor.title": "Kuin uusi",
	...
	"advancements.husbandry.silk_touch_nest.description": "Siirrä mehiläispesää, jossa on 3 mehiläistä, silkkisen kosketuksen avulla",
	...
	"advancements.husbandry.uh_oh.description": "Anna rikkikuution imeä TNT-kuutio itseensä",
	"advancements.husbandry.uh_oh.title": "O-ou",
	...
	"advancements.husbandry.whole_pack.description": "Kesytä kaikki susirodut",
	"advancements.husbandry.whole_pack.title": "Koko lauma kasassa",
	...
	"advancements.nether.fast_travel.description": "Matkusta Netherin kautta 7 km ylämaailmassa",
	...
	"argument.double.big": "Desimaali ei voi olla suurempi kuin %s: sinulla on %s",
	"argument.double.low": "Desimaali ei voi olla pienempi kuin %s: sinulla on%s",
	...
	"argument.entity.selector.nearestEntity": "Lähin kohde",
	...
	"argument.float.big": "Liukuluku ei voi olla suurempi kuin %s: sinulla on %s",
	"argument.float.low": "Murtoarvo ei saa olla pienempi kuin %s: löydetty %s",
	"argument.gamemode.invalid": "Tuntematon pelitila: %s",
	"argument.hexcolor.invalid": "Virheellinen heksavärikoodi '%s'",
	"argument.id.invalid": "Virheellinen ID",
	"argument.id.unknown": "Tuntematon ID: %s",
	"argument.integer.big": "Kokonaisluku ei voi olla suurempi kuin %s: sinulla on %s",
	"argument.integer.low": "Kokonaisluku ei voi olla pienempi kuin %s: sinulla on %s",
	"argument.item.id.invalid": "Tuntematon esine '%s'",
	"argument.item.tag.disallowed": "Tunnisteet eivät ole sallittuja täällä; vain oikeat esineet",
	"argument.literal.incorrect": "Odotettiin kirjallista %s",
	"argument.long.big": "Pitkä kokonaisluku ei voi olla suurempi kuin %s: sinulla on %s",
	"argument.long.low": "Pitkä kokonaisluku ei voi olla pienempi kuin %s: sinulla on %s",
	"argument.message.too_long": "Keskusteluviesti oli liian pitkä (%s > enintään %s merkkiä)",
	...
	"argument.nbt.expected.compound": "Odotetiin compound-tunnistetta",
	...
	"argument.range.ints": "Vain kokonaisluvut ovat sallittuja; ei desimaaleja",
	...
	"argument.resource_or_id.failed_to_parse": "Rakennelman parsiminen epäonnistui: %s",
	"argument.resource_or_id.invalid": "Virheellinen tunniste tai tagi",
	"argument.resource_or_id.no_such_element": "Elementtiä '%s' ei löydy rekisteristä '%s'",
	"argument.resource_selector.not_found": "Ei osumia tyypin '%[2]s' valitsimelle '%[1]s'",
	...
	"argument.style.invalid": "Virheellinen tyyli: %s",
	"argument.time.invalid_tick_count": "Pykälämäärän täytyy olla epänegatiivinen",
	"argument.time.invalid_unit": "Virheellinen yksikkö",
	"argument.time.tick_count_too_low": "Pykälien määrä ei voi olla pienempi kuin %s: sinulla on %s",
	"argument.uuid.invalid": "Virheellinen UUID",
	"argument.waypoint.invalid": "Valittu kohde ei ole reittipiste",
	...
	"arguments.item.component.expected": "Odotettu esinekomponentti",
	"arguments.item.component.malformed": "Väärin muotoiltu '%s' komponentti: '%s'",
	"arguments.item.component.repeated": "Esineen komponentti '%s' toistettiin, mutta vain yksi arvo voidaan määritellä",
	"arguments.item.component.unknown": "Tuntematon esinekomponentti '%s'",
	"arguments.item.malformed": "Väärin muotoiltu esine: '%s'",
	"arguments.item.overstacked": "%s voi pinoutua vain lukuun %s",
	"arguments.item.predicate.malformed": "Väärin muotoiltu '%s' predikaatti: '%s'",
	"arguments.item.predicate.unknown": "Tuntematon esineen predikaatti '%s'",
	...
	"attribute.name.air_drag_modifier": "Ilmanvastuksen muuntaja",
	"attribute.name.armor": "Haarniska",
	"attribute.name.armor_toughness": "Haarniskan kovuus",
	"attribute.name.attack_damage": "Hyökkäysvahinko",
	"attribute.name.attack_knockback": "Hyökkäyksen työntövoima",
	"attribute.name.attack_speed": "Hyökkäysnopeus",
	"attribute.name.below_name_distance": "Nimikyltin pisteiden etäisyys",
	"attribute.name.block_break_speed": "Kuutioiden tuhoamisnopeus",
	"attribute.name.block_interaction_range": "Kuutioiden käyttöetäisyys",
	"attribute.name.bounciness": "Kimmoisuus",
	"attribute.name.burning_time": "Palamisaika",
	"attribute.name.camera_distance": "Kameran etäisyys",
	"attribute.name.entity_interaction_range": "Olioiden käyttöetäisyys",
	"attribute.name.explosion_knockback_resistance": "Räjähdyksestä johtuvan taakselyönnin vastustaminen",
	"attribute.name.fall_damage_multiplier": "Putoamisvahingon kerroin",
	"attribute.name.flying_speed": "Lentonopeus",
	"attribute.name.follow_range": "Olion seurantaetäisyys",
	"attribute.name.friction_modifier": "Kitkan muuntaja",
	...
	"attribute.name.generic.block_interaction_range": "Kuutioiden käyttöetäisyys",
	"attribute.name.generic.burning_time": "Palamisaika",
	"attribute.name.generic.entity_interaction_range": "Olioiden käyttöetäisyys",
	"attribute.name.generic.explosion_knockback_resistance": "Räjähdyksestä johtuvan taakselyönnin vastustaminen",
	"attribute.name.generic.fall_damage_multiplier": "Putoamisvahingon kerroin",
	"attribute.name.generic.flying_speed": "Lentonopeus",
	"attribute.name.generic.follow_range": "Olion seurantaetäisyys",
	"attribute.name.generic.gravity": "Painovoima",
	"attribute.name.generic.jump_strength": "Hypyn voimakkuus",
	"attribute.name.generic.knockback_resistance": "Taakselyönnin vastustaminen",
	"attribute.name.generic.luck": "Onni",
	"attribute.name.generic.max_absorption": "Enimmäisimeytyminen",
	"attribute.name.generic.max_health": "Maksimi elinvoima",
	"attribute.name.generic.movement_efficiency": "Liikkumistehokkuus",
	"attribute.name.generic.movement_speed": "Nopeus",
	"attribute.name.generic.oxygen_bonus": "Happietu",
	"attribute.name.generic.safe_fall_distance": "Turvallinen putoamisetäisyys",
	"attribute.name.generic.scale": "Koko",
	"attribute.name.generic.step_height": "Askelkorkeus",
	"attribute.name.generic.water_movement_efficiency": "Vedessä liikkumisen tehokkuus",
	"attribute.name.gravity": "Painovoima",
	"attribute.name.horse.jump_strength": "Hevosen hyppyvoimakkuus",
	"attribute.name.jump_strength": "Hypyn voimakkuus",
	"attribute.name.knockback_resistance": "Taakselyönnin vastustaminen",
	"attribute.name.luck": "Onni",
	"attribute.name.max_absorption": "Enimmäisimeytyminen",
	"attribute.name.max_health": "Enimmäiselinvoima",
	"attribute.name.mining_efficiency": "Louhintatehokkuus",
	"attribute.name.movement_efficiency": "Liikkumistehokkuus",
	"attribute.name.movement_speed": "Nopeus",
	"attribute.name.nameplate_distance": "Nimikyltin etäisyys",
	"attribute.name.oxygen_bonus": "Happietu",
	"attribute.name.player.block_break_speed": "Kuutioiden tuhoamisnopeus",
	"attribute.name.player.block_interaction_range": "Kuutioiden käyttöetäisyys",
	"attribute.name.player.entity_interaction_range": "Olioiden käyttöetäisyys",
	"attribute.name.player.mining_efficiency": "Louhintatehokkuus",
	"attribute.name.player.sneaking_speed": "Hiipimisnopeus",
	"attribute.name.player.submerged_mining_speed": "Louhimisnopeus upoksissa",
	"attribute.name.player.sweeping_damage_ratio": "Kiitävän iskun vahinkosuhde",
	"attribute.name.safe_fall_distance": "Turvallinen putoamisetäisyys",
	"attribute.name.scale": "Koko",
	"attribute.name.sneaking_speed": "Hiipimisnopeus",
	"attribute.name.spawn_reinforcements": "Zombivahvistusjoukot",
	"attribute.name.step_height": "Askelkorkeus",
	"attribute.name.submerged_mining_speed": "Louhimisnopeus upoksissa",
	"attribute.name.sweeping_damage_ratio": "Kiitävän iskun vahinkosuhde",
	"attribute.name.tempt_range": "Olennon houkutteluetäisyys",
	"attribute.name.water_movement_efficiency": "Vedessä liikkumisen tehokkuus",
	"attribute.name.waypoint_receive_range": "Reittipisteen vastaanottoetäisyys",
	"attribute.name.waypoint_transmit_range": "Reittipisteen lähetysetäisyys",
	...
	"biome.minecraft.pale_garden": "Kalvastarha",
	...
	"biome.minecraft.sulfur_caves": "Rikkiluolat",
	...
	"block.minecraft.acacia_shelf": "Akaasiahylly",
	...
	"block.minecraft.acacia_wall_hanging_sign": "Riippuva akaasiakyltti",
	...
	"block.minecraft.attached_melon_stem": "Kytkeytynyt melonin varsi",
	...
	"block.minecraft.bamboo_shelf": "Bambuhylly",
	...
	"block.minecraft.bamboo_wall_hanging_sign": "Riippuva bambukyltti",
	...
	"block.minecraft.banner.base.lime": "Täysin limetinvihreä pohja",
	"block.minecraft.banner.base.magenta": "Täysin purppura pohja",
	...
	"block.minecraft.banner.creeper.black": "Musta creeper",
	"block.minecraft.banner.creeper.blue": "Sininen creeper",
	"block.minecraft.banner.creeper.brown": "Ruskea creeper",
	"block.minecraft.banner.creeper.cyan": "Syaani creeper",
	"block.minecraft.banner.creeper.gray": "Harmaa creeper",
	"block.minecraft.banner.creeper.green": "Vihreä creeper",
	"block.minecraft.banner.creeper.light_blue": "Vaaleansininen creeper",
	"block.minecraft.banner.creeper.light_gray": "Vaaleanharmaa creeper",
	"block.minecraft.banner.creeper.lime": "Limetinvihreä creeper",
	"block.minecraft.banner.creeper.magenta": "Purppura creeper",
	"block.minecraft.banner.creeper.orange": "Oranssi creeper",
	"block.minecraft.banner.creeper.pink": "Vaaleanpunainen creeper",
	"block.minecraft.banner.creeper.purple": "Violetti creeper",
	"block.minecraft.banner.creeper.red": "Punainen creeper",
	"block.minecraft.banner.creeper.white": "Valkoinen creeper",
	"block.minecraft.banner.creeper.yellow": "Keltainen creeper",
	...
	"block.minecraft.banner.flow.black": "Musta virtaus",
	"block.minecraft.banner.flow.blue": "Sininen virtaus",
	"block.minecraft.banner.flow.brown": "Ruskea virtaus",
	"block.minecraft.banner.flow.cyan": "Syaani virtaus",
	"block.minecraft.banner.flow.gray": "Harmaa virtaus",
	"block.minecraft.banner.flow.green": "Vihreä virtaus",
	"block.minecraft.banner.flow.light_blue": "Vaaleansininen virtaus",
	"block.minecraft.banner.flow.light_gray": "Vaaleanharmaa virtaus",
	"block.minecraft.banner.flow.lime": "Limetinvihreä virtaus",
	"block.minecraft.banner.flow.magenta": "Purppura virtaus",
	"block.minecraft.banner.flow.orange": "Oranssi virtaus",
	"block.minecraft.banner.flow.pink": "Vaaleanpunainen virtaus",
	"block.minecraft.banner.flow.purple": "Violetti virtaus",
	"block.minecraft.banner.flow.red": "Punainen virtaus",
	"block.minecraft.banner.flow.white": "Valkoinen virtaus",
	"block.minecraft.banner.flow.yellow": "Keltainen virtaus",
	"block.minecraft.banner.flower.black": "Musta kukka",
	"block.minecraft.banner.flower.blue": "Sininen kukka",
	"block.minecraft.banner.flower.brown": "Ruskea kukka",
	"block.minecraft.banner.flower.cyan": "Syaani kukka",
	"block.minecraft.banner.flower.gray": "Harmaa kukka",
	"block.minecraft.banner.flower.green": "Vihreä kukka",
	"block.minecraft.banner.flower.light_blue": "Vaaleansininen kukka",
	"block.minecraft.banner.flower.light_gray": "Vaaleanharmaa kukka",
	"block.minecraft.banner.flower.lime": "Limetinvihreä kukka",
	"block.minecraft.banner.flower.magenta": "Purppura kukka",
	"block.minecraft.banner.flower.orange": "Oranssi kukka",
	"block.minecraft.banner.flower.pink": "Vaaleanpunainen kukka",
	"block.minecraft.banner.flower.purple": "Violetti kukka",
	"block.minecraft.banner.flower.red": "Punainen kukka",
	"block.minecraft.banner.flower.white": "Valkoinen kukka",
	"block.minecraft.banner.flower.yellow": "Keltainen kukka",
	...
	"block.minecraft.banner.guster.black": "Musta tuulahdus",
	"block.minecraft.banner.guster.blue": "Sininen tuulahdus",
	"block.minecraft.banner.guster.brown": "Ruskea tuulahdus",
	"block.minecraft.banner.guster.cyan": "Syaani tuulahdus",
	"block.minecraft.banner.guster.gray": "Harmaa tuulahdus",
	"block.minecraft.banner.guster.green": "Vihreä tuulahdus",
	"block.minecraft.banner.guster.light_blue": "Vaaleansininen tuulahdus",
	"block.minecraft.banner.guster.light_gray": "Vaaleanharmaa tuulahdus",
	"block.minecraft.banner.guster.lime": "Limetinvihreä tuulahdus",
	"block.minecraft.banner.guster.magenta": "Purppura tuulahdus",
	"block.minecraft.banner.guster.orange": "Oranssi tuulahdus",
	"block.minecraft.banner.guster.pink": "Vaaleanpunainen tuulahdus",
	"block.minecraft.banner.guster.purple": "Violetti tuulahdus",
	"block.minecraft.banner.guster.red": "Punainen tuulahdus",
	"block.minecraft.banner.guster.white": "Valkoinen tuulahdus",
	"block.minecraft.banner.guster.yellow": "Keltainen tuulahdus",
	...
	"block.minecraft.banner.half_vertical.lime": "Limetinvihreä halkoinen",
	...
	"block.minecraft.banner.skull.black": "Musta pääkallo",
	"block.minecraft.banner.skull.blue": "Sininen pääkallo",
	"block.minecraft.banner.skull.brown": "Ruskea pääkallo",
	"block.minecraft.banner.skull.cyan": "Syaani pääkallo",
	"block.minecraft.banner.skull.gray": "Harmaa pääkallo",
	"block.minecraft.banner.skull.green": "Vihreä pääkallo",
	"block.minecraft.banner.skull.light_blue": "Vaaleansininen pääkallo",
	"block.minecraft.banner.skull.light_gray": "Vaaleanharmaa pääkallo",
	"block.minecraft.banner.skull.lime": "Limetinvihreä pääkallo",
	"block.minecraft.banner.skull.magenta": "Purppura pääkallo",
	"block.minecraft.banner.skull.orange": "Oranssi pääkallo",
	"block.minecraft.banner.skull.pink": "Vaaleanpunainen pääkallo",
	"block.minecraft.banner.skull.purple": "Violetti pääkallo",
	"block.minecraft.banner.skull.red": "Punainen pääkallo",
	"block.minecraft.banner.skull.white": "Valkoinen pääkallo",
	"block.minecraft.banner.skull.yellow": "Keltainen pääkallo",
	...
	"block.minecraft.birch_shelf": "Koivuhylly",
	...
	"block.minecraft.birch_wall_hanging_sign": "Riippuva koivukyltti",
	...
	"block.minecraft.bush": "Pensas",
	"block.minecraft.cactus": "Kaktus",
	"block.minecraft.cactus_flower": "Kaktuksen kukka",
	...
	"block.minecraft.cherry_shelf": "Kirsikkapuuhylly",
	...
	"block.minecraft.cherry_wall_hanging_sign": "Riippuva kirsikkapuukyltti",
	...
	"block.minecraft.chiseled_cinnabar": "Kaiverrettu sinooperi",
	"block.minecraft.chiseled_copper": "Kaiverrettu kupari",
	"block.minecraft.chiseled_deepslate": "Kaiverrettu pohjaliuskekivi",
	"block.minecraft.chiseled_nether_bricks": "Kaiverretut Nether-tiilet",
	...
	"block.minecraft.chiseled_resin_bricks": "Kaiverretut pihkatiilet",
	"block.minecraft.chiseled_sandstone": "Kaiverrettu hiekkakivi",
	"block.minecraft.chiseled_stone_bricks": "Kaiverretut kivitiilet",
	"block.minecraft.chiseled_sulfur": "Kaiverrettu rikki",
	"block.minecraft.chiseled_tuff": "Kaiverrettu tuffi",
	"block.minecraft.chiseled_tuff_bricks": "Kaiverretut tuffitiilet",
	"block.minecraft.chorus_flower": "Chorus-kukka",
	"block.minecraft.chorus_plant": "Chorus-kasvi",
	"block.minecraft.cinnabar": "Sinooperi",
	"block.minecraft.cinnabar_brick_slab": "Sinooperitiililaatta",
	"block.minecraft.cinnabar_brick_stairs": "Sinooperitiiliportaat",
	"block.minecraft.cinnabar_brick_wall": "Sinooperitiilimuuri",
	"block.minecraft.cinnabar_bricks": "Sinooperitiilet",
	"block.minecraft.cinnabar_slab": "Sinooperilaatta",
	"block.minecraft.cinnabar_stairs": "Sinooperiportaat",
	"block.minecraft.cinnabar_wall": "Sinooperimuuri",
	"block.minecraft.clay": "Savi",
	"block.minecraft.closed_eyeblossom": "Sulkeutunut silmäkukka",
	...
	"block.minecraft.copper_bars": "Kuparikalterit",
	"block.minecraft.copper_block": "Kuparikuutio",
	"block.minecraft.copper_bulb": "Kuparilamppu",
	"block.minecraft.copper_chain": "Kupariketju",
	"block.minecraft.copper_chest": "Kupariarkku",
	"block.minecraft.copper_door": "Kupariovi",
	"block.minecraft.copper_golem_statue": "Kuparigolempatsas",
	"block.minecraft.copper_grate": "Kupariritilä",
	"block.minecraft.copper_lantern": "Kuparilyhty",
	"block.minecraft.copper_ore": "Kuparimalmi",
	"block.minecraft.copper_torch": "Kuparisoihtu",
	"block.minecraft.copper_trapdoor": "Kupariluukku",
	"block.minecraft.copper_wall_torch": "Seinälle asetettu kuparisoihtu",
	"block.minecraft.cornflower": "Ruiskaunokki",
	"block.minecraft.cracked_deepslate_bricks": "Murtuneet pohjaliuskekivitiilet",
	"block.minecraft.cracked_deepslate_tiles": "Murtuneet pohjaliuskekivikaakelit",
	"block.minecraft.cracked_nether_bricks": "Murtuneet Nether-tiilet",
	"block.minecraft.cracked_polished_blackstone_bricks": "Murtuneet kiillotetut mustakivitiilet",
	"block.minecraft.cracked_stone_bricks": "Murtunet kivitiilet",
	"block.minecraft.crafter": "Työstin",
	"block.minecraft.crafting_table": "Työpöytä",
	"block.minecraft.creaking_heart": "Narahteleva sydän",
	...
	"block.minecraft.crimson_shelf": "Karmiinihylly",
	...
	"block.minecraft.crimson_wall_hanging_sign": "Riippuva karmiinikyltti",
	...
	"block.minecraft.dark_oak_shelf": "Tumma tammihylly",
	...
	"block.minecraft.dark_oak_wall_hanging_sign": "Riippuva tumma tammikyltti",
	...
	"block.minecraft.deepslate_bricks": "Pohjaliuskekivitiilet",
	...
	"block.minecraft.deepslate_tile_wall": "Pohjaliuskekivikaakelimuuri",
	...
	"block.minecraft.dried_ghast": "Kuivunut ghast",
	...
	"block.minecraft.end_stone_bricks": "End-kivitiilet",
	"block.minecraft.ender_chest": "Ender-arkku",
	"block.minecraft.exposed_chiseled_copper": "Altistunut kaiverrettu kupari",
	"block.minecraft.exposed_copper": "Altistunut kupari",
	"block.minecraft.exposed_copper_bars": "Altistuneet kuparikalterit",
	"block.minecraft.exposed_copper_bulb": "Altistunut kuparilamppu",
	"block.minecraft.exposed_copper_chain": "Altistunut kupariketju",
	"block.minecraft.exposed_copper_chest": "Altistunut kupariarkku",
	"block.minecraft.exposed_copper_door": "Altistunut kupariovi",
	"block.minecraft.exposed_copper_golem_statue": "Altistunut kuparigolempatsas",
	"block.minecraft.exposed_copper_grate": "Altistunut kupariritilä",
	"block.minecraft.exposed_copper_lantern": "Altistunut kuparilyhty",
	"block.minecraft.exposed_copper_trapdoor": "Altistunut kupariluukku",
	...
	"block.minecraft.exposed_lightning_rod": "Altistunut ukkosenjohdatin",
	...
	"block.minecraft.firefly_bush": "Tulikärpäspensas",
	...
	"block.minecraft.golden_dandelion": "Kultainen voikukka",
	...
	"block.minecraft.heavy_core": "Raskas ydin",
	...
	"block.minecraft.infested_chiseled_stone_bricks": "Saastuneet kaiverretut kivitiilet",
	"block.minecraft.infested_cobblestone": "Saastunut mukulakivi",
	"block.minecraft.infested_cracked_stone_bricks": "Saastuneet murtuneet kivitiilet",
	"block.minecraft.infested_deepslate": "Saastunut pohjaliuskekivi",
	"block.minecraft.infested_mossy_stone_bricks": "Saastuneet sammaleiset kivitiilet",
	"block.minecraft.infested_stone": "Saastunut kivi",
	"block.minecraft.infested_stone_bricks": "Saastuneet kivitiilet",
	"block.minecraft.iron_bars": "Rautakalterit",
	"block.minecraft.iron_block": "Rautakuutio",
	"block.minecraft.iron_chain": "Rautaketju",
	...
	"block.minecraft.jungle_shelf": "Viidakkopuuhylly",
	...
	"block.minecraft.jungle_wall_hanging_sign": "Riippuva viidakkopuukyltti",
	...
	"block.minecraft.leaf_litter": "Lehtikarike",
	...
	"block.minecraft.mangrove_shelf": "Mangrovepuuhylly",
	...
	"block.minecraft.mangrove_wall_hanging_sign": "Riippuva mangrovepuukyltti",
	...
	"block.minecraft.mossy_cobblestone_wall": "Sammaleinen mukulakivimuuri",
	...
	"block.minecraft.mossy_stone_bricks": "Sammaleiset kivitiilet",
	...
	"block.minecraft.mud_bricks": "Mutatiilet",
	...
	"block.minecraft.nether_bricks": "Nether-tiilet",
	...
	"block.minecraft.oak_shelf": "Tammihylly",
	...
	"block.minecraft.oak_wall_hanging_sign": "Riippuva tammikyltti",
	...
	"block.minecraft.open_eyeblossom": "Avautunut silmäkukka",
	...
	"block.minecraft.oxidized_chiseled_copper": "Hapettunut kaiverrettu kupari",
	"block.minecraft.oxidized_copper": "Hapettunut kupari",
	"block.minecraft.oxidized_copper_bars": "Hapettuneet kuparikalterit",
	"block.minecraft.oxidized_copper_bulb": "Hapettunut kuparilamppu",
	"block.minecraft.oxidized_copper_chain": "Hapettunut kupariketju",
	"block.minecraft.oxidized_copper_chest": "Hapettunut kupariarkku",
	"block.minecraft.oxidized_copper_door": "Hapettunut kupariovi",
	"block.minecraft.oxidized_copper_golem_statue": "Hapettunut kuparigolempatsas",
	"block.minecraft.oxidized_copper_grate": "Hapettunut kupariritilä",
	"block.minecraft.oxidized_copper_lantern": "Hapettunut kuparilyhty",
	"block.minecraft.oxidized_copper_trapdoor": "Hapettunut kupariluukku",
	...
	"block.minecraft.oxidized_lightning_rod": "Hapettunut ukkosenjohdatin",
	"block.minecraft.packed_ice": "Pakkautunut jää",
	"block.minecraft.packed_mud": "Pakkautunut muta",
	"block.minecraft.pale_hanging_moss": "Roikkuva kalvassammal",
	"block.minecraft.pale_moss_block": "Kalvassammalkuutio",
	"block.minecraft.pale_moss_carpet": "Kalvassammalmatto",
	"block.minecraft.pale_oak_button": "Kalvastamminappi",
	"block.minecraft.pale_oak_door": "Kalvastammiovi",
	"block.minecraft.pale_oak_fence": "Kalvastammiaita",
	"block.minecraft.pale_oak_fence_gate": "Kalvastammiportti",
	"block.minecraft.pale_oak_hanging_sign": "Roikkuva kalvastammikyltti",
	"block.minecraft.pale_oak_leaves": "Kalvastammenlehdet",
	"block.minecraft.pale_oak_log": "Kalvastammihalko",
	"block.minecraft.pale_oak_planks": "Kalvastammilankut",
	"block.minecraft.pale_oak_pressure_plate": "Kalvastammipainelaatta",
	"block.minecraft.pale_oak_sapling": "Kalvastammen taimi",
	"block.minecraft.pale_oak_shelf": "Kalvastammihylly",
	"block.minecraft.pale_oak_sign": "Kalvastammikyltti",
	"block.minecraft.pale_oak_slab": "Kalvastammilaatta",
	"block.minecraft.pale_oak_stairs": "Kalvastammiportaat",
	"block.minecraft.pale_oak_trapdoor": "Kalvastammiluukku",
	"block.minecraft.pale_oak_wall_hanging_sign": "Riippuva kalvastammikyltti",
	"block.minecraft.pale_oak_wall_sign": "Ripustettu kalvastammikyltti",
	"block.minecraft.pale_oak_wood": "Kalvastammipuu",
	...
	"block.minecraft.polished_andesite_stairs": "Kiillotetut andesiittiportaat",
	...
	"block.minecraft.polished_blackstone_bricks": "Kiillotetut mustakivitiilet",
	...
	"block.minecraft.polished_cinnabar": "Kiillotettu sinooperi",
	"block.minecraft.polished_cinnabar_slab": "Kiillotettu sinooperilaatta",
	"block.minecraft.polished_cinnabar_stairs": "Kiillotetut sinooperiportaat",
	"block.minecraft.polished_cinnabar_wall": "Kiillotettu sinooperimuuri",
	...
	"block.minecraft.polished_deepslate_wall": "Kiillotettu pohjaliuskekivimuuri",
	...
	"block.minecraft.polished_sulfur": "Kiillotettu rikki",
	"block.minecraft.polished_sulfur_slab": "Kiillotettu rikkilaatta",
	"block.minecraft.polished_sulfur_stairs": "Kiillotetut rikkiportaat",
	"block.minecraft.polished_sulfur_wall": "Kiillotettu rikkimuuri",
	"block.minecraft.polished_tuff": "Kiillotettu tuffi",
	"block.minecraft.polished_tuff_slab": "Kiillotettu tuffilaatta",
	"block.minecraft.polished_tuff_stairs": "Kiillotetut tuffiportaat",
	"block.minecraft.polished_tuff_wall": "Kiillotettu tuffimuuri",
	"block.minecraft.poppy": "Unikko",
	"block.minecraft.potatoes": "Peruna",
	"block.minecraft.potent_sulfur": "Väkevä rikki",
	...
	"block.minecraft.potted_azure_bluet": "Istutettu keijunsilmä",
	...
	"block.minecraft.potted_closed_eyeblossom": "Istutettu sulkeutunut silmäkukka",
	...
	"block.minecraft.potted_golden_dandelion": "Istutettu kultainen voikukka",
	...
	"block.minecraft.potted_open_eyeblossom": "Istutettu avautunut silmäkukka",
	...
	"block.minecraft.potted_pale_oak_sapling": "Istutettu kalvastammen taimi",
	...
	"block.minecraft.prismarine_bricks": "Prismariinitiilet",
	...
	"block.minecraft.quartz_bricks": "Kvartsitiilet",
	...
	"block.minecraft.red_nether_bricks": "Punaiset Nether-tiilet",
	...
	"block.minecraft.resin_block": "Pihkakuutio",
	"block.minecraft.resin_brick_slab": "Pihkatiililaatta",
	"block.minecraft.resin_brick_stairs": "Pihkatiiliportaat",
	"block.minecraft.resin_brick_wall": "Pihkatiilimuuri",
	"block.minecraft.resin_bricks": "Pihkatiilet",
	"block.minecraft.resin_clump": "Pihkakimpale",
	...
	"block.minecraft.short_dry_grass": "Lyhyt kuiva ruoho",
	"block.minecraft.short_grass": "Lyhyt ruoho",
	...
	"block.minecraft.spruce_shelf": "Kuusihylly",
	...
	"block.minecraft.spruce_wall_hanging_sign": "Riippuva kuusikyltti",
	...
	"block.minecraft.stone_bricks": "Kivitiilet",
	...
	"block.minecraft.stripped_pale_oak_log": "Kuorittu kalvastammihalko",
	"block.minecraft.stripped_pale_oak_wood": "Kuorittu kalvastammi",
	...
	"block.minecraft.structure_block": "Rakennelmakuutio",
	"block.minecraft.structure_void": "Rakennelmatyhjiö",
	"block.minecraft.sugar_cane": "Sokeriruoko",
	"block.minecraft.sulfur": "Rikki",
	"block.minecraft.sulfur_brick_slab": "Rikkitiililaatta",
	"block.minecraft.sulfur_brick_stairs": "Rikkitiiliportaat",
	"block.minecraft.sulfur_brick_wall": "Rikkitiilimuuri",
	"block.minecraft.sulfur_bricks": "Rikkitiilet",
	"block.minecraft.sulfur_slab": "Rikkilaatta",
	"block.minecraft.sulfur_spike": "Rikkipiikki",
	"block.minecraft.sulfur_stairs": "Rikkiportaat",
	"block.minecraft.sulfur_wall": "Rikkimuuri",
	...
	"block.minecraft.tall_dry_grass": "Pitkä kuiva ruoho",
	...
	"block.minecraft.test_block": "Testikuutio",
	"block.minecraft.test_instance_block": "Testitapauskuutio",
	"block.minecraft.tinted_glass": "Tummennettu lasi",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "TNT:n räjähdykset ovat poissa käytöstä",
	...
	"block.minecraft.trial_spawner": "Koetuksen luojakuutio",
	...
	"block.minecraft.tuff_brick_slab": "Tuffitiililaatta",
	"block.minecraft.tuff_brick_stairs": "Tuffitiiliportaat",
	"block.minecraft.tuff_brick_wall": "Tuffitiilimuuri",
	"block.minecraft.tuff_bricks": "Tuffitiilet",
	"block.minecraft.tuff_slab": "Tuffilaatta",
	"block.minecraft.tuff_stairs": "Tuffiportaat",
	"block.minecraft.tuff_wall": "Tuffimuuri",
	...
	"block.minecraft.warped_shelf": "Kummahylly",
	...
	"block.minecraft.warped_wall_hanging_sign": "Riippuva kummakyltti",
	...
	"block.minecraft.waxed_chiseled_copper": "Vahattu kaiverrettu kupari",
	"block.minecraft.waxed_copper_bars": "Vahatut kuparikalterit",
	"block.minecraft.waxed_copper_block": "Vahattu kuparikuutio",
	"block.minecraft.waxed_copper_bulb": "Vahattu kuparilamppu",
	"block.minecraft.waxed_copper_chain": "Vahattu kupariketju",
	"block.minecraft.waxed_copper_chest": "Vahattu kupariarkku",
	"block.minecraft.waxed_copper_door": "Vahattu kupariovi",
	"block.minecraft.waxed_copper_golem_statue": "Vahattu kuparigolempatsas",
	"block.minecraft.waxed_copper_grate": "Vahattu kupariritilä",
	"block.minecraft.waxed_copper_lantern": "Vahattu kuparilyhty",
	"block.minecraft.waxed_copper_trapdoor": "Vahattu kupariluukku",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Vahattu altistunut kaiverrettu kupari",
	"block.minecraft.waxed_exposed_copper": "Vahattu altistunut kupari",
	"block.minecraft.waxed_exposed_copper_bars": "Vahatut altistuneet kuparikalterit",
	"block.minecraft.waxed_exposed_copper_bulb": "Vahattu altistunut kuparilamppu",
	"block.minecraft.waxed_exposed_copper_chain": "Vahattu altistunut kupariketju",
	"block.minecraft.waxed_exposed_copper_chest": "Vahattu altistunut kupariarkku",
	"block.minecraft.waxed_exposed_copper_door": "Vahattu altistunut kupariovi",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Vahattu altistunut kuparigolempatsas",
	"block.minecraft.waxed_exposed_copper_grate": "Vahattu altistunut kupariritilä",
	"block.minecraft.waxed_exposed_copper_lantern": "Vahattu altistunut kuparilyhty",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Vahattu altistunut kupariluukku",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Vahattu altistunut ukkosenjohdatin",
	"block.minecraft.waxed_lightning_rod": "Vahattu ukkosenjohdatin",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Vahattu hapettunut kaiverrettu kupari",
	"block.minecraft.waxed_oxidized_copper": "Vahattu hapettunut kupari",
	"block.minecraft.waxed_oxidized_copper_bars": "Vahatut hapettuneet kuparikalterit",
	"block.minecraft.waxed_oxidized_copper_bulb": "Vahattu hapettunut kuparilamppu",
	"block.minecraft.waxed_oxidized_copper_chain": "Vahattu hapettunut kupariketju",
	"block.minecraft.waxed_oxidized_copper_chest": "Vahattu hapettunut kupariarkku",
	"block.minecraft.waxed_oxidized_copper_door": "Vahattu hapettunut kupariovi",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Vahattu hapettunut kuparigolempatsas",
	"block.minecraft.waxed_oxidized_copper_grate": "Vahattu hapettunut kupariritilä",
	"block.minecraft.waxed_oxidized_copper_lantern": "Vahattu hapettunut kuparilyhty",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Vahattu hapettunut kupariluukku",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Vahattu hapettunut ukkosenjohdatin",
	"block.minecraft.waxed_weathered_chiseled_copper": "Vahattu rapautunut kaiverrettu kupari",
	"block.minecraft.waxed_weathered_copper": "Vahattu rapautunut kupari",
	"block.minecraft.waxed_weathered_copper_bars": "Vahatut rapautuneet kuparikalterit",
	"block.minecraft.waxed_weathered_copper_bulb": "Vahattu rapautunut kuparilamppu",
	"block.minecraft.waxed_weathered_copper_chain": "Vahattu rapautunut kupariketju",
	"block.minecraft.waxed_weathered_copper_chest": "Vahattu rapautunut kupariarkku",
	"block.minecraft.waxed_weathered_copper_door": "Vahattu rapautunut kupariovi",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Vahattu rapautunut kuparigolempatsas",
	"block.minecraft.waxed_weathered_copper_grate": "Vahattu rapautunut kupariritilä",
	"block.minecraft.waxed_weathered_copper_lantern": "Vahattu rapautunut kuparilyhty",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Vahattu rapautunut kupariluukku",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Vahattu rapautunut ukkosenjohdatin",
	"block.minecraft.weathered_chiseled_copper": "Rapautunut kaiverrettu kupari",
	"block.minecraft.weathered_copper": "Rapautunut kupari",
	"block.minecraft.weathered_copper_bars": "Rapautuneet kuparikalterit",
	"block.minecraft.weathered_copper_bulb": "Rapautunut kuparilamppu",
	"block.minecraft.weathered_copper_chain": "Rapautunut kupariketju",
	"block.minecraft.weathered_copper_chest": "Rapautunut kupariarkku",
	"block.minecraft.weathered_copper_door": "Rapautunut kupariovi",
	"block.minecraft.weathered_copper_golem_statue": "Rapautunut kuparigolempatsas",
	"block.minecraft.weathered_copper_grate": "Rapautunut kupariritilä",
	"block.minecraft.weathered_copper_lantern": "Rapautunut kuparilyhty",
	"block.minecraft.weathered_copper_trapdoor": "Rapautunut kupariluukku",
	...
	"block.minecraft.weathered_lightning_rod": "Rapautunut ukkosenjohdatin",
	...
	"block.minecraft.wildflowers": "Luonnonkukat",
	...
	"book.edit.title": "Kirjan muokkausnäkymä",
	...
	"book.page_button.next": "Seuraava sivu",
	"book.page_button.previous": "Edellinen sivu",
	"book.sign.title": "Kirjan allekirjoitusnäkymä",
	"book.sign.titlebox": "Nimi",
	"book.signButton": "Allekirjoita",
	"book.view.title": "Kirjan katselunäkymä",
	"build.spawn_protection": "Syntymissuojaus koskee %s:ää",
	"build.tooHigh": "Rakentamisen korkeusrajoitus on %s kuutiota",
	"build.tooLow": "Rakentamisen vähimmäiskorkeus on %s",
	...
	"chat.disabled.invalid_command_signature": "Komennolla oli odottamattomia tai puuttuvia komentoargumenttien allekirjoituksia.",
	"chat.disabled.invalid_signature": "Virhellinen allekirjoitus keskustelussa. Yritä yhdistää uudelleen.",
	"chat.disabled.launcher": "Keskustelu on poistettu käytöstä käynnistysohjelmassa. Viestiä ei voida lähettää.",
	...
	"chat.disabled.out_of_order_chat": "Keskustelu vastaanotettiin epäjärjestyksessä. Muuttuiko järjestelmäsi aika?",
	"chat.disabled.profile": "Keskustelu ei ole sallittu tilin asetuksissa. Paina '%s' uudelleen saadaksesi lisätietoa.",
	...
	"chat.queue": "[+%s rivi(ä) jonossa]",
	"chat.queue.tooltip": "Klikkaa näyttääksesi seuraavan viestin",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "Palvelin lähetti virheellisen viestin.",
	...
	"chat.validation_error": "Keskustelun vahvistamisen virhe",
	"chat_restriction.chat_and_commands_disabled_by_options": "Keskustelua on rajoitettu käyttöliittymän asetuksissa.",
	"chat_restriction.chat_disabled_by_options": "Pelaajien keskustelua on rajoitettu käyttöliittymän asetuksissa.",
	"chat_restriction.chat_disabled_by_options.action": "Mene keskusteluasetuksiin",
	"chat_restriction.disabled_by_launcher": "Keskustelua on rajoitettu käynnistysohjelmassa",
	"chat_restriction.disabled_by_profile": "Keskustelua on rajoitettu käyttäjän asetuksissa.",
	"chat_restriction.disabled_by_profile.action": "Mene käyttäjän asetuksiin",
	"chat_screen.commands_not_allowed": "Komentojen lähettäminen ei ole sallittua",
	"chat_screen.message": "Lähetettävä viesti: %s",
	"chat_screen.messages_not_allowed": "Keskusteluviestien lähettäminen ei ole sallittua",
	"chat_screen.restricted": "Keskustelua on rajoitettu. Klikkaa tätä viestiä saadaksesi lisätietoa.",
	"chat_screen.restricted.narration": "Keskustelua on rajoitettu. Mene rajoitusnäkymään maailman asetuksissa.",
	"chat_screen.title": "Keskusteluikkuna",
	"chat_screen.usage": "Syötä viesti ja paina Enter lähettääksesi",
	"chunk.toast.checkLog": "Katso lokitiedot saadaksesi lisätietoja",
	"chunk.toast.loadFailure": "Sijainnissa %s sijaitsevan lohkon lataaminen epäonnistui",
	"chunk.toast.lowDiskSpace": "Levytila vähissä!",
	"chunk.toast.lowDiskSpace.description": "Maailmaa ei ehkä voida tallentaa.",
	"chunk.toast.saveFailure": "Sijainnissa %s sijaitsevan lohkon tallentaminen epäonnistui",
	...
	"command.forkLimit": "Asiayhteyksien enimmäismäärä (%s) saavutettu",
	"command.trailing_data": "Jälkitietoa löytyi: %s",
	...
	"commands.attribute.base_value.reset.success": "Kohteen %[2]s ominaisuuden %[1]s pohja-arvo on nollattu oletukseksi %[3]s",
	...
	"commands.banlist.entry.unknown": "(Tuntematon)",
	"commands.banlist.list": "Löydettiin %s porttikielto(a):",
	"commands.banlist.none": "Ei yhtään porttikieltoa",
	...
	"commands.bossbar.get.players.some": "Mukautettu päävastustajapalkki %s näkyy %s paikalla olevalle pelaajalle: %s",
	...
	"commands.bossbar.list.bars.none": "Ei aktiivisia mukautettuja päävastustajapalkkeja",
	"commands.bossbar.list.bars.some": "Löydettiin %s mukautettu(a) päävastustajapalkki(a): %s",
	...
	"commands.bossbar.set.players.success.some": "Mukautettu päävastustajapalkki %s näkyy nyt %s pelaajalle: %s",
	...
	"commands.clone.success": "Onnistuneesti kloonattu %s kuutio(ta)",
	...
	"commands.data.modify.expected_list": "Odotettiin listaa, mutta saatiin %s",
	"commands.data.modify.expected_object": "Odotettiin kohdetta, mutta saatiin %s",
	"commands.data.modify.expected_value": "Odotettiin arvoa, mutta saatiin %s",
	"commands.data.modify.invalid_index": "Virheellinen listaindeksi: %s",
	"commands.data.modify.invalid_substring": "Virheelliset osamerkkijonoindeksit: %s - %s",
	...
	"commands.datapack.create.already_exists": "Paketti nimellä '%s' on jo olemassa",
	"commands.datapack.create.invalid_full_name": "Virheellinen uuden paketin nimi '%s'",
	"commands.datapack.create.invalid_name": "Virheellisiä merkkejä uudessa paketin nimessä '%s'",
	"commands.datapack.create.io_failure": "Ei voida luoda pakettia nimellä '%s'. Katso lokitiedot",
	"commands.datapack.create.metadata_encode_failure": "Metadatan enkoodaaminen paketille nimellä '%s' epäonnistui: %s",
	"commands.datapack.create.success": "Luotiin uusi tyhjä paketti nimellä '%s'",
	"commands.datapack.disable.failed": "Paketti ’%s’ ei ole käytössä!",
	"commands.datapack.disable.failed.feature": "Pakettia '%s' ei voida poistaa käytöstä, sillä se on osa käytössä olevaa kokonaisuutta!",
	...
	"commands.datapack.list.available.success": "Käytettävissäsi on %s datapaketti(a): %s",
	"commands.datapack.list.enabled.none": "Datapaketteja ei ole käytössä",
	"commands.datapack.list.enabled.success": "Käytössä on %s datapaketti(a): %s",
	...
	"commands.debug.function.noReturnRun": "Jäljitystä ei voi käyttää komennolle /return run",
	...
	"commands.dialog.clear.multiple": "Dialogi tyhjennetty %s pelaajalta",
	"commands.dialog.clear.single": "Dialogi tyhjennetty pelaajalta %s",
	"commands.dialog.show.multiple": "Dialogi esitetty %s pelaajalle",
	"commands.dialog.show.single": "Dialogi esitetty pelaajalle %s",
	...
	"commands.drop.no_loot_table": "Kohteella %s ei ole saalisluetteloa",
	"commands.drop.no_loot_table.block": "Kuutiolla %s ei ole saalisluetteloa",
	"commands.drop.success.multiple": "Pudotettiin %s tavaraa",
	"commands.drop.success.multiple_with_table": "Pudotettiin %s esinettä saalisluettelosta %s",
	"commands.drop.success.single": "Pudotettu %s %s",
	"commands.drop.success.single_with_table": "Pudotettiin %s %s saalisluettelosta %s",
	"commands.effect.clear.everything.failed": "Kohteella ei ole vaikutuksia poistettavaksi",
	...
	"commands.execute.function.instantiationFailure": "Funktion %s suorittaminen epäonnistui: %s",
	...
	"commands.fetchprofile.copy_component": "Kopioi komponentti",
	"commands.fetchprofile.copy_text": "Kopioi %s",
	"commands.fetchprofile.entity.success": "Profiilin yhdistäminen kohteeseen %s onnistui: %s",
	"commands.fetchprofile.failed_to_serialize": "Profiilin sarjallistaminen epäonnistui: %s",
	"commands.fetchprofile.give_item": "Anna esine",
	"commands.fetchprofile.id.failure": "Profiilin yhdistäminen tunnisteeseen %s epäonnistui",
	"commands.fetchprofile.id.success": "Profiilin yhdistäminen tunnisteeseen %s onnistui: %s",
	"commands.fetchprofile.name.failure": "Profiilin yhdistäminen nimeen %s epäonnistui",
	"commands.fetchprofile.name.success": "Profiilin yhdistäminen nimeen %s onnistui: %s",
	"commands.fetchprofile.no_profile": "Kohteella %s ei ole profiilia",
	"commands.fetchprofile.summon_mannequin": "Luo mannekiini",
	"commands.fill.failed": "Kuutioita ei täytetty",
	"commands.fill.success": "Onnistuneesti täytetty %s kuutio(ta)",
	...
	"commands.fillbiome.success.count": "%s biomi(a) asetettu välille %s, %s, %s ja %s, %s, %s",
	...
	"commands.function.error.argument_not_compound": "Virheellinen argumenttityyppi: %s. Odotettiin tyyppiä Compound",
	"commands.function.error.missing_argument": "Puuttuva argumentti %[2]s funktiossa %[1]s",
	"commands.function.error.missing_arguments": "Puuttuvia argumentteja funktiossa %s",
	"commands.function.error.parse": "Suorittaessa makroa %s: Komento '%s' aiheutti virheen: %s",
	"commands.function.instantiationFailure": "Funktion %s suorittaminen epäonnistui: %s",
	"commands.function.result": "Funktio %s palautti arvon %s",
	"commands.function.scheduled.multiple": "Käynnissä olevat toiminnot %s",
	"commands.function.scheduled.no_functions": "Nimellä %s ei löydetty yhtään funktiota",
	"commands.function.scheduled.single": "Käynnissä oleva toiminto %s",
	...
	"commands.function.success.single.result": "Funktio '%[2]s' palautti arvon %[1]s",
	...
	"commands.kick.owner.failed": "Palvelimen omistajaa ei voida potkia LAN-pelistä",
	"commands.kick.singleplayer.failed": "Pelaajia ei voida potkia offline-yksinpelistä",
	...
	"commands.place.template.invalid": "Mallia tunnisteella \"%s\" ei ole olemassa",
	...
	"commands.profile_fetch.copy_component": "Kopioi komponentti",
	"commands.profile_fetch.failed_to_serialize": "Profiilin sarjallistaminen epäonnistui: %s",
	"commands.profile_fetch.give_item": "Anna esine",
	"commands.profile_fetch.id.failure": "Profiilin yhdistäminen tunnisteeseen %s epäonnistui",
	"commands.profile_fetch.id.success": "Profiilin yhdistäminen tunnisteeseen %s onnistui: %s",
	"commands.profile_fetch.name.failure": "Profiilin yhdistäminen nimeen %s epäonnistui",
	"commands.profile_fetch.name.success": "Profiilin yhdistäminen nimeen %s onnistui: %s",
	"commands.publish.alreadyPublished": "Moninpeli on jo isännöity portin %s kautta",
	"commands.publish.alreadyPublished.lan": "Paikallista peliä isännöidään jo portilla %s",
	"commands.publish.alreadyPublished.online": "Paikallista peliä isännöidään jo",
	...
	"commands.publish.started.lan": "Paikallinen peli luotu portilla %s",
	"commands.publish.started.online": "Verkkopeli luotu",
	"commands.publish.success": "Moninpeli on nyt isännöity portin %s kautta",
	"commands.random.error.range_too_large": "Satunnainen arvo voi olla enintään 2147483646",
	"commands.random.error.range_too_small": "Satunnaisen arvon tulee olla vähintään 2",
	"commands.random.reset.all.success": "Nollattiin %s satunnaista sarjaa",
	"commands.random.reset.success": "Nollattiin satunnainen sarja %s",
	"commands.random.roll": "%s pyöritti luvun %s (väliltä %s–%s)",
	"commands.random.sample.success": "Satunnainen arvo: %s",
	"commands.recipe.give.failed": "Uusia reseptejä ei opittu",
	"commands.recipe.give.success.multiple": "Avattiin %s resepti(ä) %s pelaajalle",
	"commands.recipe.give.success.single": "Avattiin %s resepti(ä) pelaajalle %s",
	"commands.recipe.take.failed": "Reseptejä ei pystytty unohtamaan",
	"commands.recipe.take.success.multiple": "Otettiin pois %s resepti(ä) %s pelaajalta",
	"commands.recipe.take.success.single": "Otettiin pois %s resepti(ä) pelaajalta %s",
	...
	"commands.rotate.success": "Käännetty %s",
	...
	"commands.schedule.cleared.failure": "Ei aikatauluja tunnisteella %s",
	"commands.schedule.cleared.success": "Poistettiin %s aikataulu(a) tunnisteella %s",
	...
	"commands.schedule.macro": "Et voi ajastaa makroa",
	...
	"commands.scoreboard.objectives.list.success": "Pistetaulukossa on %s tavoite(tta): %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Näytön automaattipäivitys kytketty pois päältä tavoitteelle %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Näytön automaattipäivitys kytketty päälle tavoitteelle %s",
	"commands.scoreboard.objectives.modify.displayname": "Vaihdettiin tavoitteen %s näyttönimeksi %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Tavoitteen %s oletusnumeromuotoilu tyhjennetty",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Tavoitteen %s oletusnumeromuotoilu muutettu",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Tyhjennettiin %s kohteen näyttönimi tavoitteessa %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Tyhjennettiin kohteen %s näyttönimi tavoitteessa %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Vaihdettiin %[2]s kohteen näyttönimeksi %[1]s tavoitteessa %[3]s",
	"commands.scoreboard.players.display.name.set.success.single": "Vaihdettiin kohteen %[2]s näyttönimeksi %[1]s tavoitteessa %[3]s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Tyhjennettiin %s kohteen numeromuotoilu tavoitteessa %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Tyhjennettiin kohteen %s numeromuotoilu tavoitteessa %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Vaihdettiin %s kohteen numeromuotoilua tavoitteessa %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Vaihdettiin kohteen %s numeromuotoilua tavoitteessa %s",
	...
	"commands.scoreboard.players.list.entity.success": "Kohteella %s on %s tulos(ta):",
	"commands.scoreboard.players.list.success": "Seurataan %s kohdetta: %s",
	...
	"commands.setidletimeout.success.disabled": "Pelaajan toimettomuusaikakatkaisu on nyt poissa käytöstä",
	"commands.setworldspawn.failure.not_overworld": "Maailman aloituspiste voidaan asettaa vain ylämaailmaan",
	"commands.setworldspawn.success": "Asetettiin maailman syntymispisteeksi %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Asetettiin maailman syntymispisteeksi %s, %s, %s [%s, %s] ulottuvuuteen %s",
	"commands.spawnpoint.success.multiple": "Asetettiin syntymispisteeksi %s, %s, %s [%s] ulottuvuuteen %s %s pelaajalle",
	"commands.spawnpoint.success.multiple.new": "Asetettiin syntymispisteeksi %s, %s, %s [%s, %s] ulottuvuuteen %s %s pelaajalle",
	"commands.spawnpoint.success.single": "Asetettiin syntymispisteeksi %s, %s, %s [%s] ulottuvuuteen %s pelaajalle %s",
	"commands.spawnpoint.success.single.new": "Asetettiin syntymispisteeksi %s, %s, %s [%s, %s] ulottuvuuteen %s pelaajalle %s",
	"commands.spectate.cannot_spectate": "Kohdetta %s ei voi katsoa",
	...
	"commands.stopwatch.already_exists": "Sekuntikello '%s' on jo olemassa",
	"commands.stopwatch.create.success": "Luotiin sekuntikello '%s'",
	"commands.stopwatch.does_not_exist": "Sekuntikelloa '%s' ei ole olemassa",
	"commands.stopwatch.query": "Sekuntikello '%s' on ollut käynnissä %s s ajan",
	"commands.stopwatch.remove.success": "Poistettiin sekuntikello '%s'",
	"commands.stopwatch.restart.success": "Käynnistettiin sekuntikello '%s' uudelleen",
	"commands.summon.failed": "Kohdetta ei pystytty luoda",
	"commands.summon.failed.peaceful": "Hirviöitä ei voi luoda rauhallisella vaikeustasolla",
	...
	"commands.swing.failed.notliving": "Heiluttavia eläviä olioita ei löytynyt",
	"commands.swing.success.multiple": "%s oliota heiluttaa nyt käsivarsiaan",
	"commands.swing.success.single": "%s heiluttaa nyt käsivarttaan",
	...
	"commands.team.empty.success": "Poistettiin %s pelaaja(a) joukkueesta %s",
	...
	"commands.team.list.members.success": "Joukkueessa %s on %s pelaaja(a): %s",
	"commands.team.list.teams.empty": "Joukkueita ei ole",
	"commands.team.list.teams.success": "Löydettiin %s joukkue(tta): %s",
	...
	"commands.team.option.color.clear.success": "Väri poistettu joukkueelta %s",
	...
	"commands.test.batch.starting": "Aloitusympäristö %s erä %s",
	"commands.test.clear.error.no_tests": "Ei löydetty pyyhittäviä testejä",
	"commands.test.clear.success": "Pyyhitty %s rakennelma(a)",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Klikkaa kopioidaksesi leikepöydälle",
	"commands.test.create.success": "Testiasetukset luotu testille %s",
	"commands.test.error.no_test_containing_pos": "Ei löydetty testitapausta, joka sisältää %s, %s, %s",
	"commands.test.error.no_test_instances": "Testitapauksia ei löydetty",
	"commands.test.error.non_existant_test": "Testiä %s ei löydetty",
	"commands.test.error.structure_not_found": "Testirakennelmaa %s ei löydetty",
	"commands.test.error.test_instance_not_found": "Testitapauskuution kohdetta ei löydetty",
	"commands.test.error.test_instance_not_found.position": "Testitapauskuution kohdetta ei löydetty testille sijainnissa %s, %s, %s",
	"commands.test.error.too_large": "Rakennelman koon tulee olla vähemmän kuin %s kuutiota kunkin akselin suuntaisesti",
	"commands.test.locate.done": "Paikannus päättyi: löydettiin %s rakennelma(a)",
	"commands.test.locate.found": "Löydettiin rakenne sijainnista %s (etäisyys %s)",
	"commands.test.locate.started": "Aloitettiin testirakennelmien paikannus. Tämä saattaa kestää hetken...",
	"commands.test.no_tests": "Ei testejä suoritettavana",
	"commands.test.relative_position": "Sijainti suhteessa %s: %s",
	"commands.test.reset.error.no_tests": "Nollattavia testejä ei löytynyt",
	"commands.test.reset.success": "Nollattu %s rakennelma(a)",
	"commands.test.run.no_tests": "Testejä ei löytynyt",
	"commands.test.run.running": "Suoritetaan %s testiä...",
	"commands.test.summary": "Pelitesti valmis! %s testiä suoritettiin",
	"commands.test.summary.all_required_passed": "Kaikki vaaditut testit läpäisty :)",
	"commands.test.summary.failed": "%s vaadittua testiä epäonnistui :(",
	"commands.test.summary.optional_failed": "%s valinnaista testiä epäonnistui",
	"commands.tick.query.percentiles": "Persentiilit: P50: %s ms P95: %s ms P99: %sms. Otos: %s",
	"commands.tick.query.rate.running": "Kohdepykälänopeus: %s sekunnissa.\nKeskimääräinen pykäläaika: %s ms (Kohde: %s ms)",
	"commands.tick.query.rate.sprinting": "Kohdepykälänopeus: %s sekunnissa (ohitettu, vain viitteellinen).\nKeskimääräinen pykäläaika: %s ms",
	"commands.tick.rate.success": "Asetettiin kohdepykälänopeudeksi %s sekunnissa",
	"commands.tick.sprint.report": "Juoksutettiin %s pykälää sekunnissa tai %s ms pykälää kohden",
	"commands.tick.sprint.stop.fail": "Ei pykäläjuoksutusta käynnissä",
	"commands.tick.sprint.stop.success": "Pykäläjuoksutus keskeytettiin",
	"commands.tick.status.frozen": "Peli on jäädytetty",
	"commands.tick.status.lagging": "Peli on käynnissä, mutta ei pysy kohdepykälänopeuden perässä",
	"commands.tick.status.running": "Peli toimii normaalisti",
	"commands.tick.status.sprinting": "Pykäläjuoksutus käynnissä",
	"commands.tick.step.fail": "Pelin askeltaminen ei onnistu – peli tulee jäädyttää ensin",
	"commands.tick.step.stop.fail": "Ei pykäläaskellusta käynnissä",
	"commands.tick.step.stop.success": "Pykäläaskellus keskeytettiin",
	"commands.tick.step.success": "Askelletaan %s pykälä(ä)",
	"commands.time.no_default_clock": "Ulottuvuudessa %s ei ole oletuskelloa",
	"commands.time.no_time_marker_found": "Kellolla %[2]s ei ole aikamerkkiä %[1]s",
	"commands.time.pause": "Kello %s pysäytettiin",
	"commands.time.query": "Aika on nyt %s",
	"commands.time.query.absolute": "Kello %s on pykälässä %s",
	"commands.time.query.gametime": "Pelin aika on %s pykälä(ä)",
	"commands.time.query.timeline": "Aikajana %s on pykälässä %s",
	"commands.time.query.timeline.repetitions": "Aikajana %s on suorittanut %s toiston/toistoa",
	"commands.time.rate": "Kello %s etenee nyt %sx normaalilla nopeudella",
	"commands.time.resume": "Kelloa %s jatkettiin",
	"commands.time.set": "Asetettiin ajaksi %s",
	"commands.time.set.absolute": "Asetettiin %s %s pykälään",
	"commands.time.set.time_marker": "Asetettiin %s aikamerkkiin %s",
	"commands.time.wrong_timeline_for_clock": "Aikajana %s ei kelpaa kellolle %s",
	...
	"commands.transfer.error.no_players": "Vähintään yksi siirrettävä pelaaja täytyy määrittää",
	"commands.transfer.success.multiple": "Siirretään %s pelaajaa kohteeseen %s:%s",
	"commands.transfer.success.single": "Siirretään %s kohteeseen %s:%s",
	...
	"commands.unpublish.notPublished": "Ei julkaistua moninpeliä",
	"commands.unpublish.success": "Moninpelin julkaiseminen on peruttu",
	...
	"commands.waypoint.list.empty": "Ei reittipisteitä sijainnissa %s",
	"commands.waypoint.list.success": "%s reittipiste(ttä) sijainnissa %s: %s",
	"commands.waypoint.modify.color": "Reittipisteen väri on nyt %s",
	"commands.waypoint.modify.color.reset": "Nollaa reittipisteen väri",
	"commands.waypoint.modify.style": "Reittipisteen tyyliä muutettu",
	...
	"commands.whitelist.list": "Valkoisella listalla on %s pelaaja(a): %s",
	"commands.whitelist.none": "Valkoisella listalla ei ole yhtään pelaajaa",
	...
	"component.profile.dynamic": "Dynaaminen",
	...
	"connect.failed.transfer": "Yhteyden muodostaminen epäonnistui siirrettäessä palvelimelle",
	"connect.joining": "Liitytään maailmaan...",
	"connect.negotiating": "Neuvotellaan...",
	"connect.p2p.establishing": "Luodaan yhteyttä...",
	"connect.p2p.failed.generic": "Pelaajaan ei voitu yhdistää",
	"connect.p2p.failed.signaling": "Juuri tällä hetkellä ei ole mahdollista yhdistää.\nYritä myöhemmin uudelleen.",
	"connect.p2p.failed.timeout": "Yhteyspyyntö aikakatkaistiin",
	"connect.p2p.failed.unreachable": "Pelaaja ei ole tavoitettavissa",
	"connect.reconfiging": "Uudelleenjärjestellään...",
	"connect.reconfiguring": "Uudelleenjärjestellään...",
	"connect.transferring": "Siirretään uudelle palvelimelle...",
	"container.barrel": "Tynnyri",
	"container.beacon": "Merkkivalo",
	"container.beehive.bees": "Mehiläisiä: %s/%s",
	"container.beehive.honey": "Hunajaa: %s/%s",
	...
	"createWorld.customize.buffet.search": "Hae...",
	"createWorld.customize.buffet.title": "Yksibiomisen maailman muokkaaminen",
	...
	"dataPack.locator_bar.description": "Näytä muiden pelaajien suunta moninpelissä",
	"dataPack.locator_bar.name": "Paikannuspalkki",
	"dataPack.minecart_improvements.description": "Paranneltu kaivosvaunujen liikkuminen",
	"dataPack.minecart_improvements.name": "Kaivosvaunuparannukset",
	"dataPack.redstone_experiments.description": "Kokeelliset redstone-muutokset",
	"dataPack.redstone_experiments.name": "Kokeellinen redstone",
	"dataPack.title": "Valitse datapaketit",
	"dataPack.trade_rebalance.description": "Päivitetty kaupankäynti kyläläisille",
	"dataPack.trade_rebalance.name": "Kyläläisten vaihtokaupan tasapainotus",
	...
	"dataPack.update_1_21.description": "Minecraft-version 1.21 uudet ominaisuudet ja sisältö",
	"dataPack.update_1_21.name": "Päivitys 1.21",
	...
	"dataPack.winter_drop.description": "Talvipäivityksen uudet ominaisuudet ja sisältö",
	"dataPack.winter_drop.name": "Talvipäivitys",
	...
	"death.attack.dryout": "%[1]s kuivui hengiltä",
	"death.attack.dryout.player": "%[1]s kuivui hengiltä yrittäessään paeta kohdetta %[2]s",
	...
	"death.attack.fallingStalactite.player": "Putoava stalaktiitti lävisti pelaajan %[1]s hänen taistellessa kohteen %[2]s kanssa",
	...
	"death.attack.fireworks.item": "%[1]s kuoli pamaukseen pelaajan %[2]s ammuttua tätä kohti ilotulitteen esineellä %[3]s",
	...
	"death.attack.genericKill.player": "%[1]s kuoli taistellessaan kohteen %[2]s kanssa",
	...
	"death.attack.mace_smash": "%[2]s murskasi pelaajan %[1]s",
	"death.attack.mace_smash.item": "%[2]s murskasi pelaajan %[1]s käyttäen esinettä %[3]s",
	"death.attack.magic": "%[1]s tapettiin taialla",
	"death.attack.magic.player": "%[1]s kuoli taikaan yrittäessään paeta kohdetta %[2]s",
	...
	"death.attack.onFire.item": "%[1]s paloi poroksi taistellessaan kohdetta %[2]s vastaan, joka käytti asetta %[3]s",
	...
	"death.attack.outsideBorder.player": "%[1]s poistui tästä maailmasta taistellessaan kohdetta %[2]s vastaan",
	...
	"death.attack.sonic_boom.item": "%[1]s tuhoutui ääniaallon voimasta yrittäessään paeta kohdetta %[2]s, joka käytti asetta %[3]s",
	"death.attack.sonic_boom.player": "%[1]s tuhoutui ääniaallon voimasta yrittäessään paeta kohdetta %[2]s",
	"death.attack.spear": "%[2]s keihästi pelaajan %[1]s",
	"death.attack.spear.item": "%[2]s keihästi pelaajan %[1]s käyttäen keihästä %[3]s",
	"death.attack.stalagmite": "%[1]s seivästyi stalagmiittiin",
	"death.attack.stalagmite.player": "Stalagmiitti seivästi pelaajan %[1]s hänen taistellessa kohteen %[2]s kanssa",
	...
	"death.attack.sulfurCubeHot": "%[1]s kuoli, koska muukin kuin lattia oli laavaa",
	"death.attack.sulfurCubeHot.player": "%[2]s näytti pelaajalle %[1]s, että muukin kuin lattia on laavaa",
	...
	"deathScreen.score.value": "Pisteet: %s",
	...
	"debug.copy_location.help": "F3 + C = Kopioi sijainti /tp komentona tai pidä pohjassa 10 sekuntia kaataaksesi pelin",
	...
	"debug.crash.message.rebindable": "%s + %s on painettuna. Tämä kaataa pelin ellei näppäimiä vapauteta.",
	...
	"debug.entry.always": "Aina",
	"debug.entry.currently.alwaysOn": "%s: Nyt aina päällä",
	"debug.entry.currently.inF3": "%s: Nyt vain F3-näkymässä",
	"debug.entry.currently.inOverlay": "%s: Nyt vain peittokuvanäkymässä",
	"debug.entry.currently.never": "%s: Nyt poissa päältä",
	"debug.entry.f3": "F3",
	"debug.entry.overlay": "Peittokuvassa",
	...
	"debug.options.category.renderer": "Virheenkorjauskuvantajat",
	"debug.options.category.text": "Virheenkorjausnäytön teksti",
	"debug.options.help": "F3 + F6 = Muokkaa virheenkorjausasetuksia",
	"debug.options.notAllowed.tooltip": "Ei näkyvissä kun virheenkorjaustetoja on vähennetty",
	"debug.options.profile.default": "Oletusprofiili",
	"debug.options.profile.performance": "Suorituskykyprofiili",
	"debug.options.search": "Hae...",
	"debug.options.title": "Virheenkorjausasetukset",
	"debug.options.warning": "Nämä asetukset ovat vain testaamistarkoitukseen. Ne saattavat hidastaa tietokonettasi, kaataa pelin tai syödä lemmikkikivesi.",
	...
	"debug.profiling.start.rebindable": "Profilointi aloitettu %s sekunnin ajaksi. Käytä %s + %s pysäyttääksesi",
	...
	"debug.version.header": "Asiakasohjelman version tiedot:",
	"debug.version.help": "F3 + V = Asiakasohjelman version tiedot",
	...
	"disconnect.ignoring_status_request": "Ohitetaan tilapyyntö",
	...
	"disconnect.packetError": "Verkkoprotokollavirhe",
	"disconnect.spam": "Potkittiin pelistä roskapostin vuoksi",
	"disconnect.timeout": "Aikakatkaistu",
	"disconnect.transfer": "Siirretty toiselle palvelimelle",
	"disconnect.unknownHost": "Tuntematon palvelin",
	"download.pack.failed": "%s/%s paketin lataaminen epäonnistui",
	"download.pack.progress.bytes": "Edistyminen: %s (tuntematon koko)",
	"download.pack.progress.percent": "Edistyminen: %s%%",
	"download.pack.title": "Ladataan resurssipakettia %s/%s",
	"editGamerule.default": "Oletus: %s",
	"editGamerule.inGame.button": "Muokkaa pelisääntöjä...",
	"editGamerule.inGame.disabled.tooltip": "Pelisääntöjen muokkaaminen vaatii operaattorioikeudet.",
	"editGamerule.inGame.discardChanges.message": "Haluatko varmasti hylätä odottavat muutokset pelisääntöihin?",
	"editGamerule.inGame.discardChanges.title": "Muutokset pelisääntöihin",
	"editGamerule.inGame.downloadingGamerules": "Haetaan pelisääntöjä...",
	"editGamerule.title": "Muokkaa pelisääntöjä",
	"effect.duration.infinite": "∞",
	"effect.minecraft.absorption": "Imeytyminen",
	"effect.minecraft.bad_omen": "Paha enne",
	"effect.minecraft.blindness": "Sokeus",
	"effect.minecraft.breath_of_the_nautilus": "Helmiveneen henkäys",
	...
	"effect.minecraft.infested": "Saastuminen",
	...
	"effect.minecraft.oozing": "Limaisuus",
	"effect.minecraft.poison": "Myrkky",
	"effect.minecraft.raid_omen": "Hyökkäyksen enne",
	...
	"effect.minecraft.trial_omen": "Koetuksen enne",
	"effect.minecraft.unluck": "Huono onni",
	"effect.minecraft.water_breathing": "Vedenhengitys",
	"effect.minecraft.weakness": "Heikkous",
	"effect.minecraft.weaving": "Kutominen",
	"effect.minecraft.wind_charged": "Tuulella ladattu",
	...
	"enchantment.minecraft.breach": "Murtaja",
	"enchantment.minecraft.channeling": "Kanavointi",
	"enchantment.minecraft.density": "Tiheys",
	...
	"enchantment.minecraft.lunge": "Syöksy",
	...
	"enchantment.minecraft.sweeping_edge": "Kiitävä reuna",
	...
	"enchantment.minecraft.wind_burst": "Puuska",
	"entity.minecraft.acacia_boat": "Akaasiavene",
	"entity.minecraft.acacia_chest_boat": "Akaasiavene arkulla",
	"entity.minecraft.allay": "Apuri",
	"entity.minecraft.area_effect_cloud": "Alueen vaikutuspilvi",
	"entity.minecraft.armadillo": "Vyötiäinen",
	"entity.minecraft.armor_stand": "Haarniskateline",
	"entity.minecraft.arrow": "Nuoli",
	"entity.minecraft.axolotl": "Aksolotli",
	"entity.minecraft.bamboo_chest_raft": "Bambulautta arkulla",
	"entity.minecraft.bamboo_raft": "Bambulautta",
	"entity.minecraft.bat": "Lepakko",
	"entity.minecraft.bee": "Mehiläinen",
	"entity.minecraft.birch_boat": "Koivuvene",
	"entity.minecraft.birch_chest_boat": "Koivuvene arkulla",
	"entity.minecraft.blaze": "Roihu",
	"entity.minecraft.block_display": "Kuutionäyttö",
	"entity.minecraft.boat": "Vene",
	"entity.minecraft.bogged": "Rämeinen",
	"entity.minecraft.breeze": "Viima",
	"entity.minecraft.breeze_wind_charge": "Puhuripallo",
	"entity.minecraft.camel": "Kameli",
	"entity.minecraft.camel_husk": "Kameliholkki",
	"entity.minecraft.cat": "Kissa",
	"entity.minecraft.cave_spider": "Luolahämähäkki",
	"entity.minecraft.cherry_boat": "Kirsikkapuuvene",
	"entity.minecraft.cherry_chest_boat": "Kirsikkapuuvene arkulla",
	...
	"entity.minecraft.copper_golem": "Kuparigolem",
	"entity.minecraft.cow": "Lehmä",
	"entity.minecraft.creaking": "Narahtelija",
	"entity.minecraft.creaking_transient": "Narahtelija",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Tumma tammivene",
	"entity.minecraft.dark_oak_chest_boat": "Tumma tammivene arkulla",
	...
	"entity.minecraft.happy_ghast": "Iloinen ghast",
	...
	"entity.minecraft.iron_golem": "Rautagolem",
	"entity.minecraft.item": "Esine",
	"entity.minecraft.item_display": "Esinenäyttö",
	"entity.minecraft.item_frame": "Kehys",
	"entity.minecraft.jungle_boat": "Viidakkopuuvene",
	"entity.minecraft.jungle_chest_boat": "Viidakkopuuvene arkulla",
	...
	"entity.minecraft.lingering_potion": "Viipyvä taikajuoma",
	"entity.minecraft.llama": "Laama",
	"entity.minecraft.llama_spit": "Laaman sylki",
	"entity.minecraft.magma_cube": "Magmakuutio",
	"entity.minecraft.mangrove_boat": "Mangrovepuuvene",
	"entity.minecraft.mangrove_chest_boat": "Mangrovepuuvene arkulla",
	"entity.minecraft.mannequin": "Mannekiini",
	...
	"entity.minecraft.nautilus": "Helmivene",
	"entity.minecraft.oak_boat": "Tammivene",
	"entity.minecraft.oak_chest_boat": "Tammivene arkulla",
	"entity.minecraft.ocelot": "Oselotti",
	"entity.minecraft.ominous_item_spawner": "Pahaenteinen esineiden luoja",
	"entity.minecraft.painting": "Maalaus",
	"entity.minecraft.pale_oak_boat": "Kalvastammivene",
	"entity.minecraft.pale_oak_chest_boat": "Kalvastammivene arkulla",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Kuivahtanut",
	...
	"entity.minecraft.shulker_bullet": "Shulkerin ammus",
	...
	"entity.minecraft.splash_potion": "Roiskahtava taikajuoma",
	"entity.minecraft.spruce_boat": "Kuusivene",
	"entity.minecraft.spruce_chest_boat": "Kuusivene arkulla",
	"entity.minecraft.squid": "Kalmari",
	"entity.minecraft.stray": "Vaeltaja",
	"entity.minecraft.strider": "Rämpijä",
	"entity.minecraft.sulfur_cube": "Rikkikuutio",
	"entity.minecraft.sulfur_cube.content": "Sisältää: %s",
	...
	"entity.minecraft.wind_charge": "Puhuripallo",
	...
	"entity.minecraft.zombie_nautilus": "Zombihelmivene",
	...
	"event.minecraft.raid.defeat.full": "Hyökkäys – Tappio",
	"event.minecraft.raid.raiders_remaining": "Hyökkääjiä jäljellä: %s",
	"event.minecraft.raid.victory": "Voitto",
	"event.minecraft.raid.victory.full": "Hyökkäys – Voitto",
	"filled_map.buried_treasure": "Haudatun aarteen kartta",
	"filled_map.explorer_jungle": "Viidakon seikkailijakartta",
	"filled_map.explorer_swamp": "Suon seikkailijakartta",
	"filled_map.id": "ID #%s",
	...
	"filled_map.trial_chambers": "Koetuksen seikkailijakartta",
	"filled_map.unknown": "Tuntematon kartta",
	"filled_map.village_desert": "Aavikkokylän kartta",
	"filled_map.village_plains": "Tasankokylän kartta",
	"filled_map.village_savanna": "Savannikylän kartta",
	"filled_map.village_snowy": "Lumikylän kartta",
	"filled_map.village_taiga": "Taigakylän kartta",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Salli Nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Hallitsee, voivatko pelaajat mennä Netheriin.",
	"gamerule.allowFireTicksAwayFromPlayer": "Päivitä tuli kaukana pelaajista",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Hallitsee tulen ja laavan vaikutusten päivittymistä yli 8 lohkon etäisyydellä pelaajista",
	...
	"gamerule.commandBlocksEnabled": "Salli komentokuutiot",
	...
	"gamerule.disablePlayerMovementCheck": "Poista pelaajan liikkumistarkistus",
	...
	"gamerule.enableCommandBlocks": "Salli komentokuutiot",
	"gamerule.enderPearlsVanishOnDeath": "Heitetyt ender-helmet katoavat kuollessa",
	"gamerule.enderPearlsVanishOnDeath.description": "Katoavatko pelaajan heittämät ender-helmet, kun pelaaja kuolee?",
	"gamerule.entitiesWithPassengersCanUsePortals": "Oliot, joilla on ratsastajia, voivat käyttää portaaleja",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Salli olioiden teleporttaaminen nether-portaalien, end-portaalien ja end-porttien läpi ratsastajien kanssa.",
	...
	"gamerule.locatorBar": "Ota pelaajanpaikannuspalkki käyttöön",
	"gamerule.locatorBar.description": "Kun käytössä, näytöllä näytetään palkki pelaajien suunnan osoittamiseksi.",
	...
	"gamerule.maxCommandForkCount": "Komentoasiayhteyksien yläraja",
	"gamerule.maxCommandForkCount.description": "Enimmäismäärä asiayhteyksiä, joita voidaan käyttää komennoissa kuten 'execute as'.",
	"gamerule.maxEntityCramming": "Kasautuvien kohteiden enimmäismäärä",
	"gamerule.minecartMaxSpeed": "Kaivosvaunun enimmäisnopeus",
	"gamerule.minecartMaxSpeed.description": "Maalla liikkuvan kaivosvaunun oletusenimmäisnopeus.",
	"gamerule.minecraft.elytra_movement_check": "Tee elytran liikkumistarkistus",
	"gamerule.minecraft.fire_spread_radius_around_player": "Tulen leviämissäde",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Pelaajan ympärillä oleva alue kuutioina, jolla tuli voi levitä",
	"gamerule.minecraft.player_movement_check": "Tee pelaajan liikkumistarkistus",
	"gamerule.minecraft.raids": "Salli hyökkäykset",
	"gamerule.minecraft.universal_anger.description": "Vihaiset neutraaliolennot hyökkäävät kaikkia lähellä olevia pelaajia vastaan, eikä vain ne suututtaneeseen pelaajaan. Toimii parhaiten, jos forgive_dead_players on poissa käytöstä.",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Pelaajan Nether-portaaliviive luovassa tilassa",
	"gamerule.playersNetherPortalCreativeDelay.description": "Aika (pykälinä), jonka luovassa tilassa olevan pelaajan tulee seistä Nether-portaalissa ennen toiseen ulottuvuuteen siirtymistä.",
	"gamerule.playersNetherPortalDefaultDelay": "Pelaajan Nether-portaaliviive muussa kuin luovassa tilassa",
	"gamerule.playersNetherPortalDefaultDelay.description": "Aika (pykälinä), jonka muussa kuin luovassa tilassa olevan pelaajan tulee seistä Nether-portaalissa ennen toiseen ulottuvuuteen siirtymistä.",
	...
	"gamerule.projectilesCanBreakBlocks": "Ammukset voivat rikkoa kuutioita",
	"gamerule.projectilesCanBreakBlocks.description": "Hallitsee, tuhoavatko ammukset niiden tuhottavissa olevia kuutioita.",
	"gamerule.pvp": "Salli pvp",
	"gamerule.pvp.description": "Hallitsee, voivatko pelaajat vahingoittaa toisiaan.",
	...
	"gamerule.spawnChunkRadius": "Syntymälohkon koko",
	"gamerule.spawnChunkRadius.description": "Ylämaailman syntymäpaikan lähellä ladattuna pysyvien lohkojen määrä.",
	"gamerule.spawnMonsters": "Luo hirviöitä",
	"gamerule.spawnMonsters.description": "Hallitsee, syntyykö hirviöitä luonnollisesti.",
	"gamerule.spawnRadius": "Uudelleensyntymissijainnin säde",
	"gamerule.spawnRadius.description": "Hallitsee syntymispisteen ympärillä olevan alueen kokoa, johon pelaajat voivat syntyä.",
	"gamerule.spawnerBlocksEnabled": "Salli luojakuutiot",
	"gamerule.spectatorsGenerateChunks": "Salli katselijoiden luoda maastoa",
	"gamerule.tntExplodes": "Salli TNT:n aktivoiminen ja räjähtäminen",
	...
	"generator.minecraft.amplified.info": "Huomio: Huvin vuoksi! Vaatii tehokkaan tietokoneen.",
	...
	"gui.abuseReport.attestation": "Lähettämällä tämän raportin vahvistat, että antamasi tiedot ovat parhaan tietämyksesi mukaan oikeita ja täydellisiä.",
	"gui.abuseReport.comments": "Kommentit",
	"gui.abuseReport.describe": "Yksityiskohtien kertominen voi auttaa meitä parhaan mahdollisen valinnan tekemisessä.",
	"gui.abuseReport.discard.content": "Jos poistut, menetät tämän ilmoituksen ja siihen liittyvät kommentit.\nHaluatko varmasti poistua?",
	"gui.abuseReport.discard.discard": "Poistu ja hylkää ilmoitus",
	"gui.abuseReport.discard.draft": "Tallenna luonnoksena",
	"gui.abuseReport.discard.return": "Jatka muokkausta",
	"gui.abuseReport.discard.title": "Hylkää ilmoitus ja kommentit?",
	"gui.abuseReport.draft.content": "Haluaisitko jatkaa olemassa olevan ilmoituksen muokaamista vai luoda kokonaan uuden?",
	"gui.abuseReport.draft.discard": "Hylkää",
	"gui.abuseReport.draft.edit": "Jatka muokkausta",
	"gui.abuseReport.draft.quittotitle.content": "Haluaisitko jatkaa sen muokkaamista vai hylätä sen?",
	"gui.abuseReport.draft.quittotitle.title": "Sinulla on keskustelun ilmoituksen luonnos, jonka menetät poistuessasi",
	"gui.abuseReport.draft.title": "Muokkaa keskustelun ilmoituksen luonnosta?",
	"gui.abuseReport.error.title": "Ongelma ilmoituksesi lähettämisessä",
	"gui.abuseReport.message": "Missä kohtasit sopimatonta käytöstä?\nTämä auttaa meitä tutkimaan tapaustasi.",
	"gui.abuseReport.more_comments": "Kuvaile tapahtumia:",
	"gui.abuseReport.name.comment_box_label": "Kerro, miksi haluat ilmoittaa tästä nimestä:",
	"gui.abuseReport.name.reporting": "Olet ilmoittamassa pelaajasta \"%s\".",
	"gui.abuseReport.name.title": "Ilmoita pelaajan nimestä",
	"gui.abuseReport.observed_what": "Miksi ilmoitat tästä?",
	"gui.abuseReport.read_info": "Lue lisää ilmoittamisesta",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Kunnianloukkaus",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Joku vahingoittaa sinun tai jonkun toisen mainetta esimerkiksi jakamalla väärää tietoa tarkoituksenaan hyväksikäyttää tai harhaanjohtaa muita.",
	"gui.abuseReport.reason.description": "Kuvaus:",
	"gui.abuseReport.reason.false_reporting": "Virheelliset ilmoitukset",
	"gui.abuseReport.reason.generic": "Haluan ilmoittaa hänestä",
	"gui.abuseReport.reason.generic.description": "Hän ärsyttää minua/ hän on tehnyt jotain, mistä en pidä.",
	...
	"gui.abuseReport.reason.imminent_harm": "Uhka vahingoittaa muita",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Itsensä vahingoittaminen tai itsemurha",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Seksuaalisesti sopimaton",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Seksuaalisiin tekoihin, sukupuolielimiin ja seksuaaliseen väkivaltaan liittyvät graafiset skinit.",
	...
	"gui.abuseReport.report_sent_msg": "Olemme vastaanottaneet ilmoituksesi onnistuneesti. Kiitos!\n\nTiimimme tarkastaa sen mahdollisimman pian.",
	"gui.abuseReport.select_reason": "Valitse ilmoituskategoria",
	"gui.abuseReport.send": "Lähetä ilmoitus",
	"gui.abuseReport.send.comment_too_long": "Lyhennä kommenttia",
	...
	"gui.abuseReport.send.no_reason": "Valitse ilmoituskategoria",
	"gui.abuseReport.send.not_attested": "Lue yläpuolella oleva teksti ja klikkaa valintaruutua voidaksesi lähettää ilmoituksen",
	...
	"gui.abuseReport.skin.title": "Ilmoita pelaajan skinistä",
	"gui.abuseReport.title": "Ilmoita pelaajasta",
	"gui.abuseReport.type.chat": "Keskusteluviestit",
	"gui.abuseReport.type.name": "Pelaajan nimi",
	"gui.abuseReport.type.skin": "Pelaajan skini",
	...
	"gui.banned.name.description": "Nykyinen nimesi – \"%s\" – rikkoo Yhteisömme normeja. Voit pelata yksinpeliä, mutta pelataksesi netissä sinun on muutettava nimeäsi.\n\nLue lisää tai lähetä korjaushakemus seuraavasta linkistä: %s",
	"gui.banned.name.title": "Nimi ei ole sallittu moninpelissä",
	...
	"gui.banned.skin.description": "Nykyinen skinisi rikkoo Yhteisömme normeja. Voit pelata oletusskinillä, tai valita uuden.\n\nLue lisää tai lähetä korjaushakemus seuraavasta linkistä: %s",
	"gui.banned.skin.title": "Skini ei sallittu",
	...
	"gui.continue": "Jatka",
	"gui.copy_link_to_clipboard": "Kopioi linkki leikepöydälle",
	"gui.days": "%s päivää",
	"gui.done": "Valmis",
	"gui.down": "Alas",
	"gui.entity_tooltip.type": "Tyyppi: %s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "Hylättiin %s kansiota",
	"gui.fileDropFailure.title": "Tiedostojen lisääminen epäonnistui",
	"gui.friends.accept": "Hyväksy",
	"gui.friends.button.loading": "Odota...",
	"gui.friends.button.loading.invite_request_pending": "Odotetaan vahvistusta",
	"gui.friends.button.loading.join_request_pending": "Odotetaan hyväksymistä käyttäjältä %s",
	"gui.friends.cancel_request": "Peru pyyntö",
	"gui.friends.confirm_title": "Vahvista",
	"gui.friends.confirm_unfriend": "Oletko varma, että haluat poistaa tämän pelaajan kaverilistaltasi?",
	"gui.friends.copy_to_clipboard": "Kopioi leikepöydälle",
	"gui.friends.decline": "Hylkää",
	"gui.friends.empty_nickname": "Syötä kelvollinen profiilin nimi ennen kaveripyynnön lähettämistä",
	"gui.friends.empty_state": "Lisäämäsi kaverit näytetään täällä.\n\nHallinnoi verkkoturvallisuutta %slläsi.",
	"gui.friends.empty_state.link": "Microsoft-tili",
	"gui.friends.enter_nickname": "Syötä profiilin nimi",
	"gui.friends.error.connection_issue": "Kaverilista ei toimi juuri nyt.\n\nTarkista internet-yhteytesi ja yritä uudelleen.",
	"gui.friends.error.failed.message": "Kaveripyyntöä ei voitu lähettää juuri nyt",
	"gui.friends.error.forbidden.message": "Tämän kaveritoiminnon suorittaminen epäonnistui. Se saattaa johtua tilin yksityisyysasetuksista.",
	"gui.friends.error.generic": "Jotain on vialla — tässä ominaisuudessa, ei kavereissasi!\n\nYritä uudelleen myöhemmin.",
	"gui.friends.error.rateLimited.message": "Olet suorittamassa kaverilistatoimintoja liian nopeasti. Odota hetki ja yritä uudelleen.",
	"gui.friends.error.temporary_unavailable": "Kaverilista ei toimi juuri nyt.\n\nYritä myöhemmin uudelleen.",
	"gui.friends.error.unavailable.message": "Kaverilistapalvelu ei ole tällä hetkellä saatavilla. Tarkista yhteytesi ja yritä myöhemmin uudelleen.",
	"gui.friends.error.upgrade_needed": "Päivitä peli käyttääksesi kaverilistaa.",
	"gui.friends.error.user_may_lack_active_profile": "Kenelläkään pelaajalla ei ole tätä profiilinimeä",
	"gui.friends.join": "Liity",
	"gui.friends.loading_friends": "Ladataan kaverilistaa...",
	"gui.friends.loading_requests": "Ladataan pyyntöjä...",
	"gui.friends.manage_account_footer": "Hallinnoi verkkoturvallisuutta %slläsi",
	"gui.friends.multiplayer.invite": "Kutsu maailmaan",
	"gui.friends.multiplayer.invite_accept": "Hyväksy kutsu liittyä maailmaan",
	"gui.friends.multiplayer.invite_reject": "Hylkää kutsu liittyä maailmaan",
	"gui.friends.multiplayer.join_request": "Pyydä maailmaan liittymistä",
	"gui.friends.multiplayer.join_request_accept": "Hyväksy pyyntö liittyä maailmaan",
	"gui.friends.multiplayer.join_request_reject": "Hylkää pyyntö liittyä maailmaan",
	"gui.friends.my_profile_name": "Profiilini nimi: ",
	"gui.friends.my_profile_name.narration": "Kopioi profiilin nimi %s leikepöydälle",
	"gui.friends.narration.button.accept": "Paina enteriä hyväksyäksesi kaveripyynnön käyttäjältä %s",
	"gui.friends.narration.button.cancel_request": "Paina enteriä peruaksesi kaveripyynnön käyttäjälle %s",
	"gui.friends.narration.button.decline": "Paina enteriä hylätäksesi kaveripyynnön käyttäjältä %s",
	"gui.friends.narration.button.unfriend": "Paina enteriä poistaaksesi käyttäjän %s kaverilistalta",
	"gui.friends.narration.entry.friend": "Kaveri %s",
	"gui.friends.narration.entry.incoming": "Saapuva kaveripyyntö käyttäjältä %s",
	"gui.friends.narration.entry.outgoing": "Lähtevä kaveripyyntö käyttäjälle %s",
	"gui.friends.open": "Kaverit",
	"gui.friends.open.narration": "Kaverilista",
	"gui.friends.open.tooltip": "Kaverit",
	"gui.friends.pending.empty": "Ei odottavia kaveripyyntöjä",
	"gui.friends.pending.received": "Vastaanotettu",
	"gui.friends.pending.sent": "Lähetetty",
	"gui.friends.presence.status.offline": "Ei paikalla",
	"gui.friends.presence.status.online": "Paikalla",
	"gui.friends.presence.status.playing_hosted_server": "Liityttävässä maailmassa",
	"gui.friends.presence.status.playing_offline": "Maailmassa",
	"gui.friends.presence.status.playing_realms": "Realmissa",
	"gui.friends.presence.status.playing_server": "Palvelimella",
	"gui.friends.requests_count": "Pyynnöt (%s)",
	"gui.friends.send_request": "Lähetä kaveripyyntö",
	"gui.friends.tab_friends": "Kaverit",
	"gui.friends.toast.friend_added.message": "%s hyväksyi kaveripyyntösi",
	"gui.friends.toast.friend_invited.message": "%s on kutsuttu liittymään maailmaasi.",
	"gui.friends.toast.friend_removed.message": "%s on poistettu kaverilistaltasi",
	"gui.friends.toast.generic_error": "Tapahtui odottamaton virhe päivitettäessä kaverilistaasi. Yritä myöhemmin uudelleen.",
	"gui.friends.toast.host_invite_expired.message": "Kutsu pelaajalle %s liittyä tähän maailmaan on vanhentunut.",
	"gui.friends.toast.invite_from_friend.message": "%s kutsui sinut liittymään hänen maailmaansa. Avaa kaverilista painamalla \"%s\" liittyäksesi",
	"gui.friends.toast.join_invite_expired.message": "Kutsu liittyä pelaajan %s maailmaan on vanhentunut.",
	"gui.friends.toast.join_request.message": "%s haluaa liittyä maailmaasi. Avaa kaverilista painamalla \"%s\" tai pelivalikosta.",
	"gui.friends.toast.request_accepted.message": "Olet nyt pelaajan %s kaveri",
	"gui.friends.toast.request_received.message": "%s lähetti sinulle kaveripyynnön",
	"gui.friends.toast.request_sent.message": "Kaveripyyntö lähetetty pelaajalle %s",
	"gui.friends.toast.request_to_join_friend.message": "Pyysit liittymistä pelaajan %s maailmaan",
	"gui.friends.toast.requests_accepted_multiple.message": "%s kaveria hyväksyivät kaveripyyntösi",
	"gui.friends.toast.requests_received_multiple.message": "Olet saanut %s kaveripyyntöä",
	"gui.friends.unfriend": "Poista kaveri",
	"gui.game_rule.search": "Hae...",
	"gui.hours": "%s tuntia",
	"gui.language.search": "Hae...",
	"gui.loadingMinecraft": "Ladataan Minecraftia",
	...
	"gui.none": "Ei mikään",
	"gui.ok": "Ok",
	"gui.open_report_dir": "Avaa ilmoitusluettelo",
	"gui.packSelection.search": "Hae...",
	"gui.privacy_link.message": "Avaa tämä linkki hallitaksesi yksityisyys- ja verkkoturvallisuusasetuksiasi.",
	"gui.privacy_link.title": "Muutokset Xbox-asetuksiin voivat kestää hetken tullakseen voimaan.\n\nJos ne eivät päivity, käynnistä peli uudelleen.",
	"gui.proceed": "Jatka",
	"gui.recipebook.moreRecipes": "Napsauta hiiren oikeaa painiketta nähdäksesi lisää",
	"gui.recipebook.next_page": "Seuraava sivu",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Edellinen sivu",
	...
	"gui.remove": "Poista",
	"gui.report_to_server": "Ilmoita palvelimelle",
	"gui.selectWorld.search": "Hae...",
	...
	"gui.socialInteractions.empty_hidden": "Ei piilotettuja pelaajia keskustelussa",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Tästä pelaajasta ei voi ilmoittaa, koska hänen keskustelunsa on poissa käytöstä tai estetty",
	...
	"gui.stats": "Tilastot",
	"gui.stats.none_found": "Tilastoja ei löytynyt.",
	...
	"gui.togglable_slot": "Klikkaa poistaaksesi paikan käytöstä",
	"gui.up": "Ylös",
	"gui.waitingForResponse.button.inactive": "Takaisin (%s s)",
	"gui.waitingForResponse.title": "Odotetaan palvelinta",
	"gui.yes": "Kyllä",
	...
	"item.canUse.unknown": "Tuntematon",
	"item.color": "Väri: %s",
	"item.components": "%s komponentti(a)",
	"item.disabled": "Käytöstä poistettu esine",
	"item.durability": "Kestävyys: %s / %s",
	"item.dyed": "Värjätty",
	"item.intangible": "Aineeton",
	...
	"item.minecraft.angler_pottery_shard": "Kalastajan ruukunsirpale",
	"item.minecraft.angler_pottery_sherd": "Kalastajan ruukunsirpale",
	"item.minecraft.apple": "Omena",
	"item.minecraft.archer_pottery_shard": "Jousiampujan ruukunsirpale",
	"item.minecraft.archer_pottery_sherd": "Jousiampujan ruukunsirpale",
	"item.minecraft.armadillo_scute": "Vyötiäisen suomu",
	"item.minecraft.armadillo_spawn_egg": "Luo vyötiäinen",
	"item.minecraft.armor_stand": "Haarniskateline",
	"item.minecraft.arms_up_pottery_shard": "Soturin ruukunsirpale",
	...
	"item.minecraft.black_bundle": "Musta pussi",
	"item.minecraft.black_dye": "Musta väriaine",
	"item.minecraft.black_harness": "Mustat valjaat",
	"item.minecraft.blade_pottery_shard": "Miekan ruukunsirpale",
	...
	"item.minecraft.blue_bundle": "Sininen pussi",
	"item.minecraft.blue_dye": "Sininen väriaine",
	"item.minecraft.blue_egg": "Sininen muna",
	"item.minecraft.blue_harness": "Siniset valjaat",
	"item.minecraft.bogged_spawn_egg": "Luo rämeinen",
	"item.minecraft.bolt_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Pulttien haarniskakoristeet",
	"item.minecraft.bone": "Luu",
	"item.minecraft.bone_meal": "Luujauho",
	"item.minecraft.book": "Kirja",
	"item.minecraft.bordure_indented_banner_pattern": "Hammaskororeunainen viirikuvio",
	"item.minecraft.bow": "Jousi",
	"item.minecraft.bowl": "Kulho",
	"item.minecraft.bread": "Leipä",
	"item.minecraft.breeze_rod": "Viimasauva",
	"item.minecraft.breeze_spawn_egg": "Luo viima",
	"item.minecraft.brewer_pottery_shard": "Juomanvalmistajan ruukunsirpale",
	...
	"item.minecraft.brown_bundle": "Ruskea pussi",
	"item.minecraft.brown_dye": "Ruskea väriaine",
	"item.minecraft.brown_egg": "Ruskea muna",
	"item.minecraft.brown_harness": "Ruskeat valjaat",
	"item.minecraft.brush": "Sivellin",
	"item.minecraft.bucket": "Ämpäri",
	"item.minecraft.bundle": "Pussi",
	"item.minecraft.bundle.empty": "Tyhjä",
	"item.minecraft.bundle.empty.description": "Voi kantaa sekalaisen pinon esineitä",
	"item.minecraft.bundle.full": "Täysi",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "Liekin ruukunsirpale",
	"item.minecraft.burn_pottery_sherd": "Liekin ruukunsirpale",
	"item.minecraft.camel_husk_spawn_egg": "Luo kameliholkki",
	...
	"item.minecraft.chainmail_boots": "Rengashaarniskan saappaat",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Rannikon haarniskakoristeet",
	...
	"item.minecraft.copper_axe": "Kuparikirves",
	"item.minecraft.copper_boots": "Kuparisaappaat",
	"item.minecraft.copper_chestplate": "Kuparirintapanssari",
	"item.minecraft.copper_golem_spawn_egg": "Luo kuparigolem",
	"item.minecraft.copper_helmet": "Kuparikypärä",
	"item.minecraft.copper_hoe": "Kuparikuokka",
	"item.minecraft.copper_horse_armor": "Kuparinen hevosen panssari",
	"item.minecraft.copper_ingot": "Kupariharkko",
	"item.minecraft.copper_leggings": "Kuparihousut",
	"item.minecraft.copper_nautilus_armor": "Kuparinen helmiveneen panssari",
	"item.minecraft.copper_nugget": "Kuparihippu",
	"item.minecraft.copper_pickaxe": "Kuparihakku",
	"item.minecraft.copper_shovel": "Kuparilapio",
	"item.minecraft.copper_spear": "Kuparikeihäs",
	"item.minecraft.copper_sword": "Kuparimiekka",
	"item.minecraft.cow_spawn_egg": "Luo lehmä",
	"item.minecraft.creaking_spawn_egg": "Luo narahtelija",
	"item.minecraft.creeper_banner_pattern": "Viirikuvio",
	"item.minecraft.creeper_banner_pattern.desc": "Creeper",
	"item.minecraft.creeper_banner_pattern.new": "Creeper-viirikuvio",
	"item.minecraft.creeper_spawn_egg": "Luo creeper",
	"item.minecraft.crossbow": "Varsijousi",
	"item.minecraft.crossbow.projectile": "Ammus:",
	"item.minecraft.crossbow.projectile.multiple": "Ammus: %s x %s",
	"item.minecraft.crossbow.projectile.single": "Ammus: %s",
	"item.minecraft.cyan_bundle": "Syaani pussi",
	"item.minecraft.cyan_dye": "Syaani väriaine",
	"item.minecraft.cyan_harness": "Syaanit valjaat",
	...
	"item.minecraft.diamond_nautilus_armor": "Timanttinen helmiveneen panssari",
	"item.minecraft.diamond_pickaxe": "Timanttihakku",
	"item.minecraft.diamond_shovel": "Timanttilapio",
	"item.minecraft.diamond_spear": "Timanttikeihäs",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Dyynien haarniskakoristeet",
	...
	"item.minecraft.eye_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Silmän haarniskakoristeet",
	"item.minecraft.feather": "Höyhen",
	"item.minecraft.fermented_spider_eye": "Käynyt hämähäkinsilmä",
	"item.minecraft.field_masoned_banner_pattern": "Tiilikuvioinen viirikuvio",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Virtauksen haarniskakoristeet",
	"item.minecraft.flow_banner_pattern": "Viirikuvio",
	"item.minecraft.flow_banner_pattern.desc": "Virtaus",
	"item.minecraft.flow_banner_pattern.new": "Virtausviirikuvio",
	"item.minecraft.flow_pottery_sherd": "Virtauksen ruukunsirpale",
	"item.minecraft.flower_banner_pattern": "Viirikuvio",
	"item.minecraft.flower_banner_pattern.desc": "Kukka",
	"item.minecraft.flower_banner_pattern.new": "Kukkaviirikuvio",
	...
	"item.minecraft.globe_banner_pattern.new": "Karttakuutioviirikuvio",
	...
	"item.minecraft.golden_nautilus_armor": "Kultainen helmiveneen panssari",
	"item.minecraft.golden_pickaxe": "Kultahakku",
	"item.minecraft.golden_shovel": "Kultalapio",
	"item.minecraft.golden_spear": "Kultakeihäs",
	"item.minecraft.golden_sword": "Kultamiekka",
	"item.minecraft.gray_bundle": "Harmaa pussi",
	"item.minecraft.gray_dye": "Harmaa väriaine",
	"item.minecraft.gray_harness": "Harmaat valjaat",
	"item.minecraft.green_bundle": "Vihreä pussi",
	"item.minecraft.green_dye": "Vihreä väriaine",
	"item.minecraft.green_harness": "Vihreät valjaat",
	"item.minecraft.guardian_spawn_egg": "Luo vartija",
	"item.minecraft.gunpowder": "Ruuti",
	"item.minecraft.guster_banner_pattern": "Viirikuvio",
	"item.minecraft.guster_banner_pattern.desc": "Tuulahdus",
	"item.minecraft.guster_banner_pattern.new": "Tuulahdusviirikuvio",
	"item.minecraft.guster_pottery_sherd": "Tuulahduksen ruukunsirpale",
	"item.minecraft.happy_ghast_spawn_egg": "Luo iloinen ghast",
	"item.minecraft.harness": "Valjaat",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.host_armor_trim_smithing_template.new": "Majapaikan haarniskakoristeet",
	...
	"item.minecraft.light_blue_bundle": "Vaaleansininen pussi",
	"item.minecraft.light_blue_dye": "Vaaleansininen väriaine",
	"item.minecraft.light_blue_harness": "Vaaleansiniset valjaat",
	"item.minecraft.light_gray_bundle": "Vaaleanharmaa pussi",
	"item.minecraft.light_gray_dye": "Vaaleanharmaa väriaine",
	"item.minecraft.light_gray_harness": "Vaaleanharmaat valjaat",
	"item.minecraft.lime_bundle": "Limetinvihreä pussi",
	"item.minecraft.lime_dye": "Limetinvihreä väriaine",
	"item.minecraft.lime_harness": "Limetinvihreät valjaat",
	...
	"item.minecraft.lingering_potion.effect.infested": "Viipyvä saastumisen taikajuoma",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Viipyvä limaisuuden taikajuoma",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Viipyvä kutomisen taikajuoma",
	"item.minecraft.lingering_potion.effect.wind_charged": "Viipyvä tuulilatauksen taikajuoma",
	"item.minecraft.llama_spawn_egg": "Luo laama",
	"item.minecraft.lodestone_compass": "Magneettikivikompassi",
	"item.minecraft.mace": "Nuija",
	"item.minecraft.magenta_bundle": "Purppura pussi",
	"item.minecraft.magenta_dye": "Purppura väriaine",
	"item.minecraft.magenta_harness": "Purppurat valjaat",
	...
	"item.minecraft.mojang_banner_pattern.new": "Mojang-viirikuvio",
	...
	"item.minecraft.music_disc_bounce": "Musiikkilevy",
	...
	"item.minecraft.music_disc_creator": "Musiikkilevy",
	"item.minecraft.music_disc_creator.desc": "Lena Raine – Creator",
	"item.minecraft.music_disc_creator_music_box": "Musiikkilevy",
	...
	"item.minecraft.music_disc_lava_chicken": "Musiikkilevy",
	...
	"item.minecraft.music_disc_precipice": "Musiikkilevy",
	...
	"item.minecraft.music_disc_tears": "Musiikkilevy",
	...
	"item.minecraft.nautilus_spawn_egg": "Luo helmivene",
	...
	"item.minecraft.netherite_horse_armor": "Netheriittinen hevosen panssari",
	"item.minecraft.netherite_ingot": "Netheriittiharkko",
	"item.minecraft.netherite_leggings": "Netheriittihousut",
	"item.minecraft.netherite_nautilus_armor": "Netheriittinen helmiveneen panssari",
	...
	"item.minecraft.netherite_spear": "Netheriittikeihäs",
	"item.minecraft.netherite_sword": "Netheriittimiekka",
	"item.minecraft.netherite_upgrade_smithing_template": "Taontamalli",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Netheriittipäivitys",
	...
	"item.minecraft.ominous_bottle": "Pahaenteinen pullo",
	"item.minecraft.ominous_trial_key": "Pahaenteinen koetuksen avain",
	"item.minecraft.orange_bundle": "Oranssi pussi",
	"item.minecraft.orange_dye": "Oranssi väriaine",
	"item.minecraft.orange_harness": "Oranssit valjaat",
	"item.minecraft.painting": "Maalaus",
	"item.minecraft.pale_oak_boat": "Kalvastammivene",
	"item.minecraft.pale_oak_chest_boat": "Kalvastammivene arkulla",
	"item.minecraft.panda_spawn_egg": "Luo panda",
	"item.minecraft.paper": "Paperi",
	"item.minecraft.parched_spawn_egg": "Luo kuivahtanut",
	...
	"item.minecraft.piglin_banner_pattern.new": "Kärsäviirikuvio",
	...
	"item.minecraft.pink_bundle": "Vaaleanpunainen pussi",
	"item.minecraft.pink_dye": "Vaaleanpunainen väriaine",
	"item.minecraft.pink_harness": "Vaaleanpunaiset valjaat",
	...
	"item.minecraft.potion.effect.infested": "Saastumisen taikajuoma",
	...
	"item.minecraft.potion.effect.oozing": "Limaisuuden taikajuoma",
	...
	"item.minecraft.potion.effect.weaving": "Kutomisen taikajuoma",
	"item.minecraft.potion.effect.wind_charged": "Tuulilatauksen taikajuoma",
	...
	"item.minecraft.purple_bundle": "Violetti pussi",
	"item.minecraft.purple_dye": "Violetti väriaine",
	"item.minecraft.purple_harness": "Violetit valjaat",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Kohottajan haarniskakoristeet",
	...
	"item.minecraft.red_bundle": "Punainen pussi",
	"item.minecraft.red_dye": "Punainen väriaine",
	"item.minecraft.red_harness": "Punaiset valjaat",
	"item.minecraft.redstone": "Redstone-jauhe",
	"item.minecraft.resin_brick": "Pihkatiili",
	"item.minecraft.resin_clump": "Pihkakimpale",
	"item.minecraft.rib_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Kylkiluiden haarniskakoristeet",
	...
	"item.minecraft.scrape_pottery_sherd": "Raaputuksen ruukunsirpale",
	"item.minecraft.scute": "Suomu",
	"item.minecraft.sentry_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Vartion haarniskakoristeet",
	"item.minecraft.shaper_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Valajan haarniskakoristeet",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Hiljaisuuden haarniskakoristeet",
	...
	"item.minecraft.skull_banner_pattern.desc": "Pääkallo",
	"item.minecraft.skull_banner_pattern.new": "Pääkalloviirikuvio",
	...
	"item.minecraft.snout_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Kärsäin haarniskakoristeet",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Tornin haarniskakoristeet",
	...
	"item.minecraft.splash_potion.effect.infested": "Roiskahtava saastumisen taikajuoma",
	...
	"item.minecraft.splash_potion.effect.oozing": "Roiskahtava limaisuuden taikajuoma",
	...
	"item.minecraft.splash_potion.effect.weaving": "Roiskahtava kutomisen taikajuoma",
	"item.minecraft.splash_potion.effect.wind_charged": "Roiskahtava tuulilatauksen taikajuoma",
	...
	"item.minecraft.stone_spear": "Kivikeihäs",
	...
	"item.minecraft.sulfur_cube_bucket": "Rikkikuutio ämpärissä",
	"item.minecraft.sulfur_cube_spawn_egg": "Luo rikkikuutio",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Vuorovetten haarniskakoristeet",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Saastunut nuoli",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Limainen nuoli",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Kutomisen nuoli",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Tuulilatauksen nuoli",
	...
	"item.minecraft.trial_key": "Koetuksen avain",
	...
	"item.minecraft.turtle_scute": "Kilpikonnan suomu",
	"item.minecraft.turtle_spawn_egg": "Luo kilpikonna",
	"item.minecraft.vex_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Piinan haarniskakoristeet",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Wardenin haarniskakoristeet",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Tiennäyttäjän haarniskakoristeet",
	"item.minecraft.wheat": "Vehnä",
	"item.minecraft.wheat_seeds": "Vehnän siemenet",
	"item.minecraft.white_bundle": "Valkoinen pussi",
	"item.minecraft.white_dye": "Valkoinen väriaine",
	"item.minecraft.white_harness": "Valkoiset valjaat",
	"item.minecraft.wild_armor_trim_smithing_template": "Taontamalli",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Viidakon haarniskakoristeet",
	"item.minecraft.wind_charge": "Puhuripallo",
	...
	"item.minecraft.wolf_armor": "Suden haarniska",
	...
	"item.minecraft.wooden_spear": "Puukeihäs",
	...
	"item.minecraft.yellow_bundle": "Keltainen pussi",
	"item.minecraft.yellow_dye": "Keltainen väriaine",
	"item.minecraft.yellow_harness": "Keltaiset valjaat",
	"item.minecraft.zoglin_spawn_egg": "Luo zoglin",
	"item.minecraft.zombie_horse_spawn_egg": "Luo zombihevonen",
	"item.minecraft.zombie_nautilus_spawn_egg": "Luo zombihelmivene",
	...
	"item.modifiers.any": "Kun käytössä:",
	"item.modifiers.armor": "Kun yllä:",
	"item.modifiers.body": "Kun yllä:",
	"item.modifiers.chest": "Kun yllä:",
	"item.modifiers.feet": "Kun jaloissa:",
	"item.modifiers.hand": "Kun kädessä:",
	...
	"item.modifiers.saddle": "Satuloituna:",
	"item.nbt_tags": "NBT: %s tunniste(tta)",
	"item.op_block_warning.line1": "Varoitus:",
	"item.op_block_warning.line2": "Tämän esineen käyttö saattaa johtaa komennon suorittamiseen",
	"item.op_block_warning.line3": "Älä käytä, ellet tiedä tarkkaa sisältöä!",
	"item.spawn_egg.peaceful": "Ei käytössä rauhallisella vaikeustasolla",
	...
	"jigsaw_block.placement_priority": "Asetteluprioriteetti:",
	"jigsaw_block.placement_priority.tooltip": "Kun tämä palapelikuutio yhdistyy palaseen, tämä on järjestys, jossa tuo palanen käsitellään laajemman rakennelman yhteyksiä varten.\n\nPalaset käsitellään laskevassa tärkeysjärjestyksessä, jossa lisäysjärjestys ratkoo tasatulokset.",
	"jigsaw_block.pool": "Kohderyhmä:",
	"jigsaw_block.selection_priority": "Valintaprioriteetti:",
	"jigsaw_block.selection_priority.tooltip": "Kun vanhempipalasta käsitellään yhteyksiä varten, tämä on järjestys, jossa tämä palapelikuutio yrittää yhdistyä kohdepalaseensa.\n\nPalapelit käsitellään laskevassa tärkeysjärjestyksessä, jossa satunnaisjärjestys ratkoo tasatulokset.",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine – Creator (Soittorasia)",
	...
	"key.categories.spectator": "Katsoja",
	"key.categories.ui": "Pelin käyttöliittymä",
	"key.category.minecraft.creative": "Luovuustila",
	"key.category.minecraft.debug": "Virheenkorjaus",
	"key.category.minecraft.gameplay": "Pelaaminen",
	"key.category.minecraft.inventory": "Tavaraluettelo",
	"key.category.minecraft.misc": "Sekalaista",
	"key.category.minecraft.movement": "Liikkuminen",
	"key.category.minecraft.multiplayer": "Moninpeli",
	"key.category.minecraft.spectator": "Katsoja",
	"key.chat": "Avaa keskustelu",
	"key.command": "Avaa komento",
	"key.debug.clearChat": "Tyhjennä keskustelu",
	"key.debug.copyLocation": "Kopioi sijainti",
	"key.debug.copyRecreateCommand": "Kopioi data",
	"key.debug.crash": "Virheenkorjauskaatuminen",
	"key.debug.debugOptions": "Virheenkorjausasetukset",
	"key.debug.dumpDynamicTextures": "Vedosta dynaamiset tekstuurit",
	"key.debug.dumpVersion": "Anna version tiedot",
	"key.debug.focusPause": "Pysäytys tarkennuksen kadotessa",
	"key.debug.fpsCharts": "FPS-kaaviot",
	"key.debug.lightmapTexture": "Valokartan tekstuuri",
	"key.debug.modifier": "Virheenkorjausasetusten muokkausnäppäin",
	"key.debug.networkCharts": "Verkkokaaviot",
	"key.debug.overlay": "Näytä/piilota peittokuva",
	"key.debug.profiling": "Aloita/lopeta profilointi",
	"key.debug.profilingChart": "Profilointikaavio",
	"key.debug.reloadChunk": "Uudelleenlataa lohkot",
	"key.debug.reloadResourcePacks": "Uudelleenlataa resurssipaketit",
	"key.debug.showAdvancedTooltips": "Näytä edistyneet vinkit",
	"key.debug.showChunkBorders": "Näytä lohkon rajat",
	"key.debug.showHitboxes": "Näytä osuma-alueet",
	"key.debug.spectate": "Vaihda katsojaa",
	"key.debug.switchGameMode": "Pelitilan vaihtaja",
	"key.drop": "Pudota valittu esine",
	"key.forward": "Kävele eteenpäin",
	"key.friends": "Ystävänäkymä",
	...
	"key.quickActions": "Pikatoiminnot",
	...
	"key.spectatorHotbar": "Valitse pikapalkista",
	"key.spectatorOutlines": "Korosta pelaajat",
	"key.sprint": "Juokse",
	"key.swapOffhand": "Vaihda esine toiseen käteen",
	"key.toggleGui": "Näytä/piilota käyttöliittymä",
	"key.togglePerspective": "Vaihda näkökulmaa",
	"key.toggleSpectatorShaderEffects": "Näytä/piilota katsojan varjostinefektit",
	"key.use": "Käytä esinettä/sijoita kuutio",
	"known_server_link.announcements": "Ilmoitukset",
	"known_server_link.community": "Yhteisö",
	"known_server_link.community_guidelines": "Yhteisön säännöt",
	"known_server_link.feedback": "Palaute",
	"known_server_link.forums": "Foorumit",
	"known_server_link.news": "Uutiset",
	"known_server_link.report_bug": "Ilmoita palvelinvirheestä",
	"known_server_link.status": "Tila",
	"known_server_link.support": "Tuki",
	"known_server_link.website": "Verkkosivusto",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Lisää palvelin",
	"manageServer.edit.title": "Muokkaa palvelimen tietoja",
	"manageServer.enterIp": "Palvelimen osoite",
	"manageServer.enterName": "Palvelimen nimi",
	"manageServer.resourcePack": "Palvelimen resurssipaketit",
	"manageServer.resourcePack.disabled": "Poissa käytöstä",
	"manageServer.resourcePack.enabled": "Käytössä",
	"manageServer.resourcePack.prompt": "Kehote",
	"mco.account.privacy.info": "Lue lisää Mojangista ja yksityisyydensuojalaeista",
	"mco.account.privacy.info.button": "Lue lisää yleisestä tietosuoja-asetuksesta (GDPR)",
	"mco.account.privacy.information": "Mojang soveltaa tiettyjä menetelmiä lasten ja heidän yksityisyytensä suojaamiseksi, mukaan lukien lasten yksityisyyden suojaa verkossa koskevan lain (COPPA) ja yleisen tietosuoja-asetuksen (GDPR) noudattaminen.\n\nSaatat tarvita vanhempien suostumuksen ennen kuin voit käyttää Realms-tiliäsi.",
	"mco.account.privacyinfo": "Mojang soveltaa tiettyjä menetelmiä lasten ja heidän yksityisyytensä suojaamiseksi, mukaan lukien lasten yksityisyyden suojaa verkossa koskevan lain (COPPA) ja yleisen tietosuoja-asetuksen (GDPR) noudattaminen.\n\nSaatat tarvita vanhempien suostumuksen ennen kuin voit käyttää Realms-tiliäsi.\n\nMikäli sinulla on vanhempi Minecraft-tili (kirjaudut sisään käyttäjänimelläsi), sinun tulee yhdistää tilisi Mojang-tiliin päästäksesi Realmsiin.",
	...
	"mco.backup.entry.enabledPack": "Käytössä olevat paketit",
	...
	"mco.backup.entry.worldType.adventureMap": "Seikkailukartta",
	"mco.backup.entry.worldType.experience": "Kokemus",
	"mco.backup.entry.worldType.inspiration": "Inspiraatio",
	"mco.backup.entry.worldType.minigame": "Minipeli",
	"mco.backup.entry.worldType.normal": "Tavallinen",
	"mco.backup.entry.worldType.unknown": "Tuntematon",
	"mco.backup.generate.world": "Luo maailma",
	"mco.backup.info.title": "Muutokset edellisestä varmuuskopiosta",
	"mco.backup.narration": "Varmuuskopio kohteesta %s",
	...
	"mco.brokenworld.nonowner.error": "Odota kunnes Realmin omistaja on nollannut maailmansa",
	...
	"mco.client.outdated.stable.version": "Pelisi versio (%s) ei ole yhteensopiva Realmsin kanssa.\n\nOle hyvä ja käytä Minecraftin uusinta versiota.",
	"mco.client.unsupported.snapshot.version": "Pelisi versio (%s) ei ole yhteensopiva Realmsin kanssa.\n\nRealms ei ole saatavilla tällä kehittäjäversiolla.",
	"mco.compatibility.downgrade": "Palauta aiempaan versioon",
	"mco.compatibility.downgrade.description": "Tätä maailmaa pelattiin viimeksi versiossa %s; käytät nyt versiota %s. Maailman pelaaminen aiemmalla versiolla voi aiheuttaa vaurioita – emme voi luvata että maailma latautuu tai toimii.\n\nVarmuuskopio maailmastasi tallennetaan \"Maailmojen varmuuskopiot\" -osioon. Palauta maailmasi jos on tarve.",
	"mco.compatibility.incompatible.popup.title": "Yhteensopimaton versio",
	"mco.compatibility.incompatible.releaseType.popup.message": "Maailma, johon yrität liittyä, ei ole yhteensopiva käyttämäsi version kanssa.",
	"mco.compatibility.incompatible.series.popup.message": "Tätä maailmaa on viimeksi pelattu versiossa %s; olet tällä hetkellä versiossa %s.\n\nNämä versiot eivät ole yhteensopivia keskenään. Uusi maailma vaaditaan tämän version pelaamiseksi.",
	"mco.compatibility.unverifiable.message": "Versiota, jolla tätä maailmaa viimeksi pelattiin, ei voitu tarkistaa. Jos maailman versiota muutetaan, varmuuskopio luodaan automaattisesti ja tallennetaan kohtaan \"Maailman varmuuskopiot\".",
	"mco.compatibility.unverifiable.title": "Yhteensopivuus ei vahvistettavissa",
	"mco.compatibility.upgrade": "Päivitä",
	"mco.compatibility.upgrade.description": "Tätä maailmaa pelattiin viimeksi versiossa %s; olet versiossa %s.\n\nVarmuuskopio maailmastasi tallennetaan \"World backups\" -kansioon.\n\nPalauta maailmasi tarvittaessa.",
	"mco.compatibility.upgrade.friend.description": "Tätä maailmaa pelattiin viimeksi versiossa %s; olet versiossa %s.\n\nVarmuuskopio maailmastasi tallennetaan \"World backups\" -kansioon.\n\nRealmin omistaja voi palauttaa maailman tarvittaessa.",
	"mco.compatibility.upgrade.title": "Haluatko todella päivittää maailmasi?",
	...
	"mco.configure.world.buttons.close": "Sulje Realm väliaikaisesti",
	...
	"mco.configure.world.buttons.newworld": "Uusi maailma",
	"mco.configure.world.buttons.open": "Avaa Realm uudelleen",
	"mco.configure.world.buttons.options": "Maailman asetukset",
	"mco.configure.world.buttons.players": "Pelaajat",
	"mco.configure.world.buttons.region_preference": "Valitse alue...",
	"mco.configure.world.buttons.resetworld": "Nollaa maailma",
	"mco.configure.world.buttons.save": "Tallenna",
	...
	"mco.configure.world.close.question.line1": "Voit sulkea Realmisi väliaikaisesti estäen pelaamisen, kun teet muutoksia. Avaa se uudelleen, kun olet valmis.\n\nTämä ei peruuta Realms-tilaustasi.",
	"mco.configure.world.close.question.line2": "Haluatko varmasti jatkaa?",
	"mco.configure.world.close.question.title": "Tarvitseeko sinun tehdä muutoksia ilman häiriötä?",
	"mco.configure.world.closing": "Suljetaan realmia väliaikaisesti...",
	...
	"mco.configure.world.invites.ops.tooltip": "Ylläpitäjä",
	...
	"mco.configure.world.loading": "Ladataan Realmia",
	"mco.configure.world.location": "Sijainti",
	"mco.configure.world.minigame": "Nykyinen: %s",
	"mco.configure.world.name": "Realmin nimi",
	"mco.configure.world.name.validation.whitespace": "Ei voi alkaa tai päättyä tyhjätilamerkillä. Se poistetaan.",
	"mco.configure.world.opening": "Avataan Realmia...",
	"mco.configure.world.players.error": "Kyseisen pelaajan nimeä ei ole olemassa",
	"mco.configure.world.players.invite.duplicate": "Tämänniminen pelaaja on jo kutsuttu Realmiin",
	"mco.configure.world.players.inviting": "Kutsutaan pelaajaa...",
	"mco.configure.world.players.title": "Pelaajat",
	"mco.configure.world.pvp": "PVP",
	"mco.configure.world.region_preference": "Aluemieltymys",
	"mco.configure.world.region_preference.title": "Aluemieltymyksen valinta",
	...
	"mco.configure.world.resourcepack.question": "Realm edellyttää mukautettua resurssipakettia\n\nHaluatko ladata sen pelataksesi?",
	...
	"mco.configure.world.settings.expired": "Et voi muokata vanhentuneen Realmin asetuksia",
	...
	"mco.configure.world.spawn_toggle.message.npc": "Tämän asetuksen poistaminen käytöstä poistaa kaikki tämän tyyppiset oliot, kuten kyläläiset",
	...
	"mco.configure.world.subscription.tab": "Tilaus",
	...
	"mco.configure.world.switch.slot.subtitle": "Maailma on tyhjä. Valitse mitä haluat tehdä",
	"mco.configure.world.title": "Määritä Realm:",
	"mco.configure.world.uninvite.player": "Oletko varma että haluat peruuttaa käyttäjän '%s' kutsun?",
	...
	"mco.download.confirmation.oversized": "Maailma, jota olet lataamassa, on suurempi kuin %s\n\nEt voi ladata tätä maailmaa uudelleen Realmiisi",
	...
	"mco.errorMessage.6007": "Käyttäjä on liian monessa Realmissa",
	"mco.errorMessage.6008": "Virheellinen Realmin nimi",
	"mco.errorMessage.6009": "Virheellinen Realmin kuvaus",
	"mco.errorMessage.connectionFailure": "Tapahtui virhe. Yritä uudelleen myöhemmin.",
	"mco.errorMessage.generic": "Tapahtui virhe: ",
	"mco.errorMessage.initialize.failed": "Realmin alustaminen epäonnistui",
	"mco.errorMessage.noDetails": "Virhetietoja ei annettu",
	"mco.errorMessage.realmsService": "Tapahtui virhe (%s):",
	"mco.errorMessage.realmsService.configurationError": "Maailman asetusten muokkaamisessa tapahtui odottamaton virhe",
	"mco.errorMessage.realmsService.connectivity": "Realmiin ei voitu muodostaa yhteyttä: %s",
	"mco.errorMessage.realmsService.realmsError": "Realmsit (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Yhteensopivan version tarkistaminen epäonnistui. Saatiin vastaus: %s",
	"mco.errorMessage.retry": "Yritä operaatiota uudelleen",
	...
	"mco.gui.ok": "Ok",
	"mco.info": "Tietoa!",
	"mco.invited.player.narration": "Pelaaja %s kutsuttu",
	...
	"mco.notification.transferSubscription.buttonText": "Siirrä nyt",
	"mco.notification.transferSubscription.message": "Java Realms -tilaukset siirtyvät Microsoft-kauppaan. Älä anna tilauksesi päättyä!\nSiirrä tilauksesi nyt ja saat 30 päivän Realmsin ilmaiseksi.\nMene Profiiliisi osoitteessa minecraft.net siirtääksesi tilauksesi.",
	...
	"mco.onlinePlayers": "Paikalla olevat pelaajat",
	"mco.play.button.realm.closed": "Realm on suljettu",
	...
	"mco.selectServer.closed": "Käytöstä poistettu Realm",
	...
	"mco.selectServer.create.subtitle": "Valitse minkä maailman laitat uuteen Realmiisi",
	...
	"mco.selectServer.loading": "Ladataan Realms-luetteloa",
	"mco.selectServer.mapOnlySupportedForVersion": "Tätä karttaa ei tueta versiossa %s",
	"mco.selectServer.minigame": "Minipeli:",
	"mco.selectServer.minigameName": "Minipeli: %s",
	"mco.selectServer.minigameNotSupportedInVersion": "Tätä minipeliä ei voi pelata versiossa %s",
	"mco.selectServer.noRealms": "Sinulla ei näytä olevan Realmia. Lisää Realm pelataksesi yhdessä kavereidesi kanssa.",
	...
	"mco.selectServer.popup": "Realms on turvallinen ja yksinkertainen tapa nauttia Minecraft-maailmasta verkossa yhdessä jopa kymmenen kaverin kanssa. Se tukee useita minipelejä ja monia muokattuja maailmoja! Vain Realmin omistajan tarvitsee maksaa.",
	"mco.selectServer.purchase": "Lisää Realm",
	"mco.selectServer.trial": "Hanki kokeiluaika!",
	"mco.selectServer.uninitialized": "Klikkaa aloittaaksesi uuden Realmin!",
	"mco.snapshot.createSnapshotPopup.text": "Olet luomassa ilmaista kehittäjäversion Realmia, joka yhdistetään maksulliseen Realms-tilaukseesi. Tämä kehittäjäversion Realm on käytettävissä niin kauan kuin sinulla on aktiivinen tilaus. Tämä ei vaikuta maksulliseen Realmiisi.",
	"mco.snapshot.createSnapshotPopup.title": "Luo kehittäjäversion Realm?",
	"mco.snapshot.creating": "Luodaan kehittäjäversion Realmia...",
	"mco.snapshot.description": "Yhdistetty tilaukseen \"%s\"",
	"mco.snapshot.friendsRealm.downgrade": "Sinun tulee olla versiossa %s liittyäksesi tähän Realmiin",
	"mco.snapshot.friendsRealm.upgrade": "Pelaajan %s on päivitettävä Realminsa ennen kuin voit pelata siinä tällä versiolla",
	"mco.snapshot.paired": "Tämä kehittäjäversion Realm on yhdistetty tilaukseen \"%s\"",
	"mco.snapshot.parent.tooltip": "Käytä Minecraftin viimeisintä julkaisua pelataksesi tässä Realmissa",
	"mco.snapshot.start": "Aloita ilmainen kehittäjäversion Realm",
	"mco.snapshot.subscription.info": "Tämä on kehittäjäversion Realm, joka on yhdistetty Realmin \"%s\" tilaukseen. Se on käytettävissä kun sen yhteydessä oleva Realm on aktiivinen.",
	"mco.snapshot.tooltip": "Käytä kehittäjäversion Realmsia päästäksesi kurkistamaan Minecraftin tuleviin versioihin, jotka saattavat sisältää uusia ominaisuuksia ja muita muutoksia.\n\nLöydät tavalliset Realmisi pelin kokoversiosta.",
	"mco.snapshotRealmsPopup.message": "Realms on saatavilla kehittäjäversioissa alkaen versiosta 23w41a. Jokaisen Realms-tilauksen mukana tulee ilmainen kehittäjäversion Realm, joka on erillinen tavallisesta Java-version Realmistasi!",
	"mco.snapshotRealmsPopup.title": "Realms on nyt saatavilla kehittäjäversioissa",
	"mco.snapshotRealmsPopup.urlText": "Lue lisää",
	...
	"mco.upload.failed.too_big.description": "Valittu maailma on liian suuri. Suurin sallittu koko on %s.",
	"mco.upload.failed.too_big.title": "Maailma on liian suuri",
	...
	"menu.custom_options": "Mukautetut asetukset...",
	"menu.custom_options.title": "Mukautetut asetukset",
	"menu.custom_options.tooltip": "Huom: Mukautetut asetukset ovat kolmannen osapuolen palvelimien ja/tai sisältöjen tarjoamia.\nKäytä varoen!",
	"menu.custom_screen_info.button_narration": "Tämä on mukautettu ruutu. Lue lisää.",
	"menu.custom_screen_info.contents": "Tämän ruudun sisältöä hallinnoivat kolmannen osapuolen palvelimet ja kartat, joita Mojang Studios tai Microsoft ei omista, käytä tai valvo.\n\nKäytä varoen! Ole aina varovainen klikatessasi linkkejä, äläkä koskaan anna henkilökohtaisia tietojasi, kuten käyttäjätunnuksia ja salasanoja.\n\nJos tämä ruutu estää sinua pelaamasta, voit myös poistua nykyiseltä palvelimelta käyttämällä alla olevaa nappia.",
	"menu.custom_screen_info.disconnect": "Mukautettu ruutu hylätty",
	"menu.custom_screen_info.title": "Huomautus mukautetuista ruuduista",
	"menu.custom_screen_info.tooltip": "Tämä on mukautettu ruutu. Klikkaa tästä saadaksesi lisätietoa.",
	"menu.disconnect": "Katkaise yhteys",
	"menu.feedback": "Palaute...",
	"menu.feedback.title": "Palaute",
	"menu.game": "Pelivalikko",
	"menu.modded": " (Modattu)",
	"menu.multiplayer": "Moninpeli",
	"menu.multiplayerOptions.applyChanges": "Hyväksy muutokset",
	"menu.multiplayerOptions.button": "Moninpeli...",
	"menu.multiplayerOptions.network": "Moninpeli",
	"menu.multiplayerOptions.network.header": "Verkko",
	"menu.multiplayerOptions.network.lan": "Lähiverkko",
	"menu.multiplayerOptions.network.lan.tooltip": "Samassa verkossa olevat pelaajat voivat liittyä.",
	"menu.multiplayerOptions.network.off": "POIS",
	"menu.multiplayerOptions.network.off.tooltip": "Kukaan ei voi liittyä.",
	"menu.multiplayerOptions.network.online": "Paikalla",
	"menu.multiplayerOptions.network.online.tooltip": "Paikallaolevat kaverit voivat liittyä.",
	"menu.multiplayerOptions.otherPlayers.header": "Muut pelaajat",
	"menu.multiplayerOptions.publish.started.lan": "Tämä maailma on nyt avattu lähiverkkoon. Portin numero on %s",
	"menu.multiplayerOptions.publish.started.online": "Tämä maailma on nyt avattu verkkomoninpeliin.",
	"menu.multiplayerOptions.publish.stopped": "Moninpeli on suljettu tässä maailmassa",
	"menu.multiplayerOptions.title": "Moninpeliasetukset",
	...
	"menu.playerReporting.no_players": "Tässä maailmassa ei ole raportoitavia pelaajia",
	"menu.preparingSpawn": "Valmistellaan synnyinaluetta: %s%%",
	"menu.quick_actions": "Pikatoiminnot...",
	"menu.quick_actions.title": "Pikatoiminnot",
	"menu.quit": "Poistu pelistä",
	"menu.reportBugs": "Ilmoita virheistä",
	...
	"menu.server_links": "Palvelinlinkit...",
	"menu.server_links.title": "Palvelinlinkit",
	...
	"multiplayer.codeOfConduct.check": "Älä näytä enää näiden sääntöjen kohdalla",
	"multiplayer.codeOfConduct.title": "Palvelimen säännöt",
	"multiplayer.confirm_command.parse_errors": "Yrität suorittaa tuntematonta tai virheellistä komentoa.\nOletko varma?\nKomento: %s",
	"multiplayer.confirm_command.permissions_required": "Yrität suorittaa komentoa, joka vaatii korkeampia oikeuksia.\nTämä saattaa vaikuttaa peliin negatiivisesti.\nOletko varma?\nKomento: %s",
	"multiplayer.confirm_command.run_command": "Suorita komento",
	"multiplayer.confirm_command.signature_required": "Yrität suorittaa komentoa, joka lähettää keskusteluviestejä nimelläsi.\nSen voi suorittaa vain keskusteluikkunasta\nKomento: %s",
	"multiplayer.confirm_command.suggest_command": "Kopioi keskusteluikkunaan",
	"multiplayer.confirm_command.title": "Vahvista komennon suorittaminen",
	"multiplayer.disconnect.authservers_down": "Todennuspalvelimet ovat alhaalla. Yritä myöhemmin uudelleen. Pahoittelut!",
	"multiplayer.disconnect.bad_chat_index": "Vastaanotettu puuttuva tai uudelleenjärjestelty keskusteluviesti palvelimelta",
	...
	"multiplayer.disconnect.banned.reason.default": "Operaattori on antanut sinulle porttikiellon.",
	...
	"multiplayer.disconnect.code_of_conduct": "Palvelin vaatii sääntöjen hyväksymistä",
	"multiplayer.disconnect.configuration_error": "Tuntematon virhe määrityksen aikana",
	...
	"multiplayer.disconnect.kicked": "Operaattori potkaisi sinut palvelimelta",
	...
	"multiplayer.disconnect.transfers_disabled": "Tämä palvelin ei hyväksy siirtoja",
	...
	"multiplayer.player.list.hp": "%sep",
	"multiplayer.player.list.narration": "Paikalla olevat pelaajat: %s",
	"multiplayer.requiredTexturePrompt.disconnect": "Tämä palvelin vaatii mukautetun resurssipaketin",
	...
	"multiplayer.status.anonymous_player": "Anonyymi pelaaja",
	...
	"narration.checkbox.usage.focused.check": "Paina Enteriä valitaksesi",
	"narration.checkbox.usage.focused.uncheck": "Paina Enteriä poistaaksesi valinnan",
	"narration.checkbox.usage.hovered": "Napsauta hiiren vasenta painiketta vaihtaaksesi",
	"narration.checkbox.usage.hovered.check": "Napsauta hiiren vasenta painiketta valitaksesi",
	"narration.checkbox.usage.hovered.uncheck": "Napsauta hiiren vasenta painiketta poistaaksesi valinnan",
	...
	"narration.item": "Esine: %s",
	"narration.link.usage.focused": "Paina Enteriä seurataksesi linkkiä",
	"narration.link.usage.hovered": "Klikkaa hiiren vasenta painiketta seurataksesi linkkiä",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Paina enteriä aloittaaksesi liukusäätimen arvon muuttamisen",
	...
	"narration.suggestion.usage.cycle.fixed": "Paina Tabia siirtyäksesi seuraavaan ehdotukseen",
	"narration.suggestion.usage.cycle.hidable": "Paina Tabia siirtyäksesi seuraavaan ehdotukseen tai Esciä poistuaksesi ehdotuksista",
	"narration.suggestion.usage.fill.fixed": "Paina Tabia käyttääksesi ehdotusta",
	"narration.suggestion.usage.fill.hidable": "Paina Tabia käyttääksesi ehdotusta tai Esciä poistuaksesi ehdotuksista",
	...
	"narrator.select.world_info": "Valittu %s, viimeksi pelattu: %s, %s",
	...
	"optimizeWorld.confirm.proceed": "Luo varmuuskopio ja optimoi",
	...
	"optimizeWorld.stage.finished.chunks": "Viimeistellään lohkojen päivitystä...",
	"optimizeWorld.stage.finished.entities": "Viimeistellään olioiden päivitystä...",
	"optimizeWorld.stage.finished.poi": "Viimeistellään kiinnostavien kohteiden päivitystä...",
	"optimizeWorld.stage.upgrading": "Päivitetään kaikki lohkot...",
	"optimizeWorld.stage.upgrading.chunks": "Päivitetään kaikki lohkot...",
	"optimizeWorld.stage.upgrading.entities": "Päivitetään kaikki oliot...",
	"optimizeWorld.stage.upgrading.poi": "Päivitetään kaikki kiinnostavat kohteet...",
	"optimizeWorld.title": "Optimoidaan maailmaa '%s'",
	"options.accessibility": "Esteettömyysasetukset...",
	...
	"options.accessibility.high_contrast_block_outline": "Korkeakontrastiset kuutioiden ääriviivat",
	"options.accessibility.high_contrast_block_outline.tooltip": "Tehostaa tähtäimen kohteena olevan kuution ääriviivojen kontrastia.",
	"options.accessibility.link": "Esteettömyysopas",
	"options.accessibility.menu_background_blurriness": "Valikon taustan sumennus",
	"options.accessibility.menu_background_blurriness.tooltip": "Muuttaa valikon taustan sumeutta",
	"options.accessibility.narrator_hotkey": "Kertojan pikanäppäin",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Sallii kertojan asettamisen päälle tai pois näppäinkomennolla 'Komento + B'.",
	"options.accessibility.narrator_hotkey.tooltip": "Sallii kertojan asettamisen päälle tai pois näppäinkomennolla 'Ctrl + B'.",
	...
	"options.accessibility.tooltip": "Saavutettavuusasetukset",
	"options.allowCursorChanges": "Salli kursorin muutokset",
	"options.allowCursorChanges.tooltip": "Sallii hiiren kursorin muuttaa muotoaan tiettyjen käyttöliittymäelementtien päällä.",
	"options.allowFriendRequests": "Salli pyynnöt",
	"options.allowFriendRequests.tooltip": "Salli muiden pelaajien lähettää sinulle kaveripyyntöjä",
	"options.allowServerListing": "Salli palvelinlistaus",
	"options.allowServerListing.tooltip": "Palvelimet voivat luetella online-pelaajat osana julkista tilaansa.\nTämän asetuksen ollessa pois päältä nimesi ei näy kyseisissä listoissa.",
	...
	"options.blocks": "%s kuutiota",
	"options.chat": "Keskusteluasetukset...",
	"options.chat.color": "Värit",
	"options.chat.delay": "Keskusteluviive: %s sekunti(a)",
	"options.chat.delay_none": "Keskusteluviive: Ei viivettä",
	"options.chat.drafts": "Tallenna lähettämättömät keskusteluviestit",
	"options.chat.drafts.tooltip": "Lähettämättömät viestit tallennetaan ja voidaan lähettää seuraavalla kerralla, kun keskustelu avataan.",
	...
	"options.chunkFade": "Lohkojen häipymisaika",
	"options.chunkFade.none": "Lohkojen häipyminen: ei ole",
	"options.chunkFade.seconds": "Lohkojen häipyminen: %s sekunti(a)",
	"options.chunkFade.tooltip": "Kuinka pitkään sekunneissa lohkojen pitäisi voimistua, kun ne renderöidään ensimmäisen kerran, jos ollenkaan.",
	...
	"options.cutoutLeaves": "Läpinäkyvät lehdet",
	"options.cutoutLeaves.tooltip": "Mahdollistaa lehtien aukkojen läpi näkemisen. Käytöstä poistaminen parantaa suorituskykyä.",
	...
	"options.exclusiveFullscreen": "Eksklusiivinen kokonäyttötila",
	"options.exclusiveFullscreen.warningTooltip": "Tämä asetus voi estää joitain syöttötapoja toimimasta.",
	"options.font": "Fonttiasetukset...",
	"options.font.title": "Fonttiasetukset",
	...
	"options.friendsList": "Kaverilista",
	"options.friendsList.confirm.message": "Kaverilista hallinnoi, kenen kanssa voit keskustella, kun \"Voit lähettää puheääni- ja tekstiviestejä myös muille kuin Xbox-pelaajille\" on asetettu arvoon \"Ystävät\".\n\nHallinnoi tätä asetusta Microsoft-tililläsi.\n\nKun kaverilista on PÄÄLLÄ, muut pelaajat voivat lähettää sinulle kaveripyyntöjä. Voit laittaa kaverikutsut tai kaverilistan POIS milloin vain.",
	"options.friendsList.confirm.message.link": "Microsoft-tili",
	"options.friendsList.confirm.title": "Laitetaanko kaverilista PÄÄLLE?",
	"options.friendsList.confirm.turnOff": "Laita POIS",
	"options.friendsList.confirm.turnOn": "Laita PÄÄLLE",
	"options.fullscreen": "Kokonäyttötila",
	"options.fullscreen.current": "Nykyinen",
	"options.fullscreen.entry": "%sx%s@%s (%s-bittinen)",
	...
	"options.graphics.custom": "Mukautettu",
	"options.graphics.fabulous": "Upea!",
	"options.graphics.fabulous.tooltip": "%s grafiiikka käyttää näytön varjostimia sääilmiöiden, pilvien ja partikkeleiden piirtämiseen läpikuultavien kuutioiden ja veden taakse.\nTämä saattaa vaikuttaa merkittävästi kannettavien laitteiden ja 4K-näyttöjen suorituskykyyn.",
	...
	"options.graphics.preset": "Esiasetus",
	"options.graphics.preset.tooltip": "Asettaa Laatu- & suorituskykyasetukset kohtuullisiin oletusarvoihin, jotka vastaavat haluttua laatua.",
	...
	"options.graphics.warning.vendor": "Toimittaja havaittu: [%s]",
	"options.graphics.warning.version": "OpenGL-versio havaittu: [%s]",
	"options.graphicsApi": "Grafiikkarajapinta",
	"options.graphicsApi.default": "Oletus",
	"options.graphicsApi.opengl": "Suosi OpenGL:ää",
	"options.graphicsApi.restart": "Sinun täytyy uudelleenkäynnistää peli vaihtaaksesi grafiikkarajapintaa.",
	"options.graphicsApi.tooltip": "Mitä grafiikkarajapintaa käytetään renderöintiin. Jätä oletukseksi, ellei sinulla ole erityistä tarvetta vaihtaa tätä! Vaikuttaa, kun seuraavan kerran käynnistät pelin.",
	"options.graphicsApi.tooltip.vulkan": "Kokeellinen. Voi huonontaa suorituskykyä tai aiheuttaa epävakautta joillain järjestelmillä.",
	"options.graphicsApi.vulkan": "Suosi Vulkania",
	"options.guiScale": "Valikon koko",
	"options.guiScale.auto": "Automaattinen",
	"options.hidden": "Piilotettu",
	"options.hideLightningFlashes": "Piilota taivaan välähdykset",
	"options.hideLightningFlashes.tooltip": "Estää salamoita tai muita ympäristövaikutuksia aiheuttamasta taivaan välähdyksiä. Välähdysten lähteet näkyvät silti.",
	...
	"options.hideSplashTexts": "Piilota huomiotekstit",
	"options.hideSplashTexts.tooltip": "Piilottaa keltaisen huomiotekstin päävalikosta.",
	"options.improvedTransparency": "Paranneltu läpinäkyvyys",
	"options.improvedTransparency.tooltip": "Kokeellinen lähestymistapa, jossa käytetään näytön varjostimia sääilmiöiden, pilvien ja partikkeleiden piirtämiseen läpikuultavien kuutioiden ja veden taakse.\nTämä vaikuttaa näytönohjaimen suorituskykyyn.",
	"options.inGameNotification": "Pelinsisäinen ilmoitus",
	"options.inGameNotification.tooltip": "Näytä pelinsisäiset kaveri-ilmoitukset",
	"options.inactivityFpsLimit": "Pienennä kuvataajuutta",
	"options.inactivityFpsLimit.afk": "AFK",
	"options.inactivityFpsLimit.afk.tooltip": "Rajoittaa kuvataajuuden 30:een, kun peli ei saa mitään pelaajan syötteitä yli minuuttiin. Rajoittaa sen edelleen 10:een 9 minuutin kuluttua.",
	"options.inactivityFpsLimit.minimized": "Minimoitu",
	"options.inactivityFpsLimit.minimized.tooltip": "Rajoittaa kuvataajuutta kun ikkuna on pienennetty.",
	"options.invertMouse": "Käänteinen hiiri",
	"options.invertMouseX": "Käänteinen hiiren X",
	"options.invertMouseY": "Käänteinen hiiren Y",
	"options.japaneseGlyphVariants": "Japanilaiset merkkivariantit",
	"options.japaneseGlyphVariants.tooltip": "Käyttää japanilaisia variantteja CJK-kirjoitusmerkeistä oletusfontissa",
	"options.key.hold": "Pidä painettuna",
	"options.key.toggle": "Paina kerran",
	"options.language": "Kieli...",
	"options.language.narration": "Vaihda kieltä",
	"options.language.title": "Kieli",
	"options.language.tooltip": "Vaihda kieltä",
	"options.languageAccuracyWarning": "(Käännökset eivät välttämättä ole 100%% tarkkoja)",
	...
	"options.maxAnisotropy": "Anisotrooppinen suodatus",
	"options.maxAnisotropy.tooltip": "Parantaa merkittävästi tekstuurien tasaisuutta, mutta vaikuttaa suorituskykyyn ja videomuistin käyttöön. Ei välttämättä tueta kaikilla laitteistoilla.",
	...
	"options.musicToast": "Musiikin ponnahdusilmoitus",
	"options.musicToast.never": "Ei koskaan",
	"options.musicToast.never.tooltip": "Musiikin ponnahdusilmoitusta ei näytetä.",
	"options.musicToast.pauseMenu": "Taukovalikko",
	"options.musicToast.pauseMenu.tooltip": "Ilmoitus soivasta kappaleesta näytetään pelin taukovalikossa aina, kun musiikki soi.",
	"options.musicToast.pauseMenuAndToast": "Taukovalikko ja ponnahdusilmoitus",
	"options.musicToast.pauseMenuAndToast.tooltip": "Näyttää ponnahdusilmoituksen kappaleen alkaessa soida. Sama ilmoitus näkyy jatkuvasti pelin taukovalikossa kappaleen soidessa.",
	"options.music_frequency": "Musiikin esiintymistiheys",
	"options.music_frequency.constant": "Jatkuva",
	"options.music_frequency.default": "Oletus",
	"options.music_frequency.frequent": "Tiheä",
	"options.music_frequency.tooltip": "Muuttaa sitä, kuinka usein musiikkia soi pelimaailmassa.",
	...
	"options.needsRestart": "Asetus otetaan käyttöön uudelleenkäynnistyksen jälkeen.",
	...
	"options.online.friends.header": "Kaverilista",
	"options.online.realms.header": "Realms",
	"options.online.servers.header": "Palvelimet",
	"options.online.title": "Verkkopelaamisen asetukset",
	"options.online.xboxSettings": "Xbox-asetukset...",
	...
	"options.realmsNotifications.button": "Uutiset & kutsut",
	"options.realmsNotifications.tooltip": "Hakee Realms-uutiset ja -kutsut päävalikosta ja näyttää niiden vastaavat kuvakkeet Realms-painikkessa.",
	"options.reducedDebugInfo": "Vähennetyt virheenkorjaustiedot",
	"options.renderClouds": "Pilvet",
	"options.renderCloudsDistance": "Pilvien etäisyys",
	"options.renderDistance": "Näköetäisyys",
	"options.resourcepack": "Resurssipaketit...",
	"options.restartRequired": "Jotkin muutoksistasi vaativat pelin uudelleenkäynnistyksen tullakseen voimaan.",
	"options.rotateWithMinecart": "Käänny kaivosvaunujen mukana",
	"options.rotateWithMinecart.tooltip": "Kääntyykö pelaajan kuvakulma kaivosvaunun mukana. Saatavilla vain maailmoissa, joissa kokeellinen asetus \"Kaivosvaunuparannukset\" on otettu käyttöön.",
	...
	"options.sharePresence": "Paikallaolo",
	"options.sharePresence.all": "Kaikki",
	"options.sharePresence.all.tooltip": "Paikallaolo jaetaan kavereidesi kanssa. Näyt paikallaolevana ja jaat tekemisesi.",
	"options.sharePresence.limited": "Rajoitettu",
	"options.sharePresence.limited.tooltip": "Rajoitettu paikallaolo jaetaan. Näyt paikallaolevana mutta et jaa tekemisiäsi. Voit silti kutsua kavereita peliisi.",
	"options.sharePresence.none": "Ei mitään",
	"options.sharePresence.none.tooltip": "Mitään paikallaoloa ei jaeta. Et näy paikallaolevana.",
	"options.showNowPlayingToast": "Näytä musiikin ponnahdusilmoitus",
	"options.showNowPlayingToast.tooltip": "Näyttää ponnahdusilmoituksen kappaleen alkaessa soida. Sama ilmoitus näkyy jatkuvasti pelin taukovalikossa kappaleen soidessa.",
	"options.showSubtitles": "Tekstitykset",
	"options.showSubtitles.tooltip": "Ottaa tekstitykset käyttöön pelin äänille.",
	...
	"options.sprintWindow": "Juoksun aktivoituminen",
	"options.sprintWindow.tooltip": "Aikaväli pykälinä, jonka aikana eteenpäin-näppäimen kaksoisnapautus aktivoi juoksun.",
	...
	"options.telemetry.disabled": "Telemetria on poissa käytöstä.",
	"options.telemetry.state.all": "Kaikki",
	"options.telemetry.state.minimal": "Vähän",
	"options.telemetry.state.none": "Ei mitään",
	"options.textureFiltering": "Tekstuurien suodatus",
	"options.textureFiltering.anisotropic": "Anisotrooppinen",
	"options.textureFiltering.anisotropic.tooltip": "Laitteistopohjainen suodatusmenetelmä, joka vaikuttaa suorituskykyyn ja videomuistin käyttöön merkittävästi. Ei välttämättä tueta kaikilla laitteistoilla.",
	"options.textureFiltering.none": "Ei mitään",
	"options.textureFiltering.none.tooltip": "Tekstuurit näytetään ilman mitään suodatusta. Kuutiot saattavat näyttää epäselviltä, jos niitä katsotaan tietystä kulmasta.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nVarjostinpohjainen suodatusmenetelmä, joka parantaa tekstuurien laatua vaikuttaen suorituskykyyn maltillisesti.",
	"options.title": "Asetukset",
	"options.touchscreen": "Kosketusnäyttötila",
	"options.value": "%s",
	"options.video": "Videoasetukset...",
	"options.video.display.header": "Näyttö",
	"options.video.interface.header": "Käyttöliittymä",
	"options.video.preferences.header": "Asetukset",
	"options.video.quality.header": "Laatu & suorituskyky",
	"options.videoTitle": "Videoasetukset",
	"options.viewBobbing": "Kuvan keikkuminen",
	"options.vignette": "Näytä vinjetti",
	"options.vignette.tooltip": "Tämä on pelinäytön päälle lisätty hienovarainen tekstuuri, jonka avulla näytön reunoilla kirkkautta vähennetään sekä varoitetaan pelimaailman rajoista.",
	"options.visible": "Näkyvillä",
	"options.vsync": "VSync",
	"options.weatherRadius": "Säävaikutusten säde",
	"options.weatherRadius.tooltip": "Alueen säde, jolla sade- ja lumivaikutukset ovat näkyvissä. Erittäin vähäinen vaikutus suorituskykyyn.",
	"options.worldOptions.button": "Maailman asetukset...",
	"options.worldOptions.title": "Maailman asetukset",
	...
	"pack.dropRejected.message": "Seuraavat kohteet eivät olleet kelvollisia paketteja, eikä niitä kopioitu:\n %s",
	"pack.dropRejected.title": "Kohteet, jotka eivät ole paketteja",
	...
	"pack.incompatible.confirm.unknown": "Tämä paketti on rikki tai se on tehty tuntemattomalle Minecraft-versiolle eikä välttämättä toimi oikein.",
	...
	"pack.incompatible.unknown": "(rikki tai yhteensopimaton)",
	...
	"painting.minecraft.backyard.title": "Takapiha",
	"painting.minecraft.baroque.author": "Sarah Boeving",
	"painting.minecraft.baroque.title": "Barokki",
	...
	"painting.minecraft.bouquet.title": "Kukkakimppu",
	...
	"painting.minecraft.cavebird.title": "Luolalintu",
	"painting.minecraft.changing.author": "Kristoffer Zetterstrand",
	"painting.minecraft.changing.title": "Lavasteiden vaihto",
	...
	"parsing.bool.invalid": "Virheellinen totuusarvomuuttuja: odotettiin 'true' tai 'false' mutta sinulla on '%s'",
	...
	"particle.invalidOptions": "Ei voida jäsentää partikkeliasetuksia: %s",
	...
	"realms.configuration.region.australia_east": "Uusi Etelä-Wales, Australia",
	...
	"realms.configuration.region.central_us": "Iowa, Yhdysvallat",
	"realms.configuration.region.east_asia": "Hongkong",
	"realms.configuration.region.east_us": "Virginia, Yhdysvallat",
	"realms.configuration.region.east_us_2": "Pohjois-Carolina, Yhdysvallat",
	"realms.configuration.region.france_central": "Ranska",
	"realms.configuration.region.japan_east": "Itä-Japani",
	"realms.configuration.region.japan_west": "Länsi-Japani",
	"realms.configuration.region.korea_central": "Etelä-Korea",
	"realms.configuration.region.north_central_us": "Illinois, Yhdysvallat",
	"realms.configuration.region.north_europe": "Irlanti",
	"realms.configuration.region.south_central_us": "Teksas, Yhdysvallat",
	"realms.configuration.region.southeast_asia": "Singapore",
	"realms.configuration.region.sweden_central": "Ruotsi",
	"realms.configuration.region.uae_north": "Yhdistyneet arabiemiirikunnat",
	"realms.configuration.region.uk_south": "Etelä-Englanti",
	"realms.configuration.region.west_central_us": "Utah, Yhdysvallat",
	"realms.configuration.region.west_europe": "Alankomaat",
	"realms.configuration.region.west_us": "Kalifornia, Yhdysvallat",
	"realms.configuration.region.west_us_2": "Washington, Yhdysvallat",
	"realms.configuration.region_preference.automatic_owner": "Automaattinen (Realmin omistajan viive)",
	"realms.configuration.region_preference.automatic_player": "Automaattinen (ensimmäiseksi liittynyt)",
	"realms.missing.snapshot.error.text": "Realms ei ole yhteensopiva kehittäjäversioiden kanssa",
	...
	"recover_world.bug_tracker": "Ilmoita virheestä",
	"recover_world.button": "Yritä palauttamista",
	"recover_world.done.failed": "Edellisestä versiosta palauttaminen epäonnistui.",
	"recover_world.done.success": "Palauttaminen onnistui!",
	"recover_world.done.title": "Palauttaminen valmis",
	"recover_world.issue.missing_file": "Puuttuva tiedosto",
	"recover_world.issue.none": "Ei ongelmia",
	"recover_world.message": "Seuraavat ongelmat ilmenivät, kun yritettiin lukea maailmankansiota \"%s\".\nOn ehkä mahdollista palauttaa maailma aiemmasta tilasta, tai voit ilmoittaa virheestä bugien seurantaan.",
	"recover_world.no_fallback": "Tilaa, josta palauttaa, ei ole saatavilla",
	"recover_world.restore": "Yritä palauttamista",
	"recover_world.restoring": "Yritetään palauttaa maailmaa...",
	"recover_world.state_entry": "Versio ajalta %s: ",
	"recover_world.state_entry.unknown": "tuntematon",
	"recover_world.title": "Maailman lataaminen epäonnistui",
	"recover_world.warning": "Maailman yhteenvedon lataaminen epäonnistui",
	...
	"resourcePack.runtime_failure": "Virhe resurssipaketissa havaittu",
	...
	"restrictions_screen.button": "Rajoitukset...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Voit vastaanottaa viestejä pelaajilta",
	"restrictions_screen.permission.receive_player_messages.denied": "Et voi vastaanottaa viestejä pelaajilta",
	"restrictions_screen.permission.receive_system_messages.allowed": "Voit vastaanottaa järjestelmäviestejä palvelimelta",
	"restrictions_screen.permission.receive_system_messages.denied": "Et voi vastaanottaa järjestelmäviestejä palvelimelta",
	"restrictions_screen.permission.send_commands.allowed": "Voit lähettää komentoja",
	"restrictions_screen.permission.send_commands.denied": "Et voi lähettää komentoja",
	"restrictions_screen.permission.send_messages.allowed": "Voit lähettää keskusteluviestejä",
	"restrictions_screen.permission.send_messages.denied": "Et voi lähettää keskusteluviestejä",
	"restrictions_screen.title": "Rajoitukset",
	...
	"selectWorld.allowCommands.new": "Salli komennot",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Luo varmuuskopio ennen maailman päivittämistä?",
	...
	"selectWorld.backupWarning.file_fixing_required": "Tämä maailma tulee päivittää ennen kuin siinä voi pelata. Suosittelemme vahvasti varmuuskopion luomista ennen jatkamista siltä varalta, että maailma korruptoituu.",
	"selectWorld.backupWarning.snapshot": "Tätä maailmaa on viimeksi pelattu versiossa %s; olet tällä hetkellä versiossa %s. Luothan varmuuskopion siltä varalta että maailmasi korruptoituu.",
	"selectWorld.bonusItems": "Bonusarkku",
	"selectWorld.cheats": "Huijauskomennot",
	"selectWorld.commands": "Komennot",
	...
	"selectWorld.gameMode.creative.info": "Luo, rakenna ja tutki ilman rajoituksia. Voit lentää, sinulla on loputtomasti materiaaleja, eivätkä hirviöt voi vahingoittaa sinua.",
	...
	"selectWorld.gameMode.hardcore.line2": "vaikeusasteelle, ja sinulla on vain yksi elämä",
	...
	"selectWorld.incompatible.description": "Tätä maailmaa ei voi avata tässä versiossa.\nSitä pelattiin viimeksi versiossa %s.",
	"selectWorld.incompatible.info": "Yhteensopimaton versio: %s",
	"selectWorld.incompatible.title": "Yhteensopimaton versio",
	"selectWorld.incompatible.tooltip": "Tätä maailmaa ei voi avata, koska se on luotu yhteensopimattomalla versiolla.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Tämä maailma tulee päivittää viimeisimpään versioon ennen kuin voit muokata sitä, sillä maailman formaattiin on tehty perustavanlaatuisia muutoksia.",
	"selectWorld.requiresFileFixingTooltip.play": "Tämä maailma tulee päivittää viimeisimpään versioon ennen kuin voit pelata siinä, sillä maailman formaattiin on tehty perustavanlaatuisia muutoksia.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Tämä maailma tulee päivittää viimeisimpään versioon ennen kuin voit luoda sen uudelleen, sillä maailman formaattiin on tehty perustavanlaatuisia muutoksia.",
	"selectWorld.resource_load": "Valmistellaan resursseja...",
	...
	"selectWorld.upgrade_and_play": "Päivitä ja pelaa",
	...
	"selectWorld.waitingForBackup.message": "Tämä saattaa viedä hetken maailman koosta riippuen. Ethän sulje peliä tai sammuta laitettasi.",
	"selectWorld.waitingForBackup.title": "Luodaan varmuuskopiota",
	...
	"selectWorld.warning.lowDiskSpace.description": "Laitteellasi ei ole enää paljoa tilaa.\nLevytilan loppuminen kesken pelin saattaa johtaa maailman vahingoittumiseen.",
	"selectWorld.warning.lowDiskSpace.title": "Varoitus! Levytila vähissä!",
	"selectWorld.world": "Maailma",
	"selectWorld.world_gen_settings_access": "Maailman generointiasetusten tiedostoa ei voida lukea tai avata! %s",
	"selecteWorld.backupRequiredTooltip": "Maailman lataaminen vaatii varmuuskopiointia",
	...
	"slot.only_single_allowed": "Vain yksittäiset paikat sallitaan: sinulla on '%s'",
	"slot.unknown": "Tuntematon lokero '%s'",
	"snbt.parser.empty_key": "Avain ei voi olla tyhjä",
	"snbt.parser.expected_binary_numeral": "Odotettiin binäärilukua",
	"snbt.parser.expected_decimal_numeral": "Odotettiin desimaalilukua",
	"snbt.parser.expected_float_type": "Odotettiin liukulukua",
	"snbt.parser.expected_hex_escape": "Odotettiin merkkiliteraalia, jonka pituus on %s",
	"snbt.parser.expected_hex_numeral": "Odotettiin heksadesimaalilukua",
	"snbt.parser.expected_integer_type": "Odotettiin kokonaislukua",
	"snbt.parser.expected_non_negative_number": "Odotettiin epänegatiivista lukua",
	"snbt.parser.expected_number_or_boolean": "Odotettiin lukua tai totuusarvoa",
	"snbt.parser.expected_string_uuid": "Odotettiin merkkijonoa, joka kelpaa UUID:ksi",
	"snbt.parser.expected_unquoted_string": "Odotettiin kelvollista merkkijonoa ilman lainausmerkkejä",
	"snbt.parser.infinity_not_allowed": "Ei-äärellisiä lukuja ei sallita",
	"snbt.parser.invalid_array_element_type": "Virheellinen taulukon alkion tyyppi",
	"snbt.parser.invalid_character_name": "Virheellinen Unicode-merkin nimi",
	"snbt.parser.invalid_codepoint": "Virheellinen Unicode-merkin arvo: %s",
	"snbt.parser.invalid_string_contents": "Virheellinen merkkijonon sisältö",
	"snbt.parser.invalid_unquoted_start": "Merkkijonot ilman lainausmerkkejä eivät voi alkaa numeroilla 0-9 taikka merkeillä + tai -",
	"snbt.parser.leading_zero_not_allowed": "Desimaaliluvut eivät voi alkaa numerolla 0",
	"snbt.parser.no_such_operation": "Operaatiota ei ole: %s",
	"snbt.parser.number_parse_failure": "Luvun jäsentäminen epäonnistui: %s",
	"snbt.parser.undescore_not_allowed": "Alaviivamerkit eivät ole sallittuja luvun alussa tai lopussa",
	...
	"soundCategory.ui": "Käyttöliittymä",
	"soundCategory.voice": "Lukija/Ääni",
	...
	"stat.minecraft.happy_ghast_one_cm": "Iloisella ghastilla kuljettu matka",
	"stat.minecraft.horse_one_cm": "Hevosella ratsastettu matka",
	"stat.minecraft.inspect_dispenser": "Jakelulaitteita tarkasteltu",
	"stat.minecraft.inspect_dropper": "Pudottajia tarkasteltu",
	"stat.minecraft.inspect_hopper": "Suppiloita tarkasteltu",
	...
	"stat.minecraft.nautilus_one_cm": "Helmiveneellä kuljettu matka",
	...
	"stat_type.minecraft.killed_by": "%s on tappanut sinut %s kertaa",
	...
	"subtitles.block.candle.extinguish": "Kynttilä sammuu",
	...
	"subtitles.block.copper_bulb.turn_off": "Kuparilamppu sammuu",
	"subtitles.block.copper_bulb.turn_on": "Kuparilamppu syttyy",
	"subtitles.block.copper_chest.close": "Arkku sulkeutuu",
	"subtitles.block.copper_chest.open": "Arkku avautuu",
	"subtitles.block.copper_trapdoor.close": "Luukku sulkeutuu",
	"subtitles.block.copper_trapdoor.open": "Luukku avautuu",
	"subtitles.block.crafter.craft": "Työstin työstää",
	"subtitles.block.crafter.fail": "Työstin epäonnistui",
	"subtitles.block.creaking_heart.hurt": "Narahteleva sydän vaikeroi",
	"subtitles.block.creaking_heart.idle": "Aavemainen ääni",
	"subtitles.block.creaking_heart.spawn": "Narahteleva sydän herää",
	"subtitles.block.deadbush.idle": "Kuivia ääniä",
	"subtitles.block.decorated_pot.insert": "Koristeltu ruukku täyttyy",
	"subtitles.block.decorated_pot.insert_fail": "Koristeltu ruukku heiluu",
	...
	"subtitles.block.dried_ghast.ambient": "Kuivumisen ääniä",
	"subtitles.block.dried_ghast.ambient_water": "Kuivunut ghast nesteytyy",
	"subtitles.block.dried_ghast.place_in_water": "Kuivunut ghast kastuu",
	"subtitles.block.dried_ghast.transition": "Kuivunut ghast tuntee olonsa paremmaksi",
	"subtitles.block.dry_grass.ambient": "Tuulisia ääniä",
	...
	"subtitles.block.eyeblossom.close": "Silmäkukka sulkeutuu",
	"subtitles.block.eyeblossom.idle": "Silmäkulma kuiskailee",
	"subtitles.block.eyeblossom.open": "Silmäkukka avautuu",
	...
	"subtitles.block.firefly_bush.idle": "Tulikärpäset surisevat",
	...
	"subtitles.block.generic.fall": "Jotain putoaa kuution päälle",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Kyltti heiluu",
	...
	"subtitles.block.pale_hanging_moss.idle": "Aavemainen ääni",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Rikkilähde purkautuu",
	"subtitles.block.potent_sulfur.noxious_gas": "Myrkyllistä kaasua ilmestyy",
	...
	"subtitles.block.respawn_anchor.ambient": "Uudelleensyntymisankkuri humisee",
	...
	"subtitles.block.sand.idle": "Hiekkaisia ääniä",
	"subtitles.block.sand.wind": "Tuulisia ääniä",
	...
	"subtitles.block.sculk_sensor.clicking": "Sculk-sensori naksuttaa",
	...
	"subtitles.block.shelf.activate": "Hylly aktivoituu",
	"subtitles.block.shelf.deactivate": "Hylly deaktivoituu",
	"subtitles.block.shelf.multi_swap": "Esineet vaihtuvat",
	"subtitles.block.shelf.place_item": "Esine asetettu",
	"subtitles.block.shelf.single_swap": "Esine vaihtuu",
	"subtitles.block.shelf.take_item": "Esine otettu",
	"subtitles.block.shulker_box.close": "Shulker-laatikko sulkeutuu",
	"subtitles.block.shulker_box.open": "Shulker-laatikko avautuu",
	"subtitles.block.sign.waxed_interact_fail": "Kyltti heiluu",
	"subtitles.block.smithing_table.use": "Takomispöytää käytettiin",
	"subtitles.block.smoker.smoke": "Savustin savustaa",
	...
	"subtitles.block.sponge.absorb": "Pesusieni imee",
	"subtitles.block.sweet_berry_bush.pick_berries": "Marjat popsahtavat",
	"subtitles.block.trapdoor.close": "Luukku sulkeutuu",
	"subtitles.block.trapdoor.open": "Luukku avautuu",
	"subtitles.block.trapdoor.toggle": "Luukku narahtaa",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Pahaenteinen esine valmistautuu",
	"subtitles.block.trial_spawner.ambient": "Koetuksen luojakuutio rätisee",
	"subtitles.block.trial_spawner.ambient_charged": "Pahaenteinen koetuksen luojakuutio rätisee",
	"subtitles.block.trial_spawner.ambient_ominous": "Pahaenteinen koetuksen luojakuutio rätisee",
	"subtitles.block.trial_spawner.charge_activate": "Enne nielaisee koetuksen luojakuution",
	"subtitles.block.trial_spawner.close_shutter": "Koetuksen luojakuutio sulkeutuu",
	"subtitles.block.trial_spawner.detect_player": "Koetuksen luojakuutio latautuu",
	"subtitles.block.trial_spawner.eject_item": "Koetuksen luojakuutio sylkee esineitä",
	"subtitles.block.trial_spawner.ominous_activate": "Enne nielaisee koetuksen luojakuution",
	"subtitles.block.trial_spawner.open_shutter": "Koetuksen luojakuutio avautuu",
	"subtitles.block.trial_spawner.spawn_item": "Pahaenteinen esine putoaa",
	"subtitles.block.trial_spawner.spawn_item_begin": "Pahaenteinen esine ilmestyy",
	"subtitles.block.trial_spawner.spawn_mob": "Koetuksen luojakuutio luo olennon",
	...
	"subtitles.block.vault.activate": "Holvi syttyy",
	"subtitles.block.vault.ambient": "Holvi rätisee",
	"subtitles.block.vault.close_shutter": "Holvi sulkeutuu",
	"subtitles.block.vault.deactivate": "Holvi sammuu",
	"subtitles.block.vault.eject_item": "Holvi sylkee esineen",
	"subtitles.block.vault.insert_item": "Holvin lukitus poistuu",
	"subtitles.block.vault.insert_item_fail": "Holvin avaaminen epäonnistuu",
	"subtitles.block.vault.open_shutter": "Holvi avautuu",
	"subtitles.block.vault.reject_rewarded_player": "Holvi hylkää pelaajan",
	"subtitles.block.water.ambient": "Vesi virtaa",
	"subtitles.block.wet_sponge.dries": "Pesusieni kuivuu",
	...
	"subtitles.entity.armadillo.ambient": "Vyötiäinen ähkii",
	"subtitles.entity.armadillo.brush": "Vyötiäistä harjataan",
	"subtitles.entity.armadillo.death": "Vyötiäinen kuolee",
	"subtitles.entity.armadillo.eat": "Vyötiäinen syö",
	"subtitles.entity.armadillo.hurt": "Vyötiäinen vahingoittuu",
	"subtitles.entity.armadillo.hurt_reduced": "Vyötiäinen suojautuu",
	"subtitles.entity.armadillo.land": "Vyötiäinen tömähtää maahan",
	"subtitles.entity.armadillo.peek": "Vyötiäinen kurkistaa",
	"subtitles.entity.armadillo.roll": "Vyötiäinen kieriytyy kerälle",
	"subtitles.entity.armadillo.scute_drop": "Vyötiäinen pudottaa suomun",
	"subtitles.entity.armadillo.unroll_finish": "Vyötiäinen suoristautuu",
	"subtitles.entity.armadillo.unroll_start": "Vyötiäinen kurkistaa",
	...
	"subtitles.entity.baby_cat.ambient": "Kissanpentu maukuu",
	"subtitles.entity.baby_cat.beg_for_food": "Kissanpentu kerjää",
	"subtitles.entity.baby_cat.death": "Kissanpentu kuolee",
	"subtitles.entity.baby_cat.eat": "Kissanpentu syö",
	"subtitles.entity.baby_cat.hiss": "Kissanpentu sähisee",
	"subtitles.entity.baby_cat.hurt": "Kissanpentu vahingoittuu",
	"subtitles.entity.baby_cat.purr": "Kissanpentu kehrää",
	"subtitles.entity.baby_chicken.ambient": "Tipu piipittää",
	"subtitles.entity.baby_chicken.death": "Tipu kuolee",
	"subtitles.entity.baby_chicken.hurts": "Tipu vahingoittuu",
	"subtitles.entity.baby_horse.ambient": "Varsa hirnuu",
	"subtitles.entity.baby_horse.angry": "Varsa hirnuu",
	"subtitles.entity.baby_horse.breathe": "Varsa hengittää",
	"subtitles.entity.baby_horse.death": "Varsa kuolee",
	"subtitles.entity.baby_horse.eat": "Varsa syö",
	"subtitles.entity.baby_horse.hurt": "Varsa vahingoittuu",
	"subtitles.entity.baby_horse.land": "Varsa laskeutuu",
	"subtitles.entity.baby_nautilus.ambient": "Pieni helmivene visertää",
	"subtitles.entity.baby_nautilus.ambient_land": "Pieni helmivene visertää",
	"subtitles.entity.baby_nautilus.death": "Pieni helmivene kuolee",
	"subtitles.entity.baby_nautilus.death_land": "Pieni helmivene kuolee",
	"subtitles.entity.baby_nautilus.eat": "Pieni helmivene syö",
	"subtitles.entity.baby_nautilus.hurt": "Pieni helmivene vahingoittuu",
	"subtitles.entity.baby_nautilus.hurt_land": "Pieni helmivene vahingoittuu",
	"subtitles.entity.baby_nautilus.swim": "Pieni helmivene ui",
	"subtitles.entity.baby_pig.ambient": "Porsas röhkii",
	"subtitles.entity.baby_pig.death": "Porsas kuolee",
	"subtitles.entity.baby_pig.eat": "Porsas syö",
	"subtitles.entity.baby_pig.hurt": "Porsas vahingoittuu",
	"subtitles.entity.baby_wolf.ambient": "Sudenpentu haukkuu",
	"subtitles.entity.baby_wolf.death": "Sudenpentu kuolee",
	"subtitles.entity.baby_wolf.growl": "Sudenpentu murisee",
	"subtitles.entity.baby_wolf.hurt": "Sudenpentu vahingoittuu",
	"subtitles.entity.baby_wolf.pant": "Sudenpentu läähättää",
	"subtitles.entity.baby_wolf.whine": "Sudenpentu vinkuu",
	...
	"subtitles.entity.boat.paddle_land": "Soutua",
	"subtitles.entity.boat.paddle_water": "Soutua",
	"subtitles.entity.bogged.ambient": "Rämeinen kalisee",
	"subtitles.entity.bogged.death": "Rämeinen kuolee",
	"subtitles.entity.bogged.hurt": "Rämeinen vahingoittuu",
	"subtitles.entity.breeze.charge": "Viima lataa",
	"subtitles.entity.breeze.death": "Viima kuolee",
	"subtitles.entity.breeze.deflect": "Viima torjuu",
	"subtitles.entity.breeze.hurt": "Viima vahingoittuu",
	"subtitles.entity.breeze.idle_air": "Viima ujeltaa",
	"subtitles.entity.breeze.idle_ground": "Viima puhaltaa",
	"subtitles.entity.breeze.inhale": "Viima henkäisee",
	"subtitles.entity.breeze.jump": "Viima loikkaa",
	"subtitles.entity.breeze.land": "Viima laskeutuu",
	"subtitles.entity.breeze.shoot": "Viima ampuu",
	"subtitles.entity.breeze.slide": "Viima liukuu",
	"subtitles.entity.breeze.whirl": "Viima vinkuu",
	"subtitles.entity.breeze.wind_burst": "Puhuripallo puhkeaa",
	...
	"subtitles.entity.camel_husk.ambient": "Kameliholkki murisee",
	"subtitles.entity.camel_husk.dash": "Kameliholkki loikkaa",
	"subtitles.entity.camel_husk.dash_ready": "Kameliholkki palautuu",
	"subtitles.entity.camel_husk.death": "Kameliholkki kuolee",
	"subtitles.entity.camel_husk.eat": "Kameliholkki syö",
	"subtitles.entity.camel_husk.hurt": "Kameliholkki vahingoittuu",
	"subtitles.entity.camel_husk.saddle": "Kameliholkki satuloidaan",
	"subtitles.entity.camel_husk.sit": "Kameliholkki istahtaa",
	"subtitles.entity.camel_husk.stand": "Kameliholkki nousee ylös",
	...
	"subtitles.entity.copper_golem.death": "Kuparigolem kuolee",
	"subtitles.entity.copper_golem.hurt": "Kuparigolem vahingoittuu",
	"subtitles.entity.copper_golem.item_drop": "Kuparigolem asettaa esinettä",
	"subtitles.entity.copper_golem.item_no_drop": "Kuparigolem ei voi asettaa esinettä",
	"subtitles.entity.copper_golem.no_item_get": "Kuparigolem poimii esinettä",
	"subtitles.entity.copper_golem.no_item_no_get": "Kuparigolem ei voi poimia esinettä",
	"subtitles.entity.copper_golem.spawn": "Kuparigolem ilmestyy",
	"subtitles.entity.copper_golem.spin": "Kuparigolemin pää pyörii",
	"subtitles.entity.copper_golem_become_statue": "Kuparigolem kivettyy",
	"subtitles.entity.copper_golem_oxidized.death": "Kuparigolem kuolee",
	"subtitles.entity.copper_golem_oxidized.hurt": "Kuparigolem vahingoittuu",
	"subtitles.entity.copper_golem_oxidized.spin": "Kuparigolemin pää pyörii",
	"subtitles.entity.copper_golem_weathered.death": "Kuparigolem kuolee",
	"subtitles.entity.copper_golem_weathered.hurt": "Kuparigolem vahingoittuu",
	"subtitles.entity.copper_golem_weathered.spin": "Kuparigolemin pää pyörii",
	...
	"subtitles.entity.creaking.activate": "Narahtelija havahtuu",
	"subtitles.entity.creaking.ambient": "Narahtelija narisee",
	"subtitles.entity.creaking.attack": "Narahtelija hyökkää",
	"subtitles.entity.creaking.deactivate": "Narahtelija rauhoittuu",
	"subtitles.entity.creaking.death": "Narahtelija murtuu",
	"subtitles.entity.creaking.freeze": "Narahtelija pysähtyy",
	"subtitles.entity.creaking.spawn": "Narahtelija ilmestyy",
	"subtitles.entity.creaking.sway": "Narahtelijaa lyödään",
	"subtitles.entity.creaking.twitch": "Narahtelija nykii",
	"subtitles.entity.creaking.unfreeze": "Narahtelija liikkuu",
	...
	"subtitles.entity.donkey.jump": "Aasi hyppää",
	...
	"subtitles.entity.fish.swim": "Loiskahtelua",
	...
	"subtitles.entity.generic.wind_burst": "Puhuripallo puhkeaa",
	...
	"subtitles.entity.ghastling.ambient": "Ghastling kujertaa",
	"subtitles.entity.ghastling.death": "Ghastling kuolee",
	"subtitles.entity.ghastling.hurt": "Ghastling vahingoittuu",
	"subtitles.entity.ghastling.spawn": "Ghastling ilmestyy",
	...
	"subtitles.entity.happy_ghast.ambient": "Iloinen ghast hyräilee",
	"subtitles.entity.happy_ghast.death": "Iloinen ghast kuolee",
	"subtitles.entity.happy_ghast.equip": "Iloinen ghast valjastetaan",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Iloinen ghast on valmis",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Iloinen ghast pysähtyy",
	"subtitles.entity.happy_ghast.hurt": "Iloinen ghast vahingoittuu",
	"subtitles.entity.happy_ghast.unequip": "Iloiselta ghastilta riisutaan valjaat",
	...
	"subtitles.entity.horse.armor": "Hevonen panssaroidaan",
	...
	"subtitles.entity.item_frame.place": "Kehys asetetaan",
	...
	"subtitles.entity.minecart.inside": "Kaivosvaunu rämisee",
	"subtitles.entity.minecart.inside_underwater": "Kaivosvaunu rämisee veden alla",
	...
	"subtitles.entity.mule.jump": "Muuli hyppää",
	"subtitles.entity.nautilus.ambient": "Helmivene narskahtelee",
	"subtitles.entity.nautilus.ambient_land": "Helmivene narskahtelee",
	"subtitles.entity.nautilus.dash": "Helmivene syöksähtää",
	"subtitles.entity.nautilus.dash_land": "Helmivene syöksähtää",
	"subtitles.entity.nautilus.dash_ready": "Helmivene palautuu",
	"subtitles.entity.nautilus.dash_ready_land": "Helmivene palautuu",
	"subtitles.entity.nautilus.death": "Helmivene kuolee",
	"subtitles.entity.nautilus.death_land": "Helmivene kuolee",
	"subtitles.entity.nautilus.eat": "Helmivene syö",
	"subtitles.entity.nautilus.hurt": "Helmivene vahingoittuu",
	"subtitles.entity.nautilus.hurt_land": "Helmivene vahingoittuu",
	"subtitles.entity.nautilus.swim": "Helmivene ui",
	...
	"subtitles.entity.parched.ambient": "Kuivahtanut rätisee",
	"subtitles.entity.parched.death": "Kuivahtanut kuolee",
	"subtitles.entity.parched.hurt": "Kuivahtanut vahingoittuu",
	...
	"subtitles.entity.parrot.imitate.bogged": "Papukaija kalisee",
	"subtitles.entity.parrot.imitate.breeze": "Papukaija puhaltaa",
	"subtitles.entity.parrot.imitate.camel_husk": "Papukaija murisee",
	"subtitles.entity.parrot.imitate.creaking": "Papukaija narisee",
	...
	"subtitles.entity.parrot.imitate.parched": "Papukaija rätisee",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Papukaija vaikeroi",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Papukaija kurluttaa",
	...
	"subtitles.entity.pig.eat": "Sika syö",
	...
	"subtitles.entity.player.teleport": "Pelaaja teleporttaa",
	"subtitles.entity.polar_bear.ambient": "Jääkarhu murahtaa",
	"subtitles.entity.polar_bear.ambient_baby": "Jääkarhun pentu hyrisee",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Luurankohevonen hyppää",
	...
	"subtitles.entity.sulfur_cube.absorb": "Rikkikuutio täyttyy",
	"subtitles.entity.sulfur_cube.bounce": "Rikkikuutio pomppii",
	"subtitles.entity.sulfur_cube.death": "Rikkikuutio kuolee",
	"subtitles.entity.sulfur_cube.eject": "Kuutio poistettu",
	"subtitles.entity.sulfur_cube.hit": "Rikkikuutiota lyödään",
	"subtitles.entity.sulfur_cube.hurt": "Rikkikuutio vahingoittuu",
	"subtitles.entity.sulfur_cube.push": "Rikkikuutiota työnnetään",
	"subtitles.entity.sulfur_cube.squish": "Rikkikuutio pomppii",
	...
	"subtitles.entity.turtle.death_baby": "Kilpikonnan poikanen kuolee",
	...
	"subtitles.entity.turtle.hurt_baby": "Kilpikonnan poikanen vahingoittuu",
	"subtitles.entity.turtle.lay_egg": "Kilpikonna munii munan",
	"subtitles.entity.turtle.shamble": "Kilpikonna laahustaa",
	"subtitles.entity.turtle.shamble_baby": "Kilpikonnan poikanen laahustaa",
	...
	"subtitles.entity.wind_charge.throw": "Puhuripallo lentää",
	"subtitles.entity.wind_charge.wind_burst": "Puhuripallo puhkeaa",
	...
	"subtitles.entity.wither_skeleton.ambient": "Wither-luuranko kalisee",
	...
	"subtitles.entity.wolf.bark": "Susi haukkuu",
	...
	"subtitles.entity.wolf.pant": "Susi läähättää",
	"subtitles.entity.wolf.shake": "Susi ravistelee",
	"subtitles.entity.wolf.whine": "Susi vinkuu",
	...
	"subtitles.entity.zombie_horse.angry": "Zombihevonen hirnuu",
	"subtitles.entity.zombie_horse.death": "Zombihevonen kuolee",
	"subtitles.entity.zombie_horse.eat": "Zombihevonen syö",
	"subtitles.entity.zombie_horse.hurt": "Zombihevonen vahingoittuu",
	"subtitles.entity.zombie_nautilus.ambient": "Zombihelmivene pulputtaa",
	"subtitles.entity.zombie_nautilus.ambient_land": "Zombihelmivene pulputtaa",
	"subtitles.entity.zombie_nautilus.dash": "Zombihelmivene syöksähtää",
	"subtitles.entity.zombie_nautilus.dash_land": "Zombihelmivene syöksähtää",
	"subtitles.entity.zombie_nautilus.dash_ready": "Zombihelmivene palautuu",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Zombihelmivene palautuu",
	"subtitles.entity.zombie_nautilus.death": "Zombihelmivene kuolee",
	"subtitles.entity.zombie_nautilus.death_land": "Zombihelmivene kuolee",
	"subtitles.entity.zombie_nautilus.eat": "Zombihelmivene syö",
	"subtitles.entity.zombie_nautilus.hurt": "Zombihelmivene vahingoittuu",
	"subtitles.entity.zombie_nautilus.hurt_land": "Zombihelmivene vahingoittuu",
	"subtitles.entity.zombie_nautilus.swim": "Zombihelmivene ui",
	...
	"subtitles.event.mob_effect.bad_omen": "Enne saa otteen",
	"subtitles.event.mob_effect.raid_omen": "Hyökkäys uhkaa lähistöllä",
	"subtitles.event.mob_effect.trial_omen": "Pahaenteinen koetus uhkaa lähistöllä",
	...
	"subtitles.item.armor.equip_copper": "Kuparihaarniska kolisee puettaessa",
	...
	"subtitles.item.armor.equip_nautilus": "Helmivene panssaroidaan",
	...
	"subtitles.item.armor.equip_wolf": "Suden haarniska puetaan",
	"subtitles.item.armor.unequip_nautilus": "Helmiveneeltä poistetaan panssari",
	"subtitles.item.armor.unequip_wolf": "Suden haarniska riisutaan",
	"subtitles.item.axe.scrape": "Kirves raaputtaa",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Rikkikuutio kauhotaan",
	...
	"subtitles.item.bundle.insert_fail": "Pussi täynnä",
	...
	"subtitles.item.elytra.flying": "Suhahdus",
	...
	"subtitles.item.golden_dandelion.unuse": "Kultainen voikukka jatkaa ikääntymistä",
	"subtitles.item.golden_dandelion.use": "Kultainen voikukka pysäyttää ikääntymisen",
	...
	"subtitles.item.horse_armor.unequip": "Hevosen panssari riisutaan",
	"subtitles.item.ink_sac.use": "Mustepussi läiskähtää",
	"subtitles.item.lead.break": "Talutushihna katkeaa",
	"subtitles.item.lead.tied": "Talutushihna solmittu",
	"subtitles.item.lead.untied": "Talkutushihna irrotettu",
	"subtitles.item.llama_carpet.unequip": "Talja riisutaan",
	"subtitles.item.lodestone_compass.lock": "Magneettikompassi lukittuu magneettikiveen",
	"subtitles.item.mace.smash_air": "Nuija murskaa",
	"subtitles.item.mace.smash_ground": "Nuija murskaa",
	"subtitles.item.nautilus_saddle_equip": "Helmivene satuloidaan",
	"subtitles.item.nautilus_saddle_underwater_equip": "Helmivene satuloidaan",
	"subtitles.item.nether_wart.plant": "Nether-pahka istutetaan",
	"subtitles.item.ominous_bottle.dispose": "Pullo hajoaa",
	"subtitles.item.saddle.unequip": "Satula riisutaan",
	"subtitles.item.shears.shear": "Keritsimet napsahtavat",
	"subtitles.item.shears.snip": "Keritsimet leikkaavat",
	"subtitles.item.shield.block": "Kilpi suojaa",
	"subtitles.item.shovel.flatten": "Lapio tasaa",
	"subtitles.item.spear.attack": "Keihäs pistää",
	"subtitles.item.spear.hit": "Keihäs osuu",
	"subtitles.item.spear.lunge": "Keihäs syöksyy",
	"subtitles.item.spear.use": "Keihäs on tanassa",
	"subtitles.item.spear_wood.attack": "Keihäs pistää",
	"subtitles.item.spear_wood.hit": "Keihäs osuu",
	"subtitles.item.spear_wood.use": "Keihäs on tanassa",
	...
	"subtitles.item.underwater_saddle.equip": "Helmivene satuloidaan",
	"subtitles.item.wolf_armor.break": "Suden haarniska hajoaa",
	"subtitles.item.wolf_armor.crack": "Suden haarniska halkeilee",
	"subtitles.item.wolf_armor.damage": "Suden haarniska vahingoittuu",
	"subtitles.item.wolf_armor.repair": "Suden haarniska korjataan",
	"subtitles.particle.soul_escape": "Sielu pakenee",
	"subtitles.ui.cartography_table.take_result": "Kartta piirrettiin",
	"subtitles.ui.hud.bubble_pop": "Hengitysmittari laskee",
	"subtitles.ui.loom.take_result": "Kangaspuita käytettiin",
	"subtitles.ui.stonecutter.take_result": "Kivileikkuria käytettiin",
	"subtitles.weather.end_flash": "End-välähdys jylisee",
	"subtitles.weather.rain": "Sataa",
	"symlink_warning.message": "Maailmojen lataaminen symbolisia linkkejä sisältävistä kansioista voi olla vaarallista, jos ei tiedä tarkkaan, mitä on tekemässä. Lisätietoja osoitteesta %s.",
	"symlink_warning.message.pack": "Pakettien lataaminen symbolisia linkkejä sisältävistä kansioista voi olla vaarallista, jos ei tiedä tarkkaan, mitä on tekemässä. Lisätietoja osoitteesta %s.",
	"symlink_warning.message.world": "Maailmojen lataaminen symbolisia linkkejä sisältävistä kansioista voi olla vaarallista, jos ei tiedä tarkkaan, mitä on tekemässä. Lisätietoja osoitteesta %s.",
	"symlink_warning.more_info": "Lisätietoa",
	"symlink_warning.title": "Maailman kansio sisältää symbolisia linkkejä",
	"symlink_warning.title.pack": "Lisätyt paketit sisältävät symbolisia linkkejä",
	"symlink_warning.title.world": "Maailman kansio sisältää symbolisia linkkejä",
	...
	"telemetry.event.advancement_made.description": "Edystysaskeleen ansaitsemisen taustalla olevan asiayhteyden hahmottaminen voi auttaa meitä ymmärtämään ja kehittämään pelin etenemistä paremmin.",
	"telemetry.event.advancement_made.title": "Ansaitut edistysaskeleet",
	"telemetry.event.game_load_times.description": "Tämä tapahtuma voi auttaa meitä selvittämään, missä käynnistyksen suorituskykyä on parannettava mittaamalla käynnistysvaiheiden suoritusaikoja.",
	"telemetry.event.game_load_times.title": "Pelin latausajat",
	"telemetry.event.graphics_capabilities.description": "Tämä tapahtuma antaa meille tietoa pelin pelaamiseen käytetyn grafiikkalaitteen kapasiteetista.",
	"telemetry.event.graphics_capabilities.title": "Grafiikkakapasiteetti",
	"telemetry.event.optional": "%s (Valinnainen)",
	"telemetry.event.optional.disabled": "%s (Vapaaehtoinen) – Poissa käytöstä",
	...
	"telemetry.event.p2p_connection.title": "Vertaisverkkoyhteys",
	...
	"telemetry.property.backend_failure_message.title": "Backendin luomisen epäonnistumisviesti",
	"telemetry.property.backend_failure_missing_capabilities.title": "Backendin luomisen epäonnistumisen puuttuva kapasiteetti",
	"telemetry.property.backend_failure_reason.title": "Backendin luomisen epäonnistumisen syy",
	"telemetry.property.backend_name.title": "Backendin nimi",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "Epäonnistumisosuus",
	...
	"telemetry.property.p2p_connection_successful.title": "Yhdistäminen onnistui",
	"telemetry.property.p2p_connection_total_time_ms.title": "Kokonaisyhteysaika (millisekunteina)",
	...
	"telemetry_info.button.privacy_statement": "Tietosuojaseloste",
	"telemetry_info.button.show_data": "Näytä tietoni",
	"telemetry_info.opt_in.description": "Hyväksyn vapaaehtoisten telemetriatietojen lähettämisen",
	...
	"test.error.block_property_mismatch": "Odotettiin ominaisuuden %s olevan %s, mutta sinulla on %s",
	"test.error.block_property_missing": "Kuution ominaisuudet puuttuvat. Ominaisuuden %s odotettiin olevan %s",
	"test.error.entity_property": "Kohde %s epäonnistui testissä: %s",
	"test.error.entity_property_details": "Kohde %s epäonnistui testissä: %s. Odotettiin %s, saatiin %s",
	"test.error.expected_block": "Odotettiin kuutiota %s, mutta sinulla on %s",
	"test.error.expected_block_present": "Odotettiin kuutiota %s",
	"test.error.expected_block_tag": "Odotettiin kuutiota tunnisteella #%s, mutta sinulla on %s",
	"test.error.expected_container_contents": "Säiliössä tulisi olla: %s",
	"test.error.expected_container_contents_single": "Säiliössä tulisi olla yksi yksittäinen: %s",
	"test.error.expected_empty_container": "Säiliön tulisi olla tyhjä",
	"test.error.expected_entity": "Odotettiin %s",
	"test.error.expected_entity_around": "Odotettiin %s olemassa olevaksi sijainnissa %s, %s, %s",
	"test.error.expected_entity_count": "Odotettiin %s tyypin %s kohdetta: löydettiin %s",
	"test.error.expected_entity_data": "Odotettiin kohteen tietojen olevan: %s, mutta sinulla on %s",
	"test.error.expected_entity_data_predicate": "Kohteen %s tietojen yhteensopimattomuus",
	"test.error.expected_entity_effect": "Odotettiin kohteelle %s vaikutusta %s %s",
	"test.error.expected_entity_having": "Kohteen tavaraluettelossa tulisi olla %s",
	"test.error.expected_entity_holding": "Kohteella tulisi olla kädessään %s",
	"test.error.expected_entity_in_test": "Odotettiin kohteen %s olemassaoloa testissä",
	"test.error.expected_entity_not_touching": "Ei odotettu kohteen %s koskettavan sijaintia %s, %s, %s (suhteellinen: %s, %s, %s)",
	"test.error.expected_entity_touching": "Odotettiin kohteen %s koskettavan sijaintia%s, %s, %s (suhteellinen: %s, %s, %s)",
	"test.error.expected_item": "Odotettiin esineen tyyppiä %s",
	"test.error.expected_items_count": "Odotettiin %s tyypin %s esinettä: löydettiin %s",
	"test.error.fail": "Epäonnistumisen ehdot täyttyivät",
	"test.error.invalid_block_type": "Odottamaton kuutiotyyppi löydetty: %s",
	"test.error.missing_block_entity": "Puuttuva kuutiokohde",
	"test.error.not_a_block_item": "Annettu kuutio ei ole kuutioesine",
	"test.error.position": "%s sijainnissa %s, %s, %s (suhteellinen: %s, %s, %s) pykälällä %s",
	"test.error.sequence.condition_already_triggered": "Ehto on jo käynnistetty %s",
	"test.error.sequence.condition_not_triggered": "Ehto ei käynnistynyt",
	"test.error.sequence.invalid_tick": "Onnistui virheellisellä pykälällä: odotettiin %s",
	"test.error.sequence.minimum_tick": "Onnistui ennen odotettua pykälää; valmistauduttiin odottamaan pykälää %s",
	"test.error.sequence.not_completed": "Testi aikakatkaistiin ennen sekvenssin suorittamista",
	"test.error.set_biome": "Testibiomin asettaminen epäonnistui",
	"test.error.spawn_failure": "Kohteen %s luominen epäonnistui",
	"test.error.state_not_equal": "Virheellinen tila. Odotettiin %s, mutta sinulla on %s",
	"test.error.structure.failure": "Testirakennelman sijoittaminen kohteelle %s epäonnistui",
	"test.error.tick": "%s pykälällä %s",
	"test.error.ticking_without_structure": "Pykälätesti ennen rakennelman asettamista",
	"test.error.timeout.no_result": "Ei onnistunut tai epäonnistunut %s pykälän aikana",
	"test.error.timeout.no_sequences_finished": "Ei suoritettuja sekvenssejä %s pykälän aikana",
	"test.error.too_many_entities": "Odotettiin vain yksi %s olemassa olevaksi sijainnissa %s, %s, %s mutta löydettiin %s",
	"test.error.unexpected_block": "Ei odotettu kuution olevan %s",
	"test.error.unexpected_entity": "Ei odotettu kohteen %s olemassaoloa",
	"test.error.unexpected_item": "Ei odotettu esineen tyyppiä %s",
	"test.error.unknown": "Tuntematon sisäinen virhe: %s",
	"test.error.value_not_equal": "Odotettiin kohteen %s olevan %s, mutta sinulla on %s",
	"test.error.value_not_in_between": "Oletettiin, että %s olisi arvojen %s ja %s välissä: oli %s",
	"test.error.wrong_block_entity": "Väärä kuutiokohteen tyyppi: %s",
	"test_block.error.missing": "Testirakennelmasta puuttuu %s kuutio",
	"test_block.error.too_many": "Liian monta %s kuutiota",
	"test_block.invalid_timeout": "Virheellinen aikakatkaisu (%s) – positiivinen määrä pykäliä vaaditaan",
	"test_block.message": "Viesti:",
	"test_block.mode.accept": "Hyväksy",
	"test_block.mode.fail": "Epäonnistui",
	"test_block.mode.log": "Loki",
	"test_block.mode.start": "Aloita",
	"test_block.mode_info.accept": "Hyväksymistila \u200b\u200b– Hyväksy testin (osan) onnistuminen",
	"test_block.mode_info.fail": "Vikatila – Epäonnistu testi",
	"test_block.mode_info.log": "Lokitila – Kirjaa viesti",
	"test_block.mode_info.start": "Aloitustila – Testin aloituspiste",
	"test_instance.action.reset": "Nollaa ja lataa",
	"test_instance.action.run": "Lataa ja suorita",
	"test_instance.action.save": "Tallenna rakennelma",
	"test_instance.description.batch": "Ympäristö: %s",
	"test_instance.description.failed": "Epäonnistui: %s",
	"test_instance.description.function": "Funktio: %s",
	"test_instance.description.invalid_id": "Virheellinen testitunnus",
	"test_instance.description.no_test": "Testiä ei ole",
	"test_instance.description.structure": "Rakennelma: %s",
	"test_instance.description.type": "Tyyppi: %s",
	"test_instance.type.block_based": "Kuutiopohjainen testi",
	"test_instance.type.function": "Sisäänrakennettu funktiotesti",
	"test_instance_block.entities": "Kohteet:",
	"test_instance_block.error.no_test": "Ei voida suorittaa testitapausta sijainnissa %s, %s, %s, koska sillä on määrittelemätön testi",
	"test_instance_block.error.no_test_structure": "Ei voida suorittaa testitapausta sijainnissa %s, %s, %s, koska sillä ei ole testirakennelmaa",
	"test_instance_block.error.unable_to_save": "Testirakennelmamallia ei voida tallentaa testitapaukselle sijainnissa %s, %s, %s",
	"test_instance_block.invalid": "[virheellinen]",
	"test_instance_block.reset_success": "Nollaus onnistui testille: %s",
	"test_instance_block.rotation": "Kierto:",
	"test_instance_block.size": "Testirakennelman koko",
	"test_instance_block.starting": "Aloitetaan testiä %s",
	"test_instance_block.test_id": "Testitapauksen ID",
	...
	"title.credits": "Tekijänoikeudet omistaa Mojang AB. Älä levitä!",
	"title.multiplayer.disabled": "Moninpeli on poissa käytöstä. Ole hyvä ja tarkista Microsoft-tilisi asetukset.",
	"title.multiplayer.disabled.banned.name": "Sinun on vaihdettava nimesi ennen kuin voit pelata verkossa",
	...
	"title.multiplayer.online": "Moninpeli (verkko)",
	...
	"trim_material.minecraft.resin": "Pihkamateriaali",
	"trim_pattern.minecraft.bolt": "Pulttien haarniskakoristeet",
	...
	"trim_pattern.minecraft.flow": "Virtauksen haarniskakoristeet",
	"trim_pattern.minecraft.host": "Majapaikan haarniskakoristeet",
	...
	"upgradeWorld.aborted.message": "Tämä voi tapahtua, jos toinen ohjelma on käyttänyt maailmaa päivityksen aikana.\nVoit yrittää käynnistää tietokoneen uudelleen ja yrittää uudelleen. Jos ongelma jatkuu, voit ilmoittaa virheestä.",
	"upgradeWorld.aborted.reportBug": "Ilmoita virheestä",
	"upgradeWorld.aborted.title": "Maailman päivittäminen epäonnistui",
	"upgradeWorld.canceled.message": "Maailmasi säilyy entisellään.",
	"upgradeWorld.canceled.title": "Maailman päivittäminen peruutettu",
	"upgradeWorld.done": "Maailma päivitetty",
	"upgradeWorld.failed_cleanup.message": "Maailma päivitettiin onnistuneesti nykyiseen versioon, ja se on nyt saatavilla maailmaluettelossa.\nVanhojen tietojen puhdistuksessa ilmeni ongelmia, joten maailman kansion nimeksi vaihdettiin %s.",
	"upgradeWorld.failed_cleanup.title": "Maailman päivittäminen onnistui",
	"upgradeWorld.info.converted": "Päivitetty: %s",
	"upgradeWorld.info.file_fix_stage": "Vaihe: %s/%s",
	"upgradeWorld.info.scanning": "Etsitään tiedostoja...",
	"upgradeWorld.info.total": "Yhteensä: %s",
	"upgradeWorld.joinNow": "Haluatko liittyä maailmaan nyt?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Siirretään tiedostoja",
	"upgradeWorld.progress.type.legacy_structures": "Päivitetään vanhoja rakennelmia",
	"upgradeWorld.progress.type.region": "Päivitetään alueita",
	"upgradeWorld.symlink.message": "Valittu maailma sisältää symbolisia linkkejä.\nMaailman päivittäminen nykyiseen versioon edellyttää toimia, jotka eivät tue symbolisten linkkien käyttöä. Maailman päivittämiseksi linkit on ensin ratkaistava.",
	"upgradeWorld.symlink.title": "Maailman päivittäminen ei onnistu",
	"upgradeWorld.title": "Päivitetään maailman tiedostoja",
}
