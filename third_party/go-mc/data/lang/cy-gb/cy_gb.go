// Code generated by tools/gen_lang.go from 26.1/cy_gb.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Gosodiadau Hygyrchedd...",
	...
	"advMode.notEnabled": "Nid yw blociau gorchymyn wedi'u galluogi",
	"advMode.notEnabled.spawner": "Nid yw blociau sil wedi'u galluogi",
	"advMode.previousOutput": "Allbwn Blaenorol",
	"advMode.setCommand": "Gosod Gorchymyn Consol ar gyfer y Bloc",
	"advMode.setCommand.disabled": "Gosodwyd gorchymyn: %s, ond mae blociau gorchymyn wedi'u hanalluogi o hyd",
	...
	"advancements.adventure.blowback.description": "Lladd Awel gan ddefnyddio Hyrddiad Gwynt gan Awel wedi'i allwyro",
	"advancements.adventure.blowback.title": "Chwythu Nôl",
	"advancements.adventure.brush_armadillo.description": "Cael Sgwtela Armadilo o Armadilo gan ddefnyddio Brwsh",
	"advancements.adventure.brush_armadillo.title": "Mor Sgiwt!",
	...
	"advancements.adventure.crafters_crafting_crafters.description": "Bod yn agos at Crefftiwr pan mae'n crefftio Crefftiwr",
	"advancements.adventure.crafters_crafting_crafters.title": "Crefftwyr Yn Crefftio Crefftwyr",
	...
	"advancements.adventure.heart_transplanter.description": "Rhoi Calon Gwich yn y modd cywir rhwng dau bloc Derw Llwyd",
	"advancements.adventure.heart_transplanter.title": "Trawsblanwr Calon",
	...
	"advancements.adventure.lighten_up.description": "Crafu Bwlb Copr gyda Bwyell i'w wneud yn oleuach",
	"advancements.adventure.lighten_up.title": "Goleuo Fyny",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Camu mewn i Siambr Treial",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Fersiwn Treial",
	"advancements.adventure.ol_betsy.description": "Saethu bwa croes",
	"advancements.adventure.ol_betsy.title": "Ol' Betsy",
	"advancements.adventure.overoverkill.description": "Delio 50 calon o niwed mewn un trawiad gan ddefnyddio'r Pastwn",
	"advancements.adventure.overoverkill.title": "Gor-Gor-ladd",
	...
	"advancements.adventure.revaulting.description": "Datgloi Cell Treial Ddrwgargoelus gydag Allwedd Treial Ddrwgargoelus",
	"advancements.adventure.revaulting.title": "Ailgellu",
	...
	"advancements.adventure.spear_many_mobs.description": "Taro pum creadur yn yr un ymosodiad Rhuthro gyda Phicell",
	"advancements.adventure.spear_many_mobs.title": "Cebab Creadur",
	...
	"advancements.adventure.under_lock_and_key.description": "Datgloi Cell gydag Allwedd Treial",
	"advancements.adventure.under_lock_and_key.title": "Dan Glo",
	"advancements.adventure.use_lodestone.description": "Defnyddio Cwmpawd ar Dynfaen",
	"advancements.adventure.use_lodestone.title": "Tynfaen, Tywys Fi Adre",
	...
	"advancements.adventure.who_needs_rockets.description": "Defnyddio Hyrddiad Gwynt i'ch lansio 8 bloc i'r awyr",
	"advancements.adventure.who_needs_rockets.title": "Pwy Sydd Angen Roced?",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Rhoi bloc Ghast Sych mewn dŵr",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Dyfrha!",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Tynnu Arfwisg Blaidd o Flaidd gan ddefnyddio Gwellau",
	"advancements.husbandry.remove_wolf_armor.title": "Gwellau Gwych",
	"advancements.husbandry.repair_wolf_armor.description": "Trwsio Arfwisg Blaidd gan ddefnyddio Sgwtela Armadilo",
	"advancements.husbandry.repair_wolf_armor.title": "Fel Newydd",
	...
	"advancements.husbandry.tadpole_in_a_bucket.title": "Bwced Bwced",
	"advancements.husbandry.tame_an_animal.description": "Dofi anifail",
	"advancements.husbandry.tame_an_animal.title": "Ffrindiau Gorau Am Byth",
	"advancements.husbandry.uh_oh.description": "Cael Ciwb Sylffwr bwyta bloc TNT",
	"advancements.husbandry.uh_oh.title": "O Na",
	...
	"advancements.husbandry.whole_pack.description": "Dofi holl amrywiolion Blaidd",
	"advancements.husbandry.whole_pack.title": "Y Cnud Cyfan",
	...
	"argument.double.big": "Rhaid i ddwbl beidio â bod yn fwy na %s, cafwyd %s",
	"argument.double.low": "Rhaid i ddwbl beidio â bod yn llai na %s, cafwyd %s",
	...
	"argument.entity.options.gamemode.description": "Chwaraewyr gyda modd gêm",
	...
	"argument.entity.options.type.invalid": "Math endid annilys neu anhysbys '%s'",
	...
	"argument.entity.selector.nearestEntity": "Endid agosaf",
	...
	"argument.enum.invalid": "Gwerth annilys \"%s\"",
	"argument.float.big": "Rhaid i rif arnawf beidio â bod yn fwy na %s, cafwyd %s",
	"argument.float.low": "Rhaid i rif arnawf beidio â bod yn llai na %s, cafwyd %s",
	"argument.gamemode.invalid": "Modd gêm anhysbys: %s",
	"argument.hexcolor.invalid": "Cod lliw hecs '%s' annilys",
	"argument.id.invalid": "ID annilys",
	"argument.id.unknown": "ID anhysbys: %s",
	"argument.integer.big": "Rhaid i gyfanrif beidio â bod yn fwy na %s, cafwyd %s",
	"argument.integer.low": "Rhaid i gyfanrif beidio â bod yn llai na %s, cafwyd %s",
	...
	"argument.literal.incorrect": "Wedi disgwyl %s llythrennol",
	"argument.long.big": "Rhaid i rif hir beidio â bod yn fwy na %s, cafwyd %s",
	"argument.long.low": "Rhaid i rif hir beidio â bod yn llai na %s, cafwyd %s",
	"argument.message.too_long": "Roedd y neges sgwrs yn rhy hir (%s > %s nod uchafswm)",
	"argument.nbt.array.invalid": "Math arae annilys '%s'",
	"argument.nbt.array.mixed": "Ni ellir mewnosod %s yn %s",
	"argument.nbt.expected.compound": "Tag cyfansawdd disgwyliedig",
	...
	"argument.nbt.trailing": "Mae data annisgwyl",
	"argument.player.entities": "Chwaraewyr yn unig gall eu heffeithio gan y gorchymyn hwn, ond mae'r dewisydd a ddarperir yn cynnwys endidau",
	...
	"argument.range.empty": "Disgwylwyd gwerth neu ystod o werthoedd",
	"argument.range.ints": "Dim ond rhifau cyfan a chaniateir, nid degolion",
	...
	"argument.resource_or_id.failed_to_parse": "Methwyd dosrannu strwythur: %s",
	"argument.resource_or_id.invalid": "Id neu dag annilys",
	"argument.resource_or_id.no_such_element": "Methu canfod yr elfen '%s' yn y gofrestrfa '%s'",
	"argument.resource_selector.not_found": "Dim matsys ar gyfer '%s' dethol o fath '%s'",
	...
	"argument.style.invalid": "Arddull annilys: %s",
	"argument.time.invalid_tick_count": "Rhaid i'r cyfrif ticio fod yn annegatif",
	"argument.time.invalid_unit": "Uned annilys",
	"argument.time.tick_count_too_low": "Rhaid i'r gyfric tic beidio â bod yn llai na %s, cafwyd %s",
	"argument.uuid.invalid": "UUID annilys",
	"argument.waypoint.invalid": "Nid yw'r endid a ddewiswyd yn bwynt ffordd",
	...
	"arguments.item.component.expected": "Disgwylwyd cydran eitem",
	"arguments.item.component.malformed": "Cydran '%s' camffurfiedig: '%s'",
	"arguments.item.component.repeated": "Ailadroddwyd cydran eitem '%s', ond caniateir nodi un gwerth yn unig",
	"arguments.item.component.unknown": "Cydran eitem anhysbys '%s'",
	"arguments.item.malformed": "Eitem camffurfiedig: '%s'",
	"arguments.item.overstacked": "Gall %s ond bentyrru hyd at %s",
	"arguments.item.predicate.malformed": "Dibeniad '%s' camffurfiedig: '%s'",
	"arguments.item.predicate.unknown": "Dibeniad eitem anhysbys: '%s'",
	...
	"arguments.objective.notFound": "Amcan bwrdd sgorio anhysbys '%s'",
	...
	"attribute.name.air_drag_modifier": "Addasyddion Llusgiad Aer",
	"attribute.name.armor": "Arfwisg",
	"attribute.name.armor_toughness": "Gwydnwch Arfwisg",
	"attribute.name.attack_damage": "Difrod Ymosod",
	"attribute.name.attack_knockback": "Curo 'nol ymosodiad",
	"attribute.name.attack_speed": "Cyflymder ymosodiad",
	"attribute.name.below_name_distance": "Pellter Sgôr Tag Enw",
	"attribute.name.block_break_speed": "Cyflymder Torri Bloc",
	"attribute.name.block_interaction_range": "Ystod Rhyngweithio Blociau",
	"attribute.name.bounciness": "Bounciness",
	"attribute.name.burning_time": "Amser Llosgi",
	"attribute.name.camera_distance": "Pellter Camera",
	"attribute.name.entity_interaction_range": "Ystod Rhyngweithio Endidau",
	"attribute.name.explosion_knockback_resistance": "Gwrthsafiad Curo 'nol Ffrwydriad",
	"attribute.name.fall_damage_multiplier": "Lluosydd Niwed Cwympo",
	"attribute.name.flying_speed": "Cyflymder Hedfan",
	"attribute.name.follow_range": "Ystod Dilyn Creadur",
	"attribute.name.friction_modifier": "Addasyddion Ffrithiant",
	...
	"attribute.name.generic.block_interaction_range": "Ystod Rhyngweithio Blociau",
	"attribute.name.generic.burning_time": "Amser Llosgi",
	"attribute.name.generic.entity_interaction_range": "Ystod Rhyngweithio Endidau",
	"attribute.name.generic.explosion_knockback_resistance": "Gwrthsafiad Curo 'nol Ffrwydriad",
	"attribute.name.generic.fall_damage_multiplier": "Lluosydd Niwed Cwympo",
	"attribute.name.generic.flying_speed": "Cyflymder Hedfan",
	"attribute.name.generic.follow_range": "Pellter Dilyn Creadur",
	"attribute.name.generic.gravity": "Disgyrchiant",
	"attribute.name.generic.jump_strength": "Cryfder Naid",
	"attribute.name.generic.knockback_resistance": "Gwrthsafiad Curo 'nol",
	"attribute.name.generic.luck": "Lwc",
	"attribute.name.generic.max_absorption": "Uchafswm Amsugniad",
	"attribute.name.generic.max_health": "Uchafswm Iechyd",
	"attribute.name.generic.movement_efficiency": "Effeithlonrwydd Symudiad",
	"attribute.name.generic.movement_speed": "Cyflymder",
	"attribute.name.generic.oxygen_bonus": "Bonws Ocsigen",
	"attribute.name.generic.safe_fall_distance": "Pellter Syrthio Diogel",
	"attribute.name.generic.scale": "Graddfa",
	"attribute.name.generic.step_height": "Uchder Cam",
	"attribute.name.generic.water_movement_efficiency": "Effeithlonrwydd Symudiad Dŵr",
	"attribute.name.gravity": "Disgyrchiant",
	"attribute.name.horse.jump_strength": "Cryfder Naid Ceffyl",
	"attribute.name.jump_strength": "Cryfder Neidio",
	"attribute.name.knockback_resistance": "Gwrthsafiad Curo 'nol",
	"attribute.name.luck": "Lwc",
	"attribute.name.max_absorption": "Uchafswm Amsugniad",
	"attribute.name.max_health": "Uchafswm Iechyd",
	"attribute.name.mining_efficiency": "Effeithlonrwydd Mwyngloddio",
	"attribute.name.movement_efficiency": "Effeithlonrwydd Symudiad",
	"attribute.name.movement_speed": "Cyflymder",
	"attribute.name.nameplate_distance": "Pellter Tag Enw",
	"attribute.name.oxygen_bonus": "Bonws Ocsigen",
	"attribute.name.player.block_break_speed": "Cyflymder Torri Bloc",
	"attribute.name.player.block_interaction_range": "Ystod Rhyngweithio Blociau",
	"attribute.name.player.entity_interaction_range": "Ystod Rhyngweithio Endidau",
	"attribute.name.player.mining_efficiency": "Effeithlonrwydd Mwyngloddio",
	"attribute.name.player.sneaking_speed": "Cyflymder Sleifio",
	"attribute.name.player.submerged_mining_speed": "Cyflymder Mwyngloddio Tanddwr",
	"attribute.name.player.sweeping_damage_ratio": "Cymhareb Difrod Ysgubo",
	"attribute.name.safe_fall_distance": "Pellter Syrthio Diogel",
	"attribute.name.scale": "Graddfa",
	"attribute.name.sneaking_speed": "Cyflymder Sleifio",
	"attribute.name.spawn_reinforcements": "Atgyfnerthiadau Sombi",
	"attribute.name.step_height": "Uchder Cam",
	"attribute.name.submerged_mining_speed": "Cyflymder Mwyngloddio Tanddwr",
	"attribute.name.sweeping_damage_ratio": "Cymhareb Difrod Ysgubo",
	"attribute.name.tempt_range": "Ystod Denu Creaduriaid",
	"attribute.name.water_movement_efficiency": "Effeithlonrwydd Symudiad Dŵr",
	"attribute.name.waypoint_receive_range": "Cwmpas Derbyn y Pwynt Ffordd",
	"attribute.name.waypoint_transmit_range": "Cwmpas Trosglwyddo'r Pwynt Ffordd",
	...
	"biome.minecraft.pale_garden": "Gardd Lwyd",
	...
	"biome.minecraft.sulfur_caves": "Ogofeydd Sylffwr",
	...
	"block.minecraft.acacia_shelf": "Silff Acesia",
	...
	"block.minecraft.bamboo_shelf": "Silff Bambŵ",
	...
	"block.minecraft.banner.border.brown": "Bordor Brown",
	...
	"block.minecraft.banner.bricks.black": "Maes Du Saernïwyd",
	"block.minecraft.banner.bricks.blue": "Maes Glas Saernïwyd",
	"block.minecraft.banner.bricks.brown": "Maes Brown Saernïwyd",
	"block.minecraft.banner.bricks.cyan": "Maes Gwyrddlas Saernïwyd",
	"block.minecraft.banner.bricks.gray": "Maes Llwyd Saernïwyd",
	"block.minecraft.banner.bricks.green": "Maes Gwyrdd Saernïwyd",
	"block.minecraft.banner.bricks.light_blue": "Maes Glas Golau Saernïwyd",
	"block.minecraft.banner.bricks.light_gray": "Maes Llwyd Golau Saernïwyd",
	"block.minecraft.banner.bricks.lime": "Maes Leim Saernïwyd",
	"block.minecraft.banner.bricks.magenta": "Maes Majenta Saernïwyd",
	"block.minecraft.banner.bricks.orange": "Maes Oren Saernïwyd",
	"block.minecraft.banner.bricks.pink": "Maes Pinc Saernïwyd",
	"block.minecraft.banner.bricks.purple": "Maes Porffor Saernïwyd",
	"block.minecraft.banner.bricks.red": "Maes Coch Saernïwyd",
	"block.minecraft.banner.bricks.white": "Maes Gwyn Saernïwyd",
	"block.minecraft.banner.bricks.yellow": "Maes Melyn Saernïwyd",
	...
	"block.minecraft.banner.curly_border.black": "Bordor Du Bylchog",
	"block.minecraft.banner.curly_border.blue": "Bordor Glas Bylchog",
	"block.minecraft.banner.curly_border.brown": "Bordor Brown Bylchog",
	"block.minecraft.banner.curly_border.cyan": "Bordor Gwyrddlas Bylchog",
	"block.minecraft.banner.curly_border.gray": "Bordor Llwyd Bylchog",
	"block.minecraft.banner.curly_border.green": "Bordor Gwyrdd Bylchog",
	"block.minecraft.banner.curly_border.light_blue": "Bordor Glas Golau Bylchog",
	"block.minecraft.banner.curly_border.light_gray": "Bordor Llwyd Golau Bylchog",
	"block.minecraft.banner.curly_border.lime": "Bordor Leim Bylchog",
	"block.minecraft.banner.curly_border.magenta": "Bordor Majenta Bylchog",
	"block.minecraft.banner.curly_border.orange": "Bordor Oren Bylchog",
	"block.minecraft.banner.curly_border.pink": "Bordor Pinc Bylchog",
	"block.minecraft.banner.curly_border.purple": "Bordor Porffor Bylchog",
	"block.minecraft.banner.curly_border.red": "Bordor Coch Bylchog",
	"block.minecraft.banner.curly_border.white": "Bordor Gwyn Bylchog",
	"block.minecraft.banner.curly_border.yellow": "Bordor Melyn Bylchog",
	"block.minecraft.banner.diagonal_left.black": "Du'n Groeslinol Wrthdro",
	...
	"block.minecraft.banner.flow.black": "Llif Du",
	"block.minecraft.banner.flow.blue": "Llif Glas",
	"block.minecraft.banner.flow.brown": "Llif Brown",
	"block.minecraft.banner.flow.cyan": "Llif Gwyrddlas",
	"block.minecraft.banner.flow.gray": "Llif Llwyd",
	"block.minecraft.banner.flow.green": "Llif Gwyrdd",
	"block.minecraft.banner.flow.light_blue": "Llif Glas Golau",
	"block.minecraft.banner.flow.light_gray": "Llif Llwyd Golau",
	"block.minecraft.banner.flow.lime": "Llif Leim",
	"block.minecraft.banner.flow.magenta": "Llif Majenta",
	"block.minecraft.banner.flow.orange": "Llif Oren",
	"block.minecraft.banner.flow.pink": "Llif Pinc",
	"block.minecraft.banner.flow.purple": "Llif Porffor",
	"block.minecraft.banner.flow.red": "Llif Coch",
	"block.minecraft.banner.flow.white": "Llif Gwyn",
	"block.minecraft.banner.flow.yellow": "Llif Melyn",
	...
	"block.minecraft.banner.guster.black": "Hwrdd Du",
	"block.minecraft.banner.guster.blue": "Hwrdd Glas",
	"block.minecraft.banner.guster.brown": "Hwrdd Brown",
	"block.minecraft.banner.guster.cyan": "Hwrdd Gwyrddlas",
	"block.minecraft.banner.guster.gray": "Hwrdd Llwyd",
	"block.minecraft.banner.guster.green": "Hwrdd Gwyrdd",
	"block.minecraft.banner.guster.light_blue": "Hwrdd Glas Golau",
	"block.minecraft.banner.guster.light_gray": "Hwrdd Llwyd Golau",
	"block.minecraft.banner.guster.lime": "Hwrdd Leim",
	"block.minecraft.banner.guster.magenta": "Hwrdd Majenta",
	"block.minecraft.banner.guster.orange": "Hwrdd Oren",
	"block.minecraft.banner.guster.pink": "Hwrdd Pinc",
	"block.minecraft.banner.guster.purple": "Hwrdd Porffor",
	"block.minecraft.banner.guster.red": "Hwrdd Coch",
	"block.minecraft.banner.guster.white": "Hwrdd Gwyn",
	"block.minecraft.banner.guster.yellow": "Hwrdd Melyn",
	...
	"block.minecraft.banner.triangle_bottom.magenta": "Sieffrwn Majenta",
	...
	"block.minecraft.banner.triangle_top.black": "Sieffrwn Du Gwrthdro",
	"block.minecraft.banner.triangle_top.blue": "Sieffrwn Glas Gwrthdro",
	"block.minecraft.banner.triangle_top.brown": "Sieffrwn Brown Gwrthdro",
	"block.minecraft.banner.triangle_top.cyan": "Sieffrwn Gwyrddlas Gwrthdro",
	"block.minecraft.banner.triangle_top.gray": "Sieffrwn Llwyd Gwrthdro",
	"block.minecraft.banner.triangle_top.green": "Sieffrwn Gwyrdd Gwrthdro",
	"block.minecraft.banner.triangle_top.light_blue": "Sieffrwn Glas Golau Gwrthdro",
	"block.minecraft.banner.triangle_top.light_gray": "Sieffrwn Llwyd Golau Gwrthdro",
	"block.minecraft.banner.triangle_top.lime": "Sieffrwn Leim Gwrthdro",
	"block.minecraft.banner.triangle_top.magenta": "Sieffrwn Majenta Gwrthdro",
	"block.minecraft.banner.triangle_top.orange": "Sieffrwn Oren Gwrthdro",
	"block.minecraft.banner.triangle_top.pink": "Sieffrwn Pinc Gwrthdro",
	"block.minecraft.banner.triangle_top.purple": "Sieffrwn Porffor Gwrthdro",
	"block.minecraft.banner.triangle_top.red": "Sieffrwn Coch Gwrthdro",
	"block.minecraft.banner.triangle_top.white": "Sieffrwn Gwyn Gwrthdro",
	"block.minecraft.banner.triangle_top.yellow": "Sieffrwn Melyn Gwrthdro",
	...
	"block.minecraft.beacon.secondary": "Pŵer Eilaidd",
	...
	"block.minecraft.birch_shelf": "Silff Bedw",
	...
	"block.minecraft.brain_coral": "Cwrel Ymennydd",
	...
	"block.minecraft.bush": "Llwyn",
	"block.minecraft.cactus": "Cactws",
	"block.minecraft.cactus_flower": "Blodyn Cactws",
	...
	"block.minecraft.cherry_shelf": "Silff Ceirios",
	...
	"block.minecraft.chiseled_cinnabar": "Sinabar Nadd",
	"block.minecraft.chiseled_copper": "Copr Nadd",
	...
	"block.minecraft.chiseled_resin_bricks": "Briciau Resin Nadd",
	"block.minecraft.chiseled_sandstone": "Tywodfaen Nadd",
	"block.minecraft.chiseled_stone_bricks": "Briciau Carreg Nadd",
	"block.minecraft.chiseled_sulfur": "Sylffwr Nadd",
	"block.minecraft.chiseled_tuff": "Twff Nadd",
	"block.minecraft.chiseled_tuff_bricks": "Briciau Twff Nadd",
	"block.minecraft.chorus_flower": "Blodyn Corws",
	"block.minecraft.chorus_plant": "Planhigyn Corws",
	"block.minecraft.cinnabar": "Sinabar",
	"block.minecraft.cinnabar_brick_slab": "Slab Briciau Sinabar",
	"block.minecraft.cinnabar_brick_stairs": "Grisiau Briciau Sinabar",
	"block.minecraft.cinnabar_brick_wall": "Wal Friciau Sinabar",
	"block.minecraft.cinnabar_bricks": "Briciau Sinabar",
	"block.minecraft.cinnabar_slab": "Slab Sinabar",
	"block.minecraft.cinnabar_stairs": "Grisiau Sinabar",
	"block.minecraft.cinnabar_wall": "Wal Sinabar",
	"block.minecraft.clay": "Clai",
	"block.minecraft.closed_eyeblossom": "Llygadflodyn Cau",
	...
	"block.minecraft.cobblestone_stairs": "Grisiau Crynion",
	...
	"block.minecraft.copper_bars": "Bariau Copr",
	"block.minecraft.copper_block": "Bloc Copr",
	"block.minecraft.copper_bulb": "Bwlb Copr",
	"block.minecraft.copper_chain": "Cadwyn Copr",
	"block.minecraft.copper_chest": "Cist Copr",
	"block.minecraft.copper_door": "Drws Copr",
	"block.minecraft.copper_golem_statue": "Cerflun Golem Copr",
	"block.minecraft.copper_grate": "Gratiau Copr",
	"block.minecraft.copper_lantern": "Llusern Copr",
	"block.minecraft.copper_ore": "Mwyn Copr",
	"block.minecraft.copper_torch": "Tors Copr",
	"block.minecraft.copper_trapdoor": "Drws Cudd Copr",
	"block.minecraft.copper_wall_torch": "Tors Wal Copr",
	...
	"block.minecraft.crafter": "Crefftiwr",
	"block.minecraft.crafting_table": "Bwrdd Crefft",
	"block.minecraft.creaking_heart": "Calon Gwich",
	...
	"block.minecraft.crimson_shelf": "Silff Rhuddgoch",
	...
	"block.minecraft.dark_oak_fence_gate": "Gât Ffens Dderw Dywyll",
	...
	"block.minecraft.dark_oak_shelf": "Silff Derw Tywyll",
	...
	"block.minecraft.dried_ghast": "Ghast Sych",
	...
	"block.minecraft.exposed_chiseled_copper": "Copr Nadd Wedi Pylu",
	"block.minecraft.exposed_copper": "Copr Wedi Pylu",
	"block.minecraft.exposed_copper_bars": "Bariau Copr Wedi Pylu",
	"block.minecraft.exposed_copper_bulb": "Bwlb Copr Wedi Pylu",
	"block.minecraft.exposed_copper_chain": "Cadwyn Copr Wedi Pylu",
	"block.minecraft.exposed_copper_chest": "Cist Copr Wedi Pylu",
	"block.minecraft.exposed_copper_door": "Drws Copr Wedi Pylu",
	"block.minecraft.exposed_copper_golem_statue": "Cerflun Golem Copr Wedi Pylu",
	"block.minecraft.exposed_copper_grate": "Gratiau Copr Wedi Pylu",
	"block.minecraft.exposed_copper_lantern": "Llusern Copr Wedi Pylu",
	"block.minecraft.exposed_copper_trapdoor": "Drws Cudd Copr Wedi Pylu",
	...
	"block.minecraft.exposed_lightning_rod": "Rhoden Fellt Wedi Pylu",
	...
	"block.minecraft.firefly_bush": "Llwyn Pryf Tân",
	...
	"block.minecraft.golden_dandelion": "Dant Y Llew Euraid",
	...
	"block.minecraft.gray_terracotta": "Terracotta Llwyd",
	...
	"block.minecraft.heavy_core": "Craidd Trwm",
	...
	"block.minecraft.iron_chain": "Cadwyn Haearn",
	...
	"block.minecraft.jungle_shelf": "Silff Jyngl",
	...
	"block.minecraft.leaf_litter": "Torllwyth Dail",
	...
	"block.minecraft.light_gray_terracotta": "Terracotta Llwyd Golau",
	...
	"block.minecraft.mangrove_shelf": "Silff Mangrof",
	...
	"block.minecraft.oak_shelf": "Silff Derw",
	...
	"block.minecraft.open_eyeblossom": "Llygadflodyn Agored",
	...
	"block.minecraft.oxidized_chiseled_copper": "Copr Nadd Ocsidiedig",
	"block.minecraft.oxidized_copper": "Copr Ocsidiedig",
	"block.minecraft.oxidized_copper_bars": "Bariau Copr Ocsidiedig",
	"block.minecraft.oxidized_copper_bulb": "Bwlb Copr Ocsidiedig",
	"block.minecraft.oxidized_copper_chain": "Cadwyn Copr Ocsidiedig",
	"block.minecraft.oxidized_copper_chest": "Cist Copr Ocsidiedig",
	"block.minecraft.oxidized_copper_door": "Drws Copr Ocsidiedig",
	"block.minecraft.oxidized_copper_golem_statue": "Cerflun Golem Copr Ocsidiedig",
	"block.minecraft.oxidized_copper_grate": "Gratiau Copr Ocsidiedig",
	"block.minecraft.oxidized_copper_lantern": "Llusern Copr Ocsidiedig",
	"block.minecraft.oxidized_copper_trapdoor": "Drws Cudd Copr Ocsidiedig",
	...
	"block.minecraft.oxidized_lightning_rod": "Rhoden Fellt Ocsidiedig",
	"block.minecraft.packed_ice": "Rhew Cywasgedig",
	"block.minecraft.packed_mud": "Mwd Cywasgedig",
	"block.minecraft.pale_hanging_moss": "Mwsog Crog Llwyd",
	"block.minecraft.pale_moss_block": "Bloc Mwsog Llwyd",
	"block.minecraft.pale_moss_carpet": "Carped Mwsog Llwyd",
	"block.minecraft.pale_oak_button": "Botwm Derw Llwyd",
	"block.minecraft.pale_oak_door": "Drws Derw Llwyd",
	"block.minecraft.pale_oak_fence": "Ffens Dderw Llwyd",
	"block.minecraft.pale_oak_fence_gate": "Gât Ffens Dderw Llwyd",
	"block.minecraft.pale_oak_hanging_sign": "Arwydd Crog Derw Llwyd",
	"block.minecraft.pale_oak_leaves": "Dail Derw Llwyd",
	"block.minecraft.pale_oak_log": "Boncyff Derw Llwyd",
	"block.minecraft.pale_oak_planks": "Planciau Derw Llwyd",
	"block.minecraft.pale_oak_pressure_plate": "Gwasglechen Derw Llwyd",
	"block.minecraft.pale_oak_sapling": "Glasbren Derw Llwyd",
	"block.minecraft.pale_oak_shelf": "Silff Derw Llwyd",
	"block.minecraft.pale_oak_sign": "Arwydd Derw Llwyd",
	"block.minecraft.pale_oak_slab": "Slab Derw Llwyd",
	"block.minecraft.pale_oak_stairs": "Grisiau Derw Llwyd",
	"block.minecraft.pale_oak_trapdoor": "Drws Cudd Derw Llwyd",
	"block.minecraft.pale_oak_wall_hanging_sign": "Arwydd Wal Crog Derw Llwyd",
	"block.minecraft.pale_oak_wall_sign": "Arwydd Wal Derw Llwyd",
	"block.minecraft.pale_oak_wood": "Pren Derw Llwyd",
	...
	"block.minecraft.polished_cinnabar": "Sinabar Caboledig",
	"block.minecraft.polished_cinnabar_slab": "Slab Sinabar Caboledig",
	"block.minecraft.polished_cinnabar_stairs": "Grisiau Sinabar Caboledig",
	"block.minecraft.polished_cinnabar_wall": "Wal Sinabar Caboledig",
	...
	"block.minecraft.polished_sulfur": "Sylffwr Caboledig",
	"block.minecraft.polished_sulfur_slab": "Slab Sylffwr Caboledig",
	"block.minecraft.polished_sulfur_stairs": "Grisiau Sylffwr Caboledig",
	"block.minecraft.polished_sulfur_wall": "Wal Sylffwr Caboledig",
	"block.minecraft.polished_tuff": "Twff Caboledig",
	"block.minecraft.polished_tuff_slab": "Slab Twff Caboledig",
	"block.minecraft.polished_tuff_stairs": "Grisiau Twff Caboledig",
	"block.minecraft.polished_tuff_wall": "Wal Twff Caboledig",
	"block.minecraft.poppy": "Pabi",
	"block.minecraft.potatoes": "Tatws",
	"block.minecraft.potent_sulfur": "Sylffwr Cryf",
	...
	"block.minecraft.potted_closed_eyeblossom": "Llygadflodyn Cau Mewn Pot",
	...
	"block.minecraft.potted_golden_dandelion": "Dant Y Llew Euraid Mewn Pot",
	...
	"block.minecraft.potted_open_eyeblossom": "Llygadflodyn Agored Mewn Pot",
	"block.minecraft.potted_orange_tulip": "Tiwlip Oren Mewn Pot",
	"block.minecraft.potted_oxeye_daisy": "Llygad Llo Mewn Pot",
	"block.minecraft.potted_pale_oak_sapling": "Glasbren Derw Llwyd Mewn Pot",
	...
	"block.minecraft.raw_gold_block": "Bloc Aur Crai",
	...
	"block.minecraft.resin_block": "Bloc Resin",
	"block.minecraft.resin_brick_slab": "Slab Bricsen Resin",
	"block.minecraft.resin_brick_stairs": "Grisiau Bricsen Resin",
	"block.minecraft.resin_brick_wall": "Wal Friciau Resin",
	"block.minecraft.resin_bricks": "Briciau Resin",
	"block.minecraft.resin_clump": "Talp Resin",
	...
	"block.minecraft.short_dry_grass": "Glaswellt Byr Sych",
	"block.minecraft.short_grass": "Glaswellt Byr",
	...
	"block.minecraft.spruce_shelf": "Silff Pyrwydd",
	...
	"block.minecraft.stripped_pale_oak_log": "Boncyff Derw Llwyd Moel",
	"block.minecraft.stripped_pale_oak_wood": "Pren Derw Llwyd Moel",
	...
	"block.minecraft.sulfur": "Sylffwr",
	"block.minecraft.sulfur_brick_slab": "Slab Briciau Sylffwr",
	"block.minecraft.sulfur_brick_stairs": "Grisiau Briciau Sylffwr",
	"block.minecraft.sulfur_brick_wall": "Wal Friciau Sylffwr",
	"block.minecraft.sulfur_bricks": "Briciau Sylffwr",
	"block.minecraft.sulfur_slab": "Slab Sylffwr",
	"block.minecraft.sulfur_spike": "Sbigyn Sylffwr",
	"block.minecraft.sulfur_stairs": "Grisiau Sylffwr",
	"block.minecraft.sulfur_wall": "Wal Sylffwr",
	...
	"block.minecraft.tall_dry_grass": "Glaswellt Hir Sych",
	...
	"block.minecraft.test_block": "Bloc Prawf",
	"block.minecraft.test_instance_block": "Bloc Enghraifft Prawf",
	"block.minecraft.tinted_glass": "Gwydr Arlliw",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "Analluogir ffrwydradau TNT",
	...
	"block.minecraft.trial_spawner": "Sil Treial",
	...
	"block.minecraft.tuff_brick_slab": "Slab Briciau Twff",
	"block.minecraft.tuff_brick_stairs": "Grisiau Briciau Twff",
	"block.minecraft.tuff_brick_wall": "Wal Friciau Twff",
	"block.minecraft.tuff_bricks": "Briciau Twff",
	"block.minecraft.tuff_slab": "Slab Twff",
	"block.minecraft.tuff_stairs": "Grisiau Twff",
	"block.minecraft.tuff_wall": "Wal Twff",
	...
	"block.minecraft.warped_shelf": "Silff Annaearol",
	...
	"block.minecraft.waxed_chiseled_copper": "Copr Cwyrog Nadd",
	"block.minecraft.waxed_copper_bars": "Bariau Copr Cwyrog",
	"block.minecraft.waxed_copper_block": "Bloc Copr Cwyrog",
	"block.minecraft.waxed_copper_bulb": "Bwlb Copr Cwyrog",
	"block.minecraft.waxed_copper_chain": "Cadwyn Copr Cwyrog",
	"block.minecraft.waxed_copper_chest": "Cist Copr Cwyrog",
	"block.minecraft.waxed_copper_door": "Drws Copr Cwyrog",
	"block.minecraft.waxed_copper_golem_statue": "Cerflun Golem Copr Cwyrog",
	"block.minecraft.waxed_copper_grate": "Gratiau Copr Cwyrog",
	"block.minecraft.waxed_copper_lantern": "Llusern Copr Cwyrog",
	"block.minecraft.waxed_copper_trapdoor": "Drws Cudd Copr Cwyrog",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Copr Cwyrog Nadd Wedi Pylu",
	"block.minecraft.waxed_exposed_copper": "Copr Cwyrog Wedi Pylu",
	"block.minecraft.waxed_exposed_copper_bars": "Bariau Copr Cwyrog Wedi Pylu",
	"block.minecraft.waxed_exposed_copper_bulb": "Bwlb Copr Cwyrog Wedi Pylu",
	"block.minecraft.waxed_exposed_copper_chain": "Cadwyn Copr Cwyrog Wedi Pylu",
	"block.minecraft.waxed_exposed_copper_chest": "Cist Copr Cwyrog Wedi Pylu",
	"block.minecraft.waxed_exposed_copper_door": "Drws Copr Cwyrog Wedi Pylu",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Cerflun Golem Copr Cwyrog Wedi Pylu",
	"block.minecraft.waxed_exposed_copper_grate": "Gratiau Copr Cwyrog Wedi Pylu",
	"block.minecraft.waxed_exposed_copper_lantern": "Llusern Copr Cwyrog Wedi Pylu",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Drws Cudd Copr Cwyrog Wedi Pylu",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Rhoden Fellt Cwyrog Wedi Pylu",
	"block.minecraft.waxed_lightning_rod": "Rhoden Fellt Cwyrog",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Copr Nadd Cwyrog Ocsidiedig",
	"block.minecraft.waxed_oxidized_copper": "Copr Cwyrog Ocsidiedig",
	"block.minecraft.waxed_oxidized_copper_bars": "Bariau Copr Cwyrog Ocsidiedig",
	"block.minecraft.waxed_oxidized_copper_bulb": "Bwlb Copr Cwyrog Ocsidiedig",
	"block.minecraft.waxed_oxidized_copper_chain": "Cadwyn Copr Cwyrog Ocsidiedig",
	"block.minecraft.waxed_oxidized_copper_chest": "Cist Copr Cwyrog Ocsidiedig",
	"block.minecraft.waxed_oxidized_copper_door": "Drws Copr Cwyrog Ocsidiedig",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Cerflun Copr Copr Cwyrog Ocsidiedig",
	"block.minecraft.waxed_oxidized_copper_grate": "Gratiau Copr Cwyrog Ocsidiedig",
	"block.minecraft.waxed_oxidized_copper_lantern": "Llusern Copr Cwyrog Ocsidiedig",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Drws Cudd Copr Cwyrog Ocsidiedig",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Rhoden Fellt Cwyrog Ocsidiedig",
	"block.minecraft.waxed_weathered_chiseled_copper": "Copr Cwyrog Nadd Hindreuliedig",
	"block.minecraft.waxed_weathered_copper": "Copr Cwyrog Hindreuliedig",
	"block.minecraft.waxed_weathered_copper_bars": "Bariau Copr Cwyrog Hindreuliedig",
	"block.minecraft.waxed_weathered_copper_bulb": "Bwlb Copr Cwyrog Hindreuliedig",
	"block.minecraft.waxed_weathered_copper_chain": "Cadwyn Copr Cwyrog Hindreuliedig",
	"block.minecraft.waxed_weathered_copper_chest": "Cist Copr Cwyrog Hindreuliedig",
	"block.minecraft.waxed_weathered_copper_door": "Drws Copr Cwyrog Hindreuliedig",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Cerflun Golem Copr Cwyrog Hindreuliedig",
	"block.minecraft.waxed_weathered_copper_grate": "Gratiau Copr Cwyrog Hindreuliedig",
	"block.minecraft.waxed_weathered_copper_lantern": "Llusern Copr Cwyrog Hindreuliedig",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Drws Cudd Copr Cwyrog Hindreuliedig",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Rhoden Fellt Cwyrog Hindreuliedig",
	"block.minecraft.weathered_chiseled_copper": "Copr Nadd Hindreuliedig",
	"block.minecraft.weathered_copper": "Copr Hindreuliedig",
	"block.minecraft.weathered_copper_bars": "Bariau Copr Hindreuliedig",
	"block.minecraft.weathered_copper_bulb": "Bwlb Copr Hindreuliedig",
	"block.minecraft.weathered_copper_chain": "Cadwyn Copr Hindreuliedig",
	"block.minecraft.weathered_copper_chest": "Cist Copr Hindreuliedig",
	"block.minecraft.weathered_copper_door": "Drws Copr Hindreuliedig",
	"block.minecraft.weathered_copper_golem_statue": "Cerflun Golem Copr Hindreuliedig",
	"block.minecraft.weathered_copper_grate": "Gratiau Copr Hindreuliedig",
	"block.minecraft.weathered_copper_lantern": "Llusern Copr Hindreuliedig",
	"block.minecraft.weathered_copper_trapdoor": "Drws Cudd Copr Hindreuliedig",
	...
	"block.minecraft.wildflowers": "Blodau Gwyllt",
	...
	"book.edit.title": "Sgrin Golygu Llyfr",
	...
	"book.page_button.next": "Tudalen Nesaf",
	"book.page_button.previous": "Tudalen Blaenorol",
	"book.sign.title": "Sgrin Llofnodi Llyfr",
	"book.sign.titlebox": "Teitl",
	"book.signButton": "Llofnodi",
	"book.view.title": "Sgrin Golwg Llyfr",
	"build.spawn_protection": "Mae %s o dan amddiffyniad silio",
	"build.tooHigh": "Terfyn uchder adeiladu yw %s",
	"build.tooLow": "Y taldra lleiaf am adeilad yw %s",
	...
	"chat.disabled.invalid_command_signature": "Roedd gan y gorchymyn lofnodion dadl gorchymyn annisgwyl neu goll.",
	"chat.disabled.invalid_signature": "Sgwrs heb lofnod dilys. Ceisiwch ailgysylltu, os gwelwch yn dda.",
	...
	"chat.disabled.options": "Sgwrsio wedi'i ddiffodd yn newisiadau cleient.",
	"chat.disabled.out_of_order_chat": "Sgwrs wedi derbyn allan o drefn. A wnaeth yr amser ar dy system newid?",
	...
	"chat.queue.tooltip": "Cliciwch i ddangos y neges nesaf",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "Anfonodd y gweinydd neges annilys.",
	...
	"chat.validation_error": "Gwall gwirio sgwrs",
	"chat_restriction.chat_and_commands_disabled_by_options": "Mae'r sgwrs yn gyfyngedig yng ngosodiadau'r cleient.",
	"chat_restriction.chat_disabled_by_options": "Mae'r sgwrs chwaraewr yn gyfyngedig yng ngosodiadau'r cleient.",
	"chat_restriction.chat_disabled_by_options.action": "Mynd i'r sgrîn Gosodiadau Sgwrs",
	"chat_restriction.disabled_by_launcher": "Mae'r lansiwr yn cyfyngu ar y sgwrs",
	"chat_restriction.disabled_by_profile": "Mae'r gosodiadau proffil yn cyfyngu ar y sgwrs.",
	"chat_restriction.disabled_by_profile.action": "Ewch i'ch gosodiadau proffil",
	"chat_screen.commands_not_allowed": "Ni chaniateir anfon gorchmynion",
	"chat_screen.message": "Neges i'w ddanfon: %s",
	"chat_screen.messages_not_allowed": "Ni chaniateir anfon negeseuon sgwrs",
	"chat_screen.restricted": "Mae'r sgwrs yn gyfyngedig. Cliciwch ar y neges hon am fanylion.",
	"chat_screen.restricted.narration": "Mae'r sgwrs yn cyfyngedig. Ewch i'r sgrîn Cyfyngiadau yn Opsiynau Byd.",
	"chat_screen.title": "Sgrîn sgwrsio",
	"chat_screen.usage": "Rhowch neges a gwasgwch Enter i ddanfon",
	"chunk.toast.checkLog": "Gweler y log am fwy o manylion",
	"chunk.toast.loadFailure": "Methwyd llwytho talp yn %s",
	"chunk.toast.lowDiskSpace": "Lle disg isel!",
	"chunk.toast.lowDiskSpace.description": "Efallai nad oes modd cadw'r byd.",
	"chunk.toast.saveFailure": "Methwyd cadw talp yn %s",
	...
	"command.forkLimit": "Cyrhaeddwyd mwyafswm nifer cyd-destunau(%s)",
	...
	"commands.attribute.base_value.reset.success": "Gwerth sylfaenol ar gyfer priodoledd %s ar gyfer endid %s wedi'i ailosod i ddiofyn %s",
	...
	"commands.banlist.entry.unknown": "(Anhysbys)",
	"commands.banlist.list": "Mae %s gwaharddiad:",
	"commands.banlist.none": "Dim gwaharddiadau",
	...
	"commands.data.modify.invalid_substring": "Mynegrifau is-linell annilys: %s i %s",
	...
	"commands.datapack.create.already_exists": "Mae pecyn gyda'r enw '%s' eisoes yn bodoli",
	"commands.datapack.create.invalid_full_name": "Enw pac newydd '%s' annilys",
	"commands.datapack.create.invalid_name": "Nodau annilys yn enw pac newydd '%s'",
	"commands.datapack.create.io_failure": "Methu creu pac gyda'r enw '%s', gwiriwch logiau",
	"commands.datapack.create.metadata_encode_failure": "Methu amgodio'r metadata ar gyfer pac gyda'r enw '%s': %s",
	"commands.datapack.create.success": "Crëwyd pac gwag newydd gyda'r enw '%s'",
	"commands.datapack.disable.failed": "Ni ddefnyddir pecyn '%s'!",
	"commands.datapack.disable.failed.feature": "Ni ellir analluogi'r pecyn '%s', oherwydd ei fod yn rhan o fflag wedi'i alluogi!",
	...
	"commands.debug.function.noReturnRun": "Ni ellir defnyddio olrhain gyda return run",
	...
	"commands.dialog.clear.multiple": "Cliriwyd deialog ar gyfer %s chwaraewr",
	"commands.dialog.clear.single": "Cliriwyd deialog ar gyfer %s",
	"commands.dialog.show.multiple": "Dangoswyd deialog i %s chwaraewr",
	"commands.dialog.show.single": "Dangoswyd deialog i %s",
	...
	"commands.drop.no_loot_table.block": "Nid oes gan bloc %s dabl ysbail",
	...
	"commands.execute.function.instantiationFailure": "Methwyd creu swyddogaeth %s: %s",
	...
	"commands.fetchprofile.copy_component": "Copïo Cydran",
	"commands.fetchprofile.copy_text": "Copïo %s",
	"commands.fetchprofile.entity.success": "Resolved profile for entity %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Methwyd â chyfresi proffil: %s",
	"commands.fetchprofile.give_item": "Rhoi Eitem",
	"commands.fetchprofile.id.failure": "Methwyd â datrys proffil ar gyfer ID %s",
	"commands.fetchprofile.id.success": "Resolved profile for ID %s: %s",
	"commands.fetchprofile.name.failure": "Methwyd â datrys proffil ar gyfer enw %s",
	"commands.fetchprofile.name.success": "Resolved profile for name %s: %s",
	"commands.fetchprofile.no_profile": "Nid oes gan yr endid %s proffil",
	"commands.fetchprofile.summon_mannequin": "Galw Model",
	...
	"commands.fillbiome.success.count": "Gosodwyd %s bïom rhwng %s, %s, %s a %s, %s, %s",
	...
	"commands.function.error.argument_not_compound": "Math paramedr annilys: %s, wedi disgwyl Compound",
	"commands.function.error.missing_argument": "Paramedr %[2]s ar goll yn swyddogaeth %[1]s",
	"commands.function.error.missing_arguments": "Paramedrau ar goll yn swyddogaeth %s",
	"commands.function.error.parse": "Wrth redeg macro %s: Achosodd gorchymyn '%s' wall: %s",
	"commands.function.instantiationFailure": "Methwyd creu swyddogaeth %s: %s",
	"commands.function.result": "Swyddogaeth '%s' wedi dychwelyd %s",
	"commands.function.scheduled.multiple": "Wrthi'n rhedeg swyddogaethau %s",
	"commands.function.scheduled.no_functions": "Ni ellir canfod unrhyw swyddogaethau o'r enw %s",
	"commands.function.scheduled.single": "Wrthi'n rhedeg swyddogaeth %s",
	"commands.function.success.multiple": "Gweithredwyd %s gorchymyn o %s swyddogaeth",
	"commands.function.success.multiple.result": "Gweithredwyd %s swyddogaeth",
	"commands.function.success.single": "Gweithredwyd %s gorchymyn o swyddogaeth '%s'",
	"commands.function.success.single.result": "Swyddogaeth '%[2]s' wedi dychwelyd %[1]s",
	...
	"commands.kick.owner.failed": "Ni ellir cicio perchennog y gweinydd yng ngêm LAN",
	"commands.kick.singleplayer.failed": "Ni ellir cicio mewn gêm chwaraewr sengl all-lein",
	...
	"commands.locate.biome.not_found": "Methu canfod bïom o fath \"%s\" o fewn pellter rhesymol",
	"commands.locate.biome.success": "Mae'r %s agosaf yn %s (%s bloc i ffwrdd)",
	"commands.locate.poi.not_found": "Methu canfod pwynt o ddiddordeb o fath \"%s\" o fewn pellter rhesymol",
	...
	"commands.locate.structure.not_found": "Methu canfod strwythur o fath \"%s\" yn gyfagos",
	...
	"commands.profile_fetch.copy_component": "Copïo Cydran",
	"commands.profile_fetch.failed_to_serialize": "Methwyd â chyfresi proffil: %s",
	"commands.profile_fetch.give_item": "Rhoi Eitem",
	"commands.profile_fetch.id.failure": "Methwyd â datrys proffil ar gyfer id %s",
	"commands.profile_fetch.id.success": "Resolved profile for ID %s: %s",
	"commands.profile_fetch.name.failure": "Methwyd â datrys proffil ar gyfer enw %s",
	...
	"commands.random.error.range_too_large": "Rhaid i ystod yr hapwerth fod hyd at 2147483646",
	"commands.random.error.range_too_small": "Rhaid i ystod yr hapwerth fod o leiaf 2",
	"commands.random.reset.all.success": "Wedi ailosod dilyniant(nau) ar hap %s",
	"commands.random.reset.success": "Wedi ailosod dilyniant ar hap %s",
	"commands.random.roll": "Cafodd %s %s (rhwng %s a %s)",
	"commands.random.sample.success": "Gwerth ar hap: %s",
	...
	"commands.rotate.success": "Wedi troi %s",
	...
	"commands.schedule.cleared.success": "Dilëwyd %s amserlen gydag id %s",
	...
	"commands.schedule.macro": "Methu trefnu macro",
	...
	"commands.scoreboard.objectives.list.success": "Mae %s amcan: %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Analluogwyd arddangos auto-diweddaru amcan %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Galluogwyd arddangos auto-diweddaru amcan %s",
	"commands.scoreboard.objectives.modify.displayname": "Newidwyd enw arddangos o %s i %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Clirwyd fformat rhif rhagosodedig amcan %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Newidwyd fformat rhif rhagosodedig amcan %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Cliriwyd enw arddangos ar gyfer %s endid yn %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Cliriwyd enw arddangos ar gyfer %s yn %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Newidiwyd enw arddangos i %s ar gyfer %s endid yn %s",
	"commands.scoreboard.players.display.name.set.success.single": "Newidiwyd enw arddangos i %s ar gyfer %s yn %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Clirwyd fformat rhif ar gyfer %s endid yn %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Clirwyd fformat rhif ar gyfer %s yn %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Newidwyd fformat rhif ar gyfer %s endid yn %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Newidwyd fformat rhif ar gyfer %s yn %s",
	...
	"commands.setidletimeout.success.disabled": "Mae terfyn amser segurdod chwaraewr nawr wedi'i ddiffodd",
	"commands.setworldspawn.failure.not_overworld": "Rhaid i'r pwynt silio fod yn yr Uwchfyd",
	"commands.setworldspawn.success": "Gosodwyd man atgyfodi'r byd i %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Gosodwyd man atgyfodi'r byd i %s, %s, %s [%s, %s] yn %s",
	"commands.spawnpoint.success.multiple": "Gosodwyd man atgyfodi i %s, %s, %s [%s] yn %s ar gyfer %s chwaraewr",
	"commands.spawnpoint.success.multiple.new": "Gosodwyd man atgyfodi i %s, %s, %s [%s, %s] yn %s ar gyfer %s chwaraewr",
	"commands.spawnpoint.success.single": "Gosodwyd man atgyfodi i %s, %s, %s [%s] yn %s ar gyfer %s",
	"commands.spawnpoint.success.single.new": "Gosodwyd man atgyfodi i %s, %s, %s [%s, %s] yn %s ar gyfer %s",
	"commands.spectate.cannot_spectate": "Ni ellir arsylwi ar %s",
	...
	"commands.stopsound.success.sourceless.any": "Atalwyd pob sain",
	"commands.stopsound.success.sourceless.sound": "Atalwyd swn '%s'",
	"commands.stopwatch.already_exists": "Mae stopwatsh '%s' yn bodoli eisoes",
	"commands.stopwatch.create.success": "Crëwyd Stopwatsh '%s'",
	"commands.stopwatch.does_not_exist": "Nid yw Stopwatsh '%s' yn bodoli",
	"commands.stopwatch.query": "Mae Stopwatsh '%s' wedi rhedeg am %ss",
	"commands.stopwatch.remove.success": "Tynnwyd Stopwatsh '%s'",
	"commands.stopwatch.restart.success": "Ailddechreuwyd Stopwatsh '%s'",
	"commands.summon.failed": "Ni ellir galw'r endid",
	"commands.summon.failed.peaceful": "Ni ellir galw ar Greaduriaid ym modd Heddychlon",
	...
	"commands.team.list.members.success": "Mae %s aelod gan Dîm %s: %s",
	...
	"commands.team.option.color.clear.success": "Cliriwyd y lliw ar gyfer tîm %s",
	...
	"commands.test.batch.starting": "Cychwyn amgylchedd %s swp %s",
	"commands.test.clear.error.no_tests": "Methu darganfod unrhyw brofion i eglur",
	"commands.test.clear.success": "%s strwythur(au) wedi cael eu clirio",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Cliciwch i gopïo i'r clipfwrdd",
	"commands.test.create.success": "Wedi creu gosodiad prawf ar gyfer arbrawf %s",
	"commands.test.error.no_test_containing_pos": "Methu dod o hyd i enghraifft arbrawf sy'n cynnwys %s, %s, %s",
	"commands.test.error.no_test_instances": "Ni chanfuwyd unrhyw enghreifftiau arbrawf",
	"commands.test.error.non_existant_test": "Ni ellid dod o hyd i arbrawf %s",
	"commands.test.error.structure_not_found": "Ni chafwyd hyd i strwythur arbrawf %s",
	"commands.test.error.test_instance_not_found": "Ni fu modd dod o hyd i endid bloc enghreifftiau arbrawf",
	"commands.test.error.test_instance_not_found.position": "Ni ellid dod o hyd i endid bloc enghreifftiau arbrawf ar gyfer arbrawf mewn %s %s %s",
	"commands.test.error.too_large": "Rhaid i faint y strwythur fod yn llai na %s floc ar hyd pob echelin",
	"commands.test.locate.done": "Gorffen lleoli, dod o hyd i (%s) strwythur",
	"commands.test.locate.found": "Canfuwyd strwythur yn: %s (Pellter: %s)",
	"commands.test.locate.started": "Mae dod o hyd i strwythurau arbrawf wedi dechrau. Gall hyn gymryd peth amser...",
	"commands.test.no_tests": "Nid oes unrhyw arbrofion i'w cynnal",
	"commands.test.relative_position": "Y sefyllfa mewn perthynas â %s: %s",
	"commands.test.reset.error.no_tests": "Methu darganfod unrhyw brofion i ailosod",
	"commands.test.reset.success": "Ailosod %s strwythur",
	"commands.test.run.no_tests": "Dim profion wedi canfod",
	"commands.test.run.running": "Rhedeg %s prawf...",
	"commands.test.summary": "Prawf Gêm wedi gyflawn %s Prawf(ion) eu rhedeg",
	"commands.test.summary.all_required_passed": "Wedi llwyddo pob prawf angenrheidiol :)",
	"commands.test.summary.failed": "%s Prawf angenrheidiol wedi methu :(",
	"commands.test.summary.optional_failed": "%s prawf(ion) dewisol wedi methu",
	"commands.tick.query.percentiles": "Canraddol: P50: %sms P95: %sms P99: %sms, sampl: %s",
	"commands.tick.query.rate.running": "Cyfradd tic targed: %s yr eiliad.\nAmser cyfartalog fesul tic: %sms (Targed: %sms)",
	"commands.tick.query.rate.sprinting": "Cyfradd tic targed: %s yr eiliad (wedi'i ingori, cyfeirnod yn unig).\nAmser cyfartalog fesul tic: %sms",
	"commands.tick.rate.success": "Gosodwyd y gyfradd ticio darged i %s yr eiliad",
	"commands.tick.sprint.report": "Cwblhawyd sbrint gyda %s o diciau yr eiliad, neu %s ms y tic",
	"commands.tick.sprint.stop.fail": "Dim sbrint tic ar hyn o bryd",
	"commands.tick.sprint.stop.success": "Mae sbrint tic wedi cael ei dorri",
	"commands.tick.status.frozen": "Mae'r gêm wedi rhewi",
	"commands.tick.status.lagging": "Mae'r gêm yn rhedeg, ond ni all gadw i fyny â'r targed gyfradd ticio",
	"commands.tick.status.running": "Mae'r gêm yn rhedeg fel arfer",
	"commands.tick.status.sprinting": "Mae'r gêm yn cyflymu",
	"commands.tick.step.fail": "Ni ellir hepgor y gêm - mae rhaid rhewi'r gêm yn gyntaf",
	"commands.tick.step.stop.fail": "Dim hepgoriad tic ar hyn o bryd",
	"commands.tick.step.stop.success": "Mae hepgoriad tic wedi cael ei dorri",
	"commands.tick.step.success": "Yn hepgor %s tic",
	"commands.time.no_default_clock": "Nid oes cloc diofyn yn nimensiwn %s",
	"commands.time.no_time_marker_found": "Nid yw marciwr amser %s yn bodoli ar gyfer cloc %s",
	"commands.time.pause": "Wedi seibio cloc %s",
	"commands.time.query": "Yr amser yw %s",
	"commands.time.query.absolute": "Mae cloc %s wedi'i osod ar %s tic",
	"commands.time.query.gametime": "Amser y gêm yw %s tic",
	...
	"commands.time.resume": "Wedi parhau cloc %s",
	"commands.time.set": "Wedi gosod yr amser i %s",
	"commands.time.set.absolute": "Gosodwyd %s i %s tic",
	"commands.time.set.time_marker": "Gosodwyd %s i farciwr amser %s",
	...
	"commands.transfer.error.no_players": "Rhaid nodi o leiaf un chwaraewr i symud",
	"commands.transfer.success.multiple": "Wrthi'n symud %s chwaraewr i %s:%s",
	"commands.transfer.success.single": "Wrthi'n symud %s i %s:%s",
	...
	"commands.waypoint.list.empty": "Dim pwyntiau ffordd yn %s",
	"commands.waypoint.list.success": "%s pwynt ffordd yn %s: %s",
	"commands.waypoint.modify.color": "Lliw pwynt ffordd yn nawr %s",
	"commands.waypoint.modify.color.reset": "Ailosod lliw pwynt ffordd",
	"commands.waypoint.modify.style": "Newidwyd arddull pwynt ffordd",
	...
	"commands.whitelist.list": "Mae %s chwaraewr ar restr caniatáu: %s",
	...
	"component.profile.dynamic": "Dynamig",
	"connect.aborted": "Ataliwyd",
	"connect.authorizing": "Mewngofnodi...",
	"connect.connecting": "Wrthi'n cysylltu â'r gweinydd...",
	"connect.encrypting": "Yn amgryptio...",
	"connect.failed": "Methu cysylltu â'r gweinydd",
	"connect.failed.transfer": "Methwyd y cysylltiad wrth symud i'r gweinydd",
	"connect.joining": "Wrthi'n ymuno â'r byd...",
	...
	"connect.reconfiging": "Wrthi'n ail-ffurfweddu...",
	"connect.reconfiguring": "Wrthi'n ail-ffurfweddu...",
	"connect.transferring": "Wrthi'n symud i weinydd newydd...",
	"container.barrel": "Casgen",
	"container.beacon": "Goleufa",
	"container.beehive.bees": "Gwenyn: %s/%s",
	"container.beehive.honey": "Mêl: %s/%s",
	...
	"container.repair": "Trwsio ac Enwi",
	...
	"controls.title": "Rheolyddion",
	"createWorld.customize.buffet.biome": "Dewiswch bïom",
	"createWorld.customize.buffet.search": "Chwilio...",
	...
	"createWorld.customize.presets.list": "Fel arall, dyma rhai gwnaethom yn gynharach!",
	...
	"credits_and_attribution.screen.title": "Cydnabyddiaeth a Phriodoliad",
	"dataPack.bundle.description": "Mae'n galluogi'r eitem arbrofol Bwndel",
	"dataPack.bundle.name": "Bwndeli",
	"dataPack.locator_bar.description": "Dangos cyfeiriad chwaraewyr eraill yn aml-chwaraewr",
	"dataPack.locator_bar.name": "Bar Lleoli",
	"dataPack.minecart_improvements.description": "Symudiad gwell ar gyfer Cartiau Pwll",
	"dataPack.minecart_improvements.name": "Gwelliannau Cart Pwll",
	"dataPack.redstone_experiments.description": "Newidiadau Arbrofol Redstone",
	"dataPack.redstone_experiments.name": "Arbrofion Redstone",
	"dataPack.title": "Dewis Pecynnau Data",
	"dataPack.trade_rebalance.description": "Diweddaru masnachau Pentrefwyr",
	"dataPack.trade_rebalance.name": "Ail-gydbwyso Masnach Pentrefwyr",
	...
	"dataPack.update_1_21.description": "Nodweddion a chynnwys newydd ar gyfer Minecraft 1.21",
	"dataPack.update_1_21.name": "Fersiwn 1.21",
	...
	"dataPack.winter_drop.description": "Nodweddion a chynnwys newydd ar gyfer Gollyngiad y Gaeaf",
	"dataPack.winter_drop.name": "Gollyngiad y Gaeaf",
	...
	"death.attack.dryout.player": "Bu farw %[1]s o syched wrth geisio dianc oddi wrth %[2]s",
	...
	"death.attack.genericKill": "Lladdwyd %[1]s",
	"death.attack.genericKill.player": "Lladdwyd %[1]s wrth frwydro yn erbyn %[2]s",
	...
	"death.attack.mace_smash": "Curwyd %[1]s gan %[2]s",
	"death.attack.mace_smash.item": "Curwyd %[1]s gan %[2]s gan ddefnyddio %[3]s",
	...
	"death.attack.outsideBorder": "Gadawodd %[1]s ffiniau'r byd hwn",
	"death.attack.outsideBorder.player": "Gadawodd %[1]s ffiniau'r byd hwn wrth ymladd %[2]s",
	...
	"death.attack.sonic_boom.item": "Chwalwyd %[1]s gan sgrech sonig wrth geisio dianc oddi wrth %[2]s wrth arfer %[3]s",
	"death.attack.sonic_boom.player": "Chwalwyd %[1]s gan sgrech trydanol wrth geisio dianc oddi wrth %[2]s",
	"death.attack.spear": "Trywanwyd %[1]s gan %[2]s",
	"death.attack.spear.item": "Trywanwyd %[1]s gan %[2]s gan ddefnyddio %[3]s",
	...
	"deathScreen.score.value": "Sgôr: %s",
	...
	"debug.copy_location.help": "F3 + C = Copïwch y lleoliad fel gorchymyn /tp, daliwch F3 + C i lawr i chwalu'r gêm",
	...
	"debug.crash.message.rebindable": "Mae %s + %s yn cael eu ddal i lawr. Bydd hyn yn chwalu y gêm oni bai nhw'n cael eu rhyddhau.",
	...
	"debug.dump_dynamic_textures.help": "F3 + S = Dymp adnoddau deinamig",
	"debug.entry.always": "Bob amser",
	"debug.entry.currently.alwaysOn": "%s: Ymlaen bob amser",
	"debug.entry.currently.inF3": "%s: Dim ond yn F3",
	"debug.entry.currently.inOverlay": "%s: Dim ond mewn troshaen ddadfygio",
	"debug.entry.currently.never": "%s: I ffwrdd",
	"debug.entry.f3": "Yn F3",
	"debug.entry.overlay": "Mewn Troshaen",
	...
	"debug.options.category.renderer": "Rendrwyr Dadfygio",
	"debug.options.category.text": "Testun Sgrîn Dadfygio",
	"debug.options.help": "F3 + F6 = Golygu opsiynau dadfygio",
	"debug.options.notAllowed.tooltip": "Not visible when debug info is reduced",
	"debug.options.profile.default": "Proffil diofyn",
	"debug.options.profile.performance": "Proffil Perfformiad",
	"debug.options.search": "Chwilio...",
	"debug.options.title": "Opsiynau Dadfygio",
	...
	"debug.profiling.start.rebindable": "Dechreuwyd proffilio am %s eiliad. Defnyddiwch %s + %s i'w atal yn gynnar",
	...
	"debug.version.header": "Gwybodaeth fersiwn cleient:",
	"debug.version.help": "F3 + V = Gwybodaeth fersiwn cleient",
	...
	"disconnect.ignoring_status_request": "Wrthi'n anwybyddu cais statws",
	...
	"disconnect.packetError": "Gwall Protocol Rhwydwaith",
	"disconnect.spam": "Ciciwyd am sbamio",
	"disconnect.timeout": "Wedi amseru allan",
	"disconnect.transfer": "Wedi symud i weinydd newydd",
	"disconnect.unknownHost": "Lletywr anhysbys",
	"download.pack.failed": "Methodd %s o %s pecyn i lawrlwytho",
	"download.pack.progress.bytes": "Hynt: %s (maint llawn anhysbys)",
	"download.pack.progress.percent": "Hynt: %s%%",
	"download.pack.title": "Yn lawrlwytho pecyn adnodd %s/%s",
	"editGamerule.default": "Rhagosodedig: %s",
	"editGamerule.inGame.button": "Golygu Rheolau Gêm...",
	"editGamerule.inGame.disabled.tooltip": "Mae angen caniatadau gweithredwr i ddiweddaru'r rheolau gêm.",
	"editGamerule.inGame.discardChanges.message": "Are you sure you want to discard your pending game rule changes?",
	"editGamerule.inGame.discardChanges.title": "Newidiadau Rheolau Gêm",
	"editGamerule.inGame.downloadingGamerules": "Wrthi'n nôl rheolau gêm...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Anadl y Nawtilws",
	...
	"effect.minecraft.infested": "Heigiog",
	...
	"effect.minecraft.oozing": "Lleidiog",
	"effect.minecraft.poison": "Gwenwyn",
	"effect.minecraft.raid_omen": "Argoel Cyrch",
	...
	"effect.minecraft.trial_omen": "Argoel Treial",
	"effect.minecraft.unluck": "Anlwc",
	"effect.minecraft.water_breathing": "Anadlu Dŵr",
	"effect.minecraft.weakness": "Gwendid",
	"effect.minecraft.weaving": "Gwau",
	"effect.minecraft.wind_charged": "Hyrddiad Gwynt",
	...
	"enchantment.minecraft.breach": "Torri",
	"enchantment.minecraft.channeling": "Sianelu",
	"enchantment.minecraft.density": "Dwysedd",
	...
	"enchantment.minecraft.knockback": "Curo Nôl",
	...
	"enchantment.minecraft.lunge": "Rhagwthio",
	...
	"enchantment.minecraft.sweeping_edge": "Ymyl Ysgubol",
	...
	"enchantment.minecraft.wind_burst": "Ffrwydrad Gwynt",
	"entity.minecraft.acacia_boat": "Cwch Acesia",
	"entity.minecraft.acacia_chest_boat": "Cwch Acesia â Chist",
	...
	"entity.minecraft.bamboo_chest_raft": "Rafft Fambŵ â Chist",
	"entity.minecraft.bamboo_raft": "Rafft Fambŵ",
	"entity.minecraft.bat": "Ystlum",
	"entity.minecraft.bee": "Gwenynen",
	"entity.minecraft.birch_boat": "Cwch Bedw",
	"entity.minecraft.birch_chest_boat": "Cwch Bedw â Chist",
	"entity.minecraft.blaze": "Tânfwystfil",
	"entity.minecraft.block_display": "Arddangosiad Bloc",
	"entity.minecraft.boat": "Cwch",
	"entity.minecraft.bogged": "Corslyd",
	"entity.minecraft.breeze": "Awel",
	"entity.minecraft.breeze_wind_charge": "Hyrddiad Gwynt",
	"entity.minecraft.camel": "Camel",
	"entity.minecraft.camel_husk": "Cibyn Camel",
	"entity.minecraft.cat": "Cath",
	"entity.minecraft.cave_spider": "Pryf Cop Ogof",
	"entity.minecraft.cherry_boat": "Cwch Ceirios",
	"entity.minecraft.cherry_chest_boat": "Cwch Ceirios â Chist",
	...
	"entity.minecraft.copper_golem": "Golem Copr",
	"entity.minecraft.cow": "Buwch",
	"entity.minecraft.creaking": "Gwich",
	"entity.minecraft.creaking_transient": "Gwich",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Cwch Derw Tywyll",
	"entity.minecraft.dark_oak_chest_boat": "Cwch Derw Tywyll â Chist",
	...
	"entity.minecraft.happy_ghast": "Ghast Hapus",
	...
	"entity.minecraft.jungle_boat": "Cwch Jyngl",
	"entity.minecraft.jungle_chest_boat": "Cwch Jyngl â Chist",
	...
	"entity.minecraft.lingering_potion": "Diod Parhaus",
	"entity.minecraft.llama": "Lama",
	"entity.minecraft.llama_spit": "Poer Lama",
	"entity.minecraft.magma_cube": "Ciwb Magma",
	"entity.minecraft.mangrove_boat": "Cwch Mangrof",
	"entity.minecraft.mangrove_chest_boat": "Cwch Mangrof â Chist",
	...
	"entity.minecraft.nautilus": "Nawtilws",
	"entity.minecraft.oak_boat": "Cwch Derw",
	"entity.minecraft.oak_chest_boat": "Cwch Derw â Chist",
	"entity.minecraft.ocelot": "Cath Wyllt",
	"entity.minecraft.ominous_item_spawner": "Sil Eitem Ddrwgargoelus",
	"entity.minecraft.painting": "Llun",
	"entity.minecraft.pale_oak_boat": "Cwch Derw Llwyd",
	"entity.minecraft.pale_oak_chest_boat": "Cwch Derw Llwyd â Chist",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Sychedig",
	...
	"entity.minecraft.splash_potion": "Diod Tasgu",
	"entity.minecraft.spruce_boat": "Cwch Pyrwydd",
	"entity.minecraft.spruce_chest_boat": "Cwch Pyrwydd â Chist",
	"entity.minecraft.squid": "Ystifflog",
	"entity.minecraft.stray": "Crwydryn",
	"entity.minecraft.strider": "Brasgamwr",
	"entity.minecraft.sulfur_cube": "Ciwb Sylffwr",
	"entity.minecraft.sulfur_cube.content": "Yn cynnwys: %s",
	...
	"entity.minecraft.wind_charge": "Hyrddiad Gwynt",
	...
	"entity.minecraft.zombie_nautilus": "Nawtilws Sombi",
	...
	"event.minecraft.raid.defeat.full": "Cyrch - Gorchfygiad",
	"event.minecraft.raid.raiders_remaining": "Herwyr Sydd ar Ôl: %s",
	"event.minecraft.raid.victory": "Buddugoliaeth",
	"event.minecraft.raid.victory.full": "Cyrch - Buddugoliaeth",
	"filled_map.buried_treasure": "Map Trysor Cudd",
	"filled_map.explorer_jungle": "Map Chwilotwr Jyngl",
	"filled_map.explorer_swamp": "Map Chwilotwr Cors",
	"filled_map.id": "Id #%s",
	"filled_map.level": "(Lefel %s/%s)",
	"filled_map.locked": "Ynghlo",
	"filled_map.mansion": "Map Chwilotwr Coedwig",
	"filled_map.monument": "Map Chwilotwr Cefnfor",
	"filled_map.scale": "Graddfa yn 1:%s",
	"filled_map.trial_chambers": "Map Siambrau Treial",
	"filled_map.unknown": "Map Anhysbys",
	"filled_map.village_desert": "Map Pentref Anialwch",
	"filled_map.village_plains": "Map Pentref Gwastadeddau",
	"filled_map.village_savanna": "Map Pentref Safana",
	"filled_map.village_snowy": "Map Pentref Eiraog",
	"filled_map.village_taiga": "Map Pentref Taiga",
	...
	"gameMode.hardcore": "Modd Craiddgaled!",
	"gameMode.spectator": "Modd Gwyliwr",
	"gameMode.survival": "Modd Goroesi",
	"gamerule.allowEnteringNetherUsingPortals": "Galluogi'r Nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Yn rheoli p'un a yw chwaraewyr yn gallu mynd i'r Nether.",
	"gamerule.allowFireTicksAwayFromPlayer": "Ticiwch tân i ffwrdd oddi wrth chwaraewyr",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Yn rheoli a all tân neu lafa yn gallu ticio 8 tapl i ffwrdd o unrhyw chwaraewr",
	"gamerule.announceAdvancements": "Datgan dyrchafiadau",
	"gamerule.blockExplosionDropDecay": "Colli rhai gollyngiadau bloc mewn ffrwydradau bloc",
	...
	"gamerule.commandBlocksEnabled": "Galluogi Blociau Gorchymyn",
	...
	"gamerule.disablePlayerMovementCheck": "Diffodd gwiriad symudiad y chwaraewr",
	...
	"gamerule.doLimitedCrafting.description": "Os yn weithredol, bydd chwaraewyr ond yn gallu crefftio ryseitiau maen nhw wedi'u datgloi.",
	"gamerule.doMobLoot": "Gollwng ysbail creaduriaid",
	"gamerule.doMobLoot.description": "Yn rheoli gollyngiadau adnoddau o greaduriaid, gan gynnwys pelenni profiad.",
	"gamerule.doMobSpawning": "Silio creaduriaid",
	"gamerule.doMobSpawning.description": "Gall rhai endidau cael rheolau ar wahân.",
	"gamerule.doPatrolSpawning": "Silio patrolau ysbeilwyr",
	"gamerule.doTileDrops": "Gollwng blociau",
	"gamerule.doTileDrops.description": "Yn rheoli gollyngiadau adnoddau o flociau, gan gynnwys pelenni profiad.",
	...
	"gamerule.enableCommandBlocks": "Galluogi Blociau Gorchymyn",
	"gamerule.enderPearlsVanishOnDeath": "Perlau Ender wedi'u taflu yn diflannu ar ôl marwolaeth",
	"gamerule.enderPearlsVanishOnDeath.description": "A yw perlau ender wedi'u taflu gan chwaraewr yn diflannu pan fydd y chwaraewr hwnnw yn marw.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Gall endidau â theithwyr ddefnyddio pyrth",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Galluogi endidau â theithwyr i delegludo trwy pyrth nether a phyrth end.",
	...
	"gamerule.locatorBar": "Galluogi Bar Lleoli chwaraewyr",
	"gamerule.locatorBar.description": "Pan gael galluogi, dangosir bar ar y sgrin i dangos cyfeiriad y chwaraewyr.",
	...
	"gamerule.maxCommandForkCount": "Terfyn cyd-destun gorchmynion",
	"gamerule.maxCommandForkCount.description": "Uchafswm nifer y cyd-destunau y gellir eu defnyddio gan orchmynion fel 'gweithredu fel'.",
	"gamerule.maxEntityCramming": "Trothwy gwasgu endidau",
	"gamerule.minecartMaxSpeed": "Uchafswm cyflymder Cart Pwll",
	"gamerule.minecartMaxSpeed.description": "Uchafswm cyflymder rhagosodedig Cart Pwll ar y tir",
	"gamerule.minecraft.elytra_movement_check": "Cynnal gwiriad symudiad elytra",
	"gamerule.minecraft.fire_spread_radius_around_player": "Radiws lledaeniad tân",
	...
	"gamerule.minecraft.player_movement_check": "Cynnal gwiriad symudiad y chwaraewr",
	"gamerule.minecraft.raids": "Cynnal cyrchoedd",
	"gamerule.minecraft.universal_anger.description": "Pan yn flin, mae creaduriaid niwtral yn ymosod ar unrhyw chwaraewr cyfagos, yn ogystal â'r chwaraewr a'u gwylltiodd. Mae'n gweithio orau os yw forgive_dead_players wedi'i ddiffodd.",
	"gamerule.mobExplosionDropDecay": "Colli rhai gollyngiadau bloc mewn ffrwydradau creadur",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Oedi Porth Nether y chwaraewr ym modd creadigol",
	"gamerule.playersNetherPortalCreativeDelay.description": "Amser (mewn ticiau) y mae angen i chwaraewr modd creadigol sefyll mewn porth Nether cyn newid dimensiynau.",
	"gamerule.playersNetherPortalDefaultDelay": "Oedi Porth Nether y chwaraewr mewn moddau nad yw'n greadigol",
	"gamerule.playersNetherPortalDefaultDelay.description": "Amser (mewn ticiau) y mae angen i chwaraewr modd nad yw'n greadigol sefyll mewn porth Nether cyn newid dimensiynau.",
	...
	"gamerule.projectilesCanBreakBlocks": "Gall taflegrau dorri blociau",
	"gamerule.projectilesCanBreakBlocks.description": "Yn rheoli a fydd taflunyddion effaith yn dinistrio blociau y gallant eu dinistrio.",
	"gamerule.pvp": "Galluogi pvp",
	"gamerule.pvp.description": "Yn rheoli p'un a yw chwaraewyr yn gallu niweidio chwaraewyr eraill.",
	"gamerule.randomTickSpeed": "Cyfradd cyflymder tic ar-hap",
	"gamerule.reducedDebugInfo": "Lleihau gwybodaeth dadfygio",
	"gamerule.reducedDebugInfo.description": "Cwtogi cynnwys y sgrîn dadfygio.",
	"gamerule.sendCommandFeedback": "Anfon adborth gorchymyn",
	"gamerule.showDeathMessages": "Dangos negeseuon marwolaeth",
	"gamerule.snowAccumulationHeight": "Terfyn uchder eira",
	...
	"gamerule.spawnChunkRadius": "Radiws talpiau silio",
	"gamerule.spawnChunkRadius.description": "Nifer y talpiau sy'n aros wedi'u llwytho o gwmpas pwynt silio'r byd yn yr Uwchfyd.",
	"gamerule.spawnMonsters": "Silio Bwystfilod",
	"gamerule.spawnMonsters.description": "Yn rheoli p'un a yw creaduriaid yn silio.",
	"gamerule.spawnRadius": "Cwmpas lleoliad atgyfodi",
	"gamerule.spawnRadius.description": "Rheoli maint yr ardal o gwmpas y pwynt silio lle y gellid silio chwaraewyr.",
	"gamerule.spawnerBlocksEnabled": "Galluogi Blociau Sil",
	"gamerule.spectatorsGenerateChunks": "Caniatau gwylwyr i greu tirwedd",
	"gamerule.tntExplodes": "Galluogi i TNT gael ei gynnau a ffrwydro",
	"gamerule.tntExplosionDropDecay": "Colli rhai gollyngiadau bloc mewn ffrwydradau TNT",
	...
	"gui.abuseReport.attestation": "Wrth gyflwyno'r adroddiad hon, rydych chi'n cadarnhau bod y wybodaeth yr ydych chi wedi darparu yn gyfan ac yn gywir hyd eithaf eich gwybodaeth.",
	"gui.abuseReport.comments": "Sylwadau",
	"gui.abuseReport.describe": "Bydd rhannu manylion yn ein helpu ni gwneud penderfyniad hyddysg.",
	"gui.abuseReport.discard.content": "Os ydych chi'n gadael, mi fyddwch chi golli'r adroddiad hwn a'ch sylwadau.\nYdych chi wir eisiau gadael?",
	"gui.abuseReport.discard.discard": "Gadael a Chanslo Adroddiad",
	"gui.abuseReport.discard.draft": "Cadw fel Drafft",
	"gui.abuseReport.discard.return": "Parhau i olygu",
	"gui.abuseReport.discard.title": "Canslo adroddiad a sylwadau?",
	"gui.abuseReport.draft.content": "Hoffech chi barhau i olygu'r adroddiad cyfredol, neu ei ddileu a chreu un newydd?",
	"gui.abuseReport.draft.discard": "Canslo",
	"gui.abuseReport.draft.edit": "Parhau i olygu",
	"gui.abuseReport.draft.quittotitle.content": "Hoffech chi barhau ei olygu neu'i ganslo?",
	"gui.abuseReport.draft.quittotitle.title": "Mae gennych adroddiad sgwrs drafft a fydd yn cael ei golli os byddwch chi'n gadael",
	"gui.abuseReport.draft.title": "Golygu drafft adroddiad sgwrs?",
	"gui.abuseReport.error.title": "Problem wrth anfon eich adroddiad",
	"gui.abuseReport.message": "Ble weloch chi'r ymddygiad drwg?\nBydd hyn yn ein helpu i ymchwilio i'ch achos.",
	"gui.abuseReport.more_comments": "Disgrifiwch yr hyn sydd wedi digwydd:",
	"gui.abuseReport.name.comment_box_label": "Disgrifiwch pam ydych chi am adrodd yr enw hwn:",
	"gui.abuseReport.name.reporting": "Rydych chi am riportio \"%s\".",
	"gui.abuseReport.name.title": "Riportio Enw Chwaraewr",
	"gui.abuseReport.observed_what": "Pam ydych chi'n riportio hwn?",
	"gui.abuseReport.read_info": "Dysgu am Riportio",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Difenwi",
	...
	"gui.abuseReport.reason.generic": "Hoffwn i riportio nhw",
	"gui.abuseReport.reason.generic.description": "Dwi'n grac wrthyn nhw / maen nhw wedi gwneud rhywbeth fy mod i ddim yn hoffi.",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Rhywiol amhriodol",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Gweddau sy'n dangos gweithredoedd rhywiol, organau rhywiol, a thrais rhywiol yn graffigol.",
	...
	"gui.abuseReport.report_sent_msg": "Rydym wedi derbyn eich adroddiad yn llwyddiannus. Diolch!\n\nBydd ein tîm yn bwrw golwg drosto cyn gynted ag y bo modd.",
	"gui.abuseReport.select_reason": "Dewiswch Gategori Riportio",
	"gui.abuseReport.send": "Anfon Adroddiad",
	"gui.abuseReport.send.comment_too_long": "Gwnewch y sylw yn fyrrach os gwelwch yn dda",
	...
	"gui.abuseReport.send.no_reason": "Dewiswch gategori riportio",
	"gui.abuseReport.send.not_attested": "Darllenwch y destun uchod a rhowch tic yn y blwch er mwyn anfon yr adroddiad",
	...
	"gui.abuseReport.sending.title": "Wrthi'n anfon eich adroddiad...",
	"gui.abuseReport.sent.title": "Anfonwyd eich adroddiad",
	"gui.abuseReport.skin.title": "Riportio Edrychiad Chwaraewr",
	"gui.abuseReport.title": "Riportio Chwaraewr",
	"gui.abuseReport.type.chat": "Negeseuon sgwrs",
	"gui.abuseReport.type.name": "Enw'r chwaraewr",
	"gui.abuseReport.type.skin": "Edrychiad y chwaraewr",
	"gui.acknowledge": "Rwy'n deall",
	"gui.advancements": "Dyrchafiadau",
	"gui.all": "Popeth",
	"gui.back": "Yn ôl",
	"gui.banned.description": "%s\n\n%s\n\nDysgwch fwy ar y ddolen ganlynol: %s",
	"gui.banned.description.permanent": "Mae eich cyfrif wedi derbyn gwaharddiad parhaol, sy'n golygu nad oes modd i chi chwarae ar-lein neu ymuno â Realms.",
	...
	"gui.banned.name.description": "Mae eich enw cyfredol - \"%s\" - yn torri ein Safonau Cymuned. Gallwch chi barhau i chwarae modd chwaraewr sengl, ond bydd angen ichi newid eich enw cyn chwarae ar-lein. \n\nDysgwch fwy neu gyflwynwch gais adolygu ar y ddolen ganlynol: %s",
	"gui.banned.name.title": "Enw Gwaharddedig ym Modd Aml-Chwaraewr",
	...
	"gui.banned.skin.description": "Mae eich gwedd cyfredol yn torri ein Safonau Cymuned. Gallwch chi barhau i chwarae gyda gwedd rhagosodedig, neu ddewiswch un arall. \n\nDysgwch fwy neu gyflwynwch gais adolygu ar y ddolen ganlynol: %s",
	"gui.banned.skin.title": "Edrychiad Gwaharddedig",
	...
	"gui.continue": "Parhau",
	"gui.copy_link_to_clipboard": "Copïo Dolen i'r Clipfwrdd",
	"gui.days": "%s diwrnod",
	"gui.done": "Gorffen",
	"gui.down": "I lawr",
	"gui.entity_tooltip.type": "Math: %s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "Gwrthodwyd %s ffeil",
	"gui.fileDropFailure.title": "Methwyd ychwanegu ffeiliau",
	...
	"gui.game_rule.search": "Chwilio...",
	"gui.hours": "%s awr",
	"gui.language.search": "Chwilio...",
	"gui.loadingMinecraft": "Wrthi'n llwytho Minecraft",
	"gui.minutes": "%s munud",
	...
	"gui.none": "Dim un",
	"gui.ok": "Iawn",
	"gui.open_report_dir": "Agor Ffolder Adroddion",
	"gui.packSelection.search": "Chwilio...",
	...
	"gui.recipebook.next_page": "Tudalen Nesaf",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Tudalen Flaenorol",
	...
	"gui.remove": "Remove",
	"gui.report_to_server": "Adrodd i'r Gweinydd",
	"gui.selectWorld.search": "Chwilio...",
	...
	"gui.stats": "Ystadegau",
	"gui.stats.none_found": "Ni chafwyd ystadegau.",
	...
	"gui.togglable_slot": "Clicio i analluogi slot",
	"gui.up": "I fyny",
	"gui.waitingForResponse.button.inactive": "Nôl (%se)",
	"gui.waitingForResponse.title": "Aros am Gweinydd",
	"gui.yes": "Ie",
	...
	"item.minecraft.angler_pottery_shard": "Darn Crochenwaith Pysgotwr",
	"item.minecraft.angler_pottery_sherd": "Darn Crochenwaith Pysgotwr",
	"item.minecraft.apple": "Afal",
	"item.minecraft.archer_pottery_shard": "Darn Crochenwaith Saethwr",
	"item.minecraft.archer_pottery_sherd": "Darn Crochenwaith Saethwr",
	"item.minecraft.armadillo_scute": "Sgwtela Armadilo",
	"item.minecraft.armadillo_spawn_egg": "Ŵy Geni Armadilo",
	"item.minecraft.armor_stand": "Daliadur Arfwisg",
	"item.minecraft.arms_up_pottery_shard": "Darn Crochenwaith Breichiau",
	...
	"item.minecraft.black_bundle": "Bwndel Du",
	"item.minecraft.black_dye": "Llifyn Du",
	"item.minecraft.black_harness": "Harnais Du",
	"item.minecraft.blade_pottery_shard": "Darn Crochenwaith Cleddyf",
	...
	"item.minecraft.blue_bundle": "Bwndel Glas",
	"item.minecraft.blue_dye": "Llifyn Glas",
	"item.minecraft.blue_egg": "Ŵy Glas",
	"item.minecraft.blue_harness": "Harnais Glas",
	"item.minecraft.bogged_spawn_egg": "Wy Geni Corslyd",
	"item.minecraft.bolt_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Addurn Arfwisg Bollten",
	"item.minecraft.bone": "Asgwrn",
	"item.minecraft.bone_meal": "Blawd Esgyrn",
	"item.minecraft.book": "Llyfr",
	"item.minecraft.bordure_indented_banner_pattern": "Patrwm Baner Bordor Rasyd",
	"item.minecraft.bow": "Bwa",
	"item.minecraft.bowl": "Powlen",
	"item.minecraft.bread": "Bara",
	"item.minecraft.breeze_rod": "Gwialen Awel",
	"item.minecraft.breeze_spawn_egg": "Wy Geni Awel",
	"item.minecraft.brewer_pottery_shard": "Darn Crochenwaith Bragu",
	...
	"item.minecraft.brown_bundle": "Bwndel Brown",
	"item.minecraft.brown_dye": "Llifyn Brown",
	"item.minecraft.brown_egg": "Ŵy Brown",
	"item.minecraft.brown_harness": "Harnais Brown",
	"item.minecraft.brush": "Brwsh",
	"item.minecraft.bucket": "Bwced",
	"item.minecraft.bundle": "Bwndel",
	"item.minecraft.bundle.empty": "Gwag",
	"item.minecraft.bundle.empty.description": "Yn gallu dal pentwr cymysg o eitemau",
	"item.minecraft.bundle.full": "Llawn",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "Darn Crochenwaith Llosgi",
	"item.minecraft.burn_pottery_sherd": "Darn Crochenwaith Llosgi",
	"item.minecraft.camel_husk_spawn_egg": "Wy Geni Cibyn Camel",
	...
	"item.minecraft.chest_minecart": "Cart Pwll â Chist",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Addurn Arfwisg Arfordir",
	...
	"item.minecraft.copper_axe": "Bwyell Copr",
	"item.minecraft.copper_boots": "Esgidiau Copr",
	"item.minecraft.copper_chestplate": "Dwyfronneg Copr",
	"item.minecraft.copper_golem_spawn_egg": "Wy Geni Golem Copr",
	"item.minecraft.copper_helmet": "Helmed Copr",
	"item.minecraft.copper_hoe": "Hof Copr",
	"item.minecraft.copper_horse_armor": "Arfwisg Ceffyl Copr",
	"item.minecraft.copper_ingot": "Bar Copr",
	"item.minecraft.copper_leggings": "Legins Copr",
	"item.minecraft.copper_nautilus_armor": "Arfwisg Nawtilws Copr",
	"item.minecraft.copper_nugget": "Clap Copr",
	"item.minecraft.copper_pickaxe": "Caib Copr",
	"item.minecraft.copper_shovel": "Rhaw Copr",
	"item.minecraft.copper_spear": "Picell Gopr",
	"item.minecraft.copper_sword": "Cleddyf Copr",
	"item.minecraft.cow_spawn_egg": "Wy Geni Buwch",
	"item.minecraft.creaking_spawn_egg": "Wy Geni Gwich",
	"item.minecraft.creeper_banner_pattern": "Patrwm Baner",
	"item.minecraft.creeper_banner_pattern.desc": "Luws Creeper",
	"item.minecraft.creeper_banner_pattern.new": "Patrwm Baner Luws Creeper",
	...
	"item.minecraft.crossbow.projectile.multiple": "Taflegryn: %s x %s",
	"item.minecraft.crossbow.projectile.single": "Taflegryn: %s",
	"item.minecraft.cyan_bundle": "Bwndel Gwyrddlas",
	"item.minecraft.cyan_dye": "Llifyn Gwyrddlas",
	"item.minecraft.cyan_harness": "Harnais Gwyrddlas",
	"item.minecraft.danger_pottery_shard": "Darn Crochenwaith Peryg",
	...
	"item.minecraft.diamond_nautilus_armor": "Arfwisg Nawtilws Diemwnt",
	"item.minecraft.diamond_pickaxe": "Caib Diemwnt",
	"item.minecraft.diamond_shovel": "Rhaw Diemwnt",
	"item.minecraft.diamond_spear": "Picell Ddiemwnt",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Addurn Arfwisg Twyn",
	...
	"item.minecraft.explorer_pottery_shard": "Darn Crochenwaith Anturwr",
	"item.minecraft.explorer_pottery_sherd": "Darn Crochenwaith Anturwr",
	"item.minecraft.eye_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Addurn Arfwisg Llygad",
	"item.minecraft.feather": "Pluen",
	"item.minecraft.fermented_spider_eye": "Llygad Pryf Cop Wedi Eplesu",
	"item.minecraft.field_masoned_banner_pattern": "Patrwm Baner Maes Saernïwyd",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Addurn Arfwisg Llif",
	"item.minecraft.flow_banner_pattern": "Patrwm Baner",
	"item.minecraft.flow_banner_pattern.desc": "Llif",
	"item.minecraft.flow_banner_pattern.new": "Patrwm Baner Llif",
	"item.minecraft.flow_pottery_sherd": "Darn Crochenwaith Llif",
	"item.minecraft.flower_banner_pattern": "Patrwm Baner",
	"item.minecraft.flower_banner_pattern.desc": "Luws Blodyn",
	"item.minecraft.flower_banner_pattern.new": "Patrwm Baner Luws Blodyn",
	"item.minecraft.flower_pot": "Pot Blodau",
	"item.minecraft.fox_spawn_egg": "Wy Geni Llwynog",
	"item.minecraft.friend_pottery_shard": "Darn Crochenwaith Ffrind",
	...
	"item.minecraft.globe_banner_pattern.new": "Patrwm Baner Glôb",
	...
	"item.minecraft.golden_nautilus_armor": "Arfwisg Nawtilws Aur",
	"item.minecraft.golden_pickaxe": "Caib Aur",
	"item.minecraft.golden_shovel": "Rhaw Aur",
	"item.minecraft.golden_spear": "Picell Aur",
	"item.minecraft.golden_sword": "Cleddyf Aur",
	"item.minecraft.gray_bundle": "Bwndel Llwyd",
	"item.minecraft.gray_dye": "Llifyn Llwyd",
	"item.minecraft.gray_harness": "Harnais Llwyd",
	"item.minecraft.green_bundle": "Bwndel Gwyrdd",
	"item.minecraft.green_dye": "Llifyn Gwyrdd",
	"item.minecraft.green_harness": "Harnais Gwyrdd",
	"item.minecraft.guardian_spawn_egg": "Wy Geni Gwarchodwr",
	"item.minecraft.gunpowder": "Powdr Gwn",
	"item.minecraft.guster_banner_pattern": "Patrwm Baner",
	"item.minecraft.guster_banner_pattern.desc": "Hwrdd",
	"item.minecraft.guster_banner_pattern.new": "Patrwm Baner Hwrdd",
	"item.minecraft.guster_pottery_sherd": "Darn Crochenwaith Hwrdd",
	"item.minecraft.happy_ghast_spawn_egg": "Wy Geni Ghast Hapus",
	"item.minecraft.harness": "Harnais",
	"item.minecraft.heart_of_the_sea": "Calon y Môr",
	"item.minecraft.heart_pottery_shard": "Darn Crochenwaith Calon",
	"item.minecraft.heart_pottery_sherd": "Darn Crochenwaith Calon",
	"item.minecraft.heartbreak_pottery_shard": "Darn Crochenwaith Torcalon",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.host_armor_trim_smithing_template.new": "Addurn Arfwisg Lletywr",
	"item.minecraft.howl_pottery_shard": "Darn Crochenwaith Blaidd",
	...
	"item.minecraft.light_blue_bundle": "Bwndel Glas Golau",
	"item.minecraft.light_blue_dye": "Llifyn Glas Golau",
	"item.minecraft.light_blue_harness": "Harnais Glas Golau",
	"item.minecraft.light_gray_bundle": "Bwndel Llwyd Golau",
	"item.minecraft.light_gray_dye": "Llifyn Llwyd Golau",
	"item.minecraft.light_gray_harness": "Harnais Llwyd Golau",
	"item.minecraft.lime_bundle": "Bwndel Leim",
	"item.minecraft.lime_dye": "Llifyn Leim",
	"item.minecraft.lime_harness": "Harnais Leim",
	...
	"item.minecraft.lingering_potion.effect.infested": "Diod Pla Parhaus",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Diod Lleidiog Parhaus",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Diod Gwau Parhaus",
	"item.minecraft.lingering_potion.effect.wind_charged": "Diod Hyrddiad Gwynt Parhaus",
	"item.minecraft.llama_spawn_egg": "Wy Gemi Lama",
	"item.minecraft.lodestone_compass": "Cwmpawd Tynfaen",
	"item.minecraft.mace": "Pastwn",
	"item.minecraft.magenta_bundle": "Bwndel Majenta",
	"item.minecraft.magenta_dye": "Llifyn Majenta",
	"item.minecraft.magenta_harness": "Harnais Majenta",
	...
	"item.minecraft.miner_pottery_shard": "Darn Crochenwaith Cloddio",
	...
	"item.minecraft.mojang_banner_pattern.new": "Patrwm Baner Peth",
	"item.minecraft.mooshroom_spawn_egg": "Wy Geni Mooshroom",
	"item.minecraft.mourner_pottery_shard": "Darn Crochenwaith Galaru",
	...
	"item.minecraft.music_disc_creator": "Disg Cerddoriaeth",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Disg Cerddoriaeth",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Creator (Bocs Cerddoriaeth)",
	"item.minecraft.music_disc_far": "Disg Cerddoriaeth",
	"item.minecraft.music_disc_far.desc": "C418 - far",
	"item.minecraft.music_disc_lava_chicken": "Disg Cerddoriaeth",
	...
	"item.minecraft.music_disc_precipice": "Disg Cerddoriaeth",
	...
	"item.minecraft.music_disc_tears": "Disg Cerddoriaeth",
	...
	"item.minecraft.nautilus_spawn_egg": "Wy Geni Nawtilws",
	...
	"item.minecraft.netherite_horse_armor": "Arfwisg Ceffyl Netherit",
	"item.minecraft.netherite_ingot": "Bar Netherit",
	"item.minecraft.netherite_leggings": "Legins Netherit",
	"item.minecraft.netherite_nautilus_armor": "Arfwisg Nawtilws Netherit",
	...
	"item.minecraft.netherite_spear": "Picell Netherit",
	"item.minecraft.netherite_sword": "Cleddyf Netherit",
	"item.minecraft.netherite_upgrade_smithing_template": "Templed Gof",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Uwchraddiad Netherit",
	...
	"item.minecraft.ominous_bottle": "Potel Ddrwgargoelus",
	"item.minecraft.ominous_trial_key": "Allwedd Treial Ddrwgargoelus",
	"item.minecraft.orange_bundle": "Bwndel Oren",
	"item.minecraft.orange_dye": "Llifyn Oren",
	"item.minecraft.orange_harness": "Harnais Oren",
	"item.minecraft.painting": "Llun",
	"item.minecraft.pale_oak_boat": "Cwch Derw Llwyd",
	"item.minecraft.pale_oak_chest_boat": "Cwch Derw Llwyd â Chist",
	"item.minecraft.panda_spawn_egg": "Wy Geni Panda",
	"item.minecraft.paper": "Papur",
	"item.minecraft.parched_spawn_egg": "Wy Geni Sychedig",
	...
	"item.minecraft.piglin_banner_pattern.new": "Patrwm Baner Trwyn",
	...
	"item.minecraft.pink_bundle": "Bwndel Pinc",
	"item.minecraft.pink_dye": "Llifyn Pinc",
	"item.minecraft.pink_harness": "Harnais Pinc",
	"item.minecraft.pitcher_plant": "Piserlys",
	"item.minecraft.pitcher_pod": "Pod Piserlys",
	"item.minecraft.plenty_pottery_shard": "Darn Crochenwaith Digonedd",
	...
	"item.minecraft.potion.effect.infested": "Diod Pla",
	...
	"item.minecraft.potion.effect.oozing": "Diod Lleidiog",
	...
	"item.minecraft.potion.effect.weaving": "Diod Gwau",
	"item.minecraft.potion.effect.wind_charged": "Diod Hyrddiad Gwynt",
	"item.minecraft.pottery_shard_archer": "Darn Crochenwaith Saethwr",
	"item.minecraft.pottery_shard_arms_up": "Darn Crochenwaith Breichiau",
	"item.minecraft.pottery_shard_prize": "Darn Crochenwaith Gwobr",
	"item.minecraft.pottery_shard_skull": "Darn Crochenwaith Penglog",
	...
	"item.minecraft.prize_pottery_shard": "Darn Crochenwaith Gwobr",
	...
	"item.minecraft.purple_bundle": "Bwndel Porffor",
	"item.minecraft.purple_dye": "Llifyn Porffor",
	"item.minecraft.purple_harness": "Harnais Porffor",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Addurn Arfwisg Codwr",
	...
	"item.minecraft.red_bundle": "Bwndel Coch",
	"item.minecraft.red_dye": "Llifyn Coch",
	"item.minecraft.red_harness": "Harnais Coch",
	"item.minecraft.redstone": "Llwch Redstone",
	"item.minecraft.resin_brick": "Bric Resin",
	"item.minecraft.resin_clump": "Talp Resin",
	"item.minecraft.rib_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Addurn Arfwisg Asen",
	...
	"item.minecraft.scrape_pottery_sherd": "Darn Crochenwaith Crafu",
	"item.minecraft.scute": "Sgwtela",
	"item.minecraft.sentry_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Addurn Arfwisg Gwyliwr",
	"item.minecraft.shaper_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Addurn Arfwisg Siapiwr",
	"item.minecraft.sheaf_pottery_shard": "Darn Crochenwaith Ysgub",
	...
	"item.minecraft.shelter_pottery_shard": "Darn Crochenwaith Cysgod",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Addurn Arfwisg Tawelwch",
	...
	"item.minecraft.skull_banner_pattern.new": "Patrwm Baner Luws Penglog",
	"item.minecraft.skull_pottery_shard": "Darn Crochenwaith Penglog",
	...
	"item.minecraft.smithing_template.armor_trim.additions_slot_description": "Ychwanegu bar neu grisial",
	"item.minecraft.smithing_template.armor_trim.applies_to": "Arfwisg",
	"item.minecraft.smithing_template.armor_trim.base_slot_description": "Ychwanegu ddarn o arfwisg",
	...
	"item.minecraft.snort_pottery_shard": "Darn Crochenwaith Trwyn",
	"item.minecraft.snort_pottery_sherd": "Darn Crochenwaith Trwyn",
	"item.minecraft.snout_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Addurn Arfwisg Trwyn",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Addurn Arfwisg Tŵr",
	...
	"item.minecraft.splash_potion.effect.infested": "Diod Sblash o Bla",
	...
	"item.minecraft.splash_potion.effect.oozing": "Diod Sblash Lleidiog",
	...
	"item.minecraft.splash_potion.effect.weaving": "Diod Sblash Gwau",
	"item.minecraft.splash_potion.effect.wind_charged": "Diod Sblash Hyrddiad Gwynt",
	...
	"item.minecraft.stone_spear": "Picell Garreg",
	...
	"item.minecraft.sulfur_cube_bucket": "Bwced o Ciwb Sylffwr",
	"item.minecraft.sulfur_cube_spawn_egg": "Wy Geni Ciwb Sylffwr",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Addurn Arfwisg Llanw",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Saeth Pla",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Saeth Lleidiog",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Saeth Gwau",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Saeth Hyrddiad Gwynt",
	...
	"item.minecraft.trial_key": "Allwedd Treial",
	...
	"item.minecraft.turtle_scute": "Sgwtela Crwban",
	"item.minecraft.turtle_spawn_egg": "Wy Geni Crwban y Môr",
	"item.minecraft.vex_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Addurn Arfwisg Aflonyddwr",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Addurn Arfwisg Wart",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Addurn Arfwisg Cyfeiriadu",
	"item.minecraft.wheat": "Gwenith",
	"item.minecraft.wheat_seeds": "Hadau Gwenith",
	"item.minecraft.white_bundle": "Bwndel Gwyn",
	"item.minecraft.white_dye": "Llifyn Gwyn",
	"item.minecraft.white_harness": "Harnais Gwyn",
	"item.minecraft.wild_armor_trim_smithing_template": "Templed Gof",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Addurn Arfwisg Gwyllt",
	"item.minecraft.wind_charge": "Hyrddiad Gwynt",
	...
	"item.minecraft.wolf_armor": "Arfwisg Blaidd",
	...
	"item.minecraft.wooden_spear": "Picell Bren",
	...
	"item.minecraft.yellow_bundle": "Bwndel Melyn",
	"item.minecraft.yellow_dye": "Llifyn Melyn",
	"item.minecraft.yellow_harness": "Harnais Melyn",
	"item.minecraft.zoglin_spawn_egg": "Wy Geni Zoglin",
	"item.minecraft.zombie_horse_spawn_egg": "Wy Geni Ceffyl Sombi",
	"item.minecraft.zombie_nautilus_spawn_egg": "Wy Geni Nawtilws Sombi",
	...
	"item.modifiers.any": "Wrth ddefnyddio:",
	"item.modifiers.armor": "Wrth wisgo:",
	"item.modifiers.body": "Wrth wisgo:",
	"item.modifiers.chest": "Pan ar y Corff:",
	"item.modifiers.feet": "Pan ar y Traed:",
	"item.modifiers.hand": "Wrth ddal:",
	...
	"item.modifiers.saddle": "Ar y cyfrwy:",
	"item.nbt_tags": "NBT: %s tag",
	"item.op_block_warning.line1": "Rhybudd:",
	"item.op_block_warning.line2": "Gall defnyddio'r eitem hon arwain at weithredu gorchymyn",
	"item.op_block_warning.line3": "Peidiwch â defnyddio oni bai eich bod yn gwybod yr union gynnwys!",
	"item.spawn_egg.peaceful": "Analluogwyd ym Modd Heddychlon",
	...
	"itemGroup.consumables": "Nwyddau Traul",
	...
	"jigsaw_block.placement_priority": "Blaenoriaeth Gosod:",
	"jigsaw_block.placement_priority.tooltip": "Pan fydd y bloc Jig-so hwn yn cysylltu â darn, dyma'r drefn y caiff y darn hwnnw ei brosesu ar gyfer cysylltiadau yn y strwythur ehangach.\n\nBydd darnau'n cael eu prosesu mewn blaenoriaeth ddisgynnol gyda chysylltiadau torri trefn mewnosod.",
	"jigsaw_block.pool": "Cronfa Darged:",
	"jigsaw_block.selection_priority": "Blaenoriaeth Dewis:",
	"jigsaw_block.selection_priority.tooltip": "Pan fydd y darn rhiant yn cael ei brosesu ar gyfer cysylltiadau, dyma'r drefn y mae'r bloc Jig-so hwn yn ceisio cysylltu â'i ddarn targed.\n\nBydd jig-sos yn cael eu prosesu mewn blaenoriaeth ddisgynnol gyda chlymau archebu ar hap yn torri.",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine - Creator (Bocs Cerddoriaeth)",
	...
	"key.categories.spectator": "Gwyliwr",
	"key.categories.ui": "Rhyngwyneb Gêm",
	"key.category.minecraft.creative": "Modd Creadigol",
	"key.category.minecraft.debug": "Dadfygio",
	"key.category.minecraft.gameplay": "Chwarae'r Gêm",
	"key.category.minecraft.inventory": "Rhestr Eiddo",
	"key.category.minecraft.misc": "Amrywiol",
	"key.category.minecraft.movement": "Symud",
	"key.category.minecraft.multiplayer": "Aml-Chwaraewr",
	"key.category.minecraft.spectator": "Gwyliwr",
	"key.chat": "Agor Sgwrs",
	"key.command": "Agor Gorchymyn",
	"key.debug.clearChat": "Clirio Sgwrs",
	"key.debug.copyLocation": "Copïo Lleoliad",
	"key.debug.copyRecreateCommand": "Copïo Data",
	"key.debug.crash": "Chwalu Dadfygio",
	"key.debug.debugOptions": "Opsiynau Dadfygio",
	"key.debug.dumpDynamicTextures": "Dump Dynamic Textures",
	"key.debug.dumpVersion": "Anfon Gwybodaeth Fersiwn",
	"key.debug.focusPause": "Toggle Lost Focus Pause",
	"key.debug.fpsCharts": "Siartiau FPS",
	"key.debug.lightmapTexture": "Gwead Lightmap",
	"key.debug.modifier": "Debug Modifier Key",
	"key.debug.networkCharts": "Siartiau Rhwydwaith",
	"key.debug.overlay": "Toglo Troshaen",
	"key.debug.profiling": "Dechrau/Stopio Proffilio",
	"key.debug.profilingChart": "Siart Proffilio",
	"key.debug.reloadChunk": "Adnewyddu Talpiau",
	"key.debug.reloadResourcePacks": "Ail-lwytho pecynnau adnodd",
	"key.debug.showAdvancedTooltips": "Dangos Esboniadau Uwch",
	"key.debug.showChunkBorders": "Dangos Terfynau Talp",
	"key.debug.showHitboxes": "Dangos Blychau Taro",
	"key.debug.spectate": "Cylchdroi Gwyliwr",
	"key.debug.switchGameMode": "Newidiwr Modd Gêm",
	...
	"key.quickActions": "Gweithredoedd Cyflym",
	...
	"known_server_link.announcements": "Cyhoeddiadau",
	"known_server_link.community": "Cymuned",
	"known_server_link.community_guidelines": "Canllawiau'r Gymuned",
	"known_server_link.feedback": "Adborth",
	"known_server_link.forums": "Fforymau",
	"known_server_link.news": "Newyddion",
	"known_server_link.report_bug": "Adrodd Gwall Gweinydd",
	"known_server_link.status": "Statws",
	"known_server_link.support": "Cefnogaeth",
	"known_server_link.website": "Gwefan",
	...
	"lanServer.scanning": "Wrthi'n sganio ar gyfer gemau ar eich rhwydwaith lleol",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Ychwanegu Gweinydd",
	"manageServer.edit.title": "Golygu Manylion Gweinydd",
	"manageServer.enterIp": "Cyfeiriad Gweinydd",
	"manageServer.enterName": "Enw Gweinydd",
	"manageServer.resourcePack": "Pecynnau Adnodd Gweinydd",
	"manageServer.resourcePack.disabled": "Analluogwyd",
	"manageServer.resourcePack.enabled": "Galluogwyd",
	"manageServer.resourcePack.prompt": "Gofyn",
	"mco.account.privacy.info": "Darllenwch mwy am Mojang a deddfau prifatrwydd",
	"mco.account.privacy.info.button": "Dysgu mwy am GDPR",
	"mco.account.privacy.information": "Mae Mojang yn gweithredu rhai gweithdrefnau i helpu i amddiffyn plant a'u preifatrwydd gan gynnwys cydymffurfio â'r Children’s Online Privacy Protection Act (COPPA) a'r Rheoliad Cyffredinol ar Ddiogelu Data (GDPR).\n\nMae'n bosib bydd angen i chi gael caniatâd rhiant cyn cael mynediad i'ch cyfrif Realms.",
	...
	"mco.backup.entry": "Copi wrth gefn (%s)",
	"mco.backup.entry.description": "Disgrifiad",
	"mco.backup.entry.enabledPack": "Pecyn wedi'i alluogi",
	"mco.backup.entry.gameDifficulty": "Anhawster y Gêm",
	"mco.backup.entry.gameMode": "Modd y Gêm",
	"mco.backup.entry.gameServerVersion": "Fersiwn Gweinydd y Gêm",
	"mco.backup.entry.name": "Enw",
	"mco.backup.entry.seed": "Hedyn",
	"mco.backup.entry.templateName": "Enw'r Templed",
	"mco.backup.entry.undefined": "Pecyn Anniffiniedig",
	"mco.backup.entry.uploaded": "Uwchlwythwyd",
	"mco.backup.entry.worldType": "Math Byd",
	"mco.backup.entry.worldType.adventureMap": "Map Antur",
	"mco.backup.entry.worldType.experience": "Profiad",
	"mco.backup.entry.worldType.inspiration": "Ysbrydoliaeth",
	"mco.backup.entry.worldType.minigame": "Gêm fer",
	"mco.backup.entry.worldType.normal": "Arferol",
	"mco.backup.entry.worldType.unknown": "Anhysbys",
	"mco.backup.generate.world": "Generadu'r byd",
	"mco.backup.info.title": "Newidiadau ers y copi wrth gefn diwethaf",
	"mco.backup.narration": "Copi wrth gefn o %s",
	"mco.backup.nobackups": "Nid oes copïau wrth gefn or Realm hwn ar hyn o bryd.",
	"mco.backup.restoring": "Yn adfer eich Realm",
	"mco.backup.unknown": "ANHYSBYS",
	"mco.brokenworld.download": "Lawrlwytho",
	"mco.brokenworld.downloaded": "Lawrlwythwyd",
	"mco.brokenworld.message.line1": "Ailosodwch neu dewiswch byd arall.",
	...
	"mco.client.outdated.stable.version": "Nid yw eich fersiwn cleient (%s) yn gydnaws â Realms.\n\nDefnyddiwch fersiwn diweddaraf Minecraft os gwelwch yn dda.",
	"mco.client.unsupported.snapshot.version": "Nid yw eich fersiwn cleient (%s) yn gydnaws â Realms.\n\nNid yw Realms ar gael yn y fersiwn ciplun hwn.",
	"mco.compatibility.downgrade": "Israddio",
	"mco.compatibility.downgrade.description": "Chwaraewyd y byd hwn ddiwethaf yn fersiwn %s; rydych chi ar fersiwn %s. Gallai israddio byd achosi llygredd - ni allwn warantu y bydd yn llwytho nac yn gweithio. \n\nBydd copi o'ch byd ar gael o dan y ffolder \"Copïau wrth gefn\". Adferwch eich byd os oes angen.",
	"mco.compatibility.incompatible.popup.title": "Fersiwn anghydnaws",
	"mco.compatibility.incompatible.releaseType.popup.message": "Mae'r byd rydych chi'n ceisio ymuno ag ef yn anghydnaws â'r fersiwn rydych chi arno.",
	"mco.compatibility.incompatible.series.popup.message": "Chwaraewyd y byd hwn ddiwethaf yn fersiwn %s; rydych ar fersiwn %s.",
	"mco.compatibility.unverifiable.message": "Ni ellir gwirio'r fersiwn y chwaraewyd y byd hwn ddiwethaf. Os bydd y byd yn cael ei uwchraddio neu ei israddio, bydd copi wrth gefn yn cael ei greu a'i gadw yn awtomatig o dan \"Copïau wrth gefn\".",
	"mco.compatibility.unverifiable.title": "Cydnawsedd nad yw'n wiriadwy",
	"mco.compatibility.upgrade": "Uwchraddio",
	"mco.compatibility.upgrade.description": "Fe'i chwaraewyd ddiwethaf yn fersiwn %s; rydych chi ar fersiwn %s.\n\nBydd copi wrth gefn o'ch byd yn cael ei gadw o dan \"Copïau wrth gefn\". Ceisiwch adfer eich byd os oes angen.",
	"mco.compatibility.upgrade.friend.description": "Fe'i chwaraewyd y byd hwn ddiwethaf yn fersiwn %s; rydych chi ar fersiwn %s.\n\nBydd copi wrth gefn o'r byd yn cael ei gadw o dan \"Copïau Wrth Gefn\". Gall percehnnog y Realm adfer y byd os oes angen.",
	"mco.compatibility.upgrade.title": "Ydych chi wir am uwchraddio eich byd?",
	...
	"mco.configure.world.buttons.invite": "Gwahodd chwaraewr",
	"mco.configure.world.buttons.moreoptions": "Mwy o ddewisiadau",
	"mco.configure.world.buttons.newworld": "Byd Newydd",
	...
	"mco.configure.world.buttons.region_preference": "Dewis Rhanbarth...",
	"mco.configure.world.buttons.resetworld": "Ailosod y byd",
	"mco.configure.world.buttons.save": "Cadw",
	...
	"mco.configure.world.close.question.title": "Ydych chi angen gwneud newidiadau heb darfu arnoch?",
	...
	"mco.configure.world.invited.number": "Gwahoddwyd (%s)",
	...
	"mco.configure.world.loading": "Llwytho'r Realm",
	"mco.configure.world.location": "Lleoliad",
	"mco.configure.world.minigame": "Cyfredol: %s",
	...
	"mco.configure.world.players.invite.duplicate": "Mae chwaraewr â'r enw a roddwyd eisoes wedi cael ei wahodd i'r Realm",
	"mco.configure.world.players.inviting": "Wrthi'n gwahodd chwaraewr...",
	"mco.configure.world.players.title": "Chwaraewyr",
	"mco.configure.world.pvp": "PVP",
	"mco.configure.world.region_preference": "Dewisiad Rhanbarth",
	"mco.configure.world.region_preference.title": "Dewis Rhanbarth",
	...
	"mco.configure.world.resourcepack.question": "Mae angen pecyn adnoddau wedi'i deilwra arnoch i chwarae ar y deyrnas hon\n\nYdych chi am ei lawrlwytho a'i chwarae?",
	...
	"mco.configure.world.settings.expired": "Ni allwch newid gosodiadau Realm wedi'i ddarfod",
	...
	"mco.configure.world.subscription.remaining.days": "%[1]s diwrnod",
	"mco.configure.world.subscription.remaining.months": "%[1]s mis",
	"mco.configure.world.subscription.remaining.months.days": "%[1]s mis, %[2]s diwrnod",
	"mco.configure.world.subscription.start": "Dyddiad cychwyn",
	"mco.configure.world.subscription.tab": "Tanysgrifiad",
	...
	"mco.configure.world.switch.slot.subtitle": "Mae'r byd yma'n wag, dewiswch sut i greu eich byd",
	"mco.configure.world.title": "Cyflunio teyrnas:",
	"mco.configure.world.uninvite.player": "Ydych chi wir eisiau dadwahodd '%s'?",
	...
	"mco.download.confirmation.oversized": "Mae'r byd rydych chi'n mynd i'w lawrlwytho yn fwy na %s\n\nNi fyddwch yn gallu uwchlwytho'r byd hwn i'ch tiriogaeth eto",
	...
	"mco.download.speed.narration": "%s/e",
	...
	"mco.errorMessage.6005": "Byd dan glo",
	"mco.errorMessage.6006": "Mae'r byd wedi dyddio",
	"mco.errorMessage.6007": "Defnyddiwr mewn gormod o Realms",
	"mco.errorMessage.6008": "Enw Realm annilys",
	"mco.errorMessage.6009": "Disgrifiad Realm annilys",
	"mco.errorMessage.connectionFailure": "Digwyddodd gwall, rhowch gynnig arall arni yn nes ymlaen.",
	"mco.errorMessage.generic": "Digwyddodd gwall: ",
	"mco.errorMessage.initialize.failed": "Methwyd cychwyn Realm",
	"mco.errorMessage.noDetails": "Ni ddarparwyd manylion gwall",
	"mco.errorMessage.realmsService": "Digwyddodd gwall (%s):",
	"mco.errorMessage.realmsService.configurationError": "Digwyddwyd gwall annisgwyl tra newid dewisiadau'r byd",
	"mco.errorMessage.realmsService.connectivity": "Methu cysylltu â Realms: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Methu gwirio fersiwn cydweddol, cafwyd: %s",
	"mco.errorMessage.retry": "Rhoi cynnig arall arni",
	...
	"mco.gui.ok": "Iawn",
	"mco.info": "Gwybodaeth!",
	"mco.invited.player.narration": "Wedi gwahodd chwaraewr %s",
	...
	"mco.minigame.world.noSelection": "Dewiswch os gwelwch yn dda",
	...
	"mco.notification.transferSubscription.buttonText": "Trosglwyddo Nawr",
	"mco.notification.transferSubscription.message": "Mae tanysgrifiadau Realms Java yn symud i'r Microsoft Store. Peidiwch â gadael i'ch tanysgrifiad ddod i ben!\nTrosglwyddwch nawr a chael 30 diwrnod o Realms am ddim.\nEwch i Profile ar minecraft.net i drosglwyddo'ch tanysgrifiad.",
	"mco.notification.visitUrl.buttonText.default": "Agor dolen",
	"mco.notification.visitUrl.message.default": "Agorwch y ddolen isod",
	"mco.onlinePlayers": "Chwaraewyr ar-lein",
	"mco.play.button.realm.closed": "Realm ar gau",
	"mco.question": "Cwestiwn",
	...
	"mco.selectServer.create.subtitle": "Dewiswch pa fyd i roi ar eich Realm newydd",
	...
	"mco.selectServer.loading": "Wrthi'n llwytho rhestr Realms",
	"mco.selectServer.mapOnlySupportedForVersion": "Ni chefnogir y map hwn yn %s",
	"mco.selectServer.minigame": "Gem fer:",
	"mco.selectServer.minigameName": "Gêm fer: %s",
	"mco.selectServer.minigameNotSupportedInVersion": "Does dim modd chwarae y gêm fer hwn yn %s",
	"mco.selectServer.noRealms": "Mae'n ymddangos nad oes gennych chi Realm. Ychwanegwch Realm i chwarae gyda'ch ffrindiau.",
	...
	"mco.snapshot.createSnapshotPopup.text": "Rydych chi ar fin creu Ciplun Realm am ddim a fydd yn cael ei baru â'ch tanysgrifiad Realms taledig. Bydd modd ichi gael mynediad at y Realm Ciplun newydd hwn oni bai bod y tanysgrifiad taledig yn anweithredol. Ni fydd eich Realm taledig yn cael ei effeithio.",
	"mco.snapshot.createSnapshotPopup.title": "Creu Realm Ciplun?",
	"mco.snapshot.creating": "Wrthi'n creu Realm Ciplun...",
	"mco.snapshot.description": "Ynghyd â / ag %s",
	"mco.snapshot.friendsRealm.downgrade": "Rhaid ichi fod ar fersiwn %s i ymuno â'r Realm hwn",
	"mco.snapshot.friendsRealm.upgrade": "Rhaid i %s uwchraddio eu Realm cyn ichi allu chwarae ar y Ciplun hwn",
	"mco.snapshot.paired": "Mae'r Realm Ciplun hwn wedi'i baru â / ag %s",
	"mco.snapshot.parent.tooltip": "Defnyddiwch y fersiwn rhyddhad diweddaraf o Minecraft i chwarae ar y Realm hwn",
	"mco.snapshot.start": "Dechrau Realm Ciplun am ddim",
	"mco.snapshot.subscription.info": "Dyma Realm Ciplun sydd wedi'i baru â'ch tanysgrifiad Realm o'r enw '%s'. Bydd yn parhau i fod yn weithredol yn ystod cyfnod tanysgrifio ei Realm.",
	"mco.snapshot.tooltip": "Defnyddiwch Gipluniau Realms i gael cip ar fersiynau Minecraft sydd i ddod, a allai gynnwys nodweddion newydd a newidiadau eraill.\n\nGallwch chi ddod o hyd i'ch Realms arferol mewn fersiynau rhyddhad o'r gêm.",
	"mco.snapshotRealmsPopup.message": "Mae Realms bellach ar gael yng Nghipluniau yn dechrau gyda Chiplun 23w41a. Mae pob tanysgrifiad Realms yn dod â Realm Ciplun am ddim sydd ar wahân i'ch Java Realm arferol!",
	"mco.snapshotRealmsPopup.title": "Mae Realms bellach ar gael mewn Cipluniau",
	"mco.snapshotRealmsPopup.urlText": "Dysgu mwy",
	...
	"mco.time.daysAgo": "%[1]s diwrnod yn ôl",
	"mco.time.hoursAgo": "%[1]s awr yn ôl",
	"mco.time.minutesAgo": "%[1]s munud yn ôl",
	"mco.time.now": "nawr",
	"mco.time.secondsAgo": "%[1]s eiliad yn ôl",
	...
	"mco.upload.close.failure": "Methu cau eich Realm, rhowch gynnig arall arni nes ymlaen",
	...
	"mco.upload.failed.too_big.description": "Mae'r byd a ddewiswyd yn rhy fawr. Caniateir nifer uchafswm o %s.",
	"mco.upload.failed.too_big.title": "Mae'r byd yn rhy fawr",
	...
	"mco.upload.select.world.subtitle": "Dewiswch byd chwaraewr sengl i'w uwchlwytho",
	...
	"mco.version": "Fersiwn: %s",
	"mco.warning": "Rhybudd!",
	"mco.worldSlot.minigame": "Gêm fer",
	"menu.custom_options": "Dewisiadau Addasu...",
	"menu.custom_options.title": "Dewisiadau Addasu",
	"menu.custom_options.tooltip": "Nodyn: Darperir dewisiadau addasu gan weinyddion a/neu chynnwys trydydd-parti. Gofalwch!",
	"menu.custom_screen_info.button_narration": "Sgrin addasu yw hon. Dysgu mwy.",
	"menu.custom_screen_info.contents": "Rheolir cynnwys y sgrin hon gan weinyddion a mapiau trydydd-parti nad ydynt eiddo Mojang Studios neu Microsoft ac nad ydynt yn cael eu gweithredu na'u goruchwylio gan Mojang Studios neu Microsoft.\n\nGofalwch! Byddwch yn ofalus bob amser pan ddilyn dolennau a byth yn rhoi i ffwrdd eich gwybodaeth personol, yn cynnwys manylion mewngofnodi.\n\nOs yw'r sgrin hon yn eich atal rhag chwarae, gallwch datgysylltu o'r gweinydd cyfredol hefyd trwy defnyddio'r botwm isod.",
	"menu.custom_screen_info.disconnect": "Gwrthodwyd sgrin addasu",
	"menu.custom_screen_info.title": "Nodyn am sgriniau addasu",
	"menu.custom_screen_info.tooltip": "Sgrin addasu yw hon. Cliciwch yma i ddysgu mwy.",
	"menu.disconnect": "Datgysylltu",
	"menu.feedback": "Adborth...",
	"menu.feedback.title": "Adborth",
	...
	"menu.quick_actions": "Dewisiadau Addasu...",
	"menu.quick_actions.title": "Dewisiadau Addasu",
	...
	"menu.server_links": "Dolenni Gweinydd...",
	"menu.server_links.title": "Dolenni Gweinydd",
	...
	"multiplayer.codeOfConduct.check": "Peidiwch â hysbysu eto ar gyfer y Cod Ymddygiad hwn",
	"multiplayer.codeOfConduct.title": "Cod Ymddygiad y Gweinydd",
	"multiplayer.confirm_command.parse_errors": "Rydych chi'n ceisio gweithredu gorchymyn anhysbys neu annilys.\nYdych chi'n siŵr?\nGorchymyn: %s",
	"multiplayer.confirm_command.permissions_required": "Rydych chi'n ceisio gweithredu gorchymyn sy'n gofyn caniatâd uwch.\nYdych chi'n siŵr?\nGorchymyn: %s",
	"multiplayer.confirm_command.run_command": "Rhedeg Gorchymyn",
	...
	"multiplayer.confirm_command.suggest_command": "Copïo i'r Sgrîn Sgwrs",
	"multiplayer.confirm_command.title": "Cadarnhau Gweithredu Gorchymyn",
	"multiplayer.disconnect.authservers_down": "Nid yw'r gweinyddion dilysu yn ymateb. Rhowch gynnig arall arni nes ymlaen!",
	"multiplayer.disconnect.bad_chat_index": "Canfuwyd neges sgwrs a gollwyd neu a aildrefnwyd o'r serfiwr",
	...
	"multiplayer.disconnect.banned.reason.default": "Cafodd eich gwahardd gan weithredwr.",
	...
	"multiplayer.disconnect.code_of_conduct": "Mae angen derbyn Cod Ymddygiad y gweinydd",
	...
	"multiplayer.disconnect.transfers_disabled": "Nid yw'r gweinydd hwn yn caniatáu symud",
	...
	"multiplayer.player.list.hp": "%spi",
	...
	"multiplayer.socialInteractions.not_available": "Dim ond ym mydoedd Aml-Chwaraewr mae Ymadweithiau Cymdeithasol ar gael",
	"multiplayer.status.and_more": "... a %s mwy ...",
	"multiplayer.status.anonymous_player": "Chwaraewr Dienw",
	...
	"narration.checkbox.usage.focused.check": "Gwasgwch Enter i roi tic",
	"narration.checkbox.usage.focused.uncheck": "Gwasgwch Enter i glirio tic",
	"narration.checkbox.usage.hovered": "Clic chwith i doglo",
	"narration.checkbox.usage.hovered.check": "Clic chwith i roi tic",
	"narration.checkbox.usage.hovered.uncheck": "Clic chwith i glirio tic",
	...
	"narration.selection.usage": "Gwasgwch fotymau lan a lawr er mwyn symud i gofnod arall",
	"narration.slider.usage.focused": "Gwasgwch fotymau bysellfwrdd chwith a dde i newid gwerth",
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Gwasgwch Enter i ddechrau newid gwerth y llithrydd",
	...
	"narration.suggestion.usage.cycle.fixed": "Pwyswch Tab i fynd i'r awgrym nesaf",
	"narration.suggestion.usage.cycle.hidable": "Pwyswch Tab i fynd i'r awgrym nesaf, neu Escape i adael awgrymiadau",
	"narration.suggestion.usage.fill.fixed": "Pwyswch Tab i ddefnyddio awgrym",
	"narration.suggestion.usage.fill.hidable": "Pwyswch Tab i ddefnyddio awgrym, neu Escape i adael awgrymiadau",
	...
	"narrator.joining": "Wrthi'n ymuno",
	...
	"narrator.select.world_info": "Dewiswyd %s, chwaraewyd diwethaf: %s,%s",
	...
	"optimizeWorld.confirm.proceed": "Creu Copi Wrth Gefn ac Optimeiddio",
	...
	"optimizeWorld.stage.finished.chunks": "Bron â gorffen uwchraddio pob talp...",
	"optimizeWorld.stage.finished.entities": "Bron â gorffen uwchraddio pob endid...",
	"optimizeWorld.stage.finished.poi": "Bron â gorffen uwchraddio pwyntiau o ddiddordeb...",
	"optimizeWorld.stage.upgrading": "Wrthi'n uwchraddio pob talp...",
	"optimizeWorld.stage.upgrading.chunks": "Wrthi'n uwchraddio pob talp...",
	"optimizeWorld.stage.upgrading.entities": "Wrthi'n uwchraddio pob endid...",
	"optimizeWorld.stage.upgrading.poi": "Wrthi'n uwchraddio pwyntiau o ddiddordeb...",
	"optimizeWorld.title": "Optimeiddio Byd '%s'",
	"options.accessibility": "Gosodiadau Mynediad Hwylus...",
	...
	"options.accessibility.high_contrast_block_outline": "Llinellau Bloc Cyferbyniad Uchel",
	"options.accessibility.high_contrast_block_outline.tooltip": "Yn gwella'r cyferbyniad amlinellol y bloc wedi'i dargedu.",
	"options.accessibility.link": "Canllaw Hygyrchedd",
	"options.accessibility.menu_background_blurriness": "Niwl Cefndir Dewislen",
	"options.accessibility.menu_background_blurriness.tooltip": "Newid niwlogrwydd cefndiroedd dewislen",
	"options.accessibility.narrator_hotkey": "Bysell Brys Adroddwr",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Mae hyn yn galluogi toglo'r Adroddwr ymlaen ac i ffwrdd gyda 'Ctrl+B'",
	"options.accessibility.narrator_hotkey.tooltip": "Mae hyn yn galluogi toglo'r adroddwr ymlaen ac i ffwrdd gyda 'Ctrl+B'",
	...
	"options.allowCursorChanges": "Galluogi Newidiadau Cyrchwr",
	...
	"options.chunkFade": "Amser Pylu Talpiau",
	"options.chunkFade.none": "Pylu Talpiau: Dim",
	"options.chunkFade.seconds": "Pylu Talpiau: %s eiliad",
	...
	"options.controls": "Rheolyddion...",
	"options.credits_and_attribution": "Cydnabyddiaeth a Phriodoliad...",
	"options.cutoutLeaves": "Dail Tryloyw",
	"options.cutoutLeaves.tooltip": "Yn eich galluogi i weld drwy fylchau mewn dail. Bydd analluogi hyn yn gwella perfformiad.",
	...
	"options.font": "Gosodiadau Ffont...",
	"options.font.title": "Gosodiadau Ffont",
	...
	"options.graphics.preset": "Rhagosodiad",
	...
	"options.graphicsApi": "API Graffeg",
	"options.graphicsApi.default": "Diofyn",
	"options.graphicsApi.opengl": "Dewis OpenGL",
	"options.graphicsApi.restart": "Rhaid i chi ailddechrau eich gêm i newid yr API graffeg.",
	...
	"options.graphicsApi.vulkan": "Defnyddio Vulkan",
	"options.guiScale": "Graddfa GUI",
	"options.guiScale.auto": "Awtomatig",
	"options.hidden": "Cudd",
	"options.hideLightningFlashes": "Cuddio Fflachiadau Mellt",
	"options.hideLightningFlashes.tooltip": "Yn atal Mellt rhag creu effeithiau fflach ar y wybren. Bydd y Mellt dal yn weladwy.",
	"options.hideMatchedNames": "Cuddio Enwau Cyfatebol",
	"options.hideMatchedNames.tooltip": "Efallai bydd Gweinyddion 3ydd-parti yn anfon negeseuon sgwrs mewn fformat ansafonol.\nWrth alluogi y dewis hwn, fe fydd chwaraewyr cudd yn cael ei cysefeillio yn seiliedig ar enwau anfonwr.",
	"options.hideSplashTexts": "Cuddio Negeseuon Sblash",
	"options.hideSplashTexts.tooltip": "Cuddio'r testun melyn sblash ar y brif sgrîn deitl.",
	"options.improvedTransparency": "Tryloywder Gwell",
	...
	"options.inactivityFpsLimit": "Lleihau FPS tra bod",
	"options.inactivityFpsLimit.afk": "Absennol",
	"options.inactivityFpsLimit.afk.tooltip": "Mae hyn yn cyfyngu'r cyfradd fframiau i 30 pan nad yw'r gêm yn cael unrhyw fewnbwn chwaraewr am fwy na munud. Cyfyngu ymhellach i 10 ar ôl 9 munud arall.",
	"options.inactivityFpsLimit.minimized": "Wedi lleihau",
	"options.inactivityFpsLimit.minimized.tooltip": "Mae hyn yn cyfyngu'r cyfradd ffrâm pan fydd y ffenestr gêm yn cael ei leihau.",
	"options.invertMouse": "Gwrth-droi Llygoden",
	"options.invertMouseX": "Gwrth-droi Llygoden X",
	"options.invertMouseY": "Gwrth-droi Llygoden Y",
	"options.japaneseGlyphVariants": "Amrywiadau Glyffiau Siapaneg",
	"options.japaneseGlyphVariants.tooltip": "Defnyddio amrywiadau o arwyddnodau CJK yn y ffont rhagosodol",
	"options.key.hold": "Dal",
	"options.key.toggle": "Toglo",
	"options.language": "Iaith...",
	"options.language.narration": "Change Language",
	"options.language.title": "Iaith",
	"options.language.tooltip": "Change Language",
	"options.languageAccuracyWarning": "(Efallai ni fydd cyfeithiadau yn 100%% yn gywir)",
	...
	"options.maxAnisotropy": "Hidlo Anisotropic",
	...
	"options.musicToast": "Hysbysiad Cerddoriaeth",
	"options.musicToast.never": "Byth",
	"options.musicToast.never.tooltip": "Ni ddangosir hysbysiad cerddoriaeth.",
	"options.musicToast.pauseMenu": "Dewislen Seibio",
	"options.musicToast.pauseMenu.tooltip": "Caiff hysbysiad cerddoriaeth ei arddangos yn newislen seibio'r gêm tra bod cân yn chwarae.",
	"options.musicToast.pauseMenuAndToast": "Dewislen Seibio a Hysbysiad",
	"options.musicToast.pauseMenuAndToast.tooltip": "Yn dangos hysbysiad pan fydd cân yn chwarae. Bydd yr un hysbysiad yn cael ei ddangos yn gyson yn y ddewislen saib tra bod cân yn chwarae.",
	"options.music_frequency": "Amlder Cerddoriaeth",
	"options.music_frequency.constant": "Cyson",
	"options.music_frequency.default": "Diofyn",
	"options.music_frequency.frequent": "Aml",
	"options.music_frequency.tooltip": "Yn newid pa mor aml mae'r gerddoriaeth yn chwarae tra mewn byd gêm.",
	...
	"options.needsRestart": "Caiff yr opsiwn ei roi ar waith ar ôl ailddechrau.",
	...
	"options.realmsNotifications.tooltip": "Yn nol newyddion a gwahoddiadau Realms yn y sgrin deitl ac yn dangos yr eicon ar y botwm Realms.",
	"options.reducedDebugInfo": "Llai Gwybodaeth Dadfygio",
	"options.renderClouds": "Cymylau",
	"options.renderCloudsDistance": "Pellter Cymylau",
	...
	"options.rotateWithMinecart": "Troi gyda Chartiau Pwll",
	"options.rotateWithMinecart.tooltip": "Os yw'r chwaraewr yn troi yn yr un modd gyda Chart Pwll. Dim ond ar gael mewn bydoedd gyda'r gosodiad arbrofol 'Gwelliannau Cart Pwll' wedi'i droi ymlaen.",
	...
	"options.showNowPlayingToast": "Dangos Hysbysiad Cerddoriaeth",
	"options.showNowPlayingToast.tooltip": "Yn dangos hysbysiad pan fydd cân yn chwarae. Bydd yr un hysbysiad yn cael ei ddangos yn gyson yn y ddewislen saib tra bod cân yn chwarae.",
	"options.showSubtitles": "Dangos Isdeitlau",
	"options.showSubtitles.tooltip": "Galluogi isdeitlau ar gyfer synau sy'n cael eu chwarae yn y gêm.",
	...
	"options.sprintWindow": "Ffenestr Rhedeg",
	...
	"options.telemetry.disabled": "Analluogir casglu data telemetrig.",
	"options.telemetry.state.all": "Popeth",
	"options.telemetry.state.minimal": "Lleiafrif",
	"options.telemetry.state.none": "Dim",
	"options.textureFiltering": "Hidlo Gweadau",
	"options.textureFiltering.anisotropic": "Anisotropig",
	...
	"options.textureFiltering.none": "Dim",
	...
	"options.video.display.header": "Arddangos",
	"options.video.interface.header": "Rhyngwyneb",
	"options.video.preferences.header": "Dewisiadau",
	"options.video.quality.header": "Ansawdd a Pherfformiad",
	"options.videoTitle": "Gosodiadau Fideo",
	"options.viewBobbing": "Siglad Golwg",
	"options.vignette": "Dangos Vignette",
	...
	"pack.dropRejected.message": "Nid yw'r cofnodion canlynol yn becynnau dilys ac felly ni chawsant eu copïo:\n%s",
	"pack.dropRejected.title": "Cofnodion di-becyn",
	...
	"pack.incompatible.confirm.unknown": "Mae'r pecyn yma wedi torri neu wedi'i wneud ar gyfer fersiwn anhysbys o Minecraft ac mae'n bosib na wneith weithio'n gywir gyda'r fersiwn yma.",
	"pack.incompatible.new": "(Ar gyfer fersiwn diweddarach o Minecraft)",
	"pack.incompatible.old": "(Ar gyfer fersiwn hŷn o Minecraft)",
	"pack.incompatible.unknown": "(Wedi'i dorri neu'n anghydnaws)",
	...
	"particle.invalidOptions": "Ni ellir dosrannu opsiynau gronyn: %s",
	...
	"quickplay.error.invalid_identifier": "Methu canfod byd gyda'r dynodydd a roddwyd",
	"quickplay.error.realm_connect": "Methu cysylltu â'r Realm",
	"quickplay.error.realm_permission": "Dim caniatâd i gysylltu â'r Realm hwn",
	"quickplay.error.title": "Methwyd i Chwarae Cyflym",
	"realms.configuration.region.australia_east": "De Cymru Newydd, Awstralia",
	"realms.configuration.region.australia_southeast": "Victoria, Awstralia",
	"realms.configuration.region.brazil_south": "Brasil",
	"realms.configuration.region.central_india": "India",
	"realms.configuration.region.central_us": "Iowa, UDA",
	"realms.configuration.region.east_asia": "Hong Kong",
	"realms.configuration.region.east_us": "Virginia, UDA",
	"realms.configuration.region.east_us_2": "Gogledd Carolina, UDA",
	"realms.configuration.region.france_central": "Ffrainc",
	"realms.configuration.region.japan_east": "Dwyrain Japan",
	"realms.configuration.region.japan_west": "Gorllewin Japan",
	"realms.configuration.region.korea_central": "De Korea",
	"realms.configuration.region.north_central_us": "Illinois, UDA",
	"realms.configuration.region.north_europe": "Iwerddon",
	"realms.configuration.region.south_central_us": "Texas, UDA",
	"realms.configuration.region.southeast_asia": "Singapore",
	"realms.configuration.region.sweden_central": "Sweden",
	"realms.configuration.region.uae_north": "Yr Emiraethau Arabaidd Unedig (UAE)",
	"realms.configuration.region.uk_south": "De Lloegr",
	"realms.configuration.region.west_central_us": "Utah, UDA",
	"realms.configuration.region.west_europe": "Yr Iseldiroedd",
	"realms.configuration.region.west_us": "Califfornia, UDA",
	"realms.configuration.region.west_us_2": "Washington, UDA",
	"realms.configuration.region_preference.automatic_owner": "Awtomatig (ping perchennog y Realm)",
	"realms.configuration.region_preference.automatic_player": "Awtomatig (y cyntaf i ymuno â'r sesiwn)",
	...
	"recipe.toast.description": "Gwiriwch eich ryseitiau",
	"recipe.toast.title": "Ryseitiau Newydd!",
	"record.nowPlaying": "Nawr yn Chwarae: %s",
	"recover_world.bug_tracker": "Adrodd nam",
	"recover_world.button": "Ceisio adfer",
	"recover_world.done.failed": "Methwyd ag adfer o'r cyflwr blaenorol.",
	"recover_world.done.success": "Roedd yr adferiad yn llwyddiannus!",
	"recover_world.done.title": "Adferiad wedi cwblhau",
	"recover_world.issue.missing_file": "Ffeil ar goll",
	"recover_world.issue.none": "Dim gwallau",
	"recover_world.message": "Digwyddodd y gwallau hyn wrth geisio darllen ffolder byd \"%s\".\nEfallai y bydd yn bosibl adfer y byd o gyflwr hŷn neu gallwch riportio'r gwall hwn ar y traciwr bygiau.",
	"recover_world.no_fallback": "Dim cyflwr ar gael ar gyfer adfer",
	"recover_world.restore": "Ceisio adfer",
	"recover_world.restoring": "Wrthi'n ceisio adfer byd...",
	"recover_world.state_entry": "Cyflwr o %s: ",
	"recover_world.state_entry.unknown": "anhysbys",
	"recover_world.title": "Methwyd llwytho byd",
	"recover_world.warning": "Methwyd llwytho crynodeb byd",
	...
	"resourcePack.runtime_failure": "Canfuwyd gwall pecyn adnodd",
	...
	"restrictions_screen.button": "Cyfyngiadau...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Gallwch dderbyn negeseuon gan chwaraewyr",
	"restrictions_screen.permission.receive_player_messages.denied": "Ni allwch dderbyn negeseuon gan chwaraewyr",
	"restrictions_screen.permission.receive_system_messages.allowed": "Gallwch dderbyn negeseuon gan y gweinydd",
	"restrictions_screen.permission.receive_system_messages.denied": "Ni allwch dderbyn negeseuon gan y gweinydd",
	"restrictions_screen.permission.send_commands.allowed": "Cewch anfon gorchmynion",
	"restrictions_screen.permission.send_commands.denied": "Ni chewch anfon gorchmynion",
	"restrictions_screen.permission.send_messages.allowed": "Cewch anfon negeseuon sgwrs",
	"restrictions_screen.permission.send_messages.denied": "Ni chewch anfon negeseuon sgwrs",
	"restrictions_screen.title": "Cyfyngiadau",
	...
	"selectServer.select": "Ymuno â'r Gweinydd",
	...
	"selectWorld.allowCommands.new": "Galluogi Gorchmynion",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Creu copi wrth gefn cyn uwchraddio'r byd hwn?",
	...
	"selectWorld.commands": "Gorchmynion",
	...
	"selectWorld.incompatible.description": "Ni ellir agor y byd hwn yn y fersiwn hon.\nFe'i chwaraewyd ddiwethaf yn fersiwn %s.",
	"selectWorld.incompatible.info": "Fersiwn anghydnaws: %s",
	"selectWorld.incompatible.title": "Fersiwn anghydnaws",
	"selectWorld.incompatible.tooltip": "Ni ellir agor y byd hwn oherwydd ei fod wedi'i greu mewn fersiwn anghydnaws.",
	...
	"selectWorld.loading_list": "Wrthi'n llwytho Rhestr Bydoedd",
	...
	"selectWorld.resource_load": "Wrthi'n paratoi adnoddau...",
	...
	"selectWorld.upgrade_and_play": "Uwchraddio a Chwarae",
	...
	"selectWorld.waitingForBackup.message": "Gan ddibynnu ar faint eich byd, gall hyn gymryd amser. Peidiwch â chau'r gêm na ddiffodd eich dyfais.",
	"selectWorld.waitingForBackup.title": "Wrthi'n creu Copi Wrth Gefn",
	...
	"selectWorld.warning.lowDiskSpace.description": "Nid oes llawer o le ar ôl ar eich dyfais.\nGall rhedeg allan o le ar y ddisg wrth chwarae arwain at ddifrodi eich byd.",
	"selectWorld.warning.lowDiskSpace.title": "Rhybudd! Lle disg isel!",
	"selectWorld.world": "Byd",
	"selectWorld.world_gen_settings_access": "Unable to read or access the world gen settings file! %s",
	"selecteWorld.backupRequiredTooltip": "Mae angen creu copi wrth gefn cyn llwytho'r byd",
	...
	"sleep.skipping_night": "Yn cysgu trwy'r nos",
	"slot.only_single_allowed": "Caniateir slotiau sengl yn unig, cafwyd '%s'",
	"slot.unknown": "Slot anhysbys '%s'",
	"snbt.parser.empty_key": "Ni all yr allwedd fod yn wag",
	"snbt.parser.expected_binary_numeral": "Disgwyliwyd rhif deuaidd",
	"snbt.parser.expected_decimal_numeral": "Disgwyliwyd rhif degol",
	"snbt.parser.expected_float_type": "Disgwyliwyd rhif pwynt symudol",
	"snbt.parser.expected_hex_escape": "Disgwyliwyd llythrennol nod o hyd %s",
	"snbt.parser.expected_hex_numeral": "Disgwyliwyd rhif hecsadegol",
	"snbt.parser.expected_integer_type": "Disgwyliwyd cyfanrif",
	"snbt.parser.expected_non_negative_number": "Disgwyliwyd rhif annegyddol",
	"snbt.parser.expected_number_or_boolean": "Disgwyliwyd rhif neu boole",
	"snbt.parser.expected_string_uuid": "Disgwyliwyd llinyn yn cynrychioli UUID dilys",
	"snbt.parser.expected_unquoted_string": "Disgwyliwyd llinyn heb ddyfynbris dilys",
	"snbt.parser.infinity_not_allowed": "Ni chaniateir rhifau anfeidraidd",
	"snbt.parser.invalid_array_element_type": "Math elfen arae annilys",
	"snbt.parser.invalid_character_name": "Enw nod Unicode annilys",
	"snbt.parser.invalid_codepoint": "Gwerth nod Unicode annilys: %s",
	"snbt.parser.invalid_string_contents": "Cynnwys llinyn annilys",
	"snbt.parser.invalid_unquoted_start": "Ni all llinynnau heb ddyfynbris ddechrau gyda digidau 0-9, + neu -",
	"snbt.parser.leading_zero_not_allowed": "Ni all rhifau degol ddechrau gyda 0",
	"snbt.parser.no_such_operation": "Dim gweithrediad o'r fath: %s",
	"snbt.parser.number_parse_failure": "Methwyd dosrannu'r rhif: %s",
	"snbt.parser.undescore_not_allowed": "Ni chaniateir llinynnau atodnod ar ddechrau na diwedd rhif",
	...
	"spectatorMenu.team_teleport.prompt": "Dewiswch i pa dîm yr hoffech chi delegludo",
	"spectatorMenu.teleport": "Telegludo i Chwaraewr",
	"spectatorMenu.teleport.prompt": "Dewiswch i bwy yr hoffech chi delegludo",
	...
	"stat.minecraft.happy_ghast_one_cm": "Pellter gyda Ghast Hapus",
	...
	"stat.minecraft.nautilus_one_cm": "Pellter ar ben Nawtilws",
	...
	"subtitles.block.candle.extinguish": "Canwyll wedi'i ddiffodd",
	...
	"subtitles.block.copper_bulb.turn_off": "Bwlb Copr yn diffodd",
	"subtitles.block.copper_bulb.turn_on": "Bwlb Copr yn dod ymlaen",
	"subtitles.block.copper_chest.close": "Cist yn cau",
	"subtitles.block.copper_chest.open": "Cist yn agor",
	"subtitles.block.copper_trapdoor.close": "Drws Cudd yn cau",
	"subtitles.block.copper_trapdoor.open": "Drws Cudd yn agor",
	"subtitles.block.crafter.craft": "Crefftiwr wedi saernïo",
	"subtitles.block.crafter.fail": "Crefftiwr wedi methu",
	"subtitles.block.creaking_heart.hurt": "Calon Gwich yn gweiddi",
	"subtitles.block.creaking_heart.idle": "Sŵn iasol",
	"subtitles.block.creaking_heart.spawn": "Calon Gwich yn ysgogi",
	"subtitles.block.deadbush.idle": "Synau sych",
	"subtitles.block.decorated_pot.insert": "Pot Addurnedig yn llenwi",
	"subtitles.block.decorated_pot.insert_fail": "Pot Addurnedig yn siglo",
	...
	"subtitles.block.dried_ghast.ambient": "Ghast Sych yn gwichio",
	"subtitles.block.dried_ghast.ambient_water": "Ghast Sych yn ailhydradu",
	"subtitles.block.dried_ghast.place_in_water": "Ghast Sych yn mwydo",
	"subtitles.block.dried_ghast.transition": "Ghast Sych yn teimlo'n well",
	"subtitles.block.dry_grass.ambient": "Synau gwyntog",
	...
	"subtitles.block.eyeblossom.close": "Llygadflodyn yn cau",
	"subtitles.block.eyeblossom.idle": "Llygadflodyn yn sibrwd",
	"subtitles.block.eyeblossom.open": "Llygadflodyn yn agor",
	...
	"subtitles.block.firefly_bush.idle": "Pryfaid Tân yn suo",
	...
	"subtitles.block.generic.fall": "Rhywbeth yn cwympo ar floc",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Arwydd yn siglo",
	...
	"subtitles.block.pale_hanging_moss.idle": "Sŵn iasol",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Ffynnon sylffwr yn ffrwydro",
	"subtitles.block.potent_sulfur.noxious_gas": "Nwy gwenwynig yn ymddangos",
	...
	"subtitles.block.sand.idle": "Synau tywodlyd",
	"subtitles.block.sand.wind": "Synau gwyntog",
	...
	"subtitles.block.shelf.activate": "Silff yn ysgogi",
	"subtitles.block.shelf.deactivate": "Silff yn diffodd",
	"subtitles.block.shelf.multi_swap": "Eitemau yn cyfnewid",
	"subtitles.block.shelf.place_item": "Eitem wedi'i rhoi",
	"subtitles.block.shelf.single_swap": "Eitem yn cyfnewid",
	"subtitles.block.shelf.take_item": "Eitem wedi'i chymryd",
	...
	"subtitles.block.sponge.absorb": "Sbwng yn sugno",
	"subtitles.block.sweet_berry_bush.pick_berries": "Aeron yn popian",
	"subtitles.block.trapdoor.close": "Drws Cudd yn cau",
	"subtitles.block.trapdoor.open": "Drws Cudd yn agor",
	"subtitles.block.trapdoor.toggle": "Drws Cudd yn crecian",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Eitem ddrwgargoelus yn paratoi",
	"subtitles.block.trial_spawner.ambient": "Sil Treial yn clecian",
	"subtitles.block.trial_spawner.ambient_charged": "Sil Treial Ddrwgargoelus yn clecian",
	"subtitles.block.trial_spawner.ambient_ominous": "Sil Treial Ddrwgargoelus yn craclo",
	"subtitles.block.trial_spawner.charge_activate": "Argoel yn cymryd Sil Treial",
	"subtitles.block.trial_spawner.close_shutter": "Sil Treial yn cau",
	"subtitles.block.trial_spawner.detect_player": "Sil Treial yn gwefrio",
	"subtitles.block.trial_spawner.eject_item": "Sil Treial yn taflu eitemau allan",
	"subtitles.block.trial_spawner.ominous_activate": "Argoel yn cymryd Sil Treial",
	"subtitles.block.trial_spawner.open_shutter": "Sil Treial yn agor",
	"subtitles.block.trial_spawner.spawn_item": "Eitem ddrwgargoelus yn gollwng",
	"subtitles.block.trial_spawner.spawn_item_begin": "Eitem ddrwgargoelus yn ymddangos",
	"subtitles.block.trial_spawner.spawn_mob": "Bwystfil yn silio",
	...
	"subtitles.block.vault.activate": "Cell yn tanio",
	"subtitles.block.vault.ambient": "Cell yn clecian",
	"subtitles.block.vault.close_shutter": "Cell yn cau",
	"subtitles.block.vault.deactivate": "Cell wedi'i diffodd",
	"subtitles.block.vault.eject_item": "Cell yn taflu eitem",
	"subtitles.block.vault.insert_item": "Cell yn datgloi",
	"subtitles.block.vault.insert_item_fail": "Cell yn methu datgloi",
	"subtitles.block.vault.open_shutter": "Cell yn agor",
	"subtitles.block.vault.reject_rewarded_player": "Cell yn gwrthod chwaraewr sydd eisoes wedi'i wobrwyo",
	"subtitles.block.water.ambient": "Dŵr yn llifo",
	"subtitles.block.wet_sponge.dries": "Sbwng yn sychu",
	...
	"subtitles.entity.armadillo.ambient": "Armadilo yn rhochian",
	"subtitles.entity.armadillo.brush": "Armadilo yn brwsio",
	"subtitles.entity.armadillo.death": "Armadilo yn marw",
	"subtitles.entity.armadillo.eat": "Armadilo yn bwyta",
	"subtitles.entity.armadillo.hurt": "Armadilo yn brifo",
	"subtitles.entity.armadillo.hurt_reduced": "Armadilo yn hunanamddifyn",
	"subtitles.entity.armadillo.land": "Armadilo yn glanio",
	"subtitles.entity.armadillo.peek": "Armadilo yn specian",
	"subtitles.entity.armadillo.roll": "Armadilo yn rholio",
	"subtitles.entity.armadillo.scute_drop": "Sgwtela yn gollwng",
	"subtitles.entity.armadillo.unroll_finish": "Armadilo yn dadrolio",
	"subtitles.entity.armadillo.unroll_start": "Armadilo yn specian",
	...
	"subtitles.entity.baby_cat.ambient": "Cath fach yn mewian",
	"subtitles.entity.baby_cat.beg_for_food": "Cath fach yn cardota",
	"subtitles.entity.baby_cat.death": "Cath fach yn marw",
	"subtitles.entity.baby_cat.eat": "Cath fach yn bwyta",
	"subtitles.entity.baby_cat.hiss": "Cath fach yn hisian",
	"subtitles.entity.baby_cat.hurt": "Cath fach yn brifo",
	"subtitles.entity.baby_cat.purr": "Cath fach yn canu grwndi",
	"subtitles.entity.baby_chicken.ambient": "Cyw yn pipian",
	"subtitles.entity.baby_chicken.death": "Cyw yn marw",
	"subtitles.entity.baby_chicken.hurts": "Cyw yn brifo",
	"subtitles.entity.baby_horse.ambient": "Ebol yn gweryru",
	"subtitles.entity.baby_horse.angry": "Ebol yn gweryru",
	"subtitles.entity.baby_horse.breathe": "Ebol yn anadlu",
	"subtitles.entity.baby_horse.death": "Ebol yn marw",
	"subtitles.entity.baby_horse.eat": "Ebol yn bwyta",
	"subtitles.entity.baby_horse.hurt": "Ebol yn brifo",
	"subtitles.entity.baby_horse.land": "Ebol yn glanio",
	"subtitles.entity.baby_nautilus.ambient": "Nawtilws Bach yn grillian",
	"subtitles.entity.baby_nautilus.ambient_land": "Nawtilws Bach yn grillian",
	"subtitles.entity.baby_nautilus.death": "Nawtilws Bach yn marw",
	"subtitles.entity.baby_nautilus.death_land": "Nawtilws Bach yn marw",
	"subtitles.entity.baby_nautilus.eat": "Nawtilws Bach yn bwyta",
	"subtitles.entity.baby_nautilus.hurt": "Nawtilws Bach yn brifo",
	"subtitles.entity.baby_nautilus.hurt_land": "Nawtilws Bach yn brifo",
	"subtitles.entity.baby_nautilus.swim": "Nawtilws Bach yn nofio",
	"subtitles.entity.baby_pig.ambient": "Mochyn Bach yn rochian",
	"subtitles.entity.baby_pig.death": "Mochyn Bach yn marw",
	"subtitles.entity.baby_pig.eat": "Mochyn Bach yn bwyta",
	"subtitles.entity.baby_pig.hurt": "Mochyn Bach yn brifo",
	"subtitles.entity.baby_wolf.ambient": "Ci bach yn clepian",
	"subtitles.entity.baby_wolf.death": "Ci bach yn marw",
	"subtitles.entity.baby_wolf.growl": "Ci bach yn chwyrnu",
	"subtitles.entity.baby_wolf.hurt": "Ci bach yn brifo",
	"subtitles.entity.baby_wolf.pant": "Ci bach yn dyhefod",
	"subtitles.entity.baby_wolf.whine": "Ci bach yn swnian",
	...
	"subtitles.entity.bogged.ambient": "Corslyd yn ratlo",
	"subtitles.entity.bogged.death": "Corslyd yn marw",
	"subtitles.entity.bogged.hurt": "Corslyd yn brifo",
	"subtitles.entity.breeze.charge": "Awel yn rhuthro",
	"subtitles.entity.breeze.death": "Awel yn marw",
	"subtitles.entity.breeze.deflect": "Awel yn gwyro",
	"subtitles.entity.breeze.hurt": "Awel yn brifo",
	"subtitles.entity.breeze.idle_air": "Awel yn hedfan",
	"subtitles.entity.breeze.idle_ground": "Awel yn chwyrndroi",
	"subtitles.entity.breeze.inhale": "Awel yn anadlu",
	"subtitles.entity.breeze.jump": "Awel yn neidio",
	"subtitles.entity.breeze.land": "Awel yn glanio",
	"subtitles.entity.breeze.shoot": "Awel yn saethu",
	"subtitles.entity.breeze.slide": "Awel yn llithro",
	"subtitles.entity.breeze.whirl": "Awel yn chwyrlio",
	"subtitles.entity.breeze.wind_burst": "Hyrddiad gwynt yn ffrwydro",
	...
	"subtitles.entity.camel.saddle": "Cyfrwy wedi'i roi",
	...
	"subtitles.entity.camel_husk.ambient": "Cibyn Camel yn cwyno",
	"subtitles.entity.camel_husk.dash": "Cibyn Camel yn taflu",
	"subtitles.entity.camel_husk.dash_ready": "Cibyn Camel yn adfer",
	"subtitles.entity.camel_husk.death": "Cibyn Camel yn marw",
	"subtitles.entity.camel_husk.eat": "Cibyn Camel yn bwyta",
	"subtitles.entity.camel_husk.hurt": "Cibyn Camel yn brifo",
	"subtitles.entity.camel_husk.saddle": "Cyfrwy wedi'i roi",
	"subtitles.entity.camel_husk.sit": "Cibyn Camel yn eistedd",
	"subtitles.entity.camel_husk.stand": "Cibyn Camel yn sefyll",
	"subtitles.entity.cat.ambient": "Cath yn mewian",
	...
	"subtitles.entity.copper_golem.death": "Golem Copr yn marw",
	"subtitles.entity.copper_golem.hurt": "Golem Copr yn brifo",
	"subtitles.entity.copper_golem.item_drop": "Golem Copr yn gosod eitem",
	"subtitles.entity.copper_golem.item_no_drop": "Golem Copr yn methu gosod eitem",
	"subtitles.entity.copper_golem.no_item_get": "Golem Copr yn casglu eitem",
	"subtitles.entity.copper_golem.no_item_no_get": "Golem Copr yn methu gosod eitem",
	"subtitles.entity.copper_golem.spawn": "Golem Copr yn ymddangos",
	"subtitles.entity.copper_golem.spin": "Pen Golem Copr yn troi",
	"subtitles.entity.copper_golem_become_statue": "Golem Copr yn troi'n gerflun",
	"subtitles.entity.copper_golem_oxidized.death": "Golem Copr yn marw",
	"subtitles.entity.copper_golem_oxidized.hurt": "Golem Copr yn brifo",
	"subtitles.entity.copper_golem_oxidized.spin": "Pen Golem Copr yn troi",
	"subtitles.entity.copper_golem_weathered.death": "Golem Copr yn marw",
	"subtitles.entity.copper_golem_weathered.hurt": "Golem Copr yn brifo",
	"subtitles.entity.copper_golem_weathered.spin": "Pen Golem Copr yn troi",
	...
	"subtitles.entity.creaking.activate": "Gwich yn ysgogi",
	"subtitles.entity.creaking.ambient": "Gwich yn gwichian",
	"subtitles.entity.creaking.attack": "Gwich yn ymosod",
	"subtitles.entity.creaking.deactivate": "Gwich yn diffodd",
	"subtitles.entity.creaking.death": "Gwich yn marw",
	"subtitles.entity.creaking.freeze": "Gwich yn stopio",
	"subtitles.entity.creaking.spawn": "Gwich yn byw",
	"subtitles.entity.creaking.sway": "Gwich yn amddiffyn",
	"subtitles.entity.creaking.twitch": "Gwich yn plycio",
	"subtitles.entity.creaking.unfreeze": "Gwich yn symud",
	...
	"subtitles.entity.donkey.chest": "Cist Asyn wedi'i roi",
	...
	"subtitles.entity.donkey.jump": "Asyn yn neidio",
	...
	"subtitles.entity.fish.swim": "Tasgu",
	...
	"subtitles.entity.generic.wind_burst": "Hyrddiad gwynt yn ffrwydro",
	...
	"subtitles.entity.ghastling.ambient": "Ghastyn yn cŵan",
	"subtitles.entity.ghastling.death": "Ghastyn yn marw",
	"subtitles.entity.ghastling.hurt": "Ghastyn yn brifo",
	"subtitles.entity.ghastling.spawn": "Ghastyn yn diflannu",
	...
	"subtitles.entity.happy_ghast.ambient": "Ghast Hapus yn crwnan",
	"subtitles.entity.happy_ghast.death": "Ghast Hapus yn marw",
	"subtitles.entity.happy_ghast.equip": "Harnais wedi'i roi",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Ghast Hapus yn barod",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Ghast Hapus yn aros",
	"subtitles.entity.happy_ghast.hurt": "Ghast Hapus yn brifo",
	"subtitles.entity.happy_ghast.unequip": "Harnais wedi'i dynny",
	...
	"subtitles.entity.horse.armor": "Arfwisg ceffyl wedi'i roi",
	...
	"subtitles.entity.horse.saddle": "Cyfryw wedi'i roi",
	...
	"subtitles.entity.leash_knot.place": "Cwlwm Tennyn yn cael ei glymu",
	...
	"subtitles.entity.llama.chest": "Cist Lama wedi'i roi",
	...
	"subtitles.entity.minecart.inside": "Cart Pwll yn clincian",
	"subtitles.entity.minecart.inside_underwater": "Cart Pwll yn clincian dan ddŵr",
	...
	"subtitles.entity.mule.chest": "Cist Mul wedi'i roi",
	"subtitles.entity.mule.death": "Mul yn marw",
	"subtitles.entity.mule.eat": "Mul yn bwyta",
	"subtitles.entity.mule.hurt": "Mil yn brifo",
	"subtitles.entity.mule.jump": "Mil yn neidio",
	"subtitles.entity.nautilus.ambient": "Nawtilws yn clecian",
	"subtitles.entity.nautilus.ambient_land": "Nawtilws yn clecian",
	"subtitles.entity.nautilus.dash": "Nawtilws yn gwibio",
	"subtitles.entity.nautilus.dash_land": "Nawtilws yn gwibio",
	"subtitles.entity.nautilus.dash_ready": "Nawtilws yn adfer",
	"subtitles.entity.nautilus.dash_ready_land": "Nawtilws yn adfer",
	"subtitles.entity.nautilus.death": "Nawtilws yn marw",
	"subtitles.entity.nautilus.death_land": "Nawtilws yn marw",
	"subtitles.entity.nautilus.eat": "Nawtilws yn bwyta",
	"subtitles.entity.nautilus.hurt": "Nawtilws yn brifo",
	"subtitles.entity.nautilus.hurt_land": "Nawtilws yn brifo",
	"subtitles.entity.nautilus.swim": "Nawtilws yn nofio",
	...
	"subtitles.entity.parched.ambient": "Sychedig yn craclo",
	"subtitles.entity.parched.death": "Sychedig yn marw",
	"subtitles.entity.parched.hurt": "Sychedig yn brifo",
	...
	"subtitles.entity.parrot.imitate.bogged": "Parot yn ratlo",
	"subtitles.entity.parrot.imitate.breeze": "Parot yn chwyrndroi",
	"subtitles.entity.parrot.imitate.camel_husk": "Parot yn cwyno",
	"subtitles.entity.parrot.imitate.creaking": "Parot yn gwichian",
	...
	"subtitles.entity.parrot.imitate.parched": "Parot yn craclo",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Parot yn griddfan",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Parot yn garglo",
	...
	"subtitles.entity.pig.eat": "Mochyn yn bwyta",
	"subtitles.entity.pig.hurt": "Mochyn yn brifo",
	"subtitles.entity.pig.saddle": "Cyfrwy wedi'i roi",
	...
	"subtitles.entity.player.teleport": "Chwaraewr yn telegludo",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Ceffyl Sgerbwd yn neidio",
	...
	"subtitles.entity.sniffer.egg_crack": "Ŵy Ffroenwr yn cracio",
	"subtitles.entity.sniffer.egg_hatch": "Ŵy Ffroenwr yn deori",
	...
	"subtitles.entity.sulfur_cube.absorb": "Ciwb Sylffwr yn llawn",
	"subtitles.entity.sulfur_cube.bounce": "Ciwb Sylffwr yn bownsio",
	"subtitles.entity.sulfur_cube.death": "Ciwb Sylffwr yn marw",
	"subtitles.entity.sulfur_cube.eject": "Bloc wedi'i dynnu",
	"subtitles.entity.sulfur_cube.hit": "Ciwb Sylffwr wedi'i ergydio",
	"subtitles.entity.sulfur_cube.hurt": "Ciwb Sylffwr yn brifo",
	"subtitles.entity.sulfur_cube.push": "Ciwb Sylffwr wedi'i wthio",
	"subtitles.entity.sulfur_cube.squish": "Ciwb Sylffwr yn bownsio",
	...
	"subtitles.entity.wind_charge.throw": "Hyrddiad gwynt yn hedfan",
	"subtitles.entity.wind_charge.wind_burst": "Hyrddiad gwynt yn ffrwydro",
	...
	"subtitles.entity.wolf.bark": "Blaidd yn cyfarth",
	...
	"subtitles.entity.wolf.pant": "Blaidd yn dyhefod",
	"subtitles.entity.wolf.shake": "Blaidd yn ysgwyd",
	"subtitles.entity.wolf.whine": "Blaidd yn swnian",
	...
	"subtitles.entity.zombie_horse.angry": "Ceffyl Sombi yn gweryru",
	"subtitles.entity.zombie_horse.death": "Ceffyl Sombi yn marw",
	"subtitles.entity.zombie_horse.eat": "Ceffyl Sombi yn bwyta",
	"subtitles.entity.zombie_horse.hurt": "Ceffyl Sombi yn brifo",
	"subtitles.entity.zombie_nautilus.ambient": "Nawtilws Sombi yn byrlymu",
	"subtitles.entity.zombie_nautilus.ambient_land": "Nawtilws Sombi yn byrlymu",
	"subtitles.entity.zombie_nautilus.dash": "Nawtilws Sombi yn gwibio",
	"subtitles.entity.zombie_nautilus.dash_land": "Nawtilws Sombi yn gwibio",
	"subtitles.entity.zombie_nautilus.dash_ready": "Nawtilws Sombi yn adfer",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Nawtilws Sombi yn adfer",
	"subtitles.entity.zombie_nautilus.death": "Nawtilws Sombi yn marw",
	"subtitles.entity.zombie_nautilus.death_land": "Nawtilws Sombi yn marw",
	"subtitles.entity.zombie_nautilus.eat": "Nawtilws Sombi yn bwyta",
	"subtitles.entity.zombie_nautilus.hurt": "Nawtilws Sombi yn brifo",
	"subtitles.entity.zombie_nautilus.hurt_land": "Nawtilws Sombi yn brifo",
	"subtitles.entity.zombie_nautilus.swim": "Nawtilws Sombi yn nofio",
	...
	"subtitles.event.mob_effect.bad_omen": "Argoel yn ffurfio",
	"subtitles.event.mob_effect.raid_omen": "Cyrch yn agosáu",
	"subtitles.event.mob_effect.trial_omen": "Treial ddrwgargoelus yn agosáu",
	"subtitles.event.raid.horn": "Corn drwgargoelus yn canu",
	"subtitles.item.armor.equip": "Gêr wedi'i roi",
	"subtitles.item.armor.equip_chain": "Arfwisg Gadwyn yn tincian",
	"subtitles.item.armor.equip_copper": "Arfwisg Copr yn taro",
	...
	"subtitles.item.armor.equip_nautilus": "Arfwisg Nawtilus wedi'i roi",
	"subtitles.item.armor.equip_netherite": "Arfwisg netherit yn toncio",
	"subtitles.item.armor.equip_turtle": "Cragen Crwban yn cnocio",
	"subtitles.item.armor.equip_wolf": "Arfwisg Blaidd yn dodrefnu",
	"subtitles.item.armor.unequip_nautilus": "Arfwisg Nawtilus wedi'i dynnu",
	"subtitles.item.armor.unequip_wolf": "Arfwisg Blaidd yn llithro",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Ciwb Sylffwr wedi'i gasglu",
	...
	"subtitles.item.bundle.insert_fail": "Bwndel llawn",
	...
	"subtitles.item.elytra.flying": "Swsial",
	...
	"subtitles.item.golden_dandelion.unuse": "Dant Y Llew Euraid yn dechrau heneiddio",
	"subtitles.item.golden_dandelion.use": "Dant Y Llew Euraid yn stopio heneiddio",
	"subtitles.item.hoe.till": "Hof yn troi",
	"subtitles.item.honey_bottle.drink": "Llowcio",
	"subtitles.item.honeycomb.wax_on": "Cwyr ymlaen",
	"subtitles.item.horse_armor.unequip": "Arfwisg Ceffyl yn llithro",
	"subtitles.item.ink_sac.use": "Coden Inc yn strempio",
	"subtitles.item.lead.break": "Tennyn yn torri",
	"subtitles.item.lead.tied": "Tennyn clymu",
	"subtitles.item.lead.untied": "Tennyn datglymu",
	"subtitles.item.llama_carpet.unequip": "Carped yn torri i ffwrdd",
	"subtitles.item.lodestone_compass.lock": "Cwmpawd Tynfaen yn olrhain Tynfaen",
	"subtitles.item.mace.smash_air": "Pastwn yn curo",
	"subtitles.item.mace.smash_ground": "Pastwn yn curo",
	"subtitles.item.nautilus_saddle_equip": "Cyfrwy wedi'i roi",
	"subtitles.item.nautilus_saddle_underwater_equip": "Cyfrwy wedi'i roi",
	"subtitles.item.nether_wart.plant": "Cnwd wedi'i blannu",
	"subtitles.item.ominous_bottle.dispose": "Potel yn torri",
	"subtitles.item.saddle.unequip": "Cyfrwy yn torri i ffwrdd",
	"subtitles.item.shears.shear": "Gwellau'n clecian",
	"subtitles.item.shears.snip": "Gwellau yn torri",
	"subtitles.item.shield.block": "Tarian yn gwarchod",
	"subtitles.item.shovel.flatten": "Rhaw yn fflatio",
	"subtitles.item.spear.attack": "Picell yn trywanu",
	"subtitles.item.spear.hit": "Picell yn taro",
	"subtitles.item.spear.lunge": "Picell yn rhagwthio",
	"subtitles.item.spear.use": "Rhuthro gyda Phicell",
	"subtitles.item.spear_wood.attack": "Picell yn trywanu",
	"subtitles.item.spear_wood.hit": "Picell yn taro",
	"subtitles.item.spear_wood.use": "Rhuthro gyda Phicell",
	...
	"subtitles.item.underwater_saddle.equip": "Cyfrwy wedi'i roi",
	"subtitles.item.wolf_armor.break": "Arfwisg Blaidd yn torri",
	"subtitles.item.wolf_armor.crack": "Arfwisg Blaidd yn cracio",
	"subtitles.item.wolf_armor.damage": "Arfwisg Blaidd yn cymryd difrod",
	"subtitles.item.wolf_armor.repair": "Trwsiwyd Arfwisg Blaidd",
	"subtitles.particle.soul_escape": "Enaid yn dianc",
	"subtitles.ui.cartography_table.take_result": "Map yn cael ei ddarlunio",
	"subtitles.ui.hud.bubble_pop": "Metr anadl yn gollwng",
	"subtitles.ui.loom.take_result": "Defnyddir Gwŷdd",
	"subtitles.ui.stonecutter.take_result": "Defnyddir Naddwr Cerrig",
	"subtitles.weather.end_flash": "Fflach End yn rymblan",
	"subtitles.weather.rain": "Glaw yn bwrw",
	"symlink_warning.message": "Gall llwytho bydoedd o ffolderi gyda dolenni symbolaidd fod yn beryglus os nad ydych chi'n gwybod beth ydych chi'n ei gwneud. Gweler %s i ddysgu mwy.",
	"symlink_warning.message.pack": "Gall llwytho pecynnau gyda dolenni symbolaidd fod yn beryglus os nad ydych chi'n gwybod beth ydych chi'n ei gwneud. Gweler %s i ddysgu mwy.",
	"symlink_warning.message.world": "Gall llwytho bydoedd o ffolderi gyda dolenni symbolaidd fod yn beryglus os nad ydych chi'n gwybod beth ydych chi'n ei gwneud. Gweler %s i ddysgu mwy.",
	"symlink_warning.more_info": "Mwy o wybodaeth",
	"symlink_warning.title": "Mae ffolder y byd yn cynnwys dolenni symbolaidd",
	"symlink_warning.title.pack": "Mae pecyn(nau) ychwanegol yn cynnwys dolenni symbolaidd",
	"symlink_warning.title.world": "Mae ffolder y byd yn cynnwys dolenni symbolaidd",
	...
	"telemetry.event.advancement_made.description": "Mae deall y cyd-destun y tu ôl i dderbyn dyrchfiad yn gallu ein helpu i ddeall a gwella dilyniant y gêm.",
	"telemetry.event.advancement_made.title": "Dyrchafiad wedi'i cyflawni",
	"telemetry.event.game_load_times.description": "Mae'r digwyddiad hwn yn gallu ein helpu i bwyso a mesur lle mae angen gwelliannau i berfformiad cychwyn drwy fesur amseroedd gweithredu'r cyfnodau cychwyn.",
	"telemetry.event.game_load_times.title": "Amserau Llwytho'r Gêm",
	"telemetry.event.graphics_capabilities.description": "Mae'r digwyddiad hwn yn rhoi gwybod i ni am alluoedd y ddyfais graffeg a ddefnyddir i chwarae'r gêm.",
	"telemetry.event.graphics_capabilities.title": "Galluoedd Graffeg",
	"telemetry.event.optional": "%s (Dewisol)",
	"telemetry.event.optional.disabled": "%s (Dewisol) - Analluogir",
	...
	"telemetry_info.button.privacy_statement": "Datganiad Preifatrwydd",
	"telemetry_info.button.show_data": "Dangos Fy Nata",
	"telemetry_info.opt_in.description": "Rwy'n cydsynio i anfon data telemetreg dewisol",
	...
	"test.error.entity_property": "Methodd endid %s brawf: %s",
	"test.error.entity_property_details": "Methodd endid %s brawf %s. Disgwylwyd %s: cafwyd %s",
	"test.error.expected_block": "Wedi disgwyl y bloc %s: cafwyd %s",
	"test.error.expected_block_present": "Disgwylwyd i floc %s fod yn bresennol",
	"test.error.expected_block_tag": "Expected block in #%s: got %s",
	"test.error.expected_container_contents": "Dylai'r cynhwysydd gynnwys: %s",
	"test.error.expected_container_contents_single": "Dylai'r cynhwysydd gynnwys dim ond un: %s",
	"test.error.expected_empty_container": "Dylai'r cynhwysydd fod yn wag",
	"test.error.expected_entity": "Disgwylwyd %s",
	...
	"test.error.expected_entity_holding": "Dylai'r endid fod yn dal %s",
	...
	"test.error.expected_item": "Disgwylwyd eitem o fath %s",
	"test.error.expected_items_count": "Disgwylwyd %s eitem o fath %s: cafwyd %s",
	"test.error.fail": "Bodlonwyd y gofynion methu",
	"test.error.invalid_block_type": "Unexpected block type found: %s",
	"test.error.missing_block_entity": "Endid bloc ar goll",
	...
	"test.error.sequence.minimum_tick": "Llwyddodd cyn y tic disgwyliedig: disgwylir aros %s",
	"test.error.sequence.not_completed": "Test timed out before sequence completed",
	"test.error.set_biome": "Methwyd â gosod bïom ar gyfer prawf",
	"test.error.spawn_failure": "Methwyd â chreu endid %s",
	...
	"test.error.unexpected_entity": "Ni ddisgwylwyd i %s fodoli",
	"test.error.unexpected_item": "Ni ddisgwylwyd eitem o fath %s",
	"test.error.unknown": "Gwall mewnol anhysbys: %s",
	...
	"test.error.wrong_block_entity": "Teip endid bloc anghywir: %s",
	"test_block.error.missing": "Adeiledd prawf ar goll bloc %s",
	"test_block.error.too_many": "Gormod o blociau %s",
	"test_block.invalid_timeout": "Terfyn amser annilys (%s) - rhaid iddo fod yn nifer positif o diciau",
	"test_block.message": "Neges:",
	"test_block.mode.accept": "Derbyn",
	"test_block.mode.fail": "Methu",
	"test_block.mode.log": "Cofnod",
	"test_block.mode.start": "Dechrau",
	"test_block.mode_info.accept": "Modd Derbyn - Derbyn llwyddiant ar gyfer (rhan o) brawf",
	"test_block.mode_info.fail": "Modd Methu - Methu'r prawf",
	"test_block.mode_info.log": "Modd Cofnodi - Cofnodi neges",
	"test_block.mode_info.start": "Modd dechrau - Y pwynt dechrau ar gyfer brawf",
	"test_instance.action.reset": "Ailosod a Llwytho",
	"test_instance.action.run": "Llwytho a Cyflawni",
	"test_instance.action.save": "Cadw Strwythur",
	"test_instance.description.batch": "Amgylchedd: %s",
	"test_instance.description.failed": "Methwyd: %s",
	"test_instance.description.function": "Ffwythiant: %s",
	"test_instance.description.invalid_id": "ID arbrawf annilys",
	"test_instance.description.no_test": "Dim prawf o'r fath",
	"test_instance.description.structure": "Strwythur: %s",
	"test_instance.description.type": "Math: %s",
	"test_instance.type.block_based": "Prawf ar sail Bloc",
	"test_instance.type.function": "Built-in Function Test",
	"test_instance_block.entities": "Endidau:",
	...
	"test_instance_block.invalid": "[annilys]",
	"test_instance_block.reset_success": "Reset succeeded for test: %s",
	"test_instance_block.rotation": "Troi:",
	"test_instance_block.size": "Prawf Maint Strwythur",
	"test_instance_block.starting": "Wrthi'n dechrau arbrawf %s",
	"test_instance_block.test_id": "ID Enghraifft Prawf",
	...
	"title.credits": "Hawlfraint Mojang AB. Peidiwch â dosbarthu!",
	"title.multiplayer.disabled": "Analluogir aml-chwaraewr. Gwiriwch gosodiadau eich cyfrif Microsoft os gwelwch yn dda.",
	"title.multiplayer.disabled.banned.name": "Rhaid ichi newid eich enw cyn chwarae ar-lein",
	...
	"trim_material.minecraft.resin": "Deunydd Resin",
	"trim_pattern.minecraft.bolt": "Addurn Arfwisg Bollten",
	...
	"trim_pattern.minecraft.flow": "Addurn Arfwisg Llif",
	...
	"tutorial.craft_planks.description": "Gall y llyfr rysáit helpu",
	...
	"upgradeWorld.aborted.message": "Gall hyn ddigwydd os rhaglen arall yn cyrchu'r byd yn ystod yr uwchraddiad. Efallai y byddai'n helpu i ailgychwyn eich cyfrifiadur a trial eto. Os yw'r problem yn mynnu, ystyried reportiwch y byg.",
	"upgradeWorld.aborted.reportBug": "Adrodd nam",
	"upgradeWorld.aborted.title": "Methwyd ag uwchraddio'r byd",
	"upgradeWorld.canceled.message": "Mae eich byd yn parhau fel yr oedd.",
	"upgradeWorld.canceled.title": "Uwchraddiad byd wedi'i ganslo",
	"upgradeWorld.done": "Wedi Uwchraddio'r Byd",
	"upgradeWorld.failed_cleanup.message": "Uwchraddiwyd y byd yn llwyddiannus i'r fersiwn cyfredol ac mae'r byd yn ar gael yn rhestr y byd. Daethom ar draws problemau wrth glirio hen ddata, felly mae enw'r ffolder byd wedi'i newid i %s.",
	"upgradeWorld.failed_cleanup.title": "Wedi uwchraddio'r byd yn llwyddiannus",
	"upgradeWorld.info.converted": "Wedi uwchraddio: %s",
	"upgradeWorld.info.file_fix_stage": "Cam: %s/%s",
	"upgradeWorld.info.scanning": "Wrthi'n sganio ffeiliau...",
	"upgradeWorld.info.total": "Cyfanswm: %s",
	"upgradeWorld.joinNow": "Ydych chi am ymuno â'r byd nawr?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Wrthi'n symud ffeiliau",
	"upgradeWorld.progress.type.legacy_structures": "Wrthi'n diweddaru hen strwythurau",
	"upgradeWorld.progress.type.region": "Wrthi'n uwchraddio rhanbarthau",
	"upgradeWorld.symlink.message": "Mae'r byd a ddewiswyd yn cynnwys dolenni symbolaidd.\nNid yw'r camau sydd eu hangen i uwchraddio'r byd i'r fersiwn gyfredol yn cefnogi'r defnydd o ddolenni symbolaidd. Er mwyn uwchraddio'r byd, mae angen addasu'r dolenni yn gyntaf.",
	"upgradeWorld.symlink.title": "Ni ellir uwchraddio'r byd",
	"upgradeWorld.title": "Uwchraddio Ffeiliau Byd",
}
