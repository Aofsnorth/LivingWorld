// Code generated by tools/gen_lang.go from 26.1/ca_es.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Opcions d'accessibilitat...",
	"accessibility.onboarding.accessibility.button.narration": "Opcions d'accessibilitat",
	...
	"advMode.notEnabled.spawner": "Els blocs generadors no estan permesos",
	"advMode.previousOutput": "Resultat anterior",
	"advMode.setCommand": "Canvia el comandament del bloc",
	"advMode.setCommand.disabled": "Conjunt d’ordres: %s, però els blocs d’ordres encara estan desactivats",
	...
	"advancements.adventure.blowback.title": "Molt tocat per la tramuntana",
	"advancements.adventure.brush_armadillo.description": "Obté escames d'armadillo utilitzant un pinzell",
	"advancements.adventure.brush_armadillo.title": "No és això una escama?",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Fabrica un gerro decorat amb 4 fragments de ceràmica",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Restauració meticulosa",
	"advancements.adventure.crafters_crafting_crafters.description": "Estigues a prop d'un elaborador mentre que elabori un elaborador",
	"advancements.adventure.crafters_crafting_crafters.title": "Elaboradors elaborant elaboradors",
	...
	"advancements.adventure.heart_transplanter.description": "Col·loqueu un cor cruixent amb l'alineació correcta entre dos blocs de troncs de roure pàl·lid",
	"advancements.adventure.heart_transplanter.title": "Trasplantador de cors",
	...
	"advancements.adventure.lighten_up.description": "Treu un tros de coure amb una destral per fer-ho més brillant",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Entra en una cambra de reptes",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Edició(ns) de Prova",
	"advancements.adventure.ol_betsy.description": "Dispara una ballesta",
	"advancements.adventure.ol_betsy.title": "La vella Betsy",
	"advancements.adventure.overoverkill.description": "Infligeix 50 de dany d'un sol cop utilitzant la maça",
	"advancements.adventure.overoverkill.title": "Sobre-rematar",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Llegeix el senyal d'energia d'una llibreria cisellada emprant un comparador",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "El poder dels llibres",
	"advancements.adventure.revaulting.description": "Desbloqueja una caixa forta ominosa utilitzant una clau de reptes ominosa",
	"advancements.adventure.revaulting.title": "Capsa de pandora",
	"advancements.adventure.root.description": "Aventura, exploració i combat",
	"advancements.adventure.root.title": "Aventura",
	"advancements.adventure.salvage_sherd.description": "Raspa un bloc sospitós per aconseguir un fragment de ceràmica",
	"advancements.adventure.salvage_sherd.title": "Respectant les restes",
	...
	"advancements.adventure.spear_many_mobs.description": "Colpeja cinc entitats amb la mateixa càrrega utilitzant la llança",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Aplica aquests motlles de ferreria almenys una vegada: agulles, musell, costelles, vigilant, silenci, esperit, marea, cerca camins",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Forjant amb estil",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Decora una armadura amb una taula de ferreria",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Creant un nou estil",
	...
	"advancements.adventure.under_lock_and_key.title": "Amb clau i pany",
	"advancements.adventure.use_lodestone.description": "Utilitza una Brúixola a una Magnetita",
	"advancements.adventure.use_lodestone.title": "Camins de bloc, porteu-me al lloc",
	...
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.description": "Camina sobre la neu en pols... sense enfonsar-t'hi",
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.title": "Lleuger com una llebre",
	"advancements.adventure.who_needs_rockets.description": "Utilitza una càrrega de vent per llançar-te 8 blocs cap amunt",
	...
	"advancements.husbandry.feed_snifflet.description": "Alimenta una cria d'ensumador",
	"advancements.husbandry.feed_snifflet.title": "Ensumadetes",
	...
	"advancements.husbandry.obtain_sniffer_egg.description": "Obté un ou d'ensumador",
	"advancements.husbandry.obtain_sniffer_egg.title": "Quina olor més curiosa",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Col·loca un ghast sec dins l'aigua",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Manteniu-vos hidratats!",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Planta qualsevol llavor d'un ensumador",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Treu l'armadura de llop utilitzant tisores",
	"advancements.husbandry.remove_wolf_armor.title": "Esquilada lluent",
	"advancements.husbandry.repair_wolf_armor.description": "Repara una armadura de llop danyada utilitzant escates d'armadillo",
	"advancements.husbandry.repair_wolf_armor.title": "Com nova",
	...
	"advancements.husbandry.silk_touch_nest.description": "Mou un rusc o un rusc fix que contingui 3 abelles utilitzant toc de seda",
	...
	"advancements.husbandry.uh_oh.description": "Fes que un Cub de Sofre absorbeixi una TNT",
	"advancements.husbandry.uh_oh.title": "Oh no",
	...
	"advancements.husbandry.whole_pack.description": "Domestica un llop de cada variant",
	"advancements.husbandry.whole_pack.title": "Tota la manada",
	...
	"argument.block.tag.disallowed": "Aquí no es permeten etiquetes, només blocs reals",
	...
	"argument.entity.options.gamemode.description": "Jugadors amb mode de joc",
	...
	"argument.entity.selector.nearestEntity": "Entitat més propera",
	...
	"argument.hexcolor.invalid": "'%s' Codi d'hex invàlid",
	...
	"argument.item.tag.disallowed": "Aquí no es permeten etiquetes, només ítems reals",
	"argument.literal.incorrect": "Es requereix el valor literal \"%s\"",
	"argument.long.big": "El valor long no pot ser major que %s (trobat %s)",
	"argument.long.low": "El valor long no pot ser menor que %s (trobat %s)",
	...
	"argument.nbt.expected.compound": "Es requereix etiqueta composta",
	...
	"argument.resource_or_id.invalid": "Identitat o etiqueta no vàlida",
	"argument.resource_or_id.no_such_element": "No s'ha pogut trobar l'element %s al registre %s",
	"argument.resource_selector.not_found": "Sense coincidències pel selector '%s' del tipus '%s'",
	...
	"argument.time.invalid_tick_count": "La quantitat de ticks no ha de ser negativa",
	"argument.time.invalid_unit": "Unitat invàlida",
	"argument.time.tick_count_too_low": "El compte de tics no pot ser inferior a %s: s'ha trobat %s",
	"argument.uuid.invalid": "UUID invàlid",
	"argument.waypoint.invalid": "L'entitat seleccionada no és un punt de referència",
	...
	"arguments.item.component.expected": "Es requereix un component d'ítem",
	"arguments.item.component.malformed": "Component '%s' malformat: '%s'",
	"arguments.item.component.repeated": "El component d'ítems '%s' s'ha repetit, però només es pot especificar un valor",
	"arguments.item.component.unknown": "Component d'ítem '%s' desconegut",
	"arguments.item.malformed": "Ítem mal format: '%s'",
	"arguments.item.overstacked": "%s només pot apilar-se fins a %s",
	"arguments.item.predicate.malformed": "Predicat '%s' malformat: '%s'",
	"arguments.item.predicate.unknown": "Predicat d'ítem desconegut '%s\"",
	...
	"arguments.swizzle.invalid": "Reordenació de components no vàlida: s’esperava una combinació de «x», «y» i «z»",
	...
	"attribute.name.air_drag_modifier": "Modificador de resistència a l'aire",
	"attribute.name.armor": "Armadura",
	"attribute.name.armor_toughness": "Duresa de l'armadura",
	"attribute.name.attack_damage": "Dany per atac",
	"attribute.name.attack_knockback": "Atac de retrocés",
	"attribute.name.attack_speed": "Velocitat de l'atac",
	"attribute.name.below_name_distance": "Distància de puntuació de l'etiqueta del nom",
	"attribute.name.block_break_speed": "Velocitat del trencament de bloc",
	"attribute.name.block_interaction_range": "Distància d'interacció amb blocs",
	"attribute.name.bounciness": "Elasticitat",
	"attribute.name.burning_time": "Temps en flames",
	"attribute.name.camera_distance": "Distància de càmera",
	"attribute.name.entity_interaction_range": "Distància d'interacció amb entitats",
	"attribute.name.explosion_knockback_resistance": "Resistència a l'empenta d'explosions",
	"attribute.name.fall_damage_multiplier": "Multiplicador de dany per caiguda",
	"attribute.name.flying_speed": "Velocitat de vol",
	"attribute.name.follow_range": "Distància de seguiment del monstre",
	...
	"attribute.name.generic.block_interaction_range": "Distància d'interacció de blocs",
	"attribute.name.generic.burning_time": "Duració de cremar",
	"attribute.name.generic.entity_interaction_range": "Distància d'interacció d'entitats",
	"attribute.name.generic.explosion_knockback_resistance": "Resistència a l'empenta d'explosions",
	"attribute.name.generic.fall_damage_multiplier": "Multiplicador de danys per alçada",
	...
	"attribute.name.generic.oxygen_bonus": "Oxigen addicional",
	"attribute.name.generic.safe_fall_distance": "Distància de caiguda segura",
	"attribute.name.generic.scale": "Escala",
	"attribute.name.generic.step_height": "Alçada del pas",
	"attribute.name.generic.water_movement_efficiency": "Eficiència de moviment aquàtica",
	...
	"attribute.name.knockback_resistance": "Resistència a empentes",
	"attribute.name.luck": "Sort",
	"attribute.name.max_absorption": "Absorció màxima",
	"attribute.name.max_health": "Vida màxima",
	"attribute.name.mining_efficiency": "Eficiència de mineria",
	"attribute.name.movement_efficiency": "Eficiència de moviment",
	"attribute.name.movement_speed": "Velocitat",
	"attribute.name.nameplate_distance": "Distància de l'etiqueta del nom",
	"attribute.name.oxygen_bonus": "Oxigen addicional",
	"attribute.name.player.block_break_speed": "Velocitat de trencar blocs",
	"attribute.name.player.block_interaction_range": "Distància d'interacció de blocs",
	"attribute.name.player.entity_interaction_range": "Distància d'interacció d'entitats",
	"attribute.name.player.mining_efficiency": "Eficiència minera",
	"attribute.name.player.sneaking_speed": "Velocitat en ajupir-se",
	"attribute.name.player.submerged_mining_speed": "Velocitat minera bussejant",
	"attribute.name.player.sweeping_damage_ratio": "Ració de danys d'escombrat",
	"attribute.name.safe_fall_distance": "Distància de caiguda segura",
	"attribute.name.scale": "Escala",
	"attribute.name.sneaking_speed": "Velocitat en ajupir-se",
	"attribute.name.spawn_reinforcements": "Reforços zombi",
	"attribute.name.step_height": "Pas amunt",
	"attribute.name.submerged_mining_speed": "Velocitat de mineria submergida",
	"attribute.name.sweeping_damage_ratio": "Radi de danys d'escombra",
	"attribute.name.tempt_range": "Radi de moviment temptatiu",
	"attribute.name.water_movement_efficiency": "Eficiència de moviment aquàtica",
	"attribute.name.waypoint_receive_range": "Rang de recepció del punt de referència",
	"attribute.name.waypoint_transmit_range": "Rang de transmissió del punt de referència",
	...
	"biome.minecraft.pale_garden": "Jardí pàl·lid",
	...
	"block.minecraft.acacia_shelf": "Prestatge d'acàcia",
	...
	"block.minecraft.bamboo_shelf": "Prestatge de bambú",
	...
	"block.minecraft.banner.flow.black": "Espiral negre",
	"block.minecraft.banner.flow.blue": "Espiral blau",
	"block.minecraft.banner.flow.brown": "Espiral marró",
	"block.minecraft.banner.flow.cyan": "Espiral cian",
	"block.minecraft.banner.flow.gray": "Espiral gris",
	"block.minecraft.banner.flow.green": "Espiral verd",
	"block.minecraft.banner.flow.light_blue": "Espiral blau cel",
	"block.minecraft.banner.flow.light_gray": "Espiral gris clar",
	"block.minecraft.banner.flow.lime": "Espiral llima",
	"block.minecraft.banner.flow.magenta": "Espiral magenta",
	"block.minecraft.banner.flow.orange": "Espiral taronja",
	"block.minecraft.banner.flow.pink": "Espiral rosa",
	"block.minecraft.banner.flow.purple": "Espiral morat",
	"block.minecraft.banner.flow.red": "Espiral vermell",
	"block.minecraft.banner.flow.white": "Espiral blanc",
	"block.minecraft.banner.flow.yellow": "Espiral groc",
	...
	"block.minecraft.banner.guster.black": "Brisa negra",
	"block.minecraft.banner.guster.blue": "Brisa blava",
	"block.minecraft.banner.guster.brown": "Brisa marró",
	"block.minecraft.banner.guster.cyan": "Brisa cian",
	"block.minecraft.banner.guster.gray": "Brisa grisa",
	"block.minecraft.banner.guster.green": "Brisa verda",
	"block.minecraft.banner.guster.light_blue": "Brisa blau cel",
	"block.minecraft.banner.guster.light_gray": "Brisa gris clar",
	"block.minecraft.banner.guster.lime": "Brisa llima",
	"block.minecraft.banner.guster.magenta": "Brisa magenta",
	"block.minecraft.banner.guster.orange": "Brisa taronja",
	"block.minecraft.banner.guster.pink": "Brisa rosa",
	"block.minecraft.banner.guster.purple": "Brisa morada",
	"block.minecraft.banner.guster.red": "Brisa vermella",
	"block.minecraft.banner.guster.white": "Brisa blanca",
	"block.minecraft.banner.guster.yellow": "Brisa groga",
	...
	"block.minecraft.birch_shelf": "Prestatge de bedoll",
	...
	"block.minecraft.cherry_shelf": "Prestatge de cirerer",
	...
	"block.minecraft.chiseled_resin_bricks": "Maons de resina cisellats",
	...
	"block.minecraft.chiseled_tuff": "Tuf cisellat",
	"block.minecraft.chiseled_tuff_bricks": "Maons de tuf cisellats",
	...
	"block.minecraft.cinnabar_brick_slab": "Llosa de maons de cinabri",
	"block.minecraft.cinnabar_brick_stairs": "Escales de maons de cinabri",
	"block.minecraft.cinnabar_brick_wall": "Mur de maons de cinabri",
	"block.minecraft.cinnabar_bricks": "Maons de cinabri",
	...
	"block.minecraft.closed_eyeblossom": "Iridàcia tancada",
	...
	"block.minecraft.copper_bars": "Barres de coure",
	"block.minecraft.copper_block": "Bloc de coure",
	"block.minecraft.copper_bulb": "Bombeta de coure",
	"block.minecraft.copper_chain": "Cadenes de coure",
	"block.minecraft.copper_chest": "Bagul de coure",
	"block.minecraft.copper_door": "Porta de coure",
	"block.minecraft.copper_golem_statue": "Estàtua de Gòlem de Coure",
	"block.minecraft.copper_grate": "Reixa de coure",
	"block.minecraft.copper_lantern": "Fanal de Coure",
	"block.minecraft.copper_ore": "Mena de coure",
	"block.minecraft.copper_torch": "Antorxa de Coure",
	"block.minecraft.copper_trapdoor": "Trapa de coure",
	"block.minecraft.copper_wall_torch": "Antorxa de paret de Coure",
	...
	"block.minecraft.crafter": "Elaborador",
	"block.minecraft.crafting_table": "Taula d'elaboració",
	"block.minecraft.creaking_heart": "Cor de cruixidor",
	...
	"block.minecraft.exposed_copper_bars": "Barrots de coure exposat",
	"block.minecraft.exposed_copper_bulb": "Bombeta de coure exposat",
	...
	"block.minecraft.exposed_copper_golem_statue": "Estàtua de gòlem de coure exposat",
	"block.minecraft.exposed_copper_grate": "Reixa de coure exposat",
	...
	"block.minecraft.firefly_bush": "Matoll de cuques de llum",
	...
	"block.minecraft.jungle_shelf": "Prestatge de jungla",
	...
	"block.minecraft.mangrove_shelf": "Prestatge de mangle",
	...
	"block.minecraft.oak_shelf": "Prestatge de roure",
	...
	"block.minecraft.open_eyeblossom": "Iridàcia oberta",
	...
	"block.minecraft.oxidized_copper_bars": "Barrots de coure oxidat",
	"block.minecraft.oxidized_copper_bulb": "Bombeta de coure oxidat",
	...
	"block.minecraft.oxidized_copper_golem_statue": "Estàtua de gòlem de coure oxidat",
	"block.minecraft.oxidized_copper_grate": "Reixa de coure oxidat",
	...
	"block.minecraft.pale_hanging_moss": "Molsa pàl·lida penjant",
	"block.minecraft.pale_moss_block": "Bloc de molsa pàl·lida",
	"block.minecraft.pale_moss_carpet": "Catifa de molsa pàl·lida",
	"block.minecraft.pale_oak_button": "Botó de roure pàl·lid",
	"block.minecraft.pale_oak_door": "Porta de roure pàl·lid",
	"block.minecraft.pale_oak_fence": "Tanca de roure pàl·lid",
	"block.minecraft.pale_oak_fence_gate": "Porta de tanca de roure pàl·lid",
	"block.minecraft.pale_oak_hanging_sign": "Rètol de paret de roure pàl·lid",
	"block.minecraft.pale_oak_leaves": "Fulles de roure pàl·lid",
	"block.minecraft.pale_oak_log": "Tronc de roure pàl·lid",
	"block.minecraft.pale_oak_planks": "Taulons de fusta de roure pàl·lid",
	"block.minecraft.pale_oak_pressure_plate": "Placa de pressió de roure pàl·lid",
	"block.minecraft.pale_oak_sapling": "Esqueix de roure pàl·lid",
	"block.minecraft.pale_oak_shelf": "Prestatge de roure pàl·lid",
	"block.minecraft.pale_oak_sign": "Rètol de roure pàl·lid",
	"block.minecraft.pale_oak_slab": "Llosa de roure pàl·lid",
	"block.minecraft.pale_oak_stairs": "Escales de roure pàl·lid",
	"block.minecraft.pale_oak_trapdoor": "Trapa de roure pàl·lid",
	"block.minecraft.pale_oak_wall_hanging_sign": "Cartell penjant de roure pàl·lid amb suport",
	"block.minecraft.pale_oak_wall_sign": "Cartell de roure pàl·lid",
	"block.minecraft.pale_oak_wood": "Fusta de roure pàl·lid",
	...
	"block.minecraft.polished_tuff_slab": "Llosa de tuf polit",
	"block.minecraft.polished_tuff_stairs": "Escales de tuf polit",
	...
	"block.minecraft.potted_closed_eyeblossom": "Test amb iridàcia tancada",
	...
	"block.minecraft.potted_open_eyeblossom": "Test amb iridàcia oberta",
	"block.minecraft.potted_orange_tulip": "Test amb tulipà taronja",
	"block.minecraft.potted_oxeye_daisy": "Test amb margarida",
	"block.minecraft.potted_pale_oak_sapling": "Test amb esqueix de roure pàl·lid",
	...
	"block.minecraft.resin_brick_slab": "Llosa de maons de resina",
	"block.minecraft.resin_brick_stairs": "Escales de maons de resina",
	"block.minecraft.resin_brick_wall": "Mur de maons de resina",
	"block.minecraft.resin_bricks": "Maons de resina",
	"block.minecraft.resin_clump": "Grumoll de resina",
	...
	"block.minecraft.spruce_shelf": "Prestatge de pi",
	...
	"block.minecraft.stripped_pale_oak_log": "Tronc de roure pàl·lid escorçat",
	"block.minecraft.stripped_pale_oak_wood": "Fusta de roure pàl·lid escorçada",
	...
	"block.minecraft.sulfur_brick_slab": "Llosa de maons de sofre",
	"block.minecraft.sulfur_brick_stairs": "Escales de maons de sofre",
	"block.minecraft.sulfur_brick_wall": "Mur de maons de sofre",
	"block.minecraft.sulfur_bricks": "Maons de sofre",
	"block.minecraft.sulfur_slab": "Llosa de sofre",
	"block.minecraft.sulfur_spike": "Pics de sofre",
	...
	"block.minecraft.test_instance_block": "Bloc de prova d'instàncies",
	"block.minecraft.tinted_glass": "Vidre opac",
	"block.minecraft.tnt": "Dinamita",
	"block.minecraft.tnt.disabled": "Les explosions de TNT estan deshabilitades",
	...
	"block.minecraft.tuff_brick_slab": "Llosa de maons de tuf ",
	"block.minecraft.tuff_brick_stairs": "Escales de maons de tuf",
	"block.minecraft.tuff_brick_wall": "Mur de maons de tuf",
	"block.minecraft.tuff_bricks": "Maons de tuf",
	"block.minecraft.tuff_slab": "Llosa de tuf",
	"block.minecraft.tuff_stairs": "Escales de tuf",
	...
	"block.minecraft.warped_shelf": "Prestatge guerxo",
	...
	"block.minecraft.waxed_chiseled_copper": "Coure encerat cisellat",
	"block.minecraft.waxed_copper_bars": "Barrots de coure encerats",
	"block.minecraft.waxed_copper_block": "Bloc de coure encerat",
	"block.minecraft.waxed_copper_bulb": "Bombeta de coure encerat",
	"block.minecraft.waxed_copper_chain": "Cadena de coure encerada",
	"block.minecraft.waxed_copper_chest": "Cofre de coure encerat",
	"block.minecraft.waxed_copper_door": "Porta de coure encerat",
	"block.minecraft.waxed_copper_golem_statue": "Estàtua de gòlem de coure encerada",
	"block.minecraft.waxed_copper_grate": "Reixa de coure encerat",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Coure exposat encerat cisellat",
	"block.minecraft.waxed_exposed_copper": "Coure exposat encerat",
	"block.minecraft.waxed_exposed_copper_bars": "Barrots de coure exposat encerats",
	"block.minecraft.waxed_exposed_copper_bulb": "Bombeta de coure exposat encerat",
	"block.minecraft.waxed_exposed_copper_chain": "Cadena de coure exposat encerada",
	...
	"block.minecraft.waxed_exposed_copper_golem_statue": "Estàtua de gòlem de coure exposat encerada",
	"block.minecraft.waxed_exposed_copper_grate": "Reixa de coure exposat encerat",
	...
	"block.minecraft.waxed_oxidized_chiseled_copper": "Coure oxidat encerat cisellat",
	"block.minecraft.waxed_oxidized_copper": "Coure oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_bars": "Barrots de coure oxidat exposats",
	"block.minecraft.waxed_oxidized_copper_bulb": "Bombeta de coure oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_chain": "Cadena de coure oxidat encerada",
	...
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Estàtua de coure exposat oxidada",
	...
	"block.minecraft.waxed_weathered_chiseled_copper": "Coure corroït encerat cisellat",
	"block.minecraft.waxed_weathered_copper": "Coure corroït encerat",
	"block.minecraft.waxed_weathered_copper_bars": "Barres de coure encerades i desgastades",
	"block.minecraft.waxed_weathered_copper_bulb": "Bombeta de coure corroït encerat",
	"block.minecraft.waxed_weathered_copper_chain": "Cadena de coure corroït encerada",
	"block.minecraft.waxed_weathered_copper_door": "Porta de coure corroït encerat",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Estàtua de gòlem de coure corroït encerada",
	"block.minecraft.waxed_weathered_copper_grate": "Reixa de coure corroït encerat",
	"block.minecraft.waxed_weathered_copper_lantern": "Fanal de coure corroït encerat",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Trapa de coure corroït encerat",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Parallamps corroït encerat",
	"block.minecraft.weathered_chiseled_copper": "Coure corroït cisellat",
	"block.minecraft.weathered_copper": "Coure corroït",
	"block.minecraft.weathered_copper_bars": "Barrots de coure corroït",
	"block.minecraft.weathered_copper_bulb": "Bombeta de coure corroït",
	"block.minecraft.weathered_copper_chain": "Cadena de coure corroït",
	"block.minecraft.weathered_copper_chest": "Cofre de coure corroït",
	"block.minecraft.weathered_copper_door": "Porta de coure corroït",
	"block.minecraft.weathered_copper_golem_statue": "Estàtua de gòlem de coure corroit",
	"block.minecraft.weathered_copper_grate": "Reixa de coure corroït",
	"block.minecraft.weathered_copper_lantern": "Fanal de coure corroït",
	"block.minecraft.weathered_copper_trapdoor": "Trapa de coure corroït",
	...
	"block.minecraft.weathered_lightning_rod": "Parallamps corroït",
	...
	"build.spawn_protection": "%s està protegit per la protecció d'aparició",
	"build.tooHigh": "El límit d'alçada per construir és de %s blocs",
	"build.tooLow": "L'alçada mínima per a construir és %s",
	...
	"chat.disabled.invalid_command_signature": "El comandament tenia signatures de comando inesperades o no en té.",
	"chat.disabled.invalid_signature": "Xat tenia una signatura invàlida. Si us plau, intenta reconnectar-te.",
	...
	"chat.disabled.out_of_order_chat": "El xat està fora de servei. S'ha canviat l'hora del teu sistema?",
	...
	"chat.queue.tooltip": "Fes clic per mostrar el missatge següent",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "El servidor ha enviat un missatge no vàlid.",
	...
	"chat_restriction.chat_disabled_by_options": "El xat està restringit en la configuració del client.",
	"chat_restriction.chat_disabled_by_options.action": "Anar a la pantalla de Configuració del Xat",
	...
	"chat_restriction.disabled_by_profile.action": "Anar a la configuració del perfil",
	"chat_screen.commands_not_allowed": "Enviar comandaments no està permès",
	"chat_screen.message": "Missatge a enviar: %s",
	"chat_screen.messages_not_allowed": "Enviar missatges al xat no està permès",
	"chat_screen.restricted": "El xat està restringit. Polsa en aquest missatge per a més detalls.",
	"chat_screen.restricted.narration": "El xat està restringit. Ves a la pantalla de Restriccions en les Opcions del Món.",
	"chat_screen.title": "Pantalla del xat",
	"chat_screen.usage": "Escriu un missatge i prem Enter per enviar",
	"chunk.toast.checkLog": "Mira el registre per a més detalls",
	"chunk.toast.loadFailure": "No s'ha pogut carregar el chunk a %s",
	"chunk.toast.lowDiskSpace": "Poc espai al disc!",
	"chunk.toast.lowDiskSpace.description": "Pot ser que no es pugui guardar el món.",
	"chunk.toast.saveFailure": "No s'ha pogut guardar el chunk a %s",
	...
	"command.forkLimit": "S'ha arribat al màxim de contextos (%s)",
	"command.trailing_data": "%s",
	...
	"commands.attribute.base_value.reset.success": "El valor base de l'atribut %s de l'entitat %s s'ha restablert al predeterminat %s",
	...
	"commands.bossbar.get.players.some": "La barra personalitzada de l'amo %s té %s jugador(s) connectats: %s",
	...
	"commands.bossbar.list.bars.some": "Hi ha %s barra(es) personalitzada(es) de l'amo actiu(s): %s",
	...
	"commands.bossbar.set.players.success.some": "La barra personalitzada de l'amo %s té ara %s jugador(s): %s",
	...
	"commands.clear.success.single": "S'han eliminat %s objecte(s) del jugador %s",
	...
	"commands.clone.success": "S'han clonat %s bloc(s)",
	...
	"commands.data.modify.invalid_substring": "Índexs de subcadenes no vàlids: %s fins %s",
	...
	"commands.datapack.create.already_exists": "Un paquet anomenat '%s' ja existeix",
	"commands.datapack.create.invalid_full_name": "Nou nom de paquet invàlid '%s'",
	"commands.datapack.create.invalid_name": "Caràcters invàlids al nom del nou paquet '%s'",
	"commands.datapack.create.io_failure": "No es pot crear un paquet anomenat '%s', revisa els registres",
	"commands.datapack.create.metadata_encode_failure": "No s'han pogut codificar les metadades del paquet anomenat '%s': %s",
	"commands.datapack.create.success": "S'ha creat un nou paquet buit anomenat '%s'",
	"commands.datapack.disable.failed": "El paquet de dades \"%s\" no estava activat!",
	"commands.datapack.disable.failed.feature": "El paquet de dades '%s' no es pot desactivar, ja que és part d'una de les variables actives!",
	...
	"commands.datapack.list.available.success": "Hi ha %s paquet(s) de dades disponibles: %s",
	"commands.datapack.list.enabled.none": "No hi ha paquets de dades actius",
	"commands.datapack.list.enabled.success": "Hi ha %s paquet(s) de dades actius: %s",
	...
	"commands.debug.function.noReturnRun": "El seguiment no es pot utilitzar amb",
	...
	"commands.debug.stopped": "S'ha parat l'anàlisi de tics després de %s segons i %s tics (%s tics per segon)",
	...
	"commands.dialog.clear.multiple": "Eliminat diàleg per %s jugadors",
	"commands.dialog.clear.single": "Eliminat diàleg per a %s",
	"commands.dialog.show.multiple": "Mostrat diàleg per %s jugadors",
	"commands.dialog.show.single": "Mostrat diàleg per a %s",
	...
	"commands.drop.no_loot_table.block": "El bloc %s no té taula de botí",
	...
	"commands.execute.function.instantiationFailure": "Error a l'inicialitzar la funció %s: %s",
	...
	"commands.fetchprofile.copy_component": "Copiar component",
	"commands.fetchprofile.copy_text": "Copiar %s",
	"commands.fetchprofile.entity.success": "Perfil resolt per a l'entitat %s: %s",
	"commands.fetchprofile.failed_to_serialize": "No s'ha pogut serialitzar el perfil: %s",
	"commands.fetchprofile.give_item": "Donar ítem",
	"commands.fetchprofile.id.failure": "No s'ha pogut resoldre el perfil per l'ID %s",
	"commands.fetchprofile.id.success": "Resolt perfil per a l'ID %s: %s",
	"commands.fetchprofile.name.failure": "No s'ha pogut resoldre el perfil pel nom %s",
	"commands.fetchprofile.name.success": "Resolt perfil pel nom %s: %s",
	...
	"commands.fill.success": "S'han omplert %s bloc(s) amb èxit",
	...
	"commands.fillbiome.success.count": "%s Entrada/entrades del bioma establert entre %s, %s, %s i %s, %s, %s",
	...
	"commands.function.error.argument_not_compound": "El tipus d'argument no és vàlid: %s, s'esperava Compound",
	"commands.function.error.missing_argument": "Falta l'argument %[2]s a la funció %[1]s",
	"commands.function.error.missing_arguments": "Falten arguments a la funció %s",
	"commands.function.error.parse": "En executar la macro %s: la comanda '%s' ha provocat l'error: %s",
	"commands.function.instantiationFailure": "Error en inicialitzar la funció %s: %s",
	"commands.function.result": "Funció '%s' ha retornat %s",
	"commands.function.scheduled.multiple": "Executant funcions %s",
	"commands.function.scheduled.no_functions": "No s'ha trobat cap funció amb el nom %s",
	"commands.function.scheduled.single": "Executant la funció %s",
	"commands.function.success.multiple": "S'ha(n) executat %s comandament(s) de %s funcions",
	"commands.function.success.multiple.result": "Executades %s funcions",
	"commands.function.success.single": "S'han executat %s comandament(s) de la funció '%s'",
	"commands.function.success.single.result": "Funció '%[2]s' ha retornat %[1]s",
	...
	"commands.kick.owner.failed": "No es pot expulsar el propietari del servidor al joc LAN",
	"commands.kick.singleplayer.failed": "No es pot expulsar en un joc individual fora de línia",
	...
	"commands.profile_fetch.copy_component": "Copiar component",
	"commands.profile_fetch.failed_to_serialize": "No s'ha pogut serialitzar el perfil: %s",
	"commands.profile_fetch.give_item": "Donar ítem",
	"commands.profile_fetch.id.failure": "No s'ha pogut resoldre el perfil per l'ID %s",
	"commands.profile_fetch.id.success": "Resolt perfil per a l'ID %s: %s",
	"commands.profile_fetch.name.failure": "No s'ha pogut resoldre el perfil pel nom %s",
	"commands.profile_fetch.name.success": "Resolt perfil pel nom %s: %s",
	"commands.publish.alreadyPublished": "La partida multijugador ja s'allotja al port %s",
	"commands.publish.alreadyPublished.lan": "La partida local ja s'allotja al port %s",
	...
	"commands.publish.started.lan": "Partida local allotjada al port %s",
	...
	"commands.random.error.range_too_large": "El rang d'un valor aleatori ha de ser com a màxim 2147483646",
	"commands.random.error.range_too_small": "El rang d'un valor aleatori ha de ser com a mínim 2",
	"commands.random.reset.all.success": "Reinicia %s seqüència/es aleatòria/es",
	"commands.random.reset.success": "Reinicia la seqüència aleatòria %s",
	"commands.random.roll": "%s ha tret %s (entre %s i %s)",
	...
	"commands.schedule.macro": "No es pot carregar en Macro",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "S'ha desactivat l'actualització automàtica de mostrar a l'objectiu %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "S'ha activat l'actualització automàtica de mostrar per a l'objectiu %s",
	"commands.scoreboard.objectives.modify.displayname": "S'ha canviat el nom a mostrar de %s a %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "S'ha esborrat el format del número per defecte de l'objectiu %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "S'ha canviat el format del número per defecte de l'objectiu %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "S'ha esborrat el text a mostrar de %s entitats a %s",
	"commands.scoreboard.players.display.name.clear.success.single": "S'ha esborrat el text a mostrar de %s a %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "S'ha canviat el text a mostrar a %s per a %s entitats a %s",
	"commands.scoreboard.players.display.name.set.success.single": "S'ha canviat el text a mostrar a %s per a %s a %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "S'ha esborrat el format de nombre per a %s entitats a %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "S'ha esborrat el format de nombre de %s a %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "S'ha canviat el format de nombre per a %s entitats a %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "S'ha canviat el format de nombre per a %s a %s",
	...
	"commands.scoreboard.players.list.entity.success": "%s té puntuació(ns) de %s:",
	"commands.scoreboard.players.list.success": "Hi ha %s entitat/entitats registrada/es: %s",
	...
	"commands.setidletimeout.success": "Ara el temps màxim d'inactivitat del jugador és %s minut(s)",
	"commands.setidletimeout.success.disabled": "El temps màxim d'inactivitat dels jugadors s'ha desactivat",
	"commands.setworldspawn.failure.not_overworld": "Només es pot establir el punt d'aparició del món pel món superior",
	"commands.setworldspawn.success": "S'ha canviat el punt d'aparició del món a %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "S'ha establert el punt de reaparició del món a %s, %s, %s [%s, %s] a %s",
	"commands.spawnpoint.success.multiple": "Definit el punt de reaparició a %s, %s, %s [%s] en la dimensió %s per a %s jugadors",
	"commands.spawnpoint.success.multiple.new": "S'ha establert el punt de reaparició a %s, %s, %s [%s, %s] a %s pels jugadors %s",
	"commands.spawnpoint.success.single": "Definit el punt de reaparició a %s, %s, %s [%s] en la dimensió %s per a %s",
	"commands.spawnpoint.success.single.new": "S'ha establert el punt de reaparició a %s, %s, %s [%s, %s] a %s per %s",
	"commands.spectate.cannot_spectate": "No pots observar a %s",
	...
	"commands.spreadplayers.failed.entities": "No s'han pogut repartir %s entitats al voltant de %s, %s (són massa entitats per aquest espai, prova repartint-les com a màxim %s)",
	...
	"commands.spreadplayers.failed.teams": "No s'han pogut repartir %s equip(s) al voltant de %s, %s (massa entitats per aquest espai, prova repartint-les com a màxim %s)",
	...
	"commands.stopwatch.already_exists": "El cronòmetre «%s» ja existeix",
	"commands.stopwatch.create.success": "S’ha creat el cronòmetre '%s'",
	"commands.stopwatch.does_not_exist": "El cronòmetre «%s» no existeix",
	"commands.stopwatch.query": "El cronòmetre '%s' ha funcionat durant %s s",
	"commands.stopwatch.remove.success": "S’ha eliminat el cronòmetre '%s'",
	"commands.stopwatch.restart.success": "S’ha reiniciat el cronòmetre '%s'",
	"commands.summon.failed": "No s'ha pogut generar l'entitat",
	"commands.summon.failed.peaceful": "No es poden generar monstres en dificultat pacífica",
	...
	"commands.swing.failed.notliving": "No hi ha entitats vives per moure-les",
	"commands.swing.success.multiple": "Has fet que %s entitats moguin un braç",
	"commands.swing.success.single": "Has fet que %s mogui un braç",
	...
	"commands.team.empty.success": "S'han eliminat a %s membre(s) de l'equip %s",
	...
	"commands.team.option.color.clear.success": "S'ha tret el color de l'equip %s",
	...
	"commands.test.batch.starting": "Començant entorn %s del lot %s",
	"commands.test.clear.error.no_tests": "No s'ha pogut trobar cap prova per netejar",
	"commands.test.clear.success": "S'ha(n) eliminat %s estructures",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Pressiona per copiar al porta-retalls",
	"commands.test.create.success": "Configuració creada per la prova %s",
	"commands.test.error.no_test_containing_pos": "No s'ha pogut trobar cap instància de test que contingui, %s, %s, %s",
	"commands.test.error.no_test_instances": "No s'ha trobat cap instància de test",
	"commands.test.error.non_existant_test": "No s'ha pogut trobar el test %s",
	"commands.test.error.structure_not_found": "No s'ha pogut trobar l'estructura de test %s",
	"commands.test.error.test_instance_not_found": "No s'ha pogut trobar cap bloc de prova",
	"commands.test.error.test_instance_not_found.position": "No s'ha pogut trobar cap bloc de prova a %s, %s, %s",
	"commands.test.error.too_large": "La mida de l'estructura ha de ser més petita de %s blocs",
	"commands.test.locate.done": "S'ha acabat la cerca, s'ha(n) trobat %s estructures",
	"commands.test.locate.found": "S'ha trobat una estructura a: %s (distància: %s)",
	"commands.test.locate.started": "Ha començat la cerca d'estructures de prova, això pot trigar un temps...",
	"commands.test.no_tests": "No hi ha proves per iniciar",
	"commands.test.relative_position": "Posició relativa a %s: %s",
	"commands.test.reset.error.no_tests": "No s'ha trobat cap prova per reiniciar",
	"commands.test.reset.success": "S'ha(n) reiniciat %s estructures",
	"commands.test.run.no_tests": "No s'han trobat proves",
	"commands.test.run.running": "Començant %s prova(es)...",
	"commands.test.summary": "Prova de Joc completada! %s prova(es) estan en funcionament",
	"commands.test.summary.all_required_passed": "Totes les proves requerides s'han superat :)",
	"commands.test.summary.failed": "%s proves requerida/es han fallat :(",
	"commands.test.summary.optional_failed": "%s proves opcional/s ha/n fallat :(",
	"commands.tick.query.percentiles": "Percentils: P50: %sms P95: %sms P99: %sms, mostra: %s",
	"commands.tick.query.rate.running": "Freqüència de tic objectiu: %s per segon\nTemps mitjà per tic: %sms (Objectiu:%sms)",
	"commands.tick.query.rate.sprinting": "Freqüència de tic objectiu: %s per segon (ignorat, només referència).\nTemps mitjà per tic: %sms",
	"commands.tick.rate.success": "Estableix la freqüència de tic objectiu a %s per segon",
	"commands.tick.sprint.report": "Acceleració de tics completada amb %s tics per segon, %s o ms per tic",
	"commands.tick.sprint.stop.fail": "No hi ha cap acceleració de tics en curs",
	"commands.tick.sprint.stop.success": "S'ha interromput l'acceleració de tics",
	"commands.tick.status.frozen": "El joc està congelat",
	"commands.tick.status.lagging": "El joc s'està executant, però no pot mantenir amb la taxa de cicle objectiu",
	"commands.tick.status.running": "El joc s'està executant a una velocitat normal",
	"commands.tick.status.sprinting": "El joc està accelerat",
	"commands.tick.step.fail": "Error a l'avançar el joc: el joc ha d'estar congelat prèviament",
	"commands.tick.step.stop.fail": "No hi ha cap avenç de tics en curs",
	"commands.tick.step.stop.success": "S'ha interromput l'avenç de tics",
	"commands.tick.step.success": "Avançant %s tic(s)",
	"commands.time.no_default_clock": "No hi ha rellotge predeterminat en aquesta dimensió %s",
	"commands.time.no_time_marker_found": "El marcador de temps %s no existeix per al rellotge %s",
	"commands.time.pause": "Rellotge %s pausat",
	"commands.time.query": "Hora: %s tics",
	"commands.time.query.absolute": "El rellotge %s té %s tic(s)",
	"commands.time.query.gametime": "El temps del joc és de %s tic(s)",
	"commands.time.query.timeline": "La línia de temps %s és a %s tic(s)",
	"commands.time.query.timeline.repetitions": "La línia de temps %s s'ha repetit %s vegades",
	"commands.time.rate": "El rellotge %s ara avança %s vegades del temps normal",
	"commands.time.resume": "S'ha reprès el rellotge %s",
	"commands.time.set": "Temps ajustat a %s",
	"commands.time.set.absolute": "Assigna %s a %s tic(s)",
	"commands.time.set.time_marker": "S'ha establert %s al marcador de temps %s",
	"commands.time.wrong_timeline_for_clock": "La línia de temps %s no és vàlid per al rellotge %s",
	...
	"commands.transfer.error.no_players": "S'ha d'especificar almenys un jugador per transferir",
	...
	"commands.version.build_time": "temps_de_construcció = %s",
	"commands.version.data": "Dades = %s",
	"commands.version.header": "Informació de la versió:",
	"commands.version.id": "id = %s",
	"commands.version.name": "nom %s",
	"commands.version.pack.data": "dades_del_paquet = %s",
	"commands.version.pack.resource": "font_del_paquet = %s",
	...
	"commands.waypoint.list.empty": "No punts de referènia a %s",
	"commands.waypoint.list.success": "%s punt(s) de referència a %s: %s",
	"commands.waypoint.modify.color": "El color del punt de referència és ara %s",
	"commands.waypoint.modify.color.reset": "Reiniciar el color del punt de referència",
	"commands.waypoint.modify.style": "L'estil del punt de referència s'ha canviat",
	...
	"component.profile.dynamic": "Dinàmic",
	...
	"connect.p2p.failed.generic": "No s'ha pogut connectar amb el jugador",
	"connect.p2p.failed.signaling": "No és possible connectar-se ara. Torna-ho a intentar més tard.",
	"connect.p2p.failed.timeout": "La sol·licitud de connexió ha expirat",
	"connect.p2p.failed.unreachable": "El jugador no està disponible",
	"connect.reconfiging": "Reconfigurant...",
	"connect.reconfiguring": "Reconfigurant...",
	"connect.transferring": "Transferint a un nou servidor...",
	...
	"createWorld.customize.buffet.search": "Buscant...",
	...
	"dataPack.locator_bar.description": "Mostrar la direcció dels altres jugador en multijugador",
	"dataPack.locator_bar.name": "Barra Localitzadora",
	"dataPack.minecart_improvements.description": "Moviment millorat per a les vagonetes",
	"dataPack.minecart_improvements.name": "Millores per a les vagonetes",
	"dataPack.redstone_experiments.description": "Canvis experimentals de redstone",
	"dataPack.redstone_experiments.name": "Experiments pedra vermella",
	"dataPack.title": "Selecciona paquets de dades",
	"dataPack.trade_rebalance.description": "Intercanvis actualitzats pels vilatans",
	"dataPack.trade_rebalance.name": "Reequilibri d'intercanvis dels vilatans",
	...
	"dataPack.update_1_21.description": "Noves característiques i contingut per a Minecraft 1.21",
	...
	"dataPack.winter_drop.description": "Nou contingut a l'edició del Ivern",
	"dataPack.winter_drop.name": "Entrega del ivern",
	...
	"datapackFailure.title": "Els errors dels paquets de dades seleccionats han impedit que el món es carregui. Pots intentar carregar-lo únicament amb el paquet de dades per defecte (\"mode segur\"), o tornar al menú principal i arreglar-ho manualment.",
	...
	"death.attack.genericKill": "%[1]s ha estat assassinat",
	"death.attack.genericKill.player": "%[1]s ha estat assassinat mentre lluitava amb %[2]s",
	...
	"death.attack.inWall.player": "%[1]s s'ha asfixiat en una paret mentre lluitava amb %[2]s",
	...
	"death.attack.mace_smash": "Vas ser aixafat per ",
	"death.attack.mace_smash.item": "Vas ser aixafat per %[2]s amb",
	...
	"death.attack.onFire.item": "%[1]s ha cremat fins a les cendres mentre lluitava amb %[2]s utilitzant %[3]s",
	"death.attack.onFire.player": "%[1]s s'ha cremat fins a les cendres mentre lluitava amb %[2]s",
	"death.attack.outOfWorld": "%[1]s ha caigut del món",
	"death.attack.outOfWorld.player": "%[1]s no volia viure en el mateix món que %[2]s",
	"death.attack.outsideBorder": "%[1]s s'ha anat més enllà dels confins d'aquest món",
	"death.attack.outsideBorder.player": "%[1]s ha anat més enllà dels confins d'aquest món mentre lluitava amb %[2]s",
	...
	"death.attack.spear": "%[1]s ha estat travessat per %[2]s",
	"death.attack.spear.item": "%[1]s ha estat travessat per %[2]s amb %[3]s",
	"death.attack.stalagmite": "%[1]s ha estat empalat amb una estalagmita",
	"death.attack.stalagmite.player": "%[1]s s'ha empalat en una estalagmita mentre lluitava amb %[2]s",
	...
	"death.attack.thorns.item": "%[1]s ha sigut assassinat per %[3]s mentre provava ferir a %[2]s",
	...
	"debug.crash.message.rebindable": "%s + %s està pressionat. Això farà que el joc falli tret que es deixi anar.",
	...
	"debug.creative_spectator.help": "F3 + N = Canvia entre el mode de joc anterior <-> espectador",
	...
	"debug.entry.currently.alwaysOn": "%s: Sempre activada",
	"debug.entry.currently.inF3": "%s: Només amb F3",
	"debug.entry.currently.inOverlay": "%s: Actualment només a la superposició de depuració",
	"debug.entry.currently.never": "%s: Apagada",
	"debug.entry.f3": "Amb F3",
	...
	"debug.options.category.renderer": "Renderitzadors de debug",
	"debug.options.category.text": "Pantalla de text de debug",
	"debug.options.help": "F3 + F5 = Modificar opcions de debug",
	"debug.options.notAllowed.tooltip": "No visible amb les opcions de debug reduïdes",
	"debug.options.profile.default": "Perfil de debug",
	"debug.options.profile.performance": "Perfil de rendiment",
	"debug.options.search": "Buscar...",
	"debug.options.title": "Opcions de debug",
	"debug.options.warning": "Aquestes opcions són només per a proves. Poden alentir l’ordinador, tancar el joc o fer que el caganer faci de les seves.",
	...
	"debug.profiling.start.rebindable": "S’ha iniciat el perfilatge durant %s segons. Utilitza %s + %s per aturar-lo abans",
	...
	"disconnect.ignoring_status_request": "Ignorant sol·licitud d'estat",
	...
	"editGamerule.inGame.button": "Editar Regles del Joc...",
	"editGamerule.inGame.disabled.tooltip": "Actualitzar les regles del joc requereix permisos d'administrador.",
	...
	"effect.minecraft.breath_of_the_nautilus": "Alè del Nautilus",
	...
	"effect.minecraft.infested": "Infestació",
	...
	"effect.minecraft.oozing": "Supura",
	"effect.minecraft.poison": "Verí",
	"effect.minecraft.raid_omen": "Presagi de setge",
	...
	"effect.minecraft.trial_omen": "Presagi de reptes",
	...
	"effect.minecraft.wind_charged": "Vent carregat",
	...
	"enchantment.minecraft.breach": "Fissura",
	...
	"enchantment.minecraft.sweeping_edge": "Fil desolador",
	...
	"enchantment.minecraft.wind_burst": "Esclata de vent",
	"entity.minecraft.acacia_boat": "El vaixell fet d'acàcia",
	"entity.minecraft.acacia_chest_boat": "El vaixell fet d'acàcia amb un cofre",
	...
	"entity.minecraft.block_display": "Mostra el bloc",
	"entity.minecraft.boat": "Barca",
	"entity.minecraft.bogged": "Aiguamoll",
	"entity.minecraft.breeze": "Brisa",
	"entity.minecraft.breeze_wind_charge": "Càrrega ventosa",
	"entity.minecraft.camel": "Dromedari",
	"entity.minecraft.camel_husk": "Pell de camell",
	...
	"entity.minecraft.chest_boat": "Barca de bedoll amb cofre",
	...
	"entity.minecraft.copper_golem": "Gòlem de coure",
	"entity.minecraft.cow": "Vaca",
	"entity.minecraft.creaking": "Cruixidor",
	"entity.minecraft.creaking_transient": "Cruixidor",
	...
	"entity.minecraft.ominous_item_spawner": "Generador d'ítems ominós",
	"entity.minecraft.painting": "Quadre",
	"entity.minecraft.pale_oak_boat": "Barca de roure pàl·lid",
	"entity.minecraft.pale_oak_chest_boat": "Barca de roure pàl·lid cofre",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Assedegat",
	...
	"entity.minecraft.splash_potion": "Poció llancívola",
	"entity.minecraft.spruce_boat": "Barca de pi",
	"entity.minecraft.spruce_chest_boat": "Barca de pi amb cofre",
	...
	"event.minecraft.raid.defeat.full": "Setge - Derrota",
	"event.minecraft.raid.raiders_remaining": "Assaltants restants: %s",
	"event.minecraft.raid.victory": "Victòria",
	"event.minecraft.raid.victory.full": "Setge - Victòria",
	"filled_map.buried_treasure": "Mapa del tresor ",
	"filled_map.explorer_jungle": "Mapa d'exploració de la jungla",
	"filled_map.explorer_swamp": "Mapa d'exploració del pantà",
	"filled_map.id": "ID %s",
	...
	"filled_map.trial_chambers": "Mapa de cambra de reptes",
	"filled_map.unknown": "Mapa desconegut",
	"filled_map.village_desert": "Mapa d'exploració del poble del desert",
	"filled_map.village_plains": "Mapa d'exploració del poble de les planes",
	"filled_map.village_savanna": "Mapa d'exploració del poble de la sabana",
	"filled_map.village_snowy": "Mapa d'exploració del poble nevat",
	"filled_map.village_taiga": "Mapa d'exploració del poble de taigà",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Permetre nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Controla si els jugadors poden accedir al nether.",
	"gamerule.allowFireTicksAwayFromPlayer": "Carregar foc lluny dels jugadors",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Controla si el foc o la lava haurien d'estar carregats a més de 8 chunks de distància de qualsevol jugador",
	...
	"gamerule.commandBlocksEnabled": "Permetre blocs de comandaments",
	...
	"gamerule.disablePlayerMovementCheck": "Desactiva la comprovació de moviment dels jugadors",
	...
	"gamerule.doLimitedCrafting.description": "Si s'activa, els jugadors només podran elaborar receptes apreses.",
	"gamerule.doMobLoot": "Deixar caure botí de criatures",
	"gamerule.doMobLoot.description": "Controla els recursos que criatures poden soltar, incloent-hi orbes d'experiència.",
	"gamerule.doMobSpawning": "Generar criatures",
	"gamerule.doMobSpawning.description": "Algunes entitats poden tenir les seves pròpies regles.",
	"gamerule.doPatrolSpawning": "Generar bandes de saquejadors",
	"gamerule.doTileDrops": "Deixar caure blocs",
	"gamerule.doTileDrops.description": "Controla els recursos que blocs poden soltar, incloent-hi orbes d'experiència.",
	...
	"gamerule.enableCommandBlocks": "Permetre blocs de comandaments",
	"gamerule.enderPearlsVanishOnDeath": "Les perles d'Ender desapareixen al morir",
	"gamerule.enderPearlsVanishOnDeath.description": "Controla si les perles d'Ender llençades per un jugador desapareixen quan aquest mor.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Entitats amb passatgers poden utilitzar portals",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Permet entitats amb passatgers teleportar a través de portals del Nether, End i els passatges de l'End.",
	...
	"gamerule.locatorBar": "Activar la barra localitzadora de jugadors",
	"gamerule.locatorBar.description": "Quan s'activa, es mostra una barra a la pantalla per indicar la direcció dels jugadors.",
	...
	"gamerule.maxCommandForkCount": "Límit de contextos en comandaments",
	"gamerule.maxCommandForkCount.description": "Nombre màxim de contextos que es poden emprar en comandaments com 'execute as'.",
	"gamerule.maxEntityCramming": "Límit d'entitats en un mateix bloc",
	"gamerule.minecartMaxSpeed": "Velocitat màxima d'una vagoneta",
	"gamerule.minecartMaxSpeed.description": "Velocitat màxima predeterminada d'una vagoneta en moviment a terra.",
	"gamerule.minecraft.elytra_movement_check": "Fes la comprovació de moviment amb les èlitres",
	"gamerule.minecraft.fire_spread_radius_around_player": "Radi de propagació del foc",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "El radi, en blocs, al voltant d’un jugador dins del qual el foc es pot propagar",
	"gamerule.minecraft.player_movement_check": "Fes la comprovació de moviment del jugador",
	"gamerule.minecraft.raids": "Fes batudes",
	"gamerule.minecraft.universal_anger.description": "Els enemics neutrals enfadats ataquen qualsevol jugador proper, no només el jugador que els ha provocat. Funciona millor si forgive_dead_players està desactivat.",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Retràs del jugador en mode creatiu en el portal del Nether",
	"gamerule.playersNetherPortalCreativeDelay.description": "Temps (en tics) que un jugador en mode creatiu ha de passar dins el portal del Nether per canviar de dimensió.",
	"gamerule.playersNetherPortalDefaultDelay": "Retràs del jugador en mode no-creatiu en el portal del Nether",
	"gamerule.playersNetherPortalDefaultDelay.description": "Temps (en tics) que un jugador sense mode creatiu ha de passar dins el portal del Nether per canviar de dimensió.",
	...
	"gamerule.projectilesCanBreakBlocks": "Projectils poden trencar blocs",
	"gamerule.projectilesCanBreakBlocks.description": "Controla si projectils d'impacte destruiran blocs que són destructibles per ells.",
	"gamerule.pvp": "Permetre combat entre jugadors",
	"gamerule.pvp.description": "Controla si els jugadors tenen permís per provocar mal a altres jugadors.",
	...
	"gamerule.spawnChunkRadius": "Radi del chunk del punt d'aparició",
	"gamerule.spawnChunkRadius.description": "Quantitat de chunks que es mantindran carregats al voltant del punt d'aparició del món superior.",
	"gamerule.spawnMonsters": "Generar monstres",
	"gamerule.spawnMonsters.description": "Controla si els monstres es poden generar monstres de forma natural.",
	"gamerule.spawnRadius": "Radi del punt de reaparició",
	"gamerule.spawnRadius.description": "Controla la mida de l'àrea al voltant del punt d'aparició que poden aparèixer jugadors.",
	"gamerule.spawnerBlocksEnabled": "\nPermetre generadors de monstres",
	"gamerule.spectatorsGenerateChunks": "Permet la generació de terreny en mode espectador",
	"gamerule.tntExplodes": "Permetre activar la TNT i fer-ne explotar",
	...
	"gui.abuseReport.attestation": "Enviant aquesta denúncia confirmes que la informació que has proveït és precisa i complet segons el teu millor coneixement.",
	"gui.abuseReport.comments": "Comentaris",
	"gui.abuseReport.describe": "Compartir detalls ens ajudarà a prendre una decisió adequada.",
	"gui.abuseReport.discard.content": "Si surts ara, s'esborrarà aquesta denúncia i els teus comentaris.\nEstàs segur que vols sortir?",
	"gui.abuseReport.discard.discard": "Surt i descarta la denúncia",
	"gui.abuseReport.discard.draft": "Desar com a esborrany",
	"gui.abuseReport.discard.return": "Seguir editant",
	"gui.abuseReport.discard.title": "Vols descartar la denúncia i els comentaris?",
	"gui.abuseReport.draft.content": "Vols seguir editant la denúncia existent o descartar-la i crear-ne una de nova?",
	"gui.abuseReport.draft.discard": "Descartar",
	"gui.abuseReport.draft.edit": "Seguir editant",
	"gui.abuseReport.draft.quittotitle.content": "Vols seguir editant la denúncia o descartar-la?",
	"gui.abuseReport.draft.quittotitle.title": "L'esborrany de la denúncia es perdrà si surts",
	"gui.abuseReport.draft.title": "Editar l'esborrany de la denúncia de xat?",
	"gui.abuseReport.error.title": "Problema en enviar la teva denúncia",
	"gui.abuseReport.message": "On has observat el mal comportament?\nAixò ens ajudarà en la investigació del teu cas.",
	"gui.abuseReport.more_comments": "Si us plau, descriu el que ha passat:",
	"gui.abuseReport.name.comment_box_label": "Si us plau, descriu per què vols denunciar aquest nom:",
	"gui.abuseReport.name.reporting": "Estàs denunciant a \"%s\".",
	"gui.abuseReport.name.title": "Denuncia nom d'un jugador",
	"gui.abuseReport.observed_what": "Per què estàs denunciant això?",
	"gui.abuseReport.read_info": "Aprèn més sobre les denúncies",
	...
	"gui.abuseReport.reason.generic": "Els vull denunciar",
	"gui.abuseReport.reason.generic.description": "Estic enfadat amb ells / han fet una cosa que no m'agrada.",
	...
	"gui.abuseReport.reason.sexually_inappropriate.description": "Aparences que mostren elements de naturalesa sexual, òrgans sexuals o violència sexual",
	...
	"gui.abuseReport.report_sent_msg": "Hem rebut la teva denúncia. Gràcies!\nEl nostre equip ho revisarà al més aviat possible.",
	"gui.abuseReport.select_reason": "Tria una categoria per a la denúncia",
	"gui.abuseReport.send": "Enviar denúncia",
	"gui.abuseReport.send.comment_too_long": "Si us plau, sigues més breu",
	...
	"gui.abuseReport.send.no_reason": "Si us plau, tria una categoria per a la denúncia",
	"gui.abuseReport.send.not_attested": "Si us plau, llegeix el text anterior i marca la casella de selecció per enviar la denúncia",
	...
	"gui.abuseReport.skin.title": "Denuncia l'aparença d'un jugador",
	...
	"gui.abuseReport.type.skin": "Aparença del jugador",
	"gui.acknowledge": "Entès",
	"gui.advancements": "Avenços",
	"gui.all": "Totes",
	"gui.back": "Torna",
	"gui.banned.description": "%s\n\n%s\n\nAprèn més al següent enllaç: %s",
	"gui.banned.description.permanent": "El teu compte ha estat suspès permanentment; això vol dir que no podràs jugar en línia o unir-te a Realms.",
	...
	"gui.banned.name.description": "El teu nom actual - %s- no compleix amb les normes de la comunitat. Pots jugar individual, però hauràs de canviar el teu nom per a jugar en línia.\n\nAprèn més o presenta una revisió del cas al següent enllaç: %s",
	"gui.banned.name.title": "Nom no permès en multijugador",
	...
	"gui.banned.skin.description": "La teva aparença actual no compleix amb les normes de la comunitat. Encara pots jugar amb una aparença predeterminada, o selecciona una nova. \n\nAprèn més o presenta una revisió del cas al següent enllaç: %s",
	"gui.banned.skin.title": "Aparença no permès",
	...
	"gui.chatReport.draft.title": "Editar l'esborrany de l'informe del xat?",
	...
	"gui.chatReport.report_sent_msg": "Hem rebut el vostre informe amb èxit. Gràcies!\n\nEl nostre equip el revisarà al més aviat possible.",
	...
	"gui.chatReport.title": "Denunciar missatge d'un jugador",
	...
	"gui.fileDropFailure.detail": "%s arxius s'han rebutjat",
	"gui.fileDropFailure.title": "Error en afegir arxius",
	...
	"gui.friends.confirm_unfriend": "Segur que vols eliminar aquest jugador de la teva llista d'amics?",
	"gui.friends.copy_to_clipboard": "Copiar al porta-retalls",
	"gui.friends.decline": "Rebutjar",
	"gui.friends.empty_nickname": "Insereix un nom de perfil vàlid abans d'enviar una sol·licitud d'amistat",
	"gui.friends.empty_state": "Els amics que afegeixis es mostraran aquí.\n\nGestiona la seguretat en línia amb el teu %s.",
	"gui.friends.empty_state.link": "Compte de Microsoft",
	"gui.friends.enter_nickname": "Insereix nom del perfil",
	"gui.friends.error.connection_issue": "La llista d'amics no està funcionant.\n\nComprova la teva connexió a internet i torna-ho a intentar.",
	"gui.friends.error.failed.message": "No es pot enviar la teva sol·licitud d'amistat ara mateix",
	"gui.friends.error.forbidden.message": "No s'ha pogut realitzar aquesta acció. Pot ser degut a la configuració de privacitat del compte.",
	"gui.friends.error.generic": "Alguna cosa està malament - amb aquesta funció, no amb els teus amics!\n\nTorna-ho a intentar més tard.",
	"gui.friends.error.rateLimited.message": "Estàs realitzant accions en la llista d'amics massa ràpid. Per favor, espera un moment i torna-ho a intentar.",
	"gui.friends.error.temporary_unavailable": "La llista d'amics no està funcionant en aquests moments.\n\nTorna-ho a intentar més tard.",
	"gui.friends.error.unavailable.message": "El servei de la llista d'amics no està disponible ara mateix. Per favor, comprova la teva connexió a internet i torna-ho a provar més tard.",
	"gui.friends.error.upgrade_needed": "Actualitza el joc per a accedir a la teva llista d'amics.",
	"gui.friends.error.user_may_lack_active_profile": "No hi ha cap jugador amb aquest nom de perfil",
	...
	"gui.friends.multiplayer.join_request_accept": "Acceptar la sol·licitud per unir-se al món",
	"gui.friends.multiplayer.join_request_reject": "Rebutjar la sol·licitud per unir-se al món",
	"gui.friends.my_profile_name": "El meu nom de perfil: ",
	"gui.friends.my_profile_name.narration": "Copiar el nom de perfil %s al porta-retalls",
	"gui.friends.narration.button.accept": "Prem Enter per acceptar la sol·licitud d'amistat de %s",
	"gui.friends.narration.button.cancel_request": "Prem Enter per cancel·lar la sol·licitud d'amistat a %s",
	"gui.friends.narration.button.decline": "Prem Enter per rebutjar la sol·licitud d'amistat de %s",
	"gui.friends.narration.button.unfriend": "Prem Enter per eliminar a %s de la llista d'amics",
	...
	"gui.friends.presence.status.playing_hosted_server": "En un món al qual és possible unir-se",
	...
	"gui.friends.toast.friend_added.message": "%s ha acceptat la teva sol·licitud d'amistat",
	"gui.friends.toast.friend_invited.message": "%s ha sigut convidat a unir-se al teu món.",
	"gui.friends.toast.friend_removed.message": "%s ha sigut eliminat de la teva llista d'amics",
	"gui.friends.toast.generic_error": "S'ha produït un error inesperat mentre s'actualitzava la teva llista d'amics. Per favor, torna-ho a intentar més tard.",
	"gui.friends.toast.host_invite_expired.message": "La invitació a %s per unir-se a aquest món ha expirat.",
	"gui.friends.toast.invite_from_friend.message": "%s t'ha convidat a unir-te al seu món. Obre la llista d'amics prement \"%s\" per unir-te",
	"gui.friends.toast.join_invite_expired.message": "La invitació per a unir-se al món de %s ha expirat.",
	"gui.friends.toast.join_request.message": "%s ha sol·licitat unir-se al teu món. Obre la llista d'amics prement \"%s\" o accedint a través del menú de joc.",
	"gui.friends.toast.request_accepted.message": "Ara ja ets amic de %s",
	...
	"gui.friends.toast.request_to_join_friend.message": "S'ha enviat la sol·licitud per unir-se al món a %s",
	"gui.friends.toast.requests_accepted_multiple.message": "%s amics han acceptat les teves sol·licituds d'amistat",
	...
	"gui.loadingMinecraft": "Carregant Minecraft",
	...
	"gui.none": "Cap",
	"gui.ok": "Fet",
	"gui.open_report_dir": "Obre el directori d'informes",
	"gui.packSelection.search": "Buscar...",
	"gui.privacy_link.message": "Obre aquest enllaç per gestionar la configuració de la teva privacitat i seguretat en línia.",
	"gui.privacy_link.title": "Els canvis a la configuració de Xbox poden tardar un temps a aplicar-se.\n\nSi no s'actualitzen, reinicia el joc.",
	"gui.proceed": "Continua",
	"gui.recipebook.moreRecipes": "Fes clic dret per a més receptes",
	"gui.recipebook.next_page": "Següent Pàgina",
	...
	"gui.remove": "Eliminar",
	"gui.report_to_server": "Informa el servidor",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Aquest jugador no pot ser reportat perquè el xat està deshabilitat o bloquejat",
	...
	"gui.toRealms": "Torna a la llista de servidors de Realm",
	"gui.toTitle": "Torna al menú principal",
	"gui.toWorld": "Tornar a la llista de mons",
	"gui.togglable_slot": "Fes clic per desactivar la ranura",
	"gui.up": "Amunt",
	"gui.waitingForResponse.button.inactive": "Tornant (%ss)",
	"gui.waitingForResponse.title": "Esperant un servidor",
	"gui.yes": "Sí",
	...
	"item.minecraft.angler_pottery_shard": "Fragment de ceràmica de canya de pescar",
	"item.minecraft.angler_pottery_sherd": "Fragment de ceràmica de canya de pescar",
	"item.minecraft.apple": "Poma",
	"item.minecraft.archer_pottery_shard": "Fragment de ceràmica d'arquer",
	"item.minecraft.archer_pottery_sherd": "Fragment de ceràmica d'arquer",
	"item.minecraft.armadillo_scute": "Escata d'armadillo",
	"item.minecraft.armadillo_spawn_egg": "Generar armadillo",
	"item.minecraft.armor_stand": "Maniquí",
	"item.minecraft.arms_up_pottery_shard": "Fragment de ceràmica de ninot",
	"item.minecraft.arms_up_pottery_sherd": "Fragment de ceràmica de ninot",
	...
	"item.minecraft.black_bundle": "Sarró Negre",
	"item.minecraft.black_dye": "Tint negre",
	"item.minecraft.black_harness": "Arnès Negre",
	"item.minecraft.blade_pottery_shard": "Fragment de ceràmica d'espasa",
	"item.minecraft.blade_pottery_sherd": "Fragment de ceràmica d'espasa",
	...
	"item.minecraft.blue_bundle": "Sarró Blau",
	"item.minecraft.blue_dye": "Tint blau",
	"item.minecraft.blue_egg": "Ou blau",
	"item.minecraft.blue_harness": "Arnès Blau",
	"item.minecraft.bogged_spawn_egg": "Generador d'aiguamoll",
	"item.minecraft.bolt_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Patró d'armadura: Reblat",
	"item.minecraft.bone": "Os",
	"item.minecraft.bone_meal": "Farina d'ossos",
	"item.minecraft.book": "Llibre",
	"item.minecraft.bordure_indented_banner_pattern": "Patró de bordura dentada",
	...
	"item.minecraft.brewer_pottery_shard": "Fragment de ceràmica de poció",
	"item.minecraft.brewer_pottery_sherd": "Fragment de ceràmica de poció",
	"item.minecraft.brewing_stand": "Altar de pocions",
	"item.minecraft.brick": "Maó",
	"item.minecraft.brown_bundle": "Sarró marró",
	"item.minecraft.brown_dye": "Tint marró",
	"item.minecraft.brown_egg": "Ou marró",
	"item.minecraft.brown_harness": "Arnès Marró",
	"item.minecraft.brush": "Pinzell",
	"item.minecraft.bucket": "Galleda",
	"item.minecraft.bundle": "Sarró",
	"item.minecraft.bundle.empty": "Buit",
	"item.minecraft.bundle.empty.description": "Pot contenir una pila mixta d'ítems",
	"item.minecraft.bundle.full": "Ple",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "Fragment de ceràmica de foc",
	"item.minecraft.burn_pottery_sherd": "Fragment de ceràmica de foc",
	"item.minecraft.camel_husk_spawn_egg": "Ou de generació Dromedari esquelet sec",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Patró d'armadura: Costa",
	...
	"item.minecraft.copper_golem_spawn_egg": "Generar gòlem de coure",
	...
	"item.minecraft.copper_nautilus_armor": "Armadura de Nautilus de Coure",
	"item.minecraft.copper_nugget": "Grànul de coure",
	...
	"item.minecraft.cyan_bundle": "Sarró cian",
	"item.minecraft.cyan_dye": "Tint cian",
	"item.minecraft.cyan_harness": "Arnès Cian",
	"item.minecraft.danger_pottery_shard": "Fragment de ceràmica de creeper",
	"item.minecraft.danger_pottery_sherd": "Fragment de ceràmica de creeper",
	...
	"item.minecraft.diamond_nautilus_armor": "Armadura de Nautilus de Diamant",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Patró d'armadura: Duna",
	...
	"item.minecraft.explorer_pottery_shard": "Fragment de ceràmica de mapa",
	"item.minecraft.explorer_pottery_sherd": "Fragment de ceràmica de mapa",
	"item.minecraft.eye_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Patró d'armadura: Ull",
	"item.minecraft.feather": "Ploma",
	"item.minecraft.fermented_spider_eye": "Ull d'aranya fermentat",
	"item.minecraft.field_masoned_banner_pattern": "Patró de maçonat",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Patró d'armadura: Espiral",
	"item.minecraft.flow_banner_pattern": "Patró d'espiral",
	"item.minecraft.flow_banner_pattern.desc": "Espiral",
	"item.minecraft.flow_banner_pattern.new": "Estampat d'espiral",
	"item.minecraft.flow_pottery_sherd": "Fragment de ceràmica d'espiral",
	"item.minecraft.flower_banner_pattern": "Patró de flor",
	"item.minecraft.flower_banner_pattern.desc": "Estampat de flor",
	"item.minecraft.flower_banner_pattern.new": "Estampat de flor",
	"item.minecraft.flower_pot": "Test",
	"item.minecraft.fox_spawn_egg": "Generar guineu",
	"item.minecraft.friend_pottery_shard": "Fragment de ceràmica d'amistat",
	"item.minecraft.friend_pottery_sherd": "Fragment de ceràmica d'amistat",
	...
	"item.minecraft.globe_banner_pattern.new": "Estampat de planeta",
	...
	"item.minecraft.golden_nautilus_armor": "Armadura de Nautilus daurada",
	"item.minecraft.golden_pickaxe": "Pic d'or",
	"item.minecraft.golden_shovel": "Pala d'or",
	"item.minecraft.golden_spear": "Llança daurada",
	"item.minecraft.golden_sword": "Espasa d'or",
	"item.minecraft.gray_bundle": "Sarró gris",
	"item.minecraft.gray_dye": "Tint gris",
	"item.minecraft.gray_harness": "Arnès Gris",
	"item.minecraft.green_bundle": "Sarró verd",
	"item.minecraft.green_dye": "Tint verd",
	"item.minecraft.green_harness": "Arnès verd",
	"item.minecraft.guardian_spawn_egg": "Generar guardià",
	"item.minecraft.gunpowder": "Pólvora",
	"item.minecraft.guster_banner_pattern": "Patró de brisa",
	"item.minecraft.guster_banner_pattern.desc": "Brisa",
	"item.minecraft.guster_banner_pattern.new": "Estampat de brisa",
	"item.minecraft.guster_pottery_sherd": "Fragment de ceràmica de brisa",
	"item.minecraft.happy_ghast_spawn_egg": "Generar Ghast Feliç",
	"item.minecraft.harness": "Arnès",
	"item.minecraft.heart_of_the_sea": "Cor del mar",
	"item.minecraft.heart_pottery_shard": "Fragment de ceràmica d'amor",
	"item.minecraft.heart_pottery_sherd": "Fragment de ceràmica d'amor",
	"item.minecraft.heartbreak_pottery_shard": "Fragment de ceràmica de desamor",
	"item.minecraft.heartbreak_pottery_sherd": "Fragment de ceràmica de desamor",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.host_armor_trim_smithing_template.new": "Disseny d'armadura d'amfitrió",
	"item.minecraft.howl_pottery_shard": "Fragment de ceràmica de llop",
	"item.minecraft.howl_pottery_sherd": "Fragment de ceràmica de llop",
	...
	"item.minecraft.iron_nautilus_armor": "Armadura de Nautilus de ferro",
	...
	"item.minecraft.light_blue_bundle": "Sarró blau cel",
	"item.minecraft.light_blue_dye": "Tint blau clar",
	"item.minecraft.light_blue_harness": "Arnès Blau Clar",
	"item.minecraft.light_gray_bundle": "Sarró gris clar",
	"item.minecraft.light_gray_dye": "Tint gris clar",
	"item.minecraft.light_gray_harness": "Arnès Gris Clar",
	"item.minecraft.lime_bundle": "Sarró llima",
	"item.minecraft.lime_dye": "Tint llima",
	"item.minecraft.lime_harness": "Arnès Llima",
	...
	"item.minecraft.lingering_potion.effect.infested": "Poció d'infestació persistent",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Poció de supura persistent",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Poció de teixidura persistent",
	"item.minecraft.lingering_potion.effect.wind_charged": "Poció de vent carregat persistent",
	"item.minecraft.llama_spawn_egg": "Generar llama",
	"item.minecraft.lodestone_compass": "Brúixola guia",
	"item.minecraft.mace": "Maça",
	"item.minecraft.magenta_bundle": "Sarró magenta",
	"item.minecraft.magenta_dye": "Tint magenta",
	"item.minecraft.magenta_harness": "Arnès Magenta",
	...
	"item.minecraft.miner_pottery_sherd": "Fragment de ceràmica de miner",
	"item.minecraft.mojang_banner_pattern": "Patró de Mojang",
	"item.minecraft.mojang_banner_pattern.desc": "Estampat de Mojang",
	"item.minecraft.mojang_banner_pattern.new": "Estampat de Mojang",
	"item.minecraft.mooshroom_spawn_egg": "Generar mooshroom",
	"item.minecraft.mourner_pottery_shard": "Fragment de ceràmica de Vigilant",
	"item.minecraft.mourner_pottery_sherd": "Fragment de ceràmica de Vigilant",
	...
	"item.minecraft.netherite_horse_armor": "Armadura de cavall de netherita",
	"item.minecraft.netherite_ingot": "Lingot de netherita",
	"item.minecraft.netherite_leggings": "Malles de netherita",
	"item.minecraft.netherite_nautilus_armor": "Armadura de Nautilus de netherita",
	...
	"item.minecraft.netherite_upgrade_smithing_template": "Patró de ferreria",
	...
	"item.minecraft.ominous_bottle": "Ampolla ominosa",
	"item.minecraft.ominous_trial_key": "Clau de reptes ominós",
	"item.minecraft.orange_bundle": "Sarró taronja",
	"item.minecraft.orange_dye": "Tint taronja",
	"item.minecraft.orange_harness": "Arnès Cian",
	"item.minecraft.painting": "Quadre",
	"item.minecraft.pale_oak_boat": "Barca de roure pàl·lid",
	"item.minecraft.pale_oak_chest_boat": "Barca de roure pàl·lid amb cofre",
	"item.minecraft.panda_spawn_egg": "Generar panda",
	"item.minecraft.paper": "Paper",
	"item.minecraft.parched_spawn_egg": "Ou de generació Assedegat",
	...
	"item.minecraft.piglin_banner_pattern.new": "Estampat de musell",
	...
	"item.minecraft.pink_bundle": "Sarró rosa",
	"item.minecraft.pink_dye": "Tint rosa",
	"item.minecraft.pink_harness": "Arnès Rosa",
	"item.minecraft.pitcher_plant": "Planta gerro",
	"item.minecraft.pitcher_pod": "Beina de planta gerro",
	"item.minecraft.plenty_pottery_shard": "Fragment de ceràmica de cofre",
	"item.minecraft.plenty_pottery_sherd": "Fragment de ceràmica de cofre",
	...
	"item.minecraft.potion.effect.oozing": "Poció de supura",
	...
	"item.minecraft.potion.effect.wind_charged": "Poció de vent carregat",
	"item.minecraft.pottery_shard_archer": "Fragment de ceràmica d'arquer",
	"item.minecraft.pottery_shard_arms_up": "Fragment de ceràmica de ninot",
	"item.minecraft.pottery_shard_prize": "Fragment de ceràmica de joia",
	...
	"item.minecraft.prize_pottery_shard": "Fragment de ceràmica de joia",
	"item.minecraft.prize_pottery_sherd": "Fragment de ceràmica de joia",
	...
	"item.minecraft.purple_bundle": "Sarró lila",
	"item.minecraft.purple_dye": "Tint lila",
	"item.minecraft.purple_harness": "Arnès Violeta",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Patró de ferreria",
	...
	"item.minecraft.red_bundle": "Sarró vermell",
	"item.minecraft.red_dye": "Tint vermell",
	"item.minecraft.red_harness": "Arnès Vermell",
	"item.minecraft.redstone": "Pols de redstone",
	"item.minecraft.resin_brick": "Maons de resina",
	"item.minecraft.resin_clump": "Grumoll de resina",
	"item.minecraft.rib_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Patró d'armadura de costella",
	...
	"item.minecraft.scrape_pottery_sherd": "Fragment de ceràmica de destral",
	"item.minecraft.scute": "Escata",
	"item.minecraft.sentry_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Patró d'armadura de sentinella",
	"item.minecraft.shaper_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Patró d'armadura de modelador",
	"item.minecraft.sheaf_pottery_shard": "Fragment de ceràmica de palla",
	"item.minecraft.sheaf_pottery_sherd": "Fragment de ceràmica de blat",
	...
	"item.minecraft.shelter_pottery_sherd": "Fragment de ceràmica de refugi",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Disseny d'armadura de silenci",
	...
	"item.minecraft.skull_banner_pattern.new": "Estampat de calavera",
	"item.minecraft.skull_pottery_shard": "Fragment de ceràmica de calavera",
	"item.minecraft.skull_pottery_sherd": "Fragment de ceràmica de calavera",
	...
	"item.minecraft.snort_pottery_shard": "Fragment de ceràmica d'ensumador",
	"item.minecraft.snort_pottery_sherd": "Fragment de ceràmica d'ensumador",
	"item.minecraft.snout_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Disseny d'armadura de musell",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Disseny d'armadura d'agulles",
	...
	"item.minecraft.splash_potion.effect.infested": "Poció d'infestació llancívola",
	...
	"item.minecraft.splash_potion.effect.oozing": "Poció de supura llancívola",
	...
	"item.minecraft.splash_potion.effect.weaving": "Poció de teixidura llancívola",
	"item.minecraft.splash_potion.effect.wind_charged": "Poció de carregada de vent llancívola",
	...
	"item.minecraft.sulfur_cube_bucket": "Galleda amb cub de sofre",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Disseny d'armadura de la marea",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Fletxa de supura",
	...
	"item.minecraft.tipped_arrow.effect.wind_charged": "Fletxa de vent carregat",
	...
	"item.minecraft.turtle_scute": "Escata de tortuga",
	"item.minecraft.turtle_spawn_egg": "Generar tortuga",
	"item.minecraft.vex_armor_trim_smithing_template": "Patró de ferreria",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Disseny d'armadura de vigilant",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Disseny d'armadura de cerca camins",
	"item.minecraft.wheat": "Blat",
	"item.minecraft.wheat_seeds": "Llavors de blat",
	"item.minecraft.white_bundle": "Sarró blanc",
	"item.minecraft.white_dye": "Tint blanc",
	"item.minecraft.white_harness": "Arnès Blanc",
	"item.minecraft.wild_armor_trim_smithing_template": "Patró de ferreria",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Disseny d'armadura salvatge",
	"item.minecraft.wind_charge": "Càrrega Ventosa",
	...
	"item.minecraft.yellow_bundle": "Sarró groc",
	"item.minecraft.yellow_dye": "Tint groc",
	"item.minecraft.yellow_harness": "Arnès Groc",
	"item.minecraft.zoglin_spawn_egg": "Generar zoglin",
	"item.minecraft.zombie_horse_spawn_egg": "Generar cavall zombi",
	"item.minecraft.zombie_nautilus_spawn_egg": "Generar del Nautilus",
	...
	"item.modifiers.saddle": "En equipar muntura:",
	"item.nbt_tags": "NBT: %s etiqueta(es)",
	"item.op_block_warning.line1": "Advertència:",
	"item.op_block_warning.line2": "Podrien executar-se comandaments amb aquest bloc",
	"item.op_block_warning.line3": "No el facis servir a menys que coneguis el seu interior!",
	"item.spawn_egg.peaceful": "Desactivat en pacífic",
	...
	"jigsaw_block.placement_priority.tooltip": "Quan aquest bloc trencaclosques es connecta a una peça, aquest és l'ordre en el qual la peça és processada per connexions en l'estructura més amplia.\n\nPeces seran processades en prioritat descendent amb l'ordre d'inserció de llaços trencats.",
	"jigsaw_block.pool": "Grup objectiu:",
	"jigsaw_block.selection_priority": "Prioritat de selecció:",
	"jigsaw_block.selection_priority.tooltip": "Quan la peça pare s'està processant per connexions, aquest és l'ordre en el qual aquest bloc trencaclosques atempta de connectar-se a l'objectiu.\n\nTrencaclosques seran processats de prioritat descendent amb ordres aleatòries trencant llaços.",
	...
	"key.category.minecraft.misc": "Miscel·lanis",
	...
	"key.debug.copyRecreateCommand": "Copia els arxius",
	"key.debug.crash": "Depura l’error",
	"key.debug.debugOptions": "Opcions de depuració",
	"key.debug.dumpDynamicTextures": "Aboca les textures dinàmiques",
	"key.debug.dumpVersion": "Aboca la informació de la versió",
	"key.debug.focusPause": "Activa/desactiva pausa en perdre el focus",
	"key.debug.fpsCharts": "Gràfiques de FPS",
	"key.debug.lightmapTexture": "Textura del mapa de llum",
	"key.debug.modifier": "Tecla modificadora de depuració",
	"key.debug.networkCharts": "Gràfiques de xarxa",
	"key.debug.overlay": "Activa/desactiva superposició",
	"key.debug.profiling": "Inicia/Atura el perfilat",
	"key.debug.profilingChart": "Gràfica de perfilat",
	"key.debug.reloadChunk": "Torna a carregar els chunks",
	"key.debug.reloadResourcePacks": "Torna a carregar els paquets de recursos",
	"key.debug.showAdvancedTooltips": "Mostra consells avançats",
	"key.debug.showChunkBorders": "Mostra els límits dels chunks",
	"key.debug.showHitboxes": "Mostra les hitboxes",
	"key.debug.spectate": "Passa d’espectador",
	"key.debug.switchGameMode": "Canviador de mode de joc",
	...
	"key.spectatorHotbar": "Selecciona a la barra d'ítems",
	"key.spectatorOutlines": "Destacar jugadors (espectadors)",
	"key.sprint": "Córrer",
	"key.swapOffhand": "Intercanviar l'objecte amb la mà secundària",
	"key.toggleGui": "Activa/desactiva el menú",
	"key.togglePerspective": "Canviar perspectiva",
	"key.toggleSpectatorShaderEffects": "Activa/desactiva els efectes de l'ombra del mode espectador",
	"key.use": "Utilitzar ítem/col·locar bloc",
	"known_server_link.announcements": "Anuncis",
	"known_server_link.community": "Comunitat",
	"known_server_link.community_guidelines": "Directius de la comunitat",
	"known_server_link.feedback": "Comentaris",
	"known_server_link.forums": "Fòrums",
	"known_server_link.news": "Notícies",
	"known_server_link.report_bug": "Informa d'un error del servidor",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Afegir servidor",
	"manageServer.edit.title": "Modifica la informació del servidor",
	"manageServer.enterIp": "IP del servidor",
	"manageServer.enterName": "Nom del servidor",
	"manageServer.resourcePack": "Paquet de recursos del servidor",
	"manageServer.resourcePack.disabled": "Desactivat",
	...
	"mco.account.privacy.info.button": "Llegeix més sobre GDPR",
	"mco.account.privacy.information": "Mojang implementa certs procediments per ajudar a protegir als menors i la seva privacitat, que consisteixen en complir amb la Llei de Protecció de Privacitat Infantil a Internet (COPPA) i el Reglament General de Protecció de Dades (RGPD).\n\nHas de tenir consentiment parental abans de poder tenir accés al teu compte de Realms.",
	...
	"mco.backup.entry.enabledPack": "Paquet(s) activat(s)",
	...
	"mco.backup.entry.worldType.adventureMap": "Mapa d’aventura",
	...
	"mco.backup.info.title": "Canvis de l'última còpia de seguretat",
	"mco.backup.narration": "Còpia de seguretat de %s",
	"mco.backup.nobackups": "Aquest realm no disposa de cap còpia de seguretat actualment.",
	...
	"mco.client.outdated.stable.version": "La teva versió del client (%s) no és compatible amb Realms.\n\nSi us plau, utilitza la versió més recent de Minecraft.",
	"mco.client.unsupported.snapshot.version": "La teva versió del client (%s) no és compatible amb Realms.\n\nRealms no és disponible per aquesta versió de prova.",
	"mco.compatibility.downgrade": "Degradar",
	"mco.compatibility.downgrade.description": "Aquest món era últim jugat en la versió %s; estàs a la versió %s. Carregant un món en una versió anterior el pot corrompre - no et podem assegurar que es carregui o funcioni. \n\nUna còpia de seguretat del món serà desada en \"Còpies de seguretat\". Si us plau, restaura el teu món si és necessari.",
	"mco.compatibility.incompatible.popup.title": "Versió incompatible",
	"mco.compatibility.incompatible.releaseType.popup.message": "El món que t'estàs intentant unir no és compatible amb la teva versió del joc.",
	"mco.compatibility.incompatible.series.popup.message": "Aquest món era últim jugat en la versió %s; estàs en la versió %s.\n\nAquestes sèries no són compatibles amb un a l'altre. Necessites un nou món per jugar-hi en aquesta versió.",
	"mco.compatibility.unverifiable.message": "L'última versió en què aquest món es va jugar no s'ha pogut verificar. Si el món és actualitzat o rebaixat, una còpia de seguretat es crearà automàticament i desat sota \"Còpies de seguretat\".",
	"mco.compatibility.unverifiable.title": "Comptabilitat no verificable",
	"mco.compatibility.upgrade": "Actualitzar",
	"mco.compatibility.upgrade.description": "Aquest món era últim jugat en la versió %s; estàs en la versió %s.\n\nUna còpia de seguretat del teu món es desarà sota \"Còpies de seguretat\". Si us plau, restaura el teu món si cal.",
	"mco.compatibility.upgrade.friend.description": "Aquest món era últim jugat en la versió %s; estàs en la versió %s.\n\nUna còpia de seguretat del món es desarà sota \"Còpies de seguretat\". \n\nL'amo del Realm pot restaurar el món si cal.",
	"mco.compatibility.upgrade.title": "Segur que vols actualitzar aquest món?",
	...
	"mco.configure.world.buttons.open": "Obre el realm",
	...
	"mco.configure.world.buttons.save": "Desar",
	...
	"mco.configure.world.close.question.title": "Necessites fer canvis sense cap interrupció?",
	...
	"mco.configure.world.loading": "Carregant Realm",
	"mco.configure.world.location": "Localització",
	"mco.configure.world.minigame": "Actual: %s",
	"mco.configure.world.name": "Nom del Realm",
	"mco.configure.world.name.validation.whitespace": "No ha de començar ni acabar amb espais en blanc. Seran eliminats automàticament.",
	"mco.configure.world.opening": "Obrint el Realm...",
	"mco.configure.world.players.error": "No existeix cap jugador amb aquest nom",
	"mco.configure.world.players.invite.duplicate": "Un jugador amb el nom que has proporcionat ja va ser convidat al Realm",
	"mco.configure.world.players.inviting": "Convidant jugador...",
	...
	"mco.configure.world.resourcepack.question": "Necessites un paquet de recursos personalitzat per jugar en aquest realm\n\nVols descarregar-lo i jugar?",
	...
	"mco.configure.world.settings.expired": "No pots editar la configuració d'un Realm vençut",
	"mco.configure.world.settings.title": "Configuració",
	"mco.configure.world.slot": "Món %s",
	"mco.configure.world.slot.empty": "Buit",
	"mco.configure.world.slot.switch.question.line1": "Es canviarà el seu reialme a un altre món",
	...
	"mco.configure.world.spawnMonsters": "Permetre monstres",
	"mco.configure.world.spawnNPCs": "Generar vilatans",
	"mco.configure.world.spawnProtection": "Protecció del punt de reaparició",
	"mco.configure.world.spawn_toggle.message": "Desactivar aquesta opció eliminarà totes les entitats d'aquest tipus que existeixin",
	"mco.configure.world.spawn_toggle.message.npc": "Desactivar aquesta opció eliminarà totes les entitats d'aquest tipus que existeixin, com els vilatans",
	...
	"mco.configure.world.subscription.title": "Informació de la subscripció",
	...
	"mco.configure.world.uninvite.player": "¿Estàs segur que vols desconvidar '%s'?",
	...
	"mco.download.resourcePack.fail": "No s'ha pogut descarregar el paquet de recursos!",
	...
	"mco.errorMessage.6007": "Usuari està en massa Realms",
	"mco.errorMessage.6008": "Nom del Realm no vàlid",
	"mco.errorMessage.6009": "La descripció del Realm no és vàlida",
	"mco.errorMessage.connectionFailure": "S'ha produït un error, proveu-ho més tard.",
	"mco.errorMessage.generic": "S'ha produït un error: ",
	"mco.errorMessage.initialize.failed": "Error en iniciar el Realm",
	"mco.errorMessage.noDetails": "No s'han proporcionat detalls de l'error",
	"mco.errorMessage.realmsService": "S'ha produït un error (%s):",
	"mco.errorMessage.realmsService.configurationError": "S'ha produït un error inesperat mentre s'editaven les opcions del món",
	"mco.errorMessage.realmsService.connectivity": "No s'ha pogut connectar a Realms: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "No s'ha pogut comprovar la versió compatible, s'ha obtingut la resposta: %s",
	"mco.errorMessage.retry": "Torna a provar l'operació",
	"mco.errorMessage.serviceBusy": "Realms està ocupat en aquest moment.\nProva de connectar-te al teu Realm de nou en uns minuts.",
	"mco.gui.button": "Botó",
	"mco.gui.ok": "D'acord",
	"mco.info": "Informació!",
	"mco.invited.player.narration": "Jugador %s s'ha convidat",
	...
	"mco.minigame.world.switch.title": "Canvia de petit joc",
	...
	"mco.notification.transferSubscription.buttonText": "Transfereix Ara",
	"mco.notification.transferSubscription.message": "Les subscripcions de Java Realms s'estan movent al Microsoft Store. No deixis que la teva subscripció s'expiri!\nTransfereix ara i aconsegueix 30 dies de Realms gratuïts. \nVes a la teva pàgina de perfil en minecraft.net per transferir la teva subscripció.",
	...
	"mco.selectServer.create.subtitle": "Selecciona a un món per posar al teu nou Realm",
	"mco.selectServer.expired": "Realm esgotat",
	...
	"mco.selectServer.leave": "Sortir del Realm",
	"mco.selectServer.loading": "Carregant la llista de Realms",
	...
	"mco.selectServer.noRealms": "Pareix que no tens un Realm. Afegeix-ne un per jugar amb els teus amics.",
	...
	"mco.selectServer.popup": "Minecraft Realms és un servei simple i segur per a gaudir d'un món de Minecraft en línia amb fins a 10 amics a la vegada. Suporta a molts minijocs i mons personalitzats! Només cal que pagui el propietari del realm.",
	"mco.selectServer.purchase": "Afegeix un Realm",
	"mco.selectServer.trial": "Aconsegueix una prova!",
	"mco.selectServer.uninitialized": "Fes clic per a crear el teu realm!",
	"mco.snapshot.createSnapshotPopup.text": "Estàs a punt de crear una versió de prova de Realms gratuïta que estarà aparellat amb la teva subscripció de Realms. Aquesta versió de prova de Realms serà accessible mentre que la subscripció pagada estigui activa. El teu Realm pagat no serà afectat.",
	"mco.snapshot.createSnapshotPopup.title": "Crear versió de prova de Realm?",
	"mco.snapshot.creating": "Creant versió de prova de Realm...",
	"mco.snapshot.description": "Aparellat amb %s",
	"mco.snapshot.friendsRealm.downgrade": "Necessites estar en la versió %s per unir-te aquest Realm",
	"mco.snapshot.friendsRealm.upgrade": "%s necessita actualitzar el seu Realm abans que puguis jugar aquesta versió de prova",
	"mco.snapshot.paired": "Aquesta versió de prova està aparellat amb %s",
	"mco.snapshot.parent.tooltip": "Utilitza l'última publicació de Minecraft per jugar en aquest Realm",
	"mco.snapshot.start": "Comença versió de prova de Realm gratuïta",
	"mco.snapshot.subscription.info": "Això és una versió de prova de Realm que està aparellada a la subscripció del teu realm '%s'. Es quedarà actiu mentre estigui amb el Realm aparellat.",
	"mco.snapshot.tooltip": "Utiliza versions de prova de Realms per fe una ullada a les pròximes versions de Minecraft, que potser inclouen noves característiques i canvis.\n\nPots trobar els teus Realms normals en la versió de llançament del joc.",
	"mco.snapshotRealmsPopup.message": "Els Realms ja estan disponibles en les versions de prova, a partir de la 23w41a. Cada subscripció a Realms inclou una versió de prova de Realm gratuïta, independent del Realm de Java normal!",
	"mco.snapshotRealmsPopup.title": "Els Realms estan ara disponibles en versions de prova",
	"mco.snapshotRealmsPopup.urlText": "Aprèn Més",
	...
	"mco.upload.failed.too_big.description": "El món seleccionat és massa gran. La grandària màxima permesa és de %s.",
	...
	"mco.upload.select.world.title": "Carregar món",
	...
	"menu.custom_options": "Opcions de personalització...",
	"menu.custom_options.title": "Opcions de personalització",
	"menu.custom_options.tooltip": "Important: les Opcions de personalització les proporcionen servidors i/o continguts externs.\nTingui cura!",
	"menu.custom_screen_info.button_narration": "Això és una pantalla de personalització. Més informació.",
	"menu.custom_screen_info.contents": "Els continguts d'aquesta pantalla els controlen servidors externs i mapes que no pertanyen, controlen o supervisen Mojang Studios ni Microsoft.\n\nTingui cura! Sigui prudent a l'hora de seguir enllaços i mai proporcioni informació personal, incloent-hi detalls d'inici de sessió.\n\nSi aquesta pantalla no li deixa jugar, també pot desconectar-se del servidor actual en prémer el botó inferior.",
	"menu.custom_screen_info.disconnect": "Pantalla de personalització rebutjada",
	"menu.custom_screen_info.title": "Informació sobre les pantalles de personalització",
	"menu.custom_screen_info.tooltip": "Això és una pantalla de personalització. Premi aquí per a més informació.",
	...
	"menu.multiplayerOptions.applyChanges": "Aplicar els canvis",
	...
	"menu.multiplayerOptions.network.lan.tooltip": "Els jugadors en la mateixa xarxa poden unir-se.",
	...
	"menu.multiplayerOptions.network.online.tooltip": "Es poden unir amics en línia.",
	"menu.multiplayerOptions.otherPlayers.header": "Altres jugadors",
	"menu.multiplayerOptions.publish.started.lan": "Aquest món ara està obert a LAN. El número de port és %s",
	"menu.multiplayerOptions.publish.started.online": "Aquest món ara està obert al multijugador. El número de port és %s",
	"menu.multiplayerOptions.publish.stopped": "Aquest món ja no està obert al multijugador",
	...
	"menu.playerReporting.no_players": "No hi ha jugador per reportar en aquest món",
	"menu.preparingSpawn": "Preparant l'àrea de reaparició: %s%%",
	"menu.quick_actions": "Operacions ràpides...",
	"menu.quick_actions.title": "Operacions ràpides",
	...
	"menu.server_links": "Enllaços de servidors...",
	"menu.server_links.title": "Enllaços de servidors",
	...
	"multiplayer.codeOfConduct.check": "No informar més d'aquest codi de conducta",
	"multiplayer.codeOfConduct.title": "Codi de conducta del servidor",
	"multiplayer.confirm_command.parse_errors": "Està intentant executar un comandament no reconegut o invàlid. \nEstà segur?\nComandament: %s",
	"multiplayer.confirm_command.permissions_required": "Està intentant executar un comandament que requereix autoritzacions elevades. \nÉs possible que això afecti el vostre joc de manera negativa. \nEstà segur? \nComandament: %s",
	"multiplayer.confirm_command.run_command": "Executar comandament",
	"multiplayer.confirm_command.signature_required": "Estàs a punt d'executar un comandament que enviarà un missatge al xat al teu nom.\nNomés es pot executar des de la pantalla de xat\nComandament: %s",
	"multiplayer.confirm_command.suggest_command": "Copiar a la pantalla de xat",
	"multiplayer.confirm_command.title": "Confirmar execució del comandament",
	"multiplayer.disconnect.authservers_down": "Els servidors d'autenticació no funcionen. Prova-ho més tard!",
	"multiplayer.disconnect.bad_chat_index": "Missatge desaparegut o reordenat rebut del servidor",
	...
	"multiplayer.disconnect.banned.reason.default": "Bloquejat per un administrador.",
	...
	"multiplayer.disconnect.code_of_conduct": "El servidor requereix que acceptis el codi de conducta",
	"multiplayer.disconnect.configuration_error": "Error inesperat mentre al configurar",
	...
	"multiplayer.disconnect.invalid_public_key_signature.new": "Signatura de la clau pública del perfil no és vàlida.\nProveu de reiniciar el joc.",
	...
	"multiplayer.disconnect.missing_tags": "Set d'etiquetes rebut del servidor incorrecte.\nSi us plau, contacta amb l'administrador del servidor.",
	...
	"narration.checkbox.usage.focused.check": "Prem Enter per comprovar",
	"narration.checkbox.usage.focused.uncheck": "Prem Enter per desmarcar",
	"narration.checkbox.usage.hovered": "Fes clic esquerre per marcar o desmarcar",
	"narration.checkbox.usage.hovered.check": "Clic esquerre per marcar",
	"narration.checkbox.usage.hovered.uncheck": "Clic esquerre per desmarcar",
	"narration.component_list.usage": "Premeu la tecla Tabulador per a navegar al següent element",
	...
	"narration.link.usage.focused": "Prem Enter per a obrir l'enllaç",
	"narration.link.usage.hovered": "Fes clic esquerre per obrir l'enllaç",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Prem Intro per començar a canviar el valor del selector lliscant",
	"narration.slider.usage.hovered": "Arrossegueu la barra lliscant per a canviar el valor",
	...
	"narration.suggestion.usage.cycle.fixed": "Prem Tab per passar al següent suggeriment",
	"narration.suggestion.usage.cycle.hidable": "Prem Tab per passar al següent suggeriment, o Surt per abandonar els suggeriments",
	"narration.suggestion.usage.fill.fixed": "Prem Tab per utilitzar el suggeriment",
	"narration.suggestion.usage.fill.hidable": "Prem ''Tab'' per utilitzar el suggeriment, o ''Esc'' per abandonar els suggeriments",
	...
	"narrator.select.world_info": "Seleccionat %s, última jugada %s, %s",
	...
	"optimizeWorld.confirm.proceed": "Crea una còpia de seguretat i optimitza",
	...
	"optimizeWorld.stage.finished.chunks": "Acabant l'actualització de chunks...",
	"optimizeWorld.stage.finished.entities": "Acabant l'actualització d'entitats...",
	"optimizeWorld.stage.finished.poi": "Acabant l'actualització dels punts d'interès...",
	...
	"optimizeWorld.stage.upgrading.poi": "Actualitzant tots els punts d'interès...",
	"optimizeWorld.title": "Optimitzant el món \"%s\"",
	"options.accessibility": "Opcions d'accessibilitat...",
	...
	"options.accessibility.high_contrast_block_outline": "Vores de blocs d'alt contrast",
	"options.accessibility.high_contrast_block_outline.tooltip": "Augmenta el contrast de la vora del bloc que estiguis apuntant.",
	...
	"options.accessibility.narrator_hotkey": "Tecla d'accés ràpid a la narradora",
	...
	"options.accessibility.title": "Opcions d'accessibilitat...",
	"options.accessibility.tooltip": "Opcions d'accessibilitat",
	"options.allowCursorChanges": "Permetre canvis al cursor",
	...
	"options.allowFriendRequests.tooltip": "Permet que altres jugadors t'enviïn sol·licituds d'amistat",
	...
	"options.chat": "Configuracions del xat...",
	...
	"options.chat.drafts.tooltip": "Els missatges no enviats es guardaran i podràs enviar-los la pròxima vegada que l'obris.",
	...
	"options.chunkFade": "Temps de desaparició del chunk",
	"options.chunkFade.none": "Desaparició del chunk: Cap",
	"options.chunkFade.seconds": "Desaparició del chunk: %s segon(s)",
	"options.chunkFade.tooltip": "Quant de temps en segons, haurien de desaparèixer els chunks quan es renderitzen per primera vegada, si és que ho han de fer.",
	...
	"options.cutoutLeaves": "Fulles translúcides",
	...
	"options.exclusiveFullscreen": "Exclusivament pantalla completa",
	"options.exclusiveFullscreen.warningTooltip": "Aquesta opció pot preveure que alguns mètodes d'entrada funcionin.",
	"options.font": "Configuracions de la lletra predeterminada...",
	"options.font.title": "Configuracions de la font",
	...
	"options.friendsList.confirm.message": "La llista d'amics controla amb qui pots xatejar quan \"Pot comunicar-se fora de Xbox\" està configurat en \"Amics\".\n\nGestiona aquesta opció en el teu compte de Microsoft.\n\nQuan la llista d'amics està activada, els altres jugadors poden enviar-te sol·licituds d'amistat. Pots desactivar les invitacions o la llista d'amics en qualsevol moment.",
	...
	"options.graphics.custom": "Personalitza",
	...
	"options.graphics.preset": "Predefinit",
	"options.graphics.preset.tooltip": "Estableix les opcions de ''Qualitat i Rendiment'' a valors predeterminats raonables segons la qualitat desitjada.",
	...
	"options.graphicsApi": "Gràfiques API",
	"options.graphicsApi.default": "Per defecte",
	"options.graphicsApi.opengl": "Prefereixo OpenGL",
	"options.graphicsApi.restart": "Has de reiniciar el joc per canviar les gràfiques API.",
	"options.graphicsApi.tooltip": "Quines gràfiques API fer servir per renderitzar. Deixar en Per defecte a no ser que sigui específicament necessari canviar-ho! Tindrà efecte la pròxima vegada que inicies el joc.",
	"options.graphicsApi.tooltip.vulkan": "Experimental. Pot reduir el rendiment o causar inestabilitat en alguns sistemes.",
	"options.graphicsApi.vulkan": "Prefereixo Vulkan",
	...
	"options.hideLightningFlashes.tooltip": "Evita que els llamps facin que s'il·lumini el cel. Els llamps encara seran visibles.",
	"options.hideMatchedNames": "Oculta els noms coincidents",
	"options.hideMatchedNames.tooltip": "Els servidors de tercers poden enviar missatges al xat en formats no estàndards.\nAmb aquesta opció activada, els jugadors ocults es podran trobar segons els noms dels remitents del xat.",
	"options.hideSplashTexts": "Amaga textos d'esquitxos",
	"options.hideSplashTexts.tooltip": "Amaga el text groc esquitxó en el menú principal.",
	"options.improvedTransparency": "Transparència millorada",
	"options.improvedTransparency.tooltip": "Un enfocament experimental que utilitza ombrejat de pantalla per dibuixar la pluja, els núvols i les partícules darrere de blocs i aigua translúcids.\nAixò tindrà un impacte en el rendiment de la GPU.",
	"options.inGameNotification": "Notificacions dins del joc",
	"options.inGameNotification.tooltip": "Mostrar notificacions d'amics dins del joc",
	"options.inactivityFpsLimit": "Reduir FPS quan",
	"options.inactivityFpsLimit.afk": "Per inactivitat",
	"options.inactivityFpsLimit.afk.tooltip": "Limita els FPS a 30 en passar un minut sense activitat. El límit augmentarà a 10 FPS després de passar 10 minuts sense activitat.",
	"options.inactivityFpsLimit.minimized": "En minimitzar",
	"options.inactivityFpsLimit.minimized.tooltip": "Només es limitaran els FPS quan el joc estigui minimitzat.",
	"options.invertMouse": "Invertir el ratolí",
	"options.invertMouseX": "Inverteix el ratolí X",
	"options.invertMouseY": "Inverteix el ratolí Y",
	"options.japaneseGlyphVariants": "Variacions de glifs Japonesos",
	"options.japaneseGlyphVariants.tooltip": "Utilitza variacions de caràcters CJK Japonesos en la lletra predeterminada",
	...
	"options.languageAccuracyWarning": "(Les traduccions poden no ser fiables al 100%)",
	...
	"options.maxAnisotropy": "Filtratge anisotròpic",
	"options.maxAnisotropy.tooltip": "Millora significativament l’aspecte suau de les textures, però afecta el rendiment i augmenta notablement l’ús de la memòria de vídeo. Pot ser que no estigui suportat en tot el maquinari.",
	...
	"options.musicToast": "Notificacions de Música",
	"options.musicToast.never": "Mai",
	"options.musicToast.never.tooltip": "No mostrar notificacions de música.",
	"options.musicToast.pauseMenu": "Menú de pausa",
	"options.musicToast.pauseMenu.tooltip": "Una notificació es mostra constantment al menú de pausa del joc mentre s'està reproduint una cançó.",
	"options.musicToast.pauseMenuAndToast": "Menú de pausa i de notificacions",
	"options.musicToast.pauseMenuAndToast.tooltip": "Es mostra una notificació quan comença a sonar una cançó. La notificació es mostrarà constantment en el menú de pausa mentre estigui sonant la cançó.",
	...
	"options.online.xboxSettings": "Configuració de Xbox...",
	...
	"options.realmsNotifications.tooltip": "Aporta notícies de Realms i invitacions al menú principal i mostra la respectiva icona en el botó de Realms.",
	"options.reducedDebugInfo": "Reduir dades de F3",
	"options.renderClouds": "Núvols",
	"options.renderCloudsDistance": "Distància dels núvols",
	"options.renderDistance": "Distància de renderitzat",
	"options.resourcepack": "Paquets de recursos...",
	"options.restartRequired": "Alguns dels teus canvis requereixen reiniciar el joc per aplicar-se.",
	"options.rotateWithMinecart": "Gira amb les vagonetes",
	"options.rotateWithMinecart.tooltip": "Si la vista del jugador ha de girar al costat de la vagoneta. Només disponible a mons amb la configuració experimental 'Millores de Vagoneta' activada.",
	...
	"options.sharePresence.all.tooltip": "La presència és compartida amb els teus amics. Apareixes com connectat i comparteixes el que estàs fent.",
	"options.sharePresence.limited": "Limitada",
	"options.sharePresence.limited.tooltip": "Compartint presència limitada. Apareixes com connectat, però no comparteixes el que estàs fent. Encara pots invitar amics al teu món.",
	"options.sharePresence.none": "Cap",
	"options.sharePresence.none.tooltip": "No compartint cap presència. Apareixes com desconnectat.",
	...
	"options.showSubtitles.tooltip": "Activa els subtítols per als sons reproduïts al joc.",
	...
	"options.sprintWindow": "Interval per córrer",
	"options.sprintWindow.tooltip": "Interval de temps en tics on en prémer dues vegades la tecla d'avançar s'activa l'esprint.",
	...
	"options.telemetry.disabled": "Telemetria desactivada.",
	"options.telemetry.state.all": "Completa",
	"options.telemetry.state.minimal": "Mínima",
	"options.telemetry.state.none": "Cap",
	"options.textureFiltering": "Filtrat de textures",
	"options.textureFiltering.anisotropic": "Anisotròpic",
	"options.textureFiltering.anisotropic.tooltip": "Un mètode de filtratge basat en maquinari, però afecta el rendiment i incrementa significativament l’ús de la memòria de vídeo. Pot ser que no sigui compatible amb tot el maquinari.",
	"options.textureFiltering.none": "Cap",
	"options.textureFiltering.none.tooltip": "Les textures es mostren sense cap filtratge. Els blocs poden veure’s borrosos quan es miren en un angle.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Super mostreig en Reixa Rotada)\nUn mètode de filtratge basat en ombres que millora la qualitat de les textures amb un impacte moderat en el rendiment.",
	"options.title": "Opcions",
	"options.touchscreen": "Mode de pantalla tàctil",
	"options.value": "%s",
	"options.video": "Configuració de vídeo...",
	"options.video.display.header": "Visualització",
	...
	"pack.dropRejected.message": "Les següents entrades no són paquets vàlids i no seran copiades:\n%s",
	...
	"pack.incompatible.confirm.unknown": "Aquest paquet està trencat o està fet per a una versió desconeguda del Minecraft, i podria no funcionar correctament.",
	...
	"painting.minecraft.backyard.title": "Pati posterior",
	...
	"painting.minecraft.cavebird.title": "Ocell de cavernes",
	...
	"painting.minecraft.endboss.title": "L'últim amo",
	...
	"painting.minecraft.pond.title": "Estany",
	...
	"particle.invalidOptions": "No es pot analitzar les opcions de la partícula: %s",
	...
	"quickplay.error.invalid_identifier": "No s'ha pogut trobar el món amb l'identificador donat",
	"quickplay.error.realm_connect": "No s'ha pogut connectar al Realm",
	"quickplay.error.realm_permission": "No tens permís per connectar-te a aquest Realm",
	...
	"realms.configuration.region.japan_east": "Est del Japó",
	"realms.configuration.region.japan_west": "Japó Occidental",
	...
	"realms.configuration.region.uk_south": "Sud d'Anglaterra",
	...
	"realms.configuration.region_preference.automatic_player": "Automàtic (primer a entrar)",
	...
	"recover_world.done.failed": "No s'ha pogut recuperar de l'estat anterior.",
	"recover_world.done.success": "S'ha recuperat amb èxit!",
	"recover_world.done.title": "Recuperació feta",
	"recover_world.issue.missing_file": "Arxiu falta",
	"recover_world.issue.none": "Cap problema",
	"recover_world.message": "Els següents problemes s'han produït intentant de llegir la carpeta del món \"%s\".\nÉs possible restaurar el món d'un estat més vell o pots informar aquest problema al bug tracker.",
	"recover_world.no_fallback": "Cap estat disponible per recuperar",
	"recover_world.restore": "Intenta restaurar",
	"recover_world.restoring": "Intentant de restaurar el món...",
	"recover_world.state_entry": "Estat des de %s: ",
	...
	"resourcePack.runtime_failure": "Error amb paquet de recursos detectat",
	...
	"restrictions_screen.permission.receive_player_messages.allowed": "Pots rebre missatges de jugadors",
	"restrictions_screen.permission.receive_player_messages.denied": "No pots rebre missatges de jugadors",
	"restrictions_screen.permission.receive_system_messages.allowed": "Pots rebre missatges del sistema del servidor",
	"restrictions_screen.permission.receive_system_messages.denied": "No pots rebre missatges del sistema del servidor",
	...
	"restrictions_screen.permission.send_messages.allowed": "Pots enviar missatges pel xat",
	"restrictions_screen.permission.send_messages.denied": "No pots enviar missatges pel xat",
	...
	"selectWorld.allowCommands.new": "Permetre Comandaments",
	...
	"selectWorld.backupJoinSkipButton": "Sé el que em faig!",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Crear una còpia de seguretat abans d'actualitzar aquest món?",
	...
	"selectWorld.backupWarning.file_fixing_required": "Aquest món necessita ser actualitzat abans que puguis jugar-lo. Recomanem molt crear una còpia de seguretat abans de continuar per si experimentes corrupcions al món.",
	...
	"selectWorld.incompatible.description": "Aquest món no es pot obrir en aquesta versió.\nEra últim jugat en la versió %s.",
	"selectWorld.incompatible.info": "Versió incompatible: %s",
	"selectWorld.incompatible.title": "Versió incompatible",
	"selectWorld.incompatible.tooltip": "Aquest món no es pot obrir perquè era creat en una versió incompatible.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Aquest món ha de ser actualitzat a l'última versió abans de poder editar a causa de canvis subjacents en el format del món.",
	"selectWorld.requiresFileFixingTooltip.play": "Aquest món ha de ser actualitzat a l'última versió abans de jugar a causa de canvis subjacents en el format del món.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Aquest món ha de ser actualitzat a l'última versió abans de recrear-lo a causa de canvis subjacents en el format del món.",
	...
	"selectWorld.tooltip.fromNewerVersion2": "carregar aquest món pot causar problemes!",
	...
	"selectWorld.upgrade_and_play": "Actualitzar i Jugar",
	...
	"selectWorld.waitingForBackup.message": "Depenent de la mida del món, això pot tardar una estona. Per favor, no apagues el joc o desconnectes l'aparell.",
	...
	"selectWorld.warning.lowDiskSpace.description": "No queda molt espai en el teu dispositiu.\nSi et quedes sense espai mentre que jugues pot provocar que el teu món es corrompi.",
	"selectWorld.warning.lowDiskSpace.title": "Avis! Poc espai al disc!",
	"selectWorld.world": "Món",
	"selectWorld.world_gen_settings_access": "Incapaç de llegir o accedir a l'arxiu de configuració de generació del món! %s",
	"selecteWorld.backupRequiredTooltip": "Carregar el món requereix fer un resguard primer",
	...
	"slot.only_single_allowed": "A soles es permeten espais individuals, has obtingut '%s'",
	"slot.unknown": "Ranura desconeguda: %s",
	"snbt.parser.empty_key": "La tecla no pot estar buida",
	...
	"snbt.parser.expected_float_type": "S'esperava un nombre de coma flotant",
	"snbt.parser.expected_hex_escape": "S'esperava una cadena de longitud %s",
	...
	"snbt.parser.expected_non_negative_number": "S'esperava un nombre positiu",
	"snbt.parser.expected_number_or_boolean": "S'esperava un nombre o una booleana",
	"snbt.parser.expected_string_uuid": "S'esperava una cadena amb un UUID vàlid",
	"snbt.parser.expected_unquoted_string": "S'esperava una cadena sense cometes vàlida",
	"snbt.parser.infinity_not_allowed": "No es permeten nombres infinits",
	"snbt.parser.invalid_array_element_type": "Tipus de llista d'elements invàlid",
	"snbt.parser.invalid_character_name": "Nombre de caràcter invàlid",
	"snbt.parser.invalid_codepoint": "Valor invàlid del caràcter: %s",
	"snbt.parser.invalid_string_contents": "Invàlid contingut de cadena ",
	"snbt.parser.invalid_unquoted_start": "Una cadena sense cometes no pot començar amb nombres 0-9, + o -",
	"snbt.parser.leading_zero_not_allowed": "Els nombres decimals  no poden començar amb 0",
	"snbt.parser.no_such_operation": "No existeix l'operació: %s",
	"snbt.parser.number_parse_failure": "Error analitzant el nombre: %s",
	"snbt.parser.undescore_not_allowed": "Els guions baixos  no estan permesos al principi i final d'un nombre ",
	...
	"stat.minecraft.nautilus_one_cm": "Distància per Nautilus",
	...
	"structure_block.detect_size": "Detecta la mida i posició de l'estructura:",
	...
	"structure_block.mode_info.data": "Mode de dades - Fes servir la lògica del joc",
	...
	"structure_block.strict": "Posicionament Estricte:",
	"structure_block.structure_name": "Nom de l'estructura",
	"subtitles.ambient.cave": "Soroll inquietant",
	"subtitles.ambient.sound": "Soroll esgarrifós",
	"subtitles.block.amethyst_block.chime": "Ametista repica",
	"subtitles.block.amethyst_block.resonate": "Ametista ressona",
	...
	"subtitles.block.candle.extinguish": "Espelma s'extingeix",
	...
	"subtitles.block.copper_bulb.turn_off": "Bombeta de coure s'apaga",
	"subtitles.block.copper_bulb.turn_on": "Bombeta de coure s'encén",
	"subtitles.block.copper_chest.close": "Cofre es tanca",
	"subtitles.block.copper_chest.open": "Cofre s'obre",
	"subtitles.block.copper_trapdoor.close": "Trapa es tanca",
	"subtitles.block.copper_trapdoor.open": "Trapa s'obre",
	"subtitles.block.crafter.craft": "Elaborador elaborat",
	"subtitles.block.crafter.fail": "Elaborador ha fallat",
	"subtitles.block.creaking_heart.hurt": "Es queixa el cor del cruixidor",
	"subtitles.block.creaking_heart.idle": "Soroll inquietant",
	"subtitles.block.creaking_heart.spawn": "Desperta el cor del cruixidor",
	"subtitles.block.deadbush.idle": "Sons secs",
	"subtitles.block.decorated_pot.insert": "Gerro decorat es plena",
	"subtitles.block.decorated_pot.insert_fail": "Gerro decorat es sacseja",
	"subtitles.block.decorated_pot.shatter": "Gerro decorat es trenca",
	...
	"subtitles.block.dried_ghast.ambient": "Sons de sequedat",
	"subtitles.block.dried_ghast.ambient_water": "Un ghast sec es rehidrata",
	"subtitles.block.dried_ghast.place_in_water": "Un ghast sec es remulla",
	"subtitles.block.dried_ghast.transition": "Un ghast sec se sent millor",
	"subtitles.block.dry_grass.ambient": "Sons de vent",
	...
	"subtitles.block.eyeblossom.close": "Iridàcia es tanca",
	"subtitles.block.eyeblossom.idle": "Iridàcia xiuxiueja",
	"subtitles.block.eyeblossom.open": "Iridàcia s'obre",
	...
	"subtitles.block.firefly_bush.idle": "Brunzit de cuques de llum",
	...
	"subtitles.block.generic.fall": "Alguna cosa cau a un bloc",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Cartell es balanceja",
	...
	"subtitles.block.pale_hanging_moss.idle": "Soroll inquietant",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Erupció de guèiser de sofre",
	"subtitles.block.potent_sulfur.noxious_gas": "Gas nauseabund apareix",
	...
	"subtitles.block.sand.idle": "Sons de sorra",
	"subtitles.block.sand.wind": "Sons de vent",
	...
	"subtitles.block.sculk_sensor.clicking": "Sensor sculk vibra",
	...
	"subtitles.block.shelf.activate": "Una prestatgeria s'activa",
	"subtitles.block.shelf.deactivate": "Una prestatgeria es desactiva",
	"subtitles.block.shelf.multi_swap": "S'intercanvien objectes",
	"subtitles.block.shelf.place_item": "Objecte col·locat",
	"subtitles.block.shelf.single_swap": "Objecte s'intercanvia",
	"subtitles.block.shelf.take_item": "Objecte agafat",
	"subtitles.block.shulker_box.close": "Shulker es tanca",
	"subtitles.block.shulker_box.open": "Shulker s'obre",
	"subtitles.block.sign.waxed_interact_fail": "Cartell es balanceja",
	"subtitles.block.smithing_table.use": "Taula de ferreria utilitzada",
	"subtitles.block.smoker.smoke": "El fumador està fumant",
	"subtitles.block.sniffer_egg.crack": "L'ou d'ensumador desclosa",
	"subtitles.block.sniffer_egg.hatch": "L'ou d'ensumador desclosa",
	"subtitles.block.sniffer_egg.plop": "Ensumador pon un ou",
	"subtitles.block.sponge.absorb": "L'esponja xucla",
	"subtitles.block.sweet_berry_bush.pick_berries": "Baies són recollides",
	"subtitles.block.trapdoor.close": "Trapa es tanca",
	"subtitles.block.trapdoor.open": "Trapa s'obre",
	"subtitles.block.trapdoor.toggle": "Trapa grinyola",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Ítem ominós es prepara",
	"subtitles.block.trial_spawner.ambient": "Generador de reptes fa crepitades",
	"subtitles.block.trial_spawner.ambient_charged": "Generador de reptes ominós fa crepitades",
	"subtitles.block.trial_spawner.ambient_ominous": "Generador de reptes ominós fa crepitades",
	"subtitles.block.trial_spawner.charge_activate": "Presagi engoleix un generador de reptes",
	"subtitles.block.trial_spawner.close_shutter": "Generador de reptes es tanca",
	"subtitles.block.trial_spawner.detect_player": "Generador de reptes es carrega",
	"subtitles.block.trial_spawner.eject_item": "Generador de reptes expulsa ítems",
	"subtitles.block.trial_spawner.ominous_activate": "Presagi engoleix un generador de reptes",
	"subtitles.block.trial_spawner.open_shutter": "Generador de reptes s'obre",
	"subtitles.block.trial_spawner.spawn_item": "Ítem ominós cau",
	"subtitles.block.trial_spawner.spawn_item_begin": "Ítem ominós apareix",
	"subtitles.block.trial_spawner.spawn_mob": "Criatura genera",
	...
	"subtitles.block.vault.activate": "Caixa forta encesa",
	"subtitles.block.vault.ambient": "Caixa forta crepita",
	"subtitles.block.vault.close_shutter": "Caixa forta tanca",
	"subtitles.block.vault.deactivate": "Caixa forta s'extingeix",
	"subtitles.block.vault.eject_item": "Caixa forta expulsa un objecte",
	"subtitles.block.vault.insert_item": "Caixa forta desbloquejada",
	"subtitles.block.vault.insert_item_fail": "Caixa forta no s'ha pogut desbloquejar",
	"subtitles.block.vault.open_shutter": "Caixa forta s'obre",
	"subtitles.block.vault.reject_rewarded_player": "Caixa forta rebutja jugador ja recompensat",
	"subtitles.block.water.ambient": "Flux d'aigua",
	"subtitles.block.wet_sponge.dries": "Esponja s'asseca",
	"subtitles.chiseled_bookshelf.insert": "Llibre és col·locat",
	"subtitles.chiseled_bookshelf.insert_enchanted": "Llibre encantat col·locat",
	"subtitles.chiseled_bookshelf.take": "Llibre és retirat",
	"subtitles.chiseled_bookshelf.take_enchanted": "Llibre encantat pres",
	...
	"subtitles.entity.armadillo.ambient": "Armadillo gruny",
	"subtitles.entity.armadillo.brush": "Armadillo raspallat",
	"subtitles.entity.armadillo.death": "Armadillo mor",
	"subtitles.entity.armadillo.eat": "Armadillo menja",
	"subtitles.entity.armadillo.hurt": "Armadillo ferit",
	"subtitles.entity.armadillo.hurt_reduced": "L'armadillo es cobreix",
	"subtitles.entity.armadillo.land": "Armadillo aterra",
	"subtitles.entity.armadillo.peek": "Armadillo mira",
	"subtitles.entity.armadillo.roll": "Armadillo s'enrosca",
	"subtitles.entity.armadillo.scute_drop": "Escata cau",
	"subtitles.entity.armadillo.unroll_finish": "Armadillo es desenrosca",
	...
	"subtitles.entity.baby_cat.ambient": "El gatet miola",
	"subtitles.entity.baby_cat.beg_for_food": "El gatet suplica",
	"subtitles.entity.baby_cat.death": "El gatet mor",
	"subtitles.entity.baby_cat.eat": "El gatet menja",
	"subtitles.entity.baby_cat.hiss": "El gatet bufa",
	"subtitles.entity.baby_cat.hurt": "Al gatet li fa mal",
	"subtitles.entity.baby_cat.purr": "El gatet ronca",
	"subtitles.entity.baby_chicken.ambient": "Pollet piu",
	"subtitles.entity.baby_chicken.death": "Pollet mor",
	"subtitles.entity.baby_chicken.hurts": "Pollet ferit",
	"subtitles.entity.baby_horse.ambient": "Poltre es queixa",
	"subtitles.entity.baby_horse.angry": "Poltre relinxa",
	"subtitles.entity.baby_horse.breathe": "Poltre respira",
	"subtitles.entity.baby_horse.death": "Poltre mors",
	"subtitles.entity.baby_horse.eat": "Poltre menja",
	"subtitles.entity.baby_horse.hurt": "Poltre ferit",
	"subtitles.entity.baby_horse.land": "Poltre aterra",
	"subtitles.entity.baby_nautilus.ambient": "Els Nautilus nadó xiuxiueja",
	"subtitles.entity.baby_nautilus.ambient_land": "El nadó de Nàutil fa petits xerrics",
	"subtitles.entity.baby_nautilus.death": "Els Nautilus nadó moren",
	"subtitles.entity.baby_nautilus.death_land": "El nadó de Nàutil mor",
	"subtitles.entity.baby_nautilus.eat": "El Nautilus nadó menja",
	"subtitles.entity.baby_nautilus.hurt": "El Nautilus nadó es fa mal",
	"subtitles.entity.baby_nautilus.hurt_land": "El nadó de Nàutil sent dolor",
	"subtitles.entity.baby_nautilus.swim": "El Nautilus nadó neda",
	"subtitles.entity.baby_pig.ambient": "El porquet gruny",
	"subtitles.entity.baby_pig.death": "El porquet mor",
	"subtitles.entity.baby_pig.eat": "El porquet menja",
	"subtitles.entity.baby_pig.hurt": "Al porquet li fa mal",
	"subtitles.entity.baby_wolf.ambient": "El cadell gemega",
	"subtitles.entity.baby_wolf.death": "El cadell mor",
	"subtitles.entity.baby_wolf.growl": "El cadell gruny",
	"subtitles.entity.baby_wolf.hurt": "Al cadell li fa mal",
	"subtitles.entity.baby_wolf.pant": "El cadell panteixa",
	"subtitles.entity.baby_wolf.whine": "El cadell ploriqueja",
	...
	"subtitles.entity.bogged.ambient": "Esquelet empantanat trontolla",
	"subtitles.entity.bogged.death": "Aiguamoll mor",
	"subtitles.entity.bogged.hurt": "Aiguamoll ferit",
	"subtitles.entity.breeze.charge": "Brisa carrega",
	"subtitles.entity.breeze.death": "Brisa mor",
	"subtitles.entity.breeze.deflect": "Brisa desvia",
	"subtitles.entity.breeze.hurt": "Brisa ferida",
	"subtitles.entity.breeze.idle_air": "Brisa vola",
	"subtitles.entity.breeze.idle_ground": "Brisa xiuxiueig",
	"subtitles.entity.breeze.inhale": "Brisa inspira",
	"subtitles.entity.breeze.jump": "Brisa salta",
	"subtitles.entity.breeze.land": "Brisa aterra",
	"subtitles.entity.breeze.shoot": "Brisa dispara",
	"subtitles.entity.breeze.slide": "Brisa llisca",
	"subtitles.entity.breeze.whirl": "Brisa fa remolins",
	"subtitles.entity.breeze.wind_burst": "Càrrega de vent esclata",
	...
	"subtitles.entity.camel_husk.ambient": "El Dromedari Ressec gruny",
	"subtitles.entity.camel_husk.dash": "El Dromedari Ressec llença",
	"subtitles.entity.camel_husk.dash_ready": "El Dromedari Ressec es recupera",
	"subtitles.entity.camel_husk.death": "El Dromedari Ressec mor",
	"subtitles.entity.camel_husk.eat": "El Dromedari Ressec menja",
	"subtitles.entity.camel_husk.hurt": "El Dromedari Ressec rep mal",
	"subtitles.entity.camel_husk.saddle": "Sella equipada",
	"subtitles.entity.camel_husk.sit": "El Dromedari Ressec s’asseu",
	"subtitles.entity.camel_husk.stand": "El Dromedari Ressec s'aixeca",
	...
	"subtitles.entity.copper_golem.death": "Un gólem de coure mor",
	"subtitles.entity.copper_golem.hurt": "Un gólem de coure és ferit",
	"subtitles.entity.copper_golem.item_drop": "Gòlem de coure està col·locant un objecte",
	"subtitles.entity.copper_golem.item_no_drop": "Gòlem de coure no pot col·locar l'ítem",
	"subtitles.entity.copper_golem.no_item_get": "Gòlem de coure està recollint un ítem",
	"subtitles.entity.copper_golem.no_item_no_get": "Gòlem de coure no pot col·locar l'ítem",
	"subtitles.entity.copper_golem.spawn": "Gòlem de coure apareix",
	"subtitles.entity.copper_golem.spin": "Cap de gòlem de coure gira",
	"subtitles.entity.copper_golem_become_statue": "Un gólem de coure es petrifica",
	"subtitles.entity.copper_golem_oxidized.death": "Un gólem de coure mor",
	"subtitles.entity.copper_golem_oxidized.hurt": "Un gólem de coure és ferit",
	"subtitles.entity.copper_golem_oxidized.spin": "El cap d'un gólem de coure gira",
	"subtitles.entity.copper_golem_weathered.death": "Un gólem de coure mor",
	"subtitles.entity.copper_golem_weathered.hurt": "Gólem de coure és ferit",
	"subtitles.entity.copper_golem_weathered.spin": "El cap d'un gólem de coure gira",
	...
	"subtitles.entity.creaking.activate": "Cruixidor observa",
	"subtitles.entity.creaking.ambient": "Cruixidor cruix",
	"subtitles.entity.creaking.attack": "Cruixidor ataca",
	"subtitles.entity.creaking.deactivate": "Cruixidor es calma",
	"subtitles.entity.creaking.death": "Cruixidor s'esmicola",
	"subtitles.entity.creaking.freeze": "Cruixidor para",
	"subtitles.entity.creaking.spawn": "Cruixidor es manifesta",
	"subtitles.entity.creaking.sway": "Cruixidor és atacat",
	"subtitles.entity.creaking.twitch": "Contraccions de cruixidor",
	"subtitles.entity.creaking.unfreeze": "cruixidor es mou",
	...
	"subtitles.entity.donkey.jump": "Ruc salta",
	...
	"subtitles.entity.fish.swim": "Esquitxades",
	...
	"subtitles.entity.generic.wind_burst": "Càrrega de vent esclata",
	...
	"subtitles.entity.ghastling.ambient": "Ghastet arrulla",
	"subtitles.entity.ghastling.death": "Ghastet mor",
	"subtitles.entity.ghastling.hurt": "Ghastet ferit",
	"subtitles.entity.ghastling.spawn": "Ghastet apareix",
	"subtitles.entity.glow_item_frame.add_item": "S'omple un marc lluent",
	"subtitles.entity.glow_item_frame.break": "Se trenca un marc lluent",
	...
	"subtitles.entity.happy_ghast.ambient": "Ghast feliç cantusseja",
	"subtitles.entity.happy_ghast.death": "Ghast feliç mor",
	"subtitles.entity.happy_ghast.equip": "Arnès equipat",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Ghast feliç preparat",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Ghast feliç s'atura",
	"subtitles.entity.happy_ghast.hurt": "Ghast feliç ferit",
	"subtitles.entity.happy_ghast.unequip": "Arnès desequipat",
	...
	"subtitles.entity.leash_knot.break": "El nus de la corretja es trenca",
	"subtitles.entity.leash_knot.place": "Nus de corretja lligat",
	...
	"subtitles.entity.minecart.inside": "Jangles de Minecraft",
	"subtitles.entity.minecart.inside_underwater": "Jangles de Minecraft sota l'aigua",
	...
	"subtitles.entity.nautilus.ambient": "El Nautilus fa clics",
	"subtitles.entity.nautilus.ambient_land": "El Nàutil fa clics",
	"subtitles.entity.nautilus.dash": "El Nautilus es propulsa",
	"subtitles.entity.nautilus.dash_land": "El Nàutil expulsa raigs",
	"subtitles.entity.nautilus.dash_ready": "El Nautilus es recupera",
	"subtitles.entity.nautilus.dash_ready_land": "Nàutil es recupera",
	"subtitles.entity.nautilus.death": "El Nautilus mor",
	"subtitles.entity.nautilus.death_land": "El Nàutil mor",
	"subtitles.entity.nautilus.eat": "El Nauilus menja",
	"subtitles.entity.nautilus.hurt": "El Nautilus es fa mal",
	"subtitles.entity.nautilus.hurt_land": "El Nàutil pateix",
	"subtitles.entity.nautilus.swim": "El Nautilus nada",
	...
	"subtitles.entity.parched.ambient": "Esquelet Extraviat grinyola",
	"subtitles.entity.parched.death": "L'Esquelet extraviat mor",
	"subtitles.entity.parched.hurt": "Esquelet Extraviat rep mal",
	...
	"subtitles.entity.parrot.imitate.bogged": "Lloro imita un esquelet empantanat",
	"subtitles.entity.parrot.imitate.breeze": "Lloro xiuxiueig",
	"subtitles.entity.parrot.imitate.camel_husk": "El Lloro gruny",
	"subtitles.entity.parrot.imitate.creaking": "Lloro imita un cruixidor",
	...
	"subtitles.entity.parrot.imitate.parched": "El Lloro crepita",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "El Lloro gemega",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "El Lloro gorgoteja",
	...
	"subtitles.entity.pig.eat": "El porc menja",
	...
	"subtitles.entity.player.teleport": "Jugador teleporta",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Cavall esquelètic saltant",
	...
	"subtitles.entity.sniffer.egg_hatch": "L'ou d'ensumador desclosa",
	...
	"subtitles.entity.sulfur_cube.bounce": "Cub de sofre rebota",
	"subtitles.entity.sulfur_cube.death": "Cub de sofre mor",
	"subtitles.entity.sulfur_cube.eject": "Bloc tret",
	"subtitles.entity.sulfur_cube.hit": "Cub de sofre colpejat",
	"subtitles.entity.sulfur_cube.hurt": "Cub de sofre ferit",
	"subtitles.entity.sulfur_cube.push": "Cub de sofre empès",
	"subtitles.entity.sulfur_cube.squish": "Cub de sofre rebota",
	...
	"subtitles.entity.turtle.hurt_baby": "Cria de tortuga ferida",
	...
	"subtitles.entity.wind_charge.throw": "Càrrega de vent vola",
	"subtitles.entity.wind_charge.wind_burst": "Càrrega de vent esclata",
	...
	"subtitles.entity.zombie_horse.angry": "El Cavall zombi renilla",
	"subtitles.entity.zombie_horse.death": "Cavall zombi mor",
	"subtitles.entity.zombie_horse.eat": "Cavall Zombi menja",
	"subtitles.entity.zombie_horse.hurt": "Cavall zombi és ferit",
	"subtitles.entity.zombie_nautilus.ambient": "El Nautilus zombi fa borbollons",
	"subtitles.entity.zombie_nautilus.ambient_land": "El Nàutil zombi fa borbollons",
	"subtitles.entity.zombie_nautilus.dash": "El Nautilus zombi propulsa",
	"subtitles.entity.zombie_nautilus.dash_land": "Nàutil zombi expulsa raigs",
	"subtitles.entity.zombie_nautilus.dash_ready": "El Nautilus zombi es recupera",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "El Nàutil zombi es recupera",
	"subtitles.entity.zombie_nautilus.death": "El Nautilus zombi mor",
	"subtitles.entity.zombie_nautilus.death_land": "El Nàutil zombi mor",
	"subtitles.entity.zombie_nautilus.eat": "El Nautilus zombi menja",
	"subtitles.entity.zombie_nautilus.hurt": "El Nautilus zombi es fa mal",
	"subtitles.entity.zombie_nautilus.hurt_land": "El Nàutil zombi es fa mal",
	"subtitles.entity.zombie_nautilus.swim": "El Nautilus zombi neda",
	...
	"subtitles.event.mob_effect.raid_omen": "S'acosta un setge",
	"subtitles.event.mob_effect.trial_omen": "Un repte ominós s'acosta",
	...
	"subtitles.item.armor.equip_copper": "Armadura de coure repica",
	...
	"subtitles.item.armor.equip_nautilus": "S’equipen les armadures de Nautilus",
	...
	"subtitles.item.armor.equip_wolf": "Corretja d'armadura per a llops",
	"subtitles.item.armor.unequip_nautilus": "S’ha desequipat l’armadura de Nautilus",
	"subtitles.item.armor.unequip_wolf": "Armadura per a llop es desequipa",
	...
	"subtitles.item.brush.brushing.gravel": "Raspallant grava",
	"subtitles.item.brush.brushing.gravel.complete": "Raspallat de grava Completat",
	"subtitles.item.brush.brushing.sand": "Raspallant Sorra",
	"subtitles.item.brush.brushing.sand.complete": "Raspallat de sorra completat",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Cub de sofre recollit",
	...
	"subtitles.item.bundle.insert_fail": "Sarró ple",
	...
	"subtitles.item.elytra.flying": "Fiu",
	...
	"subtitles.item.golden_dandelion.unuse": "Dent de lleó inicia el creixement",
	"subtitles.item.golden_dandelion.use": "Dent de lleó daurat atura creixement",
	...
	"subtitles.item.horse_armor.unequip": "Armadura per a llop es desequipa",
	"subtitles.item.ink_sac.use": "Sac de tinta taca",
	"subtitles.item.lead.break": "Llaç es trenca",
	"subtitles.item.lead.tied": "Llaç lligat",
	"subtitles.item.lead.untied": "Llaç deslligat",
	"subtitles.item.llama_carpet.unequip": "Catifa es desequipa",
	"subtitles.item.lodestone_compass.lock": "Brúixola és orientada en una fita",
	"subtitles.item.mace.smash_air": "Maça aixafa",
	"subtitles.item.mace.smash_ground": "Maça aixafa",
	"subtitles.item.nautilus_saddle_equip": "Sella equipada",
	"subtitles.item.nautilus_saddle_underwater_equip": "Sella equipada",
	"subtitles.item.nether_wart.plant": "Berruga plantada",
	"subtitles.item.ominous_bottle.dispose": "Ampolla es trenca",
	"subtitles.item.saddle.unequip": "Sella de muntar es desequipa",
	"subtitles.item.shears.shear": "Tisores tallen",
	"subtitles.item.shears.snip": "Tisores tallen",
	"subtitles.item.shield.block": "Bloqueig amb escut",
	"subtitles.item.shovel.flatten": "Pala aplana",
	"subtitles.item.spear.attack": "Clavat de llança",
	"subtitles.item.spear.hit": "Cop de llança",
	"subtitles.item.spear.lunge": "Estocada de llança",
	"subtitles.item.spear.use": "Carrega amb la llança",
	"subtitles.item.spear_wood.attack": "Llança punxa",
	"subtitles.item.spear_wood.hit": "Llança colpeja",
	"subtitles.item.spear_wood.use": "Carrega amb la llança",
	...
	"subtitles.item.underwater_saddle.equip": "Sella de muntar equipada",
	"subtitles.item.wolf_armor.break": "Armadura de llop es trenca",
	"subtitles.item.wolf_armor.crack": "Armadura de llop s'esquerda",
	"subtitles.item.wolf_armor.damage": "Armadura de llop rep danys",
	"subtitles.item.wolf_armor.repair": "Armadura de llop es repara",
	...
	"subtitles.weather.end_flash": "Esclat del End",
	"subtitles.weather.rain": "Pluja",
	"symlink_warning.message": "Carregar mons des de carpetes amb enllaços simbòlics pot ser insegur si no saps exactament què estàs fent. Si us plau, visita %s per aprendre'n més.",
	"symlink_warning.message.pack": "Carregar paquets amb enllaços simbòlics pot ser insegur si no saps exactament què estàs fent. Si us plau, visita %s per aprendre'n més.",
	"symlink_warning.message.world": "Carregar mons des de carpetes amb enllaços simbòlics pot ser insegur si no saps exactament què estàs fent. Si us plau, visita %s per aprendre'n més.",
	"symlink_warning.more_info": "Més informació",
	"symlink_warning.title": "La carpeta Món conté enllaços simbòlics",
	"symlink_warning.title.pack": "Els paquets afegits contenen enllaços simbòlics",
	...
	"telemetry.event.advancement_made.description": "Entendre el context desparés de fer un avenç, ens pot ajudar a millorar i entendre la progressió del joc.",
	"telemetry.event.advancement_made.title": "Avenç fet",
	"telemetry.event.game_load_times.description": "Aquest esdeveniment ens pot ajudar a esbrinar a on millores del rendiment d'inici es necessiten, mesurant el temps d'execució de les diferents fases d'inici.",
	"telemetry.event.game_load_times.title": "Temps de càrrega del joc",
	"telemetry.event.graphics_capabilities.description": "Aquest esdeveniment ens informa de les capacitats del dispositiu gràfic utilitzat per jugar al joc.",
	...
	"telemetry.event.p2p_connection.description": "Aquest esdeveniment ens ajuda a entendre la fiabilitat i el rendiment de les connexions peer-to-peer entre jugadors. Registra si la connexió s'ha establert amb èxit, el tipus de candidat d'Interactive Connectivity Establishment (ICE, el protocol que fem servir per establir les connexions peer-to-peer) utilitzat i quant de temps ha trigat en establir-se la connexió.",
	...
	"telemetry.property.advancement_id.title": "ID de l'avenç",
	"telemetry.property.backend_failure_message.title": "Missatge d'error en la creació de l'API gràfica",
	"telemetry.property.backend_failure_missing_capabilities.title": "Error en la creació de l'API gràfica per falta de capacitats",
	"telemetry.property.backend_failure_reason.title": "Motiu de l'error en la creació de l'API gràfica",
	"telemetry.property.backend_name.title": "Nom de l'API gràfica",
	...
	"telemetry.property.load_time_pre_window_ms.title": "Temps abans que la finestra s'obri (Mil·lisegons)",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "Etapa d'error",
	...
	"telemetry.property.p2p_connection_successful.title": "Connexió exitosa",
	...
	"telemetry_info.button.show_data": "Mirar les meves dades",
	"telemetry_info.opt_in.description": "Jo consento a enviar data de telemetria opcional",
	...
	"test.error.block_property_missing": "Falta una propietat del bloc, s'esperava que la propietat %s fos %s",
	"test.error.entity_property": "L'entitat %s ha fallat la prova: %s",
	"test.error.entity_property_details": "Han fallat els tests de l'entitat %s: %s, s'esperaven %s, han sigut %s",
	"test.error.expected_block": "S'esperava el bloc %s, s'ha obtingut %s",
	"test.error.expected_block_present": "S'esperava que el bloc %s estigués present",
	"test.error.expected_block_tag": "S'esperava el bloc en #%s, s'ha obtingut %s",
	"test.error.expected_container_contents": "El contenidor hauria de tenir %s",
	"test.error.expected_container_contents_single": "El contenidor hauria de tenir un %s simple",
	"test.error.expected_empty_container": "El contenidor hauria d'estar buit",
	"test.error.expected_entity": "Es requereix %s",
	...
	"test.error.expected_entity_data": "S'esperava que les dades de l'entitat fossin %s, han sigut %s",
	"test.error.expected_entity_data_predicate": "Les dades de l'entitat no coincideixen per a %s",
	"test.error.expected_entity_effect": "S'esperava que %s tingués l'efecte %s %s",
	"test.error.expected_entity_having": "L'inventari de l'entitat hauria de tenir %s",
	"test.error.expected_entity_holding": "Entitat hauria d'agafar %s",
	"test.error.expected_entity_in_test": "S'esperava que %s existís al test",
	"test.error.expected_entity_not_touching": "No s'esperava que %s estigués tocant %s, %s, %s (relatiu: %s, %s, %s)",
	"test.error.expected_entity_touching": "S'esperava que %s estigués tocant %s, %s, %s (relatiu: %s, %s, %s)",
	...
	"test.error.not_a_block_item": "El bloc donat no és un ítem d'un bloc",
	"test.error.position": "%s en %s, %s, %s (relatiu: %s, %s, %s) al tic %s",
	"test.error.sequence.condition_already_triggered": "Condició ja activada a %s",
	"test.error.sequence.condition_not_triggered": "La condició no ha estat activada",
	"test.error.sequence.invalid_tick": "Èxit en tic no vàlid: s'esperava %s",
	"test.error.sequence.minimum_tick": "Èxit abans del tic esperat: s'estimava que esperés %s",
	"test.error.sequence.not_completed": "S'ha acabat el temps del test abans que la seqüència es completés",
	"test.error.set_biome": "Error en establir el bioma per al test",
	"test.error.spawn_failure": "Error per crear entitat %s",
	...
	"test.error.tick": "%s al tic %s",
	"test.error.ticking_without_structure": "Executar prova abans de col·locar l'estructura",
	...
	"test.error.unexpected_block": "No s'esperava que el bloc fos %s",
	"test.error.unexpected_entity": "No s'esperava que %s existís",
	"test.error.unexpected_item": "No s'esperava un objecte del tipus %s",
	"test.error.unknown": "Error intern desconegut: %s",
	"test.error.value_not_equal": "S'esperava que %s fos %s, ha sigut %s",
	"test.error.value_not_in_between": "S'esperava que %s estigués entre %s i %s: ha sigut %s",
	"test.error.wrong_block_entity": "Tipus de bloc-entitat incorrecte: %s",
	"test_block.error.missing": "Falta el bloc %s a l'estructura de prova",
	"test_block.error.too_many": "Molt de %s blocs",
	"test_block.invalid_timeout": "Temps d'espera no vàlid (%s) - Ha de ser un número positiu de tics",
	"test_block.message": "Missatge:",
	"test_block.mode.accept": "Acceptar",
	"test_block.mode.fail": "Fallar",
	"test_block.mode.log": "Registre",
	"test_block.mode.start": "Començar",
	"test_block.mode_info.accept": "Mode d'acceptació - Accepta superació de (part de) una prova",
	"test_block.mode_info.fail": "Mode de fallida - Falla la prova",
	"test_block.mode_info.log": "Mode Registrar - Registra un missatge",
	"test_block.mode_info.start": "Mode d'inici - El punt d'inici d'una prova",
	"test_instance.action.reset": "Reiniciar i Carregar",
	"test_instance.action.run": "Carregar i Obrir",
	"test_instance.action.save": "Guardar Estructura",
	"test_instance.description.batch": "Entorn: %s",
	...
	"test_instance.description.no_test": "Aquesta prova no existeix",
	...
	"test_instance_block.error.no_test": "No s'ha pogut dur a terme la prova a %s, %s, %s perquè no s'ha definit una prova",
	...
	"title.credits": "Drets d'autor Mojang AB. No distribuir!",
	...
	"title.multiplayer.disabled.banned.name": "Has de canviar el teu nom d'usuari abans de jugar en línia",
	...
	"trim_pattern.minecraft.bolt": "Patró d'armadura: Reblat",
	...
	"trim_pattern.minecraft.flow": "Patró d'armadura: Espiral",
	...
	"upgradeWorld.aborted.message": "Això pot passar si un altre programa accedeix al món mentre s'actualitza.\nReiniciar l'ordinador i tornar a provar pot ajudar. Si el problema continua, per favor considera reportar un error.",
	"upgradeWorld.aborted.reportBug": "Reportar un error",
	"upgradeWorld.aborted.title": "No s'ha pogut actualitzar el món",
	"upgradeWorld.canceled.message": "El món continua com estava abans.",
	"upgradeWorld.canceled.title": "Actualització del món cancel·lada",
	"upgradeWorld.done": "Actualització del món completada",
	"upgradeWorld.failed_cleanup.message": "El món s'ha actualitzat exitosament a la versió actual i està disponible en la llista de mons.\nHem trobat problemes mentre netejàvem data antiquada, així que el nom de la carpeta del món s'ha canviat a %s.",
	"upgradeWorld.failed_cleanup.title": "S'ha actualitzat el món amb èxit",
	"upgradeWorld.info.converted": "Actualitzat: %s",
	"upgradeWorld.info.file_fix_stage": "Escenari: %s/%s",
	"upgradeWorld.info.scanning": "Escanejant arxius...",
	"upgradeWorld.info.total": "Total: %s",
	"upgradeWorld.joinNow": "Vols unir-te al món ara?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Movent arxius",
	"upgradeWorld.progress.type.legacy_structures": "Actualitzant el llegat d'estructures",
	"upgradeWorld.progress.type.region": "Actualitzant regions",
	"upgradeWorld.symlink.message": "El món seleccionat conté enllaços simbòlics. Els passos requerits per actualitzar el món a la versió actualitzada no suporta l'ús d'enllaços simbòlics. Per a actualitzar el món, han de ser resolts els enllaços primer.",
	"upgradeWorld.symlink.title": "No es pot actualitzar el món",
	"upgradeWorld.title": "Actualitzant els arxius del món",
}
