// Code generated by tools/gen_lang.go from 26.1/es_ve.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Ajustes de accesibilidad...",
	...
	"advMode.notEnabled.spawner": "Los bloques generadores no están habilitados",
	...
	"advancements.adventure.avoid_vibration.description": "Camina agachado cerca de un sensor de sculk o de un warden para evitar que te detecten",
	"advancements.adventure.avoid_vibration.title": "Sigilo 100",
	"advancements.adventure.blowback.description": "Mata una brisa usando una carga de viento desviada de la brisa",
	"advancements.adventure.blowback.title": "Soy espejo y me reflejo",
	"advancements.adventure.brush_armadillo.description": "Obtén escamas de Cachicamo usando una Brocha",
	"advancements.adventure.brush_armadillo.title": "¿No es Escadorable?",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Fabrica un jarrón decorado con 4 fragmentos de cerámica",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Restauración Cuidadosa",
	...
	"advancements.adventure.heart_transplanter.description": "Coloca un Corazón Crujiente con la alineación correcta entre dos bloques de Tronco de Roble Pálido",
	"advancements.adventure.heart_transplanter.title": "Trasplante de corazones",
	...
	"advancements.adventure.lighten_up.description": "Raspa una bombilla de cobre con un hacha para hacerla más brillante",
	"advancements.adventure.lighten_up.title": "Enciéndelo",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Entra a una Cámara de Prueba",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Edición de Prueba(s)",
	"advancements.adventure.ol_betsy.description": "Dispara una ballesta",
	"advancements.adventure.ol_betsy.title": "La vieja Betsy",
	"advancements.adventure.overoverkill.description": "Haz 50 corazones de daño en un solo golpe usando el mazo",
	"advancements.adventure.overoverkill.title": "¡Ma-Mazacre!",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Lee la señal de energía de una Estantería Cincelada usando un Comparador",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "El poder de los libros",
	"advancements.adventure.revaulting.description": "Desbloquea una bóveda siniestra con una llave de prueba siniestra",
	...
	"advancements.adventure.salvage_sherd.title": "Desempolvando reliquias",
	...
	"advancements.adventure.spear_many_mobs.description": "Empala a cinco mobs durante el mismo ataque de carga usando la Lanza",
	"advancements.adventure.spear_many_mobs.title": "Parrillada",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Aplica estos moldes de herrería al menos una vez: Agujas, Hocico, Costillas, Warden, Silencio, Vex, Marea, encuentra-caminos",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Forjando chévere",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Decora una pieza de armadura en una Mesa de Herrería",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Fabricando una nueva pinta",
	"advancements.adventure.two_birds_one_arrow.description": "Mata a dos phantoms usando una flecha perforante",
	"advancements.adventure.two_birds_one_arrow.title": "Dos pájaros de un tiro",
	"advancements.adventure.under_lock_and_key.description": "Desbloquea una Bóveda con una Llave de Desafío",
	"advancements.adventure.under_lock_and_key.title": "Los corotos finos",
	"advancements.adventure.use_lodestone.description": "Usa una brújula en un bloque de magnetita",
	"advancements.adventure.use_lodestone.title": "Magnetismo, llévame a mi ranchito",
	...
	"advancements.adventure.who_needs_rockets.description": "Usa una carga de viento para lanzarte hacia arriba 8 bloques",
	"advancements.adventure.who_needs_rockets.title": "Ventilador con motor de lavadora",
	...
	"advancements.end.dragon_breath.description": "Recoge aliento de dragón en un frasco",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Haz que un allay deje caer un pastel en un bloque musical",
	...
	"advancements.husbandry.complete_catalogue.description": "¡Domestica a todas las variantes de gato!",
	"advancements.husbandry.complete_catalogue.title": "Un gatálogo completo",
	"advancements.husbandry.feed_snifflet.description": "Alimenta a un bebé sniffer bebé",
	...
	"advancements.husbandry.make_a_sign_glow.description": "Haz que el texto de cualquier cartel brille",
	"advancements.husbandry.make_a_sign_glow.title": "¡Brillante idea!",
	"advancements.husbandry.netherite_hoe.description": "Usa un lingote de netherita para mejorar un azadón y replantéate tu vida",
	...
	"advancements.husbandry.obtain_sniffer_egg.title": "Esto huele interesante...",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Coloca a un ghast seco en agua",
	"advancements.husbandry.place_dried_ghast_in_water.title": "¡Mantente hidratado!",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Planta cualquier semilla de sniffer",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Retira la Armadura de un Lobo utilizando Tijeras",
	"advancements.husbandry.remove_wolf_armor.title": "Corta Brillantemente",
	"advancements.husbandry.repair_wolf_armor.description": "Repara una armadura de lobo dañada usando escamas de cachicamo",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Usa una fogata para recolectar miel de una colmena usando una botella de vidrio sin molestar a las abejas",
	...
	"advancements.husbandry.tactical_fishing.description": "Atrapa un pez... ¡pero sin caña de pescar!",
	...
	"advancements.husbandry.wax_off.title": "Cera pulida",
	...
	"advancements.husbandry.whole_pack.title": "Este color no lo tengo",
	...
	"argument.double.big": "El valor no debe ser mayor que %s: se encontró %s",
	"argument.double.low": "El valor no debe ser menor que %s: se encontró %s",
	...
	"argument.entity.options.gamemode.description": "Jugadores con un modo de juego",
	...
	"argument.entity.selector.nearestEntity": "Entidad Cercana",
	...
	"argument.float.big": "El valor no debe ser mayor que %s: se encontró %s",
	"argument.float.low": "El valor no debe ser menor que %s: se encontró %s",
	"argument.gamemode.invalid": "Modo de juego desconocido: %s",
	"argument.hexcolor.invalid": "Código de color hexadecimal no válido «%s»",
	"argument.id.invalid": "ID no válido",
	"argument.id.unknown": "ID desconocido: %s",
	"argument.integer.big": "El número entero no puede ser mayor que %s, se han encontrado %s",
	"argument.integer.low": "El número entero no puede ser menor que %s, se han encontrado %s",
	"argument.item.id.invalid": "Objeto desconocido: %s",
	"argument.item.tag.disallowed": "Aquí no se permiten etiquetas; solo se admiten objetos reales",
	"argument.literal.incorrect": "Se requiere el valor literal \"%s\"",
	"argument.long.big": "El valor no debe ser mayor que %s: se encontró %s",
	"argument.long.low": "El valor long no puede ser menor que %s (encontrado: %s)",
	"argument.message.too_long": "Este mensaje fue demasiado largo (%s > máximo de %s caracteres)",
	"argument.nbt.array.invalid": "Tipo de matriz no válido: %s",
	"argument.nbt.array.mixed": "No se puede insertar %s en %s",
	"argument.nbt.expected.compound": "Etiqueta compuesta prevista",
	...
	"argument.range.ints": "Sólo números enteros, sin decimales",
	"argument.range.swapped": "El mínimo no puede ser mayor que el máximo",
	"argument.resource.invalid_type": "El elemento \"%s\" es de tipo incorrecto \"%s\" (se esperaba \"%s\")",
	"argument.resource.not_found": "No se pudo encontrar el elemento \"%s\" de tipo \"%s\"",
	"argument.resource_or_id.failed_to_parse": "Falla en Análisis de Estructura: %s",
	"argument.resource_or_id.invalid": "Apodo o Identificación Invalida",
	"argument.resource_or_id.no_such_element": "No se pudo encontrar el elemento '%s' en el registro '%s'",
	...
	"argument.time.tick_count_too_low": "El número de ciclos no puede ser inferior a %s, encontrado: %s",
	...
	"arguments.item.component.expected": "Componente de objeto esperado",
	"arguments.item.component.malformed": "Componente '%s' malformado: '%s'",
	"arguments.item.component.repeated": "El componente del objeto ‘%s’ se repitió, pero solo se puede especificar un valor",
	...
	"arguments.item.predicate.malformed": "Deformado: %s Predicado: %s",
	...
	"arguments.nbtpath.too_large": "La cantidad de información NBT es muy grande",
	...
	"attribute.name.armor_toughness": "Resistencia de armadura",
	...
	"attribute.name.block_break_speed": "Velocidad de ruptura de bloques",
	"attribute.name.block_interaction_range": "Rango de interacción de bloques",
	"attribute.name.bounciness": "Rebote",
	"attribute.name.burning_time": "Duración de las quemaduras",
	"attribute.name.camera_distance": "Distancia de la cámara",
	"attribute.name.entity_interaction_range": "Rango de interacción de entidades",
	"attribute.name.explosion_knockback_resistance": "Resistencia al empuje de las explosiones",
	"attribute.name.fall_damage_multiplier": "Multiplicador de daño de caída",
	...
	"attribute.name.generic.explosion_knockback_resistance": "Resistencia al empuje por Explosiones",
	...
	"attribute.name.generic.jump_strength": "Intensidad del salto",
	...
	"attribute.name.generic.movement_efficiency": "Eficiencia del Movimiento",
	"attribute.name.generic.movement_speed": "Velocidad",
	"attribute.name.generic.oxygen_bonus": "Bono de oxígeno",
	"attribute.name.generic.safe_fall_distance": "Distancia de caída segura",
	"attribute.name.generic.scale": "Escala",
	"attribute.name.generic.step_height": "Altura de salto",
	...
	"attribute.name.jump_strength": "Fuerza de salto",
	"attribute.name.knockback_resistance": "Resistencia a empuje",
	"attribute.name.luck": "Suerte",
	"attribute.name.max_absorption": "Absorción máxima",
	"attribute.name.max_health": "Salud máxima",
	"attribute.name.mining_efficiency": "Eficiencia al minar",
	...
	"attribute.name.player.mining_efficiency": "Eficiencia de Minería",
	"attribute.name.player.sneaking_speed": "Velocidad sigilosa",
	"attribute.name.player.submerged_mining_speed": "Velocidad al Minar bajo el agua",
	"attribute.name.player.sweeping_damage_ratio": "Proporción del Daño por Barrido",
	...
	"attribute.name.submerged_mining_speed": "Velocidad al minar bajo el agua",
	...
	"attribute.name.water_movement_efficiency": "Eficiencia del movimiento acuático",
	"attribute.name.waypoint_receive_range": "Rango de recepción de Punto de Referencia",
	"attribute.name.waypoint_transmit_range": "Rango de transmisión de Punto de Referencia",
	...
	"biome.minecraft.old_growth_spruce_taiga": "Bosque de pinos ancestral",
	...
	"block.minecraft.bamboo_fence": "Cerca de bambú",
	"block.minecraft.bamboo_fence_gate": "Puerta de cerca de bambú",
	...
	"block.minecraft.banner.base.light_blue": "Paño completamente azul cielo",
	...
	"block.minecraft.banner.flow.black": "Flujo Negro",
	"block.minecraft.banner.flow.blue": "Flujo Azul",
	"block.minecraft.banner.flow.brown": "Flujo Marrón",
	"block.minecraft.banner.flow.cyan": "Flujo turquesa",
	"block.minecraft.banner.flow.gray": "Flujo Gris",
	"block.minecraft.banner.flow.green": "Flujo Verde",
	"block.minecraft.banner.flow.light_blue": "Flujo Azul Claro",
	"block.minecraft.banner.flow.light_gray": "Flujo Gris Claro",
	"block.minecraft.banner.flow.lime": "Flujo Lima",
	"block.minecraft.banner.flow.magenta": "Flujo Magenta",
	"block.minecraft.banner.flow.orange": "Flujo Naranja",
	"block.minecraft.banner.flow.pink": "Flujo Rosado",
	"block.minecraft.banner.flow.purple": "Flujo Morado",
	"block.minecraft.banner.flow.red": "Flujo Rojo",
	"block.minecraft.banner.flow.white": "Flujo Blanco",
	"block.minecraft.banner.flow.yellow": "Flujo Amarillo",
	...
	"block.minecraft.banner.guster.black": "Ventisca Negra",
	"block.minecraft.banner.guster.blue": "Ventisca Azul",
	"block.minecraft.banner.guster.brown": "Ventisca Marrón",
	"block.minecraft.banner.guster.cyan": "Ventisca Turquesa",
	"block.minecraft.banner.guster.gray": "Ventisca Gris",
	"block.minecraft.banner.guster.green": "Ventisca Verde",
	"block.minecraft.banner.guster.light_blue": "Ventisca Azul Claro",
	"block.minecraft.banner.guster.light_gray": "Ventisca Gris Claro",
	"block.minecraft.banner.guster.lime": "Ventisca Lima",
	"block.minecraft.banner.guster.magenta": "Ventisca Magenta",
	"block.minecraft.banner.guster.orange": "Ventisca Naranja",
	"block.minecraft.banner.guster.pink": "Ventisca Rosa",
	"block.minecraft.banner.guster.purple": "Ventisca Morada",
	"block.minecraft.banner.guster.red": "Ventisca Roja",
	"block.minecraft.banner.guster.white": "Ventisca Blanca",
	"block.minecraft.banner.guster.yellow": "Ventisca Amarilla",
	...
	"block.minecraft.cherry_fence": "Cerca de cerezo",
	"block.minecraft.cherry_fence_gate": "Puerta de cerca de cerezo",
	...
	"block.minecraft.cherry_sapling": "Arbolito de cerezo",
	...
	"block.minecraft.chiseled_bookshelf": "Estantería cincelada",
	...
	"block.minecraft.chiseled_resin_bricks": "Ladrillo de Resina Cincelada",
	...
	"block.minecraft.closed_eyeblossom": "Flor de ojo Cerrada",
	...
	"block.minecraft.copper_wall_torch": "Antorcha de cobre de pared",
	...
	"block.minecraft.creaking_heart": "Corazón de tronador",
	...
	"block.minecraft.cyan_candle_cake": "Torta con vela turquesa",
	...
	"block.minecraft.exposed_copper_bulb": "Lámpara de cobre expuesta",
	...
	"block.minecraft.exposed_copper_door": "Puerta de cobre expuesta",
	"block.minecraft.exposed_copper_golem_statue": "Estatua de gólem de cobre expuesto",
	"block.minecraft.exposed_copper_grate": "Rejilla de cobre expuesta",
	"block.minecraft.exposed_copper_lantern": "Farol de cobre expuesto",
	"block.minecraft.exposed_copper_trapdoor": "Escotilla de cobre expuesta",
	...
	"block.minecraft.leaf_litter": "Hojas caídas",
	...
	"block.minecraft.light_blue_candle": "Vela azul cielo",
	"block.minecraft.light_blue_candle_cake": "Torta con vela azul cielo",
	...
	"block.minecraft.lime_candle": "Vela verde limón",
	"block.minecraft.lime_candle_cake": "Torta con vela verde limón",
	...
	"block.minecraft.mangrove_fence": "Cerca de mangle",
	"block.minecraft.mangrove_fence_gate": "Puerta de cerca de mangle",
	...
	"block.minecraft.mangrove_wall_hanging_sign": "Cartel de mangle colgante en pared",
	...
	"block.minecraft.oak_hanging_sign": "Cartel de roble colgante",
	...
	"block.minecraft.oak_wall_hanging_sign": "Cartel de roble colgante en pared",
	...
	"block.minecraft.open_eyeblossom": "Flor de ojo Abierta",
	...
	"block.minecraft.oxidized_copper_bulb": "Lámpara de cobre oxidada",
	...
	"block.minecraft.oxidized_copper_door": "Puerta de cobre oxidada",
	"block.minecraft.oxidized_copper_golem_statue": "Estatua de gólem de cobre oxidado",
	"block.minecraft.oxidized_copper_grate": "Rejilla de cobre oxidada",
	...
	"block.minecraft.pale_oak_button": "Botón de Madera Pálida",
	"block.minecraft.pale_oak_door": "Puerta de Madera Pálida",
	"block.minecraft.pale_oak_fence": "Valla de Madera Pálida",
	"block.minecraft.pale_oak_fence_gate": "Puerta de Valla de Madera Pálida",
	"block.minecraft.pale_oak_hanging_sign": "Cartel Colgante de Madera Pálida",
	"block.minecraft.pale_oak_leaves": "Hojas Pálidas",
	"block.minecraft.pale_oak_log": "Tronco Pálido",
	"block.minecraft.pale_oak_planks": "Tablones de Madera Pálida",
	"block.minecraft.pale_oak_pressure_plate": "Placa de presión de Madera Pálida",
	"block.minecraft.pale_oak_sapling": "Retoño de Madera Pálida",
	"block.minecraft.pale_oak_shelf": "Estante de roble pálido",
	"block.minecraft.pale_oak_sign": "Cartel de Madera Pálida",
	"block.minecraft.pale_oak_slab": "Losa de Madera Pálida",
	"block.minecraft.pale_oak_stairs": "Escaleras de Madera Pálida",
	"block.minecraft.pale_oak_trapdoor": "Escotilla de Madera Pálida",
	"block.minecraft.pale_oak_wall_hanging_sign": "Cartel Colgante de Madera Pálida para Paredes",
	"block.minecraft.pale_oak_wall_sign": "Cartel de Madera Pálida para Paredes",
	"block.minecraft.pale_oak_wood": "Madera Pálida",
	...
	"block.minecraft.pointed_dripstone": "Espeleotema puntiaguda",
	...
	"block.minecraft.potted_cherry_sapling": "Maceta con arbolito de cerezo",
	"block.minecraft.potted_closed_eyeblossom": "Maceta con flor ojo cerrado",
	...
	"block.minecraft.potted_golden_dandelion": "Diente de león dorado en maceta",
	...
	"block.minecraft.potted_open_eyeblossom": "Maceta con flor ojo abierto",
	"block.minecraft.potted_orange_tulip": "Maceta con tulipán naranja",
	"block.minecraft.potted_oxeye_daisy": "Maceta con margarita",
	"block.minecraft.potted_pale_oak_sapling": "Maceta con retoño de roble pálido\n",
	...
	"block.minecraft.potted_torchflower": "Maceta con florantorcha",
	...
	"block.minecraft.powder_snow_cauldron": "Caldero de nieve polvo",
	...
	"block.minecraft.resin_brick_slab": "Losa de ladrillo de resina",
	"block.minecraft.resin_brick_stairs": "Escaleras de ladrillos de resina",
	"block.minecraft.resin_brick_wall": "Muro de ladrillo de resina",
	...
	"block.minecraft.short_grass": "Grama Corta",
	...
	"block.minecraft.spawner.desc2": "Fija el tipo de criatura",
	...
	"block.minecraft.spruce_hanging_sign": "Cartel de pino colgante",
	...
	"block.minecraft.spruce_wall_hanging_sign": "Cartel colgante de pino en pared",
	...
	"block.minecraft.stripped_pale_oak_wood": "Leño de roble seco sin corteza",
	...
	"block.minecraft.suspicious_gravel": "Gravilla sospechosa",
	...
	"block.minecraft.test_instance_block": "Bloque de instancia de prueba",
	...
	"block.minecraft.torchflower": "Florantorcha",
	"block.minecraft.torchflower_crop": "Cultivo de florantorcha",
	"block.minecraft.trapped_chest": "Baúl trampa",
	"block.minecraft.trial_spawner": "Generador de pruebas",
	...
	"block.minecraft.waxed_copper_bulb": "Lámpara de cobre encerada",
	...
	"block.minecraft.waxed_exposed_copper_bulb": "Lámpara de cobre encerado expuesta",
	...
	"block.minecraft.waxed_exposed_copper_door": "Puerta de cobre encerada expuesta",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Estatua de gólem de cobre expuesto encerado",
	"block.minecraft.waxed_exposed_copper_grate": "Rejilla de cobre encerado expuesta",
	"block.minecraft.waxed_exposed_copper_lantern": "Farol de cobre expuesto encerado",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Escotilla de cobre expuesta encerada",
	...
	"block.minecraft.waxed_weathered_copper_trapdoor": "Escotilla de cobre degradada encerada",
	...
	"block.minecraft.wildflowers": "Florecitas silvestres",
	...
	"book.edit.title": "Pantalla de Edición de Libros",
	...
	"build.spawn_protection": "%s está bajo la protección de Spawn",
	"build.tooHigh": "El límite para construir es de %s bloques",
	"build.tooLow": "La altura de construcción mínima es %s",
	...
	"chat.disabled.chain_broken": "El chat se deshabilitó debido a una cadena rota. Por favor, intenta reconectar.",
	...
	"chat.disabled.invalid_command_signature": "El comando tenia firmas de argumentos de comando faltantes o restantes.",
	"chat.disabled.invalid_signature": "El chat tenía una firma no válida. Intenta reconectar.",
	"chat.disabled.launcher": "Chat desactivado por el lanzador. No puedes enviar mensajes.",
	"chat.disabled.missingProfileKey": "El chat se desabilitó debido a la falta de la clave pública del perfil. Por favor, intenta reconectar.",
	...
	"chat.disabled.profile": "Chat no permitido por la configuración de la cuenta. Presiona '%s' Otra vez para mas información.",
	...
	"chat.filtered_full": "El servidor ha ocultado tu mensaje para algunos jugadores.",
	...
	"chat.validation_error": "Error de validación de chat",
	"chat_restriction.chat_and_commands_disabled_by_options": "El chat está restringido en la configuración del cliente.",
	"chat_restriction.chat_disabled_by_options": "El chat del jugador está restringido en la configuración del cliente.",
	"chat_restriction.chat_disabled_by_options.action": "Ir a Configuración del chat.",
	"chat_restriction.disabled_by_launcher": "El chat está restringido por el launcher",
	"chat_restriction.disabled_by_profile": "El chat está restringido por la configuración del perfil",
	"chat_restriction.disabled_by_profile.action": "Ir a la configuración del perfil",
	"chat_screen.commands_not_allowed": "Enviar comandos no está habilitado",
	"chat_screen.message": "Mensaje para enviar: %s",
	"chat_screen.messages_not_allowed": "Enviar mensajes en el chat no está habilitado",
	"chat_screen.restricted": "El chat está restringido. Clic al mensaje para ver más detalles.",
	"chat_screen.restricted.narration": "El chat está restringido. Vé al apartado de Restricciones de la configuración del mundo.",
	"chat_screen.title": "Pantalla de chat",
	"chat_screen.usage": "Escribe un mensaje y presiona Enter para enviar",
	"chunk.toast.checkLog": "Consulta el registro del juego para más detalles",
	...
	"commands.attribute.base_value.reset.success": "Valor Base para atributos %s para entidades %s restablecido al valor predeterminado",
	...
	"commands.banlist.entry.unknown": "(Desconocid@)",
	"commands.banlist.list": "Hay %s prohibición(es):",
	...
	"commands.bossbar.get.players.some": "La barra de jefe personalizada %s tiene %s jugador(es) en línea: %s",
	...
	"commands.bossbar.list.bars.some": "Hay %s barra(s) personalizada(s) activas: %s",
	...
	"commands.clear.success.multiple": "%s objeto(s) fueron eliminados de %s jugadores",
	"commands.clear.success.single": "%s objeto(s) fueron eliminados de %s",
	"commands.clear.test.multiple": "Se encontraron %s objeto(s) que coinciden en el inventario de %s jugadores",
	"commands.clear.test.single": "Se encontraron %s objeto(s) que coinciden en el inventario de %s",
	...
	"commands.data.modify.expected_value": "Se requiere un valor, obtenido: %s",
	...
	"commands.datapack.create.already_exists": "Ya existe un paquete con el nombre '%s'",
	...
	"commands.datapack.create.io_failure": "No se puede crear el paquete con el nombre '%s', verifique los registros",
	"commands.datapack.create.metadata_encode_failure": "Error al codificar los metadatos del paquete '%s': %s",
	...
	"commands.datapack.enable.failed.no_flags": "El paquete \"%s\" no puede ser habilitado porque las siguientes características no están habilitadas en este mundo: %s",
	"commands.datapack.list.available.none": "No hay más paquetes de datos disponibles",
	"commands.datapack.list.available.success": "Aquí hay %s un paquete(s) de datos disponible %s",
	"commands.datapack.list.enabled.none": "No hay paquetes de datos habilitados",
	"commands.datapack.list.enabled.success": "Aquí hay %s un paquete(s) de datos activo: %s",
	...
	"commands.debug.started": "Análisis debug iniciado",
	...
	"commands.execute.blocks.toobig": "Demasiados bloques en el área especificada (el máximo es %s y se especificaron %s)",
	...
	"commands.execute.function.instantiationFailure": "Error al ejecutar la función %s: %s",
	...
	"commands.fetchprofile.entity.success": "Perfil de la entidad %s resuelto: %s",
	...
	"commands.fetchprofile.summon_mannequin": "Invocar maniquí",
	"commands.fill.failed": "No se rellenaron bloques",
	"commands.fill.success": "Bloque(s) rellenados con éxito: %s",
	"commands.fill.toobig": "Demasiados bloques en el área especificada (el máximo es %s y se especificaron %s)",
	...
	"commands.fillbiome.toobig": "Demasiados bloques en el volumen especificado (el máximo es %s y se especificaron %s)",
	...
	"commands.function.error.argument_not_compound": "Tipo de argumento invalido: %s, se esperaba Compound",
	"commands.function.error.missing_argument": "Falta de argumento %[2]s en la funcion %[1]s",
	"commands.function.error.missing_arguments": "Argumentos faltantes en la funcion %s",
	...
	"commands.function.scheduled.no_functions": "No se encontraron funciones con el nombre %s",
	"commands.function.scheduled.single": "Función programada en ejecución %s",
	"commands.function.success.multiple": "%s comandos ejecutado(s) de %s funciones",
	"commands.function.success.multiple.result": "%s funciones ejecutadas",
	"commands.function.success.single": "%s comando(s) ejectutados de la funcion '%s'",
	...
	"commands.kick.owner.failed": "No se puede expulsar al dueño de un juego LAN",
	"commands.kick.singleplayer.failed": "No se puede expulsar a un jugador en un mundo para un jugador sin conexión",
	...
	"commands.locate.biome.success": "El/la %s más cercano/a está en %s (a %s bloques de distancia)",
	"commands.locate.poi.not_found": "No se pudo encontrar el punto de interés \"%s\" a una distancia razonable",
	"commands.locate.poi.success": "El/la %s más cercano/a está en %s (a %s bloques de distancia)",
	"commands.locate.structure.invalid": "No hay una estructura con el tipo %s",
	"commands.locate.structure.not_found": "No se pudo encontrar una estructura de tipo %s cerca",
	...
	"commands.perf.stopped": "Perfilado de rendimiento detenido despues de %s segundo(s) y %s ciclo(s) (%s ciclo(s) por segundo)",
	"commands.place.feature.failed": "Error al colocar la característica",
	"commands.place.feature.invalid": "No hay ninguna característica con el tipo %s",
	"commands.place.feature.success": "Se colocó %s en %s, %s, %s",
	...
	"commands.place.structure.invalid": "No existe ninguna estructura de tipo \"%s\"",
	...
	"commands.place.template.invalid": "No existe una plantilla con el ID \"%s\"",
	...
	"commands.profile_fetch.id.failure": "Error al resolver el perfil para el id %s",
	"commands.profile_fetch.id.success": "Perfil resuelto para el id %s: %s",
	"commands.profile_fetch.name.failure": "Error al resolver el perfil para el nombre %s",
	...
	"commands.random.error.range_too_large": "El rango del valor aleatorio debe ser como máximo, 2147483646",
	"commands.random.error.range_too_small": "El intervalo del valor aleatorio debe ser como mínimo, 2",
	"commands.random.reset.all.success": "Reiniciar %s secuencia(s) aleatoria(s)",
	"commands.random.reset.success": "Reiniciar secuencia aleatoria %s",
	...
	"commands.ride.already_riding": "%s ya está montando %s",
	"commands.ride.dismount.success": "%s dejó de montar %s",
	"commands.ride.mount.failure.cant_ride_players": "No se puede montar en otro jugador",
	"commands.ride.mount.failure.generic": "%s no pudo empezar a montar %s",
	"commands.ride.mount.failure.loop": "No puede montar la entidad sobre sí misma ni sobre ninguno de sus pasajeros",
	"commands.ride.mount.failure.wrong_dimension": "No se puede aplicar a una criatura que está en otra dimensión",
	"commands.ride.mount.success": "%s empezó a montar %s",
	"commands.ride.not_riding": "%s no conduce ningún vehículo",
	"commands.rotate.success": "Girar %s",
	...
	"commands.schedule.cleared.success": "%s programacion(es) removidas con id %s",
	"commands.schedule.created.function": "Funcion '%s' programada a %s ciclo(s) en tiempo de juego %s",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Se ha desactivado la actualización automatica del objetivo %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Se ha activado la actualización automática del objetivo %s",
	...
	"commands.scoreboard.players.display.name.set.success.multiple": "Se ha cambiado el nombre de %s para %s entidades en %s",
	"commands.scoreboard.players.display.name.set.success.single": "Se ha cambiado el nombre de %s a %s en %s",
	...
	"commands.scoreboard.players.operation.success.single": "Se ha fijado %s para %s a %s",
	...
	"commands.setidletimeout.success": "El tiempo limite de inactividad de los jugadores ahora es %s minuto(s)",
	"commands.setidletimeout.success.disabled": "Se desactivó el tiempo de inactividad de jugadores",
	"commands.setworldspawn.failure.not_overworld": "El punto de reaparición del mundo solo puede estar en la superficie",
	"commands.setworldspawn.success": "El punto de reaparición del mundo fue establecido en %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Establecer el punto de aparición del mundo en %s, %s, %s [%s, %s] en %s",
	...
	"commands.spawnpoint.success.multiple.new": "Establecer el punto de aparición en %s, %s, %s [%s, %s] en %s para %s jugadores",
	"commands.spawnpoint.success.single": "El punto de reaparición de %[6]s en la dimensión %[5]s fue establecido en %[1]s, %[2]s, %[3]s [%[4]s]",
	"commands.spawnpoint.success.single.new": "Establecer el punto de aparición en %s, %s, %s [%s, %s] en %s para %s",
	"commands.spectate.cannot_spectate": "%s no se puede observar",
	...
	"commands.spreadplayers.failed.entities": "No se pudo propagar la entidad/entidades %s alrededor de %s, %s (demasiadas entidades para el espacio - intenta propagar no mas de %s)",
	"commands.spreadplayers.failed.invalid.height": "maxHeight %s no válido, se requiere un valor mayor al mínimo %s del mundo",
	"commands.spreadplayers.failed.teams": "No se pudo propagar %s equipo(s) alrededor de %s, %s (demasiadas entidades para el espacio - intenta propagar no mas de %s)",
	"commands.spreadplayers.success.entities": "Propagación de %s jugador(s) alrededor de %s, %s con una distancia promedio de %s bloques entre ellos",
	"commands.spreadplayers.success.teams": "Propagación de %s equipo(s) alrededor de %s, %s con una distancia promedio de %s bloques entre ellos",
	...
	"commands.swing.failed.notliving": "No se encontraron entidades vivas móviles",
	"commands.swing.success.multiple": "%s entidades movieron sus brazos",
	"commands.swing.success.single": "%s movió su brazo",
	...
	"commands.team.empty.success": "Se ha(n) eliminado miembro(s) del equipo",
	...
	"commands.test.clear.error.no_tests": "No se pudo encontrar pruebas para eliminar",
	...
	"commands.test.error.no_test_instances": "No se encontraron instancias de prueba",
	...
	"commands.test.locate.done": "Se terminó la búsqueda, se encontró %s estructura(s)",
	...
	"commands.test.run.no_tests": "No se encontró pruebas",
	"commands.test.run.running": "Realizando %s pruebas...",
	...
	"commands.test.summary.failed": "Fallaron %s pruebas requeridas :(",
	"commands.test.summary.optional_failed": "Fallaron %s pruebas opcionales",
	"commands.tick.query.percentiles": "Percentiles: P50: %s ms, P95: %s ms, P99: %s ms; muestra: %s",
	"commands.tick.query.rate.running": "Tasa de ticks de destino: %s por segundo\nMedia de tiempo por tick: %sms (destino: %sms)",
	"commands.tick.query.rate.sprinting": "Tasa de ticks de destino: %s por segundo (ignorado, como referencia)\nMedia de tiempo por tick: %sms",
	"commands.tick.rate.success": "Se ha cambiado la tasa de ticks de destino a %s por segundo",
	"commands.tick.sprint.report": "Alta velocidad con %s ticks por segundo o %s ms por tick",
	"commands.tick.sprint.stop.fail": "No hay ticks a alta velocidad en curso",
	"commands.tick.sprint.stop.success": "Se ha interrumpido un tick a alta velocidad",
	"commands.tick.status.frozen": "El juego está congelado",
	"commands.tick.status.lagging": "El juego se está ejecutando, pero no puede mantenerse activo con la tasa de ticks de destino",
	"commands.tick.status.running": "El juego se está ejecutando a velocidad normal",
	"commands.tick.status.sprinting": "El juego está a alta velocidad",
	"commands.tick.step.fail": "Error al volver a la velocidad normal; el juego debe estar congelado primero",
	"commands.tick.step.stop.fail": "No hay ticks a velocidad normal en curso",
	"commands.tick.step.stop.success": "Se ha interrumpido un tick a velocidad normal",
	"commands.tick.step.success": "Regulando %s tick(s)",
	...
	"commands.time.pause": "Reloj %s pausado",
	"commands.time.query": "Hora: %s ticks",
	"commands.time.query.absolute": "El reloj %s está en %s tick(s)",
	"commands.time.query.gametime": "El tiempo del juego es %s tick(s)",
	"commands.time.query.timeline": "La línea de tiempo %s está en %s tick(s)",
	"commands.time.query.timeline.repetitions": "La línea de tiempo %s ha completado %s repetición(es)",
	"commands.time.rate": "El reloj %s ahora avanzará a la velocidad normal %sx",
	"commands.time.resume": "Reloj %s reanudado",
	"commands.time.set": "Tiempo ajustado a %s ticks",
	"commands.time.set.absolute": "%s establecido en %s tick(s)",
	"commands.time.set.time_marker": " %s establecido al marcador de tiempo %s",
	...
	"commands.transfer.success.single": "Transfiriendo a %s hacia %s:%s",
	...
	"commands.version.build_time": "Tiempo de compilación = %s",
	...
	"commands.version.pack.data": "paquete_dato = %s",
	"commands.version.pack.resource": "paquete_recurso = %s",
	...
	"commands.waypoint.list.empty": "No hay puntos de referencia en %s",
	"commands.waypoint.list.success": "%s punto(s) de referencia en %s: %s",
	...
	"commands.worldborder.damage.buffer.success": "Cambiada la zona segura fuera del borde del mundo a %s bloque(s)",
	"commands.worldborder.get": "El borde del mundo actualmente tiene un tamaño de %s bloque(s)",
	...
	"commands.worldborder.set.immediate": "Cambiado el borde del mundo a tamaño de %s bloque(s)",
	"commands.worldborder.set.shrink": "Reduciendo el borde del mundo a %s bloque(s) durante %s segundo(s)",
	"commands.worldborder.warning.distance.failed": "Nada cambió: el aviso del borde del mundo ya tenía esta distancia",
	"commands.worldborder.warning.distance.success": "Cambiada la distancia de advertencia del borde del mundo a %s bloque(s)",
	"commands.worldborder.warning.time.failed": "Nada cambió: el aviso del borde del mundo ya duraba esta cantidad de tiempo",
	"commands.worldborder.warning.time.success": "Cambiado el tiempo de advertencia del borde del mundo a %s segundo(s)",
	...
	"createWorld.customize.presets.list": "Alternativamente, ¡aquí hay unas que hicimos antes!",
	...
	"credits_and_attribution.screen.title": "Creditos y atribuciones",
	...
	"dataPack.locator_bar.name": "Barra de localización",
	"dataPack.minecart_improvements.description": "Movimiento mejorado de Vagones",
	"dataPack.minecart_improvements.name": "Mejoras de vagones",
	...
	"dataPack.trade_rebalance.name": "Rebalance del comercio con aldeanos",
	...
	"dataPack.winter_drop.description": "Nuevas características y contenido para el lanzamiento de invierno",
	"dataPack.winter_drop.name": "drop de Invierno",
	...
	"datapackFailure.title": "No se ha podido cargar el mundo porque hay errores en los paquetes de datos seleccionados.\nPuedes intentar cargarlo únicamente con el paquete de datos \"vanilla\" (\"modo seguro\") o volver al menú principal y buscar una solución manualmente.",
	...
	"death.attack.dragonBreath.player": "%[1]s fue calcinado en aliento de dragón por %[2]s",
	...
	"death.attack.hotFloor.player": "%[1]s ha pisado una zona de peligro debido a %[2]s",
	...
	"death.attack.mace_smash": "%[1]s fue aplastado/a por %[2]s",
	"death.attack.mace_smash.item": "%[1]s fue aplastado por %[2]s usando su %[3]s",
	...
	"death.attack.message_too_long": "Lamentablemente, el mensaje era demasiado largo para ser enviado. ¡Lo sentimos! Aquí tienes la versión abreviada: %s",
	...
	"death.attack.onFire.item": "%[1]s se quemó mientras luchaba contra %[2]s empuñando %[3]s",
	...
	"death.attack.outsideBorder": "%[1]s ha abandonado los confines de este mundo",
	"death.attack.outsideBorder.player": "%[1]s abandonó los confines del mundo mientras luchaba contra %[2]s",
	"death.attack.player": "%[1]s fue asesinado por %[2]s",
	"death.attack.player.item": "%[1]s fue asesinado por %[2]s utilizando %[3]s",
	"death.attack.sonic_boom": "%[1]s fue impactado/a por un rugido supersónico",
	...
	"death.attack.sonic_boom.player": "%[1]s fue impactado/a por un rugido supersónico tratando de escapar de %[2]s",
	"death.attack.spear": "%[1]s fue atravesado por %[2]s",
	"death.attack.spear.item": "%[1]s fue atravesado por %[2]s utilizando %[3]s",
	...
	"death.attack.witherSkull.item": "%[1]s ha sido golpeado por un cráneo de %[2]s usando %[3]s",
	...
	"debug.crash.message.rebindable": "%s + %s presionados. Si no los sueltas, el juego dejará de funcionar.",
	...
	"debug.creative_spectator.help": "F3 + N = Cambiar entre el modo de juego previo <-> espectador",
	...
	"debug.entry.currently.inOverlay": "%s: Actualmente solo en sobreposición de depuración",
	"debug.entry.currently.never": "%s: Actualmente apagado",
	"debug.entry.f3": "En F3",
	"debug.entry.overlay": "En Interfaz",
	...
	"debug.options.category.renderer": "Renderizadores de Debug",
	"debug.options.category.text": "Texto de pantalla de Debug",
	"debug.options.help": "F3 + F5 = Editar opciones de Debug",
	"debug.options.notAllowed.tooltip": "No es visible cuando la información de Debug está reducida",
	...
	"debug.options.title": "Opciones de Debug",
	"debug.options.warning": "Estas opciones están destinadas para fines de prueba. Podrían ralentizar tu ordenador, hacer que el juego deje de funcionar... o abrir un agujero negro.",
	...
	"demo.help.movementMouse": "Mira a tu alrededor usando el mouse",
	...
	"editGamerule.inGame.disabled.tooltip": "Actualizar las reglas del juego requiere permisos de operador.",
	"editGamerule.inGame.discardChanges.message": "¿Está seguro de que desea descartar los cambios pendientes en las reglas del juego?",
	"editGamerule.inGame.discardChanges.title": "Cambios en las reglas del juego",
	"editGamerule.inGame.downloadingGamerules": "Recuperando las reglas del juego...",
	...
	"effect.minecraft.oozing": "Exudado",
	...
	"effect.minecraft.trial_omen": "Presagio de Prueba",
	"effect.minecraft.unluck": "Mala suerte",
	"effect.minecraft.water_breathing": "Respiración",
	"effect.minecraft.weakness": "Debilidad",
	"effect.minecraft.weaving": "Costura",
	"effect.minecraft.wind_charged": "Viento cargado",
	...
	"enchantment.minecraft.breach": "Abertura",
	...
	"enchantment.minecraft.wind_burst": "Impulso aéreo",
	"entity.minecraft.acacia_boat": "Barco de acacia",
	"entity.minecraft.acacia_chest_boat": "Barco de acacia con cofre",
	"entity.minecraft.allay": "Allay",
	"entity.minecraft.area_effect_cloud": "Nube de efecto persistente",
	"entity.minecraft.armadillo": "Cachicamo",
	"entity.minecraft.armor_stand": "Soporte para armadura",
	"entity.minecraft.arrow": "Flecha",
	"entity.minecraft.axolotl": "Ajolote",
	"entity.minecraft.bamboo_chest_raft": "Bote de Bambú con Cofre",
	...
	"entity.minecraft.boat": "Bote de Roble",
	"entity.minecraft.bogged": "Esqueleto pantanoso",
	"entity.minecraft.breeze": "Brisa",
	...
	"entity.minecraft.cherry_chest_boat": "Bote de cerezo con baúl",
	...
	"entity.minecraft.creaking": "Tronador",
	"entity.minecraft.creaking_transient": "Tronador",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Bote de madera oscura",
	"entity.minecraft.dark_oak_chest_boat": "Bote de roble oscuro con baúl",
	...
	"entity.minecraft.falling_block_type": "En caída %s",
	...
	"entity.minecraft.jungle_chest_boat": "Bote de jungla con baúl",
	...
	"entity.minecraft.mangrove_boat": "Bote de manglares",
	"entity.minecraft.mangrove_chest_boat": "Bote de manglares con baúl",
	...
	"entity.minecraft.oak_chest_boat": "Bote de roble con baúl",
	"entity.minecraft.ocelot": "Cunaguaro",
	"entity.minecraft.ominous_item_spawner": "Generador de objetos siniestros",
	"entity.minecraft.painting": "Cuadro",
	"entity.minecraft.pale_oak_boat": "Bote de madera pálida",
	"entity.minecraft.pale_oak_chest_boat": "Bote de madera pálida con cofre",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Esqueleto disecado",
	...
	"entity.minecraft.spawner_minecart": "Vagón con generador de criaturas",
	...
	"entity.minecraft.spruce_boat": "Bote de pino",
	"entity.minecraft.spruce_chest_boat": "Bote de pino con baúl",
	...
	"entity.not_summonable": "No se pudo generar una entidad de tipo %s",
	...
	"filled_map.trial_chambers": "Mapa de Prueba del Explorador",
	"filled_map.unknown": "Mapa desconocido",
	"filled_map.village_desert": "Mapa de aldea de desierto",
	"filled_map.village_plains": "Mapa de aldea de planicie",
	"filled_map.village_savanna": "Mapa de aldea de sabana",
	"filled_map.village_snowy": "Mapa de aldea nevada",
	...
	"gamerule.allowEnteringNetherUsingPortals.description": "Controla si los jugadores pueden ingresar al Nether o no",
	"gamerule.allowFireTicksAwayFromPlayer": "Tick de fuego lejos de los jugadores",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Controla si el fuego y la lava pueden hacer tick a más de 8 chunks de distancia de cualquier jugador",
	"gamerule.announceAdvancements": "Anunciar progresos",
	"gamerule.blockExplosionDropDecay": "En explosiones por interacción con bloques, algunos bloques no soltarán objetos",
	"gamerule.blockExplosionDropDecay.description": "Algunos de los objetos soltados por bloques destruidos a causa de explosiones derivadas de interacciones con bloques se pierden en la explosión.",
	...
	"gamerule.commandBlocksEnabled": "Habilitar bloques de comandos",
	"gamerule.commandModificationBlockLimit": "Límite de bloques modificables por comandos",
	"gamerule.commandModificationBlockLimit.description": "Número de bloques que pueden modificarse a la vez mediante un comando, como /fill o /clone.",
	...
	"gamerule.doLimitedCrafting.description": "Si habilitado, el jugador solo podra fabricar recetas ya aprendidas.",
	...
	"gamerule.doVinesSpread": "Esparcimiento de enredaderas",
	"gamerule.doVinesSpread.description": "Controla si las enredaderas se esparcen aleatoriamente a los bloques cercanos. Los efectos no se aplican a otro tipo de enredaderas como las retorcidas, o las lacrimosas, etc.",
	...
	"gamerule.enableCommandBlocks": "Habilitar bloques de comandos",
	"gamerule.enderPearlsVanishOnDeath": "Las Perlas de ender lanzadas desaparecen si el jugador muere",
	...
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Permite a las entidades con pasajeros viajar a través de portales del Nether, del End y nexos del End.",
	...
	"gamerule.globalSoundEvents": "Sonidos globales",
	"gamerule.globalSoundEvents.description": "Cuando un evento ocurre, como la generación de un jefe, el sonido se oye en todo el mundo.",
	"gamerule.keepInventory": "Mantener inventario al morir",
	"gamerule.lavaSourceConversion": "La lava se convierte en fuente",
	"gamerule.lavaSourceConversion.description": "Cuando una corriente de lava está rodeada de agua por dos o más lados se convierte en fuente.",
	"gamerule.locatorBar": "Activar localizador de jugadores",
	...
	"gamerule.minecartMaxSpeed": "Velocidad máxima de los vagones",
	"gamerule.minecartMaxSpeed.description": "Valocidad máxima por defecto de un vagon por tierra.",
	"gamerule.minecraft.elytra_movement_check": "Realizar comprobación del movimiento de las élitras",
	"gamerule.minecraft.fire_spread_radius_around_player": "Radio de esparcimiento del fuego",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "El radio de bloques alrededor del jugador en los que el fuego se puede esparcir",
	"gamerule.minecraft.player_movement_check": "Comprobar el movimiento del jugador",
	"gamerule.minecraft.raids": "Activar invasiones",
	"gamerule.minecraft.universal_anger.description": "Los mobs neutrales molestos atacarán a cualquier jugador cercano, no solo al que los enfureció. Funciona mejor si pray_dead_players está deshabilitado.",
	"gamerule.mobExplosionDropDecay": "En explosiones por criaturas, algunos bloques no soltarán objetos",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Tiempo de espera para teletransportarse al Nether en el modo creativo",
	...
	"gamerule.playersNetherPortalDefaultDelay": "Tiempo de espera para teletransportarse al Nether en modos de juego que no sean creativo",
	"gamerule.playersNetherPortalDefaultDelay.description": "Tiempo (en tics) que necesita pasar un jugador sobre el portal en modos de juego que no sean creativo para cambiar de dimensión.",
	...
	"gamerule.reducedDebugInfo.description": "Limita el contenido de la pantalla debug al presionar F3.",
	...
	"gamerule.snowAccumulationHeight.description": "Cuando nieva, se forman capas de nieve en el suelo con este número como capas máximas.",
	"gamerule.spawnChunkRadius": "Radio del punto de aparición",
	"gamerule.spawnChunkRadius.description": "Cantidad de chunks que se mantienen cargados alrededor del punto de reaparición.",
	...
	"gamerule.spawnerBlocksEnabled": "Habilitar bloques generadores",
	"gamerule.spectatorsGenerateChunks": "Generar terreno en modo espectador",
	"gamerule.tntExplodes": "Permitir que el TNT se active y explote.",
	...
	"gamerule.waterSourceConversion.description": "Cuando una corriente de agua está rodeada de agua por dos o más lados se convierte en fuente.",
	"generator.custom": "personalizado",
	"generator.customized": "Personalizado (antiguo)",
	"generator.minecraft.amplified": "AMPLIFICADO",
	"generator.minecraft.amplified.info": "Aviso: ¡sólo por diversión!\nRequiere una buena compu.",
	...
	"gui.abuseReport.discard.content": "Si sales, este reporte y tus comentarios se descartarán.\n¿Estás seguro de que quieres salir?",
	"gui.abuseReport.discard.discard": "Salir y descartar reporte",
	"gui.abuseReport.discard.draft": "Guardar como borrador",
	"gui.abuseReport.discard.return": "Continuar editando",
	"gui.abuseReport.discard.title": "¿Descartar reporte y comentarios?",
	"gui.abuseReport.draft.content": "¿Te gustaría seguir editando el reporte ya existente o prefieres descartarlo y crear uno nuevo?",
	...
	"gui.abuseReport.draft.quittotitle.title": "Tienes un borrador de reporte de chat que se perderá si sales",
	"gui.abuseReport.draft.title": "¿Editar el borrador del reporte de chat?",
	...
	"gui.abuseReport.observed_what": "¿Por qué estás reportando esto?",
	"gui.abuseReport.read_info": "Más información sobre los reportes",
	...
	"gui.abuseReport.reason.generic": "Quiero denunciarlos",
	...
	"gui.abuseReport.reason.hate_speech.description": "Alguien está atacándote a ti o a otro jugador por características de su identidad, como religión, etnia o condición sexual.",
	...
	"gui.abuseReport.reason.sexually_inappropriate.description": "Aspectos que muestran elementos relacionados a actos sexuales, órganos sexuales o violencia sexual.",
	...
	"gui.abuseReport.select_reason": "Seleccionar categoria de reporte",
	"gui.abuseReport.send": "Enviar reporte",
	...
	"gui.abuseReport.send.json_error": "Se ha detectado una carga útil mal estructurada al enviar tu reporte.",
	"gui.abuseReport.send.no_reason": "Selecciona una categoría para el reporte",
	"gui.abuseReport.send.not_attested": "Lee el texto y asegúrate de marcar la casilla para enviar el informe",
	"gui.abuseReport.send.service_unavailable": "No se ha podido contactar con el servicio de reportes por abuso. Asegúrate de que estás conectado a internet e inténtalo de nuevo.",
	...
	"gui.abuseReport.title": "Reportar jugador",
	"gui.abuseReport.type.chat": "Mensajes de chat",
	"gui.abuseReport.type.name": "Nombre del jugador",
	"gui.abuseReport.type.skin": "Aspecto de jugador",
	"gui.acknowledge": "Entendido",
	"gui.advancements": "Progresos",
	"gui.all": "Todas",
	"gui.back": "Atrás",
	"gui.banned.description": "%s\n\n%s\n\nMás información en el siguiente enlace: %s",
	"gui.banned.description.permanent": "Tu cuenta fue suspendida permanentemente, lo que significa que no podrás volver a jugar en línea ni unirte a Realms.",
	"gui.banned.description.reason": "Recientemente hemos recibido un reporte por mal comportamiento hacia tu cuenta. Nuestros moderadores han revisado tu caso y lo han identificado como %s, lo que va en contra de los estándares de la comunidad de Minecraft.",
	...
	"gui.banned.description.unknownreason": "Recientemente hemos recibido un reporte por mal comportamiento hacia tu cuenta. Nuestros moderadores han revisado tu caso y han identificado que va en contra de los estándares de la comunidad de Minecraft.",
	...
	"gui.banned.reason.defamation_impersonation_false_information": "Robo de identidad o compartir información para aprovecharse o engañar a otros",
	...
	"gui.banned.reason.harassment_or_bullying": "Lenguaje abusivo usado de manera directa y dañina",
	"gui.banned.reason.hate_speech": "Incitación al odio o discriminación",
	...
	"gui.banned.reason.imminent_harm_to_person_or_property": "Intención de causar daños en la vida real a personas o propiedades",
	"gui.banned.reason.nudity_or_pornography": "Mostrar material obsceno o pornográfico",
	...
	"gui.banned.title.permanent": "Cuenta suspendida permanentemente",
	"gui.banned.title.temporary": "Cuenta suspendida temporalmente",
	"gui.cancel": "Cancelar",
	"gui.chatReport.comments": "Comentarios",
	"gui.chatReport.describe": "Compartir detalles nos ayudará a tomar una decisión más precisa.",
	"gui.chatReport.discard.content": "Si sales ahora, se borrarán este reporte y tus comentarios.\n¿Seguro que quieres salir?",
	...
	"gui.chatReport.draft.quittotitle.title": "Tienes un borrador de reporte que se perderá si sales",
	...
	"gui.chatReport.read_info": "Más información sobre reportes",
	...
	"gui.chatReport.selected_chat": "%s mensaje(s) selecionados para reportar",
	"gui.chatReport.send": "Enviar reporte",
	"gui.chatReport.send.comments_too_long": "Por favor, acorta el comentario",
	...
	"gui.chatReport.send.too_many_messages": "Estás incluyendo demasiados mensajes en el reporte",
	"gui.chatReport.title": "Reportar jugador",
	...
	"gui.chatSelection.join": "%s se unió al chat",
	"gui.chatSelection.message.narrate": "%s ha dicho: %s (%s)",
	"gui.chatSelection.selected": "Mensaje(s) seleccionados: %s/%s",
	"gui.chatSelection.title": "Seleccionar mensajes que quieres reportar",
	...
	"gui.remove": "Eliminar",
	"gui.report_to_server": "Reportar al servidor",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Éste jugador no puede ser reportado porque su chat está deshabilitado o bloqueado",
	"gui.socialInteractions.tooltip.report.disabled": "El servicio de reporte no está disponible",
	"gui.socialInteractions.tooltip.report.no_messages": "No hay mensajes de infracción de %s",
	"gui.socialInteractions.tooltip.report.not_reportable": "Este jugador no puede ser reportado, porque sus mensajes no se pueden verificar en este servidor",
	"gui.socialInteractions.tooltip.show": "Mostrar mensajes",
	"gui.stats": "Estadísticas",
	"gui.stats.none_found": "No se encontraron estadísticas.",
	...
	"gui.up": "Arriba",
	"gui.waitingForResponse.button.inactive": "Atrás (%ss)",
	"gui.waitingForResponse.title": "Esperando a el servidor",
	"gui.yes": "Sí",
	...
	"item.dyed": "Teñido",
	"item.intangible": "Intocable",
	"item.minecraft.acacia_boat": "Bote de acacia",
	"item.minecraft.acacia_chest_boat": "Bote de acacia con baúl",
	"item.minecraft.allay_spawn_egg": "Generar allay",
	"item.minecraft.amethyst_shard": "Fragmento de amatista",
	"item.minecraft.angler_pottery_shard": "Fragmento de caña de pescar",
	"item.minecraft.angler_pottery_sherd": "Fragmento de cerámica de caña de pescar",
	"item.minecraft.apple": "Manzana",
	"item.minecraft.archer_pottery_shard": "Fragmento de arco",
	"item.minecraft.archer_pottery_sherd": "Fragmento de cerámica de arco",
	"item.minecraft.armadillo_scute": "Escama de cachicamo",
	"item.minecraft.armadillo_spawn_egg": "Generar cachicamo",
	"item.minecraft.armor_stand": "Soporte para armadura",
	"item.minecraft.arms_up_pottery_shard": "Fragmento de manos arriba",
	"item.minecraft.arms_up_pottery_sherd": "Fragmento de cerámica de manos arriba",
	...
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Diseño de armadura de tornillo",
	...
	"item.minecraft.breeze_rod": "Vara de Brisa",
	"item.minecraft.breeze_spawn_egg": "Generar brisa",
	"item.minecraft.brewer_pottery_shard": "Fragmento de poción",
	...
	"item.minecraft.cherry_chest_boat": "Bote de cerezo con baúl",
	...
	"item.minecraft.coast_armor_trim_smithing_template.new": "Diseño de armadura de costa",
	...
	"item.minecraft.creaking_spawn_egg": "Generar tronador",
	...
	"item.minecraft.cyan_harness": "Arnés Cyan",
	"item.minecraft.danger_pottery_shard": "Fragmento de peligro",
	"item.minecraft.danger_pottery_sherd": "Fragmento de cerámica de peligro",
	"item.minecraft.dark_oak_boat": "Bote de roble oscuro",
	"item.minecraft.dark_oak_chest_boat": "Bote de roble oscuro con baúl",
	...
	"item.minecraft.dune_armor_trim_smithing_template.new": "Diseño de armadura de dunas",
	...
	"item.minecraft.ender_dragon_spawn_egg": "Generar Ender Dragon",
	...
	"item.minecraft.explorer_pottery_shard": "Fragmento de explorador",
	...
	"item.minecraft.field_masoned_banner_pattern": "Estampado de campo de albañilería",
	...
	"item.minecraft.flow_banner_pattern.desc": "Flujo",
	"item.minecraft.flow_banner_pattern.new": "Estampado de espiral",
	"item.minecraft.flow_pottery_sherd": "Fragmento de cerámica de flujo",
	...
	"item.minecraft.friend_pottery_shard": "Fragmento de amistad",
	...
	"item.minecraft.guster_banner_pattern.desc": "Ventisca",
	"item.minecraft.guster_banner_pattern.new": "Estampado de brisa",
	"item.minecraft.guster_pottery_sherd": "Fragmento de cerámica de Ventisca",
	...
	"item.minecraft.heart_pottery_shard": "Fragmento de corazón",
	"item.minecraft.heart_pottery_sherd": "Fragmento de cerámica de corazón",
	"item.minecraft.heartbreak_pottery_shard": "Fragmento de corazón roto",
	...
	"item.minecraft.howl_pottery_shard": "Fragmento de canino",
	"item.minecraft.howl_pottery_sherd": "Fragmento de cerámica de canino",
	...
	"item.minecraft.jungle_chest_boat": "Bote de jungla con baúl",
	...
	"item.minecraft.light_blue_bundle": "Bolsa azul claro",
	...
	"item.minecraft.lime_bundle": "Bolsa verde limón",
	"item.minecraft.lime_dye": "Tinte verde limón",
	"item.minecraft.lime_harness": "Arnés Lima",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Poción de exudado persistente",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Poción de costura persistente",
	"item.minecraft.lingering_potion.effect.wind_charged": "Pocion de Viento Cargado persistente",
	"item.minecraft.llama_spawn_egg": "Generar llama",
	"item.minecraft.lodestone_compass": "Brújula magnetizada",
	"item.minecraft.mace": "Mazo",
	...
	"item.minecraft.mangrove_chest_boat": "Bote de mangle con baúl",
	...
	"item.minecraft.miner_pottery_shard": "Fragmento de minero",
	...
	"item.minecraft.mourner_pottery_shard": "Fragmento de doliente",
	"item.minecraft.mourner_pottery_sherd": "Fragmento de cerámica de doliente",
	...
	"item.minecraft.music_disc_lava_chicken.desc": "Hiper Potions - Lava Chicken",
	...
	"item.minecraft.netherite_horse_armor": "Armadura de Netherita para Caballos",
	...
	"item.minecraft.netherite_upgrade_smithing_template.new": "Mejora de Inframundita",
	"item.minecraft.oak_boat": "Bote de roble",
	"item.minecraft.oak_chest_boat": "Bote de roble con baúl",
	"item.minecraft.ocelot_spawn_egg": "Generar cunaguaro",
	"item.minecraft.ominous_bottle": "Botella Siniestra",
	"item.minecraft.ominous_trial_key": "Llave de Prueba Siniestra",
	...
	"item.minecraft.pale_oak_chest_boat": "Bote de roble pálido con baúl",
	"item.minecraft.panda_spawn_egg": "Generar panda",
	"item.minecraft.paper": "Papel",
	"item.minecraft.parched_spawn_egg": "Generar esqueleto disecado",
	...
	"item.minecraft.pink_bundle": "Bolsa rosada",
	"item.minecraft.pink_dye": "Tinte rosa",
	"item.minecraft.pink_harness": "Arnés Rosado",
	"item.minecraft.pitcher_plant": "Nepenthes",
	"item.minecraft.pitcher_pod": "Semilla de Nepenthes",
	"item.minecraft.plenty_pottery_shard": "Fragmento de abundancia",
	...
	"item.minecraft.potion.effect.oozing": "Poción de exudado",
	...
	"item.minecraft.potion.effect.weaving": "Poción de Costura",
	"item.minecraft.potion.effect.wind_charged": "Poción de Carga de Viento",
	"item.minecraft.pottery_shard_archer": "Fragmento de arco",
	"item.minecraft.pottery_shard_arms_up": "Fragmento de manos arriba",
	"item.minecraft.pottery_shard_prize": "Fragmento de tesoro",
	"item.minecraft.pottery_shard_skull": "Fragmento de calavera",
	"item.minecraft.powder_snow_bucket": "Balde con nieve en polvo",
	"item.minecraft.prismarine_crystals": "Cristales de prismarina",
	"item.minecraft.prismarine_shard": "Fragmento de prismarina",
	"item.minecraft.prize_pottery_shard": "Fragmento de tesoro",
	...
	"item.minecraft.purple_bundle": "Bolsa morada",
	...
	"item.minecraft.resin_clump": "Abrazadera de resina",
	...
	"item.minecraft.scrape_pottery_sherd": "Raspar Fragmento de Cerámica",
	...
	"item.minecraft.sheaf_pottery_shard": "Fragmento de trigo",
	...
	"item.minecraft.shelter_pottery_shard": "Fragmento de refugio",
	...
	"item.minecraft.skull_pottery_shard": "Fragmento de calavera",
	...
	"item.minecraft.snort_pottery_shard": "Fragmento de sniffer",
	...
	"item.minecraft.spire_armor_trim_smithing_template.new": "Diseño de armadura de aguja",
	...
	"item.minecraft.splash_potion.effect.oozing": "Poción de Exudado Arrojadiza",
	...
	"item.minecraft.splash_potion.effect.weaving": "Poción de Costura Arrojadiza",
	"item.minecraft.splash_potion.effect.wind_charged": "Poción de Carga de Viento Arrojadiza",
	"item.minecraft.spruce_boat": "Bote de pino",
	"item.minecraft.spruce_chest_boat": "Bote de pino con baúl",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Flecha de Exudado",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Flecha de Costura",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Flecha de Carga de Viento",
	"item.minecraft.tnt_minecart": "Vagón con dinamita",
	"item.minecraft.torchflower_seeds": "Semillas de florantorcha",
	...
	"item.minecraft.trial_key": "Llave de Prueba",
	...
	"item.minecraft.wind_charge": "Carga de brisa",
	...
	"item.modifiers.armor": "Cuando se Usa:",
	"item.modifiers.body": "Cuando está en la mano principal:",
	"item.modifiers.chest": "En el cuerpo:",
	"item.modifiers.feet": "En los pies:",
	"item.modifiers.hand": "Cuando se Tiene:",
	...
	"item.modifiers.saddle": "Cuando ensillado:",
	"item.nbt_tags": "NBT: %s etiqueta(s)",
	"item.op_block_warning.line1": "Advertencia:",
	"item.op_block_warning.line2": "Colocar este bloque podría resultar en ejecución de comando",
	"item.op_block_warning.line3": "¡No lo use a menos que conozca el contenido exacto!",
	...
	"itemGroup.spawnEggs": "Generadores",
	...
	"jukebox_song.minecraft.lava_chicken": "Hiper Potions - Lava Chicken",
	...
	"key.category.minecraft.gameplay": "Jugabilidad",
	...
	"key.debug.clearChat": "Limpiar chat",
	"key.debug.copyLocation": "Copiar localización",
	"key.debug.copyRecreateCommand": "Copiar datos",
	"key.debug.crash": "Fallo de depuración",
	"key.debug.debugOptions": "Opciones de depuración",
	"key.debug.dumpDynamicTextures": "Descargar Texturas Dinámicas",
	"key.debug.dumpVersion": "Volcar información de la Versión",
	"key.debug.focusPause": "Alternar pausa del segundo plano",
	"key.debug.fpsCharts": "Gráficos de FPS",
	"key.debug.lightmapTexture": "Textura de mapa lumínico",
	"key.debug.modifier": "Tecla modificadora de depuración",
	"key.debug.networkCharts": "Gráficos de Internet",
	"key.debug.overlay": "Alternar interfaz",
	"key.debug.profiling": "Iniciar/Detener perfilado",
	"key.debug.profilingChart": "Gráfico de perfil",
	...
	"key.debug.showChunkBorders": "Mostrar límites de chunks",
	"key.debug.showHitboxes": "Mostrar Hitbox",
	"key.debug.spectate": "Cambiar a Espectador",
	"key.debug.switchGameMode": "Cambiar modo de juego",
	...
	"key.spectatorHotbar": "Seleccionar en la barra de acceso rápido",
	"key.spectatorOutlines": "Destacar jugadores (espectadores)",
	"key.sprint": "Correr",
	"key.swapOffhand": "Cambiar ítem a la mano secundaria",
	"key.toggleGui": "Alternar interfaz de usuario",
	...
	"known_server_link.report_bug": "Informar error del Servidor",
	...
	"lanServer.port.invalid.new": "Puerto no válido.\nDeja la caja de edición vacía o introduce un número entre el %s y el %s.",
	...
	"lanServer.port.unavailable.new": "Puerto no disponible.\nDeja la caja de edición vacía o introduce un número distinto entre el %s y el %s.",
	...
	"manageServer.resourcePack.disabled": "Deshabilitado",
	"manageServer.resourcePack.enabled": "Habilitado",
	...
	"mco.backup.button.reset": "Restablecer mundo",
	"mco.backup.button.restore": "Restaurar",
	"mco.backup.button.upload": "Cargar mundo",
	"mco.backup.changes.tooltip": "Cambios",
	"mco.backup.entry": "Copia de seg. (%s)",
	"mco.backup.entry.description": "Descripción",
	"mco.backup.entry.enabledPack": "Se ha activado el Paquete",
	"mco.backup.entry.gameDifficulty": "Dificultad del juego",
	"mco.backup.entry.gameMode": "Modo del juego",
	"mco.backup.entry.gameServerVersion": "Versión del servidor del juego",
	...
	"mco.backup.info.title": "Cambios del último respaldo",
	"mco.backup.narration": "Copia de seguridad de %s",
	"mco.backup.nobackups": "Este realm no tiene copias de seguridad.",
	"mco.backup.restoring": "Restaurando realm",
	"mco.backup.unknown": "DESCONOCIDO",
	...
	"mco.compatibility.downgrade.description": "Este mundo se jugó por última vez en la versión %s y la tuya es %s. Desactualizar un mundo a una versión anterior podría dañarlo. No podemos garantizarte que cargue o funcione.\n\nSe guardará una copia de seguridad de tu mundo en «saves». Restaura tu mundo si es necesario.",
	"mco.compatibility.incompatible.popup.title": "Versión Incompatible",
	"mco.compatibility.incompatible.releaseType.popup.message": "El mundo al que quieres entrar es incompatible con tu versión del juego.",
	"mco.compatibility.incompatible.series.popup.message": "Este mundo fue jugado por última vez en la versión %s; estás en la %s.\n\nEstas series no son compatibles. Necesitas un mundo nuevo para jugar en esta versión.",
	"mco.compatibility.unverifiable.message": "No se ha podido verificar la versión en la que este se jugó mundo por última vez. Si el mundo se actualiza o baja de versión, se creará automáticamente una copia de seguridad que se guardará en «saves».",
	"mco.compatibility.unverifiable.title": "No se puede verificar la compatibilidad",
	"mco.compatibility.upgrade": "Actualizar",
	"mco.compatibility.upgrade.description": "Este mundo fue jugado por última vez en la versión %s; estás en la versión %s.\n\nSe guardará una copia de seguridad de tu mundo en \"Copias del mundo\". Por favor restaura tu mundo si es necesario.",
	...
	"mco.compatibility.upgrade.title": "¿De verdad quieres actualizar tu mundo?",
	...
	"mco.configure.world.buttons.region_preference": "Seleccione región...",
	"mco.configure.world.buttons.resetworld": "Reiniciar mundo",
	"mco.configure.world.buttons.save": "Guardado",
	...
	"mco.configure.world.close.question.title": "¿Necesitas hacer cambios sin distracciones?",
	...
	"mco.configure.world.invite.narration": "Tienes %s nueva(s) invitacione(s)",
	...
	"mco.configure.world.name.validation.whitespace": "No debe empezar ni terminar con un espacio en blanco. Se recortará.",
	"mco.configure.world.opening": "Abriendo el realm...",
	"mco.configure.world.players.error": "No existe ningún jugador con ese nombre",
	"mco.configure.world.players.invite.duplicate": "Un jugador con el nombre dado ya ha sido invitado al Realm",
	"mco.configure.world.players.inviting": "Invitando...",
	...
	"mco.configure.world.region_preference.title": "Preferencia de región",
	...
	"mco.configure.world.settings.expired": "No puedes editar los ajustes de un Reinos caducado",
	...
	"mco.configure.world.spawn_toggle.message": "Desactivar esta opción eliminará todas las entidades existentes de ese tipo",
	"mco.configure.world.spawn_toggle.message.npc": "Desactivar esta opción eliminará todas las entidades existentes de ese tipo, como aldeanos.",
	...
	"mco.configure.world.subscription.recurring.info": "Los cambios hechos a tu suscripción de Realms, como añadir tiempo a tu suscripción o cancelar facturaciones recurrentes, no se verán reflejados hasta tu próxima fecha de facturación.",
	...
	"mco.configure.world.uninvite.player": "¿Seguro que quieres cancelar la invitación de %s?",
	...
	"mco.download.confirmation.oversized": "El mundo que vas a descargar es más grande que %s\n\nNo podrás volver a subir este mundo a tu realm.",
	...
	"mco.errorMessage.6007": "El usuario está en muchos Realms",
	"mco.errorMessage.6008": "Nombre del realm no válido",
	...
	"mco.errorMessage.noDetails": "No se han proporcionado los detalles del error",
	"mco.errorMessage.realmsService": "Ha ocurrido un error (%s):",
	"mco.errorMessage.realmsService.configurationError": "Ha ocurrido un error inesperado al intentar editar las opciones del mundo",
	"mco.errorMessage.realmsService.connectivity": "No se pudo conectar al Realms: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "No se pudo comprobar la versión compatible, obteniendo respuesta: %s",
	"mco.errorMessage.retry": "Reintentar operación",
	"mco.errorMessage.serviceBusy": "Realms está ocupado en este momento.\nIntenta conectarte en unos minutos.",
	"mco.gui.button": "Botón",
	"mco.gui.ok": "Aceptar",
	"mco.info": "Información!",
	"mco.invited.player.narration": "Jugador invitado %s",
	"mco.invites.button.accept": "Aceptar",
	"mco.invites.button.reject": "Rechazar",
	"mco.invites.nopending": "¡No hay invitaciones pendientes!",
	"mco.invites.pending": "Nueva(s) invitación(es)!",
	...
	"mco.play.button.realm.closed": "El reino está cerrado",
	...
	"mco.reset.world.title": "Restablecer mundo",
	...
	"mco.snapshot.createSnapshotPopup.text": "Está a punto de crear un Realm Snapshot gratuito que se emparejará con su suscripción a Realms pagada. Este nuevo Realm Snapshot será accesible mientras la suscripción pagada siga activa. Tu Realm pagado no será afectado",
	"mco.snapshot.createSnapshotPopup.title": "¿Crear Realm Snapshot?",
	"mco.snapshot.creating": "Creando Realm de prueba...",
	"mco.snapshot.description": "Emparejado con %s",
	"mco.snapshot.friendsRealm.downgrade": "Debes estar en la versión %s para entrar a este Realm",
	"mco.snapshot.friendsRealm.upgrade": "%s necesita actualizar su Realm antes de que puedas jugar desde esta version",
	"mco.snapshot.paired": "Este Realm Snapshot está emparejado con %s",
	"mco.snapshot.parent.tooltip": "Utiliza la última versión de Minecraft para jugar en este Realm",
	"mco.snapshot.start": "Iniciar Realm Snapshot gratuito",
	"mco.snapshot.subscription.info": "Este es un Realm Snapshot que está emparejado a la suscripción de tu Realm '%s'. Permanecerá activo mientras tu Realm emparejado esté.",
	"mco.snapshot.tooltip": "Utiliza Realms Snapshot para conseguir un vistazo a las próximas versiones de Minecraft, que pueden incluir nuevas características y otros cambios.\n\nPuedes encontrar tus Realms normales en la versión completa del juego.",
	"mco.snapshotRealmsPopup.message": "Los Realms ahora están disponibles en versiones snapshot desde la Snapshot 23w41a. ¡Todas las suscripciones a Realms vienen con un Realm Snapshot gratuito que viene por separado de tu Realm normal!",
	"mco.snapshotRealmsPopup.title": "Realms ahora es compatible con las versiones snapshot",
	"mco.snapshotRealmsPopup.urlText": "Aprende más",
	...
	"mco.upload.failed.too_big.description": "El mundo seleccionado es demasiado grande. El tamaño máximo permitido es %s.",
	...
	"menu.custom_options.tooltip": "Nota: Las opciones personalizadas las proporcionan servidores de terceros y/o contenido.\n¡Ten cuidado!",
	"menu.custom_screen_info.button_narration": "Esto es una pantalla personalizada. Más información.",
	"menu.custom_screen_info.contents": "El contenido de esta pantalla está controlado por servidores y mapas de terceros que no son propiedad, están operados ni supervisados por Mojang Studios ni por Microsoft.\n\n¡Mano con cuidado! Tenga siempre cuidado al seguir los enlaces y nunca regale su información personal, incluidos los datos de inicio de sesión.\n\nSi esta pantalla le impide jugar, también puede desconectarse del servidor actual utilizando el botón de abajo.",
	"menu.custom_screen_info.disconnect": "Pantalla personalizada desconectada",
	"menu.custom_screen_info.title": "Acerca de las pantallas personalizadas",
	"menu.custom_screen_info.tooltip": "Esto es una pantalla personalizada. Haga clic aquí para más información.",
	"menu.disconnect": "Desconectarte",
	"menu.feedback": "Comentario...",
	"menu.feedback.title": "Comentario",
	"menu.game": "Menú",
	...
	"multiplayer.confirm_command.permissions_required": "Estás intentando ejecutar un comando que necesita permisos elevados.\nEsto podría afectar negativamente a tu juego.\n¿Seguro que quieres hacer esto?\nComando: %s",
	...
	"multiplayer.disconnect.bad_chat_index": "Mensaje de chat perdido o reordenado desde el servidor",
	...
	"multiplayer.disconnect.out_of_order_chat": "Se ha detectado un paquete de chat fuera de servicio. ¿Cambiaste la hora de tu sistema?",
	...
	"multiplayer.unsecureserver.toast": "Los mensajes enviados al servidor pueden ser modificados y no reflejar el mensaje original",
	"multiplayer.unsecureserver.toast.title": "Los mensajes del chat no pueden ser verificados",
	...
	"music.game.a_familiar_room": "Aron Cherof - A Familiar Room",
	"music.game.an_ordinary_day": "Kumi Tanioka - Un día cualquiera",
	...
	"music.game.comforting_memories": "Kumi Tanioka - Recuerdos reconfortantes",
	...
	"music.game.floating_dream": "Kumi Tanioka - Floating Dream (Sueño flotante)",
	...
	"music.menu.mutation": "C418 - Mutación",
	...
	"narration.checkbox.usage.focused.check": "Pulse Intro para comprobar",
	"narration.checkbox.usage.focused.uncheck": "Pulse Intro para desmarcar",
	"narration.checkbox.usage.hovered": "Clic izquierdo para alternar",
	"narration.checkbox.usage.hovered.check": "Haga clic con el botón izquierdo para marcar",
	"narration.checkbox.usage.hovered.uncheck": "Haga clic con el botón izquierdo para desmarcar",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Presiona Entrar para empezar a cambiar el valor del deslizador",
	...
	"narration.suggestion.usage.cycle.fixed": "Pulsa Tabulador para pasar a la siguiente sugerencia",
	"narration.suggestion.usage.cycle.hidable": "Presiona Tabulador para pasar a la siguiente sugerencia, o Escapar para salir de las sugerencias",
	"narration.suggestion.usage.fill.fixed": "Pulsa Tabulador para usar la sugerencia",
	"narration.suggestion.usage.fill.hidable": "Pulsa Tabulador para usar la sugerencia, o Escapar para salir de las sugerencias",
	...
	"narrator.position.tab": "Pestaña numero %s de %s",
	"narrator.ready_to_play": "Listo para jugar! :)",
	"narrator.screen.title": "Menú principal",
	"narrator.screen.usage": "Usa el cursor del mouse o el tabulador para seleccionar elemento",
	...
	"optimizeWorld.confirm.proceed": "Crear copia de seguridad y optimizar",
	...
	"optimizeWorld.stage.finished.chunks": "Finalizando mejora de chunks...",
	"optimizeWorld.stage.finished.entities": "Finalizando mejora de entidades...",
	"optimizeWorld.stage.finished.poi": "Finalizando mejora de puntos de interés...",
	"optimizeWorld.stage.upgrading": "Mejorando todos los chunks...",
	"optimizeWorld.stage.upgrading.chunks": "Mejorando todos los chunks...",
	"optimizeWorld.stage.upgrading.entities": "Mejorando todas las entidades...",
	"optimizeWorld.stage.upgrading.poi": "Mejorando todos los puntos de interés...",
	"optimizeWorld.title": "Optimizando el mundo \"%s\"",
	"options.accessibility": "Opciones de accesibilidad...",
	...
	"options.accessibility.high_contrast_block_outline": "Contraste en contorno de bloques",
	"options.accessibility.high_contrast_block_outline.tooltip": "Mejora el contraste del borde del bloque apuntado.",
	"options.accessibility.link": "Guía de accesibilidad",
	"options.accessibility.menu_background_blurriness": "Desenfoque del fondo de los menús",
	"options.accessibility.menu_background_blurriness.tooltip": "Cambia el desenfoque de los fondos de los menús",
	...
	"options.accessibility.title": "Opciones de accesibilidad",
	...
	"options.chat": "Ajustes de chat...",
	"options.chat.color": "Colores",
	"options.chat.delay": "Retraso del chat: %s segundos",
	"options.chat.delay_none": "Ralentizar chat: NO",
	"options.chat.drafts": "Guardar Chats No Enviados",
	...
	"options.chunkFade": "Tiempo de desvanecimiento de los Chunks",
	"options.chunkFade.none": "Desvanecimiento: Nada",
	"options.chunkFade.seconds": "Desvanecimiento: %s segundos",
	"options.chunkFade.tooltip": "¿Cuánto tiempo, en segundos, deberían tardar en aparecer gradualmente los Chunks cuando se renderizan por primera vez, si es que deben hacerlo?",
	...
	"options.cutoutLeaves": "Hojas transparentes",
	...
	"options.damageTiltStrength": "Sacudida al recibir daño",
	"options.damageTiltStrength.tooltip": "La sacudida de la cámara cuando te golpean.",
	...
	"options.darknessEffectScale": "Pulsaciones oscuras",
	...
	"options.difficulty.easy.info": "Las criaturas agresivas aparecen, pero quitan menos daño. La barra de hambre estando vacía solo te quita hasta 5 corazones.",
	"options.difficulty.hard": "Difícil",
	"options.difficulty.hard.info": "Aparecen criaturas hostiles más fuertes. La barra de hambre se agota, pudiendo reducir toda la salud.",
	"options.difficulty.hardcore": "Extremo",
	"options.difficulty.normal": "Normal",
	"options.difficulty.normal.info": "Las criaturas agresivas aparecen, y tienen un daño estándar. Cuando la hambre baja por completo, empezarás a recibir daño hasta quedarte a medio corazón.",
	...
	"options.directionalAudio.off.tooltip": "Sonido estereo clásico",
	"options.directionalAudio.on.tooltip": "Usa audio direccional basado en HRTF para mejorar la simulación de sonido 3D. Se requiere hardware de audio compatible con HRTF, y se experimenta mejor con audífonos.%s.",
	...
	"options.fovEffectScale.tooltip": "Controla la variación del campo de visión con los efectos del juego.",
	"options.framerate": "%s",
	...
	"options.fullscreen.entry": "%sx%s a %shz (%s bits)",
	...
	"options.glintSpeed.tooltip": "Controla que tan rápido es el brillo del destello visual va en los objetos encantados.",
	"options.glintStrength": "La Intensidad del destello",
	"options.glintStrength.tooltip": "Controla que tan transparente es el destello visual en los objetos encantados.",
	...
	"options.graphics.preset": "Preestablecido",
	"options.graphics.preset.tooltip": "Establece los ajustes de 'Calidad y Rendimiento' en valores predeterminados razonables correspondientes a la calidad deseada",
	...
	"options.hideLightningFlashes": "Ocultar destellos del cielo",
	"options.hideLightningFlashes.tooltip": "Evita que los rayos hagan que se ilumine el cielo. Aun así, se seguirán viendo los rayos.",
	"options.hideMatchedNames": "Ocultar nombres iguales",
	"options.hideMatchedNames.tooltip": "Los servidores de terceros pueden enviar mensajes de chat en formatos no estándar. Con esta opción activada, los jugadores ocultos serán emparejados en función de los nombres de los remitentes del chat.",
	"options.hideSplashTexts": "Ocultar textos de bienvenida",
	"options.hideSplashTexts.tooltip": "Oculta los textos parpadeantes amarillos que aparecen en el menú principal.",
	"options.improvedTransparency": "Transparencia mejorada",
	"options.improvedTransparency.tooltip": "Un enfoque experimental que utiliza sombreadores de pantalla para dibujar el clima, las nubes y las partículas detrás de los bloques translúcidos y el agua.",
	...
	"options.inactivityFpsLimit.afk": "Al estar inactivo",
	"options.inactivityFpsLimit.afk.tooltip": "Limita los FPS tras pasar un corto tiempo sin actividad. El limite aumentará a 10 FPS después de pasar 10 minutos sin actividad.",
	"options.inactivityFpsLimit.minimized": "Minimizado",
	"options.inactivityFpsLimit.minimized.tooltip": "Limitar los cuadros por segundo cuando el juegos se encuentra minimizado.",
	...
	"options.japaneseGlyphVariants.tooltip": "Usa variantes japonesas de los caracteres CJK en la fuente predeterminada",
	...
	"options.maxAnisotropy": "Filtro Anisotropico",
	"options.maxAnisotropy.tooltip": "Mejora significativamente cuan limpias se ven las texturas, pero afecta el rendimiento y afectará significativamente el uso de la memoria de vídeo. Puede no ser soportado por todos los hardwares.",
	...
	"options.modelPart.left_pants_leg": "Pierna izquierda del pantalón",
	"options.modelPart.left_sleeve": "Manga izquierda",
	"options.modelPart.right_pants_leg": "Pierna derecha del pantalón",
	...
	"options.musicToast": "Notificación musical",
	"options.musicToast.never": "Nunca",
	"options.musicToast.never.tooltip": "No se muestra ningúna notificación musical.",
	"options.musicToast.pauseMenu": "Menú de pausa",
	"options.musicToast.pauseMenu.tooltip": "Mientras suena una canción, se muestra constantemente un notificación musical en el menú de pausa del juego.",
	"options.musicToast.pauseMenuAndToast": "Menú de pausa y notificación",
	"options.musicToast.pauseMenuAndToast.tooltip": "Muestra una notificación cuando comienza a reproducirse una canción. La misma notificación se muestra constantemente en el menú de pausa del juego mientras se reproduce una canción.",
	"options.music_frequency": "Frecuencia de la música",
	"options.music_frequency.constant": "Continuo",
	...
	"options.notifications.display_time.tooltip": "Afecta al tiempo que todas las notificaciones permanecen visibles en la pantalla.",
	"options.off": "NO",
	...
	"options.onlyShowSecureChat.tooltip": "Solo mostrar mensajes de jugadores cuya pertenencia del mensaje haya sido verificada y no modificada.",
	...
	"options.realmsNotifications.tooltip": "Obtiene noticias e invitaciones de Realms en la pantalla de título y muestra su ícono respectivo en el botón Realms.",
	"options.reducedDebugInfo": "Reducir datos de F3",
	"options.renderClouds": "Nubes",
	"options.renderCloudsDistance": "Distancia de renderizado de las nubes",
	...
	"options.rotateWithMinecart": "Girar con Vagón",
	"options.rotateWithMinecart.tooltip": "Controla la vista del jugador si la cámara debería rotar al montar en un Vagón. Solo disponible en mundos con el ajuste experimental «Mejoras de Vagones» activado.",
	...
	"options.showNowPlayingToast": "Aviso de Música",
	"options.showNowPlayingToast.tooltip": "Muestra un aviso cada vez que una canción empiezen a sonar. El aviso\nsiempre estará en el menú de pausa siempre y cuando este soñando una \ncanción.",
	"options.showSubtitles": "Mostrar subtítulos",
	"options.showSubtitles.tooltip": "Activa subtítulos para sonidos reproducidos en el juego.",
	...
	"options.telemetry": "Datos de telemetría...",
	...
	"options.textureFiltering": "Filtro de texturas",
	"options.textureFiltering.anisotropic": "Filtro Anisotropico",
	"options.textureFiltering.anisotropic.tooltip": "Es un método de filtrado basado en hardware, pero afecta al rendimiento y al uso de la memoria de vídeo de forma significativa. Puede que no sea compatible con todo el hardware.",
	"options.textureFiltering.none": "Ninguno",
	"options.textureFiltering.none.tooltip": "Las texturas se muestran sin ningún filtro. Los bloques pueden verse borrosos al mirarlos desde un ángulo.",
	"options.textureFiltering.rgss": "SCR",
	"options.textureFiltering.rgss.tooltip": "(Supermuestreo de cuadrícula rotada)\nUn método de filtrado basado en sombreadores que mejora la calidad de las texturas con un impacto moderado en el rendimiento.",
	...
	"options.vignette.tooltip": "Es un efecto sutil sobre la pantalla del juego que reduce el brillo en los bordes y avisa del límite del mundo.",
	"options.visible": "Visible",
	"options.vsync": "VSync",
	"options.weatherRadius": "Radio de efecto meteorológico",
	"options.weatherRadius.tooltip": "Radio del área donde los efectos de lluvia y nieve son visibles. Tiene un impacto muy bajo en el rendimiento.",
	...
	"pack.dropRejected.title": "Entradas que no son de paquetes",
	...
	"pack.incompatible.confirm.unknown": "Este paquete está averiado o diseñado para una versión desconocida de Minecraft y puede que ya no funcione correctamente.",
	...
	"painting.minecraft.bomb.title": "Objetivo Explotado Sastifactoriamente",
	...
	"painting.minecraft.courbet.title": "El reencuentro",
	...
	"painting.minecraft.passage.title": "Pasillo",
	"painting.minecraft.pigscene.author": "Kristoffer Zetterstrand",
	"painting.minecraft.pigscene.title": "La Porcena",
	...
	"painting.minecraft.skull_and_roses.title": "La calavera y las rosas",
	...
	"painting.minecraft.wanderer.title": "El caminante",
	...
	"painting.minecraft.wither.title": "Descomposición",
	...
	"particle.invalidOptions": "No se pudo analizar las opciones de la Particula: %s",
	...
	"quickplay.error.invalid_identifier": "No se pudo encontrar un mundo identificador proporcionado",
	"quickplay.error.realm_connect": "No se pudo conectar al Realm",
	"quickplay.error.realm_permission": "Carece de permisos para conectarse al Realm",
	"quickplay.error.title": "Error al ingresar al modo de juego rápido",
	...
	"realms.configuration.region_preference.automatic_player": "Automática (latencia del primero en unirse)",
	...
	"recover_world.bug_tracker": "Reportar un error",
	...
	"recover_world.issue.missing_file": "Archivo faltante",
	"recover_world.issue.none": "Sin problemas",
	"recover_world.message": "Se produjeron los siguientes problemas al intentar leer la carpeta «%s».\nTal vez sea posible restaurar el mundo de una versión anterior o puedes reportar el error en el registro de errores.",
	...
	"resourcePack.runtime_failure": "Se detectó un error en un paquete de recursos",
	...
	"restrictions_screen.permission.receive_player_messages.allowed": "Puedes recibir mensajes de los jugadores",
	"restrictions_screen.permission.receive_player_messages.denied": "No puedes recibir mensajes de los jugadores",
	"restrictions_screen.permission.receive_system_messages.allowed": "Puedes recibir mensajes del sistema por el servidor",
	"restrictions_screen.permission.receive_system_messages.denied": "No puedes recibir mensajes del sistema por el servidor",
	...
	"restrictions_screen.permission.send_messages.allowed": "Puedes enviar mensajes en el chat",
	"restrictions_screen.permission.send_messages.denied": "No puedes enviar mensajes en el chat",
	...
	"selectWorld.backupJoinSkipButton": "¡Yo sé lo que hago!",
	...
	"selectWorld.backupWarning.file_fixing_required": "Este mundo necesita una actualización antes de poder jugar. Recomendamos encarecidamente crear una copia de seguridad antes de continuar por si experimentas problemas con el mundo.",
	...
	"selectWorld.conversion.tooltip": "Este mundo debe ser abierto en una versión más antigua (como la 1.6.4) para ser convertido completamente sin problemas",
	...
	"selectWorld.experimental.message": "¡Atención!\nEsta configuración requiere de caractertísticas que aún están siendo desarrolladas. Puede que tu mundo deje de funcionar, se rompa o no funcione con futuras actualizaciones.",
	"selectWorld.experimental.title": "Aviso de características experimentales",
	"selectWorld.experiments": "Experimentos",
	"selectWorld.experiments.info": "Tiene posible novedades que son experimentales. Ten cuidado porque las cosas pueden dañarse. La opción Experimental no se puede desactivar después de la creación del mundo.",
	...
	"selectWorld.gameMode.adventure.info": "Igual que el modo supervivencia, pero no puedes colocar o destruir bloques.",
	...
	"selectWorld.gameMode.hardcore.info": "Modo supervivencia bloqueado en la dificultad \"Difícil\". No reapareces al morir.",
	...
	"selectWorld.recreate.error.title": "¡Ocurrió un error!",
	...
	"selectWorld.requiresFileFixingTooltip.play": "Este mundo debe actualizarse a la última versión antes de poder jugarlo debido a cambios subyacentes en el formato del mundo.",
	...
	"selectWorld.waitingForBackup.message": "Dependiendo del tamaño de tu mundo, esto puede tardar un poco. No cierres el juego ni apagues tu dispositivo.",
	"selectWorld.waitingForBackup.title": "Creando una copia de seguridad",
	...
	"selectWorld.warning.deprecated.title": "¡Atención! Estas opciones utilizan características que ya no están en uso",
	...
	"selectWorld.warning.experimental.title": "¡Advertencia! Estas opciones utilizan características experimentales",
	"selectWorld.warning.lowDiskSpace.description": "No queda mucho espacio en tu dispositivo.\nTu mundo podría corromperse si te quedas sin espacio en el disco mientras juegas.",
	...
	"selecteWorld.backupRequiredTooltip": "Para cargar el mundo es necesario realizar primero una copia de seguridad",
	...
	"slot.only_single_allowed": "Solo se permiten espacios individuales, se obtuvo ‘%s’",
	"slot.unknown": "Ranura desconocida: %s",
	"snbt.parser.empty_key": "La tecla no puede estar vacía",
	"snbt.parser.expected_binary_numeral": "Se espera un número binario",
	"snbt.parser.expected_decimal_numeral": "Se espera un número Decimal",
	"snbt.parser.expected_float_type": "Se espera un número de coma flotante",
	"snbt.parser.expected_hex_escape": "Se espera un carácter literal de longitud %s",
	"snbt.parser.expected_hex_numeral": "Se espera un número hexadecimal",
	"snbt.parser.expected_integer_type": "Se espera un número entero",
	"snbt.parser.expected_non_negative_number": "Se espera un número no negativo",
	"snbt.parser.expected_number_or_boolean": "Se espera un número o un boolean",
	"snbt.parser.expected_string_uuid": "Se espera un hilo que represente un UUID valido",
	"snbt.parser.expected_unquoted_string": "Se espera una cadena válida sin comillas",
	"snbt.parser.infinity_not_allowed": "No se admiten números no finitos",
	...
	"snbt.parser.invalid_codepoint": "Valor de carácter unicode no válido: %s",
	...
	"snbt.parser.no_such_operation": "No existe tal operación: %s",
	"snbt.parser.number_parse_failure": "Error al analizar el número: %s",
	"snbt.parser.undescore_not_allowed": "Los guiones bajos no están permitidos al principio ni al final de un número",
	...
	"stat.minecraft.happy_ghast_one_cm": "Distancia de ghast feliz",
	...
	"stat.minecraft.nautilus_one_cm": "Distancia por nautilo",
	...
	"subtitles.ambient.sound": "Ruidos espeluznantes",
	...
	"subtitles.block.cake.add_candle": "Torta aplastándose",
	...
	"subtitles.block.copper_trapdoor.close": "Escotilla se cierra",
	"subtitles.block.copper_trapdoor.open": "Escotilla se abre",
	"subtitles.block.crafter.craft": "Fabricador fabrica",
	"subtitles.block.crafter.fail": "Fabricador falla",
	"subtitles.block.creaking_heart.hurt": "Gruñidos de corazón crujidor",
	"subtitles.block.creaking_heart.idle": "Ruidos espeluznantes",
	"subtitles.block.creaking_heart.spawn": "Despertó el corazón crujidor",
	"subtitles.block.deadbush.idle": "Ruidos secos",
	"subtitles.block.decorated_pot.insert": "Vasija decorada se llena",
	"subtitles.block.decorated_pot.insert_fail": "Vasija decorada se bambolea",
	"subtitles.block.decorated_pot.shatter": "Vasija se rompe",
	...
	"subtitles.block.dried_ghast.ambient": "Jadeo de Ghast Seco",
	"subtitles.block.dried_ghast.ambient_water": "Ghast seco rehidratándose",
	"subtitles.block.dried_ghast.place_in_water": "Ghast seco en remojo",
	...
	"subtitles.block.eyeblossom.close": "Florojo se cierra",
	"subtitles.block.eyeblossom.idle": "Murmullos de la flor de ojo",
	"subtitles.block.eyeblossom.open": "Florojo se abre",
	...
	"subtitles.block.frogspawn.hatch": "Huevas de rana eclosionan",
	"subtitles.block.furnace.fire_crackle": "Chispas de horno",
	"subtitles.block.generic.break": "Bloque roto",
	"subtitles.block.generic.fall": "Algo cae encima de un bloque",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Cartel se bambolea",
	...
	"subtitles.block.pale_hanging_moss.idle": "Ruidos espeluznantes",
	...
	"subtitles.block.respawn_anchor.ambient": "Portal suena",
	...
	"subtitles.block.shelf.take_item": "Objeto tomado",
	"subtitles.block.shulker_box.close": "Caja de shulker cerrada",
	"subtitles.block.shulker_box.open": "Shulker se abre",
	"subtitles.block.sign.waxed_interact_fail": "Cartel se tambalea",
	"subtitles.block.smithing_table.use": "Mesa de herrería usada",
	"subtitles.block.smoker.smoke": "Ahumador echando humo",
	"subtitles.block.sniffer_egg.crack": "Huevo de sniffer con grietas ",
	"subtitles.block.sniffer_egg.hatch": "Huevo de Sniffer eclosionado ",
	"subtitles.block.sniffer_egg.plop": "Sniffer pone un huevo",
	"subtitles.block.sponge.absorb": "Esponja absorbiendo",
	"subtitles.block.sweet_berry_bush.pick_berries": "Bayas caen",
	"subtitles.block.trapdoor.close": "Escotilla se cierra",
	"subtitles.block.trapdoor.open": "Escotilla se abre",
	...
	"subtitles.block.trial_spawner.ambient": "Generador de Prueba crepita",
	"subtitles.block.trial_spawner.ambient_charged": "Crujido Siniestro",
	"subtitles.block.trial_spawner.ambient_ominous": "Crujido Siniestro",
	"subtitles.block.trial_spawner.charge_activate": "Presagio envuelve un Generador de Prueba",
	"subtitles.block.trial_spawner.close_shutter": "Generador de Prueba se cierra",
	"subtitles.block.trial_spawner.detect_player": "Generador de Prueba se carga",
	"subtitles.block.trial_spawner.eject_item": "Generador de Prueba expulsa objetos",
	"subtitles.block.trial_spawner.ominous_activate": "Presagio envuelve un Generador de Prueba",
	"subtitles.block.trial_spawner.open_shutter": "Generador de Prueba se abre",
	"subtitles.block.trial_spawner.spawn_item": "Objetos que Suelta Siniestro",
	"subtitles.block.trial_spawner.spawn_item_begin": "Objeto Siniestro Aparece",
	"subtitles.block.trial_spawner.spawn_mob": "Generador de Prueba genera una criatura",
	...
	"subtitles.block.vault.activate": "Boveda activada",
	"subtitles.block.vault.ambient": "Sonido de boveda",
	"subtitles.block.vault.close_shutter": "Boveda cerrada",
	"subtitles.block.vault.deactivate": "Boveda desactivada",
	"subtitles.block.vault.eject_item": "Boveda suelta un item",
	"subtitles.block.vault.insert_item": "Boveda desbloqueada",
	"subtitles.block.vault.insert_item_fail": "Boveda falla al desbloquear",
	"subtitles.block.vault.open_shutter": "Boveda se abre",
	"subtitles.block.vault.reject_rewarded_player": "El arca rechazó al jugador",
	...
	"subtitles.entity.armadillo.ambient": "Cachicamo gruñe",
	"subtitles.entity.armadillo.brush": "Cepillado de Cachicamo",
	"subtitles.entity.armadillo.death": "Cachicamo muere",
	"subtitles.entity.armadillo.eat": "Cachicamo come",
	"subtitles.entity.armadillo.hurt": "Cachicamo herido",
	"subtitles.entity.armadillo.hurt_reduced": "Cachicamo se resguarda",
	"subtitles.entity.armadillo.land": "Cachicamo aterriza",
	"subtitles.entity.armadillo.peek": "Cachicamo se asoma",
	"subtitles.entity.armadillo.roll": "Cachicamo se enrolla",
	"subtitles.entity.armadillo.scute_drop": "Cachicamo suelta una escama",
	"subtitles.entity.armadillo.unroll_finish": "Cachicamo se desenrolla",
	"subtitles.entity.armadillo.unroll_start": "Cachicamo se asoma",
	...
	"subtitles.entity.baby_pig.ambient": "Cerdito gruñe",
	"subtitles.entity.baby_pig.death": "Cerdito muere",
	"subtitles.entity.baby_pig.eat": "Cerdito come",
	"subtitles.entity.baby_pig.hurt": "Cerdito herido",
	"subtitles.entity.baby_wolf.ambient": "Lobo bebé aúlla",
	"subtitles.entity.baby_wolf.death": "Lobo bebé muere",
	"subtitles.entity.baby_wolf.growl": "Lobo bebé gruñe",
	"subtitles.entity.baby_wolf.hurt": "Lobo bebé herido",
	"subtitles.entity.baby_wolf.pant": "Lobo bebé jadea",
	"subtitles.entity.baby_wolf.whine": "Lobo bebé gime",
	...
	"subtitles.entity.bogged.ambient": "Traqueteo de esqueleto pantanoso",
	"subtitles.entity.bogged.death": "Esqueleto pantanoso muere",
	"subtitles.entity.bogged.hurt": "Esqueleto pantanoso herido",
	"subtitles.entity.breeze.charge": "Brisa carga",
	"subtitles.entity.breeze.death": "Brisa muere",
	"subtitles.entity.breeze.deflect": "Brisa desvía",
	"subtitles.entity.breeze.hurt": "Brisa herida",
	"subtitles.entity.breeze.idle_air": "Brisa vuela",
	"subtitles.entity.breeze.idle_ground": "Brisa zumba",
	"subtitles.entity.breeze.inhale": "Brisa inhala",
	"subtitles.entity.breeze.jump": "Brisa salta",
	"subtitles.entity.breeze.land": "Brisa aterriza",
	"subtitles.entity.breeze.shoot": "Briza dispara",
	"subtitles.entity.breeze.slide": "Brisa se desplaza",
	"subtitles.entity.breeze.whirl": "Brisa ulula",
	"subtitles.entity.breeze.wind_burst": "Carga de brisa estalla",
	"subtitles.entity.camel.ambient": "Camello gruñe",
	"subtitles.entity.camel.dash": "Camello brinca",
	...
	"subtitles.entity.camel.saddle": "Silla equipada",
	"subtitles.entity.camel.sit": "Camello se sienta",
	"subtitles.entity.camel.stand": "Camello se levanta",
	"subtitles.entity.camel.step": "Camello camina",
	"subtitles.entity.camel.step_sand": "Camello camina sobre arena",
	"subtitles.entity.camel_husk.ambient": "Gruñidos del Camello seco",
	"subtitles.entity.camel_husk.dash": "Impulso del Camello seco",
	"subtitles.entity.camel_husk.dash_ready": "Recarga del Camello seco",
	"subtitles.entity.camel_husk.death": "Camello seco muere",
	"subtitles.entity.camel_husk.eat": "Camello seco come",
	"subtitles.entity.camel_husk.hurt": "Camello seco herido",
	"subtitles.entity.camel_husk.saddle": "La montura es equipada",
	"subtitles.entity.camel_husk.sit": "El Camello seco se sienta",
	"subtitles.entity.camel_husk.stand": "Camello seco se levanta",
	...
	"subtitles.entity.copper_golem.item_drop": "Gólem de Cobre está colocando un ítem",
	"subtitles.entity.copper_golem.item_no_drop": "Gólem de cobre no puede colocar el ítem",
	"subtitles.entity.copper_golem.no_item_get": "Gólem de cobre está recogiendo un objeto",
	...
	"subtitles.entity.copper_golem_become_statue": "Gólem de Cobre es petrificado",
	...
	"subtitles.entity.copper_golem_oxidized.spin": "Cabeza del Gólem de Cobre gira",
	...
	"subtitles.entity.copper_golem_weathered.spin": "Cabeza del Gólem de Cobre gira",
	...
	"subtitles.entity.creaking.activate": "Crepitante activa",
	"subtitles.entity.creaking.ambient": "Tronador truena",
	"subtitles.entity.creaking.attack": "Tronador ataca",
	"subtitles.entity.creaking.deactivate": "Crepitante se desactiva",
	"subtitles.entity.creaking.death": "Crepitante muere",
	"subtitles.entity.creaking.freeze": "Crepitante se detiene",
	"subtitles.entity.creaking.spawn": "Crepitante aparece",
	"subtitles.entity.creaking.sway": "Crepitante se protege",
	...
	"subtitles.entity.drowned.ambient_water": "Ahogado gargarea",
	...
	"subtitles.entity.generic.wind_burst": "Carga de brisa estalla",
	...
	"subtitles.entity.ghastling.ambient": "Ghastling tararea",
	...
	"subtitles.entity.happy_ghast.ambient": "Ghast feliz tararea",
	...
	"subtitles.entity.leash_knot.break": "Nudo de la rienda se rompe",
	"subtitles.entity.leash_knot.place": "Nudo de la rienda atada",
	...
	"subtitles.entity.nautilus.dash_land": "Nautilo se impulsa",
	"subtitles.entity.nautilus.dash_ready": "Nautilo se recupera",
	"subtitles.entity.nautilus.dash_ready_land": "Nautilo recarga",
	...
	"subtitles.entity.parched.ambient": "Esqueleto disecado cruje",
	"subtitles.entity.parched.death": "Esqueleto disecado muere",
	"subtitles.entity.parched.hurt": "Esqueleto disecado herido",
	...
	"subtitles.entity.parrot.imitate.breeze": "Loro imita a una brisa",
	"subtitles.entity.parrot.imitate.camel_husk": "Loro imita un Camello seco",
	"subtitles.entity.parrot.imitate.creaking": "Crujidos de loro",
	...
	"subtitles.entity.parrot.imitate.guardian": "Loro gime como un guardián",
	...
	"subtitles.entity.parrot.imitate.illusioner": "Loro murmura como un ilusionista",
	"subtitles.entity.parrot.imitate.magma_cube": "Loro imita a un cubo de magma",
	"subtitles.entity.parrot.imitate.parched": "Loro imita un esqueleto disecado",
	...
	"subtitles.entity.parrot.imitate.pillager": "Loro murmura como un saqueador",
	...
	"subtitles.entity.parrot.imitate.silverfish": "Loro sisea como un pececillo de plata",
	...
	"subtitles.entity.parrot.imitate.wither_skeleton": "Loro imita a un esqueleto de Wither",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Loro imita un Caballo zombí",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Loro imita un Nautilo zombí",
	...
	"subtitles.entity.pig.saddle": "Silla equipada",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Salto de caballo esquelético",
	...
	"subtitles.entity.sniffer.egg_crack": "Huevo de sniffer se quiebra",
	...
	"subtitles.entity.tadpole.flop": "Renacuajo nada",
	...
	"subtitles.entity.turtle.shamble_baby": "Tortuga bebé repta",
	...
	"subtitles.entity.warden.sniff": "Olfateo de warden",
	...
	"subtitles.entity.wind_charge.throw": "Carga de brisa lanzada",
	"subtitles.entity.wind_charge.wind_burst": "Carga de brisa estalla",
	...
	"subtitles.entity.wolf.whine": "Lobo gimotea",
	...
	"subtitles.entity.zombie_nautilus.ambient_land": "Nautilo zombi gorgotea",
	"subtitles.entity.zombie_nautilus.dash": "Nautilo zombi se propulsa",
	"subtitles.entity.zombie_nautilus.dash_land": "Nautilo zombi se impulsa",
	"subtitles.entity.zombie_nautilus.dash_ready": "Nautilo zombi se recupera",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Nautilo zombi recarga",
	...
	"subtitles.event.mob_effect.raid_omen": "Se acerca una Invasión",
	"subtitles.event.mob_effect.trial_omen": "Se Acerca un desafio Siniestro",
	...
	"subtitles.item.armor.equip_copper": "Armadura de cobre hace un ruido seco",
	...
	"subtitles.item.armor.equip_nautilus": "Armadura de nautilo equipada",
	...
	"subtitles.item.armor.unequip_nautilus": "Armadura de nautilo desequipada",
	"subtitles.item.armor.unequip_wolf": "Armadura para lobo desequipada",
	...
	"subtitles.item.brush.brushing.gravel": "Cepillando gravilla",
	"subtitles.item.brush.brushing.gravel.complete": "Cepillado de gravilla completado",
	"subtitles.item.brush.brushing.sand": "Arena cepillada",
	"subtitles.item.brush.brushing.sand.complete": "Arena completa cepillada",
	...
	"subtitles.item.bundle.drop_contents": "Bolsa se vacía",
	...
	"subtitles.item.crossbow.hit": "Flecha golpea",
	...
	"subtitles.item.golden_dandelion.unuse": "El diente de león dorado comienza a envejecer",
	"subtitles.item.golden_dandelion.use": "El diente de león dorado detiene el envejecimiento",
	...
	"subtitles.item.lead.tied": "Plomo atado",
	"subtitles.item.lead.untied": "Plomo desatado",
	"subtitles.item.llama_carpet.unequip": "La alfombra se recorta",
	"subtitles.item.lodestone_compass.lock": "Brújula magnetizada con magnetita",
	"subtitles.item.mace.smash_air": "Mazo aplasta",
	"subtitles.item.mace.smash_ground": "Mazo aplasta",
	"subtitles.item.nautilus_saddle_equip": "Se coloca la montura en nautilo",
	"subtitles.item.nautilus_saddle_underwater_equip": "Se coloca la montura en nautilo bajo el agua",
	"subtitles.item.nether_wart.plant": "Verruga plantada",
	"subtitles.item.ominous_bottle.dispose": "Botella se rompe",
	"subtitles.item.saddle.unequip": "Silla de montar recorta",
	"subtitles.item.shears.shear": "Tijeras cortando",
	"subtitles.item.shears.snip": "Corte de tijera",
	"subtitles.item.shield.block": "Bloqueo con escudo",
	"subtitles.item.shovel.flatten": "Pala aplanando",
	"subtitles.item.spear.attack": "Pinchazos de lanza",
	"subtitles.item.spear.hit": "Golpes de lanza",
	"subtitles.item.spear.lunge": "Estocadas con lanza",
	"subtitles.item.spear.use": "Carga con lanza",
	"subtitles.item.spear_wood.attack": "Pinchazos de lanza",
	"subtitles.item.spear_wood.hit": "Golpes de lanza",
	...
	"subtitles.item.underwater_saddle.equip": "Se coloca la montura en nautilo bajo el agua",
	"subtitles.item.wolf_armor.break": "Armadura para lobo se rompe",
	"subtitles.item.wolf_armor.crack": "Armadura para lobo se agrieta",
	"subtitles.item.wolf_armor.damage": "Armadura para lobo recibe daño",
	"subtitles.item.wolf_armor.repair": "Armadura para lobo es reparada",
	"subtitles.particle.soul_escape": "Fuga de alma",
	"subtitles.ui.cartography_table.take_result": "Mapa dibujado",
	"subtitles.ui.hud.bubble_pop": "Nivel de oxígeno agotándose",
	"subtitles.ui.loom.take_result": "Telar usado",
	"subtitles.ui.stonecutter.take_result": "Cortapiedras usado",
	"subtitles.weather.end_flash": "Trueno del End",
	"subtitles.weather.rain": "Lluvia",
	"symlink_warning.message": "Cargando mundos desde carpetas con enlaces simbólicos puede ser inseguro si no sabes exactamente lo que estás haciendo. Visita %s para más información.",
	"symlink_warning.message.pack": "Cargando paquetes con enlaces simbólicos puede ser inseguro si no sabes exactamente lo que estás haciendo. Visita %s para más información.",
	"symlink_warning.message.world": "Cargando mundos desde carpetas con enlaces simbólicos puede ser inseguro si no sabes exactamente lo que estás haciendo. Visita %s para más información.",
	"symlink_warning.more_info": "Más información",
	"symlink_warning.title": "La carpeta del mundo contiene enlaces simbólicos",
	"symlink_warning.title.pack": "Paquete(s) añadido(s) contiene(n) enlaces simbólicos",
	...
	"telemetry.event.advancement_made.description": "Comprendiendo el contexto en el que se realiza un progreso nos ayudará a entender y mejorar la progresión del juego.",
	...
	"telemetry.event.performance_metrics.description": "Conocer el perfil de rendimiento de Minecraft nos ayuda a mejorar y optimizar el juego para distintas computadoras y sistemas operativos. \nLa versión del juego se incluye para ayudarnos a comparar el rendimiento de nuevas versiones de Minecraft.",
	"telemetry.event.performance_metrics.title": "Medición de rendimiento",
	"telemetry.event.required": "%s (necesario)",
	"telemetry.event.world_load_times.description": "Es importante para nosotros saber el tiempo que se tarda en entrar a un mundo y cómo cambia eso con el tiempo. Por ejemplo, cuando añadimos nuevas características o realizamos cambios técnicos significativos, necesitamos ver cuánto impacto tienen en los tiempos de carga.",
	"telemetry.event.world_load_times.title": "Tiempos de carga de los mundos",
	"telemetry.event.world_loaded.description": "Saber cómo los jugadores juegan a Minecraft (qué modo de juego, cliente o servidor y versión del juego) nos permite centrarnos en mejorar las partes del juego que más importan.\nEl evento \"Mundo cargado\" está vinculado a el de \"Mundo descargado\" para calcular cuánto ha durado la partida.",
	"telemetry.event.world_loaded.title": "Mundo cargado",
	"telemetry.event.world_unloaded.description": "Este evento está ligado al de «Mundo cargado» para calcular cuánto ha durado la sesión de juego.\nLa duración (en segundos y tics) se mide cuando una sesión de juego termina (saliendo al menú principal, desconectándose de un servidor).",
	...
	"telemetry.property.launcher_name.title": "Nombre del launcher",
	...
	"telemetry.property.opt_in.title": "Incribirse",
	...
	"telemetry.property.used_memory_samples.title": "Memoria de acceso aleatorio usada",
	"telemetry.property.user_id.title": "ID de usuario",
	"telemetry.property.world_load_time_ms.title": "Tiempo de la carga del mundo (milisegundos)",
	"telemetry.property.world_session_id.title": "ID de sesión de mundo",
	"telemetry_info.button.give_feedback": "Dar sugerencias",
	...
	"telemetry_info.property_title": "Información incluida",
	"telemetry_info.screen.description": "La recolección de datos nos ayuda a mejorar Minecraft guiándonos hacia direcciones relevantes para nuestros jugadores.\nTambién puedes envíar sugerencias adicionales para ayudarnos a mejorar Minecraft.",
	"telemetry_info.screen.title": "Recolección de datos de telemetría",
	"test.error.block_property_mismatch": "Se requiere que la propiedad %s sea %s, era %s",
	...
	"test.error.entity_property_details": "La entidad %s falló la prueba: %s, se requiere: %s, era: %s",
	"test.error.expected_block": "Se requiere el bloque %s, se obtuvo %s",
	"test.error.expected_block_present": "Se esperaba que el bloque %s estuviera presente",
	...
	"test.error.expected_entity_count": "Se requiere %s entidades del tipo %s, se encontró %s",
	"test.error.expected_entity_data": "Se requiere que los datos de la entidad sean: %s, eran: %s",
	...
	"test.error.expected_entity_not_touching": "No se requería que %s tocase %s, %s, %s (relativo: %s, %s, %s)",
	...
	"test.error.expected_items_count": "Se requieren %s objetos del tipo %s, se encontró %s",
	...
	"test.error.not_a_block_item": "El bloque dado no es un objeto de bloque",
	...
	"test.error.sequence.invalid_tick": "Éxito en tick inválido: se requiere %s",
	"test.error.sequence.minimum_tick": "Tuvo éxito antes del tick esperado: se esperaba esperar %s",
	...
	"test.error.state_not_equal": "Estado incorrecto. Se requiere %s, era %s",
	"test.error.structure.failure": "Fallo al colocar la estructura de prueba %s",
	"test.error.tick": "%s en el tick %s",
	"test.error.ticking_without_structure": "Prueba de ticks antes de colocar la estructura",
	"test.error.timeout.no_result": "No tuvo éxito o fracasó entre %s ticks",
	"test.error.timeout.no_sequences_finished": "Ninguna secuencia ha acabado en %s ticks",
	"test.error.too_many_entities": "Se requiere que exista un único %s alrededor de %s, %s, %s, pero se encontró %s",
	...
	"test_instance.description.invalid_id": "ID de prueba inválido ",
	...
	"test_instance_block.error.no_test": "No se pudo realizar la instancia de prueba en %s, %s, %s porque no hay definido una prueba",
	"test_instance_block.error.no_test_structure": "No se pudo realizar la instancia de prueba en %s, %s, %s porque no ha definido una estructura de prueba",
	...
	"test_instance_block.reset_success": "Reinicio exitoso para la prueba: %s",
	"test_instance_block.rotation": "Rotación:",
	"test_instance_block.size": "Tamaño de la estructura de prueba",
	"test_instance_block.starting": "Se inició la prueba %s",
	"test_instance_block.test_id": "ID de instancia de prueba",
	...
	"title.multiplayer.disabled.banned.name": "Debes cambiar tu nombre de usuario antes de jugar en modo multijugador",
	"title.multiplayer.disabled.banned.permanent": "Tu cuenta fue suspendida permanentemente y no podrás jugar en línea",
	...
	"trim_pattern.minecraft.coast": "Decoración de armadura costera",
	"trim_pattern.minecraft.dune": "Decoración de armadura de dunas",
	"trim_pattern.minecraft.eye": "Decoración de armadura de ojos de ender",
	...
	"trim_pattern.minecraft.rib": "Decoración de armadura de esqueleto de wither",
	"trim_pattern.minecraft.sentry": "Decoración de armadura centinela",
	"trim_pattern.minecraft.shaper": "Diseño de armadura de moldeador",
	"trim_pattern.minecraft.silence": "Diseño de armadura silenciosa",
	"trim_pattern.minecraft.snout": "Decoración de armadura de piglin",
	"trim_pattern.minecraft.spire": "Decoración de armadura de aguja",
	"trim_pattern.minecraft.tide": "Decoración de armadura de marea",
	"trim_pattern.minecraft.vex": "Decoración de armadura de vex",
	"trim_pattern.minecraft.ward": "Decoración de armadura de guardián",
	"trim_pattern.minecraft.wayfinder": "Diseño de armadura de buscacaminos",
	"trim_pattern.minecraft.wild": "Decoración de armadura salvaje",
	...
	"upgradeWorld.aborted.message": "Esto puede ocurrir si otro programa accedió al mundo durante la actualización. Reiniciar el ordenador y volver a intentarlo puede ser útil. Si el problema persiste, considera reportar un error.",
	"upgradeWorld.aborted.reportBug": "Reportar un bug",
	"upgradeWorld.aborted.title": "Falló al actualizar el mundo",
	"upgradeWorld.canceled.message": "Tu mundo permanece como era antes.",
	"upgradeWorld.canceled.title": "Actualización del mundo cancelada",
	"upgradeWorld.done": "Actualización del Mundo Completada",
	"upgradeWorld.failed_cleanup.message": "El mundo se actualizó correctamente a la versión actual y ya está disponible en la lista de mundos.\nEncontramos problemas al limpiar datos obsoletos, por lo que el nombre de la carpeta del mundo cambió a %s.",
	"upgradeWorld.failed_cleanup.title": "Actualización del mundo completada correctamente",
	...
	"upgradeWorld.joinNow": "¿Quieres unirte al mundo ahora?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Moviendo archivos",
	"upgradeWorld.progress.type.legacy_structures": "Actualizando estructuras antiguas",
	"upgradeWorld.progress.type.region": "Actualizando regiones",
	"upgradeWorld.symlink.message": "El mundo seleccionado contiene enlaces simbólicos.\nLos pasos necesarios para actualizar el mundo a la versión actual no admiten el uso de enlaces simbólicos. Para actualizar el mundo, primero es necesario resolver los enlaces.",
