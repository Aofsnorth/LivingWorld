// Code generated by tools/gen_lang.go from 26.1/es_cl.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advMode.notEnabled.spawner": "Los spawners están desactivados",
	...
	"advancements.adventure.blowback.title": "¡Sóplame este ojo!",
	"advancements.adventure.brush_armadillo.description": "Consigue escamas de armadillo cepillando a uno con un cepillo",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Arma una vasija decorada con 4 fragmentos de cerámica",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Restauración delicada",
	"advancements.adventure.crafters_crafting_crafters.description": "Presencia a una crafteadora craftear una crafteadora",
	...
	"advancements.adventure.heart_transplanter.description": "Coloca un corazón de crujidor alineado correctamente entre dos troncos de roble pálido",
	...
	"advancements.adventure.lighten_up.description": "Aumenta el brillo de una lámpara de cobre raspándola con un hacha",
	"advancements.adventure.lighten_up.title": "Lúcete",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Pon un pie en un calabozo de desafío",
	...
	"advancements.adventure.overoverkill.description": "Saca 50 corazones de daño con un solo golpe usando la maza",
	"advancements.adventure.overoverkill.title": "Masacre",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Lee la señal de Redstone de un estante de libros usando un comparador",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "El poder de la lectura",
	"advancements.adventure.revaulting.description": "Abre una bóveda ominosa con una llave de desafío ominosa",
	...
	"advancements.adventure.salvage_sherd.description": "Consigue un fragmento de cerámica cepillando un bloque sospechoso",
	...
	"advancements.adventure.spear_many_mobs.description": "Pégale a cinco criaturas con la misma carga de la lanza",
	"advancements.adventure.spear_many_mobs.title": "Anticucho de criaturas",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Usa alguno de estos moldes de herrería al menos una vez: aguja, hocico, costillas, guardia, silencio, vex, marea, guía",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Maestro de la herrería",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Decora una armadura en una mesa de herrería",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Forjando estilos",
	...
	"advancements.adventure.under_lock_and_key.description": "Abre una bóveda con una llave de desafío",
	"advancements.adventure.under_lock_and_key.title": "Bajo llave",
	"advancements.adventure.use_lodestone.description": "Imanta una brújula con magnetita",
	...
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.description": "Camina sobre nieve polvo... sin hundirte",
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.title": "Livianito como conejo",
	"advancements.adventure.who_needs_rockets.description": "Impúlsate 8 bloques al cielo con una carga de viento",
	"advancements.adventure.who_needs_rockets.title": "Sé que puedo volar",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Haz que un allay suelte una torta en un bloque musical",
	...
	"advancements.husbandry.feed_snifflet.description": "Dale de comer a un sniffer bebé",
	...
	"advancements.husbandry.obtain_sniffer_egg.title": "¿Qué es ese olor?",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Coloca un bloque de ghast deshidratado en agua",
	"advancements.husbandry.place_dried_ghast_in_water.title": "¡Siempre hidratado!",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Planta una semilla encontrada por un sniffer",
	"advancements.husbandry.plant_any_sniffer_seed.title": "Plantando el pasado",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Quítale la armadura a un lobo con unas tijeras",
	"advancements.husbandry.remove_wolf_armor.title": "Acicalado",
	"advancements.husbandry.repair_wolf_armor.description": "Repara por completo una armadura para lobos dañada con escamas de armadillo",
	...
	"advancements.husbandry.silk_touch_nest.description": "Mueve una colmena o un apiario con 3 abejas dentro usando toque de seda",
	...
	"advancements.husbandry.whole_pack.description": "Domestica a todas las razas de lobo",
	"advancements.husbandry.whole_pack.title": "Tírame a los lobos",
	...
	"argument.block.tag.disallowed": "Las etiquetas no están permitidas aquí, solo los bloques mismos",
	...
	"argument.float.big": "El valor flotar no puede ser mayor que %s encontrado: %s",
	"argument.float.low": "El valor flotar no puede ser menor que %s encontrado: %s",
	"argument.gamemode.invalid": "Modo de juego desconocido: %s",
	"argument.hexcolor.invalid": "Código hex de color no válido: '%s'",
	...
	"argument.nbt.expected.compound": "Se requiere una etiqueta compuesta",
	...
	"argument.resource_or_id.failed_to_parse": "No se pudo analizar la estructura: %s",
	"argument.resource_or_id.invalid": "ID o etiqueta inválida",
	"argument.resource_or_id.no_such_element": "No se encontró el elemento '%s' en el registro '%s'",
	...
	"argument.time.tick_count_too_low": "El número de ticks no puede ser menor a %s, se encontraron %s",
	...
	"arguments.item.component.expected": "Componente de ítem esperado",
	"arguments.item.component.malformed": "Componente '%s' mal formado: '%s'",
	"arguments.item.component.repeated": "El componente de objeto '%s' se repitió, pero solo puede especificarse un único valor",
	...
	"attribute.name.attack_damage": "Daño por ataque",
	"attribute.name.attack_knockback": "Empuje por ataque",
	...
	"attribute.name.bounciness": "Elasticidad",
	"attribute.name.burning_time": "Tiempo de quemado",
	...
	"attribute.name.follow_range": "Rango de seguimiento de mobs",
	...
	"attribute.name.generic.burning_time": "Tiempo de quemado",
	...
	"attribute.name.generic.step_height": "Altura de pasos",
	...
	"attribute.name.nameplate_distance": "Distancia del nametag",
	"attribute.name.oxygen_bonus": "Bonus de oxígeno",
	...
	"attribute.name.player.mining_efficiency": "Eficiencia al minar",
	"attribute.name.player.sneaking_speed": "Velocidad al agacharse",
	"attribute.name.player.submerged_mining_speed": "Eficiencia al minar bajo el agua",
	...
	"attribute.name.step_height": "Altura de pisadas",
	"attribute.name.submerged_mining_speed": "Eficiencia al romper bloques sumergido",
	"attribute.name.sweeping_damage_ratio": "Proporción del daño de barrido",
	"attribute.name.tempt_range": "Rango de atracción de mobs",
	"attribute.name.water_movement_efficiency": "Eficiencia de movimiento acuático",
	"attribute.name.waypoint_receive_range": "Rango de Recepción del Punto de Ruta",
	"attribute.name.waypoint_transmit_range": "Rango de Transmisión del Punto de Ruta",
	...
	"block.minecraft.banner.flow.cyan": "Flujo cian",
	"block.minecraft.banner.flow.gray": "Flujo gris",
	"block.minecraft.banner.flow.green": "Flujo verde",
	"block.minecraft.banner.flow.light_blue": "Flujo celeste",
	"block.minecraft.banner.flow.light_gray": "Flujo gris claro",
	"block.minecraft.banner.flow.lime": "Flujo verde lima",
	...
	"block.minecraft.banner.guster.brown": "Torbellino marrón",
	...
	"block.minecraft.cherry_wall_hanging_sign": "Cartel colgante de cerezo de pared",
	...
	"block.minecraft.chiseled_bookshelf": "Estante de libros",
	...
	"block.minecraft.crafter": "Crafteadora",
	...
	"block.minecraft.pale_oak_wall_hanging_sign": "Cartel colgante de roble pálido de pared",
	"block.minecraft.pale_oak_wall_sign": "Cartel de roble pálido en pared",
	"block.minecraft.pale_oak_wood": "Madera de roble pálido",
	...
	"block.minecraft.polished_deepslate_wall": "Pared de pizarra abismal pulida",
	...
	"block.minecraft.potted_closed_eyeblossom": "Macetero con miraflor cerrada",
	...
	"block.minecraft.potted_golden_dandelion": "Macetero con diente de león dorado",
	...
	"block.minecraft.potted_open_eyeblossom": "Macetero con miraflor abierta",
	...
	"block.minecraft.potted_pale_oak_sapling": "Macetero con brote de roble pálido",
	...
	"block.minecraft.short_dry_grass": "Pasto corto seco",
	...
	"block.minecraft.stripped_pale_oak_wood": "Madera de roble pálido sin corteza",
	...
	"block.minecraft.tall_dry_grass": "Pasto alto seco",
	...
	"block.minecraft.test_block": "Bloque de testeo",
	"block.minecraft.test_instance_block": "Bloque de prueba de instancias",
	"block.minecraft.tinted_glass": "Vidrio opaco",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "Explosiones de TNT desactivadas",
	...
	"block.minecraft.trial_spawner": "Spawner de desafío",
	...
	"book.edit.title": "Pantalla para Editar el Libro",
	...
	"book.sign.title": "Pantalla para Firmar el Libro",
	...
	"chat.disabled.chain_broken": "El chat se ha deshabilitado debido a una cadena rota. Por favor, intenta reconectarte.",
	...
	"chat.disabled.invalid_command_signature": "El comando tuvo firmas de argumento de comando inesperadas o perdidas.",
	"chat.disabled.invalid_signature": "El chat tuvo una firma inválida. Por favor, vuelve a conectarte.",
	"chat.disabled.launcher": "Chat desactivado en las opciones del launcher. No se pudo enviar el mensaje.",
	...
	"chat.disabled.profile.moreInfo": "Chat desactivado en los ajustes de la cuenta. No se pueden enviar ni ver mensajes.",
	"chat.editBox": "chat",
	...
	"chat_restriction.chat_disabled_by_options.action": "Ir a pantalla de ajustes de chat",
	...
	"chat_restriction.disabled_by_profile.action": "Ir a tus ajustes de perfil",
	...
	"chat_screen.restricted": "El chat está restringido. Haz click en este mensaje para más información.",
	...
	"chunk.toast.lowDiskSpace": "¡Almacenamiento insuficiente!",
	"chunk.toast.lowDiskSpace.description": "Es posible que no se pueda guardar el mundo.",
	"chunk.toast.saveFailure": "Error al guardar chunk en %s",
	...
	"commands.attribute.base_value.reset.success": "El valor base del atributo %s para la entidad %s se estableció a su valor predeterminado %s",
	...
	"commands.clone.success": "Se clonaron %s bloque(s)",
	"commands.clone.toobig": "Demasiados bloques en el área especificada (máximo %s, especificados: %s)",
	...
	"commands.data.modify.expected_value": "Valor esperado, se obtuvo: %s",
	...
	"commands.datapack.create.already_exists": "Ya hay un paquete con ese nombre: '%s'",
	"commands.datapack.create.invalid_full_name": "Nombre inválido para el nuevo paquete '%s'",
	"commands.datapack.create.invalid_name": "Caracteres inválidos en el nombre del nuevo paquete: '%s'",
	"commands.datapack.create.io_failure": "No se pudo crear un paquete con el nombre '%s', revisa los registros",
	"commands.datapack.create.metadata_encode_failure": "No se pudo codificar la información sobre los datos del paquete con el nombre '%s': %s",
	...
	"commands.datapack.disable.failed.feature": "¡No se puede desactivar el paquete '%s' porque es parte de una propiedad activada!",
	...
	"commands.debug.stopped": "Se detuvo el perfilado de ticks después de %s segundo(s) y %s tick(s) (%s tick(s) por segundo)",
	...
	"commands.dialog.clear.multiple": "Conversación eliminada para %s jugadores",
	"commands.dialog.clear.single": "Conversación eliminada para %s",
	"commands.dialog.show.multiple": "Conversación mostrada a %s jugadores",
	"commands.dialog.show.single": "Conversación mostrada a %s",
	...
	"commands.drop.no_loot_table.block": "El bloque %s no tiene tabla de loot",
	...
	"commands.drop.success.single_with_table": "Eliminados %s %s de la tabla de loot %s",
	...
	"commands.execute.blocks.toobig": "Demasiados bloques en el área especificada (máximo %s, especificados: %s)",
	...
	"commands.execute.function.instantiationFailure": "Error al instanciar la función %s: %s",
	...
	"commands.fetchprofile.failed_to_serialize": "No se pudo convertir el perfil: %s",
	"commands.fetchprofile.give_item": "Dar ítem",
	"commands.fetchprofile.id.failure": "Fallo en resolver configuración del Identificador %s",
	"commands.fetchprofile.id.success": "Resolver configuración del Identificador %s: %s",
	"commands.fetchprofile.name.failure": "Fallo en resolver configuración del nombre %s",
	"commands.fetchprofile.name.success": "Resolver configuración del nombre %s: %s",
	...
	"commands.fillbiome.success.count": "Esteblecida(s) %s entrada(s) al bioma entre %s, %s, %s y %s, %s, %s",
	...
	"commands.forceload.toobig": "Demasiados chunks en el área especificada (máximo %s, especificados: %s)",
	"commands.function.error.argument_not_compound": "Tipo de argumento no válido: %s, se esperaba un compuesto",
	...
	"commands.function.error.parse": "Al ejecutar el macro %s: el comando '%s' provocó el error: %s",
	"commands.function.instantiationFailure": "Error al instanciar la función %s: %s",
	"commands.function.result": "La función %s devolvió %s",
	"commands.function.scheduled.multiple": "Ejecutando funciones %s",
	"commands.function.scheduled.no_functions": "No se encontró ninguna función con el nombre %s",
	"commands.function.scheduled.single": "Ejecutando función %s",
	...
	"commands.function.success.single.result": "La función '%[2]s' retornó %[1]s",
	...
	"commands.kick.owner.failed": "No puedes expulsar al dueño de un server LAN",
	"commands.kick.singleplayer.failed": "No se puede expulsar en un mundo de un jugador",
	...
	"commands.profile_fetch.failed_to_serialize": "Fallo al convertir el perfil: %s",
	"commands.profile_fetch.give_item": "Dar ítem",
	"commands.profile_fetch.id.failure": "Fallo al resolver Configuración del identificar %s",
	"commands.profile_fetch.id.success": "Resolver configuración de Identificación %s: %s",
	"commands.profile_fetch.name.failure": "Fallo al resolver configuración del nombre %s",
	"commands.profile_fetch.name.success": "Resolver configuración del nombre %s: %s",
	...
	"commands.random.error.range_too_large": "El rango del número al azar debe ser como máximo 2147483646",
	"commands.random.error.range_too_small": "El rango del número al azar debe ser como mínimo 2",
	"commands.random.reset.all.success": "Se reseteó %s secuencia(s) aleatoria(s)",
	"commands.random.reset.success": "Se reseteó la secuencia aleatoria %s",
	"commands.random.roll": "%s sacó %s (entre %s y %s)",
	"commands.random.sample.success": "Número al azar: %s",
	"commands.recipe.give.failed": "No se han aprendido recetas",
	"commands.recipe.give.success.multiple": "Se desbloqueó %s receta(s) a %s jugadores",
	"commands.recipe.give.success.single": "Se desbloqueó %s receta(s) a %s",
	"commands.recipe.take.failed": "No hay recetas que olvidar",
	"commands.recipe.take.success.multiple": "Se eliminó %s receta(s) a %s jugadores",
	"commands.recipe.take.success.single": "Se eliminó %s receta(s) a %s",
	...
	"commands.schedule.created.tag": "Se programó la etiqueta '%s' dentro de %s tick(s) en tiempo de juego %s",
	"commands.schedule.macro": "No se pudo programar un macro",
	...
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Se quitó el formato numérico predeterminado del objetivo %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Se cambió el formato numérico predeterminado del objetivo %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Se limpió el nombre de %s entidades en %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Se limpió el nombre de %s en %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Se cambió el nombre a %s a %s entidades en %s",
	"commands.scoreboard.players.display.name.set.success.single": "Se cambió el nombre a %s a %s en %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Se limpió el formato numérico de %s entidades en %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Se limpió el formato numérico de %s en %s",
	...
	"commands.setidletimeout.success.disabled": "Se desactivó el tiempo máximo de inactividad por jugador",
	"commands.setworldspawn.failure.not_overworld": "El punto de aparición del mundo no puede estar en otra dimensión",
	...
	"commands.spreadplayers.success.entities": "Se repartió %s entidad(es) entre %s, %s con una distancia promedio de %s bloque(s)",
	"commands.spreadplayers.success.teams": "Se repartió %s equipo(s) entre %s, %s con una distancia promedio de %s bloque(s)",
	...
	"commands.summon.failed.peaceful": "Los Monstruos no pueden Aparecer en la dificultad Pacífica",
	...
	"commands.swing.success.multiple": "Se hizo que %s de las entidades muevan los brazos",
	...
	"commands.test.clear.success": "Estructura %s borrada(s)",
	...
	"commands.test.error.no_test_instances": "No se encontraron instancias de testeo",
	...
	"commands.test.error.too_large": "El tamaño de la estructura debe ser menor a %s bloques en cada eje",
	"commands.test.locate.done": "Búsqueda terminada, se han encontrado %s estructura(s)",
	"commands.test.locate.found": "Se ha encontrado una estructura en: %s (distancia: %s)",
	"commands.test.locate.started": "Se ha iniciado la búsqueda de estructuras de prueba, esto puede tardar un poco...",
	...
	"commands.test.reset.success": "Se han reiniciado %s estructura(s)",
	"commands.test.run.no_tests": "Ninguna prueba encontrada",
	...
	"commands.test.summary.all_required_passed": "Han pasado todas las pruebas requeridas :)",
	"commands.test.summary.failed": "Fallaron %s prueba(s) requeridas :(",
	"commands.test.summary.optional_failed": "Fallaron %s prueba(s) opcional(es)",
	"commands.tick.query.percentiles": "Percentiles P50: %sms, P95: %sms, P99: %sms, muestra: %s",
	"commands.tick.query.rate.running": "Tasa de ticks objetivo: %s por segundo.\nTiempo por tick promedio: %sms (Objetivo: %sms)",
	"commands.tick.query.rate.sprinting": "Tasa de ticks objetivo: %s por segundo (ignorado, solo de referencia)\nTiempo por tick promedio: %sms",
	"commands.tick.rate.success": "Se estableció la tasa de ticks a %s por segundo",
	"commands.tick.sprint.report": "Se completó la aceleración de ticks con %s ticks por segundo, ó %s ms por tick",
	"commands.tick.sprint.stop.fail": "No hay una aceleración de ticks en curso",
	"commands.tick.sprint.stop.success": "Se interrumpió la aceleración de ticks",
	"commands.tick.status.frozen": "Se congeló el juego",
	"commands.tick.status.lagging": "El juego se está ejecutando, pero no pudo mantenerse con la tasa de ticks buscada",
	"commands.tick.status.running": "El juego se ejecutará a velocidad normal",
	"commands.tick.status.sprinting": "Ejecutando a velocidad alta",
	"commands.tick.step.fail": "No se pudo ejecutar tick del juego, el juego debe estar congelado primero",
	"commands.tick.step.stop.fail": "No hay ninguna ejecución de tick en progreso",
	"commands.tick.step.stop.success": "Se interrumpió la ejecución del tick actual",
	"commands.tick.step.success": "Ejecutando %s tick(s)",
	"commands.time.no_default_clock": "No hay reloj por defecto en la dimensión del %s",
	...
	"commands.time.query.timeline.repetitions": "La linea de tiempo %s se ha repetido %s veces",
	...
	"commands.transfer.error.no_players": "Debes especificar al menos un jugador a transferir",
	"commands.transfer.success.multiple": "Transfiriendo %s jugadores a %s:%s",
	"commands.transfer.success.single": "Trasnfiriendo a %s a %s:%s",
	...
	"commands.waypoint.modify.color": "El punto de referencia ahora es de color %s",
	"commands.waypoint.modify.color.reset": "Reinicia el color del punto de referencia",
	"commands.waypoint.modify.style": "Se cambió el estilo del marcador",
	...
	"commands.worldborder.set.immediate": "Se estableció el borde del mundo a %s bloque(s) de ancho",
	"commands.worldborder.set.shrink": "Reduciendo el borde del mundo a %s bloque(s) de ancho en %s segundo(s)",
	"commands.worldborder.warning.distance.failed": "Nada cambió, el aviso del borde del mundo ya tenía esa distancia",
	"commands.worldborder.warning.distance.success": "Se estableció la distancia de advertencia del borde del mundo a %s bloque(s)",
	"commands.worldborder.warning.time.failed": "Nada cambió, el aviso del borde del mundo ya duraba esa cantidad de tiempo",
	"commands.worldborder.warning.time.success": "Se estableció el tiempo advertencia del borde del mundo a %s segundo(s)",
	...
	"connect.p2p.failed.generic": "Error al conectar player",
	...
	"connect.transferring": "Transfiriendo a nuevo servidor...",
	...
	"createWorld.customize.buffet.title": "Personalizar bioma único",
	...
	"dataPack.locator_bar.description": "Indica la dirección de otros jugadores en multijugador",
	"dataPack.locator_bar.name": "Barra localizadora",
	"dataPack.minecart_improvements.description": "Mejoras al movimiento de los vagones",
	"dataPack.minecart_improvements.name": "Vagones mejorados",
	"dataPack.redstone_experiments.description": "Cambios experimentales a la redstone",
	"dataPack.redstone_experiments.name": "Redstone experimental",
	"dataPack.title": "Seleccionar Paquetes de Datos",
	"dataPack.trade_rebalance.description": "Tradeos con aldeanos actualizados",
	"dataPack.trade_rebalance.name": "Rebalance de tradeos de aldeanos",
	...
	"dataPack.winter_drop.description": "Nuevas características y contenido del drop de invierno",
	...
	"death.attack.cactus.player": "%[1]s caminó cerca de un cactus mientras intentaba escapar de %[2]s",
	"death.attack.cramming": "%[1]s fue aplastado con demasiada fuerza",
	"death.attack.cramming.player": "%[1]s fue aplastado por %[2]s",
	"death.attack.dragonBreath": "%[1]s se asó en aliento de dragón",
	"death.attack.dragonBreath.player": "%[1]s se asó en aliento de dragón por culpa de %[2]s",
	...
	"death.attack.dryout.player": "%[1]s murió de deshidratación mientras intentaba escapar de %[2]s",
	...
	"death.attack.genericKill.player": "%[1]s murió mientras peleaba contra %[2]s",
	...
	"death.attack.mace_smash": "%[1]s fue reventado por %[2]s",
	"death.attack.mace_smash.item": "%[1]s fue reventado por %[2]s con su %[3]s",
	...
	"death.attack.outsideBorder": "%[1]s abandonó los confines de este mundo",
	...
	"death.attack.spear": "%[1]s fue espetado por %[2]s",
	"death.attack.spear.item": "%[1]s fue espetado por %[2]s usando %[3]s",
	...
	"death.attack.sweetBerryBush.player": "%[1]s se pinchó con arbusto de bayas dulces hasta morir mientras intentaba escapar de %[2]s",
	"death.attack.thorns": "%[1]s fue asesinado mientras trataba de golpear a %[2]s",
	"death.attack.thorns.item": "%[1]s fue asesinado por %[3]s mientras intentaba pegarle a %[2]s",
	...
	"death.attack.wither.player": "%[1]s murió de descomposición mientras peleaba contra %[2]s",
	...
	"debug.copy_location.help": "F3 + C = Copiar la ubicación como comando /tp, o mantener por 10 segundos para crashear el juego",
	...
	"debug.options.category.text": "Texto de debug",
	"debug.options.help": "F3 + F6 = Editar opciones de debug",
	"debug.options.notAllowed.tooltip": "No visible cuando se reduce la información de debug",
	...
	"debug.options.warning": "Estas opciones son solo para fines de testeo. Podrían ralentizar tu computador, crashear el juego, o provocar un terremoto...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Respiración del nautilo",
	...
	"effect.minecraft.oozing": "Secreción",
	...
	"effect.minecraft.wind_charged": "Hinchazón",
	...
	"enchantment.minecraft.sweeping_edge": "Filo arrasador",
	...
	"entity.minecraft.ominous_item_spawner": "Spawner de ítems ominoso",
	...
	"filled_map.trial_chambers": "Mapa de calabozo de desafío",
	"filled_map.unknown": "Mapa desconocido",
	"filled_map.village_desert": "Mapa de exploración de desierto",
	"filled_map.village_plains": "Mapa de exploración de planicie",
	"filled_map.village_savanna": "Mapa de exploración de sabana",
	...
	"gamerule.allowFireTicksAwayFromPlayer.description": "Controla si el fuego o la lava podrían cargarse al estar a más de 8 chunks de distancia de cualquier jugador.",
	"gamerule.announceAdvancements": "Anunciar progresos",
	"gamerule.blockExplosionDropDecay": "En explosiones por bloques, algunos bloques no soltarán ítems",
	...
	"gamerule.disablePlayerMovementCheck": "Desactivar chequeo de movimiento de los jugadores",
	...
	"gamerule.doLimitedCrafting.description": "Si se activa, solo se podrán craftear recetas aprendidas.",
	"gamerule.doMobLoot": "Obtener loot de criaturas",
	"gamerule.doMobLoot.description": "Controla si los mobs sueltan o no recursos, incluyendo orbes de experiencia.",
	"gamerule.doMobSpawning": "Generar mobs",
	"gamerule.doMobSpawning.description": "Algunas entidades podrían tener reglas distintas.",
	"gamerule.doPatrolSpawning": "Generar patrullas de saqueadores",
	"gamerule.doTileDrops": "Soltar bloques",
	"gamerule.doTileDrops.description": "Controla los drops de bloques, incluyendo orbes de experiencia.",
	"gamerule.doTraderSpawning": "Generar vendedores ambulantes",
	"gamerule.doVinesSpread": "Propagación de enredaderas",
	"gamerule.doVinesSpread.description": "Controla si las enredaderas se propagan a bloques adyacentes al azar. No afecta a otro tipo de enredaderas, como enredaderas lloronas, enredaderas retorcidas, etcétera.",
	...
	"gamerule.enderPearlsVanishOnDeath": "Destruir perlas de ender al morir",
	"gamerule.enderPearlsVanishOnDeath.description": "Las perlas de ender lanzadas por un jugador se romperán si ese jugador muere.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Las entidades con pasajeros pueden usar portales",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Permite que las entidades con pasajeros puedan viajar a través de portales al Nether, al End, y accesos al End.",
	...
	"gamerule.locatorBar": "Activar barra localizadora de jugadores",
	"gamerule.locatorBar.description": "Al activarlo, aparece una barra en la pantalla que muestra la dirección de los jugadores.",
	...
	"gamerule.maxCommandForkCount": "Límite de circunstancias por comando",
	"gamerule.maxCommandForkCount.description": "El número máximo de circunstancias que pueden ser usadas por comandos como 'execute as'.",
	"gamerule.maxEntityCramming": "Límite de entidades por bloque",
	"gamerule.minecartMaxSpeed": "Velocidad máxima de vagones",
	"gamerule.minecartMaxSpeed.description": "Velocidad máxima por defecto de los vagones en movimiento por tierra.",
	"gamerule.minecraft.elytra_movement_check": "Permitir verificación de movimiento de elytra",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Delay del portal del Nether en creativo",
	"gamerule.playersNetherPortalCreativeDelay.description": "Tiempo (en ticks) que un jugador necesita esperar para cambiar de dimensión al pararse en un portal del Nether en modo creativo.",
	"gamerule.playersNetherPortalDefaultDelay": "Delay del portal del Nether predeterminado",
	"gamerule.playersNetherPortalDefaultDelay.description": "Tiempo (en ticks) que un jugador necesita esperar para cambiar de dimensión al pararse en un portal del Nether en cualquier modo de juego distinto a creativo.",
	...
	"gamerule.projectilesCanBreakBlocks.description": "Controla si los proyectiles pueden o no destruir los bloques que deberían al impactar.",
	...
	"gamerule.reducedDebugInfo.description": "Limita el contenido de la pantalla de debug.",
	...
	"gamerule.spawnChunkRadius": "Chunks de radio de aparición",
	"gamerule.spawnChunkRadius.description": "Cantidad de chunks que permanecen cargados alrededor del punto de aparición.",
	...
	"gamerule.spawnRadius.description": "Controla el tamaño del área del punto de aparición en el que aparecen los jugadores.",
	"gamerule.spawnerBlocksEnabled": "Permitir spawners",
	...
	"gui.abuseReport.attestation": "Al enviar este reporte, confirmas que la información que proporcionas es correcta y considera todo lo que sepas.",
	"gui.abuseReport.comments": "Observaciones",
	"gui.abuseReport.describe": "Compartir detalles nos ayudará a tomar una decisión bien informada.",
	"gui.abuseReport.discard.content": "Si sales ahora, este reporte y tus observaciones no se guardarán.\n¿Estás seguro de que quieres salir?",
	...
	"gui.abuseReport.discard.title": "¿Descartar reporte y observaciones?",
	...
	"gui.abuseReport.error.title": "Sucedio un problema al enviar tu reporte",
	"gui.abuseReport.message": "¿Dónde identificaste el mal comportamiento?\nEsto nos ayudará en la investigación de tu caso.",
	"gui.abuseReport.more_comments": "Por favor, describe la situación:",
	"gui.abuseReport.name.comment_box_label": "Describe por qué quieres denunciar este nombre:",
	...
	"gui.abuseReport.read_info": "Acerca de reportar",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Difamación",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Alguien está dañando la reputación de otra persona, compartiendo, por ejemplo, información falsa con el objetivo de aprovecharse o engañar a otros.",
	"gui.abuseReport.reason.description": "Descripción:",
	"gui.abuseReport.reason.false_reporting": "Denuncia falsa",
	"gui.abuseReport.reason.generic": "Quiero reportarle",
	"gui.abuseReport.reason.generic.description": "Me molestó / hizo algo que no me agrada.",
	...
	"gui.abuseReport.reason.imminent_harm": "Amenaza de daños a otros",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Autolesión o suicidio",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Contenido sexual",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Skins que refieren a actos sexuales, órganos sexuales y violencia sexual.",
	...
	"gui.abuseReport.send.comment_too_long": "Por favor, resume la observación",
	...
	"gui.abuseReport.send.http_error": "Se produjo un error HTTP inesperado al enviar tu denuncia.",
	"gui.abuseReport.send.json_error": "Se ha detectado un paquete mal estructurado al enviar tu denuncia.",
	"gui.abuseReport.send.no_reason": "Por favor, selecciona una categoría para el reporte",
	"gui.abuseReport.send.not_attested": "Por favor, lee el texto que está arriba y marca la casilla para poder enviar el reporte",
	...
	"gui.all": "Todas",
	"gui.back": "Volver",
	"gui.banned.description": "%s\n\n%s\n\nMás información en el siguiente link: %s",
	"gui.banned.description.permanent": "Tu cuenta está baneada permanentemente, lo que significa que no puedes jugar online ni unirte a Realms.",
	...
	"gui.banned.description.temporary": "%s Hasta entonces, no puedes jugar online ni unirte a Realms.",
	...
	"gui.banned.name.description": "Tu nombre actual, \"%s\", incumple las Normas de la Comunidad. Puedes jugar en mundos de un jugador, pero deberás cambiar tu nombre para poder jugar en multijugador.\n\nAprende más o solicita una revisión del caso en el siguiente link: %s",
	...
	"gui.banned.skin.description": "Tu skin actual incumple las Normas de la Comunidad. Podrás seguir jugando con una skin predeterminada o cambiando tu skin a una distinta.\n\nAprende más o solicita una revisión del caso en el siguiente link: %s",
	...
	"gui.cancel": "Cancelar",
	"gui.chatReport.comments": "Observaciones",
	"gui.chatReport.describe": "Compartir detalles nos ayudará a tomar una decisión bien informada.",
	"gui.chatReport.discard.content": "Si sales ahora, este reporte y sus observaciones no se guardarán.\n¿Estás seguro de que quieres salir?",
	...
	"gui.chatReport.discard.title": "¿Descartar reporte y observaciones?",
	...
	"gui.chatReport.send.comments_too_long": "Por favor, resume la observación",
	...
	"gui.copy_link_to_clipboard": "Copiar link al portapapeles",
	"gui.days": "%s día(s)",
	"gui.done": "Aceptar",
	"gui.down": "Abajo",
	...
	"gui.friends.button.loading": "Esperar...",
	"gui.friends.button.loading.invite_request_pending": "Esperando por confirmación",
	...
	"gui.friends.empty_state.link": "Cuenta Microsoft",
	...
	"gui.friends.error.user_may_lack_active_profile": "No hay ningún jugador con este nombre de usuario",
	"gui.friends.join": "Entrar",
	"gui.friends.loading_friends": "Cargando lista de amigos...",
	"gui.friends.loading_requests": "Cargando peticiones...",
	...
	"gui.friends.multiplayer.invite_accept": "Aceptar Invitación para entrar al mundo",
	"gui.friends.multiplayer.invite_reject": "Rechazar invitación para entrar al mundo",
	"gui.friends.multiplayer.join_request": "Pedir entrar al mundo",
	"gui.friends.multiplayer.join_request_accept": "Aceptar pedido para entrar al mundo",
	"gui.friends.multiplayer.join_request_reject": "Rechazar pedido para entrar al mundo",
	...
	"gui.remove": "Eliminar",
	"gui.report_to_server": "Informar al server",
	...
	"gui.waitingForResponse.title": "Esperando al server",
	"gui.yes": "Sí",
	...
	"inventory.hotbarInfo": "Guarda la barra de ítems con %[1]s + %[2]s",
	"inventory.hotbarSaved": "Se guardó la barra de ítems (restáurala con %[1]s + %[2]s)",
	...
	"item.minecraft.blade_pottery_sherd": "Fragmento de cerámica de cuchilla",
	...
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Ornamento de remache",
	...
	"item.minecraft.breeze_rod": "Barra de breeze",
	"item.minecraft.breeze_spawn_egg": "Generar breeze",
	"item.minecraft.brewer_pottery_shard": "Fragmento de cerámica de alquimia",
	"item.minecraft.brewer_pottery_sherd": "Fragmento de cerámica de alquimia",
	...
	"item.minecraft.bundle.empty.description": "Puede guardar varios ítems",
	...
	"item.minecraft.chainmail_leggings": "Pantalones de cota de mallas",
	...
	"item.minecraft.copper_hoe": "Azadón de cobre",
	"item.minecraft.copper_horse_armor": "Armadura de cobre para caballos",
	...
	"item.minecraft.dune_armor_trim_smithing_template.new": "Ornamento de duna",
	...
	"item.minecraft.field_masoned_banner_pattern": "Estampado de mampostería",
	...
	"item.minecraft.flow_armor_trim_smithing_template.new": "Ornamento de flujo",
	...
	"item.minecraft.guster_banner_pattern.desc": "Estampado de torbellino",
	...
	"item.minecraft.host_armor_trim_smithing_template.new": "Ornamento de anfritrión",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Poción de secreción persistente",
	...
	"item.minecraft.lingering_potion.effect.wind_charged": "Poción persistente de hinchazón",
	...
	"item.minecraft.mourner_pottery_sherd": "Fragmento de cerámica de monstruo",
	...
	"item.minecraft.potion.effect.oozing": "Poción de secreción",
	...
	"item.minecraft.potion.effect.wind_charged": "Poción de hinchazón",
	...
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Ornamento de criador",
	...
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Ornamento de formador",
	"item.minecraft.sheaf_pottery_shard": "Fragmento de cerámica de heno",
	"item.minecraft.sheaf_pottery_sherd": "Fragmento de cerámica de heno",
	...
	"item.minecraft.spire_armor_trim_smithing_template.new": "Ornamento de aguja",
	...
	"item.minecraft.splash_potion.effect.oozing": "Poción de secreción arrojadiza",
	...
	"item.minecraft.splash_potion.effect.wind_charged": "Poción arrojadiza de hinchazón",
	...
	"item.minecraft.tide_armor_trim_smithing_template.new": "Ornamento de marea",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Flecha de secreción",
	...
	"item.minecraft.tipped_arrow.effect.wind_charged": "Flecha de hinchazón",
	...
	"item.minecraft.ward_armor_trim_smithing_template.new": "Ornamento de guardia",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Ornamento de guía",
	...
	"item.minecraft.wild_armor_trim_smithing_template.new": "Ornamento salvaje",
	...
	"item.minecraft.wolf_armor": "Armadura para lobos",
	...
	"item.op_block_warning.line2": "El uso de este ítem podría provocar la ejecución de un comando.",
	"item.op_block_warning.line3": "¡No lo utilices a menos que conozcas su contenido exacto!",
	"item.spawn_egg.peaceful": "Desactivado en Pacifico",
	...
	"jigsaw_block.placement_priority": "Orden de colocación:",
	"jigsaw_block.placement_priority.tooltip": "Cuando este bloque de rompecabezas se conecta con una pieza, este es el orden en el cual esa pieza es procesada por conexiones con la estructura más amplia.\n\nLas piezas serán procesadas por prioridad de manera descendente, rompiendo empates por orden de inserción.",
	"jigsaw_block.pool": "Grupo objetivo:",
	"jigsaw_block.selection_priority": "Orden de selección:",
	"jigsaw_block.selection_priority.tooltip": "Cuando la pieza padre está siendo procesada por conexiones, este será el orden en el cual este bloque de rompecabezas intente conectarse con su pieza objetivo.\n\nLos rompecabezas serán procesados por orden de prioridad descendente, deshaciéndose los empates de forma aleatoria.",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine - Creator (cajita musical)",
	...
	"key.hotbar.1": "Espacio 1 de la barra de objetos",
	"key.hotbar.2": "Espacio 2 de la barra de objetos",
	"key.hotbar.3": "Espacio 3 de la barra de objetos",
	"key.hotbar.4": "Espacio 4 de la barra de objetos",
	"key.hotbar.5": "Espacio 5 de la barra de objetos",
	"key.hotbar.6": "Espacio 6 de la barra de objetos",
	"key.hotbar.7": "Espacio 7 de la barra de objetos",
	"key.hotbar.8": "Espacio 8 de la barra de objetos",
	"key.hotbar.9": "Espacio 9 de la barra de objetos",
	...
	"key.sprint": "Correr",
	"key.swapOffhand": "Cambiar ítem de mano",
	"key.toggleGui": "Alternar GUI",
	...
	"known_server_link.news": "Noticias",
	"known_server_link.report_bug": "Informar error del server",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Añadir server",
	"manageServer.edit.title": "Editar información del server",
	"manageServer.enterIp": "Dirección del server",
	"manageServer.enterName": "Nombre del server",
	"manageServer.resourcePack": "Paquetes de recursos del server",
	...
	"mco.account.privacy.information": "Mojang implementa ciertos procedimientos para ayudar a proteger a los menores y su privacidad, incluyendo cumplir con la Ley de Protección de Privacidad Infantil en Internet (COPPA) y el Reglamento General de Protección de Datos (RGPD).\n\nPuede que necesites el permiso de tus padres para acceder a tu cuenta de Realms.",
	"mco.account.privacyinfo": "Mojang implementa ciertos procedimientos para ayudar a proteger a los menores y su privacidad que consisten en cumplir con la Ley de Protección de Privacidad Infantil en Internet (COPPA) y el Reglamento General de Protección de Datos (RGPD).\n\nPuede que necesites el permiso de tus padres para acceder a tu cuenta de Realms.\n\nSi tienes una cuenta de Minecraft antigua (inicia sesión con tu nombre de usuario), necesitarás migrar tu cuenta a una de Mojang para poder acceder a Realms.",
	...
	"mco.backup.entry.enabledPack": "Paquete(s) activo(s)",
	"mco.backup.entry.gameDifficulty": "Dificultad",
	"mco.backup.entry.gameMode": "Modo de juego",
	"mco.backup.entry.gameServerVersion": "Versión del juego del server",
	"mco.backup.entry.name": "Nombre",
	"mco.backup.entry.seed": "Semilla",
	"mco.backup.entry.templateName": "Nombre de la plantilla",
	...
	"mco.backup.nobackups": "Este Reino no tiene copias de seguridad.",
	...
	"mco.brokenworld.nonowner.error": "Por favor, espera a que el propietario del Reino restablezca el mundo",
	...
	"mco.client.outdated.stable.version": "Tu versión del cliente (%s) no es compatible con Realms.\n\nPor favor, actualiza a la versión más reciente de Minecraft.",
	"mco.client.unsupported.snapshot.version": "Tu versión del cliente (%s) no es compatible con Realms.\n\nRealms no está disponible para esta versión snapshot.",
	"mco.compatibility.downgrade": "Desactualizar",
	"mco.compatibility.downgrade.description": "Este mundo se jugó por última vez en la versión %s; estás en la versión %s. Desactualizar un mundo a una versión anterior podría causar que se corrompa. No podemos garantizar que cargue o funcione.\n\nSe guardará una copia de seguridad de tu mundo en la carpeta \"World Backups\". Por favor, restaura tu mundo si es necesario.",
	"mco.compatibility.incompatible.popup.title": "Versión incompatible",
	"mco.compatibility.incompatible.releaseType.popup.message": "El mundo al que te estás intentando unir es incompatible con la versión en la que estás.",
	"mco.compatibility.incompatible.series.popup.message": "Este mundo se jugó por última vez en la versión %s; estás en la versión %s.\n\nEstas series no son compatibles entre sí. Necesitarás un mundo nuevo para jugar en esta versión.",
	"mco.compatibility.unverifiable.message": "No se pudo verificar la versión en la que se jugó este mundo por última vez. Si el mundo se actualiza o desactualiza, se creará automáticamente una copia de seguridad que se guardará en \"World Backups\".",
	"mco.compatibility.unverifiable.title": "Compatibilidad no verificable",
	"mco.compatibility.upgrade": "Actualizar",
	"mco.compatibility.upgrade.description": "Este mundo se jugó por última vez en la versión %s; estás en la versión %s.\n\nSe guardará un respaldo de tu mundo en la carpeta \"World Backups\". \n\nPor favor, restaura tu mundo si es necesario.",
	"mco.compatibility.upgrade.friend.description": "Este mundo se jugó por última vez en la versión %s; estás en la versión %s.\n\nSe guardará un respaldo del mundo en la carpeta \"World Backups\". \n\nEl dueño del Realm podrá restaurar el mundo si es necesario.",
	"mco.compatibility.upgrade.title": "¿Seguro de que quieres actualizar este mundo?",
	...
	"mco.configure.world.backup": "Copias de seguridad del mundo",
	...
	"mco.configure.world.buttons.options": "Opciones de mundo",
	...
	"mco.configure.world.close.question.line1": "Tu Reino dejará de estar disponible.",
	...
	"mco.configure.world.leave.question.line1": "Si abandonas este Reino no podrás verlo hasta que te vuelvan a invitar",
	...
	"mco.configure.world.name.validation.whitespace": "No puede comenzar o terminar con un espacio en blanco. Será recortado.",
	"mco.configure.world.opening": "Abriendo el Realm...",
	"mco.configure.world.players.error": "No existe ningún jugador con ese nombre",
	"mco.configure.world.players.invite.duplicate": "Ya se ha invitado al jugador con el nombre proporcionado al Reino",
	...
	"mco.configure.world.region_preference.title": "Selección de región de preferencia",
	...
	"mco.configure.world.resourcepack.question": "Necesitas un paquete de recursos personalizado para jugar en este Reino\n\n¿Quieres descargarlo y jugar?",
	"mco.configure.world.resourcepack.question.line1": "Necesitas un paquete de recursos personalizado para jugar en este Reino",
	...
	"mco.configure.world.settings.expired": "No es posible modificar la configuración de un Realms que ha caducado",
	"mco.configure.world.settings.title": "Ajustes",
	"mco.configure.world.slot": "Mundo %s",
	"mco.configure.world.slot.empty": "Vacío",
	"mco.configure.world.slot.switch.question.line1": "Tu Reino se cambiará a otro mundo",
	...
	"mco.configure.world.spawn_toggle.message": "Desactivar esta opción eliminará a todas las entidades existentes de ese tipo",
	"mco.configure.world.spawn_toggle.message.npc": "Desactivar esta opción eliminará a todas las entidades existentes de ese tipo, como aldeanos",
	...
	"mco.configure.world.uninvite.player": "¿Seguro de que quieres cancelar la invitación a '%s'?",
	...
	"mco.errorMessage.6009": "Descripción del Realm es inválida",
	...
	"mco.errorMessage.initialize.failed": "Error al iniciar el Realm",
	"mco.errorMessage.noDetails": "No se proporcionaron detalles del error",
	"mco.errorMessage.realmsService": "Ocurrió un error (%s):",
	"mco.errorMessage.realmsService.configurationError": "Editando un espacio de reino inactivo inesperado",
	...
	"mco.errorMessage.realmsService.unknownCompatibility": "No se pudo revisar la compatibilidad de la versión. Respuesta obtenida: %s",
	...
	"mco.invited.player.narration": "Se invitó al jugador %s",
	...
	"mco.minigame.world.restore.question.line1": "El modo de juego finalizará y tu Reino se restaurará.",
	"mco.minigame.world.restore.question.line2": "¿Seguro que quieres hacerlo?",
	"mco.minigame.world.selected": "Minijuego seleccionado:",
	"mco.minigame.world.slot.screen.title": "Cambiando de mundo...",
	...
	"mco.notification.transferSubscription.message": "Estamos moviendo las suscripciones de Realms Java a la Microsoft Store. ¡No dejes que tu suscripción expire!\nTransfiere tu suscripción ahora y obtén 30 días de Realms gratis.\nVe a tu perfil en minecraft.net para transferir tu suscripción.",
	...
	"mco.reset.world.warning": "Esto sustituirá el mundo actual de tu Reino",
	...
	"mco.selectServer.create.subtitle": "Selecciona qué mundo poner en tu nuevo Realm",
	...
	"mco.selectServer.noRealms": "Parece que no tienes ningún Realm. Agrega un Realm para jugar con tus amigos.",
	...
	"mco.selectServer.popup": "Realms es una forma simple y segura de jugar Minecraft con hasta diez amigos a la vez. ¡Soporta minijuegos y mundos personalizados! Solo paga el dueño.",
	...
	"mco.snapshot.createSnapshotPopup.text": "Estás a punto de crear un Realm para snapshots gratis que estará vinculado a tu suscripción de Realms de pago. Este Realm para snapshots será accesible mientras tu suscripción de pago esté activa. Tu Realm principal no se verá afectado.",
	"mco.snapshot.createSnapshotPopup.title": "¿Crear Realm para snapshots?",
	"mco.snapshot.creating": "Creando Realm para snapshots...",
	"mco.snapshot.description": "Vinculado con %s",
	"mco.snapshot.friendsRealm.downgrade": "Debes estar en la versión %s para unirte a este Realm",
	"mco.snapshot.friendsRealm.upgrade": "%s deberá actualizar su Realm para jugar en esta versión",
	"mco.snapshot.paired": "Este Realm para snapshots está vinculado con %s",
	"mco.snapshot.parent.tooltip": "Usa la versión estable de Minecraft más reciente para jugar en este Realm",
	"mco.snapshot.start": "Iniciar Realm para snapshots",
	"mco.snapshot.subscription.info": "Este es un Realm para snapshots que está vinculado a la suscripción de tu Realm \"%s\". Permanecerá activo mientras el Realm principal lo esté.",
	"mco.snapshot.tooltip": "Usa los Realms para snapshots para echar un vistazo a próximas versiones de Minecraft que pueden incluir nuevas características y otros cambios.\n\nTus Realms normales permanecerán en la versión estable del juego.",
	"mco.snapshotRealmsPopup.message": "Los Realms ahora están disponibles para snapshots desde la 23w41a en adelante. ¡Todas las suscripciones de Realms vienen con un Realm para snapshots gratis, además de tu Realm de Java normal!",
	"mco.snapshotRealmsPopup.title": "Realms ahora es compatible con snapshots",
	...
	"menu.custom_options.tooltip": "Nota: Las opciones personalizadas provienen de servidores y/o contenido de terceros.\n¡Ve con cuidado!",
	"menu.custom_screen_info.button_narration": "Esta es una pantalla personalizada. Obtén más información.",
	"menu.custom_screen_info.contents": "El contenido de esta pantalla es controlado por servidores y mapas de terceros que no son propiedad ni están operados o supervisados por Mojang Estudios ni Microsoft.\n\n¡Úsalo con precaución! Siempre ten cuidado al seguir enlaces y nunca compartas tu información personal, incluidos tus datos de inicio de sesión.\n\nSi esta pantalla te impide jugar, también puedes desconectarte del servidor actual usando el botón de abajo.",
	...
	"menu.custom_screen_info.tooltip": "Esta es una pantalla personalizada. Haz clic aquí para obtener más información.",
	...
	"menu.server_links": "Links del server...",
	"menu.server_links.title": "Links del server",
	...
	"multiplayer.codeOfConduct.check": "No volver a notificarme de este Código de Conducta",
	"multiplayer.codeOfConduct.title": "Código de Conducta del server",
	"multiplayer.confirm_command.parse_errors": "Estás intentando ejecutar un comando no reconocido o inválido. \n¿Estás seguro? \nComando: %s",
	"multiplayer.confirm_command.permissions_required": "Estás intentando ejecutar un comando que requiere permisos elevados. Esto podría afectar negativamente tu juego.\n¿Estás seguro? \nComando: %s",
	"multiplayer.confirm_command.run_command": "Ejecutar comando",
	"multiplayer.confirm_command.signature_required": "Estás intentando ejecutar un comando que enviará mensajes de chat utilizando tu nombre.\nSolo se puede ejecutar desde la pantalla de mensaje\nComando: %s",
	...
	"multiplayer.disconnect.bad_chat_index": "Mensaje de chat perdido o reordenado desde servidor",
	...
	"multiplayer.disconnect.banned.reason.default": "Has sido baneado por un administrador.",
	...
	"multiplayer.disconnect.code_of_conduct": "El server requiere aceptar el Código de Conducta",
	...
	"multiplayer.disconnect.invalid_public_key_signature.new": "Firma de la llave pública inválida.\nIntenta reiniciar tu juego.",
	...
	"multiplayer.disconnect.missing_tags": "El server envió un conjunto de tags (etiquetas) incompleto.\nPor favor, contacta con el/la admin del server.",
	...
	"multiplayer.disconnect.transfers_disabled": "Este server no acepta transferencias",
	...
	"multiplayer.requiredTexturePrompt.disconnect": "Este server requiere un paquete de recursos personalizado",
	...
	"narration.checkbox.usage.focused.check": "Pulsa Enter para marcar",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Presiona Enter para comenzar a cambiar el valor del deslizador",
	...
	"narration.suggestion.usage.fill.fixed": "Presiona el tabulador para usar la sugerencia",
	"narration.suggestion.usage.fill.hidable": "Presiona el tabulador para usar la sugerencia, o escape para salir de las sugerencias",
	...
	"options.accessibility.high_contrast_block_outline": "Alto contraste en bordes",
	"options.accessibility.high_contrast_block_outline.tooltip": "Aumenta el contraste del contorno del bloque al que miras.",
	"options.accessibility.link": "Guía de accesibilidad",
	"options.accessibility.menu_background_blurriness": "Desenfoque del fondo",
	...
	"options.accessibility.panorama_speed": "Velocidad de panorama",
	...
	"options.allowCursorChanges.tooltip": "Permite que el cursor del mouse cambie su forma al pasar sobre ciertos elementos de la interfaz.",
	...
	"options.allowServerListing.tooltip": "Los servers pueden mostrar usuarios conectados teniendo su estado público.\nAl desactivar esta opción, tu nombre no se mostrará en dichas listas.",
	...
	"options.chat.delay": "Ralentizar chat: %s seg(s)",
	"options.chat.delay_none": "Retraso del chat: NO",
	"options.chat.drafts": "Guardar mensajes no enviados",
	"options.chat.drafts.tooltip": "Los mensajes no enviados se guardarán y podrán ser enviados la próxima vez que se abra el chat.",
	...
	"options.cutoutLeaves.tooltip": "Permite ver a través de los agujeros en las hojas. Desactivarlo puede mejorar el rendimiento.",
	...
	"options.friendsList.confirm.message.link": "Cuenta microsoft",
	...
	"options.graphics.warning.cancel": "Volver atrás",
	...
	"options.graphicsApi.tooltip": "Escoge qué API de gráficos usar para renderizar. ¡Mantenlo en la opción por defecto a menos que sea necesario! Los cambios se aplicarán al reiniciar el juego.",
	...
	"options.hideLightningFlashes.tooltip": "Apaga los destellos en el cielo producidos por rayos u otros fenómenos ambientales. Las fuentes de los destellos en sí permanecerán visibles.",
	"options.hideMatchedNames": "Ocultar nombres iguales",
	"options.hideMatchedNames.tooltip": "Los servidores de terceros podrían enviar mensajes en formatos no estándar.\nCon esta opción activada, los jugadores ocultos serán emparejados según su nombre de emisor en el chat.",
	"options.hideSplashTexts": "Ocultar textos splash",
	"options.hideSplashTexts.tooltip": "Oculta los textos splash amarillos del menú principal.",
	...
	"options.inactivityFpsLimit": "Reducir FPS al",
	"options.inactivityFpsLimit.afk": "Estar AFK",
	"options.inactivityFpsLimit.afk.tooltip": "Limita la tasa de fotogramas a 30 si el jugador no interactúa con el juego por más de un minuto. Se reducirá a 10 luego de 9 minutos más.",
	"options.inactivityFpsLimit.minimized": "Minimizar",
	"options.inactivityFpsLimit.minimized.tooltip": "Limita la tasa de fotogramas al minimizar la ventana del juego.",
	"options.invertMouse": "Invertir mouse",
	"options.invertMouseX": "Invertir eje X",
	"options.invertMouseY": "Invertir eje Y",
	"options.japaneseGlyphVariants": "Variante de glifos japoneses",
	...
	"options.music_frequency.default": "Predeterminado",
	"options.music_frequency.frequent": "Frecuente",
	"options.music_frequency.tooltip": "Cambia la frecuencia con la que se reproduce música durante el juego.",
	...
	"options.rotateWithMinecart.tooltip": "Controla si la cámara rota al girar en un vagón. Solo disponible en mundos que utilicen la característica experimental de «Vagones mejorados».",
	...
	"options.showNowPlayingToast.tooltip": "Muestra una notificación cuando comienza una canción. La misma notificación se muestra constantemente en el menú de pausa del juego mientras la canción está sonando.",
	...
	"options.sprintWindow": "Lapso para correr",
	"options.sprintWindow.tooltip": "El intervalo de tiempo en ticks para presionar por segunda vez la tecla hacia adelante para correr.",
	...
	"options.telemetry.disabled": "La telemetría está desactivada.",
	...
	"options.textureFiltering.none": "NO",
	...
	"options.video.quality.header": "Calidad & Rendimiento",
	"options.videoTitle": "Ajustes de gráficos",
	"options.viewBobbing": "Balanceo",
	"options.vignette": "Mostrar viñeta",
	"options.vignette.tooltip": "Esta es una textura sutil sobre la pantalla del juego para reducir el brillo en los bordes de la pantalla y la advertencia del borde del mundo.",
	...
	"pack.dropRejected.message": "No se copiaron las siguientes entradas por no ser paquetes válidos:\n %s",
	"pack.dropRejected.title": "Entradas de tipo no-paquete",
	...
	"pack.incompatible.confirm.unknown": "Este paquete está dañado o está diseñado para una versión desconocida de MineCraft y es posible que no funcione correctamente.",
	...
	"quickplay.error.title": "Error al ejecutar inicio rápido",
	...
	"realms.configuration.region.south_central_us": "Tejas, EE. UU.",
	...
	"realms.configuration.region_preference.automatic_owner": "Automática (según la conexión del dueño)",
	"realms.configuration.region_preference.automatic_player": "Automático (según quien entre primero)",
	...
	"recover_world.message": "Ocurrieron los siguientes errores al intentar leer la carpeta \"%s\" del mundo.\nPodría ser posible restaurar el mundo de algún estado anterior o puedes reportar el problema en el bug tracker.",
	"recover_world.no_fallback": "No hay ningún estado anterior para restaurar",
	"recover_world.restore": "Intentar restaurar",
	"recover_world.restoring": "Intentando restaurar el mundo...",
	...
	"selectWorld.backupWarning.downgrade": "Este mundo fue jugado por última vez en la versión %s; estás en la versión %s. Degradar la versión de un mundo podría corromperlo. No podemos garantizar que vaya a cargar o funcionar. Si aún así quieres continuar, ¡por favor haz un respaldo!",
	...
	"selectWorld.backupWarning.file_fixing_required": "Este mundo necesita ser actualizado antes de poder jugar. Recomendamos crear un respaldo antes de continuar por si se produjeran daños en el mundo.",
	"selectWorld.backupWarning.snapshot": "Este mundo se jugó por última vez en la versión %s; estás en la versión %s. Te recomendamos crear un respaldo en caso de que exprimentes problemas con el mundo.",
	...
	"selectWorld.edit.resetIcon": "Restablecer ícono",
	...
	"selectWorld.incompatible.description": "Este mundo no se puede jugar en esta versión.\nSe jugó por última vez en la versión %s.",
	"selectWorld.incompatible.info": "Versión incompatible: %s",
	"selectWorld.incompatible.title": "Versión incompatible",
	"selectWorld.incompatible.tooltip": "No se puede jugar este mundo porque fue creado en una versión incompatible.",
	...
	"selectWorld.waitingForBackup.message": "Dependiendo del tamaño de tu mundo, esto podría tomar un tiempo. Por favor, no cierres el juego ni apagues tu dispostivo.",
	"selectWorld.waitingForBackup.title": "Creando respaldo",
	...
	"selectWorld.warning.lowDiskSpace.description": "No hay suficiente espacio de almacenamiento en tu dispositivo.\nQuedarte sin espacio durante la partida podría ocasionar que tu mundo se corrompa.",
	"selectWorld.warning.lowDiskSpace.title": "¡Advertencia! ¡Almacenamiento insuficiente!",
	...
	"selecteWorld.backupRequiredTooltip": "Se requiere primero una copia de seguridad para cargar al mundo",
	...
	"slot.only_single_allowed": "Solo se admiten espacios individuales, se obtuvo '%s'",
	"slot.unknown": "Espacio desconocido: %s",
	"snbt.parser.empty_key": "La llave no puede estar vacía",
	...
	"snbt.parser.invalid_array_element_type": "Tipo de formación de elementos no válida",
	...
	"snbt.parser.invalid_string_contents": "Contenido de cadenas no válido",
	"snbt.parser.invalid_unquoted_start": "Las strings sin comillas no pueden empezar por los dígitos del 0 al 9, + ó -",
	...
	"snbt.parser.undescore_not_allowed": "Caracteres subrayados no están permitidos al comienzo o al final de un número",
	...
	"soundCategory.voice": "Narrador o voz",
	...
	"stat.minecraft.nautilus_one_cm": "Distancia recorrida en Nautilo",
	...
	"structure_block.mode_info.corner": "Esquina: indica posición y tamaño",
	...
	"subtitles.block.copper_bulb.turn_on": "Lámpara de cobre se prende",
	...
	"subtitles.block.crafter.craft": "Crafteadora craftea",
	"subtitles.block.crafter.fail": "Crafteadora falla",
	"subtitles.block.creaking_heart.hurt": "Corazón de crujidor murmura",
	"subtitles.block.creaking_heart.idle": "Ruido extraño",
	...
	"subtitles.block.decorated_pot.shatter": "Vasija decorada se quiebra",
	...
	"subtitles.block.dried_ghast.place_in_water": "Ghast deshidratado puesto en agua",
	"subtitles.block.dried_ghast.transition": "Ghast deshidratado alivia",
	...
	"subtitles.block.sand.idle": "Ruidos arenosos",
	"subtitles.block.sand.wind": "Viento",
	...
	"subtitles.block.shelf.activate": "Repisa se activa",
	"subtitles.block.shelf.deactivate": "Repisa se desactiva",
	"subtitles.block.shelf.multi_swap": "Ítems se intercambian",
	"subtitles.block.shelf.place_item": "Ítem colocado",
	"subtitles.block.shelf.single_swap": "Ítem se intercambia",
	"subtitles.block.shelf.take_item": "Ítem tomado",
	...
	"subtitles.block.sniffer_egg.crack": "Huevo de sniffer cruje",
	"subtitles.block.sniffer_egg.hatch": "Huevo de sniffer eclosiona",
	"subtitles.block.sniffer_egg.plop": "Sniffer se deja caer",
	...
	"subtitles.block.trial_spawner.about_to_spawn_item": "Ítem ominoso se prepara",
	"subtitles.block.trial_spawner.ambient": "Spawner de desafío crepita",
	...
	"subtitles.block.trial_spawner.close_shutter": "Spawner de desafío se cierra",
	"subtitles.block.trial_spawner.detect_player": "Spawner de desafío se carga",
	"subtitles.block.trial_spawner.eject_item": "Spawner de desafío expulsa ítems",
	"subtitles.block.trial_spawner.ominous_activate": "Presagio envuelve un spawner de desafío",
	"subtitles.block.trial_spawner.open_shutter": "Spawner de desafío se abre",
	"subtitles.block.trial_spawner.spawn_item": "Ítem ominoso cae",
	"subtitles.block.trial_spawner.spawn_item_begin": "Ítem ominoso aparece",
	"subtitles.block.trial_spawner.spawn_mob": "Spawner de desafío genera un mob",
	...
	"subtitles.block.vault.activate": "Bóveda se activa",
	"subtitles.block.vault.ambient": "Bóveda chisporrotea",
	"subtitles.block.vault.close_shutter": "Bóveda se cierra",
	"subtitles.block.vault.deactivate": "Bóveda se desactiva",
	"subtitles.block.vault.eject_item": "Bóveda expulsa un ítem",
	"subtitles.block.vault.insert_item": "Bóveda se desbloquea",
	"subtitles.block.vault.insert_item_fail": "Bóveda rechaza un ítem",
	"subtitles.block.vault.open_shutter": "Bóveda se abre",
	"subtitles.block.vault.reject_rewarded_player": "Bóveda rechaza a un jugador",
	...
	"subtitles.entity.armadillo.ambient": "Armadillo chilla",
	...
	"subtitles.entity.armadillo.roll": "Armadillo se hace bolita",
	...
	"subtitles.entity.baby_pig.ambient": "Chanchito hace un guarrido",
	...
	"subtitles.entity.baby_wolf.death": "Perrito muere",
	"subtitles.entity.baby_wolf.growl": "Lobezno gruñe",
	"subtitles.entity.baby_wolf.hurt": "Perrito herido",
	...
	"subtitles.entity.copper_golem.item_no_drop": "Gólem de cobre no puede colocar un ítem",
	"subtitles.entity.copper_golem.no_item_get": "Gólem de cobre recogiendo un ítem",
	"subtitles.entity.copper_golem.no_item_no_get": "Gólem de cobre no puede recoger un ítem",
	...
	"subtitles.entity.creaking.death": "Crujidor se desmorona",
	"subtitles.entity.creaking.freeze": "Crujidor quieto",
	"subtitles.entity.creaking.spawn": "Crujidor emerge",
	...
	"subtitles.entity.fox.screech": "Zorro chirría",
	...
	"subtitles.entity.horse.breathe": "Caballo resopla",
	...
	"subtitles.entity.llama.swag": "Llama es adornada",
	...
	"subtitles.entity.nautilus.ambient": "Nautilo chilla",
	"subtitles.entity.nautilus.ambient_land": "Nautilo chilla",
	...
	"subtitles.entity.parrot.imitate.bogged": "Loro traquetea",
	"subtitles.entity.parrot.imitate.breeze": "Loro ulula",
	...
	"subtitles.entity.parrot.imitate.parched": "Loro traquetea",
	...
	"subtitles.entity.rabbit.jump": "Conejo brinca",
	...
	"subtitles.entity.stray.ambient": "Stray traquetea",
	...
	"subtitles.entity.strider.happy": "Strider celebra",
	"subtitles.entity.strider.hurt": "Strider herido",
	"subtitles.entity.strider.idle": "Strider chilla",
	...
	"subtitles.entity.wandering_trader.drink_milk": "Vendedor ambulante toma leche",
	"subtitles.entity.wandering_trader.drink_potion": "Vendedor ambulante se toma una poción",
	...
	"subtitles.entity.witch.throw": "Bruja lanza",
	...
	"subtitles.entity.wither_skeleton.ambient": "Esqueleto Wither traquetea",
	...
	"subtitles.entity.wolf.whine": "Lobo gime",
	...
	"subtitles.event.mob_effect.bad_omen": "Presagio se manifiesta",
	"subtitles.event.mob_effect.raid_omen": "Se avecina una invasión",
	"subtitles.event.mob_effect.trial_omen": "Desafío ominoso se acerca",
	...
	"subtitles.item.armor.equip_wolf": "Armadura para lobos equipada",
	"subtitles.item.armor.unequip_nautilus": "Armadura para nautilo desequipada",
	"subtitles.item.armor.unequip_wolf": "Armadura para lobos soltada",
	"subtitles.item.axe.scrape": "Hacha raspa",
	"subtitles.item.axe.strip": "Hacha raspa",
	"subtitles.item.axe.wax_off": "Cera pulida",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Cubo de azufre capturado",
	...
	"subtitles.item.elytra.flying": "Silbido de viento",
	...
	"subtitles.item.golden_dandelion.unuse": "Diente de león dorado reanuda el envejecimiento",
	"subtitles.item.golden_dandelion.use": "Diente de león dorado detiene el envejecimiento",
	...
	"subtitles.item.horse_armor.unequip": "Armadura para caballos se suelta",
	"subtitles.item.ink_sac.use": "Saco de tinta mancha",
	"subtitles.item.lead.break": "Cuerda se rompe",
	"subtitles.item.lead.tied": "Cuerda atada",
	"subtitles.item.lead.untied": "Cuerda desatada",
	...
	"subtitles.item.totem.use": "Tótem se activa",
	...
	"subtitles.item.wolf_armor.break": "Armadura para lobos se rompe",
	"subtitles.item.wolf_armor.crack": "Armadura para lobos se agrieta",
	"subtitles.item.wolf_armor.damage": "Armadura para lobos es dañada",
	"subtitles.item.wolf_armor.repair": "Armadura para lobos reparada",
	...
	"subtitles.weather.end_flash": "Destello del End truena",
	"subtitles.weather.rain": "Lluvia",
	"symlink_warning.message": "Cargar mundos desde carpetas con enlaces simbólicos puede no ser seguro si no sabes con certeza lo que estás haciendo. Por favor, visita %s para más información.",
	"symlink_warning.message.pack": "Cargar paquetes con enlaces simbólicos puede no ser seguro si no sabes con certeza lo que estás haciendo. Por favor, visita %s para más información.",
	"symlink_warning.message.world": "Cargar mundos desde carpetas con enlaces simbólicos puede no ser seguro si no sabes con certeza lo que estás haciendo. Por favor, visita %s para más información.",
	"symlink_warning.more_info": "Más información",
	"symlink_warning.title": "La carpeta del mundo contiene enlaces simbólicos",
	"symlink_warning.title.pack": "El o los paquetes añadidos contienen enlaces simbólicos",
	...
	"telemetry.event.advancement_made.description": "Entender el contexto detrás de recibir un logro nos puede ayudar a entender mejor y mejorar el progreso del juego.",
	"telemetry.event.advancement_made.title": "Progreso realizado",
	"telemetry.event.game_load_times.description": "Este evento nos ayuda a determinar dónde se necesitan mejoras de rendimiento, midiendo los tiempos de ejecución de las diferentes fases del inicio del juego.",
	...
	"telemetry.property.advancement_id.title": "ID de progreso",
	...
	"telemetry.property.load_time_bootstrap_ms.title": "Tiempo de inicialización (milisegundos)",
	"telemetry.property.load_time_loading_overlay_ms.title": "Tiempo en pantalla de carga (milisegundos)",
	"telemetry.property.load_time_pre_window_ms.title": "Tiempo antes de inicio de ventana (milisegundos)",
	...
	"telemetry_info.opt_in.description": "Doy mi consentimiento para el envío de información de telemetría opcional",
	...
	"test.error.block_property_mismatch": "Se esperaba que la propiedad %s sea %s, y se obtuvo %s",
	"test.error.block_property_missing": "Propiedad del bloque restante, se esperaba que la propiedad %s sea %s",
	"test.error.entity_property": "Entidad %s falló la prueba: %s",
	"test.error.entity_property_details": "Entidad %s falló la prueba: %s, se esperaba %s, y se obtuvo %s",
	"test.error.expected_block": "Se esperaba el bloque %s, se obtuvo %s",
	"test.error.expected_block_present": "Se requiere que el bloque %s esté presente",
	"test.error.expected_block_tag": "Se esperaba el bloque en #%s, y se obtuvo %s",
	"test.error.expected_container_contents": "Contenedor debe contener: %s",
	"test.error.expected_container_contents_single": "Contenedor debe contener un único: %s",
	"test.error.expected_empty_container": "El contenedor debe estar vacío",
	"test.error.expected_entity": "Se esperaba %s",
	"test.error.expected_entity_around": "Se esperó que %s exista alrededor de %s, %s, %s",
	"test.error.expected_entity_count": "Se esperó %s entidades de tipo %s, y se obtuvo %s",
	"test.error.expected_entity_data": "Se esperó que los datos de la entidad sean: %s, y se obtuvo %s",
	"test.error.expected_entity_data_predicate": "Los datos de la entidad no coinciden para %s",
	"test.error.expected_entity_effect": "Se esperó que %s tenga el efecto %s %s",
	"test.error.expected_entity_having": "El inventario de la entidad debe contener %s",
	"test.error.expected_entity_holding": "La entidad debe estar sosteniendo %s",
	...
	"test.error.structure.failure": "No se pudo analizar la estructura: %s",
	...
	"test.error.unexpected_entity": "No esperaba que existiera\n",
	...
	"test_block.mode_info.log": "Modo Registro - Registra un mensaje",
	...
	"test_instance.description.invalid_id": "Identificador de prueba no válida",
	...
	"test_instance_block.error.no_test_structure": "No se ha podido ejecutar el caso de prueba en %s, %s, %s porque no hay estructura de prueba",
	...
	"test_instance_block.size": "Tamaño de la estructura de testeo",
	...
	"title.multiplayer.disabled.banned.name": "Debes cambiar tu nombre de usuario antes de poder jugar online",
	...
	"trim_pattern.minecraft.bolt": "Ornamento de remache",
	...
	"trim_pattern.minecraft.flow": "Ornamento de flujo",
	"trim_pattern.minecraft.host": "Ornamento de anfritrión",
	...
	"upgradeWorld.progress.type.legacy_structures": "Actualizando estructuras hereradas",
