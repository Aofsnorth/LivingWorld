// Code generated by tools/gen_lang.go from 26.1/eu_es.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"accessibility.onboarding.accessibility.button.narration": "Irisgarritasuna",
	...
	"advMode.notEnabled": "Komando blokeak ez daude zerbitzari honetan gaituta",
	"advMode.notEnabled.spawner": "Bloke sortzaileak ez daude gaituta",
	"advMode.previousOutput": "Aurreko irteera",
	"advMode.setCommand": "Ezarri ezazu komando-agindu bat blokean",
	"advMode.setCommand.disabled": "Komando-multzoa: %s, baina komando blokeak oraindik desgaituta daude",
	"advMode.setCommand.success": "Ezarritako agindua: %s",
	"advMode.trackOutput": "Irteera ikusi",
	"advMode.triggering": "Abiarazten",
	"advMode.type": "Mota",
	...
	"advancements.adventure.blowback.description": "Haizete bat hil haize-zurrunbilo bat itzuliz",
	...
	"advancements.adventure.heart_transplanter.description": "Bihotz-karrankari bat bi haritz zurbil enbor blokeen artean lerrokatze zuzenarekin jarri",
	"advancements.adventure.heart_transplanter.title": "Urtarril hotza, neguaren bihotza",
	...
	"advancements.adventure.lighten_up.description": "Aizkorarekin kobrezko bonbilla bat urratu distiratsuagoa egiteko",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Irakurri liburu-apalategi zizelkatu baten potentzia-seinalea konparadore bat erabiliz",
	...
	"advancements.adventure.spear_many_mobs.description": "Lantza erabiliz, karga eraso bakarrean bost izaki jo",
	"advancements.adventure.spear_many_mobs.title": "Txitxi-burduntzi",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Erabili behin behintzat errementaritza-txantiloia hauek: orratza, muturra, saihets-hezurra, jagolea, isiltasuna, arima, itsasaldia, bidebilatzailea",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Errementariaren etxean zotza burduntzi",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Edertu armadura bat errementari-mahaia erabiltzen",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Arropa berria janzten duenak, infernuko demonioari begia ateratzen",
	"advancements.adventure.two_birds_one_arrow.description": "Gezi zulatzaile bakar batekin bi mamu erail",
	"advancements.adventure.two_birds_one_arrow.title": "Tiro batekin bi txori hil",
	"advancements.adventure.under_lock_and_key.description": "Ireki kupel bat erronka-giltz batekin",
	"advancements.adventure.under_lock_and_key.title": "Ezkutu guztiak dakuskien Jainkoa",
	"advancements.adventure.use_lodestone.description": "Erabili iparorratz bat magnetita baten gainean",
	"advancements.adventure.use_lodestone.title": "Lau teilatu gainian, magnetita erdian",
	"advancements.adventure.very_very_frightening.description": "Herritar bat tximista batekin jo",
	"advancements.adventure.very_very_frightening.title": "Beldurrik ez, bururik ez",
	...
	"advancements.adventure.who_needs_rockets.description": "Haize-zurrunbilo bat erabili 8 bloke gorantz altxatzeko",
	"advancements.adventure.who_needs_rockets.title": "Gogoratu debekatuta dagoela suziriak jaurtitzea",
	...
	"advancements.end.levitate.title": "Ikuspegi bikaina hemendik",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Allay batek pastel bat musika-bloke baten gainean utz dezala",
	"advancements.husbandry.allay_deliver_cake_to_note_block.title": "Zorionak zuri",
	"advancements.husbandry.allay_deliver_item_to_player.description": "Agindua zorra, esan ohi da",
	...
	"advancements.husbandry.breed_an_animal.description": "Bi animalia elkarrekin ugaldu",
	"advancements.husbandry.breed_an_animal.title": "Ahuntzaren umea, antxumea",
	"advancements.husbandry.complete_catalogue.description": "Katurik ez dagoen etxean saguak dantzan!",
	"advancements.husbandry.complete_catalogue.title": "Katalogo osoa",
	"advancements.husbandry.feed_snifflet.description": "Usnagiletxu bat elikatu",
	...
	"advancements.husbandry.froglights.description": "Igel-argi guztiak zure inbentarioan eduki",
	"advancements.husbandry.froglights.title": "Gure botereekin bateratuta!",
	"advancements.husbandry.kill_axolotl_target.description": "Axolote batekin bat egin eta borroka bat irabazi",
	"advancements.husbandry.kill_axolotl_target.title": "Maitasunaren botere sendagarria!",
	"advancements.husbandry.leash_all_frog_variants.description": "Soka batekin igel mota guztiak lortu",
	"advancements.husbandry.leash_all_frog_variants.title": "Aberatsak, guztiak adiskide",
	"advancements.husbandry.make_a_sign_glow.description": "Edozein kartel motaren testua distirarazi",
	"advancements.husbandry.make_a_sign_glow.title": "Argi dago!",
	"advancements.husbandry.netherite_hoe.description": "Erabili netheritazko lingote bat aitzur bat hobetzeko, eta zure bizitzaz hausnartu",
	"advancements.husbandry.netherite_hoe.title": "Langile onentzako, ez dago tresna txarrik",
	"advancements.husbandry.obtain_sniffer_egg.description": "Usnagilearen arrautza bat lortu",
	"advancements.husbandry.obtain_sniffer_egg.title": "Hau usain bitxia...",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Ghast siku bat urez busti",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Ur botila bat edo botila bat ur?",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Landatu edozein Sniffer hazi",
	...
	"advancements.husbandry.repair_wolf_armor.title": "Berria balitz bezala",
	...
	"advancements.husbandry.tactical_fishing.description": "Harrapa ezazu arrain bat... kanaberarik gabe!",
	...
	"advancements.husbandry.uh_oh.description": "Egin sufrezko kubo batek dinamita-bloke bat xurgatzea",
	"advancements.husbandry.uh_oh.title": "Oh ez",
	"advancements.husbandry.wax_off.description": "Kobrezko bloke batetik argizaria kendu!",
	"advancements.husbandry.wax_off.title": "Argizaria kendu",
	"advancements.husbandry.wax_on.description": "Ezkoztatu kobrezko bloke bat!",
	"advancements.husbandry.wax_on.title": "Ezkoztatu",
	"advancements.husbandry.whole_pack.description": "Otso espezia guztiak hezi",
	"advancements.husbandry.whole_pack.title": "Talde o(t)soa",
	...
	"advancements.nether.brew_potion.description": "Edabe bat prestatu",
	"advancements.nether.brew_potion.title": "Edabe horretatik edaten duena ez da inoiz gaixotuko",
	...
	"advancements.nether.create_beacon.description": "Faro bat sortu eta ipini",
	...
	"advancements.nether.netherite_armor.title": "Estal nazazu netheritaz",
	"advancements.nether.obtain_ancient_debris.description": "Lortu antzinako hondakinak",
	...
	"advancements.nether.obtain_crying_obsidian.description": "Lortu obsidiana negartsua",
	...
	"advancements.nether.summon_wither.description": "Witherra inbokatu",
	...
	"advancements.story.deflect_arrow.description": "Jaurtigai bat desbideratu ezkutu baten laguntzaz",
	"advancements.story.deflect_arrow.title": "Eskerrik asko, Mari Belasko!",
	...
	"advancements.story.enter_the_nether.title": "Betelu: deabru guztien ikuilu",
	...
	"advancements.story.mine_stone.description": "Harria apurtu zure pikotx berriarekin",
	...
	"advancements.story.upgrade_tools.description": "Sortu pikotx hobe bat",
	...
	"argument.block.property.invalid": "%s blokeak ez du %s ezaugarrirako '%s' onartzen",
	...
	"argument.entity.options.advancements.description": "Aurrerapenak dituzten jokalariak",
	...
	"argument.entity.options.level.negative": "Maila ezin da negatiboa izan",
	...
	"argument.hexcolor.invalid": "Kolore-kode hamaseitar baliogabea: '%s'",
	...
	"argument.integer.low": "Zenbaki osoak ez du %s baino txikiagoa izan behar, %s aurkitu da",
	"argument.item.id.invalid": "Objektu ezezaguna: '%s'",
	"argument.item.tag.disallowed": "Hemen ez dira etiketak onartzen, objektuak besterik ez",
	"argument.literal.incorrect": "%s literala espero zen",
	"argument.long.big": "Luzeera balioak ez du %s baino gehiago izan behar, %s aurkitu da",
	...
	"argument.nbt.expected.compound": "Etiketa konposatua espero zen",
	...
	"argument.resource_or_id.failed_to_parse": "Akats bat egon da %s egitura analizatzean",
	"argument.resource_or_id.invalid": "Balio ez duen id-a edo etiketa",
	"argument.resource_or_id.no_such_element": "Ezin da '%s' elementua '%s' erregistroan aurkitu",
	"argument.resource_selector.not_found": "Ez da kointzidentziarik aurkitu %s hautagailuarentzat, %s motakoa",
	...
	"argument.waypoint.invalid": "Hautatutako entitatea ez da bide-puntu bat",
	...
	"arguments.item.component.expected": "Objektuaren osagaia espero zen",
	...
	"arguments.item.component.unknown": "Artikuluaren osagaia ezezaguna: '%s'",
	...
	"arguments.item.predicate.unknown": "Objektuaren predikatu ezezaguna: '%s'",
	...
	"attribute.name.air_drag_modifier": "Aire-Arraste Aldatzailea",
	"attribute.name.armor": "Armadura",
	"attribute.name.armor_toughness": "Armadura-gogortasuna",
	...
	"attribute.name.below_name_distance": "Puntuazio-markagailuaren distantzia",
	"attribute.name.block_break_speed": "Blokeak hausteko abiadura",
	"attribute.name.block_interaction_range": "Blokeekin elkarreragiteko irismena",
	"attribute.name.bounciness": "Errebotea",
	"attribute.name.burning_time": "Erretze-denbora",
	"attribute.name.camera_distance": "Kamara distantzia",
	...
	"attribute.name.friction_modifier": "Murruskadura Aldatzailea",
	...
	"attribute.name.generic.oxygen_bonus": "Oxigeno-saria",
	...
	"attribute.name.nameplate_distance": "Izen-etiketaren distantzia",
	"attribute.name.oxygen_bonus": "Oxigeno-saria",
	...
	"attribute.name.player.sweeping_damage_ratio": "Ekorketa-kaltearen erlazioa",
	...
	"attribute.name.sweeping_damage_ratio": "Ekorketa-kaltearen erlazioa",
	...
	"attribute.name.waypoint_receive_range": "Bide-puntuaren harrera eremua",
	"attribute.name.waypoint_transmit_range": "Bide-puntuaren igorpen eremua",
	...
	"biome.minecraft.sulfur_caves": "Sufre Koba",
	...
	"block.minecraft.acacia_shelf": "Akaziazko apala",
	...
	"block.minecraft.azalea_leaves": "Azalea hostoak",
	...
	"block.minecraft.bamboo_shelf": "Banbuzko apala",
	...
	"block.minecraft.birch_shelf": "Urkizko apala",
	...
	"block.minecraft.cactus_flower": "Kaktus lorea",
	...
	"block.minecraft.chain": "Burdinazko katea",
	...
	"block.minecraft.cherry_shelf": "Gereziondozko apala",
	...
	"block.minecraft.chiseled_bookshelf": "Liburu-apalategi zizelkatua",
	"block.minecraft.chiseled_cinnabar": "Zizelatu Zinabrioa",
	...
	"block.minecraft.chiseled_sulfur": "Zizelatu Sufrea",
	...
	"block.minecraft.cinnabar": "Zinabrioa",
	"block.minecraft.cinnabar_brick_slab": "Zinabrio Adreiluzko Lauza",
	"block.minecraft.cinnabar_brick_stairs": "Zinabrio Adreiluzko Eskailerak",
	"block.minecraft.cinnabar_brick_wall": "Zinabrio Adreiluzko Horma",
	"block.minecraft.cinnabar_bricks": "Zinabriozko Adreiluak",
	"block.minecraft.cinnabar_slab": "Zinabriozko Lauza",
	"block.minecraft.cinnabar_stairs": "Zinabriozko Eskailerak",
	"block.minecraft.cinnabar_wall": "Zinabriozko Horma",
	...
	"block.minecraft.copper_bars": "Kobrezko barrak",
	"block.minecraft.copper_block": "Kobrezko blokea",
	"block.minecraft.copper_bulb": "Kobrezko bonbilla",
	"block.minecraft.copper_chain": "Kobrezko katea",
	"block.minecraft.copper_chest": "Kobrezko kutxa",
	"block.minecraft.copper_door": "Kobrezko atea",
	"block.minecraft.copper_golem_statue": "Kobrezko golem estatua",
	"block.minecraft.copper_grate": "Kobrezko sareta",
	"block.minecraft.copper_lantern": "Kobrezko argiontzia",
	"block.minecraft.copper_ore": "Kobrezko mea",
	"block.minecraft.copper_torch": "Kobrezko argi-zuzia",
	"block.minecraft.copper_trapdoor": "Kobrezko tranpola",
	"block.minecraft.copper_wall_torch": "Kobre-zuzia horman",
	...
	"block.minecraft.crimson_shelf": "Apal gorrimina",
	...
	"block.minecraft.crying_obsidian": "Obsidiana negartsua",
	...
	"block.minecraft.dark_oak_shelf": "Haritz ilunezko apala",
	...
	"block.minecraft.dried_ghast": "Ghast sikua",
	...
	"block.minecraft.end_stone": "Endeko harria",
	...
	"block.minecraft.exposed_chiseled_copper": "Kobre estalgabetu zizelkatua",
	"block.minecraft.exposed_copper": "Kobre estalgabetua",
	"block.minecraft.exposed_copper_bars": "Kobrezko barra estalgabetuak",
	"block.minecraft.exposed_copper_bulb": "Kobrezko bonbilla estalgabetua",
	"block.minecraft.exposed_copper_chain": "Kobrezko kate estalgabetua",
	"block.minecraft.exposed_copper_chest": "Kobrezko kutxa estalgabetua",
	"block.minecraft.exposed_copper_door": "Kobrezko ate estalgabetua",
	"block.minecraft.exposed_copper_golem_statue": "Kobrezko golem estatua estalgabetua",
	"block.minecraft.exposed_copper_grate": "Kobrezko sareta estalgabetua",
	"block.minecraft.exposed_copper_lantern": "Kobrezko argiontzi estalgabetua",
	"block.minecraft.exposed_copper_trapdoor": "Kobrezko tranpol estalgabetua",
	...
	"block.minecraft.exposed_lightning_rod": "Kobrezko tximistorratz estalgabetua",
	...
	"block.minecraft.golden_dandelion": "Urrezko txikoria",
	...
	"block.minecraft.iron_chain": "Burdinazko katea",
	...
	"block.minecraft.jungle_shelf": "Oihanezko apala",
	...
	"block.minecraft.leaf_litter": "Orbelak",
	...
	"block.minecraft.mangrove_shelf": "Manglezko apala",
	...
	"block.minecraft.oak_shelf": "Haritzezko apala",
	...
	"block.minecraft.oxidized_copper": "Kobre herdoildua",
	"block.minecraft.oxidized_copper_bars": "Kobrezko barra herdoilduak",
	"block.minecraft.oxidized_copper_bulb": "Kobrezko bonbilla herdoildua",
	"block.minecraft.oxidized_copper_chain": "Kobrezko kate herdoildua",
	"block.minecraft.oxidized_copper_chest": "Kobrezko kutxa herdoildua",
	"block.minecraft.oxidized_copper_door": "Kobrezko ate herdoildua",
	"block.minecraft.oxidized_copper_golem_statue": "Kobrezko golem estatua herdoildua",
	"block.minecraft.oxidized_copper_grate": "Kobrezko sareta herdoildua",
	"block.minecraft.oxidized_copper_lantern": "Kobrezko argiontzi herdoildua",
	"block.minecraft.oxidized_copper_trapdoor": "Kobrezko tranpol herdoildua",
	"block.minecraft.oxidized_cut_copper": "Moztutako kobre herdoildua",
	"block.minecraft.oxidized_cut_copper_slab": "Moztutako kobrezko lauza herdoildua",
	"block.minecraft.oxidized_cut_copper_stairs": "Moztutako kobrezko eskailera herdoilduak",
	"block.minecraft.oxidized_lightning_rod": "Kobrezko tximistorratz herdoildua",
	...
	"block.minecraft.pale_oak_shelf": "Haritz zurbilezko apala",
	...
	"block.minecraft.polished_cinnabar": "Leunduta Zinabrioa",
	"block.minecraft.polished_cinnabar_slab": "Leunduta Zinabriozko Lauza",
	"block.minecraft.polished_cinnabar_stairs": "Leunduta Zinabriozko Eskailerak",
	"block.minecraft.polished_cinnabar_wall": "Leunduta Zinabriozko Horma",
	...
	"block.minecraft.polished_sulfur": "Leunduta Sufrezko Adreilua",
	"block.minecraft.polished_sulfur_slab": "Leunduta Sufrezko Lauza",
	"block.minecraft.polished_sulfur_stairs": "Leunduta Sufrezko Eskailerak",
	"block.minecraft.polished_sulfur_wall": "Leunduta Sufrezko Horma",
	...
	"block.minecraft.potent_sulfur": "Indartsua Sufrea",
	...
	"block.minecraft.potted_golden_dandelion": "Urrezko txikoria landatua",
	...
	"block.minecraft.purpur_block": "Purpurezko blokea",
	"block.minecraft.purpur_pillar": "Purpurezko zutabea",
	"block.minecraft.purpur_slab": "Purpurezko lauza",
	...
	"block.minecraft.raw_copper_block": "Kobrezko bloke landugabea",
	"block.minecraft.raw_gold_block": "Urrezko bloke landugabea",
	...
	"block.minecraft.sniffer_egg": "Snifferren Arrautza",
	...
	"block.minecraft.spruce_shelf": "Izeizko apala",
	...
	"block.minecraft.sulfur": "Sufrea",
	"block.minecraft.sulfur_brick_slab": "Sufre Adreiluzko Lauza",
	"block.minecraft.sulfur_brick_stairs": "Sufre Adreiluzko Eskailerak",
	"block.minecraft.sulfur_brick_wall": "Sufre Adreiluzko Horma",
	"block.minecraft.sulfur_bricks": "Sufrezko Adreiluak",
	"block.minecraft.sulfur_slab": "Sufrezko Lauza",
	"block.minecraft.sulfur_spike": "Sufrezko punta",
	"block.minecraft.sulfur_stairs": "Sufrezko Eskailerak",
	"block.minecraft.sulfur_wall": "Sufrezko Horma",
	...
	"block.minecraft.warped_shelf": "Apal okertua",
	...
	"block.minecraft.waxed_chiseled_copper": "Ezkoztatutako kobre zizelkatua",
	"block.minecraft.waxed_copper_bars": "Ezkoztatutako kobrezko barrak",
	"block.minecraft.waxed_copper_block": "Ezkoztatutako kobrezko blokea",
	"block.minecraft.waxed_copper_bulb": "Ezkoztatutako kobrezko bonbilla",
	"block.minecraft.waxed_copper_chain": "Ezkoztatutako kobrezko katea",
	"block.minecraft.waxed_copper_chest": "Ezkoztatutako kobrezko kutxa",
	"block.minecraft.waxed_copper_door": "Ezkoztatutako kobrezko atea",
	"block.minecraft.waxed_copper_golem_statue": "Ezkoztatutako kobrezko golem estatua",
	"block.minecraft.waxed_copper_grate": "Ezkoztatutako kobrezko sareta",
	"block.minecraft.waxed_copper_lantern": "Ezkoztatutako kobrezko argiontzia",
	"block.minecraft.waxed_copper_trapdoor": "Ezkoztatutako kobrezko tranpola",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Ezkoztatutako kobre estalgabetu zizelkatua",
	"block.minecraft.waxed_exposed_copper": "Ezkoztatutako kobre estalgabetua",
	"block.minecraft.waxed_exposed_copper_bars": "Ezkoztatutako kobrezko barra estalgabetuak",
	"block.minecraft.waxed_exposed_copper_bulb": "Ezkoztatutako kobrezko bonbilla estalgabetua",
	"block.minecraft.waxed_exposed_copper_chain": "Ezkoztatutako kobrezko kate estalgabetua",
	"block.minecraft.waxed_exposed_copper_chest": "Ezkoztatutako kobrezko kutxa estalgabetua",
	"block.minecraft.waxed_exposed_copper_door": "Ezkoztatutako kobrezko ate estalgabetua",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Ezkoztatutako kobrezko golem estatua estalgabetua",
	"block.minecraft.waxed_exposed_copper_grate": "Ezkoztatutako kobrezko sareta estalgabetua",
	"block.minecraft.waxed_exposed_copper_lantern": "Ezkoztatutako kobrezko argiontzi estalgabetua",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Ezkoztatutako kobrezko tranpol estalgabetua",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Ezkoztatutako kobrezko tximistorratz estalgabetua",
	"block.minecraft.waxed_lightning_rod": "Ezkoztatutako kobrezko tximistorratza",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Ezkoztatutako kobre herdoildu zizelkatua",
	"block.minecraft.waxed_oxidized_copper": "Ezkoztatutako kobre herdoildua",
	"block.minecraft.waxed_oxidized_copper_bars": "Ezkoztatutako kobrezko barra herdoilduak",
	"block.minecraft.waxed_oxidized_copper_bulb": "Ezkoztatutako kobrezko bonbilla herdoildua",
	"block.minecraft.waxed_oxidized_copper_chain": "Ezkoztatutako kobrezko kate herdoildua",
	"block.minecraft.waxed_oxidized_copper_chest": "Ezkoztatutako kobrezko kutxa herdoildua",
	"block.minecraft.waxed_oxidized_copper_door": "Ezkoztatutako kobrezko ate herdoildua",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Ezkoztatutako kobrezko golem estatua herdoildua",
	"block.minecraft.waxed_oxidized_copper_grate": "Ezkoztatutako kobrezko sareta herdoildua",
	"block.minecraft.waxed_oxidized_copper_lantern": "Ezkoztatutako kobrezko argiontzi herdoildua",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Ezkoztatutako kobrezko tranpol herdoildua",
	"block.minecraft.waxed_oxidized_cut_copper": "Ezkoztatutako moztutako kobre herdoildua",
	"block.minecraft.waxed_oxidized_cut_copper_slab": "Ezkoztatutako moztutako kobrezko lauza herdoildua",
	"block.minecraft.waxed_oxidized_cut_copper_stairs": "Ezkoztatutako moztutako kobrezko eskailera herdoilduak",
	"block.minecraft.waxed_oxidized_lightning_rod": "Ezkoztatutako kobrezko tximistorratz herdoildua",
	"block.minecraft.waxed_weathered_chiseled_copper": "Ezkoztatutako kobre degradatu zizelkatua",
	"block.minecraft.waxed_weathered_copper": "Ezkoztatutako kobre degradatua",
	"block.minecraft.waxed_weathered_copper_bars": "Ezkoztatutako kobrezko barra degradatuak",
	"block.minecraft.waxed_weathered_copper_bulb": "Ezkoztatutako kobrezko bonbilla degradatua",
	"block.minecraft.waxed_weathered_copper_chain": "Ezkoztatutako kobrezko kate degradatua",
	"block.minecraft.waxed_weathered_copper_chest": "Ezkoztatutako kobrezko kutxa degradatua",
	"block.minecraft.waxed_weathered_copper_door": "Ezkoztatutako kobrezko ate degradatua",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Ezkoztatutako kobrezko golem estatua degradatua",
	"block.minecraft.waxed_weathered_copper_grate": "Ezkoztatutako kobrezko sareta degradatua",
	"block.minecraft.waxed_weathered_copper_lantern": "Ezkoztatutako kobrezko argiontzi degradatua",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Ezkoztatutako kobrezko tranpol degradatua",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Ezkoztatutako kobrezko tximistorratz degradatua",
	"block.minecraft.weathered_chiseled_copper": "Kobre degradatu zizelkatua",
	"block.minecraft.weathered_copper": "Kobre degradatua",
	"block.minecraft.weathered_copper_bars": "Kobrezko barra degradatuak",
	"block.minecraft.weathered_copper_bulb": "Kobrezko bonbilla degradatua",
	"block.minecraft.weathered_copper_chain": "Kobrezko kate degradatua",
	"block.minecraft.weathered_copper_chest": "Kobrezko kutxa degradatua",
	"block.minecraft.weathered_copper_door": "Kobrezko ate degradatua",
	"block.minecraft.weathered_copper_golem_statue": "Kobrezko golem estatua degradatua",
	"block.minecraft.weathered_copper_grate": "Kobrezko sareta degradatua",
	"block.minecraft.weathered_copper_lantern": "Kobrezko argiontzi degradatua",
	"block.minecraft.weathered_copper_trapdoor": "Kobrezko tranpol degradatua",
	...
	"block.minecraft.weathered_lightning_rod": "Kobrezko tximistorratz degradatua",
	...
	"block.minecraft.wildflowers": "Loretxo basatiak",
	...
	"book.edit.title": "Liburua editatzeko pantaila",
	...
	"book.page_button.next": "Hurrengo orria",
	"book.page_button.previous": "Aurreko orria",
	"book.sign.title": "Liburuaren sinadura-pantaila",
	"book.sign.titlebox": "Izenburua",
	"book.signButton": "Sinatu",
	"book.view.title": "Liburuaren ikus-pantaila",
	"build.spawn_protection": "\"%s agertze-babespean dago\"",
	"build.tooHigh": "Eraikitzeko altuera muga %s da",
	"build.tooLow": "Eraikinaren gutxieneko altuera %s da",
	"chat.cannotSend": "Txataren mezua bidali ezin izan da",
	"chat.coordinates": "%s, %s, %s",
	"chat.coordinates.tooltip": "Egin klik telegarraiatzeko",
	"chat.copy": "Kopiatu paper-zorrora",
	"chat.copy.click": "Egin klik paper-zorrora kopiatzeko",
	...
	"chat.disabled.invalid_command_signature": "Komandoak ustekabeko edo ez zeuden komandoaren argudio-sinadurak zituen.",
	...
	"chat.link.confirmTrusted": "Lotura hau irekitzea edo zure paper-zorrora kopiatzea nahi duzu?",
	...
	"chat.queue.tooltip": "Klik egin hurrengo mezua erakusteko",
	...
	"chat_restriction.chat_and_commands_disabled_by_options": "Txata mugatuta dago bezeroaren ezarpenean.",
	"chat_restriction.chat_disabled_by_options": "Jokalarien txata mugatuta dago bezeroaren ezarpenean.",
	"chat_restriction.chat_disabled_by_options.action": "Joan txataren ezarpenen pantailara",
	"chat_restriction.disabled_by_launcher": "Abiarazleak txata mugatzen du",
	"chat_restriction.disabled_by_profile": "Txata profilaren ezarpenak mugatuta dago.",
	"chat_restriction.disabled_by_profile.action": "Joan zure profilaren ezarpenara",
	"chat_screen.commands_not_allowed": "Komandoak bidaltzea ez da onartzen",
	"chat_screen.message": "Bidaltzeko mezua: %s",
	"chat_screen.messages_not_allowed": "Txat mezuak bidaltzea ez da onartzen",
	"chat_screen.restricted": "Txata mugatuta dago. Sakatu mezu hau xehetasunak ikusteko.",
	"chat_screen.restricted.narration": "Txata mugatuta dago. Mundu aukeretan, joan murrizketak pantailara.",
	"chat_screen.title": "Txat-pantaila",
	"chat_screen.usage": "Mezua idatzi eta \"Sartu\" sakatu mezu hau bidaltzeko",
	"chunk.toast.checkLog": "Xehetasun gehiago lortzeko, ikusi erregistroa",
	"chunk.toast.loadFailure": "Akats bat egon da %s chunka kargatzean",
	"chunk.toast.lowDiskSpace": "Leku gutxi diskoan!",
	"chunk.toast.lowDiskSpace.description": "Baliteke mundu hau ez gorde ahal izatea.",
	"chunk.toast.saveFailure": "Akats bat egon da %s chunka gordetzean",
	...
	"command.trailing_data": "Bide datuak topatuta: %s",
	"command.unknown.argument": "Argumentu okerra",
	"command.unknown.command": "Komando ezezagun edo osatugabea, begiratu akats mezua azpian",
	...
	"commands.attribute.base_value.reset.success": "Oinarrizko %s atributuaren balioa %s entitatearentzat %s(e)ra lehenetsi da",
	...
	"commands.datapack.create.already_exists": "'%s' izeneko paketea jada existitzen da",
	"commands.datapack.create.invalid_full_name": "Baliogabeko pakete izen berria: '%s'",
	"commands.datapack.create.invalid_name": "Karaktere baliogabeak '%s' pakete berriaren izenean",
	"commands.datapack.create.io_failure": "Ezin izan da '%s' izeneko paketea sortu, egiaztatu erregistroak",
	"commands.datapack.create.metadata_encode_failure": "Akats bat egon da '%s': %s izeneko paketearen metadatuak kodetzean",
	"commands.datapack.create.success": "'%s' izeneko pakete huts berria sortu da",
	"commands.datapack.disable.failed": "'%s' paketea ez dago gaituta!",
	"commands.datapack.disable.failed.feature": "'%s' paketea ezin da desgaitu, izan ere, gaitutako bandera baten parte da!",
	...
	"commands.debug.function.noRecursion": "Ezin da funtzio baten barrutik aztarnaratu",
	...
	"commands.debug.function.traceFailed": "Akats bat egon da funtzioa jarraitzean",
	...
	"commands.dialog.clear.multiple": "%s jokalariri izenburua garbitu zaie",
	"commands.dialog.clear.single": "%s(r)i izenburua garbitu zaio",
	"commands.dialog.show.multiple": "Izenburua %s jokalariri erakutsita",
	"commands.dialog.show.single": "Izenburua %s(r)i erakutsita",
	...
	"commands.execute.function.instantiationFailure": "Akats bat egon da %s: %s funtzioa instantziatzean",
	...
	"commands.fetchprofile.copy_component": "Osagaia kopiatu",
	"commands.fetchprofile.copy_text": "%s kopiatu",
	"commands.fetchprofile.entity.success": "%s entitatearen profila ebatzita: %s",
	"commands.fetchprofile.failed_to_serialize": "Akats bat egon da %s profila serializatzean",
	"commands.fetchprofile.give_item": "Objektua eman",
	"commands.fetchprofile.id.failure": "Akats bat egon da %s IDko profila ebaztean",
	"commands.fetchprofile.id.success": "%s: %s IDko profila ebatzita",
	"commands.fetchprofile.name.failure": "Akats bat egon da %s izeneko profila ebaztean",
	"commands.fetchprofile.name.success": "%s: %s izeneko profila ebatzita",
	"commands.fetchprofile.no_profile": "%s entitateak ez du profilik",
	"commands.fetchprofile.summon_mannequin": "Manikia sortu",
	...
	"commands.function.instantiationFailure": "Akats bat egon da %s: %s funtzioa instantziatzean",
	...
	"commands.give.failed.toomanyitems": "Ezin dira %s baino gehiago %s-tik eman",
	...
	"commands.jfr.dump.failed": "Akats bat egon da %s JFR grabaketa deskargatzean",
	"commands.jfr.start.failed": "Akats bat egon da %s JFR profila hastean",
	...
	"commands.perf.reportFailed": "Akats bat egon da arazketa txostena sortzean",
	...
	"commands.place.feature.failed": "Akats bat egon da ezaugarria jartzean",
	...
	"commands.place.jigsaw.failed": "Akats bat egon da puzzlea sortzean",
	"commands.place.jigsaw.invalid": "Ez dago \"%s\" izeneko egiturarik",
	"commands.place.jigsaw.success": "Puzzlea sortu da %s, %s, %s",
	"commands.place.structure.failed": "Akats bat egon da estruktura jartzean",
	...
	"commands.place.template.failed": "Akats bat egon da txantiloia jartzean",
	...
	"commands.profile_fetch.copy_component": "Osagaia kopiatu",
	"commands.profile_fetch.failed_to_serialize": "Akats bat egon da %s profila serializatzean",
	"commands.profile_fetch.give_item": "Objektua eman",
	"commands.profile_fetch.id.failure": "Akats bat egon da %s IDko profila ebaztean",
	"commands.profile_fetch.id.success": "%s: %s IDko profila ebatzita",
	"commands.profile_fetch.name.failure": "Akats bat egon da %s izeneko profila ebaztean",
	"commands.profile_fetch.name.success": "%s: %s izeneko profila ebatzita",
	...
	"commands.schedule.macro": "Ezin da makro bat programatu",
	...
	"commands.scoreboard.objectives.remove.success": "%s helburua ezabatu da",
	...
	"commands.scoreboard.players.display.name.set.success.single": "%s(e)n %s erakusteko %s izenera aldatuta",
	...
	"commands.setidletimeout.success.disabled": "Jokalariaren inaktibitate-denbora orain desgaituta dago",
	...
	"commands.setworldspawn.success.new": "Munduaren spawn puntua ezarri da %s, %s, %s [%s, %s] %s-en",
	"commands.spawnpoint.success.multiple": "Ezarri munduko sorketa-puntua %s, %s, %s [%s] %s(e)n %s jokalarientzat",
	"commands.spawnpoint.success.multiple.new": "Spawn puntua ezarri da %s, %s, %s [%s, %s] %s-en %s jokalarientzat",
	"commands.spawnpoint.success.single": "Ezarri munduko sorketa-puntua %s, %s, %s [%s] %s(e)n %s(r)entzat",
	"commands.spawnpoint.success.single.new": "Spawn puntua ezarri da %s, %s, %s [%s, %s] %s-en %s jokalariarentzat",
	"commands.spectate.cannot_spectate": "%s ezin da ikuskatu",
	...
	"commands.stopwatch.already_exists": "'%s' denbora-neurgailua dagoeneko existitzen da",
	"commands.stopwatch.create.success": "'%s' denbora-neurgailua sortu egin da",
	"commands.stopwatch.does_not_exist": "'%s' denbora-neurgailua ez da existitzen",
	"commands.stopwatch.query": "'%s' denbora-neurgailua %ss iraun du",
	"commands.stopwatch.remove.success": "'%s' denbora-neurgailua ezabatu egin da",
	"commands.stopwatch.restart.success": "'%s' denbora-neurgailua berrezarri egin da",
	"commands.summon.failed": "Ezin izan da entitatea sortu",
	"commands.summon.failed.peaceful": "Munstroak ezin dira zailtasun baketsuan sortu",
	...
	"commands.swing.failed.notliving": "Ez ziren aurkiten entitateak igeri egiten",
	"commands.swing.success.multiple": "%s entitateek beren besoak mugitu dituzte",
	"commands.swing.success.single": "%s entitateak bere besoa mugitu du",
	...
	"commands.team.option.color.clear.success": "%s taldearen kolorea ezabatu da",
	"commands.team.option.color.success": "%s taldearen kolorea %s-(e)ra eguneratu da",
	...
	"commands.teleport.invalidPosition": "Ezin da leku honetara telegarraiatu",
	"commands.teleport.success.entity.multiple": "%s entitate %s-ra telegarraiatu dira",
	"commands.teleport.success.entity.single": "%s %s-ra telegarraiatuta",
	"commands.teleport.success.location.multiple": "%s entitate %s, %s, %s-ra telegarraiatuta",
	"commands.teleport.success.location.single": "%s %s, %s, %s-ra telegarraiatuta",
	"commands.test.batch.starting": "%s. ingurunea hasten, %s. sorta",
	"commands.test.clear.error.no_tests": "Ezin izan da ezabatzeko probarik aurkitu",
	"commands.test.clear.success": "%s egitura ezabatuta",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Klik egin paper-zorrora kopiatzeko",
	...
	"commands.test.error.no_test_instances": "Ez da proba-instantziarik aurkitu",
	"commands.test.error.non_existant_test": "%s proba ez da aurkitu",
	"commands.test.error.structure_not_found": "%s proba egitura ez da aurkitu",
	...
	"commands.test.run.no_tests": "Ez da probarik aurkitu",
	"commands.test.run.running": "%s proba exekutatzen...",
	"commands.test.summary": "Jokoaren proba bukaturik! %s proba egin dira",
	"commands.test.summary.all_required_passed": "Beharrezko proba guztiak pasa dira :)",
	"commands.test.summary.failed": "Hautazko %s probek huts egin dute :(",
	"commands.test.summary.optional_failed": "Hautazko %s probek huts egin dute",
	...
	"commands.time.no_default_clock": "%s dimentsioan erloju lehenetsirik ez",
	"commands.time.no_time_marker_found": "%s denbora-markatzailea ez dago %s erlojuarentzat",
	"commands.time.pause": "%s erlojua pausatua",
	"commands.time.query": "Ordua %s da",
	"commands.time.query.absolute": "%s erlojua %s tick-etan dago",
	"commands.time.query.gametime": "Jokaren denbora %s tick-ekoa da",
	"commands.time.query.timeline": "%s denbora-lerroa %s tick-ekoa da",
	"commands.time.query.timeline.repetitions": "%s denbora-lerroa %s errepikapena(k) pasatu da",
	"commands.time.rate": "%s erlojuak orain %sx ohiko abiaduran aurreratuko du",
	"commands.time.resume": "%s erlojua berriro hasi zen",
	"commands.time.set": "%s -etan denbora ezarrita",
	"commands.time.set.absolute": "Ezarri %s %s tick-etara",
	"commands.time.set.time_marker": "Ezarri %s %s denbora-markatzailera",
	"commands.time.wrong_timeline_for_clock": "%s denbora-lerroa ez da baliozko %s erlojuarentzat",
	...
	"commands.version.header": "Zerbitzariaren bertsio-informazioa:",
	...
	"commands.waypoint.list.empty": "Ez dago bide-punturik %s(e)n",
	"commands.waypoint.list.success": "%s bide-puntu daude %s: %s kokalekuan",
	"commands.waypoint.modify.color": "Bide-puntuaren kolorea %s da orain",
	"commands.waypoint.modify.color.reset": "Bide-puntuaren kolorea berrezarri",
	"commands.waypoint.modify.style": "Bide-puntuaren estiloa aldatuta",
	...
	"component.profile.dynamic": "Dinamikoa",
	...
	"connect.p2p.establishing": "Konexioa ezartzen...",
	"connect.p2p.failed.generic": "Ezin izan da jokalarira konektatu",
	"connect.p2p.failed.signaling": "Ez gara izan gai orain konektatzeko.\nSaiatu berriro gero.",
	"connect.p2p.failed.timeout": "Eskaeraren itxarote-denbora agortu da",
	"connect.p2p.failed.unreachable": "Jokalaria ez dago prest",
	...
	"createWorld.customize.buffet.search": "Bilatu...",
	...
	"dataPack.locator_bar.description": "Multijokalari moduan beste jokalarien norabidea erakutsi",
	"dataPack.locator_bar.name": "Barra kokatzailea",
	...
	"datapackFailure.safeMode.failed.title": "Akats bat egon da modu seguruan mundua kargatzean.",
	...
	"death.attack.anvil": "%[1]s ingude batez zapaldua izan da",
	"death.attack.anvil.player": "%[1]s ingude batez zapaldua izan da %[2]s(r)en aurka borrokatzen zuen bitartean",
	"death.attack.arrow": "%[1]s %[2]s(e)k tirokatuta hil da",
	"death.attack.arrow.item": "%[1]s %[2]s(e)k %[3]s erabiliz tirokatuta hil da",
	"death.attack.badRespawnPoint.link": "Nahitazko joko-diseinua",
	"death.attack.badRespawnPoint.message": "%[2]s(e)k %[1]s(r)ekin akabatu du",
	"death.attack.cactus": "%[1]s heriotzaraino ziztatu da",
	"death.attack.cactus.player": "%[1]s bete-betean kaktus baten kontra joan da %[2]s(r)engandik ihes egiten saiatzen zuen bitartean",
	"death.attack.cramming": "%[1]s inplosionatuta hil da",
	"death.attack.cramming.player": "%[1]s %[2]s(e)k zapaldua izan da",
	"death.attack.dragonBreath": "%[1]s dragoiaren hatsaz erraustua izan da",
	"death.attack.dragonBreath.player": "%[1]s %[2]s(e)k eraginda dragoiaren hatsaz erraustua izan da",
	"death.attack.drown": "%[1]s ito egin da",
	"death.attack.drown.player": "%[1]s ito egin da %[2]s(r)engandik ihes egiten saiatzen zuen bitartean",
	"death.attack.dryout": "%[1]s deshidratatuta hil da",
	"death.attack.dryout.player": "%[1]s deshidratatuta hil da %[2]s(r)engandik ihes egiten saiatzen zuen bitartean",
	"death.attack.even_more_magic": "%[1]s magia beltzez hil da",
	"death.attack.explosion": "%[1]s(e)k leher egin du",
	"death.attack.explosion.player": "%[1]s %[2]s(e)k lehertua izan da",
	"death.attack.explosion.player.item": "%[1]s %[2]s(e)k %[3]s erabiliz lehertua izan da",
	"death.attack.fall": "%[1]s(e)k lurra oso gogor jo du",
	"death.attack.fall.player": "%[1]s(e)k lurra oso gogor jo du %[2]s(r)engandik ihes egiten saiatzen zuen bitartean",
	"death.attack.fallingBlock": "%[1]s bloke batez zapaldua izan da",
	"death.attack.fallingBlock.player": "%[1]s bloke batez zapaldua izan da %[2]s(r)en aurka borrokatzen zuen bitartean",
	"death.attack.fallingStalactite": "%[1]s estalaktita batez zeharkatuta hil da",
	"death.attack.fallingStalactite.player": "%[1]s estalaktita batez zeharkatuta hil da %[2]s(r)en aurka borrokatzen zuen bitartean",
	"death.attack.fireball": "%[1]s %[2]s(e)k botatako su-bola batekin bizirik erre egin da",
	"death.attack.fireball.item": "%[1]s %[2]s(e)k %[3]s erabiliz botatako su-bola batekin bizirik erre egin da",
	"death.attack.fireworks": "%[1]s(r)i suziri bat leher egin zaio",
	"death.attack.fireworks.item": "%[1]s(r)i %[2]s(e)k %[3]s(e)tik jautitutako suziri bat leher egin zaio",
	"death.attack.fireworks.player": "%[1]s(r)i suziri bat leher egin zaio %[2]s(r)en aurka borrokatzen zuen bitartean",
	"death.attack.flyIntoWall": "%[1]s(e)k energia zinetikoa zer den ezagutu du",
	"death.attack.flyIntoWall.player": "%[1]s(e)k energia zinetikoa zer den ezagutu du %[2]s(r)engandik ihes egiten saiatzen zuen bitartean",
	"death.attack.freeze": "%[1]s izoztuta hil da",
	"death.attack.freeze.player": "%[1]s %[2]s(e)k izoztuta hil da",
	"death.attack.generic": "%[1]s hil da",
	"death.attack.generic.player": "%[1]s hil da %[2]s dela eta",
	"death.attack.genericKill": "%[1]s eraildua izan da",
	"death.attack.genericKill.player": "%[1]s eraildua izan da %[2]s(r)en aurka borrokatzen zuen bitartean",
	"death.attack.hotFloor": "%[1]s labaren tenperaturaz jabetu da",
	"death.attack.hotFloor.player": "%[1]s eremu arriskutsuan sartu da %[2]s dela eta",
	"death.attack.inFire": "%[1]s sutan erre da",
	"death.attack.inFire.player": "%[1]s sutan erre da %[2]s(r)en aurka borrokatzen zuen bitartean",
	"death.attack.inWall": "%[1]s horma batean asfixiatu da",
	"death.attack.inWall.player": "%[1]s horma batean asfixiatu da %[2]s(r)en aurka borrokatzen zuen bitartean",
	"death.attack.indirectMagic": "%[1]s %[2]s(r)en magiaz eraildua izan da",
	"death.attack.indirectMagic.item": "%[1]s %[2]s(e)k %[3]s erabiliz eraildua izan da",
	"death.attack.lava": "%[1]s laban igeri egiten saiatu da",
	"death.attack.lava.player": "%[1]s laban igeri egiten saiatu da %[2]s(r)engandik ihesean",
	"death.attack.lightningBolt": "%[1]s tximista batek jota hil da",
	"death.attack.lightningBolt.player": "%[1]s tximista batek jota hil da %[2]s(r)en aurka borrokatzen zuen bitartean",
	"death.attack.mace_smash": "%[1]s %[2]s(e)k mailukatua izan da",
	"death.attack.mace_smash.item": "%[1]s %[2]s(e)k %[3]s erabiliz mailukatua izan da",
	"death.attack.magic": "%[1]s magiaz hil da",
	"death.attack.magic.player": "%[1]s magiaz hil da %[2]s(r)engandik ihes egiten saiatzen zuen bitartean",
	...
	"death.attack.onFire.item": "%[1]s %[2]s(r)en aurka borrokatzen zebilenean %[3]s zeramala errauts bihurtu arte erre zen",
	"death.attack.onFire.player": "%[1]s errauts egin arte erre zen %[2]s(r)ekin borrokan zebilenean",
	...
	"death.attack.outsideBorder.player": "%[1]s munduko mugetatik atera da %[2]sren aurka borrokatzen zen bitartean",
	...
	"death.attack.sonic_boom.item": "%[1]s soinuz-kargatutako oihu batengatik suntsitua izan da %[2]s(a)gandik ihes egiten saiatzen ari zenean",
	"death.attack.sonic_boom.player": "%[1]s soinuz-kargatutako oihu batengatik suntsitua izan da %[2]s(a)gandik ihes egiten saiatzen ari zenean",
	"death.attack.spear": "%[1]s %[2]s(e)k zeharkatua izan da",
	"death.attack.spear.item": "%[1]s %[2]s(e)k %[3]s erabiliz zeharkatua izan da",
	...
	"death.attack.sweetBerryBush.player": "%[1]s fruitu gozozko zuhaixka baten arantzen artean hil da %[2]s(r)engandik ihes egin nahian",
	"death.attack.thorns": "%[1]s hil da %[2]s(r)i mina egiten saiatzean",
	"death.attack.thorns.item": "%[3]s(a)k %[1]s hil du %[2]s erasotzen saiatzean",
	...
	"death.attack.wither.player": "%[1]s indargabetu egin zen %[2]s(r)ekin borrokan zebilela",
	...
	"debug.copy_location.help": "F3 + C = Kopiatu kokalekua /tp komando bezala, edo 10 segunduz mantendu jokoa ixteko",
	"debug.copy_location.message": "Kokapena paper-zorrora kopiatu da",
	"debug.crash.message": "F3 + C sakatuta dago. Honek jokuak funtionatzeari uztea eragingo du sakatzeari utzi ezean.",
	"debug.crash.message.rebindable": "%s + %s sakatuta dago. Honek jokoa crash egitea eragingo du askatu ezean.",
	...
	"debug.dump_dynamic_textures": "Testura dinamikoak %s-en gorde dira",
	"debug.dump_dynamic_textures.help": "F3 + S = Testura dinamikoak isuri",
	"debug.entry.always": "Beti",
	"debug.entry.currently.alwaysOn": "%s: Orain beti agerian",
	"debug.entry.currently.inF3": "%s: Orain bakarrik F3n",
	"debug.entry.currently.inOverlay": "%s: Une honetan soilik arazketa gainjartzean dago",
	"debug.entry.currently.never": "%s: Orain amatatuta",
	"debug.entry.f3": "F3n",
	"debug.entry.overlay": "Gainjartzean",
	...
	"debug.inspect.client.block": "Bezeroaren bloke datuak paper-zorrora kopiatu dira",
	"debug.inspect.client.entity": "Bezeroaren entitate datuak paper-zorrora kopiatu dira",
	"debug.inspect.help": "F3 + I = Kopiatu entitate edo bloke datuak paper-zorrora",
	"debug.inspect.server.block": "Zerbitzariaren bloke datuak paper-zorrora kopiatu dira",
	"debug.inspect.server.entity": "Zerbitzariaren entitate datuak paper-zorrora kopiatu dira",
	"debug.options.category.renderer": "Arazketa-errendatzaileak",
	"debug.options.category.text": "Arazketa-pantaila testua",
	"debug.options.help": "F3 + F6 = Arazketa-ezarpenak editatu",
	"debug.options.notAllowed.tooltip": "Ez da ikusgai arazketa-informazioa murriztuta dagoenean",
	"debug.options.profile.default": "Profil lehenetsia",
	"debug.options.profile.performance": "Errendimendu profila",
	"debug.options.search": "Bilatu...",
	"debug.options.title": "Arazketa-ezarpenak",
	"debug.options.warning": "Aukera hauek proba-helburuetarako bakarrik dira. Baliteke zure ordenagailua moteltzea, jokoa kraskatzea edo... txerriak hegan egiten hastea.",
	...
	"debug.profiling.start": "Profilaketa hasi da %s segundoz. F3 + L erabili lehenago gelditzeko",
	"debug.profiling.start.rebindable": "Profilaketa hasi da %s segundoz. %s + %s erabili lehenago gelditzeko",
	...
	"debug.version.header": "Bezero-bertsioaren informazioa:",
	"debug.version.help": "F3 + V = Bezero-bertsioaren informazioa",
	...
	"editGamerule.inGame.button": "Joko-Arauak Editatu...",
	"editGamerule.inGame.disabled.tooltip": "Joko-arauak aldatzeko administratzailearen baimena behar da.",
	"editGamerule.inGame.discardChanges.message": "Ziur zaude zure joko-arauen aldaketak baztertu nahi dituzula?",
	"editGamerule.inGame.discardChanges.title": "Joko-arau aldaketak",
	"editGamerule.inGame.downloadingGamerules": "Joko-arauak berreskuratzen...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Nautilusaren arnasa",
	...
	"effect.minecraft.wind_charged": "Haize-bolada",
	...
	"enchantment.minecraft.lunge": "Estokada",
	...
	"enchantment.minecraft.sweeping": "Ekorketa-ertza",
	"enchantment.minecraft.sweeping_edge": "Ekorketa-ertza",
	...
	"enchantment.minecraft.wind_burst": "Aire-abiada",
	...
	"entity.minecraft.area_effect_cloud": "Eragin-hodei iraunkorra",
	"entity.minecraft.armadillo": "Armadiloa",
	"entity.minecraft.armor_stand": "Armadura-euskarria",
	...
	"entity.minecraft.block_display": "Bloke holografikoa",
	"entity.minecraft.boat": "Txalupa",
	"entity.minecraft.bogged": "Lokaztia",
	"entity.minecraft.breeze": "Haizetea",
	"entity.minecraft.breeze_wind_charge": "Haize-zurrunbiloa",
	"entity.minecraft.camel": "Gamelua",
	"entity.minecraft.camel_husk": "Gamelu momifikatua",
	...
	"entity.minecraft.copper_golem": "Kobrezko golema",
	...
	"entity.minecraft.experience_orb": "Esperientzia-lurbira",
	...
	"entity.minecraft.fishing_bobber": "Arrantza-amua",
	...
	"entity.minecraft.item_display": "Objektu holografikoa",
	...
	"entity.minecraft.leash_knot": "Lotura-korapiloa",
	"entity.minecraft.lightning_bolt": "Tximista",
	"entity.minecraft.lingering_potion": "Edabe iraunkorra",
	"entity.minecraft.llama": "Llama",
	"entity.minecraft.llama_spit": "Llamaren txistua",
	...
	"entity.minecraft.mannequin": "Manikia",
	"entity.minecraft.mannequin.label": "NPC",
	"entity.minecraft.marker": "Markagailua",
	"entity.minecraft.minecart": "Bagoneta",
	"entity.minecraft.mooshroom": "Mooshroom-a",
	"entity.minecraft.mule": "Mandoa",
	"entity.minecraft.nautilus": "Nautilusa",
	...
	"entity.minecraft.parched": "Idorrekoa",
	"entity.minecraft.parrot": "Loroa",
	"entity.minecraft.phantom": "Mamua",
	"entity.minecraft.pig": "Txerria",
	"entity.minecraft.piglin": "Piglina",
	"entity.minecraft.piglin_brute": "Piglin bortitza",
	...
	"entity.minecraft.spawner_minecart": "Bagoneta munstro sortzailearekin",
	"entity.minecraft.spectral_arrow": "Gezi espektrala",
	"entity.minecraft.spider": "Armiarma",
	"entity.minecraft.splash_potion": "Edabe jaurtigarria",
	...
	"entity.minecraft.sulfur_cube": "Sufrezko kuboa",
	"entity.minecraft.sulfur_cube.content": "Du: %s",
	"entity.minecraft.tadpole": "Zapaburua",
	"entity.minecraft.text_display": "Testu holografikoa",
	...
	"entity.minecraft.villager.nitwit": "Alferrontzia",
	...
	"entity.minecraft.wind_charge": "Haize-zurrunbiloa",
	"entity.minecraft.witch": "Sorgina",
	"entity.minecraft.wither": "Wither-a",
	...
	"entity.minecraft.zombie_nautilus": "Zonbi-nautilusa",
	...
	"filled_map.explorer_jungle": "Oihaneko Esploratzaile Mapa",
	"filled_map.explorer_swamp": "Zingirako Esploratzaile Mapa",
	"filled_map.id": "Id #%s",
	...
	"filled_map.trial_chambers": "Erronka esploratzaile mapa",
	"filled_map.unknown": "Mapa ezezaguna",
	"filled_map.village_desert": "Basamortuko Herriaren Mapa",
	"filled_map.village_plains": "Lautadetako Herriaren Mapa",
	"filled_map.village_savanna": "Sabanako Herriaren Mapa",
	"filled_map.village_snowy": "Elurtutako Herriaren Mapa",
	"filled_map.village_taiga": "Taigako Herriaren Mapa",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Netherra gaitu",
	"gamerule.allowEnteringNetherUsingPortals.description": "Jokalariek Netherrera sartzea baimendu edo ez kontrolatzen du.",
	"gamerule.allowFireTicksAwayFromPlayer": "Sua jokalariengandik urrundu",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Suak eta labak jokalariengandik 8 chunk-etara egon behar duten kontrolatzen du.",
	...
	"gamerule.commandBlocksEnabled": "Komando blokeak gaitu",
	...
	"gamerule.enableCommandBlocks": "Komando blokeak gaitu",
	...
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Baimendu bidaiariak dituzten entitateei Nether atarietatik, End atarietatik eta End loturaetatik telegarraiatzeko.",
	...
	"gamerule.locatorBar": "Gaitu jokalarien barra kokatzailea",
	"gamerule.locatorBar.description": "Aktibatuta, barra bat agertzen da pantailan jokalarien norabidea adierazteko.",
	...
	"gamerule.minecraft.elytra_movement_check": "Elitroen mugimendua egiaztatu",
	"gamerule.minecraft.fire_spread_radius_around_player": "Suaren hedapen erradioa",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Erradio bat blokeetan, jokalari baten inguruan, non sua heda daitekeen",
	"gamerule.minecraft.player_movement_check": "Jokalariaren mugimendua egiaztatu",
	"gamerule.minecraft.raids": "Erasoaldiak",
	"gamerule.minecraft.universal_anger.description": "Haserre dauden izaki neutraleek gertu dauden edozein jokalariri erasotzen diete, ez bakarrik haserretu dien jokalariari. Hobekien funtzionatzen du «forgive_dead_players» desgaituta dagoenean.",
	...
	"gamerule.playersSleepingPercentage.description": "Gaua aurrera egiteko lo egiten egon behar duten jokalari ehunekoa.",
	...
	"gamerule.pvp": "PvP gaitu",
	"gamerule.pvp.description": "Jokalariek beste jokalariei kalte egiteko baimena duten kontrolatzen du.",
	...
	"gamerule.sendCommandFeedback": "Bidali komandoen iritziak",
	...
	"gamerule.spawnMonsters": "Munstroak sortu",
	"gamerule.spawnMonsters.description": "Monstruak modu naturalean sortzen diren kontrolatzen du.",
	...
	"gamerule.spawnerBlocksEnabled": "Sortzaile blokeak gaitu",
	...
	"gui.banned.description.permanent": "Zure kontua betirako blokeatu da, hau da, ezin izango duzu linean jokatu edo Realmsera sartu.",
	...
	"gui.banned.title.permanent": "Betirako blokeaturiko kontua",
	...
	"gui.chatReport.title": "Jokalariaren mezua salatu",
	...
	"gui.copy_link_to_clipboard": "Kopiatu esteka paper-zorrora",
	"gui.days": "%s egun",
	"gui.done": "Eginda",
	"gui.down": "Behera",
	...
	"gui.fileDropFailure.title": "Akats bat egon da fitxategia gordetzean",
	"gui.friends.accept": "Onartu",
	"gui.friends.button.loading": "Itxaron...",
	"gui.friends.button.loading.invite_request_pending": "Waiting for confirmation",
	"gui.friends.button.loading.join_request_pending": "%s(r)en konfirmazioa itxaroten",
	"gui.friends.cancel_request": "Eskaera deuseztatu",
	"gui.friends.confirm_title": "Konfirmatu",
	"gui.friends.confirm_unfriend": "Are you sure you want to remove this player from your Friends List?",
	"gui.friends.copy_to_clipboard": "Kopiatu paper-zorrora",
	...
	"gui.friends.empty_state.link": "Microsoft kontua",
	"gui.friends.enter_nickname": "Sartu profil izena",
	...
	"gui.friends.error.user_may_lack_active_profile": "Ez dago jokalaririk izen honekin",
	"gui.friends.join": "Sartu",
	"gui.friends.loading_friends": "Lagunen zerrenda kargatzen...",
	"gui.friends.loading_requests": "Eskaerak kargatzen...",
	"gui.friends.manage_account_footer": "Kudeatu sareko segurtasuna zure %s-ekin",
	"gui.friends.multiplayer.invite": "Mundura gonbidatu",
	"gui.friends.multiplayer.invite_accept": "Mundura sartzeko gonbidapena onartu",
	"gui.friends.multiplayer.invite_reject": "Mundura sartzeko gonbidapena baztertu",
	"gui.friends.multiplayer.join_request": "Eskaera mundura sartzeko",
	"gui.friends.multiplayer.join_request_accept": "Mundura sartzeko eskaera onartu",
	"gui.friends.multiplayer.join_request_reject": "Mundura sartzeko eskaera baztertu",
	"gui.friends.my_profile_name": "Nire izena: ",
	"gui.friends.my_profile_name.narration": "%s profil izena kopiatu paper-zorrora",
	"gui.friends.narration.button.accept": "«Enter» sakatu %s(r)en lagun eskaera onartzeko",
	"gui.friends.narration.button.cancel_request": "«Enter» sakatu %s(r)en lagun eskaera deuseztatzeko",
	"gui.friends.narration.button.decline": "«Enter» sakatu %s(r)en lagun eskaera baztertzeko",
	"gui.friends.narration.button.unfriend": "«Enter» sakatu %s lagun-zerrendatik ezabatzeko",
	"gui.friends.narration.entry.friend": "Laguna %s",
	"gui.friends.narration.entry.incoming": "%s(r)en lagun eskaera",
	"gui.friends.narration.entry.outgoing": "%s(r)en lagun eskaera bidalia",
	"gui.friends.open": "Lagunak",
	"gui.friends.open.narration": "Lagun-zerrenda",
	"gui.friends.open.tooltip": "Lagunak",
	"gui.friends.pending.empty": "Ez duzu laguntasun-eskaerarik unean",
	"gui.friends.pending.received": "Jasota",
	"gui.friends.pending.sent": "Bidalita",
	"gui.friends.presence.status.offline": "Deskonektatua",
	"gui.friends.presence.status.online": "Linean",
	"gui.friends.presence.status.playing_hosted_server": "Online (World)",
	"gui.friends.presence.status.playing_offline": "Mundu batean",
	"gui.friends.presence.status.playing_realms": "Realm batean",
	"gui.friends.presence.status.playing_server": "Zerbitzari batean",
	"gui.friends.requests_count": "Eskakizunak (%s)",
	"gui.friends.send_request": "Lagun-eskaera bidali",
	"gui.friends.tab_friends": "Lagunak",
	...
	"gui.game_rule.search": "Bilatu...",
	"gui.hours": "%s ordu",
	"gui.language.search": "Bilatu...",
	...
	"gui.packSelection.search": "Bilatu...",
	...
	"gui.recipebook.next_page": "Hurrengo Orrialdea",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Aurrekok Orrialdea",
	...
	"gui.remove": "Ezabatu",
	"gui.report_to_server": "Zerbitzariari jakinarazi",
	"gui.selectWorld.search": "Bilatu...",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Ezin duzu jokalari hau salatu txata desgaituta edo blokeatuta dagoelako",
	...
	"gui.stats.none_found": "Ez da estatistikarik aurkitu.",
	...
	"gui.up": "Gora",
	"gui.waitingForResponse.button.inactive": "Atzera (%ss)",
	"gui.waitingForResponse.title": "Zerbitzaria itxaroten",
	"gui.yes": "Bai",
	...
	"item.minecraft.amethyst_shard": "Ametista puska",
	"item.minecraft.angler_pottery_shard": "Arrantzale zeramika-puska",
	"item.minecraft.angler_pottery_sherd": "Arrantzale zeramika-puska",
	"item.minecraft.apple": "Sagarra",
	"item.minecraft.archer_pottery_shard": "Arkulari zeramika-puska",
	"item.minecraft.archer_pottery_sherd": "Arkulari zeramika-puska",
	"item.minecraft.armadillo_scute": "Armadilo-ezkata",
	"item.minecraft.armadillo_spawn_egg": "Armadilo sortzaile arrautza",
	"item.minecraft.armor_stand": "Armadurarentzako euskarria",
	"item.minecraft.arms_up_pottery_shard": "Txotxongilo zeramika-puska",
	"item.minecraft.arms_up_pottery_sherd": "Txotxongilo zeramika-puska",
	...
	"item.minecraft.blade_pottery_shard": "Ezpata zeramika-puska",
	"item.minecraft.blade_pottery_sherd": "Ezpata zeramika-puska",
	...
	"item.minecraft.blue_egg": "Arrautza urdina",
	...
	"item.minecraft.brewer_pottery_shard": "Edabegile zeramika-puska",
	"item.minecraft.brewer_pottery_sherd": "Edabegile zeramika-puska",
	...
	"item.minecraft.brown_egg": "Arrautza marroia",
	...
	"item.minecraft.burn_pottery_shard": "Su zeramika-puska",
	"item.minecraft.burn_pottery_sherd": "Su zeramika-puska",
	"item.minecraft.camel_husk_spawn_egg": "Gamelu momifikatu sortzaile arrautza",
	"item.minecraft.camel_spawn_egg": "Gamelu sortzaile arrautza",
	...
	"item.minecraft.copper_axe": "Kobrezko aizkora",
	"item.minecraft.copper_boots": "Kobrezko botak",
	"item.minecraft.copper_chestplate": "Kobrezko bular-oskola",
	"item.minecraft.copper_golem_spawn_egg": "Kobrezko golem sortzaile arrautza",
	"item.minecraft.copper_helmet": "Kobrezko kaskoa",
	"item.minecraft.copper_hoe": "Kobrezko aitzurra",
	"item.minecraft.copper_horse_armor": "Kobrezko zaldi-armadura",
	"item.minecraft.copper_ingot": "Kobrezko lingotea",
	"item.minecraft.copper_leggings": "Kobrezko zangoak",
	"item.minecraft.copper_nautilus_armor": "Kobrezko nautilus-armadura",
	"item.minecraft.copper_nugget": "Kobrezko pipita",
	"item.minecraft.copper_pickaxe": "Kobrezko pikotxa",
	"item.minecraft.copper_shovel": "Kobrezko pala",
	"item.minecraft.copper_spear": "Kobrezko lantza",
	"item.minecraft.copper_sword": "Kobrezko ezpata",
	...
	"item.minecraft.danger_pottery_shard": "Arrisku zeramika-puska",
	"item.minecraft.danger_pottery_sherd": "Arrisku zeramika-puska",
	...
	"item.minecraft.diamond_nautilus_armor": "Diamantezko nautilus-armadura",
	"item.minecraft.diamond_pickaxe": "Diamantezko pikotxa",
	"item.minecraft.diamond_shovel": "Diamantezko pala",
	"item.minecraft.diamond_spear": "Diamantezko lantza",
	...
	"item.minecraft.explorer_pottery_shard": "Esploratzaile zeramika-puska",
	"item.minecraft.explorer_pottery_sherd": "Esploratzaile zeramika-puska",
	...
	"item.minecraft.flow_pottery_sherd": "Espiraldun zeramika-puska",
	...
	"item.minecraft.friend_pottery_shard": "Lagun zeramika-puska",
	"item.minecraft.friend_pottery_sherd": "Lagun zeramika-puska",
	...
	"item.minecraft.gold_nugget": "Urrezko pipita",
	...
	"item.minecraft.golden_nautilus_armor": "Urrezko nautilus-armadura",
	"item.minecraft.golden_pickaxe": "Urrezko pikotxa",
	"item.minecraft.golden_shovel": "Urrezko pala",
	"item.minecraft.golden_spear": "Urrezko lantza",
	...
	"item.minecraft.guster_pottery_sherd": "Haizete zeramika-puska",
	...
	"item.minecraft.heart_pottery_shard": "Bihotz zeramika-puska",
	"item.minecraft.heart_pottery_sherd": "Bihotz zeramika-puska",
	"item.minecraft.heartbreak_pottery_shard": "Bihotz-haustura zeramika-puska",
	"item.minecraft.heartbreak_pottery_sherd": "Bihotz-haustura zeramika-puska",
	...
	"item.minecraft.howl_pottery_shard": "Oihartzun zeramika-puska",
	"item.minecraft.howl_pottery_sherd": "Oihartzun zeramika-puska",
	...
	"item.minecraft.iron_nautilus_armor": "Burdinazko nautilus-armadura",
	"item.minecraft.iron_nugget": "Burdinazko pipita",
	"item.minecraft.iron_pickaxe": "Burdinazko pikotxa",
	"item.minecraft.iron_shovel": "Burdinazko pala",
	"item.minecraft.iron_spear": "Burdinazko lantza",
	...
	"item.minecraft.lingering_potion.effect.awkward": "Edabe misteriotsu iraunkorra",
	"item.minecraft.lingering_potion.effect.empty": "Edabe ezezagun iraunkorra",
	"item.minecraft.lingering_potion.effect.fire_resistance": "Suaren aurkako edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.harming": "Min egiteko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.healing": "Sendatzeko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.infested": "Infestazioko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.invisibility": "Ikusezintasuneko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.leaping": "Jauzi egiteko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.levitation": "Lebitazioko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.luck": "Zortezko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.mundane": "Edabe arrunt iraunkorra",
	"item.minecraft.lingering_potion.effect.night_vision": "Gaueko ikusmeneko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.oozing": "Lohitzeko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.poison": "Pozoitzeko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.regeneration": "Birsorkuntzako edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.slow_falling": "Erorketa geldoko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.slowness": "Geldotasuneko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.strength": "Indartzeko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.swiftness": "Azkartasuneko edabe iraunkorra",
	...
	"item.minecraft.lingering_potion.effect.water": "Ur botila iraunkorra",
	"item.minecraft.lingering_potion.effect.water_breathing": "Urpean arnasteko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.weakness": "Ahultzeko edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.weaving": "Ehungintza astunaren edabe iraunkorra",
	"item.minecraft.lingering_potion.effect.wind_charged": "Haize-boladazko edabe iraunkorra",
	...
	"item.minecraft.magenta_harness": "Arnes magenta",
	...
	"item.minecraft.miner_pottery_shard": "Meatzari zeramika-puska",
	"item.minecraft.miner_pottery_sherd": "Meatzari zeramika-puska",
	...
	"item.minecraft.mooshroom_spawn_egg": "Mooshroom sortzaile arrautza",
	"item.minecraft.mourner_pottery_shard": "Negarti zeramika-puska",
	"item.minecraft.mourner_pottery_sherd": "Negarti zeramika-puska",
	...
	"item.minecraft.music_disc_bounce": "Musika diskoa",
	...
	"item.minecraft.music_disc_lava_chicken": "Musika diskoa",
	...
	"item.minecraft.music_disc_tears": "Musika diskoa",
	...
	"item.minecraft.nautilus_shell": "Nautilus oskola",
	"item.minecraft.nautilus_spawn_egg": "Nautilus sortzaile arrautza",
	...
	"item.minecraft.netherite_horse_armor": "Netheritazko zldi-armadura",
	"item.minecraft.netherite_ingot": "Netheritazko lingotea",
	"item.minecraft.netherite_leggings": "Netheritazko zangoak",
	"item.minecraft.netherite_nautilus_armor": "Netheritazko nautilus-armadura",
	...
	"item.minecraft.netherite_spear": "Netheritazko lantza",
	...
	"item.minecraft.orange_harness": "Arnes laranja",
	...
	"item.minecraft.parched_spawn_egg": "Idorreko sortzaile arrautza",
	...
	"item.minecraft.plenty_pottery_shard": "Amaigabetasun zeramika-puska",
	"item.minecraft.plenty_pottery_sherd": "Amaigabetasun zeramika-puska",
	...
	"item.minecraft.potion.effect.empty": "Edabe eginezina",
	"item.minecraft.potion.effect.fire_resistance": "Suaren aurkako edabea",
	"item.minecraft.potion.effect.harming": "Min egiteko edabea",
	"item.minecraft.potion.effect.healing": "Sendatzeko edabea",
	"item.minecraft.potion.effect.infested": "Infestazioko edabea",
	"item.minecraft.potion.effect.invisibility": "Ikusezintasuneko edabea",
	"item.minecraft.potion.effect.leaping": "Jauzi egiteko edabea",
	"item.minecraft.potion.effect.levitation": "Lebitazioko edabea",
	"item.minecraft.potion.effect.luck": "Zortezko edabea",
	"item.minecraft.potion.effect.mundane": "Edabe arrunta",
	"item.minecraft.potion.effect.night_vision": "Gaueko ikusmeneko edabea",
	"item.minecraft.potion.effect.oozing": "Lohitzeko edabea",
	"item.minecraft.potion.effect.poison": "Pozoitzeko edabea",
	"item.minecraft.potion.effect.regeneration": "Birsorkuntzako edabea",
	"item.minecraft.potion.effect.slow_falling": "Erorketa geldoko edabea",
	"item.minecraft.potion.effect.slowness": "Geldotasuneko edabea",
	"item.minecraft.potion.effect.strength": "Indartzeko edabea",
	"item.minecraft.potion.effect.swiftness": "Azkartasuneko edabea",
	"item.minecraft.potion.effect.thick": "Edabe mamitsua",
	...
	"item.minecraft.potion.effect.weakness": "Ahultzeko edabea",
	"item.minecraft.potion.effect.weaving": "Ehungintza astunaren edabea",
	"item.minecraft.potion.effect.wind_charged": "Haize-boladazko edabea",
	...
	"item.minecraft.pottery_shard_prize": "Sari zeramika-puska",
	"item.minecraft.pottery_shard_skull": "Garezur zeramika-puska",
	...
	"item.minecraft.prize_pottery_shard": "Sari zeramika-puska",
	"item.minecraft.prize_pottery_sherd": "Sari zeramika-puska",
	...
	"item.minecraft.raw_copper": "Kobre landugabea",
	"item.minecraft.raw_gold": "Urre landugabea",
	"item.minecraft.raw_iron": "Burdina landugabea",
	...
	"item.minecraft.scrape_pottery_sherd": "Aizkora zeramika-puska",
	...
	"item.minecraft.sheaf_pottery_shard": "Altxor zeramika-puska",
	"item.minecraft.sheaf_pottery_sherd": "Altxor zeramika-puska",
	"item.minecraft.shears": "Guraizeak",
	"item.minecraft.sheep_spawn_egg": "Ardi sortzaile arrautza",
	"item.minecraft.shelter_pottery_shard": "Aterpe zeramika-puska",
	"item.minecraft.shelter_pottery_sherd": "Aterpe zeramika-puska",
	...
	"item.minecraft.skull_pottery_shard": "Garezur zeramika-puska",
	"item.minecraft.skull_pottery_sherd": "Garezur zeramika-puska",
	...
	"item.minecraft.smithing_template.applies_to": "Non jar daiteke:",
	...
	"item.minecraft.sniffer_spawn_egg": "Sniffer sorgailu arrautza",
	"item.minecraft.snort_pottery_shard": "Usnagile zeramika-puska",
	"item.minecraft.snort_pottery_sherd": "Usnagile zeramika-puska",
	...
	"item.minecraft.splash_potion": "Edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.awkward": "Edabe misteriotsu jaurtigarria",
	"item.minecraft.splash_potion.effect.empty": "Edabe ezezagun jaurtigarria",
	...
	"item.minecraft.splash_potion.effect.infested": "Infestazioko edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.invisibility": "Ikusezintasuneko edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.leaping": "Jauzi egiteko edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.levitation": "Lebitazioko edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.luck": "Zortezko edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.mundane": "Edabe arrunt jaurtigarria",
	"item.minecraft.splash_potion.effect.night_vision": "Gaueko ikusmeneko edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.oozing": "Lohitzeko edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.poison": "Pozoitzeko edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.regeneration": "Birsorkuntzako edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.slow_falling": "Erorketa geldoko edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.slowness": "Geldotasuneko edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.strength": "Indartzeko edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.swiftness": "Azkartasuneko edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.thick": "Edabe mamitsu jaurtigarria",
	...
	"item.minecraft.splash_potion.effect.weakness": "Ahultzeko edabe jaurtigarria",
	"item.minecraft.splash_potion.effect.weaving": "Ehungintza astunaren edabe jautigarria",
	"item.minecraft.splash_potion.effect.wind_charged": "Haize-boladazko edabe jaurtigarria",
	...
	"item.minecraft.stone_spear": "Harrizko lantza",
	...
	"item.minecraft.sulfur_cube_bucket": "Sufre Kubo-Ontzia",
	"item.minecraft.sulfur_cube_spawn_egg": "Sufre-Kubo Sorgailu Arrautza",
	...
	"item.minecraft.tipped_arrow.effect.wind_charged": "Haize-boladazko gezia",
	...
	"item.minecraft.wind_charge": "Haize-zurrunbiloa",
	...
	"item.minecraft.wolf_armor": "Otso-armadura",
	"item.minecraft.wolf_spawn_egg": "Otso sortzaile arrautza",
	"item.minecraft.wooden_axe": "Egurrezko aizkora",
	"item.minecraft.wooden_hoe": "Egurrezko aitzurra",
	"item.minecraft.wooden_pickaxe": "Egurrezko pikotxa",
	"item.minecraft.wooden_shovel": "Egurrezko pala",
	"item.minecraft.wooden_spear": "Egurrezko lantza",
	"item.minecraft.wooden_sword": "Egurrezko ezpata",
	...
	"item.minecraft.zombie_nautilus_spawn_egg": "Zonbi-nautilus sortzaile arrautza",
	...
	"item.modifiers.any": "Ekipatzean:",
	"item.modifiers.armor": "Jantzita:",
	"item.modifiers.body": "Ekipatzean:",
	"item.modifiers.chest": "Bularrean:",
	"item.modifiers.feet": "Oinetan:",
	"item.modifiers.hand": "Eskuan:",
	...
	"item.modifiers.saddle": "Zaltokia daramanean:",
	...
	"item.spawn_egg.peaceful": "Baketsuan desgaituta",
	...
	"key.categories.spectator": "Ikuslea",
	"key.categories.ui": "Jokoaren interfazea",
	"key.category.minecraft.creative": "Sortzaile modua",
	"key.category.minecraft.debug": "Arazketa",
	"key.category.minecraft.gameplay": "Jokoa",
	"key.category.minecraft.inventory": "Inbentarioa",
	"key.category.minecraft.misc": "Askotarikoak",
	"key.category.minecraft.movement": "Mugimendua",
	"key.category.minecraft.multiplayer": "Multijokalaria",
	"key.category.minecraft.spectator": "Ikuslea",
	"key.chat": "Txata ireki",
	"key.command": "Agintaritza ireki",
	"key.debug.clearChat": "Txata ezabatu",
	"key.debug.copyLocation": "Kokapena kopiatu",
	"key.debug.copyRecreateCommand": "Datuak kopiatu",
	"key.debug.crash": "Crash-a araztu",
	"key.debug.debugOptions": "Arazketa-ezarpenak",
	"key.debug.dumpDynamicTextures": "Testura dinamikoak isuri",
	"key.debug.dumpVersion": "Bertsio-informazioa isuri",
	"key.debug.focusPause": "Arreta galtzean pausa aldatu",
	"key.debug.fpsCharts": "FPS grafikoak",
	"key.debug.lightmapTexture": "Argi-mapa testura",
	"key.debug.modifier": "Arazketa-aldatzailearen tekla",
	"key.debug.networkCharts": "Sare-grafikoak",
	"key.debug.overlay": "Gainjartzea aldatu",
	"key.debug.profiling": "Profilaketa hasi/gelditu",
	"key.debug.profilingChart": "Profilaketa-grafikoa",
	"key.debug.reloadChunk": "Chunk guztiak birkargatu",
	"key.debug.reloadResourcePacks": "Baliabide-paketeak birkargatu",
	"key.debug.showAdvancedTooltips": "Tresna-iradokizun aurreratuak erakutsi",
	"key.debug.showChunkBorders": "Chunk mugak erakutsi",
	"key.debug.showHitboxes": "Talka-kutxak erakutsi",
	"key.debug.spectate": "Ikuslea txandakatu",
	"key.debug.switchGameMode": "Joko-modu aldatzailea",
	"key.drop": "Aukeratutako objektua bota",
	"key.forward": "Aurrera ibili",
	"key.friends": "Lagunen pantaila",
	...
	"key.keyboard.keypad.enter": "Sartu (zenbakizko teklatua)",
	...
	"key.quickActions": "Ekintza azkarrak",
	...
	"key.spectatorHotbar": "Sarbide-azkarrean hautatu",
	"key.spectatorOutlines": "Jokalariak nabarmendu",
	"key.sprint": "Korrika egin",
	"key.swapOffhand": "trukatu elementua eskuz",
	"key.toggleGui": "GUI aldatu",
	"key.togglePerspective": "Ikuspuntua aldatu",
	"key.toggleSpectatorShaderEffects": "Ikusle shader efektuak",
	...
	"known_server_link.feedback": "Iritziak",
	"known_server_link.forums": "Foroak",
	"known_server_link.news": "Berriak",
	"known_server_link.report_bug": "Zerbitzariaren akatsa salatu",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Zerbitzaria gehitu",
	"manageServer.edit.title": "Zerbitzariaren informazioa editatu",
	"manageServer.enterIp": "Zerbitzari-helbidea",
	"manageServer.enterName": "Zerbitzari-izena",
	"manageServer.resourcePack": "Zerbitzariaren baliabide-paketeak",
	"manageServer.resourcePack.disabled": "Desgaituta",
	"manageServer.resourcePack.enabled": "Gaituta",
	"manageServer.resourcePack.prompt": "Galdetu",
	...
	"mco.backup.entry.worldType.adventureMap": "Abentura mapa",
	"mco.backup.entry.worldType.experience": "Esperientzia",
	"mco.backup.entry.worldType.inspiration": "Inspirazioa",
	"mco.backup.entry.worldType.minigame": "Minijokoa",
	"mco.backup.entry.worldType.normal": "Normala",
	"mco.backup.entry.worldType.unknown": "Ezezaguna",
	...
	"mco.client.unsupported.snapshot.version": "Zure bezero-bertsioa (%s) ez da bateragarria Realms zerbitzuarekin.\n\nRealms ez dago erabilgarri froga-bertsio honetan.",
	"mco.compatibility.downgrade": "Bertsioa jaitsi",
	"mco.compatibility.downgrade.description": "Mundu hau azken aldiz %s bertsioan jokatu zen; zuk %s bertsioa duzu. Bertsio-jaitsierak mundua hondatzea eragin dezake - ezin dugu bermatu kargatuko denik edo ondo funtzionatuko duenik.\n\nZure munduaren babeskopia \"Munduaren babeskopiak\" karpetan gordeko da. Mesedez, berreskuratu zure mundua behar izanez gero.",
	"mco.compatibility.incompatible.popup.title": "Bertsio bateraezina",
	...
	"mco.compatibility.unverifiable.message": "Mundu hau azken aldiz jokatu zen bertsioa ezin izan da egiaztatu. Mundua eguneratzen edo bertsio-jaitsiera egiten bada, automatikoki sortuko da babeskopia bat eta \"Munduaren babeskopiak\" karpetan gordeko da.",
	...
	"mco.configure.world.backup": "Mundu babeskopiak",
	...
	"mco.configure.world.buttons.newworld": "Mundu berria",
	...
	"mco.configure.world.buttons.region_preference": "Aukeratu eskualdea...",
	"mco.configure.world.buttons.resetworld": "\"Realm\" berrezarri",
	"mco.configure.world.buttons.save": "Gorde",
	...
	"mco.configure.world.close.question.title": "Etenik gabe aldaketak egin behar dituzu?",
	...
	"mco.configure.world.loading": "Realma kargatzen",
	"mco.configure.world.location": "Kokalekua",
	"mco.configure.world.minigame": "Orain: %s",
	"mco.configure.world.name": "Realm izena",
	"mco.configure.world.name.validation.whitespace": "Ez da zuriunearekin hasi edo amaitu behar. Moztuko da.",
	"mco.configure.world.opening": "Realm irekitzen...",
	"mco.configure.world.players.error": "Ez dago emandako izena daukan jokalaririk",
	"mco.configure.world.players.invite.duplicate": "Sartutako izen berarekin jada jokalari bat Realmera gonbidatu da",
	"mco.configure.world.players.inviting": "Gonbidatzen jokalaria...",
	"mco.configure.world.players.title": "Jokalariak",
	"mco.configure.world.pvp": "PVP",
	"mco.configure.world.region_preference": "Eskualdeko hobespena",
	"mco.configure.world.region_preference.title": "Eskualdeko hobespenaren hautaketa",
	...
	"mco.configure.world.restore.download.question.line1": "Mundua jaitsi eta zure jokalari bakarreko liburutegira gehituko da.",
	...
	"mco.configure.world.settings.expired": "Ezin dituzu iraungitako Realm baten ezarpenak editatu",
	...
	"mco.configure.world.spawn_toggle.message": "Aukera hau itzaltzeak mota horretako entitate guztiak ezabatuko ditu",
	"mco.configure.world.spawn_toggle.message.npc": "Aukera hau itzaltzeak mota horretako entitate guztiak ezabatuko ditu, adibidez, herritarrak",
	...
	"mco.configure.world.subscription.remaining.months": "%[1]s hilabete",
	"mco.configure.world.subscription.remaining.months.days": "%[1]s hilabete, %[2]s egun",
	"mco.configure.world.subscription.start": "Hasiera data",
	"mco.configure.world.subscription.tab": "Harpidetza",
	...
	"mco.connect.failed": "Akats bat egon da Realmera konektatzean",
	"mco.connect.region": "Zerbitzariaren eskualdea: %s",
	"mco.connect.success": "Ados",
	"mco.create.world": "Sortu",
	"mco.create.world.error": "Izen bat sartu beharko duzu!",
	"mco.create.world.failed": "Akats bat egon da mundua sortzean!",
	...
	"mco.download.resourcePack.fail": "Akats bat egon da errekurtso-paketea deskargatzean!",
	...
	"mco.errorMessage.connectionFailure": "Akats bat gertatu da, saiatu geroago.",
	"mco.errorMessage.generic": "Akatsen bat gertatu da: ",
	"mco.errorMessage.initialize.failed": "Akats bat egon da Realma hastean",
	"mco.errorMessage.noDetails": "Ez da akatsaren xehetasunik eman",
	"mco.errorMessage.realmsService": "Akatsen bat gertatu da (%s):",
	"mco.errorMessage.realmsService.configurationError": "Ezusteko akats bat gertatu da munduaren aukerak editatzean",
	...
	"mco.invited.player.narration": "%s jokalaria gonbidatu da",
	...
	"mco.play.button.realm.closed": "Realma itxita dago",
	...
	"mco.snapshot.friendsRealm.downgrade": "Realm honetan sartzeko, %s bertsioan egon behar duzu",
	...
	"mco.upload.failed.too_big.description": "Hautatutako mundua handiegia da. Gehienezko tamaina %s da.",
	"mco.upload.failed.too_big.title": "Munduaren mugak handiegiak dira",
	...
	"menu.custom_options": "Aukera pertsonalizatuak...",
	"menu.custom_options.title": "Aukera pertsonalizatuak",
	"menu.custom_options.tooltip": "Oharra: Aukera pertsonalizatuak hirugarrenen zerbitzariek eta/edo edukiek eskaintzen dituzte.\nKontuz ibili!",
	"menu.custom_screen_info.button_narration": "Pantaila pertsonalizatu bat da hau. Gehiago jakin.",
	"menu.custom_screen_info.contents": "Pantaila honen edukiak hirugarrenen zerbitzariek eta mapek kontrolatzen dituzte, eta ez dira Mojang Studiosen edo Microsoften jabetzakoak, operatutakoak edo gainbegiratuak.\n\nKontuz ibili! Beti izan zuhur estekak jarraitzean eta ez eman inoiz zure informazio pertsonala, saio-hasierako xehetasunak barne.\n\nPantaila honek jokatzea eragozten badizu, beheko botoia erabiliz uneko zerbitzaritik deskonekta zaitezke.",
	"menu.custom_screen_info.disconnect": "Pantaila pertsonalizatua baztertuta",
	"menu.custom_screen_info.title": "Oharra pantaila pertsonalizatuei buruz",
	"menu.custom_screen_info.tooltip": "Pantaila pertsonalizatu bat da hau. Egin klik hemen gehiago jakiteko.",
	"menu.disconnect": "Deskonektatu",
	"menu.feedback": "Iritziak...",
	"menu.feedback.title": "Iritziak",
	"menu.game": "Joko menua",
	"menu.modded": " (modekin)",
	"menu.multiplayer": "Multijokalaria",
	"menu.multiplayerOptions.applyChanges": "Aplikatu aldaketak",
	"menu.multiplayerOptions.button": "Multijokalaria...",
	"menu.multiplayerOptions.network": "Multijokalaria",
	"menu.multiplayerOptions.network.header": "Sarea",
	"menu.multiplayerOptions.network.lan": "Sare lokala",
	"menu.multiplayerOptions.network.lan.tooltip": "Sare bereko jokalariak sar daitezke",
	"menu.multiplayerOptions.network.off": "Itzalita",
	"menu.multiplayerOptions.network.off.tooltip": "Inor ezin da sartu.",
	"menu.multiplayerOptions.network.online": "Linean",
	"menu.multiplayerOptions.network.online.tooltip": "Lagunak sar daitezke.",
	"menu.multiplayerOptions.otherPlayers.header": "Beste jokalariak",
	"menu.multiplayerOptions.publish.started.lan": "Mundu hau orain sare lokalean irekita dago. Ataka zenbakia hurrengoa da: %s",
	"menu.multiplayerOptions.publish.started.online": "Mundu hau orain multijokalarira irekita dago. Ataka zenbakia hurrengoa da: %s",
	"menu.multiplayerOptions.publish.stopped": "Mundu hau ez dago jada multijokalarira irekita",
	"menu.multiplayerOptions.title": "Multijokalari aukerak",
	...
	"menu.playerReporting.no_players": "Ez dago salatzeko jokalaririk mundu honetan",
	"menu.preparingSpawn": "Ateratzeko ingurunea prestatzen: %s%%",
	"menu.quick_actions": "Ekintza azkarrak...",
	"menu.quick_actions.title": "Ekintza azkarrak",
	...
	"menu.server_links": "Zerbitzariko estekak...",
	"menu.server_links.title": "Zerbitzariko estekak",
	...
	"multiplayer.codeOfConduct.check": "Ez jakinarazi berriro jokabide-kode honi buruz",
	"multiplayer.codeOfConduct.title": "Zerbitzariaren jokabide-kodea",
	"multiplayer.confirm_command.parse_errors": "Komando ezezagun edo baliogabe bat egikaritzen saiatzen ari zara.\nZiur zaude?\nKomandoa: %s",
	"multiplayer.confirm_command.permissions_required": "Baimen goratuak eskatzen dituen komando bat egikaritzen saiatzen ari zara.\nHorrek zure jokoari kalte egin diezaioke.\nZiur zaude? Komandoa: %s",
	"multiplayer.confirm_command.run_command": "Komandoa exekutatu",
	"multiplayer.confirm_command.signature_required": "Zure izena erabiliz txat-mezuak bidaliko dituen komando bat exekutatzen saiatzen ari zara.\nTxat-pantailatik soilik exekutatu daiteke\nKomandoa: %s",
	"multiplayer.confirm_command.suggest_command": "Kopiatu txat-pantailara",
	"multiplayer.confirm_command.title": "Komandoaren egikaritzea baieztatu",
	"multiplayer.disconnect.authservers_down": "Autentifikazio serbidoreak eroriak daude. Mesedez berriro sahiatu geroago, Barkatu!",
	"multiplayer.disconnect.bad_chat_index": "Zerbitzaritik bidalitako txat-mezu galdu edo berrordenatu bat antzeman da",
	...
	"multiplayer.disconnect.banned.reason.default": "Operadore batek blokeatua.",
	...
	"multiplayer.disconnect.code_of_conduct": "Zerbitzariaren jokabide-kodea onartu behar da",
	"multiplayer.disconnect.configuration_error": "Ustekabeko errorea konfiguratzean",
	...
	"multiplayer.disconnect.unverified_username": "Akats bat egon da izen egiaztatzean!",
	...
	"multiplayer.requiredTexturePrompt.disconnect": "Zerbitzari honek baliabide-pakete pertsonalizatu bat eskatzen du",
	...
	"multiplayer.status.anonymous_player": "Jokalari anonimoa",
	...
	"narration.button.usage.focused": "Sakatu \"Sartu\" aktibatzeko",
	"narration.button.usage.hovered": "Sakatu ezkerreko klika aktibatzeko",
	"narration.checkbox": "Kutxa: %s",
	"narration.checkbox.usage.focused": "Sakatu \"Sartu\" txandakatzeko",
	"narration.checkbox.usage.focused.check": "Markatzeko Enter sakatu",
	"narration.checkbox.usage.focused.uncheck": "Ez-markatzeko Enter sakatu",
	"narration.checkbox.usage.hovered": "Sakatu ezkerreko klika aldatzeko",
	"narration.checkbox.usage.hovered.check": "Markatzeko ezkerreko klika klikatu",
	"narration.checkbox.usage.hovered.uncheck": "Ez-markatzeko ezkerreko klika klikatu",
	"narration.component_list.usage": "Tab botoia sakatu hurrengo elementura joateko",
	"narration.cycle_button.usage.focused": "Sakatu \"Sartu\" %s(e)ra aldatzeko",
	"narration.cycle_button.usage.hovered": "Sakatu ezkerreko klika %s aldatzeko",
	"narration.edit_box": "Kutxa editatu: %s",
	"narration.item": "Objektua: %s",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Sakatu \"Sartu\" graduatzailearen balioa aldatzen hasteko",
	...
	"options.accessibility.tooltip": "Irisgarritasun ezarpenak",
	"options.allowCursorChanges": "Kurtsore aldaketak baimendu",
	"options.allowCursorChanges.tooltip": "Saguaren kurtsorea formaz aldatzea baimentzen du UI elementu jakin batzuen gainean dagoenean.",
	"options.allowFriendRequests": "Eskaerak onartu",
	...
	"options.chat.delay": "Txataren atzerapena: %s segundo",
	"options.chat.delay_none": "Atzerapena: Bat ere ez",
	"options.chat.drafts": "Bidali gabeko txatak gorde",
	"options.chat.drafts.tooltip": "Bidali gabeko txatak gordeko dira eta txata irekiko den hurrengo aldian bidaliak izan ahal dira.",
	...
	"options.chunkFade": "Chunken lausotze denbora",
	"options.chunkFade.none": "Chunken lausotzea: Ezer ez",
	"options.chunkFade.seconds": "Chunken lausotzea: %s segundo",
	"options.chunkFade.tooltip": "Zenbat denboraz (segundotan) sartu behar dira chunkak lehen aldiz kargatzean, baldin eta batere ez bada.",
	...
	"options.cutoutLeaves": "Hosto gardenak",
	"options.cutoutLeaves.tooltip": "Hostoen tarteen bidez ikustea ahalbidetzen du. Desaktibatzeak errendimendua hobetu dezake.",
	...
	"options.directionalAudio.on.tooltip": "HRTF-n oinarritutako noranzko audioa erabiltzen du 3D soinuaren simulazioa hobetzeko. HRTF-rekin bateragarria den audio-hardwarea behar du eta entzungailuekin da onena.",
	...
	"options.exclusiveFullscreen": "Pantaila osoa Esklusiboa",
	"options.exclusiveFullscreen.warningTooltip": "Aukera honek sarrera-metodo batzuk funtzionatzea eragotzi dezake.",
	...
	"options.friendsList": "Lagun-zerrenda",
	...
	"options.friendsList.confirm.title": "Lagun-zerrenda gaitu?",
	"options.friendsList.confirm.turnOff": "Desgaitu",
	"options.friendsList.confirm.turnOn": "Gaitu",
	...
	"options.graphics.custom": "Pertsonalizatua",
	...
	"options.graphics.preset": "Ereduak",
	"options.graphics.preset.tooltip": "\"Kalitatea eta errendimendua\" ezarpenak lehenetsi egokietara ezartzen ditu nahi den kalitatearen arabera.",
	...
	"options.graphicsApi": "Grafikoen APIa",
	"options.graphicsApi.default": "Lehenetsia",
	"options.graphicsApi.opengl": "Nahiago OpenGL",
	"options.graphicsApi.restart": "Grafikoen APIa aldatzeko, zure jokoa berrabiarazi behar duzu.",
	"options.graphicsApi.tooltip": "Zein grafiko rendering API erabili? Utzi balio lehenetsia, hau aldatzeko behar zehatzik ez baduzu! Eragina izango du partida abiarazten duzun hurrengoan.",
	"options.graphicsApi.tooltip.vulkan": "Experimental. Might reduce performance or cause instability on some systems.",
	"options.graphicsApi.vulkan": "Nahiago Vulkan",
	...
	"options.improvedTransparency": "Transparentzia hobetua",
	"options.improvedTransparency.tooltip": "Hurbilketa esperimentala, pantailako shader-ak erabiliz eguraldia, hodeiak eta partikula atzeko planoan marrazteko, bloke gardenak eta ura atzean. GPUaren errendimenduan eragina izango du.",
	...
	"options.invertMouseX": "Saguaren X alderantzikatu",
	"options.invertMouseY": "Saguaren Y alderantzikatu",
	...
	"options.language.narration": "Hizkuntza aldatu",
	"options.language.title": "Hizkuntza",
	"options.language.tooltip": "Hizkuntza aldatu",
	...
	"options.maxAnisotropy": "Iragazketa anisotropikoa",
	"options.maxAnisotropy.tooltip": "Testura leunak nola ikusten diren nabarmen hobetzen du, baina errendimendua eragiten du eta bideo-memoriaren erabileran nabarmen eragiten du. Ezin da hardware guztietan erabili.",
	...
	"options.musicToast": "Musika Izenburu",
	"options.musicToast.never": "Inoiz",
	"options.musicToast.never.tooltip": "Musika izenburu ez da bistaratzen",
	"options.musicToast.pauseMenu": "Pausatzeko Menua",
	"options.musicToast.pauseMenu.tooltip": "Bitartean musika jotzen da, \netengabe bistaratzen da musika izenburu pausatzeko menuan",
	"options.musicToast.pauseMenuAndToast": "Pausatzeko Menua eta Musika Izenburu",
	"options.musicToast.pauseMenuAndToast.tooltip": "Izenburu bat erakusten du abesti bat jotzen hasten denean. Izenburu bera etengabe agertzen da joko barruko pausa menuan abesti bat jotzen ari den bitartean.",
	"options.music_frequency": "Frekuenzia musikala",
	"options.music_frequency.constant": "Etengabe",
	"options.music_frequency.default": "Lehenetsia",
	"options.music_frequency.frequent": "Maiz",
	"options.music_frequency.tooltip": "Joko mundu batean musika zein maiztasunarekin jotzen den aldatzen du.",
	...
	"options.needsRestart": "Aukera berrabiarazi ondoren aplikatuko da.",
	...
	"options.realmsNotifications.tooltip": "Realms albisteak eta gonbidapenak eskuratzen ditu titulu-pantailan eta dagokien ikonoa bistaratzen du Realms botoian.",
	"options.reducedDebugInfo": "Debug info murriztua",
	"options.renderClouds": "Hodeiak",
	"options.renderCloudsDistance": "Hodei distantzia",
	...
	"options.screenEffectScale.tooltip": "Goragalearen indarra eta Nether atariaren pantaila distortsionatzeko efektuak.\nBalio beheragoetan, goragalearen efektua gainjarri orlegi batekin ordezkatzen da.",
	"options.sensitivity": "Sentsibilitatea",
	"options.sensitivity.max": "HYPERABIADURA!!!",
	"options.sensitivity.min": "*aharrausia*",
	"options.sharePresence": "Presentzia",
	"options.sharePresence.all": "Guztiak",
	...
	"options.sharePresence.limited": "Mugatua",
	"options.sharePresence.limited.tooltip": "Presentzia mugatua partekatzea. Sarean agertzea, baina egiten ari zarena ez partekatzen. Oraindik lagunak zure jolaserako gonbidatu ditzakezu.",
	"options.sharePresence.none": "Ezer ez",
	"options.sharePresence.none.tooltip": "Not sharing any presence. Appearing as offline.",
	"options.showNowPlayingToast": "Musika jakinarazpenak",
	"options.showNowPlayingToast.tooltip": "Abestia jotzen hasten denean jakinarazpena erakusten du. Abestia jotzen ari den bitartean, jakinarazpen berbera etengabe erakusten da joko barruko etenaldi-menuan.",
	"options.showSubtitles": "Azpitituluak",
	"options.showSubtitles.tooltip": "Jokoan jotzen diren soinuetarako azpitituluak gaitzen ditu.",
	...
	"options.sprintWindow": "Korrika tartea",
	"options.sprintWindow.tooltip": "Korrika tekla bi aldiz sakatzean korrika aktibatzeko denbora-tareta (ticketan).",
	...
	"options.textureFiltering": "Ehundura Iragazkia",
	"options.textureFiltering.anisotropic": "Anisotropikoa",
	"options.textureFiltering.anisotropic.tooltip": "Hardwarean oinarritutako iragazketa-metodo bat da, baina errendimenduan eta bideo-memoriaren erabileran eragina du nabarmen. Baliteke hardware guztietan ez onartzea.",
	"options.textureFiltering.none": "Bat ere ez",
	"options.textureFiltering.none.tooltip": "Ehundurak iragazkia gabe bistaratzen da. Blokeak lauso ager daitezke angelu batetik ikusita.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nItzalgailuetan oinarritutako iragazketa metodo bat, ehunduraren kalitatea hobetzen duena errendimenduan eragin moderatua izanik.",
	"options.title": "Aukerak",
	"options.touchscreen": "Ukipen-pantaila modua",
	"options.value": "%s",
	"options.video": "Bideo ezarpenak...",
	"options.video.display.header": "Pantaila",
	"options.video.interface.header": "Interfazea",
	"options.video.preferences.header": "Lehenespenak",
	"options.video.quality.header": "Kalitatea eta errendimendua",
	"options.videoTitle": "Bideo ezarpenak",
	"options.viewBobbing": "Kulunka",
	"options.vignette": "Bineta bistaratu",
	"options.vignette.tooltip": "Hau jokoaren pantailan aplikatzen den testura sotila da, pantailaren ertzetara distira murrizteko eta munduaren muga abisatzeko erabiltzen dena.",
	"options.visible": "Ikusgai",
	"options.vsync": "VSync",
	"options.weatherRadius": "Eguraldi efektuaren erradioa",
	"options.weatherRadius.tooltip": "Eremuaren erradioa non euria eta elurraren efektuak ikus daitezkeen. Errendimenduari eragin oso txikia.",
	"options.worldOptions.button": "Munduko Aukerak...",
	"options.worldOptions.title": "Munduko Aukerak",
	...
	"pack.copyFailure": "Akats bat egon da paketeak kopiatzean",
	...
	"pack.incompatible.confirm.new": "Baliabide-pakete hau Minecraft bertsio berriago baterako sortu zen eta agian ezingo du ondo ibili.",
	"pack.incompatible.confirm.old": "Baliabide-pakete hau Minecraft bertsio zaharrago baterako sortu zen eta agian ezingo du ondo ibili.",
	"pack.incompatible.confirm.title": "Ziur zaude pakete hau kargatu nahi duzula?",
	"pack.incompatible.confirm.unknown": "Baliabide-pakete hau apurtuta dago edo Minecraft bertsio ezezagun baterako sortu zen eta agian ezingo du ondo ibili.",
	...
	"pack.incompatible.unknown": "(Apurtuta edo bateraezina)",
	...
	"painting.minecraft.prairie_ride.title": "Zelaian ibilaldia",
	...
	"painting.minecraft.sunflowers.title": "Eguzki-loreak",
	...
	"quickplay.error.invalid_identifier": "Ezin izan da emandako identifikatzailearekin mundua aurkitu",
	"quickplay.error.realm_connect": "Ezin izan da Realmera konektatu",
	"quickplay.error.realm_permission": "Realm honetara konektatzeko baimena falta da",
	"quickplay.error.title": "Akats bat egon da partida azkarra abiaraztean",
	"realms.configuration.region.australia_east": "Hegoaldeko Gales Berria, Australia",
	...
	"realms.configuration.region.central_us": "Iowa, AEB",
	"realms.configuration.region.east_asia": "Hong Kong",
	"realms.configuration.region.east_us": "Virginia, AEB",
	"realms.configuration.region.east_us_2": "Ipar Carolina, AEB",
	"realms.configuration.region.france_central": "Frantzia",
	"realms.configuration.region.japan_east": "Ekialdetar Japonia",
	"realms.configuration.region.japan_west": "Mendebaldar Japonia",
	"realms.configuration.region.korea_central": "Hego Korea",
	"realms.configuration.region.north_central_us": "Illinois, AEB",
	"realms.configuration.region.north_europe": "Irlanda",
	"realms.configuration.region.south_central_us": "Texas, AEB",
	"realms.configuration.region.southeast_asia": "Singapur",
	"realms.configuration.region.sweden_central": "Suedia",
	"realms.configuration.region.uae_north": "Arabiar Emirerri Batuak",
	"realms.configuration.region.uk_south": "Hegotar Ingalaterra",
	"realms.configuration.region.west_central_us": "Utah, AEB",
	"realms.configuration.region.west_europe": "Herbehereak",
	"realms.configuration.region.west_us": "Kalifornia, AEB",
	"realms.configuration.region.west_us_2": "Washington, AEB",
	"realms.configuration.region_preference.automatic_owner": "Automatikoa (Realm jabearen ping-a)",
	"realms.configuration.region_preference.automatic_player": "Automatikoa (saioan lehenengoa sartzean)",
	...
	"recipe.toast.title": "Errezeta berria(k) desblokeatuta!",
	"record.nowPlaying": "Orain jolasten: %s",
	"recover_world.bug_tracker": "Akats bat salatu",
	"recover_world.button": "Saiatu berreskuratzen",
	"recover_world.done.failed": "Akats bat egon da aurreko egoera berreskuratzean.",
	...
	"recover_world.title": "Akats bat egon da mundua kargatzean",
	"recover_world.warning": "Akats bat egon da munduaren laburpena kargatzean",
	...
	"restrictions_screen.button": "Murrizketak...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Beste jokalarien mezuak jaso ditzakezu",
	"restrictions_screen.permission.receive_player_messages.denied": "Ezin dituzu beste jokalarien mezuak jaso",
	"restrictions_screen.permission.receive_system_messages.allowed": "Sistemaren mezuak zerbitzaritik jaso ditzakezu",
	"restrictions_screen.permission.receive_system_messages.denied": "Ezin dituzu sistemaren mezuak zerbitzaritik jaso",
	"restrictions_screen.permission.send_commands.allowed": "Komandoak bidali dezakezu",
	"restrictions_screen.permission.send_commands.denied": "Ezin dituzu komandoak bidali",
	"restrictions_screen.permission.send_messages.allowed": "Txat mezuak bidali dezakezu",
	"restrictions_screen.permission.send_messages.denied": "Ezin dituzu txat mezuak bidali",
	"restrictions_screen.title": "Murrizketak",
	...
	"selectWorld.access_failure": "Akats bat egon da munduan sartzean",
	...
	"selectWorld.backupQuestion.downgrade": "Ez da onartzen mundu baten bertsio-jaitsiera",
	"selectWorld.backupQuestion.experimental": "Ezarpen esperimentalak erabiltzen dituzten munduak ez dira bateragarriak",
	"selectWorld.backupQuestion.file_fixing_required": "Mundu hau eguneratu aurretik babeskopia bat sortu?",
	...
	"selectWorld.backupWarning.downgrade": "Mundu hau azken aldiz %s bertsioan jokatu zen; zuk %s bertsioa duzu. Bertsio-jaitsiera mundua hondatzea eragin dezake - ezin dugu bermatu kargatuko denik edo ondo funtzionatuko duenik. Jarraitu nahi baduzu, mesedez egin babeskopia bat.",
	...
	"selectWorld.backupWarning.file_fixing_required": "Mundu hau eguneratzea beharrezkoa da jolastu aurretik. Gomendatzen dizugu babeskopia bat egitea jarraitu baino lehen zure mundua kaltetzen bada.",
	...
	"selectWorld.commands": "Komandoak",
	...
	"selectWorld.delete_failure": "Akats bat egon da mundua ezabatzean",
	...
	"selectWorld.mapFeatures.info": "Herriak, itsasontzi hondoratuak, etab.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Mundu hau eguneratzea beharrezkoa da azken bertsiora editatu aurretik oinarrizko aldaketen bide mundu formatura.",
	"selectWorld.requiresFileFixingTooltip.play": "Mundu hau eguneratzea beharrezkoa da azken bertsiora jolastu aurretik oinarrizko aldaketen bide mundu formatura.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Mundu hau eguneratzea beharrezkoa da azken bertsiora bersortu aurretik oinarrizko aldaketen bide mundu formatura.",
	...
	"selectWorld.upgrade_and_play": "Eguneratu eta Jolastu",
	...
	"selectWorld.waitingForBackup.message": "Zure munduren tamaina nolakoa den, hau denbora pixka bat luze jo ahal du. Mesedez, ez itxi jokoa edo itzali zure gailua.",
	"selectWorld.waitingForBackup.title": "Babeskopia sortzen",
	...
	"selectWorld.warning.experimental.title": "Kontuz! Ezarpen hauek funtzio experimentalak erabiltzen ari dira",
	"selectWorld.warning.lowDiskSpace.description": "Ez dago leku askorik zure gailuan.\nJokoa martxan dagoen bitartean diskoko lekurik gabe gelditzeak zure mundua kaltetu dezake.",
	"selectWorld.warning.lowDiskSpace.title": "Kontuz! Diskoan leku gutxi geratzen da!",
	"selectWorld.world": "Mundua",
	"selectWorld.world_gen_settings_access": "Ezin da munduaren belaunaldiko ezarpenen fitxategia irakurri edo atzitu! %s",
	"selecteWorld.backupRequiredTooltip": "Mundua kargatzeko, lehenik babeskopia bat egin behar duzu",
	"sign.edit": "Editatu kartelaren mezua",
	"sleep.not_possible": "Ez dago jokalari nahiko gaua lo saltatzeko",
	"sleep.players_sleeping": "%s/%s jokalari lo egiten",
	"sleep.skipping_night": "Gaua lo igarotzen",
	"slot.only_single_allowed": "Espazio bakarrak izan daitezke: lortutakoa '%s'",
	"slot.unknown": "'%s' tarte ezezaguna",
	"snbt.parser.empty_key": "Gakoa ezin da hutsik egon",
	"snbt.parser.expected_binary_numeral": "Zenbaki bitar bat espero zen",
	"snbt.parser.expected_decimal_numeral": "Zenbaki hamartar bat espero zen",
	"snbt.parser.expected_float_type": "Koma mugikorreko zenbaki bat espero zen",
	"snbt.parser.expected_hex_escape": "%s luzerako karaktere-literal bat espero zen",
	"snbt.parser.expected_hex_numeral": "Zenbaki hamaseitar bat espero zen",
	"snbt.parser.expected_integer_type": "Zenbaki oso bat espero zen",
	"snbt.parser.expected_non_negative_number": "Zenbaki ez-negatibo bat espero zen",
	"snbt.parser.expected_number_or_boolean": "Zenbaki edo boolear bat espero zen",
	"snbt.parser.expected_string_uuid": "Baliozko UUID kate bat espero zen",
	"snbt.parser.expected_unquoted_string": "Komatxorik gabeko baliozko kate bat espero zen",
	"snbt.parser.infinity_not_allowed": "Zenbaki ez-mugatuak ez daude onartuta",
	"snbt.parser.invalid_array_element_type": "Baliogabeko zerrendako elementu mota",
	"snbt.parser.invalid_character_name": "Baliogabeko Unicode karaktere izena",
	"snbt.parser.invalid_codepoint": "Baliogabeko Unicode karaktere balioa: %s",
	"snbt.parser.invalid_string_contents": "Baliogabeko kate edukiak",
	"snbt.parser.invalid_unquoted_start": "Komatxorik gabeko kateak ezin dira 0-9, + edo - digituekin hasi",
	"snbt.parser.leading_zero_not_allowed": "Zenbaki hamartarrak ezin dira 0 digituarekin hasi",
	"snbt.parser.no_such_operation": "Operazioa ez da existitzen: %s",
	"snbt.parser.number_parse_failure": "Akats bat egon da %s zenbakia parseatzean",
	"snbt.parser.undescore_not_allowed": "Zenbaki baten hasierako edo amaierako gidoi baxuak ez daude baimenduta",
	"soundCategory.ambient": "Ingurunea",
	"soundCategory.block": "Blokeak",
	"soundCategory.hostile": "Etsai-izakiak",
	...
	"stat.minecraft.happy_ghast_one_cm": "Distantzia ghast alaiz",
	...
	"stat.minecraft.interact_with_lectern": "Atrilaren erabilerak",
	...
	"stat.minecraft.nautilus_one_cm": "Distantzia nautilus bidez",
	...
	"structure_block.mode_info.corner": "Ertz modua - Kokapena eta tamaina markatzailea",
	...
	"structure_block.strict": "Kokapen zehatza:",
	...
	"subtitles.block.amethyst_block.chime": "Ametista txintxin",
	"subtitles.block.amethyst_block.resonate": "Ametista durundatzen",
	...
	"subtitles.block.candle.extinguish": "Kandela itzaltzen",
	...
	"subtitles.block.copper_bulb.turn_off": "Kobrezko bonbilla amatatzen",
	"subtitles.block.copper_bulb.turn_on": "Kobrezko bonbilla pizten",
	"subtitles.block.copper_chest.close": "Kutxa ixten",
	"subtitles.block.copper_chest.open": "Kutxa irekitzen",
	...
	"subtitles.block.deadbush.idle": "Soinu lehorrak",
	...
	"subtitles.block.dried_ghast.ambient": "Ghast sikua arnasbehartzen",
	"subtitles.block.dried_ghast.ambient_water": "Ghast sikua berhidratatzen",
	"subtitles.block.dried_ghast.place_in_water": "Ghast sikua ura xurgatzen",
	"subtitles.block.dried_ghast.transition": "Ghast sikua bere onera etortzen",
	"subtitles.block.dry_grass.ambient": "Haizea txistukatzen",
	...
	"subtitles.block.pointed_dripstone.drip_lava": "Laba tantaka",
	"subtitles.block.pointed_dripstone.drip_lava_into_cauldron": "Laba galdarara tantakatzen",
	"subtitles.block.pointed_dripstone.drip_water": "Ura tantaka",
	"subtitles.block.pointed_dripstone.drip_water_into_cauldron": "Ura galdarara tantakatzen",
	"subtitles.block.pointed_dripstone.land": "Estalaktita erortzen",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Sufrezko geiserra erupzioa lehertzen",
	"subtitles.block.potent_sulfur.noxious_gas": "Gas kaltegarria agertzen",
	...
	"subtitles.block.sand.idle": "Soinu hareatsuak",
	"subtitles.block.sand.wind": "Haizea txistukatzen",
	...
	"subtitles.block.shelf.activate": "Apala aktibatzen",
	"subtitles.block.shelf.deactivate": "Apala desaktibatzen",
	"subtitles.block.shelf.multi_swap": "Objektuak aldatzen",
	"subtitles.block.shelf.place_item": "Objektua ipintzen",
	"subtitles.block.shelf.single_swap": "Objektua aldatzen",
	"subtitles.block.shelf.take_item": "Objektua hartuta",
	...
	"subtitles.block.sniffer_egg.crack": "Snifferren Arrautza apurtzen da",
	"subtitles.block.sniffer_egg.hatch": "Snifferren Arrautza eklosionatzen da",
	...
	"subtitles.block.trapdoor.close": "Tranpola ixten",
	"subtitles.block.trapdoor.open": "Tranpola irekitzen",
	...
	"subtitles.block.vault.activate": "Kupela pizten",
	"subtitles.block.vault.ambient": "Kupelaren kirrikak",
	"subtitles.block.vault.close_shutter": "Kupela ixten",
	"subtitles.block.vault.deactivate": "Kupela itzaltzen",
	"subtitles.block.vault.eject_item": "Kupela objektua kanporatzen",
	"subtitles.block.vault.insert_item": "Kupela desblokeatzen",
	"subtitles.block.vault.insert_item_fail": "Kupela elementua baztertzen",
	"subtitles.block.vault.open_shutter": "Kupela irekitzen",
	"subtitles.block.vault.reject_rewarded_player": "Kupela jokalaria ezeztatzen",
	"subtitles.block.water.ambient": "Ur emaria",
	"subtitles.block.wet_sponge.dries": "Belakia lehortzen",
	"subtitles.chiseled_bookshelf.insert": "Liburua sartzen",
	"subtitles.chiseled_bookshelf.insert_enchanted": "Sorgindutako sartzen",
	"subtitles.chiseled_bookshelf.take": "Liburua hartzen",
	"subtitles.chiseled_bookshelf.take_enchanted": "Sorgindutako hartzen",
	...
	"subtitles.entity.armadillo.ambient": "Armadiloa marmar egiten",
	"subtitles.entity.armadillo.brush": "Ezkata eskuilatzen",
	"subtitles.entity.armadillo.death": "Armadiloa hiltzen",
	"subtitles.entity.armadillo.eat": "Armadiloa jaten",
	"subtitles.entity.armadillo.hurt": "Armadiloa zauritzen",
	"subtitles.entity.armadillo.hurt_reduced": "Armadiloa bere burua babesten",
	"subtitles.entity.armadillo.land": "Armadiloa lurreratzen",
	"subtitles.entity.armadillo.peek": "Armadiloa begiratua egiten",
	"subtitles.entity.armadillo.roll": "Armadiloa kiribiltzen",
	"subtitles.entity.armadillo.scute_drop": "Armadiloaren ezkata erortzen",
	"subtitles.entity.armadillo.unroll_finish": "Armadiloa hedatzen",
	"subtitles.entity.armadillo.unroll_start": "Armadiloa begiratua egiten",
	...
	"subtitles.entity.baby_cat.ambient": "Katutxoa miau egiten",
	"subtitles.entity.baby_cat.beg_for_food": "Katutxoa erregutzen",
	"subtitles.entity.baby_cat.death": "Katutxoa hiltzen",
	"subtitles.entity.baby_cat.eat": "Katutxoa jaten",
	"subtitles.entity.baby_cat.hiss": "Katutxoa siseatzen",
	"subtitles.entity.baby_cat.hurt": "Katutxoa min hartzen",
	"subtitles.entity.baby_cat.purr": "Katutxoa urruma egiten",
	"subtitles.entity.baby_chicken.ambient": "Txita txio egiten",
	"subtitles.entity.baby_chicken.death": "Txita hiltzen",
	"subtitles.entity.baby_chicken.hurts": "Txita min hartzen",
	"subtitles.entity.baby_horse.ambient": "Potroa irrintzi egiten",
	"subtitles.entity.baby_horse.angry": "Potroa irrintzi egiten",
	"subtitles.entity.baby_horse.breathe": "Potroa arnasatzen",
	"subtitles.entity.baby_horse.death": "Potroa hiltzen",
	"subtitles.entity.baby_horse.eat": "Potroa jaten",
	"subtitles.entity.baby_horse.hurt": "Potroa min hartzen",
	"subtitles.entity.baby_horse.land": "Moxal lurrak",
	"subtitles.entity.baby_nautilus.ambient": "Nautilus txikia kirrink egiten",
	"subtitles.entity.baby_nautilus.ambient_land": "Nautilus txikia kirrink egiten",
	"subtitles.entity.baby_nautilus.death": "Nautilus txikia hiltzen",
	"subtitles.entity.baby_nautilus.death_land": "Nautilus txikia hiltzen",
	"subtitles.entity.baby_nautilus.eat": "Nautilus txikia jaten",
	"subtitles.entity.baby_nautilus.hurt": "Nautilus txikia zauritzen",
	"subtitles.entity.baby_nautilus.hurt_land": "Nautilus txikia zauritzen",
	"subtitles.entity.baby_nautilus.swim": "Nautilus txikia igeri egiten",
	"subtitles.entity.baby_pig.ambient": "Txerri Haurra oink egiten",
	"subtitles.entity.baby_pig.death": "Txerri Haurra hiltzen",
	"subtitles.entity.baby_pig.eat": "Txerri Haurra min hartzen",
	"subtitles.entity.baby_pig.hurt": "Txerri Haurra min hartzen",
	"subtitles.entity.baby_wolf.ambient": "Txakurkume zaunka egiten",
	"subtitles.entity.baby_wolf.death": "Txakurkume hiltzen",
	"subtitles.entity.baby_wolf.growl": "Txakurkume orrokatzen",
	"subtitles.entity.baby_wolf.hurt": "Txakurkume min hartzen",
	"subtitles.entity.baby_wolf.pant": "Txakurkume arin-arin arnastzen",
	"subtitles.entity.baby_wolf.whine": "Txakurkume kexu egiten",
	...
	"subtitles.entity.breeze.wind_burst": "Haize-zurrunbiloa lehertzen",
	"subtitles.entity.camel.ambient": "Gamelua marmarka",
	"subtitles.entity.camel.dash": "Gamelua oldartzen",
	"subtitles.entity.camel.dash_ready": "Gamelua berreskuratzen",
	"subtitles.entity.camel.death": "Gamelua hiltzen",
	"subtitles.entity.camel.eat": "Gamelua jaten",
	"subtitles.entity.camel.hurt": "Gamelua zauritzen",
	"subtitles.entity.camel.saddle": "Jarlekua jarrita",
	"subtitles.entity.camel.sit": "Gamelua esertzen",
	"subtitles.entity.camel.stand": "Gamelua altxatzen",
	"subtitles.entity.camel.step": "Gamelua ibiltzen",
	"subtitles.entity.camel.step_sand": "Gamelua harean",
	"subtitles.entity.camel_husk.ambient": "Gamelu momifikatua kurrinkatzen",
	"subtitles.entity.camel_husk.dash": "Gamelu momifikatua oldartzen",
	"subtitles.entity.camel_husk.dash_ready": "Gamelu momifikatua berreskuratzen",
	"subtitles.entity.camel_husk.death": "Gamelu momifikatua hiltzen",
	"subtitles.entity.camel_husk.eat": "Gamelu momifikatua jaten",
	"subtitles.entity.camel_husk.hurt": "Gamelu momifikatua zauritzen",
	"subtitles.entity.camel_husk.saddle": "Jarlekua jarrita",
	"subtitles.entity.camel_husk.sit": "Gamelu momifikatua esertzen",
	"subtitles.entity.camel_husk.stand": "Gamelu momifikatua altxatzen",
	...
	"subtitles.entity.copper_golem.death": "Kobrezko golema hiltzen",
	"subtitles.entity.copper_golem.hurt": "Kobrezko golema zauritzen",
	"subtitles.entity.copper_golem.item_drop": "Kobrezko golema objektu bat jartzen",
	"subtitles.entity.copper_golem.item_no_drop": "Kobrezko golema objektu bat jarri ezinik",
	"subtitles.entity.copper_golem.no_item_get": "Kobrezko golema objektu bat hartzen",
	"subtitles.entity.copper_golem.no_item_no_get": "Kobrezko golema objektu bat hartu ezinik",
	"subtitles.entity.copper_golem.spawn": "Kobrezko golema agertzen",
	"subtitles.entity.copper_golem.spin": "Kobrezko golema burua biratzen",
	"subtitles.entity.copper_golem_become_statue": "Kobrezko golema petrifikatuta",
	"subtitles.entity.copper_golem_oxidized.death": "Kobrezko golema hiltzen",
	"subtitles.entity.copper_golem_oxidized.hurt": "Kobrezko golema zauritzen",
	"subtitles.entity.copper_golem_oxidized.spin": "Kobrezko golema burua biratzen",
	"subtitles.entity.copper_golem_weathered.death": "Kobrezko golema hiltzen",
	"subtitles.entity.copper_golem_weathered.hurt": "Kobrezko golema zauritzen",
	"subtitles.entity.copper_golem_weathered.spin": "Kobrezko golema burua biratzen",
	...
	"subtitles.entity.donkey.jump": "Astoa jauzian",
	...
	"subtitles.entity.ender_eye.launch": "Ender begia jaurtitzen",
	"subtitles.entity.ender_pearl.throw": "Amaierako Perla Hegan",
	"subtitles.entity.enderman.ambient": "Enderman-a murmurikatzen",
	"subtitles.entity.enderman.death": "Enderman-a hiltzen",
	"subtitles.entity.enderman.hurt": "Enderman-a zauritzen",
	"subtitles.entity.enderman.scream": "Enderman-a garrasika",
	"subtitles.entity.enderman.stare": "Enderman-a garrasika",
	"subtitles.entity.enderman.teleport": "Enderman-a telegarraiatzen",
	...
	"subtitles.entity.fox.teleport": "Azeria telegarraiatzen",
	...
	"subtitles.entity.generic.big_fall": "Zerbait erortzen",
	...
	"subtitles.entity.generic.wind_burst": "Haize-zurrunbiloa lehertzen",
	"subtitles.entity.ghast.ambient": "Ghast negar egiten",
	"subtitles.entity.ghast.death": "Ghast hiltzen",
	"subtitles.entity.ghast.hurt": "Ghast zauritzen",
	"subtitles.entity.ghast.shoot": "Ghast tiro egiten",
	"subtitles.entity.ghastling.ambient": "Ghastxoa xaramelatzen",
	"subtitles.entity.ghastling.death": "Ghastxoa hiltzen",
	"subtitles.entity.ghastling.hurt": "Ghastxoa min hartzen",
	"subtitles.entity.ghastling.spawn": "Ghastxoa agertzen",
	...
	"subtitles.entity.goat.eat": "Ahuntza jaten",
	"subtitles.entity.goat.horn_break": "Ahuntzaren adarra apurtzen da",
	"subtitles.entity.goat.hurt": "Ahuntza zauritzen",
	...
	"subtitles.entity.happy_ghast.ambient": "Ghast alaia marmarka",
	"subtitles.entity.happy_ghast.death": "Ghast alaia hiltzen",
	"subtitles.entity.happy_ghast.equip": "Arnesa jarrita",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Ghast alaia prest",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Ghast alaia gelditzen",
	"subtitles.entity.happy_ghast.hurt": "Ghast alaia min hartzen",
	"subtitles.entity.happy_ghast.unequip": "Arnesa kenduta",
	...
	"subtitles.entity.horse.saddle": "Zaltokia jarrita",
	...
	"subtitles.entity.mooshroom.convert": "Mooshroom eraldatzen",
	"subtitles.entity.mooshroom.eat": "Mooshroom jaten",
	"subtitles.entity.mooshroom.milk": "Mooshroom jezten",
	"subtitles.entity.mooshroom.suspicious_milk": "Mooshroom susmo txarrez jezten",
	...
	"subtitles.entity.mule.jump": "Mandoa jauzian",
	"subtitles.entity.nautilus.ambient": "Nautilus klask egiten",
	"subtitles.entity.nautilus.ambient_land": "Nautilus klask egiten",
	"subtitles.entity.nautilus.dash": "Nautilus abiada hartzen",
	"subtitles.entity.nautilus.dash_land": "Nautilus abiada hartzen",
	"subtitles.entity.nautilus.dash_ready": "Nautilus berreskuratzen",
	"subtitles.entity.nautilus.dash_ready_land": "Nautilus berreskuratzen",
	"subtitles.entity.nautilus.death": "Nautilus hiltzen",
	"subtitles.entity.nautilus.death_land": "Nautilus hiltzen",
	"subtitles.entity.nautilus.eat": "Nautilus jaten",
	"subtitles.entity.nautilus.hurt": "Nautilus zauritzen",
	"subtitles.entity.nautilus.hurt_land": "Nautilus zauritzen",
	"subtitles.entity.nautilus.swim": "Nautilus igeri egiten",
	...
	"subtitles.entity.parched.ambient": "Idorrekoa triki-traka egiten",
	"subtitles.entity.parched.death": "Idorrekoa hiltzen",
	"subtitles.entity.parched.hurt": "Idorrekoa zauritzen",
	...
	"subtitles.entity.parrot.imitate.camel_husk": "Loroa gamelu momifikatua imitatzen",
	...
	"subtitles.entity.parrot.imitate.ghast": "Loroa ghast imitatzen",
	...
	"subtitles.entity.parrot.imitate.parched": "Loroa idorrekoa imitatzen",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Loroa piglina imitatzen",
	...
	"subtitles.entity.parrot.imitate.wither_skeleton": "Loroa triki-traka",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Loroa zonbi-zaldia imitatzen",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Loroa zonbi-nautilusa imitatzen",
	...
	"subtitles.entity.pig.eat": "Txerria jaten",
	"subtitles.entity.pig.hurt": "Txerria zauritzen",
	"subtitles.entity.pig.saddle": "Zaltokia jarrita",
	...
	"subtitles.entity.player.attack.sweep": "Ekorketa erasoa",
	...
	"subtitles.entity.player.freeze_hurt": "Jokalaria izozten",
	...
	"subtitles.entity.player.teleport": "Jokalaria telegarraiatzen",
	...
	"subtitles.entity.potion.splash": "Botila hausten",
	"subtitles.entity.potion.throw": "Botila jaurtitzen",
	...
	"subtitles.entity.shulker.teleport": "Shulkerra telegarraiatzen",
	...
	"subtitles.entity.sniffer.death": "Usnagilea hiltzen",
	"subtitles.entity.sniffer.digging": "Usnagilea lurra aitzurtzen",
	"subtitles.entity.sniffer.digging_stop": "Sniffer zutik jaikitzen da",
	"subtitles.entity.sniffer.drop_seed": "Sniffer hazia erortzen uzten du",
	"subtitles.entity.sniffer.eat": "Sniffer jaten",
	"subtitles.entity.sniffer.egg_crack": "Sniffer Arrautza apurtzen da",
	"subtitles.entity.sniffer.egg_hatch": "Snifferren Arrautza eklosionatzen da",
	"subtitles.entity.sniffer.happy": "Sniffer atsegin hartzen du",
	"subtitles.entity.sniffer.hurt": "Sniffer zauritzen",
	"subtitles.entity.sniffer.idle": "Sniffer kurrunkatzen du",
	"subtitles.entity.sniffer.scenting": "Sniffer usaina ematen du",
	"subtitles.entity.sniffer.searching": "Sniffer bilatzen du",
	"subtitles.entity.sniffer.sniffing": "Sniffer usnatzen du",
	"subtitles.entity.sniffer.step": "Snifferren urratsak",
	...
	"subtitles.entity.sulfur_cube.absorb": "Sufre Kubo beteta",
	"subtitles.entity.sulfur_cube.bounce": "Sufre Kubo errebote egiten",
	"subtitles.entity.sulfur_cube.death": "Sufre Kubo hiltzen",
	"subtitles.entity.sulfur_cube.eject": "Blokea kenduta",
	"subtitles.entity.sulfur_cube.hit": "Sufre Kubo jo",
	"subtitles.entity.sulfur_cube.hurt": "Sufrezko kuboa zauritzen",
	"subtitles.entity.sulfur_cube.push": "Sufre Kubo bultzatuta",
	"subtitles.entity.sulfur_cube.squish": "Sufre Kubo errebote egiten",
	...
	"subtitles.entity.turtle.hurt_baby": "Dortoka-kumea min hartzen",
	...
	"subtitles.entity.wandering_trader.drink_potion": "Saltzaile ibiltariak edabea edaten",
	...
	"subtitles.entity.warden.heartbeat": "Wardenren bihotza taupa egiten du",
	...
	"subtitles.entity.wind_charge.throw": "Haize-zurrunbiloa hegan egiten",
	"subtitles.entity.wind_charge.wind_burst": "Haize-zurrunbiloa lehertzen",
	...
	"subtitles.entity.wither_skeleton.ambient": "Wither eskeletoa triki-traka",
	...
	"subtitles.entity.wolf.ambient": "Otsoa arnasestuka",
	"subtitles.entity.wolf.bark": "Otsoa zaunka",
	"subtitles.entity.wolf.death": "Otso hilketa",
	"subtitles.entity.wolf.growl": "Otsoak marmarka egiten du",
	"subtitles.entity.wolf.hurt": "Otsoa zauritzen",
	"subtitles.entity.wolf.pant": "Otsoa hatsankatzen",
	"subtitles.entity.wolf.shake": "Otsoak astindu egiten du",
	"subtitles.entity.wolf.whine": "Otsoa kexatzen",
	...
	"subtitles.entity.zombie.break_wooden_door": "Atea apurtuta",
	...
	"subtitles.entity.zombie_horse.angry": "Zonbi-zaldia irrintzi egiten",
	"subtitles.entity.zombie_horse.death": "Zonbi-zaldia hiltzen",
	"subtitles.entity.zombie_horse.eat": "Zonbi-zaldia jaten",
	"subtitles.entity.zombie_horse.hurt": "Zonbi-zaldia zauritzen",
	"subtitles.entity.zombie_nautilus.ambient": "Zonbi-nautilus burbuilak egiten",
	"subtitles.entity.zombie_nautilus.ambient_land": "Zonbi-nautilus burbuilak egiten",
	"subtitles.entity.zombie_nautilus.dash": "Zonbi-nautilus abiada hartzen",
	"subtitles.entity.zombie_nautilus.dash_land": "Zonbi-nautilus abiada hartzen",
	"subtitles.entity.zombie_nautilus.dash_ready": "Zonbi-nautilus berreskuratzen",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Zonbi-nautilus berreskuratzen",
	"subtitles.entity.zombie_nautilus.death": "Zonbi-nautilus hiltzen",
	"subtitles.entity.zombie_nautilus.death_land": "Zonbi-nautilus hiltzen",
	"subtitles.entity.zombie_nautilus.eat": "Zonbi-nautilus jaten",
	"subtitles.entity.zombie_nautilus.hurt": "Zonbi-nautilus zauritzen",
	"subtitles.entity.zombie_nautilus.hurt_land": "Zonbi-nautilus zauritzen",
	"subtitles.entity.zombie_nautilus.swim": "Zonbi-nautilus igeri egiten",
	...
	"subtitles.item.armor.equip_chain": "Kotazko armadura tintinka",
	"subtitles.item.armor.equip_copper": "Kobrezko armadura klonk egiten",
	"subtitles.item.armor.equip_diamond": "Diamantezko armadura kiliski-kalaska",
	"subtitles.item.armor.equip_elytra": "Elitroa farfar",
	"subtitles.item.armor.equip_gold": "Urrezko armadura klinka",
	"subtitles.item.armor.equip_iron": "Burdinazko armadura kiliski-kalaska",
	"subtitles.item.armor.equip_leather": "Larruzko armadura farfarka",
	"subtitles.item.armor.equip_nautilus": "Nautilus-armadura jarrita",
	...
	"subtitles.item.armor.equip_wolf": "Otsoaren armadura lotzen",
	"subtitles.item.armor.unequip_nautilus": "Nautilus-armadura kenduta",
	"subtitles.item.armor.unequip_wolf": "Otsoaren armadura askatzen",
	...
	"subtitles.item.bone_meal.use": "Hezur hautsa hautseztatzen",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Sufrezko kuboa bilduta",
	...
	"subtitles.item.chorus_fruit.teleport": "Jokalaria telegarraiatzen",
	...
	"subtitles.item.dye.use": "Tindagaia erabiltzen",
	...
	"subtitles.item.glow_ink_sac.use": "Tinta zaku distiratsua zikintzen",
	"subtitles.item.goat_horn.play": "Ahuntz adarra jotzen",
	"subtitles.item.golden_dandelion.unuse": "Urrezko txikoria denbora zahartzen",
	"subtitles.item.golden_dandelion.use": "Urrezko txikoria denbora gelditzen",
	...
	"subtitles.item.horse_armor.unequip": "Zaldi-armadura askatuta",
	"subtitles.item.ink_sac.use": "Tinta zakua zikintzen",
	"subtitles.item.lead.break": "Soka apurtuta",
	"subtitles.item.lead.tied": "Soka lotuta",
	"subtitles.item.lead.untied": "Soka askatuta",
	"subtitles.item.llama_carpet.unequip": "Alfonbra askatuta",
	"subtitles.item.lodestone_compass.lock": "Magnetita iparrorratzak magnetitara finkatzen da",
	"subtitles.item.mace.smash_air": "Mailua haizea birrintzen",
	"subtitles.item.mace.smash_ground": "Mailua lurra birrintzen",
	"subtitles.item.nautilus_saddle_equip": "Jarlekua jarrita",
	"subtitles.item.nautilus_saddle_underwater_equip": "Jarlekua jarrita",
	"subtitles.item.nether_wart.plant": "Garatxo landua",
	"subtitles.item.ominous_bottle.dispose": "Botila apurtzen",
	"subtitles.item.saddle.unequip": "Zaltokia askatuta",
	"subtitles.item.shears.shear": "Artazien karraska",
	"subtitles.item.shears.snip": "Artaziak ebakitzen",
	"subtitles.item.shield.block": "Ezkutuarekin blokeoa",
	"subtitles.item.shovel.flatten": "Pala zorua lautzen",
	"subtitles.item.spear.attack": "Lantza kolpekatzen",
	"subtitles.item.spear.hit": "Lartza jotzen",
	"subtitles.item.spear.lunge": "Lantza lerratzen",
	"subtitles.item.spear.use": "Lantza kargatzen",
	"subtitles.item.spear_wood.attack": "Lantza kolpekatzen",
	"subtitles.item.spear_wood.hit": "Lantza jotzen",
	"subtitles.item.spear_wood.use": "Lantza kargatzen",
	"subtitles.item.spyglass.stop_using": "Kataloxa ixten",
	"subtitles.item.spyglass.use": "Kataloxa zabaltzen",
	...
	"subtitles.item.underwater_saddle.equip": "Jarlekua jarrita",
	"subtitles.item.wolf_armor.break": "Otso-armadura apurtzen",
	"subtitles.item.wolf_armor.crack": "Otso-armadura kraskatzen",
	"subtitles.item.wolf_armor.damage": "Otso-armadura kaltetzen",
	"subtitles.item.wolf_armor.repair": "Otso-armadura konponduta",
	...
	"subtitles.weather.end_flash": "Endeko distira durundaka",
	...
	"telemetry.event.graphics_capabilities.description": "Gertaera honek jokoa jolastean erabilitako grafikoko gailuaren ahalmenak jakinarazten dizkigu.",
	"telemetry.event.graphics_capabilities.title": "Gaitasun grafikoak",
	...
	"telemetry.property.backend_failure_message.title": "Errore-mezua backenda sortzean",
	"telemetry.property.backend_failure_missing_capabilities.title": "Errorea backenda sortzean, gaitasun faltagatik",
	"telemetry.property.backend_failure_reason.title": "Errore-arrazoia backenda sortzean",
	"telemetry.property.backend_name.title": "Backend izena",
	...
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Urruneko hautagai mota",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Seinalatze konexio-denbora (milisegundoak)",
	"telemetry.property.p2p_connection_successful.title": "Konexio arrakastatsua",
	"telemetry.property.p2p_connection_total_time_ms.title": "Konexio denbora guztira (milisegundoak)",
	...
	"test.error.block_property_mismatch": "%s propietatea %s izatea espero zen: %s zen",
	"test.error.block_property_missing": "Bloke-propietatea falta da. %s propietatea %s izatea espero zen",
	"test.error.entity_property": "%s entitateak proba gainditu du: %s",
	"test.error.entity_property_details": "%s entitateak huts egin du proban: %s. %s espero zen: %s zen",
	"test.error.expected_block": "%s blokea espero zen: %s jaso da",
	"test.error.expected_block_present": "%s blokea egon behar zen",
	"test.error.expected_block_tag": "#%s-n blokea espero zen: %s jaso da",
	"test.error.expected_container_contents": "Edukiontziak honakoa eduki beharko luke: %s",
	"test.error.expected_container_contents_single": "Edukiontziak bakar batek eduki beharko luke: %s",
	"test.error.expected_empty_container": "Ontzia hutsik egon behar da",
	"test.error.expected_entity": "%s espero zen",
	"test.error.expected_entity_around": "%s(e)k %s, %s, %s inguruan existitzea espero zen",
	"test.error.expected_entity_count": "%s entitate mota %s espero ziren: %s aurkitu dira",
	"test.error.expected_entity_data": "Entitate datuak %s izatea espero zen: %s zeuden",
	"test.error.expected_entity_data_predicate": "Entitate datuen desadostasuna %s(e) rako",
	"test.error.expected_entity_effect": "%s(e)k %s %s efektua izatea espero zen",
	"test.error.expected_entity_having": "Entitatearen inbentarioak %s eduki beharko luke",
	"test.error.expected_entity_holding": "Entitateak %s eutsi beharko luke",
	"test.error.expected_entity_in_test": "%s proban existitzea espero zen",
	"test.error.expected_entity_not_touching": "Ez zen %s espero %s, %s, %s ukitzen (erlazionatua: %s, %s, %s)",
	"test.error.expected_entity_touching": "%s espero zen %s, %s, %s ukitzen (erlazionatua: %s, %s, %s)",
	"test.error.expected_item": "%s motako elementua espero zen",
	"test.error.expected_items_count": "%s %s motako elementu espero ziren: %s aurkitu dira",
	"test.error.fail": "Huts egiteko baldintzak bete dira",
	"test.error.invalid_block_type": "Ustekabeko bloke mota aurkitu da: %s",
	"test.error.missing_block_entity": "Bloke entitatea falta da",
	"test.error.not_a_block_item": "Emandakoa blokea ez da blokea elementu bat",
	"test.error.position": "%s %s, %s, %s kokapenan (erlazionatua: %s, %s, %s) %s tickean",
	"test.error.sequence.condition_already_triggered": "Baldintza %s(e)n dagoeneko aktibatuta dago",
	"test.error.sequence.condition_not_triggered": "Baldintza ez da aktibatu",
	"test.error.sequence.invalid_tick": "Erloju tick baliogabean arrakastatsua: %s espero zen",
	"test.error.sequence.minimum_tick": "Espero baino lehen arrakasta izan du: %s itxaron behar izatea espero da",
	"test.error.sequence.not_completed": "Proban denbora-muga gainditu da sekuentzia amaitu aurretik",
	"test.error.set_biome": "Akats bat egon da probatzeko biomak ezartzean",
	"test.error.spawn_failure": "Akats bat egon da %s entitatea sortzean",
	"test.error.state_not_equal": "Egoera okerra, %s espero zen, %s izan da",
	"test.error.structure.failure": "Akats bat egon da %s proba-egitura jartzean",
	"test.error.tick": "%s %s tickean",
	"test.error.ticking_without_structure": "Proba exekutatu egitura jarri aurretik",
	"test.error.timeout.no_result": "Ez zen emaitzarik izan %s ticketan\n\n",
	"test.error.timeout.no_sequences_finished": "Sekuentziarik ez da amaitu %s ticketan",
	"test.error.too_many_entities": "%s bakar bat espero zen %s, %s, %s inguruan, baina %s aurkitu dira",
	"test.error.unexpected_block": "Blokea %s izatea ez zen espero",
	"test.error.unexpected_entity": "%s existitzea ez zen espero",
	"test.error.unexpected_item": "%s motako objektua ez zen espero",
	"test.error.unknown": "Barne-akats ezezaguna: %s",
	"test.error.value_not_equal": "%s %s izatea espero zen, %s izan da",
	"test.error.value_not_in_between": "%s %s eta %s artean egotea espero zen: %s zen",
	"test.error.wrong_block_entity": "Bloke entitate mota okerra: %s",
	"test_block.error.missing": "Test-egituraren %s blokea falta da",
	"test_block.error.too_many": "%s bloke gehiegi",
	"test_block.invalid_timeout": "Denbora-muga baliogabea (%s) - tick kopuru positibo bat izan behar da",
	...
	"test_block.mode_info.accept": "Onartu modua - Proba baten (zati baten) arrakasta onartu",
	"test_block.mode_info.fail": "Huts modua - Proba huts egin",
	"test_block.mode_info.log": "Erregistro modua - Erregistratu mezu bat",
	"test_block.mode_info.start": "Hasiera modua - Proba baten abiapuntua",
	"test_instance.action.reset": "Berrezarri eta kargatu",
	"test_instance.action.run": "Kargatu eta exekutatu",
	"test_instance.action.save": "Gorde egitura",
	"test_instance.description.batch": "Ingurunea: %s",
	...
	"test_instance.description.structure": "Egitura: %s",
	"test_instance.description.type": "Mota: %s",
	"test_instance.type.block_based": "Bloke proba",
	"test_instance.type.function": "Funtzio-proba integratua",
	"test_instance_block.entities": "Entitateak:",
	"test_instance_block.error.no_test": "Ezin da %s, %s, %s kokapenean proba instantzia exekutatu, proba definitu gabea baitu",
	"test_instance_block.error.no_test_structure": "Ezin da %s, %s, %s kokapenean proba instantzia exekutatu, ez baitu proba-egiturarik",
	"test_instance_block.error.unable_to_save": "Ezin da proba-egituraren txantiloia gorde %s, %s, %s kokapeneko proba instantziarentzat",
	"test_instance_block.invalid": "[okerra]",
	"test_instance_block.reset_success": "%s probaren berrezarpena ongi burutu da",
	"test_instance_block.rotation": "Errotazioa:",
	"test_instance_block.size": "Probaren tamaina",
	"test_instance_block.starting": "%s froga hasten",
	...
	"title.multiplayer.online": "Multijokalaria (linean)",
	...
	"upgradeWorld.aborted.message": "Hau gertatu ahal da beste programa bat sartu ba den munduan eguneratzen zegoen momentuan. Berrabiaraztea eta berriz saiatzea lagundu ahal du. Arazoa jarraitzen badu, mesedez akatsaren txosten bat sortu eta jakinarazi.",
	"upgradeWorld.aborted.reportBug": "Akatsa Salatu",
	"upgradeWorld.aborted.title": "Akats bat egon da mundua eguneratzean",
	"upgradeWorld.canceled.message": "Zure mundua lehen bezala jarraitzen du.",
	"upgradeWorld.canceled.title": "Munduko eguneratu bertan behera utzi da",
	"upgradeWorld.done": "Mundu Eguneratzea Amaitu da",
	"upgradeWorld.failed_cleanup.message": "Mundua arrakastaz eguneratu da uneko bertsiora eta orain mundu-zerrendan dago eskuragarri.\nArazoak izan ditugu datu zaharkituak garbitzean, beraz mundu-karpetaren izena %s-ra aldatu da.",
	"upgradeWorld.failed_cleanup.title": "Mundua ongi eguneratu egin da",
	"upgradeWorld.info.converted": "Eguneratua: %s",
	"upgradeWorld.info.file_fix_stage": "Etapa: %s/%s",
	"upgradeWorld.info.scanning": "Fitxategiak eskaneatzen...",
	"upgradeWorld.info.total": "Guztira: %s",
	"upgradeWorld.joinNow": "Mundua batean sartu nahi al duzu orain?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Fitxategiak mugitzen",
	"upgradeWorld.progress.type.legacy_structures": "Egitura zaharrak eguneratzen",
	"upgradeWorld.progress.type.region": "Eskualdeak eguneratzea",
	"upgradeWorld.symlink.message": "Aukeratutako mundua lotura sinbolikoak ditu. Pausu beharrezkoak mundua azkeneko bertsiora eguneratzeko ez dute lotura sinbolikoak lagatzen. Mundua eguneratzeko, loturak kendu behar dira lehenengo.",
	"upgradeWorld.symlink.title": "Ezin da mundu eguneratu",
	"upgradeWorld.title": "Munduko Fitxategiak Eguneratzen",
}
