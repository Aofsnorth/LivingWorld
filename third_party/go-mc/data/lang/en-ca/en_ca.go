// Code generated by tools/gen_lang.go from 26.1/en_ca.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Make a Decorated Pot out of four Pottery Sherds",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Set foot in a Trial Chamber",
	...
	"advancements.adventure.spear_many_mobs.title": "Mob Kebab",
	...
	"advancements.husbandry.silk_touch_nest.description": "Move a Bee Nest or Beehive, with three Bees inside, using Silk Touch",
	...
	"block.minecraft.oxidized_chiseled_copper": "Oxidized Chiselled Copper",
	...
	"block.minecraft.waxed_oxidized_chiseled_copper": "Waxed Oxidized Chiselled Copper",
	...
	"commands.worldborder.set.grow": "Growing the world border to %s blocks wide over %s second(s)",
	...
	"debug.options.warning": "These options are for testing purposes only. They may slow down your computer, crash the game, or provoke nearby house hippos.",
	...
	"item.minecraft.smithing_template.netherite_upgrade.base_slot_description": "Add diamond armour, weapon or tool",
	...
	"mco.configure.world.settings.expired": "You cannot edit the settings of an expired Realm",
	...
	"narration.selection.usage": "Press the up and down keyboard buttons to move to another entry",
	...
	"narration.suggestion.usage.cycle.hidable": "Press Tab to cycle to the next suggestion, or press Escape to leave suggestions",
	...
	"subtitles.block.frogspawn.hatch": "Tadpoles hatch",
	...
	"subtitles.entity.turtle.egg_hatch": "Baby Turtle hatches",
	...
	"subtitles.item.brush.brushing.gravel.complete": "Brushing Gravel completes",
	"subtitles.item.brush.brushing.sand": "Brushing Sand",
	"subtitles.item.brush.brushing.sand.complete": "Brushing Sand completes",
