// Code generated by tools/gen_lang.go from 26.1/it_it.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"accessibility.onboarding.accessibility.button.narration": "Impostazioni di accessibilità",
	...
	"addServer.resourcePack.prompt": "Chiedi",
	...
	"advMode.notEnabled": "I blocchi comandi sono disattivati",
	"advMode.notEnabled.spawner": "I generatori sono disattivati",
	"advMode.previousOutput": "Esito precedente",
	"advMode.setCommand": "Assegna un comando al blocco",
	"advMode.setCommand.disabled": "Comando impostato: %s (i blocchi comandi sono ancora disattivati)",
	...
	"advancements.adventure.brush_armadillo.title": "Gli armadilli hanno gli strati",
	...
	"advancements.adventure.shoot_arrow.description": "Colpisci una creatura con una freccia",
	...
	"advancements.adventure.spear_many_mobs.description": "Colpisci cinque creature con una lancia nello stesso attacco caricato",
	"advancements.adventure.spear_many_mobs.title": "Lo spiedo scoppiettando",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Forgiando con stile",
	...
	"advancements.adventure.under_lock_and_key.description": "Apri una cassaforte con una chiave della sfida",
	...
	"advancements.adventure.whos_the_pillager_now.title": "Chi è il predone adesso?",
	...
	"advancements.end.levitate.title": "Che bella vista da quassù!",
	...
	"advancements.husbandry.feed_snifflet.description": "Nutri un fiutatorello",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Rimuovi con le cesoie l'armatura da un lupo",
	...
	"advancements.husbandry.uh_oh.description": "Fai assorbire un blocco di TNT a un cubo di zolfo",
	"advancements.husbandry.uh_oh.title": "Come vola via una bomba",
	...
	"advancements.story.shiny_gear.description": "Un'armatura di diamante può salvarti la vita",
	...
	"argument.integer.big": "Il numero intero non deve essere maggiore di %s (ricevuto: %s)",
	"argument.integer.low": "Il numero intero non deve essere minore di %s (ricevuto: %s)",
	...
	"argument.resource_or_id.failed_to_parse": "Analisi della struttura non riuscita: %s",
	"argument.resource_or_id.invalid": "ID o tag non valido",
	"argument.resource_or_id.no_such_element": "Impossibile trovare l'elemento «%s» nel registro «%s»",
	...
	"argument.time.invalid_tick_count": "Il numero di tick non può essere negativo",
	"argument.time.invalid_unit": "Unità non valida",
	"argument.time.tick_count_too_low": "Il numero di tick non deve essere minore di %s (ricevuto: %s)",
	...
	"attribute.name.air_drag_modifier": "Modificatore di resistenza aerodinamica",
	...
	"attribute.name.below_name_distance": "Distanza del punteggio nella targhetta",
	...
	"attribute.name.bounciness": "Elasticità",
	...
	"attribute.name.friction_modifier": "Modificatore di attrito",
	...
	"attribute.name.nameplate_distance": "Distanza della targhetta",
	...
	"biome.minecraft.sulfur_caves": "Caverne di zolfo",
	...
	"block.minecraft.acacia_shelf": "Scaffale di acacia",
	...
	"block.minecraft.bamboo_shelf": "Scaffale di bambù",
	...
	"block.minecraft.banner.square_bottom_right.light_gray": "Cantone sinistro della punta grigio chiaro",
	...
	"block.minecraft.bedrock": "Roccia di fondo",
	...
	"block.minecraft.birch_shelf": "Scaffale di betulla",
	...
	"block.minecraft.cherry_shelf": "Scaffale di ciliegio",
	...
	"block.minecraft.chiseled_cinnabar": "Cinabro cesellato",
	...
	"block.minecraft.chiseled_sulfur": "Zolfo cesellato",
	...
	"block.minecraft.cinnabar_brick_slab": "Lastra di mattoni di cinabro",
	"block.minecraft.cinnabar_brick_stairs": "Scalini di mattoni di cinabro",
	"block.minecraft.cinnabar_brick_wall": "Muretto di mattoni di cinabro",
	"block.minecraft.cinnabar_bricks": "Mattoni di cinabro",
	"block.minecraft.cinnabar_slab": "Lastra di cinabro",
	"block.minecraft.cinnabar_stairs": "Scalini di cinabro",
	"block.minecraft.cinnabar_wall": "Muretto di cinabro",
	...
	"block.minecraft.copper_bars": "Sbarre di rame",
	"block.minecraft.copper_block": "Blocco di rame",
	"block.minecraft.copper_bulb": "Lampada di rame",
	"block.minecraft.copper_chain": "Catena di rame",
	"block.minecraft.copper_chest": "Baule di rame",
	"block.minecraft.copper_door": "Porta di rame",
	"block.minecraft.copper_golem_statue": "Statua di golem di rame",
	"block.minecraft.copper_grate": "Grata di rame",
	"block.minecraft.copper_lantern": "Lanterna di rame",
	"block.minecraft.copper_ore": "Minerale di rame",
	"block.minecraft.copper_torch": "Torcia di rame",
	"block.minecraft.copper_trapdoor": "Botola di rame",
	"block.minecraft.copper_wall_torch": "Torcia di rame a parete",
	...
	"block.minecraft.crimson_shelf": "Scaffale cremisi",
	...
	"block.minecraft.dark_oak_shelf": "Scaffale di quercia scura",
	...
	"block.minecraft.exposed_copper_bars": "Sbarre di rame esposto",
	"block.minecraft.exposed_copper_bulb": "Lampada di rame esposto",
	"block.minecraft.exposed_copper_chain": "Catena di rame esposto",
	"block.minecraft.exposed_copper_chest": "Baule di rame esposto",
	"block.minecraft.exposed_copper_door": "Porta di rame esposto",
	"block.minecraft.exposed_copper_golem_statue": "Statua di golem di rame esposto",
	"block.minecraft.exposed_copper_grate": "Grata di rame esposto",
	"block.minecraft.exposed_copper_lantern": "Lanterna di rame esposto",
	...
	"block.minecraft.exposed_lightning_rod": "Parafulmine esposto",
	...
	"block.minecraft.golden_dandelion": "Dente di leone d'oro",
	...
	"block.minecraft.iron_chain": "Catena di ferro",
	...
	"block.minecraft.jungle_shelf": "Scaffale della giungla",
	...
	"block.minecraft.mangrove_shelf": "Scaffale di mangrovia",
	...
	"block.minecraft.oak_shelf": "Scaffale di quercia",
	...
	"block.minecraft.oxidized_copper_bars": "Sbarre di rame ossidato",
	"block.minecraft.oxidized_copper_bulb": "Lampada di rame ossidato",
	"block.minecraft.oxidized_copper_chain": "Catena di rame ossidato",
	"block.minecraft.oxidized_copper_chest": "Baule di rame ossidato",
	"block.minecraft.oxidized_copper_door": "Porta di rame ossidato",
	"block.minecraft.oxidized_copper_golem_statue": "Statua di golem di rame ossidato",
	"block.minecraft.oxidized_copper_grate": "Grata di rame ossidato",
	"block.minecraft.oxidized_copper_lantern": "Lanterna di rame ossidato",
	...
	"block.minecraft.oxidized_lightning_rod": "Parafulmine ossidato",
	...
	"block.minecraft.pale_oak_shelf": "Scaffale di quercia pallida",
	...
	"block.minecraft.polished_blackstone_pressure_plate": "Pedana a pressione di pietranera levigata",
	...
	"block.minecraft.polished_cinnabar": "Cinabro levigato",
	"block.minecraft.polished_cinnabar_slab": "Lastra di cinabro levigato",
	"block.minecraft.polished_cinnabar_stairs": "Scalini di cinabro levigato",
	"block.minecraft.polished_cinnabar_wall": "Muretto di cinabro levigato",
	...
	"block.minecraft.polished_sulfur": "Zolfo levigato",
	"block.minecraft.polished_sulfur_slab": "Lastra di zolfo levigato",
	"block.minecraft.polished_sulfur_stairs": "Scalini di zolfo levigato",
	"block.minecraft.polished_sulfur_wall": "Muretto di zolfo levigato",
	...
	"block.minecraft.potent_sulfur": "Zolfo concentrato",
	...
	"block.minecraft.potted_golden_dandelion": "Vaso con dente di leone d'oro",
	...
	"block.minecraft.spruce_shelf": "Scaffale di abete",
	...
	"block.minecraft.sulfur": "Zolfo",
	"block.minecraft.sulfur_brick_slab": "Lastra di mattoni di zolfo",
	"block.minecraft.sulfur_brick_stairs": "Scalini di mattoni di zolfo",
	"block.minecraft.sulfur_brick_wall": "Muretto di mattoni di zolfo",
	"block.minecraft.sulfur_bricks": "Mattoni di zolfo",
	"block.minecraft.sulfur_slab": "Lastra di zolfo",
	"block.minecraft.sulfur_spike": "Spuntone di zolfo",
	"block.minecraft.sulfur_stairs": "Scalini di zolfo",
	"block.minecraft.sulfur_wall": "Muretto di zolfo",
	...
	"block.minecraft.warped_shelf": "Scaffale distorto",
	...
	"block.minecraft.waxed_copper_bars": "Sbarre di rame cerato",
	"block.minecraft.waxed_copper_block": "Blocco di rame cerato",
	"block.minecraft.waxed_copper_bulb": "Lampada di rame cerato",
	"block.minecraft.waxed_copper_chain": "Catena di rame cerato",
	"block.minecraft.waxed_copper_chest": "Baule di rame cerato",
	"block.minecraft.waxed_copper_door": "Porta di rame cerato",
	"block.minecraft.waxed_copper_golem_statue": "Statua di golem di rame cerato",
	"block.minecraft.waxed_copper_grate": "Grata di rame cerato",
	"block.minecraft.waxed_copper_lantern": "Lanterna di rame cerato",
	...
	"block.minecraft.waxed_exposed_copper_bars": "Sbarre di rame esposto cerato",
	"block.minecraft.waxed_exposed_copper_bulb": "Lampada di rame esposto cerato",
	"block.minecraft.waxed_exposed_copper_chain": "Catena di rame esposto cerato",
	"block.minecraft.waxed_exposed_copper_chest": "Baule di rame esposto cerato",
	"block.minecraft.waxed_exposed_copper_door": "Porta di rame esposto cerato",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Statua di golem di rame esposto cerato",
	"block.minecraft.waxed_exposed_copper_grate": "Grata di rame esposto cerato",
	"block.minecraft.waxed_exposed_copper_lantern": "Lanterna di rame esposto cerato",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Parafulmine esposto cerato",
	"block.minecraft.waxed_lightning_rod": "Parafulmine cerato",
	...
	"block.minecraft.waxed_oxidized_copper_bars": "Sbarre di rame ossidato cerato",
	"block.minecraft.waxed_oxidized_copper_bulb": "Lampada di rame ossidato cerato",
	"block.minecraft.waxed_oxidized_copper_chain": "Catena di rame ossidato cerato",
	"block.minecraft.waxed_oxidized_copper_chest": "Baule di rame ossidato cerato",
	"block.minecraft.waxed_oxidized_copper_door": "Porta di rame ossidato cerato",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Statua di golem di rame ossidato cerato",
	"block.minecraft.waxed_oxidized_copper_grate": "Grata di rame ossidato cerato",
	"block.minecraft.waxed_oxidized_copper_lantern": "Lanterna di rame ossidato cerato",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Parafulmine ossidato cerato",
	...
	"block.minecraft.waxed_weathered_copper_bars": "Sbarre di rame corroso cerato",
	"block.minecraft.waxed_weathered_copper_bulb": "Lampada di rame corroso cerato",
	"block.minecraft.waxed_weathered_copper_chain": "Catena di rame corroso cerato",
	"block.minecraft.waxed_weathered_copper_chest": "Baule di rame corroso cerato",
	"block.minecraft.waxed_weathered_copper_door": "Porta di rame corroso cerato",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Statua di golem di rame corroso cerato",
	"block.minecraft.waxed_weathered_copper_grate": "Grata di rame corroso cerato",
	"block.minecraft.waxed_weathered_copper_lantern": "Lanterna di rame corroso cerato",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Parafulmine corroso cerato",
	"block.minecraft.weathered_chiseled_copper": "Rame cesellato corroso",
	"block.minecraft.weathered_copper": "Rame corroso",
	"block.minecraft.weathered_copper_bars": "Sbarre di rame corroso",
	"block.minecraft.weathered_copper_bulb": "Lampada di rame corroso",
	"block.minecraft.weathered_copper_chain": "Catena di rame corroso",
	"block.minecraft.weathered_copper_chest": "Baule di rame corroso",
	"block.minecraft.weathered_copper_door": "Porta di rame corroso",
	"block.minecraft.weathered_copper_golem_statue": "Statua di golem di rame corroso",
	"block.minecraft.weathered_copper_grate": "Grata di rame corroso",
	"block.minecraft.weathered_copper_lantern": "Lanterna di rame corroso",
	...
	"block.minecraft.weathered_lightning_rod": "Parafulmine corroso",
	...
	"book.edit.title": "Finestra di modifica del libro",
	...
	"book.page_button.next": "Pagina successiva",
	"book.page_button.previous": "Pagina precedente",
	"book.sign.title": "Finestra della firma del libro",
	"book.sign.titlebox": "Titolo",
	"book.signButton": "Firma",
	"book.view.title": "Finestra di lettura del libro",
	"build.spawn_protection": "%s è sotto la protezione della zona iniziale",
	"build.tooHigh": "Altezza massima di costruzione: %s",
	"build.tooLow": "Altezza minima di costruzione: %s",
	"chat.cannotSend": "Impossibile inviare il messaggio in chat",
	"chat.coordinates": "%s, %s, %s",
	"chat.coordinates.tooltip": "Clicca per teletrasportarti",
	"chat.copy": "Copia negli appunti",
	"chat.copy.click": "Clicca per copiare negli appunti",
	...
	"chat.disabled.profile": "Chat disattivata nelle impostazioni dell'account. Premi di nuovo «%s» per ulteriori informazioni.",
	...
	"chat.link.warning": "Mai aprire collegamenti di persone di cui non ti fidi!",
	"chat.queue": "[+%s in attesa]",
	"chat.queue.tooltip": "Clicca per mostrare il prossimo messaggio",
	...
	"chat_restriction.chat_and_commands_disabled_by_options": "La chat è limitata nelle opzioni del client.",
	"chat_restriction.chat_disabled_by_options": "La chat tra giocatori è limitata nelle opzioni del client.",
	"chat_restriction.chat_disabled_by_options.action": "Vai alle impostazioni della chat",
	"chat_restriction.disabled_by_launcher": "La chat è limitata dal launcher.",
	"chat_restriction.disabled_by_profile": "La chat è limitata dalle impostazioni del profilo.",
	"chat_restriction.disabled_by_profile.action": "Vai alle impostazioni del profilo",
	"chat_screen.commands_not_allowed": "L'invio di comandi non è consentito",
	"chat_screen.message": "Messaggio da inviare: %s",
	"chat_screen.messages_not_allowed": "L'invio di messaggi in chat non è consentito",
	"chat_screen.restricted": "La chat è limitata. Clicca su questo messaggio per più dettagli.",
	"chat_screen.restricted.narration": "La chat è limitata. Vai alla finestra delle limitazioni nelle opzioni del mondo.",
	"chat_screen.title": "Schermata della chat",
	"chat_screen.usage": "Scrivi un messaggio e premi Invio per inviarlo",
	"chunk.toast.checkLog": "Controlla il registro per ulteriori dettagli",
	"chunk.toast.loadFailure": "Caricamento del chunk in %s non riuscito",
	...
	"chunk.toast.saveFailure": "Salvataggio del chunk in %s non riuscito",
	...
	"command.trailing_data": "Rilevati dati in coda: %s",
	...
	"commands.bossbar.create.failed": "Esiste già una barra boss con l'ID «%s»",
	...
	"commands.bossbar.get.players.none": "Nessun giocatore associato alla barra boss %s è in linea",
	"commands.bossbar.get.players.some": "La barra boss %s ha al momento %s giocatore/i in linea: %[3]s",
	...
	"commands.bossbar.unknown": "Non esiste alcuna barra boss con l'ID «%s»",
	...
	"commands.data.block.invalid": "Il blocco di destinazione non è un blocco complesso",
	...
	"commands.datapack.create.invalid_full_name": "Nome del nuovo pacchetto non valido: «%s»",
	"commands.datapack.create.invalid_name": "Caratteri non validi nel nome del nuovo pacchetto: «%s»",
	"commands.datapack.create.io_failure": "Impossibile creare un pacchetto con il nome «%s». Controlla i registri",
	"commands.datapack.create.metadata_encode_failure": "Codifica dei metadati non riuscita per il pacchetto «%s»: %s",
	...
	"commands.debug.function.traceFailed": "Tracciamento della funzione non riuscito",
	...
	"commands.dialog.clear.multiple": "I dialoghi per %s giocatori sono stati cancellati",
	"commands.dialog.clear.single": "I dialoghi per %s sono stati cancellati",
	"commands.dialog.show.multiple": "Dialogo mostrato a %s giocatori",
	"commands.dialog.show.single": "Dialogo mostrato a %s",
	"commands.difficulty.failure": "Nessun cambiamento: la difficoltà è già impostata su «%s»",
	"commands.difficulty.query": "La difficoltà attuale è «%s»",
	"commands.difficulty.success": "La difficoltà è stata stata cambiata: %s",
	...
	"commands.execute.function.instantiationFailure": "Creazione di un'istanza della funzione %s non riuscita: %s",
	...
	"commands.fetchprofile.copy_component": "Copia il componente",
	"commands.fetchprofile.copy_text": "Copia %s",
	"commands.fetchprofile.entity.success": "Profilo risolto per l'entità «%s»: %s",
	"commands.fetchprofile.failed_to_serialize": "Serializzazione del profilo non riuscita: %s",
	"commands.fetchprofile.give_item": "Ottieni la testa",
	"commands.fetchprofile.id.failure": "Risoluzione di un profilo per l'ID «%s» non riuscita",
	"commands.fetchprofile.id.success": "Profilo risolto per l'ID «%s»: %s",
	"commands.fetchprofile.name.failure": "Risoluzione di un profilo per il nome «%s» non riuscita",
	"commands.fetchprofile.name.success": "Profilo risolto per il nome «%s»: %s",
	"commands.fetchprofile.no_profile": "L'entità %s non ha un profilo",
	"commands.fetchprofile.summon_mannequin": "Evoca un manichino",
	...
	"commands.fillbiome.toobig": "Troppi blocchi nello spazio (massimo: %s, specificati: %s)",
	...
	"commands.function.error.argument_not_compound": "Tipo di argomento non valido: %s (previsto un valore composto)",
	...
	"commands.function.instantiationFailure": "Creazione di un'istanza della funzione %s non riuscita: %s",
	...
	"commands.gamerule.query": "La regola di gioco %s è attualmente impostata su «%s»",
	"commands.gamerule.set": "La regola di gioco %s è stata impostata su «%s»",
	...
	"commands.jfr.dump.failed": "Salvataggio della registrazione JFR non riuscito: %s",
	"commands.jfr.start.failed": "Avvio della profilatura JFR non riuscito",
	...
	"commands.kick.owner.failed": "Impossibile espellere il proprietario del server in una sessione locale",
	...
	"commands.list.players": "%s giocatore/i (su %s) sono attualmente in linea: %s",
	...
	"commands.perf.reportFailed": "Creazione del rapporto di debug non riuscita",
	"commands.perf.reportSaved": "Il rapporto di debug è stato creato in %s",
	...
	"commands.place.feature.failed": "Piazzamento della decorazione non riuscito",
	...
	"commands.place.jigsaw.invalid": "Non esiste un insieme di modelli di tipo «%s»",
	"commands.place.jigsaw.success": "Puzzle generato a %s, %s, %s",
	"commands.place.structure.failed": "Piazzamento della struttura non riuscito",
	...
	"commands.place.template.failed": "Piazzamento del modello non riuscito",
	...
	"commands.profile_fetch.copy_component": "Copia componente",
	"commands.profile_fetch.failed_to_serialize": "Serializzazione del profilo non riuscita: %s",
	"commands.profile_fetch.give_item": "Ottieni oggetto",
	"commands.profile_fetch.id.failure": "Risoluzione di un profilo per l'ID «%s» non riuscita",
	"commands.profile_fetch.id.success": "Profilo risolto per l'ID «%s»: %s",
	"commands.profile_fetch.name.failure": "Risoluzione di un profilo per il nome «%s» non riuscita",
	"commands.profile_fetch.name.success": "Profilo risolto per il nome «%s»: %s",
	"commands.publish.alreadyPublished": "La partita multigiocatore è già ospitata sulla porta %s",
	"commands.publish.alreadyPublished.lan": "La partita locale è già ospitata sulla porta %s",
	"commands.publish.alreadyPublished.online": "La partita in rete è già ospitata",
	...
	"commands.publish.started.lan": "La partita locale è ospitata sulla porta %s",
	"commands.publish.started.online": "La partita in rete è stata ospitata",
	...
	"commands.schedule.cleared.failure": "Nessun programma con l'ID %s",
	"commands.schedule.cleared.success": "Rimosso %s programma/i con l'ID %s",
	"commands.schedule.created.function": "La funzione «%s» verrà eseguita tra %s tick (tempo di gioco: %s)",
	"commands.schedule.created.tag": "Il tag «%s» verrà eseguito tra %s tick (tempo di gioco: %s)",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Attivato l'aggiornamento visuale automatico per l'obiettivo: %s",
	...
	"commands.setworldspawn.success.new": "Il punto di generazione globale è stato impostato in %s, %s, %s [%s, %s] nella dimensione %s",
	...
	"commands.spawnpoint.success.multiple.new": "Il punto di generazione di %[7]s giocatori è stato impostato in %[1]s, %[2]s, %[3]s [%[4]s, %[5]s] nella dimensione %[6]s",
	...
	"commands.spawnpoint.success.single.new": "Il punto di generazione di %[7]s è stato impostato in %[1]s, %[2]s, %[3]s [%[4]s, %[5]s] nella dimensione %[6]s",
	"commands.spectate.cannot_spectate": "Non puoi osservare da %s",
	...
	"commands.spreadplayers.failed.entities": "Impossibile distribuire %s entità intorno a %s, %s (troppe entità per l'area: prova a distribuire al massimo %s entità)",
	...
	"commands.spreadplayers.failed.teams": "Impossibile distribuire %s squadra/e intorno a %s, %s (troppe entità per l'area: prova a distribuire al massimo %s squadra/e)",
	"commands.spreadplayers.success.entities": "Distribuito %s entità intorno a %s, %s con una separazione media in blocchi pari a %s",
	"commands.spreadplayers.success.teams": "Distribuito %s squadra/e intorno a %s, %s con una separazione media in blocchi pari a %s",
	...
	"commands.stopwatch.already_exists": "Il cronometro «%s» esiste già",
	"commands.stopwatch.create.success": "Il cronometro «%s» è stato creato",
	"commands.stopwatch.does_not_exist": "Il cronometro «%s» non esiste",
	"commands.stopwatch.query": "Il cronometro «%s» segna %s s",
	"commands.stopwatch.remove.success": "Il cronometro «%s» è stato rimosso",
	"commands.stopwatch.restart.success": "Il cronometro «%s» è stato riavviato",
	"commands.summon.failed": "Impossibile evocare l'entità",
	"commands.summon.failed.peaceful": "Impossibile evocare mostri nella difficoltà pacifica",
	...
	"commands.swing.failed.notliving": "Nessun'entità vivente compatibile è stata trovata",
	"commands.swing.success.multiple": "%s entità hanno agitato un braccio",
	"commands.swing.success.single": "%s ha agitato un braccio",
	...
	"commands.team.option.collisionRule.success": "La regola di collisione per la squadra %s è stata impostata su «%s»",
	"commands.team.option.collisionRule.unchanged": "Nessun cambiamento: la regola di collisione è già impostata su questo valore",
	"commands.team.option.color.clear.success": "Il colore della squadra %s è stato cancellato",
	...
	"commands.team.option.deathMessageVisibility.success": "La visibilità dei messaggi di morte per la squadra %s è stata impostata su «%s»",
	...
	"commands.team.option.friendlyfire.disabled": "Disattivato il fuoco amico per la squadra %s",
	"commands.team.option.friendlyfire.enabled": "Attivato il fuoco amico per la squadra %s",
	...
	"commands.team.option.nametagVisibility.success": "La visibilità dei nomi dei giocatori per la squadra %s è stata impostata su «%s»",
	...
	"commands.test.clear.success": "Cancellato %s struttura/e",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Clicca per copiare negli appunti",
	...
	"commands.test.error.test_instance_not_found": "Impossibile trovare il blocco complesso di collaudo",
	"commands.test.error.test_instance_not_found.position": "Impossibile trovare il blocco complesso di collaudo presso %s, %s, %s",
	"commands.test.error.too_large": "Le dimensioni della struttura devono essere inferiori a %s blocchi su ogni asse",
	"commands.test.locate.done": "Localizzazione terminata. Strutture trovate: %s",
	...
	"commands.tick.rate.success": "Frequenza indicata impostata a %s tick al secondo",
	...
	"commands.time.no_default_clock": "Non c'è alcun orologio predefinito nella dimensione %s",
	"commands.time.no_time_marker_found": "Il marcatore temporale %s non esiste per l'orologio %s",
	"commands.time.pause": "Orologio in pausa: %s",
	"commands.time.query": "Tempo: %s tick",
	"commands.time.query.absolute": "L'orologio %s è a %s tick",
	"commands.time.query.gametime": "Il tempo di gioco è a %s tick",
	"commands.time.query.timeline": "La sequenza temporale %s è a %s tick",
	"commands.time.query.timeline.repetitions": "La sequenza temporale %s ha completato %s ripetizione/i",
	"commands.time.rate": "L'orologio %s ora scorre a velocità %s×",
	"commands.time.resume": "Orologio riattivato: %s",
	"commands.time.set": "Il tempo è stato impostato a %s tick",
	"commands.time.set.absolute": "%s è stato impostato a %s tick",
	"commands.time.set.time_marker": "%s è stato impostato al marcatore temporale %s",
	"commands.time.wrong_timeline_for_clock": "La sequenza temporale %s non è valida per l'orologio %s",
	...
	"commands.unpublish.notPublished": "Nessuna partita multigiocatore pubblicata",
	"commands.unpublish.success": "La partita multigiocatore non è più pubblicata",
	...
	"commands.waypoint.modify.style": "Lo stile del punto di riferimento è stato cambiato",
	...
	"component.profile.dynamic": "Dinamico",
	...
	"connect.p2p.establishing": "Stabilimento della connessione...",
	"connect.p2p.failed.generic": "Impossibile connettersi al giocatore",
	"connect.p2p.failed.signaling": "Non è possibile connettersi al momento.\nRiprova più tardi.",
	"connect.p2p.failed.timeout": "Richiesta di connessione scaduta",
	"connect.p2p.failed.unreachable": "Giocatore non raggiungibile",
	...
	"controls.keybinds.duplicateKeybinds": "Altre azioni per questo tasto:\n%s",
	...
	"createWorld.customize.buffet.search": "Cerca...",
	...
	"dataPack.locator_bar.description": "Mostra la posizione degli altri giocatori in multigiocatore",
	"dataPack.locator_bar.name": "Barra localizzatrice",
	...
	"dataPack.title": "Pacchetti di dati",
	...
	"datapackFailure.safeMode.failed.title": "Caricamento del mondo in modalità provvisoria non riuscito.",
	...
	"death.attack.spear": "%[1]s è stato/a infilzato/a da %[2]s",
	"death.attack.spear.item": "%[1]s è stato/a infilzato/a da %[2]s con %[3]s",
	...
	"death.attack.sulfurCubeHot": "%[1]s è morto/a perché qualcos'altro oltre al pavimento era lava",
	"death.attack.sulfurCubeHot.player": "%[2]s ha mostrato a %[1]s che qualcos'altro oltre al pavimento era lava",
	...
	"debug.advanced_tooltips.help": "F3 + H = Descrizioni avanzate",
	"debug.advanced_tooltips.off": "Descrizioni avanzate: nascoste",
	"debug.advanced_tooltips.on": "Descrizioni avanzate: visibili",
	...
	"debug.copy_location.help": "F3 + C = Copia la posizione come comando «/tp» o tienili premuti per 10 secondi per arrestare il gioco",
	...
	"debug.crash.message.rebindable": "Stai tenendo premuti %s + %s. Se non li rilasci, il gioco sarà arrestato.",
	"debug.crash.warning": "Arresto del gioco tra %s...",
	...
	"debug.entry.always": "Sì",
	"debug.entry.currently.alwaysOn": "%s: attualmente sempre visibile",
	"debug.entry.currently.inF3": "%s: attualmente visibile premendo F3",
	"debug.entry.currently.inOverlay": "%s: attualmente visibile nel cruscotto di debug",
	"debug.entry.currently.never": "%s: attualmente nascosta",
	"debug.entry.f3": "Con F3",
	"debug.entry.overlay": "Cruscotto",
	"debug.gamemodes.error": "Non hai il permesso di cambiare modalità di gioco",
	"debug.gamemodes.help": "F3 + F4 = Apri il selettore della modalità di gioco",
	...
	"debug.options.category.renderer": "Renderer di debug",
	"debug.options.category.text": "Informazioni di debug",
	"debug.options.help": "F3 + F6 = Modifica le opzioni di debug",
	"debug.options.notAllowed.tooltip": "Non visibile quando le informazioni di debug sono ridotte",
	"debug.options.profile.default": "Profilo predefinito",
	"debug.options.profile.performance": "Profilo prestazioni",
	"debug.options.search": "Cerca...",
	"debug.options.title": "Opzioni di debug",
	"debug.options.warning": "Queste opzioni sono disponibili a scopo di test. Potrebbero rallentare il tuo computer, far arrestare il gioco o rubarti la merenda appena ti distrai.",
	...
	"debug.profiling.start.rebindable": "Profilatura di %s secondi avviata. Premi %s + %s per interromperla in anticipo",
	...
	"debug.show_hitboxes.help": "F3 + B = Mostra le zone di collisione",
	"debug.show_hitboxes.off": "Zone di collisione: nascoste",
	"debug.show_hitboxes.on": "Zone di collisione: visibili",
	...
	"demo.day.1": "Questo mondo di prova durerà cinque giorni di gioco. Fai del tuo meglio!",
	...
	"demo.demoExpired": "Il tempo di prova è scaduto!",
	"demo.help.buy": "Acquista adesso!",
	"demo.help.fullWrapped": "Questo mondo di prova durerà cinque giorni di gioco (circa 1 ora e 40 minuti di tempo reale). Dai un'occhiata ai progressi per avere dei suggerimenti! Buon divertimento!",
	...
	"demo.help.title": "Prova gratuita di Minecraft",
	"demo.remainingTime": "Tempo restante: %s",
	"demo.reminder": "La prova gratuita è terminata. Acquista il gioco per continuare o crea un nuovo mondo!",
	...
	"difficulty.lock.title": "Blocco della difficoltà del mondo",
	...
	"disconnect.loginFailedInfo.userBanned": "Sei bannato/a dal gioco in rete",
	...
	"disconnect.unknownHost": "Indirizzo non trovato",
	"download.pack.failed": "Download di %s pacchetti su %s non riuscito",
	...
	"editGamerule.inGame.button": "Regole di gioco...",
	"editGamerule.inGame.disabled.tooltip": "Le regole di gioco possono essere cambiate solo dagli operatori.",
	"editGamerule.inGame.discardChanges.message": "Vuoi davvero annullare le modifiche in sospeso alle regole di gioco?",
	"editGamerule.inGame.discardChanges.title": "Regole di gioco",
	"editGamerule.inGame.downloadingGamerules": "Recupero delle regole di gioco...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Fiato del nautilo",
	"effect.minecraft.conduit_power": "Energia condotta",
	"effect.minecraft.darkness": "Oscurità",
	"effect.minecraft.dolphins_grace": "Grazia delfina",
	"effect.minecraft.fire_resistance": "Resistenza al fuoco",
	...
	"effect.minecraft.raid_omen": "Presagio incursivo",
	...
	"effect.minecraft.trial_omen": "Presagio sfidante",
	...
	"enchantment.minecraft.lunge": "Affondo",
	...
	"entity.minecraft.camel_husk": "Mummifario",
	...
	"entity.minecraft.copper_golem": "Golem di rame",
	...
	"entity.minecraft.husk": "Mummificato",
	...
	"entity.minecraft.mannequin": "Manichino",
	"entity.minecraft.mannequin.label": "PNG",
	...
	"entity.minecraft.parched": "Ossecco",
	...
	"entity.minecraft.sulfur_cube": "Cubo di zolfo",
	...
	"entity.minecraft.villager.fletcher": "Frecciaio",
	...
	"entity.minecraft.villager.nitwit": "Zuccone",
	"entity.minecraft.villager.none": "Villico",
	"entity.minecraft.villager.shepherd": "Pastore",
	"entity.minecraft.villager.toolsmith": "Ferraio",
	...
	"gameMode.adventure": "Avventura",
	"gameMode.changed": "La tua modalità di gioco è stata cambiata in %s",
	"gameMode.creative": "Creativa",
	"gameMode.hardcore": "Estrema",
	"gameMode.spectator": "Spettatore",
	"gameMode.survival": "Sopravvivenza",
	"gamerule.allowEnteringNetherUsingPortals": "Accesso al Nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Determina se i giocatori possono entrare nel Nether attraverso i portali.",
	"gamerule.allowFireTicksAwayFromPlayer": "Propagazione distante del fuoco",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Determina se il fuoco e la lava sono attivi anche a una distanza maggiore di 8 chunk da ogni giocatore.",
	"gamerule.announceAdvancements": "Progressi annunciati",
	"gamerule.blockExplosionDropDecay": "Perdita dei rilasci con le esplosioni dei blocchi",
	...
	"gamerule.category.updates": "Natura",
	"gamerule.commandBlockOutput": "Esito dei blocchi comandi",
	"gamerule.commandBlocksEnabled": "Blocchi comandi funzionanti",
	...
	"gamerule.disableElytraMovementCheck": "Verifica del volo con le elitre disattivata",
	"gamerule.disablePlayerMovementCheck": "Verifica dei movimenti dei giocatori disattivata",
	"gamerule.disableRaids": "Incursioni disattivate",
	"gamerule.doDaylightCycle": "Ciclo circadiano",
	"gamerule.doEntityDrops": "Rilasci delle entità",
	"gamerule.doEntityDrops.description": "Determina i rilasci dei vagonetti (compresi gli inventari), delle cornici, delle barche ecc.",
	"gamerule.doFireTick": "Propagazione del fuoco",
	"gamerule.doImmediateRespawn": "Rinascita immediata",
	"gamerule.doInsomnia": "Fantasmi",
	"gamerule.doLimitedCrafting": "Fabbricazione limitata",
	...
	"gamerule.doMobLoot": "Rilasci delle creature",
	"gamerule.doMobLoot.description": "Determina le risorse che vengono rilasciate dalle creature, comprese le sfere di esperienza.",
	"gamerule.doMobSpawning": "Creature",
	"gamerule.doMobSpawning.description": "Alcune entità potrebbero avere regole separate.",
	"gamerule.doPatrolSpawning": "Pattuglie di predoni",
	"gamerule.doTileDrops": "Rilasci dei blocchi",
	"gamerule.doTileDrops.description": "Determina le risorse rilasciate dai blocchi, comprese le sfere di esperienza.",
	"gamerule.doTraderSpawning": "Mercanti ambulanti",
	"gamerule.doVinesSpread": "Propagazione dei rampicanti",
	"gamerule.doVinesSpread.description": "Determina la propagazione casuale dei rampicanti verso i blocchi adiacenti. Non ha effetto sugli altri tipi di rampicanti (come i rampicanti piangenti o i rampicanti attorcigliati).",
	"gamerule.doWardenSpawning": "Sorveglianti",
	"gamerule.doWeatherCycle": "Tempo atmosferico",
	"gamerule.drowningDamage": "Danno da annegamento",
	"gamerule.enableCommandBlocks": "Blocchi comandi funzionanti",
	"gamerule.enderPearlsVanishOnDeath": "Scomparsa alla morte delle perle di ender già lanciate",
	...
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Consenti alle entità con passeggeri di teletrasportarsi attraverso i portali del Nether, i portali dell'End e i varchi dell'End.",
	"gamerule.fallDamage": "Danno da caduta",
	"gamerule.fireDamage": "Danno da bruciatura",
	"gamerule.forgiveDeadPlayers": "Perdono dei giocatori morti",
	...
	"gamerule.freezeDamage": "Danno da congelamento",
	"gamerule.globalSoundEvents": "Eventi sonori globali",
	"gamerule.globalSoundEvents.description": "Al verificarsi di determinati eventi, come la generazione di un boss, il suono verrà udito globalmente.",
	"gamerule.keepInventory": "Conservazione dell'inventario dopo la morte",
	"gamerule.lavaSourceConversion": "Conversione di lava in sorgente",
	"gamerule.lavaSourceConversion.description": "Quando la lava colante è circondata da sorgenti di lava su due lati, si trasforma in sorgente.",
	"gamerule.locatorBar": "Barra localizzatrice",
	"gamerule.locatorBar.description": "Quando attiva, viene mostrata una barra sullo schermo per indicare la posizione dei giocatori.",
	"gamerule.logAdminCommands": "Registrazione dei comandi degli operatori",
	...
	"gamerule.maxCommandForkCount.description": "Numero massimo di contesti che possono essere usati da comandi come «/execute as».",
	"gamerule.maxEntityCramming": "Limite d'ammassamento delle entità",
	...
	"gamerule.minecraft.elytra_movement_check": "Verifica del volo con le elitre",
	"gamerule.minecraft.fire_spread_radius_around_player": "Raggio di propagazione del fuoco intorno al giocatore",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Il raggio in blocchi intorno a un giocatore entro cui il fuoco può propagarsi",
	"gamerule.minecraft.player_movement_check": "Verifica dei movimenti dei giocatori",
	"gamerule.minecraft.raids": "Incursioni",
	"gamerule.minecraft.universal_anger.description": "Le creature neutrali che sono state provocate attaccano ogni giocatore nelle vicinanze, non solo il giocatore che li ha fatti arrabbiare. Funziona meglio se la regola «forgive_dead_players» è disattivata.",
	"gamerule.mobExplosionDropDecay": "Perdita dei rilasci con le esplosioni delle creature",
	...
	"gamerule.mobGriefing": "Azioni distruttive delle creature",
	"gamerule.naturalRegeneration": "Rigenerazione della salute",
	"gamerule.playersNetherPortalCreativeDelay": "Ritardo dei portali del Nether in modalità creativa",
	...
	"gamerule.playersNetherPortalDefaultDelay": "Ritardo dei portali del Nether",
	...
	"gamerule.projectilesCanBreakBlocks.description": "Determina se i proiettili da impatto possono distruggere i blocchi vulnerabili.",
	"gamerule.pvp": "Combattimento tra giocatori",
	"gamerule.pvp.description": "Determina se i giocatori possono infliggere danno agli altri giocatori.",
	"gamerule.randomTickSpeed": "Frequenza dei tick casuali",
	"gamerule.reducedDebugInfo": "Informazioni di debug ridotte",
	"gamerule.reducedDebugInfo.description": "Limita il contenuto della schermata di debug.",
	"gamerule.sendCommandFeedback": "Risposte dei comandi",
	"gamerule.showDeathMessages": "Messaggi di morte",
	...
	"gamerule.spawnMonsters": "Mostri",
	"gamerule.spawnMonsters.description": "Determina se i mostri si generano naturalmente.",
	"gamerule.spawnRadius": "Raggio del punto di rinascita",
	"gamerule.spawnRadius.description": "Determina la dimensione dell'area intorno al punto di generazione dei giocatori.",
	"gamerule.spawnerBlocksEnabled": "Generatori funzionanti",
	"gamerule.spectatorsGenerateChunks": "Generazione di terreno da parte degli spettatori",
	"gamerule.tntExplodes": "Innesco ed esplosione di TNT",
	"gamerule.tntExplosionDropDecay": "Perdita dei rilasci con le esplosioni di TNT",
	...
	"gamerule.waterSourceConversion": "Conversione d'acqua in sorgente",
	"gamerule.waterSourceConversion.description": "Quando l'acqua corrente è circondata da sorgenti d'acqua su due lati, si trasforma in sorgente.",
	...
	"gui.abuseReport.report_sent_msg": "Abbiamo ricevuto la tua segnalazione. Grazie!\n\nIl nostro team la revisionerà il prima possibile.",
	...
	"gui.all": "Tutti",
	"gui.back": "Indietro",
	"gui.banned.description": "%s\n\n%s\n\nScopri di più al collegamento seguente: %s",
	"gui.banned.description.permanent": "Il tuo account è permanentemente bannato, dunque non puoi giocare in rete o entrare nei Realm.",
	...
	"gui.banned.description.temporary": "%s Nel frattempo, non potrai giocare in rete o entrare nei Realm.",
	"gui.banned.description.temporary.duration": "Il tuo account è temporaneamente sospeso e verrà riattivato tra %s.",
	...
	"gui.banned.name.description": "Il tuo nome attuale («%s») viola gli Standard della community. Puoi giocare in giocatore singolo, ma devi cambiare il nome per giocare in rete.\n\nScopri di più o richiedi una revisione del caso al collegamento seguente: %s",
	...
	"gui.chatReport.report_sent_msg": "Abbiamo ricevuto la tua segnalazione. Grazie!\n\nIl nostro team la revisionerà il prima possibile.",
	...
	"gui.chatSelection.context": "I messaggi adiacenti verranno inclusi per fornire del contesto aggiuntivo",
	...
	"gui.chatSelection.selected": "Messaggi selezionati: %s/%s",
	...
	"gui.fileDropFailure.title": "Aggiunta non riuscita",
	"gui.friends.accept": "Accetta",
	"gui.friends.button.loading": "Attendi...",
	"gui.friends.button.loading.invite_request_pending": "In attesa di conferma...",
	"gui.friends.button.loading.join_request_pending": "In attesa di conferma...",
	"gui.friends.cancel_request": "Annulla richiesta",
	"gui.friends.confirm_title": "Conferma",
	"gui.friends.confirm_unfriend": "Vuoi davvero rimuovere questo giocatore dalla tua lista amici?",
	"gui.friends.copy_to_clipboard": "Copia negli appunti",
	"gui.friends.decline": "Rifiuta",
	"gui.friends.empty_nickname": "Inserisci un nome utente valido prima d'inviare una richiesta d'amicizia",
	"gui.friends.empty_state": "Gli amici appariranno qua\n\nGestisci la sicurezza in rete con l'%s",
	"gui.friends.empty_state.link": "account Microsoft",
	"gui.friends.enter_nickname": "Inserisci il nome utente",
	"gui.friends.error.connection_issue": "La lista amici non è al momento disponibile\n\nControlla la connessione a Internet e riprova",
	"gui.friends.error.failed.message": "Impossibile inviare la richiesta d'amicizia al momento",
	"gui.friends.error.forbidden.message": "Azione non riuscita. Potrebbe dipendere dalle impostazioni di riservatezza del giocatore",
	"gui.friends.error.generic": "Qualcosa non va... in questa funzione, mica nei tuoi amici!\n\nRiprova più tardi",
	"gui.friends.error.rateLimited.message": "Stai gestendo la lista amici troppo velocemente. Attendi qualche secondo e riprova",
	"gui.friends.error.temporary_unavailable": "La lista amici non è al momento disponibile\n\nRiprova più tardi",
	"gui.friends.error.unavailable.message": "Il servizio della lista amici non è al momento disponibile. Controlla la connessione o riprova più tardi",
	"gui.friends.error.upgrade_needed": "Aggiorna il gioco per accedere alla lista amici",
	"gui.friends.error.user_may_lack_active_profile": "Non esiste un giocatore con questo nome utente",
	"gui.friends.join": "Entra",
	"gui.friends.loading_friends": "Caricamento della lista amici...",
	"gui.friends.loading_requests": "Caricamento delle richieste...",
	"gui.friends.manage_account_footer": "Gestisci la sicurezza in rete con l'%s",
	"gui.friends.multiplayer.invite": "Invita",
	"gui.friends.multiplayer.invite_accept": "Accetta",
	"gui.friends.multiplayer.invite_reject": "Rifiuta",
	"gui.friends.multiplayer.join_request": "Chiedi di entrare",
	"gui.friends.multiplayer.join_request_accept": "Accetta",
	"gui.friends.multiplayer.join_request_reject": "Rifiuta",
	"gui.friends.my_profile_name": "Il tuo nome: ",
	"gui.friends.my_profile_name.narration": "Copia il nome utente «%s» negli appunti",
	"gui.friends.narration.button.accept": "Premi Invio per accettare la richiesta d'amicizia da %s",
	"gui.friends.narration.button.cancel_request": "Premi Invio per annullare la richiesta d'amicizia inviata a %s",
	"gui.friends.narration.button.decline": "Premi Invio per rifiutare la richiesta d'amicizia da %s",
	"gui.friends.narration.button.unfriend": "Premi Invio per rimuovere %s dalla lista amici",
	"gui.friends.narration.entry.friend": "Amico %s",
	"gui.friends.narration.entry.incoming": "Richiesta d'amicizia in arrivo da %s",
	"gui.friends.narration.entry.outgoing": "Richiesta d'amicizia inviata a %s",
	"gui.friends.open": "Amici",
	"gui.friends.open.narration": "Lista amici",
	"gui.friends.open.tooltip": "Amici",
	"gui.friends.pending.empty": "Nessuna richiesta in sospeso",
	"gui.friends.pending.received": "Ricevute",
	"gui.friends.pending.sent": "Inviate",
	"gui.friends.presence.status.offline": "Non in linea",
	"gui.friends.presence.status.online": "In linea",
	"gui.friends.presence.status.playing_hosted_server": "In linea (mondo)",
	"gui.friends.presence.status.playing_offline": "In linea (mondo)",
	"gui.friends.presence.status.playing_realms": "In linea (Realm)",
	"gui.friends.presence.status.playing_server": "In linea (server)",
	"gui.friends.requests_count": "Richieste (%s)",
	"gui.friends.send_request": "Invia richiesta d'amicizia",
	"gui.friends.tab_friends": "Amici",
	"gui.friends.toast.friend_added.message": "%s ha accettato la tua richiesta",
	"gui.friends.toast.friend_invited.message": "Hai invitato %s a entrare nel tuo mondo",
	"gui.friends.toast.friend_removed.message": "Hai rimosso %s dalla tua lista amici",
	"gui.friends.toast.generic_error": "Si è verificato un errore imprevisto durante l'aggiornamento della lista amici. Riprova più tardi",
	"gui.friends.toast.host_invite_expired.message": "L'invito a entrare nel mondo inviato a %s è scaduto",
	"gui.friends.toast.invite_from_friend.message": "%s ti ha invitato a entrare nel suo mondo. Apri la lista amici premendo %s per accettare",
	"gui.friends.toast.join_invite_expired.message": "L'invito a entrare nel mondo di %s è scaduto",
	"gui.friends.toast.join_request.message": "%s vuole entrare nel tuo mondo. Apri la lista amici premendo %s o dal menu di gioco",
	"gui.friends.toast.request_accepted.message": "Hai stretto amicizia con %s",
	"gui.friends.toast.request_received.message": "%s ti ha inviato una richiesta d'amicizia",
	"gui.friends.toast.request_sent.message": "Hai inviato una richiesta d'amicizia a %s",
	"gui.friends.toast.request_to_join_friend.message": "Hai chiesto di entrare nel mondo di %s",
	"gui.friends.toast.requests_accepted_multiple.message": "%s amici hanno accettato le tue richieste d'amicizia",
	"gui.friends.toast.requests_received_multiple.message": "Hai ricevuto %s richieste d'amicizia",
	"gui.friends.unfriend": "Rimuovi amico",
	"gui.game_rule.search": "Cerca...",
	"gui.hours": "%s ora/e",
	"gui.language.search": "Cerca...",
	...
	"gui.packSelection.search": "Cerca...",
	"gui.privacy_link.message": "Apri questo collegamento per gestire le impostazioni di riservatezza e sicurezza in rete.",
	"gui.privacy_link.title": "La modifica delle impostazioni di Xbox potrebbe richiedere del tempo.\n\nRiavvia il gioco per forzare l'aggiornamento.",
	"gui.proceed": "Continua",
	"gui.recipebook.moreRecipes": "Clic destro per altre ricette",
	"gui.recipebook.next_page": "Pagina successiva",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Pagina precedente",
	...
	"gui.socialInteractions.hidden_in_chat": "I messaggi in chat di %s verranno nascosti",
	"gui.socialInteractions.hide": "Nascondi nella chat",
	"gui.socialInteractions.narration.hide": "Nascondi messaggi da %s",
	"gui.socialInteractions.narration.report": "Segnala %s",
	...
	"gui.socialInteractions.shown_in_chat": "I messaggi in chat di %s verranno mostrati",
	"gui.socialInteractions.status_blocked": "Bloccati",
	"gui.socialInteractions.status_blocked_offline": "Bloccato/a — Non in linea",
	"gui.socialInteractions.status_hidden": "Nascosti",
	"gui.socialInteractions.status_hidden_offline": "Nascosto/a — Non in linea",
	"gui.socialInteractions.status_offline": "Non in linea",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Questo giocatore non può essere segnalato perché la chat è disattivata o bloccata",
	...
	"gui.stats.none_found": "Nessuna statistica trovata.",
	...
	"gui.togglable_slot": "Clicca per disattivare lo slot",
	"gui.up": "Su",
	"gui.waitingForResponse.button.inactive": "Indietro (%s s)",
	"gui.waitingForResponse.title": "In attesa del server...",
	"gui.yes": "Sì",
	...
	"item.minecraft.camel_husk_spawn_egg": "Uovo generatore di mummifario",
	...
	"item.minecraft.copper_axe": "Ascia di rame",
	"item.minecraft.copper_boots": "Stivali di rame",
	"item.minecraft.copper_chestplate": "Corazza di rame",
	"item.minecraft.copper_golem_spawn_egg": "Uovo generatore di golem di rame",
	"item.minecraft.copper_helmet": "Elmo di rame",
	"item.minecraft.copper_hoe": "Zappa di rame",
	"item.minecraft.copper_horse_armor": "Bardatura di rame",
	"item.minecraft.copper_ingot": "Lingotto di rame",
	"item.minecraft.copper_leggings": "Gambiere di rame",
	"item.minecraft.copper_nautilus_armor": "Armatura di rame per nautili",
	"item.minecraft.copper_nugget": "Pepita di rame",
	"item.minecraft.copper_pickaxe": "Piccone di rame",
	"item.minecraft.copper_shovel": "Pala di rame",
	"item.minecraft.copper_spear": "Lancia di rame",
	"item.minecraft.copper_sword": "Spada di rame",
	...
	"item.minecraft.crossbow.projectile.multiple": "Proiettile: %s × %s",
	...
	"item.minecraft.diamond_nautilus_armor": "Armatura di diamante per nautili",
	"item.minecraft.diamond_pickaxe": "Piccone di diamante",
	"item.minecraft.diamond_shovel": "Pala di diamante",
	"item.minecraft.diamond_spear": "Lancia di diamante",
	...
	"item.minecraft.glow_squid_spawn_egg": "Uovo generatore di calamaro luminescente",
	...
	"item.minecraft.golden_nautilus_armor": "Armatura d'oro per nautili",
	"item.minecraft.golden_pickaxe": "Piccone d'oro",
	"item.minecraft.golden_shovel": "Pala d'oro",
	"item.minecraft.golden_spear": "Lancia d'oro",
	...
	"item.minecraft.host_armor_trim_smithing_template.new": "Ornamento stile oste",
	"item.minecraft.howl_pottery_shard": "Coccio con ululato",
	"item.minecraft.howl_pottery_sherd": "Coccio con ululato",
	"item.minecraft.husk_spawn_egg": "Uovo generatore di mummificato",
	...
	"item.minecraft.iron_nautilus_armor": "Armatura di ferro per nautili",
	...
	"item.minecraft.iron_spear": "Lancia di ferro",
	...
	"item.minecraft.lingering_potion.effect.fire_resistance": "Pozione persistente di resistenza al fuoco",
	...
	"item.minecraft.lingering_potion.effect.turtle_master": "Pozione persistente del maestro tartaruga",
	"item.minecraft.lingering_potion.effect.water": "Ampolla d'acqua persistente",
	"item.minecraft.lingering_potion.effect.water_breathing": "Pozione persistente di apnea",
	...
	"item.minecraft.music_disc_bounce": "Disco musicale",
	...
	"item.minecraft.music_disc_lava_chicken": "Disco musicale",
	...
	"item.minecraft.music_disc_tears": "Disco musicale",
	...
	"item.minecraft.nautilus_spawn_egg": "Uovo generatore di nautilo",
	...
	"item.minecraft.netherite_horse_armor": "Bardatura di netherite",
	"item.minecraft.netherite_ingot": "Lingotto di netherite",
	"item.minecraft.netherite_leggings": "Gambiere di netherite",
	"item.minecraft.netherite_nautilus_armor": "Armatura di netherite per nautili",
	...
	"item.minecraft.netherite_spear": "Lancia di netherite",
	...
	"item.minecraft.parched_spawn_egg": "Uovo generatore di ossecco",
	...
	"item.minecraft.potion.effect.water_breathing": "Pozione di apnea",
	...
	"item.minecraft.splash_potion.effect.water_breathing": "Pozione da lancio di apnea",
	...
	"item.minecraft.stone_spear": "Lancia di pietra",
	...
	"item.minecraft.sulfur_cube_bucket": "Secchio con cubo di zolfo",
	"item.minecraft.sulfur_cube_spawn_egg": "Uovo generatore di cubo di zolfo",
	...
	"item.minecraft.tipped_arrow.effect.water_breathing": "Freccia di apnea",
	...
	"item.minecraft.wooden_spear": "Lancia di legno",
	...
	"item.minecraft.zombie_nautilus_spawn_egg": "Uovo generatore di nautilo zombi",
	...
	"item.op_block_warning.line2": "Quest'oggetto potrebbe eseguire comandi.",
	"item.op_block_warning.line3": "Utilizzalo soltanto se sai a che cosa serve!",
	"item.spawn_egg.peaceful": "Disattivato in modalità pacifica",
	...
	"jigsaw_block.final_state": "Stato finale",
	"jigsaw_block.generate": "Genera",
	"jigsaw_block.joint.aligned": "Fissa",
	"jigsaw_block.joint.rollable": "Rotatoria",
	...
	"jigsaw_block.placement_priority.tooltip": "Quando questo blocco puzzle si connette a un pezzo, questo sarà l'ordine in cui il pezzo viene elaborato per le connessioni nella struttura complessiva.\n\nI pezzi verranno elaborati in ordine di priorità decrescente o, in caso di parità, seguendo l'ordine d'inserimento.",
	"jigsaw_block.pool": "Insieme di destinazione",
	"jigsaw_block.selection_priority": "Priorità di selezione e di piazzamento",
	"jigsaw_block.selection_priority.tooltip": "Quando il pezzo associato viene elaborato per le connessioni, questo sarà l'ordine in cui questo blocco puzzle tenterà di connettersi al suo pezzo di destinazione.\n\nI pezzi verranno elaborati in ordine di priorità decrescente o, in caso di parità, casualmente.",
	"jigsaw_block.target": "Nome di destinazione",
	...
	"key.categories.creative": "Creativa",
	...
	"key.categories.spectator": "Spettatore",
	"key.categories.ui": "Interfaccia di gioco",
	"key.category.minecraft.creative": "Creativa",
	"key.category.minecraft.debug": "Debug",
	"key.category.minecraft.gameplay": "Azioni di gioco",
	"key.category.minecraft.inventory": "Inventario",
	"key.category.minecraft.misc": "Varie",
	"key.category.minecraft.movement": "Movimento",
	"key.category.minecraft.multiplayer": "Multigiocatore",
	"key.category.minecraft.spectator": "Spettatore",
	"key.chat": "Apri la chat",
	"key.command": "Digita un comando",
	"key.debug.clearChat": "Svuota la chat",
	"key.debug.copyLocation": "Copia la posizione",
	"key.debug.copyRecreateCommand": "Copia i dati",
	"key.debug.crash": "Arresto forzato del gioco",
	"key.debug.debugOptions": "Opzioni di debug",
	"key.debug.dumpDynamicTextures": "Esporta le grafiche dinamiche",
	"key.debug.dumpVersion": "Esporta le informazioni sulla versione",
	"key.debug.focusPause": "Pausa alla perdita dello stato attivo",
	"key.debug.fpsCharts": "Grafici di frequenza dei fotogrammi",
	"key.debug.lightmapTexture": "Grafica della mappa d'illuminazione",
	"key.debug.modifier": "Tasto modificatore di debug",
	"key.debug.networkCharts": "Grafici di rete",
	"key.debug.overlay": "Mostra o nascondi il cruscotto",
	"key.debug.profiling": "Avvia o arresta la profilatura",
	"key.debug.profilingChart": "Grafico di profilatura",
	"key.debug.reloadChunk": "Ricarica i chunk",
	"key.debug.reloadResourcePacks": "Ricarica i pacchetti di risorse",
	"key.debug.showAdvancedTooltips": "Mostra le descrizioni avanzate",
	"key.debug.showChunkBorders": "Mostra i confini dei chunk",
	"key.debug.showHitboxes": "Mostra le zone di collisione",
	"key.debug.spectate": "Passa alla modalità spettatore",
	"key.debug.switchGameMode": "Selettore della modalità di gioco",
	"key.drop": "Rilascia l'oggetto selezionato",
	"key.forward": "Cammina in avanti",
	"key.friends": "Lista amici",
	...
	"key.keyboard.page.down": "Pag ↓",
	"key.keyboard.page.up": "Pag ↑",
	...
	"key.keyboard.slash": "/",
	"key.keyboard.space": "Spazio",
	"key.keyboard.tab": "Tab",
	"key.keyboard.unknown": "Nessuno",
	"key.keyboard.up": "↑",
	...
	"key.quickActions": "Azioni rapide",
	...
	"key.spectatorHotbar": "Seleziona nella barra rapida",
	"key.spectatorOutlines": "Evidenzia i giocatori",
	"key.sprint": "Corri",
	"key.swapOffhand": "Scambia gli oggetti tra le mani",
	"key.toggleGui": "Mostra o nascondi interfaccia",
	"key.togglePerspective": "Cambia la modalità di visuale",
	"key.toggleSpectatorShaderEffects": "Effetti della vista da spettatore",
	"key.use": "Usa o piazza",
	...
	"known_server_link.report_bug": "Segnala un errore del server",
	...
	"lanServer.port": "Numero di porta",
	"lanServer.port.invalid": "La porta non è valida.\nLascia il riquadro vuoto o inserisci un numero tra 1024 e 65535.",
	"lanServer.port.invalid.new": "La porta non è valida.\nLascia il riquadro vuoto o inserisci un numero tra %s e %s.",
	...
	"lanServer.start": "Avvia il mondo in locale",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Aggiungi un server",
	"manageServer.edit.title": "Modifica le informazioni del server",
	"manageServer.enterIp": "Indirizzo del server",
	"manageServer.enterName": "Nome del server",
	"manageServer.resourcePack": "Pacchetti di risorse del server",
	"manageServer.resourcePack.disabled": "No",
	"manageServer.resourcePack.enabled": "Sì",
	"manageServer.resourcePack.prompt": "Chiedi",
	...
	"mco.account.privacy.information": "Mojang applica alcune misure per assicurare la protezione dei bambini e della loro riservatezza, in conformità della legge sulla protezione della riservatezza in rete dei minori (COPPA) e del regolamento generale sulla protezione dei dati (RGPD).\n\nPotrebbe essere necessario il consenso dei genitori per accedere al tuo account su Realms.",
	"mco.account.privacyinfo": "Mojang applica alcune misure per assicurare la protezione dei bambini e della loro riservatezza, in conformità della legge sulla protezione della riservatezza in rete dei minori (COPPA) e del regolamento generale sulla protezione dei dati (RGPD).\n\nPotrebbe essere necessario il consenso dei genitori per accedere al tuo account su Realms.\n\nSe possiedi un vecchio account di Minecraft (accedi usando il nome utente), dovrai eseguire la migrazione a un account Mojang per poter accedere a Realms.",
	...
	"mco.backup.entry.worldType.adventureMap": "Avventura",
	"mco.backup.entry.worldType.experience": "Esperienza",
	"mco.backup.entry.worldType.inspiration": "Ispirazione",
	"mco.backup.entry.worldType.minigame": "Minigioco",
	"mco.backup.entry.worldType.normal": "Normale",
	"mco.backup.entry.worldType.unknown": "Sconosciuto",
	...
	"mco.configure.world.buttons.close": "Chiudi il Realm temporaneamente",
	...
	"mco.configure.world.buttons.newworld": "Nuovo mondo",
	"mco.configure.world.buttons.open": "Riapri il Realm",
	"mco.configure.world.buttons.options": "Opzioni del mondo",
	"mco.configure.world.buttons.players": "Giocatori",
	"mco.configure.world.buttons.region_preference": "Seleziona la regione...",
	...
	"mco.configure.world.close.question.line1": "Puoi chiudere temporaneamente il tuo Realm, impedendo l'accesso al gioco mentre apporti delle modifiche. Riaprilo quando sei pronto. \n\nIl tuo abbonamento a Realms non verrà disdetto.",
	"mco.configure.world.close.question.line2": "Vuoi davvero continuare?",
	"mco.configure.world.close.question.title": "Hai bisogno di apportare modifiche senza interruzioni?",
	"mco.configure.world.closing": "Chiusura temporanea del Realm...",
	"mco.configure.world.commandBlocks": "Blocchi comandi",
	"mco.configure.world.delete.button": "Elimina il Realm",
	"mco.configure.world.delete.question.line1": "Il tuo Realm verrà eliminato permanentemente.",
	...
	"mco.configure.world.leave.question.line1": "Se abbandoni questo Realm, non lo rivedrai finché non verrai invitato di nuovo.",
	"mco.configure.world.leave.question.line2": "Vuoi davvero continuare?",
	"mco.configure.world.loading": "Caricamento del Realm...",
	"mco.configure.world.location": "Posizione",
	"mco.configure.world.minigame": "Attuale: %s",
	"mco.configure.world.name": "Nome del Realm",
	"mco.configure.world.name.validation.whitespace": "Gli spazi vuoti ai margini del nome verranno rimossi.",
	"mco.configure.world.opening": "Apertura del Realm...",
	"mco.configure.world.players.error": "Non esistono giocatori con il nome dato",
	"mco.configure.world.players.invite.duplicate": "Un giocatore con questo nome è già stato invitato al Realm",
	"mco.configure.world.players.inviting": "Invio dell'invito...",
	"mco.configure.world.players.title": "Giocatori",
	"mco.configure.world.pvp": "Combattimento tra giocatori",
	"mco.configure.world.region_preference": "Regione preferita",
	"mco.configure.world.region_preference.title": "Selezione della preferenza regionale",
	"mco.configure.world.reset.question.line1": "Il tuo mondo verrà rigenerato e quello attuale andrà perso.",
	...
	"mco.configure.world.resourcepack.question.line2": "Vuoi scaricarlo per giocare?",
	...
	"mco.configure.world.settings.expired": "Non puoi modificare le impostazioni di un Realm scaduto",
	...
	"mco.configure.world.subscription.recurring.info": "Le modifiche effettuate al tuo abbonamento a Realms, come l'estensione del termine o la disattivazione della fatturazione ricorrente, non verranno rese effettive fino alla prossima data di fatturazione.",
	...
	"mco.configure.world.subscription.tab": "Abbonamento",
	...
	"mco.configure.world.uninvite.player": "Vuoi davvero revocare l'invito a «%s»?",
	"mco.configure.world.uninvite.question": "Vuoi davvero revocare l'invito a",
	...
	"mco.connect.region": "Regione del server: %s",
	"mco.connect.success": "Fatto",
	"mco.create.world": "Crea",
	"mco.create.world.error": "Devi immettere un nome!",
	"mco.create.world.failed": "Creazione del mondo non riuscita!",
	...
	"mco.download.resourcePack.fail": "Download del pacchetto non riuscito!",
	...
	"mco.errorMessage.realmsService.configurationError": "Si è verificato un errore non previsto durante la modifica delle opzioni del mondo",
	...
	"mco.notification.visitUrl.buttonText.default": "Apri collegamento",
	"mco.notification.visitUrl.message.default": "Visita il collegamento qui sotto",
	"mco.onlinePlayers": "Giocatori in linea",
	"mco.play.button.realm.closed": "Il Realm è chiuso",
	...
	"mco.selectServer.buy": "Acquista un Realm!",
	"mco.selectServer.close": "Chiudi",
	"mco.selectServer.closed": "Realm disattivato",
	...
	"mco.selectServer.expiredTrial": "Periodo di prova terminato",
	...
	"mco.selectServer.popup": "Realms è un modo semplice e sicuro per giocare a Minecraft con un massimo di dieci amici alla volta. Ci sono tantissimi minigiochi e mondi personalizzati! Solo il proprietario del Realm deve pagare.",
	"mco.selectServer.purchase": "Aggiungi Realm",
	"mco.selectServer.trial": "Provalo ora!",
	"mco.selectServer.uninitialized": "Clicca per avviare il tuo nuovo Realm!",
	"mco.snapshot.createSnapshotPopup.text": "Stai per creare un Realm gratuito su versione sperimentale che verrà associato al tuo abbonamento a Realms. Questo nuovo Realm sperimentale sarà accessibile finché il tuo abbonamento a pagamento rimarrà attivo. Il tuo Realm a pagamento non sarà influenzato.",
	...
	"mco.snapshotRealmsPopup.title": "Realms è ora disponibile nelle versioni sperimentali",
	...
	"mco.template.trailer.tooltip": "Anteprima della mappa",
	...
	"mco.trial.message.line2": "Clicca qui per saperne di più!",
	...
	"mco.upload.uploading": "Caricamento del mondo «%s»...",
	"mco.upload.verifying": "Verifica del mondo...",
	"mco.version": "Versione: %s",
	"mco.warning": "Attenzione!",
	"mco.worldSlot.minigame": "Minigioco",
	"menu.custom_options": "Opzioni personalizzate...",
	"menu.custom_options.title": "Opzioni personalizzate",
	"menu.custom_options.tooltip": "Nota: le opzioni personalizzate sono fornite da server o contenuti di terze parti.\nUsare con cautela!",
	"menu.custom_screen_info.button_narration": "Questa è una schermata personalizzata. Scopri di più.",
	"menu.custom_screen_info.contents": "I contenuti di questa schermata sono controllati da server e mappe di terze parti che non sono posseduti, gestiti o supervisionati da Mojang Studios o Microsoft.\n\nUsare con cautela! Fa' sempre attenzione nel seguire i collegamenti e non fornire mai dati personali, inclusi i dettagli di accesso.\n\nSe questa schermata t'impedisce di giocare, puoi disconnetterti dal server usando il pulsante qui sotto.",
	"menu.custom_screen_info.disconnect": "Schermata personalizzata rifiutata",
	"menu.custom_screen_info.title": "Nota riguardante le schermate personalizzate",
	"menu.custom_screen_info.tooltip": "Questa è una schermata personalizzata. Clicca qui per saperne di più.",
	...
	"menu.multiplayerOptions.applyChanges": "Modifica",
	"menu.multiplayerOptions.button": "Multigiocatore...",
	"menu.multiplayerOptions.network": "Multigiocatore",
	"menu.multiplayerOptions.network.header": "Rete",
	"menu.multiplayerOptions.network.lan": "Locale",
	"menu.multiplayerOptions.network.lan.tooltip": "I giocatori sulla stessa rete possono entrare nel mondo.",
	"menu.multiplayerOptions.network.off": "No",
	"menu.multiplayerOptions.network.off.tooltip": "Nessuno può entrare nel mondo.",
	"menu.multiplayerOptions.network.online": "In rete",
	"menu.multiplayerOptions.network.online.tooltip": "I giocatori nella tua lista amici possono entrare nel mondo.",
	"menu.multiplayerOptions.otherPlayers.header": "Altri giocatori",
	"menu.multiplayerOptions.publish.started.lan": "Questo mondo è stato aperto in rete locale. Il numero di porta è %s",
	"menu.multiplayerOptions.publish.started.online": "Questo mondo è stato aperto al multigiocatore in rete",
	"menu.multiplayerOptions.publish.stopped": "Questo mondo non è più aperto al multigiocatore",
	"menu.multiplayerOptions.title": "Opzioni del multigiocatore",
	"menu.online": "Minecraft Realms",
	"menu.options": "Opzioni...",
	"menu.paused": "Gioco in pausa",
	"menu.playdemo": "Gioca nel mondo di prova",
	"menu.playerReporting": "Segnala giocatore",
	"menu.playerReporting.no_players": "Nessun giocatore segnalabile",
	"menu.preparingSpawn": "Preparazione dell'area di generazione: %s%%",
	"menu.quick_actions": "Azioni rapide...",
	"menu.quick_actions.title": "Azioni rapide",
	"menu.quit": "Esci dal gioco",
	"menu.reportBugs": "Segnala errori",
	"menu.resetdemo": "Ripristina il mondo di prova",
	...
	"menu.server_links": "Collegamenti...",
	"menu.server_links.title": "Collegamenti del server",
	"menu.shareToLan": "Apri in locale",
	...
	"multiplayer.codeOfConduct.check": "Non avvisarmi più per questo codice di condotta",
	"multiplayer.codeOfConduct.title": "Codice di condotta del server",
	"multiplayer.confirm_command.parse_errors": "Stai cercando di eseguire un comando non riconosciuto o invalido.\nVuoi davvero continuare?\nComando: %s",
	"multiplayer.confirm_command.permissions_required": "Stai cercando di eseguire un comando che richiede permessi elevati.\nCiò potrebbe influire negativamente sulla tua esperienza di gioco.\nVuoi davvero continuare?\nComando: %s",
	"multiplayer.confirm_command.run_command": "Esegui il comando",
	"multiplayer.confirm_command.signature_required": "Stai cercando di eseguire un comando che invierà messaggi in chat a nome tuo.\nPuò essere eseguito solo dalla chat\nComando: %s",
	"multiplayer.confirm_command.suggest_command": "Copia nella chat",
	"multiplayer.confirm_command.title": "Conferma l'esecuzione del comando",
	...
	"multiplayer.disconnect.banned.reason.default": "Bannato/a da un operatore.",
	...
	"multiplayer.disconnect.code_of_conduct": "Il server richiede l'accettazione del codice di condotta",
	"multiplayer.disconnect.configuration_error": "Errore non previsto durante la configurazione",
	...
	"multiplayer.disconnect.transfers_disabled": "Questo server non accetta i trasferimenti",
	"multiplayer.disconnect.unexpected_query_response": "Ricevuti dal client dei dati personalizzati non previsti",
	"multiplayer.disconnect.unsigned_chat": "Ricevuto un pacchetto chat con firma mancante o non valida.",
	"multiplayer.disconnect.unverified_username": "Verifica del nome utente non riuscita!",
	...
	"multiplayer.message_not_delivered": "Impossibile inviare il messaggio in chat. Controlla i registri del server: %s",
	...
	"multiplayer.player.list.narration": "Giocatori in linea: %s",
	"multiplayer.requiredTexturePrompt.disconnect": "Questo server richiede un pacchetto di risorse personalizzato",
	...
	"multiplayer.status.anonymous_player": "Giocatore anonimo",
	"multiplayer.status.cancelled": "Connessione annullata",
	"multiplayer.status.cannot_connect": "Impossibile connettersi al server",
	"multiplayer.status.cannot_resolve": "Risoluzione dell'indirizzo non riuscita",
	...
	"multiplayer.status.player_count.narration": "Giocatori in linea: %s su %s",
	...
	"multiplayerWarning.header": "Attenzione! Gioco in rete di terze parti",
	"multiplayerWarning.message": "Attenzione! Il gioco in rete è offerto da server di terze parti che non sono di proprietà, gestiti o controllati da Mojang Studios o da Microsoft. Durante il gioco in rete, potresti trovare messaggi in chat non moderati o altri tipi di contenuti generati da utenti che potrebbero non essere adatti a tutti.",
	...
	"narration.button.usage.hovered": "Premi il tasto sinistro per attivare",
	"narration.checkbox": "Casella di controllo: %s",
	"narration.checkbox.usage.focused": "Premi Invio per alternare",
	"narration.checkbox.usage.focused.check": "Premi Invio per selezionare",
	"narration.checkbox.usage.focused.uncheck": "Premi Invio per deselezionare",
	"narration.checkbox.usage.hovered": "Premi il tasto sinistro per alternare",
	"narration.checkbox.usage.hovered.check": "Premi il tasto sinistro per selezionare",
	"narration.checkbox.usage.hovered.uncheck": "Premi il tasto sinistro per deselezionare",
	...
	"narration.cycle_button.usage.hovered": "Premi il tasto sinistro per passare a %s",
	"narration.edit_box": "Casella di modifica: %s",
	"narration.item": "Oggetto: %s",
	"narration.link.usage.focused": "Premi Invio per aprire il collegamento",
	"narration.link.usage.hovered": "Premi il tasto sinistro per aprire il collegamento",
	"narration.recipe": "Ricetta per %s",
	"narration.recipe.usage": "Premi il tasto sinistro per selezionare",
	"narration.recipe.usage.more": "Premi il tasto destro per mostrare più ricette",
	"narration.selection.usage": "Premi i tasti freccia su e giù per muoverti tra gli elementi",
	"narration.slider.usage.focused": "Premi i tasti freccia sinistra o destra per cambiare il valore",
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Premi Invio per iniziare a cambiare il valore del regolatore",
	...
	"narrator.button.difficulty_lock.unlocked": "Difficoltà sbloccata",
	...
	"narrator.toast.disabled": "Assistente disattivato",
	"narrator.toast.enabled": "Assistente vocale attivato",
	"optimizeWorld.confirm.description": "Quest'operazione tenterà di ottimizzare il mondo verificando che tutti i dati siano memorizzati nel formato di gioco più recente. Ciò potrebbe richiedere molto tempo a seconda delle dimensioni del mondo. Una volta ottimizzato, il mondo potrebbe caricarsi più velocemente, ma non sarà più compatibile con le vecchie versioni del gioco. Vuoi davvero continuare?",
	...
	"options.accessibility.narrator_hotkey": "Scorciatoia assistente",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Consente di attivare o disattivare l'assistente vocale con Cmd + B.",
	"options.accessibility.narrator_hotkey.tooltip": "Consente di attivare o disattivare l'assistente vocale con Ctrl + B.",
	...
	"options.accessibility.tooltip": "Accessibilità",
	"options.allowCursorChanges": "Alterazioni del cursore",
	"options.allowCursorChanges.tooltip": "Consente l'alterazione dell'aspetto del cursore del mouse passando su determinati elementi dell'interfaccia.",
	"options.allowFriendRequests": "Richieste",
	"options.allowFriendRequests.tooltip": "Consenti agli altri giocatori d'inviarti richieste d'amicizia",
	"options.allowServerListing": "Nome negli elenchi",
	"options.allowServerListing.tooltip": "Alcuni server potrebbero includere nel loro stato pubblico un elenco dei giocatori in linea.\nCon quest'opzione disattivata, il tuo nome non comparirà in questi elenchi.",
	...
	"options.autoSuggestCommands": "Suggerimenti sui comandi",
	"options.autosaveIndicator": "Indicatore di salvataggio",
	"options.biomeBlendRadius": "Sfumatura tra biomi",
	"options.biomeBlendRadius.1": "No",
	"options.biomeBlendRadius.11": "11 × 11",
	"options.biomeBlendRadius.13": "13 × 13",
	"options.biomeBlendRadius.15": "15 × 15",
	"options.biomeBlendRadius.3": "3 × 3",
	"options.biomeBlendRadius.5": "5 × 5",
	"options.biomeBlendRadius.7": "7 × 7",
	"options.biomeBlendRadius.9": "9 × 9",
	"options.blocks": "%s blocchi",
	"options.chat": "Chat...",
	"options.chat.color": "Colori",
	"options.chat.delay": "Ritardo della chat: %s s",
	"options.chat.delay_none": "Ritardo della chat: Nessuno",
	"options.chat.drafts": "Salva le bozze",
	"options.chat.drafts.tooltip": "I messaggi non inviati verranno salvati e potranno essere inviati aprendo la chat.",
	...
	"options.chat.links.prompt": "Avviso sui collegamenti",
	"options.chat.opacity": "Opacità della chat",
	...
	"options.chunkFade": "Tempo di dissolvenza dei chunk",
	"options.chunkFade.none": "Dissolvenza chunk: No",
	"options.chunkFade.seconds": "Dissolvenza chunk: %s s",
	"options.chunkFade.tooltip": "Durata in secondi dell'eventuale dissolvenza dei chunk al primo caricamento.",
	"options.chunks": "%s chunk",
	"options.clouds.fancy": "Sofisticate",
	"options.clouds.fast": "Semplici",
	"options.controls": "Comandi...",
	"options.credits_and_attribution": "Riconoscimenti...",
	"options.cutoutLeaves": "Foglie trasparenti",
	"options.cutoutLeaves.tooltip": "Consente di vedere attraverso gli spazi tra le foglie. Disattivare quest'opzione migliora le prestazioni.",
	...
	"options.darknessEffectScale.tooltip": "Determina l'intensità della pulsazione per l'effetto di oscurità, quando ricevuto da un sorvegliante o uno sculk urlatore.",
	...
	"options.directionalAudio.off.tooltip": "Audio stereo classico.",
	"options.directionalAudio.on.tooltip": "Usa l'audio direzionale basato su funzioni di trasferimento correlate alla testa (FTCT, in inglese HRTF) per migliorare la simulazione del suono tridimensionale. Richiede hardware audio compatibile ed è consigliabile usare le cuffie.",
	...
	"options.exclusiveFullscreen": "Schermo intero esclusivo",
	"options.exclusiveFullscreen.warningTooltip": "Questa opzione potrebbe impedire il funzionamento di alcuni metodi d'ingresso.",
	"options.font": "Tipo di carattere...",
	...
	"options.fov.max": "Pro di Quake",
	"options.fov.min": "Normale",
	"options.fovEffectScale": "Effetti di campo visivo",
	"options.fovEffectScale.tooltip": "Determina quanto il campo visivo può cambiare con gli effetti di gioco.",
	"options.framerate": "%s fps",
	"options.framerateLimit": "Limite frequenza",
	"options.framerateLimit.max": "No",
	"options.friendsList": "Lista amici",
	"options.friendsList.confirm.message": "Puoi usare la lista amici per inviare e ricevere richieste d'amicizia.\n\nVuoi attivarla?\n\nGestisci le impostazioni di sicurezza in rete con l'%s.",
	"options.friendsList.confirm.message.link": "account Microsoft",
	"options.friendsList.confirm.title": "Lista amici",
	"options.friendsList.confirm.turnOff": "No",
	"options.friendsList.confirm.turnOn": "Sì",
	...
	"options.glintSpeed.tooltip": "Determina la velocità del luccichio degli oggetti incantati.",
	"options.glintStrength": "Intensità del luccichio",
	"options.glintStrength.tooltip": "Determina l'opacità del luccichio degli oggetti incantati.",
	...
	"options.graphics.preset": "Configurazione",
	"options.graphics.preset.tooltip": "Imposta le impostazioni di qualità e prestazioni su valori predefiniti ragionevoli, a seconda della qualità desiderata.",
	"options.graphics.warning.accept": "Continua senza compatibilità",
	...
	"options.graphicsApi": "Libreria",
	"options.graphicsApi.default": "Predefinita",
	"options.graphicsApi.opengl": "OpenGL",
	"options.graphicsApi.restart": "Devi riavviare il gioco per cambiare la libreria grafica.",
	"options.graphicsApi.tooltip": "Determina l'interfaccia di programmazione (in inglese API) grafica da preferire per la generazione dell'immagine. Non toccare senza un motivo valido!",
	"options.graphicsApi.tooltip.vulkan": "Funzionalità sperimentale: potrebbe avere un impatto negativo sulle prestazioni o causare instabilità.",
	"options.graphicsApi.vulkan": "Vulkan (instabile)",
	"options.guiScale": "Scala interfaccia",
	"options.guiScale.auto": "Automatica",
	"options.hidden": "Nascosto",
	"options.hideLightningFlashes": "Lampi nel cielo attenuati",
	"options.hideLightningFlashes.tooltip": "Disattiva i lampi di luce prodotti da fulmini o altri eventi atmosferici nel cielo. I fulmini stessi saranno ancora visibili.",
	...
	"options.hideSplashTexts": "Nascondi i testi iniziali",
	"options.hideSplashTexts.tooltip": "Nasconde i testi gialli mostrati nel menu principale.",
	"options.improvedTransparency": "Trasparenza migliorata",
	"options.improvedTransparency.tooltip": "Un approccio sperimentale che fa uso di shader per disegnare tempo atmosferico, nuvole e particelle attraverso l'acqua e i blocchi semitrasparenti.\nAvrà un impatto negativo sulle prestazioni della scheda grafica.",
	"options.inGameNotification": "Notifiche nel gioco",
	"options.inGameNotification.tooltip": "Mostra le notifiche della lista amici nel gioco",
	...
	"options.invertMouseX": "Inverti asse x del mouse",
	"options.invertMouseY": "Inverti asse y del mouse",
	"options.japaneseGlyphVariants": "Caratteri giapponesi",
	"options.japaneseGlyphVariants.tooltip": "Applica le varianti giapponesi dei caratteri CJK al tipo di carattere predefinito.",
	"options.key.hold": "Tieni",
	"options.key.toggle": "Alterna",
	"options.language": "Lingua...",
	"options.language.narration": "Lingua",
	"options.language.title": "Lingua",
	"options.language.tooltip": "Lingua",
	...
	"options.maxAnisotropy.tooltip": "Ogni livello rende le grafiche molto più armoniose, ma incide sulle prestazioni e aumenta notevolmente l'uso della memoria grafica. Richiede l'attivazione del filtro anisotropico.",
	"options.mipmapLevels": "Livelli di MIP map",
	...
	"options.multiplayer.title": "Opzioni del multigiocatore",
	"options.multiplier": "%s×",
	"options.musicToast": "Notifiche musicali",
	"options.musicToast.never": "No",
	"options.musicToast.never.tooltip": "Non vengono mostrati messaggi a comparsa per le canzoni.",
	"options.musicToast.pauseMenu": "Solo menu",
	"options.musicToast.pauseMenu.tooltip": "Mostra costantemente un messaggio a comparsa nel menu di pausa del gioco mentre la canzone è in riproduzione.",
	"options.musicToast.pauseMenuAndToast": "Sì",
	"options.musicToast.pauseMenuAndToast.tooltip": "Mostra un messaggio a comparsa quando inizia una canzone. Lo stesso messaggio viene costantemente mostrato nel menu di pausa del gioco mentre la canzone è in riproduzione.",
	"options.music_frequency": "Musica",
	"options.music_frequency.constant": "Costantemente",
	"options.music_frequency.default": "Occasionalmente",
	"options.music_frequency.frequent": "Frequentemente",
	"options.music_frequency.tooltip": "Modifica la frequenza di riproduzione della musica nel mondo di gioco.",
	"options.narrator": "Assistente vocale",
	"options.narrator.all": "Tutto",
	"options.narrator.chat": "Chat",
	"options.narrator.notavailable": "Assente",
	"options.narrator.off": "No",
	"options.narrator.system": "Sistema",
	"options.needsRestart": "È richiesto il riavvio del gioco.",
	...
	"options.online": "Gioco in rete...",
	"options.online.friends.header": "Lista amici",
	"options.online.realms.header": "Realms",
	"options.online.servers.header": "Server",
	"options.online.title": "Opzioni per il gioco in rete",
	"options.online.xboxSettings": "Impostazioni di Xbox...",
	...
	"options.prioritizeChunkUpdates": "Compila chunk",
	"options.prioritizeChunkUpdates.byPlayer": "Per azione",
	...
	"options.prioritizeChunkUpdates.nearby.tooltip": "I chunk vicini vengono sempre compilati immediatamente. Ciò potrebbe incidere sulle prestazioni del gioco quando si piazzano o distruggono blocchi.",
	...
	"options.realmsNotifications.button": "Notizie e inviti",
	...
	"options.renderCloudsDistance": "Distanza nuvole",
	"options.renderDistance": "Visibilità",
	"options.resourcepack": "Pacchetti di risorse...",
	"options.restartRequired": "Alcune modifiche richiedono il riavvio del gioco.",
	"options.rotateWithMinecart": "Ruota con i vagonetti",
	...
	"options.screenEffectScale.tooltip": "Regola l'intensità della distorsione dello schermo causata dalla nausea e dai portali del Nether.\nA valori più bassi, l'effetto della nausea viene sostituito da una vignettatura verde.",
	...
	"options.sharePresence.all": "Sì",
	"options.sharePresence.all.tooltip": "Presenza condivisa con gli amici. Risulterai in linea e la tua attività sarà visibile.",
	"options.sharePresence.limited": "Parziale",
	"options.sharePresence.limited.tooltip": "Presenza condivisa parzialmente. Risulterai in linea, ma la tua attività non sarà visibile. Puoi comunque invitare gli amici.",
	"options.sharePresence.none": "No",
	"options.sharePresence.none.tooltip": "Presenza non condivisa. Non risulterai in linea.",
	"options.showNowPlayingToast": "Mostra notifiche musicali",
	"options.showNowPlayingToast.tooltip": "Mostra un messaggio a comparsa ogni volta che inizia una canzone. Lo stesso messaggio viene costantemente mostrato nel menu di pausa del gioco mentre la canzone è in riproduzione.",
	"options.showSubtitles": "Sottotitoli",
	"options.showSubtitles.tooltip": "Mostra i sottotitoli per i suoni riprodotti nel gioco.",
	"options.simulationDistance": "Simulazione",
	...
	"options.sprintWindow": "Intervallo di corsa",
	"options.sprintWindow.tooltip": "Intervallo di tempo in tick entro cui il doppio tocco sul tasto «Cammina in avanti» attiva la corsa.",
	...
	"options.textureFiltering": "Filtro grafico",
	"options.textureFiltering.anisotropic": "Anisotropico",
	"options.textureFiltering.anisotropic.tooltip": "Un filtraggio basato sull'hardware che incide sulle prestazioni e aumenta notevolmente l'uso della memoria grafica. Potrebbe non essere compatibile con tutti i dispositivi.",
	"options.textureFiltering.none": "No",
	"options.textureFiltering.none.tooltip": "Nessun filtraggio viene applicato alle grafiche. I blocchi potrebbero apparire sfocati da alcune angolature.",
	"options.textureFiltering.rgss": "SCGR",
	"options.textureFiltering.rgss.tooltip": "Supercampionamento a griglia ruotata (SCGR, in inglese RGSS), un filtraggio basato su shader che migliora la qualità grafica con un impatto moderato sulle prestazioni.",
	"options.title": "Opzioni",
	"options.touchscreen": "Modalità schermo tattile",
	"options.value": "%s",
	"options.video": "Grafica...",
	"options.video.display.header": "Schermo",
	"options.video.interface.header": "Interfaccia",
	"options.video.preferences.header": "Preferenze",
	"options.video.quality.header": "Qualità e prestazioni",
	"options.videoTitle": "Impostazioni grafiche",
	"options.viewBobbing": "Visuale oscillante",
	"options.vignette": "Mostra la vignettatura",
	"options.vignette.tooltip": "Una grafica tenue sullo schermo di gioco utilizzata per ridurre la luminosità verso i bordi dello schermo ed evidenziare i confini del mondo.",
	"options.visible": "Visibile",
	"options.vsync": "Sincronismo verticale",
	"options.weatherRadius": "Raggio del meteo",
	"options.weatherRadius.tooltip": "Raggio entro il quale gli effetti di pioggia e neve sono visibili. L'impatto sulle prestazioni è trascurabile.",
	"options.worldOptions.button": "Opzioni del mondo...",
	"options.worldOptions.title": "Opzioni del mondo",
	"outOfMemory.message": "Minecraft ha esaurito la memoria.\n\nCiò può essere causato da un errore del gioco o dal fatto che non sia stata allocata abbastanza memoria alla macchina virtuale di Java.\n\nPer prevenire il danneggiamento del mondo, la partita in corso è stata terminata. Abbiamo provato a liberare abbastanza memoria per permetterti di tornare al menu principale e ricominciare a giocare, ma potrebbe non aver funzionato.\n\nRiavvia il gioco se vedi di nuovo questo messaggio.",
	"outOfMemory.title": "Memoria esaurita!",
	"pack.available.title": "Disponibili",
	"pack.copyFailure": "Copia non riuscita",
	...
	"pack.incompatible.confirm.unknown": "È danneggiato o creato per una versione di Minecraft sconosciuta e potrebbe non funzionare correttamente.",
	...
	"pack.incompatible.unknown": "(Danneggiato o non compatibile)",
	"pack.nameAndSource": "%s (%s)",
	"pack.openFolder": "Cartella dei pacchetti",
	...
	"painting.minecraft.bomb.title": "Bombardamento completato",
	...
	"painting.minecraft.courbet.title": "Buongiorno signor Courbet",
	...
	"painting.minecraft.lowmist.title": "Foschia",
	...
	"painting.minecraft.owlemons.title": "Limongufo",
	...
	"painting.minecraft.wind.title": "Aria",
	"painting.minecraft.wither.author": "Mojang",
	"painting.minecraft.wither.title": "Wither",
	"painting.random": "Variante casuale",
	"parsing.bool.expected": "Previsto un valore bool",
	"parsing.bool.invalid": "Valore bool non valido: %s (previsto «true» o «false»)",
	...
	"quickplay.error.title": "Avvio rapido non riuscito",
	"realms.configuration.region.australia_east": "Australia (Nuovo Galles del Sud)",
	"realms.configuration.region.australia_southeast": "Australia (Victoria)",
	"realms.configuration.region.brazil_south": "Brasile",
	"realms.configuration.region.central_india": "India",
	"realms.configuration.region.central_us": "Stati Uniti d'America (Iowa)",
	"realms.configuration.region.east_asia": "Hong Kong",
	"realms.configuration.region.east_us": "Stati Uniti d'America (Virginia)",
	"realms.configuration.region.east_us_2": "Stati Uniti d'America (Carolina del Nord)",
	"realms.configuration.region.france_central": "Francia",
	"realms.configuration.region.japan_east": "Giappone (orientale)",
	"realms.configuration.region.japan_west": "Giappone (occidentale)",
	"realms.configuration.region.korea_central": "Corea del Sud",
	"realms.configuration.region.north_central_us": "Stati Uniti d'America (Illinois)",
	"realms.configuration.region.north_europe": "Irlanda",
	"realms.configuration.region.south_central_us": "Stati Uniti d'America (Texas)",
	"realms.configuration.region.southeast_asia": "Singapore",
	"realms.configuration.region.sweden_central": "Svezia",
	"realms.configuration.region.uae_north": "Emirati Arabi Uniti",
	"realms.configuration.region.uk_south": "Inghilterra (meridionale)",
	"realms.configuration.region.west_central_us": "Stati Uniti d'America (Utah)",
	"realms.configuration.region.west_europe": "Paesi Bassi",
	"realms.configuration.region.west_us": "Stati Uniti d'America (California)",
	"realms.configuration.region.west_us_2": "Stati Uniti d'America (Washington)",
	"realms.configuration.region_preference.automatic_owner": "Automatico (ping del proprietario del Realm)",
	"realms.configuration.region_preference.automatic_player": "Automatico (primo a unirsi alla sessione)",
	...
	"recover_world.bug_tracker": "Segnala un errore",
	"recover_world.button": "Tenta il recupero",
	"recover_world.done.failed": "Recupero non riuscito.",
	...
	"recover_world.message": "Durante il tentativo di lettura della cartella del mondo «%s», si sono verificati i seguenti errori.\nPotrebbe essere possibile ripristinare il mondo da uno stato precedente, altrimenti puoi segnalare il problema sul sito dedicato.",
	...
	"recover_world.title": "Caricamento del mondo non riuscito",
	"recover_world.warning": "Caricamento del riepilogo del mondo non riuscito",
	"resourcePack.broken_assets": "RILEVATE RISORSE DIFETTOSE",
	"resourcePack.high_contrast.name": "Contrasto elevato",
	"resourcePack.load_fail": "Ricaricamento non riuscito",
	...
	"resourcePack.title": "Pacchetti di risorse",
	...
	"restrictions_screen.button": "Limitazioni...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Puoi ricevere messaggi dai giocatori",
	"restrictions_screen.permission.receive_player_messages.denied": "Non puoi ricevere messaggi dai giocatori",
	"restrictions_screen.permission.receive_system_messages.allowed": "Puoi ricevere messaggi di sistema dal server",
	"restrictions_screen.permission.receive_system_messages.denied": "Non puoi ricevere messaggi di sistema dal server",
	"restrictions_screen.permission.send_commands.allowed": "Puoi inviare comandi",
	"restrictions_screen.permission.send_commands.denied": "Non puoi inviare comandi",
	"restrictions_screen.permission.send_messages.allowed": "Puoi inviare messaggi in chat",
	"restrictions_screen.permission.send_messages.denied": "Non puoi inviare messaggi in chat",
	"restrictions_screen.title": "Limitazioni",
	...
	"selectWorld.access_failure": "Accesso non riuscito",
	"selectWorld.allowCommands": "Comandi",
	"selectWorld.allowCommands.info": "Comandi come «/gamemode», «/experience» ecc.",
	"selectWorld.allowCommands.new": "Comandi",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Effettuare un backup del mondo prima di aggiornarlo?",
	"selectWorld.backupQuestion.snapshot": "Vuoi davvero caricare questo mondo?",
	"selectWorld.backupWarning.customized": "Purtroppo non supportiamo mondi personalizzati in questa versione di Minecraft. Possiamo comunque caricare questo mondo e mantenere tutto com'era, ma il nuovo terreno generato non verrà personalizzato. Ci scusiamo per il disagio!",
	...
	"selectWorld.backupWarning.file_fixing_required": "È necessario aggiornare questo mondo prima di poterci giocare. Prima di procedere, ti consigliamo vivamente di effettuare un backup da utilizzare se dovessi riscontrare danneggiamenti al mondo.",
	...
	"selectWorld.delete_failure": "Eliminazione non riuscita",
	...
	"selectWorld.edit.backupSize": "Backup creato (%s MB)",
	...
	"selectWorld.gameMode.adventure.line1": "Come la modalità sopravvivenza, ma non",
	"selectWorld.gameMode.adventure.line2": "puoi aggiungere o rimuovere blocchi.",
	...
	"selectWorld.gameMode.hardcore.info": "Modalità sopravvivenza con la difficoltà bloccata su «Difficile» e con una sola vita.",
	"selectWorld.gameMode.hardcore.line1": "Come la modalità sopravvivenza, ma con",
	"selectWorld.gameMode.hardcore.line2": "la massima difficoltà e una sola vita.",
	...
	"selectWorld.import_worldgen_settings": "Importa parametri",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "È necessario aggiornare questo mondo all'ultima versione prima di poterlo modificare, a causa di modifiche strutturali al formato del salvataggio.",
	"selectWorld.requiresFileFixingTooltip.play": "È necessario aggiornare questo mondo all'ultima versione prima di poterci giocare, a causa di modifiche strutturali al formato del salvataggio.",
	"selectWorld.requiresFileFixingTooltip.recreate": "È necessario aggiornare questo mondo all'ultima versione prima di poterlo ricreare, a causa di modifiche strutturali al formato del salvataggio.",
	"selectWorld.resource_load": "Preparazione delle risorse...",
	"selectWorld.resultFolder": "Verrà salvato in:",
	"selectWorld.search": "cerca un mondo",
	"selectWorld.seedInfo": "Lascia vuoto per un seme casuale",
	"selectWorld.select": "Gioca in questo mondo",
	...
	"selectWorld.upgrade_and_play": "Aggiorna e gioca",
	...
	"selectWorld.waitingForBackup.message": "A seconda delle dimensioni del mondo, potrebbe volerci un po' di tempo. Non chiudere il gioco e non spegnere il dispositivo.",
	"selectWorld.waitingForBackup.title": "Creazione del backup...",
	...
	"selectWorld.world_gen_settings_access": "Impossibile leggere o accedere ai parametri di generazione! %s",
	"selecteWorld.backupRequiredTooltip": "È necessario effettuare un backup del mondo prima di poterlo caricare",
	...
	"snbt.parser.number_parse_failure": "Analisi del numero non riuscita: %s",
	...
	"soundCategory.neutral": "Creature pacifiche",
	"soundCategory.player": "Giocatori",
	"soundCategory.record": "Blocchi musicali",
	"soundCategory.ui": "Interfaccia",
	"soundCategory.voice": "Assistente vocale",
	...
	"stat.minecraft.interact_with_cartography_table": "Interazioni con i banchi da cartografia",
	...
	"stat.minecraft.interact_with_smithing_table": "Interazioni con i banchi da forgiatura",
	...
	"stat.minecraft.nautilus_one_cm": "Distanza su nautilo",
	...
	"structure_block.detect_size": "Coordinate automatiche",
	...
	"structure_block.include_entities": "Entità",
	...
	"structure_block.invalid_structure_name": "Nome della struttura non valido: «%s»",
	...
	"structure_block.show_boundingbox": "Zona di delimitazione",
	...
	"subtitles.ambient.cave": "Rumore cupo",
	...
	"subtitles.block.copper_chest.close": "Baule si chiude",
	"subtitles.block.copper_chest.open": "Baule si apre",
	...
	"subtitles.block.creaking_heart.idle": "Rumore sinistro",
	...
	"subtitles.block.generic.hit": "Blocco incrinato",
	...
	"subtitles.block.pale_hanging_moss.idle": "Rumore frusciante",
	...
	"subtitles.block.portal.trigger": "Rumore intenso del portale",
	"subtitles.block.potent_sulfur.geyser_eruption": "Sorgente sulfurea erutta",
	"subtitles.block.potent_sulfur.noxious_gas": "Esalazione nociva",
	...
	"subtitles.block.respawn_anchor.deplete": "Ancora della rinascita indebolita",
	...
	"subtitles.block.shelf.activate": "Scaffale attivato",
	"subtitles.block.shelf.deactivate": "Scaffale attivato",
	"subtitles.block.shelf.multi_swap": "Oggetti scambiati",
	"subtitles.block.shelf.place_item": "Oggetto posato",
	"subtitles.block.shelf.single_swap": "Oggetto scambiato",
	"subtitles.block.shelf.take_item": "Oggetto preso",
	...
	"subtitles.block.sniffer_egg.crack": "Uovo di fiutatore incrinato",
	...
	"subtitles.block.trial_spawner.charge_activate": "Presagio travolge generatore",
	...
	"subtitles.block.tripwire.detach": "Filo d'inciampo staccato",
	...
	"subtitles.entity.baby_cat.ambient": "Gattino miagola",
	"subtitles.entity.baby_cat.beg_for_food": "Gattino chiede cibo",
	"subtitles.entity.baby_cat.death": "Gattino muore",
	"subtitles.entity.baby_cat.eat": "Gattino mangia",
	"subtitles.entity.baby_cat.hiss": "Gattino soffia",
	"subtitles.entity.baby_cat.hurt": "Gattino ferito",
	"subtitles.entity.baby_cat.purr": "Gattino fa le fusa",
	"subtitles.entity.baby_chicken.ambient": "Pulcino pigola",
	"subtitles.entity.baby_chicken.death": "Pulcino muore",
	"subtitles.entity.baby_chicken.hurts": "Pulcino ferito",
	"subtitles.entity.baby_horse.ambient": "Puledro nitrisce",
	"subtitles.entity.baby_horse.angry": "Puledro sbuffa",
	"subtitles.entity.baby_horse.breathe": "Puledro respira",
	"subtitles.entity.baby_horse.death": "Puledro muore",
	"subtitles.entity.baby_horse.eat": "Puledro mangia",
	"subtitles.entity.baby_horse.hurt": "Puledro ferito",
	"subtitles.entity.baby_horse.land": "Puledro atterra",
	"subtitles.entity.baby_nautilus.ambient": "Nautilino stride",
	"subtitles.entity.baby_nautilus.ambient_land": "Nautilino stride",
	"subtitles.entity.baby_nautilus.death": "Nautilino muore",
	"subtitles.entity.baby_nautilus.death_land": "Nautilino muore",
	"subtitles.entity.baby_nautilus.eat": "Nautilino mangia",
	"subtitles.entity.baby_nautilus.hurt": "Nautilino ferito",
	"subtitles.entity.baby_nautilus.hurt_land": "Nautilino ferito",
	"subtitles.entity.baby_nautilus.swim": "Nautilino nuota",
	"subtitles.entity.baby_pig.ambient": "Porcellino grugnisce",
	"subtitles.entity.baby_pig.death": "Porcellino muore",
	"subtitles.entity.baby_pig.eat": "Porcellino mangia",
	"subtitles.entity.baby_pig.hurt": "Porcellino ferito",
	"subtitles.entity.baby_wolf.ambient": "Lupetto guaisce",
	"subtitles.entity.baby_wolf.death": "Lupetto muore",
	"subtitles.entity.baby_wolf.growl": "Lupetto ringhia",
	"subtitles.entity.baby_wolf.hurt": "Lupetto ferito",
	"subtitles.entity.baby_wolf.pant": "Lupetto ansima",
	"subtitles.entity.baby_wolf.whine": "Lupetto si lamenta",
	...
	"subtitles.entity.breeze.shoot": "Brezza attacca",
	...
	"subtitles.entity.camel.saddle": "Sella allacciata",
	...
	"subtitles.entity.camel_husk.ambient": "Mummifario grugnisce",
	"subtitles.entity.camel_husk.dash": "Mummifario scatta",
	"subtitles.entity.camel_husk.dash_ready": "Mummifario si riprende",
	"subtitles.entity.camel_husk.death": "Mummifario muore",
	"subtitles.entity.camel_husk.eat": "Mummifario mangia",
	"subtitles.entity.camel_husk.hurt": "Mummifario ferito",
	"subtitles.entity.camel_husk.saddle": "Sella allacciata",
	"subtitles.entity.camel_husk.sit": "Mummifario si siede",
	"subtitles.entity.camel_husk.stand": "Mummifario si alza",
	...
	"subtitles.entity.copper_golem.death": "Golem di rame muore",
	"subtitles.entity.copper_golem.hurt": "Golem di rame ferito",
	"subtitles.entity.copper_golem.item_drop": "Golem di rame deposita",
	"subtitles.entity.copper_golem.item_no_drop": "Oggetto non depositato",
	"subtitles.entity.copper_golem.no_item_get": "Golem di rame estrae",
	"subtitles.entity.copper_golem.no_item_no_get": "Oggetto non estratto",
	"subtitles.entity.copper_golem.spawn": "Golem di rame appare",
	"subtitles.entity.copper_golem.spin": "Testa di golem di rame ruota",
	"subtitles.entity.copper_golem_become_statue": "Golem di rame pietrificato",
	"subtitles.entity.copper_golem_oxidized.death": "Golem di rame muore",
	"subtitles.entity.copper_golem_oxidized.hurt": "Golem di rame ferito",
	"subtitles.entity.copper_golem_oxidized.spin": "Testa di golem di rame ruota",
	"subtitles.entity.copper_golem_weathered.death": "Golem di rame muore",
	"subtitles.entity.copper_golem_weathered.hurt": "Golem di rame ferito",
	"subtitles.entity.copper_golem_weathered.spin": "Testa di golem di rame ruota",
	...
	"subtitles.entity.donkey.angry": "Asino sbuffa",
	"subtitles.entity.donkey.chest": "Baule dell'asino allacciato",
	...
	"subtitles.entity.enderman.ambient": "Enderman mugugna",
	...
	"subtitles.entity.fox.aggro": "Volpe infuriata",
	...
	"subtitles.entity.generic.burn": "Combustione",
	...
	"subtitles.entity.glow_item_frame.rotate_item": "Oggetto incorniciato ruotato",
	...
	"subtitles.entity.glow_squid.squirt": "Calamaro luminescente spruzza",
	...
	"subtitles.entity.hoglin.angry": "Hoglin inferocito",
	"subtitles.entity.hoglin.attack": "Hoglin attacca",
	"subtitles.entity.hoglin.converted_to_zombified": "Hoglin si zombifica",
	...
	"subtitles.entity.horse.angry": "Cavallo sbuffa",
	"subtitles.entity.horse.armor": "Bardatura allacciata",
	...
	"subtitles.entity.horse.saddle": "Sella allacciata",
	"subtitles.entity.husk.ambient": "Mummificato geme",
	"subtitles.entity.husk.converted_to_zombie": "Mummificato si zombifica",
	"subtitles.entity.husk.death": "Mummificato muore",
	"subtitles.entity.husk.hurt": "Mummificato ferito",
	...
	"subtitles.entity.leash_knot.break": "Guinzaglio sciolto",
	...
	"subtitles.entity.llama.chest": "Baule del lama allacciato",
	...
	"subtitles.entity.magma_cube.squish": "Cubo di magma balza",
	...
	"subtitles.entity.mule.angry": "Mulo sbuffa",
	"subtitles.entity.mule.chest": "Baule del mulo allacciato",
	...
	"subtitles.entity.nautilus.ambient": "Nautilo schiocca",
	"subtitles.entity.nautilus.ambient_land": "Nautilo schiocca",
	"subtitles.entity.nautilus.dash": "Nautilo si propelle",
	"subtitles.entity.nautilus.dash_land": "Nautilo si propelle",
	"subtitles.entity.nautilus.dash_ready": "Nautilo si riprende",
	"subtitles.entity.nautilus.dash_ready_land": "Nautilo si riprende",
	"subtitles.entity.nautilus.death": "Nautilo muore",
	"subtitles.entity.nautilus.death_land": "Nautilo muore",
	"subtitles.entity.nautilus.eat": "Nautilo mangia",
	"subtitles.entity.nautilus.hurt": "Nautilo ferito",
	"subtitles.entity.nautilus.hurt_land": "Nautilo ferito",
	"subtitles.entity.nautilus.swim": "Nautilo nuota",
	"subtitles.entity.painting.break": "Quadro staccato",
	"subtitles.entity.painting.place": "Quadro appeso",
	...
	"subtitles.entity.parched.ambient": "Ossecco scricchiola",
	"subtitles.entity.parched.death": "Ossecco muore",
	"subtitles.entity.parched.hurt": "Ossecco ferito",
	...
	"subtitles.entity.parrot.imitate.blaze": "Pappagallo imita blaze",
	"subtitles.entity.parrot.imitate.bogged": "Pappagallo imita paludoso",
	"subtitles.entity.parrot.imitate.breeze": "Pappagallo imita brezza",
	"subtitles.entity.parrot.imitate.camel_husk": "Pappagallo imita mummifario",
	"subtitles.entity.parrot.imitate.creaking": "Pappagallo imita scricchio",
	"subtitles.entity.parrot.imitate.creeper": "Pappagallo imita creeper",
	"subtitles.entity.parrot.imitate.drowned": "Pappagallo imita annegato",
	"subtitles.entity.parrot.imitate.elder_guardian": "Pappagallo imita guardiano antico",
	"subtitles.entity.parrot.imitate.ender_dragon": "Pappagallo imita Enderdrago",
	"subtitles.entity.parrot.imitate.endermite": "Pappagallo imita endermite",
	"subtitles.entity.parrot.imitate.evoker": "Pappagallo imita evocatore",
	"subtitles.entity.parrot.imitate.ghast": "Pappagallo imita ghast",
	"subtitles.entity.parrot.imitate.guardian": "Pappagallo imita guardiano",
	"subtitles.entity.parrot.imitate.hoglin": "Pappagallo imita hoglin",
	"subtitles.entity.parrot.imitate.husk": "Pappagallo imita mummificato",
	"subtitles.entity.parrot.imitate.illusioner": "Pappagallo imita illusore",
	"subtitles.entity.parrot.imitate.magma_cube": "Pappagallo imita cubo di magma",
	"subtitles.entity.parrot.imitate.parched": "Pappagallo imita ossecco",
	"subtitles.entity.parrot.imitate.phantom": "Pappagallo imita fantasma",
	"subtitles.entity.parrot.imitate.piglin": "Pappagallo imita piglin",
	"subtitles.entity.parrot.imitate.piglin_brute": "Pappagallo imita piglin bruto",
	"subtitles.entity.parrot.imitate.pillager": "Pappagallo imita predone",
	"subtitles.entity.parrot.imitate.ravager": "Pappagallo imita devastatore",
	"subtitles.entity.parrot.imitate.shulker": "Pappagallo imita shulker",
	"subtitles.entity.parrot.imitate.silverfish": "Pappagallo imita pesciolino d'argento",
	"subtitles.entity.parrot.imitate.skeleton": "Pappagallo imita scheletro",
	"subtitles.entity.parrot.imitate.slime": "Pappagallo imita gelatina",
	"subtitles.entity.parrot.imitate.spider": "Pappagallo imita ragno",
	"subtitles.entity.parrot.imitate.stray": "Pappagallo imita errante",
	"subtitles.entity.parrot.imitate.vex": "Pappagallo imita vessante",
	"subtitles.entity.parrot.imitate.vindicator": "Pappagallo imita vendicatore",
	"subtitles.entity.parrot.imitate.warden": "Pappagallo imita sorvegliante",
	"subtitles.entity.parrot.imitate.witch": "Pappagallo imita strega",
	"subtitles.entity.parrot.imitate.wither": "Pappagallo imita Wither",
	"subtitles.entity.parrot.imitate.wither_skeleton": "Pappagallo imita scheletro di Wither",
	"subtitles.entity.parrot.imitate.zoglin": "Pappagallo imita zoglin",
	"subtitles.entity.parrot.imitate.zombie": "Pappagallo imita zombi",
	"subtitles.entity.parrot.imitate.zombie_horse": "Pappagallo imita cavallo zombi",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Pappagallo imita nautilo zombi",
	"subtitles.entity.parrot.imitate.zombie_villager": "Pappagallo imita villico zombi",
	...
	"subtitles.entity.piglin_brute.angry": "Piglin bruto inferocito",
	...
	"subtitles.entity.polar_bear.ambient_baby": "Orsetto polare bramisce",
	...
	"subtitles.entity.slime.squish": "Gelatina balza",
	...
	"subtitles.entity.sniffer.egg_crack": "Uovo di fiutatore incrinato",
	...
	"subtitles.entity.squid.squirt": "Calamaro spruzza",
	...
	"subtitles.entity.sulfur_cube.absorb": "Cubo di zolfo pieno",
	"subtitles.entity.sulfur_cube.bounce": "Cubo di zolfo rimbalza",
	"subtitles.entity.sulfur_cube.death": "Cubo di zolfo muore",
	"subtitles.entity.sulfur_cube.eject": "Blocco rimosso",
	"subtitles.entity.sulfur_cube.hit": "Cubo di zolfo colpito",
	"subtitles.entity.sulfur_cube.hurt": "Cubo di zolfo ferito",
	"subtitles.entity.sulfur_cube.push": "Cubo di zolfo spinto",
	"subtitles.entity.sulfur_cube.squish": "Cubo di zolfo balza",
	...
	"subtitles.entity.villager.work_fletcher": "Frecciaio lavora",
	...
	"subtitles.entity.villager.work_toolsmith": "Ferraio lavora",
	...
	"subtitles.entity.warden.angry": "Sorvegliante irritato",
	...
	"subtitles.entity.wither.ambient": "Wither infuriato",
	...
	"subtitles.entity.zoglin.angry": "Zoglin inferocito",
	...
	"subtitles.entity.zombie_horse.angry": "Cavallo zombi sbuffa",
	"subtitles.entity.zombie_horse.death": "Cavallo zombi muore",
	"subtitles.entity.zombie_horse.eat": "Cavallo zombi mangia",
	"subtitles.entity.zombie_horse.hurt": "Cavallo zombi ferito",
	"subtitles.entity.zombie_nautilus.ambient": "Nautilo zombi gorgoglia",
	"subtitles.entity.zombie_nautilus.ambient_land": "Nautilo zombi gorgoglia",
	"subtitles.entity.zombie_nautilus.dash": "Nautilo zombi si propelle",
	"subtitles.entity.zombie_nautilus.dash_land": "Nautilo zombi si propelle",
	"subtitles.entity.zombie_nautilus.dash_ready": "Nautilo zombi si riprende",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Nautilo zombi si riprende",
	"subtitles.entity.zombie_nautilus.death": "Nautilo zombi muore",
	"subtitles.entity.zombie_nautilus.death_land": "Nautilo zombi muore",
	"subtitles.entity.zombie_nautilus.eat": "Nautilo zombi mangia",
	"subtitles.entity.zombie_nautilus.hurt": "Nautilo zombi ferito",
	"subtitles.entity.zombie_nautilus.hurt_land": "Nautilo zombi ferito",
	"subtitles.entity.zombie_nautilus.swim": "Nautilo zombi nuota",
	...
	"subtitles.entity.zombified_piglin.angry": "Piglin zombificato inferocito",
	...
	"subtitles.event.mob_effect.bad_omen": "Presagio in azione",
	...
	"subtitles.item.armor.equip_copper": "Armatura di rame sferraglia",
	...
	"subtitles.item.armor.equip_nautilus": "Armatura per nautili indossata",
	...
	"subtitles.item.armor.unequip_nautilus": "Armatura per nautili slacciata",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Cubo di zolfo catturato",
	...
	"subtitles.item.bundle.remove_one": "Oggetto estratto",
	...
	"subtitles.item.flintandsteel.use": "Acciarino sferraglia",
	"subtitles.item.glow_ink_sac.use": "Sacca d'inchiostro spremuta",
	"subtitles.item.goat_horn.play": "Corno di capra suonato",
	"subtitles.item.golden_dandelion.unuse": "Crescita ripristinata",
	"subtitles.item.golden_dandelion.use": "Crescita arrestata",
	...
	"subtitles.item.horse_armor.unequip": "Bardatura slacciata",
	"subtitles.item.ink_sac.use": "Sacca d'inchiostro spremuta",
	"subtitles.item.lead.break": "Guinzaglio si spezza",
	"subtitles.item.lead.tied": "Guinzaglio legato",
	"subtitles.item.lead.untied": "Guinzaglio slegato",
	"subtitles.item.llama_carpet.unequip": "Tappeto slacciato",
	...
	"subtitles.item.nautilus_saddle_equip": "Sella allacciata",
	"subtitles.item.nautilus_saddle_underwater_equip": "Sella allacciata",
	"subtitles.item.nether_wart.plant": "Pianta seminata",
	"subtitles.item.ominous_bottle.dispose": "Ampolla distrutta",
	"subtitles.item.saddle.unequip": "Sella slacciata",
	"subtitles.item.shears.shear": "Cesoie sferragliano",
	"subtitles.item.shears.snip": "Cesoie sciolgono",
	"subtitles.item.shield.block": "Colpo parato",
	"subtitles.item.shovel.flatten": "Pala spiana",
	"subtitles.item.spear.attack": "Lancia infilza",
	"subtitles.item.spear.hit": "Lancia colpisce",
	"subtitles.item.spear.lunge": "Lancia affonda",
	"subtitles.item.spear.use": "Carica con lancia",
	"subtitles.item.spear_wood.attack": "Lancia infilza",
	"subtitles.item.spear_wood.hit": "Lancia colpisce",
	"subtitles.item.spear_wood.use": "Carica con lancia",
	...
	"subtitles.item.underwater_saddle.equip": "Sella allacciata",
	"subtitles.item.wolf_armor.break": "Armatura per lupi si rompe",
	"subtitles.item.wolf_armor.crack": "Armatura per lupi incrinata",
	...
	"subtitles.weather.end_flash": "Tuono dell'End",
	...
	"telemetry.event.graphics_capabilities.description": "Questo evento ci comunica le capacità del dispositivo grafico in uso durante la partita.",
	"telemetry.event.graphics_capabilities.title": "Funzionalità grafiche",
	"telemetry.event.optional": "%s (facoltativo)",
	"telemetry.event.optional.disabled": "%s (facoltativo) - disattivato",
	"telemetry.event.p2p_connection.description": "Questo evento ci aiuta a capire l'affidabilità e le prestazioni delle connessioni a rete paritaria tra giocatori. Registra l'esito della connessione, il tipo di candidato usato per lo stabilimento di connettività interattiva (SCI, o ICE in inglese, il protocollo che usiamo per le connessioni a rete paritaria) e il tempo richiesto per stabilire la connessione.",
	"telemetry.event.p2p_connection.title": "Connessione a rete paritaria",
	...
	"telemetry.event.world_load_times.description": "Per noi è importante capire il tempo necessario per entrare in un mondo e come questo dato può cambiare. Ad esempio, quando aggiungiamo nuove funzionalità o apportiamo modifiche tecniche significative, ci serve sapere in che modo ciò incide sui tempi di caricamento.",
	"telemetry.event.world_load_times.title": "Tempo di caricamento dei mondi",
	"telemetry.event.world_loaded.description": "Sapere come i giocatori giocano a Minecraft (per esempio la modalità e la versione di gioco o client e server modificati) ci consente di focalizzare gli aggiornamenti del gioco al fine di migliorare le aree a cui i giocatori tengono di più. L'evento «Mondo caricato» è usato insieme a «Mondo scaricato» per calcolare la durata delle sessioni di gioco.",
	"telemetry.event.world_loaded.title": "Mondo caricato",
	"telemetry.event.world_unloaded.description": "Quest'evento viene usato insieme a «Mondo caricato» per calcolare la durata della sessione del mondo. La durata (in secondi e in tick) viene misurata al termine della sessione di un mondo (cioè quando si torna al menu principale o ci si disconnette da un server).",
	"telemetry.event.world_unloaded.title": "Mondo scaricato",
	"telemetry.property.advancement_game_time.title": "Tempo di gioco (tick)",
	"telemetry.property.advancement_id.title": "ID del progresso",
	"telemetry.property.backend_failure_message.title": "Messaggio dell'errore nella creazione della libreria",
	"telemetry.property.backend_failure_missing_capabilities.title": "Funzionalità mancanti alla creazione della libreria",
	"telemetry.property.backend_failure_reason.title": "Motivo dell'errore nella creazione della libreria",
	"telemetry.property.backend_name.title": "Nome della libreria grafica",
	...
	"telemetry.property.minecraft_session_id.title": "ID della sessione di Minecraft",
	...
	"telemetry.property.opt_in.title": "Consenso",
	"telemetry.property.p2p_connection_failure_stage.title": "Fase dell'errore",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Tempo di connessione dello SCI (millisecondi)",
	"telemetry.property.p2p_connection_ice_path.title": "Percorso dello stabilimento di connettività interattiva (SCI)",
	"telemetry.property.p2p_connection_local_candidate_type.title": "Tipo di candidato locale",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Tipo di candidato remoto",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Tempo di connessione di segnalamento (millisecondi)",
	"telemetry.property.p2p_connection_successful.title": "Esito della connessione positivo",
	"telemetry.property.p2p_connection_total_time_ms.title": "Tempo totale di connessione (millisecondi)",
	...
	"telemetry.property.render_distance.title": "Visibilità",
	...
	"telemetry.property.used_memory_samples.title": "Utilizzo della memoria (RAM)",
	"telemetry.property.user_id.title": "ID dell'utente",
	"telemetry.property.world_load_time_ms.title": "Tempo di caricamento del mondo (millisecondi)",
	"telemetry.property.world_session_id.title": "ID della sessione del mondo",
	...
	"telemetry_info.screen.description": "La raccolta di questi dati ci aiuta a migliorare Minecraft, indicandoci le decisioni più opportune per i giocatori. Inoltre, puoi inviare un riscontro aggiuntivo per aiutarci a migliorare Minecraft ulteriormente.",
	"telemetry_info.screen.title": "Raccolta dei dati di telemetria",
	"test.error.block_property_mismatch": "Proprietà %s prevista: %s (ricevuto: %s)",
	...
	"test.error.entity_property_details": "L'entità %s ha fallito il test: %s (previsto: %s, ricevuto: %s)",
	"test.error.expected_block": "Previsto il blocco %s (ricevuto: %s)",
	"test.error.expected_block_present": "Prevista la presenza del blocco %s",
	"test.error.expected_block_tag": "Previsto blocco nel tag #%s (ricevuto: %s)",
	...
	"test.error.expected_entity_count": "Previste %s entità di tipo %s (ricevuto: %s)",
	"test.error.expected_entity_data": "Dati dell'entità previsti: %s (ricevuto: %s)",
	...
	"test.error.expected_items_count": "Previsti %s oggetti di tipo %s (ricevuto: %s)",
	"test.error.fail": "Condizioni di fallimento soddisfatte",
	"test.error.invalid_block_type": "Trovato tipo di blocco non previsto: %s",
	"test.error.missing_block_entity": "Blocco complesso mancante",
	"test.error.not_a_block_item": "Il blocco specificato non può essere un oggetto",
	...
	"test.error.sequence.invalid_tick": "Riuscita ottenuta durante un tick non valido: previsto %s",
	"test.error.sequence.minimum_tick": "Riuscita ottenuta prima del tick previsto: prevista l'attesa di %s",
	"test.error.sequence.not_completed": "Il test è scaduto prima del completamento della sequenza",
	"test.error.set_biome": "Impostazione del bioma non riuscita",
	"test.error.spawn_failure": "Creazione dell'entità %s non riuscita",
	"test.error.state_not_equal": "Stato non corretto (previsto: %s, ricevuto: %s)",
	"test.error.structure.failure": "Piazzamento della struttura di test per %s non riuscita",
	...
	"test.error.too_many_entities": "Prevista l'esistenza di una sola entità %s intorno a %s, %s, %s (ricevuto: %s)",
	...
	"test.error.value_not_in_between": "Previsto un valore %s tra %s e %s (ricevuto: %s)",
	"test.error.wrong_block_entity": "Tipo di blocco complesso sbagliato: %s",
	...
	"test_block.mode.fail": "Fallisci",
	"test_block.mode.log": "Registra",
	"test_block.mode.start": "Avvia",
	"test_block.mode_info.accept": "Accettazione: accetta la riuscita di (una parte di) un test",
	"test_block.mode_info.fail": "Fallimento: fai fallire il test",
	"test_block.mode_info.log": "Registrazione: registra un messaggio",
	"test_block.mode_info.start": "Avvio: il punto di partenza di un test",
	...
	"test_instance_block.test_id": "ID dell'istanza di test",
	...
	"title.32bit.deprecation.realms": "A breve Minecraft necessiterà di un sistema a 64 bit. Ciò t'impedirà di giocare o usare Realms su questo dispositivo. Dovrai disdire manualmente qualsiasi abbonamento a Realms.",
	...
	"title.credits": "© Mojang AB. Vietata la distribuzione!",
	"title.multiplayer.disabled": "La modalità multigiocatore è disattivata. Controlla le impostazioni del tuo account Microsoft.",
	"title.multiplayer.disabled.banned.name": "Devi cambiare il nome prima di poter giocare in rete",
	"title.multiplayer.disabled.banned.permanent": "Il tuo account è permanentemente sospeso dal gioco in rete",
	"title.multiplayer.disabled.banned.temporary": "Il tuo account è temporaneamente sospeso dal gioco in rete",
	"title.multiplayer.lan": "Multigiocatore (locale)",
	"title.multiplayer.online": "Multigiocatore (in rete)",
	...
	"trim_pattern.minecraft.host": "Ornamento stile oste",
	...
	"upgradeWorld.aborted.message": "Ciò può accadere quando un altro programma prova ad accedere al mondo durante l'aggiornamento.\nRiavvia il dispositivo e riprova. Se il problema persiste, ti consigliamo di segnalare l'errore.",
	"upgradeWorld.aborted.reportBug": "Segnala un errore",
	"upgradeWorld.aborted.title": "Aggiornamento del mondo non riuscito",
	"upgradeWorld.canceled.message": "Il tuo mondo non ha subito modifiche.",
	"upgradeWorld.canceled.title": "Aggiornamento del mondo annullato",
	"upgradeWorld.done": "Mondo aggiornato",
	"upgradeWorld.failed_cleanup.message": "Il mondo è stato aggiornato alla versione attuale ed è ora disponibile nella lista dei mondi. Ci sono stati degli errori durante la pulizia dei vecchi dati, di conseguenza la cartella del mondo è stata cambiata in «%s».",
	"upgradeWorld.failed_cleanup.title": "Aggiornamento del mondo completato",
	"upgradeWorld.info.converted": "Aggiornati: %s",
	"upgradeWorld.info.file_fix_stage": "Fase %s di %s",
	"upgradeWorld.info.scanning": "Analisi del salvataggio...",
	"upgradeWorld.info.total": "Totale: %s",
	"upgradeWorld.joinNow": "Vuoi giocare nel mondo adesso?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Spostamento...",
	"upgradeWorld.progress.type.legacy_structures": "Aggiornamento delle strutture...",
	"upgradeWorld.progress.type.region": "Aggiornamento delle regioni...",
	"upgradeWorld.symlink.message": "Il mondo selezionato contiene collegamenti simbolici, che impediscono l'aggiornamento del mondo alla versione attuale. Per aggiornare il mondo, è necessario prima risolvere i collegamenti presenti.",
	"upgradeWorld.symlink.title": "Aggiornamento del mondo non riuscito",
	"upgradeWorld.title": "Aggiornamento del salvataggio...",
}
