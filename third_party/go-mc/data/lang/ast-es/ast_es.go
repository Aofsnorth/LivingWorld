// Code generated by tools/gen_lang.go from 26.1/ast_es.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Conf. de l'accesibilidá…",
	"accessibility.onboarding.accessibility.button.narration": "Accessibility Settings",
	"accessibility.onboarding.screen.narrator": "Primi «Intro» p'activar el narrador",
	"accessibility.onboarding.screen.title": "¡Afáyate en Minecraft!\n\n¿Quies activar el narrador o dir a la configuración de l'accesibilidá?",
	"addServer.add": "Fecho",
	...
	"addServer.title": "Edición de la información del sirvidor",
	...
	"advMode.notEnabled.spawner": "Los bloques xeneradores nun tan activaos",
	...
	"advMode.trackOutput": "Ver la resultancia",
	...
	"advancements.adventure.arbalistic.description": "Cola ballesta, mata a cinco creatures úniques d'un tiru",
	"advancements.adventure.arbalistic.title": "Arbalística",
	"advancements.adventure.avoid_vibration.description": "Anda gacháu cerca d'un Sensor de Sculk o Serenu pa que nun te sienta",
	"advancements.adventure.avoid_vibration.title": "Furtivu 100",
	"advancements.adventure.blowback.description": "Mata un Breeze reflexando una de les sos cargues d'aire",
	"advancements.adventure.blowback.title": "Voló p'atrás",
	"advancements.adventure.brush_armadillo.description": "Consigui Escudos d'Armadillu d'un Armadillu usando un Cepiyu",
	"advancements.adventure.brush_armadillo.title": "¿Nun ye escamaraviyosu?",
	"advancements.adventure.bullseye.description": "Da nel blancu d'una diana dende, pelo menos, 30 metros de distancia",
	"advancements.adventure.bullseye.title": "¡Nun toques la diana!",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Fai un tiestu decoráu con 4 fragmentos de cerámica",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Restauración Curiosa",
	"advancements.adventure.crafters_crafting_crafters.description": "Tate cerca a un Crafter cuando esti faiga un Crafter",
	"advancements.adventure.crafters_crafting_crafters.title": "Facedores Faciendo Facedores",
	"advancements.adventure.fall_from_world_height.description": "Déxate cayer de la cima'l mundiu (llende de construcción) a lo más fondero y sobrevive",
	"advancements.adventure.fall_from_world_height.title": "Cueves y Cantiles",
	"advancements.adventure.heart_transplanter.description": "Pon un Corazón Crespu cola alliniación correuta ente dos bloques de Tueru de Carbayu Pálido",
	"advancements.adventure.heart_transplanter.title": "Ciruxanu cardiovascular",
	"advancements.adventure.hero_of_the_village.description": "Defendi un pueblu de les invasiones",
	"advancements.adventure.hero_of_the_village.title": "Héroe'l pueblu",
	"advancements.adventure.honey_block_slide.description": "Cai enriba d'un bloque de miel p'amortiguar la cayida",
	...
	"advancements.adventure.kill_all_mobs.title": "Monstruos Cazaos",
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Mata un monstru cerca d'un Catalizador de Sculk",
	"advancements.adventure.kill_mob_near_sculk_catalyst.title": "Medra",
	"advancements.adventure.lighten_up.description": "Llima una bombilla de cobre con un hachu pa facela rellumar más",
	"advancements.adventure.lighten_up.title": "Alluma esa cara",
	"advancements.adventure.lightning_rod_with_villager_no_fire.description": "Protexi a un Aldeanu d'una descarga llétrica inesperada ensin provocar una quema",
	"advancements.adventure.lightning_rod_with_villager_no_fire.title": "Téunicu en pararrayos",
	"advancements.adventure.minecraft_trials_edition.description": "Entra nuna Cámara de Pruebes",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Edición de Prueba(es)",
	"advancements.adventure.ol_betsy.description": "Tirar la ballesta",
	"advancements.adventure.ol_betsy.title": "La vieya Betsy",
	"advancements.adventure.overoverkill.description": "Fai 50 puntos de dañu d'un solo golpe usando'l Martiellu",
	"advancements.adventure.overoverkill.title": "Estra-Estramuertu",
	"advancements.adventure.play_jukebox_in_meadows.description": "Fai que los praos vibren col dulce cantar d'un Tocadiscos",
	"advancements.adventure.play_jukebox_in_meadows.title": "El soníu de la música",
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Llei la señal de potencia d'una estantería cincelada usando un Comparador",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "El poder de los llibros",
	"advancements.adventure.revaulting.description": "Desbloquea un arca siniestra con una llave de desafíu siniestra",
	"advancements.adventure.revaulting.title": "La Caxa de Pandora",
	"advancements.adventure.root.description": "Aventures, esploración ya combates",
	"advancements.adventure.root.title": "Aventura",
	"advancements.adventure.salvage_sherd.description": "Llimpia un Bloque Sospechosu pa consiguir un Fragmentu de Cerámica",
	"advancements.adventure.salvage_sherd.title": "El pasáu ta nel presente",
	...
	"advancements.adventure.spear_many_mobs.description": "Da-y a cinco creatures nel mesmu ataque de Carga cola llancia",
	"advancements.adventure.spear_many_mobs.title": "Espetu de Monstruos",
	"advancements.adventure.spyglass_at_dragon.description": "Mira'l Dragón del End con una Lente",
	"advancements.adventure.spyglass_at_dragon.title": "¿Ye un avión?",
	"advancements.adventure.spyglass_at_ghast.description": "Mira un Ghast con una Lente",
	"advancements.adventure.spyglass_at_ghast.title": "¿Ye un globu?",
	"advancements.adventure.spyglass_at_parrot.description": "Mira un Loru con una Lente",
	...
	"advancements.adventure.throw_trident.description": "Llanza una traenta contra daqué.\nNota: tirar la única arma que tienes nun ye bona idea.",
	...
	"advancements.adventure.trade_at_world_height.description": "Comercia con un aldeanu na llende d'altor del mundu",
	"advancements.adventure.trade_at_world_height.title": "Viaxante estelar",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Aplica estes plantiyes de ferrería siquier una vegada: Aguya, Focicu, Costiella, Custodia, Silenciu, Fadiu, Marea, Orientador",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Ferrería con estilu",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Fai una armadura recortada n'una mesa de ferrería",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Creando una nueva apariencia",
	...
	"advancements.adventure.under_lock_and_key.description": "Desbloquea una Arca con una Llave de Prueba",
	"advancements.adventure.under_lock_and_key.title": "Trancao y pesllao",
	"advancements.adventure.use_lodestone.description": "Imanta una brúxula con una magnetita",
	"advancements.adventure.use_lodestone.title": "Magnetita, llévame a casa",
	"advancements.adventure.very_very_frightening.description": "Da a un aldeanu con un rayu",
	"advancements.adventure.very_very_frightening.title": "Rayos ya centelles",
	"advancements.adventure.voluntary_exile.description": "Mata al capitán d'una invasión ya dempués nun t'averes a nengún pueblu nun tiempu, ¿acuéi?",
	"advancements.adventure.voluntary_exile.title": "Exiliu voluntariu",
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.description": "Camina sobre la nieve en polvu... ensin fundite ente ella",
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.title": "Pesu pluma",
	"advancements.adventure.who_needs_rockets.description": "Usa una Carga de Vientu pa propulsate 8 bloques p'arriba",
	"advancements.adventure.who_needs_rockets.title": "Los Cohetes son del Pasáu",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Fai qu'un allay dexe cayer una tarta n'un bloque de notes",
	"advancements.husbandry.allay_deliver_cake_to_note_block.title": "Canción de Cumpleaños",
	"advancements.husbandry.allay_deliver_item_to_player.description": "Fai qu'un Allay t'apurra oxetos",
	"advancements.husbandry.allay_deliver_item_to_player.title": "Ties un amigo en min",
	...
	"advancements.husbandry.breed_an_animal.title": "Les flores ya les abeyes",
	...
	"advancements.husbandry.feed_snifflet.description": "Alimenta a un golifu",
	"advancements.husbandry.feed_snifflet.title": "Pequenos golifos",
	...
	"advancements.husbandry.froglights.description": "Ten toles xarilluces nel inventariu",
	"advancements.husbandry.froglights.title": "¡Xuntos y Xuníos, Podemos!",
	"advancements.husbandry.kill_axolotl_target.description": "Forma equipu con un axolote y gana una engarradiella",
	"advancements.husbandry.kill_axolotl_target.title": "¡El poder curatible de l'amistá!",
	"advancements.husbandry.leash_all_frog_variants.description": "Ten a toles variantes de xaronca amarraes con un llaciu",
	"advancements.husbandry.leash_all_frog_variants.title": "Cuando la panda va blincando pela ciudá",
	"advancements.husbandry.make_a_sign_glow.description": "Fai que'l testu de cualesquier mena de cartelu brille",
	"advancements.husbandry.make_a_sign_glow.title": "¡Brilla y mira!",
	...
	"advancements.husbandry.obtain_sniffer_egg.description": "Consigui un güevu de goliflón",
	"advancements.husbandry.obtain_sniffer_egg.title": "Güel raro",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Mete un bloque de ghast secu ente agua",
	"advancements.husbandry.place_dried_ghast_in_water.title": "¡Mantente hidratáu!",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Llanta cualesquier semiente de Sniffer",
	"advancements.husbandry.plant_any_sniffer_seed.title": "Llantando'l pasáu",
	"advancements.husbandry.plant_seed.description": "Planta una semiente y mírala medrar",
	"advancements.husbandry.plant_seed.title": "Un llugar semáu",
	"advancements.husbandry.remove_wolf_armor.description": "Quíta-y l'armadura a un llobu con unes tesories",
	"advancements.husbandry.remove_wolf_armor.title": "Brillu que curta",
	"advancements.husbandry.repair_wolf_armor.description": "Igua una armadura de llobu dañada con escales d'armadillu",
	"advancements.husbandry.repair_wolf_armor.title": "Como nuevu",
	"advancements.husbandry.ride_a_boat_with_a_goat.description": "Súbite a un barcu y flota con una cabra",
	"advancements.husbandry.ride_a_boat_with_a_goat.title": "'Lo que te mantenga nel aire!",
	"advancements.husbandry.root.description": "El mundu ta enllén de collacios ya comida",
	"advancements.husbandry.root.title": "Bayura",
	"advancements.husbandry.safely_harvest_honey.description": "Usa una fogera pa catar miel d'un caxellu con una botella de cristal ensin enritar les abeyes",
	"advancements.husbandry.safely_harvest_honey.title": "Abelantre, esta ye la to casa",
	"advancements.husbandry.silk_touch_nest.description": "Muevi un caxellu con 3 abeyes usando toque de seda",
	"advancements.husbandry.silk_touch_nest.title": "Dexa d'abeyar, ho",
	"advancements.husbandry.tactical_fishing.description": "Atrapa un pexe... ¡Ensin una caña de pescar!",
	"advancements.husbandry.tactical_fishing.title": "Pesca táutica",
	"advancements.husbandry.tadpole_in_a_bucket.description": "Atrapa un renacuayu nun calderu",
	"advancements.husbandry.tadpole_in_a_bucket.title": "Renacuayu al balde",
	...
	"advancements.husbandry.uh_oh.description": "Fai un cubu d'azufre absorba un bloque de TNT",
	"advancements.husbandry.uh_oh.title": "Ai, non",
	"advancements.husbandry.wax_off.description": "¡Llima la cera d'un bloque de cobre!",
	"advancements.husbandry.wax_off.title": "Des-Enceráu",
	"advancements.husbandry.wax_on.description": "¡Aplica una seta a un bloque de cobre!",
	"advancements.husbandry.wax_on.title": "Enceráu",
	"advancements.husbandry.whole_pack.description": "Adoma toles variantes de llobu",
	"advancements.husbandry.whole_pack.title": "La manada entera",
	...
	"advancements.nether.all_potions.title": "Cóctel peligrosu",
	"advancements.nether.brew_potion.description": "Fai una poción",
	"advancements.nether.brew_potion.title": "Destilería llocal",
	"advancements.nether.charge_respawn_anchor.description": "Carga un Ancla de reapaición al máximo",
	"advancements.nether.charge_respawn_anchor.title": "Igual 9 vides non, ¿eh?",
	"advancements.nether.create_beacon.description": "Constrúi y pon un faru",
	"advancements.nether.create_beacon.title": "Allumando'l camín",
	"advancements.nether.create_full_beacon.description": "Dai a un faru máxima potencia",
	...
	"advancements.nether.find_bastion.description": "Entra nun Remanente de Bastión",
	...
	"advancements.nether.loot_bastion.description": "Roba una arca nuna Remanente de bastión",
	"advancements.nether.loot_bastion.title": "Guerreros gochos",
	"advancements.nether.netherite_armor.description": "Consigue tol conxuntu de l'armadura de netherita",
	...
	"advancements.nether.ride_strider.description": "Montate nun Lavagante con un hongo alteráu nun palu",
	"advancements.nether.ride_strider.title": "Esta barca tien pates",
	"advancements.nether.ride_strider_in_overworld_lava.description": "Da un llaaaaaaaaargu paséu con un lavagante sobro un llagu de lava na superficie",
	"advancements.nether.ride_strider_in_overworld_lava.title": "Siéntese como nel llar",
	...
	"advancements.nether.use_lodestone.description": "Usa una brúxula n'una magnetita",
	"advancements.nether.use_lodestone.title": "Magnetita, llévame a casina",
	...
	"advancements.story.deflect_arrow.description": "Devuelve un proyectil con un escudu",
	...
	"advancements.story.form_obsidian.description": "Consigue un bloque d'obsidiana",
	"advancements.story.form_obsidian.title": "Llava… ¿esfrecío?",
	"advancements.story.iron_tools.description": "Meyora el to picu",
	"advancements.story.iron_tools.title": "Nun dar en fierro",
	"advancements.story.lava_bucket.description": "Llena un caldeiru con agua",
	...
	"advancements.story.mine_stone.description": "Mina piedres col to nuevu picu",
	...
	"advancements.story.root.description": "El corazón ya la hestoria del xuegu",
	...
	"advancements.story.smelt_iron.description": "Funde un lingote de fierro",
	"advancements.story.smelt_iron.title": "En fierros",
	"advancements.story.upgrade_tools.description": "Faite un meyor picu de fierro",
	...
	"argument.angle.incomplete": "Incompletu (requier 1 ángulu)",
	"argument.angle.invalid": "L'ángulu nun ye válidu",
	"argument.block.id.invalid": "Tipu de bloque \"%s' desconocíu",
	"argument.block.property.duplicate": "La propiedá '%s' d'l bloque %s solo pode ponese una vegada",
	"argument.block.property.invalid": "El bloque %s nun acepta \"%s\" para la propiedá \"%s\"",
	"argument.block.property.novalue": "Ríquese un valor para la propiedá \"%s\" del bloque %s",
	"argument.block.property.unclosed": "Esperábase'l corchete de zarru pa bloquiar les propiedaes del estáu",
	"argument.block.property.unknown": "El bloque %s nun tien la propiedá «%s»",
	"argument.block.tag.disallowed": "Equí nun se permiten les etiquetes, namás bloques",
	"argument.color.invalid": "Desconozse'l color «%s»",
	"argument.component.invalid": "Componente de chat non válidu: %s",
	...
	"argument.entity.invalid": "El nome o la UUID nun son válidos",
	...
	"argument.entity.options.dx.description": "Entidaes ente x ya x + dx",
	"argument.entity.options.dy.description": "Entidaes ente y ya y + dy",
	"argument.entity.options.dz.description": "Entidaes ente z ya z + dz",
	"argument.entity.options.gamemode.description": "Xugadores con mou de xuegu",
	"argument.entity.options.inapplicable": "Equí nun se pue aplicar la opción «%s»",
	"argument.entity.options.level.description": "Nivel d'esperiencia",
	"argument.entity.options.level.negative": "El nivel nun habría ser negativu",
	...
	"argument.entity.options.mode.invalid": "Mou de xuegu non válidu o desconocíu: %s",
	...
	"argument.entity.options.sort.description": "Ordenar entidaes",
	"argument.entity.options.sort.irreversible": "El tipu de clasificación \"%s\" ye desconocíu o nun ye válidu",
	"argument.entity.options.tag.description": "Entidaes con etiqueta",
	"argument.entity.options.team.description": "Entidaes nel equipu",
	"argument.entity.options.type.description": "Entidaes de un tipu determináu",
	"argument.entity.options.type.invalid": "Tipu d'entidá inválidu o desconocíu '%s'",
	"argument.entity.options.unknown": "Desconozse la opción «%s»",
	"argument.entity.options.unterminated": "Esperábase un corchete de zarru",
	"argument.entity.options.valueless": "Valor esperáu pa la opción '%s'",
	"argument.entity.options.x.description": "Posición en x",
	"argument.entity.options.x_rotation.description": "Rotación en x de la entidá",
	"argument.entity.options.y.description": "Posición en y",
	"argument.entity.options.y_rotation.description": "Rotación en y de la entidad",
	"argument.entity.options.z.description": "Posición en z",
	"argument.entity.selector.allEntities": "Toles entidaes",
	"argument.entity.selector.allPlayers": "Tolos xugadores",
	"argument.entity.selector.missing": "Faltache'l tipu de selector",
	"argument.entity.selector.nearestEntity": "La entidad más cercana",
	"argument.entity.selector.nearestPlayer": "El xugador más cercanu",
	"argument.entity.selector.not_allowed": "Selector non permitíu",
	"argument.entity.selector.randomPlayer": "Xugador al debalu",
	"argument.entity.selector.self": "Entidá actual",
	"argument.entity.selector.unknown": "Tipu de selector desconocíu '%s'",
	"argument.entity.toomany": "Namás se permite una entidá mas el selector apurríu permite más d'una",
	"argument.enum.invalid": "Valor non válidu \"%s\"",
	...
	"argument.gamemode.invalid": "Mou de xuegu desconocíu: %s",
	"argument.hexcolor.invalid": "Códigu de color hexadecimal non válidu '%s'",
	...
	"argument.item.tag.disallowed": "Les etiquetes nun tan permitíes equí, namái elementos reales",
	"argument.literal.incorrect": "Espérase un lletal %s",
	...
	"argument.message.too_long": "El mensaxe de chat yera muncho llargu (%s > máximu de %s caracteres)",
	"argument.nbt.array.invalid": "Triba de matriz inválida '%s'",
	"argument.nbt.array.mixed": "Nun se pue inxertar %s en %s",
	"argument.nbt.expected.compound": "Requíerese etiqueta compuesta",
	"argument.nbt.expected.key": "Esperábase una clave",
	"argument.nbt.expected.value": "Esperábase un valor",
	"argument.nbt.list.mixed": "Nun se pue inxertar %s na llista de %s",
	"argument.nbt.trailing": "Datos finales inesperaos",
	"argument.player.entities": "Esti comandu solo afecta a xugadores, mas el selector utilizáu inclúi entidaes",
	"argument.player.toomany": "Namás se permite un xugador mas el selector apurríu permite más d'unu",
	"argument.player.unknown": "Esi xugador nun esiste",
	"argument.pos.missing.double": "Esperábase una coordenada",
	"argument.pos.missing.int": "Ríquese la posición d'un bloque",
	"argument.pos.mixed": "Nun se puen mecer les coordenaes del mundu ya les llocales (les dos han usar ^ o non)",
	...
	"argument.pos2d.incomplete": "Incompletu (precísense 2 coordenaes)",
	"argument.pos3d.incomplete": "El comandu ta incompletu (esperábense 3 coordenaes)",
	"argument.range.empty": "Valor esperáu o rangu de valores",
	...
	"argument.resource.invalid_type": "L'elementu '%s' tien un tipu incorreutu '%s' (esperábase '%s')",
	"argument.resource.not_found": "Nun se pue alcontrar l'elementu '%s' del tipu '%s'",
	"argument.resource_or_id.failed_to_parse": "Fallu al analizar la estructura: %s",
	"argument.resource_or_id.invalid": "Identificador o etiqueta inválida",
	"argument.resource_or_id.no_such_element": "Non puede atopase l'elementu '%s' nel rexistru '%s'",
	"argument.resource_selector.not_found": "Nun hai coincidencies pal selector '%s' de tipu '%s'",
	"argument.resource_tag.invalid_type": "La etiqueta '%s' tien un tipu incorreutu '%s' (esperábase '%s')",
	"argument.resource_tag.not_found": "Nun se pue alcontrar la etiqueta '%s' de tipu '%s'",
	...
	"argument.scoreboardDisplaySlot.invalid": "El ranuru d'amuesa desconocíu '%s'",
	"argument.style.invalid": "L'estilu ye inválidu: %s",
	"argument.time.invalid_tick_count": "La cuntá de marques tien que ser non negativa",
	"argument.time.invalid_unit": "La unidá ye inválida",
	"argument.time.tick_count_too_low": "La cuntá de marques nun puede ser menos de %s, atopóse %s",
	"argument.uuid.invalid": "La UUID nun ye válida",
	"argument.waypoint.invalid": "La entidá seleccioná nun tien una señal",
	...
	"arguments.item.component.expected": "Componente d'elementu esperáu",
	"arguments.item.component.malformed": "Componente mal formáu '%s': '%s'",
	"arguments.item.component.repeated": "El componenti d'elementu '%s' s'esta repitiendo, pero namás pue especificase un valor",
	"arguments.item.component.unknown": "Componente d'elementu desconocíu '%s'",
	"arguments.item.malformed": "Elementu mal formáu: '%s'",
	"arguments.item.overstacked": "%s namás pue apilase hasta %s",
	"arguments.item.predicate.malformed": "Predicáu mal formáu: '%s' '%s'",
	"arguments.item.predicate.unknown": "Predicáu d'elementu desconocíu '%s'",
	"arguments.item.tag.unknown": "Etiqueta d'elementu desconocida '%s'",
	"arguments.nbtpath.node.invalid": "Elementu de ruta NBT inválidu",
	"arguments.nbtpath.nothing_found": "Nun s'atoparon elementos que concasen con %s",
	"arguments.nbtpath.too_deep": "NBT resultante demasiado anidáu",
	"arguments.nbtpath.too_large": "Taas oo keentay NBT aad u weyn",
	"arguments.objective.notFound": "Oxetivu de tabla desconocíu '%s'",
	"arguments.objective.readonly": "L'oxetivu éstoesu de la tabla '%s' es namái de llectura",
	"arguments.operation.div0": "Nun se pue dividir por cero",
	"arguments.operation.invalid": "La operación ye inválida",
	...
	"attribute.name.armor_toughness": "Dureza de la armadura",
	"attribute.name.attack_damage": "Daño de ataque",
	"attribute.name.attack_knockback": "Retroceso de ataque",
	"attribute.name.attack_speed": "Velocidá d'ataque",
	"attribute.name.below_name_distance": "Nome la etiqueta de distancia",
	"attribute.name.block_break_speed": "Velocidá de rotura de bloques",
	"attribute.name.block_interaction_range": "Rango d'interacción de bloques",
	"attribute.name.bounciness": "Bounciness",
	"attribute.name.burning_time": "Tiempu de quemáu",
	"attribute.name.camera_distance": "Distancia de la Cámara",
	"attribute.name.entity_interaction_range": "Rango d'interacción d'entidaes",
	"attribute.name.explosion_knockback_resistance": "Resistencia al retroceso de la explosión",
	"attribute.name.fall_damage_multiplier": "Multiplicador de daño por caída",
	"attribute.name.flying_speed": "Velocidá de vuelu",
	"attribute.name.follow_range": "Rangu de seguimientu de la mafia",
	...
	"attribute.name.generic.attack_knockback": "Retrocesu d'ataque",
	"attribute.name.generic.attack_speed": "de velocidá d'ataque",
	"attribute.name.generic.block_interaction_range": "Rangu d'interacción con bloques",
	"attribute.name.generic.burning_time": "Tiempu de quemáu",
	"attribute.name.generic.entity_interaction_range": "Rangu d'interacción con entidaes",
	"attribute.name.generic.explosion_knockback_resistance": "Resistencia l'empuxón d'esplosión",
	"attribute.name.generic.fall_damage_multiplier": "Multiplicador de dañu per cayida",
	...
	"attribute.name.generic.jump_strength": "Potencia de Saltu",
	...
	"attribute.name.generic.movement_efficiency": "Eficiencia de movimientu",
	"attribute.name.generic.movement_speed": "Velocidá",
	"attribute.name.generic.oxygen_bonus": "Bonus d'oxíxenu",
	"attribute.name.generic.safe_fall_distance": "Distancia de cayida segura",
	"attribute.name.generic.scale": "Escala",
	"attribute.name.generic.step_height": "Altor del pasu",
	"attribute.name.generic.water_movement_efficiency": "Eficiencia de movimientu na agua",
	"attribute.name.gravity": "Gravedá",
	"attribute.name.horse.jump_strength": "Fuercia del saltu'l caballu",
	"attribute.name.jump_strength": "Fuerza del saltu",
	"attribute.name.knockback_resistance": "Resistencia de retrocesu",
	"attribute.name.luck": "Suerte",
	"attribute.name.max_absorption": "Absorción Máxima",
	"attribute.name.max_health": "Salú máxima",
	"attribute.name.mining_efficiency": "Eficiencia al minar",
	"attribute.name.movement_efficiency": "Eficiencia de movimientu",
	"attribute.name.movement_speed": "Velocidá",
	"attribute.name.nameplate_distance": "Distancia la etiqueta de xugador",
	"attribute.name.oxygen_bonus": "Bonus d'osíxenu",
	"attribute.name.player.block_break_speed": "Velocidá de frayatu del bloque",
	"attribute.name.player.block_interaction_range": "Rangue d'interacción con bloques",
	"attribute.name.player.entity_interaction_range": "Rangue d'interacción con entidaes",
	"attribute.name.player.mining_efficiency": "Eficiencia de minaú",
	"attribute.name.player.sneaking_speed": "Velocidá d'escuenta",
	"attribute.name.player.submerged_mining_speed": "Velocidá de mina sumerxida",
	"attribute.name.player.sweeping_damage_ratio": "Razón de dañu de barríu",
	"attribute.name.safe_fall_distance": "Distancia de cayida segura",
	"attribute.name.scale": "Escala",
	"attribute.name.sneaking_speed": "Velocidá d'esclucar",
	"attribute.name.spawn_reinforcements": "Refuerzos zombi",
	"attribute.name.step_height": "Altor de pasu",
	"attribute.name.submerged_mining_speed": "Velocidá de minería sumerxida",
	"attribute.name.sweeping_damage_ratio": "Relación de dañu de barríu",
	"attribute.name.tempt_range": "Radiu d'atracción de criatures",
	"attribute.name.water_movement_efficiency": "Eficiencia de movimientu nel agua",
	"attribute.name.waypoint_receive_range": "Rangu de Recepción del Puntu de Referencia",
	...
	"biome.minecraft.desert": "Desiertu",
	"biome.minecraft.dripstone_caves": "Cueves d'espeleotema",
	"biome.minecraft.end_barrens": "Xubíu End",
	"biome.minecraft.end_highlands": "Tierres altes del End",
	"biome.minecraft.end_midlands": "Medio End",
	...
	"biome.minecraft.frozen_peaks": "Picos de Europa",
	"biome.minecraft.frozen_river": "Ríu xeláu",
	"biome.minecraft.grove": "Robledal",
	"biome.minecraft.ice_spikes": "Picos de xelu",
	"biome.minecraft.jagged_peaks": "Picos escarpiaos",
	"biome.minecraft.jungle": "Xungla",
	"biome.minecraft.lukewarm_ocean": "Océanu templáu",
	"biome.minecraft.lush_caves": "Cueves frondoses",
	"biome.minecraft.mangrove_swamp": "Manglar de marisqueiras",
	"biome.minecraft.meadow": "Prau",
	"biome.minecraft.mushroom_fields": "Campos de fungos",
	"biome.minecraft.nether_wastes": "Desiertu Escuerdo",
	"biome.minecraft.ocean": "Océanu",
	"biome.minecraft.old_growth_birch_forest": "Bocarza de quilces pernenes",
	"biome.minecraft.old_growth_pine_taiga": "Anciana taiga de pino",
	"biome.minecraft.old_growth_spruce_taiga": "Antigua taiga de abetos",
	"biome.minecraft.pale_garden": "Xardín pálidu",
	...
	"biome.minecraft.snowy_beach": "Sablera nevada",
	"biome.minecraft.snowy_plains": "Llanures nevancies",
	"biome.minecraft.snowy_slopes": "Mozos nevares",
	"biome.minecraft.snowy_taiga": "Taiga nevada",
	"biome.minecraft.soul_sand_valley": "Valle de sable d'ánimes",
	"biome.minecraft.sparse_jungle": "Xunglá espaciada",
	"biome.minecraft.stony_peaks": "Picos pedregosos",
	"biome.minecraft.stony_shore": "Costa pedregalosa",
	"biome.minecraft.sulfur_caves": "Cueves d'azufre",
	"biome.minecraft.sunflower_plains": "Llanada de xirasoles",
	"biome.minecraft.swamp": "Pantanu",
	"biome.minecraft.taiga": "Taiga",
	"biome.minecraft.the_end": "Tineo",
	"biome.minecraft.the_void": "Mieres del camin",
	"biome.minecraft.warm_ocean": "Océanu caliente",
	"biome.minecraft.warped_forest": "Viesca distorsionada",
	"biome.minecraft.windswept_forest": "Bosque barríu polo vientu",
	"biome.minecraft.windswept_gravelly_hills": "Colles calizas desgastadas polo vientu",
	"biome.minecraft.windswept_hills": "Colles barríes polo vientu",
	"biome.minecraft.windswept_savanna": "Savana barría polo vientu",
	"biome.minecraft.wooded_badlands": "Brameles con arboláu",
	...
	"block.minecraft.acacia_hanging_sign": "Cartel colgante d'acaciu",
	...
	"block.minecraft.acacia_shelf": "Estantería d'alcacia",
	...
	"block.minecraft.acacia_wall_hanging_sign": "Cartel colgante d'acaciu pa la pared",
	...
	"block.minecraft.amethyst_cluster": "Conxuntu d'amatistas",
	...
	"block.minecraft.bamboo_block": "Bloquéu de bambú",
	"block.minecraft.bamboo_button": "Botón de bambú",
	"block.minecraft.bamboo_door": "Puerta de bambú",
	"block.minecraft.bamboo_fence": "Cercáu de bambú",
	"block.minecraft.bamboo_fence_gate": "Puerta de cercáu de bambú",
	"block.minecraft.bamboo_hanging_sign": "Cartelu colgante de bambú",
	"block.minecraft.bamboo_mosaic": "Mosaico de bambú",
	"block.minecraft.bamboo_mosaic_slab": "Lladríu de mosaico de bambú",
	"block.minecraft.bamboo_mosaic_stairs": "Escaleres de mosaicu de bambú",
	...
	"block.minecraft.bamboo_shelf": "Estantería de bambú",
	"block.minecraft.bamboo_sign": "Cartelu de bambú",
	"block.minecraft.bamboo_slab": "Madera de bambú",
	"block.minecraft.bamboo_stairs": "Escaleres de bambú",
	"block.minecraft.bamboo_trapdoor": "Portella trampa de bambú",
	"block.minecraft.bamboo_wall_hanging_sign": "Cartelu de bambú pa colgar na paret",
	"block.minecraft.bamboo_wall_sign": "Cartelu de bambú pa pindiar na pared",
	...
	"block.minecraft.banner.flow.black": "Fluyíu negru",
	"block.minecraft.banner.flow.blue": "Fluyíu azul",
	"block.minecraft.banner.flow.brown": "Fluyíu marrón",
	"block.minecraft.banner.flow.cyan": "Fluyíu cian",
	"block.minecraft.banner.flow.gray": "Fluyíu gris",
	"block.minecraft.banner.flow.green": "Fluyíu verde",
	"block.minecraft.banner.flow.light_blue": "Fluyíu azul claro",
	"block.minecraft.banner.flow.light_gray": "Fluyíu gris claro",
	"block.minecraft.banner.flow.lime": "Fluyíu lima",
	"block.minecraft.banner.flow.magenta": "Fluyíu magenta",
	"block.minecraft.banner.flow.orange": "Fluyíu naranja",
	"block.minecraft.banner.flow.pink": "Fluyíu rosa",
	"block.minecraft.banner.flow.purple": "Fluyíu púrpura",
	"block.minecraft.banner.flow.red": "Fluyíu rojo",
	"block.minecraft.banner.flow.white": "Fluyíu blanco",
	"block.minecraft.banner.flow.yellow": "Fluyíu amarillo",
	...
	"block.minecraft.banner.globe.light_gray": "Planeta buxa clara",
	...
	"block.minecraft.banner.guster.black": "Rafagón negro",
	"block.minecraft.banner.guster.blue": "Estampáu azul de breeze",
	"block.minecraft.banner.guster.brown": "Estampáu marrón de breeze",
	"block.minecraft.banner.guster.cyan": "Estampáu cian de breeze",
	"block.minecraft.banner.guster.gray": "Estampáu gris de breeze",
	"block.minecraft.banner.guster.green": "Estampáu verde de breeze",
	"block.minecraft.banner.guster.light_blue": "Estampáu azul claro de breeze",
	"block.minecraft.banner.guster.light_gray": "Estampáu gris claro de breeze",
	"block.minecraft.banner.guster.lime": "Estampáu llima de breeze",
	"block.minecraft.banner.guster.magenta": "Estampáu magenta de breeze",
	"block.minecraft.banner.guster.orange": "Estampáu naranxa de breeze",
	"block.minecraft.banner.guster.pink": "Estampáu rosa de breeze",
	"block.minecraft.banner.guster.purple": "Estampáu moráu de breeze",
	"block.minecraft.banner.guster.red": "Estampáu colloráu de breeze",
	"block.minecraft.banner.guster.white": "Estampáu blancu de breeze",
	"block.minecraft.banner.guster.yellow": "Estampáu mariellu de breeze",
	...
	"block.minecraft.banner.piglin.light_blue": "Focicu azul claru",
	"block.minecraft.banner.piglin.light_gray": "Focicu gris claru",
	...
	"block.minecraft.birch_hanging_sign": "Cartel сolgante de abedul",
	...
	"block.minecraft.birch_shelf": "Estantería de bidul",
	...
	"block.minecraft.birch_wall_hanging_sign": "Cartel de pared colgante de abedul",
	...
	"block.minecraft.brick_stairs": "Pasales de lladriyos",
	...
	"block.minecraft.budding_amethyst": "Amatista naciente",
	"block.minecraft.bush": "Parrotal",
	...
	"block.minecraft.calibrated_sculk_sensor": "Sensor sculk calibráu",
	...
	"block.minecraft.cauldron": "Calderu",
	"block.minecraft.cave_air": "Aire de cueva",
	"block.minecraft.cave_vines": "Víes de cueva",
	"block.minecraft.cave_vines_plant": "Planta de vies de cueva",
	"block.minecraft.chain": "Cadena",
	"block.minecraft.chain_command_block": "Bloque de comandos en cadena",
	"block.minecraft.cherry_button": "Botón de cereza",
	"block.minecraft.cherry_door": "Puerta de cerezo",
	"block.minecraft.cherry_fence": "Valla de cerezu",
	"block.minecraft.cherry_fence_gate": "Portón de cerezu",
	"block.minecraft.cherry_hanging_sign": "Cartel colgante de cerezo",
	"block.minecraft.cherry_leaves": "Fueyes de cerezu",
	"block.minecraft.cherry_log": "Troncu de cerezu",
	"block.minecraft.cherry_planks": "Tablones de cerezu",
	"block.minecraft.cherry_pressure_plate": "Placa de presión de cerezu",
	"block.minecraft.cherry_sapling": "Renovellu de cerezu",
	"block.minecraft.cherry_shelf": "Estantería de cerezu",
	"block.minecraft.cherry_sign": "Señal de cerezu",
	"block.minecraft.cherry_slab": "Tabla de cerezu",
	"block.minecraft.cherry_stairs": "Escaleres de cerezu",
	"block.minecraft.cherry_trapdoor": "Escaleres de cerezu",
	"block.minecraft.cherry_wall_hanging_sign": "Señal de parede colgante de cerezu",
	"block.minecraft.cherry_wall_sign": "Señal de parede de cerezu",
	"block.minecraft.cherry_wood": "Madera de cerezu",
	"block.minecraft.chest": "Bagul",
	"block.minecraft.chipped_anvil": "Xuncla estellada",
	"block.minecraft.chiseled_bookshelf": "Librería trabayada a mano",
	"block.minecraft.chiseled_cinnabar": "Cinabriu cincelao",
	"block.minecraft.chiseled_copper": "Cobre talláu",
	"block.minecraft.chiseled_deepslate": "Pizarra cincelao",
	"block.minecraft.chiseled_nether_bricks": "Lladriyos del Nether cincelaos",
	"block.minecraft.chiseled_polished_blackstone": "Nigrilitu pulío ya cincelao",
	...
	"block.minecraft.chiseled_resin_bricks": "Lladriyos de resina cincelaos",
	"block.minecraft.chiseled_sandstone": "Gres cincelao",
	"block.minecraft.chiseled_stone_bricks": "Lladriyos de piedra cincelao",
	"block.minecraft.chiseled_sulfur": "Azofre cincelao",
	"block.minecraft.chiseled_tuff": "Tufu esculpíu",
	"block.minecraft.chiseled_tuff_bricks": "Lladríos de tufu esculpíos",
	"block.minecraft.chorus_flower": "Flor del Coru",
	"block.minecraft.chorus_plant": "Planta del Coru",
	"block.minecraft.cinnabar": "Cinabriu",
	"block.minecraft.cinnabar_brick_slab": "Llábana de lladriyu de cinabriu",
	"block.minecraft.cinnabar_brick_stairs": "Escaleres de lladriyu de cinabriu",
	"block.minecraft.cinnabar_brick_wall": "Muria de lladriyu de cinabriu",
	"block.minecraft.cinnabar_bricks": "Lladriyos de cinabriu",
	"block.minecraft.cinnabar_slab": "Llábana de cinabriu",
	"block.minecraft.cinnabar_stairs": "Escaleres de cinabriu",
	"block.minecraft.cinnabar_wall": "Muria de cinabriu",
	...
	"block.minecraft.copper_bulb": "Bombía de cobre",
	"block.minecraft.copper_chain": "Cadena de cobre",
	"block.minecraft.copper_chest": "Bagul de cobre",
	"block.minecraft.copper_door": "Puerta de cobre",
	"block.minecraft.copper_golem_statue": "Estatua de gólem de cobre",
	"block.minecraft.copper_grate": "Reixeta de cobre",
	"block.minecraft.copper_lantern": "Llámpara de cobre",
	"block.minecraft.copper_ore": "Veta de cobre",
	"block.minecraft.copper_torch": "Antorcha de cobre",
	"block.minecraft.copper_trapdoor": "Reixeta de cobre",
	"block.minecraft.copper_wall_torch": "Antorcha de cobre en paré",
	...
	"block.minecraft.cracked_polished_blackstone_bricks": "Lladriyos de nigrilitu pulío frañaos",
	"block.minecraft.cracked_stone_bricks": "Lladriyos de piedra frañaos",
	"block.minecraft.crafter": "Artesán",
	"block.minecraft.crafting_table": "Mesa d'ellaboración",
	"block.minecraft.creaking_heart": "Corazón Crespu",
	...
	"block.minecraft.crimson_door": "Puerta carmesina",
	"block.minecraft.crimson_fence": "Valla carmesina",
	"block.minecraft.crimson_fence_gate": "Portiella carmesina",
	"block.minecraft.crimson_fungus": "Fungu carmesín",
	"block.minecraft.crimson_hanging_sign": "Cartel colgante carmesí",
	"block.minecraft.crimson_hyphae": "Hixas carmesí",
	"block.minecraft.crimson_nylium": "Niliu carmesín",
	"block.minecraft.crimson_planks": "Tables carmesines",
	"block.minecraft.crimson_pressure_plate": "Placa de presión carmesín",
	"block.minecraft.crimson_roots": "Yerba carmesín",
	"block.minecraft.crimson_shelf": "Estantería carmesina",
	"block.minecraft.crimson_sign": "Cartelu carmesín",
	"block.minecraft.crimson_slab": "Llábana carmesina",
	"block.minecraft.crimson_stairs": "Pasales carmesinos",
	"block.minecraft.crimson_stem": "Madera carmesín",
	"block.minecraft.crimson_trapdoor": "Trapiella carmesina",
	"block.minecraft.crimson_wall_hanging_sign": "Cartel coleandero de muria carmesín",
	"block.minecraft.crimson_wall_sign": "Cartel de muria carmesí",
	...
	"block.minecraft.cut_red_sandstone_slab": "Llábana de gres colorao cortao",
	"block.minecraft.cut_sandstone": "Gres cortao",
	"block.minecraft.cut_sandstone_slab": "Llábana de gres cortao",
	...
	"block.minecraft.dark_oak_button": "Botón de carbayu escuro",
	"block.minecraft.dark_oak_door": "Puerta de carbayu escuro",
	"block.minecraft.dark_oak_fence": "Valla de carbayu escuro",
	"block.minecraft.dark_oak_fence_gate": "Portiella de carbayu escuro",
	"block.minecraft.dark_oak_hanging_sign": "Cartel colgante de roble oscuro",
	"block.minecraft.dark_oak_leaves": "Fueyes de carbayu escuro",
	"block.minecraft.dark_oak_log": "Tueru de carbayu escuro",
	"block.minecraft.dark_oak_planks": "Tables de carbayu escuro",
	"block.minecraft.dark_oak_pressure_plate": "Placa de presión de carbayu escuro",
	"block.minecraft.dark_oak_sapling": "Biltu de carbayu escuro",
	"block.minecraft.dark_oak_shelf": "Estantería de carbayu escuro",
	"block.minecraft.dark_oak_sign": "Cartelu de carbayu escuro",
	"block.minecraft.dark_oak_slab": "Llábana de carbayu escuro",
	"block.minecraft.dark_oak_stairs": "Pasales de carbayu escuro",
	"block.minecraft.dark_oak_trapdoor": "Trapiella de carbayu escuro",
	"block.minecraft.dark_oak_wall_hanging_sign": "Cartel colgante de roble oscuro",
	"block.minecraft.dark_oak_wall_sign": "Cartelu de carbayu escuro na parede",
	"block.minecraft.dark_oak_wood": "Madera de carbayu escuro con corteza",
	...
	"block.minecraft.exposed_copper_bars": "Barrotes de cobre espuesto",
	"block.minecraft.exposed_copper_bulb": "Bombilla de cobre expuesta",
	"block.minecraft.exposed_copper_chain": "Cadena de cobre espuesto",
	"block.minecraft.exposed_copper_chest": "Bagul de cobre espuesto",
	"block.minecraft.exposed_copper_door": "Puerta de cobre expuesta",
	"block.minecraft.exposed_copper_golem_statue": "Estatua de Gólem de Cobre Espuesta",
	"block.minecraft.exposed_copper_grate": "Reixa de cobre espuesta",
	"block.minecraft.exposed_copper_lantern": "Llámpara de cobre espuesto",
	"block.minecraft.exposed_copper_trapdoor": "Trampa de cobre expuesta",
	"block.minecraft.exposed_cut_copper": "Cobre cortado expuesto",
	"block.minecraft.exposed_cut_copper_slab": "Loza de cobre cortada expuesta",
	"block.minecraft.exposed_cut_copper_stairs": "Escaleras de cobre cortadas expuestas",
	"block.minecraft.exposed_lightning_rod": "Pararrayos espuestu",
	"block.minecraft.farmland": "Bloque d'eru",
	...
	"block.minecraft.firefly_bush": "Parrotal de lluciérnagas",
	...
	"block.minecraft.frogspawn": "Asoccançada de sapos",
	...
	"block.minecraft.golden_dandelion": "Cardeña dorada",
	...
	"block.minecraft.infested_chiseled_stone_bricks": "Lladriyos de piedra cincelao infestaos",
	"block.minecraft.infested_cobblestone": "Llastra infestao",
	"block.minecraft.infested_cracked_stone_bricks": "Lladriyos de piedra frañíos ya infestaos",
	"block.minecraft.infested_deepslate": "Pizarra infestao",
	"block.minecraft.infested_mossy_stone_bricks": "Lladriyos de piedra mofoso ya infestao",
	"block.minecraft.infested_stone": "Piedra infestao",
	"block.minecraft.infested_stone_bricks": "Lladriyos de piedra infestao",
	"block.minecraft.iron_bars": "Barrotes de fierro",
	"block.minecraft.iron_block": "Bloque de fierro",
	"block.minecraft.iron_chain": "Cadena de fierro",
	...
	"block.minecraft.jigsaw": "Bloque de tétramuxería",
	...
	"block.minecraft.jungle_hanging_sign": "Señal colgante de la selva",
	...
	"block.minecraft.jungle_shelf": "Estantería de xungla",
	...
	"block.minecraft.jungle_wall_hanging_sign": "Paniellu colgante de la muria de la selva",
	...
	"block.minecraft.large_amethyst_bud": "Broche de amatista grande",
	"block.minecraft.large_fern": "Felechu grande",
	"block.minecraft.lava": "Llava",
	"block.minecraft.lava_cauldron": "Calderu con llava",
	"block.minecraft.leaf_litter": "Fueyes seques",
	...
	"block.minecraft.light_blue_candle_cake": "Tarta con cendra azul claru",
	...
	"block.minecraft.light_gray_bed": "Cama buxo claro",
	"block.minecraft.light_gray_candle": "Vela gris clara",
	"block.minecraft.light_gray_candle_cake": "Tarta con vela gris clara",
	...
	"block.minecraft.mangrove_button": "Botón de manglar",
	"block.minecraft.mangrove_door": "Puerta de manglar",
	"block.minecraft.mangrove_fence": "Madera de manglar",
	"block.minecraft.mangrove_fence_gate": "Puerta de cercu de mangle",
	"block.minecraft.mangrove_hanging_sign": "Cartel colgante de mangle",
	"block.minecraft.mangrove_leaves": "Fueyes de manglar",
	...
	"block.minecraft.mangrove_roots": "Raíces de manglar",
	"block.minecraft.mangrove_shelf": "Estantería de mangle",
	"block.minecraft.mangrove_sign": "Signo de manglar",
	"block.minecraft.mangrove_slab": "Llancha de manglar",
	"block.minecraft.mangrove_stairs": "Escaleres de manglar",
	"block.minecraft.mangrove_trapdoor": "Portella de manglar",
	"block.minecraft.mangrove_wall_hanging_sign": "Cartel de pared de mangle colgante",
	"block.minecraft.mangrove_wall_sign": "Cartel de pared de mangle",
	"block.minecraft.mangrove_wood": "Madera de mangle",
	"block.minecraft.medium_amethyst_bud": "Brotu mediu de ametista",
	...
	"block.minecraft.mud_brick_slab": "Llábana de lladriyu de Barru",
	"block.minecraft.mud_brick_stairs": "Escaleres de lladriyu de barru",
	"block.minecraft.mud_brick_wall": "Muria de Lladriyu de Barru",
	"block.minecraft.mud_bricks": "Lladriyos de Barru",
	"block.minecraft.muddy_mangrove_roots": "Raigañu fangosu de mangle",
	...
	"block.minecraft.nether_sprouts": "Brootes de l'infern",
	"block.minecraft.nether_wart": "Fungu del Nether",
	...
	"block.minecraft.oak_hanging_sign": "Cartel colgante de branu",
	...
	"block.minecraft.oak_shelf": "Estantería de carbayu",
	...
	"block.minecraft.oak_wall_hanging_sign": "Cartel colgante de branu de l'arriu",
	...
	"block.minecraft.ochre_froglight": "Xaroncalluz ocre",
	...
	"block.minecraft.oxidized_chiseled_copper": "Cobru ciselláu oxidáu",
	"block.minecraft.oxidized_copper": "Cobre oxidao",
	"block.minecraft.oxidized_copper_bars": "Barres de cobre ferruñoso",
	"block.minecraft.oxidized_copper_bulb": "Bombiella de cobru oxidáu",
	"block.minecraft.oxidized_copper_chain": "Cadena de cobre ferruñoso",
	"block.minecraft.oxidized_copper_chest": "Bagul de cobre ferruñoso",
	"block.minecraft.oxidized_copper_door": "Puerta de cobru oxidáu",
	"block.minecraft.oxidized_copper_golem_statue": "Estatua de Gólem de Cobre Ferruñosu",
	"block.minecraft.oxidized_copper_grate": "Reixa de cobru oxidáu",
	"block.minecraft.oxidized_copper_lantern": "Farol de Cobre Ferruñosu",
	"block.minecraft.oxidized_copper_trapdoor": "Trampexa de cobru oxidáu",
	...
	"block.minecraft.oxidized_lightning_rod": "Pararrayos de Cobre Ferruñosu",
	"block.minecraft.packed_ice": "Xelu compauto",
	"block.minecraft.packed_mud": "Barru Compauto",
	"block.minecraft.pale_hanging_moss": "Mofu pálido colgante",
	"block.minecraft.pale_moss_block": "Bloque de mofu pálido",
	"block.minecraft.pale_moss_carpet": "Alfombra de mofu pálido",
	"block.minecraft.pale_oak_button": "Botón de carbayu pálido",
	"block.minecraft.pale_oak_door": "Puerta de carbayu pálido",
	"block.minecraft.pale_oak_fence": "Valla de carbayu pálido",
	"block.minecraft.pale_oak_fence_gate": "Puerta de valla de carbayu pálido",
	"block.minecraft.pale_oak_hanging_sign": "Cartelu colgante de carbayu pálido",
	"block.minecraft.pale_oak_leaves": "Fueyes de carbayu pálido",
	"block.minecraft.pale_oak_log": "Tueru de carbayu pálido",
	"block.minecraft.pale_oak_planks": "Tablones de carbayu pálido",
	"block.minecraft.pale_oak_pressure_plate": "Placa de presión de carbayu pálido",
	"block.minecraft.pale_oak_sapling": "Biltu de carbayu pálido",
	"block.minecraft.pale_oak_shelf": "Estantería de carbayu pálido",
	"block.minecraft.pale_oak_sign": "Cartelu de carbayu pálido",
	"block.minecraft.pale_oak_slab": "Llosa de carbayu pálido",
	"block.minecraft.pale_oak_stairs": "Escaleres de carbayu pálido",
	"block.minecraft.pale_oak_trapdoor": "Trapiella de carbayu pálido",
	"block.minecraft.pale_oak_wall_hanging_sign": "Cartelu colgante de carbayu pálido na paré",
	"block.minecraft.pale_oak_wall_sign": "Cartelu de carbayu pálido na paré",
	"block.minecraft.pale_oak_wood": "Tochu de carbayu pálido",
	"block.minecraft.pearlescent_froglight": "Xaroncalluz nacarada",
	...
	"block.minecraft.piglin_wall_head": "Cabeza de piglin na paré",
	...
	"block.minecraft.pink_petals": "Pétalos roses",
	...
	"block.minecraft.pitcher_crop": "Cultivu de cántarus",
	"block.minecraft.pitcher_plant": "Planta de cántaros",
	...
	"block.minecraft.polished_cinnabar": "Cinabriu apolazao",
	"block.minecraft.polished_cinnabar_slab": "Llábana de cinabriu apolazao",
	"block.minecraft.polished_cinnabar_stairs": "Escaleres de cinabriu apolazao",
	"block.minecraft.polished_cinnabar_wall": "Muria de cinabriu apolazao",
	...
	"block.minecraft.polished_sulfur": "Azufre pulío",
	"block.minecraft.polished_sulfur_slab": "Llábana d'azufre pulío",
	"block.minecraft.polished_sulfur_stairs": "Escaleres d'azufre pulío",
	"block.minecraft.polished_sulfur_wall": "Muria d'azufre pulío",
	"block.minecraft.polished_tuff": "Tufu pulíu",
	"block.minecraft.polished_tuff_slab": "Solanca de tufu pulíu",
	"block.minecraft.polished_tuff_stairs": "Escaleres de tufu pulida",
	"block.minecraft.polished_tuff_wall": "Muria de tufu pulía",
	...
	"block.minecraft.potted_cherry_sapling": "Planta de cereza en maceta",
	"block.minecraft.potted_closed_eyeblossom": "Tiestu con miraflor cerrada",
	...
	"block.minecraft.potted_dark_oak_sapling": "Tiestu con un biltu de carbayu escuro",
	"block.minecraft.potted_dead_bush": "Matu muertu n'unu macetu",
	...
	"block.minecraft.potted_mangrove_propagule": "Propágulu de mangle nuna maceta",
	"block.minecraft.potted_oak_sapling": "Tiestu con un biltu de carbayu",
	"block.minecraft.potted_open_eyeblossom": "Tiestu con miraflor abierta",
	...
	"block.minecraft.potted_pale_oak_sapling": "Tiestu con biltu de carbayu pálido",
	...
	"block.minecraft.potted_torchflower": "Maceta de flor de antorcha",
	...
	"block.minecraft.powder_snow_cauldron": "Caldera con nieve en polvu",
	...
	"block.minecraft.reinforced_deepslate": "Profundu fragu reinforciau",
	...
	"block.minecraft.resin_brick_stairs": "Escaleres de lladriyos de resina",
	...
	"block.minecraft.sculk_catalyst": "Catalizador sculk",
	"block.minecraft.sculk_sensor": "Sensor sculk",
	"block.minecraft.sculk_shrieker": "Glayador de Sculk",
	...
	"block.minecraft.short_grass": "Miera curta",
	"block.minecraft.shroomlight": "Setubril",
	...
	"block.minecraft.small_amethyst_bud": "Florecína ametista pequeño",
	...
	"block.minecraft.sniffer_egg": "Corvu d'olfatiu",
	...
	"block.minecraft.soul_wall_torch": "Llume de muria d'almes",
	"block.minecraft.spawn.not_valid": "Non tienes cama de llar, cama de resurreición cargada o foi obstruyida",
	"block.minecraft.spawner": "Creador de monstruos",
	"block.minecraft.spawner.desc1": "Interactuar cola Güevu d'aportiu:",
	"block.minecraft.spawner.desc2": "Axusta'l tipu d'averá",
	...
	"block.minecraft.spruce_hanging_sign": "Cartel colgante de abetu",
	...
	"block.minecraft.spruce_wall_hanging_sign": "Cartel colgante de pared de abetu",
	...
	"block.minecraft.stripped_bamboo_block": "Bloque de bambú peláu",
	...
	"block.minecraft.stripped_cherry_log": "Trocín de cerru peláu",
	"block.minecraft.stripped_cherry_wood": "Madera de cerru peláu",
	"block.minecraft.stripped_crimson_hyphae": "Hífaes escarletes peladaes",
	"block.minecraft.stripped_crimson_stem": "Tueru carmesín ensin corteza",
	"block.minecraft.stripped_dark_oak_log": "Tueru de carbayu escuro ensin corteza",
	"block.minecraft.stripped_dark_oak_wood": "Madera de carbayu escuro ensin corteza",
	...
	"block.minecraft.stripped_mangrove_log": "Trocín de manglar peláu",
	"block.minecraft.stripped_mangrove_wood": "Madera de manglar peláu",
	...
	"block.minecraft.stripped_pale_oak_wood": "Madera de Carbayu Pálidu Espelleyada",
	...
	"block.minecraft.stripped_warped_hyphae": "Hífaes xiries peladaes",
	...
	"block.minecraft.sulfur_brick_slab": "Llosa de lladriyos d'azufre",
	"block.minecraft.sulfur_brick_stairs": "Escaleres de lladriyos d'azufre",
	"block.minecraft.sulfur_brick_wall": "Muria de lladriyos d'azufre",
	"block.minecraft.sulfur_bricks": "Lladriyos d'azufre",
	"block.minecraft.sulfur_slab": "Llábana d'azufre",
	"block.minecraft.sulfur_spike": "Picos d'azufre",
	"block.minecraft.sulfur_stairs": "Escaleres d'azufre",
	"block.minecraft.sulfur_wall": "Muria d'azufre",
	"block.minecraft.sunflower": "Xirasol",
	"block.minecraft.suspicious_gravel": "Gravilla sospechosa",
	"block.minecraft.suspicious_sand": "Arenes sospechoses",
	"block.minecraft.sweet_berry_bush": "Arbuste de berries dulces",
	"block.minecraft.tall_dry_grass": "Yerba seco alto",
	...
	"block.minecraft.test_block": "Bloque de Prebes",
	"block.minecraft.test_instance_block": "Test Instance Block",
	"block.minecraft.tinted_glass": "Vidru tiñío",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "Les esplosiones de TNT tan desactivaes",
	"block.minecraft.torch": "Antorcha",
	"block.minecraft.torchflower": "Flor torcia",
	"block.minecraft.torchflower_crop": "Cosecha de flores de torcia",
	"block.minecraft.trapped_chest": "Bagul trampa",
	"block.minecraft.trial_spawner": "Xenerador de prueba",
	...
	"block.minecraft.tuff_brick_slab": "Llosa de lladriyos de toba",
	"block.minecraft.tuff_brick_stairs": "Pasales de Lladriyos de Toba",
	"block.minecraft.tuff_brick_wall": "Muria de Lladriyos de Toba",
	"block.minecraft.tuff_bricks": "Tuff Bricks",
	"block.minecraft.tuff_slab": "Tuff Slab",
	"block.minecraft.tuff_stairs": "Pasales de Toba",
	"block.minecraft.tuff_wall": "Muria de Toba",
	...
	"block.minecraft.verdant_froglight": "Xaroncalluz verde",
	...
	"block.minecraft.warped_hanging_sign": "Cartelu colgante torcíu",
	"block.minecraft.warped_hyphae": "Hyphae torcides",
	...
	"block.minecraft.warped_wall_hanging_sign": "Cartelu colgante torcíu de pared",
	"block.minecraft.warped_wall_sign": "Cartelu de pared torcidu",
	...
	"block.minecraft.waxed_copper_bulb": "Bombilla de cobre encerada",
	"block.minecraft.waxed_copper_chain": "Waxed Copper Chain",
	"block.minecraft.waxed_copper_chest": "Waxed Copper Chest",
	"block.minecraft.waxed_copper_door": "Puerta de cobre encerada",
	"block.minecraft.waxed_copper_golem_statue": "Waxed Copper Golem Statue",
	"block.minecraft.waxed_copper_grate": "Reixa de cobre encerada",
	"block.minecraft.waxed_copper_lantern": "Waxed Copper Lantern",
	"block.minecraft.waxed_copper_trapdoor": "Trampa de cobre encerada",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Cobre esculpiu espuesto encerado",
	"block.minecraft.waxed_exposed_copper": "Cobre al descubierto encerado",
	...
	"block.minecraft.waxed_exposed_copper_door": "Puerta de cobre al descubierto encerado",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Waxed Exposed Copper Golem Statue",
	"block.minecraft.waxed_exposed_copper_grate": "Reja de cobre al descubierto encerada",
	"block.minecraft.waxed_exposed_copper_lantern": "Waxed Exposed Copper Lantern",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Trampilla de cobre al descubierto encerada",
	"block.minecraft.waxed_exposed_cut_copper": "Cobre expuesto cortado y encerado",
	"block.minecraft.waxed_exposed_cut_copper_slab": "Llancha de cobre cinceláu eshomáu",
	"block.minecraft.waxed_exposed_cut_copper_stairs": "Escaleres de cobre cinceláu eshomáu",
	"block.minecraft.waxed_exposed_lightning_rod": "Waxed Exposed Lightning Rod",
	"block.minecraft.waxed_lightning_rod": "Parrayos con cera",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Cobre esfolláu oxidáu y manxáu",
	"block.minecraft.waxed_oxidized_copper": "Cobre oxidadu enceráu",
	"block.minecraft.waxed_oxidized_copper_bars": "Cadenes de cobre ferruñoso con cera",
	"block.minecraft.waxed_oxidized_copper_bulb": "Cordón de coiro oxidadu enceráu",
	"block.minecraft.waxed_oxidized_copper_chain": "Cadena de cobre ferruñoso con cera",
	"block.minecraft.waxed_oxidized_copper_chest": "Bagul de cobre ferruñoso con cera",
	"block.minecraft.waxed_oxidized_copper_door": "Porta de cobre oxidáu enceráu",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Estatua de gólem de cobre ferruñoso con cera",
	"block.minecraft.waxed_oxidized_copper_grate": "Reixu de cobre oxidáu enceráu",
	"block.minecraft.waxed_oxidized_copper_lantern": "Llámpara de cobre ferruñoso con cera",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Trampa de cobre oxidáu enceráu",
	"block.minecraft.waxed_oxidized_cut_copper": "Cobre cortáu oxidáu enceráu",
	"block.minecraft.waxed_oxidized_cut_copper_slab": "Placa d'oxídicu de cobre cortada con vierte cera",
	"block.minecraft.waxed_oxidized_cut_copper_stairs": "Escaleres de cobre cortaes oxidáu y enceráu",
	"block.minecraft.waxed_oxidized_lightning_rod": "Pararrayos ferruñosu con cera",
	"block.minecraft.waxed_weathered_chiseled_copper": "Cobre chiseleáu envejecíu y enceráu",
	"block.minecraft.waxed_weathered_copper": "Cobre ensolbañado y enceráu",
	"block.minecraft.waxed_weathered_copper_bars": "Barres de cobre corroyío con cera",
	"block.minecraft.waxed_weathered_copper_bulb": "Bombilla de cobre envejecido y encerado",
	"block.minecraft.waxed_weathered_copper_chain": "Cadena de cobre corroyío con cera",
	"block.minecraft.waxed_weathered_copper_chest": "Bagul de cobre corroyío con cera",
	"block.minecraft.waxed_weathered_copper_door": "Puerta de cobre envejecido y encerado",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Estatua de gólem de cobre corroyío con cera",
	"block.minecraft.waxed_weathered_copper_grate": "Rejilla de cobre envejecido y encerado",
	"block.minecraft.waxed_weathered_copper_lantern": "Llámpara de cobre corroyío con cera",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Trampa de cobre envejecido y encerado",
	"block.minecraft.waxed_weathered_cut_copper": "Cobre cortáu envejecíu y enceráu",
	"block.minecraft.waxed_weathered_cut_copper_slab": "Tabla de cobre cortada envejecida y encerada",
	"block.minecraft.waxed_weathered_cut_copper_stairs": "Escaleras de cobre cortado envejecido y encerado",
	"block.minecraft.waxed_weathered_lightning_rod": "Pararrayos corroyíu con cera",
	"block.minecraft.weathered_chiseled_copper": "Cobre cincelado y envejecido",
	"block.minecraft.weathered_copper": "Cobre corroyío",
	"block.minecraft.weathered_copper_bars": "Weathered Copper Bars",
	"block.minecraft.weathered_copper_bulb": "Bombilla de cobre envejecido",
	...
	"block.minecraft.weathered_copper_door": "Puerta de cobre envejecido",
	"block.minecraft.weathered_copper_golem_statue": "Weathered Copper Golem Statue",
	"block.minecraft.weathered_copper_grate": "Reixu de cobre envejecíu",
	"block.minecraft.weathered_copper_lantern": "Weathered Copper Lantern",
	"block.minecraft.weathered_copper_trapdoor": "Portella de cobre envejecíu",
	...
	"block.minecraft.weeping_vines": "Lloriqueo de les plantes",
	"block.minecraft.weeping_vines_plant": "Planta de enredadera llorona",
	...
	"block.minecraft.wildflowers": "Flores Monteses",
	...
	"book.invalid.tag": "* Etiqueta de llibru inválida *",
	...
	"build.tooHigh": "La llende d'altor pa la construcción ye %s",
	...
	"chat.deleted_marker": "Esti mensaxe de chat foi esborráu pol servidor.",
	"chat.disabled.chain_broken": "Conversación desactivada por cadenamu rotu. Por favor, inténtalo a conectar.",
	"chat.disabled.expiredProfileKey": "Conversación desactivada pola clave pública del perfil caducada. Por favor, intentalo a conectar.",
	"chat.disabled.invalid_command_signature": "La comanda tenía signatures d'argumentu de comanda inesperaes o ausentes.",
	"chat.disabled.invalid_signature": "La conversación tenía una firma inválida. Por favor, inténtalo volver a conectar.",
	"chat.disabled.launcher": "Conversación desactivada pola opción del llanzador. Non se pue unviar mensaxe.",
	"chat.disabled.missingProfileKey": "Conversación desactivada pola clave pública del perfil ausente. Por favor, intentalo a conectar.",
	"chat.disabled.options": "Chat desconetau neles opciones de cliente\"\"",
	"chat.disabled.out_of_order_chat": "Conversación recibida fora d'orde. ¿Camudó la hora del to sistema?",
	"chat.disabled.profile": "La conversación nun ta permitida pola configuración de la cuenta. Preme '%s' de nuevu pa más información.",
	"chat.disabled.profile.moreInfo": "Les conversaciones nun tán permitíes poles configuraciones de la cuenta. Nun se puen unviar nin ver mensaxes.",
	"chat.editBox": "charra",
	"chat.filtered": "Filtráu pol servidor.",
	"chat.filtered_full": "El servidor oxultó'l to mensaxe pa dalgunos xugadores.",
	...
	"chat.tag.error": "El servidor envió un mensaxe inválido.",
	"chat.tag.modified": "Mensaxe modificáu pol servidor. Orixinal:",
	"chat.tag.not_secure": "Mensaxe non verificado. Non pue ser informáu.",
	"chat.tag.system": "Mensaxe del servidor. Non pue ser informáu.",
	...
	"chat.validation_error": "Error de validación de la conversación",
	...
	"chunk.toast.checkLog": "Consulta'l rexistru pa más detalles",
	"chunk.toast.loadFailure": "Fallu al cargar los fragmentos en %s",
	"chunk.toast.lowDiskSpace": "Espaciu de discu baxu!",
	"chunk.toast.lowDiskSpace.description": "Quiciáis nun se pueda guardar el mundu.",
	"chunk.toast.saveFailure": "Fallu al guardar chunk en %s",
	"clear.failed.multiple": "Nun s'atoparon oxetos en %s xugadores",
	...
	"command.forkLimit": "Númberu máximu de contestos (%s) algamáu",
	...
	"commands.banlist.entry.unknown": "(Desconocío)",
	...
	"commands.data.storage.get": "%s nel contenedor %s, tres un factor escala de %s, ye %s",
	...
	"commands.datapack.create.already_exists": "Ya esiste un paquete con ese nome: %s",
	"commands.datapack.create.invalid_full_name": "Invalid new pack name '%s'",
	"commands.datapack.create.invalid_name": "Caracteres inválidus nel nuevo nome del paquete: %s",
	"commands.datapack.create.io_failure": "No se pudo crear un paquete col nome «%s», revisa los rexistros",
	"commands.datapack.create.metadata_encode_failure": "Fallu al codificar los metadatus del paquete col nome «%s»: %s",
	"commands.datapack.create.success": "Creóse un nuevu paquete vacío col nome «%s»",
	"commands.datapack.disable.failed": "¡El paquete «%s» nun ta activáu!",
	"commands.datapack.disable.failed.feature": "¡El paquete de datos «%s» nun pue desactivase porque ye parte d'una de les variables actives!",
	...
	"commands.place.feature.success": "Colocóse «%s» en %s, %s, %s",
	...
	"commands.place.structure.failed": "Errú al xenerar estructura",
	...
	"commands.publish.failed": "Nun ye posible agospiar la partida llocal",
	...
	"commands.scoreboard.players.list.entity.success": "%s Tien %spuntu(s):",
	"commands.scoreboard.players.list.success": "Hai %s entidá(es) rexistra(es): %s",
	"commands.scoreboard.players.operation.success.multiple": "Anovóse %s pa %s entidaes",
	"commands.scoreboard.players.operation.success.single": "Cambióse la puntuación del oxetivu %s pa %s a %s",
	...
	"commands.setworldspawn.failure.not_overworld": "Namás se pue colocar el puntu de spawn del mundu",
	...
	"commands.spawnpoint.success.multiple": "Establecer el puntu de spawn en %s, %s, %s [%s] en %s pa %s xugadores",
	"commands.spawnpoint.success.multiple.new": "Set spawn point to %s, %s, %s [%s, %s] in %s for %s players",
	"commands.spawnpoint.success.single": "Establecer el puntu de spawn en %s, %s, %s [%s] en %s pa %s",
	...
	"commands.test.run.no_tests": "Nun s'atopó nenguna prueba",
	"commands.test.run.running": "Running %s test(s)...",
	"commands.test.summary": "Game Test complete! %s test(s) were run",
	"commands.test.summary.all_required_passed": "Superáronse toles pruebes riquíes :)",
	...
	"controls.keybinds.duplicateKeybinds": "Esta clave tamién s'usa pa:\n%s",
	...
	"createWorld.customize.presets.share": "¿Quies compartir el preaxuste con daquién? ¡Usa la caxa d'abaxo!",
	...
	"credits_and_attribution.button.credits": "Creitos",
	"credits_and_attribution.button.licenses": "Llicencies",
	"credits_and_attribution.screen.title": "Creitos y Atribución",
	...
	"dataPack.minecart_improvements.description": "Ameyora'l movimientu de les vagonetes",
	"dataPack.minecart_improvements.name": "Vagonetes meyores",
	"dataPack.redstone_experiments.description": "Cambeos esperimentales cola Redstone",
	"dataPack.redstone_experiments.name": "Esperimentos cola Redstone",
	"dataPack.title": "Esbilla de paquetes de datos",
	"dataPack.trade_rebalance.description": "Anueva les ufiertes de los aldeanos",
	"dataPack.trade_rebalance.name": "Aldeanos con intercambios modificaos",
	"dataPack.update_1_20.description": "Nuevas carauterístiques y conteníu pa Minecraft 1.20",
	...
	"datapackFailure.safeMode.failed.description": "Esti mundu contién datos de guardáu inválidos o corruptos.",
	"datapackFailure.safeMode.failed.title": "Erru al cargar el mundu en Mou Seguru.",
	"datapackFailure.title": "Los erros nos paquetes de datos escoyíos impidieron al mundu cargar.\nPues o probar a cargalu namás colos paquetes de datos vanilla (\"mou seguru\"), o volver pal menú principal y igualo manualmente.",
	...
	"death.attack.dragonBreath": "%[1]s foi asaeteáu pola follestïa del dragón",
	"death.attack.dragonBreath.player": "%[1]s foi asaeteáu na follestïa del dragón por %[2]s",
	...
	"death.attack.fallingStalactite": "%[1]s foi espetáu por un estalactito que caió",
	"death.attack.fallingStalactite.player": "%[1]s foi espetáu por un estalactito que caió mentres luuchaba contra %[2]s",
	...
	"death.attack.fireworks.item": "%[1]s explotó con un estuoiu por una boiñia tirada dende %[3]s por %[2]s",
	...
	"death.attack.genericKill": "%[1]s foi asesináu",
	"death.attack.genericKill.player": "%[1]s foi asesináu mentres luuchaba contra %[2]s",
	"death.attack.hotFloor": "%[1]s descubrió que'l suelu yera llava",
	"death.attack.hotFloor.player": "%[1]s entró na zona de peligru por mor de %[2]s",
	...
	"death.attack.message_too_long": "Sentáu, mensaxe yera demostráu ser muncho llargu pa ser entregáu por completu. ¡Perdón! Equí tien una versión afayada: %s",
	...
	"death.attack.onFire.item": "%[1]s foi asadíu hasta quedase braxáu mentes lluchaba contra %[2]s, blandiendo %[3]s",
	...
	"death.attack.outsideBorder": "%[1]s dexó los llindes d'esti mundu",
	"death.attack.outsideBorder.player": "%[1]s dexó los llindes d'esti mundu mentes lluchaba contra %[2]s",
	"death.attack.player": "%[1]s foi asasináu por %[2]s",
	"death.attack.player.item": "%[1]s foi esguinzado por %[2]s usando %[3]s",
	"death.attack.sonic_boom": "%[1]s foi aniquilado por un chillíu cargáu de soníos",
	"death.attack.sonic_boom.item": "%[1]s foi aniquilado por un chillíu cargáu de soníos mientres trataba d'escapar de %[2]s esgrimiendo %[3]s",
	"death.attack.sonic_boom.player": "%[1]s foi aniquilado por un chillíu cargáu de soníos mientres trataba d'escapar de %[2]s",
	"death.attack.spear": "%[1]s was speared by %[2]s",
	"death.attack.spear.item": "%[1]s was speared by %[2]s using %[3]s",
	"death.attack.stalagmite": "%[1]s foi empalado numa estalagmite",
	"death.attack.stalagmite.player": "%[1]s foi empalado numa estalagmite mientres lluchaba contra %[2]s",
	...
	"death.attack.sting.item": "%[1]s foi picado até à morte por %[2]s usando %[3]s",
	...
	"death.attack.sweetBerryBush": "%[1]s foi picado até a morte por um arbusto de bagas doces",
	"death.attack.sweetBerryBush.player": "%[1]s foi picado até a muerte por un arbustu de bayes dulces mientres intentaba escaper de %[2]s",
	...
	"death.attack.witherSkull": "%[1]s foi atingido por um tiro de um crânio de %[2]s",
	...
	"death.fell.accident.other_climbable": "%[1]s cayó mientres escalaba",
	"death.fell.accident.scaffolding": "%[1]s cayó d'un andamiu",
	"death.fell.accident.twisting_vines": "%[1]s cayó dalgunes vides torcies",
	"death.fell.accident.vines": "%[1]s cayó del enromadoriu",
	"death.fell.accident.weeping_vines": "%[1]s cayó dalgunes vides lloroses",
	...
	"deathScreen.titleScreen": "Pantalla de títulos",
	...
	"debug.creative_spectator.error": "Nun ye posible cambiar el mou de xuegu porque nun tienes permisu",
	...
	"enchantment.minecraft.impaling": "Empalar",
	...
	"enchantment.minecraft.wind_burst": "Españíu de vientu",
	"entity.minecraft.acacia_boat": "Barca d'Alcacia",
	"entity.minecraft.acacia_chest_boat": "Barca d'Alcacia con Bagul",
	"entity.minecraft.allay": "Allay",
	"entity.minecraft.area_effect_cloud": "Ñube d'efeutos n'área",
	"entity.minecraft.armadillo": "Armadillu",
	...
	"entity.minecraft.bamboo_raft": "Llancha de Bambú",
	"entity.minecraft.bat": "Esperteyu",
	"entity.minecraft.bee": "Abeya",
	"entity.minecraft.birch_boat": "Barca de Bidul",
	"entity.minecraft.birch_chest_boat": "Barca de Bidul con Bagul",
	...
	"entity.minecraft.evoker_fangs": "Caniles d'Invocador",
	...
	"entity.minecraft.ominous_item_spawner": "Xenerador d'oxetos siniestros",
	...
	"entity.minecraft.spawner_minecart": "Vagoneta con xenerador",
	...
	"entity.minecraft.sulfur_cube": "Llimu d'azufre",
	"entity.minecraft.sulfur_cube.content": "Contién: %s",
	"entity.minecraft.tadpole": "Cucharapa",
	...
	"entity.minecraft.warden": "Serenu",
	...
	"gamerule.doTraderSpawning": "Crear vendedores errantes",
	...
	"gamerule.doWardenSpawning": "Spawn guardianes",
	...
	"gamerule.spawnChunkRadius": "Radio del fragmentu de xeneración",
	"gamerule.spawnChunkRadius.description": "Cantidá de fragmentos que queden cargaos alredor de la posición de xeneración del mundu.",
	...
	"gamerule.spawnRadius.description": "Controla'l tamañu de la zona alredor del punto de xeneración onde los xugadores pueden apaecer.",
	...
	"gui.abuseReport.draft.content": "¿Quies siguir cola edición del informe esistente o quies escartalu y crear otru?",
	...
	"gui.abuseReport.type.name": "Nome de xugador",
	...
	"gui.banned.description.permanent": "Espulsáronte permanentemente, lo que significa que nun pues xugar en llinia nin xunite a Realms.",
	...
	"gui.banned.description.unknownreason": "Apocayá recibimos un informe por mal comportamientu de la to cuenta. Los nuesos moderadores revisaron el casu ya identificaron qu'incumples los Estándares de la Comunidá de Minecraft.",
	...
	"gui.banned.reason.harassment_or_bullying": "Llinguaxe abusivu gastáu de xeitu dirixíu y dañible",
	...
	"gui.banned.title.permanent": "Espulsión permanente",
	...
	"gui.chatReport.draft.content": "¿Quies siguir cola edición del informe esistente o quies escartalu y crear otru?",
	...
	"item.minecraft.armadillo_scute": "Escudu d'Armadillu",
	...
	"item.minecraft.bolt_armor_trim_smithing_template": "Plantiya de ferrería",
	...
	"item.minecraft.cherry_boat": "Barcu de zrezal",
	"item.minecraft.cherry_chest_boat": "Barcu de zrezal con cofre",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Plantiya de ferrería",
	...
	"item.minecraft.crossbow.projectile.single": "Proyeutil: %s",
	...
	"item.minecraft.dark_oak_boat": "Barca de carbayu escuro",
	...
	"item.minecraft.disc_fragment_5.desc": "Vinilu - 5",
	...
	"item.minecraft.echo_shard": "Fragmentu d'ecu",
	...
	"item.minecraft.music_disc_5": "Vinilu",
	...
	"item.minecraft.music_disc_creator": "Vinilu",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Vinilu",
	...
	"item.minecraft.music_disc_lava_chicken": "Vinilu",
	...
	"item.minecraft.music_disc_tears": "Vinilu",
	...
	"item.minecraft.piglin_banner_pattern.new": "Patrón d'estandarte de focicu",
	"item.minecraft.piglin_brute_spawn_egg": "Güevu qu'apruz un piglin brutu",
	...
	"item.minecraft.smithing_template.applies_to": "Aplícase a:",
	"item.minecraft.smithing_template.armor_trim.additions_slot_description": "Añede un llingote o cristal",
	"item.minecraft.smithing_template.armor_trim.applies_to": "Armadura",
	"item.minecraft.smithing_template.armor_trim.base_slot_description": "Añede una pieza d'armadura",
	"item.minecraft.smithing_template.armor_trim.ingredients": "Llingotes y cristales",
	"item.minecraft.smithing_template.ingredients": "Ingredientes:",
	"item.minecraft.smithing_template.netherite_upgrade.additions_slot_description": "Añede llingote de netherita",
	"item.minecraft.smithing_template.netherite_upgrade.applies_to": "Equipamientu de diamante",
	"item.minecraft.smithing_template.netherite_upgrade.base_slot_description": "Añede una armadura, arma o ferramienta de diamante",
	"item.minecraft.smithing_template.netherite_upgrade.ingredients": "Llingote de netherita",
	"item.minecraft.smithing_template.upgrade": "Meyora: ",
	...
	"item.minecraft.sulfur_cube_bucket": "Calderu de llimu d'azufre",
	"item.minecraft.sulfur_cube_spawn_egg": "Güevu qu'apruz un llimu d'azufre",
	...
	"item.minecraft.turtle_scute": "Escudu de Tortuga",
	"item.minecraft.turtle_spawn_egg": "Güevu qu'apruz a una tortuga",
	"item.minecraft.vex_armor_trim_smithing_template": "Plantiya de ferrería",
	...
	"item.minecraft.warden_spawn_egg": "Güevu qu'apruz un serenu",
	...
	"item.modifiers.saddle": "Cuando ensilláu:",
	...
	"itemGroup.foodAndDrink": "Comida y bébora",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine - Creator (Caxa de música)",
	...
	"key.category.minecraft.creative": "Mou creativu",
	...
	"key.keyboard.unknown": "Ensin asignar",
	...
	"known_server_link.announcements": "Anuncius",
	"known_server_link.community": "Comunidá",
	"known_server_link.community_guidelines": "Normes de la comunidá",
	"known_server_link.feedback": "Opiniones",
	"known_server_link.forums": "Foros",
	"known_server_link.news": "Novedaes",
	"known_server_link.report_bug": "Informar d'erru nel servidor",
	...
	"lanServer.port": "Númberu de puertu",
	"lanServer.port.invalid": "Puertu non válidu.\nDexa la caxa d'edición vacida o escueye un númberu ente 1024 y 65535.",
	"lanServer.port.invalid.new": "Puertu non válidu.\nDexa la caxa d'edición vacida o introduz un númberu entre %s y %s.",
	"lanServer.port.unavailable": "Puertu non disponible.\nDexa la caxa d'edición vacida o escueye un númberu distintu ente 1024 y 65535.",
	"lanServer.port.unavailable.new": "El puertu nun ta disponible.\nDexa baleru'l cuadru d'edición o introduz otru númberu ente %s y %s.",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Sirvidor nuevu",
	"manageServer.edit.title": "Edición de la información del sirvidor",
	"manageServer.enterIp": "Direición del sirvidor",
	"manageServer.enterName": "Nome del sirvidor",
	"manageServer.resourcePack": "Paqts. recursos del sirvidor",
	"manageServer.resourcePack.disabled": "Non",
	"manageServer.resourcePack.enabled": "Sí",
	"manageServer.resourcePack.prompt": "Entrugar",
	"mco.account.privacy.info": "Lleer más tocante a Mojang y les lleis de privacidá",
	"mco.account.privacy.info.button": "Lleer más sobre'l RGPD",
	"mco.account.privacy.information": "Mojang implementa ciertos procedimientos para ayudar a protexer a los menores y la so privacidá, que consisten en cumplir cola Llei de Protección de Privacidá Infantil n'Internet (COPPA) y el Reglamentu Xeneral de Protección de Datos (RGPD).\n\nTienes de tener consentimientu parental antes de poder tener accesu a la to cuenta de Realms.",
	...
	"mco.activity.noactivity": "Ensin actividá dende %s día(s)",
	"mco.activity.title": "Actividá del xugador",
	"mco.backup.button.download": "Baxar la última",
	"mco.backup.button.reset": "Resetear mundu",
	"mco.backup.button.restore": "Restaurar",
	"mco.backup.button.upload": "Cargar un mundu",
	"mco.backup.changes.tooltip": "Cambeos",
	"mco.backup.entry": "Copia de seguridá. (%s)",
	"mco.backup.entry.description": "Descripción",
	"mco.backup.entry.enabledPack": "Paquete(s) activáu(s)",
	"mco.backup.entry.gameDifficulty": "Dificultá del xuegu",
	"mco.backup.entry.gameMode": "Modu de xuegu",
	"mco.backup.entry.gameServerVersion": "Versión del servidor de xuegu",
	...
	"mco.configure.world.close.question.line2": "¿Tas seguru que quies faer esto?",
	...
	"mco.configure.world.delete.question.line2": "¿Tas seguru que quies siguir?",
	...
	"mco.configure.world.invite.narration": "Tienes nueves invitaciones: %s",
	"mco.configure.world.invite.profile.name": "Nome",
	"mco.configure.world.invited": "Persones convidaes",
	"mco.configure.world.invited.number": "Invitao (%s)",
	...
	"mco.configure.world.players.inviting": "Convidando xugador...",
	...
	"mco.configure.world.resourcepack.question": "Precises un paquete de recursos personalizáu pa xugar nesti realm\n\n¿Quies descargalo y xugar?",
	...
	"mco.configure.world.settings.title": "Configuración",
	...
	"mco.configure.world.spawn_toggle.title": "¡Cuidao!",
	...
	"mco.configure.world.subscription.recurring.info": "Los cambios na to suscripción de Realms, como l'ampliación del periodu de suscripción o la desactivación de la renovación automática, nun van aplicase hasta la próxima fecha de facturación.",
	...
	"mco.configure.world.uninvite.player": "¿Seguru que quies anular la invitación a %s?",
	"mco.configure.world.uninvite.question": "¿De xuru que quies anular la invitación de",
	"mco.configure.worlds.title": "Mundos",
	"mco.connect.authorizing": "Empecipiando sesión...",
	...
	"mco.download.confirmation.oversized": "El mundu qu'intentes descargar supera los %s\n\nNun vas poder volver xubir esti mundu al to realm",
	...
	"mco.download.resourcePack.fail": "¡Erru al descargar el paquete de recursos!",
	...
	"mco.errorMessage.6005": "Mundu bloquiáu",
	"mco.errorMessage.6006": "Mundu desactualizao",
	"mco.errorMessage.6007": "L'usuariu ta en demasiaos realms",
	"mco.errorMessage.6008": "Nome de realm non válidu",
	"mco.errorMessage.6009": "Descripción del realm non válida",
	"mco.errorMessage.connectionFailure": "Asocedió un fallu, volvi tentalo dempués.",
	"mco.errorMessage.generic": "Prodúxose un error: ",
	"mco.errorMessage.initialize.failed": "Failed to initialize Realm",
	"mco.errorMessage.noDetails": "Nun s'apurrieron detalles del erru",
	"mco.errorMessage.realmsService": "Prodúxose un error (%s):",
	"mco.errorMessage.realmsService.configurationError": "Prodúxose un error inesperáu mentanto s'editaben les opciones del mundu",
	"mco.errorMessage.realmsService.connectivity": "Nun se pudo conectar a Realms: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Nun se pudo comprobar la versión compatible, llogrose la respuesta: %s",
	...
	"mco.notification.dismiss": "Escartar",
	"mco.notification.transferSubscription.buttonText": "Tresferir",
	"mco.notification.transferSubscription.message": "Les soscripciones de Java Realms treslladáronse a la Microsoft Store.\nPa tresferir la to soscripción ya consiguir 30 díes de Realms gratis, ve a la seición Perfil de minecraft.net.\n¡Nun dexes que la to soscripción caduque!",
	"mco.notification.visitUrl.buttonText.default": "Abrir l'enllaz",
	"mco.notification.visitUrl.message.default": "Visita l'enllaz d'abaxo",
	"mco.onlinePlayers": "Online Players",
	"mco.play.button.realm.closed": "Realm is closed",
	"mco.question": "Entruga",
	...
	"mco.selectServer.purchase": "Amestar un realm",
	"mco.selectServer.trial": "¡Pruébalu!",
	...
	"mco.snapshotRealmsPopup.message": "Realms ta disponible nes versiones Snapshot dende la 23w41a. Cada soscripción a Realms inclúi un Realm Snapshot de baldre, independiente del to Realm de Java.",
	"mco.snapshotRealmsPopup.title": "Realms ta disponible nes Snapshots",
	"mco.snapshotRealmsPopup.urlText": "Saber más",
	...
	"mco.trial.message.line2": "¡Calca equí pa consiguir más información!",
	...
	"multiplayer.texturePrompt.line2": "¿Quies baxalu ya instalalu automáxicamente?",
	"multiplayer.texturePrompt.serverPrompt": "%s\n\nMensaxe del sirvidor:\n%s",
	"multiplayer.title": "Xuegu nel mou multixugador",
	"multiplayer.unsecureserver.toast": "Ye posible que se modifiquen los mensaxes que s'unvien nesti sirvidor y nun reflexen el mensaxe orixinal",
	"multiplayer.unsecureserver.toast.title": "Nun se puen verificar los mensaxes de la charra",
	...
	"options.accessibility.high_contrast": "Contraste altu",
	"options.accessibility.high_contrast.error.tooltip": "El paquete de recursos en contraste altu nun ta disponible",
	"options.accessibility.high_contrast.tooltip": "Ameyora'l contraste de los elementos de la IU",
	...
	"options.accessibility.link": "Guía de l'accesibilidá",
	...
	"options.accessibility.title": "Configuración de l'accesibilidá",
	...
	"options.autoJump": "Saltu automáticu",
	...
	"options.chat.title": "Configuración de la charra…",
	...
	"options.credits_and_attribution": "Creitos ya atribución…",
	...
	"options.darknessEffectScale": "Pulsu d'Escuridá",
	"options.darknessEffectScale.tooltip": "Controla cuanto pulsia l'efectu d'Escuridá cuando un Warden o Glayador de Sculk te lo aplica.",
	...
	"options.discrete_mouse_scroll": "Desplazamientu estremáu",
	"options.entityDistanceScaling": "Distancia de les entidaes",
	"options.entityShadows": "Solombres de les entidaes",
	...
	"options.font": "Configuración de la fonte…",
	"options.font.title": "Configuración de la fonte",
	"options.forceUnicodeFont": "Fonte Unicode",
	"options.fov": "Campu de visión",
	"options.fov.max": "Quake Pro",
	"options.fov.min": "Normal",
	"options.fovEffectScale": "Efeutos del campu de visión",
	...
	"options.fullscreen.unavailable": "La opción nun ta disponible",
	...
	"options.graphics.fabulous.tooltip": "«%s» usa asolombradores pa dibuxar el clima, les nubes ya partícules darrera d'agua ya bloques tresllúcidos.\nEsto pue afeutar muncho al rindimientu en preseos portátiles ya pantalles 4K.",
	"options.graphics.fancy": "Detallaos",
	"options.graphics.fancy.tooltip": "«Detallaos» equilibra'l rindimientu ya la calidá na mayoría de máquines.\nYe posible que'l clima, les nubes ya les partícules nun apaezan darrera d'agua o bloques tresllúcidos.",
	"options.graphics.fast": "Rápidos",
	"options.graphics.fast.tooltip": "«Rápidos» amenorga la cantidá de lloviu ya nieve visibles.\nDesactívense los efeutos de tresparencia en dalgunos bloques como les fueyes de los árboles.",
	...
	"options.japaneseGlyphVariants.tooltip": "Usa la variante xaponesa de los caráuteres CJK na fonte predeterminada.",
	"options.key.hold": "Mantener",
	"options.key.toggle": "Alternar",
	"options.language": "Llingua…",
	"options.language.narration": "Change Language",
	"options.language.title": "Llingua",
	"options.language.tooltip": "Change Language",
	"options.languageAccuracyWarning": "(Ye posible que les traducciones nun seyan 100%% correutes)",
	"options.languageWarning": "Ye posible que les traducciones nun seyan 100%% correutes",
	...
	"options.mouseWheelSensitivity": "Sensibilidá del desplazamientu",
	"options.mouse_settings": "Configuración del mur…",
	"options.mouse_settings.title": "Configuración del mur",
	"options.multiplayer.title": "Conf. del mou multixugador…",
	...
	"options.prioritizeChunkUpdates": "Creador de chunks",
	"options.prioritizeChunkUpdates.byPlayer": "Bloques incompletos",
	...
	"options.prioritizeChunkUpdates.nearby": "Bloques completos",
	...
	"options.prioritizeChunkUpdates.none": "Per filos",
	...
	"options.realmsNotifications": "Noticies ya invitaciones de Realms",
	...
	"options.screenEffectScale.tooltip": "Aumenta los efeutos de la distorsión visual de los portales del Nether.\nEn valores baxos, l'efeutu de voltura sustitúise por una superposición verde.",
	...
	"options.showSubtitles": "Amosar los sotítulos",
	"options.showSubtitles.tooltip": "Activa los sotítulos de los soníos que se reproducen nes partíes.",
	"options.simulationDistance": "Distancia de la simulación",
	"options.skinCustomisation": "Person. del aspeutu…",
	"options.skinCustomisation.title": "Personalización del aspeutu",
	"options.sounds": "Música ya soníos…",
	"options.sounds.title": "Opciones de la música ya'l soníu",
	...
	"options.telemetry": "Datos de la telemetría…",
	"options.telemetry.button": "Recoyida de datos",
	"options.telemetry.button.tooltip": "«%s» inclúi namás los datos riquíos.\n«%s» inclúi los datos opcionales, ya tamién, los riquíos.",
	...
	"options.telemetry.state.none": "Nenguna",
	...
	"options.touchscreen": "Mou táctil",
	"options.value": "%s",
	...
	"painting.minecraft.fire.title": "Fueu",
	...
	"resourcePack.high_contrast.name": "Contraste altu",
	...
	"selectWorld.backupQuestion.experimental": "Los mundos qu'usen opciones esperimentales nun son compatibles",
	...
	"selectWorld.backupWarning.experimental": "Esti mundu usa opciones esperimentales que podríen dexar de funcionar en cualesquier momentu. Nun podemos garantizar la so carga o funcionamientu. Anda pelo segao, ¿acuéi?",
	...
	"selectWorld.experiments.info": "Los esperimentos son opciones de prueba que puen convertise en funciones nueves ya nun pues desactivalos dempués de crear el mundu. Ten curiáu con ellos.",
	...
	"selectWorld.gameMode.creative.info": "Crear, construyir y eslorar sin llímites. Puedes volar, tienes materiales ensin fin y nun puedes ser feíu por monstruos.",
	...
	"selectWorld.gameMode.survival.info": "Esplora un mundu misteriosu onde construyes, cuelles, crees y lluches escontra monstruos.",
	...
	"selectWorld.mapFeatures": "Xenerar estructures",
	...
	"stat.minecraft.fill_cauldron": "Calderos enllenaos",
	...
	"stat.minecraft.use_cauldron": "Agua coyío de calderos",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Guéiser d'azufre españa",
	"subtitles.block.potent_sulfur.noxious_gas": "Apaez gas gafo",
	...
	"subtitles.block.sculk.charge": "Burbuyes sculk",
	"subtitles.block.sculk.spread": "Sculk medra",
	"subtitles.block.sculk_catalyst.bloom": "Catalizador de Sculk florez",
	"subtitles.block.sculk_sensor.clicking": "Sensor de Sculk trisca",
	"subtitles.block.sculk_sensor.clicking_stop": "Sensor de Sculk dexa de triscar",
	"subtitles.block.sculk_shrieker.shriek": "Glayador de Sculk glaya",
	...
	"subtitles.entity.armadillo.brush": "Los Escudos se desprienden al cepiyase",
	...
	"subtitles.entity.armadillo.scute_drop": "L'Armadillu despriende escudos",
	...
	"subtitles.entity.baby_pig.ambient": "Oinc de bebé piglin",
	"subtitles.entity.baby_pig.death": "Bebé gochu que muerre",
	"subtitles.entity.baby_pig.eat": "Bebé piglin come",
	"subtitles.entity.baby_pig.hurt": "Bebé gochu mancáu",
	...
	"subtitles.entity.camel.saddle": "Equipamientu de sillín",
	...
	"subtitles.entity.camel_husk.saddle": "Equipamientu de sillín",
	...
	"subtitles.entity.dolphin.ambient": "Glayar de toliña",
	...
	"subtitles.entity.hoglin.retreat": "Hoglin fuxe",
	...
	"subtitles.entity.parrot.imitate.creaking": "Loru que restalla",
	...
	"subtitles.entity.parrot.imitate.piglin": "Loru qu'urnia",
	"subtitles.entity.parrot.imitate.piglin_brute": "Loru qu'urnia",
	...
	"subtitles.entity.pig.eat": "Gochu que come",
	...
	"subtitles.entity.piglin.retreat": "Piglin fuxe",
	"subtitles.entity.piglin.step": "Piglin qu'anda",
	"subtitles.entity.piglin_brute.ambient": "Piglin brutu qu'urnia",
	"subtitles.entity.piglin_brute.angry": "Piglin brutu enfocicáu qu'urnia",
	"subtitles.entity.piglin_brute.converted_to_zombified": "Piglin brutu convertíu en piglin zombificáu",
	"subtitles.entity.piglin_brute.death": "Piglin brutu que muerre",
	"subtitles.entity.piglin_brute.hurt": "Piglin brutu que manca",
	"subtitles.entity.piglin_brute.step": "Piglin brutu qu'anda",
	...
	"subtitles.entity.skeleton_horse.death": "Caballu esqueléticu que muerre",
	...
	"subtitles.entity.snow_golem.death": "Gólem de nieve que muerre",
	"subtitles.entity.snow_golem.hurt": "Golem de nieve mancáu",
	...
	"subtitles.entity.strider.retreat": "Strider fuxe",
	"subtitles.entity.sulfur_cube.absorb": "Llimu d'azufre enllenu",
	"subtitles.entity.sulfur_cube.bounce": "Llimu d'azufre bota",
	"subtitles.entity.sulfur_cube.death": "Llimu d'azufre muerre",
	"subtitles.entity.sulfur_cube.eject": "Bloque desaniciáu",
	"subtitles.entity.sulfur_cube.hit": "Llimu d'azufre golpiáu",
	"subtitles.entity.sulfur_cube.hurt": "Llimu d'azufre mancáu",
	"subtitles.entity.sulfur_cube.push": "Llimu d'azufre puxáu",
	"subtitles.entity.sulfur_cube.squish": "Llimu d'azufre bota",
	...
	"subtitles.entity.vex.charge": "Glayíu de picuscayu",
	"subtitles.entity.vex.death": "Picuscayu que muerre",
	...
	"subtitles.entity.warden.death": "Serenu que muerre",
	"subtitles.entity.warden.dig": "Serenu que fura",
	"subtitles.entity.warden.emerge": "Serenu que surde",
	"subtitles.entity.warden.heartbeat": "Warden's heart beats",
	"subtitles.entity.warden.hurt": "Serenu mancáu",
	"subtitles.entity.warden.listening": "Serenu repara",
	"subtitles.entity.warden.listening_angry": "Serenu enfocicáu repara",
	"subtitles.entity.warden.nearby_close": "Warden approaches",
	"subtitles.entity.warden.nearby_closer": "Warden advances",
	"subtitles.entity.warden.nearby_closest": "Serenu avérase",
	...
	"subtitles.entity.warden.step": "Serenu pisa",
	...
	"subtitles.item.bucket.fill_axolotl": "Axolote garráu",
	"subtitles.item.bucket.fill_fish": "Fish captured",
	"subtitles.item.bucket.fill_sulfur_cube": "Llimu d'azufre garráu",
	...
	"subtitles.item.nautilus_saddle_equip": "Equipamientu de sillín",
	"subtitles.item.nautilus_saddle_underwater_equip": "Equipamientu de sillín",
	...
	"subtitles.item.spyglass.stop_using": "La Lente inxer",
	"subtitles.item.spyglass.use": "La Lente s'espande",
	...
	"subtitles.item.underwater_saddle.equip": "Equipamientu de sillín",
	...
	"telemetry.event.required": "%s (Requeríu)",
	...
	"telemetry.property.client_id.title": "ID del veceru",
	"telemetry.property.client_modded.title": "Veceru modificáu",
	...
	"telemetry.property.operating_system.title": "Sistema operativu",
	...
	"telemetry_info.button.give_feedback": "Opinar",
	"telemetry_info.button.privacy_statement": "Privacy Statement",
	"telemetry_info.button.show_data": "Abrir los datos",
	"telemetry_info.opt_in.description": "I consent to sending optional telemetry data",
	"telemetry_info.property_title": "Datos incluyíos",
	"telemetry_info.screen.description": "La recoyida d'estos datos ayúdanos a ameyorar Minecraft indicando la direición que ye relevante pa los xugadores. Tamién pues unviar más opiniones p'ayudanos a siguir ameyorando Minecraft.",
	"telemetry_info.screen.title": "Recoyida de datos de telemetría",
	...
	"trim_pattern.minecraft.vex": "Diseñu d'armadura de picuscayu",
	...
	"upgrade.minecraft.netherite_upgrade": "Meyorador de Netherita",
