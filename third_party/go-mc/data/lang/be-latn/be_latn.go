// Code generated by tools/gen_lang.go from 26.1/be_latn.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"accessibility.onboarding.accessibility.button.narration": "Spiecyjalnyja mahčymasci",
	...
	"advMode.notEnabled": "Kamandnyja błoki adklučany",
	"advMode.notEnabled.spawner": "Błoki rassadnikaŭ nie ŭklučany",
	"advMode.previousOutput": "Papiaredniaja kamanda",
	"advMode.setCommand": "Zadajcie kamandu",
	"advMode.setCommand.disabled": "Kamanda ŭstalavana: %s, ale kamandnyja błoki ŭsio jašče adklučanyja",
	...
	"advancements.adventure.heart_transplanter.description": "Zmiascicie ryplivaje serca viertykalna pamiž dvuma biarvionami blednaha duba",
	"advancements.adventure.heart_transplanter.title": "Pierasadka serca",
	...
	"advancements.adventure.spear_many_mobs.description": "Pratnicie piać istot adnoj atakaj dzidy",
	"advancements.adventure.spear_many_mobs.title": "Istotny šašłyk",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Zmiascicie błok zasmahłaha ghasta ŭ vadu",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Ghastojka",
	...
	"advancements.husbandry.uh_oh.description": "Zrabicie tak, kab sierny kub pahłynuŭ dynamit",
	"advancements.husbandry.uh_oh.title": "Oj",
	...
	"advancements.nether.ride_strider.title": "Čovien na mahmianych nožkach",
	...
	"argument.block.tag.disallowed": "Tehi tut nie dazvolenyja; tolki sapraŭdnyja błoki",
	...
	"argument.hexcolor.invalid": "Pamyłkovy šasnaccatkovy koleravy kod «%s»",
	...
	"argument.resource_or_id.no_such_element": "Niemahčyma znajsci elemient «%s» u rejestry «%s»",
	...
	"argument.waypoint.invalid": "Abranaja isnasć nie zjaŭlajecca aryjenciram",
	...
	"attribute.name.air_drag_modifier": "Madyfikatar supracivu pavietra",
	...
	"attribute.name.below_name_distance": "Dalokasć bačnasci liku pad imiem",
	...
	"attribute.name.bounciness": "Pruhkasć",
	"attribute.name.burning_time": "Čas harennia",
	"attribute.name.camera_distance": "Dalokasć kamiery",
	...
	"attribute.name.friction_modifier": "Madyfikatar trennia",
	"attribute.name.generic.armor": "Brania",
	"attribute.name.generic.armor_toughness": "Tryvałasć brani",
	"attribute.name.generic.attack_damage": "Škoda pry atacy",
	...
	"attribute.name.nameplate_distance": "Dalokasć bačnasci imia",
	...
	"attribute.name.waypoint_receive_range": "Dalokasć atrymannia aryjenciraŭ",
	"attribute.name.waypoint_transmit_range": "Dalokasć pieradačy aryjenciraŭ",
	...
	"biome.minecraft.sulfur_caves": "Siernyja piačory",
	...
	"block.minecraft.acacia_shelf": "Palica z akacyi",
	...
	"block.minecraft.bamboo_shelf": "Bambukavaja palica",
	...
	"block.minecraft.birch_shelf": "Biarozavaja palica",
	...
	"block.minecraft.cave_vines_plant": "Sciabło piačornaj łazy",
	...
	"block.minecraft.cherry_shelf": "Palica z višniovaj draŭniny",
	...
	"block.minecraft.chiseled_cinnabar": "Raźbianaja kinavar",
	...
	"block.minecraft.chiseled_sulfur": "Raźbianaja siera",
	...
	"block.minecraft.cinnabar": "Kinavar",
	"block.minecraft.cinnabar_brick_slab": "Plita z kinavarnaj cegły",
	"block.minecraft.cinnabar_brick_stairs": "Prystupki z kinavarnaj cegły",
	"block.minecraft.cinnabar_brick_wall": "Sciana z kinavarnaj cegły",
	"block.minecraft.cinnabar_bricks": "Kinavarnaja cegła",
	"block.minecraft.cinnabar_slab": "Plita z kinavary",
	"block.minecraft.cinnabar_stairs": "Prystupki z kinavary",
	"block.minecraft.cinnabar_wall": "Sciana z kinavary",
	...
	"block.minecraft.copper_bars": "Miadzianyja kraty",
	"block.minecraft.copper_block": "Miadziany błok",
	"block.minecraft.copper_bulb": "Miadzianaja lampa",
	"block.minecraft.copper_chain": "Miadziany łancuh",
	"block.minecraft.copper_chest": "Miadziany kufar",
	"block.minecraft.copper_door": "Miadzianyja dzviery",
	"block.minecraft.copper_golem_statue": "Statuja miadzianaha holema",
	"block.minecraft.copper_grate": "Miadzianaja rašotka",
	"block.minecraft.copper_lantern": "Miadziany lichtar",
	"block.minecraft.copper_ore": "Miadzianaja ruda",
	"block.minecraft.copper_torch": "Miadziany fakieł",
	"block.minecraft.copper_trapdoor": "Miadziany luk",
	"block.minecraft.copper_wall_torch": "Nascienny miadziany fakieł",
	...
	"block.minecraft.crimson_shelf": "Barvovaja palica",
	...
	"block.minecraft.dark_oak_shelf": "Palica z ciomnaha dubu",
	...
	"block.minecraft.dried_ghast": "Zasmahły ghast",
	...
	"block.minecraft.exposed_copper_bars": "Paćmianiełyja miadzianyja kraty",
	"block.minecraft.exposed_copper_bulb": "Paćmianiełaja miadzianaja lampa",
	"block.minecraft.exposed_copper_chain": "Paćmianieły miadziany łancuh",
	"block.minecraft.exposed_copper_chest": "Paćmianieły miadziany kufar",
	"block.minecraft.exposed_copper_door": "Paćmianiełyja miadzianyja dzviery",
	"block.minecraft.exposed_copper_golem_statue": "Paćmianiełaja statuja miadzianaha holema",
	"block.minecraft.exposed_copper_grate": "Paćmianiełaja miadzianaja rašotka",
	"block.minecraft.exposed_copper_lantern": "Paćmianieły miadziany lichtar",
	...
	"block.minecraft.exposed_lightning_rod": "Paćmianieły małankaadvod",
	...
	"block.minecraft.golden_dandelion": "Załaty dźmuchaviec",
	...
	"block.minecraft.iron_chain": "Žalezny łancuh",
	...
	"block.minecraft.jungle_shelf": "Palica z trapičnaj draŭniny",
	...
	"block.minecraft.leaf_litter": "Suchoje liscie",
	...
	"block.minecraft.mangrove_shelf": "Palica z manhravaj draŭniny",
	...
	"block.minecraft.nether_gold_ore": "Netherskaja zalataja ruda",
	...
	"block.minecraft.oak_shelf": "Dubovaja palica",
	...
	"block.minecraft.oxidized_copper_bars": "Akislenyja miadzianyja kraty",
	"block.minecraft.oxidized_copper_bulb": "Akislenaja miadzianaja lampa",
	"block.minecraft.oxidized_copper_chain": "Akisleny miadziany łancuh",
	"block.minecraft.oxidized_copper_chest": "Akisleny miadziany kufar",
	"block.minecraft.oxidized_copper_door": "Akislenyja miadzianyja dzviery",
	"block.minecraft.oxidized_copper_golem_statue": "Akislenaja statuja miadzianaha holema",
	"block.minecraft.oxidized_copper_grate": "Akislenaja miadzianaja rašotka",
	"block.minecraft.oxidized_copper_lantern": "Akisleny miadziany lichtar",
	...
	"block.minecraft.oxidized_lightning_rod": "Akisleny małankaadvod",
	...
	"block.minecraft.pale_oak_shelf": "Palica z blednaha dubu",
	...
	"block.minecraft.polished_cinnabar": "Paliravanaja kinavar",
	"block.minecraft.polished_cinnabar_slab": "Plita z paliravanaj kinavary",
	"block.minecraft.polished_cinnabar_stairs": "Prystupki z paliravanaj kinavary",
	"block.minecraft.polished_cinnabar_wall": "Sciana z paliravanaj kinavary",
	...
	"block.minecraft.polished_sulfur": "Paliravanaja siera",
	"block.minecraft.polished_sulfur_slab": "Plita z paliravanaj siery",
	"block.minecraft.polished_sulfur_stairs": "Prystupki z paliravanaj siery",
	"block.minecraft.polished_sulfur_wall": "Sciana z paliravanaj siery",
	...
	"block.minecraft.potent_sulfur": "Mocnaja siera",
	...
	"block.minecraft.potted_golden_dandelion": "Załaty dźmuchaviec u haršku",
	...
	"block.minecraft.spawner.desc1": "Uzajemadziejanniaŭ z jajkam vykliku:",
	...
	"block.minecraft.spruce_shelf": "Jałovaja palica",
	...
	"block.minecraft.sulfur_brick_slab": "Plita z siernaj cegły",
	"block.minecraft.sulfur_brick_stairs": "Prystupki z siernaj cegły",
	"block.minecraft.sulfur_brick_wall": "Sciana z siernaj cegły",
	"block.minecraft.sulfur_bricks": "Siernaja cegła",
	"block.minecraft.sulfur_slab": "Plita s siery",
	"block.minecraft.sulfur_spike": "Sierny šyp",
	"block.minecraft.sulfur_stairs": "Prystupki z siery",
	"block.minecraft.sulfur_wall": "Sciana z siery",
	...
	"block.minecraft.twisting_vines": "Pakručastyja łozy",
	"block.minecraft.twisting_vines_plant": "Sciabło pakručastaj łazy",
	...
	"block.minecraft.warped_shelf": "Skažonaja palica",
	...
	"block.minecraft.waxed_copper_bars": "Vaskavanyja miadzianyja kraty",
	...
	"block.minecraft.waxed_copper_chain": "Vaskavany miadziany łancuh",
	"block.minecraft.waxed_copper_chest": "Vaskavany miadziany kufar",
	"block.minecraft.waxed_copper_door": "Vaskavanyja miadzianyja dzviery",
	"block.minecraft.waxed_copper_golem_statue": "Vaskavanaja statuja miadzianaha holema",
	"block.minecraft.waxed_copper_grate": "Vaskavanaja miadzianaja rašotka",
	"block.minecraft.waxed_copper_lantern": "Vaskavany miadziany lichtar",
	...
	"block.minecraft.waxed_exposed_copper_bars": "Vaskavanyja paćmianiełyja miadzianyja kraty",
	"block.minecraft.waxed_exposed_copper_bulb": "Vaskavanaja paćmianiełaja miadzianaja lampa",
	"block.minecraft.waxed_exposed_copper_chain": "Vaskavany paćmianieły miadziany łancuh",
	"block.minecraft.waxed_exposed_copper_chest": "Vaskavany paćmianieły miadziany kufar",
	"block.minecraft.waxed_exposed_copper_door": "Vaskavanyja paćmianiełyja miadzianyja dzviery",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Vaskavanaja paćmianiełaja statuja miadzianaha holema",
	"block.minecraft.waxed_exposed_copper_grate": "Vaskavanaja paćmianiełaja miadzianaja rašotka",
	"block.minecraft.waxed_exposed_copper_lantern": "Vaskavany paćmianieły miadziany lichtar",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Vaskavany paćmianieły małankaadvod",
	"block.minecraft.waxed_lightning_rod": "Vaskavany małankaadvod",
	...
	"block.minecraft.waxed_oxidized_copper_bars": "Vaskavanyja akislenyja miadzianyja kraty",
	"block.minecraft.waxed_oxidized_copper_bulb": "Vaskavanaja akislenaja miadzianaja lampa",
	"block.minecraft.waxed_oxidized_copper_chain": "Vaskavany akisleny miadziany łancuh",
	"block.minecraft.waxed_oxidized_copper_chest": "Vaskavany akisleny miadziany kufar",
	"block.minecraft.waxed_oxidized_copper_door": "Vaskavanyja akislenyja miadzianyja dzviery",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Vaskavanaja akislenaja statuja miadzianaha holema",
	"block.minecraft.waxed_oxidized_copper_grate": "Vaskavanaja akislenaja miadzianaja rašotka",
	"block.minecraft.waxed_oxidized_copper_lantern": "Vaskavany akisleny miadziany lichtar",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Vaskavany akisleny małankaadvod",
	...
	"block.minecraft.waxed_weathered_copper_bars": "Vaskavanyja vyvietranyja miadzianyja kraty",
	"block.minecraft.waxed_weathered_copper_bulb": "Vaskavanaja vyvietranaja miadzianaja lampa",
	"block.minecraft.waxed_weathered_copper_chain": "Vaskavany vyvietrany miadziany łancuh",
	"block.minecraft.waxed_weathered_copper_chest": "Vaskavany vyvietrany miadziany kufar",
	"block.minecraft.waxed_weathered_copper_door": "Vaskavanyja vyvietranyja miadzianyja dzviery",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Vaskavanaja vyvietranaja statuja miadzianaha holema",
	"block.minecraft.waxed_weathered_copper_grate": "Vaskavanaja vyvietranaja miadzianaja rašotka",
	"block.minecraft.waxed_weathered_copper_lantern": "Vaskavany vyvietrany miadziany lichtar",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Vaskavany vyvietrany małankaadvod",
	...
	"block.minecraft.weathered_copper_bars": "Vyvietranyja miadzianyja kraty",
	"block.minecraft.weathered_copper_bulb": "Vyvietranaja miadzianaja lampa",
	"block.minecraft.weathered_copper_chain": "Vyvietrany miadziany łancuh",
	"block.minecraft.weathered_copper_chest": "Vyvietrany miadziany kufar",
	"block.minecraft.weathered_copper_door": "Vyvietranyja miadzianyja dzviery",
	"block.minecraft.weathered_copper_golem_statue": "Vyvietranaja statuja miadzianaha holema",
	"block.minecraft.weathered_copper_grate": "Vyvietranaja miadzianaja rašotka",
	"block.minecraft.weathered_copper_lantern": "Vyvietrany miadziany lichtar",
	...
	"block.minecraft.weathered_lightning_rod": "Vyvietrany małankaadvod",
	"block.minecraft.weeping_vines": "Nicyja łozy",
	"block.minecraft.weeping_vines_plant": "Sciabło nicaj łazy",
	...
	"book.edit.title": "Ekran redahavannia knihi",
	...
	"book.page_button.next": "Nastupnaja staronka",
	"book.page_button.previous": "Papiaredniaja staronka",
	"book.sign.title": "Ekran podpisu knihi",
	"book.sign.titlebox": "Nazva",
	"book.signButton": "Padpisać",
	"book.view.title": "Ekran prahladu knihi",
	"build.spawn_protection": "%s znachodzicca pad abaronaj spaŭnu",
	"build.tooHigh": "Abmiežavannie pa vyšyni dla budoŭli — %s",
	"build.tooLow": "Minimalnaja vyšynia budavannia roŭnaja %s",
	...
	"chat.queue.tooltip": "Nacisnicie, kab pakazać nastupnaje paviedamlennie",
	...
	"chat_restriction.chat_and_commands_disabled_by_options": "Čat abmiežavany ŭ naładach klijenta.",
	"chat_restriction.chat_disabled_by_options": "Čat z hulcami abmiežavany ŭ naładach klijenta.",
	"chat_restriction.chat_disabled_by_options.action": "Pierajsci na ekran «Nałady čatu»",
	"chat_restriction.disabled_by_launcher": "Čat abmiežavany łaŭnčaram",
	"chat_restriction.disabled_by_profile": "Čat abmiežavany naładami profilu.",
	"chat_restriction.disabled_by_profile.action": "Pierajsci ŭ nałady profilu",
	"chat_screen.commands_not_allowed": "Adpraŭlennie kamand zabaroniena",
	"chat_screen.message": "Paviedamlennie, jakoje budzie vysłana: %s",
	"chat_screen.messages_not_allowed": "Adpraŭlennie paviedamlenniaŭ zabaroniena",
	"chat_screen.restricted": "Čat abmiežavany. Nacisnicie heta paviedamlennie, kab daviedacca bolš.",
	"chat_screen.restricted.narration": "Čat abmiežavany. Pierajdzicie na ekran «Abmiežavanni» ŭ naładach svietu.",
	...
	"command.trailing_data": "Znojdzieny lišnija danyja: %s",
	"command.unknown.argument": "Niapravilny arhumient dla kamandy",
	"command.unknown.command": "Nieviadomaja ci niapoŭnaja kamanda; hladzicie nižej dla pamyłki",
	...
	"commands.clone.toobig": "Zašmat błokaŭ u paznačanaj vobłasci (maksimum %s, paznačana %s)",
	...
	"commands.datapack.create.already_exists": "Pakiet z nazvaj «%s» užo isnuje",
	"commands.datapack.create.invalid_full_name": "Niedapuščalnaja nazva dla novaha pakieta «%s»",
	"commands.datapack.create.invalid_name": "Niedapuščalnyja simvały ŭ novaj nazvie pakieta «%s»",
	"commands.datapack.create.io_failure": "Nielha stvaryć pakiet z nazvaj «%s»; praviercie žurnał",
	"commands.datapack.create.metadata_encode_failure": "Nie ŭdałosia zašyfravać mietadanyja pakieta z nazvaj «%s»: %s",
	"commands.datapack.create.success": "Stvorany novy pusty pakiet z nazvaj «%s»",
	...
	"commands.dialog.clear.multiple": "Dyjałoh prybrany dla %s hulcoŭ",
	"commands.dialog.clear.single": "Dyjałoh prybrany dla %s",
	"commands.dialog.show.multiple": "Dyjałoh pakazany %s hulcam",
	"commands.dialog.show.single": "Dyjałoh pakazany %s",
	...
	"commands.execute.blocks.toobig": "Zašmat błokaŭ u paznačanaj vobłasci (maksimum %s, paznačana %s)",
	...
	"commands.fetchprofile.copy_component": "Kapijavać kampanient",
	"commands.fetchprofile.copy_text": "Kapijavać %s",
	"commands.fetchprofile.entity.success": "Profil byŭ vyrašany dla isnasci %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Nie ŭdałosia sieryjalizavać profil: %s",
	"commands.fetchprofile.give_item": "Vydać pradmiet",
	"commands.fetchprofile.id.failure": "Nie ŭdałosia vyrašyć profil dla identyfikatara %s",
	"commands.fetchprofile.id.success": "Profil byŭ vyrašany dla identyfikatara %s: %s",
	"commands.fetchprofile.name.failure": "Nie ŭdałosia vyrašyć profil dla imia %s",
	"commands.fetchprofile.name.success": "Profil byŭ vyrašany dla imia %s: %s",
	"commands.fetchprofile.no_profile": "Isnasć %s nie maje profilu",
	"commands.fetchprofile.summon_mannequin": "Vyklikać maniekien",
	...
	"commands.profile_fetch.copy_component": "Kapijavać kampanient",
	"commands.profile_fetch.failed_to_serialize": "Nie ŭdałosia sieryjalizavać profil: %s",
	"commands.profile_fetch.give_item": "Vydać pradmiet",
	"commands.profile_fetch.id.failure": "Nie ŭdałosia vyrašyć profil dla identyfikatara %s",
	"commands.profile_fetch.id.success": "Profil byŭ vyrašany dla identyfikatara %s: %s",
	"commands.profile_fetch.name.failure": "Nie ŭdałosia vyrašyć profil dla imia %s",
	"commands.profile_fetch.name.success": "Profil byŭ vyrašany dla imia %s: %s",
	...
	"commands.setworldspawn.success.new": "Punkt adradžennia ŭ sviecie pryznačany na %s, %s, %s [%s, %s] u %s",
	"commands.spawnpoint.success.multiple": "Punkt adradžennia ŭstalavany na %s, %s, %s [%s] u %s dla %s hulcoŭ",
	"commands.spawnpoint.success.multiple.new": "Punkt adradžennia ŭstalavany na %s, %s, %s [%s, %s] u %s dla %s hulcoŭ",
	"commands.spawnpoint.success.single": "Punkt adradžennia ŭstalavany na %s, %s, %s [%s] u %s dla hulca %s",
	"commands.spawnpoint.success.single.new": "Punkt adradžennia ŭstalavany na %s, %s, %s [%s, %s] u %s dla %s",
	"commands.spectate.cannot_spectate": "Za %s niemahčyma nazirać",
	...
	"commands.stopwatch.already_exists": "Siekundamier «%s» užo isnuje",
	"commands.stopwatch.create.success": "Stvorany siekundamier «%s»",
	"commands.stopwatch.does_not_exist": "Siekundamier «%s» nie isnuje",
	"commands.stopwatch.query": "Siekundamier «%s» aktyŭny ŭžo %s s",
	"commands.stopwatch.remove.success": "Vydaleny siekundamier «%s»",
	"commands.stopwatch.restart.success": "Pierazapuščany siekundamier «%s»",
	"commands.summon.failed": "Nie atrymałasia pryzvać isnasć",
	"commands.summon.failed.peaceful": "Pačvaru niemahčyma vyklikać na mirnaj składanasci",
	...
	"commands.swing.failed.notliving": "Nie znojdziena žyvych isnasciaŭ, jakija b mahli machać",
	"commands.swing.success.multiple": "%s isnasciaŭ machnuli rukami",
	"commands.swing.success.single": "%s ciapier machaje rukoj",
	...
	"commands.team.option.color.clear.success": "Koler prybrany dla kamandy %s",
	...
	"commands.test.error.test_instance_not_found.position": "Nie ŭdałosia znajsci błok-isnasć testavaha asobnika dla testa na %s, %s, %s",
	...
	"commands.tick.query.rate.sprinting": "Metavaja častata cikaŭ: %s u siekundu (ihnarujecca, tolki dla daviedki).\nSiaredni čas ciku: %sms",
	...
	"commands.time.no_default_clock": "U vymiarenni %s niama hadzinnika pa zmaŭčanni",
	"commands.time.no_time_marker_found": "Časavaja adznaka %s nie isnuje dla hadzinnika %s",
	"commands.time.pause": "Hadzinnik %s prypynieny",
	"commands.time.query": "Čas: %s",
	"commands.time.query.absolute": "Hadzinnik %s na %s takcie",
	"commands.time.query.gametime": "Hulniavy čas %s taktaŭ",
	"commands.time.query.timeline": "Škała času %s na %s takcie",
	"commands.time.query.timeline.repetitions": "Kolkasć paŭtoraŭ škały času %s: %s",
	"commands.time.rate": "Hadzinnik %s budzie isci ŭ %s razoŭ chutčej za zvyčajny",
	"commands.time.resume": "Hadzinnik %s adnoŭleny",
	"commands.time.set": "Čas ustanoŭleny na %s",
	"commands.time.set.absolute": "Ustalavana %s na %s taktaŭ",
	"commands.time.set.time_marker": "Ustalavana %s na časavuju paznaku %s",
	"commands.time.wrong_timeline_for_clock": "Škała času %s nie padychodzić dla hadzinnika %s",
	...
	"commands.waypoint.list.empty": "Niama aryjenciraŭ u %s",
	"commands.waypoint.list.success": "%s aryjenciraŭ u %s: %s",
	"commands.waypoint.modify.color": "Koler aryjencira ciapier %s",
	"commands.waypoint.modify.color.reset": "Koler aryjencira skinuty",
	"commands.waypoint.modify.style": "Styl aryjencira zmienieny",
	...
	"component.profile.dynamic": "Dynamičny",
	...
	"connect.p2p.establishing": "Ustalavannie złučennia…",
	"connect.p2p.failed.generic": "Niemahčyma złučycca z hetym hulcom",
	"connect.p2p.failed.signaling": "Zaraz niemahčyma ŭstalavać złučennie.\nPaŭtarycie sprobu pazniej.",
	"connect.p2p.failed.timeout": "Čas čakannia zapytu na złučennie skončyŭsia",
	"connect.p2p.failed.unreachable": "Hulec niedastupny",
	...
	"createWorld.customize.buffet.search": "Pošuk…",
	...
	"dataPack.locator_bar.description": "Pakazvaje kirunak da inšych hulcoŭ u sumiesnaj hulni",
	"dataPack.locator_bar.name": "Łakatar",
	...
	"death.attack.spear": "%[2]s praciaŭ %[1]s",
	"death.attack.spear.item": "%[2]s praciaŭ %[1]s z dapamohaj %[3]s",
	...
	"death.fell.accident.twisting_vines": "Pakručastyja łozy nie vytrymali %[1]s",
	...
	"debug.crash.message.rebindable": "Zacisnuty kłavišy %s + %s. Kali ich nie adpuscić, adbudziecca zboj hulni.",
	...
	"debug.entry.always": "Zaŭsiody",
	"debug.entry.currently.alwaysOn": "%s: Zaraz zaŭsiody uklučana",
	"debug.entry.currently.inF3": "%s: Zaraz tolki ŭ F3",
	"debug.entry.currently.inOverlay": "%s: Zaraz tolki ŭ naładkavym avierłei",
	"debug.entry.currently.never": "%s: Zaraz adklučana",
	"debug.entry.f3": "U F3",
	"debug.entry.overlay": "U avierłei",
	...
	"debug.options.category.renderer": "Adładkavy rendar",
	"debug.options.category.text": "Tekst ekrana adładki",
	"debug.options.help": "F3 + F6 = Zmianić nałady adładki",
	"debug.options.notAllowed.tooltip": "Nie bačna, kali infarmacyja adładki skaročana",
	"debug.options.profile.default": "Profil pa zmaŭčanni",
	"debug.options.profile.performance": "Profil pradukcyjnasci",
	"debug.options.search": "Pošuk…",
	"debug.options.title": "Nałady adładki",
	"debug.options.warning": "Hetyja nałady pryznačany tolki dla testavannia. Jany mohuć zapavolić pracu vašaha kampjutara, vyklikać zboj u hulni ci zjesci vaš chaładnik.",
	...
	"debug.profiling.start.rebindable": "Prafilavannie zapuščana na %s siekund. Nacisnicie %s + %s, kab spynić jaho dačasna",
	...
	"debug.version.header": "Infarmacyja pra viersiju klijenta:",
	"debug.version.help": "F3 + V = Infarmacyja pra viersiju klijenta",
	...
	"editGamerule.inGame.button": "Redahavać praviły hulni…",
	"editGamerule.inGame.disabled.tooltip": "Abnaŭlennie praviłaŭ hulni patrabuje pravoŭ apieratara.",
	"editGamerule.inGame.discardChanges.message": "Vy ŭpeŭnieny, što chočacie adchilić niezachavanyja zmieny praviłaŭ hulni?",
	"editGamerule.inGame.discardChanges.title": "Praviły hulni zmienieny",
	"editGamerule.inGame.downloadingGamerules": "Atrymannie praviłaŭ hulni…",
	...
	"effect.minecraft.breath_of_the_nautilus": "Dychannie naŭtyłusa",
	...
	"effect.minecraft.poison": "Atručennie",
	...
	"effect.minecraft.wind_charged": "Vietranasć",
	...
	"enchantment.minecraft.lunge": "Ryvok",
	...
	"enchantment.minecraft.wind_burst": "Paryŭ vietru",
	...
	"entity.minecraft.camel_husk": "Viarblud-zdychlak",
	...
	"entity.minecraft.copper_golem": "Miadziany holem",
	...
	"entity.minecraft.happy_ghast": "Ščaslivy ghast",
	...
	"entity.minecraft.mannequin": "Maniekien",
	...
	"entity.minecraft.nautilus": "Naŭtyłus",
	...
	"entity.minecraft.parched": "Suchlak",
	...
	"entity.minecraft.sulfur_cube": "Sierny kub",
	"entity.minecraft.sulfur_cube.content": "Zmiaščaje: %s",
	...
	"entity.minecraft.zombie_nautilus": "Miarcviak-naŭtyłus",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Dostup u Nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Vyznačaje, ci dazvolena hulcam uvachodzić u Nether",
	...
	"gamerule.commandBlocksEnabled": "Uklučyć kamandnyja błoki",
	...
	"gamerule.enableCommandBlocks": "Uklučyć kamandnyja błoki",
	...
	"gamerule.locatorBar": "Uklučyć łakatar hulcoŭ",
	"gamerule.locatorBar.description": "Kali ŭklučana, na ekranie zjaŭlajecca panel, jakaja pakazvaje kirunak hulcoŭ.",
	...
	"gamerule.minecraft.elytra_movement_check": "Praviarać ruch elitraŭ",
	"gamerule.minecraft.fire_spread_radius_around_player": "Radyus raspaŭsiudžvannia ahniu",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Radyus u błokach vakoł hulca, u jakim ahoń moža raspaŭsiudžvacca",
	"gamerule.minecraft.player_movement_check": "Praviarać ruch hulca",
	"gamerule.minecraft.raids": "Napady",
	"gamerule.minecraft.universal_anger.description": "Aburanyja niejtralnyja istoty atakujuć luboha hulca pablizu, a nie tolki hulca, jaki ich aburyŭ. Pracuje najlepš, kali kamanda forgive_dead_players adklučana.",
	...
	"gamerule.pvp": "Uklučyć PvP",
	"gamerule.pvp.description": "Vyznačaje, ci mohuć hulcy čynić škodu inšym hulcam.",
	...
	"gamerule.spawnMonsters": "Zjaŭlennie monstraŭ",
	"gamerule.spawnMonsters.description": "Vyznačaje, ci mohuć monstry zjaŭlacca sami praz siabie",
	...
	"gamerule.spawnerBlocksEnabled": "Uklučyć błoki rassadnikaŭ",
	...
	"gui.friends.accept": "Pryniać",
	"gui.friends.button.loading": "Čakajcie…",
	"gui.friends.button.loading.invite_request_pending": "Waiting for confirmation",
	"gui.friends.button.loading.join_request_pending": "Čakannie pacviardžennia ad %s",
	"gui.friends.cancel_request": "Skasavać zapyt",
	"gui.friends.confirm_title": "Pacvierdzić",
	"gui.friends.confirm_unfriend": "Vy ŭpeŭnieny, što chočacie vydalić hetaha hulca sa spisa siabroŭ?",
	"gui.friends.copy_to_clipboard": "Skapijavać u bufier",
	"gui.friends.decline": "Adchilić",
	"gui.friends.empty_nickname": "Uviadzicie sapraŭdnaje imia profilu pierad adpraŭkaj zapytu siabroŭstva",
	"gui.friends.empty_state": "Dadadzienyja vami siabry buduć pakazvacca tut.\n\nKirujcie anłajn-biaspiekaj z dapamohaj svajho %s.",
	"gui.friends.empty_state.link": "Ulikovy zapis Microsoft",
	"gui.friends.enter_nickname": "Uviadzicie imia profilu",
	"gui.friends.error.connection_issue": "Spis siabroŭ zaraz nie pracuje.\n\nPraviercie internet-złučennie i paŭtarycie sprobu.",
	"gui.friends.error.failed.message": "Zaraz niemahčyma adpravić vaš zapyt siabroŭstva",
	"gui.friends.error.forbidden.message": "Nie ŭdałosia vykanać hetaje dziejannie z siabram. Pryčynaj mohuć być nałady pryvatnasci ŭlikovaha zapisu.",
	"gui.friends.error.generic": "Niešta nie tak… z hetaj funkcyjaj, a nie z vašymi siabrami!\n\nPaŭtarycie sprobu pazniej.",
	"gui.friends.error.rateLimited.message": "Vy zanadta chutka vykonvajecie dziejanni sa spisam siabroŭ. Kali łaska, pačakajcie krychu i paŭtarycie sprobu.",
	"gui.friends.error.temporary_unavailable": "Spis siabroŭ zaraz nie pracuje.\n\nPaŭtarycie sprobu pazniej.",
	"gui.friends.error.unavailable.message": "Servis spisa siabroŭ zaraz niedastupny. Kali łaska, praviercie internet-złučennie i paŭtarycie sprobu pazniej.",
	"gui.friends.error.upgrade_needed": "Abnavicie hulniu, kab atrymać dostup da spisa siabroŭ.",
	"gui.friends.error.user_may_lack_active_profile": "Hulca z takim imiem profilu nie isnuje",
	"gui.friends.join": "Dałučycca",
	"gui.friends.loading_friends": "Zahruzka spisa siabroŭ...",
	"gui.friends.loading_requests": "Zahruzka zapytaŭ…",
	"gui.friends.manage_account_footer": "Kirujcie biaspiekaj u sietcy ŭ vašym %s",
	"gui.friends.multiplayer.invite": "Zaprasić u sviet",
	"gui.friends.multiplayer.invite_accept": "Pryniać zaprašennie ŭ sviet",
	"gui.friends.multiplayer.invite_reject": "Adchilić zaprašennie ŭ sviet",
	"gui.friends.multiplayer.join_request": "Zapyt dałučycca da svietu",
	"gui.friends.multiplayer.join_request_accept": "Pryniać zapyt dałučycca da svietu",
	"gui.friends.multiplayer.join_request_reject": "Adchilić zapyt dałučycca da svietu",
	"gui.friends.my_profile_name": "Imia majho profilu: ",
	"gui.friends.my_profile_name.narration": "Kapijavać imia profilu %s u bufier abmienu",
	"gui.friends.narration.button.accept": "Nacisnicie «Enter», kab pryniać zapyt siabroŭstva ad %s",
	"gui.friends.narration.button.cancel_request": "Nacisnicie «Enter», kab skasavać zapyt siabroŭstva da %s",
	"gui.friends.narration.button.decline": "Nacisnicie «Enter», kab adchilić zapyt siabroŭstva ad %s",
	"gui.friends.narration.button.unfriend": "Nacisnicie «Enter», kab vydalić %s sa spisa siabroŭ",
	"gui.friends.narration.entry.friend": "Siabry %s",
	"gui.friends.narration.entry.incoming": "Atrymany zapyt siabroŭstva ad %s",
	"gui.friends.narration.entry.outgoing": "Vysłany zapyt siabroŭstva da %s",
	"gui.friends.open": "Siabry",
	"gui.friends.open.narration": "Spis siabroŭ",
	"gui.friends.open.tooltip": "Siabry",
	"gui.friends.pending.empty": "Niama zapytaŭ siabroŭstva ŭ čakanni",
	"gui.friends.pending.received": "Atrymanyja",
	"gui.friends.pending.sent": "Adpraŭlenyja",
	"gui.friends.presence.status.offline": "Pa-za sietkaj",
	"gui.friends.presence.status.online": "U sietcy",
	"gui.friends.presence.status.playing_hosted_server": "U sviecie, da jakoha možna dałučycca",
	"gui.friends.presence.status.playing_offline": "U sviecie",
	"gui.friends.presence.status.playing_realms": "U Realm",
	"gui.friends.presence.status.playing_server": "Na sierviery",
	"gui.friends.requests_count": "Zapyty (%s)",
	"gui.friends.send_request": "Adpravić zapyt siabroŭstva",
	"gui.friends.tab_friends": "Siabry",
	"gui.friends.toast.friend_added.message": "Hulec %s pryniaŭ vaš zapyt siabroŭstva",
	"gui.friends.toast.friend_invited.message": "Hulec %s zaprošany dałučycca da vašaha svietu.",
	"gui.friends.toast.friend_removed.message": "Hulec %s vydaleny sa spisa siabroŭ",
	"gui.friends.toast.generic_error": "Padčas abnaŭlennia spisa siabroŭ adbyłasia niečakanaja pamyłka. Kali łaska, paŭtarycie sprobu pazniej.",
	"gui.friends.toast.host_invite_expired.message": "Zaprašennie ŭ hety sviet dla hulca %s bolš nie dziejničaje.",
	"gui.friends.toast.invite_from_friend.message": "Hulec %s zaprasiŭ vas dałučycca da svajho svietu. Kab dałučycca, adkryjcie spis siabroŭ, nacisnuŭšy «%s»",
	"gui.friends.toast.join_invite_expired.message": "Zaprašennie dałučycca da svietu hulca %s bolš nie dziejničaje.",
	"gui.friends.toast.join_request.message": "Hulec %s adpraviŭ zapyt na dałučennie da vašaha svietu. Adkryjcie spis siabroŭ, nacisnuŭšy «%s», abo pierajdzicie da jaho praz mieniu hulni.",
	"gui.friends.toast.request_accepted.message": "Ciapier vy siabry z %s",
	"gui.friends.toast.request_received.message": "Hulec %s adpraviŭ vam zapyt siabroŭstva",
	"gui.friends.toast.request_sent.message": "Zapyt siabroŭstva adpraŭleny hulcu %s",
	"gui.friends.toast.request_to_join_friend.message": "Zapyt na dałučennie da svietu adpraŭleny hulcu %s",
	"gui.friends.toast.requests_accepted_multiple.message": "%s siabroŭ pryniali vašy zapyty siabroŭstva",
	"gui.friends.toast.requests_received_multiple.message": "Vy atrymali %s zapytaŭ siabroŭstva",
	"gui.friends.unfriend": "Vydalić siabra",
	"gui.game_rule.search": "Pošuk…",
	"gui.hours": "%s hadz.",
	"gui.language.search": "Pošuk…",
	...
	"gui.packSelection.search": "Pošuk…",
	"gui.privacy_link.message": "Pierajdzicie pa spasyłcy, kab kiravać naładami pryvatnasci i biaspieki ŭ sietcy.",
	"gui.privacy_link.title": "Užyvannie zmien u naładach Xbox moža zaniać niekatory čas.\n\nKali jany nie abnoviacca, pierazapuscicie hulniu.",
	"gui.proceed": "Praciahnuć",
	"gui.recipebook.moreRecipes": "Jašče varyjanty — pravy pstryčok",
	"gui.recipebook.next_page": "Nastupnaja staronka",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Papiaredniaja staronka",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Na hetaha hulca nielha paskardzicca, bo čat adklučany abo zabłakavany",
	...
	"gui.stats.none_found": "Statystyka nie znojdziena.",
	...
	"gui.up": "Uvierch",
	"gui.waitingForResponse.button.inactive": "Nazad (%ss)",
	"gui.waitingForResponse.title": "Čakannie sierviera",
	"gui.yes": "Tak",
	...
	"item.minecraft.armadillo_spawn_egg": "Jajka vykliku — Branianosiec",
	...
	"item.minecraft.axolotl_spawn_egg": "Jajka vykliku — Aksałotl",
	...
	"item.minecraft.bat_spawn_egg": "Jajka vykliku — Kažan",
	"item.minecraft.bee_spawn_egg": "Jajka vykliku — Pčała",
	...
	"item.minecraft.black_harness": "Čornaja vupraž",
	...
	"item.minecraft.blaze_spawn_egg": "Jajka vykliku — Połymień",
	"item.minecraft.blue_bundle": "Sini miech",
	"item.minecraft.blue_dye": "Sini farbavalnik",
	"item.minecraft.blue_egg": "Błakitnaja jajka",
	"item.minecraft.blue_harness": "Siniaja vupraž",
	"item.minecraft.bogged_spawn_egg": "Jajka vykliku — Dryhviak",
	...
	"item.minecraft.breeze_spawn_egg": "Jajka vykliku — Vietryk",
	...
	"item.minecraft.brown_harness": "Karyčnievaja vupraž",
	...
	"item.minecraft.camel_husk_spawn_egg": "Jajka vykliku — Viarblud-zdychlak",
	"item.minecraft.camel_spawn_egg": "Jajka vykliku — Viarblud",
	"item.minecraft.carrot": "Morkva",
	"item.minecraft.carrot_on_a_stick": "Morkva na pałačcy",
	"item.minecraft.cat_spawn_egg": "Jajka vykliku — Kot",
	"item.minecraft.cauldron": "Kacioł",
	"item.minecraft.cave_spider_spawn_egg": "Jajka vykliku — Piačorny pavuk",
	...
	"item.minecraft.chicken_spawn_egg": "Jajka vykliku — Kuryca",
	...
	"item.minecraft.cod_spawn_egg": "Jajka vykliku — Traska",
	...
	"item.minecraft.copper_axe": "Miadzianaja siakiera",
	"item.minecraft.copper_boots": "Miadzianyja boty",
	"item.minecraft.copper_chestplate": "Miadzianaja kirasa",
	"item.minecraft.copper_golem_spawn_egg": "Jajka vykliku — Miadziany holem",
	"item.minecraft.copper_helmet": "Miadziany šlem",
	"item.minecraft.copper_hoe": "Miadzianaja matyka",
	"item.minecraft.copper_horse_armor": "Miadzianaja konskaja brania",
	"item.minecraft.copper_ingot": "Miadziany zlitak",
	"item.minecraft.copper_leggings": "Miadzianyja ponažy",
	"item.minecraft.copper_nautilus_armor": "Miadzianaja naŭtyłusava brania",
	"item.minecraft.copper_nugget": "Kavałak miedzi",
	"item.minecraft.copper_pickaxe": "Miadzianaja kirka",
	"item.minecraft.copper_shovel": "Miadzianaja rydloŭka",
	"item.minecraft.copper_spear": "Miadzianaja dzida",
	"item.minecraft.copper_sword": "Miadziany mieč",
	"item.minecraft.cow_spawn_egg": "Jajka vykliku — Karova",
	"item.minecraft.creaking_spawn_egg": "Jajka vykliku — Rypień",
	...
	"item.minecraft.creeper_spawn_egg": "Jajka vykliku — Creeper",
	...
	"item.minecraft.cyan_harness": "Biruzovaja vupraž",
	...
	"item.minecraft.diamond_nautilus_armor": "Dyjamientavaja naŭtyłusava brania",
	"item.minecraft.diamond_pickaxe": "Dyjamientavaja kirka",
	"item.minecraft.diamond_shovel": "Dyjamientavaja rydloŭka",
	"item.minecraft.diamond_spear": "Dyjamientavaja dzida",
	...
	"item.minecraft.dolphin_spawn_egg": "Jajka vykliku — Delfin",
	"item.minecraft.donkey_spawn_egg": "Jajka vykliku — Asioł",
	"item.minecraft.dragon_breath": "Dychannie cmoka",
	"item.minecraft.dried_kelp": "Sušanaja łaminaryja",
	"item.minecraft.drowned_spawn_egg": "Jajka vykliku — Tapielec",
	...
	"item.minecraft.elder_guardian_spawn_egg": "Jajka vykliku — Staražytny vartavy",
	...
	"item.minecraft.ender_dragon_spawn_egg": "Jajka vykliku — Ender-cmok",
	"item.minecraft.ender_eye": "Voka Endera",
	"item.minecraft.ender_pearl": "Žamčužyna Enda",
	"item.minecraft.enderman_spawn_egg": "Jajka vykliku — Enderman",
	"item.minecraft.endermite_spawn_egg": "Jajka vykliku — Endermite",
	"item.minecraft.evoker_spawn_egg": "Jajka vykliku — Zaklinalnik",
	...
	"item.minecraft.glow_squid_spawn_egg": "Jajka vykliku — Zichatlivy sprut",
	"item.minecraft.glowstone_dust": "Zichatlivy pył",
	"item.minecraft.goat_horn": "Kaziny roh",
	"item.minecraft.goat_spawn_egg": "Jajka vykliku — Kaza",
	...
	"item.minecraft.happy_ghast_spawn_egg": "Jajka vykliku — Ščaslivy ghast",
	"item.minecraft.harness": "Vupraž",
	...
	"item.minecraft.hoglin_spawn_egg": "Jajka vykliku — Hoglin",
	...
	"item.minecraft.horse_spawn_egg": "Jajka vykliku — Koń",
	...
	"item.minecraft.husk_spawn_egg": "Jajka vykliku — Zdychlak",
	...
	"item.minecraft.iron_golem_spawn_egg": "Jajka vykliku — Žalezny holem",
	...
	"item.minecraft.iron_nautilus_armor": "Žaleznaja naŭtyłusava brania",
	...
	"item.minecraft.iron_spear": "Žaleznaja dzida",
	...
	"item.minecraft.lingering_potion.effect.wind_charged": "Tryvałaje zielle vietranasci",
	"item.minecraft.llama_spawn_egg": "Jajka vykliku — Łama",
	...
	"item.minecraft.magenta_harness": "Purpurnaja vupraž",
	"item.minecraft.magma_cream": "Zhustak mahmy",
	"item.minecraft.magma_cube_spawn_egg": "Jajka vykliku — Mahmakub",
	...
	"item.minecraft.mooshroom_spawn_egg": "Jajka vykliku — Mooshroom",
	...
	"item.minecraft.mule_spawn_egg": "Jajka vykliku — Muł",
	...
	"item.minecraft.music_disc_bounce": "Hrampłascinka",
	...
	"item.minecraft.music_disc_lava_chicken": "Hrampłascinka",
	...
	"item.minecraft.music_disc_tears": "Hrampłascinka",
	...
	"item.minecraft.nautilus_spawn_egg": "Jajka vykliku — Naŭtyłus",
	...
	"item.minecraft.netherite_horse_armor": "Netherytavaja konskaja brania",
	"item.minecraft.netherite_ingot": "Netherytavy zlitak",
	"item.minecraft.netherite_leggings": "Netherytavyja ponažy",
	"item.minecraft.netherite_nautilus_armor": "Netherytavaja naŭtyłusava brania",
	...
	"item.minecraft.netherite_spear": "Netherytavaja dzida",
	...
	"item.minecraft.ocelot_spawn_egg": "Jajka vykliku — Acełot",
	...
	"item.minecraft.orange_harness": "Aranžavaja vupraž",
	...
	"item.minecraft.panda_spawn_egg": "Jajka vykliku — Panda",
	"item.minecraft.paper": "Papiera",
	"item.minecraft.parched_spawn_egg": "Jajka vykliku — Suchlak",
	"item.minecraft.parrot_spawn_egg": "Jajka vykliku — Papuhaj",
	"item.minecraft.phantom_membrane": "Miembrana fantoma",
	"item.minecraft.phantom_spawn_egg": "Jajka vykliku — Fantom",
	"item.minecraft.pig_spawn_egg": "Jajka vykliku — Svinnia",
	...
	"item.minecraft.piglin_brute_spawn_egg": "Jajka vykliku — Brutalny piglin",
	"item.minecraft.piglin_spawn_egg": "Jajka vykliku — Piglin",
	"item.minecraft.pillager_spawn_egg": "Jajka vykliku — Maradzior",
	"item.minecraft.pink_bundle": "Ružovy miech",
	"item.minecraft.pink_dye": "Ružovy farbavalnik",
	"item.minecraft.pink_harness": "Ružovaja vupraž",
	...
	"item.minecraft.polar_bear_spawn_egg": "Jajka vykliku — Bieły miadzviedź",
	...
	"item.minecraft.potion.effect.wind_charged": "Zielle vietranasci",
	...
	"item.minecraft.prismarine_crystals": "Pryzmarynavyja kryštali",
	...
	"item.minecraft.pufferfish_spawn_egg": "Jajka vykliku — Ihołkabruch",
	...
	"item.minecraft.purple_harness": "Fijaletavaja vupraž",
	...
	"item.minecraft.rabbit_spawn_egg": "Jajka vykliku — Trus",
	...
	"item.minecraft.ravager_spawn_egg": "Jajka vykliku — Spustašalnik",
	...
	"item.minecraft.red_harness": "Čyrvonaja vupraž",
	"item.minecraft.redstone": "Redstonavy pył",
	"item.minecraft.resin_brick": "Smalanaja caglina",
	...
	"item.minecraft.salmon_spawn_egg": "Jajka vykliku — Łasoś",
	...
	"item.minecraft.sheep_spawn_egg": "Jajka vykliku — Aviečka",
	...
	"item.minecraft.shulker_spawn_egg": "Jajka vykliku — Shulker",
	...
	"item.minecraft.silverfish_spawn_egg": "Jajka vykliku — Łuskaŭnica",
	"item.minecraft.skeleton_horse_spawn_egg": "Jajka vykliku — Koń-škilet",
	"item.minecraft.skeleton_spawn_egg": "Jajka vykliku — Škilet",
	...
	"item.minecraft.slime_spawn_egg": "Jajka vykliku — Slimak",
	...
	"item.minecraft.sniffer_spawn_egg": "Jajka vykliku — Niuchač",
	...
	"item.minecraft.snow_golem_spawn_egg": "Jajka vykliku — Sniežny holem",
	...
	"item.minecraft.spider_spawn_egg": "Jajka vykliku — Pavuk",
	...
	"item.minecraft.splash_potion.effect.wind_charged": "Vybuchnoje zielle vietranasci",
	...
	"item.minecraft.squid_spawn_egg": "Jajka vykliku — Sprut",
	...
	"item.minecraft.stone_spear": "Kamiennaja dzida",
	"item.minecraft.stone_sword": "Kamienny mieč",
	"item.minecraft.stray_spawn_egg": "Jajka vykliku — Badziaha",
	"item.minecraft.strider_spawn_egg": "Jajka vykliku — Łavacuha",
	"item.minecraft.string": "Nitka",
	"item.minecraft.sugar": "Cukar",
	"item.minecraft.sulfur_cube_bucket": "Viadro z siernym kubam",
	"item.minecraft.sulfur_cube_spawn_egg": "Jajka vykliku — Sierny kub",
	...
	"item.minecraft.tadpole_spawn_egg": "Jajka vykliku — Apałonik",
	...
	"item.minecraft.tipped_arrow.effect.wind_charged": "Strała vietranasci",
	...
	"item.minecraft.trader_llama_spawn_egg": "Jajka vykliku — Łama handlara",
	...
	"item.minecraft.tropical_fish_spawn_egg": "Jajka vykliku — Trapičnaja ryba",
	"item.minecraft.turtle_helmet": "Pancyr čarapachi",
	"item.minecraft.turtle_scute": "Łuskavinka čarapachi",
	"item.minecraft.turtle_spawn_egg": "Jajka vykliku — Čarapacha",
	...
	"item.minecraft.vex_spawn_egg": "Jajka vykliku — Škodnik",
	"item.minecraft.villager_spawn_egg": "Jajka vykliku — Viaskoviec",
	"item.minecraft.vindicator_spawn_egg": "Jajka vykliku — Baraćbit",
	"item.minecraft.wandering_trader_spawn_egg": "Jajka vykliku — Vandroŭny handlar",
	...
	"item.minecraft.warden_spawn_egg": "Jajka vykliku — Vartaŭnik",
	...
	"item.minecraft.white_harness": "Biełaja vupraž",
	...
	"item.minecraft.witch_spawn_egg": "Jajka vykliku — Viedźma",
	"item.minecraft.wither_skeleton_spawn_egg": "Jajka vykliku — Wither-škilet",
	"item.minecraft.wither_spawn_egg": "Jajka vykliku — Wither",
	"item.minecraft.wolf_armor": "Voŭčaja brania",
	"item.minecraft.wolf_spawn_egg": "Jajka vykliku — Voŭk",
	...
	"item.minecraft.wooden_spear": "Draŭlanaja dzida",
	...
	"item.minecraft.yellow_harness": "Žoŭtaja vupraž",
	"item.minecraft.zoglin_spawn_egg": "Jajka vykliku — Zoglin",
	"item.minecraft.zombie_horse_spawn_egg": "Jajka vykliku — Koń-miarcviak",
	"item.minecraft.zombie_nautilus_spawn_egg": "Jajka vykliku — Naŭtyłus-miarcviak",
	"item.minecraft.zombie_spawn_egg": "Jajka vykliku — Miarcviak",
	"item.minecraft.zombie_villager_spawn_egg": "Jajka vykliku — Miarcviak-viaskoviec",
	"item.minecraft.zombified_piglin_spawn_egg": "Jajka vykliku — Miarcviak-piglin",
	...
	"item.spawn_egg.peaceful": "Adklučana na mirnaj składanasci",
	...
	"itemGroup.spawnEggs": "Jajki vykliku",
	...
	"key.categories.spectator": "Naziralnik",
	"key.categories.ui": "Hulniavy interfejs",
	"key.category.minecraft.creative": "Tvorčy režym",
	"key.category.minecraft.debug": "Adładka",
	"key.category.minecraft.gameplay": "Hulniavy praces",
	"key.category.minecraft.inventory": "Ryštunak",
	"key.category.minecraft.misc": "Roznaje",
	"key.category.minecraft.movement": "Ruch",
	"key.category.minecraft.multiplayer": "Sumiesnaja hulnia",
	"key.category.minecraft.spectator": "Naziralnik",
	"key.chat": "Adkryć čat",
	"key.command": "Uviesci kamandu",
	"key.debug.clearChat": "Ačyscić čat",
	"key.debug.copyLocation": "Kapijavać kaardynaty",
	"key.debug.copyRecreateCommand": "Kapijavać danyja",
	"key.debug.crash": "Adładačny zboj",
	"key.debug.debugOptions": "Nałady adładki",
	"key.debug.dumpDynamicTextures": "Zachavać dynamičnyja tekstury",
	"key.debug.dumpVersion": "Zachavać infarmacyju ab viersii",
	"key.debug.focusPause": "Pieraklučennie paŭzy pry pieraklučenni na inšaje akno",
	"key.debug.fpsCharts": "Hrafiki FPS",
	"key.debug.lightmapTexture": "Karta cieniaŭ",
	"key.debug.modifier": "Adładačnaja kłaviša-madyfikatar",
	"key.debug.networkCharts": "Hrafiki sietkavaha złučennia",
	"key.debug.overlay": "Pakazać/prybrać averłej",
	"key.debug.profiling": "Pačać/spynić prafilavannie",
	"key.debug.profilingChart": "Hrafik prafilavannia",
	"key.debug.reloadChunk": "Pierazahruzić čanki",
	"key.debug.reloadResourcePacks": "Pierazahruzić pakiety resursaŭ",
	"key.debug.showAdvancedTooltips": "Pakazać pašyranyja padkazki",
	"key.debug.showChunkBorders": "Pakazvać miežy čankaŭ",
	"key.debug.showHitboxes": "Pakazvać chitboksy",
	"key.debug.spectate": "Pieramykać režym naziralnika",
	"key.debug.switchGameMode": "Pieramykalnik režymaŭ hulni",
	"key.drop": "Vykinuć vybrany pradmiet",
	"key.forward": "Upierad",
	"key.friends": "Ekran siabroŭ",
	...
	"key.quickActions": "Chutkija dziejanni",
	"key.right": "Uprava",
	...
	"key.spectatorHotbar": "Vybrać na paneli chutkaha dostupu",
	"key.spectatorOutlines": "Padsviečvać hulcoŭ",
	"key.sprint": "Bieh",
	"key.swapOffhand": "Pamianiać miescami pradmiety ŭ rukach",
	"key.toggleGui": "Pieramykalnik interfiejsu",
	"key.togglePerspective": "Pieraklučyć pierspiektyvu",
	"key.toggleSpectatorShaderEffects": "Pieraklučennie šejderaŭ u režymie naziralnika",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Dadać siervier",
	"manageServer.edit.title": "Redahavać zviestki sierviera",
	"manageServer.enterIp": "Adras sierviera",
	"manageServer.enterName": "Nazva sierviera",
	"manageServer.resourcePack": "Pakiety resursaŭ sierviera",
	"manageServer.resourcePack.disabled": "Adklučany",
	"manageServer.resourcePack.enabled": "Uklučany",
	"manageServer.resourcePack.prompt": "Zapytvać",
	...
	"mco.backup.entry.worldType.adventureMap": "Pryhodnickaja mapa",
	"mco.backup.entry.worldType.experience": "Uražannie",
	"mco.backup.entry.worldType.inspiration": "Natchniennie",
	"mco.backup.entry.worldType.minigame": "Mini-hulnia",
	"mco.backup.entry.worldType.normal": "Zvyčajny",
	"mco.backup.entry.worldType.unknown": "Nieviadomy",
	...
	"mco.configure.world.buttons.close": "Časova zakryć Realm",
	...
	"mco.configure.world.buttons.newworld": "Novy sviet",
	"mco.configure.world.buttons.open": "Adkryć Realm iznoŭ",
	"mco.configure.world.buttons.options": "Nałady svietu",
	"mco.configure.world.buttons.players": "Hulcy",
	"mco.configure.world.buttons.region_preference": "Vybrać rehijon…",
	"mco.configure.world.buttons.resetworld": "Skinuć sviet",
	"mco.configure.world.buttons.save": "Zachavać",
	...
	"mco.configure.world.close.question.line1": "Vy možacie časova zakryć svoj Realm, kab nichto nie moh hulać, pakul vy robicie zmieny. Kali budziecie hatovy – adkryjcie jaho znoŭ.\n\nHeta nie skasuje vašu padpisku na Realms.",
	"mco.configure.world.close.question.line2": "Sapraŭdy praciahvać?",
	"mco.configure.world.close.question.title": "Patrebna zrabić zmieny biez parušennia pracy?",
	"mco.configure.world.closing": "Zakryvajem Realm da času…",
	...
	"mco.configure.world.loading": "Zahruzka Realm",
	...
	"mco.configure.world.name.validation.whitespace": "Nie pavinna kančacca ci pačynacca prabiełam. Budzie abrezana.",
	"mco.configure.world.opening": "Adkryccio Realm…",
	"mco.configure.world.players.error": "Hulec z dadzienym imiem nie isnuje",
	"mco.configure.world.players.invite.duplicate": "Hulec z paznačanym imiem užo zaprošany ŭ Realm",
	"mco.configure.world.players.inviting": "Zaprašennie hulca…",
	"mco.configure.world.players.title": "Hulcy",
	"mco.configure.world.pvp": "PVP",
	"mco.configure.world.region_preference": "Pažadany rehijon",
	"mco.configure.world.region_preference.title": "Vybar pažadanaha rehijonu",
	...
	"mco.configure.world.settings.expired": "Vy nie možacie zmianiać nałady praterminavanaha Realm",
	...
	"mco.configure.world.spawnMonsters": "Zjaŭlennie pačvar",
	...
	"mco.configure.world.subscription.tab": "Padpiska",
	...
	"mco.connect.region": "Rehijon sierviera: %s",
	...
	"mco.errorMessage.realmsService.configurationError": "Pry redahavanni naład svietu adbyłasia niečakanaja pamyłka",
	...
	"mco.play.button.realm.closed": "Realm zakryty",
	...
	"mco.upload.close.failure": "Nie ŭdałosia zakryć vaš Realm. Paŭtarycie sprobu pazniej.",
	...
	"menu.custom_options": "Karystalnickija nałady…",
	"menu.custom_options.title": "Karystalnickija nałady",
	"menu.custom_options.tooltip": "Zaŭvaha: karystalnickija nałady dajucca staronnimi siervierami ci zmiescivam.\nBudźcie asciarožnymi!",
	"menu.custom_screen_info.button_narration": "Heta karystalnicki ekran. Daviedacca bolš.",
	"menu.custom_screen_info.contents": "Zmiesciva hetaha ekrana kantralujecca staronnimi siervierami i mapami, jakija nie znachodziacca pad kiravanniem, nahladam ci va ŭłasnasci Mojang Studios abo Microsoft.\n\nBudźcie asciarožnymi! Zaŭždy praviarajcie biaspiečnasć spasyłak i nie dzialiciesia svaimi asabistymi zviestkami, uklučajučy ŭlikovyja danyja.\n\nKali hety ekran nie dazvalaje vam praciahnuć hulniu, vy možacie adłučycca ad sierviera, nacisnuŭšy knopku ŭnizie.",
	"menu.custom_screen_info.disconnect": "Karystalnicki ekran adchileny",
	"menu.custom_screen_info.title": "Zaŭvaha pra karystalnickija ekrany",
	"menu.custom_screen_info.tooltip": "Heta karystalnicki ekran. Nacisnicie, kab daviedacca bolš.",
	...
	"menu.multiplayerOptions.applyChanges": "Prymianić zmieny",
	"menu.multiplayerOptions.button": "Sumiesnaja hulnia…",
	"menu.multiplayerOptions.network": "Sumiesnaja hulnia",
	"menu.multiplayerOptions.network.header": "Sieciva",
	"menu.multiplayerOptions.network.lan": "LAN",
	"menu.multiplayerOptions.network.lan.tooltip": "Hulcy ŭ toj ža sietcy mohuć dałučycca.",
	"menu.multiplayerOptions.network.off": "VYKŁ",
	"menu.multiplayerOptions.network.off.tooltip": "Nichto nie moža dałučycca.",
	"menu.multiplayerOptions.network.online": "U sietcy",
	"menu.multiplayerOptions.network.online.tooltip": "Siabry ŭ sietcy mohuć dałučycca.",
	"menu.multiplayerOptions.otherPlayers.header": "Inšyja hulcy",
	"menu.multiplayerOptions.publish.started.lan": "Hety sviet ciapier adkryty dla łakalnaj sietki. Numar porta: %s",
	"menu.multiplayerOptions.publish.started.online": "Hety sviet ciapier adkryty dla sumiesnaj hulni. Numar porta: %s",
	"menu.multiplayerOptions.publish.stopped": "Hety sviet bolš nie adkryty dla sumiesnaj hulni",
	"menu.multiplayerOptions.title": "Nałady sumiesnaj hulni",
	"menu.online": "Minecraft Realms",
	"menu.options": "Nałady…",
	"menu.paused": "Hulnia prypyniena",
	"menu.playdemo": "Hulać u demanstracyjnym sviecie",
	"menu.playerReporting": "Skarhi na hulcoŭ",
	"menu.playerReporting.no_players": "U hetym sviecie niama hulcoŭ, na jakich možna paskardzicca",
	"menu.preparingSpawn": "Padrychtoŭka zony adradžennia: %s%%",
	"menu.quick_actions": "Chutkija dziejanni…",
	"menu.quick_actions.title": "Chutkija dziejanni",
	...
	"multiplayer.codeOfConduct.check": "Bolš nie paviedamlać dla hetych normaŭ pavodzin",
	"multiplayer.codeOfConduct.title": "Normy pavodzin na sierviery",
	"multiplayer.confirm_command.parse_errors": "Vy namahajeciesia vykanać nieviadomuju abo niapravilnuju kamandu.\nVy ŭpeŭnieny?\nKamanda: %s",
	"multiplayer.confirm_command.permissions_required": "Vy namahajeciesia vykanać kamandu, jakaja patrabuje pavyšanych dazvołaŭ.\nHeta moža admoŭna paŭpłyvać na vašu hulniu.\nVy ŭpeŭnieny?\nKamanda: %s",
	"multiplayer.confirm_command.run_command": "Vykanannie kamandy",
	"multiplayer.confirm_command.signature_required": "Vy namahajeciesia vykanać kamandu, jakaja adpravić paviedamlenni ŭ čacie, užyvajučy vaša imia.\nJaje možna vykanać tolki z akna čatu.\nKamanda: %s",
	"multiplayer.confirm_command.suggest_command": "Kapijavać u akno čatu",
	"multiplayer.confirm_command.title": "Pacvierdzić vykanannie kamandy",
	...
	"multiplayer.disconnect.banned.reason.default": "Vy byli zabłakavany apierataram.",
	...
	"multiplayer.disconnect.code_of_conduct": "Siervier patrabuje pahadzicca z normami pavodzin",
	"multiplayer.disconnect.configuration_error": "Niečakanaja pamyłka padčas kanfihuracyi",
	...
	"multiplayer.message_not_delivered": "Nie ŭdałosia dastavić paviedamlennie ŭ čat, praviercie žurnał sierviera: %s",
	...
	"multiplayer.status.anonymous_player": "Ananimny hulec",
	...
	"narration.checkbox.usage.focused.check": "Nacisnicie «Enter», kab paznačyć",
	"narration.checkbox.usage.focused.uncheck": "Nacisnicie «Enter», kab zniać paznaku",
	"narration.checkbox.usage.hovered": "Nacisnicie ŁKM, kab pieraklučyć",
	"narration.checkbox.usage.hovered.check": "Nacisnicie «ŁKM», kab paznačyć",
	"narration.checkbox.usage.hovered.uncheck": "Nacisnicie «ŁKM», kab zniać paznaku",
	"narration.component_list.usage": "Nacisnicie «Tab», kab pierajsci da nastupnaha elemienta",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Nacisnicie «Enter», kab pačać zmianiać značennie paŭzunka",
	...
	"narration.suggestion.usage.fill.fixed": "Nacisnicie «Tab», kab dastasavać prapanovu",
	...
	"options.accessibility.tooltip": "Spiecyjalnyja mahčymasci",
	"options.allowCursorChanges": "Dazvolić zmienu kursora",
	"options.allowCursorChanges.tooltip": "Dazvalaje kursoru myšy zmianiać formu pry naviadzienni na peŭnyja elemienty interfiejsu.",
	"options.allowFriendRequests": "Dazvolić zapyty",
	"options.allowFriendRequests.tooltip": "Dazvolić inšym hulcam adpraŭlać vam zapyty siabroŭstva",
	"options.allowServerListing": "Pakazvać u spisach",
	"options.allowServerListing.tooltip": "Sierviery mohuć pakazvać hulcoŭ u sietcy jak častku svajho publičnaha statusu.\nKali hety paramietr adklučany, vaša imia nie budzie adlustroŭvacca ŭ takich spisach.",
	...
	"options.chat.drafts": "Zachoŭvać nieadpraŭlenyja paviedamlenni",
	"options.chat.drafts.tooltip": "Nieadpraŭlenyja paviedamlenni buduć zachavany i mohuć być adpraŭleny pry nastupnym adkrycci čatu.",
	...
	"options.chunkFade": "Čas prajaŭlennia čankaŭ",
	"options.chunkFade.none": "Prajaŭlennie čankaŭ: Niama",
	"options.chunkFade.seconds": "Prajaŭlennie čanku: %s siek.",
	"options.chunkFade.tooltip": "Daŭžynia prajaŭlennia čankaŭ u siekundach pry pieršaj prahruzcy.",
	...
	"options.cutoutLeaves": "Prazrystaje liscie",
	"options.cutoutLeaves.tooltip": "Dazvalaje bačyć skroź prahały ŭ lisci. Adklučennie hetaj funkcyi moža palepšyć pradukcyjnasć.",
	...
	"options.exclusiveFullscreen": "Ekskluziŭny poŭnaekranny režym",
	"options.exclusiveFullscreen.warningTooltip": "Heta opcyja moža pieraškodzić pracy niekatorych sposabaŭ uvodu.",
	...
	"options.friendsList": "Spis siabroŭ",
	"options.friendsList.confirm.message": "Spis siabroŭ vyznačaje, z kim vy možacie razmaŭlać u čacie, kali dla nałady «Možna mieć znosiny pa-za Xbox» vybrana značennie «Siabry».\n\nKirujcie hetaj naładaj u svaim ulikovym zapisie Microsoft.\n\nKali Spis siabroŭ uklučany, inšyja hulcy mohuć adpraŭlać vam zapyty siabroŭstva. Vy možacie vyklučyć zaprašenni ŭ siabry abo spis siabroŭ u luby čas.",
	"options.friendsList.confirm.message.link": "Microsoft account",
	"options.friendsList.confirm.title": "Uklučyć spis siabroŭ?",
	"options.friendsList.confirm.turnOff": "Adklučyć",
	"options.friendsList.confirm.turnOn": "Uklučyć",
	...
	"options.graphics.custom": "Karystalnicki",
	...
	"options.graphics.preset": "Šabłon",
	"options.graphics.preset.tooltip": "Ustaloŭvaje paramietry «Jakasć i pradukcyjnasć» na razumnyja značenni pa zmaŭčanni, što adpaviadajuć žadanaj jakasci.",
	...
	"options.graphicsApi": "Hrafičny API",
	"options.graphicsApi.default": "Pa zmaŭčanni",
	"options.graphicsApi.opengl": "OpenGL",
	"options.graphicsApi.restart": "Kab zmianić hrafičny API, treba pierazapuscić hulniu.",
	"options.graphicsApi.tooltip": "Vybar jaki hrafičny API vykarystoŭvać dla adlustravannia. Pakińcie značennie «Pa zmaŭčanni», kali ŭ vas niama asablivaj patreby heta zmianiać! Zmieny nabuduć moc pry nastupnym zapusku hulni.",
	...
	"options.improvedTransparency": "Palepšanaja prazrystasć",
	"options.improvedTransparency.tooltip": "Ekspierymientalny padychod, jaki vykarystoŭvaje ekrannyja šejdary dla admaloŭki nadvorja, vobłakaŭ i čascinak za napaŭprazrystymi błokami i vadoj.\nHeta paŭpłyvaje na pradukcyjnasć hrafičnaha pracesara.",
	"options.inGameNotification": "Apaviaščenni ŭ hulni",
	"options.inGameNotification.tooltip": "Pakazvać apaviaščenni ab siabrach u hulni",
	...
	"options.invertMouseX": "Inviersija myšy pa X",
	"options.invertMouseY": "Inviersija myšy pa Y",
	...
	"options.language.narration": "Zmianić movu",
	"options.language.title": "Mova",
	"options.language.tooltip": "Zmianić movu",
	...
	"options.maxAnisotropy": "Anizatropnaja filtracyja",
	"options.maxAnisotropy.tooltip": "Značna palapšaje jakasć zhładžvannia tekstur, ale znižaje pradukcyjnasć i značna pavialičvaje vykarystannie videapamiaci. Moža padtrymvacca nie na ŭsich pryładach.",
	...
	"options.musicToast": "Nazva muzyki",
	"options.musicToast.never": "Nikoli",
	"options.musicToast.never.tooltip": "Nazva muzyki nie pakazvajecca na ekranie.",
	"options.musicToast.pauseMenu": "Mieniu paŭzy",
	"options.musicToast.pauseMenu.tooltip": "Nazva muzyki adlustroŭvajecca ŭvieś čas u mieniu paŭzy hulni, pakul hraje muzyka.",
	"options.musicToast.pauseMenuAndToast": "Mieniu paŭzy i padkazka",
	"options.musicToast.pauseMenuAndToast.tooltip": "Pakazvaje padkazku štoraz, jak pačynajecca prajhravannie muzyki. Takaja ž padkazka pastajanna pakazvajecca ŭ mieniu paŭzy hulni, pakul hraje muzyka.",
	"options.music_frequency": "Pieryjadyčnasć muzyki",
	"options.music_frequency.constant": "Pastajanna",
	"options.music_frequency.default": "Pa zmaŭčanni",
	"options.music_frequency.frequent": "Časta",
	"options.music_frequency.tooltip": "Zmianiaje častatu prajhravannia muzyki ŭ sviecie.",
	...
	"options.needsRestart": "Opcyja budzie prymieniena pasla pierazapusku.",
	"options.notifications.display_time": "Daŭžynia apaviaščenniaŭ",
	"options.notifications.display_time.tooltip": "Upłyvaje na daŭžyniu pakazu apaviaščenniaŭ na ekranie.",
	"options.off": "VYKŁ",
	"options.off.composed": "%s: VYKŁ",
	"options.on": "UKŁ",
	"options.on.composed": "%s: UKŁ",
	"options.online": "Sietka…",
	"options.online.friends.header": "Spis siabroŭ",
	"options.online.realms.header": "Realms",
	"options.online.servers.header": "Servers",
	"options.online.title": "Nałady sietki",
	"options.online.xboxSettings": "Nałady Xbox…",
	...
	"options.renderCloudsDistance": "Dalokasć abłokaŭ",
	"options.renderDistance": "Adrysoŭka",
	"options.resourcepack": "Pakiety resursaŭ…",
	"options.restartRequired": "Kab prymianić niekatoryja z vašych zmianienniaŭ, treba pierazapuscić hulniu.",
	...
	"options.sharePresence": "Aktyŭnasć",
	"options.sharePresence.all": "Usio",
	"options.sharePresence.all.tooltip": "Aktyŭnasć pakazvajecca vašym siabram. Jany buduć bačyć, što vy ŭ sietcy, i što mienavita vy robicie.",
	"options.sharePresence.limited": "Abmiežavana",
	"options.sharePresence.limited.tooltip": "Abmiežavany dostup da aktyŭnasci. Siabry buduć bačyć, što vy ŭ sietcy, ale nie buduć viedać, što mienavita vy robicie. Vy ŭsio jašče možacie zaprašać siabroŭ u svaju hulniu.",
	"options.sharePresence.none": "Ničoha",
	"options.sharePresence.none.tooltip": "Aktyŭnasć nie pakazvajecca. Vy adlustroŭvajeciesia jak pa-za sietkaj.",
	"options.showNowPlayingToast": "Pakazvać nazvu treka",
	"options.showNowPlayingToast.tooltip": "Pakazvaje padkazku štoraz, jak pačynajecca prajhravannie muzyki. Takaja ž padkazka pastajanna pakazvajecca ŭ mieniu paŭzy hulni, pakul hraje muzyka.",
	"options.showSubtitles": "Subcitry",
	"options.showSubtitles.tooltip": "Uklučaje subcitry dla hukaŭ, jakija prajhrajucca ŭ hulni.",
	...
	"options.sprintWindow": "Pieryjad razbiehu",
	"options.sprintWindow.tooltip": "Pieryjad u taktach, na praciahu jakoha padvojnaje naciskannie kłavišy «Upierad» uklučaje bieh.",
	...
	"options.textureFiltering": "Filtracyja tekstur",
	"options.textureFiltering.anisotropic": "Anizatropnaja",
	"options.textureFiltering.anisotropic.tooltip": "Aparatny mietad filtracyi. Maje prykmietny ŭpłyŭ na pradukcyjnasć i vykarystannie videapamiaci. Moža padtrymlivacca nie na ŭsich pryładach.",
	"options.textureFiltering.none": "Niama",
	"options.textureFiltering.none.tooltip": "Tekstury adlustroŭvajucca biez zhładžvannia. Błoki mohuć vyhladać nievyrazna, kali hladzieć pad vuhłom.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Zvyšdyskretyzacyja na paviernutaj sietcy / RGSS)\nMietad zhładžvannia na asnovie šejdaraŭ, jaki palapšaje jakasć tekstur z umieranym upłyvam na pradukcyjnasć.",
	...
	"options.video.interface.header": "Interfiejs",
	"options.video.preferences.header": "Pažadanni",
	"options.video.quality.header": "Jakasć i pradukcyjnasć",
	"options.videoTitle": "Nałady hrafiki",
	"options.viewBobbing": "Pakałychvannie kamiery",
	"options.vignette": "Pakazvać vińjetku",
	"options.vignette.tooltip": "Vińjetka — słabaprymietnaja tekstura, jakaja prycišaje jarkasć pa krajach ekrana i papiaredžvaje pra blizkasć miažy svietu.",
	"options.visible": "Bačny",
	"options.vsync": "VSync",
	"options.weatherRadius": "Radyus efiektaŭ nadvorja",
	"options.weatherRadius.tooltip": "Radyus vobłasci, u jakoj vidać efiekty daždžu i sniehu. Maje niaznačny ŭpłyŭ na pradukcyjnasć.",
	"options.worldOptions.button": "Nałady svietu…",
	"options.worldOptions.title": "Nałady svietu",
	...
	"pack.incompatible.confirm.unknown": "Hety pakiet niaspraŭny abo zrobleny dla nieviadomaj viersii Minecraft i moža pracavać z pamyłkami.",
	...
	"pack.incompatible.unknown": "(Niaspraŭny abo niesumiaščalny)",
	...
	"realms.configuration.region.australia_east": "Novy Paŭdniovy Uels, Aŭstralija",
	"realms.configuration.region.australia_southeast": "Viktoryja, Aŭstralija",
	"realms.configuration.region.brazil_south": "Brazilija",
	"realms.configuration.region.central_india": "Indyja",
	"realms.configuration.region.central_us": "Ajava, ZŠA",
	"realms.configuration.region.east_asia": "Hankonh",
	"realms.configuration.region.east_us": "Virdžynija, ZŠA",
	"realms.configuration.region.east_us_2": "Paŭnočnaja Karalina, ZŠA",
	"realms.configuration.region.france_central": "Francyja",
	"realms.configuration.region.japan_east": "Uschodniaja Japonija",
	"realms.configuration.region.japan_west": "Zachodniaja Japonija",
	"realms.configuration.region.korea_central": "Paŭdniovaja Kareja",
	"realms.configuration.region.north_central_us": "Ilinojs, ZŠA",
	"realms.configuration.region.north_europe": "Irłandyja",
	"realms.configuration.region.south_central_us": "Techas, ZŠA",
	"realms.configuration.region.southeast_asia": "Sinhapur",
	"realms.configuration.region.sweden_central": "Šviecyja",
	"realms.configuration.region.uae_north": "Abjadnanyja Arabskija Emiraty (AAE)",
	"realms.configuration.region.uk_south": "Paŭdniovaja Anhlija",
	"realms.configuration.region.west_central_us": "Juta, ZŠA",
	"realms.configuration.region.west_europe": "Niderłandy",
	"realms.configuration.region.west_us": "Kalifornija, ZŠA",
	"realms.configuration.region.west_us_2": "Vašynhton, ZŠA",
	"realms.configuration.region_preference.automatic_owner": "Aŭtamatyčny (sietkavaja zatrymka ŭłasnika)",
	"realms.configuration.region_preference.automatic_player": "Aŭtamatyčny (pieršy hulec, jaki dałučyŭsia)",
	...
	"restrictions_screen.button": "Abmiežavanni…",
	"restrictions_screen.permission.receive_player_messages.allowed": "Vy možacie atrymlivać paviedamlenni ad hulcoŭ",
	"restrictions_screen.permission.receive_player_messages.denied": "Vy nie možacie atrymlivać paviedamlenni ad hulcoŭ",
	"restrictions_screen.permission.receive_system_messages.allowed": "Vy možacie atrymlivać sistemnyja paviedamlenni ad sierviera",
	"restrictions_screen.permission.receive_system_messages.denied": "Vy nie možacie atrymlivać sistemnyja paviedamlenni ad sierviera",
	"restrictions_screen.permission.send_commands.allowed": "Vy možacie adpraŭlać kamandy",
	"restrictions_screen.permission.send_commands.denied": "Vy nie možacie adpraŭlacie kamandy",
	"restrictions_screen.permission.send_messages.allowed": "Vy možacie adpraŭlać paviedamlenni",
	"restrictions_screen.permission.send_messages.denied": "Vy nie možacie adpraŭlać paviedamlenni",
	"restrictions_screen.title": "Abmiežavanni",
	...
	"selectWorld.backupJoinConfirmButton": "Zrabić reziervovuju kopiju",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Stvaryć reziervovuju kopiju pierad abnaŭlenniem hetaha svietu?",
	...
	"selectWorld.backupWarning.file_fixing_required": "Hety sviet treba abnavić, pierš jak vy zmožacie hulać u jaho. My nastojliva raim stvaryć reziervovuju kopiju pierad praciaham na vypadak, kali sviet budzie paškodžany.",
	...
	"selectWorld.locked": "Zabłakavana inšaj aktyŭnaj kopijaj hulni.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Pierš jak redahavać hety sviet, treba abnavić jaho da apošniaj viersii praz zmieny ŭ farmacie svietu.",
	"selectWorld.requiresFileFixingTooltip.play": "Pierš jak hulać u hetym sviecie, treba abnavić jaho da apošniaj viersii praz zmieny ŭ farmacie svietu.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Pierš jak pierastvaryć hety sviet, treba abnavić jaho da apošniaj viersii praz zmieny ŭ farmacie svietu.",
	...
	"selectWorld.upgrade_and_play": "Abnavić i hulać",
	...
	"selectWorld.waitingForBackup.message": "U zaležnasci ad pamieru vašaha svietu heta moža zaniać peŭny čas. Kali łaska, nie zakryvajcie hulniu i nie vyklučajcie pryładu.",
	"selectWorld.waitingForBackup.title": "Stvarennie reziervovaj kopii",
	...
	"selectWorld.world_gen_settings_access": "Nie ŭdałosia pračytać abo atrymać dostup da fajła naład hienieracyi svietu! %s",
	"selecteWorld.backupRequiredTooltip": "Pierad tym jak zahruzić sviet, spačatku stvarycie reziervovuju kopiju",
	...
	"soundCategory.ui": "Interfiejs",
	"soundCategory.voice": "Dyktar/Hołas",
	...
	"stat.minecraft.bell_ring": "Udaraŭ u zvon",
	...
	"stat.minecraft.happy_ghast_one_cm": "Na ščaslivym ghascie",
	...
	"stat.minecraft.nautilus_one_cm": "Prajechana na naŭtyłusie",
	...
	"stat.minecraft.time_since_rest": "Čas ad apošniaha snu",
	...
	"subtitles.block.copper_chest.close": "Kufar zakryvajecca",
	"subtitles.block.copper_chest.open": "Kufar adkryvajecca",
	...
	"subtitles.block.dried_ghast.ambient": "Huki suchasci",
	"subtitles.block.dried_ghast.ambient_water": "Zasmahły ghast uvilhotnieny",
	"subtitles.block.dried_ghast.place_in_water": "Zasmahły ghast admakaje",
	"subtitles.block.dried_ghast.transition": "Zasmahły ghast pačuvajecca lepš",
	"subtitles.block.dry_grass.ambient": "Šum vietru",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Siernaja krynica vyviarhajecca",
	"subtitles.block.potent_sulfur.noxious_gas": "Atrutny haz zjaŭlajecca",
	...
	"subtitles.block.shelf.activate": "Palica aktyvavana",
	"subtitles.block.shelf.deactivate": "Palica deaktyvavana",
	"subtitles.block.shelf.multi_swap": "Pradmiety pieramieščany",
	"subtitles.block.shelf.place_item": "Pradmiet razmieščany",
	"subtitles.block.shelf.single_swap": "Pradmiet pieramieščany",
	"subtitles.block.shelf.take_item": "Pradmiet uziaty",
	...
	"subtitles.block.trapdoor.close": "Luk začyniajecca",
	"subtitles.block.trapdoor.open": "Luk adčyniajecca",
	...
	"subtitles.entity.baby_cat.ambient": "Kaciania miaŭkaje",
	"subtitles.entity.baby_cat.beg_for_food": "Kaciania prosić",
	"subtitles.entity.baby_cat.death": "Kaciania hinie",
	"subtitles.entity.baby_cat.eat": "Kaciania jesć",
	"subtitles.entity.baby_cat.hiss": "Kaciania šypić",
	"subtitles.entity.baby_cat.hurt": "Kaciania paranienaje",
	"subtitles.entity.baby_cat.purr": "Kaciania murkaje",
	"subtitles.entity.baby_chicken.ambient": "Kurania ciŭkaje",
	"subtitles.entity.baby_chicken.death": "Kurania hinie",
	"subtitles.entity.baby_chicken.hurts": "Kurania paranienaje",
	"subtitles.entity.baby_horse.ambient": "Žarabia irže",
	"subtitles.entity.baby_horse.angry": "Žarabia ravie",
	"subtitles.entity.baby_horse.breathe": "Žarabia dychaje",
	"subtitles.entity.baby_horse.death": "Žarabia hinie",
	"subtitles.entity.baby_horse.eat": "Žarabia jesć",
	"subtitles.entity.baby_horse.hurt": "Žarabia paranienaje",
	"subtitles.entity.baby_horse.land": "Žarabia pryziamlajecca",
	"subtitles.entity.baby_nautilus.ambient": "Naŭtyłus-dziciania ciochkaje",
	"subtitles.entity.baby_nautilus.ambient_land": "Naŭtyłus-dziciania ciochkaje",
	"subtitles.entity.baby_nautilus.death": "Naŭtyłus-dziciania hinie",
	"subtitles.entity.baby_nautilus.death_land": "Naŭtyłus-dziciania hinie",
	"subtitles.entity.baby_nautilus.eat": "Naŭtyłus-dziciania jesć",
	"subtitles.entity.baby_nautilus.hurt": "Naŭtyłus-dziciania paranienaje",
	"subtitles.entity.baby_nautilus.hurt_land": "Naŭtyłus-dziciania paranienaje",
	"subtitles.entity.baby_nautilus.swim": "Naŭtyłus-dziciania płyvie",
	"subtitles.entity.baby_pig.ambient": "Parasia rochkaje",
	"subtitles.entity.baby_pig.death": "Parasia hinie",
	"subtitles.entity.baby_pig.eat": "Parasia jesć",
	"subtitles.entity.baby_pig.hurt": "Parasia paranienaje",
	"subtitles.entity.baby_wolf.ambient": "Ščania ciaŭkaje",
	"subtitles.entity.baby_wolf.death": "Ščania hinie",
	"subtitles.entity.baby_wolf.growl": "Ščania hyrkaje",
	"subtitles.entity.baby_wolf.hurt": "Ščania paranienaje",
	"subtitles.entity.baby_wolf.pant": "Ščania ciažka sapie",
	"subtitles.entity.baby_wolf.whine": "Ščania skavyča",
	...
	"subtitles.entity.camel.dash_ready": "Viarblud nabirajecca sił",
	...
	"subtitles.entity.camel_husk.ambient": "Viarblud-zdychlak burkoča",
	"subtitles.entity.camel_husk.dash": "Viarblud-zdychlak pieraskokvaje",
	"subtitles.entity.camel_husk.dash_ready": "Viarblud-zdychlak nabirajecca sił",
	"subtitles.entity.camel_husk.death": "Viarblud-zdychlak hinie",
	"subtitles.entity.camel_husk.eat": "Viarblud-zdychlak jesć",
	"subtitles.entity.camel_husk.hurt": "Viarblud-zdychlak paranieny",
	"subtitles.entity.camel_husk.saddle": "Viarblud-zdychlak asiadłany",
	"subtitles.entity.camel_husk.sit": "Viarblud-zdychlak siadaje",
	"subtitles.entity.camel_husk.stand": "Viarblud-zdychlak ustaje",
	...
	"subtitles.entity.copper_golem.death": "Miadziany holem hinie",
	"subtitles.entity.copper_golem.hurt": "Miadziany holem paškodžany",
	"subtitles.entity.copper_golem.item_drop": "Miadziany holem kładzie pradmiet",
	"subtitles.entity.copper_golem.item_no_drop": "Miadziany holem nie moža pakłasci pradmiet",
	"subtitles.entity.copper_golem.no_item_get": "Miadziany holem biare pradmiet",
	"subtitles.entity.copper_golem.no_item_no_get": "Miadziany holem nie moža ŭziać pradmiet",
	"subtitles.entity.copper_golem.spawn": "Miadziany holem zjaŭlajecca",
	"subtitles.entity.copper_golem.spin": "Miadziany holem krucić hałavoju",
	"subtitles.entity.copper_golem_become_statue": "Miadziany holem skamianieŭ",
	"subtitles.entity.copper_golem_oxidized.death": "Miadziany holem hinie",
	"subtitles.entity.copper_golem_oxidized.hurt": "Miadziany holem paškodžany",
	"subtitles.entity.copper_golem_oxidized.spin": "Miadziany holem krucić hałavoju",
	"subtitles.entity.copper_golem_weathered.death": "Miadziany holem hinie",
	"subtitles.entity.copper_golem_weathered.hurt": "Miadziany holem paškodžany",
	"subtitles.entity.copper_golem_weathered.spin": "Miadziany holem krucić hałavoju",
	...
	"subtitles.entity.generic.wind_burst": "Zarad vietru vybuchaje",
	...
	"subtitles.entity.ghastling.ambient": "Ghasciania varkoča",
	"subtitles.entity.ghastling.death": "Ghasciania hinie",
	"subtitles.entity.ghastling.hurt": "Ghasciania paraniena",
	"subtitles.entity.ghastling.spawn": "Ghasciania zjaŭlajecca",
	...
	"subtitles.entity.happy_ghast.ambient": "Ščaslivy ghast ciŭkaje",
	"subtitles.entity.happy_ghast.death": "Ščaslivy ghast hinie",
	"subtitles.entity.happy_ghast.equip": "Vupraž apranuta",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Ščaslivy ghast hatovy",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Ščaslivy ghast spyniajecca",
	"subtitles.entity.happy_ghast.hurt": "Ščaslivy ghast paranieny",
	"subtitles.entity.happy_ghast.unequip": "Vupraž zniata",
	...
	"subtitles.entity.horse.ambient": "Koń irže",
	"subtitles.entity.horse.angry": "Koń ravie",
	...
	"subtitles.entity.nautilus.ambient": "Naŭtyłus kłacaje",
	"subtitles.entity.nautilus.ambient_land": "Naŭtyłus kłacaje",
	"subtitles.entity.nautilus.dash": "Naŭtyłus bje strumieniem",
	"subtitles.entity.nautilus.dash_land": "Naŭtyłus bje strumieniem",
	"subtitles.entity.nautilus.dash_ready": "Naŭtyłus pieravodzić duch",
	"subtitles.entity.nautilus.dash_ready_land": "Naŭtyłus pieravodzić duch",
	"subtitles.entity.nautilus.death": "Naŭtyłus hinie",
	"subtitles.entity.nautilus.death_land": "Naŭtyłus hinie",
	"subtitles.entity.nautilus.eat": "Naŭtyłus jesć",
	"subtitles.entity.nautilus.hurt": "Naŭtyłus paranieny",
	"subtitles.entity.nautilus.hurt_land": "Naŭtyłus paranieny",
	"subtitles.entity.nautilus.swim": "Naŭtyłus płyvie",
	...
	"subtitles.entity.parched.ambient": "Suchlak brazhoča kasciami",
	"subtitles.entity.parched.death": "Suchlak hinie",
	"subtitles.entity.parched.hurt": "Suchlak paranieny",
	...
	"subtitles.entity.parrot.imitate.camel_husk": "Papuhaj pierajmaje viarbluda-zdychlaka",
	...
	"subtitles.entity.parrot.imitate.parched": "Papuhaj pierajmaje suchlaka",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Papuhaj pierajmaje kania-miarcviaka",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Papuhaj pierajmaje miarcviaka-naŭtyłusa",
	...
	"subtitles.entity.pig.eat": "Svinnia jesć",
	...
	"subtitles.entity.sulfur_cube.absorb": "Sierny kub poŭny",
	"subtitles.entity.sulfur_cube.bounce": "Sierny kub padskokvaje",
	"subtitles.entity.sulfur_cube.death": "Sierny kub hinie",
	"subtitles.entity.sulfur_cube.eject": "Błok vyniaty",
	"subtitles.entity.sulfur_cube.hit": "Sierny kub udaryli",
	"subtitles.entity.sulfur_cube.hurt": "Sierny kub paranieny",
	"subtitles.entity.sulfur_cube.push": "Sierny kub šturchnuli",
	"subtitles.entity.sulfur_cube.squish": "Sierny kub chlupaje",
	...
	"subtitles.entity.zombie_horse.angry": "Koń-miarcviak irže",
	"subtitles.entity.zombie_horse.death": "Koń-miarcviak hinie",
	"subtitles.entity.zombie_horse.eat": "Koń-miarcviak jesć",
	"subtitles.entity.zombie_horse.hurt": "Koń-miarcviak paranieny",
	"subtitles.entity.zombie_nautilus.ambient": "Naŭtyłus-miarcviak bulkoča",
	"subtitles.entity.zombie_nautilus.ambient_land": "Naŭtyłus-miarcviak bulkoča",
	"subtitles.entity.zombie_nautilus.dash": "Naŭtyłus-miarcviak bje strumieniem",
	"subtitles.entity.zombie_nautilus.dash_land": "Naŭtyłus-miarcviak bje strumieniem",
	"subtitles.entity.zombie_nautilus.dash_ready": "Naŭtyłus-miarcviak pieravodzić duch",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Naŭtyłus-miarcviak pieravodzić duch",
	"subtitles.entity.zombie_nautilus.death": "Naŭtyłus-miarcviak hinie",
	"subtitles.entity.zombie_nautilus.death_land": "Naŭtyłus-miarcviak hinie",
	"subtitles.entity.zombie_nautilus.eat": "Naŭtyłus-miarcviak jesć",
	"subtitles.entity.zombie_nautilus.hurt": "Naŭtyłus-miarcviak paranieny",
	"subtitles.entity.zombie_nautilus.hurt_land": "Naŭtyłus-miarcviak paranieny",
	"subtitles.entity.zombie_nautilus.swim": "Naŭtyłus-miarcviak płyvie",
	...
	"subtitles.item.armor.equip_copper": "Miadzianaja brania brazhoča",
	...
	"subtitles.item.armor.equip_nautilus": "Naŭtyłusava brania apranuta",
	...
	"subtitles.item.armor.unequip_nautilus": "Naŭtyłusava brania zniata",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Sierny kub spajmany",
	...
	"subtitles.item.golden_dandelion.unuse": "Załaty dźmuchaviec adnaŭlaje praces starennia",
	"subtitles.item.golden_dandelion.use": "Załaty dźmuchaviec spyniaje praces starennia",
	"subtitles.item.hoe.till": "Matyka are",
	"subtitles.item.honey_bottle.drink": "Hłytannie",
	"subtitles.item.honeycomb.wax_on": "Vaskavannie",
	"subtitles.item.horse_armor.unequip": "Konskaja brania spadaje",
	"subtitles.item.ink_sac.use": "Pyrski čarniła",
	"subtitles.item.lead.break": "Pavadok irviecca",
	"subtitles.item.lead.tied": "Pavadok zaviazany",
	"subtitles.item.lead.untied": "Pavadok razviazany",
	"subtitles.item.llama_carpet.unequip": "Dyvan spadaje",
	...
	"subtitles.item.nautilus_saddle_equip": "Siadło ekipiravana",
	"subtitles.item.nautilus_saddle_underwater_equip": "Siadło ekipiravana",
	"subtitles.item.nether_wart.plant": "Netherskaja narasć pasadžana",
	"subtitles.item.ominous_bottle.dispose": "Plaška razbivajecca",
	"subtitles.item.saddle.unequip": "Siadło spadaje",
	"subtitles.item.shears.shear": "Pstryk nažnic",
	"subtitles.item.shears.snip": "Razrez nažnicami",
	"subtitles.item.shield.block": "Udar pa ščycie",
	"subtitles.item.shovel.flatten": "Kapannie rydloŭkaj",
	"subtitles.item.spear.attack": "Dzida kole",
	"subtitles.item.spear.hit": "Dzida łučyć",
	"subtitles.item.spear.lunge": "Ryvok z dzidaj",
	"subtitles.item.spear.use": "Dzida nastaŭlena",
	"subtitles.item.spear_wood.attack": "Dzida kole",
	"subtitles.item.spear_wood.hit": "Dzida bje",
	"subtitles.item.spear_wood.use": "Ataka dzidaj",
	...
	"subtitles.item.underwater_saddle.equip": "Siadło ekipiravana",
	...
	"subtitles.weather.end_flash": "Zarnica Enda hrymić",
	...
	"telemetry.event.graphics_capabilities.description": "Heta padzieja paviedamlaje pra mahčymasci hrafičnaj pryłady, jakaja vykarystoŭvajecca dla hulni.",
	"telemetry.event.graphics_capabilities.title": "Hrafičnyja mahčymasci",
	"telemetry.event.optional": "%s (nieabaviazkova)",
	"telemetry.event.optional.disabled": "%s (nieabaviazkova) — vyklučana",
	"telemetry.event.p2p_connection.description": "Heta padzieja dapamahaje nam zrazumieć nadziejnasć i pradukcyjnasć peer-to-peer-złučenniaŭ pamiž hulcami. Jana zapisvaje, ci było złučennie paspiachovym, typ vykarystanaha kandydata Interactive Connectivity Establishment (ICE, pratakoł, jaki my vykarystoŭvajem dla ŭstalavannia peer-to-peer-złučenniaŭ), a taksama kolki času spatrebiłasia dla ŭstalavannia złučennia.",
	"telemetry.event.p2p_connection.title": "Złučennie peer-to-peer",
	...
	"telemetry.property.backend_failure_message.title": "Pamyłka stvarennia hrafičnaha bekendu: padrabiaznasci",
	"telemetry.property.backend_failure_missing_capabilities.title": "Pamyłka stvarennia hrafičnaha bekendu: adsutnyja mahčymasci",
	"telemetry.property.backend_failure_reason.title": "Pamyłka stvarennia hrafičnaha bekendu: pryčyna",
	"telemetry.property.backend_name.title": "Nazva hrafičnaha bekendu",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "Etap zboju",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Čas ustalavannia złučennia Interactive Connectivity Establishment (ICE; u milisiekundach)",
	"telemetry.property.p2p_connection_ice_path.title": "Šlach Interactive Connectivity Establishment (ICE)",
	"telemetry.property.p2p_connection_local_candidate_type.title": "Typ łakalnaha kandydata",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Typ addalenaha kandydata",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Čas ustalavannia sihnalnaha złučennia (u milisiekundach)",
	"telemetry.property.p2p_connection_successful.title": "Złučennie paspiachova",
	"telemetry.property.p2p_connection_total_time_ms.title": "Ahulny čas ustalavannia złučennia (u milisiekundach)",
	...
	"test.error.block_property_mismatch": "Čakałasia, što ŭłascivasć %s budzie %s, atrymana %s",
	"test.error.block_property_missing": "Ułascivasć błoka adsutničaje; čakałasia, što ŭłascivasć %s budzie %s",
	"test.error.entity_property": "Isnasć %s pravaliła test: %s",
	"test.error.entity_property_details": "Isnasć %s pravaliła test: %s, čakałasia: %s, atrymana: %s",
	"test.error.expected_block": "Čakaŭsia błok %s, atrymana: %s",
	"test.error.expected_block_present": "Čakałasia, što błok %s budzie prysutnym",
	...
	"test.error.expected_entity_data": "Čakałasia, što danyja isnasci buduć %s, atrymana %s",
	...
	"test.error.expected_entity_not_touching": "Nie čakałasia sutykniennie %s z punktam %s, %s, %s (adnosna: %s, %s, %s)",
	"test.error.expected_entity_touching": "Čakałasia sutykniennie %s z punktam %s, %s, %s (adnosna: %s, %s, %s)",
	...
	"test.error.not_a_block_item": "Dadzieny błok nie zjaŭlajecca błokam pradmietam",
	"test.error.position": "%s u %s, %s, %s (adnosna: %s, %s, %s) na takcie %s",
	"test.error.sequence.condition_already_triggered": "Umova ŭžo była vykanana ŭ takcie %s",
	...
	"test.error.sequence.minimum_tick": "Paspiachova zavieršana pierad čakanym taktam: čakałasia %s",
	...
	"test.error.too_many_entities": "Čakałasia tolki adna isnasć %s kala %s, %s, %s, ale znojdziena %s",
	...
	"test.error.value_not_in_between": "Čakałasia, što %s budzie pamiž %s i %s: było %s",
	...
	"test_block.mode_info.accept": "Režym «Pospiech» — pryniać pospiech (častki) testa",
	...
	"test_instance.type.function": "Test na asnovie funkcyj",
	"test_instance_block.entities": "Isnasci:",
	"test_instance_block.error.no_test": "Niemahčyma vykanać testavy asobnik na %s, %s, %s, bo test nie vyznačany",
	"test_instance_block.error.no_test_structure": "Niemahčyma vykanać testavy asobnik na %s, %s, %s, bo niama testavaj struktury",
	"test_instance_block.error.unable_to_save": "Niemahčyma zachavać šabłon testavaj struktury dla testavaha asobnika na %s, %s, %s",
	...
	"title.multiplayer.online": "Sumiesnaja hulnia (anłajn)",
	...
	"upgradeWorld.aborted.message": "Heta moža zdarycca, kali padčas abnaŭlennia inšaja prahrama atrymała dostup da svietu.\nMoža dapamahčy pierazapusk kampjutara i paŭtornaja sproba. Kali prablema nie zniknie, kali łaska, paviedamicie pra pamyłku.",
	"upgradeWorld.aborted.reportBug": "Paviedamić ab prablemie",
	"upgradeWorld.aborted.title": "Nie ŭdałosia abnavić sviet",
	"upgradeWorld.canceled.message": "Sviet zastaniecca takim, jakim byŭ raniej.",
	"upgradeWorld.canceled.title": "Abnaŭlennie svietu skasavana",
	"upgradeWorld.done": "Abnaŭlennie svietu zavieršana",
	"upgradeWorld.failed_cleanup.message": "Sviet byŭ paspiachova abnoŭleny da biahučaj viersii i ciapier dastupny ŭ spisie svietaŭ.\nPraz niekatoryja prablemy pry ačyščenni zastarełych danych nazva papki svietu była zmieniena na %s.",
	"upgradeWorld.failed_cleanup.title": "Sviet byŭ paspiachova abnoŭleny",
	"upgradeWorld.info.converted": "Abnoŭlena: %s",
	"upgradeWorld.info.file_fix_stage": "Etap: %s/%s",
	"upgradeWorld.info.scanning": "Analiz fajłaŭ…",
	"upgradeWorld.info.total": "Usiaho: %s",
	"upgradeWorld.joinNow": "Ci chočacie vy dałučycca da svietu?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Pieramiaščennie fajłaŭ",
	"upgradeWorld.progress.type.legacy_structures": "Abnaŭlennie starych struktur",
	"upgradeWorld.progress.type.region": "Abnaŭlennie rehijonaŭ",
	"upgradeWorld.symlink.message": "Abrany sviet zmiaščaje simvalnyja spasyłki.\nNieabchodnyja dla abnaŭlennia svietu da biahučaj viersii dziejanni nie padtrymlivajuć vykarystannia simvaličnych spasyłak. Kab abnavić sviet, hetyja spasyłki musiać pierš być razviazany.",
	"upgradeWorld.symlink.title": "Niemahčyma abnavić sviet",
	"upgradeWorld.title": "Abnaŭlennie fajłaŭ svietu",
}
