// Code generated by tools/gen_lang.go from 26.1/uk_ua.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advMode.notAllowed": "Необхідно бути оператором у режимі творчости",
	"advMode.notEnabled": "Командні блоки не ввімкнені",
	"advMode.notEnabled.spawner": "Блоки-породжувачі не ввімкнені",
	"advMode.previousOutput": "Попередній вивід",
	"advMode.setCommand": "Задати консольну команду для блока",
	"advMode.setCommand.disabled": "Команду встановлено: %s, але командні блоки досі вимкнені",
	...
	"advancements.adventure.overoverkill.description": "Завдайте 50 сердець шкоди одним ударом булавою",
	...
	"advancements.adventure.sniper_duel.description": "Убийте скелета на відстані не менш як 50 метрів",
	"advancements.adventure.sniper_duel.title": "Снайперська дуель",
	"advancements.adventure.spear_many_mobs.description": "Ударте п’ятьох мобів однією атакою списа",
	"advancements.adventure.spear_many_mobs.title": "Моб’ячий шашлик",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Розмістіть блок висушеного ґаста у воду",
	...
	"advancements.husbandry.uh_oh.description": "Дайте сіркокубу поглинути блок динаміту",
	"advancements.husbandry.uh_oh.title": "Йой",
	...
	"advancements.story.smelt_iron.description": "Витопіть залізний злиток",
	...
	"argument.double.big": "Число з рухомою комою подвійної точности повинне бути не більшим ніж %s; знайдено %s",
	"argument.double.low": "Число з рухомою комою подвійної точности повинне бути не меншим ніж %s; знайдено %s",
	...
	"argument.float.big": "Число з рухомою комою повинне бути не більшим ніж %s; знайдено %s",
	"argument.float.low": "Число з рухомою комою повинне бути не меншим ніж %s; знайдено %s",
	...
	"argument.integer.big": "Ціле число повинне бути не більшим ніж %s; знайдено %s",
	"argument.integer.low": "Ціле число повинне бути не меншим ніж %s; знайдено %s",
	...
	"argument.long.big": "Довге ціле число повинне бути не більшим ніж %s; знайдено %s",
	"argument.long.low": "Довге ціле число повинне бути не меншим ніж %s; знайдено %s",
	...
	"argument.range.ints": "Дозволені тільки цілі числа, але не десяткові дроби",
	...
	"argument.resource_or_id.no_such_element": "Не можна знайти елемент «%s» у реєстрі «%s»",
	...
	"argument.scoreHolder.empty": "Жодних відповідних утримувачів рахунків не вдалося знайти",
	...
	"argument.time.tick_count_too_low": "Кількість тактів має бути не меншою ніж %s; знайдено %s",
	"argument.uuid.invalid": "Недійсний UUID",
	"argument.waypoint.invalid": "Вибрана сутність не є маршрутною точкою",
	...
	"arguments.nbtpath.nothing_found": "Не знайдено жодних елементів, що збігаються з %s",
	...
	"attribute.name.air_drag_modifier": "опору повітря",
	...
	"attribute.name.below_name_distance": "відстані видимости рахунку",
	...
	"attribute.name.bounciness": "пружности",
	...
	"attribute.name.friction_modifier": "тертя",
	...
	"attribute.name.nameplate_distance": "відстані видимости імені",
	...
	"attribute.name.tempt_range": "дальности спокуси мобів",
	"attribute.name.water_movement_efficiency": "ефективности руху у воді",
	"attribute.name.waypoint_receive_range": "дальности приймання маршрутної точки",
	"attribute.name.waypoint_transmit_range": "дальности передавання маршрутної точки",
	...
	"biome.minecraft.sulfur_caves": "Сірчані печери",
	...
	"block.minecraft.acacia_shelf": "Акацієва полиця",
	...
	"block.minecraft.bamboo_shelf": "Бамбукова полиця",
	...
	"block.minecraft.blast_furnace": "Домна",
	...
	"block.minecraft.cave_vines_plant": "Стебло печерних ліз",
	...
	"block.minecraft.cherry_shelf": "Вишнева полиця",
	...
	"block.minecraft.chiseled_cinnabar": "Різьблений кіновар",
	...
	"block.minecraft.chiseled_sulfur": "Різьблена сірка",
	...
	"block.minecraft.cinnabar": "Кіновар",
	"block.minecraft.cinnabar_brick_slab": "Плита з кіноварної цегли",
	"block.minecraft.cinnabar_brick_stairs": "Сходи з кіноварної цегли",
	"block.minecraft.cinnabar_brick_wall": "Стіна з кіноварної цегли",
	"block.minecraft.cinnabar_bricks": "Кіноварна цегла",
	"block.minecraft.cinnabar_slab": "Кіноварна плита",
	"block.minecraft.cinnabar_stairs": "Кіноварні сходи",
	"block.minecraft.cinnabar_wall": "Кіноварна стіна",
	...
	"block.minecraft.copper_chain": "Мідний ланцюг",
	"block.minecraft.copper_chest": "Мідна скриня",
	...
	"block.minecraft.copper_lantern": "Мідний ліхтар",
	"block.minecraft.copper_ore": "Мідна руда",
	"block.minecraft.copper_torch": "Мідний смолоскип",
	"block.minecraft.copper_trapdoor": "Мідний люк",
	"block.minecraft.copper_wall_torch": "Мідний настінний смолоскип",
	...
	"block.minecraft.crimson_shelf": "Багряна полиця",
	...
	"block.minecraft.dark_oak_shelf": "Темно-дубова полиця",
	...
	"block.minecraft.exposed_copper_bars": "Наражені мідні ґрати",
	"block.minecraft.exposed_copper_bulb": "Наражена мідна жарівка",
	"block.minecraft.exposed_copper_chain": "Наражений мідний ланцюг",
	"block.minecraft.exposed_copper_chest": "Наражена мідна скриня",
	"block.minecraft.exposed_copper_door": "Наражені мідні двері",
	"block.minecraft.exposed_copper_golem_statue": "Наражена статуя мідного ґолема",
	"block.minecraft.exposed_copper_grate": "Наражена мідна решітка",
	"block.minecraft.exposed_copper_lantern": "Наражений мідний ліхтар",
	...
	"block.minecraft.exposed_lightning_rod": "Наражений блискавковідвід",
	...
	"block.minecraft.hanging_roots": "Висяче коріння",
	...
	"block.minecraft.iron_chain": "Залізний ланцюг",
	...
	"block.minecraft.jungle_shelf": "Тропічна полиця",
	...
	"block.minecraft.mangrove_shelf": "Мангрова полиця",
	...
	"block.minecraft.oxidized_copper_bars": "Окиснені мідні ґрати",
	"block.minecraft.oxidized_copper_bulb": "Окиснена мідна жарівка",
	"block.minecraft.oxidized_copper_chain": "Окиснений мідний ланцюг",
	"block.minecraft.oxidized_copper_chest": "Окиснена мідна скриня",
	"block.minecraft.oxidized_copper_door": "Окиснені мідні двері",
	"block.minecraft.oxidized_copper_golem_statue": "Окиснена статуя мідного ґолема",
	"block.minecraft.oxidized_copper_grate": "Окиснена мідна решітка",
	"block.minecraft.oxidized_copper_lantern": "Окиснений мідний ліхтар",
	...
	"block.minecraft.oxidized_lightning_rod": "Окиснений блискавковідвід",
	"block.minecraft.packed_ice": "Твердий лід",
	...
	"block.minecraft.pale_oak_shelf": "Блідо-дубова полиця",
	...
	"block.minecraft.polished_cinnabar": "Полірований кіновар",
	"block.minecraft.polished_cinnabar_slab": "Плита з полірованого кіновару",
	"block.minecraft.polished_cinnabar_stairs": "Сходи з полірованого кіновару",
	"block.minecraft.polished_cinnabar_wall": "Стіна з полірованого кіновару",
	...
	"block.minecraft.polished_sulfur_slab": "Плита з полірованої сірки",
	"block.minecraft.polished_sulfur_stairs": "Сходи з полірованої сірки",
	"block.minecraft.polished_sulfur_wall": "Стіна з полірованої сірки",
	...
	"block.minecraft.potent_sulfur": "Активна сірка",
	...
	"block.minecraft.potted_golden_dandelion": "Золота кульбаба в горщику",
	...
	"block.minecraft.redstone_wall_torch": "Редстоуновий настінний смолоскип",
	...
	"block.minecraft.spawner": "Породжувач монстрів",
	"block.minecraft.spawner.desc1": "Взаємодія з яйцем виклику:",
	"block.minecraft.spawner.desc2": "Установлює тип моба",
	...
	"block.minecraft.sulfur_brick_slab": "Плита із сірчаної цегли",
	"block.minecraft.sulfur_brick_stairs": "Сходи із сірчаної цегли",
	"block.minecraft.sulfur_brick_wall": "Стіна із сірчаної цегли",
	"block.minecraft.sulfur_bricks": "Сірчана цегла",
	"block.minecraft.sulfur_slab": "Сірчана плита",
	"block.minecraft.sulfur_spike": "Сірчаний шип",
	"block.minecraft.sulfur_stairs": "Сірчані сходи",
	...
	"block.minecraft.trial_spawner": "Породжувач випробувань",
	...
	"block.minecraft.twisting_vines_plant": "Стебло кручених ліз",
	...
	"block.minecraft.warped_shelf": "Химерна полиця",
	...
	"block.minecraft.waxed_copper_bars": "Вощені мідні ґрати",
	"block.minecraft.waxed_copper_block": "Вощений блок міді",
	"block.minecraft.waxed_copper_bulb": "Вощена мідна жарівка",
	"block.minecraft.waxed_copper_chain": "Вощений мідний ланцюг",
	"block.minecraft.waxed_copper_chest": "Вощена мідна скриня",
	"block.minecraft.waxed_copper_door": "Вощені мідні двері",
	"block.minecraft.waxed_copper_golem_statue": "Вощена статуя мідного ґолема",
	"block.minecraft.waxed_copper_grate": "Вощена мідна решітка",
	"block.minecraft.waxed_copper_lantern": "Вощений мідний ліхтар",
	...
	"block.minecraft.waxed_exposed_copper_bars": "Вощені наражені мідні ґрати",
	"block.minecraft.waxed_exposed_copper_bulb": "Вощена наражена мідна жарівка",
	"block.minecraft.waxed_exposed_copper_chain": "Вощений наражений мідний ланцюг",
	"block.minecraft.waxed_exposed_copper_chest": "Вощена наражена мідна скриня",
	"block.minecraft.waxed_exposed_copper_door": "Вощені наражені мідні двері",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Вощена наражена статуя мідного ґолема",
	"block.minecraft.waxed_exposed_copper_grate": "Вощена наражена мідна решітка",
	"block.minecraft.waxed_exposed_copper_lantern": "Вощений наражений мідний ліхтар",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Вощений наражений блискавковідвід",
	"block.minecraft.waxed_lightning_rod": "Вощений блискавковідвід",
	...
	"block.minecraft.waxed_oxidized_copper_bars": "Вощені окиснені мідні ґрати",
	"block.minecraft.waxed_oxidized_copper_bulb": "Вощена окиснена мідна жарівка",
	"block.minecraft.waxed_oxidized_copper_chain": "Вощений окиснений мідний ланцюг",
	"block.minecraft.waxed_oxidized_copper_chest": "Вощена окиснена мідна скриня",
	"block.minecraft.waxed_oxidized_copper_door": "Вощені окиснені мідні двері",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Вощена окиснена статуя мідного ґолема",
	"block.minecraft.waxed_oxidized_copper_grate": "Вощена окиснена мідна решітка",
	"block.minecraft.waxed_oxidized_copper_lantern": "Вощений окиснений мідний ліхтар",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Вощений окиснений блискавковідвід",
	...
	"block.minecraft.waxed_weathered_copper_bars": "Вощені вивітрені мідні ґрати",
	"block.minecraft.waxed_weathered_copper_bulb": "Вощена вивітрена мідна жарівка",
	"block.minecraft.waxed_weathered_copper_chain": "Вощений вивітрений мідний ланцюг",
	"block.minecraft.waxed_weathered_copper_chest": "Вощена вивітрена мідна скриня",
	"block.minecraft.waxed_weathered_copper_door": "Вощені вивітрені мідні двері",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Вощена вивітрена статуя мідного ґолема",
	"block.minecraft.waxed_weathered_copper_grate": "Вощена вивітрена мідна решітка",
	"block.minecraft.waxed_weathered_copper_lantern": "Вощений вивітрений мідний ліхтар",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Вощений вивітрений блискавковідвід",
	"block.minecraft.weathered_chiseled_copper": "Вивітрена різьблена мідь",
	"block.minecraft.weathered_copper": "Вивітрена мідь",
	"block.minecraft.weathered_copper_bars": "Вивітрені мідні ґрати",
	"block.minecraft.weathered_copper_bulb": "Вивітрена мідна жарівка",
	"block.minecraft.weathered_copper_chain": "Вивітрений мідний ланцюг",
	"block.minecraft.weathered_copper_chest": "Вивітрена мідна скриня",
	"block.minecraft.weathered_copper_door": "Вивітрені мідні двері",
	"block.minecraft.weathered_copper_golem_statue": "Вивітрена статуя мідного ґолема",
	"block.minecraft.weathered_copper_grate": "Вивітрена мідна решітка",
	"block.minecraft.weathered_copper_lantern": "Вивітрений мідний ліхтар",
	...
	"block.minecraft.weathered_lightning_rod": "Вивітрений блискавковідвід",
	"block.minecraft.weeping_vines": "Плакучі лози",
	"block.minecraft.weeping_vines_plant": "Стебло плакучих ліз",
	...
	"book.edit.title": "Екран редагування книги",
	...
	"book.page_button.previous": "Попередня сторінка",
	"book.sign.title": "Екран підписування книги",
	"book.sign.titlebox": "Назва",
	"book.signButton": "Підписати",
	"book.view.title": "Екран перегляду книги",
	"build.spawn_protection": "%s перебуває під захистом точки відродження",
	"build.tooHigh": "Максимальна висота для будівництва — %s",
	"build.tooLow": "Мінімальна висота будування — %s",
	...
	"chat.copy.click": "Натисніть, щоб скопіювати в буфер обміну",
	...
	"chat.disabled.invalid_command_signature": "Команда мала неочікувані або відсутні підписи аргументів команди.",
	...
	"chat.link.confirm": "Ви впевнені, що хочете відкрити цей вебсайт?",
	...
	"chat.queue.tooltip": "Натисніть, щоб показати наступне повідомлення",
	...
	"chat_restriction.chat_and_commands_disabled_by_options": "Чат обмежений у налаштуваннях клієнта.",
	"chat_restriction.chat_disabled_by_options": "Чат гравців обмежений у налаштуваннях клієнта.",
	"chat_restriction.chat_disabled_by_options.action": "Перейти на екран «Налаштування чату»",
	"chat_restriction.disabled_by_launcher": "Чат обмежений запускачем",
	"chat_restriction.disabled_by_profile": "Чат обмежений налаштуваннями профілю.",
	"chat_restriction.disabled_by_profile.action": "Перейти до налаштувань профілю",
	"chat_screen.commands_not_allowed": "Надсилання команд не дозволене",
	"chat_screen.message": "Повідомлення для надсилання: %s",
	"chat_screen.messages_not_allowed": "Надсилання повідомлень у чат не дозволене",
	"chat_screen.restricted": "Чат обмежений. Натисніть це повідомлення, щоб дізнатися більше.",
	"chat_screen.restricted.narration": "Чат обмежений. Перейдіть на екран «Обмеження» в налаштуваннях світу.",
	"chat_screen.title": "Екран чату",
	"chat_screen.usage": "Уведіть повідомлення і натисніть Enter, щоб надіслати",
	"chunk.toast.checkLog": "Перегляньте журнал, щоб дізнатися більше",
	...
	"clear.failed.multiple": "Жодних предметів не знайдено в %s гравців",
	"clear.failed.single": "Жодних предметів не знайдено в гравця %s",
	...
	"command.trailing_data": "Кінцеві дані знайдено: %s",
	"command.unknown.argument": "Неприпустимий аргумент для команди",
	"command.unknown.command": "Невідома або неповна команда. Дивіться помилку нижче",
	"commands.advancement.criterionNotFound": "Досягнення «%[1]s» не містить критерій «%[2]s»",
	...
	"commands.attribute.value.get.success": "Значення атрибута %s для сутности %s становить %s",
	...
	"commands.clone.toobig": "Забагато блоків у зазначеній області (щонайбільше %s, але зазначено %s)",
	...
	"commands.datapack.create.invalid_full_name": "Недійсна нова назва пакета «%s»",
	"commands.datapack.create.invalid_name": "Недійсні символи в новій назві пакета «%s»",
	"commands.datapack.create.io_failure": "Не можна створити пакет із назвою «%s». Перевірте журнали",
	...
	"commands.dialog.clear.multiple": "Очищено діалог %s гравцям",
	"commands.dialog.clear.single": "Очищено діалог для %s",
	"commands.dialog.show.multiple": "Показано діалог %s гравцям",
	"commands.dialog.show.single": "Показано діалог у %s",
	"commands.difficulty.failure": "Складність не змінилась. Вона вже встановлена на: %s",
	"commands.difficulty.query": "Складність: %s",
	...
	"commands.enchant.failed.itemless": "%s не тримає предмет",
	...
	"commands.execute.blocks.toobig": "Забагато блоків у зазначеній області (щонайбільше %s, але зазначено %s)",
	"commands.execute.conditional.fail": "Тест провалений",
	"commands.execute.conditional.fail_count": "Тест провалено. Кількість: %s",
	"commands.execute.conditional.pass": "Тест пройдений",
	"commands.execute.conditional.pass_count": "Тест пройдено. Кількість: %s",
	...
	"commands.fetchprofile.copy_component": "Копіювати компонент",
	"commands.fetchprofile.copy_text": "Копіювати %s",
	"commands.fetchprofile.entity.success": "Вирішено профіль для сутности %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Не вдалося серіалізувати профіль: %s",
	"commands.fetchprofile.give_item": "Дати предмет",
	"commands.fetchprofile.id.failure": "Не вдалося вирішити профіль для ID %s",
	"commands.fetchprofile.id.success": "Вирішено профіль для ID %s: %s",
	"commands.fetchprofile.name.failure": "Не вдалося вирішити профіль для назви %s",
	"commands.fetchprofile.name.success": "Вирішено профіль для назви %s: %s",
	"commands.fetchprofile.no_profile": "Сутність %s не має профілю",
	"commands.fetchprofile.summon_mannequin": "Викликати манекен",
	"commands.fill.failed": "Не вдалося здійснити заповнення блоками",
	"commands.fill.success": "Успішно заповнено %s блоків",
	"commands.fill.toobig": "Забагато блоків у зазначеній області (щонайбільше %s, але зазначено %s)",
	...
	"commands.fillbiome.toobig": "Забагато блоків у зазначеному обсязі (щонайбільше %s, але зазначено %s)",
	"commands.forceload.added.failure": "Не вдалося відмітити чанки примусово завантажуваними",
	"commands.forceload.added.multiple": "Відмічено %s чанків у %s з %s по %s як примусово завантажувані",
	"commands.forceload.added.none": "Жодних примусово завантажуваних чанків не знайдено в %s",
	"commands.forceload.added.single": "Відмічено чанк %s у %s як примусово завантажуваний",
	"commands.forceload.list.multiple": "%s примусово завантажуваних чанків знайдено в %s на: %s",
	"commands.forceload.list.single": "Примусово завантажуваний чанк знайдено в %s на: %s",
	"commands.forceload.query.failure": "Чанк на %s у %s не відмічено для примусового завантаження",
	"commands.forceload.query.success": "Чанк на %s у %s відмічено для примусового завантаження",
	"commands.forceload.removed.all": "Відмічено всі чанки вивантажуваними в %s",
	"commands.forceload.removed.failure": "Жоден чанк не усунуто з примусового завантаження",
	"commands.forceload.removed.multiple": "Відмічено %s чанків у %s з %s по %s як вивантажувані",
	"commands.forceload.removed.single": "Відмічено чанк %s у %s як вивантажуваний",
	"commands.forceload.toobig": "Забагато чанків у зазначеній області (щонайбільше %s, але зазначено %s)",
	"commands.function.error.argument_not_compound": "Неприпустимий тип аргументу: %s, очікувався Compound",
	...
	"commands.jfr.dump.failed": "Не вдалося зберегти запис JFR: %s",
	"commands.jfr.start.failed": "Не вдалося запустити профілювання JFR",
	"commands.jfr.started": "Профілювання JFR запущено",
	"commands.jfr.stopped": "Профілювання JFR зупинено та збережено в %s",
	...
	"commands.locate.biome.not_found": "Не вдалося знайти біом типу «%s» поблизу",
	"commands.locate.biome.success": "Найближчий біом: %s розташований на координатах %s (на відстані %s блоків)",
	"commands.locate.poi.not_found": "Не вдалося знайти жодної точки інтересу типу «%s» на припустимій відстані",
	...
	"commands.profile_fetch.copy_component": "Копіювати компонент",
	"commands.profile_fetch.failed_to_serialize": "Не вдалося серіалізувати профіль: %s",
	"commands.profile_fetch.give_item": "Дати предмет",
	"commands.profile_fetch.id.failure": "Не вдалося вирішити профіль для ID %s",
	"commands.profile_fetch.id.success": "Вирішено профіль для ID %s: %s",
	"commands.profile_fetch.name.failure": "Не вдалося вирішити профіль для імені %s",
	"commands.profile_fetch.name.success": "Вирішено профіль для імені %s: %s",
	...
	"commands.random.error.range_too_small": "Діапазон випадкового значення повинен становити принаймні 2",
	...
	"commands.schedule.cleared.failure": "Процеси з id %s відсутні",
	"commands.schedule.cleared.success": "Скасовано %s запланованих задач з ідентифікатором %s",
	...
	"commands.scoreboard.objectives.display.set": "Установлено слот показу %s для показування задачі %s",
	...
	"commands.setworldspawn.success": "Установлено точку відродження у світі на %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Установлено точку відродження у світі на %s, %s, %s [%s, %s] у %s",
	"commands.spawnpoint.success.multiple": "Установлено точку відродження на %s, %s, %s [%s] у %s для %s гравців",
	"commands.spawnpoint.success.multiple.new": "Установлено точку відродження на %s, %s, %s [%s, %s] у %s для %s гравців",
	"commands.spawnpoint.success.single": "Установлено точку відродження на %s, %s, %s [%s] у %s для %s",
	"commands.spawnpoint.success.single.new": "Установлено точку відродження на %s, %s, %s [%s, %s] у %s для %s",
	"commands.spectate.cannot_spectate": "За %s не можна спостерігати",
	"commands.spectate.not_spectator": "%s не в режимі спостерігача",
	"commands.spectate.self": "Не можна спостерігати за собою",
	"commands.spectate.success.started": "Зараз спостереження за %s",
	...
	"commands.stopwatch.already_exists": "Секундомір «%s» уже існує",
	"commands.stopwatch.create.success": "Створено секундомір «%s»",
	"commands.stopwatch.does_not_exist": "Секундомір «%s» не існує",
	"commands.stopwatch.query": "Секундомір «%s» працював протягом %sс",
	"commands.stopwatch.remove.success": "Видалено секундомір «%s»",
	"commands.stopwatch.restart.success": "Перезапущено секундомір «%s»",
	"commands.summon.failed": "Неможливо створити сутність",
	"commands.summon.failed.peaceful": "Монстрів не можна викликати в мирній складності",
	...
	"commands.swing.failed.notliving": "Жодних живих сутностей не знайдено, які розмахують руками",
	"commands.swing.success.multiple": "Змушено %s сутностей розмахувати руками",
	"commands.swing.success.single": "Змушено %s розмахувати рукою",
	...
	"commands.tag.list.multiple.empty": "Немає теґів у %s сутностей",
	...
	"commands.tag.remove.failed": "Ціль не має цього теґу",
	...
	"commands.team.option.color.clear.success": "Прибрано колір для команди %s",
	...
	"commands.test.error.test_instance_not_found": "Блок-сутність тестового примірника не вдалося знайти",
	"commands.test.error.test_instance_not_found.position": "Блок-сутність тестового примірника не вдалося знайти для тесту на %s, %s, %s",
	...
	"commands.test.run.no_tests": "Жодних тестів не знайдено",
	...
	"commands.time.no_default_clock": "У вимірі %s немає усталеного годинника",
	"commands.time.no_time_marker_found": "Позначка часу %s відсутня для годинника %s",
	"commands.time.pause": "Призупинено годинник %s",
	"commands.time.query": "Час: %s",
	"commands.time.query.absolute": "Годинник %s — на %s тактах",
	"commands.time.query.gametime": "Ігровий час — %s тактів",
	"commands.time.query.timeline": "Часова шкала %s — на %s тактах",
	"commands.time.query.timeline.repetitions": "Часова шкала %s пройшла %s повторень",
	"commands.time.rate": "Годинник %s тепер рухатиметься зі звичайною швидкістю %sx",
	"commands.time.resume": "Відновлено годинник %s",
	"commands.time.set": "Установлено час %s",
	"commands.time.set.absolute": "Установлено %s на %s такт(ів)",
	"commands.time.set.time_marker": "Установлено %s на позначку часу %s",
	"commands.time.wrong_timeline_for_clock": "Часова шкала %s недійсна для годинника %s",
	...
	"commands.title.show.subtitle.multiple": "Показ нового підзаголовка для %s гравців",
	"commands.title.show.subtitle.single": "Показ нового підзаголовка для %s",
	"commands.title.show.title.multiple": "Показ нового заголовка для %s гравців",
	"commands.title.show.title.single": "Показ нового заголовка для %s",
	...
	"commands.waypoint.list.empty": "Немає маршрутних точок у %s",
	"commands.waypoint.list.success": "%s маршрутних точок у %s: %s",
	"commands.waypoint.modify.color": "Колір маршрутної точки тепер %s",
	"commands.waypoint.modify.color.reset": "Скинуто колір маршрутної точки",
	"commands.waypoint.modify.style": "Стиль маршрутної точки змінено",
	...
	"commands.whitelist.none": "Немає гравців у білому списку",
	...
	"container.repair": "Полагодити і назвати",
	...
	"dataPack.locator_bar.name": "Панель локатора",
	...
	"death.attack.spear": "%[2]s проштрикнув %[1]s",
	"death.attack.spear.item": "%[2]s проштрикнув %[1]s за допомогою: %[3]s",
	...
	"debug.chunk_boundaries.on": "Межі чанків: показані",
	"debug.clear_chat.help": "F3 + D = Очистити чат",
	"debug.copy_location.help": "F3 + C = Скопіювати розташування як команду /tp; тримайте 10 секунд, щоб спричинити збій гри",
	"debug.copy_location.message": "Скопійовано розташування в буфер обміну",
	"debug.crash.message": "Натиснуто F3 + C. Це приведе до аварійного завершення гри, якщо не відпустите.",
	"debug.crash.message.rebindable": "Натиснуто %s + %s. Це призведе до аварійного завершення гри, якщо не відпустите.",
	"debug.crash.warning": "Збій через %s…",
	"debug.creative_spectator.error": "Неможливо перемкнути режим гри: немає прав",
	...
	"debug.entry.always": "Завжди",
	"debug.entry.currently.alwaysOn": "%s: Наразі завжди ввімкнуто",
	"debug.entry.currently.inF3": "%s: Наразі тільки в F3",
	"debug.entry.currently.inOverlay": "%s: Наразі лише в накладенні налагодження",
	"debug.entry.currently.never": "%s: Наразі вимкнуто",
	"debug.entry.f3": "У F3",
	"debug.entry.overlay": "У накладенні",
	"debug.gamemodes.error": "Неможливо відкрити перемикач режиму гри: немає прав",
	...
	"debug.options.category.renderer": "Рендерери налагодження",
	"debug.options.category.text": "Текст екрана налагодження",
	"debug.options.help": "F3 + F6 = Редагувати налаштування налагодження",
	"debug.options.notAllowed.tooltip": "Не видно, коли інформація налагодження скорочена",
	"debug.options.profile.default": "Усталений профіль",
	"debug.options.profile.performance": "Профіль продуктивности",
	"debug.options.search": "Пошук…",
	"debug.options.title": "Налаштування налагодження",
	"debug.options.warning": "Ці налаштування призначені тільки з метою тестування. Вони можуть уповільнити ваш комп’ютер, призвести до збою гри або з’їсти вашого камінчика-улюбленця.",
	...
	"debug.profiling.start.rebindable": "Профілювання розпочато на %s секунд. Використовуйте %s + %s, щоб закінчити раніше",
	...
	"debug.show_hitboxes.off": "Гітбокси: приховані",
	"debug.show_hitboxes.on": "Гітбокси: показані",
	"debug.version.header": "Інформація про версію клієнта:",
	"debug.version.help": "F3 + V = Інформація про версію клієнта",
	...
	"editGamerule.inGame.button": "Редагувати ігрові правила…",
	"editGamerule.inGame.disabled.tooltip": "Для оновлення ігрових правил потрібні права оператора.",
	"editGamerule.inGame.discardChanges.message": "Ви впевнені, що хочете відхилити свої незбережені зміни ігрових правил?",
	"editGamerule.inGame.discardChanges.title": "Ігрові правила було змінено",
	"editGamerule.inGame.downloadingGamerules": "Отримання ігрових правил…",
	...
	"effect.minecraft.breath_of_the_nautilus": "Дихання навтилуса",
	...
	"effect.minecraft.trial_omen": "Прикмета випробувань",
	...
	"entity.minecraft.camel_husk": "Верблюд-висушень",
	...
	"entity.minecraft.copper_golem": "Мідний ґолем",
	...
	"entity.minecraft.glow_squid": "Сяйний кальмар",
	...
	"entity.minecraft.nautilus": "Навтилус",
	...
	"entity.minecraft.ominous_item_spawner": "Зловісний породжувач предметів",
	...
	"entity.minecraft.parched": "Засушень",
	...
	"entity.minecraft.spawner_minecart": "Вагонетка з породжувачем монстрів",
	...
	"entity.minecraft.sulfur_cube": "Сіркокуб",
	"entity.minecraft.sulfur_cube.content": "Уміст: %s",
	"entity.minecraft.tadpole": "Пуголовок",
	"entity.minecraft.text_display": "Текстовий дисплей",
	"entity.minecraft.tnt": "Підпалений динаміт",
	...
	"entity.minecraft.zombie_nautilus": "Зомбонавтилус",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Дозволити Незер",
	"gamerule.allowEnteringNetherUsingPortals.description": "Керує тим, чи гравцям можна входити в Незер.",
	"gamerule.allowFireTicksAwayFromPlayer": "Оновлювати вогонь далеко від гравців",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Керує тим, чи мають вогонь і лава на відстані понад 8 чанків від будь-якого гравця оновлюватися.",
	...
	"gamerule.doInsomnia": "Породжувати фантомів",
	...
	"gamerule.doMobSpawning": "Породжувати мобів",
	"gamerule.doMobSpawning.description": "Деякі сутності можуть мати окремі правила.",
	"gamerule.doPatrolSpawning": "Породжувати патрулі розбійників",
	...
	"gamerule.doTraderSpawning": "Породжувати мандрівних крамарів",
	...
	"gamerule.doWardenSpawning": "Породжувати боронителів",
	"gamerule.doWeatherCycle": "Оновлювати погоду",
	"gamerule.drowningDamage": "Заподіювати шкоду від утоплення",
	"gamerule.enableCommandBlocks": "Увімкнути командні блоки",
	...
	"gamerule.globalSoundEvents.description": "Коли виникають певні ігрові події, як-от породження боса, звук чутно скрізь.",
	...
	"gamerule.locatorBar": "Увімкнути панель локатора гравців",
	"gamerule.locatorBar.description": "Якщо ввімкнено, на екрані показуватиметься панель, що показує напрямок гравців.",
	...
	"gamerule.minecraft.elytra_movement_check": "Здійснювати перевірку руху елітр",
	"gamerule.minecraft.fire_spread_radius_around_player": "Радіус поширення вогню",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Радіус у блоках навколо гравця, у якому вогонь може поширюватися",
	"gamerule.minecraft.player_movement_check": "Здійснювати перевірку руху гравців",
	"gamerule.minecraft.raids": "Здійснювати набіги",
	"gamerule.minecraft.universal_anger.description": "Розлючені нейтральні моби нападатимуть на будь-яких гравців поблизу, а не лише на гравця, який розлютив їх. Працює найкраще, якщо правило forgive_dead_players вимкнене.",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Затримка гравця в порталі Незеру в режимі творчости",
	"gamerule.playersNetherPortalCreativeDelay.description": "Час (у тактах), який гравець творчого режиму повинен простояти в порталі в Незер перед зміною виміру.",
	"gamerule.playersNetherPortalDefaultDelay": "Затримка гравця в порталі Незеру поза режимом творчости",
	"gamerule.playersNetherPortalDefaultDelay.description": "Час (у тактах), який гравець не творчого режиму повинен простояти в порталі у Незер перед зміною вимірів.",
	"gamerule.playersSleepingPercentage": "Відсоток сну",
	...
	"gamerule.pvp": "Увімкнути PvP",
	"gamerule.pvp.description": "Керує тим, чи можуть гравці завдавати шкоди іншим гравцям.",
	...
	"gamerule.spawnChunkRadius.description": "Кількість чанків, що залишаються завантаженими навколо точки відродження у Верхньому світі.",
	"gamerule.spawnMonsters": "Породжувати монстрів",
	"gamerule.spawnMonsters.description": "Керує тим, чи монстри природно породжуються.",
	...
	"gamerule.spawnerBlocksEnabled": "Увімкнути блоки-породжувачі",
	...
	"gui.abuseReport.error.title": "Виникла проблема з надсиланням вашої скарги",
	...
	"gui.abuseReport.reason.sexually_inappropriate.description": "Відверті скіни, які зображають статеві акти, статеві органи або сексуальне насилля.",
	...
	"gui.banned.title.temporary": "Обліковий запис тимчасово заблоковано\n",
	...
	"gui.chatReport.discard.title": "Відхилити скаргу та коментарі?",
	...
	"gui.chatReport.draft.title": "Редагувати чернетку скарги?",
	...
	"gui.friends.open": "Друзі",
	"gui.friends.open.narration": "Список друзів",
	"gui.friends.open.tooltip": "Друзі",
	...
	"gui.recipebook.previous_page": "Попередня сторінка",
	"gui.recipebook.search_hint": "Пошук…",
	"gui.recipebook.toggleRecipes.all": "Усі",
	"gui.recipebook.toggleRecipes.blastable": "Доступні для перетоплення",
	"gui.recipebook.toggleRecipes.craftable": "Доступні для майстрування",
	"gui.recipebook.toggleRecipes.smeltable": "Доступні для витоплення",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "На цього гравця не можна скаржитись, оскільки чат вимкнений або заблокований",
	...
	"gui.stats.none_found": "Жодної статистики не знайдено.",
	...
	"gui.waitingForResponse.title": "Очікування на сервер",
	"gui.yes": "Так",
	...
	"item.intangible": "Нематеріальний",
	...
	"item.minecraft.camel_husk_spawn_egg": "Яйце виклику верблюда-висушня",
	...
	"item.minecraft.copper_axe": "Мідна сокира",
	"item.minecraft.copper_boots": "Мідні чоботи",
	"item.minecraft.copper_chestplate": "Мідний нагрудник",
	"item.minecraft.copper_golem_spawn_egg": "Яйце виклику мідного ґолема",
	"item.minecraft.copper_helmet": "Мідний шолом",
	"item.minecraft.copper_hoe": "Мідна мотика",
	"item.minecraft.copper_horse_armor": "Мідні кінські обладунки",
	"item.minecraft.copper_ingot": "Мідний злиток",
	"item.minecraft.copper_leggings": "Мідні наголінники",
	"item.minecraft.copper_nautilus_armor": "Мідні обладунки навтилуса",
	"item.minecraft.copper_nugget": "Мідний самородок",
	"item.minecraft.copper_pickaxe": "Мідне кайло",
	"item.minecraft.copper_shovel": "Мідна лопата",
	"item.minecraft.copper_spear": "Мідний спис",
	...
	"item.minecraft.diamond_nautilus_armor": "Діамантові обладунки навтилуса",
	"item.minecraft.diamond_pickaxe": "Діамантове кайло",
	"item.minecraft.diamond_shovel": "Діамантова лопата",
	"item.minecraft.diamond_spear": "Діамантовий спис",
	...
	"item.minecraft.glow_squid_spawn_egg": "Яйце виклику сяйного кальмара",
	...
	"item.minecraft.golden_nautilus_armor": "Золоті обладунки навтилуса",
	"item.minecraft.golden_pickaxe": "Золоте кайло",
	"item.minecraft.golden_shovel": "Золота лопата",
	"item.minecraft.golden_spear": "Золотий спис",
	...
	"item.minecraft.iron_nautilus_armor": "Залізні обладунки навтилуса",
	...
	"item.minecraft.iron_spear": "Залізний спис",
	...
	"item.minecraft.music_disc_lava_chicken": "Платівка",
	...
	"item.minecraft.music_disc_tears": "Платівка",
	"item.minecraft.music_disc_tears.desc": "Еймос Родді — Tears",
	...
	"item.minecraft.nautilus_spawn_egg": "Яйце виклику навтилуса",
	...
	"item.minecraft.netherite_horse_armor": "Незеритові кінські обладунки",
	"item.minecraft.netherite_ingot": "Незеритовий злиток",
	"item.minecraft.netherite_leggings": "Незеритові наголінники",
	"item.minecraft.netherite_nautilus_armor": "Незеритові обладунки навтилуса",
	...
	"item.minecraft.netherite_spear": "Незеритовий спис",
	...
	"item.minecraft.parched_spawn_egg": "Яйце виклику засушня",
	...
	"item.minecraft.squid_spawn_egg": "Яйце виклику кальмара",
	...
	"item.minecraft.stone_spear": "Кам'яний спис",
	...
	"item.minecraft.sulfur_cube_bucket": "Відро із сіркокубом",
	"item.minecraft.sulfur_cube_spawn_egg": "Яйце виклику сіркокуба",
	...
	"item.minecraft.wooden_spear": "Дерев'яний спис",
	...
	"item.minecraft.zombie_nautilus_spawn_egg": "Яйце виклику зомбонавтилуса",
	...
	"item.spawn_egg.peaceful": "Вимкнене в мирній складності",
	...
	"jukebox_song.minecraft.tears": "Еймос Родді — Tears",
	...
	"key.back": "Іти назад",
	"key.categories.creative": "Режим творчости",
	...
	"key.categories.spectator": "Спостерігач",
	"key.categories.ui": "Ігровий інтерфейс",
	"key.category.minecraft.creative": "Режим творчости",
	"key.category.minecraft.debug": "Налагодження",
	"key.category.minecraft.gameplay": "Ігровий процес",
	"key.category.minecraft.inventory": "Інвентар",
	"key.category.minecraft.misc": "Різне",
	"key.category.minecraft.movement": "Рух",
	"key.category.minecraft.multiplayer": "Гра в мережі",
	"key.category.minecraft.spectator": "Спостерігач",
	"key.chat": "Відкрити чат",
	"key.command": "Відкрити команду",
	"key.debug.clearChat": "Очистити чат",
	"key.debug.copyLocation": "Копіювати розташування",
	"key.debug.copyRecreateCommand": "Копіювати дані",
	"key.debug.crash": "Збій для налагодження",
	"key.debug.debugOptions": "Налаштування налагодження",
	"key.debug.dumpDynamicTextures": "Зберегти динамічні текстури",
	"key.debug.dumpVersion": "Зберегти інформацію про версію",
	"key.debug.focusPause": "Перемикати призупинення при переході до іншого вікна",
	"key.debug.fpsCharts": "Діаграми FPS",
	"key.debug.lightmapTexture": "Текстура мапи освітлення",
	"key.debug.modifier": "Клавіша-модифікатор налагодження",
	"key.debug.networkCharts": "Діаграми мережі",
	"key.debug.overlay": "Перемкнути накладення",
	"key.debug.profiling": "Почати/зупинити профілювання",
	"key.debug.profilingChart": "Діаграма профілювання",
	"key.debug.reloadChunk": "Перезавантажити чанки",
	"key.debug.reloadResourcePacks": "Перезавантажити пакети ресурсів",
	"key.debug.showAdvancedTooltips": "Показати розширені підказки",
	"key.debug.showChunkBorders": "Показати межі чанків",
	"key.debug.showHitboxes": "Показати гітбокси",
	"key.debug.spectate": "Перемкнути режим глядача",
	"key.debug.switchGameMode": "Перемикач режиму гри",
	...
	"key.spectatorHotbar": "Вибрати на панелі швидкого доступу",
	"key.spectatorOutlines": "Підсвічувати гравців",
	"key.sprint": "Біг",
	"key.swapOffhand": "Поміняти місцями предмети в руках",
	"key.toggleGui": "Перемикати графічний інтерфейс",
	"key.togglePerspective": "Перемкнути перспективу",
	"key.toggleSpectatorShaderEffects": "Перемикати ефекти шейдерів глядача",
	...
	"manageServer.edit.title": "Редагувати інформацію сервера",
	"manageServer.enterIp": "Адреса сервера",
	"manageServer.enterName": "Назва сервера",
	"manageServer.resourcePack": "Пакети ресурсів сервера",
	"manageServer.resourcePack.disabled": "Вимкнено",
	"manageServer.resourcePack.enabled": "Увімкнено",
	"manageServer.resourcePack.prompt": "Запитувати",
	...
	"mco.backup.entry.worldType.adventureMap": "Мапа пригод",
	"mco.backup.entry.worldType.experience": "Досвід",
	"mco.backup.entry.worldType.inspiration": "Натхнення",
	"mco.backup.entry.worldType.minigame": "Мінігра",
	"mco.backup.entry.worldType.normal": "Звичайний",
	"mco.backup.entry.worldType.unknown": "Невідомий",
	...
	"mco.configure.world.buttons.close": "Тимчасово закрити Realm",
	...
	"mco.configure.world.buttons.newworld": "Новий світ",
	"mco.configure.world.buttons.open": "Відкрити Realm знову",
	"mco.configure.world.buttons.options": "Налаштування світу",
	"mco.configure.world.buttons.players": "Гравці",
	"mco.configure.world.buttons.region_preference": "Вибрати регіон…",
	"mco.configure.world.buttons.resetworld": "Скинути світ",
	"mco.configure.world.buttons.save": "Зберегти",
	...
	"mco.configure.world.close.question.line1": "Ви можете тимчасово закрити свій Realm, щоб ніхто не міг грати, поки ви вносите зміни. Коли будете готові — відкрийте його знову. \n\nЦе не скасовує вашу підписку Realms.",
	"mco.configure.world.close.question.line2": "Ви справді хочете продовжити?",
	"mco.configure.world.close.question.title": "Потрібно зробити зміни без перешкод?",
	"mco.configure.world.closing": "Тимчасове закриття Realm…",
	...
	"mco.configure.world.leave.question.line1": "Якщо ви покинете світ Realms, то не побачите його до повторного запрошення",
	"mco.configure.world.leave.question.line2": "Ви справді хочете продовжити?",
	"mco.configure.world.loading": "Завантаження Realm",
	"mco.configure.world.location": "Розташування",
	"mco.configure.world.minigame": "Поточна: %s",
	"mco.configure.world.name": "Назва Realm",
	"mco.configure.world.name.validation.whitespace": "Не повинно бути пробілу на початку або кінці. Його буде прибрано.",
	"mco.configure.world.opening": "Відкриття Realm…",
	"mco.configure.world.players.error": "Гравця з указаним іменем не існує",
	"mco.configure.world.players.invite.duplicate": "Гравець з указаним іменем уже запрошений до Realm",
	"mco.configure.world.players.inviting": "Запрошуємо гравця…",
	"mco.configure.world.players.title": "Гравці",
	"mco.configure.world.pvp": "PVP",
	"mco.configure.world.region_preference": "Бажаний регіон",
	"mco.configure.world.region_preference.title": "Вибір бажаного регіону",
	...
	"mco.configure.world.restore.download.question.line1": "Світ буде завантажено і додано до списку ваших світів.",
	...
	"mco.configure.world.settings.expired": "Ви не можете редагувати налаштування простроченого Realm",
	...
	"mco.configure.world.spawnNPCs": "Породжувати NPC",
	"mco.configure.world.spawnProtection": "Захист точки відродження",
	"mco.configure.world.spawn_toggle.message": "Вимкнення цього налаштування видалить усі наявні сутності цього типу",
	"mco.configure.world.spawn_toggle.message.npc": "Вимкнення цього налаштування видалить усі наявні сутності цього типу, як от, селян",
	...
	"mco.configure.world.subscription.tab": "Підписка",
	...
	"mco.configure.world.switch.slot.subtitle": "Цей світ порожній. Виберіть, як створити ваш світ",
	...
	"mco.connect.region": "Регіон сервера: %s",
	...
	"mco.errorMessage.connectionFailure": "Сталася помилка. Будь ласка, спробуйте ще раз пізніше.",
	...
	"mco.errorMessage.realmsService.configurationError": "Сталася неочікувана помилка під час редагування налаштувань світу",
	...
	"mco.invites.nopending": "Немає очікуваних запрошень!",
	...
	"mco.play.button.realm.closed": "Realm закритий",
	...
	"mco.selectServer.closed": "Дезактивований Realm",
	...
	"mco.selectServer.popup": "Realms є безпечним і простим шляхом, щоб насолоджуватись онлайн до 10 друзям водночас. Він підтримує завантаження мініігор та власних світів. Тільки власник Realms повинен платити.",
	...
	"mco.upload.select.world.none": "Жодних світів для гри наодинці не знайдено!",
	...
	"menu.custom_options": "Користувацькі налаштування…",
	"menu.custom_options.title": "Користувацькі налаштування",
	"menu.custom_options.tooltip": "Примітка: Користувацькі налаштування надаються сторонніми серверами або вмістом.\nДбайте про безпеку!",
	"menu.custom_screen_info.button_narration": "Це користувацький екран. Дізнайтеся більше.",
	"menu.custom_screen_info.contents": "Уміст цього екрана контролюється сторонніми серверами та мапами, якими не володіє, керує або які не модерує Mojang Studios або Microsoft.\n\nДбайте про безпеку! Завжди будьте обережними, переходячи за посиланнями, і ніколи не розголошуйте свою особисту інформацію, зокрема також дані для входу.\n\nЯкщо цей екран заважає вам грати, ви також можете від’єднатися від сервера, натиснувши кнопку нижче.",
	"menu.custom_screen_info.disconnect": "Користувацький екран відхилено",
	"menu.custom_screen_info.title": "Примітка про користувацькі екрани",
	"menu.custom_screen_info.tooltip": "Це користувацький екран. Натисніть тут, щоб дізнатися більше.",
	...
	"menu.quick_actions": "Швидкі дії…",
	"menu.quick_actions.title": "Швидкі дії",
	...
	"multiplayer.codeOfConduct.check": "Більше не повідомляти про цей Кодекс поведінки",
	"multiplayer.codeOfConduct.title": "Кодекс поведінки сервера",
	"multiplayer.confirm_command.parse_errors": "Ви намагаєтеся виконати нерозпізнану або недійсну команду.\nВи впевнені?\nКоманда: %s",
	"multiplayer.confirm_command.permissions_required": "Ви намагаєтеся виконати команду, що потребує підвищених дозволів.\nЦе може негативно вплинути на вашу гру.\nВи впевнені?\nКоманда: %s",
	"multiplayer.confirm_command.run_command": "Виконати команду",
	"multiplayer.confirm_command.signature_required": "Ви намагаєтеся виконати команду, яка надсилатиме повідомлення чату під вашим іменем.\nЇї можна запустити лише з екрана чату\nКоманда: %s",
	"multiplayer.confirm_command.suggest_command": "Копіювати до екрана чату",
	"multiplayer.confirm_command.title": "Підтвердити виконання команди",
	"multiplayer.disconnect.authservers_down": "Сервери автентифікації не працюють. Будь ласка, спробуйте ще раз пізніше. Вибачте!",
	...
	"multiplayer.disconnect.banned.reason.default": "Заблоковано оператором.",
	...
	"multiplayer.disconnect.code_of_conduct": "Сервер вимагає прийняття Кодексу поведінки",
	"multiplayer.disconnect.configuration_error": "Неочікувана помилка під час конфігурування",
	...
	"multiplayer.message_not_delivered": "Не можна доставити повідомлення чату. Перевірте журнали сервера: %s",
	...
	"multiplayer.requiredTexturePrompt.disconnect": "Сервер вимагає користувацький пакет ресурсів",
	"multiplayer.requiredTexturePrompt.line1": "Цей сервер вимагає використання власного пакета ресурсів.",
	"multiplayer.requiredTexturePrompt.line2": "Відмова від цього власного пакета ресурсів від’єднає вас від цього сервера.",
	...
	"multiplayer.status.anonymous_player": "Анонімний гравець",
	...
	"multiplayerWarning.message": "Увага: Мережева гра здійснюється на сторонніх серверах, якими не володіє, керує або які не модерує Mojang Studios або Microsoft. Під час мережевої гри можна зіткнутися з немодерованими повідомленнями в чаті або іншим вмістом від користувачів, що може підходити не кожному.",
	"music.game.a_familiar_room": "Аарон Шероф — A Familiar Room",
	"music.game.an_ordinary_day": "Кумі Таніока — An Ordinary Day",
	"music.game.ancestry": "Лейна Рейн — Ancestry",
	"music.game.below_and_above": "Еймос Родді — Below and Above",
	"music.game.broken_clocks": "Еймос Родді — Broken Clocks",
	"music.game.bromeliad": "Аарон Шероф — Bromeliad",
	"music.game.clark": "C418 — Clark",
	"music.game.comforting_memories": "Кумі Таніока — Comforting Memories",
	...
	"music.game.deeper": "Лейна Рейн — Deeper",
	"music.game.dry_hands": "C418 — Dry Hands",
	"music.game.ebb": "fingerspit — Ebb",
	"music.game.echo_in_the_wind": "Аарон Шероф — Echo in the Wind",
	"music.game.eld_unknown": "Лейна Рейн — Eld Unknown",
	"music.game.end.alpha": "C418 — Alpha",
	"music.game.end.boss": "C418 — Boss",
	"music.game.end.the_end": "C418 — The End",
	"music.game.endless": "Лейна Рейн — Endless",
	"music.game.featherfall": "Аарон Шероф — Featherfall",
	"music.game.fireflies": "Еймос Родді — Fireflies",
	"music.game.floating_dream": "Кумі Таніока — Floating Dream",
	"music.game.haggstrom": "C418 — Haggstrom",
	"music.game.home": "fingerspit — Home",
	"music.game.infinite_amethyst": "Лейна Рейн — Infinite Amethyst",
	"music.game.key": "C418 — Key",
	"music.game.komorebi": "Кумі Таніока — komorebi",
	"music.game.left_to_bloom": "Лейна Рейн — Left to Bloom",
	"music.game.lilypad": "Еймос Родді — Lilypad",
	...
	"music.game.nether.crimson_forest.chrysopoeia": "Лейна Рейн — Chrysopoeia",
	"music.game.nether.dead_voxel": "C418 — Dead Voxel",
	"music.game.nether.nether_wastes.rubedo": "Лейна Рейн — Rubedo",
	"music.game.nether.soulsand_valley.so_below": "Лейна Рейн — So Below",
	"music.game.nether.warmth": "C418 — Warmth",
	"music.game.nightly": "fingerspit — Nightly",
	"music.game.one_more_day": "Лейна Рейн — One More Day",
	"music.game.os_piano": "Еймос Родді — O’s Piano",
	"music.game.oxygene": "C418 — Oxygène",
	"music.game.pokopoko": "Кумі Таніока — pokopoko",
	"music.game.puzzlebox": "Аарон Шероф — Puzzlebox",
	"music.game.shores": "fingerspit — Shores",
	"music.game.stand_tall": "Лейна Рейн — Stand Tall",
	"music.game.subwoofer_lullaby": "C418 — Subwoofer Lullaby",
	"music.game.swamp.aerie": "Лейна Рейн — Aerie",
	"music.game.swamp.firebugs": "Лейна Рейн — Firebugs",
	"music.game.swamp.labyrinthine": "Лейна Рейн — Labyrinthine",
	...
	"music.game.wending": "Лейна Рейн — Wending",
	"music.game.wet_hands": "C418 — Wet Hands",
	"music.game.yakusoku": "Кумі Таніока — yakusoku",
	...
	"narration.checkbox.usage.focused.check": "Натисніть Enter, щоб позначити",
	"narration.checkbox.usage.focused.uncheck": "Натисніть Enter, щоб зняти позначку",
	"narration.checkbox.usage.hovered": "Натисніть ЛКМ, щоб перемкнути",
	"narration.checkbox.usage.hovered.check": "Натисніть ЛКМ, щоб позначити",
	"narration.checkbox.usage.hovered.uncheck": "Натисніть ЛКМ, щоб зняти позначку",
	...
	"narration.selection.usage": "Натискайте клавіші вгору й униз, щоб переходити до іншого запису",
	"narration.slider.usage.focused": "Натискайте клавіші вліво або вправо на клавіатурі, щоб змінювати значення",
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Натисніть Enter, щоб почати змінювати значення повзунка",
	"narration.slider.usage.hovered": "Перетягніть повзунок, щоб змінити його значення",
	...
	"options.accessibility.narrator_hotkey": "Гар. клавіша диктора",
	...
	"options.allowCursorChanges": "Дозвол. зміни курсору",
	"options.allowCursorChanges.tooltip": "Дозволяє курсору миші змінювати форму над деякими елементами інтерфейсу.",
	...
	"options.allowServerListing.tooltip": "Сервери можуть показувати онлайн гравців у своєму загальнодоступному стані.\nЯкщо цю опцію вимкнено, ваше ім’я не показуватиметься в цих списках.",
	...
	"options.biomeBlendRadius": "Зміш. біомів",
	...
	"options.chat.drafts": "Збер. ненадісл. чати",
	"options.chat.drafts.tooltip": "Ненадіслані повідомлення буде збережено і їх можна буде надіслати наступного разу, коли чат буде відкрито.",
	...
	"options.chunkFade": "Час анімації чанку",
	"options.chunkFade.none": "Анімація чанку: Відсутня",
	"options.chunkFade.seconds": "Анімація чанку: %s секунд",
	"options.chunkFade.tooltip": "Як довго в секундах анімовано чанки, коли вони вперше промальовуються.",
	...
	"options.cutoutLeaves": "Прозоре листя",
	"options.cutoutLeaves.tooltip": "Дозволяє вам бачити крізь прогалини в листі. Вимкнення покращує продуктивність.",
	...
	"options.directionalAudio.on.tooltip": "Використовується спрямований звук на основі HRTF для покращення моделювання 3D-звуку. Потрібне аудіотехнічне обладнання, сумісне з HRTF, рекомендуємо користуватися навушниками для кращого ігрового досвіду.",
	...
	"options.exclusiveFullscreen": "Ексклюзивний повний екран",
	"options.exclusiveFullscreen.warningTooltip": "Ця опція може завадити працювати деяким способам введення.",
	...
	"options.graphics.custom": "Користувацький",
	...
	"options.graphics.preset.tooltip": "Установлює налаштування «Якість і продуктивність» на прийнятні усталені, що відповідають бажаній якості.",
	...
	"options.graphicsApi": "Графічний API",
	"options.graphicsApi.default": "Усталений",
	"options.graphicsApi.opengl": "OpenGL",
	"options.graphicsApi.restart": "Ви повинні перезапустити вашу гру, щоб змінити графічний API.",
	"options.graphicsApi.tooltip": "Який графічний API використовувати для промальовування. Залишіть «Усталений», якщо у вас немає особливої потреби його змінити! Вплине наступного разу, коли ви запустите гру.",
	...
	"options.graphicsApi.vulkan": "Vulkan (Експериментальний)",
	"options.guiScale": "Розмір інтерфейсу",
	"options.guiScale.auto": "Авто",
	"options.hidden": "Приховано",
	"options.hideLightningFlashes": "Схов. спалахи неба",
	"options.hideLightningFlashes.tooltip": "Запобігає спалахам неба від блискавок або інших ефектів оточення. Самі джерела спалахів досі будуть видимими.",
	...
	"options.improvedTransparency": "Покращ. прозорість",
	"options.improvedTransparency.tooltip": "Експериментальний підхід, що використовує екранні шейдери для малювання погоди, хмар і частинок за напівпрозорими блоками й водою.\nЦе вплине на продуктивність графічного процесора.",
	...
	"options.invertMouseX": "Інвертувати X миші",
	"options.invertMouseY": "Інвертувати Y миші",
	...
	"options.maxAnisotropy": "Анізотропне фільтрування",
	"options.maxAnisotropy.tooltip": "Значно покращує вигляд гладких текстур, але впливає на продуктивність і значно впливає на використання відеопам’яті. Може підтримуватися не всім апаратним забезпеченням.",
	...
	"options.musicToast": "Музична підказка",
	"options.musicToast.never": "Ніколи",
	"options.musicToast.never.tooltip": "Музичні підказки не буде показано.",
	"options.musicToast.pauseMenu": "Меню паузи",
	"options.musicToast.pauseMenu.tooltip": "Під час відтворення пісні в меню паузи в грі постійно буде видно музичну підказку.",
	"options.musicToast.pauseMenuAndToast": "Меню павзи та муз. підказка",
	"options.musicToast.pauseMenuAndToast.tooltip": "Показує підказку, коли починається відтворення пісні. Ця підказка постійно показується в меню паузи в грі під час відтворення пісні.",
	"options.music_frequency": "Частота музики",
	"options.music_frequency.constant": "Постійна",
	"options.music_frequency.default": "Усталена",
	"options.music_frequency.frequent": "Часта",
	"options.music_frequency.tooltip": "Змінює, як часто музика відтворюється в ігровому світі.",
	"options.narrator": "Диктор",
	"options.narrator.all": "Озвучує все",
	"options.narrator.chat": "Озвучує чат",
	"options.narrator.notavailable": "Недоступний",
	"options.narrator.off": "ВИМК.",
	"options.narrator.system": "Озвучує систему",
	"options.needsRestart": "Опція набуде чинности після перезапуску.",
	"options.notifications.display_time": "Час сповіщення",
	"options.notifications.display_time.tooltip": "Впливає на тривалість часу, протягом якого всі сповіщення залишаються видимими на екрані.",
	"options.off": "ВИМК.",
	...
	"options.renderCloudsDistance": "Відстань хмар",
	...
	"options.screenEffectScale.tooltip": "Сила ефектів запаморочення та спотворення від Незер-порталу.\nПри низьких значеннях ефект запаморочення замінюється зеленим підсвічуванням.",
	...
	"options.showNowPlayingToast": "Показ. муз. підказку",
	"options.showNowPlayingToast.tooltip": "Показує підказку щоразу, коли починається відтворення музики. Ця підказка постійно показується в ігровому меню призупинення під час відтворення пісні.",
	"options.showSubtitles": "Субтитри",
	"options.showSubtitles.tooltip": "Умикає субтитри звуків, що відтворюються в грі.",
	...
	"options.sprintWindow.tooltip": "Часовий проміжок у тактах, під час якого подвійне натискання клавіші руху вперед активує біг.",
	...
	"options.textureFiltering": "Фільтрування текстур",
	"options.textureFiltering.anisotropic": "Анізотропне",
	"options.textureFiltering.anisotropic.tooltip": "Апаратний метод фільтрації, але впливає на продуктивність і значно впливає на використання відеопам’яті. Може підтримуватися не всім обладнанням.",
	"options.textureFiltering.none": "Жодного",
	"options.textureFiltering.none.tooltip": "Текстури буде видно без фільтрації. Блоки можуть виглядати розмитими, якщо дивитися під кутом.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nМетод фільтрації на основі шейдерів, який покращує якість текстур із помірним впливом на продуктивність.",
	"options.title": "Налаштування",
	"options.touchscreen": "Сенсорний режим",
	"options.value": "%s",
	"options.video": "Налаштування відео…",
	"options.video.display.header": "Дисплей",
	"options.video.interface.header": "Інтерфейс",
	"options.video.preferences.header": "Уподобання",
	"options.video.quality.header": "Якість і продуктивність",
	"options.videoTitle": "Налаштування відео",
	"options.viewBobbing": "Коливання камери",
	"options.vignette": "Показувати віньєтку",
	"options.vignette.tooltip": "Це малопомітна текстура на ігровому екрані, яка використовується для зменшення яскравости вздовж країв екрана та попереджає про наближення до меж світу.",
	"options.visible": "Показано",
	"options.vsync": "VSync",
	"options.weatherRadius": "Радіус еф. погоди",
	"options.weatherRadius.tooltip": "Радіус области, у якій видно ефекти дощу та снігу. Дуже низький вплив на продуктивність.",
	"options.worldOptions.button": "Налаштування світу…",
	"options.worldOptions.title": "Налаштування світу",
	...
	"pack.incompatible.confirm.unknown": "Цей пакет зламаний або зроблений для невідомої версії Minecraft та може не працювати правильно.",
	"pack.incompatible.new": "(Зроблені для новішої версії Minecraft)",
	"pack.incompatible.old": "(Зроблений для старішої версії Minecraft)",
	"pack.incompatible.unknown": "(Зламаний або несумісний)",
	...
	"painting.minecraft.dennis.title": "Денніс",
	...
	"realms.configuration.region.australia_east": "Новий Південний Вельс, Австралія",
	"realms.configuration.region.australia_southeast": "Вікторія, Австралія",
	"realms.configuration.region.brazil_south": "Бразилія",
	...
	"realms.configuration.region.east_us": "Вірджинія, США",
	"realms.configuration.region.east_us_2": "Північна Кароліна, США",
	"realms.configuration.region.france_central": "Франція",
	"realms.configuration.region.japan_east": "Схід Японії",
	"realms.configuration.region.japan_west": "Захід Японії",
	"realms.configuration.region.korea_central": "Південна Корея",
	"realms.configuration.region.north_central_us": "Іллінойс, США",
	...
	"realms.configuration.region.uae_north": "Об’єднані Арабські Емірати (ОАЕ)",
	"realms.configuration.region.uk_south": "Південна Англія",
	"realms.configuration.region.west_central_us": "Юта, США",
	"realms.configuration.region.west_europe": "Нідерланди",
	"realms.configuration.region.west_us": "Каліфорнія, США",
	"realms.configuration.region.west_us_2": "Вашингтон, США",
	"realms.configuration.region_preference.automatic_owner": "Автоматичний (пінг власника Realm)",
	"realms.configuration.region_preference.automatic_player": "Автоматичний (перший, що приєднався до сесії)",
	...
	"restrictions_screen.button": "Обмеження…",
	"restrictions_screen.permission.receive_player_messages.allowed": "Ви можете отримувати повідомлення від гравців",
	"restrictions_screen.permission.receive_player_messages.denied": "Ви не можете отримувати повідомлення від гравців",
	"restrictions_screen.permission.receive_system_messages.allowed": "Ви можете отримувати системні повідомлення від сервера",
	"restrictions_screen.permission.receive_system_messages.denied": "Ви не можете отримувати системні повідомлення від сервера",
	"restrictions_screen.permission.send_commands.allowed": "Ви можете надсилати команди",
	"restrictions_screen.permission.send_commands.denied": "Ви не можете надсилати команди",
	"restrictions_screen.permission.send_messages.allowed": "Ви можете надсилати повідомлення в чат",
	"restrictions_screen.permission.send_messages.denied": "Ви не можете надсилати повідомлення в чат",
	"restrictions_screen.title": "Обмеження",
	...
	"selectWorld.allowCommands.info": "Команди на кшталт /gamemode, /experience",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Створити резервну копію перед оновленням цього світу?",
	...
	"selectWorld.backupWarning.file_fixing_required": "Цей світ потрібно оновити, перш ніж ви зможете в нього грати. Ми наполегливо рекомендуємо створити резервну копію, перш ніж продовжити, якщо ви зіткнетеся із зіпсуванням світу.",
	...
	"selectWorld.locked": "Заблоковано іншим чинним примірником Minecraft.",
	...
	"selectWorld.mapType.normal": "Звичайний",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Цей світ потрібно оновити до останньої версії, перш ніж ви зможете його редагувати через внутрішні зміни у форматі світу.",
	"selectWorld.requiresFileFixingTooltip.play": "Цей світ потрібно оновити до останньої версії, перш ніж ви зможете грати в нього через внутрішні зміни у форматі світу.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Цей світ потрібно оновити до останньої версії, перш ніж ви зможете перестворити його через внутрішні зміни у форматі світу.",
	...
	"selectWorld.tooltip.fromNewerVersion1": "Світ було збережено в новішій версії. Його",
	"selectWorld.tooltip.fromNewerVersion2": "завантаження може призвести до проблем!",
	...
	"selectWorld.upgrade_and_play": "Оновити й грати",
	...
	"selectWorld.waitingForBackup.message": "Залежно від розміру вашого світу це може зайняти деякий час. Не закривайте гру та не вимикайте пристрій.",
	"selectWorld.waitingForBackup.title": "Створення резервної копії",
	...
	"selectWorld.world_gen_settings_access": "Неможливо прочитати або отримати доступ до файлу налаштувань генерації світу! %s",
	"selecteWorld.backupRequiredTooltip": "Для завантаження світу спершу потрібно зробити резервну копію",
	...
	"stat.minecraft.clean_banner": "Стягів випрано",
	...
	"stat.minecraft.interact_with_blast_furnace": "Взаємодій із домною",
	...
	"stat.minecraft.nautilus_one_cm": "Відстань, проплита на навтилусі",
	...
	"stat.minecraft.total_world_time": "Час із відкритим світом",
	...
	"stat.minecraft.use_cauldron": "Води взято з казана",
	...
	"structure_block.integrity": "Цілісність і зерно структури",
	"structure_block.integrity.integrity": "Цілісність структури",
	"structure_block.integrity.seed": "Зерно структури",
	...
	"subtitles.block.blastfurnace.fire_crackle": "Домна потріскує",
	...
	"subtitles.block.copper_chest.close": "Скриня зачиняється",
	"subtitles.block.copper_chest.open": "Скриня відчиняється",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Сірчане джерело вивергається",
	"subtitles.block.potent_sulfur.noxious_gas": "Шкідливий газ з’являється",
	...
	"subtitles.block.shelf.activate": "Полиця активується",
	"subtitles.block.shelf.deactivate": "Полиця дезактивується",
	"subtitles.block.shelf.multi_swap": "Предмети переміщено",
	"subtitles.block.shelf.place_item": "Предмет розміщено",
	"subtitles.block.shelf.single_swap": "Предмет переміщено",
	"subtitles.block.shelf.take_item": "Предмет узято",
	...
	"subtitles.block.trial_spawner.ambient": "Породжувач випробувань потріскує",
	...
	"subtitles.block.trial_spawner.charge_activate": "Прикмета охоплює породжувач випробувань",
	"subtitles.block.trial_spawner.close_shutter": "Породжувач випробувань зачиняється",
	"subtitles.block.trial_spawner.detect_player": "Породжувач випробувань заряджається",
	"subtitles.block.trial_spawner.eject_item": "Породжувач випробувань викидає предмети",
	"subtitles.block.trial_spawner.ominous_activate": "Прикмета охоплює породжувач випробувань",
	"subtitles.block.trial_spawner.open_shutter": "Породжувач випробувань відчиняється",
	...
	"subtitles.block.trial_spawner.spawn_mob": "Породжувач випробувань породжує моба",
	...
	"subtitles.entity.baby_cat.ambient": "Кошеня нявчить",
	"subtitles.entity.baby_cat.beg_for_food": "Кошеня випрошує їжу",
	"subtitles.entity.baby_cat.death": "Кошеня гине",
	"subtitles.entity.baby_cat.eat": "Кошеня їсть",
	"subtitles.entity.baby_cat.hiss": "Кошеня шипить",
	"subtitles.entity.baby_cat.hurt": "Кошеня поранено",
	"subtitles.entity.baby_cat.purr": "Кошеня муркоче",
	"subtitles.entity.baby_chicken.ambient": "Курча цвірінькає",
	"subtitles.entity.baby_chicken.death": "Курча гине",
	"subtitles.entity.baby_chicken.hurts": "Курча поранено",
	"subtitles.entity.baby_horse.ambient": "Лоша ірже",
	"subtitles.entity.baby_horse.angry": "Лоша ірже",
	"subtitles.entity.baby_horse.breathe": "Лоша дихає",
	"subtitles.entity.baby_horse.death": "Лоша гине",
	"subtitles.entity.baby_horse.eat": "Лоша їсть",
	"subtitles.entity.baby_horse.hurt": "Лоша поранено",
	"subtitles.entity.baby_horse.land": "Лоша приземлюється",
	"subtitles.entity.baby_nautilus.ambient": "Дитинча навтилуса балакає",
	"subtitles.entity.baby_nautilus.ambient_land": "Дитинча навтилуса балакає",
	"subtitles.entity.baby_nautilus.death": "Дитинча навтилуса гине",
	"subtitles.entity.baby_nautilus.death_land": "Дитинча навтилуса гине",
	"subtitles.entity.baby_nautilus.eat": "Дитинча навтилуса їсть",
	"subtitles.entity.baby_nautilus.hurt": "Дитинча навтилуса поранено",
	"subtitles.entity.baby_nautilus.hurt_land": "Дитинча навтилуса поранено",
	"subtitles.entity.baby_nautilus.swim": "Дитинча навтилуса пливе",
	"subtitles.entity.baby_pig.ambient": "Порося рохкає",
	"subtitles.entity.baby_pig.death": "Порося гине",
	"subtitles.entity.baby_pig.eat": "Порося їсть",
	"subtitles.entity.baby_pig.hurt": "Порося поранено",
	"subtitles.entity.baby_wolf.ambient": "Цуценя гавкає",
	"subtitles.entity.baby_wolf.death": "Цуценя гине",
	"subtitles.entity.baby_wolf.growl": "Цуценя гарчить",
	"subtitles.entity.baby_wolf.hurt": "Цуценя поранено",
	"subtitles.entity.baby_wolf.pant": "Цуценя пихтить",
	"subtitles.entity.baby_wolf.whine": "Цуценя скиглить",
	...
	"subtitles.entity.camel.saddle": "Сідло споряджається",
	...
	"subtitles.entity.camel_husk.ambient": "Верблюд-висушень бурчить",
	"subtitles.entity.camel_husk.dash": "Верблюд-висушень перестрибує",
	"subtitles.entity.camel_husk.dash_ready": "Верблюд-висушень відновлюється",
	"subtitles.entity.camel_husk.death": "Верблюд-висушень гине",
	"subtitles.entity.camel_husk.eat": "Верблюд-висушень їсть",
	"subtitles.entity.camel_husk.hurt": "Верблюда-висушня поранено",
	"subtitles.entity.camel_husk.saddle": "Сідло споряджається",
	"subtitles.entity.camel_husk.sit": "Верблюд-висушень сідає",
	"subtitles.entity.camel_husk.stand": "Верблюд-висушень встає",
	...
	"subtitles.entity.copper_golem.death": "Мідний ґолем гине",
	"subtitles.entity.copper_golem.hurt": "Мідного ґолема поранено",
	"subtitles.entity.copper_golem.item_drop": "Мідний ґолем кладе предмет",
	"subtitles.entity.copper_golem.item_no_drop": "Мідний ґолем не може покласти предмет",
	"subtitles.entity.copper_golem.no_item_get": "Мідний ґолем бере предмет",
	"subtitles.entity.copper_golem.no_item_no_get": "Мідний ґолем не може взяти предмет",
	"subtitles.entity.copper_golem.spawn": "Мідний ґолем з’являється",
	"subtitles.entity.copper_golem.spin": "Мідний ґолем крутить головою",
	"subtitles.entity.copper_golem_become_statue": "Мідний ґолем скам’янів",
	"subtitles.entity.copper_golem_oxidized.death": "Мідний ґолем гине",
	"subtitles.entity.copper_golem_oxidized.hurt": "Мідного ґолема поранено",
	"subtitles.entity.copper_golem_oxidized.spin": "Мідний ґолем крутить головою",
	"subtitles.entity.copper_golem_weathered.death": "Мідний ґолем гине",
	"subtitles.entity.copper_golem_weathered.hurt": "Мідного ґолема поранено",
	"subtitles.entity.copper_golem_weathered.spin": "Мідний ґолем крутить головою",
	...
	"subtitles.entity.elder_guardian.ambient_land": "Стародавній вартовий махає плавцями",
	...
	"subtitles.entity.generic.eat": "Поїдання",
	...
	"subtitles.entity.glow_squid.ambient": "Сяйний кальмар пливе",
	"subtitles.entity.glow_squid.death": "Сяйний кальмар гине",
	"subtitles.entity.glow_squid.hurt": "Сяйного кальмара поранено",
	"subtitles.entity.glow_squid.squirt": "Сяйний кальмар стріляє чорнилом",
	...
	"subtitles.entity.happy_ghast.equip": "Упряж споряджається",
	...
	"subtitles.entity.horse.saddle": "Сідло споряджається",
	...
	"subtitles.entity.illusioner.ambient": "Ілюзіонин бурмоче",
	"subtitles.entity.illusioner.cast_spell": "Ілюзіонин чаклує",
	"subtitles.entity.illusioner.death": "Ілюзіонин гине",
	"subtitles.entity.illusioner.hurt": "Ілюзіонина поранено",
	"subtitles.entity.illusioner.mirror_move": "Ілюзіонин переміщується",
	"subtitles.entity.illusioner.prepare_blindness": "Ілюзіонин готує сліпоту",
	"subtitles.entity.illusioner.prepare_mirror": "Ілюзіонин готує віддзеркалення",
	...
	"subtitles.entity.nautilus.ambient": "Навтилус клацає",
	"subtitles.entity.nautilus.ambient_land": "Навтилус клацає",
	"subtitles.entity.nautilus.dash": "Навтилус струменіє",
	"subtitles.entity.nautilus.dash_land": "Навтилус струменіє",
	"subtitles.entity.nautilus.dash_ready": "Навтилус відновлюється",
	"subtitles.entity.nautilus.dash_ready_land": "Навтилус відновлюється",
	"subtitles.entity.nautilus.death": "Навтилус гине",
	"subtitles.entity.nautilus.death_land": "Навтилус гине",
	"subtitles.entity.nautilus.eat": "Навтилус їсть",
	"subtitles.entity.nautilus.hurt": "Навтилуса поранено",
	"subtitles.entity.nautilus.hurt_land": "Навтилуса поранено",
	"subtitles.entity.nautilus.swim": "Навтилус пливе",
	...
	"subtitles.entity.parched.ambient": "Засушень брязкає кістками",
	"subtitles.entity.parched.death": "Засушень гине",
	"subtitles.entity.parched.hurt": "Засушня поранено",
	...
	"subtitles.entity.parrot.imitate.camel_husk": "Папуга бурчить",
	...
	"subtitles.entity.parrot.imitate.parched": "Папуга вдає брязкання",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Папуга вдає іржання",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Папуга вдає булькання",
	...
	"subtitles.entity.pig.eat": "Свиня їсть",
	"subtitles.entity.pig.hurt": "Свиню поранено",
	"subtitles.entity.pig.saddle": "Сідло споряджається",
	...
	"subtitles.entity.squid.ambient": "Кальмар пливе",
	"subtitles.entity.squid.death": "Кальмар гине",
	"subtitles.entity.squid.hurt": "Кальмара поранено",
	"subtitles.entity.squid.squirt": "Кальмар стріляє чорнилом",
	...
	"subtitles.entity.sulfur_cube.absorb": "Сіркокуба наповнено",
	"subtitles.entity.sulfur_cube.bounce": "Сіркокуб відстрибує",
	"subtitles.entity.sulfur_cube.death": "Сіркокуб гине",
	"subtitles.entity.sulfur_cube.eject": "Блок прибрано",
	"subtitles.entity.sulfur_cube.hit": "Сіркокуба вдарено",
	"subtitles.entity.sulfur_cube.hurt": "Сіркокуба поранено",
	"subtitles.entity.sulfur_cube.push": "Сіркокуба відштовхнуто",
	"subtitles.entity.sulfur_cube.squish": "Сіркокуб хлюпає",
	...
	"subtitles.entity.zombie.infect": "Зомбі заражає",
	"subtitles.entity.zombie_horse.ambient": "Зомбокінь плаче",
	"subtitles.entity.zombie_horse.angry": "Зомбокінь ірже",
	"subtitles.entity.zombie_horse.death": "Зомбокінь гине",
	"subtitles.entity.zombie_horse.eat": "Зомбокінь їсть",
	"subtitles.entity.zombie_horse.hurt": "Зомбоконя поранено",
	"subtitles.entity.zombie_nautilus.ambient": "Зомбонавтилус бурмоче",
	"subtitles.entity.zombie_nautilus.ambient_land": "Зомбонавтилус бурмоче",
	"subtitles.entity.zombie_nautilus.dash": "Зомбонавтилус струменіє",
	"subtitles.entity.zombie_nautilus.dash_land": "Зомбонавтилус струменіє",
	"subtitles.entity.zombie_nautilus.dash_ready": "Зомбонавтилус відновлюється",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Зомбонавтилус відновлюється",
	"subtitles.entity.zombie_nautilus.death": "Зомбонавтилус гине",
	"subtitles.entity.zombie_nautilus.death_land": "Зомбонавтилус гине",
	"subtitles.entity.zombie_nautilus.eat": "Зомбонавтилус їсть",
	"subtitles.entity.zombie_nautilus.hurt": "Зомбонавтилуса поранено",
	"subtitles.entity.zombie_nautilus.hurt_land": "Зомбонавтилуса поранено",
	"subtitles.entity.zombie_nautilus.swim": "Зомбонавтилус пливе",
	...
	"subtitles.item.armor.equip": "Обладунки споряджаються",
	"subtitles.item.armor.equip_chain": "Кольчуга дзеленчить",
	"subtitles.item.armor.equip_copper": "Мідні обладунки бряжчать",
	...
	"subtitles.item.armor.equip_nautilus": "Навтилус споряджається обладунками",
	...
	"subtitles.item.armor.unequip_nautilus": "Обладунки навтилуса знімаються",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Сіркокуба спіймано",
	...
	"subtitles.item.golden_dandelion.unuse": "Золота кульбаба відновлює старіння",
	"subtitles.item.golden_dandelion.use": "Золота кульбаба зупиняє старіння",
	...
	"subtitles.item.horse_armor.unequip": "Кінські обладунки знімаються",
	"subtitles.item.ink_sac.use": "Чорнило нанесено",
	"subtitles.item.lead.break": "Повідець рветься",
	"subtitles.item.lead.tied": "Повідець прив’язано",
	"subtitles.item.lead.untied": "Повідець відв’язано",
	"subtitles.item.llama_carpet.unequip": "Килим знімається",
	...
	"subtitles.item.nautilus_saddle_equip": "Сідло споряджається",
	"subtitles.item.nautilus_saddle_underwater_equip": "Сідло споряджається",
	"subtitles.item.nether_wart.plant": "Наріст посаджено",
	"subtitles.item.ominous_bottle.dispose": "Пляшка розбивається",
	"subtitles.item.saddle.unequip": "Сідло знімається",
	...
	"subtitles.item.spear.attack": "Спис ударяє",
	"subtitles.item.spear.hit": "Спис улучає",
	"subtitles.item.spear.lunge": "Випад списом",
	"subtitles.item.spear.use": "Таран списом",
	"subtitles.item.spear_wood.attack": "Спис ударяє",
	"subtitles.item.spear_wood.hit": "Спис влучає",
	"subtitles.item.spear_wood.use": "Підготування списа",
	...
	"subtitles.item.underwater_saddle.equip": "Сідло споряджається",
	...
	"subtitles.weather.end_flash": "Спалах Енду гуркотить",
	...
	"telemetry.event.graphics_capabilities.title": "Можливості графіки",
	...
	"telemetry.event.world_load_times.description": "Нам важливо розуміти, скільки часу потрібно, щоб приєднатися до світу, і як це змінюється з часом. Наприклад, коли ми додаємо нові можливості або робимо більші технічні зміни, нам потрібно бачити, який вплив це має на завантаження світу.",
	...
	"telemetry.property.backend_failure_message.title": "Повідомлення помилки бекенду",
	"telemetry.property.backend_failure_missing_capabilities.title": "Відсутні можливості бекенду",
	"telemetry.property.backend_failure_reason.title": "Причина помилки створення бекенду",
	"telemetry.property.backend_name.title": "Назва бекенду",
	...
	"test.error.block_property_missing": "Властивість блока відсутня. Очікувалося, що властивість %s буде %s",
	"test.error.entity_property": "Сутність %s провалила тест: %s",
	"test.error.entity_property_details": "Сутність %s провалила тестування: %s. Очікувалося %s; було %s",
	"test.error.expected_block": "Очікувався блок %s; отримано %s",
	"test.error.expected_block_present": "Очікувалося, що блок %s буде присутнім",
	...
	"test.error.expected_entity_data": "Очікувалося, що дані сутности будуть %s; були %s",
	...
	"test.error.not_a_block_item": "Зазначений блок не є блоком-предметом",
	...
	"test.error.sequence.minimum_tick": "Виконано успішно перед очікуваним тактом: було очікувано чекати %s",
	...
	"test.error.value_not_in_between": "Очікувалося, що %s буде між %s і %s: було %s",
	...
	"test_block.mode.log": "Журналювати",
	...
	"test_instance.description.batch": "Середовище: %s",
	...
	"test_instance.type.function": "Убудований функціональний тест",
	...
	"upgradeWorld.aborted.message": "Це може статися, якщо інша програма мала доступ до світу під час оновлення.\nМає допомогти, якщо ви перезапустите свій комп’ютер і спробуєте знову. Якщо це не усуне проблему, будь ласка, повідомте про помилку.",
	"upgradeWorld.aborted.reportBug": "Повідомити про помилку",
	"upgradeWorld.aborted.title": "Не вдалося оновити світ",
	"upgradeWorld.canceled.message": "Ваш світ залишається таким, яким був раніше.",
	"upgradeWorld.canceled.title": "Оновлення світу скасовано",
	"upgradeWorld.done": "Оновлення світу завершено",
	"upgradeWorld.failed_cleanup.message": "Світ успішно оновлено до поточної версії й тепер доступний у списку світів.\nМи зіштовхнулися з проблемами під час очищення застарілих даних, тому назву теки світу було змінено на %s.",
	"upgradeWorld.failed_cleanup.title": "Світ успішно оновлено",
	"upgradeWorld.info.converted": "Оновлено: %s",
	"upgradeWorld.info.file_fix_stage": "Етап: %s/%s",
	"upgradeWorld.info.scanning": "Сканування файлів…",
	"upgradeWorld.info.total": "Усього: %s",
	"upgradeWorld.joinNow": "Хочете приєднатись до світу зараз?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Переміщення файлів",
	"upgradeWorld.progress.type.legacy_structures": "Оновлення старих структур",
	"upgradeWorld.progress.type.region": "Оновлення регіонів",
	"upgradeWorld.symlink.message": "Вибраний світ містить символічні посилання.\nНеобхідні кроки для оновлення світу до поточної версії не підтримують використання символічних посилань. Щоб оновити світ, спочатку потрібно розкрити посилання.",
	"upgradeWorld.symlink.title": "Не можна оновити світ",
	"upgradeWorld.title": "Оновлення файлів світу",
}
