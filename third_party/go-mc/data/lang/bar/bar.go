// Code generated by tools/gen_lang.go from 26.1/bar.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Barriernfreiheidseinschdellungen...",
	...
	"advMode.notEnabled.spawner": "Spawner san ned aktiviert",
	"advMode.previousOutput": "Letzte Asgobe",
	"advMode.setCommand": "Befehl oangebn",
	"advMode.setCommand.disabled": "Befehl is gsetzt: %s, oba de Command Blöck san no ausgschoitn",
	...
	"advancements.adventure.avoid_vibration.description": "Schleich in da Näh vo am Sculk-Sensor oda vom Wärta, um zum verhindan, dass du bemerkt weast",
	"advancements.adventure.avoid_vibration.title": "Schleicha 100",
	"advancements.adventure.blowback.description": "Erleg a Bö mit a abgwehrtn Böen-Windkugl",
	"advancements.adventure.blowback.title": "Gechawind",
	"advancements.adventure.brush_armadillo.description": "Nimm an Pinsel, um a Hornschüld vom Panza vo am Girtlvaich zu lösa",
	"advancements.adventure.brush_armadillo.title": "Is des ned putzig?",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Vorsichtige Restorierung",
	"advancements.adventure.crafters_crafting_crafters.description": "Sei in da Nähe vo am Werkler, wenn a an Werkler bastlt",
	"advancements.adventure.crafters_crafting_crafters.title": "Sölwa gmachd in schdaader Nachd",
	...
	"advancements.adventure.heart_transplanter.description": "Platzia a Krachads Herz in da richtign Ausrichtung zwischn zwoa Heie Oachnstämme",
	"advancements.adventure.heart_transplanter.title": "Herztransplantation",
	...
	"advancements.adventure.lighten_up.description": "Kratz a Kupfabiandl mit na Axt ob, um d Leichtkraft stärker z macha",
	"advancements.adventure.lighten_up.title": "Afhelln",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Geh in a Aufgamkammer",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Priafungs-Edition",
	...
	"advancements.adventure.overoverkill.description": "Vauasach 50 Herzn Schon mit oam Schlog vo am Streitkoim",
	"advancements.adventure.overoverkill.title": "Komplette Nullifikation",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Lies mit oanem Komparator die Signalstärke oanes gearbeitetn Bücherregals aus",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Die Stärke der Bücher",
	"advancements.adventure.revaulting.description": "Moch an ominösn Tresor mit am ominösn Schlüssl af",
	"advancements.adventure.revaulting.title": "Ruaf d Bullerei",
	...
	"advancements.adventure.salvage_sherd.title": "Obacht voa dem Oiden",
	...
	"advancements.adventure.spear_many_mobs.description": "Triff fünf Kreaturn in oam Rutsch mit'm Speer",
	"advancements.adventure.spear_many_mobs.title": "Fünf an oam Spieß",
	"advancements.adventure.spyglass_at_dragon.description": "Schaug an Enderdrachn duach a Feanroah o",
	"advancements.adventure.spyglass_at_dragon.title": "Is's a Fliaga?",
	"advancements.adventure.spyglass_at_ghast.description": "Schaug an Ghast duach a Feanroah o",
	"advancements.adventure.spyglass_at_ghast.title": "Is's a Boion?",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Benutz jede vo dene Schmiedevorlagn oamoi: Turmspitzn, Schnauzn, Ripperl, Woathof, Staad, Plagegeist, Bob seins und Pfodfinder",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Schmieden mid Stil",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Verzia a Rüstungsteil an am Schmieddisch",
	"advancements.adventure.trim_with_any_armor_pattern.title": "A neichs Ausseng",
	...
	"advancements.adventure.under_lock_and_key.description": "Moch an Tresor mit am Aufgomschlüssl af",
	"advancements.adventure.under_lock_and_key.title": "Hinta Schloss und Riegel",
	"advancements.adventure.use_lodestone.description": "Nutz an Kompass an am Leitstoa",
	"advancements.adventure.use_lodestone.title": "Woaßt, wo de Leitstoa’ stehn?",
	...
	"advancements.adventure.who_needs_rockets.description": "Nutz an Windboi um di 8 Blöcke afe z schleidern",
	"advancements.adventure.who_needs_rockets.title": "A haudiga Fluag",
	...
	"advancements.husbandry.feed_snifflet.title": "A zoats Schnuffln",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Platzia an ausdrocknadn Ghast ins Wossa",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Saufa muaßt!",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Sa irgenan Samen, den a Schniffler ausgrom hod",
	"advancements.husbandry.plant_any_sniffer_seed.title": "Mia säen Gschichte",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Entfern d Hundsrüstung vo am Woif mit na Schar",
	"advancements.husbandry.remove_wolf_armor.title": "Schnipp‐schnapp!",
	"advancements.husbandry.repair_wolf_armor.description": "Reparier a beschädigte Hundsrüstung mit Gürtltier-Schuppn",
	"advancements.husbandry.repair_wolf_armor.title": "So guad wia nei",
	...
	"advancements.husbandry.whole_pack.description": "Zähm olle vaschiedenen Hundesortn",
	"advancements.husbandry.whole_pack.title": "Wolfgang",
	...
	"argument.entity.selector.nearestEntity": "Näxtes Objekt",
	...
	"argument.hexcolor.invalid": "Unguitiga Hex-Farbcode '%s'",
	...
	"argument.message.too_long": "Chatnachricht war z lang (%s > maximal %s Zeichn)",
	"argument.nbt.array.invalid": "Ungültiga Array-Typ ‚%s‘",
	"argument.nbt.array.mixed": "%s konn ned in %s oang'fügt wern",
	"argument.nbt.expected.compound": "Verbunddaten erwartet",
	...
	"argument.resource_or_id.failed_to_parse": "Struktur hod ned ausgewertet wern kinna: %s",
	"argument.resource_or_id.invalid": "Unguitige id oda tag",
	"argument.resource_or_id.no_such_element": "Element '%s' in Register '%s' ko ned gfunna wern",
	"argument.resource_selector.not_found": "Koa Übereinstimmungen für'n Selektor ‚%s‘ vom Typ'n ‚%s‘",
	...
	"argument.style.invalid": "Ungeitige Schriftauszeichnung: %s",
	...
	"argument.waypoint.invalid": "Ausgweids Viech is koa Wegpunkt",
	...
	"arguments.item.component.expected": "Stairs",
	"arguments.item.component.malformed": "Unpassnde '%s' - Komponentn: '%s'",
	"arguments.item.component.repeated": "Itemkomponentn '%s' is wiederhoid worn, aba nur oa Wert ko ohem wern",
	"arguments.item.component.unknown": "Unbekannte Itemkomponentn '%s'",
	"arguments.item.malformed": "Fehlerhafta Gegnstand: '%s'",
	"arguments.item.overstacked": "Maximale Staplgröße vo %s is %s",
	"arguments.item.predicate.malformed": "Fehlerhafts '%s' - Prädikat: '%s'",
	"arguments.item.predicate.unknown": "Unbekannts Itemprädikat '%s'",
	...
	"attribute.name.air_drag_modifier": "Luftwiderstandsfaktor",
	"attribute.name.armor": "Rüstung",
	"attribute.name.armor_toughness": "Rüstungshärtn",
	"attribute.name.attack_damage": "Angriffsschon",
	"attribute.name.attack_knockback": "Angriffsrückstoß",
	"attribute.name.attack_speed": "Angriffsgschwindigkeit",
	"attribute.name.below_name_distance": "Punktetafelabstand",
	"attribute.name.block_break_speed": "Blockabbaugschwindigkeit",
	"attribute.name.block_interaction_range": "Blockinteraktionsreichweitn",
	"attribute.name.bounciness": "Federung",
	"attribute.name.burning_time": "Brenn dauer",
	"attribute.name.camera_distance": "Kameradistanz",
	"attribute.name.entity_interaction_range": "Viechinteraktionsreichweitn",
	"attribute.name.explosion_knockback_resistance": "Explosionsrückstoßwiederstand",
	"attribute.name.fall_damage_multiplier": "Foischonmultiplikator",
	"attribute.name.flying_speed": "Fliaggschwindigkeit",
	"attribute.name.follow_range": "Viechafoigedistanz",
	"attribute.name.friction_modifier": "Reibungsfaktor",
	...
	"attribute.name.generic.block_interaction_range": "Block-Interaktionsreichweitn",
	"attribute.name.generic.burning_time": "Brennzeid",
	"attribute.name.generic.entity_interaction_range": "Viech-Interaktionsreichweitn",
	"attribute.name.generic.explosion_knockback_resistance": "Explosionsrückstoßwiederstandkraft",
	"attribute.name.generic.fall_damage_multiplier": "Foischadn‐Multiplikatoa",
	"attribute.name.generic.flying_speed": "Fluggschwindigkeit",
	"attribute.name.generic.follow_range": "Viecha-Folgedistanz",
	"attribute.name.generic.gravity": "Schwaakroft",
	"attribute.name.generic.jump_strength": "Sprungstärkn",
	...
	"attribute.name.generic.safe_fall_distance": "Sichere Fallheing",
	"attribute.name.generic.scale": "Greßn",
	"attribute.name.generic.step_height": "Schrittheng",
	"attribute.name.generic.water_movement_efficiency": "Wasserbewegungseffizienz",
	"attribute.name.gravity": "Schwerkraft",
	"attribute.name.horse.jump_strength": "Pferdlsprungstärke",
	"attribute.name.jump_strength": "Sprungstärkn",
	"attribute.name.knockback_resistance": "Rückstoßwiedastand",
	"attribute.name.luck": "Glück",
	"attribute.name.max_absorption": "Greßste Absorption",
	"attribute.name.max_health": "Greßte Gsundheit",
	...
	"attribute.name.oxygen_bonus": "Sauastoffbonus",
	"attribute.name.player.block_break_speed": "Blockabbaugschwindigkeit",
	"attribute.name.player.block_interaction_range": "Block-Interaktionsreichweitn",
	"attribute.name.player.entity_interaction_range": "Viech-Interaktionsreichweitn",
	"attribute.name.player.mining_efficiency": "Abbaueffizienz",
	"attribute.name.player.sneaking_speed": "Schleichgschwindigkeit",
	"attribute.name.player.submerged_mining_speed": "Unterwasserabbaugschwindigkeit",
	"attribute.name.player.sweeping_damage_ratio": "Gschwunganaschadnvaheitnis",
	"attribute.name.safe_fall_distance": "Sichere Fallheng",
	"attribute.name.scale": "Greß",
	"attribute.name.sneaking_speed": "Schleichgschwindigkeit",
	"attribute.name.spawn_reinforcements": "Zombie-Vastärkung",
	"attribute.name.step_height": "Schrittheng",
	"attribute.name.submerged_mining_speed": "Untawasserabbaugschwindigkeit",
	"attribute.name.sweeping_damage_ratio": "Schwungschonvaheitnis",
	"attribute.name.tempt_range": "Viecha-Anlockentfernung",
	"attribute.name.water_movement_efficiency": "Wassa-Bewegungseffizienz",
	"attribute.name.waypoint_receive_range": "Wegpunktempfangsreichweitn",
	"attribute.name.waypoint_transmit_range": "Wegpunktübertragungsreichweitn",
	...
	"biome.minecraft.pale_garden": "Heia Hain",
	...
	"biome.minecraft.sulfur_caves": "Schwefelhöhlen",
	...
	"block.minecraft.acacia_shelf": "Akazienhoizreagl",
	...
	"block.minecraft.bamboo_shelf": "Bambusreagl",
	...
	"block.minecraft.banner.flow.black": "Schwoaza Fluß",
	"block.minecraft.banner.flow.blue": "Blaua Fluß",
	"block.minecraft.banner.flow.brown": "Brauna Fluß",
	"block.minecraft.banner.flow.cyan": "Türkisa Fluß",
	"block.minecraft.banner.flow.gray": "Graua Fluß",
	"block.minecraft.banner.flow.green": "Greana Fluß",
	"block.minecraft.banner.flow.light_blue": "Höiblaua Fluß",
	"block.minecraft.banner.flow.light_gray": "Höigraua Fluß",
	"block.minecraft.banner.flow.lime": "Giftgreana Fluß",
	"block.minecraft.banner.flow.magenta": "Magenta Fluß",
	"block.minecraft.banner.flow.orange": "Oranga Fluß",
	"block.minecraft.banner.flow.pink": "Rosa Fluß",
	"block.minecraft.banner.flow.purple": "Violetta Fluß",
	"block.minecraft.banner.flow.red": "Rouda Fluß",
	"block.minecraft.banner.flow.white": "Weißa Fluß",
	"block.minecraft.banner.flow.yellow": "Gëiba Fluß",
	...
	"block.minecraft.banner.guster.black": "Schwoaza Windstoußa",
	"block.minecraft.banner.guster.blue": "Blaua Windstoußa",
	"block.minecraft.banner.guster.brown": "Brauna Windstoußa",
	"block.minecraft.banner.guster.cyan": "Türkisa Windstoußa",
	"block.minecraft.banner.guster.gray": "Graua Windstoußa",
	"block.minecraft.banner.guster.green": "Greana Windstoußa",
	"block.minecraft.banner.guster.light_blue": "Höiblaua Windstoußa",
	"block.minecraft.banner.guster.light_gray": "Höigraua Windstoußa",
	"block.minecraft.banner.guster.lime": "Giftgreana Windstoußa",
	"block.minecraft.banner.guster.magenta": "Magneta Windstoußa",
	"block.minecraft.banner.guster.orange": "Oranga Windstoußa",
	"block.minecraft.banner.guster.pink": "Rosa Windstoußa",
	"block.minecraft.banner.guster.purple": "Violetta Windstoußa",
	"block.minecraft.banner.guster.red": "Rouda Windstoußa",
	"block.minecraft.banner.guster.white": "Weißa Windstoußa",
	"block.minecraft.banner.guster.yellow": "Gëiba Winstoußa",
	...
	"block.minecraft.birch_shelf": "Birknhoizreagl",
	...
	"block.minecraft.cactus_flower": "Kaktusblüte",
	...
	"block.minecraft.cherry_shelf": "Kirschhoizreagl",
	...
	"block.minecraft.chiseled_cinnabar": "Gemeißelter Zinnober",
	"block.minecraft.chiseled_copper": "Gmeißelta Kupfablock",
	...
	"block.minecraft.chiseled_resin_bricks": "Gmeißelte Harzziegel",
	"block.minecraft.chiseled_sandstone": "Gemeißelta Sondstoa",
	"block.minecraft.chiseled_stone_bricks": "G’meißlte Stoazigl",
	"block.minecraft.chiseled_sulfur": "Gemeißelter Schwefelblock",
	"block.minecraft.chiseled_tuff": "Gmeißelta Tuffstoa",
	"block.minecraft.chiseled_tuff_bricks": "Gmeißelte Tuffziagl",
	...
	"block.minecraft.cinnabar_brick_stairs": "Zinnoberziegeltreppe",
	"block.minecraft.cinnabar_brick_wall": "Zinnoberziegelmauer",
	"block.minecraft.cinnabar_bricks": "Zinnoberziegel",
	"block.minecraft.cinnabar_slab": "Zinnoberstufe",
	"block.minecraft.cinnabar_stairs": "Zinnobertreppe",
	"block.minecraft.cinnabar_wall": "Zinnobermauer",
	"block.minecraft.clay": "Ton",
	"block.minecraft.closed_eyeblossom": "Gschlossane Augnbliatn",
	...
	"block.minecraft.copper_bars": "Kupfagitter",
	"block.minecraft.copper_block": "Kupfablock",
	"block.minecraft.copper_bulb": "Kupfalampn",
	"block.minecraft.copper_chain": "Kupfakettn",
	"block.minecraft.copper_chest": "Kupfakistn",
	"block.minecraft.copper_door": "Kupfadia",
	"block.minecraft.copper_golem_statue": "Kupfagolemstatü",
	"block.minecraft.copper_grate": "Kupfagitter",
	"block.minecraft.copper_lantern": "Kupfalatarn",
	"block.minecraft.copper_ore": "Kupfaerz",
	"block.minecraft.copper_torch": "Kupfafackl",
	"block.minecraft.copper_trapdoor": "Kupfaklappdierl",
	"block.minecraft.copper_wall_torch": "Kupfawandfackl",
	...
	"block.minecraft.crafter": "Handwerka",
	"block.minecraft.crafting_table": "Werkbank",
	"block.minecraft.creaking_heart": "Krachads Herz",
	...
	"block.minecraft.crimson_shelf": "Karmesinhoizreagl",
	...
	"block.minecraft.dark_oak_shelf": "Schwoarzeichnhoizreagl",
	...
	"block.minecraft.dried_ghast": "Ausdruckada Ghast",
	...
	"block.minecraft.exposed_chiseled_copper": "Oglafana Gmeißelta Kupfablock",
	"block.minecraft.exposed_copper": "Angelaufena Kupfablock",
	"block.minecraft.exposed_copper_bars": "Aglaufens Kupfagitter",
	"block.minecraft.exposed_copper_bulb": "Oglafane Kupfalampn",
	"block.minecraft.exposed_copper_chain": "Aglaufene Kupfakettn",
	"block.minecraft.exposed_copper_chest": "Aglaufene Kupfakistn",
	"block.minecraft.exposed_copper_door": "Oglafane Kupfadia",
	"block.minecraft.exposed_copper_golem_statue": "Aglaufene Kupfagolemstatue",
	"block.minecraft.exposed_copper_grate": "Oglafans Kupfagitter",
	"block.minecraft.exposed_copper_lantern": "Aglaufene Kupfalatarn",
	"block.minecraft.exposed_copper_trapdoor": "Oglafans Kupfaklapodierl",
	...
	"block.minecraft.exposed_lightning_rod": "Aglaufener Blitzobleida",
	...
	"block.minecraft.firefly_bush": "Glüweamal Busch",
	...
	"block.minecraft.golden_dandelion": "Goidlöwnzahn",
	...
	"block.minecraft.heavy_core": "Schwara Kean",
	...
	"block.minecraft.iron_chain": "Eisnkettn",
	...
	"block.minecraft.jungle_shelf": "Tropnhoizreagl",
	...
	"block.minecraft.leaf_litter": "Laban",
	...
	"block.minecraft.mangrove_shelf": "Mangrovenhoizreagl",
	...
	"block.minecraft.oak_shelf": "Eichnhoizreagl",
	...
	"block.minecraft.open_eyeblossom": "Offane Augnbliatn",
	...
	"block.minecraft.oxidized_chiseled_copper": "Oxidierta Gmeißelta Kupfablock",
	"block.minecraft.oxidized_copper": "Oxidiata Kupfablock",
	"block.minecraft.oxidized_copper_bars": "Oxidiats Kupfagitter",
	"block.minecraft.oxidized_copper_bulb": "Oxidiate Kupfalampn",
	"block.minecraft.oxidized_copper_chain": "Oxidiate Kupfakettn",
	"block.minecraft.oxidized_copper_chest": "Oxidiate Kupfakistn",
	"block.minecraft.oxidized_copper_door": "Oxidierte Kupfadia",
	"block.minecraft.oxidized_copper_golem_statue": "Oxidiate Kupfergolemstatü",
	"block.minecraft.oxidized_copper_grate": "Oxidierts Kupfagitter",
	"block.minecraft.oxidized_copper_lantern": "Oxidiate Kupfalatarn",
	"block.minecraft.oxidized_copper_trapdoor": "Oxidierts Kupfaklappdierl",
	...
	"block.minecraft.oxidized_lightning_rod": "Oxidiater Blitzobleida",
	"block.minecraft.packed_ice": "Packeis",
	"block.minecraft.packed_mud": "Fester Matsch",
	"block.minecraft.pale_hanging_moss": "Heis Hängads Moos",
	"block.minecraft.pale_moss_block": "Heia Moosblock",
	"block.minecraft.pale_moss_carpet": "Heia Mossteppich",
	"block.minecraft.pale_oak_button": "Heia Oachnknopf",
	"block.minecraft.pale_oak_door": "Heie Oachndia",
	"block.minecraft.pale_oak_fence": "Heia Oachnzaun",
	"block.minecraft.pale_oak_fence_gate": "Heis Ochnzaundial",
	"block.minecraft.pale_oak_hanging_sign": "Heis Oachnhoizhängadsschuidl",
	"block.minecraft.pale_oak_leaves": "Heis Oachnlaub",
	"block.minecraft.pale_oak_log": "Heia Oachnstamm",
	"block.minecraft.pale_oak_planks": "Heie Oachnbretta",
	"block.minecraft.pale_oak_pressure_plate": "Heie Oachndruckplattn",
	"block.minecraft.pale_oak_sapling": "Heia Oachnzweigerl",
	"block.minecraft.pale_oak_shelf": "Blass Eichnhoizreagl",
	"block.minecraft.pale_oak_sign": "Heis Oachnschuidl",
	"block.minecraft.pale_oak_slab": "Heia Oachnhoizstufe",
	"block.minecraft.pale_oak_stairs": "Heia Oachnhoizschdiang",
	"block.minecraft.pale_oak_trapdoor": "Heia Oachnhoizklappdierl",
	"block.minecraft.pale_oak_wall_hanging_sign": "Heia Oachnhoizhängadsschuidl",
	"block.minecraft.pale_oak_wall_sign": "Heia Oachnhoizschuidl",
	"block.minecraft.pale_oak_wood": "Heia Oachnhoiz",
	...
	"block.minecraft.polished_cinnabar": "Polierter Zinnober",
	"block.minecraft.polished_cinnabar_slab": "Polierte Zinnoberstufe",
	"block.minecraft.polished_cinnabar_stairs": "Polierte Zinnobertreppe",
	"block.minecraft.polished_cinnabar_wall": "Polierte Zinnobermauer",
	...
	"block.minecraft.polished_sulfur": "Polierter Schwefelblock",
	"block.minecraft.polished_sulfur_slab": "Polierte Schwefelstufe",
	"block.minecraft.polished_sulfur_stairs": "Polierte Schwefeltreppe",
	"block.minecraft.polished_sulfur_wall": "Polierte Schwefelmauer",
	"block.minecraft.polished_tuff": "Polierta Tuffstoa",
	"block.minecraft.polished_tuff_slab": "Polierte Tuffstufn",
	"block.minecraft.polished_tuff_stairs": "Polierte Tuffstiagn",
	"block.minecraft.polished_tuff_wall": "Polierte Tuffmauer",
	"block.minecraft.poppy": "Mohn",
	"block.minecraft.potatoes": "Eadäpfe",
	"block.minecraft.potent_sulfur": "Aktiver Schwefel",
	...
	"block.minecraft.potted_closed_eyeblossom": "Eipflanzte gschlossane Augnbleame",
	...
	"block.minecraft.potted_golden_dandelion": "Eidopfta Goidlöwnzahn",
	...
	"block.minecraft.potted_open_eyeblossom": "Eipflanzte offane Augnbleame",
	"block.minecraft.potted_orange_tulip": "Eidopfte orange Tulpe",
	"block.minecraft.potted_oxeye_daisy": "Eidopfte Margerite",
	"block.minecraft.potted_pale_oak_sapling": "Eipflanzta Heia Oachnsetzling",
	...
	"block.minecraft.resin_brick_slab": "Harzzieglstufe",
	"block.minecraft.resin_brick_stairs": "Harzzieglschdiang",
	"block.minecraft.resin_brick_wall": "Harzzieglmaua",
	"block.minecraft.resin_bricks": "Harzziagl",
	"block.minecraft.resin_clump": "Harzbrockn",
	...
	"block.minecraft.short_dry_grass": "Druckans Gros",
	"block.minecraft.short_grass": "Kurzs Gros",
	...
	"block.minecraft.spruce_shelf": "Fichtnhoizreagl",
	...
	"block.minecraft.stripped_pale_oak_log": "Heia Oachnhoizstamm",
	"block.minecraft.stripped_pale_oak_wood": "Entrindeter Heia Oachnhoizstamm",
	...
	"block.minecraft.sulfur": "Schwefelblock",
	"block.minecraft.sulfur_brick_slab": "Schwefelziegelstufe",
	"block.minecraft.sulfur_brick_stairs": "Schwefelziegeltreppe",
	"block.minecraft.sulfur_brick_wall": "Schwefelziegelmauer",
	"block.minecraft.sulfur_bricks": "Schwefelziegel",
	"block.minecraft.sulfur_slab": "Schwefelstufe",
	"block.minecraft.sulfur_spike": "Schwefelzapfen",
	"block.minecraft.sulfur_stairs": "Schwefeltreppe",
	"block.minecraft.sulfur_wall": "Schwefelmauer",
	...
	"block.minecraft.tall_dry_grass": "Hohes druckans Gros",
	...
	"block.minecraft.tnt.disabled": "TNT-Explosionen san ausgschoitn",
	...
	"block.minecraft.tuff_brick_slab": "Tuffziaglstufn",
	"block.minecraft.tuff_brick_stairs": "Tuffziaglstiagn",
	"block.minecraft.tuff_brick_wall": "Tuffziaglmauer",
	"block.minecraft.tuff_bricks": "Tuffziagl",
	"block.minecraft.tuff_slab": "Tuffstufn",
	"block.minecraft.tuff_stairs": "Tuffstiagn",
	"block.minecraft.tuff_wall": "Tuffmauer",
	...
	"block.minecraft.warped_shelf": "Wirrhoizreagl",
	...
	"block.minecraft.waxed_chiseled_copper": "Gwachsta Gmeißelta Kupfablock",
	"block.minecraft.waxed_copper_bars": "Gwachsts Kupfagitter",
	"block.minecraft.waxed_copper_block": "G'wachsta Kupfablock",
	"block.minecraft.waxed_copper_bulb": "Gwachste Kupfalampn",
	"block.minecraft.waxed_copper_chain": "Gwachste Kupfakettn",
	"block.minecraft.waxed_copper_chest": "Gwachste Kupfakistn",
	"block.minecraft.waxed_copper_door": "Gwachste Kupfadia",
	"block.minecraft.waxed_copper_golem_statue": "Gwachste Kupfagolemstatü",
	"block.minecraft.waxed_copper_grate": "Gwachsts Kupfagitter",
	"block.minecraft.waxed_copper_lantern": "Gwachste Kupfalatarn",
	"block.minecraft.waxed_copper_trapdoor": "Gwachste Kupfaklappdierl",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Gwachsta Oglafana Gmeißelta Kupfablock",
	"block.minecraft.waxed_exposed_copper": "G'wachsta ang'laufena Kupfablock",
	"block.minecraft.waxed_exposed_copper_bars": "Gwachsts Aglaufenes Kupfagitter",
	"block.minecraft.waxed_exposed_copper_bulb": "Gwachste Oglafane Kupfalampn",
	"block.minecraft.waxed_exposed_copper_chain": "Gwachste Aglaufene Kupfakettn",
	"block.minecraft.waxed_exposed_copper_chest": "Gwachste Aglaufene Kupfakistn",
	"block.minecraft.waxed_exposed_copper_door": "Gwachste Oglafane Kupfadia",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Gwachste Aglaufene Kupfagolemstatue",
	"block.minecraft.waxed_exposed_copper_grate": "Gwachsts Oglafans Kupfagitter",
	"block.minecraft.waxed_exposed_copper_lantern": "Gwachste Aglaufene Kufpalatarn",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Gwachste Oglafane Kupfaklappdierl",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Gwachster Aglaufener Blitzobleida",
	"block.minecraft.waxed_lightning_rod": "Gwachster Blitzobleida",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Gwachsta Oxidierta Gmeißelta Kupfablock",
	"block.minecraft.waxed_oxidized_copper": "G'wachsta oxidiata Kupfablock",
	"block.minecraft.waxed_oxidized_copper_bars": "Gwachstes Oxidiats Kupfagitter",
	"block.minecraft.waxed_oxidized_copper_bulb": "Gwachste Oxidierte Kupfalampn",
	"block.minecraft.waxed_oxidized_copper_chain": "Gwachste Oxidiate Kupfakettn",
	"block.minecraft.waxed_oxidized_copper_chest": "Gwachste Oxidiate Kupfakistn",
	"block.minecraft.waxed_oxidized_copper_door": "Gwachste Oxidierte Kupfalampn",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Gwachste Oxidiate Kupfagolemstatue",
	"block.minecraft.waxed_oxidized_copper_grate": "Gwachsts Oxidierts Kupfagitter",
	"block.minecraft.waxed_oxidized_copper_lantern": "Gwachste Oxidiate Kupfalatarn",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Gwachste Oxidierte Kupfaklappdierl",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Gwachster Oxidiater Blitzobleida",
	"block.minecraft.waxed_weathered_chiseled_copper": "Gwachsta Verwitterta Gmeißelta Kupfablock",
	"block.minecraft.waxed_weathered_copper": "G'wachsta verwitterta Kupfablock",
	"block.minecraft.waxed_weathered_copper_bars": "Gwachsts Verwittats Kupfagitter",
	"block.minecraft.waxed_weathered_copper_bulb": "Gwachste Verwitterte Kupfalampn",
	"block.minecraft.waxed_weathered_copper_chain": "Gwachste Verwittate Kupfakettn",
	"block.minecraft.waxed_weathered_copper_chest": "Gwachste Verwittate Kupfakistn",
	"block.minecraft.waxed_weathered_copper_door": "Gwachste Verwitterte Kupfadia",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Gwachste Verwittate Kupfagolemstatue",
	"block.minecraft.waxed_weathered_copper_grate": "Gwachsts Verwitterts Kupfagitter",
	"block.minecraft.waxed_weathered_copper_lantern": "Gwachste Verwittate Kupfalatarn",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Gwachsts Verwitterts Kupfaklappdierl",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Gwachster Verwittater Blitzobleida",
	"block.minecraft.weathered_chiseled_copper": "Verwitterta Gmeißelta Kupfablock",
	"block.minecraft.weathered_copper": "Verwitterta Kupfablock",
	"block.minecraft.weathered_copper_bars": "Verwittats Kupfagitter",
	"block.minecraft.weathered_copper_bulb": "Verwitterte Kupfalampn",
	"block.minecraft.weathered_copper_chain": "Verwittate Kupfakettn",
	"block.minecraft.weathered_copper_chest": "Verwittate Kupferkistn",
	"block.minecraft.weathered_copper_door": "Verwittate Kupfadia",
	"block.minecraft.weathered_copper_golem_statue": "Verwittate Kupfagolemstatü",
	"block.minecraft.weathered_copper_grate": "Verwittats Kupfagitter",
	"block.minecraft.weathered_copper_lantern": "Verwittate Kupfalatarn",
	"block.minecraft.weathered_copper_trapdoor": "Verwittats Kupfaklappdierl",
	...
	"block.minecraft.weathered_lightning_rod": "Verwittater Blitzobleida",
	...
	"block.minecraft.wildflowers": "Wuide Bleamal",
	...
	"block.minecraft.yellow_bed": "Gäibs Bett",
	...
	"book.edit.title": "Buachbearbeitungsfenster",
	...
	"book.page_button.next": "Nächste Seitn",
	"book.page_button.previous": "Vorherige Seitn",
	"book.sign.title": "Buachsignierfenster",
	"book.sign.titlebox": "Titel",
	"book.signButton": "Signian",
	"book.view.title": "Buachansichtsfenster",
	"build.spawn_protection": "%s unterliegt dem Schutz des Einstiegsbereichs",
	"build.tooHigh": "De maximale Bauhäh beträgt %s",
	"build.tooLow": "Die minimale Bauhöhe beträgt %s",
	...
	"chat.disabled.invalid_command_signature": "Befehl hod unerwartete oda feiade Befehlsargument-Signaturn.",
	"chat.disabled.invalid_signature": "Da Chat hod a invalide Signatur. Vasuach di nei z vabindn.",
	...
	"chat.disabled.out_of_order_chat": "Chat in da foischn Reohenfoige erhoitn. Hod si dei Systemzeit gändat?",
	"chat.disabled.profile": "Da Chat is duch Kontoeinstellung net erlaubt. Dückst no amol '%s' für a poar Informationen.",
	...
	"chat.queue.tooltip": "Klick, dann kriagst de nächste Nachricht o'zeigt",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "Da Server hod a ungültige Nochricht gschickt.",
	...
	"chat.validation_error": "Chatübaprüfungsfölla",
	"chat_restriction.chat_and_commands_disabled_by_options": "Der Chat ist in den Client‐Einstellungen deaktiviert.",
	"chat_restriction.chat_disabled_by_options": "Der Spielerchat ist in den Client‐Einstellungen deaktiviert.",
	"chat_restriction.chat_disabled_by_options.action": "Chateinstellungen öffnen",
	"chat_restriction.disabled_by_launcher": "Chat wird durch den Launcher eingeschränkt.\n",
	"chat_restriction.disabled_by_profile": "Chat wird durch die Profileinstellungen eingeschränkt.",
	"chat_restriction.disabled_by_profile.action": "Profileinstellungen öffnen",
	"chat_screen.commands_not_allowed": "Senden von Befehlen nicht erlaubt",
	"chat_screen.message": "Zu sendende Nochricht: %s",
	"chat_screen.messages_not_allowed": "Senden von Chatnachrichten nicht erlaubt",
	"chat_screen.restricted": "Der Chat ist eingeschränkt. Klicke auf diese Nachricht für Einzelheiten.",
	"chat_screen.restricted.narration": "Der Chat ist eingeschränkt. Öffne das Einschränkungenfenster in den Weltoptionen.",
	"chat_screen.title": "Chatfensta",
	"chat_screen.usage": "Nochricht eingem und zum Senden de Eingobtaste druggn",
	"chunk.toast.checkLog": "Schau ins Protokoll fia mehr Details",
	"chunk.toast.loadFailure": "Chunk bei %s hod ned glon wern kinna",
	"chunk.toast.lowDiskSpace": "Niedriger Speicherblotz!",
	"chunk.toast.lowDiskSpace.description": "D Weid kannt unta Umständn ned gspeichert wern kinna.",
	"chunk.toast.saveFailure": "Chunk bei %s hod ned gspeichad wern kinna",
	...
	"command.forkLimit": "Maximale Anzahl fo Befehlsramen (%s) erreicht",
	"command.trailing_data": "Nachfolgende Daten gefunden: %s",
	...
	"commands.attribute.base_value.reset.success": "Grundwert für's Attribut %s vom Objekt %s is auf'n Standardwert von %s z'ruckg'setzt woan",
	...
	"commands.banlist.entry.unknown": "(ned bekannt)",
	...
	"commands.bossbar.list.bars.some": "Es is/san %s benutzadefinierte Bossleistn aktiv: %s",
	...
	"commands.clear.test.single": "%s übaeistimmande Sachan bei %s Spielan g'fundn",
	"commands.clone.failed": "Es wurdn koane Blöcke kopiat",
	"commands.clone.overlap": "Quell- und Zuibereich dürfn sich ned übaschneidn",
	"commands.clone.success": "%s Block(Blöcke) san erfoigreich kopiert worn",
	"commands.clone.toobig": "Zu viele Blöcke im ang'gebenen Bereich (maximal %s, ang'geben %s)",
	"commands.damage.invulnerable": "Ziel ko durch agebnen Schadenstyp ned verletzt wern",
	"commands.damage.success": "%s Schodn is auf %s ogwant worn",
	...
	"commands.data.modify.expected_value": "Wert erwoart, '%s' erhaltn",
	"commands.data.modify.invalid_index": "Ungültiga Listnindex: %s",
	"commands.data.modify.invalid_substring": "Unguitige Abschnittsindizes: %s bis %s",
	...
	"commands.datapack.create.already_exists": "Packerl mid Nam '%s' gibts scho",
	"commands.datapack.create.invalid_full_name": "Neier Pack-Name '%s' is ned gültig",
	"commands.datapack.create.invalid_name": "Unguitige Zeichn im nein Packerlnam '%s'",
	"commands.datapack.create.io_failure": "Ko packerl mit Nam '%s' ned erstein, schau ins Protokoll",
	"commands.datapack.create.metadata_encode_failure": "Hod d Metadatn fias Packal mit Nam '%s' hod ned kodiert wern kinna: %s",
	"commands.datapack.create.success": "Neis leers Packal mit Nam '%s' ersteit",
	"commands.datapack.disable.failed": "Datnpaket ‚%s‘ is bereits deaktiviert",
	"commands.datapack.disable.failed.feature": "Packerl '%s' ko ned ausgschoitn wetn, weils Teil vo am aktiven Umschoita is!",
	"commands.datapack.enable.failed": "Datnpaket ‚%s‘ is bereits aktiviert",
	"commands.datapack.enable.failed.no_flags": "As Datnpaket '%s' ko ned aktiviert wern, weil de benötigten Umschoiter für de Weit nrd aktiviert san: %s!",
	...
	"commands.datapack.list.enabled.success": "Es is/san %s Datnpaket(e) aktiviert: %s",
	...
	"commands.debug.function.noReturnRun": "Ablaufafzeichnung ko ned mit \"return run\" verwendet wern",
	"commands.debug.function.success.multiple": "%s Befehl(e) vo %s Funktionen wurd(n) in de Ausgobdatei %s aufzeichnet",
	"commands.debug.function.success.single": "%s Befehl(e) da Funktion ‚%s‘ wurdn in de Ausgobdatei %s aufgzeichnet",
	...
	"commands.dialog.clear.multiple": "Dialog fia %s Spieler wurdn g’löscht",
	"commands.dialog.clear.single": "Dialog fia %s wurd g’löscht",
	"commands.dialog.show.multiple": "Dialog wird %s Spieler o'zeigt",
	"commands.dialog.show.single": "Dialog wird %s o'zeigt",
	...
	"commands.drop.no_loot_table.block": "Objekt %s hod koa Beutetabelle",
	...
	"commands.enchant.failed.entity": "%s is koa gültiga Eintrag fia diesn Befehl",
	...
	"commands.execute.blocks.toobig": "Zfei Blöcke im agebnen Bereich (maximum %s, agem %s)",
	...
	"commands.execute.function.instantiationFailure": "Funktion \"%s\" ko ned ausgwertet wern: %s",
	...
	"commands.fetchprofile.copy_component": "Komponente kopiern",
	"commands.fetchprofile.copy_text": "%s kopiern",
	"commands.fetchprofile.entity.success": "Profil für Objekt ‚%s‘ aufgelöst: %s",
	"commands.fetchprofile.failed_to_serialize": "Profil ließ si ned serialisiern: %s",
	"commands.fetchprofile.give_item": "Gegenstand gebn",
	"commands.fetchprofile.id.failure": "Profil fia ID %s konnt ned aufg’löst wern",
	"commands.fetchprofile.id.success": "Profil fia ID %s wurd aufg’löst: %s",
	"commands.fetchprofile.name.failure": "Profil fia Name %s konnt ned aufg’löst wern",
	"commands.fetchprofile.name.success": "Profil fia Name %s wurd aufg’löst: %s",
	"commands.fetchprofile.no_profile": "Objekt %s hat kein Profil",
	"commands.fetchprofile.summon_mannequin": "Spielerpuppn b'schwörn",
	"commands.fill.failed": "Es wurdn koane Blöcke platziert",
	"commands.fill.success": "%s Block/Blöcke san erfoigreich kopiert worn",
	"commands.fill.toobig": "Zfei Blöcke im agebnen Bereich (maximum %s, agem %s)",
	"commands.fillbiome.success": "Biom zwischen %s, %s, %s und %s, %s, %s festglegt",
	"commands.fillbiome.success.count": "%s Biom‐Eintrag/Einträge zwischen %s, %s, %s und %s, %s, %s festglegt",
	"commands.fillbiome.toobig": "Zfei Blöcke im agebnen Raum (maximum %s, agem %s)",
	...
	"commands.function.error.argument_not_compound": "Argumenttyp %s is ned guitig, erwartet wird a Verbund",
	"commands.function.error.missing_argument": "Argument %[2]s feit füa Funktion %[1]s",
	"commands.function.error.missing_arguments": "Argumente fein für Funktion %s",
	"commands.function.error.parse": "Beim Auswerten vo Makro %s hod Befehl '%s' den Fehler %s verursacht",
	"commands.function.instantiationFailure": "Funktion \"%s\" ko ned ausgwertet wern: %s",
	"commands.function.result": "Funktion \"%s\" hod %s zruckgliefert",
	"commands.function.scheduled.multiple": "Funtionen %s wern ausgführt",
	"commands.function.scheduled.no_functions": "Ko koane Funktionen findn fürn Namen %s",
	"commands.function.scheduled.single": "Füahd Funtion %s aus",
	"commands.function.success.multiple": "%s Befehl(e) vo %s Funktionen san ausgführt worn",
	"commands.function.success.multiple.result": "%s Funktionen ausgführt",
	"commands.function.success.single": "%s Befehl(e) da Funktion ‚%s‘ san augführt worn",
	"commands.function.success.single.result": "Funktion '%[2]s' hod '%[1]s' zruckgliefert",
	...
	"commands.kick.owner.failed": "Da Server Besitzer ko ned aus am LAN-Spui gekickt wern",
	"commands.kick.singleplayer.failed": "In am gschlossenen Oanzlspielaspui ko ned gekickt wern",
	...
	"commands.locate.biome.success": "As näheste %s is bei %s (%s Blöcke weit weg)",
	"commands.locate.poi.not_found": "Es hod in ogmessener Entfernung koa Zielpunkt vom Typ \"%s\" gfunden wern kinna",
	"commands.locate.poi.success": "As näheste %s is bei %s (%s Blöcke weit weg)",
	...
	"commands.perf.stopped": "Leistungsaufzeichnung is nach %s sekundn und %s tick(s) (%s tick(s) pro sekundn) beendet worn",
	...
	"commands.place.jigsaw.failed": "Verbund hod ned generiert wern kinna",
	"commands.place.jigsaw.invalid": "Es gibt koa Vorlag vom Typ \"%s\"",
	"commands.place.jigsaw.success": "Verbund is bei %s, %s, %s generiert worn",
	"commands.place.structure.failed": "Struktur hod ned platziert wern kinna",
	"commands.place.structure.invalid": "Es gibt koa Struktur vom Typ \"%s\"",
	"commands.place.structure.success": "Struktur \"%s\" is bei %s, %s, %s generiert worn",
	"commands.place.template.failed": "Vorlage hod ned platziert wern kinna",
	"commands.place.template.invalid": "Es gibt koa Vorlage mit da id \"%s\"",
	"commands.place.template.success": "Vorlage \"%s\" is bei %s, %s, %s gladen worn",
	...
	"commands.profile_fetch.copy_component": "Komponente kopiern",
	"commands.profile_fetch.failed_to_serialize": "Profil ließ si ned serialisiern: %s",
	"commands.profile_fetch.give_item": "Gegenstand gebn",
	"commands.profile_fetch.id.failure": "Profil fia ID %s konnt ned aufg’löst wern",
	"commands.profile_fetch.id.success": "Profil fia ID %s wurd aufg’löst: %s",
	"commands.profile_fetch.name.failure": "Profil fia Name %s konnt ned aufg’löst wern",
	"commands.profile_fetch.name.success": "Profil fia Name %s wurd aufg’löst: %s",
	...
	"commands.random.error.range_too_large": "Da Bereich vom Zufallswer deaf höchstens 2147483646 sei",
	"commands.random.error.range_too_small": "Da Bereich für den Zufallswert muass mimdestens 2 sei",
	"commands.random.reset.all.success": "%s Zufallsfolge(n) is/san zruckgsetzt worn",
	"commands.random.reset.success": "Zufallsfolge %s is zruckgsetzt worn",
	"commands.random.roll": "%s hod %s gwürfelt (zwischn %s und %s)",
	...
	"commands.ride.already_riding": "%s reitet scho auf %s",
	"commands.ride.dismount.success": "%s hod afghert %s zu reitn",
	"commands.ride.mount.failure.cant_ride_players": "Spiela ko ma ned reitn",
	"commands.ride.mount.failure.generic": "%s hod ned afanga kinna %s zu reitn",
	"commands.ride.mount.failure.loop": "Ma kann des Objekt ned auf es seiber oder auf oan fo seine Passagiere afsteign lossn",
	"commands.ride.mount.failure.wrong_dimension": "Ko ned auf a Objekt in na anderen Dimension aufteign",
	"commands.ride.mount.success": "%s hod ogfanga %s zum reitn",
	"commands.ride.not_riding": "%s fährt in koam Fahrmittl",
	"commands.rotate.success": "%s is draht woan",
	...
	"commands.schedule.cleared.success": "%s Planungen mit id %s sand entfernt worn",
	"commands.schedule.created.function": "Funktion '%s' is in %s tick(s) zur Spuizair %s eiplant worn",
	"commands.schedule.created.tag": "Etikett '%s' wurd in %s Ticks zua Spülzeit %s eiplant",
	"commands.schedule.macro": "Makros können nicht geplant werden",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Automatische Aktualisierung vo da Anzeige is ausgschoitn worn füa Ziel %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Automatische Aktualisierung vo da Anzeige is agschoitn worn füa Ziel %s",
	"commands.scoreboard.objectives.modify.displayname": "Anzeigenama von %s wurde zu %s g'ändert",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Standart-Zahlenformat is zruckgsetzt worn fia Ziel %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Standart-Zahlenformat is gändert worn fia Ziel %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Anzeigenamen vo %s Viecha is in %s san zruckgsetzt worn",
	"commands.scoreboard.players.display.name.clear.success.single": "Anzeigenamen vo %s is in %s san zruckgsetzt worn",
	"commands.scoreboard.players.display.name.set.success.multiple": "Anzeigenamen vo %s Viecha is in %s zu %s gändert worn",
	"commands.scoreboard.players.display.name.set.success.single": "Anzeigenama vo %s Viecha is in %s zu %s gändert woan",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Zahlendarstellung vo %s Viecha %s is zruckgsetzt worn",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Fia %s Zahlendarstellung in %s zruckgsetzt",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Fia %s Sachan in %s as Zahlenformat gändat",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Zahlenformat fia %s in %s gändat",
	...
	"commands.scoreboard.players.list.entity.success": "%s hod %s Punktstand(-stände):",
	"commands.scoreboard.players.list.success": "Da san %s getrackte Objekte: %s",
	...
	"commands.setidletimeout.success": "As Untätigkeitslimit is eatz %s Minute(n)",
	"commands.setidletimeout.success.disabled": "Spiela wern jetz nimma wega Untätigkeit vom Server gschmissn",
	"commands.setworldspawn.failure.not_overworld": "Weitspawn ko nur fia d Oberweit gsetzt wern",
	"commands.setworldspawn.success": "Weydoanstiegspunkt wurde af (%s, %s, %s) [%s] g'setzt",
	"commands.setworldspawn.success.new": "Weltoanstiegspunkt is auf %s, %s, %s [%s, %s] in %s g'setzt worn",
	"commands.spawnpoint.success.multiple": "Oanstiegspunkt vo %[6]s Spielan wurde af (%[1]s, %[2]s, %[3]s) [%[4]s] in %[5]s g'setzt",
	"commands.spawnpoint.success.multiple.new": "Oanstiegspunkt fia %[7]s Spieler is auf %[1]s, %[2]s, %[3]s [%[4]s, %[5]s] in %[6]s g'setzt worn",
	"commands.spawnpoint.success.single": "Oanstiegspunkt vo %[6]s wurde af (%[1]s, %[2]s, %[3]s) [%[4]s] in %[5]s g'setzt",
	"commands.spawnpoint.success.single.new": "Oanstiegspunkt fia %[7]s is auf %[1]s, %[2]s, %[3]s [%[4]s, %[5]s] in %[6]s g'setzt worn",
	"commands.spectate.cannot_spectate": "%s ko ned beobacht wern",
	...
	"commands.spreadplayers.failed.entities": "%s Objekt(e) hod/hom ned um %s, %s verteilt wern kinna (zvei Objekte fürn Platz - versuach höchstns %s zu verteilen)",
	"commands.spreadplayers.failed.invalid.height": "Unmögliche maxHeight %s; du musst scho höh'a als di woituntaseit'n %s angeb'n",
	"commands.spreadplayers.failed.teams": "%s Team(s) hod/hom ned um %s, %s verteilt wern kinna (zvei Objekte fürn Platz - versuach höchstns %s zu verteilen)",
	"commands.spreadplayers.success.entities": "%s Spieler is/san um %s %s mit am durchschnittlichn Abstand vo %s Blöcke verteilt worn",
	"commands.spreadplayers.success.teams": "%s Team(s) is/san um %s, %s mit am durchschnittlichn Abstand vo %s verteilt worn",
	...
	"commands.stopwatch.already_exists": "Stoppuhr '%s' gibt's scho",
	"commands.stopwatch.create.success": "Stoppuhr ‚%s‘ is erstellt worn",
	"commands.stopwatch.does_not_exist": "Stoppuhr '%s' gibt’s ned",
	"commands.stopwatch.query": "Stoppuhr ‚%s‘ laft seit %ss",
	"commands.stopwatch.remove.success": "Stoppuhr '%s' wurd g'löscht",
	"commands.stopwatch.restart.success": "Stoppuhr ‚%s‘ wurd neu g'startet",
	"commands.summon.failed": "Objekt konnte ned erzeugt wern",
	"commands.summon.failed.peaceful": "Monster kennan auf der Schwierigkeit ‚Friedlich‘ ned erzeugt wern",
	...
	"commands.swing.failed.notliving": "Es wurn koane lebendigen Objekte zum Schwinga g'fundn",
	"commands.swing.success.multiple": "%s Objekte wurn dazu bracht, ihre Arm schwinga z'lassn",
	"commands.swing.success.single": "%s wurd dazu bracht, sei Arm schwinga z'lassn",
	...
	"commands.team.empty.success": "%s Mitglied(er) vo Team %s entfernt",
	...
	"commands.team.list.members.success": "Team %s hod %s Mitglied(er): %s",
	"commands.team.list.teams.empty": "Es gibt koane Teams",
	"commands.team.list.teams.success": "Da san %s Team(s): %s",
	...
	"commands.test.batch.starting": "Umgebung %s, Teil %s wird gstartet",
	"commands.test.clear.error.no_tests": "Es san koane Tests zum löschn gfundn worn",
	"commands.test.clear.success": "%s Konstruktion(en) is / san glöscht worn",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Druck draf ums ind Zwischnablag z kopiern",
	"commands.test.create.success": "Testaufbau fia Test %s is ersteit worn",
	"commands.test.error.no_test_containing_pos": "Es ko koa Testinstanz gfundn wern, de %s, %s, %s enthoit",
	"commands.test.error.no_test_instances": "Es san koane Testinstanzn gfundn worn",
	"commands.test.error.non_existant_test": "Test %s konnt ned g'fundn wern",
	"commands.test.error.structure_not_found": "Teststruktur %s konnt ned g'fundn wern",
	"commands.test.error.test_instance_not_found": "Testinstanz-Blockviech hod ned gfundn wern kinna",
	"commands.test.error.test_instance_not_found.position": "Testinstanz-Blockviech hod ned fian Test bei %s, %s, %s gfundn wern kinna",
	"commands.test.error.too_large": "De Gräß von da Struktur deaf ned mea ois %s Blocks in jeder Richtung sei",
	"commands.test.locate.done": "Fertig mid suacha, %s Struktur(en) g'fundn",
	"commands.test.locate.found": "Struktur bei: %s g'fundn (Entfernung: %s)",
	"commands.test.locate.started": "Og'fanga, Teststruckturen zu findn, kon a biss'l dauern...",
	"commands.test.no_tests": "Koane Tests zu macha",
	"commands.test.relative_position": "Position relativ zu %s: %s",
	"commands.test.reset.error.no_tests": "Koane Tests zum z'rucksetzn g'fundn",
	"commands.test.reset.success": "%s Struktur(en) z'ruckg'setzt",
	"commands.test.run.no_tests": "Koane Tests g'fundn",
	"commands.test.run.running": "%s Test(s) is / san ausg'fürd woan...",
	"commands.test.summary": "Spui Test fertig! %s Test(s) san ausg'fürt woan",
	"commands.test.summary.all_required_passed": "Olle erforderlichn Tests b'standn :)",
	"commands.test.summary.failed": "%s erforderliche(r) Test(s) g'scheitert :(",
	"commands.test.summary.optional_failed": "%s optionale(r) Test(s) g'scheitert",
	"commands.tick.query.percentiles": "Perzentile: P50: %s ms, P95: %s ms, P99: %s ms; Stichprobn: %s",
	"commands.tick.query.rate.running": "Zieltickratn: %s pro Sekundn.\nDurchschnittliche Zeit pro Tick: %s ms (Ziel: %s ms)",
	"commands.tick.query.rate.sprinting": "Zieltickratn: %s pro Sekunde (ned berücksichtigt, nur fia d Referenz).\nDurchschnittliche Zeit pro Tick: %s ms",
	"commands.tick.rate.success": "Zieltickratn wird auf %s pro Sekundn gsetzt",
	"commands.tick.sprint.report": "Bschleinigung abgschlossn mot %s Ticks pro Sekundn, oda %s ms pro Tick",
	"commands.tick.sprint.stop.fail": "Grod is koa Tick-Bschleinigung",
	"commands.tick.sprint.stop.success": "Aktuelle Tick-Bschleinigung abbrocha",
	"commands.tick.status.frozen": "Des Spui is eingefrorn",
	"commands.tick.status.lagging": "As Spui laft, ko aba ned mit da Zieltickratn midhoitn",
	"commands.tick.status.running": "Des Spui lafft noamoi",
	"commands.tick.status.sprinting": "As Spui laft beschleinigt",
	"commands.tick.step.fail": "As Spui ko ned fortgschrittn wern - ma muas erst eifriern",
	"commands.tick.step.stop.fail": "Koa Tickfortschreitn grod",
	"commands.tick.step.stop.success": "Aktuellels Tickfortschreitn abbrocha",
	"commands.tick.step.success": "Um %s Tick(s) fortgschrittn",
	"commands.time.no_default_clock": "In da Dimension %s gibt’s koa Standarduhr",
	"commands.time.no_time_marker_found": "Uhr %s hod koa Zeitmarkn %s",
	"commands.time.pause": "Uhr %s o’ghoit’n",
	"commands.time.query": "De aktuelle Zeid is %s",
	"commands.time.query.absolute": "Uhr %s is bei %s Tick(s)",
	"commands.time.query.gametime": "D’Spielzeit hod %s Tick(s)",
	"commands.time.query.timeline": "Zeitachs’n %s is bei %s Tick(s)",
	"commands.time.query.timeline.repetitions": "Zeitachs'n %s wurd %s-moi durchlafa",
	"commands.time.rate": "Weltuhr ‚%s‘ läuft nun mit %s‐facher Geschwindigkeit",
	"commands.time.resume": "Uhr %s weiterg’lafa",
	"commands.time.set": "Zeid wurde af %s g'setzt",
	"commands.time.set.absolute": "%s auf %s Tick(s) g’setzt",
	"commands.time.set.time_marker": "%s auf d’Zeitmarke %s g’setzt",
	"commands.time.wrong_timeline_for_clock": "Uhr %s unterstützt d’Zeitachs’n %s ned",
	...
	"commands.transfer.error.no_players": "Es muas mindestns oa Spiela zum übertrong ogem wern",
	"commands.transfer.success.multiple": "%s Spiela wern zu %s:%s übatrong",
	"commands.transfer.success.single": "%s wird zu %s:%s übatrong",
	...
	"commands.version.header": "Serverversionsinformation:",
	...
	"commands.waypoint.list.empty": "Koane Wegpunkte in %s",
	"commands.waypoint.list.success": "%s Wegpunkt(e) in %s: %s",
	"commands.waypoint.modify.color": "D Farb vom Wegpunkt is etz %s",
	"commands.waypoint.modify.color.reset": "Farb vom Wegpunkt zruckgsetzt",
	"commands.waypoint.modify.style": "Aussehen vom Wegpunkt gändat",
	...
	"commands.whitelist.list": "Es gibt %s Spiela auf da Whitelist: %s",
	...
	"commands.worldborder.damage.buffer.success": "D Schadensschutzzone um d Weltgrenze is auf %s Block/Blöcke gsetzt worn",
	"commands.worldborder.get": "D Weltgrenze is im Moment %s Block/Blöcke weit",
	...
	"commands.worldborder.set.immediate": "Weltgrenze is auf %s Block/Blöcke weit gsetzt worn",
	"commands.worldborder.set.shrink": "Weltgrenze wird üba %[2]s Sekunde(n) auf %[2]s Block/Blöcke verkleanad",
	...
	"commands.worldborder.warning.distance.success": "Da Warnbereich um d Weltgrenze is auf %s Block/Blöcke gsetzt worn",
	"commands.worldborder.warning.time.failed": "Nichts hot sich g'ändat, de Warnzeid da Weydbarriere hot bereits diesn Wert",
	"commands.worldborder.warning.time.success": "Weltgrenzenwarnzeit is auf %s Sekund(e)n gsetzt worn",
	...
	"connect.failed.transfer": "Vabindung beim übatrong aufn Server abbrocha",
	...
	"connect.reconfiging": "Nei konfigurieren...",
	"connect.reconfiguring": "Nei konfigurieren...",
	"connect.transferring": "Übatragung augfn neien Server...",
	"container.barrel": "Fassl",
	"container.beacon": "Leichtfeia",
	"container.beehive.bees": "Bienen: %s/%s",
	"container.beehive.honey": "Honig: %s/%s",
	"container.blast_furnace": "Schmeizofn",
	"container.brewing": "Braustand",
	"container.cartography_table": "Koatndisch",
	"container.chest": "Kistn",
	"container.chestDouble": "Große Truhe",
	"container.crafter": "Handweaksmaschiin",
	...
	"container.shulkerBox": "Shulker-Kistn",
	...
	"container.upgrade.error_tooltip": "Gegenstand ko so ned aufgwertet wern",
	"container.upgrade.missing_template_tooltip": "Schmiedevorlag dazua doa",
	"controls.keybinds": "Tastnbelegung...",
	"controls.keybinds.duplicateKeybinds": "De Taste wird a für %s verwendet",
	...
	"createWorld.customize.buffet.search": "Suachn...",
	...
	"createWorld.tab.more.title": "Mehra",
	...
	"dataPack.bundle.description": "Aktiviert as experimentelle Bündl",
	"dataPack.bundle.name": "Bündl",
	"dataPack.locator_bar.description": "Zoagt im Mehrspielermodus d Richtung vo andane Spieler o",
	"dataPack.locator_bar.name": "Ortungsleistn",
	"dataPack.minecart_improvements.description": "Verbesserungen fia Loren",
	"dataPack.minecart_improvements.name": "Lorenvabesserungen",
	"dataPack.redstone_experiments.description": "Experimentelle Redstoneändarungen",
	"dataPack.redstone_experiments.name": "Redstone-Experimente",
	"dataPack.title": "Datnpakete aswöln",
	"dataPack.trade_rebalance.description": "Überorbadete Angebote füa Doafbewohner",
	"dataPack.trade_rebalance.name": "Neigwichtung vom Doafbewohner Handel",
	"dataPack.update_1_20.description": "Neie Spuielemente und Inhalte füa Minecraft 1.20",
	"dataPack.update_1_20.name": "Aktualisierung 1.20",
	"dataPack.update_1_21.description": "Neue Spuielemente und Inhalte fia Mincraft 1.21",
	...
	"dataPack.winter_drop.description": "Neie Spuielemente und Zeigs fian Winter-Drop",
	"dataPack.winter_drop.name": "Winter-Drop",
	"datapackFailure.safeMode": "Abg'sicherta Modus",
	"datapackFailure.safeMode.failed.description": "De Weit beinhoit unguitige oder beschädigte Speichadatn.",
	"datapackFailure.safeMode.failed.title": "Lodn der Weit im abgsicherten Modus fehlgschlong.",
	"datapackFailure.title": "Fehler in de derzeitig ausgwählten Datnpaketn hom de Weit davo abghoiten zu lon.\nDu kost entweder versuacha sie nur mit dem Vanilla-Datnpaket zu lon (\"abgsicherter Modus\"), oder zum Hauptmenü zrückgeh und es per Hand richtn.",
	...
	"death.attack.dragonBreath": "%[1]s is im Drachnatem gröstet worn",
	"death.attack.dragonBreath.player": "%[1]s is vo %[2]s im Drachnatem gröstet worn",
	...
	"death.attack.genericKill": "%[1]s is getötet worn",
	"death.attack.genericKill.player": "%[1]s is während am Kämpfen mit %[2]s getötet worn",
	"death.attack.hotFloor": "%[1]s hot rausgfunden, das da Bodn Lava is",
	"death.attack.hotFloor.player": "%[1]s is wega %[2]s in d Gfahrenzone grotn",
	...
	"death.attack.mace_smash": "%[1]s is vo %[2]s zamdo worn",
	"death.attack.mace_smash.item": "%[1]s is vo %[2]s mit %[3]s zam do worn",
	"death.attack.magic": "%[1]s wurde duach Magie gedödet",
	"death.attack.magic.player": "%[1]s is af da Flucht vo %[2]s wegen Magie gstorbn",
	"death.attack.message_too_long": "Leida is de Meldung zlang um s ganz zu liefern. Do is a verkürzte Version: %s",
	...
	"death.attack.onFire.item": "%[1]s is während am Kampf mit %[2]s, hod %[3]s in da Hand, zu am Heifal Asche verbrennt",
	...
	"death.attack.outsideBorder": "%[1]s hod die Grenzn da Weit verlassn",
	"death.attack.outsideBorder.player": "%[1]s hod während am Kampf mit %[2]s die Grenzn da Weit verlassn",
	"death.attack.player": "%[1]s is vo %[2]s erschlogn worn",
	"death.attack.player.item": "%[1]s is vo %[2]s mit %[3]s erschlogn worn",
	"death.attack.sonic_boom": "%[1]s is vo schallgeladenem Gekreische ausglöscht worn",
	"death.attack.sonic_boom.item": "%[1]s is vo schallgeladenem Gekreische ausglöscht worn, während am Versuch %[2]s, mit %[3]s in da Hend, z entkemma",
	"death.attack.sonic_boom.player": "%[1]s is vo schallgeladenem Gekreische ausglöscht worn, während am Versuch %[2]s z entkemma",
	"death.attack.spear": "%[1]s wurd vo %[2]s aufg’spießt",
	"death.attack.spear.item": "%[1]s wurd vo %[2]s mit %[3]s aufg’spießt",
	...
	"death.attack.witherSkull.item": "%[1]s is vo %[2]s mit %[3]s mit am Schädl daschossn worn",
	...
	"deathScreen.score.value": "Spuistand: %s",
	...
	"debug.crash.message.rebindable": "%s + %s san g’druckt. Des Spui stürzt ab, wenn’s ned losg’lassen wird.",
	"debug.crash.warning": "Absturz in %s …",
	"debug.creative_spectator.error": "Ko Spuimodus ned wechseln; koa Berechtigung",
	"debug.creative_spectator.help": "F3 + N = Zwischn vorherigm Spuimodus und Zuschauamodus wechsln",
	"debug.dump_dynamic_textures": "Dynamische Texturen in %s gspeichert",
	"debug.dump_dynamic_textures.help": "F3 +S = Dynamische Texturen ausgem",
	"debug.entry.always": "Imma",
	"debug.entry.currently.alwaysOn": "%s: Grod imma an",
	"debug.entry.currently.inF3": "%s: Grod nua in F3",
	"debug.entry.currently.inOverlay": "%s: Grod nua im Debug-Overlay",
	"debug.entry.currently.never": "%s: Grod aus",
	...
	"debug.options.category.text": "Text auf da Debug-Anzeig",
	"debug.options.help": "F3 + F6 = Debug-Optionen bearbeitn",
	"debug.options.notAllowed.tooltip": "Ned z’seng, wenn Debug-Info reduziert is",
	"debug.options.profile.default": "Standardprofil",
	"debug.options.profile.performance": "Leistungsprofil",
	"debug.options.search": "Suachn...",
	"debug.options.title": "Debug‐Optionen",
	"debug.options.warning": "De Optionen san nua zum Test’n. Sie kennan dein Rechner verlangsam’n, des Spui abstürzn lassn oder and’re unerwartete Neb’nwirkungen hob’n.",
	...
	"debug.profiling.start.rebindable": "Debug-Aufzeichnung wurd fia %s Sekundn g'startet. Nutz %s + %s, um’s früher stopp’n z'lassn",
	...
	"debug.version.header": "Clientversionsinfo:",
	"debug.version.help": "F3 + V = Clientversionsinfo",
	...
	"disconnect.ignoring_status_request": "Statusanfrage wird ignoriert",
	...
	"disconnect.packetError": "Netzweakprotokollfehla",
	"disconnect.spam": "Rausgeworfn wegn Spamming",
	"disconnect.timeout": "Zeidübaschreitung",
	"disconnect.transfer": "Auf an andan Server übatrong",
	"disconnect.unknownHost": "Unbekonnta Serva",
	"download.pack.failed": "%s von %s Packerl hom ned obaglon wern kinna",
	"download.pack.progress.bytes": "Fortschritt: %s (Gsamtgreß ned bekannt)",
	"download.pack.progress.percent": "Fortschritt: %s%%",
	"download.pack.title": "Ressourcenpaket %s/%s wiad obaglon",
	"editGamerule.default": "Standard: %s",
	"editGamerule.inGame.button": "Spielregeln bearbeit’n...",
	"editGamerule.inGame.disabled.tooltip": "De Spielregeln kennan nua Operatoren ändern.",
	"editGamerule.inGame.discardChanges.message": "Bist da sicher, dass’d de no offenen Änderunga wegschmeißn mogst?",
	"editGamerule.inGame.discardChanges.title": "Änderungen der Spielregeln",
	"editGamerule.inGame.downloadingGamerules": "Spielregeln werden abgerufen …",
	...
	"effect.minecraft.health_boost": "Gsundheids-Boost",
	"effect.minecraft.hero_of_the_village": "Dorfhäid",
	"effect.minecraft.hunger": "Hunger",
	"effect.minecraft.infested": "Befoin",
	...
	"effect.minecraft.oozing": "Rotzn",
	"effect.minecraft.poison": "Vergiftung",
	"effect.minecraft.raid_omen": "Kriagszeichn",
	...
	"effect.minecraft.trial_omen": "Priafungszeichn",
	"effect.minecraft.unluck": "Pech",
	"effect.minecraft.water_breathing": "Unterwossaatmung",
	"effect.minecraft.weakness": "Schwäche",
	"effect.minecraft.weaving": "Spinnad",
	"effect.minecraft.wind_charged": "Afblosn",
	...
	"enchantment.minecraft.breach": "Duachbruch",
	"enchantment.minecraft.channeling": "Entladung",
	"enchantment.minecraft.density": "Schwarigkeit",
	...
	"enchantment.minecraft.lunge": "Ausfoischritt",
	...
	"enchantment.minecraft.sweeping_edge": "Schwingarei",
	...
	"enchantment.minecraft.wind_burst": "Liftal",
	"entity.minecraft.acacia_boat": "Akazien Bood",
	"entity.minecraft.acacia_chest_boat": "Akazien Bood mid Kistn",
	"entity.minecraft.allay": "Huifsgoast",
	"entity.minecraft.area_effect_cloud": "Partiklwoike",
	"entity.minecraft.armadillo": "Giatltier",
	"entity.minecraft.armor_stand": "Rüstungsstända",
	"entity.minecraft.arrow": "Pfeil",
	"entity.minecraft.axolotl": "Axolotl",
	"entity.minecraft.bamboo_chest_raft": "Bambus-Kistnfloß",
	"entity.minecraft.bamboo_raft": "Bambus-Floß",
	"entity.minecraft.bat": "Fledermaus",
	"entity.minecraft.bee": "Imp",
	"entity.minecraft.birch_boat": "Birkn Bood",
	"entity.minecraft.birch_chest_boat": "Birkn Bood mid Kistn",
	"entity.minecraft.blaze": "Lohe",
	"entity.minecraft.block_display": "Blockdarstella",
	"entity.minecraft.boat": "Bood",
	"entity.minecraft.bogged": "Moorleichn",
	"entity.minecraft.breeze": "Wirblwind",
	"entity.minecraft.breeze_wind_charge": "Windkugl",
	...
	"entity.minecraft.cherry_boat": "Kirschn Bood",
	"entity.minecraft.cherry_chest_boat": "Kirschn Bood",
	"entity.minecraft.chest_boat": "Bood mit Kistn",
	...
	"entity.minecraft.copper_golem": "Kupfagolem",
	"entity.minecraft.cow": "Rindviech",
	"entity.minecraft.creaking": "Knarzer",
	"entity.minecraft.creaking_transient": "Kracha",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Schwoazoachnboot",
	"entity.minecraft.dark_oak_chest_boat": "Schwoazoachntruhenboot",
	...
	"entity.minecraft.end_crystal": "Enderkrisdoj",
	...
	"entity.minecraft.falling_block_type": "Foiada %s",
	"entity.minecraft.fireball": "Feiakugl",
	"entity.minecraft.firework_rocket": "Feierwerkraketn",
	...
	"entity.minecraft.happy_ghast": "Lachada Ghast",
	...
	"entity.minecraft.interaction": "Intaaktionsobjekt",
	...
	"entity.minecraft.jungle_boat": "Tropnhoizboot",
	"entity.minecraft.jungle_chest_boat": "Tropnhoiztruhenboot",
	"entity.minecraft.killer_bunny": "Mörder Haas",
	"entity.minecraft.leash_knot": "Leinenknotn",
	"entity.minecraft.lightning_bolt": "Blitz",
	"entity.minecraft.lingering_potion": "Vaweiltrank",
	"entity.minecraft.llama": "Lama",
	"entity.minecraft.llama_spit": "Lamaspucke",
	"entity.minecraft.magma_cube": "Magmawürfl",
	"entity.minecraft.mangrove_boat": "Mangrovnboot",
	"entity.minecraft.mangrove_chest_boat": "Mangrovnhoiztruhenboot",
	"entity.minecraft.mannequin": "Spielerpuppn",
	...
	"entity.minecraft.oak_boat": "Oachnboot",
	"entity.minecraft.oak_chest_boat": "Oachnboottruhenboot",
	"entity.minecraft.ocelot": "Wuidkotz",
	"entity.minecraft.ominous_item_spawner": "Ominösa Item-Spawna",
	"entity.minecraft.painting": "Buidl",
	"entity.minecraft.pale_oak_boat": "Heis Oachnboot",
	"entity.minecraft.pale_oak_chest_boat": "Heis Oachntruhenboot",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Vertrockneta",
	...
	"entity.minecraft.sniffer": "Schniffer",
	...
	"entity.minecraft.splash_potion": "Wuaftrank",
	"entity.minecraft.spruce_boat": "Fichtnboot",
	"entity.minecraft.spruce_chest_boat": "Fichtntruhenboot",
	...
	"entity.minecraft.sulfur_cube.content": "Enthält: %s",
	...
	"entity.minecraft.villager": "Doafbewohna",
	...
	"entity.minecraft.wind_charge": "Windkugl",
	...
	"entity.not_summonable": "Objekt vo typ %s ko ned erzeugt wern",
	"event.minecraft.raid": "Überfoi",
	"event.minecraft.raid.defeat": "Verlorn",
	"event.minecraft.raid.defeat.full": "Überfall - Niederloch",
	"event.minecraft.raid.raiders_remaining": "Verbleibende Raiber: %s",
	"event.minecraft.raid.victory": "Gwonna",
	"event.minecraft.raid.victory.full": "Überfall - Gwunna",
	"filled_map.buried_treasure": "Schotzkoate",
	"filled_map.explorer_jungle": "Dchnugelentdeckungskoat'n",
	"filled_map.explorer_swamp": "Sumpf-Entdeckerkoat'n",
	"filled_map.id": "Nr. %s",
	"filled_map.level": "(Stufe %s/%s)",
	"filled_map.locked": "Gspart",
	"filled_map.mansion": "Woid-Entdeckerkoate",
	"filled_map.monument": "Weydmeea-Entdeckerkoate",
	"filled_map.scale": "Maßstab 1:%s",
	"filled_map.trial_chambers": "Prüfungs-Entdeckerkoatn",
	"filled_map.unknown": "Unbekonnte Koate",
	"filled_map.village_desert": "Wüstndoafkoatn",
	"filled_map.village_plains": "Wiesndoafkoatn",
	"filled_map.village_savanna": "Savannendoafkoatn",
	"filled_map.village_snowy": "Verschnoads Doaf Koatn",
	"filled_map.village_taiga": "Taigadoafkoatn",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Nether erlaubn",
	"gamerule.allowEnteringNetherUsingPortals.description": "Gibt oan, ob d'Spieler in’n Nether ein'geh’n kennan.",
	"gamerule.allowFireTicksAwayFromPlayer": "Feia vo Spiela weg aktualisiern",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Steiad ob Feier und Lava weider wia 8 Chunks weg vom Spiela aktualisiert wern",
	"gamerule.announceAdvancements": "Foatschridde bekonnt gebn",
	"gamerule.blockExplosionDropDecay": "Block‐Explosionsausbeute verschwint",
	"gamerule.blockExplosionDropDecay.description": "Einiges vo da Ausbeute vo Blöcken, de wega Block-Explosionen kaputt gengan, geht verlorn.",
	...
	"gamerule.commandBlocksEnabled": "Befehlsblöck erlaubn",
	"gamerule.commandModificationBlockLimit": "Befehlsänderungs‐Blockgrenzn",
	"gamerule.commandModificationBlockLimit.description": "Anzahl vo Blöcke, de gleichzeitig mit oam Befehl wie fill oder clone verändert wern kinnan.",
	"gamerule.disableElytraMovementCheck": "Elytrenflugübaprüfung deaktiviern",
	"gamerule.disablePlayerMovementCheck": "Spielerbewegungsprüfung ausschoitn",
	...
	"gamerule.doLimitedCrafting.description": "Bei Aktivierung kinnan Spiela nur freigschoitene Rezepte mocha.",
	...
	"gamerule.doMobSpawning.description": "Manche Objekte kinna eigne Objekte hom.",
	"gamerule.doPatrolSpawning": "Plündera‐Patrouilln erzeign",
	"gamerule.doTileDrops": "Blockausbeite falln loua",
	"gamerule.doTileDrops.description": "Steierd ob Blöcke erane Ressourcen foin lossn, Erfahrungskugln eigschlossn.",
	"gamerule.doTraderSpawning": "Tandla spawnen",
	"gamerule.doVinesSpread": "Ranknausbrotung",
	"gamerule.doVinesSpread.description": "Steierd ob Rankn si zufällig auf angrenznde Blöcke ausbreitn. Des betrifft ned andere Arten vo Rankenblöcken wia Trauarankn, Zwirblrankn, etc.",
	"gamerule.doWardenSpawning": "Wächta erschafn",
	"gamerule.doWeatherCycle": "Wedawechsel",
	"gamerule.drowningDamage": "Schadn duach Ertrinken",
	"gamerule.enableCommandBlocks": "Befehlsblöck erlaubn",
	"gamerule.enderPearlsVanishOnDeath": "Gwoafane Enderperln verschwindn beim Tod",
	"gamerule.enderPearlsVanishOnDeath.description": "Ob Endaperln, de vo am Spieler gschmissn worn san, vaschwindn, wenn da Spiela varreckt.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Krampf mit Viecha drin ko durch Portale",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Erlaube Sachan mit Viecher drin si durch Nether Portale, End Portale und Endtransportportale zu teleportiern.",
	...
	"gamerule.globalSoundEvents": "Weitweida Lärm",
	"gamerule.globalSoundEvents.description": "Wenn bstimmte Sachan bassian, zum Beispui dass a Boss spawnt, ko ma des Geräusch übaroi hern.",
	"gamerule.keepInventory": "Inventar noch dem Doud behaltn",
	"gamerule.lavaSourceConversion": "Lavaerneierung",
	"gamerule.lavaSourceConversion.description": "Wenn fließnde Lava auf zwoa Seitn vo Lavaquelln umgem is, wird sie zur Quelln.",
	"gamerule.locatorBar": "Schoit d Spielaortungsleistn ei",
	"gamerule.locatorBar.description": "Wenn o wiad a Leistn ozoagt, um d Richtung vo Spieler ozzooang.",
	"gamerule.logAdminCommands": "Administratorbefehle protokolliern",
	"gamerule.maxCommandChainLength": "Obagrenze fia Befehlskettn",
	"gamerule.maxCommandChainLength.description": "Werd auf Befehlsblöckkettn und Funktionen angwent.",
	"gamerule.maxCommandForkCount": "Obagrenzn fian Befehlsrahmen",
	"gamerule.maxCommandForkCount.description": "Maximale Anzahl vo Kontextn, de bei Befehln wia 'execute as' gnutzt wern kinnan.",
	"gamerule.maxEntityCramming": "Obagrenze fia Objektgedränge",
	"gamerule.minecartMaxSpeed": "Minenwagerlmaximalgschwindigkeit",
	"gamerule.minecartMaxSpeed.description": "Maximalgschwindigkeit, de a Minenwagerl normal an Land erreichen ko.",
	"gamerule.minecraft.elytra_movement_check": "Elytren-Bewegungsübaprüfung",
	"gamerule.minecraft.fire_spread_radius_around_player": "Radius vo da Feierausbreitung",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Da Radius in Blöck um an Spieler, in dem si’s Feier ausbreit’n ko",
	"gamerule.minecraft.player_movement_check": "Spieler‐Bwegungsprüfung",
	"gamerule.minecraft.raids": "Übafoi'e",
	"gamerule.minecraft.universal_anger.description": "Grantige neutrale Kreaturn geh’n auf jedn Spieler in da Näh los, ned nua auf den, der’s grantig g’macht hod. Laft am best’n, wenn forgive_dead_players ausg’schalten is.",
	"gamerule.mobExplosionDropDecay": "Wenn Monster ind Luft gengan wern manche Blöcke nix droppn",
	"gamerule.mobExplosionDropDecay.description": "Bei manche vo de Blöcke, de bei da Explosion vo am Mob kaputt gengan, wern d Drops valon geh.",
	"gamerule.mobGriefing": "Zerstörung duach Viecha",
	"gamerule.naturalRegeneration": "Gesundheit regeneriern",
	"gamerule.playersNetherPortalCreativeDelay": "Netherportal Vazögerung im Kreativmodus",
	"gamerule.playersNetherPortalCreativeDelay.description": "Zeit (in Ticks), de a Spiela im Kreativmodus im Netherportal steh muas, bevor a ind andane Dimension gschickt wird.",
	"gamerule.playersNetherPortalDefaultDelay": "Natzerportal-Verzögerung in oism aussa Kreativmodus",
	"gamerule.playersNetherPortalDefaultDelay.description": "Zeit (in Ticks), de a Spiela in irgendwos aussa Kreativmodus im Netherportal steh muas, bevor a ind andane Dimension gschickt wird.",
	...
	"gamerule.projectilesCanBreakBlocks": "Projektile kinnan Blöcke zastörn",
	"gamerule.projectilesCanBreakBlocks.description": "Entscheidet, ob Projektile Blöcke zastörn wern, des zastörn kinnan, wenns afkemman.",
	"gamerule.pvp": "PvP erlaubn",
	"gamerule.pvp.description": "Gibt oan, ob Spieler andern Spielern Schaden z’foin kennan.",
	"gamerule.randomTickSpeed": "Häifigkeit vo Zufallsereignissen",
	"gamerule.reducedDebugInfo": "Debug‐Infos reduziern",
	"gamerule.reducedDebugInfo.description": "Begrenzt an Inhalt vom Debug-Screen.",
	"gamerule.sendCommandFeedback": "Befehlsausgabe oanzeign",
	"gamerule.showDeathMessages": "Doudesmeldungen oanzeign",
	"gamerule.snowAccumulationHeight": "Schneedecknhöhe",
	"gamerule.snowAccumulationHeight.description": "Wenns schneid sammeln si am Boden maximal de Nummer vo Lagen Schnee.",
	"gamerule.spawnChunkRadius": "Spawn-Chunk-Radius",
	"gamerule.spawnChunkRadius.description": "Menge vo Chunks um an Overworld Spawn glon bleim.",
	"gamerule.spawnMonsters": "Monster erschaff’n",
	"gamerule.spawnMonsters.description": "Gibt oan, ob Monster auf natürliche Weis erschaff’n wern.",
	"gamerule.spawnRadius": "Radius des Wiedaoanstiegsbereichs",
	"gamerule.spawnRadius.description": "Entscheidet d Größe vom Bereich um an Spawnpunkt in dem d Spieler spawnen kinnan.",
	"gamerule.spawnerBlocksEnabled": "Spawner-Blöck erlaubn",
	"gamerule.spectatorsGenerateChunks": "Zuschaua generiern Landschoft",
	"gamerule.tntExplodes": "Erlaubt, dass TNT aktiviad wiad und explodiert",
	"gamerule.tntExplosionDropDecay": "Bei TNT-Explosionen geht mancha Loot valon",
	"gamerule.tntExplosionDropDecay.description": "Manche vo de Blöcke, de in na TNT-Explosion zastört wern gengan valohn.",
	...
	"gamerule.waterSourceConversion": "Wasser wird zu na Quelle",
	"gamerule.waterSourceConversion.description": "Wenn fließndes Wasser an zwoa Seitn vo Quellen umgem is wirds zu na Quelle.",
	...
	"gui.abuseReport.attestation": "Durchs abgem vo dem Report bestätigst du, dass de geschriebenen Informationen wahr und deinem Wissen nach vollständig san.",
	"gui.abuseReport.comments": "Kommentare",
	"gui.abuseReport.describe": "Details z vazeihn huift uns, a guad informierte Entscheidung z treffa.",
	"gui.abuseReport.discard.content": "Wennsta du die Seitn verlassen datst, würden dei Meldungen und Kommentare verloren gehnga.\nBists dir da sicher, dass du sie verlassen möchst?",
	"gui.abuseReport.discard.discard": "Valassn und Meldung vawerfn",
	"gui.abuseReport.discard.draft": "Ois Entwuaf speichan",
	"gui.abuseReport.discard.return": "Weida bearbeitn",
	"gui.abuseReport.discard.title": "Soin d Meldung und Kommentare vaworfn wern?",
	"gui.abuseReport.draft.content": "Wuist du d bestehende Meldung weida bearbeiten oda a de vawerfen und a neie macha?",
	"gui.abuseReport.draft.discard": "Vaweafn",
	"gui.abuseReport.draft.edit": "Weida bearbeiten",
	"gui.abuseReport.draft.quittotitle.content": "Wuist dus weida bearbeiten oda vawerfen?",
	"gui.abuseReport.draft.quittotitle.title": "Du host an Meldeentwurf der valohn geht, wennst rausgehst",
	"gui.abuseReport.draft.title": "Meldeentwurf bearbatn?",
	"gui.abuseReport.error.title": "Problem beim sendn vo deina Meldung",
	"gui.abuseReport.message": "Wo host du des schlechte Vahoitn beobachtet? Des wird uns beim untersuacha vo dem Foi heifa.",
	"gui.abuseReport.more_comments": "Beschreib bitte, wos bassiert is:",
	"gui.abuseReport.name.comment_box_label": "Bitte sog moi, warum du den Namen mein wuist:",
	"gui.abuseReport.name.reporting": "De meidsd \"%s\".",
	"gui.abuseReport.name.title": "Spielanam mein",
	"gui.abuseReport.observed_what": "Warum meidsd du des?",
	"gui.abuseReport.read_info": "Erfahr mehr zum mein",
	...
	"gui.abuseReport.reason.generic": "I wui den mein",
	"gui.abuseReport.reason.generic.description": "De nervn mi / de hom wos gmocht, wos I ned mog.",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Sexuell unpassnd",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Skins, de sexuelle Handlungen, Reproduktionsorgane oda sexuelle Gwoit graphisch darstein.",
	...
	"gui.abuseReport.report_sent_msg": "Mia hom dei Meldung griagt. Dangschee!\n\nUnsa Team wiad sis meglichst schnei oschaun.",
	"gui.abuseReport.select_reason": "Meidekategorie aussuacha",
	"gui.abuseReport.send": "Meldung sendn",
	"gui.abuseReport.send.comment_too_long": "Bitte fass di kiaza",
	...
	"gui.abuseReport.send.no_reason": "Bitte suach a Meldingskategorie aus",
	"gui.abuseReport.send.not_attested": "Bitte lies den Text om und hackl des Kastl ob, damidsd de Meldung sendn kost",
	...
	"gui.abuseReport.skin.title": "Spiela-Skin mein",
	"gui.abuseReport.title": "Spiela mein",
	"gui.abuseReport.type.chat": "Chatnachrichtn",
	"gui.abuseReport.type.name": "Spielanam",
	"gui.abuseReport.type.skin": "Spiela-Skin",
	...
	"gui.banned.name.description": "Dei jetziga Name - \"%s\" - vastesst gega unsane Community Standarts. Du kost aloa spuin, aba wiast dein Nom ändan miassn um online spuin z kinna.\n\nFia mehr Infos oda um a Einzlfallspriafung eizreichn folgenda Link: %s\n\nWie bitte lest du des grod??? Des Spui spuid doch eh koana auf Boarisch? Und dann schaffst as no an foischn Namen z wählen... Dad ma ganz schee stinga. Aba, du host des Easter Egg gfunna... Moi schaun wos no so findsd... ~ Da Übersetzer mit Grüßen aus Niederbayern",
	"gui.banned.name.title": "Nam ned erlaubt im Mehrspiela",
	"gui.banned.reason.defamation_impersonation_false_information": "Identitätsdiebstoi oda Weitagabe vo Informationen um andane ausznutzn oda z deischn",
	"gui.banned.reason.drugs": "Erwähnung illegala Drogn",
	"gui.banned.reason.extreme_violence_or_gore": "Darstellung vo exzessiva Gwoit oda bluadige Szenen ausm echtn Lem",
	"gui.banned.reason.false_reporting": "Ausufernde foische oda ungenaue Meidungen",
	"gui.banned.reason.fraud": "Betrügarische Aneignung oda Nutzung vo Inhalte",
	"gui.banned.reason.generic_violation": "Valetzung vo de Community-Standarts",
	"gui.banned.reason.harassment_or_bullying": "Beleidigende Spoch, de in na gerichteten und valetzendn Weise gnutzt wiad",
	"gui.banned.reason.hate_speech": "Hassredn oda Diskriminisation",
	"gui.banned.reason.hate_terrorism_notorious_figure": "Erwähnung vo Hassgruppn, terroristische Organisationen oda berüchtigte Figurn",
	"gui.banned.reason.imminent_harm_to_person_or_property": "Absicht, im echtn Lem Schon an Leid oda Besitz z vaursachn",
	"gui.banned.reason.nudity_or_pornography": "Darstellung vo anzüglichm oda pornographischem Material",
	"gui.banned.reason.sexually_inappropriate": "Themen oda Inhoite mit sexueller Natur",
	"gui.banned.reason.spam_or_advertising": "Spam oda Werbung",
	"gui.banned.skin.description": "Dei jetziger Skin valetzt unsane Community-Standarts. Du kost mit am Standartskin spuin, oda wennst am neuen wählst.\n\nMehr oda Einzelfallsprüfung unta folgendem Link: %s",
	"gui.banned.skin.title": "Skin need erlaubt",
	...
	"gui.chatReport.report_sent_msg": "Mia hom dei Meldung erfoigreich erhoitn. Dangschöö!\n\nUnsa Team weads so fria wias gehd oschaugng.",
	...
	"gui.fileDropFailure.detail": "%s Datein abglehnt",
	"gui.fileDropFailure.title": "Datein hom ned hinzugefügt wern kinna",
	...
	"gui.friends.enter_nickname": "Profilnamen eingeben",
	...
	"gui.friends.error.temporary_unavailable": "Die Freundesliste funktioniert gerade nicht.\n\nVersuche es später erneut.",
	"gui.friends.error.unavailable.message": "Der Dienst hinter der Freundesliste ist momentan nicht erreichbar. Bitte überprüfe deine Verbindung und versuche es später erneut.",
	"gui.friends.error.upgrade_needed": "Aktualisiere das Spiel, um auf deine Freundesliste zuzugreifen.",
	"gui.friends.error.user_may_lack_active_profile": "Es gibt keinen Spieler mit diesem Profilnamen",
	"gui.friends.join": "Beitreten",
	"gui.friends.loading_friends": "Freundesliste wird geladen...",
	"gui.friends.loading_requests": "Anfragen werden geladen...",
	"gui.friends.manage_account_footer": "Verwalte deine Online‐Sicherheit in deinem %s",
	"gui.friends.multiplayer.invite": "Einladen",
	"gui.friends.multiplayer.invite_accept": "Annehmen",
	"gui.friends.multiplayer.invite_reject": "Ablehnen",
	"gui.friends.multiplayer.join_request": "Beitritt anfragen",
	"gui.friends.multiplayer.join_request_accept": "Annehmen",
	"gui.friends.multiplayer.join_request_reject": "Ablehnen",
	...
	"gui.game_rule.search": "Suachn...",
	"gui.hours": "%s Stund(n)",
	"gui.language.search": "Suachn...",
	"gui.loadingMinecraft": "Minecraft lod",
	...
	"gui.none": "Nix",
	"gui.ok": "Ok",
	"gui.open_report_dir": "Berichtsvazeichnis öffnen",
	"gui.packSelection.search": "Suachn...",
	...
	"gui.recipebook.next_page": "Negste Seitn",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Vorige Seitn",
	...
	"gui.report_to_server": "An an Server mein",
	"gui.selectWorld.search": "Suachn...",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Dieser Spieler kann nicht gemeldet werden, da der Chat deaktiviert oder blockiert ist",
	...
	"gui.stats.none_found": "Koane Statistiken g'fundn.",
	"gui.toMenu": "Zruck zur Servaaswahl",
	"gui.toRealms": "Zruck zur Realms-Auswoi",
	"gui.toTitle": "Zruck zum Hauptmenü",
	"gui.toWorld": "Zruck zur Weitn-Auswoi",
	"gui.togglable_slot": "Klicke, um Inventarplätze z sparn",
	"gui.up": "Afe",
	"gui.waitingForResponse.button.inactive": "Zruck (%ss)",
	"gui.waitingForResponse.title": "Auf’n Server wart’n",
	"gui.yes": "Ja",
	"hanging_sign.edit": "Hängadsschuidlnachricht bearbatn",
	...
	"item.canUse.unknown": "Unbekonnt",
	"item.color": "Foabe: %s",
	"item.components": "%s Komponentn",
	"item.disabled": "Deaktivierts Glump",
	"item.durability": "Hoitbarkeit: %s/%s",
	"item.dyed": "G'färbt",
	"item.intangible": "Ned greifbar",
	"item.minecraft.acacia_boat": "Akazienhoizboot",
	"item.minecraft.acacia_chest_boat": "Akazienhoiztruhenboot",
	"item.minecraft.allay_spawn_egg": "Huifsgoast-Spawn-Oa",
	"item.minecraft.amethyst_shard": "Amethystscherbe",
	"item.minecraft.angler_pottery_shard": "Angler-Töpferscherm",
	"item.minecraft.angler_pottery_sherd": "Angler-Töpferscherm",
	"item.minecraft.apple": "Opfe",
	"item.minecraft.archer_pottery_shard": "Schützen-Töpferscherm",
	"item.minecraft.archer_pottery_sherd": "Schützen-Töpferscherm",
	"item.minecraft.armadillo_scute": "Gürtltierschuppn",
	"item.minecraft.armadillo_spawn_egg": "Gürtltier Spawn-Ei",
	"item.minecraft.armor_stand": "Rüstungsstända",
	"item.minecraft.arms_up_pottery_shard": "Gfuchtl-Töpferscherm",
	"item.minecraft.arms_up_pottery_sherd": "Gfuchtl-Töpferscherm",
	...
	"item.minecraft.bamboo_chest_raft": "Bambushoiztruhenfloß",
	...
	"item.minecraft.birch_chest_boat": "Birknhoiztruhenboot",
	"item.minecraft.black_bundle": "Schwoaz Bündel",
	"item.minecraft.black_dye": "Schwoaza Foabstoff",
	"item.minecraft.black_harness": "Schwarzes Gschirr",
	"item.minecraft.blade_pottery_shard": "Klingen-Töpferscherm",
	"item.minecraft.blade_pottery_sherd": "Klingen-Töpferscherm",
	...
	"item.minecraft.blue_bundle": "Blaues Bündel",
	"item.minecraft.blue_dye": "Blaua Foabstoff",
	"item.minecraft.blue_egg": "Blaus Ei",
	"item.minecraft.blue_harness": "Blaus Gschirr",
	"item.minecraft.bogged_spawn_egg": "Moorleichn Spawn-Ei",
	"item.minecraft.bolt_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Boizn-Rüstungsschmuck",
	"item.minecraft.bone": "Boanen",
	"item.minecraft.bone_meal": "Boanenmej",
	"item.minecraft.book": "Buach",
	"item.minecraft.bordure_indented_banner_pattern": "Bordürenbannervorlag",
	"item.minecraft.bow": "Boong",
	"item.minecraft.bowl": "Schüssl",
	"item.minecraft.bread": "Brod",
	"item.minecraft.breeze_rod": "Brisnsteckerl",
	"item.minecraft.breeze_spawn_egg": "Brisn Spawn-Ei",
	"item.minecraft.brewer_pottery_shard": "Brauer-Töperscherm",
	"item.minecraft.brewer_pottery_sherd": "Brauer-Töperscherm",
	"item.minecraft.brewing_stand": "Brauerei",
	"item.minecraft.brick": "Ziegl",
	"item.minecraft.brown_bundle": "Brauns Bündel",
	"item.minecraft.brown_dye": "Brauna Foabstoff",
	"item.minecraft.brown_egg": "Brauns Ei",
	"item.minecraft.brown_harness": "Brauns Gschirr",
	"item.minecraft.brush": "Waschl",
	"item.minecraft.bucket": "Oama",
	"item.minecraft.bundle": "Bündl",
	"item.minecraft.bundle.empty": "Lar",
	"item.minecraft.bundle.empty.description": "Ko an gmischtn Stack Items hoitn",
	"item.minecraft.bundle.full": "Voi",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "Feier-Töpferscherm",
	"item.minecraft.burn_pottery_sherd": "Feier-Töpferscherm",
	"item.minecraft.camel_husk_spawn_egg": "Oa vom Zombiedromedar",
	...
	"item.minecraft.cherry_chest_boat": "Kiaschhoiztruhenboot",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Küstn-Rüstungsschmuck",
	...
	"item.minecraft.copper_axe": "Kupfaoxt",
	"item.minecraft.copper_boots": "Kupferschuah",
	"item.minecraft.copper_chestplate": "Kupferbrustplatt’n",
	"item.minecraft.copper_golem_spawn_egg": "Oa vom Kupfagolem",
	"item.minecraft.copper_helmet": "Kupfahölm",
	"item.minecraft.copper_hoe": "Kupfahack'n",
	"item.minecraft.copper_horse_armor": "Kupfa-Pferdepanza",
	"item.minecraft.copper_ingot": "Kupfabarrn",
	"item.minecraft.copper_leggings": "Kupfahos'n",
	"item.minecraft.copper_nautilus_armor": "Kupfa\u00ad-Nautiluspanza",
	"item.minecraft.copper_nugget": "Kupfaklumpn",
	"item.minecraft.copper_pickaxe": "Kupfaspitzhackn",
	"item.minecraft.copper_shovel": "Kupfaschaufl",
	"item.minecraft.copper_spear": "Kupfaspiaß",
	"item.minecraft.copper_sword": "Kupfaschwert",
	"item.minecraft.cow_spawn_egg": "Rindvieh-Spawn-Oa",
	"item.minecraft.creaking_spawn_egg": "Kracha-Spawnei",
	...
	"item.minecraft.cyan_bundle": "Türkises Bündl",
	"item.minecraft.cyan_dye": "Türkisa Foabstoff",
	"item.minecraft.cyan_harness": "Türkises Gschirr",
	"item.minecraft.danger_pottery_shard": "Gfahr-Töpferscherm",
	"item.minecraft.danger_pottery_sherd": "Gfahr-Töpferscherm",
	"item.minecraft.dark_oak_boat": "Schwoazoachenhoizboot",
	"item.minecraft.dark_oak_chest_boat": "Schwoazeichntruhenboot",
	...
	"item.minecraft.diamond_nautilus_armor": "Diamant-Nautiluspanza",
	"item.minecraft.diamond_pickaxe": "Diamantgrompm",
	"item.minecraft.diamond_shovel": "Diamantschaufl",
	"item.minecraft.diamond_spear": "Diamantspiaß",
	"item.minecraft.diamond_sword": "Diamantschwert",
	"item.minecraft.disc_fragment_5": "Plattnstickl",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Dünen-Rüstungsschmuck",
	"item.minecraft.echo_shard": "Echo Scherm",
	...
	"item.minecraft.explorer_pottery_shard": "Entdecker-Töpferscherm",
	"item.minecraft.explorer_pottery_sherd": "Entdecker-Töpferscherm",
	"item.minecraft.eye_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Augn-Rüstungsschmuck",
	"item.minecraft.feather": "Feda",
	"item.minecraft.fermented_spider_eye": "Fermentiertes Spinnaauge",
	"item.minecraft.field_masoned_banner_pattern": "Gmeia-Bannerschmuck",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Fluss-Rüstungsschmuck",
	"item.minecraft.flow_banner_pattern": "Bannervorlang",
	"item.minecraft.flow_banner_pattern.desc": "Ache",
	"item.minecraft.flow_banner_pattern.new": "Fluss-Bannervorlag",
	"item.minecraft.flow_pottery_sherd": "Fluss-Töpferscherm",
	"item.minecraft.flower_banner_pattern": "Bannervorlagn",
	"item.minecraft.flower_banner_pattern.desc": "Bläamen",
	"item.minecraft.flower_banner_pattern.new": "Bleame-Bannervorlag",
	"item.minecraft.flower_pot": "Blummatopf",
	"item.minecraft.fox_spawn_egg": "Fuchs-Spawn-Oa",
	"item.minecraft.friend_pottery_shard": "Freind-Töoferscherm",
	"item.minecraft.friend_pottery_sherd": "Freind-Töpferscherm",
	...
	"item.minecraft.glass_bottle": "Glosflaschn",
	...
	"item.minecraft.golden_nautilus_armor": "Goid-Nautiluspanza",
	"item.minecraft.golden_pickaxe": "Goidgrompm",
	"item.minecraft.golden_shovel": "Goidschaufl",
	"item.minecraft.golden_spear": "Goidspiaß",
	...
	"item.minecraft.green_bundle": "Greans Bündel",
	"item.minecraft.green_dye": "Greana Foabstoff",
	"item.minecraft.green_harness": "Greans Gschirr",
	"item.minecraft.guardian_spawn_egg": "Wächter-Spawn-Oa",
	"item.minecraft.gunpowder": "Schwoazpulva",
	"item.minecraft.guster_banner_pattern": "Bannervorlang",
	"item.minecraft.guster_banner_pattern.desc": "Bloser",
	"item.minecraft.guster_banner_pattern.new": "Liftl-Bannervorlag",
	"item.minecraft.guster_pottery_sherd": "Bloser-Töpferscherm",
	"item.minecraft.happy_ghast_spawn_egg": "Lachada Ghast Spawn-Ei",
	"item.minecraft.harness": "Gschirr",
	"item.minecraft.heart_of_the_sea": "Meerherz",
	"item.minecraft.heart_pottery_shard": "Herz-Töpferscherm",
	"item.minecraft.heart_pottery_sherd": "Herz-Töpferscherm",
	"item.minecraft.heartbreak_pottery_shard": "Herzweh-Töpferscheim",
	"item.minecraft.heartbreak_pottery_sherd": "Herzweh-Töpferscheim",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.host_armor_trim_smithing_template.new": "Wirts-Rüstungsschmuck",
	"item.minecraft.howl_pottery_shard": "Gheul-Töpferscherm",
	"item.minecraft.howl_pottery_sherd": "Gheul-Töpferscherm",
	...
	"item.minecraft.light_blue_bundle": "Heiblaus Bündel",
	"item.minecraft.light_blue_dye": "Höiblaue Farb",
	"item.minecraft.light_blue_harness": "Heiblaus Gschirr",
	"item.minecraft.light_gray_bundle": "Heigraus Bündel",
	"item.minecraft.light_gray_dye": "Höigraue Farb",
	"item.minecraft.light_gray_harness": "Heigraus Gschirr",
	"item.minecraft.lime_bundle": "Heigreans Bündel",
	"item.minecraft.lime_dye": "Giftgreana Foabstoff",
	"item.minecraft.lime_harness": "Heigreans Gschirr",
	...
	"item.minecraft.lingering_potion.effect.infested": "Vaweiltrank des Befalls",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Vaweiktrank des Rotzens",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Vaweiltrank da Spinnerei",
	"item.minecraft.lingering_potion.effect.wind_charged": "Vaweiktrank des Lifterls",
	"item.minecraft.llama_spawn_egg": "Lama-Spawn-Oa",
	"item.minecraft.lodestone_compass": "Leitstoa-Kompass",
	"item.minecraft.mace": "Streitkoim",
	"item.minecraft.magenta_bundle": "Magenta Bündel",
	"item.minecraft.magenta_dye": "Magenta Farb",
	"item.minecraft.magenta_harness": "Pinks Gschirr",
	...
	"item.minecraft.mangrove_chest_boat": "Mangrovnhoiztruhenboot",
	...
	"item.minecraft.miner_pottery_shard": "Bergarbeiter-Töpferscherm",
	"item.minecraft.miner_pottery_sherd": "Bergarbeiter-Töpferscherm",
	"item.minecraft.mojang_banner_pattern": "Bannervorlagn",
	"item.minecraft.mojang_banner_pattern.desc": "Mojang-Logo",
	"item.minecraft.mojang_banner_pattern.new": "Dings-Bannervorlag",
	"item.minecraft.mooshroom_spawn_egg": "Mooshroom-Spawn-Oa",
	"item.minecraft.mourner_pottery_shard": "Trauernder-Töpferscherm",
	"item.minecraft.mourner_pottery_sherd": "Trauernder-Töpferscherm",
	...
	"item.minecraft.music_disc_creator": "Schoiplattn",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Schoiplattn",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Creator (Spieluhr)",
	"item.minecraft.music_disc_far": "Schoiplattn",
	"item.minecraft.music_disc_far.desc": "C418 - far",
	"item.minecraft.music_disc_lava_chicken": "Schallplattn",
	...
	"item.minecraft.music_disc_precipice": "Schoiplattn",
	"item.minecraft.music_disc_precipice.desc": "Aaron Cherof - Precipice",
	"item.minecraft.music_disc_relic": "Schoiplattn",
	...
	"item.minecraft.music_disc_tears": "Schallplattn",
	...
	"item.minecraft.nautilus_spawn_egg": "Nautilus-Spawn-Oa",
	...
	"item.minecraft.netherite_horse_armor": "Netherit-Pferdepanza",
	"item.minecraft.netherite_ingot": "Netheritbarren",
	"item.minecraft.netherite_leggings": "Netherithaxnschutz",
	"item.minecraft.netherite_nautilus_armor": "Netherit-Nautiluspanza",
	...
	"item.minecraft.netherite_spear": "Netheritspiaß",
	"item.minecraft.netherite_sword": "Netheritschwert",
	"item.minecraft.netherite_upgrade_smithing_template": "Schmiedevorlang",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Netherite Upgrade",
	"item.minecraft.oak_boat": "Oachenhoizboot",
	"item.minecraft.oak_chest_boat": "Oachnhoiztruhenboot",
	"item.minecraft.ocelot_spawn_egg": "Wuidkotz-Spawn-Oa",
	"item.minecraft.ominous_bottle": "Ominöse Flaschn",
	"item.minecraft.ominous_trial_key": "Ominösa Priafungsschlissl",
	"item.minecraft.orange_bundle": "Orangs Bündel",
	"item.minecraft.orange_dye": "Oranga Foabstoff",
	"item.minecraft.orange_harness": "Orangs Gschirr",
	"item.minecraft.painting": "Gemälde",
	"item.minecraft.pale_oak_boat": "Heis Oachnboot",
	"item.minecraft.pale_oak_chest_boat": "Heis Oachntruhenboot",
	"item.minecraft.panda_spawn_egg": "Panda-Spawn-Oa",
	"item.minecraft.paper": "Papier",
	"item.minecraft.parched_spawn_egg": "Vertrocknata-Spawn-Oa",
	...
	"item.minecraft.piglin_banner_pattern.new": "Schnauzn Bannervorlag",
	...
	"item.minecraft.pink_bundle": "Pinks Bündel",
	"item.minecraft.pink_dye": "Rosa Foabstoff",
	"item.minecraft.pink_harness": "Rosa Gschirr",
	"item.minecraft.pitcher_plant": "Kannenbleame",
	"item.minecraft.pitcher_pod": "Kannenbleamesamen",
	"item.minecraft.plenty_pottery_shard": "Reichtum-Töpferscherm",
	"item.minecraft.plenty_pottery_sherd": "Reichtum-Töpferscherm",
	...
	"item.minecraft.potion.effect.infested": "Trank as Befalls",
	...
	"item.minecraft.potion.effect.oozing": "Trank as Rotzns",
	...
	"item.minecraft.potion.effect.weaving": "Trank da Spinnerei",
	"item.minecraft.potion.effect.wind_charged": "Trank as Liftals",
	"item.minecraft.pottery_shard_archer": "Schützen-Töpferscherm",
	"item.minecraft.pottery_shard_arms_up": "Gfuchtl-Töpferscherm",
	"item.minecraft.pottery_shard_prize": "Juweln-Töpferscherm",
	"item.minecraft.pottery_shard_skull": "Schädl-Töpferscherm",
	...
	"item.minecraft.prize_pottery_shard": "Juweln-Töpferscherm",
	"item.minecraft.prize_pottery_sherd": "Juweln-Töpferscherm",
	...
	"item.minecraft.purple_bundle": "Lilans Bündel",
	"item.minecraft.purple_dye": "Violetta Foabstoff",
	"item.minecraft.purple_harness": "Lila Gschirr",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Eitern-Rüstungsschmuck",
	...
	"item.minecraft.recovery_compass": "Wiederherhoikompass",
	"item.minecraft.red_bundle": "Roads Bündel",
	"item.minecraft.red_dye": "Rouda Foabstoff",
	"item.minecraft.red_harness": "Roads Gschirr",
	"item.minecraft.redstone": "Redstone-Waugerln",
	"item.minecraft.resin_brick": "Harzziegl",
	"item.minecraft.resin_clump": "Harzklumpn",
	"item.minecraft.rib_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Rippal-Rüstungsschmuck",
	"item.minecraft.rotten_flesh": "Verrottetes Fleisch",
	"item.minecraft.saddle": "Sattel",
	"item.minecraft.salmon": "Rohs Lachs",
	"item.minecraft.salmon_bucket": "Kübe voi Lachs",
	"item.minecraft.salmon_spawn_egg": "Lachs-Spawn-Oa",
	"item.minecraft.scrape_pottery_sherd": "Kratzer-Töpferscherm",
	"item.minecraft.scute": "Schuppe",
	"item.minecraft.sentry_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Praesidium-Rüstungsschmuck",
	"item.minecraft.shaper_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Künstler-Rüstungsschmuck",
	"item.minecraft.sheaf_pottery_shard": "Garbn-Töpferscherm",
	"item.minecraft.sheaf_pottery_sherd": "Garbn-Töpferscherm",
	"item.minecraft.shears": "Rebschaa",
	"item.minecraft.sheep_spawn_egg": "Schof-Spawn-Oa",
	"item.minecraft.shelter_pottery_shard": "Bunker-Töpferscherm",
	"item.minecraft.shelter_pottery_sherd": "Bunker-Töpferscherm",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Ruah-Rüstungsschmuck",
	...
	"item.minecraft.skull_banner_pattern.new": "Schäk-Bannervorlag",
	"item.minecraft.skull_pottery_shard": "Schädl-Töpferscherm",
	"item.minecraft.skull_pottery_sherd": "Schädl-Töpferscherm",
	"item.minecraft.slime_ball": "Schleimboi",
	"item.minecraft.slime_spawn_egg": "Schleim-Spawn-Oa",
	"item.minecraft.smithing_template": "Schmiedevorlang",
	"item.minecraft.smithing_template.applies_to": "Anwendbar af:",
	"item.minecraft.smithing_template.armor_trim.additions_slot_description": "Metallbarren oda Kristall dazua doa",
	"item.minecraft.smithing_template.armor_trim.applies_to": "Rüstung",
	"item.minecraft.smithing_template.armor_trim.base_slot_description": "Rüstungsteil dazua doa",
	"item.minecraft.smithing_template.armor_trim.ingredients": "Metallbarren & Kristalle",
	"item.minecraft.smithing_template.ingredients": "Zutatn:",
	"item.minecraft.smithing_template.netherite_upgrade.additions_slot_description": "Netheritebarren dazua doa",
	"item.minecraft.smithing_template.netherite_upgrade.applies_to": "Diamantausristung",
	"item.minecraft.smithing_template.netherite_upgrade.base_slot_description": "Diamantristung, - waffe oda - werkzeig dazua doa",
	"item.minecraft.smithing_template.netherite_upgrade.ingredients": "Netheritebarren",
	"item.minecraft.smithing_template.upgrade": "Afwertn: ",
	"item.minecraft.sniffer_spawn_egg": "Schniffer Spawn-Ei",
	"item.minecraft.snort_pottery_shard": "Schnaufa-Töpferscherm",
	"item.minecraft.snort_pottery_sherd": "Schnaufa-Töpferscherm",
	"item.minecraft.snout_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Schnauzn-Rüstungsschmuck",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Turmspitzn-Rüstungsschmuck",
	...
	"item.minecraft.splash_potion.effect.infested": "Wurftrank as Befalls",
	...
	"item.minecraft.splash_potion.effect.oozing": "Wuafttank as Rotzns",
	...
	"item.minecraft.splash_potion.effect.weaving": "Wuaftrank da Spinnerei",
	"item.minecraft.splash_potion.effect.wind_charged": "Wuaftrank as Liftl",
	"item.minecraft.spruce_boat": "Fichtnhoizboot",
	"item.minecraft.spruce_chest_boat": "Fichtnhoiztruhenboot",
	...
	"item.minecraft.stone_spear": "Stoaspiaß",
	...
	"item.minecraft.sulfur_cube_bucket": "Schwefelwürfeleimer",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Bobs-Rüstungsschmuck",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Pfeil as Befalls",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Pfeil as Rotzns",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Pfeil da Spinnerei",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Pfeil as Liftals",
	"item.minecraft.tnt_minecart": "TNT-Lore",
	"item.minecraft.torchflower_seeds": "Fackelbleamesamen",
	"item.minecraft.totem_of_undying": "Totem da Unsterblichkeit",
	"item.minecraft.trader_llama_spawn_egg": "Händlalama-Spawn-Oa",
	"item.minecraft.trial_key": "Priafungsschlissl",
	...
	"item.minecraft.turtle_scute": "Schildkrötnschuppn",
	"item.minecraft.turtle_spawn_egg": "Schuidkrötn-Spawn-Oa",
	"item.minecraft.vex_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Krebs-Rüstungsschmuck",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Befestigungs-Rüstungsschmuck",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Pfadfinder-Rüstungsschmuck",
	"item.minecraft.wheat": "Woazn",
	"item.minecraft.wheat_seeds": "Woaznkerndl",
	"item.minecraft.white_bundle": "Weißs Bündel",
	"item.minecraft.white_dye": "Weißa Foabstoff",
	"item.minecraft.white_harness": "Weißs Gschirr",
	"item.minecraft.wild_armor_trim_smithing_template": "Schmiedevorlang",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Wuidnis-Rüstungsschmuck",
	"item.minecraft.wind_charge": "Windkugl",
	...
	"item.minecraft.wolf_armor": "Hundsrüstung",
	...
	"item.minecraft.wooden_spear": "Hoizspiaß",
	...
	"item.minecraft.yellow_bundle": "Geibs Bündel",
	"item.minecraft.yellow_dye": "Gejba Foabstoff",
	"item.minecraft.yellow_harness": "Geibs Gschirr",
	"item.minecraft.zoglin_spawn_egg": "Zoglin-Spawn-Oa",
	"item.minecraft.zombie_horse_spawn_egg": "Zombiepferdl-Spawn-Oa",
	"item.minecraft.zombie_nautilus_spawn_egg": "Zombienautilus-Spawn-Oa",
	...
	"item.modifiers.any": "Wenn ausgrüstet:",
	"item.modifiers.armor": "Wenn o:",
	"item.modifiers.body": "Wenn ausgrüstet:",
	"item.modifiers.chest": "Am Kerpr:",
	"item.modifiers.feet": "An den Fiaßn:",
	"item.modifiers.hand": "Wenn ghoitn:",
	...
	"item.modifiers.saddle": "Wenn gsattlt:",
	"item.nbt_tags": "NBT: %s Eigenschaft(en)",
	"item.op_block_warning.line1": "ALARM:",
	"item.op_block_warning.line2": "D Benutzung vo dem Item kannt zur Ausführung vo am Befehl führn",
	"item.op_block_warning.line3": "Nur nutzn wennst an genaun Inhalt kennst!",
	"item.spawn_egg.peaceful": "Auf „Friedlich“ ausgschaltn",
	...
	"jigsaw_block.placement_priority.tooltip": "Wenn si der Puzzleblock mit am Stickl vabindet is des d Reihenfolge in der des Stickl verarbat wird fia Verbindungen in da weitern Struktur.\n\nStickl wern in absteigenda Reihenfolge verarbat, wobei d Einfügereihenfolge bei Unentschiedn entscheidet.",
	"jigsaw_block.pool": "Bezugsquelle:",
	"jigsaw_block.selection_priority": "Auswahlpriorität:",
	"jigsaw_block.selection_priority.tooltip": "Wenn as übergeordnete Stück auf Vabindungen ausgewertet wiad is des d Reihenfolge, in der der Puzzleblock vasuacht si zum Zielstickl z vabindn.\n\nPuzzle wern in absteigenda Reihenfolge verarbat, wobei da Zufall bei Unentschiedn entscheidet.",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine - Creator (Spuiuhr)",
	...
	"key.categories.spectator": "Zuaschaua",
	"key.categories.ui": "Spuisteiarung",
	"key.category.minecraft.creative": "Bastl-Modus",
	"key.category.minecraft.debug": "Debug",
	"key.category.minecraft.gameplay": "Spuimechanik",
	"key.category.minecraft.inventory": "Inventar",
	"key.category.minecraft.misc": "Verschiedns",
	"key.category.minecraft.movement": "Bwegung",
	"key.category.minecraft.multiplayer": "Mehrspuia",
	"key.category.minecraft.spectator": "Zuaschaua",
	"key.chat": "Chat afmachn",
	"key.command": "Befehlszeile öffnen",
	"key.debug.clearChat": "Chat leern",
	"key.debug.copyLocation": "Position kopiarn",
	"key.debug.copyRecreateCommand": "Daten kopiarn",
	"key.debug.crash": "Debug‐Absturz",
	"key.debug.debugOptions": "Debug‐Optionen",
	"key.debug.dumpDynamicTextures": "Dynamische Texturn ausgebn",
	"key.debug.dumpVersion": "Versionsinformation ausgebn",
	"key.debug.focusPause": "Pausn bei Fensta-Fokusverlust umschoitn",
	"key.debug.fpsCharts": "FPS-Grafikn",
	"key.debug.lightmapTexture": "Lichtkartntextur",
	"key.debug.modifier": "Debug-Modifikatortastn",
	"key.debug.networkCharts": "Netzwerk-Grafikn",
	"key.debug.overlay": "Overlay umschoiten",
	"key.debug.profiling": "Profilerstellung startn/stoppn",
	"key.debug.profilingChart": "Profil-Grafik",
	"key.debug.reloadChunk": "Chunks neu ladn",
	"key.debug.reloadResourcePacks": "Ressourcenpakete neu ladn",
	"key.debug.showAdvancedTooltips": "Erweitate Schnellinfos o'zeign",
	"key.debug.showChunkBorders": "Chunk-Grenzn o’zeign",
	"key.debug.showHitboxes": "Hitboxn o'zeign",
	"key.debug.spectate": "Zuaschauamodus wechsln",
	"key.debug.switchGameMode": "Spuimodusauswahl",
	...
	"key.quickActions": "Schneiaktionen",
	"key.right": "Rechts",
	...
	"key.spectatorHotbar": "In da Schneizugriffsleistn aussuacha",
	"key.spectatorOutlines": "Spiela hervorhebn (Zuschaua)",
	"key.sprint": "Sprinten",
	"key.swapOffhand": "Gegnstond mid Zweidhond tauschn",
	"key.toggleGui": "Benutzeroberfläch umschoitn",
	"key.togglePerspective": "Perspektive wechseln",
	"key.toggleSpectatorShaderEffects": "Zuaschaua-Shader-Effekte umschoitn",
	"key.use": "Benutzn/Platziern",
	"known_server_link.announcements": "Okündigumgen",
	"known_server_link.community": "Community",
	"known_server_link.community_guidelines": "Communityrichtlinien",
	"known_server_link.feedback": "Feedback",
	"known_server_link.forums": "Foren",
	"known_server_link.news": "Neiigkeidn",
	"known_server_link.report_bug": "Servee Bug mein",
	...
	"lanServer.port.invalid": "Koa guitiger Port.\nLoss des Kastl lar oda schreib a Zahl zwischn 1024 und 65535 eine.",
	"lanServer.port.invalid.new": "Koa guitiger Port.\nLoss des Kastl lar oda schreib a Zahl zwischn %s und %s eine.",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Server dazuadoa",
	"manageServer.edit.title": "Serverinformationen beorbeiten",
	"manageServer.enterIp": "Serveradress",
	"manageServer.enterName": "Servernam",
	"manageServer.resourcePack": "Server-Ressourcenpackln",
	"manageServer.resourcePack.disabled": "Ausgschoitn",
	"manageServer.resourcePack.enabled": "Oagschoitn",
	"manageServer.resourcePack.prompt": "Abfragn",
	"mco.account.privacy.info": "Eafohr mea iba Mojang und de Datenschudzgsetze",
	"mco.account.privacy.info.button": "Mehr zua DSGVO",
	"mco.account.privacy.information": "Mojang nutzt vaschiedene Prozesse um Kinder und era Privatsphäre z schützn, unter anderem den Children's Online Privacy Protection Act (COPPA) und die Datenschutz-Grundverordnung (DSGVO).\n\nEs ko sei, daas du d Erlaubnis vo deine Eitern brauchst, bevor du Zugriff auf dein Realms Account griagst.",
	...
	"mco.activity.noactivity": "Koa Aktivität in de letztn %s Dog",
	"mco.activity.title": "Spielaaktivität",
	"mco.backup.button.download": "Aktuellste untaladn",
	"mco.backup.button.reset": "Weid zrucksetzn",
	"mco.backup.button.restore": "Wiedaherstelln",
	"mco.backup.button.upload": "Weid hochlon",
	"mco.backup.changes.tooltip": "Änderungen",
	"mco.backup.entry": "Backup (%s)",
	"mco.backup.entry.description": "Beschreibung",
	"mco.backup.entry.enabledPack": "Aktivierte(s) Backerl",
	"mco.backup.entry.gameDifficulty": "Spuischwierigkeid",
	"mco.backup.entry.gameMode": "Spuimodus",
	"mco.backup.entry.gameServerVersion": "Spuiservaversion",
	"mco.backup.entry.name": "Nama",
	"mco.backup.entry.seed": "Soot",
	"mco.backup.entry.templateName": "Vorlognama",
	"mco.backup.entry.undefined": "Unbestimmte Ändarungen",
	"mco.backup.entry.uploaded": "Houchgladn",
	"mco.backup.entry.worldType": "Wäidtyp",
	"mco.backup.entry.worldType.adventureMap": "Abenteia-Wöd",
	"mco.backup.entry.worldType.experience": "Erfoarungs-Wöd",
	"mco.backup.entry.worldType.inspiration": "Inspirations-Wöd",
	"mco.backup.entry.worldType.minigame": "Minispui",
	"mco.backup.entry.worldType.normal": "Noamoi",
	"mco.backup.entry.worldType.unknown": "Unbekannt",
	"mco.backup.generate.world": "Weyd generian",
	"mco.backup.info.title": "Ändarungen vom letztn Backup",
	"mco.backup.narration": "Backup vo %s",
	...
	"mco.client.outdated.stable.version": "De Version vo deim Client (%s) is ned kompatobl mit Realms.\n\nBitte nutz d neieste Veraion vo Minecraft.",
	"mco.client.unsupported.snapshot.version": "Dei Client Version(%s) is ned kompatibl mit Realms. \n\nRealms gibts fia de Snapshotversion ned.",
	"mco.compatibility.downgrade": "Downgrade",
	"mco.compatibility.downgrade.description": "De Weid is zletzt in Version %s gspuid worn; du bist af Versikn %s. Downgraden vo na Weid ko zu Korruption fian - mia kinnan garantian, dass lon oda funktioniern wiad.\n\nA Backup vo deiner Weid wird unta \"World Backups\" gspeichad. Bitte stei dei Weid wieder her falls nötig.",
	"mco.compatibility.incompatible.popup.title": "Inkompatible Version",
	"mco.compatibility.incompatible.releaseType.popup.message": "De Weid, de du betreten wuist is mit der Version de du spuist inkompatibl.",
	"mco.compatibility.incompatible.series.popup.message": "De Weid is zletztad in Version %s gsouid worn; du bist af Version %s.\n\nDe Serien san nes kompatibl midanand. A neie Weid wird braucht, um af der Version spuin z kinna.",
	"mco.compatibility.unverifiable.message": "D Version in der de Weid zletzt gspuit worn is hod ned verifiziert wern kinna. Falls de Welt geupgraded oder downgraded wird wiad automatisch a Backup unter \"World Backups\" gmocht.",
	"mco.compatibility.unverifiable.title": "Kompatibilität ned verifiziabar",
	"mco.compatibility.upgrade": "Upgraden",
	"mco.compatibility.upgrade.description": "De Weid is zletzt in Version %s gspuid worn; du bist in Version %s.\n\nA Backup vo deina Weid wird in \"World Backups\" gspeichert.\n\nBitte stei dei Weid wieder her, soiadsd as braucha.",
	"mco.compatibility.upgrade.friend.description": "De Weid is zletzt in Version %s gspuid worn; du bist in Version %s.\n\nA Backup vo der Weid wird in \"World Backups\" gspeichert.\n\nDa Besitzer vom Realm kos wieder herstein, soiad mas braucha.",
	"mco.compatibility.upgrade.title": "Mogst du d'Wäid wiaklich houchstufn?",
	"mco.configure.current.minigame": "Aktuei",
	...
	"mco.configure.world.buttons.done": "Ois fertig",
	"mco.configure.world.buttons.edit": "Oanstellungen",
	"mco.configure.world.buttons.invite": "Spüla eilohn",
	"mco.configure.world.buttons.moreoptions": "Meah Optiona",
	"mco.configure.world.buttons.newworld": "Neie Weid",
	...
	"mco.configure.world.buttons.region_preference": "Regian auswein...",
	"mco.configure.world.buttons.resetworld": "Zrucksetzn",
	"mco.configure.world.buttons.save": "Speichan",
	...
	"mco.configure.world.close.question.title": "Muast du ohne Störungen Änderungen vornemma?",
	...
	"mco.configure.world.invite.narration": "Du host %s neie Einladung(en)",
	"mco.configure.world.invite.profile.name": "Nama",
	"mco.configure.world.invited": "Eiglon",
	"mco.configure.world.invited.number": "Eingeladn (%s)",
	...
	"mco.configure.world.loading": "Realm wird glodn",
	"mco.configure.world.location": "Oat",
	"mco.configure.world.minigame": "Aktuei: %s",
	"mco.configure.world.name": "Realm Nama",
	"mco.configure.world.name.validation.whitespace": "Ko ned mit am Leerzeichn o’fanga oder endn. Des wird o’gschnittn.",
	"mco.configure.world.opening": "Öffne as Realm …",
	"mco.configure.world.players.error": "Es existiert ko Spiela mid diesem Nama",
	"mco.configure.world.players.invite.duplicate": "A Spieler mit dem Nam is scho ins Realm eigladn worn",
	"mco.configure.world.players.inviting": "Spiela wiad eingeladn...",
	"mco.configure.world.players.title": "Spüla",
	"mco.configure.world.pvp": "Spiela gegn Spiela (PvP)",
	"mco.configure.world.region_preference": "Bevorzugte Region",
	"mco.configure.world.region_preference.title": "Regionswoi",
	...
	"mco.configure.world.resourcepack.question": "Du brauchst a bsondas Ressourcenpackerl um af dem Realm spuin z kinna\n\nWuist as obalon und spuin?",
	...
	"mco.configure.world.settings.expired": "Du kost d Einstellungen vo am obglafana Realm ned ändern",
	...
	"mco.configure.world.spawnMonsters": "Monster erschaff’n",
	"mco.configure.world.spawnNPCs": "Dorfbewohna erzeign",
	"mco.configure.world.spawnProtection": "Spawnpunktschutz",
	"mco.configure.world.spawn_toggle.message": "Wennst de Option obschoitst, wern alle vorhandanen Objekte vo dem Typ g'löscht",
	"mco.configure.world.spawn_toggle.message.npc": "Wennst de Option ausschoitst, werdn olle vorhandna Entitätn von dem Typ entfernt, wia z. B. Dorfbwohna",
	"mco.configure.world.spawn_toggle.title": "Obacht!",
	...
	"mco.configure.world.subscription.recurring.info": "Ändarungen an deim Realms-Abo wia a Verlängerung oda as ausschoitn vo wiederkehrende Rechnungen tretn erst mid da nächstn Rechnung in Kraft.",
	"mco.configure.world.subscription.remaining.days": "%[1]s Dog",
	"mco.configure.world.subscription.remaining.months": "%[1]s Monat",
	"mco.configure.world.subscription.remaining.months.days": "%[1]s Monat, %[2]s Dog",
	"mco.configure.world.subscription.start": "Beginn",
	"mco.configure.world.subscription.tab": "Abo",
	...
	"mco.connect.success": "Ois fertig",
	"mco.create.world": "Erzeign",
	"mco.create.world.error": "Du musst oanen Nama eingebn!",
	"mco.create.world.failed": "Weid hod ned ersteit wern kinna!",
	...
	"mco.download.confirmation.oversized": "D Weid, de du obalon wuist is greßa ois wia %s\n\nDu wiast as nimma aufs Realm hochlon kinna",
	...
	"mco.download.resourcePack.fail": "Obalon vom Ressourcenpackal feigschlong!",
	...
	"mco.errorMessage.6005": "Wäid gsperrt",
	"mco.errorMessage.6006": "Wäid is ned meah aktuell",
	"mco.errorMessage.6007": "Nutzer is in zfui Realms",
	"mco.errorMessage.6008": "Unguitiger Realm-Nom",
	"mco.errorMessage.6009": "Unguitige Realm-Beschreibung",
	"mco.errorMessage.connectionFailure": "A Fehla is afdrehn, vasouchs bitte spada numal.",
	"mco.errorMessage.generic": "Do is wos foisch glafa: ",
	"mco.errorMessage.initialize.failed": "Realm hod ned Initialisiert wern kinna",
	"mco.errorMessage.noDetails": "Koane Details zim Fehla vorhandn",
	"mco.errorMessage.realmsService": "Es is wos schied glafa (%s):",
	"mco.errorMessage.realmsService.configurationError": "A unerwarteta Fehler is auftretn wärend d Weidoptionen bearbeitet worn san",
	"mco.errorMessage.realmsService.connectivity": "Hod si ned mit Realm vabindn kinna: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Kompatible Version hod ned übaprüft wern kinna, hod Antwort griagt: %s",
	"mco.errorMessage.retry": "Vorganga nomoi probiern",
	...
	"mco.minigame.world.switch.title": "Minispui wechsln",
	"mco.minigame.world.title": "Realm zu Minispül wechseln",
	"mco.news": "Realms‐Neiigkeitn",
	"mco.notification.dismiss": "Schliaßn",
	"mco.notification.transferSubscription.buttonText": "Jetz übatrong",
	"mco.notification.transferSubscription.message": "Java Realms-Abos wechseln zum Microsoft Store. Loss dei Abo ned auslafa!\nWechsl jetzad und gtaig 30 Dog Realms fia lau.\nGeh zu Profil af minecraft.net um dei Abo ume z transferiern.",
	"mco.notification.visitUrl.buttonText.default": "Link afmacha",
	"mco.notification.visitUrl.message.default": "Bitte schau da den Link untn i",
	"mco.onlinePlayers": "Spiela online",
	"mco.play.button.realm.closed": "Realm is zua",
	"mco.question": "Frage",
	...
	"mco.reset.world.title": "Wäid zrucksetzn",
	...
	"mco.selectServer.configureRealm": "Realm eirichtn",
	"mco.selectServer.create": "Realm erstölln",
	"mco.selectServer.create.subtitle": "Wähle, weiche Weid auf dein neien Realm soi",
	...
	"mco.selectServer.purchase": "Realm hinzuafügen",
	"mco.selectServer.trial": "Probias as!",
	"mco.selectServer.uninitialized": "Realm nei erstölln!",
	"mco.snapshot.createSnapshotPopup.text": "Du bist dabei a kostnloses Snapshit Realm z erstein, des mit deim bezahltn Realms-Abo vabundn wird. Des neie Snapshot Realm bleibt so lang nutzbar wia as bezahlte Abo aktiv is. An deim bezahltn Realm ändat si nix.",
	"mco.snapshot.createSnapshotPopup.title": "Snapshit Realm erstein?",
	"mco.snapshot.creating": "Snapshot Realm wird ersteit...",
	"mco.snapshot.description": "Vabundn mit \"%s\"",
	"mco.snapshot.friendsRealm.downgrade": "Du muast in Version %s spuin um dem Realm beiztretn",
	"mco.snapshot.friendsRealm.upgrade": "%s muas den Realm upgradn, bevorst mit der Version spuin kost",
	"mco.snapshot.paired": "Der Snapshot-Realm is vabundn mit \"%s\"",
	"mco.snapshot.parent.tooltip": "Benutz d neiseste Minecraft Version um auf dem Realm z spuin",
	"mco.snapshot.start": "Starte gratis Snapshot-Realm",
	"mco.snapshot.subscription.info": "Des is a Snapshot-Realms, der mit dwim Abo von Realm '%s' vabundn is. Er wiad aktiv bleim so lang wias vabundene Realm.",
	"mco.snapshot.tooltip": "Nutze Snapshot-Realms um a kurze Vorschau fia d nächstn Minecraft Versionen z griang, wos neie Features und andere Änderungen beinhalten kannt.\n\nDu kost deine normaln Realms in da öffentlichn Version findn.",
	"mco.snapshotRealmsPopup.message": "Realms gibts jetz a auf Snapshots ab Snapshot 23w41a. A jeds Realms-Abo kimmt mit am gratis Snapshot-Realm, des seperat vo deim normaln Java-Realm is!",
	"mco.snapshotRealmsPopup.title": "Realms gibts jetz in Snapshots",
	"mco.snapshotRealmsPopup.urlText": "Meah eafahrn",
	...
	"mco.template.title": "Wäidvorlogn",
	...
	"mco.time.daysAgo": "Vor %[1]s Dog ",
	"mco.time.hoursAgo": "Vor %[1]s Stund(n)",
	"mco.time.minutesAgo": "Vor %[1]s Minutn",
	"mco.time.now": "grod jetz",
	"mco.time.secondsAgo": "Vor %[1]s Sekundn",
	...
	"mco.upload.failed.too_big.description": "D ausgweide Weid is z groß. D maximale Größe is %s.",
	"mco.upload.failed.too_big.title": "Wäid zu grouß",
	...
	"mco.upload.select.world.title": "Wäid houchladn",
	...
	"mco.warning": "Owachd!",
	"mco.worldSlot.minigame": "Minispui",
	"menu.custom_options": "Bnutzerdefinierte Optiona...",
	"menu.custom_options.title": "Bnutzerdefinierte Optiona",
	"menu.custom_options.tooltip": "Hinweis: Bnutzerdefinierte Optiona kemman vo Servern und/oder Inhalt Dritter. Obacht!",
	"menu.custom_screen_info.button_narration": "Des is a bnutzerdefinierte Ansicht. Mehr dazua.",
	"menu.custom_screen_info.contents": "Da Inhalt von dera Ansicht werd vo Drittanbieter-Servern und -Karten g’steiert, de ned zu Mojang Studios oder Microsoft g’hörn, von eana betriebn oder überwacht werdn.\n\nObacht damit! Sei immer vorsichtig, wennst Links folgst, und gib nia dei oagene Informationa her, wia dei Anmeldedaten.\n\nWenn di de Ansicht am Spuin hindert, kannst di a vom aktuellen Server trennan, indemst unten auf den Knopf druckst.",
	"menu.custom_screen_info.disconnect": "Bnutzerdefinierte Ansicht abg’lehnt",
	"menu.custom_screen_info.title": "Hinweis zu bnutzerdefiniertn Ansichten",
	"menu.custom_screen_info.tooltip": "Des is a bnutzerdefinierte Ansicht. Do klickn, um mehr z’erfahrn.",
	...
	"menu.quick_actions": "Schneiaktionen...",
	"menu.quick_actions.title": "Schneiaktionen",
	...
	"multiplayer.codeOfConduct.check": "Fia den Verhaltenskodex nimma benachrichtign",
	"multiplayer.codeOfConduct.title": "Server‐Verhaltenskodex",
	"multiplayer.confirm_command.parse_errors": "Du versuachst, an unbekannten oder ungültign Befehl ausz'führn.\nBist da sicher?\nBefehl: %s",
	"multiplayer.confirm_command.permissions_required": "Du versuachst, an Befehl ausz'führn, der erhöhte Rechte braucht.\nDes ko s’Spui negativ beeinflussn.\nBist da sicher?\nBefehl: %s",
	"multiplayer.confirm_command.run_command": "Befehl ausfüahrn",
	"multiplayer.confirm_command.signature_required": "Du versuachst, an Befehl ausz'führn, der Chat-Nachrichtn in deim Nam verschickt.\nDer Befehl ko bloß im Chat-Fenster ausgführt wern.\nBefehl: %s",
	"multiplayer.confirm_command.suggest_command": "Ins Chatfenster kopiarn",
	"multiplayer.confirm_command.title": "Befehlsausfiahrung b'stätign",
	...
	"multiplayer.disconnect.bad_chat_index": "A verpasste oder falsch ei’gordnete Chat-Nachricht vom Server is erkannt worn",
	...
	"multiplayer.disconnect.banned.reason.default": "Von am Operator g’sperrt.",
	...
	"multiplayer.disconnect.code_of_conduct": "Da Server verlangt, dass ma am Verhaltenskodex zua’stimmt",
	"multiplayer.disconnect.configuration_error": "Unerwarteter Fehler bei da Konfiguration",
	...
	"multiplayer.disconnect.invalid_public_key_signature.new": "Unguitige Signatur fian öffentlichn Profilschlüssl.\nVasuach as Spui nei z startn.",
	...
	"multiplayer.disconnect.transfers_disabled": "Der Serva nimmt koane Übertragungen o",
	...
	"multiplayer.lan.server_found": "Neia Server gfundn: %s",
	...
	"multiplayer.status.anonymous_player": "Anonyma Spieler",
	...
	"multiplayer.status.player_count.narration": "%s vo %s Spielan online",
	...
	"narration.checkbox.usage.focused.check": "Druck d’Eingabetastn zum Auswähln",
	"narration.checkbox.usage.focused.uncheck": "Druck d’Eingabetastn zum Obwähln",
	"narration.checkbox.usage.hovered": "Links Klick zum Aktivieren",
	"narration.checkbox.usage.hovered.check": "Linksklick zum Auswähln",
	"narration.checkbox.usage.hovered.uncheck": "Linksklick zum Obwähln",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Druck d’Eingabetastn, um’n Wert vom Schieberegler z’ändern",
	...
	"narration.suggestion.usage.cycle.fixed": "Druck TAB um zum nächstn Vorschlag z kemma",
	"narration.suggestion.usage.cycle.hidable": "Druck TAB um zum nächstn Vorschlag z kemma, oda Esc um d Vorschläge z valossn",
	"narration.suggestion.usage.fill.fixed": "Druck TAB um an Vorschlag z nutzn",
	"narration.suggestion.usage.fill.hidable": "Druck TAB um den Vorschlag z nutzn, oda Esc um d Vorschläge z valossn",
	"narration.tab_navigation.usage": "Druck Ctrl und TAB um zwischn Tabs z wechsln",
	...
	"narrator.position.tab": "Tab %s vo %s ausgweid",
	"narrator.ready_to_play": "Bereit zum spuin",
	...
	"narrator.select.world_info": "%s ausgweid, zletzt gspuid: %s, %s",
	...
	"optimizeWorld.confirm.proceed": "Kopie erstelln und optimiern",
	...
	"optimizeWorld.stage.finished": "Fertistäin...",
	"optimizeWorld.stage.finished.chunks": "Chunkaktualisierung wiad fertig gsteid...",
	"optimizeWorld.stage.finished.entities": "Viechaaktualisierung wiad fertig gsteid...",
	"optimizeWorld.stage.finished.poi": "Zielpunktaktualisierung wiad fertig gsteid...",
	"optimizeWorld.stage.upgrading": "Olle Chunks wern aktualisiert...",
	"optimizeWorld.stage.upgrading.chunks": "Olle Chunks wern aktualisiert...",
	"optimizeWorld.stage.upgrading.entities": "Olle Viecha wern aktualisiad...",
	"optimizeWorld.stage.upgrading.poi": "Olle Zielpunkte wern aktualisiad...",
	"optimizeWorld.title": "Weyd ‚%s‘ wiad optimiert",
	"options.accessibility": "Barrierefreiheitseistellungen...",
	"options.accessibility.high_contrast": "Houha Kontrast",
	"options.accessibility.high_contrast.error.tooltip": "As hochkontrastige Ressourcenpackal is ned vafügbar.",
	"options.accessibility.high_contrast.tooltip": "Vastärkt an Kontrast vo UI Zeigs.",
	"options.accessibility.high_contrast_block_outline": "Kontrastreiche Blockumrisse",
	"options.accessibility.high_contrast_block_outline.tooltip": "Erhöht'n Kontrast vo de Umrisslinien vom gezeigten Block.",
	"options.accessibility.link": "Leitfadn zua Barrierefreiheit",
	"options.accessibility.menu_background_blurriness": "Menühintergrundsvaschwommenheit",
	"options.accessibility.menu_background_blurriness.tooltip": "Ändat d Vaschwommenheit vom Hintergrund vom Menü.",
	"options.accessibility.narrator_hotkey": "Erzählakuazwoi",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Erlaubt an Erzähla mit 'Cmd+B' o und auszschoitn.",
	"options.accessibility.narrator_hotkey.tooltip": "Erlaubt an Erzähla mit 'Ctrl+B' o und auszschoitn.",
	"options.accessibility.panorama_speed": "Panorama‐Buidllaffschneiigkeid",
	...
	"options.allowCursorChanges": "Mauszeiger-Änderungen erlaubn",
	"options.allowCursorChanges.tooltip": "Wenn aktiviert, passt da Mauszeiger in da Benutzeroberfläche sei Form an’s Objekt o, des du anvisierst.",
	...
	"options.blocks": "%s Blöcke",
	"options.chat": "Chatoastellungen...",
	"options.chat.color": "Foaben",
	"options.chat.delay": "Chatvazögerung: %s Sekundn",
	"options.chat.delay_none": "Chatvazögerung: Koane",
	"options.chat.drafts": "Ungesendete Chatnachrichten speichern",
	"options.chat.drafts.tooltip": "Nicht gesendete Nachrichten werden gespeichert und können beim nächsten Öffnen des Chats gesendet werden.",
	...
	"options.chunkFade": "Chunk‐Einblendungszeit",
	"options.chunkFade.none": "Chunk‐Einblendung: Keine",
	"options.chunkFade.seconds": "Chunk‐Einblendung: %s Sekunde(n)",
	"options.chunkFade.tooltip": "Wie viele Sekunden lang Chunks beim ersten Rendern einblenden sollen, wenn überhaupt.",
	"options.chunks": "%s Chunks",
	"options.clouds.fancy": "Schee",
	"options.clouds.fast": "Gaach",
	"options.controls": "Steuerung …",
	"options.credits_and_attribution": "Mitwirknde und andane Anerkennungen...",
	"options.cutoutLeaves": "Durchsichtiges Laub",
	"options.cutoutLeaves.tooltip": "Ermöglicht die Sicht durch Lücken im Laub. Deaktivieren kann die Leistung verbessern.",
	"options.damageTiltStrength": "Schonwacklerei",
	"options.damageTiltStrength.tooltip": "Wia stoak d Kamera wacklt, wennst Schon griagst.",
	...
	"options.darknessEffectScale.tooltip": "Steierd wia stoak da Dunklheit - Effekt pulsiad, wenn da Warden oda a Sculk-Schreia den da gibt.",
	"options.difficulty": "Schwierigkeit",
	"options.difficulty.easy": "Oafach",
	"options.difficulty.easy.info": "Feindliche Viecha spawnen, mochan aba wenga Schon. Hunga geht valohn und mocht bis 5 Herzn Schon.",
	"options.difficulty.hard": "Schwar",
	"options.difficulty.hard.info": "Feindliche Viecha spawnen und mochan mehr Schon. Hunga geht valohn und ko alle Herzn nemma.",
	"options.difficulty.hardcore": "Hardcore",
	"options.difficulty.normal": "Normoal",
	"options.difficulty.normal.info": "Feindliche Viecha spawnen und mochan normalen Schon. Hunga geht valohn und mocht bis auf a hoibads Herz Schon.",
	"options.difficulty.online": "Serva‐Schwierigkeit",
	"options.difficulty.peaceful": "Friedlich",
	"options.difficulty.peaceful.info": "Koane feindlichn Viecha und nur manche neutrale Viecher spawnan. Hunga geht ned valohn und Herzn werb wieder afgfüllt üba Zeid.",
	"options.directionalAudio": "Richdungs Audio",
	"options.directionalAudio.off.tooltip": "Klassischa Stereo ton",
	"options.directionalAudio.on.tooltip": "Nutzt HRTF-basiertn Raumsound um d Simulation vo am 3D Raum z vabessan. Erfordat HRTF-kompatible Hardware und is am bestn mit Kopfhörer.",
	...
	"options.exclusiveFullscreen": "Exklusives Vollbild",
	"options.exclusiveFullscreen.warningTooltip": "Diese Option kann dazu führen, dass einige Eingabemethoden nicht funktionieren.",
	"options.font": "Schriftoatoastellungen...",
	"options.font.title": "Schriftoatoanstellungen",
	...
	"options.fovEffectScale.tooltip": "Steierd wia fui si as Sichtfeid duach Spuimechanikeffekte gändat wern ko.",
	...
	"options.glintSpeed": "Schimmergschwindigkeit",
	"options.glintSpeed.tooltip": "Ändat wia schnei vazaubats Zeigs schimmert.",
	"options.glintStrength": "Schimmerstärkn",
	"options.glintStrength.tooltip": "Ändat wia transparent da Schimmer vo vazaubatm Zeigs is.",
	...
	"options.graphics.preset": "Voreinstellung",
	"options.graphics.preset.tooltip": "Setzt die Einstellungen für „Qualität & Leistung“ auf sinnvolle Standardwerte, die der gewünschten Qualität entsprechen.",
	"options.graphics.warning.accept": "Ohne Untastützung weida mocha",
	"options.graphics.warning.cancel": "Bring mi zruck",
	...
	"options.graphicsApi": "Grafikbibliothek",
	"options.graphicsApi.default": "Standard",
	"options.graphicsApi.opengl": "OpenGL bevorzugen",
	"options.graphicsApi.restart": "Du musst das Spiel neu starten, um die Grafikschnittstelle zu ändern.",
	"options.graphicsApi.tooltip": "Steuert, mit welcher Grafikbibliothek das Bild erzeugt wird. Behalte den Standard bei, sofern du keinen Anlass hast, diese Einstellung zu ändern!",
	"options.graphicsApi.tooltip.vulkan": "Experimentell. Kann auf einigen Geräten zu Leistungseinbußen oder Instabilität führen.",
	"options.graphicsApi.vulkan": "Vulkan bevorzugen",
	...
	"options.hideLightningFlashes.tooltip": "Blitze erleichtn an Himml nimma. D Blitze seiba werst scho no seng kinna.",
	"options.hideMatchedNames": "Nach Nama filtan",
	"options.hideMatchedNames.tooltip": "Server vo Drittanbietan kanntn Chatnachrichtn in unnormale Formate schicka.\nMid ser Option wern vasteckte Spiela erane Nachrichten anhand vo Chatabsendernamen zuagordnet.",
	"options.hideSplashTexts": "Menüsprichal ausblendn",
	"options.hideSplashTexts.tooltip": "Vasteckt des geibe Gschreibsl im Hauptmenü.",
	"options.improvedTransparency": "Verbesserte Transparenz",
	"options.improvedTransparency.tooltip": "Ein experimenteller Ansatz, bei dem Bildschirm‐Shader zur Darstellung von Wetter, Wolken und Partikeln hinter lichtdurchlässigen Blöcken und Wasser verwendet werden.\nDies wirkt sich auf die Grafikleistung aus.",
	...
	"options.inactivityFpsLimit": "FPS verringern, wenn",
	"options.inactivityFpsLimit.afk": "Obwesend",
	"options.inactivityFpsLimit.afk.tooltip": "Begrenzt die Bildwiederholrate auf 30 Bilder pro Sekunde, wenn der Spieler länger als 1 Minute keine Eingabe tätigt. Begrenzt sie nach 9 weiteren Minuten auf 10 Bilder pro Sekunde.",
	"options.inactivityFpsLimit.minimized": "Minimiert",
	"options.inactivityFpsLimit.minimized.tooltip": "Begrenzt die Bildwiederholrate nur dann, wenn das Spielfenster minimiert ist.",
	"options.invertMouse": "Maus umkehrn",
	"options.invertMouseX": "X‐Mausachse umkehren",
	"options.invertMouseY": "Y‐Mausachse umkehren",
	"options.japaneseGlyphVariants": "Japanische Glyphnvariantn",
	"options.japaneseGlyphVariants.tooltip": "Nutzt japanische Variantn vo CJK-Zeichn in da Standartschriftart.",
	...
	"options.languageAccuracyWarning": "(Übasetzungen kanntn ned 100%% richtig sei)",
	...
	"options.maxAnisotropy": "Anisotrope Filterung",
	"options.maxAnisotropy.tooltip": "Jede Stufe verbessert deutlich, wie glatt Texturen aussehen. Wirkt sich jedoch auf die Leistung aus und erhöht den Speicherbedarf der Grafikkarte erheblich. „Texturfilterung“ muss auf „Anisotrop“ gestellt sein.",
	...
	"options.musicToast.never.tooltip": "Musiktitel werden nicht angezeigt.",
	"options.musicToast.pauseMenu": "Pausenmenü",
	"options.musicToast.pauseMenu.tooltip": "Eine Einblendung wird durchgehend im Pausenmenü des Spiels angezeigt, während ein Lied abgespielt wird.",
	"options.musicToast.pauseMenuAndToast": "Pausenmenü und Einblendung",
	"options.musicToast.pauseMenuAndToast.tooltip": "Zeigt eine Einblendung, sobald ein Lied zu spielen beginnt. Während das Lied abgespielt wird, ist diese Einblendung außerdem im Pausenmenü zu sehen.",
	"options.music_frequency": "Musikhäufigkeit",
	"options.music_frequency.constant": "Durchgängig",
	"options.music_frequency.default": "Standard",
	"options.music_frequency.frequent": "Häufig",
	"options.music_frequency.tooltip": "Steuert, wie häufig Musik beim Spielen in einer Welt wiedergegeben wird.",
	...
	"options.needsRestart": "Die Änderung wird mit dem nächsten Neustart wirksam.",
	"options.notifications.display_time": "Benochrichtigungsdaua",
	"options.notifications.display_time.tooltip": "Beeinflusst d Zeitdauer, wia lang Benachrichtigungen am Bildschirm sichtbar bleim.",
	"options.off": "Aus",
	...
	"options.operatorItemsTab": "Operatorzeigs-Tab",
	...
	"options.realmsNotifications": "Realms Neiigkeitn & Eilodungen",
	"options.realmsNotifications.button": "Neuigkeiten & Einladungen",
	"options.realmsNotifications.tooltip": "Ruaft Realms Neiigkeitn und Eilodungen im Hauptmenü ob und zoagt d entsprechendn Buidl aufm Realms Knopf a.",
	"options.reducedDebugInfo": "Reduzierte Debug-Infos",
	"options.renderClouds": "Woikn",
	"options.renderCloudsDistance": "Woiknentfernung",
	...
	"options.rotateWithMinecart": "Mit Loren mitdrehen",
	"options.rotateWithMinecart.tooltip": "Steuert, ob sich die Blickrichtung des Spielers mit Loren mitdreht. Nur in Welten verfügbar, in denen das Experiment „Lorenverbesse‐ rungen“ eingeschaltet ist.",
	...
	"options.showNowPlayingToast": "Liedtitel einblenden",
	"options.showNowPlayingToast.tooltip": "Zeigt eine Einblendung, sobald ein Lied zu spielen beginnt. Während das Lied abgespielt wird, ist diese Einblendung außerdem im Pausenmenü zu sehen.",
	"options.showSubtitles": "Untatitel oanzeign",
	"options.showSubtitles.tooltip": "Aktiviert Untertitel für Geräusche im Spiel.",
	...
	"options.sprintWindow": "Sprint‐Zeitfenster",
	"options.sprintWindow.tooltip": "Zeitfenster in Ticks, innerhalb dessen ein doppelter Anschlag der Vorwärtstaste den Spieler sprinten lässt.",
	"options.telemetry": "Telemetriedatn...",
	"options.telemetry.button": "Datnsammlung",
	"options.telemetry.button.tooltip": "\"%s\" beinhaltet nur d nötige Datn.\n\"%s\" beinhaltet dazua no ootionals Zeigs.",
	"options.telemetry.disabled": "Telemetrie is aus.",
	"options.telemetry.state.all": "Ois",
	"options.telemetry.state.minimal": "Minimoi",
	"options.telemetry.state.none": "Koane",
	"options.textureFiltering": "Texturfilterung",
	"options.textureFiltering.anisotropic": "Anisotrop",
	"options.textureFiltering.anisotropic.tooltip": "Eine hardwarebasierte Filtermethode, die sich allerdings auf die Leistung auswirkt und den Grafikspeicherbedarf erheblich erhöht. Wird möglicherweise nicht von allen Geräten unterstützt.",
	"options.textureFiltering.none": "Keine",
	"options.textureFiltering.none.tooltip": "Texturen werden ohne Filterung angezeigt. Blöcke können verschwommen aussehen, wenn sie aus einem bestimmten Winkel betrachtet werden.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nEine Shader‐basierte Filtermethode, welche die Texturqualität bei mäßigen Leistungseinbußen verbessert.",
	"options.title": "Optiona",
	"options.touchscreen": "Touchscreen-Modus",
	"options.value": "%s",
	"options.video": "Grafikoastellungen …",
	"options.video.display.header": "Anzeige",
	"options.video.interface.header": "Oberfläche",
	"options.video.preferences.header": "Präferenzen",
	"options.video.quality.header": "Qualität & Leistung",
	"options.videoTitle": "Grafikoastellungen",
	"options.viewBobbing": "Gehbewegung",
	"options.vignette": "Vignettierung anzeigen",
	"options.vignette.tooltip": "Ein subtiler Effekt im Sichtfeld, der die Bildschirmränder verdunkelt und auch vor der Weltbarriere warnt.",
	"options.visible": "Ois ozoang",
	"options.vsync": "VSync",
	"options.weatherRadius": "Wettereffekt‐Radius",
	"options.weatherRadius.tooltip": "Radius des Bereichs, in dem Regen‐ und Schneeeffekte sichtbar sind. Sehr geringe Auswirkung auf die Leistung.",
	"options.worldOptions.button": "Weltoptionen …",
	"options.worldOptions.title": "Weltoptionen",
	...
	"outOfMemory.title": "Koa Speichaplåtz meah!",
	...
	"pack.dropRejected.message": "D folgndn Eiträge warn koane guitign Packerl und san ned kopiert gworn:\n%s",
	"pack.dropRejected.title": "Ned-Pckerl-Eiträge",
	...
	"pack.incompatible.confirm.unknown": "Dieses Paket ist beschädigt oder für eine unbekannte Minecraft‐Version erstellt worden und funktioniert möglicherweise nicht richtig.",
	...
	"painting.minecraft.lowmist.title": "Nebelschwaden",
	...
	"painting.minecraft.sunflowers.title": "Sunnableamen",
	"painting.minecraft.sunset.author": "Kristoffer Zetterstrand",
	"painting.minecraft.sunset.title": "As Omdroud",
	"painting.minecraft.tides.author": "Kristoffer Zetterstrand",
	"painting.minecraft.tides.title": "Nordländerprobleme",
	"painting.minecraft.unpacked.author": "Sarah Boeving",
	"painting.minecraft.unpacked.title": "Entpackt",
	"painting.minecraft.void.author": "Kristoffer Zetterstrand",
	"painting.minecraft.void.title": "Des Nix",
	"painting.minecraft.wanderer.author": "Kristoffer Zetterstrand",
	"painting.minecraft.wanderer.title": "Strawanzer",
	"painting.minecraft.wasteland.author": "Kristoffer Zetterstrand",
	"painting.minecraft.wasteland.title": "Die Ödnis",
	"painting.minecraft.water.author": "Mojang",
	"painting.minecraft.water.title": "Wåssa",
	"painting.minecraft.wind.author": "Mojang",
	"painting.minecraft.wind.title": "Luft",
	"painting.minecraft.wither.author": "Mojang",
	"painting.minecraft.wither.title": "Da Wither",
	...
	"particle.invalidOptions": "Partikeleigenschaften können nicht ausgewertet werden: %s",
	...
	"realms.configuration.region.central_us": "Iowa, Vereinigte Staaten",
	"realms.configuration.region.east_asia": "Hongkong",
	"realms.configuration.region.east_us": "Virginia, Vereinigte Staaten",
	"realms.configuration.region.east_us_2": "North Carolina, Vereinigte Staaten",
	"realms.configuration.region.france_central": "Frankreich",
	...
	"realms.configuration.region.north_central_us": "Illinois, Vereinigte Staaten",
	"realms.configuration.region.north_europe": "Irland",
	"realms.configuration.region.south_central_us": "Texas, Vereinigte Staaten",
	"realms.configuration.region.southeast_asia": "Singapur",
	"realms.configuration.region.sweden_central": "Schweden",
	"realms.configuration.region.uae_north": "Vereinigte Arabische Emirate (VAE)",
	"realms.configuration.region.uk_south": "Südengland",
	"realms.configuration.region.west_central_us": "Utah, Vereinigte Staaten",
	"realms.configuration.region.west_europe": "Niederlande",
	"realms.configuration.region.west_us": "Kalifornien, Vereinigte Staaten",
	"realms.configuration.region.west_us_2": "Washington, Vereinigte Staaten",
	"realms.configuration.region_preference.automatic_owner": "Automatisch (nahe Realm‐Besitzer)",
	"realms.configuration.region_preference.automatic_player": "Automatisch (abhängig vom erstn Spiela der gejoined is)",
	...
	"recover_world.bug_tracker": "An Fehler mein",
	"recover_world.button": "Wiederherstellung wiad vasuacht",
	"recover_world.done.failed": "Hod ned aus am vorherigen Zustand wiederhergsteid wern kinna.",
	"recover_world.done.success": "Wiederherstellung war erfoigreich!",
	"recover_world.done.title": "Wiederherstellung ferti",
	"recover_world.issue.missing_file": "Do feihd wos",
	"recover_world.issue.none": "Koane Probleme",
	"recover_world.message": "D foigenden Probleme san bassiad während da Weidordner \"%s\" glesn worn is.\nDu kost vasuacha d Weid aus am eidern Zustand wiederhersteinoder du kost des Problem am bug tracker mein.",
	"recover_world.no_fallback": "Koa Zustand zum wiederherstein vorhandn",
	"recover_world.restore": "Wiederherstellung wiad vasuacht",
	"recover_world.restoring": "Vasuacht d Weid wiederherzstein...",
	"recover_world.state_entry": "Zustand vom %s: ",
	"recover_world.state_entry.unknown": "ned bekannt",
	"recover_world.title": "Weid hod ned glon wern kinna",
	"recover_world.warning": "Weidzamfassung hod ned glon wern kinna",
	"resourcePack.broken_assets": "KAPUTTE RESSOURCN GFUNDN",
	"resourcePack.high_contrast.name": "Houha Kontrast",
	"resourcePack.load_fail": "Neiladn da Ressourcn fehlg'schlogn",
	"resourcePack.programmer_art.name": "Programmiakunst",
	"resourcePack.runtime_failure": "Resourcenpaketfehler gfundn",
	"resourcePack.server.name": "Weidspezifische Ressourcn",
	"resourcePack.title": "Ressourcenpakete auswählen",
	"resourcePack.vanilla.description": "As Standartzeigs vo Minecraft hoid",
	...
	"restrictions_screen.button": "Einschränkungen …",
	"restrictions_screen.permission.receive_player_messages.allowed": "Du kannst Nachrichten von Mitspielern empfangen.",
	"restrictions_screen.permission.receive_player_messages.denied": "Du kannst keine Nachrichten von Mitspielern empfangen.",
	"restrictions_screen.permission.receive_system_messages.allowed": "Du kannst Systemnachrichten vom Server empfangen.",
	"restrictions_screen.permission.receive_system_messages.denied": "Du kannst keine Systemnachrichten vom Server empfangen.",
	"restrictions_screen.permission.send_commands.allowed": "Du kannst Befehle versenden.",
	"restrictions_screen.permission.send_commands.denied": "Du kannst keine Befehle versenden.",
	"restrictions_screen.permission.send_messages.allowed": "Du kannst Chatnachrichten versenden.",
	"restrictions_screen.permission.send_messages.denied": "Du kannst keine Chatnachrichten versenden.",
	"restrictions_screen.title": "Einschränkungen",
	...
	"selectWorld.allowCommands.new": "Commands erlaum",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Sicherheitskopie erstellen, bevor die Welt hochgestuft wird?",
	...
	"selectWorld.backupWarning.file_fixing_required": "Diese Welt muss hochgestuft werden, bevor du sie spielen kannst. Wir raten dringend dazu, zuvor eine Sicherheitskopie zu erstellen, da die Welt dabei beschädigt werden kann.",
	...
	"selectWorld.experimental.message": "AAAAAACHTUNG!!!!!\nDe Konfiguration braucht Funktionen, de imma no unter Entwicklung san. Kannt sei dass dei Weid komplett zahaud. Wird vielleicht mit weidere Updates a nur schlechter.",
	"selectWorld.experimental.title": "Obacht: Experimentelle Funktionen",
	"selectWorld.experiments": "Experimente",
	"selectWorld.experiments.info": "Experimente san mögliche neie Features. Bass af, weil Sachan hi geh kanntn. Du kost as nach der Weidgeneration a nimme ausmacha.",
	...
	"selectWorld.gameMode.adventure.info": "Genau s gleiche wia da Übalebensmodus, aba du kost a koane Blöcke plaziern oda abbaun.",
	...
	"selectWorld.gameMode.creative.info": "Erschaff, bau und erkund ohne Grenzn. Du kost fliang, host unendlich Material und kost vo Monstan ned valetzt wern.",
	...
	"selectWorld.gameMode.hardcore.info": "Übalebensmodus auf Schwar und du kost nachm Tod nimma respawnen.",
	...
	"selectWorld.gameMode.spectator.info": "Nua guckn, ned anfassn.",
	"selectWorld.gameMode.spectator.line1": "Nur guckn, ned anfassn",
	"selectWorld.gameMode.survival": "Überlem",
	"selectWorld.gameMode.survival.info": "Erkund a misteriöse Weid, in dersd baust, sammlst, bastlst und gega Monster kämpfst.",
	...
	"selectWorld.incompatible.description": "De Weid ko in der Version ned afgmocht wern.\nDe is zletzt gspuid worn in Version %s.",
	"selectWorld.incompatible.info": "Inkompatible Version: %s",
	"selectWorld.incompatible.title": "Inkompatible Version",
	"selectWorld.incompatible.tooltip": "De Weis ko ned göffnet wern, weils in ja inkompatiblen Version ersteit worn is.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Wegen grundlegender Änderungen am Weltformat muss diese Welt auf die neueste Version hochgestuft werden, bevor du sie bearbeiten kannst.",
	"selectWorld.requiresFileFixingTooltip.play": "Wegen grundlegender Änderungen am Weltformat muss diese Welt auf die neueste Version hochgestuft werden, bevor du sie betreten kannst.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Wegen grundlegender Änderungen am Weltformat muss diese Welt auf die neueste Version hochgestuft werden, bevor du sie neu erzeugen kannst.",
	"selectWorld.resource_load": "Bereitet Ressourcen voa...",
	...
	"selectWorld.targetFolder": "Speichaordner: %s",
	...
	"selectWorld.upgrade_and_play": "Hochstufen und spielen",
	...
	"selectWorld.waitingForBackup.message": "Dies kann eine Weile dauern, abhängig von der Größe deiner Welt. Bitte schließe das Spiel nicht und schalte dein Gerät nicht aus.",
	...
	"selectWorld.warning.lowDiskSpace.description": "Du host fast koan Speichablotz mehr. Wennst untam souin koan Speichablotzmehr host ko des zu Schon an deina Weid fian.",
	"selectWorld.warning.lowDiskSpace.title": "Owachd! Weng freia Speichaplåtz!",
	"selectWorld.world": "Weyd",
	"selectWorld.world_gen_settings_access": "Auf die Datei mit den Generierungseinstellungen konnte nicht zugegriffen werden! %s",
	"selecteWorld.backupRequiredTooltip": "Um die Welt zu laden, muss zunächst eine Sicherheitskopie erstellt werden.",
	...
	"slot.only_single_allowed": "Nur oanzlne Imventarplätze erlaubt, griagt '%s'",
	"slot.unknown": "Unbekonnta Inventarplatz ‚%s‘",
	"snbt.parser.empty_key": "Schlüssl deaf ned lar sei",
	"snbt.parser.expected_binary_numeral": "Binärzoi erwartet",
	"snbt.parser.expected_decimal_numeral": "Dezimalzoi erwartet",
	"snbt.parser.expected_float_type": "Gleitkomazoi erwartet",
	"snbt.parser.expected_hex_escape": "Zeichnkettn mit da Länge %s erwartet",
	"snbt.parser.expected_hex_numeral": "Hexadezimalzoi erwartet",
	"snbt.parser.expected_integer_type": "Ganzzoi erwartet",
	"snbt.parser.expected_non_negative_number": "Ned-negative Zoi erwartet",
	"snbt.parser.expected_number_or_boolean": "Zoi oda Boolean erwartet",
	"snbt.parser.expected_string_uuid": "String erwartet, der a guitige UUID darsteid",
	"snbt.parser.expected_unquoted_string": "Guitige String ohne Gänsefüßchen erwartet",
	"snbt.parser.infinity_not_allowed": "Ned-endliche Zoin san ned erlaubt",
	"snbt.parser.invalid_array_element_type": "Unguitiger Typ vo Listenelement",
	"snbt.parser.invalid_character_name": "Unguitiger Name vo Unicode-Character",
	"snbt.parser.invalid_codepoint": "Unguitiger Wert vo Unicode-Character: %s",
	"snbt.parser.invalid_string_contents": "Unguitiger Stringinhalt",
	"snbt.parser.invalid_unquoted_start": "Zeichenketten ohne Anführungszeichen dürfen nicht mit den Ziffern 0–9 oder mit den Zeichen + und − beginnen",
	"snbt.parser.leading_zero_not_allowed": "Dezimalzahlen dürfen nicht mit 0 beginnen",
	"snbt.parser.no_such_operation": "Oane Operation ‚%s‘ existiat ned",
	"snbt.parser.number_parse_failure": "Zahl konnte nicht gelesen werden: %s",
	"snbt.parser.undescore_not_allowed": "Unterstriche sind an Anfang und Ende einer Zahl nicht erlaubt",
	...
	"soundCategory.ui": "Benutzeroberfläche",
	...
	"stat.minecraft.happy_ghast_one_cm": "Strecke auf glücklichem Ghast geflogen",
	...
	"stat.minecraft.nautilus_one_cm": "Strecke auf Nautilus geritten",
	...
	"structure_block.detect_size": "Struktur Greßn und Position erkenna:",
	...
	"structure_block.include_entities": "Viecha eibeziang:",
	...
	"structure_block.strict": "Strikte Platzierung:",
	"structure_block.structure_name": "Konstruktionsnama",
	"subtitles.ambient.cave": "Graislichs Graisch",
	"subtitles.ambient.sound": "Komischs Gereisch",
	"subtitles.block.amethyst_block.chime": "Amethyst klingt",
	"subtitles.block.amethyst_block.resonate": "Amethyst schwingt mid",
	...
	"subtitles.block.candle.extinguish": "Kerzn erlischt",
	...
	"subtitles.block.copper_bulb.turn_off": "Kupfabiandl schoit aus",
	"subtitles.block.copper_bulb.turn_on": "Kupfabiandl schoit o",
	"subtitles.block.copper_chest.close": "Kistn geht zua",
	"subtitles.block.copper_chest.open": "Kistn tuat si auf",
	"subtitles.block.copper_trapdoor.close": "Klappdierl schliaßt",
	"subtitles.block.copper_trapdoor.open": "Klappdierl öffnet",
	"subtitles.block.crafter.craft": "Werka werklt",
	"subtitles.block.crafter.fail": "Werka schaffts werkln ned",
	"subtitles.block.creaking_heart.hurt": "Krachads Herz kracht",
	"subtitles.block.creaking_heart.idle": "Komischs Gereisch",
	"subtitles.block.creaking_heart.spawn": "Krachads Herz wacht af",
	"subtitles.block.deadbush.idle": "Zweige knistern",
	"subtitles.block.decorated_pot.insert": "Vaziata Krug füllt si",
	"subtitles.block.decorated_pot.insert_fail": "Vaziata Krug wacklt",
	"subtitles.block.decorated_pot.shatter": "Vaziata Krug zabricht",
	...
	"subtitles.block.dried_ghast.ambient": "Trockene Geräusche",
	"subtitles.block.dried_ghast.ambient_water": "Ausgetrockneter Ghast nimmt Wasser auf",
	"subtitles.block.dried_ghast.place_in_water": "Ausgetrockneter Ghast quillt",
	"subtitles.block.dried_ghast.transition": "Ausgetrocknetem Ghast geht es besser",
	...
	"subtitles.block.eyeblossom.close": "Augnbleame schliaßt",
	"subtitles.block.eyeblossom.idle": "Augnbleame flistad",
	"subtitles.block.eyeblossom.open": "Augnbleame geht af",
	...
	"subtitles.block.firefly_bush.idle": "Glühwürmchen schwirren",
	...
	"subtitles.block.generic.fall": "Wos foid auf an Block",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Schuidl wacklt",
	"subtitles.block.honey_block.slide": "Honiblock herunterrutschn",
	"subtitles.block.iron_trapdoor.close": "Klappdierl schliaßt",
	"subtitles.block.iron_trapdoor.open": "Klappdierl öffnet",
	...
	"subtitles.block.pale_hanging_moss.idle": "Komischs Gereisch",
	...
	"subtitles.block.potent_sulfur.noxious_gas": "Reizgas tritt auf",
	...
	"subtitles.block.sculk.spread": "Sculk breitet si aus",
	"subtitles.block.sculk_catalyst.bloom": "Sculk-Katalysator bliad af",
	...
	"subtitles.block.shelf.multi_swap": "Gegenstände getauscht",
	"subtitles.block.shelf.place_item": "Gegenstand abgelegt",
	"subtitles.block.shelf.single_swap": "Gegenstand getauscht",
	"subtitles.block.shelf.take_item": "Gegenstand entnommen",
	"subtitles.block.shulker_box.close": "Shulker-Kiste schliaßt",
	"subtitles.block.shulker_box.open": "Shulker-Kiste öffnet",
	"subtitles.block.sign.waxed_interact_fail": "Schuidl wacklt",
	"subtitles.block.smithing_table.use": "Schmieddisch benutzt",
	"subtitles.block.smoker.smoke": "Reichaofn reichat",
	"subtitles.block.sniffer_egg.crack": "Schnifer-Ei knaxst",
	"subtitles.block.sniffer_egg.hatch": "Schniffer-Ei schlipft",
	"subtitles.block.sniffer_egg.plop": "Schniffer plopt",
	"subtitles.block.sponge.absorb": "Schwamm saugt si voi",
	"subtitles.block.sweet_berry_bush.pick_berries": "Bean g'pflückt",
	"subtitles.block.trapdoor.close": "Falltür schließt",
	"subtitles.block.trapdoor.open": "Falltür öffnet",
	"subtitles.block.trapdoor.toggle": "Klappdierl knarrt",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Ominöses Item bereitet si vor",
	"subtitles.block.trial_spawner.ambient": "Priafungsspawna knistad",
	"subtitles.block.trial_spawner.ambient_charged": "Ominöses knistan",
	"subtitles.block.trial_spawner.ambient_ominous": "Ominöses knistan",
	"subtitles.block.trial_spawner.charge_activate": "Vorzeichn umhülln an Prüfungsspawna",
	"subtitles.block.trial_spawner.close_shutter": "Prüfungsspawna geht zua",
	"subtitles.block.trial_spawner.detect_player": "Prüfungsspawna lod af",
	"subtitles.block.trial_spawner.eject_item": "Prüfungsspawna wirft Item aus",
	"subtitles.block.trial_spawner.ominous_activate": "Vorzeichn umhülln an Prüfungsspawna",
	"subtitles.block.trial_spawner.open_shutter": "Prüfungsspawna geht af",
	"subtitles.block.trial_spawner.spawn_item": "Ominöss Item foid obe",
	"subtitles.block.trial_spawner.spawn_item_begin": "Ominöses itm daucht auf",
	"subtitles.block.trial_spawner.spawn_mob": "Prüfungsspawner mocht A Viech",
	...
	"subtitles.block.vault.activate": "Tresor entflammt",
	"subtitles.block.vault.ambient": "Tresor knistat",
	"subtitles.block.vault.close_shutter": "Tresor geht zua",
	"subtitles.block.vault.deactivate": "Tresor geht aus",
	"subtitles.block.vault.eject_item": "Tresor wirft a item raus",
	"subtitles.block.vault.insert_item": "Tresor wiad afgspart",
	"subtitles.block.vault.insert_item_fail": "Tresor akzepziert s DIng ned",
	"subtitles.block.vault.open_shutter": "Tresor geht af",
	"subtitles.block.vault.reject_rewarded_player": "Tresor lehnt an Spieler ab",
	"subtitles.block.water.ambient": "Wossa fließt",
	"subtitles.block.wet_sponge.dries": "Schwamm trocknet",
	"subtitles.chiseled_bookshelf.insert": "Buach wiad higsteid",
	"subtitles.chiseled_bookshelf.insert_enchanted": "Vazaubads Buach wiad higsteid",
	"subtitles.chiseled_bookshelf.take": "Buach wiad gnomma",
	"subtitles.chiseled_bookshelf.take_enchanted": "Vazaubads Buach wiad gnomma",
	...
	"subtitles.entity.armadillo.ambient": "Gürtltier grunzt",
	"subtitles.entity.armadillo.brush": "Hornschuidl wiad obe gebürstet",
	"subtitles.entity.armadillo.death": "Gürtltier stiabt",
	"subtitles.entity.armadillo.eat": "Gürtltier frisst",
	"subtitles.entity.armadillo.hurt": "Gürtltier nimmt Schodn",
	"subtitles.entity.armadillo.hurt_reduced": "Gürtltier schützt sich",
	"subtitles.entity.armadillo.land": "Gürteltier landet",
	"subtitles.entity.armadillo.peek": "Gürteltier späht",
	"subtitles.entity.armadillo.roll": "Gürteltier rollt sich ein",
	"subtitles.entity.armadillo.scute_drop": "Gürteltier wirft Hornschild ab",
	...
	"subtitles.entity.baby_cat.ambient": "Kätzchen miaut",
	"subtitles.entity.baby_cat.beg_for_food": "Kätzchen bettelt",
	"subtitles.entity.baby_cat.death": "Kätzchen stirbt",
	"subtitles.entity.baby_cat.eat": "Kätzchen frisst",
	"subtitles.entity.baby_cat.hiss": "Kätzchen faucht",
	"subtitles.entity.baby_cat.hurt": "Kätzchen nimmt Schaden",
	"subtitles.entity.baby_cat.purr": "Kätzchen schnurrt",
	"subtitles.entity.baby_chicken.ambient": "Küken piepst",
	"subtitles.entity.baby_chicken.death": "Küken stirbt",
	"subtitles.entity.baby_chicken.hurts": "Küken nimmt Schaden",
	"subtitles.entity.baby_horse.ambient": "Fohlen wiehert",
	"subtitles.entity.baby_horse.angry": "Fohlen wiehert",
	"subtitles.entity.baby_horse.breathe": "Fohlen schnaubt",
	"subtitles.entity.baby_horse.death": "Fohlen stirbt",
	"subtitles.entity.baby_horse.eat": "Fohlen frisst",
	"subtitles.entity.baby_horse.hurt": "Fohlen nimmt Schaden",
	"subtitles.entity.baby_horse.land": "Fohlen landet",
	"subtitles.entity.baby_nautilus.ambient": "Nautilusjunges zwitschert",
	"subtitles.entity.baby_nautilus.ambient_land": "Nautilusjunges zwitschert",
	"subtitles.entity.baby_nautilus.death": "Nautilusjunges stirbt",
	"subtitles.entity.baby_nautilus.death_land": "Nautilusjunges stirbt",
	"subtitles.entity.baby_nautilus.eat": "Nautilusjunges frisst",
	"subtitles.entity.baby_nautilus.hurt": "Nautilusjunges nimmt Schaden",
	"subtitles.entity.baby_nautilus.hurt_land": "Nautilusjunges nimmt Schaden",
	"subtitles.entity.baby_nautilus.swim": "Nautilusjunges schwimmt",
	...
	"subtitles.entity.baby_pig.hurt": "Ferkel nimmt Schaden",
	"subtitles.entity.baby_wolf.ambient": "Welpe jault",
	"subtitles.entity.baby_wolf.death": "Welpe stirbt",
	"subtitles.entity.baby_wolf.growl": "Welpe knurrt",
	"subtitles.entity.baby_wolf.hurt": "Welpe nimmt Schaden",
	"subtitles.entity.baby_wolf.pant": "Welpe hechelt",
	"subtitles.entity.baby_wolf.whine": "Welpe winselt",
	...
	"subtitles.entity.bogged.death": "Sumpfskelett stiabt",
	"subtitles.entity.bogged.hurt": "Sumpfskelett nimmt Schodn",
	"subtitles.entity.breeze.charge": "Böe lädt auf",
	...
	"subtitles.entity.breeze.whirl": "Böe wirbelt",
	"subtitles.entity.breeze.wind_burst": "Windkugel platzt",
	"subtitles.entity.camel.ambient": "Dromedar grunzt",
	"subtitles.entity.camel.dash": "Dromedar prischt",
	"subtitles.entity.camel.dash_ready": "Dromedar dahoid si",
	"subtitles.entity.camel.death": "Dromedar stirbt",
	"subtitles.entity.camel.eat": "Dromedar frisst",
	"subtitles.entity.camel.hurt": "Dromedar nimmt Schodn",
	"subtitles.entity.camel.saddle": "Dromedar wird gsattlt",
	"subtitles.entity.camel.sit": "Dromedar gnockt si hi",
	"subtitles.entity.camel.stand": "Dromedar steht af",
	"subtitles.entity.camel.step": "Dromedar laft",
	"subtitles.entity.camel.step_sand": "Dromedar laft im Sand",
	"subtitles.entity.camel_husk.ambient": "Zombiedromedar grummelt",
	...
	"subtitles.entity.camel_husk.hurt": "Zombiedromedar nimmt Schaden",
	"subtitles.entity.camel_husk.saddle": "Zombiedromedar gesattelt",
	"subtitles.entity.camel_husk.sit": "Zombiedromedar legt sich hin",
	...
	"subtitles.entity.copper_golem.death": "Kupfergolem stirbt",
	"subtitles.entity.copper_golem.hurt": "Kupfergolem nimmt Schaden",
	"subtitles.entity.copper_golem.item_drop": "Kupfergolem verstaut Gegenstand",
	"subtitles.entity.copper_golem.item_no_drop": "Kupfergolem kann Gegenstand nicht ablegen",
	"subtitles.entity.copper_golem.no_item_get": "Kupfergolem holt Gegenstand heraus",
	"subtitles.entity.copper_golem.no_item_no_get": "Kupfergolem kann Gegenstand nicht herausholen",
	"subtitles.entity.copper_golem.spawn": "Kupfergolem erscheint",
	"subtitles.entity.copper_golem.spin": "Kupfergolemkopf dreht sich",
	"subtitles.entity.copper_golem_become_statue": "Kupfergolem erstarrt",
	"subtitles.entity.copper_golem_oxidized.death": "Kupfergolem stirbt",
	"subtitles.entity.copper_golem_oxidized.hurt": "Kupfergolem nimmt Schaden",
	"subtitles.entity.copper_golem_oxidized.spin": "Kupfergolemkopf dreht sich",
	"subtitles.entity.copper_golem_weathered.death": "Kupfergolem stirbt",
	"subtitles.entity.copper_golem_weathered.hurt": "Kupfergolem nimmt Schaden",
	"subtitles.entity.copper_golem_weathered.spin": "Kupfergolemkopf dreht sich",
	...
	"subtitles.entity.creaking.activate": "Knarz lauert",
	"subtitles.entity.creaking.ambient": "Knarz knarzt",
	"subtitles.entity.creaking.attack": "Knarz greift an",
	"subtitles.entity.creaking.deactivate": "Knarz beruhigt sich",
	"subtitles.entity.creaking.death": "Knarz zerbröckelt",
	"subtitles.entity.creaking.freeze": "Knarz erstarrt",
	"subtitles.entity.creaking.spawn": "Knarz nimmt Gestalt an",
	"subtitles.entity.creaking.sway": "Knarz getroffen",
	"subtitles.entity.creaking.twitch": "Knarz zuckt",
	"subtitles.entity.creaking.unfreeze": "Knarz rührt sich",
	...
	"subtitles.entity.fish.swim": "Platschn",
	...
	"subtitles.entity.ghastling.ambient": "Ghastlein gurrt",
	"subtitles.entity.ghastling.death": "Ghastlein stirbt",
	"subtitles.entity.ghastling.hurt": "Ghastlein nimmt Schaden",
	"subtitles.entity.ghastling.spawn": "Ghastlein erscheint",
	...
	"subtitles.entity.happy_ghast.ambient": "Glücklicher Ghast trällert",
	"subtitles.entity.happy_ghast.death": "Glücklicher Ghast stirbt",
	"subtitles.entity.happy_ghast.equip": "Geschirr angelegt",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Glücklicher Ghast ist flugbereit",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Glücklicher Ghast hält an",
	"subtitles.entity.happy_ghast.hurt": "Glücklicher Ghast nimmt Schaden",
	"subtitles.entity.happy_ghast.unequip": "Geschirr abgenommen",
	...
	"subtitles.entity.minecart.inside": "Lore rattert",
	"subtitles.entity.minecart.inside_underwater": "Lore rattert unter Wasser",
	...
	"subtitles.entity.mule.jump": "Maultier springt",
	"subtitles.entity.nautilus.ambient": "Nautilus klappert",
	"subtitles.entity.nautilus.ambient_land": "Nautilus klappert",
	...
	"subtitles.entity.nautilus.hurt": "Nautilus nimmt Schaden",
	"subtitles.entity.nautilus.hurt_land": "Nautilus nimmt Schaden",
	...
	"subtitles.entity.parched.ambient": "Vertrockneter knistert",
	"subtitles.entity.parched.death": "Vertrockneter stirbt",
	"subtitles.entity.parched.hurt": "Vertrockneter nimmt Schaden",
	...
	"subtitles.entity.parrot.imitate.camel_husk": "Papagei grummelt",
	...
	"subtitles.entity.parrot.imitate.parched": "Papagei knistert",
	...
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Papagei gurgelt",
	...
	"subtitles.entity.pig.eat": "Schwein frisst",
	"subtitles.entity.pig.hurt": "Sei nimmt Schadn",
	"subtitles.entity.pig.saddle": "Sattl wiad ausgerüstet",
	...
	"subtitles.entity.player.teleport": "Spiela teleportiert",
	...
	"subtitles.entity.sniffer.death": "Schniffler varreckt",
	"subtitles.entity.sniffer.digging": "Schniffler grobt",
	"subtitles.entity.sniffer.digging_stop": "Schniffler steht af",
	"subtitles.entity.sniffer.drop_seed": "Schniffler lost an Samen foin",
	"subtitles.entity.sniffer.eat": "Schniffler frisst",
	"subtitles.entity.sniffer.egg_crack": "Schniffler-Ei knaxst",
	"subtitles.entity.sniffer.egg_hatch": "Schniffler-Ei schlipft",
	"subtitles.entity.sniffer.happy": "Schniffler jauchzt",
	"subtitles.entity.sniffer.hurt": "Schniffler griagt Schon",
	"subtitles.entity.sniffer.idle": "Schniffler grunzt",
	"subtitles.entity.sniffer.scenting": "Schniffler riacht",
	"subtitles.entity.sniffer.searching": "Schniffler suacht",
	"subtitles.entity.sniffer.sniffing": "Schniffler schnupft",
	"subtitles.entity.sniffer.step": "Schniffler geht",
	...
	"subtitles.entity.sulfur_cube.absorb": "Schwefelwürfel gefüllt",
	"subtitles.entity.sulfur_cube.bounce": "Schwefelwürfel federt",
	"subtitles.entity.sulfur_cube.death": "Schwefelwürfel stirbt",
	"subtitles.entity.sulfur_cube.eject": "Block entnommen",
	"subtitles.entity.sulfur_cube.hit": "Schwefelwürfel getroffen",
	"subtitles.entity.sulfur_cube.hurt": "Schwefelwürfel nimmt Schaden",
	"subtitles.entity.sulfur_cube.push": "Schwefelwürfel geschoben",
	"subtitles.entity.sulfur_cube.squish": "Schwefelwürfel federt",
	"subtitles.entity.tadpole.death": "Kaulquappn freckt",
	"subtitles.entity.tadpole.flop": "Kaulquappe flopt rum",
	"subtitles.entity.tadpole.grow_up": "Kaulquappe wochst af",
	"subtitles.entity.tadpole.hurt": "Kaulquappe griagt Schon",
	...
	"subtitles.entity.warden.agitated": "Wächta stöhnt wütend",
	"subtitles.entity.warden.ambient": "Wächta heult",
	"subtitles.entity.warden.angry": "Wächta regt si af",
	...
	"subtitles.entity.warden.emerge": "Wächta daucht af",
	"subtitles.entity.warden.heartbeat": "Wächta sei Herz schlogt",
	"subtitles.entity.warden.hurt": "Wärta tuats weh",
	"subtitles.entity.warden.listening": "Wächta foid wos af",
	"subtitles.entity.warden.listening_angry": "Wächta foids wiatnd af",
	"subtitles.entity.warden.nearby_close": "Wächta nähert si",
	"subtitles.entity.warden.nearby_closer": "Wächta geht weida",
	"subtitles.entity.warden.nearby_closest": "Wächta kimmt ganz nah",
	"subtitles.entity.warden.roar": "Wärta bruit",
	"subtitles.entity.warden.sniff": "Wärta schnuppert",
	"subtitles.entity.warden.sonic_boom": "Wächta mocht bumm",
	"subtitles.entity.warden.sonic_charge": "Wächta sprintet los",
	"subtitles.entity.warden.step": "Wächta laft",
	"subtitles.entity.warden.tendril_clicks": "Wächta seine Antennen klickan",
	"subtitles.entity.wind_charge.throw": "Windkugel fliagt",
	"subtitles.entity.wind_charge.wind_burst": "Windkugel mocht bumm",
	...
	"subtitles.entity.wolf.bark": "Woif bellt",
	...
	"subtitles.entity.wolf.pant": "Woif hechelt",
	"subtitles.entity.wolf.shake": "Woif schüttelt sich",
	"subtitles.entity.wolf.whine": "Woif winselt",
	...
	"subtitles.entity.zombie_horse.angry": "Zombiepferd wiehert",
	...
	"subtitles.entity.zombie_nautilus.ambient": "Zombienautilus blubbert",
	"subtitles.entity.zombie_nautilus.ambient_land": "Zombienautilus blubbert",
	...
	"subtitles.entity.zombie_nautilus.hurt": "Zombienautilus nimmt Schaden",
	"subtitles.entity.zombie_nautilus.hurt_land": "Zombienautilus nimmt Schaden",
	...
	"subtitles.event.mob_effect.bad_omen": "Vorzeichn manifestiern",
	"subtitles.event.mob_effect.raid_omen": "Überfoi naht",
	"subtitles.event.mob_effect.trial_omen": "Ominöse Priafung kimmt glei",
	...
	"subtitles.item.armor.equip_copper": "Kupferrüstung scheppert",
	...
	"subtitles.item.armor.equip_nautilus": "Nautiluspanzer angelegt",
	...
	"subtitles.item.armor.equip_wolf": "Woifsrüstung wird festzurrt",
	"subtitles.item.armor.unequip_nautilus": "Nautiluspanzer abgenommen",
	"subtitles.item.armor.unequip_wolf": "Woifsrüstung geht oba",
	...
	"subtitles.item.brush.brushing.generic": "Abpinsln",
	"subtitles.item.brush.brushing.gravel": "Kies wird abpinslt",
	"subtitles.item.brush.brushing.gravel.complete": "Kies fertig abpinslt",
	"subtitles.item.brush.brushing.sand": "Sand wird abpinslt",
	"subtitles.item.brush.brushing.sand.complete": "Sand fertig abpinslt",
	...
	"subtitles.item.bundle.insert_fail": "Bündl voi",
	...
	"subtitles.item.crossbow.hit": "Pfeil drifft",
	...
	"subtitles.item.elytra.flying": "Wusch",
	...
	"subtitles.item.golden_dandelion.unuse": "Goldener Löwenzahn setzt Alterung fort",
	"subtitles.item.golden_dandelion.use": "Goldener Löwenzahn unterbricht Alterung",
	"subtitles.item.hoe.till": "Hau pflügt",
	"subtitles.item.honey_bottle.drink": "Schluckn",
	"subtitles.item.honeycomb.wax_on": "Wochsn",
	"subtitles.item.horse_armor.unequip": "Rossharnisch abgestreift",
	"subtitles.item.ink_sac.use": "Tintnbeitl kleckst",
	"subtitles.item.lead.break": "Leine reißt",
	"subtitles.item.lead.tied": "Leine angebunden",
	"subtitles.item.lead.untied": "Leine gelöst",
	"subtitles.item.llama_carpet.unequip": "Teppich abgestreift",
	"subtitles.item.lodestone_compass.lock": "Kompass af Leitstoa asg'richtet",
	"subtitles.item.mace.smash_air": "Streitkoim haud",
	"subtitles.item.mace.smash_ground": "Streitkoim haud",
	"subtitles.item.nautilus_saddle_equip": "Nautilus gesattelt",
	"subtitles.item.nautilus_saddle_underwater_equip": "Nautilus unter Wasser gesattelt",
	"subtitles.item.nether_wart.plant": "Pflanzna g'pflanzt",
	"subtitles.item.ominous_bottle.dispose": "Flaschn zabricht",
	"subtitles.item.saddle.unequip": "Sattel abgestreift",
	"subtitles.item.shears.shear": "Rebschaa schneidet",
	"subtitles.item.shears.snip": "Schere schneidet",
	"subtitles.item.shield.block": "Schuidl wehrt ab",
	"subtitles.item.shovel.flatten": "Schaufl planiert",
	"subtitles.item.spear.attack": "Speer sticht",
	"subtitles.item.spear.hit": "Speer trifft",
	"subtitles.item.spear.lunge": "Speer stößt vor",
	"subtitles.item.spear.use": "Anlauf mit Speer",
	"subtitles.item.spear_wood.attack": "Speer sticht",
	"subtitles.item.spear_wood.hit": "Speer trifft",
	"subtitles.item.spear_wood.use": "Anlauf mit Speer",
	...
	"subtitles.item.underwater_saddle.equip": "Wassertier gesattelt",
	"subtitles.item.wolf_armor.break": "Woifsrüstung bricht",
	"subtitles.item.wolf_armor.crack": "Woifsüstung bricht",
	"subtitles.item.wolf_armor.damage": "Woifsrüstung griagt Schon",
	"subtitles.item.wolf_armor.repair": "Woifsrüstung wiad repariert",
	"subtitles.particle.soul_escape": "Seele entweicht",
	"subtitles.ui.cartography_table.take_result": "Koate g'zeichnet",
	"subtitles.ui.hud.bubble_pop": "Atemluft geht aus",
	...
	"symlink_warning.message": "Weitn aus am Ordner mit symbolische Vaknüpfungen z lon ko unsicha sei, wennst ned woast wos du mochst.\nBitte schau da %s um mehr z lerna.",
	"symlink_warning.message.pack": "Packerl aus am Ordner mit symbolische Vaknüpfungen z lon ko unsicha sei, wennst ned woast wos du mochst.\nBitte schau da %s um mehr z lerna.",
	"symlink_warning.message.world": "Weitn aus am Ordner mit symbolische Vaknüpfungen z lon ko unsicha sei, wennst ned woast wos du mochst.\nBitte schau da %s um mehr z lerna.",
	"symlink_warning.more_info": "Meah Informationen",
	"symlink_warning.title": "Weidordner hod symbolische Verknüpfungen",
	"symlink_warning.title.pack": "Hinzugefügte(s) Paket(e) enthält/enthalten symbolische Verknüpfungen",
	"symlink_warning.title.world": "Weydordner enthält symbolische Verknüpfungn",
	...
	"telemetry.event.optional.disabled": "%s (Optional) – Deaktiviat",
	...
	"telemetry.event.world_load_times.description": "Es ist wichtig, dass wir verstehen, wie lange es dauert, eine Welt zu betreten, und wie sich das im Lauf der Zeit ändert. Wenn wir beispielsweise neue Spielelemente hinzufügen oder umfassende technische Änderungen vornehmen, müssen wir wissen, wie sich das auf die Ladezeiten auswirkt.",
	"telemetry.event.world_load_times.title": "Wäidladezeiden",
	...
	"telemetry.event.world_loaded.title": "Wäid geladn",
	...
	"telemetry.event.world_unloaded.title": "Weyd entladn",
	"telemetry.property.advancement_game_time.title": "Spuizeid (Ticks)",
	"telemetry.property.advancement_id.title": "Foatschridds-ID",
	...
	"telemetry.property.client_modded.title": "Klient modifiziat",
	"telemetry.property.dedicated_memory_kb.title": "Zugewiesener Arbeitsspeicher (KB)",
	"telemetry.property.event_timestamp_utc.title": "Zeidpunkt des Ereignisses (koordinierte Weydzeid)",
	"telemetry.property.frame_rate_samples.title": "Datenwerte zur Bildwiederholrate (FPS)",
	"telemetry.property.game_mode.title": "Spuimodus",
	"telemetry.property.game_version.title": "Spuiversion",
	"telemetry.property.launcher_name.title": "Launcher‐Nama",
	"telemetry.property.load_time_bootstrap_ms.title": "Initialisierungszeid (Millisekundn)",
	...
	"telemetry.property.new_world.title": "Neie Weyd",
	...
	"telemetry.property.realms_map_content.title": "Realms‐Weltinhalt (Name des Minispiels)",
	...
	"telemetry.property.server_modded.title": "Serva modifiziat",
	"telemetry.property.server_type.title": "Servatyp",
	...
	"telemetry.property.user_id.title": "Benutza‐ID",
	"telemetry.property.world_load_time_ms.title": "Weydladezeid (Millisekundn)",
	"telemetry.property.world_session_id.title": "Weyd‐Sitzungs‐ID",
	"telemetry_info.button.give_feedback": "Feedback gebn",
	"telemetry_info.button.privacy_statement": "Datnschutzerklärung",
	...
	"telemetry_info.property_title": "Enthaltene Datn",
	...
	"test.error.block_property_mismatch": "Zustand %s wurde als %s erwartet, war aber %s",
	"test.error.block_property_missing": "Blockeigenschaft nicht vorhanden. Eigenschaft %s wurde als %s erwartet",
	"test.error.entity_property": "Objekt %s erfüllte Test nicht: %s",
	"test.error.entity_property_details": "Objekt %s hat Test %s nicht erfüllt: %s erwartet, war aber %s",
	"test.error.expected_block": "Block %s erwartet, war aber %s",
	"test.error.expected_block_present": "Vorhandensein des Blocks %s erwartet",
	"test.error.expected_block_tag": "Block in #%s erwartet, war aber %s",
	"test.error.expected_container_contents": "Behälter muss enthalten: %s",
	"test.error.expected_container_contents_single": "Behälter muss ein %s enthalten",
	"test.error.expected_empty_container": "Behälter muss leer sein",
	"test.error.expected_entity": "%s erwartet",
	"test.error.expected_entity_around": "%s wurde bei %s, %s, %s erwartet",
	"test.error.expected_entity_count": "%s Objekte vom Typ %s erwartet; %s gefunden",
	"test.error.expected_entity_data": "Objektdaten %s wurden erwartet, waren aber %s",
	"test.error.expected_entity_data_predicate": "Objektdaten für %s stimmen nicht überein",
	"test.error.expected_entity_effect": "Effekt für %s wurde als %s %s erwartet",
	"test.error.expected_entity_having": "Objektinventar hätte %s enthalten sollen",
	"test.error.expected_entity_holding": "Objekt hätte %s halten sollen",
	"test.error.expected_entity_in_test": "Erwartete %s im Test",
	"test.error.expected_entity_not_touching": "%s wurde nicht als an %s, %s, %s angrenzend erwartet (relativ: %s, %s, %s)",
	"test.error.expected_entity_touching": "%s wurde als an %s, %s, %s angrenzend erwartet (relativ: %s, %s, %s)",
	"test.error.expected_item": "Gegenstand vom Typ %s erwartet",
	"test.error.expected_items_count": "%s Gegenstände vom Typ %s erwartet; %s gefunden",
	"test.error.fail": "Fehlkriterien erfüllt",
	"test.error.invalid_block_type": "Unerwarteter Blocktyp gefunden: %s",
	"test.error.missing_block_entity": "Fehlendes Blockobjekt",
	"test.error.not_a_block_item": "Der angegebene Block ist kein Blockgegenstand",
	"test.error.position": "%s bei %s, %s, %s (relativ: %s, %s, %s) in Tick %s",
	"test.error.sequence.condition_already_triggered": "Bedingung bereits in Tick %s ausgelöst",
	"test.error.sequence.condition_not_triggered": "Bedingung nicht ausgelöst",
	"test.error.sequence.invalid_tick": "In ungültigem Tick stattgefunden: %s wurde erwartet",
	"test.error.sequence.minimum_tick": "Vor erwartetem Tick stattgefunden: erwartet, %s zu warten",
	"test.error.sequence.not_completed": "Test vor Abschluss des Vorgangs abgelaufen",
	"test.error.set_biome": "Biom für Test konnte nicht festgelegt werden",
	"test.error.spawn_failure": "Objekt %s konnte ned erzeugt wern",
	"test.error.state_not_equal": "Falscher Zustand. %s erwartet, war %s",
	"test.error.structure.failure": "Testkonstruktion für %s konnte nicht platziert werden",
	"test.error.tick": "%s in Tick %s",
	"test.error.ticking_without_structure": "Testausführung begann, bevor Konstruktion platziert wurde",
	"test.error.timeout.no_result": "Weder Erfolg noch Fehlschlag innerhalb von %s Ticks",
	"test.error.timeout.no_sequences_finished": "Keine Testabläufe innerhalb von %s Ticks abgeschlossen",
	"test.error.too_many_entities": "Nur ein %s um %s, %s, %s erwartet, aber %s gefunden",
	"test.error.unexpected_block": "Block wurde nicht als %s erwartet",
	"test.error.unexpected_entity": "Nicht erwartet, %s vorzufinden",
	"test.error.unexpected_item": "Gegenstand vom Typ %s wurde nicht erwartet",
	"test.error.unknown": "Unbekannter interner Fehler: %s",
	"test.error.value_not_equal": "%s wurde als %s erwartet, war aber %s",
	"test.error.value_not_in_between": "%s zwischen %s und %s erwartet, war aber %s",
	"test.error.wrong_block_entity": "Falscher Blockobjekttyp: %s",
	"test_block.error.missing": "Testkonstruktion hat keinen %s‐Block",
	"test_block.error.too_many": "Zu viele %s‐Blöcke",
	"test_block.invalid_timeout": "Ungültiges Timeout (%s) – muss eine positive Anzahl von Ticks sein",
	"test_block.message": "Nochricht:",
	"test_block.mode.accept": "Akzeptieren",
	"test_block.mode.fail": "Fehlschlog",
	"test_block.mode.log": "Protokoll",
	"test_block.mode.start": "Start",
	"test_block.mode_info.accept": "Akzeptanzmodus – Nimmt (teilweisen) Erfolg eines Tests entgegen",
	"test_block.mode_info.fail": "Fehlermodus – Lässt den Test fehlschlagen",
	"test_block.mode_info.log": "Protokollmodus – Protokolliere eine Nachricht",
	"test_block.mode_info.start": "Startmodus – Der Anfangspunkt eines Tests",
	"test_instance.action.reset": "Zurücksetzen und laden",
	"test_instance.action.run": "Laden und ausführen",
	"test_instance.action.save": "Konstruktion speichern",
	"test_instance.description.batch": "Umgebung: %s",
	"test_instance.description.failed": "Fehlg'schlogn: %s",
	"test_instance.description.function": "Funktion: %s",
	"test_instance.description.invalid_id": "Ungültige Test‐ID",
	"test_instance.description.no_test": "Dieser Test existiert nicht",
	"test_instance.description.structure": "Konstruktion: %s",
	"test_instance.description.type": "Typ: %s",
	"test_instance.type.block_based": "Blockbasierter Test",
	"test_instance.type.function": "Integrierter Funktionstest",
	"test_instance_block.entities": "Objekte:",
	"test_instance_block.error.no_test": "Testinstanz bei %s, %s, %s kann nicht ausgeführt werden, da ihr kein Test zugewiesen ist",
	"test_instance_block.error.no_test_structure": "Testinstanz bei %s, %s, %s konnte nicht ausgeführt werden, da ihre Testkonstruktion fehlt",
	"test_instance_block.error.unable_to_save": "Testkonstruktionsvorlage für Testinstanz bei %s, %s, %s kann nicht gespeichert werden",
	"test_instance_block.invalid": "[ungültig]",
	"test_instance_block.reset_success": "Test %s wurde erfolgreich zurückgesetzt",
	"test_instance_block.rotation": "Rotation:",
	"test_instance_block.size": "Größe der Testkonstruktion",
	"test_instance_block.starting": "Test %s wird gestartet",
	...
	"title.credits": "Copyright Mojang AB. Ned vabreitn!",
	...
	"trim_material.minecraft.gold": "Goid",
	"trim_material.minecraft.iron": "Eisnmodaioi",
	"trim_material.minecraft.lapis": "Lapismodaioi",
	"trim_material.minecraft.netherite": "Netheritmateroi",
	"trim_material.minecraft.quartz": "Quarzmodaioi",
	"trim_material.minecraft.redstone": "Redstone-Modaioi",
	"trim_material.minecraft.resin": "Harz",
	"trim_pattern.minecraft.bolt": "Bolzen-Rüstungsbesatz",
	...
	"trim_pattern.minecraft.flow": "Fluss-Rüstungsbesatz",
	...
	"trim_pattern.minecraft.tide": "Bobs-Rüstungsschmuck",
	...
	"upgradeWorld.aborted.message": "Dies kann auftreten, wenn während des Hochstufens ein anderes Programm auf die Welt zugreift.\nEs könnte helfen, deinen Rechner neu zu starten und es erneut zu versuchen. Sollte der Fehler bestehen bleiben, bitten wir dich, eine Fehlermeldung zu senden.",
	"upgradeWorld.aborted.reportBug": "Fehler melden",
	"upgradeWorld.aborted.title": "Welt konnte nicht hochgestuft werden",
	"upgradeWorld.canceled.message": "Deine Welt bleibt unverändert.",
	"upgradeWorld.canceled.title": "Hochstufen der Welt abgebrochen",
	"upgradeWorld.done": "Hochstufen der Welt abgeschlossen",
	"upgradeWorld.failed_cleanup.message": "Die Welt wurde erfolgreich auf die aktuelle Version hochgestuft und ist nun in der Weltauswahl verfügbar.\nAufgrund von Fehlern beim Bereinigen alter Daten wurde der Weltordner in „%s“ umbenannt.",
	"upgradeWorld.failed_cleanup.title": "Welt wurde erfolgreich hochgestuft",
	"upgradeWorld.info.converted": "Hochgestuft: %s",
	"upgradeWorld.info.file_fix_stage": "Schritt: %s/%s",
	"upgradeWorld.info.scanning": "Dateien werden eingelesen …",
	"upgradeWorld.info.total": "Insgesamt: %s",
	"upgradeWorld.joinNow": "Möchtest du die Welt jetzt betreten?",
	"upgradeWorld.progress.percentage": "%s %%",
	"upgradeWorld.progress.type.files": "Dateien werden verschoben",
	"upgradeWorld.progress.type.legacy_structures": "Veraltete Strukturen werden hochgestuft",
	"upgradeWorld.progress.type.region": "Regionen werden hochgestuft",
	"upgradeWorld.symlink.message": "Die gewählte Welt enthält symbolische Verknüpfungen.\nDas notwendige Verfahren, die Welt auf die aktuelle Version hochzustufen, unterstützt symbolische Verknüpfungen nicht. Um die Welt hochzustufen, müssen die Verknüpfungen zunächst aufgelöst werden.",
	"upgradeWorld.symlink.title": "Welt kann nicht hochgestuft werden",
	"upgradeWorld.title": "Weltdateien werden hochgestuft",
}
