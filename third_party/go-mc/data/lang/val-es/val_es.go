// Code generated by tools/gen_lang.go from 26.1/val_es.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Configuració d'accessibilitat...",
	"accessibility.onboarding.accessibility.button.narration": "Configuració d’accessibilitat",
	"accessibility.onboarding.screen.narrator": "Prem \"Intro\" per a activar el narrador",
	"accessibility.onboarding.screen.title": "Benvingut al Minecraft!\n\nVols activar el narrador o vore els ajustos d'accessibilitat?",
	"addServer.add": "Fet",
	...
	"advMode.notEnabled": "Els blocs de comandaments estan desactivats",
	"advMode.notEnabled.spawner": "Els generadors de monstres estan desactivats",
	"advMode.previousOutput": "Eixida anterior",
	"advMode.setCommand": "Canvia el comandament del bloc",
	"advMode.setCommand.disabled": "Comandament establit: %s, però els blocs de comandaments estan desactivats",
	...
	"advancements.adventure.blowback.description": "Mata una brisa retornant-li una càrrega de vent",
	"advancements.adventure.blowback.title": "Represàlia",
	"advancements.adventure.brush_armadillo.description": "Obtín plaques d'armadillo utilitzant un raspall",
	"advancements.adventure.brush_armadillo.title": "Implacable?",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Fes un gerro amb 4 fragments de gerro",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Restauració cautelosa",
	"advancements.adventure.crafters_crafting_crafters.description": "Sigues testimoni d'un fabricador fabricant un fabricador",
	"advancements.adventure.crafters_crafting_crafters.title": "Fabricadors fabricant fabricadors",
	...
	"advancements.adventure.heart_transplanter.description": "Col·loca un cor de crepitant, perfectament alineat, entre dos troncs de roure tètric",
	"advancements.adventure.heart_transplanter.title": "Transplantador de cors",
	...
	"advancements.adventure.lighten_up.description": "Raspa una làmpada de coure amb una destral perquè faça més llum",
	"advancements.adventure.lighten_up.title": "Il·luminat",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Posa un peu en una masmorra de reptes",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: edició repte(s)",
	"advancements.adventure.ol_betsy.description": "Dispara una ballesta",
	"advancements.adventure.ol_betsy.title": "La vella Betsy",
	"advancements.adventure.overoverkill.description": "Infligix 50 de dany d'un sol colp utilitzant la maça",
	"advancements.adventure.overoverkill.title": "Re-rematar",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Llig la potència del senyal d'una llibreria cisellada amb un comparador",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "El poder de la lectura",
	"advancements.adventure.revaulting.description": "Obri una caixa forta ominosa amb una clau de reptes ominosa",
	"advancements.adventure.revaulting.title": "Manyà",
	"advancements.adventure.root.description": "Aventura, exploració i combat",
	"advancements.adventure.root.title": "Aventura",
	"advancements.adventure.salvage_sherd.description": "Raspalla un bloc sospitós per obtenir un fragment de gerro",
	"advancements.adventure.salvage_sherd.title": "Respectant els antics",
	...
	"advancements.adventure.spear_many_mobs.description": "Colpeja cinc criatures en una sola càrrega utilitzant la llança",
	"advancements.adventure.spear_many_mobs.title": "Broqueta de criatures",
	...
	"advancements.adventure.summon_iron_golem.description": "Genera un gólem de ferro per protegir la vila",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Aplica els següents motles de ferreria almenys una vegada: cúpula, morro, os, guardià, silenci, esperit, marea, explorador",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Forjant amb estil",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Fes una armadura amb un disseny en una ferreria",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Creant un nou aspecte",
	...
	"advancements.adventure.under_lock_and_key.description": "Utilitza una clau de reptes en una caixa forta",
	"advancements.adventure.under_lock_and_key.title": "Tancat a pany i clau",
	"advancements.adventure.use_lodestone.description": "Imanta una brúixola",
	"advancements.adventure.use_lodestone.title": "Au a casa! Per on era?",
	...
	"advancements.adventure.who_needs_rockets.description": "Utilitza una càrrega de vent per a propulsar-te 7 blocs cap amunt",
	"advancements.adventure.who_needs_rockets.title": "Qui necessita coets?",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Fes que un al·lai amolle un pastís sobre un bloc musical",
	"advancements.husbandry.allay_deliver_cake_to_note_block.title": "En el dia d'avui",
	"advancements.husbandry.allay_deliver_item_to_player.description": "Fes que un al·lai et porte objectes",
	...
	"advancements.husbandry.feed_snifflet.description": "Alimenta una cria de rastrejador",
	"advancements.husbandry.feed_snifflet.title": "Rastrejadorets",
	...
	"advancements.husbandry.obtain_sniffer_egg.description": "Obtín un ou de rastrejador",
	"advancements.husbandry.obtain_sniffer_egg.title": "Això fa bona olor",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Col·loca un bloc de ghast sec dins de l'aigua",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Hidrata't!",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Planta qualsevol llavor de rastrejador",
	"advancements.husbandry.plant_any_sniffer_seed.title": "Sembrant el passat",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Utilitza unes tisores d'esquilar per a llevar l'armadura a un llop",
	"advancements.husbandry.remove_wolf_armor.title": "Venen retallades!",
	"advancements.husbandry.repair_wolf_armor.description": "Repara una armadura de llop utilitzant plaques d'armadillo",
	"advancements.husbandry.repair_wolf_armor.title": "Com nou",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Utilitza una foguera per a recollir mel d'un buc amb una botella sense alterar a les abelles",
	"advancements.husbandry.safely_harvest_honey.title": "Apicultor",
	"advancements.husbandry.silk_touch_nest.description": "Mou un rusc amb tres abelles dins utilitzant el toc de seda",
	...
	"advancements.husbandry.uh_oh.description": "Fes que un cub de sofre absorbisca un bloc de TNT",
	"advancements.husbandry.uh_oh.title": "Ie, xe, xe, xe, xe!",
	...
	"advancements.husbandry.whole_pack.description": "Domestica totes les races de llop",
	"advancements.husbandry.whole_pack.title": "Un de cada",
	...
	"advancements.nether.get_wither_skull.description": "Aconseguix una calavera d'esquelet wither",
	...
	"advancements.story.enter_the_nether.description": "Construïx, activa i entra a un portal al Nether",
	...
	"argument.entity.selector.nearestEntity": "Entitat més pròxima",
	...
	"argument.hexcolor.invalid": "Codi de color hexadecimal \"%s\" invàlid",
	...
	"argument.message.too_long": "El missatge del xat és massa llarg (%s > màxim %s caràcters)",
	"argument.nbt.array.invalid": "Tipus de fletxa invàlid: %s",
	"argument.nbt.array.mixed": "No es pot inserir %s a %s",
	"argument.nbt.expected.compound": "S'esperava una etiqueta composta",
	...
	"argument.resource_or_id.failed_to_parse": "No s'ha pogut analitzar l'estructura: %s",
	"argument.resource_or_id.invalid": "Id o etiqueta invàlida",
	"argument.resource_or_id.no_such_element": "No es pot trobar l'element \"%s\" al registre \"%s\"",
	"argument.resource_selector.not_found": "No hi ha coincidències per al selector \"%s\" del tipus \"%s\"",
	...
	"argument.style.invalid": "Estil invàlid: %s",
	"argument.time.invalid_tick_count": "El recompte de tics no pot ser negatiu",
	"argument.time.invalid_unit": "Unitat invàlida",
	"argument.time.tick_count_too_low": "El recompte de tics no pot ser menor que %s: s'ha trobat %s",
	"argument.uuid.invalid": "L'UUID és invàlida",
	"argument.waypoint.invalid": "L'entitat seleccionada no és un punt de ruta",
	...
	"arguments.item.component.expected": "Component d'objecte esperat",
	"arguments.item.component.malformed": "Component \"%s\" malformat: \"%s\"",
	"arguments.item.component.repeated": "El component d'objectes \"%s\" s'ha repetit, però només es pot especificar un valor",
	"arguments.item.component.unknown": "Component d'objecte \"%s\" desconegut",
	"arguments.item.malformed": "Objecte malformat: \"%s\"",
	"arguments.item.overstacked": "%s només pot apilar-se fins a %s",
	"arguments.item.predicate.malformed": "El predicat \"%s\" està mal format: \"%s\"",
	"arguments.item.predicate.unknown": "Predicat d'objecte desconegut \"%s\"",
	...
	"arguments.swizzle.invalid": "Error: s'esperava una combinació d'\"x\", \"y\" i \"z\"",
	...
	"attribute.name.air_drag_modifier": "Modificador de resistència de l’aire",
	"attribute.name.armor": "Armadura",
	"attribute.name.armor_toughness": "Duresa de l'armadura",
	"attribute.name.attack_damage": "Dany de l'atac",
	"attribute.name.attack_knockback": "Espenta de l'atac",
	"attribute.name.attack_speed": "Velocitat de l'atac",
	"attribute.name.below_name_distance": "Distància de puntuació de la placa identificativa",
	"attribute.name.block_break_speed": "Velocitat de trencament de bloc",
	"attribute.name.block_interaction_range": "Rang d'interacció amb blocs",
	"attribute.name.bounciness": "Rebot",
	"attribute.name.burning_time": "Temps de crema",
	"attribute.name.camera_distance": "Distància de càmera",
	"attribute.name.entity_interaction_range": "Rang d'interacció amb entitats",
	"attribute.name.explosion_knockback_resistance": "Resistència al retrocés per explosió",
	"attribute.name.fall_damage_multiplier": "Multiplicador de dany per caiguda",
	"attribute.name.flying_speed": "Velocitat de vol",
	"attribute.name.follow_range": "Rang de seguiment de les criatures",
	"attribute.name.friction_modifier": "Modificador de fricció",
	...
	"attribute.name.generic.block_interaction_range": "Rang d'interacció amb blocs",
	"attribute.name.generic.burning_time": "Temps de crema",
	"attribute.name.generic.entity_interaction_range": "Rang d'interacció amb entitats",
	"attribute.name.generic.explosion_knockback_resistance": "Resistència al retrocés per explosió",
	"attribute.name.generic.fall_damage_multiplier": "Multiplicador de dany per caiguda",
	...
	"attribute.name.generic.jump_strength": "Força de salt",
	"attribute.name.generic.knockback_resistance": "Resistència a l'espenta",
	"attribute.name.generic.luck": "Sort",
	"attribute.name.generic.max_absorption": "Absorció màxima",
	"attribute.name.generic.max_health": "Salut màxima",
	"attribute.name.generic.movement_efficiency": "Eficiència de moviment",
	"attribute.name.generic.movement_speed": "Velocitat",
	"attribute.name.generic.oxygen_bonus": "Bonificació d'oxigen",
	"attribute.name.generic.safe_fall_distance": "Distància de caiguda segura",
	"attribute.name.generic.scale": "Escala",
	"attribute.name.generic.step_height": "Grandària del pas",
	"attribute.name.generic.water_movement_efficiency": "Eficiència de moviment en l'aigua",
	"attribute.name.gravity": "Gravetat",
	"attribute.name.horse.jump_strength": "Impuls de salt del cavall",
	"attribute.name.jump_strength": "Força de salt",
	"attribute.name.knockback_resistance": "Resistència a l'espenta",
	"attribute.name.luck": "Sort",
	"attribute.name.max_absorption": "Absorció màxima",
	"attribute.name.max_health": "Salut màxima",
	"attribute.name.mining_efficiency": "Eficiència minera",
	"attribute.name.movement_efficiency": "Eficiència de moviment",
	"attribute.name.movement_speed": "Velocitat",
	"attribute.name.nameplate_distance": "Distància de la placa identificativa",
	"attribute.name.oxygen_bonus": "Bonificació d'oxigen",
	"attribute.name.player.block_break_speed": "Velocitat de trencament de blocs",
	"attribute.name.player.block_interaction_range": "Rang d'interacció amb blocs",
	"attribute.name.player.entity_interaction_range": "Rang d'interacció amb entitats",
	"attribute.name.player.mining_efficiency": "Eficiència minera",
	"attribute.name.player.sneaking_speed": "Velocitat en acatxar-se",
	"attribute.name.player.submerged_mining_speed": "Velocitat minera bussejant",
	"attribute.name.player.sweeping_damage_ratio": "Ràtio de dany per batuda",
	"attribute.name.safe_fall_distance": "Distància de caiguda segura",
	"attribute.name.scale": "Escala",
	"attribute.name.sneaking_speed": "Velocitat en acatxar-se",
	"attribute.name.spawn_reinforcements": "Reforços de zombis",
	"attribute.name.step_height": "Grandària del pas",
	"attribute.name.submerged_mining_speed": "Velocitat minera bussejant",
	"attribute.name.sweeping_damage_ratio": "Ràtio de dany per batuda",
	"attribute.name.tempt_range": "Rang d'atracció de criatures",
	"attribute.name.water_movement_efficiency": "Eficiència de moviment en l'aigua",
	"attribute.name.waypoint_receive_range": "Rang de recepció de punt de ruta",
	"attribute.name.waypoint_transmit_range": "Rang de transmissió de punt de ruta",
	...
	"biome.minecraft.cherry_grove": "Cirerar",
	...
	"biome.minecraft.old_growth_spruce_taiga": "Taigà de pícees ancestrals",
	"biome.minecraft.pale_garden": "Jardí tètric",
	"biome.minecraft.plains": "Planures",
	...
	"biome.minecraft.sulfur_caves": "Coves de sofre",
	...
	"block.minecraft.acacia_wall_hanging_sign": "Cartell d'acàcia penjant de paret",
	"block.minecraft.acacia_wall_sign": "Cartell d'acàcia de paret",
	"block.minecraft.acacia_wood": "Llenya d'acàcia",
	...
	"block.minecraft.bamboo_hanging_sign": "Cartell de bambú penjant",
	...
	"block.minecraft.bamboo_shelf": "Prestatgeria de bambú",
	...
	"block.minecraft.bamboo_wall_hanging_sign": "Cartell de bambú penjant de paret",
	"block.minecraft.bamboo_wall_sign": "Cartell de bambú de paret",
	...
	"block.minecraft.banner.flow.black": "Flux negre",
	"block.minecraft.banner.flow.blue": "Flux blau",
	"block.minecraft.banner.flow.brown": "Flux marró",
	"block.minecraft.banner.flow.cyan": "Flux cian",
	"block.minecraft.banner.flow.gray": "Flux gris",
	"block.minecraft.banner.flow.green": "Flux verd",
	"block.minecraft.banner.flow.light_blue": "Flux blau clar",
	"block.minecraft.banner.flow.light_gray": "Flux gris clar",
	"block.minecraft.banner.flow.lime": "Flux verd llima",
	"block.minecraft.banner.flow.magenta": "Flux magenta",
	"block.minecraft.banner.flow.orange": "Flux taronja",
	"block.minecraft.banner.flow.pink": "Flux rosa",
	"block.minecraft.banner.flow.purple": "Flux morat",
	"block.minecraft.banner.flow.red": "Flux roig",
	"block.minecraft.banner.flow.white": "Flux blanc",
	"block.minecraft.banner.flow.yellow": "Flux groc",
	...
	"block.minecraft.banner.guster.black": "Ràfega negra",
	"block.minecraft.banner.guster.blue": "Ràfega blava",
	"block.minecraft.banner.guster.brown": "Ràfega marró",
	"block.minecraft.banner.guster.cyan": "Ràfega cian",
	"block.minecraft.banner.guster.gray": "Ràfega gris",
	"block.minecraft.banner.guster.green": "Ràfega verda",
	"block.minecraft.banner.guster.light_blue": "Ràfega blava clara",
	"block.minecraft.banner.guster.light_gray": "Ràfega grisa clara",
	"block.minecraft.banner.guster.lime": "Ràfega verda llima",
	"block.minecraft.banner.guster.magenta": "Ràfega magenta",
	"block.minecraft.banner.guster.orange": "Ràfega taronja",
	"block.minecraft.banner.guster.pink": "Ràfega rosa",
	"block.minecraft.banner.guster.purple": "Ràfega morada",
	"block.minecraft.banner.guster.red": "Ràfega roja",
	"block.minecraft.banner.guster.white": "Ràfega blanca",
	"block.minecraft.banner.guster.yellow": "Ràfega groga",
	...
	"block.minecraft.birch_wall_hanging_sign": "Cartell de bedoll penjant de paret",
	"block.minecraft.birch_wall_sign": "Cartell de bedoll de paret",
	"block.minecraft.birch_wood": "Llenya de bedoll",
	"block.minecraft.black_banner": "Estandard negre",
	...
	"block.minecraft.blue_banner": "Estandard blau",
	...
	"block.minecraft.brick_stairs": "Escales de rajoles",
	"block.minecraft.brick_wall": "Mur de rajoles",
	"block.minecraft.bricks": "Rajoles",
	"block.minecraft.brown_banner": "Estandard marró",
	...
	"block.minecraft.calibrated_sculk_sensor": "Sensor de sculk calibrat",
	...
	"block.minecraft.cherry_wall_hanging_sign": "Cartell de cirerer penjant de paret",
	"block.minecraft.cherry_wall_sign": "Cartell de cirerer de paret",
	"block.minecraft.cherry_wood": "Llenya de cirerer",
	...
	"block.minecraft.chiseled_cinnabar": "Cinabri cisellat",
	"block.minecraft.chiseled_copper": "Coure cisellat",
	...
	"block.minecraft.chiseled_resin_bricks": "Rajoles de resina cisellades",
	...
	"block.minecraft.chiseled_sulfur": "Sofre cisellat",
	"block.minecraft.chiseled_tuff": "Tova volcànica cisellada",
	"block.minecraft.chiseled_tuff_bricks": "Rajoles de tova volcànica cisellada",
	"block.minecraft.chorus_flower": "Flor de coral",
	"block.minecraft.chorus_plant": "Coral",
	"block.minecraft.cinnabar": "Cinabri",
	"block.minecraft.cinnabar_brick_slab": "Llosa de rajoles de cinabri",
	"block.minecraft.cinnabar_brick_stairs": "Escales de rajoles de cinabri",
	"block.minecraft.cinnabar_brick_wall": "Mur de rajoles de cinabri",
	"block.minecraft.cinnabar_bricks": "Rajoles de cinabri",
	"block.minecraft.cinnabar_slab": "Llosa de cinabri",
	"block.minecraft.cinnabar_stairs": "Escales de cinabri",
	"block.minecraft.cinnabar_wall": "Mur de cinabri",
	"block.minecraft.clay": "Argila",
	"block.minecraft.closed_eyeblossom": "Florull tancat",
	...
	"block.minecraft.copper_bars": "Reixa de coure",
	"block.minecraft.copper_block": "Bloc de coure",
	"block.minecraft.copper_bulb": "Làmpada de coure",
	"block.minecraft.copper_chain": "Cadena de coure",
	"block.minecraft.copper_chest": "Cofre de coure",
	"block.minecraft.copper_door": "Porta de coure",
	"block.minecraft.copper_golem_statue": "Estàtua de gólem de coure",
	"block.minecraft.copper_grate": "Reixeta de coure",
	"block.minecraft.copper_lantern": "Fanal de coure",
	"block.minecraft.copper_ore": "Mena de coure",
	"block.minecraft.copper_torch": "Torxa de coure",
	"block.minecraft.copper_trapdoor": "Trapa de coure",
	"block.minecraft.copper_wall_torch": "Torxa de coure de paret",
	...
	"block.minecraft.creaking_heart": "Cor de crepitant",
	...
	"block.minecraft.crimson_hanging_sign": "Cartell carmesí penjant",
	...
	"block.minecraft.crimson_shelf": "Prestatgeria carmesina",
	...
	"block.minecraft.crimson_wall_hanging_sign": "Cartell carmesí penjant de paret",
	...
	"block.minecraft.cyan_banner": "Estandard cian",
	...
	"block.minecraft.dark_oak_button": "Botó de roure fosc",
	"block.minecraft.dark_oak_door": "Porta roure fosc",
	"block.minecraft.dark_oak_fence": "Tanca de roure fosc",
	"block.minecraft.dark_oak_fence_gate": "Porta de tanca de roure fosc",
	"block.minecraft.dark_oak_hanging_sign": "Cartell de roure fosc penjant",
	"block.minecraft.dark_oak_leaves": "Fulles de roure fosc",
	"block.minecraft.dark_oak_log": "Tronc de roure fosc",
	"block.minecraft.dark_oak_planks": "Taulons de roure fosc",
	"block.minecraft.dark_oak_pressure_plate": "Placa de pressió de roure fosc",
	"block.minecraft.dark_oak_sapling": "Esqueix de roure fosc",
	"block.minecraft.dark_oak_shelf": "Prestatgeria de roure fosc",
	"block.minecraft.dark_oak_sign": "Cartell de roure fosc",
	"block.minecraft.dark_oak_slab": "Llosa de roure fosc",
	"block.minecraft.dark_oak_stairs": "Escales de roure fosc",
	"block.minecraft.dark_oak_trapdoor": "Trapa de roure fosc",
	"block.minecraft.dark_oak_wall_hanging_sign": "Cartell de roure fosc penjant de paret",
	"block.minecraft.dark_oak_wall_sign": "Cartell de roure fosc de paret",
	"block.minecraft.dark_oak_wood": "Llenya de roure fosc",
	...
	"block.minecraft.decorated_pot": "Gerro",
	...
	"block.minecraft.dried_ghast": "Ghast sec",
	...
	"block.minecraft.exposed_chiseled_copper": "Coure exposat cisellat",
	"block.minecraft.exposed_copper": "Coure exposat",
	"block.minecraft.exposed_copper_bars": "Reixa de coure exposat",
	"block.minecraft.exposed_copper_bulb": "Làmpada de coure exposat",
	"block.minecraft.exposed_copper_chain": "Cadena de coure exposat",
	"block.minecraft.exposed_copper_chest": "Cofre de coure exposat",
	"block.minecraft.exposed_copper_door": "Porta de coure exposat",
	"block.minecraft.exposed_copper_golem_statue": "Estátua de gólem de coure exposat",
	"block.minecraft.exposed_copper_grate": "Reixeta de coure exposat",
	"block.minecraft.exposed_copper_lantern": "Fanal de coure exposat",
	"block.minecraft.exposed_copper_trapdoor": "Trapa de coure exposat",
	...
	"block.minecraft.exposed_lightning_rod": "Parallamps exposat",
	...
	"block.minecraft.firefly_bush": "Arbust amb lluernes",
	...
	"block.minecraft.golden_dandelion": "Dent de lleó daurat",
	...
	"block.minecraft.gray_banner": "Estandard gris",
	...
	"block.minecraft.green_banner": "Estandard verd",
	...
	"block.minecraft.heavy_core": "Nucli dens",
	...
	"block.minecraft.iron_chain": "Cadena de ferro",
	...
	"block.minecraft.jungle_wall_hanging_sign": "Cartell de jungla penjant de paret",
	"block.minecraft.jungle_wall_sign": "Cartell de jungla de paret",
	"block.minecraft.jungle_wood": "Llenya de jungla",
	...
	"block.minecraft.leaf_litter": "Fulles seques",
	"block.minecraft.lectern": "Faristol",
	"block.minecraft.lever": "Palanca",
	"block.minecraft.light": "Llum",
	"block.minecraft.light_blue_banner": "Estandard blau clar",
	...
	"block.minecraft.light_gray_banner": "Estandard gris clar",
	...
	"block.minecraft.lime_banner": "Estandard verd llima",
	...
	"block.minecraft.magenta_banner": "Estandard magenta",
	...
	"block.minecraft.mangrove_hanging_sign": "Cartell de mangle penjant",
	"block.minecraft.mangrove_leaves": "Fulles de mangle",
	"block.minecraft.mangrove_log": "Tronc de mangle",
	"block.minecraft.mangrove_planks": "Taulons de mangle",
	...
	"block.minecraft.mangrove_shelf": "Prestatgeria de mangle",
	...
	"block.minecraft.mangrove_wall_hanging_sign": "Cartell de mangle penjant de paret",
	"block.minecraft.mangrove_wall_sign": "Cartell de mangle de paret",
	"block.minecraft.mangrove_wood": "Llenya de mangle",
	...
	"block.minecraft.nether_brick_fence": "Tanca de rajoles del Nether",
	"block.minecraft.nether_brick_slab": "Llosa de rajoles del Nether",
	"block.minecraft.nether_brick_stairs": "Escales de rajoles del Nether",
	...
	"block.minecraft.oak_button": "Botó de roure",
	"block.minecraft.oak_door": "Porta de roure",
	"block.minecraft.oak_fence": "Tanca de roure",
	"block.minecraft.oak_fence_gate": "Porta de tanca de roure",
	"block.minecraft.oak_hanging_sign": "Cartell de roure penjant",
	"block.minecraft.oak_leaves": "Fulles de roure",
	"block.minecraft.oak_log": "Tronc de roure",
	"block.minecraft.oak_planks": "Taulons de roure",
	"block.minecraft.oak_pressure_plate": "Placa de pressió de roure",
	"block.minecraft.oak_sapling": "Esqueix de roure",
	"block.minecraft.oak_shelf": "Prestatgeria de roure",
	"block.minecraft.oak_sign": "Cartell de roure",
	"block.minecraft.oak_slab": "Llosa de roure",
	"block.minecraft.oak_stairs": "Escales de roure",
	"block.minecraft.oak_trapdoor": "Trapa de roure",
	"block.minecraft.oak_wall_hanging_sign": "Cartell de roure penjant de paret",
	"block.minecraft.oak_wall_sign": "Cartell de roure de paret",
	"block.minecraft.oak_wood": "Llenya de roure",
	...
	"block.minecraft.open_eyeblossom": "Florull obert",
	"block.minecraft.orange_banner": "Estandard taronja",
	...
	"block.minecraft.oxidized_chiseled_copper": "Coure oxidat cisellat",
	"block.minecraft.oxidized_copper": "Coure oxidat",
	"block.minecraft.oxidized_copper_bars": "Reixa de coure oxidat",
	"block.minecraft.oxidized_copper_bulb": "Làmpada de coure oxidat",
	"block.minecraft.oxidized_copper_chain": "Cadena de coure oxidat",
	"block.minecraft.oxidized_copper_chest": "Cofre de coure oxidat",
	"block.minecraft.oxidized_copper_door": "Porta de coure oxidat",
	"block.minecraft.oxidized_copper_golem_statue": "Estàtua de gólem de coure oxidat",
	"block.minecraft.oxidized_copper_grate": "Reixeta de coure oxidat",
	"block.minecraft.oxidized_copper_lantern": "Fanal de coure oxidat",
	"block.minecraft.oxidized_copper_trapdoor": "Trapa de coure oxidat",
	...
	"block.minecraft.oxidized_lightning_rod": "Parallamps oxidat",
	"block.minecraft.packed_ice": "Gel compacte",
	"block.minecraft.packed_mud": "Fang compacte",
	"block.minecraft.pale_hanging_moss": "Molsa tètrica penjant",
	"block.minecraft.pale_moss_block": "Bloc de molsa tètrica",
	"block.minecraft.pale_moss_carpet": "Estora de molsa tètrica",
	"block.minecraft.pale_oak_button": "Botó de roure tètric",
	"block.minecraft.pale_oak_door": "Porta de roure tètric",
	"block.minecraft.pale_oak_fence": "Tanca de roure tètric",
	"block.minecraft.pale_oak_fence_gate": "Porta de tanca de roure tètric",
	"block.minecraft.pale_oak_hanging_sign": "Cartell de roure tètric penjant",
	"block.minecraft.pale_oak_leaves": "Fulles de roure tètric",
	"block.minecraft.pale_oak_log": "Tronc de roure tètric",
	"block.minecraft.pale_oak_planks": "Taulons de roure tètric",
	"block.minecraft.pale_oak_pressure_plate": "Placa de pressió de roure tètric",
	"block.minecraft.pale_oak_sapling": "Esqueix de roure tètric",
	"block.minecraft.pale_oak_shelf": "Prestatgeria de roure tètric",
	"block.minecraft.pale_oak_sign": "Cartell de roure tètric",
	"block.minecraft.pale_oak_slab": "Llosa de roure tètric",
	"block.minecraft.pale_oak_stairs": "Escales de roure tètric",
	"block.minecraft.pale_oak_trapdoor": "Trapa de roure tètric",
	"block.minecraft.pale_oak_wall_hanging_sign": "Cartell de roure tètric penjant de paret",
	"block.minecraft.pale_oak_wall_sign": "Cartell de roure tètric de paret",
	"block.minecraft.pale_oak_wood": "Llenya de roure tètric",
	"block.minecraft.pearlescent_froglight": "Granollum perlescent",
	"block.minecraft.peony": "Peònia",
	"block.minecraft.petrified_oak_slab": "Llosa petrificada de roure",
	"block.minecraft.piglin_head": "Cap de piglin",
	"block.minecraft.piglin_wall_head": "Cap de piglin de paret",
	"block.minecraft.pink_banner": "Estandard rosa",
	...
	"block.minecraft.pitcher_crop": "Cultiu de planta de gerra",
	"block.minecraft.pitcher_plant": "Planta de gerra",
	...
	"block.minecraft.polished_cinnabar": "Cinabri polit",
	"block.minecraft.polished_cinnabar_slab": "Llosa de cinabri polit",
	"block.minecraft.polished_cinnabar_stairs": "Escales de cinabri polit",
	"block.minecraft.polished_cinnabar_wall": "Mur de cinabri polit",
	...
	"block.minecraft.polished_sulfur": "Sofre polit",
	"block.minecraft.polished_sulfur_slab": "Llosa de sofre polit",
	"block.minecraft.polished_sulfur_stairs": "Escales de sofre polit",
	"block.minecraft.polished_sulfur_wall": "Mur de sofre polit",
	"block.minecraft.polished_tuff": "Tova volcànica polida",
	"block.minecraft.polished_tuff_slab": "Llosa de tova volcànica polida",
	"block.minecraft.polished_tuff_stairs": "Escales de tova volcànica polida",
	"block.minecraft.polished_tuff_wall": "Mur de tova volcànica polida",
	"block.minecraft.poppy": "Rosella",
	"block.minecraft.potatoes": "Creïlles",
	"block.minecraft.potent_sulfur": "Sofre potent",
	...
	"block.minecraft.potted_closed_eyeblossom": "Test amb florull tancat",
	...
	"block.minecraft.potted_dark_oak_sapling": "Test amb esqueix de roure fosc",
	...
	"block.minecraft.potted_golden_dandelion": "Test amb dent de lleó daurat",
	...
	"block.minecraft.potted_oak_sapling": "Test amb esqueix de roure",
	"block.minecraft.potted_open_eyeblossom": "Test amb florull obert",
	"block.minecraft.potted_orange_tulip": "Test amb tulipa taronja",
	"block.minecraft.potted_oxeye_daisy": "Test amb margarida",
	"block.minecraft.potted_pale_oak_sapling": "Test amb esqueix de roure tètric",
	...
	"block.minecraft.potted_spruce_sapling": "Test amb esqueix de pícea",
	"block.minecraft.potted_torchflower": "Test amb flamaflor",
	...
	"block.minecraft.purple_banner": "Estandard morat",
	...
	"block.minecraft.red_banner": "Estandard roig",
	...
	"block.minecraft.resin_block": "Bloc de resina",
	"block.minecraft.resin_brick_slab": "Llosa de rajoles de resina",
	"block.minecraft.resin_brick_stairs": "Escales de rajoles de resina",
	"block.minecraft.resin_brick_wall": "Mur de rajoles de resina",
	"block.minecraft.resin_bricks": "Rajoles de resina",
	...
	"block.minecraft.short_dry_grass": "Herba seca curta",
	"block.minecraft.short_grass": "Herba curta",
	...
	"block.minecraft.skeleton_wall_skull": "Calavera d'esquelet de paret",
	...
	"block.minecraft.spruce_button": "Botó de pícea",
	"block.minecraft.spruce_door": "Porta de pícea",
	"block.minecraft.spruce_fence": "Tanca de pícea",
	"block.minecraft.spruce_fence_gate": "Porta de tanca de pícea",
	"block.minecraft.spruce_hanging_sign": "Cartell de pícea penjant",
	"block.minecraft.spruce_leaves": "Fulles de pícea",
	"block.minecraft.spruce_log": "Tronc de pícea",
	"block.minecraft.spruce_planks": "Taulons de pícea",
	"block.minecraft.spruce_pressure_plate": "Placa de pressió de pícea",
	"block.minecraft.spruce_sapling": "Esqueix de pícea",
	"block.minecraft.spruce_shelf": "Prestatgeria de pícea",
	"block.minecraft.spruce_sign": "Cartell de pícea",
	"block.minecraft.spruce_slab": "Llosa de pícea",
	"block.minecraft.spruce_stairs": "Escales de pícea",
	"block.minecraft.spruce_trapdoor": "Trapa de pícea",
	"block.minecraft.spruce_wall_hanging_sign": "Cartell de pícea penjant de paret",
	"block.minecraft.spruce_wall_sign": "Cartell de pícea de paret",
	"block.minecraft.spruce_wood": "Llenya de pícea",
	...
	"block.minecraft.stone_brick_stairs": "Escales de rajoles de roca",
	...
	"block.minecraft.stripped_acacia_wood": "Llenya d’acàcia escorçada",
	"block.minecraft.stripped_bamboo_block": "Bloc de bambú escorçat",
	"block.minecraft.stripped_birch_log": "Tronc de bedoll escorçat",
	"block.minecraft.stripped_birch_wood": "Llenya de bedoll escorçada",
	"block.minecraft.stripped_cherry_log": "Tronc de cirerer escorçat",
	"block.minecraft.stripped_cherry_wood": "Llenya de cirerer escorçada",
	...
	"block.minecraft.stripped_dark_oak_log": "Tronc de roure fosc escorçat",
	"block.minecraft.stripped_dark_oak_wood": "Llenya de roure fosc escorçada",
	"block.minecraft.stripped_jungle_log": "Tronc de jungla escorçat",
	"block.minecraft.stripped_jungle_wood": "Llenya de jungla escorçada",
	"block.minecraft.stripped_mangrove_log": "Tronc de mangle escorçat",
	"block.minecraft.stripped_mangrove_wood": "Llenya de mangle escorçada",
	"block.minecraft.stripped_oak_log": "Tronc de roure escorçat",
	"block.minecraft.stripped_oak_wood": "Llenya de roure escorçada",
	"block.minecraft.stripped_pale_oak_log": "Tronc de roure tètric escorçat",
	"block.minecraft.stripped_pale_oak_wood": "Llenya de roure tètric escorçada",
	"block.minecraft.stripped_spruce_log": "Tronc de pícea escorçat",
	"block.minecraft.stripped_spruce_wood": "Llenya de pícea escorçada",
	...
	"block.minecraft.sulfur": "Sofre",
	"block.minecraft.sulfur_brick_slab": "Llosa de rajoles de sofre",
	"block.minecraft.sulfur_brick_stairs": "Escales de rajoles de sofre",
	"block.minecraft.sulfur_brick_wall": "Mur de rajoles de sofre",
	"block.minecraft.sulfur_bricks": "Rajoles de sofre",
	"block.minecraft.sulfur_slab": "Llosa de sofre",
	"block.minecraft.sulfur_spike": "Pic de sofre",
	"block.minecraft.sulfur_stairs": "Escales de sofre",
	"block.minecraft.sulfur_wall": "Mur de sofre",
	"block.minecraft.sunflower": "Gira-sol",
	"block.minecraft.suspicious_gravel": "Grava sospitosa",
	"block.minecraft.suspicious_sand": "Arena sospitosa",
	...
	"block.minecraft.test_block": "Bloc de proves",
	"block.minecraft.test_instance_block": "Bloc de proves d'instància",
	"block.minecraft.tinted_glass": "Vidre opac",
	"block.minecraft.tnt": "Explosius",
	"block.minecraft.tnt.disabled": "Les explosions de dinamita estan desactivades",
	"block.minecraft.torch": "Torxa",
	"block.minecraft.torchflower": "Flamaflor",
	"block.minecraft.torchflower_crop": "Cultiu de flamaflor",
	"block.minecraft.trapped_chest": "Cofre trampa",
	"block.minecraft.trial_spawner": "Generador de reptes",
	...
	"block.minecraft.tuff_brick_slab": "Llosa de rajoles de tova volcànica",
	"block.minecraft.tuff_brick_stairs": "Escales de rajoles de tova volcànica",
	"block.minecraft.tuff_brick_wall": "Mur de rajoles de tova volcànica",
	"block.minecraft.tuff_bricks": "Rajoles de tova volcànica",
	"block.minecraft.tuff_slab": "Llosa de tova volcànica",
	"block.minecraft.tuff_stairs": "Escales de tova volcànica",
	"block.minecraft.tuff_wall": "Mur de tova volcànica",
	...
	"block.minecraft.vault": "Caixa forta",
	...
	"block.minecraft.warped_hanging_sign": "Cartell estrambòtic penjant",
	...
	"block.minecraft.warped_shelf": "Prestatgeria estrambòtica",
	...
	"block.minecraft.warped_wall_hanging_sign": "Cartell estrambòtic penjant de paret",
	...
	"block.minecraft.waxed_chiseled_copper": "Coure cisellat encerat",
	"block.minecraft.waxed_copper_bars": "Reixa de coure encerat",
	"block.minecraft.waxed_copper_block": "Bloc de coure encerat",
	"block.minecraft.waxed_copper_bulb": "Làmpada de coure encerat",
	"block.minecraft.waxed_copper_chain": "Cadena de coure encerat",
	"block.minecraft.waxed_copper_chest": "Cofre de coure encerat",
	"block.minecraft.waxed_copper_door": "Porta de coure encerat",
	"block.minecraft.waxed_copper_golem_statue": "Estàtua de gólem de coure encerat",
	"block.minecraft.waxed_copper_grate": "Reixeta de coure encerat",
	"block.minecraft.waxed_copper_lantern": "Fanal de coure encerat",
	"block.minecraft.waxed_copper_trapdoor": "Trapa de coure encerat",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Coure cisellat exposat encerat",
	"block.minecraft.waxed_exposed_copper": "Coure encerat exposat",
	"block.minecraft.waxed_exposed_copper_bars": "Reixa de coure exposat encerat",
	"block.minecraft.waxed_exposed_copper_bulb": "Làmpada de coure exposat encerat",
	"block.minecraft.waxed_exposed_copper_chain": "Cadena de coure exposat encerat",
	"block.minecraft.waxed_exposed_copper_chest": "Cofre de coure exposat encerat",
	"block.minecraft.waxed_exposed_copper_door": "Porta de coure exposat encerat",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Estàtua de gólem de coure exposat encerat",
	"block.minecraft.waxed_exposed_copper_grate": "Reixeta de coure exposat encerat",
	"block.minecraft.waxed_exposed_copper_lantern": "Fanal de coure exposat encerat",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Trapa de coure exposat encerat",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Parallamps exposat encerat",
	"block.minecraft.waxed_lightning_rod": "Parallamps encerat",
	...
	"block.minecraft.waxed_oxidized_copper_bars": "Reixa de coure oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_bulb": "Làmpada de coure oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_chain": "Cadena de coure oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_chest": "Cofre de coure oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_door": "Porta de coure oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Estàtua de gólem de coure oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_grate": "Reixeta de coure oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_lantern": "Fanal de coure oxidat encerat",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Parallamps oxidat encerat",
	"block.minecraft.waxed_weathered_chiseled_copper": "Coure cisellat rovellat encerat",
	"block.minecraft.waxed_weathered_copper": "Coure encerat rovellat",
	"block.minecraft.waxed_weathered_copper_bars": "Reixa de coure rovellat encerat",
	"block.minecraft.waxed_weathered_copper_bulb": "Làmpada de coure rovellat encerat",
	"block.minecraft.waxed_weathered_copper_chain": "Cadena de coure rovellat encerat",
	"block.minecraft.waxed_weathered_copper_chest": "Cofre de coure rovellat encerat",
	"block.minecraft.waxed_weathered_copper_door": "Porta de coure rovellat encerat",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Estàtua de gólem de coure rovellat encerat",
	"block.minecraft.waxed_weathered_copper_grate": "Reixeta de coure rovellat encerat",
	"block.minecraft.waxed_weathered_copper_lantern": "Fanal de coure rovellat encerat",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Trapa de coure rovellat encerat",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Parallamps rovellat encerat",
	"block.minecraft.weathered_chiseled_copper": "Coure cisellat rovellat",
	"block.minecraft.weathered_copper": "Coure rovellat",
	"block.minecraft.weathered_copper_bars": "Reixa de coure rovellat",
	"block.minecraft.weathered_copper_bulb": "Làmpada de coure rovellat",
	"block.minecraft.weathered_copper_chain": "Cadena de coure rovellat",
	"block.minecraft.weathered_copper_chest": "Cofre de coure rovellat",
	"block.minecraft.weathered_copper_door": "Porta de coure rovellat",
	"block.minecraft.weathered_copper_golem_statue": "Estàtua de gólem de coure rovellat",
	"block.minecraft.weathered_copper_grate": "Reixeta de coure rovellat",
	"block.minecraft.weathered_copper_lantern": "Fanal de coure rovellat",
	"block.minecraft.weathered_copper_trapdoor": "Trapa de coure rovellat",
	...
	"block.minecraft.weathered_lightning_rod": "Parallamps rovellat",
	...
	"block.minecraft.white_banner": "Estandard blanc",
	...
	"block.minecraft.wildflowers": "Flors silvestres",
	"block.minecraft.wither_rose": "Rosa mústia",
	"block.minecraft.wither_skeleton_skull": "Calavera d'esquelet wither",
	"block.minecraft.wither_skeleton_wall_skull": "Calavera d'esquelet wither de paret",
	"block.minecraft.yellow_banner": "Estandard groc",
	...
	"book.edit.title": "Pantalla d'edició del llibre",
	...
	"book.page_button.next": "Pàgina següent",
	"book.page_button.previous": "Pàgina anterior",
	"book.sign.title": "Pantalla de signatura del llibre",
	"book.sign.titlebox": "Títol",
	"book.signButton": "Signatura",
	"book.view.title": "Pantalla de visualització del llibre",
	"build.spawn_protection": "%s està baix la protecció d’aparició",
	"build.tooHigh": "L'altura límit de construcció és %s",
	"build.tooLow": "L'altura mínima de construcció és %s",
	...
	"chat.disabled.invalid_command_signature": "Un comandament ha tingut una signatura d'argument inesperada o absent.",
	"chat.disabled.invalid_signature": "El xat ha tingut una signatura invàlida. Per favor, prova a reconnectar-te.",
	...
	"chat.disabled.out_of_order_chat": "El xat està fora de servici. Ha canviat l'hora del sistema?",
	...
	"chat.queue.tooltip": "Fes clic per a mostrar el següent missatge",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "El servidor ha enviat un missatge invàlid.",
	...
	"chat.validation_error": "Error de validació del xat",
	"chat_restriction.chat_and_commands_disabled_by_options": "El xat està restringit en la configuració del client.",
	"chat_restriction.chat_disabled_by_options": "El xat del jugador està restringit en la configuració del client.",
	"chat_restriction.chat_disabled_by_options.action": "Ves a la pantalla de configuració del xat",
	"chat_restriction.disabled_by_launcher": "El xat està restringit pel llançador",
	"chat_restriction.disabled_by_profile": "El xat està restringit per la configuració del perfil.",
	"chat_restriction.disabled_by_profile.action": "Ves a la configuració del perfil",
	"chat_screen.commands_not_allowed": "No està permés enviar comandaments",
	"chat_screen.message": "Missatge per a enviar: %s",
	"chat_screen.messages_not_allowed": "No està permés enviar missatges de xat",
	"chat_screen.restricted": "El xat està restringit. Fes clic en este missatge per a veure'n els detalls.",
	"chat_screen.restricted.narration": "El xat està restringit. Ves a la pantalla de restriccions a les opcions del món.",
	"chat_screen.title": "Pantalla del xat",
	"chat_screen.usage": "Escriu un missatge i prem \"Enter\" per a enviar",
	"chunk.toast.checkLog": "Mira el registre per a obtindre més detalls",
	"chunk.toast.loadFailure": "No s'ha pogut carregar el chunk en %s",
	"chunk.toast.lowDiskSpace": "Queda poc d'espai al disc!",
	"chunk.toast.lowDiskSpace.description": "Potser no es puga guardar el món.",
	"chunk.toast.saveFailure": "No s'ha pogut guardar el chunk en %s",
	...
	"command.failed": "Ha ocorregut un error inesperat en intentar executar el comandament",
	"command.forkLimit": "S'ha superat el número màxim de contextos (%s)",
	"command.trailing_data": "S'han trobat dades de seguiment: %s",
	...
	"commands.attribute.base_value.reset.success": "El valor base per a l'atribut %s per a l'entitat %s s'ha reiniciat al predeterminat %s",
	...
	"commands.banip.info": "Este bloqueig afecta a %s jugador/s: %s",
	...
	"commands.banlist.list": "Hi ha %s compte/s bloquejat/s:",
	...
	"commands.bossbar.get.players.some": "La barra personalitzada d'enemic final %s té ara %s jugador/s en línia: %s",
	...
	"commands.bossbar.set.players.success.some": "La barra personalitzada d'enemic final %s té ara %s jugador/s: %s",
	...
	"commands.clear.success.multiple": "S'han eliminat %s objectes de %s jugadors",
	"commands.clear.success.single": "S'han eliminat %s objectes del jugador %s",
	...
	"commands.damage.invulnerable": "L'objectiu és immune al dany escollit",
	"commands.damage.success": "S'ha aplicat %s de dany a %s",
	...
	"commands.data.modify.invalid_substring": "Índexs de la subcadena no vàlids: %s a %s",
	...
	"commands.datapack.create.already_exists": "El pack amb el nom \"%s\" ja existix",
	"commands.datapack.create.invalid_full_name": "\"%s\" no és un nom vàlid per al nou paquet",
	"commands.datapack.create.invalid_name": "El pack amb el nom \"%s\" té caràcters invàlids",
	"commands.datapack.create.io_failure": "No es pot crear el pack amb el nom \"%s\". Revisa'n els registres",
	"commands.datapack.create.metadata_encode_failure": "No s'han pogut codificar les metadades del paquet anomenat \"%s\": %s",
	"commands.datapack.create.success": "S'ha creat un pack buit amb el nom \"%s\"",
	"commands.datapack.disable.failed": "El paquet de dades \"%s\" no està activat!",
	"commands.datapack.disable.failed.feature": "No es pot desactivar el paquet de dades \"%s\", ja que és part d'una variable activada!",
	"commands.datapack.enable.failed": "El paquet de dades \"%s\" ja estava activat!",
	"commands.datapack.enable.failed.no_flags": "El paquet de dades \"%s\" no es pot activar, ja que les variables necessàries no estan activades en este món: %s!",
	"commands.datapack.list.available.none": "No hi ha més paquets de dades disponibles",
	"commands.datapack.list.available.success": "Hi ha %s paquet/s de dades disponible/s: %s",
	"commands.datapack.list.enabled.none": "No hi ha paquets de dades activats",
	"commands.datapack.list.enabled.success": "Hi ha %s paquet/s de dades activat/s: %s",
	...
	"commands.debug.alreadyRunning": "L'analitzador de tics ja està iniciat",
	"commands.debug.function.noRecursion": "No s'ha pogut traçar des de dins de la funció",
	"commands.debug.function.noReturnRun": "El seguiment no es pot utilitzar amb el retorn d'execució",
	"commands.debug.function.success.multiple": "S'han traçat %s comandaments de %s funcions al fitxer %s",
	"commands.debug.function.success.single": "S'han traçat %s comandaments de la funció \"%s\" al fitxer %s",
	"commands.debug.function.traceFailed": "No s'ha pogut traçar la funció",
	"commands.debug.notRunning": "L'analitzador de tics no s'ha iniciat",
	"commands.debug.started": "S'ha iniciat l'analitzador de tics",
	...
	"commands.dialog.clear.multiple": "S'ha borrat el diàleg per a %s jugadors",
	"commands.dialog.clear.single": "S'ha borrat el diàleg per a %s",
	"commands.dialog.show.multiple": "S'ha mostrat el diàleg per a %s jugadors",
	"commands.dialog.show.single": "S'ha mostrat el diàleg per a %s",
	...
	"commands.execute.conditional.fail_count": "Ha fallat la prova. Recompte: %s",
	"commands.execute.conditional.pass": "Prova superada",
	"commands.execute.conditional.pass_count": "Prova superada. Recompte: %s",
	"commands.execute.function.instantiationFailure": "No s'ha pogut instanciar la funció %s: %s",
	...
	"commands.fetchprofile.copy_component": "Copia el component",
	"commands.fetchprofile.copy_text": "Copia %s",
	"commands.fetchprofile.entity.success": "S'ha resolt el perfil per a l'entitat %s: %s",
	"commands.fetchprofile.failed_to_serialize": "No s'ha pogut publicar el perfil: %s",
	"commands.fetchprofile.give_item": "Dona l'objecte",
	"commands.fetchprofile.id.failure": "No s'ha trobat cap perfil per a l'ID %s",
	"commands.fetchprofile.id.success": "S'ha trobat un perfil per a l'ID %s: %s",
	"commands.fetchprofile.name.failure": "No s'ha trobat cap perfil per al nom %s",
	"commands.fetchprofile.name.success": "S'ha trobat un perfil per al nom %s: %s",
	"commands.fetchprofile.no_profile": "L'entitat %s no té perfil",
	"commands.fetchprofile.summon_mannequin": "Generar maniquí",
	"commands.fill.failed": "No s'han posat blocs",
	"commands.fill.success": "S'han omplit correctament %s bloc/s",
	...
	"commands.fillbiome.success.count": "S'han establit %s entrada/es de bioma entre %s, %s, %s i %s, %s, %s",
	...
	"commands.function.error.argument_not_compound": "El tipus d'argument no és vàlid: %s. S'esperava un compost",
	"commands.function.error.missing_argument": "Falta l'argument %[2]s en la funció %[1]s",
	"commands.function.error.missing_arguments": "Falten arguments en la funció %s",
	"commands.function.error.parse": "Mentre s'instanciava la macro %s: el comandament \"%s\" ha causat un error: %s",
	"commands.function.instantiationFailure": "No s'ha pogut instanciar la funció %s: %s",
	"commands.function.result": "La funció %s ha retornat %s",
	"commands.function.scheduled.multiple": "Executant les funcions %s",
	"commands.function.scheduled.no_functions": "No s'ha trobat cap funció per al nom %s",
	"commands.function.scheduled.single": "Executant les funcions %s",
	"commands.function.success.multiple": "S'han executat %s comandaments de %s funcions",
	"commands.function.success.multiple.result": "S'han executat %s funcions",
	"commands.function.success.single": "S'han executat %s comandaments de la funció \"%s\"",
	"commands.function.success.single.result": "La funció \"%[2]s\" ha tornat %[1]s",
	...
	"commands.kick.owner.failed": "No pots expulsar a l'amo del servidor LAN",
	"commands.kick.singleplayer.failed": "No es pot expulsar en una partida d'un jugador fora de línia",
	...
	"commands.perf.stopped": "S'ha parat l'anàlisi de rendiment després de %s segons i %s tic/s (%s tic/s per segon)",
	...
	"commands.profile_fetch.copy_component": "Copia el component",
	"commands.profile_fetch.failed_to_serialize": "No s'ha pogut publicar el perfil: %s",
	"commands.profile_fetch.give_item": "Dona l'objecte",
	"commands.profile_fetch.id.failure": "No s'ha trobat cap perfil per a l'id %s",
	"commands.profile_fetch.id.success": "S'ha trobat un perfil per a l'id %s: %s",
	"commands.profile_fetch.name.failure": "No s'ha trobat cap perfil per al nom %s",
	"commands.profile_fetch.name.success": "S'ha trobat un perfil per al nom %s: %s",
	"commands.publish.alreadyPublished": "La partida multijugador ja s'allotja al port %s",
	"commands.publish.alreadyPublished.lan": "El joc local ja està allotjat al port %s",
	"commands.publish.alreadyPublished.online": "La partida en línia ja està allotjada",
	"commands.publish.failed": "Impossible hostatjar el joc local",
	"commands.publish.started": "Joc local hostatjat al port %s",
	"commands.publish.started.lan": "Joc local allotjat al port %s",
	"commands.publish.started.online": "Partida en línia allotjada",
	"commands.publish.success": "La partida multijugador està ara allotjada al port %s",
	"commands.random.error.range_too_large": "El rang del valor aleatori ha de ser com a màxim 2147483646",
	"commands.random.error.range_too_small": "El rang del valor aleatori ha de ser com a mínim 2",
	"commands.random.reset.all.success": "Reinicia %s seqüències aleatòries",
	"commands.random.reset.success": "Reinicia la seqüència aleatòria %s",
	"commands.random.roll": "%s ha rodat %s (de %s a %s)",
	"commands.random.sample.success": "Valor aleatoritzat: %s",
	...
	"commands.ride.already_riding": "%s ja està muntat en %s",
	"commands.ride.dismount.success": "%s ha deixat de muntar en %s",
	"commands.ride.mount.failure.cant_ride_players": "Els jugadors no poden ser cavalcats",
	"commands.ride.mount.failure.generic": "%s no ha pogut començar a muntar en %s",
	"commands.ride.mount.failure.loop": "No es pot cavalcar una entitat en sí mateixa o en els seus passatgers",
	"commands.ride.mount.failure.wrong_dimension": "No pots cavalcar una entitat en una altra dimensió",
	"commands.ride.mount.success": "%s ha començat a muntar en %s",
	"commands.ride.not_riding": "%s no està muntant cap vehicle",
	"commands.rotate.success": "S'ha rotat %s",
	...
	"commands.schedule.cleared.failure": "No hi ha cap planificació amb l'id %s",
	"commands.schedule.cleared.success": "S'han eliminat %s planificacions amb id %s",
	"commands.schedule.created.function": "S'ha programat la funció \"%s\" en %s tic/s en temps de joc %s",
	"commands.schedule.created.tag": "S'ha programat l'etiqueta \"%s\" en %s tics en temps de joc %s",
	"commands.schedule.macro": "No s'ha pogut programar una macro",
	"commands.schedule.same_tick": "No es pot programar per al tic actual",
	...
	"commands.scoreboard.objectives.list.success": "Hi ha %s objectiu/s: %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "S'ha desactivat la notificació d'actualització automàtica per a l'objectiu %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "S'ha activat la notificació d'actualització automàtica per a l'objectiu %s",
	"commands.scoreboard.objectives.modify.displayname": "S'ha canviat el nom per mostrar de %s a %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "S'ha esborrat el format per defecte del número de l'objectiu %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "S'ha canviat el format per defecte del número de l'objectiu %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "S'ha esborrat el nom per a mostrar per a %s entitats en %s",
	"commands.scoreboard.players.display.name.clear.success.single": "S'ha esborrat el nom per a mostrar per a %s en %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "S'ha canviat el nom per a mostrar a %s per a %s entitats en %s",
	"commands.scoreboard.players.display.name.set.success.single": "S'ha canviat el nom per a mostrar a %s per a %s en %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "S'ha esborrat el format del número per a %s entitats en %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "S'ha esborrat el format del número per a %s en %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "S'ha canviat el format del número per a %s entitats en %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "S'ha canviat el format del número per a %s en %s",
	...
	"commands.scoreboard.players.list.success": "Hi ha %s entitat/s registrada/es: %s",
	...
	"commands.setidletimeout.success.disabled": "El temps d'inactivitat del jugador està ara desactivat",
	"commands.setworldspawn.failure.not_overworld": "Només pots establir el punt de reaparició a la superfície",
	"commands.setworldspawn.success": "S'ha establit el punt de reaparició del món a %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "S'ha establit el punt d'aparició del món a %s, %s, %s [%s, %s] a %s",
	"commands.spawnpoint.success.multiple": "S'ha establit el punt de reaparició a %s, %s, %s [%s] a %s per a %s jugadors",
	"commands.spawnpoint.success.multiple.new": "S'ha establit el punt d'aparició a %s, %s, %s [%s, %s] a %s per a %s jugadors",
	"commands.spawnpoint.success.single": "S'ha establit el punt de reaparició %s, %s, %s [%s] a %s per a %s",
	"commands.spawnpoint.success.single.new": "S'ha establit el punt d'aparició a %s, %s, %s [%s, %s] a %s per a %s",
	"commands.spectate.cannot_spectate": "%s no pot ser visualitzat",
	...
	"commands.spreadplayers.success.entities": "S'han escampat %s entitats al voltant de %s, %s amb una distància mitjana entre ells de %s blocs",
	...
	"commands.stopwatch.already_exists": "El Stopwatch \"%s\" ja existeix",
	"commands.stopwatch.create.success": "S'ha creat el Stopwatch \"%s\"",
	"commands.stopwatch.does_not_exist": "El Stopwatch \"%s\" no existeix",
	"commands.stopwatch.query": "El Stopwatch \"%s\" s'ha executat per a %ss",
	"commands.stopwatch.remove.success": "S'ha eliminat el Stopwatch \"%s\"",
	"commands.stopwatch.restart.success": "S'ha reiniciat el Stopwatch \"%s\"",
	"commands.summon.failed": "No s'ha pogut generar l'entitat",
	"commands.summon.failed.peaceful": "El monstre no pot generar-se en dificultat \"Pacífica\"",
	...
	"commands.swing.failed.notliving": "No s'han trobat entitats vives per moure",
	"commands.swing.success.multiple": "S'ha fet que %s entitats balancegen els braços",
	"commands.swing.success.single": "S'ha fet que %s balancege un braç",
	...
	"commands.team.list.members.success": "L'equip %s té %s membre/s: %s",
	"commands.team.list.teams.empty": "No hi ha equips",
	"commands.team.list.teams.success": "Hi ha %s equip/s: %s",
	...
	"commands.team.option.color.clear.success": "S'ha esborrat el color per a l'equip %s",
	...
	"commands.test.batch.starting": "Iniciant entorn %s del grup %s",
	"commands.test.clear.error.no_tests": "No s'ha pogut trobar cap prova per a eliminar",
	"commands.test.clear.success": "S'han eliminat %s estructures",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Clica per a copiar-ho al porta-retalls",
	"commands.test.create.success": "S'ha creat un test de configuració per al test %s",
	"commands.test.error.no_test_containing_pos": "No s'ha trobat la instància de prova que conté %s, %s, %s",
	"commands.test.error.no_test_instances": "No s'han trobat instàncies de proves",
	"commands.test.error.non_existant_test": "La prova %s no s'ha trobat",
	"commands.test.error.structure_not_found": "L'estructura de prova %s no s'ha trobat",
	"commands.test.error.test_instance_not_found": "No s'ha pogut trobar la instància de prova per al bloc-entitat",
	"commands.test.error.test_instance_not_found.position": "No s'ha pogut trobar la instància de prova per al bloc-entitat, per a la prova a %s, %s, %s",
	"commands.test.error.too_large": "La grandària de l'estructura ha de ser menor a %s blocs en cada eix",
	"commands.test.locate.done": "Localització finalitzada. S'han trobat %s estructures",
	"commands.test.locate.found": "Estructura trobada a: %s (distància: %s)",
	"commands.test.locate.started": "Localització d'estructures de prova iniciada. Açò pot tardar un poc...",
	"commands.test.no_tests": "No hi ha proves per a executar",
	"commands.test.relative_position": "Posició relativa a %s: %s",
	"commands.test.reset.error.no_tests": "No s'ha trobat cap prova per a reiniciar",
	"commands.test.reset.success": "L'estructura/estructures %s s'ha/han restablit",
	"commands.test.run.no_tests": "No s'han trobat proves",
	"commands.test.run.running": "Executant %s test/s...",
	"commands.test.summary": "Prova del joc completada! Executat/s %s test/s",
	"commands.test.summary.all_required_passed": "S'han superat tots els tests requerits :)",
	"commands.test.summary.failed": "Han fallat %s tests requerits :(",
	"commands.test.summary.optional_failed": "Han fallat %s tests opcionals",
	"commands.tick.query.percentiles": "Percentils: P50: %sms P95: %sms P99: %sms, mostra: %s",
	"commands.tick.query.rate.running": "Taxa de tics de l'objectiu: %s per segon.\nTemps mitjà per tic: %sms (Objectiu: %sms)",
	"commands.tick.query.rate.sprinting": "Taxa de tics de l'objectiu: %s per segon (ignorat, només de referència).\nTemps mitjà per tic: %sms",
	"commands.tick.rate.success": "Establix la taxa de tics de l'objectiu en %s per segon",
	"commands.tick.sprint.report": "S'ha completat la correguda amb %s tics per segon, o %s ms per tic",
	"commands.tick.sprint.stop.fail": "No hi ha cap correguda de tics en procés",
	"commands.tick.sprint.stop.success": "S'ha interromput una correguda de tic",
	"commands.tick.status.frozen": "El joc s'ha penjat",
	"commands.tick.status.lagging": "El joc s'està executant, però no es pot mantindre amb la taxa de tics de l'objectiu",
	"commands.tick.status.running": "El joc funciona amb normalitat",
	"commands.tick.status.sprinting": "El joc va a tota velocitat",
	"commands.tick.step.fail": "No s'ha pogut passar el joc - ha d'estar parat",
	"commands.tick.step.stop.fail": "No hi ha cap pas de tic en procés",
	"commands.tick.step.stop.success": "S'ha interromput un pas de tic",
	"commands.tick.step.success": "Passant %s tic/s",
	"commands.time.no_default_clock": "No hi ha rellotge predeterminat en la dimensió %s",
	"commands.time.no_time_marker_found": "El marcador de temps %s no existix per al rellotge %s",
	"commands.time.pause": "S'ha pausat el rellotge %s",
	"commands.time.query": "Hora: %s",
	"commands.time.query.absolute": "El rellotge %s està a %s tic/s",
	"commands.time.query.gametime": "El temps del joc és %s tic/s",
	"commands.time.query.timeline": "La línia de temps està a %s tic/s",
	"commands.time.query.timeline.repetitions": "La línia de temps ha fet %s repeticions",
	"commands.time.rate": "El rellotge %s ara avançarà a %sx de velocitat normal",
	"commands.time.resume": "Rellotge resumit %s",
	"commands.time.set": "S'ha canviat l'hora a %s",
	"commands.time.set.absolute": "S'ha establit %s a %s tic/s",
	"commands.time.set.time_marker": "S'ha establit %s al marcador de temps %s",
	"commands.time.wrong_timeline_for_clock": "La línia de temps %s no és vàlida per al rellotge %s",
	...
	"commands.transfer.error.no_players": "Has d'especificar almenys un jugador per transferir",
	"commands.transfer.success.multiple": "Transferint %s jugadors a %s:%s",
	"commands.transfer.success.single": "Transferint %s a %s:%s",
	...
	"commands.unpublish.notPublished": "No s’ha publicat cap partida multijugador",
	"commands.unpublish.success": "La partida multijugador ja no està publicada",
	"commands.version.build_time": "build_time = %s",
	"commands.version.data": "data = %s",
	"commands.version.header": "Informació de la versió del servidor:",
	...
	"commands.waypoint.list.empty": "No hi ha punts de ruta en %s",
	"commands.waypoint.list.success": "%s punt/s de ruta en %s: %s",
	"commands.waypoint.modify.color": "El color del punt de ruta ara és %s",
	"commands.waypoint.modify.color.reset": "Restablix el color del punt de ruta",
	"commands.waypoint.modify.style": "S'ha canviat l'estil del punt de ruta",
	...
	"commands.worldborder.get": "El límit del món té actualment %s bloc/s d'ample",
	...
	"commands.worldborder.set.immediate": "S'ha establit el límit del món a %s bloc/s d'ample",
	"commands.worldborder.set.shrink": "Reduint el límit del món a %s bloc/s d'ample en %s segon/s",
	"commands.worldborder.warning.distance.failed": "Res ha canviat, l'avís del límit del món ja tenia eixa distància",
	"commands.worldborder.warning.distance.success": "S'ha establit la distància d'advertència del límit del món a %s bloc/s",
	"commands.worldborder.warning.time.failed": "Res ha canviat, l'avís del límit del món ja durava eixe temps",
	"commands.worldborder.warning.time.success": "S'ha establit el temps d'advertència del límit del món a %s segon/s",
	...
	"component.profile.dynamic": "Dinamic",
	...
	"connect.failed.transfer": "La connexió ha fallat mentre es transferia al servidor",
	"connect.joining": "Entrant al món...",
	"connect.negotiating": "Connectant...",
	"connect.p2p.establishing": "Establint connexió...",
	"connect.p2p.failed.generic": "No s’ha pogut connectar al jugador",
	"connect.p2p.failed.signaling": "No és possible connectar ara mateix. Torna-ho a intentar més tard.",
	"connect.p2p.failed.timeout": "El temps de connexió ha expirat",
	"connect.p2p.failed.unreachable": "El jugador no és accessible",
	"connect.reconfiging": "Reconfigurant...",
	"connect.reconfiguring": "Reconfigurant...",
	"connect.transferring": "Transferint al nou servidor...",
	"container.barrel": "Barril",
	"container.beacon": "Far màgic",
	"container.beehive.bees": "Abelles: %s/%s",
	...
	"container.upgrade.error_tooltip": "L'objecte no es pot millorar així",
	"container.upgrade.missing_template_tooltip": "Afig motle de ferreria",
	"controls.keybinds": "Controls...",
	"controls.keybinds.duplicateKeybinds": "Esta tecla ja s'utilitza per a:\n%s",
	...
	"createWorld.customize.buffet.search": "Busca...",
	"createWorld.customize.buffet.title": "Personalització del món d'un sol bioma",
	...
	"credits_and_attribution.button.attribution": "Atribució",
	...
	"dataPack.locator_bar.description": "Mostra la direcció dels altres jugadors en multijugador",
	"dataPack.locator_bar.name": "Barra de localització",
	"dataPack.minecart_improvements.description": "Moviment millorat per a vagonetes",
	"dataPack.minecart_improvements.name": "Millores de les vagonetes",
	"dataPack.redstone_experiments.description": "Canvis experimentals de redstone",
	"dataPack.redstone_experiments.name": "Experiments de redstone",
	"dataPack.title": "Selecciona els paquets de dades",
	"dataPack.trade_rebalance.description": "S'han actualitzat els intercanvis dels vilatans",
	"dataPack.trade_rebalance.name": "Reequilibri dels intercanvis dels vilatans",
	...
	"dataPack.update_1_21.description": "Noves funcions i contingut per al Minecraft 1.21",
	"dataPack.update_1_21.name": "Actualització 1.21",
	...
	"dataPack.winter_drop.description": "Noves funcions i contingut per a l'estrena d'hivern",
	"dataPack.winter_drop.name": "Estrena d'hivern",
	"datapackFailure.safeMode": "Mode segur",
	"datapackFailure.safeMode.failed.description": "Este món conté dades guardades corruptes o invàlides.",
	"datapackFailure.safeMode.failed.title": "Error en carregar el món en mode segur.",
	...
	"death.attack.cactus.player": "%[1]s ha xocat amb un cactus mentre fugia de %[2]s",
	...
	"death.attack.genericKill": "%[1]s ha sigut assassinat",
	"death.attack.genericKill.player": "%[1]s ha sigut assassinat mentre lluitava contra %[2]s",
	"death.attack.hotFloor": "%[1]s ha descobert que el terra era lava",
	"death.attack.hotFloor.player": "%[1]s ha entrat en la zona de perill degut a %[2]s",
	"death.attack.inFire": "%[1]s s'ha socarrat",
	"death.attack.inFire.player": "%[1]s ha entrat al foc mentre lluitava amb %[2]s",
	...
	"death.attack.mace_smash": "%[1]s ha sigut destrossat per %[2]s",
	"death.attack.mace_smash.item": "%[1]s ha sigut destrossat per %[2]s utilitzant %[3]s",
	...
	"death.attack.message_too_long": "El missatge és massa llarg per enviar-se completament. Ho lamentem! Ací en tens una versió abreujada: %s",
	...
	"death.attack.onFire.item": "%[1]s s'ha rostit mentre lluitava amb %[2]s empunyant %[3]s",
	"death.attack.onFire.player": "%[1]s s'ha rostit mentre lluitava amb %[2]s",
	"death.attack.outOfWorld": "%[1]s ha caigut al buit",
	"death.attack.outOfWorld.player": "%[1]s no volia viure al mateix món que %[2]s",
	"death.attack.outsideBorder": "%[1]s se n'ha anat dels confins del món",
	"death.attack.outsideBorder.player": "%[1]s se n'ha anat dels confins del món mentre lluitava amb %[2]s",
	...
	"death.attack.sonic_boom.item": "%[1]s ha sigut arrasat per un crit sònic mentre intentava escapar de %[2]s empunyant %[3]s",
	"death.attack.sonic_boom.player": "%[1]s ha sigut arrasat per un crit sònic mentre escapava de %[2]s",
	"death.attack.spear": "%[1]s ha sigut llancejat per %[2]s",
	"death.attack.spear.item": "%[1]s ha sigut llancejat per %[2]s utilitzant %[3]s",
	"death.attack.stalagmite": "%[1]s ha sigut travessat per una estalagmita",
	"death.attack.stalagmite.player": "%[1]s ha sigut empalat per una estalagmita mentre lluitava amb %[2]s",
	...
	"death.attack.sulfurCubeHot": "%[1]s ha mort perquè no només el terra és lava",
	"death.attack.sulfurCubeHot.player": "%[2]s ha demostrat a %[1]s que no només el terra és lava",
	...
	"death.attack.thorns": "%[1]s ha sigut assassinat mentre intentava ferir %[2]s",
	...
	"death.attack.witherSkull.item": "%[1]s ha sigut alcançat per una calavera de %[2]s utilitzant %[3]s",
	...
	"deathScreen.score.value": "Puntuació: %s",
	...
	"debug.copy_location.help": "F3 + C = copia la localització com a comandament /tp, o mantín-ho 10 segons per tancar bruscament el joc",
	...
	"debug.crash.message.rebindable": "Estàs prement %s + %s. Si no les deixes anar, el joc deixarà de funcionar.",
	"debug.crash.warning": "Tancant bruscament el joc en %s...",
	"debug.creative_spectator.error": "No tens permís per a canviar el mode de joc",
	"debug.creative_spectator.help": "F3 + N = Alterna entre el mode de joc anterior <-> espectador",
	"debug.dump_dynamic_textures": "Les textures dinàmiques s'han guardat en %s",
	"debug.dump_dynamic_textures.help": "F3 + S = bolca les textures dinàmiques",
	"debug.entry.always": "Sempre",
	"debug.entry.currently.alwaysOn": "%s: actualment sempre",
	"debug.entry.currently.inF3": "%s: actualment només en F3",
	"debug.entry.currently.inOverlay": "%s: actualment només en la superposició depuració",
	"debug.entry.currently.never": "%s: actualment desactivat",
	"debug.entry.f3": "En F3",
	"debug.entry.overlay": "En superposició",
	...
	"debug.options.category.renderer": "Renderitzadors de depuració",
	"debug.options.category.text": "Text de la pantalla de depuració",
	"debug.options.help": "F3 + F5 = edita les opcions de depuració",
	"debug.options.notAllowed.tooltip": "No visible quan la informació de depuració és reduïda",
	"debug.options.profile.default": "Perfil per defecte",
	"debug.options.profile.performance": "Perfil de rendiment",
	"debug.options.search": "Busca...",
	"debug.options.title": "Opcions de depuració",
	"debug.options.warning": "Estes opcions són només per a proves. Potser facen que el teu ordinador vaja més lent, es tanque el joc, o que tot pegue el pet.",
	...
	"debug.profiling.start.rebindable": "S'ha iniciat l'anàlisi per %s segons. Prem %s + %s per parar-lo abans",
	...
	"debug.version.header": "Informació de la versió del client:",
	"debug.version.help": "F3 + V = informació de la versió del client",
	...
	"disconnect.ignoring_status_request": "Ignorant la petició d'estat",
	...
	"disconnect.packetError": "Error de protocol de xarxa",
	"disconnect.spam": "Expulsat per fer spam",
	"disconnect.timeout": "Temps d'espera esgotat",
	"disconnect.transfer": "S'ha transferit a un altre servidor",
	"disconnect.unknownHost": "Amfitrió desconegut",
	"download.pack.failed": "%s de %s paquets no s'han pogut descarregar",
	"download.pack.progress.bytes": "Progrés: %s (grandària total desconeguda)",
	"download.pack.progress.percent": "Progrés: %s%%",
	"download.pack.title": "Descarregant paquet de recursos %s/%s",
	"editGamerule.default": "Per defecte: %s",
	"editGamerule.inGame.button": "Edita les regles del joc...",
	"editGamerule.inGame.disabled.tooltip": "Actualitzar les regles del joc requerix permisos d'operador.",
	"editGamerule.inGame.discardChanges.message": "Estàs segur que vols descartar els canvis pendents a les regles del joc?",
	"editGamerule.inGame.discardChanges.title": "Canvis a les regles del joc",
	"editGamerule.inGame.downloadingGamerules": "Recuperant les regles del joc...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Alé de nautilus",
	...
	"effect.minecraft.oozing": "Supuració",
	"effect.minecraft.poison": "Verí",
	"effect.minecraft.raid_omen": "Presagi d'assalt",
	...
	"enchantment.minecraft.breach": "Clevill",
	...
	"enchantment.minecraft.knockback": "Espenta",
	...
	"enchantment.minecraft.lunge": "Envestida",
	...
	"enchantment.minecraft.sweeping_edge": "Batuda",
	...
	"enchantment.minecraft.wind_burst": "Explosió de vent",
	"entity.minecraft.acacia_boat": "Barca d'acàcia",
	"entity.minecraft.acacia_chest_boat": "Barca d'acàcia amb cofre",
	"entity.minecraft.allay": "Al·lai",
	...
	"entity.minecraft.bamboo_chest_raft": "Rai de bambú amb cofre",
	"entity.minecraft.bamboo_raft": "Rai de bambú",
	"entity.minecraft.bat": "Ratpenat",
	"entity.minecraft.bee": "Abella",
	"entity.minecraft.birch_boat": "Barca de bedoll",
	"entity.minecraft.birch_chest_boat": "Barca de bedoll amb cofre",
	"entity.minecraft.blaze": "Flama",
	"entity.minecraft.block_display": "Exhibir bloc",
	"entity.minecraft.boat": "Barca",
	"entity.minecraft.bogged": "Esquelet empantanat",
	"entity.minecraft.breeze": "Brisa",
	"entity.minecraft.breeze_wind_charge": "Càrrega de vent",
	"entity.minecraft.camel": "Dromedari",
	"entity.minecraft.camel_husk": "Dromedari momificat",
	"entity.minecraft.cat": "Gat",
	"entity.minecraft.cave_spider": "Aranya de cova",
	"entity.minecraft.cherry_boat": "Barca de cirerer",
	"entity.minecraft.cherry_chest_boat": "Barca de cirerer amb cofre",
	...
	"entity.minecraft.copper_golem": "Gólem de coure",
	"entity.minecraft.cow": "Vaca",
	"entity.minecraft.creaking": "Crepitant",
	"entity.minecraft.creaking_transient": "Crepitant",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Barca de roure fosc",
	"entity.minecraft.dark_oak_chest_boat": "Barca de roure fosc amb cofre",
	...
	"entity.minecraft.falling_block_type": "%s està caient",
	...
	"entity.minecraft.happy_ghast": "Ghast feliç",
	...
	"entity.minecraft.item_display": "Exhibir objecte",
	"entity.minecraft.item_frame": "Marc",
	"entity.minecraft.jungle_boat": "Barca de jungla",
	"entity.minecraft.jungle_chest_boat": "Barca de jungla amb cofre",
	...
	"entity.minecraft.lingering_potion": "Poció persistent",
	...
	"entity.minecraft.mangrove_chest_boat": "Barca de mangle amb cofre",
	...
	"entity.minecraft.oak_boat": "Barca de roure",
	"entity.minecraft.oak_chest_boat": "Barca de roure amb cofre",
	"entity.minecraft.ocelot": "Ocelot",
	"entity.minecraft.ominous_item_spawner": "Generador ominós d'objectes",
	"entity.minecraft.painting": "Quadre",
	"entity.minecraft.pale_oak_boat": "Barca de roure tètric",
	"entity.minecraft.pale_oak_chest_boat": "Barca de roure tètric amb cofre",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Esquelet de les arenes",
	...
	"entity.minecraft.sniffer": "Rastrejador",
	"entity.minecraft.snow_golem": "Gólem de neu",
	...
	"entity.minecraft.splash_potion": "Poció explosiva",
	"entity.minecraft.spruce_boat": "Barca de pícea",
	"entity.minecraft.spruce_chest_boat": "Barca de pícea amb cofre",
	"entity.minecraft.squid": "Calamar",
	"entity.minecraft.stray": "Esquelet glacial",
	"entity.minecraft.strider": "Caminant",
	"entity.minecraft.sulfur_cube": "Cub de sofre",
	"entity.minecraft.sulfur_cube.content": "Conté: %s",
	"entity.minecraft.tadpole": "Cullerot",
	"entity.minecraft.text_display": "Exhibir text",
	...
	"entity.minecraft.villager.armorer": "Ferrer",
	...
	"entity.minecraft.wind_charge": "Càrrega de vent",
	...
	"event.minecraft.raid.defeat.full": "Assalt - Derrota",
	"event.minecraft.raid.raiders_remaining": "Queden %s assaltants",
	"event.minecraft.raid.victory": "Victòria",
	"event.minecraft.raid.victory.full": "Assalt - Victòria",
	"filled_map.buried_treasure": "Mapa del tresor enterrat",
	"filled_map.explorer_jungle": "Mapa d'exploració de jungla",
	"filled_map.explorer_swamp": "Mapa d'exploració de pantà",
	"filled_map.id": "Id #%s",
	...
	"filled_map.trial_chambers": "Mapa de masmorra de reptes",
	"filled_map.unknown": "Mapa desconegut",
	"filled_map.village_desert": "Mapa de vila de desert",
	"filled_map.village_plains": "Mapa de vila de prats",
	"filled_map.village_savanna": "Mapa de vila de sabana",
	"filled_map.village_snowy": "Mapa de vila nevada",
	"filled_map.village_taiga": "Mapa de vila de taigà",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Permet el Nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Controla si els jugadors poden accedir al Nether.",
	"gamerule.allowFireTicksAwayFromPlayer": "Tics de foc allunyats dels jugadors",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Controla si el foc o la lava haurien de carregar tics a una distància de més de 8 chunks dels jugadors.",
	...
	"gamerule.commandBlocksEnabled": "Permet els blocs de comandaments",
	"gamerule.commandModificationBlockLimit": "Límit de blocs modificables per comandaments",
	"gamerule.commandModificationBlockLimit.description": "Quantitat de blocs que es poden canviar alhora amb un comandament, com \"fill\" o \"clone\".",
	"gamerule.disableElytraMovementCheck": "Desactiva la comprovació de moviment dels èlitres",
	"gamerule.disablePlayerMovementCheck": "Desactiva la comprovació de moviment del jugador",
	...
	"gamerule.doVinesSpread.description": "Controla si les lianes es propaguen aleatòriament als blocs adjacents o no. No afecta a altres tipus de lianes com ara les carmesines, les estrambòtiques, etc.",
	...
	"gamerule.enableCommandBlocks": "Permet els blocs de comandaments",
	"gamerule.enderPearlsVanishOnDeath": "Les perles d'Ender llançades desapareixen en morir",
	"gamerule.enderPearlsVanishOnDeath.description": "Determina si les perles d'Ender llançades per un jugador desapareixen quan es mor o no.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Les entitats amb passatgers poden utilitzar portals",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Permet que les entitats amb passatgers es teletransporten a través de portals del Nether, de l'End i portes de l'End.",
	...
	"gamerule.lavaSourceConversion.description": "Quan la lava fluent es rodege pels dos costats per fonts de lava, es convertirà en font.",
	"gamerule.locatorBar": "Activa la barra de localització de jugadors",
	"gamerule.locatorBar.description": "Quan s'activa, es mostra una barra a la pantalla que indica la direcció dels jugadors.",
	...
	"gamerule.maxCommandForkCount": "Límit de contextos del commandament",
	"gamerule.maxCommandForkCount.description": "Número màxim de contextos que poden ser usats per comandaments com \"execute as\".",
	"gamerule.maxEntityCramming": "Límit d'entitats per bloc",
	"gamerule.minecartMaxSpeed": "Velocitat màxima de les vagonetes",
	"gamerule.minecartMaxSpeed.description": "Velocitat màxima per defecte d'una vagoneta en moviment a terra",
	"gamerule.minecraft.elytra_movement_check": "Comprova el moviment dels èlitres",
	"gamerule.minecraft.fire_spread_radius_around_player": "Radi de propagació del foc",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "El radi en blocs al voltant del jugador en el qual el foc es pot propagar",
	"gamerule.minecraft.player_movement_check": "Comprova el moviment del jugador",
	"gamerule.minecraft.raids": "Permetre assalts",
	"gamerule.minecraft.universal_anger.description": "Les criatures neutrals enfadades atacaran els jugadors propers, no només qui les haja molestat. Funciona millor si \"forgive_dead_players\" està desactivat.",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Temps d'espera del jugador en mode creatiu per a entrar a un portal del Nether",
	"gamerule.playersNetherPortalCreativeDelay.description": "Temps (en tics) que un jugador en mode creatiu ha d'estar en un portal del Nether per a canviar de dimensió.",
	"gamerule.playersNetherPortalDefaultDelay": "Temps d'espera del jugador en un mode distint al creatiu per a entrar a un portal del Nether",
	"gamerule.playersNetherPortalDefaultDelay.description": "Temps (en tics) que un jugador en un mode distint al creatiu ha d'estar en un portal del Nether per a canviar de dimensió.",
	...
	"gamerule.projectilesCanBreakBlocks": "Els projectils poden trencar blocs",
	"gamerule.projectilesCanBreakBlocks.description": "Determina si els projectils poden trencar blocs que puguen ser trencats per ells o no.",
	"gamerule.pvp": "Permet el pvp",
	"gamerule.pvp.description": "Controla si els jugadors poden o no inflingir dany a altres jugadors.",
	"gamerule.randomTickSpeed": "Freqüència de tics aleatoris",
	...
	"gamerule.spawnChunkRadius": "Radi del punt de reaparició",
	"gamerule.spawnChunkRadius.description": "Quantitat de chunks que es mantindran carregats al voltant del punt de reaparició de la superfície.",
	"gamerule.spawnMonsters": "Genera monstres",
	"gamerule.spawnMonsters.description": "Controla si els monstres es poden generar de forma natural o no.",
	"gamerule.spawnRadius": "Radi del punt de reaparició",
	"gamerule.spawnRadius.description": "Controla la grandària de l'àrea al voltant del punt de reaparició on els jugadors poden aparéixer.",
	"gamerule.spawnerBlocksEnabled": "Permet els generadors de monstres",
	"gamerule.spectatorsGenerateChunks": "Permet als espectadors generar terreny",
	"gamerule.tntExplodes": "Permet que la dinamita puga activar-se i esclatar",
	...
	"gui.abuseReport.attestation": "Enviant esta denúncia, confirmes que la informació proporcionada és precisa i completa segons el teu coneixement.",
	"gui.abuseReport.comments": "Comentaris",
	"gui.abuseReport.describe": "Compartir detalls ens ajudarà a prendre la millor decisió.",
	"gui.abuseReport.discard.content": "Si ixes perdràs la denúncia i els comentaris.\nSegur que vols eixir?",
	"gui.abuseReport.discard.discard": "Ix i descarta la denúncia",
	"gui.abuseReport.discard.draft": "Guarda com a esborrany",
	"gui.abuseReport.discard.return": "Continua editant",
	"gui.abuseReport.discard.title": "Vols descartar la denúncia i els comentaris?",
	"gui.abuseReport.draft.content": "Vols continuar editant la denúncia existent o descartar-la i crear-ne una de nova?",
	"gui.abuseReport.draft.discard": "Descarta",
	"gui.abuseReport.draft.edit": "Continua editant",
	"gui.abuseReport.draft.quittotitle.content": "Vols continuar editant-la o descartar-la?",
	"gui.abuseReport.draft.quittotitle.title": "Tens una denúncia de xat en esborranys que es perdrà si ixes",
	"gui.abuseReport.draft.title": "Vols editar l'esborrany de la denúncia de xat?",
	"gui.abuseReport.error.title": "Hi ha hagut un problema en enviar la teua denúncia",
	"gui.abuseReport.message": "On has vist el mal comportament?\nAixò ens ajudarà a estudiar el teu cas.",
	"gui.abuseReport.more_comments": "Per favor, descriu què ha passat:",
	"gui.abuseReport.name.comment_box_label": "Per favor, descriu per què vols denunciar este nom:",
	"gui.abuseReport.name.reporting": "Estàs denunciant a \"%s\".",
	"gui.abuseReport.name.title": "Denúncia el nom del jugador",
	"gui.abuseReport.observed_what": "Per què denuncies això?",
	"gui.abuseReport.read_info": "Aprén dobre denunciar",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Difamació",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Algú està danyant la reputació d'un altre, per exemple compartint informació falsa, amb la intenció d'explotar o enganyar els altres.",
	"gui.abuseReport.reason.description": "Descripció:",
	"gui.abuseReport.reason.false_reporting": "Denúncia falsa",
	"gui.abuseReport.reason.generic": "Vull denunciar-los",
	"gui.abuseReport.reason.generic.description": "Estic molest amb ells/es / han fet una cosa que no m'agrada.",
	...
	"gui.abuseReport.reason.imminent_harm": "Amenaça de danyar als altres",
	...
	"gui.abuseReport.reason.self_harm_or_suicide": "Autolesió o suïcidi",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Sexualment inapropiat",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Aspectes que són gràfics en temes d'actes sexuals, òrgans sexuals i violència sexual.",
	...
	"gui.abuseReport.report_sent_msg": "Hem rebut la teua denúncia. Gràcies!\n\nEl nostre equip la revisarà el més prompte possible.",
	"gui.abuseReport.select_reason": "Selecciona la categoria de la denúncia",
	"gui.abuseReport.send": "Envia la denúncia",
	"gui.abuseReport.send.comment_too_long": "Per favor, acurta el comentari",
	...
	"gui.abuseReport.send.no_reason": "Per favor, tria una categoria de denúncia",
	"gui.abuseReport.send.not_attested": "Per favor, llig el text anterior i marca la casella per a poder enviar la denúncia",
	...
	"gui.abuseReport.skin.title": "Denuncia l'aspecte d'un jugador",
	"gui.abuseReport.title": "Denuncia un jugador",
	"gui.abuseReport.type.chat": "Missatges del xat",
	"gui.abuseReport.type.name": "Nom del jugador",
	"gui.abuseReport.type.skin": "Aspecte del jugador",
	...
	"gui.banned.name.description": "El teu nom actual - \"%s\" - no complix amb els estàndards de la comunitat. Podràs jugar en mode \"Un jugador\", però hauràs de canviar-te'l per jugar en línia.\n\nAprén-ne més o presenta una apel·lació en l'enllaç següent: %s",
	"gui.banned.name.title": "El nom no està permés en multijugador",
	"gui.banned.reason.defamation_impersonation_false_information": "Suplantació o compartició d'informació per a explotar o enganyar als altres",
	"gui.banned.reason.drugs": "Referències a drogues il·legals",
	"gui.banned.reason.extreme_violence_or_gore": "Representacions de violència excessiva o gore en la vida real",
	"gui.banned.reason.false_reporting": "Denúncies excessives o imprecises",
	"gui.banned.reason.fraud": "Adquisició o ús fraudulent de contingut",
	"gui.banned.reason.generic_violation": "Violació dels estàndards de la comunitat",
	"gui.banned.reason.harassment_or_bullying": "Llenguatge abussiu utilitzat de forma directa o perjudicial",
	"gui.banned.reason.hate_speech": "Discurs d'odi o discriminació",
	"gui.banned.reason.hate_terrorism_notorious_figure": "Referències a grups d'odi, organitzacions terroristes o figures notòries",
	"gui.banned.reason.imminent_harm_to_person_or_property": "Intent de causar mal en la vida real a persones o propietats",
	"gui.banned.reason.nudity_or_pornography": "Mostra de material pornogràfic o luxuriós",
	"gui.banned.reason.sexually_inappropriate": "Temes o contingut de naturalesa sexual",
	"gui.banned.reason.spam_or_advertising": "Spam o publicitat",
	"gui.banned.skin.description": "El teu aspecte actual no complix amb els estàndards de la comunitat. Podràs jugar amb un aspecte per defecte o triar-ne un de nou.\n\nAprén-ne més o presenta una apel·lació en l'enllaç següent: %s",
	"gui.banned.skin.title": "Aspecte no permés",
	...
	"gui.chatReport.title": "Denuncia el xat d'un jugador",
	...
	"gui.copy_link_to_clipboard": "Copia l'enllaç al porta-retalls",
	"gui.days": "%s dia/es",
	"gui.done": "Fet",
	"gui.down": "Avall",
	"gui.entity_tooltip.type": "Tipus: %s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "%s fitxers rebutjats",
	"gui.fileDropFailure.title": "No s'han pogut afegir els arxius",
	"gui.friends.accept": "Acceptar",
	"gui.friends.button.loading": "Espera...",
	"gui.friends.button.loading.invite_request_pending": "Esperant confirmació",
	"gui.friends.button.loading.join_request_pending": "Esperant confirmació de %s",
	"gui.friends.cancel_request": "Cancel·lar sol·licitud",
	"gui.friends.confirm_title": "Confirmar",
	"gui.friends.confirm_unfriend": "Estàs segur que vols eliminar este jugador de la teua llista d’amics?",
	"gui.friends.copy_to_clipboard": "Copiar al porta-retalls",
	"gui.friends.decline": "Rebutjar",
	"gui.friends.empty_nickname": "Introdueix un nom de perfil vàlid abans d’enviar una sol·licitud d’amistat",
	"gui.friends.empty_state": "Els amics que afegisques apareixeran ací.\n\nGestiona la seguretat en línia amb el teu %s.",
	"gui.friends.empty_state.link": "Compte de Microsoft",
	"gui.friends.enter_nickname": "Introdueix el nom del perfil",
	"gui.friends.error.connection_issue": "La llista d’amics no funciona ara mateix.\n\nComprova la connexió a internet i torna-ho a intentar.",
	"gui.friends.error.failed.message": "No s’ha pogut enviar la teua sol·licitud d’amistat ara mateix",
	"gui.friends.error.forbidden.message": "No s’ha pogut completar esta acció. Pot ser a causa de la configuració de privacitat del compte.",
	"gui.friends.error.generic": "Alguna cosa ha fallat — amb esta funció, no amb els teus amics!\n\nTorna-ho a intentar més tard.",
	"gui.friends.error.rateLimited.message": "Estàs fent massa accions de la llista d’amics massa ràpid. Espera un moment i torna-ho a intentar.",
	"gui.friends.error.temporary_unavailable": "La llista d’amics no funciona ara mateix.\n\nTorna-ho a intentar més tard.",
	"gui.friends.error.unavailable.message": "El servei de la llista d’amics no està disponible actualment. Comprova la connexió i torna-ho a intentar més tard.",
	"gui.friends.error.upgrade_needed": "Actualitza el joc per a accedir a la teua llista d’amics.",
	"gui.friends.error.user_may_lack_active_profile": "No hi ha cap jugador amb este nom de perfil",
	"gui.friends.join": "Unir-se",
	"gui.friends.loading_friends": "Carregant la llista d’amics...",
	"gui.friends.loading_requests": "Carregant sol·licituds...",
	"gui.friends.manage_account_footer": "Gestiona la seguretat en línia amb el teu %s",
	"gui.friends.multiplayer.invite": "Convidar al món",
	"gui.friends.multiplayer.invite_accept": "Acceptar invitació al món",
	"gui.friends.multiplayer.invite_reject": "Rebutjar invitació al món",
	"gui.friends.multiplayer.join_request": "Sol·licitar unir-se al món",
	"gui.friends.multiplayer.join_request_accept": "Acceptar sol·licitud per a unir-se al món",
	"gui.friends.multiplayer.join_request_reject": "Rebutjar sol·licitud per a unir-se al món",
	"gui.friends.my_profile_name": "El meu nom de perfil: ",
	"gui.friends.my_profile_name.narration": "Copiar el nom del perfil %s al porta-retalls",
	"gui.friends.narration.button.accept": "Prem Intro per a acceptar la sol·licitud d’amistat de %s",
	"gui.friends.narration.button.cancel_request": "Prem Intro per a cancel·lar la sol·licitud d’amistat a %s",
	"gui.friends.narration.button.decline": "Prem Intro per a rebutjar la sol·licitud d’amistat de %s",
	"gui.friends.narration.button.unfriend": "Prem Intro per a eliminar %s de la llista d’amics",
	"gui.friends.narration.entry.friend": "Amic %s",
	"gui.friends.narration.entry.incoming": "Sol·licitud d’amistat entrant de %s",
	"gui.friends.narration.entry.outgoing": "Sol·licitud d’amistat enviada a %s",
	"gui.friends.open": "Amics",
	"gui.friends.open.narration": "Llista d’amics",
	"gui.friends.open.tooltip": "Amics",
	"gui.friends.pending.empty": "No hi ha sol·licituds d’amistat pendents",
	"gui.friends.pending.received": "Rebudes",
	"gui.friends.pending.sent": "Enviades",
	"gui.friends.presence.status.offline": "Desconnectat",
	"gui.friends.presence.status.online": "Connectat",
	"gui.friends.presence.status.playing_hosted_server": "En un món al qual es pot unir",
	"gui.friends.presence.status.playing_offline": "En un món",
	"gui.friends.presence.status.playing_realms": "En un Realm",
	"gui.friends.presence.status.playing_server": "En un servidor",
	"gui.friends.requests_count": "Sol·licituds (%s)",
	"gui.friends.send_request": "Enviar sol·licitud d’amistat",
	"gui.friends.tab_friends": "Amics",
	"gui.friends.toast.friend_added.message": "%s ha acceptat la teua sol·licitud d’amistat",
	"gui.friends.toast.friend_invited.message": "%s ha sigut convidat a unir-se al teu món.",
	"gui.friends.toast.friend_removed.message": "%s ha sigut eliminat de la teua llista d’amics",
	"gui.friends.toast.generic_error": "S’ha produït un error inesperat mentre s’actualitzava la teua llista d’amics. Torna-ho a intentar més tard.",
	"gui.friends.toast.host_invite_expired.message": "La invitació de %s per a unir-te a este món ha caducat.",
	"gui.friends.toast.invite_from_friend.message": "%s t’ha convidat a unir-te al seu món. Obri la llista d’amics prement “%s” per a unir-te",
	"gui.friends.toast.join_invite_expired.message": "La invitació per a unir-te al món de %s ha caducat.",
	"gui.friends.toast.join_request.message": "%s ha sol·licitat unir-se al teu món. Obri la llista d’amics prement “%s” o accedix-hi des del menú del joc.",
	"gui.friends.toast.request_accepted.message": "Ara sou amics amb %s",
	"gui.friends.toast.request_received.message": "%s t’ha enviat una sol·licitud d’amistat",
	"gui.friends.toast.request_sent.message": "Sol·licitud d’amistat enviada a %s",
	"gui.friends.toast.request_to_join_friend.message": "S’ha enviat una sol·licitud per a unir-se al món a %s",
	"gui.friends.toast.requests_accepted_multiple.message": "%s amics han acceptat les teues sol·licituds d’amistat",
	"gui.friends.toast.requests_received_multiple.message": "Has rebut %s sol·licituds d’amistat",
	"gui.friends.unfriend": "Eliminar amic",
	"gui.game_rule.search": "Busca...",
	"gui.hours": "%s hora/es",
	"gui.language.search": "Busca...",
	"gui.loadingMinecraft": "Carregant el Minecraft",
	...
	"gui.none": "Cap",
	"gui.ok": "D'acord",
	"gui.open_report_dir": "Obri el directori d'informes",
	"gui.packSelection.search": "Busca...",
	"gui.privacy_link.message": "Obri este enllaç per a gestionar la configuració de privacitat i seguretat en línia.",
	"gui.privacy_link.title": "Els canvis en la configuració d’Xbox poden tardar un temps a aplicar-se.\n\nSi no s’actualitzen, reinicia el joc.",
	"gui.proceed": "Continua",
	"gui.recipebook.moreRecipes": "Clic dret per a més informació",
	"gui.recipebook.next_page": "Pàgina següent",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Pàgina anterior",
	...
	"gui.remove": "Eliminar",
	"gui.report_to_server": "Informa'n el servidor",
	"gui.selectWorld.search": "Busca...",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "No es pot denunciar al jugador perquè el xat està desactivat o bloquejat",
	...
	"gui.stats.none_found": "No s'han trobat estadístiques.",
	"gui.toMenu": "Torna a la llista de servidors",
	"gui.toRealms": "Torna a la llista de Realms",
	"gui.toTitle": "Torna a l'inici",
	"gui.toWorld": "Torna a la llista de mons",
	"gui.togglable_slot": "Fes clic per a desactivar l'espai",
	"gui.up": "Amunt",
	"gui.waitingForResponse.button.inactive": "Arrere (%ss)",
	"gui.waitingForResponse.title": "Esperant al servidor",
	"gui.yes": "Sí",
	...
	"item.minecraft.allay_spawn_egg": "Generar al·lai",
	"item.minecraft.amethyst_shard": "Fragment d'ametista",
	"item.minecraft.angler_pottery_shard": "Fragments de gerro de pescador",
	"item.minecraft.angler_pottery_sherd": "Fragments de gerro de pescador",
	"item.minecraft.apple": "Poma",
	"item.minecraft.archer_pottery_shard": "Fragments de gerro d'arquer",
	"item.minecraft.archer_pottery_sherd": "Fragments de gerro d'arquer",
	"item.minecraft.armadillo_scute": "Placa d'armadillo",
	"item.minecraft.armadillo_spawn_egg": "Generar armadillo",
	"item.minecraft.armor_stand": "Suport per a armadures",
	"item.minecraft.arms_up_pottery_shard": "Fragments de gerro de braços amunt",
	"item.minecraft.arms_up_pottery_sherd": "Fragments de gerro de braços amunt",
	...
	"item.minecraft.black_bundle": "Saquet negre",
	"item.minecraft.black_dye": "Tint negre",
	"item.minecraft.black_harness": "Arnés negre",
	"item.minecraft.blade_pottery_shard": "Fragments de gerro de fil",
	"item.minecraft.blade_pottery_sherd": "Fragments de gerro de fil",
	...
	"item.minecraft.blue_bundle": "Saquet blau",
	"item.minecraft.blue_dye": "Tint blau",
	"item.minecraft.blue_egg": "Ou blau",
	"item.minecraft.blue_harness": "Arnés blau",
	"item.minecraft.bogged_spawn_egg": "Generar esquelet empantanat",
	"item.minecraft.bolt_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Disseny d'armadura de caragol",
	"item.minecraft.bone": "Os",
	"item.minecraft.bone_meal": "Farina d'ossos",
	"item.minecraft.book": "Llibre",
	"item.minecraft.bordure_indented_banner_pattern": "Estandard amb bordura dentada",
	...
	"item.minecraft.brewer_pottery_shard": "Fragments de gerro d'alquimista",
	"item.minecraft.brewer_pottery_sherd": "Fragments de gerro d'alquimista",
	"item.minecraft.brewing_stand": "Altar de pocions",
	"item.minecraft.brick": "Rajola",
	"item.minecraft.brown_bundle": "Saquet marró",
	"item.minecraft.brown_dye": "Tint marró",
	"item.minecraft.brown_egg": "Ou marró",
	"item.minecraft.brown_harness": "Arnés marró",
	"item.minecraft.brush": "Raspall",
	"item.minecraft.bucket": "Poal",
	"item.minecraft.bundle": "Saquet",
	"item.minecraft.bundle.empty": "Buit",
	"item.minecraft.bundle.empty.description": "Pot contenir una pila mixta d'objectes",
	"item.minecraft.bundle.full": "Ple",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.burn_pottery_shard": "Fragments de gerro de foc",
	"item.minecraft.burn_pottery_sherd": "Fragments de gerro de foc",
	"item.minecraft.camel_husk_spawn_egg": "Generar dromedari momificat",
	...
	"item.minecraft.chainmail_leggings": "Malles de cota de malla",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Disseny d'armadura de costa",
	...
	"item.minecraft.copper_axe": "Destral de coure",
	"item.minecraft.copper_boots": "Botes de coure",
	"item.minecraft.copper_chestplate": "Cuirassa de coure",
	"item.minecraft.copper_golem_spawn_egg": "Generar gólem de coure",
	"item.minecraft.copper_helmet": "Casc de coure",
	"item.minecraft.copper_hoe": "Aixada de coure",
	"item.minecraft.copper_horse_armor": "Armadura de coure per a cavalls",
	"item.minecraft.copper_ingot": "Lingot de coure",
	"item.minecraft.copper_leggings": "Malles de coure",
	"item.minecraft.copper_nautilus_armor": "Armadura de coure per a nautilus",
	"item.minecraft.copper_nugget": "Palleta de coure",
	"item.minecraft.copper_pickaxe": "Pic de coure",
	"item.minecraft.copper_shovel": "Pala de coure",
	"item.minecraft.copper_spear": "Llança de coure",
	"item.minecraft.copper_sword": "Espasa de coure",
	"item.minecraft.cow_spawn_egg": "Generar vaca",
	"item.minecraft.creaking_spawn_egg": "Generar crepitant",
	"item.minecraft.creeper_banner_pattern": "Estandard de creeper",
	"item.minecraft.creeper_banner_pattern.desc": "Estampat de creeper",
	"item.minecraft.creeper_banner_pattern.new": "Estandard de creeper carregat",
	...
	"item.minecraft.crossbow.projectile.multiple": "Projectil: %s x %s",
	"item.minecraft.crossbow.projectile.single": "Projectil: %s",
	"item.minecraft.cyan_bundle": "Saquet cian",
	"item.minecraft.cyan_dye": "Tint cian",
	"item.minecraft.cyan_harness": "Arnés cian",
	"item.minecraft.danger_pottery_shard": "Fragments de gerro de perill",
	"item.minecraft.danger_pottery_sherd": "Fragments de gerro de perill",
	"item.minecraft.dark_oak_boat": "Barca de roure fosc",
	"item.minecraft.dark_oak_chest_boat": "Barca de roure fosc amb cofre",
	...
	"item.minecraft.diamond_nautilus_armor": "Armadura de diamant per a nautilus",
	"item.minecraft.diamond_pickaxe": "Pic de diamant",
	"item.minecraft.diamond_shovel": "Pala de diamant",
	"item.minecraft.diamond_spear": "Llança de diamant",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Disseny d'armadura de duna",
	...
	"item.minecraft.explorer_pottery_shard": "Fragments de gerro d'explorador",
	"item.minecraft.explorer_pottery_sherd": "Fragments de gerro d'explorador",
	"item.minecraft.eye_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Disseny d'armadura d'ull",
	"item.minecraft.feather": "Ploma",
	"item.minecraft.fermented_spider_eye": "Ull d'aranya fermentat",
	"item.minecraft.field_masoned_banner_pattern": "Estandard maçonat",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Disseny d'armadura de flux",
	"item.minecraft.flow_banner_pattern": "Estandard de flux",
	"item.minecraft.flow_banner_pattern.desc": "Flux",
	"item.minecraft.flow_banner_pattern.new": "Estandard de flux",
	"item.minecraft.flow_pottery_sherd": "Fragments de gerro de flux",
	"item.minecraft.flower_banner_pattern": "Estandard floral",
	"item.minecraft.flower_banner_pattern.desc": "Estampat de flors",
	"item.minecraft.flower_banner_pattern.new": "Estandard de flor",
	"item.minecraft.flower_pot": "Test",
	"item.minecraft.fox_spawn_egg": "Generar rabosa",
	"item.minecraft.friend_pottery_shard": "Fragments de gerro d'amic",
	"item.minecraft.friend_pottery_sherd": "Fragments de gerro d'amic",
	...
	"item.minecraft.globe_banner_pattern.new": "Estandard de planeta",
	...
	"item.minecraft.golden_nautilus_armor": "Armadura d'or per a nautilus",
	"item.minecraft.golden_pickaxe": "Pic d'or",
	"item.minecraft.golden_shovel": "Pala d'or",
	"item.minecraft.golden_spear": "Llança d'or",
	"item.minecraft.golden_sword": "Espasa d'or",
	"item.minecraft.gray_bundle": "Saquet gris",
	"item.minecraft.gray_dye": "Tint gris",
	"item.minecraft.gray_harness": "Arnés gris",
	"item.minecraft.green_bundle": "Saquet verd",
	"item.minecraft.green_dye": "Tint verd",
	"item.minecraft.green_harness": "Arnés verd",
	"item.minecraft.guardian_spawn_egg": "Generar guardià de les profunditats",
	"item.minecraft.gunpowder": "Pólvora",
	"item.minecraft.guster_banner_pattern": "Estandard de ràfega",
	"item.minecraft.guster_banner_pattern.desc": "Ràfega",
	"item.minecraft.guster_banner_pattern.new": "Estandard de ràfega",
	"item.minecraft.guster_pottery_sherd": "Fragments de gerro de ràfega",
	"item.minecraft.happy_ghast_spawn_egg": "Generar ghast feliç",
	"item.minecraft.harness": "Arnés",
	"item.minecraft.heart_of_the_sea": "El cor de la mar",
	"item.minecraft.heart_pottery_shard": "Fragments de gerro de cor",
	"item.minecraft.heart_pottery_sherd": "Fragments de gerro de cor",
	"item.minecraft.heartbreak_pottery_shard": "Fragments de gerro de cor trencat",
	"item.minecraft.heartbreak_pottery_sherd": "Fragments de gerro de cor trencat",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.host_armor_trim_smithing_template.new": "Disseny d'armadura d'hostatge",
	"item.minecraft.howl_pottery_shard": "Fragments de gerro d'udol",
	"item.minecraft.howl_pottery_sherd": "Fragments de gerro d'udol",
	...
	"item.minecraft.iron_golem_spawn_egg": "Generar gólem de ferro",
	...
	"item.minecraft.iron_nautilus_armor": "Armadura de ferro per a nautilus",
	...
	"item.minecraft.iron_spear": "Llança de ferro",
	...
	"item.minecraft.light_blue_bundle": "Saquet blau clar",
	"item.minecraft.light_blue_dye": "Tint blau clar",
	"item.minecraft.light_blue_harness": "Arnés blau clar",
	"item.minecraft.light_gray_bundle": "Saquet gris clar",
	"item.minecraft.light_gray_dye": "Tint gris clar",
	"item.minecraft.light_gray_harness": "Arnés gris clar",
	"item.minecraft.lime_bundle": "Saquet verd llima",
	"item.minecraft.lime_dye": "Tint verd llima",
	"item.minecraft.lime_harness": "Arnés verd llima",
	...
	"item.minecraft.lingering_potion.effect.infested": "Poció persistent d'infestació",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Poció persistent de supuració",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Poció persistent de teixidura",
	"item.minecraft.lingering_potion.effect.wind_charged": "Poció persistent de ventositat",
	"item.minecraft.llama_spawn_egg": "Generar llama",
	"item.minecraft.lodestone_compass": "Brúixola imantada",
	"item.minecraft.mace": "Maça",
	"item.minecraft.magenta_bundle": "Saquet magenta",
	...
	"item.minecraft.miner_pottery_shard": "Fragments de gerro de miner",
	"item.minecraft.miner_pottery_sherd": "Fragments de gerro de miner",
	"item.minecraft.mojang_banner_pattern": "Estandard de Mojang",
	"item.minecraft.mojang_banner_pattern.desc": "Cosa",
	"item.minecraft.mojang_banner_pattern.new": "Estandard de Mojang",
	"item.minecraft.mooshroom_spawn_egg": "Generar mooshroom",
	"item.minecraft.mourner_pottery_shard": "Fragments de gerro de dolent",
	"item.minecraft.mourner_pottery_sherd": "Fragments de gerro de dolent",
	...
	"item.minecraft.music_disc_bounce": "Disc de música",
	...
	"item.minecraft.music_disc_creator": "Disc de música",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Disc de música",
	...
	"item.minecraft.music_disc_lava_chicken": "Disc de música",
	...
	"item.minecraft.music_disc_precipice": "Disc de música",
	"item.minecraft.music_disc_precipice.desc": "Aaron Cherof - Precipice",
	"item.minecraft.music_disc_relic": "Disc de música",
	...
	"item.minecraft.music_disc_tears": "Disc de música",
	...
	"item.minecraft.nautilus_spawn_egg": "Generar nautilus",
	...
	"item.minecraft.netherite_horse_armor": "Armadura de netherita per a cavalls",
	"item.minecraft.netherite_ingot": "Lingot de netherita",
	"item.minecraft.netherite_leggings": "Malles de netherita",
	"item.minecraft.netherite_nautilus_armor": "Armadura de netherita per a nautilus",
	...
	"item.minecraft.netherite_spear": "Llança de netherita",
	"item.minecraft.netherite_sword": "Espasa de netherita",
	"item.minecraft.netherite_upgrade_smithing_template": "Motle de ferreria",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Millora de netherita",
	"item.minecraft.oak_boat": "Barca de roure",
	"item.minecraft.oak_chest_boat": "Barca de roure amb cofre",
	"item.minecraft.ocelot_spawn_egg": "Generar ocelot",
	"item.minecraft.ominous_bottle": "Botella ominosa",
	"item.minecraft.ominous_trial_key": "Clau de reptes ominosa",
	"item.minecraft.orange_bundle": "Saquet taronja",
	"item.minecraft.orange_dye": "Tint taronja",
	"item.minecraft.orange_harness": "Arnés taronja",
	"item.minecraft.painting": "Quadre",
	"item.minecraft.pale_oak_boat": "Barca de roure tètric",
	"item.minecraft.pale_oak_chest_boat": "Barca de roure tètric amb cofre",
	"item.minecraft.panda_spawn_egg": "Generar panda",
	"item.minecraft.paper": "Paper",
	"item.minecraft.parched_spawn_egg": "Generar esquelet de les arenes",
	...
	"item.minecraft.piglin_banner_pattern.new": "Estandard de morro",
	...
	"item.minecraft.pink_bundle": "Saquet rosa",
	"item.minecraft.pink_dye": "Tint rosa",
	"item.minecraft.pink_harness": "Arnés rosa",
	"item.minecraft.pitcher_plant": "Planta de gerra",
	"item.minecraft.pitcher_pod": "Baina de planta de gerra",
	"item.minecraft.plenty_pottery_shard": "Fragments de gerro de plenitud",
	"item.minecraft.plenty_pottery_sherd": "Fragments de gerro de plenitud",
	...
	"item.minecraft.potion.effect.infested": "Poció d'infestació",
	...
	"item.minecraft.potion.effect.oozing": "Poció de supuració",
	...
	"item.minecraft.potion.effect.weaving": "Poció de teixidura",
	"item.minecraft.potion.effect.wind_charged": "Poció de ventositat",
	"item.minecraft.pottery_shard_archer": "Fragment de ceràmica d'arquer",
	"item.minecraft.pottery_shard_arms_up": "Fragment de ceràmica de braços en alt",
	"item.minecraft.pottery_shard_prize": "Fragments de ceràmica de premi",
	"item.minecraft.pottery_shard_skull": "Fragment de ceràmica de calavera",
	...
	"item.minecraft.prize_pottery_shard": "Fragments de gerro de premi",
	"item.minecraft.prize_pottery_sherd": "Fragments de gerro de premi",
	...
	"item.minecraft.purple_bundle": "Saquet morat",
	"item.minecraft.purple_dye": "Tint morat",
	"item.minecraft.purple_harness": "Arnés morat",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Disseny d'armadura d'elevació",
	...
	"item.minecraft.red_bundle": "Saquet roig",
	"item.minecraft.red_dye": "Tint roig",
	"item.minecraft.red_harness": "Arnés roig",
	"item.minecraft.redstone": "Pols de redstone",
	"item.minecraft.resin_brick": "Rajola de resina",
	"item.minecraft.resin_clump": "Resina",
	"item.minecraft.rib_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Disseny d'armadura d'os",
	...
	"item.minecraft.scrape_pottery_sherd": "Fragments de gerro d'arrap",
	"item.minecraft.scute": "Placa",
	"item.minecraft.sentry_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Disseny d'armadura de sentinella",
	"item.minecraft.shaper_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Disseny d'armadura de forma",
	"item.minecraft.sheaf_pottery_shard": "Fragments de gerro de feix",
	"item.minecraft.sheaf_pottery_sherd": "Fragments de gerro de feix",
	"item.minecraft.shears": "Tisores d'esquilar",
	"item.minecraft.sheep_spawn_egg": "Generar ovella",
	"item.minecraft.shelter_pottery_shard": "Fragments de gerro de refugi",
	"item.minecraft.shelter_pottery_sherd": "Fragments de gerro de refugi",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Disseny d'aramdura del silenci",
	...
	"item.minecraft.skull_banner_pattern.new": "Estandard de calavera",
	"item.minecraft.skull_pottery_shard": "Fragments de gerro de calavera",
	"item.minecraft.skull_pottery_sherd": "Fragments de gerro de calavera",
	"item.minecraft.slime_ball": "Bola de Llim",
	"item.minecraft.slime_spawn_egg": "Generar cub de llim",
	"item.minecraft.smithing_template": "Motle de ferreria",
	"item.minecraft.smithing_template.applies_to": "S'aplica a:",
	"item.minecraft.smithing_template.armor_trim.additions_slot_description": "Afig un lingot o cristall",
	"item.minecraft.smithing_template.armor_trim.applies_to": "Armadura",
	"item.minecraft.smithing_template.armor_trim.base_slot_description": "Afig una peça d'armadura",
	...
	"item.minecraft.smithing_template.netherite_upgrade.additions_slot_description": "Afig un lingot de netherita",
	"item.minecraft.smithing_template.netherite_upgrade.applies_to": "Equipament de diamant",
	"item.minecraft.smithing_template.netherite_upgrade.base_slot_description": "Afig una armadura, arma o ferramenta de diamant",
	"item.minecraft.smithing_template.netherite_upgrade.ingredients": "Lingot de netherita",
	"item.minecraft.smithing_template.upgrade": "Millora: ",
	"item.minecraft.sniffer_spawn_egg": "Generar rastrejador",
	"item.minecraft.snort_pottery_shard": "Fragments de gerro de bufit",
	"item.minecraft.snort_pottery_sherd": "Fragments de gerro de bufit",
	"item.minecraft.snout_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Disseny d'armadura de morro",
	"item.minecraft.snow_golem_spawn_egg": "Generar gólem de neu",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Disseny d'armadura de cúpula",
	...
	"item.minecraft.splash_potion.effect.infested": "Poció explosiva d'infestació",
	...
	"item.minecraft.splash_potion.effect.oozing": "Poció explosiva de supuració",
	...
	"item.minecraft.splash_potion.effect.weaving": "Poció explosiva de teixidura",
	"item.minecraft.splash_potion.effect.wind_charged": "Poció explosiva de ventositat",
	"item.minecraft.spruce_boat": "Barca de pícea",
	"item.minecraft.spruce_chest_boat": "Barca de pícea amb cofre",
	...
	"item.minecraft.stone_spear": "Llança de pedra",
	...
	"item.minecraft.sulfur_cube_bucket": "Poal amb cub de sofre",
	"item.minecraft.sulfur_cube_spawn_egg": "Generar cub de sofre",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Disseny d'armadura de marea",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Fletxa d'infestació",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Fletxa de supuració",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Fletxa de teixidura",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Fletxa de ventositat",
	"item.minecraft.tnt_minecart": "Vagoneta amb explosius",
	"item.minecraft.torchflower_seeds": "Llavors de flamaflor",
	"item.minecraft.totem_of_undying": "Tòtem de la immortalitat",
	"item.minecraft.trader_llama_spawn_egg": "Generar llama de càrrega",
	"item.minecraft.trial_key": "Clau de reptes",
	...
	"item.minecraft.turtle_scute": "Placa de tortuga",
	"item.minecraft.turtle_spawn_egg": "Generar tortuga marina",
	"item.minecraft.vex_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Disseny d'armadura d'esperit",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Disseny d'armadura de guardià",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Disseny d'armadura d'explorador",
	"item.minecraft.wheat": "Blat",
	"item.minecraft.wheat_seeds": "Llavors de blat",
	"item.minecraft.white_bundle": "Saquet blanc",
	"item.minecraft.white_dye": "Tint blanc",
	"item.minecraft.white_harness": "Arnés blanc",
	"item.minecraft.wild_armor_trim_smithing_template": "Motle de ferreria",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Disseny d'armadura salvatge",
	"item.minecraft.wind_charge": "Càrrega de vent",
	...
	"item.minecraft.wolf_armor": "Armadura de llop",
	...
	"item.minecraft.wooden_spear": "Llança de fusta",
	...
	"item.minecraft.yellow_bundle": "Saquet groc",
	"item.minecraft.yellow_dye": "Tint groc",
	"item.minecraft.yellow_harness": "Arnés groc",
	"item.minecraft.zoglin_spawn_egg": "Generar zoglin",
	"item.minecraft.zombie_horse_spawn_egg": "Generar cavall zombi",
	"item.minecraft.zombie_nautilus_spawn_egg": "Generar nautilus zombi",
	...
	"item.modifiers.any": "Quan s'equipa:",
	"item.modifiers.armor": "Quan es porta:",
	"item.modifiers.body": "Quan s'equipa:",
	"item.modifiers.chest": "Al pit:",
	"item.modifiers.feet": "Als peus:",
	"item.modifiers.hand": "Quan se sosté:",
	...
	"item.modifiers.saddle": "Amb sella de muntar:",
	"item.nbt_tags": "NBT: %s etiqueta/es",
	"item.op_block_warning.line1": "Advertència:",
	"item.op_block_warning.line2": "Si es col·loca este objecte es podria executar un comandament.",
	"item.op_block_warning.line3": "No l'utilitzes si no saps el seu contingut!",
	"item.spawn_egg.peaceful": "Desactivat en \"Pacífica\"",
	...
	"itemGroup.op": "Funcions d'administrador",
	...
	"jigsaw_block.placement_priority": "Prioritat de col·locació:",
	"jigsaw_block.placement_priority.tooltip": "Quan este bloc de trencaclosques es connecta a una peça, eixe serà l'ordre amb què eixa peça serà processada per a connexions en l'estructura gran.\n\nLes peces es processaran en prioritat descendent amb trencament d'enllaços per ordre d'inserció.",
	"jigsaw_block.pool": "Grup objectiu:",
	"jigsaw_block.selection_priority": "Prioritat de selecció:",
	"jigsaw_block.selection_priority.tooltip": "Quan la peça mare està sent processada per a connexions, eixe serà l'ordre amb què eixe bloc de trencaclosques s'intentarà connectar amb la peça objectiu.\n\nEls trencacloques es processaran en prioritat descendent amb trencament d'enllaços aleatoris.",
	...
	"key.category.minecraft.creative": "Mode creatiu",
	"key.category.minecraft.debug": "Depuració",
	"key.category.minecraft.gameplay": "Jugabilitat",
	"key.category.minecraft.inventory": "Inventari",
	"key.category.minecraft.misc": "Altres",
	"key.category.minecraft.movement": "Moviment",
	...
	"key.debug.clearChat": "Esborra el xat",
	"key.debug.copyLocation": "Copia la ubicació",
	"key.debug.copyRecreateCommand": "Copia les dades",
	"key.debug.crash": "Depuració del tancament brusc del joc",
	"key.debug.debugOptions": "Opcions de depuració",
	"key.debug.dumpDynamicTextures": "Bolca les textures dinàmiques",
	"key.debug.dumpVersion": "Bolca la informació de la versió",
	"key.debug.focusPause": "Activa/desactiva la pausa del joc en canviar de finestra",
	"key.debug.fpsCharts": "Gràfics d'FPS",
	"key.debug.lightmapTexture": "Textura del mapa d'il·luminació",
	"key.debug.modifier": "Tecla de modificació de depuració",
	"key.debug.networkCharts": "Gràfics de la xarxa",
	"key.debug.overlay": "Activa/desactiva la superposició",
	"key.debug.profiling": "Comença/para l'anàlisi",
	"key.debug.profilingChart": "Gràfic de l'anàlisi",
	"key.debug.reloadChunk": "Recarrega els chunks",
	"key.debug.reloadResourcePacks": "Recarrega els paquets de recursos",
	"key.debug.showAdvancedTooltips": "Mostra les opcions avançades",
	"key.debug.showChunkBorders": "Mostra les vores dels chunks",
	"key.debug.showHitboxes": "Mostra les hitboxes",
	"key.debug.spectate": "Cicle d'espectador",
	"key.debug.switchGameMode": "Selecció del mode de joc",
	"key.drop": "Tira l'objecte seleccionat",
	"key.forward": "Caminar avant",
	"key.friends": "Pantalla d’amics",
	...
	"key.spectatorHotbar": "Selecciona-ho a la barra de ferramentes",
	"key.spectatorOutlines": "Destaca els jugadors",
	"key.sprint": "Córrer",
	"key.swapOffhand": "Intercanvia l'objecte amb la mà secundària",
	"key.toggleGui": "Activa/desactiva la interfície d'usuari",
	"key.togglePerspective": "Alterna perspectiva",
	"key.toggleSpectatorShaderEffects": "Activa/desactiva els efectes d'ombres per al mode espectador",
	"key.use": "Utilitzar objecte/posar bloc",
	"known_server_link.announcements": "Anuncis",
	"known_server_link.community": "Comunitat",
	"known_server_link.community_guidelines": "Directrius de la comunitat",
	"known_server_link.feedback": "Comentaris",
	"known_server_link.forums": "Fòrums",
	"known_server_link.news": "Notícies",
	"known_server_link.report_bug": "Informar d'un error del servidor",
	"known_server_link.status": "Estat",
	"known_server_link.support": "Suport",
	"known_server_link.website": "Pàgina web",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Afig servidor",
	"manageServer.edit.title": "Edita la informació del servidor",
	"manageServer.enterIp": "Adreça del servidor",
	"manageServer.enterName": "Nom del servidor",
	"manageServer.resourcePack": "Paquets de recursos del servidor",
	"manageServer.resourcePack.disabled": "Deshabilitat",
	"manageServer.resourcePack.enabled": "Habilitat",
	"manageServer.resourcePack.prompt": "Pregunta",
	"mco.account.privacy.info": "Llig més sobre Mojang i les lleis de privacitat",
	"mco.account.privacy.info.button": "Llig més sobre el GDPR",
	"mco.account.privacy.information": "Mojang implementa procediments segurs per a ajudar a protegir els xiquets i xiquetes i la seua privacitat incloent el compliment amb la Llei de Protecció de la Privacitat de Xiquets i Xiquetes en línia (COPPA) i la Reglament General de Protecció de Dades (GDPR).\n\nNecessitaràs el permís dels teus pares per accedir al teu compte de Realms.",
	...
	"mco.activity.noactivity": "No hi ha hagut cap activitat des de fa %s dia/dies",
	...
	"mco.backup.entry": "Còpia de seguretat (%s)",
	"mco.backup.entry.description": "Descripció",
	"mco.backup.entry.enabledPack": "Pack/s activat/s",
	"mco.backup.entry.gameDifficulty": "Dificultat del joc",
	"mco.backup.entry.gameMode": "Mode de joc",
	"mco.backup.entry.gameServerVersion": "Versió del servidor del joc",
	"mco.backup.entry.name": "Nom",
	"mco.backup.entry.seed": "Llavor",
	"mco.backup.entry.templateName": "Nom de la plantilla",
	"mco.backup.entry.undefined": "Canvi no definit",
	"mco.backup.entry.uploaded": "Pujat",
	"mco.backup.entry.worldType": "Tipus de món",
	"mco.backup.entry.worldType.adventureMap": "Mapa d'aventures",
	"mco.backup.entry.worldType.experience": "Experiència",
	"mco.backup.entry.worldType.inspiration": "Inspiració",
	"mco.backup.entry.worldType.minigame": "Minijoc",
	"mco.backup.entry.worldType.normal": "Normal",
	"mco.backup.entry.worldType.unknown": "Desconegut",
	"mco.backup.generate.world": "Genera el món",
	"mco.backup.info.title": "Canvis des de l'última còpia de seguretat",
	"mco.backup.narration": "Còpia de seguretat de %s",
	"mco.backup.nobackups": "Este realm encara no té cap còpia de seguretat.",
	"mco.backup.restoring": "Restaurant el teu realm",
	"mco.backup.unknown": "DESCONEGUDA",
	...
	"mco.client.outdated.stable.version": "La teua versió de client (%s) no és compatible amb els Realms.\n\nPer favor, utilitza la versió més recent del Minecraft.",
	"mco.client.unsupported.snapshot.version": "La teua versió de client (%s) no és compatible amb els Realms.\n\nEls Realms no estan disponibles per a esta versió de prova.",
	"mco.compatibility.downgrade": "Degrada",
	"mco.compatibility.downgrade.description": "Es va jugar a este món per última vegada en la versió %s; tu estàs en la versió %s. Carregar un món en una versió antiga pot corrompre'l - no podem garantir que carregue o funcione.\n\nEs guardarà una còpia de seguretat del teu món en \"World backups\". Per favor, restaura'l si és necessari.",
	"mco.compatibility.incompatible.popup.title": "Versió incompatible",
	"mco.compatibility.incompatible.releaseType.popup.message": "El món al qual vols unir-te és incompatible amb la versió actual.",
	"mco.compatibility.incompatible.series.popup.message": "Este món va ser jugat per última vegada en la versió %s; estàs en la versió %s.\n\nEstes séries no són compatibles entre elles. Es necessita jugar a un nou món en esta versió.",
	"mco.compatibility.unverifiable.message": "No s'ha pogut verificar l'última versió amb la qual es va jugar a este món. Si el món s'actualitza o s'obri en una versió antiga, es crearà i guardarà una còpia de seguretat automàticament en \"World backups\".",
	"mco.compatibility.unverifiable.title": "Compatibilitat no verificable",
	"mco.compatibility.upgrade": "Actualitza",
	"mco.compatibility.upgrade.description": "Es va jugar a este món per última vegada en la versió %s; tu estàs en la versió %s.\n\nEs guardarà una còpia de seguretat del teu món en \"World backups\". Per favor, restaura'l si és necessari.",
	"mco.compatibility.upgrade.friend.description": "Es va jugar a este món per última vegada en la versió %s; tu estàs en la versió %s.\n\nEs guardarà una còpia de seguretat del món en \"World Backups\".\n\nEl propietari del Realm pot restaurar el món si és necessari.",
	"mco.compatibility.upgrade.title": "Segur que vols actualitzar este món?",
	...
	"mco.configure.world.buttons.close": "Tanca el Realm temporalment",
	...
	"mco.configure.world.buttons.newworld": "Nou món",
	"mco.configure.world.buttons.open": "Reobri el Realm",
	"mco.configure.world.buttons.options": "Opcions del món",
	"mco.configure.world.buttons.players": "Jugadors",
	"mco.configure.world.buttons.region_preference": "Selecciona una regió...",
	"mco.configure.world.buttons.resetworld": "Reinicia el món",
	"mco.configure.world.buttons.save": "Guarda",
	"mco.configure.world.buttons.settings": "Configuració",
	"mco.configure.world.buttons.subscription": "Subscripció",
	"mco.configure.world.buttons.switchminigame": "Canvia el mini joc",
	"mco.configure.world.close.question.line1": "Pots tancar temporalment el teu Realm, impedint jugar mentre fas ajustos. Reobri'l quan ho tingues a punt. \n\nAixò no cancel·larà la teua subscripció als Realms.",
	"mco.configure.world.close.question.line2": "Segur que vols continuar?",
	"mco.configure.world.close.question.title": "Necessites fer canvis sense interrupcions?",
	...
	"mco.configure.world.invited.number": "Convidat (%s)",
	...
	"mco.configure.world.loading": "Carregant el Realm",
	"mco.configure.world.location": "Ubicació",
	"mco.configure.world.minigame": "Actual: %s",
	"mco.configure.world.name": "Nom del Realm",
	"mco.configure.world.name.validation.whitespace": "No pot començar amb un espai en blanc. Este es retallarà.",
	"mco.configure.world.opening": "Obrint el realm...",
	"mco.configure.world.players.error": "No existeix cap jugador amb eixe nom",
	"mco.configure.world.players.invite.duplicate": "Ja s'ha convidat un jugador amb eixe nom al Realm",
	"mco.configure.world.players.inviting": "Convidant al jugador...",
	"mco.configure.world.players.title": "Jugadors",
	"mco.configure.world.pvp": "PVP (podràs atacar i ser atacat!)",
	"mco.configure.world.region_preference": "Preferència de regió",
	"mco.configure.world.region_preference.title": "Selecció de preferència de regió",
	...
	"mco.configure.world.resourcepack.question": "Necessites un paquet de recursos personalitzat per jugar en este el realm.\n\nVols descarregar-lo i jugar-hi?",
	...
	"mco.configure.world.settings.expired": "No pots editar la configuració d'un Realm que ha expirat",
	...
	"mco.configure.world.spawn_toggle.message": "Si desactives esta opció, s'eliminaran totes les entitats d'eixe tipus",
	"mco.configure.world.spawn_toggle.message.npc": "Si desactives esta opció, s'eliminaran totes les entitats d'eixe tipus, com per exemple els vilatans",
	...
	"mco.configure.world.subscription.recurring.info": "Els canvis fets en la teua subscripció als Realms, com ara afegir més temps o desactivar el pagament, no tindran efecte fins la pròxima data de facturació.",
	"mco.configure.world.subscription.remaining.days": "%[1]s dia/es",
	"mco.configure.world.subscription.remaining.months": "%[1]s mes/os",
	"mco.configure.world.subscription.remaining.months.days": "%[1]s mes/os, %[2]s dia/es",
	"mco.configure.world.subscription.start": "Data d'inici",
	"mco.configure.world.subscription.tab": "Subscripció",
	"mco.configure.world.subscription.timeleft": "Temps restant",
	"mco.configure.world.subscription.title": "La teua subscripció",
	"mco.configure.world.subscription.unknown": "Desconegut",
	"mco.configure.world.switch.slot": "Crea un món",
	"mco.configure.world.switch.slot.subtitle": "Este món està buit. Tria com vols crear-lo",
	"mco.configure.world.title": "Configura el Realm:",
	"mco.configure.world.uninvite.player": "Segur que vols desconvidar a \"%s\"?",
	...
	"mco.connect.region": "Regió del servidor: %s",
	"mco.connect.success": "Fet",
	"mco.create.world": "Crea",
	"mco.create.world.error": "Has de posar-li un nom!",
	"mco.create.world.failed": "No s'ha pogut crear el món!",
	...
	"mco.download.confirmation.oversized": "El món que intentes descarregar és més gran que %s.\n\nNo podràs pujar-lo de nou al teu realm",
	...
	"mco.download.resourcePack.fail": "Error en descarregar el paquet de recursos!",
	...
	"mco.error.invalid.session.title": "Sessió no vàlida",
	...
	"mco.errorMessage.6005": "Món bloquejat",
	"mco.errorMessage.6006": "El món està antiquat",
	"mco.errorMessage.6007": "L'usuari està en massa Realms",
	"mco.errorMessage.6008": "Nom del Realm no vàlid",
	"mco.errorMessage.6009": "Descripció del Realm no vàlida",
	"mco.errorMessage.connectionFailure": "Ha ocorregut un error. Intenta-ho més tard.",
	"mco.errorMessage.generic": "Ha ocorregut un error: ",
	"mco.errorMessage.initialize.failed": "No s'ha pogut iniciar el Realm",
	"mco.errorMessage.noDetails": "No s'han proveït detalls de l'error",
	"mco.errorMessage.realmsService": "Ha ocorregut un error (%s):",
	"mco.errorMessage.realmsService.configurationError": "S'ha produït un error inesperat mentre s'editaven les opcions del món",
	"mco.errorMessage.realmsService.connectivity": "No s'ha pogut connectar als Realms: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "No s'ha pogut comprovar la versió compatible. Resposta: %s",
	"mco.errorMessage.retry": "Torna-ho a provar",
	"mco.errorMessage.serviceBusy": "Realms està ocupat en este moment.\nProva a connectar-te al teu Realm de nou en uns minuts.",
	"mco.gui.button": "Botó",
	"mco.gui.ok": "D'acord",
	"mco.info": "Info!",
	"mco.invited.player.narration": "Jugador convidat %s",
	...
	"mco.minigame.world.restore": "Finalitzant el mini joc...",
	...
	"mco.minigame.world.starting.screen.title": "Començant el mini joc...",
	"mco.minigame.world.stopButton": "Acaba el mini joc",
	"mco.minigame.world.switch.new": "Vols triar un altre mini joc?",
	"mco.minigame.world.switch.title": "Canvia el mini joc",
	"mco.minigame.world.title": "Canvia el realm a mini joc",
	"mco.news": "Notícies dels Realms",
	"mco.notification.dismiss": "Descarta",
	"mco.notification.transferSubscription.buttonText": "Transferix ara",
	"mco.notification.transferSubscription.message": "Les subscripcions dels Realms de Java ara estaran a la botiga de Microsoft. No deixes que la teua subscripció caduque!\nTransferix-la ara i obtín 30 dies de Realms gratuïts.\nVes al teu perfil en minecraft.net per a transferir la teua subscripció.",
	"mco.notification.visitUrl.buttonText.default": "Obri l'enllaç",
	"mco.notification.visitUrl.message.default": "Per favor, visita l'enllaç de baix",
	"mco.onlinePlayers": "Jugadors en línia",
	"mco.play.button.realm.closed": "El Realm està tancat",
	...
	"mco.selectServer.closed": "Realm desactivat",
	...
	"mco.selectServer.create.subtitle": "Selecciona un món per posar al nou realm",
	...
	"mco.selectServer.loading": "Carregant llista dels Realms",
	...
	"mco.selectServer.noRealms": "Pareix que no tens cap Realm. Afig-ne un per jugar amb els teus amics.",
	...
	"mco.snapshot.createSnapshotPopup.text": "Estàs a punt de crear un Realm de versió en proves gratuït que s'unirà a la teua subscripció pagada de Realms. Este nou Realm de versió en proves serà accessible mentre la subscripció pagada estiga vigent. El teu Realm pagat no es vorà afectat.",
	"mco.snapshot.createSnapshotPopup.title": "Vols crear un Realm de versió en proves?",
	"mco.snapshot.creating": "Creant un Realm de versió en proves...",
	"mco.snapshot.description": "Emparellat amb %s",
	"mco.snapshot.friendsRealm.downgrade": "Has d'estar en la versió %s per a unir-te a este Realm",
	"mco.snapshot.friendsRealm.upgrade": "%s ha d'actualitzar el seu Realm abans que pugues jugar des d'esta versió en proves",
	"mco.snapshot.paired": "Este Realm de versió en proves està emparellat amb %s",
	"mco.snapshot.parent.tooltip": "Utilitza l'última versió de Minecraft per a jugar a este Realm",
	"mco.snapshot.start": "Comença un Realm de versió en proves",
	"mco.snapshot.subscription.info": "Este és un Realm de versió en proves que està unit a la subscripció del teu Realm \"%s\". Romandrà actiu mentre ho estiga el Realm al qual està emparellat.",
	"mco.snapshot.tooltip": "Utilitza els Realms de versions en proves per a fer una ullada a les pròximes versions de Minecraft, que poden incloure nous continguts i canvis.\n\nPots trobar els teus Realms normals en les versions estrenades del joc.",
	"mco.snapshotRealmsPopup.message": "Els Realms estan ara disponibles a les versions en proves, a partir de la 23w41a. Totes les subscripcions als Realms inclouen una versió de prova de Realm gratuïta a banda del teu Realm de Java normal!",
	"mco.snapshotRealmsPopup.title": "Els Realms estan ara disponibles en les versions en proves",
	"mco.snapshotRealmsPopup.urlText": "Apren-ne més",
	...
	"mco.time.daysAgo": "Fa %[1]s dia/es",
	"mco.time.hoursAgo": "Fa %[1]s hora/es",
	"mco.time.minutesAgo": "Fa %[1]s minut/s",
	"mco.time.now": "ara mateix",
	"mco.time.secondsAgo": "Fa %[1]s segon/s",
	...
	"mco.upload.failed.too_big.description": "El món seleccionat és massa gran. La grandària màxima permesa és %s.",
	"mco.upload.failed.too_big.title": "El món és massa gran",
	...
	"mco.version": "Versió: %s",
	"mco.warning": "Atenció!",
	"mco.worldSlot.minigame": "Minijoc",
	"menu.custom_options": "Opcions personalitzades...",
	"menu.custom_options.title": "Opcions personalitzades",
	"menu.custom_options.tooltip": "Nota: les opcions personalitzades són proporcionades per servidors de tercers i/o altres tipus de contingut.\nUtilitza-les amb coneiximent!",
	"menu.custom_screen_info.button_narration": "Esta és una pantalla personalitzada. Més informació.",
	"menu.custom_screen_info.contents": "Els continguts d'esta pantalla els controlen servidors de tercers i mapes que no pertanyen, controlen o supervisen Mojang Studios ni Microsoft.\n\nVes a espai! Compte a l'hora d'entrar a enllaços i mai proporciones informació personal ni detalls d'inici de sessió.\n\nSi esta pantalla no et deixa jugar, també pots desconnectar-te del servidor actual amb el botó de baix.",
	"menu.custom_screen_info.disconnect": "S'ha rebutjat la pantalla personalitzada",
	"menu.custom_screen_info.title": "Informació sobre les pantalles personalitzades",
	"menu.custom_screen_info.tooltip": "Esta és una pantalla personalitzada. Clica per a més informació.",
	"menu.disconnect": "Desconnecta",
	"menu.feedback": "Comentaris...",
	"menu.feedback.title": "Comentaris",
	"menu.game": "Menú del joc",
	"menu.modded": " (Modificat)",
	"menu.multiplayer": "Multijugador",
	"menu.multiplayerOptions.applyChanges": "Aplicar canvis",
	"menu.multiplayerOptions.button": "Multijugador...",
	"menu.multiplayerOptions.network": "Multijugador",
	"menu.multiplayerOptions.network.header": "Xarxa",
	"menu.multiplayerOptions.network.lan": "LAN",
	"menu.multiplayerOptions.network.lan.tooltip": "Els jugadors de la mateixa xarxa poden unir-se.",
	"menu.multiplayerOptions.network.off": "DESACTIVAT",
	"menu.multiplayerOptions.network.off.tooltip": "Ningú pot unir-se.",
	"menu.multiplayerOptions.network.online": "En línia",
	"menu.multiplayerOptions.network.online.tooltip": "Els amics en línia poden unir-se.",
	"menu.multiplayerOptions.otherPlayers.header": "Altres jugadors",
	"menu.multiplayerOptions.publish.started.lan": "Este món està ara obert a LAN. El número de port és %s",
	"menu.multiplayerOptions.publish.started.online": "Este món està ara obert al multijugador. El número de port és %s",
	"menu.multiplayerOptions.publish.stopped": "Este món ja no està obert al multijugador",
	"menu.multiplayerOptions.title": "Opcions de multijugador",
	"menu.online": "Minecraft Realms",
	"menu.options": "Opcions...",
	"menu.paused": "Joc pausat",
	"menu.playdemo": "Juga al món de demostració",
	"menu.playerReporting": "Denúncia",
	"menu.playerReporting.no_players": "No hi ha jugadors per a reportar en este món",
	"menu.preparingSpawn": "Preparant l'àrea de reaparició: %s%%",
	"menu.quick_actions": "Accions ràpides...",
	"menu.quick_actions.title": "Accions ràpides",
	"menu.quit": "Eixir del joc",
	"menu.reportBugs": "Informa d'errors",
	...
	"menu.server_links": "Enllaços del servidor...",
	"menu.server_links.title": "Enllaços del servidor",
	...
	"multiplayer.codeOfConduct.check": "No ho notifiques més per a este Codi de Conducta",
	"multiplayer.codeOfConduct.title": "Codi de Conducta del servidor",
	"multiplayer.confirm_command.parse_errors": "Estàs intentant executar un comandament no reconegut o invàlid.\nEstàs segur?\nComandament: %s",
	"multiplayer.confirm_command.permissions_required": "Estàs intentant executar un comandament que requerix permisos elevats. \nÉs possible que això afecte el joc negativament. \nEstàs segur? \nComandament: %s",
	"multiplayer.confirm_command.run_command": "Executa el comandament",
	"multiplayer.confirm_command.signature_required": "Estàs a punt d'executar un comandament que enviarà missatges de xat en nom teu.\nNomés podrà ser executat des de la finestra del xat.\nComandament: %s",
	"multiplayer.confirm_command.suggest_command": "Copia a la finestra del xat",
	"multiplayer.confirm_command.title": "Confirma l'execució del comandament",
	...
	"multiplayer.disconnect.bad_chat_index": "S'ha detectat un missatge de xat perdut o reordenat del servidor",
	...
	"multiplayer.disconnect.banned.reason.default": "Expulsat per un operador.",
	...
	"multiplayer.disconnect.code_of_conduct": "El servidor requerix que acceptes el Codi de Conducta",
	"multiplayer.disconnect.configuration_error": "Ha ocorregut un error inesperat durant la configuració",
	...
	"multiplayer.disconnect.invalid_public_key_signature.new": "La signatura per a la clau pública del perfil no és vàlida.\nProva de reiniciar el joc.",
	...
	"multiplayer.disconnect.transfers_disabled": "El servidor no accepta transferències",
	...
	"multiplayer.lan.server_found": "S'ha trobat un nou servidor: %s",
	...
	"multiplayer.status.anonymous_player": "Jugador anònim",
	...
	"multiplayer.status.ping.narration": "Ping de %s mil·lisegons",
	...
	"multiplayer.unsecureserver.toast.title": "Missatges del xat no verificables",
	...
	"narration.checkbox.usage.focused.check": "Prem \"Intro\" per marcar-ho",
	"narration.checkbox.usage.focused.uncheck": "Prem \"Intro\" per desmarcar-ho",
	"narration.checkbox.usage.hovered": "Clic esquerre per alternar",
	"narration.checkbox.usage.hovered.check": "Clic dret per marcar-ho",
	"narration.checkbox.usage.hovered.uncheck": "Clic dret per desmarcar-ho",
	"narration.component_list.usage": "Prem Tab per navegar al següent element",
	...
	"narration.item": "Objecte: %s",
	"narration.link.usage.focused": "Prem Intro per seguir l’enllaç",
	"narration.link.usage.hovered": "Fes clic esquerre per seguir l’enllaç",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Prem \"Intro\" per començar a canviar el valor de la barra",
	"narration.slider.usage.hovered": "Arrossega la barra per canviar-ne el valor",
	...
	"narration.suggestion.usage.cycle.fixed": "Prem Tab per passar a la següent suggerència",
	"narration.suggestion.usage.cycle.hidable": "Prem Tab per passar a la següent suggerència, o Esc per eixir dels suggeriments",
	"narration.suggestion.usage.fill.fixed": "Prem Tab per utilitzar la suggerència",
	"narration.suggestion.usage.fill.hidable": "Prem Tab per utilitzar la suggerència, o Esc per eixir dels suggeriments",
	"narration.tab_navigation.usage": "Prem Ctrl i Tab per canviar entre pestanyes",
	...
	"narrator.position.tab": "Pestanya %s de %s seleccionada",
	...
	"narrator.select.world_info": "Seleccionat %s, jugat per última vegada: %s, %s",
	...
	"optimizeWorld.confirm.proceed": "Crea una còpia de segurat i optimitza",
	...
	"optimizeWorld.stage.finished": "Acabant...",
	"optimizeWorld.stage.finished.chunks": "Acabant d'actualitzar els chunks...",
	"optimizeWorld.stage.finished.entities": "Acabant d'actualitzar les entitats...",
	"optimizeWorld.stage.finished.poi": "Acabant d'actualitzar els punts d'interés...",
	"optimizeWorld.stage.upgrading": "Actualitzant tots els chunks...",
	"optimizeWorld.stage.upgrading.chunks": "Actualitzant tots els chunks...",
	"optimizeWorld.stage.upgrading.entities": "Actualitzant totes les entitats...",
	"optimizeWorld.stage.upgrading.poi": "Actualitzant tots els punts d'interés...",
	"optimizeWorld.title": "Optimitzant el món \"%s\"",
	"options.accessibility": "Configuració d'accessibilitat...",
	"options.accessibility.high_contrast": "Contrast alt",
	"options.accessibility.high_contrast.error.tooltip": "El paquet de recursos d'alt contrast no està disponible.",
	"options.accessibility.high_contrast.tooltip": "Millora el contrast dels elements de la IU.",
	"options.accessibility.high_contrast_block_outline": "Vora de blocs d'alt contrast",
	"options.accessibility.high_contrast_block_outline.tooltip": "Augmenta el contrast de la vora dels blocs objectiu.",
	"options.accessibility.link": "Guia d'accessibilitat",
	"options.accessibility.menu_background_blurriness": "Nitidesa del fons del menú",
	"options.accessibility.menu_background_blurriness.tooltip": "Canvia la nitidesa dels fons dels menús",
	"options.accessibility.narrator_hotkey": "Tecla ràpida del narrador",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Permet activar i desactivar el narrador amb \"Cmd + B\".",
	"options.accessibility.narrator_hotkey.tooltip": "Permet activar i desactivar el narrador amb \"Ctrl + B\".",
	...
	"options.accessibility.tooltip": "Configuració d’accessibilitat",
	"options.allowCursorChanges": "Permet canvis al cursor",
	"options.allowCursorChanges.tooltip": "Permet al cursor del ratolí canviar de forma quan es troba sobre determinats elements de la interfície.",
	"options.allowFriendRequests": "Permetre sol·licituds",
	"options.allowFriendRequests.tooltip": "Permet que altres jugadors t’envien sol·licituds d’amistat",
	...
	"options.chat": "Configuració del xat...",
	"options.chat.color": "Colors",
	"options.chat.delay": "Retard del xat: %s segon/s",
	"options.chat.delay_none": "Retard del xat: cap",
	"options.chat.drafts": "Guarda els xats no enviats",
	"options.chat.drafts.tooltip": "Els missatges no enviats es guardaran i podràs enviar-los la pròxima vegada que òbrigues el xat.",
	...
	"options.chunkFade": "Temps de difuminació dels chunks",
	"options.chunkFade.none": "Temps de difuminació dels chunks: cap",
	"options.chunkFade.seconds": "Temps de difuminació dels chunks: %s segon/s",
	"options.chunkFade.tooltip": "Temps en segons en el qual els chunks es difuminen quan es renderitzen per primera vegada, si és que ho fan.",
	...
	"options.cutoutLeaves": "Vore a través de les fulles",
	"options.cutoutLeaves.tooltip": "Permet veure a través dels forats de les fulles. Desactivar-ho pot millorar el rendiment.",
	"options.damageTiltStrength": "Sacseig per mal",
	"options.damageTiltStrength.tooltip": "El moviment del sacseig de la càmera causat quan et fas mal.",
	...
	"options.difficulty.easy.info": "Es generen criatures hostils però dèbils. La barra de fam es buidarà i et podrà reduir la vida fins a 5 cors.",
	"options.difficulty.hard": "Difícil",
	"options.difficulty.hard.info": "Es generen criatures hostils molt fortes. La barra de fam es buidarà fins la mort.",
	"options.difficulty.hardcore": "Extrem",
	"options.difficulty.normal": "Normal",
	"options.difficulty.normal.info": "Es generen criatures hostils de nivell estàndard. La barra de fam es buidarà i et podrà reduir la vida fins que et quede mig cor.",
	"options.difficulty.online": "Dificultat del servidor",
	"options.difficulty.peaceful": "Pacífica",
	"options.difficulty.peaceful.info": "Sense criatures hostils i només algunes de neutrals. Mai tens fam i et regeneres ràpidament.",
	...
	"options.exclusiveFullscreen.warningTooltip": "Esta opció podria impedir que alguns mètodes d’entrada funcionen.",
	"options.font": "Opcions de font...",
	"options.font.title": "Opcions de font",
	...
	"options.friendsList": "Llista d’amics",
	"options.friendsList.confirm.message": "La llista d’amics controla amb qui pots xatejar quan “Pot comunicar-se fora d’Xbox” està configurat en “Amics”.\n\nGestiona esta configuració al teu compte de Microsoft.\n\nQuan la llista d’amics està ACTIVADA, altres jugadors poden enviar-te sol·licituds d’amistat. Pots DESACTIVAR les invitacions d’amistat o la llista d’amics en qualsevol moment.",
	"options.friendsList.confirm.message.link": "Compte de Microsoft",
	"options.friendsList.confirm.title": "Activar la llista d’amics?",
	...
	"options.glintSpeed": "Velocitat de brillantor",
	"options.glintSpeed.tooltip": "Controla com de ràpid brillaran els objectes encantats.",
	"options.glintStrength": "Intensitat de brillantor",
	"options.glintStrength.tooltip": "Controla la transparència de la brillantor dels objectes encantats.",
	"options.graphics": "Gràfics",
	"options.graphics.custom": "Personalitzat",
	...
	"options.graphics.preset": "Predeterminat",
	"options.graphics.preset.tooltip": "Estableix l'opció de configuració \"Qualitat i rendiment\" en estàndards raonables segons la qualitat desitjada.",
	"options.graphics.warning.accept": "Continua sense suport",
	"options.graphics.warning.cancel": "Torna",
	...
	"options.graphicsApi": "API gràfica",
	"options.graphicsApi.default": "Per defecte",
	"options.graphicsApi.opengl": "Preferisc OpenGL",
	"options.graphicsApi.restart": "Has de reiniciar el joc per a canviar l’API gràfica.",
	"options.graphicsApi.tooltip": "Quina API gràfica utilitzar per al renderitzat: deixa-ho en \"Per defecte\" llevat que tingues una necessitat específica de canviar-ho. Tindrà efecte la pròxima vegada que inicies el joc.",
	"options.graphicsApi.tooltip.vulkan": "Experimental. Pot reduir el rendiment o causar inestabilitat en alguns sistemes.",
	"options.graphicsApi.vulkan": "Preferisc Vulkan",
	...
	"options.hideLightningFlashes.tooltip": "Evita que els llamps i altres efectes de l'ambient facen resplendir el cel. Les fonts dels resplendors en sí, sí que es voran.",
	...
	"options.hideSplashTexts": "Amaga els textos de portada",
	"options.hideSplashTexts.tooltip": "Amaga els textos grocs de portada al menú principal.",
	"options.improvedTransparency": "Transparència millorada",
	"options.improvedTransparency.tooltip": "Una aproximació experimental que utilitza ombres per dibuixar l'oratge, núvols i partícules darrere dels blocs translúcids i l'aigua.\nAçò tindrà un impacte en el rendiment de la targeta gràfica.",
	"options.inGameNotification": "Notificació dins del joc",
	"options.inGameNotification.tooltip": "Mostrar notificacions d’amics dins del joc",
	"options.inactivityFpsLimit": "Reduïx els FPS quan",
	"options.inactivityFpsLimit.afk": "està inactiu",
	"options.inactivityFpsLimit.afk.tooltip": "Limita els fotogrames a 30 quan el jugador està inactiu més d'un minut. Es reduïx a 10 després de 9 minuts.",
	"options.inactivityFpsLimit.minimized": "està minimitzat",
	"options.inactivityFpsLimit.minimized.tooltip": "Limita els fotogrames només quan la finestra del joc està minimitzada.",
	"options.invertMouse": "Invertir el ratolí",
	"options.invertMouseX": "Invertix el ratolí X",
	"options.invertMouseY": "Invertix el ratolí Y",
	"options.japaneseGlyphVariants": "Variants de símbols japonesos",
	"options.japaneseGlyphVariants.tooltip": "Utilitza variants japoneses dels caràcters xinesos, coreans i japonesos en la font per defecte.",
	"options.key.hold": "Mantín",
	"options.key.toggle": "Canvia",
	"options.language": "Llengua...",
	"options.language.narration": "Canviar idioma",
	"options.language.title": "Llengua",
	"options.language.tooltip": "Canviar idioma",
	"options.languageAccuracyWarning": "(Les traduccions són realitzades per la comunitat)",
	...
	"options.maxAnisotropy": "Filtre anisotròpic",
	"options.maxAnisotropy.tooltip": "Millora significativament l'aparença de les textures llises, però tindrà un impacte en el rendiment i en l'ús de la memòria de vídeo. Potser no ho suporten tots els tipus de maquinari.",
	...
	"options.modelPart.left_pants_leg": "Camal esquerre",
	...
	"options.musicToast": "Notificació de música",
	"options.musicToast.never": "Mai",
	"options.musicToast.never.tooltip": "No es mostren notificacions de música.",
	"options.musicToast.pauseMenu": "Menú de pausa",
	"options.musicToast.pauseMenu.tooltip": "Una notificació de música es mostra constantment al menú de pausa quan sona una cançó.",
	"options.musicToast.pauseMenuAndToast": "Menú de pausa i notificacions",
	"options.musicToast.pauseMenuAndToast.tooltip": "Mostra una notificació quan comença a sonar una cançó. La mateixa notificació es mostra al menú de pausa mentre sona una cançó.",
	"options.music_frequency": "Freqüència de la música",
	"options.music_frequency.constant": "Constant",
	"options.music_frequency.default": "Per defecte",
	"options.music_frequency.frequent": "Freqüent",
	"options.music_frequency.tooltip": "Canvia la freqüència amb què sona la música mentre es juga en un món.",
	...
	"options.needsRestart": "L’opció s’aplicarà després de reiniciar.",
	"options.notifications.display_time": "Temps de notificació",
	"options.notifications.display_time.tooltip": "Controla quant de temps es mantenen les notificacions visibles en la pantalla.",
	"options.off": "NO",
	"options.off.composed": "%s: NO",
	"options.on": "SÍ",
	"options.on.composed": "%s: SÍ",
	"options.online": "En línia...",
	"options.online.friends.header": "Llista d’amics",
	"options.online.realms.header": "Realms",
	"options.online.servers.header": "Servidors",
	"options.online.title": "Opcions en línia",
	"options.online.xboxSettings": "Configuració d’Xbox...",
	...
	"options.operatorItemsTab": "Objectes d'admin.",
	...
	"options.realmsNotifications": "Notícies i invitacions dels Realms",
	"options.realmsNotifications.button": "Novetats i invitacions",
	"options.realmsNotifications.tooltip": "Aporta notícies de Realms i invitacions al menú principal i mostra les respectives icones al botó de Realms.",
	"options.reducedDebugInfo": "Reduir informació de F3",
	"options.renderClouds": "Núvols",
	"options.renderCloudsDistance": "Distància de núvols",
	"options.renderDistance": "Punt remot de visió",
	"options.resourcepack": "Paquets de recursos...",
	"options.restartRequired": "Alguns dels teus canvis requerixen reiniciar el joc per a aplicar-se.",
	"options.rotateWithMinecart": "Girs amb les vagonetes",
	"options.rotateWithMinecart.tooltip": "Controla si la visió del jugador gira amb els girs de les vagonetes. Només disponible als mons amb l'opció \"Millores de les vagonetes\" activada.",
	...
	"options.sharePresence": "Presència",
	"options.sharePresence.all": "Tot",
	"options.sharePresence.all.tooltip": "La presència es compartix amb els teus amics. Apareixes com a connectat i compartint el que estàs fent.",
	"options.sharePresence.limited": "Limitada",
	"options.sharePresence.limited.tooltip": "Compartint una presència limitada. Apareixes com a connectat, però sense compartir el que estàs fent. Encara pots convidar amics a la teua partida.",
	"options.sharePresence.none": "Cap",
	"options.sharePresence.none.tooltip": "Sense compartir cap presència. Apareixes com a desconnectat.",
	"options.showNowPlayingToast": "Mostra la notificació de la música",
	"options.showNowPlayingToast.tooltip": "Mostra una notificació quan la música comença a sonar. La mateixa notificació es mostra fixa quan el joc està en pausa i la música està sonant.",
	"options.showSubtitles": "Subtítols amagats",
	"options.showSubtitles.tooltip": "Activa els subtitols per als sons reproduïts al joc.",
	...
	"options.sprintWindow": "Finestra de córrer",
	"options.sprintWindow.tooltip": "Finestra de temps en tics, on en prémer dos vegades la tecla d'avançar, s'activa l'esprint.",
	...
	"options.telemetry.disabled": "La telemetria està desactivada.",
	"options.telemetry.state.all": "Totes",
	"options.telemetry.state.minimal": "Mínimes",
	"options.telemetry.state.none": "Cap",
	"options.textureFiltering": "Filtre de textures",
	"options.textureFiltering.anisotropic": "Anisotròpic",
	"options.textureFiltering.anisotropic.tooltip": "Un mètode de filtrat basat en maquinari, que afectarà el rendiment i l'ús de la memòria de vídeo. Pot ser no tot el maquinari ho suporte.",
	"options.textureFiltering.none": "Cap",
	"options.textureFiltering.none.tooltip": "Les textures es motraran sense filtre. Els blocs potser es vegen borrossos segons la perspectiva.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nUn mètode de filtrat basat en ombres que millora la qualitat de les textures amb un impacte en el rendiment moderat.",
	...
	"options.video.interface.header": "Interfície",
	"options.video.preferences.header": "Preferències",
	"options.video.quality.header": "Qualitat i rendiment",
	"options.videoTitle": "Configuració de vídeo",
	"options.viewBobbing": "Moviment de càmera",
	"options.vignette": "Mostra la vinyeta",
	"options.vignette.tooltip": "Això és una subtil textura sobre la pantalla del joc utilitzada per reduir la brillantor cap a la vora de la pantalla i avisar del límit del món.",
	"options.visible": "Visible",
	"options.vsync": "VSync",
	"options.weatherRadius": "Radi d'efecte de l'oratge",
	"options.weatherRadius.tooltip": "Radi de l'àrea on els efectes de la pluja i la neu són visibles. No afecta pràcticament al rendiment.",
	"options.worldOptions.button": "Opcions del món...",
	"options.worldOptions.title": "Opcions del món",
	...
	"pack.dropRejected.message": "Les següents entrades no són paquets vàlids i no s'han copiat:\n %s",
	"pack.dropRejected.title": "Entrades sense paquet",
	...
	"pack.incompatible.confirm.unknown": "Aquest pack està trencat o està fet per a una versió desconeguda del Minecraft, i podria no funcionar correctament.",
	...
	"pack.incompatible.unknown": "(Trencat o incompatible)",
	...
	"painting.minecraft.backyard.title": "Pati de darrere",
	"painting.minecraft.baroque.author": "Sarah Boeving",
	"painting.minecraft.baroque.title": "Barroc",
	"painting.minecraft.bomb.author": "Kristoffer Zetterstrand",
	"painting.minecraft.bomb.title": "Objectiu bombardejat correctament",
	"painting.minecraft.bouquet.author": "Kristoffer Zetterstrand",
	"painting.minecraft.bouquet.title": "Ram",
	...
	"painting.minecraft.cavebird.title": "Pardal de cova",
	"painting.minecraft.changing.author": "Kristoffer Zetterstrand",
	"painting.minecraft.changing.title": "Canviant",
	...
	"painting.minecraft.creebet.title": "Creesatge",
	...
	"painting.minecraft.owlemons.title": "Mussollimes",
	"painting.minecraft.passage.author": "Kristoffer Zetterstrand",
	"painting.minecraft.passage.title": "Passatge",
	"painting.minecraft.pigscene.author": "Kristoffer Zetterstrand",
	"painting.minecraft.pigscene.title": "Porcsena",
	"painting.minecraft.plant.author": "Kristoffer Zetterstrand",
	"painting.minecraft.plant.title": "Paradisträd",
	"painting.minecraft.pointer.author": "Kristoffer Zetterstrand",
	"painting.minecraft.pointer.title": "Assenyalador",
	"painting.minecraft.pond.author": "Kristoffer Zetterstrand",
	"painting.minecraft.pond.title": "Tolla",
	"painting.minecraft.pool.author": "Kristoffer Zetterstrand",
	"painting.minecraft.pool.title": "La piscina",
	"painting.minecraft.prairie_ride.author": "Sarah Boeving",
	"painting.minecraft.prairie_ride.title": "Passeig pels prats",
	"painting.minecraft.sea.author": "Kristoffer Zetterstrand",
	"painting.minecraft.sea.title": "La mar",
	"painting.minecraft.skeleton.author": "Kristoffer Zetterstrand",
	"painting.minecraft.skeleton.title": "Espiral mortal",
	...
	"painting.minecraft.wither.title": "El wither",
	"painting.random": "Variant aleatòria",
	"parsing.bool.expected": "Es requerix un valor booleà",
	"parsing.bool.invalid": "Valor booleà invàlid: s'esperava \"true\" o \"false\" però s'ha trobat \"%s\"",
	...
	"particle.invalidOptions": "No s'han pogut analitzar les opcions de partícula: %s",
	...
	"quickplay.error.invalid_identifier": "No s'ha trobat cap món amb l'identificador donat",
	"quickplay.error.realm_connect": "No s'ha pogut connectar amb el Realm",
	"quickplay.error.realm_permission": "No tens permís per connectar-te a este Realm",
	"quickplay.error.title": "Ha fallat el joc ràpid",
	"realms.configuration.region.australia_east": "Nova Gal·les del Sud, Austràlia",
	"realms.configuration.region.australia_southeast": "Victòria, Austràlia",
	...
	"realms.configuration.region.east_us_2": "Carolina del Nord, EUA",
	"realms.configuration.region.france_central": "França",
	"realms.configuration.region.japan_east": "Japó (est)",
	"realms.configuration.region.japan_west": "Japó (oest)",
	"realms.configuration.region.korea_central": "Corea del Sud",
	...
	"realms.configuration.region.sweden_central": "Suècia",
	"realms.configuration.region.uae_north": "Emirats Àrabs Units (EAU)",
	"realms.configuration.region.uk_south": "Anglaterra (sud)",
	"realms.configuration.region.west_central_us": "Utah, EUA",
	"realms.configuration.region.west_europe": "Països Baixos",
	"realms.configuration.region.west_us": "Califòrnia, EUA",
	"realms.configuration.region.west_us_2": "Washington, EUA",
	"realms.configuration.region_preference.automatic_owner": "Automàtic (ping del propietari del Realm)",
	"realms.configuration.region_preference.automatic_player": "Automàtic (primer en entrar)",
	"realms.missing.snapshot.error.text": "Minecraft Realms no és compatible amb les versions en proves",
	...
	"recover_world.bug_tracker": "Informa d'un error",
	"recover_world.button": "Intenta recuperar",
	"recover_world.done.failed": "No s'ha pogut recuperar l'últim estat guardat.",
	"recover_world.done.success": "La recuperació s'ha fet amb èxit!",
	"recover_world.done.title": "Recuperació feta",
	"recover_world.issue.missing_file": "Falta algun arxiu",
	"recover_world.issue.none": "Cap error",
	"recover_world.message": "S'han produït els següents errors en intentar llegir la carpeta del món \"%s\".\nEs podria restaurar el món des d'un estat anterior o informar d'este problema al rastrejador d'errors.",
	"recover_world.no_fallback": "No hi ha cap estat disponible per recuperar",
	"recover_world.restore": "Intenta restaurar",
	"recover_world.restoring": "Intentant restaurar el món...",
	"recover_world.state_entry": "Estat de %s: ",
	"recover_world.state_entry.unknown": "desconegut",
	"recover_world.title": "No s'ha pogut carregar el món",
	"recover_world.warning": "No s'ha pogut carregar el resum del món",
	...
	"resourcePack.runtime_failure": "S'ha detectat un error del paquet de recursos",
	...
	"restrictions_screen.button": "Restriccions...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Pots rebre missatges d'altres jugadors",
	"restrictions_screen.permission.receive_player_messages.denied": "No pots rebre missatges d'altres jugadors",
	"restrictions_screen.permission.receive_system_messages.allowed": "Pots rebre missatges del sistema des del servidor",
	"restrictions_screen.permission.receive_system_messages.denied": "No pots rebre missatges del sistema des del servidor",
	"restrictions_screen.permission.send_commands.allowed": "Pots enviar comandaments",
	"restrictions_screen.permission.send_commands.denied": "No pots enviar comandaments",
	"restrictions_screen.permission.send_messages.allowed": "Pots enviar missatges de xat",
	"restrictions_screen.permission.send_messages.denied": "No pots enviar missatges de xat",
	"restrictions_screen.title": "Restriccions",
	"screenshot.failure": "No es pot guardar la captura de pantalla: %s",
	"screenshot.success": "S'ha fet una captura de pantalla com a %s",
	...
	"selectWorld.allowCommands.new": "Permet comandaments",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Vols crear una còpia de seguretat abans d'actualitzar el món?",
	...
	"selectWorld.backupWarning.file_fixing_required": "Este món necessita ser actualitzat abans de poder-lo jugar. Et recomanem crear una còpia de seguretat abans de continuar, per si de cas.",
	...
	"selectWorld.commands": "Comandaments",
	...
	"selectWorld.experimental.message": "Compte!\nEsta configuració requerix característiques que encara estan en desenvolupament. El món podria trencar-se o deixar de funcionar en futures actualitzacions.",
	"selectWorld.experimental.title": "Alerta de funcions experimentals",
	"selectWorld.experiments": "Experiments",
	"selectWorld.experiments.info": "Els experiments són noves característiques potencials. Ves amb compte ja que algunes coses podrien deixar de funcionar. Els experiments no es poden desactivar una vegada s'ha creat el món.",
	...
	"selectWorld.gameMode.adventure.info": "Igual que el mode supervivència però no pots ni llevar ni posar blocs.",
	...
	"selectWorld.gameMode.creative.info": "Crea, construïx i explora sense límits. Pots volar, no tens límit de materials i els monstres no poden fer-te mal.",
	...
	"selectWorld.gameMode.hardcore.info": "Mode de supervivència amb dificultat bloquejada en \"Difícil\". Si mors no reapareixes.",
	...
	"selectWorld.gameMode.spectator.info": "Es mira però no es toca.",
	"selectWorld.gameMode.spectator.line1": "Pots mirar però no tocar",
	"selectWorld.gameMode.survival": "Supervivència",
	"selectWorld.gameMode.survival.info": "Explora un món misteriós on construir, recollir, fabricar i lluitar contra monstres.",
	...
	"selectWorld.incompatible.description": "Este món no es pot obrir en esta versió.\nVa ser obert per última vegada en la versió %s.",
	"selectWorld.incompatible.info": "Versió incompatible: %s",
	"selectWorld.incompatible.title": "Versió incompatible",
	"selectWorld.incompatible.tooltip": "Este món on es pot obrir perquè es va crear en una versió incompatible.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Este món necessita ser actualitzat a l'última versió abans de poder-lo editar, a causa de canvis subjacents en el format.",
	"selectWorld.requiresFileFixingTooltip.play": "Este món necessita ser actualitzat a l'última versió abans de poder jugar-lo, a causa de canvis subjacents en el format.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Este món necessita ser actualitzat a l'última versió abans de poder-lo recrear, a causa de canvis subjacents en el format.",
	"selectWorld.resource_load": "Preparant recursos...",
	...
	"selectWorld.targetFolder": "Guarda a la carpeta: %s",
	...
	"selectWorld.tooltip.fromNewerVersion2": "i carregar-lo podria causar problemes!",
	...
	"selectWorld.upgrade_and_play": "Actualitza i juga",
	...
	"selectWorld.waitingForBackup.message": "Segons la grandària del teu món, això pot tardar un temps. Per favor, no tanques el joc ni apagues el teu dispositiu.",
	"selectWorld.waitingForBackup.title": "Creant còpia de seguretat",
	...
	"selectWorld.warning.lowDiskSpace.description": "No queda molt d'espai al teu dispositiu.\nSi et quedes sense espai mentre jugues, el teu món es podria danyar.",
	"selectWorld.warning.lowDiskSpace.title": "Atenció! Queda poc d'espai al disc!",
	"selectWorld.world": "Món",
	"selectWorld.world_gen_settings_access": "No s'ha pogut llegir ni accedir al fitxer de configuració de generació del món! %s",
	"selecteWorld.backupRequiredTooltip": "Carregar el món requerix crear una còpia de seguretat primer",
	...
	"slot.only_single_allowed": "Només es permeten espais individuals. S'ha obtingut \"%s\"",
	"slot.unknown": "Espai desconegut: \"%s\"",
	"snbt.parser.empty_key": "La clau no pot estar buida",
	"snbt.parser.expected_binary_numeral": "S'esperava un nombre binari",
	"snbt.parser.expected_decimal_numeral": "S'esperava un nombre decimal",
	"snbt.parser.expected_float_type": "S'esperava un nombre en coma flotant",
	"snbt.parser.expected_hex_escape": "S'esperava un caràcter literal de longitud %s",
	"snbt.parser.expected_hex_numeral": "S'esperava un nombre hexadecimal",
	"snbt.parser.expected_integer_type": "S'esperava un nombre enter",
	"snbt.parser.expected_non_negative_number": "S'esperava un número natural",
	"snbt.parser.expected_number_or_boolean": "Es requerix un número o un booleà",
	"snbt.parser.expected_string_uuid": "Es requerix una cadena amb un UUID vàlid",
	"snbt.parser.expected_unquoted_string": "S'esperava una cadena vàlida sense cometes",
	"snbt.parser.infinity_not_allowed": "No es poden utilitzar nombres infinits",
	"snbt.parser.invalid_array_element_type": "El tipus d'element al vector no és vàlid",
	"snbt.parser.invalid_character_name": "El nom del caràcter unicode no és vàlid",
	"snbt.parser.invalid_codepoint": "Valor de caràcter d'unicode invàlid: %s",
	"snbt.parser.invalid_string_contents": "Continguts de la cadena no vàlids",
	"snbt.parser.invalid_unquoted_start": "Les cadenes sense cometes no poden començar amb els dígits 0-9, + o -",
	"snbt.parser.leading_zero_not_allowed": "Els nombres decimals no poden començar amb 0",
	"snbt.parser.no_such_operation": "L'operació no existix: %s",
	"snbt.parser.number_parse_failure": "No s'ha pogut analitzar el nombre: %s",
	"snbt.parser.undescore_not_allowed": "La barra baixa no pot estar al principi o al final d'un nombre",
	...
	"soundCategory.ui": "IU",
	"soundCategory.voice": "Narrador/Veu",
	...
	"stat.minecraft.clean_banner": "Estandards netejats",
	...
	"stat.minecraft.happy_ghast_one_cm": "Distància amb ghast feliç",
	...
	"stat.minecraft.nautilus_one_cm": "Distància en nautilus",
	...
	"structure_block.detect_size": "Detecta la grandària i la posició de l'estructura:",
	...
	"structure_block.strict": "Col·locació estricta:",
	"structure_block.structure_name": "Nom de l'estructura",
	"subtitles.ambient.cave": "Soroll misteriós",
	"subtitles.ambient.sound": "Soroll inquietant",
	"subtitles.block.amethyst_block.chime": "Ametista repicant",
	"subtitles.block.amethyst_block.resonate": "L'ametista està resonant",
	...
	"subtitles.block.candle.extinguish": "S'ha apagat un ciri",
	...
	"subtitles.block.copper_bulb.turn_off": "S'ha apagat una làmpada de coure",
	"subtitles.block.copper_bulb.turn_on": "S'ha encés una làmpada de coure",
	"subtitles.block.copper_chest.close": "S'ha tancat un cofre",
	"subtitles.block.copper_chest.open": "S'ha obert un cofre",
	"subtitles.block.copper_trapdoor.close": "S'ha tancat una trapa",
	"subtitles.block.copper_trapdoor.open": "S'ha obert una trapa",
	"subtitles.block.crafter.craft": "Un fabricador ha fabricat",
	"subtitles.block.crafter.fail": "Un fabricador ha fallat",
	"subtitles.block.creaking_heart.hurt": "Crits de cor de crepitant",
	"subtitles.block.creaking_heart.idle": "So inquietant",
	"subtitles.block.creaking_heart.spawn": "S'ha despertat un cor de crepitant",
	"subtitles.block.deadbush.idle": "So àrid",
	"subtitles.block.decorated_pot.insert": "S'ha emplenat un gerro",
	"subtitles.block.decorated_pot.insert_fail": "Un gerro està trontollant",
	"subtitles.block.decorated_pot.shatter": "Un gerro s'ha fet miquetes",
	...
	"subtitles.block.dried_ghast.ambient": "Soroll de secor",
	"subtitles.block.dried_ghast.ambient_water": "Un ghast sec s'està rehidratant",
	"subtitles.block.dried_ghast.place_in_water": "Un ghast sec s'ha posat a remulla",
	"subtitles.block.dried_ghast.transition": "Un ghast sec s'està sentint millor",
	"subtitles.block.dry_grass.ambient": "Soroll de vent",
	...
	"subtitles.block.eyeblossom.close": "S'ha tancat un florull",
	"subtitles.block.eyeblossom.idle": "Murmuri de florull",
	"subtitles.block.eyeblossom.open": "S'ha obert un florull",
	...
	"subtitles.block.firefly_bush.idle": "Brunzit de lluerna",
	...
	"subtitles.block.generic.fall": "Alguna cosa ha caigut",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Un cartell està trontollant",
	...
	"subtitles.block.pale_hanging_moss.idle": "So inquietant",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Un guèiser de sofre ha fet erupció",
	"subtitles.block.potent_sulfur.noxious_gas": "Ha aparegut un gas nociu",
	"subtitles.block.pressure_plate.click": "Accionament de placa de pressió",
	"subtitles.block.pumpkin.carve": "Tisores esquilant",
	"subtitles.block.redstone_torch.burnout": "Una torxa està crepitant",
	"subtitles.block.respawn_anchor.ambient": "Brunzit d'àncora de reaparició",
	...
	"subtitles.block.sand.idle": "So arenós",
	"subtitles.block.sand.wind": "So de vent",
	...
	"subtitles.block.shelf.activate": "S'ha activat una prestatgeria",
	"subtitles.block.shelf.deactivate": "S'ha desactivat una prestatgeria",
	"subtitles.block.shelf.multi_swap": "S'ha intercanviat un objecte",
	"subtitles.block.shelf.place_item": "S'ha col·locat un objecte",
	"subtitles.block.shelf.single_swap": "S'ha intercanviat un objecte",
	"subtitles.block.shelf.take_item": "S'ha llevat un objecte",
	"subtitles.block.shulker_box.close": "Una caixa de shulker s'ha tancat",
	"subtitles.block.shulker_box.open": "Una caixa de shulker s'ha obert",
	"subtitles.block.sign.waxed_interact_fail": "Un cartell s'està balancejant",
	"subtitles.block.smithing_table.use": "S'ha utilitzat una ferreria",
	"subtitles.block.smoker.smoke": "Un fumador està tirant fum",
	"subtitles.block.sniffer_egg.crack": "Un ou de rastrejador s'ha clevillat",
	"subtitles.block.sniffer_egg.hatch": "Un ou de rastrejador ha desclosat",
	"subtitles.block.sniffer_egg.plop": "Un rastrejador ha post",
	"subtitles.block.sponge.absorb": "Una esponja està absorbint",
	"subtitles.block.sweet_berry_bush.pick_berries": "Han caigut baies",
	"subtitles.block.trapdoor.close": "S'ha tancat una trapa",
	"subtitles.block.trapdoor.open": "S'ha obert una trapa",
	"subtitles.block.trapdoor.toggle": "Cruixit de trapa",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Un objecte ominós s'està preparant",
	"subtitles.block.trial_spawner.ambient": "Espurneig de generador de reptes",
	"subtitles.block.trial_spawner.ambient_charged": "Espurneig de generador de reptes ominós",
	"subtitles.block.trial_spawner.ambient_ominous": "Espurneig de generador de reptes ominós",
	"subtitles.block.trial_spawner.charge_activate": "Un presagi envolta un generador de reptes",
	"subtitles.block.trial_spawner.close_shutter": "Un generador de reptes s'ha tancat",
	"subtitles.block.trial_spawner.detect_player": "Un generador de reptes s'ha recarregat",
	"subtitles.block.trial_spawner.eject_item": "Un generador de reptes ha expulsat objectes",
	"subtitles.block.trial_spawner.ominous_activate": "Un presagi envolta un generador de reptes",
	"subtitles.block.trial_spawner.open_shutter": "Un generador de reptes s'ha obert",
	"subtitles.block.trial_spawner.spawn_item": "S'ha amollat un objecte ominós",
	"subtitles.block.trial_spawner.spawn_item_begin": "Ha aparegut un objecte ominós",
	"subtitles.block.trial_spawner.spawn_mob": "S'ha generat una criatura",
	...
	"subtitles.block.vault.activate": "S'ha encés una caixa forta",
	"subtitles.block.vault.ambient": "Espurneig de caixa forta",
	"subtitles.block.vault.close_shutter": "S'ha tancat una caixa forta",
	"subtitles.block.vault.deactivate": "S'ha apagat una caixa forta",
	"subtitles.block.vault.eject_item": "Una caixa forta ha expulsat un objecte",
	"subtitles.block.vault.insert_item": "S'ha desbloquejat una caixa forta",
	"subtitles.block.vault.insert_item_fail": "No s'ha pogut desbloquejar una caixa forta",
	"subtitles.block.vault.open_shutter": "S'ha obert una caixa forta",
	"subtitles.block.vault.reject_rewarded_player": "Una caixa forta ha rebutjat un jugador",
	"subtitles.block.water.ambient": "Aigua fluïx",
	"subtitles.block.wet_sponge.dries": "Una esponja s'ha eixugat",
	...
	"subtitles.entity.allay.ambient_with_item": "Un al·lai està buscant",
	"subtitles.entity.allay.ambient_without_item": "Un al·lai està anhelant",
	"subtitles.entity.allay.death": "Ha mort un al·lai",
	"subtitles.entity.allay.hurt": "Han ferit un al·lai",
	"subtitles.entity.allay.item_given": "Un al·lai està somrient satisfet",
	"subtitles.entity.allay.item_taken": "Un al·lai està recollint",
	"subtitles.entity.allay.item_thrown": "Un al·lai està llançant",
	"subtitles.entity.armadillo.ambient": "Un armadillo està grunyint",
	"subtitles.entity.armadillo.brush": "S'ha raspallat un armadillo",
	"subtitles.entity.armadillo.death": "Ha mort un armadillo",
	"subtitles.entity.armadillo.eat": "Un armadillo està menjant",
	"subtitles.entity.armadillo.hurt": "Han ferit un armadillo",
	"subtitles.entity.armadillo.hurt_reduced": "Un armadillo s'ha protegit",
	"subtitles.entity.armadillo.land": "Un armadillo ha aterrat",
	"subtitles.entity.armadillo.peek": "Un armadillo està espiant",
	"subtitles.entity.armadillo.roll": "Un armadillo s'ha enroscat",
	"subtitles.entity.armadillo.scute_drop": "Ha caigut una placa",
	"subtitles.entity.armadillo.unroll_finish": "Un armadillo s'ha desenrotllat",
	"subtitles.entity.armadillo.unroll_start": "Un armadillo està espiant",
	...
	"subtitles.entity.baby_cat.ambient": "Un gatet està miolant",
	"subtitles.entity.baby_cat.beg_for_food": "Un gatet està demanant",
	"subtitles.entity.baby_cat.death": "Ha mort un gatet",
	"subtitles.entity.baby_cat.eat": "Un gatet està menjant",
	"subtitles.entity.baby_cat.hiss": "Un gatet està bufant",
	"subtitles.entity.baby_cat.hurt": "Han ferit un gatet",
	"subtitles.entity.baby_cat.purr": "Un gatet està rumrumejant",
	"subtitles.entity.baby_chicken.ambient": "Un pollet està piulant",
	"subtitles.entity.baby_chicken.death": "Ha mort un pollet",
	"subtitles.entity.baby_chicken.hurts": "Han ferit un pollet",
	"subtitles.entity.baby_horse.ambient": "Un poltre està renillant",
	"subtitles.entity.baby_horse.angry": "Un poltre està renillant",
	"subtitles.entity.baby_horse.breathe": "Un poltre està respirant",
	"subtitles.entity.baby_horse.death": "Ha mort un poltre",
	"subtitles.entity.baby_horse.eat": "Un poltre està menjant",
	"subtitles.entity.baby_horse.hurt": "Han ferit un poltre",
	"subtitles.entity.baby_horse.land": "Un poltre ha aterrat",
	"subtitles.entity.baby_nautilus.ambient": "Cant de cria de nautilus",
	"subtitles.entity.baby_nautilus.ambient_land": "Cant de cria de nautilus",
	"subtitles.entity.baby_nautilus.death": "Ha mort una cria de nautilus",
	"subtitles.entity.baby_nautilus.death_land": "Han ferit una cria de nautilus",
	"subtitles.entity.baby_nautilus.eat": "Una cria de nautilus està menjant",
	"subtitles.entity.baby_nautilus.hurt": "Han ferit una cria de nautilus",
	"subtitles.entity.baby_nautilus.hurt_land": "Ha mort una cria nautilus",
	"subtitles.entity.baby_nautilus.swim": "Una cria de nautilus està nadant",
	"subtitles.entity.baby_pig.ambient": "Un garrí està grunyint",
	"subtitles.entity.baby_pig.death": "Ha mort un garrí",
	"subtitles.entity.baby_pig.eat": "Un garrí està menjant",
	"subtitles.entity.baby_pig.hurt": "Han ferit un garrí",
	"subtitles.entity.baby_wolf.ambient": "Un cadell està fent bub-bub",
	"subtitles.entity.baby_wolf.death": "Ha mort un cadell",
	"subtitles.entity.baby_wolf.growl": "Un cadell està grunyint",
	"subtitles.entity.baby_wolf.hurt": "Han ferit un cadell",
	"subtitles.entity.baby_wolf.pant": "Un cadell està panteixant",
	"subtitles.entity.baby_wolf.whine": "Un cadell està gemegant",
	...
	"subtitles.entity.bogged.ambient": "Un esquelet empantanat s'està sacsant",
	"subtitles.entity.bogged.death": "Ha mort un esquelet empantanat",
	"subtitles.entity.bogged.hurt": "Han ferit un esquelet empantanat",
	"subtitles.entity.breeze.charge": "Una brisa està carregant",
	"subtitles.entity.breeze.death": "Ha mort una brisa",
	"subtitles.entity.breeze.deflect": "Una brisa ha desviat un atac",
	"subtitles.entity.breeze.hurt": "Han ferit una brisa",
	"subtitles.entity.breeze.idle_air": "Una brisa està volant",
	"subtitles.entity.breeze.idle_ground": "Brunzit de brisa",
	"subtitles.entity.breeze.inhale": "Una brisa està inhalant",
	"subtitles.entity.breeze.jump": "Una brisa està botant",
	"subtitles.entity.breeze.land": "Una brisa ha aterrat",
	"subtitles.entity.breeze.shoot": "Una brisa està disparant",
	"subtitles.entity.breeze.slide": "Una brisa està lliscant",
	"subtitles.entity.breeze.whirl": "Una brisa està girant",
	"subtitles.entity.breeze.wind_burst": "Ha explotat una càrrega de vent",
	...
	"subtitles.entity.camel_husk.ambient": "Un dromedari momificat està grunyint",
	"subtitles.entity.camel_husk.dash": "Un dromedari momificat s'ha llançat",
	"subtitles.entity.camel_husk.dash_ready": "Un dromedari momificat s'està recuperant",
	"subtitles.entity.camel_husk.death": "Ha mort un dromedari momificat",
	"subtitles.entity.camel_husk.eat": "Un dromedari momificat està menjant",
	"subtitles.entity.camel_husk.hurt": "Han ferit un dromedari momificat",
	"subtitles.entity.camel_husk.saddle": "S'ha equipat una sella de muntar",
	"subtitles.entity.camel_husk.sit": "Un dromedari momificat s'ha assegut",
	"subtitles.entity.camel_husk.stand": "Un dromedari momificat s'ha posat dempeus",
	...
	"subtitles.entity.cat.hiss": "Un gat està bufant",
	...
	"subtitles.entity.copper_golem.death": "Ha mort un gólem de coure",
	"subtitles.entity.copper_golem.hurt": "Han ferit un gólem de coure",
	"subtitles.entity.copper_golem.item_drop": "Un gólem de coure està col·locant un objecte",
	"subtitles.entity.copper_golem.item_no_drop": "Un gólem de coure no pot col·locar un objecte",
	"subtitles.entity.copper_golem.no_item_get": "Un gólem de coure està agafant un objecte",
	"subtitles.entity.copper_golem.no_item_no_get": "Un gólem de coure no pot agafar un objecte",
	"subtitles.entity.copper_golem.spawn": "Ha aparegut un gólem de coure",
	"subtitles.entity.copper_golem.spin": "Un gólem de coure ha girat el cap",
	"subtitles.entity.copper_golem_become_statue": "Un gólem de coure s'ha petrificat",
	"subtitles.entity.copper_golem_oxidized.death": "Ha mort un gólem de coure",
	"subtitles.entity.copper_golem_oxidized.hurt": "Han ferit un gólem de coure",
	"subtitles.entity.copper_golem_oxidized.spin": "Un gólem de coure ha girat el cap",
	"subtitles.entity.copper_golem_weathered.death": "Ha mort un gólem de coure",
	"subtitles.entity.copper_golem_weathered.hurt": "Han ferit un gólem de coure",
	"subtitles.entity.copper_golem_weathered.spin": "Un gólem de coure ha girat el cap",
	...
	"subtitles.entity.creaking.activate": "S'ha activat un crepitant",
	"subtitles.entity.creaking.ambient": "Un crepitant està crepitant",
	"subtitles.entity.creaking.attack": "Un crepitant està atacant",
	"subtitles.entity.creaking.deactivate": "S'ha desactivat un crepitant",
	"subtitles.entity.creaking.death": "Ha mort un crepitant",
	"subtitles.entity.creaking.freeze": "Un crepitant ha parat",
	"subtitles.entity.creaking.spawn": "Un crepitant viu",
	"subtitles.entity.creaking.sway": "Han colpejat un crepitant",
	"subtitles.entity.creaking.twitch": "Un crepitant s'està sacsant",
	"subtitles.entity.creaking.unfreeze": "Un crepitant es mou",
	"subtitles.entity.creeper.death": "Ha mort un creeper",
	"subtitles.entity.creeper.hurt": "Han ferit un creeper",
	"subtitles.entity.creeper.primed": "Un creeper està bufant",
	...
	"subtitles.entity.donkey.jump": "Un ase està botant",
	...
	"subtitles.entity.fish.swim": "Esquitxant",
	...
	"subtitles.entity.generic.wind_burst": "Una càrrega de vent ha esclatat",
	...
	"subtitles.entity.ghastling.ambient": "Una cria de ghast està parrupant",
	"subtitles.entity.ghastling.death": "Ha mort una cria de ghast",
	"subtitles.entity.ghastling.hurt": "Han ferit una cria de ghast",
	"subtitles.entity.ghastling.spawn": "Ha aparegut una cria de ghast",
	...
	"subtitles.entity.happy_ghast.ambient": "Un ghast feliç està canturrutxant",
	"subtitles.entity.happy_ghast.death": "Ha mort un ghast feliç",
	"subtitles.entity.happy_ghast.equip": "S'ha equipat un arnés",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Un ghast feliç està preparat",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Un ghast feliç s'ha parat",
	"subtitles.entity.happy_ghast.hurt": "Han ferit un ghast feliç",
	"subtitles.entity.happy_ghast.unequip": "S'ha llevat un arnés",
	...
	"subtitles.entity.iron_golem.attack": "Un gólem de ferro està atacant",
	"subtitles.entity.iron_golem.damage": "S'ha trencat un gólem de ferro",
	"subtitles.entity.iron_golem.death": "Ha mort un gólem de ferro",
	"subtitles.entity.iron_golem.hurt": "Han ferit un gólem de ferro",
	"subtitles.entity.iron_golem.repair": "S'ha reparat un gólem de ferro",
	...
	"subtitles.entity.minecart.inside": "Una vagoneta està dringant",
	"subtitles.entity.minecart.inside_underwater": "Una vagoneta està dringant baix de l'aigua",
	...
	"subtitles.entity.mule.jump": "Una mula està botant",
	"subtitles.entity.nautilus.ambient": "Tritlleig de nautilus",
	"subtitles.entity.nautilus.ambient_land": "Tritlleig de nautilus",
	"subtitles.entity.nautilus.dash": "Un nautilus s'està impulsant",
	"subtitles.entity.nautilus.dash_land": "Un nautilus s'està impulsant",
	"subtitles.entity.nautilus.dash_ready": "Un nautilus s'està recuperant",
	"subtitles.entity.nautilus.dash_ready_land": "Un nautilus s'està recuperant",
	"subtitles.entity.nautilus.death": "Ha mort un nautilus",
	"subtitles.entity.nautilus.death_land": "Ha mort un nautilus",
	"subtitles.entity.nautilus.eat": "Un nautilus està menjant",
	"subtitles.entity.nautilus.hurt": "Han ferit un nautilus",
	"subtitles.entity.nautilus.hurt_land": "Han ferit un nautilus",
	"subtitles.entity.nautilus.swim": "Un nautilus està nadant",
	...
	"subtitles.entity.parched.ambient": "Un esquelet glacial s'està sacsant",
	"subtitles.entity.parched.death": "Ha mort un esquelet glacial",
	"subtitles.entity.parched.hurt": "Han ferit un esquelet glacial",
	...
	"subtitles.entity.parrot.imitate.bogged": "Un lloro s'està sacsant",
	"subtitles.entity.parrot.imitate.breeze": "Un lloro està inhalant",
	"subtitles.entity.parrot.imitate.camel_husk": "Un lloro està grunyint",
	"subtitles.entity.parrot.imitate.creaking": "Un lloro està crepitant",
	"subtitles.entity.parrot.imitate.creeper": "Un lloro està bufant",
	...
	"subtitles.entity.parrot.imitate.parched": "Un lloro està espurnejant",
	...
	"subtitles.entity.parrot.imitate.silverfish": "Un lloro està bufant",
	...
	"subtitles.entity.parrot.imitate.spider": "Un lloro està bufant",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Un lloro està gemegant",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Un lloro està fent gàrgares",
	...
	"subtitles.entity.pig.eat": "Un porc està menjant",
	...
	"subtitles.entity.player.teleport": "Un jugador s'ha teletransportat",
	"subtitles.entity.polar_bear.ambient": "Un os polar està gemegant",
	"subtitles.entity.polar_bear.ambient_baby": "Una cria d'os polar està brunzint",
	...
	"subtitles.entity.silverfish.ambient": "Un peixet de plata està bufant",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Un cavall esquelètic està saltant",
	...
	"subtitles.entity.sniffer.death": "Ha mort un rastrejador",
	"subtitles.entity.sniffer.digging": "Un rastrejador està excavant",
	"subtitles.entity.sniffer.digging_stop": "Un rastrejador s'ha alçat",
	"subtitles.entity.sniffer.drop_seed": "Un rastrejador ha amollat llavors",
	"subtitles.entity.sniffer.eat": "Un rastrejador està menjant",
	"subtitles.entity.sniffer.egg_crack": "Un ou de rastrejador s'ha clevillat",
	"subtitles.entity.sniffer.egg_hatch": "Un ou de rastrejador ha desclosat",
	"subtitles.entity.sniffer.happy": "Un rastrejador s'està delectant",
	"subtitles.entity.sniffer.hurt": "Han ferit un rastrejador",
	"subtitles.entity.sniffer.idle": "Un rastrejador està grunyint",
	"subtitles.entity.sniffer.scenting": "Un rastrejador està olorant",
	"subtitles.entity.sniffer.searching": "Un rastrejador està buscant",
	"subtitles.entity.sniffer.sniffing": "Un rastrejador està olorant",
	"subtitles.entity.sniffer.step": "Passos de rastrejador",
	"subtitles.entity.snow_golem.death": "Ha mort un gólem de neu",
	"subtitles.entity.snow_golem.hurt": "Han ferit un gólem de neu",
	"subtitles.entity.snowball.throw": "Han llançat una bola de neu",
	"subtitles.entity.spider.ambient": "Una aranya està bufant",
	...
	"subtitles.entity.sulfur_cube.absorb": "Cub de sofre ple",
	"subtitles.entity.sulfur_cube.bounce": "Un cub de sofre està rebotant",
	"subtitles.entity.sulfur_cube.death": "Ha mort un cub de sofre",
	"subtitles.entity.sulfur_cube.eject": "S'ha eliminat un bloc",
	"subtitles.entity.sulfur_cube.hit": "Han colpejat un cub de sofre",
	"subtitles.entity.sulfur_cube.hurt": "Han ferit un cub de sofre",
	"subtitles.entity.sulfur_cube.push": "Han espentat un cub de sofre",
	"subtitles.entity.sulfur_cube.squish": "Un cub de sofre està rebotant",
	...
	"subtitles.entity.wandering_trader.trade": "Un comerciant està negociant",
	...
	"subtitles.entity.wind_charge.throw": "Una càrrega de vent està volant",
	"subtitles.entity.wind_charge.wind_burst": "Ha explotat una càrrega de vent",
	...
	"subtitles.entity.wolf.bark": "Un llop està lladrant",
	...
	"subtitles.entity.wolf.pant": "Un llop està panteixant",
	"subtitles.entity.wolf.shake": "Un llop s'està sacsejant",
	"subtitles.entity.wolf.whine": "Un llop està gemegant",
	...
	"subtitles.entity.zombie_horse.angry": "Renill de cavall zombi",
	"subtitles.entity.zombie_horse.death": "Ha mort un cavall zombi",
	"subtitles.entity.zombie_horse.eat": "Un cavall zombi està menjant",
	"subtitles.entity.zombie_horse.hurt": "Han ferit un cavall zombi",
	"subtitles.entity.zombie_nautilus.ambient": "Un nautilus zombi està bombollejant",
	"subtitles.entity.zombie_nautilus.ambient_land": "Un nautilus zombi està bombollejant",
	"subtitles.entity.zombie_nautilus.dash": "Un nautilus zombi s'està impulsant",
	"subtitles.entity.zombie_nautilus.dash_land": "Un nautilus zombi s'està impulsant",
	"subtitles.entity.zombie_nautilus.dash_ready": "Un nautilus zombi s'està recuperant",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Un nautilus zombi s'està recuperant",
	"subtitles.entity.zombie_nautilus.death": "Ha mort un nautilus zombi",
	"subtitles.entity.zombie_nautilus.death_land": "Ha mort un nautilus zombi",
	"subtitles.entity.zombie_nautilus.eat": "Un nautilus zombi està menjant",
	"subtitles.entity.zombie_nautilus.hurt": "Han ferit un nautilus zombi",
	"subtitles.entity.zombie_nautilus.hurt_land": "Han ferit un nautilus zombi",
	"subtitles.entity.zombie_nautilus.swim": "Un nautilus zombi està nadant",
	...
	"subtitles.event.mob_effect.bad_omen": "Un presagi s'ha establit",
	"subtitles.event.mob_effect.raid_omen": "Un assalt és imminent a prop",
	"subtitles.event.mob_effect.trial_omen": "Un repte ominós és imminent a prop",
	...
	"subtitles.item.armor.equip_copper": "Una armadura de coure està fent soroll",
	...
	"subtitles.item.armor.equip_nautilus": "S'ha equipat una armadura per a nautilus",
	...
	"subtitles.item.armor.equip_wolf": "Una armadura de llop està estirant",
	"subtitles.item.armor.unequip_nautilus": "S'ha llevat una armadura per a nautilus",
	"subtitles.item.armor.unequip_wolf": "Un llop s'ha llevat l'armadura",
	...
	"subtitles.item.brush.brushing.generic": "Raspallant",
	"subtitles.item.brush.brushing.gravel": "S'està raspallant grava",
	"subtitles.item.brush.brushing.gravel.complete": "S'ha completat el raspallament de grava",
	"subtitles.item.brush.brushing.sand": "S'està raspallant arena",
	"subtitles.item.brush.brushing.sand.complete": "S'ha completat el raspallament d'arena",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "S'ha recollit un cub de sofre",
	...
	"subtitles.item.bundle.insert_fail": "Saquet ple",
	...
	"subtitles.item.elytra.flying": "Xiulets d'èlitres",
	...
	"subtitles.item.golden_dandelion.unuse": "Un dent de lleó daurat ha començat a envellir",
	"subtitles.item.golden_dandelion.use": "Un dent de lleó daurat ha parat d'envellir",
	...
	"subtitles.item.horse_armor.unequip": "S'ha llevat una armadura per a cavalls",
	"subtitles.item.ink_sac.use": "Un sac de tinta ha tacat",
	"subtitles.item.lead.break": "S'ha trencat un llaç",
	"subtitles.item.lead.tied": "S'ha nugat un llaç",
	"subtitles.item.lead.untied": "S'ha desnugat un llaç",
	"subtitles.item.llama_carpet.unequip": "S'ha llevat una estora",
	"subtitles.item.lodestone_compass.lock": "S'ha fixat la brúixola imantada a l'imant",
	"subtitles.item.mace.smash_air": "Atac de maça",
	"subtitles.item.mace.smash_ground": "Atac de maça",
	"subtitles.item.nautilus_saddle_equip": "S'ha equipat una sella de muntar",
	"subtitles.item.nautilus_saddle_underwater_equip": "S'ha equipat una sella de muntar",
	"subtitles.item.nether_wart.plant": "S'ha plantat una llavor",
	"subtitles.item.ominous_bottle.dispose": "S'ha trencat una botella",
	"subtitles.item.saddle.unequip": "S'ha llevat una sella de muntar",
	"subtitles.item.shears.shear": "Han esclafit unes tisores d'esquilar",
	"subtitles.item.shears.snip": "S'ha tallat un llaç",
	"subtitles.item.shield.block": "S'ha bloquejat un atac amb un escut",
	"subtitles.item.shovel.flatten": "Aplanant amb pala",
	"subtitles.item.spear.attack": "Punxada de llança",
	"subtitles.item.spear.hit": "Colp de llança",
	"subtitles.item.spear.lunge": "Envestida de llança",
	"subtitles.item.spear.use": "Càrrega de llança",
	"subtitles.item.spear_wood.attack": "Punxada de llança",
	"subtitles.item.spear_wood.hit": "Colp de llança",
	"subtitles.item.spear_wood.use": "Càrrega de llança",
	...
	"subtitles.item.underwater_saddle.equip": "S'ha equipat una sella de muntar",
	"subtitles.item.wolf_armor.break": "Una armadura de gos s'ha trencat",
	"subtitles.item.wolf_armor.crack": "Una armadura de gos s'ha clevillat",
	"subtitles.item.wolf_armor.damage": "Una armadura de gos s'ha danyat",
	"subtitles.item.wolf_armor.repair": "Una armadura de gos s'ha reparat",
	"subtitles.particle.soul_escape": "Ànima escapant",
	"subtitles.ui.cartography_table.take_result": "S'ha dibuixat un mapa",
	"subtitles.ui.hud.bubble_pop": "S'acaba l'oxigen",
	"subtitles.ui.loom.take_result": "S'ha utilitzat un teler",
	"subtitles.ui.stonecutter.take_result": "S'ha utilitzat un tallapedra",
	"subtitles.weather.end_flash": "Esclafit de l'End",
	"subtitles.weather.rain": "Està plovent",
	"symlink_warning.message": "Carregar mons des de carpetes amb enllaços simbòlics pot no ser segur si no saps exactament que estàs fent. Visita %s per a aprendre'n més.",
	"symlink_warning.message.pack": "Carregar paquets amb enllaços simbòlics pot no ser segur si no saps exactament què estàs fent. Per favor, visita %s per saber-ne més.",
	"symlink_warning.message.world": "Carregar mons des de carpetes amb enllaços simbòlics pot no ser segur si no saps exactament què estàs fent. Per favor, visita %s per saber-ne més.",
	"symlink_warning.more_info": "Més informació",
	"symlink_warning.title": "La carpeta del món conté enllaços simbòlics",
	"symlink_warning.title.pack": "S'han afegit paquets que contenen enllaços simbòlics",
	"symlink_warning.title.world": "La carpeta del món conté enllaços simbòlics",
	...
	"telemetry.event.advancement_made.description": "Entendre el context després de fer un avanç ens ajuda a entendre millor i millorar la progressió del joc.",
	"telemetry.event.advancement_made.title": "Avanç fet",
	"telemetry.event.game_load_times.description": "Este esdeveniment ens pot ajudar a determinar les millores de rendiment necessàries mesurant el temps d'execució de les diferents fases d'inici.",
	"telemetry.event.game_load_times.title": "Temps de càrrega del joc",
	"telemetry.event.graphics_capabilities.description": "Este esdeveniment ens informa sobre les capacitats del dispositiu gràfic utilitzat per a jugar.",
	"telemetry.event.graphics_capabilities.title": "Capacitats gràfiques",
	"telemetry.event.optional": "%s (opcional)",
	"telemetry.event.optional.disabled": "%s (opcional) - Desactivat",
	"telemetry.event.p2p_connection.description": "Este esdeveniment ajuda a entendre la fiabilitat i el rendiment de les connexions peer-to-peer entre jugadors. Registra si la connexió s’ha establit amb èxit, el tipus de candidat d’Interactive Connectivity Establishment (ICE, el protocol que utilitzem per a establir connexions peer-to-peer) utilitzat i quant de temps ha tardat a establir-se la connexió.",
	"telemetry.event.p2p_connection.title": "Connexió peer-to-peer",
	...
	"telemetry.property.advancement_game_time.title": "Temps de joc (tics)",
	"telemetry.property.advancement_id.title": "ID de l'avanç",
	"telemetry.property.backend_failure_message.title": "Missatge de fallada en la creació del backend",
	"telemetry.property.backend_failure_missing_capabilities.title": "Fallada en la creació del backend per falta de capacitats",
	"telemetry.property.backend_failure_reason.title": "Raó de la fallada en la creació del backend",
	"telemetry.property.backend_name.title": "Nom del backend",
	...
	"telemetry.property.launcher_name.title": "Nom del llançador",
	"telemetry.property.load_time_bootstrap_ms.title": "Temps de càrrega (mil·lisegons)",
	"telemetry.property.load_time_loading_overlay_ms.title": "Temps en pantalla de càrrega (mil·lisegons)",
	"telemetry.property.load_time_pre_window_ms.title": "Temps abans que s'òbriga la finestra (mil·lisegons)",
	"telemetry.property.load_time_total_time_ms.title": "Temps total de càrrega (mil·lisegons)",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "Etapa de fallada",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Temps de connexió d’Interactive Connectivity Establishment (ICE) (mil·lisegons)",
	"telemetry.property.p2p_connection_ice_path.title": "Ruta d’Interactive Connectivity Establishment (ICE)",
	"telemetry.property.p2p_connection_local_candidate_type.title": "Tipus de candidat local",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Tipus de candidat remot",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Temps de connexió de senyalització (mil·lisegons)",
	"telemetry.property.p2p_connection_successful.title": "Connexió establida correctament",
	"telemetry.property.p2p_connection_total_time_ms.title": "Temps total de connexió (mil·lisegons)",
	"telemetry.property.platform.title": "Plataforma",
	"telemetry.property.realms_map_content.title": "Contingut del mapa de Realms (nom del minijoc)",
	...
	"telemetry.property.ticks_since_load.title": "Temps des de la càrrega (tics)",
	...
	"telemetry_info.button.privacy_statement": "Declaració de privacitat",
	"telemetry_info.button.show_data": "Obri les meues dades",
	"telemetry_info.opt_in.description": "Consentisc l'enviament de dades de telemetria opcionals",
	...
	"test.error.block_property_mismatch": "La propietat %s que havia de ser %s, ha resultat ser %s",
	"test.error.block_property_missing": "Falta una propietat del bloc. S'esperava que la propietat %s fora %s",
	"test.error.entity_property": "L'entitat %s ha fallat la prova: %s",
	"test.error.entity_property_details": "Ha fallat el test de l'entitat %s: %s. S'esperava %s i ha sigut %s",
	"test.error.expected_block": "S'esperava el bloc %s. S'ha obtingut %s",
	"test.error.expected_block_present": "S'esperava el bloc %s",
	"test.error.expected_block_tag": "S'esperava el bloc en #%s. S'ha obtingut %s",
	"test.error.expected_container_contents": "El contenidor hauria de tindre %s",
	"test.error.expected_container_contents_single": "El contenidor hauria de tindre un %s simple",
	"test.error.expected_empty_container": "El contenidor hauria d'estar buit",
	"test.error.expected_entity": "S'esperava %s",
	"test.error.expected_entity_around": "S'esperava %s per existir al voltant de %s, %s, %s",
	"test.error.expected_entity_count": "S'esperaven %s entitats del tipus %s. S'han trobat %s",
	"test.error.expected_entity_data": "S'esperava que les dades de l'entitat foren %s. Han sigut %s",
	"test.error.expected_entity_data_predicate": "Les dades de l'entitat no coincidixen per a %s",
	"test.error.expected_entity_effect": "S'esperava que %s tinguera l'efecte %s %s",
	"test.error.expected_entity_having": "L'inventari de l'entitat hauria de tindre %s",
	"test.error.expected_entity_holding": "L'entitat hauria d'estar subjectant %s",
	"test.error.expected_entity_in_test": "S'esperava que %s existira al test",
	"test.error.expected_entity_not_touching": "No s'esperava que %s estiguera tocant %s, %s, %s (relatiu: %s, %s, %s)",
	"test.error.expected_entity_touching": "S'esperava que %s estiguera tocant %s, %s, %s (relatiu: %s, %s, %s)",
	"test.error.expected_item": "S'esperava un objecte del tipus %s",
	"test.error.expected_items_count": "S'esperaven %s objectes del tipus %s. S'han trobat %s",
	"test.error.fail": "S'han complit les condicions de fallada",
	"test.error.invalid_block_type": "S'ha trobat un tipus de bloc no esperat: %s",
	"test.error.missing_block_entity": "Falta un bloc-entitat",
	"test.error.not_a_block_item": "El bloc indicat no és un element de bloc",
	"test.error.position": "%s en %s, %s, %s (relatiu: %s, %s, %s) al tic %s",
	"test.error.sequence.condition_already_triggered": "Condició ja activada en %s",
	"test.error.sequence.condition_not_triggered": "La condició no està activada",
	"test.error.sequence.invalid_tick": "Èxit en tic no vàlid: s'esperava %s",
	"test.error.sequence.minimum_tick": "Èxit abans del tic esperat: s'esperava esperar %s",
	"test.error.sequence.not_completed": "S'ha acabat el temps del test abans que la seqüència es completara",
	"test.error.set_biome": "Error en establir el bioma per al test",
	"test.error.spawn_failure": "Error en crear l'entitat %s",
	"test.error.state_not_equal": "Estat incorrecte. S'esperava %s. Ha sigut %s",
	"test.error.structure.failure": "No s'ha pogut col·locar l'estructura de prova per a %s",
	"test.error.tick": "%s el tic %s",
	"test.error.ticking_without_structure": "Verificant prova abans de col·locar l'estructura",
	"test.error.timeout.no_result": "Sense èxit, o fracàs, entre %s tics",
	"test.error.timeout.no_sequences_finished": "No ha finalitzat cap seqüència en %s tics",
	"test.error.too_many_entities": "S'esperava només un %s existent al voltant de %s, %s, %s, però s'han trobat %s",
	"test.error.unexpected_block": "No s'esperava un bloc en %s",
	"test.error.unexpected_entity": "No s'esperava que %s existira",
	"test.error.unexpected_item": "No s'esperava un objecte del tipus %s",
	"test.error.unknown": "Error intern desconegut: %s",
	"test.error.value_not_equal": "S'esperava que %s fora %s. Ha sigut %s",
	"test.error.value_not_in_between": "S’esperava que %s estiguera entre %s i %s: estava en %s",
	"test.error.wrong_block_entity": "Tipus de bloc-entitat incorrecte: %s",
	"test_block.error.missing": "A l'estructura de prova li falta el bloc %s",
	"test_block.error.too_many": "Massa %s blocs",
	"test_block.invalid_timeout": "Temps de pausa invàlid (%s) - ha de ser un número de tics positiu",
	"test_block.message": "Missatge:",
	"test_block.mode.accept": "Acceptació",
	"test_block.mode.fail": "Fallida",
	"test_block.mode.log": "Registre",
	"test_block.mode.start": "Inici",
	"test_block.mode_info.accept": "Mode d'acceptació - quan accepta l'èxit d'una prova (o part d'esta)",
	"test_block.mode_info.fail": "Mode fallida - quan la prova falla",
	"test_block.mode_info.log": "Mode registre - registra un missatge",
	"test_block.mode_info.start": "Mode inici - el punt de partida d'una prova",
	"test_instance.action.reset": "Restablix i carrega",
	"test_instance.action.run": "Carrega i executa",
	"test_instance.action.save": "Guarda l'estructura",
	"test_instance.description.batch": "Ambient: %s",
	"test_instance.description.failed": "Ha fallat: %s",
	"test_instance.description.function": "Funció: %s",
	"test_instance.description.invalid_id": "ID de prova invàlid",
	"test_instance.description.no_test": "No hi ha cap prova",
	"test_instance.description.structure": "Estructura: %s",
	"test_instance.description.type": "Tipus: %s",
	"test_instance.type.block_based": "Prova basada en blocs",
	"test_instance.type.function": "Prova de funció integrada",
	"test_instance_block.entities": "Entitats:",
	"test_instance_block.error.no_test": "No s'ha pogut executar la instància de prova a %s, %s, %s perquè té una prova sense definir",
	"test_instance_block.error.no_test_structure": "No es pot executar la instància de prova en %s, %s, %s perquè no conté cap estructura de prova",
	"test_instance_block.error.unable_to_save": "No s'ha pogut guardar la plantilla de l'estructura de prova per a la instància de prova a %s, %s, %s",
	"test_instance_block.invalid": "[invàlid]",
	"test_instance_block.reset_success": "S'ha reiniciat amb èxit la prova: %s",
	"test_instance_block.rotation": "Rotació:",
	"test_instance_block.size": "Prova de grandària d'estructura",
	"test_instance_block.starting": "Iniciant prova %s",
	"test_instance_block.test_id": "ID d'instància de prova",
	...
	"title.credits": "Copyright Mojang AB. No ho distribuïsques!",
	...
	"title.multiplayer.disabled.banned.name": "Has de canviar-te el nom abans de poder jugar en línia",
	...
	"title.multiplayer.online": "Multijugador (en línia)",
	...
	"trim_material.minecraft.amethyst": "Material d'ametista",
	"trim_material.minecraft.copper": "Material de coure",
	"trim_material.minecraft.diamond": "Material de diamant",
	"trim_material.minecraft.emerald": "Material de maragda",
	"trim_material.minecraft.gold": "Material d'or",
	"trim_material.minecraft.iron": "Material de ferro",
	"trim_material.minecraft.lapis": "Material de lapislàtzuli",
	"trim_material.minecraft.netherite": "Material de netherita",
	"trim_material.minecraft.quartz": "Material de quars",
	"trim_material.minecraft.redstone": "Material de redstone",
	"trim_material.minecraft.resin": "Material de resina",
	"trim_pattern.minecraft.bolt": "Disseny d'armadura de llamp",
	"trim_pattern.minecraft.coast": "Disseny d'armadura de costa",
	"trim_pattern.minecraft.dune": "Disseny d'armadura de duna",
	"trim_pattern.minecraft.eye": "Disseny d'armadura d'ull",
	"trim_pattern.minecraft.flow": "Disseny d'armadura de flux",
	"trim_pattern.minecraft.host": "Disseny d'armadura d'hostatge",
	"trim_pattern.minecraft.raiser": "Disseny d'armadura d'elevació",
	"trim_pattern.minecraft.rib": "Disseny d'armadura d’os",
	"trim_pattern.minecraft.sentry": "Disseny d'armadura de sentinella",
	"trim_pattern.minecraft.shaper": "Disseny d'armadura de forma",
	"trim_pattern.minecraft.silence": "Disseny d'armadura del silenci",
	"trim_pattern.minecraft.snout": "Disseny d'armadura de morro",
	"trim_pattern.minecraft.spire": "Disseny d'armadura de cúpula",
	"trim_pattern.minecraft.tide": "Disseny d'armadura de marea",
	"trim_pattern.minecraft.vex": "Disseny d'armadura d'esperit",
	"trim_pattern.minecraft.ward": "Disseny d'armadura de guardià",
	"trim_pattern.minecraft.wayfinder": "Disseny d'armadura d'explorador",
	"trim_pattern.minecraft.wild": "Disseny d'armadura salvatge",
	...
	"upgradeWorld.aborted.message": "Això pot passar si un altre programa va accedir al món durant l'actualització.\nReinicia l'ordinador i torna-ho a provar. Si el problema persistix, considera informar de l'error.",
	"upgradeWorld.aborted.reportBug": "Informa d'un error",
	"upgradeWorld.aborted.title": "Error en actualitzar el món",
	"upgradeWorld.canceled.message": "El teu món roman com estava abans.",
	"upgradeWorld.canceled.title": "S'ha cancel·lat l'actualització del món",
	"upgradeWorld.done": "S'ha completat l'actualització del món",
	"upgradeWorld.failed_cleanup.message": "El món s'ha actualitzat correctament a la versió actual i ara està disponible a la llista de mons.\nHem tingut problemes en netejar les dades antigues, per la qual cosa el nom de la carpeta del món ha canviat a %s.",
	"upgradeWorld.failed_cleanup.title": "El món s'ha actualitzat correctament",
	"upgradeWorld.info.converted": "Actualitzat: %s",
	"upgradeWorld.info.file_fix_stage": "Etapa: %s/%s",
	"upgradeWorld.info.scanning": "Escanejant els fitxers...",
	"upgradeWorld.info.total": "Total: %s",
	"upgradeWorld.joinNow": "Vols unir-te al món ara?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Movent els fitxers",
	"upgradeWorld.progress.type.legacy_structures": "Actualitzant les estructures heretades",
	"upgradeWorld.progress.type.region": "Actualitzant les regions",
	"upgradeWorld.symlink.message": "El món seleccionat conté enllaços simbòlics.\nEls passos necessaris per a actualitzar el món a la versió actual no admeten l'ús d'enllaços simbòlics. Per a poder actualitzar el món, primer cal resoldre estos enllaços.",
	"upgradeWorld.symlink.title": "No es pot actualitzar el món",
	"upgradeWorld.title": "Actualitzant els fitxers del món",
}
