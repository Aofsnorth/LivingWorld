// Code generated by tools/gen_lang.go from 26.1/fur_it.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Impostazions acès facilitât...",
	"accessibility.onboarding.accessibility.button.narration": "Impostazions acès facilitât",
	...
	"advMode.notEnabled.spawner": "I gjeneradôrs no son abilitâts",
	"advMode.previousOutput": "Esit precedent",
	"advMode.setCommand": "Stabilìs il comant de console pal bloc",
	"advMode.setCommand.disabled": "Comant assegnât: %s (i blocs comants no son abilitâts)",
	...
	"advancements.adventure.avoid_vibration.description": "Sbassiti dongje di un sensôr di Sculk o di une vuardie par no fâti sintî",
	...
	"advancements.adventure.brush_armadillo.title": "Disarmadil",
	...
	"advancements.adventure.crafters_crafting_crafters.description": "Cjatiti dongje di un fabricadôr cuant che al fabriche un fabricadôr",
	"advancements.adventure.crafters_crafting_crafters.title": "Fabricadôrs a fabrichin fabricadôrs",
	"advancements.adventure.fall_from_world_height.description": "Butiti jù de cime dal mont (limit di costruzion) fin tal pont plui bas dal mont cence murî",
	"advancements.adventure.fall_from_world_height.title": "Landris e scoieris",
	"advancements.adventure.heart_transplanter.description": "Met un cûr dal cric, cul inlineament just, jenfri doi blocs di tronc di rôl palit",
	"advancements.adventure.heart_transplanter.title": "Traplant di cûr",
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Cope une creature dongje di un catalizadôr di Sculk",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Jentre intune stanzie de prove",
	"advancements.adventure.minecraft_trials_edition.title": "Sfide acetade!",
	...
	"advancements.adventure.revaulting.description": "Sbloche une cassefuarte dal malauguri cuntune clâf de prove dal malauguri",
	"advancements.adventure.revaulting.title": "Fracassefuarte",
	...
	"advancements.adventure.spear_many_mobs.description": "Colpìs cinc creaturis cuntun sôl atac cjariât di lance",
	"advancements.adventure.spear_many_mobs.title": "Spêt mostruôs",
	...
	"advancements.adventure.under_lock_and_key.description": "Dopre une clâf de prove su di une cassefuarte",
	"advancements.adventure.under_lock_and_key.title": "Sot clâf",
	"advancements.adventure.use_lodestone.description": "Dopre une bussule suntun bloc di magnetite",
	"advancements.adventure.use_lodestone.title": "Bussule magnetizade, direzion sigurade",
	...
	"advancements.adventure.who_needs_rockets.title": "Cui aial dibisugne des fusetis?",
	...
	"advancements.end.kill_dragon.description": "Buine fortune",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Fâs in mût che un slizeridôr al moli une torte su di un bloc sonôr",
	"advancements.husbandry.allay_deliver_cake_to_note_block.title": "Bon complean!",
	"advancements.husbandry.allay_deliver_item_to_player.description": "Fâti puartâ un ogjet di un slizeridôr",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Met un bloc di Ghast secjât inte aghe",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Ben idratât!",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Gjave la armadure di un lôf doprant lis fuarpiis",
	"advancements.husbandry.remove_wolf_armor.title": "A la mode",
	...
	"advancements.husbandry.uh_oh.description": "Fâs asorbî un bloc di TNT di un cubi di solfar",
	...
	"advancements.husbandry.whole_pack.title": "Dut il trop",
	...
	"advancements.nether.loot_bastion.description": "Svalise un baûl dentri di un bastion in ruvine",
	...
	"argument.entity.selector.nearestEntity": "Entitât plui vicine",
	...
	"argument.hexcolor.invalid": "Codiç di colôr esadecimâl '%s' no valit",
	...
	"argument.message.too_long": "Messaç de chat masse lunc (%s > %s caratars massims)",
	"argument.nbt.array.invalid": "Gjenar di array '%s' no valit",
	"argument.nbt.array.mixed": "Impussibil inserî %s in %s",
	"argument.nbt.expected.compound": "Si spietave une etichete componude",
	...
	"argument.resource_or_id.invalid": "ID o etichete no valits",
	"argument.resource_or_id.no_such_element": "Impussibil cjatâ l'element '%s' tal regjistri '%s'",
	"argument.resource_selector.not_found": "Nissune corispondence pal seletôr '%s' di gjenar '%s'",
	...
	"argument.waypoint.invalid": "La entitât selezionade no je un pont di riferiment",
	...
	"attribute.name.air_drag_modifier": "Modificadôr di resistence dal aiar",
	"attribute.name.armor": "Ponts di armadure",
	"attribute.name.armor_toughness": "Tignince de armadure",
	"attribute.name.attack_damage": "Dams di atac",
	"attribute.name.attack_knockback": "Cuintricolp dal atac",
	"attribute.name.attack_speed": "Velocitât di atac",
	"attribute.name.below_name_distance": "Distance dai ponts de etichete",
	"attribute.name.block_break_speed": "Velocitât di distruzion di un bloc",
	"attribute.name.block_interaction_range": "Rai di interazion cui blocs",
	"attribute.name.bounciness": "Elasticitât",
	"attribute.name.burning_time": "Timp di combustion",
	"attribute.name.camera_distance": "Distance de incuadradure",
	"attribute.name.entity_interaction_range": "Rai di interazion cun lis entitâts",
	"attribute.name.explosion_knockback_resistance": "Resistence al cuintricolp des esplosions",
	"attribute.name.fall_damage_multiplier": "Moltiplicadôr dai dams pe colade",
	"attribute.name.flying_speed": "Velocitât svolant",
	"attribute.name.follow_range": "Rai di rilevament des creaturis",
	"attribute.name.friction_modifier": "Modificadôr di atrît",
	...
	"attribute.name.generic.burning_time": "Timp di combustion",
	"attribute.name.generic.entity_interaction_range": "Rai di interazion cun lis entitâts",
	"attribute.name.generic.explosion_knockback_resistance": "Resistence al cuintricolp des esplosions",
	...
	"attribute.name.generic.movement_efficiency": "Eficience dal moviment",
	"attribute.name.generic.movement_speed": "Velocitât",
	"attribute.name.generic.oxygen_bonus": "Ossigjen extra",
	"attribute.name.generic.safe_fall_distance": "Altece sigure pe colade",
	"attribute.name.generic.scale": "Scjale",
	"attribute.name.generic.step_height": "Altece dal pas",
	"attribute.name.generic.water_movement_efficiency": "Eficience dal moviment te aghe",
	"attribute.name.gravity": "Gravitât",
	"attribute.name.horse.jump_strength": "Fuarce dal salt dal cjaval",
	"attribute.name.jump_strength": "Fuarce dal salt",
	"attribute.name.knockback_resistance": "Resistence al cuintricolp",
	"attribute.name.luck": "Furtune",
	"attribute.name.max_absorption": "Assorbiment massim",
	"attribute.name.max_health": "Salût massime",
	"attribute.name.mining_efficiency": "Eficience tal sgjavâ",
	"attribute.name.movement_efficiency": "Eficience dal moviment",
	"attribute.name.movement_speed": "Velocitât",
	"attribute.name.nameplate_distance": "Distance de etichete",
	"attribute.name.oxygen_bonus": "Ossigjen extra",
	...
	"attribute.name.player.mining_efficiency": "Eficience tal sgjavâ",
	"attribute.name.player.sneaking_speed": "Velocitât scrufuiât",
	"attribute.name.player.submerged_mining_speed": "Velocitât tal sgjavâ sot aghe",
	"attribute.name.player.sweeping_damage_ratio": "Rapuart di dam dal atac scoreât",
	"attribute.name.safe_fall_distance": "Altece sigure pe colade",
	"attribute.name.scale": "Scjale",
	"attribute.name.sneaking_speed": "Velocitât scrufuiât",
	"attribute.name.spawn_reinforcements": "Rinfuarçs zombi",
	"attribute.name.step_height": "Altece dal pas",
	"attribute.name.submerged_mining_speed": "Velocitât tal sgjavâ sot aghe",
	"attribute.name.sweeping_damage_ratio": "Rapuart di dam dal atac scoreât",
	"attribute.name.tempt_range": "Rai di atrazion des creaturis",
	"attribute.name.water_movement_efficiency": "Eficience dal moviment te aghe",
	"attribute.name.waypoint_receive_range": "Puartade di ricezion dal pont di riferiment",
	"attribute.name.waypoint_transmit_range": "Puartade di trasmission dal pont di riferiment",
	...
	"biome.minecraft.pale_garden": "Zardin palit",
	...
	"biome.minecraft.sulfur_caves": "Grotis di solfar",
	...
	"block.minecraft.acacia_shelf": "Scansie di agacie",
	...
	"block.minecraft.bamboo_shelf": "Scansie di bambù",
	...
	"block.minecraft.banner.flow.black": "Flus neri",
	"block.minecraft.banner.flow.blue": "Flus blu",
	"block.minecraft.banner.flow.brown": "Flus maron",
	"block.minecraft.banner.flow.cyan": "Flus ciano",
	"block.minecraft.banner.flow.gray": "Flus grîs",
	"block.minecraft.banner.flow.green": "Flus vert",
	"block.minecraft.banner.flow.light_blue": "Flus blu clâr",
	"block.minecraft.banner.flow.light_gray": "Flus grîs clâr",
	"block.minecraft.banner.flow.lime": "Flus vert limon",
	"block.minecraft.banner.flow.magenta": "Flus magenta",
	"block.minecraft.banner.flow.orange": "Flus naranç",
	"block.minecraft.banner.flow.pink": "Flus rose",
	"block.minecraft.banner.flow.purple": "Flus viole",
	"block.minecraft.banner.flow.red": "Flus ros",
	"block.minecraft.banner.flow.white": "Flus blanc",
	"block.minecraft.banner.flow.yellow": "Flus zâl",
	...
	"block.minecraft.banner.guster.black": "Bugade nere",
	"block.minecraft.banner.guster.blue": "Bugade blu",
	"block.minecraft.banner.guster.brown": "Bugade maron",
	"block.minecraft.banner.guster.cyan": "Bugade ciano",
	"block.minecraft.banner.guster.gray": "Bugade grise",
	"block.minecraft.banner.guster.green": "Bugade verde",
	"block.minecraft.banner.guster.light_blue": "Bugade blu clâr",
	"block.minecraft.banner.guster.light_gray": "Bugade grîs clâr",
	"block.minecraft.banner.guster.lime": "Bugade vert limon",
	"block.minecraft.banner.guster.magenta": "Bugade magenta",
	"block.minecraft.banner.guster.orange": "Bugade naranç",
	"block.minecraft.banner.guster.pink": "Bugade rose",
	"block.minecraft.banner.guster.purple": "Bugade viole",
	"block.minecraft.banner.guster.red": "Bugade rosse",
	"block.minecraft.banner.guster.white": "Bugade blancje",
	"block.minecraft.banner.guster.yellow": "Bugade zale",
	...
	"block.minecraft.birch_shelf": "Scansie di bedoi",
	...
	"block.minecraft.bush": "Baraç",
	"block.minecraft.cactus": "Cactus",
	"block.minecraft.cactus_flower": "Rose di cactus",
	...
	"block.minecraft.cherry_shelf": "Scansie di cjariesâr",
	...
	"block.minecraft.chiseled_cinnabar": "Cinabro ceselât",
	...
	"block.minecraft.cinnabar_brick_slab": "Lastre di modons di cinabro",
	"block.minecraft.cinnabar_brick_stairs": "Scjalins di modons di cinabro",
	"block.minecraft.cinnabar_brick_wall": "Muret di modons di cinabro",
	"block.minecraft.cinnabar_bricks": "Modons di cinabro",
	"block.minecraft.cinnabar_slab": "Lastre di cinabro",
	"block.minecraft.cinnabar_stairs": "Scjalins di cinabro",
	"block.minecraft.cinnabar_wall": "Muret di cinabro",
	"block.minecraft.clay": "Arzile",
	"block.minecraft.closed_eyeblossom": "Rose-voli sierade",
	...
	"block.minecraft.copper_bars": "Sbaris di ram",
	"block.minecraft.copper_block": "Bloc di ram",
	"block.minecraft.copper_bulb": "Lampade di ram",
	"block.minecraft.copper_chain": "Cjadene di ram",
	"block.minecraft.copper_chest": "Baûl di ram",
	"block.minecraft.copper_door": "Puarte di ram",
	"block.minecraft.copper_golem_statue": "Statue di golem di ram",
	"block.minecraft.copper_grate": "Grade di ram",
	"block.minecraft.copper_lantern": "Ferâl di ram",
	"block.minecraft.copper_ore": "Minerâl di ram",
	"block.minecraft.copper_torch": "Torce di ram",
	"block.minecraft.copper_trapdoor": "Trabuchel di ram",
	"block.minecraft.copper_wall_torch": "Torce di ram di parêt",
	...
	"block.minecraft.creaking_heart": "Cûr dal cric",
	...
	"block.minecraft.crimson_shelf": "Scansie cremisine",
	...
	"block.minecraft.dark_oak_shelf": "Scansie di rôl scûr",
	...
	"block.minecraft.dried_ghast": "Ghast secjât",
	...
	"block.minecraft.exposed_copper_bars": "Sbaris di ram esponudis",
	"block.minecraft.exposed_copper_bulb": "Lampade di ram esponude",
	"block.minecraft.exposed_copper_chain": "Cjadene di ram esponude",
	"block.minecraft.exposed_copper_chest": "Baûl di ram esponût",
	"block.minecraft.exposed_copper_door": "Puarte di ram esponude",
	"block.minecraft.exposed_copper_golem_statue": "Statue di golem di ram esponude",
	"block.minecraft.exposed_copper_grate": "Grade di ram esponude",
	"block.minecraft.exposed_copper_lantern": "Ferâl di ram esponût",
	...
	"block.minecraft.exposed_lightning_rod": "Paresaetis esponût",
	...
	"block.minecraft.firefly_bush": "Baraç di lusignis",
	...
	"block.minecraft.golden_dandelion": "Tale dorade",
	...
	"block.minecraft.iron_chain": "Cjadene di fier",
	...
	"block.minecraft.jungle_shelf": "Scansie di len di jungle",
	...
	"block.minecraft.leaf_litter": "Grum di fueis",
	...
	"block.minecraft.mangrove_shelf": "Scansie di mangrovie",
	...
	"block.minecraft.oak_shelf": "Scansie di rôl",
	...
	"block.minecraft.open_eyeblossom": "Rose-voli vierte",
	...
	"block.minecraft.oxidized_copper_bars": "Sbaris di ram ossidadis",
	"block.minecraft.oxidized_copper_bulb": "Lampade di ram ossidade",
	"block.minecraft.oxidized_copper_chain": "Cjadene di ram ossidade",
	"block.minecraft.oxidized_copper_chest": "Baûl di ram ossidât",
	"block.minecraft.oxidized_copper_door": "Puarte di ram ossidade",
	"block.minecraft.oxidized_copper_golem_statue": "Statue di golem di ram ossidade",
	"block.minecraft.oxidized_copper_grate": "Grade di ram ossidade",
	"block.minecraft.oxidized_copper_lantern": "Ferâl di ram ossidât",
	...
	"block.minecraft.oxidized_lightning_rod": "Paresaetis ossidât",
	"block.minecraft.packed_ice": "Glaç pressât",
	"block.minecraft.packed_mud": "Pantan penç",
	"block.minecraft.pale_hanging_moss": "Muscli palit che al pendule",
	"block.minecraft.pale_moss_block": "Bloc di muscli palit",
	"block.minecraft.pale_moss_carpet": "Tapêt di muscli palit",
	"block.minecraft.pale_oak_button": "Boton di rôl palit",
	"block.minecraft.pale_oak_door": "Puarte di rôl palit",
	"block.minecraft.pale_oak_fence": "Stangjaçade di rôl palit",
	"block.minecraft.pale_oak_fence_gate": "Portonut di rôl palit",
	"block.minecraft.pale_oak_hanging_sign": "Insegne di rôl palit",
	"block.minecraft.pale_oak_leaves": "Fueis di rôl palit",
	"block.minecraft.pale_oak_log": "Tronc di rôl palit",
	"block.minecraft.pale_oak_planks": "Breis di rôl palit",
	"block.minecraft.pale_oak_pressure_plate": "Plache di pression di rôl palit",
	"block.minecraft.pale_oak_sapling": "Arbossit di rôl palit",
	"block.minecraft.pale_oak_shelf": "Scansie di rôl palit",
	"block.minecraft.pale_oak_sign": "Cartel di rôl palit",
	"block.minecraft.pale_oak_slab": "Lastre di rôl palit",
	"block.minecraft.pale_oak_stairs": "Scjalins di rôl palit",
	"block.minecraft.pale_oak_trapdoor": "Trabuchel di rôl palit",
	"block.minecraft.pale_oak_wall_hanging_sign": "Insegne di parêt di rôl palit",
	"block.minecraft.pale_oak_wall_sign": "Targhe di parêt di rôl palit",
	"block.minecraft.pale_oak_wood": "Len di rôl palit",
	...
	"block.minecraft.polished_cinnabar": "Cinabro lustrât",
	"block.minecraft.polished_cinnabar_slab": "Lastre di cinabro lustrât",
	"block.minecraft.polished_cinnabar_stairs": "Scjalins di cinabro lustrât",
	"block.minecraft.polished_cinnabar_wall": "Muret di cinabro lustrât",
	...
	"block.minecraft.polished_sulfur": "Solfar lustrât",
	"block.minecraft.polished_sulfur_slab": "Lastre di solfar lustrât",
	"block.minecraft.polished_sulfur_stairs": "Scjalins di solfar lustrât",
	"block.minecraft.polished_sulfur_wall": "Muret di solfar lustrât",
	...
	"block.minecraft.potent_sulfur": "Solfar concentrât",
	...
	"block.minecraft.potted_closed_eyeblossom": "Rose-voli sierade in vâs",
	...
	"block.minecraft.potted_golden_dandelion": "Tale dorade in vâs",
	...
	"block.minecraft.potted_open_eyeblossom": "Rose-voli vierte in vâs",
	"block.minecraft.potted_orange_tulip": "Tulipan naranç in vâs",
	"block.minecraft.potted_oxeye_daisy": "Margherite in vâs",
	"block.minecraft.potted_pale_oak_sapling": "Arbossit di rôl palit in vâs",
	...
	"block.minecraft.resin_block": "Bloc di resine",
	"block.minecraft.resin_brick_slab": "Lastre di modons di resine",
	"block.minecraft.resin_brick_stairs": "Scjalins di modons di resine",
	"block.minecraft.resin_brick_wall": "Muret di modons di resine",
	"block.minecraft.resin_bricks": "Modons di resine",
	"block.minecraft.resin_clump": "Grop di resine",
	...
	"block.minecraft.short_dry_grass": "Jerbe secje basse",
	...
	"block.minecraft.spruce_shelf": "Scansie di peç",
	...
	"block.minecraft.stripped_cherry_log": "Tronc di cjariesâr spelât",
	...
	"block.minecraft.stripped_pale_oak_log": "Tronc di rôl palit spelât",
	"block.minecraft.stripped_pale_oak_wood": "Len di rôl palit spelât",
	...
	"block.minecraft.sulfur": "Solfar",
	"block.minecraft.sulfur_brick_slab": "Lastre di modons di solfar",
	"block.minecraft.sulfur_brick_stairs": "Scjalins di modons di solfar",
	"block.minecraft.sulfur_brick_wall": "Muret di modons di solfar",
	"block.minecraft.sulfur_bricks": "Modons di solfar",
	"block.minecraft.sulfur_slab": "Lastre di solfar",
	"block.minecraft.sulfur_spike": "Pic di solfar",
	"block.minecraft.sulfur_stairs": "Scjalins di solfar",
	"block.minecraft.sulfur_wall": "Muret di solfar",
	...
	"block.minecraft.tall_dry_grass": "Jerbe secje alte",
	...
	"block.minecraft.test_block": "Bloc di prove",
	"block.minecraft.test_instance_block": "Bloc di istance di prove",
	"block.minecraft.tinted_glass": "Veri scurît",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "Lis esplosions di TNT a son disativadis",
	...
	"block.minecraft.warped_shelf": "Scansie disnaturade",
	...
	"block.minecraft.waxed_copper_bars": "Sbaris di ram inceradis",
	"block.minecraft.waxed_copper_block": "Bloc incerât di ram",
	"block.minecraft.waxed_copper_bulb": "Lampade di ram incerade",
	"block.minecraft.waxed_copper_chain": "Cjadene di ram incerade",
	"block.minecraft.waxed_copper_chest": "Baûl di ram incerât",
	"block.minecraft.waxed_copper_door": "Puarte di ram incerade",
	"block.minecraft.waxed_copper_golem_statue": "Statue di golem di ram incerade",
	"block.minecraft.waxed_copper_grate": "Grade di ram incerade",
	"block.minecraft.waxed_copper_lantern": "Ferâl di ram incerât",
	...
	"block.minecraft.waxed_exposed_copper_bars": "Sbaris di ram esponudis inceradis",
	"block.minecraft.waxed_exposed_copper_bulb": "Lampade di ram esponude incerade",
	"block.minecraft.waxed_exposed_copper_chain": "Cjadene di ram esponude incerade",
	"block.minecraft.waxed_exposed_copper_chest": "Baûl di ram esponût incerât",
	"block.minecraft.waxed_exposed_copper_door": "Puarte di ram esponude incerade",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Statue di golem di ram esponude incerade",
	"block.minecraft.waxed_exposed_copper_grate": "Grade di ram esponude incerade",
	"block.minecraft.waxed_exposed_copper_lantern": "Ferâl di ram esponût incerât",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Paresaetis esponût incerât",
	"block.minecraft.waxed_lightning_rod": "Paresaetis incerât",
	...
	"block.minecraft.waxed_oxidized_copper_bars": "Sbaris di ram ossidadis inceradis",
	"block.minecraft.waxed_oxidized_copper_bulb": "Lampade di ram ossidade incerade",
	"block.minecraft.waxed_oxidized_copper_chain": "Cjadene di ram ossidade incerade",
	"block.minecraft.waxed_oxidized_copper_chest": "Baûl di ram ossidât incerât",
	"block.minecraft.waxed_oxidized_copper_door": "Puarte di ram ossidade incerade",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Statue di golem di ram ossidade incerade",
	"block.minecraft.waxed_oxidized_copper_grate": "Grade di ram ossidade incerade",
	"block.minecraft.waxed_oxidized_copper_lantern": "Ferâl di ram ossidât incerât",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Paresaetis ossidât incerât",
	...
	"block.minecraft.waxed_weathered_copper_bars": "Sbaris di ram corotis inceradis",
	"block.minecraft.waxed_weathered_copper_bulb": "Lampade di ram corote incerade",
	"block.minecraft.waxed_weathered_copper_chain": "Cjadene di ram corote incerade",
	"block.minecraft.waxed_weathered_copper_chest": "Baûl di ram corot incerât",
	"block.minecraft.waxed_weathered_copper_door": "Puarte di ram corote incerade",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Statue di golem di ram corote incerade",
	"block.minecraft.waxed_weathered_copper_grate": "Grade di ram corote incerade",
	"block.minecraft.waxed_weathered_copper_lantern": "Ferâl di ram corot incerât",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Paresaetis corot incerât",
	"block.minecraft.weathered_chiseled_copper": "Ram ceselât corot",
	"block.minecraft.weathered_copper": "Ram corot",
	"block.minecraft.weathered_copper_bars": "Sbaris di ram corotis",
	"block.minecraft.weathered_copper_bulb": "Lampade di ram corote",
	"block.minecraft.weathered_copper_chain": "Cjadene di ram corote",
	"block.minecraft.weathered_copper_chest": "Baûl di ram corot",
	"block.minecraft.weathered_copper_door": "Puarte di ram corote",
	"block.minecraft.weathered_copper_golem_statue": "Statue di golem di ram corote",
	"block.minecraft.weathered_copper_grate": "Grade di ram corote",
	"block.minecraft.weathered_copper_lantern": "Ferâl di ram corot",
	...
	"block.minecraft.weathered_lightning_rod": "Paresaetis corot",
	...
	"block.minecraft.wildflowers": "Rosis salvadis",
	...
	"book.edit.title": "Videade di modifiche dal libri",
	...
	"book.page_button.next": "Pagjine sucessive",
	"book.page_button.previous": "Pagjine precedente",
	"book.sign.title": "Videade di firme dal libri",
	"book.sign.titlebox": "Titul",
	"book.signButton": "Firme",
	"book.view.title": "Videade dal libri",
	"build.spawn_protection": "%s al è sot la protezion dal pont di nassite",
	"build.tooHigh": "Il limit di altece pes construzions al è di %s",
	"build.tooLow": "Il limit minim di altece pes construzions al è di %s",
	...
	"chat.disabled.invalid_command_signature": "Lis firmis dal argoment dal comant a mancjin opûr no son validis.",
	"chat.disabled.invalid_signature": "Firme de chat no valide. Torne a provâ a conetiti.",
	...
	"chat.disabled.out_of_order_chat": "Pachets de chat fûr ordin. Ise stade modificade la ore dal to sisteme?",
	"chat.disabled.profile": "La chat no je abilitade da lis impostazions dal to account. Frache \"%s\" di gnûf par viodi plui informazions.",
	"chat.disabled.profile.moreInfo": "La chat no je abilitade da lis impostazions dal to account. Impussibil inviâ o viodi i messaçs.",
	"chat.editBox": "chat",
	"chat.filtered": "Filtrât dal servidôr.",
	"chat.filtered_full": "Il servidôr al à platât il to messaç par cualchi zuiadôr.",
	...
	"chat.queue": "[+%s rie(is) in spiete]",
	"chat.queue.tooltip": "Fâs clic par mostrâ il messaç sucessif",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "Il servidôr al à inviât un messaç no valit.",
	"chat.tag.modified": "Messaç modificât dal servidôr. Origjinâl:",
	"chat.tag.not_secure": "Messaç no verificât. Impussibil segnalâ.",
	"chat.tag.system": "Messaç dal servidôr. Impussibil segnalâ.",
	...
	"chat_restriction.chat_and_commands_disabled_by_options": "Chat limitade tes opzions dal client.",
	"chat_restriction.chat_disabled_by_options": "Chat cui zuiadôrs limitade tes impostazions dal client.",
	"chat_restriction.chat_disabled_by_options.action": "Va as opzions de chat",
	"chat_restriction.disabled_by_launcher": "Chat limitade dal inviadôr",
	"chat_restriction.disabled_by_profile": "Chat limitade das impostazions dal profîl.",
	"chat_restriction.disabled_by_profile.action": "Va as impostazions dal tô profîl",
	"chat_screen.commands_not_allowed": "Inviâ comants nol è permetût",
	"chat_screen.message": "Messaç di inviâ: %s",
	"chat_screen.messages_not_allowed": "Inviâ messaçs de chat nol è permetût",
	"chat_screen.restricted": "Chat limitade. Fâs clic achì par plui detais.",
	"chat_screen.restricted.narration": "Chat limitade. Va ae videade das limitazions tas opzions dal mont.",
	"chat_screen.title": "Videade de chat",
	"chat_screen.usage": "Scrîf un messaç e frache Invie par inviâlu",
	"chunk.toast.checkLog": "Cjale il regjistri par vê plui detais",
	...
	"command.forkLimit": "Rivâts al numar massim di contescj (%s)",
	"command.trailing_data": "Dâts in code rilevâts: %s",
	...
	"commands.attribute.base_value.reset.success": "Il valôr base dal atribût %s de entitât %s al è stât ripristinât al valôr predefinît %s",
	...
	"commands.banlist.entry": "%[2]s al/e à bandît %[1]s: %[3]s",
	...
	"commands.data.modify.expected_value": "Al jere previodût un valôr, si à vût: %s",
	...
	"commands.datapack.create.already_exists": "Il pachet cul non '%s' al esist za",
	"commands.datapack.create.invalid_full_name": "Gnûf non dal pachet '%s' no valit",
	"commands.datapack.create.invalid_name": "Caratars no valits tal gnûf non dal pachet '%s'",
	"commands.datapack.create.io_failure": "Impussibil creâ il pachet cul non '%s', controle i regjstris",
	"commands.datapack.create.metadata_encode_failure": "Impussibil codificâ i metadâts pal pachet cul non '%s': %s",
	"commands.datapack.create.success": "Al è stât creât un gnûf pachet vueit cul non '%s'",
	"commands.datapack.disable.failed": "Il pachet '%s' nol è abilitât!",
	"commands.datapack.disable.failed.feature": "Nol è pussibil disabilitâ il pachet '%s', parcè che al fâs part di une variabile abilitade!",
	"commands.datapack.enable.failed": "Il pachet '%s' al è za abilitât!",
	"commands.datapack.enable.failed.no_flags": "Nol è pussibil abilitâ il pachet \"%s\", parcè che lis variabilis necessaris no son abilitadis in chest mont: %s!",
	...
	"commands.debug.function.noRecursion": "Nol è pussibil segnâ di dentri di une funzion",
	"commands.debug.function.noReturnRun": "Nol è pussibil segnâ cun return run",
	...
	"commands.debug.function.traceFailed": "Impussibil sta daûr de funzion",
	...
	"commands.debug.stopped": "La profiladure des ticadis e je stade fermade dopo %s secont(s) e %s ticade(is) (%s ticade(is) par secont)",
	...
	"commands.dialog.clear.multiple": "Il dialic par %s zuiadôrs al è stât scancelât",
	"commands.dialog.clear.single": "Il dialic par %s al è stât scancelât",
	"commands.dialog.show.multiple": "Il dialic al è stât mostrât a %s zuiadôrs",
	"commands.dialog.show.single": "Il dialic al è stât mostrât a %s",
	...
	"commands.drop.no_loot_table.block": "Il bloc %s nol à une tabele dai ogjets",
	...
	"commands.execute.blocks.toobig": "Masse blocs inte aree specificade (massim %s, specificâts %s)",
	...
	"commands.execute.function.instantiationFailure": "Erôr te creazion de funzion %s: %s",
	...
	"commands.fetchprofile.copy_component": "Copie component",
	"commands.fetchprofile.copy_text": "Copie %s",
	"commands.fetchprofile.entity.success": "Profîl risolût pe entitât %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Impussibil serializâ il profîl: %s",
	"commands.fetchprofile.give_item": "Oten ogjet",
	"commands.fetchprofile.id.failure": "Impussibil risolvi un profîl pal ID %s",
	"commands.fetchprofile.id.success": "Profîl risolût pal ID %s: %s",
	"commands.fetchprofile.name.failure": "Impussibil risolvi un profîl pal non %s",
	"commands.fetchprofile.name.success": "Profîl risolût pal non %s: %s",
	"commands.fetchprofile.no_profile": "La entitât %s no à un profîl",
	"commands.fetchprofile.summon_mannequin": "Evoche manichin",
	"commands.fill.failed": "Nol è stât plaçât nissun bloc",
	"commands.fill.success": "%s bloc(s) plaçât(s) cun sucès",
	"commands.fill.toobig": "Masse blocs inte aree specificade (massim %s, specificâts %s)",
	...
	"commands.fillbiome.toobig": "Masse blocs intal volum specificât (massim %s, specificât %s)",
	...
	"commands.function.error.argument_not_compound": "Gjenar di argoment no valit: %s, al jere previodût un valôr componût",
	...
	"commands.function.error.parse": "Te creazion de macro %s: il comant \"%s\" al à causât un erôr: %s",
	"commands.function.instantiationFailure": "Erôr te creazion de funzion %s: %s",
	"commands.function.result": "La funzion %s e à tornât %s",
	"commands.function.scheduled.multiple": "Esecuzion di funzions %s",
	"commands.function.scheduled.no_functions": "Impussibil cjatâ funzions clamadis %s",
	"commands.function.scheduled.single": "Esecuzion de funzion %s",
	...
	"commands.item.source.not_a_container": "La posizion di origjin %s, %s, %s no je un contignidôr",
	"commands.item.target.no_changed.known_item": "Nissun destinatari al à acetât l'ogjet %s tal spazi %s",
	"commands.item.target.no_changes": "Nissun destinatari al à acetât l'ogjet tal spazi %s",
	"commands.item.target.no_such_slot": "Il destinatari nol à il spazi %s",
	"commands.item.target.not_a_container": "La posizion di destinazion %s, %s, %s no je un contignidôr",
	...
	"commands.kick.singleplayer.failed": "Impussibil parâ fûr intun mont fûr rêt in zuiadôr singul",
	...
	"commands.locate.poi.not_found": "Impussibil cjatâ un pont di interès di gjenar \"%s\" a une distance resonevule",
	...
	"commands.perf.started": "Scomençade une profiladure di prestazions di 10 seconts (dopre \"/perf stop\" par fermâle prime)",
	...
	"commands.place.feature.success": "Plaçât \"%s\" a %s, %s, %s",
	"commands.place.jigsaw.failed": "Impussibil gjenerâ il berdei",
	"commands.place.jigsaw.invalid": "Nol esist nissun grup di modei di gjenar \"%s\"",
	...
	"commands.profile_fetch.copy_component": "Copie component",
	"commands.profile_fetch.failed_to_serialize": "Impussibil serializâ il profîl: %s",
	"commands.profile_fetch.give_item": "Oten ogjet",
	"commands.profile_fetch.id.failure": "Impussibil risolvi un profîl pal ID %s",
	"commands.profile_fetch.id.success": "Profîl risolût pal ID %s: %s",
	"commands.profile_fetch.name.failure": "Impussibil risolvi un profîl pal non %s",
	"commands.profile_fetch.name.success": "Profîl risolût pal non %s: %s",
	"commands.publish.alreadyPublished": "La partide multi-zuiadôr e je za ospitade te puarte %s",
	"commands.publish.alreadyPublished.lan": "La partide loacâl e je za ospitade te puarte %s",
	"commands.publish.alreadyPublished.online": "La partide in linie e je za ospitade",
	...
	"commands.publish.started.lan": "La partide locâl e je ospitade te puarte %s",
	"commands.publish.started.online": "Partide in linie ospitade",
	...
	"commands.random.roll": "%s al/e à tirât fûr %s (tra %s e %s)",
	"commands.random.sample.success": "Valôr casuâl: %s",
	"commands.recipe.give.failed": "No je stade imparade nissune ricete",
	"commands.recipe.give.success.multiple": "Sblocade(is) %s ricete(is) par %s zuiadôrs",
	"commands.recipe.give.success.single": "Sblocade(is) %s ricete(is) par %s",
	"commands.recipe.take.failed": "Nol è pussibil dismenteâ lis ricetis",
	"commands.recipe.take.success.multiple": "Gjavade(is) %s ricete(is) di %s zuiadôrs",
	"commands.recipe.take.success.single": "Gjavad(is) %s ricete(is) di %s",
	...
	"commands.ride.already_riding": "%s al/e sta za parsore di %s",
	"commands.ride.dismount.success": "%s al/e à fermât di cjavalgjâ %s",
	"commands.ride.mount.failure.cant_ride_players": "Nol è pussibil montâ parsore dai zuiadôrs",
	"commands.ride.mount.failure.generic": "%s nol/no pues montâ parsore di %s",
	"commands.ride.mount.failure.loop": "Une entitât no pues montâ sore di se stesse o parsore dai siei passizîrs",
	"commands.ride.mount.failure.wrong_dimension": "Nol è pussibil montâ parsore di une entitât intune dimension diferente",
	"commands.ride.mount.success": "%s al/e à scomençât a cjavalgjâ %s",
	"commands.ride.not_riding": "%s nol/no sta su nissun veicul",
	"commands.rotate.success": "Zirât %s",
	...
	"commands.schedule.created.tag": "La etichete '%s' e vignarà eseguide chi di %s ticade(is) (timp di zûc: %s)",
	"commands.schedule.macro": "Impussibil programâ une macro",
	...
	"commands.scoreboard.players.list.entity.success": "%s al/e à %s pont(s):",
	...
	"commands.setidletimeout.success.disabled": "Il timp di inativitât massim pai zuiadôrs al è stât disabilitât",
	"commands.setworldspawn.failure.not_overworld": "Al è pussibil meti il pont di rinassite dome te superficie",
	"commands.setworldspawn.success": "Il pont di gjenerazion/rinassite globâl al è stât metût a %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Il pont di gjenerazion/rinassite globâl al è stât metût a %s, %s, %s [%s, %s] in %s",
	"commands.spawnpoint.success.multiple": "Il pont di rinassite di %[6]s zuiadôrs al è stât metût in %[1]s, %[2]s, %[3]s [%[4]s] te dimension %[5]s",
	"commands.spawnpoint.success.multiple.new": "Il pont di rinassite al è stât metût a %s, %s, %s [%s, %s] in %s par %s zuiadôrs",
	"commands.spawnpoint.success.single": "Il pont di rinassite di %[6]s al è stât metût in %[1]s, %[2]s, %[3]s [%[4]s] te dimension %[5]s",
	"commands.spawnpoint.success.single.new": "Il pont di rinassite al è stât metût a %s, %s, %s [%s, %s] in %s par %s",
	"commands.spectate.cannot_spectate": "No tu puedis osservâ di %s",
	...
	"commands.spreadplayers.success.teams": "Sparniçât %s scuadre(is) tor ator di %s, %s cuntune separazion medie di %s toc(s)",
	...
	"commands.stopwatch.already_exists": "Il cronometri cul non '%s' al esist za",
	"commands.stopwatch.create.success": "Il cronometri '%s' al è stât creât",
	"commands.stopwatch.does_not_exist": "Il cronometri cul non '%s' nol esist",
	"commands.stopwatch.query": "Il cronometri '%s' al segne %ss",
	"commands.stopwatch.remove.success": "Il cronometri '%s' al è stât gjavât",
	"commands.stopwatch.restart.success": "Tornât a inviâ il cronometri '%s'",
	"commands.summon.failed": "Impussibil evocâ la entitât",
	"commands.summon.failed.peaceful": "Chest mostri nol pues jessi evocât in dificoltât pacifiche",
	...
	"commands.swing.failed.notliving": "Nissune entitât vive compatibil cjatade",
	"commands.swing.success.multiple": "Fat movi i braçs a %s entitâts",
	"commands.swing.success.single": "Fat movi un braç a %s",
	...
	"commands.team.option.color.clear.success": "Il colôr de scuadre %s%% al è stât scancelât",
	...
	"commands.test.batch.starting": "Inviament dal ambient %s lot %s",
	"commands.test.clear.error.no_tests": "Impussibil cjatâ une prove di scancelâ",
	"commands.test.clear.success": "Struturis canceladis: %s",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Fâs clic par copiâ intes notis",
	"commands.test.create.success": "Creade configurazion de prove %s",
	"commands.test.error.no_test_containing_pos": "Impussibil cjatâ une istance di prove che e conten %s, %s, %s",
	"commands.test.error.no_test_instances": "No son stadis cjatadis istancis di prove",
	"commands.test.error.non_existant_test": "Impussibil cjatâ la prove %s",
	"commands.test.error.structure_not_found": "Impussibil cjatâ la struture de prove %s",
	"commands.test.error.test_instance_not_found": "Impussibil cjatâ la entitât dal bloc de istance di prove",
	"commands.test.error.test_instance_not_found.position": "Impussibil cjatâ la entitât dal bloc de istance di prove pe prove su %s, %s, %s",
	"commands.test.error.too_large": "La dimension de struture e scugne jessi plui piçule di %s blocs su ogni as",
	"commands.test.locate.done": "Localizazion terminade, struturis cjatadis: %s",
	"commands.test.locate.found": "Struture cjatade a: %s (distance: %s)",
	"commands.test.locate.started": "E je stade inviade la localizazion des struturis di prove, al podarès tirâle a dilunc...",
	"commands.test.no_tests": "Nissune prove di eseguî",
	"commands.test.relative_position": "Posizion relative a %s: %s",
	"commands.test.reset.error.no_tests": "Impussibil cjatâ provis di ripristinâ",
	"commands.test.reset.success": "Ripristine %s struture(-is)",
	"commands.test.run.no_tests": "Nissune prove cjatade",
	"commands.test.run.running": "Esecuzion di %s prove(is)...",
	"commands.test.summary": "Prove dal zûc completade! Provis eseguidis: %s",
	"commands.test.summary.all_required_passed": "Dutis lis provis necessariis a son stadis superadis :)",
	"commands.test.summary.failed": "Provis necessariis falidis: %s :(",
	"commands.test.summary.optional_failed": "Provis facoltativis falidis: %s",
	"commands.tick.query.percentiles": "Percentîi: P50: %sms P95: %sms P99: %sms, campion: %s",
	...
	"commands.tick.sprint.report": "Acelerazion completade cun %s ticadis par secont o %s ms par ticade",
	"commands.tick.sprint.stop.fail": "Nissune acelerazion des ticadis",
	"commands.tick.sprint.stop.success": "Acelerazion des ticadis interote",
	"commands.tick.status.frozen": "Il zûc al è blocât",
	"commands.tick.status.lagging": "Il zûc al è in esecuzion, ma nol rive a stâ daûr ae frecuence des ticadis indicade",
	"commands.tick.status.running": "Il zûc al funzione come simpri",
	"commands.tick.status.sprinting": "Il zûc al è acelerât",
	"commands.tick.step.fail": "Impussibil eseguî l'avanzament dal zûc - prime il zûc al à di jessi blocât",
	"commands.tick.step.stop.fail": "Nissun avanzament di ticade in cors",
	"commands.tick.step.stop.success": "Avanzament di ticade interot",
	"commands.tick.step.success": "Avanzament %s ticade(is)",
	"commands.time.no_default_clock": "Nol è nissun orloi predefinît te dimension %s",
	"commands.time.no_time_marker_found": "Il segnepuest temporâl %s nol esist par l'orloi %s",
	"commands.time.pause": "Orloi %s in pause",
	"commands.time.query": "Timp: %s ticadis",
	"commands.time.query.absolute": "L'orloi %s al è a %s ticade(is)",
	"commands.time.query.gametime": "Il timp di zûc al è a %s ticade(is)",
	"commands.time.query.timeline": "La secuence temporâl %s e je a %s ticade(is)",
	"commands.time.query.timeline.repetitions": "La secuence temporâl %s e à completât %s ripetizion(s)",
	"commands.time.rate": "L'orloi %s cumò al côr a %s voltis la velocitât normâl",
	"commands.time.resume": "Orloi %s ativât",
	"commands.time.set": "Il timp al è stât metût a %s ticadis",
	"commands.time.set.absolute": "Impostât %s a %s ticade(is)",
	"commands.time.set.time_marker": "Impostât %s al segnepuest temporâl %s",
	"commands.time.wrong_timeline_for_clock": "La secuence temporâl %s no je valide par l'orloi %s",
	...
	"commands.unpublish.notPublished": "Nissune partide multi-zuidôr publicade",
	"commands.unpublish.success": "La partide multi-zuiadôr no je plui publicade",
	...
	"commands.version.stable.yes": "stable = sì",
	"commands.waypoint.list.empty": "Nissun pont di riferiment in %s",
	"commands.waypoint.list.success": "%s pont(s) di riferiment in %s: %s",
	"commands.waypoint.modify.color": "Il colôr dal pont di riferiment cumò al è %s",
	"commands.waypoint.modify.color.reset": "Ripristine il colôr dal pont di riferiment",
	"commands.waypoint.modify.style": "Al è stât modificât il stîl dal pont di riferiment",
	...
	"compliance.playtime.message": "Zuiâ par masse timp al pues interferî cu la vite di ogni dì",
	...
	"connect.p2p.establishing": "Realizant une conession...",
	"connect.p2p.failed.generic": "Impussibil conetisi al zuiadôr",
	"connect.p2p.failed.signaling": "Impussibil conetisi cumò.\nTorne prove plui indenant.",
	"connect.p2p.failed.timeout": "Domande di conession scjadude",
	"connect.p2p.failed.unreachable": "Zuiadôr fûr puartade",
	...
	"container.beehive.bees": "Âfs: %s / %s",
	"container.beehive.honey": "Mîl: %s / %s",
	...
	"container.upgrade.error_tooltip": "Nol è pussibil miorâ l'ogjet in cheste maniere",
	...
	"createWorld.customize.buffet.search": "Cîr...",
	"createWorld.customize.buffet.title": "Personalizazion dal biome singul",
	...
	"createWorld.customize.presets.share": "Vuelistu condividi il to model cun cualchidun? Dopre il ricuadri chi sot!",
	...
	"credits_and_attribution.button.attribution": "Atribuzions",
	"credits_and_attribution.button.credits": "Ricognossiments",
	"credits_and_attribution.button.licenses": "Licencis",
	"credits_and_attribution.screen.title": "Ricognossiments e atribuzions",
	"dataPack.bundle.description": "Abilite l'ogjet sperimentâl \"sacut\"",
	"dataPack.bundle.name": "Sacuts",
	"dataPack.locator_bar.description": "Mostre la direzion dai altris zuiadôrs in multi-zuiadôr",
	"dataPack.locator_bar.name": "Sbare di localizazion",
	"dataPack.minecart_improvements.description": "Moviment dai carei mineraris miorât",
	"dataPack.minecart_improvements.name": "Mioraments dai carei mineraris",
	"dataPack.redstone_experiments.description": "Modifichis sperimentâls de redstone",
	"dataPack.redstone_experiments.name": "Esperiments de redstone",
	...
	"dataPack.winter_drop.description": "Gnûfs contignûts e funzionalitâts pe espansion invernâl",
	"dataPack.winter_drop.name": "Espansion invernâl",
	...
	"death.attack.arrow": "%[2]s al/e à trat a %[1]s",
	"death.attack.arrow.item": "%[2]s al/e à trat a %[1]s doprant %[3]s",
	"death.attack.badRespawnPoint.link": "Progjetazion intenzionâl dal zûc",
	"death.attack.badRespawnPoint.message": "%[2]s al/e à copât %[1]s",
	"death.attack.cactus": "Une muart di spiçots e becadis par %[1]s",
	"death.attack.cactus.player": "%[1]s al/e à cjaminât intor di un cactus intant che al/e cirive di scjampâ di %[2]s",
	...
	"death.attack.dragonBreath.player": "Il flât di drâc al à rustît %[1]s par colpe di %[2]s",
	"death.attack.drown": "%[1]s inneât/ade",
	"death.attack.drown.player": "%[1]s inneât/ade cirint di scjampâ di %[2]s",
	"death.attack.dryout": "La disidratazion e à copât %[1]s",
	"death.attack.dryout.player": "La disidratazion e à copât %[1]s intant che al/e cirive di scjampâ di %[2]s",
	"death.attack.even_more_magic": "Ancjemò altre magjie e à copât %[1]s",
	"death.attack.explosion": "%[1]s tonât/ade par aiar",
	"death.attack.explosion.player": "%[2]s al/e à fat tonâ par aiar %[1]s",
	"death.attack.explosion.player.item": "%[2]s al/e à fat tonâ par aiar %[1]s doprant %[3]s",
	...
	"death.attack.fireball.item": "%[2]s al/e à trat une bale di fûc a %[1]s doprant %[3]s",
	...
	"death.attack.flyIntoWall": "%[1]s al/e à provât la energjie cinetiche",
	"death.attack.flyIntoWall.player": "%[1]s al/e à provât la energjie cinetiche, cirint di scjampâ di %[2]s",
	...
	"death.attack.generic": "E vie %[1]s... muart/e",
	"death.attack.generic.player": "%[1]s muart/e par colpe di %[2]s",
	...
	"death.attack.hotFloor": "%[1]s al/e à discuviert che il paviment al jere di lave",
	"death.attack.hotFloor.player": "%[1]s al/e à cjaminât intune zone pericolose par vie di %[2]s",
	"death.attack.inFire": "%[1]s al/e à cjapât fûc",
	"death.attack.inFire.player": "%[1]s al/e à cjaminât tal fûc intant dal combatiment cun %[2]s",
	...
	"death.attack.indirectMagic": "%[2]s al/e à copât %[1]s doprant la magjie",
	"death.attack.indirectMagic.item": "%[2]s al/e à copât %[1]s doprant %[3]s",
	"death.attack.lava": "%[1]s al/e à cirût di nadâ te lave",
	"death.attack.lava.player": "%[1]s al/e à cirût di nadâ te lave par scjampâ di %[2]s",
	...
	"death.attack.mace_smash": "%[2]s al/e à fruçât %[1]s",
	"death.attack.mace_smash.item": "%[2]s al/e à fruçât %[1]s cun %[3]s",
	...
	"death.attack.message_too_long": "Nus displâs, ma in realtât il messaç al jere masse lunc par podêlu spedî complet. Chi e je la version scurtade: %s",
	"death.attack.mob": "%[2]s al/e à copât %[1]s",
	"death.attack.mob.item": "%[2]s al/e à copât %[1]s doprant %[3]s",
	"death.attack.onFire": "A %[1]s i à tocjât di brusâ vîf/vive",
	"death.attack.onFire.item": "%[1]s al/e à brusât fin a deventâ crostulin dilunc il combatiment cun %[2]s impugnant %[3]s",
	"death.attack.onFire.player": "%[1]s al/e à brusât fin a deventâ crostulin dilunc il combatiment cun %[2]s",
	"death.attack.outOfWorld": "%[1]s colât/ade fûr dal mont",
	...
	"death.attack.spear": "%[2]s al/e à sfilzât %[1]s",
	"death.attack.spear.item": "%[2]s al/e à sfilzât %[1]s doprant %[3]s",
	...
	"death.attack.starve": "%[1]s muart/e di fam",
	"death.attack.starve.player": "%[1]s muart/e di fam dilunc il combatiment cun %[2]s",
	"death.attack.sting": "%[1]s al/e à cjapât becadis fin ae sô muart",
	"death.attack.sting.item": "%[2]s al/e à becât a muart %[1]s doprant %[3]s",
	"death.attack.sting.player": "%[2]s al/e à becât a muart %[1]s",
	...
	"death.attack.thorns": "%[1]s copât/ade intant che al/e cirive di ferî %[2]s",
	"death.attack.thorns.item": "%[3]s al/e à copât %[1]s intant che al/e cirive di ferî %[2]s",
	"death.attack.thrown": "%[2]s al/e à dât pachis a %[1]s",
	"death.attack.thrown.item": "%[2]s al/e à dât pachis a %[1]s doprant %[3]s",
	"death.attack.trident": "%[2]s al/e à impalât %[1]s",
	"death.attack.trident.item": "%[2]s al/e à impalât %[1]s cun %[3]s",
	...
	"death.attack.witherSkull.item": "%[2]s cun %[3]s al à trat un crani che al à colpît %[1]s",
	"death.fell.accident.generic": "%[1]s colât/ade jù di adalt",
	"death.fell.accident.ladder": "A %[1]s i à capitât di colâ di une scjale",
	"death.fell.accident.other_climbable": "%[1]s colât/ade intant che si rimpinave",
	"death.fell.accident.scaffolding": "%[1]s colât/ade di une impalcadure",
	"death.fell.accident.twisting_vines": "%[1]s colât/colade des plantis rimpighinis intorteadis",
	"death.fell.accident.vines": "%[1]s colât/ade des plantis rimpighinis",
	"death.fell.accident.weeping_vines": "%[1]s colât/ade des plantis rimpighinis vaiulintis",
	"death.fell.assist": "%[1]s colât/ade jù par colpe di %[2]s",
	"death.fell.assist.item": "%[1]s colât/ade jù par colpe di %[2]s doprant %[3]s",
	"death.fell.finish": "%[2]s al/e à finît %[1]s che al/e jere colât/ade masse lontan",
	"death.fell.finish.item": "%[2]s, doprant %[3]s, al/e à finît %[1]s che al/e jere colât/ade masse lontan",
	...
	"debug.copy_location.help": "F3 + C = copie la posizion come comant /tp, tegniju fracâts par 10 seconts par fâ colassâ il zûc",
	...
	"debug.crash.message.rebindable": "Tu stâs tignint fracât %s + %s, se no tu ju molis, il zuc al colassarà.",
	...
	"debug.dump_dynamic_textures": "Tramis dinamichis salvadis in %s",
	"debug.dump_dynamic_textures.help": "F3 + S = espuarte tramis dinamichis",
	"debug.entry.always": "Simpri",
	"debug.entry.currently.alwaysOn": "%s: simpri visibil",
	"debug.entry.currently.inF3": "%s: visibil dome in F3",
	"debug.entry.currently.inOverlay": "%s: visibil dome tal cruscot di debug",
	"debug.entry.currently.never": "%s: platade",
	"debug.entry.f3": "Cun F3",
	"debug.entry.overlay": "Cruscot",
	...
	"debug.options.category.renderer": "Visualizadôr di debug",
	"debug.options.category.text": "Informazions te videade di debug",
	"debug.options.help": "F3 + F6 = Modifiche lis opzions di debug",
	"debug.options.notAllowed.tooltip": "No visibil cuant che lis informazions di debug e son diminuidis",
	"debug.options.profile.default": "Profîl predefinît",
	"debug.options.profile.performance": "Profîl prestazions",
	"debug.options.search": "Cîr...",
	"debug.options.title": "Opzions di debug",
	"debug.options.warning": "Chestis opzions a son disponibii a fin di test. A podaresin intardâ il to computer, colassâ il zûc o robâti la mirinde.",
	...
	"debug.profiling.start.rebindable": "Profiladure di %s seconts inviade. Frache %s + %s par fermâle prime",
	...
	"debug.version.header": "Informazions su la version dal client:",
	"debug.version.help": "F3 + V = Informazions su la version dal client",
	...
	"disconnect.loginFailedInfo.userBanned": "Tu sês bandît/ide dal zûc in linie",
	"disconnect.lost": "Conession pierdude",
	"disconnect.packetError": "Erôr dal protocol di rêt",
	"disconnect.spam": "Parâts fûr par spam",
	"disconnect.timeout": "Conession scjadude",
	"disconnect.transfer": "Trasferît suntun altri servidôr",
	"disconnect.unknownHost": "Host no cognossût",
	"download.pack.failed": "Impussibil discjariâ %s di %s pachets",
	...
	"editGamerule.inGame.button": "Modifiche regulis dal zûc...",
	"editGamerule.inGame.disabled.tooltip": "Par modificâ lis regulis dal zûc al covente il permès di un operadôr.",
	"editGamerule.inGame.discardChanges.message": "Anulâ pardabon lis modifichis des regulis dal zûc?",
	"editGamerule.inGame.discardChanges.title": "Modifichis des regulis dal zûc",
	"editGamerule.inGame.downloadingGamerules": "Recupar des regulis dal zûc...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Respîr dal nautil",
	...
	"effect.minecraft.infested": "Infestazion",
	...
	"effect.minecraft.oozing": "Secrezion",
	"effect.minecraft.poison": "Velen",
	"effect.minecraft.raid_omen": "Malauguri de incursion",
	...
	"effect.minecraft.trial_omen": "Malauguri de prove",
	"effect.minecraft.unluck": "Sfortune",
	"effect.minecraft.water_breathing": "Respîr te aghe",
	"effect.minecraft.weakness": "Debilece",
	"effect.minecraft.weaving": "Tiessidure",
	"effect.minecraft.wind_charged": "Cjarie di aiar",
	...
	"enchantment.minecraft.breach": "Infrazion",
	"enchantment.minecraft.channeling": "Canalizazion",
	"enchantment.minecraft.density": "Densitât",
	...
	"enchantment.minecraft.lunge": "Stocade",
	...
	"enchantment.minecraft.wind_burst": "Colp di aiar",
	"entity.minecraft.acacia_boat": "Barcje di agacie",
	"entity.minecraft.acacia_chest_boat": "Barcje di agacie cun baûl",
	"entity.minecraft.allay": "Slizeridôr",
	...
	"entity.minecraft.bamboo_chest_raft": "Çate di bambù cun baûl",
	"entity.minecraft.bamboo_raft": "Çate di bambù",
	"entity.minecraft.bat": "Gnotul",
	"entity.minecraft.bee": "Âf",
	"entity.minecraft.birch_boat": "Barcje di bedoi",
	"entity.minecraft.birch_chest_boat": "Barcje di bedoi cun baûl",
	...
	"entity.minecraft.camel_husk": "Dromedari sec",
	"entity.minecraft.cat": "Gjat",
	"entity.minecraft.cave_spider": "Ragn dai landris",
	"entity.minecraft.cherry_boat": "Barcje di cjariesâr",
	"entity.minecraft.cherry_chest_boat": "Barcje di cjariesâr cun baûl",
	...
	"entity.minecraft.copper_golem": "Golem di ram",
	"entity.minecraft.cow": "Vacje",
	"entity.minecraft.creaking": "Cric",
	"entity.minecraft.creaking_transient": "Cric",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Barcje di rôl scûr",
	"entity.minecraft.dark_oak_chest_boat": "Barcje di rôl scûr cun baûl",
	...
	"entity.minecraft.falling_block_type": "Colâ di %s",
	...
	"entity.minecraft.jungle_boat": "Barcje di len di jungle",
	"entity.minecraft.jungle_chest_boat": "Barcje di len di jungle cun baûl",
	...
	"entity.minecraft.lingering_potion": "Pozion persistente",
	"entity.minecraft.llama": "Lama",
	"entity.minecraft.llama_spit": "Spudacj di lama",
	"entity.minecraft.magma_cube": "Cubi di magme",
	"entity.minecraft.mangrove_boat": "Barcje di mangrovie",
	"entity.minecraft.mangrove_chest_boat": "Barcje di mangrovie cun baûl",
	"entity.minecraft.mannequin": "Manichin",
	"entity.minecraft.mannequin.label": "PNZ",
	...
	"entity.minecraft.oak_boat": "Barcje di rôl",
	"entity.minecraft.oak_chest_boat": "Barcje di rôl cun baûl",
	"entity.minecraft.ocelot": "Gjat salvadi",
	"entity.minecraft.ominous_item_spawner": "Gjeneradôr di ogjets dal malauguri",
	"entity.minecraft.painting": "Cuadri",
	"entity.minecraft.pale_oak_boat": "Barcje di rôl palit",
	"entity.minecraft.pale_oak_chest_boat": "Barcje di rôl palit cun baûl",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Secjât",
	...
	"entity.minecraft.splash_potion": "Pozion di tîr",
	"entity.minecraft.spruce_boat": "Barcje di peç",
	"entity.minecraft.spruce_chest_boat": "Barcje di peç cun baûl",
	"entity.minecraft.squid": "Calamâr",
	"entity.minecraft.stray": "Scheletri vagabont",
	"entity.minecraft.strider": "Strider",
	"entity.minecraft.sulfur_cube": "Cubi di solfar",
	"entity.minecraft.sulfur_cube.content": "Al conten: %s",
	...
	"filled_map.trial_chambers": "Mape dal esploradôr des provis",
	"filled_map.unknown": "Mape no cognossude",
	"filled_map.village_desert": "Mape dal paisut dal desert",
	"filled_map.village_plains": "Mape dal paisut de planure",
	"filled_map.village_savanna": "Mape dal paisut de savane",
	"filled_map.village_snowy": "Mape dal paisut cuviert di nêf",
	"filled_map.village_taiga": "Mape dal paisut de taiga",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Permet il Nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Controle se i zuiadôrs a puedin jentrâ tal Nether.",
	"gamerule.allowFireTicksAwayFromPlayer": "Permet propagazion dal fûc lontan dai zuiadôrs",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Al controle se il fûc e la lave a puedin rivâ a propagâsi a plui di 8 tocs di distance dai zuiadôr.",
	...
	"gamerule.blockExplosionDropDecay.description": "Se une interazion cui blocs e causione une esplosion che e distrûç blocs, cualchi ogjet molât al vignarà pierdût te esplosion.",
	...
	"gamerule.commandBlocksEnabled": "Abilite i blocs comants",
	"gamerule.commandModificationBlockLimit": "Limit dai blocs modificabii cuntun comant",
	"gamerule.commandModificationBlockLimit.description": "Numar massim di blocs che si puedin modificâ cuntun sôl comant, come /fill o /clone.",
	"gamerule.disableElytraMovementCheck": "Disative il control dal moviment cu lis elitris",
	"gamerule.disablePlayerMovementCheck": "Disative il control dal moviment dal zuiadôr",
	...
	"gamerule.doTileDrops.description": "Al controle lis risorsis che a vegnin moladis dai blocs, includudis lis sferis di esperience.",
	"gamerule.doTraderSpawning": "Gjenere i vendidôrs ambulants",
	"gamerule.doVinesSpread": "Difusion des plantis rampighinis",
	...
	"gamerule.enableCommandBlocks": "Abilite blocs comants",
	"gamerule.enderPearlsVanishOnDeath": "Lis perlis dal End tiradis a sparissin dopo de muart",
	"gamerule.enderPearlsVanishOnDeath.description": "Controle se lis perlis dal End tiradis di un zuiadôr a sparissin cuant che chel zuiadôr al mûr.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Lis entitâts cun passizîrs a puedin doprâ i portâi",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Permet aes entitâts cun passizîrs di teletraspuartâsi tai portâi dal Nether, tai portâi dal End e tai passaçs pal End.",
	...
	"gamerule.freezeDamage": "Causione i dams di conzelament",
	"gamerule.globalSoundEvents": "Events sonôrs globâi",
	"gamerule.globalSoundEvents.description": "Cuant che a sucedin cierts events di zûc, come la gjenerazion di un boss, il sun si sint dapardut.",
	...
	"gamerule.lavaSourceConversion.description": "Cuant che la lave corinte e je circondade di sorzints di lave su dôs bandis, si trasforme in sorzint.",
	"gamerule.locatorBar": "Abilite la sbare di localizazion dai zuiadôrs",
	"gamerule.locatorBar.description": "Se e ven abilitade, e ven mostrade une sbare sul schermi par indicâ la direzion dai zuiadôrs.",
	...
	"gamerule.maxCommandForkCount.description": "Numar massim di contescj che a puedin jessi doprâts dai comants come 'execute as'.",
	"gamerule.maxEntityCramming": "Limit di ingrumament des entitâts",
	"gamerule.minecartMaxSpeed": "Velocitât massime dal carel minerari",
	"gamerule.minecartMaxSpeed.description": "Velocitât massime predefinide di un carel minerari in moviment sul teren.",
	"gamerule.minecraft.elytra_movement_check": "Controle il moviment cu lis elitris",
	"gamerule.minecraft.fire_spread_radius_around_player": "Rai di difusion dal fûc",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Il rai in blocs ator di un zuiadôr dulà che il fûc si pues slargjâ",
	"gamerule.minecraft.player_movement_check": "Controle il moviment dal zuiadôr",
	"gamerule.minecraft.raids": "Incursions",
	"gamerule.minecraft.universal_anger.description": "Lis creaturis neutrâls, che a son stadis provocadis, a atachin ogni zuiadôr tai contors, no dome chel che lis à fatis inrabiâ. Al funzione miôr se la regule \"forgive_dead_players\" e je disativade.",
	"gamerule.mobExplosionDropDecay": "Cuant che une creature e tone, cualchi bloc nol molarà il so contignût",
	"gamerule.mobExplosionDropDecay.description": "Cuant che une creature e fâs tonâ blocs, cualchi ogjet molât al larà pierdût te esplosion.",
	...
	"gamerule.playersNetherPortalDefaultDelay": "Ritart dai portâi pal Nether pai zuiadôrs che no son in modalitât creative",
	"gamerule.playersNetherPortalDefaultDelay.description": "Timp (in ticadis) che un zuiadôr al à di restâ intun portâl pal Nether par cambiâ dimension, gjavât che nol sedi in modalitât creative.",
	"gamerule.playersSleepingPercentage": "Percentuâl di zuiadôrs indurmidîts",
	"gamerule.playersSleepingPercentage.description": "La percentuâl di zuiadôrs che a àn di sei indurmidîts par saltâ la gnot.",
	"gamerule.projectilesCanBreakBlocks": "I proietii a puedin spacâ i blocs",
	"gamerule.projectilesCanBreakBlocks.description": "Al controle se i proietii cun impat a puedin spacâ i blocs che si puedin rompi.",
	"gamerule.pvp": "Abilite il PvP",
	"gamerule.pvp.description": "Controle se i zuiadôrs a puedin fâ dam a chei altris zuiadôrs.",
	...
	"gamerule.spawnChunkRadius.description": "Numar di tocs che a restin cjariâts ator dal pont di gjenerazion te superficie.",
	"gamerule.spawnMonsters": "Gjenere i mostris",
	"gamerule.spawnMonsters.description": "Controle se i mostris si puedin gjenerâ in nature.",
	"gamerule.spawnRadius": "Rai dal pont di rinassite",
	"gamerule.spawnRadius.description": "Controle la dimension de aree ator dal pont di gjenerazion dulà che il zuiadôr al pues gjenerâsi.",
	"gamerule.spawnerBlocksEnabled": "Abilite i gjeneradôrs",
	"gamerule.spectatorsGenerateChunks": "Permet ai spetatôrs di gjenerâ teren",
	"gamerule.tntExplodes": "Permet di lescjâ e di fâ tonâ i blocs di TNT",
	"gamerule.tntExplosionDropDecay": "Intes esplosions cul TNT, cualchi bloc nol molarà il so contignût",
	"gamerule.tntExplosionDropDecay.description": "Cuant che il TNT al tone e al distrûç blocs, cualchi ogjet che al varès di vignî molât al larà pierdût te esplosion.",
	...
	"gamerule.waterSourceConversion.description": "Cuant che la aghe corinte e je circondade di sorzints di aghe su dôs bandis, si trasforme in sorzint.",
	...
	"gui.abuseReport.attestation": "Inviant cheste segnalazion, tu confermis che lis informazions indicadis a son precisis e completis.",
	"gui.abuseReport.comments": "Coments",
	"gui.abuseReport.describe": "Condividi detais nus jude a cjapâ une decision ben informade.",
	"gui.abuseReport.discard.content": "Se tu vâs fûr, tu pierdarâs la segnalazion e i coments.\nDesideristu pardabon lâ fûr?",
	...
	"gui.abuseReport.message": "Dulà âstu cjatât un compuartament scoret?\nChest nus judarà te analisi dal tô câs.",
	"gui.abuseReport.more_comments": "Par plasê descrîf ce che al è sucedût:",
	"gui.abuseReport.name.comment_box_label": "Par plasê descrîf parcè che tu vûs segnalâ chest non:",
	"gui.abuseReport.name.reporting": "Tu stâs segnalant \"%s\".",
	"gui.abuseReport.name.title": "Segnale non inadat dal zuiadôr",
	"gui.abuseReport.observed_what": "Parcè stâstu segnalant cheste robe chi?",
	...
	"gui.abuseReport.reason.alcohol_tobacco_drugs.description": "Cualchidun al sburte chei altris a partecipâ a cualchi ativitât ilegâl leade ae droghe o al alcolisim minorîl.",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse": "Sfrutament o abûs sessuâl su minôrs",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse.description": "Cualchidun al fevele o al promôf compuartaments indecents cjapant dentri fruts.",
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Difamazion, identitât robade o informazion false",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Cualchidun al fâs dam ae reputazion di cualchidun altri, al fâs fente di jessi cualchidun altri o al condivît informazions falsis par abusâ o ingjanâ chei altris.",
	"gui.abuseReport.reason.description": "Descrizion:",
	"gui.abuseReport.reason.false_reporting": "False segnalazion",
	"gui.abuseReport.reason.generic": "O vuei segnalâ chest zuiadôr",
	"gui.abuseReport.reason.generic.description": "Chest zuiadôr mi da fastidi o al à fat alc che no mi plâs.",
	"gui.abuseReport.reason.harassment_or_bullying": "Molestiis o bulos",
	"gui.abuseReport.reason.harassment_or_bullying.description": "Cualchidun al umilie, al tache o al fâs il bulo cuintri di te o di cualchidun altri. Chest al inclût cuant che cualchidun al prove cun insistence a contatâ te o cualchidun altri cence permès, o al spartìs informazions privadis sul to cont o su chel di cualchidun altri cence permès (\"doxing\").",
	"gui.abuseReport.reason.hate_speech": "Incitament al odi",
	"gui.abuseReport.reason.hate_speech.description": "Cualchidun al tache te o un altri zuiadôr pes carateristichis de lôr identitât, come religjon, raze o sessualitât.",
	...
	"gui.abuseReport.reason.non_consensual_intimate_imagery": "Imagjins intimis cence consens",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Contignûts sessuâi inadats",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Aspiets di nature grafiche in relazion a ats sessuâi, orghins sessuâi o violence sessuâl.",
	"gui.abuseReport.reason.terrorism_or_violent_extremism": "Terorisim o estremisim violent",
	"gui.abuseReport.reason.terrorism_or_violent_extremism.description": "Cualchidun al fevele, promôf o menace di fâ ats di terorisim o estremisim violent par resons politichis, religjosis, ideologjichis o altris motîfs.",
	"gui.abuseReport.reason.title": "Selezione une categorie di segnalazion",
	"gui.abuseReport.report_sent_msg": "O vin ricevût la tô segnalazion cun sucès, gracie!\nLa nestre scuadre le visionarà il prime pussibil.",
	...
	"gui.abuseReport.send.not_attested": "Par plasê lei il test parsore e selezione la casele par podê inviâ la segnalazion",
	"gui.abuseReport.send.service_unavailable": "Impussibil contatâ il servizi di segnalazion dai abûs. Controle la tô conession a internet e torne prove.",
	...
	"gui.banned.description.reason": "O vin ricevût une segnalazion par compuartament scoret dal to account. I nestris moderadôrs a àn revisionât il to câs e lu àn identificât come %s, chest al va cuintri dai standards de comunitât di Minecraft.",
	"gui.banned.description.reason_id": "Codiç: %s",
	"gui.banned.description.reason_id_message": "Codiç: %s - %s",
	"gui.banned.description.temporary": "%s Par intant, no tu podarâs zuiâ in linie o jentrâ tai Realms.",
	"gui.banned.description.temporary.duration": "Il to account al è sospindût in mût temporani e al vignarà riativât ca di %s.",
	"gui.banned.description.unknownreason": "O vin ricevût une segnalazion par compuartament scoret dal to account. I nestris moderadôrs a àn revisionât il to câs e a àn decidût che al va cuintri dai standards de comunitât di Minecraft.",
	"gui.banned.name.description": "Il to non atuâl - \"%s\" - al viole i nestris standards de comunitât. Tu puedis zuiâ in zuiadôr singul, ma tu âs di cambiâ il to non par zuiâ in linie.\n\nImpare di plui o domande une revision a chest colegament: %s",
	"gui.banned.name.title": "Non no permetût in multi-zuiadôr",
	"gui.banned.reason.defamation_impersonation_false_information": "Identitât robade o difusion di informazions par abusâ o ingjanâ chei altris",
	"gui.banned.reason.drugs": "Riferiment a droghis ilegâls",
	"gui.banned.reason.extreme_violence_or_gore": "Rafigurazion di senis di vite-reâl masse violentis o cruentis",
	...
	"gui.banned.reason.hate_speech": "Incitament al odi o discriminazion",
	...
	"gui.banned.reason.nudity_or_pornography": "Condivision di materiâl ossen o pornografic",
	...
	"gui.banned.skin.description": "Il to aspiet atuâl al viole i nestris standards de comunitât. Tu puedis zuiâ cuntun aspiet predefinît o sielzi un gnûf aspiet.\n\nScuvierç di plui o domande une revision a chest colegament: %s",
	...
	"gui.chatReport.discard.content": "Se tu vâs fûr, tu pierdarâs la segnalazion e i coments.\nDesideristu pardabon lâ fûr?",
	...
	"gui.chatReport.more_comments": "Par plasê descrîf ce che al è sucedût:",
	"gui.chatReport.observed_what": "Parcè stâstu segnalant chê robe ca?",
	...
	"gui.chatSelection.context": "I messaçs vicins ae selezion a vignaran includûts par dâi un contest plui complet",
	...
	"gui.fileDropFailure.detail": "Rifiutâts %s files",
	"gui.fileDropFailure.title": "Impussibil zontâ i files",
	"gui.friends.accept": "Acete",
	"gui.friends.button.loading": "Spiete...",
	"gui.friends.button.loading.invite_request_pending": "Waiting for confirmation",
	"gui.friends.button.loading.join_request_pending": "In spiete di conferme da %s",
	"gui.friends.cancel_request": "Anule richieste",
	"gui.friends.confirm_title": "Conferme",
	"gui.friends.confirm_unfriend": "Gjavâ pardabon chest zuiadôr da tô liste amîs?",
	"gui.friends.copy_to_clipboard": "Copie intes notis",
	"gui.friends.decline": "Refude",
	"gui.friends.empty_nickname": "Inserìs un non utent valit prime di inviâ une domande di amicizie",
	"gui.friends.empty_state": "I tiei amîs a vignaràn listâts achì.\n\nGjestìs la sigurece in linie cul to %s.",
	"gui.friends.empty_state.link": "Account di Microsoft",
	"gui.friends.enter_nickname": "Inserìs il non utent",
	"gui.friends.error.connection_issue": "In chest moment la liste amîs no è disponibil.\n\nControle la tô conession a internet e torne prove.",
	"gui.friends.error.failed.message": "Impussibil inviâ la domande di amicizie in chest moment",
	"gui.friends.error.forbidden.message": "Erôr tal eseguî cheste azion. Al podarès jessi par vie des opzions di riservatece dal zuiadôr.",
	...
	"gui.friends.multiplayer.invite": "Invide al mont",
	...
	"gui.game_rule.search": "Cîr...",
	"gui.hours": "%s ore(is)",
	"gui.language.search": "Cîr...",
	...
	"gui.none": "Nissun",
	"gui.ok": "Va ben",
	"gui.open_report_dir": "Vierç la cartele des segnalazions",
	"gui.packSelection.search": "Cîr...",
	...
	"gui.recipebook.next_page": "Pagjine sucessive",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Pagjine precedente",
	...
	"gui.remove": "Remove",
	"gui.report_to_server": "Segnale al servidôr",
	"gui.selectWorld.search": "Cîr...",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Chest zuiadôr no po sei segnalat, parcè che la chat e je disativade o blocade",
	...
	"gui.stats.none_found": "Nissune statistiche cjatade.",
	...
	"gui.up": "Sù",
	"gui.waitingForResponse.button.inactive": "Indaûr (%ss)",
	"gui.waitingForResponse.title": "In spiete dal servidôr",
	"gui.yes": "Sì",
	...
	"item.minecraft.black_bundle": "Sacut neri",
	"item.minecraft.black_dye": "Tinture nere",
	"item.minecraft.black_harness": "Imbragadure nere",
	...
	"item.minecraft.blue_bundle": "Sacut blu",
	"item.minecraft.blue_dye": "Tinture blu",
	"item.minecraft.blue_egg": "Ûf blu",
	"item.minecraft.blue_harness": "Imbragadure blu",
	"item.minecraft.bogged_spawn_egg": "Ûf di nassite dal paludan",
	"item.minecraft.bolt_armor_trim_smithing_template": "Model par fari",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Ornament cun stîl bulon",
	"item.minecraft.bone": "Vues",
	"item.minecraft.bone_meal": "Farine di vues",
	"item.minecraft.book": "Libri",
	"item.minecraft.bordure_indented_banner_pattern": "Model di stendart cun bordure dintade",
	...
	"item.minecraft.brown_bundle": "Sacut maron",
	"item.minecraft.brown_dye": "Tinture maron",
	"item.minecraft.brown_egg": "Ûf maron",
	"item.minecraft.brown_harness": "Imbragadure maron",
	"item.minecraft.brush": "Sborfin",
	"item.minecraft.bucket": "Seglot",
	"item.minecraft.bundle": "Sacut",
	"item.minecraft.bundle.empty": "Vueit",
	"item.minecraft.bundle.empty.description": "Al pues tignî une pile messedade di ogjets",
	...
	"item.minecraft.camel_husk_spawn_egg": "Ûf di nassite dal dromedari sec",
	...
	"item.minecraft.coast_armor_trim_smithing_template.new": "Ornament cun stîl costîr",
	...
	"item.minecraft.copper_axe": "Manarie di ram",
	"item.minecraft.copper_boots": "Stivâi di ram",
	"item.minecraft.copper_chestplate": "Corace di ram",
	"item.minecraft.copper_golem_spawn_egg": "Ûf di nassite dal golem di ram",
	"item.minecraft.copper_helmet": "Elm di ram",
	"item.minecraft.copper_hoe": "Sape di ram",
	"item.minecraft.copper_horse_armor": "Furniment in ram pal cjaval",
	"item.minecraft.copper_ingot": "Lingot di ram",
	"item.minecraft.copper_leggings": "Gjambâi in ram",
	"item.minecraft.copper_nautilus_armor": "Armadure in ram pal nautil",
	"item.minecraft.copper_nugget": "Pepite di ram",
	"item.minecraft.copper_pickaxe": "Picon di ram",
	"item.minecraft.copper_shovel": "Pale di ram",
	"item.minecraft.copper_spear": "Lance di ram",
	"item.minecraft.copper_sword": "Spade di ram",
	"item.minecraft.cow_spawn_egg": "Ûf di nassite de vacje",
	"item.minecraft.creaking_spawn_egg": "Ûf di nassite dal cric",
	"item.minecraft.creeper_banner_pattern": "Model di stendart",
	"item.minecraft.creeper_banner_pattern.desc": "Muse di creeper",
	"item.minecraft.creeper_banner_pattern.new": "Model di stendart cun muse di creeper",
	...
	"item.minecraft.crossbow.projectile.multiple": "Proietil: %s x %s",
	"item.minecraft.crossbow.projectile.single": "Proietil: %s",
	"item.minecraft.cyan_bundle": "Sacut ciano",
	"item.minecraft.cyan_dye": "Tinture ciano",
	"item.minecraft.cyan_harness": "Imbragadure ciano",
	...
	"item.minecraft.diamond_nautilus_armor": "Armadure in diamant pal nautil",
	"item.minecraft.diamond_pickaxe": "Picon di diamant",
	"item.minecraft.diamond_shovel": "Pale di diamant",
	"item.minecraft.diamond_spear": "Lance di diamant",
	...
	"item.minecraft.dune_armor_trim_smithing_template.new": "Ornament cun stîl dune",
	...
	"item.minecraft.eye_armor_trim_smithing_template.new": "Ornament cun stîl voli",
	"item.minecraft.feather": "Plume",
	"item.minecraft.fermented_spider_eye": "Voli di ragn fermentât",
	"item.minecraft.field_masoned_banner_pattern": "Model di stendart cun semenât di modons",
	...
	"item.minecraft.flow_armor_trim_smithing_template.new": "Ornament cun stîl flus",
	"item.minecraft.flow_banner_pattern": "Model di stendart",
	"item.minecraft.flow_banner_pattern.desc": "Flus",
	"item.minecraft.flow_banner_pattern.new": "Model di stendart cun flus",
	...
	"item.minecraft.flower_banner_pattern.new": "Model di stendart cun rose",
	...
	"item.minecraft.globe_banner_pattern.new": "Model di stendart cun globi",
	"item.minecraft.glow_berries": "Pomulis luminessentis",
	"item.minecraft.glow_ink_sac": "Sache di ingjustri luminessent",
	"item.minecraft.glow_item_frame": "Curnîs luminessente",
	...
	"item.minecraft.golden_nautilus_armor": "Armadure in aur pal nautil",
	"item.minecraft.golden_pickaxe": "Picon di aur",
	"item.minecraft.golden_shovel": "Pale di aur",
	"item.minecraft.golden_spear": "Lance di aur",
	"item.minecraft.golden_sword": "Spade di aur",
	"item.minecraft.gray_bundle": "Sacut grîs",
	"item.minecraft.gray_dye": "Tinture grise",
	"item.minecraft.gray_harness": "Imbragadure grise",
	"item.minecraft.green_bundle": "Sacut vert",
	"item.minecraft.green_dye": "Tinture verde",
	"item.minecraft.green_harness": "Imbragadure verde",
	...
	"item.minecraft.guster_banner_pattern.new": "Model di stendart cun bugade",
	"item.minecraft.guster_pottery_sherd": "Crep cun bugade",
	"item.minecraft.happy_ghast_spawn_egg": "Ûf di nassite dal Ghast legri",
	"item.minecraft.harness": "Imbragadure",
	...
	"item.minecraft.host_armor_trim_smithing_template.new": "Ornament cun stîl ospit",
	...
	"item.minecraft.iron_nautilus_armor": "Armadure in fier pal nautil",
	...
	"item.minecraft.iron_spear": "Lance di fier",
	...
	"item.minecraft.light_blue_bundle": "Sacut blu clâr",
	"item.minecraft.light_blue_dye": "Tinture blu clâr",
	"item.minecraft.light_blue_harness": "Imbragadure blu clâr",
	"item.minecraft.light_gray_bundle": "Sacut grîs clâr",
	"item.minecraft.light_gray_dye": "Tinture grîs clâr",
	"item.minecraft.light_gray_harness": "Imbragadure grîs clâr",
	"item.minecraft.lime_bundle": "Sacut vert limon",
	"item.minecraft.lime_dye": "Tinture vert limon",
	"item.minecraft.lime_harness": "Imbragadure vert limon",
	...
	"item.minecraft.lingering_potion.effect.infested": "Pozion di infestazion persistente",
	...
	"item.minecraft.lingering_potion.effect.luck": "Pozion di fortune persistente",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Pozion di secrezion persistente",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Pozion di tiessidure persistente",
	"item.minecraft.lingering_potion.effect.wind_charged": "Pozion di cjarie di aiar persistente",
	...
	"item.minecraft.magenta_bundle": "Sacut magenta",
	"item.minecraft.magenta_dye": "Tinture magenta",
	"item.minecraft.magenta_harness": "Imbragadure magenta",
	"item.minecraft.magma_cream": "Creme di magme",
	"item.minecraft.magma_cube_spawn_egg": "Ûf di nassite dal cubi di magme",
	...
	"item.minecraft.mojang_banner_pattern.new": "Model di stendart cun logo",
	...
	"item.minecraft.music_disc_creator": "Disc musicâl",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Disc musicâl",
	...
	"item.minecraft.music_disc_lava_chicken": "Disc musicâl",
	...
	"item.minecraft.music_disc_precipice": "Disc musicâl",
	...
	"item.minecraft.music_disc_tears": "Disc musicâl",
	...
	"item.minecraft.nautilus_spawn_egg": "Ûf di nassite dal nautil",
	...
	"item.minecraft.netherite_horse_armor": "Furniment in netherite pal cjaval",
	"item.minecraft.netherite_ingot": "Lingot di netherite",
	"item.minecraft.netherite_leggings": "Gjambâi in netherite",
	"item.minecraft.netherite_nautilus_armor": "Armadure in netherite pal nautil",
	...
	"item.minecraft.netherite_spear": "Lance di netherite",
	"item.minecraft.netherite_sword": "Spade in netherite",
	"item.minecraft.netherite_upgrade_smithing_template": "Model par fari",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Miorament di netherite",
	...
	"item.minecraft.ominous_bottle": "Boce dal malauguri",
	"item.minecraft.ominous_trial_key": "Clâf de prove dal malauguri",
	"item.minecraft.orange_bundle": "Sacut naranç",
	"item.minecraft.orange_dye": "Tinture naranç",
	"item.minecraft.orange_harness": "Imbragadure naranç",
	"item.minecraft.painting": "Cuadri",
	"item.minecraft.pale_oak_boat": "Barcje di rôl palit",
	"item.minecraft.pale_oak_chest_boat": "Barcje di rôl palit cun baûl",
	"item.minecraft.panda_spawn_egg": "Ûf di nassite dal panda",
	"item.minecraft.paper": "Cjarte",
	"item.minecraft.parched_spawn_egg": "Ûf di nassite dal secjât",
	...
	"item.minecraft.piglin_banner_pattern.new": "Model di stendart cun music",
	...
	"item.minecraft.pink_bundle": "Sacut rose",
	"item.minecraft.pink_dye": "Tinture rose",
	"item.minecraft.pink_harness": "Imbragadure rose",
	...
	"item.minecraft.potion.effect.infested": "Pozion di infestazion",
	...
	"item.minecraft.potion.effect.weaving": "Pozion di tiessidure",
	"item.minecraft.potion.effect.wind_charged": "Pozion di cjarie di aiar",
	...
	"item.minecraft.purple_bundle": "Sacut viole",
	"item.minecraft.purple_dye": "Tinture viole",
	"item.minecraft.purple_harness": "Imbragadure viole",
	...
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Ornament cun stîl arlevadôr",
	...
	"item.minecraft.red_bundle": "Sacut ros",
	"item.minecraft.red_dye": "Tinture rosse",
	"item.minecraft.red_harness": "Imbragadure rosse",
	"item.minecraft.redstone": "Polvar di redstone",
	"item.minecraft.resin_brick": "Modon di resine",
	"item.minecraft.resin_clump": "Grop di resine",
	"item.minecraft.rib_armor_trim_smithing_template": "Model par fari",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Ornament cun stîl cuestis",
	...
	"item.minecraft.scrape_pottery_sherd": "Crep cun russade",
	"item.minecraft.scute": "Scus",
	"item.minecraft.sentry_armor_trim_smithing_template": "Model par fari",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Ornament cun stîl sentinele",
	"item.minecraft.shaper_armor_trim_smithing_template": "Model par fari",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Ornament cun stîl modeladôr",
	...
	"item.minecraft.silence_armor_trim_smithing_template.new": "Ornament cun stîl cidin",
	...
	"item.minecraft.skull_banner_pattern.new": "Model di stendart cun crani",
	...
	"item.minecraft.smithing_template.netherite_upgrade.base_slot_description": "Zonte une armadure, arme o imprest di diamant",
	...
	"item.minecraft.snout_armor_trim_smithing_template.new": "Ornament cun stîl music",
	...
	"item.minecraft.spire_armor_trim_smithing_template.new": "Ornament cun stîl spicis",
	...
	"item.minecraft.splash_potion.effect.infested": "Pozion di tîr di infestazion",
	...
	"item.minecraft.splash_potion.effect.luck": "Pozion di tîr pe fortune",
	...
	"item.minecraft.splash_potion.effect.oozing": "Pozion di tîr di secrezion",
	...
	"item.minecraft.splash_potion.effect.weaving": "Pozion di tîr di tiessidure",
	"item.minecraft.splash_potion.effect.wind_charged": "Pozion di tîr di cjarie di aiar",
	...
	"item.minecraft.stone_spear": "Lance di piere",
	...
	"item.minecraft.sulfur_cube_bucket": "Seglot cun cubi di solfar",
	"item.minecraft.sulfur_cube_spawn_egg": "Ûf di nassite dal cubi di solfar",
	...
	"item.minecraft.tide_armor_trim_smithing_template.new": "Ornament cun stîl maree",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Frece di infestazion",
	...
	"item.minecraft.tipped_arrow.effect.luck": "Frece di fortune",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Frece di secrezion",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Frece di tiessidure",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Frece di cjarie di aiar",
	...
	"item.minecraft.vex_armor_trim_smithing_template.new": "Ornament cun stîl vex",
	...
	"item.minecraft.ward_armor_trim_smithing_template.new": "Ornament cun stîl vuardie",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Ornament cun stîl esploradôr",
	"item.minecraft.wheat": "Forment",
	"item.minecraft.wheat_seeds": "Semencis di forment",
	"item.minecraft.white_bundle": "Sacut blanc",
	"item.minecraft.white_dye": "Tinture blancje",
	"item.minecraft.white_harness": "Imbragadure blancje",
	"item.minecraft.wild_armor_trim_smithing_template": "Model par fari",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Ornament cun stîl salvadi",
	"item.minecraft.wind_charge": "Cjarie di aiar",
	...
	"item.minecraft.zombie_nautilus_spawn_egg": "Ûf di nassite dal nautil zombi",
	...
	"item.modifiers.any": "Metût sù:",
	"item.modifiers.armor": "Metût sù:",
	"item.modifiers.body": "Metût sù:",
	"item.modifiers.chest": "Sul pet:",
	"item.modifiers.feet": "Sui pîts:",
	"item.modifiers.hand": "Te man:",
	...
	"item.modifiers.saddle": "Se sielât:",
	"item.nbt_tags": "NBT: %s etichete(-is)",
	"item.op_block_warning.line1": "Atenzion:",
	"item.op_block_warning.line2": "Chest ogjet al podarès eseguî comants.",
	"item.op_block_warning.line3": "No sta doprâlu se no tu sâs a ce che al covente!",
	"item.spawn_egg.peaceful": "Disattivât in dificoltât pacifiche",
	...
	"jigsaw_block.placement_priority.tooltip": "Cuant che chest bloc berdei si conet a un toc, chest al è l'ordin doprât par elaborâ il toc pes conessions ae struture plui grande.\n\nI tocs e vignaran elaborâts cun prioritât in calâ, risolvint i câs di paritât in base al ordin di inseriment.",
	"jigsaw_block.pool": "Bacin di destinazion:",
	"jigsaw_block.selection_priority": "Prioritât di selezion:",
	"jigsaw_block.selection_priority.tooltip": "Cuant che il toc gjenitôr al ven elaborât pes conessions, chest al è l'ordin doprât dal bloc berdei pai tentatîfs di conession al so toc di destinazion.\n\nI berdeis e vignaran elaborâts cun prioritât in calâ, cun ordin casuâl par risolvi i câs di paritât.",
	...
	"key.categories.spectator": "Spetatôr",
	"key.categories.ui": "Interface dal zûc",
	"key.category.minecraft.creative": "Modalitât creative",
	"key.category.minecraft.debug": "Debug",
	"key.category.minecraft.gameplay": "Azions di zûc",
	"key.category.minecraft.inventory": "Inventari",
	"key.category.minecraft.misc": "Variis",
	"key.category.minecraft.movement": "Moviment",
	"key.category.minecraft.multiplayer": "Multi-zuiadôr",
	"key.category.minecraft.spectator": "Spetatôr",
	"key.chat": "Vierzi la chat",
	"key.command": "Scrivi un comant",
	"key.debug.clearChat": "Disvuede la chat",
	"key.debug.copyLocation": "Copie la posizion",
	"key.debug.copyRecreateCommand": "Copie i dâts",
	"key.debug.crash": "Colàs di debug",
	"key.debug.debugOptions": "Opzions di debug",
	"key.debug.dumpDynamicTextures": "Espuarte tramis dinamichis",
	"key.debug.dumpVersion": "Espuarte lis informazions su la version",
	"key.debug.focusPause": "Comute la pause se al mancje il stât atîf",
	"key.debug.fpsCharts": "Grafics di frecuence dai fotograms",
	"key.debug.lightmapTexture": "Trame de mape di iluminazion",
	"key.debug.modifier": "Tast modificadôr di debug",
	"key.debug.networkCharts": "Grafics di rêt",
	"key.debug.overlay": "Comute il cruscot",
	"key.debug.profiling": "Invie o ferme la profiladure",
	"key.debug.profilingChart": "Grafic di profiladure",
	"key.debug.reloadChunk": "Torne cjame i tocs",
	"key.debug.reloadResourcePacks": "Torne cjame i pachets di risorsis",
	"key.debug.showAdvancedTooltips": "Mostre i sugjeriments avanzâts",
	"key.debug.showChunkBorders": "Mostre i ôrs dai tocs",
	"key.debug.showHitboxes": "Mostre la incuadradure visive",
	"key.debug.spectate": "Cicle la modalitât spetatôr",
	"key.debug.switchGameMode": "Seletôr de modalitât di zûc",
	...
	"key.quickActions": "Azions sveltis",
	...
	"key.spectatorHotbar": "Selezione te sbare rapide",
	"key.spectatorOutlines": "Evidenzie i zuiadôrs",
	"key.sprint": "Cori",
	"key.swapOffhand": "Cambiâ di man",
	"key.toggleGui": "Comute GUI",
	"key.togglePerspective": "Comutâ la prospetive",
	"key.toggleSpectatorShaderEffects": "Comute efiets visîfs dal spetatôr",
	"key.use": "Doprâ un ogjet/Plaçâ un bloc",
	"known_server_link.announcements": "Avîs",
	"known_server_link.community": "Comunitât",
	"known_server_link.community_guidelines": "Liniis vuide de comunitât",
	"known_server_link.feedback": "Coments",
	"known_server_link.forums": "Forum",
	"known_server_link.news": "Notiziis",
	"known_server_link.report_bug": "Segnale erôr di servidôr",
	"known_server_link.status": "Stât",
	"known_server_link.support": "Assistence",
	"known_server_link.website": "Sît web",
	"lanServer.otherPlayers": "Impostazions pai altris zuiadôrs",
	"lanServer.port": "Numar de puarte",
	"lanServer.port.invalid": "Puarte no valide.\nLasse vueit il ricuadri di modifiche opûr inserìs un numar diferent tal interval 1024 - 65535.",
	"lanServer.port.invalid.new": "Puarte no valide.\nLasse vueit il ricuadri di modifiche opûr inserìs un numar diferent tal interval %s - %s.",
	"lanServer.port.unavailable": "Puarte no disponibile.\nLasse vueit il ricuadri di modifiche opûr inserìs un numar diferent tal interval 1024 - 65535.",
	"lanServer.port.unavailable.new": "Puarte no disponibile.\nLasse vueit il ricuadri di modifiche opûr inserìs un numar diferent tal interval %s - %s.",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Zonte un servidôr",
	"manageServer.edit.title": "Modifiche lis informazions dal servidôr",
	"manageServer.enterIp": "Direzion dal servidôr",
	"manageServer.enterName": "Non dal servidôr",
	"manageServer.resourcePack": "Pachets risorsis dal servidôr",
	"manageServer.resourcePack.disabled": "Disabilitât",
	"manageServer.resourcePack.enabled": "Abilitât",
	"manageServer.resourcePack.prompt": "Domande",
	...
	"mco.backup.entry.worldType.experience": "Esperience",
	"mco.backup.entry.worldType.inspiration": "Ispirazion",
	"mco.backup.entry.worldType.minigame": "Minizûc",
	"mco.backup.entry.worldType.normal": "Normâl",
	"mco.backup.entry.worldType.unknown": "No cognossût",
	"mco.backup.generate.world": "Gjenere il mont",
	"mco.backup.info.title": "Modifichis rispiet ae ultime copie di sigurece",
	"mco.backup.narration": "Copie di sigurece dal %s",
	...
	"mco.client.incompatible.msg.line3": "Realms nol è compatibil cu lis version sperimentâls.",
	"mco.client.incompatible.title": "Client incompatibil!",
	"mco.client.outdated.stable.version": "La version dal client (%s) no je compatibile cun Realms.\n\nDopre la version plui resinte di Minecraft.",
	"mco.client.unsupported.snapshot.version": "La version dal client (%s) no je compatibile cun Realms.\n\nRealms nol è disponibil par cheste version sperimentâl.",
	"mco.compatibility.downgrade": "Torne indaûr di version",
	"mco.compatibility.downgrade.description": "Chest mont al è stât zuiât la ultime volte te version %s; tu tu stâs doprant la version %s. Il tornâ indaûr di version di un mont al pues causâ coruzions - no podìn garantî che si cjami o che al funzioni.\n\nE vignarà salvade une copie di sigurece in \"Copiis di sigurece dal mont\". Se al covente, ripristine il mont.",
	"mco.compatibility.incompatible.popup.title": "Version incompatibile",
	"mco.compatibility.incompatible.releaseType.popup.message": "Chest mont al è incompatibil cu la to version.",
	"mco.compatibility.incompatible.series.popup.message": "La ultime volte chest mont al è stât zuiât te version %s; tu tu sês te version %s.\n\nLis dôs versions no son compatibii. Par zuiâ in cheste version, cree un gnûf mont.",
	"mco.compatibility.unverifiable.message": "Nol è stât pussibil verificâ la ultime version di chest mont. Se tu lu inzornis o al torne indaûr di version, une copie di sigurece e vignarà salvade in automatic in \"Copiis di sigurece dal mont\".",
	"mco.compatibility.unverifiable.title": "Compatibilitât no verificabile",
	"mco.compatibility.upgrade": "Inzorne",
	"mco.compatibility.upgrade.description": "La ultime volte che chest mont al è stât zuiât al jere te version %s; tu tu stâs doprant la version %s.\n\nUne copie di sigurece e vignarà salvade in \"Copiis di sigurece dal mont\". Se al covente, ripristine il mont.",
	"mco.compatibility.upgrade.friend.description": "La ultime volte chest mont al è stât zuiât te version %s; tu stâs doprant la version %s.\n\nUne copie di sigurece e vignarà salvade in \"Copiis di sigurece dal mont\".\n\nIl proprietari dal Realm al podarà ripristinâ il mont.",
	...
	"mco.configure.world.buttons.close": "Siere il Realm in mût temporani",
	...
	"mco.configure.world.buttons.newworld": "Gnûf mont",
	"mco.configure.world.buttons.open": "Torne vierç il Realm",
	"mco.configure.world.buttons.options": "Opzions dal mont",
	"mco.configure.world.buttons.players": "Zuiadôrs",
	"mco.configure.world.buttons.region_preference": "Selezione une regjon...",
	"mco.configure.world.buttons.resetworld": "Torne inizialize il mont",
	"mco.configure.world.buttons.save": "Salve",
	...
	"mco.configure.world.close.question.line1": "Tu puedis sierâ il to Realm in mût temporani, impedint l'acès al zûc intant che tu fâsis modifichis. Torne vierzilu cuant che tu sês pront. \n\nChest nol anule il to abonament a Realms.",
	"mco.configure.world.close.question.line2": "Continuâ pardabon?",
	"mco.configure.world.close.question.title": "Âstu dibisugne di modificâ cence interuzions?",
	"mco.configure.world.closing": "Daûr a sierâ il Realm par un pôc di timp...",
	...
	"mco.configure.world.loading": "Daûr a cjariâ il Realm",
	"mco.configure.world.location": "Posizion",
	"mco.configure.world.minigame": "Atuâl: %s",
	"mco.configure.world.name": "Non dal Realm",
	"mco.configure.world.name.validation.whitespace": "Il spazi blanc al inizi e ae fin dal non al vignarà scancelât.",
	"mco.configure.world.opening": "Daûr a vierzi il Realm...",
	"mco.configure.world.players.error": "No esistin zuiadôrs cul non indicât",
	"mco.configure.world.players.invite.duplicate": "Un zuiadôr cun chest non al è za stât invidât al Realm",
	"mco.configure.world.players.inviting": "Invît dal zuiadôr...",
	"mco.configure.world.players.title": "Zuiadôrs",
	"mco.configure.world.pvp": "PvP",
	"mco.configure.world.region_preference": "Regjon preferide",
	"mco.configure.world.region_preference.title": "Selezion de regjon preferide",
	...
	"mco.configure.world.resourcepack.question": "Ti covente un pachet di risorsis personalizât par zuiâ su chest Realm.\n\nDesideristu discjariâlu e zuiâ?",
	...
	"mco.configure.world.settings.expired": "No tu puedis modificâ lis impostazions di un Realm scjadût",
	...
	"mco.configure.world.spawnMonsters": "Gjenere i mostris",
	"mco.configure.world.spawnNPCs": "Paisans",
	"mco.configure.world.spawnProtection": "Protezion dal pont di nassite",
	"mco.configure.world.spawn_toggle.message": "Disativant cheste opzion, dutis lis entitâts di chel gjenar a vignaran eliminadis",
	"mco.configure.world.spawn_toggle.message.npc": "Disativant cheste opzion, dutis lis entitâts di chel gjenar, come i paisans, a vignaran eliminadis",
	...
	"mco.configure.world.subscription.recurring.info": "Lis modifichis fatis sul to abonament a Realms, come zontâ timp o disativâ lis faturis ricorintis, no saran efetivis fin ae prossime date di fature.",
	...
	"mco.connect.region": "Regjion dal servidôr: %s",
	"mco.connect.success": "Fat",
	"mco.create.world": "Cree",
	"mco.create.world.error": "Tu scugnis inserî un non!",
	"mco.create.world.failed": "Nol è stât pussibil creâ il mont!",
	...
	"mco.download.confirmation.oversized": "Il mont che tu stâs par discjariâ al è plui grant di %s\n\nNo tu podarâs plui cjamâ in rêt chest mont sul to Realm",
	...
	"mco.errorMessage.initialize.failed": "Nol è stât pussibil inizializâ il realm",
	"mco.errorMessage.noDetails": "No son stâts furnîts detais dal erôr",
	"mco.errorMessage.realmsService": "Al è vignût fûr un erôr (%s):",
	"mco.errorMessage.realmsService.configurationError": "Al è vignût fûr un erôr no previodût tal modificâ lis impostazions dal mont",
	...
	"mco.errorMessage.realmsService.unknownCompatibility": "Impussibil controlâ la version compatibile, rispueste ricevude: %s",
	"mco.errorMessage.retry": "Torne prove la operazion",
	"mco.errorMessage.serviceBusy": "Realms al è ocupât al moment. Prove di gnûf a conetiti al to Realm ca di un pâr di minûts.",
	"mco.gui.button": "Boton",
	"mco.gui.ok": "Va ben",
	"mco.info": "Informazions!",
	"mco.invited.player.narration": "Invidât il zuiadôr %s",
	...
	"mco.onlinePlayers": "Zuiadôrs in linie",
	"mco.play.button.realm.closed": "Il Realm al è sierât",
	...
	"mco.selectServer.closed": "Realm disativât",
	...
	"mco.selectServer.noRealms": "Al pâr che no tu vedis nissun Realm. Zonte un Realm par zuiâ cui tiei amîs.",
	...
	"mco.snapshot.createSnapshotPopup.text": "Tu stâs par creâ un Realm gratuit intune version sperimentâl che al sarà associât al to abonament a Realms. Tu puedis zuiâ in chest gnûf Realm dome se il to abonament al è atîf. Il to Realm paiât nol sarà tocjât.",
	"mco.snapshot.createSnapshotPopup.title": "Creâ un Realm intune version sperimentâl?",
	"mco.snapshot.creating": "Creazion di un Realm intune version sperimentâl...",
	...
	"mco.snapshot.paired": "Chest Realm sperimentâl al è associât cun \"%s\"",
	"mco.snapshot.parent.tooltip": "Dopre la ultime version di Minecraft par zuiâ in chest Realm",
	"mco.snapshot.start": "Invie un Realm sperimentâl gratuit",
	"mco.snapshot.subscription.info": "Chest al è un Realm intune version sperimentâl associât al to abonament pal Realm '%s'. Al reste atîf dome fintant che il Realm associât al è atîf.",
	"mco.snapshot.tooltip": "Dopre i Realms sperimentâi par viodi une anteprime des prossimis versions di Minecraft, che a podaressin includi gnovis funzionalitâts e cambiaments.\n\nTu cjatis i tiei Realms normâi te version uficiâl dal zûc.",
	"mco.snapshotRealmsPopup.message": "Cu la version 23w41a, i Realms a saran disponibii ancje tes versions sperimentâls. Ducj i abonaments ai Realms a includin un Realm pes versions sperimentâls, separât dal to Realm Java normâl!",
	"mco.snapshotRealmsPopup.title": "I Realms a son cumò disponibii tes versions sperimentâls",
	...
	"mco.upload.failed.too_big.description": "Chest mont al è masse grant. La dimension massime ametude e je %s.",
	"mco.upload.failed.too_big.title": "Mont masse grant",
	...
	"menu.custom_options": "Opzions personalizadis...",
	"menu.custom_options.title": "Opzions personalizadis",
	"menu.custom_options.tooltip": "Note: lis opzions personalizadis a son furnidis di servidôrs o contignûts di tierçs.\nFâs a ments!",
	"menu.custom_screen_info.button_narration": "Cheste e je une videade personalizade. Scuvierç di plui.",
	"menu.custom_screen_info.contents": "I contignûts di cheste videade a son controlâts di servidôrs o mapis di tierçs che no son supervisionâts, gjestîts o di proprietât di Mojang Studios o Microsoft.\n\nAtenzion! Sta simpri atent tal lâ daûr a colegaments e ten par te lis tos informazions privadis, includûts i dâts di acés.\n\nSe cheste videade no ti permèt di zuiâ, tu ti puedis disconeti dal servidôr doprant il boton chi sot.",
	"menu.custom_screen_info.disconnect": "Videade personalizade refudade",
	"menu.custom_screen_info.title": "Note su lis schermadis personalizadis",
	"menu.custom_screen_info.tooltip": "Cheste e je une videade personalizade. Fâs clic achì par scuvierzi di plui.",
	"menu.disconnect": "Disconetiti",
	"menu.feedback": "Coments...",
	"menu.feedback.title": "Coments",
	...
	"menu.quick_actions": "Azions sveltis...",
	"menu.quick_actions.title": "Azions sveltis",
	...
	"menu.server_links": "Colegaments dal servidôr...",
	"menu.server_links.title": "Colegaments dal servidôr",
	...
	"multiplayer.codeOfConduct.check": "No sta visâmi plui par chest codiç di compuartament",
	"multiplayer.codeOfConduct.title": "Codiç di compuartament dal servidôr",
	"multiplayer.confirm_command.parse_errors": "Tu stâs provant a eseguî un comant invalid o no ricognossût.\nSêstu sigûr?\nComant: %s",
	"multiplayer.confirm_command.permissions_required": "Tu stâs provant a eseguî un comant che al domande permès elevâts.\nChest al podarès influençâ in mût negatîf il to zûc.\nContinuâ pardabon?\nComant: %s",
	"multiplayer.confirm_command.run_command": "Eseguìs il comant",
	"multiplayer.confirm_command.signature_required": "Tu stâs provant a eseguî un comant che al inviarà messaçs te chat doprant il to non.\nAl è eseguibil dome de videade de chat\nComant: %s",
	"multiplayer.confirm_command.suggest_command": "Copie inte videade de chat",
	"multiplayer.confirm_command.title": "Conferme la esecuzion dal comant",
	"multiplayer.disconnect.authservers_down": "I servidôrs di autenticazion no funzionin. Torne prove plui indenant!",
	"multiplayer.disconnect.bad_chat_index": "Ricevût un messaç de chat mancjant o reordenât dal servidôr",
	...
	"multiplayer.disconnect.banned.reason.default": "Bandît/ide di un operadôr.",
	...
	"multiplayer.disconnect.code_of_conduct": "Il servidôr al domande di acetâ il codiç di compuartament",
	"multiplayer.disconnect.configuration_error": "Erôr no previodût intant da configurazion",
	...
	"multiplayer.disconnect.invalid_player_data": "Dâts dal zuiadôr no valits",
	...
	"multiplayer.disconnect.unsigned_chat": "Ricevût un pachet de chat cence firme o cun firme no valide.",
	...
	"multiplayer.status.anonymous_player": "Zuiadôr anonim",
	...
	"narration.checkbox.usage.focused.check": "Frache Invie par selezionâ",
	"narration.checkbox.usage.focused.uncheck": "Frache Invie par gjavâ la selezion",
	"narration.checkbox.usage.hovered": "Clic di çampe par comutâ",
	"narration.checkbox.usage.hovered.check": "Clic di çampe par selezionâ",
	"narration.checkbox.usage.hovered.uncheck": "Clic di çampe par gjavâ la selezion",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Frache Invie par cambiâ il valôr dal cursôr",
	...
	"narrator.button.accessibility": "Acès facilitât",
	...
	"narrator.ready_to_play": "Pront par zuiâ",
	...
	"optimizeWorld.confirm.proceed": "Cree une copie di sigurece e otimize",
	...
	"optimizeWorld.stage.finished.chunks": "Daûr a completâ l'inzornament dai tocs...",
	"optimizeWorld.stage.finished.entities": "Daûr a completâ l'inzornament des entitâts...",
	"optimizeWorld.stage.finished.poi": "Daûr a completâ l'inzornament dai ponts di interès...",
	"optimizeWorld.stage.upgrading": "Inzornament di ducj i tocs...",
	"optimizeWorld.stage.upgrading.chunks": "Inzornament di ducj i tocs...",
	"optimizeWorld.stage.upgrading.entities": "Inzornament di dutis lis entitâts...",
	"optimizeWorld.stage.upgrading.poi": "Inzornament di ducj i ponts di interès...",
	...
	"options.accessibility.high_contrast_block_outline": "Contors evidents",
	"options.accessibility.high_contrast_block_outline.tooltip": "Al fâs cressi il contrast dal contor dal bloc pontât.",
	"options.accessibility.link": "Vuide pal acès facilitât",
	"options.accessibility.menu_background_blurriness": "Metude a fûc dal fonts dal menù",
	"options.accessibility.menu_background_blurriness.tooltip": "Modifiche la metude a fûc dal fonts dal menù.",
	...
	"options.accessibility.title": "Impostazions acès facilitât",
	"options.accessibility.tooltip": "Accessibility Settings",
	"options.allowCursorChanges": "Permet modifichis al cursôr",
	"options.allowCursorChanges.tooltip": "Al permet la modifiche dal aspiet dal cursôr dal mouse passant parsore di cualchi element de interface utent.",
	...
	"options.chat.delay": "Ritart chat: %s secont(s)",
	"options.chat.delay_none": "Ritart chat: Nissun",
	"options.chat.drafts": "Salve i messaçs no inviâts",
	"options.chat.drafts.tooltip": "I messaçs no inviâts a vignaràn salvâts e inviâts cuant che tu tornis a vierzi la chat.",
	...
	"options.chunkFade": "Timp par sfantâ i tocs",
	"options.chunkFade.none": "Disfasiment dai tocs: no",
	"options.chunkFade.seconds": "Disfasiment dai tocs: %s s",
	"options.chunkFade.tooltip": "Trop timp in seconts par sfantâ i tocs al prin cjariament.",
	...
	"options.cutoutLeaves": "Fueis trasparentis",
	"options.cutoutLeaves.tooltip": "Al permet di viodi di traviers das busis das fueis. Disabilitâ cheste opzion al miore lis prestazions.",
	...
	"options.darknessEffectScale.tooltip": "Al controle trop che al pulse l'efiet di scuretât cuant che une vuardie o un Sculk zigon tal cause.",
	"options.difficulty": "Dificoltât",
	"options.difficulty.easy": "Facile",
	"options.difficulty.easy.info": "I mostris si gjenerin ma a fasin mancul dam. La sbare de fam si esaurìs e e sbasse la salût fin a 5 cûrs.",
	"options.difficulty.hard": "Dificile",
	"options.difficulty.hard.info": "I mostris si gjenerin e a fasin plui dam. La sbare de fam si esaurìs e e scunìs la salût dal dut.",
	"options.difficulty.hardcore": "Impegnative",
	"options.difficulty.normal": "Normâl",
	"options.difficulty.normal.info": "I mostris si gjenerin e a fasin dams normâi. La sbare de fam si esaurìs e e sbasse la salût fin a mieç cûr.",
	"options.difficulty.online": "Dificoltât dal servidôr",
	"options.difficulty.peaceful": "Pacifiche",
	"options.difficulty.peaceful.info": "Nol gjenere mostris e cualchi creature neutrâl. La sbare de fam no si esaurìs e la salût si ripristine cul timp a lâ.",
	"options.directionalAudio": "Audio direzionâl",
	"options.directionalAudio.off.tooltip": "Sun stereo classic.",
	"options.directionalAudio.on.tooltip": "Al dopre l'audio direzionâl basât su HRTF par miorâ la simulazion dal sun 3D. Al covente un machinari audio compatibil cun HRTF e al funzione miôr cu lis scufis.",
	...
	"options.exclusiveFullscreen": "Plen visôr esclusîf",
	"options.exclusiveFullscreen.warningTooltip": "Cheste opzions e podarès impedî il funzionament di cualchi comant.",
	"options.font": "Impostazions caratar...",
	"options.font.title": "Impostazions caratar",
	...
	"options.glintStrength": "Intensitât dal lusarili",
	"options.glintStrength.tooltip": "Al controle la trasparence dal lusarili sui ogjets incjantâts.",
	"options.graphics": "Grafiche",
	"options.graphics.custom": "Personalizade",
	...
	"options.graphics.preset": "Model",
	"options.graphics.preset.tooltip": "Al assegne valôrs predefinîts resonevui a lis impostazions di \"Cualitât e prestazions\", daûr la cualitât desiderade.",
	...
	"options.graphicsApi": "API grafic",
	"options.graphicsApi.default": "Predefinît",
	"options.graphicsApi.opengl": "OpenGL",
	"options.graphicsApi.restart": "Al è necessari tornâ a inviâ il zûc par cambiâ il API grafic.",
	"options.graphicsApi.tooltip": "L'interface di programazion (API in inglês) doprade par gjenerâ la videade. No stâ tocjâ cence un motîf valit!",
	...
	"options.hideLightningFlashes": "Plate i lamps tal cîl",
	"options.hideLightningFlashes.tooltip": "Al impedìs ai lamps dai fulmins o altris efiets ambientai di iluminâ il cîl. Al sarà simpri pussibil viodi i fulmins.",
	...
	"options.hideSplashTexts": "Plate tescj iniziâi",
	"options.hideSplashTexts.tooltip": "Plate i tescj iniziâi zâi tal menù principâl.",
	"options.improvedTransparency": "Trasparence miorade",
	"options.improvedTransparency.tooltip": "Une tecniche sperimentâl che e dopre lis ombrenaduris (shaders) par dissegnâ il timp meteorologjic, i nûi, lis particelis daûr dai blocs translucits e la aghe.\nChest al influìs su lis prestazions de schede grafiche.",
	"options.inGameNotification": "In-Game Notification",
	"options.inGameNotification.tooltip": "Show Friend notifications in-game",
	"options.inactivityFpsLimit": "Ridûs frecuence se",
	"options.inactivityFpsLimit.afk": "Inatîf",
	"options.inactivityFpsLimit.afk.tooltip": "Limite la frecuence dai fotograms a 30 cuant che il zuiadôr nol da comants par plui di un minût. Limite a 10 dopo altris 9 minûts.",
	"options.inactivityFpsLimit.minimized": "Minimizât",
	"options.inactivityFpsLimit.minimized.tooltip": "Limite la frecuence dai fotograms dome cuant che il barcon dal zûc al è minimizât.",
	"options.invertMouse": "Invertìs il mouse",
	"options.invertMouseX": "Invertìs l'as x dal mouse",
	"options.invertMouseY": "Invertìs l'as y dal mouse",
	"options.japaneseGlyphVariants": "Variantis dai caratars gjaponês",
	"options.japaneseGlyphVariants.tooltip": "Dopre lis variantis gjaponesis dai caratars CJK tai caratars predefinîts.",
	...
	"options.maxAnisotropy": "Filtri anisotrop",
	"options.maxAnisotropy.tooltip": "Ogni nivel al miore une vore la clarece des tramis, ma al influìs su lis prestazions e al aumente no pôc l'ûs de memorie grafiche. Al è necessari impostâ il filtri des tramis su anisotrop.",
	...
	"options.musicToast": "Notifichis de musiche",
	"options.musicToast.never": "Mai",
	"options.musicToast.never.tooltip": "No vegnin mostradis lis notifichis de musiche.",
	"options.musicToast.pauseMenu": "Dome tal menù di pause",
	"options.musicToast.pauseMenu.tooltip": "Al mostre une notifiche tal menù di pause dal zûc cuant che la musiche e sune.",
	"options.musicToast.pauseMenuAndToast": "Simpri",
	"options.musicToast.pauseMenuAndToast.tooltip": "Al mostre une notifiche cuant che une musiche e tache a sunâ. Cheste notifiche e ven ancje mostrade tal menù di pause dal zûc cuant che la musiche e sune.",
	"options.music_frequency": "Frecuence musiche",
	"options.music_frequency.constant": "Costant",
	"options.music_frequency.default": "Predefinît",
	"options.music_frequency.frequent": "Frecuent",
	"options.music_frequency.tooltip": "Al modifiche trop dispès che e ven riprodote la musiche intun mont dal zûc.",
	...
	"options.needsRestart": "Torne invie il zûc par aplicâ cheste opzion.",
	"options.notifications.display_time": "Durade des notifichis",
	"options.notifications.display_time.tooltip": "Al regole par trop timp che dutis lis notifichis a restin visibilis su schermi.",
	"options.off": "No",
	...
	"options.onlyShowSecureChat.tooltip": "Mostre dome i messaçs di altris zuiadôrs che a son verificâts pal mitent e che no son stâts modificâts.",
	...
	"options.prioritizeChunkUpdates.byPlayer.tooltip": "Cualchi azion tal toc, come plaçâ o spacâ i blocs, lu tornarà a compilâ daurman.",
	...
	"options.realmsNotifications.tooltip": "Recupere notiziis e invîts di Realms tal menù principâl e mostre lis lôr iconis tal boton di Realms.",
	"options.reducedDebugInfo": "Dâts di F3 ridots",
	"options.renderClouds": "Nûi",
	"options.renderCloudsDistance": "Distance dai nûi",
	...
	"options.rotateWithMinecart": "Zire cul carel minerari",
	"options.rotateWithMinecart.tooltip": "Controle se la visuâl dal zuiadôr e zire cul zirâ dal carel minerari. Disponibil dome tai monts cun la impostazion sperimentâl \"Mioraments dai carei mineraris\" ative.",
	...
	"options.showNowPlayingToast": "Mostre lis notifichis de musiche",
	"options.showNowPlayingToast.tooltip": "Al mostre une notifiche cuant che une musiche e tache a sunâ. Cheste notifiche e ven ancje mostrade tal menù di pause dal zûc cuant che la musiche e sune.",
	"options.showSubtitles": "Sottitui",
	"options.showSubtitles.tooltip": "Mostre i sottitui par i suns riprodots tal zûc.",
	...
	"options.sprintWindow": "Interval par la corse",
	"options.sprintWindow.tooltip": "Interval di timp in ticadis entri cui il fracâ dos voltis il tast \"Cjaminâ indenant\" al ative la corse.",
	...
	"options.telemetry.disabled": "Telemetrie disabilitade.",
	"options.telemetry.state.all": "Ducj",
	"options.telemetry.state.minimal": "Minims",
	"options.telemetry.state.none": "Nissun",
	"options.textureFiltering": "Filtri des tramis",
	"options.textureFiltering.anisotropic": "Anisotrop",
	"options.textureFiltering.anisotropic.tooltip": "Un filtri basât sul hardware, al influìs su lis prestazions e al aumente une vore l'ûs de memorie grafiche. Al podarès no jessi compatibil cun ducj i dispositîfs.",
	"options.textureFiltering.none": "Nissun",
	"options.textureFiltering.none.tooltip": "Nol ven doprât nissun filtri pes tramis. I blocs a puedin mostrâsi smamîts di cualchi angul.",
	"options.textureFiltering.rgss": "SCRZ",
	"options.textureFiltering.rgss.tooltip": "Il SuperCampionament a Rêt Zirade (SCRZ, in inglês RGSS) al è un filtri basât su ombrenaduris che al miore la cualitât des tramis, cun impat moderât su lis prestazions.",
	"options.title": "Opzions",
	"options.touchscreen": "Modalitât schermi tatil",
	"options.value": "%s",
	"options.video": "Impostazions video...",
	"options.video.display.header": "Visôr",
	"options.video.interface.header": "Interface",
	"options.video.preferences.header": "Preferencis",
	"options.video.quality.header": "Cualitât e prestazions",
	"options.videoTitle": "Impostazions video",
	"options.viewBobbing": "Pendolâ",
	"options.vignette": "Mostre vignetadure",
	"options.vignette.tooltip": "Une grafiche lizere parsore de videade di zûc, doprade par diminuî la luminositât tai margjins de videade e visâ dai confins dal mont.",
	"options.visible": "Visibil",
	"options.vsync": "VSync",
	"options.weatherRadius": "Rai dal meteo",
	"options.weatherRadius.tooltip": "Il rai dulà che i efiets di ploie e nêf a son visibii. Al influìs poc su lis prestazions.",
	"options.worldOptions.button": "Opzions dal mont...",
	"options.worldOptions.title": "Opzions dal mont",
	...
	"pack.dropInfo": "Strissine e mole i pachets in cheste videade par zontâju",
	...
	"pack.incompatible.confirm.unknown": "Chest pachet al è ruvinât o al è stât fat par une version no cognossude di Minecraft e al è probabil che nol funzioni ben.",
	...
	"pack.incompatible.unknown": "(Ruvinât o incompatibil)",
	...
	"painting.minecraft.backyard.title": "Curtîl",
	...
	"painting.minecraft.bouquet.title": "Macet",
	...
	"painting.minecraft.cavebird.title": "Uciel dai landris",
	"painting.minecraft.changing.author": "Kristoffer Zetterstrand",
	"painting.minecraft.changing.title": "Cambi",
	...
	"painting.minecraft.lowmist.title": "Fumadice basse",
	...
	"painting.minecraft.orb.title": "Sfere",
	"painting.minecraft.owlemons.author": "Kristoffer Zetterstrand",
	"painting.minecraft.owlemons.title": "Limons e çus",
	"painting.minecraft.passage.author": "Kristoffer Zetterstrand",
	"painting.minecraft.passage.title": "Passaç",
	...
	"painting.minecraft.sunflowers.title": "Gjirasoi",
	...
	"painting.minecraft.unpacked.title": "Dispacât",
	...
	"particle.invalidOptions": "Impussibil esaminâ lis opzions de particele: %s",
	...
	"quickplay.error.invalid_identifier": "Impussibil cjatâ il mont cul identificadôr furnît",
	"quickplay.error.realm_connect": "Impussibil conetisi al Realm",
	"quickplay.error.realm_permission": "Al mancje il permès par conetisi a chest Realm",
	"quickplay.error.title": "Alc al è lât strucj te partide svelte",
	"realms.configuration.region.australia_east": "Gnûf Gales dal Sud, Australie",
	"realms.configuration.region.australia_southeast": "Victoria, Australie",
	"realms.configuration.region.brazil_south": "Brasîl",
	"realms.configuration.region.central_india": "Indie",
	"realms.configuration.region.central_us": "Iowa, Stâts Unîts di Americhe",
	"realms.configuration.region.east_asia": "Hong Kong",
	"realms.configuration.region.east_us": "Virginia, Stâts Unîts di Americhe",
	"realms.configuration.region.east_us_2": "Carolina dal Nord, Stâts Unîts di Americhe",
	"realms.configuration.region.france_central": "France",
	"realms.configuration.region.japan_east": "Gjapon dal Est",
	"realms.configuration.region.japan_west": "Gjapon dal Ovest",
	"realms.configuration.region.korea_central": "Coree dal Sud",
	"realms.configuration.region.north_central_us": "Illinois, Stâts Unîts di Americhe",
	"realms.configuration.region.north_europe": "Irlande",
	"realms.configuration.region.south_central_us": "Texas, Stâts Unîts di Americhe",
	"realms.configuration.region.southeast_asia": "Singapôr",
	"realms.configuration.region.sweden_central": "Svezie",
	"realms.configuration.region.uae_north": "Emirâts Araps Unîts",
	"realms.configuration.region.uk_south": "Ingletiere dal Sud",
	"realms.configuration.region.west_central_us": "Utah, Stâts Unîts di Americhe",
	"realms.configuration.region.west_europe": "Paîs Bas",
	"realms.configuration.region.west_us": "California, Stâts Unîts di Americhe",
	"realms.configuration.region.west_us_2": "Washington, Stâts Unîts di Americhe",
	"realms.configuration.region_preference.automatic_owner": "Automatic (ping dal proprietari dal Realm)",
	"realms.configuration.region_preference.automatic_player": "Automatic (prin a jentrâ te session)",
	"realms.missing.snapshot.error.text": "Realms pal moment nol è supuartât tes versions sperimentâls",
	...
	"resourcePack.runtime_failure": "Erôr dal pachet di risorsis",
	...
	"restrictions_screen.button": "Limitazions...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Tu puedis ricevi messaçs dai zuiadôrs",
	"restrictions_screen.permission.receive_player_messages.denied": "No tu puedis ricevi messaçs dai zuiadôrs",
	"restrictions_screen.permission.receive_system_messages.allowed": "Tu puedis ricevi messaçs di sisteme dal servidôr",
	"restrictions_screen.permission.receive_system_messages.denied": "No tu puedis ricevi messaçs di sisteme dal servidôr",
	"restrictions_screen.permission.send_commands.allowed": "Tu puedis inviâ comants",
	"restrictions_screen.permission.send_commands.denied": "No tu puedis inviâ comants",
	"restrictions_screen.permission.send_messages.allowed": "Tu puedis inviâ il messaçs de chat",
	"restrictions_screen.permission.send_messages.denied": "No tu puedis inviâ il messaçs de chat",
	"restrictions_screen.title": "Limitazions",
	...
	"selectWorld.allowCommands.new": "Permet comants",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Desideristu creâ une copie di sigurece prime di inzornâ il mont?",
	...
	"selectWorld.backupWarning.downgrade": "La ultime volte che chest mont al è stât zuiât, al jere te version %s; tu tu stâs doprant la version %s. Il tornâ indaûr di version di un mont al pues causâ coruzions - no podìn garantî che si cjami o che al funzioni. Se tu desideris distès continuâ, fâs prime une copie di sigurece.",
	...
	"selectWorld.backupWarning.file_fixing_required": "Al è necessari inzornâ chest mont prime di zuiâ. Ti consein in mût fuart di fâ une copie di sigurece tal câs che tu ledis incuintri a problemis di coruzion dal mont.",
	"selectWorld.backupWarning.snapshot": "La ultime volte chest mont al è stât zuiât te version %s; tu tu sês te version %s. Fâs une copie di sigurece tal câs che tu ledis incuintri a problemis di coruzion dal mont.",
	"selectWorld.bonusItems": "Casse di jutori",
	"selectWorld.cheats": "Trucs",
	"selectWorld.commands": "Comants",
	"selectWorld.conversion": "Al è necessari convertîlu!",
	"selectWorld.conversion.tooltip": "Par vê une conversion sigure, chest mont al à di jessi vierzût intune version plui vecje (come la 1.6.4)",
	...
	"selectWorld.edit.backupFolder": "Vierç la cartele des copiis di sigurece",
	...
	"selectWorld.experiments.info": "I esperiments a son gnovis funzionalitâts che un doman a podaressin vignî zontâts al zûc. Atenzion: i esperiments a puedin causâ erôrs e nol è pussibil disativâju dopo de creazion dal mont.",
	...
	"selectWorld.gameMode.creative.info": "Cree, costruìs e esplore cence limits. Tu puedis svolâ, vê materiâi infinîts e i mostris no ti fasin mâl.",
	...
	"selectWorld.gameMode.hardcore.info": "Modalitât Sorevivence blocade su la dificoltât 'Dificile'. Se tu mueris no tu puedis tornâ a nassi.",
	...
	"selectWorld.gameMode.survival.info": "Esplore un mont misteriôs, dulà che tu puedis costruî, tirâ dongje risorsis, fabricâ ogjets e combati i mostris.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Al è necessari inzornâ chest mont ae ultime version prime di fâ modifichis, par vie di cambiaments struturai al formât dal mont.",
	"selectWorld.requiresFileFixingTooltip.play": "Al è necessari inzornâ chest mont ae ultime version prime di zuiâ, par vie di cambiaments struturai al formât dal mont.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Al è necessari inzornâ chest mont ae ultime version prime di tornâ a creâlu, par vie di cambiaments struturai al formât dal mont.",
	...
	"selectWorld.tooltip.fromNewerVersion2": "e cjariâlu al podarès causâ problemis!",
	...
	"selectWorld.upgrade_and_play": "Inzorne e zuie",
	...
	"selectWorld.waitingForBackup.message": "In base ae dimension dal mont, cheste operazion e podarès tirâle a dilunc. No sta sierâ il mont o distudâ il dispositîf.",
	"selectWorld.waitingForBackup.title": "Daûr a creâ la copie di sigurece",
	"selectWorld.warning.deprecated.question": "Cualchi funzionalitât doprade e je deplorade e un doman no funzionarà plui. Continuâ?",
	...
	"selectWorld.warning.lowDiskSpace.description": "Al reste pôc spazi libar tal to dispositîf.\nFinî il spazi sul disc dilunc di une session di zûc al podarès comprometi il mont.",
	"selectWorld.warning.lowDiskSpace.title": "Atenzion! Pôc spazi sul disc!",
	"selectWorld.world": "Mont",
	"selectWorld.world_gen_settings_access": "Impussibil lei o jentrâ tai parametris di gjenerazion dal mont! %s",
	"selecteWorld.backupRequiredTooltip": "Al è necessari creâ une copie di sigurece prime di cjariâ il mont",
	...
	"sleep.skipping_night": "Tu stâs passant la gnôt a polsâ",
	"slot.only_single_allowed": "Si ametin dome spazis singui, si à vût '%s'",
	"slot.unknown": "Spazi '%s' no cognossût",
	"snbt.parser.empty_key": "La clâf no pues jessi vueide",
	"snbt.parser.expected_binary_numeral": "Al jere previodût un numar binari",
	"snbt.parser.expected_decimal_numeral": "Al jere previodût un numar decimâl",
	"snbt.parser.expected_float_type": "Al jere previodût un numar in virgule mobile",
	"snbt.parser.expected_hex_escape": "Al jere previodût un caratar leterâl di lungjece %s",
	"snbt.parser.expected_hex_numeral": "Al jere previodût un numar esadecimâl",
	"snbt.parser.expected_integer_type": "Al jere previodût un numar intîr",
	"snbt.parser.expected_non_negative_number": "Al jere previodût un numar no negatîf",
	"snbt.parser.expected_number_or_boolean": "Al jere previodût un numar o un boolean",
	"snbt.parser.expected_string_uuid": "E jere previodude une stringhe cuntun UUID valit",
	"snbt.parser.expected_unquoted_string": "E jere previodude une stringhe valide cence virgulutis",
	"snbt.parser.infinity_not_allowed": "I numars no finîts no son permetûts",
	"snbt.parser.invalid_array_element_type": "Gjenar di element dal array no valit",
	"snbt.parser.invalid_character_name": "Non dal caratar unicode no valit",
	"snbt.parser.invalid_codepoint": "Valôr dal caratar unicode no valit: %s",
	"snbt.parser.invalid_string_contents": "Contignûts de stringhe no valits",
	"snbt.parser.invalid_unquoted_start": "Lis stringhis cence virgulutis no puedin tacâ cun lis cifris 0-9, cun + o cun -",
	"snbt.parser.leading_zero_not_allowed": "I numars decimâls no puedin tacâ cun 0",
	"snbt.parser.no_such_operation": "Nissune operazion: %s",
	"snbt.parser.number_parse_failure": "Impussibil esaminâ il numar: %s",
	"snbt.parser.undescore_not_allowed": "I tratuts bas no son permetûts tal inizi o ae fin di un numar",
	...
	"soundCategory.ui": "Interface utent",
	"soundCategory.voice": "Naratôr/Vôs",
	...
	"stat.minecraft.happy_ghast_one_cm": "Distance dal Ghast legri",
	...
	"stat.minecraft.nautilus_one_cm": "Distance su nautil",
	...
	"stat.minecraft.total_world_time": "Timp cul mont viert",
	...
	"subtitles.block.candle.extinguish": "Cjandele distudade",
	...
	"subtitles.block.copper_chest.close": "Baûl si siere",
	"subtitles.block.copper_chest.open": "Baûl al ven viert",
	"subtitles.block.copper_trapdoor.close": "Trabuchel si siere",
	"subtitles.block.copper_trapdoor.open": "Trabuchel si vierç",
	"subtitles.block.crafter.craft": "Fabricadôr al fabriche",
	"subtitles.block.crafter.fail": "Erôr dal fabricadôr",
	"subtitles.block.creaking_heart.hurt": "Cûr dal cric al bruntule",
	"subtitles.block.creaking_heart.idle": "Rumôr incuietant",
	"subtitles.block.creaking_heart.spawn": "Cûr dal cric si svee",
	"subtitles.block.deadbush.idle": "Suns secs",
	...
	"subtitles.block.dried_ghast.ambient": "Ghast secjât al sflade",
	"subtitles.block.dried_ghast.ambient_water": "Ghast secjât si torne a idratâ",
	"subtitles.block.dried_ghast.place_in_water": "Ghast secjât si imbombe",
	"subtitles.block.dried_ghast.transition": "Ghast secjât si sint miôr",
	"subtitles.block.dry_grass.ambient": "Suns di aiar che al tire",
	...
	"subtitles.block.eyeblossom.close": "Rose-voli si siere",
	"subtitles.block.eyeblossom.idle": "Rose-voli e cisiche",
	"subtitles.block.eyeblossom.open": "Rose-voli si vierç",
	...
	"subtitles.block.firefly_bush.idle": "Businâ di lusigne",
	...
	"subtitles.block.generic.fall": "Alc al cole su di un bloc",
	...
	"subtitles.block.pale_hanging_moss.idle": "Rumôr incuietant",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Fontane di solfar e erute",
	"subtitles.block.potent_sulfur.noxious_gas": "Esalazion nocive",
	...
	"subtitles.block.sand.idle": "Suns di savalon",
	"subtitles.block.sand.wind": "Suns di aiar che al tire",
	...
	"subtitles.block.shelf.activate": "Scansie ativade",
	"subtitles.block.shelf.deactivate": "Scansie disativade",
	"subtitles.block.shelf.multi_swap": "Ogjets scambiâts",
	"subtitles.block.shelf.place_item": "Ogjet plaçât",
	"subtitles.block.shelf.single_swap": "Ogjet scambiât",
	"subtitles.block.shelf.take_item": "Ogjet cjolt",
	"subtitles.block.shulker_box.close": "Scjatule di Shulker si siere",
	"subtitles.block.shulker_box.open": "Scjatule di Shulker si vierç",
	...
	"subtitles.block.trapdoor.close": "Trabuchel si siere",
	"subtitles.block.trapdoor.open": "Trabuchel si vierç",
	"subtitles.block.trapdoor.toggle": "Trabuchel al ciule",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Ogjet dal malauguri si prepare",
	"subtitles.block.trial_spawner.ambient": "Sclopetament dal gjeneradôr de prove",
	"subtitles.block.trial_spawner.ambient_charged": "Sclopetament dal gjeneradôr de prove dal maluguri",
	"subtitles.block.trial_spawner.ambient_ominous": "Sclopetament dal gjeneradôr de prove dal maluguri",
	"subtitles.block.trial_spawner.charge_activate": "Malauguri al inglobe il gjeneradôr de prove",
	...
	"subtitles.block.trial_spawner.ominous_activate": "Malauguri al inglobe il gjeneradôr de prove",
	"subtitles.block.trial_spawner.open_shutter": "Gjeneradôr de prove si vierç",
	"subtitles.block.trial_spawner.spawn_item": "Ogjet dal malauguri al cole",
	"subtitles.block.trial_spawner.spawn_item_begin": "Ogjet dal malauguri al ven fûr",
	"subtitles.block.trial_spawner.spawn_mob": "Creature de prove e nas",
	...
	"subtitles.block.vault.activate": "Cassefuarte si impie",
	"subtitles.block.vault.ambient": "Sclopetament di cassefuarte",
	"subtitles.block.vault.close_shutter": "Cassefuarte si siere",
	"subtitles.block.vault.deactivate": "Cassefuarte si distude",
	"subtitles.block.vault.eject_item": "Cassefuarte e bute fûr un ogjet",
	"subtitles.block.vault.insert_item": "Cassefuarte si sbloche",
	"subtitles.block.vault.insert_item_fail": "Cassefuarte no si sbloche",
	"subtitles.block.vault.open_shutter": "Cassefuarte si vierç",
	"subtitles.block.vault.reject_rewarded_player": "Cassefuarte e refude un zuiadôr",
	"subtitles.block.water.ambient": "Aghe che e cor",
	"subtitles.block.wet_sponge.dries": "Sponze si secje",
	...
	"subtitles.entity.allay.ambient_with_item": "Slizeridôr al cjace",
	"subtitles.entity.allay.ambient_without_item": "Slizeridôr al brame",
	"subtitles.entity.allay.death": "Slizeridôr al mûr",
	"subtitles.entity.allay.hurt": "Slizeridôr ferît",
	"subtitles.entity.allay.item_given": "Slizeridôr al rît",
	"subtitles.entity.allay.item_taken": "Slizeridôr al cjape sù",
	"subtitles.entity.allay.item_thrown": "Slizeridôr al tire",
	...
	"subtitles.entity.armadillo.hurt_reduced": "Armadil si pare",
	"subtitles.entity.armadillo.land": "Armadil al tocje tiere",
	"subtitles.entity.armadillo.peek": "Armadil al cuche",
	"subtitles.entity.armadillo.roll": "Armadil si inrodole",
	"subtitles.entity.armadillo.scute_drop": "Armadil al piert un scus",
	"subtitles.entity.armadillo.unroll_finish": "Armadil si disrodole",
	"subtitles.entity.armadillo.unroll_start": "Armadil al cuche",
	...
	"subtitles.entity.baby_cat.ambient": "Gnauleç di gjatut",
	"subtitles.entity.baby_cat.beg_for_food": "Gjatut al domande mangjative",
	"subtitles.entity.baby_cat.death": "Gjatut al mûr",
	"subtitles.entity.baby_cat.eat": "Gjatut al mangje",
	"subtitles.entity.baby_cat.hiss": "Gjatut al tufe",
	"subtitles.entity.baby_cat.hurt": "Gjatut ferît",
	"subtitles.entity.baby_cat.purr": "Gjatut al fâs fûs",
	"subtitles.entity.baby_chicken.ambient": "Poleçut al piule",
	"subtitles.entity.baby_chicken.death": "Poleçut al mûr",
	"subtitles.entity.baby_chicken.hurts": "Poleçut ferît",
	"subtitles.entity.baby_horse.ambient": "Puieri al sgagnìs",
	"subtitles.entity.baby_horse.angry": "Puieri al sgagnìs",
	"subtitles.entity.baby_horse.breathe": "Respîr di puieri",
	"subtitles.entity.baby_horse.death": "Puieri al mûr",
	"subtitles.entity.baby_horse.eat": "Puieri al mangje",
	"subtitles.entity.baby_horse.hurt": "Puieri ferît",
	"subtitles.entity.baby_horse.land": "Puieri al tocje tiere",
	"subtitles.entity.baby_nautilus.ambient": "Piçul di nautil al scriule",
	"subtitles.entity.baby_nautilus.ambient_land": "Piçul di nautil al scriule",
	"subtitles.entity.baby_nautilus.death": "Piçul di nautil al mûr",
	"subtitles.entity.baby_nautilus.death_land": "Piçul di nautil al mûr",
	"subtitles.entity.baby_nautilus.eat": "Piçul di nautil al mangje",
	"subtitles.entity.baby_nautilus.hurt": "Piçul di nautil ferît",
	"subtitles.entity.baby_nautilus.hurt_land": "Piçul di nautil ferît",
	"subtitles.entity.baby_nautilus.swim": "Piçul di nautil al nade",
	"subtitles.entity.baby_pig.ambient": "Purcitut al rugne",
	"subtitles.entity.baby_pig.death": "Purcitut al mûr",
	"subtitles.entity.baby_pig.eat": "Purcitut al mangje",
	"subtitles.entity.baby_pig.hurt": "Purcitut ferît",
	"subtitles.entity.baby_wolf.ambient": "Piçul di lôf al vuiche",
	"subtitles.entity.baby_wolf.death": "Piçul di lôf al mûr",
	"subtitles.entity.baby_wolf.growl": "Piçul di lôf al rugne",
	"subtitles.entity.baby_wolf.hurt": "Piçul di lôf ferît",
	"subtitles.entity.baby_wolf.pant": "Piçul di lôf al sflade",
	"subtitles.entity.baby_wolf.whine": "Piçul di lôf sì lamente",
	...
	"subtitles.entity.bogged.ambient": "Criçâ di paludan",
	"subtitles.entity.bogged.death": "Paludan al mûr",
	"subtitles.entity.bogged.hurt": "Paludan ferît",
	...
	"subtitles.entity.breeze.wind_burst": "Cjarie di aiar e sclope",
	...
	"subtitles.entity.camel_husk.ambient": "Dromedari sec al rugne",
	"subtitles.entity.camel_husk.dash": "Dromedari sec al salte",
	"subtitles.entity.camel_husk.dash_ready": "Dromedari sec al torne a dâ di ca",
	"subtitles.entity.camel_husk.death": "Dromedari sec al mûr",
	"subtitles.entity.camel_husk.eat": "Dromedari sec al mangje",
	"subtitles.entity.camel_husk.hurt": "Dromedari sec ferît",
	"subtitles.entity.camel_husk.saddle": "Siele metude sù",
	"subtitles.entity.camel_husk.sit": "Dromedari sec si sente",
	"subtitles.entity.camel_husk.stand": "Dromedari sec si alce",
	...
	"subtitles.entity.copper_golem.death": "Golem di ram al mûr",
	"subtitles.entity.copper_golem.hurt": "Golem di ram ferît",
	"subtitles.entity.copper_golem.item_drop": "Golem di ram al plaçe un ogjet",
	"subtitles.entity.copper_golem.item_no_drop": "Golem di ram al falìs tal plaçâ un ogjet",
	"subtitles.entity.copper_golem.no_item_get": "Golem di ram al cjape sù un ogjet",
	"subtitles.entity.copper_golem.no_item_no_get": "Golem di ram al falìs tal cjapâ sù un ogjet",
	"subtitles.entity.copper_golem.spawn": "Golem di ram al comparìs",
	"subtitles.entity.copper_golem.spin": "Cjâf dal golem di ram si volte",
	"subtitles.entity.copper_golem_become_statue": "Golem di ram petrificât",
	"subtitles.entity.copper_golem_oxidized.death": "Golem di ram al mûr",
	"subtitles.entity.copper_golem_oxidized.hurt": "Golem di ram ferît",
	"subtitles.entity.copper_golem_oxidized.spin": "Cjâf dal golem di ram si volte",
	"subtitles.entity.copper_golem_weathered.death": "Golem di ram al mûr",
	"subtitles.entity.copper_golem_weathered.hurt": "Golem di ram ferît",
	"subtitles.entity.copper_golem_weathered.spin": "Cjâf dal golem di ram si volte",
	...
	"subtitles.entity.creaking.activate": "Cric al cjale",
	"subtitles.entity.creaking.ambient": "Cric al criche",
	"subtitles.entity.creaking.attack": "Cric al atache",
	"subtitles.entity.creaking.deactivate": "Cric si calme",
	"subtitles.entity.creaking.death": "Cric si fruçone",
	"subtitles.entity.creaking.freeze": "Cric si ferme",
	"subtitles.entity.creaking.spawn": "Cric al comparis",
	"subtitles.entity.creaking.sway": "Cric colpît",
	"subtitles.entity.creaking.twitch": "Cric si plee",
	"subtitles.entity.creaking.unfreeze": "Cric si môf",
	...
	"subtitles.entity.donkey.jump": "Mus al salte",
	...
	"subtitles.entity.fish.swim": "Sclipignadis di aghe",
	...
	"subtitles.entity.ghastling.ambient": "Ghastinut al grugjule",
	"subtitles.entity.ghastling.death": "Ghastinut al mûr",
	"subtitles.entity.ghastling.hurt": "Ghastinut ferît",
	"subtitles.entity.ghastling.spawn": "Ghastinut al comparìs",
	"subtitles.entity.glow_item_frame.add_item": "Curnîs luminessente jemplade",
	"subtitles.entity.glow_item_frame.break": "Curnîs luminessente distrute",
	"subtitles.entity.glow_item_frame.place": "Curnîs luminessente plaçade",
	"subtitles.entity.glow_item_frame.remove_item": "Curnîs luminessente disvuedade",
	...
	"subtitles.entity.happy_ghast.ambient": "Ghast legri al cjantuce",
	"subtitles.entity.happy_ghast.death": "Ghast legri al mûr",
	"subtitles.entity.happy_ghast.equip": "Imbragadure peade",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Ghast legri al è pront",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Ghast legri si ferme",
	"subtitles.entity.happy_ghast.hurt": "Ghast legri ferît",
	"subtitles.entity.happy_ghast.unequip": "Imbragadure disleade",
	...
	"subtitles.entity.minecart.inside": "Carel minerari al scriule",
	"subtitles.entity.minecart.inside_underwater": "Carel minerari al scriule sot aghe",
	...
	"subtitles.entity.mule.jump": "Mûl al salte",
	"subtitles.entity.nautilus.ambient": "Nautil al scjoche",
	"subtitles.entity.nautilus.ambient_land": "Nautil al scjoche",
	"subtitles.entity.nautilus.dash": "Nautil si propulse",
	"subtitles.entity.nautilus.dash_land": "Nautil si propulse",
	"subtitles.entity.nautilus.dash_ready": "Nautil al torne a dâ di ca",
	"subtitles.entity.nautilus.dash_ready_land": "Nautil al torne a dâ di ca",
	"subtitles.entity.nautilus.death": "Nautil al mûr",
	"subtitles.entity.nautilus.death_land": "Nautil al mûr",
	"subtitles.entity.nautilus.eat": "Nautil al mangje",
	"subtitles.entity.nautilus.hurt": "Nautil ferît",
	"subtitles.entity.nautilus.hurt_land": "Nautil ferît",
	"subtitles.entity.nautilus.swim": "Nautil al nade",
	...
	"subtitles.entity.parched.ambient": "Criçâ di secjât",
	"subtitles.entity.parched.death": "Secjât al mûr",
	"subtitles.entity.parched.hurt": "Secjât ferît",
	...
	"subtitles.entity.parrot.imitate.bogged": "Pampagal al imite il criçâ dal paludan",
	"subtitles.entity.parrot.imitate.breeze": "Pampagal al sofle come une brise",
	"subtitles.entity.parrot.imitate.camel_husk": "Pampagal al rugne come un dromedari sec",
	"subtitles.entity.parrot.imitate.creaking": "Pampagal al criche",
	...
	"subtitles.entity.parrot.imitate.parched": "Pampagal al imite il criçâ dal secjât",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Pampagal al imite il lament di un cjaval zombi",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Pampagal al clucugne come un nautil zombi",
	...
	"subtitles.entity.pig.eat": "Purcit al mangje",
	...
	"subtitles.entity.player.freeze_hurt": "Zuiadôr si inglace",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Scheletri di cjaval al salte",
	...
	"subtitles.entity.sulfur_cube.absorb": "Cubi di solfar plen",
	"subtitles.entity.sulfur_cube.bounce": "Cubi di solfar al sbalçe",
	"subtitles.entity.sulfur_cube.death": "Cubi di solfar al mûr",
	"subtitles.entity.sulfur_cube.eject": "Bloc gjavât vie",
	"subtitles.entity.sulfur_cube.hit": "Cubi di solfar colpît",
	"subtitles.entity.sulfur_cube.hurt": "Cubi di solfar ferît",
	"subtitles.entity.sulfur_cube.push": "Cubi di solfar sburtât",
	"subtitles.entity.sulfur_cube.squish": "Cubi di solfar al sbalçe",
	...
	"subtitles.entity.warden.agitated": "Vuardie e zem in mût gnervôs",
	"subtitles.entity.warden.ambient": "Vuardie si lamente",
	"subtitles.entity.warden.angry": "Vuardie si inrabie",
	...
	"subtitles.entity.warden.tendril_clicks": "Antenis de vuardie a sclopetin",
	"subtitles.entity.wind_charge.throw": "Cjarie di aiar e svole",
	"subtitles.entity.wind_charge.wind_burst": "Cjarie di aiar e sclope",
	...
	"subtitles.entity.zombie_horse.angry": "Cjaval zombi al sgagnìs",
	"subtitles.entity.zombie_horse.death": "Cjaval zombi al mûr",
	"subtitles.entity.zombie_horse.eat": "Cjaval zombi al mangje",
	"subtitles.entity.zombie_horse.hurt": "Cjaval zombi ferît",
	"subtitles.entity.zombie_nautilus.ambient": "Nautil zombi al clucugne",
	"subtitles.entity.zombie_nautilus.ambient_land": "Nautil zombi al clucugne",
	"subtitles.entity.zombie_nautilus.dash": "Nautil zombi si propulse",
	"subtitles.entity.zombie_nautilus.dash_land": "Nautil zombi si propulse",
	"subtitles.entity.zombie_nautilus.dash_ready": "Nautil zombi al torne a dâ di ca",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Nautil zombi al torne a dâ di ca",
	"subtitles.entity.zombie_nautilus.death": "Nautil zombi al mûr",
	"subtitles.entity.zombie_nautilus.death_land": "Nautil zombi al mûr",
	"subtitles.entity.zombie_nautilus.eat": "Nautil zombi al mangje",
	"subtitles.entity.zombie_nautilus.hurt": "Nautil zombi ferît",
	"subtitles.entity.zombie_nautilus.hurt_land": "Nautil zombi ferît",
	"subtitles.entity.zombie_nautilus.swim": "Nautil zombi al nade",
	...
	"subtitles.event.mob_effect.bad_omen": "Malauguri al cjape possès",
	"subtitles.event.mob_effect.raid_omen": "Incursion e menace chi dongje",
	"subtitles.event.mob_effect.trial_omen": "Prove dal malauguri e menace chi dongje",
	...
	"subtitles.item.armor.equip_copper": "Armadure di ram e sdrondene",
	...
	"subtitles.item.armor.equip_nautilus": "Armadure pal nautil metude sù",
	...
	"subtitles.item.armor.unequip_nautilus": "Armadure pal nautil gjavade",
	"subtitles.item.armor.unequip_wolf": "Armadure di lôf si dislee",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Cubi di solfar cjapât su",
	...
	"subtitles.item.bundle.insert_fail": "Sacut plen",
	...
	"subtitles.item.elytra.flying": "Sfruiament",
	...
	"subtitles.item.golden_dandelion.unuse": "Cressite ripristinade",
	"subtitles.item.golden_dandelion.use": "Cressite blocade",
	"subtitles.item.hoe.till": "Sapâ di sape",
	"subtitles.item.honey_bottle.drink": "Glotude di mîl",
	"subtitles.item.honeycomb.wax_on": "Cere metude",
	"subtitles.item.horse_armor.unequip": "Furniment dal cjaval si dislee",
	"subtitles.item.ink_sac.use": "Sache di ingjustri strucade",
	"subtitles.item.lead.break": "Sguinçâl si romp",
	"subtitles.item.lead.tied": "Sguinçâl leât",
	"subtitles.item.lead.untied": "Sguinçâl disleât",
	"subtitles.item.llama_carpet.unequip": "Tapêt gjavât",
	"subtitles.item.lodestone_compass.lock": "Bussule magnetizade su magnetite",
	"subtitles.item.mace.smash_air": "Mace e fruçone",
	"subtitles.item.mace.smash_ground": "Mace e fruçone",
	"subtitles.item.nautilus_saddle_equip": "Siele metude sù",
	"subtitles.item.nautilus_saddle_underwater_equip": "Siele metude sù",
	"subtitles.item.nether_wart.plant": "Plante semenade",
	"subtitles.item.ominous_bottle.dispose": "Boce si romp",
	"subtitles.item.saddle.unequip": "Siele gjavade",
	"subtitles.item.shears.shear": "Fuarpiis dopradis",
	"subtitles.item.shears.snip": "Fuarpiis a taçin",
	"subtitles.item.shield.block": "Colp parât",
	"subtitles.item.shovel.flatten": "Tiere batude cu la pale",
	"subtitles.item.spear.attack": "Lance e sfilze",
	"subtitles.item.spear.hit": "Lance e colpìs",
	"subtitles.item.spear.lunge": "Lance e stoche",
	"subtitles.item.spear.use": "Cjarie cun lance",
	"subtitles.item.spear_wood.attack": "Lance e sfilze",
	"subtitles.item.spear_wood.hit": "Lance e colpìs",
	"subtitles.item.spear_wood.use": "Cjarie cun lance",
	...
	"subtitles.item.underwater_saddle.equip": "Siele metude sù",
	"subtitles.item.wolf_armor.break": "Armadure di lôf si romp",
	"subtitles.item.wolf_armor.crack": "Armadure di lôf si creve",
	"subtitles.item.wolf_armor.damage": "Armadure di lôf ruvinade",
	"subtitles.item.wolf_armor.repair": "Armadure di lôf comedade",
	"subtitles.particle.soul_escape": "Anime e scjampe",
	"subtitles.ui.cartography_table.take_result": "Mape dissegnade",
	"subtitles.ui.hud.bubble_pop": "Ossigjen daûr a calâ",
	"subtitles.ui.loom.take_result": "Telâr doprât",
	"subtitles.ui.stonecutter.take_result": "Taiadôr di piere doprât",
	"subtitles.weather.end_flash": "Lamp dal End al rombe",
	"subtitles.weather.rain": "Ploie",
	"symlink_warning.message": "Cjariâ monts di cartelis cun colegaments simbolics al è pericolôs se no tu sâs ce che tu stâs fasint. Visite %s par savênt di plui.",
	"symlink_warning.message.pack": "Cjariâ pachets cun colegaments simbolics al è pericolôs se no tu sâs ce che tu stâs fasint. Visite %s par savênt di plui.",
	"symlink_warning.message.world": "Cjariâ monts di cartelis cun colegaments simbolics al è pericolôs se no tu sâs ce che tu stâs fasint. Visite %s par savênt di plui.",
	"symlink_warning.more_info": "Altris informazions",
	"symlink_warning.title": "La cartele dal mont e conten colegaments simbolics",
	"symlink_warning.title.pack": "I pachets zontâts a contegnin colegaments simbolics",
	...
	"telemetry.event.game_load_times.description": "Misurant i timps di esecuzion des fasis di inviament dal zûc, o podarìn capî dulà che a coventin mioraments.",
	"telemetry.event.game_load_times.title": "Timps di cjariament dal zûc",
	"telemetry.event.graphics_capabilities.description": "Chest event nus comuniche la capacitât dal dispositîf grafic doprât dal zûc.",
	"telemetry.event.graphics_capabilities.title": "Funzionalitâts grafichis",
	...
	"telemetry.event.performance_metrics.description": "Cognossi il profîl des prestazions complessivis di Minecraft nus jude a regolâ e otimizâ il zûc par une ample schirie di dispositîfs e sistemis operatîfs.\nLa version dal zûc e je includude par judânus a fâ il confront cul profîl di prestazion pes gnovis versions di Minecraft.",
	"telemetry.event.performance_metrics.title": "Metrichis di prestazion",
	"telemetry.event.required": "%s (necessari)",
	"telemetry.event.world_load_times.description": "Par nô al è impuartant capî trop timp che al vûl par jentrâ intun mont e cemût che chest al cambie cul timp a lâ. Par esempli, cuant che o zontìn gnovis funzionalitâts opûr o fasìn modifichis tecnichis, o vin dibisugne di viodi cemût che chest al influìs sul timp di cjariament.",
	"telemetry.event.world_load_times.title": "Timp di cjariament dai monts",
	...
	"telemetry.property.backend_failure_message.title": "Messaç dal erôr te creazion de librarie",
	"telemetry.property.backend_failure_missing_capabilities.title": "Funzionalitâts mancjantis te creazion de librarie",
	"telemetry.property.backend_failure_reason.title": "Reson dal erôr te creazion de librarie",
	"telemetry.property.backend_name.title": "Non de librarie grafiche",
	...
	"telemetry.property.load_time_bootstrap_ms.title": "Timp di inviament (miliseconts)",
	"telemetry.property.load_time_loading_overlay_ms.title": "Timp te videade di cjariament (miliseconts)",
	"telemetry.property.load_time_pre_window_ms.title": "Timp prime che si vierzi la videade (miliseconts)",
	"telemetry.property.load_time_total_time_ms.title": "Timp totâl di cjariament (miliseconts)",
	...
	"telemetry.property.realms_map_content.title": "Contignût de mape di Realms (non dal minizûc)",
	...
	"telemetry.property.server_type.title": "Gjenar di servidôr",
	...
	"telemetry_info.screen.description": "La racuelte di chescj dâts nus jude a miorâ Minecraft mostrant lis direzions plui impuartantis pai zuiadôrs.\nTu puedis ancje inviâ il to parê par judânus a miorâ Minecraft.",
	"telemetry_info.screen.title": "Racuelte di dâts di telemetrie",
	"test.error.block_property_mismatch": "Si spietave che la proprietât %s e fos %s, ma e jere %s",
	"test.error.block_property_missing": "E mancje la proprietât dal bloc, e jere previodude che la proprietât %s e fos %s",
	"test.error.entity_property": "La entitât %s no à passât la prove: %s",
	"test.error.entity_property_details": "Prove falide pe entitât %s: %s, previodût: %s, al jere: %s",
	"test.error.expected_block": "Bloc previodût %s, vût %s",
	"test.error.expected_block_present": "Previodude la presince dal bloc %s",
	"test.error.expected_block_tag": "Bloc previodût in #%s, vût %s",
	"test.error.expected_container_contents": "Il contignidôr al varès di contignî: %s",
	"test.error.expected_container_contents_single": "Il contignidôr al varès di contignî un ugnul: %s",
	"test.error.expected_empty_container": "Il contignidôr al varès di jessi vueit",
	"test.error.expected_entity": "Previodût %s",
	"test.error.expected_entity_around": "Al jere previodût che %s al esistès tor ator di %s, %s, %s",
	"test.error.expected_entity_count": "E jere previodude la entitât %s di gjenar %s, cjatade %s",
	"test.error.expected_entity_data": "A jerin previodût che i dâts de entitât a fossin: %s, a jerin: %s",
	"test.error.expected_entity_data_predicate": "Mancjade corispondence dai dâts de entitât par %s",
	"test.error.expected_entity_effect": "Al jere previodût che %s al ves l'efiet %s %s",
	"test.error.expected_entity_having": "L'inventari de entitât al varès di contignî %s",
	"test.error.expected_entity_holding": "La entitât e varès di tignî %s",
	"test.error.expected_entity_in_test": "Te prove al jere previodût che %s al esistès",
	"test.error.expected_entity_not_touching": "Nol jere previodût che %s al tocjàs %s, %s, %s (relatîf: %s, %s, %s)",
	"test.error.expected_entity_touching": "Al jere previodût che %s al tocjàs %s, %s, %s (relatîf: %s, %s, %s)",
	"test.error.expected_item": "Al jere previodût un element di gjenar %s",
	"test.error.expected_items_count": "A jerin previodûts %s elements di gjenar %s, cjatâts %s",
	"test.error.fail": "Condizions di faliment sodisfatis",
	"test.error.invalid_block_type": "Cjatât gjenar di bloc inspietât: %s",
	"test.error.missing_block_entity": "E mancje la entitât dal bloc",
	"test.error.not_a_block_item": "Il bloc specificât nol pues jessi un ogjet",
	"test.error.position": "%s a %s, %s, %s (relatîf: %s, %s, %s) ae ticade %s",
	"test.error.sequence.condition_already_triggered": "Condizion za ativade a %s",
	"test.error.sequence.condition_not_triggered": "Condizion no ativade",
	"test.error.sequence.invalid_tick": "Superât te ticade no valide: al jere previodût %s",
	"test.error.sequence.minimum_tick": "Superât prime de ticade previodude: al jere previodût di spietâ %s",
	"test.error.sequence.not_completed": "La prove e je scjadude prime dal completament de secuence",
	"test.error.set_biome": "Impussibil configurâ il biome pe prove",
	"test.error.spawn_failure": "Impussibil creâ la entitât %s",
	"test.error.state_not_equal": "Stât sbaliât. Si spietave %s, ma al jere %s",
	"test.error.structure.failure": "Impussibil plaçâ la struture di prove par %s",
	"test.error.tick": "%s su la ticade %s",
	"test.error.ticking_without_structure": "Prove di ticade prime di plaçâ la struture",
	"test.error.timeout.no_result": "No je passade opûr e je falide dentri di %s ticadis",
	"test.error.timeout.no_sequences_finished": "Nissune secuence e à finît dentri di %s ticadis",
	"test.error.too_many_entities": "Si spietave dome un %s tor ator di %s, %s, %s, ma a'nd è %s",
	"test.error.unexpected_block": "Nol jere previodût che il bloc al fos %s",
	"test.error.unexpected_entity": "Nol jere previodût che %s al esistès",
	"test.error.unexpected_item": "Nol jere previodût un element di gjenar %s",
	"test.error.unknown": "Erôr interni no cognossût: %s",
	"test.error.value_not_equal": "Si spietave che %s al fos %s, ma al jere %s",
	"test.error.value_not_in_between": "Si spietave che %s al fos jenfri %s e %s, ma al jere %s",
	"test.error.wrong_block_entity": "Gjenar di entitât dal bloc sbaliât: %s",
	"test_block.error.missing": "Ae struture di prove e mancje il bloc %s",
	"test_block.error.too_many": "Masse blocs %s",
	"test_block.invalid_timeout": "Timp di scjadince no valit (%s): al scugne jessi un numar positîf di ticadis",
	"test_block.message": "Messaç:",
	"test_block.mode.accept": "Acete",
	"test_block.mode.fail": "Falìs",
	"test_block.mode.log": "Regjistre",
	"test_block.mode.start": "Invie",
	"test_block.mode_info.accept": "Modalitât acetazion - Acete la riesside di (part di) une prove",
	"test_block.mode_info.fail": "Modalitât faliment - Falìs la prove",
	"test_block.mode_info.log": "Modalitât regjistri - Regjistre un messaç",
	"test_block.mode_info.start": "Modalitât inizi - Il pont iniziâl di une prove",
	"test_instance.action.reset": "Ripristine e cjame",
	"test_instance.action.run": "Cjame e eseguìs",
	"test_instance.action.save": "Salve struture",
	"test_instance.description.batch": "Ambient: %s",
	"test_instance.description.failed": "Falît: %s",
	"test_instance.description.function": "Funzion: %s",
	"test_instance.description.invalid_id": "ID prove no valit",
	"test_instance.description.no_test": "Nissune prove cjatade",
	"test_instance.description.structure": "Struture: %s",
	"test_instance.description.type": "Gjenar: %s",
	"test_instance.type.block_based": "Prove basade su blocs",
	"test_instance.type.function": "Prove di funzion integrade",
	"test_instance_block.entities": "Entitâts:",
	"test_instance_block.error.no_test": "Impussibil eseguî la istance di prove su %s, %s, %s viodût che no je stade definide nissune prove",
	"test_instance_block.error.no_test_structure": "Impussibil eseguî la istance di prove su %s, %s, %s viodût che no esist une struture di prove",
	"test_instance_block.error.unable_to_save": "Impussibil salvâ il model di struture di prove pe istance di prove su %s, %s, %s",
	"test_instance_block.invalid": "[no valit]",
	"test_instance_block.reset_success": "Ripristinament lât a bon fin pe prove: %s",
	"test_instance_block.rotation": "Rotazion:",
	"test_instance_block.size": "Dimension de struture di prove",
	"test_instance_block.starting": "Inviament de prove %s",
	"test_instance_block.test_id": "ID de istance di prove",
	"title.32bit.deprecation": "Rilevât sisteme a 32 bit: chest al podarès impedîti di zuiâ in futûr, parcè che al coventarà un sisteme a 64 bit!",
	"title.32bit.deprecation.realms": "Ca di pôc a Minecraft i coventarà un sisteme a 64-bit, chest ti impedirà di zuiâ a Minecraft o di doprâ Realms su chest dispositîf. Tu varâs di anulâ a man il to abonament a Realms.",
	...
	"trim_material.minecraft.resin": "Di resine",
	"trim_pattern.minecraft.bolt": "Ornament cun stîl bulon",
	...
	"trim_pattern.minecraft.flow": "Ornament cun stîl flus",
	...
	"upgradeWorld.aborted.message": "Chest al pues capitâ se cualchi altri program al cîr di jentrâ tal mont intant dal inzornament.\nTorne invie il tô dispositîf e torne prove. Se il probleme al indure, segnale l'erôr.",
	"upgradeWorld.aborted.reportBug": "Segnale un erôr",
	"upgradeWorld.aborted.title": "Nol è stât pussibil inzornâ il mont",
	"upgradeWorld.canceled.message": "Il tô mont nol è stât modificât.",
	"upgradeWorld.canceled.title": "Inzornament dal mont anulât",
	"upgradeWorld.done": "Inzornament dal mont completât",
	"upgradeWorld.failed_cleanup.message": "Il mont al è inzornât ae version atuâl e al è disponibil te liste dai monts.\nAlc al è lât strucj tal netâ i dâts sorpassâts, par cui il nom de cartele dal mont al è stât cambiât in %s.",
	"upgradeWorld.failed_cleanup.title": "Inzornament dal mont completât cun sucès",
	"upgradeWorld.info.converted": "Inzornât: %s",
	"upgradeWorld.info.file_fix_stage": "Fase: %s/%s",
	"upgradeWorld.info.scanning": "Analisi dai dâts...",
	"upgradeWorld.info.total": "Totâl: %s",
	"upgradeWorld.joinNow": "Desideristu jentrâ in chest mont daurman?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Trasferiment",
	"upgradeWorld.progress.type.legacy_structures": "Inzornament des struturis",
	"upgradeWorld.progress.type.region": "Inzornament des regjions",
	"upgradeWorld.symlink.message": "Il mont selezionât al conten colegaments simbolics, che a no permetin di inzornâ il mont a version atuâl. Par inzornâ il mont, al covente prime risolvi i colegaments.",
	"upgradeWorld.symlink.title": "Impussibil inzornâ il mont",
	"upgradeWorld.title": "Inzornament dal mont",
}
