// Code generated by tools/gen_lang.go from 26.1/yo_ng.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Eto Wiwọle...",
	...
	"advancements.adventure.blowback.title": "Rongbachkim",
	"advancements.adventure.brush_armadillo.description": "Get Armadillo Scutes gikan sa Usa Ka Armadillo sa paggamit sa Usa Ka Brush",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Ka ifihan agbara ti Chiseled Bookshelf nipa lilo Afiwera",
	...
	"advancements.adventure.salvage_sherd.title": "Bọwọ Awọn iyokù",
	...
	"advancements.adventure.spyglass_at_parrot.title": "Ṣé ẹyẹ ni?",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Smithing Ọna rẹ",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Ṣiṣẹ ihamọra gige kan ni tabili Smithing kan",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Ṣiṣẹda Wiwo Tuntun",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Lo ina ibudó lati gba Oyin lati inu Ile-oyin kan nipa lilo Igo Gilasi kan lai mu awọn oyin naa buru si",
	...
	"advancements.nether.ride_strider.title": "Ọkọ̀ yìí ní ẹsẹ̀",
	...
	"argument.color.invalid": "Àìmọ̀ àwọ̀: '%s'",
	...
	"argument.entity.options.gamemode.description": "Awọn ẹrọ orin pẹlu game mode",
	...
	"argument.gamemode.invalid": "Ipo ere aimọ: %s",
	...
	"attribute.name.armor": "Ìhámọ́ra",
	"attribute.name.armor_toughness": "Agbara ìhámọ́ra",
	...
	"attribute.name.generic.gravity": "Walẹ",
	...
	"attribute.name.movement_speed": "Yiyara",
	...
	"block.minecraft.end_portal": "Ipari Portal",
	...
	"chat.disabled.launcher": "Iwiregbe alaabo nipasẹ aṣayan ifilọlẹ. Ko le fi ifiranṣẹ ranṣẹ.",
	"chat.disabled.missingProfileKey": "Iwiregbe ni alaabo nitori bọtini profaili ti o padanu. Jọwọ gbiyanju atunsopọ.",
	"chat.disabled.options": "Iwiregbe alaabo ninu eto awọn aṣayan.",
	"chat.disabled.out_of_order_chat": "Chat received out-of-order. Did your system time change?",
	"chat.disabled.profile": "Iwiregbe ko gba laaye nipasẹ awọn eto akọọlẹ. Tẹ '%s' lẹẹkansi fun alaye diẹ sii.",
	...
	"commands.banlist.entry.unknown": "(Aimọ)",
	"commands.banlist.list": "(Awọn) Idinamọ %s wa:",
	...
	"commands.bossbar.get.players.some": "Ilera Oga aṣa %s ni awọn oṣere %s ti o wa lọwọlọwọ: %s",
	...
	"commands.bossbar.list.bars.some": "Awọn ilera aṣa aṣa %s n ṣiṣẹ: %s",
	...
	"commands.bossbar.set.players.success.some": "Ilera olori aṣa %s bayi ni awọn oṣere %s: %s",
	...
	"commands.clone.success": "Awọn bulọọki %s ṣe ẹda ni aṣeyọri",
	...
	"commands.data.modify.invalid_substring": "Awọn atọka okun inu aiṣedeede: %s si %s",
	...
	"commands.datapack.list.available.success": "Awọn akopọ ẹya %s wa: %s",
	"commands.datapack.list.enabled.none": "Ko si awọn akopọ data ti o ṣiṣẹ",
	"commands.datapack.list.enabled.success": "Awọn idii ẹya %s wa ti a mu ṣiṣẹ: %s",
	...
	"commands.fillbiome.success.count": "%s biome titẹsi/awọn titẹ sii ṣeto laarin %s, %s, %s ati %s, %s, %s",
	...
	"commands.scoreboard.objectives.list.success": "%s afojusun/afojusun wa: %s",
	...
	"commands.scoreboard.players.list.entity.success": "%s ni awọn nọmba %s:",
	"commands.scoreboard.players.list.success": "Awọn nkan/awọn nkan ti a tọpinpin %s wa: %s",
	...
	"commands.team.empty.success": "Ti yọ %s (àwọn) ọmọ ẹgbẹ́ kúrò nínú ẹgbẹ́ %s",
	...
	"commands.team.list.members.success": "Ẹgbẹ́ %s ní %s (àwọn) ọmọ ẹgbẹ́:%s",
	"commands.team.list.teams.empty": "Ko si awọn ẹgbẹ",
	"commands.team.list.teams.success": "(Àwọn) %s ẹgbẹ́ wà: %s",
	...
	"commands.whitelist.list": "(Àwọn) akópa tí wọ́n %s ní ìgbàláàyè wà: %s",
	...
	"createWorld.customize.flat.tile": "Ohun èlò Layer",
	...
	"datapackFailure.title": "Awọn aṣiṣe ninu awọn akopọ data ti a yan lọwọlọwọ ṣe idiwọ fun agbaye lati kojọpọ.\nO le gbiyanju lati ṣajọpọ pẹlu idii data fanila nikan (\"ipo ailewu\"), tabi pada si iboju akọle ki o ṣe atunṣe pẹlu ọwọ.",
	...
	"death.attack.outsideBorder": "%[1]s fi opin si aye yi",
	"death.attack.outsideBorder.player": "%[1]s fi opin si aye yi nigba ija %[2]s",
	...
	"debug.creative_spectator.error": "Ko le yipada ipo ere; ko si igbanilaaye",
	"debug.creative_spectator.help": "F3 + N = Yi ipo ere iṣaaju <-> oluwoye",
	...
	"disconnect.ignoring_status_request": "Fojusi ibeere ipo",
	...
	"gamerule.doLimitedCrafting.description": "Ti o ba mu ṣiṣẹ, awọn oṣere yoo ni anfani lati ṣe awọn ilana ṣiṣi silẹ nikan.",
	"gamerule.doMobLoot": "Ju ikogun eniyan",
	"gamerule.doMobLoot.description": "Ṣakoso awọn orisun silẹ lati awọn agbajo eniyan, pẹlu awọn orbs iriri.",
	"gamerule.doMobSpawning": "Spawn agbajo eniyan",
	"gamerule.doMobSpawning.description": "Diẹ ninu awọn ile-iṣẹ le ni awọn ofin lọtọ.",
	"gamerule.doPatrolSpawning": "Ibisi pillager patrols",
	"gamerule.doTileDrops": "Awọn bulọọki silẹ",
	"gamerule.doTileDrops.description": "Ṣakoso awọn orisun orisun silẹ lati awọn bulọọki, pẹlu awọn orbs iriri.",
	...
	"gamerule.maxCommandChainLength.description": "Kan si pipaṣẹ awọn ẹwọn Àkọsílẹ ati awọn iṣẹ.",
	...
	"gamerule.reducedDebugInfo.description": "Awọn akoonu ifilelẹ ti iboju yokokoro.",
	...
	"gui.copy_link_to_clipboard": "Daakọ Ọna asopọ si Agekuru",
	"gui.days": "%s ọjọ (awọn)",
	"gui.done": "Me see",
	"gui.down": "Si isalẹ",
	...
	"item.minecraft.angler_pottery_shard": "Angler apadì o Shard",
	"item.minecraft.angler_pottery_sherd": "Angler apadì o Sherd",
	"item.minecraft.apple": "Àpù",
	"item.minecraft.archer_pottery_shard": "Archer apadì o Shard",
	...
	"item.minecraft.arms_up_pottery_shard": "Arms Up apadì o Shard",
	...
	"item.minecraft.enchanted_golden_apple": "Àpù wúrà àdánidára",
	...
	"item.minecraft.golden_apple": "Àpù wúrà",
	...
	"item.minecraft.heart_pottery_shard": "Okan apadì o Shard",
	"item.minecraft.heart_pottery_sherd": "Okan apadì o Sherd",
	"item.minecraft.heartbreak_pottery_shard": "Heartbreak Iseamokoko Shard",
	...
	"item.minecraft.shelter_pottery_shard": "Koseemani apadì o Shard",
	...
	"item.minecraft.skull_pottery_shard": "Timole apadì o Shard",
	...
	"item.minecraft.snort_pottery_shard": "Snort apadì o Shard",
	...
	"key.advancements": "Awọn ilọsiwaju",
	"key.attack": "Kolu/run",
	"key.back": "Lọ pada",
	...
	"mco.backup.entry.gameDifficulty": "Ere Kikankikan",
	"mco.backup.entry.gameMode": "Ipo Ere",
	"mco.backup.entry.gameServerVersion": "Ere Server Version",
	"mco.backup.entry.name": "Oruko",
	"mco.backup.entry.seed": "Irugbin",
	"mco.backup.entry.templateName": "Orukọ Awoṣe",
	"mco.backup.entry.undefined": "Aisọye Iyipada",
	"mco.backup.entry.uploaded": "Uploaded",
	"mco.backup.entry.worldType": "Iru agbaye",
	...
	"mco.backup.info.title": "Ayipada lati kẹhin afẹyinti",
	...
	"mco.configure.world.invited.number": "Iye ti a pe (%s)",
	...
	"mco.configure.world.minigame": "Lọwọlọwọ: %s",
	...
	"mco.configure.world.players.inviting": "Oṣere ifiwepe...",
	...
	"mco.configure.world.subscription.remaining.months.days": "%[1]s osu(s), %[2]s ọjọ(s)",
	...
	"mco.configure.world.uninvite.player": "Ṣe o da ọ loju pe o fẹ lati pe '%s' bi?",
	...
	"mco.download.resourcePack.fail": "Kuna lati ṣe igbasilẹ idii orisun!",
	...
	"narration.recipe": "Ohun èlò fún %s",
	...
	"telemetry.event.advancement_made.title": "Ilosiwaju Ti Ṣe",
	...
	"telemetry.property.advancement_id.title": "Ilọsiwaju ID",
	...
	"translation.test.invalid": "e ǹlẹ́ %",
	"translation.test.invalid2": "e ǹlẹ́ %s",
	"translation.test.none": "E ǹlẹ́, ayé!",
	"translation.test.world": "ayé",
	"trim_material.minecraft.amethyst": "Ohun èlò Amethyst",
	"trim_material.minecraft.copper": "Ohun èlò idẹ",
	"trim_material.minecraft.diamond": "Ohun èlò Ẹ̀yẹ́",
	"trim_material.minecraft.emerald": "Ohun èlò Emerald",
	"trim_material.minecraft.gold": "Ohun èlò Wúrà",
	"trim_material.minecraft.iron": "Ohun èlò Irin",
	"trim_material.minecraft.lapis": "Ohun èlò Lapis",
	"trim_material.minecraft.netherite": "Ohun èlò Netherite",
	"trim_material.minecraft.quartz": "Ohun èlò Quartz",
	"trim_material.minecraft.redstone": "Ohun èlò Redstone",
	"trim_material.minecraft.resin": "Ohun èlò Resin",
