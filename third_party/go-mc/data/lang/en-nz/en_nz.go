// Code generated by tools/gen_lang.go from 26.1/en_nz.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"death.attack.onFire.item": "%[1]s was burnt to a crisp while fighting %[2]s wielding %[3]s",
	...
	"debug.options.warning": "These options are for testing purposes only. They may slow down your computer, crash the game or make your computer start speaking fluent Kiwi and calling you 'bro'.",
	...
	"subtitles.entity.arrow.hit_player": "Arrow hits player",
