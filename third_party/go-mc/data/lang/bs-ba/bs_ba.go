// Code generated by tools/gen_lang.go from 26.1/bs_ba.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Podešavanja pristupa...",
	"accessibility.onboarding.accessibility.button.narration": "Accessibility Settings",
	"accessibility.onboarding.screen.narrator": "Pritisnite enter da omogućite naratora",
	...
	"advMode.trackOutput": "Izlaz trake",
	...
	"advancements.adventure.avoid_vibration.description": "Šunjaj se u blizini Skulk Senzora ili Nadzornika da te ne detektuje",
	"advancements.adventure.avoid_vibration.title": "Šunjanje 100",
	"advancements.adventure.blowback.description": "Ubij Povjetarac vraćajući mu njegov Udar Vjetra",
	"advancements.adventure.blowback.title": "Mogu i ja puhati!",
	"advancements.adventure.brush_armadillo.description": "Nabavi armadilove pločice od armadila koristeći četku",
	"advancements.adventure.brush_armadillo.title": "Arma-dio!",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Napravite Ukrašeni ćup od 4 ulomka keramike",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Pažljiva restauracija",
	"advancements.adventure.crafters_crafting_crafters.description": "Budi blizu Pravljača kada napravi Pravljač",
	"advancements.adventure.crafters_crafting_crafters.title": "Pravljači Prave Pravljače",
	"advancements.adventure.fall_from_world_height.description": "Padni s vrha svijeta (visinska granica) na dno svijeta i preživi",
	"advancements.adventure.fall_from_world_height.title": "Pećine i litice",
	"advancements.adventure.heart_transplanter.description": "Postavite Škripavo Srce s pravilnim poravnanjem između dva bloka Blijedog Hrastovog Trupca",
	"advancements.adventure.heart_transplanter.title": "Presađivač Srca",
	"advancements.adventure.hero_of_the_village.description": "Uspješno obrani selo od napada",
	"advancements.adventure.hero_of_the_village.title": "Junak Sela",
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Ubij stvorenje blizu Skulk Katalizatora",
	"advancements.adventure.kill_mob_near_sculk_catalyst.title": "Širi se",
	"advancements.adventure.lighten_up.description": "Sastruži bakrenu sijalicu sjekirom da postane svijetlija",
	"advancements.adventure.lighten_up.title": "Razvedri se",
	"advancements.adventure.lightning_rod_with_villager_no_fire.description": "Zaštiti seljaka od neželjenog šoka bez da napraviš požar",
	"advancements.adventure.lightning_rod_with_villager_no_fire.title": "Zaštitnik od Prenapona",
	"advancements.adventure.minecraft_trials_edition.description": "Zakorači u Komoru Iskušenja",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Izdanje Iskušenja",
	"advancements.adventure.ol_betsy.description": "Pucaj samostrelom",
	"advancements.adventure.ol_betsy.title": "Stara Pouzdana",
	"advancements.adventure.overoverkill.description": "Nanesi 50 srca štete jednim udarcem topuza",
	"advancements.adventure.overoverkill.title": "Pre-pretjerivanje",
	"advancements.adventure.play_jukebox_in_meadows.description": "Oživi livade zvukom muzike iz džuboksa",
	"advancements.adventure.play_jukebox_in_meadows.title": "Moje pjesme, moji snovi",
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Očitajte signal napajanja isklesane police za knjige pomoću komparatora",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Sila Knjiga",
	"advancements.adventure.revaulting.description": "Otključaj Zloslutni Trezor sa Zlosutnim Ključem Iskušenja",
	"advancements.adventure.revaulting.title": "Ponovno zaključavanje",
	"advancements.adventure.root.description": "Avantura, istraživanje i borba",
	"advancements.adventure.root.title": "Avantura",
	"advancements.adventure.salvage_sherd.description": "Očistite sumnjivi blok da dobijete ulomak keramike",
	...
	"advancements.adventure.sleep_in_bed.description": "Spavaj u krevetu kako bi promijenio tačku ponovnog stvaranja",
	...
	"advancements.adventure.spear_many_mobs.description": "Udari pet čudovišta u istom napadu juriša koristeći koplje",
	...
	"advancements.adventure.spyglass_at_ghast.description": "Pogledaj Duha kroz dvogled",
	"advancements.adventure.spyglass_at_ghast.title": "Je li to balon?",
	"advancements.adventure.spyglass_at_parrot.description": "Pogledaj papigu kroz dvogled",
	...
	"advancements.adventure.trade_at_world_height.description": "Trguj se sa seljakom na granici visine gradnje",
	"advancements.adventure.trade_at_world_height.title": "Zvijedna trgovanja",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Primijenite ove kovačke šablone barem jednom: Spire, Snout, Rib, Ward, Silence, Vex, Tide, Wayfinder",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Kovanje sa stilom",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Izradite obrubljen oklop za kovačkim stolom",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Izrada novog izgleda",
	"advancements.adventure.two_birds_one_arrow.description": "Ubij dva fantoma sa strijelom za probijanje",
	"advancements.adventure.two_birds_one_arrow.title": "Dvije ptice, jedna strijela",
	"advancements.adventure.under_lock_and_key.description": "Otključaj trezor sa ključem izazova",
	"advancements.adventure.under_lock_and_key.title": "pod ključem",
	"advancements.adventure.use_lodestone.description": "Koristite Kompas na Lodestone",
	...
	"advancements.adventure.who_needs_rockets.description": "Iskoristi \"Wind Charge\" da se lansiraš 8 blokova u zrak",
	"advancements.adventure.who_needs_rockets.title": "Kome trebaju vatromente rakete?",
	...
	"advancements.husbandry.allay_deliver_item_to_player.description": "Imajte Alej da vam donosi svari",
	"advancements.husbandry.allay_deliver_item_to_player.title": "Imaš prijatelja u meni",
	...
	"advancements.husbandry.feed_snifflet.description": "Nahrani njuškalo",
	"advancements.husbandry.feed_snifflet.title": "Malo Njuška",
	"advancements.husbandry.fishy_business.description": "Uhvati ribu",
	"advancements.husbandry.fishy_business.title": "Riblji posao",
	"advancements.husbandry.froglights.description": "Imajte sva Žablja Svjetla u vašem inventaru",
	"advancements.husbandry.froglights.title": "Sa svim našim kombiniranim moćima!",
	"advancements.husbandry.kill_axolotl_target.description": "Udruži se s aksolotlom i pobjedi u borbi",
	"advancements.husbandry.kill_axolotl_target.title": "Iscjeljujuća moć prijateljstva!",
	"advancements.husbandry.leash_all_frog_variants.description": "Uzmite svaku varijantu Žabe na povodcu",
	"advancements.husbandry.leash_all_frog_variants.title": "Kada tim uleti u grad",
	"advancements.husbandry.make_a_sign_glow.description": "Neka tekst bilo koje vrste znaka svijetli",
	"advancements.husbandry.make_a_sign_glow.title": "Sjaj i Čudženje!",
	"advancements.husbandry.netherite_hoe.description": "Koristite Netherite polugu da nadogradite motiku i onda preispitajte svoje životne odluke",
	"advancements.husbandry.netherite_hoe.title": "Ozbiljna predanost",
	"advancements.husbandry.obtain_sniffer_egg.description": "Nabavite jaje Njuškala",
	"advancements.husbandry.obtain_sniffer_egg.title": "Miriše Zanimljivo",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Postavite blok Isušenog Ghasta u vodu",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Hidriraj se!",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Posadite bilo koje sjeme Njuškala",
	"advancements.husbandry.plant_any_sniffer_seed.title": "Sadnja prošlosti",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Skini vučji oklop sa vuka, koristeći makaze",
	"advancements.husbandry.remove_wolf_armor.title": "Briljantno odsiječeno",
	"advancements.husbandry.repair_wolf_armor.description": "Potpuno popravi oštećeni Oklop Vuka koristeći oklop Armadila",
	"advancements.husbandry.repair_wolf_armor.title": "Dobro kao novo",
	"advancements.husbandry.ride_a_boat_with_a_goat.description": "Zaplovi s kozom u brodu",
	"advancements.husbandry.ride_a_boat_with_a_goat.title": "Šta god da pluta vaša koza!",
	"advancements.husbandry.root.description": "Svijet je pun prijatelja i hrane",
	"advancements.husbandry.root.title": "Stočarstvo",
	"advancements.husbandry.safely_harvest_honey.description": "Koristite logorsku vatru da prikupite Med iz košnice koristeći staklenu bočicu bez provociranja pčela",
	"advancements.husbandry.safely_harvest_honey.title": "Medom se pogosti, pčele neće bosti",
	"advancements.husbandry.silk_touch_nest.description": "Premjesti Košnicu, sa 3 Pčele unutra, koristeći Dodir Svile",
	...
	"advancements.husbandry.tadpole_in_a_bucket.description": "Uhvati punoglavca u kantu",
	...
	"advancements.husbandry.wax_off.title": "Depiliranje",
	"advancements.husbandry.wax_on.description": "Primjeni saće na blok bakra!",
	"advancements.husbandry.wax_on.title": "Nanosiš",
	"advancements.husbandry.whole_pack.description": "Pritom jedan od svakih vučijih pasmina",
	...
	"advancements.nether.ride_strider_in_overworld_lava.description": "Uzmi paklenog šetača na duuuugu vožnju jezerima od lave u svijetu",
	"advancements.nether.ride_strider_in_overworld_lava.title": "Osjeća se kao kod Kuće",
	...
	"advancements.story.smelt_iron.description": "Otopi željeznu polugu",
	...
	"argument.angle.incomplete": "Nepotpuno (očekivan 1 ugao)",
	...
	"argument.entity.options.gamemode.description": "Igraci sa rezimom igre",
	...
	"argument.hexcolor.invalid": "Nevažeći heksadecimalni kod boje '%s'",
	...
	"argument.message.too_long": "Poruka je bila preduga (%s > maksimalan %s znakova)",
	"argument.nbt.array.invalid": "Pogrešan red tipa '%s'",
	"argument.nbt.array.mixed": "Nije moguće ubaciti %s u %s",
	"argument.nbt.expected.compound": "Očekivani compound tag",
	...
	"argument.resource_or_id.failed_to_parse": "nije uspio analizirati strukturu",
	"argument.resource_or_id.invalid": "Neispravna oznaka",
	"argument.resource_or_id.no_such_element": "Ne mogu pronaći element '%s' u registru '%s'",
	"argument.resource_selector.not_found": "Bez podudaranja za selektor '%s' tipa '%s'",
	...
	"argument.time.tick_count_too_low": "Broj tiketa ne smije biti manji od %s, pronađeno %s",
	"argument.uuid.invalid": "Nevažeći UUID",
	"argument.waypoint.invalid": "Odabrani entitet nije putna tačka",
	...
	"arguments.item.component.malformed": "Malformirana komponenta",
	"arguments.item.component.repeated": "komponenta stavke je ponovljena, ali samo jedna vrijednost može biti specificirana",
	"arguments.item.component.unknown": "Neznat komponent stavke '%s'",
	"arguments.item.malformed": "Malformirana stavka",
	"arguments.item.overstacked": "%s može jedino da se gomila do %s",
	"arguments.item.predicate.malformed": "Malformirani predikat",
	"arguments.item.predicate.unknown": "Nepoznata stavka predikat",
	...
	"arguments.nbtpath.too_deep": "Rezultirajući NBT je previše duboko ugniježđen",
	"arguments.nbtpath.too_large": "Rezultirajući NBT je prevelik",
	...
	"attribute.name.attack_damage": "Šteta pri napadu",
	"attribute.name.attack_knockback": "Snaga Napada",
	"attribute.name.attack_speed": "Brzina Napada",
	"attribute.name.below_name_distance": "Name Tag Score Distance",
	"attribute.name.block_break_speed": "Brzina rušenja blokova",
	"attribute.name.block_interaction_range": "Domet za interakciju s blokom",
	"attribute.name.bounciness": "Bounciness",
	"attribute.name.burning_time": "Vrijeme Gorenja",
	"attribute.name.camera_distance": "Distanca Kamere",
	"attribute.name.entity_interaction_range": "Domet za interakciju s entitetom",
	"attribute.name.explosion_knockback_resistance": "Otpornost na odbacivanje eksplozije",
	"attribute.name.fall_damage_multiplier": "Multiplikator Štete pri Padu",
	"attribute.name.flying_speed": "Brzina Letenja",
	"attribute.name.follow_range": "Protok Mobova",
	...
	"attribute.name.generic.block_interaction_range": "Domet interakcije bloka",
	"attribute.name.generic.burning_time": "Vrijeme Gorenja",
	"attribute.name.generic.entity_interaction_range": "Domet interakcije entiteta",
	"attribute.name.generic.explosion_knockback_resistance": "Otpornost od udarca eksplozija",
	"attribute.name.generic.fall_damage_multiplier": "Multiplikator Štete Od Pada",
	...
	"attribute.name.generic.jump_strength": "Skoči Snagu",
	...
	"attribute.name.generic.movement_efficiency": "Efikasnost Kretanja",
	"attribute.name.generic.movement_speed": "Brzina",
	"attribute.name.generic.oxygen_bonus": "Bonus za kisik",
	"attribute.name.generic.safe_fall_distance": "Sigurna Udaljenost Pada",
	"attribute.name.generic.scale": "Razmjer",
	"attribute.name.generic.step_height": "Visina koraka",
	"attribute.name.generic.water_movement_efficiency": "Efikasnost kretanja vode",
	"attribute.name.gravity": "Gravitacija",
	"attribute.name.horse.jump_strength": "Jačina skoka konja",
	"attribute.name.jump_strength": "Jačina Skoka",
	"attribute.name.knockback_resistance": "Otpor na odbacivanje",
	"attribute.name.luck": "Sreća",
	"attribute.name.max_absorption": "Maksimalna apsorpcija",
	"attribute.name.max_health": "Maksimalno zdravlje",
	"attribute.name.mining_efficiency": "Efikasnost rudarstva",
	"attribute.name.movement_efficiency": "Efikasnost kretanja",
	"attribute.name.movement_speed": "Brzina",
	"attribute.name.nameplate_distance": "Name Tag Distance",
	"attribute.name.oxygen_bonus": "bonus za kisik",
	"attribute.name.player.block_break_speed": "Brzina trganja blokova",
	"attribute.name.player.block_interaction_range": "Dužina interakcije bloka",
	"attribute.name.player.entity_interaction_range": "Dužina interakcije entiteta",
	"attribute.name.player.mining_efficiency": "Efikasnost rudarenja",
	"attribute.name.player.sneaking_speed": "Brzina Šunjanja",
	"attribute.name.player.submerged_mining_speed": "Brzina Rudarenja pod Vodom",
	"attribute.name.player.sweeping_damage_ratio": "Omjer štete",
	"attribute.name.safe_fall_distance": "sigurna udaljenost pada",
	"attribute.name.scale": "Skali",
	"attribute.name.sneaking_speed": "Brzina Šunjanja",
	"attribute.name.spawn_reinforcements": "Zombi pojačanje",
	"attribute.name.step_height": "visina koraka",
	"attribute.name.submerged_mining_speed": "Brzina potopljenog rudarstva",
	"attribute.name.sweeping_damage_ratio": "Omjer štete",
	"attribute.name.tempt_range": "Mob Tempt Raspon",
	"attribute.name.water_movement_efficiency": "Efikasnost kretanja vode",
	"attribute.name.waypoint_receive_range": "Domet prijema tačaka puta",
	"attribute.name.waypoint_transmit_range": "Domet odašiljanja tačaka puta",
	...
	"biome.minecraft.pale_garden": "Blijeda Šuma",
	...
	"block.minecraft.acacia_shelf": "Polica od Akacije",
	...
	"block.minecraft.acacia_wall_hanging_sign": "Viseći znak od bagrema",
	...
	"block.minecraft.bamboo_fence_gate": "Bambusova ograda kapija",
	...
	"block.minecraft.bamboo_pressure_plate": "Bambusova tlačna ploča",
	"block.minecraft.bamboo_sapling": "Mladi bambus",
	"block.minecraft.bamboo_shelf": "Polica od bambusa",
	"block.minecraft.bamboo_sign": "Bambusova tlačna ploča",
	...
	"block.minecraft.bamboo_wall_hanging_sign": "Viseći znak od bambusa",
	"block.minecraft.bamboo_wall_sign": "Viseći znak od bambusa",
	...
	"block.minecraft.banner.flow.black": "Crna Spirala",
	"block.minecraft.banner.flow.blue": "Plava Spirala",
	"block.minecraft.banner.flow.brown": "Smeđa Spirala",
	"block.minecraft.banner.flow.cyan": "Cijan tok",
	"block.minecraft.banner.flow.gray": "Smeđa Spirala",
	"block.minecraft.banner.flow.green": "Zelena Spirala",
	"block.minecraft.banner.flow.light_blue": "Svijetllo Plava Spirala",
	"block.minecraft.banner.flow.light_gray": "Svijetlo Siva Spirala",
	"block.minecraft.banner.flow.lime": "Svjetlozelena Spirala",
	"block.minecraft.banner.flow.magenta": "Magenta Spirala",
	"block.minecraft.banner.flow.orange": "Narandžasta Spirala",
	"block.minecraft.banner.flow.pink": "Roza Spirala",
	"block.minecraft.banner.flow.purple": "Ljubičasta Spirala",
	"block.minecraft.banner.flow.red": "Crvena Spirala",
	"block.minecraft.banner.flow.white": "Bijela Spirala",
	"block.minecraft.banner.flow.yellow": "Žuta Spirala",
	...
	"block.minecraft.banner.guster.black": "Crni Guster",
	"block.minecraft.banner.guster.blue": "Plavi Guster",
	"block.minecraft.banner.guster.brown": "Smeđi Guster",
	"block.minecraft.banner.guster.cyan": "cijan guster",
	"block.minecraft.banner.guster.gray": "Sivi Guster",
	"block.minecraft.banner.guster.green": "Zeleni Guster",
	"block.minecraft.banner.guster.light_blue": "Svijetlo Plavi Guster",
	"block.minecraft.banner.guster.light_gray": "Svijetlo Sivi Guster",
	"block.minecraft.banner.guster.lime": "Svijetlo Zeleni Guster",
	"block.minecraft.banner.guster.magenta": "Magenta Guster",
	"block.minecraft.banner.guster.orange": "Narandžasti Guster",
	"block.minecraft.banner.guster.pink": "Rozi Guster",
	"block.minecraft.banner.guster.purple": "Ljubičasti Guster",
	"block.minecraft.banner.guster.red": "Crveni Guster",
	"block.minecraft.banner.guster.white": "Bijeli Guster",
	"block.minecraft.banner.guster.yellow": "Žuti Guster",
	...
	"block.minecraft.birch_shelf": "Polica od breze",
	...
	"block.minecraft.birch_wall_hanging_sign": "Viseći znak od breze",
	...
	"block.minecraft.cherry_fence": "Trešnja Ograda",
	"block.minecraft.cherry_fence_gate": "Trešnja kapija ograde",
	"block.minecraft.cherry_hanging_sign": "Viseći znak trešnje",
	"block.minecraft.cherry_leaves": "trešnja listovi",
	"block.minecraft.cherry_log": "Trešnja log",
	"block.minecraft.cherry_planks": "Trešnja daske",
	"block.minecraft.cherry_pressure_plate": "Trešnja tlačna ploča",
	"block.minecraft.cherry_sapling": "Trešnja mladica",
	"block.minecraft.cherry_shelf": "Polica od trešnje",
	"block.minecraft.cherry_sign": "Trešnja sign",
	...
	"block.minecraft.cherry_wall_hanging_sign": "Viseći znak na zidu trešnje",
	"block.minecraft.cherry_wall_sign": "Znak na zidu trešnje",
	...
	"block.minecraft.chiseled_copper": "Isklesano Bakar",
	...
	"block.minecraft.chiseled_resin_bricks": "isklesane cigle od smole",
	...
	"block.minecraft.chiseled_tuff": "Isklesano Tuff",
	...
	"block.minecraft.closed_eyeblossom": "Zatvoreni EyeBlossm",
	...
	"block.minecraft.copper_bars": "Bakrene poluge",
	"block.minecraft.copper_block": "Blok bakra",
	"block.minecraft.copper_bulb": "Bakar Sijalica",
	"block.minecraft.copper_chain": "Bakreni lanac",
	"block.minecraft.copper_chest": "Bakrena kutija",
	"block.minecraft.copper_door": "Bakrena vrata",
	"block.minecraft.copper_golem_statue": "Statua Bakarnog Golema",
	"block.minecraft.copper_grate": "Bakarna rešetka",
	"block.minecraft.copper_lantern": "Bakrena lampa",
	"block.minecraft.copper_ore": "Bakrena ruda",
	"block.minecraft.copper_torch": "Bakrena baklja",
	"block.minecraft.copper_trapdoor": "Bakrena podna vrata",
	"block.minecraft.copper_wall_torch": "Zidna Bakrena Baklja",
	...
	"block.minecraft.crafter": "Pravljač",
	"block.minecraft.crafting_table": "Radni sto",
	"block.minecraft.creaking_heart": "Srce koje škripi",
	...
	"block.minecraft.crimson_shelf": "Grimizna Polica",
	...
	"block.minecraft.crimson_wall_hanging_sign": "Grimizni zidni viseći znak",
	...
	"block.minecraft.dark_oak_shelf": "Polica od Tamnog Hrasta",
	...
	"block.minecraft.decorated_pot": "Dekorisana vaza",
	...
	"block.minecraft.dried_ghast": "Osušeni ghast",
	...
	"block.minecraft.exposed_chiseled_copper": "Otkriveni klesani bakar",
	"block.minecraft.exposed_copper": "Izloženi bakar",
	"block.minecraft.exposed_copper_bars": "Otkrivene Bakarne Šipke",
	"block.minecraft.exposed_copper_bulb": "Otkrivena bakarna lampa",
	"block.minecraft.exposed_copper_chain": "Otkriveni Bakarni Lanac",
	"block.minecraft.exposed_copper_chest": "Otkriveni Bakarni Kovčeg",
	"block.minecraft.exposed_copper_door": "Otkrivena bakarna vrata",
	"block.minecraft.exposed_copper_golem_statue": "Otkrivena Statua Bakarnog Golema",
	"block.minecraft.exposed_copper_grate": "Otkrivena bakarna rešetka",
	"block.minecraft.exposed_copper_lantern": "Otkrivena Bakarna Lampa",
	"block.minecraft.exposed_copper_trapdoor": "Otkriveni bakarni kapak",
	...
	"block.minecraft.exposed_lightning_rod": "Otkriveni Gromobran",
	...
	"block.minecraft.firefly_bush": "Grm Krijesnica",
	...
	"block.minecraft.iron_chain": "Gvozdeni lanac",
	...
	"block.minecraft.jungle_shelf": "Polica Džungle",
	...
	"block.minecraft.jungle_wall_hanging_sign": "Viseći znak drveta džungle",
	...
	"block.minecraft.leaf_litter": "Razbacano lišće",
	...
	"block.minecraft.mangrove_shelf": "Polica Mangrove",
	...
	"block.minecraft.mangrove_wall_hanging_sign": "Viseći mangorve zidni znak",
	...
	"block.minecraft.oak_shelf": "Polica Hrasta",
	...
	"block.minecraft.oak_wall_hanging_sign": "Hrastov viseći zidni znak",
	...
	"block.minecraft.open_eyeblossom": "Otvori cvijet očiju",
	...
	"block.minecraft.oxidized_chiseled_copper": "Oksidirani klesani bakar",
	"block.minecraft.oxidized_copper": "Oksidirani bakar",
	"block.minecraft.oxidized_copper_bars": "Oksidizirani Bakarni Šipci",
	"block.minecraft.oxidized_copper_bulb": "Oksidirana bakarna lampa",
	"block.minecraft.oxidized_copper_chain": "Oksidizirani Bakarni Lanac",
	"block.minecraft.oxidized_copper_chest": "Škrinja od oksidiranog bakra",
	"block.minecraft.oxidized_copper_door": "Oksidirana bakarna vrata",
	"block.minecraft.oxidized_copper_golem_statue": "Oksidirana Statua Bakrenog Golema",
	"block.minecraft.oxidized_copper_grate": "Oksidirana bakarna rešetka",
	"block.minecraft.oxidized_copper_lantern": "Oksidirana bakrena lampa",
	"block.minecraft.oxidized_copper_trapdoor": "Oksidirani bakarni kapak",
	...
	"block.minecraft.oxidized_lightning_rod": "Oksidirani gromobran",
	...
	"block.minecraft.pale_moss_block": "Blok blijede mahovine",
	"block.minecraft.pale_moss_carpet": "Blijedi tepih od mahovine",
	"block.minecraft.pale_oak_button": "Bledo hrastovo dugme",
	"block.minecraft.pale_oak_door": "Vrata od blijedog hrasta",
	"block.minecraft.pale_oak_fence": "Ograda od blijedog hrasta",
	"block.minecraft.pale_oak_fence_gate": "Vrata ograde od blijedog hrasta",
	"block.minecraft.pale_oak_hanging_sign": "Blijedi hrastov viseći znak",
	"block.minecraft.pale_oak_leaves": "Lišće Svijetlog Hrasta",
	"block.minecraft.pale_oak_log": "blijedo hrastova cjepanica",
	"block.minecraft.pale_oak_planks": "Daska od Svijetlog Hrasta",
	"block.minecraft.pale_oak_pressure_plate": "blijedo hrastova tlačna ploča",
	"block.minecraft.pale_oak_sapling": "Mladica blijedog hrasta",
	"block.minecraft.pale_oak_shelf": "Polica od svijetlog hrasta",
	"block.minecraft.pale_oak_sign": "Znak blijedog hrasta",
	"block.minecraft.pale_oak_slab": "blijedo hrastova ploča",
	"block.minecraft.pale_oak_stairs": "Stepenice od blijedog hrasta",
	"block.minecraft.pale_oak_trapdoor": "Smeđa hrastova trap vrata",
	"block.minecraft.pale_oak_wall_hanging_sign": "Viseći Znak od Blijedog Hrasta",
	"block.minecraft.pale_oak_wall_sign": "Zidni znak od blijedog hrasta",
	"block.minecraft.pale_oak_wood": "Blijedo hrastovo drvo",
	...
	"block.minecraft.piglin_head": "Klipova glava",
	"block.minecraft.piglin_wall_head": "Klipska zidna glava",
	...
	"block.minecraft.pink_petals": "Roza traka",
	...
	"block.minecraft.pitcher_crop": "Kruh\nštap\njabuka",
	...
	"block.minecraft.polished_tuff_slab": "Polirana ploča tufa",
	"block.minecraft.polished_tuff_stairs": "Polirana stepenica tufa",
	"block.minecraft.polished_tuff_wall": "Polirani zid tufa",
	...
	"block.minecraft.potted_cherry_sapling": "Zasađena mladica višnje",
	"block.minecraft.potted_closed_eyeblossom": "Zatvoreni cvijet očiju u saksiji",
	...
	"block.minecraft.potted_open_eyeblossom": "Otvoreni Cvijet u Saksiji",
	...
	"block.minecraft.potted_pale_oak_sapling": "Mladica Blijedog Hrasta u Saksiji",
	...
	"block.minecraft.resin_brick_slab": "Ploča smolove cigle",
	"block.minecraft.resin_brick_stairs": "Stepenice smolove cigle",
	"block.minecraft.resin_brick_wall": "Zid od smolove cigle",
	"block.minecraft.resin_bricks": "Smolove cigle",
	...
	"block.minecraft.short_dry_grass": "Kratko Suho Staklo",
	...
	"block.minecraft.spawner.desc1": "Interakcija sa spawn jajetom:",
	"block.minecraft.spawner.desc2": "Postavlja vrstu čudovišta",
	...
	"block.minecraft.spruce_shelf": "Polica od smreke",
	...
	"block.minecraft.spruce_wall_hanging_sign": "Viseći znak smreke",
	...
	"block.minecraft.stripped_bamboo_block": "Blok ogoljenog bambusa",
	"block.minecraft.stripped_birch_log": "Oguljen panj od breze",
	"block.minecraft.stripped_birch_wood": "Oguljeno brezino drvo",
	"block.minecraft.stripped_cherry_log": "Ogoljeni Cherry Log",
	"block.minecraft.stripped_cherry_wood": "Ogoljeni Cherry Log",
	...
	"block.minecraft.stripped_pale_oak_log": "Oguljen panj od blijedog hrasta",
	"block.minecraft.stripped_pale_oak_wood": "Oguljeno drvo blijedog hrasta",
	...
	"block.minecraft.suspicious_sand": "Sumnjivi pjesak",
	...
	"block.minecraft.test_block": "Test blok",
	"block.minecraft.test_instance_block": "Blok Testne Instance",
	"block.minecraft.tinted_glass": "Obojeno staklo",
	"block.minecraft.tnt": "Dinamit",
	"block.minecraft.tnt.disabled": "TNT eksplozije su onemogućene",
	...
	"block.minecraft.trial_spawner": "Stvarač iskušenja",
	...
	"block.minecraft.tuff_brick_slab": "Ciglena ploča tufa",
	"block.minecraft.tuff_brick_stairs": "Ciglena stepenica tufa",
	"block.minecraft.tuff_brick_wall": "Cigleni zid tufa",
	"block.minecraft.tuff_bricks": "Cigle tufa",
	"block.minecraft.tuff_slab": "Ploča tufa",
	"block.minecraft.tuff_stairs": "Stepenice tufa",
	"block.minecraft.tuff_wall": "Zid tufa",
	...
	"block.minecraft.warped_hanging_sign": "Iskrivljen viseći znak",
	...
	"block.minecraft.warped_wall_hanging_sign": "Iskrivljeni zidni znak",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Voštani Otkriveni Klesani Bakar",
	...
	"block.minecraft.waxed_exposed_copper_bulb": "Voštana Otkrivena Bakarna Sijalica",
	...
	"block.minecraft.waxed_exposed_copper_door": "Voštana Otkrivena Bakarna Vrata",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Waxed Exposed Copper Golem Statue",
	"block.minecraft.waxed_exposed_copper_grate": "Voštana Otkrivena Bakarna Rešetka",
	"block.minecraft.waxed_exposed_copper_lantern": "Waxed Exposed Copper Lantern",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Voštani Otkriveni Bakarni Kapak",
	...
	"block.minecraft.waxed_oxidized_chiseled_copper": "Voštani Oksidirani Klesani Bakar",
	...
	"block.minecraft.waxed_oxidized_copper_bulb": "Voštana Oksidirana Bakarna Sijalica",
	...
	"block.minecraft.waxed_oxidized_copper_door": "Voštana Oksidirana Bakarna Vrata",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Waxed Oxidized Copper Golem Statue",
	"block.minecraft.waxed_oxidized_copper_grate": "Voštana Oksidirana Bakarna Rešetka",
	"block.minecraft.waxed_oxidized_copper_lantern": "Waxed Oxidized Copper Lantern",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Voštani Oksidirani Bakarni Kapak",
	...
	"block.minecraft.waxed_weathered_chiseled_copper": "Voštani Istrošeni Klesani Bakar",
	...
	"block.minecraft.waxed_weathered_copper_bulb": "Voštana Istrošena Bakarna Sijalica",
	...
	"block.minecraft.waxed_weathered_copper_door": "Voštana Istrošena Bakarna Vrata",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Waxed Weathered Copper Golem Statue",
	"block.minecraft.waxed_weathered_copper_grate": "Voštana Istrošena Bakarna Rešetka",
	"block.minecraft.waxed_weathered_copper_lantern": "Waxed Weathered Copper Lantern",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Vošteni Istrošeni Bakarni Kapak",
	...
	"block.minecraft.weathered_chiseled_copper": "Istrošeni Klesani Bakar",
	"block.minecraft.weathered_copper": "Korodirani bakar",
	"block.minecraft.weathered_copper_bars": "Weathered Copper Bars",
	"block.minecraft.weathered_copper_bulb": "Istrošena Bakarna Sijalica",
	...
	"block.minecraft.weathered_copper_door": "Istrošena Bakarna Vrata",
	"block.minecraft.weathered_copper_golem_statue": "Weathered Copper Golem Statue",
	"block.minecraft.weathered_copper_grate": "Istrošena Bakarna Rešetka",
	"block.minecraft.weathered_copper_lantern": "Weathered Copper Lantern",
	"block.minecraft.weathered_copper_trapdoor": "Istrošeni Bakarni Kapak",
	...
	"chat.disabled.invalid_command_signature": "Naredba je imala neočekivane ili nedostajuće naredbene znakove argumenta.",
	"chat.disabled.invalid_signature": "Čet je imao nevažeći znak. Molimo pokušajte ponovno povezivanje.",
	"chat.disabled.launcher": "Dopisivanje je onemogućeno od strane opcija pokretača. Ne možete slati poruke.",
	"chat.disabled.missingProfileKey": "Dopisivanje je onemogućeno zbog izgubljenog javnog ključa. Probajte se ponovo ulogovati.",
	"chat.disabled.options": "Razgovor je isključen u postavkama klijenta.",
	"chat.disabled.out_of_order_chat": "Čet je primio \"out-of-order\". Da li se promijenilo vrijeme tvog sistema?",
	"chat.disabled.profile": "Dopisivanje je onemogućeno zbog postavki profila. Pritisnite %s za više informacija.",
	...
	"chat.tag.system_single_player": "Poruka servera.",
	"chat.type.admin": "[%s: %s]",
	...
	"chat.validation_error": "Greška potvrde dijaloga",
	...
	"chunk.toast.checkLog": "Vidi zapis za više detalja",
	"chunk.toast.loadFailure": "Neuspješno učitavanje čanka kod %s",
	"chunk.toast.lowDiskSpace": "Manjak prostora na disku!",
	"chunk.toast.lowDiskSpace.description": "Postoji mogućnost da se ovaj svijet neće spremiti.",
	"chunk.toast.saveFailure": "Neuspješno spremanje čanka kod %s",
	...
	"command.forkLimit": "Dostignut je maksimalan broj konteksta (%s)",
	...
	"commands.attribute.base_value.reset.success": "Osnovna vrijednost za atribut %s za entitet %s postavljen na fabričku postavku %s",
	...
	"commands.banip.info": "Ovaj ban uključuje %s igrač(a): %s",
	...
	"commands.banlist.list": "Zabranjeni %s su:",
	...
	"commands.bossbar.get.players.some": "\nPrilagođena bossbar %s ima %s igrača(a) trenutno na mreži: %s",
	...
	"commands.bossbar.list.bars.some": "Postoji %s prilagođenih bossbar(a) aktivnih: %s",
	...
	"commands.bossbar.set.players.success.some": "Prilagođena bossbar %s sada ima %s igrača(e): %s",
	...
	"commands.clear.success.multiple": "Uklonjeno %s stvar(i) od %s igrača",
	"commands.clear.success.single": "Uklonjeno %s stvar(i) od igrača %s",
	"commands.clear.test.multiple": "Pronadjeno %s istih stvar(i) na %s igrača",
	"commands.clear.test.single": "Pronadjeno %s istih stvar(i) na %s igrača",
	...
	"commands.clone.success": "Uspješno kloniran(o) %s blok(ova)",
	"commands.clone.toobig": "Previše blokova u specifičnom prostoru (maksimalno %s, specifično %s)",
	"commands.damage.invulnerable": "Meta je izdrživa datom tipu udarca",
	"commands.damage.success": "Dodano %s štete %s",
	...
	"commands.datapack.disable.failed.feature": "Paket '%s' se ne može onemogućiti jer je dio omogućenog flaga!",
	"commands.datapack.enable.failed": "Paket '%s' je već uključen!",
	"commands.datapack.enable.failed.no_flags": "Paket %s ne može biti uključen, od kad zastave nisu uključene u ovom svijetu!",
	"commands.datapack.list.available.none": "Ne postoji više dostupnih paketa podataka",
	"commands.datapack.list.available.success": "Postoje mogućih %s data paket(a): %s",
	"commands.datapack.list.enabled.none": "Ne postoje odobreni paketi podataka",
	"commands.datapack.list.enabled.success": "Omogućeno je %s data paket(a): %s",
	...
	"commands.debug.function.noReturnRun": "Praćenje se ne može koristiti s povratnim pokretanjem",
	"commands.debug.function.success.multiple": "Pratio %s komandu(e) od %s funkcija do izlazne datoteke %s",
	"commands.debug.function.success.single": "Pratio %s komandu(e) od funkcije '%s' do izlazne datoteke %s",
	...
	"commands.drop.no_loot_table.block": "Blok %s nema tabelu plijena",
	...
	"commands.execute.function.instantiationFailure": "Neuspješno instanciranje funkcije %s: %s",
	...
	"commands.fill.success": "Uspješno popunjeno %s blok(ova)",
	...
	"commands.fillbiome.success.count": "%s unos/unosi u biome postavljeni između %s, %s, %s i %s, %s, %s",
	"commands.fillbiome.toobig": "Previše blokova u navedenom volumenu (maksimalno %s, specificirano %s)",
	...
	"commands.function.error.argument_not_compound": "Nevažeća vrsta argumenta: %s, očekivan Spoj",
	"commands.function.error.missing_argument": "Nedostaje argument %[2]s funkciji %[1]s",
	"commands.function.error.missing_arguments": "Nedostaje argument funkciji %s",
	"commands.function.error.parse": "Prilikom instanciranja makroa %s: Naredba '%s' izazvala je grešku: %s",
	"commands.function.instantiationFailure": "Neuspješno instanciranje funkcije %s: %s",
	"commands.function.result": "Funkcija %s vratila je %s",
	"commands.function.scheduled.multiple": "Pokrenute funkcije %s",
	"commands.function.scheduled.no_functions": "Ne mogu naći nikakvu funkciju sa imenom %s",
	"commands.function.scheduled.single": "Pokrenute funkcije %s",
	"commands.function.success.multiple": "Izvršeno %s komande(e) iz %s funkcija",
	"commands.function.success.multiple.result": "Izvršene funkcije %s",
	"commands.function.success.single": "Izvršena %s naredba(e) iz funkcije '%s'",
	...
	"commands.kick.owner.failed": "Ne mogu izbaciti vlasnika servera u LAN igri",
	"commands.kick.singleplayer.failed": "Ne može se Izbacivati u offline igri za jednog igrača",
	...
	"commands.perf.stopped": "Zaustavljeno profiliranje performansi nakon %s sekundi i %s tikova (%s tikova u sekundi)",
	...
	"commands.random.error.range_too_large": "Raspon nasumične vrijednosti mora biti najviše 2147483646",
	"commands.random.error.range_too_small": "Raspon nasumične vrijednosti mora biti najmanje 2",
	"commands.random.reset.all.success": "Poništi %s nasumičnu/e sekvencu/e",
	"commands.random.reset.success": "Restartuj nasumičnu sekvencu %s",
	"commands.random.roll": "%s ubacio %s (od %s do %s)",
	...
	"commands.ride.dismount.success": "%s je prestao voziti %s",
	"commands.ride.mount.failure.cant_ride_players": "Igrači se ne mogu jahati",
	"commands.ride.mount.failure.generic": "%s nije mogao početi voziti %s",
	"commands.ride.mount.failure.loop": "Ne može montirati entitet na sebe ili nekog od njegovih putnika",
	"commands.ride.mount.failure.wrong_dimension": "Ne može se montirati entitet u drugoj dimenziji",
	"commands.ride.mount.success": "%s je počeo voziti %s",
	"commands.ride.not_riding": "%s ne vozi nijedno vozilo",
	"commands.rotate.success": "Rotiran %s",
	...
	"commands.schedule.cleared.success": "Uklonjen %s raspored(a) sa Id-om %s",
	"commands.schedule.created.function": "Planirana funkcija '%s' u %s tick(ovima) u vrijeme igre %s",
	"commands.schedule.created.tag": "Planirana oznaka '%s' u %s otkucaja u vremenu od igre %s",
	"commands.schedule.macro": "Nemoguće zakazivanje makra",
	...
	"commands.scoreboard.objectives.list.success": "Postoji %s ciljeva: %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Onemogućeno auto-ažuriranje zaslona za cilj %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Omogućeno auto-ažuriranje zaslona za cilj %s",
	"commands.scoreboard.objectives.modify.displayname": "Promijenjeno prikazno ime %s na %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Očišćen zadani format brojeva za cilj %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Promijenjen zadani format brojeva za cilj %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Očišćen nadimak za %s entiteta u %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Očišćen nadimak za %s u %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Promiijenjen nadimak u %s za %s entiteta u %s",
	"commands.scoreboard.players.display.name.set.success.single": "Promijenjen nadimak u %s za %s u %s",
	...
	"commands.scoreboard.players.list.entity.success": "%s ima %s rezultat(e):",
	"commands.scoreboard.players.list.success": "Postoji %s praćenih entiteta/entiteta: %s",
	...
	"commands.setidletimeout.success": "Vrijeme čekanja igrača je sada %s min(s)",
	"commands.setidletimeout.success.disabled": "Vremensko ograničenje neaktivnosti igrača je sada onemogućeno",
	"commands.setworldspawn.failure.not_overworld": "Svijetno mrijesto se može postaviti samo za nadzemni svijet",
	...
	"commands.spreadplayers.failed.entities": "Nije moguće proširiti %s entitet/entitete oko %s, %s (previše entiteta za prostor - pokušajte koristiti širenje od najviše %s)",
	"commands.spreadplayers.failed.invalid.height": "Nevažeć maxHeight %s; previsoko je za minimum svijeta %s",
	"commands.spreadplayers.failed.teams": "Nije moguće rasporediti %s tim(ova) oko %s, %s (previše entiteta za prostor - pokušajte koristiti širenje od najviše %s)",
	"commands.spreadplayers.success.entities": "Raširite %s igrača(e) oko %s, %s sa prosječnom udaljenosti od %s blokova",
	"commands.spreadplayers.success.teams": "Rasporedite %s tim(ove) oko %s, %s sa prosječnom udaljenosti od %s blokova",
	...
	"commands.team.empty.success": "Uklonjeno %s članova iz tima %s",
	...
	"commands.team.list.teams.success": "Postoji %s tim(ovi): %s",
	...
	"commands.test.batch.starting": "Početno okruženje %s serija %s",
	"commands.test.clear.error.no_tests": "Nije moguće pronaći ikakve testove za čišćenje",
	"commands.test.clear.success": "Očišćeno %s struktura(e)",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Kliknite da kopirate u međuspremnik",
	"commands.test.create.success": "Kreiran test namještaj za test %s",
	"commands.test.error.no_test_containing_pos": "Can't find a test instance that contains %s, %s, %s",
	"commands.test.error.no_test_instances": "Nije pronađen nijedan test instance",
	"commands.test.error.non_existant_test": "Test %s nije pronađen",
	...
	"commands.test.no_tests": "Nema testova za pokretanje",
	"commands.test.relative_position": "Pozicija relativna %s: %s",
	"commands.test.reset.error.no_tests": "Nije moguće pronaći ikakve testove za resetovanje",
	"commands.test.reset.success": "Resetovano %s struktura(e)",
	"commands.test.run.no_tests": "Nisu pronađeni testovi",
	"commands.test.run.running": "Pokretanje %s test(ova)...",
	"commands.test.summary": "Test Igre završen! Izvršeno je %s test(ova)",
	"commands.test.summary.all_required_passed": "Svi potrebni testovi položeni :)",
	"commands.test.summary.failed": "%s potrebni testovi nisu uspjeli :(",
	"commands.test.summary.optional_failed": "%s opcijonalni test(i) nije uspio",
	...
	"commands.tick.query.rate.sprinting": "Ciljna brzina takta: %s po sekundi (Ignorišite, samo referenca).\nProsječno vrijeme po ticka: %sms",
	"commands.tick.rate.success": "Ciljna brzina takta postavljena na %s po sekundi",
	"commands.tick.sprint.report": "Sprint završen sa %s otkucaja po sekundi, ili %s ms po otkucaju",
	"commands.tick.sprint.stop.fail": "Nema sprint-a otkucaja u progresu",
	"commands.tick.sprint.stop.success": "Prekinut trenutni sprint otkucaja",
	"commands.tick.status.frozen": "Igra je smrznuta",
	"commands.tick.status.lagging": "Igra radi, ali ne može se pratiti ciljna brzina takta",
	"commands.tick.status.running": "Igra normalno radi",
	"commands.tick.status.sprinting": "Igra sprinta",
	"commands.tick.step.fail": "Nije moguće",
	"commands.tick.step.stop.fail": "Nema koraka za označavanje u toku",
	"commands.tick.step.stop.success": "Prekinulo trenutni korak toka",
	...
	"commands.transfer.success.multiple": "Prebacivanje %s igrača na %s:%s",
	"commands.transfer.success.single": "Prebacivanje %s na %s:%s",
	...
	"commands.whitelist.list": "Postoji %s igrača na bijeloj listi: %s",
	...
	"commands.worldborder.damage.buffer.success": "Postavite bafer oštećenja svjetske granice na %s blok(ova)",
	"commands.worldborder.get": "Svjetska granica je trenutno široka %s blok(ova)",
	...
	"commands.worldborder.set.immediate": "Postavite svjetsku granicu na širinu %s blok(ova)",
	"commands.worldborder.set.shrink": "Smanjenje svjetske granice na %s blok(ova) širine tijekom %s sekundi",
	"commands.worldborder.warning.distance.failed": "Izmjena nije učinjena. Obaviještenje granice svijeta već ima tu daljinu",
	"commands.worldborder.warning.distance.success": "Postavite udaljenost upozorenja svjetske granice na %s blok(ova)",
	"commands.worldborder.warning.time.failed": "Izmjena nije učinjena. Obaviještenje granice svijeta već ima ovo vrijeme",
	"commands.worldborder.warning.time.success": "Postavite vrijeme upozorenja na svjetsku granicu na %s sekundi",
	...
	"connect.failed.transfer": "Veza nije uspjela tokom prijenosa na server",
	...
	"connect.reconfiging": "Ponovo konfiguriranje...",
	"connect.reconfiguring": "Rekonfigurišem...",
	...
	"container.upgrade.error_tooltip": "Stavka se ne može nadograditi na ovaj način",
	"container.upgrade.missing_template_tooltip": "Dodaj Smithing Template",
	"controls.keybinds": "Postavke tipki...",
	"controls.keybinds.duplicateKeybinds": "Ovaj ključ se također koristi za:\n%s",
	...
	"credits_and_attribution.button.attribution": "Pripisivanje",
	"credits_and_attribution.button.credits": "Zasluge",
	"credits_and_attribution.button.licenses": "Licence",
	"credits_and_attribution.screen.title": "Zasluge i atribucija",
	"dataPack.bundle.description": "Omogućuje eksperimentalnu stavku predmeta",
	"dataPack.bundle.name": "Paketi",
	"dataPack.locator_bar.description": "Show the direction of other players in multiplayer",
	"dataPack.locator_bar.name": "Locator Bar",
	"dataPack.minecart_improvements.description": "Poboljšani pokreti za Rudarenja kolica",
	"dataPack.minecart_improvements.name": "Unapređenja rudarskih kolica",
	...
	"dataPack.trade_rebalance.description": "Ažurirane trgovine za seljane",
	"dataPack.trade_rebalance.name": "Rebalans Trgovine Seljaka",
	"dataPack.update_1_20.description": "Nove funkcije i sadržaj za Minecraft 1.20",
	"dataPack.update_1_20.name": "Ažuriranje 1.20",
	"dataPack.update_1_21.description": "Novi sadržaj i posebnosti za Minecraft 1.21",
	...
	"dataPack.winter_drop.name": "Zimska kap",
	"datapackFailure.safeMode": "Sigurni režim",
	"datapackFailure.safeMode.failed.description": "Ovaj svijet sadrži nevažeće ili oštećene sačuvane podatke.",
	"datapackFailure.safeMode.failed.title": "Učitavanje svijeta u sigurnom načinu rada nije uspjelo.",
	"datapackFailure.title": "Greške u trenutno odabranim paketima podataka spriječile su učitavanje svijeta.\nMožete ili pokušati da ga učitate samo sa vanilla paketom podataka (\"sigurni način\") ili se vratite na naslovni ekran i popravite ga ručno.",
	...
	"death.attack.dragonBreath": "%[1]s je pečeno u zmajevom dahu",
	...
	"death.attack.freeze.player": "%[1]s je smrznuo %[2]s do smrti",
	...
	"death.attack.genericKill.player": "%[1]s je ispečen u zmajevom dahu od strane %[2]s",
	...
	"death.attack.mace_smash": "Razbio ga je",
	"death.attack.mace_smash.item": "je razbijen sa",
	...
	"death.attack.message_too_long": "Zapravo, poruka je bila previše duga da se pošalje cijela. Izvinite! Izvolite skraćenu verziju: %s",
	...
	"death.attack.onFire.item": "%[1]s je izgorio dok se borio protiv %[2]s držeći %[3]s",
	...
	"death.attack.outsideBorder": "%[1]s je izašao ograničenja od ovog svijeta",
	"death.attack.outsideBorder.player": "%[1]s je izašao ograničenja ovog svijeta dok se borio sa %[2]s",
	...
	"death.attack.sweetBerryBush.player": "%[1]s je probijen do smrti od slatkog žbuna bobica dok je pokušavao pobjeći od %[2]s",
	...
	"death.attack.witherSkull": "%[1]sje pogođen od lobanje od%[2]s",
	...
	"debug.creative_spectator.error": "Nije moguća promjena načina igre; nema dozvole",
	"debug.creative_spectator.help": "F3 + N = Pokreni prethodni način igre <-> gledalac",
	"debug.dump_dynamic_textures": "Spašene dinamičke teksture u %s",
	"debug.dump_dynamic_textures.help": "F3 + S = Dump dinamičke teksture",
	...
	"debug.gamemodes.error": "Nije moguće otvoriti mijenjač načina igre, nemate dozvolu",
	...
	"disconnect.ignoring_status_request": "Ignoriranje statusa zahtjeva",
	...
	"disconnect.transfer": "Prebačeno na drugu domenu/server",
	...
	"download.pack.title": "Preuzimanje tekstura %s/%s",
	...
	"effect.duration.infinite": "beskonačno",
	...
	"effect.minecraft.infested": "Zaraženo",
	...
	"effect.minecraft.oozing": "Curenje",
	"effect.minecraft.poison": "Otrov",
	"effect.minecraft.raid_omen": "Znak Racije",
	...
	"effect.minecraft.wind_charged": "Nabojen Vjetrom",
	"effect.minecraft.wither": "Venuti",
	...
	"enchantment.minecraft.sweeping_edge": "Zamahivajući rub",
	...
	"enchantment.minecraft.wind_burst": "vjetar je prasnuo",
	"entity.minecraft.acacia_boat": "Brod od bagrema",
	"entity.minecraft.acacia_chest_boat": "Čamac od bagrema sa sandukom",
	"entity.minecraft.allay": "Alej",
	"entity.minecraft.area_effect_cloud": "Efekat područja oblaka",
	"entity.minecraft.armadillo": "Oklopnik",
	"entity.minecraft.armor_stand": "Postolje za oklop",
	"entity.minecraft.arrow": "Strijela",
	"entity.minecraft.axolotl": "Aksolotl",
	"entity.minecraft.bamboo_chest_raft": "Bambusov splav sa grudima",
	"entity.minecraft.bamboo_raft": "splav od bambusa",
	"entity.minecraft.bat": "Slijepi miš",
	"entity.minecraft.bee": "Pčela",
	"entity.minecraft.birch_boat": "brod od breze",
	"entity.minecraft.birch_chest_boat": "Brod od breze sa sandukom",
	"entity.minecraft.blaze": "Plamen",
	"entity.minecraft.block_display": "Prikaz bloka",
	"entity.minecraft.boat": "čamac",
	"entity.minecraft.bogged": "Zaglibio",
	"entity.minecraft.breeze": "Povetarac",
	"entity.minecraft.breeze_wind_charge": "Vjetar naboj",
	...
	"entity.minecraft.cherry_boat": "Čamac s trešnjama",
	"entity.minecraft.cherry_chest_boat": "Čamac od trešnje sa škrinjom",
	"entity.minecraft.chest_boat": "Brod sa sandukom",
	...
	"entity.minecraft.creaking": "škripi",
	"entity.minecraft.creaking_transient": "škripi",
	"entity.minecraft.creeper": "Kriper",
	"entity.minecraft.dark_oak_boat": "Čamac od tamnog hrasta",
	"entity.minecraft.dark_oak_chest_boat": "Čamac od tamnog hrasta sa sandukom",
	...
	"entity.minecraft.falling_block_type": "Padanje %s",
	...
	"entity.minecraft.jungle_boat": "Brod iz džungle",
	"entity.minecraft.jungle_chest_boat": "Čamac iz džungle sa škrinjom",
	"entity.minecraft.killer_bunny": "Zec ubica",
	"entity.minecraft.leash_knot": "Čvor povodca",
	"entity.minecraft.lightning_bolt": "Munja",
	"entity.minecraft.lingering_potion": "Zadržavajući Napitak",
	"entity.minecraft.llama": "Lama",
	"entity.minecraft.llama_spit": "Lama pljuje",
	"entity.minecraft.magma_cube": "Kocka magme",
	"entity.minecraft.mangrove_boat": "Brod s mangrovima",
	"entity.minecraft.mangrove_chest_boat": "Čamac za mangrove sa sandukom",
	...
	"entity.minecraft.oak_boat": "Hrastov brod",
	"entity.minecraft.oak_chest_boat": "Hrastov čamac sa sandukom",
	"entity.minecraft.ocelot": "Divlja mačka",
	"entity.minecraft.ominous_item_spawner": "Zloslutni stvarač predmeta",
	"entity.minecraft.painting": "Slika",
	"entity.minecraft.pale_oak_boat": "Čamac od blijedog hrasta",
	"entity.minecraft.pale_oak_chest_boat": "Brod za Kovčegom od Blijedog Hrasta",
	...
	"entity.minecraft.sniffer": "Njuskalo",
	"entity.minecraft.snow_golem": "Sniježni golem",
	"entity.minecraft.snowball": "Grudva",
	"entity.minecraft.spawner_minecart": "Vagon sa cudovišnim stvaračem",
	"entity.minecraft.spectral_arrow": "Svijetleća strijela",
	"entity.minecraft.spider": "Pauk",
	"entity.minecraft.splash_potion": "Napitak za Prskanje",
	"entity.minecraft.spruce_boat": "Brod od Smreke",
	"entity.minecraft.spruce_chest_boat": "Brod za Kovčegom od Smreke",
	...
	"event.minecraft.raid.victory.full": "Pljačka - Pobjeda",
	"filled_map.buried_treasure": "Zakopana mapa sa blagom",
	"filled_map.explorer_jungle": "Mapa Istraživača Džungle",
	"filled_map.explorer_swamp": "Mapa Istraživača Močvare",
	"filled_map.id": "Id #%s",
	...
	"filled_map.village_desert": "Karta sela u pustinji",
	"filled_map.village_plains": "Plains Village Map",
	"filled_map.village_savanna": "Mapa Sela Savane",
	"filled_map.village_snowy": "Karta sela prekrivenog snijegom",
	"filled_map.village_taiga": "Karta sela tajga",
	...
	"gameMode.hardcore": "Ekstremni mod!",
	...
	"gamerule.blockExplosionDropDecay": "U eksplozijama interakcije blokova, neki blokovi neće ispustiti svoj plijen",
	"gamerule.blockExplosionDropDecay.description": "Neki od predmeta iz blokova uništenih eksplozijama uzrokovanim interakcijama blokova gube se u eksploziji.",
	...
	"gamerule.commandModificationBlockLimit": "Modifikacija komande Ograničenje blokova",
	"gamerule.commandModificationBlockLimit.description": "Broj blokova koji se mogu promijeniti odjednom od jedne komande, kao popuni ili kloniraj.",
	...
	"gamerule.doLimitedCrafting.description": "Ako je uključeno, igrači će moći da prave samo otključane recepte.",
	"gamerule.doMobLoot": "Ispusti plijen stvorenja",
	"gamerule.doMobLoot.description": "Kontrole ispuštanja resursa od stvorenja, uklučujući iskustvo.",
	...
	"gamerule.doTileDrops.description": "Kontrole ispuštanja resursa iz blokova, uključujući iskustvo.",
	"gamerule.doTraderSpawning": "Stvoriti Lutajuče Trgovce",
	"gamerule.doVinesSpread": "Lijane se šire",
	"gamerule.doVinesSpread.description": "Kontrole da li blok lijane nasumično šire na susjedne blokove. Ne utiče druge vrste blokova lijane kao i Plačljive lijane, Vrteće lijane, itd.",
	"gamerule.doWardenSpawning": "Stvori Čuvare",
	...
	"gamerule.globalSoundEvents.description": "Kada se određeni trenutci igre se dogode, kao stvaranje šefa, svuk se čuje posvuda.",
	...
	"gamerule.maxCommandChainLength.description": "Primjenjuje se na blok Komande Lance i funkcije.",
	"gamerule.maxCommandForkCount": "Ograničite kontekst naredbe",
	...
	"gamerule.minecartMaxSpeed": "Minecraft maksimalna brzina",
	...
	"gamerule.mobExplosionDropDecay": "U eksplozijama stvorenja, neki blokovi neće ispustiti svoj plijen",
	"gamerule.mobExplosionDropDecay.description": "Neki plijen od blokova razbijenih od eksplozija napravljene od stvorenja je izgubljen u eksploziji.",
	...
	"gamerule.projectilesCanBreakBlocks": "Projektili mogu razbijati blokove",
	...
	"gamerule.reducedDebugInfo.description": "Ograničava sadržaja ekrana za otklanjanje grešaka.",
	"gamerule.sendCommandFeedback": "Šalji povratnu informaciju komande",
	"gamerule.showDeathMessages": "Prikazuj poruke smrti",
	"gamerule.snowAccumulationHeight": "Visina akumulacije Snijega",
	"gamerule.snowAccumulationHeight.description": "Kada pada Snijeg, na tlu se formiraju slojevi Snijega do najviše ovog broja slojeva.",
	...
	"gamerule.tntExplosionDropDecay": "U eksplosijama TNT-a, neki blokovi neće ispustiti svoj plijen",
	"gamerule.tntExplosionDropDecay.description": "Neki plijen od blokova uništeni eksploziji napravljenih od TNT-a je izgubljen u eksploziji.",
	...
	"gamerule.waterSourceConversion": "Voda se pretvori u izvor",
	...
	"gui.abuseReport.attestation": "Podnošenjem ovog izvještaja, potvrđujete da su informacije koje ste dali tačne i potpune prema vašem najboljem znanju.",
	"gui.abuseReport.comments": "Komentari",
	"gui.abuseReport.describe": "Dijeljenje detalja pomoći će nam da napravimo dobro informisanu odluku.",
	"gui.abuseReport.discard.content": "Ako napustite ovu stranicu vaš izvještaj i komentari će biti izgubljeni.\nJeste li sigurni da želite napustiti stranicu?",
	"gui.abuseReport.discard.discard": "Izađi i Odbaci Prijavu",
	"gui.abuseReport.discard.draft": "Spremi kao skicu",
	"gui.abuseReport.discard.return": "Nastavite uređivati",
	"gui.abuseReport.discard.title": "Poništi prijavu i komentar?",
	"gui.abuseReport.draft.content": "Želite li nastaviti uređivati postojeći izvještaj ili ga odbaciti i kreirati novi?",
	"gui.abuseReport.draft.discard": "Odbaci",
	"gui.abuseReport.draft.edit": "Nastavite sa uređivanjem",
	"gui.abuseReport.draft.quittotitle.content": "Želite li ga nastaviti uređivati ili odbaciti?",
	"gui.abuseReport.draft.quittotitle.title": "Imate nacrt izvještaja o chatu koji će biti izgubljen ako date otkaz",
	"gui.abuseReport.draft.title": "Uredite nedovršenu prijavu poruke?",
	...
	"gui.abuseReport.more_comments": "Molim vas opišite što se dogodilo:",
	"gui.abuseReport.name.comment_box_label": "Molim vas opišite zašto želite prijaviti ovo ime:",
	...
	"gui.abuseReport.read_info": "Saznajte više o prijavljanju",
	...
	"gui.abuseReport.reason.imminent_harm.description": "Neko prijeti da će nauditi vama ili nekom drugom u stvarnom životu.",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Seksualno neprikladno",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Skinovi koji su grafičke prirode koji se odnose na seksualne činove, seksualne organe i seksualno nasilje.",
	...
	"gui.abuseReport.report_sent_msg": "Uspješno smo primili vaš izvještaj. Hvala!\n\nNaš tim će ga pregledati što je prije moguće.",
	"gui.abuseReport.select_reason": "Odaberite kategoriju izvještaja",
	...
	"gui.abuseReport.send.no_reason": "Molimo odaberite kategoriju izvještaja",
	"gui.abuseReport.send.not_attested": "Molimo pročitajte gornji tekst i označite potvrdni okvir da biste mogli poslati izvještaj",
	...
	"gui.abuseReport.skin.title": "Prijavi kožu igrača",
	...
	"gui.banned.description.permanent": "Vaš račun je trajno zabranjen, što znači da ne možete igrati online ili se pridružiti Realms-u.",
	...
	"gui.banned.name.description": "Vaše trenutno ime - \"%s\" - krši naše standarde zajednice. Možete igrati singleplayer, ali ćete morati promijeniti svoje ime da biste igrali online.\n\nSaznajte više ili pošaljite pregled slučaja na sljedećem linku: %s",
	"gui.banned.name.title": "Ime nije dozvoljeno u multiplayeru ",
	"gui.banned.reason.defamation_impersonation_false_information": "Lažno predstavljanje ili dijeljenje informacija radi iskorištavanja ili zavaravanja drugih",
	"gui.banned.reason.drugs": "Reference na ilegalne droge",
	"gui.banned.reason.extreme_violence_or_gore": "Prikazi pretjeranog nasilja ili krvotoka u stvarnom životu",
	"gui.banned.reason.false_reporting": "Previše lažnih ili netačnih izvještaja",
	"gui.banned.reason.fraud": "Prevarno sticanje ili korištenje sadržaja",
	"gui.banned.reason.generic_violation": "Kršenje standarda zajednice",
	"gui.banned.reason.harassment_or_bullying": "Uvredljiv jezik korišten na usmjeren, štetan način",
	"gui.banned.reason.hate_speech": "Govor mržnje ili diskriminacija",
	"gui.banned.reason.hate_terrorism_notorious_figure": "Reference na grupe mržnje, terorističke organizacije ili ozloglašene ličnosti",
	"gui.banned.reason.imminent_harm_to_person_or_property": "Namjera da se nanese šteta u stvarnom životu osobama ili imovini",
	"gui.banned.reason.nudity_or_pornography": "Prikazivanje nepristojnog ili pornografskog materijala",
	"gui.banned.reason.sexually_inappropriate": "Teme ili sadržaji seksualne prirode",
	"gui.banned.reason.spam_or_advertising": "Spam ili oglašavanje",
	"gui.banned.skin.description": "Vaša trenutna koža krši naše standarde zajednice. Još uvijek možete igrati sa zadanim skinom, ili odabrati novi.\n\nSaznajte više ili pošaljite pregled slučaja na sljedećem linku: %s\n \n",
	...
	"gui.copy_link_to_clipboard": "Kopiraj Vezu u Međuspremnik",
	"gui.days": "%s dan(a)",
	"gui.done": "Urađeno",
	"gui.down": "Dolje",
	...
	"gui.none": "Ništa",
	"gui.ok": "Ok",
	"gui.open_report_dir": "Otvori direktorij izvještaja",
	...
	"gui.remove": "Remove",
	"gui.report_to_server": "Javi se serveru",
	...
	"gui.toRealms": "Povratak na listu Carstva",
	"gui.toTitle": "Nazad na Početni Ekran",
	"gui.toWorld": "Povratak na svjetsku listu",
	...
	"item.minecraft.angler_pottery_shard": "Krhotina Angler Pottery Shard",
	...
	"item.minecraft.armadillo_scute": "Ljuska oklopnika",
	"item.minecraft.armadillo_spawn_egg": "Jaje za stvaranje armadila",
	...
	"item.minecraft.blade_pottery_shard": "Krhotina oštrice",
	"item.minecraft.blade_pottery_sherd": "Oštrica keramike s oštricom",
	...
	"item.minecraft.blue_egg": "Plavo Jaje",
	"item.minecraft.blue_harness": "Blue Harness",
	"item.minecraft.bogged_spawn_egg": "Jaje Zaglibitog",
	"item.minecraft.bolt_armor_trim_smithing_template": "Kovačka šablona",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Ukras Oklopa Zavrtanj",
	...
	"item.minecraft.breeze_rod": "Vjetroviti štap",
	"item.minecraft.breeze_spawn_egg": "Jaje za stvaranje vjetrenog čudovišta",
	"item.minecraft.brewer_pottery_shard": "Brewer Pottery Shard",
	"item.minecraft.brewer_pottery_sherd": "Brewer Pottery Sherd",
	"item.minecraft.brewing_stand": "Štand za pivo",
	...
	"item.minecraft.burn_pottery_shard": "Spali krhotine",
	"item.minecraft.burn_pottery_sherd": "Spali ulomak keramike",
	...
	"item.minecraft.cherry_chest_boat": "Cherry Boat sa sandukom",
	...
	"item.minecraft.coast_armor_trim_smithing_template.new": "Obalni Ukras Oklopa",
	...
	"item.minecraft.creaking_spawn_egg": "Jaje Škripućeg",
	...
	"item.minecraft.danger_pottery_shard": "Opasnost krhotina keramike",
	...
	"item.minecraft.dune_armor_trim_smithing_template.new": "Ukras Oklopa Dina",
	...
	"item.minecraft.ender_dragon_spawn_egg": "Jaje Stvaranja Krajnjeg Zmaja",
	...
	"item.minecraft.explorer_pottery_shard": "Krhotina keramike Istraživač",
	"item.minecraft.explorer_pottery_sherd": "Ulomak Keramike Istraživač",
	"item.minecraft.eye_armor_trim_smithing_template": "Kovački šablon",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Ukras Oklopa Oko",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Kovačka šablona",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Ukras Oklopa Protok",
	"item.minecraft.flow_banner_pattern": "Banner Pattern",
	"item.minecraft.flow_banner_pattern.desc": "Protok",
	"item.minecraft.flow_banner_pattern.new": "Patern Banera Protok",
	"item.minecraft.flow_pottery_sherd": "Ulomak Keramike Protok",
	"item.minecraft.flower_banner_pattern": "Uzorak Banera",
	...
	"item.minecraft.friend_pottery_shard": "Prijatelj Pottery Shard",
	"item.minecraft.friend_pottery_sherd": "Prijatelj Pottery Sherd",
	"item.minecraft.frog_spawn_egg": "Jaje Stvaranja Žabe",
	"item.minecraft.furnace_minecart": "Vagon sa Peći",
	"item.minecraft.ghast_spawn_egg": "Jaje Ghasta",
	"item.minecraft.ghast_tear": "Ghasta suza",
	"item.minecraft.glass_bottle": "Staklena bočica",
	"item.minecraft.glistering_melon_slice": "Svetlucava kriška lubenice",
	"item.minecraft.globe_banner_pattern": "Uzorak Banera",
	"item.minecraft.globe_banner_pattern.desc": "Globus",
	"item.minecraft.globe_banner_pattern.new": "Patern Banera Globus",
	...
	"item.minecraft.glow_squid_spawn_egg": "Jaje stvaranja svjetleće lignje",
	...
	"item.minecraft.guster_banner_pattern": "Patern Banera",
	...
	"item.minecraft.heart_pottery_shard": "Ulomak Keramike Srce",
	"item.minecraft.heart_pottery_sherd": "Ulomak Keramike Srce",
	"item.minecraft.heartbreak_pottery_shard": "Ulomak Keramike slomljeno srce",
	"item.minecraft.heartbreak_pottery_sherd": "Ulomak Keramike Slomljeno Srce",
	...
	"item.minecraft.howl_pottery_shard": "Ulomak Keramike Zavijanje",
	"item.minecraft.howl_pottery_sherd": "Ulomak Keramike Zavijanje",
	...
	"item.minecraft.iron_golem_spawn_egg": "Jaje Stvaranja Gvozdenog Golema",
	...
	"item.minecraft.jungle_chest_boat": "Džunglin Brod sa Kovčegom",
	...
	"item.minecraft.lingering_potion.effect.infested": "Dugotrajni Napitak Zaraze",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Dugotrajni Napitak Curenja",
	...
	"item.minecraft.lingering_potion.effect.wind_charged": "Dugotrajni Napitak Nabijenog Vjetra",
	...
	"item.minecraft.magenta_bundle": "Magenta Svežanj",
	...
	"item.minecraft.mangrove_boat": "Mangrov Brod",
	"item.minecraft.mangrove_chest_boat": "Mangrov Brod sa Kovčegom",
	...
	"item.minecraft.miner_pottery_shard": "Ulomak Keramike Rudar",
	"item.minecraft.miner_pottery_sherd": "Ulomak Keramike Rudar",
	"item.minecraft.mojang_banner_pattern": "Uzorak Banera",
	"item.minecraft.mojang_banner_pattern.desc": "Stvar",
	"item.minecraft.mojang_banner_pattern.new": "Stvar Patern Banera",
	"item.minecraft.mooshroom_spawn_egg": "Jaje mooshruma",
	"item.minecraft.mourner_pottery_shard": "Ulomak Keramike Ožalošćeni",
	"item.minecraft.mourner_pottery_sherd": "Ulomak keramike Ožaloščeni",
	...
	"item.minecraft.music_disc_creator": "Muzička ploča",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Kreator",
	"item.minecraft.music_disc_creator_music_box": "Muzička ploča",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Kreator (Glazbena Kutija)",
	...
	"item.minecraft.music_disc_precipice": "Muzička ploča",
	"item.minecraft.music_disc_precipice.desc": "Aaron Cherof - Provalija",
	"item.minecraft.music_disc_relic": "Muzički Disk",
	...
	"item.minecraft.nether_wart": "Nederska Izraslina",
	...
	"item.minecraft.netherite_upgrade_smithing_template.new": "Netherit Nadogratnja",
	"item.minecraft.oak_boat": "Hrastov Čamac",
	"item.minecraft.oak_chest_boat": "Hrastov Brod sa Kovčegom",
	"item.minecraft.ocelot_spawn_egg": "Jaje divlje mačke",
	"item.minecraft.ominous_bottle": "Zloslutna boca",
	...
	"item.minecraft.pale_oak_chest_boat": "Brod za Kovčegom od Blijedog Hrasta",
	...
	"item.minecraft.piglin_banner_pattern": "Uzorak Banera",
	"item.minecraft.piglin_banner_pattern.desc": "Njuška",
	"item.minecraft.piglin_banner_pattern.new": "Njuška Patern Banera",
	...
	"item.minecraft.pink_bundle": "Rozi Svežanj",
	"item.minecraft.pink_dye": "Ružičasti pigment",
	"item.minecraft.pink_harness": "Pink Harness",
	"item.minecraft.pitcher_plant": "Pitcher biljka",
	"item.minecraft.pitcher_pod": "Pitcher Pod",
	"item.minecraft.plenty_pottery_shard": "Ulomak Keramike Dosta",
	"item.minecraft.plenty_pottery_sherd": "Ulomak Keramike Dosta",
	...
	"item.minecraft.potion.effect.infested": "Napitak Infestacije",
	...
	"item.minecraft.potion.effect.oozing": "Napitak Curenja",
	...
	"item.minecraft.potion.effect.wind_charged": "Napitak Nabijanja Vjetra",
	"item.minecraft.pottery_shard_archer": "Ulomak Keramike Strijelac",
	"item.minecraft.pottery_shard_arms_up": "Ulomak Keramike Ruke Gore",
	"item.minecraft.pottery_shard_prize": "Ulomak Keramike Nagrada",
	"item.minecraft.pottery_shard_skull": "Ulomak Keramike Lobanja",
	...
	"item.minecraft.prize_pottery_shard": "Ulomak Keramike Nagrada",
	"item.minecraft.prize_pottery_sherd": "Ulomak Keramike Nagrada",
	...
	"item.minecraft.resin_brick": "Cigla Smola",
	"item.minecraft.resin_clump": "Grudvica Smole",
	"item.minecraft.rib_armor_trim_smithing_template": "Kovački šablon",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Ukras Oklopa Rebra",
	...
	"item.minecraft.scrape_pottery_sherd": "Ulomak Keramike Ogrebotina",
	...
	"item.minecraft.sheaf_pottery_shard": "Ulomak Keramike Snop",
	"item.minecraft.sheaf_pottery_sherd": "Ulomak Keramike Snop",
	"item.minecraft.shears": "Makaze",
	"item.minecraft.sheep_spawn_egg": "Jaje ovce",
	"item.minecraft.shelter_pottery_shard": "Ulomak Keramike Zaklon",
	"item.minecraft.shelter_pottery_sherd": "Ulomak Keramike Zaklon",
	...
	"item.minecraft.skull_banner_pattern": "Uzorak Banera",
	"item.minecraft.skull_banner_pattern.desc": "Lobanja",
	"item.minecraft.skull_banner_pattern.new": "Skull Charge Banner Pattern",
	"item.minecraft.skull_pottery_shard": "Ulomak Keramike Lobanja",
	"item.minecraft.skull_pottery_sherd": "Ulomak Keramike Lobanja",
	...
	"item.minecraft.smithing_template.armor_trim.additions_slot_description": "Dodaj šipku ili kristal",
	...
	"item.minecraft.smithing_template.armor_trim.ingredients": "Šipke I Kristali",
	"item.minecraft.smithing_template.ingredients": "Namjernice:",
	"item.minecraft.smithing_template.netherite_upgrade.additions_slot_description": "Dodaj Nederitsku Šipku",
	"item.minecraft.smithing_template.netherite_upgrade.applies_to": "Diamantska Oprema",
	"item.minecraft.smithing_template.netherite_upgrade.base_slot_description": "Dodaj Diamantski oklop, oružje, ili alat",
	"item.minecraft.smithing_template.netherite_upgrade.ingredients": "Nederitska Poluga",
	"item.minecraft.smithing_template.upgrade": "Nadograda: ",
	"item.minecraft.sniffer_spawn_egg": "Jaje Stvaranja Njuškala",
	"item.minecraft.snort_pottery_shard": "Ulomak Keramike Frktanje",
	"item.minecraft.snort_pottery_sherd": "Ulomak Keramike Frktanje",
	"item.minecraft.snout_armor_trim_smithing_template": "Kovački šablon",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Ukras Oklopa Njuška",
	"item.minecraft.snow_golem_spawn_egg": "Jaje stvaranja Sniježnog golema",
	...
	"item.minecraft.splash_potion.effect.infested": "Rasprskujući Napitak Zaraze",
	...
	"item.minecraft.splash_potion.effect.oozing": "Rasprskujući Napitak Curenja",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Strijela infestacije",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Strijela sluznosti",
	...
	"item.minecraft.tipped_arrow.effect.wind_charged": "Strijela vazdušnog naboja",
	"item.minecraft.tnt_minecart": "Vagon sa Dinamitom",
	"item.minecraft.torchflower_seeds": "Sjeme cvijeća baklje",
	"item.minecraft.totem_of_undying": "Totem besmrtnosti",
	"item.minecraft.trader_llama_spawn_egg": "Jaje trgovca lame",
	"item.minecraft.trial_key": "Testni ključ",
	...
	"item.minecraft.wither_spawn_egg": "Jaje uvenućeg",
	...
	"itemGroup.consumables": "Konzumacije",
	...
	"itemGroup.ingredients": "Namjernice",
	"itemGroup.inventory": "Inventar za preživljavanje",
	"itemGroup.natural": "Naturalni blokovi",
	"itemGroup.op": "Operatorne usluge",
	"itemGroup.redstone": "Blokovi crvenog kamena",
	"itemGroup.search": "Pretraga inventara",
	"itemGroup.spawnEggs": "Stvori jaja",
	"itemGroup.tools": "Alati i Usluge",
	...
	"jukebox_song.minecraft.wait": "C418 - čekaj",
	...
	"key.keyboard.unknown": "Nije vezano",
	...
	"mco.account.privacy.info.button": "Pročitajte više o GDPR",
	"mco.account.privacy.information": "Mojang provodi određene procedure kako bi pomogli u zaštiti djece i njihove privatnosti uključujući usklađivanje sa Children's Online Privacy Protection Act (COPPA) i General Data Protection Regulation (GDPR).\n\nMožete trebati dobiti odobrenje roditelja prije pristupanja vašem Realms računu.",
	...
	"mco.activity.noactivity": "Nema aktivnosti u zadnjim %s dan(a)",
	...
	"mco.backup.entry": "Kopija (%s)",
	"mco.backup.entry.description": "Opis",
	"mco.backup.entry.enabledPack": "Omogućeni paket",
	...
	"mco.backup.entry.templateName": "Naziv šablona",
	"mco.backup.entry.undefined": "Neizražena promjena",
	"mco.backup.entry.uploaded": "Prijenos",
	"mco.backup.entry.worldType": "Tip svijeta",
	...
	"mco.backup.info.title": "Promjena od zadnje kopije",
	"mco.backup.narration": "Backup od %s",
	...
	"mco.client.outdated.stable.version": "Verzija vašeg klienta (%s) nije kompatibilna za Realms.\n\nMolimo koristite naj noviju verziju Minecraft-a.",
	"mco.client.unsupported.snapshot.version": "Verzija vašeg klienta (%s) nije kompatibilna za Realms.\n\nRealms nije dostupan za ovu snapshot verziju.",
	"mco.compatibility.downgrade": "Sniziti",
	"mco.compatibility.downgrade.description": "Ovaj svijet zadnji put je igran na verziji %s; ti si na verziji %s. Vraćanje na staru verziju svijeta može uzrokovati oštećenje ili korupciju - nemamo garanciju hoće li svijet proraditi.\nKopija svijeta biti će napravljenu na lokaciji \"World backups\". Molimo da obnovite svijet po potrebi.",
	"mco.compatibility.incompatible.popup.title": "Ne kompatibilna verzija",
	"mco.compatibility.incompatible.releaseType.popup.message": "Svijet u koji pokušavate ući nije kompatibilan sa vašom verzijom.",
	"mco.compatibility.incompatible.series.popup.message": "Ovaj svijet je zadnje igran na verziji %s; vi ste na verziji %s.\n\nOve serije nisu kompatibilne jedna sa drugom. Novi svijet je potreban za igranje na ovoj verziji.",
	"mco.compatibility.unverifiable.message": "Ovaj verzija ovoga svijeta koja je zadnji put igrana nije mogla biti verificirana. Ako nadogradite svijet ili ga degradirate, kopija će se automatski napraviti i spremiti unutar \"World backups\".",
	"mco.compatibility.unverifiable.title": "Nije moguće verifikovati kompatibilnost",
	"mco.compatibility.upgrade": "Nadograditi",
	...
	"mco.configure.world.invite.narration": "Ti imaš %s novih poziv(a)",
	"mco.configure.world.invite.profile.name": "Ime",
	"mco.configure.world.invited": "Pozvan",
	"mco.configure.world.invited.number": "Pozvan (%s)",
	...
	"mco.configure.world.minigame": "Trenutni: %s",
	...
	"mco.configure.world.subscription.recurring.info": "Promjene napravljene na tvoje supskripcije Carstva kao i slaganje vremena ili isklučivanje ponavljajuću naplatu neće biti reflektovano do tvojeg sljedećeg datuma računa.",
	...
	"mco.configure.world.switch.slot": "Napravi svijet",
	...
	"mco.configure.world.uninvite.player": "Da li ste sigurni da hoćete poništiti poziv '%s?",
	...
	"mco.create.world.failed": "Kreiranje svijeta nije uspjelo!",
	...
	"mco.download.resourcePack.fail": "Preuzimanje resurs paketa nije uspjelo!",
	...
	"mco.errorMessage.6007": "Korisnik u previše Carstva",
	"mco.errorMessage.6008": "Ime Carstva ne važi",
	"mco.errorMessage.6009": "Opis Carstva ne važi",
	"mco.errorMessage.connectionFailure": "Došlo je do greške, molimo pokušajte kasnije.",
	"mco.errorMessage.generic": "Greška se pojavila: ",
	"mco.errorMessage.initialize.failed": "Failed to initialize Realm",
	"mco.errorMessage.noDetails": "Ne postoji obrazloženje ove pogreške",
	"mco.errorMessage.realmsService": "Greška se pojavila (%s):",
	...
	"mco.notification.transferSubscription.buttonText": "Prevedi odmah",
	...
	"mco.notification.visitUrl.buttonText.default": "Otvori vezu",
	"mco.notification.visitUrl.message.default": "Molim vas posjetite vezu ispod",
	"mco.onlinePlayers": "Online Igrači",
	...
	"mco.selectServer.configureRealm": "Konfiguriši carstvo",
	...
	"mco.selectServer.loading": "Učitavanje Realms Liste",
	...
	"mco.snapshot.description": "Uparen sa \"%s\"",
	...
	"mco.time.daysAgo": "%[1]s dan(i) prije",
	"mco.time.hoursAgo": "%[1]s sat(i) prije",
	"mco.time.minutesAgo": "%[1]s minut(a) prije",
	"mco.time.now": "upravo sad",
	"mco.time.secondsAgo": "%[1]s sekund(i) prije",
	...
	"mco.upload.close.failure": "Nismo mogli zatvoriti vaš realm, molimo pokušajte kasnije",
	...
	"menu.server_links": "Serverske Veze...",
	"menu.server_links.title": "Serverske Veze",
	...
	"multiplayer.disconnect.invalid_public_key_signature.new": "Nevažeći potpis za javni ključ profila.\nPokušajte ponovo pokrenuti igru.",
	...
	"multiplayer.disconnect.transfers_disabled": "Ovaj server/domena ne dozvoljava prebačaje",
	...
	"multiplayer.lan.server_found": "Novi server pronađen: %s",
	...
	"multiplayer.status.player_count.narration": "%s od %s igrača na vezi",
	...
	"narration.suggestion.usage.cycle.fixed": "Pritisni Tab kako bi otišao na drugu sugestiju",
	"narration.suggestion.usage.cycle.hidable": "Pritisni Tab kako bi otišao na drugu sugestiju, ili Escape kako bi izašao iz sugestija",
	"narration.suggestion.usage.fill.fixed": "Pritisni Tab kako bi vidio sugestije",
	"narration.suggestion.usage.fill.hidable": "Pritisni Tab kako bi otišao na drugu sugestiju, ili Escape kako bi izašao iz sugestija",
	"narration.tab_navigation.usage": "Pricnite Ctrl i Tab da prebacivate između kartica",
	...
	"narrator.position.tab": "Odabrana kartica Press %s od %s",
	...
	"narrator.select.world_info": "Odabran %s, zadnje igran: %s, %s",
	...
	"optimizeWorld.stage.finished": "Dovršavanje...",
	...
	"options.accessibility": "Podešavanja pristupa...",
	"options.accessibility.high_contrast": "Visok kontrast",
	"options.accessibility.high_contrast.error.tooltip": "Visoki kontrast resurs paket nije dostupan",
	"options.accessibility.high_contrast.tooltip": "Poboljšava kontrast elemenata korisničkog sučelja",
	...
	"options.accessibility.narrator_hotkey": "Tipka za naraciju",
	...
	"options.accessibility.panorama_speed": "Panaroma brzina skrolovanja",
	...
	"options.credits_and_attribution": "Zasluge i Atribucija...",
	...
	"options.damageTiltStrength": "Oštećenje nagiba",
	"options.damageTiltStrength.tooltip": "Količina podrhtavanja kamere uzrokovana ozljedom.",
	...
	"options.difficulty.easy.info": "Neprijateljska stvorenja se stvaraju ali nanesu manje štete. Traka gladi iscrpljuje i iscrpljuje zdravlje na 5 srca.",
	"options.difficulty.hard": "Teško",
	"options.difficulty.hard.info": "Neprijateljska stvorenja se stvaraju i nanesu više štete. Traka gladi iscrpljuje i iscrupljuje sav život.",
	"options.difficulty.hardcore": "Ekstremno",
	"options.difficulty.normal": "Normalno",
	"options.difficulty.normal.info": "Neprijatelska stvorenja se stvaraju i rade standarndnu štetu. Traka gladi iscrpljuje i iscrpljuje zdravlje na pola srca.",
	"options.difficulty.online": "Okrutnost poslužitelja",
	"options.difficulty.peaceful": "Mirno",
	"options.difficulty.peaceful.info": "Neprijateljska stvorenja se ne stvaraju i samo neka neutralna stvorenja se stvaraju. Traka gladi ne iscrpljuje i zdravlje dopunjava tokom vremena.",
	...
	"options.font": "Postavke fontova...",
	"options.font.title": "Postavke fontova",
	...
	"options.glintSpeed": "Brzina Sjaja",
	"options.glintSpeed.tooltip": "Kontrolira koliko brzo vizualni odsjaj svjetluca preko začaranih predmeta.",
	"options.glintStrength": "Snaga Odsjaja",
	"options.glintStrength.tooltip": "Kontrolira koliko je providan vizualni odsjaj na začaranim predmetima.",
	...
	"options.hideLightningFlashes.tooltip": "Spriječava munje da nebo bljesne. Same munje će i dalje biti vidljivi.",
	"options.hideMatchedNames": "Sakrij podudarno ime",
	"options.hideMatchedNames.tooltip": "Serveri treće strane mogu slati poruke ćaskanja u nestandardnim formatima.\nKada je ova opcija uključena, skriveni igrači će se upariti na osnovu imena pošiljatelja chata.",
	...
	"options.notifications.display_time": "Vrijeme Obavještenja",
	"options.notifications.display_time.tooltip": "Utječe na dužinu vremena u kojem sva obavještenja ostaju vidljiva na ekranu.",
	...
	"options.operatorItemsTab": "Stavke operatera Tab",
	...
	"options.realmsNotifications": "Novosti Carstva i Pozivi",
	...
	"options.telemetry.button": "Prikupljane podatka",
	"options.telemetry.button.tooltip": "„%s“ obuhvaća samo nužne podatke.\n„%s“ uz nužne podatke obuhvata i neobavezne.",
	"options.telemetry.disabled": "Telemertijski podatci su isključeni.",
	...
	"painting.minecraft.bomb.title": "Meta Uspješno Bombardovana",
	"painting.minecraft.bouquet.author": "Kristoffer Zetterstrand",
	"painting.minecraft.bouquet.title": "Buket",
	"painting.minecraft.burning_skull.author": "Kristoffer Zetterstrand",
	"painting.minecraft.burning_skull.title": "Lobanja Na Vatri",
	"painting.minecraft.bust.author": "Kristoffer Zetterstrand",
	"painting.minecraft.bust.title": "Poprsje",
	...
	"painting.minecraft.pigscene.title": "Svinjascena",
	"painting.minecraft.plant.author": "Kristoffer Zetterstrand",
	"painting.minecraft.plant.title": "Rajsko drvo",
	"painting.minecraft.pointer.author": "Kristoffer Zetterstrand",
	"painting.minecraft.pointer.title": "Pokazilac",
	...
	"painting.minecraft.wither.title": "Venuti",
	"painting.random": "Nasumična varianta",
	...
	"quickplay.error.invalid_identifier": "Nije moguće pronaći svijet sa navedenim identifikatorom",
	"quickplay.error.realm_connect": "Povezivanje na Carstvo nije uspjelo",
	"quickplay.error.realm_permission": "Nedostaje dozvola za povezivanje u ovo Carstvo",
	"quickplay.error.title": "Brza Igra Nije Uspijela",
	...
	"recover_world.done.failed": "Oporavak iz prethodnog stanja je neuspješan.",
	"recover_world.done.success": "Oporavak je uspješan!",
	"recover_world.done.title": "Oporavak završen",
	"recover_world.issue.missing_file": "Nedostaje fajl",
	"recover_world.issue.none": "Nisu pronađeni problemi",
	...
	"selectWorld.allowCommands.new": "Dopusti naredbe",
	...
	"selectWorld.experimental.message": "Budi pažljiv!\nOva konfiguracija zahtijeva funkcije koje su još u razvoju. Vaš Svijet se može srušiti, pokvariti, ili ne raditi sa budućim ažuriranjima.",
	"selectWorld.experimental.title": "Eksperimentalne karakteristike upozorenje",
	"selectWorld.experiments": "Eksperimenti",
	"selectWorld.experiments.info": "Eksperimenti su potencijalne nove funkcije. Budi pažljiv zato što stvari se mogu polomiti. Eksperimenti ne mogu biti onemogućeni poslije kreacije svijeta.",
	...
	"selectWorld.gameMode.adventure.info": "Isto kao Mod Preživljavanja, ali blokovi ne mogu biti dodani ili uništeni.",
	...
	"selectWorld.gameMode.hardcore.info": "Mod Preživljavanja zaključan na 'Teškoj' Težini. Ne možeš se ponovo stvoriti ako umreš.",
	...
	"selectWorld.gameMode.spectator.info": "Možeš gledati ali nemoj dirati.",
	...
	"selectWorld.incompatible.description": "Ovaj svijet se ne može otvoriti u ovoj verziji.\nZadnji put je igrana u verziji %s.",
	"selectWorld.incompatible.info": "Nepodržana verzija:%s",
	"selectWorld.incompatible.title": "Ova verzija nije podržana",
	...
	"selectWorld.locked": "Zaključan od strane drugog postojanja Minecraft-a",
	...
	"selectWorld.resource_load": "Pripremanje sadržaja...",
	...
	"selectWorld.targetFolder": "Sačuvaj folder: %s",
	...
	"selectWorld.warning.lowDiskSpace.description": "Na Vašem disku ponestaje prostora. \nGubitak prostora na disku usred igre može oštetiti Vaš svijet.",
	"selectWorld.warning.lowDiskSpace.title": "Upozorenje! Manjak prostora na disku!",
	...
	"subtitles.block.candle.extinguish": "Svijeća plane",
	...
	"subtitles.block.copper_bulb.turn_off": "Bakrena sijalica se gasi",
	"subtitles.block.copper_bulb.turn_on": "Bakrena sijalica se pali",
	"subtitles.block.copper_chest.close": "Chest closes",
	"subtitles.block.copper_chest.open": "Chest opens",
	"subtitles.block.copper_trapdoor.close": "Poklopac se zatvara",
	"subtitles.block.copper_trapdoor.open": "Poklopac se otvara",
	"subtitles.block.crafter.craft": "Pravljač pravi",
	"subtitles.block.crafter.fail": "Pravljač ne uspijeva da napravi",
	...
	"subtitles.block.decorated_pot.shatter": "Lonac se razbija",
	...
	"subtitles.block.end_portal.spawn": "Krajnji portal se otvara",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Znak se ljulja",
	...
	"subtitles.block.sign.waxed_interact_fail": "Znak se koleba",
	"subtitles.block.smithing_table.use": "Kovački sto se koristi",
	"subtitles.block.smoker.smoke": "Pušač puši",
	"subtitles.block.sniffer_egg.crack": "Njuškaličevo Jaje napukne",
	"subtitles.block.sniffer_egg.hatch": "Njuškaličevo jaje se izleže",
	"subtitles.block.sniffer_egg.plop": "Njuškalo pljesne",
	...
	"subtitles.block.vault.open_shutter": "Trezor se otvara",
	...
	"subtitles.chiseled_bookshelf.take": "Knjiga uzeta",
	"subtitles.chiseled_bookshelf.take_enchanted": "Začarana Knjiga uzeta",
	...
	"subtitles.entity.armadillo.death": "Oklopnik umire",
	"subtitles.entity.armadillo.eat": "Oklopnik jede",
	"subtitles.entity.armadillo.hurt": "Oklopnik je ozlijeđen",
	"subtitles.entity.armadillo.hurt_reduced": "Oklopnik se štiti",
	"subtitles.entity.armadillo.land": "Armadilo udara pod",
	"subtitles.entity.armadillo.peek": "Armadilo pogleda",
	"subtitles.entity.armadillo.roll": "Armadilo se zarola",
	"subtitles.entity.armadillo.scute_drop": "Oklopnik se ljušti",
	...
	"subtitles.entity.bogged.death": "Zaglibiti umire",
	"subtitles.entity.bogged.hurt": "Zaglibiti boli",
	"subtitles.entity.breeze.charge": "Breeze charges",
	"subtitles.entity.breeze.death": "Povjetarac umire",
	...
	"subtitles.entity.camel.ambient": "Deva grca",
	"subtitles.entity.camel.dash": "Deva se baci",
	...
	"subtitles.entity.camel.sit": "Deva sjedne",
	"subtitles.entity.camel.stand": "Deva ustane",
	"subtitles.entity.camel.step": "Deva zakorači",
	"subtitles.entity.camel.step_sand": "Deva zakorači po pijesku",
	...
	"subtitles.entity.drowned.ambient_water": "Utopljeni grglja",
	...
	"subtitles.entity.horse.angry": "Konj njiše",
	...
	"subtitles.entity.leash_knot.break": "Povodac se lomi",
	"subtitles.entity.leash_knot.place": "Povodac vezan",
	...
	"subtitles.entity.parrot.imitate.piglin_brute": "Papagaj frkće",
	"subtitles.entity.parrot.imitate.pillager": "Papagaj mrmlja",
	...
	"subtitles.entity.parrot.imitate.slime": "Papagaj gniječi",
	"subtitles.entity.parrot.imitate.spider": "Papagaj sikće",
	"subtitles.entity.parrot.imitate.stray": "Papagaj zvecka",
	...
	"subtitles.entity.parrot.imitate.wither_skeleton": "Papagaj zvecka",
	...
	"subtitles.entity.player.teleport": "Igrač se teleportuje",
	...
	"subtitles.entity.sniffer.death": "Njuškalica umre",
	"subtitles.entity.sniffer.digging": "Njuškalica kopa",
	"subtitles.entity.sniffer.digging_stop": "Njuškalica ustaje",
	"subtitles.entity.sniffer.drop_seed": "Njuškalica baci sjeme",
	"subtitles.entity.sniffer.eat": "Njuškalica jede",
	"subtitles.entity.sniffer.egg_crack": "Njuškaličevo jaje napukne",
	"subtitles.entity.sniffer.egg_hatch": "Njuškaličevo jaje se izleže",
	"subtitles.entity.sniffer.happy": "Njuškalo uživa",
	"subtitles.entity.sniffer.hurt": "Njuškalo je povrijeđeno",
	"subtitles.entity.sniffer.idle": "Njuškalo grca",
	...
	"subtitles.entity.sniffer.step": "Njuškalo koraći",
	...
	"subtitles.item.brush.brushing.gravel.complete": "Četkanje Šljunka završeno",
	"subtitles.item.brush.brushing.sand": "Četkanje Pijeska",
	"subtitles.item.brush.brushing.sand.complete": "Četkanje Pijeska završeno",
	...
	"subtitles.item.mace.smash_air": "Buzdovan razbija",
	"subtitles.item.mace.smash_ground": "Buzdovan razbija",
	...
	"subtitles.item.wolf_armor.damage": "Vučji oklop prima štetu",
	"subtitles.item.wolf_armor.repair": "Vučji oklop je popravljen",
	...
	"symlink_warning.message": "Učitavanje svijetova iz foldera sa simboličkim vezama može biti nesigurno ako neznate tačno šta radite. Molim vas posjetite %s da naučite više.",
	...
	"symlink_warning.title": "Folder Svijeta sadrži simboličke veze",
	...
	"telemetry.event.advancement_made.description": "Razumijevanje konteksta iza dobivanja napredovanja može nam pomoči da bolje razumijemo i poboljšamo progresiju igre.",
	"telemetry.event.advancement_made.title": "Napredak napravljen",
	"telemetry.event.game_load_times.description": "Ovaj događaj može nam pomoči shvatiti gdje su potrebna poboljšanja performansi pokretanja mjerenjem vremena izvršavanjem faza pokretanja.",
	"telemetry.event.game_load_times.title": "Vrijeme učitavanja igre",
	...
	"telemetry.event.optional": "%s (Opciono)",
	"telemetry.event.optional.disabled": "%s(Opcionalno) - deaktivirano",
	...
	"telemetry.event.performance_metrics.description": "Poznavanje ukupnog profila performansi Minecrafta pomaže nam da prilagodimo i optimiziramo igru \u200b\u200bza širok spektar specifikacija mašina i operativnih sistema. \nVerzija igre je uključena da nam pomogne da uporedimo profil performansi za nove verzije Minecrafta.",
	"telemetry.event.performance_metrics.title": "Metrika performanse",
	"telemetry.event.required": "%s (Obavezno)",
	"telemetry.event.world_load_times.description": "Za nas je važno da shvatimo koliko je vremena potrebno da uđete u svijet i kako se to mijenja tokom vremena. Na primjer, kada dodajemo nove funkcije ili radimo veće tehničke promjene, moramo vidjeti kakav je to utjecaj imao na vrijeme učitavanja.",
	"telemetry.event.world_load_times.title": "Vrijeme Učitavanje Svijeta",
	"telemetry.event.world_loaded.description": "Poznavanje načina na koji igrači igraju Minecraft (kao što je način igre, modifikovani klijent ili server i verzija igre) omogućava nam da fokusiramo ažuriranja igre kako bismo poboljšali područja do kojih je igračima najviše stalo.\nDogađaj Svijet učitan je uparen sa događajem Svijet neučitan kako bi se izračunalo koliko je dugo trajala sesija igranja.",
	"telemetry.event.world_loaded.title": "Svijet učitan",
	"telemetry.event.world_unloaded.description": "Ovaj događaj je uparen sa događajem Svijet Učitanda kalkulira koliko dugo je svijetska sesija trajala.\nTrajanje (U sekundi i tikovima) je izmjereno kad je svijetska sesija završila (odustajanje do nazlova, odspajanje iz servera).",
	"telemetry.event.world_unloaded.title": "Svijet neučitan",
	"telemetry.property.advancement_game_time.title": "Vrijeme igre (Tikovi)",
	...
	"telemetry.property.client_modded.title": "Modifikovan Klijent",
	"telemetry.property.dedicated_memory_kb.title": "Dedikovana Memorija (kB)",
	"telemetry.property.event_timestamp_utc.title": "Vremenska Oznaka Događaja (UTC)",
	"telemetry.property.frame_rate_samples.title": "Uzorci Brzine Kadrova (FPS)",
	...
	"telemetry.property.load_time_bootstrap_ms.title": "Vrijeme pokretanja (Milisekundi)",
	"telemetry.property.load_time_loading_overlay_ms.title": "Vrijeme na ekranu za učitavanje (Milisekundi)",
	"telemetry.property.load_time_pre_window_ms.title": "Vrijeme Prije Otvaranja Prozora (milisekunde)",
	"telemetry.property.load_time_total_time_ms.title": "Totalno Vrijeme Učitavanja (Milisekundi)",
	...
	"telemetry.property.realms_map_content.title": "Sadržaj mape Carstava (Ime Mini Igre)",
	"telemetry.property.render_distance.title": "Udaljenost Renderiranja",
	"telemetry.property.render_time_samples.title": "Uzorci Vremena Renderiranja",
	"telemetry.property.seconds_since_load.title": "Vrijeme Od Učitavanja (Sekundi)",
	"telemetry.property.server_modded.title": "Server Modificiran",
	"telemetry.property.server_type.title": "Vrsta Servera",
	"telemetry.property.ticks_since_load.title": "Vrijeme Od Učitavanja (Tikovi)",
	"telemetry.property.used_memory_samples.title": "Koristio Nasumični Pristup Memorije",
	"telemetry.property.user_id.title": "ID Korisnika",
	"telemetry.property.world_load_time_ms.title": "Vrijeme Učitavanja Svijeta (Milisekundi)",
	"telemetry.property.world_session_id.title": "ID Sesije Svijeta",
	"telemetry_info.button.give_feedback": "Dajte Povratnu Informaciju",
	"telemetry_info.button.privacy_statement": "Sigurnosna izjava",
	"telemetry_info.button.show_data": "Otvori moje podatke",
	"telemetry_info.opt_in.description": "Prihvaćam slajnje opcionalnih telemetrijskih podataka",
	"telemetry_info.property_title": "Uključeni Podaci",
	"telemetry_info.screen.description": "Uzimanje ovih podatka pomaže nam da poboljšamo Minecraft tako što nas vodi u pravcima koji su relevantni za naše igrače. Također možete poslati dodatne povratne informacije da nam pomognete da nastavimo poboljšavati Minecraft.",
	...
	"test.error.tick": "%s na otkucaju %s",
	"test.error.ticking_without_structure": "Test kucanja prije postavljanja konstrukcije",
	"test.error.timeout.no_result": "Nije uspjelo ili propalo unutar %s otkucaja",
	"test.error.timeout.no_sequences_finished": "Nijedna sekvenca nije završena unutar %s otkucaja",
	"test.error.too_many_entities": "Očekivano samo jedan %s da postoji oko %s, %s, %s ali je pronađeno %s",
	"test.error.unexpected_block": "Nije očekivano da blok bude %s",
	"test.error.unexpected_entity": "Nije očekivao %s da postoji",
	"test.error.unexpected_item": "Nije očekivao tip stavke %s",
	"test.error.unknown": "Nepoznata interna greška: %s",
	"test.error.value_not_equal": "Očekivano %s da bude %s, bilo %s",
	"test.error.value_not_in_between": "Expected %s to be in between %s and %s: was %s",
	"test.error.wrong_block_entity": "Pogrešni tip blok entiteta: %s",
	...
	"test_block.mode.fail": "Propasti",
	"test_block.mode.log": "Dnevnik",
	"test_block.mode.start": "Početak",
	...
	"test_instance_block.invalid": "[nevažeći]",
	...
	"title.credits": "Copyright Mojang AB. Umaložavanje i naknadna redistribucija nije dozvoljena!",
	"title.multiplayer.disabled": "Multiplayer igra je onemogućena. Molimo provjerite svoje Microsoft postavke računa.",
	"title.multiplayer.disabled.banned.name": "Potrebno je promijeniti svoje ime prije igranja na mreži",
	...
	"trim_material.minecraft.amethyst": "Materijal Ametista",
	"trim_material.minecraft.copper": "Materijal Bakra",
	"trim_material.minecraft.diamond": "Dijamantski Materijal",
	"trim_material.minecraft.emerald": "Smaragdni Materijal",
	"trim_material.minecraft.gold": "Zlatni Materijal",
	"trim_material.minecraft.iron": "Gvozdeni Materijal",
	"trim_material.minecraft.lapis": "Materijal Lapisa",
	"trim_material.minecraft.netherite": "Nederitski Materijal",
	"trim_material.minecraft.quartz": "Materijal Kvarca",
	"trim_material.minecraft.redstone": "Materijal Crvenog Kamena",
	"trim_material.minecraft.resin": "Materijal Smole",
	"trim_pattern.minecraft.bolt": "Ukras Oklopa Zavrtanj",
	"trim_pattern.minecraft.coast": "Ukras Oklopa Obala",
	"trim_pattern.minecraft.dune": "Ukras Oklopa Dina",
	"trim_pattern.minecraft.eye": "Ukras Oklopa Oko",
	"trim_pattern.minecraft.flow": "Ukras Oklopa Protok",
	"trim_pattern.minecraft.host": "Ukras Oklopa Domaćin",
	"trim_pattern.minecraft.raiser": "Ukras Oklopa Podizač",
	"trim_pattern.minecraft.rib": "Ukras Oklopa Rebro",
	"trim_pattern.minecraft.sentry": "Ukras Oklopa Stražar",
	"trim_pattern.minecraft.shaper": "Ukras Oklopa Disajner",
	"trim_pattern.minecraft.silence": "Ukras Oklopa Tišina",
	"trim_pattern.minecraft.snout": "Ukras Oklopa Njuška",
	"trim_pattern.minecraft.spire": "Ukras Oklopa Spirala",
	"trim_pattern.minecraft.tide": "Ukras Oklopa Plima",
	"trim_pattern.minecraft.vex": "Ukras Oklopa Vex",
	"trim_pattern.minecraft.ward": "Ukras Oklopa Ward",
	"trim_pattern.minecraft.wayfinder": "Ukras Oklopa Pronalazivač Puta",
	"trim_pattern.minecraft.wild": "Ukras Oklopa Divljina",
	...
	"upgrade.minecraft.netherite_upgrade": "Nederitsko Poboljšanje",
