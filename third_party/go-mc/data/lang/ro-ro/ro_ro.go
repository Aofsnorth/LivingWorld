// Code generated by tools/gen_lang.go from 26.1/ro_ro.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"accessibility.onboarding.accessibility.button.narration": "Setări de accesibilitate",
	...
	"advMode.notEnabled.spawner": "Generatoarele de monștri nu sunt activate",
	"advMode.previousOutput": "Rezultatul precedent",
	"advMode.setCommand": "Definește o comandă pentru acest bloc",
	"advMode.setCommand.disabled": "Comandă setată: %s, dar blocurile de comenzi sunt dezactivate",
	...
	"advancements.adventure.arbalistic.description": "Omoară cinci creaturi diferite dintr-o lovitură cu arbaleta",
	...
	"advancements.adventure.blowback.title": "Vânt opus",
	...
	"advancements.adventure.heart_transplanter.title": "Transplantare de inimă",
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Omoară o creatură lângă un catalizator sculk",
	...
	"advancements.adventure.overoverkill.title": "Extra-exagerat",
	"advancements.adventure.play_jukebox_in_meadows.description": "Fă pajiștea să prindă viață cu ajutorul sunetului tonomatului",
	...
	"advancements.adventure.revaulting.title": "Noul zăvor",
	...
	"advancements.adventure.spear_many_mobs.description": "Lovește cinci entități cu același atac încărcat utilizând o suliță",
	"advancements.adventure.spear_many_mobs.title": "Frigărui de creaturi",
	"advancements.adventure.spyglass_at_dragon.description": "Uită-te la dragonul de Ender printr-un ochean",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Aplică aceste șabloane de fierărie cel puțin odată: turlă, rât, coastă, pază, tăcere, spirit, maree, călăuză",
	...
	"advancements.adventure.who_needs_rockets.description": "Folosește o minge de vânt pentru a te lansa în sus 8 blocuri",
	...
	"advancements.adventure.whos_the_pillager_now.title": "Cine este jefuitorul acum?",
	"advancements.empty": "Se pare că nu este nimic aici…",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.title": "La mulți ani!",
	...
	"advancements.husbandry.axolotl_in_a_bucket.description": "Prinde un axolot cu o găleată",
	...
	"advancements.husbandry.feed_snifflet.title": "Mici adulmecări",
	...
	"advancements.husbandry.kill_axolotl_target.description": "Aliază-te cu un axolot și câștigă bătălia",
	...
	"advancements.husbandry.make_a_sign_glow.description": "Fă textul oricărui tip de semn să strălucească",
	"advancements.husbandry.make_a_sign_glow.title": "Lucește și privește!",
	"advancements.husbandry.netherite_hoe.description": "Folosește un lingou de netherit pentru a îmbunătăți o sapă, apoi gândește-te la alegerile vieții tale",
	...
	"advancements.husbandry.plant_any_sniffer_seed.description": "Plantează orice sămânță găsită de un adulmecător",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Dă jos armura de pe un lup folosind foarfeci",
	...
	"advancements.husbandry.root.description": "Lumea este plină de prieteni și mâncare",
	...
	"advancements.husbandry.uh_oh.description": "Pune un cub sulfuros să absoarbă un bloc de TNT",
	...
	"advancements.nether.fast_travel.description": "Folosește Netherul ca să te deplasezi 7 km în lumea de la suprafață",
	...
	"advancements.nether.return_to_sender.description": "Omoară un ghast cu o minge de foc",
	...
	"advancements.nether.ride_strider_in_overworld_lava.description": "Ia-ți umblătorul pentru o călătorie luuuungă pe un lac de lavă pe suprafață",
	...
	"advancements.nether.uneasy_alliance.description": "Scoate un ghast din Nether, adu-l în siguranță la suprafață… și apoi omoară-l",
	...
	"advancements.story.deflect_arrow.description": "Returnează un proiectil cu scutul",
	...
	"argument.block.tag.disallowed": "Aici sunt permise doar blocuri propriu-zise, nu și etichete",
	...
	"argument.entity.options.tag.description": "Entitățile cu o anumită etichetă",
	...
	"argument.enum.invalid": "Valoare invalidă: „%s”",
	...
	"argument.item.tag.disallowed": "Aici sunt permise doar obiecte propriu-zise, nu și etichete",
	...
	"argument.long.low": "Valoarea long nu trebuie să fie mai puțin de %s. S-a găsit %s",
	...
	"argument.nbt.expected.compound": "Era prevăzută o etichetă compusă",
	...
	"argument.resource_or_id.invalid": "Etichetă sau ID invalid",
	"argument.resource_or_id.no_such_element": "Nu s-a putut găsi elementul „%s” în registru „%s”",
	"argument.resource_selector.not_found": "Selectorul „%s” de tip „%s” nu a găsit nimic",
	"argument.resource_tag.invalid_type": "Eticheta „%s” are tipul greșit: „%s” (era prevăzut „%s”)",
	"argument.resource_tag.not_found": "Nu s-a putut găsi eticheta „%s” de tip „%s”",
	...
	"argument.style.invalid": "Stil invalid: „%s”",
	...
	"arguments.block.tag.unknown": "Etichetă de bloc necunoscut: „%s”",
	"arguments.function.tag.unknown": "Etichetă de funcție necunoscută: „%s”",
	"arguments.function.unknown": "Funcție necunoscută: „%s”",
	"arguments.item.component.expected": "Era prevăzută o componentă de obiect",
	"arguments.item.component.malformed": "Formatul componentei „%s” este incorect: „%s”",
	...
	"arguments.item.malformed": "Formatul obiectului incorect: „%s”",
	"arguments.item.overstacked": "%s poate să fie într-o stivă de maxim %s",
	"arguments.item.predicate.malformed": "Formatul predicatului „%s” este incorect: „%s”",
	"arguments.item.predicate.unknown": "Predicat de obiect necunoscut: „%s”",
	"arguments.item.tag.unknown": "Etichetă de obiect necunoscut: „%s”",
	...
	"arguments.nbtpath.too_deep": "NBT rezultantă este prea imbricată",
	"arguments.nbtpath.too_large": "NBT rezultat prea mare",
	"arguments.objective.notFound": "Obiectiv al tabelei de scor necunoscut: „%s”",
	"arguments.objective.readonly": "Obiectivul „%s” de pe tabela de scor poate fi doar citit",
	"arguments.operation.div0": "Nu se poate împărți la zero",
	"arguments.operation.invalid": "Operație nevalidă",
	"arguments.swizzle.invalid": "Swizzle invalid: era prevăzută o combinație de „x“, „y“ și „z“",
	...
	"attribute.name.air_drag_modifier": "Modificator al rezistenței aerului",
	"attribute.name.armor": "Armură",
	"attribute.name.armor_toughness": "Duritatea armurii",
	"attribute.name.attack_damage": "Puncte de atac",
	"attribute.name.attack_knockback": "Recul la atac",
	"attribute.name.attack_speed": "Viteză de atac",
	"attribute.name.below_name_distance": "Distanța plăcuței de identificare a scorului",
	...
	"attribute.name.bounciness": "Elasticitate",
	...
	"attribute.name.friction_modifier": "Modificator de frecare",
	...
	"attribute.name.generic.burning_time": "Timp de ardere",
	"attribute.name.generic.entity_interaction_range": "Distanță de interacțiune cu entități",
	"attribute.name.generic.explosion_knockback_resistance": "Rezistență la reculul exploziilor",
	...
	"attribute.name.generic.jump_strength": "Forța săriturii",
	...
	"attribute.name.generic.scale": "Dimensiune",
	...
	"attribute.name.jump_strength": "Forța săriturii",
	"attribute.name.knockback_resistance": "Rezistență la recul",
	...
	"attribute.name.nameplate_distance": "Distanța plăcuței de identificare",
	...
	"attribute.name.scale": "Dimensiune",
	...
	"attribute.name.waypoint_receive_range": "Distanță de recepție punctelor de trecere",
	"attribute.name.waypoint_transmit_range": "Distanță de transmisie punctelor de trecere",
	...
	"biome.minecraft.meadow": "Pajiște",
	...
	"biome.minecraft.sulfur_caves": "Peșteri sulfuroase",
	...
	"block.minecraft.acacia_shelf": "Raft de salcâm",
	...
	"block.minecraft.bamboo_shelf": "Raft de bambus",
	...
	"block.minecraft.banner.cross.black": "Cruce diagonală neagră",
	"block.minecraft.banner.cross.blue": "Cruce diagonală albastră",
	"block.minecraft.banner.cross.brown": "Cruce diagonală maro",
	"block.minecraft.banner.cross.cyan": "Cruce diagonală turcoaz",
	"block.minecraft.banner.cross.gray": "Cruce diagonală gri",
	"block.minecraft.banner.cross.green": "Cruce diagonală verde",
	"block.minecraft.banner.cross.light_blue": "Cruce diagonală bleu",
	"block.minecraft.banner.cross.light_gray": "Cruce diagonală gri-deschis",
	"block.minecraft.banner.cross.lime": "Cruce diagonală verde-deschis",
	"block.minecraft.banner.cross.magenta": "Cruce diagonală magenta",
	"block.minecraft.banner.cross.orange": "Cruce diagonală portocalie",
	"block.minecraft.banner.cross.pink": "Cruce diagonală roz",
	"block.minecraft.banner.cross.purple": "Cruce diagonală violetă",
	"block.minecraft.banner.cross.red": "Cruce diagonală roșie",
	"block.minecraft.banner.cross.white": "Cruce diagonală albă",
	"block.minecraft.banner.cross.yellow": "Cruce diagonală galbenă",
	...
	"block.minecraft.banner.stripe_left.black": "Dungă stângă neagră",
	"block.minecraft.banner.stripe_left.blue": "Dungă stângă albastră",
	"block.minecraft.banner.stripe_left.brown": "Dungă stângă maro",
	"block.minecraft.banner.stripe_left.cyan": "Dungă stângă turcoaz",
	"block.minecraft.banner.stripe_left.gray": "Dungă stângă gri",
	"block.minecraft.banner.stripe_left.green": "Dungă stângă verde",
	"block.minecraft.banner.stripe_left.light_blue": "Dungă stângă bleu",
	"block.minecraft.banner.stripe_left.light_gray": "Dungă stângă gri-deschis",
	"block.minecraft.banner.stripe_left.lime": "Dungă stângă verde-deschis",
	"block.minecraft.banner.stripe_left.magenta": "Dungă stângă magenta",
	"block.minecraft.banner.stripe_left.orange": "Dungă stângă portocalie",
	"block.minecraft.banner.stripe_left.pink": "Dungă stângă roz",
	"block.minecraft.banner.stripe_left.purple": "Dungă stângă violet",
	"block.minecraft.banner.stripe_left.red": "Dungă stângă roșie",
	"block.minecraft.banner.stripe_left.white": "Dungă stângă albă",
	"block.minecraft.banner.stripe_left.yellow": "Dungă stângă galbenă",
	...
	"block.minecraft.banner.stripe_right.black": "Dungă dreaptă neagră",
	"block.minecraft.banner.stripe_right.blue": "Dungă dreaptă albastră",
	"block.minecraft.banner.stripe_right.brown": "Dungă dreaptă maro",
	"block.minecraft.banner.stripe_right.cyan": "Dungă dreaptă turcoaz",
	"block.minecraft.banner.stripe_right.gray": "Dungă dreaptă gri",
	"block.minecraft.banner.stripe_right.green": "Dungă dreaptă verde",
	"block.minecraft.banner.stripe_right.light_blue": "Dungă dreaptă bleu",
	"block.minecraft.banner.stripe_right.light_gray": "Dungă dreaptă gri-deschis",
	"block.minecraft.banner.stripe_right.lime": "Dungă dreaptă verde-deschis",
	"block.minecraft.banner.stripe_right.magenta": "Dungă dreaptă magenta",
	"block.minecraft.banner.stripe_right.orange": "Dungă dreaptă portocalie",
	"block.minecraft.banner.stripe_right.pink": "Dungă dreaptă roz",
	"block.minecraft.banner.stripe_right.purple": "Dungă dreaptă violet",
	"block.minecraft.banner.stripe_right.red": "Dungă dreaptă roșie",
	"block.minecraft.banner.stripe_right.white": "Dungă dreaptă albă",
	"block.minecraft.banner.stripe_right.yellow": "Dungă dreaptă galbenă",
	...
	"block.minecraft.birch_shelf": "Raft de mesteacăn",
	...
	"block.minecraft.cherry_shelf": "Raft de cireș",
	...
	"block.minecraft.chipped_anvil": "Nicovală ciobită",
	"block.minecraft.chiseled_bookshelf": "Bibliotecă cioplită",
	"block.minecraft.chiseled_cinnabar": "Cinabru sculptat",
	"block.minecraft.chiseled_copper": "Bloc de cupru sculptat",
	...
	"block.minecraft.chiseled_sulfur": "Sulf sculptat",
	...
	"block.minecraft.cinnabar": "Cinabru",
	"block.minecraft.cinnabar_brick_slab": "Lespede de cărămizi de cinabru",
	"block.minecraft.cinnabar_brick_stairs": "Trepte de cărămizi de cinabru",
	"block.minecraft.cinnabar_brick_wall": "Zid de cărămizi de cinabru",
	"block.minecraft.cinnabar_bricks": "Cărămizi de cinabru",
	"block.minecraft.cinnabar_slab": "Lespede de cinabru",
	"block.minecraft.cinnabar_stairs": "Trepte de cinabru",
	"block.minecraft.cinnabar_wall": "Zid de cinabru",
	...
	"block.minecraft.conduit": "Conductă",
	"block.minecraft.copper_bars": "Gratii de cupru",
	"block.minecraft.copper_block": "Bloc de cupru",
	"block.minecraft.copper_bulb": "Bec de cupru",
	"block.minecraft.copper_chain": "Lanț de cupru",
	"block.minecraft.copper_chest": "Cufăr de cupru",
	"block.minecraft.copper_door": "Ușă de cupru",
	"block.minecraft.copper_golem_statue": "Statuie de golem de cupru",
	"block.minecraft.copper_grate": "Grilaj de cupru",
	"block.minecraft.copper_lantern": "Felinar de cupru",
	"block.minecraft.copper_ore": "Minereu de cupru",
	"block.minecraft.copper_torch": "Torță de cupru",
	"block.minecraft.copper_trapdoor": "Trapă de cupru",
	"block.minecraft.copper_wall_torch": "Torță de cupru pe perete",
	...
	"block.minecraft.crimson_shelf": "Raft stacojiu",
	...
	"block.minecraft.dark_oak_shelf": "Raft de stejar negru",
	...
	"block.minecraft.exposed_chiseled_copper": "Bloc de cupru sculptat expus",
	"block.minecraft.exposed_copper": "Bloc de cupru expus",
	"block.minecraft.exposed_copper_bars": "Gratii de cupru expuse",
	"block.minecraft.exposed_copper_bulb": "Bec de cupru expus",
	"block.minecraft.exposed_copper_chain": "Lanț de cupru expus",
	"block.minecraft.exposed_copper_chest": "Cufăr de cupru expus",
	"block.minecraft.exposed_copper_door": "Ușă de cupru expusă",
	"block.minecraft.exposed_copper_golem_statue": "Statuie de golem de cupru expus",
	"block.minecraft.exposed_copper_grate": "Grilaj de cupru expus",
	"block.minecraft.exposed_copper_lantern": "Felinar de cupru expus",
	"block.minecraft.exposed_copper_trapdoor": "Trapă de cupru expusă",
	"block.minecraft.exposed_cut_copper": "Bloc de cupru tăiat expus",
	...
	"block.minecraft.exposed_lightning_rod": "Paratrăsnet expus",
	...
	"block.minecraft.firefly_bush": "Tufiș cu licurici",
	...
	"block.minecraft.golden_dandelion": "Păpădie de aur",
	...
	"block.minecraft.iron_chain": "Lanț de fier",
	...
	"block.minecraft.jigsaw": "Bloc de construcție",
	...
	"block.minecraft.jungle_shelf": "Raft de junglă",
	...
	"block.minecraft.mangrove_door": "Ușă de mangrovă",
	...
	"block.minecraft.mangrove_shelf": "Raft de mangrovă",
	...
	"block.minecraft.oak_shelf": "Raft de stejar",
	...
	"block.minecraft.oxidized_chiseled_copper": "Bloc de cupru sculptat oxidat",
	"block.minecraft.oxidized_copper": "Bloc de cupru oxidat",
	"block.minecraft.oxidized_copper_bars": "Gratii de cupru oxidate",
	"block.minecraft.oxidized_copper_bulb": "Bec de cupru oxidat",
	"block.minecraft.oxidized_copper_chain": "Lanț de cupru oxidat",
	"block.minecraft.oxidized_copper_chest": "Cufăr de cupru oxidat",
	"block.minecraft.oxidized_copper_door": "Ușă de cupru oxidată",
	"block.minecraft.oxidized_copper_golem_statue": "Statuie de golem de cupru oxidat",
	"block.minecraft.oxidized_copper_grate": "Grilaj de cupru oxidat",
	"block.minecraft.oxidized_copper_lantern": "Felinar de cupru oxidat",
	"block.minecraft.oxidized_copper_trapdoor": "Trapă de cupru oxidată",
	"block.minecraft.oxidized_cut_copper": "Bloc de cupru tăiat oxidat",
	...
	"block.minecraft.oxidized_lightning_rod": "Paratrăsnet oxidat",
	...
	"block.minecraft.pale_oak_shelf": "Raft de stejar palid",
	...
	"block.minecraft.pitcher_crop": "Cultură de plantă-urcior",
	"block.minecraft.pitcher_plant": "Plantă-urcior",
	...
	"block.minecraft.polished_cinnabar": "Cinabru șlefuit",
	"block.minecraft.polished_cinnabar_slab": "Lespede de cinabru șlefuit",
	"block.minecraft.polished_cinnabar_stairs": "Trepte de cinabru șlefuit",
	"block.minecraft.polished_cinnabar_wall": "Zid de cinabru șlefuit",
	...
	"block.minecraft.polished_sulfur": "Bloc de sulf șlefuit",
	"block.minecraft.polished_sulfur_slab": "Lespede de sulf șlefuit",
	"block.minecraft.polished_sulfur_stairs": "Trepte de sulf șlefuit",
	"block.minecraft.polished_sulfur_wall": "Zid de sulf șlefuit",
	...
	"block.minecraft.potent_sulfur": "Sulf potent",
	...
	"block.minecraft.potted_golden_dandelion": "Păpădie de aur în ghiveci",
	...
	"block.minecraft.soul_wall_torch": "Torță de suflete pe perete",
	...
	"block.minecraft.spruce_shelf": "Raft de molid",
	...
	"block.minecraft.sulfur": "Sulf",
	"block.minecraft.sulfur_brick_slab": "Lespede de cărămizi de sulf",
	"block.minecraft.sulfur_brick_stairs": "Trepte de cărămizi de sulf",
	"block.minecraft.sulfur_brick_wall": "Zid de cărămizi de sulf",
	"block.minecraft.sulfur_bricks": "Cărămizi de sulf",
	"block.minecraft.sulfur_slab": "Lespede de sulf",
	"block.minecraft.sulfur_spike": "Vârf de sulf",
	"block.minecraft.sulfur_stairs": "Trepte de sulf",
	"block.minecraft.sulfur_wall": "Zid de sulf",
	...
	"block.minecraft.warped_shelf": "Raft deformat",
	...
	"block.minecraft.waxed_chiseled_copper": "Bloc de cupru sculptat ceruit",
	"block.minecraft.waxed_copper_bars": "Gratii de cupru ceruite",
	"block.minecraft.waxed_copper_block": "Bloc de cupru ceruit",
	"block.minecraft.waxed_copper_bulb": "Bec de cupru ceruit",
	"block.minecraft.waxed_copper_chain": "Lanț de cupru ceruit",
	"block.minecraft.waxed_copper_chest": "Cufăr de cupru ceruit",
	"block.minecraft.waxed_copper_door": "Ușă de cupru ceruită",
	"block.minecraft.waxed_copper_golem_statue": "Statuie de golem de cupru ceruit",
	"block.minecraft.waxed_copper_grate": "Grilă de cupru ceruit",
	"block.minecraft.waxed_copper_lantern": "Felinar de cupru ceruit",
	"block.minecraft.waxed_copper_trapdoor": "Trapă de cupru ceruită",
	"block.minecraft.waxed_cut_copper": "Bloc de cupru tăiat ceruit",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Bloc de cupru sculptat expus ceruit",
	"block.minecraft.waxed_exposed_copper": "Bloc de cupru expus ceruit",
	"block.minecraft.waxed_exposed_copper_bars": "Gratii de cupru expuse ceruite",
	"block.minecraft.waxed_exposed_copper_bulb": "Bec de cupru expus ceruit",
	"block.minecraft.waxed_exposed_copper_chain": "Lanț de cupru expus ceruit",
	"block.minecraft.waxed_exposed_copper_chest": "Cufăr de cupru expus ceruit",
	"block.minecraft.waxed_exposed_copper_door": "Ușă de cupru expusă ceruită",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Statuie de golem de cupru expus ceruit",
	"block.minecraft.waxed_exposed_copper_grate": "Grilaj de cupru expus ceruit",
	"block.minecraft.waxed_exposed_copper_lantern": "Felinar de cupru expus ceruit",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Trapă de cupru expusă ceruită",
	"block.minecraft.waxed_exposed_cut_copper": "Bloc de cupru tăiat expus ceruit",
	"block.minecraft.waxed_exposed_cut_copper_slab": "Lespede de cupru tăiată expusă ceruită",
	"block.minecraft.waxed_exposed_cut_copper_stairs": "Trepte de cupru tăiate expuse ceruite",
	"block.minecraft.waxed_exposed_lightning_rod": "Paratrăsnet expus ceruit",
	"block.minecraft.waxed_lightning_rod": "Paratrăsnet ceruit",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Bloc de cupru sculptat oxidat ceruit",
	"block.minecraft.waxed_oxidized_copper": "Bloc de cupru oxidat ceruit",
	"block.minecraft.waxed_oxidized_copper_bars": "Gratii de cupru oxidate ceruite",
	"block.minecraft.waxed_oxidized_copper_bulb": "Bec de cupru oxidat ceruit",
	"block.minecraft.waxed_oxidized_copper_chain": "Lanț de cupru oxidat ceruit",
	"block.minecraft.waxed_oxidized_copper_chest": "Cufăr de cupru oxidat ceruit",
	"block.minecraft.waxed_oxidized_copper_door": "Ușă de cupru oxidată ceruită",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Statuie de golem de cupru oxidat ceruit",
	"block.minecraft.waxed_oxidized_copper_grate": "Grilaj de cupru oxidat ceruit",
	"block.minecraft.waxed_oxidized_copper_lantern": "Felinar de cupru oxidat ceruit",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Trapă de cupru oxidată ceruită",
	"block.minecraft.waxed_oxidized_cut_copper": "Bloc de cupru tăiat oxidat ceruit",
	"block.minecraft.waxed_oxidized_cut_copper_slab": "Lespede de cupru tăiată oxidată ceruită",
	"block.minecraft.waxed_oxidized_cut_copper_stairs": "Trepte de cupru tăiate oxidate ceruite",
	"block.minecraft.waxed_oxidized_lightning_rod": "Paratrăsnet oxidat ceruit",
	"block.minecraft.waxed_weathered_chiseled_copper": "Bloc de cupru sculptat erodat ceruit",
	"block.minecraft.waxed_weathered_copper": "Bloc de cupru erodat ceruit",
	"block.minecraft.waxed_weathered_copper_bars": "Gratii de cupru erodate ceruite",
	"block.minecraft.waxed_weathered_copper_bulb": "Bec de cupru erodat ceruit",
	"block.minecraft.waxed_weathered_copper_chain": "Lanț de cupru erodat ceruit",
	"block.minecraft.waxed_weathered_copper_chest": "Cufăr de cupru erodat ceruit",
	"block.minecraft.waxed_weathered_copper_door": "Ușă de cupru erodată ceruită",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Statuie de golem de cupru erodat ceruit",
	"block.minecraft.waxed_weathered_copper_grate": "Grilaj de cupru erodat ceruit",
	"block.minecraft.waxed_weathered_copper_lantern": "Felinar de cupru erodat ceruit",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Trapă de cupru erodată ceruită",
	"block.minecraft.waxed_weathered_cut_copper": "Bloc de cupru tăiat erodat ceruit",
	"block.minecraft.waxed_weathered_cut_copper_slab": "Lespede de cupru tăiată erodată ceruită",
	"block.minecraft.waxed_weathered_cut_copper_stairs": "Trepte de cupru tăiate erodate ceruite",
	"block.minecraft.waxed_weathered_lightning_rod": "Paratrăsnet erodat ceruit",
	"block.minecraft.weathered_chiseled_copper": "Bloc de cupru sculptat erodat",
	"block.minecraft.weathered_copper": "Bloc de cupru erodat",
	"block.minecraft.weathered_copper_bars": "Gratii de cupru erodate",
	"block.minecraft.weathered_copper_bulb": "Bec de cupru erodat",
	"block.minecraft.weathered_copper_chain": "Lanț de cupru erodat",
	"block.minecraft.weathered_copper_chest": "Cufăr de cupru erodat",
	"block.minecraft.weathered_copper_door": "Ușă de cupru erodată",
	"block.minecraft.weathered_copper_golem_statue": "Statuie de golem de cupru erodat",
	"block.minecraft.weathered_copper_grate": "Grilaj de cupru erodat",
	"block.minecraft.weathered_copper_lantern": "Felinar de cupru erodat",
	...
	"block.minecraft.weathered_lightning_rod": "Paratrăsnet erodat",
	...
	"block.minecraft.wither_rose": "Trandafir al witherului",
	...
	"book.edit.title": "Ecran editare carte",
	...
	"book.invalid.tag": "* Etichetă de carte nevalidă *",
	"book.pageIndicator": "Pagina %[1]s din %[2]s",
	"book.page_button.next": "Pagina următoare",
	"book.page_button.previous": "Pagina anterioară",
	"book.sign.title": "Ecran semnare carte",
	"book.sign.titlebox": "Titlu",
	"book.signButton": "Semnează",
	"book.view.title": "Ecran afișare carte",
	"build.spawn_protection": "%s se află sub protecția punctului de apariție",
	"build.tooHigh": "Înălțimea maximă pentru construit este %s",
	"build.tooLow": "Înălțimea minimă pentru construit este %s",
	"chat.cannotSend": "Nu se poate trimite mesajul în chat",
	"chat.coordinates": "%s, %s, %s",
	"chat.coordinates.tooltip": "Apasă pentru a te teleporta",
	"chat.copy": "Copiază",
	"chat.copy.click": "Apasă pentru a copia",
	"chat.deleted_marker": "Acest mesaj a fost șters de server.",
	"chat.disabled.chain_broken": "Chat dezactivat din cauza unui lanț rupt. Te rugăm să încerci să te reconectezi.",
	"chat.disabled.expiredProfileKey": "Chat dezactivat din cauza cheii publice de profil expirate. Te rugăm să încerci să te reconectezi.",
	"chat.disabled.invalid_command_signature": "Comanda avea o semnătură de argument neașteptată sau lipsă.",
	"chat.disabled.invalid_signature": "Conversația a avut o semnătură nevalidă. Te rugăm să te reconectezi.",
	"chat.disabled.launcher": "Chatul este dezactivat din opțiunile Launcher-ului. Nu s-a putut trimite mesajul.",
	"chat.disabled.missingProfileKey": "Chat dezactivat din cauza lipsei cheii publice de profil. Te rugăm să încerci să te reconectezi.",
	"chat.disabled.options": "Chatul este dezactivat din opțiunile clientului.",
	...
	"chat.queue.tooltip": "Apasă pentru a afișa următorul mesaj",
	...
	"chat.tag.system": "Mesajul serverului. Nu poate fi raportat.",
	...
	"chat.validation_error": "Eroare de validare a chatului",
	"chat_restriction.chat_and_commands_disabled_by_options": "Chatul este restricționat din opțiunile clientului.",
	"chat_restriction.chat_disabled_by_options": "Chatul jucătorilor este restricționat din opțiunile clientului.",
	"chat_restriction.chat_disabled_by_options.action": "Du-te la fereastra setărilor chatului",
	"chat_restriction.disabled_by_launcher": "Chatul este restricționat de Launcher",
	"chat_restriction.disabled_by_profile": "Chatul este restricționat din setările profilului.",
	"chat_restriction.disabled_by_profile.action": "Du-te la setările profilului",
	"chat_screen.commands_not_allowed": "Trimiterea comenzilor nu este permisă",
	"chat_screen.message": "Mesaj de trimis: %s",
	"chat_screen.messages_not_allowed": "Trimiterea mesajelor nu este permisă",
	"chat_screen.restricted": "Chatul este restricționat. Apasă acest mesaj pentru mai multe detalii.",
	"chat_screen.restricted.narration": "Chatul este restricționat. Du-te la fereastra Restricții din Opțiunile lumii.",
	...
	"chunk.toast.loadFailure": "Nu s-a putut încărca chunk-ul de la %s",
	"chunk.toast.lowDiskSpace": "Spațiu pe disc scăzut!",
	"chunk.toast.lowDiskSpace.description": "S-ar putea ca lumea să nu poată fi salvată.",
	"chunk.toast.saveFailure": "Nu s-a putut salva chunk-ul de la %s",
	"clear.failed.multiple": "Nu a fost găsit niciun obiect la %s jucători",
	"clear.failed.single": "Nu a fost găsit niciun obiect la %s",
	...
	"command.forkLimit": "Numărul maxim de contexte atins (%s)",
	"command.trailing_data": "S-au găsit date reziduale: %s",
	...
	"commands.banlist.list": "Există %s interdicți(e/i):",
	...
	"commands.bossbar.get.visible.visible": "Bara de boss %s este vizibilă",
	"commands.bossbar.list.bars.none": "Nu există nicio bară de boss activă",
	"commands.bossbar.list.bars.some": "%s bară/e de boss personalizată/e activ(e): %s",
	...
	"commands.clear.success.multiple": "A(u) fost eliminat/e %s obiect(e) de la %s jucători",
	"commands.clear.success.single": "A(u) fost eliminat/e %s obiect(e) de la %s",
	...
	"commands.clone.toobig": "Sunt prea multe blocuri în zona specificată (maxim %s, %s specificate)",
	...
	"commands.data.get.invalid": "Nu se poate obține %s. Sunt permise doar etichete numerice",
	"commands.data.get.multiple": "Acest argument acceptă o singură valoare NBT",
	"commands.data.get.unknown": "Nu se poate obține %s. Eticha nu există",
	...
	"commands.datapack.create.already_exists": "Există deja un pachet de date cu numele „%s”",
	"commands.datapack.create.invalid_full_name": "Nume pachet nou invalid „%s”",
	...
	"commands.datapack.disable.failed": "Pachetul de date „%s” nu este activat!",
	"commands.datapack.disable.failed.feature": "Pachetul „%s” nu poate fi dezactivat, face parte dintr-o opțiune activată!",
	"commands.datapack.enable.failed": "Pachetul de date „%s” este deja activat!",
	...
	"commands.datapack.list.available.success": "Există %s pachet(e) de date disponibil(e): %s",
	"commands.datapack.list.enabled.none": "Nu este activ niciun pachet de date",
	"commands.datapack.list.enabled.success": "Există %s pachet(e) de date activat(e): %s",
	...
	"commands.debug.function.success.multiple": "%s com(andă/enzi) din %s funcții au fost trasate în fișierul de ieșire %s",
	"commands.debug.function.success.single": "%s com(andă/enzi) din funcția „%s“ au fost trasate în fișierul de ieșire %s",
	...
	"commands.dialog.clear.multiple": "Dialogul a fost șters pentru %s jucători",
	"commands.dialog.clear.single": "Dialogul a fost șters pentru %s",
	"commands.dialog.show.multiple": "Dialogul a fost afișat la %s jucători",
	"commands.dialog.show.single": "Dialogul a fost afișat la %s",
	...
	"commands.experience.set.levels.success.multiple": "Nivelurile de experiență a %s jucători au fost setate la %s",
	"commands.experience.set.levels.success.single": "Nivelurile de experiență ale lui %s au fost setate la %s",
	"commands.experience.set.points.invalid": "Nu se pot seta puncte de experiență peste maximul nivelului actual al jucătorului",
	"commands.experience.set.points.success.multiple": "Punctele de experiență a %s jucători au fost setate la %s",
	"commands.experience.set.points.success.single": "Punctele de experiență ale lui %s au fost setate la %s",
	"commands.fetchprofile.copy_component": "Copiază componentul",
	"commands.fetchprofile.copy_text": "Copiază %s",
	"commands.fetchprofile.entity.success": "S-a rezolvat profilul pentru entitatea %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Nu s-a putut serializa profilul: %s",
	"commands.fetchprofile.give_item": "Oferă obiect",
	"commands.fetchprofile.id.failure": "Rezolvarea profilului cu ID %s a eșuat",
	"commands.fetchprofile.id.success": "S-a rezolvat profilul cu ID %s: %s",
	"commands.fetchprofile.name.failure": "Rezolvarea profilului cu nume %s a eșuat",
	"commands.fetchprofile.name.success": "S-a rezolvat profilul cu nume %s: %s",
	"commands.fetchprofile.no_profile": "Entitatea %s nu are profil",
	"commands.fetchprofile.summon_mannequin": "Invocă un manechin",
	...
	"commands.forceload.added.multiple": "%s chunk-uri din %s de la %s la %s au fost marcate pentru încărcare forțată",
	...
	"commands.forceload.list.multiple": "Au fost găsite %s chunk-uri încărcate forțat în %s la: %s",
	...
	"commands.forceload.removed.failure": "Nu s-a schimbat nimic. Aceste chunk-uri nu erau marcate pentru încărcare forțată",
	"commands.forceload.removed.multiple": "%s chunk-uri din %s de la %s la %s nu mai sunt marcate pentru încărcare forțată",
	"commands.forceload.removed.single": "Chunkul %s din %s nu mai este marcat pentru încărcarea forțată",
	"commands.forceload.toobig": "Sunt prea multe chunk-uri în zona specificată (maxim %s, %s specificate)",
	...
	"commands.function.scheduled.single": "Rulează funcția %s",
	"commands.function.success.multiple": "A(u) fost executat(e) %s com(andă/enzi) din %s funcții",
	"commands.function.success.multiple.result": "Au fost executate %s funcții",
	...
	"commands.item.entity.set.success.multiple": "S-a înlocuit un slot pe %s entități cu %s",
	...
	"commands.item.source.not_a_container": "Poziția-sursă %s, %s, %s nu este un container",
	"commands.item.target.no_changed.known_item": "Nicio țintă nu a acceptat obiectul %s în slotul %s",
	"commands.item.target.no_changes": "Nicio țintă nu a acceptat obiectul în slotul %s",
	"commands.item.target.no_such_slot": "Ținta nu are slot %s",
	...
	"commands.perf.alreadyRunning": "Profilul de performanță a început deja",
	"commands.perf.notRunning": "Profilul de performanță nu a început încă",
	"commands.perf.reportFailed": "Nu s-a putut crea raportul de depanare",
	"commands.perf.reportSaved": "Raport de depanare creat în %s",
	"commands.perf.started": "Au început 10 secunde de profilul de performanță (folosește '/perf stop' pentru al opri mai devreme)",
	...
	"commands.place.feature.invalid": "Nu există nicio funcție de tip „%s”",
	"commands.place.feature.success": "Structura %s a fost plasată la %s, %s, %s",
	"commands.place.jigsaw.failed": "Generarea construcției a eșuat",
	"commands.place.jigsaw.invalid": "Nu există niciun grup de șabloane de tip „%s”",
	"commands.place.jigsaw.success": "Construcția s-a generat la %s, %s, %s",
	"commands.place.structure.failed": "Nu s-a putut plasa structura",
	"commands.place.structure.invalid": "Nu există nicio structură de tip „%s”",
	...
	"commands.place.template.invalid": "Nu există niciun șablon cu ID-ul %s",
	"commands.place.template.success": "Șablonul „%s” s-a încărcat la %s, %s, %s",
	...
	"commands.profile_fetch.copy_component": "Copiază componentul",
	"commands.profile_fetch.failed_to_serialize": "Nu s-a putut serializa profilul: %s",
	"commands.profile_fetch.give_item": "Oferă obiect",
	"commands.profile_fetch.id.failure": "Nu s-a putut rezolva profilul cu ID-ul %s",
	"commands.profile_fetch.id.success": "Profilul cu ID-ul „%s“: %s a fost rezolvat",
	"commands.profile_fetch.name.failure": "Nu s-a putut rezolva profilul cu numele %s",
	"commands.profile_fetch.name.success": "Profilul cu numele %s:%s a fost rezolvat",
	"commands.publish.alreadyPublished": "Este găzduit deja un joc multiplayer pe portul %s",
	"commands.publish.alreadyPublished.lan": "Este găzduit deja un joc local pe portul %s",
	"commands.publish.alreadyPublished.online": "Jocul online e deja găzduit",
	"commands.publish.failed": "Nu se poate găzdui un joc local",
	"commands.publish.started": "Jocul local este găzduit pe portul %s",
	"commands.publish.started.lan": "Joc online găzduit pe portul %s",
	"commands.publish.started.online": "Joc online găzduit",
	...
	"commands.ride.mount.failure.generic": "%s nu a putut începe să călărească %s",
	...
	"commands.schedule.created.tag": "Eticheta „%s” a fost programată în %s ticuri la momentul din joc %s",
	...
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Formatul numeric pentru %s entități din %s a fost eliminat",
	...
	"commands.scoreboard.players.list.entity.empty": "%s nu are niciun scor de afișat",
	"commands.scoreboard.players.list.entity.entry": "%s: %s",
	"commands.scoreboard.players.list.entity.success": "%s are %s scor(uri):",
	"commands.scoreboard.players.list.success": "Există %s entitate/entități urmărită(e): %s",
	...
	"commands.setworldspawn.failure.not_overworld": "Punctul în care apare lumea poate fi definit doar pentru suprafață",
	"commands.setworldspawn.success": "Setati punctul de reînviere al lumii la %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "A fost setat punctul de reînviere a lumii la %s, %s, %s [%s, %s] în %s",
	"commands.spawnpoint.success.multiple": "A fost setat punctul de reînviere la %s, %s, %s [%s] în %s pentru %s jucători",
	"commands.spawnpoint.success.multiple.new": "A fost setat punctul de reînviere la %s, %s, %s [%s, %s] în %s pentru %s jucători",
	"commands.spawnpoint.success.single": "A fost setat punctul de reînviere la %s, %s, %s [%s] în %s pentru %s",
	"commands.spawnpoint.success.single.new": "A fost setat punctul de reînviere la %s, %s, %s [%s, %s] în %s pentru %s",
	"commands.spectate.cannot_spectate": "%s nu poate fi privit",
	...
	"commands.spreadplayers.failed.entities": "Nu s-au putut dispersa %s entitate/entități în jurul punctului %s, %s (prea multe entități pentru spațiul disponibil - încearcă să nu depășești %s)",
	"commands.spreadplayers.failed.invalid.height": "maxHeight %s invalid; era prevăzut mai mult decât minimul lumii %s",
	"commands.spreadplayers.failed.teams": "Nu s-au putut dispersa %s echipă(e) în jurul punctului %s, %s (prea multe entități pentru spațiul disponibil - încearcă să nu depășești %s)",
	"commands.spreadplayers.success.entities": "%s jucător(i) a(u) fost dispersat(ți) în jurul punctului %s, %s cu o distanță medie de %s blocuri între ei",
	"commands.spreadplayers.success.teams": "%s echipă(e) a(u) fost dispersată(e) în jurul punctului %s, %s cu o distanță medie de %s blocuri între ele",
	"commands.stop.stopping": "Serverul este în curs de oprire",
	"commands.stopsound.success.source.any": "Au fost oprite toate sunetele cu sursa „%s”",
	...
	"commands.stopwatch.already_exists": "Cronometrul „%s” deja există",
	"commands.stopwatch.create.success": "A fost creat cronometrul „%s”",
	"commands.stopwatch.does_not_exist": "Cronometrul „%s” nu există",
	"commands.stopwatch.query": "Cronometrul „%s” a funcționat timp de %s secunde",
	"commands.stopwatch.remove.success": "A fost eliminat cronometrul „%s”",
	"commands.stopwatch.restart.success": "A fost repornit cronometrul „%s”",
	"commands.summon.failed": "Entitatea nu a putut fi invocată",
	"commands.summon.failed.peaceful": "Monștrii nu pot fi invocați pe dificultatea pașnică",
	...
	"commands.swing.failed.notliving": "Nu a fost găsită nicio entitate care ar putea să-și fluture mâinile",
	"commands.swing.success.multiple": "%s entități acum își flutură mâinile",
	"commands.swing.success.single": "%s acum își flutură mâinile",
	"commands.tag.add.failed": "Ținta are deja eticheta sau are prea multe etichete",
	"commands.tag.add.success.multiple": "Eticheta „%s” a fost adăugată la %s entități",
	"commands.tag.add.success.single": "Eticheta „%s” a fost adăugată la %s",
	"commands.tag.list.multiple.empty": "Cele %s entități nu au etichete",
	"commands.tag.list.multiple.success": "Cele %s entități au %s etichete în total: %s",
	"commands.tag.list.single.empty": "%s nu are etichete",
	"commands.tag.list.single.success": "%s are %s etichete: %s",
	"commands.tag.remove.failed": "Ținta nu are acestă etichetă",
	"commands.tag.remove.success.multiple": "Eticheta „%s” a fost eliminată de la %s entități",
	"commands.tag.remove.success.single": "Eticheta „%s” a fost eliminată de la %s",
	...
	"commands.team.list.members.success": "Echipa %s are %s membru(i): %s",
	"commands.team.list.teams.empty": "Nu există nicio echipă",
	"commands.team.list.teams.success": "Există %s echipă(e): %s",
	...
	"commands.team.option.color.clear.success": "Culoarea echipei %s a fost ștearsă",
	...
	"commands.test.clear.error.no_tests": "Nu s-a putut găsi niciun test care să fie golit",
	"commands.test.clear.success": "%s structură/i au fost golite",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Apasă pentru a copia",
	"commands.test.create.success": "A fost creat configurația de testare pentru testul „%s“",
	...
	"commands.test.locate.done": "A fost finalizat localizarea, a(u) fost găsit(ă/e) %s structur(ă/i)",
	"commands.test.locate.found": "A fost găsit structura la: %s (distanță: %s)",
	...
	"commands.test.reset.success": "Resetează %s structură/i",
	"commands.test.run.no_tests": "Niciun test găsit",
	"commands.test.run.running": "Rulând %s test(e)…",
	"commands.test.summary": "Testarea jocului completată! %s test(e) a(u) rulat",
	"commands.test.summary.all_required_passed": "Toate testele necesare au trecut :)",
	"commands.test.summary.failed": "%s test(e) necesar(e) eșuat(e) :(",
	"commands.test.summary.optional_failed": "%s test(e) opțional(e) eșuat(e)",
	"commands.tick.query.percentiles": "Per centile: P50: %sms P95: %sms P99: %sms. Eșantion: %s",
	"commands.tick.query.rate.running": "Rata de ticuri țintă: %s pe secundă.\nTimp mediu pe tic: %s ms (țintă: %s ms)",
	"commands.tick.query.rate.sprinting": "Rata de ticuri țintă: %s pe secundă (ignorată, doar referințe).\nTimp mediu pe tic: %s ms",
	"commands.tick.rate.success": "Rata de ticuri țintă a fost setat la %s pe secundă",
	"commands.tick.sprint.report": "Accelerare finalizată cu %s ticuri pe secundă sau %s ms pe tic",
	"commands.tick.sprint.stop.fail": "Nicio accelerare de ticuri în curs",
	"commands.tick.sprint.stop.success": "Accelerare de ticuri a fost întrerupt",
	"commands.tick.status.frozen": "Jocul este blocat",
	"commands.tick.status.lagging": "Jocul rulează, dar nu poate ține pasul cu rata de ticuri țintă",
	"commands.tick.status.running": "Jocul rulează normal",
	"commands.tick.status.sprinting": "Jocul rulează rapid",
	"commands.tick.step.fail": "Nu s-a putut avansa jocul - mai întâi trebuie să fie blocat",
	"commands.tick.step.stop.fail": "Nicio avansare de ticuri în curs",
	"commands.tick.step.stop.success": "Avansarea de ticuri a fost întrerupt",
	"commands.tick.step.success": "Avansare de %s tic(uri)",
	"commands.time.no_default_clock": "Nu există niciun ceas implicit în dimensiunea %s",
	"commands.time.no_time_marker_found": "Marcatorul de timp %s nu există pentru ceasul %s",
	"commands.time.pause": "Ceasul %s a fost oprit",
	"commands.time.query": "Este ora %s",
	"commands.time.query.absolute": "Ceasul %s este la %s tic(uri)",
	"commands.time.query.gametime": "Timpul jocului este de %s tic(uri)",
	"commands.time.query.timeline": "Cronologia %s este la %s tic(uri)",
	"commands.time.query.timeline.repetitions": "Cronologia %s a depășit %s repetiție(ții)",
	"commands.time.rate": "Ceasul %s va avansa cu o viteză de %s ori mai mare decât cea obișnuită",
	"commands.time.resume": "Ceasul %s a fost reluat",
	"commands.time.set": "Ora a fost setată la %s",
	"commands.time.set.absolute": "%s a fost setat la %s tic(uri)",
	"commands.time.set.time_marker": "%s a fost setat la marcajul de timp %s",
	"commands.time.wrong_timeline_for_clock": "Cronologia %s nu este validă pentru ceasul %s",
	...
	"commands.unpublish.notPublished": "Niciun joc multiplayer publicat",
	"commands.unpublish.success": "Jocul multiplayer e acum nepublicat",
	...
	"commands.waypoint.list.empty": "Niciun punct de trecere în %s",
	"commands.waypoint.list.success": "%s punct(e) de trecere în %s: %s",
	"commands.waypoint.modify.color": "Culoarea punctului de trecere este acum %s",
	"commands.waypoint.modify.color.reset": "Culoarea punctului de trecere resetată",
	"commands.waypoint.modify.style": "Stilul punctului de trecere a fost schimbat",
	...
	"commands.whitelist.list": "Sunt %s jucător(i) pe lista albă: %s",
	"commands.whitelist.none": "Nu există niciun jucător pe lista albă",
	...
	"connect.p2p.establishing": "Se stabilește o conexiune...",
	"connect.p2p.failed.generic": "Nu s-a putut conecta la jucător",
	"connect.p2p.failed.signaling": "Momentan nu este posibilă conectarea.\nVă rugăm să încercați mai târziu.",
	"connect.p2p.failed.timeout": "Cererea de conectare a expirat",
	"connect.p2p.failed.unreachable": "Jucătorul nu poate fi accesat",
	"connect.reconfiging": "Reconfigurare…",
	"connect.reconfiguring": "Reconfigurare…",
	"connect.transferring": "Se transferă într-un nou server…",
	...
	"container.upgrade.error_tooltip": "Obiectul tău nu poate fi îmbunătățit în acest mod",
	...
	"createWorld.customize.buffet.search": "Caută…",
	"createWorld.customize.buffet.title": "Personalizarea unui singur biom",
	...
	"dataPack.trade_rebalance.description": "A fost actualizat comerțul cu sătenii",
	...
	"dataPack.winter_drop.description": "Funcții noi și conținut pentru drop-ul de iarnă",
	"dataPack.winter_drop.name": "Drop de iarnă",
	"datapackFailure.safeMode": "Modul sigur",
	"datapackFailure.safeMode.failed.description": "Această lume conține date nevalide sau corupte.",
	"datapackFailure.safeMode.failed.title": "Lumea nu a putut fi încărcată în modul sigur.",
	"datapackFailure.title": "Erorile din pachetele de date selectate în prezent au împiedicat încărcarea lumii.\nPoți încerca să-l încarci doar cu pachetul de date prestabilit („modul sigur”) sau întoarce-te la ecranul de titlu și remediază-l manual.",
	...
	"death.attack.drown.player": "%[1]s s-a înecat în timp ce încerca să scape de %[2]s",
	...
	"death.attack.fallingStalactite.player": "%[1]s a fost străpuns de o stalactită în timp ce se lupta cu %[2]s",
	...
	"death.attack.genericKill.player": "%[1]s a fost ucis(ă) în timp ce se lupta cu %[2]s",
	...
	"death.attack.mace_smash": "%[1]s a fost zdrobit(ă) de %[2]s",
	"death.attack.mace_smash.item": "%[1]s a fost zdrobit(ă) de %[2]s cu %[3]s",
	...
	"death.attack.message_too_long": "Din păcate, mesajul a fost prea lung ca să fie trimis în întregime. Scuze! Uite o versiune scurtată: %s",
	...
	"death.attack.onFire.item": "%[1]s s-a prăjit în timp ce se lupta cu %[2]s înarmat cu %[3]s",
	...
	"death.attack.spear": "%[1]s a fost străpuns de %[2]s",
	"death.attack.spear.item": "%[1]s a fost străpuns de %[2]s cu %[3]s",
	...
	"death.attack.sulfurCubeHot": "%[1]s a murit pentru că nu doar podeaua e lavă",
	"death.attack.sulfurCubeHot.player": "%[2]s i-a arătat lui %[1]s că nu doar podeaua este lavă",
	...
	"debug.chunk_boundaries.help": "F3 + G = Arată granițele chunk-urilor",
	"debug.chunk_boundaries.off": "Granițe de chunk-uri: ascunse",
	"debug.chunk_boundaries.on": "Granițe de chunk-uri: vizibile",
	...
	"debug.crash.message.rebindable": "%s + %s sunt apăsate. Se va produce un crash dacă nu le dai drumul.",
	...
	"debug.dump_dynamic_textures.help": "F3 + S = Salvează texturile dinamice într-un dosar",
	"debug.entry.always": "Mereu",
	"debug.entry.currently.alwaysOn": "%s: Momentan întotdeauna pornit",
	"debug.entry.currently.inF3": "%s: Momentan doar în F3",
	"debug.entry.currently.inOverlay": "%s: Momentan doar în meniul de depanare",
	"debug.entry.currently.never": "%s: Momentan dezactivat",
	"debug.entry.f3": "În F3",
	"debug.entry.overlay": "În meniu",
	...
	"debug.options.category.renderer": "Randări de depanare",
	"debug.options.category.text": "Text din meniul de depanare",
	"debug.options.help": "F3 + F6 = Modifică opțiunile de depanare",
	"debug.options.notAllowed.tooltip": "Nu este vizibil când informațiile de depanare sunt reduse",
	"debug.options.profile.default": "Profil implicit",
	"debug.options.profile.performance": "Profil de performanță",
	"debug.options.search": "Caută opțiuni…",
	"debug.options.title": "Opțiuni de depanare",
	"debug.options.warning": "Aceste opțiuni sunt doar pentru testare. Acestea îți pot încetini computerul, pot cauza un crash sau să se transforme într-un vampir.",
	...
	"debug.profiling.start.rebindable": "Profilarea a început acum %s secunde. Apasă %s + %s pentru a opri mai devreme",
	"debug.profiling.stop": "Profilarea s-a terminat. Rezultatele au fost salvate în %s",
	"debug.reload_chunks.help": "F3 + A = Reîncarcă chunk-urile",
	"debug.reload_chunks.message": "Se reîncarcă toate chunk-urile",
	...
	"disconnect.loginFailedInfo.invalidSession": "Sesiune nevalidă (Încearcă să repornești jocul și Launcher-ul)",
	"disconnect.loginFailedInfo.serversUnavailable": "Serverele de autentificare nu sunt disponibile momentan. Te rugăm să încerci din nou.",
	...
	"disconnect.transfer": "Transferat la alt server",
	"disconnect.unknownHost": "Gazdă necunoscută",
	"download.pack.failed": "%s din %s pachet(e) nu au putut fi descărcate",
	...
	"editGamerule.inGame.button": "Modifică regulile jocului...",
	"editGamerule.inGame.disabled.tooltip": "Actualizarea regulilor jocului necesită permisiuni de operator.",
	"editGamerule.inGame.discardChanges.message": "Ești sigur că vrei să renunți la modificările în așteptare ale regulilor de joc?",
	"editGamerule.inGame.discardChanges.title": "Schimbări ale regulilor jocului",
	"editGamerule.inGame.downloadingGamerules": "Recuperarea regulilor jocului...",
	"editGamerule.title": "Modifică regulile jocului",
	"effect.duration.infinite": "∞",
	"effect.minecraft.absorption": "Absorbție",
	"effect.minecraft.bad_omen": "Rău augur",
	"effect.minecraft.blindness": "Orbire",
	"effect.minecraft.breath_of_the_nautilus": "Respirația nautilului",
	"effect.minecraft.conduit_power": "Putere de conductă",
	...
	"effect.minecraft.oozing": "Înmâzgare",
	...
	"enchantment.minecraft.breach": "Ruptură",
	...
	"enchantment.minecraft.lunge": "Fandare",
	...
	"entity.minecraft.camel_husk": "Cămilă-momâie",
	...
	"entity.minecraft.chest_minecart": "Vagonet cu cufăr",
	"entity.minecraft.chicken": "Găină",
	"entity.minecraft.cod": "Cod",
	"entity.minecraft.command_block_minecart": "Vagonet cu bloc de comenzi",
	"entity.minecraft.copper_golem": "Golem de cupru",
	...
	"entity.minecraft.furnace_minecart": "Vagonet cu cuptor",
	...
	"entity.minecraft.hopper_minecart": "Vagonet cu pâlnie",
	...
	"entity.minecraft.mannequin": "Manechin",
	...
	"entity.minecraft.parched": "Uscat",
	...
	"entity.minecraft.spawner_minecart": "Vagonet cu generator de monștri",
	...
	"entity.minecraft.sulfur_cube": "Cub sulfuros",
	"entity.minecraft.sulfur_cube.content": "Conține: %s",
	"entity.minecraft.tadpole": "Mormoloc",
	"entity.minecraft.text_display": "Afișaj de text",
	"entity.minecraft.tnt": "TNT amorsat",
	"entity.minecraft.tnt_minecart": "Vagonet cu TNT",
	...
	"entity.minecraft.zombie_nautilus": "Nautil-zombi",
	"entity.minecraft.zombie_villager": "Sătean-zombi",
	"entity.minecraft.zombified_piglin": "Piglin zombificat",
	"entity.not_summonable": "Nu poate fi invocată entitatea de tip „%s”",
	...
	"filled_map.village_desert": "Hartă de sat din deșert",
	"filled_map.village_plains": "Hartă de sat din câmpie",
	"filled_map.village_savanna": "Hartă de sat din savană",
	"filled_map.village_snowy": "Hartă de sat înzăpezit",
	"filled_map.village_taiga": "Hartă de sat din taiga",
	...
	"flat_world_preset.minecraft.overworld": "Suprafață",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Permite Netherul",
	"gamerule.allowEnteringNetherUsingPortals.description": "Controlează dacă jucătorii pot să intre sau nu în Nether",
	"gamerule.allowFireTicksAwayFromPlayer": "Actualizarea focului departe de jucători",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Controlează dacă focul și lava pot să aibă ticuri la mai mult de 8 chunk-uri de jucător",
	...
	"gamerule.category.mobs": "Creaturi",
	...
	"gamerule.commandBlocksEnabled": "Activează blocurile de comenzi",
	"gamerule.commandModificationBlockLimit": "Limită de blocuri modificate prin comenzi",
	"gamerule.commandModificationBlockLimit.description": "Numărul de blocuri care pot fi modificate în același timp de o singură comandă, cum ar fi /fill și /clone.",
	...
	"gamerule.doEntityDrops": "Primește obiecte de la entități",
	...
	"gamerule.doTileDrops.description": "Controlează pierderile de resurse de la creaturi, inclusiv sferele de experiență.",
	...
	"gamerule.enableCommandBlocks": "Activează blocurile de comenzi",
	"gamerule.enderPearlsVanishOnDeath": "Perlele ender dispar la moarte",
	"gamerule.enderPearlsVanishOnDeath.description": "Controlează dacă perlele ender aruncate de un jucător dispar atunci când acel jucător moare.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Entitățile cu pasageri pot folosi portaluri\n",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Permite entităților cu pasageri să se teleporteze prin portalurile Nether, End și prin poarta de End.",
	...
	"gamerule.lavaSourceConversion.description": "Când lava curgătoare este înconjurată pe două părți de izvoare de lavă, aceasta se transformă în izvor.",
	"gamerule.locatorBar": "Activează bara de localizare a jucătorilor",
	"gamerule.locatorBar.description": "Când este activată, este afișată o bară pe ecran pentru a indica direcția jucătorilor.",
	...
	"gamerule.minecartMaxSpeed.description": "Viteza maximă normală a unui vagonet în mișcare pe uscat.",
	"gamerule.minecraft.elytra_movement_check": "Verifică mișcarea elitrelor",
	"gamerule.minecraft.fire_spread_radius_around_player": "Raza de răspândire a focului",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Raza în blocuri din jurul jucătorului în care focul se poate răspândi",
	"gamerule.minecraft.player_movement_check": "Verifică mișcarea jucătorului",
	"gamerule.minecraft.raids": "Invazii",
	"gamerule.minecraft.universal_anger.description": "Creaturile neutre enervate atacă orice jucător în apropiere, nu doar cel care le-a enervat. Funcționează cel mai bine când regula forgive_dead_players este dezactivată.",
	"gamerule.mobExplosionDropDecay": "În exploziile cauzate de creaturi, unele blocuri se vor pierde",
	...
	"gamerule.mobGriefing": "Permite acțiuni distrugătoare de creaturi",
	...
	"gamerule.playersNetherPortalCreativeDelay.description": "Timpul (în ticuri) de care are nevoie un jucător în modul creativ pentru a sta într-un portal Nether înainte de a schimba dimensiunile.",
	"gamerule.playersNetherPortalDefaultDelay": "Întârzierea portalului Nether în modul non-creativ",
	"gamerule.playersNetherPortalDefaultDelay.description": "Timpul (în ticuri) de care are nevoie un jucător în mod non-creativ pentru a sta într-un portal Nether înainte de a schimba dimensiunile.",
	...
	"gamerule.pvp": "Activează PVP",
	"gamerule.pvp.description": "Controlează dacă jucătorii pot răni alți jucători sau nu",
	...
	"gamerule.spawnChunkRadius": "Raza de apariție a chunk-urilor",
	"gamerule.spawnChunkRadius.description": "Numărul de chunk-uri care stau încărcate în jurul punctului de apariție din suprafață.",
	"gamerule.spawnMonsters": "Generează monștri",
	"gamerule.spawnMonsters.description": "Controlează dacă monștrii pot fi generați în mod natural sau nu",
	"gamerule.spawnRadius": "Raza zonei de reînviere",
	"gamerule.spawnRadius.description": "Controlează dimensiunea zonei din jurul punctului de reînviere în care pot apărea jucătorii.",
	"gamerule.spawnerBlocksEnabled": "Activează generatoarele de monștri",
	...
	"gamerule.tntExplosionDropDecay": "În exploziile de TNT, unele blocuri se vor pierde",
	"gamerule.tntExplosionDropDecay.description": "Unele dintre obiectele lăsate de blocurile distruse de explozii cauzate de TNT se pierd în explozie.",
	"gamerule.universalAnger": "Furie universală",
	"gamerule.universalAnger.description": "Creaturile neutrale enervate atacă orice jucător în apropiere, nu doar cel care i-a enervat. Funcționează cel mai bine când regula forgiveDeadPlayers este dezactivată.",
	"gamerule.waterSourceConversion": "Apa devine un izvor",
	"gamerule.waterSourceConversion.description": "Când apa curgătoare este înconjurată pe două părți de izvoare de apă, aceasta se transformă în izvor.",
	"generator.custom": "Personalizat",
	"generator.customized": "Personalizat (vechi)",
	"generator.minecraft.amplified": "AMPLIFICATĂ",
	"generator.minecraft.amplified.info": "Notă: Doar pentru amuzament! Necesită un calculator performant.",
	...
	"gui.abuseReport.discard.draft": "Salvează ca schiță",
	...
	"gui.abuseReport.draft.quittotitle.content": "Dorești să-l editezi în continuare sau să renunți la el?",
	"gui.abuseReport.draft.quittotitle.title": "Ai o schiță de raport de chat care se va pierde dacă ieși",
	"gui.abuseReport.draft.title": "Editezi schița raportului de chat?",
	...
	"gui.abuseReport.name.comment_box_label": "Te rugăm să descrii de ce dorești să raportezi acest nume:",
	"gui.abuseReport.name.reporting": "Raportezi numele „%s”.",
	"gui.abuseReport.name.title": "Raportează numele jucătorului",
	"gui.abuseReport.observed_what": "De ce raportezi asta?",
	"gui.abuseReport.read_info": "Află despre raportare",
	...
	"gui.abuseReport.reason.generic": "Vreau să raportez acest jucător",
	"gui.abuseReport.reason.generic.description": "Mă enervează sau au facut ceva ce nu mi-a plăcut.",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Skin indecent",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Skinuri care sunt grafice prin natura lor, referitoare la acte sexuale, organe sexuale și violență sexuală.",
	...
	"gui.abuseReport.send.error_message": "S-a returnat o eroare în timpul trimiterii raportului tău:\n„%s”",
	...
	"gui.abuseReport.send.no_reason": "Te rugăm să selectezi o categorie de raport",
	"gui.abuseReport.send.not_attested": "Te rugăm să citești textul de mai sus și să marchezi căsuța pentru a trimite raportul",
	"gui.abuseReport.send.service_unavailable": "Nu a fost posibilă contactarea serviciului de raportare a abuzurilor. Te rugăm să te asiguri că ești conectat la internet și să încerci din nou.",
	"gui.abuseReport.sending.title": "Trimitem raportul tău…",
	"gui.abuseReport.sent.title": "Raportul a fost trimis",
	"gui.abuseReport.skin.title": "Raportează skinul jucătorului",
	"gui.abuseReport.title": "Raportează jucătorul",
	"gui.abuseReport.type.chat": "Mesaje de chat",
	"gui.abuseReport.type.name": "Nume jucător",
	"gui.abuseReport.type.skin": "Skinul unui jucător",
	...
	"gui.banned.description.unknownreason": "Am primit recent un raport pentru comportament necorespunzător al contului tău. Moderatorii noștri au analizat acum cazul tău și au identificat că acesta contravine standardelor comunității Minecraft.",
	...
	"gui.banned.reason.hate_speech": "Discriminare sau instigare la ură",
	...
	"gui.banned.skin.description": "Skinul tău curent violează Standardele Comunității noastre. Te mai poți juca folosind un personaj implicit sau selectând unul nou.\n\nAflă mai multe sau înscrie o revizuire de caz la link-ul următor: %s",
	"gui.banned.skin.title": "Skin interzis",
	...
	"gui.chatReport.discard.discard": "Renunță la raportare",
	"gui.chatReport.discard.draft": "Salvează ca schiță",
	"gui.chatReport.discard.return": "Continuă editarea",
	"gui.chatReport.discard.title": "Sigur renunți la raportare?",
	"gui.chatReport.draft.content": "Continui editarea sesizării existente sau renunți și creezi una nouă?",
	"gui.chatReport.draft.discard": "Renunță",
	"gui.chatReport.draft.edit": "Continuă editarea",
	"gui.chatReport.draft.quittotitle.content": "Continui să o editezi sau renunți la ea?",
	"gui.chatReport.draft.quittotitle.title": "Ai o schiță de raport de chat care se va pierde dacă renunți",
	"gui.chatReport.draft.title": "Editezi schița raportului de chat?",
	...
	"gui.chatReport.send.no_reason": "Te rugăm să selectezi o categorie de raport",
	"gui.chatReport.send.no_reported_messages": "Te rugăm să selectezi cel puțin un mesaj de chat pentru a raporta",
	"gui.chatReport.send.too_many_messages": "Încerci să incluzi prea multe mesaje în raport",
	"gui.chatReport.title": "Reclamă mesajele jucătorului",
	...
	"gui.fileDropFailure.detail": "%s fișiere au fost respinse",
	"gui.fileDropFailure.title": "Nu s-au putut adăuga fișiere",
	"gui.friends.accept": "Acceptă",
	"gui.friends.button.loading": "Așteaptă...",
	"gui.friends.button.loading.invite_request_pending": "Se așteaptă confirmarea",
	"gui.friends.button.loading.join_request_pending": "Se așteaptă confirmarea de la %s",
	"gui.friends.cancel_request": "Anulează cererea",
	"gui.friends.confirm_title": "Confirmă",
	"gui.friends.confirm_unfriend": "Ești sigur că vrei să elimini acest jucător din lista ta de prieteni?",
	"gui.friends.copy_to_clipboard": "Copiază în clipboard",
	"gui.friends.decline": "Refuză",
	"gui.friends.empty_nickname": "Introdu un nume de profil valid înainte de a trimite o cerere de prietenie",
	"gui.friends.empty_state": "Prietenii pe care îi adaugi vor apărea aici.\n\nGestionează siguranța online cu ajutorul %s.",
	"gui.friends.empty_state.link": "contului Microsoft",
	"gui.friends.enter_nickname": "Introdu numele de profil",
	"gui.friends.error.connection_issue": "Lista de prieteni nu funcționează în acest moment.\n\nVerifică conexiunea la internet și încearcă din nou.",
	"gui.friends.error.failed.message": "Nu se poate trimite cererea de prietenie în acest moment",
	"gui.friends.error.forbidden.message": "Nu s-a putut efectua această acțiune legată de prieten. Este posibil ca acest lucru să se datoreze setărilor de confidențialitate ale contului.",
	"gui.friends.error.generic": "Ceva nu a mers bine — e vorba de această funcție, nu de prietenii tăi!\n\nÎncearcă din nou mai târziu.",
	"gui.friends.error.rateLimited.message": "Efectuezi operațiuni legate de lista de prieteni prea repede. Te rugăm să aștepți puțin și să încerci din nou.",
	"gui.friends.error.temporary_unavailable": "Lista de prieteni nu funcționează în acest moment.\n\nÎncearcă din nou mai târziu.",
	"gui.friends.error.unavailable.message": "Serviciul „lista de prieteni” nu este disponibil în acest moment. Te rugăm să verifici conexiunea la internet și să încerci din nou mai târziu.",
	"gui.friends.error.upgrade_needed": "Actualizează jocul pentru a accesa lista de prieteni.",
	"gui.friends.error.user_may_lack_active_profile": "Nu există niciun jucător cu acest nume de profil",
	"gui.friends.join": "Alătură-te",
	"gui.friends.loading_friends": "Se încarcă lista de prieteni...",
	"gui.friends.loading_requests": "Se încarcă cererile de prietenie...",
	"gui.friends.manage_account_footer": "Gestionează siguranța online cu ajutorul %s",
	"gui.friends.multiplayer.invite": "Invită",
	"gui.friends.multiplayer.invite_accept": "Acceptă",
	"gui.friends.multiplayer.invite_reject": "Refuză",
	"gui.friends.multiplayer.join_request": "Cere să te alături lumii",
	"gui.friends.multiplayer.join_request_accept": "Acceptă",
	"gui.friends.multiplayer.join_request_reject": "Refuză",
	"gui.friends.my_profile_name": "Numele meu de profil: ",
	"gui.friends.my_profile_name.narration": "Copiază numele de profil %s în clipboard",
	"gui.friends.narration.button.accept": "Apasă tasta Enter pentru a accepta cererea de prietenie de la %s",
	"gui.friends.narration.button.cancel_request": "Apasă tasta Enter pentru a anula cererea de prietenie către %s",
	"gui.friends.narration.button.decline": "Apasă tasta Enter pentru a refuza cererea de prietenie de la %s",
	"gui.friends.narration.button.unfriend": "Apasă tasta Enter pentru a-l elimina pe %s din lista de prieteni",
	"gui.friends.narration.entry.friend": "Prieten %s",
	"gui.friends.narration.entry.incoming": "Cerere de prietenie de la %s",
	"gui.friends.narration.entry.outgoing": "Cerere de prietenie către %s",
	"gui.friends.open": "Prieteni",
	"gui.friends.open.narration": "Lista de prieteni",
	"gui.friends.open.tooltip": "Prieteni",
	"gui.friends.pending.empty": "Nicio cerere de prietenie în așteptare",
	"gui.friends.pending.received": "Primite",
	"gui.friends.pending.sent": "Trimise",
	"gui.friends.presence.status.offline": "Offline",
	"gui.friends.presence.status.online": "Online",
	"gui.friends.presence.status.playing_hosted_server": "Online (Într-o lume)",
	"gui.friends.presence.status.playing_offline": "Online (Într-o lume)",
	"gui.friends.presence.status.playing_realms": "Online (Într-un Realm)",
	"gui.friends.presence.status.playing_server": "Online (Într-un server)",
	"gui.friends.requests_count": "Cereri (%s)",
	"gui.friends.send_request": "Trimite cererea de prietenie",
	"gui.friends.tab_friends": "Prieteni",
	"gui.friends.toast.friend_added.message": "%s ți-a acceptat cererea de prietenie",
	"gui.friends.toast.friend_invited.message": "%s a fost invitat să se alăture lumii tale.",
	"gui.friends.toast.friend_removed.message": "%s a fost eliminat din lista ta de prieteni.",
	"gui.friends.toast.generic_error": "A apărut o eroare neașteptată în timpul actualizării listei tale de prieteni. Te rugăm să încerci din nou mai târziu.",
	"gui.friends.toast.host_invite_expired.message": "Invitația către %s de a se alătura acestei lumi a expirat.",
	"gui.friends.toast.invite_from_friend.message": "%s te-a invitat să te alături lumii lor. Alătură-te prin a deschide lista de prieteni apăsând „%s”",
	"gui.friends.toast.join_invite_expired.message": "Invitația de a te alătura lumii lui %s a expirat.",
	"gui.friends.toast.join_request.message": "%s a cerut să se alăture lumii tale. Deschide lista de prieteni apăsând „%s” sau acceseaz-o din meniul jocului.",
	"gui.friends.toast.request_accepted.message": "Ai devenit prieten cu %s",
	"gui.friends.toast.request_received.message": "%s ți-a trimis o cerere de prietenie",
	"gui.friends.toast.request_sent.message": "Cerere de prietenie trimisă către %s",
	"gui.friends.toast.request_to_join_friend.message": "Ai cerut să te alături lumii lui %s",
	"gui.friends.toast.requests_accepted_multiple.message": "%s prieteni ți-au acceptat cererile de prietenie",
	"gui.friends.toast.requests_received_multiple.message": "Ai primit %s cereri de prietenie",
	"gui.friends.unfriend": "Elimină prietenul",
	"gui.game_rule.search": "Caută...",
	"gui.hours": "%s oră(e)",
	"gui.language.search": "Caută…",
	...
	"gui.none": "Niciunul",
	"gui.ok": "OK",
	"gui.open_report_dir": "Deschide directorul de sesizare",
	"gui.packSelection.search": "Caută…",
	"gui.privacy_link.message": "Deschide acest link pentru a-ți gestiona setările de confidențialitate și siguranță online.",
	"gui.privacy_link.title": "Este posibil ca modificările aduse setărilor profilului Xbox să dureze ceva timp până să fie aplicate.\n\nDacă nu se actualizează, repornește jocul.",
	"gui.proceed": "Continuă",
	"gui.recipebook.moreRecipes": "Clic dreapta pentru mai multe",
	"gui.recipebook.next_page": "Pagina următoare",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Pagina anterioară",
	...
	"gui.remove": "Elimină",
	"gui.report_to_server": "Raportează la server",
	"gui.selectWorld.search": "Caută...",
	"gui.socialInteractions.blocking_hint": "Gestionează cu contul Microsoft",
	...
	"gui.socialInteractions.narration.report": "Raportează pe %s",
	"gui.socialInteractions.narration.show": "Afișează mesajele de la %s",
	"gui.socialInteractions.report": "Reclamă",
	"gui.socialInteractions.search_empty": "Nu s-a găsit niciun jucător cu acel nume",
	...
	"gui.socialInteractions.tooltip.report": "Raportează jucătorul",
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Acest jucător nu poate fi raportat deoarece chatul este dezactivat sau blocat",
	"gui.socialInteractions.tooltip.report.disabled": "Serviciul de raportare este indisponibil",
	"gui.socialInteractions.tooltip.report.no_messages": "Nu există mesaje raportabile de la %s",
	...
	"gui.stats.none_found": "Nicio statistică găsită.",
	...
	"gui.up": "Sus",
	"gui.waitingForResponse.button.inactive": "Înapoi (%s s)",
	"gui.waitingForResponse.title": "Se așteaptă serverul",
	"gui.yes": "Da",
	...
	"item.minecraft.arms_up_pottery_shard": "Ciob de ceramică de figură",
	"item.minecraft.arms_up_pottery_sherd": "Ciob de ceramică de figură",
	"item.minecraft.arrow": "Săgeată",
	"item.minecraft.axolotl_bucket": "Găleată cu axolot",
	"item.minecraft.axolotl_spawn_egg": "Ou generator de axolot",
	...
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Ornament de armură de bolț",
	...
	"item.minecraft.camel_husk_spawn_egg": "Ou generator de cămilă-momâie",
	"item.minecraft.camel_spawn_egg": "Ou generator de cămilă",
	"item.minecraft.carrot": "Morcov",
	"item.minecraft.carrot_on_a_stick": "Morcov pe un băț",
	...
	"item.minecraft.chest_minecart": "Vagonet cu cufăr",
	"item.minecraft.chicken": "Pui crud",
	...
	"item.minecraft.command_block_minecart": "Vagonet cu bloc de comenzi",
	"item.minecraft.compass": "Busolă",
	"item.minecraft.cooked_beef": "Carne de vită friptă",
	"item.minecraft.cooked_chicken": "Pui fript",
	...
	"item.minecraft.copper_axe": "Topor de cupru",
	"item.minecraft.copper_boots": "Cizme de cupru",
	"item.minecraft.copper_chestplate": "Platoșă de cupru",
	"item.minecraft.copper_golem_spawn_egg": "Ou generator de golem de cupru",
	"item.minecraft.copper_helmet": "Cască de cupru",
	"item.minecraft.copper_hoe": "Sapă de cupru",
	"item.minecraft.copper_horse_armor": "Armură de cal din cupru",
	"item.minecraft.copper_ingot": "Lingou de cupru",
	"item.minecraft.copper_leggings": "Jambiere de cupru",
	"item.minecraft.copper_nautilus_armor": "Armură de nautil din cupru",
	"item.minecraft.copper_nugget": "Pepită de cupru",
	"item.minecraft.copper_pickaxe": "Târnăcop de cupru",
	"item.minecraft.copper_shovel": "Lopată de cupru",
	"item.minecraft.copper_spear": "Suliță de cupru",
	"item.minecraft.copper_sword": "Sabie de cupru",
	...
	"item.minecraft.danger_pottery_shard": "Ciob de ceramică de pericol",
	...
	"item.minecraft.diamond_nautilus_armor": "Armură de nautil din diamant",
	"item.minecraft.diamond_pickaxe": "Târnăcop de diamant",
	"item.minecraft.diamond_shovel": "Lopată de diamant",
	"item.minecraft.diamond_spear": "Suliță de diamant",
	...
	"item.minecraft.endermite_spawn_egg": "Ou generator de endermit",
	...
	"item.minecraft.flow_banner_pattern.new": "Model pentru stindard de spirală",
	...
	"item.minecraft.friend_pottery_shard": "Ciob de ceramică de prieten",
	"item.minecraft.friend_pottery_sherd": "Ciob de ceramică de prieten",
	"item.minecraft.frog_spawn_egg": "Ou generator de broască",
	"item.minecraft.furnace_minecart": "Vagonet cu cuptor",
	...
	"item.minecraft.golden_nautilus_armor": "Armură de nautil din aur",
	"item.minecraft.golden_pickaxe": "Târnăcop de aur",
	"item.minecraft.golden_shovel": "Lopată de aur",
	"item.minecraft.golden_spear": "Suliță de aur",
	...
	"item.minecraft.heartbreak_pottery_shard": "Ciob de ceramică de inimă frântă",
	...
	"item.minecraft.hopper_minecart": "Vagonet cu pâlnie",
	...
	"item.minecraft.howl_pottery_shard": "Ciob de ceramică de lup",
	"item.minecraft.howl_pottery_sherd": "Ciob de ceramică de lup",
	...
	"item.minecraft.iron_nautilus_armor": "Armură de nautil din fier",
	...
	"item.minecraft.iron_spear": "Suliță de fier",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Poțiune de înmâzgare persistentă",
	...
	"item.minecraft.miner_pottery_shard": "Ciob de ceramică de miner",
	"item.minecraft.miner_pottery_sherd": "Ciob de ceramică de miner",
	...
	"item.minecraft.mourner_pottery_shard": "Ciob de ceramică de jelitor",
	...
	"item.minecraft.music_disc_bounce": "Disc muzical",
	...
	"item.minecraft.music_disc_lava_chicken": "Disc muzical",
	...
	"item.minecraft.music_disc_tears": "Disc muzical",
	...
	"item.minecraft.nautilus_shell": "Cochilie de nautil",
	"item.minecraft.nautilus_spawn_egg": "Ou generator de nautil",
	...
	"item.minecraft.netherite_horse_armor": "Armură de cal de netherit",
	"item.minecraft.netherite_ingot": "Lingou de netherit",
	"item.minecraft.netherite_leggings": "Jambiere de netherit",
	"item.minecraft.netherite_nautilus_armor": "Armură de nautil din netherit",
	...
	"item.minecraft.netherite_spear": "Suliță de netherit",
	...
	"item.minecraft.parched_spawn_egg": "Ou generator de uscat",
	...
	"item.minecraft.pitcher_plant": "Plantă-urcior",
	"item.minecraft.pitcher_pod": "Bulb de plantă-urcior",
	"item.minecraft.plenty_pottery_shard": "Ciob de ceramică de abundență",
	...
	"item.minecraft.potion.effect.oozing": "Poțiune de înmâzgare",
	...
	"item.minecraft.pottery_shard_archer": "Ciob de ceramică de arcaș",
	"item.minecraft.pottery_shard_arms_up": "Ciob de ceramică de figură",
	"item.minecraft.pottery_shard_prize": "Ciob de ceramică de premiu",
	"item.minecraft.pottery_shard_skull": "Ciob de ceramică de craniu",
	...
	"item.minecraft.prize_pottery_shard": "Ciob de ceramică de premiu",
	"item.minecraft.prize_pottery_sherd": "Ciob de ceramică de premiu",
	...
	"item.minecraft.sheaf_pottery_shard": "Ciob de ceramică de snop",
	"item.minecraft.sheaf_pottery_sherd": "Ciob de ceramică de snop",
	"item.minecraft.shears": "Foarfeci",
	"item.minecraft.sheep_spawn_egg": "Ou generator de oaie",
	"item.minecraft.shelter_pottery_shard": "Ciob de ceramică de adăpost",
	...
	"item.minecraft.skull_pottery_shard": "Ciob de ceramică de craniu",
	...
	"item.minecraft.snort_pottery_shard": "Ciob de ceramică de grohăială",
	"item.minecraft.snort_pottery_sherd": "Ciob de ceramică de grohăială",
	"item.minecraft.snout_armor_trim_smithing_template": "Șablon de fierărie",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Ornament de armură de rât",
	...
	"item.minecraft.splash_potion.effect.oozing": "Poțiune de înmâzgare de aruncat",
	...
	"item.minecraft.squid_spawn_egg": "Ou generator de calamar",
	...
	"item.minecraft.stone_spear": "Suliță de piatră",
	...
	"item.minecraft.sulfur_cube_bucket": "Găleată cu cub sulfuros",
	"item.minecraft.sulfur_cube_spawn_egg": "Ou generator de cub sulfuros",
	"item.minecraft.suspicious_stew": "Supă suspectă",
	"item.minecraft.sweet_berries": "Fructe de pădure dulci",
	"item.minecraft.tadpole_bucket": "Găleată cu mormoloc",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Săgeată de înmâzgare",
	...
	"item.minecraft.tnt_minecart": "Vagonet cu TNT",
	...
	"item.minecraft.trial_key": "Cheie de încercare",
	...
	"item.minecraft.wooden_spear": "Suliță de lemn",
	...
	"item.minecraft.zombie_nautilus_spawn_egg": "Ou generator de nautil-zombi",
	...
	"item.nbt_tags": "NBT: %s etichetă(e)",
	"item.op_block_warning.line1": "Atenție:",
	"item.op_block_warning.line2": "Utilizarea acestui obiect ar putea rezulta în executarea unei comenzi",
	"item.op_block_warning.line3": "Nu folosi dacă nu știi conținutul exact!",
	"item.spawn_egg.peaceful": "Dezactivat pe dificultatea pașnică",
	...
	"jigsaw_block.keep_jigsaws": "Păstrează construcții",
	"jigsaw_block.levels": "Niveluri: %s",
	"jigsaw_block.name": "Nume:",
	"jigsaw_block.placement_priority": "Prioritate plasare:",
	"jigsaw_block.placement_priority.tooltip": "Când acest bloc de construcție se conectează la o piesă, aceasta este ordinea în care piesa respectivă este procesată pentru conexiunile în structura mai largă.\n\nPiesele vor fi procesate cu prioritate descrescătoare cu ordinea de inserare rupând legăturile.",
	"jigsaw_block.pool": "Elemente-țintă:",
	"jigsaw_block.selection_priority": "Prioritate selecție:",
	"jigsaw_block.selection_priority.tooltip": "Când piesa părinte este procesată pentru conexiuni, aceasta este ordinea în care acest bloc de construcție încearcă să se conecteze la piesa țintă.\n\nBlocurile de construcție vor fi procesate cu prioritate descrescătoare și ruperea legăturilor prin ordonare aleatorie.",
	...
	"key.category.minecraft.creative": "Modul Creativ",
	"key.category.minecraft.debug": "Depanare",
	"key.category.minecraft.gameplay": "Acțiuni din joc",
	"key.category.minecraft.inventory": "Inventar",
	"key.category.minecraft.misc": "Diverse",
	"key.category.minecraft.movement": "Mișcare",
	...
	"key.debug.clearChat": "Golește chatul",
	"key.debug.copyLocation": "Copiază locația",
	"key.debug.copyRecreateCommand": "Copiază datele",
	"key.debug.crash": "Crash de depanare",
	"key.debug.debugOptions": "Opțiuni de depanare",
	"key.debug.dumpDynamicTextures": "Salvează texturile dinamine în dosar",
	"key.debug.dumpVersion": "Informații despre versiunea clientului",
	"key.debug.focusPause": "Comută pauza la schimbarea ferestrei",
	"key.debug.fpsCharts": "Grafice de FPS",
	"key.debug.lightmapTexture": "Textură Lightmap",
	"key.debug.modifier": "Tastă modificatoare de depanare",
	"key.debug.networkCharts": "Grafice de rețea",
	"key.debug.overlay": "Comută meniul de depanare",
	"key.debug.profiling": "Pornește/Oprește profilarea",
	"key.debug.profilingChart": "Grafic de profilare",
	"key.debug.reloadChunk": "Reîncarcă chunk-urile",
	"key.debug.reloadResourcePacks": "Reîncarcă pachetele de resurse",
	"key.debug.showAdvancedTooltips": "Arată descrieri avansate",
	"key.debug.showChunkBorders": "Arată granițele chunk-urilor",
	"key.debug.showHitboxes": "Arată cutiile de coliziune",
	"key.debug.spectate": "Comută modul spectator",
	"key.debug.switchGameMode": "Comută modul de joc",
	"key.drop": "Aruncă obiectul selectat",
	"key.forward": "Mers înainte",
	"key.friends": "Fereastra Prieteni",
	...
	"key.quickActions": "Acțiuni rapide",
	...
	"key.spectatorHotbar": "Selectează în bara de acțiune",
	"key.spectatorOutlines": "Evidențiază jucători",
	"key.sprint": "Aleargă",
	"key.swapOffhand": "Schimbă obiectele între mâini",
	"key.toggleGui": "Comută interfața grafică",
	"key.togglePerspective": "Comută perspectiva",
	"key.toggleSpectatorShaderEffects": "Comută shaderele din spectator",
	"key.use": "Folosește obiecte/Așază blocuri",
	"known_server_link.announcements": "Anunțuri",
	"known_server_link.community": "Comunitate",
	"known_server_link.community_guidelines": "Indicațiile comunității",
	"known_server_link.feedback": "Feedback",
	"known_server_link.forums": "Forumuri",
	"known_server_link.news": "Știri",
	"known_server_link.report_bug": "Raportează erori ale serverului",
	...
	"lanServer.port": "Număr port",
	"lanServer.port.invalid": "Port nevalid.\nLasă caseta goală sau introdu un număr diferit între 1024 și 65535.",
	"lanServer.port.invalid.new": "Port nevalid.\nLasă caseta goală sau introdu un număr diferit între %s și %s.",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Adaugă un server",
	"manageServer.edit.title": "Modifică informațiile serverului",
	"manageServer.enterIp": "Adresa serverului",
	"manageServer.enterName": "Numele serverului",
	"manageServer.resourcePack": "Pachete de resurse ale serverului",
	"manageServer.resourcePack.disabled": "Dezactivat",
	"manageServer.resourcePack.enabled": "Activat",
	"manageServer.resourcePack.prompt": "Întreabă",
	"mco.account.privacy.info": "Află mai multe despre Mojang și legile privind confidențialitatea",
	"mco.account.privacy.info.button": "Citește mai multe despre RGPD",
	"mco.account.privacy.information": "Mojang implementează anumite proceduri care ajută la protejarea copiilor și a confidențialității acestora, printre care se numără respectarea Children’s Online Privacy Protection Act (COPPA) și a regulamentului general privind protecția datelor (RGPD).\n\nEste posibil să ai nevoie de consimțământul părinților pentru a-ți accesa contul Realms.",
	...
	"mco.activity.noactivity": "Nicio activitate în ultim(a/ele) %s zi(le)",
	...
	"mco.backup.entry.enabledPack": "Pachet(e) activat(e)",
	"mco.backup.entry.gameDifficulty": "Dificultatea jocului",
	"mco.backup.entry.gameMode": "Mod de joc",
	"mco.backup.entry.gameServerVersion": "Versiunea serverului",
	"mco.backup.entry.name": "Nume",
	"mco.backup.entry.seed": "Sămânță",
	"mco.backup.entry.templateName": "Numele modelului",
	"mco.backup.entry.undefined": "Schimbare nedefinită",
	"mco.backup.entry.uploaded": "Încărcat",
	"mco.backup.entry.worldType": "Tip de lume",
	"mco.backup.entry.worldType.adventureMap": "Hartă de aventură",
	"mco.backup.entry.worldType.experience": "Experiență",
	"mco.backup.entry.worldType.inspiration": "Inspirație",
	"mco.backup.entry.worldType.minigame": "Minijoc",
	"mco.backup.entry.worldType.normal": "Normal",
	"mco.backup.entry.worldType.unknown": "Necunoscut",
	"mco.backup.generate.world": "Generează lumea",
	"mco.backup.info.title": "Schimbări de la ultimul backup",
	"mco.backup.narration": "Backup din %s",
	"mco.backup.nobackups": "Realmul acesta nu are niciun backup în prezent.",
	"mco.backup.restoring": "Realm-ul tău se restaurează",
	...
	"mco.brokenworld.nonowner.error": "Te rugăm să aștepți ca administratorul de Realm să reseteze lumea",
	...
	"mco.compatibility.incompatible.series.popup.message": "Această lume a fost jucată ultima dată în versiunea %s; tu ești pe versiunea %s.\n\nAceste serii nu sunt compatibile între ele. O lume nouă este necesară pentru a juca pe această versiune.",
	"mco.compatibility.unverifiable.message": "Versiunea în care această lume a fost jucată ultima dată nu a putut fi verificată. Dacă lumea este actualizată sau retrogradată, se va crea automat un backup care va fi salvată în \"Backup-uri lumilor\".",
	"mco.compatibility.unverifiable.title": "Compatibilitatea nu poate fi verificată",
	"mco.compatibility.upgrade": "Actualizare",
	"mco.compatibility.upgrade.description": "Ultima dată când această lume a fost lansată era versiunea %s; acum este lansată versiunea %s.\n\nUn backup a lumii tale va fi salvată în tab-ul „Backup-uri lumilor”.\n\nDacă este necesar, cu ajutorul ei îți vei putea recupera lumea.",
	"mco.compatibility.upgrade.friend.description": "Ultima dată când această lume a fost lansată era versiunea %s; acum este lansată versiunea %s.\n\nUn backup a lumii tale va fi salvată în tab-ul „Backup-uri lumilor”.\n\nDacă este necesar, cu ajutorul ei îți vei putea recupera lumea.",
	...
	"mco.configure.world.buttons.region_preference": "Selectează regiunea…",
	"mco.configure.world.buttons.resetworld": "Resetează lumea",
	"mco.configure.world.buttons.save": "Salvează",
	...
	"mco.configure.world.close.question.line1": "Poți închide temporar Realm-ul pentru ca nimeni să nu se poată juca în timp ce faci modificările. Deschide-l din nou când ai terminat. \n\nAcest lucru nu va anula abonamentul Realms.",
	"mco.configure.world.close.question.line2": "Sigur vrei să continui?",
	"mco.configure.world.close.question.title": "Trebuie să faci schimbări fără deranjare?",
	"mco.configure.world.closing": "Se închide temporar Realmul…",
	...
	"mco.configure.world.invite.narration": "Ai (o) %s invitați(e/i) no(uă/i)",
	...
	"mco.configure.world.loading": "Se încarcă Realm-ul",
	"mco.configure.world.location": "Locație",
	"mco.configure.world.minigame": "Actual: %s",
	"mco.configure.world.name": "Numele Realmului",
	"mco.configure.world.name.validation.whitespace": "Nu trebuie să înceapă sau să se termine cu spații albe. Acestea vor fi eliminate automat.",
	...
	"mco.configure.world.players.invite.duplicate": "Un jucător cu numele furnizat a fost deja invitat în Realm",
	"mco.configure.world.players.inviting": "Se invită jucătorul…",
	"mco.configure.world.players.title": "Jucători",
	"mco.configure.world.pvp": "PVP",
	"mco.configure.world.region_preference": "Preferință de regiune",
	"mco.configure.world.region_preference.title": "Selecția preferinței de regiune",
	...
	"mco.configure.world.settings.expired": "Nu poți edita setările unui Realm expirat",
	"mco.configure.world.settings.title": "Setări",
	"mco.configure.world.slot": "Lumea %s",
	"mco.configure.world.slot.empty": "Gol",
	"mco.configure.world.slot.switch.question.line1": "Realm-ul tău va fi schimbat în altă lume",
	...
	"mco.configure.world.subscription.recurring.info": "Modificările aduse abonamentului tău Realms, cum ar fi timpul de stivuire sau dezactivarea facturării recurente, nu vor fi reflectate până la următoarea dată de facturare.",
	"mco.configure.world.subscription.remaining.days": "%[1]s zi(le)",
	"mco.configure.world.subscription.remaining.months": "%[1]s lună/i",
	"mco.configure.world.subscription.remaining.months.days": "%[1]s lună/i, %[2]s zi(le)",
	"mco.configure.world.subscription.start": "Dată de început",
	"mco.configure.world.subscription.tab": "Abonament",
	...
	"mco.connect.region": "Regiune server: %s",
	...
	"mco.download.confirmation.line2": "Nu vei putea să mai încarci această lume pe Realm",
	"mco.download.confirmation.oversized": "Lumea pe care urmează să o descărcați este mai mare de %s\n\nNu vei mai putea încărca această lume pe Realm",
	...
	"mco.error.invalid.session.title": "Sesiune invalidă",
	...
	"mco.errorMessage.6006": "Lumea este învechită",
	...
	"mco.errorMessage.realmsService.configurationError": "A apărut o eroare neașteptată în timpul editării opțiunilor lumii",
	...
	"mco.errorMessage.realmsService.unknownCompatibility": "Nu s-a putut verifica versiunea compatibilă, răspuns: %s",
	"mco.errorMessage.retry": "Reîncercați operațiunea",
	"mco.errorMessage.serviceBusy": "Realms este ocupat momentan.\nÎncearcă să te conectezi din nou la Realmul tău în câteva minute.",
	...
	"mco.invites.pending": "Invitați(e/i) no(uă/i)!",
	...
	"mco.notification.transferSubscription.message": "Abonamentele Java Realms se mută la Microsoft Store. Nu lasă abonamentul tău să expire!\nTransferă acum și obține 30 de zile de Realms gratuit.\nAccesează profilul tău pe minecraft.net pentru a transfera abonamentul.",
	...
	"mco.play.button.realm.closed": "Realm închis",
	...
	"mco.selectServer.create.subtitle": "Selectează ce lume să pui în noul tău Realm",
	...
	"mco.selectServer.loading": "Se încarcă lista Realmurilor",
	...
	"mco.selectServer.popup": "Realms este un mod sigur și simplu de a juca Minecraft online cu până la zece prieteni simultan. Sunt incluse o mulțime de minijocuri și lumi personalizate! Doar proprietarul de Realm trebuie să plătească.",
	"mco.selectServer.purchase": "Adăugă Realmul",
	"mco.selectServer.trial": "Probează!",
	"mco.selectServer.uninitialized": "Apasă ca să începi noul tău Realm!",
	"mco.snapshot.createSnapshotPopup.text": "Ești pe cale să creezi un Realm snapshot gratuit, care va fi asociat cu abonamentul tău plătit Realms. Acest nou Realm snapshot va fi accesibil atât timp cât abonamentul plătit este activ. Realm plătit nu va fi afectat.",
	"mco.snapshot.createSnapshotPopup.title": "Crează un Realm snapshot?",
	"mco.snapshot.creating": "Se creează un Realm snapshot…",
	...
	"mco.snapshot.paired": "Acest Realm snapshot este asociat cu „%s“",
	"mco.snapshot.parent.tooltip": "Folosește cea mai recentă versiune a Minecraft pentru a juca pe acest Realm",
	"mco.snapshot.start": "Începe Realm-ul snapshot gratuit",
	"mco.snapshot.subscription.info": "Acesta este un Realm snapshot care este asociat cu abonamentul tău Realm „%s”. O să rămână activ atâta timp cât este Realm-ul său asociat.",
	"mco.snapshot.tooltip": "Utilizează Realm-ul snapshot pentru a obține o perspectivă asupra versiunilor viitoare de Minecraft, care ar putea include funcții noi și alte modificări.\n\nPoți găsi Realm-urile normale în versiunea de lansare a jocului.",
	"mco.snapshotRealmsPopup.message": "Realms sunt acum disponibile în versiunile Snapshot, începând cu Snapshot 23w41a. Fiecare abonament Realms vine cu un Snapshot Realm gratuit, separat de Realm-ul Java obișnuit!",
	...
	"mco.time.daysAgo": "acum %[1]s zi(le)",
	"mco.time.hoursAgo": "acum %[1]s or(ă/e)",
	"mco.time.minutesAgo": "acum %[1]s minut(e)",
	"mco.time.now": "chiar acum",
	"mco.time.secondsAgo": "acum %[1]s secunde",
	"mco.trial.message.line1": "Vrei să ai propriul tău Realm?",
	"mco.trial.message.line2": "Apasă aici pentru mai multe informații!",
	"mco.upload.button.name": "Încarcă",
	"mco.upload.cancelled": "Încărcare anulată",
	"mco.upload.close.failure": "Realm-ul nu a putut fi închis, încearcă din nou mai târziu.",
	...
	"menu.custom_options": "Opțiuni personalizate…",
	"menu.custom_options.title": "Opțiuni personalizate",
	"menu.custom_options.tooltip": "Notă: opțiunile personalizate sunt furnizate de servere și/sau conținut terț.\nAi grijă!",
	"menu.custom_screen_info.button_narration": "Aceasta este o fereastră personalizată. Află mai multe.",
	"menu.custom_screen_info.contents": "Conținutul acestei ferestre este controlat de servere și hărți terțe care nu sunt deținute, operate sau supravegheate de Mojang Studios sau Microsoft.\n\nAi grijă! Fii întotdeauna atent când accesezi linkuri și nu divulga niciodată informațiile personale, inclusiv datele de conectare.\n\nDacă această fereastră te împiedică să joci, te poți deconecta de la server utilizând butonul de mai jos.",
	"menu.custom_screen_info.disconnect": "Fereastră personalizată respinsă",
	"menu.custom_screen_info.title": "Note despre ferestrele personalizate",
	"menu.custom_screen_info.tooltip": "Aceasta este o fereastră personalizată. Apasă aici pentru a afla mai multe.",
	...
	"menu.multiplayerOptions.applyChanges": "Aplică modificările",
	"menu.multiplayerOptions.button": "Multiplayer...",
	"menu.multiplayerOptions.network": "Multiplayer",
	"menu.multiplayerOptions.network.header": "Rețea",
	"menu.multiplayerOptions.network.lan": "LAN",
	"menu.multiplayerOptions.network.lan.tooltip": "Prietenii din aceeași rețea se pot alătura.",
	"menu.multiplayerOptions.network.off": "DEZACTIVAT",
	"menu.multiplayerOptions.network.off.tooltip": "Nimeni nu se poate alătura.",
	"menu.multiplayerOptions.network.online": "Online",
	"menu.multiplayerOptions.network.online.tooltip": "Prietenii care sunt online se pot alătura.",
	"menu.multiplayerOptions.otherPlayers.header": "Alți jucători",
	"menu.multiplayerOptions.publish.started.lan": "Această lume este acum deschisă în LAN. Numărul portului este %s",
	"menu.multiplayerOptions.publish.started.online": "Această lume este acum deschisă pentru multiplayer.",
	"menu.multiplayerOptions.publish.stopped": "Această lume nu mai este deschisă pentru multiplayer",
	"menu.multiplayerOptions.title": "Setări multiplayer",
	...
	"menu.playerReporting.no_players": "Nu există jucători de raportat în această lume",
	"menu.preparingSpawn": "Se pregătește zona de început: %s%%",
	"menu.quick_actions": "Acțiuni rapide…",
	"menu.quick_actions.title": "Acțiuni rapide",
	"menu.quit": "Închide jocul",
	"menu.reportBugs": "Sesizează erori",
	...
	"menu.savingChunks": "Se salvează chunk-urile",
	...
	"multiplayer.codeOfConduct.check": "Nu mai notifica pentru acest cod de conduită",
	"multiplayer.codeOfConduct.title": "Codul de conduită al serverului",
	"multiplayer.confirm_command.parse_errors": "Ai încercat să execuți o comandă nerecunoscută sau nevalidă.\nEști sigur?\nComanda: %s",
	"multiplayer.confirm_command.permissions_required": "Încerci să execuți o comandă care necesită permisiuni ridicate.\nAcest lucru ar putea afecta negativ jocul tău.\nEști sigur?\nComanda: %s",
	"multiplayer.confirm_command.run_command": "Rulează comanda",
	"multiplayer.confirm_command.signature_required": "Încerci să execuți o comandă care va trimite un mesaj în chat utilizând numele tău.\nPoate fi rulată doar în ecranul chatului\nComanda: %s",
	"multiplayer.confirm_command.suggest_command": "Copiază în ecranul chatului",
	"multiplayer.confirm_command.title": "Confirmare execuție comandă",
	...
	"multiplayer.disconnect.banned.reason.default": "Ai fost interzis de un operator.",
	...
	"multiplayer.disconnect.code_of_conduct": "Serverul necesită acceptarea codului de conduită",
	"multiplayer.disconnect.configuration_error": "Eroare neașteptată în timpul configurării",
	"multiplayer.disconnect.duplicate_login": "Te-ai logat deja din alt loc",
	"multiplayer.disconnect.expired_public_key": "Cheie publică de profil expirată. Verifică dacă ora sistemului este sincronizată și încearcă să repornești jocul.",
	...
	"multiplayer.disconnect.invalid_public_key_signature.new": "Semnătură nevalidă pentru cheia publică de profil.\nÎncearcă să-ți restartezi jocul.",
	...
	"multiplayer.disconnect.missing_tags": "Set de etichete primite de la server incomplete. Te rugăm să contactezi operatorul de server.",
	...
	"multiplayer.disconnect.outdated_client": "Client incompatibil! Te rugăm să folosești %s",
	"multiplayer.disconnect.outdated_server": "Client incompatibil! Te rugăm să folosești %s",
	...
	"multiplayer.disconnect.unsigned_chat": "Primit pachet de chat fără semnătură sau cu semnătură nevalidă.",
	...
	"multiplayer.status.anonymous_player": "Jucător anonim",
	...
	"narration.button.usage.hovered": "Clic stânga pentru a activa",
	"narration.checkbox": "Casetă de bifat: %s",
	"narration.checkbox.usage.focused": "Apasă Enter pentru a comuta",
	"narration.checkbox.usage.focused.check": "Apasă Enter pentru a bifa",
	"narration.checkbox.usage.focused.uncheck": "Apasă Enter pentru a debifa",
	"narration.checkbox.usage.hovered": "Clic stânga pentru a comuta",
	"narration.checkbox.usage.hovered.check": "Clic stânga pentru a bifa",
	"narration.checkbox.usage.hovered.uncheck": "Clic stânga pentru a debifa",
	...
	"narration.cycle_button.usage.hovered": "Clic stânga pentru a schimba la %s",
	"narration.edit_box": "Editează căsuța: %s",
	"narration.item": "Obiect: %s",
	"narration.link.usage.focused": "Apasă Enter pentru a urma linkul",
	"narration.link.usage.hovered": "Clic stânga pentru a urma linkul",
	"narration.recipe": "Rețetă pentru %s",
	"narration.recipe.usage": "Clic stânga pentru a selecta",
	"narration.recipe.usage.more": "Clic dreapta pentru a afișa mai multe rețete",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Apasă Enter pentru a începe modificarea valorii glisorului",
	...
	"narration.suggestion.usage.fill.fixed": "Apasă Tab pentru a folosi sugestii",
	"narration.suggestion.usage.fill.hidable": "Apasă Tab pentru a folosi sugestii, sau Esc pentru a ieși din sugestii",
	"narration.tab_navigation.usage": "Apasă Ctrl și Tab pentru a schimba fila",
	...
	"narrator.position.list": "A fost selectat rândul %s din lista din %s",
	...
	"narrator.position.tab": "Fila selectată este %s din %s",
	...
	"optimizeWorld.info.converted": "Chunk-uri convertite: %s",
	"optimizeWorld.info.skipped": "Chunk-uri omise: %s",
	"optimizeWorld.info.total": "Chunk-uri totale: %s",
	"optimizeWorld.progress.counter": "%s / %s",
	"optimizeWorld.progress.percentage": "%s%%",
	"optimizeWorld.stage.counting": "Se numără chunk-urile…",
	"optimizeWorld.stage.failed": "Nu a reușit! :(",
	"optimizeWorld.stage.finished": "Se finalizează…",
	"optimizeWorld.stage.finished.chunks": "Se finalizează convertirea tuturor chunk-urilor…",
	...
	"optimizeWorld.stage.upgrading": "Se convertesc toate chunk-urile…",
	"optimizeWorld.stage.upgrading.chunks": "Se convertesc toate chunk-urile…",
	"optimizeWorld.stage.upgrading.entities": "Actualizarea tuturor entităților…",
	"optimizeWorld.stage.upgrading.poi": "Actualizarea tuturor punctele de interes…",
	...
	"options.accessibility.high_contrast.error.tooltip": "Pachetul de resurse cu contrast ridicat nu este disponibil.",
	"options.accessibility.high_contrast.tooltip": "Mărește contrastul dintre elementele interfeței.",
	...
	"options.accessibility.menu_background_blurriness": "Defocalizare fundal meniu",
	"options.accessibility.menu_background_blurriness.tooltip": "Schimbă focalizarea fundalului din meniu.",
	"options.accessibility.narrator_hotkey": "Scurtătură narator",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Permite naratorul să fie activat sau dezactivat cu „Cmd + B“.",
	"options.accessibility.narrator_hotkey.tooltip": "Permite naratorul să fie activat sau dezactivat cu „Cmd + B“.",
	...
	"options.accessibility.tooltip": "Setări de accesibilitate",
	"options.allowCursorChanges": "Permite modificarea cursorului",
	"options.allowCursorChanges.tooltip": "Permite cursorul mouse-ului să-și schimbe forma când este deasupra unor elemente ale interfeței.",
	"options.allowFriendRequests": "Permite cereri de prietenie",
	"options.allowFriendRequests.tooltip": "Permite altor jucători să-ți trimită cereri de prieteni",
	"options.allowServerListing": "Permite listele de server",
	"options.allowServerListing.tooltip": "Serverele pot lista jucători online ca parte a statutului lor public.\nCu această opțiune dezactivată, numele tău nu va apărea în astfel de liste.",
	"options.ao": "Lumină fină",
	"options.ao.max": "Maxim(ă)",
	...
	"options.blocks": "%s blocuri",
	"options.chat": "Setările chatului…",
	"options.chat.color": "Culori",
	"options.chat.delay": "Întârziere chat: %s secundă(e)",
	"options.chat.delay_none": "Întârziere în chat: Deloc",
	"options.chat.drafts": "Salvează mesajele netrimise",
	"options.chat.drafts.tooltip": "Mesajele netrimise vor fi salvate și vor putea fi transmise data viitoare când se deschide chatul.",
	...
	"options.chunkFade": "Durata de estompare a chunk-urilor",
	"options.chunkFade.none": "Estompare a chunk-urilor: Deloc",
	"options.chunkFade.seconds": "Estompare a chunk-urilor: %s secund(ă/e)",
	"options.chunkFade.tooltip": "Durata, în secunde, în care chunk-urile apar treptat atunci când sunt încărcate pentru prima dată.",
	"options.chunks": "%s chunk-uri",
	...
	"options.cutoutLeaves": "Frunze transparente",
	"options.cutoutLeaves.tooltip": "Permite vizualizarea prin golurile din frunze. Dezactivarea opțiunii poate îmbunătăți performanța.",
	...
	"options.difficulty.easy": "Ușoară",
	...
	"options.difficulty.hard": "Grea",
	"options.difficulty.hard.info": "Apar creaturi ostile și cauzează mai multe daune. Bara de foame se golește și scade toată viața.",
	"options.difficulty.hardcore": "Extremă",
	"options.difficulty.normal": "Normală",
	"options.difficulty.normal.info": "Apar creaturi ostile și cauzează daune standard. Bara de foame se golește și scade viața până la jumătate de inimă.",
	"options.difficulty.online": "Dificultatea serverului",
	"options.difficulty.peaceful": "Pașnică",
	...
	"options.entityDistanceScaling": "Distanța de afișare a entităților",
	"options.entityShadows": "Umbre de entități",
	"options.exclusiveFullscreen": "Ecran complet exclusiv",
	"options.exclusiveFullscreen.warningTooltip": "Această opțiune poate preveni niște metode de intrare din a funcționa.",
	...
	"options.friendsList": "Lista de prieteni",
	"options.friendsList.confirm.message": "Folosește lista de prieteni pentru a trimite și a primi cereri de prietenie.\n\nGestionează setările de siguranță online cu ajutorul %s.",
	"options.friendsList.confirm.message.link": "contului Microsoft",
	"options.friendsList.confirm.title": "Lista de prieteni",
	"options.friendsList.confirm.turnOff": "DEZACTIVEAZĂ",
	"options.friendsList.confirm.turnOn": "PORNEȘTE",
	...
	"options.glintSpeed": "Viteza sclipiri",
	"options.glintSpeed.tooltip": "Controlează cât de repede sclipește strălucirea vizuală pe obiectele fermecate.",
	"options.glintStrength": "Intensitatea sclipirii",
	"options.glintStrength.tooltip": "Controlează cât de transparentă este sclipirea vizuală pe obiectele fermecate.",
	"options.graphics": "Grafică",
	"options.graphics.custom": "Personalizat",
	...
	"options.graphics.preset": "Presetare",
	"options.graphics.preset.tooltip": "Setează setările „Calitate și performanță” la valori implicite rezonabile, corespunzătoare calității dorite.",
	...
	"options.graphics.warning.renderer": "Randări detectate: [%s]",
	...
	"options.graphicsApi": "API Grafice",
	"options.graphicsApi.default": "Implicit",
	"options.graphicsApi.opengl": "Prefer OpenGL",
	"options.graphicsApi.restart": "Trebuie să repornești jocul pentru a schimba API-ul grafic.",
	"options.graphicsApi.tooltip": "Ce API grafic se utilizează pentru randare. Lasă ca implicit, cu excepția cazului în care ai o nevoie specifică să schimbi setarea! Va lua efect după repornirea jocului.",
	"options.graphicsApi.tooltip.vulkan": "Experimental. Poate afecta negativ performanța jocului sau poate provoca instabilitate pe anumite sisteme.",
	...
	"options.hideLightningFlashes": "Ascundeți străfulgerările de lumină",
	"options.hideLightningFlashes.tooltip": "Împiedică fulgerele sau alte efecte de mediu să lumineze cerul. Sursele luminării vor fi vizibile în continuare.",
	"options.hideMatchedNames": "Ascunde după nume",
	"options.hideMatchedNames.tooltip": "Serverele terțe pot trimite mesaje de chat în formate nestandardizate.\nCu această opțiune activată, jucătorii ascunși vor fi potriviți în funcție de numele expeditorilor din chat.",
	"options.hideSplashTexts": "Ascunde textele inițiale",
	"options.hideSplashTexts.tooltip": "Ascunde textul inițial galben afișat în meniul principal.",
	"options.improvedTransparency": "Transparență îmbunătățită",
	"options.improvedTransparency.tooltip": "O abordare experimentală care folosește shadere de ecran pentru desenarea vremii, a norilor și a particulelor în spatele blocurilor translucide și a apei. Aceasta va afecta performanța GPU-ului.",
	"options.inGameNotification": "Notificări în joc",
	"options.inGameNotification.tooltip": "Afișează notificări legate de prietenii tăi în joc",
	"options.inactivityFpsLimit": "Reduce FPS-ul când",
	"options.inactivityFpsLimit.afk": "Inactiv",
	"options.inactivityFpsLimit.afk.tooltip": "Limitează frecvența cadrelor la 30 când jocul nu primește niciun input din partea jucătorului pentru mai mult de un minut. O limitează în continuare la 10 după încă 9 minute.",
	"options.inactivityFpsLimit.minimized": "Minimizat",
	"options.inactivityFpsLimit.minimized.tooltip": "Limitează frecvența cadrelor doar când fereastra jocului este minimizată.",
	"options.invertMouse": "Inversează mouse-ul",
	"options.invertMouseX": "Inversează mouse-ul X",
	"options.invertMouseY": "Inversează mouse-ul Y",
	...
	"options.language.narration": "Schimbă limba",
	"options.language.title": "Limbă",
	"options.language.tooltip": "Schimbă limba",
	"options.languageAccuracyWarning": "(Este posibil ca traducerile să nu fie 100%% corecte)",
	...
	"options.maxAnisotropy": "Filtrare anizotropă",
	"options.maxAnisotropy.tooltip": "Îmbunătățește semnificativ cât de netedă este o textură, dar afectează performanța și consumă multă memorie video. Este posibil să nu fie compatibilă cu toate plăcile video.",
	"options.mipmapLevels": "Niveluri de mipmap",
	"options.modelPart.cape": "Mantie",
	...
	"options.musicToast": "Panou informativ de melodie",
	"options.musicToast.never": "Niciodată",
	"options.musicToast.never.tooltip": "Niciun panou informativ de melodie nu este afișat.",
	"options.musicToast.pauseMenu": "Meniul de pauză",
	"options.musicToast.pauseMenu.tooltip": "Un panou informativ de melodie este afișat în meniul de pauză oricând o melodie este redată.",
	"options.musicToast.pauseMenuAndToast": "Meniul de pauză și panou informativ",
	"options.musicToast.pauseMenuAndToast.tooltip": "Afișează un panou informativ oricând o melodie începe să fie redată. Același panou este afișat constant în meniul de pauză al jocului în timpul redării unei melodii.",
	"options.music_frequency": "Frecvența muzicii",
	"options.music_frequency.constant": "Constant",
	"options.music_frequency.default": "Implicit",
	"options.music_frequency.frequent": "Frecvent",
	"options.music_frequency.tooltip": "Modifică frecvența cu care se redă muzica într-o lume de joc.",
	...
	"options.needsRestart": "Opțiunea va fi aplicată după repornire.",
	"options.notifications.display_time": "Durata notificărilor",
	"options.notifications.display_time.tooltip": "Modifică durata de afișare a notificărilor.",
	"options.off": "Nu",
	"options.off.composed": "%s: Nu",
	"options.on": "Da",
	"options.on.composed": "%s: Da",
	"options.online": "Online…",
	"options.online.friends.header": "Lista de prieteni",
	"options.online.realms.header": "Realms",
	"options.online.servers.header": "Servere",
	"options.online.title": "Opțiuni Online",
	"options.online.xboxSettings": "Setările profilului Xbox...",
	...
	"options.prioritizeChunkUpdates": "Actualizare chunk-uri",
	"options.prioritizeChunkUpdates.byPlayer": "La interacțiune",
	...
	"options.prioritizeChunkUpdates.nearby": "Pe rând",
	"options.prioritizeChunkUpdates.nearby.tooltip": "Chunk-urile alăturate vor fi actualizate imediat ce un bloc este plasat sau distrus. Poate afecta negativ performanța jocului.",
	"options.prioritizeChunkUpdates.none": "În paralel",
	"options.prioritizeChunkUpdates.none.tooltip": "Chunk-urile alăturate vor fi actualizate în paralel, pe fire CPU distincte. Poate cauza apariția unor goluri în pământ pentru câteva momente, la distrugerea sau plasarea blocurilor.",
	"options.rawMouseInput": "Intrare directă",
	"options.realmsNotifications": "Noutăți și invitații Realms",
	"options.realmsNotifications.button": "Știri și invitații",
	...
	"options.renderCloudsDistance": "Distanță nori",
	"options.renderDistance": "Distanță vizuală",
	"options.resourcepack": "Pachete de resurse…",
	"options.restartRequired": "Unele schimbări necesită o repornire a jocului.",
	...
	"options.screenEffectScale.tooltip": "Puterea grețurilor și efectele portalului Nether de deformare a ecranului.\nLa valori mai mici, efectul de greață este înlocuit cu o suprapunere verde.",
	"options.sensitivity": "Sensibilitate",
	"options.sensitivity.max": "VITEZĂ MAXIMĂ!!!",
	"options.sensitivity.min": "*căscat*",
	"options.sharePresence": "Prezență",
	"options.sharePresence.all": "Tuturor",
	"options.sharePresence.all.tooltip": "Prezența este împărtășită cu prietenii. Apari ca fiind online și împărtășești ce faci.",
	"options.sharePresence.limited": "Limitată",
	"options.sharePresence.limited.tooltip": "Prezență limitată. Apari ca fiind online, dar fără a împărtășii ce faci. Poți totuși să-ți inviți prietenii la joc.",
	"options.sharePresence.none": "Deloc",
	"options.sharePresence.none.tooltip": "Nu e împărtășită prezența. Apari ca fiind offline.",
	"options.showNowPlayingToast": "Panou informativ de melodie",
	"options.showNowPlayingToast.tooltip": "Afișează un panou informativ oricând o melodie începe să ruleze. Același panou este afișat constat în meniul de pauză al jocului în timpul rulării unei melodii.",
	"options.showSubtitles": "Subtitrări complexe",
	"options.showSubtitles.tooltip": "Activează subtitrări pentru sunetele care rulează în joc.",
	"options.simulationDistance": "Distanță de simulare",
	...
	"options.sprintWindow": "Interval de alergare",
	"options.sprintWindow.tooltip": "Intervalul de timp în ticuri în care apăsarea de două ori a tastei de mers în față activează alergarea.",
	...
	"options.telemetry.state.none": "Debifat",
	"options.textureFiltering": "Filtrarea texturilor",
	"options.textureFiltering.anisotropic": "Anizotropă",
	"options.textureFiltering.anisotropic.tooltip": "O metodă de filtrare bazată pe hardware, dar care afectează performanța și crește semnificativ utilizarea memoriei video. Este posibil să nu fie disponibilă pe toate dispozitivele hardware.",
	"options.textureFiltering.none": "Niciuna",
	"options.textureFiltering.none.tooltip": "Texturile sunt afișate fără nicio filtrare. Blocurile pot părea neclare când sunt vizualizate din unghi.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nO metodă de filtrare bazată pe shader care îmbunătățește calitatea texturii cu un impact moderat asupra performanței.",
	...
	"options.video.interface.header": "Interfață",
	"options.video.preferences.header": "Preferințe",
	"options.video.quality.header": "Calitate și performanță",
	"options.videoTitle": "Setări grafice",
	"options.viewBobbing": "Clătinarea privirii",
	"options.vignette": "Efect de vignetare",
	"options.vignette.tooltip": "Aceasta este o textură subtilă peste fereastra jocului, utilizată pentru a reduce luminozitatea spre marginile ecranului și pentru a avertiza asupra frontierei lumii.",
	"options.visible": "Vizibil",
	"options.vsync": "Sincronizare verticală",
	"options.weatherRadius": "Raza de efecte meteorologice",
	"options.weatherRadius.tooltip": "Raza zonei în care sunt vizibile efectele ploii și ale zăpezii. Impact foarte scăzut asupra performanței.",
	"options.worldOptions.button": "Opțiunile lumii...",
	"options.worldOptions.title": "Opțiunile lumii",
	"outOfMemory.message": "Minecraft a rămas fără memorie.\n\nAcest lucru poate fi cauzat de o eroare de logică sau de alocarea către Java a unei cantități insuficiente de memorie.\n\nPentru a evita eronarea lumilor, jocul a fost închis. Am încercat eliberarea memoriei pentru a permite revenirea la meniul principal și reluarea jocui, dar probabil asta nu a funcționat.\n\nDacă acest mesaj apare din nou, repornește jocul.",
	...
	"pack.incompatible.confirm.title": "Sigur vrei să încarci acest pachet?",
	"pack.incompatible.confirm.unknown": "Acest pachet este stricat sau a fost făcut pentru o versiune necunoscută de Minecraft și poate să nu mai funcționeze corect.",
	...
	"pack.incompatible.unknown": "(Stricat sau incompatibil)",
	...
	"painting.minecraft.skeleton.title": "Vremelnicea strânsoare",
	...
	"particle.invalidOptions": "Nu se poate analiza opțiunile de particule: %s",
	...
	"realms.configuration.region.australia_east": "Noua Galie de Sud, Australia",
	"realms.configuration.region.australia_southeast": "Victoria, Australia",
	"realms.configuration.region.brazil_south": "Brazilia",
	"realms.configuration.region.central_india": "India",
	"realms.configuration.region.central_us": "Iowa, SUA",
	"realms.configuration.region.east_asia": "Hong Kong",
	"realms.configuration.region.east_us": "Virginia, SUA",
	"realms.configuration.region.east_us_2": "Carolina de Nord, SUA",
	"realms.configuration.region.france_central": "Franța",
	"realms.configuration.region.japan_east": "Japonia de Est",
	"realms.configuration.region.japan_west": "Japonia de Vest",
	"realms.configuration.region.korea_central": "Coreea de Sud",
	"realms.configuration.region.north_central_us": "Illinois, SUA",
	"realms.configuration.region.north_europe": "Irlanda",
	"realms.configuration.region.south_central_us": "Texas, SUA",
	"realms.configuration.region.southeast_asia": "Singapore",
	"realms.configuration.region.sweden_central": "Suedia",
	"realms.configuration.region.uae_north": "Emiratele Arabe Unite (EAU)",
	"realms.configuration.region.uk_south": "Anglia de Sud",
	"realms.configuration.region.west_central_us": "Utah, SUA",
	"realms.configuration.region.west_europe": "Țările de Jos",
	"realms.configuration.region.west_us": "California, SUA",
	"realms.configuration.region.west_us_2": "Washington, SUA",
	"realms.configuration.region_preference.automatic_owner": "Automat (ping proprietar Realm)",
	"realms.configuration.region_preference.automatic_player": "Automat (primul care intră)",
	...
	"recipe.toast.title": "Rețet(ă/e) noi deblocate!",
	"record.nowPlaying": "Disc redat: %s",
	"recover_world.bug_tracker": "Sesizează o eroare",
	...
	"recover_world.message": "Următoarele probleme au apărut la încercarea de a citi dosarul mondial „%s”.\nEste posibil să restaurezi lumea dintr-o stare mai veche sau poți sesiza această problemă pe urmărirea problemelor.",
	"recover_world.no_fallback": "Nu este disponibilă nicio stare de restaurare",
	...
	"resourcePack.runtime_failure": "A fost detectat o eroare la pachetul de resurse",
	...
	"restrictions_screen.button": "Restricții...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Poți primi mesaje de la jucători",
	"restrictions_screen.permission.receive_player_messages.denied": "Nu poți primi mesaje de la jucători",
	"restrictions_screen.permission.receive_system_messages.allowed": "Poți primi mesaje de sistem de la server",
	"restrictions_screen.permission.receive_system_messages.denied": "Nu poți primi mesaje de sistem de la server",
	"restrictions_screen.permission.send_commands.allowed": "Poți trimite comenzi",
	"restrictions_screen.permission.send_commands.denied": "Nu poți trimite comenzi",
	"restrictions_screen.permission.send_messages.allowed": "Poți trimite mesaje în chat",
	"restrictions_screen.permission.send_messages.denied": "Nu poți trimite mesaje în chat",
	"restrictions_screen.title": "Restricții",
	...
	"selectServer.deleteWarning": "Lumea „%s” va fi pierdută pentru totdeauna! (Un timp foarte lung!)",
	...
	"selectWorld.backupJoinConfirmButton": "Creează un backup și încarc-ăl",
	...
	"selectWorld.backupQuestion.file_fixing_required": "Să se creeze un backup înainte să fie actualizată lumea?",
	...
	"selectWorld.backupWarning.file_fixing_required": "Această lume trebuie să fie actualizată înainte să te poți juca. Recomandăm crearea unui backup înainte să continui în caz de lumea se corupe.",
	"selectWorld.backupWarning.snapshot": "Această lume a fost jucată ultima dată în versiunea %s; sunteți în versiunea %s. Vă rugăm să faceți un backup în cazul în care vă confruntați cu corupții în lume.",
	...
	"selectWorld.deleteWarning": "Lumea „%s” va fi pierdută pentru totdeauna! (Un timp foarte lung!)",
	"selectWorld.delete_failure": "Lumea nu a putut fi ștearsă",
	"selectWorld.edit": "Modifică",
	"selectWorld.edit.backup": "Creează un backup",
	"selectWorld.edit.backupCreated": "S-a copiat: %s",
	"selectWorld.edit.backupFailed": "Backup eșuat",
	"selectWorld.edit.backupFolder": "Deschide dosarul cu backup-uri",
	...
	"selectWorld.experimental.title": "Avertisment despre funcțiile experimentale",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Această lume trebuie actualizată la cea mai recentă versiune înainte de a o putea edita, din cauza modificărilor subiacente aduse formatului lumii.",
	"selectWorld.requiresFileFixingTooltip.play": "Această lume trebuie actualizată la cea mai recentă versiune înainte de a o putea juca, din cauza modificărilor subiacente aduse formatului lumii.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Această lume trebuie actualizată la cea mai recentă versiune înainte de a o putea recrea, din cauza modificărilor subiacente aduse formatului lumii.",
	...
	"selectWorld.upgrade_and_play": "Actualizează și joacă",
	...
	"selectWorld.waitingForBackup.message": "În funcție de dimensiunea lumii tale, acest lucru poate dura ceva timp. Te rugăm să nu închizi jocul și să nu oprești dispozitivul.",
	"selectWorld.waitingForBackup.title": "Creând backup",
	...
	"selectWorld.world_gen_settings_access": "Nu se poate citi sau accesa fișierul cu setările de generare ale lumii! %s",
	"selecteWorld.backupRequiredTooltip": "Încărcarea lumii necesită crearea unui backup mai întâi",
	...
	"snbt.parser.expected_float_type": "Era prevăzut un număr cu virgulă mobilă",
	...
	"snbt.parser.expected_string_uuid": "Era aștept un string, reprezentând un UUID valid",
	...
	"snbt.parser.invalid_array_element_type": "Tip de element matrice nevalid",
	"snbt.parser.invalid_character_name": "Nume de caracter Unicode nevalid: %s",
	"snbt.parser.invalid_codepoint": "Valoare de caracter Unicode nevalidă: %s",
	"snbt.parser.invalid_string_contents": "Conținutul șirului este nevalid",
	...
	"soundCategory.hostile": "Creaturi ostile",
	"soundCategory.master": "Volum principal",
	"soundCategory.music": "Muzică",
	"soundCategory.neutral": "Creaturi prietenoase",
	"soundCategory.player": "Jucători",
	"soundCategory.record": "Discuri și note",
	"soundCategory.ui": "Interfață utilizator",
	"soundCategory.voice": "Narator/voce",
	...
	"stat.minecraft.mob_kills": "Creaturi omorâte",
	"stat.minecraft.nautilus_one_cm": "Distanță cu nautilul",
	...
	"stat_type.minecraft.killed.none": "Nu ai omorât niciodată un %s",
	"stat_type.minecraft.killed_by": "Te-a omorât de %s ori",
	...
	"structure_block.mode_info.save": "Modul de salvare — salvează în fișier",
	...
	"subtitles.block.amethyst_block.resonate": "Ametistul răsună",
	"subtitles.block.anvil.destroy": "Nicovala se distruge",
	"subtitles.block.anvil.land": "Nicovala aterizează",
	"subtitles.block.anvil.use": "Nicovala se folosește",
	"subtitles.block.barrel.close": "Butoiul se închide",
	"subtitles.block.barrel.open": "Butoiul se deschide",
	...
	"subtitles.block.beacon.power_select": "Puterea farului se selectează",
	"subtitles.block.beehive.drip": "Mierea picură",
	"subtitles.block.beehive.enter": "Albina intră în stup",
	"subtitles.block.beehive.exit": "Albina iese din stup",
	"subtitles.block.beehive.shear": "Foarfecile răzuiesc",
	"subtitles.block.beehive.work": "Albinele muncesc",
	"subtitles.block.bell.resonate": "Clopotul răsună",
	"subtitles.block.bell.use": "Clopotul sună",
	...
	"subtitles.block.blastfurnace.fire_crackle": "Furnalul trosnește",
	"subtitles.block.brewing_stand.brew": "Alambicul bulbucește",
	"subtitles.block.bubble_column.bubble_pop": "Bulele se sparg",
	"subtitles.block.bubble_column.upwards_ambient": "Bulele plutesc",
	"subtitles.block.bubble_column.upwards_inside": "Bulele vâjâie",
	"subtitles.block.bubble_column.whirlpool_ambient": "Bulele se învolbură",
	"subtitles.block.bubble_column.whirlpool_inside": "Bulele șuieră",
	"subtitles.block.button.click": "Butonul face clic",
	"subtitles.block.cake.add_candle": "Tortul se strivește",
	"subtitles.block.campfire.crackle": "Focul de tabără trosnește",
	"subtitles.block.candle.crackle": "Lumânarea trosnește",
	"subtitles.block.candle.extinguish": "Lumânarea se stinge",
	"subtitles.block.chest.close": "Cufărul se închide",
	"subtitles.block.chest.locked": "Cufărul se încuie",
	"subtitles.block.chest.open": "Cufărul se deschide",
	"subtitles.block.chorus_flower.death": "Floarea corală se ofilește",
	"subtitles.block.chorus_flower.grow": "Floarea corală crește",
	"subtitles.block.comparator.click": "Comparatorul face clic",
	"subtitles.block.composter.empty": "Compostorul se golește",
	"subtitles.block.composter.fill": "Compostorul se umple",
	"subtitles.block.composter.ready": "Compostorul compostează",
	"subtitles.block.conduit.activate": "Conducta se activează",
	"subtitles.block.conduit.ambient": "Conducta pulsează",
	"subtitles.block.conduit.attack.target": "Conducta atacă",
	"subtitles.block.conduit.deactivate": "Conducta se dezactivează",
	...
	"subtitles.block.copper_chest.close": "Cufărul se închide",
	"subtitles.block.copper_chest.open": "Cufărul se deschide",
	"subtitles.block.copper_trapdoor.close": "Trapa se închide",
	"subtitles.block.copper_trapdoor.open": "Trapa se deschide",
	...
	"subtitles.block.decorated_pot.insert": "Vasul decorat se umple",
	"subtitles.block.decorated_pot.insert_fail": "Vasul decorat se clatină",
	"subtitles.block.decorated_pot.shatter": "Vasul decorat se sparge",
	"subtitles.block.dispenser.dispense": "Obiectul se distribuie",
	"subtitles.block.dispenser.fail": "Distribuitorul eșuează",
	"subtitles.block.door.toggle": "Ușa scârțâie",
	"subtitles.block.dried_ghast.ambient": "Ghastul uscat respiră greu",
	"subtitles.block.dried_ghast.ambient_water": "Ghastul uscat se rehidratează",
	"subtitles.block.dried_ghast.place_in_water": "Ghastul uscat se înmuie",
	"subtitles.block.dried_ghast.transition": "Ghastul uscat se simte mai bine",
	"subtitles.block.dry_grass.ambient": "Sunete șuierătoare",
	"subtitles.block.enchantment_table.use": "Masa de farmece se folosește",
	"subtitles.block.end_portal.spawn": "Portalul spre End se deschide",
	"subtitles.block.end_portal_frame.fill": "Ochiul de Ender se atașează",
	"subtitles.block.eyeblossom.close": "Floarea-ochi se închide",
	"subtitles.block.eyeblossom.idle": "Floarea-ochi șoptește",
	"subtitles.block.eyeblossom.open": "Floarea-ochi se deschide",
	"subtitles.block.fence_gate.toggle": "Portița scârțâie",
	"subtitles.block.fire.ambient": "Focul trosnește",
	"subtitles.block.fire.extinguish": "Focul se stinge",
	"subtitles.block.firefly_bush.idle": "Licuricii bâzâie",
	"subtitles.block.frogspawn.hatch": "Mormolocul eclozează",
	"subtitles.block.furnace.fire_crackle": "Cuptorul trosnește",
	"subtitles.block.generic.break": "Blocul s-a spart",
	"subtitles.block.generic.fall": "Ceva cade pe un bloc",
	"subtitles.block.generic.footsteps": "Pași",
	"subtitles.block.generic.hit": "Blocul se sparge",
	"subtitles.block.generic.place": "Blocul se așează",
	"subtitles.block.grindstone.use": "Tocila se folosește",
	"subtitles.block.growing_plant.crop": "Planta se recoltează",
	...
	"subtitles.block.iron_trapdoor.close": "Trapa se închide",
	"subtitles.block.iron_trapdoor.open": "Trapa se deschide",
	"subtitles.block.lava.ambient": "Lava bulbucește",
	"subtitles.block.lava.extinguish": "Lava fâsâie",
	"subtitles.block.lever.click": "Maneta face clic",
	"subtitles.block.note_block.note": "Blocul muzical cântă",
	"subtitles.block.pale_hanging_moss.idle": "Sunet straniu",
	"subtitles.block.piston.move": "Pistonul se mișcă",
	...
	"subtitles.block.portal.ambient": "Sunet de portal",
	"subtitles.block.portal.travel": "Sunetul de portal se reduce",
	"subtitles.block.portal.trigger": "Sunetul de portal se intensifică",
	"subtitles.block.potent_sulfur.geyser_eruption": "Izvorul sulfuros erupe",
	"subtitles.block.potent_sulfur.noxious_gas": "Gazul nociv apare",
	"subtitles.block.pressure_plate.click": "Placa de presiune face clic",
	"subtitles.block.pumpkin.carve": "Foarfecile sculptează",
	"subtitles.block.redstone_torch.burnout": "Torța se stinge",
	"subtitles.block.respawn_anchor.ambient": "Ancora de reînviere șuieră",
	"subtitles.block.respawn_anchor.charge": "Ancora de reînviere se încarcă",
	"subtitles.block.respawn_anchor.deplete": "Ancora de reînviere se consumă",
	...
	"subtitles.block.shelf.activate": "Raft se activează",
	"subtitles.block.shelf.deactivate": "Raft se dezactivează",
	"subtitles.block.shelf.multi_swap": "Obiecte înlocuite",
	"subtitles.block.shelf.place_item": "Obiect așezat",
	"subtitles.block.shelf.single_swap": "Obiect înlocuit",
	"subtitles.block.shelf.take_item": "Obiect luat",
	"subtitles.block.shulker_box.close": "Cutia de shulker se închide",
	"subtitles.block.shulker_box.open": "Cutia de shulker se deschide",
	"subtitles.block.sign.waxed_interact_fail": "Semnul se clatină",
	"subtitles.block.smithing_table.use": "Masa de fierărie se folosește",
	"subtitles.block.smoker.smoke": "Afumătoarea afumă",
	"subtitles.block.sniffer_egg.crack": "Oul de adulmecător crapă",
	"subtitles.block.sniffer_egg.hatch": "Oul de adulmecător eclozează",
	"subtitles.block.sniffer_egg.plop": "Adulmecătorul face un ou",
	"subtitles.block.sponge.absorb": "Buretele absoarbe",
	"subtitles.block.sweet_berry_bush.pick_berries": "Fructele de pădure pocnesc",
	"subtitles.block.trapdoor.close": "Trapa se închide",
	"subtitles.block.trapdoor.open": "Trapa se deschide",
	"subtitles.block.trapdoor.toggle": "Trapa scârțâie",
	...
	"subtitles.block.trial_spawner.ambient_charged": "Trosnet de rău augur",
	...
	"subtitles.block.trial_spawner.eject_item": "Generatorul de încercări varsă obiecte",
	...
	"subtitles.block.trial_spawner.spawn_item_begin": "Obiectul de rău augur apare",
	"subtitles.block.trial_spawner.spawn_mob": "Generatorul de încercări creează o creatură",
	"subtitles.block.tripwire.attach": "Firul declanșator se atașează",
	"subtitles.block.tripwire.click": "Firul declanșator se activează",
	"subtitles.block.tripwire.detach": "Firul declanșator se detașează",
	...
	"subtitles.block.vault.eject_item": "Seiful ejectează un obiect",
	"subtitles.block.vault.insert_item": "Seiful se deblochează",
	"subtitles.block.vault.insert_item_fail": "Seiful respinge un obiect",
	"subtitles.block.vault.open_shutter": "Seiful se deschide",
	"subtitles.block.vault.reject_rewarded_player": "Seiful respinge jucătorul",
	"subtitles.block.water.ambient": "Apa curge",
	"subtitles.block.wet_sponge.dries": "Buretele se usucă",
	"subtitles.chiseled_bookshelf.insert": "Cartea se așează",
	"subtitles.chiseled_bookshelf.insert_enchanted": "Cartea fermecată se așează",
	"subtitles.chiseled_bookshelf.take": "Cartea este luată",
	"subtitles.chiseled_bookshelf.take_enchanted": "Cartea fermecată este luată",
	"subtitles.enchant.thorns.hit": "Spinii înțeapă",
	...
	"subtitles.entity.armadillo.ambient": "Tatuul mormăie",
	"subtitles.entity.armadillo.brush": "Solzul de tatu se perie",
	"subtitles.entity.armadillo.death": "Tatuul moare",
	"subtitles.entity.armadillo.eat": "Tatuul mănâncă",
	"subtitles.entity.armadillo.hurt": "Tatuul este rănit",
	"subtitles.entity.armadillo.hurt_reduced": "Tatuul se apără",
	"subtitles.entity.armadillo.land": "Tatuul aterizează",
	"subtitles.entity.armadillo.peek": "Tatuul pândește",
	"subtitles.entity.armadillo.roll": "Tatuul se încolăcește",
	"subtitles.entity.armadillo.scute_drop": "Tatuul năpârlește",
	"subtitles.entity.armadillo.unroll_finish": "Tatuul se descolăcește",
	"subtitles.entity.armadillo.unroll_start": "Tatuul pândește",
	"subtitles.entity.armor_stand.fall": "Ceva cade",
	"subtitles.entity.arrow.hit": "Săgeata nimerește",
	"subtitles.entity.arrow.hit_player": "Jucătorul este nimerit",
	"subtitles.entity.arrow.shoot": "Săgeata se trage",
	"subtitles.entity.axolotl.attack": "Axolotul atacă",
	"subtitles.entity.axolotl.death": "Axolotul moare",
	"subtitles.entity.axolotl.hurt": "Axolotul este rănit",
	"subtitles.entity.axolotl.idle_air": "Axolotul ciripește",
	"subtitles.entity.axolotl.idle_water": "Axolotul ciripește",
	"subtitles.entity.axolotl.splash": "Axolotul stropește",
	"subtitles.entity.axolotl.swim": "Axolotul înoată",
	"subtitles.entity.baby_cat.ambient": "Pisicuța miaună",
	"subtitles.entity.baby_cat.beg_for_food": "Pisicuța cere mâncare",
	"subtitles.entity.baby_cat.death": "Pisicuța moare",
	"subtitles.entity.baby_cat.eat": "Pisicuța mănâncă",
	"subtitles.entity.baby_cat.hiss": "Pisicuța sâsâie",
	"subtitles.entity.baby_cat.hurt": "Pisicuța este rănită",
	"subtitles.entity.baby_cat.purr": "Pisicuța toarce",
	"subtitles.entity.baby_chicken.ambient": "Puiul piscuie",
	"subtitles.entity.baby_chicken.death": "Puiul moare",
	"subtitles.entity.baby_chicken.hurts": "Puiul este rănit",
	"subtitles.entity.baby_horse.ambient": "Mânzul nechează",
	"subtitles.entity.baby_horse.angry": "Mânzul nechează",
	"subtitles.entity.baby_horse.breathe": "Mânzul respiră",
	"subtitles.entity.baby_horse.death": "Mânzul moare",
	"subtitles.entity.baby_horse.eat": "Mânzul mănâncă",
	"subtitles.entity.baby_horse.hurt": "Mânzul este rănit",
	"subtitles.entity.baby_horse.land": "Mânzul aterizează",
	"subtitles.entity.baby_nautilus.ambient": "Puiul de nautil ciripește",
	"subtitles.entity.baby_nautilus.ambient_land": "Puiul de nautil ciripește",
	"subtitles.entity.baby_nautilus.death": "Puiul de nautil moare",
	"subtitles.entity.baby_nautilus.death_land": "Puiul de nautil moare",
	"subtitles.entity.baby_nautilus.eat": "Puiul de nautil mănâncă",
	"subtitles.entity.baby_nautilus.hurt": "Puiul de nautil este rănit",
	"subtitles.entity.baby_nautilus.hurt_land": "Puiul de nautil este rănit",
	"subtitles.entity.baby_nautilus.swim": "Puiul de nautil înoată",
	"subtitles.entity.baby_pig.ambient": "Purcelușul guiță",
	"subtitles.entity.baby_pig.death": "Purcelușul moare",
	"subtitles.entity.baby_pig.eat": "Purcelușul mănâncă",
	"subtitles.entity.baby_pig.hurt": "Purcelușul este rănit",
	"subtitles.entity.baby_wolf.ambient": "Lupușorul schelălăie",
	"subtitles.entity.baby_wolf.death": "Lupușorul moare",
	"subtitles.entity.baby_wolf.growl": "Lupușorul moare",
	"subtitles.entity.baby_wolf.hurt": "Lupușorul este rănit",
	"subtitles.entity.baby_wolf.pant": "Lupușorul gâfâie",
	"subtitles.entity.baby_wolf.whine": "Lupușorul se scheaună",
	"subtitles.entity.bat.ambient": "Liliacul țipă",
	"subtitles.entity.bat.death": "Liliacul moare",
	"subtitles.entity.bat.hurt": "Liliacul este rănit",
	"subtitles.entity.bat.takeoff": "Liliacul își ia zborul",
	"subtitles.entity.bee.ambient": "Albina bâzâie",
	"subtitles.entity.bee.death": "Albina moare",
	"subtitles.entity.bee.hurt": "Albina este rănită",
	"subtitles.entity.bee.loop": "Albina bâzâie",
	"subtitles.entity.bee.loop_aggressive": "Albina bâzâie furios",
	"subtitles.entity.bee.pollinate": "Albina bâzâie fericit",
	"subtitles.entity.bee.sting": "Albina înțeapă",
	"subtitles.entity.blaze.ambient": "Dogoreala respiră",
	"subtitles.entity.blaze.burn": "Dogoreala trosnește",
	"subtitles.entity.blaze.death": "Dogoreala moare",
	"subtitles.entity.blaze.hurt": "Dogoreala este rănită",
	"subtitles.entity.blaze.shoot": "Dogoreala trage",
	"subtitles.entity.boat.paddle_land": "Vâslit",
	"subtitles.entity.boat.paddle_water": "Vâslit",
	"subtitles.entity.bogged.ambient": "Împotmolitul zornăie",
	"subtitles.entity.bogged.death": "Împotmolitul moare",
	"subtitles.entity.bogged.hurt": "Împotmolitul este rănit",
	"subtitles.entity.breeze.charge": "Briza se pregătește",
	"subtitles.entity.breeze.death": "Briza moare",
	"subtitles.entity.breeze.deflect": "Briză ricoșează",
	"subtitles.entity.breeze.hurt": "Briza este rănită",
	"subtitles.entity.breeze.idle_air": "Briza zboară",
	"subtitles.entity.breeze.idle_ground": "Briza vâjâie",
	"subtitles.entity.breeze.inhale": "Briza inspiră",
	"subtitles.entity.breeze.jump": "Briza sare",
	"subtitles.entity.breeze.land": "Briza aterizează",
	"subtitles.entity.breeze.shoot": "Briza trage",
	"subtitles.entity.breeze.slide": "Briza alunecă",
	"subtitles.entity.breeze.whirl": "Briza vâjâie",
	"subtitles.entity.breeze.wind_burst": "Mingea de vânt explodează",
	...
	"subtitles.entity.camel.hurt": "Cămila este rănită",
	"subtitles.entity.camel.saddle": "Șaua se echipează",
	"subtitles.entity.camel.sit": "Cămila se așează",
	"subtitles.entity.camel.stand": "Cămila se ridică",
	"subtitles.entity.camel.step": "Cămila pășește",
	"subtitles.entity.camel.step_sand": "Cămila pășește pe nisip",
	"subtitles.entity.camel_husk.ambient": "Cămila-momâie mârâie",
	"subtitles.entity.camel_husk.dash": "Cămila-momâie se lansează",
	"subtitles.entity.camel_husk.dash_ready": "Cămila-momâie își revine",
	"subtitles.entity.camel_husk.death": "Cămila-momâie moare",
	"subtitles.entity.camel_husk.eat": "Cămila-momâie mănâncă",
	"subtitles.entity.camel_husk.hurt": "Cămila-momâie este rănită",
	"subtitles.entity.camel_husk.saddle": "Șaua se echipează",
	"subtitles.entity.camel_husk.sit": "Cămila-momâie se așează",
	"subtitles.entity.camel_husk.stand": "Cămila-momâie se ridică",
	"subtitles.entity.cat.ambient": "Pisica miaună",
	"subtitles.entity.cat.beg_for_food": "Pisica cere mâncare",
	"subtitles.entity.cat.death": "Pisica moare",
	"subtitles.entity.cat.eat": "Pisica mănâncă",
	"subtitles.entity.cat.hiss": "Pisica sâsâie",
	"subtitles.entity.cat.hurt": "Pisica este rănită",
	"subtitles.entity.cat.purr": "Pisica toarce",
	"subtitles.entity.chicken.ambient": "Găina cotcodăcește",
	"subtitles.entity.chicken.death": "Găina moare",
	"subtitles.entity.chicken.egg": "Găina face un ou",
	"subtitles.entity.chicken.hurt": "Găina este rănită",
	"subtitles.entity.cod.death": "Codul moare",
	"subtitles.entity.cod.flop": "Codul se zbate",
	"subtitles.entity.cod.hurt": "Codul este rănit",
	"subtitles.entity.copper_golem.death": "Golem de cupru moare",
	"subtitles.entity.copper_golem.hurt": "Golemul de cupru este rănit",
	"subtitles.entity.copper_golem.item_drop": "Golemul de cupru introduce un obiect",
	"subtitles.entity.copper_golem.item_no_drop": "Golemul de cupru nu poate introduce un obiect",
	"subtitles.entity.copper_golem.no_item_get": "Golemul de cupru ia un obiect",
	"subtitles.entity.copper_golem.no_item_no_get": "Golemul de cupru nu poate lua un obiect",
	"subtitles.entity.copper_golem.spawn": "Golemul de cupru apare",
	"subtitles.entity.copper_golem.spin": "Capul golemului de cupru se învârte",
	"subtitles.entity.copper_golem_become_statue": "Golem de cupru se pietrifică",
	"subtitles.entity.copper_golem_oxidized.death": "Golem de cupru moare",
	"subtitles.entity.copper_golem_oxidized.hurt": "Golemul de cupru este rănit",
	"subtitles.entity.copper_golem_oxidized.spin": "Capul golemului de cupru se învârte",
	"subtitles.entity.copper_golem_weathered.death": "Golemul de cupru moare",
	"subtitles.entity.copper_golem_weathered.hurt": "Golemul de cupru este rănit",
	"subtitles.entity.copper_golem_weathered.spin": "Capul golemului de cupru se învârte",
	"subtitles.entity.cow.ambient": "Vaca mugește",
	"subtitles.entity.cow.death": "Vaca moare",
	"subtitles.entity.cow.hurt": "Vaca este rănită",
	"subtitles.entity.cow.milk": "Vaca este mulsă",
	...
	"subtitles.entity.creaking.death": "Scârțâitorul se destramă",
	"subtitles.entity.creaking.freeze": "Scârțâitorul se oprește",
	"subtitles.entity.creaking.spawn": "Scârțâitorul trăiește",
	"subtitles.entity.creaking.sway": "Scârțâitorul este nimerit",
	"subtitles.entity.creaking.twitch": "Scârțâitorul tremură",
	"subtitles.entity.creaking.unfreeze": "Scârțâitorul se mișcă",
	"subtitles.entity.creeper.death": "Creeperul moare",
	"subtitles.entity.creeper.hurt": "Creeperul este rănit",
	"subtitles.entity.creeper.primed": "Creeperul fâsâie",
	"subtitles.entity.dolphin.ambient": "Delfinul țârâie",
	"subtitles.entity.dolphin.ambient_water": "Delfinul fluieră",
	"subtitles.entity.dolphin.attack": "Delfinul atacă",
	"subtitles.entity.dolphin.death": "Delfinul moare",
	"subtitles.entity.dolphin.eat": "Delfinul mânâncă",
	"subtitles.entity.dolphin.hurt": "Delfinul este rănit",
	"subtitles.entity.dolphin.jump": "Delfinul sare",
	"subtitles.entity.dolphin.play": "Delfinul se joacă",
	"subtitles.entity.dolphin.splash": "Delfinul împroașcă",
	"subtitles.entity.dolphin.swim": "Delfinul înoată",
	"subtitles.entity.donkey.ambient": "Măgarul rage",
	"subtitles.entity.donkey.angry": "Măgarul nechează",
	"subtitles.entity.donkey.chest": "Cufărul se echipează pe măgar",
	"subtitles.entity.donkey.death": "Măgarul moare",
	"subtitles.entity.donkey.eat": "Măgarul mănâncă",
	"subtitles.entity.donkey.hurt": "Măgarul este rănit",
	"subtitles.entity.donkey.jump": "Măgarul sare",
	"subtitles.entity.drowned.ambient": "Înecatul gâlgâie",
	"subtitles.entity.drowned.ambient_water": "Înecatul gâlgâie",
	"subtitles.entity.drowned.death": "Înecatul moare",
	"subtitles.entity.drowned.hurt": "Înecatul este rănit",
	"subtitles.entity.drowned.shoot": "Înecatul aruncă un trident",
	"subtitles.entity.drowned.step": "Înecatul pășește",
	"subtitles.entity.drowned.swim": "Înecatul înoată",
	"subtitles.entity.egg.throw": "Oul zboară",
	"subtitles.entity.elder_guardian.ambient": "Marele străjer geme",
	"subtitles.entity.elder_guardian.ambient_land": "Marele străjer țiuie",
	"subtitles.entity.elder_guardian.curse": "Marele străjer blestemă",
	"subtitles.entity.elder_guardian.death": "Marele străjer moare",
	"subtitles.entity.elder_guardian.flop": "Marele străjer se zbate",
	"subtitles.entity.elder_guardian.hurt": "Marele străjer este rănit",
	"subtitles.entity.ender_dragon.ambient": "Dragonul rage",
	"subtitles.entity.ender_dragon.death": "Dragonul moare",
	"subtitles.entity.ender_dragon.flap": "Dragonul bate din aripi",
	"subtitles.entity.ender_dragon.growl": "Dragonul mârâie",
	"subtitles.entity.ender_dragon.hurt": "Dragonul este rănit",
	"subtitles.entity.ender_dragon.shoot": "Dragonul trage",
	"subtitles.entity.ender_eye.death": "Ochiul de Ender cade",
	"subtitles.entity.ender_eye.launch": "Ochiul de Ender este aruncat",
	"subtitles.entity.ender_pearl.throw": "Perla de Ender zboară",
	"subtitles.entity.enderman.ambient": "Endermanul vociferează",
	"subtitles.entity.enderman.death": "Endermanul moare",
	"subtitles.entity.enderman.hurt": "Endermanul este rănit",
	"subtitles.entity.enderman.scream": "Endermanul țipă",
	"subtitles.entity.enderman.stare": "Endermanul urlă",
	"subtitles.entity.enderman.teleport": "Endermanul se teleportează",
	"subtitles.entity.endermite.ambient": "Endermitul sâsâie",
	"subtitles.entity.endermite.death": "Endermitul moare",
	"subtitles.entity.endermite.hurt": "Endermitul este rănit",
	"subtitles.entity.evoker.ambient": "Evocatorul murmură",
	"subtitles.entity.evoker.cast_spell": "Evocatorul vrăjește",
	"subtitles.entity.evoker.celebrate": "Evocatorul se bucură",
	"subtitles.entity.evoker.death": "Evocatorul moare",
	"subtitles.entity.evoker.hurt": "Evocatorul este rănit",
	"subtitles.entity.evoker.prepare_attack": "Evocatorul se pregătește de atac",
	"subtitles.entity.evoker.prepare_summon": "Evocatorul se pregătește de invocare",
	"subtitles.entity.evoker.prepare_wololo": "Evocatorul se pregătește de descântec",
	"subtitles.entity.evoker_fangs.attack": "Colții mușcă",
	"subtitles.entity.experience_orb.pickup": "Experiența este luată",
	"subtitles.entity.firework_rocket.blast": "Artificiile explodează",
	"subtitles.entity.firework_rocket.launch": "Artificiile se lansează",
	"subtitles.entity.firework_rocket.twinkle": "Artificiile pârâie",
	"subtitles.entity.fish.swim": "Pleoscăituri",
	"subtitles.entity.fishing_bobber.retrieve": "Pluta este recăpătată",
	"subtitles.entity.fishing_bobber.splash": "Pluta pleoscăie",
	"subtitles.entity.fishing_bobber.throw": "Pluta este aruncată",
	"subtitles.entity.fox.aggro": "Vulpea se înfurie",
	"subtitles.entity.fox.ambient": "Vulpea chițăie",
	"subtitles.entity.fox.bite": "Vulpea mușcă",
	"subtitles.entity.fox.death": "Vulpea moare",
	"subtitles.entity.fox.eat": "Vulpea mănâncă",
	"subtitles.entity.fox.hurt": "Vulpea este rănită",
	"subtitles.entity.fox.screech": "Vulpea țipă",
	"subtitles.entity.fox.sleep": "Vulpea sforăie",
	"subtitles.entity.fox.sniff": "Vulpea adulmecă",
	"subtitles.entity.fox.spit": "Vulpea scuipă",
	"subtitles.entity.fox.teleport": "Vulpea se teleportează",
	...
	"subtitles.entity.generic.big_fall": "Ceva cade",
	"subtitles.entity.generic.burn": "Ceva arde",
	"subtitles.entity.generic.death": "Ceva moare",
	"subtitles.entity.generic.drink": "Sorbit",
	"subtitles.entity.generic.eat": "Mâncat",
	"subtitles.entity.generic.explode": "Explozie",
	"subtitles.entity.generic.extinguish_fire": "Focul se stinge",
	"subtitles.entity.generic.hurt": "Ceva este rănit",
	"subtitles.entity.generic.small_fall": "Ceva se împiedică",
	"subtitles.entity.generic.splash": "Ceva pleoscăie",
	"subtitles.entity.generic.swim": "Înotat",
	"subtitles.entity.generic.wind_burst": "Mingea de vânt explodează",
	"subtitles.entity.ghast.ambient": "Ghastul plânge",
	"subtitles.entity.ghast.death": "Ghastul moare",
	"subtitles.entity.ghast.hurt": "Ghastul este rănit",
	"subtitles.entity.ghast.shoot": "Ghastul trage",
	"subtitles.entity.ghastling.ambient": "Ghastulețul gângurește",
	"subtitles.entity.ghastling.death": "Ghastulețul moare",
	"subtitles.entity.ghastling.hurt": "Ghastulețul este rănit",
	"subtitles.entity.ghastling.spawn": "Ghastulețul apare",
	...
	"subtitles.entity.glow_squid.ambient": "Calamarul strălucitor înoată",
	"subtitles.entity.glow_squid.death": "Calamarul strălucitor moare",
	"subtitles.entity.glow_squid.hurt": "Calamarul strălucitor este rănit",
	"subtitles.entity.glow_squid.squirt": "Calamarul strălucitor împroșcă cerneală",
	...
	"subtitles.entity.goat.hurt": "Capra este rănită",
	...
	"subtitles.entity.guardian.ambient": "Străjerul geme",
	"subtitles.entity.guardian.ambient_land": "Străjerul țiuie",
	"subtitles.entity.guardian.attack": "Străjerul trage",
	"subtitles.entity.guardian.death": "Străjerul moare",
	"subtitles.entity.guardian.flop": "Străjerul se zbate",
	"subtitles.entity.guardian.hurt": "Străjerul este rănit",
	"subtitles.entity.happy_ghast.ambient": "Ghastul fericit fredonează",
	"subtitles.entity.happy_ghast.death": "Ghastul fericit moare",
	"subtitles.entity.happy_ghast.equip": "Hamul se echipează",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Ghastul fericit este gata",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Ghastul fericit se oprește",
	"subtitles.entity.happy_ghast.hurt": "Ghastul fericit este rănit",
	"subtitles.entity.happy_ghast.unequip": "Hamul se dezechipează",
	"subtitles.entity.hoglin.ambient": "Hoglinul mârâie",
	"subtitles.entity.hoglin.angry": "Hoglinul mârâie furios",
	"subtitles.entity.hoglin.attack": "Hoglinul atacă",
	"subtitles.entity.hoglin.converted_to_zombified": "Hoglinul se convertește în zoglin",
	"subtitles.entity.hoglin.death": "Hoglinul moare",
	"subtitles.entity.hoglin.hurt": "Hoglinul este rănit",
	"subtitles.entity.hoglin.retreat": "Hoglinul se retrage",
	"subtitles.entity.hoglin.step": "Hoglinul pășește",
	"subtitles.entity.horse.ambient": "Calul nechează",
	"subtitles.entity.horse.angry": "Calul nechează",
	"subtitles.entity.horse.armor": "Armura de cal se echipează",
	"subtitles.entity.horse.breathe": "Calul respiră",
	"subtitles.entity.horse.death": "Calul moare",
	"subtitles.entity.horse.eat": "Calul mănâncă",
	"subtitles.entity.horse.gallop": "Calul galopează",
	"subtitles.entity.horse.hurt": "Calul este rănit",
	"subtitles.entity.horse.jump": "Calul sare",
	"subtitles.entity.horse.saddle": "Șaua se echipează",
	"subtitles.entity.husk.ambient": "Momâia geme",
	"subtitles.entity.husk.converted_to_zombie": "Momâia se convertește zombi",
	"subtitles.entity.husk.death": "Momâia moare",
	"subtitles.entity.husk.hurt": "Momâia este rănită",
	"subtitles.entity.illusioner.ambient": "Iluzionistul murmură",
	"subtitles.entity.illusioner.cast_spell": "Iluzionistul vrăjește",
	"subtitles.entity.illusioner.death": "Iluzionistul moare",
	"subtitles.entity.illusioner.hurt": "Iluzionistul este rănit",
	"subtitles.entity.illusioner.mirror_move": "Iluzionistul se împarte",
	"subtitles.entity.illusioner.prepare_blindness": "Iluzionistul pregătește orbirea",
	"subtitles.entity.illusioner.prepare_mirror": "Iluzionistul pregătește reflexiile",
	"subtitles.entity.iron_golem.attack": "Golemul de fier atacă",
	"subtitles.entity.iron_golem.damage": "Golemul de fier se strică",
	"subtitles.entity.iron_golem.death": "Golemul de fier moare",
	"subtitles.entity.iron_golem.hurt": "Golemul de fier este rănit",
	"subtitles.entity.iron_golem.repair": "Golemul de fier se repară",
	"subtitles.entity.item.break": "Obiectul se strică",
	"subtitles.entity.item.pickup": "Obiectul este luat",
	"subtitles.entity.item_frame.add_item": "Rama de obiect se umple",
	"subtitles.entity.item_frame.break": "Rama de obiect se distruge",
	"subtitles.entity.item_frame.place": "Rama de obiect se așează",
	"subtitles.entity.item_frame.remove_item": "Rama de obiect se golește",
	"subtitles.entity.item_frame.rotate_item": "Obiectul se rotește în ramă",
	"subtitles.entity.leash_knot.break": "Nodul de lesă se rupe",
	"subtitles.entity.leash_knot.place": "Nodul de lesă se leagă",
	"subtitles.entity.lightning_bolt.impact": "Trăsnetul lovește",
	"subtitles.entity.lightning_bolt.thunder": "Tunete",
	"subtitles.entity.llama.ambient": "Lama behăie",
	"subtitles.entity.llama.angry": "Lama behăie furios",
	"subtitles.entity.llama.chest": "Cufărul se echipează pe lamă",
	"subtitles.entity.llama.death": "Lama moare",
	"subtitles.entity.llama.eat": "Lama mănâncă",
	"subtitles.entity.llama.hurt": "Lama este rănită",
	"subtitles.entity.llama.spit": "Lama scuipă",
	"subtitles.entity.llama.step": "Lama pășește",
	"subtitles.entity.llama.swag": "Lama se decorează",
	"subtitles.entity.magma_cube.death": "Cubul de magmă moare",
	"subtitles.entity.magma_cube.hurt": "Cubul de magmă este rănit",
	"subtitles.entity.magma_cube.squish": "Cubul de magmă lipăie",
	"subtitles.entity.minecart.inside": "Vagonet zornăie",
	"subtitles.entity.minecart.inside_underwater": "Vagonet zornăie sub apă",
	"subtitles.entity.minecart.riding": "Vagonetul merge",
	"subtitles.entity.mooshroom.convert": "Mooshroomul se transformă",
	"subtitles.entity.mooshroom.eat": "Mooshroomul mănâncă",
	"subtitles.entity.mooshroom.milk": "Mooshroomul este muls",
	"subtitles.entity.mooshroom.suspicious_milk": "Mooshroomul este muls suspect",
	"subtitles.entity.mule.ambient": "Catârul rage",
	"subtitles.entity.mule.angry": "Catârul nechează",
	"subtitles.entity.mule.chest": "Cufărul se echipează pe catâr",
	"subtitles.entity.mule.death": "Catârul moare",
	"subtitles.entity.mule.eat": "Catârul mănâncă",
	"subtitles.entity.mule.hurt": "Catârul este rănit",
	"subtitles.entity.mule.jump": "Catârul sare",
	"subtitles.entity.nautilus.ambient": "Nautilul pocnește",
	"subtitles.entity.nautilus.ambient_land": "Nautilul pocnește",
	"subtitles.entity.nautilus.dash": "Nautilul se propulsează",
	"subtitles.entity.nautilus.dash_land": "Nautilul se propulsează",
	"subtitles.entity.nautilus.dash_ready": "Nautilul își revine",
	"subtitles.entity.nautilus.dash_ready_land": "Nautilul își revine",
	"subtitles.entity.nautilus.death": "Nautilul moare",
	"subtitles.entity.nautilus.death_land": "Nautilul moare",
	"subtitles.entity.nautilus.eat": "Nautilul mănâncă",
	"subtitles.entity.nautilus.hurt": "Nautilul este rănit",
	"subtitles.entity.nautilus.hurt_land": "Nautilul este rănit",
	"subtitles.entity.nautilus.swim": "Nautilul înoată",
	"subtitles.entity.painting.break": "Pictura se distruge",
	"subtitles.entity.painting.place": "Pictura se așează",
	"subtitles.entity.panda.aggressive_ambient": "Pandaul pufăie",
	"subtitles.entity.panda.ambient": "Pandaul gâfâie",
	"subtitles.entity.panda.bite": "Pandaul mușcă",
	"subtitles.entity.panda.cant_breed": "Pandaul geme",
	"subtitles.entity.panda.death": "Pandaul moare",
	"subtitles.entity.panda.eat": "Pandaul mănâncă",
	"subtitles.entity.panda.hurt": "Pandaul este rănit",
	"subtitles.entity.panda.pre_sneeze": "Pandaul simte nevoia să strănute",
	"subtitles.entity.panda.sneeze": "Pandaul strănută",
	"subtitles.entity.panda.step": "Pandaul pășește",
	"subtitles.entity.panda.worried_ambient": "Pandaul scâncește",
	"subtitles.entity.parched.ambient": "Uscatul zornăie",
	"subtitles.entity.parched.death": "Uscatul moare",
	"subtitles.entity.parched.hurt": "Uscatul este rănit",
	"subtitles.entity.parrot.ambient": "Papagalul vorbește",
	"subtitles.entity.parrot.death": "Papagalul moare",
	"subtitles.entity.parrot.eats": "Papagalul mănâncă",
	"subtitles.entity.parrot.fly": "Papagalul flutură din aripi",
	"subtitles.entity.parrot.hurts": "Papagalul este rănit",
	"subtitles.entity.parrot.imitate.blaze": "Papagalul imită o dogoreală",
	"subtitles.entity.parrot.imitate.bogged": "Papagalul imită un împotmolit",
	"subtitles.entity.parrot.imitate.breeze": "Papagalul imită o briză",
	"subtitles.entity.parrot.imitate.camel_husk": "Papagalul imită o cămilă-momâie",
	"subtitles.entity.parrot.imitate.creaking": "Papagalul imită un scârțâitor",
	"subtitles.entity.parrot.imitate.creeper": "Papagalul imită un creeper",
	"subtitles.entity.parrot.imitate.drowned": "Papagalul imită un înecat",
	"subtitles.entity.parrot.imitate.elder_guardian": "Papagalul imită un mare străjer",
	"subtitles.entity.parrot.imitate.ender_dragon": "Papagalul imită dragonul de Ender",
	"subtitles.entity.parrot.imitate.endermite": "Papagalul imită un endermit",
	"subtitles.entity.parrot.imitate.evoker": "Papagalul imită un evocator",
	"subtitles.entity.parrot.imitate.ghast": "Papagalul imită un ghast",
	"subtitles.entity.parrot.imitate.guardian": "Papagalul imită un străjer",
	"subtitles.entity.parrot.imitate.hoglin": "Papagalul imită un hoglin",
	"subtitles.entity.parrot.imitate.husk": "Papagalul imită o momâie",
	"subtitles.entity.parrot.imitate.illusioner": "Papagalul imită un iluzionist",
	"subtitles.entity.parrot.imitate.magma_cube": "Papagalul imită un cub de magmă",
	"subtitles.entity.parrot.imitate.parched": "Papagul imită un uscat",
	"subtitles.entity.parrot.imitate.phantom": "Papagalul imită o fantasmă",
	"subtitles.entity.parrot.imitate.piglin": "Papagalul imită un piglin",
	"subtitles.entity.parrot.imitate.piglin_brute": "Papagalul imită un piglin brutal",
	"subtitles.entity.parrot.imitate.pillager": "Papagalul imită un jefuitor",
	"subtitles.entity.parrot.imitate.ravager": "Papagalul imită un distrugător",
	"subtitles.entity.parrot.imitate.shulker": "Papagalul imită un shulker",
	"subtitles.entity.parrot.imitate.silverfish": "Papagalul imită un peștișor argintiu",
	"subtitles.entity.parrot.imitate.skeleton": "Papagalul imită un schelet",
	"subtitles.entity.parrot.imitate.slime": "Papagalul imită o mâzgă",
	"subtitles.entity.parrot.imitate.spider": "Papagalul imită un păianjen",
	"subtitles.entity.parrot.imitate.stray": "Papagalul imită un hoinar",
	"subtitles.entity.parrot.imitate.vex": "Papagalul imită un spirit",
	"subtitles.entity.parrot.imitate.vindicator": "Papagalul imită un apărător",
	"subtitles.entity.parrot.imitate.warden": "Papagalul imită un gardian",
	"subtitles.entity.parrot.imitate.witch": "Papagalul imită o vrăjitoare",
	"subtitles.entity.parrot.imitate.wither": "Papagalul imită un wither",
	"subtitles.entity.parrot.imitate.wither_skeleton": "Papagalul imită un schelet wither",
	"subtitles.entity.parrot.imitate.zoglin": "Papagalul imită un zoglin",
	"subtitles.entity.parrot.imitate.zombie": "Papagalul imită un zombi",
	"subtitles.entity.parrot.imitate.zombie_horse": "Papagalul imită un cal-zombi",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Papagalul imită un nautil-zombi",
	"subtitles.entity.parrot.imitate.zombie_villager": "Papagalul imită un sătean-zombi",
	"subtitles.entity.phantom.ambient": "Fantasma cârâie",
	"subtitles.entity.phantom.bite": "Fantasma mușcă",
	"subtitles.entity.phantom.death": "Fantasma moare",
	"subtitles.entity.phantom.flap": "Fantasma bate din aripi",
	"subtitles.entity.phantom.hurt": "Fantasma este rănită",
	"subtitles.entity.phantom.swoop": "Fantasma plonjează",
	"subtitles.entity.pig.ambient": "Porcul guiță",
	"subtitles.entity.pig.death": "Porcul moare",
	"subtitles.entity.pig.eat": "Porcul mănâncă",
	"subtitles.entity.pig.hurt": "Porcul este rănit",
	"subtitles.entity.pig.saddle": "Șaua se echipează",
	"subtitles.entity.piglin.admiring_item": "Piglinul admiră un obiect",
	"subtitles.entity.piglin.ambient": "Piglinul grohăie",
	"subtitles.entity.piglin.angry": "Piglinul grohăie furios",
	"subtitles.entity.piglin.celebrate": "Piglinul sărbătorește",
	"subtitles.entity.piglin.converted_to_zombified": "Piglinul se convertește în piglin zombificat",
	"subtitles.entity.piglin.death": "Piglinul moare",
	"subtitles.entity.piglin.hurt": "Piglinul este rănit",
	"subtitles.entity.piglin.jealous": "Piglinul grohăie invidios",
	"subtitles.entity.piglin.retreat": "Piglinul se retrage",
	"subtitles.entity.piglin.step": "Piglinul pășește",
	"subtitles.entity.piglin_brute.ambient": "Piglinul brutal grohăie",
	"subtitles.entity.piglin_brute.angry": "Piglinul brutal grohăie furios",
	"subtitles.entity.piglin_brute.converted_to_zombified": "Piglinul brutal se convertește în piglin zombificat",
	"subtitles.entity.piglin_brute.death": "Piglinul brutal moare",
	"subtitles.entity.piglin_brute.hurt": "Piglinul brutal este rănit",
	"subtitles.entity.piglin_brute.step": "Piglinul brutal pășește",
	"subtitles.entity.pillager.ambient": "Jefuitorul murmură",
	"subtitles.entity.pillager.celebrate": "Jefuitorul se bucură",
	"subtitles.entity.pillager.death": "Jefuitorul moare",
	"subtitles.entity.pillager.hurt": "Jefuitorul este rănit",
	"subtitles.entity.player.attack.crit": "Atac critic",
	"subtitles.entity.player.attack.knockback": "Atac cu recul",
	...
	"subtitles.entity.player.death": "Jucătorul moare",
	"subtitles.entity.player.freeze_hurt": "Jucătorul îngheață",
	"subtitles.entity.player.hurt": "Jucătorul este rănit",
	"subtitles.entity.player.hurt_drown": "Jucătorul se îneacă",
	"subtitles.entity.player.hurt_on_fire": "Jucătorul arde",
	"subtitles.entity.player.levelup": "Jucătorul crește în nivel",
	"subtitles.entity.player.teleport": "Jucătorul se teleportează",
	"subtitles.entity.polar_bear.ambient": "Ursul polar mormăie",
	"subtitles.entity.polar_bear.ambient_baby": "Pui de urs polar mormăind",
	"subtitles.entity.polar_bear.death": "Ursul polar moare",
	"subtitles.entity.polar_bear.hurt": "Ursul polar este rănit",
	"subtitles.entity.polar_bear.warning": "Ursul polar rage",
	"subtitles.entity.potion.splash": "Sticluța se sparge",
	"subtitles.entity.potion.throw": "Sticluța este aruncată",
	"subtitles.entity.puffer_fish.blow_out": "Peștele-balon se dezumflă",
	"subtitles.entity.puffer_fish.blow_up": "Peștele-balon se dezumflă",
	"subtitles.entity.puffer_fish.death": "Peștele-balon moare",
	"subtitles.entity.puffer_fish.flop": "Peștele-balon se zbate",
	"subtitles.entity.puffer_fish.hurt": "Peștele-balon este rănit",
	"subtitles.entity.puffer_fish.sting": "Peștele-balon înțeapă",
	"subtitles.entity.rabbit.ambient": "Iepurele chițăie",
	"subtitles.entity.rabbit.attack": "Iepurele atacă",
	"subtitles.entity.rabbit.death": "Iepurele moare",
	"subtitles.entity.rabbit.hurt": "Iepurele este rănit",
	"subtitles.entity.rabbit.jump": "Iepurele țopăie",
	"subtitles.entity.ravager.ambient": "Distrugătorul mormăie",
	"subtitles.entity.ravager.attack": "Distrugătorul mușcă",
	"subtitles.entity.ravager.celebrate": "Distrugătorul se bucură",
	"subtitles.entity.ravager.death": "Distrugătorul moare",
	"subtitles.entity.ravager.hurt": "Distrugătorul este rănit",
	"subtitles.entity.ravager.roar": "Distrugătorul rage",
	"subtitles.entity.ravager.step": "Distrugătorul pășește",
	"subtitles.entity.ravager.stunned": "Distrugătorul este năucit",
	"subtitles.entity.salmon.death": "Somonul moare",
	"subtitles.entity.salmon.flop": "Somonul se zbate",
	"subtitles.entity.salmon.hurt": "Somonul este rănit",
	"subtitles.entity.sheep.ambient": "Oaia behăie",
	"subtitles.entity.sheep.death": "Oaia moare",
	"subtitles.entity.sheep.hurt": "Oaia este rănită",
	"subtitles.entity.shulker.ambient": "Shulkerul pândește",
	"subtitles.entity.shulker.close": "Shulkerul se închide",
	"subtitles.entity.shulker.death": "Shulkerul moare",
	"subtitles.entity.shulker.hurt": "Shulkerul este rănit",
	"subtitles.entity.shulker.open": "Shulkerul se deschide",
	"subtitles.entity.shulker.shoot": "Shulkerul trage",
	"subtitles.entity.shulker.teleport": "Shulkerul se teleportează",
	...
	"subtitles.entity.silverfish.ambient": "Peștișorul argintiu sâsâie",
	"subtitles.entity.silverfish.death": "Peștișorul argintiu moare",
	"subtitles.entity.silverfish.hurt": "Peștișorul argintiu este rănit",
	"subtitles.entity.skeleton.ambient": "Scheletul zornăie",
	"subtitles.entity.skeleton.converted_to_stray": "Scheletul se convertește în hoinar",
	"subtitles.entity.skeleton.death": "Scheletul moare",
	"subtitles.entity.skeleton.hurt": "Scheletul este rănit",
	"subtitles.entity.skeleton.shoot": "Scheletul trage",
	"subtitles.entity.skeleton_horse.ambient": "Calul-schelet nechează",
	"subtitles.entity.skeleton_horse.death": "Calul-schelet moare",
	"subtitles.entity.skeleton_horse.hurt": "Calul-schelet este rănit",
	"subtitles.entity.skeleton_horse.jump_water": "Calul-schelet sare",
	"subtitles.entity.skeleton_horse.swim": "Calul-schelet înoată",
	"subtitles.entity.slime.attack": "Mâzga atacă",
	"subtitles.entity.slime.death": "Mâzga moare",
	"subtitles.entity.slime.hurt": "Mâzga este rănită",
	"subtitles.entity.slime.squish": "Mâzga lipăie",
	...
	"subtitles.entity.sniffer.hurt": "Adulmecătorul este rănit",
	...
	"subtitles.entity.snow_golem.death": "Golemul de zăpadă moare",
	"subtitles.entity.snow_golem.hurt": "Golemul de zăpadă este rănit",
	"subtitles.entity.snowball.throw": "Bulgărele de zăpadă zboară",
	"subtitles.entity.spider.ambient": "Păianjenul sâsâie",
	"subtitles.entity.spider.death": "Păianjenul moare",
	"subtitles.entity.spider.hurt": "Păianjenul este rănit",
	"subtitles.entity.squid.ambient": "Calamarul înoată",
	"subtitles.entity.squid.death": "Calamarul moare",
	"subtitles.entity.squid.hurt": "Calamarul este rănit",
	"subtitles.entity.squid.squirt": "Calamarul aruncă cerneală",
	"subtitles.entity.stray.ambient": "Hoinarul zornăie",
	"subtitles.entity.stray.death": "Hoinarul moare",
	"subtitles.entity.stray.hurt": "Hoinarul este rănit",
	"subtitles.entity.strider.death": "Umblătorul moare",
	"subtitles.entity.strider.eat": "Umblătorul mănâncă",
	"subtitles.entity.strider.happy": "Umblătorul ciripește",
	"subtitles.entity.strider.hurt": "Umblătorul este rănit",
	"subtitles.entity.strider.idle": "Umblătorul orăcăie",
	"subtitles.entity.strider.retreat": "Umblătorul se retrage",
	"subtitles.entity.sulfur_cube.absorb": "Cubul sulfuros e plin",
	"subtitles.entity.sulfur_cube.bounce": "Cubul sulfuros sare",
	"subtitles.entity.sulfur_cube.death": "Cubul sulfuros moare",
	"subtitles.entity.sulfur_cube.eject": "Bloc eliminat",
	"subtitles.entity.sulfur_cube.hit": "Cubul sulfuros e lovit",
	"subtitles.entity.sulfur_cube.hurt": "Cubul sulfuros e rănit",
	"subtitles.entity.sulfur_cube.push": "Cubul sulfuros e împins",
	"subtitles.entity.sulfur_cube.squish": "Cubul sulfuros sare",
	"subtitles.entity.tadpole.death": "Mormolocul moare",
	...
	"subtitles.entity.tnt.primed": "TNT-ul fâsâie",
	"subtitles.entity.tropical_fish.death": "Peștele tropical moare",
	"subtitles.entity.tropical_fish.flop": "Peștele tropical se zbate",
	"subtitles.entity.tropical_fish.hurt": "Peștele tropical este rănit",
	"subtitles.entity.turtle.ambient_land": "Țestoasa ciripește",
	"subtitles.entity.turtle.death": "Țestoasa moare",
	"subtitles.entity.turtle.death_baby": "Puiul de țestoasă moare",
	"subtitles.entity.turtle.egg_break": "Oul de țestoasă se sparge",
	"subtitles.entity.turtle.egg_crack": "Oul de țestoasă se crapă",
	"subtitles.entity.turtle.egg_hatch": "Oul de țestoasă eclozează",
	"subtitles.entity.turtle.hurt": "Țestoasa este rănită",
	"subtitles.entity.turtle.hurt_baby": "Puiul de țestoasă este rănit",
	"subtitles.entity.turtle.lay_egg": "Țestoasa face un ou",
	"subtitles.entity.turtle.shamble": "Țestoasa se târăște",
	"subtitles.entity.turtle.shamble_baby": "Puiul de țestoasă se târăște",
	"subtitles.entity.turtle.swim": "Țestoasa înoată",
	"subtitles.entity.vex.ambient": "Spiritul sâcâie",
	"subtitles.entity.vex.charge": "Spiritul țipă",
	"subtitles.entity.vex.death": "Spiritul moare",
	"subtitles.entity.vex.hurt": "Spiritul este rănit",
	"subtitles.entity.villager.ambient": "Săteanul mormăie",
	"subtitles.entity.villager.celebrate": "Săteanul se bucură",
	"subtitles.entity.villager.death": "Săteanul moare",
	"subtitles.entity.villager.hurt": "Săteanul este rănit",
	"subtitles.entity.villager.no": "Săteanul este nemulțumit",
	"subtitles.entity.villager.trade": "Săteanul face schimb",
	"subtitles.entity.villager.work_armorer": "Fierarul de armură muncește",
	"subtitles.entity.villager.work_butcher": "Măcelarul muncește",
	"subtitles.entity.villager.work_cartographer": "Cartograful muncește",
	"subtitles.entity.villager.work_cleric": "Clericul muncește",
	"subtitles.entity.villager.work_farmer": "Fermierul muncește",
	"subtitles.entity.villager.work_fisherman": "Pescarul muncește",
	"subtitles.entity.villager.work_fletcher": "Săgetarul muncește",
	"subtitles.entity.villager.work_leatherworker": "Pielarul muncește",
	"subtitles.entity.villager.work_librarian": "Bibliotecarul muncește",
	"subtitles.entity.villager.work_mason": "Zidarul muncește",
	"subtitles.entity.villager.work_shepherd": "Ciobanul muncește",
	"subtitles.entity.villager.work_toolsmith": "Fierarul de unelte muncește",
	"subtitles.entity.villager.work_weaponsmith": "Fierarul de arme muncește",
	"subtitles.entity.villager.yes": "Săteanul este mulțumit",
	"subtitles.entity.vindicator.ambient": "Apărătorul mormăie",
	"subtitles.entity.vindicator.celebrate": "Apărătorul se bucură",
	"subtitles.entity.vindicator.death": "Apărătorul moare",
	"subtitles.entity.vindicator.hurt": "Apărătorul este rănit",
	"subtitles.entity.wandering_trader.ambient": "Negustorul ambulant mormăie",
	"subtitles.entity.wandering_trader.death": "Negustor ambulant murind",
	"subtitles.entity.wandering_trader.disappeared": "Negustorul ambulant dispare",
	"subtitles.entity.wandering_trader.drink_milk": "Negustorul ambulant bea lapte",
	"subtitles.entity.wandering_trader.drink_potion": "Negustorul ambulant bea poțiune",
	"subtitles.entity.wandering_trader.hurt": "Negustorul ambulant este rănit",
	"subtitles.entity.wandering_trader.no": "Negustorul ambulant este nemulțumit",
	"subtitles.entity.wandering_trader.reappeared": "Negustorul ambulant apare",
	"subtitles.entity.wandering_trader.trade": "Negustorul ambulant face schimb",
	"subtitles.entity.wandering_trader.yes": "Negustorul ambulant este mulțumit",
	...
	"subtitles.entity.warden.sonic_boom": "Gardianul lansează un bum sonic",
	"subtitles.entity.warden.sonic_charge": "Gardianul se încarcă",
	"subtitles.entity.warden.step": "Gardianul pășește",
	"subtitles.entity.warden.tendril_clicks": "Lianele gardianului troscăie",
	"subtitles.entity.wind_charge.throw": "Mingea de vânt zboară",
	"subtitles.entity.wind_charge.wind_burst": "Mingea de vânt explodează",
	"subtitles.entity.witch.ambient": "Vrăjitoarea chicotește",
	"subtitles.entity.witch.celebrate": "Vrăjitoarea se bucură",
	"subtitles.entity.witch.death": "Vrăjitoarea moare",
	"subtitles.entity.witch.drink": "Vrăjitoarea bea",
	"subtitles.entity.witch.hurt": "Vrăjitoarea este rănită",
	"subtitles.entity.witch.throw": "Vrăjitoarea aruncă",
	"subtitles.entity.wither.ambient": "Witherul se înfurie",
	"subtitles.entity.wither.death": "Witherul moare",
	"subtitles.entity.wither.hurt": "Witherul este rănit",
	"subtitles.entity.wither.shoot": "Witherul atacă",
	"subtitles.entity.wither.spawn": "Witherul este eliberat",
	"subtitles.entity.wither_skeleton.ambient": "Scheletul wither zornăie",
	"subtitles.entity.wither_skeleton.death": "Scheletul wither moare",
	"subtitles.entity.wither_skeleton.hurt": "Scheletul wither este rănit",
	"subtitles.entity.wolf.ambient": "Lupul gâfâie",
	"subtitles.entity.wolf.bark": "Lupul latră",
	"subtitles.entity.wolf.death": "Lupul moare",
	"subtitles.entity.wolf.growl": "Lupul mârâie",
	"subtitles.entity.wolf.hurt": "Lupul este rănit",
	"subtitles.entity.wolf.pant": "Lupul gâfâie",
	"subtitles.entity.wolf.shake": "Lupul se scutură",
	"subtitles.entity.wolf.whine": "Lupul se scheaună",
	"subtitles.entity.zoglin.ambient": "Zoglinul mârâie",
	"subtitles.entity.zoglin.angry": "Zoglinul mârâie furios",
	"subtitles.entity.zoglin.attack": "Zoglinul atacă",
	"subtitles.entity.zoglin.death": "Zoglinul moare",
	"subtitles.entity.zoglin.hurt": "Zoglinul este rănit",
	"subtitles.entity.zoglin.step": "Zoglinul pășește",
	"subtitles.entity.zombie.ambient": "Zombiul geme",
	"subtitles.entity.zombie.attack_wooden_door": "Ușa se scutură",
	"subtitles.entity.zombie.break_wooden_door": "Ușa se sparge",
	"subtitles.entity.zombie.converted_to_drowned": "Zombiul se convertește în înecat",
	"subtitles.entity.zombie.death": "Zombiul moare",
	"subtitles.entity.zombie.destroy_egg": "Oul de țestoasă este călcat",
	"subtitles.entity.zombie.hurt": "Zombiul este rănit",
	"subtitles.entity.zombie.infect": "Zombiul infectează",
	"subtitles.entity.zombie_horse.ambient": "Calul-zombi nechează",
	"subtitles.entity.zombie_horse.angry": "Calul-zombi nechează",
	"subtitles.entity.zombie_horse.death": "Calul-zombi moare",
	"subtitles.entity.zombie_horse.eat": "Calul-zombi mănâncă",
	"subtitles.entity.zombie_horse.hurt": "Calul-zombi este rănit",
	"subtitles.entity.zombie_nautilus.ambient": "Nautilul-zombi bolborosește",
	"subtitles.entity.zombie_nautilus.ambient_land": "Nautilul-zombi bolborosește",
	"subtitles.entity.zombie_nautilus.dash": "Nautilul-zombi se propulsează",
	"subtitles.entity.zombie_nautilus.dash_land": "Nautilul-zombi se propulsează",
	"subtitles.entity.zombie_nautilus.dash_ready": "Nautilul-zombi își revine",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Nautilul-zombi își revine",
	"subtitles.entity.zombie_nautilus.death": "Nautilul-zombi moare",
	"subtitles.entity.zombie_nautilus.death_land": "Nautilul-zombi moare",
	"subtitles.entity.zombie_nautilus.eat": "Nautilul-zombi mănâncă",
	"subtitles.entity.zombie_nautilus.hurt": "Nautilul-zombi este rănit",
	"subtitles.entity.zombie_nautilus.hurt_land": "Nautilul-zombi este rănit",
	"subtitles.entity.zombie_nautilus.swim": "Nautilul-zombi înoată",
	"subtitles.entity.zombie_villager.ambient": "Săteanul-zombi geme",
	"subtitles.entity.zombie_villager.converted": "Săteanul-zombi vociferează",
	"subtitles.entity.zombie_villager.cure": "Săteanul-zombi începe să se vindece",
	"subtitles.entity.zombie_villager.death": "Săteanul-zombi moare",
	"subtitles.entity.zombie_villager.hurt": "Săteanul-zombi este rănit",
	"subtitles.entity.zombified_piglin.ambient": "Piglinul zombificat grohăie",
	"subtitles.entity.zombified_piglin.angry": "Piglinul zombificat grohăie furios",
	"subtitles.entity.zombified_piglin.death": "Piglinul zombificat moare",
	"subtitles.entity.zombified_piglin.hurt": "Piglinul zombificat este rănit",
	"subtitles.event.mob_effect.bad_omen": "Răul augur se manifestă",
	...
	"subtitles.event.raid.horn": "Cornul de rău augur sună",
	"subtitles.item.armor.equip": "Echipamentul se echipează",
	"subtitles.item.armor.equip_chain": "Armura de zale zornăie",
	"subtitles.item.armor.equip_copper": "Armura de cupru zdrăngăne",
	"subtitles.item.armor.equip_diamond": "Armura de diamant zăngănește",
	"subtitles.item.armor.equip_elytra": "Elitrele foșnesc",
	"subtitles.item.armor.equip_gold": "Armura de aur clincăne",
	"subtitles.item.armor.equip_iron": "Armura de fier zuruie",
	"subtitles.item.armor.equip_leather": "Armura de piele foșnește",
	"subtitles.item.armor.equip_nautilus": "Armura de nautil se echipează",
	"subtitles.item.armor.equip_netherite": "Armura de netherit zornăie",
	"subtitles.item.armor.equip_turtle": "Carapacea de țestoasă bufnește",
	"subtitles.item.armor.equip_wolf": "Armura de lup se echipează",
	"subtitles.item.armor.unequip_nautilus": "Armura de nautil se dezechipează",
	"subtitles.item.armor.unequip_wolf": "Armura de lup se dezechipează",
	"subtitles.item.axe.scrape": "Toporul răzuiește",
	"subtitles.item.axe.strip": "Toporul descojește",
	"subtitles.item.axe.wax_off": "Deceruire",
	"subtitles.item.bone_meal.use": "Făina de oase se folosește",
	"subtitles.item.book.page_turn": "Pagina foșnește",
	"subtitles.item.book.put": "Cartea se așează",
	"subtitles.item.bottle.empty": "Sticluța se golește",
	"subtitles.item.bottle.fill": "Sticluța se umple",
	"subtitles.item.brush.brushing.generic": "Periaj",
	"subtitles.item.brush.brushing.gravel": "Periat pietriș",
	"subtitles.item.brush.brushing.gravel.complete": "Periatul pietrișului complet",
	"subtitles.item.brush.brushing.sand": "Periat nisip",
	"subtitles.item.brush.brushing.sand.complete": "Periatul nisipului complet",
	"subtitles.item.bucket.empty": "Găleata se golește",
	"subtitles.item.bucket.fill": "Găleata se umple",
	"subtitles.item.bucket.fill_axolotl": "Axolotul este prins",
	"subtitles.item.bucket.fill_fish": "Peștele este capturat",
	"subtitles.item.bucket.fill_sulfur_cube": "Cubul sulfuros e prins",
	"subtitles.item.bucket.fill_tadpole": "Mormolocul este capturat",
	"subtitles.item.bundle.drop_contents": "Săculețul se golește",
	"subtitles.item.bundle.insert": "Obiectul este ambalat",
	"subtitles.item.bundle.insert_fail": "Săculețul este plin",
	"subtitles.item.bundle.remove_one": "Obiectul se dezambalează",
	"subtitles.item.chorus_fruit.teleport": "Jucătorul se teleportează",
	"subtitles.item.crop.plant": "Planta este plantată",
	"subtitles.item.crossbow.charge": "Arbaleta se încarcă",
	"subtitles.item.crossbow.hit": "Săgeata nimerește",
	"subtitles.item.crossbow.load": "Arbaleta se încarcă",
	"subtitles.item.crossbow.shoot": "Arbaleta trage",
	"subtitles.item.dye.use": "Pete de vopsea",
	"subtitles.item.elytra.flying": "Vâjâind",
	"subtitles.item.firecharge.use": "Mingea de foc vâjâie",
	"subtitles.item.flintandsteel.use": "Cremenea și amnar țăcăne",
	"subtitles.item.glow_ink_sac.use": "Sacul de cerneală strălucitoare se împrăștie",
	"subtitles.item.goat_horn.play": "Cornul de capră răsună",
	"subtitles.item.golden_dandelion.unuse": "Păpădia de aur pornește îmbătrânirea",
	"subtitles.item.golden_dandelion.use": "Păpădia de aur oprește îmbătrânirea",
	"subtitles.item.hoe.till": "Sapa ară",
	"subtitles.item.honey_bottle.drink": "Înghițituri",
	"subtitles.item.honeycomb.wax_on": "Ceruire",
	"subtitles.item.horse_armor.unequip": "Armura de cal se dezechipează",
	"subtitles.item.ink_sac.use": "Sacul de cerneală se împrăștie",
	"subtitles.item.lead.break": "Lesă se rupe",
	"subtitles.item.lead.tied": "Lesă se leagă",
	"subtitles.item.lead.untied": "Lesă se dezleagă",
	"subtitles.item.llama_carpet.unequip": "Covorul se dezechipează",
	"subtitles.item.lodestone_compass.lock": "Busola cu magnetită se fixează pe magnetită",
	"subtitles.item.mace.smash_air": "Buzduganul zdrobește",
	"subtitles.item.mace.smash_ground": "Buzduganul zdrobește",
	"subtitles.item.nautilus_saddle_equip": "Șaua se echipează",
	"subtitles.item.nautilus_saddle_underwater_equip": "Șaua se echipează",
	"subtitles.item.nether_wart.plant": "Planta este plantată",
	"subtitles.item.ominous_bottle.dispose": "Sticla se sparge",
	"subtitles.item.saddle.unequip": "Șaua se dezechipează",
	"subtitles.item.shears.shear": "Foarfecile taie",
	"subtitles.item.shears.snip": "Foarfecile taie",
	"subtitles.item.shield.block": "Scut blochează",
	"subtitles.item.shovel.flatten": "Lopata bătătorește",
	"subtitles.item.spear.attack": "Sulița înjunghie",
	"subtitles.item.spear.hit": "Sulița străpunge",
	"subtitles.item.spear.lunge": "Fandează cu sulița",
	"subtitles.item.spear.use": "Se avântă cu sulița",
	"subtitles.item.spear_wood.attack": "Sulița înjunghie",
	"subtitles.item.spear_wood.hit": "Sulița străpunge",
	"subtitles.item.spear_wood.use": "Se avântă cu sulița",
	"subtitles.item.spyglass.stop_using": "Ocheanul se retrage",
	"subtitles.item.spyglass.use": "Ocheanul se extinde",
	"subtitles.item.totem.use": "Totemul se activează",
	"subtitles.item.trident.hit": "Tridentul străpunge",
	"subtitles.item.trident.hit_ground": "Tridentul vibrează",
	"subtitles.item.trident.return": "Tridentul se întoarce",
	"subtitles.item.trident.riptide": "Tridentul șuieră",
	"subtitles.item.trident.throw": "Tridentul zăngănește",
	"subtitles.item.trident.thunder": "Tridentul tună",
	"subtitles.item.underwater_saddle.equip": "Șaua se echipează",
	"subtitles.item.wolf_armor.break": "Armura de lup se sparge",
	"subtitles.item.wolf_armor.crack": "Armura de lup crapă",
	"subtitles.item.wolf_armor.damage": "Armura de lup se strică",
	"subtitles.item.wolf_armor.repair": "Armura de lup se repară",
	"subtitles.particle.soul_escape": "Sufletul scapă",
	"subtitles.ui.cartography_table.take_result": "Harta se desenează",
	"subtitles.ui.hud.bubble_pop": "Nivelul de oxigen scade",
	"subtitles.ui.loom.take_result": "Războiul de țesut se folosește",
	"subtitles.ui.stonecutter.take_result": "Tăietorul de piatră se folosește",
	"subtitles.weather.end_flash": "Străfulgerare a Endului bubuie",
	"subtitles.weather.rain": "Ploaie",
	"symlink_warning.message": "Încărcarea lumilor din dosare cu legături simbolice poate fi riscantă dacă nu știi exact ce faci. Te rugăm să vizitezi %s pentru a afla mai mult.",
	"symlink_warning.message.pack": "Încărcarea pachetelor cu linkuri simbolice poate fi riscantă dacă nu știi exact ce faci. Te rugăm să vizitezi %s pentru a afla mai multe.",
	"symlink_warning.message.world": "Încărcarea lumilor din dosare cu linkuri simbolice poate fi riscantă dacă nu știi exact ce faci. Te rugăm să vizitezi %s pentru a afla mai multe.",
	"symlink_warning.more_info": "Mai multe informații",
	"symlink_warning.title": "Dosarul lumii conține legături simbolice",
	"symlink_warning.title.pack": "Pachet(e) adaugate contin(e) linkuri symbolice",
	"symlink_warning.title.world": "Dosarul lumii conține legături simbolice",
	...
	"telemetry.event.graphics_capabilities.description": "Acest eveniment ne oferă informații despre capacitățile plăcii grafice utilizate pentru rularea jocului.",
	"telemetry.event.graphics_capabilities.title": "Capacități grafice",
	"telemetry.event.optional": "%s (opțional)",
	"telemetry.event.optional.disabled": "%s (Opțional) — Dezactivat",
	"telemetry.event.p2p_connection.description": "Acest eveniment ne ajută să înțelegem fiabilitatea și performanța conexiunilor peer-to-peer dintre jucători. Acesta înregistrează dacă conexiunea a fost realizată cu succes, tipul de candidat ICE (Interactive Connectivity Establishment, protocolul pe care îl folosim pentru a stabili conexiuni peer-to-peer) utilizat și cât timp a durat stabilirea conexiunii.",
	"telemetry.event.p2p_connection.title": "Conexiune peer-to-peer",
	...
	"telemetry.event.world_load_times.description": "Este important să înțelegem cât de mult durează ca un jucător să intre într-o lume și cum se schimbă această durată de timp. De exemplu, când adăugăm noi funcționalități sau facem schimbări tehnice mari, trebuie să vedem ce impact au asupra timpilor de încărcare.",
	...
	"telemetry.event.world_unloaded.description": "Evenimentele \"Lume încărcată\" și \"Lume descărcată\" sunt folosite pentru a calcula durata sesiunii de joc.\nDurata (în secunde și ticuri) se măsoară în momentul în care o sesiune de lume s-a încheiat (prin salvarea și întoarcerea la meniul principal sau deconectarea de la server).",
	"telemetry.event.world_unloaded.title": "Lume descărcată",
	"telemetry.property.advancement_game_time.title": "Timp de joc (ticuri)",
	"telemetry.property.advancement_id.title": "ID-ul progresului",
	"telemetry.property.backend_failure_message.title": "Mesaj eșuare creare backend",
	"telemetry.property.backend_failure_missing_capabilities.title": "Crearea backend-ului a eșuat: compatibilități lipsă",
	"telemetry.property.backend_failure_reason.title": "Motivul eșuării creării backend-ului",
	"telemetry.property.backend_name.title": "Nume backend",
	...
	"telemetry.property.launcher_name.title": "Numele Launcher-ului",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "Etapa de eșec",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Durata conexiunii (în milisecunde) ICE (Interactive Connectivity Establishment)",
	"telemetry.property.p2p_connection_ice_path.title": "Cale ICE (Interactive Connectivity Establishment)",
	"telemetry.property.p2p_connection_local_candidate_type.title": "Tipul candidatului local",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Tipul candidatului la distanță",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Timpul de conectare la semnal (în milisecunde)",
	"telemetry.property.p2p_connection_successful.title": "Conexiune stabilită cu succes",
	"telemetry.property.p2p_connection_total_time_ms.title": "Timpul total de conexiune (în milisecunde)",
	"telemetry.property.platform.title": "Platformă",
	"telemetry.property.realms_map_content.title": "Conținutul hărții Realms (numele minijocului)",
	"telemetry.property.render_distance.title": "Distanță de randare",
	"telemetry.property.render_time_samples.title": "Probe ale timpului de randare",
	...
	"telemetry_info.button.show_data": "Afișează-mi datele",
	...
	"test.error.block_property_mismatch": "Era prevăzut proprietatea %s să fie %s, era %s",
	"test.error.block_property_missing": "Proprietatea blocului lipsește, era prevăzut ca proprietatea %s să fie %s",
	"test.error.entity_property": "Entitatea %s a eșuat testul: „%s”",
	"test.error.entity_property_details": "Entitatea %s a eșuat testul: %s, era prevăzut %s, era %s",
	"test.error.expected_block": "Era prevăzut blocul „%s”, dar s-a primit „%s”",
	"test.error.expected_block_present": "Era prevăzut ca blocul %s să fie prezent",
	"test.error.expected_block_tag": "Era prevăzut blocul în #%s, a fost %s",
	...
	"test.error.expected_entity_around": "Era prevăzut ca %s să existe în jurul punctului %s, %s, %s",
	"test.error.expected_entity_count": "Erau prevăzute ca %s entități de tipul %s, găsite %s",
	...
	"test.error.expected_entity_effect": "Era prevăzut ca %s să aibă efectul %s %s",
	...
	"test.error.expected_entity_in_test": "Era prevăzut ca %s să existe în test",
	"test.error.expected_entity_not_touching": "Nu era prevăzut %s să atingă punctul %s, %s, %s (relativ: %s, %s, %s)",
	"test.error.expected_entity_touching": "Nu era prevăzut %s să atingă punctul %s, %s, %s (relativ: %s, %s, %s)",
	"test.error.expected_item": "Era prevăzut obiect de tip %s",
	"test.error.expected_items_count": "Erau prevăzute %s obiecte de tipul %s, găsite %s",
	"test.error.fail": "Condiții de eșec îndeplinite",
	"test.error.invalid_block_type": "Tip neașteptat de block găsit: %s",
	"test.error.missing_block_entity": "Lipsește entitatea blocului",
	"test.error.not_a_block_item": "Blocul referit nu este un obiect bloc",
	"test.error.position": "%s la %s, %s, %s (relativ: %s, %s, %s) la ticul %s",
	...
	"test.error.sequence.invalid_tick": "Succes în tic invalid: era prevăzut %s",
	"test.error.sequence.minimum_tick": "Efectuat cu succes înaintea ticului prevăzut: timp de așteptare prevăzut %s",
	"test.error.sequence.not_completed": "Testul a expirat înainte ca secvența să fie completată",
	"test.error.set_biome": "Nu s-a putut seta biomul pentru testare",
	"test.error.spawn_failure": "Nu s-a putut crea entitatea %s",
	"test.error.state_not_equal": "Stare incorectă. A fost prevăzut %s, era %s",
	"test.error.structure.failure": "A eșuat plasarea structurii de test pentru „%s“",
	"test.error.tick": "%s pe tick %s",
	"test.error.ticking_without_structure": "Test de tic înainte de plasarea structurii",
	"test.error.timeout.no_result": "Nu a reușit și nici nu a eșuat în %s ticuri",
	"test.error.timeout.no_sequences_finished": "Nicio secvență terminată în %s ticuri",
	"test.error.too_many_entities": "Era prevăzut numai un %s să existe în jurul punctului %s, %s, %s dar a fost găsit %s",
	"test.error.unexpected_block": "Nu era prevăzut ca block-ul să fie %s",
	"test.error.unexpected_entity": "Nu era prevăzut să existe %s",
	"test.error.unexpected_item": "Nu era prevăzut obiectul de tip %s",
	"test.error.unknown": "Eroare internă necunoscută: „%s”",
	"test.error.value_not_equal": "Așteptat %s să fie %s, era %s",
	"test.error.value_not_in_between": "Era prevăzut ca %s să fie între %s și %s: a fost %s",
	"test.error.wrong_block_entity": "Tip de entitate de bloc greșită: %s",
	"test_block.error.missing": "Structura de test lipsește blocul „%s”",
	...
	"test_block.mode.accept": "Acceptă",
	...
	"test_instance_block.error.unable_to_save": "Nu se poate salva modelul a structuri de test pentru instanța de test la %s, %s, %s",
	...
	"test_instance_block.size": "Dimensiunea structurii de test",
	...
	"title.32bit.deprecation.realms": "Minecraft va necesita un sistem bazat pe 64 de biți, care te va împiedica de a te juca Realms pe acest dispozitiv. Va trebui să anulezi manual orice abonament la Realms.",
	...
	"title.multiplayer.disabled.banned.name": "Trebuie să îți schimbi numele înainte de a putea juca online",
	...
	"trim_material.minecraft.quartz": "Material de cuarț",
	"trim_material.minecraft.redstone": "Material de redstone",
	"trim_material.minecraft.resin": "Material de rășină",
	...
	"upgradeWorld.aborted.message": "Acest lucru se poate întâmpla dacă un alt program a accesat lumea în timpul actualizării.\nAr putea ajuta să repornești computerul și să încerci din nou. Dacă problema persistă, te rog ia în considerare sesizarea unei erori.",
	"upgradeWorld.aborted.reportBug": "Sesizează o eroare",
	"upgradeWorld.aborted.title": "Lumea nu a putut fi actualizată",
	"upgradeWorld.canceled.message": "Lumea ta rămâne la fel cum era înainte.",
	"upgradeWorld.canceled.title": "Actualizarea lumii anulată",
	"upgradeWorld.done": "Actualizarea lumii completă",
	"upgradeWorld.failed_cleanup.message": "Lumea a fost actualizată cu succes la versiunea curentă și este acum disponibilă în lista lumilor.\nAm întâmpinat probleme la curățarea datelor învechite, prin urmare, numele dosarului lumii s-a schimbat în %s.",
	"upgradeWorld.failed_cleanup.title": "Lumea a fost actualizată cu succes",
	"upgradeWorld.info.converted": "Actualizat: %s",
	"upgradeWorld.info.file_fix_stage": "Etapa: %s/%s",
	"upgradeWorld.info.scanning": "Scanând fișierele...",
	"upgradeWorld.info.total": "Total: %s",
	"upgradeWorld.joinNow": "Vrei să intri acum pe lume?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Transferând fișiere",
	"upgradeWorld.progress.type.legacy_structures": "Actualizând structuri moștenite",
	"upgradeWorld.progress.type.region": "Actualizând regiuni",
	"upgradeWorld.symlink.message": "Lumea selectată cuprinde legături simbolice.\nPașii necesari pentru actualizarea lumii la versiunea curentă nu acceptă utilizarea legăturilor simbolice. Pentru a actualiza lumea, legăturile trebuie mai întâi rezolvate.",
	"upgradeWorld.symlink.title": "Lumea nu poate fi actualizată",
	"upgradeWorld.title": "Actualizând fișierele de lume",
}
