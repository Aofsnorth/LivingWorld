// Code generated by tools/gen_lang.go from 26.1/esan.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Âççeçibilidá...",
	...
	"advMode.notEnabled": "Lô bloquê de comandô no êttán âttibáô",
	"advMode.notEnabled.spawner": "Lô heneradorê de criaturâ no êttán âttibáô",
	"advMode.previousOutput": "Çalida der comando anteriôh",
	"advMode.setCommand": "Êttableçe un comando de conçola par bloque",
	"advMode.setCommand.disabled": "Comando êttableçío: %s, pero lô bloquê de comandô çigen deçâttibáô",
	...
	"advancements.adventure.blowback.description": "Mata un breeze deborbiéndole una carga de biento",
	"advancements.adventure.blowback.title": "¡A tomâh por çaco!",
	"advancements.adventure.brush_armadillo.description": "Conçige êccamâ d'un armaíyo uçando un pinçêh",
	"advancements.adventure.brush_armadillo.title": "Dêarma'iyo?",
	...
	"advancements.adventure.crafters_crafting_crafters.description": "Mantente çerca de un fabricadôh cuando fabrique otro fabricadôh",
	"advancements.adventure.crafters_crafting_crafters.title": "Fabricaorê fabricando fabricaorê",
	...
	"advancements.adventure.heart_transplanter.description": "Coloca un Coraçón Cruhiente con la alineaçión corrêtta entre dôh bloquê de Leño de quehigo pálido",
	"advancements.adventure.heart_transplanter.title": "Trâpplantadôh de coraçón",
	...
	"advancements.adventure.lighten_up.description": "Râppa una lámpara de cobre con una acha pa açêh que briye mâh.",
	"advancements.adventure.lighten_up.title": "Briyo a la bîtta",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Entra en una cámara de deçafío",
	...
	"advancements.adventure.overoverkill.description": "Inflihe 50 coraçonê de daño d'un çolo gorpe uçando la maça",
	"advancements.adventure.overoverkill.title": "Çobremaçaço",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Lee la çeñâh d'enerhía d'un anaquêh de librô êccurpío utiliçando un comparadôh",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Er podêh de lô librô",
	"advancements.adventure.revaulting.description": "Dêbbloquea un'arca ominoça con una yabe de deçafío ominoça",
	"advancements.adventure.revaulting.title": "Caha pandora",
	...
	"advancements.adventure.salvage_sherd.title": "Rêppetando lô bêttihiô",
	...
	"advancements.adventure.spear_many_mobs.description": "Gorpea a çinco criaturâ con una embêttida utiliçando una lança",
	"advancements.adventure.spear_many_mobs.title": "Pinxo moruno",
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Aplica êttô mordê d'errería ar menô una bêh: aguhâ, oçico, côttiyâ, çilençio, bêh, marea, bûccacaminô",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Forhando con êttilo",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Decora una armadura en una meça de herrería",
	...
	"advancements.adventure.under_lock_and_key.description": "Abre un'arca uçando una yabe de deçafío",
	"advancements.adventure.under_lock_and_key.title": "Baho yabe",
	"advancements.adventure.use_lodestone.description": "Imanta una brúhula con un bloque de mânnetita",
	"advancements.adventure.use_lodestone.title": "Mânnetita, yébame a caçita",
	...
	"advancements.adventure.who_needs_rockets.description": "Uça una carga de biento pa lançarte 8 bloquê açia'rriba",
	"advancements.adventure.who_needs_rockets.title": "¿Quién neçeçita coetê?",
	...
	"advancements.husbandry.feed_snifflet.description": "Da de comêh a una cría d'olîqqueadôh",
	"advancements.husbandry.feed_snifflet.title": "Pequeñô olîqqueô",
	...
	"advancements.husbandry.obtain_sniffer_egg.description": "Conçige un guebo d'olîqqueadôh",
	"advancements.husbandry.obtain_sniffer_egg.title": "Guele intereçante",
	"advancements.husbandry.place_dried_ghast_in_water.description": "Coloca un bloque de ghast çeco en agua",
	"advancements.husbandry.place_dried_ghast_in_water.title": "¡Mantente hidratao'!",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Planta cuarquiêh çemiya d'olîqqueadôh",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Quítale la armaúra a un lobo uçando unâ êttiherâ",
	"advancements.husbandry.remove_wolf_armor.title": "A la moda",
	"advancements.husbandry.repair_wolf_armor.description": "Repara una armaúra pa lobo dañá uçando êccamâ d'armaíyo",
	"advancements.husbandry.repair_wolf_armor.title": "Como nuebo",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Utiliça una candela pa recohêh miêh d'una cormena con un frâcco de crîttâh çin enfadâh a lâ abehâ",
	"advancements.husbandry.safely_harvest_honey.title": "Abelante, êtta êh tu caça",
	"advancements.husbandry.silk_touch_nest.description": "Muebe una cormena o apiario que contenga 3 abehâ utiliçando toque de çeda",
	...
	"advancements.husbandry.whole_pack.description": "Domêttica a toâ lâ êppeçiê de lobo",
	"advancements.husbandry.whole_pack.title": "Lídê de la maná",
	...
	"argument.block.tag.disallowed": "Lâ etiquetâ no êttán permitíâ aquí, çolo lô bloquê realê",
	...
	"argument.entity.selector.nearestEntity": "Entidá mâh çercana",
	...
	"argument.hexcolor.invalid": "Código de colôh êççadeçimâh no válido: '%s'",
	...
	"argument.message.too_long": "Er mensahe êh demasiao largo (%s > máççimo %s carâtterê)",
	"argument.nbt.array.invalid": "Tipo de matrîh \"%s\" no bálido",
	"argument.nbt.array.mixed": "No çe pué inçertâh %s en %s",
	"argument.nbt.expected.compound": "Etiqueta compuêtta requería",
	...
	"argument.resource_or_id.failed_to_parse": "Errôh al analiçâh êttrûttura: %s",
	"argument.resource_or_id.invalid": "ID o etiqueta imbálida",
	"argument.resource_or_id.no_such_element": "No se ha podido encontrar el elemento «%s» en el registro «%s».",
	"argument.resource_selector.not_found": "No ây coiçidênnçiah pâh el çelectóh '%s' dêl tîpoh '%s'",
	...
	"argument.style.invalid": "Êttilo no bálido: %s",
	...
	"argument.waypoint.invalid": "La entidá çelêccioná no êh un punto de referençia",
	...
	"arguments.item.component.expected": "Çe requiere componente d'ôhheto",
	"arguments.item.component.malformed": "Componente '%s' malformao: '%s'",
	"arguments.item.component.repeated": "Ça repetío er componente '%s', pero çolo çe pué êppeçificáh un valóh",
	"arguments.item.component.unknown": "Componente d'ôhheto dêcconoçío: %s",
	"arguments.item.malformed": "Ôhheto mal formao: %s",
	"arguments.item.overstacked": "%s çolo pué apilarçe âtta %s",
	"arguments.item.predicate.malformed": "Predicao '%s' mal formao: %s",
	"arguments.item.predicate.unknown": "Predicao d'ôhheto dêcconoçío: %s",
	...
	"attribute.name.air_drag_modifier": "Modificadôh de reçîttençia del aire",
	"attribute.name.armor": "Armaúra",
	"attribute.name.armor_toughness": "Dureça d'armaúra",
	"attribute.name.attack_damage": "Daño d'ataque",
	"attribute.name.attack_knockback": "Empuhe d'ataque",
	"attribute.name.attack_speed": "Beloçidá d'ataque",
	"attribute.name.below_name_distance": "Distancia del marcador de puntuación",
	"attribute.name.block_break_speed": "Veloçidá al rompêh bloquê",
	"attribute.name.block_interaction_range": "Rango de interaççión con bloquê",
	"attribute.name.bounciness": "Rebote",
	"attribute.name.burning_time": "Tiempo en yamâ",
	"attribute.name.camera_distance": "Dîttançia de la cámara",
	"attribute.name.entity_interaction_range": "Rango de interaççión con entidadê",
	"attribute.name.explosion_knockback_resistance": "Reçîttençia al empuhe de lâ êpploçionê",
	"attribute.name.fall_damage_multiplier": "Murtiplicadôh de daño por caía",
	"attribute.name.flying_speed": "Beloçidá de buelo",
	"attribute.name.follow_range": "Rango de çegimiento de criaturâ",
	"attribute.name.friction_modifier": "Modificadôh de frîççión",
	"attribute.name.generic.armor": "Armaúra",
	"attribute.name.generic.armor_toughness": "Dureça d'armaúra",
	...
	"attribute.name.generic.block_interaction_range": "Rango de interaççión con lô bloquê",
	"attribute.name.generic.burning_time": "Tiempo en yamâ",
	"attribute.name.generic.entity_interaction_range": "Rango de interaççión con entidadê",
	"attribute.name.generic.explosion_knockback_resistance": "Reçîttençia al empuhe de lâ êpploçionê",
	"attribute.name.generic.fall_damage_multiplier": "Murtiplicadôh de daño por caía",
	"attribute.name.generic.flying_speed": "Beloçidá de buelo",
	"attribute.name.generic.follow_range": "Rango de çegimiento de criaturâ",
	"attribute.name.generic.gravity": "Grabedá",
	"attribute.name.generic.jump_strength": "Potençia de çarto",
	"attribute.name.generic.knockback_resistance": "Reçîttençia al empuhe",
	"attribute.name.generic.luck": "Potra",
	"attribute.name.generic.max_absorption": "Âççorçión máççima",
	"attribute.name.generic.max_health": "Çalûh máççima",
	"attribute.name.generic.movement_efficiency": "Efiçiençia de mobimiento",
	"attribute.name.generic.movement_speed": "Beloçidá",
	"attribute.name.generic.oxygen_bonus": "Ôççíheno êttra",
	"attribute.name.generic.safe_fall_distance": "Dîttançia de caía çegura",
	"attribute.name.generic.scale": "Êccala",
	"attribute.name.generic.step_height": "Artura de paço",
	"attribute.name.generic.water_movement_efficiency": "Efiçiençia de mobimiento acuático",
	"attribute.name.gravity": "Grabedâh",
	"attribute.name.horse.jump_strength": "Potençia de çarto de la haca",
	"attribute.name.jump_strength": "Potençia de çarto",
	"attribute.name.knockback_resistance": "Reçîttençia al empuhe",
	"attribute.name.luck": "Potra",
	"attribute.name.max_absorption": "Âççorçión máççima",
	"attribute.name.max_health": "Çalûh máççima",
	"attribute.name.mining_efficiency": "Efiçiençia al rompêh bloquê",
	"attribute.name.movement_efficiency": "Efiçiençia de mobimiento",
	"attribute.name.movement_speed": "Beloçidâh",
	"attribute.name.nameplate_distance": "Distancia del identificador",
	"attribute.name.oxygen_bonus": "Ôççíheno êttra",
	"attribute.name.player.block_break_speed": "Beloçidâh al rompêh bloquê",
	"attribute.name.player.block_interaction_range": "Rango de interaççión con bloquê",
	"attribute.name.player.entity_interaction_range": "Rango de interaççión con entidadê",
	"attribute.name.player.mining_efficiency": "Efiçiençia al rompêh bloquê",
	"attribute.name.player.sneaking_speed": "Beloçidá al agaxarçe",
	"attribute.name.player.submerged_mining_speed": "Beloçidá al rompêh bloquê çumerhío",
	"attribute.name.player.sweeping_damage_ratio": "Proporçión der daño de barrío",
	"attribute.name.safe_fall_distance": "Dîttançia de caía çegura",
	"attribute.name.scale": "Êccala",
	"attribute.name.sneaking_speed": "Beloçidá al agaxarçe",
	"attribute.name.spawn_reinforcements": "Refuerçô çombi",
	"attribute.name.step_height": "Artura de paço",
	"attribute.name.submerged_mining_speed": "Beloçidá al rompêh bloquê çumerhío",
	"attribute.name.sweeping_damage_ratio": "Proporçión der daño de barrío",
	"attribute.name.tempt_range": "Radio d'atraççión de criaturâ",
	"attribute.name.water_movement_efficiency": "Efiçiençia de mobimiento acuático",
	"attribute.name.waypoint_receive_range": "Rango de Recepción de Waypoint",
	"attribute.name.waypoint_transmit_range": "Rango de transmiçión der punto de referencia",
	...
	"biome.minecraft.pale_garden": "Hardín Pálido",
	...
	"block.minecraft.acacia_shelf": "Êttante de acaçia",
	...
	"block.minecraft.bamboo_shelf": "Êttante de bambú",
	...
	"block.minecraft.banner.flow.black": "Êttampao êccuro d'êppirâh",
	"block.minecraft.banner.flow.blue": "Êttampao açûh d'êppirâh",
	"block.minecraft.banner.flow.brown": "Êttampao marrón d'êppirâh",
	"block.minecraft.banner.flow.cyan": "Êttampao çian d'êppirâh",
	"block.minecraft.banner.flow.gray": "Êttampao grîh d'êppirâh",
	"block.minecraft.banner.flow.green": "Êttampao berde d'êppirâh",
	"block.minecraft.banner.flow.light_blue": "Êttampao açûh claro d'êppirâh",
	"block.minecraft.banner.flow.light_gray": "Êttampao grîh claro d'êppirâh",
	"block.minecraft.banner.flow.lime": "Êttampao berde lima d'êppirâh",
	"block.minecraft.banner.flow.magenta": "Êttampao mahenta d'êppirâh",
	"block.minecraft.banner.flow.orange": "Êttampao naranha d'êppirâh",
	"block.minecraft.banner.flow.pink": "Êttampao roça d'êppirâh",
	"block.minecraft.banner.flow.purple": "Êttampao morao d'êppirâh",
	"block.minecraft.banner.flow.red": "Êttampao roho d'êppirâh",
	"block.minecraft.banner.flow.white": "Êttampao blanco d'êppirâh",
	"block.minecraft.banner.flow.yellow": "Êttampao amariyo d'êppirâh",
	...
	"block.minecraft.banner.guster.black": "Êttampao êccuro de breeze",
	"block.minecraft.banner.guster.blue": "Êttampao açûh de breeze",
	"block.minecraft.banner.guster.brown": "Êttampao marrón de breeze",
	"block.minecraft.banner.guster.cyan": "Êttampao çian de breeze",
	"block.minecraft.banner.guster.gray": "Êttampao grîh de breeze",
	"block.minecraft.banner.guster.green": "Êttampao berde de breeze",
	"block.minecraft.banner.guster.light_blue": "Êttampao açûh claro de breeze",
	"block.minecraft.banner.guster.light_gray": "Êttampao grîh claro de breeze",
	"block.minecraft.banner.guster.lime": "Êttampao berde lima de breeze",
	"block.minecraft.banner.guster.magenta": "Êttampao mahenta de breeze",
	"block.minecraft.banner.guster.orange": "Êttampao naranha de breeze",
	"block.minecraft.banner.guster.pink": "Êttampao roça de breeze",
	"block.minecraft.banner.guster.purple": "Êttampao morao de breeze",
	"block.minecraft.banner.guster.red": "Êttampao colorao de breeze",
	"block.minecraft.banner.guster.white": "Êttampao blanco de breeze",
	"block.minecraft.banner.guster.yellow": "Êttampao amariyo de breeze",
	...
	"block.minecraft.birch_shelf": "Êttante de abedûh",
	...
	"block.minecraft.bush": "Arbūhto",
	"block.minecraft.cactus": "Câttû",
	"block.minecraft.cactus_flower": "Flor que pinsha",
	...
	"block.minecraft.cherry_shelf": "Êttante de çereço",
	...
	"block.minecraft.chiseled_cinnabar": "Çinabrio çinçelao",
	"block.minecraft.chiseled_copper": "Cobre çinçelao",
	...
	"block.minecraft.chiseled_resin_bricks": "Ladriyôh de reçina çinçeláô",
	"block.minecraft.chiseled_sandstone": "Arbero êccurpío",
	"block.minecraft.chiseled_stone_bricks": "Ladriyô de roca êccurpía",
	"block.minecraft.chiseled_sulfur": "Açufre çinçelao",
	"block.minecraft.chiseled_tuff": "Toba çinçelá",
	"block.minecraft.chiseled_tuff_bricks": "Ladriyô de toba çinçeláô",
	...
	"block.minecraft.cinnabar_brick_slab": "Loça de ladriyô de çinabrio",
	"block.minecraft.cinnabar_brick_stairs": "Êccalerâ de ladriyô de çinabrio",
	...
	"block.minecraft.closed_eyeblossom": "Frô ôho çerráh",
	...
	"block.minecraft.copper_bars": "Barrotê de cobre",
	"block.minecraft.copper_block": "Bloque de cobre",
	"block.minecraft.copper_bulb": "Lámpara de cobre",
	"block.minecraft.copper_chain": "Caena de cobre",
	"block.minecraft.copper_chest": "Cofre de cobre",
	"block.minecraft.copper_door": "Puerta de cobre",
	"block.minecraft.copper_golem_statue": "Êttatua de gólem de cobre",
	"block.minecraft.copper_grate": "Rehiya de cobre",
	"block.minecraft.copper_lantern": "Farôh de cobre",
	"block.minecraft.copper_ore": "Beta de cobre",
	"block.minecraft.copper_torch": "Antorxa de cobre",
	"block.minecraft.copper_trapdoor": "Trampiya de cobre",
	"block.minecraft.copper_wall_torch": "Antorxa de cobre de paré",
	...
	"block.minecraft.crafter": "Fabricadôh",
	"block.minecraft.crafting_table": "Meça de crâtteo",
	"block.minecraft.creaking_heart": "Coraçón Cruhiente",
	...
	"block.minecraft.crimson_shelf": "Êttante carmeçí",
	...
	"block.minecraft.dark_oak_shelf": "Êttante de roble ôccuro",
	...
	"block.minecraft.dried_ghast": "Ghast çeco",
	...
	"block.minecraft.exposed_chiseled_copper": "Cobre çinçelao êppuêtto",
	"block.minecraft.exposed_copper": "Cobre êppuêtto",
	"block.minecraft.exposed_copper_bars": "Barrotê de cobre êppuêtto",
	"block.minecraft.exposed_copper_bulb": "Lámpa de cobre êppuêtto",
	"block.minecraft.exposed_copper_chain": "Cadena de cobre êppuêtto",
	"block.minecraft.exposed_copper_chest": "Cofre de cobre êppuêtto",
	"block.minecraft.exposed_copper_door": "Puerta de cobre êppuêtto",
	"block.minecraft.exposed_copper_golem_statue": "Êttatua de gólem de cobre êppuêtto",
	"block.minecraft.exposed_copper_grate": "Rejiya de cobre êppuêtto",
	"block.minecraft.exposed_copper_lantern": "Farôh de cobre êppuêtto",
	"block.minecraft.exposed_copper_trapdoor": "Trampiya de cobre êppuêtto",
	...
	"block.minecraft.exposed_lightning_rod": "Pararrayô êppuêtto",
	...
	"block.minecraft.firefly_bush": "Arbûtto de luçiérganâ",
	...
	"block.minecraft.golden_dandelion": "Diente de león dorao",
	...
	"block.minecraft.heavy_core": "Núcleo peçao",
	...
	"block.minecraft.iron_chain": "Cadena de ierro",
	...
	"block.minecraft.jungle_shelf": "Êttante de hungla",
	...
	"block.minecraft.leaf_litter": "Ohâ secâ",
	...
	"block.minecraft.mangrove_shelf": "Êttante de mangle",
	...
	"block.minecraft.oak_shelf": "Êttante de roble",
	...
	"block.minecraft.open_eyeblossom": "Oho-ê pêtalo abietto",
	...
	"block.minecraft.oxidized_chiseled_copper": "Cobre çinçelao ôççidao",
	"block.minecraft.oxidized_copper": "Cobre ôççidao",
	"block.minecraft.oxidized_copper_bars": "Barrotê de cobre ôççidao",
	"block.minecraft.oxidized_copper_bulb": "Lámpa de cobre ôççidao",
	"block.minecraft.oxidized_copper_chain": "Cadena de cobre ôççidao",
	"block.minecraft.oxidized_copper_chest": "Cofre de cobre ôççidao",
	"block.minecraft.oxidized_copper_door": "Puerta de cobre ôççidao",
	"block.minecraft.oxidized_copper_golem_statue": "Êttatua de gólem de cobre ôççidao",
	"block.minecraft.oxidized_copper_grate": "Rehiya de cobre ôççidao",
	"block.minecraft.oxidized_copper_lantern": "Farôh de cobre ôççidao",
	"block.minecraft.oxidized_copper_trapdoor": "Trampiya de cobre ôççidao",
	...
	"block.minecraft.oxidized_lightning_rod": "Pararrayô ôççidao",
	"block.minecraft.packed_ice": "Yelo compâttao",
	"block.minecraft.packed_mud": "Adobe",
	"block.minecraft.pale_hanging_moss": "Mûggo pálido corgante",
	"block.minecraft.pale_moss_block": "Mûggo pálido",
	"block.minecraft.pale_moss_carpet": "Arfombra de mûggo pálido",
	"block.minecraft.pale_oak_button": "Botón de quehigo pálido",
	"block.minecraft.pale_oak_door": "Puerta de quehigo pálido",
	"block.minecraft.pale_oak_fence": "Berha de quehigo pálido",
	"block.minecraft.pale_oak_fence_gate": "Cançela de quehigo pálido",
	"block.minecraft.pale_oak_hanging_sign": "Letrero corgante de quehigo pálido",
	"block.minecraft.pale_oak_leaves": "Ohâ de quehigo pálido",
	"block.minecraft.pale_oak_log": "Tronco de quehigo pálido",
	"block.minecraft.pale_oak_planks": "Tablonê de quehigo pálido",
	"block.minecraft.pale_oak_pressure_plate": "Placa de preçión de quehigo pálido",
	"block.minecraft.pale_oak_sapling": "Brote de quehigo pálido",
	"block.minecraft.pale_oak_shelf": "Êttante de roble pálido",
	"block.minecraft.pale_oak_sign": "Letrero de quehigo pálido",
	"block.minecraft.pale_oak_slab": "Bardoça de quehigo pálido",
	"block.minecraft.pale_oak_stairs": "Êccalerâ de quehigo pálido",
	"block.minecraft.pale_oak_trapdoor": "Trampiya de quehigo pálido",
	"block.minecraft.pale_oak_wall_hanging_sign": "Letrero corgante de quehigo pálido en paré",
	"block.minecraft.pale_oak_wall_sign": "Letrero de quehigo pálido en paré",
	"block.minecraft.pale_oak_wood": "Leño de quehigo pálido",
	...
	"block.minecraft.polished_tuff": "Toba pulía",
	"block.minecraft.polished_tuff_slab": "Loça de toba pulía",
	"block.minecraft.polished_tuff_stairs": "Êccalerâ de toba pulía",
	"block.minecraft.polished_tuff_wall": "Muro de toba pulía",
	...
	"block.minecraft.potted_closed_eyeblossom": "Flô d'óho çerrâh",
	...
	"block.minecraft.potted_golden_dandelion": "Maçeta con diente de león dorao",
	...
	"block.minecraft.potted_open_eyeblossom": "Flô d'óho abiêttah",
	"block.minecraft.potted_orange_tulip": "Tiêtto con tulipán naranha",
	"block.minecraft.potted_oxeye_daisy": "Tiêtto con margarita",
	"block.minecraft.potted_pale_oak_sapling": "Tiêtto con brote de quehigo pálido",
	...
	"block.minecraft.potted_torchflower": "Tiêtto con plantorxa",
	...
	"block.minecraft.resin_block": "Blôque de reçinah",
	"block.minecraft.resin_brick_slab": "Loça-ê bloque-ê reçina",
	"block.minecraft.resin_brick_stairs": "Eccalerah-ê bloque-ê reçina",
	"block.minecraft.resin_brick_wall": "Paré de ladrillo de resina",
	"block.minecraft.resin_bricks": "Bloqueh-ê resina",
	...
	"block.minecraft.short_dry_grass": "Yerbah secah i cortah",
	"block.minecraft.short_grass": "Ierba corta",
	...
	"block.minecraft.sniffer_egg": "Guebo d'olîqqueadôh",
	...
	"block.minecraft.spruce_shelf": "Êttante de abeto",
	...
	"block.minecraft.stripped_pale_oak_log": "Tronco de quehigo pálido çin corteça",
	"block.minecraft.stripped_pale_oak_wood": "Leño de quehigo pálido çin corteça",
	...
	"block.minecraft.suspicious_gravel": "Çaorra çôppexoça",
	"block.minecraft.suspicious_sand": "Arena çôppexoça",
	"block.minecraft.sweet_berry_bush": "Arbûtto de bayâ durçê",
	"block.minecraft.tall_dry_grass": "Yerbah secah i ártah",
	...
	"block.minecraft.test_block": "Bloque-ê pruêbesillah",
	"block.minecraft.test_instance_block": "Blôque d'îttançia",
	"block.minecraft.tinted_glass": "Crîttâh êccureçío",
	"block.minecraft.tnt": "TNT",
	"block.minecraft.tnt.disabled": "Lâh êpploçionê de TNT êttán deçactibâh",
	...
	"block.minecraft.trial_spawner": "Heneradôh de criaturâ de deçafío",
	...
	"block.minecraft.tuff_brick_slab": "Loça de ladriyô de toba",
	"block.minecraft.tuff_brick_stairs": "Êccalerâ de ladriyô de toba",
	"block.minecraft.tuff_brick_wall": "Muro de ladriyô de toba",
	"block.minecraft.tuff_bricks": "Ladriyô de toba",
	"block.minecraft.tuff_slab": "Loça de toba",
	"block.minecraft.tuff_stairs": "Êccalerâ de toba",
	...
	"block.minecraft.warped_shelf": "Êttante dîttorçionao",
	...
	"block.minecraft.waxed_chiseled_copper": "Cobre çinçelao ençerao",
	"block.minecraft.waxed_copper_bars": "Barrotê de cobre ençerao",
	"block.minecraft.waxed_copper_block": "Bloque de cobre ençerao",
	"block.minecraft.waxed_copper_bulb": "Lámpa de cobre ençerao",
	"block.minecraft.waxed_copper_chain": "Cadena de cobre ençerao",
	"block.minecraft.waxed_copper_chest": "Cofre de cobre ençerao",
	"block.minecraft.waxed_copper_door": "Puerta de cobre ençerao",
	"block.minecraft.waxed_copper_golem_statue": "Êttatua de gólem de cobre ençerao",
	"block.minecraft.waxed_copper_grate": "Rehiya de cobre ençerao",
	"block.minecraft.waxed_copper_lantern": "Farôh de cobre ençerao",
	"block.minecraft.waxed_copper_trapdoor": "Trampiya de cobre ençerao",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Cobre çinçelao êppuêtto ençerao",
	"block.minecraft.waxed_exposed_copper": "Cobre êppuêtto ençerao",
	"block.minecraft.waxed_exposed_copper_bars": "Barrotê de cobre êppuêtto ençerao",
	"block.minecraft.waxed_exposed_copper_bulb": "Lámpa de cobre êppuêtto ençerao",
	"block.minecraft.waxed_exposed_copper_chain": "Cadena de cobre êppuêtto ençerao",
	"block.minecraft.waxed_exposed_copper_chest": "Cofre de cobre êppuêtto ençera",
	"block.minecraft.waxed_exposed_copper_door": "Puerta de cobre êppuêtto ençerao",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Êttatua de gólem de cobre êppuêtto ençerao",
	"block.minecraft.waxed_exposed_copper_grate": "Rehiya de cobre êppuêtto ençerao",
	"block.minecraft.waxed_exposed_copper_lantern": "Farôh de cobre êppuêtto ençerao",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Trampiya de cobre êppuêtto ençerao",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Pararrayô êppuêtto ençerao",
	"block.minecraft.waxed_lightning_rod": "Pararrayô ençerao",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Cobre çinçelao ôççidao ençerao",
	"block.minecraft.waxed_oxidized_copper": "Cobre ôççidao ençerao",
	"block.minecraft.waxed_oxidized_copper_bars": "Barrotê de cobre ôççidao ençerao",
	"block.minecraft.waxed_oxidized_copper_bulb": "Lámpa de cobre ôççidao ençerao",
	"block.minecraft.waxed_oxidized_copper_chain": "Cadena de cobre ôççidao ençerao",
	"block.minecraft.waxed_oxidized_copper_chest": "Cofre de cobre ôççidao ençerao",
	"block.minecraft.waxed_oxidized_copper_door": "Puerta de cobre ôççidao ençerao",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Êttatua de gólem de cobre ôççidao ençerao",
	"block.minecraft.waxed_oxidized_copper_grate": "Rehiya de cobre ôççidao ençerao",
	"block.minecraft.waxed_oxidized_copper_lantern": "Farôh de cobre ôççidao ençerao",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Trampiya de cobre ôççidao ençerao",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Pararrayô ôççidao ençerao",
	"block.minecraft.waxed_weathered_chiseled_copper": "Cobre çinçelao degradao ençerao",
	"block.minecraft.waxed_weathered_copper": "Cobre corroío ençerao",
	"block.minecraft.waxed_weathered_copper_bars": "Barrotê de cobre degradao ençerao",
	"block.minecraft.waxed_weathered_copper_bulb": "Lámpa de cobre degradao ençerao",
	"block.minecraft.waxed_weathered_copper_chain": "Cadena de cobre degradao ençerao",
	"block.minecraft.waxed_weathered_copper_chest": "Cofre de cobre degradao ençerao",
	"block.minecraft.waxed_weathered_copper_door": "Puerta de cobre degradao ençerao",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Êttatua de gólem de cobre degradao ençerao",
	"block.minecraft.waxed_weathered_copper_grate": "Rehiya de cobre degradao ençerao",
	"block.minecraft.waxed_weathered_copper_lantern": "Farôh de cobre degradao ençerao",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Trampiya de cobre degradao ençerao",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Pararrayô degradao ençerao",
	"block.minecraft.weathered_chiseled_copper": "Cobre çinçelao degradao",
	"block.minecraft.weathered_copper": "Cobre corroío",
	"block.minecraft.weathered_copper_bars": "Barrotê de cobre degradao",
	"block.minecraft.weathered_copper_bulb": "Lámpa de cobre degradao",
	"block.minecraft.weathered_copper_chain": "Cadena de cobre degradao",
	"block.minecraft.weathered_copper_chest": "Cofre de cobre degradao",
	"block.minecraft.weathered_copper_door": "Puerta de cobre degradao",
	"block.minecraft.weathered_copper_golem_statue": "Êttatua de gólem de cobre degradao",
	"block.minecraft.weathered_copper_grate": "Rehiya de cobre degradao",
	"block.minecraft.weathered_copper_lantern": "Farôh de cobre degradao",
	"block.minecraft.weathered_copper_trapdoor": "Trampiya de cobre degradao",
	...
	"block.minecraft.weathered_lightning_rod": "Pararrayô degradao",
	...
	"block.minecraft.wildflowers": "Florê çirbêttrê",
	...
	"book.edit.title": "Pantaya de ediçión der libro",
	...
	"book.page_button.next": "Çigiente páhina",
	"book.page_button.previous": "Páhina anteriôh",
	"book.sign.title": "Pantaya de firma der libro",
	"book.sign.titlebox": "Título",
	"book.signButton": "Firmâh",
	"book.view.title": "Pantaya de bîtta der libro",
	"build.spawn_protection": "%s êttá baho protêççión de reapariçión",
	"build.tooHigh": "Er límite d'artura pa la côttrûççión êh %s",
	"build.tooLow": "La artura mínima pa côttruîh êh %s",
	...
	"chat.disabled.invalid_command_signature": "Er comando tenía firmâ d'argumentô de comando inesperâh o no tiene.",
	"chat.disabled.invalid_signature": "Er xâh tenía una firma no bálida. Intenta reconêttâh.",
	...
	"chat.disabled.out_of_order_chat": "Ç'a recibío er xâh deçordenao. ¿A abío argún cambio en la ora de tu dîppoçitibo?",
	"chat.disabled.profile": "Xâh no permitío por lô ahûttê de la cuenta. Purça '%s' de nuebo pa mâh informaçión.",
	...
	"chat.queue.tooltip": "Âh clîh pa môttrâh er çigiente mençahe",
	"chat.square_brackets": "[%s]",
	"chat.tag.error": "Er çerbidôh a embiao un mençahe no bálido.",
	...
	"chat.validation_error": "Errôh de balidaçión der xâh",
	"chat_restriction.chat_and_commands_disabled_by_options": "Xâh rêttrinhío en lô ahûttê der cliente.",
	"chat_restriction.chat_disabled_by_options": "Xâh de hugadorê rêttrinhío en lô ahûttê der cliente.",
	"chat_restriction.chat_disabled_by_options.action": "Îh a Ahûttê de xâh",
	"chat_restriction.disabled_by_launcher": "Xâh rêttrinhío por er lançadôh",
	"chat_restriction.disabled_by_profile": "Xâh rêttrinhío por lô ahûttê der perfîh.",
	"chat_restriction.disabled_by_profile.action": "Îh a lô ahûttê der perfîh",
	"chat_screen.commands_not_allowed": "No çe permite embiâh comandô",
	"chat_screen.message": "Mençahe pa embiâh: %s",
	"chat_screen.messages_not_allowed": "No çe permite embiâh mençahê en er xâh",
	"chat_screen.restricted": "Er xâh êttá rêttrinhío. Âh clîh en êtte mençahe pa mâh informaçión.",
	"chat_screen.restricted.narration": "Er xâh êttá rêttrinhío. Be a la pantaya Rêttrîççionê en Ôççionê der mundo.",
	"chat_screen.title": "Pantaya der xâh",
	"chat_screen.usage": "Êccribe un mençahe y purça Intro pa embiâl-lo",
	"chunk.toast.checkLog": "Mâh informaçión n'er rehîttro der huego",
	"chunk.toast.loadFailure": "Errôh al cargâh er chunk en %s",
	"chunk.toast.lowDiskSpace": "¡Queda poco êppaçio n'er dîcco!",
	"chunk.toast.lowDiskSpace.description": "Êh poçible que no çe puea guardâh er mundo.",
	"chunk.toast.saveFailure": "Errôh ar guardâh er chunk en %s",
	...
	"command.forkLimit": "Çe a arcançao er número máççimo de contêttô (%s)",
	"command.trailing_data": "Datô de çegimiento encontráô: %s",
	...
	"commands.attribute.base_value.reset.success": "Er balôh baçe der atributo %s pa la entidá %s ça rêttableçío en %s",
	...
	"commands.banlist.entry.unknown": "(Dêcconoçida)",
	...
	"commands.data.modify.invalid_substring": "Índiçê de çûccadena no bálidô: de %s á %s",
	"commands.data.storage.get": "%s n'er contenedôh %s, trâ un fâttôh êccala de %s, êh %s",
	"commands.data.storage.modified": "Ça modificao'r conteneôh %s",
	"commands.data.storage.query": "Er conteneôh %s tié: %s",
	"commands.datapack.create.already_exists": "Ya êççîtte un paquete con eçe nombre: %s",
	"commands.datapack.create.invalid_full_name": "Nombre de paquete nuebo no bálido '%s'",
	"commands.datapack.create.invalid_name": "Carâtterê no bálidôh en er nuevo nombre der paquete: %s",
	"commands.datapack.create.io_failure": "No ça podío creâh un paquete con er nombre «%s», rebiça lôh regîttrô",
	"commands.datapack.create.metadata_encode_failure": "Errôh ar codificâh lôh metadatos der paquete con er nombre «%s»: %s",
	"commands.datapack.create.success": "Ça creao un nuebo paquete vaçío con er nombre «%s»",
	"commands.datapack.disable.failed": "¡Er paquete de datô \"%s\" no êttaba âttibao!",
	"commands.datapack.disable.failed.feature": "¡Er paquete de datô \"%s\" no pué desâttibarçe porque êh parte d'una de lâh bariablê âttibâ!",
	...
	"commands.debug.function.noReturnRun": "No çe puede râttreâh con «/return run»",
	...
	"commands.dialog.clear.multiple": "Diálogo çerrao pa %s hugadorê",
	"commands.dialog.clear.single": "Diálogo çerrao pa %s",
	"commands.dialog.show.multiple": "Mostrando diálogo a %s hugadorê",
	...
	"commands.drop.no_loot_table.block": "Er bloque %s no tié tabla de botín",
	...
	"commands.execute.function.instantiationFailure": "Errôh al realiçâh la funçión %s: %s",
	...
	"commands.fetchprofile.copy_component": "Copiâh componente",
	"commands.fetchprofile.copy_text": "Copiâh %s",
	"commands.fetchprofile.entity.success": "Perfîh reçuerto pa la entidá %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Errôh ar çerialiçâh er perfîh: %s",
	"commands.fetchprofile.give_item": "Dâh ôhheto",
	"commands.fetchprofile.id.failure": "No çe a podío reçorbêh er perfîh pa la id. %s",
	"commands.fetchprofile.id.success": "Perfîh reçuerto pa la id. %s: %s",
	"commands.fetchprofile.name.failure": "No çe a podío reçorbêh er perfîh pa er nombre %s",
	"commands.fetchprofile.name.success": "Perfîh reçuerto pa er nombre %s: %s",
	"commands.fetchprofile.no_profile": "La entidá %s no tiene perfîh",
	"commands.fetchprofile.summon_mannequin": "Henerâh maniquí",
	...
	"commands.fillbiome.success.count": "%s entrâh de biomâ definidâ entre %s, %s, %s y %s, %s, %s",
	...
	"commands.function.error.argument_not_compound": "Tipo de argumento no bálido: %s, çe êpperaba Compound",
	"commands.function.error.missing_argument": "Ettá fartando er argumento %[2]s en la funçión %[1]s",
	"commands.function.error.missing_arguments": "Fartan argumentô en la funçión %s",
	"commands.function.error.parse": "Al ejecutar la macro %s: el comando «%s» provocó el error: %s",
	"commands.function.instantiationFailure": "Errôh ar realiçâh la funçión %s: %s",
	"commands.function.result": "La funçión «%s» ha debuerto %s",
	"commands.function.scheduled.multiple": "Funçionê en ehecuçión %s",
	"commands.function.scheduled.no_functions": "No çe an encontrao funçionê con er nombre %s",
	"commands.function.scheduled.single": "Funçión en ehecuçión %s",
	...
	"commands.kick.owner.failed": "No çe puede êppurçâh ar dueño de un mundo en LAN",
	"commands.kick.singleplayer.failed": "No çe puede êppulçâh en un mundo pâ un hugadôh",
	...
	"commands.place.template.invalid": "No ay plantiya con id %s",
	...
	"commands.profile_fetch.copy_component": "Copiâh componente",
	"commands.profile_fetch.failed_to_serialize": "Errôh ar çerialiçâh er perfîh: %s",
	"commands.profile_fetch.give_item": "Dâh ôhheto",
	"commands.profile_fetch.id.failure": "Errôh al reçorbêh er perfîh pa el id %s",
	"commands.profile_fetch.id.success": "Perfîh reçuerto pa el Id %s: %s",
	"commands.profile_fetch.name.failure": "Errôh al reçorbêh er perfîh pa er nombre %s",
	"commands.profile_fetch.name.success": "Perfîh reçuerto pa er nombre %s: %s",
	...
	"commands.random.error.range_too_large": "El interbalo der balôh aleatorio debe çêh, como máççimo, 2147483646",
	"commands.random.error.range_too_small": "El interbalo der balôh aleatorio debe çêh, como mínimo, 2",
	"commands.random.reset.all.success": "Reiniçiâh %s çecuençia(s) aleatoria(s)",
	"commands.random.reset.success": "Reiniçiâh çecuençia aleatoria %s",
	"commands.random.roll": "%s a çacao %s (entre %s y %s)",
	"commands.random.sample.success": "Balôh aleatorio: %s",
	...
	"commands.rotate.success": "S'á rotao %s",
	...
	"commands.schedule.macro": "No çe pué programâh una macro",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Ç'a deçâttibao l'attualiçaçión automática der nombre del ohetibo %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Ç'âttibao l'attualiçaçión automática der nombre del ohetibo %s",
	"commands.scoreboard.objectives.modify.displayname": "Ça cambiao'r nombre de %s a %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Ç'a eliminao er formato numérico predefinio del ohetibo %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Ç'a cambiao er formato numérico predefinio del ohetibo %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Ç'a eliminao er nombre de %s bichô en %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Ç'a eliminao er nombre de %s en %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Ç'a cambiao er nombre a %s a %s bichô en %s",
	"commands.scoreboard.players.display.name.set.success.single": "Ç'a cambiao er nombre de %s a %s en %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Ç'a eliminao er formato numérico de %s bichô en %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Ç'a eliminao er formato numérico de %s en %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Ç'a eliminao er formato numérico de %s bichô en %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Ç'a eliminao er formato numérico de %s en %s",
	...
	"commands.setidletimeout.success.disabled": "Ça deçâttibao er tiempo mâççimo d'inâttibidá de hugadorê",
	"commands.setworldspawn.failure.not_overworld": "Er punto de rapariçión der mundo çolo puede êttâh en la çuperfiçie",
	"commands.setworldspawn.success": "Ça cambiao'r punto d'apariçión der mundo a %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Çe a cambiao er punto de apariçión der mundo a %s, %s, %s [%s, %s] en %s",
	"commands.spawnpoint.success.multiple": "Ça cambiao'r punto d'apariçión a %s, %s, %s [%s] en %s pa %s hugaorê",
	"commands.spawnpoint.success.multiple.new": "Çe a cambiao er punto de apariçión a %s, %s, %s [%s, %s] en %s para %s hugadorê",
	"commands.spawnpoint.success.single": "Ça cambiao'r punto d'apariçión a %s, %s, %s [%s] en %s pa %s",
	"commands.spawnpoint.success.single.new": "Çe a cambiao er punto de apariçión a %s, %s, %s [%s, %s] en %s para %s",
	"commands.spectate.cannot_spectate": "%s no puede çêh ôççerbao",
	...
	"commands.stopwatch.already_exists": "Er cronómetro «%s» ya êççîtte",
	"commands.stopwatch.create.success": "Çe a creao er cronómetro «%s»",
	"commands.stopwatch.does_not_exist": "Er cronómetro «%s» no êççîtte",
	"commands.stopwatch.query": "Er cronómetro «%s» a êttao âttibo durante %ss",
	"commands.stopwatch.remove.success": "Çe a eliminao er cronómetro «%s»",
	"commands.stopwatch.restart.success": "Çe a reiniçiao er cronómetro «%s»",
	"commands.summon.failed": "No ça podío henerâh la entidá",
	"commands.summon.failed.peaceful": "Er môttruo no puede imbocarçe en la dificurtá Paçífico",
	...
	"commands.swing.failed.notliving": "No ay entidadê bibâ pa que çe mueban",
	"commands.swing.success.multiple": "%s entidadê an mobío çû braçô",
	"commands.swing.success.single": "%s a mobío un braço",
	...
	"commands.test.batch.starting": "Iniçiando entônno %s lote %s",
	"commands.test.clear.error.no_tests": "No s'á encontrâo pruèba ninguna pa quitah",
	"commands.test.clear.success": "S'án quitao %s ehtructura(h)",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Dâle pa copiâh en er portapapêleh",
	"commands.test.create.success": "Configuraçión creâh pa la prueba %s",
	"commands.test.error.no_test_containing_pos": "No ça podío encontrâh ningún caço de prueba que cottênga %s, %s, %s",
	"commands.test.error.no_test_instances": "No ça encontrao ningún caço de prueba",
	"commands.test.error.non_existant_test": "No s'â poîo 'ncontrâh la pruêba %s",
	"commands.test.error.structure_not_found": "No s'â poîo 'ncontrâh la ettructûa de pruêba %s",
	"commands.test.error.test_instance_not_found": "No ça podío encontrâh ningún bloque de caço de prueba",
	"commands.test.error.test_instance_not_found.position": "No ça podío encontrâh ningún bloque de caço de prueba en %s, %s, %s",
	"commands.test.error.too_large": "El tamaño de la estructura debe ser menor que %s bloques en cada eje",
	"commands.test.locate.done": "Se han encontrado %s estructura(s)",
	"commands.test.locate.found": "Estructura encontrada en: %s(distante: %s)",
	"commands.test.locate.started": "Se ha iniciado la búsqueda de estructuras de prueba, esto puede tardar un poco...",
	"commands.test.no_tests": "Çin prêbah keh corrêh",
	"commands.test.relative_position": "Poçiçión relattîa a %s: %s",
	"commands.test.reset.error.no_tests": "No s'â encottrâo ningûna pruêba pa' reiniçiâh",
	"commands.test.reset.success": "S'ân reiniçiâo %s ettructtúrâ(h)",
	"commands.test.run.no_tests": "Nigûna prêba encontrâh",
	"commands.test.run.running": "Ejecutando %s prueba(s)...",
	"commands.test.summary": "¡Prueba de juego completada! %s prueba(s) ejecutada",
	"commands.test.summary.all_required_passed": "Çan çuperao toâ-lâ pruebâ requeríâ :)",
	"commands.test.summary.failed": "%s prueba(s) requerida fallida :(",
	"commands.test.summary.optional_failed": "%s prueba(s) opcional fallida",
	"commands.tick.query.percentiles": "Perçentilê: P50: %s ms, P95: %s ms, P99: %s ms; muêttra: %s",
	"commands.tick.query.rate.running": "Bêh. de tics de dêttino: %s por çegundo.\nMedia de tiempo: %sms (dêttino: %sms)",
	"commands.tick.query.rate.sprinting": "Bêh. de tics de dêttino: %s por çegundo (înnorao, çolo como referençia).\nMedia de tiempo: %sms",
	"commands.tick.rate.success": "Çe a cambiao la bêh. de tics de dêttino a %s por çegundo",
	"commands.tick.sprint.report": "Arta beloçidá con %s tics por segundo o %s ms por tic",
	"commands.tick.sprint.stop.fail": "No ay tics a arta beloçidá en curço",
	"commands.tick.sprint.stop.success": "Çe a interrumpío un tîh a arta beloçidá",
	"commands.tick.status.frozen": "Er huego êttá conhelao",
	"commands.tick.status.lagging": "Er huego ç'está ejecutando, pero no puede mantenerse âttibo con la vel. de tics de dêttino",
	"commands.tick.status.running": "Er huego çe êttá ehecutando a beloçidá normâh",
	"commands.tick.status.sprinting": "Er huego êttá a arta beloçidá",
	"commands.tick.step.fail": "Errôh ar borbêh a la beloçidá normâh; er huego debe êttâh conhelao primero",
	"commands.tick.step.stop.fail": "No ay tics a beloçidá normâh en curço",
	"commands.tick.step.stop.success": "Çe a interrumpío un tîh a beloçidá normâh",
	"commands.tick.step.success": "Regulando %s tic(s)",
	"commands.time.no_default_clock": "No ay relôh predeterminao en la dimençión %s",
	"commands.time.no_time_marker_found": "Er marcadôh de tiempo %s no êççîtte pa el relôh %s",
	"commands.time.pause": "Çe a pauçao el relôh %s",
	"commands.time.query": "Ora: %s ticks",
	"commands.time.query.absolute": "El relôh %s êttá en %s tic(s)",
	"commands.time.query.gametime": "Er tiempo de huego êh de %s tic(s)",
	"commands.time.query.timeline": "La línea de tiempo %s êttá en %s tic(s)",
	"commands.time.query.timeline.repetitions": "La línea de tiempo %s çe a repetío %s beçê",
	"commands.time.rate": "Er relôh %s abançará a %sx su beloçidâh normâh",
	"commands.time.resume": "Çe a reanudao el relôh %s",
	"commands.time.set": "Tiempo ahûttao a %s",
	"commands.time.set.absolute": "Çe a êttableçío %s a %s tic(s)",
	"commands.time.set.time_marker": "Çe a êttableçío %s ar marcadôh de tiempo %s",
	"commands.time.wrong_timeline_for_clock": "La línea de tiempo %s no êh bálida pa el relôh %s",
	...
	"commands.transfer.error.no_players": "Debê êppeçificâh ar menô un hugadôh pa trâfferîh",
	"commands.transfer.success.multiple": "Trâffiriendo %s Hugadorê a %s:%s",
	"commands.transfer.success.single": "Trâffiriendo a %s a %s:%s",
	...
	"commands.waypoint.list.empty": "No ay ningún punto de referençia en %s",
	"commands.waypoint.list.success": "Ay %s puntô de referençia en %s: %s",
	"commands.waypoint.modify.color": "Er colôh der punto de referençia ara êh %s",
	"commands.waypoint.modify.color.reset": "Ça restableçío er colôh der punto de referençia",
	"commands.waypoint.modify.style": "Ça cambiao el êttilo der punto de referençia",
	...
	"connect.failed.transfer": "Errôh de conêççión ar trâfferîh ar çerbidôh",
	...
	"connect.transferring": "Trâffiriendo al nuebo çerbidôh...",
	"container.barrel": "Barrîh",
	"container.beacon": "Faro",
	"container.beehive.bees": "Abehâ: %s / %s",
	"container.beehive.honey": "Miêh: %s / %s",
	...
	"container.upgrade.error_tooltip": "Êtte ôhheto no puede mehorarçe d'êtta manera",
	"container.upgrade.missing_template_tooltip": "Añad'un morde d'errería",
	...
	"createWorld.customize.buffet.search": "Bûccâh...",
	...
	"createWorld.customize.presets.list": "Artênnatibamente, ¡aquí tienê unâ que emô exo antê!",
	...
	"dataPack.locator_bar.description": "Mostrâh la dirêççión d'otrô hugadorê en multijugadôh",
	"dataPack.locator_bar.name": "Barra localiçadora",
	"dataPack.minecart_improvements.description": "Mehorâ n'er mobimiento de lâ bagonetâ",
	"dataPack.minecart_improvements.name": "Mehorâ de bagonetâ",
	"dataPack.redstone_experiments.description": "Cambiô de redstone êpperimentalê",
	"dataPack.redstone_experiments.name": "Êpperimentô de redstone",
	"dataPack.title": "Çelêççionâh paquetê de datô",
	"dataPack.trade_rebalance.description": "Âttualiçaçión de lô comerçiô con ardeanô",
	"dataPack.trade_rebalance.name": "Ahûttê der comerçio con ardeanô",
	...
	"dataPack.update_1_21.description": "Nuebâ carâtterítticâ y contenío pa Minecraft 1.21",
	"dataPack.update_1_21.name": "Âttualiçaçión 1.21",
	...
	"dataPack.winter_drop.description": "Nuebâ carâtterítticâ y contenío de l'actâliçaçîón d'invêhno",
	"dataPack.winter_drop.name": "Lançamiento d'Invierno",
	...
	"death.attack.genericKill": "%[1]s ça morío",
	"death.attack.genericKill.player": "%[1]s ça morío de mientrâ luxaba contra %[2]s",
	...
	"death.attack.inFire.player": "%[1]s ça metío en to'r fuego de mientrâ luxaba contra %[2]s",
	...
	"death.attack.mace_smash": "%[1]s a çío êppaxurrao por %[2]s",
	"death.attack.mace_smash.item": "%[1]s a çío êppaxurrao por %[2]s con %[3]s",
	...
	"death.attack.outsideBorder": "%[1]s a abandonao lô confinê d'êtte mundo",
	"death.attack.outsideBorder.player": "%[1]s a abandonao lô confinê d'êtte mundo de mientrâ luxaba contra %[2]s",
	...
	"death.attack.spear": "%[1]s fue ençartao por %[2]s",
	"death.attack.spear.item": "%[1]s fue ençartao por %[2]s utiliçando %[3]s",
	...
	"deathScreen.score.value": "Puntuaçión: %s",
	...
	"debug.crash.message.rebindable": "Êttâh purçando %s + %s. Çi no lâ çuertâ, er huego dehará de funçionâh.",
	...
	"debug.dump_dynamic_textures.help": "F3 + S = Êpportâh têtturâ dinámicâ",
	"debug.entry.always": "Çiempre",
	"debug.entry.currently.alwaysOn": "%s: Âttuarmente çiempre",
	"debug.entry.currently.inF3": "%s: Âttuarmente çolo en F3",
	"debug.entry.currently.inOverlay": "%s: Çolo en çuperpoçiçión de depuraçión",
	"debug.entry.currently.never": "%s: Âttuarmente apagao",
	"debug.entry.f3": "En F3",
	"debug.entry.overlay": "En çuperpoçiçión",
	...
	"debug.options.category.renderer": "Renderiçadorê de depuraçión",
	"debug.options.category.text": "Têtto de pantaya de depuraçión",
	"debug.options.help": "F3 + F5 = Editâh ôççionê de depuraçión",
	"debug.options.notAllowed.tooltip": "No êh biçible cuando la informaçión de depuraçión êttá reduçida",
	"debug.options.profile.default": "Perfîh por defêtto",
	"debug.options.profile.performance": "Perfîh de rendimiento",
	"debug.options.search": "Bûccâh ôççionê",
	"debug.options.title": "Ôççionê de deçarroyo",
	"debug.options.warning": "Êttâ ôççionê êttán dêttinâh pa finê de prueba. Podrían ralentiçâh tu ordenadôh, açêh que er huego dehe de funçionâh... o abrîh un aguhero negro.",
	...
	"debug.profiling.start.rebindable": "Iniçiao perfilao durante %s çegundô. Uça %s + %s pa detenêl-lo antê",
	...
	"debug.version.header": "Informaçión de la berçión der cliente:",
	"debug.version.help": "F3 + V = Informaçión de la berçión der cliente",
	...
	"disconnect.ignoring_status_request": "Înnorando çoliçitûh d'êttao",
	...
	"disconnect.packetError": "Errôh de protocolo de rêh",
	"disconnect.spam": "Êppurçao por spam",
	"disconnect.timeout": "Tiempo d'êppera agotao",
	"disconnect.transfer": "Trâfferío a otro çerbidôh",
	"disconnect.unknownHost": "Anfitrión dêcconoçío",
	"download.pack.failed": "No ç'an podío dêccargâh %s de %s paquetê",
	"download.pack.progress.bytes": "Progreço: %s (tamaño totâh dêcconoçío)",
	"download.pack.progress.percent": "Progreço: %s %%",
	"download.pack.title": "Dêccargando paquete de recurçô %s/%s",
	"editGamerule.default": "Por defêtto: %s",
	"editGamerule.inGame.button": "Editâh lâ reglâ der huego...",
	"editGamerule.inGame.disabled.tooltip": "Cambiâh lâ reglâ der huego requiere permiçô de âmminîttradôh.",
	"editGamerule.inGame.discardChanges.message": "¿Çeguro que quierê dêccartâh tû cambiô?",
	"editGamerule.inGame.discardChanges.title": "Cambiô a lâ reglâ der huego",
	"editGamerule.inGame.downloadingGamerules": "Ôtteniendo lâ reglâ der huego...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Aliento der nautilo",
	...
	"effect.minecraft.infested": "Infêttaçión",
	...
	"effect.minecraft.oozing": "Mucoçidá",
	"effect.minecraft.poison": "Beneno",
	"effect.minecraft.raid_omen": "Presahio d'imbaçión",
	...
	"effect.minecraft.trial_omen": "Preçahio de deçafío",
	"effect.minecraft.unluck": "Mala çuerte",
	"effect.minecraft.water_breathing": "Ânnea",
	"effect.minecraft.weakness": "Debilidá",
	"effect.minecraft.weaving": "Teheúra",
	"effect.minecraft.wind_charged": "Çierço",
	...
	"enchantment.minecraft.breach": "Fiçura",
	"enchantment.minecraft.channeling": "Condûttibidá",
	"enchantment.minecraft.density": "Dençidá",
	...
	"enchantment.minecraft.lunge": "Êttocá",
	...
	"enchantment.minecraft.wind_burst": "Aeroimpurço",
	"entity.minecraft.acacia_boat": "Barca de mimoça",
	"entity.minecraft.acacia_chest_boat": "Barca de mimoça con baûh",
	"entity.minecraft.allay": "Allay",
	"entity.minecraft.area_effect_cloud": "Nube d'efêtto perçîttente",
	"entity.minecraft.armadillo": "Armaíyo",
	"entity.minecraft.armor_stand": "Maniquí",
	"entity.minecraft.arrow": "Flexa",
	"entity.minecraft.axolotl": "Aholote",
	"entity.minecraft.bamboo_chest_raft": "Barsa de bambú con cofre",
	"entity.minecraft.bamboo_raft": "Barsa de bambú",
	"entity.minecraft.bat": "Murçiégalo",
	"entity.minecraft.bee": "Abeha",
	"entity.minecraft.birch_boat": "Barca de xopo",
	"entity.minecraft.birch_chest_boat": "Barca de xopo con baûh",
	"entity.minecraft.blaze": "Blaze",
	"entity.minecraft.block_display": "Bloque olográfico",
	"entity.minecraft.boat": "Barca",
	"entity.minecraft.bogged": "Çiénago",
	"entity.minecraft.breeze": "Breeze",
	"entity.minecraft.breeze_wind_charge": "Carga de biento",
	"entity.minecraft.camel": "Cameyo",
	"entity.minecraft.camel_husk": "Cameyo diçecao",
	"entity.minecraft.cat": "Gato",
	"entity.minecraft.cave_spider": "Araña de cueba",
	"entity.minecraft.cherry_boat": "Barca de çereço",
	"entity.minecraft.cherry_chest_boat": "Barca de çereço con baûh",
	...
	"entity.minecraft.creaking": "Crujío",
	"entity.minecraft.creaking_transient": "Crujío",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Barca de xaparro",
	"entity.minecraft.dark_oak_chest_boat": "Barca de xaparro con baûh",
	...
	"entity.minecraft.happy_ghast": "Ghast felîh",
	...
	"entity.minecraft.jungle_boat": "Barca de hungla",
	"entity.minecraft.jungle_chest_boat": "Barca de hungla con baûh",
	...
	"entity.minecraft.lingering_potion": "Poçiôn peçîttente",
	...
	"entity.minecraft.mangrove_chest_boat": "Barca de mangle con baûh",
	...
	"entity.minecraft.oak_boat": "Barca de quehigo",
	"entity.minecraft.oak_chest_boat": "Barca de quehigo con baûh",
	"entity.minecraft.ocelot": "Oçelote",
	"entity.minecraft.ominous_item_spawner": "Hene'ado' de ojetoh hominoho",
	"entity.minecraft.painting": "Cuadro",
	"entity.minecraft.pale_oak_boat": "Barca de quehigo pálido",
	"entity.minecraft.pale_oak_chest_boat": "Barca de quehigo pálido con baûh",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Momificao",
	...
	"entity.minecraft.sniffer": "Olîqqueadôh",
	...
	"entity.minecraft.splash_potion": "Poçiôn lançable",
	"entity.minecraft.spruce_boat": "Barca de pinçapo",
	"entity.minecraft.spruce_chest_boat": "Barca de pinçapo con baûh",
	...
	"entity.minecraft.wind_charge": "Carga de biento",
	...
	"entity.minecraft.zombie_nautilus": "Nautilo çombi",
	...
	"event.minecraft.raid.defeat.full": "Imbaçión - Derrota",
	"event.minecraft.raid.raiders_remaining": "Çaqueaorê rêttantê: %s",
	"event.minecraft.raid.victory": "Bîttoria",
	"event.minecraft.raid.victory.full": "Imbaçión - Bîttoria",
	"filled_map.buried_treasure": "Mapa der teçoro enterrao",
	"filled_map.explorer_jungle": "Mapa de templo de hungla",
	...
	"filled_map.trial_chambers": "Mapa de cámara de deçafío",
	"filled_map.unknown": "Mapa dêcconoçío",
	"filled_map.village_desert": "Mapa d'ardea de deçierto",
	"filled_map.village_plains": "Mapa d'ardea de yanura",
	"filled_map.village_savanna": "Mapa d'ardea de sabana",
	"filled_map.village_snowy": "Mapa d'ardea de yanura nebá",
	"filled_map.village_taiga": "Mapa d'ardea de yanura",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Permitîh Nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Controla çi lô hugadorê pueden ingreçâh ar Nether o no",
	"gamerule.allowFireTicksAwayFromPlayer": "Garrapata dispara lejos de los jugadores",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Controla si el fuego y la lava deben poder alejarse más de 8 trozos de cualquier jugador",
	...
	"gamerule.commandBlocksEnabled": "Permitîh bloquê de comandô",
	...
	"gamerule.disablePlayerMovementCheck": "Deçattibâh e'cottrôh de mobimiêtto de loh hugadôreh",
	...
	"gamerule.enableCommandBlocks": "Permitîh bloquê de comandô",
	"gamerule.enderPearlsVanishOnDeath": "Pel-lâ d'Ender lanzâ deçapareçen ar morîh",
	"gamerule.enderPearlsVanishOnDeath.description": "Lâ pel-lâ d'Ender lanzâ por un hugadôh deçapareçen cuando êtte muere.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Lâh entidadê con paçaherô puen utiliçâh portalê",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Permite a lâ entidadê biahâh con pasaherô a travêh de portalê der Nether, del End y nêççô del End.",
	...
	"gamerule.locatorBar": "Uçâh barra localiçadora de hugadorê",
	"gamerule.locatorBar.description": "Cuando êttá âttibâh, çe muêttra una barra en la pantaya qu'indica la dirêççión d'otrô hugadorê.",
	"gamerule.logAdminCommands": "Notificâh uço de comandô de âmmin",
	"gamerule.maxCommandChainLength": "Límite de comandô encadenáô",
	"gamerule.maxCommandChainLength.description": "Ç'aplica a lâ caenâ de bloquê de comandô y funçionê.",
	"gamerule.maxCommandForkCount": "Límite de contêttos der comando",
	"gamerule.maxCommandForkCount.description": "Er número máççimo de contêttos que çe pueden utiliçâh en comandô como «execute as».",
	"gamerule.maxEntityCramming": "Límite d'entidadê por bloque",
	"gamerule.minecartMaxSpeed": "Beloçidá mâççima de lâ bagonetâ",
	"gamerule.minecartMaxSpeed.description": "Beloçidá mâççima por defêtto d'una bagoneta por tierra",
	"gamerule.minecraft.elytra_movement_check": "Comprobâh mobimiento con élitrô",
	"gamerule.minecraft.fire_spread_radius_around_player": "Radio de propagaçión der fuego",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "El radio en bloquê arrededôh de un hugadôh en er que er fuego puede êppandirçe",
	"gamerule.minecraft.player_movement_check": "Comprobâh mobimiento der hugadôh",
	"gamerule.minecraft.raids": "Imbaçionê",
	"gamerule.minecraft.universal_anger.description": "Lâ criaturâ neutralê que êttén enfadâh atacarán a cuarquiêh hugadôh çercano, no çolo ar que lâ iço enfadâh. Funçiona mehôh çi «Perdonâh hugadorê muertô» çe deçâttiba.",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Tiempo de êppera para teletranpportarçe ar Nether en er modo creatibo",
	"gamerule.playersNetherPortalCreativeDelay.description": "Tiempo (en tics) que neceçita pasâh un hugadôh sobre er portâh en modo creatibo pa cambiâh de dimençión.",
	"gamerule.playersNetherPortalDefaultDelay": "Tiempo de êppera pa teletranpportarçe ar Nether en modô que no sean creatibo",
	"gamerule.playersNetherPortalDefaultDelay.description": "Tiempo (en tics) que neçeçita paçâh un hugadôh çobre er portâh en modô que no çean creatibo pa cambiâh de dimençión.",
	...
	"gamerule.projectilesCanBreakBlocks": "Lô proyectilê pueden rompêh bloquê",
	"gamerule.projectilesCanBreakBlocks.description": "Controla çi el impâtto de proyectilè destruirá bloquê a lô que normarmente puede dêttruir.",
	"gamerule.pvp": "Permitîh PvP",
	"gamerule.pvp.description": "Controla çi lô hugadorê pueden dañâh a otrô hugadorê o no",
	...
	"gamerule.spawnChunkRadius": "Radio der punto de reapariçión",
	"gamerule.spawnChunkRadius.description": "Cantidá de xunks que çe mantienen cargáô arrededôh der punto de reapariçión.",
	"gamerule.spawnMonsters": "Henerâh môttruô",
	"gamerule.spawnMonsters.description": "Controla çi lô môttruô apareçen naturarmente o no",
	"gamerule.spawnRadius": "Radio der punto de reapariçión",
	"gamerule.spawnRadius.description": "Controla er tamaño de la çona arrededôh der punto de reapariçión donde pueden apareçêh lô hugadorê.",
	"gamerule.spawnerBlocksEnabled": "Permitîh heneradorê de criaturâ",
	...
	"gui.abuseReport.attestation": "Al embiâh êtte informe, confirmâ que la informaçión que proporçionâ êh corrêtta y êttá completa.",
	"gui.abuseReport.comments": "Comentariô",
	"gui.abuseReport.describe": "Ar compartîh detayê, nô ayudâ a tomâh una deçiçión adecuá.",
	"gui.abuseReport.discard.content": "Çi çalê, êtta denuncia y tû comentariô çe dêccartarán.\n¿Êttás çeguro que quierê çalîh?",
	"gui.abuseReport.discard.discard": "Çalîh y dêccartâh denunçia",
	"gui.abuseReport.discard.draft": "Guardâh borradôh",
	"gui.abuseReport.discard.return": "Çegîh editando",
	"gui.abuseReport.discard.title": "¿Dêccartâh denunçia y comentariô?",
	"gui.abuseReport.draft.content": "¿Te gûttaría çegîh editando la denunçia ya êççîttente o prefierê dêccartâl-la y creâh una nueba?",
	"gui.abuseReport.draft.discard": "Dêccartâh",
	"gui.abuseReport.draft.edit": "Çeguîh editando",
	"gui.abuseReport.draft.quittotitle.content": "¿Quierê çegîh editándolo o quierê dêccartâl-lo?",
	"gui.abuseReport.draft.quittotitle.title": "Tienê un borradôh de denunçia de xâh que çe perderá çi te çalê",
	"gui.abuseReport.draft.title": "¿Editâh er borradôh de la denunçia de xâh?",
	"gui.abuseReport.error.title": "Problema al embiâh tu denunçia",
	"gui.abuseReport.message": "¿Ónde hâ observao er mar comportamiento?\nÊtto nô ayudará a inbêttigâh tu caço.",
	"gui.abuseReport.more_comments": "Por favôh dêccribe lo suçedido:",
	"gui.abuseReport.name.comment_box_label": "Dêccribe por qué quierê reportâh êtte nombre:",
	"gui.abuseReport.name.reporting": "Êttás denunçiando a «%s».",
	"gui.abuseReport.name.title": "Denunçiâh nombre de hugadôh",
	"gui.abuseReport.observed_what": "¿Por qué êttâ denunçiando êtto?",
	"gui.abuseReport.read_info": "Mâh informaçión çobre lâ denunçiâ",
	...
	"gui.abuseReport.reason.generic": "Quiero denunçiâl-lo/a",
	"gui.abuseReport.reason.generic.description": "Me molêttó / âh exo argo que no me gûtta.",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Temâ o contenío de naturaleça çêççuâh",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Âppêttô que muêttran elementô de naturaleça çêççuâh, órganô çêççualê o biolencia çêççuâh.",
	...
	"gui.abuseReport.report_sent_msg": "Hemô reçibío tu denunçia, ¡munxâ graçiâ!\n\nNuêttro equipo la rebiçará lo máh pronto poçible.",
	"gui.abuseReport.select_reason": "Elehîh categoría de denunçia",
	"gui.abuseReport.send": "Embiâh denunçia",
	"gui.abuseReport.send.comment_too_long": "Por fabôh, acorta el informe",
	...
	"gui.abuseReport.send.no_reason": "Elihe una categoría pa la denunçia",
	"gui.abuseReport.send.not_attested": "Lee er têtto y açegúrate de marcâh la caçiya pa embiâh el informe",
	...
	"gui.abuseReport.skin.title": "Denunçiâh âppêtto der hugadôh",
	"gui.abuseReport.title": "Denunçiâh hugadôh",
	"gui.abuseReport.type.chat": "Mençahê de xâh",
	"gui.abuseReport.type.name": "Nombre der hugadôh",
	"gui.abuseReport.type.skin": "Âppêtto der hugadôh",
	...
	"gui.banned.name.description": "Tu nombre âttuâh, \"%s\", incumple nuêttrô êttándarê comunitariô. Puedê hugâh en mundô de un hugadôh, pero debê cambiâh tu nombre pa hugâh en murtihugadôh.\n\nAprende mâh o çoliçita una rebiçión der caço en er çigiente enlaçe: %s",
	"gui.banned.name.title": "Nombre no permitío en murtihugadôh",
	"gui.banned.reason.defamation_impersonation_false_information": "Çuplantaçión o intercambio de informaçión pa engañâh o aprobexarçe d'otrô",
	...
	"gui.banned.reason.hate_speech": "Dîccurço d'odio o dîccriminaçión",
	"gui.banned.reason.hate_terrorism_notorious_figure": "Referençiâ a gripô d'odio, organiçaçionê terrorîtta o figurâ notoriâ",
	...
	"gui.banned.reason.spam_or_advertising": "Spam o publiçidá",
	"gui.banned.skin.description": "Tu âppêtto âttuâh incumple nuêttrô êttándarê comunitariô. Puedê hugâh con un âppêtto predeterminao, o çelêççionâh uno nuebo.\n\nAprende mâh o çoliçita una rebiçión der caço en er çigiente enlaçe: %s",
	"gui.banned.skin.title": "Âppêtto no permitío",
	...
	"gui.copy_link_to_clipboard": "Copiâh enlaçe ar portapapelê",
	"gui.days": "%s día(â)",
	"gui.done": "Lîtto",
	"gui.down": "Abaho",
	"gui.entity_tooltip.type": "Tipo: %s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "%s arxibô rexaçáô",
	"gui.fileDropFailure.title": "Errôh al añadîh arxibô",
	...
	"gui.game_rule.search": "Bûccâh...",
	"gui.hours": "%s ora(â)",
	"gui.language.search": "Bûccâh...",
	...
	"gui.none": "Ninguno",
	"gui.ok": "Açêttâh",
	"gui.open_report_dir": "Abrîh carpeta d'informê",
	"gui.packSelection.search": "Bûccâh...",
	...
	"gui.recipebook.next_page": "Çigiente páhina",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Páhina anteriôh",
	...
	"gui.remove": "Eliminar",
	"gui.report_to_server": "Informâh ar çerbidôh",
	"gui.selectWorld.search": "Bûccâh...",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Êtte hugadôh no puede çêh denunçiao porque er xâh êttá deçâttibao o bloqueao",
	...
	"gui.stats.none_found": "No çe encontraron êttadítticâ.",
	...
	"gui.togglable_slot": "Âh clîh pa deçâttibâh el êppaçio",
	"gui.up": "Arriba",
	"gui.waitingForResponse.button.inactive": "Atrâh (%ss)",
	"gui.waitingForResponse.title": "Êpperando ar Çerbidôh",
	"gui.yes": "Çí",
	...
	"inventory.hotbarInfo": "Guarda la barra rápida con %[1]s+%[2]s",
	...
	"item.canUse.unknown": "Dêcconoçío",
	"item.color": "Colôh: %s",
	"item.components": "%s componente(ê)",
	"item.disabled": "Ôhheto deçâttibao",
	"item.durability": "Durabilidá: %s / %s",
	"item.dyed": "Tintao",
	"item.intangible": "Intanhible",
	...
	"item.minecraft.angler_pottery_shard": "Frâmmento de çerámica de pêccadôh",
	"item.minecraft.angler_pottery_sherd": "Frâmmento de çerámica de caña de pêccâh",
	"item.minecraft.apple": "Pero",
	"item.minecraft.archer_pottery_shard": "Frâmmento de çerámica d'arquero",
	"item.minecraft.archer_pottery_sherd": "Frâmmento de çerámica de arco",
	"item.minecraft.armadillo_scute": "Êccama d'armaíyo",
	"item.minecraft.armadillo_spawn_egg": "Guebo heneradôh d'armadiyo",
	...
	"item.minecraft.black_bundle": "Çaco êccuro",
	"item.minecraft.black_dye": "Tinte êccuro",
	"item.minecraft.black_harness": "Arnêh",
	...
	"item.minecraft.blue_bundle": "Çaco açûh",
	"item.minecraft.blue_dye": "Tinte açûh",
	"item.minecraft.blue_egg": "Guebo açûh",
	"item.minecraft.blue_harness": "Arnêh açûh",
	"item.minecraft.bogged_spawn_egg": "Henerâh çiénago",
	"item.minecraft.bolt_armor_trim_smithing_template": "Morde d'errería",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Diçeño de remaxê",
	"item.minecraft.bone": "Gueço",
	"item.minecraft.bone_meal": "Harina de gueço",
	"item.minecraft.book": "Libro",
	"item.minecraft.bordure_indented_banner_pattern": "Êttampao de bordura dentá",
	"item.minecraft.bow": "Arco",
	"item.minecraft.bowl": "Taçón",
	"item.minecraft.bread": "Pan",
	"item.minecraft.breeze_rod": "Bara de breeze",
	"item.minecraft.breeze_spawn_egg": "Henerâh breeze",
	...
	"item.minecraft.brown_bundle": "Çaco marrón",
	"item.minecraft.brown_dye": "Tinte marrón",
	"item.minecraft.brown_egg": "Guebo marrôh",
	"item.minecraft.brown_harness": "Arnêh marrón",
	"item.minecraft.brush": "Broxa",
	"item.minecraft.bucket": "Barde",
	"item.minecraft.bundle": "Talega",
	"item.minecraft.bundle.empty": "Baçía",
	"item.minecraft.bundle.empty.description": "Pué contenêh una pila mîtta d'ôhhetô",
	"item.minecraft.bundle.full": "Yena",
	...
	"item.minecraft.camel_husk_spawn_egg": "Henerâh cameyo diçecao",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Morde d'errería",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Diçeño d'armaúra côttera",
	...
	"item.minecraft.copper_axe": "Axa de cobre",
	"item.minecraft.copper_boots": "Botâ de cobre",
	"item.minecraft.copper_chestplate": "Peto de cobre",
	"item.minecraft.copper_golem_spawn_egg": "Henerâh gólem de cobre",
	"item.minecraft.copper_helmet": "Câcco de cobre",
	"item.minecraft.copper_hoe": "Açá de cobre",
	"item.minecraft.copper_horse_armor": "Armaúra de cobre pa haca",
	"item.minecraft.copper_ingot": "Lingote de cobre",
	"item.minecraft.copper_leggings": "Grebâ de cobre",
	"item.minecraft.copper_nautilus_armor": "Armaúra de cobre pa nautilo",
	...
	"item.minecraft.crossbow.projectile.multiple": "Proyettîh: %s x %s",
	"item.minecraft.crossbow.projectile.single": "Proyettîh: %s",
	"item.minecraft.cyan_bundle": "Çaco çiân",
	"item.minecraft.cyan_dye": "Tinte çian",
	"item.minecraft.cyan_harness": "Arnêh çian",
	...
	"item.minecraft.diamond_nautilus_armor": "Armaúra de diamante pa nautilo",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Morde d'errería",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Diçeño d'armaúra de lâh dunâh",
	...
	"item.minecraft.eye_armor_trim_smithing_template": "Morde d'errería",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Diçeño d'armaúra d'ohôs",
	"item.minecraft.feather": "Pluma",
	"item.minecraft.fermented_spider_eye": "Oho d'araña fermentao",
	"item.minecraft.field_masoned_banner_pattern": "Etampâo d'eppirâh",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Morde d'errería",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Diçeño d'armaúra d'eppirâh",
	"item.minecraft.flow_banner_pattern": "Diseño d'êttandarte",
	"item.minecraft.flow_banner_pattern.desc": "Êttampao d'êppirâh",
	"item.minecraft.flow_banner_pattern.new": "Etampâo d'eppirâh",
	"item.minecraft.flow_pottery_sherd": "Frâmmento de çerámica d'êppirâh",
	"item.minecraft.flower_banner_pattern": "Patrón d'êttandarte",
	"item.minecraft.flower_banner_pattern.desc": "Êttampao de flôh",
	"item.minecraft.flower_banner_pattern.new": "Etampâo de flôreh",
	...
	"item.minecraft.globe_banner_pattern.new": "Etampâo de planêta",
	...
	"item.minecraft.golden_nautilus_armor": "Armaúra d'oro pa nautilo",
	"item.minecraft.golden_pickaxe": "Êppioxa d'oro",
	"item.minecraft.golden_shovel": "Pala d'oro",
	"item.minecraft.golden_spear": "Lança de oro",
	"item.minecraft.golden_sword": "Êppá d'oro",
	"item.minecraft.gray_bundle": "Çaco grîh",
	"item.minecraft.gray_dye": "Tinte grîh",
	"item.minecraft.gray_harness": "Arnêh grîh",
	"item.minecraft.green_bundle": "Çaco berde",
	"item.minecraft.green_dye": "Tinte berde",
	"item.minecraft.green_harness": "Arnêh berde",
	"item.minecraft.guardian_spawn_egg": "Guebo heneradôh de guardián",
	"item.minecraft.gunpowder": "Pórbora",
	"item.minecraft.guster_banner_pattern": "Diseño d'êttandarte",
	"item.minecraft.guster_banner_pattern.desc": "Buster",
	"item.minecraft.guster_banner_pattern.new": "Etampâo de brîça",
	"item.minecraft.guster_pottery_sherd": "Fragmento de cerâmica buster ",
	"item.minecraft.happy_ghast_spawn_egg": "Henerâh ghast felîh",
	"item.minecraft.harness": "Arnêh",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Morde d'errería",
	"item.minecraft.host_armor_trim_smithing_template.new": "Diçêño d'amadúrah d'anfitrióh",
	...
	"item.minecraft.iron_nautilus_armor": "Armaúra de yerro pa nautilo",
	...
	"item.minecraft.iron_spear": "Lança de yerro",
	...
	"item.minecraft.light_blue_bundle": "Çaco açûh claro",
	"item.minecraft.light_blue_dye": "Tinte açûh claro",
	"item.minecraft.light_blue_harness": "Arnêh açûh claro",
	"item.minecraft.light_gray_bundle": "Çaco grîh clâo",
	"item.minecraft.light_gray_dye": "Tinte grîh claro",
	"item.minecraft.light_gray_harness": "Arnêh grîh claro",
	"item.minecraft.lime_bundle": "Çaco bêrde clâo",
	"item.minecraft.lime_dye": "Tinte lima",
	"item.minecraft.lime_harness": "Arnêh berde lima",
	...
	"item.minecraft.lingering_potion.effect.infested": "Poção resistente de infestação",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Brebahe perçîttente de mucoçidá",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Brebahe perçîttente de Tehedura",
	"item.minecraft.lingering_potion.effect.wind_charged": "Poção resistênte de Carga de Vento",
	...
	"item.minecraft.magenta_bundle": "Çaco mahenta",
	"item.minecraft.magenta_dye": "Tinte mahenta",
	"item.minecraft.magenta_harness": "Arnêh mahenta",
	...
	"item.minecraft.miner_pottery_shard": "Frâmmento de çerámica de Êppioxa",
	"item.minecraft.miner_pottery_sherd": "Frâmmento de çerámica de Êppioxa",
	"item.minecraft.mojang_banner_pattern": "Patrón d'êttandarte",
	"item.minecraft.mojang_banner_pattern.desc": "Êttampao de Mojang",
	"item.minecraft.mojang_banner_pattern.new": "Etampâo de la côça",
	...
	"item.minecraft.music_disc_creator": "Dîcco de múçica",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Dîcco de múçica",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Crator (caha de múçica)",
	"item.minecraft.music_disc_far": "Dîcco de múçica",
	"item.minecraft.music_disc_far.desc": "C418 - far",
	"item.minecraft.music_disc_lava_chicken": "Dîcco de múçica",
	...
	"item.minecraft.music_disc_precipice": "Dîcco de múçica",
	...
	"item.minecraft.music_disc_tears": "Dîcco de múçica",
	...
	"item.minecraft.nautilus_spawn_egg": "Henerâh nautilo",
	...
	"item.minecraft.netherite_horse_armor": "Armaúra de netherita pa haca",
	"item.minecraft.netherite_ingot": "Lingote de netherita",
	"item.minecraft.netherite_leggings": "Grebâ de netherita",
	"item.minecraft.netherite_nautilus_armor": "Armaúra de netherita pa nautilo",
	...
	"item.minecraft.netherite_upgrade_smithing_template": "morde d'errería",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Mehóâ de nezerîta",
	...
	"item.minecraft.ominous_bottle": "Frâcco ominoço",
	"item.minecraft.ominous_trial_key": "Yabe de deçafío ominoça",
	"item.minecraft.orange_bundle": "Çaco narânha",
	"item.minecraft.orange_dye": "Tinte naranha",
	"item.minecraft.orange_harness": "Arnêh naranha",
	"item.minecraft.painting": "Cuadro",
	"item.minecraft.pale_oak_boat": "Barca de quehigo pálido",
	"item.minecraft.pale_oak_chest_boat": "Barca de quehigo pálido con baûh",
	"item.minecraft.panda_spawn_egg": "Guebo heneradôh de panda",
	"item.minecraft.paper": "Papêh",
	"item.minecraft.parched_spawn_egg": "Henerâh momificao",
	...
	"item.minecraft.piglin_banner_pattern.new": "Estampao de hocico",
	...
	"item.minecraft.pink_harness": "Arnêh roça",
	...
	"item.minecraft.potion.effect.infested": "Brebahe de infêttaçión",
	...
	"item.minecraft.potion.effect.oozing": "Brebahe de mucoçidá",
	...
	"item.minecraft.potion.effect.weaving": "Brebahe de teheúra",
	"item.minecraft.potion.effect.wind_charged": "Brebahe de çierço",
	...
	"item.minecraft.purple_bundle": "Saco morao",
	"item.minecraft.purple_dye": "Tinte morao",
	"item.minecraft.purple_harness": "Arnêh morao",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "morde d'errería",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Diçeño d'amadúrah d'elebaçión",
	...
	"item.minecraft.red_bundle": "Çaco colorao",
	"item.minecraft.red_dye": "Tinte colorao",
	"item.minecraft.red_harness": "Arnêh roho",
	"item.minecraft.redstone": "Porbo de redstone",
	"item.minecraft.resin_brick": "Bloquêh de reçina",
	"item.minecraft.resin_clump": "Grûmo deh reçina",
	"item.minecraft.rib_armor_trim_smithing_template": "Morde d'errería",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Diçeño d'amadúrah de cottîyah",
	...
	"item.minecraft.scrape_pottery_sherd": "Frâmmento de çerámica de axa",
	"item.minecraft.scute": "Êccama de tortuga",
	"item.minecraft.sentry_armor_trim_smithing_template": "Morde d'errería",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Diseño de armadura de centinela",
	"item.minecraft.shaper_armor_trim_smithing_template": "Morde d'errería",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Diçeño d'armadura de modeladôh",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "morde d'errería",
	...
	"item.minecraft.smithing_template": "morde d'errería",
	...
	"item.minecraft.sniffer_spawn_egg": "Guebo heneradôh d'olîqqueadôh",
	...
	"item.minecraft.snout_armor_trim_smithing_template": "morde d'errería",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "morde d'errería",
	...
	"item.minecraft.splash_potion.effect.infested": "Brebahe de infêttaçión arrohaíça",
	...
	"item.minecraft.splash_potion.effect.oozing": "Brebahe de mucoçidá arrohaíça",
	...
	"item.minecraft.splash_potion.effect.weaving": "Poçión de teheúra arrohaíça",
	"item.minecraft.splash_potion.effect.wind_charged": "Brebahe de çierço arrohaíça",
	...
	"item.minecraft.stone_spear": "Lança de piedra",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "morde d'errería",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Flexa d'infêttaçión",
	...
	"item.minecraft.tipped_arrow.effect.oozing": "Flexa de mucoçidá",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Flexa de teheúra",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Flexa de çierço",
	...
	"item.minecraft.trial_key": "Yabe de deçafío",
	...
	"item.minecraft.turtle_scute": "Êccama de tortuga",
	"item.minecraft.turtle_spawn_egg": "Guebo heneradôh de tortuga",
	"item.minecraft.vex_armor_trim_smithing_template": "Morde de errería",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "morde d'errería",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Morde d'errería",
	...
	"item.minecraft.white_bundle": "Çaco blânco",
	"item.minecraft.white_dye": "Tinte blanco",
	"item.minecraft.white_harness": "Arnêh blanco",
	"item.minecraft.wild_armor_trim_smithing_template": "Morde d'errería",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Diseño de armadura salvaje",
	"item.minecraft.wind_charge": "Carga de biento",
	...
	"item.minecraft.wolf_armor": "Armaúra pa lobo",
	...
	"item.minecraft.wooden_spear": "Lança de maera",
	...
	"item.minecraft.yellow_bundle": "Çaco amarîyo",
	"item.minecraft.yellow_dye": "Tinte amariyo",
	"item.minecraft.yellow_harness": "Arnêh amariyo",
	...
	"item.minecraft.zombie_nautilus_spawn_egg": "Henerâh nautilo çombi",
	...
	"item.modifiers.any": "Al equipâh:",
	"item.modifiers.armor": "N'er cuerpo:",
	"item.modifiers.body": "Al equipâh:",
	"item.modifiers.chest": "N'er cuerpo:",
	"item.modifiers.feet": "En lô piê:",
	...
	"item.modifiers.saddle": "Al equipâh montura:",
	"item.nbt_tags": "NBT: %s etiqueta(s)",
	"item.op_block_warning.line1": "Advêhtençia:",
	"item.op_block_warning.line2": "Se podrían ejecutar comandos al usar este bloque",
	"item.op_block_warning.line3": "¡No utiliçâh a no sêh que conôccah tôo su contenîo!",
	"item.spawn_egg.peaceful": "Deçâttibao en Paçífico",
	...
	"jigsaw_block.placement_priority": "Prioridá de colocaçión:",
	"jigsaw_block.placement_priority.tooltip": "Cuando er bloque rompecabeçâ çe conêtta a una pieça, êtte êh el orden en er que la pieça çe proçeça pa lâ conêççionê en êttrûtturâ mâh anxâ.\n\nLâ pieçâ çe proçeçan en orden dêççenten, teniendo en cuenta el orden de inçerçión.",
	"jigsaw_block.pool": "Grupo ôhhetibo:",
	"jigsaw_block.selection_priority": "Prioridá de çelêççión:",
	"jigsaw_block.selection_priority.tooltip": "Ar proçeçâh la pieça açoçiá a lâ conêççionê, êtte êh el orden en er que er bloque rompecabeçâ intenta conêttâh con çu pieça de dêttino.\n\nLô bloquê rompecabeçâ çe proçeçan en orden dêççenten, con un orden de inçerçión aleatorio.",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine - Creator (caha de múçica)",
	...
	"key.categories.spectator": "Êppêttadôh",
	"key.categories.ui": "Interfâh der huego",
	"key.category.minecraft.creative": "Modo creatibo",
	"key.category.minecraft.debug": "Depuraçión",
	"key.category.minecraft.gameplay": "Huego",
	"key.category.minecraft.inventory": "Imbentario",
	"key.category.minecraft.misc": "Bariô",
	"key.category.minecraft.movement": "Mobimiento",
	"key.category.minecraft.multiplayer": "Murtihugadôh",
	"key.category.minecraft.spectator": "Êppêttadôh",
	"key.chat": "Abrîh xâh",
	"key.command": "Abrîh línia de comandô",
	"key.debug.clearChat": "Borrâh xâh",
	"key.debug.copyLocation": "Copiâh ubicaçión",
	"key.debug.copyRecreateCommand": "Copiâh datô",
	"key.debug.crash": "Forçâh çierre",
	"key.debug.debugOptions": "Ôççionê de depuraçión",
	"key.debug.dumpDynamicTextures": "Borcâh têtturâ dinámicâ",
	"key.debug.dumpVersion": "Borcâh informaçión de la berçión",
	"key.debug.focusPause": "Artênnâh pauça ar perdêh enfoque",
	"key.debug.fpsCharts": "Gráficâ de FPS",
	"key.debug.lightmapTexture": "Têttura der mapa de lûh",
	"key.debug.modifier": "Tecla de depuraçión",
	"key.debug.networkCharts": "Gráficâ de ré",
	"key.debug.overlay": "Artênnâh çuperpoçiçión",
	"key.debug.profiling": "Iniçiar/Terminâh perfilao",
	"key.debug.profilingChart": "Gráfica de perfilao",
	"key.debug.reloadChunk": "Recargâh xunks",
	"key.debug.reloadResourcePacks": "Recargâh paquetê de recurçô",
	"key.debug.showAdvancedTooltips": "Môttrâh dêccrîççionê abançâh",
	"key.debug.showChunkBorders": "Mostrar bordes de chunks",
	"key.debug.showHitboxes": "Môttrâh cahâ de coliçionê",
	"key.debug.spectate": "Artênnâh modo êppêttadôh",
	"key.debug.switchGameMode": "Cambiadôh de modo de huego",
	...
	"key.quickActions": "Atahô de teclao",
	...
	"key.spectatorHotbar": "Çelêççionâh en la barra de ôhhetô",
	"key.spectatorOutlines": "Reçartâh hugadorê (êppêttaórê)",
	"key.sprint": "Corrêh",
	"key.swapOffhand": "Cambiâh ôhheto de manô",
	"key.toggleGui": "Artênnâh interfâh",
	"key.togglePerspective": "Cambiâh perppêttiba",
	"key.toggleSpectatorShaderEffects": "Artênnâh efêttô de çombreao de êppêttadôh",
	"key.use": "Interâttuâh/Colocâh bloque",
	"known_server_link.announcements": "Anunçiô",
	"known_server_link.community": "Comunidá",
	"known_server_link.community_guidelines": "Normâ de la comunidá",
	"known_server_link.feedback": "Opinionê",
	"known_server_link.forums": "Forô",
	"known_server_link.news": "Nobedaê",
	"known_server_link.report_bug": "Informâh d'errôh n'er çerbidôh",
	"known_server_link.status": "Êttao",
	"known_server_link.support": "Çoporte",
	"known_server_link.website": "Çitio web",
	...
	"loading.progress": "%s %%",
	"manageServer.add.title": "Añadîh çerbidôh",
	"manageServer.edit.title": "Editâh informaçión der çerbidôh",
	"manageServer.enterIp": "Dirêççión der çerbidôh",
	"manageServer.enterName": "Nombre der çerbidôh",
	"manageServer.resourcePack": "Paquete de recurçô",
	"manageServer.resourcePack.disabled": "Deçâttibao",
	"manageServer.resourcePack.enabled": "Âttibao",
	"manageServer.resourcePack.prompt": "Preguntâh",
	"mco.account.privacy.info": "Leêh mâh çobre Mojang y lâ leyê de pribaçidá",
	"mco.account.privacy.info.button": "Mâh informaçión çobre el RGPD",
	"mco.account.privacy.information": "Mojang implementa çiertô proçedimientô pa ayudâh a protehêh a lô menorê y çu pribaçidá, que conçîtten en cumplîh con la Ley de Protêççión de Pribaçidá Infantîh en Intênnêh (COPPA) y el Reglamento Henerâh de Protêççión de Datô (RGPD).\n\nDebê tenêh conçentimiento parentâh antê de podêh tenêh âççeço a tu cuenta de Realms.",
	...
	"mco.backup.entry.worldType.adventureMap": "Mapa de abentura",
	"mco.backup.entry.worldType.experience": "Êpperiençia",
	"mco.backup.entry.worldType.inspiration": "Îppiraçión",
	"mco.backup.entry.worldType.minigame": "Minihuego",
	"mco.backup.entry.worldType.normal": "Normâh",
	"mco.backup.entry.worldType.unknown": "Dêcconoçío",
	"mco.backup.generate.world": "Henerâh mundo",
	"mco.backup.info.title": "Cambiô de la úrtima copia",
	"mco.backup.narration": "Copia dêdde %s",
	...
	"mco.client.outdated.stable.version": "La berçión de tu cliente (%s) no êh compatible con Realms.\n\nPor fabôh, âttualiça a la berçión mâh reçiente de Minecraft.",
	"mco.client.unsupported.snapshot.version": "La berçión de tu cliente (%s) no êh compatible con Realms.\n\nRealms no êttá dîpponible en êtta berçión de prueba.",
	"mco.compatibility.downgrade": "Deçâttualiçâh",
	"mco.compatibility.downgrade.description": "Êtte mundo se hugó por úrtima bêh en la berçión %s. Êttâh en la berçión %s. Degradâh un mundo a una berçión anteriôh podría dañâl-lo. No poemô garantiçarte que carge o funçione.",
	"mco.compatibility.incompatible.popup.title": "Berçión incompatible",
	"mco.compatibility.incompatible.releaseType.popup.message": "Er mundo al que te êttâh intentando unîh êh incompatible con tu berçión der huego.",
	"mco.compatibility.incompatible.series.popup.message": "Êtte mundo çe hugó por úrtima bêh en la berçión %s y la tuya êh %s.",
	"mco.compatibility.unverifiable.message": "No ç'a podío berificâh la berçión en la que êtte mundo se hugó por úrtima bêh. Çi er mundo s'âttualiça o baha de berçión, çe creará automáticamente una copia de çeguridá que se guardará en \"Copiâ der mundo\".",
	"mco.compatibility.unverifiable.title": "No çe puede berificâh la compatibilidá",
	"mco.compatibility.upgrade": "Âttualiçâh",
	"mco.compatibility.upgrade.description": "Êtte mundo se hugó por úrtima bêh en la berçión %s. Êttâh en la berçión %s.",
	"mco.compatibility.upgrade.friend.description": "Êtte mundo se hugó por úrtima bêh en la berçión %s. Êttâh en la berçión %s.",
	"mco.compatibility.upgrade.title": "¿Çeguro que quierê âttualiçâh tu mundo?",
	...
	"mco.configure.world.backup": "Copiâ de çeguridá der mundo",
	"mco.configure.world.buttons.activity": "Âttibidá der hugadôh",
	"mco.configure.world.buttons.close": "Çerrâh Realm temporarmente",
	...
	"mco.configure.world.buttons.newworld": "Nuebo mundo",
	...
	"mco.configure.world.buttons.region_preference": "Çelêççionâh rehión...",
	"mco.configure.world.buttons.resetworld": "Reiniçiâh er mundo",
	"mco.configure.world.buttons.save": "Guardâh",
	...
	"mco.configure.world.close.question.line1": "Puedê çerrâh temporarmente tu Realm, ebitando que çe unan otrô hugadorê. Ábrelo de nuebo cuando lo tengâ tó lîtto.\n\nAçêh êtto no cançelará tu çûccrîççión de Realms.",
	"mco.configure.world.close.question.line2": "¿Çeguro que quiêh continuâh?",
	"mco.configure.world.close.question.title": "¿Neçeçitâ açê cambiô çin interrûççionê?",
	"mco.configure.world.closing": "Çerrando'l Realm...",
	...
	"mco.configure.world.description": "Dêccîççión der Realm",
	...
	"mco.configure.world.name.validation.whitespace": "No puede empeçâh o acabâh con un êppaçio en blanco. Er nombre çerá recortao.",
	"mco.configure.world.opening": "Abriendo'l Realm...",
	"mco.configure.world.players.error": "No êççîtte ningún hugadôh con êtte nombre",
	"mco.configure.world.players.invite.duplicate": "Ya ça imbitao a un hugadôh con eçe nombre al Realm",
	"mco.configure.world.players.inviting": "Combidando a un hugadôh...",
	"mco.configure.world.players.title": "Hugaorê",
	"mco.configure.world.pvp": "PvP",
	"mco.configure.world.region_preference": "Preferençia de rehión",
	"mco.configure.world.region_preference.title": "Selêççión de rehión",
	...
	"mco.configure.world.resourcepack.question": "Neçeçitâ un paquete de recurçô perçonaliçao pa hugâh en êtte Realm\n\n¿Quierê dêccargal-lo y hugâh?",
	...
	"mco.configure.world.settings.expired": "No puedê editâh lô ahûttê de un Realm caducao",
	"mco.configure.world.settings.title": "Ahûttê",
	"mco.configure.world.slot": "Mundo %s",
	"mco.configure.world.slot.empty": "Baçío",
	"mco.configure.world.slot.switch.question.line1": "Tu Realm ba cambiâh a otro mundo",
	...
	"mco.configure.world.subscription.tab": "Çûccrîççión",
	"mco.configure.world.subscription.timeleft": "Tiempo que quéa",
	...
	"mco.configure.world.uninvite.player": "¿Çeguro que quiêh dêccombidâh a \"%s\"?",
	...
	"mco.connect.region": "Rehión der çerbidôh: %s",
	"mco.connect.success": "Açêttâh",
	"mco.create.world": "Creâh",
	"mco.create.world.error": "¡Neçeçitâ ponêl-le un nombre!",
	"mco.create.world.failed": "No ça podío creâh er mundo!",
	"mco.create.world.reset.title": "Creando'r mundo...",
	"mco.create.world.skip": "Çartâh",
	"mco.create.world.subtitle": "Çi quiêh, çelêççiona un mundo pa ponêl-lo en tu nuebo Realm",
	...
	"mco.download.confirmation.oversized": "Er mundo que intentâ dêccargâh çupera lô %s\n\nNo podrâ borbêh a çubîh êtte mundo a tu Realm",
	...
	"mco.errorMessage.6005": "Mundo bloqueao",
	"mco.errorMessage.6006": "Mundo deçâttualiçao",
	"mco.errorMessage.6007": "El uçuario êttá en demaçiáô Realms",
	"mco.errorMessage.6008": "Nombre de Realm no bálido",
	"mco.errorMessage.6009": "Dêccrîççión der Realm no bálida",
	"mco.errorMessage.connectionFailure": "Ça produçío un errôh. Arfabôh d'intentâl-lo de nuebo mâh tarde.",
	"mco.errorMessage.generic": "Ça produçío un errôh: ",
	"mco.errorMessage.initialize.failed": "No se pûo iniçiâh el Realm",
	"mco.errorMessage.noDetails": "No çe an proporçionao detayê del errôh",
	"mco.errorMessage.realmsService": "Ça produçío un errôh (%s):",
	"mco.errorMessage.realmsService.configurationError": "Ça produçío un errôh inêpperao al intentâh editâh lâ ôççionê der mundo",
	"mco.errorMessage.realmsService.connectivity": "No ça podío conêttâh a Realms: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "No çe a podío comprobâh la berçión compatible, çe ôttubo la rêppuêtta: %s",
	"mco.errorMessage.retry": "Reintentâh operaçión",
	...
	"mco.gui.ok": "Açêttâh",
	"mco.info": "¡Info!",
	"mco.invited.player.narration": "Ç'a imbitao a %s",
	...
	"mco.notification.transferSubscription.buttonText": "Trâfferîh ya",
	"mco.notification.transferSubscription.message": "Lâ çûccrîççionê de Realms pa Java çan mobío a Microsoft Store. ¡No êpperê a que tu çûccrîççión termine!\nTrâffiérela ya y ôttén 30 díâ de Realms gratî.\nBe a tu perfîh en minecraft.net pa trâfferîh tu çûccrîççión.",
	...
	"mco.onlinePlayers": "Hugadorê en línea",
	"mco.play.button.realm.closed": "Realm çerrao",
	...
	"mco.reset.world.warning": "Êtto çûttituirá'r mundo âttuâh de tu Realm",
	...
	"mco.selectServer.create.subtitle": "Elihe qué mundo quiêh ponêh en tu nuebo Realm",
	...
	"mco.selectServer.uninitialized": "¡Âh clîh pa creâh tu nuebo Realm!",
	"mco.snapshot.createSnapshotPopup.text": "Êttâh a punto de creâh un Realm pa berçionê de prueba gratuito que êttará binculao a tu çûccrîççión de Realms de pago. Êtte Realm en particulâh çerá âççeçible mientrâ la çûccrîççión de pago êtté âttiba. Tu Realm de pago no çe berá afêttao.",
	"mco.snapshot.createSnapshotPopup.title": "¿Creâh un Realm pa berçionê de prueba?",
	"mco.snapshot.creating": "Creando Realm pa berçionê de prueba...",
	"mco.snapshot.description": "Binculao a %s",
	"mco.snapshot.friendsRealm.downgrade": "Debê êttâh en la berçión %s pa unirte a êtte Realm",
	"mco.snapshot.friendsRealm.upgrade": "Pa hugâh dêdde la berçión en la que êttâh, %s deberá âttualiçâh çu Realm primero",
	"mco.snapshot.paired": "Êtte Realm para berçionê de prueba êttá binculao a %s",
	"mco.snapshot.parent.tooltip": "Utiliça la berçión êttable má reçiente de Minecraft pa hugâh en êtte Realm",
	"mco.snapshot.start": "Abrîh Realm pa berçionê de prueba gratuito",
	"mco.snapshot.subscription.info": "Êtte êh un Realm pa berçionê de prueba binculao a la çûccriççión de tu realm \"%s\". Permaneçerá âttibo mientrâ el Realm binculao êtté en funçionamiento.",
	"mco.snapshot.tooltip": "Utiliça lôh Realms pa berçionê de prueba pa exâh un bîttaço a próççimâ berçionê, que podrían incluîh nuebâ carâtterîtticâ y otrô cambiô.",
	"mco.snapshotRealmsPopup.message": "Realms ara êh compatible con lâ berçionê de prueba dêdde la 23w41a. ¡Toâ lâ çûccrîççionê a Realms bienen con una berçión de prueba de Realms gratuita, independiente a tu realm de Java normâh!",
	"mco.snapshotRealmsPopup.title": "Realms ara êh compatible con lâ berçionê de prueba",
	"mco.snapshotRealmsPopup.urlText": "Mâh informaçión",
	...
	"mco.upload.failed.too_big.description": "El mûndo çelecçionâo eh demaçiâo grânde. Eh tamâño mâh grânde pemitîo eh de %s.",
	"mco.upload.failed.too_big.title": "Mûndo demaçiâo grânde",
	...
	"menu.custom_options": "Ôççionê perçonaliçâh...",
	"menu.custom_options.title": "Ôççionê perçonaliçâh",
	"menu.custom_options.tooltip": "Nota: Lâ ôççionê perçonaliçâh lâ proporçionan çerbidorê o contenío de terçerô.\n¡Ten cuidao!",
	"menu.custom_screen_info.button_narration": "Êtto êh una pantaya perçonaliçá. Mâh informaçión.",
	"menu.custom_screen_info.contents": "Er contenío de êtta pantaya êttá controlao por çerbidorê y mapâ de terçerô que no çon propiedá de Mohang Studiô ni de Microçôtt, ni êttán operáô ni çuperbiçáô \u200b\u200bpôh eyô.\n\n¡Atençión! Ten cuidao al abrîh enlaçê y nunca compartâ tu informaçión perçonâh, incluyendo tû datô de iniçio de çeçión.\n\nÇi êtta pantaya te impide hugâh, puedê dêcconêttarte der çerbidôh uçando er botón de aquí abaho.",
	"menu.custom_screen_info.disconnect": "Pantaya perçonaliçá rexaçá",
	"menu.custom_screen_info.title": "Açerca de lâ pantayâ perçonaliçâh",
	"menu.custom_screen_info.tooltip": "Êtto êh una pantaya perçonaliçá. Âh clîh aquí pa mâh informaçión.",
	"menu.disconnect": "Dêcconêttarçe",
	"menu.feedback": "Danô tu opinión...",
	"menu.feedback.title": "Danô tu opinión",
	...
	"menu.quick_actions": "Atahô de teclao...",
	"menu.quick_actions.title": "Atahô de teclao",
	...
	"menu.server_links": "Enlaçê der çerbidôh...",
	"menu.server_links.title": "Enlaçê der çerbidôh",
	...
	"multiplayer.codeOfConduct.check": "No borbêh a notificâh çobre êtte código de condûtta",
	"multiplayer.codeOfConduct.title": "Código de condûtta der çerbidôh",
	"multiplayer.confirm_command.parse_errors": "Êttâh intentando ehecutâh un comando dêcconoçío o no bálido.\n¿Êttâh çeguro?\nComando: %s",
	"multiplayer.confirm_command.permissions_required": "Êttâh intentando ehecutâh un comando que requiere permiçô elebaô.\nÊtto podría afêttâh negatibamente a tu huego.\n¿Êttâh çeguro?\nComando: %s",
	"multiplayer.confirm_command.run_command": "Ehecutâh Comando",
	"multiplayer.confirm_command.signature_required": "Êttâh intentando ehecutâh un comando que embiará mençahê de xâh utiliçando tu nombre.\nÇolo çe puede ehecutâh dêdde la pantaya de xâh.\nComando: %s",
	"multiplayer.confirm_command.suggest_command": "Copiâh a la Pantaya de Xâh",
	"multiplayer.confirm_command.title": "Confirmâh ehecuçión der comando",
	"multiplayer.disconnect.authservers_down": "Lô çerbiorê d'autenticaçión no funçionan. ¡Lo çentimô! Inténtalo mâh tarde!",
	"multiplayer.disconnect.bad_chat_index": "Mençahe de xâh perdío o reordenao reçibío der çerbidôh",
	...
	"multiplayer.disconnect.banned.reason.default": "Bloqueao/a por un âmminîttradôh.",
	...
	"multiplayer.disconnect.code_of_conduct": "Er çerbidôh requiere açêttâh er código de condûtta",
	"multiplayer.disconnect.configuration_error": "Errôh inêpperao durante la configuraçión",
	...
	"multiplayer.player.list.hp": "%s PÇ",
	...
	"multiplayer.status.anonymous_player": "Hugadôh anónimo",
	...
	"narration.checkbox.usage.focused.check": "Purça Entrâh pa marcâh",
	"narration.checkbox.usage.focused.uncheck": "Purça Entrâh pa dêmmarcâh",
	"narration.checkbox.usage.hovered": "Âh clîh îqquierdo p'artênnâh",
	"narration.checkbox.usage.hovered.check": "Âh clîh îqquierdo pa marcâh",
	"narration.checkbox.usage.hovered.uncheck": "Âh clîh îqquierdo pa dêmmarcâh",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Preçiona Entrâh pa empeçâh a cambiâh er balôh der dêl-liçadôh",
	...
	"narration.suggestion.usage.cycle.fixed": "Purça Tâh pa paçâh a la çigiente çuherençia",
	"narration.suggestion.usage.cycle.hidable": "Purça Tâh pa paçâh a la çigiente çuherençia, o Êcc pa çalîh de lâ çuherençiâ",
	"narration.suggestion.usage.fill.fixed": "Purça Tâh pa uçâh la çuherençia",
	"narration.suggestion.usage.fill.hidable": "Purça Tâh pa paçâh a la çigiente çuherençia, o Êcc pa çalîh de lâ çuherençiâ",
	...
	"narrator.position.tab": "Ça çelêççionao la pêttaña %s de %s",
	...
	"narrator.select.world_info": "Çelêççionao %s, hugao por úrtima bêh: %s, %s",
	...
	"optimizeWorld.confirm.proceed": "Guadâh coppîa y optimiçâh",
	...
	"optimizeWorld.stage.finished.chunks": "Finalizando  ôttimiçaçión de xunks...",
	"optimizeWorld.stage.finished.entities": "Finalizando  ôttimiçaçión  dentidadê...",
	"optimizeWorld.stage.finished.poi": "Finalizando  ôttimiçaçión de puntô dinterêh...",
	"optimizeWorld.stage.upgrading": "Âttualiçando tó lô chunks...",
	"optimizeWorld.stage.upgrading.chunks": "Âttualiçando tó lô chunks...",
	"optimizeWorld.stage.upgrading.entities": " Ôttimiçando toâ lâ entidadê...",
	"optimizeWorld.stage.upgrading.poi": "Ôttimiçando tôh lô puntô dinterêh...",
	"optimizeWorld.title": "Ôttimiçando'r mundo \"%s\"",
	"options.accessibility": "Ahûttê d'âççeçibilidá...",
	...
	"options.accessibility.high_contrast_block_outline": "Bôdèh de âtto cottrâhte",
	...
	"options.accessibility.menu_background_blurriness": "Difuminao der fondo der menú",
	"options.accessibility.menu_background_blurriness.tooltip": "Controla er difumano der fondo en lô menûh.",
	"options.accessibility.narrator_hotkey": "Ataho al narradôh",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Permite âttibâh o deçâttibâh el narradôh con Cmd+B.",
	"options.accessibility.narrator_hotkey.tooltip": "Permite âttibâh o deçâttibâh el narradôh con Ctrl+B.",
	...
	"options.accessibility.title": "Ahûttê d'âççeçibilidá",
	"options.accessibility.tooltip": "Accesibilidad",
	"options.allowCursorChanges": "Permitîh cambiô de curçôh",
	"options.allowCursorChanges.tooltip": "Permite que er curçôh del ratón cambie de forma cuando çe paça por ençima de çiertô elementô de la interfâh de uçuario.",
	...
	"options.blocks": "%s bloquê",
	"options.chat": "Ahûttê der xâh...",
	"options.chat.color": "Colorê",
	"options.chat.delay": "Retraço ner xâh: %s çegundô",
	"options.chat.delay_none": "Retraço ner xâh: Ná",
	"options.chat.drafts": "Guardâh Xats No Embiáô",
	"options.chat.drafts.tooltip": "Lô mençahê no embiáô çe guardarán y çe podrán embiâh la próççima bêh que çe abra er xâh.",
	...
	"options.chunkFade": "Tiempo de difuminao de xunks",
	"options.chunkFade.none": "Difuminao de xunks: No",
	"options.chunkFade.seconds": "Difuminao de xunks: %s seg.",
	"options.chunkFade.tooltip": "Tiempo, en çegundô, que tardan lô xunks en apareçêh graduarmente al renderiçarçe.",
	...
	"options.cutoutLeaves": "Bêh a trabêh de ohâ",
	"options.cutoutLeaves.tooltip": "Permite bêh a trabêh de lô guecô entre lâ ohâ. Deçâttibâl-lo puede mehorâh el rendimiento.",
	"options.damageTiltStrength": "Çacudía por daño",
	"options.damageTiltStrength.tooltip": "Cuanto çe çacude la cámara al reçibîh daño.",
	...
	"options.exclusiveFullscreen": "Pantaya completa êccluçiba",
	"options.exclusiveFullscreen.warningTooltip": "Êtta ôççión pu'êccaxarrâh argunô métôh de entrá.",
	"options.font": "Ahûttê der xâh...",
	"options.font.title": "Ahûttê de fuente",
	...
	"options.graphics.custom": "Perçonaliçao",
	...
	"options.graphics.preset": "Plantiya",
	"options.graphics.preset.tooltip": "Êttableçe lô ahûttê de «Calidá y rendimiento» en balorê por defêtto raçonablê que çe corrêpponden con la calidá deçeá.",
	...
	"options.hideMatchedNames.tooltip": "Lô çerbidorê de terçerô pueden embiâh mençahê ner xâh en formatô no êttándâ.\nÇi êtta ôççión êttá âttibá: lô hugaórê ocurtô ç'identificarán en baçe a lô nombrê de lô remitentê der xâh.",
	"options.hideSplashTexts": "Ocurtâh lô têttô de biembenía",
	"options.hideSplashTexts.tooltip": "Ocurta lô têttô de biembenía amariyô q'apareçen n'er menú prinçipâh.",
	"options.improvedTransparency": "Trâpparençia mehorá",
	"options.improvedTransparency.tooltip": "Un enfoque êpperimentâh que utiliça çombreadorê de pantaya pa dibuhâh er clima, lâ nubê y lâ partículâ detrâh de bloquê trâpparentê y agua. Êtto afêttará al rendimiento de la GPU.",
	...
	"options.inactivityFpsLimit.afk.tooltip": "Limita la belocidâh de fotogramâ a 30 cuando er huego no reçibe ninguna entrâh der hugadôh durante mâh d'un minuto. Ademâh, la limita a 10 despuêh de 9 minutô mâh.",
	...
	"options.invertMouseX": "Imbertîh X del ratón",
	"options.invertMouseY": "Imbertîh Y del ratón",
	"options.japaneseGlyphVariants": "Bariantê de glifô haponeçâ",
	"options.japaneseGlyphVariants.tooltip": "Uça lâ bariantê haponeçâ de lô carâtterê CJK en la fuente predeterminá.",
	...
	"options.languageAccuracyWarning": "(Lâ tradûççionê tar bêh no çêan 100%% êççâttâ)",
	...
	"options.maxAnisotropy": "Firtrao aniçotrópico",
	"options.maxAnisotropy.tooltip": "Cá nibêh mehora çînnificatibamente la nitidêh de lâ têtturâ, pero afêtta al rendimiento y, en êppeçiâh, al uço de memoria de bídeo. Êh neçeçario tenêh âttibao er firtrao de têtturâ aniçotrópico.",
	...
	"options.musicToast": "Notif. de múçica",
	"options.musicToast.never": "Nunca",
	"options.musicToast.never.tooltip": "No çe muêttra ninguna notificaçión de múçica.",
	"options.musicToast.pauseMenu": "Menú de pauça",
	"options.musicToast.pauseMenu.tooltip": "Muêttra una notificaçión de múçica en er menú de pauça mientrâ çuena una cançión.",
	"options.musicToast.pauseMenuAndToast": "Menú de pauça y notificaçión",
	"options.musicToast.pauseMenuAndToast.tooltip": "Muêttra una notificaçión cuando empieça a çonâh una cançión. La notificaçión permaneçerá biçible en er menú de pauça mientrâ aya una cançión çonando.",
	"options.music_frequency": "Frecuençia de la múçica",
	"options.music_frequency.constant": "Côttante",
	"options.music_frequency.default": "Por defêtto",
	"options.music_frequency.frequent": "Frecuente",
	"options.music_frequency.tooltip": "Cambia la frecuençia con la que çe reproduçe múçica durante una partía.",
	...
	"options.needsRestart": "La ôççión ç'aplicará trâh reiniçiâh.",
	...
	"options.realmsNotifications.tooltip": "Bûcca notiçiâ e imbitaçionê de Realms n'er menú prinçipâh y muêttra çû rêppêttibô iconô n'er botón de Realms.",
	"options.reducedDebugInfo": "Reduçîh datô de F3",
	"options.renderClouds": "Nubê",
	"options.renderCloudsDistance": "Dîttançia de lâh nubê",
	...
	"options.rotateWithMinecart": "Hirâh con bagonetâ",
	"options.rotateWithMinecart.tooltip": "Çi la bîtta der hugadôh debe rotâh con una bagonetâ hirando. Çolo dîpponible en mundô con el ahûtte êpperimentâh 'Mehorâ de bagonetâ' âttibao.",
	...
	"options.showNowPlayingToast": "Notificaçión de múçica",
	"options.showNowPlayingToast.tooltip": "Muêttra una notificaçión cá bêh que empieça a çonâh una cançión. La notificaçión permaneçerá biçible en er menú de pauça mientrâ aya una cançión çonando.",
	"options.showSubtitles": "Môttrâh çûttítulô",
	"options.showSubtitles.tooltip": "Âttiba çûttítulô pa çoníô reproduçíô en er huego.",
	...
	"options.sprintWindow": "Bentana de Corrêh",
	"options.sprintWindow.tooltip": "Bentana de tiempo en tics, donde ar tocâh dôh beçê la tecla de abançe çe âttiba el êpprín.",
	...
	"options.telemetry.disabled": "Telemetería desâttibá.",
	"options.telemetry.state.all": "Toâ",
	"options.telemetry.state.minimal": "Mínimâ",
	"options.telemetry.state.none": "Ná",
	"options.textureFiltering": "Firtrao de têtturâ",
	"options.textureFiltering.anisotropic": "Aniçotrópico",
	"options.textureFiltering.anisotropic.tooltip": "Un métó de firtrao baçao en el ardware. Afêtta al rendimiento y al uço de la memoria de bídeo de forma çînnificatiba. Puede que no çea compatible con tu ardware.",
	"options.textureFiltering.none": "Ninguno",
	"options.textureFiltering.none.tooltip": "Lâ têtturâ çe muêttran çin ningún firtro. Lô bloquê pueden berçe borroçô ar mirâl-lô dêdde çiertô ángulô.",
	"options.textureFiltering.rgss": "RGSS",
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nMétó de firtrao baçao en çombreadorê que mehora la calidá de lâ têtturâ con un impâtto moderao en el rendimiento.",
	"options.title": "Ôççionê",
	"options.touchscreen": "Pantaya táttî",
	"options.value": "%s",
	"options.video": "Gráficô...",
	"options.video.display.header": "Pantaya",
	"options.video.interface.header": "Interfâh",
	"options.video.preferences.header": "Preferençiâ",
	"options.video.quality.header": "Calidá y rendimiento",
	"options.videoTitle": "Ôççionê gráficâ",
	"options.viewBobbing": "Balançeo de biçión",
	"options.vignette": "Môttrâh biñeta",
	"options.vignette.tooltip": "Çe trata de una têttura çutîh çobre la pantaya der huego que çe utiliça pa reduçîh er briyo en lô bordê de la pantaya y âbbertîh çobre er límite der mundo.",
	"options.visible": "Biçible",
	"options.vsync": "VSync",
	"options.weatherRadius": "Radio der clima",
	"options.weatherRadius.tooltip": "Radio del área donde çe ben lô efêttô de la yubia y la niebe. Impâtto mu baho en el rendimiento.",
	"options.worldOptions.button": "Ôççionê der mundo...",
	"options.worldOptions.title": "Ôççionê der mundo",
	...
	"pack.dropRejected.message": "Lâ çigientê entrâh no eran paquetê bálidô y no ç'an copiao: %s",
	"pack.dropRejected.title": "Entrâh que no çon paquete",
	...
	"pack.incompatible.confirm.unknown": "Êtte paquete êttá roto o diçeñao pa una berçión dêcconoçida de Minecraft y puede que ya no funçione corrêttamente.",
	...
	"painting.minecraft.cavebird.title": "Páharo de lâ cabernâ",
	...
	"painting.minecraft.meditative.title": "Meditatibo",
	...
	"painting.minecraft.owlemons.title": "Búo con limonê",
	"painting.minecraft.passage.author": "Kristoffer Zetterstrand",
	"painting.minecraft.passage.title": "Paçaíço",
	...
	"particle.invalidOptions": "No ç'an podío analiçâh lâ ôççionê de la partícula: %s",
	...
	"quickplay.error.realm_permission": "No tié permiço pa conêttarte a êtte Realm",
	"quickplay.error.title": "Errôh al intentâh iniçiâh en modo huego rápido",
	"realms.configuration.region.australia_east": "Nueba Galê der Çûh, Aûttralia",
	"realms.configuration.region.australia_southeast": "Bîttoria, Aûttralia",
	"realms.configuration.region.brazil_south": "Braçîh",
	...
	"realms.configuration.region.east_us": "Birhinia, EE. UU.",
	"realms.configuration.region.east_us_2": "Carolina der Norte, EE. UU.",
	"realms.configuration.region.france_central": "Françia",
	"realms.configuration.region.japan_east": "Êtte de Hapón",
	"realms.configuration.region.japan_west": "Oêtte de Hapón",
	"realms.configuration.region.korea_central": "Corea der Sûh",
	...
	"realms.configuration.region.southeast_asia": "Çingapur",
	"realms.configuration.region.sweden_central": "Çueçia",
	"realms.configuration.region.uae_north": "Emiratô Árabê Uníô (EAU)",
	"realms.configuration.region.uk_south": "Çur de Inglaterra",
	"realms.configuration.region.west_central_us": "Utah, EE. UU.",
	"realms.configuration.region.west_europe": "Paíçê Bahô",
	"realms.configuration.region.west_us": "California, EE. UU.",
	"realms.configuration.region.west_us_2": "Washington, EE. UU.",
	"realms.configuration.region_preference.automatic_owner": "Atomática (latencia der dueño der Realm)",
	"realms.configuration.region_preference.automatic_player": "Atomática (latencia der primero en unirçe)",
	...
	"recover_world.bug_tracker": "Informâh d'errôh",
	"recover_world.button": "Intentâh recuperâh",
	"recover_world.done.failed": "Errôh al recuperâh un êttao anteriôh.",
	"recover_world.done.success": "¡Recuperaçión realiçá con éççito!",
	"recover_world.done.title": "Recuperaçión completá",
	"recover_world.issue.missing_file": "Farta un arxibo",
	"recover_world.issue.none": "Çin problemâ",
	"recover_world.message": "Çe produheron lô çigientê problemâ al intentâh leêh la carpeta \"%s\".\nTar bêh çea poçible rêttaurâh er mundo d'una berçión anteriôh o informâh del errôh n'er rehîttro d'errorê.",
	"recover_world.no_fallback": "No ay êttaô de recuperaçión dîpponiblê",
	"recover_world.restore": "Intentâh rêttaurâh",
	"recover_world.restoring": "Intentando rêttaurâh mundo...",
	"recover_world.state_entry": "Êttao dêdde %s: ",
	"recover_world.state_entry.unknown": "dêcconoçío",
	"recover_world.title": "Errôh al cargâh er mundo",
	"recover_world.warning": "Errôh al cargâh el reçumen der mundo",
	...
	"resourcePack.runtime_failure": "Ça detêttao un errôh en un paquete de recurçô",
	...
	"restrictions_screen.button": "Rêttrîççionê...",
	"restrictions_screen.permission.receive_player_messages.allowed": "Puedê reçibîh mençahê de hugadorê",
	"restrictions_screen.permission.receive_player_messages.denied": "No puedê reçibîh mençahê de hugadorê",
	"restrictions_screen.permission.receive_system_messages.allowed": "Puedê reçibîh mençahê der çîttema dêdde er çerbidôh",
	"restrictions_screen.permission.receive_system_messages.denied": "No puedê reçibîh mençahê der çîttema dêdde er çerbidôh",
	"restrictions_screen.permission.send_commands.allowed": "Puedê embiâh comandô",
	"restrictions_screen.permission.send_commands.denied": "No puedê embiâh comandô",
	"restrictions_screen.permission.send_messages.allowed": "Puedê embiâh mençahê de xâh",
	"restrictions_screen.permission.send_messages.denied": "No puedê embiâh mençahê de xâh",
	"restrictions_screen.title": "Rêttrîççionê",
	...
	"selectWorld.allowCommands.new": "Permitîh comandô",
	...
	"selectWorld.backupQuestion.file_fixing_required": "¿Quiere' haçe una copia der mundo ante' de âttualiçal-lo?",
	...
	"selectWorld.backupWarning.file_fixing_required": "Êtte mundo neçeçita ser attualiça'o ante' de hugá. Te recomendamo' creâh una copia ante' de continuá, por si la' moccâh.",
	...
	"selectWorld.incompatible.description": "Êtte mundo no çe pué abrîh en êtta berçión.\nLa úrtima bêh çe hugó en la berçión %s.",
	"selectWorld.incompatible.info": "Berçión incompatible: %s",
	"selectWorld.incompatible.title": "Berçión incompatible",
	"selectWorld.incompatible.tooltip": "Êtte mundo no çe puede abrîh porque çe creó en una berçión no compatible.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Êtte mundo neçeçita sêh âttcualiçao a la úrtima bersiôh ante' de pode' edital-lo pâ ebitáh problemâ.",
	"selectWorld.requiresFileFixingTooltip.play": "Êtte mundo neçeçita sêh âttcualiçao a la úrtima bersiôh ante' de pode' hugá pâ ebitáh problemâ.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Êtte mundo neçeçita sêh âttcualiçao a la úrtima bersiôh ante' de pode' recreal-lo pâ ebitáh problemâ.",
	"selectWorld.resource_load": "Preparando recurçô...",
	...
	"selectWorld.tooltip.fromNewerVersion2": "cargâh êtte mundo podría cauçâh poblemâ!",
	...
	"selectWorld.upgrade_and_play": "Âttualçá y Hugá",
	...
	"selectWorld.waitingForBackup.message": "Depende der tamañô der mundo, êtto puede tardá un ratito. No bayâ a çerrâ er huego o apagâ er dispositibo, que te beo benî.",
	"selectWorld.waitingForBackup.title": "Creandôçe Copia",
	...
	"selectWorld.warning.lowDiskSpace.description": "No quea muxo êppaçio en tu dîppoçitibo",
	"selectWorld.warning.lowDiskSpace.title": "¡Abiço! ¡Quea poco êppaçio n'er dîcco!",
	"selectWorld.world": "Mundo",
	"selectWorld.world_gen_settings_access": "¡No çe puedê leê ni açedêh ar archibo de configuraçió' de generaçiô der mundo! %s",
	"selecteWorld.backupRequiredTooltip": "Pa' cargá er mundo neçeçita haçe una copia primero",
	...
	"slot.only_single_allowed": "Çolo çe permiten êppaçiô indibidualê, ôttenío: %s",
	...
	"snbt.parser.expected_hex_escape": "Ç'êpperaba una cadena de lonhitûh %s",
	"snbt.parser.expected_hex_numeral": "Ç'êpperaba un número êççadeçimâh",
	...
	"snbt.parser.invalid_character_name": "Nombre de carâttê Unicode no bálido",
	"snbt.parser.invalid_codepoint": "Ccarâttê Unicode no bálido: %s",
	"snbt.parser.invalid_string_contents": "Er contenío de la cadena no êh bálido",
	"snbt.parser.invalid_unquoted_start": "Lâ cadenâ çin comiyâ no pueden empeçâh por lô díhitô 0-9, + o -",
	"snbt.parser.leading_zero_not_allowed": "Lô númerô deçimalê no pueden empeçâh por 0",
	"snbt.parser.no_such_operation": "La operaçión no êççîttte: %s",
	"snbt.parser.number_parse_failure": "Errôh al analiçâh número: %s",
	"snbt.parser.undescore_not_allowed": "Lô gionê bahô ar comienço o ar finâh de un número no êttán permitíô",
	...
	"stat.minecraft.happy_ghast_one_cm": "Dîttançia n'ghast felîh",
	...
	"stat.minecraft.nautilus_one_cm": "Dîttançia en nautilo",
	...
	"subtitles.block.candle.extinguish": "Bela ç'apaga",
	...
	"subtitles.block.copper_bulb.turn_off": "Lámpara de cobre ç'apaga",
	"subtitles.block.copper_bulb.turn_on": "Lámpara de cobre ç'ençiende",
	"subtitles.block.copper_chest.close": "Baûh çe çierra",
	"subtitles.block.copper_chest.open": "Baûh ç'abre",
	"subtitles.block.copper_trapdoor.close": "Trampiya ç'ençierra",
	"subtitles.block.copper_trapdoor.open": "Trampiya çe abre",
	"subtitles.block.crafter.craft": "Fabricadôh fabrica",
	"subtitles.block.crafter.fail": "Fabricadôh faya",
	"subtitles.block.creaking_heart.hurt": "Corazón de crepitante gruñe",
	"subtitles.block.creaking_heart.idle": "Ruío tenebroço",
	"subtitles.block.creaking_heart.spawn": "Coraçón de crepitante çe despierta",
	"subtitles.block.deadbush.idle": "Çoníô çecô",
	"subtitles.block.decorated_pot.insert": "Baçiha decorá çe yena",
	"subtitles.block.decorated_pot.insert_fail": "Baçiha decorá çe tambalea",
	"subtitles.block.decorated_pot.shatter": "Baçiha çe haçe añicô",
	...
	"subtitles.block.dried_ghast.ambient": "Ghast çeco reçopla",
	"subtitles.block.dried_ghast.ambient_water": "Ghast çeco çe reidrata",
	"subtitles.block.dried_ghast.place_in_water": "Ghast çeco çe empapa",
	"subtitles.block.dried_ghast.transition": "Ghast çeco çe çiente mehô",
	"subtitles.block.dry_grass.ambient": "Çoplíô de biento",
	...
	"subtitles.block.eyeblossom.close": "Capuyo çe çierra",
	"subtitles.block.eyeblossom.idle": "Capuyo çuçurra",
	"subtitles.block.eyeblossom.open": "Capuyo çe abre",
	...
	"subtitles.block.firefly_bush.idle": "Luçiênnagâ çumban",
	...
	"subtitles.block.generic.fall": "Argo cae çobre un bloque",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Cartêh çe balançea",
	...
	"subtitles.block.pale_hanging_moss.idle": "Ruío tenebroço",
	...
	"subtitles.block.sand.idle": "Çonío arenoçô",
	"subtitles.block.sand.wind": "Çoplíô de biento",
	...
	"subtitles.block.sculk_sensor.clicking": "Çençôh de ehcurk ç'âttiba",
	...
	"subtitles.block.shelf.activate": "Êttante çe âttiba",
	"subtitles.block.shelf.deactivate": "Êttante çe deçâttiba",
	"subtitles.block.shelf.multi_swap": "Ôhhetô çe intercambian",
	"subtitles.block.shelf.place_item": "Ôhheto puêtto",
	"subtitles.block.shelf.single_swap": "Ôhheto çe intercambia",
	"subtitles.block.shelf.take_item": "Ôhheto tomao",
	...
	"subtitles.block.sniffer_egg.crack": "Guebo d'olîqqueadôh ç'agrieta",
	"subtitles.block.sniffer_egg.hatch": "Guebo d'olîqqueadôh ecloçiona",
	"subtitles.block.sniffer_egg.plop": "Olîqqueadôh pone un guebo",
	"subtitles.block.sponge.absorb": "Êpponha âççorbe",
	"subtitles.block.sweet_berry_bush.pick_berries": "Bayâ recohíâ",
	"subtitles.block.trapdoor.close": "Trampiya ç'ençierra",
	"subtitles.block.trapdoor.open": "Trampiya çe abre",
	"subtitles.block.trapdoor.toggle": "Trampiya rexina",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Ôhheto ominoço çe prepara",
	"subtitles.block.trial_spawner.ambient": "Heneradôh de deçafío xîpporrotea",
	"subtitles.block.trial_spawner.ambient_charged": "Xîpporroteo ominoço",
	"subtitles.block.trial_spawner.ambient_ominous": "Xîpporroteo ominoço",
	"subtitles.block.trial_spawner.charge_activate": "Preçahio embuerbe un heneradôh de deçafío",
	"subtitles.block.trial_spawner.close_shutter": "Heneradôh de deçafío çe çierra",
	"subtitles.block.trial_spawner.detect_player": "Heneradôh de deçafío cargao",
	"subtitles.block.trial_spawner.eject_item": "Heneradôh de deçafío êppurça ôhhetô",
	"subtitles.block.trial_spawner.ominous_activate": "Preçahio embuerbe un heneradôh de deçafío",
	"subtitles.block.trial_spawner.open_shutter": "Heneradôh de deçafío çe abre",
	"subtitles.block.trial_spawner.spawn_item": "Ôhheto ominoço cae",
	"subtitles.block.trial_spawner.spawn_item_begin": "Ôhheto ominoço apareçe",
	"subtitles.block.trial_spawner.spawn_mob": "Heneradôh êppawnea un mob",
	...
	"subtitles.block.vault.activate": "Arca âttibá",
	"subtitles.block.vault.ambient": "Arca xîpporrotea",
	"subtitles.block.vault.close_shutter": "Arca çe çierra",
	"subtitles.block.vault.deactivate": "Arca deçâttibá",
	"subtitles.block.vault.eject_item": "Arca êppurça un ôhheto",
	"subtitles.block.vault.insert_item": "Arca çe dêbbloquea",
	"subtitles.block.vault.insert_item_fail": "Arca rexaça un ôhheto",
	"subtitles.block.vault.open_shutter": "Arca çe abre",
	"subtitles.block.vault.reject_rewarded_player": "Arca rexaça a un hugadôh",
	"subtitles.block.water.ambient": "Agua fluye",
	"subtitles.block.wet_sponge.dries": "Êpponha çe çeca",
	...
	"subtitles.entity.armadillo.ambient": "Armaíyo gruñe",
	"subtitles.entity.armadillo.brush": "Armaíyo çepiyao",
	"subtitles.entity.armadillo.death": "Armaíyo muere",
	"subtitles.entity.armadillo.eat": "Armaíyo come",
	"subtitles.entity.armadillo.hurt": "Armaíyo herío",
	"subtitles.entity.armadillo.hurt_reduced": "Armaíyo çe protehe",
	"subtitles.entity.armadillo.land": "Armaíyo aterriça",
	"subtitles.entity.armadillo.peek": "Armaíyo ç'açoma",
	"subtitles.entity.armadillo.roll": "Armaíyo ç'enroya",
	"subtitles.entity.armadillo.scute_drop": "Armaíyo çuerta una êccama",
	"subtitles.entity.armadillo.unroll_finish": "Armaíyo çe deçenroya",
	"subtitles.entity.armadillo.unroll_start": "Armaíyo ç'açoma",
	...
	"subtitles.entity.baby_cat.ambient": "Gatito maúya",
	...
	"subtitles.entity.baby_cat.hurt": "Gatito erío",
	"subtitles.entity.baby_cat.purr": "Gatito ronronea",
	"subtitles.entity.baby_chicken.ambient": "Poyito pía",
	"subtitles.entity.baby_chicken.death": "Poyito muere",
	"subtitles.entity.baby_chicken.hurts": "Poyito erío",
	"subtitles.entity.baby_horse.ambient": "Potro relinxa",
	"subtitles.entity.baby_horse.angry": "Potro relinxa",
	"subtitles.entity.baby_horse.breathe": "Potro rêppira",
	"subtitles.entity.baby_horse.death": "Potro muere",
	"subtitles.entity.baby_horse.eat": "Potro come",
	"subtitles.entity.baby_horse.hurt": "Potro erío",
	"subtitles.entity.baby_horse.land": "Potro aterriça",
	"subtitles.entity.baby_nautilus.ambient": "Cría de nautilo xiya",
	"subtitles.entity.baby_nautilus.ambient_land": "Cría de nautilo xiya",
	...
	"subtitles.entity.baby_nautilus.hurt": "Cría de nautilo erío",
	"subtitles.entity.baby_nautilus.hurt_land": "Cría de nautilo erío",
	"subtitles.entity.baby_nautilus.swim": "Cría de nautilo nada",
	"subtitles.entity.baby_pig.ambient": "Lexón gruñe",
	"subtitles.entity.baby_pig.death": "Lexón muere",
	"subtitles.entity.baby_pig.eat": "Lexón come",
	"subtitles.entity.baby_pig.hurt": "Lexón erío",
	"subtitles.entity.baby_wolf.ambient": "Lobênno ladra",
	"subtitles.entity.baby_wolf.death": "Lobênno muere",
	"subtitles.entity.baby_wolf.growl": "Lobênno gruñe",
	"subtitles.entity.baby_wolf.hurt": "Lobênno erío",
	"subtitles.entity.baby_wolf.pant": "Lobênno hadea",
	"subtitles.entity.baby_wolf.whine": "Lobênno himotea",
	...
	"subtitles.entity.bogged.ambient": "Çiénago traquetea",
	"subtitles.entity.bogged.death": "Çiénago muere",
	"subtitles.entity.bogged.hurt": "Çiénago erío",
	"subtitles.entity.breeze.charge": "Breeze carga",
	"subtitles.entity.breeze.death": "Breeze muere",
	"subtitles.entity.breeze.deflect": "Breeze dêbbía",
	"subtitles.entity.breeze.hurt": "Breeze erío",
	"subtitles.entity.breeze.idle_air": "Breeze buela",
	"subtitles.entity.breeze.idle_ground": "Breeze çumba",
	"subtitles.entity.breeze.inhale": "Breeze inala",
	"subtitles.entity.breeze.jump": "Breeze çarta",
	"subtitles.entity.breeze.land": "Breeze aterriça",
	"subtitles.entity.breeze.shoot": "Breeze dîppara",
	"subtitles.entity.breeze.slide": "Breeze çe dêl-liça",
	"subtitles.entity.breeze.whirl": "Breeze ulula",
	"subtitles.entity.breeze.wind_burst": "Carga de biento êttaya",
	...
	"subtitles.entity.camel_husk.ambient": "Cameyo diçecao gruñe",
	"subtitles.entity.camel_husk.dash": "Cameyo diçecao çe lança",
	"subtitles.entity.camel_husk.dash_ready": "Cameyo diçecao çe recupera",
	"subtitles.entity.camel_husk.death": "Cameyo diçecao muere",
	"subtitles.entity.camel_husk.eat": "Cameyo diçecao come",
	"subtitles.entity.camel_husk.hurt": "Cameyo diçecao erío",
	"subtitles.entity.camel_husk.saddle": "Montura equipá",
	"subtitles.entity.camel_husk.sit": "Cameyo diçecao çe çienta",
	"subtitles.entity.camel_husk.stand": "Cameyo diçecao çe lebanta",
	...
	"subtitles.entity.copper_golem.hurt": "Gólem de Cobre erío",
	"subtitles.entity.copper_golem.item_drop": "Gólem de Cobre êttá colocando un ítem",
	"subtitles.entity.copper_golem.item_no_drop": "Gólem de cobre no puede colocâh el ítem",
	"subtitles.entity.copper_golem.no_item_get": "Gólem de cobre êttá recohiendo un ôhheto",
	"subtitles.entity.copper_golem.no_item_no_get": "Gólem de cobre no puede recohêh un ôhheto",
	"subtitles.entity.copper_golem.spawn": "Gólem de cobre apareçe",
	"subtitles.entity.copper_golem.spin": "Cabeça der gólem de cobre hira",
	"subtitles.entity.copper_golem_become_statue": "Gólem de Cobre petrificao",
	"subtitles.entity.copper_golem_oxidized.death": "Gólem de Cobre muere",
	"subtitles.entity.copper_golem_oxidized.hurt": "Gólem de Cobre erío",
	"subtitles.entity.copper_golem_oxidized.spin": "Cabeça der Gólem de Cobre hira",
	"subtitles.entity.copper_golem_weathered.death": "Gólem de Cobre muere",
	"subtitles.entity.copper_golem_weathered.hurt": "Gólem de Cobre erío",
	"subtitles.entity.copper_golem_weathered.spin": "Cabeça der Gólem de Cobre hira",
	...
	"subtitles.entity.creaking.activate": "Crepitante mira",
	"subtitles.entity.creaking.ambient": "Cruhidô chirrîà",
	"subtitles.entity.creaking.attack": "Cruhidô te cruhe",
	"subtitles.entity.creaking.deactivate": "Cruhidô çe câhma",
	"subtitles.entity.creaking.death": "Cruhidô çe dehmorôna",
	"subtitles.entity.creaking.freeze": "Cruhidô çe pâra",
	"subtitles.entity.creaking.spawn": "Cruhidô çe manifêhtta",
	"subtitles.entity.creaking.sway": "Cruhidô eh goppeâo",
	"subtitles.entity.creaking.twitch": "Cruhidô çe retuêhçe",
	"subtitles.entity.creaking.unfreeze": "Cruhidô çe muêbe",
	...
	"subtitles.entity.donkey.jump": "Burro çarta",
	...
	"subtitles.entity.fish.swim": "Chappotêoh",
	...
	"subtitles.entity.generic.wind_burst": "Carga de biento êttaya",
	...
	"subtitles.entity.ghastling.ambient": "Ghastling arruya",
	"subtitles.entity.ghastling.death": "Ghastling muere",
	"subtitles.entity.ghastling.hurt": "Ghastling çe daña",
	"subtitles.entity.ghastling.spawn": "Ghastling apareçe",
	...
	"subtitles.entity.happy_ghast.ambient": "Ghast felîh canturrea",
	"subtitles.entity.happy_ghast.death": "Ghast felîh muere",
	"subtitles.entity.happy_ghast.equip": "Arnêh equipao",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Ghast felîh lîtto",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Ghast felîh çe para",
	"subtitles.entity.happy_ghast.hurt": "Ghast felîh herio",
	"subtitles.entity.happy_ghast.unequip": "Arnêh deçequipao",
	...
	"subtitles.entity.horse.armor": "Armaúra pa haca equipá",
	...
	"subtitles.entity.leash_knot.break": "Rienda çe rompe",
	"subtitles.entity.leash_knot.place": "Rienda çe ata",
	...
	"subtitles.entity.minecart.inside": "Bagonêta chîrría",
	"subtitles.entity.minecart.inside_underwater": "Bagonêta chîrría bâho eh âgua",
	...
	"subtitles.entity.mule.jump": "Mula çarta",
	"subtitles.entity.nautilus.ambient": "Nautilo xâqquea",
	"subtitles.entity.nautilus.ambient_land": "Nautilo xâqquea",
	"subtitles.entity.nautilus.dash": "Nautilo çe propurça",
	"subtitles.entity.nautilus.dash_land": "Nautilo çe propurça",
	"subtitles.entity.nautilus.dash_ready": "Nautilo çe recupera",
	"subtitles.entity.nautilus.dash_ready_land": "Nautilo çe recupera",
	...
	"subtitles.entity.nautilus.hurt": "Nautilo erío",
	"subtitles.entity.nautilus.hurt_land": "Nautilo erío",
	...
	"subtitles.entity.parched.ambient": "Momificao traquetea",
	"subtitles.entity.parched.death": "Momificao muere",
	"subtitles.entity.parched.hurt": "Momificao erío",
	...
	"subtitles.entity.parrot.imitate.bogged": "Loro imita a un çiénago",
	"subtitles.entity.parrot.imitate.breeze": "Loro imita a un breeze",
	"subtitles.entity.parrot.imitate.camel_husk": "Loro imita a un cameyo diçecao",
	"subtitles.entity.parrot.imitate.creaking": "Lôro crûhe",
	...
	"subtitles.entity.parrot.imitate.parched": "Loro imita a un momificao",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Loro imita a una haca çombi",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Loro imita a un nautilo çombi",
	...
	"subtitles.entity.pig.eat": "Çerdo come",
	...
	"subtitles.entity.player.teleport": "Hugadôh çe teletrâpporta",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Cabâyo ehquelêto çattâ",
	...
	"subtitles.entity.sniffer.death": "Olîqqueadôh muere",
	"subtitles.entity.sniffer.digging": "Olîqqueadôh êccaba",
	"subtitles.entity.sniffer.digging_stop": "Olîqqueadôh çe lebanta",
	"subtitles.entity.sniffer.drop_seed": "Olîqqueadôh çuerta una çemiya",
	"subtitles.entity.sniffer.eat": "Olîqqueadôh come",
	"subtitles.entity.sniffer.egg_crack": "Guebo d'olîqqueadôh ç'agrieta",
	"subtitles.entity.sniffer.egg_hatch": "Guebo d'olîqqueadôh ecloçiona",
	"subtitles.entity.sniffer.happy": "Olîqqueadôh çe deleita",
	"subtitles.entity.sniffer.hurt": "Olîqqueadôh herío",
	"subtitles.entity.sniffer.idle": "Olîqqueadôh gruñe",
	"subtitles.entity.sniffer.scenting": "Olîqqueadôh guele",
	"subtitles.entity.sniffer.searching": "Olîqqueadôh bûcca",
	"subtitles.entity.sniffer.sniffing": "Olîqqueadôh orfatea",
	"subtitles.entity.sniffer.step": "Olîqqueadôh camina",
	...
	"subtitles.entity.wind_charge.throw": "Carga de biento lançá",
	"subtitles.entity.wind_charge.wind_burst": "Carga de biento êttaya",
	...
	"subtitles.entity.wolf.pant": "Lobo hadea",
	"subtitles.entity.wolf.shake": "Lobo çacudiéndoçe",
	"subtitles.entity.wolf.whine": "Lobo himotea",
	...
	"subtitles.entity.zombie_horse.angry": "Haca çombi relinxa",
	"subtitles.entity.zombie_horse.death": "Haca çombi muere",
	"subtitles.entity.zombie_horse.eat": "Haca çombi come",
	"subtitles.entity.zombie_horse.hurt": "Haca çombi hería",
	"subtitles.entity.zombie_nautilus.ambient": "Nautilo çombi barbuçea",
	"subtitles.entity.zombie_nautilus.ambient_land": "Nautilo çombi barbuçea",
	"subtitles.entity.zombie_nautilus.dash": "Nautilo çombi çe propurça",
	"subtitles.entity.zombie_nautilus.dash_land": "Nautilo çombi çe propurça",
	"subtitles.entity.zombie_nautilus.dash_ready": "Nautilo çombi çe recupera",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Nautilo çombi çe recupera",
	"subtitles.entity.zombie_nautilus.death": "Nautilo çombi muere",
	"subtitles.entity.zombie_nautilus.death_land": "Nautilo çombi muere",
	"subtitles.entity.zombie_nautilus.eat": "Nautilo çombi come",
	"subtitles.entity.zombie_nautilus.hurt": "Nautilo çombi erío",
	"subtitles.entity.zombie_nautilus.hurt_land": "Nautilo çombi erío",
	"subtitles.entity.zombie_nautilus.swim": "Nautilo çombi nada",
	...
	"subtitles.event.mob_effect.bad_omen": "Un preçahio çe manifiêtta",
	"subtitles.event.mob_effect.raid_omen": "Ç'abeçina una imbaçión",
	"subtitles.event.mob_effect.trial_omen": "Ç'abeçina un deçafío ominoço",
	...
	"subtitles.item.armor.equip_copper": "Armadura de cobre açe un ruío çeco",
	...
	"subtitles.item.armor.equip_nautilus": "Armaúra pa nautilo equipá",
	...
	"subtitles.item.armor.equip_wolf": "Armaúra pa lobo equipá",
	"subtitles.item.armor.unequip_nautilus": "Armaúra pa nautilo deçequipá",
	"subtitles.item.armor.unequip_wolf": "Armaúra pa lobo çe çuerta",
	...
	"subtitles.item.brush.brushing.gravel": "Çepiyando çaorra",
	"subtitles.item.brush.brushing.gravel.complete": "Çepiyao de çaorra completao",
	"subtitles.item.brush.brushing.sand": "Çepiyando arena",
	...
	"subtitles.item.bundle.insert_fail": "Çaco yêno",
	...
	"subtitles.item.elytra.flying": "Çibîdo",
	...
	"subtitles.item.golden_dandelion.unuse": "Creçimiento reanudao",
	"subtitles.item.golden_dandelion.use": "Creçimiento detenío",
	...
	"subtitles.item.horse_armor.unequip": "Armaúra pa haca çe çuerta",
	"subtitles.item.ink_sac.use": "Çaco de tinta manxa",
	"subtitles.item.lead.break": "Rienda çe rompe",
	"subtitles.item.lead.tied": "Rienda atâh",
	"subtitles.item.lead.untied": "Rienda desatâh",
	"subtitles.item.llama_carpet.unequip": "Arfombra çe çuerta",
	"subtitles.item.lodestone_compass.lock": "Brúhula imantá çe fiha a la mânnetita",
	"subtitles.item.mace.smash_air": "Maça gorpea",
	"subtitles.item.mace.smash_ground": "Maça gorpea",
	"subtitles.item.nautilus_saddle_equip": "Montura equipá",
	"subtitles.item.nautilus_saddle_underwater_equip": "Montura equipá",
	"subtitles.item.nether_wart.plant": "Berruga curtibá",
	"subtitles.item.ominous_bottle.dispose": "Frâcco çe quiebra",
	"subtitles.item.saddle.unequip": "Montura çe çuerta",
	"subtitles.item.shears.shear": "Xâqquío de êttiherâ",
	"subtitles.item.shears.snip": "Êttiherâ cortan",
	"subtitles.item.shield.block": "Bloqueo con êccúo",
	"subtitles.item.shovel.flatten": "Pala aplanando",
	"subtitles.item.spear.attack": "Lança ataca",
	"subtitles.item.spear.hit": "Lança impâtta",
	"subtitles.item.spear.lunge": "Êttocá con lança",
	"subtitles.item.spear.use": "Carga con lança",
	"subtitles.item.spear_wood.attack": "Lança ataca",
	"subtitles.item.spear_wood.hit": "Lança impâtta",
	"subtitles.item.spear_wood.use": "Carga con lança",
	...
	"subtitles.item.underwater_saddle.equip": "Montura equipá",
	"subtitles.item.wolf_armor.break": "Armaúra pa lobo çe rompe",
	"subtitles.item.wolf_armor.crack": "Armaúra pa lobo ç'agrieta",
	"subtitles.item.wolf_armor.damage": "Armaúra pa lobo dañá",
	"subtitles.item.wolf_armor.repair": "Armaúra pa lobo repará",
	"subtitles.particle.soul_escape": "Ánima ç'êccapa",
	"subtitles.ui.cartography_table.take_result": "Mapa dibuhao",
	"subtitles.ui.hud.bubble_pop": "Oxígeno ç'agota",
	"subtitles.ui.loom.take_result": "Telâh utiliçao",
	"subtitles.ui.stonecutter.take_result": "Cortapiedrâ utiliçao",
	"subtitles.weather.end_flash": "Rêttayío del End",
	"subtitles.weather.rain": "Yuebe",
	"symlink_warning.message": "Cargâh mundô dêdde carpetâ con enlaçê çimbólicô puede çêh poco çeguro çi no çabê êççâttamente lo que êttâh açiendo. Biçita %s pa mâh informaçión.",
	"symlink_warning.message.pack": "Cargâh paquetê con enlaçê çimbólicô puede çêh poco çeguro çi no çabê êççâttamente lo que êttâh açiendo. Biçita %s pa mâh informaçión.",
	"symlink_warning.message.world": "Cargâh mundô dêdde carpetâ con enlaçê çimbólicô puede çêh poco çeguro çi no çabê êççâttamente lo que êttâh açiendo. Biçita pa %s mâh informaçión.",
	"symlink_warning.more_info": "Mâh informaçión",
	"symlink_warning.title": "La carpeta der mundo contiene enlaçê çimbólicô",
	"symlink_warning.title.pack": "Lô paquetê añadíô contienen enlaçê çimbólicô",
	"symlink_warning.title.world": "La carpeta der mundo contiene enlaçê çimbólicô",
	...
	"telemetry.event.advancement_made.description": "Comprendêh er contêtto en er que çe reçibe un abançe, nô ayudará a entendêh y mehorâh la progreçión der huego.",
	"telemetry.event.advancement_made.title": "Progreço realiçao",
	"telemetry.event.game_load_times.description": "Êtte ebento puede ayudânnô a determinâh lâ mehorâ de rendimiento que neçeçitamô, midiendo lô tiempô de ehecuçión de lâ diferentê façê de arranque.",
	...
	"telemetry.event.optional.disabled": "%s (ôççionâh): Deçâttibao",
	...
	"telemetry_info.button.privacy_statement": "Declaraçión de pribaçidá",
	"telemetry_info.button.show_data": "Mirâh mî datô",
	"telemetry_info.opt_in.description": "Permito embiâh mî datô de telemetría ôççionalê",
	...
	"test.error.block_property_mismatch": "Çe requiere que la propiedâh %s sea %s, ôttenío: %s",
	"test.error.block_property_missing": "Farta una propiedâh de bloque, çe requiere que la propiedad %s sea %s",
	"test.error.entity_property": "La entidâh %s fayó la prueba: %s",
	"test.error.entity_property_details": "La entidâh %s fayó la prueba: %s. Çe requiere: %s, ôttenío: %s",
	"test.error.expected_block": "Çe requiere er bloque %s, ôttenío: %s",
	"test.error.expected_block_present": "Çe requiere er bloque %s preçente",
	...
	"test.error.expected_entity_count": "Çe requieren %s entidadê der tipo %s, ç'encontraron %s",
	...
	"test.error.expected_item": "Çe requiere un ôhheto der tipo %s",
	"test.error.expected_items_count": "Çe requieren %s ôhhetô der tipo %s, ç'encontraron %s",
	...
	"test.error.not_a_block_item": "Er bloque dao no êh un ôhheto de bloque",
	...
	"test.error.sequence.minimum_tick": "Éççito antê der tîh êpperao: çe êpperaba que êpperaçe %s",
	...
	"test.error.spawn_failure": "No çe pudo creâh la entidâh %s",
	...
	"test.error.unexpected_item": "No ç'êpperaba un ôhheto der tipo %s",
	...
	"test_block.error.missing": "Farta er bloque %s en la êttrûttura de prueba",
	"test_block.error.too_many": "Demaçiâoh blôqueh %s",
	"test_block.invalid_timeout": "Tiempo de êppera no bálido (%s): debe çêh un número poçitibo de tics",
	"test_block.message": "Mehçâhe:",
	"test_block.mode.accept": "Açettâh",
	"test_block.mode.fail": "Fayâh",
	"test_block.mode.log": "Rehittrâh",
	"test_block.mode.start": "'Mpeçâh",
	"test_block.mode_info.accept": "Môdo açettâh - Açêtta la çupêraçión de (pâtte d') una pruêba",
	"test_block.mode_info.fail": "Môdo fayâh - Fâya la pruêba",
	"test_block.mode_info.log": "Môdo rehittrâh - rehîttra un mençâhe",
	"test_block.mode_info.start": "Môdo 'mpeçâh - Eh pûnto d'inîçio d'una pruêba",
	"test_instance.action.reset": "Reiniçiâh y cargâh",
	"test_instance.action.run": "Cargâh y ehecutâh",
	"test_instance.action.save": "Guardâh êttrûttura",
	"test_instance.description.batch": "Lote: %s",
	"test_instance.description.failed": "Fayó: %s",
	"test_instance.description.function": "Funçión: %s",
	"test_instance.description.invalid_id": "Id. de prueba no bálida",
	"test_instance.description.no_test": "Eça prueba no êççîtte",
	"test_instance.description.structure": "Êttrûttura: %s",
	"test_instance.description.type": "Tipo: %s",
	"test_instance.type.block_based": "Pruêba basâh eh blôqueh",
	"test_instance.type.function": "Prueba de funçión integrá",
	"test_instance_block.entities": "Ettidâes:",
	"test_instance_block.error.no_test": "No ça podío ehecutâh er caço de prueba en %s, %s, %s porque no ça definío una prueba",
	"test_instance_block.error.no_test_structure": "No ça podío ehecutâh la îttançia de prueba en %s, %s, %s porque no tiene êttrûttura de prueba",
	"test_instance_block.error.unable_to_save": "No ça podío guardâh la plantilla d'êttrûttura de prueba en %s, %s, %s",
	"test_instance_block.invalid": "[no bálido]",
	"test_instance_block.reset_success": "Ça reiniciao la prueba %s",
	"test_instance_block.rotation": "Rotaçîón:",
	"test_instance_block.size": "Tamaño de la êttrûttura de prueba",
	"test_instance_block.starting": "Iniçiando prueba %s",
	"test_instance_block.test_id": "Id. der caço de prueba",
	...
	"title.credits": "Copyright Mojang AB. ¡No dîttribuîh!",
	"title.multiplayer.disabled": "Er modo murtihugadôh êttá deçâttibao. Arfabôh y comprueba lô ahûttê de tu cuenta de Microsoft.",
	"title.multiplayer.disabled.banned.name": "Debê cambiâh tu nombre de uçuario antê de hugâh en murtihugadôh",
	...
	"trim_material.minecraft.amethyst": "Incrûttaçionê de amatîtta",
	...
	"trim_pattern.minecraft.bolt": "Diseño d'armaúra de remaxê",
	...
	"trim_pattern.minecraft.flow": "Diseño d'armaúra d'êppirâh",
	...
	"upgradeWorld.aborted.message": "Êtto puede çuçedêh çi otro programa âççedió ar mundo durante la âttualiçaçión.\nPuede çêh útî reiniçiâh tu ordenadôh e intentâl-lo de nuebo. Çi er problema perçîtte, puedê informâh del errôh.",
	"upgradeWorld.aborted.reportBug": "Informâh de errôh",
	"upgradeWorld.aborted.title": "Errôh al âttualiçâh er mundo",
	"upgradeWorld.canceled.message": "Tu mundo çige çiendo como era antê.",
	"upgradeWorld.canceled.title": "Âttualiçaçión der mundo cançelá",
	"upgradeWorld.done": "Âttualiçaçiôn der Mundo Completadâh",
	"upgradeWorld.failed_cleanup.message": "Er mundo çe a âttualiçao corrêttamente a la berçión âttuâh y aora êttá dîpponible en la lîtta de mundô.\nEmô encontrao problemâ ar limpiâh datô ôççoletô, por lo que er nombre de la carpeta der mundo a cambiao a %s.",
	"upgradeWorld.failed_cleanup.title": "Mundo âttualiçao con éççito",
	"upgradeWorld.info.converted": "Âttualiçao: %s",
	"upgradeWorld.info.file_fix_stage": "Êtapa: %s/%s",
	"upgradeWorld.info.scanning": "Êccaneandoh archiboh...",
	"upgradeWorld.info.total": "Totâh: %s",
	"upgradeWorld.joinNow": "¿Te quierêh unî ar mundo aora?",
	"upgradeWorld.progress.percentage": "%s%%",
	"upgradeWorld.progress.type.files": "Mobiendo archibôh",
	"upgradeWorld.progress.type.legacy_structures": "Âttualiçando lâh êtrutturâh heredâh",
	"upgradeWorld.progress.type.region": "Âttualiçando rehionê",
	"upgradeWorld.symlink.message": "Êtte mundo contienê enlaçêh simbólicôh.\nLôh paçôh neçeçariô pâ âttualiçá er mundo a la bersió âttúa no soportâh er uso de enlaçêh simbólicôh. Pâ âttualiçá er mundo. lôh enlaçêh neçeçitâh çé reçuertôh antê.",
	"upgradeWorld.symlink.title": "No çê puedê âttualiçá er mundo",
	"upgradeWorld.title": "Âttualiçando lôh Archibôh der Mundo",
}
