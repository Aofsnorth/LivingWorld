// Code generated by tools/gen_lang.go from 26.1/sr_cs.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Podešavanja pristupačnosti...",
	...
	"advancements.adventure.blowback.description": "Ubij Povetarac sa odbačenim punjenjem vetra",
	"advancements.adventure.blowback.title": "Povratni udarac",
	"advancements.adventure.brush_armadillo.description": "Nabavite Oklopnikove Scutove od Oklopnika koristeći četku",
	"advancements.adventure.brush_armadillo.title": "Nije li sladak?",
	...
	"advancements.adventure.crafters_crafting_crafters.description": "Budi blizu proizvođača kada napravi proizvođača",
	"advancements.adventure.crafters_crafting_crafters.title": "Proizvođači proizvode proizvođače",
	...
	"advancements.adventure.heart_transplanter.description": "Postavi Srce Škripca pravilno između dva Bloka Belog Hrasta",
	"advancements.adventure.heart_transplanter.title": "Transplator srca",
	...
	"advancements.adventure.lighten_up.description": "Ištrugaj bakarnu sijalicu sekirom da bude svetlija",
	"advancements.adventure.lighten_up.title": "Zasvetli",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Kroči u Komoru Izazova",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Testna edicija",
	...
	"advancements.adventure.overoverkill.description": "Nanesi 50 srca štete jednim pogotkom koristeći buzdovan",
	"advancements.adventure.overoverkill.title": "Pre-preterivanje",
	...
	"advancements.adventure.revaulting.description": "Otključajte Zloslutnu riznicu Zloslutnim ključem Izazova",
	"advancements.adventure.revaulting.title": "Riznično",
	...
	"advancements.adventure.under_lock_and_key.description": "Otključajte Riznicu Ključem Izazova",
	"advancements.adventure.under_lock_and_key.title": "Pod katancem i ključem",
	"advancements.adventure.use_lodestone.description": "Koristi Kompas na Magnetu",
	"advancements.adventure.use_lodestone.title": "Magnetit se vraća kući",
	...
	"advancements.adventure.who_needs_rockets.description": "Lansiraj se 8 blokova uvis uz pomoć vazdušne lopte",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Postavi Osušen Ghast blok u vodu",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Skloni Vučji Oklop sa Vuka koristeći Makaze",
	"advancements.husbandry.remove_wolf_armor.title": "Savršenstvo makaza",
	"advancements.husbandry.repair_wolf_armor.description": "Popravi oštećeno odelo vuka koristeći štit armadila",
	...
	"advancements.husbandry.whole_pack.description": "Pripitomi jednog od svake rase vuka",
	"advancements.husbandry.whole_pack.title": "Ceo čopor",
	...
	"advancements.nether.fast_travel.description": "Iskoristi Nether da pređete 7 kilometara u Nadzemlju",
	...
	"advancements.nether.ride_strider_in_overworld_lava.description": "Povedite šetača na duuuugu šetnju po jezeru lave u Nadzemlju",
	...
	"advancements.nether.uneasy_alliance.description": "Spasite ghasta iz Nethera, bezbedno ga dovedite kući u Nadzemlje... i onda ga ubijte",
	...
	"argument.hexcolor.invalid": "Nevažeći heksadecimalni kod boje '%s'",
	...
	"argument.message.too_long": "Poslata poruka je predugačka (%s > maksimalno %s znakova)",
	...
	"argument.resource_or_id.failed_to_parse": "Rastavljanje strukture neuspešno: %s",
	"argument.resource_or_id.invalid": "Nevalidan id ili tag",
	"argument.resource_or_id.no_such_element": "Nije moguće pronaći elemenat „%s“ tipa „%s“",
	...
	"argument.waypoint.invalid": "Izabran entitet nije putna tačka",
	...
	"arguments.item.component.expected": "Očekivana komponenta stvari",
	"arguments.item.component.malformed": "Neispravna '%s' komponenta: '%s'",
	"arguments.item.component.repeated": "Komponenta stvari '%s' je ponovljena, ali se može navesti samo jedna vrednost",
	...
	"attribute.name.armor_toughness": "Jačina oklopa",
	"attribute.name.attack_damage": "Oštećenje povod napada",
	"attribute.name.attack_knockback": "Povratni udarac napada",
	...
	"attribute.name.block_interaction_range": "Domet interakcije s blokom",
	"attribute.name.bounciness": "Bounciness",
	"attribute.name.burning_time": "Vreme gorenja",
	"attribute.name.camera_distance": "Udaljenost kamere",
	"attribute.name.entity_interaction_range": "Domet interakcije sa entitetom",
	"attribute.name.explosion_knockback_resistance": "Otpor na povratni udarac eksplozije",
	"attribute.name.fall_damage_multiplier": "Multiplikator štete pada",
	...
	"attribute.name.generic.burning_time": "Vreme gorenja",
	"attribute.name.generic.entity_interaction_range": "Domet interakcije entiteta",
	"attribute.name.generic.explosion_knockback_resistance": "Otpor na povratni udarac eksplozije",
	"attribute.name.generic.fall_damage_multiplier": "Multiplikator štete pada",
	...
	"attribute.name.generic.jump_strength": "Jačina skoka",
	...
	"attribute.name.generic.movement_efficiency": "Efikasnost pokretljivosti",
	"attribute.name.generic.movement_speed": "Brzina",
	"attribute.name.generic.oxygen_bonus": "Bonus kiseonik",
	"attribute.name.generic.safe_fall_distance": "Bezbedna daljina pada",
	"attribute.name.generic.scale": "Razmer",
	"attribute.name.generic.step_height": "Visina koraka",
	"attribute.name.generic.water_movement_efficiency": "Efikasnost pokretljivosti u vodi",
	...
	"attribute.name.knockback_resistance": "Otpornost na odbacivanje",
	"attribute.name.luck": "Sreća",
	"attribute.name.max_absorption": "Maksimalna apsorbcija",
	...
	"attribute.name.oxygen_bonus": "Bonus kiseonika",
	"attribute.name.player.block_break_speed": "Brzina Uništavanja Bloka",
	"attribute.name.player.block_interaction_range": "Domet Interakcije Bloka",
	"attribute.name.player.entity_interaction_range": "Domet Interakcije Entiteta",
	"attribute.name.player.mining_efficiency": "Efikasnost kopanja",
	"attribute.name.player.sneaking_speed": "Brzina šunjanja",
	"attribute.name.player.submerged_mining_speed": "Efikasnost kopanja pod vodom",
	"attribute.name.player.sweeping_damage_ratio": "Razmera dometa oštećenja",
	"attribute.name.safe_fall_distance": "Bezbedna daljina pada",
	...
	"attribute.name.submerged_mining_speed": "Efikasnost kopanja pod vodom",
	"attribute.name.sweeping_damage_ratio": "Razmera dometa oštećenja",
	"attribute.name.tempt_range": "Domet mamljenja stvorenja",
	"attribute.name.water_movement_efficiency": "Efikasnost pokretljivosti u vodi",
	"attribute.name.waypoint_receive_range": "Domet prijema putne tačke",
	"attribute.name.waypoint_transmit_range": "Domet prenosa putne tačke",
	...
	"biome.minecraft.pale_garden": "Bledi vrt",
	...
	"block.minecraft.acacia_shelf": "Polica od Bagrema",
	...
	"block.minecraft.banner.flow.black": "Crni tok",
	"block.minecraft.banner.flow.blue": "Plavi tok",
	"block.minecraft.banner.flow.brown": "Braon tok",
	"block.minecraft.banner.flow.cyan": "Tirkizni tok",
	"block.minecraft.banner.flow.gray": "Sivi tok",
	"block.minecraft.banner.flow.green": "Zeleni tok",
	"block.minecraft.banner.flow.light_blue": "Svetloplavi tok",
	"block.minecraft.banner.flow.light_gray": "Svetlosivi tok",
	"block.minecraft.banner.flow.lime": "Svetlozeleni tok",
	"block.minecraft.banner.flow.magenta": "Magenta tok",
	"block.minecraft.banner.flow.orange": "Narandžasti tok",
	"block.minecraft.banner.flow.pink": "Roze tok",
	"block.minecraft.banner.flow.purple": "Ljubičasti tok",
	"block.minecraft.banner.flow.red": "Crveni tok",
	"block.minecraft.banner.flow.white": "Beli tok",
	"block.minecraft.banner.flow.yellow": "Žuti tok",
	...
	"block.minecraft.banner.guster.brown": "Braon zapuh",
	...
	"block.minecraft.banner.guster.light_blue": "Svetloplavi zapuh",
	"block.minecraft.banner.guster.light_gray": "Svetlosivi zapuh",
	"block.minecraft.banner.guster.lime": "Svetlozeleni zapuh",
	"block.minecraft.banner.guster.magenta": "Magenta zapuh",
	"block.minecraft.banner.guster.orange": "Narandžasti zapuh",
	"block.minecraft.banner.guster.pink": "Roze zapuh",
	"block.minecraft.banner.guster.purple": "Ljubičasti zapuh",
	"block.minecraft.banner.guster.red": "Crveni zapuh",
	"block.minecraft.banner.guster.white": "Beli zapuh",
	...
	"block.minecraft.cactus_flower": "Kaktus cvet",
	...
	"block.minecraft.chiseled_copper": "Isklesan bakar",
	...
	"block.minecraft.chiseled_resin_bricks": "Isklesane cigle smole",
	...
	"block.minecraft.chiseled_tuff": "Isklesan Tuf",
	"block.minecraft.chiseled_tuff_bricks": "Isklesane Tuf Cigle",
	...
	"block.minecraft.closed_eyeblossom": "Zatvoren cvet očiju",
	...
	"block.minecraft.copper_bars": "Bakarne Šipke",
	...
	"block.minecraft.copper_chest": "Bakarni Kovčeg",
	"block.minecraft.copper_door": "Bakrena vrata",
	"block.minecraft.copper_golem_statue": "Statua od Bakarnog Golema",
	"block.minecraft.copper_grate": "Bakrena rešetka",
	"block.minecraft.copper_lantern": "Fenjer od Bakra",
	"block.minecraft.copper_ore": "Ruda bakra",
	"block.minecraft.copper_torch": "Baklja od Bakra",
	"block.minecraft.copper_trapdoor": "Bakarno okno",
	"block.minecraft.copper_wall_torch": "Zidna Baklja od Bakra",
	...
	"block.minecraft.crafter": "Proizvođač",
	"block.minecraft.crafting_table": "Zanatski sto",
	"block.minecraft.creaking_heart": "Srce Škripanja",
	...
	"block.minecraft.dark_oak_shelf": "Tamha hrastova polica",
	...
	"block.minecraft.exposed_copper_bulb": "Izložena bakarna sijalica",
	"block.minecraft.exposed_copper_chain": "Lanac of izloženog bakra",
	"block.minecraft.exposed_copper_chest": "Exposed Copper Chest",
	"block.minecraft.exposed_copper_door": "Vrata od Izloženog Bakra",
	"block.minecraft.exposed_copper_golem_statue": "Exposed Copper Golem Statue",
	"block.minecraft.exposed_copper_grate": "Rešetka od Izloženog Bakra",
	"block.minecraft.exposed_copper_lantern": "Exposed Copper Lantern",
	"block.minecraft.exposed_copper_trapdoor": "Okno od izloženog bakra",
	...
	"block.minecraft.firefly_bush": "Žbun svitaca",
	...
	"block.minecraft.heavy_core": "Teško Jezgro",
	...
	"block.minecraft.jungle_shelf": "Jungle polica",
	...
	"block.minecraft.leaf_litter": "Gomila Lišća",
	...
	"block.minecraft.open_eyeblossom": "Otvoren Cvet Očiju",
	...
	"block.minecraft.pale_hanging_moss": "Bleda viseća mahovina",
	"block.minecraft.pale_moss_block": "Blok blede mahovine",
	"block.minecraft.pale_moss_carpet": "Tepih blede mahovine",
	"block.minecraft.pale_oak_button": "Bledo hrastovo dugme",
	"block.minecraft.pale_oak_door": "Bleda hrastova vrata",
	"block.minecraft.pale_oak_fence": "Bleda hrastova ograda",
	"block.minecraft.pale_oak_fence_gate": "Bleda hrastova kapija",
	"block.minecraft.pale_oak_hanging_sign": "Bledi hrastov viseći znak",
	"block.minecraft.pale_oak_leaves": "Bledo hrastovo lišće",
	"block.minecraft.pale_oak_log": "Bledi hrastov panj",
	"block.minecraft.pale_oak_planks": "Blede hrastove daske",
	"block.minecraft.pale_oak_pressure_plate": "Bledo hrastova potisna ploča",
	"block.minecraft.pale_oak_sapling": "Bleda hrastova mladica",
	"block.minecraft.pale_oak_shelf": "Pale Oak Shelf",
	"block.minecraft.pale_oak_sign": "Bledi hrastov znak",
	"block.minecraft.pale_oak_slab": "Bleda hrastova ploča",
	"block.minecraft.pale_oak_stairs": "Blede hrastove stepenice",
	"block.minecraft.pale_oak_trapdoor": "Bledo hrastovo okno",
	"block.minecraft.pale_oak_wall_hanging_sign": "Bledi hrastov viseći znak",
	"block.minecraft.pale_oak_wall_sign": "Bledi hrastov zidni znak",
	"block.minecraft.pale_oak_wood": "Bleda hrastovina",
	...
	"block.minecraft.polished_tuff": "Uglačan tuf",
	"block.minecraft.polished_tuff_slab": "Uglačana tuf ploča",
	"block.minecraft.polished_tuff_stairs": "Uglačane tuf stepenice",
	"block.minecraft.polished_tuff_wall": "Zid od uglačanog tufa",
	...
	"block.minecraft.potted_closed_eyeblossom": "Saksiji zatvorenog cveta očiju",
	...
	"block.minecraft.potted_open_eyeblossom": "Otvoren cvet očiju u saksiji",
	"block.minecraft.potted_orange_tulip": "Narandžasta lala u saksiji",
	"block.minecraft.potted_oxeye_daisy": "Bela rada u saksiji",
	"block.minecraft.potted_pale_oak_sapling": "Bleda hrastova mladica u saksiji",
	...
	"block.minecraft.resin_brick_slab": "Ploča od ciglene smole",
	"block.minecraft.resin_brick_stairs": "Stepenice od ciglene smole",
	"block.minecraft.resin_brick_wall": "Zid od ciglene smole",
	"block.minecraft.resin_bricks": "Cigle od smole",
	"block.minecraft.resin_clump": "Grumen smole",
	...
	"block.minecraft.short_dry_grass": "Niska osušena trava",
	...
	"block.minecraft.stripped_pale_oak_log": "Oguljeni bledi hrastov panj",
	"block.minecraft.stripped_pale_oak_wood": "Oguljena bleda hrastovina",
	...
	"block.minecraft.tall_dry_grass": "Visoka osušena trava",
	...
	"block.minecraft.test_instance_block": "Blok test instance",
	"block.minecraft.tinted_glass": "Zamagljeno staklo",
	"block.minecraft.tnt": "Dinamit",
	"block.minecraft.tnt.disabled": "TNT eksplozije su isključene",
	...
	"block.minecraft.tuff_brick_slab": "Ploča od ciglenog tufa",
	"block.minecraft.tuff_brick_stairs": "Stepenice od ciglenog tufa",
	"block.minecraft.tuff_brick_wall": "Zid od ciglenog tufa",
	"block.minecraft.tuff_bricks": "Tuf cigle",
	"block.minecraft.tuff_slab": "Tuf ploča",
	"block.minecraft.tuff_stairs": "Stepenice od tufa",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Izloženi isklesani bakar obložen voskom",
	...
	"block.minecraft.waxed_exposed_copper_bulb": "Izložena bakarna sijalica obložena voskom",
	...
	"block.minecraft.waxed_exposed_copper_door": "Izložena bakarna vrata obložena voskom",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Waxed Exposed Copper Golem Statue",
	"block.minecraft.waxed_exposed_copper_grate": "Izložena bakarna rešetka obložena voskom",
	"block.minecraft.waxed_exposed_copper_lantern": "Waxed Exposed Copper Lantern",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Izloženo bakarno okno obloženo voskom",
	...
	"block.minecraft.waxed_oxidized_chiseled_copper": "Oksidovani isklesani bakar obložen voskom",
	...
	"block.minecraft.waxed_oxidized_copper_bulb": "Oksidovana bakarna sijalica obložena voskom",
	...
	"block.minecraft.waxed_oxidized_copper_door": "Oksidovana bakarna vrata obložena voskom",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Waxed Oxidized Copper Golem Statue",
	"block.minecraft.waxed_oxidized_copper_grate": "Oksidovana bakarna rešetka obložena voskom",
	"block.minecraft.waxed_oxidized_copper_lantern": "Waxed Oxidized Copper Lantern",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Oksidovano bakarno okno obloženo voskom",
	...
	"block.minecraft.waxed_weathered_chiseled_copper": "Zastareli bakar obložen voskom",
	...
	"block.minecraft.waxed_weathered_copper_bulb": "Zastarela bakarna sijalica obložena voskom",
	...
	"block.minecraft.waxed_weathered_copper_door": "Zastarela bakarna vrata obložena voskom",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Waxed Weathered Copper Golem Statue",
	"block.minecraft.waxed_weathered_copper_grate": "Zastarela bakarna rešetka obložena voskom",
	"block.minecraft.waxed_weathered_copper_lantern": "Waxed Weathered Copper Lantern",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Zastarelo bakarno okno obloženo voskom",
	...
	"block.minecraft.weathered_chiseled_copper": "Zastareli isklesani bakar",
	"block.minecraft.weathered_copper": "Oksidovan bakar",
	"block.minecraft.weathered_copper_bars": "Weathered Copper Bars",
	"block.minecraft.weathered_copper_bulb": "Zastarela bakarna sijalica",
	...
	"block.minecraft.weathered_copper_door": "Zastarela bakarna vrata",
	"block.minecraft.weathered_copper_golem_statue": "Weathered Copper Golem Statue",
	"block.minecraft.weathered_copper_grate": "Zastarela bakarna rešetka",
	"block.minecraft.weathered_copper_lantern": "Weathered Copper Lantern",
	"block.minecraft.weathered_copper_trapdoor": "Zastarelo bakarno okno",
	...
	"block.minecraft.wildflowers": "Vetrovka",
	...
	"chat.disabled.invalid_signature": "Čat je imao nevažeću signaturu. Pokušajte ponovo da se povežete.",
	...
	"chat.disabled.out_of_order_chat": "Čet primljen van reda. Da li se vreme vašeg sistema promenilo?",
	...
	"chat.queue": "[+%s red(ova) preostao/lo]",
	...
	"chunk.toast.checkLog": "Pogledaj logove za više detalja",
	"chunk.toast.loadFailure": "Neuspešno učitavanje čankova u %s",
	"chunk.toast.lowDiskSpace": "Malo prostora na disku!",
	"chunk.toast.lowDiskSpace.description": "Možda neće moći da se sačuva svet.",
	"chunk.toast.saveFailure": "Neuspešno sačuvanje čankova u %s",
	...
	"command.forkLimit": "Dostignut najveći broj konteksta (%s)",
	...
	"commands.attribute.base_value.reset.success": "Osnovna vrednost za atribut %s za entitet %s resetuj te na podrazumevano %s",
	...
	"commands.datapack.create.already_exists": "Paket sa imenom '%s' već postoji",
	"commands.datapack.create.invalid_full_name": "Invalid new pack name '%s'",
	"commands.datapack.create.invalid_name": "Neispravni karakteri u novom imenu paketa '%s'",
	"commands.datapack.create.io_failure": "Ne može te kreirati paket sa imenom '%s', proverite logove",
	"commands.datapack.create.metadata_encode_failure": "Failed to encode metadata for pack with name '%s': %s",
	"commands.datapack.create.success": "Napravljen novi paket sa imenom '%s'",
	"commands.datapack.disable.failed": "Paket '%s' nije uključen!",
	"commands.datapack.disable.failed.feature": "Paket '%s' ne mogu da budu isključeni, zato sto su deo omogućene zastave!",
	...
	"commands.debug.function.noReturnRun": "Prikaz ne može biti korišćen sa return run",
	...
	"commands.debug.stopped": "Zaustavljeno profilisanje otkucaja posle %s sekund(e) i %s tik(ova) (%s tik(ova) po sekundi)",
	...
	"commands.drop.no_loot_table.block": "Blok %s nema tablu imovine",
	...
	"commands.execute.function.instantiationFailure": "Neuspešno instanciranje funkcije %s: %s",
	...
	"commands.fetchprofile.give_item": "Dati stvar",
	...
	"commands.function.instantiationFailure": "Neuspešno instanciranje funkcije %s: %s",
	"commands.function.result": "Funkcija %s vratila je %s",
	"commands.function.scheduled.multiple": "Pokrenute funkcije %s",
	"commands.function.scheduled.no_functions": "Nije moguće pronaći nijednu funkciju sa imenom %s",
	"commands.function.scheduled.single": "Pokrenuta funkcija %s",
	...
	"commands.kick.singleplayer.failed": "Nemoguće je izbaciti igrača u samostalnoj igri",
	...
	"commands.profile_fetch.give_item": "Dati stvar",
	...
	"commands.recipe.give.success.multiple": "Otključan(i) %s recepat/recepti za %s igrače",
	"commands.recipe.give.success.single": "Otključan(i) %s recepat/recepti za %s",
	"commands.recipe.take.failed": "Nema recepata koji se mogu zaboraviti",
	"commands.recipe.take.success.multiple": "Uzeo %s recept/recepata od %s igrača",
	"commands.recipe.take.success.single": "Uzeo %s recept/recepata od %s",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Isključi displej auto poboljšavanje za objektivu %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Uključi displej auto poboljšavanje za objektivu %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Izbrisan prikaz imena za %s entitete u %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Uklonjeno prikazno ime za %s u %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Promenjeno prikazno ime u %s za %s entiteta u %s",
	"commands.scoreboard.players.display.name.set.success.single": "Promenjeno prikazno ime u %s za %s u %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Izbrisan format za %s entiteta u %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Očišćen broj formata za %s u %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Promeni format broja za %s entitete u %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Promenjen broj formata od %s u %s",
	...
	"commands.setidletimeout.success.disabled": "Vremensko ograničenje za neaktivnost igrača je sada isključeno",
	"commands.setworldspawn.failure.not_overworld": "Mesto reinkarnacije može samo biti u nadzemlju",
	...
	"commands.test.clear.error.no_tests": "Neuspešna pretraga testova za brisanje",
	"commands.test.clear.success": "Obrisana/e %s struktura/e",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Kliknite za kopiranje u međuspremnik",
	"commands.test.create.success": "Napravljena test podešavanja za test %s",
	"commands.test.error.no_test_containing_pos": "Neuspešno pronalaženje test instance koja sadrži %s, %s, %s",
	"commands.test.error.no_test_instances": "Nije nađen ni jedan test primer",
	"commands.test.error.non_existant_test": "Test %s nije pronađen",
	"commands.test.error.structure_not_found": "Test strukture %s ne može biti pronađen",
	...
	"commands.test.error.too_large": "Veličina strukture mora biti manja od %s blokova duž svake ose",
	"commands.test.locate.done": "Pretraživanje završeno, nađena/o je %s struktura",
	"commands.test.locate.found": "Pronađene strukture kod: %s (na distanci od: %s)",
	"commands.test.locate.started": "Pretraživanje test struktura je započeto, ovo može potrajati...",
	"commands.test.no_tests": "Nema testova za započeti",
	"commands.test.relative_position": "Pozicija relativna %s: %s",
	"commands.test.reset.error.no_tests": "Neuspešna pretraga testova za resetovanje",
	"commands.test.reset.success": "Resetuj %s strukturu/e",
	"commands.test.run.no_tests": "Ni jedan test nije pronađen",
	"commands.test.run.running": "Započinjanje %s testa/ova...",
	"commands.test.summary": "Test igre je završen! %s test(ovi) su sproveden(i)",
	"commands.test.summary.all_required_passed": "Svi traženi testovi položeni :)",
	"commands.test.summary.failed": "%s traženi test(ovi) neuspešni :(",
	"commands.test.summary.optional_failed": "%s opcionalan/opcionalni test/testovi neuspešni/neuspešan",
	"commands.tick.query.percentiles": "Percentili: P50: %sms P95: %sms P99: %sms, uzorak: %s",
	...
	"commands.tick.rate.success": "Otkucavanje je namešteno na %s po sekundi",
	...
	"commands.tick.status.running": "Igra radi normalno",
	...
	"commands.transfer.error.no_players": "Morate specificirati barem jednog igrača da transferujete",
	"commands.transfer.success.multiple": "Transferovanje %s igrača do %s:%s",
	"commands.transfer.success.single": "Transferovanje %s do %s:%s",
	...
	"commands.version.build_time": "vreme_građenja = %s",
	"commands.version.data": "podatak/ci = %s",
	"commands.version.header": "Informacije verzije servera:",
	"commands.version.id": "id = %s",
	"commands.version.name": "ime = %s",
	"commands.version.pack.data": "podaci_paketa = %s",
	"commands.version.pack.resource": "resursi_paketa = %s",
	"commands.version.protocol": "protokol = %s (%s)",
	"commands.version.series": "serija = %s",
	"commands.version.stable.no": "stabilno = da",
	"commands.version.stable.yes": "stabilno = ne",
	"commands.waypoint.list.empty": "Nema putnih tačaka u %s",
	"commands.waypoint.list.success": "%s putna/e tačka/e u %s: %s",
	"commands.waypoint.modify.color": "Boja putne tačke je sad %s",
	"commands.waypoint.modify.color.reset": "Boja putne tačke je resetovana",
	...
	"connect.failed.transfer": "Povezanost neuspešna pri prenosu na server",
	...
	"connect.transferring": "Prenošenje na novi server...",
	...
	"dataPack.locator_bar.description": "Pokaži pravac drugih igrača u onlajn igri",
	"dataPack.locator_bar.name": "Lokator",
	"dataPack.minecart_improvements.description": "Poboljšano pokretanje vagona",
	"dataPack.minecart_improvements.name": "Poboljšanja vagona",
	"dataPack.redstone_experiments.description": "Eksperimentalne crveni kamen promene",
	...
	"dataPack.update_1_21.description": "Nove funkcije i sadržaj Minecraft 1.21",
	...
	"dataPack.winter_drop.description": "Novi sadržaji za zimsko ažuriranje",
	"dataPack.winter_drop.name": "Zimsko ažuriranje",
	...
	"death.attack.mace_smash": "%[1]s je bio smrvljen od %[2]s",
	"death.attack.mace_smash.item": "%[1]s je bio smrvljen od %[2]s koristeći %[3]s",
	...
	"debug.options.profile.default": "Običan profil",
	"debug.options.profile.performance": "Performance profile",
	"debug.options.search": "Pretražiti...",
	...
	"debug.version.header": "Informacije o verziji klijenta:",
	"debug.version.help": "F3 + V = Informacije o verziji klijenta",
	...
	"disconnect.packetError": "Greška mrežnog protokola",
	"disconnect.spam": "Izbačen zbog spama",
	"disconnect.timeout": "Vreme je isteklo",
	"disconnect.transfer": "Transferovano na drugi server",
	"disconnect.unknownHost": "Nepoznati server",
	"download.pack.failed": "%s od %s paket(a) nije uspešno preuzeto",
	...
	"effect.minecraft.infested": "Inficiran",
	...
	"enchantment.minecraft.density": "Gustina",
	...
	"enchantment.minecraft.sweeping_edge": "Ivica zamahivanja",
	...
	"enchantment.minecraft.wind_burst": "Prasak vetra",
	"entity.minecraft.acacia_boat": "Čamac od bagrema",
	"entity.minecraft.acacia_chest_boat": "Čamac od bagrema sa kovčegom",
	...
	"entity.minecraft.bamboo_chest_raft": "Splav od bambusa sa kovčegom",
	"entity.minecraft.bamboo_raft": "Splav od bambusa",
	"entity.minecraft.bat": "Slepi miš",
	"entity.minecraft.bee": "Pčela",
	"entity.minecraft.birch_boat": "Brezov čamac",
	"entity.minecraft.birch_chest_boat": "Brezov čamac sa kovčegom",
	"entity.minecraft.blaze": "Ognjeni",
	"entity.minecraft.block_display": "Prikaz bloka",
	"entity.minecraft.boat": "Čamac",
	"entity.minecraft.bogged": "Zaglibljen",
	"entity.minecraft.breeze": "Povetarac",
	"entity.minecraft.breeze_wind_charge": "Lopta vetra",
	...
	"entity.minecraft.cherry_boat": "Trešnjin čamac",
	"entity.minecraft.cherry_chest_boat": "Trešnjin čamac sa kovčegom",
	...
	"entity.minecraft.creaking": "Škripanje",
	"entity.minecraft.creaking_transient": "Škripanje",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Tamni hrastov čamac",
	"entity.minecraft.dark_oak_chest_boat": "Tamni hrastov čamac sa kovčegom",
	...
	"entity.minecraft.happy_ghast": "Srećan Ghast",
	...
	"entity.minecraft.jungle_boat": "Čamac od prašumskog drveta",
	"entity.minecraft.jungle_chest_boat": "Čamac od drveta džungle sa kovčegom",
	...
	"entity.minecraft.mangrove_boat": "Čamac od mangrova",
	"entity.minecraft.mangrove_chest_boat": "Čamac od mangrova sa kovčegom",
	"entity.minecraft.mannequin": "Mannequin",
	"entity.minecraft.mannequin.label": "Robot",
	...
	"entity.minecraft.oak_boat": "Hrastov čamac",
	"entity.minecraft.oak_chest_boat": "Hrastov čamac sa kovčegom",
	...
	"entity.minecraft.pale_oak_boat": "Čamac od blede hrastovine",
	"entity.minecraft.pale_oak_chest_boat": "Čamac od blede hrastovine sa kovčegom",
	...
	"entity.minecraft.splash_potion": "Rasprskujući napitak",
	"entity.minecraft.spruce_boat": "Čamac od smreke",
	"entity.minecraft.spruce_chest_boat": "Čamac od smreke sa kovčegom",
	...
	"entity.minecraft.wind_charge": "Vetrovita lopta",
	...
	"filled_map.trial_chambers": "Izazovna istraživačka mapa",
	...
	"flat_world_preset.minecraft.overworld": "Nadzemlje",
	...
	"gamerule.allowFireTicksAwayFromPlayer": "Otkucaji vatre daleko od igrača",
	...
	"gamerule.disablePlayerMovementCheck": "Isključi proveru kretanja igrača",
	...
	"gamerule.entitiesWithPassengersCanUsePortals": "Entiteti sa putnicima mogu koristiti portale",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Dozvoli entitetima sa putnicima da se teleportuju kroz Nether portale, End portale i End kapije.",
	...
	"gamerule.maxCommandForkCount": "Ograničenje konteksta komande",
	"gamerule.maxCommandForkCount.description": "Maksimalan broj konteksta koji mogu da se koriste u komandama kao 'execute as'.",
	"gamerule.maxEntityCramming": "Količina entiteta u jednom bloku",
	"gamerule.minecartMaxSpeed": "Maksimalna brzina vagona",
	"gamerule.minecartMaxSpeed.description": "Maksimalna uobičajena brzina vagona koji se pokreče na tlu.",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Kašnjenje Nether portala igrača u kreativnom modu",
	...
	"gamerule.playersNetherPortalDefaultDelay": "Kašnjenje Nether portala igrača van kreativnog moda",
	...
	"gamerule.projectilesCanBreakBlocks": "Projektili mogu srušiti blokove",
	"gamerule.projectilesCanBreakBlocks.description": "Kontroliše da li će udarni projektili uništiti blokove koje mogu uništiti.",
	"gamerule.pvp": "Omogućena borba",
	...
	"gamerule.spawnChunkRadius": "Opseg čankova stvaranja",
	"gamerule.spawnChunkRadius.description": "Broj čanka koji ostaje učitan oko pozicije stvaranja u nadzemlju.",
	...
	"gamerule.spawnRadius.description": "Kontroliše veličinu oblasti oko mesta stvaranja gde igrači mogu da se stvore.",
	...
	"gamerule.tntExplodes": "Dozvoli da se TNT aktivira i da eksplodira",
	...
	"generator.single_biome_caves": "Pećine",
	...
	"gui.abuseReport.name.comment_box_label": "Opišite zašto prijavljujete ovo ime:",
	"gui.abuseReport.name.reporting": "Prijavljujete \"%s\".",
	"gui.abuseReport.name.title": "Prijavi neprikladno Ime Igrača",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Seksulano neprikladno",
	...
	"gui.abuseReport.send.not_attested": "Molimo vas da pročitate tekst iznad i da štiklirate polje za potvrdu da bi ste mogli da pošaljete izveštaj",
	...
	"gui.banned.description.permanent": "Vaš nalog je trajno zabranjen, što znači da ne možete da igrate onlajn ili da se pridružite Realmovima.",
	...
	"gui.fileDropFailure.detail": "Odbijeni %s fajlovi",
	"gui.fileDropFailure.title": "Neuspešno dodavanje fajlova",
	...
	"gui.remove": "Remove",
	"gui.report_to_server": "Prijavi serveru",
	...
	"gui.togglable_slot": "Klikni da onemogućiš slot",
	"gui.up": "Gore",
	"gui.waitingForResponse.button.inactive": "Back (%ss)",
	"gui.waitingForResponse.title": "Čekanje za server",
	"gui.yes": "Da",
	...
	"item.minecraft.armadillo_scute": "Ploča oklopa armadila",
	"item.minecraft.armadillo_spawn_egg": "Jaje armadila",
	...
	"item.minecraft.black_bundle": "Crni džak",
	"item.minecraft.black_dye": "Crna boja",
	"item.minecraft.black_harness": "Crni pojas",
	...
	"item.minecraft.blue_bundle": "Plavi džak",
	"item.minecraft.blue_dye": "Plava boja",
	"item.minecraft.blue_egg": "Plavo jaje",
	"item.minecraft.blue_harness": "Plavi pojas",
	"item.minecraft.bogged_spawn_egg": "Jaje Zaglibljenog",
	"item.minecraft.bolt_armor_trim_smithing_template": "Kovački šablon",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Munja dekoracija oklopa",
	...
	"item.minecraft.breeze_rod": "Povetarac štap",
	"item.minecraft.breeze_spawn_egg": "Jaje Povetarca",
	...
	"item.minecraft.brown_bundle": "Braon džak",
	"item.minecraft.brown_dye": "Braon boja",
	"item.minecraft.brown_egg": "Braon jaje",
	"item.minecraft.brown_harness": "Braon pojas",
	"item.minecraft.brush": "Četkica",
	"item.minecraft.bucket": "Kofa",
	"item.minecraft.bundle": "Svežanj",
	"item.minecraft.bundle.empty": "Prazno",
	"item.minecraft.bundle.empty.description": "Može nositi mešoviti stek predmeta",
	...
	"item.minecraft.coast_armor_trim_smithing_template.new": "Obala dekoracija oklopa",
	...
	"item.minecraft.creaking_spawn_egg": "Jaje Škripanja",
	...
	"item.minecraft.cyan_bundle": "Tirkizni džak",
	"item.minecraft.cyan_dye": "Tirkizna boja",
	"item.minecraft.cyan_harness": "Tirkizan pojas",
	...
	"item.minecraft.dune_armor_trim_smithing_template.new": "Dina dekoracija oklopa",
	...
	"item.minecraft.eye_armor_trim_smithing_template.new": "Oko dekoracija za oklop",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Kovački šablon",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Tok dekoracija oklopa",
	"item.minecraft.flow_banner_pattern": "Šara banera",
	"item.minecraft.flow_banner_pattern.desc": "Protok",
	"item.minecraft.flow_banner_pattern.new": "Tok šara banera",
	"item.minecraft.flow_pottery_sherd": "Tok delić grnčarije",
	...
	"item.minecraft.globe_banner_pattern.new": "Globus šara banera",
	...
	"item.minecraft.gray_bundle": "Sivi džak",
	"item.minecraft.gray_dye": "Siva boja",
	"item.minecraft.gray_harness": "Sivi pojas",
	"item.minecraft.green_bundle": "Zeleni džak",
	"item.minecraft.green_dye": "Zelena boja",
	"item.minecraft.green_harness": "Zeleni pojas",
	"item.minecraft.guardian_spawn_egg": "Jaje čuvara",
	"item.minecraft.gunpowder": "Barut",
	"item.minecraft.guster_banner_pattern": "Šara banera",
	...
	"item.minecraft.happy_ghast_spawn_egg": "Srećni Ghast jaje",
	"item.minecraft.harness": "Pojas",
	...
	"item.minecraft.host_armor_trim_smithing_template.new": "Domaćin dekoracija oklopa",
	...
	"item.minecraft.light_blue_bundle": "Svetlo plavi džak",
	"item.minecraft.light_blue_dye": "Svetloplava boja",
	"item.minecraft.light_blue_harness": "Svetloplavi pojas",
	"item.minecraft.light_gray_bundle": "Svetlosiva sveća",
	"item.minecraft.light_gray_dye": "Svetlosiva boja",
	"item.minecraft.light_gray_harness": "Svetlosivi pojas",
	"item.minecraft.lime_bundle": "Svetlozeleni džak",
	"item.minecraft.lime_dye": "Svetlozelena boja",
	"item.minecraft.lime_harness": "Svetlozeleni pojas",
	...
	"item.minecraft.magenta_bundle": "Magenta džak",
	"item.minecraft.magenta_dye": "Magenta boja",
	"item.minecraft.magenta_harness": "Magenta pojas",
	...
	"item.minecraft.mojang_banner_pattern.new": "Stvar šara banera",
	...
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Creator (Muzička Kutija)",
	"item.minecraft.music_disc_far": "Muzička ploča",
	"item.minecraft.music_disc_far.desc": "C418 - far",
	"item.minecraft.music_disc_lava_chicken": "Muzički disk\n",
	...
	"item.minecraft.music_disc_tears": "Muzički disk",
	...
	"item.minecraft.netherite_upgrade_smithing_template.new": "Netherit poboljšanje",
	...
	"item.minecraft.ominous_bottle": "Zloslutna flaša",
	"item.minecraft.ominous_trial_key": "Zloslutni ključ izazova",
	"item.minecraft.orange_bundle": "Narandžasti džak",
	"item.minecraft.orange_dye": "Narandžasta boja",
	"item.minecraft.orange_harness": "Narandžasti pojas",
	"item.minecraft.painting": "Slika",
	"item.minecraft.pale_oak_boat": "Bledi hrastov čamac",
	"item.minecraft.pale_oak_chest_boat": "Bledi hrastov čamac sа kоvčegom",
	...
	"item.minecraft.piglin_banner_pattern.new": "Njuška šara banera",
	...
	"item.minecraft.pink_bundle": "Roze džak",
	"item.minecraft.pink_dye": "Roze boja",
	"item.minecraft.pink_harness": "Roze pojas",
	...
	"item.minecraft.purple_bundle": "Ljubičasti džak",
	"item.minecraft.purple_dye": "Ljubičasta boja",
	"item.minecraft.purple_harness": "Ljubičast pojas",
	...
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Staratelj dekoracija za oklop",
	...
	"item.minecraft.red_bundle": "Crveni džak",
	"item.minecraft.red_dye": "Crvena boja",
	"item.minecraft.red_harness": "Crveni pojas",
	"item.minecraft.redstone": "Redstone prah",
	"item.minecraft.resin_brick": "Cigla smole",
	"item.minecraft.resin_clump": "Grumen smole",
	"item.minecraft.rib_armor_trim_smithing_template": "Kovački šablon",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Rebro dekoracija za oklop",
	...
	"item.minecraft.scute": "Ploča oklopa",
	"item.minecraft.sentry_armor_trim_smithing_template": "Kovački šablon",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Stražar dekoracija za oklop",
	"item.minecraft.shaper_armor_trim_smithing_template": "Kovački šablon",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Oblikovatelj dekoracija za oklop",
	...
	"item.minecraft.silence_armor_trim_smithing_template.new": "Tišina dekoracija za oklop",
	...
	"item.minecraft.snout_armor_trim_smithing_template.new": "Njuška dekoracija za oklop",
	...
	"item.minecraft.spire_armor_trim_smithing_template.new": "Kula dekoracija za oklop",
	...
	"item.minecraft.tide_armor_trim_smithing_template.new": "Plima dekoracija za oklop",
	...
	"item.minecraft.trial_key": "Ključ izazova",
	...
	"item.minecraft.turtle_scute": "Ploča kornjačinog oklopa",
	"item.minecraft.turtle_spawn_egg": "Jaje kornjače",
	"item.minecraft.vex_armor_trim_smithing_template": "Kovački šablon",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Napast dekoracija za oklop",
	...
	"item.minecraft.ward_armor_trim_smithing_template.new": "Čuvar dekoracija za oklop",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Putokaz dekoracija za oklop",
	"item.minecraft.wheat": "Pšenica",
	"item.minecraft.wheat_seeds": "Seme pšenice",
	"item.minecraft.white_bundle": "Beli džak",
	"item.minecraft.white_dye": "Bela boja",
	"item.minecraft.white_harness": "Beli pojas",
	"item.minecraft.wild_armor_trim_smithing_template": "Kovački šablon",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Divlji dekoracija za oklop",
	...
	"item.minecraft.wolf_armor": "Oklop za vuka",
	...
	"item.minecraft.yellow_bundle": "Žuti džak",
	"item.minecraft.yellow_dye": "Žuta boja",
	"item.minecraft.yellow_harness": "Žuti pojas",
	...
	"item.modifiers.any": "Kad se opremi:",
	"item.modifiers.armor": "Kad se obuče:",
	"item.modifiers.body": "Kad se opremi:",
	"item.modifiers.chest": "Kada je na telu:",
	"item.modifiers.feet": "Kada je na stopalima:",
	"item.modifiers.hand": "Kad se drži:",
	...
	"item.modifiers.saddle": "Kad zajahan:",
	"item.nbt_tags": "NBT: %s tag(ovi)",
	"item.op_block_warning.line1": "Upozorenje:",
	"item.op_block_warning.line2": "Korišćenje ovog predmeta može dovesti do izvršena komande",
	"item.op_block_warning.line3": "Ne koristiti osim ako znaš pravi sadržaj!",
	"item.spawn_egg.peaceful": "Onemogućeno u miru",
	...
	"jigsaw_block.placement_priority": "Prioritet postavljanja:",
	...
	"jigsaw_block.selection_priority": "Prioritet izbora:",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine - Creator (Muzička Kutija)",
	...
	"known_server_link.announcements": "Saopštenja",
	"known_server_link.community": "Zajednica",
	"known_server_link.community_guidelines": "Smernice zajednice",
	"known_server_link.feedback": "Povratne informacije",
	"known_server_link.forums": "Forumi",
	"known_server_link.news": "Novosti",
	"known_server_link.report_bug": "Prijavi serversku grešku",
	...
	"loading.progress": "%s%%",
	"manageServer.add.title": "Dodati server",
	...
	"manageServer.resourcePack.disabled": "Onemogućen",
	"manageServer.resourcePack.enabled": "Omogućen",
	"manageServer.resourcePack.prompt": "Prompt",
	"mco.account.privacy.info": "Pročitaj više o Mojang-u i zakonima o privatnosti",
	"mco.account.privacy.info.button": "Pročitajte više o GDPR-u",
	...
	"mco.backup.entry.enabledPack": "Dozvoljen(i) paket(i)",
	...
	"mco.backup.narration": "Rezervna kopija od %s",
	...
	"mco.client.outdated.stable.version": "Verzija vašeg klijenta (%s) nije kompatibilna sa Realms.\n\nMolimo vas da koristite najnoviju verziju Minecraft-a.",
	...
	"mco.compatibility.downgrade": "Degradacija",
	"mco.compatibility.downgrade.description": "Ovaj svet je poslednji put igran na verziji %s; Vi ste na verziji %s. Degradacija sveta može dovesti do korupcije - ne možemo obećati da će se učitati ili raditi.\n\nRezervna kopija Vašeg sveta biće sačuvana u ,,World Backups\". Molimo vas da obnovite svoj svet ako je potrebno.",
	...
	"mco.compatibility.unverifiable.title": "Kompatibilnost nije proverljiva",
	"mco.compatibility.upgrade": "Nadograditi",
	"mco.compatibility.upgrade.description": "Ovaj svet je poslednji put igran na verziji %s; vi ste na verziji %s.\n\nRezervna kopija vašeg sveta će biti sačuvana u folderu ,,World Backups\".\n\nMolimo vas da vratite svoj svet ako je potrebno.",
	"mco.compatibility.upgrade.friend.description": "Ovaj svet je poslednji put igran na verziji %s; vi ste na verziji %s.\n\nRezervna kopija vašeg sveta će biti sačuvana u folderu ,,World Backups\".\n\nVlasnik Realm-a može vratiti svet ako je potrebno.",
	"mco.compatibility.upgrade.title": "Da li stvarno želite da poboljšate ovaj svet?",
	...
	"mco.configure.world.buttons.save": "Sačuvati",
	...
	"mco.configure.world.resourcepack.question": "Treba vam paketa resursa da bi ste igrali na ovom Realmu\n\nDa li želite da je preuzmete i da igrate?",
	...
	"mco.create.world.failed": "Neuspešna kreacija sveta!",
	...
	"mco.download.confirmation.oversized": "Svet koji će te instalirati je veći od %s\n\nNećete više moći dodati ovaj svet na svoj Realm",
	...
	"mco.errorMessage.initialize.failed": "Neuspešna inicijalizacija Realma",
	...
	"mco.notification.transferSubscription.buttonText": "Prenesi sada",
	...
	"mco.onlinePlayers": "Onlajn igrači",
	...
	"mco.snapshot.creating": "Pravljenje Snapshot Realma...",
	"mco.snapshot.description": "Uparen sa ,,%s\"",
	"mco.snapshot.friendsRealm.downgrade": "Treba da budete na verziji %s da bi ste igrali na ovom Realmu",
	"mco.snapshot.friendsRealm.upgrade": "%s mora da nadogradi njihov Realm pre nego što možete da igrate na ovoj verziji",
	"mco.snapshot.paired": "This Snapshot Realm is paired with \"%s\"",
	"mco.snapshot.parent.tooltip": "Koristi te najnoviju verziju Minecraft-a da bi ste igrali na ovom Realm-u",
	...
	"mco.upload.failed.too_big.title": "Svet previše velik",
	...
	"menu.feedback.title": "Povratne informacije",
	"menu.game": "Meni igre",
	...
	"menu.server_links": "Serverski linkovi...",
	"menu.server_links.title": "Serverski linkovi",
	...
	"multiplayer.disconnect.transfers_disabled": "Server ne dopušta transverovanje",
	...
	"optimizeWorld.confirm.proceed": "Napravi rezervnu kopiju i optimiziraj",
	...
	"optimizeWorld.stage.finished.chunks": "Završavanje poboljšavanja čankova...",
	"optimizeWorld.stage.finished.entities": "Završavanje poboljšavanja entiteta...",
	"optimizeWorld.stage.finished.poi": "Finishing up upgrading points of interest...",
	"optimizeWorld.stage.upgrading": "Nadograđivanje svih čankova...",
	"optimizeWorld.stage.upgrading.chunks": "Nadograđivanje svih čankova...",
	"optimizeWorld.stage.upgrading.entities": "Nadograđivanje svih entiteta...",
	"optimizeWorld.stage.upgrading.poi": "Nadograđivanje svih tačaka interesovanja...",
	...
	"options.accessibility.high_contrast.error.tooltip": "Visok kontrast paketa resursa nedostupan.",
	...
	"options.accessibility.menu_background_blurriness": "Mutnost pozadine menija",
	...
	"options.chat.delay": "Odlaganje četa: %s sekunda/i",
	...
	"options.font": "Podešavanja fonta...",
	"options.font.title": "Podešavanja fonta",
	...
	"options.inactivityFpsLimit": "Smanji FPS kada",
	"options.inactivityFpsLimit.afk": "Kad sam neaktivan",
	...
	"options.music_frequency.default": "Obično",
	...
	"painting.minecraft.cavebird.title": "Pećinska ptica",
	"painting.minecraft.changing.author": "Kristoffer Zetterstrand",
	"painting.minecraft.changing.title": "Promena",
	...
	"painting.minecraft.finding.title": "Tražiti",
	...
	"painting.minecraft.humble.title": "Skroman",
	...
	"painting.minecraft.lowmist.title": "Niska magla",
	...
	"painting.minecraft.orb.title": "Kugla",
	"painting.minecraft.owlemons.author": "Kristoffer Zetterstrand",
	"painting.minecraft.owlemons.title": "Sova limuni",
	...
	"painting.minecraft.pond.title": "Bara",
	...
	"painting.minecraft.tides.title": "Plime i oseke",
	"painting.minecraft.unpacked.author": "Sarah Boeving",
	"painting.minecraft.unpacked.title": "Neraspakovano",
	...
	"recipe.toast.title": "Novi recept(i) otključani!",
	"record.nowPlaying": "Sada svira: %s",
	"recover_world.bug_tracker": "Prijavite grešku",
	"recover_world.button": "Pokušaj oporavak",
	"recover_world.done.failed": "Neuspešan oporavak iz prošlog stanja.",
	"recover_world.done.success": "Oporavak je uspešan!",
	"recover_world.done.title": "Oporavak gotov",
	...
	"recover_world.restore": "Pokušaj povratak",
	"recover_world.restoring": "Pokušavanje povratka sveta...",
	"recover_world.state_entry": "Stanje od %s: ",
	"recover_world.state_entry.unknown": "nepoznat",
	"recover_world.title": "Neuspešno učitavanje sveta",
	"recover_world.warning": "Neuspešno učitavanje sadržaja sveta",
	...
	"resourcePack.runtime_failure": "Greška u paketu resursa detektovana",
	...
	"selectWorld.allowCommands.new": "Dozvoli komande",
	...
	"selectWorld.incompatible.description": "Ovaj svet ne može da se otvori na ovoj verziji.\nPoslednji put je bio igran na verziji %s.",
	...
	"selectWorld.resource_load": "Spremanje resursa...",
	...
	"selectWorld.warning.lowDiskSpace.title": "Upozorenje! Malo prostora na disku!",
	...
	"slot.only_single_allowed": "Samo jedan slot dozvoljen, ima '%s'",
	"slot.unknown": "Nepoznati položaj '%s'",
	"snbt.parser.empty_key": "Ključ ne može biti prazan",
	"snbt.parser.expected_binary_numeral": "Očekivan je binarni broj",
	"snbt.parser.expected_decimal_numeral": "Očekivan je decimalni broj",
	"snbt.parser.expected_float_type": "Očekivan je broj sa pokretnim zarezom",
	"snbt.parser.expected_hex_escape": "Expected a character literal of length %s",
	"snbt.parser.expected_hex_numeral": "Očekivan je heksadecimalni broj",
	"snbt.parser.expected_integer_type": "Očekivan je ceo broj",
	"snbt.parser.expected_non_negative_number": "Očekivan je nenegativan broj",
	...
	"snbt.parser.infinity_not_allowed": "Neograničeni brojevi nisu dozvoljeni",
	...
	"snbt.parser.leading_zero_not_allowed": "Decimalni brojevi ne mogu početi sa 0",
	"snbt.parser.no_such_operation": "Ne postoje operacije kao: %s",
	"snbt.parser.number_parse_failure": "Neuspešno analiziranje broja: %s",
	...
	"stat.minecraft.happy_ghast_one_cm": "Distanca od Srećnog Ghast",
	...
	"subtitles.block.candle.extinguish": "Sveća se izgasi",
	...
	"subtitles.block.copper_trapdoor.close": "Okno se zatvara",
	"subtitles.block.copper_trapdoor.open": "Okno se otvara",
	"subtitles.block.crafter.craft": "Proizvođač proizvodi",
	"subtitles.block.crafter.fail": "Proizvođač neuspešno proizvodi",
	"subtitles.block.creaking_heart.hurt": "Srce Škripanja gunđa",
	"subtitles.block.creaking_heart.idle": "Jeziv zvuk",
	"subtitles.block.creaking_heart.spawn": "Srce Škripanja",
	"subtitles.block.deadbush.idle": "Osušeni zvukovi",
	...
	"subtitles.block.dried_ghast.ambient": "Osušeni Ghast teško diše",
	"subtitles.block.dried_ghast.ambient_water": "Osušeni ghast se rehidrira",
	"subtitles.block.dried_ghast.place_in_water": "Osušeni Ghast se potapa",
	"subtitles.block.dried_ghast.transition": "Osušeni Ghast se oseća bolje",
	"subtitles.block.dry_grass.ambient": "Vetroviti zvukovi",
	...
	"subtitles.block.eyeblossom.close": "Cvet očiju se zatvara",
	"subtitles.block.eyeblossom.idle": "Cvet očiju šapuće",
	"subtitles.block.eyeblossom.open": "Cvet očiju se otvara",
	...
	"subtitles.block.firefly_bush.idle": "Svici zuje",
	...
	"subtitles.block.generic.fall": "Nešto je palo sa bloka",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Znak se klati",
	...
	"subtitles.block.sand.idle": "Peščani zvukovi",
	"subtitles.block.sand.wind": "Vetroviti zvukovi",
	...
	"subtitles.block.trapdoor.close": "Okno se zatvara",
	"subtitles.block.trapdoor.open": "Okno se otvara",
	"subtitles.block.trapdoor.toggle": "Okno škripi",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Zloslutan predmet se priprema",
	"subtitles.block.trial_spawner.ambient": "Izazovni stvarač pucketa",
	"subtitles.block.trial_spawner.ambient_charged": "Zloslutno pucketanje",
	"subtitles.block.trial_spawner.ambient_ominous": "Zloslutno pucketanje",
	...
	"subtitles.block.trial_spawner.eject_item": "Izazovni stvarač izbacuje predmet",
	...
	"subtitles.block.trial_spawner.spawn_mob": "Izazovni stvarač stvara moba",
	...
	"subtitles.block.vault.ambient": "Sef škripi",
	"subtitles.block.vault.close_shutter": "Sef se zatvara",
	"subtitles.block.vault.deactivate": "Sef se gasi",
	"subtitles.block.vault.eject_item": "Sef izbacuje predmet",
	"subtitles.block.vault.insert_item": "Sef se otključava",
	"subtitles.block.vault.insert_item_fail": "Sef odbija predmet",
	"subtitles.block.vault.open_shutter": "Sef se otvara",
	"subtitles.block.vault.reject_rewarded_player": "Sef odbija igrača",
	"subtitles.block.water.ambient": "Voda teče",
	"subtitles.block.wet_sponge.dries": "Sunđer se suši",
	...
	"subtitles.entity.armadillo.ambient": "Armadilo grokće",
	"subtitles.entity.armadillo.brush": "Scute is brushed off",
	"subtitles.entity.armadillo.death": "Armadilo umire",
	"subtitles.entity.armadillo.eat": "Armadilo jede",
	"subtitles.entity.armadillo.hurt": "Armadilo je povređen",
	"subtitles.entity.armadillo.hurt_reduced": "Armadilo se brani",
	"subtitles.entity.armadillo.land": "Armadillo lands",
	"subtitles.entity.armadillo.peek": "Armadilo gviri",
	"subtitles.entity.armadillo.roll": "Armadilo se urola",
	"subtitles.entity.armadillo.scute_drop": "Armadillo sheds scute",
	"subtitles.entity.armadillo.unroll_finish": "Armadillo unrolls",
	"subtitles.entity.armadillo.unroll_start": "Armadilo viri",
	...
	"subtitles.entity.breeze.death": "Povetarac umire",
	"subtitles.entity.breeze.deflect": "Breeze deflects",
	"subtitles.entity.breeze.hurt": "Povetarac je povređen",
	"subtitles.entity.breeze.idle_air": "Povetarac leti",
	"subtitles.entity.breeze.idle_ground": "Breeze whirs",
	"subtitles.entity.breeze.inhale": "Povetarac uzdiše",
	"subtitles.entity.breeze.jump": "Povetarac skače",
	"subtitles.entity.breeze.land": "Povetarac sleće",
	"subtitles.entity.breeze.shoot": "Povetarac puca",
	"subtitles.entity.breeze.slide": "Povetarac kliza",
	"subtitles.entity.breeze.whirl": "Povetarac se kovitla",
	...
	"subtitles.entity.copper_golem_oxidized.hurt": "Srce bakarnog golema",
	...
	"subtitles.entity.creaking.activate": "Škripanje gleda",
	"subtitles.entity.creaking.ambient": "Škripanje škripi",
	"subtitles.entity.creaking.attack": "Škripanje napada",
	"subtitles.entity.creaking.deactivate": "Škripanje je smireno",
	"subtitles.entity.creaking.death": "Škripanje se izmrvilo",
	"subtitles.entity.creaking.freeze": "Škripanje staje",
	"subtitles.entity.creaking.spawn": "Creaking manifests",
	"subtitles.entity.creaking.sway": "Škripanje je udareno",
	"subtitles.entity.creaking.twitch": "Škripanje se trza",
	"subtitles.entity.creaking.unfreeze": "Škripanje se pomera",
	...
	"subtitles.entity.ghastling.ambient": "Ghastling guguta",
	"subtitles.entity.ghastling.death": "Ghastling umire",
	"subtitles.entity.ghastling.hurt": "Ghastling je povređen",
	"subtitles.entity.ghastling.spawn": "Ghastling se pojavljuje",
	...
	"subtitles.entity.happy_ghast.ambient": "Srećni Ghast pevuši",
	"subtitles.entity.happy_ghast.death": "Srećni Ghast umire",
	"subtitles.entity.happy_ghast.equip": "Harness equips",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Srećni Ghast je spreman",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Srećan Ghast staje",
	"subtitles.entity.happy_ghast.hurt": "Srećan Ghast je povređen",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Kostur konj skače",
	...
	"subtitles.item.bundle.insert_fail": "Pun džak",
	...
	"subtitles.item.elytra.flying": "Кrilа huјu",
	...
	"subtitles.item.ominous_bottle.dispose": "Flaša je razbijena",
	...
	"subtitles.item.wolf_armor.crack": "Pasji oklop puca",
	"subtitles.item.wolf_armor.damage": "Pasji oklop je oštećen",
	"subtitles.item.wolf_armor.repair": "Pasji oklop je popravljen",
	...
	"telemetry.event.optional.disabled": "%s (Opcionalno) - Onemogućeno",
	...
	"telemetry_info.opt_in.description": "Saglasan/saglasna sam sа slanjem opcionalnih telemetrijskih podataka",
	...
	"test.error.entity_property": "Entitet %s je pao test: %s",
	"test.error.entity_property_details": "Entitet %s je pao test: %s, očekivano: %s, bio: %s",
	...
	"test.error.expected_entity": "Očekivano %s",
	"test.error.expected_entity_around": "Očekivano %s da postoji oko %s, %s, %s",
	"test.error.expected_entity_count": "Očekivani %s entiteti vrste %s, nađeni %s",
	"test.error.expected_entity_data": "Očekivani podaci entiteta da budu: %s, bili su %s",
	"test.error.expected_entity_data_predicate": "Neusklađenost podataka entiteta za %s",
	"test.error.expected_entity_effect": "Očekivano %s da ima efekat %s %s",
	"test.error.expected_entity_having": "Inventar entiteta treba da ima %s",
	"test.error.expected_entity_holding": "Entitet treba da drži %s",
	"test.error.expected_entity_in_test": "Očekivano %s da postoji u testu",
	...
	"test.error.expected_item": "Očekivan predmet tipa %s",
	"test.error.expected_items_count": "Očekivani %s predmeti tipa %s, nađeni %s",
	"test.error.fail": "Fail conditions met",
	"test.error.invalid_block_type": "Neočekivan tip bloka je nađen: %s",
	"test.error.missing_block_entity": "Nedostaje blok entitet",
	"test.error.not_a_block_item": "Given block is not a block item",
	"test.error.position": "%s kod %s, %s, %s (relativno: %s, %s, %s) na otkucaj %s",
	...
	"test.error.set_biome": "Neuspešno postavljanje bioma za test",
	"test.error.spawn_failure": "Neuspešno stvaranje entiteta %s",
	...
	"test.error.tick": "%s na otkucaj %s",
	...
	"test.error.too_many_entities": "Očekivan samo jedan %s da postoji oko %s,%s,%s ali nađen %s",
	"test.error.unexpected_block": "Nije očekivan blok da bude %s",
	"test.error.unexpected_entity": "Nije očekivano %s da postoji",
	"test.error.unexpected_item": "Nije očekivan tip stavke %s",
	"test.error.unknown": "Nepoznati unutrašnja greška: %s",
	"test.error.value_not_equal": "Očekivano %s da bude %s bilo je %s",
	"test.error.value_not_in_between": "Expected %s to be in between %s and %s: was %s",
	"test.error.wrong_block_entity": "Pogrešan tip blok entiteta tip: %s",
	...
	"test_block.mode.accept": "Prihvati",
	...
	"test_block.mode_info.fail": "Neuspešan mod - Padni test",
	...
	"test_instance.action.save": "Sačuvaj strukture",
	"test_instance.description.batch": "Gomila: %s",
	"test_instance.description.failed": "Neuspešno: %s",
	"test_instance.description.function": "Funkcija: %s",
	"test_instance.description.invalid_id": "Invalid test ID",
	"test_instance.description.no_test": "Nema takvog testa",
	...
	"test_instance_block.size": "Testiraj veličinu strukture",
	"test_instance_block.starting": "Test počinje %s",
	...
	"trim_material.minecraft.resin": "Materijal od smole",
	"trim_pattern.minecraft.bolt": "Munja Dekoracija za Oklop",
	...
	"trim_pattern.minecraft.flow": "Tok Dekoracija za Oklop",
