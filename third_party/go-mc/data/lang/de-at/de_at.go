// Code generated by tools/gen_lang.go from 26.1/de_at.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Barrierefreiheitseinstöllungen...",
	"accessibility.onboarding.accessibility.button.narration": "Barrierefreiheitseinstellungen",
	"accessibility.onboarding.screen.narrator": "Druck de Eingobetaste um de Sprochausgob zu aktivieren",
	...
	"advMode.notEnabled.spawner": "Spawna san ned aktiviat",
	"advMode.previousOutput": "Letzte Ausgob",
	"advMode.setCommand": "Befehl eigebn",
	"advMode.setCommand.disabled": "Befehl gsetzt: %s, Befehlsblöcke san oba weitahin deaktiviert",
	...
	"advancements.adventure.avoid_vibration.description": "Schleich in da Nähe von an Sculk-Sensor oda an Wärta um ned erwischt zu wean",
	"advancements.adventure.avoid_vibration.title": "Sneak 100",
	"advancements.adventure.blowback.description": "Bring a Böe mit ana obgwehrtn Böen-Windkugel um",
	"advancements.adventure.blowback.title": "Gegnwind",
	"advancements.adventure.brush_armadillo.description": "Benutz an Pinsl, um a Hornschüd vom Panzer von an Gürtltier zum kriagn",
	"advancements.adventure.brush_armadillo.title": "Is des ned liab?",
	...
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Bau an vaziertn Kruag aus vier Töpfascherbn",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.title": "Vorsichtig Restauriat",
	"advancements.adventure.crafters_crafting_crafters.description": "Sei in da nähe von am Werka, wonn dea an Werka heastöht",
	"advancements.adventure.crafters_crafting_crafters.title": "Weaka weakln Weaka",
	...
	"advancements.adventure.heart_transplanter.description": "Setz a Knoazheaz in de richtign Ausrichtung zwischen zwa Blosseichnstämme",
	"advancements.adventure.heart_transplanter.title": "Heazvapflonza",
	"advancements.adventure.hero_of_the_village.description": "Verteidig a Dorf erfolgreich vor an Überfoi",
	"advancements.adventure.hero_of_the_village.title": "Höd vom Doaf",
	"advancements.adventure.honey_block_slide.description": "Spring auf an Honigblock, um dein Sturz obzufongen",
	...
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Moch an Vieh in da Nähe von an Sculk-Katalysatoa hin",
	"advancements.adventure.kill_mob_near_sculk_catalyst.title": "Es vabreitet si",
	"advancements.adventure.lighten_up.description": "Krotz mit ana Oxt on ana Kupfaleichtn, damit se hölla weat",
	"advancements.adventure.lighten_up.title": "Aufhön",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Moch an Schritt in a Prüfungskamma",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Prüfungs Ausgob",
	"advancements.adventure.ol_betsy.description": "Feia a Oambrust ob",
	"advancements.adventure.ol_betsy.title": "De oide Betsy",
	"advancements.adventure.overoverkill.description": "Moch 50 Herzn Schodn mit an Schlägel schlog",
	"advancements.adventure.overoverkill.title": "Is scho hin musst nit noamoll draufhaun",
	"advancements.adventure.play_jukebox_in_meadows.description": "Beleb die Alm mitn Klong da Musi aus an Plottnspiela",
	"advancements.adventure.play_jukebox_in_meadows.title": "Klong von da Musik",
	...
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Die Kroft vo Biacha",
	"advancements.adventure.revaulting.description": "Öffne an unheilvolln Tresor imt am unheilvolln Prüfungschlussl",
	"advancements.adventure.revaulting.title": "Ponzaknocka",
	...
	"advancements.adventure.spear_many_mobs.description": "Triff fünf Mobs mit an oanzigen Charge-Ongriff mitm Speer",
	"advancements.adventure.spear_many_mobs.title": "Kreaturn-Akupunktur",
	...
	"advancements.adventure.under_lock_and_key.description": "Entsperr an Tresor mit am Prüfungsschlüssl",
	"advancements.adventure.under_lock_and_key.title": "Hinta Schloss und Riegl",
	"advancements.adventure.use_lodestone.description": "Leitstoa-Kompass verwendn",
	"advancements.adventure.use_lodestone.title": "Woaßt du, wo de Leitstoana stehn?",
	...
	"advancements.adventure.who_needs_rockets.description": "Benutz a Windkugl, um di 8 Blöcke in de höhe zum schleidan",
	"advancements.adventure.who_needs_rockets.title": "Wea braucht schon Raketen?",
	...
	"advancements.husbandry.place_dried_ghast_in_water.description": "Platziea an vatrocknetn Ghast in Wossa",
	"advancements.husbandry.place_dried_ghast_in_water.title": "Imma vü trinkn!",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Entfean Woifsrüstung von am Woif mit ana Schea",
	"advancements.husbandry.remove_wolf_armor.title": "Schnipp-schnapp!",
	"advancements.husbandry.repair_wolf_armor.description": "Reparier a beschädigte Woifsrüstung mit Gürtltierhornschüdn komplett",
	"advancements.husbandry.repair_wolf_armor.title": "So guad wie neich",
	...
	"advancements.husbandry.whole_pack.description": "Zahm olle Woifsoatn",
	"advancements.husbandry.whole_pack.title": "Olle san do",
	...
	"advancements.nether.use_lodestone.title": "Woaßt du, wo de Leitstoana stehn?",
	...
	"argument.entity.selector.nearestEntity": "Naxtes Objekt",
	...
	"argument.hexcolor.invalid": "Ungültiga Hex Foabncode '%s'",
	...
	"argument.message.too_long": "Chat Nochricht woa zlong (%s > hechstns %s Zeichn)",
	"argument.nbt.array.invalid": "Ungültiga Array-Typ ‚%s‘",
	"argument.nbt.array.mixed": "%s konn ned in %s eigfügt werdn",
	"argument.nbt.expected.compound": "Vabunddatn erwoat",
	...
	"argument.resource_or_id.failed_to_parse": "Struktur hod ned analysiat wean kenna: %s",
	"argument.resource_or_id.invalid": "Ungültige ID oda Etikett",
	"argument.resource_or_id.no_such_element": "Des Element '%s' konn im Register '%s' ned gfundn werden",
	"argument.resource_selector.not_found": "Kane Übaeinstimmungen fia Selektor '%s' von Typ '%s'",
	...
	"argument.style.invalid": "Ungültige JSON: %s",
	...
	"argument.waypoint.invalid": "De ausgwöhte Entität is ka Wegpunkt",
	...
	"arguments.item.component.expected": "Gegnstondskomponete eawoatet",
	"arguments.item.component.malformed": "Fehlahofte '%s'-Komponente: '%s'",
	"arguments.item.component.repeated": "Gegnstondskompontente '%s' wuad widaholt, es darf oba nua a Wert ongebn weadn",
	"arguments.item.component.unknown": "Unbekonnta Gegnstondskomponent '%s'",
	"arguments.item.malformed": "Fehlahofta Gegnstond: '%s'",
	"arguments.item.overstacked": "Maximale Stoplgreß von %s is %s",
	"arguments.item.predicate.malformed": "Fehlahofts '%s'-Prädikat: '%s'",
	"arguments.item.predicate.unknown": "Unbekonnts Gegnstondsprädikat: '%s'",
	...
	"arguments.operation.div0": "Konn net durch Null dividieren",
	...
	"attribute.name.attack_damage": "Ongriffsschodn",
	"attribute.name.attack_knockback": "Ongriffsrückstoß",
	"attribute.name.attack_speed": "Ongriffsgschwindigkeit",
	"attribute.name.below_name_distance": "Punktetafelabstand",
	"attribute.name.block_break_speed": "Blockobbautempo",
	"attribute.name.block_interaction_range": "Block Intaaktionsreichweite",
	"attribute.name.bounciness": "Federung",
	"attribute.name.burning_time": "Brennzeit",
	"attribute.name.camera_distance": "Kameraentfernung",
	"attribute.name.entity_interaction_range": "Objekt Intaaktionsreichweite",
	"attribute.name.explosion_knockback_resistance": "Explosionsstondfestigkeit",
	"attribute.name.fall_damage_multiplier": "Foischodnmultiplikatoa",
	"attribute.name.flying_speed": "Fluggschwindigkeit",
	"attribute.name.follow_range": "Kreatuan Foigedistanz",
	...
	"attribute.name.generic.block_interaction_range": "Block-Erkennungsradius",
	"attribute.name.generic.burning_time": "Brondzeit",
	"attribute.name.generic.entity_interaction_range": "Objekt-Erkennungsradius",
	"attribute.name.generic.explosion_knockback_resistance": "Explosionsstondfestigkeit",
	"attribute.name.generic.fall_damage_multiplier": "Follschodn Vervüfacher",
	"attribute.name.generic.flying_speed": "Fluggschwindigkeit",
	"attribute.name.generic.follow_range": "Kreaturn-Folgedistanz",
	"attribute.name.generic.gravity": "Schweakroft",
	...
	"attribute.name.generic.oxygen_bonus": "Sauastoffbonus",
	"attribute.name.generic.safe_fall_distance": "Sichare-Follhöhe",
	"attribute.name.generic.scale": "Größe",
	"attribute.name.generic.step_height": "Schritthöhe",
	"attribute.name.generic.water_movement_efficiency": "Wossa‐Bewegungseffizienz",
	"attribute.name.gravity": "Schweakroft",
	"attribute.name.horse.jump_strength": "Roßsprungstärke",
	"attribute.name.jump_strength": "Sprungstärkn",
	"attribute.name.knockback_resistance": "Stondfestigkeit",
	"attribute.name.luck": "Glück",
	"attribute.name.max_absorption": "Maximale Absorption",
	"attribute.name.max_health": "Maximale Gsundheit",
	"attribute.name.mining_efficiency": "Obbaueffizienz",
	...
	"attribute.name.player.block_break_speed": "Blockobbautempo",
	"attribute.name.player.block_interaction_range": "Block-Erkennungsradius",
	"attribute.name.player.entity_interaction_range": "Objekt-Erkennungsradius",
	"attribute.name.player.mining_efficiency": "Obbaueffizienz",
	"attribute.name.player.sneaking_speed": "Schleichgeschwindigkeit",
	"attribute.name.player.submerged_mining_speed": "Unterwosser‐Obbaugschwindigkeit",
	"attribute.name.player.sweeping_damage_ratio": "Schwungschodensverhötnis",
	"attribute.name.safe_fall_distance": "Sichare Foiihöhe",
	"attribute.name.scale": "Greß",
	"attribute.name.sneaking_speed": "Schleichgschwindigkeit",
	"attribute.name.spawn_reinforcements": "Zombievastärkungen",
	"attribute.name.step_height": "Schritthöhe",
	"attribute.name.submerged_mining_speed": "Untawossa Obbaugschwindigkeit",
	"attribute.name.sweeping_damage_ratio": "Schwungschodensverhötnis",
	"attribute.name.tempt_range": "Kreaturen‐Onlockdistanz",
	"attribute.name.water_movement_efficiency": "Wossabewegungseffizienz",
	"attribute.name.waypoint_receive_range": "Wegpunkt Empfongsreichweite",
	...
	"biome.minecraft.pale_garden": "Fahler Garten",
	...
	"block.minecraft.acacia_shelf": "Akazien Regal",
	...
	"block.minecraft.bamboo_shelf": "Bambus Regal",
	...
	"block.minecraft.banner.flow.black": "Schwoaza Fluss",
	"block.minecraft.banner.flow.blue": "Blaua Fluss",
	"block.minecraft.banner.flow.brown": "Brauna Fluss",
	"block.minecraft.banner.flow.cyan": "Türkisa Fluss",
	"block.minecraft.banner.flow.gray": "Graua Fluss",
	"block.minecraft.banner.flow.green": "Greana Fluss",
	"block.minecraft.banner.flow.light_blue": "Höblaua Fluss",
	"block.minecraft.banner.flow.light_gray": "Högraua Fluss",
	"block.minecraft.banner.flow.lime": "Högreana Fluss",
	"block.minecraft.banner.flow.magenta": "Magenta Fluss",
	"block.minecraft.banner.flow.orange": "Oranga Fluss",
	"block.minecraft.banner.flow.pink": "Pinka Fluss",
	"block.minecraft.banner.flow.purple": "Violetta Fluss",
	"block.minecraft.banner.flow.red": "Rota Fluss",
	"block.minecraft.banner.flow.white": "Weißa Fluss",
	"block.minecraft.banner.flow.yellow": "Göba Fluss",
	...
	"block.minecraft.banner.guster.black": "Schoaza Windstoßa",
	"block.minecraft.banner.guster.blue": "Blaua Windstoßa",
	"block.minecraft.banner.guster.brown": "Brauna Windstoßa",
	"block.minecraft.banner.guster.cyan": "Türkisa Windstoßa",
	"block.minecraft.banner.guster.gray": "Graua Windstoßa",
	"block.minecraft.banner.guster.green": "Greana Windstoßa",
	"block.minecraft.banner.guster.light_blue": "Höblaua Windstoßa",
	"block.minecraft.banner.guster.light_gray": "Högraua Windstoßa",
	"block.minecraft.banner.guster.lime": "Högreana Windstoßa",
	"block.minecraft.banner.guster.magenta": "Mangenta Windstoßa",
	"block.minecraft.banner.guster.orange": "Oranga Windstoßa",
	"block.minecraft.banner.guster.pink": "Pinka Windstoßa",
	"block.minecraft.banner.guster.purple": "Violetta Windstoßa",
	"block.minecraft.banner.guster.red": "Rota Windstoßa",
	"block.minecraft.banner.guster.white": "Weißa Windstoßa",
	"block.minecraft.banner.guster.yellow": "Göba Windstoßa",
	...
	"block.minecraft.birch_shelf": "Biakn Regal",
	...
	"block.minecraft.bush": "Buschn",
	"block.minecraft.cactus": "Kaktus",
	"block.minecraft.cactus_flower": "Kaktusblütn",
	...
	"block.minecraft.cherry_shelf": "Kiaschn Regal",
	...
	"block.minecraft.chiseled_resin_bricks": "Gmeißelte Hoazziagl",
	...
	"block.minecraft.closed_eyeblossom": "Gschlossene Augnbluam",
	...
	"block.minecraft.creaking_heart": "Knarrendes Herz",
	...
	"block.minecraft.crimson_shelf": "Karmesin Regal",
	...
	"block.minecraft.dark_oak_shelf": "Schwoazeichn Regal",
	...
	"block.minecraft.decorated_pot": "Vazierta Kruag",
	...
	"block.minecraft.dried_ghast": "Vatrockneta Ghast",
	...
	"block.minecraft.exposed_copper_bars": "Oglaufnes Kupfagitta",
	"block.minecraft.exposed_copper_bulb": "Ausgsetzte Kupfalompn",
	"block.minecraft.exposed_copper_chain": "Oglaufne Kupfakettn",
	"block.minecraft.exposed_copper_chest": "Ausgsetzte Kupfakistn",
	"block.minecraft.exposed_copper_door": "Ausgsetzte Kupfatir",
	"block.minecraft.exposed_copper_golem_statue": "Ausgsetzte Kupfagolem Statue",
	"block.minecraft.exposed_copper_grate": "Ausgsetzta Kupfarost",
	"block.minecraft.exposed_copper_lantern": "Oglaufne Kupfalatern",
	...
	"block.minecraft.exposed_lightning_rod": "Ausgesetzta Blitzobleita",
	...
	"block.minecraft.golden_dandelion": "Goidana Löwnzohn",
	...
	"block.minecraft.heavy_core": "Schwara Kern",
	...
	"block.minecraft.jungle_shelf": "Tropnhoiz Regal",
	...
	"block.minecraft.leaf_litter": "Lab",
	...
	"block.minecraft.mangrove_shelf": "Mangrovn Regal",
	...
	"block.minecraft.oak_shelf": "Eichn Regal",
	...
	"block.minecraft.open_eyeblossom": "Offene Augnbluam",
	...
	"block.minecraft.oxidized_copper_bars": "Oxidiats Kupfagitta",
	...
	"block.minecraft.oxidized_copper_golem_statue": "Oxidiate Kupfagolem Statue",
	"block.minecraft.oxidized_copper_grate": "Varrosteta Kupfarost",
	"block.minecraft.oxidized_copper_lantern": "Oxidiate Kupfalatern",
	...
	"block.minecraft.oxidized_lightning_rod": "Oxidiata Blitzobleita",
	...
	"block.minecraft.pale_moss_block": "Blasser Moosblock",
	"block.minecraft.pale_moss_carpet": "Blasser Moosteppich",
	"block.minecraft.pale_oak_button": "Blasser Eichenknopf",
	"block.minecraft.pale_oak_door": "Blasse Eichentür",
	"block.minecraft.pale_oak_fence": "Blasser Eichenzaun",
	"block.minecraft.pale_oak_fence_gate": "Blasses Eichenzauntor",
	"block.minecraft.pale_oak_hanging_sign": "Helles Eichenhängeschild",
	"block.minecraft.pale_oak_leaves": "Blasse Eichenblätter",
	"block.minecraft.pale_oak_log": "Blasser Eichenstamm",
	"block.minecraft.pale_oak_planks": "Blasse Eichenbretter",
	"block.minecraft.pale_oak_pressure_plate": "Blasse Eichendruckplatte",
	"block.minecraft.pale_oak_sapling": "Blasser Eichensetzling",
	"block.minecraft.pale_oak_shelf": "Blosseichn Regal",
	"block.minecraft.pale_oak_sign": "Blosseichnhoizschüd",
	"block.minecraft.pale_oak_slab": "Blosseichnhoizstufn",
	"block.minecraft.pale_oak_stairs": "Blosseichnhoiztreppn",
	"block.minecraft.pale_oak_trapdoor": "Blosseichnhoizfoitir",
	"block.minecraft.pale_oak_wall_hanging_sign": "Blosseichnhoizwondhängeschüd",
	"block.minecraft.pale_oak_wall_sign": "Blosseichnhoizwondschüd",
	"block.minecraft.pale_oak_wood": "Blosseichnhoiz",
	...
	"block.minecraft.potted_closed_eyeblossom": "Eingetopfte gschlossene Augnbluam",
	...
	"block.minecraft.potted_golden_dandelion": "Eingsetzta goidana Löwnzohn",
	...
	"block.minecraft.potted_open_eyeblossom": "Eingetopfte offene Augnbluam",
	"block.minecraft.potted_orange_tulip": "Eingsetzte orange Tulpn",
	"block.minecraft.potted_oxeye_daisy": "Eingsetzte Magerite",
	"block.minecraft.potted_pale_oak_sapling": "Eingetopfta Blosseichnhoizsetzling",
	...
	"block.minecraft.resin_block": "Hoazblock",
	"block.minecraft.resin_brick_slab": "Hoazziaglstufn",
	"block.minecraft.resin_brick_stairs": "Hoazziagltreppn",
	"block.minecraft.resin_brick_wall": "Hoazziaglmaua",
	"block.minecraft.resin_bricks": "Hoazziagl",
	"block.minecraft.resin_clump": "Hoazpatzn",
	...
	"block.minecraft.short_dry_grass": "Niedrigs trockenes Gros",
	"block.minecraft.short_grass": "Niedrigs Gros",
	...
	"block.minecraft.spruce_shelf": "Fichtn Regal",
	...
	"block.minecraft.stripped_pale_oak_log": "Entrindeta Blosseichnhoizstomm",
	"block.minecraft.stripped_pale_oak_wood": "Entrindetes Blosseichnhoiz",
	...
	"block.minecraft.suspicious_sand": "Vadächtiga Sond",
	"block.minecraft.sweet_berry_bush": "Süßbeernstrauch",
	"block.minecraft.tall_dry_grass": "Hochs trockenes Gros",
	...
	"block.minecraft.tnt.disabled": "TNT-Explosionen san aus",
	...
	"block.minecraft.trial_spawner": "Prüfungs-Erschaffer",
	...
	"block.minecraft.warped_shelf": "Wirr Regal",
	...
	"block.minecraft.waxed_copper_bars": "Gwochsts Kupfagitta",
	"block.minecraft.waxed_copper_block": "Gwochsta Kupfablock",
	"block.minecraft.waxed_copper_bulb": "Gwochste Kupfalompn",
	"block.minecraft.waxed_copper_chain": "Gwochste Kupfakettn",
	"block.minecraft.waxed_copper_chest": "Gwochste Kupfakistn",
	"block.minecraft.waxed_copper_door": "Gwochste Kupfatir",
	"block.minecraft.waxed_copper_golem_statue": "Gwochsta Kupfagolem Statue",
	"block.minecraft.waxed_copper_grate": "Gwochsta Kupfarost",
	"block.minecraft.waxed_copper_lantern": "Gwochste Kupfalatern",
	...
	"block.minecraft.waxed_exposed_copper_bars": "Gwochsts oglaufnes Kupfagitta",
	"block.minecraft.waxed_exposed_copper_bulb": "Gwochste ausgsetzte Kupfalompn",
	"block.minecraft.waxed_exposed_copper_chain": "Gwochst oglaufnes Kupfagitta",
	"block.minecraft.waxed_exposed_copper_chest": "Gwochste Ausgsetzte Kupfakistn",
	"block.minecraft.waxed_exposed_copper_door": "Gwochste ausgsetzte Kupfatir",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Gwochste Ausgsetzte Kupfagolem Statue",
	"block.minecraft.waxed_exposed_copper_grate": "Gwochsta ausgsetzta Kupfarost",
	"block.minecraft.waxed_exposed_copper_lantern": "Gwochst oglaufne Kupfalatern",
	...
	"block.minecraft.waxed_exposed_lightning_rod": "Gwochsta ausgsetzta Blitzobleita",
	"block.minecraft.waxed_lightning_rod": "Gwochsta Blitzobleita",
	...
	"block.minecraft.waxed_oxidized_copper_bars": "Gwochst oxidiats Kupfagitta",
	"block.minecraft.waxed_oxidized_copper_bulb": "Gwochste varrostete Kupfalompn",
	"block.minecraft.waxed_oxidized_copper_chain": "Gwochste oxidiate Kupfakettn",
	"block.minecraft.waxed_oxidized_copper_chest": "Gwochste Oxidiate Kupfakistn",
	"block.minecraft.waxed_oxidized_copper_door": "Gwochste varrostete Kupfatir",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Gwochste Oxidiate Kupfagolem Statue",
	"block.minecraft.waxed_oxidized_copper_grate": "Gwochsta varrosteta Kupfarost",
	"block.minecraft.waxed_oxidized_copper_lantern": "Gwochst oxidiate Kupfalatern",
	...
	"block.minecraft.waxed_oxidized_lightning_rod": "Gwochsta Oxidiata Blitzobleita",
	...
	"block.minecraft.waxed_weathered_copper_bars": "Gwochst veawittats Kupfagitta",
	"block.minecraft.waxed_weathered_copper_bulb": "Gwochste vawittate Kupfalompn",
	"block.minecraft.waxed_weathered_copper_chain": "Gwochste veawittate Kupfakettn",
	"block.minecraft.waxed_weathered_copper_chest": "Gwochste vawittate Kupfakistn",
	"block.minecraft.waxed_weathered_copper_door": "Gwochste vawittate Kupfatir",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Gwochste vawittate Kupfagolem Statue",
	"block.minecraft.waxed_weathered_copper_grate": "Gwochsta vawittate Kupfarost",
	"block.minecraft.waxed_weathered_copper_lantern": "Gwochste veawittate Kupfalatern",
	...
	"block.minecraft.waxed_weathered_lightning_rod": "Gwochsta vawittata Blitzobleita",
	...
	"block.minecraft.weathered_copper_bars": "veawittats Kupfagitta",
	"block.minecraft.weathered_copper_bulb": "Vawittate Kupfalompn",
	"block.minecraft.weathered_copper_chain": "veawittate Kupfakettn",
	"block.minecraft.weathered_copper_chest": "Vawittate Kupfakistn",
	"block.minecraft.weathered_copper_door": "Vawittate Kupfatir",
	"block.minecraft.weathered_copper_golem_statue": "Vawittate Kupfagolem Statue",
	"block.minecraft.weathered_copper_grate": "Vawittata Kupfarost",
	"block.minecraft.weathered_copper_lantern": "veawittate Kupfalatern",
	...
	"block.minecraft.weathered_lightning_rod": "Vawittata Blitzobleita",
	...
	"block.minecraft.wildflowers": "Wüdblumen",
	...
	"book.edit.title": "Buach ända Fensta ",
	...
	"book.sign.title": "Buach-untaschreib-Büdschirm",
	"book.sign.titlebox": "Titl",
	"book.signButton": "Signian",
	"book.view.title": "Buach-auschau-Büdschirm",
	...
	"chat.disabled.invalid_command_signature": "Der Auftrog woa ned wia erwoated oda fahlnde Auftrogsargument-Unterschrifftn",
	"chat.disabled.invalid_signature": "Da Chat hot a ungültige Signatur aufwisn. Bitte vasuach, di nei zu vabindn.",
	...
	"chat.disabled.out_of_order_chat": "Der Schat wuad in foischa Reihenfolge empfongen. Hot sich de Systemzeit vaändat?",
	...
	"chat.queue.tooltip": "Klick, um de nächste Nochricht onzuzagn",
	...
	"chat_restriction.chat_and_commands_disabled_by_options": "Da Chat is in den Clienteistellungen ausgmocht.",
	"chat_restriction.chat_disabled_by_options": "Da Spielachat is in den Clienteistellungen ausgmocht.",
	"chat_restriction.chat_disabled_by_options.action": "Geh in die Chateistellungen",
	"chat_restriction.disabled_by_launcher": "Da Chat is durchn Launcher ausgmocht",
	"chat_restriction.disabled_by_profile": "Da Chat is durch die Profüleistellungen ausgmocht.",
	"chat_restriction.disabled_by_profile.action": "Geh in die Profüleistellungen",
	"chat_screen.commands_not_allowed": "Es diafn kane Befehle obgschickt wean",
	"chat_screen.message": "Zua sendane Nochricht: %s",
	"chat_screen.messages_not_allowed": "Es diafn kane Chatnochrichten obgschickt wean",
	...
	"chunk.toast.checkLog": "Schau im Ausgabeverlauf fia mehr Infos",
	"chunk.toast.loadFailure": "Chunk bei %s hot ned glodn wean kennan",
	"chunk.toast.lowDiskSpace": "Weinig freia Speichaplotz!",
	"chunk.toast.lowDiskSpace.description": "Wöld konn vielleicht ned gespeichat wean.",
	"chunk.toast.saveFailure": "Chunk bei %s hot ned gspeichat wean kennan",
	...
	"commands.attribute.base_value.reset.success": "Grudnweat fürs Attribut %s für Entität %s aufn Standard %s zrucksetzt",
	...
	"commands.datapack.create.already_exists": "A Paket mit dem Nomen '%s' gibts schon",
	"commands.datapack.create.invalid_full_name": "Ungültiger Nome ‚%s‘ fia neies Dotnpaket",
	"commands.datapack.create.invalid_name": "Ungültige Zeichn im neichen Paketnomen '%s'",
	"commands.datapack.create.io_failure": "Dotnpaket mitm Nomen '%s' konn ned erstöllt wean; schau ins Protokoll",
	"commands.datapack.create.metadata_encode_failure": "Metadatn fürs Paket mit dem Nomen '%s' hom ned koadiat wean kennen: %s",
	"commands.datapack.create.success": "Neichs leares Paket mitm Nomen '%s' is eastöllt woan",
	"commands.datapack.disable.failed": "Datnpaket '%s' is scho deaktiviat!",
	"commands.datapack.disable.failed.feature": "Dotnpaket '%s' konn ned ausgschoitn wean, weil es Teil von am aktivn Schoitas is!",
	...
	"commands.dialog.clear.multiple": "Dialog is fia %s Spiela glöscht woan",
	"commands.dialog.clear.single": "Dialog is fia %s glöscht woan",
	"commands.dialog.show.multiple": "Dialog fia %s Spiela ongezagt",
	"commands.dialog.show.single": "Dialog fia %s ongezagt",
	...
	"commands.drop.no_loot_table.block": "Block %s hot ka Beutetabelln",
	...
	"commands.fetchprofile.copy_component": "Komponent kopian",
	"commands.fetchprofile.copy_text": "%s kopian",
	"commands.fetchprofile.entity.success": "Profil für Objekt ‚%s‘ aufgelöst: %s",
	"commands.fetchprofile.failed_to_serialize": "Profü '%s' hod ned serialisiat wean kennen",
	"commands.fetchprofile.give_item": "Item gebn",
	"commands.fetchprofile.id.failure": "Profü fia ID '%s' hod ned aufglöst wean kennen",
	"commands.fetchprofile.id.success": "Profü fia ID '%s' aufglöst: %s",
	"commands.fetchprofile.name.failure": "Profü fian Nomen '%s' hod ned aufglöst wean kennen",
	"commands.fetchprofile.name.success": "Profü fian Nomen '%s' aufglöst: %s",
	"commands.fetchprofile.no_profile": "Objekt %s hat kein Profil",
	"commands.fetchprofile.summon_mannequin": "Spielapuppn easchoffn",
	...
	"commands.function.error.missing_argument": "Fehlndes Argument %[2]s füa de Funktion %[1]s",
	"commands.function.error.missing_arguments": "Fehlende Aurgumente für die Fuanktion ‚%s‘",
	"commands.function.error.parse": "Bei da Auswertung des Makros '%s' hot da Befehl '%s' an Fehla vaursocht: %s",
	"commands.function.instantiationFailure": "Funktion %s hod net ausgwertet wean kennan: %s",
	"commands.function.result": "Funktion '%s' hot %s ausgebn",
	"commands.function.scheduled.multiple": "Fuanktionen laufen %s",
	"commands.function.scheduled.no_functions": "Es san kane Funktionen mit dem Nomen '%s' gfundn wean kennan",
	...
	"commands.function.success.single.result": "Funktion '%[2]s' is zruck %[1]s",
	...
	"commands.kick.owner.failed": "Da Server Besitza von am LAN-Spül konn ned ausegwoafn wean",
	"commands.kick.singleplayer.failed": "In am Offlinem Anzlspilaspül konn ned ausegworfn wean",
	...
	"commands.profile_fetch.copy_component": "Komponent kopian",
	"commands.profile_fetch.failed_to_serialize": "Profü '%s' hod ned serialisiat wean kennen",
	"commands.profile_fetch.give_item": "Item gebn",
	"commands.profile_fetch.id.failure": "Profü fia ID '%s' hod ned aufglöst wean kennen",
	"commands.profile_fetch.id.success": "Profü fia ID '%s' aufglöst: %s",
	"commands.profile_fetch.name.failure": "Profü fian Nomen '%s' hod ned aufglöst wean kennen",
	"commands.profile_fetch.name.success": "Profü fian Nomen '%s' aufglöst: %s",
	...
	"commands.random.error.range_too_large": "Spanne darf hechstns 2147483646 Zufallswerte umfossn",
	"commands.random.error.range_too_small": "Spanne muss mindestns 2 Zufollswerte umfossn",
	"commands.random.reset.all.success": "Zuafals folge %s wuarde zurückgesetzt(s)",
	"commands.random.reset.success": "Zufoisfolge ‚%s‘ is zrugggsetzt wordn",
	"commands.random.roll": "%s hot %s gwürflt (zwischn %s und %s inklusive)",
	"commands.random.sample.success": "Zufoiswert: %s",
	"commands.recipe.give.failed": "Koane neien Rezepte san gleant wordn",
	"commands.recipe.give.success.multiple": "%s Rezepte sen fia %s Spiela freigscholtn wordn",
	...
	"commands.recipe.take.success.single": "%s Rezepte san vo %s Spiela entfernt wordn",
	...
	"commands.rotate.success": "%s is gedraht woan",
	...
	"commands.schedule.macro": "Makros kennen net geplat weadn",
	...
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Automatische Aktualisierung des Onzeigenomns is fürs Punkte-Ziel '%s' deaktiviert woadn",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Automatische Aktualisierung vom Onzeigenomen is fürs Punkte‐Ziel '%s' aktiviert woadn",
	"commands.scoreboard.objectives.modify.displayname": "Da Onzeigenom vo %s is auf %s geändert worden",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Standard‐Zahlendoarstellung vom Punkte‐Ziel '%s' is zrückgesetzt woan",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Standard‐Zahlendarstellung vom Punkte‐Ziel '%s' is geändat woan",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Onzeigenomen in %s is fia %s Objekte zurückgesetzt woan",
	"commands.scoreboard.players.display.name.clear.success.single": "Onzeigenomen in %s is fia %s zurückgesetzt woan",
	...
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Zoindorstellung in %s wird für %s zruckgsetzt",
	...
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Zoinendorstellung in %s wird für %s gendert",
	...
	"commands.setidletimeout.success.disabled": "Spiela-Inaktivitätslimit is ausgschoitn woan",
	"commands.setworldspawn.failure.not_overworld": "Da Wölteinstiegspunkt konn nua in da Obawölt gsetzt wean",
	"commands.setworldspawn.success": "Welt-Einstiegspunkt wurd auf (%s, %s, %s [%s]) gsetzt",
	"commands.setworldspawn.success.new": "Wödspawnpunkt is auf %s, %s, %s, [%s, %s] in %s gsetzt woan",
	"commands.spawnpoint.success.multiple": "Einstiegspunkt von %[6]s Spielan wurd auf (%[1]s, %[2]s, %[3]s) [%[4]s] in %[5]s gsetzt",
	"commands.spawnpoint.success.multiple.new": "Spawnpunkt is auf %s, %s, %s [%s, %s] in %s fia %s spiela gsetzt woan",
	"commands.spawnpoint.success.single": "Einstiegspunkt von %[6]s wurd auf (%[1]s, %[2]s, %[3]s) [%[4]s] in %[5]s gsetzt",
	"commands.spawnpoint.success.single.new": "Spawnpunkt is auf %s, %s, %s [%s, %s] in %s fia %s gsetzt woan",
	"commands.spectate.cannot_spectate": "%s kon ned zuagschaut wean",
	...
	"commands.stopwatch.already_exists": "Stoppuhr '%s' gibts schon",
	"commands.stopwatch.create.success": "Stoppuhr '%s' eastöllt",
	"commands.stopwatch.does_not_exist": "Stoppuhr '%s' gibts ned",
	"commands.stopwatch.query": "Stoppuhr '%s' laft seit %ss",
	"commands.stopwatch.remove.success": "Stoppuhr '%s' glöscht",
	"commands.stopwatch.restart.success": "Stoppuhr '%s' is nei gstartet woan",
	"commands.summon.failed": "Objekt hot ned erzeugt wean kina",
	"commands.summon.failed.peaceful": "Monsta kennen ned in da \"Friedlich\"-Schwierigkeit easchoffn wean",
	...
	"commands.swing.failed.notliving": "Es san ka lebende Objekte, zum schwinga g’funden wordn",
	"commands.swing.success.multiple": "%s Objekte zum Armschwinga bracht",
	"commands.swing.success.single": "%s is dazu brocht worn, mitm Oarm zu schwinga",
	...
	"commands.test.batch.starting": "Umgebung %s, Reihe %s wead gestartet",
	"commands.test.clear.error.no_tests": "Es san kane Prüfungen zum leern gfundn woan",
	"commands.test.clear.success": "%s Struktuan san gleert woan",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Klickn, um in de Zwischnoblog zu kopian",
	"commands.test.create.success": "Testaufbau fian Test %s wuad gmocht",
	"commands.test.error.no_test_containing_pos": "Es konn ka Testinstanz gfundn wean de %s, %s, %s enhält",
	"commands.test.error.no_test_instances": "Kane Testinstanzn gfundn woan",
	"commands.test.error.non_existant_test": "Test %s hod ned gfundn wean kennen",
	"commands.test.error.structure_not_found": "Teststruktur %s hod ned gfundn wean kennen",
	"commands.test.error.test_instance_not_found": "Testinstanz-Blockobjekt hod ned gfundn wean kennen",
	"commands.test.error.test_instance_not_found.position": "Testinstanz-Blockobjekt hod ned bei am Test bei %s, %s, %s gfundn wean kennen",
	"commands.test.error.too_large": "De Konstruktion derf in olle Richtungen hechstens %s Blöcke groß sein",
	"commands.test.locate.done": "Featig gsuacht, %s Struktur(n) hom gfundn wean kennen",
	"commands.test.locate.found": "Strucktur bei %s gfundn (Entfeanung: %s)",
	"commands.test.locate.started": "Teststruktuan weadn gsuacht, des konn a bissl dauan...",
	"commands.test.no_tests": "Kane Tests zum Ausfian vorhondn",
	"commands.test.relative_position": "Position relativ zu %s: %s",
	"commands.test.reset.error.no_tests": "Es san kane Tests zum Zrucksetzn gfundn woan",
	"commands.test.reset.success": "%s Konstruktion(en) zruckgsetzt",
	"commands.test.run.no_tests": "Kane Tests san gfundn woan",
	"commands.test.run.running": "%s Tests wean ausgfiat...",
	"commands.test.summary": "Spütest featig! %s tests san ausgfiat woan",
	"commands.test.summary.all_required_passed": "Olle eafoadalichn Tests hom gepasst :)",
	"commands.test.summary.failed": "%s eafoadalichn Tests san fehlschlogn :(",
	"commands.test.summary.optional_failed": "%s optionale Tests san fehlgschlogn",
	"commands.tick.query.percentiles": "Perzentile: P50: %s ms, P95: %s ms, P99: %s ms; Stichprob: %s",
	"commands.tick.query.rate.running": "Soi‐Tickrotn: %s pro Sekund.\nDurchschnittliche Zeit pro Tick: %s ms (Soi: %s ms)",
	"commands.tick.query.rate.sprinting": "Soi‐Tickrotn: %s pro Sekund (net berücksichtigt, nua zua Referenz).\nDurchschnittliche Zeit pro Tick: %s ms",
	"commands.tick.rate.success": "Soi‐Tickrotn is auf %s pro Sekund gesetzt wuan",
	"commands.tick.sprint.report": "Beschleinigung is mit %s Ticks pro Sekund bzw. %s ms pro Tick obgschlossn wuan",
	"commands.tick.sprint.stop.fail": "Es find daweil koaTick‐Beschleinigung stott",
	"commands.tick.sprint.stop.success": "Tick‐Beschleinigung is obrochn wuan",
	"commands.tick.status.frozen": "Es Spü is eingfrohrn",
	"commands.tick.status.lagging": "Es Spü laft, es konn oba ned mit da Ziel-Tickrate mithoitn",
	...
	"commands.tick.step.stop.fail": "Es find daweil koa Tick‐Beschleinigung stott",
	"commands.tick.step.stop.success": "Tick‐Beschleinigung is obrochn wuan",
	"commands.tick.step.success": "Es wead um %s Tick(s) fortgschrittn",
	"commands.time.no_default_clock": "In da Dimension %s gibts ka Standardua",
	"commands.time.no_time_marker_found": "Ua %s hot ka Zeitmoakn %s",
	"commands.time.pause": "Ua %s onghoitn",
	"commands.time.query": "De aktuelle Zeit is %s",
	"commands.time.query.absolute": "Ua %s is bei %s Tick(s)",
	"commands.time.query.gametime": "De Spüzeit is %s Tick(s)",
	"commands.time.query.timeline": "Zeitlinie %s is bei %s Tick(s)",
	"commands.time.query.timeline.repetitions": "Zeitlinie %s is %s-moi duachlafn woan",
	"commands.time.rate": "Weltuhr ‚%s‘ läuft nun mit %s‐facher Geschwindigkeit",
	"commands.time.resume": "Ua %s fuatgsetzt",
	"commands.time.set": "Zeit auf %s gsetzt",
	"commands.time.set.absolute": "%s is auf %s Tick(s) gsetzt woan",
	"commands.time.set.time_marker": "%s is auf Zeitmoakn %s gsetzt woan",
	"commands.time.wrong_timeline_for_clock": "Ua %s untastützt Zeitachse %s ned",
	...
	"commands.transfer.error.no_players": "Es muas mindestns a Spila zum Übatrogn ongegebn wean",
	"commands.transfer.success.multiple": "%s Spila weadn on %s:%s übatrogn",
	"commands.transfer.success.single": "Übertrog %s zu %s:%s",
	...
	"commands.version.header": "Server Versions Info:",
	...
	"commands.version.stable.no": "stabil = na",
	"commands.version.stable.yes": "stabil = jo",
	"commands.waypoint.list.empty": "Kane Wegpunkte in %s",
	"commands.waypoint.list.success": "%s Wegpunkt(e) in %s: %s",
	"commands.waypoint.modify.color": "Wegpunktfoab is jetz %s",
	"commands.waypoint.modify.color.reset": "Wegpunktfoab zrucksetztn",
	"commands.waypoint.modify.style": "Wegpunkt Stial gändert",
	...
	"connect.failed.transfer": "Verbindung bei Übertrogung an den Server is föhgschlogen",
	...
	"connect.transferring": "Übertrog an neuen Serva…",
	...
	"createWorld.customize.presets.list": "Alternativ kust a a boa von uns nemma!",
	...
	"dataPack.locator_bar.description": "Zagt im Meahspielamodus de Richtung ondara Spiela on",
	"dataPack.locator_bar.name": "Oatungsleistn",
	"dataPack.minecart_improvements.description": "Vabessate Bewegungen von Wagons",
	"dataPack.minecart_improvements.name": "Wagon Vabessarungen",
	"dataPack.redstone_experiments.description": "Experimentelle Redstone Ändarungen",
	...
	"dataPack.winter_drop.description": "Neiche Sochn im Winter-Drop",
	...
	"death.attack.mace_smash": "%[1]s is von %[2]s zaschmettat woan",
	"death.attack.mace_smash.item": "%[1]s is von %[2]s mit %[3]s zaschmettat woan",
	...
	"death.attack.spear": "%[1]s is von %[2]s aufgspießt woan",
	"death.attack.spear.item": "%[1]s is von %[2]s mit %[3]s aufgspießt woan",
	...
	"debug.crash.message.rebindable": "%s + %s san gedruckt. Des wead des Spü obstiazn lossn, wenn se ned losglossn wean.",
	...
	"debug.entry.currently.alwaysOn": "%s: Deazeit imma ein",
	"debug.entry.currently.inF3": "%s: Deazeit nua im F3 ein",
	"debug.entry.currently.inOverlay": "%s: Deazeit nua im Debug-Overlay",
	"debug.entry.currently.never": "%s: Deazeit aus",
	"debug.entry.f3": "Im F3",
	...
	"debug.options.category.renderer": "Debug-Rederer",
	"debug.options.category.text": "Debug-Onzeign Text",
	"debug.options.help": "F3 + F5 = Debug Optionen beoabeitn",
	"debug.options.notAllowed.tooltip": "Ned bei reduziatn Debug-Infos sichtboa",
	"debug.options.profile.default": "Standardprofü",
	"debug.options.profile.performance": "Leistungsprofü",
	"debug.options.search": "Noch Optionen suachn",
	"debug.options.title": "Debug Optionen",
	"debug.options.warning": "De Optionen san nua fia Testzwecke. Se mochn meglichaweise dein PC longsoma, lossns Spü obstiazn oda essn dei Stan-Haustier.",
	...
	"debug.profiling.start.rebindable": "Profil-Aufzeichnung fia %s Sekundn gstartet. Benutz %s + %s, um vuazeitig zua beendn",
	...
	"debug.version.help": "F3 + V = Client Versions Info",
	...
	"disconnect.packetError": "Fehla im Netzwerkprotokoll",
	"disconnect.spam": "Ausigschmissn wegn Spamming",
	"disconnect.timeout": "Zeitübaschreitung",
	"disconnect.transfer": "On an Onderen Server übertrogen",
	"disconnect.unknownHost": "Den Serva gibts ned",
	"download.pack.failed": "%s vom %s Paket(en) konnt(n) net runtergloden werden",
	"download.pack.progress.bytes": "Fortschritt: %s (Größe net bekannt)",
	"download.pack.progress.percent": "Fortschritt: %s %%",
	"download.pack.title": "Ressourcenpaket %s/%s wird heruntergelodn",
	"editGamerule.default": "Standard: %s",
	"editGamerule.inGame.button": "Spüregln beoabeitn...",
	"editGamerule.inGame.disabled.tooltip": "Um de Spüregln zum Vaändan brauchst Operatoanrechte.",
	"editGamerule.inGame.discardChanges.message": "Bist da sicha, doss du de vuagnommenen Ändarungen vaweafn wüst?",
	"editGamerule.inGame.discardChanges.title": "Ändarungen da Spüregln",
	"editGamerule.inGame.downloadingGamerules": "Spüregln wean obgruafn...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Otm des Nautilus",
	...
	"effect.minecraft.infested": "Befolln",
	...
	"effect.minecraft.raid_omen": "Drohenda Übafoll",
	...
	"effect.minecraft.wind_charged": "Windglodn",
	...
	"enchantment.minecraft.lunge": "Ausfoiischritt",
	...
	"enchantment.minecraft.sweeping_edge": "Schwungkroft",
	...
	"enchantment.minecraft.wind_burst": "Windböe",
	"entity.minecraft.acacia_boat": "Akazienhoizboot",
	"entity.minecraft.acacia_chest_boat": "Akazienhoizboot mit Kistn",
	...
	"entity.minecraft.bamboo_chest_raft": "Bambusfloß mit Kistn",
	"entity.minecraft.bamboo_raft": "Bambusfloß",
	"entity.minecraft.bat": "Fledamaus",
	"entity.minecraft.bee": "Biene",
	"entity.minecraft.birch_boat": "Birknhoizboot",
	"entity.minecraft.birch_chest_boat": "Birknhoizboot mit Kistn",
	...
	"entity.minecraft.camel_husk": "Untots Kamel",
	"entity.minecraft.cat": "Kotz",
	"entity.minecraft.cave_spider": "Höhlnspinn",
	"entity.minecraft.cherry_boat": "Kirschnhoizboot",
	"entity.minecraft.cherry_chest_boat": "Kirschnhoizboot mit Kistn",
	...
	"entity.minecraft.creaking": "Knoaza",
	"entity.minecraft.creaking_transient": "Knoaza",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.dark_oak_boat": "Schworzoachnhoizboot",
	"entity.minecraft.dark_oak_chest_boat": "Schworzoachnhoizboot mit Kistn",
	...
	"entity.minecraft.happy_ghast": "Froha Ghast",
	...
	"entity.minecraft.jungle_chest_boat": "Tropnhoizboot mit Kistn",
	"entity.minecraft.killer_bunny": "Da Killer-Hos",
	"entity.minecraft.leash_knot": "Leinenknotn",
	"entity.minecraft.lightning_bolt": "Blitz",
	"entity.minecraft.lingering_potion": "Vaweiltronk",
	"entity.minecraft.llama": "Lama",
	"entity.minecraft.llama_spit": "Lamaspucke",
	"entity.minecraft.magma_cube": "Magmawürfl",
	"entity.minecraft.mangrove_boat": "Mangrovnhoizboot",
	"entity.minecraft.mangrove_chest_boat": "Mangrovnhoizboot mit Kistn",
	"entity.minecraft.mannequin": "Mankale",
	...
	"entity.minecraft.oak_boat": "Oachnhoizboot",
	"entity.minecraft.oak_chest_boat": "Oachnhoizboot mit Kistn",
	"entity.minecraft.ocelot": "Ozelot",
	"entity.minecraft.ominous_item_spawner": "Vadächtiga Item Spawner",
	"entity.minecraft.painting": "Gemälde",
	"entity.minecraft.pale_oak_boat": "Blosseichnhoizboot",
	"entity.minecraft.pale_oak_chest_boat": "Blosseichnhoiz mit Kistn",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Wüstnwondara",
	...
	"entity.minecraft.splash_potion": "Wurftronk",
	"entity.minecraft.spruce_boat": "Fichtnhoizboot",
	...
	"filled_map.trial_chambers": "Prüfungskommakoatn",
	...
	"gameMode.hardcore": "Hoata Modus!",
	"gameMode.spectator": "Zuaschauamodus",
	"gameMode.survival": "Übalebnsmodus",
	"gamerule.allowEnteringNetherUsingPortals": "Nether alaubn",
	"gamerule.allowEnteringNetherUsingPortals.description": "Steiat, ob Spüla in Nether gehn kennen.",
	"gamerule.allowFireTicksAwayFromPlayer": "Vo Spiela entfernts Feia aktualisiern",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Steiat, ob Feia und Lava, de meah ois 8 Chuncks vom Spiela weg san, aktualisiat weadn",
	...
	"gamerule.commandBlocksEnabled": "Befehlsblöcke ealaubn",
	...
	"gamerule.disablePlayerMovementCheck": "Spilabewegung net übaprüfn",
	...
	"gamerule.enableCommandBlocks": "Befehlsblöcke ealaubn",
	"gamerule.enderPearlsVanishOnDeath": "Gewoafnene Enderperln vaschwindn beim Sterbn",
	"gamerule.enderPearlsVanishOnDeath.description": "Steiat, ob Endaperl, de von am Spila gworf wean, vaschwindn, wenn da Spila stirbt.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Portalnutzung durch Objekte mit Passagieren",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Ermöglicht es entities mit Passagieren, si durch Nether‐, End‐ und Endtransitportale zu teleportieren.",
	...
	"gamerule.locatorBar": "Aktiviare Spüa aufspüa Leistn",
	"gamerule.locatorBar.description": "Weins aktiviat is wiad a Leistn am Büdschirm aunzagt, dei dei Richtung von den Spüan aunzagt.",
	...
	"gamerule.minecartMaxSpeed": "Maximale Wagon Gschwindigkeit",
	"gamerule.minecartMaxSpeed.description": "Normale Höchstgschwindigkeit von am Wagon des sich auf Lond bewegt",
	"gamerule.minecraft.elytra_movement_check": "Elytren-Bewegungsübaprüfung",
	"gamerule.minecraft.fire_spread_radius_around_player": "Feiaausbreitungs-Radius",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Da Radius in Blöckn um an Spiela, in dem sich Feia ausbreitn konn",
	"gamerule.minecraft.player_movement_check": "Spiela-Bewegungsübaprüfung",
	"gamerule.minecraft.raids": "Übafälle",
	"gamerule.minecraft.universal_anger.description": "Veaärgerte neutrale Kreaturn greifn jedn Spiela in da Nähe on, ned lei de Spieler, de se verärgert hobn. Funktioniat am bestn, wenn forgive_dead_players deaktiviert is.",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Netherportalzeitverzögarung im Kreativ-Modus",
	"gamerule.playersNetherPortalCreativeDelay.description": "Zeit (in Ticks), de a Spila im Kreativ-Modus braucht, um duach a Netherportal zu reisn.",
	"gamerule.playersNetherPortalDefaultDelay": "Netherportalzeitverzögarung im Nicht-Kreativ-Modus",
	"gamerule.playersNetherPortalDefaultDelay.description": "Zeit (in Ticks), de a Spila im Nicht-Kreativ-Modus braucht, um duach a Netherportal zu reisn.",
	...
	"gamerule.projectilesCanBreakBlocks": "Projektile kennan Blöcke zerstörn",
	"gamerule.projectilesCanBreakBlocks.description": "Steiat, ob aufprollnde Projektile Blöcke zerstörn, de duach se zerstörboar waratn.",
	"gamerule.pvp": "PVP ealaubn",
	"gamerule.pvp.description": "Steiat, ob Spiela ondan Spielan Schodn mochn kennen.",
	...
	"gamerule.spawnChunkRadius.description": "Onzohl der Chunks um den Spawnpunkt in da Obawölt, die imma glodn bleibn.",
	"gamerule.spawnMonsters": "Monster spawnen",
	"gamerule.spawnMonsters.description": "Steiat, ob Monster auf natürliche Weise spawnen kennen.",
	"gamerule.spawnRadius": "Radius vom Wiedaeistiegsbereich",
	"gamerule.spawnRadius.description": "Steiat de Größe vom Bereich um den Spawnpunkt, in dem Spila in de Wölt einsteign kennan.",
	"gamerule.spawnerBlocksEnabled": "Spawna ealaubn",
	"gamerule.spectatorsGenerateChunks": "Zuschaua genariern Londschoftn",
	"gamerule.tntExplodes": "TNT derf entzündn wean und explodiern",
	...
	"gui.abuseReport.attestation": "Mit der Einreichung von da Mödung versicherst du, dass dei Ongoben wahrheitsgetreu und voiständig is – noch bestem Wissen.",
	"gui.abuseReport.comments": "Kommentare",
	"gui.abuseReport.describe": "Wenn du Details mit uns teils, konn uns des hölfn, wichtige Entscheidungen zum treffn.",
	...
	"gui.abuseReport.draft.quittotitle.title": "Du host an Mödeentwurf, dea valuan geht, wenn du es Spü valosst.",
	"gui.abuseReport.draft.title": "Mödeentwurf beorbeitn?",
	"gui.abuseReport.error.title": "Problem beim Senden deiner Meldung",
	"gui.abuseReport.message": "Wo hod oana deppad tu?\nDe Auswoi erleichtat uns, dein Vorgong zu untasuachn.",
	"gui.abuseReport.more_comments": "Bitte beschreib wos passiad is:",
	"gui.abuseReport.name.comment_box_label": "Bitte Beschreib, warum du den Nomen möldn mechast:",
	"gui.abuseReport.name.reporting": "Du mödst „%s“.",
	...
	"gui.abuseReport.reason.generic.description": "Dea Spiela is lei beim ummaraunzn / hot wos tu wos ma ned gfoid.",
	...
	"gui.abuseReport.reason.sexually_inappropriate": "Sexuell unangmessn",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Skins, die sexuelle Hondlungen, Gschlechtsorgane und/oder sexuelle Gewalt grafisch doarstölln.",
	...
	"gui.abuseReport.report_sent_msg": "Mia hom dei Meldung erhoitn. Donk da!\n\nUnsa Team wead sich möglichst zeitnoh drum kümman.",
	"gui.abuseReport.select_reason": "Mödekategorie auswöhn",
	...
	"gui.abuseReport.send.no_reason": "Bitte wöhl a Report-Kategorie aus",
	"gui.abuseReport.send.not_attested": "Bitte les da den text do oben durch und kreizel donn den Kontroikosten ob, um die Mödung absenden zu können",
	...
	"gui.banned.description.permanent": "Dei Konto is dauahoft gspat, des hoaßt, dass du weder online spün no Realms betretn konnst.",
	...
	"gui.banned.description.unknownreason": "Wir hobn kürzlich a Mödung wegen schlechten Verhaltens Ihres Kontos erhoitn. Unsare Moderatoren hobn Ihren Fall nun überprüft und festgstöt dass er gegn de Minecraft-Community-Standards verstoßt.",
	"gui.banned.name.description": "Dei jeziga Nome - '%s' - verstößt gegn unsare Community Standarts. Du konnst Anzspila spüln, oba du muast dein Nomen ändan, um online zu spüln.\n\nErfohr mea oda loss a Follübaprüfung beim folgenden Link do: %s",
	...
	"gui.banned.reason.generic_violation": "Verlötzung da Community‐Stondards",
	...
	"gui.banned.skin.description": "Dei jeziga Skin verstößt gegn unsare Community Standarts. Du konnst mit am Standart Skin spüln, oda du nimmst an neichn.\n\nErfohr mea oda loss a Follübaprüfung beim folgenden Link do: %s",
	"gui.banned.skin.title": "Skin net erlaubt",
	"gui.banned.title.permanent": "Dei Konto is gspat wordn",
	"gui.banned.title.temporary": "Konto vorübagehend gspat",
	"gui.cancel": "Obbrechn",
	...
	"gui.fileDropFailure.detail": "%s Die Dateien gehgan ned",
	"gui.fileDropFailure.title": "Speichan hod ned hikaut",
	...
	"gui.recipebook.next_page": "Nächste Seitn",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Zruck",
	...
	"gui.report_to_server": "An den Serva meldn",
	"gui.selectWorld.search": "Suach...",
	...
	"gui.stats.none_found": "Kane Statistiken gfundn.",
	...
	"gui.togglable_slot": "Klickn, um den Inventarplotz zum sperrn",
	"gui.up": "Auffe",
	"gui.waitingForResponse.button.inactive": "Zruck(%s)",
	"gui.waitingForResponse.title": "Woatn aufn Server",
	"gui.yes": "Jo",
	...
	"item.minecraft.armadillo_scute": "Gürtltier Hornschüd",
	"item.minecraft.armadillo_spawn_egg": "Gürtltia Spawn Ei",
	...
	"item.minecraft.black_bundle": "Schwoazes Sackerl",
	"item.minecraft.black_dye": "Schworze Forb",
	"item.minecraft.black_harness": "Schwoazes Gschirr",
	...
	"item.minecraft.blue_bundle": "Blaus Sackerl",
	"item.minecraft.blue_dye": "Blaue Forb",
	"item.minecraft.blue_egg": "Blaues Ei",
	"item.minecraft.blue_harness": "Blaues Gschirr",
	"item.minecraft.bogged_spawn_egg": "Sumpfskellet Spawn Ei",
	"item.minecraft.bolt_armor_trim_smithing_template": "Schmiedevualog",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Bolzn-Rüstungsbesotz",
	"item.minecraft.bone": "Knochn",
	"item.minecraft.bone_meal": "Knochnmöh",
	"item.minecraft.book": "Buach",
	"item.minecraft.bordure_indented_banner_pattern": "Bord-Bannervualog",
	"item.minecraft.bow": "Bogn",
	"item.minecraft.bowl": "Schissl",
	"item.minecraft.bread": "Brot",
	"item.minecraft.breeze_rod": "Böenruatn",
	...
	"item.minecraft.brown_bundle": "Brauns Sackerl",
	"item.minecraft.brown_dye": "Braune Forb",
	"item.minecraft.brown_egg": "Braunes Ei",
	"item.minecraft.brown_harness": "Braunes Gschirr",
	"item.minecraft.brush": "Pinsl",
	"item.minecraft.bucket": "Kiwe",
	"item.minecraft.bundle": "Sackerl",
	"item.minecraft.bundle.empty": "Leea",
	"item.minecraft.bundle.empty.description": "Konn an gmischtn Stapl von Gegnständn aufkhoitn",
	...
	"item.minecraft.camel_husk_spawn_egg": "Untots-Kamel-Spawn-Ei",
	...
	"item.minecraft.coast_armor_trim_smithing_template.new": "Strond-Rüstungssotz",
	...
	"item.minecraft.copper_boots": "Kupfastiefl",
	"item.minecraft.copper_chestplate": "Kupfabrustplottn",
	"item.minecraft.copper_golem_spawn_egg": "Kupfagolem Spawn Ei",
	"item.minecraft.copper_helmet": "Kupfahöm",
	"item.minecraft.copper_hoe": "Kupfahackn",
	"item.minecraft.copper_horse_armor": "Kupfa Pfeaderüstung",
	"item.minecraft.copper_ingot": "Kupfaborrn",
	"item.minecraft.copper_leggings": "Kupfahosn",
	"item.minecraft.copper_nautilus_armor": "Kupfa-Nautilusponza",
	"item.minecraft.copper_nugget": "Kupfaklumpn",
	"item.minecraft.copper_pickaxe": "Kupfaspitzhock",
	"item.minecraft.copper_shovel": "Kupfaschaufl",
	"item.minecraft.copper_spear": "Kupfalonzn",
	"item.minecraft.copper_sword": "Kupfaschweat",
	"item.minecraft.cow_spawn_egg": "Kua-Spawn-Ei",
	"item.minecraft.creaking_spawn_egg": "Knoaza-Spawn-Ei",
	"item.minecraft.creeper_banner_pattern": "Bannamusta",
	"item.minecraft.creeper_banner_pattern.desc": "Creeper",
	"item.minecraft.creeper_banner_pattern.new": "Creeper-Bannervualog",
	...
	"item.minecraft.crossbow.projectile.multiple": "Gschoss: %s x %s",
	"item.minecraft.crossbow.projectile.single": "Gschoss: %s",
	"item.minecraft.cyan_bundle": "Türkises Sackerl",
	...
	"item.minecraft.diamond_nautilus_armor": "Diamant-Nautilusponza",
	"item.minecraft.diamond_pickaxe": "Diamantspitzhock",
	"item.minecraft.diamond_shovel": "Diamantschaufe",
	"item.minecraft.diamond_spear": "Diamantlonzn",
	...
	"item.minecraft.dune_armor_trim_smithing_template.new": "Dünen-Rüstungssotz",
	...
	"item.minecraft.eye_armor_trim_smithing_template.new": "Augn-Rüstungssotz",
	"item.minecraft.feather": "Feda",
	"item.minecraft.fermented_spider_eye": "Fermentiads Spinnenaug",
	"item.minecraft.field_masoned_banner_pattern": "Mauarungs-Bannervualog",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Schmiedevualog",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Fluss-Rüstungssotz",
	"item.minecraft.flow_banner_pattern": "Bonnavualog",
	"item.minecraft.flow_banner_pattern.desc": "Fluss",
	"item.minecraft.flow_banner_pattern.new": "Fluss-Bannervualog",
	"item.minecraft.flow_pottery_sherd": "Fluss Töpfavualog",
	"item.minecraft.flower_banner_pattern": "Bannamusta",
	"item.minecraft.flower_banner_pattern.desc": "Blume",
	"item.minecraft.flower_banner_pattern.new": "Blumen-Bannervualog",
	...
	"item.minecraft.globe_banner_pattern.new": "Globus-Bannervualog",
	...
	"item.minecraft.golden_nautilus_armor": "Gold-Nautilusponza",
	"item.minecraft.golden_pickaxe": "Goidspitzhock",
	"item.minecraft.golden_shovel": "Goidschaufe",
	"item.minecraft.golden_spear": "Goldlonzn",
	"item.minecraft.golden_sword": "Goidschwert",
	"item.minecraft.gray_bundle": "Graus Sackerl",
	"item.minecraft.gray_dye": "Graue Forb",
	"item.minecraft.gray_harness": "Graus Gschirr",
	"item.minecraft.green_bundle": "Greans Sackerl",
	"item.minecraft.green_dye": "Grüne Forb",
	"item.minecraft.green_harness": "Grüns Gschirr",
	"item.minecraft.guardian_spawn_egg": "Wächta-Spawn-Ei",
	"item.minecraft.gunpowder": "Schworzpuiva",
	"item.minecraft.guster_banner_pattern": "Bonnavualog",
	"item.minecraft.guster_banner_pattern.desc": "Windstoßa",
	"item.minecraft.guster_banner_pattern.new": "Windstoßa-Bannervualog",
	"item.minecraft.guster_pottery_sherd": "Windstoßa Töpfascherbn",
	"item.minecraft.happy_ghast_spawn_egg": "Froha Ghast Spawn Ei",
	...
	"item.minecraft.host_armor_trim_smithing_template.new": "Wirts-Rüstungssotz",
	...
	"item.minecraft.light_blue_bundle": "Höblaus Sackerl",
	"item.minecraft.light_blue_dye": "Hellblaue Forb",
	"item.minecraft.light_blue_harness": "Höll Blaues Gschirr",
	"item.minecraft.light_gray_bundle": "Högraus Sackerl",
	"item.minecraft.light_gray_dye": "Hellgraue Forb",
	"item.minecraft.light_gray_harness": "Höllgraues Gschirr",
	"item.minecraft.lime_bundle": "Högreans Sackerl",
	"item.minecraft.lime_dye": "Hellgrüne Forb",
	"item.minecraft.lime_harness": "Höllgrünes Gschirr",
	...
	"item.minecraft.lingering_potion.effect.infested": "Vaweiltronk des Befolls",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Vaweiltronk des Schleimens",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Vaweiltronk des Webns",
	"item.minecraft.lingering_potion.effect.wind_charged": "Vaweiltronk da Windlodung",
	"item.minecraft.llama_spawn_egg": "Lama-Spawn-Ei",
	"item.minecraft.lodestone_compass": "Leitstoa-Kompass",
	"item.minecraft.mace": "Schlägel",
	"item.minecraft.magenta_bundle": "Magenta Sackerl",
	"item.minecraft.magenta_dye": "Magentane Forb",
	"item.minecraft.magenta_harness": "Magenta Fliagermutzn",
	...
	"item.minecraft.mojang_banner_pattern.new": "Ding-Bannervualog",
	...
	"item.minecraft.music_disc_creator": "Schoiplottn",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Schoiplottn",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Creator (Plottnspiela)",
	"item.minecraft.music_disc_far": "Schoiplottn",
	"item.minecraft.music_disc_far.desc": "C418 - far",
	"item.minecraft.music_disc_lava_chicken": "Schollplottn",
	"item.minecraft.music_disc_lava_chicken.desc": "Hyper Potions - Lava Hendl",
	...
	"item.minecraft.music_disc_precipice": "Schoiplottn",
	...
	"item.minecraft.music_disc_tears": "Schoiplottn",
	"item.minecraft.music_disc_tears.desc": "Amos Roddy - Träanen",
	...
	"item.minecraft.netherite_horse_armor": "Netherit-Pferdlrüst’n",
	"item.minecraft.netherite_ingot": "Netheritborrn",
	"item.minecraft.netherite_leggings": "Netherithaxnschutz",
	"item.minecraft.netherite_nautilus_armor": "Netherit-Nautilusponza",
	...
	"item.minecraft.netherite_spear": "Netheritlonzn",
	"item.minecraft.netherite_sword": "Netheritschwert",
	"item.minecraft.netherite_upgrade_smithing_template": "Schmiedevorlog",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Netherite Vabessarung",
	...
	"item.minecraft.ominous_bottle": "Unheilvolle Floschn",
	"item.minecraft.ominous_trial_key": "Unheilvolla Prüfungschlüssl",
	"item.minecraft.orange_bundle": "Oranges Sackerl",
	"item.minecraft.orange_dye": "Orange Forb",
	"item.minecraft.orange_harness": "Orangne Fliagermutzn",
	"item.minecraft.painting": "Büd",
	"item.minecraft.pale_oak_boat": "Blosseichnhoizboot",
	"item.minecraft.pale_oak_chest_boat": "Blosseichnhoizboot mit Kistn",
	"item.minecraft.panda_spawn_egg": "Panda-Spawn-Ei",
	"item.minecraft.paper": "Papia",
	"item.minecraft.parched_spawn_egg": "Wüstnwondara-Spawn-Ei",
	...
	"item.minecraft.piglin_banner_pattern.new": "Schnauzn-Bannervualog",
	...
	"item.minecraft.pink_bundle": "Pinks Sackerl",
	"item.minecraft.pink_dye": "Rosane Forb",
	"item.minecraft.pink_harness": "Pinkes Gschirr",
	...
	"item.minecraft.potion.effect.infested": "Tronk des Befolls",
	...
	"item.minecraft.potion.effect.oozing": "Tronk des Schleimens",
	...
	"item.minecraft.potion.effect.weaving": "Tronk des Webns",
	"item.minecraft.potion.effect.wind_charged": "Tronk da Windlodung",
	...
	"item.minecraft.purple_bundle": "Violetts Sackerl",
	...
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Aufziaga-Rüstungssotz",
	...
	"item.minecraft.red_bundle": "Rots Sackerl",
	"item.minecraft.red_dye": "Rote Forb",
	"item.minecraft.red_harness": "Rots Gschirr",
	"item.minecraft.redstone": "Redstone-Stab",
	"item.minecraft.resin_brick": "Hoazziagl",
	"item.minecraft.resin_clump": "Hoazpatzn",
	"item.minecraft.rib_armor_trim_smithing_template": "Schmiedevorlog",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Rippn-Rüstungssotz",
	...
	"item.minecraft.scrape_pottery_sherd": "Obkrotz Töpfascherbn",
	"item.minecraft.scute": "Hornschüd",
	"item.minecraft.sentry_armor_trim_smithing_template": "Schmiedevorlog",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Wochn-Rüstungssotz",
	"item.minecraft.shaper_armor_trim_smithing_template": "Schmiedevorlog",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Künstla-Rüstungssotz",
	...
	"item.minecraft.silence_armor_trim_smithing_template.new": "Stille-Rüstungssotz",
	...
	"item.minecraft.skull_banner_pattern.new": "Totnkopf--Bannervualog",
	...
	"item.minecraft.snout_armor_trim_smithing_template.new": "Schnauzn-Rüstungssotz",
	...
	"item.minecraft.spire_armor_trim_smithing_template.new": "Turmspitzn-Rüstungssotz",
	...
	"item.minecraft.splash_potion.effect.infested": "Wuaftronk des Befolls",
	...
	"item.minecraft.splash_potion.effect.oozing": "Wuaftronk des Schleimens",
	...
	"item.minecraft.splash_potion.effect.weaving": "Wuaftronk des Webns",
	"item.minecraft.splash_potion.effect.wind_charged": "Wuaftronk da Windlodung",
	...
	"item.minecraft.stone_spear": "Stanlonzn",
	...
	"item.minecraft.tide_armor_trim_smithing_template.new": "Gezeitn-Rüstungssotz",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Pfeil des Befolls",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Pfeil des Webns",
	"item.minecraft.tipped_arrow.effect.wind_charged": "Pfeil da Windlodung",
	...
	"item.minecraft.trial_key": "Prüfungsschlüssl",
	...
	"item.minecraft.turtle_scute": "Schüdkrötn Hornschüd",
	"item.minecraft.turtle_spawn_egg": "Schüdkrötn-Spawn-Ei",
	"item.minecraft.vex_armor_trim_smithing_template": "Schmiedevorlog",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Plogegeista-Rüstungssotz",
	...
	"item.minecraft.ward_armor_trim_smithing_template.new": "Wärta-Rüstungssotz",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Wegfinda-Rüstungssotz",
	"item.minecraft.wheat": "Weizn",
	"item.minecraft.wheat_seeds": "Weiznkern",
	"item.minecraft.white_bundle": "Weißes Sackerl",
	"item.minecraft.white_dye": "Weiße Forb",
	"item.minecraft.white_harness": "Weißes Gschirr",
	"item.minecraft.wild_armor_trim_smithing_template": "Schmiedevorlog",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Wüldniss-Rüstungssotz",
	...
	"item.minecraft.wolf_armor": "Woifsrüstung",
	...
	"item.minecraft.wooden_spear": "Hoizlonzn",
	...
	"item.minecraft.yellow_bundle": "Göbs Sackerl",
	"item.minecraft.yellow_dye": "Gelbe Forb",
	"item.minecraft.yellow_harness": "Göbs Gschirr",
	"item.minecraft.zoglin_spawn_egg": "Zoglin-Spawn-Ei",
	"item.minecraft.zombie_horse_spawn_egg": "Zombieroß-Spawn-Ei",
	"item.minecraft.zombie_nautilus_spawn_egg": "Zombinautilus-Spawn-Ei",
	...
	"item.modifiers.any": "Ausgrüstet:",
	"item.modifiers.armor": "Onglegt:",
	"item.modifiers.body": "Onglegt:",
	"item.modifiers.chest": "Am Körpa:",
	"item.modifiers.feet": "An de Fiaß:",
	"item.modifiers.hand": "Gehoitn:",
	...
	"item.modifiers.saddle": "Gsottlt:",
	"item.nbt_tags": "NBT: %s Eignschoft(n)",
	"item.op_block_warning.line1": "Ochtung:",
	"item.op_block_warning.line2": "Den Block zu platzian kennt an Befehl ausfian",
	"item.op_block_warning.line3": "Verwend des ned, außer du weißt wos drin ist!",
	"item.spawn_egg.peaceful": "In \"Friedlich\" ausgschoitn",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine - Creator (Plottnspiela)",
	"jukebox_song.minecraft.far": "C418 - far",
	"jukebox_song.minecraft.lava_chicken": "Hyper Potions - Lava Hendl",
	...
	"jukebox_song.minecraft.tears": "Amos Roddy - Träanen",
	...
	"key.category.minecraft.gameplay": "Spümechanikn",
	"key.category.minecraft.inventory": "Inventar",
	"key.category.minecraft.misc": "Vaschiedns",
	"key.category.minecraft.movement": "Bewegung",
	"key.category.minecraft.multiplayer": "Measpüla",
	"key.category.minecraft.spectator": "Zuaschaua",
	"key.chat": "Chat",
	"key.command": "Befehlszeile aufmochn",
	"key.debug.clearChat": "Chat löschn",
	"key.debug.copyLocation": "Position kopian",
	"key.debug.copyRecreateCommand": "Datn kopian",
	"key.debug.crash": "Debug-Obstuaz",
	"key.debug.debugOptions": "Debug-Optionen",
	"key.debug.dumpDynamicTextures": "Dynamische Textuan ausgebn",
	"key.debug.dumpVersion": "Versionsinformationen ausgebn",
	"key.debug.focusPause": "Pause bei Fensta-Fokusvalust umschoitn",
	"key.debug.fpsCharts": "FPS-Diagramme",
	"key.debug.lightmapTexture": "Des is a Textur, de fias Liacht zuaständig is",
	"key.debug.modifier": "Debug-Modifikatortastn",
	"key.debug.networkCharts": "Netzweakdiagramme",
	"key.debug.overlay": "Overlay umschoitn",
	"key.debug.profiling": "Profüeastöllung startn/stoppn",
	"key.debug.profilingChart": "Profüdiagramm",
	"key.debug.reloadChunk": "Chunks nei lodn",
	"key.debug.reloadResourcePacks": "Ressourcenpakete nei lodn",
	"key.debug.showAdvancedTooltips": "Eaweitate Schnöllinfos onzagn",
	"key.debug.showChunkBorders": "Chunkgrenzn onzagn",
	"key.debug.showHitboxes": "Hitboxn onzagn",
	"key.debug.spectate": "Zuaschauamodus wechsln",
	"key.debug.switchGameMode": "Spümodusauswoi",
	...
	"key.quickActions": "Schnö Aktionan",
	"key.right": "Rechts",
	...
	"key.spectatorHotbar": "In da Schnöllzuagriffsleistn auswöhln",
	"key.spectatorOutlines": "Spiela markian (Zuaschaua)",
	"key.sprint": "Sprintn",
	"key.swapOffhand": "Gegnstond mit Zwoathond tauschn",
	"key.toggleGui": "Benutzaobaflächn umschoitn",
	...
	"known_server_link.announcements": "Onkündigungen",
	"known_server_link.community": "Gemeinschoft",
	"known_server_link.community_guidelines": "Gemeinschoftsregeln",
	"known_server_link.feedback": "Rückmeldung",
	"known_server_link.forums": "Foren",
	"known_server_link.news": "Neuigkeitn",
	"known_server_link.report_bug": "Host an Fehla beim Server Gfunden?",
	"known_server_link.status": "Status",
	"known_server_link.support": "Hilfe/Untastützung",
	...
	"loading.progress": "%s %%",
	"manageServer.add.title": "Server hinzuafügn",
	"manageServer.edit.title": "Serverinfo beoabeitn",
	"manageServer.enterIp": "Serveradress",
	"manageServer.enterName": "Servernom",
	"manageServer.resourcePack": "Server-Ressourcenpakete",
	"manageServer.resourcePack.disabled": "Ausgschoitn",
	"manageServer.resourcePack.enabled": "Eingschoitn",
	"manageServer.resourcePack.prompt": "Obfrogn",
	"mco.account.privacy.info": "Erfohr mehr üba Mojang und Datnschutzgsetze",
	"mco.account.privacy.info.button": "Erfoah mehr üba DSGVO",
	"mco.account.privacy.information": "Mojang wendet bestimmte Verfohren an, um Kinda und deren Privatsphäre zu schützn; so wean es „Gesetz zum Schutz da Privatsphäre vo Kindern im Internet“ (COPPA) und de Datenschutz‐Grundverordnung (DSGVO) eingeholtn.\n\nMöglicherweise musst du de Zustimmung deina Eltern eiholn, bevor du auf dei Realms‐Konto zuagreifn kannst.",
	...
	"mco.backup.entry.worldType.adventureMap": "Obnteiawölt",
	"mco.backup.entry.worldType.experience": "Eafoahrungwölt",
	"mco.backup.entry.worldType.inspiration": "Inspirationswölt",
	"mco.backup.entry.worldType.minigame": "Minispü",
	"mco.backup.entry.worldType.normal": "Normal",
	"mco.backup.entry.worldType.unknown": "Unbekonnt",
	"mco.backup.generate.world": "Wöd generian",
	"mco.backup.info.title": "Vaändrunga gegaüba vo da letschta sicharung",
	"mco.backup.narration": "Sicharung von %s",
	...
	"mco.client.outdated.stable.version": "Dei Version (%s) ist a bissi z`oit und ned mit Realms kompatibel.\n\nBitte verwende die neichste Version vo Minecraft.",
	"mco.client.unsupported.snapshot.version": "Dei Version (%s) is ned mit Realms kompatibel.\n\nRealms is für diese Entwicklungsversion ned verfügbar.",
	"mco.compatibility.downgrade": "Hearab Stuafen",
	"mco.compatibility.downgrade.description": "De Wöd is as letzte Moi in da Version %s gspüt wordn; du bist jetz auf da Version %s. De Wöd mit ana ondan Version zum Spün ku zu ana Beschädigung von de Datn führn - mia kinan ned garantiern, dass de Wöd lodt oda richtig geht. \n\nWenn du des etz trotzdem toa wüst, donn moch bitte a Sicherheitskopie.",
	"mco.compatibility.incompatible.popup.title": "Ned übereinstimmende Version",
	"mco.compatibility.incompatible.releaseType.popup.message": "Die Wöd, die du betreten wüst, ist mit deiner aktuellen Version ned kompatibel.",
	"mco.compatibility.incompatible.series.popup.message": "Diese Wöd wurde zuletzt in der Version %s gspüt; du bist aud da Version %s.\n\nDe Versionsstände sand ned miteinander kompatibel. Um in de vorliegenden Version zu spünn, wird anne neiche Wöd benötigt.",
	"mco.compatibility.unverifiable.message": "Es konnte ned festgstöt werden, in wöcher Version de Wöd letztens gspüt worden is, wenn du sie hoch‐ bzw. herabstufst, wird automatisch anne Sicherheitskopie erstöht und unter „Sicherungen“ gspeichert.",
	"mco.compatibility.unverifiable.title": "Kompatibilität ned überprüfbar",
	"mco.compatibility.upgrade": "Upgrade",
	"mco.compatibility.upgrade.description": "Die Wöd wurde letztens in da Version %s gspüt; du bist auf da Version %s.\n\nUnter „Sicherungen“ wird anne Sicherheitskopie deiner Wöd gspeichert.\n\nBitte setz sie im Bedarfsfall darauf zurück.",
	"mco.compatibility.upgrade.friend.description": "Die Wöd wurde letztens in da Version %s gspüt; du bist auf da Version %s.\n\nUnter „Sicherungen“ wird anne Sicherheitskopie deiner Wöd gspeichert.\n\nBitte setz sie im Bedarfsfall darauf zurück.",
	"mco.compatibility.upgrade.title": "Mogst du de wöd wiaklich lodn?",
	...
	"mco.configure.world.buttons.newworld": "Neie Wöd",
	...
	"mco.configure.world.buttons.region_preference": "Region auswöhn...",
	...
	"mco.configure.world.close.question.title": "Muast wos Ändan ohne das wea Nervt?",
	...
	"mco.configure.world.loading": "Realm wird gloadn",
	"mco.configure.world.location": "Ort",
	"mco.configure.world.minigame": "Grad: %s",
	"mco.configure.world.name": "Nom vom Realm",
	"mco.configure.world.name.validation.whitespace": "Daf ned mit am Leazeichn onfongen oda endn. Es wead obgschnittn.",
	"mco.configure.world.opening": "Realm wead aufgmocht ...",
	"mco.configure.world.players.error": "Es existiat koa Spiela mit dem Nomen",
	"mco.configure.world.players.invite.duplicate": "A Spüla mitm gegebenen Nomen is schon zum Realm einglodn woan",
	...
	"mco.configure.world.region_preference": "Beforzuagte Region",
	"mco.configure.world.region_preference.title": "Beforzuagte Region auswöhn",
	...
	"mco.configure.world.resourcepack.question": "Du benötigst a benutzerdefiniertes Ressourcenpaket, um auf dem Realm zu spün.\n\nMechtast du`s da runterloden und damit spün?",
	...
	"mco.configure.world.settings.expired": "De Einstellungen von am obglofenem Realm kennen ned beoabeitet wean",
	...
	"mco.configure.world.spawnMonsters": "Monsta spawnen",
	"mco.configure.world.spawnNPCs": "Dorfbewohna",
	"mco.configure.world.spawnProtection": "Spawnpunktschutz",
	"mco.configure.world.spawn_toggle.message": "Wennsd des ausschoitest, wean olle bereits existanden Entitätn von dem Typ entfeant",
	"mco.configure.world.spawn_toggle.message.npc": "Wennsd des ausschoitest, wean olle bereits existanden Entitätn von dem Typ entfeant, wie zB Doafbewohna",
	...
	"mco.create.world.failed": "Wöd hod net erstöllt wean kennan!",
	...
	"mco.download.confirmation.oversized": "Die Wöd, die du runterloden wüst, ist größer ois %s.\n\nDu wirst de Wöd ned wieder auf dein Realm hochloden kenna",
	...
	"mco.errorMessage.initialize.failed": "Realm hod net initiallisiert wean kennan",
	"mco.errorMessage.noDetails": "Ka Föhlabeschreibung vorhondn",
	"mco.errorMessage.realmsService": "An Fähla isch uftreata (%s):",
	"mco.errorMessage.realmsService.configurationError": "A uneawoteta Fehla is beim beoabeitn von de Wödoptionen aufgetretn",
	"mco.errorMessage.realmsService.connectivity": "De Vabindung zum Server hot ned heagstöt weadn kina: %s",
	"mco.errorMessage.realmsService.realmsError": "Realms (%s):",
	"mco.errorMessage.realmsService.unknownCompatibility": "Kompatible Version konnt ned überprüft werden kenna; erhaltene Antwort: %s",
	...
	"mco.gui.ok": "Ok",
	"mco.info": "Info!",
	"mco.invited.player.narration": "%s is einglodn woadn",
	...
	"mco.notification.transferSubscription.message": "Java‐Realms‐Abonnements werden in den Microsoft Store verschoben. Loss dei Abonnement ned auslaufen!\nJetzt übertragogen und 30 Tog Realms kostenlos krigen.\nGehe zum Profil auf minecraft.net, um dein Abonnement zu übertragen.",
	...
	"mco.onlinePlayers": "Spüler online",
	"mco.play.button.realm.closed": "Realm is gschlossn",
	"mco.question": "Frog",
	...
	"mco.selectServer.create.subtitle": "Wöh, auf wöche Wöd dei neiche Realm glodn wean soid",
	...
	"mco.selectServer.loading": "Realm‐Auswoi wird glodn",
	...
	"mco.selectServer.noRealms": "Du scheinst kan Realm zu hoben. Füge ein Realm hinzu, um mit deinen Freinden zu spün.",
	...
	"mco.snapshot.createSnapshotPopup.text": "Du bist dabei, a kostenloses Realm für Entwicklungsversionen zu erstön, das mit deinem zahlungspflichtigen Realms‐Abonnement verknüpft wird. Des neiche Entwicklungsversionen‐Realm konn so long genutzt werden, wiea das zahlungspflichtige Abonnement aktiv ist. An deinem bezahlten Realm ändert si dadurch gornix.",
	"mco.snapshot.createSnapshotPopup.title": "Entwiacklungsversionen‐Realm erstellen?",
	"mco.snapshot.creating": "Entwicklungsversionen‐Realm wird erstöd…",
	"mco.snapshot.description": "Verkniapft mit „%s“",
	"mco.snapshot.friendsRealm.downgrade": "Du brauchast die Version %s, um dem Realm zu betreten",
	"mco.snapshot.friendsRealm.upgrade": "%s muss das Realm hochstufen, bevor du in de Version drauf spün konnst",
	"mco.snapshot.paired": "De Entwicklungsversionen‐Realm ist mit „%s“ verknüpft",
	"mco.snapshot.parent.tooltip": "Verwende de neichste Voiversion, um auf dem Realm zu spün",
	"mco.snapshot.start": "Kostenloses Entwicklungsversionen‐Realm onlegen",
	"mco.snapshot.subscription.info": "Dies ist ein Realm für Entwicklungsversionen, des mit dem Abonnement deines Realms „%s“ verknüpft ist. Es bleibt so longe aktiv, wie des damit verknüpfte Realm aktiv ist.",
	"mco.snapshot.tooltip": "Entwicklungsversionen‐Realms verschaffen dir annen Einblick in zukünftige Versionen von Minecraft, die möglicherweise neue Spielelemente und sonstige Änderungen enthoiten.\n\nDeine normalen Realms kannst du in der aktuellen Voiversion obrufen.",
	"mco.snapshotRealmsPopup.message": "Realms gibt es jetz a in Entwicklungsversionen, beginnend mit 23w41a. Jedes Realms‐Abonnement wird um ein kostenloses Realm für Entwicklungsversionen ergänzt, des von deinem normalen Java‐Realm getrennt ist!",
	"mco.snapshotRealmsPopup.title": "Realms jetz is Entwicklungsversionen verfügbar",
	...
	"mco.upload.failed.too_big.description": "De ausgwölte Wöd is zgroß. De maximale Greß is %s.",
	"mco.upload.failed.too_big.title": "Wöd is zu groß",
	...
	"menu.custom_options": "Eigene Einstöllungen...",
	"menu.custom_options.title": "Eigene Einstöllungen",
	"menu.custom_options.tooltip": "Hinweis: Benutza definierte Gschichten wean vom Serva und/oda vun am Drittn bereitgstöd. Bas auf!",
	"menu.custom_screen_info.button_narration": "Des is a benutzadefiniertes Menü. Druck do dast mea eafost.",
	"menu.custom_screen_info.contents": "De Inholte von dem Fensta wean von am Serva und Drittn koatn definiert, de Mojang Studios oda Microsoft ned kean, nu von denen betiebn wean \n\nBas auf! Sei voasichtig wonnst auf Links druckst und sog nia deine Persönlichn Daten (wia deine Onmödedaten).\n\nWenn di des Fensta am Spün hindat, kunnst de Verbindung zum Serva a üba da Schoitflechn untn trenna.",
	"menu.custom_screen_info.disconnect": "Benutza Defnierts Menü obglehtn",
	"menu.custom_screen_info.title": "Hinweis zu benutza definiertn Menü",
	"menu.custom_screen_info.tooltip": "Des is a benutzadefiniertes Menü. Druck do dast mea eafost.",
	"menu.disconnect": "Server valossn",
	"menu.feedback": "Rückmödung…",
	"menu.feedback.title": "Rückmödung",
	"menu.game": "Spümenü",
	...
	"menu.quick_actions": "Schnöll Aktionen...",
	"menu.quick_actions.title": "Schnöll Aktionen",
	...
	"multiplayer.codeOfConduct.check": "Fia den Veahoitnskodex neama benochrichtigt wean",
	"multiplayer.codeOfConduct.title": "Server-Verhoitnskodx",
	"multiplayer.confirm_command.parse_errors": "Du wüst an unbekonnt oder foischen Befehl ausführn.\nBist da sicha?\nBefehl: %s",
	"multiplayer.confirm_command.permissions_required": "Du probiast an Beföh auszfüan, dea a hechare Berechtigung braucht.\nDes kunnt si schlecht aufs Spüh auswiakn.\nBist da sicha? \nBeföh: %s",
	"multiplayer.confirm_command.run_command": "Befö ausfüan",
	"multiplayer.confirm_command.signature_required": "Du versuachst, an Befö auszufüan, der Chatnochrichtn in deinem Nom versendet.\nDieser Befö konn nur üba des Chatfensta ausgfüat werdn.\nBefö: %s",
	"multiplayer.confirm_command.suggest_command": "Ins Chatfensta kopian",
	"multiplayer.confirm_command.title": "Befehlsausfiahrung bestätign",
	...
	"multiplayer.disconnect.bad_chat_index": "Vapasste oda umgeordnete Chatnochricht vom Server erkonnt",
	...
	"multiplayer.disconnect.banned.reason.default": "Von am Operator gebannt.",
	...
	"multiplayer.disconnect.code_of_conduct": "Da Server valongt, dem Veahoitnskodex zuazumstimmen",
	"multiplayer.disconnect.configuration_error": "Uneawoateta Fehla während da konfiguration",
	...
	"multiplayer.disconnect.transfers_disabled": "Der Server nimmt kanne Übertragungen entgegen",
	...
	"multiplayer.status.anonymous_player": "Anonyma Spiela",
	...
	"music.game.clark": "C418 - Far (Geile Scheibn)",
	...
	"narration.checkbox.usage.focused.check": "Druck Enta zum Auswöhln",
	"narration.checkbox.usage.focused.uncheck": "Druck Enta zum Obwöhln",
	"narration.checkbox.usage.hovered": "Linksklick zum umschoitn",
	"narration.checkbox.usage.hovered.check": "Linksklick zum Auswöhln",
	"narration.checkbox.usage.hovered.uncheck": "Linksklick zum Obwöhln",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Drück Enta umn Weat vom Schiaberegla zu ändan",
	...
	"narration.suggestion.usage.cycle.fixed": "Druck de Tabulatortosten, um zum nächsten Vorschlog zu blättern",
	"narration.suggestion.usage.cycle.hidable": "Drucke de Tabulatortoste, um zum nächsten Vorschlog zu blättern, oder Escape, um die Vorschläge zu verlossen",
	"narration.suggestion.usage.fill.fixed": "Drüacke die Taobulatoartoaste, um den Voarschlag zu verwenden",
	"narration.suggestion.usage.fill.hidable": "Drucke de Tabulatortoste, um zum nächsten Vorschlog zu blättern, oder Escape, um die Vorschläge zu verlossen",
	...
	"optimizeWorld.confirm.proceed": "Kopie erstölln und optimian",
	...
	"optimizeWorld.stage.finished.chunks": "Chunk‐Aktualisierung wird obgschlossen…",
	"optimizeWorld.stage.finished.entities": "Objektaktualisierung wird obgschlossen…",
	"optimizeWorld.stage.finished.poi": "Zielpunktaktualisierung wird obgschlossen …",
	"optimizeWorld.stage.upgrading": "Olle Chunks wean aktualisiert...",
	"optimizeWorld.stage.upgrading.chunks": "Olle Chunks wean aktualisiert...",
	"optimizeWorld.stage.upgrading.entities": "Olle Objekte wean aktualisiert...",
	"optimizeWorld.stage.upgrading.poi": "Olle Zielpunkte wean aktualisiert...",
	...
	"options.accessibility.high_contrast_block_outline.tooltip": "Erhöht n Kontrast von da Umrisslinie vom ongezültn Block.",
	"options.accessibility.link": "Leitfodn zua Barrierefreiheit",
	"options.accessibility.menu_background_blurriness": "Menühintagrundsunschärfe",
	"options.accessibility.menu_background_blurriness.tooltip": "Ändat de Unschärfe von Menü-Hintagründn",
	"options.accessibility.narrator_hotkey": "Sprochausgobn‐Kurzonwoi",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Ob de Sprochausgob mit [STRG]/[CMD] + [B] ein- oda ausgschoitn wean konn",
	"options.accessibility.narrator_hotkey.tooltip": "Ob de Sprochausgob mit [STRG]/[CMD] + [B] ein- oda ausgschoitn wean konn",
	...
	"options.allowCursorChanges": "Dynamischa Mauszaga",
	"options.allowCursorChanges.tooltip": "Mocht, dass sich da Mauszaga veaändat, wenn du üba bestimmtn UI-Elementn bist.",
	...
	"options.chat.drafts": "Ungesendete Chatnochrichtn speichan",
	"options.chat.drafts.tooltip": "Ned gsendete Nochrichtn werdn gspeichat und kennan beim nächstn Öffnan des Chats gsendet werdn.",
	...
	"options.chunkFade.none": "Chunk-Einblendung. Kane",
	"options.chunkFade.seconds": "Chunk-Einblendung: %s Sekund(n)",
	"options.chunkFade.tooltip": "Wie vü Sekundn long Chunks beim eastn Rendern einblendn, wenn übahaupt.",
	...
	"options.cutoutLeaves": "Duachsichtiges Lab",
	"options.cutoutLeaves.tooltip": "Eamöglicht es, duach Lab-Zwischnräume duachzumsehgn. Des Deaktivian konn de Leistung vabessan.",
	...
	"options.font": "Schriftorteinstöllungen...",
	"options.font.title": "Schriftorteinstöllungen",
	...
	"options.graphics.custom": "Benutzadefiniat",
	...
	"options.graphics.preset": "Vuaeinstöllung",
	"options.graphics.preset.tooltip": "Setzt de Einstöllungen fia \"Qualität & Leistung\" auf sinnvolle Standardwerte, de dea gwünschtn Qualität entsprechn.",
	...
	"options.hideSplashTexts.tooltip": "Schoitet de Göbn Sprüche im Hauptmenü aus.",
	"options.improvedTransparency": "Vabessate Transparenz",
	"options.improvedTransparency.tooltip": "A experimentella Onsotz, bei dem Büldschiam-Shader zua Doastöllung von Wetta, Woikn und Partikl hinta lichtduachlässign Blöckn und Wossa vawendet wean. Des wiakt sich auf de Grafikleistung aus.",
	...
	"options.inactivityFpsLimit": "Bildwiedaholrotn varingan, wenn",
	"options.inactivityFpsLimit.afk": "Obwesnd",
	"options.inactivityFpsLimit.afk.tooltip": "Setzt de Büldwiedaholrotn auf 30, wenn des Spü a Minutn ka Eingobe kriagt. Noch 9 Weitan Minutn weats auf 10 Bülda pro Sekunde gestzt.",
	"options.inactivityFpsLimit.minimized": "Minimiat",
	"options.inactivityFpsLimit.minimized.tooltip": "Varingat de Büldwiedaholratn nua donn, wenn es Spüfensta mimimiat is.",
	"options.invertMouse": "Maus umkehrn",
	"options.invertMouseX": "X-Mausrichtung umdrahn",
	"options.invertMouseY": "Y-Mausrichtung umdrahn",
	"options.japaneseGlyphVariants": "Japanische Glyphenvarianten",
	"options.japaneseGlyphVariants.tooltip": "Vawendet japanische Vartanten von CJK-Zeichn in da Standartschriftoat",
	...
	"options.languageAccuracyWarning": "(De Übasetzungen san vielleicht ned zu 100%% richtig)",
	...
	"options.maxAnisotropy": "Antisotrope Fültarung",
	"options.maxAnisotropy.tooltip": "Vabessat deitlich, wie glott Textuan aussehn, wiakt sich oba auf de Leistung aus und eahöht den Speichabedarf da Grafikkoatn eaheblich. Wead meglichaweise ned von olln Gerätn untastützt.",
	...
	"options.musicToast": "Liadtitel eiblendn",
	"options.musicToast.never": "Nia",
	"options.musicToast.never.tooltip": "Liadtitel wean ned auzagt.",
	"options.musicToast.pauseMenu": "Pausnmenü",
	"options.musicToast.pauseMenu.tooltip": "A Eiblendung wiad duachgehnd im Pausnmenü des Spüs auzagt während a Liad obgspüt wiad.",
	"options.musicToast.pauseMenuAndToast": "Pausnmenü und Eiblendung",
	"options.musicToast.pauseMenuAndToast.tooltip": "Zagt a Einblendung on, wonn a Liad zum spüln onfongt. Daweil des Liad obgspüt wead, is de Einblendung a im Pausnmenü zum segn.",
	"options.music_frequency": "Musikheifigkeit",
	"options.music_frequency.constant": "Imma",
	"options.music_frequency.default": "Stondard",
	"options.music_frequency.frequent": "Heifig",
	"options.music_frequency.tooltip": "Stöllt ein, wie oft Musik währendm spün obgspüt wead.",
	...
	"options.realmsNotifications.tooltip": "Ruft Realms‐Neuigkeiten und ‐Einladungen im Hauptmenü ob und zagt ihre jeweiligen Symbole auf da Schoitflächen „Realms“ an.",
	"options.reducedDebugInfo": "Reduziate Debug-Infos",
	"options.renderClouds": "Woikn",
	"options.renderCloudsDistance": "Woiknreichweitn",
	...
	"options.rotateWithMinecart": "Mit Wagons mitdrahn",
	"options.rotateWithMinecart.tooltip": "Wenn de Blickrichtung von m Spiela sich mit Wagons mitdrahn soii. Gibts nua in Wöltn, in de de experimentelle \"Wagon Vabessarung\" Einstöllung ein is.",
	...
	"options.showNowPlayingToast": "Liadl Nom zoagn",
	"options.showNowPlayingToast.tooltip": "Zagt a Einblendung on, wonn a neie Musik spüt. De Einblendung is imma do, wenn du im Pausnmenü bist und a Musik spüt.",
	"options.showSubtitles": "Untatitl uzoagn",
	"options.showSubtitles.tooltip": "Schoitet Untatitl fia Geräusche im Spü ein.",
	...
	"options.sprintWindow": "Sprint-Zeitfensta",
	"options.sprintWindow.tooltip": "Zeitfensta in Ticks, indem man mit am W-Doppldruck des Sprintn einschoitet.",
	...
	"options.telemetry.disabled": "Telemetrie is ausschoitn.",
	"options.telemetry.state.all": "Alles",
	"options.telemetry.state.minimal": "Minimal",
	"options.telemetry.state.none": "Keine",
	"options.textureFiltering": "Texturfüterung",
	"options.textureFiltering.anisotropic": "Anisotrop",
	"options.textureFiltering.anisotropic.tooltip": "A Hardware-basiate Fültamethodn, wiakt sich oba auf de Leistung aus und eahöht den Grafikspeicherbedoaf eaheblich. Wead meglichaweise ned von ollan Gerätn untastützt.",
	"options.textureFiltering.none": "Koa",
	"options.textureFiltering.none.tooltip": "Textuan wean ohne Fültarung ongezagt. Blöcke kennen vaschwumman aussegn, wenn se aus am bestimmtn Winkl ongschaut wean.",
	"options.textureFiltering.rgss": "RRSS",
	"options.textureFiltering.rgss.tooltip": "(Rotiertes Raster‐Supersampling)\nA Shader-basiate Fültamethode, de de Textuaqualität mit mittlaren Leistungseinbußungen vabessat.",
	"options.title": "Optionen",
	"options.touchscreen": "Touchscreen-Modus",
	"options.value": "%s",
	"options.video": "Grafikeistellungen ...",
	"options.video.display.header": "Onzeige",
	"options.video.interface.header": "Obafläche",
	"options.video.preferences.header": "Präfarenzn",
	"options.video.quality.header": "Qualität & Leistung",
	"options.videoTitle": "Grafikeistellungen",
	"options.viewBobbing": "Gehbewegung",
	"options.vignette": "Vignette onzagn",
	"options.vignette.tooltip": "Des is a subtile Textua im Sichtföd, de de Büldschiamrända vadunklt und a vua da Wöltnbarriere want.",
	"options.visible": "Sichtbor",
	"options.vsync": "VSync",
	"options.weatherRadius": "Wettaeffekt-Radius",
	"options.weatherRadius.tooltip": "Radius, in dem Regn- und Schneeeffekte sichtboa san. Sea niedriga Leistungseinfluss.",
	"options.worldOptions.button": "Wödeinstöllungen...",
	"options.worldOptions.title": "Wödeinstöllungen",
	...
	"pack.dropRejected.message": "De folgenden Einträge woan kane gültign Pakete und san ned kopiat woan: %s",
	...
	"pack.incompatible.confirm.unknown": "Des Paket is hin oda fia a unbekonnte Minecraft-Version gmocht und geht vielleicht net gonz.",
	...
	"pack.incompatible.unknown": "(Hin oda inkompatibl)",
	...
	"painting.minecraft.backyard.title": "Da Hinterhof",
	...
	"painting.minecraft.bouquet.title": "Da Blumenstrauß",
	...
	"painting.minecraft.cavebird.title": "Da Höhlenvogei",
	"painting.minecraft.changing.author": "Kristoffer Zetterstrand",
	"painting.minecraft.changing.title": "Da Kostümwechsel",
	...
	"painting.minecraft.endboss.title": "Da Feind am ende annes spüs",
	...
	"painting.minecraft.finding.title": "Finden",
	...
	"painting.minecraft.lowmist.title": "Tiefnöbi",
	...
	"painting.minecraft.orb.title": "Kugi",
	"painting.minecraft.owlemons.author": "Kristoffer Zetterstrand",
	"painting.minecraft.owlemons.title": "Zitruseule",
	"painting.minecraft.passage.author": "Kristoffer Zetterstrand",
	"painting.minecraft.passage.title": "Durchgong",
	...
	"particle.invalidOptions": "Partikleignschoft hod ned ausgweatet wean kennen: %s",
	...
	"realms.configuration.region.west_us": "Kalifornien, Vaeinigte Stootn",
	"realms.configuration.region.west_us_2": "Washington, Vaeinigte Stootn",
	"realms.configuration.region_preference.automatic_owner": "Automatisch (nahe Realm-Besitza)",
	"realms.configuration.region_preference.automatic_player": "Automatisch (nahe 1. Spiela pro Sitzung)",
	...
	"recover_world.done.failed": "Frühara Zustond hod neg glodn wean kennan.",
	"recover_world.done.success": "De Wöld hot wida herstollt wean kennan!",
	...
	"recover_world.message": "De folgenden Fehla san beim Wöltordnalodn vom Ordna '%s' passiat.\nMöglichaweise losst sich de Wölt nua aus an öltarem Zuastond wiaherstölln, oder du konnst des Problem im Bugtracker möldn.",
	"recover_world.no_fallback": "Ka Zustond zum widaherstölln vuahondn",
	"recover_world.restore": "Vasuach zum Widaherstölln",
	"recover_world.restoring": "Es wead vasuacht, de Wölt wiad herzumstölln...",
	"recover_world.state_entry": "Zustond von %s: ",
	"recover_world.state_entry.unknown": "unbekonnt",
	"recover_world.title": "Wölt hot ned glodn wean kennan",
	...
	"resourcePack.runtime_failure": "Resourcepack-Fehla erkonnt",
	...
	"selectWorld.incompatible.description": "De Wölt kon ned in dea Version göffnet weadn.\nEs letze mol is es in da Version %s gspült woadn.",
	"selectWorld.incompatible.info": "Unkompatible Version: %s",
	"selectWorld.incompatible.title": "Unkompatible Version",
	"selectWorld.incompatible.tooltip": "De Wölt hot ned göffnet wean kennan, weil se in ana unkompatiblen Version erstöllt woan is.",
	...
	"selectWorld.resource_load": "Ressourcen wean vorbereitet ...",
	...
	"selectWorld.tooltip.fromNewerVersion2": "wennst'das jetz lodst, konn des problematische Folgn hobn!",
	...
	"selectWorld.warning.lowDiskSpace.description": "Auf deim Gerät is neama vü Speichaplotz voahondn.\nWennst kan Speichaplotz mea host, kennt des dei Wölt hin mochn.",
	"selectWorld.warning.lowDiskSpace.title": "Ochtung! Wenig Speichaplotz!",
	...
	"slot.only_single_allowed": "Nua anzelne Inventarplätze san erlaubt, '%s' erholtn",
	"slot.unknown": "Unbekonnta Slot '%s'",
	"snbt.parser.empty_key": "Schlissl derf ned leer sein",
	"snbt.parser.expected_binary_numeral": "Binärzohl erwoat",
	"snbt.parser.expected_decimal_numeral": "Dezimalzohl erwoat",
	"snbt.parser.expected_float_type": "Gleitkommazohl eawoatet",
	"snbt.parser.expected_hex_escape": "Zeichnkettn von da Länge %s erwoat",
	"snbt.parser.expected_hex_numeral": "Hexadezimalzohl erwoat",
	"snbt.parser.expected_integer_type": "Ganzzohl erwoat",
	"snbt.parser.expected_non_negative_number": "Nichtnegative Zohl erwoat",
	"snbt.parser.expected_number_or_boolean": "Zohl oda Wahrheit erwoat",
	"snbt.parser.expected_string_uuid": "Zeichnkettn erwoat, de a gültige UUID darstellt",
	"snbt.parser.expected_unquoted_string": "Gültige Zeichnkettn ohne Anführungszeichn erwoat",
	"snbt.parser.infinity_not_allowed": "Ned endliche Zohln san ned erlaubt",
	"snbt.parser.invalid_array_element_type": "Ungültiga Typ von Listnelement",
	"snbt.parser.invalid_character_name": "Ungültiga Name von Unicode-Zeichn",
	"snbt.parser.invalid_codepoint": "Ungültiga Wert für Unicode-Zeichen: %s",
	"snbt.parser.invalid_string_contents": "Ungültiga Inhalt von da Zeichnkettn",
	"snbt.parser.invalid_unquoted_start": "Zeichnkettn ohne Anführungszeichn derfn ned mit den Ziffern 0-9 oda mit den Zeichn + und - beginnen",
	"snbt.parser.leading_zero_not_allowed": "Dezimalzohln derfn ned mit 0 beginnen",
	"snbt.parser.no_such_operation": "Keine derartige Operation: %s",
	"snbt.parser.number_parse_failure": "Zohl hot ned glesen werdn kennan: %s",
	"snbt.parser.undescore_not_allowed": "Unterstrich san am Onfong und End ana Zohl ned erlaubt",
	...
	"soundCategory.ui": "Benutzaobaflächn",
	...
	"stat.minecraft.happy_ghast_one_cm": "Streckn mitm glücklichm Ghast gflogn",
	...
	"stat.minecraft.nautilus_one_cm": "Streckn auf Nautilus grittn",
	...
	"subtitles.ambient.sound": "Grusligs Geräusch",
	...
	"subtitles.block.copper_bulb.turn_off": "Kupfalompn gehd aus",
	"subtitles.block.copper_bulb.turn_on": "Kupfalompn gehd ei",
	"subtitles.block.copper_chest.close": "Kistn schliaßt",
	"subtitles.block.copper_chest.open": "Kistn öffnet",
	"subtitles.block.copper_trapdoor.close": "Troapdoar moacht zua",
	"subtitles.block.copper_trapdoor.open": "Foitir mocht auf",
	"subtitles.block.crafter.craft": "Wearker wearckelt",
	"subtitles.block.crafter.fail": "Crafter vamurkst",
	"subtitles.block.creaking_heart.hurt": "Knoazaheaz grummlt",
	"subtitles.block.creaking_heart.idle": "Grusligs Geräusch",
	"subtitles.block.creaking_heart.spawn": "Knoazaheaz erwocht",
	"subtitles.block.deadbush.idle": "Zwoag knistan",
	"subtitles.block.decorated_pot.insert": "Vazierta Kruag gfüt",
	"subtitles.block.decorated_pot.insert_fail": "Vazierta Kruag wocklt",
	"subtitles.block.decorated_pot.shatter": "Vazierta Kruag zabricht",
	...
	"subtitles.block.dried_ghast.ambient": "Schnaufn ",
	"subtitles.block.dried_ghast.ambient_water": "Trockena Ghast nimmt Wossa auf",
	"subtitles.block.dried_ghast.place_in_water": "Trockena Ghast quillt",
	"subtitles.block.dried_ghast.transition": "Trockenem Ghast gehts bessa",
	"subtitles.block.dry_grass.ambient": "Wind waht",
	...
	"subtitles.block.eyeblossom.close": "Augnbluam schließt",
	"subtitles.block.eyeblossom.idle": "Augnbluam flüstat",
	"subtitles.block.eyeblossom.open": "Augnbluam öffnet",
	...
	"subtitles.block.firefly_bush.idle": "Glühwürmchen schwirrn",
	...
	"subtitles.block.generic.fall": "Iagndwos foiit auf an Block",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Schüd wocklt",
	...
	"subtitles.block.pale_hanging_moss.idle": "Grusligs Geräusch",
	...
	"subtitles.block.sand.idle": "Sond waht",
	"subtitles.block.sand.wind": "Wind waht",
	...
	"subtitles.block.shelf.multi_swap": "Items wean getauscht",
	"subtitles.block.shelf.place_item": "Item platziert",
	"subtitles.block.shelf.single_swap": "Item wead getauscht",
	"subtitles.block.shelf.take_item": "Item gnommen",
	...
	"subtitles.block.trapdoor.close": "Foitir mocht zua",
	"subtitles.block.trapdoor.open": "Foitir mocht auf",
	"subtitles.block.trapdoor.toggle": "Foitir knarrt",
	"subtitles.block.trial_spawner.about_to_spawn_item": "Unheilvolla Gegnstond bereitet sich vua",
	"subtitles.block.trial_spawner.ambient": "Prüfungsspawner knistat",
	"subtitles.block.trial_spawner.ambient_charged": "Unheilvolla Prüfungsspawner knistat",
	"subtitles.block.trial_spawner.ambient_ominous": "Unheilvolles Knarzen\n",
	"subtitles.block.trial_spawner.charge_activate": "Unheil umhüllt Prüfungsspawner",
	"subtitles.block.trial_spawner.close_shutter": "Prüfungsspawner schliaßt",
	"subtitles.block.trial_spawner.detect_player": "Prüfungsspawner lodet sich auf",
	"subtitles.block.trial_spawner.eject_item": "Prüfungsspawner wirft Beute aus",
	"subtitles.block.trial_spawner.ominous_activate": "Unheil umhüt Prüfungs‐Spawner",
	"subtitles.block.trial_spawner.open_shutter": "Prüfungsspawner öffnet",
	"subtitles.block.trial_spawner.spawn_item": "Unheilvolla Gegnstond foin glossn",
	"subtitles.block.trial_spawner.spawn_item_begin": "Unheilvolla Gegnstond erscheint",
	"subtitles.block.trial_spawner.spawn_mob": "Prüfungsspawner erschofft a Geschöpf",
	...
	"subtitles.block.vault.close_shutter": "Tresor schliaßt",
	"subtitles.block.vault.deactivate": "Tresor erlischt",
	"subtitles.block.vault.eject_item": "Tresor wirft Gegnstond aus",
	"subtitles.block.vault.insert_item": "Tresor entrieglt",
	"subtitles.block.vault.insert_item_fail": "Tresor bleibt verriegelt",
	"subtitles.block.vault.open_shutter": "Tresor öffnet",
	"subtitles.block.vault.reject_rewarded_player": "Tresor weist Spüler ob",
	"subtitles.block.water.ambient": "Wossa fliaßt",
	"subtitles.block.wet_sponge.dries": "Schwomm trocknet",
	...
	"subtitles.entity.armadillo.ambient": "Gürtltia grunzt",
	"subtitles.entity.armadillo.brush": "Hornschüd obgebürstet",
	"subtitles.entity.armadillo.death": "Gürtltia stirbt",
	"subtitles.entity.armadillo.eat": "Gürtltia frisst",
	"subtitles.entity.armadillo.hurt": "Gürtltia nimmb Schodn",
	"subtitles.entity.armadillo.hurt_reduced": "Gürtltia schütz sich",
	"subtitles.entity.armadillo.land": "Gürtltia londet",
	"subtitles.entity.armadillo.peek": "Gürtltia späht",
	"subtitles.entity.armadillo.roll": "Gürtltia rollt sich ein",
	"subtitles.entity.armadillo.scute_drop": "Gürtltier wiaft Hornschüd ob",
	"subtitles.entity.armadillo.unroll_finish": "Gürtltia entrollt sich",
	"subtitles.entity.armadillo.unroll_start": "Gürtltia späht",
	...
	"subtitles.entity.baby_cat.ambient": "Katzal miaut",
	"subtitles.entity.baby_cat.beg_for_food": "Katzal bettlt",
	"subtitles.entity.baby_cat.death": "Katzal stiabt",
	"subtitles.entity.baby_cat.eat": "Katzal frisst",
	"subtitles.entity.baby_cat.hiss": "Katzal faucht",
	"subtitles.entity.baby_cat.hurt": "Katzal nimmt Schodn",
	"subtitles.entity.baby_cat.purr": "Katzal schnurrt",
	...
	"subtitles.entity.baby_horse.breathe": "Fohl otmet",
	"subtitles.entity.baby_horse.death": "Fohl stiabt",
	...
	"subtitles.entity.baby_nautilus.ambient": "Nautilusbaby zwitschat",
	"subtitles.entity.baby_nautilus.ambient_land": "Nautilusbaby zwitschat",
	"subtitles.entity.baby_nautilus.death": "Nautilusbaby stiabt",
	"subtitles.entity.baby_nautilus.death_land": "Nautilusbaby stiabt",
	"subtitles.entity.baby_nautilus.eat": "Nautilusbaby frisst",
	"subtitles.entity.baby_nautilus.hurt": "Nautilusbaby nimmb Schodn",
	"subtitles.entity.baby_nautilus.hurt_land": "Nautilusbaby nimmb Schodn",
	"subtitles.entity.baby_nautilus.swim": "Nautilusbaby schwimmt",
	"subtitles.entity.baby_pig.ambient": "Ferkal grunzt",
	"subtitles.entity.baby_pig.death": "Ferkal stiabt",
	"subtitles.entity.baby_pig.eat": "Ferkel frisst",
	"subtitles.entity.baby_pig.hurt": "Ferkal nimmt Schodn",
	"subtitles.entity.baby_wolf.ambient": "Hundal jaunzt",
	"subtitles.entity.baby_wolf.death": "Hundal stiabt",
	"subtitles.entity.baby_wolf.growl": "Hundal knurrt",
	"subtitles.entity.baby_wolf.hurt": "Hundal nimmt Schodn",
	"subtitles.entity.baby_wolf.pant": "Hundal keicht",
	"subtitles.entity.baby_wolf.whine": "Hundal winslt",
	...
	"subtitles.entity.bogged.ambient": "Sumpfskellet kloppat",
	"subtitles.entity.bogged.death": "Sumpfskellet stiabt",
	"subtitles.entity.bogged.hurt": "Sumpfskelett nimmt Schodn",
	"subtitles.entity.breeze.charge": "Böe lodet auf",
	"subtitles.entity.breeze.death": "Böe stiabt",
	"subtitles.entity.breeze.deflect": "Böe wehrt ob",
	"subtitles.entity.breeze.hurt": "Böe kriegt schodn",
	"subtitles.entity.breeze.idle_air": "Böe fliagt",
	"subtitles.entity.breeze.idle_ground": "Böe wirblt",
	"subtitles.entity.breeze.inhale": "Böe hoid Luft",
	"subtitles.entity.breeze.jump": "Böe spring",
	"subtitles.entity.breeze.land": "Böe londet",
	"subtitles.entity.breeze.shoot": "Böe schiaßt",
	"subtitles.entity.breeze.slide": "Böe gleitet",
	"subtitles.entity.breeze.whirl": "Böe wiablt",
	"subtitles.entity.breeze.wind_burst": "Windkugl platzt",
	...
	"subtitles.entity.camel_husk.ambient": "Untots Kamel grummlt",
	"subtitles.entity.camel_husk.dash": "Untots Kamel prescht",
	"subtitles.entity.camel_husk.dash_ready": "Untots Kamel eaholt sich",
	"subtitles.entity.camel_husk.death": "Untots Kamel stiabt",
	"subtitles.entity.camel_husk.eat": "Untots Kamel frisst",
	"subtitles.entity.camel_husk.hurt": "Untots Kamel nimmt Schodn",
	"subtitles.entity.camel_husk.saddle": "Untots Kamel gsottlt",
	"subtitles.entity.camel_husk.sit": "Untots Kamel setzt sich hi",
	"subtitles.entity.camel_husk.stand": "Untots Kamel steht auf",
	...
	"subtitles.entity.copper_golem.death": "Kupfagolem stiabt",
	"subtitles.entity.copper_golem.hurt": "Kupfagolem nimmt Schodn",
	"subtitles.entity.copper_golem.item_drop": "Kupfagolem legt a Item in a Kistn",
	"subtitles.entity.copper_golem.item_no_drop": "Kupfagolem konn ka Item oblegn",
	"subtitles.entity.copper_golem.no_item_get": "Kupfagolem nimmt Item auf",
	"subtitles.entity.copper_golem.no_item_no_get": "Kupfagolem konn ka Item aufnehmen",
	"subtitles.entity.copper_golem.spawn": "Kupfagolem eascheint",
	"subtitles.entity.copper_golem.spin": "Kopf vom Kupfagolem draht sich",
	"subtitles.entity.copper_golem_become_statue": "Kupfagolem erstarrt",
	"subtitles.entity.copper_golem_oxidized.death": "Kupfagolem stiabt",
	"subtitles.entity.copper_golem_oxidized.hurt": "Kupfagolem nimmt Schodn",
	"subtitles.entity.copper_golem_oxidized.spin": "Kopf vom Kupfagolem draht sich",
	"subtitles.entity.copper_golem_weathered.death": "Kupfagolem stiabt",
	"subtitles.entity.copper_golem_weathered.hurt": "Kupfagolem nimmt Schodn",
	"subtitles.entity.copper_golem_weathered.spin": "Kopf vom Kupfagolem draht sich",
	...
	"subtitles.entity.creaking.activate": "Knoaza schaut",
	"subtitles.entity.creaking.ambient": "Knoaza knoazt",
	"subtitles.entity.creaking.attack": "Knoaza attakiat",
	"subtitles.entity.creaking.deactivate": "Knoaza beruhigt sich",
	"subtitles.entity.creaking.death": "Knoaza brecklt",
	"subtitles.entity.creaking.freeze": "Knoaza erstarrt",
	"subtitles.entity.creaking.spawn": "Knoaza manifestiert",
	"subtitles.entity.creaking.sway": "Knoaza wead gschützt",
	"subtitles.entity.creaking.twitch": "Knoaza zuckt",
	"subtitles.entity.creaking.unfreeze": "Knoaza bewegt sich",
	...
	"subtitles.entity.donkey.jump": "Esl springt",
	...
	"subtitles.entity.generic.wind_burst": "Windkugl plotzt",
	...
	"subtitles.entity.ghastling.hurt": "Ghast nimmb Schodn",
	"subtitles.entity.ghastling.spawn": "Ghastlein eascheint",
	...
	"subtitles.entity.happy_ghast.ambient": "Glücklicha Ghast trällat",
	"subtitles.entity.happy_ghast.death": "Glücklicher Ghast stirbt",
	"subtitles.entity.happy_ghast.equip": "Gschirr onglegt",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Glücklicha Ghast is flugbereit",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Glücklicha Ghast heat auf",
	"subtitles.entity.happy_ghast.hurt": "Glücklicha Ghast nimmt Schodn",
	"subtitles.entity.happy_ghast.unequip": "Gschirr auszogn",
	...
	"subtitles.entity.llama.swag": "Lama vaziert",
	...
	"subtitles.entity.minecart.inside": "Wagon klirrt",
	"subtitles.entity.minecart.inside_underwater": "Wagon klirrt untawossa",
	...
	"subtitles.entity.nautilus.ambient": "Nautilus klappat",
	"subtitles.entity.nautilus.ambient_land": "Nautilus klappat",
	"subtitles.entity.nautilus.dash": "Nautilus düst",
	"subtitles.entity.nautilus.dash_land": "Nautilus düst",
	"subtitles.entity.nautilus.dash_ready": "Nautilus eaholt sich",
	"subtitles.entity.nautilus.dash_ready_land": "Nautilus daholt si",
	"subtitles.entity.nautilus.death": "Nautilus stiabt",
	"subtitles.entity.nautilus.death_land": "Nautilus stirb",
	"subtitles.entity.nautilus.eat": "Nautilus frisst",
	"subtitles.entity.nautilus.hurt": "Nautilus nimmt Schodn",
	"subtitles.entity.nautilus.hurt_land": "Nautilus nimmb Schodn",
	...
	"subtitles.entity.parched.ambient": "Eiswondara klappat",
	"subtitles.entity.parched.death": "Eiswondara stiabt",
	"subtitles.entity.parched.hurt": "Eiswondara nimmt Schodn",
	...
	"subtitles.entity.parrot.imitate.breeze": "Popagei wirblt",
	"subtitles.entity.parrot.imitate.camel_husk": "Popagei grummlt",
	"subtitles.entity.parrot.imitate.creaking": "Popagei knoazt",
	...
	"subtitles.entity.parrot.imitate.parched": "Popagei knistat",
	...
	"subtitles.entity.parrot.imitate.zombie_horse": "Popagei stöhnt",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Popagei guaglt",
	...
	"subtitles.entity.wind_charge.throw": "Windkugl fliagt",
	"subtitles.entity.wind_charge.wind_burst": "Windkugl plotzt",
	...
	"subtitles.entity.wolf.bark": "Woif böt",
	...
	"subtitles.entity.wolf.pant": "Woif hechlt",
	"subtitles.entity.wolf.shake": "Woif schüttlt si",
	"subtitles.entity.wolf.whine": "Woif winslt",
	...
	"subtitles.entity.zombie_horse.angry": "Zombieroß wiehat",
	"subtitles.entity.zombie_horse.death": "Zombieroß stirb",
	"subtitles.entity.zombie_horse.eat": "Zombieroß frisst",
	"subtitles.entity.zombie_horse.hurt": "Zombieroß nimmb Schodn",
	"subtitles.entity.zombie_nautilus.ambient": "Zombienautilus blubbat",
	"subtitles.entity.zombie_nautilus.ambient_land": "Zombie Nautilus blubbat",
	"subtitles.entity.zombie_nautilus.dash": "Zombienautilus düst",
	"subtitles.entity.zombie_nautilus.dash_land": "Zombie Nautilus flitzt uma",
	"subtitles.entity.zombie_nautilus.dash_ready": "Zombienautilus eaholt sich",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Zombie Nautilus daholt si",
	"subtitles.entity.zombie_nautilus.death": "Zombienautilus stiabt",
	"subtitles.entity.zombie_nautilus.death_land": "Zombie Nautilus stirb",
	"subtitles.entity.zombie_nautilus.eat": "Zombienautilus frisst",
	"subtitles.entity.zombie_nautilus.hurt": "Zombienautilus nimmt Schodn",
	"subtitles.entity.zombie_nautilus.hurt_land": "Zombie Nautilus nimmb Schodn",
	...
	"subtitles.event.mob_effect.raid_omen": "Überfoi kemt auf di zua",
	"subtitles.event.mob_effect.trial_omen": "Unheilvolle Prüfung kumt auf di zua",
	...
	"subtitles.item.armor.equip_copper": "Kupfagolem scheppat",
	...
	"subtitles.item.armor.equip_nautilus": "Nautilusponza onglegt",
	"subtitles.item.armor.equip_netherite": "Netheritrüstung scheppat",
	"subtitles.item.armor.equip_turtle": "Schildkrötnponza ongleg",
	"subtitles.item.armor.equip_wolf": "Wolfpanza is wieda guat",
	"subtitles.item.armor.unequip_nautilus": "Nautilusponza obglegt",
	"subtitles.item.armor.unequip_wolf": "Wolfspanzer obgenomma",
	...
	"subtitles.item.bundle.insert_fail": "Sackerl voii",
	...
	"subtitles.item.elytra.flying": "Elytra fliagt",
	...
	"subtitles.item.golden_dandelion.unuse": "Goidana Löwnzohn wiad oid",
	"subtitles.item.golden_dandelion.use": "Goidana Löwnzohn wiad nemma oid",
	"subtitles.item.hoe.till": "Hock pflügt",
	"subtitles.item.honey_bottle.drink": "Schluckn",
	"subtitles.item.honeycomb.wax_on": "Wochsn",
	"subtitles.item.horse_armor.unequip": "Pfeadlpanzer obgnumma",
	"subtitles.item.ink_sac.use": "Tintnbeitl tropft",
	"subtitles.item.lead.break": "Leine grissn",
	"subtitles.item.lead.tied": "Testkonstruktionsgreß",
	"subtitles.item.lead.untied": "Leine offn",
	"subtitles.item.llama_carpet.unequip": "Teppich obgstreift",
	"subtitles.item.lodestone_compass.lock": "Leitstoa Kompass is auf Leitstoa grichtet woan",
	"subtitles.item.mace.smash_air": "Streitkoiben zerschmettert",
	"subtitles.item.mace.smash_ground": "Schlägel zertrümmert",
	"subtitles.item.nautilus_saddle_equip": "Nautilus gsottlt",
	"subtitles.item.nautilus_saddle_underwater_equip": "Nautilus gsottlt",
	"subtitles.item.nether_wart.plant": "Plonzn gepflonz",
	"subtitles.item.ominous_bottle.dispose": "Flosche bricht",
	"subtitles.item.saddle.unequip": "Sottl obgstreift",
	"subtitles.item.shears.shear": "Schar schneid",
	"subtitles.item.shears.snip": "Schea schneit",
	"subtitles.item.shield.block": "Schüd wehrt o",
	"subtitles.item.shovel.flatten": "Schaufe planiat",
	"subtitles.item.spear.attack": "Lonzn sticht",
	"subtitles.item.spear.hit": "Lonzn trifft",
	"subtitles.item.spear.lunge": "Lonzn stößt vua",
	"subtitles.item.spear.use": "Onlauf mit Lonzn",
	"subtitles.item.spear_wood.attack": "Lonzn sticht",
	"subtitles.item.spear_wood.hit": "Lonzn trifft",
	"subtitles.item.spear_wood.use": "Onlauf mit Lonzn",
	...
	"subtitles.item.underwater_saddle.equip": "Sottl auftrogn",
	"subtitles.item.wolf_armor.break": "Wolfpanza is hin",
	"subtitles.item.wolf_armor.crack": "Wolfpanza is hin",
	"subtitles.item.wolf_armor.damage": "Wolfspanzer is a bisi zafetzt",
	"subtitles.item.wolf_armor.repair": "Wolfpanza is wieda guat",
	"subtitles.particle.soul_escape": "Seele entwichn",
	"subtitles.ui.cartography_table.take_result": "Kortn zeichnt",
	"subtitles.ui.hud.bubble_pop": "Luftvorrot nimmt ob",
	"subtitles.ui.loom.take_result": "Webstui gnutzt",
	"subtitles.ui.stonecutter.take_result": "Stoasog benutzt",
	"subtitles.weather.end_flash": "Endblitz rumpet",
	...
	"symlink_warning.message.pack": "Wötn aus Ordna mit symbolische Verknüpfungen zum Lodn is gor ned so ungfährlich wenn du koan Tau host wos du tuast. Bitte schau auf %s vorbei, donn bisd gscheida.",
	"symlink_warning.message.world": "Wötn aus Ordna mit symbolische Verknüpfungen zum Lodn is gor ned so ungfährlich wenn du koan Tau host wos du tuast. Bitte schau auf %s vorbei, donn bisd gscheida.",
	...
	"telemetry.property.user_id.title": "Nutza‐ID",
	"telemetry.property.world_load_time_ms.title": "Wödlodezeit (Millisekundn)",
	"telemetry.property.world_session_id.title": "Wöd‐Sitzungs‐ID",
	...
	"telemetry_info.screen.title": "Telemetrie‐Datnerhebung",
	"test.error.block_property_mismatch": "De eawoatete Eignschoft %s wurd ois %s eawoatet, woa oba %s",
	"test.error.block_property_missing": "Blockeignschoftn Föhn, Eigneschoft %s siot %s sei",
	"test.error.entity_property": "Entität %s hod den Test %s ned eafüllt",
	"test.error.entity_property_details": "Entität %s hot den Test %s ned eafüllt, eawoatet woa %s, woa oba %s",
	"test.error.expected_block": "Block %s eawoatet, woa oba %s",
	"test.error.expected_block_present": "Da Block %s wiad erwartet",
	"test.error.expected_block_tag": "Block woa in %s eawoatet, woa oba %s",
	"test.error.expected_container_contents": "Behöta soit %s enthoitn",
	"test.error.expected_container_contents_single": "Behöta soit oa %s enthoitn",
	"test.error.expected_empty_container": "Behöta soit la sei",
	"test.error.expected_entity": "%s erwoatet",
	"test.error.expected_entity_around": "%s soit bei %s, %s, %s sei",
	"test.error.expected_entity_count": "%s Entitätn vom Typ %s san eawoatet woan, es san oba %s",
	"test.error.expected_entity_data": "Enitätsdaten %s wuadn eawoatet, woan oba %s",
	"test.error.expected_entity_data_predicate": "Entitätndaten dia %s stimmen ned übaein",
	"test.error.expected_entity_effect": "Eawoatet, dass %s Effekt %s %s hod",
	"test.error.expected_entity_having": "Entitätninventar soit %s entholtn",
	"test.error.expected_entity_holding": "Entität soid %s hoitn",
	"test.error.expected_entity_in_test": "Eawoatete %s im Test",
	"test.error.expected_entity_not_touching": "%s is ned ois %s, %s, %s ongrenzend eawoatet (relativ: %s, %s, %s)",
	"test.error.expected_entity_touching": "%s wiad ois on %s, %s, %s ongrenzend eawoatet (relativ: %s, %s, %s)",
	"test.error.expected_item": "Teil vom typ %s eawoatet",
	"test.error.expected_items_count": "%s Items vom Typ %s san eawoatet woan, es san oba %s",
	"test.error.fail": "Fehlschlogsbedingungen treffn zua",
	"test.error.invalid_block_type": "%s bei %s, %s, %s (relativ: %s, %s, %s) in Tick %s",
	"test.error.missing_block_entity": "Fehlndes Blockobjekt",
	...
	"test.error.sequence.condition_already_triggered": "Bedingung is schon in Tick %s ausglöst woan",
	"test.error.sequence.condition_not_triggered": "Bedingung ned ausglöst",
	"test.error.sequence.invalid_tick": "In ungültigm Tick passiat: %s is eawoatet woan",
	"test.error.sequence.minimum_tick": "Vor erwartetem Tick stattgefunden: erwartet, %s zu warten",
	"test.error.sequence.not_completed": "Test is voa featigstöllung obglofn",
	"test.error.set_biome": "Biom ist fia Test ned festglegt woan",
	"test.error.spawn_failure": "Entität %s hod ned eastöllt wean kennen",
	"test.error.state_not_equal": "Folscha Zuastond. %s erwoat, woa %s",
	"test.error.structure.failure": "Testkonstruktion fia %s hot ned platziert wean kenna",
	"test.error.tick": "%s in Tick %s",
	"test.error.ticking_without_structure": "Testausführung hot ongfongan, bevor die Konstruktion platziert wordn is",
	"test.error.timeout.no_result": "Weda Erfolg noch Fehlschlog innerholb von %s Ticks",
	"test.error.timeout.no_sequences_finished": "Kane Testobläufe innerholb von %s Ticks obgschlossn",
	"test.error.too_many_entities": "Nur a %s um %s, %s, %s erwoat, owa %s gfundn",
	"test.error.unexpected_block": "Block is ned ols %s erwoat woan",
	"test.error.unexpected_entity": "Ned erwoat, %s vorzfindn",
	"test.error.unexpected_item": "Gegnstond vom Typ %s is ned erwoat woan",
	"test.error.unknown": "Unbekonnta interna Fehla: %s",
	"test.error.value_not_equal": "%s is ols %s erwoat woan, woa oba %s",
	"test.error.value_not_in_between": "%s zwischen %s und %s erwartet, war aber %s",
	"test.error.wrong_block_entity": "Folscha Blockobjekttyp: %s",
	"test_block.error.missing": "Testkonstruktion hot kan %s-Block",
	"test_block.error.too_many": "Zu vü %s-Bleck",
	"test_block.invalid_timeout": "Ungültigs Timeout (%s) - muaß a positive Onzohl von Ticks sein",
	"test_block.message": "Nochricht:",
	"test_block.mode.accept": "Unemma",
	"test_block.mode.fail": "Fehlgschlogn",
	"test_block.mode.log": "Protokoll",
	"test_block.mode.start": "Start",
	"test_block.mode_info.accept": "Akzeptonzmodus - Nimmb (teilweisn) Erfolg von an Test entgegn",
	"test_block.mode_info.fail": "Fehlamodus - Losst an Test fehlschlogn",
	"test_block.mode_info.log": "Protokollmodus - Protokollier a Nochricht",
	"test_block.mode_info.start": "Startmodus - Da Onfangspunkt von an Test",
	"test_instance.action.reset": "Zrucksetzn und lonan",
	"test_instance.action.run": "lonan und ausfian",
	"test_instance.action.save": "Struktua speichan",
	"test_instance.description.batch": "Teil: %s",
	"test_instance.description.failed": "Fehlgschlogn: %s",
	"test_instance.description.function": "Funktion: %s",
	"test_instance.description.invalid_id": "Ungültige Test-ID",
	"test_instance.description.no_test": "Den Test gibts ned",
	"test_instance.description.structure": "Struktua: %s",
	"test_instance.description.type": "Typ: %s",
	"test_instance.type.block_based": "Blockbasiata Test",
	"test_instance.type.function": "Eingebauta Funktionstest",
	"test_instance_block.entities": "Objekte:",
	"test_instance_block.error.no_test": "Testinstonz bei %s, %s, %s konn ned ausgführt wean, wal ihra koa Test zugwiesn is",
	"test_instance_block.error.no_test_structure": "Testinstonz bei %s, %s, %s konn ned ausgführt wean, wal ihra koa Test zugwiesn is",
	"test_instance_block.error.unable_to_save": "Testkonstruktionsvoalog füa Testiinstonz bei %s,%s,%s ko ned gschpeichat wean",
	"test_instance_block.invalid": "ungültig",
	"test_instance_block.reset_success": "Test %s is eafoikreich zruckgestetzt",
	"test_instance_block.rotation": "Drahung:",
	"test_instance_block.size": "Testkonstruktionsgreß",
	"test_instance_block.starting": "Test %s wead gstartet",
	"test_instance_block.test_id": "Testinstonz-ID",
	...
	"trim_material.minecraft.resin": "Hoazmaterial",
	"trim_pattern.minecraft.bolt": "Bolzn-Rüstungssotz",
	...
	"trim_pattern.minecraft.flow": "Fluss-Rüstungssotz",
